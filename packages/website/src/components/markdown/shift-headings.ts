...
/**
 * remark plugin to shift heading levels. Usefull when used on markdown partials.
 * When the `omitH1` flag is set, all headings with level 1 are removed from the output
 */
