...
The activities we organize are intended to stimulate collaboration between members of the community. We use the data you enter when registering to communicate with you about that event and to draw your attention to similar events after the event. For the logistics of the event, we will use the registration data, for example to send invitations.
...
Good to know: of course you can unsubscribe at any time. You can do this by sending an email to [mailto:info@nldesignsystem.nl](info@nldesignsystem.nl).

## More information

If you have any questions about the protection of your privacy in relation to the website nldesignsystem.nl, you can contact the core team via [mailto:info@nldesignsystem.nl](info@nldesignsystem.nl).

The person whose personal data is processed has the right to contact NL Design System with a request to view, correct or (have) delete this personal data. You can also contact the core team for this via [mailto:info@nldesignsystem.nl](info@nldesignsystem.nl).
