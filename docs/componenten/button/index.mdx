...
<CriteriaList
  headingLevel={4}
  testList="Toegankelijkheid algemeen"
  items={[
    {
      title: "De zichtbare naam van de button is gelijk aan de toegankelijke naam",
      sc: "2.5.3",
      status: "Nog te bepalen of we dit gaan gebruiken",
      component: <Wcag253 />,
    },
    {
...
<CriteriaList
  headingLevel={4}
  testList="Toegankelijkheid visueel ontwerp"
  items={[
    {
...
<CriteriaList
  headingLevel={4}
  testList="Toegankelijkheid zoom en herschalen"
  items={[
    {
...
<CriteriaList
  headingLevel={4}
  testList="Toegankelijkheid toetsenbord"
  items={[
    {
...
<CriteriaList
  headingLevel={4}
  testList="Toegankelijkheid screenreader"
  items={[
    {
