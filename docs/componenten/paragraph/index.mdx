...
<ComponentStory
  label="Voorbeeld van een Paragraph met een korte zin waarin bijna alle letters van het alfabet zijn gebruikt"
  render={() => <CandidateParagraph>{"Op brute wĳze ving de schooljuf de quasi-kalme lynx."}</CandidateParagraph>}
/>
