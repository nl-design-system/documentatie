...
<Checklist headingLevel="4">
  ...
  <ChecklistItem
    title="Als een paragraaftekst in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode."
    sc="3.1.2"
    status=""
...
<Checklist headingLevel="4">
  <ChecklistItem title="Gebruik het p-element voor paragraaftekst." sc="1.3.1" status="" tags={["developer"]}>
    <Wcag131 />
  </ChecklistItem>
  <ChecklistItem
