...
import { Mark as CandidateMark } from "@nl-design-system-candidate/mark-react/css";
...
<ComponentStory label='Voorbeeld van  Mark in een zin waar "quasi-kalme lynx" gemarkeerd is.'>
  <div>
    {"Op brute wĳze ving de schooljuf de "}
    <CandidateMark>quasi-kalme lynx</CandidateMark>
    {"."}
  </div>
</ComponentStory>
