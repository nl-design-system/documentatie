...
description: Paneel om onderwerpen te groeperen, waarbij er maar één per keer zichtbaar is, met knoppen om te kiezen welk onderwerp wordt weergegeven.
slug: /tabs
---
...
export const description = "Paneel om onderwerpen te groeperen, waarbij er maar één per keer zichtbaar is, met knoppen om te kiezen welk onderwerp wordt weergegeven.";
