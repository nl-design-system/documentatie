...
description: Toont de titel van een sub-sub-sub sectie en helpt de inhoud van een pagina te structureren.
slug: /heading-5
...
export const description = "Toont de titel van een sub-sub-sub sectie en helpt de inhoud van een pagina te structureren.";
