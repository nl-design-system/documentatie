...
description: Toont de eerste titel van de pagina en helpt de inhoud van een pagina te structureren.
slug: /heading-1
...
export const description = "Toont de eerste titel van de pagina en helpt de inhoud van een pagina te structureren.";
