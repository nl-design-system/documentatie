...
import AcComponentIntro from "@nl-design-system-unstable/documentation/componenten/ac/_ac_component_intro.md";
import AcGebruikIntro from "@nl-design-system-unstable/documentation/componenten/ac/_ac_gebruik_intro.md";
...
<CriteriaList
  ...
  items={[
    ...
    {
      title: "De Link heeft een rol van link",
      sc: "4.1.2",
      status: "",
      component: <Wcag412 />,
    },
...
<CriteriaList
  ...
  items={[
    ...
    {
      title: "De Link heeft een toegankelijke naam die duidelijk maakt waar de Link voor dient",
      sc: "4.1.2",
      status: "",
      component: <Wcag412 />,
    },
