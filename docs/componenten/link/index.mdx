...
<Checklist headingLevel="4">
  ...
  <ChecklistItem
    title="Als het zichtbare label van de Link alleen een afbeelding of icoon is, dan is het contrast tussen de afbeelding en de achtergrond minimaal 3:1."
    sc="1.4.11"
    status=""
    tags={["designer", "contentmaker"]}
  >
  ...
  <ChecklistItem
    title="Als de tekst van de Link in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode."
    sc="3.1.2"
    status=""
...
<Checklist headingLevel="4">
  ...
  {/*
    ...
    */}
  <ChecklistItem title="" sc="2.5.2" status="" tags={["developer"]}>
    <Wcag252 />
  </ChecklistItem>
  <ChecklistItem
