...
description: Toont een tekstlabel dat informeert over de te selecteren optie.
...
export const description = "Toont een tekstlabel dat informeert over de te selecteren optie.";
