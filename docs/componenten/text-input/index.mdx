...
<Checklist
  ...
  items={[
    ...
    {
      title: "Het tekstuele label van de Text Input is programmatisch gekoppeld aan de Text Input.",
      sc: "1.3.1",
      status: "",
      component: <Wcag131 />,
      tags: ["developer"],
    ...
    {
      title:
        "Instructies bij de Text Input staan op een logische plek en/of zijn programmatisch gekoppeld aan de Text Input.",
      sc: "1.3.2",
      status: "",
      component: <Wcag132 />,
