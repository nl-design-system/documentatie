...
<Checklist
  ...
  items={[
    {
      title: "Als de Text input een niet-decoratief icoon bevat, is de betekenis van het icoon duidelijk.",
      sc: "1.1.1",
      status: "",
      component: <Wcag111 />,
    ...
    {
      title: "Als de Text input een icoon bevat, is dat geen afbeelding van tekst.",
      sc: "1.4.5",
      status: "",
      component: <Wcag145 />,
      tags: ["developer", "contentmaker"],
    ...
    {
      title: "De Text input heeft een beschrijvend tekstueel label en toegankelijke naam.",
      sc: "2.4.6",
      status: "",
      component: <Wcag246 />,
...
<Checklist
  ...
  items={[
    ...
    {
      title: "Het is mogelijk de Text input een toegankelijke naam en de juiste rol te geven.",
      sc: "4.1.2",
      status: "",
      component: <Wcag412 />,
      tags: ["developer"],
