...
import Wcag111 from "@nl-design-system-unstable/documentation/componenten/ac/\_wcag-1.1.1-accordion.md";
...
import Wcag321 from "@nl-design-system-unstable/documentation/componenten/ac/\_wcag-3.2.1-accordion.md";
...
import Wcag412 from "@nl-design-system-unstable/documentation/wcag/summaries/\_4.1.2-summary.md";
...
<CriteriaList
  ...
  items={[
    {
      title: "Het icoon dat aangeeft of de accordion in- of uitgeklapt is heeft een alternatieve tekst",
      sc: "1.1.1",
      status: "",
      component: <Wcag111 />,
    },
