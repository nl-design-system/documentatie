...
description: Toont een titel en helpt de inhoud van een pagina te structureren.
slug: /heading
...
export const description = "Toont een titel en helpt de inhoud van een pagina te structureren.";
