...
<Checklist headingLevel="4">
  ...
  <ChecklistItem
    title="Als de tekst van de Skip Link in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode."
    sc="3.1.2"
    status=""
    tags={["developer", "contentmaker"]}
  >
...
<Checklist headingLevel="4">
  ...
  <ChecklistItem
    title="Als je de hele webpagina inzoomt tot 400% veroorzaakt de Skip Link geen horizontale scrollbalk en blijft alle tekst op de pagina leesbaar."
    sc="1.4.10"
    status=""
    tags={["developer", "designer"]}
  >
  ...
  <ChecklistItem
    title="Als een gebruiker de Skip Link focust met het toetsenbord, dan moet deze ook weer weg kunnen gaan met het toetsenbord."
    sc="2.1.2"
    status=""
    tags={["developer"]}
  >
  ...
  <ChecklistItem title="Het aanwijsgebied van de Skip Link is groot genoeg." sc="2.5.5" status="" tags={["developer"]}>
    <Wcag255NLDS />
  </ChecklistItem>
  <ChecklistItem
  ...
  <ChecklistItem title="De Skip Link heeft een rol van link." sc="4.1.2" status="" tags={["developer"]}>
    <Wcag412NLDS />
  </ChecklistItem>
</Checklist>
