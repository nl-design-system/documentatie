...
import Wcag412RO from "@nl-design-system-unstable/documentation/componenten/ac/_wcag-4.1.2-link-role.md";
...
Hier beschrijven we wat je zelf nog moet doen om de component toegankelijk én gebruiksvriendelijk in te zetten.
...
<CriteriaList
  ...
  items={[
    {
      title:
        "Als je de Skip Link indrukt met een aanwijzer zoals een muis of vinger, is er de mogelijkheid om actie te voorkomen of ongedaan te maken",
      sc: "2.5.2",
      status: "",
      component: <Wcag252 />,
    },
