...
import { NewChecklist } from "@site/src/components/NewChecklist";
import { DoneList } from "@site/src/components/DoneList";
...
## De component gebruiken

<IntroGebruik />

### Toegankelijkheid van de component
...
<!-- hier ook UX- en tips uit gebruiksonderzoek delen -->
...
<NewChecklist
  items={[
    ...
    {
      title: "De focusindicator van de Skip Link heeft voldoende contrast met de achtergrond.",
      sc: "2.4.13",
      status: "",
      component: <Wcag2413CC />,
      tags: ["developer", "designer"],
    },
    {
    ...
    {
      title:
        "De Skip Link heeft een rol van link en een toegankelijke naam die duidelijk maakt waar de Skip Link naar verwijst.",
      sc: "4.1.2",
      status: "",
      component: <Wcag412 />,
      tags: ["developer"],
...
## Implementaties in de community
