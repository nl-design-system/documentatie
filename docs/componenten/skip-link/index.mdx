...
import Wcag247 from "/docs/componenten/ac/_wcag-2.4.7-skip-link.md";
...
<CriteriaList
  ...
  items={[
    ...
    {
      title: "De linktekst van de Skip Link vertelt eenduidig aan de gebruiker waar de link naar toe gaat (het linkdoel)",
      sc: "2.4.4",
      status: "",
      component: <Wcag244 />,
    },
    {
      title: "Als de gebruiker de Skip Link indrukt met een aanwijzer zoals een muis of vinger, is er de mogelijkheid is om actie te voorkomen of ongedaan te maken",
      sc: "2.5.2",
      status: "",
      component: <Wcag252 />,
    },
...
<CriteriaList
  ...
  items={[
    ...
    {
      title: "Als je de hele webpagina inzoomt tot 400% blijft veroorzaakt de Skip Link veroorzaakt geen horizontale scrollbalk en alle tekst op de pagina blijft leesbaar",
      sc: "1.4.10",
      status: "",
      component: <Wcag1410 />,
    },
...
<CriteriaList
  ...
  items={[
    ...
    {
      title: "De Skip Link heeft een rol van link en een toegankelijke naam die duidelijk maakt waar de Skip Link voor dient",
      sc: "4.1.2",
      status: "",
      component: <Wcag412 />,
    },
