...
<Card className="implementation-card">
  <CardContent>
    ...
    <LinkList>
<<<<<<< HEAD
      <LinkListLink href="https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=13781-17931"><BrandIcon brand='figma' />Figma - Start bibliotheek</LinkListLink>
      <LinkListLink href="https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=13781-179313553"><BrandIcon brand='figma' />Figma - Voorbeeld bibliotheek</LinkListLink>
=======
...
>>>>>>> a11ff7421c1 (feat: solve component axe errors with linkedlistlink)
    </LinkList>
...
<Checklist
  ...
  items={[
    ...
    {
      title:
        "Als je de beschrijvende tekst bij een Color Sample vergroot tot 200% blijft deze in zijn geheel zichtbaar.",
      sc: "1.4.4",
      status: "",
      component: <Wcag144 />,
      tags: ["developer"],
