...
import { ColorSample as CandidateColorSample } from "@nl-design-system-candidate/color-sample-react/css";
...
<ComponentStory label="Voorbeeld van een Color Sample waar een klein vakje met is ingekleurd">
  <CandidateColorSample value="#007dad" />
</ComponentStory>
