...
<Checklist headingLevel="4">
  ...
  <ChecklistItem
    title="Wanneer de achtergrondkleur van het Code Block anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina."
    sc="1.4.11"
    status=""
    tags={["designer", "contentmaker"]}
  >
...
<Checklist headingLevel="4">
  ...
  <ChecklistItem title="Als je inzoomt naar 200% blijft alle tekst leesbaar." sc="1.4.4" status="" tags={["developer"]}>
    <Wcag144 />
  </ChecklistItem>
  <ChecklistItem
