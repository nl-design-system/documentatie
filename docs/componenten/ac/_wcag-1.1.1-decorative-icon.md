...
Het is daarom niet nodig dat gebruikers die hulpsoftware, zoals een [screenreader](/woordenlijst/#screenreader), gebruiken weten dat er icon aanwezig is. Verberg decoratieve iconen, bijvoorbeeld met `aria-hidden="true"` op het parent element van de icon.
