...
Er is een goed zichtbare focusindicator. Dit doe je met een minimale dikte van 2 pixels. Om ervoor te zorgen dat de focusindicator altijd volledig zichtbaar is, kun je gebruik maken van `inset`. Hierdoor is de focusindicator onderdeel van de totale grote van het interactieve element. Zie als voorbeeld [de opmaak van het candidate Skip Link component](https://github.com/nl-design-system/candidate/blob/main/packages/components-css/skip-link-css/src/_mixin.scss).
