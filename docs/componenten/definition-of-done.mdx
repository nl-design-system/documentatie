...
De componenten van NL Design System worden met een [estafette aanpak]('/meedoen/estafettemodel') gemaakt. Daarom kan een component een van de volgende statussen hebben:
