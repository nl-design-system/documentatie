...
Technologie verandert elke maand, dus de precieze betekenis van de Baseline verandert. Op de NL Design System website publiceren we periodiek een momentopname van welke softwareversies op dat moment worden bedoeld met de Baseline. De meest recente in de serie is de [Baseline october 2025](/baseline/2025-10).
