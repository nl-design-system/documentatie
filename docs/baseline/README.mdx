...
Technologie verandert elke maand, dus de preciese betekenis van de Baseline verandert. Op de NL Design System website publiceren we periodiek een momentopname van welke softwareversies op dat moment worden bedoeld met de Baseline. De eerste in de serie is de [Baseline december 2024](/baseline/2024-12).
