...
Technologie verandert elke maand, dus de preciese betekenis van de Baseline verandert. Op de NL Design System website publiceren we periodiek een momentopname van welke softwareversies op dat moment worden bedoeld met de Baseline. De laatste in de serie is de [Baseline juli 2025](/baseline/2025-07).
