...
Het uitgangspunt van NL Design System is toegankelijk en gebruiksvriendelijk ontwerpen en ontwikkelen. Alternatieven voor basis toegankelijkheid, zoals een versie die geactiveerd moet worden met een hoogcontrastknop of toegankelijkheidswidget, zijn daarom geen onderdeel van de baseline van NL Design System.

Aanvullende instellingen voor persoonlijke voorkeuren, zoals dark mode of het aanpassen aan systeem- en browserinstellingen, zijn wel onderdeel van de baseline.
