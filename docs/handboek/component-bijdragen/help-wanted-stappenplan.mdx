...
Om de community letterlijk een beeld te geven van de component voegen we een afbeelding toe. Dit kan een sreenshot, schets of uitgewerkt ontwerp zijn. Voor het formaat kun je het [Figma 'Schetsboek'](https://www.figma.com/file/fy08SZpZmqx6ljLwvA3Woe/NLDS---Schetsboek?type=design&node-id=439-969&mode=design) gebruiken.
