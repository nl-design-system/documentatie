...
- **Er capaciteit is** bij het kernteam voor begeleiding
...
Dit component is een **voorstel voor een standaard**. Het kernteam onderhoud t het en werkt met meerdere organisaties aan een versie die breed bruikbaar is. De component moet mogelijk nog extra goed getest en stabiel gemaakt worden.
