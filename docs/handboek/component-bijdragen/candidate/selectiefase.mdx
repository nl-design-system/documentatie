...
In de selectiefase bepaalt het kernteam of een Community component klaar is om Candidate te worden. Je controleert of de component in verschillende huisstijlen werkt, in meerdere projecten wordt gebruikt, en in een toegankelijkheidsaudit is getest. Het resultaat is een component die bewezen heeft geschikt te zijn voor breed hergebruik.

**Wat doe je in deze fase?**

- Controleren of component Community status heeft
- Testen in verschillende huisstijlen
- Gebruik in meerdere projecten verifiëren
- WCAG-EM audit resultaten bekijken
- Community informeren over selectie
...
:::info Bonus voor de OCD-ers onder ons
