...
- Omdat het component pas de status Community krijgt op de website als deze check is gedaan wordt de checkpoint op Done gezet voordat de promotie ook echt is gedaan.

**🚩 Checkpoint**: Promotie

## Website geupdate met nieuwe status

- [@nl-design-system/component-prorgess](https://www.npmjs.com/package/@nl-design-system/component-progress) updaten met [action](https://github.com/nl-design-system/index/actions/workflows/continuous-deployment.yml).
