...
- Sluit aan op tooling zoals pnpm, TypeScript en rollup.
- Implementeer een CI/CD pipeline met GitHub Actions; publiceren van packages gebeurt alleen via een GitHub Actions workflow.
...
Organiseer een veilige werkomgeving door onze Code of Conduct (link) zichtbaar te maken en toe te passen.
...
Componenten worden _whitelabel_ opgezet en alles wat nodig is om het component te implementeren en te gebruiken, wordt beschreven zodat gebruikers er optimaal mee aan de slag kunnen.
