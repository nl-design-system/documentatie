...
De componenten van NL Design System worden met een [estafette aanpak](/introductie/estafettemodel/) gemaakt. Daarom kan een component een van de volgende statussen hebben:
...
Bekijk de status op [het projectbord voor de Candidate componenten](https://github.com/orgs/nl-design-system/projects/80).
