...
Er wordt herkend dat de component aangepast moet worden, wanneer de ongewijzigde component minder goed werkt in nieuwe versies van browsers en hulpmiddelen, wanneer getest wordt met een nieuwe versie van de [NL Design System Baseline](/baseline).
