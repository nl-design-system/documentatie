...
**Tip!** Bepaalde functionerende design objecten ontberen specifieke eisen via design tokens. Dit treedt specifiek op in situaties bij fonts achter design parameters voor Icon. Verken pragmatische implementaties in de component.
