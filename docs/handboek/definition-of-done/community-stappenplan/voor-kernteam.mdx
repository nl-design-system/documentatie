...
Het kernteam volgt dit stappenplan om een component van alle checkpoints 🚩 te voorzien die nodig zijn voor de ['Community' status](https://github.com/orgs/nl-design-system/projects/29) van het [Estafettemodel](https://www.nldesignsystem.nl/handboek/component-bijdragen/definition-of-done).
Organisaties die een component bij willen dragen kunnen het [Stappenplan voor organisaties](/handboek/estafettemodel/componenten/community/voor-organisaties/) gebruiken.
