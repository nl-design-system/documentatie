...
Het kernteam wil met de selectiefase ervoor zorgen dat er genoeg input verzameld is door de community om een succesvolle Candidate component te maken die voldoet aan de eisen en wensen van de organisaties die deze gaan gebruiken.
...
Het kernteam wil met de voorbereidingfase voorkomen dat er steeds nieuwe richtingen gekozen moeten worden tijdens de ontwikkelfase en zorgen dat de ontwikkeling van de verschillende component implementaties en documentatie zo veel mogelijk parallel kan gebeuren.
...
Het kernteam wil met de ontwikkelfase ervoor zorgen dat er gefocust kan worden op een goed gedocumenteerd, voorspelbaar component die hetzelfde werkt in verschillende implementaties.
...
Het kernteam wil met de testfase ervoor zorgen dat alle problemen die met de acceptatiecriteria konden worden voorkomen, worden opgelost voordat de component wordt gepubliceerd. Zo kan de community de component met vertrouwen inzetten en vooral feedback geven op eventueel missende functionaliteit.
...
Het kernteam zorgt met de publicatiefase ervoor dat de component kan worden ingezet door organisaties die nu de Community component gebruiken, organisaties die bijdragen aan de Community component én door nieuwe organisaties.
...
De stappen worden bijgehouden in het GitHub projectbord [Components - 3 - Candidate](https://github.com/orgs/nl-design-system/projects/80/views/1) en regelmatig geüpdatet op de website.
