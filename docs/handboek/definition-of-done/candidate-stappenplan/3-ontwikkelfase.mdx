...
De actieve stappen en tevens alle relevante parallelle uitbreidingsacties van de Ontwikkelfase zijn onlosmakelijk met de fundering gebonden. Implementeer en test effectief op basis van deze visualisatie voor structuur in de projectcyclus:
