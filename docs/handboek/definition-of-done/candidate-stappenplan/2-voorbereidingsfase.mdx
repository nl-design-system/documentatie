...
import IssuesBekendDoel from "./issues-bekend/_doel.md";
import VariantenBepaaldDoel from "./varianten-bepaald/_doel.md";
import A11yRequirements from "./a11y-requirements/_doel.md";
import AliasesDoel from "./aliases/_doel.md";
import AnatomieDoel from "./anatomie/_doel.md";
import HtmlDoel from "./html/_doel.md";
import ApiDoel from "./api/_doel.md";
import DesignTokensDoel from "./design-tokens/_doel.md";
import SpecsDoel from "./specifications/_doel.md";
import TestcasesDoel from "./testcases/_doel.md";
import CandidatePlanPromotionDoel from "./candidate-plan-promotion/_doel.md";
...
Rond de genoemde uitgeschreven stappen met de substappen gerust gelijktijdig per specifiek item de Voorbereidingsfase af. Handelingen vloeien functioneel en direct over in elkaars stappen. Richt de procedure exact conform deze gelaagde structuur in:
