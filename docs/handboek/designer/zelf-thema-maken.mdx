...
We bieden we vanuit het NL Design System het '[Start-thema](/handboek/huisstijl/themas/start-thema/)' aan. De stijl van dit Start-thema hebben we vastgelegd in een set aan 'basis-tokens'. Deze basis-tokens leven op het ['Common' niveau](/handboek/huisstijl/design-tokens#common-tokens).
...
Op basis van het [Start-thema](/handboek/huisstijl/themas/start-thema) hebben we ook een '[Voorbeeld-thema](/handboek/huisstijl/themas/voorbeeld-thema)' gemaakt. Op die manier kunnen we laten zien hoe je een eigen thema kunt doorvoeren. Het dient als 'voorbeeld'.
