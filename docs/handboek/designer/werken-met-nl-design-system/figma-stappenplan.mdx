...
- [Estafettemodel](/introductie/estafettemodel/)
...
🎥 [Video: Personal access token aanmaken](https://youtu.be/dLB7UONA5-o)
...
- Selecteer de repository waar de tokens van jouw organisatie staan. Staan je tokens in de NL Design System 'themes' repository? Kies dan voor 'themes'.
- Klik bij 'Permissions' op 'Add permissions'.
- Selecteer 'Contents' uit de lijst aan opties.
- Pas de access van Contents aan naar 'Read and write'.
