---
title: Figma migratie-stappenplan
hide_title: true
hide_table_of_contents: true
sidebar_label: Figma migratie-stappenplan
...
🎥 [Video: Bibliotheken dupliceren](https://youtu.be/sFxqBW4_i7k)
...
Publiceer beide bibliotheken daarna nogmaals.
...
Klik soms een tweede keer op ‘Apply to Page’. Zo zie je de aanpassingen direct.
...
Gebruik je in lokale componenten nog onderdelen uit een oude bibliotheek? Denk aan een button, paragraph of icoon. Je herkent deze aan de naam `deprecated-*`.
