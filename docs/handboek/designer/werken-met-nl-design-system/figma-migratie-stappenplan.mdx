...
Het migratie-stappenplan lijkt grotendeels op het algemene [Figma stappenplan](/handboek/designer/figma-stappenplan), maar is uitgebreid met extra uitleg voor iedereen die al eerder met Figma bibliotheken en Tokens Studio heeft gewerkt.
...
- Hernoem deze bestanden naar `deprecated-{naam-van-biblitoheek}`. Zo herken je componenten met een connectie hebben met deze verouderde versie.
...
Gebruik hiervoor [Figma's Swap Library functionaliteit](https://help.figma.com/hc/en-us/articles/4404856784663-Swap-style-and-component-libraries).
...
1. Open het prototype en voeg de huidige versie toe aan [Figma's Version History](https://help.figma.com/hc/en-us/articles/360038006754-View-a-file-s-version-history). Geef deze versie een herkenbare naam, bijvoorbeeld 'Swap Library'. Zo kun je het prototype altijd terugzetten naar deze huidige versie.
1. Maak ook een kopie van het prototype. Dan heb je altijd nog een back-up en kun je 'overwrites' zoals teksten gemakkelijk kopiëren en plakken.
...
![Screenshot toont venster binnen Figma waarmee je je bibliotheken kan beheren. Er staat een cirkel om de knop met de tekst 'View missing libraries'.](https://raw.githubusercontent.com/nl-design-system/documentatie/assets/img_migratie_missing-libraries.png)

- Selecteer de bibliotheek die wordt gemist.

![Screenshot toont venster binnen Figma waarmee je een overzicht krijgt van de bibliotheken die ontbreken. Er staat een cirkel om de bibliotheek met de tekst 'deprecated--NL Design System - Bibliotheek - Voorbeeld'.](https://raw.githubusercontent.com/nl-design-system/documentatie/assets/img_migratie_missing-libraries-overzicht.png)

- Maak gebruik van de Swap Library functionaliteit.

![Screenshot toont venster binnen Figma waarmee je de gebruikte componenten uit de ontbrekende bibliotheek ziet. Er staat een cirkel om een select met de tekst 'Choose library'.](https://raw.githubusercontent.com/nl-design-system/documentatie/assets/img_migratie_swap-library.png)
