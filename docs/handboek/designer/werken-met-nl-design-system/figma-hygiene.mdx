...
:::tip[Tip: houd bibliotheken en bestanden overzichtelijk]

Gebruik comments om vragen te stellen of aantekeningen versiebeheer vast te leggen. Houd verder de bibliotheken en template bestanden vrij van schetsen of losse ideeën en plaats verkenningen, kladjes en experimenten in een apart Schetsboek. Zo blijven bestanden overzichtelijk en wordt de werkwijze voorspelbaar voor iedereen.
...
:::tip[Tip: vermijd termen zoals 'Mobile' en 'Desktop']
...
:::tip[Tip: ontwerp mobile-first]

Begin bij het ontwerpen van templates, componenten en patronen vanuit het mobile-first principe. Dit zorgt ervoor dat je direct duidelijke keuzes maakt in volgorde en prioriteit, omdat de ruimte is beperkt.
...
Per patroon of template wordt er een aparte Page aangemaakt. Denk hierbij aan:
...
#### 4.2.2 Positionering en witruimte
...
- De template staat 80px onder de Page Title.
- Tussen de Small Viewport en Large Viewport van één template zit 80px.
- Tussen verschillende templates zit horizontaal 800px.

:::info[Sections in templates]

Gebruik 'Sections', ook wanneer er slechts 1 template is. Sections zorgen voor een consistente opbouw van de pagina, een opgeruimd overzicht en betere leesbaarheid bij het uitzoomen.

:::

#### 4.2.3 Annotaties

Annotatie stickers kunnen in templates worden gebruikt om aanvullende informatie te geven aan developers. Denk aan een voorstel voor de titel van een pagina.
