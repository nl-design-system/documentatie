...
Maak gebruik van [versiebeheer](https://help.figma.com/hc/en-us/articles/360038006754-View-a-file-s-version-history). Op deze manier kun je eerdere versies bekijken of herstellen. Figma slaat automatisch versies op, maar het is aan te raden om af en toe zelf een versie aan te maken en deze een duidelijke naam te geven.
...
Voor text properties gelden aanvullende naamgevingsregels:

- Text properties bevatten altijd het woord 'Text' in de naam van de property.
- Als een (sub)component één text property bevat, heet deze property 'Text'.
- Als een (sub)component meerdere teksten bevat, blijft de primaire tekst 'Text'. Overige teksten krijgen een beschrijvende naam vóór Text, zoals: 'Caption Text' bij Blockquote.
...
[Bekijk hoe je als designer een component kunt maken in Figma](/handboek/designer/zelf-componenten-maken/)
