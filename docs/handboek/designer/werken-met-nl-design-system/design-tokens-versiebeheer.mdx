...
Breaking changes in design tokens schaden de code van je afnemers. Deze wijzigingen zijn niet achterwaarts compatibel. Hierdoor werkt bestaande code niet meer.

Er gaat iets kapot. Soms is dit duidelijk, zoals verdwenen witruimte. Soms is de fout subtieler en niet direct zichtbaar.

Bij een breaking change hoog je altijd het [major](#major) deel van het versienummer op.
...
Het hernoemen van een design token is ook een breaking change. Dit lijkt een kleine ingreep, maar de impact is groot. In feite doe je twee dingen:

1. Je verwijdert een design token.
1. Je voegt een nieuw design token toe.
...
### Situatie A: in de NL Design System 'themes' repository
