...
Bekijk de video [Changelog voor designers](https://youtu.be/A68Ntz4qlAE) waarin we stap voor stap laten zien hoe je een changeset toevoegt aan een Pull Request en hoe je wijziging uiteindelijk wordt gepubliceerd.
...
Wanneer je een [pull request hebt aangemaakt](/handboek/designer/figma-stappenplan/#pushen-naar-github-en-een-pull-request-aanmaken), geef je met een extra commit aan wat je precies hebt veranderd. De beschrijving die je hierbij opgeeft, wordt opgenomen in de changelog van het package.
