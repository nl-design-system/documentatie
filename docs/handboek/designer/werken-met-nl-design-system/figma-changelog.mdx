...
- Toepassing van design tokens op Focus-ring component aangepast.
  - Bij het toepassen van design tokens op de focus-ring component zijn enkele fouten gemaakt. In deze video leggen we uit hoe je dit zelf kunt nalopen en verbeteren.
