...
Verschillende formulier componenten zijn toegevoegd en opgeschoond.
...
Community component 'Fieldset' van Utrecht is toegevoegd aan de bibliotheek.
...
Community component ‘Password Input’ van Amsterdam is toegevoegd aan de bibliotheek.
...
Community componenten ‘Task Card’ (Action Multiple) en 'Task Navigation' (Action Single) van Den Haag zijn aangepast.
...
Community component ‘Navigation Bar’ van Utrecht is aangepast.
...
Helper componenten hernoemd naar 'Helper\_\*'.
