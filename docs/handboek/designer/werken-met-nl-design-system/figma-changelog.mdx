...
De Slot functionaliteit is toegepast op meerdere componenten, zodat de opbouw beter aansluit op de implementatie in code. Het betreft de componenten: Fieldset, Checkbox Group, Radio Group, Link List, Navigation Bar, Navigation List en Note.
...
De Slot functionaliteit is toegepast op meerdere componenten, zodat de opbouw beter aansluit op de implementatie in code. Het betreft de componenten: Accordion, Action Group, Alert, Breadcrumb Navigation, Data Summary, Description List, Drawer, Figure, Form Field en Form Field Description.
