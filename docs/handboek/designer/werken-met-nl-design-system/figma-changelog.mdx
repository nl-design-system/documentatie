...
Help Wanted component 'Card as Link' is bijgewerkt in de ToDo Bibliotheek. Door deze nieuwe Card as Link zijn de Case Card en de Listbox componenten in de ToDo Bibliotheek overbodig geworden en kunnen worden verwijderd.
