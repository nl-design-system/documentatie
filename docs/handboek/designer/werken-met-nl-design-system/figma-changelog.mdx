...
- Waarde van 'focus-outline-color' en 'box-shadow-color' omgekeerd.
  ...
  - Open Tokens Studio.
  - Ga binnen de Common tokenset op zoek naar de focus kleuren.
  ...
  - Deze wijziging moet op veel verschillende plekken in Figma doorgevoerd worden. Kies daarom in Tokens Studio voor 'Apply to document'.
  - Voer daarna de gebruikelijke stappen uit, zoals; Pull Request maken, Versienummer wijzigen, Bibliotheek publiceren en wijzigingen accepteren in de relevante Figma bestanden.
