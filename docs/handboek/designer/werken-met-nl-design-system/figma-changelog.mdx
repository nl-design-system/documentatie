...
- 'Settings'-icoon in lijn gebracht met de andere iconen (niet langer een stroke).
...
- 'Line-height'-tokens toegepast om visuele voorbeelden van 'Icon' sizing.
  - Open Tokens Studio.
  - Loop de 'Text' in [de visuele voorbeelden van 'Icon' sizing](https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=21502-25752&t=4XR57VAGXKljzCQj-4) na. Je zult zien dat hier de basis-tokens voor 'font-size' al op zijn toegepast.
  - Pas hier ook de bijbehordende basis-tokens voor 'line-height' op toe.
- Design token `todo.form-field-label.column-gap` toegepast op juiste layer.
  - Open Tokens Studio.
  - Selecteer [de layer van het Form Field Label in de component Form Field](https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=958-1936&t=4XR57VAGXKljzCQj-4).
  - Verwijder design token `todo.form-field-label.column-gap`.
  - Selecteer [de layer genaamd 'label'](https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=19018-25014&t=4XR57VAGXKljzCQj-4).
  - Pas hier design token `todo.form-field-label.column-gap` toe via het contextuele menu van Tokens Studio: kies voor 'Spacing' en vervolgens voor 'Gap'.
- 'Line-height'-aanpassing voor Number Badge component.
...
Loop de volgende componenten na per bibliotheek:
