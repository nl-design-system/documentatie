...
- 'Button Group' Community component (incl. design tokens) hernoemd naar 'Action Group'.
  ...
  - Pas de naam van de design tokens aan. Doe dit door met de rechtermuisknop op de tekst 'button-group' te klikken en voor 'rename' te kiezen. Doe dit bij 'Color' én 'Dimension'.
