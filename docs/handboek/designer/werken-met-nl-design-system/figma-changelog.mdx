...
We hebben Community component 'Note' (Spotlight Section) van Utrecht uitgebreid met Type 'Default'. Hiermee is dit component meer in lijn met de mogelijkheden in code en de weergave in Storybook.
...
[Bekijk de video 'Changelog: Type toegevoegd aan Community component 'Alert' van Utrecht'](https://youtu.be/FaqdfRUKuf0) waarin wordt uitgelegd hoe je dit zelf kunt doen.
