...
- Ontbrekende design tokens toegevoegd aan Icon (Community) component.
  - [Bekijk de video 'Changelog: Aanvullende design tokens icon component'](https://youtu.be/8toBRuYFoA0) waarin we uitleggen hoe je dit zelf kunt doen.
...
- Pressed state toegevoegd aan community component Button.
  - [Bekijk de video 'Figma Changelog: Pressed state voor button'](https://youtu.be/9d6h_DxVDqs) waarin we uitleggen hoe je dit zelf kunt doen.
  - Je kunt onderstaande tekst gebruiken voor je Pull Request.
