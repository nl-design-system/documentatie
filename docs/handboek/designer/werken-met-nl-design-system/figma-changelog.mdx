...
### Margin-block-end fix

Margin-block-end is niet gewenst wanneer een Label of Legend wordt aangevuld met een Description. Deze fix zorgt ervoor dat deze witruimte niet langer wordt toegepast vanuit Tokens Studio bij varianten van Form Field en Fieldset met een Description.
