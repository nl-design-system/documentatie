...
Pas je iets aan in de code? Dan moet je een changeset schrijven. Gebruik hiervoor de sjablonen in de [.changeset/README.md](https://github.com/nl-design-system/themes/blob/main/.changeset/README.md).
...
Bekijk een volledig uitgewerkt voorbeeld op de actuele changelogpagina.
...
```md
Subcomponent 'utrecht-accordion-button' is hernoemd naar '\_\_button' binnen Accordion component.
```
