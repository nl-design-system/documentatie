...
Zijn jouw componenten ook relevant voor anderen? Deel ze dan via onze [backlog](https://github.com/nl-design-system/backlog).
...
Figma ondersteunt nu maximaal 6 Connected Projects. Wil je componenten bijdragen aan deze pilot? [Neem contact op met het kernteam](https://nldesignsystem.nl/project/kernteam/) voor een tijdelijke aansluiting.
