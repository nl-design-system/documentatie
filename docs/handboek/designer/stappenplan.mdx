...
Op de pagina ['Changelog Figma'](https://example.com) zie je welke updates zijn doorgevoerd. Wanneer je deze updates doorvoert, bepaal je helemaal zelf. We raden wel aan om dit met enige regelmaat te doen, zodat je zeker weet dat je met de nieuwste versies werkt.
...
Je hebt de huisstijl doorgevoerd, Covers en Readme's aangepast. Lekker bezig geweest, zeg!
...
We zitten natuurlijk niet stil. We voeren geregeld updates door in de Figma bibliotheken én het JSON bestand met design tokens. Omdat je via een URL gekoppeld bent aan het JSON bestand, ben je automatisch up-to-date. Je kunt de Figma bibliotheken 'in sync' houden door de updates die wij doen, ook aan jouw kant door te voeren. Op de pagina ['Changelog Figma'](https://example.com) kun je zien welke updates wij doorvoeren. Wanneer jij deze updates doorvoert, mag je zelf weten. We sturen eens in de 2 maanden een reminder via Slack in het #nl-design-system-designers kanaal.
