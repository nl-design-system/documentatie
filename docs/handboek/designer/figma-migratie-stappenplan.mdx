---
title: Figma mirgatie-stappenplan · Designer · Handboek
hide_title: true
hide_table_of_contents: true
sidebar_label: Figma mirgatie-stappenplan
sidebar_position: 3
pagination_label: Figma mirgatie-stappenplan
description: Een stappenplan dat je kan volgen om te migreren naar de nieuwe Figma bibliotheken van NL Design System.
slug: /handboek/designer/figma-migratie-stappenplan
unlisted: true
---
...
Dit migratie-stappenplan is de 'Big Bieb Sync'. Zoals aangegeven is er zoveel veranderd dat een verse installatie sneller is dan 1-voor-1 aan jouw kant alles aan te passen. Met dit stappenplan helpen we je stap voor stap te migeren.

:::info[Migratie informatie]

Het migratie-stappenplan is grotendeels gelijk aan het algemene [Figma stappenplan](/handboek/designer/figma-stappenplan). Maar dan aangevuld met extra informatie zoals deze omdat je al eerder te maken hebt gehad met Figma bibliotheken en Tokens Studio.

:::

Onderaan deze pagina vind je [extra secties voor migratie](#Extra-secties-voor-migratie) waarbij we met je meedenken over de volgende vraagstukken:
...
In het algemene stappenplan spreken we over 3 doelen en kan men stoppen op het moment dan hun doel is behaald.
...
- [Figma structuur](/handboek/huisstijl/themas/start-thema)
...
🎥 [Video: Nieuwe bibliotheken positioneren](https://youtu.be/AX-z_Rjm3ik)
...
Voor de migratie ga je verder bij '[Zelf een thema doorvoeren](#zelf-een-thema-doorvoeren)'.
...
🎥 [Video: JSON inwisselen](https://youtu.be/aCPGS7WIM-w)
...
Zie je een knop met de tekst 'Enter credentials' staan? Ga dan verder bij '[Tokens Studio koppelen aan JSON](#token-studio-koppelen-aan-json)'.
...
- Kopieer en plak deze Brand tokens vervolgens naar de 'brand' set binnen de nieuwe JSON.

Omdat het Start-thema vrij algemene waardes bevat binnen de basis-tokens is de kans groot dat je aan kleur en typografie tokens voldoende hebt. Daarnaast is het goed om te weten dat je huisstijl-opties ook direct op het Common niveau kan doorvoeren. Verderop in het stappenplan lees je daar meer over.

🎥 [Video: Brand tokens overzetten](https://youtu.be/iA_S4sexh3o)
...
Onderaan deze pagina vind je [extra secties voor migratie](#Extra-secties-voor-migratie) die hierbij kunnen helpen.
...
Je doorloopt dit migratie stappenplan omdat je ooit eerder NL Design System bibliotheken dupliceerde. Wat doe je nu met deze 'oude' bibliotheken? Die gaan we langzaam uitfaseren. In het engels is daar de mooie term 'Deprecation' voor. Doorloop de volgende stappen.

🎥 [Video: 'Oude' bibliotheken uitfaseren](https://youtu.be/Kabhmi-e8Qw)

- Open de 'oude' bibliotheek of bibliotheken.
- Hernoemen deze bestanden naar `deprecated-{naam-van-biblitoheek}`. Zo herken je componenten met een connectie naar deze verouderde versie.
- Plak een grote 'Depricated' sticker op de Cover.
- Publiceer deze versie.
- '[Unpublish](https://help.figma.com/hc/en-us/articles/360039236853-Unpublish-a-library)' nu de bibliotheek of bibliotheken.
...
Sowieso zul je de nieuwe bibliotheken willen koppelen.
...
Misschien heb je binnen de lokale componenten gebruik gemaakt van componenten uit een 'oude' bibliotheek. Denk bijvoorbeeld aan een Button, Paragraph of icoon. Je herkent deze componenten aan de verwijzing naar de oude bibliotheek die door de naamswijziging inmiddels begint met `deprecated-*`.

![Screenshot toont Figma waarbij het zichtbaar is dat een component verwijst naar 'oude' bibliotheek](https://raw.githubusercontent.com/nl-design-system/documentatie/assets/img_migratie_deprecated-herkennen.png)

Via de '[Swap instance](https://help.figma.com/hc/en-us/articles/360039150413-Swap-components-and-instances)' functionaliteit kun je deze componenten verwijzen naar de nieuwe bibliotheek.

![Screenshot toont Figma waarbij gebruik wordt gemaakt van de 'swap instance' funtionaliteit.](https://raw.githubusercontent.com/nl-design-system/documentatie/assets/img_migratie_swap-instance.png)
...
Heb je voor lokale componenten design tokens vastgelegd? Dan leven deze nog in het 'oude' JSON bestand en missen ze in de 'nieuwe'. Laten we ze toevoegen.

🎥 [Video: Design tokens van lokale componenten overzetten](https://youtu.be/SoJ9zK_g35g)

- Open Tokens Studio in een ander bestand zodat je je 'oude' JSON kunt bekijken.
- Kopieer de design tokens sets van je lokale componenten.
- Ga terug naar je lokale bibliotheek en voeg de design tokens van je lokale componenten toe.
- Verwijs de design tokens naar de juiste Common tokens.
- Push de wijzigingen naar GitHub en maak een Pull Request aan.

### Wat doe ik met mijn prototypes?

Heb je prototypes gemaakt dan heb je dat gedaan op basis van de 'oude' Figma bibliotheken. Wat je met deze prototypes gaan doen hangt er vanaf...

- Is het een prototype waar je niks meer mee gaat doen? Laat ze dan staan zoals ze zijn.
- Is het een prototype waar je nog wel iets meer gaat doen of zelfs actief mee bezig bent? Dan gaan we de nieuwe bibliotheken een het prototype koppelen.
...
Laten we er eerst voor zorgen dat je sowieso niks kwijt raakt.

1. Open het prototype en voeg de huidige versie toe aan de [Figma's Version History](https://help.figma.com/hc/en-us/articles/360038006754-View-a-file-s-version-history). Geef deze versie een herkenbare naam bijvoorbeeld 'Swap Library'. Op die manier kun je het prototype altijd terugzetten naar deze huidige versie.
1. Maak ook een kopie van het prototype. Dan heb je altijd nog een back-up en kun je 'overwrites' zoals teksten gemakkelijk kopiëren/plakken.

Ok laten we er nu voor zorgen dat je prototype gekoppeld wordt aan de 'nieuwe' bibliotheken.

- Open het prototype.
- Voeg de nieuwe bibliotheken toe.
- Omdat de 'oude' bibliotheken niet langer beschikbaar zijn worden deze 'gemist'.
- Klik op 'View missing libraries'

![Screenshot toont ...](https://raw.githubusercontent.com/nl-design-system/documentatie/assets/img_migratie_missing-libraries.png)

- Selecteer de bibliotheek die wordt gemist.

![Screenshot toont ...](https://raw.githubusercontent.com/nl-design-system/documentatie/assets/img_migratie_missing-libraries-overzicht.png)

- Maak gebruik van de Swap Library functionaliteit.

![Screenshot toont ...](https://raw.githubusercontent.com/nl-design-system/documentatie/assets/img_migratie_swap-library.png)

Loop voor alle zekerheid de componenten steekproefgewijs langs om te zien of er nog steeds een connectie is met een 'oude' bibliotheek. Je herkent deze componenten aan de verwijzing naar de oude bibliotheek die door de naamswijziging inmiddels begint met `deprecated-*`.
