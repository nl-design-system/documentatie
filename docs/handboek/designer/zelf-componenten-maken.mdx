...
- Noem het component ‘[organisatie]-demo-sticker’.
...
Gebruik de [documentatie over de ruimte](https://www.nldesignsystem.nl/richtlijnen/stijl/ruimte). Hierin staat informatie over de spacing scale en concepten.
...
- Pas auto-layout toe het component met varianten. Kies 48px voor de vertical gap, horizontal padding en vertical padding.
