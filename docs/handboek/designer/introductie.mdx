...
Ontbreekt de component die jouw organisatie nodig heeft? Controleer eerst of deze al voorkomt in de [GitHub Discussions](https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions) en of het [Help Wanted stappenplan](/handboek/estafettemodel/componenten/help-wanted) voor deze component is gevolgd.

Is dat nog niet gebeurd, start dan met het Help Wanted stappenplan. Wil je de component beschikbaar maken voor de community, ontwikkel dan als organisatie zelf componenten volgens de aanpak van NL Design System. Volg hierbij de afspraken en richtlijnen zodat nieuwe componenten naadloos aansluiten bij de rest van het design system.

Volg vervolgens het [Community stappenplan](/handboek/estafettemodel/componenten/community/voor-organisaties) zodat jouw component zichtbaar wordt voor anderen.

Deel daarna jouw component met de community. Dat kan via Slack en de [GitHub Discussion van de component](https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions).
