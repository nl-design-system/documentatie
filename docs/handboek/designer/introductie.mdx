...
- Sluit aan bij de [Slack omgeving](/slack/). NL Design System heeft hier meerdere Slack-kanalen. Specifiek voor designers is dat: [#nl-design-system-designers](https://codefornl.slack.com/archives/C01D78C2E4E). Mag jij geen Slack gebruiken? Laat het weten aan het [kernteam](/project/kernteam).
