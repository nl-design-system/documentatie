...
- Sluit aan bij de [Slack omgeving](/slack/). NL Design System heeft hier meerdere Slack-kanalen. Specifiek voor designers is dat op [Slack](/slack) in het kanaal `#nl-design-system-designers`. Mag jij geen Slack gebruiken? Laat het weten aan het [kernteam](/project/kernteam).
