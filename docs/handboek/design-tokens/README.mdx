...
Baseer de naam van het component (block) of onderdeel van het component (element), indien mogelijk, op herkenbare termen uit webstandaarden. Liever termen uit HTML, CSS, SVG en WAI-ARIA dan uit 'UI frameworks' die op het moment populair zijn.
...
[Meer informatie over Figma structuur en gebruik](../designer/figma-structuur.mdx)
