...
Voorbereiding op dit stappenplan vindt plaats in losse projectborden per community design system.

- [Projectenbord Amsterdam](https://github.com/orgs/nl-design-system/projects/48)
- [Projectenbord RVO](https://github.com/orgs/nl-design-system/projects/49/views/1)
- [Projectenbord Utrecht](https://github.com/orgs/nl-design-system/projects/36)
...
De component moet beschikbaar zijn als [NPM package](https://www.npmjs.com/). Minimaal als HTML/CSS.
...
Doel: De component voldoet aan verwachting bij naam en doel.
...
**🚩 Checkpoint**: Implementatie voldoet aan naam en doel zoals beschreven voor het [component](https://www.nldesignsystem.nl/componenten/).
...
Zorg ervoor dat de prefix van jouw organisatie zoals bijvoorbeeld `utrecht-` of `ams-` is toegevoegd aan onderstaande onderdelen. Of controleer de organisaties die aan de GitHub Discussion van het component zijn toegevoegd.
...
Door met [design tokens](/handboek/design-tokens/) te werken zorgen we ervoor dat meerdere organisaties de component van een eigen huisstijl kunnen voorzien.

Zorg ervoor dat er design tokens beschikbaar zijn als de implementatie design beslissingen bevat voor typografie en kleur. Of controleer de implementaties van organisaties die aan de GitHub Discussion van de component zijn toegevoegd.
...
Zijn er, naast kleur en typografie, ook andere design beslissingen als design tokens beschikbaar? Prima!

**🚩 Checkpoint**: Implementatie bevat minimaal design tokens voor kleur en typografie.

## Naamgeving design tokens

Doel: Een voorspelbare naamgeving van design tokens.

Voor NL Design System zijn er afspraken gemaakt voor duidelijke en voorspelbare namen van design tokens op component niveau. De beschikbare design tokens van een component moeten daarom voldoen aan [de naamgeving conventie van NL Design System](https://www.nldesignsystem.nl/handboek/design-tokens/#naamgeving). Zo is een component herbruikbaar voor alle verschillende thema's.
...
**🚩 Checkpoint**: Component heeft Openbare Licentie van de Europese Unie (EUPL-1.2).
