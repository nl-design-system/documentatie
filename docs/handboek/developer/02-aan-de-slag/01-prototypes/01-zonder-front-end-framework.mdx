---
title: Prototypes zonder front-end framework
description: In dit voorbeeld bouw je met NL Design System in een paar stappen een pagina met alleen HTML en wat CSS
hide_title: true
hide_table_of_contents: false
sidebar_label: Prototypes zonder front-end framework
pagination_label: Prototypes zonder front-end framework
slug: /handboek/developer/prototypes/zonder-front-end-framework/
---
...
<SkipLink href="#stappenplan-overslaan">Voorbeeld overslaan</SkipLink>

<div className="utrecht-root" style={{ zoom: "50%", width: "100%", height: "1024px" }}>
  <div className="utrecht-body">
    <iframe
      title="Voorbeeld HTML pagina"
      style={{ width: "100%", height: "1024px", border: "2px solid #000000" }}
      src="/examples/zonder-front-end-framework.html"
    ></iframe>
  </div>
</div>
...
<SkipLink href="#stap-4-importeer-nl-design-system-voorbeeld-thema">Voorbeeld overslaan</SkipLink>
...
<div className="utrecht-root" style={{ zoom: "50%", width: "100%", height: "1024px" }}>
  <div className="utrecht-body">
    <iframe
      title="Voorbeeld HTML pagina"
      style={{ width: "100%", height: "1024px", border: "2px solid #000000" }}
      src="/examples/zonder-front-end-framework-html-only.html"
    ></iframe>
  </div>
</div>
