---
title: CDN gebruiken
description: Zelf dependencies hosten is aanbevolen, maar in sommige situaties is een CDN handig hier lees je hoe dat met NL Design System kan
hide_title: true
...
Upgrade je prototype eerst naar de laatste versies van dependencies, wanneer je gebruik wilt maken van de nieuwste mogelijkheden. Let op dat door [breaking changes](/handboek/developer/semver-conventie/) het prototype kapot kan gaan, wanneer het versienummer voor de punt hoger wordt!
