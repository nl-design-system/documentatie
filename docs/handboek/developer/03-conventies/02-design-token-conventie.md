...
slug: /handboek/developer/design-token-conventie/
keywords:
  - api
  - design token
---
...
- `nl.nldesignsystem.css-property-syntax`: een string of array met [CSS syntax descriptors](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/At-rules/@property/syntax). We gebruiken deze waarde om een handige design token editor te genereren, en om [`@property` definities](https://developer.mozilla.org/en-US/docs/Web/CSS/@property) te genereren voor CSS.
