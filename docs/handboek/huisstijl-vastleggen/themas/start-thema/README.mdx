...
#### Basis-tokens overzicht

Een uitgebreid overzicht van alle basis-tokens en hun waarden kun je vinden op deze pagina's:

- [Kleuren](./start-thema/kleuren)
- [Typografie](./start-thema/typografie)
- [Borders](./start-thema/borders)
- [Sizing](./start-thema/sizing)
- [Spacing](./start-thema/spacing)
- [Form-controls](./start-thema/form-controls)
- [Focus](./start-thema/focus)
- [Shadow](./start-thema/shadow)
