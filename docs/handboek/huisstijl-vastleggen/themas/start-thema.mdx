...
Als we het hierbij zouden laten, zouden alle componenten subtiel getint blijven. In sommige gevallen wil je juist componenten 'stevig' neerzetten. Denk aan een primaire knop die de aandacht moet trekken, of een [Page Footer](/page-footer) die je visueel duidelijk wilt scheiden van de content erboven.
