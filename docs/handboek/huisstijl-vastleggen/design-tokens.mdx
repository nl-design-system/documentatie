...
![De kleur #1B59A4 verwijst naar 'org.kleur.donkerblauw' met het label 'Brand'.](https://raw.githubusercontent.com/nl-design-system/documentatie/assets/img_design-tokens_brand.png)
...
![De kleur #1B59A4 verwijst naar 'org.kleur.donkerblauw' met het label 'Brand'. 'org.kleur.donkerblauw' verwijst naar 'basis.color.action-1-inverse.bg-default' met het label 'Common'.](https://raw.githubusercontent.com/nl-design-system/documentatie/assets/img_design-tokens_common.png)
...
- Wijzigen op één plek: een wijziging in een Brand of Common token kan automatisch doorwerken naar alle componenten die deze gebruiken.
- Duidelijke betekenis: ieder niveau heeft een eigen verantwoordelijkheid. Brand bepaalt de beschikbare waarden, Common geeft ze een betekenis en Component bepaalt hoe ze worden toegepast.

Zo blijven huisstijlkeuzes centraal beheerd, ontwerpkeuzes consistent en componenten herbruikbaar.
