...
Het doel van dit succescriterium is om gebruikers te informeren over statusberichten die geen focus krijgen, en dit zo te doen dat de melding niet onverwacht het werk van de gebruiker onderbreekt bijvoorbeeld door de focus naar het bericht te verplaatsen.
...
**Let op**: dit geldt voor statusberichten die getoond worden zonder dat de pagina opnieuw geladen wordt.
