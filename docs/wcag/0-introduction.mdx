...
import FooterInfo from "./_wcag_footer_info.md";

# Introductie WCAG-pagina's

In deze pagina's vind je [<span lang="en">Web Content Accessibility Guidelines 2.2</span>](https://www.w3.org/Translations/WCAG22-nl/) (WCAG 2.2) beschreven en uitgelegd.
