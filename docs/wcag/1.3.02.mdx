...
import disclaimer from "./_wcag-disclaimer.md?raw";
import wcagFooterInfo from "./_wcag_footer_info.md?raw";
...
- [1.3.1 Info en relaties](https://nldesignsystem.nl/wcag/1.3.1/): de structuur van de content moet programmatisch bepaalbaar zijn.
- [2.4.3 Focusvolgorde](https://nldesignsystem.nl/wcag/2.4.3/): de volgorde van interactieve elementen bij toetsenbordnavigatie.
- [4.1.2 Naam, rol, waarde](https://nldesignsystem.nl/wcag/4.1.2/): interactieve elementen moeten correct zijn geprogrammeerd.
...
<SpotlightSection>
  <Markdown omitH1 headingLevel={3} content={disclaimer} />
</SpotlightSection>

## Help richtlijn verbeteren

<Markdown omitH1 headingLevel={3} content={wcagFooterInfo} />
