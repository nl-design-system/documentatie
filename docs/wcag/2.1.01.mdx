...
- Het activeren of bedienen van elementen moet ook met het toetsenbord kunnen.
  ...
  - Een knop is daarnaast ook te activeren met de <kbd>spatiebalk</kbd>.
...
Termen als `onClick` in de JavaScript-code kunnen duiden op problemen.
...
Net als cookiemeldingen staan feedback- en chatknoppen vaak aan het eind van de code van een pagina. Ze zijn daarmee ook moeilijk te bereiken. Door deze knoppen in de pagina te verwerken zullen ze minder snel gemist worden. Dit kan als alternatief. De bestaande knoppen kunnen blijven bestaan.
