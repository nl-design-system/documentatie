...
- Binnen een onderdeel zijn soms de pijltjestoetsen nodig. Denk hierbij aan groeperingen zoals radio-buttons, tabbladen en kalenders. Een groot onderdeel zoals een kalender is bereikbaar met <kbd>tab</kbd>. Losse dagen zijn daarna bereikbaar met pijltjestoetsen.
- Het activeren of bedienen van elementen moet ook met het toetsenbord kunnen.
  ...
  - Een formulier kan soms vanuit een element verzonden worden met <kbd>return/enter</kbd>. Dit heet [<span lang="en">implicit submission</span>](https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#implicit-submission).
