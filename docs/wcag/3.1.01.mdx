...
- [3.1.2 Taal van onderdelen](https://nldesignsystem.nl/wcag/3.1.2/): als een passage in een andere taal is geschreven dan de rest van de pagina, geeft een `lang`-attribuut op dat element de afwijkende taal aan. Lees hier meer als je pagina's hebt met gemengde talen.
...
- [Understanding SC 3.1.1: Language of Page](https://www.w3.org/WAI/WCAG22/Understanding/language-of-page.html) — de W3C-uitleg bij het succescriterium, met technieken en voorbeelden (Engels).
- [Quick Reference 3.1.1 Language of Page](https://www.w3.org/WAI/WCAG22/quickref/#language-of-page) — snelreferentie met technieken (Engels).
