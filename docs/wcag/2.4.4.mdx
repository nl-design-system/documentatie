...
'Klik hier' is de slechtste linktekst die er is. Alle gebruikers moeten eerst de hele zin lezen om te weten waar de link naar toe gaat.
Een goede tweede is het linken van een hele URL, zoals in 'Lees verder op [https://nl.wikipedia.org/wiki/Waddenzee](https://nl.wikipedia.org/wiki/Waddenzee)'.
