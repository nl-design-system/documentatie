...
title_sm: 1.3.5 Identificeer het doel van de input
hide_title: true
...
Alleen invoervelden die persoonlijke gegevens van de bezoeker verzamelen, hebben dit attribuut nodig. Bekijk de volledige [lijst met geldige waarden](https://www.w3.org/Translations/WCAG22-nl/#input-purposes).
...
<Guideline appearance="dont" title="Adresvelden zonder autocomplete">
    ...
    <label for="street-address">Straat en huisnummer</label>
...
<Guideline appearance="dont" title="Verkeerde autocomplete-waarde">
    ```html
    <label for="family-name">Achternaam</label>
    <input type="text" id="family-name" autocomplete="given-name" />
    ```
</Guideline>
...
<Guideline appearance="do" title="Correcte autocomplete-waarde">
  ```html
  <label for="family-name">Achternaam</label>
  <input type="text" id="family-name" autocomplete="family-name" />
  ```
</Guideline>

**Wie kan dit oplossen:** een developer controleert de `autocomplete`-waarde van elk veld met de [lijst met geldige waarden](https://www.w3.org/Translations/WCAG22-nl/#input-purposes).
...
<Guideline appearance="dont" title="Betaalvelden zonder autocomplete">
    ...
    <label for="card-holder-name">Naam op de kaart</label>
...
<Guideline appearance="do" title="Betaalvelden met autocomplete">
    ...
    <label for="expiry-date">Vervaldatum</label>
    <input type="text" id="expiry-date" autocomplete="cc-exp" />

    <label for="card-holder-name">Naam op de kaart</label>
    <input type="text" id="card-holder-name" autocomplete="cc-name" />
    ```
...
3. Test een inlogpagina. Biedt de browser of wachtwoordmanager de opgeslagen gegevens aan?
...
4. Gebruik <span lang="en">axe DevTools</span> of <span lang="en">Lighthouse</span> voor een eerste scan. Die tools herkennen ontbrekende `autocomplete`-attributen op veelvoorkomende veldtypen automatisch.
