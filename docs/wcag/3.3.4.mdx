...
sidebar_label: WCAG Succescriterium 3.3.4 Foutpreventie (wettelijk, financieel, gegevens)
...
- **Annuleerbaar**: Geef de gebruiker de mogelijkheid om de inzending of transactie terug te draaien.
