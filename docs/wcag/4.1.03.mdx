...
Er zijn twee gangbare oplossingen. De eerste verplaatst de focus naar de foutmelding zodat de screenreader hem direct voorleest — de bezoeker komt ook visueel bij het bericht uit. De tweede maakt de container een live region met `role="alert"`; de focus blijft staan, maar de melding wordt voorgelezen. Kies één van beide; gebruik ze niet tegelijk, anders leest de screenreader het bericht dubbel.
