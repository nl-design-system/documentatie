...
- [1.4.11 Contrast van niet-tekstuele content](https://nldesignsystem.nl/wcag/1.4.11/): een icoon dat als label dient, moet een contrast van minimaal 3:1 hebben ten opzichte van de achtergrond.
