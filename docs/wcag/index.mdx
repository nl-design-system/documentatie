...
De WCAG pagina's op NL Design System geven praktische uitleg en voorbeelden op basis van de nieuwe WCAG 2.2 specificatie. Het doel is om met deze pagina's te helpen bij het toegankelijk inzetten van de NL Design System componenten, patronen en richtlijnen en veelgemaakte fouten te voorkomen.
