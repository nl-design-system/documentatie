...
{/* prettier-ignore */}
<InlineHeadingGroup level={1} suffix={<DataBadge className={'wcag-badge'}>Niveau A</DataBadge>}>WCAG-succescriterium 1.1.1 Niet-tekstuele content</InlineHeadingGroup>
