...
Er zijn verschillende manieren om met hulptechnologie snel door een webpagina te navigeren. Zo kan een gebruiker van een screenreader een lijst van links, koppen of landmarks oproepen en daar een keuze uit maken. Maar de skiplink is ook voor gebruikers van screenreaders handig.
