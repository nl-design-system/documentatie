...
- Controleer of de zichtbare naam onderdeel is van de toegankelijke naam.
...
- Gebruik geen `title`-attributen. Dit attribuut is een soort laatste redmiddel om iets een toegankelijke naam te geven. Het is de laatste in een rij met opties en geeft vaak verkeerde en onverwachte resultaten.
- Wees spaarzaam met het gebruik van `aria-labelledby` en `aria-label`. De eerste regel van ARIA-gebruik stuurt op zo min mogelijk ARIA-gebruik. Ze zijn ook verreweg de makkelijkste manier om te falen voor dit succescriterium. Daarnaast worden deze attributen vaak slecht meegenomen door tools die vertalen.
