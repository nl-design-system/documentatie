...
Als een gebruiker een component focus geeft met het toetsenbord of er overheen hovert met de muis, veroorzaakt dit niet automatisch een contextwijziging.
...
- Tab met het toetsenbord door elk formulierelement.
