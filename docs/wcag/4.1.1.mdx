...
**Let op**: Dit succescriterium is misschien in jouw situatie niet meer van toepassing. Het is in WCAG-versie 2.2 verwijderd. In versie 2.1 is een [opmerking](https://www.w3.org/TR/WCAG21/#h-note-26) toegevoegd dat het criterium automatisch voldoet wanneer HTML of XML wordt gebruikt, maar die is niet ‘normatief’.
