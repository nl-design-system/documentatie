...
Zorg ervoor dat informatie en relaties die zichtbaar zijn, ook worden overgebracht door hulpmiddelen, zoals een screenreader. Dan krijgen niet alleen goed ziende gebruikers alle informatie mee.
...
- Formulieren: [De toegankelijke naam van een button](/richtlijnen/formulieren/buttons#de-toegankelijke-naam-van-een-button).
- Formulieren [Geef een formulierveld toegankelijke naam met een label](/richtlijnen/formulieren/labels#geef-een-formulierveld-toegankelijke-naam-met-een-label).
- Formulieren: [Schrijf een foutmelding uit in tekst](/richtlijnen/formulieren/foutmeldingen#schrijf-een-foutmelding-uit-in-tekst).

- Formulieren: [Maak de succesmelding toegankelijk voor alle gebruikers](https://nldesignsystem.nl/richtlijnen/formulieren/bevestigingspagina/#maak-de-succesmelding-toegankelijk-voor-alle-gebruikers).
