...
title_sm: Global design systems
lang: en
hide_title: true
...
- Estonia: [<span lang="en">TEDI - Estonian Design System</span>](https://tedi.ee/)
- Europe: [<span lang="en">Europa Component Library</span>](https://ec.europa.eu/component-library/)
- Finland [<span lang="en">Finland Design System</span>](https://designsystem.suomi.fi/)
...
- Germany:
  - [<span lang="en">Angie Design System</span>](https://digitalservicebund.github.io/angie/) ([Angie Design System op GitHub](https://github.com/digitalservicebund/angie))
...
- Ireland: [<span lang="en">Ireland Design System</span>](https://github.com/ogcio/govie-ds)
- Italy: [Designers Italia: The Design System for the Italian Public Administration](https://designers.italia.it)
- Norway: [Designsystemet.no](https://designsystemet.no/en/)
...
- Finland — Helsinki: [<span lang="en">Helsinki Design System</span>](https://hds.hel.fi/)
- The Netherlands - Amsterdam: [<span lang="en">Amsterdam Design System</span>](http://designsystem.amsterdam/)
- The Netherlands - Utrecht: [<span lang="en">Utrecht Design System</span>](https://github.com/nl-design-system/utrecht/)
...
- Canada:
  - [<span lang="en">GC Design System</span>](https://design-system.canada.ca/)
  - Ontario: [<span lang="en">Ontario Design System</span>](https://designsystem.ontario.ca)
...
You can find some of these design systems on Slack. [Join us on Slack](/slack), you can find us in the [Slack channel `#global-design-system`](https://codefornl.slack.com/archives/C08N9AJFAG0).
