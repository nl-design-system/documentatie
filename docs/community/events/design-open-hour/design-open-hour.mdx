...
De Design Open Hour is een laagdrempelig online moment voor designers om kennis te delen door design gerelateerde vraagstukken met elkaar te bespreken.

<DefinitionList>
  <Definition>
    <DefinitionTitle>Tijdstip</DefinitionTitle>
    <DefinitionData>Elke oneven week, op dinsdag om 13:00 uur</DefinitionData>
  </Definition>
  <Definition>
    <DefinitionTitle>Locatie</DefinitionTitle>
    <DefinitionData>
      In de Huddle van het <a href="https://codefornl.slack.com/archives/C01D78C2E4E">#nl-design-system-designers</a>
  ...
  <Definition>
    ...
    <DefinitionData>
      <a href="/design-open-hour/design-open-hour.ics">Download het kalenderbestand</a>
    </DefinitionData>
  </Definition>
</DefinitionList>
