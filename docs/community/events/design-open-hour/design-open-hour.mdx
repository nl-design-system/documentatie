...
- **Locatie**: Online de Huddle van het <a href="https://codefornl.slack.com/archives/C01D78C2E4E">#nl-design-system-designers</a> kanaal op Slack.

Door je aan te melden krijg je een kalenderbestand en kunnen wij je op de hoogte houden van Design Open Hours, bijvoorbeeld wanneer deze een keer word verplaatst.
