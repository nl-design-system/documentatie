...
- **Tijdstip**: Elke oneven week, op dinsdag om 13:00 uur.
- **Locatie**: In de Huddle van het <a href="https://codefornl.slack.com/archives/C01D78C2E4E">#nl-design-system-designers</a>-kanaal op <a href="/slack">Slack</a>.
- **Kalenderbestand**: <a href="/design-open-hour/design-open-hour.ics">Download het kalenderbestand</a>.
...
De Design Open Hour vindt plaats op [Slack](/slack) in het kanaal `#nl-design-system-designers`. We gebruiken de Huddle-functie van dat kanaal om elkaar te spreken.
