...
In deze heartbeat vertelt Hidde over de eerstvolgende communitybijeenkomst op vrijdag 18 oktober. Ook stelt ons nieuwe kernteamlid Marjon zich voor. Jaap Hein van Logius vertelt over de Logius hackaton waarbij het design systems team de publieksprijs won. Vervolgens vertelt Bryan de Jong over de Overheidsbrede Community Sprint. Tot slot vertelt Hidde dat de Design Systems Week er weer aankomt! Via de website van NL Design System meld je je aan. 
