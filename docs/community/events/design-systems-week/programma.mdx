...
>
  <Paragraph>
    Wat gebeurt er met tien jaar aan zorgvuldig opgebouwde standaarden op het moment dat iedereen in een paar prompts een werkende interface kan neerzetten?
  </Paragraph>
  <Paragraph>
    AI democratiseert het maken van software. Dat is goed nieuws voor de snelheid, maar slecht nieuws voor consistentie, toegankelijkheid en merk. Een design system dat AI niet kan lezen, bestaat voor AI niet. Het resultaat is dan het gemiddelde van het internet, geverfd in jouw kleuren.
  </Paragraph>
  <Paragraph>
    In deze sessie kijken we hoe de rol van ontwerpers verschuift van maker naar regisseur, waarom het design system daarmee belangrijker is dan ooit, en hoe je het de bron van waarheid maakt voor zowel mens als machine. Aan de hand van een klant-case zie je van begin tot eind hoe een AI Design System je grip laat houden op de kwaliteit van je producten, wat je met AI oppakt en wat je bewust bij mensen laat.
  </Paragraph>
  <Paragraph>
    Een praktische sessie voor designers, developers en design system teams die willen weten hoe ze de regie houden als het tempo van bouwen omhooggaat.
  </Paragraph>
</DSWSession>
...
>
  <Paragraph>
    Designsystemen lossen vaak keer op keer dezelfde problemen op. Wat als we de universele onderdelen zouden kunnen delen? Wat als delen geen belemmering vormt, maar juist ruimte biedt voor uniciteit en identiteit? Deze presentatie gaat over het Noorse project 'Designsystemet' en de aanpak om een ​​framework- en design-agnostische open-source toolkit te bouwen die de basis vormt voor je designsysteem.
  </Paragraph>
  <Paragraph>
    We duiken ook dieper in de vraag hoe het prioriteren van native HTML, CSS en browsergedrag componenten voorspelbaarder, flexibeler en beter combineerbaar maakt. Daarnaast kijken we kritisch naar welke onderdelen van een designsysteem je daadwerkelijk zelf moet beheren en onderhouden.
  </Paragraph>
</DSWSession>
