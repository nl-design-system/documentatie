...
description: Een online evenement georganiseerd door NL Design System met verschillende korte sessies over alles rondom design systems
hide_title: true
...
translations:
  en: /events/design-systems-week/en/
...
{!!isUpComingOrHappening && <Paragraph>Dit is het {settings.nl.edition} jaar dat NL Design System de Design Systems Week organiseert. Kun je niet wachten? Kijk dan de video's van voorgaande jaren terug!</Paragraph>}

{!isUpComingOrHappening && ("Kijk de video's van afgelopen jaren terug.")}
...
NL Design System is een project dat specialisten van verschillende overheidsorganisaties laat samenwerken aan concrete oplossingen voor websites en applicaties. Denk bijvoorbeeld aan code, ontwerp en richtlijnen. Het project wordt uitgevoerd door ICTU, in opdracht van het Ministerie van Binnenlandse Zaken en Koninkrijksrelaties. Zie ook: meer [over NL Design System](/introductie/nl-design-system/) en [Veelgestelde vragen](/project/faq).
