...
<Paragraph lead>
  NL Design System organiseert in {settings.year} voor de {settings.nl.edition} keer de Design Systems Week. Van <strong>{settings.nl.dateRange}</strong> zijn er
  dagelijks meerdere korte sessies van diverse organisaties online te volgen over het <strong>hoe en waarom van design
  systems</strong>.
</Paragraph>
...
{!!settings.isUpcomingOrHappening && (`Dit is het ${settings.nl.edition} jaar dat NL Design System de Design Systems Week organiseert. Kun je niet wachten? Kijk dan de video's van voorgaande jaren terug!`)}

{!settings.isUpcomingOrHappening && ("Kijk de video's van afgelopen jaren terug.")}
