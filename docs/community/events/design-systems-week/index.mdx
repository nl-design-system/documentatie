...
{!!isUpComingOrHappening && (`Dit is het ${settings.nl.edition} jaar dat NL Design System de Design Systems Week organiseert. Kun je niet wachten? Kijk dan de video's van voorgaande jaren terug!`)}
