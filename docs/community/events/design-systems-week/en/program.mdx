...
<Paragraph lead>
  <strong>Heads up!</strong> This session has unfortunately been cancelled due to illness. We're looking into whether
  Alain can be rescheduled as a 5th session on Thursday. We'll keep you posted.
</Paragraph>
