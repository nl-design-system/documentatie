...
Door je aan te melden kunnen wij je op de hoogte houden van Rijkshuisstijl Community Open Hours. Je ontvangt dan ook direct een kalenderbestandje, zodat je de Rijkshuisstijl Community Open Hour makkelijk aan je agenda kan toevoegen.

<ActionGroup>
  <ButtonLink href="/events/rijkshuisstijl-community-open-hour/aanmelden" appearance="primary-action">
    {"Meld je aan"}
    <IconChevronRight />
  </ButtonLink>
