...
Vanuit het NL Design System bieden we een Figma bibliotheek aan. Op dit moment zijn we druk bezig om de NL Design System Figma Bibliotheek te vullen met 'Community' componenten. Deze community componenten zijn een-op-een in code beschikbaar.

Zodra een community component in meerdere organisaties succesvol ingezet is zal deze volgens het [estafettemodel](https://github.com/nl-design-system/documentatie/pull/estafettemodel.mdx) door het kernteam opgenomen worden als 'Candidate' en later 'Hall of Fame' component.
