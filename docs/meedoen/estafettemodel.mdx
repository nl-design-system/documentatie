...
Elke status heeft zijn eigen doelen en voor elke toevoeging aan het design system hebben we een Definition of Done dat valideert of we de doelen van een status hebben gehaald. Hieronder beschrijven we deze per status.
...
- Teams kunnen op elkaars onderdeel door ontwikkelen zodat de overlap duidelijk wordt voor doorontwikkeling naar "Candidate".
...
Voldoet aan de checklist tot en met "Candidate". Het kernteam verwacht dat het uiteindelijk een "Hall of Fame" status krijgt. We verwachten dat er nog wijzigen kunnen zijn. Het onderdeel moet nog goed getest worden en stabiel worden gemaakt.
...
- Zichtbaarheid geven tijdens "request for comments" periode. Zo kunnen essentiële aanvulingen en aanpassingen getest worden voordat het onderdeel volledig stabiel moet zijn.
...
Op basis van gebruikersonderzoek of toegankelijkheids richtlijnen is dit onderdeel af te raden. Het zal dus niet opgenomen worden in een van de NL Design System estafette statussen. Indien mogelijk is een alternatief is aangewezen.
