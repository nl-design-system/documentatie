...
title_sm: Over NL Design System
hide_title: true
sidebar_position: 3
...
NL Design System bestaat uit verschillende onderdelen:
...
- Er is ook een [handboek](/introductie/) over het gebruik van NL Design System.
...
Deze aanpak om samen te werken noemen we het ‘[estafettemodel](/introductie/estafettemodel/)’. Hierin krijgen richtlijnen, componenten en patronen een status, die aangeeft hoe ver ze zijn gevorderd. Zo gaan onderdelen van [‘Help Wanted’](/handboek/estafettemodel#help-wanted) naar [‘Community’](/handboek/estafettemodel#community) naar [‘Candidate’](/handboek/estafettemodel#candidate) naar [‘Hall of Fame’](/handboek/estafettemodel#hall-of-fame). Elke stap heeft een eigen checklist, waarmee we kwaliteit waarborgen en bepalen wie wat doet.
...
- Onze richtlijnen worden gebruikt als kennisbank. Ze bevatten concrete adviezen over wat er nodig is en waarom. Er zijn do's en don'ts, uitleg van de [WCAG-succescriteria](/wcag) en tips die verder dan gaan de WCAG.
...
Ben je zelf leverancier en wil je voor klanten met NL Design System aan de slag? Neem dan contact op met het [kernteam](/introductie/contact/), we helpen je graag op weg.

## Wie zijn jullie?

### Kernteam en community

Bij NL Design System werken specialisten uit overheidsorganisaties, van gemeenten tot Rijksoverheid, samen aan betere digitale dienstverlening. Het [kernteam](/introductie/contact/) faciliteert deze samenwerking. Specialisten zijn bijvoorbeeld ontwerpers, ontwikkelaars en onderzoekers. Ze werken in hun organisatie aan specifieke webprojecten en delen hun ervaring in de community.
...
Het kernteam maakt de samenwerking in de community mogelijk, door bijvoorbeeld de generieke architectuur op te zetten, versiebeheer uit te denken en regie te houden op kwaliteit via het [estafettemodel](/introductie/estafettemodel/). Ook helpen ze organisaties en hun leveranciers op weg.
