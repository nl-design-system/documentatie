...
Gebruik een geldige [SPDX license identifier](https://spdx.dev/learn/handling-license-info/) voor de open source licentie. Bijvoorbeeld in een `package.json`:
...
Gebruik een [SPDX license identifier](https://spdx.dev/learn/handling-license-info/) in een comment aan het begin van documentatie. Bijvoorbeeld in Markdown:
