...
Gebruik waar mogelijk gebruik van biometrische identificatie, zoals een vingerafdruk of gezichtsherkenning.
...
Met een password manager is het mogelijk om unieke wachtwoorden te gebruiken voor elke account, die bovendien erg complex zijn.
...
Wanneer je access tokens instelt, zorg dan dat de toegang na een tijdje weer verloopt. Bijvoorbeeld volgende dag al. Of eind van het kwartaal. Maak nooit tokens aan die toegang hebben tot voorbij een einddatum van je contract. Gebruik geen access tokens die nooit verlopen, wanneer er een alternatief is.
