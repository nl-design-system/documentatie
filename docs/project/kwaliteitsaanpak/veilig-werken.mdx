...
Wanneer je access tokens instelt, zorg dan dat de toegang na een tijdje weer verloopt. Bijvoorbeeld volgende dag al. Of eind van het kwartaal. Maak nooit tokens aan die toegang hebben tot voorbij een einddatum van je contract. Gebruik geen access tokens die nooit verlopen.
