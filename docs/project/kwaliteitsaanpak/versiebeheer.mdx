...
Maak wijzigingen in Git altijd via Pull Requests, zodat de kwaliteit gecontroleerd kan worden met [continuous integration](./continous-integration) en [code reviews](./code-reviews).
