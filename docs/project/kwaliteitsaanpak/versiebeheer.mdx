...
Werk in de [nl-design-system organisatie op GitHub](http://github.com/nl-design-system). Push je work-in-progress regelmatig naar GitHub, tenminste elke dag.
...
Gebruik terraform om nieuwe repositories aan te maken in GitHub, en om de instellingen van de repository te beheren. Dat kan via GitOps in de [nl-design-system/terraform repository](http://github.com/nl-design-system/terraform).

## Pull Requests

Maak wijzigingen in Git altijd via Pull Requests, zodat de kwaliteit gecontroleerd kan worden met [continuous integration](./continous-integration) en [code reviews](/kwaliteitsaanpak/code-review/).
...
Lees meer in de terraform repository over [het proces van GitHub gebruikers toevoegen](https://github.com/nl-design-system/terraform/blob/main/docs/adding-users.md).
...
{/* TODO: Lees meer over conventies voor bestanden en directories in het handboek. */}
