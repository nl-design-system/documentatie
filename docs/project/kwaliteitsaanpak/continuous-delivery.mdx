...
Schrijf [release notes](./release-notes.mdx) voor elke wijziging die noemenswaardige impact heeft op gebruikers van de software of de website.
...
Gebruik een GitHub Action voor changeset voor continuous delivery. Lees meer op de NL Design System website: [Versionering: Hoe beheer je pakketversies?](https://nldesignsystem.nl/handboek/developer/changeset-conventie/)
