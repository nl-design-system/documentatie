...
Voor vragen, design of development: meld je gerust op [Slack](/slack) in het kanaal `#nl-design-system`.
...
- **Doe kennis op**: kom naar bijeenkomsten als de tweewekelijkse Heartbeat, Design Systems Week of hackatons. Of word lid van [Slack](/slack) en praat mee in het kanaal `#nl-design-system`.
