...
Voor vragen, design of development: meld je gerust op [Slack](/slack) (kanaal `#nl-design-system`).
...
- **Doe kennis op**: kom naar bijeenkomsten als de tweewekelijkse Heartbeat, Design Systems Week of hackatons. Of word lid van het kanaal `#nl-design-system` op [Slack](/slack).
