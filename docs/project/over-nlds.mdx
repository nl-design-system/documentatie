...
Deze onderdelen ontstaan niet bij het kernteam, maar in de community. Bijvoorbeeld omdat een gemeente of ministerie een specifiek component nodig heeft. Als blijkt dat meer organisaties datzelfde componenten willen gebruiken, wordt er samengewerkt aan een ultieme versie, waarop het kernteam garanties geeft.
