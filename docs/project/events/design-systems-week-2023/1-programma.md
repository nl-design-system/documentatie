...
<DSWSession title="Onze componenten, jouw huisstijl: over design tokens" speaker={speakers.JeffreyLauwers}>
...
<DSWSession title="Trinity: het design system van de KVK" speaker={speakers.KVK}>
...
<DSWSession title="Betere toegankelijkheid met een design system" speaker={speakers.DanielleRameau}>
