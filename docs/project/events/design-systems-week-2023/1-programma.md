...
<DSWSession title="Waarom wij als leverancier werken met NL Design System" speaker={speakers.MartijnRietveld} id="martijn-rietveld">
...
<DSWSession title="Onze componenten, jouw huisstijl: over design tokens" speaker={speakers.JeffreyLauwers} id="jeffrey-lauwers">
...
<DSWSession title="Trinity: het design system van de KVK" speaker={speakers.KVK} id="kvk">
...
<DSWSession title="The GOV.UK Prototype Kit" speaker={speakers.JoeLanman} id="joe-lanman">
...
<DSWSession title="Design Systems & Web Components: what works & what doesn’t" speaker={speakers.DavidDarnes} id="david-darnes">
