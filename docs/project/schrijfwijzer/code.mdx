...
Vermijd patronen en API's die worden afgeraden, om te voorkomen dat mensen de verkeerde aanpak gaan gebruiken. Bijvoorbeeld: gebruik geen `maxlength` voor `input`.
...
Code in code-voorbeelden kunnen automatisch opgemaakt worden met Prettier, dus de witruimte voor inspringing hoef je niet handmatig te optimaliseren.

## Minimale code-voorbeelden

Beperk code-voorbeelden tot een minimum, zodat het makkelijk is om de essentie te begrijpen. Voeg een korte uitleg dat het code-voorbeeld onvolledig is wanneer het risico bestaat dat mensen verkeerde voorbeelden als basis gebruiken.
