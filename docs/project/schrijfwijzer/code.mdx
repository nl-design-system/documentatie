...
Volg [code conventies](../../handboek/developer/03-conventies/index.mdx). Aandachtspunten:
...
Beperk code-voorbeelden tot een minimum, zodat het makkelijk is om de essentie te begrijpen. Voeg een korte uitleg toe dat het code-voorbeeld onvolledig is wanneer het risico bestaat dat mensen verkeerde voorbeelden als basis gebruiken.
