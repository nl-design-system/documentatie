...
Mensen met cognitieve beperkingen, zoals autisme of niet-aangeboren hersenletsel, [gebruiken soms ook een schermlezer](https://webaim.org/projects/screenreadersurvey10/) — bijvoorbeeld wanneer lezen moeite kost, of wanneer luisteren helpt om informatie beter te begrijpen.
...
- [WebAIM - schermlezergebruikersonderzoek (Engels)](https://webaim.org/projects/screenreadersurvey10/)
