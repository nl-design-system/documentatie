...
Linkteksten moeten duidelijk maken waar een link naartoe gaat. Dat helpt iedereen die snel door een pagina scant, en is extra belangrijk voor mensen die niet alle context kunnen zien of horen — bijvoorbeeld omdat ze een screenreader gebruiken, het scherm sterk vergroten, of moeite hebben met lezen.
...
<Guideline
  appearance="do"
  title="Schrijf goede toegankelijke linkteksten waaruit blijkt wat er gebeurt als je erop klikt."
>
  <Canvas language="html">
    {() => (
      <>
        <ul>
          <li>
            Meer informatie staat op de pagina <a href="https://example.com/">Rechten van mensen met een beperking</a>
          </li>
          <li>
            <a href="https://example.com/">Download de rapportage digitale toegankelijkheid 2023 (pdf 400 kB)</a>
          </li>
          <li>
            Stuur een mail naar <a href="https://example.com/">test@test.nl</a>
          </li>
        </ul>
      </>
    )}
...
<Guideline
  appearance="dont"
  title="Onduidelijke linkteksten gebruiken waaruit niet blijkt wat er gebeurt als je erop klikt."
>
  <Canvas language="html">
    {() => (
      <>
        <ul>
          <li>
            <a href="https://example.com/">Klik hier</a> voor meer informatie over de rechten van mensen met een
            beperking
          </li>
          <li>
            <a href="https://example.com/">Lees meer</a> over digitale toegankelijkheid
          </li>
        </ul>
      </>
    )}
