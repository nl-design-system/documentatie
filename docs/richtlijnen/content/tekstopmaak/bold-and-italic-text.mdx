---
title: Vet, schuingedrukt en onderstreept · Content · Richtlijnen
hide_title: true
hide_table_of_contents: false
sidebar_label: Vet, schuingedrukt en onderstreept
pagination_label: Vet, schuingedrukt en onderstreept
description: Vet, schuingedrukt en onderstreept in NL Design System
slug: /richtlijnen/content/betekenisvolle-tekstopmaak/benadrukken
keywords:
  - semantiek
  - tekstopmaak
  - structuur
...
# Vet, schuingedrukt en onderstreept
...
Bij goed gebruik van een CMS wordt de vette of schuingedrukte tekst in [`strong` en `em` elementen](/richtlijnen/stijl/typografie/strong-en-em-elementen) geplaatst. Met deze elementen in de code is de nadruk ook duidelijk voor gebruikers van hulptechnologie.
...
<Guideline appearance="do" title="vette tekst gebruiken om de betekenis van de zin aan te passen.">
  <Canvas language="html">
    {() => (
      <>
        <paragraph>
