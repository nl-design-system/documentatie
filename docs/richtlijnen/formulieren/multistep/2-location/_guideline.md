...
Plaats tekst en uitleg die hoort bij het formulier buiten het `<form>` element. Dus zet informatie over de stappen **boven** en niet **binnen** het `<form>` element. Dan is de kans dat gebruikers van screenreaders deze informatie missen het kleinst. Het waarom staat uitgelegd bij de richtlijn [Koppel een description aan het formulierveld](/richtlijnen/formulieren/descriptions/koppelen).
