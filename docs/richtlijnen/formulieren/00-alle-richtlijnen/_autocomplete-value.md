...
Het gebruik van het juiste `autocomplete`-attribuut is een manier om te voldoen aan het WCAG-succescriterium [1.3.5 Identificeer het doel van de input](https://www.w3.org/WAI/WCAG22/Understanding/identify-input-purpose) (niveau AA).
