...
Deze richtlijn is een opdracht, doe gebruikersonderzoek voor nieuwe formulieren of componenten. Gebruiksvriendelijkheid is afhankelijk van het specifieke doel en de doelgroep van een formulier.
...
- [Jakob’s Law](https://lawsofux.com/jakobs-law/):
  <span lang="en">
    Users spend most of their time on other sites. This means that users prefer your site to work the same way as all
