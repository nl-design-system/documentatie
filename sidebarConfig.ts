  ...
  richtlijnen: [
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'Tekst en taalgebruik',
          link: {
            type: 'generated-index',
            title: 'Tekst en taalgebruik',
            slug: '/richtlijnen/tekst-en-taalgebruik/overzicht',
            keywords: ['Tekst en taalgebruik', 'overzicht'],
          },
          items: [{ type: 'autogenerated', dirName: 'richtlijnen/tekst-en-taalgebruik' }],
        },
        {
          type: 'category',
          label: 'Stijl',
