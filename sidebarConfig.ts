  ...
  handboek: [
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'Handige hulpmiddelen',
          description: 'Handige tools om designs en code op bijvoorbeeld toegankelijkheid te toetsen.',
          link: {
            type: 'generated-index',
          ...
          items: [
            {
              type: 'link',
              href: '/tools/contrast',
              label: 'Contrast controleren',
              description:
                'Vul de voorgrondkleur en achtergrondkleur in als CSS-waarden. Controleer dan voor welke toepassingen je de combinatie kunt gebruiken',
            },
          ],
        },
        {
