  ...
  handboek: [
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'Niveaus van meedoen',
          description:
            'Meedoen met NL Design System op basis van behoefte en beschikbare capaciteit binnen een organisatie',
          link: {
            type: 'doc',
            id: 'handboek/niveaus-van-meedoen/README',
          },
          items: [{ type: 'autogenerated', dirName: 'handboek/niveaus-van-meedoen' }],
        },
        {
          type: 'category',
