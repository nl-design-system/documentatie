...
const ExamplesSVG = () => (
  <svg viewBox="0 0 206 234" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      <main>
        ...
        <div className="container" style={{ paddingBlockEnd: '20px' }}>
          ...
          <Paragraph>
            ...
            <Link to="/community/events/heartbeatevents/heartbeat/videos">overzicht van alle Heartbeats</Link>.
          </Paragraph>
