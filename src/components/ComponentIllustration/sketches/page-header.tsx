...
export const PageHeaderSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_641_2621)">
      ...
      <rect x="397" y="262" width="62.6" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="484.602" y="262" width="84.5" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="572.199" y="262" width="62.6" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="659.801" y="262" width="62.6" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="747.398" y="262" width="62.6" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip2_641_2621)">
        <line
          x1="2"
          y1="-2"
          x2="168.523"
          y2="-2"
          transform="matrix(0.970524 0.241004 -0.776509 0.630106 151 249.903)"
        ...
        <line
          ...
          x2="168.523"
          y2="-2"
          transform="matrix(0.970524 -0.241004 0.776509 0.630106 151.504 291)"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
          strokeLinecap="round"
        />
      ...
      <rect
        ...
        strokeWidth="4"
      />
      <rect x="71" y="230" width="818" height="81" stroke="var(--component-illustration-color, #666)" strokeWidth="4" />
    </g>
    <defs>
