...
export const HeadingSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_640_2676)">
      ...
      <rect x="233" y="262" width="494" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="303" width="494" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="344" width="494" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="385" width="330" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="168" width="330" height="40" rx="20" fill="var(--component-illustration-color, #666)" />
      <path
        d="M130 188L207.449 188M208 187C201.403 185.343 195.769 181 189 181M207.343 187.943C202.95 188.744 199.408 191.095 195.295 192.456C193.139 193.169 190.956 194.001 189.27 195.435"
    ...
    <defs>
      <clipPath id="clip0_640_2676">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_640_2676">
        <rect width="960" height="540" fill="white" />
      </clipPath>
    </defs>
  </svg>
