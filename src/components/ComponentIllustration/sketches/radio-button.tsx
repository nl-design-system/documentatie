...
export const RadioButtonSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_641_2903)">
      ...
      <g clipPath="url(#clip2_641_2903)">
        <circle cx="480" cy="270" r="79" stroke="var(--component-illustration-color, #666)" strokeWidth="8" />
      </g>
      <g clipPath="url(#clip3_641_2903)">
