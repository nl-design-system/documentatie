...
export const CheckboxSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_634_1659)">
      ...
      <g clipPath="url(#clip2_634_1659)">
        <rect x="397" y="187" width="166" height="166" fill="var(--component-illustration-color, #666)" />
      </g>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M523.536 241.464C525.488 243.417 525.488 246.583 523.536 248.536L473.536 298.536C471.583 300.488 468.417 300.488 466.464 298.536L441.464 273.536C439.512 271.583 439.512 268.417 441.464 266.464C443.417 264.512 446.583 264.512 448.536 266.464L470 287.929L516.464 241.464C518.417 239.512 521.583 239.512 523.536 241.464Z"
        fill="var(--component-illustration-background-color, white)"
      />
    </g>
    <defs>
      <clipPath id="clip0_634_1659">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_634_1659">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip2_634_1659">
        <rect width="166" height="166" fill="white" transform="translate(397 187)" />
      </clipPath>
    </defs>
  </svg>
);
