...
export const UnorderedListSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_642_3575)">
      ...
      <g clipPath="url(#clip2_642_3575)">
        <circle cx="241" cy="229" r="8" fill="var(--component-illustration-color, #666)" />
      </g>
      <rect x="265" y="221" width="462" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip3_642_3575)">
        <circle cx="241" cy="270" r="8" fill="var(--component-illustration-color, #666)" />
      </g>
      <rect x="265" y="262" width="462" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip4_642_3575)">
        <circle cx="241" cy="311" r="8" fill="var(--component-illustration-color, #666)" />
      </g>
      <rect x="265" y="303" width="298" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
    </g>
    <defs>
      <clipPath id="clip0_642_3575">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_642_3575">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip2_642_3575">
        <rect x="233" y="221" width="16" height="16" rx="8" fill="white" />
      </clipPath>
      <clipPath id="clip3_642_3575">
        <rect x="233" y="262" width="16" height="16" rx="8" fill="white" />
      </clipPath>
      <clipPath id="clip4_642_3575">
        <rect x="233" y="303" width="16" height="16" rx="8" fill="white" />
      </clipPath>
    </defs>
  </svg>
);
