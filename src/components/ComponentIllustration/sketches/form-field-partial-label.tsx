...
export const FormFieldPartialLabelSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_640_2544)">
      ...
      <rect x="192" y="188" width="120" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="374" y="188" width="120" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="556" y="188" width="120" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect
        x="184"
        y="180"
        width="182"
      ...
      />
      <path
        d="M94 197L171.449 197M172 196C165.403 194.343 159.769 190 153 190M171.343 196.943C166.95 197.744 163.408 200.095 159.295 201.456C157.139 202.169 154.956 203.001 153.27 204.435"
        stroke="var(--component-illustration-color, #666)"
        strokeWidth="4"
        strokeLinecap="round"
