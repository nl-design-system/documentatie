...
export const ActionGroupSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_633_1969)">
      ...
      <rect x="127" y="229" width="330" height="84" rx="16" fill="var(--component-illustration-color, #666)" />
      <rect
        x="172"
        y="263"
        width="240"
      ...
      />
      <rect x="548" y="262" width="240" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect
        x="505"
        y="230"
        width="326"
    ...
    <defs>
      <clipPath id="clip0_633_1969">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_633_1969">
        <rect width="960" height="540" fill="white" />
      </clipPath>
    </defs>
  </svg>
