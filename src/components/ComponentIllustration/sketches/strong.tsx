...
export const StrongSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_641_3321)">
      ...
      <rect x="233" y="221" width="494" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="262" width="223" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="609" y="262" width="118" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="303" width="330" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="464" y="258" width="137" height="24" rx="12" fill="var(--component-illustration-color, #666)" />
    </g>
    <defs>
