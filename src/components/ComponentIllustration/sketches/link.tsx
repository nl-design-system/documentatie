...
export const LinkSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_640_2816)">
      ...
      <rect x="315" y="246" width="330" height="40" rx="20" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip2_640_2816)">
        <path
          d="M325 298L635 298"
