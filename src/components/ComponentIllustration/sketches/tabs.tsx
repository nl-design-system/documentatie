...
export const TabsSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_642_3423)">
      ...
      <rect x="151" y="262" width="132" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="307" y="262" width="132" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="463" y="262" width="132" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip3_642_3423)">
        <rect
          width="132"
          height="8"
          transform="matrix(1 0 0 -1 151 313)"
          fill="var(--component-illustration-color, #666)"
        />
      </g>
    </g>
    <defs>
      <clipPath id="clip0_642_3423">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_642_3423">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip2_642_3423">
        <rect x="151" y="309" width="658" height="4" rx="2" fill="white" />
      </clipPath>
      <clipPath id="clip3_642_3423">
        <rect width="132" height="8" fill="white" transform="matrix(1 0 0 -1 151 313)" />
      </clipPath>
    </defs>
  </svg>
);
