...
export const SwitchSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_641_3352)">
      ...
      <rect x="399" y="230" width="162" height="80" rx="40" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip2_641_3352)">
        <circle cx="521" cy="270" r="34" fill="var(--component-illustration-background-color, white)" />
      </g>
      <rect
        x="399"
        y="230"
    ...
    <defs>
      <clipPath id="clip0_641_3352">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_641_3352">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip2_641_3352">
        <rect x="487" y="236" width="68" height="68" rx="34" fill="white" />
      </clipPath>
    </defs>
  </svg>
);
