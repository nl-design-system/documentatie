...
export const SeparatorSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_641_3110)">
      ...
      <rect x="233" y="345" width="494" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="99" width="494" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="386" width="494" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="140" width="494" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="427" width="330" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="181" width="330" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
    </g>
    <defs>
      <clipPath id="clip0_641_3110">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_641_3110">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip2_641_3110">
        <rect x="151" y="268" width="658" height="4" rx="2" fill="white" />
      </clipPath>
    </defs>
  </svg>
);
