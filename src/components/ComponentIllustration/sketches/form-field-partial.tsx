...
export const FormFieldPartialSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <defs>
      <clipPath id="clip0_640_2611">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_640_2611">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip2_640_2611">
