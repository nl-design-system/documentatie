...
export const FormFieldOptionLabelSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_640_2501)">
      ...
      <g clipPath="url(#clip2_640_2501)">
        <circle cx="357" cy="312" r="19" stroke="var(--component-illustration-color, #666)" strokeWidth="4" />
      </g>
      <rect x="397" y="304" width="248" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip3_640_2501)">
        <circle
          cx="9"
          cy="9"
          r="9"
      ...
      <g clipPath="url(#clip4_640_2501)">
        <rect x="336" y="207" width="42" height="42" fill="var(--component-illustration-color, #666)" />
      </g>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M372.237 218.013C372.921 218.696 372.921 219.804 372.237 220.487L354.737 237.987C354.054 238.671 352.946 238.671 352.263 237.987L343.513 229.237C342.829 228.554 342.829 227.446 343.513 226.763C344.196 226.079 345.304 226.079 345.987 226.763L353.5 234.275L369.763 218.013C370.446 217.329 371.554 217.329 372.237 218.013Z"
        fill="var(--component-illustration-background-color, white)"
      />
      <rect x="397" y="220" width="248" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <path
        d="M521 107L521 184.449M522 185C523.656 178.403 528 172.769 528 166M521.056 184.343C520.255 179.95 517.905 176.408 516.544 172.295C515.83 170.139 514.999 167.956 513.564 166.27"
      ...
      />
      <path
        d="M521 432L521 354.551M520 354C518.344 360.597 514 366.231 514 373M520.944 354.657C521.745 359.05 524.095 362.592 525.456 366.705C526.17 368.861 527.001 371.044 528.436 372.73"
        stroke="var(--component-illustration-color, #666)"
        strokeWidth="4"
        strokeLinecap="round"
        strokeLinejoin="round"
