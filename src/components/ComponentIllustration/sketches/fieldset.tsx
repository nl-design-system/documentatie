  ...
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_637_2145)">
      ...
      <rect
        ...
        strokeDasharray="8 8"
      />
      <g clipPath="url(#clip2_637_2145)">
        <circle cx="275" cy="270" r="19" stroke="var(--component-illustration-color, #666)" strokeWidth="4" />
      </g>
      <g clipPath="url(#clip3_637_2145)">
        <circle cx="275" cy="188" r="19" stroke="var(--component-illustration-color, #666)" strokeWidth="4" />
      </g>
      <g clipPath="url(#clip4_637_2145)">
        <circle cx="275" cy="352" r="19" stroke="var(--component-illustration-color, #666)" strokeWidth="4" />
      </g>
      <rect x="315" y="262" width="320" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="315" y="180" width="240" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="315" y="344" width="240" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip5_637_2145)">
        <circle
          cx="9"
          cy="9"
          r="9"
          transform="matrix(-1 0 0 1 284 179)"
          fill="var(--component-illustration-color, #666)"
        />
      </g>
      <rect x="231" y="52" width="252" height="28" rx="14" fill="var(--component-illustration-color, #666)" />
      <rect
        x="231"
        y="52"
        width="252"
        height="28"
        rx="14"
        stroke="var(--component-illustration-background-color, white)"
        strokeWidth="4"
      />
    </g>
    <defs>
