  ...
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_640_2333)">
      ...
      <rect
        ...
        strokeWidth="4"
      />
      <rect x="233" y="219" width="330" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="173" width="248" height="24" rx="12" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip2_640_2333)">
        <path
          d="M259 289L259 329"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
      ...
      <path
        d="M130 227L207.449 227M208 226C201.403 224.343 195.769 220 189 220M207.343 226.943C202.95 227.744 199.408 230.095 195.295 231.456C193.139 232.169 190.956 233.001 189.27 234.435"
        stroke="var(--component-illustration-color, #666)"
        strokeWidth="4"
        strokeLinecap="round"
