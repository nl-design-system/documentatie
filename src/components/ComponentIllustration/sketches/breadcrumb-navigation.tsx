...
export const BreadcrumbNavigationSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_633_1932)">
      ...
      <rect x="220" y="262" width="120" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M372.586 256.586C373.367 255.805 374.633 255.805 375.414 256.586L387.414 268.586C388.195 269.367 388.195 270.633 387.414 271.414L375.414 283.414C374.633 284.195 373.367 284.195 372.586 283.414C371.805 282.633 371.805 281.367 372.586 280.586L383.172 270L372.586 259.414C371.805 258.633 371.805 257.367 372.586 256.586Z"
      ...
      />
      <rect x="420" y="262" width="120" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M572.586 256.586C573.367 255.805 574.633 255.805 575.414 256.586L587.414 268.586C588.195 269.367 588.195 270.633 587.414 271.414L575.414 283.414C574.633 284.195 573.367 284.195 572.586 283.414C571.805 282.633 571.805 281.367 572.586 280.586L583.172 270L572.586 259.414C571.805 258.633 571.805 257.367 572.586 256.586Z"
        fill="var(--component-illustration-color, #666)"
        stroke="var(--component-illustration-color, #666)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <rect x="620" y="262" width="120" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
    </g>
    <defs>
