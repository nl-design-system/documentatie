  ...
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_640_2408)">
      ...
      <rect
        ...
        strokeWidth="4"
      />
      <rect x="233" y="221" width="330" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="175" width="248" height="24" rx="12" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip2_640_2408)">
        <path
          d="M259 291L259 331"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
