  ...
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_642_3535)">
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M480 335C471.163 335 464 342.163 464 351C464 359.837 471.163 367 480 367C488.837 367 496 359.837 496 351C496 342.163 488.837 335 480 335ZM460 351C460 339.954 468.954 331 480 331C491.046 331 500 339.954 500 351C500 362.046 491.046 371 480 371C468.954 371 460 362.046 460 351Z"
        fill="var(--component-illustration-color, #666)"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M478 343C478 341.895 478.895 341 480 341H480.02C481.125 341 482.02 341.895 482.02 343C482.02 344.105 481.125 345 480.02 345H480C478.895 345 478 344.105 478 343Z"
        fill="var(--component-illustration-color, #666)"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M476 351C476 349.895 476.895 349 478 349H480C481.105 349 482 349.895 482 351V357C483.105 357 484 357.895 484 359C484 360.105 483.105 361 482 361H480C478.895 361 478 360.105 478 359V353C476.895 353 476 352.105 476 351Z"
        fill="var(--component-illustration-color, #666)"
      />
      <g clipPath="url(#clip2_642_3535)">
        <rect x="233" y="187" width="494" height="84" fill="var(--component-illustration-color, #666)" />
      </g>
      <rect
        x="271"
        y="221"
      ...
      />
      <g clipPath="url(#clip3_642_3535)">
        <rect
          x="480"
          y="248"
          width="32"
          height="32"
          transform="rotate(45 480 248)"
          fill="var(--component-illustration-color, #666)"
        />
      </g>
    </g>
    <defs>
      ...
      <clipPath id="clip1_642_3535">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip2_642_3535">
        <rect width="494" height="84" fill="white" transform="translate(233 187)" />
      </clipPath>
      <clipPath id="clip3_642_3535">
        <rect width="32" height="32" fill="white" transform="translate(480 248) rotate(45)" />
      </clipPath>
    </defs>
  </svg>
);
