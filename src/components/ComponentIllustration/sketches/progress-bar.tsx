  ...
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_641_2818)">
      ...
      <rect
        ...
        strokeWidth="4"
      />
      <g clipPath="url(#clip2_641_2818)">
        <rect x="235" y="258" width="288" height="24" fill="var(--component-illustration-color, #666)" />
      </g>
    </g>
    <defs>
