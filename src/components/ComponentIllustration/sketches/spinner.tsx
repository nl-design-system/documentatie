...
export const SpinnerSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_641_3256)">
      ...
      <g clipPath="url(#clip2_641_3256)">
        <path
          d="M480 187C434.16 187 397 224.16 397 270C397 315.84 434.16 353 480 353C525.84 353 563 315.84 563 270C563 254.675 558.847 240.321 551.605 228"
    ...
    <defs>
      <clipPath id="clip0_641_3256">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_641_3256">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip2_641_3256">
