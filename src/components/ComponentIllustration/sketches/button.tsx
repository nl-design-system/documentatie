...
export const ButtonSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_609_1615)">
      ...
      <rect x="315" y="228" width="330" height="84" rx="16" fill="var(--component-illustration-color, #666)" />
      <rect
        x="360"
        y="262"
        width="240"
    ...
    <defs>
      <clipPath id="clip0_609_1615">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_609_1615">
        <rect width="960" height="540" fill="white" />
      </clipPath>
    </defs>
  </svg>
