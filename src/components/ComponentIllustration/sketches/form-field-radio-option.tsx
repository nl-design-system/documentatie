...
export const FormFieldRadioOptionSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_640_2644)">
      ...
      <g clipPath="url(#clip2_640_2644)">
        <circle cx="357" cy="270" r="19" stroke="var(--component-illustration-color, #666)" strokeWidth="4" />
      </g>
      <rect x="397" y="262" width="248" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip3_640_2644)">
        <circle
          cx="9"
          cy="9"
          r="9"
          transform="matrix(-1 0 0 1 366 261)"
