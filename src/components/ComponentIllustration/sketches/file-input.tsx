  ...
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_638_2230)">
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M361.586 254.586C362.367 253.805 363.633 253.805 364.414 254.586L372.414 262.586C373.195 263.367 373.195 264.633 372.414 265.414C371.633 266.195 370.367 266.195 369.586 265.414L365 260.828V276C365 277.105 364.105 278 363 278C361.895 278 361 277.105 361 276V260.828L356.414 265.414C355.633 266.195 354.367 266.195 353.586 265.414C352.805 264.633 352.805 263.367 353.586 262.586L361.586 254.586ZM345 288C345 286.895 345.895 286 347 286H379C380.105 286 381 286.895 381 288C381 289.105 380.105 290 379 290H347C345.895 290 345 289.105 345 288Z"
        fill="var(--component-illustration-color, #666)"
      />
      <rect x="395" y="264" width="210" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect
        x="317"
        y="232"
        width="326"
    ...
    <defs>
      <clipPath id="clip0_638_2230">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_638_2230">
        <rect width="960" height="540" fill="white" />
      </clipPath>
    </defs>
  </svg>
