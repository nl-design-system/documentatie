...
export const SideNavigationSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_641_3152)">
      ...
      <rect x="315" y="98" width="330" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="315" y="180" width="248" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="315" y="344" width="166" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="315" y="426" width="246" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
    </g>
    <defs>
