...
export const VariableHeadingSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_642_3621)">
      ...
      <rect x="233" y="168" width="494" height="40" rx="20" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="258" width="410" height="24" rx="12" fill="var(--component-illustration-color, #666)" />
      <rect x="233" y="344" width="248" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
    </g>
    <defs>
      <clipPath id="clip0_642_3621">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_642_3621">
        <rect width="960" height="540" fill="white" />
      </clipPath>
    </defs>
  </svg>
