...
export const FormFieldCheckboxOptionSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_640_2300)">
      ...
      <g clipPath="url(#clip2_640_2300)">
        <rect x="336" y="249" width="42" height="42" fill="var(--component-illustration-color, #666)" />
      </g>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
