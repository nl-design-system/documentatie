...
export const BlockquoteSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_632_1892)">
      ...
      <rect x="264" y="210" width="463" height="24" rx="12" fill="var(--component-illustration-color, #666)" />
      <rect x="264" y="258" width="463" height="24" rx="12" fill="var(--component-illustration-color, #666)" />
      <rect x="264" y="306" width="299" height="24" rx="12" fill="var(--component-illustration-color, #666)" />
      <rect x="235" y="384" width="160" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip2_632_1892)">
        <path
          d="M234 188L234 352"
