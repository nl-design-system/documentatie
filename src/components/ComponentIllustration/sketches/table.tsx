...
export const TableSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_642_3379)">
      ...
      <rect x="151" y="180" width="84" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="397" y="180" width="84" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="643" y="180" width="84" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <path
        d="M151 150H809V142H151V150ZM809 226H151V234H809V226Z"
        fill="var(--component-illustration-color, #666)"
        mask="url(#path-1-inside-1_642_3379)"
      />
      <rect x="151" y="94" width="126" height="24" rx="12" fill="var(--component-illustration-color, #666)" />
      <rect x="397" y="94" width="126" height="24" rx="12" fill="var(--component-illustration-color, #666)" />
      <rect x="643" y="94" width="126" height="24" rx="12" fill="var(--component-illustration-color, #666)" />
      <rect x="151" y="263" width="150" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="397" y="263" width="150" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="643" y="263" width="150" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <path
        d="M809 309H151V317H809V309Z"
        fill="var(--component-illustration-color, #666)"
        mask="url(#path-9-inside-2_642_3379)"
      />
      <rect x="151" y="345" width="126" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="397" y="345" width="126" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="643" y="345" width="126" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <path
        d="M809 391H151V399H809V391Z"
        fill="var(--component-illustration-color, #666)"
        mask="url(#path-14-inside-3_642_3379)"
      />
    </g>
    <defs>
