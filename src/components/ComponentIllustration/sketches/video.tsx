  ...
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_642_3651)">
      ...
      <rect
        ...
        strokeWidth="4"
      />
      <g clipPath="url(#clip2_642_3651)">
        <circle cx="480" cy="270" r="42" fill="var(--component-illustration-color, #666)" />
      </g>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M468.024 252.254C468.657 251.901 469.431 251.917 470.048 252.297L496.048 268.297C496.64 268.661 497 269.305 497 270C497 270.695 496.64 271.339 496.048 271.703L470.048 287.703C469.431 288.083 468.657 288.099 468.024 287.746C467.392 287.392 467 286.725 467 286V254C467 253.275 467.392 252.608 468.024 252.254ZM471 257.579V282.421L491.184 270L471 257.579Z"
