  ...
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_633_2001)">
      ...
      <rect
        ...
        strokeWidth="4"
      />
      <g clipPath="url(#clip2_633_2001)">
        <line
          x1="2"
          y1="-2"
          x2="365.346"
          y2="-2"
          transform="matrix(0.895612 0.444835 -0.524557 0.851375 315 66.5914)"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
          strokeLinecap="round"
        />
        <line
          ...
          x2="365.346"
          y2="-2"
          transform="matrix(0.895612 -0.444835 0.524557 0.851375 316 230)"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
          strokeLinecap="round"
        />
      ...
      <rect
        ...
        strokeWidth="4"
      />
      <rect x="357" y="260" width="174" height="24" rx="12" fill="var(--component-illustration-color, #666)" />
      <rect x="356" y="310" width="248" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="356" y="342" width="248" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="356" y="425" width="175" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
    </g>
    <defs>
      <clipPath id="clip0_633_2001">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_633_2001">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip2_633_2001">
        <rect x="315" y="63" width="330" height="167" fill="white" />
      </clipPath>
    </defs>
  </svg>
);
