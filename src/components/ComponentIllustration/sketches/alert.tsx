...
export const AlertSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_631_1711)">
      ...
      <g clipPath="url(#clip3_631_1711)">
        <path
          d="M129.5 168.5L143.698 182.698"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
          strokeLinecap="round"
        />
      </g>
      <g clipPath="url(#clip4_631_1711)">
        <path
          d="M121 191H141"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
      ...
      <g clipPath="url(#clip6_631_1711)">
        <path
          d="M830.5 371.5L816.302 357.302"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
          strokeLinecap="round"
        />
      </g>
      <g clipPath="url(#clip7_631_1711)">
        <path
          d="M839 349L819 349"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
      ...
      <g clipPath="url(#clip9_631_1711)">
        <path
          d="M129.5 371.5L143.698 357.302"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
          strokeLinecap="round"
        />
      </g>
      <g clipPath="url(#clip10_631_1711)">
        <path
          d="M152 380L152 360"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
      ...
      <g clipPath="url(#clip11_631_1711)">
        <path
          d="M839 190L819 190"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
      ...
      <g clipPath="url(#clip12_631_1711)">
        <path
          d="M830.5 168.5L816.302 182.698"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
          strokeLinecap="round"
        />
      </g>
      <g clipPath="url(#clip13_631_1711)">
        <path
          d="M808 160L808 180"
          stroke="var(--component-illustration-color, #666)"
          strokeWidth="4"
    ...
    <defs>
      <clipPath id="clip0_631_1711">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_631_1711">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip2_631_1711">
        <rect x="150" y="160" width="4" height="20" rx="2" fill="white" />
      </clipPath>
      <clipPath id="clip3_631_1711">
        <rect
          x="130.914"
          y="167.086"
          width="20.0796"
          height="4"
          rx="2"
          transform="rotate(45 130.914 167.086)"
          fill="white"
        />
      </clipPath>
      <clipPath id="clip4_631_1711">
        <rect x="121" y="189" width="20" height="4" rx="2" fill="white" />
      </clipPath>
      <clipPath id="clip5_631_1711">
        <rect x="810" y="380" width="4" height="20" rx="2" transform="rotate(-180 810 380)" fill="white" />
      </clipPath>
      <clipPath id="clip6_631_1711">
        <rect
          x="829.086"
          y="372.914"
          width="20.0796"
          height="4"
          rx="2"
          transform="rotate(-135 829.086 372.914)"
          fill="white"
        />
      </clipPath>
      <clipPath id="clip7_631_1711">
        <rect x="839" y="351" width="20" height="4" rx="2" transform="rotate(-180 839 351)" fill="white" />
      </clipPath>
      <clipPath id="clip8_631_1711">
        <rect x="121" y="352" width="4" height="20" rx="2" transform="rotate(-90 121 352)" fill="white" />
      </clipPath>
      <clipPath id="clip9_631_1711">
        <rect
          x="128.086"
          y="370.086"
          width="20.0796"
          height="4"
          rx="2"
          transform="rotate(-45 128.086 370.086)"
          fill="white"
        />
      </clipPath>
      <clipPath id="clip10_631_1711">
        <rect x="150" y="380" width="20" height="4" rx="2" transform="rotate(-90 150 380)" fill="white" />
      </clipPath>
      <clipPath id="clip11_631_1711">
        <rect x="839" y="188" width="4" height="20" rx="2" transform="rotate(90 839 188)" fill="white" />
      </clipPath>
      <clipPath id="clip12_631_1711">
        <rect
          x="831.914"
          y="169.914"
          width="20.0796"
          height="4"
          rx="2"
          transform="rotate(135 831.914 169.914)"
          fill="white"
        />
      </clipPath>
      <clipPath id="clip13_631_1711">
        <rect x="810" y="160" width="20" height="4" rx="2" transform="rotate(90 810 160)" fill="white" />
      </clipPath>
    </defs>
  </svg>
);
