...
export const RadioGroupSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_612_1270)">
      ...
      <g clipPath="url(#clip2_612_1270)">
        <circle cx="275" cy="270" r="19" stroke="var(--component-illustration-color, #666)" strokeWidth="4" />
      </g>
      <g clipPath="url(#clip3_612_1270)">
        <circle cx="275" cy="188" r="19" stroke="var(--component-illustration-color, #666)" strokeWidth="4" />
      </g>
      <g clipPath="url(#clip4_612_1270)">
        <circle cx="275" cy="352" r="19" stroke="var(--component-illustration-color, #666)" strokeWidth="4" />
      </g>
      <rect x="315" y="262" width="330" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="315" y="180" width="248" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="317" y="344" width="246" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <g clipPath="url(#clip5_612_1270)">
        <circle
          cx="9"
          cy="9"
          r="9"
