...
export const DotBadgeSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_637_1943)">
      ...
      <g clipPath="url(#clip2_637_1943)">
        <circle cx="323" cy="246" r="8" fill="var(--component-illustration-color, #666)" />
      </g>
      <rect x="151" y="262" width="166" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="397" y="262" width="166" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
      <rect x="643" y="262" width="166" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
    </g>
    <defs>
      <clipPath id="clip0_637_1943">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip1_637_1943">
        <rect width="960" height="540" fill="white" />
      </clipPath>
      <clipPath id="clip2_637_1943">
        <rect x="315" y="238" width="16" height="16" rx="8" fill="white" />
      </clipPath>
    </defs>
  </svg>
);
