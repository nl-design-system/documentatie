  ...
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_637_2190)">
      ...
      <line
        ...
        x2="638.539"
        y2="-2"
        transform="matrix(0.896518 0.443007 -0.526508 0.85017 193 110.237)"
        stroke="var(--component-illustration-color, #666)"
        strokeWidth="4"
        strokeLinecap="round"
      />
      <line
        ...
        x2="638.539"
        y2="-2"
        transform="matrix(0.896518 -0.443007 0.526508 0.85017 194.746 394)"
        stroke="var(--component-illustration-color, #666)"
        strokeWidth="4"
        strokeLinecap="round"
      />
      <rect
        ...
        strokeWidth="4"
      />
      <rect x="360" y="422" width="240" height="16" rx="8" fill="var(--component-illustration-color, #666)" />
    </g>
    <defs>
