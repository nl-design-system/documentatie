...
export const DataBadgeSketch = (props: HTMLAttributes<SVGElement>) => (
  <svg width="960" height="540" viewBox="0 0 960 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_634_2071)">
      ...
      <g clipPath="url(#clip2_634_2071)">
        <rect x="397" y="242" width="166" height="56" fill="var(--component-illustration-color, #666)" />
      </g>
      <rect
        x="418"
        y="262"
