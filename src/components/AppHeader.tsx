...
export const AppHeader = forwardRef(({ showHamburger, showSearchBar, onHamburgerClick, menuItems, children, className }: AppHeaderProps, ref: ForwardedRef<HTMLElement>) => {

		{/* For now use @theme navbar items as this helps maintain the navbar configuration while in beta*/}
	return <nav className={clsx(style['app-header'], { [style['app-header--show-mobile-menu']]: showHamburger }, className)} ref={ref}>
