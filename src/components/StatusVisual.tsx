...
export const StatusVisual = () => {
  return (
    <dl className={clsx('status-visual')}>
      <section className={clsx('status-visual', 'status-visual__status', 'status-visual__status--help-wanted')}>
      ...
      <section className={clsx('status-visual', 'status-visual__status', 'status-visual__status--community')}>
      ...
      <section className={clsx('status-visual', 'status-visual__status', 'status-visual__status--unstable')}>
        <ArrowDown className={clsx('status-visual__connector')} />
      ...
      <section className={clsx('status-visual', 'status-visual__status', 'status-visual__status--stable')}>
        <ArrowDown className={clsx('status-visual__connector')} />
