export const Texts = [
  ...
  },
  {
    ...
    <p>Weet je niet zeker of de afbeelding echt decoratief is? Dit zijn vragen die je jezelf hierbij kunt stellen:</p>
    <ul>
  ...
  },
  {
    ...
    <h3 class="utrecht-heading-3">Voorbeelden van complexe afbeeldingen</h3>
    <ul>
      <li>Grafiek</li>
  ...
  },
  {
    ...
    `,
    additions: ['description-already-present', 'image-clickable'],
  },
  {
    ...
    <h3 class="utrecht-heading-3">Wees voorzichtig met tekst in afbeeldingen</h3>
    <p>Tekst in een afbeelding wordt niet voorgelezen door een screenreader en kan niet worden aangepast aan de behoeften van de bezoeker. Bied daarom altijd een alternatief aan in gewone tekst.</p>
    <p>Soms is een afbeelding van tekst wél gerechtvaardigd, bijvoorbeeld bij een logo of wanneer de typografie onderdeel is van de boodschap.</p>
