 ...
 [5463],
 {
  ...
  43028: (e, n, t) => {
   ...
   var i = t(52676),
    ...
    s = t(21004),
    l = t(33984);
   const c = { title: 'Buttons in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Introductie Buttons', sidebar_position: 1, pagination_label: 'Buttons in een formulier', description: 'Richtlijnen voor het ontwerp en de code van buttons (knoppen) in een formulier.', slug: '/richtlijnen/formulieren/buttons', keywords: ['labels', 'formulier', 'design', 'code'] },
    d = 'Buttons in een formulier',
    a = { id: 'richtlijnen/formulieren/button/README', title: 'Buttons in een formulier | Richtlijnen', description: 'Richtlijnen voor het ontwerp en de code van buttons (knoppen) in een formulier.', source: '@site/docs/richtlijnen/formulieren/button/README.mdx', sourceDirName: 'richtlijnen/formulieren/button', slug: '/richtlijnen/formulieren/buttons', permalink: '/en/richtlijnen/formulieren/buttons', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/button/README.mdx', tags: [], version: 'current', sidebarPosition: 1, frontMatter: { title: 'Buttons in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Introductie Buttons', sidebar_position: 1, pagination_label: 'Buttons in een formulier', description: 'Richtlijnen voor het ontwerp en de code van buttons (knoppen) in een formulier.', slug: '/richtlijnen/formulieren/buttons', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Introductie', permalink: '/en/richtlijnen/formulieren' }, next: { title: 'Buttons in een formulier', permalink: '/en/richtlijnen/formulieren/buttons' } },
    u = {},
