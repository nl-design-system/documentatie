...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  35345: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => j, contentTitle: () => m, default: () => v, frontMatter: () => u, metadata: () => p, toc: () => b });
   var t = i(52676),
    r = i(24785),
    a = i(57716),
    s = i(71595),
   ...
   const u = { title: 'WCAG-succescriterium 2.5.3 Label in Naam', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.3 Label in Naam', pagination_label: 'WCAG-succescriterium 2.5.3 Label in Naam', description: 'Voor bedieningselementen met een zichtbaar label, moet de zichtbare labeltekst aanwezig zijn in of overeenkomen met de toegankelijke naam.', slug: '2.5.3', keywords: ['WCAG'] },
    m = void 0,
    p = { id: 'wcag/2.5.03', title: 'WCAG-succescriterium 2.5.3 Label in Naam', description: 'Voor bedieningselementen met een zichtbaar label, moet de zichtbare labeltekst aanwezig zijn in of overeenkomen met de toegankelijke naam.', source: '@site/docs/wcag/2.5.03.mdx', sourceDirName: 'wcag', slug: '/wcag/2.5.3', permalink: '/en/wcag/2.5.3', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.5.03.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.5.3 Label in Naam', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.3 Label in Naam', pagination_label: 'WCAG-succescriterium 2.5.3 Label in Naam', description: 'Voor bedieningselementen met een zichtbaar label, moet de zichtbare labeltekst aanwezig zijn in of overeenkomen met de toegankelijke naam.', slug: '2.5.3', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', permalink: '/en/wcag/2.5.2' }, next: { title: 'WCAG-succescriterium 2.5.4 Bewegingsactivering', permalink: '/en/wcag/2.5.4' } },
    j = {},
    b = [
  ...
  57716: (e, n, i) => {
   ...
   const s = (e, n) => {
    ...
    d = (e) => {
     ...
     return (0, a.jsx)(t.Z, { components: { ...c(i, r), ...o(s) }, children: n });
    };
  },
  71595: (e, n, i) => {
   i.d(n, { j: () => o });
