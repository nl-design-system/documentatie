 ...
 [3874],
 {
  ...
  3460: (e, n, i) => {
   ...
   const j = (e) => {
    ...
    v = (e) => {
     let { code: n, copy: i = !1, defaultCollapsed: v = !0, children: x, language: b } = e,
      f = "function" == typeof x ? x() : x,
      k = "function" == typeof n ? n() : (0, c.isValidElement)(n) ? n : void 0,
      y = "string" == typeof n ? n : m.uS(k || f),
      [_, w] = (0, c.useState)(y);
     (0, c.useEffect)(() => {
      (async () => {
       (_ = await d.ZP.format(y, { parser: b, plugins: [r.Z, o.ZP, a.ZP, s.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), w(_);
      })();
     }, [y]);
     const z = (0, u.Z)();
     return (0, p.jsxs)("div", {
      ...
      children: [
       f && (0, p.jsx)("div", { className: (0, l.Z)(g["nlds-canvas__example"]), children: (0, p.jsx)(t.pu, { className: "voorbeeld-theme", children: f }) }),
       (0, p.jsx)("div", { className: (0, l.Z)(g["nlds-canvas__toolbar"]), children: (0, p.jsx)(t.zx, { className: (0, l.Z)(g["nlds-canvas__button"], g["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: j, "aria-expanded": !v, "aria-controls": z, children: v ? "Bekijk code" : "Verberg code" }) }),
       (0, p.jsxs)("div", {
        className: (0, l.Z)(g["nlds-canvas__code-block"], !i && g["nlds-canvas__code-block--user-select-none"]),
        id: z,
        hidden: v,
        children: [
         (0, p.jsx)(h.u, { syntax: b, textContent: _, trim: !0 }),
         i &&
          (0, p.jsx)("div", {
