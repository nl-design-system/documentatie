(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [94770],
 {
  70041: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => p, contentTitle: () => a, default: () => f, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => m, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(16391);
   const s = { title: 'Form field radio option', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field radio option', pagination_label: 'Form field radio option', description: ' ', slug: '/form-field-radio-option', sidebar_custom_props: { illustration: 'FormFieldRadioOptionSketch' } },
    a = void 0,
    l = { id: 'componenten/form-field-radio-option/index', title: 'Form field radio option', description: ' ', source: '@site/docs/componenten/form-field-radio-option/index.mdx', sourceDirName: 'componenten/form-field-radio-option', slug: '/form-field-radio-option', permalink: '/en/form-field-radio-option', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-field-radio-option/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form field radio option', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field radio option', pagination_label: 'Form field radio option', description: ' ', slug: '/form-field-radio-option', sidebar_custom_props: { illustration: 'FormFieldRadioOptionSketch' } }, sidebar: 'componenten', previous: { title: 'Form field partial label', permalink: '/en/form-field-partial-label' }, next: { title: 'Heading', permalink: '/en/heading' } },
    u = {},
    d = [
  ...
  16391: (e, t, n) => {
   ...
   const v = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(k), children: [(0, u.jsxs)('div', { className: (0, i.Z)(_, { [x]: t }), children: [(0, u.jsx)('span', { className: w, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(f.aC, { role: 'presentation', children: n }), (0, u.jsx)(f.nv, { children: r })] })] });
    };
   var S = n(14669);
   const z = (e) => {
