...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [8323],
 {
  ...
  79134: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => T, contentTitle: () => P, default: () => U, frontMatter: () => Z, metadata: () => E, toc: () => L });
   var r = t(11527),
    o = t(47214);
   function s(e) {
  ...
  73460: (e, n, t) => {
   ...
   const g = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(r.Tg, { className: h["nlds-canvas__example-surface"], children: (0, m.jsx)(r.BB, { className: (0, o.Z)("utrecht-document--surface", h["nlds-canvas__example-document"]), children: (0, m.jsx)(r.nv, { className: h["nlds-canvas__example-paragraph"], children: n }) }) });
   };
   g.displayName = "ParagraphContainer";
   const j = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(r.Tg, { className: h["nlds-canvas__example-surface"], children: (0, m.jsx)(r.BB, { className: (0, o.Z)("utrecht-document--surface", h["nlds-canvas__example-document"]), children: n }) });
   };
   ...
   const x = (e) => {
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (S = await d.ZP.format(N, { parser: w, plugins: [s.Z, i.ZP, l.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), A(S);
     })();
    }, [N]);
    const G = (0, c.useId)();
    let B = c.Fragment;
    return (
     ...
     (0, m.jsxs)("div", {
      ...
      children: [
       _ && (0, m.jsx)("div", { className: (0, o.Z)(h["nlds-canvas__example"]), children: (0, m.jsx)("div", { className: "voorbeeld-theme", style: y, children: (0, m.jsx)(B, { children: (0, m.jsx)(r.pu, { children: _ }) }) }) }),
       v &&
        (0, m.jsx)("div", {
   ...
   function l(e) {
    ...
    return (
     ...
     (0, i.jsx)(o.y$, {
      ...
      language: t || "",
      children: (e) => {
       let { style: t, tokens: o, getLineProps: s, getTokenProps: l } = e;
       return (0, i.jsx)(r.dn, { style: t, children: o.map((e, t) => (0, i.jsxs)("span", { ...s({ line: e }), children: [n && (0, i.jsx)("span", { children: t + 1 }), e.map((e, n) => (0, i.jsx)("span", { ...l({ token: e }) }, n)), "\n"] }, t)) });
      },
     })
    );
   }
  ...
  30036: (e, n, t) => {
   ...
   const d = (e) => {
    ...
    const h = "Doen",
     ...
     m = u ? "figure" : "div",
     g = u ? "figcaption" : "div";
    return (0, a.jsxs)(m, { className: (0, i.Z)(l["nlds-guideline"], l[`nlds-guideline--${t}`]), id: "string" == typeof n ? n?.toLowerCase().replace(/\s/g, "-") : void 0, children: [(0, a.jsxs)(g, { className: (0, i.Z)(l["nlds-guideline__description"]), children: ["dont" === t ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(s.nv, { className: (0, i.Z)(l["nlds-guideline__badge"], l[`nlds-guideline__badge--${t}`]), children: [(0, a.jsx)(r.Z, { className: l["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: l["nlds-guideline__title"], children: b })] }), (0, a.jsx)(s.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(s.nv, { className: (0, i.Z)(l["nlds-guideline__badge"], l[`nlds-guideline__badge--${t}`]), children: [(0, a.jsx)(o.Z, { className: l["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: l["nlds-guideline__title"], children: h })] }), (0, a.jsx)(s.nv, { children: n })] }), d] }), (0, a.jsx)("div", { className: (0, i.Z)(l["nlds-guideline__example"]), children: c })] });
   };
  },
  47214: (e, n, t) => {
   t.d(n, { Z: () => l, a: () => i });
