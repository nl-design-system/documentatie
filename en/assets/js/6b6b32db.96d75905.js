...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [53038],
 {
  ...
  39309: (e, n, r) => {
   ...
   var l = r(33984);
   const s = { title: 'Geef feedback aan screenreadergebruikers | Foutmeldingen in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Screenreaderfeedback', pagination_label: 'Screenreaderfeedback', description: 'Richtlijnen voor feedback aan screenreadergebruikers van foutmeldingen in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/screenreaderfeedback', keywords: ['labels', 'formulier', 'design', 'code'] },
    o = void 0,
    c = { id: 'richtlijnen/formulieren/error/feedback/README', title: 'Geef feedback aan screenreadergebruikers | Foutmeldingen in een formulier | Richtlijnen', description: 'Richtlijnen voor feedback aan screenreadergebruikers van foutmeldingen in een formulier.', source: '@site/docs/richtlijnen/formulieren/error/7-feedback/README.mdx', sourceDirName: 'richtlijnen/formulieren/error/7-feedback', slug: '/richtlijnen/formulieren/foutmeldingen/screenreaderfeedback', permalink: '/en/richtlijnen/formulieren/foutmeldingen/screenreaderfeedback', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/error/7-feedback/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Geef feedback aan screenreadergebruikers | Foutmeldingen in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Screenreaderfeedback', pagination_label: 'Screenreaderfeedback', description: 'Richtlijnen voor feedback aan screenreadergebruikers van foutmeldingen in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/screenreaderfeedback', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Samenvatting fouten', permalink: '/en/richtlijnen/formulieren/foutmeldingen/samenvatting' }, next: { title: 'Labels in een formulier', permalink: '/en/richtlijnen/formulieren/labels/' } },
    u = {},
    h = [];
   function m(e) {
