  ...
  4460: (e, t, n) => {
   ...
   const v = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    b = (e) => {
     ...
     return (0, l.jsxs)('hgroup', { className: (0, c.Z)(v['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, l.jsx)('h1', { className: (0, c.Z)(v['nlds-inline-heading-group__heading']), children: t }), r && (0, l.jsxs)('p', { className: (0, c.Z)(v['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var k = n(46506),
    f = n(25953);
   const _ = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, c.Z)(x), children: [(0, l.jsxs)('div', { className: (0, c.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: S, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(k.aC, { role: 'presentation', children: n }), (0, l.jsx)(k.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, c.Z)(g['definition-of-done'], e && g[`definition-of-done--${(0, D.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
