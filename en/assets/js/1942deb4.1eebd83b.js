...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  78140: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => u, contentTitle: () => c, default: () => p, frontMatter: () => d, metadata: () => h, toc: () => g });
   var r = i(52676),
    t = i(24785),
    s = i(10757),
    a = i(47277);
   ...
   const d = { title: 'WCAG-succescriterium 4.1.1 Parsen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '4.1.1 Parsen', pagination_label: 'WCAG-succescriterium 4.1.1 Parsen', description: 'Zorg dat er geen fouten in de HTML-code zijn.', slug: '4.1.1', keywords: ['WCAG'] },
    c = 'WCAG-succescriterium 4.1.1 Parsen',
    h = { id: 'wcag/4.1.01', title: 'WCAG-succescriterium 4.1.1 Parsen', description: 'Zorg dat er geen fouten in de HTML-code zijn.', source: '@site/docs/wcag/4.1.01.mdx', sourceDirName: 'wcag', slug: '/wcag/4.1.1', permalink: '/en/wcag/4.1.1', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/4.1.01.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 4.1.1 Parsen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '4.1.1 Parsen', pagination_label: 'WCAG-succescriterium 4.1.1 Parsen', description: 'Zorg dat er geen fouten in de HTML-code zijn.', slug: '4.1.1', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.3.8 Toegankelijke authenticatie (minimum)', permalink: '/en/wcag/3.3.8' }, next: { title: 'WCAG-succescriterium 4.1.2 Naam, rol, waarde', permalink: '/en/wcag/4.1.2' } },
    u = {},
    g = [
