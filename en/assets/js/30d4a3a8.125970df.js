 ...
 [59590],
 {
  ...
  24972: (e, n, l) => {
   ...
   function t(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', (0, o.jsx)(a.X, { appearance: 'do', title: 'Geen placeholder gebruiken als het label duidelijk genoeg is.', children: (0, o.jsx)(s.X, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)(n.label, { for: 'voornaam1', children: 'Je voornaam' }), (0, o.jsx)(n.input, { autocomplete: 'given-name', id: 'voornaam1', name: 'voornaam', type: 'text' })] }) }) }), '\n', (0, o.jsx)(a.X, { appearance: 'dont', title: 'De labeltekst herhalen in de placeholder.', children: (0, o.jsx)(s.X, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)(n.label, { for: 'voornaam2', children: 'Voornaam' }), (0, o.jsx)(n.input, { autocomplete: 'given-name', id: 'voornaam2', name: 'voornaam', placeholder: 'Voornaam', type: 'text' })] }) }) })] });
   }
   function c(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
  ...
  98480: (e, n, l) => {
   ...
   const _ = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (P = await i.ZP.format(Z, { parser: k, plugins: [s.Z, a.ZP, t.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(P);
     })();
    }, [Z]);
    const D = (0, d.useId)();
    let F = d.Fragment;
    return (
     'paragraph' === x ? (F = v) : 'document' === x ? (F = g) : 'surface' === x && (F = b),
     (0, h.jsxs)('div', {
      className: (0, r.Z)(p['nlds-canvas']),
      children: [
       w && (0, h.jsx)('div', { className: (0, r.Z)(p['nlds-canvas__example']), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(F, { children: (0, h.jsx)(o.pu, { children: w }) }) }) }),
       y &&
        (0, h.jsx)('div', {
       ...
       y &&
        (0, h.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, h.jsx)(m.u, { syntax: k, textContent: P, trim: !0 }),
          l &&
           (0, h.jsx)('div', {
    ...
    return (
     ...
     (0, a.jsx)(r.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsx)(o.dn, { style: l, children: r.map((e, l) => (0, a.jsxs)('span', { ...s({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const i = (e) => {
    ...
    const p = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     v = u ? 'figcaption' : 'div';
    return (0, c.jsxs)(h, { className: (0, a.Z)(t['nlds-guideline'], t[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(v, { className: (0, a.Z)(t['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, a.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { className: t['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: t['nlds-guideline__title'], children: m })] }), (0, c.jsx)(s.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, a.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(r.Z, { className: t['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: t['nlds-guideline__title'], children: p })] }), (0, c.jsx)(s.nv, { children: n })] }), i] }), (0, c.jsx)('div', { className: (0, a.Z)(t['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => t, a: () => a });
   ...
   function t(e) {
    let n;
    return (n = e.disableParentContext ? ('function' == typeof e.components ? e.components(r) : e.components || r) : a(e.components)), o.createElement(s.Provider, { value: n }, e.children);
   }
  },
 },
]);
