        ...
        a.forEach(function (a) {
         !(function (a, t) {
          ...
          if (i) {
           ...
           if (!s) {
            var r = {};
            (r[n] = { pattern: /(^|[^\\])\/\*\*[^/][\s\S]*?(?:\*\/|$)/, lookbehind: !0, alias: "comment" }), (s = (i = e.languages.insertBefore(a, "comment", r))[n]);
           }
           if ((s instanceof RegExp && (s = i[n] = { pattern: s }), Array.isArray(s))) for (var o = 0, l = s.length; o < l; o++) s[o] instanceof RegExp && (s[o] = { pattern: s[o] }), t(s[o]);
           else t(s);
          }
         })(a, function (e) {
       ...
       value: function (t, n, i, s) {
        if (t.language === n) {
         ...
         (t.code = t.code.replace(i, function (e) {
          ...
          for (var i, o = r.length; -1 !== t.code.indexOf((i = a(n, o))); ) ++o;
          return (r[o] = e), i;
         })),
           ...
           if ("string" == typeof d || (d.content && "string" == typeof d.content)) {
            ...
            if (g > -1) {
             ...
             var f = u.substring(0, g),
              y = new e.Token(n, e.tokenize(c, t.grammar), "language-" + n, c),
              m = u.substring(g + b.length),
              h = [];
             f && h.push.apply(h, r([f])), h.push(y), m && h.push.apply(h, r([m])), "string" == typeof d ? o.splice.apply(o, [l, 1].concat(h)) : (d.content = h);
            }
