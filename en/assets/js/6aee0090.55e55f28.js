...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [44147],
 {
  ...
  37896: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => _, contentTitle: () => g, default: () => b, frontMatter: () => m, metadata: () => p, toc: () => v });
   var o = l(52676),
    t = l(24785),
    s = l(44585),
    i = l(33376);
   function a(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', (0, o.jsx)(i.X, { appearance: 'do', title: 'Leg het doel uit.', description: 'Met uitleg weet de gebruiker waar die aan toe is.', children: (0, o.jsx)(s.X, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)(n.label, { for: 'email', children: 'E-mailadres' }), (0, o.jsx)(n.p, { id: 'email-description', children: 'We hebben uw e-mailadres nodig om een afspraakbevestiging te kunnen sturen.' }), (0, o.jsx)(n.input, { 'aria-describedby': 'email-description', autocomplete: 'email', id: 'email', type: 'email' })] }) }) }), '\n', (0, o.jsx)(i.X, { appearance: 'dont', title: 'Privacygevoelige informatie vragen zonder uitleg waarom deze gegevens nodig zijn.', children: (0, o.jsx)(s.X, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)(n.label, { for: 'bsn', children: 'Burgerservicenummer' }), (0, o.jsx)(n.input, { id: 'bsn', type: 'text' })] }) }) })] });
   }
   function r(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
   ...
   var u = l(33984);
   const m = { title: 'Leg uit waarom informatie nodig is | Uit te vragen informatie in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Waarom stel je de vraag', pagination_label: 'Waarom stel je de vraag', description: 'Richtlijnen over uitleggen waarom informatie nodig is.', slug: '/richtlijnen/formulieren/vragen/leg-uit-waarom', keywords: ['labels', 'formulier', 'design', 'code'] },
    g = void 0,
    p = { id: 'richtlijnen/formulieren/questions/why/README', title: 'Leg uit waarom informatie nodig is | Uit te vragen informatie in een formulier | Richtlijnen', description: 'Richtlijnen over uitleggen waarom informatie nodig is.', source: '@site/docs/richtlijnen/formulieren/questions/1-why/README.mdx', sourceDirName: 'richtlijnen/formulieren/questions/1-why', slug: '/richtlijnen/formulieren/vragen/leg-uit-waarom', permalink: '/en/richtlijnen/formulieren/vragen/leg-uit-waarom', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/questions/1-why/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Leg uit waarom informatie nodig is | Uit te vragen informatie in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Waarom stel je de vraag', pagination_label: 'Waarom stel je de vraag', description: 'Richtlijnen over uitleggen waarom informatie nodig is.', slug: '/richtlijnen/formulieren/vragen/leg-uit-waarom', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Uit te vragen informatie in een formulier', permalink: '/en/richtlijnen/formulieren/vragen/' }, next: { title: 'Waarom is informatie nodig', permalink: '/en/richtlijnen/formulieren/vragen/check-noodzaak' } },
    _ = {},
    v = [];
   function h(e) {
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', (0, o.jsx)(d, {}), '\n', (0, o.jsx)(r, {}), '\n', (0, o.jsx)(u.ZP, {})] });
   ...
   function b(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
    return n ? (0, o.jsx)(n, { ...e, children: (0, o.jsx)(h, { ...e }) }) : h();
   }
  },
  44585: (e, n, l) => {
   l.d(n, { X: () => b });
   ...
   const b = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (z = await c.ZP.format(Z, { parser: f, plugins: [s.Z, i.ZP, a.ZP, r.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(z);
     })();
    }, [Z]);
    const E = (0, d.useId)();
    let R = d.Fragment;
    return (
     'paragraph' === x ? (R = _) : 'document' === x ? (R = v) : 'surface' === x && (R = h),
     (0, p.jsxs)('div', {
      className: (0, t.Z)(m['nlds-canvas']),
      children: [
       w && (0, p.jsx)('div', { className: (0, t.Z)(m['nlds-canvas__example']), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, p.jsx)(R, { children: (0, p.jsx)(o.pu, { children: w }) }) }) }),
       y &&
        (0, p.jsx)('div', {
       ...
       y &&
        (0, p.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, p.jsx)(g.u, { syntax: f, textContent: z, trim: !0 }),
          l &&
           (0, p.jsx)('div', {
    ...
    return (
     ...
     (0, i.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsx)(o.dn, { style: l, children: t.map((e, l) => (0, i.jsxs)('span', { ...s({ line: e }), children: [n && (0, i.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  33376: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const m = 'Doen',
     ...
     p = u ? 'figure' : 'div',
     _ = u ? 'figcaption' : 'div';
    return (0, r.jsxs)(p, { className: (0, i.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, r.jsxs)(_, { className: (0, i.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(s.nv, { className: (0, i.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(o.Z, { className: a['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: a['nlds-guideline__title'], children: g })] }), (0, r.jsx)(s.nv, { children: n })] }) : (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(s.nv, { className: (0, i.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(t.Z, { className: a['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: a['nlds-guideline__title'], children: m })] }), (0, r.jsx)(s.nv, { children: n })] }), c] }), (0, r.jsx)('div', { className: (0, i.Z)(a['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => a, a: () => i });
