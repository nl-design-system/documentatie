 ...
 [39783],
 {
  62184: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Tabs', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Tabs', pagination_label: 'Tabs', description: 'Paneel om onderwerpen te groeperen, waarbij er maar \xe9\xe9n per keer zichtbaar is, met knoppen om te kiezen welk onderwerp wordt weergegeven.', slug: '/tabs', sidebar_custom_props: { illustration: 'TabsSketch' } },
    a = void 0,
    l = { id: 'componenten/tabs/index', title: 'Tabs', description: 'Paneel om onderwerpen te groeperen, waarbij er maar \xe9\xe9n per keer zichtbaar is, met knoppen om te kiezen welk onderwerp wordt weergegeven.', source: '@site/docs/componenten/tabs/index.mdx', sourceDirName: 'componenten/tabs', slug: '/tabs', permalink: '/en/tabs', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/tabs/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Tabs', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Tabs', pagination_label: 'Tabs', description: 'Paneel om onderwerpen te groeperen, waarbij er maar \xe9\xe9n per keer zichtbaar is, met knoppen om te kiezen welk onderwerp wordt weergegeven.', slug: '/tabs', sidebar_custom_props: { illustration: 'TabsSketch' } }, sidebar: 'componenten', previous: { title: 'Table', permalink: '/en/table' }, next: { title: 'Task list', permalink: '/en/task-list' } },
    u = {},
    d = [
    ...
    h = 'Tabs',
    j = 'Paneel om onderwerpen te groeperen, waarbij er maar \xe9\xe9n per keer zichtbaar is, met knoppen om te kiezen welk onderwerp wordt weergegeven.',
    y = 'TabsSketch',
    m = 51,
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: z, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.aC, { role: 'presentation', children: n }), (0, u.jsx)(v.nv, { children: r })] })] });
    };
   var S = n(14669);
   const D = (e) => {
