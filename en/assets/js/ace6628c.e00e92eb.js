  ...
  4460: (e, t, n) => {
   ...
   const k = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    b = (e) => {
     ...
     return (0, u.jsxs)('hgroup', { className: (0, c.Z)(k['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, u.jsx)('h1', { className: (0, c.Z)(k['nlds-inline-heading-group__heading']), children: t }), r && (0, u.jsxs)('p', { className: (0, c.Z)(k['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var v = n(46506),
    f = n(25953);
   const _ = 'task-list_hh8j',
    ...
    C = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, c.Z)(x), children: [(0, u.jsxs)('div', { className: (0, c.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.aC, { role: 'presentation', children: n }), (0, u.jsx)(v.nv, { children: r })] })] });
    };
   var S = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const i = t && t.projects.filter((e) => S.e9.includes(e.id)),
      a = i && S.e9.map((e) => i.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
    ...
    M = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(b, { level: n, suffix: i && (0, u.jsx)(p.y, { state: i }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
