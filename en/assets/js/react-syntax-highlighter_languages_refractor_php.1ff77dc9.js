         ...
         !(function r(l) {
          for (var o = 0; o < l.length && !(i >= s.length); o++) {
           ...
           if ("string" == typeof d || (d.content && "string" == typeof d.content)) {
            ...
            if (f > -1) {
             ++i;
             var g = p.substring(0, f),
              y = new e.Token(n, e.tokenize(b, t.grammar), "language-" + n, b),
              h = p.substring(f + u.length),
              m = [];
             g && m.push.apply(m, r([g])), m.push(y), h && m.push.apply(m, r([h])), "string" == typeof d ? l.splice.apply(l, [o, 1].concat(m)) : (d.content = m);
            }
