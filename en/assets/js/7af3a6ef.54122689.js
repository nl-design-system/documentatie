 ...
 [3411],
 {
  ...
  73460: (e, n, i) => {
   ...
   const b = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await c.ZP.format(N, { parser: _, plugins: [l.Z, t.ZP, o.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), C(Z);
     })();
    }, [N]);
    const D = (0, d.useId)();
    let A = d.Fragment;
    return (
     "paragraph" === k ? (A = p) : "document" === k ? (A = h) : "surface" === k && (A = j),
     (0, v.jsxs)("div", {
      className: (0, r.Z)(g["nlds-canvas"]),
      children: [
       w && (0, v.jsx)("div", { className: (0, r.Z)(g["nlds-canvas__example"]), children: (0, v.jsx)("div", { className: "voorbeeld-theme", style: y, children: (0, v.jsx)(A, { children: (0, v.jsx)(s.pu, { children: w }) }) }) }),
       x &&
        (0, v.jsx)("div", {
