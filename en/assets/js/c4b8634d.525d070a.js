 ...
 [36360],
 {
  86121: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(81301),
    o = n(23952);
   const s = { title: 'Login Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Login Link', pagination_label: 'Login Link', description: 'Biedt de mogelijkheid om naar de beschikbare inlogmiddelen te navigeren.', slug: '/login-link', keywords: ['button', 'inloggen', 'action'] },
    a = void 0,
    ...
    h = 'Login Link',
    j = 'Biedt de mogelijkheid om naar de beschikbare inlogmiddelen te navigeren.',
    g = 268,
  ...
  23952: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    L = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(_), children: [(0, u.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(v.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var z = n(14669);
   const S = (e) => {
