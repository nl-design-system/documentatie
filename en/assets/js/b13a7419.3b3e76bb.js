 ...
 [94730],
 {
  ...
  98480: (e, n, l) => {
   ...
   const v = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (z = await c.ZP.format(Z, { parser: f, plugins: [i.Z, a.ZP, t.ZP, r.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(z);
     })();
    }, [Z]);
    const E = (0, d.useId)();
    let R = d.Fragment;
  ...
  41179: (e, n, l) => {
   ...
   var a = l(52676);
   function t(e) {
    let { lineNumber: n, syntax: l, textContent: t, trim: r } = e,
     c = t;
    return (
     r && (c = c.trim()),
     (0, a.jsx)(o.y$, {
      ...
      language: l || '',
      children: (e) => {
       let { style: l, tokens: o, getLineProps: i, getTokenProps: t } = e;
       return (0, a.jsx)(s.dn, { style: l, children: o.map((e, l) => (0, a.jsxs)('span', { ...i({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const m = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     g = u ? 'figcaption' : 'div';
    return (0, r.jsxs)(h, { className: (0, a.Z)(t['nlds-guideline'], t[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, r.jsxs)(g, { className: (0, a.Z)(t['nlds-guideline__description']), children: ['dont' === l ? (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(i.nv, { className: (0, a.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(s.Z, { className: t['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: t['nlds-guideline__title'], children: p })] }), (0, r.jsx)(i.nv, { children: n })] }) : (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(i.nv, { className: (0, a.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(o.Z, { className: t['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: t['nlds-guideline__title'], children: m })] }), (0, r.jsx)(i.nv, { children: n })] }), c] }), (0, r.jsx)('div', { className: (0, a.Z)(t['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => t, a: () => a });
