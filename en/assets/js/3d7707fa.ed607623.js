 ...
 [86423],
 {
  52490: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Alert', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Alert', pagination_label: 'Alert', description: 'Trekt de aandacht naar een bericht dat informeert over een status.', slug: '/alert', sidebar_custom_props: { illustration: 'AlertSketch' }, keywords: ['alert', 'banner', 'bericht', 'error', 'feedback', 'foutmelding', 'message', 'notificatie', 'notification', 'warning', 'waarschuwing'] },
    a = void 0,
    l = { id: 'componenten/alert/index', title: 'Alert', description: 'Trekt de aandacht naar een bericht dat informeert over een status.', source: '@site/docs/componenten/alert/index.mdx', sourceDirName: 'componenten/alert', slug: '/alert', permalink: '/en/alert', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/alert/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Alert', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Alert', pagination_label: 'Alert', description: 'Trekt de aandacht naar een bericht dat informeert over een status.', slug: '/alert', sidebar_custom_props: { illustration: 'AlertSketch' }, keywords: ['alert', 'banner', 'bericht', 'error', 'feedback', 'foutmelding', 'message', 'notificatie', 'notification', 'warning', 'waarschuwing'] }, sidebar: 'componenten', previous: { title: 'Action group', permalink: '/en/action-group' }, next: { title: 'Alert dialog', permalink: '/en/alert-dialog' } },
    u = {},
    d = [
    ...
    h = 'Alert',
    j = 'Trekt de aandacht naar een bericht dat informeert over een status.',
    y = 'AlertSketch',
    g = 9,
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [A]: t }), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(k.aC, { role: 'presentation', children: n }), (0, u.jsx)(k.nv, { children: r })] })] });
    };
   var T = n(14669);
   const D = (e) => {
