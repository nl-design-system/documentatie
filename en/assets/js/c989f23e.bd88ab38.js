...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [8267],
 {
  ...
  73460: (e, n, i) => {
   ...
   const x = (e) => {
    let { code: n, copy: i = !1, defaultExpandedCode: x = !0, displayCode: f = !0, children: b, container: k = "document", language: w, designTokens: y } = e,
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (z = await a.ZP.format(N, { parser: w, plugins: [l.Z, o.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), F(z);
     })();
    }, [N]);
    const G = (0, c.useId)();
    let S = c.Fragment;
    return (
     ...
     (0, m.jsxs)("div", {
      ...
      children: [
       _ && (0, m.jsx)("div", { className: (0, t.Z)(h["nlds-canvas__example"]), children: (0, m.jsx)("div", { className: "voorbeeld-theme", style: y, children: (0, m.jsx)(S, { children: (0, m.jsx)(r.pu, { children: _ }) }) }) }),
       f &&
        (0, m.jsx)("div", {
       ...
       f &&
        (0, m.jsxs)("div", {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(p.u, { syntax: w, textContent: z, trim: !0 }),
          i &&
           (0, m.jsx)("div", {
            className: (0, t.Z)(h["nlds-canvas__toolbar"]),
            children: (0, m.jsx)(r.zx, {
