 ...
 [76401],
 {
  24941: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    o = n(16391);
   const s = { title: 'Accordion', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Accordion', pagination_label: 'Accordion', description: 'Secties met de mogelijkheid om gerelateerde content te tonen en weer te verbergen.', slug: '/accordion', sidebar_custom_props: { illustration: 'AccordionSketch' } },
    a = void 0,
    u = { id: 'componenten/accordion/index', title: 'Accordion', description: 'Secties met de mogelijkheid om gerelateerde content te tonen en weer te verbergen.', source: '@site/docs/componenten/accordion/index.mdx', sourceDirName: 'componenten/accordion', slug: '/accordion', permalink: '/en/accordion', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/accordion/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Accordion', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Accordion', pagination_label: 'Accordion', description: 'Secties met de mogelijkheid om gerelateerde content te tonen en weer te verbergen.', slug: '/accordion', sidebar_custom_props: { illustration: 'AccordionSketch' } }, sidebar: 'componenten', previous: { title: 'Overzicht', permalink: '/en/componenten/' }, next: { title: 'Action group', permalink: '/en/action-group' } },
    l = {},
    d = [
