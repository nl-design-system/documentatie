(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [44921],
 {
  65807: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => s, default: () => b, description: () => j, frontMatter: () => a, illustration: () => m, issueNumber: () => g, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const a = { title: 'Breadcrumb navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Breadcrumb navigation', pagination_label: 'Breadcrumb navigation', description: 'Toont de locatie van de pagina binnen de hi\xebrarchie van een website en biedt de mogelijkheid om tussen niveaus te navigeren.', slug: '/breadcrumb-navigation', sidebar_custom_props: { illustration: 'BreadcrumbNavigationSketch' }, keywords: ['back', 'back link', 'breadcrumb navigation', 'breadcrumb trail', 'breadcrumbs', 'broodkruimelpad', 'broodkruimels', 'hi\xebrarchie', 'hierarchy', 'kruimelpad', 'link', 'nav', 'navigation', 'up'] },
    s = void 0,
    u = { id: 'componenten/breadcrumb-navigation/index', title: 'Breadcrumb navigation', description: 'Toont de locatie van de pagina binnen de hi\xebrarchie van een website en biedt de mogelijkheid om tussen niveaus te navigeren.', source: '@site/docs/componenten/breadcrumb-navigation/index.mdx', sourceDirName: 'componenten/breadcrumb-navigation', slug: '/breadcrumb-navigation', permalink: '/en/breadcrumb-navigation', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/breadcrumb-navigation/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Breadcrumb navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Breadcrumb navigation', pagination_label: 'Breadcrumb navigation', description: 'Toont de locatie van de pagina binnen de hi\xebrarchie van een website en biedt de mogelijkheid om tussen niveaus te navigeren.', slug: '/breadcrumb-navigation', sidebar_custom_props: { illustration: 'BreadcrumbNavigationSketch' }, keywords: ['back', 'back link', 'breadcrumb navigation', 'breadcrumb trail', 'breadcrumbs', 'broodkruimelpad', 'broodkruimels', 'hi\xebrarchie', 'hierarchy', 'kruimelpad', 'link', 'nav', 'navigation', 'up'] }, sidebar: 'componenten', previous: { title: 'Blockquote', permalink: '/en/blockquote' }, next: { title: 'Button', permalink: '/en/button' } },
    l = {},
    d = [
    ...
    j = 'Toont de locatie van de pagina binnen de hi\xebrarchie van een website en biedt de mogelijkheid om tussen niveaus te navigeren.',
    m = 'BreadcrumbNavigationSketch',
    g = 54,
  ...
  95929: (e, t, n) => {
   ...
   const a = (e) => {
    ...
    u = (e) => {
     let { href: t, appearance: n, className: a, component: s = 'div', children: u } = e;
     const l = (e) => ('article' === s ? (0, o.jsx)('article', { ...e }) : 'section' === s ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(l, { className: (0, i.Z)(c.cardgroup__card, c[`cardgroup__card--${n}`], a), children: u });
  ...
  60851: (e, t, n) => {
   ...
   var r = n(47027),
    ...
    u = n(32636),
    l = n(52676);
   const d = { figma: (0, l.jsx)(c.Z, {}), github: (0, l.jsx)(o.Z, {}), npm: (0, l.jsx)(a.Z, {}), storybook: (0, l.jsx)(s.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const D = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(m['definition-of-done'], m[`definition-of-done--${(0, T.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
