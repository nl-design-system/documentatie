   ...
   const D = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(g['definition-of-done'], g[`definition-of-done--${(0, F.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
         ...
         children: [
          (0, l.jsx)(A, {
           children: e.tasks.map((e) => {
            ...
            return (0, l.jsx)(S, { checked: t, title: n, description: (0, F.Q6)(r) }, r);
           }),
          }),
