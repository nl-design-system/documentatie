(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [78239],
 {
  48008: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => g, contentTitle: () => a, default: () => v, description: () => j, frontMatter: () => s, illustration: () => m, issueNumber: () => y, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Date input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date input', pagination_label: 'Date input', description: 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.', slug: '/date-input', sidebar_custom_props: { illustration: 'DateInputSketch' }, keywords: ['browser', 'built-in', 'date', 'date field', 'date input', 'date picker', 'date selection', 'datepicker', 'datum', 'datum invoer', 'datumveld', 'form', 'form control', 'formulier', 'formulierelement', 'ingebouwd', 'input', 'input field', 'invoerveld', 'invullen', 'kalender', 'native', 'text field', 'textbox'] },
    a = void 0,
   ...
   const T = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(m['definition-of-done'], m[`definition-of-done--${(0, z.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
