 ...
 [34894],
 {
  19736: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    o = n(60851);
   const s = { title: 'Checkbox', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Checkbox', pagination_label: 'Checkbox', description: ' ', slug: '/checkbox', sidebar_custom_props: { illustration: 'CheckboxSketch' }, keywords: ['aankruisvakje', 'aankruizen', 'check', 'checkbox', 'indeterminate', 'meerkeuze', 'select', 'selecteren', 'selectie', 'selectievakje', 'vinkje'] },
    a = void 0,
    u = { id: 'componenten/checkbox/index', title: 'Checkbox', description: ' ', source: '@site/docs/componenten/checkbox/index.mdx', sourceDirName: 'componenten/checkbox', slug: '/checkbox', permalink: '/en/checkbox', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/checkbox/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Checkbox', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Checkbox', pagination_label: 'Checkbox', description: ' ', slug: '/checkbox', sidebar_custom_props: { illustration: 'CheckboxSketch' }, keywords: ['aankruisvakje', 'aankruizen', 'check', 'checkbox', 'indeterminate', 'meerkeuze', 'select', 'selecteren', 'selectie', 'selectievakje', 'vinkje'] }, sidebar: 'componenten', previous: { title: 'Case card', permalink: '/en/case-card' }, next: { title: 'Checkbox group', permalink: '/en/checkbox-group' } },
    l = {},
    h = [
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, c.Z)(x), children: [(0, l.jsxs)('div', { className: (0, c.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: z, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.aC, { role: 'presentation', children: n }), (0, l.jsx)(v.nv, { children: r })] })] });
    };
   var C = n(14669);
   const D = (e) => {
