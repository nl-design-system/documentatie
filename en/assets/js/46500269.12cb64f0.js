 ...
 [15593],
 {
  87517: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Range', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Range', pagination_label: 'Range', description: 'Toont een visuele indicatie van aanpasbare inhoud en biedt de mogelijkheid om een waarde binnen een vooraf ingesteld bereik te kiezen.', slug: '/range', sidebar_custom_props: { illustration: 'RangeSketch' } },
    a = void 0,
    u = { id: 'componenten/range/index', title: 'Range', description: 'Toont een visuele indicatie van aanpasbare inhoud en biedt de mogelijkheid om een waarde binnen een vooraf ingesteld bereik te kiezen.', source: '@site/docs/componenten/range/index.mdx', sourceDirName: 'componenten/range', slug: '/range', permalink: '/en/range', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/range/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Range', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Range', pagination_label: 'Range', description: 'Toont een visuele indicatie van aanpasbare inhoud en biedt de mogelijkheid om een waarde binnen een vooraf ingesteld bereik te kiezen.', slug: '/range', sidebar_custom_props: { illustration: 'RangeSketch' } }, sidebar: 'componenten', previous: { title: 'Radio group', permalink: '/en/radio-group' }, next: { title: 'Rich text content', permalink: '/en/rich-text-content' } },
    l = {},
    d = [
