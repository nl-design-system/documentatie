       ...
       value: function (t, a, r, s) {
        if (t.language === a) {
         ...
         (t.code = t.code.replace(r, function (e) {
          ...
          for (var r, o = i.length; -1 !== t.code.indexOf((r = n(a, o))); ) ++o;
          return (i[o] = e), r;
         })),
      ...
      tokenizePlaceholders: {
       value: function (t, a) {
        if (t.language === a && t.tokenStack) {
         ...
         !(function i(o) {
          for (var p = 0; p < o.length && !(r >= s.length); p++) {
           var l = o[p];
           if ("string" == typeof l || (l.content && "string" == typeof l.content)) {
            ...
            if (f > -1) {
             ...
             var m = g.substring(0, f),
              b = new e.Token(a, e.tokenize(d, t.grammar), "language-" + a, d),
              k = g.substring(f + c.length),
              y = [];
             m && y.push.apply(y, i([m])), y.push(b), k && y.push.apply(y, i([k])), "string" == typeof l ? o.splice.apply(o, [p, 1].concat(y)) : (l.content = y);
            }
