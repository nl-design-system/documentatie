/*! For license information please see 6c269cf8.66b5c671.js.LICENSE.txt */
"use strict";
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [2356],
 {
  94091: (e, L, t) => {
   ...
   const h = (e) => {
    let { children: L } = e;
    return (0, m.jsx)(l.Tg, { className: u["nlds-canvas__example-surface"], children: (0, m.jsx)(l.BB, { className: (0, n.Z)("utrecht-document--surface", u["nlds-canvas__example-document"]), children: (0, m.jsx)(l.nv, { className: u["nlds-canvas__example-paragraph"], children: L }) }) });
   };
   h.displayName = "ParagraphContainer";
   const v = (e) => {
    let { children: L } = e;
    return (0, m.jsx)(l.Tg, { className: u["nlds-canvas__example-surface"], children: (0, m.jsx)(l.BB, { className: (0, n.Z)("utrecht-document--surface", u["nlds-canvas__example-document"]), children: L }) });
   };
   v.displayName = "DocumentContainer";
   const x = (e) => {
    let { children: L } = e;
    return (0, m.jsx)(l.Tg, { className: u["nlds-canvas__example-surface"], children: L });
   };
   x.displayName = "SurfaceContainer";
   const g = (e) => {
    let { code: L, copy: t = !1, defaultExpandedCode: g = !1, displayCode: _ = !0, children: b, container: y = "document", language: j, designTokens: k } = e,
     f = "function" == typeof b ? b() : b,
     N = "function" == typeof L ? L() : (0, i.isValidElement)(L) ? L : void 0,
     C = "string" == typeof L ? L : d.uS(N || f),
     [V, Z] = (0, i.useState)(C),
     [H, w] = (0, i.useState)(g);
    (0, i.useEffect)(() => {
     (async () => {
      (V = await c.ZP.format(C, { parser: j, plugins: [o.Z, r.ZP, s.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), Z(V);
     })();
    }, [C]);
    const A = (0, i.useId)();
    let S = i.Fragment;
    return (
     "paragraph" === y ? (S = h) : "document" === y ? (S = v) : "surface" === y && (S = x),
     (0, m.jsxs)("div", {
      className: (0, n.Z)(u["nlds-canvas"]),
      children: [
       f && (0, m.jsx)("div", { className: (0, n.Z)(u["nlds-canvas__example"]), children: (0, m.jsx)("div", { className: "voorbeeld-theme", style: k, children: (0, m.jsx)(S, { children: (0, m.jsx)(l.pu, { children: f }) }) }) }),
       _ &&
        (0, m.jsx)("div", {
         className: (0, n.Z)(u["nlds-canvas__toolbar"]),
         children: (0, m.jsx)(l.zx, {
          className: (0, n.Z)(u["nlds-canvas__button"], u["nlds-canvas__toggle-code-button"]),
       ...
       _ &&
        (0, m.jsxs)("div", {
         className: (0, n.Z)(u["nlds-canvas__code-block"], !t && u["nlds-canvas__code-block--user-select-none"]),
         id: A,
         hidden: !H,
         children: [
          (0, m.jsx)(p.u, { syntax: j, textContent: V, trim: !0 }),
          t &&
           (0, m.jsx)("div", {
            className: (0, n.Z)(u["nlds-canvas__toolbar"]),
            children: (0, m.jsx)(l.zx, {
             className: (0, n.Z)(u["nlds-canvas__button"], u["nlds-canvas__copy-button"]),
             appearance: "subtle-button",
             onClick: () => {
  ...
  41179: (e, L, t) => {
   ...
   var r = t(52676);
   function s(e) {
    let { lineNumber: L, syntax: t, textContent: s, trim: a } = e,
     c = s;
    return (
     a && (c = c.trim()),
     (0, r.jsx)(n.y$, {
      ...
      language: t || "",
      children: (e) => {
       let { style: t, tokens: n, getLineProps: o, getTokenProps: s } = e;
       return (0, r.jsx)(l.dn, { style: t, children: n.map((e, t) => (0, r.jsxs)("span", { ...o({ line: e }), children: [L && (0, r.jsx)("span", { children: t + 1 }), e.map((e, L) => (0, r.jsx)("span", { ...s({ token: e }) }, L)), "\n"] }, t)) });
      },
     })
    );
   }
  ...
  69265: (e, L, t) => {
   ...
   var a = t(52676);
   const c = (e) => {
    let { title: L, appearance: t, description: c, children: i, figure: d } = e;
    const u = "Doen",
     p = "Niet doen",
     m = d ? "figure" : "div",
     h = d ? "figcaption" : "div";
    return (0, a.jsxs)(m, { className: (0, r.Z)(s["nlds-guideline"], s[`nlds-guideline--${t}`]), id: "string" == typeof L ? L?.toLowerCase().replace(/\s/g, "-") : void 0, children: [(0, a.jsxs)(h, { className: (0, r.Z)(s["nlds-guideline__description"]), children: ["dont" === t ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(o.nv, { className: (0, r.Z)(s["nlds-guideline__badge"], s[`nlds-guideline__badge--${t}`]), children: [(0, a.jsx)(l.Z, { className: s["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: s["nlds-guideline__title"], children: p })] }), (0, a.jsx)(o.nv, { children: L })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(o.nv, { className: (0, r.Z)(s["nlds-guideline__badge"], s[`nlds-guideline__badge--${t}`]), children: [(0, a.jsx)(n.Z, { className: s["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: s["nlds-guideline__title"], children: u })] }), (0, a.jsx)(o.nv, { children: L })] }), c] }), (0, a.jsx)("div", { className: (0, r.Z)(s["nlds-guideline__example"]), children: i })] });
   };
  },
  23499: (e, L, t) => {
   t.r(L), t.d(L, { default: () => C, parseColor: () => y });
   var l = t(3225),
    n = t(73200),
    o = t(94091),
    r = t(51256),
   ...
   var i = t(52676);
   const d = (e) => {
    let { backgroundColor: L, color: t, contrastRatio: l } = e;
    return (0, i.jsxs)("dl", { className: c["contrast-ratio"], children: [(0, i.jsxs)("div", { className: c["contrast-ratio__result"], children: [(0, i.jsx)("dt", { className: c["contrast-ratio__result-key"], children: "Contrast ratio:" }), (0, i.jsx)("dd", { className: c["contrast-ratio__result-value"], children: (0, i.jsxs)(r.Pj, { children: [new Intl.NumberFormat("nl", { maximumSignificantDigits: 3, roundingMode: "floor" }).format(l), " \xf7 1"] }) })] }), (0, i.jsxs)("div", { className: (0, s.Z)(c["contrast-ratio__sample"], c["contrast-ratio__sample--background-color"]), children: [(0, i.jsx)("dt", { className: c["contrast-ratio__sample-key"], children: "Achtergrond:" }), (0, i.jsxs)("dd", { className: c["contrast-ratio__sample-value"], children: [(0, i.jsx)(r.B6, { className: c["contrast-ratio__color-sample"], color: L, role: "img", "aria-label": `voorbeeld van: ${L}` }), " ", (0, i.jsx)(r.EK, { children: L })] })] }), (0, i.jsxs)("div", { className: (0, s.Z)(c["contrast-ratio__sample"], c["contrast-ratio__sample--color"]), children: [(0, i.jsx)("dt", { className: c["contrast-ratio__sample-key"], children: "Voorgrond:" }), (0, i.jsxs)("dd", { className: c["contrast-ratio__sample-value"], children: [(0, i.jsx)(r.B6, { className: c["contrast-ratio__color-sample"], color: t, role: "img", "aria-label": `voorbeeld van: ${L}` }), " ", (0, i.jsx)(r.EK, { children: t })] })] })] });
   };
   var u = t(69265),
    p = t(92440),
    m = t(52858);
   const h = (0, a.forwardRef)((e, L) => {
    let { autoComplete: t, defaultValue: l, description: n, disabled: o, errorMessage: r, invalid: c, label: d, max: u, min: p, name: h, onBlur: v, onChange: x, onFocus: g, onInput: _, pattern: b, placeholder: y, readOnly: j, required: k, status: f, type: N, value: C, ...V } = e;
    const Z = (0, a.useId)(),
     H = (0, a.useId)(),
     w = (0, a.useId)(),
     A = (0, a.useId)();
    return (0, i.jsxs)(m.Wi, { invalid: c, ...V, children: [(0, i.jsx)("p", { className: "utrecht-form-field__label", children: (0, i.jsx)(m.lX, { htmlFor: Z, children: d }) }), n && (0, i.jsx)(m.ue, { id: H, children: n }), c && r && (0, i.jsx)(m.w7, { className: "utrecht-form-field__error-message", id: A, children: r }), (0, i.jsx)("p", { className: "utrecht-form-field__input", children: (0, i.jsx)(m.fE, { ref: L, id: Z, name: h, type: N || "text", autoComplete: t, "aria-describedby": (0, s.Z)({ [H]: n, [A]: c, [w]: f }) || void 0, invalid: c, dir: "auto", disabled: o, min: "number" == typeof p ? String(p) : "string" == typeof p ? p : void 0, max: "number" == typeof u ? String(u) : "string" == typeof u ? u : void 0, pattern: b, placeholder: y, readOnly: j, "aria-required": k, value: C, onFocus: g, onBlur: v, onInput: _, onChange: x, defaultValue: l }) }), f && (0, i.jsx)("div", { className: "utrecht-form-field__status", id: w, children: (0, i.jsx)("div", { className: "utrecht-form-field-description utrecht-form-field-description--status", children: f }) })] });
   });
   h.displayName = "FormFieldTextbox";
   var v = t(22305),
    x = t.n(v);
   const g = "nlds-form_L93Q",
    _ = "nlds-example-rendering_omLx",
    ...
    y = (e) => {
     let L = String(e || "")
      .trim()
      .toLowerCase();
     const t = /^\s*([0-9a-f]{3,6})\s*$/i;
     let l;
     t.test(L) && (L = L.replace(t, "#$1"));
     try {
      l = x()(L);
     } catch (n) {
      l = null;
    ...
    j = (e) => {
     let { children: L, label: t, ...l } = e;
     return (0, i.jsx)("div", { role: "img", "aria-label": t, className: _, ...l, children: L });
    },
    ...
    C = () => {
     const { siteConfig: e } = (0, n.Z)(),
      ...
      c = y(s),
      m = y(a),
      v = `https://nldesignsystem.nl/contrast/?${new URLSearchParams({ "background-color": s, color: a }).toString()}`,
      x = c && m ? c.contrast(m) : null,
      _ = [
       { positive: !0, result: x >= 4.5, content: (0, i.jsx)(i.Fragment, { children: "Je mag de kleuren gebruiken voor alle tekst, als je wilt voldoen aan WCAG 2.2 AA niveau." }), container: "document", example: k },
       { positive: !0, result: x >= 3, content: (0, i.jsx)(i.Fragment, { children: "Je mag de kleuren voor iconen gebruiken, als je wilt voldoen aan WCAG 2.2 AA niveau." }), container: "document", example: b },
       { positive: !0, result: x >= 3, content: (0, i.jsx)(i.Fragment, { children: "Je mag de kleuren gebruiken voor tekst groter dan 24px, als je wilt voldoen aan WCAG 2.2 AA niveau." }), container: "document", example: N },
       { positive: !0, result: x >= 3, content: (0, i.jsx)(i.Fragment, { children: "Je mag de kleuren gebruiken voor vette tekst groter dan 18.5px, als je wilt voldoen aan WCAG 2.2 AA niveau." }), container: "document", example: f },
       { positive: !1, result: x >= 3, content: (0, i.jsx)(i.Fragment, { children: "Je mag de kleuren niet voor iconen gebruiken, hiermee zou je niet voldoen aan WCAG 2.2 AA niveau." }), container: "document", example: b },
       { positive: !1, result: x >= 4.5, content: (0, i.jsx)(i.Fragment, { children: "Je mag de kleuren niet gebruiken voor tekst, hiermee zou je niet voldoen aan WCAG 2.2 AA niveau." }), container: "document", example: k },
       { positive: !1, result: x >= 7, content: (0, i.jsx)(i.Fragment, { children: "Je mag de kleuren niet gebruiken voor tekst, als je wilt voldoen aan WCAG 2.2 AAA niveau." }), container: "document", example: k },
      ],
      j = _.filter((e) => {
     ...
     return (0, i.jsx)(p.Z, {
      ...
      children: (0, i.jsxs)(r.JH, {
       ...
       children: [
        ...
        (0, i.jsxs)("form", { method: "get", action: "./", className: g, children: [(0, i.jsx)(h, { name: "background-color", label: (0, i.jsx)(r.EK, { children: "background-color" }), defaultValue: s, style: { "--utrecht-textbox-font-family": "var(--utrecht-code-font-family)" } }), (0, i.jsx)(h, { name: "color", defaultValue: a, label: (0, i.jsx)(r.EK, { children: "color" }), style: { "--utrecht-textbox-font-family": "var(--utrecht-code-font-family)" } }), (0, i.jsx)(r.zx, { type: "submit", appearance: "primary-action-button", children: "Contrast berekenen" })] }),
        "number" == typeof x &&
         (0, i.jsxs)("div", {
          children: [
           (0, i.jsx)(r.XJ, { id: "output", children: "Resultaat" }),
           (0, i.jsx)(d, { backgroundColor: s, color: a, contrastRatio: x }),
           (0, i.jsx)(r.hE, { style: { display: "none" }, children: (0, i.jsx)(r.zx, { appearance: "secondary-action-button", onClick: () => navigator.clipboard.writeText(v), children: "Link kopi\xebren" }) }),
           j.length > 0 &&
            (0, i.jsxs)(i.Fragment, {
             children: [
              ...
              (0, i.jsx)("div", {
               children: j.map((e, L) => {
                let { container: t, content: l, example: n, positive: r } = e;
                return (0, i.jsx)(u.X, { appearance: r ? "do" : "dont", title: l, displayCode: !1, figure: !0, children: (0, i.jsx)(o.X, { language: "html", code: null, displayCode: !1, container: t, designTokens: { backgroundColor: s, color: a, forcedColorAdjust: "none", "--utrecht-surface-background-color": s, "--utrecht-surface-color": a, "--utrecht-document-background-color": s, "--utrecht-document-color": a, "--utrecht-icon-color": "currentColor", "--utrecht-paragraph-color": "currentColor" }, children: n }) }, L);
               }),
              }),
             ],
            }),
            ...
            (0, i.jsxs)(i.Fragment, {
             children: [
              ...
              (0, i.jsx)("div", {
               children: C.map((e, L) => {
                let { container: t, content: l, example: n, positive: r } = e;
                return (0, i.jsx)(u.X, { appearance: r ? "do" : "dont", title: l, displayCode: !1, children: (0, i.jsx)(o.X, { language: "html", code: null, displayCode: !1, container: t, designTokens: { backgroundColor: s, color: a, forcedColorAdjust: "none", "--utrecht-surface-background-color": s, "--utrecht-surface-color": a, "--utrecht-document-background-color": s, "--utrecht-document-color": a, "--utrecht-icon-color": "currentColor", "--utrecht-paragraph-color": "currentColor" }, children: n }) }, L);
               }),
              }),
             ],
            }),
