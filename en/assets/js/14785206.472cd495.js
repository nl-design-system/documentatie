  ...
  33376: (e, n, t) => {
   ...
   const s = (e) => {
    ...
    const m = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     b = u ? 'figcaption' : 'div';
    return (0, d.jsxs)(h, { className: (0, o.Z)(a['nlds-guideline'], a[`nlds-guideline--${t}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(b, { className: (0, o.Z)(a['nlds-guideline__description']), children: ['dont' === t ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${t}`]), children: [(0, d.jsx)(l.Z, { className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: p })] }), (0, d.jsx)(r.nv, { children: n })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${t}`]), children: [(0, d.jsx)(i.Z, { className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: m })] }), (0, d.jsx)(r.nv, { children: n })] }), s] }), (0, d.jsx)('div', { className: (0, o.Z)(a['nlds-guideline__example']), children: c })] });
   };
  },
  24785: (e, n, t) => {
   t.d(n, { Z: () => a, a: () => o });
