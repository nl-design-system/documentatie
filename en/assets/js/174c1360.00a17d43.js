...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [4206],
 {
  ...
  67416: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => g, contentTitle: () => m, default: () => j, frontMatter: () => p, metadata: () => h, toc: () => v });
   var t = l(52676),
    o = l(24785),
    s = l(98480),
    i = l(91050);
   ...
   var u = l(23680);
   const p = { title: 'Schrijf een foutmelding uit in tekst | Foutmeldingen in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Fouten beschrijven', pagination_label: 'Fouten beschrijven', description: 'Richtlijnen voor uitschrijven van een foutmelding in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/beschrijven', keywords: ['labels', 'formulier', 'design', 'code'] },
    m = void 0,
    h = { id: 'richtlijnen/formulieren/error/description/README', title: 'Schrijf een foutmelding uit in tekst | Foutmeldingen in een formulier | Richtlijnen', description: 'Richtlijnen voor uitschrijven van een foutmelding in een formulier.', source: '@site/docs/richtlijnen/formulieren/error/2-description/README.mdx', sourceDirName: 'richtlijnen/formulieren/error/2-description', slug: '/richtlijnen/formulieren/foutmeldingen/beschrijven', permalink: '/en/richtlijnen/formulieren/foutmeldingen/beschrijven', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/error/2-description/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Schrijf een foutmelding uit in tekst | Foutmeldingen in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Fouten beschrijven', pagination_label: 'Fouten beschrijven', description: 'Richtlijnen voor uitschrijven van een foutmelding in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/beschrijven', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Fouten controleren', permalink: '/en/richtlijnen/formulieren/foutmeldingen/controleren' }, next: { title: 'Duidelijke foutmeldingen', permalink: '/en/richtlijnen/formulieren/foutmeldingen/duidelijk - labels - formulier - design - code' } },
    g = {},
    v = [];
   function _(e) {
  ...
  98480: (e, n, l) => {
   ...
   const j = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: j = !1, displayCode: b = !0, children: y, container: f = 'document', language: x, designTokens: k } = e,
    ...
    let P = d.Fragment;
    return (
     'paragraph' === f ? (P = g) : 'document' === f ? (P = v) : 'surface' === f && (P = _),
     (0, h.jsxs)('div', {
      className: (0, o.Z)(p['nlds-canvas']),
      children: [
       N && (0, h.jsx)('div', { className: (0, o.Z)(p['nlds-canvas__example']), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, h.jsx)(P, { children: (0, h.jsx)(t.pu, { children: N }) }) }) }),
       b &&
        (0, h.jsx)('div', {
