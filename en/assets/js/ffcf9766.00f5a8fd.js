(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [7869],
 {
  ...
  90786: (e, t, n) => {
   ...
   const _ = (e) => {
     let { children: t } = e;
     return (0, l.jsx)('ul', { className: f.Z['task-list'], children: t });
    },
    x = (e) => {
     let { checked: t, children: n, title: r, description: c, headingLevel: o = 3 } = e;
     return (0, l.jsxs)('li', { className: (0, i.Z)(f.Z['task-list-item']), children: [(0, l.jsxs)('div', { className: (0, i.Z)(f.Z['task-list-item__marker'], t && f.Z['task-list-item__marker--checked']), children: [(0, l.jsx)('span', { className: f.Z['task-list-item__marker-label'], children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var N = n(14669);
   const w = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => N.e9.includes(e.id)),
      o = c && N.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(m['definition-of-done'], e && m[`definition-of-done--${(0, N.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, l.jsx)(_, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(x, { checked: t, title: n, description: (0, N.Q6)(r) }, r);
            }),
           }),
