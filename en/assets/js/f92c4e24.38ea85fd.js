...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  38266: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => u, contentTitle: () => h, default: () => m, frontMatter: () => c, metadata: () => p, toc: () => g });
   var r = i(52676),
    s = i(24785),
    l = i(71595),
    o = i(45054),
   ...
   const c = { title: 'WCAG-succescriterium 2.4.6 Koppen en labels', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.6 Koppen en labels', pagination_label: 'WCAG-succescriterium 2.4.6 Koppen en labels', description: 'Koppen en labels beschrijven het onderwerp of het doel.', slug: '2.4.6', keywords: ['WCAG'] },
    h = void 0,
    p = { id: 'wcag/2.4.06', title: 'WCAG-succescriterium 2.4.6 Koppen en labels', description: 'Koppen en labels beschrijven het onderwerp of het doel.', source: '@site/docs/wcag/2.4.06.mdx', sourceDirName: 'wcag', slug: '/wcag/2.4.6', permalink: '/en/wcag/2.4.6', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.06.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.4.6 Koppen en labels', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.6 Koppen en labels', pagination_label: 'WCAG-succescriterium 2.4.6 Koppen en labels', description: 'Koppen en labels beschrijven het onderwerp of het doel.', slug: '2.4.6', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.4.5 Meerdere manieren', permalink: '/en/wcag/2.4.5' }, next: { title: '2.4.7 Focus zichtbaar', permalink: '/en/wcag/2.4.7' } },
    u = {},
    g = [
  ...
  72657: (e, n, i) => {
   ...
   var l = i(52676);
   const o = (e) => {
    let { children: n, className: i, level: o = 1, suffix: t, ...a } = e;
    return (0, l.jsxs)('hgroup', { className: (0, r.Z)(s['nlds-inline-heading-group'], `utrecht-heading-${o}`, i), ...a, children: [(0, l.jsx)('h1', { className: (0, r.Z)(s['nlds-inline-heading-group__heading']), children: n }), t && (0, l.jsxs)('p', { className: (0, r.Z)(s['nlds-inline-heading-group__suffix']), children: [t ? ' ' : '', t] })] });
   };
  },
  71595: (e, n, i) => {
   i.d(n, { j: () => a });
   ...
   const a = (e) => {
    ...
    return (0, t.jsx)(s.V, { className: l, suffix: i && (0, t.jsx)(r.Ou, { className: o, children: i }), ...a, children: n });
   };
  },
  24785: (e, n, i) => {
   i.d(n, { Z: () => t, a: () => o });
   ...
   function t(e) {
    let n;
    return (n = e.disableParentContext ? ('function' == typeof e.components ? e.components(s) : e.components || s) : o(e.components)), r.createElement(l.Provider, { value: n }, e.children);
   }
  },
 },
]);
