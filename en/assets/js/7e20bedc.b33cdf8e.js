 ...
 [39783],
 {
  73312: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(76037),
    o = n(23952);
   const s = { title: 'Tabs', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Tabs', pagination_label: 'Tabs', description: 'Paneel om onderwerpen te groeperen, waarbij er maar \xe9\xe9n per keer zichtbaar is, met buttons om te kiezen welk onderwerp wordt weergegeven.', slug: '/tabs' },
    a = void 0,
  ...
  23952: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(_), children: [(0, u.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var T = n(14669);
   const S = (e) => {
          ...
          children: [
           (0, u.jsx)(z, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(A, { checked: t, title: n, description: (0, T.Q6)(r) }, r);
            }),
           }),
