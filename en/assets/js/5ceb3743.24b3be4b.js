...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [41952],
 {
  ...
  98480: (e, n, l) => {
   ...
   const b = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: b = !1, displayCode: _ = !0, children: f, container: y = 'document', language: x, designTokens: k } = e,
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (D = await d.ZP.format(Z, { parser: x, plugins: [t.Z, s.ZP, r.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), S(D);
     })();
    }, [Z]);
    const F = (0, c.useId)();
    let E = c.Fragment;
  ...
  91050: (e, n, l) => {
   ...
   const d = (e) => {
    ...
    const p = 'Doen',
     ...
     g = u ? 'figure' : 'div',
     h = u ? 'figcaption' : 'div';
    return (0, a.jsxs)(g, { className: (0, s.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(h, { className: (0, s.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, s.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(i.Z, { className: r['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: r['nlds-guideline__title'], children: m })] }), (0, a.jsx)(t.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, s.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(o.Z, { className: r['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: r['nlds-guideline__title'], children: p })] }), (0, a.jsx)(t.nv, { children: n })] }), d] }), (0, a.jsx)('div', { className: (0, s.Z)(r['nlds-guideline__example']), children: c })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => s });
