 ...
 [98634],
 {
  29416: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: "Biedt de mogelijkheid om naar andere pagina's of secties te navigeren.", slug: '/link', sidebar_custom_props: { illustration: 'LinkSketch' } },
    a = void 0,
    l = { id: 'componenten/link/index', title: 'Link', description: "Biedt de mogelijkheid om naar andere pagina's of secties te navigeren.", source: '@site/docs/componenten/link/index.mdx', sourceDirName: 'componenten/link', slug: '/link', permalink: '/en/link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: "Biedt de mogelijkheid om naar andere pagina's of secties te navigeren.", slug: '/link', sidebar_custom_props: { illustration: 'LinkSketch' } }, sidebar: 'componenten', previous: { title: 'Legend', permalink: '/en/legend' }, next: { title: 'Link list', permalink: '/en/link-list' } },
    u = {},
    d = [
    ...
    h = 'Link',
    j = "Biedt de mogelijkheid om naar andere pagina's of secties te navigeren.",
    y = 'LinkSketch',
    g = 118,
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: L, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var z = n(14669);
   const D = (e) => {
