 ...
 [41769],
 {
  18343: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Page header', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Page header', pagination_label: 'Page header', description: 'Een plek bovenaan elke pagina voor een logo, navigatie en zoeken.', slug: '/page-header', sidebar_custom_props: { illustration: 'PageHeaderSketch' } },
    a = void 0,
    l = { id: 'componenten/page-header/index', title: 'Page header', description: 'Een plek bovenaan elke pagina voor een logo, navigatie en zoeken.', source: '@site/docs/componenten/page-header/index.mdx', sourceDirName: 'componenten/page-header', slug: '/page-header', permalink: '/en/page-header', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/page-header/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Page header', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Page header', pagination_label: 'Page header', description: 'Een plek bovenaan elke pagina voor een logo, navigatie en zoeken.', slug: '/page-header', sidebar_custom_props: { illustration: 'PageHeaderSketch' } }, sidebar: 'componenten', previous: { title: 'Page footer', permalink: '/en/page-footer' }, next: { title: 'Pagination', permalink: '/en/pagination' } },
    u = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: z, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
