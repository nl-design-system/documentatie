(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [79947],
 {
  35460: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => g, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => o, issueNumber: () => m, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(80719),
    s = n(90786);
   const o = { title: 'Number badge', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number badge', pagination_label: 'Number badge', description: 'Klein label dat de aandacht trekt informeert over een aantal.', slug: '/number-badge' },
    a = void 0,
  ...
  90786: (e, t, n) => {
   ...
   const w = (e) => {
     ...
     const c = t && t.projects.filter((e) => N.e9.includes(e.id)),
      s = c && N.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
