  ...
  4460: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var C = n(14669);
   const D = (e) => {
     ...
     return (
      ...
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: s.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], e && y[`definition-of-done--${(0, C.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
