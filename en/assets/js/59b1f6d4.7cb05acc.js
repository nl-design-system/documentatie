 ...
 [16882],
 {
  25675: (e, n, i) => {
   ...
   const g = { title: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.2 Aanwijzerannulering', pagination_label: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', description: 'Zorg ervoor dat, als de gebruiker bijvoorbeeld een link of button indrukt met een aanwijzer zoals een muis of vinger, er de mogelijkheid is om actie te voorkomen of ongedaan te maken.', slug: '2.5.2', keywords: ['WCAG'] },
    p = void 0,
    j = { id: 'wcag/2.5.02', title: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', description: 'Zorg ervoor dat, als de gebruiker bijvoorbeeld een link of button indrukt met een aanwijzer zoals een muis of vinger, er de mogelijkheid is om actie te voorkomen of ongedaan te maken.', source: '@site/docs/wcag/2.5.02.mdx', sourceDirName: 'wcag', slug: '/wcag/2.5.2', permalink: '/en/wcag/2.5.2', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.5.02.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.2 Aanwijzerannulering', pagination_label: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', description: 'Zorg ervoor dat, als de gebruiker bijvoorbeeld een link of button indrukt met een aanwijzer zoals een muis of vinger, er de mogelijkheid is om actie te voorkomen of ongedaan te maken.', slug: '2.5.2', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.5.1 Aanwijzergebaren', permalink: '/en/wcag/2.5.1' }, next: { title: 'WCAG-succescriterium 2.5.3 Label in Naam', permalink: '/en/wcag/2.5.3' } },
    m = {},
    v = [
