...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [44617],
 {
  ...
  44585: (e, n, o) => {
   ...
   const _ = (e) => {
    let { code: n, copy: o = !0, defaultExpandedCode: _ = !1, displayCode: j = !0, children: f, container: y = 'document', language: x, designTokens: k } = e,
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await c.ZP.format(A, { parser: x, plugins: [r.Z, s.ZP, i.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), z(Z);
     })();
    }, [A]);
    const E = (0, d.useId)();
    let P = d.Fragment;
  ...
  41179: (e, n, o) => {
   ...
   var s = o(52676);
   function i(e) {
    let { lineNumber: n, syntax: o, textContent: i, trim: a } = e,
     c = i;
    return (
     a && (c = c.trim()),
     (0, s.jsx)(l.y$, {
      ...
      children: (e) => {
       ...
       return (0, s.jsx)(t.dn, { style: o, children: l.map((e, o) => (0, s.jsxs)('span', { ...r({ line: e }), children: [n && (0, s.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, o)) });
      },
     })
    );
   }
  ...
  33376: (e, n, o) => {
   ...
   const c = (e) => {
    ...
    const m = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     v = u ? 'figcaption' : 'div';
    return (0, a.jsxs)(h, { className: (0, s.Z)(i['nlds-guideline'], i[`nlds-guideline--${o}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(v, { className: (0, s.Z)(i['nlds-guideline__description']), children: ['dont' === o ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.nv, { className: (0, s.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${o}`]), children: [(0, a.jsx)(t.Z, { className: i['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: i['nlds-guideline__title'], children: p })] }), (0, a.jsx)(r.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.nv, { className: (0, s.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${o}`]), children: [(0, a.jsx)(l.Z, { className: i['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: i['nlds-guideline__title'], children: m })] }), (0, a.jsx)(r.nv, { children: n })] }), c] }), (0, a.jsx)('div', { className: (0, s.Z)(i['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, o) => {
   o.d(n, { Z: () => i, a: () => s });
