...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [3411],
 {
  ...
  73460: (e, n, i) => {
   ...
   const p = (e) => {
    let { children: n } = e;
    return (0, v.jsx)(s.Tg, { className: g["nlds-canvas__example-surface"], children: (0, v.jsx)(s.BB, { className: (0, t.Z)("utrecht-document--surface", g["nlds-canvas__example-document"]), children: (0, v.jsx)(s.nv, { className: g["nlds-canvas__example-paragraph"], children: n }) }) });
   };
   p.displayName = "ParagraphContainer";
   const h = (e) => {
    let { children: n } = e;
    return (0, v.jsx)(s.Tg, { className: g["nlds-canvas__example-surface"], children: (0, v.jsx)(s.BB, { className: (0, t.Z)("utrecht-document--surface", g["nlds-canvas__example-document"]), children: n }) });
   };
   ...
   const j = (e) => {
    let { code: n, copy: i = !1, defaultExpandedCode: j = !1, displayCode: x = !0, children: f, container: k = "document", language: _, designTokens: y } = e,
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await c.ZP.format(N, { parser: _, plugins: [l.Z, r.ZP, o.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), C(Z);
     })();
    }, [N]);
    const D = (0, d.useId)();
    let A = d.Fragment;
    return (
     "paragraph" === k ? (A = p) : "document" === k ? (A = h) : "surface" === k && (A = b),
     (0, v.jsxs)("div", {
      className: (0, t.Z)(g["nlds-canvas"]),
      children: [
       w && (0, v.jsx)("div", { className: (0, t.Z)(g["nlds-canvas__example"]), children: (0, v.jsx)("div", { className: "voorbeeld-theme", style: y, children: (0, v.jsx)(A, { children: (0, v.jsx)(s.pu, { children: w }) }) }) }),
       x &&
        (0, v.jsx)("div", {
         className: (0, t.Z)(g["nlds-canvas__toolbar"]),
         children: (0, v.jsx)(s.zx, {
          className: (0, t.Z)(g["nlds-canvas__button"], g["nlds-canvas__toggle-code-button"]),
       ...
       x &&
        (0, v.jsxs)("div", {
         className: (0, t.Z)(g["nlds-canvas__code-block"], !i && g["nlds-canvas__code-block--user-select-none"]),
         id: D,
         hidden: !B,
         children: [
   ...
   function o(e) {
    ...
    return (
     ...
     (0, r.jsx)(t.y$, {
      ...
      language: i || "",
      children: (e) => {
       let { style: i, tokens: t, getLineProps: l, getTokenProps: o } = e;
       return (0, r.jsx)(s.dn, { style: i, children: t.map((e, i) => (0, r.jsxs)("span", { ...l({ line: e }), children: [n && (0, r.jsx)("span", { children: i + 1 }), e.map((e, n) => (0, r.jsx)("span", { ...o({ token: e }) }, n)), "\n"] }, i)) });
      },
     })
    );
   }
  ...
  30036: (e, n, i) => {
   ...
   const c = (e) => {
    ...
    const g = "Doen",
     ...
     v = u ? "figure" : "div",
     p = u ? "figcaption" : "div";
    return (0, a.jsxs)(v, { className: (0, r.Z)(o["nlds-guideline"], o[`nlds-guideline--${i}`]), id: "string" == typeof n ? n?.toLowerCase().replace(/\s/g, "-") : void 0, children: [(0, a.jsxs)(p, { className: (0, r.Z)(o["nlds-guideline__description"]), children: ["dont" === i ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(l.nv, { className: (0, r.Z)(o["nlds-guideline__badge"], o[`nlds-guideline__badge--${i}`]), children: [(0, a.jsx)(s.Z, { className: o["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: o["nlds-guideline__title"], children: m })] }), (0, a.jsx)(l.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(l.nv, { className: (0, r.Z)(o["nlds-guideline__badge"], o[`nlds-guideline__badge--${i}`]), children: [(0, a.jsx)(t.Z, { className: o["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: o["nlds-guideline__title"], children: g })] }), (0, a.jsx)(l.nv, { children: n })] }), c] }), (0, a.jsx)("div", { className: (0, r.Z)(o["nlds-guideline__example"]), children: d })] });
   };
  },
  27034: (e, n, i) => {
   i.d(n, { Z: () => o, a: () => r });
   ...
   function o(e) {
    let n;
    return (n = e.disableParentContext ? ("function" == typeof e.components ? e.components(t) : e.components || t) : r(e.components)), s.createElement(l.Provider, { value: n }, e.children);
   }
  },
 },
]);
