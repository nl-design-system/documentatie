 ...
 [32652],
 {
  73532: (e, t, n) => {
   ...
   const s = { title: 'Spinner', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Spinner', pagination_label: 'Spinner', description: "Een 'spinner' is een animatie die aangeeft dat een pagina of een deel van een pagina aan het laden is of een interactie blokkeert.", slug: '/spinner', sidebar_custom_props: { illustration: 'SpinnerSketch' } },
    ...
    h = 'Spinner',
    j = "Een 'spinner' is een animatie die aangeeft dat een pagina of een deel van een pagina aan het laden is of een interactie blokkeert.",
    y = 'SpinnerSketch',
    m = 75,
  ...
  21998: (e, t, n) => {
   ...
   const v = 'task-list_hh8j',
    ...
    N = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(f), children: [(0, l.jsxs)('div', { className: (0, i.Z)(_, { [x]: t }), children: [(0, l.jsx)('span', { className: S, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.aC, { role: 'presentation', children: n }), (0, l.jsx)(b.nv, { children: r })] })] });
    };
   var A = n(14669);
   const z = Object.keys({ HELP_WANTED: 'UNKNOWN', COMMUNITY: 'HELP_WANTED', CANDIDATE: 'COMMUNITY', HALL_OF_FAME: 'CANDIDATE' }),
    D = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], y[`definition-of-done--${(0, A.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
    ...
    M = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.X6, { level: n, children: [t.title, ' ', c && (0, l.jsx)(g.y, { state: c })] }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  5671: (e, t, n) => {
   'use strict';
