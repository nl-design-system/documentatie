 ...
 [9910],
 {
  1172: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    o = n(60851);
   const s = { title: 'Action group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Action group', pagination_label: 'Action group', description: 'Groepeert \xe9\xe9n of meer gerelateerde acties en verzorgt de lay-out van de content.', slug: '/action-group', sidebar_custom_props: { illustration: 'ActionGroupSketch' }, keywords: ['action bar', 'action group', 'button container', 'button dock', 'button group', 'button row', 'buttongroup', 'buttons', 'knoppen', 'toolbar', 'werkbalk'] },
    a = void 0,
    u = { id: 'componenten/action-group/index', title: 'Action group', description: 'Groepeert \xe9\xe9n of meer gerelateerde acties en verzorgt de lay-out van de content.', source: '@site/docs/componenten/action-group/index.mdx', sourceDirName: 'componenten/action-group', slug: '/action-group', permalink: '/en/action-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/action-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Action group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Action group', pagination_label: 'Action group', description: 'Groepeert \xe9\xe9n of meer gerelateerde acties en verzorgt de lay-out van de content.', slug: '/action-group', sidebar_custom_props: { illustration: 'ActionGroupSketch' }, keywords: ['action bar', 'action group', 'button container', 'button dock', 'button group', 'button row', 'buttongroup', 'buttons', 'knoppen', 'toolbar', 'werkbalk'] }, sidebar: 'componenten', previous: { title: 'Accordion', permalink: '/en/accordion' }, next: { title: 'Alert', permalink: '/en/alert' } },
    l = {},
    d = [
   ...
   const s = (e) => {
    ...
    u = (e) => {
     ...
     const l = (e) => ('article' === a ? (0, o.jsx)('article', { ...e }) : 'section' === a ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(l, { className: (0, c.Z)(i.cardgroup__card, i[`cardgroup__card--${n}`], s), children: u });
  ...
  60851: (e, t, n) => {
   ...
   var r = n(47027),
    ...
    u = n(32636),
    l = n(52676);
   const d = { figma: (0, l.jsx)(i.Z, {}), github: (0, l.jsx)(o.Z, {}), npm: (0, l.jsx)(s.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const T = (e) => {
     ...
     const i = t && t.projects.filter((e) => D.e9.includes(e.id)),
      o = i && D.e9.map((e) => i.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
    ...
    C = (e) => {
     ...
     const i = t && D.$3[t.relayStep];
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(v, { level: n, suffix: i && (0, l.jsx)(m.y, { state: i }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  42677: (e, t, n) => {
   'use strict';
