...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [9872],
 {
  ...
  88848: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => g, contentTitle: () => m, default: () => j, frontMatter: () => p, metadata: () => h, toc: () => b });
   var l = t(11527),
    o = t(47214),
    s = t(73460),
    r = t(30036);
  ...
  73460: (e, n, t) => {
   ...
   const j = (e) => {
    let { code: n, copy: t = !1, defaultExpandedCode: j = !0, displayCode: _ = !0, children: y, container: x = "document", language: f, designTokens: k } = e,
    ...
    let D = d.Fragment;
    return (
     "paragraph" === x ? (D = g) : "document" === x ? (D = b) : "surface" === x && (D = v),
     (0, h.jsxs)("div", {
