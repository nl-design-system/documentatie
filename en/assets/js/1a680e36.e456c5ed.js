 ...
 [61442],
 {
  ...
  11762: (e, n, i) => {
   ...
   const c = { title: 'Labels in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Introductie labels', sidebar_position: 6, pagination_label: 'Labels in een formulier', description: 'Richtlijnen voor labels in een formulier.', slug: '/richtlijnen/formulieren/labels/', keywords: ['labels', 'formulier', 'design', 'code'] },
    o = 'Labels in een formulier',
    d = { id: 'richtlijnen/formulieren/label/README', title: 'Labels in een formulier | Richtlijnen', description: 'Richtlijnen voor labels in een formulier.', source: '@site/docs/richtlijnen/formulieren/label/README.mdx', sourceDirName: 'richtlijnen/formulieren/label', slug: '/richtlijnen/formulieren/labels/', permalink: '/en/richtlijnen/formulieren/labels/', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/label/README.mdx', tags: [], version: 'current', sidebarPosition: 6, frontMatter: { title: 'Labels in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Introductie labels', sidebar_position: 6, pagination_label: 'Labels in een formulier', description: 'Richtlijnen voor labels in een formulier.', slug: '/richtlijnen/formulieren/labels/', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Screenreaderfeedback', permalink: '/en/richtlijnen/formulieren/foutmeldingen/screenreaderfeedback' }, next: { title: 'Labels in een formulier', permalink: '/en/richtlijnen/formulieren/labels/' } },
    h = {},
   ...
   function u(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', (0, r.jsx)(n.h1, { id: 'labels-in-een-formulier', children: 'Labels in een formulier' }), '\n', (0, r.jsx)(n.p, { children: 'Een label geeft aan welke gegevens de gebruiker bij een formulierveld in kan vullen.' }), '\n', (0, r.jsx)(s.l, { excludeDocIDs: ['richtlijnen/formulieren/label/README'] }), '\n', (0, r.jsx)(n.h2, { id: 'deze-documentatie-heeft-nu-een-eigen-pagina', children: 'Deze documentatie heeft nu een eigen pagina' }), '\n', (0, r.jsx)(t._, { id: 'geef-een-formulierveld-toegankelijke-naam-met-een-label', children: (0, r.jsxs)(n.p, { children: [(0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/labels/toegankelijke-naam', children: 'Geef een formulierveld een toegankelijke naam met een label' }), '.'] }) }), '\n', (0, r.jsx)(t._, { id: 'de-zichtbare-naam-moet-overeenkomen-met-de-toegankelijke-naam', children: (0, r.jsxs)(n.p, { children: [(0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/labels/zichtbare-naam', children: 'De zichtbare naam moet overeenkomen met de toegankelijke naam' }), '.'] }) }), '\n', (0, r.jsx)(t._, { id: 'zet-het-label-boven-het-formulierveld', children: (0, r.jsxs)(n.p, { children: [(0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/labels/plaatsing', children: 'Zet het label boven het formulierveld' }), '.'] }) }), '\n', (0, r.jsx)(t._, { id: 'zorg-ervoor-dat-het-label-altijd-zichtbaar-is', children: (0, r.jsxs)(n.p, { children: [(0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/labels/altijd-zichtbaar', children: 'Zorg ervoor dat het label altijd zichtbaar is' }), '.'] }) }), '\n', (0, r.jsx)(t._, { id: 'zet-alleen-tekst-in-het-label', children: (0, r.jsxs)(n.p, { children: [(0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/labels/alleen-tekst', children: 'Zet alleen tekst in het label' }), '.'] }) }), '\n', (0, r.jsx)(t._, { id: 'gebruik-duidelijke-labelteksten', children: (0, r.jsxs)(n.p, { children: [(0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/labels/duidelijke-tekst', children: 'Gebruik duidelijke labelteksten' }), '.'] }) }), '\n', (0, r.jsx)(a.ZP, {})] });
   }
   function j(e = {}) {
    const { wrapper: n } = { ...(0, l.a)(), ...e.components };
  ...
  2334: (e, n, i) => {
   ...
   const t = (e) => {
    ...
    return (0, l.jsx)('div', { ...t, className: (0, r.Z)('nlds-fragment-redirect', i), children: n });
   };
  },
  21004: (e, n, i) => {
   i.d(n, { l: () => c });
   ...
   const a = (e, n) => e.reduce((e, i) => ('link' === i.type ? (n.includes(i.docId) ? e : [...e, i]) : 'category' === i.type ? [...e, { ...i, items: a(i.items, n) }] : e), []),
    c = (e) => {
     ...
     const o = (0, r.jA)();
     return (0, s.jsx)('div', { ...c, className: (0, l.Z)('margin-top--lg', i), children: (0, s.jsx)(t.Z, { items: a(o.items, n) }) });
    };
  },
  20537: (e, n, i) => {
   i.d(n, { Z: () => j });
   ...
   var c = i(52676);
   function o(e) {
    let { href: n, icon: i = '', title: r, description: t, children: o } = e;
    return (0, c.jsxs)('div', { className: (0, s.Z)('card', a.card), children: [n ? (0, c.jsx)(l.Z, { href: n, className: (0, s.Z)(a.cardLink, 'utrecht-link'), children: (0, c.jsxs)('h2', { className: (0, s.Z)(a.cardTitle), children: [i, ' ', r] }) }) : (0, c.jsxs)('h2', { className: (0, s.Z)(a.cardTitle), children: [i, ' ', r] }), t && (0, c.jsx)('p', { className: (0, s.Z)(a.cardDescription), children: t }), o] });
   }
   function d(e) {
    let { item: n } = e;
   ...
   function j(e) {
    ...
    const l = (0, r.MN)(n);
    return (0, c.jsx)('section', { className: (0, s.Z)('row', i), children: l.map((e, n) => (0, c.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, c.jsx)(m, { item: e }) }, n)) });
   }
  },
  24785: (e, n, i) => {
   i.d(n, { Z: () => a, a: () => s });
