 ...
 [25507],
 {
  78735: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(7617),
    o = n(4460);
   const s = { title: 'Video', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Video', pagination_label: 'Video', description: 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.', slug: '/video' },
    a = void 0,
    u = { id: 'componenten/video/index', title: 'Video', description: 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.', source: '@site/docs/componenten/video/index.mdx', sourceDirName: 'componenten/video', slug: '/video', permalink: '/en/video', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/video/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Video', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Video', pagination_label: 'Video', description: 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.', slug: '/video' }, sidebar: 'componenten', previous: { title: 'Unordered list', permalink: '/en/unordered-list' } },
    l = {},
    d = [
  ...
  4460: (e, t, n) => {
   ...
   const D = (e) => {
     ...
     const c = t && t.projects.filter((e) => V.e9.includes(e.id)),
      o = c && V.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], e && y[`definition-of-done--${(0, V.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, l.jsx)(z, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(S, { checked: t, title: n, description: (0, V.Q6)(r) }, r);
            }),
           }),
