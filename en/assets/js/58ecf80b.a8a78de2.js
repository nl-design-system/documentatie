 ...
 [2652],
 {
  54548: (e, n, t) => {
   ...
   const s = { title: "Button group", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Button group", pagination_label: "Button group", description: "UX richtlijnen voor Button group component", slug: "/button-group", tags: ["Unknown"] },
    l = "Button group",
    r = { id: "componenten/build/button-group", title: "Button group", description: "UX richtlijnen voor Button group component", source: "@site/docs/componenten/build/button-group.mdx", sourceDirName: "componenten/build", slug: "/button-group", permalink: "/en/button-group", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/button-group.mdx", tags: [{ label: "Unknown", permalink: "/en/tags/unknown" }], version: "current", frontMatter: { title: "Button group", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Button group", pagination_label: "Button group", description: "UX richtlijnen voor Button group component", slug: "/button-group", tags: ["Unknown"] }, sidebar: "componenten", previous: { title: "Breadcrumb navigation", permalink: "/en/breadcrumb" }, next: { title: "Button", permalink: "/en/button" } },
    u = {},
    a = [
