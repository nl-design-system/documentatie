 ...
 [40284],
 {
  18461: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Button', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Button', pagination_label: 'Button', description: 'Biedt de mogelijkheid om een actie uit te voeren.', slug: '/button', sidebar_custom_props: { illustration: 'ButtonSketch' }, keywords: ['action', 'activate', 'button', 'knop', 'knoppen', 'submit', 'toggle button', 'versturen', 'verzenden'] },
    a = void 0,
    u = { id: 'componenten/button/index', title: 'Button', description: 'Biedt de mogelijkheid om een actie uit te voeren.', source: '@site/docs/componenten/button/index.mdx', sourceDirName: 'componenten/button', slug: '/button', permalink: '/en/button', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/button/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Button', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Button', pagination_label: 'Button', description: 'Biedt de mogelijkheid om een actie uit te voeren.', slug: '/button', sidebar_custom_props: { illustration: 'ButtonSketch' }, keywords: ['action', 'activate', 'button', 'knop', 'knoppen', 'submit', 'toggle button', 'versturen', 'verzenden'] }, sidebar: 'componenten', previous: { title: 'Breadcrumb navigation', permalink: '/en/breadcrumb-navigation' }, next: { title: 'Calendar', permalink: '/en/Calendar' } },
    l = {},
    d = [
    ...
    h = 'Button',
    j = 'Biedt de mogelijkheid om een actie uit te voeren.',
    y = 'ButtonSketch',
    m = 38,
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(k.aC, { role: 'presentation', children: n }), (0, l.jsx)(k.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
