 ...
 [17393],
 {
  6646: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(81301),
    o = n(90786);
   const s = { title: 'Form Summary', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Summary', pagination_label: 'Form Summary', description: ' ', slug: '/form-summary' },
    a = void 0,
    u = { id: 'componenten/form-summary/index', title: 'Form Summary', description: ' ', source: '@site/docs/componenten/form-summary/index.mdx', sourceDirName: 'componenten/form-summary', slug: '/form-summary', permalink: '/en/form-summary', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-summary/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form Summary', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Summary', pagination_label: 'Form Summary', description: ' ', slug: '/form-summary' }, sidebar: 'componenten', previous: { title: 'Form Field Radio Option', permalink: '/en/form-field-radio-option' }, next: { title: 'Heading', permalink: '/en/heading' } },
    l = {},
    d = [
