 ...
 [49619],
 {
  43077: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(87176),
    s = n(90786);
   const o = { title: 'Text Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text Input', pagination_label: 'Text Input', description: 'Biedt de mogelijkheid om \xe9\xe9n regel aan tekens in te vullen.', slug: '/text-input' },
    a = void 0,
    l = { id: 'componenten/text-input/index', title: 'Text Input', description: 'Biedt de mogelijkheid om \xe9\xe9n regel aan tekens in te vullen.', source: '@site/docs/componenten/text-input/index.mdx', sourceDirName: 'componenten/text-input', slug: '/text-input', permalink: '/en/text-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/text-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Text Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text Input', pagination_label: 'Text Input', description: 'Biedt de mogelijkheid om \xe9\xe9n regel aan tekens in te vullen.', slug: '/text-input' }, sidebar: 'componenten', previous: { title: 'Task List', permalink: '/en/task-list' }, next: { title: 'Text Input Group', permalink: '/en/text-input-group' } },
    u = {},
    d = [
