 ...
 [1915],
 {
  ...
  30300: (e, n, l) => {
   ...
   function o(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: ["\n", "\n", "\n", (0, i.jsx)(s.X, { appearance: "do", title: "De link boven het gerelateerde invoerveld plaatsen.", children: (0, i.jsx)(a.X, { language: "html", children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(n.p, { children: [(0, i.jsx)(n.a, { href: "#", children: "Voorwaarden vrijwilligerswerk" }), "."] }), (0, i.jsxs)(n.p, { children: [(0, i.jsx)(n.input, { type: "checkbox", name: "vrijwilliger", id: "vrijwilliger" }), (0, i.jsx)(n.label, { for: "vrijwilliger", children: "Ik wil vrijwilliger worden" })] })] }) }) }), "\n", (0, i.jsx)(s.X, { appearance: "dont", title: "De link onder het gerelateerde invoerveld plaatsen.", children: (0, i.jsx)(a.X, { language: "html", children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(n.p, { children: [(0, i.jsx)(n.input, { type: "checkbox", name: "vrijwilliger", id: "vrijwilliger" }), (0, i.jsx)(n.label, { for: "vrijwilliger", children: "Ik wil vrijwilliger worden" })] }), (0, i.jsxs)(n.p, { children: [(0, i.jsx)(n.a, { href: "#", children: "Voorwaarden vrijwilligerswerk" }), "."] })] }) }) })] });
   }
   function d(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
   ...
   function h(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: ["\n", "\n", "\n", (0, i.jsx)(s.X, { appearance: "do", title: "Alle informatie als zichtbare tekst in de link plaatsen.", children: (0, i.jsx)(a.X, { language: "html", children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(n.a, { href: "#", target: "_blank", children: "Lees het privacybeleid (opent in een nieuwe tab)" }), "."] }) }) }), "\n", (0, i.jsx)(s.X, { appearance: "do", title: "Zichtbaar icoontje plus onzichtbare, maar uitgesproken tekst voor screenreaders.", children: (0, i.jsx)(a.X, { language: "html", children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(n.a, { href: "#", target: "_blank", class: "nlds-icon-ext", children: ["Lees het privacybeleid", (0, i.jsx)(n.span, { class: "sr-only", children: ", opent in een nieuwe tab" })] }), "."] }) }) }), "\n", (0, i.jsx)(s.X, { appearance: "do", title: "Zichtbaar icoontje plus een aria-label voor screenreaders.", children: (0, i.jsx)(a.X, { language: "html", children: () => (0, i.jsx)(i.Fragment, { children: (0, i.jsx)(n.a, { href: "#", target: "_blank", class: "nlds-icon-ext", "aria-label": "Lees het privacybeleid (opent in een nieuwe tab)", children: "Lees het privacybeleid" }) }) }) }), "\n", (0, i.jsx)(s.X, { appearance: "dont", title: "Informatie over het openen in een nieuwe tab alleen aan screenreadergebruikers geven.", children: (0, i.jsx)(a.X, { language: "html", children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(n.a, { href: "#", target: "_blank", "aria-label": "Lees het privacybeleid (opent in een nieuwe tab)", children: "Lees het privacybeleid" }), "."] }) }) }), "\n", (0, i.jsx)(s.X, { appearance: "dont", title: "Informatie over het openen in een nieuwe tab voor iedereen weglaten.", children: (0, i.jsx)(a.X, { language: "html", children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(n.a, { href: "#", target: "_blank", children: "Lees het privacybeleid" }), "."] }) }) })] });
   }
   function u(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
   ...
   function g(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: ["\n", "\n", "\n", (0, i.jsx)(s.X, { appearance: "do", title: "Heel basaal, de link vlak boven het formulierveld plaatsen.", children: (0, i.jsx)(a.X, { language: "html", children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(n.p, { children: [(0, i.jsx)(n.a, { href: "#", children: "Privacybeleid gemeente Voorbeeld" }), "."] }), (0, i.jsx)(n.input, { id: "pb", type: "checkbox", name: "privacybeleid" }), (0, i.jsx)(n.label, { for: "pb", children: "Ik ga akkoord met het privacybeleid" })] }) }) }), "\n", (0, i.jsx)(s.X, { appearance: "do", title: "Groeperen met een fieldset en de informatie koppelen aan het formulierveld met een aria-describedby.", children: (0, i.jsx)(a.X, { language: "html", children: () => (0, i.jsxs)(n.fieldset, { children: [(0, i.jsx)(n.legend, { children: "Privacystatement gemeente Voorbeeld" }), (0, i.jsxs)(n.p, { id: "desc", children: ["Wij hebben jouw toestemming nodig om je e-mailadres op te slaan zodat we je onze nieuwsbrief kunnen sturen. Lees onze ", (0, i.jsx)(n.a, { href: "#", target: "_blank", children: "privacybeleid (opent in een nieuw venster)" }), "."] }), (0, i.jsx)(n.input, { type: "checkbox", "aria-describedby": "desc", id: "pvs" }), (0, i.jsx)(n.label, { for: "pvs", children: "Ik ga akkoord met het privacybeleid" })] }) }) }), "\n", (0, i.jsx)(s.X, { appearance: "dont", title: "Link in het label plaatsen.", children: (0, i.jsx)(a.X, { language: "html", children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(n.input, { id: "privacybeleid", type: "checkbox", name: "privacybeleid" }), " ", (0, i.jsxs)(n.label, { for: "privacybeleid", children: ["Ik ga akkoord met het ", (0, i.jsx)(n.a, { href: "#", children: "privacybeleid" })] })] }) }) }), "\n", (0, i.jsx)(s.X, { appearance: "dont", title: "Link samen met het invoerveld in een impliciet label plaatsen.", children: (0, i.jsx)(a.X, { language: "html", children: () => (0, i.jsxs)(n.label, { for: "tac", children: [(0, i.jsx)(n.input, { id: "tac", type: "checkbox", name: "terms-and-conditions" }), "Ik ga akkoord met het ", (0, i.jsx)(n.a, { href: "#", children: "privacybeleid" })] }) }) })] });
   }
   function j(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
   ...
   const x = { title: "Links in een formulier | Richtlijnen", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Links", sidebar_position: 7, pagination_label: "Links in een formulier", description: "Richtlijnen voor het plaatsen van links binnen een formulier.", keywords: ["links", "formulier", "design", "code"] },
    ...
    y = { id: "richtlijnen/formulieren/links", title: "Links in een formulier | Richtlijnen", description: "Richtlijnen voor het plaatsen van links binnen een formulier.", source: "@site/docs/richtlijnen/formulieren/links.mdx", sourceDirName: "richtlijnen/formulieren", slug: "/richtlijnen/formulieren/links", permalink: "/en/richtlijnen/formulieren/links", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/links.mdx", tags: [], version: "current", sidebarPosition: 7, frontMatter: { title: "Links in een formulier | Richtlijnen", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Links", sidebar_position: 7, pagination_label: "Links in een formulier", description: "Richtlijnen voor het plaatsen van links binnen een formulier.", keywords: ["links", "formulier", "design", "code"] }, sidebar: "richtlijnen", previous: { title: "Labels in een formulier", permalink: "/en/richtlijnen/formulieren/labels" }, next: { title: "Meerdere stappen", permalink: "/en/richtlijnen/formulieren/meerdere-stappen" } },
    _ = {},
    w = [];
   function z(e) {
   ...
   const v = (e) => {
    ...
    return (
     ...
     (0, m.jsxs)("div", {
      ...
      children: [
       w && (0, m.jsx)("div", { className: (0, r.Z)(h["nlds-canvas__example"]), children: (0, m.jsx)("div", { className: "voorbeeld-theme", style: _, children: (0, m.jsx)(C, { children: (0, m.jsx)(i.pu, { children: w }) }) }) }),
       k &&
        (0, m.jsx)("div", {
       ...
       k &&
        (0, m.jsxs)("div", {
         ...
         hidden: !X,
         children: [
          (0, m.jsx)(u.u, { syntax: y, textContent: L, trim: !0 }),
          l &&
           (0, m.jsx)("div", {
            className: (0, r.Z)(h["nlds-canvas__toolbar"]),
            children: (0, m.jsx)(i.zx, {
   ...
   function s(e) {
    ...
    return (
     ...
     (0, a.jsx)(r.y$, {
      ...
      language: l || "",
      children: (e) => {
       let { style: l, tokens: r, getLineProps: t, getTokenProps: s } = e;
       return (0, a.jsx)(i.dn, { style: l, children: r.map((e, l) => (0, a.jsxs)("span", { ...t({ line: e }), children: [n && (0, a.jsx)("span", { children: l + 1 }), e.map((e, n) => (0, a.jsx)("span", { ...s({ token: e }) }, n)), "\n"] }, l)) });
      },
     })
    );
   }
  ...
  30036: (e, n, l) => {
   ...
   const d = (e) => {
    ...
    const h = "Doen",
     ...
     m = p ? "figure" : "div",
     b = p ? "figcaption" : "div";
    return (0, o.jsxs)(m, { className: (0, a.Z)(s["nlds-guideline"], s[`nlds-guideline--${l}`]), id: "string" == typeof n ? n?.toLowerCase().replace(/\s/g, "-") : void 0, children: [(0, o.jsxs)(b, { className: (0, a.Z)(s["nlds-guideline__description"]), children: ["dont" === l ? (0, o.jsxs)(o.Fragment, { children: [(0, o.jsxs)(t.nv, { className: (0, a.Z)(s["nlds-guideline__badge"], s[`nlds-guideline__badge--${l}`]), children: [(0, o.jsx)(i.Z, { className: s["nlds-guideline__icon"] }), (0, o.jsx)("span", { className: s["nlds-guideline__title"], children: u })] }), (0, o.jsx)(t.nv, { children: n })] }) : (0, o.jsxs)(o.Fragment, { children: [(0, o.jsxs)(t.nv, { className: (0, a.Z)(s["nlds-guideline__badge"], s[`nlds-guideline__badge--${l}`]), children: [(0, o.jsx)(r.Z, { className: s["nlds-guideline__icon"] }), (0, o.jsx)("span", { className: s["nlds-guideline__title"], children: h })] }), (0, o.jsx)(t.nv, { children: n })] }), d] }), (0, o.jsx)("div", { className: (0, a.Z)(s["nlds-guideline__example"]), children: c })] });
   };
  },
  27034: (e, n, l) => {
   l.d(n, { Z: () => s, a: () => a });
