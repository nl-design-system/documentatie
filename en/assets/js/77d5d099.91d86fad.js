 ...
 [49e3],
 {
  97391: (e, n, t) => {
   ...
   function a(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Zorg voor voldoende kleurcontrast tussen de achtergrondkleur en de kleur van componenten die visueel betekenis hebben.' }), '\n', (0, r.jsx)(n.p, { children: 'Bijvoorbeeld:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: 'Een icoon dat betekenis heeft, zoals de 3 streepjes voor een menu of een pijltje naar rechts voor de volgende pagina.' }), '\n', (0, r.jsx)(n.li, { children: 'Een icoon dat de status aangeeft van een bericht zoals een oranje driehoek voor een waarschuwing en een groen vinkje voor succes.' }), '\n', (0, r.jsx)(n.li, { children: 'Een rode rand die aangeeft dat een invoerveld fouten bevat (als aanvulling op de foutmelding in tekst).' }), '\n'] }), '\n', (0, r.jsx)(n.p, { children: 'Het gemeten kleurcontrast tussen het element en de achtergrond moet minstens 3:1 zijn.' }), '\n', (0, r.jsx)(n.p, { children: 'Er is een uitzondering voor inactieve componenten, zoals uitgeschakelde buttons, invoervelden, aankruisvakjes en keuzerondjes. En voor het kleurcontrast voor componenten die door de browser worden bepaald en niet niet kunnen worden veranderd.' })] });
   }
   function c(e = {}) {
    const { wrapper: n } = { ...(0, s.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(a, { ...e }) }) : a(e);
   }
   const d = { title: 'WCAG-succescriterium 1.4.11 Contrast van niet-tekstuele content', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.11 Contrast van niet-tekstuele content', pagination_label: 'WCAG-succescriterium 1.4.11 Contrast van niet-tekstuele content', description: 'Zorg voor voldoende kleurcontrast tussen de achtergrondkleur en de kleur van componenten die visueel betekenis hebben.', slug: '1.4.11', keywords: ['WCAG'] },
    u = void 0,
    h = { id: 'wcag/1.4.11', title: 'WCAG-succescriterium 1.4.11 Contrast van niet-tekstuele content', description: 'Zorg voor voldoende kleurcontrast tussen de achtergrondkleur en de kleur van componenten die visueel betekenis hebben.', source: '@site/docs/wcag/1.4.11.mdx', sourceDirName: 'wcag', slug: '/wcag/1.4.11', permalink: '/en/wcag/1.4.11', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.11.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.4.11 Contrast van niet-tekstuele content', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.11 Contrast van niet-tekstuele content', pagination_label: 'WCAG-succescriterium 1.4.11 Contrast van niet-tekstuele content', description: 'Zorg voor voldoende kleurcontrast tussen de achtergrondkleur en de kleur van componenten die visueel betekenis hebben.', slug: '1.4.11', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.4.10 Reflow', permalink: '/en/wcag/1.4.10' }, next: { title: 'WCAG-succescriterium 1.4.12 Tekstafstand', permalink: '/en/wcag/1.4.12' } },
    g = {},
    p = [
  ...
  72657: (e, n, t) => {
   ...
   const o = (e) => {
    ...
    return (0, i.jsxs)('hgroup', { className: (0, r.Z)(s['nlds-inline-heading-group'], `utrecht-heading-${o}`, t), ...a, children: [(0, i.jsx)('h1', { className: (0, r.Z)(s['nlds-inline-heading-group__heading']), children: n }), l && (0, i.jsxs)('p', { className: (0, r.Z)(s['nlds-inline-heading-group__suffix']), children: [l ? ' ' : '', l] })] });
   };
  },
  71595: (e, n, t) => {
   t.d(n, { j: () => a });
   ...
   const a = (e) => {
    ...
    return (0, l.jsx)(s.V, { className: i, suffix: t && (0, l.jsx)(r.Ou, { className: o, children: t }), ...a, children: n });
   };
  },
  24785: (e, n, t) => {
   t.d(n, { Z: () => l, a: () => o });
