 ...
 [45119],
 {
  46832: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    o = n(16391);
   const s = { title: 'Date picker', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date picker', pagination_label: 'Date picker', description: ' ', slug: '/date-picker', sidebar_custom_props: { illustration: 'DatePickerSketch' } },
    a = void 0,
    u = { id: 'componenten/date-picker/index', title: 'Date picker', description: ' ', source: '@site/docs/componenten/date-picker/index.mdx', sourceDirName: 'componenten/date-picker', slug: '/date-picker', permalink: '/en/date-picker', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-picker/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Date picker', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date picker', pagination_label: 'Date picker', description: ' ', slug: '/date-picker', sidebar_custom_props: { illustration: 'DatePickerSketch' } }, sidebar: 'componenten', previous: { title: 'Date input group', permalink: '/en/date-input-group' }, next: { title: 'Definition list', permalink: '/en/definition-list' } },
    l = {},
    d = [
  ...
  16391: (e, t, n) => {
   ...
   const b = 'task-list_hh8j',
    ...
    D = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, c.Z)(f), children: [(0, l.jsxs)('div', { className: (0, c.Z)(_, { [x]: t }), children: [(0, l.jsx)('span', { className: w, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(v.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(k.aC, { role: 'presentation', children: n }), (0, l.jsx)(k.nv, { children: r })] })] });
    };
   var A = n(14669);
   const S = Object.keys({ HELP_WANTED: 'UNKNOWN', COMMUNITY: 'HELP_WANTED', CANDIDATE: 'COMMUNITY', HALL_OF_FAME: 'CANDIDATE' }),
    z = (e) => {
     ...
     const i = t && t.projects.filter((e) => S.includes(e.id)),
      o = i && S.map((e) => i.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
