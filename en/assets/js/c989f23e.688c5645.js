...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [8267],
 {
  ...
  52484: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => Z, contentTitle: () => G, default: () => I, frontMatter: () => D, metadata: () => S, toc: () => V });
   var t = i(11527),
    r = i(47214),
    l = i(73460),
    o = i(30036);
   ...
   var C = i(3324);
   const D = { title: "Foutmeldingen | Richtlijnen | NL Design System", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Foutmeldingen", pagination_label: "Foutmeldingen", description: "Als een veld niet goed is ingevuld, moet voor iedereen duidelijk zijn wat er niet klopt. Hoe help je de gebruiker het beste als die onjuiste of onvolledige informatie invult?", slug: "foutmeldingen", keywords: ["informatie", "formulier", "design", "code"] },
    G = "Foutmeldingen",
    S = { id: "richtlijnen/formulieren/alle-richtlijnen/errors", title: "Foutmeldingen | Richtlijnen | NL Design System", description: "Als een veld niet goed is ingevuld, moet voor iedereen duidelijk zijn wat er niet klopt. Hoe help je de gebruiker het beste als die onjuiste of onvolledige informatie invult?", source: "@site/docs/richtlijnen/formulieren/00-alle-richtlijnen/errors.mdx", sourceDirName: "richtlijnen/formulieren/00-alle-richtlijnen", slug: "/richtlijnen/formulieren/alle-richtlijnen/foutmeldingen", permalink: "/en/richtlijnen/formulieren/alle-richtlijnen/foutmeldingen", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/00-alle-richtlijnen/errors.mdx", tags: [], version: "current", frontMatter: { title: "Foutmeldingen | Richtlijnen | NL Design System", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Foutmeldingen", pagination_label: "Foutmeldingen", description: "Als een veld niet goed is ingevuld, moet voor iedereen duidelijk zijn wat er niet klopt. Hoe help je de gebruiker het beste als die onjuiste of onvolledige informatie invult?", slug: "foutmeldingen", keywords: ["informatie", "formulier", "design", "code"] }, sidebar: "richtlijnen", previous: { title: "Bevestigingspagina", permalink: "/en/richtlijnen/formulieren/alle-richtlijnen/bevestigingspagina" }, next: { title: "Visueel ontwerp van formulieren", permalink: "/en/richtlijnen/formulieren/alle-richtlijnen/visueel-ontwerp" } },
    Z = {},
    V = [];
   function W(e) {
    const n = { h1: "h1", li: "li", p: "p", ul: "ul", ...(0, r.a)(), ...e.components };
    return (0, t.jsxs)(t.Fragment, { children: ["\n", "\n", "\n", (0, t.jsx)(n.h1, { id: "foutmeldingen", children: "Foutmeldingen" }), "\n", (0, t.jsx)(n.p, { children: "Als een veld niet goed is ingevuld, moet voor iedereen duidelijk zijn wat er niet klopt. Hoe help je de gebruiker het beste als deze onjuiste of onvolledige informatie invult?" }), "\n", (0, t.jsx)(n.p, { children: "Belangrijk bij het aangeven van fouten:" }), "\n", (0, t.jsxs)(n.ul, { children: ["\n", (0, t.jsx)(n.li, { children: "Controleer op het juiste moment op fouten." }), "\n", (0, t.jsx)(n.li, { children: "Schrijf een foutmelding uit in tekst." }), "\n", (0, t.jsx)(n.li, { children: "Schrijf een duidelijke foutmelding." }), "\n", (0, t.jsx)(n.li, { children: "Zet de foutmeldingen bij de betreffende formuliervelden." }), "\n", (0, t.jsx)(n.li, { children: "Gebruik geen HTML-formuliervalidatie." }), "\n", (0, t.jsx)(n.li, { children: "Zet een samenvatting van de foutmeldingen boven het formulier." }), "\n", (0, t.jsx)(n.li, { children: "Geef feedback aan screenreadergebruikers." }), "\n"] }), "\n", (0, t.jsx)(z, {}), "\n", (0, t.jsx)(h, {}), "\n", (0, t.jsx)(m, {}), "\n", (0, t.jsx)(c, {}), "\n", (0, t.jsx)(d, {}), "\n", (0, t.jsx)(b, {}), "\n", (0, t.jsx)(f, {}), "\n", (0, t.jsx)(w, {}), "\n", (0, t.jsx)(N, {}), "\n", (0, t.jsx)(_, {}), "\n", (0, t.jsx)(g, {}), "\n", (0, t.jsx)(C.ZP, {})] });
   }
   function I(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
  ...
  73460: (e, n, i) => {
   ...
   const j = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(t.Tg, { className: h["nlds-canvas__example-surface"], children: (0, m.jsx)(t.BB, { className: (0, r.Z)("utrecht-document--surface", h["nlds-canvas__example-document"]), children: (0, m.jsx)(t.nv, { className: h["nlds-canvas__example-paragraph"], children: n }) }) });
   };
   j.displayName = "ParagraphContainer";
   const g = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(t.Tg, { className: h["nlds-canvas__example-surface"], children: (0, m.jsx)(t.BB, { className: (0, r.Z)("utrecht-document--surface", h["nlds-canvas__example-document"]), children: n }) });
   };
   g.displayName = "DocumentContainer";
   const v = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(t.Tg, { className: h["nlds-canvas__example-surface"], children: n });
   };
   v.displayName = "SurfaceContainer";
   const f = (e) => {
    let { code: n, copy: i = !1, defaultExpandedCode: f = !0, displayCode: x = !0, children: b, container: k = "document", language: w, designTokens: y } = e,
     _ = "function" == typeof b ? b() : b,
     A = "function" == typeof n ? n() : (0, c.isValidElement)(n) ? n : void 0,
     N = "string" == typeof n ? n : u.uS(A || _),
     [F, z] = (0, c.useState)(N),
     [C, D] = (0, c.useState)(f);
    (0, c.useEffect)(() => {
     (async () => {
      (F = await a.ZP.format(N, { parser: w, plugins: [l.Z, o.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), z(F);
     })();
    }, [N]);
    const G = (0, c.useId)();
    let S = c.Fragment;
    return (
     "paragraph" === k ? (S = j) : "document" === k ? (S = g) : "surface" === k && (S = v),
     (0, m.jsxs)("div", {
      className: (0, r.Z)(h["nlds-canvas"]),
      children: [
       _ && (0, m.jsx)("div", { className: (0, r.Z)(h["nlds-canvas__example"]), children: (0, m.jsx)("div", { className: "voorbeeld-theme", style: y, children: (0, m.jsx)(S, { children: (0, m.jsx)(t.pu, { children: _ }) }) }) }),
       x &&
        (0, m.jsx)("div", {
       ...
       x &&
        (0, m.jsxs)("div", {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(p.u, { syntax: w, textContent: F, trim: !0 }),
          i &&
           (0, m.jsx)("div", {
            className: (0, r.Z)(h["nlds-canvas__toolbar"]),
            children: (0, m.jsx)(t.zx, {
