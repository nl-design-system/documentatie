 ...
 [76318],
 {
  18130: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Pagination', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Pagination', pagination_label: 'Pagination', description: ' ', slug: '/pagination', sidebar_custom_props: { illustration: 'PaginationSketch' } },
    a = void 0,
    u = { id: 'componenten/pagination/index', title: 'Pagination', description: ' ', source: '@site/docs/componenten/pagination/index.mdx', sourceDirName: 'componenten/pagination', slug: '/pagination', permalink: '/en/pagination', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/pagination/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Pagination', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Pagination', pagination_label: 'Pagination', description: ' ', slug: '/pagination', sidebar_custom_props: { illustration: 'PaginationSketch' } }, sidebar: 'componenten', previous: { title: 'Page header', permalink: '/en/page-header' }, next: { title: 'Paragraph', permalink: '/en/paragraph' } },
    l = {},
    d = [
