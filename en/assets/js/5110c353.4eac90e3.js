 ...
 [40284],
 {
  18461: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    o = n(16391);
   const s = { title: 'Button', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Button', pagination_label: 'Button', description: 'Biedt de mogelijkheid om een actie uit te voeren.', slug: '/button', sidebar_custom_props: { illustration: 'ButtonSketch' } },
    a = void 0,
    u = { id: 'componenten/button/index', title: 'Button', description: 'Biedt de mogelijkheid om een actie uit te voeren.', source: '@site/docs/componenten/button/index.mdx', sourceDirName: 'componenten/button', slug: '/button', permalink: '/en/button', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/button/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Button', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Button', pagination_label: 'Button', description: 'Biedt de mogelijkheid om een actie uit te voeren.', slug: '/button', sidebar_custom_props: { illustration: 'ButtonSketch' } }, sidebar: 'componenten', previous: { title: 'Breadcrumb navigation', permalink: '/en/breadcrumb-navigation' }, next: { title: 'Calendar', permalink: '/en/Calendar' } },
    l = {},
    d = [
