 ...
 [77410],
 {
  42402: (e, n, t) => {
   ...
   function o(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(n.p, { children: ['De gebruiker moet tekst twee keer (200%) kunnen vergroten. Het gaat hier om ', (0, i.jsx)(n.strong, { children: 'alleen de tekst' }), ' groter maken, zonder ook bijvoorbeeld ook afbeeldingen te vergroten of de layout in te zoomen.'] }), '\n', (0, i.jsx)(n.p, { children: 'Alle functies, zoals het menu, moeten werken en zichtbaar zijn. Alle tekst moet leesbaar zijn. Er mag geen inhoud buiten beeld vallen, verborgen zijn of maar gedeeltelijk zichtbaar zijn.' }), '\n', (0, i.jsx)(n.p, { children: "Maak indien nodig een uitzondering voor de tekstgrootte instellen van tekst in afbeeldingen en van ondertitels in video's." })] });
   }
   function c(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
    return n ? (0, i.jsx)(n, { ...e, children: (0, i.jsx)(o, { ...e }) }) : o(e);
   }
   const d = { title: 'WCAG-succescriterium 1.4.4 Herschalen van tekst', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.4 Herschalen van tekst', pagination_label: 'WCAG-succescriterium 1.4.4 Herschalen van tekst', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', slug: '1.4.4', keywords: ['WCAG'] },
    u = void 0,
    h = { id: 'wcag/1.4.04', title: 'WCAG-succescriterium 1.4.4 Herschalen van tekst', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', source: '@site/docs/wcag/1.4.04.mdx', sourceDirName: 'wcag', slug: '/wcag/1.4.4', permalink: '/en/wcag/1.4.4', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.04.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.4.4 Herschalen van tekst', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.4 Herschalen van tekst', pagination_label: 'WCAG-succescriterium 1.4.4 Herschalen van tekst', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', slug: '1.4.4', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.4.3 Contrast (minimum)', permalink: '/en/wcag/1.4.3' }, next: { title: 'WCAG-succescriterium 1.4.5 Afbeeldingen van tekst', permalink: '/en/wcag/1.4.5' } },
    g = {},
    p = [
