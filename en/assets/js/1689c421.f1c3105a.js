...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [32942],
 {
  ...
  4700: (e, n, i) => {
   ...
   var l = i(23680);
   const d = { title: 'Zorg voor een logische volgorde van de informatie | Visueel ontwerp van een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Logische volgorde', pagination_label: 'Logische volgorde', description: 'Richtlijnen om informatie in een logische volgorde te tonen.', slug: '/richtlijnen/formulieren/visueel-ontwerp/logische-volgorde', keywords: ['labels', 'formulier', 'design', 'code'] },
    c = void 0,
    a = { id: 'richtlijnen/formulieren/visual-design/order/README', title: 'Zorg voor een logische volgorde van de informatie | Visueel ontwerp van een formulier | Richtlijnen', description: 'Richtlijnen om informatie in een logische volgorde te tonen.', source: '@site/docs/richtlijnen/formulieren/visual-design/8-order/README.mdx', sourceDirName: 'richtlijnen/formulieren/visual-design/8-order', slug: '/richtlijnen/formulieren/visueel-ontwerp/logische-volgorde', permalink: '/en/richtlijnen/formulieren/visueel-ontwerp/logische-volgorde', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/visual-design/8-order/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Zorg voor een logische volgorde van de informatie | Visueel ontwerp van een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Logische volgorde', pagination_label: 'Logische volgorde', description: 'Richtlijnen om informatie in een logische volgorde te tonen.', slug: '/richtlijnen/formulieren/visueel-ontwerp/logische-volgorde', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Geen afbeelding voor buttons', permalink: '/en/richtlijnen/formulieren/visueel-ontwerp/geen-afbeelding-voor-buttons' }, next: { title: 'Voorkom fouten in een formulier', permalink: '/en/richtlijnen/formulieren/voorkom-fouten/' } },
    u = {},
    m = [];
   function h(e) {
