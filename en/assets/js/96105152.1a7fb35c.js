 ...
 [20933],
 {
  72806: (e, n, i) => {
   ...
   const g = { title: 'WCAG-succescriterium 3.2.2 Bij input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.2 Bij input', pagination_label: 'WCAG-succescriterium 3.2.2 Bij input', description: 'Verras een gebruiker niet, maar maak functionaliteit voorspelbaar en daardoor goed te begrijpen. Als een gebruiker een formuliercomponent of -optie selecteert of een invoerveld invult met het toetsenbord of met de muis, veroorzaakt dit niet automatisch een contextwijziging.', slug: '3.2.2', keywords: ['WCAG'] },
    p = void 0,
    j = { id: 'wcag/3.2.02', title: 'WCAG-succescriterium 3.2.2 Bij input', description: 'Verras een gebruiker niet, maar maak functionaliteit voorspelbaar en daardoor goed te begrijpen. Als een gebruiker een formuliercomponent of -optie selecteert of een invoerveld invult met het toetsenbord of met de muis, veroorzaakt dit niet automatisch een contextwijziging.', source: '@site/docs/wcag/3.2.02.mdx', sourceDirName: 'wcag', slug: '/wcag/3.2.2', permalink: '/en/wcag/3.2.2', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.2.02.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 3.2.2 Bij input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.2 Bij input', pagination_label: 'WCAG-succescriterium 3.2.2 Bij input', description: 'Verras een gebruiker niet, maar maak functionaliteit voorspelbaar en daardoor goed te begrijpen. Als een gebruiker een formuliercomponent of -optie selecteert of een invoerveld invult met het toetsenbord of met de muis, veroorzaakt dit niet automatisch een contextwijziging.', slug: '3.2.2', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.2.1 Bij focus', permalink: '/en/wcag/3.2.1' }, next: { title: 'WCAG-succescriterium 3.2.3 Consistente navigatie', permalink: '/en/wcag/3.2.3' } },
    m = {},
    v = [
