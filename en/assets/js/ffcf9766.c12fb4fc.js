(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [7869],
 {
  73687: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => o, issueNumber: () => m, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(80719),
    s = n(90786);
   const o = { title: 'Number input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number input', pagination_label: 'Number input', description: 'Invoerveld voor een heel getal of een getal met decimalen.', slug: '/number-input' },
    a = void 0,
