 ...
 [79947],
 {
  99960: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Number badge', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number badge', pagination_label: 'Number badge', description: 'Klein label dat de aandacht trekt informeert over een aantal.', slug: '/number-badge', sidebar_custom_props: { illustration: 'NumberBadgeSketch' } },
    a = void 0,
    u = { id: 'componenten/number-badge/index', title: 'Number badge', description: 'Klein label dat de aandacht trekt informeert over een aantal.', source: '@site/docs/componenten/number-badge/index.mdx', sourceDirName: 'componenten/number-badge', slug: '/number-badge', permalink: '/en/number-badge', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/number-badge/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Number badge', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number badge', pagination_label: 'Number badge', description: 'Klein label dat de aandacht trekt informeert over een aantal.', slug: '/number-badge', sidebar_custom_props: { illustration: 'NumberBadgeSketch' } }, sidebar: 'componenten', previous: { title: 'Notification banner', permalink: '/en/notification-banner' }, next: { title: 'Number input', permalink: '/en/number-input' } },
    l = {},
    d = [
    ...
    h = 'Number badge',
    j = 'Klein label dat de aandacht trekt informeert over een aantal.',
    y = 'NumberBadgeSketch',
    m = 7,
