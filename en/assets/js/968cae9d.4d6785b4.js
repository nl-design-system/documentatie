...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [81733],
 {
  ...
  66771: (e, n, t) => {
   ...
   const _ = (e) => {
    let { code: n, copy: t = !0, defaultExpandedCode: _ = !1, displayCode: j = !0, children: f, container: x = 'document', language: y, designTokens: k } = e,
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await c.ZP.format(z, { parser: y, plugins: [r.Z, s.ZP, i.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(Z);
     })();
    }, [z]);
    const V = (0, d.useId)();
    let P = d.Fragment;
    return (
     'paragraph' === x ? (P = v) : 'document' === x ? (P = b) : 'surface' === x && (P = g),
     (0, p.jsxs)('div', {
      ...
      children: [
       ...
       j &&
        (0, p.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, p.jsx)(h.u, { syntax: y, textContent: Z, trim: !0 }),
          t &&
           (0, p.jsx)('div', {
