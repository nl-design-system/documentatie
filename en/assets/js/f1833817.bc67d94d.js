  ...
  23952: (e, n, t) => {
   ...
   const x = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, d.jsxs)('li', { className: (0, i.Z)(f), children: [(0, d.jsxs)('div', { className: (0, i.Z)(_, n && w), children: [(0, d.jsx)('span', { className: z, children: n ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), n && (0, d.jsx)(v.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(k.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), a, t] })] });
    };
   var T = t(14669);
   const S = (e) => {
     let { component: n, headingLevel: t } = e;
     const a = n && n.projects.filter((e) => T.e9.includes(e.id)),
      o = a && T.e9.map((e) => a.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
