 ...
 [88094],
 {
  56320: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(87176),
    s = n(90786);
   const o = { title: 'Fieldset', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Fieldset', pagination_label: 'Fieldset', description: 'Groep van gerelateerde formuliervelden.', slug: '/fieldset' },
    a = void 0,
    l = { id: 'componenten/fieldset/index', title: 'Fieldset', description: 'Groep van gerelateerde formuliervelden.', source: '@site/docs/componenten/fieldset/index.mdx', sourceDirName: 'componenten/fieldset', slug: '/fieldset', permalink: '/en/fieldset', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/fieldset/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Fieldset', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Fieldset', pagination_label: 'Fieldset', description: 'Groep van gerelateerde formuliervelden.', slug: '/fieldset' }, sidebar: 'componenten', previous: { title: 'Drawer', permalink: '/en/drawer' }, next: { title: 'Figure', permalink: '/en/figure' } },
    u = {},
    d = [
    ...
    h = 'Fieldset',
    j = 'Groep van gerelateerde formuliervelden.',
    y = 124,
