...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [37275],
 {
   ...
   var s = r.createContext({}),
    ...
    m = r.forwardRef(function (e, n) {
     var t = e.components,
      ...
      u = d(t),
      m = i,
      k = u["".concat(s, ".").concat(m)] || u[m] || c[m] || a;
     return t ? r.createElement(k, l(l({ ref: n }, p), {}, { components: t })) : r.createElement(k, l({ ref: n }, p));
    });
   function k(e, n) {
    var t = arguments,
     i = n && n.mdxType;
    if ("string" == typeof e || i) {
     ...
     (o.originalType = e), (o[u] = "string" == typeof e ? e : i), (l[1] = o);
  ...
  18713: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => s, contentTitle: () => l, default: () => c, frontMatter: () => a, metadata: () => o, toc: () => d });
   var r = t(87462),
    i = (t(67294), t(3905));
