 ...
 [41990],
 {
  62910: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(81301),
    o = n(90786);
   const s = { title: 'Separator', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Separator', pagination_label: 'Separator', description: 'Toont een horizontale lijn om content te scheiden.', slug: '/separator' },
    a = void 0,
    l = { id: 'componenten/separator/index', title: 'Separator', description: 'Toont een horizontale lijn om content te scheiden.', source: '@site/docs/componenten/separator/index.mdx', sourceDirName: 'componenten/separator', slug: '/separator', permalink: '/en/separator', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/separator/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Separator', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Separator', pagination_label: 'Separator', description: 'Toont een horizontale lijn om content te scheiden.', slug: '/separator' }, sidebar: 'componenten', previous: { title: 'Select', permalink: '/en/select' }, next: { title: 'Side Navigation', permalink: '/en/side-navigation' } },
    u = {},
    d = [
    ...
    h = 'Separator',
    j = 'Toont een horizontale lijn om content te scheiden.',
    y = 119,
