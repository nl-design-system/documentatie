...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [7468],
 {
  ...
  60890: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => U, contentTitle: () => S, default: () => D, frontMatter: () => F, metadata: () => C, toc: () => X });
   var i = t(11527),
    l = t(47214),
    r = t(3324),
    o = t(73460),
   ...
   const F = { title: "Uit te vragen informatie in een formulier | Richtlijnen | NL Design System", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Uit te vragen informatie", pagination_label: "Uit te vragen informatie in een formulier", description: "Richtlijnen voor uit te vragen informatie in een formulier.", slug: "vragen", keywords: ["informatie", "formulier", "design", "code"] },
    ...
    C = { id: "richtlijnen/formulieren/alle-richtlijnen/questions", title: "Uit te vragen informatie in een formulier | Richtlijnen | NL Design System", description: "Richtlijnen voor uit te vragen informatie in een formulier.", source: "@site/docs/richtlijnen/formulieren/00-alle-richtlijnen/questions.mdx", sourceDirName: "richtlijnen/formulieren/00-alle-richtlijnen", slug: "/richtlijnen/formulieren/alle-richtlijnen/vragen", permalink: "/en/richtlijnen/formulieren/alle-richtlijnen/vragen", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/00-alle-richtlijnen/questions.mdx", tags: [], version: "current", frontMatter: { title: "Uit te vragen informatie in een formulier | Richtlijnen | NL Design System", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Uit te vragen informatie", pagination_label: "Uit te vragen informatie in een formulier", description: "Richtlijnen voor uit te vragen informatie in een formulier.", slug: "vragen", keywords: ["informatie", "formulier", "design", "code"] }, sidebar: "richtlijnen", previous: { title: "Placeholders in een formulier", permalink: "/en/richtlijnen/formulieren/alle-richtlijnen/placeholders" }, next: { title: "Visueel ontwerp van formulieren", permalink: "/en/richtlijnen/formulieren/alle-richtlijnen/visueel-ontwerp" } },
    U = {},
    X = [];
   function B(e) {
  ...
  73460: (e, n, t) => {
   ...
   const g = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(i.Tg, { className: u["nlds-canvas__example-surface"], children: (0, h.jsx)(i.BB, { className: (0, l.Z)("utrecht-document--surface", u["nlds-canvas__example-document"]), children: (0, h.jsx)(i.nv, { className: u["nlds-canvas__example-paragraph"], children: n }) }) });
   };
   g.displayName = "ParagraphContainer";
   const v = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(i.Tg, { className: u["nlds-canvas__example-surface"], children: (0, h.jsx)(i.BB, { className: (0, l.Z)("utrecht-document--surface", u["nlds-canvas__example-document"]), children: n }) });
   };
   ...
   const x = (e) => {
    ...
    return (
     ...
     (0, h.jsxs)("div", {
      ...
      children: [
       w && (0, h.jsx)("div", { className: (0, l.Z)(u["nlds-canvas__example"]), children: (0, h.jsx)("div", { className: "voorbeeld-theme", style: k, children: (0, h.jsx)(X, { children: (0, h.jsx)(i.pu, { children: w }) }) }) }),
       f &&
        (0, h.jsx)("div", {
       ...
       f &&
        (0, h.jsxs)("div", {
         ...
         hidden: !S,
         children: [
          (0, h.jsx)(p.u, { syntax: y, textContent: Z, trim: !0 }),
          t &&
           (0, h.jsx)("div", {
            className: (0, l.Z)(u["nlds-canvas__toolbar"]),
            children: (0, h.jsx)(i.zx, {
