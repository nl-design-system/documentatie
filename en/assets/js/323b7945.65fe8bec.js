 ...
 [1875],
 {
  ...
  82415: (e, t, n) => {
   ...
   var a = n(83778),
    ...
    r = n(11527);
   const l = (e) => {
    let { listId: t = "", laPostaId: n = "", thanksPage: l = "", emailFieldId: d = "", firstNameFieldId: o = "", orgId: m = "", interestsId: c = "", interests: h = [], workAreasId: p = "" } = e;
    const {
      register: u,
      handleSubmit: v,
      formState: { errors: j },
    ...
    return (0, r.jsxs)("form", {
     ...
     children: [(0, r.jsxs)(a.Wi, { type: "email", children: [(0, r.jsx)(a.nv, { children: (0, r.jsx)(a.lX, { htmlFor: `id-${d}`, children: "E-mailadres" }) }), j[d] && (0, r.jsx)(a.w7, { children: (0, r.jsx)(a.nv, { children: j[d].message }) }), (0, r.jsx)(a.nv, { children: (0, r.jsx)(a.fE, { id: `id-${d}`, name: d, type: "email", "aria-required": "true", autoComplete: "email", ...u(`${d}`, { required: { value: !0, message: "Dit veld is verplicht, maar het is niet ingevuld." }, pattern: { value: /\S+@\S+\.\S+/, message: "Dit is geen correct emailadres." } }), invalid: !!j[d] }) })] }), (0, r.jsxs)(a.Wi, { type: "text", children: [(0, r.jsx)(a.nv, { children: (0, r.jsx)(a.lX, { htmlFor: o, children: "Naam (niet verplicht)" }) }), (0, r.jsx)(a.nv, { children: (0, r.jsx)(a.fE, { id: o, name: o, type: "text", autoComplete: "given-name" }) })] }), m && (0, r.jsxs)(a.Wi, { type: "text", children: [(0, r.jsx)(a.nv, { children: (0, r.jsx)(a.lX, { htmlFor: m, children: "Organisatie (niet verplicht)" }) }), (0, r.jsx)(a.nv, { children: (0, r.jsx)(a.fE, { id: m, name: m, type: "text" }) })] }), c && (0, r.jsxs)(a.pg, { children: [(0, r.jsx)(a.Qv, { children: "Waar ligt je interesse? (meerdere opties mogelijk; niet verplicht)" }), h.map((e, t) => (0, r.jsx)(a.Wi, { type: "checkbox", children: (0, r.jsxs)(a.nv, { children: [(0, r.jsx)(a.XZ, { name: `${c}[]`, value: t + 1, id: `${c}-${t + 1}` }), (0, r.jsx)(a.lX, { htmlFor: `${c}-${t + 1}`, children: e })] }) }, e))] }), p && (0, r.jsxs)(a.Wi, { type: "text", children: [(0, r.jsx)(a.nv, { children: (0, r.jsx)(a.lX, { htmlFor: p, children: "Waar werk je momenteel vooral aan? Denk aan mijn-omgevingen, formulieren, kaarten. (niet verplicht)" }) }), (0, r.jsx)(a.nv, { children: (0, r.jsx)(a.fE, { id: p, name: p, type: "text" }) })] }), (0, r.jsx)(a.hE, { children: (0, r.jsx)(a.zx, { type: "submit", appearance: "primary-action-button", children: "Aanmelden" }) }), (0, r.jsx)("input", { type: "hidden", name: "next", value: l }), (0, r.jsx)("input", { type: "hidden", name: "a", value: n }), (0, r.jsx)("input", { type: "hidden", name: "l", value: t }), (0, r.jsx)("input", { name: "osnD9cWRI3", autoComplete: "on", id: "id-osnD9cWRI3", type: "hidden", value: "NLDS website" }), (0, r.jsx)("input", { autoComplete: "new-password", type: "email", id: "email", name: "email", placeholder: "Your e-mail here", className: "sr-only", "aria-hidden": "true" })],
    });
   };
  },
  80877: (e, t, n) => {
