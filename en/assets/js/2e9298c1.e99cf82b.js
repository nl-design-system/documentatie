...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  90093: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => b, contentTitle: () => u, default: () => x, frontMatter: () => g, metadata: () => j, toc: () => v });
   var t = i(52676),
    s = i(24785),
    r = i(57716),
    a = i(73381),
   ...
   const g = { title: 'WCAG-succescriterium 2.4.1 Blokken omzeilen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.1 Blokken omzeilen', pagination_label: 'WCAG-succescriterium 2.4.1 Blokken omzeilen', description: 'Geef toetsenbordgebruikers de mogelijkheid om binnen een pagina sneller te navigeren door onderdelen te kunnen overslaan.', slug: '2.4.1', keywords: ['WCAG'] },
    u = void 0,
    j = { id: 'wcag/2.4.01', title: 'WCAG-succescriterium 2.4.1 Blokken omzeilen', description: 'Geef toetsenbordgebruikers de mogelijkheid om binnen een pagina sneller te navigeren door onderdelen te kunnen overslaan.', source: '@site/docs/wcag/2.4.01.mdx', sourceDirName: 'wcag', slug: '/wcag/2.4.1', permalink: '/en/wcag/2.4.1', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.01.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.4.1 Blokken omzeilen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.1 Blokken omzeilen', pagination_label: 'WCAG-succescriterium 2.4.1 Blokken omzeilen', description: 'Geef toetsenbordgebruikers de mogelijkheid om binnen een pagina sneller te navigeren door onderdelen te kunnen overslaan.', slug: '2.4.1', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.3.3 Animatie uit interacties', permalink: '/en/wcag/2.3.3' }, next: { title: 'WCAG-succescriterium 2.4.2 Paginatitel', permalink: '/en/wcag/2.4.2' } },
    b = {},
    v = [
  ...
  72657: (e, n, i) => {
   ...
   const a = (e) => {
    ...
    return (0, r.jsxs)('hgroup', { className: (0, t.Z)(s['nlds-inline-heading-group'], `utrecht-heading-${a}`, i), ...o, children: [(0, r.jsx)('h1', { className: (0, t.Z)(s['nlds-inline-heading-group__heading']), children: n }), l && (0, r.jsxs)('p', { className: (0, t.Z)(s['nlds-inline-heading-group__suffix']), children: [l ? ' ' : '', l] })] });
   };
  },
  57716: (e, n, i) => {
   i.d(n, { U: () => c });
  ...
  73381: (e, n, i) => {
   ...
   const o = (e) => {
    ...
    return (0, l.jsx)(r(), { url: `https://youtube.com/watch?v=${n}`, className: `${(0, t.Z)(a['video-player'])} ${i}`, width: '100%', height: '100%', controls: !0, ...s, config: { youtube: { playerVars: { disablekb: 1 } } } });
   };
  },
  71595: (e, n, i) => {
   i.d(n, { j: () => o });
   ...
   const o = (e) => {
    ...
    return (0, l.jsx)(s.V, { className: r, suffix: i && (0, l.jsx)(t.Ou, { className: a, children: i }), ...o, children: n });
   };
  },
 },
]);
