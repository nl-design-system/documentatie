(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [32652],
 {
  58057: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => y, contentTitle: () => a, default: () => m, description: () => j, frontMatter: () => s, issueNumber: () => g, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(7617),
    o = n(4460);
   const s = { title: 'Spinner', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Spinner', pagination_label: 'Spinner', description: 'Een animatie die aangeeft dat een proces nog bezig is, waardoor een deel van de pagina nog niet volledig is geladen of knoppen niet bedienbaar zijn.', slug: '/spinner' },
    a = void 0,
    l = { id: 'componenten/spinner/index', title: 'Spinner', description: 'Een animatie die aangeeft dat een proces nog bezig is, waardoor een deel van de pagina nog niet volledig is geladen of knoppen niet bedienbaar zijn.', source: '@site/docs/componenten/spinner/index.mdx', sourceDirName: 'componenten/spinner', slug: '/spinner', permalink: '/en/spinner', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/spinner/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Spinner', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Spinner', pagination_label: 'Spinner', description: 'Een animatie die aangeeft dat een proces nog bezig is, waardoor een deel van de pagina nog niet volledig is geladen of knoppen niet bedienbaar zijn.', slug: '/spinner' }, sidebar: 'componenten', previous: { title: 'Skip link', permalink: '/en/skip-link' }, next: { title: 'Status badge', permalink: '/en/status-badge' } },
    u = {},
    d = [
    ...
    h = 'Spinner',
    j = 'Een animatie die aangeeft dat een proces nog bezig is, waardoor een deel van de pagina nog niet volledig is geladen of knoppen niet bedienbaar zijn.',
    g = 75,
  ...
  4460: (e, t, n) => {
   ...
   var m = n(80407);
   const b = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    v = (e) => {
     let { children: t, level: n = 1, suffix: r } = e;
     return (0, u.jsxs)('hgroup', { className: (0, i.Z)(b['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, u.jsx)('h1', { className: (0, i.Z)(b['nlds-inline-heading-group__heading']), children: t }), r && (0, u.jsxs)('p', { className: (0, i.Z)(b['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var k = n(46506),
    f = n(25953);
   const _ = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: S, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(k.aC, { role: 'presentation', children: n }), (0, u.jsx)(k.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => D.e9.includes(e.id)),
      o = c && D.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, u.jsx)(z, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(A, { checked: t, title: n, description: (0, D.Q6)(r) }, r);
            }),
           }),
            ...
            j.Zb,
            {
             ...
             children: (0, u.jsxs)(j.aY, {
              children: [
               ...
               (0, u.jsxs)(r.nv, { children: [(0, u.jsx)(p, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(r.rU, { href: e.url, children: [e.title, ' projectbord'] })] }),
               s.length &&
                (0, u.jsxs)(u.Fragment, {
                 children: [
    ...
    M = (e) => {
     ...
     const c = t && D.$3[t.relayStep];
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(v, { level: n, suffix: c && (0, u.jsx)(m.y, { state: c }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
