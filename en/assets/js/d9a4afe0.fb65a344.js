 ...
 [23020],
 {
  13455: (e, l, o) => {
   ...
   const p = (e) => {
    ...
    h = (e) => {
     let { code: l, copy: o = !1, defaultCollapsed: t = !1, children: i, language: s } = e;
     const h = u().format(b.uS(l || i), { parser: "html", plugins: [r(), c()], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" }),
      _ = (0, v.Z)();
     return n.createElement(
      "div",
      { className: (0, d.Z)(a["nlds-canvas"], "voorbeeld-theme", "utrecht-html") },
      n.createElement("div", { className: (0, d.Z)(a["nlds-canvas__example"]) }, i),
      n.createElement("div", { className: (0, d.Z)(a["nlds-canvas__toolbar"]) }, n.createElement(m.zx, { className: (0, d.Z)(a["nlds-canvas__button"], a["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: p, "aria-expanded": !t, "aria-controls": _ }, t ? "Bekijk code" : "Verberg code")),
      n.createElement(
       "div",
       { className: (0, d.Z)(a["nlds-canvas__code-block"], !o && a["nlds-canvas__code-block--user-select-none"]), id: _, hidden: t },
       n.createElement(k.Z, { language: s, style: g }, h),
       o &&
        n.createElement(
         "div",
         { className: (0, d.Z)(a["nlds-canvas__toolbar"]) },
         n.createElement(
          m.zx,
          {
           className: (0, d.Z)(a["nlds-canvas__button"], a["nlds-canvas__copy-button"]),
  ...
  31092: (e, l, o) => {
   ...
   const c = (e) => {
    ...
    const u = { do: "Doen", dont: "Niet doen" },
     b = l ? `${u[o]}: ${l}` : u[o];
    return n.createElement("div", { className: (0, r.Z)(t["nlds-guideline"], t[`nlds-guideline--${o}`]), id: null == l ? void 0 : l.toLowerCase().replace(/\s/g, "-") }, n.createElement("div", { className: (0, r.Z)(t["nlds-guideline__description"]) }, "dont" === o ? n.createElement(i.nv, { className: (0, r.Z)(t["nlds-guideline__badge"], t[`nlds-guideline__badge--${o}`]) }, n.createElement(a.Z, { className: t["nlds-guideline__icon"] }), n.createElement("span", { className: t["nlds-guideline__title"] }, b)) : n.createElement(i.nv, { className: (0, r.Z)(t["nlds-guideline__badge"], t[`nlds-guideline__badge--${o}`]) }, n.createElement(d.Z, { className: t["nlds-guideline__icon"] }), n.createElement("span", { className: t["nlds-guideline__title"] }, b)), c), n.createElement("div", { className: (0, r.Z)(t["nlds-guideline__example"]) }, s));
   };
  },
  70618: (e, l, o) => {
   o.r(l), o.d(l, { assets: () => b, contentTitle: () => s, default: () => v, frontMatter: () => c, metadata: () => u, toc: () => k });
   var n = o(87462),
    a = o(67294),
    d = o(3905),
    t = o(13455),
   ...
   function v(e) {
    ...
    return (0, d.kt)(m, (0, n.Z)({}, g, o, { components: l, mdxType: "MDXLayout" }), (0, d.kt)("h1", { id: "duidelijk" }, "Duidelijk"), (0, d.kt)(i.nv, { lead: !0, mdxType: "Paragraph" }, "Een duidelijk formulier zorgt dat gebruikers met meer vertrouwen en zelfstandiger door je formulier kunnen gaan."), (0, d.kt)("h2", { id: "vermijd-belangrijke-informatie-in-tooltips" }, "Vermijd belangrijke informatie in tooltips"), (0, d.kt)("p", null, "Informatie die nodig is om een veld in te kunnen vullen, kan beste beste worden opgenomen als onderdeel van de content, bijvoorbeeld als omschrijving onder het label. Vermijd het gebruik van tooltips (of placeholders) voor belangrijke informatie.."), (0, d.kt)("h2", { id: "leg-jargon-uit" }, "Leg jargon uit"), (0, d.kt)("p", null, "Soms is het niet te voorkomen dat een formulier jargon bevat, bijvoorbeeld omdat termen wettelijk zijn vastgelegd. Leg in zulke gevallen duidelijk uit wat zo'n term betekent."), (0, d.kt)("h2", { id: "houd-taal-consistent" }, "Houd taal consistent"), (0, d.kt)("p", null, "Zorg ervoor dat door het hele formulier voor dezelfde dingen dezelfde termen worden gebruikt."), (0, d.kt)("h2", { id: "duidelijke-labels" }, "Duidelijke labels"), (0, d.kt)("p", null, "Het doel van een label is dat de gebruiker de vraag begrijpt. Een effectief label is duidelijk en beschrijvend. Waar nodig wordt er ook extra hulp geboden worden, zoals een omschrijving van waar een BSN-nummer te vinden is.\nLees hierover meer op de ", (0, d.kt)("a", { parentName: "p", href: "/richtlijnen/formulieren/alle-richtlijnen/labels" }, "richtlijnen over labels"), "."), (0, d.kt)("h2", { id: "leg-uit-waarom-informatie-nodig-is" }, "Leg uit waarom informatie nodig is"), (0, d.kt)("p", null, "Soms lijkt een vraag overbodig, terwijl deze essentieel is. In zulke gevallen is het een goed idee een korte uitleg toe te vroegen, om bijvoorbeeld het doel te beschrijven."), (0, d.kt)(r.X, { appearance: "do", title: "Leg het doel uit", description: "Met uitleg weet de gebruiker waar die aan toe is.", mdxType: "Guideline" }, (0, d.kt)(t.X, { language: "html", code: (0, d.kt)(a.Fragment, null, (0, d.kt)("label", { htmlFor: "email" }, "Emailadres"), (0, d.kt)("p", null, "We hebben uw emailadres nodig om een afspraakbevestiging te kunnen sturen."), (0, d.kt)("input", { type: "text", name: "email", id: "email" })), defaultCollapsed: !0, mdxType: "Canvas" }, (0, d.kt)(i.Wi, { type: "text", mdxType: "FormField" }, (0, d.kt)(i.nv, { className: "utrecht-form-field__label", mdxType: "Paragraph" }, (0, d.kt)(i.lX, { htmlFor: "email", mdxType: "FormLabel" }, "Emailadres"), (0, d.kt)(i.ue, { mdxType: "FormFieldDescription" }, "We hebben uw emailadres nodig om een afspraakbevestiging te kunnen sturen.")), (0, d.kt)(i.fE, { name: "email", id: "email", mdxType: "Textbox" })))));
   }
   v.isMDXComponent = !0;
  },
 },
