 ...
 [97366],
 {
  ...
  98480: (e, n, l) => {
   ...
   const h = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (C = await a.ZP.format(Z, { parser: x, plugins: [o.Z, i.ZP, c.ZP, r.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), D(C);
     })();
    }, [Z]);
    const R = (0, d.useId)();
    let z = d.Fragment;
      ...
      children: [
       ...
       y &&
        (0, m.jsxs)('div', {
         ...
         hidden: !P,
         children: [
          (0, m.jsx)(g.u, { syntax: x, textContent: C, trim: !0 }),
          l &&
           (0, m.jsx)('div', {
   ...
   function c(e) {
    ...
    return (
     ...
     (0, i.jsx)(t.y$, {
      ...
      language: l || '',
      children: (e) => {
       let { style: l, tokens: t, getLineProps: o, getTokenProps: c } = e;
       return (0, i.jsx)(s.dn, { style: l, children: t.map((e, l) => (0, i.jsxs)('span', { ...o({ line: e }), children: [n && (0, i.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...c({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const a = (e) => {
    ...
    const u = 'Doen',
     ...
     m = p ? 'figure' : 'div',
     _ = p ? 'figcaption' : 'div';
    return (0, r.jsxs)(m, { className: (0, i.Z)(c['nlds-guideline'], c[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, r.jsxs)(_, { className: (0, i.Z)(c['nlds-guideline__description']), children: ['dont' === l ? (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(o.nv, { className: (0, i.Z)(c['nlds-guideline__badge'], c[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(s.Z, { className: c['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: c['nlds-guideline__title'], children: g })] }), (0, r.jsx)(o.nv, { children: n })] }) : (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(o.nv, { className: (0, i.Z)(c['nlds-guideline__badge'], c[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(t.Z, { className: c['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: c['nlds-guideline__title'], children: u })] }), (0, r.jsx)(o.nv, { children: n })] }), a] }), (0, r.jsx)('div', { className: (0, i.Z)(c['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => c, a: () => i });
