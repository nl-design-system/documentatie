 ...
 [17713],
 {
  ...
  98480: (e, n, l) => {
   ...
   const _ = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (F = await i.ZP.format(z, { parser: y, plugins: [r.Z, s.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(F);
     })();
    }, [z]);
    const A = (0, d.useId)();
    let D = d.Fragment;
  ...
  91050: (e, n, l) => {
   ...
   const i = (e) => {
    ...
    const p = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     m = u ? 'figcaption' : 'div';
    return (0, c.jsxs)(h, { className: (0, s.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(m, { className: (0, s.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(r.nv, { className: (0, s.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { className: a['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: a['nlds-guideline__title'], children: v })] }), (0, c.jsx)(r.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(r.nv, { className: (0, s.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(t.Z, { className: a['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: a['nlds-guideline__title'], children: p })] }), (0, c.jsx)(r.nv, { children: n })] }), i] }), (0, c.jsx)('div', { className: (0, s.Z)(a['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => a, a: () => s });
