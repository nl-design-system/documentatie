   ...
   const D = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, c.Z)(m['definition-of-done'], m[`definition-of-done--${(0, C.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
