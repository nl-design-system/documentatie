 ...
 [85781],
 {
  23829: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    o = n(81301),
    i = n(23952);
   const s = { title: 'Code Block', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code Block', pagination_label: 'Code Block', description: 'Toont \xe9\xe9n of meerdere regels computercode en behoudt de opmaak van deze code.', slug: '/code-block', keywords: ['code'] },
    a = void 0,
    l = { id: 'componenten/code-block/index', title: 'Code Block', description: 'Toont \xe9\xe9n of meerdere regels computercode en behoudt de opmaak van deze code.', source: '@site/docs/componenten/code-block/index.mdx', sourceDirName: 'componenten/code-block', slug: '/code-block', permalink: '/en/code-block', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/code-block/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Code Block', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code Block', pagination_label: 'Code Block', description: 'Toont \xe9\xe9n of meerdere regels computercode en behoudt de opmaak van deze code.', slug: '/code-block', keywords: ['code'] }, sidebar: 'componenten', previous: { title: 'Code', permalink: '/en/code' }, next: { title: 'Color Sample', permalink: '/en/color-sample' } },
    u = {},
    d = [
    ...
    h = 'Code Block',
    j = 'Toont \xe9\xe9n of meerdere regels computercode en behoudt de opmaak van deze code.',
    y = 329,
  ...
  68963: (e, t, n) => {
   ...
   const s = (e) => {
    ...
    l = (e) => {
     ...
     const u = (e) => ('article' === a ? (0, i.jsx)('article', { ...e }) : 'section' === a ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      d = (0, i.jsx)(u, { className: (0, c.Z)(o.cardgroup__card, o[`cardgroup__card--${n}`], s), children: l });
  ...
  23952: (e, t, n) => {
   ...
   var r = n(56150),
    ...
    l = n(32636),
    u = n(52676);
   const d = { figma: (0, u.jsx)(o.Z, {}), github: (0, u.jsx)(i.Z, {}), npm: (0, u.jsx)(s.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, c.Z)(_), children: [(0, u.jsxs)('div', { className: (0, c.Z)(x, t && w), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.X6, { appearance: 'utrecht-heading-3', level: i, children: r }), o, n] })] });
    };
   var S = n(14669);
   const D = (e) => {
    ...
    L = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(b.V, { level: n, suffix: o && (0, u.jsx)(p.y, { state: o }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  86964: (e, t, n) => {
   'use strict';
