...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  88296: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => v, contentTitle: () => p, default: () => x, frontMatter: () => u, metadata: () => k, toc: () => j });
   var r = t(52676),
    i = t(24785),
    s = t(57716),
    o = t(71595),
   ...
   const u = { title: 'WCAG-succescriterium 1.4.6 Contrast (versterkt)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.6 Contrast (versterkt)', pagination_label: 'WCAG-succescriterium 1.4.6 Contrast (versterkt)', description: 'Maak het contrast van de tekstkleur ten opzichte van de achtergrondkleur hoog, zodat de tekst goed gelezen kan worden door gebruikers die een hoog contrast nodig hebben.', slug: '1.4.6', keywords: ['WCAG'] },
    p = void 0,
    k = { id: 'wcag/1.4.06', title: 'WCAG-succescriterium 1.4.6 Contrast (versterkt)', description: 'Maak het contrast van de tekstkleur ten opzichte van de achtergrondkleur hoog, zodat de tekst goed gelezen kan worden door gebruikers die een hoog contrast nodig hebben.', source: '@site/docs/wcag/1.4.06.mdx', sourceDirName: 'wcag', slug: '/wcag/1.4.6', permalink: '/en/wcag/1.4.6', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.06.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.4.6 Contrast (versterkt)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.6 Contrast (versterkt)', pagination_label: 'WCAG-succescriterium 1.4.6 Contrast (versterkt)', description: 'Maak het contrast van de tekstkleur ten opzichte van de achtergrondkleur hoog, zodat de tekst goed gelezen kan worden door gebruikers die een hoog contrast nodig hebben.', slug: '1.4.6', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.4.5 Afbeeldingen van tekst', permalink: '/en/wcag/1.4.5' }, next: { title: 'WCAG-succescriterium 1.4.7 Weinig of geen achtergrondgeluid', permalink: '/en/wcag/1.4.7' } },
    v = {},
    j = [
  ...
  72657: (e, n, t) => {
   ...
   const o = (e) => {
    ...
    return (0, s.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${o}`, t), ...l, children: [(0, s.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: n }), a && (0, s.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [a ? ' ' : '', a] })] });
   };
  },
  57716: (e, n, t) => {
   t.d(n, { U: () => c });
   ...
   const o = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, s.jsx)(r.Z, { components: { ...d(t, i), ...l(o) }, children: n });
    };
  },
  71595: (e, n, t) => {
   t.d(n, { j: () => l });
   ...
   const l = (e) => {
    ...
    return (0, a.jsx)(i.V, { className: s, suffix: t && (0, a.jsx)(r.Ou, { className: o, children: t }), ...l, children: n });
   };
  },
  24785: (e, n, t) => {
   t.d(n, { Z: () => a, a: () => o });
