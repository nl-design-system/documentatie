...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [8883],
 {
  ...
  60491: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => S, contentTitle: () => D, default: () => I, frontMatter: () => C, metadata: () => Z, toc: () => V });
   var r = i(11527),
    t = i(80877),
    l = i(73460),
    o = i(30036);
  ...
  73460: (e, n, i) => {
   ...
   const f = (e) => {
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (F = await a.ZP.format(N, { parser: y, plugins: [l.Z, o.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), A(F);
     })();
    }, [N]);
    const D = (0, c.useId)();
    let Z = c.Fragment;
    return (
     "paragraph" === k ? (Z = g) : "document" === k ? (Z = j) : "surface" === k && (Z = v),
     (0, p.jsxs)("div", {
      className: (0, t.Z)(h["nlds-canvas"]),
      children: [
       _ && (0, p.jsx)("div", { className: (0, t.Z)(h["nlds-canvas__example"]), children: (0, p.jsx)("div", { className: "voorbeeld-theme", style: w, children: (0, p.jsx)(Z, { children: (0, p.jsx)(r.pu, { children: _ }) }) }) }),
       x &&
        (0, p.jsx)("div", {
       ...
       x &&
        (0, p.jsxs)("div", {
         ...
         hidden: !G,
         children: [
          (0, p.jsx)(m.u, { syntax: y, textContent: F, trim: !0 }),
          i &&
           (0, p.jsx)("div", {
            className: (0, t.Z)(h["nlds-canvas__toolbar"]),
            children: (0, p.jsx)(r.zx, {
