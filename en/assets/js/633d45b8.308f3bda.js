...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [84756],
 {
  ...
  31182: (e, n, l) => {
   ...
   function _(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
    return n ? (0, i.jsx)(n, { ...e, children: (0, i.jsx)(v, { ...e }) }) : v();
   }
  },
  66771: (e, n, l) => {
   l.d(n, { X: () => _ });
   ...
   const h = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(i.Tg, { className: u['nlds-canvas__example-surface'], children: (0, m.jsx)(i.BB, { className: (0, t.Z)('utrecht-document--surface', u['nlds-canvas__example-document']), children: (0, m.jsx)(i.nv, { className: u['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   h.displayName = 'ParagraphContainer';
   const g = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(i.Tg, { className: u['nlds-canvas__example-surface'], children: (0, m.jsx)(i.BB, { className: (0, t.Z)('utrecht-document--surface', u['nlds-canvas__example-document']), children: n }) });
   };
   ...
   const _ = (e) => {
    ...
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       w && (0, m.jsx)('div', { className: (0, t.Z)(u['nlds-canvas__example']), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(P, { children: (0, m.jsx)(i.pu, { children: w }) }) }) }),
       k &&
        (0, m.jsx)('div', {
    ...
    return (
     ...
     (0, o.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, o.jsx)(i.dn, { style: l, children: t.map((e, l) => (0, o.jsxs)('span', { ...s({ line: e }), children: [n && (0, o.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, o.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  81014: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const u = 'Doen',
     ...
     m = p ? 'figure' : 'div',
     h = p ? 'figcaption' : 'div';
    return (0, r.jsxs)(m, { className: (0, o.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, r.jsxs)(h, { className: (0, o.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(s.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(i.Z, { className: a['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: a['nlds-guideline__title'], children: b })] }), (0, r.jsx)(s.nv, { children: n })] }) : (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(s.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(t.Z, { className: a['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: a['nlds-guideline__title'], children: u })] }), (0, r.jsx)(s.nv, { children: n })] }), c] }), (0, r.jsx)('div', { className: (0, o.Z)(a['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => a, a: () => o });
