...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  9910: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => j, contentTitle: () => u, default: () => f, frontMatter: () => g, metadata: () => p, toc: () => w });
   var r = i(52676),
    t = i(24785),
    s = i(57716),
    l = i(71595),
   ...
   const g = { title: 'WCAG-succescriterium 1.4.10 Reflow', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.10 Reflow', pagination_label: 'WCAG-succescriterium 1.4.10 Reflow', description: 'De gebruiker moet de webpagina 400% kunnen vergroten in de browser en inhoud nog steeds kunnen lezen en de website goed kunnen gebruiken.', slug: '1.4.10', keywords: ['WCAG'] },
    u = void 0,
    p = { id: 'wcag/1.4.10', title: 'WCAG-succescriterium 1.4.10 Reflow', description: 'De gebruiker moet de webpagina 400% kunnen vergroten in de browser en inhoud nog steeds kunnen lezen en de website goed kunnen gebruiken.', source: '@site/docs/wcag/1.4.10.mdx', sourceDirName: 'wcag', slug: '/wcag/1.4.10', permalink: '/en/wcag/1.4.10', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.10.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.4.10 Reflow', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.10 Reflow', pagination_label: 'WCAG-succescriterium 1.4.10 Reflow', description: 'De gebruiker moet de webpagina 400% kunnen vergroten in de browser en inhoud nog steeds kunnen lezen en de website goed kunnen gebruiken.', slug: '1.4.10', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.4.9 Afbeeldingen van tekst (geen uitzondering)', permalink: '/en/wcag/1.4.9' }, next: { title: 'WCAG-succescriterium 1.4.11 Contrast van niet-tekstuele content', permalink: '/en/wcag/1.4.11' } },
    j = {},
    w = [
