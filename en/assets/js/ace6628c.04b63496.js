 ...
 [83373],
 {
  89887: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(61475),
    o = n(21998);
   const s = { title: 'Calendar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Calendar', pagination_label: 'Calendar', description: ' ', slug: '/Calendar', sidebar_custom_props: { illustration: 'CalendarSketch' } },
    a = void 0,
    l = { id: 'componenten/calendar/index', title: 'Calendar', description: ' ', source: '@site/docs/componenten/calendar/index.mdx', sourceDirName: 'componenten/calendar', slug: '/Calendar', permalink: '/en/Calendar', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/calendar/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Calendar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Calendar', pagination_label: 'Calendar', description: ' ', slug: '/Calendar', sidebar_custom_props: { illustration: 'CalendarSketch' } }, sidebar: 'componenten', previous: { title: 'Button', permalink: '/en/button' }, next: { title: 'Card as link', permalink: '/en/card-as-link' } },
    u = {},
    d = [
  ...
  21998: (e, t, n) => {
   ...
   const k = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, c.Z)(f), children: [(0, u.jsxs)('div', { className: (0, c.Z)(_, { [x]: t }), children: [(0, u.jsx)('span', { className: w, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(v.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var C = n(14669);
         ...
         children: [
          (0, u.jsx)(N, {
           children: e.tasks.map((e) => {
            ...
            return (0, u.jsx)(A, { checked: t, title: n, description: (0, C.Q6)(r) }, r);
           }),
          }),
