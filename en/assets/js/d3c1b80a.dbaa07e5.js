 ...
 [58441],
 {
  93891: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Avatar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Avatar', pagination_label: 'Avatar', description: 'Toont een grafische weergave van een gebruiker, meestal in de vorm van een foto, illustratie, of initialen.', slug: '/avatar', sidebar_custom_props: { illustration: 'AvatarSketch' }, keywords: ['afbeelding', 'avatar', 'gebruiker', 'icon', 'identiteit', 'identity', 'image', 'organisation', 'organization', 'profielafbeelding', 'profile image', 'user'] },
    a = void 0,
    l = { id: 'componenten/avatar/index', title: 'Avatar', description: 'Toont een grafische weergave van een gebruiker, meestal in de vorm van een foto, illustratie, of initialen.', source: '@site/docs/componenten/avatar/index.mdx', sourceDirName: 'componenten/avatar', slug: '/avatar', permalink: '/en/avatar', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/avatar/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Avatar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Avatar', pagination_label: 'Avatar', description: 'Toont een grafische weergave van een gebruiker, meestal in de vorm van een foto, illustratie, of initialen.', slug: '/avatar', sidebar_custom_props: { illustration: 'AvatarSketch' }, keywords: ['afbeelding', 'avatar', 'gebruiker', 'icon', 'identiteit', 'identity', 'image', 'organisation', 'organization', 'profielafbeelding', 'profile image', 'user'] }, sidebar: 'componenten', previous: { title: 'Alert dialog', permalink: '/en/alert-dialog' }, next: { title: 'Blockquote', permalink: '/en/blockquote' } },
    u = {},
    d = [
