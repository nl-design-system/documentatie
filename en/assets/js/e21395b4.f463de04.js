 ...
 [48239],
 {
  62627: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(7617),
    o = n(4460);
   const s = { title: 'Notification banner', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Notification banner', pagination_label: 'Notification banner', description: ' ', slug: '/notification-banner' },
    a = void 0,
    u = { id: 'componenten/notification-banner/index', title: 'Notification banner', description: ' ', source: '@site/docs/componenten/notification-banner/index.mdx', sourceDirName: 'componenten/notification-banner', slug: '/notification-banner', permalink: '/en/notification-banner', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/notification-banner/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Notification banner', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Notification banner', pagination_label: 'Notification banner', description: ' ', slug: '/notification-banner' }, sidebar: 'componenten', previous: { title: 'Non modal dialog', permalink: '/en/non-modal-dialog' }, next: { title: 'Number badge', permalink: '/en/number-badge' } },
    l = {},
    d = [
  ...
  4460: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(N, { [w]: t }), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.aC, { role: 'presentation', children: n }), (0, l.jsx)(v.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
