(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [90258],
 {
  47202: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => s, default: () => v, description: () => j, frontMatter: () => a, illustration: () => g, issueNumber: () => y, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(16391);
   const a = { title: 'Language navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Language navigation', pagination_label: 'Language navigation', description: 'Biedt de optie om een andere taal te selecteren.', slug: '/language-navigation', sidebar_custom_props: { illustration: 'LanguageNavigationSketch' } },
    s = void 0,
  ...
  16391: (e, t, n) => {
   ...
   var A = n(14669);
   const S = Object.keys({ HELP_WANTED: 'UNKNOWN', COMMUNITY: 'HELP_WANTED', CANDIDATE: 'COMMUNITY', HALL_OF_FAME: 'CANDIDATE' }),
    z = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => S.includes(e.id)),
      o = c && S.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
         ...
         children: [
          (0, l.jsx)(N, {
           children: e.tasks.map((e) => {
            ...
            return (0, l.jsx)(L, { checked: t, title: n, description: (0, A.Q6)(r) }, r);
           }),
          }),
