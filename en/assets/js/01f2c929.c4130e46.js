...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [7054],
 {
  ...
  83659: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => U, contentTitle: () => X, default: () => I, frontMatter: () => W, metadata: () => T, toc: () => V });
   var r = t(11527),
    o = t(47214),
    l = t(73460),
    i = t(30036),
   ...
   function f(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ["\n", "\n", "\n", (0, r.jsx)(i.X, { appearance: "do", title: "Geef invoerveld een duidelijke visuele focusstijl.", description: (0, r.jsx)(r.Fragment, { children: "In dit voorbeeld is de focus herkenbaar aan een stippellijn rond het invoerveld. Klik in het veld of tab ernaar met het toetsenbord om het effect te zien." }), children: (0, r.jsx)(l.X, { language: "html", children: () => (0, r.jsx)(r.Fragment, { children: (0, r.jsx)(n.input, { type: "text" }) }) }) })] });
   }
   function b(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
   ...
   function F(e) {
    const n = { input: "input", ...(0, o.a)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: ["\n", "\n", "\n", (0, r.jsx)(i.X, { appearance: "do", title: "Maak de placeholder goed leesbaar door voldoende contrast.", description: (0, r.jsxs)(r.Fragment, { children: ["Dit voorbeeld heeft", " ", (0, r.jsx)(s.rU, { href: "/contrast/?color=%23606060&background-color=%23ffffff", children: "een contrast van 6.28:1" }), "."] }), children: (0, r.jsx)(l.X, { language: "html", designTokens: { "--utrecht-textbox-background-color": "#ffffff", "--utrecht-textbox-placeholder-color": "#606060" }, children: () => (0, r.jsx)(r.Fragment, { children: (0, r.jsx)(n.input, { placeholder: "Zoeken" }) }) }) }), "\n", (0, r.jsx)(i.X, { appearance: "dont", title: "Maak de placeholder slecht zichtbaar door te laag contrast.", description: (0, r.jsxs)(r.Fragment, { children: ["Dit voorbeeld heeft", " ", (0, r.jsx)(s.rU, { href: "/contrast/?color=%23888888&background-color=%23ffffff", children: "een contrast van 3.54:1" }), "."] }), children: (0, r.jsx)(l.X, { language: "html", designTokens: { "--utrecht-textbox-background-color": "#ffffff", "--utrecht-textbox-placeholder-color": "#888888" }, children: () => (0, r.jsx)(r.Fragment, { children: (0, r.jsx)(n.input, { placeholder: "Zoeken" }) }) }) })] });
   }
   function C(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(F, { ...e }) }) : F(e);
  ...
  73460: (e, n, t) => {
   ...
   const x = (e) => {
    let { code: n, copy: t = !1, defaultExpandedCode: x = !0, displayCode: f = !0, children: b, container: k = "document", language: w, designTokens: _ } = e,
     y = "function" == typeof b ? b() : b,
     A = "function" == typeof n ? n() : (0, d.isValidElement)(n) ? n : void 0,
     z = "string" == typeof n ? n : h.uS(A || y),
     [F, C] = (0, d.useState)(z),
     [G, N] = (0, d.useState)(x);
    (0, d.useEffect)(() => {
     (async () => {
      (F = await c.ZP.format(z, { parser: w, plugins: [l.Z, i.ZP, s.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), C(F);
     })();
    }, [z]);
    const Z = (0, d.useId)();
    let D = d.Fragment;
    return (
     ...
     (0, g.jsxs)("div", {
      ...
      children: [
       y && (0, g.jsx)("div", { className: (0, o.Z)(u["nlds-canvas__example"]), children: (0, g.jsx)("div", { className: "voorbeeld-theme", style: _, children: (0, g.jsx)(D, { children: (0, g.jsx)(r.pu, { children: y }) }) }) }),
       f &&
        (0, g.jsx)("div", {
   ...
   function s(e) {
    ...
    return (
     ...
     (0, i.jsx)(o.y$, {
      ...
      language: t || "",
      children: (e) => {
       let { style: t, tokens: o, getLineProps: l, getTokenProps: s } = e;
       return (0, i.jsx)(r.dn, { style: t, children: o.map((e, t) => (0, i.jsxs)("span", { ...l({ line: e }), children: [n && (0, i.jsx)("span", { children: t + 1 }), e.map((e, n) => (0, i.jsx)("span", { ...s({ token: e }) }, n)), "\n"] }, t)) });
      },
     })
    );
   }
  ...
  47214: (e, n, t) => {
   ...
   function s(e) {
    let n;
    return (n = e.disableParentContext ? ("function" == typeof e.components ? e.components(o) : e.components || o) : i(e.components)), r.createElement(l.Provider, { value: n }, e.children);
   }
  },
 },
]);
