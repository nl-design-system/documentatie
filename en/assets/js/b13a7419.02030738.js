 ...
 [94730],
 {
  ...
  98480: (e, n, l) => {
   ...
   const v = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (z = await c.ZP.format(Z, { parser: f, plugins: [i.Z, a.ZP, r.ZP, t.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(z);
     })();
    }, [Z]);
    const E = (0, d.useId)();
    let R = d.Fragment;
  ...
  41179: (e, n, l) => {
   ...
   var a = l(52676);
   function r(e) {
    let { lineNumber: n, syntax: l, textContent: r, trim: t } = e,
     c = r;
    return (
     t && (c = c.trim()),
     (0, a.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsx)(s.dn, { style: l, children: o.map((e, l) => (0, a.jsxs)('span', { ...i({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const m = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     g = u ? 'figcaption' : 'div';
    return (0, t.jsxs)(h, { className: (0, a.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, t.jsxs)(g, { className: (0, a.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, t.jsxs)(t.Fragment, { children: [(0, t.jsxs)(i.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, t.jsx)(s.Z, { className: r['nlds-guideline__icon'] }), (0, t.jsx)('span', { className: r['nlds-guideline__title'], children: p })] }), (0, t.jsx)(i.nv, { children: n })] }) : (0, t.jsxs)(t.Fragment, { children: [(0, t.jsxs)(i.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, t.jsx)(o.Z, { className: r['nlds-guideline__icon'] }), (0, t.jsx)('span', { className: r['nlds-guideline__title'], children: m })] }), (0, t.jsx)(i.nv, { children: n })] }), c] }), (0, t.jsx)('div', { className: (0, a.Z)(r['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => a });
