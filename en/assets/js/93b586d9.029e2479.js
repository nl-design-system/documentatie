...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [10632],
 {
  ...
  68380: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => b, contentTitle: () => h, default: () => g, frontMatter: () => p, metadata: () => m, toc: () => _ });
   var o = l(52676),
    s = l(24785),
    t = l(98480),
    c = l(91050);
  ...
  98480: (e, n, l) => {
   ...
   const g = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: g = !1, displayCode: y = !0, children: j, container: k = 'document', language: x, designTokens: f } = e,
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await i.ZP.format(w, { parser: x, plugins: [t.Z, c.ZP, r.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), P(Z);
     })();
    }, [w]);
    const E = (0, d.useId)();
    let D = d.Fragment;
    return (
     'paragraph' === k ? (D = b) : 'document' === k ? (D = _) : 'surface' === k && (D = v),
     (0, m.jsxs)('div', {
      className: (0, s.Z)(p['nlds-canvas']),
      children: [
       z && (0, m.jsx)('div', { className: (0, s.Z)(p['nlds-canvas__example']), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(D, { children: (0, m.jsx)(o.pu, { children: z }) }) }) }),
       y &&
        (0, m.jsx)('div', {
