...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [7478],
 {
  ...
  85500: (e, n, r) => {
   r.r(n), r.d(n, { assets: () => U, contentTitle: () => X, default: () => H, frontMatter: () => W, metadata: () => V, toc: () => T });
   var t = r(11527),
    o = r(80877),
    i = r(73460),
    s = r(30036),
   ...
   function x(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: ["\n", "\n", "\n", (0, t.jsx)(s.X, { appearance: "do", title: "Geef invoerveld een duidelijke visuele focusstijl.", description: (0, t.jsx)(t.Fragment, { children: "In dit voorbeeld is de focus herkenbaar aan een stippellijn rond het invoerveld. Klik in het veld of tab ernaar met het toetsenbord om het effect te zien." }), children: (0, t.jsx)(i.X, { language: "html", children: () => (0, t.jsx)(t.Fragment, { children: (0, t.jsx)(n.input, { type: "text" }) }) }) })] });
   }
   function b(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
   ...
   function k(e) {
    const n = { a: "a", h2: "h2", p: "p", ...(0, o.a)(), ...e.components };
    return (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.h2, { id: "maak-toetsenbord-focus-goed-zichtbaar", children: "Maak toetsenbord focus goed zichtbaar" }), "\n", (0, t.jsxs)(n.p, { children: ["Voor gebruikers van een toetsenbord of van spraakherkenning moet duidelijk zijn welk formulierveld de focus heeft. Deze zogenaamde focusstijlen moeten consistent en duidelijk genoeg zijn. Goed zichtbare focusstijlen zijn nodig om te voldoen het aan WCAG-succescriterium ", (0, t.jsx)(n.a, { href: "https://www.w3.org/WAI/WCAG22/Understanding/focus-visible.html", children: "2.4.7 Focus zichtbaar" }), " (niveau AA)."] }), "\n", (0, t.jsxs)(n.p, { children: ["Zorg ervoor dat de focusstijl een kleurcontrast heeft van tenminste 3:1 ten opzichte van de achtergrond van het formulierveld en de omringende achtergrond. Dit is nodig om te voldoen aan het WCAG-succescriterium ", (0, t.jsx)(n.a, { href: "https://www.w3.org/WAI/WCAG22/Understanding/non-text-content.html", children: "1.4.11 Contrast van niet-tekstuele content" }), " (niveau AA)."] })] });
   }
   function w(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
   ...
   function F(e) {
    const n = { input: "input", ...(0, o.a)(), ...e.components };
    return (0, t.jsxs)(t.Fragment, { children: ["\n", "\n", "\n", (0, t.jsx)(s.X, { appearance: "do", title: "Maak de placeholder goed leesbaar door voldoende contrast.", description: (0, t.jsxs)(t.Fragment, { children: ["Dit voorbeeld heeft", " ", (0, t.jsx)(l.rU, { href: "/contrast/?color=%23606060&background-color=%23ffffff", children: "een contrast van 6.28:1" }), "."] }), children: (0, t.jsx)(i.X, { language: "html", designTokens: { "--utrecht-textbox-background-color": "#ffffff", "--utrecht-textbox-placeholder-color": "#606060" }, children: () => (0, t.jsx)(t.Fragment, { children: (0, t.jsx)(n.input, { placeholder: "Zoeken" }) }) }) }), "\n", (0, t.jsx)(s.X, { appearance: "dont", title: "Maak de placeholder slecht zichtbaar door te laag contrast.", description: (0, t.jsxs)(t.Fragment, { children: ["Dit voorbeeld heeft", " ", (0, t.jsx)(l.rU, { href: "/contrast/?color=%23888888&background-color=%23ffffff", children: "een contrast van 3.54:1" }), "."] }), children: (0, t.jsx)(i.X, { language: "html", designTokens: { "--utrecht-textbox-background-color": "#ffffff", "--utrecht-textbox-placeholder-color": "#888888" }, children: () => (0, t.jsx)(t.Fragment, { children: (0, t.jsx)(n.input, { placeholder: "Zoeken" }) }) }) })] });
   }
   function G(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
  ...
  73460: (e, n, r) => {
   ...
   const f = (e) => {
    let { code: n, copy: r = !1, defaultExpandedCode: f = !1, displayCode: x = !0, children: b, container: k = "document", language: w, designTokens: _ } = e,
    ...
    return (
     ...
     (0, g.jsxs)("div", {
      ...
      children: [
       y && (0, g.jsx)("div", { className: (0, o.Z)(u["nlds-canvas__example"]), children: (0, g.jsx)("div", { className: "voorbeeld-theme", style: _, children: (0, g.jsx)(M, { children: (0, g.jsx)(t.pu, { children: y }) }) }) }),
       x &&
        (0, g.jsx)("div", {
   ...
   function l(e) {
    ...
    return (
     ...
     (0, s.jsx)(o.y$, {
      ...
      language: r || "",
      children: (e) => {
       let { style: r, tokens: o, getLineProps: i, getTokenProps: l } = e;
       return (0, s.jsx)(t.dn, { style: r, children: o.map((e, r) => (0, s.jsxs)("span", { ...i({ line: e }), children: [n && (0, s.jsx)("span", { children: r + 1 }), e.map((e, n) => (0, s.jsx)("span", { ...l({ token: e }) }, n)), "\n"] }, r)) });
      },
     })
    );
   }
  ...
  30036: (e, n, r) => {
   ...
   const d = (e) => {
    ...
    const u = "Doen",
     ...
     g = h ? "figure" : "div",
     m = h ? "figcaption" : "div";
    return (0, a.jsxs)(g, { className: (0, s.Z)(l["nlds-guideline"], l[`nlds-guideline--${r}`]), id: "string" == typeof n ? n?.toLowerCase().replace(/\s/g, "-") : void 0, children: [(0, a.jsxs)(m, { className: (0, s.Z)(l["nlds-guideline__description"]), children: ["dont" === r ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(i.nv, { className: (0, s.Z)(l["nlds-guideline__badge"], l[`nlds-guideline__badge--${r}`]), children: [(0, a.jsx)(t.Z, { className: l["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: l["nlds-guideline__title"], children: p })] }), (0, a.jsx)(i.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(i.nv, { className: (0, s.Z)(l["nlds-guideline__badge"], l[`nlds-guideline__badge--${r}`]), children: [(0, a.jsx)(o.Z, { className: l["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: l["nlds-guideline__title"], children: u })] }), (0, a.jsx)(i.nv, { children: n })] }), d] }), (0, a.jsx)("div", { className: (0, s.Z)(l["nlds-guideline__example"]), children: c })] });
   };
  },
  80877: (e, n, r) => {
   r.d(n, { Z: () => l, a: () => s });
