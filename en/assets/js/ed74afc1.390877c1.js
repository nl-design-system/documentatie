 ...
 [19552],
 {
  20049: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(87176),
    s = n(90786);
   const o = { title: 'Select', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Select', pagination_label: 'Select', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren uit een opgeklapte lijst.', slug: '/select' },
    a = void 0,
    l = { id: 'componenten/select/index', title: 'Select', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren uit een opgeklapte lijst.', source: '@site/docs/componenten/select/index.mdx', sourceDirName: 'componenten/select', slug: '/select', permalink: '/en/select', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/select/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Select', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Select', pagination_label: 'Select', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren uit een opgeklapte lijst.', slug: '/select' }, sidebar: 'componenten', previous: { title: 'Rich Text Content', permalink: '/en/rich-text-content' }, next: { title: 'Separator', permalink: '/en/separator' } },
    u = {},
    d = [
