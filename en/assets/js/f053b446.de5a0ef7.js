 ...
 [88474],
 {
  89564: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(80719),
    o = n(90786);
   const s = { title: 'Code', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code', pagination_label: 'Code', description: 'Markeert tekst dat code vertegenwoordigt.', slug: '/code', keywords: ['code block'] },
    a = void 0,
    l = { id: 'componenten/code/index', title: 'Code', description: 'Markeert tekst dat code vertegenwoordigt.', source: '@site/docs/componenten/code/index.mdx', sourceDirName: 'componenten/code', slug: '/code', permalink: '/en/code', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/code/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Code', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code', pagination_label: 'Code', description: 'Markeert tekst dat code vertegenwoordigt.', slug: '/code', keywords: ['code block'] }, sidebar: 'componenten', previous: { title: 'Checkbox group', permalink: '/en/checkbox-group' }, next: { title: 'Code block', permalink: '/en/code-block' } },
    u = {},
    d = [
    ...
    h = 'Code',
    j = 'Markeert tekst dat code vertegenwoordigt.',
    y = 326,
