 ...
 [43166],
 {
  10545: (e, n, t) => {
   ...
   const d = { title: 'Table', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Table', pagination_label: 'Table', description: 'Structureert data in rijen en kolommen.', slug: '/table' },
    h = void 0,
    u = { id: 'componenten/table/index', title: 'Table', description: 'Structureert data in rijen en kolommen.', source: '@site/docs/componenten/table/index.mdx', sourceDirName: 'componenten/table', slug: '/table', permalink: '/en/table', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/table/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Table', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Table', pagination_label: 'Table', description: 'Structureert data in rijen en kolommen.', slug: '/table' }, sidebar: 'componenten', previous: { title: 'Switch', permalink: '/en/switch' }, next: { title: 'Tabs', permalink: '/en/tabs' } },
    j = {},
    m = [
  ...
  63246: (e, n, t) => {
   ...
   const x = 'task-list_hh8j',
    ...
    T = (e) => {
     ...
     return (0, d.jsxs)('li', { className: (0, i.Z)(f), children: [(0, d.jsxs)('div', { className: (0, i.Z)(_, { [w]: n }), children: [(0, d.jsx)('span', { className: z, children: n ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), n && (0, d.jsx)(v.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(k.aC, { role: 'presentation', children: t }), (0, d.jsx)(k.nv, { children: r })] })] });
    };
   var A = t(14669);
   const S = (e) => {
     let { component: n, headingLevel: t } = e;
     const a = n && n.projects.filter((e) => A.e9.includes(e.id)),
      o = a && A.e9.map((e) => a.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, d.jsx)(N, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(T, { checked: n, title: t, description: (0, A.Q6)(r) }, r);
            }),
           }),
    ...
    D = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(y.V, { level: t, suffix: a && (0, d.jsx)(b.y, { state: a }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, n, t) => {
   'use strict';
