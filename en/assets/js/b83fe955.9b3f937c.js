  ...
  73460: (e, n, i) => {
   ...
   const f = (e) => {
    let { code: n, copy: i = !1, defaultExpandedCode: f = !1, displayCode: x = !0, children: b, container: k = "document", language: w, designTokens: y } = e,
     ...
     F = "string" == typeof n ? n : u.uS(A || _),
     [z, N] = (0, c.useState)(F),
     [C, G] = (0, c.useState)(f);
    (0, c.useEffect)(() => {
     (async () => {
      (z = await a.ZP.format(F, { parser: w, plugins: [l.Z, o.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), N(z);
     })();
    }, [F]);
    const D = (0, c.useId)();
    let Z = c.Fragment;
    return (
     ...
     (0, p.jsxs)("div", {
      ...
      children: [
       _ && (0, p.jsx)("div", { className: (0, r.Z)(h["nlds-canvas__example"]), children: (0, p.jsx)("div", { className: "voorbeeld-theme", style: y, children: (0, p.jsx)(Z, { children: (0, p.jsx)(t.pu, { children: _ }) }) }) }),
       x &&
        (0, p.jsx)("div", {
       ...
       x &&
        (0, p.jsxs)("div", {
         ...
         hidden: !C,
         children: [
          (0, p.jsx)(m.u, { syntax: w, textContent: z, trim: !0 }),
          i &&
           (0, p.jsx)("div", {
            className: (0, r.Z)(h["nlds-canvas__toolbar"]),
            children: (0, p.jsx)(t.zx, {
