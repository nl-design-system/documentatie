  ...
  78510: (e, t, r) => {
   ...
   const c = class {
    ...
    render() {
     ...
     return (0, n.h)(
      'nav',
      { key: '832463183397615f8a162a97cc354a00fc037193', class: 'utrecht-sidenav' },
      (0, n.h)(
       'ul',
       { key: 'b137bccf9fe94b12b6529e765dd68edb84754f25', class: 'utrecht-sidenav__list' },
       e.map(({ href: e, title: t, current: r, focus: c, children: a, sibling: s, haschildren: o }, d, l) =>
        (0, n.h)(
         'li',
         { key: e, class: (0, i.c)('utrecht-sidenav__item', d + 1 === l.length && 'utrecht-sidenav__item--last', s && 'utrecht-sidenav__item--sibling', o && 'utrecht-sidenav__item--parent') },
         (0, n.h)('a', { class: (0, i.c)('utrecht-sidenav__link', r && 'utrecht-sidenav__link--current', c && 'utrecht-sidenav__link--focus', s && 'utrecht-sidenav__link--sibling', o && 'utrecht-sidenav__link--parent'), href: e }, (0, n.h)('div', { class: (0, i.c)('utrecht-sidenav__marker', r && 'utrecht-sidenav__marker--current') }), (0, n.h)('div', { class: (0, i.c)('utrecht-sidenav__connection', o && 'utrecht-sidenav__connection--parent', s && 'utrecht-sidenav__connection--sibling', d + 1 === l.length && 'utrecht-sidenav__connection--last') }), t),
         a
          ? (0, n.h)(
             'ul',
