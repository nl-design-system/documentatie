(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [83373],
 {
  78405: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => o, default: () => p, description: () => j, frontMatter: () => s, issueNumber: () => y, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    c = n(24785),
    i = n(24909),
    a = n(63246);
  ...
  83931: (e, t, n) => {
   ...
   const s = (e) => {
     ...
     return (0, a.jsx)('div', { className: (0, c.Z)(i.card__illustration, t && i['card__illustration--background'], r), ...s, children: n });
    },
    o = (e) => (0, a.jsx)('div', { className: (0, c.Z)(i.card__content), ...e }),
    l = (e) => {
     let { href: t, appearance: n, className: s, component: o = 'div', children: l } = e;
     const u = (e) => ('article' === o ? (0, a.jsx)('article', { ...e }) : 'section' === o ? (0, a.jsx)('section', { ...e }) : (0, a.jsx)('div', { ...e })),
      d = (0, a.jsx)(u, { className: (0, c.Z)(i.cardgroup__card, i[`cardgroup__card--${n}`], s), children: l });
     return t ? (0, a.jsx)(r.rU, { href: t, boxContent: !0, className: i.cardgroup__link, children: d }) : d;
    },
    u = (e) => {
     let { appearance: t = 'medium', children: n, className: r } = e;
     return (0, a.jsx)('div', { className: (0, c.Z)(i.cardgroup, i[`cardgroup--${t}`], r), children: n });
    };
  },
  63246: (e, t, n) => {
   'use strict';
   n.d(t, { Gn: () => T, cN: () => S, W: () => D, Rv: () => L });
   var r = n(56150),
    c = n(4814),
    i = (n(75271), n(39854)),
    a = n(7522),
    ...
    l = n(32636),
    u = n(52676);
   const d = { figma: (0, u.jsx)(i.Z, {}), github: (0, u.jsx)(a.Z, {}), npm: (0, u.jsx)(s.Z, {}), storybook: (0, u.jsx)(o.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, c.Z)(_), children: [(0, u.jsxs)('div', { className: (0, c.Z)(x, { [w]: t }), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(v.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var C = n(14669);
   const S = (e) => {
     let { component: t, headingLevel: n } = e;
     const i = t && t.projects.filter((e) => C.e9.includes(e.id)),
      a = i && C.e9.map((e) => i.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: a.map((e) => ({
        className: (0, c.Z)(y['definition-of-done'], e && y[`definition-of-done--${(0, C.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
    ...
    L = (e) => {
     ...
     const i = t && C.$3[t.relayStep];
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(k.V, { level: n, suffix: i && (0, u.jsx)(p.y, { state: i }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
  ...
  66120: (e, t, n) => {
   ...
   var r = n(4814);
   n(75271);
   const c = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' };
   var i = n(52676);
   const a = (e) => {
    let { children: t, className: n, level: a = 1, suffix: s, ...o } = e;
    return (0, i.jsxs)('hgroup', { className: (0, r.Z)(c['nlds-inline-heading-group'], `utrecht-heading-${a}`, n), ...o, children: [(0, i.jsx)('h1', { className: (0, r.Z)(c['nlds-inline-heading-group__heading']), children: t }), s && (0, i.jsxs)('p', { className: (0, r.Z)(c['nlds-inline-heading-group__suffix']), children: [s ? ' ' : '', s] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => s, Q6: () => i, e9: () => a, mA: () => c });
