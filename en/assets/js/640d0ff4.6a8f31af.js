...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [51192],
 {
  ...
  66771: (e, l, n) => {
   ...
   const v = (e) => {
    let { children: l } = e;
    return (0, g.jsx)(s.Tg, { className: p['nlds-canvas__example-surface'], children: (0, g.jsx)(s.BB, { className: (0, o.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: (0, g.jsx)(s.nv, { className: p['nlds-canvas__example-paragraph'], children: l }) }) });
   };
   v.displayName = 'ParagraphContainer';
   const m = (e) => {
    let { children: l } = e;
    return (0, g.jsx)(s.Tg, { className: p['nlds-canvas__example-surface'], children: (0, g.jsx)(s.BB, { className: (0, o.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: l }) });
   };
   ...
   const _ = (e) => {
    ...
    return (
     ...
     (0, g.jsxs)('div', {
      ...
      children: [
       w && (0, g.jsx)('div', { className: (0, o.Z)(p['nlds-canvas__example']), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, g.jsx)(F, { children: (0, g.jsx)(s.pu, { children: w }) }) }) }),
       j &&
        (0, g.jsx)('div', {
   ...
   function t(e) {
    ...
    return (
     ...
     (0, r.jsx)(o.y$, {
      ...
      language: n || '',
      children: (e) => {
       let { style: n, tokens: o, getLineProps: a, getTokenProps: t } = e;
       return (0, r.jsx)(s.dn, { style: n, children: o.map((e, n) => (0, r.jsxs)('span', { ...a({ line: e }), children: [l && (0, r.jsx)('span', { children: n + 1 }), e.map((e, l) => (0, r.jsx)('span', { ...t({ token: e }) }, l)), '\n'] }, n)) });
      },
     })
    );
   }
  ...
  81014: (e, l, n) => {
   ...
   const c = (e) => {
    ...
    const p = 'Doen',
     ...
     g = u ? 'figure' : 'div',
     v = u ? 'figcaption' : 'div';
    return (0, i.jsxs)(g, { className: (0, r.Z)(t['nlds-guideline'], t[`nlds-guideline--${n}`]), id: 'string' == typeof l ? l?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(v, { className: (0, r.Z)(t['nlds-guideline__description']), children: ['dont' === n ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(a.nv, { className: (0, r.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${n}`]), children: [(0, i.jsx)(s.Z, { className: t['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: t['nlds-guideline__title'], children: h })] }), (0, i.jsx)(a.nv, { children: l })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(a.nv, { className: (0, r.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${n}`]), children: [(0, i.jsx)(o.Z, { className: t['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: t['nlds-guideline__title'], children: p })] }), (0, i.jsx)(a.nv, { children: l })] }), c] }), (0, i.jsx)('div', { className: (0, r.Z)(t['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, l, n) => {
   n.d(l, { Z: () => t, a: () => r });
