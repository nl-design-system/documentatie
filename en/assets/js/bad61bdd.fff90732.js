...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  12091: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => p, default: () => f, frontMatter: () => u, metadata: () => j, toc: () => k });
   var r = i(52676),
    t = i(24785),
    s = i(57716),
    l = i(71595),
   ...
   const u = { title: 'WCAG-succescriterium 1.3.3 Zintuiglijke eigenschappen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.3 Zintuiglijke eigenschappen', pagination_label: 'WCAG-succescriterium 1.3.3 Zintuiglijke eigenschappen', description: 'Geef instructies op een inclusieve manier. De instructies kunnen begrijpen moet niet afhankelijk zijn van eigenschappen die sommige gebruikers niet ervaren, zoals vorm, kleur, afmeting, locatie op het scherm, richting, of geluid.', slug: '1.3.3', keywords: ['WCAG'] },
    p = void 0,
    j = { id: 'wcag/1.3.03', title: 'WCAG-succescriterium 1.3.3 Zintuiglijke eigenschappen', description: 'Geef instructies op een inclusieve manier. De instructies kunnen begrijpen moet niet afhankelijk zijn van eigenschappen die sommige gebruikers niet ervaren, zoals vorm, kleur, afmeting, locatie op het scherm, richting, of geluid.', source: '@site/docs/wcag/1.3.03.mdx', sourceDirName: 'wcag', slug: '/wcag/1.3.3', permalink: '/en/wcag/1.3.3', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.3.03.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.3.3 Zintuiglijke eigenschappen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.3 Zintuiglijke eigenschappen', pagination_label: 'WCAG-succescriterium 1.3.3 Zintuiglijke eigenschappen', description: 'Geef instructies op een inclusieve manier. De instructies kunnen begrijpen moet niet afhankelijk zijn van eigenschappen die sommige gebruikers niet ervaren, zoals vorm, kleur, afmeting, locatie op het scherm, richting, of geluid.', slug: '1.3.3', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.3.2 Betekenisvolle volgorde', permalink: '/en/wcag/1.3.2' }, next: { title: 'WCAG-succescriterium 1.3.4 Weergavestand', permalink: '/en/wcag/1.3.4' } },
    m = {},
    k = [
  ...
  72657: (e, n, i) => {
   ...
   var s = i(52676);
   const l = (e) => {
    let { children: n, className: i, level: l = 1, suffix: a, ...c } = e;
    return (0, s.jsxs)('hgroup', { className: (0, r.Z)(t['nlds-inline-heading-group'], `utrecht-heading-${l}`, i), ...c, children: [(0, s.jsx)('h1', { className: (0, r.Z)(t['nlds-inline-heading-group__heading']), children: n }), a && (0, s.jsxs)('p', { className: (0, r.Z)(t['nlds-inline-heading-group__suffix']), children: [a ? ' ' : '', a] })] });
   };
  },
  57716: (e, n, i) => {
   i.d(n, { U: () => d });
   ...
   const l = (e, n) => {
    ...
    d = (e) => {
     ...
     return (0, s.jsx)(r.Z, { components: { ...o(i, t), ...c(l) }, children: n });
    };
  },
  71595: (e, n, i) => {
   i.d(n, { j: () => c });
   ...
   const c = (e) => {
    ...
    return (0, a.jsx)(t.V, { className: s, suffix: i && (0, a.jsx)(r.Ou, { className: l, children: i }), ...c, children: n });
   };
  },
  24785: (e, n, i) => {
   i.d(n, { Z: () => a, a: () => l });
