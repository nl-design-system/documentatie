 ...
 [83760],
 {
  90995: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(7617),
    o = n(4460);
   const s = { title: 'Form field partial label', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field partial label', pagination_label: 'Form field partial label', description: ' ', slug: '/form-field-partial-label' },
    a = void 0,
    l = { id: 'componenten/form-field-partial-label/index', title: 'Form field partial label', description: ' ', source: '@site/docs/componenten/form-field-partial-label/index.mdx', sourceDirName: 'componenten/form-field-partial-label', slug: '/form-field-partial-label', permalink: '/en/form-field-partial-label', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-field-partial-label/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form field partial label', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field partial label', pagination_label: 'Form field partial label', description: ' ', slug: '/form-field-partial-label' }, sidebar: 'componenten', previous: { title: 'Form field partial', permalink: '/en/form-field-partial' }, next: { title: 'Form field radio option', permalink: '/en/form-field-radio-option' } },
    u = {},
    d = [
          ...
          children: [
           (0, u.jsx)(z, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(S, { checked: t, title: n, description: (0, D.Q6)(r) }, r);
            }),
           }),
