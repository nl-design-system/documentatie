...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [53608],
 {
  63169: (e, t, a) => {
   ...
   function i(e) {
    ...
    return r.createElement(
     ...
     r.createElement(
      "ul",
      null,
      a.map((e) => r.createElement("li", { key: e.metadata.date }, r.createElement(l.Z, { to: e.metadata.permalink }, e.metadata.formattedDate, " - ", e.metadata.title)))
     )
    );
   }
   function m(e) {
    ...
    return r.createElement(
     ...
     r.createElement(
      ...
      r.createElement(
       "div",
       { className: "row" },
       t.map((e, t) => r.createElement("div", { key: t, className: "col col--4 margin-vert--lg" }, r.createElement(i, e)))
      )
     )
    );
   }
   function o(e) {
    let { archive: t } = e;
    const a = (0, n.I)({ id: "theme.blog.archive.title", message: "Archive", description: "The page & hero title of the blog archive page" }),
