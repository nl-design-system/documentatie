 ...
 [36200],
 {
  70105: (e, t, n) => {
   ...
   const s = { title: 'Strong', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Strong', pagination_label: 'Strong', description: 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.', slug: '/strong' },
    a = void 0,
    u = { id: 'componenten/strong/index', title: 'Strong', description: 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.', source: '@site/docs/componenten/strong/index.mdx', sourceDirName: 'componenten/strong', slug: '/strong', permalink: '/en/strong', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/strong/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Strong', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Strong', pagination_label: 'Strong', description: 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.', slug: '/strong' }, sidebar: 'componenten', previous: { title: 'Status Badge', permalink: '/en/status-badge' }, next: { title: 'Sub Heading', permalink: '/en/sub-heading' } },
    l = {},
    d = [
