(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [2930],
 {
  73055: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => a, default: () => v, description: () => j, frontMatter: () => o, illustration: () => g, issueNumber: () => y, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    s = n(60851);
   const o = { title: 'Progress list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress list', pagination_label: 'Progress list', description: 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.', slug: '/progress-list', sidebar_custom_props: { illustration: 'ProgressListSketch' } },
    a = void 0,
    l = { id: 'componenten/progress-list/index', title: 'Progress list', description: 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.', source: '@site/docs/componenten/progress-list/index.mdx', sourceDirName: 'componenten/progress-list', slug: '/progress-list', permalink: '/en/progress-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/progress-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Progress list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress list', pagination_label: 'Progress list', description: 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.', slug: '/progress-list', sidebar_custom_props: { illustration: 'ProgressListSketch' } }, sidebar: 'componenten', previous: { title: 'Progress bar', permalink: '/en/progress-bar' }, next: { title: 'Radio button', permalink: '/en/radio-button' } },
    u = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(k.aC, { role: 'presentation', children: n }), (0, u.jsx)(k.nv, { children: r })] })] });
    };
   var T = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => T.e9.includes(e.id)),
      s = c && T.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: s.map((e) => ({
        className: (0, i.Z)(g['definition-of-done'], g[`definition-of-done--${(0, T.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
