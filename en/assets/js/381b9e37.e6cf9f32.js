   ...
   const T = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: i.map((e) => ({
        className: (0, c.Z)(y['definition-of-done'], e && y[`definition-of-done--${(0, D.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
    ...
    M = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(v, { level: n, suffix: o && (0, l.jsx)(p.y, { state: o }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
