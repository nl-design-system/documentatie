 ...
 [58441],
 {
  93891: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Avatar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Avatar', pagination_label: 'Avatar', description: 'Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.', slug: '/avatar', sidebar_custom_props: { illustration: 'AvatarSketch' }, keywords: ['afbeelding', 'avatar', 'foto', 'gebruiker', 'gravatar', 'icon', 'identiteit', 'identity', 'illustratie', 'illustration', 'image', 'initial', 'initialen', 'logo', 'organisation', 'organization', 'photo', 'picture', 'profielafbeelding', 'profile image', 'user'] },
    a = void 0,
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [A]: t }), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(f.aC, { role: 'presentation', children: n }), (0, u.jsx)(f.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
