  ...
  82415: (e, n, i) => {
   ...
   const l = (e) => {
    ...
    return (0, r.jsxs)("form", {
     ...
     children: [(0, r.jsxs)(t.Wi, { type: "email", children: [(0, r.jsx)(t.nv, { children: (0, r.jsx)(t.lX, { htmlFor: `id-${o}`, children: "E-mailadres" }) }), x[o] && (0, r.jsx)(t.w7, { children: (0, r.jsx)(t.nv, { children: x[o].message }) }), (0, r.jsx)(t.nv, { children: (0, r.jsx)(t.fE, { id: `id-${o}`, name: o, type: "email", "aria-required": "true", autoComplete: "email", ...h(`${o}`, { required: { value: !0, message: "Dit veld is verplicht, maar het is niet ingevuld." }, pattern: { value: /\S+@\S+\.\S+/, message: "Dit is geen correct emailadres." } }), invalid: !!x[o] }) })] }), (0, r.jsxs)(t.Wi, { type: "text", children: [(0, r.jsx)(t.nv, { children: (0, r.jsx)(t.lX, { htmlFor: d, children: "Naam (niet verplicht)" }) }), (0, r.jsx)(t.nv, { children: (0, r.jsx)(t.fE, { id: d, name: d, type: "text", autoComplete: "given-name" }) })] }), m && (0, r.jsxs)(t.Wi, { type: "text", children: [(0, r.jsx)(t.nv, { children: (0, r.jsx)(t.lX, { htmlFor: m, children: "Organisatie (niet verplicht)" }) }), (0, r.jsx)(t.nv, { children: (0, r.jsx)(t.fE, { id: m, name: m, type: "text" }) })] }), c && (0, r.jsxs)(t.pg, { children: [(0, r.jsx)(t.Qv, { children: "Waar ligt je interesse? (niet verplicht)" }), u.map((e, n) => (0, r.jsx)(t.Wi, { type: "checkbox", children: (0, r.jsxs)(t.nv, { children: [(0, r.jsx)(t.XZ, { name: `${c}[]`, value: n + 1, id: `${c}-${n + 1}` }), (0, r.jsx)(t.lX, { htmlFor: `${c}-${n + 1}`, children: e })] }) }, e))] }), j && (0, r.jsxs)(t.Wi, { type: "text", children: [(0, r.jsx)(t.nv, { children: (0, r.jsx)(t.lX, { htmlFor: j, children: "Waar werk je momenteel vooral aan? Denk aan mijn-omgevingen, formulieren, kaarten. (niet verplicht)" }) }), (0, r.jsx)(t.nv, { children: (0, r.jsx)(t.fE, { id: j, name: j, type: "text" }) })] }), (0, r.jsx)(t.hE, { children: (0, r.jsx)(t.zx, { type: "submit", appearance: "primary-action-button", children: "Aanmelden" }) }), (0, r.jsx)("input", { type: "hidden", name: "next", value: l }), (0, r.jsx)("input", { type: "hidden", name: "a", value: i }), (0, r.jsx)("input", { type: "hidden", name: "l", value: n }), (0, r.jsx)("input", { name: "osnD9cWRI3", autoComplete: "on", id: "id-osnD9cWRI3", type: "hidden", value: "NLDS website" }), (0, r.jsx)("input", { autoComplete: "new-password", type: "email", id: "email", name: "email", placeholder: "Your e-mail here", className: "sr-only", "aria-hidden": "true" })],
    });
   };
  },
  80877: (e, n, i) => {
