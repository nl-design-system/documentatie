...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  18896: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => v, contentTitle: () => p, default: () => f, frontMatter: () => u, metadata: () => j, toc: () => m });
   var t = i(52676),
    r = i(24785),
    l = i(57716),
    s = i(71595),
   ...
   const u = { title: 'WCAG-succescriterium 2.4.2 Paginatitel', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.2 Paginatitel', pagination_label: 'WCAG-succescriterium 2.4.2 Paginatitel', description: "Webpagina's hebben titels die het onderwerp of doel beschrijven.", slug: '2.4.2', keywords: ['WCAG'] },
    p = void 0,
    j = { id: 'wcag/2.4.02', title: 'WCAG-succescriterium 2.4.2 Paginatitel', description: "Webpagina's hebben titels die het onderwerp of doel beschrijven.", source: '@site/docs/wcag/2.4.02.mdx', sourceDirName: 'wcag', slug: '/wcag/2.4.2', permalink: '/en/wcag/2.4.2', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.02.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.4.2 Paginatitel', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.2 Paginatitel', pagination_label: 'WCAG-succescriterium 2.4.2 Paginatitel', description: "Webpagina's hebben titels die het onderwerp of doel beschrijven.", slug: '2.4.2', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.4.1 Blokken omzeilen', permalink: '/en/wcag/2.4.1' }, next: { title: 'WCAG-succescriterium 2.4.3 Focus volgorde', permalink: '/en/wcag/2.4.3' } },
    v = {},
    m = [
  ...
  72657: (e, n, i) => {
   ...
   var l = i(52676);
   const s = (e) => {
    let { children: n, className: i, level: s = 1, suffix: a, ...d } = e;
    return (0, l.jsxs)('hgroup', { className: (0, t.Z)(r['nlds-inline-heading-group'], `utrecht-heading-${s}`, i), ...d, children: [(0, l.jsx)('h1', { className: (0, t.Z)(r['nlds-inline-heading-group__heading']), children: n }), a && (0, l.jsxs)('p', { className: (0, t.Z)(r['nlds-inline-heading-group__suffix']), children: [a ? ' ' : '', a] })] });
   };
  },
  57716: (e, n, i) => {
   i.d(n, { U: () => c });
   ...
   const s = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, l.jsx)(t.Z, { components: { ...o(i, r), ...d(s) }, children: n });
    };
  },
  71595: (e, n, i) => {
   i.d(n, { j: () => d });
   ...
   const d = (e) => {
    ...
    return (0, a.jsx)(r.V, { className: l, suffix: i && (0, a.jsx)(t.Ou, { className: s, children: i }), ...d, children: n });
   };
  },
  24785: (e, n, i) => {
   i.d(n, { Z: () => a, a: () => s });
