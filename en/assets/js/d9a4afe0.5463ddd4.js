...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [3020],
 {
  13455: (e, o, l) => {
   l.d(o, { X: () => _ });
   var n = l(67294);
   const a = { "nlds-canvas": "nlds-canvas_h8Yz", "nlds-canvas--distanced": "nlds-canvas--distanced_BU4b", "nlds-canvas__example": "nlds-canvas__example_sS53", "nlds-canvas__code-block": "nlds-canvas__code-block_eqxI", "nlds-canvas__code-block--user-select-none": "nlds-canvas__code-block--user-select-none_Jv1j", "nlds-canvas__toolbar": "nlds-canvas__toolbar_AMcV", "nlds-canvas__button": "nlds-canvas__button_cHBw" };
   var t = l(86010),
    d = l(28182),
    r = l.n(d),
    i = l(72237),
   ...
   const p = (e) => {
     let { target: o } = e;
     const l = o.getAttribute("aria-controls"),
      n = o.ownerDocument.getElementById(l);
     (n.hidden = !n.hidden), o.setAttribute("aria-expanded", !n.hidden), (o.innerText = n.hidden ? "Bekijk code" : "Verberg code");
    },
    _ = (e) => {
     let { code: o, copy: l = !1, defaultCollapsed: d = !1, children: i, language: s } = e;
     const _ = m().format(k.uS(o || i), { parser: "html", plugins: [r(), c()], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" }),
      h = (0, v.Z)();
     return n.createElement(
      "div",
      { className: (0, t.Z)(a["nlds-canvas"], "voorbeeld-theme", "utrecht-html") },
      n.createElement("div", { className: (0, t.Z)(a["nlds-canvas__example"]) }, i),
      n.createElement("div", { className: (0, t.Z)(a["nlds-canvas__toolbar"]) }, n.createElement(g.zx, { className: (0, t.Z)(a["nlds-canvas__button"], a["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: p, "aria-expanded": !d, "aria-controls": h }, d ? "Bekijk code" : "Verberg code")),
      n.createElement(
       "div",
       { className: (0, t.Z)(a["nlds-canvas__code-block"], !l && a["nlds-canvas__code-block--user-select-none"]), id: h, hidden: d },
       n.createElement(u.Z, { language: s, style: b }, _),
       l &&
        n.createElement(
         "div",
         { className: (0, t.Z)(a["nlds-canvas__toolbar"]) },
         n.createElement(
          g.zx,
          {
           className: (0, t.Z)(a["nlds-canvas__button"], a["nlds-canvas__copy-button"]),
  ...
  31092: (e, o, l) => {
   ...
   var r = l(86010),
    i = l(65663);
   const c = (e) => {
    let { title: o, appearance: l, description: c, children: s } = e;
    const m = { do: "Doen", dont: "Niet doen" },
     k = o ? `${m[l]}: ${o}` : m[l];
    return n.createElement("div", { className: (0, r.Z)(d["nlds-guideline"], d[`nlds-guideline--${l}`]), id: null == o ? void 0 : o.toLowerCase().replace(/\s/g, "-") }, n.createElement("div", { className: (0, r.Z)(d["nlds-guideline__description"]) }, "dont" === l ? n.createElement(i.nv, { className: (0, r.Z)(d["nlds-guideline__badge"], d[`nlds-guideline__badge--${l}`]) }, n.createElement(a.Z, { className: d["nlds-guideline__icon"] }), n.createElement("span", { className: d["nlds-guideline__title"] }, k)) : n.createElement(i.nv, { className: (0, r.Z)(d["nlds-guideline__badge"], d[`nlds-guideline__badge--${l}`]) }, n.createElement(t.Z, { className: d["nlds-guideline__icon"] }), n.createElement("span", { className: d["nlds-guideline__title"] }, k)), c), n.createElement("div", { className: (0, r.Z)(d["nlds-guideline__example"]) }, s));
   };
  },
  70618: (e, o, l) => {
   l.r(o), l.d(o, { assets: () => k, contentTitle: () => s, default: () => v, frontMatter: () => c, metadata: () => m, toc: () => u });
   var n = l(87462),
    a = l(67294),
    t = l(3905),
    d = l(13455),
    r = l(31092),
    i = l(53579);
   const c = { title: "Duidelijk | Formulieren", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Duidelijk", sidebar_position: 2, pagination_label: "Duidelijk", description: "Een duidelijk formulier zorgt dat gebruikers met meer vertrouwen en zelfstandiger door je formulier kunnen gaan", keywords: ["richtlijnen", "formulieren", "toegankelijkheid", "layout"] },
    s = void 0,
    m = { unversionedId: "richtlijnen/formulieren/duidelijk", id: "richtlijnen/formulieren/duidelijk", title: "Duidelijk | Formulieren", description: "Een duidelijk formulier zorgt dat gebruikers met meer vertrouwen en zelfstandiger door je formulier kunnen gaan", source: "@site/docs/richtlijnen/formulieren/02-duidelijk.mdx", sourceDirName: "richtlijnen/formulieren", slug: "/richtlijnen/formulieren/duidelijk", permalink: "/en/richtlijnen/formulieren/duidelijk", draft: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/02-duidelijk.mdx", tags: [], version: "current", sidebarPosition: 2, frontMatter: { title: "Duidelijk | Formulieren", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Duidelijk", sidebar_position: 2, pagination_label: "Duidelijk", description: "Een duidelijk formulier zorgt dat gebruikers met meer vertrouwen en zelfstandiger door je formulier kunnen gaan", keywords: ["richtlijnen", "formulieren", "toegankelijkheid", "layout"] }, sidebar: "richtlijnen", previous: { title: "Toegankelijk", permalink: "/en/richtlijnen/formulieren/toegankelijk" }, next: { title: "Makkelijk in te vullen", permalink: "/en/richtlijnen/formulieren/makkelijk-in-te-vullen" } },
    k = {},
    u = [
    ...
    g = "wrapper";
   function v(e) {
    let { components: o, ...l } = e;
    return (0, t.kt)(g, (0, n.Z)({}, b, l, { components: o, mdxType: "MDXLayout" }), (0, t.kt)("h1", { id: "duidelijk" }, "Duidelijk"), (0, t.kt)(i.nv, { lead: !0, mdxType: "Paragraph" }, "Een duidelijk formulier zorgt dat gebruikers met meer vertrouwen en zelfstandiger door je formulier kunnen gaan."), (0, t.kt)("h2", { id: "vermijd-belangrijke-informatie-in-tooltips" }, "Vermijd belangrijke informatie in tooltips"), (0, t.kt)("p", null, "Informatie die nodig is om een veld in te kunnen vullen, kan beste beste worden opgenomen als onderdeel van de content, bijvoorbeeld als omschrijving onder het label. Vermijd het gebruik van tooltips (of placeholders) voor belangrijke informatie.."), (0, t.kt)("h2", { id: "leg-jargon-uit" }, "Leg jargon uit"), (0, t.kt)("p", null, "Soms is het niet te voorkomen dat een formulier jargon bevat, bijvoorbeeld omdat termen wettelijk zijn vastgelegd. Leg in zulke gevallen duidelijk uit wat zo'n term betekent."), (0, t.kt)("h2", { id: "houd-taal-consistent" }, "Houd taal consistent"), (0, t.kt)("p", null, "Zorg ervoor dat door het hele formulier voor dezelfde dingen dezelfde termen worden gebruikt."), (0, t.kt)("h2", { id: "duidelijke-labels" }, "Duidelijke labels"), (0, t.kt)("p", null, "Het doel van een label is dat de gebruiker de vraag begrijpt. Een effectief label is duidelijk en beschrijvend. Waar nodig wordt er ook extra hulp geboden worden, zoals een omschrijving van waar een BSN-nummer te vinden is."), (0, t.kt)(r.X, { appearance: "do", title: "Simpel label met extra beschrijving", description: (0, t.kt)(i.nv, { mdxType: "Paragraph" }, "Gebruik waar nodig een losse ", (0, t.kt)(i.EK, { mdxType: "Code" }, "form-field-description"), " om meer uitleg te geven."), mdxType: "Guideline" }, (0, t.kt)(d.X, { language: "html", code: (0, t.kt)(a.Fragment, null, (0, t.kt)("label", { htmlFor: "first-name" }, "Voornaam(en)"), (0, t.kt)("p", { id: "first-name-description" }, " Vul de voornaam of voornamen in zoals deze op je id-kaart of paspoort staan."), (0, t.kt)("input", { type: "text", name: "first_name", id: "first-name", "aria-describedby": "first-name-description" })), copy: !0, defaultCollapsed: !0, mdxType: "Canvas" }, (0, t.kt)(i.Wi, { type: "text", mdxType: "FormField" }, (0, t.kt)(i.nv, { className: "utrecht-form-field__label", mdxType: "Paragraph" }, (0, t.kt)(i.lX, { htmlFor: "ff", mdxType: "FormLabel" }, "Voornaam (een of meerdere)")), (0, t.kt)(i.ue, { className: "utrecht-form-field__description", id: "ff-description", mdxType: "FormFieldDescription" }, "Vul de voornaam of voornamen in zoals deze op je id-kaart of paspoort staan."), (0, t.kt)(i.fE, { name: "first_name", id: "ff", "aria-describedby": "ff-description", mdxType: "Textbox" })))), (0, t.kt)(r.X, { appearance: "dont", title: "Ingewikkeld label", description: "Door veel informatie in te korten wordt het label onduidelijk", mdxType: "Guideline" }, (0, t.kt)(d.X, { language: "html", code: (0, t.kt)(a.Fragment, null, (0, t.kt)("label", { htmlFor: "name" }, "Voornaam(en)"), (0, t.kt)("input", { type: "text", name: "first_name", id: "name" })), defaultCollapsed: !0, mdxType: "Canvas" }, (0, t.kt)(i.Wi, { type: "text", mdxType: "FormField" }, (0, t.kt)(i.nv, { className: "utrecht-form-field__label", mdxType: "Paragraph" }, (0, t.kt)(i.lX, { htmlFor: "name", mdxType: "FormLabel" }, "Voornaam(en)")), (0, t.kt)(i.fE, { name: "first_name", id: "name", mdxType: "Textbox" })))), (0, t.kt)("h2", { id: "leg-uit-waarom-informatie-nodig-is" }, "Leg uit waarom informatie nodig is"), (0, t.kt)("p", null, "Soms lijkt een vraag overbodig, terwijl deze essentieel is. In zulke gevallen is het een goed idee een korte uitleg toe te vroegen, om bijvoorbeeld het doel te beschrijven."), (0, t.kt)(r.X, { appearance: "do", title: "Leg het doel uit", description: "Met uitleg weet de gebruiker waar die aan toe is.", mdxType: "Guideline" }, (0, t.kt)(d.X, { language: "html", code: (0, t.kt)(a.Fragment, null, (0, t.kt)("label", { htmlFor: "email" }, "Emailadres"), (0, t.kt)("p", null, "We hebben uw emailadres nodig om een afspraakbevestiging te kunnen sturen."), (0, t.kt)("input", { type: "text", name: "email", id: "email" })), defaultCollapsed: !0, mdxType: "Canvas" }, (0, t.kt)(i.Wi, { type: "text", mdxType: "FormField" }, (0, t.kt)(i.nv, { className: "utrecht-form-field__label", mdxType: "Paragraph" }, (0, t.kt)(i.lX, { htmlFor: "email", mdxType: "FormLabel" }, "Emailadres"), (0, t.kt)(i.ue, { mdxType: "FormFieldDescription" }, "We hebben uw emailadres nodig om een afspraakbevestiging te kunnen sturen.")), (0, t.kt)(i.fE, { name: "email", id: "email", mdxType: "Textbox" })))));
   }
   v.isMDXComponent = !0;
  },
 },
