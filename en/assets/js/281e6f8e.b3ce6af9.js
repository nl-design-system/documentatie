...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  84550: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => d, contentTitle: () => o, default: () => m, frontMatter: () => l, metadata: () => a, toc: () => h });
   var i = t(11527),
    r = t(80877),
    s = t(82415);
  ...
  82415: (e, n, t) => {
   ...
   var i = t(83778),
    ...
    l = t(11527);
   const o = (e) => {
    let { listId: n = "", laPostaId: t = "", thanksPage: o = "", emailFieldId: a = "", firstNameFieldId: d = "", orgId: h = "", interestsId: c = "", interests: m = [], workAreasId: p = "" } = e;
    const {
      register: j,
      handleSubmit: u,
      formState: { errors: v },
    ...
    return (0, l.jsxs)("form", {
     ...
     children: [(0, l.jsxs)(i.Wi, { type: "email", children: [(0, l.jsx)(i.nv, { children: (0, l.jsx)(i.lX, { htmlFor: `id-${a}`, children: "E-mailadres" }) }), v[a] && (0, l.jsx)(i.w7, { children: (0, l.jsx)(i.nv, { children: v[a].message }) }), (0, l.jsx)(i.nv, { children: (0, l.jsx)(i.fE, { id: `id-${a}`, name: a, type: "email", "aria-required": "true", autoComplete: "email", ...j(`${a}`, { required: { value: !0, message: "Dit veld is verplicht, maar het is niet ingevuld." }, pattern: { value: /\S+@\S+\.\S+/, message: "Dit is geen correct emailadres." } }), invalid: !!v[a] }) })] }), (0, l.jsxs)(i.Wi, { type: "text", children: [(0, l.jsx)(i.nv, { children: (0, l.jsx)(i.lX, { htmlFor: d, children: "Naam (niet verplicht)" }) }), (0, l.jsx)(i.nv, { children: (0, l.jsx)(i.fE, { id: d, name: d, type: "text", autoComplete: "given-name" }) })] }), h && (0, l.jsxs)(i.Wi, { type: "text", children: [(0, l.jsx)(i.nv, { children: (0, l.jsx)(i.lX, { htmlFor: h, children: "Organisatie (niet verplicht)" }) }), (0, l.jsx)(i.nv, { children: (0, l.jsx)(i.fE, { id: h, name: h, type: "text" }) })] }), c && (0, l.jsxs)(i.pg, { children: [(0, l.jsx)(i.Qv, { children: "Waar ligt je interesse? (niet verplicht)" }), m.map((e, n) => (0, l.jsx)(i.Wi, { type: "checkbox", children: (0, l.jsxs)(i.nv, { children: [(0, l.jsx)(i.XZ, { name: `${c}[]`, value: n + 1, id: `${c}-${n + 1}` }), (0, l.jsx)(i.lX, { htmlFor: `${c}-${n + 1}`, children: e })] }) }, e))] }), p && (0, l.jsxs)(i.Wi, { type: "text", children: [(0, l.jsx)(i.nv, { children: (0, l.jsx)(i.lX, { htmlFor: p, children: "Waar werk je momenteel vooral aan? Denk aan mijn-omgevingen, formulieren, kaarten. (niet verplicht)" }) }), (0, l.jsx)(i.nv, { children: (0, l.jsx)(i.fE, { id: p, name: p, type: "text" }) })] }), (0, l.jsx)(i.hE, { children: (0, l.jsx)(i.zx, { type: "submit", appearance: "primary-action-button", children: "Aanmelden" }) }), (0, l.jsx)("input", { type: "hidden", name: "next", value: o }), (0, l.jsx)("input", { type: "hidden", name: "a", value: t }), (0, l.jsx)("input", { type: "hidden", name: "l", value: n }), (0, l.jsx)("input", { name: "osnD9cWRI3", autoComplete: "on", id: "id-osnD9cWRI3", type: "hidden", value: "NLDS website" }), (0, l.jsx)("input", { autoComplete: "new-password", type: "email", id: "email", name: "email", placeholder: "Your e-mail here", className: "sr-only", "aria-hidden": "true" })],
    });
   };
  },
  80877: (e, n, t) => {
