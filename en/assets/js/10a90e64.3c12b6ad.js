...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  7850: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => d, default: () => p, frontMatter: () => c, metadata: () => u, toc: () => g });
   var t = i(52676),
    r = i(24785),
    s = i(91410),
    a = i(88435);
   ...
   const c = { title: 'WCAG-succescriterium 2.5.8 Grootte van het aanwijsgebied (minimum)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.8 Grootte van het aanwijsgebied (minimum)', pagination_label: 'WCAG-succescriterium 2.5.8 Grootte van het aanwijsgebied (minimum)', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', slug: '2.5.8', keywords: ['WCAG'] },
    d = 'WCAG-succescriterium 2.5.8 Grootte van het aanwijsgebied (minimum)',
