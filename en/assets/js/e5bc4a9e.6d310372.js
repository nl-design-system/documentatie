 ...
 [41990],
 {
  6818: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    o = n(16391);
   const s = { title: 'Separator', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Separator', pagination_label: 'Separator', description: 'Toont een horizontale lijn om content te scheiden.', slug: '/separator', sidebar_custom_props: { illustration: 'SeparatorSketch' } },
    a = void 0,
    u = { id: 'componenten/separator/index', title: 'Separator', description: 'Toont een horizontale lijn om content te scheiden.', source: '@site/docs/componenten/separator/index.mdx', sourceDirName: 'componenten/separator', slug: '/separator', permalink: '/en/separator', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/separator/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Separator', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Separator', pagination_label: 'Separator', description: 'Toont een horizontale lijn om content te scheiden.', slug: '/separator', sidebar_custom_props: { illustration: 'SeparatorSketch' } }, sidebar: 'componenten', previous: { title: 'Select', permalink: '/en/select' }, next: { title: 'Side navigation', permalink: '/en/side-navigation' } },
    l = {},
    h = [
  ...
  16391: (e, t, n) => {
   ...
   const k = 'task-list_hh8j',
    ...
    N = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, c.Z)(f), children: [(0, l.jsxs)('div', { className: (0, c.Z)(_, { [x]: t }), children: [(0, l.jsx)('span', { className: S, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.aC, { role: 'presentation', children: n }), (0, l.jsx)(v.nv, { children: r })] })] });
    };
   var z = n(14669);
   const A = Object.keys({ HELP_WANTED: 'UNKNOWN', COMMUNITY: 'HELP_WANTED', CANDIDATE: 'COMMUNITY', HALL_OF_FAME: 'CANDIDATE' }),
    T = (e) => {
     ...
     const i = t && t.projects.filter((e) => A.includes(e.id)),
      o = i && A.map((e) => i.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
    ...
    M = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.X6, { level: n, children: [t.title, ' ', i && (0, l.jsx)(g.y, { state: i })] }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  42677: (e, t, n) => {
   'use strict';
