/*! For license information please see 1a4e3797.7f105804.js.LICENSE.txt */
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [97920],
 {
  ...
  8131: (e, t, r) => {
   ...
   (a.version = r(24336)), (a.AlgoliaSearchHelper = n), (a.SearchParameters = i), (a.SearchResults = s), (e.exports = a);
  },
  68078: (e, t, r) => {
   "use strict";
   var n = r(17331);
    ...
    function V(e, t, n) {
     var i,
      s = {
       ...
       hostsCache: c({ caches: [a({ key: "".concat("4.20.0", "-").concat(e) }), u()] }),
       userAgent: x("4.20.0").add({ segment: "Browser", version: "lite" }),
  ...
  48852: (e, t, r) => {
   ...
   function i(e) {
    ...
    if ("string" == typeof e || "number" == typeof e) n += e;
     ...
     if (Array.isArray(e)) for (t = 0; t < e.length; t++) e[t] && (r = i(e[t])) && (n && (n += " "), (n += r));
   ...
   function O(e) {
    ...
    return (0, E.jsx)("div", {
     className: s("col", "col--3", "padding-left--none", _.searchVersionColumn),
     children: r.map((e) => {
      let [n, i] = e;
      const s = r.length > 1 ? `${n}: ` : "";
      return (0, E.jsx)("select", { onChange: (e) => t.setSearchVersion(n, e.target.value), defaultValue: t.searchVersions[n], className: _.searchVersionInput, children: i.versions.map((e, t) => (0, E.jsx)("option", { label: `${s}${e.label}`, value: e.name }, t)) }, n);
     }),
    });
   }
   function w() {
    const {
     ...
     [w, A] = (0, p.K)(),
     N = { items: [], query: null, totalResults: null, totalPages: null, lastPage: null, hasMore: null, loading: null },
     ...
     T = o()(t, r),
     Q = c()(T, i, { hitsPerPage: 15, advancedSyntax: !0, disjunctiveFacets: ["language", "docusaurus_tag"] });
    Q.on("result", (e) => {
     let {
      results: { query: t, hits: r, page: n, nbHits: i, nbPages: s },
     } = e;
     if ("" === t || !Array.isArray(r)) return void S({ type: "reset" });
     const c = (e) => e.replace(/algolia-docsearch-suggestion--highlight/g, "search-result-match"),
      u = r.map((e) => {
       let {
        url: t,
       ...
       return { title: i.pop(), url: a(t), summary: n.content ? `${c(n.content.value)}...` : "", breadcrumbs: i };
      });
    ...
    const [C, I] = (0, n.useState)(null),
     ...
     q = () => (w ? (0, R.I)({ id: "theme.SearchPage.existingResultsTitle", message: 'Search results for "{query}"', description: "The search page title for non-empty query" }, { query: w }) : (0, R.I)({ id: "theme.SearchPage.emptyResultsTitle", message: "Search the documentation", description: "The search page title for empty query" })),
     V = (0, v.zX)(function (t) {
      void 0 === t && (t = 0),
       Q.addDisjunctiveFacetRefinement("docusaurus_tag", "default"),
       Q.addDisjunctiveFacetRefinement("language", e),
       Object.entries(g.searchVersions).forEach((e) => {
        let [t, r] = e;
       ...
       (0, E.jsxs)("div", {
        ...
        children: [
         ...
         H.items.length > 0
          ...
          : [w && !H.loading && (0, E.jsx)("p", { children: (0, E.jsx)(R.Z, { id: "theme.SearchPage.noResultsText", description: "The paragraph for empty search result", children: "No results were found" }) }, "no-results"), !!H.loading && (0, E.jsx)("div", { className: _.loadingSpinner }, "spinner")],
         H.hasMore && (0, E.jsx)("div", { className: _.loader, ref: I, children: (0, E.jsx)(R.Z, { id: "theme.SearchPage.fetchingNewResults", description: "The paragraph for fetching new search results", children: "Fetching new results..." }) }),
        ],
       }),
      ],
     })
   ...
   function A() {
    return (0, E.jsx)(g.FG, { className: "search-page-wrapper", children: (0, E.jsx)(w, {}) });
   }
  },
 },
]);
