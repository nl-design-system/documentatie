 ...
 [38934],
 {
  62314: (e, n, o) => {
   ...
   const i = { title: 'Gebruikersonderzoek', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Gebruikersonderzoek', sidebar_position: 1, pagination_label: 'Overzicht', description: 'Gebruikersonderzoek', keywords: ['index', 'onderzoek'] },
    ...
    s = { id: 'voorbeelden/onderzoek/README', title: 'Gebruikersonderzoek', description: 'Gebruikersonderzoek', source: '@site/docs/voorbeelden/onderzoek/README.md', sourceDirName: 'voorbeelden/onderzoek', slug: '/voorbeelden/onderzoek/', permalink: '/en/voorbeelden/onderzoek/', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/voorbeelden/onderzoek/README.md', tags: [], version: 'current', sidebarPosition: 1, frontMatter: { title: 'Gebruikersonderzoek', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Gebruikersonderzoek', sidebar_position: 1, pagination_label: 'Overzicht', description: 'Gebruikersonderzoek', keywords: ['index', 'onderzoek'] }, sidebar: 'voorbeelden', previous: { title: 'Voorbeelden', permalink: '/en/voorbeelden' }, next: { title: 'Patronen', permalink: '/en/voorbeelden/patronen' } },
    a = {},
