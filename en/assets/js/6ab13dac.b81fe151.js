(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [83760],
 {
  62604: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => g, contentTitle: () => a, default: () => b, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => m, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Form field partial label', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field partial label', pagination_label: 'Form field partial label', description: ' ', slug: '/form-field-partial-label', sidebar_custom_props: { illustration: 'FormFieldPartialLabelSketch' } },
    a = void 0,
    l = { id: 'componenten/form-field-partial-label/index', title: 'Form field partial label', description: ' ', source: '@site/docs/componenten/form-field-partial-label/index.mdx', sourceDirName: 'componenten/form-field-partial-label', slug: '/form-field-partial-label', permalink: '/en/form-field-partial-label', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-field-partial-label/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form field partial label', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field partial label', pagination_label: 'Form field partial label', description: ' ', slug: '/form-field-partial-label', sidebar_custom_props: { illustration: 'FormFieldPartialLabelSketch' } }, sidebar: 'componenten', previous: { title: 'Form field partial', permalink: '/en/form-field-partial' }, next: { title: 'Form field radio option', permalink: '/en/form-field-radio-option' } },
    u = {},
    d = [
   ...
   const D = (e) => {
     ...
     return (
      ...
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], y[`definition-of-done--${(0, F.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
