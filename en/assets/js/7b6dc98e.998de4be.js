 ...
 [3693],
 {
  45590: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(76037),
    o = n(23952);
   const s = { title: 'Blockquote', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Blockquote', pagination_label: 'Blockquote', description: 'Toont een citaat dat afwijkt van de hoofdtekst.', slug: '/blockquote', keywords: ['blockquote', 'citaat', 'cite', 'citeren', 'excerpt', 'extract', 'fragment', 'quotation', 'quote', 'snippet', 'tekstfragment', 'uitspraak'] },
    a = void 0,
    u = { id: 'componenten/blockquote/index', title: 'Blockquote', description: 'Toont een citaat dat afwijkt van de hoofdtekst.', source: '@site/docs/componenten/blockquote/index.mdx', sourceDirName: 'componenten/blockquote', slug: '/blockquote', permalink: '/en/blockquote', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/blockquote/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Blockquote', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Blockquote', pagination_label: 'Blockquote', description: 'Toont een citaat dat afwijkt van de hoofdtekst.', slug: '/blockquote', keywords: ['blockquote', 'citaat', 'cite', 'citeren', 'excerpt', 'extract', 'fragment', 'quotation', 'quote', 'snippet', 'tekstfragment', 'uitspraak'] }, sidebar: 'componenten', previous: { title: 'Avatar', permalink: '/en/avatar' }, next: { title: 'Breadcrumb Navigation', permalink: '/en/breadcrumb-navigation' } },
    l = {},
    d = [
    ...
    h = 'Blockquote',
    j = 'Toont een citaat dat afwijkt van de hoofdtekst.',
    y = 73,
  ...
  23952: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(_), children: [(0, l.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, l.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var S = n(14669);
   const D = (e) => {
