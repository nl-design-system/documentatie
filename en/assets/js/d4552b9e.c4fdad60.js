  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.aC, { role: 'presentation', children: n }), (0, u.jsx)(v.nv, { children: r })] })] });
    };
   var F = n(14669);
   const T = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => F.e9.includes(e.id)),
      o = c && F.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(m['definition-of-done'], m[`definition-of-done--${(0, F.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
         ...
         children: [
          (0, u.jsx)(S, {
           children: e.tasks.map((e) => {
            ...
            return (0, u.jsx)(z, { checked: t, title: n, description: (0, F.Q6)(r) }, r);
           }),
          }),
    ...
    M = (e) => {
     ...
     const c = t && F.$3[t.relayStep];
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(b, { level: n, suffix: c && (0, u.jsx)(p.y, { state: c }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  42677: (e, t, n) => {
   'use strict';
