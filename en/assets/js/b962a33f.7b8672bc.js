 ...
 [4270],
 {
  ...
  3460: (e, n, r) => {
   ...
   const j = (e) => {
    ...
    b = (e) => {
     let { code: n, copy: r = !1, defaultCollapsed: b = !0, children: x, language: w, designTokens: v } = e,
      k = "function" == typeof x ? x() : x,
      f = "function" == typeof n ? n() : (0, c.isValidElement)(n) ? n : void 0,
      y = "string" == typeof n ? n : p.uS(f || k),
      [_, D] = (0, c.useState)(y);
     (0, c.useEffect)(() => {
      (async () => {
       (_ = await d.ZP.format(y, { parser: w, plugins: [t.Z, s.ZP, l.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), D(_);
      })();
     }, [y]);
     const N = (0, h.Z)();
     return (0, g.jsxs)("div", {
      ...
      children: [
       k && (0, g.jsx)("div", { className: (0, i.Z)(u["nlds-canvas__example"]), children: (0, g.jsx)(o.pu, { className: "voorbeeld-theme", style: v, children: k }) }),
       (0, g.jsx)("div", { className: (0, i.Z)(u["nlds-canvas__toolbar"]), children: (0, g.jsx)(o.zx, { className: (0, i.Z)(u["nlds-canvas__button"], u["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: j, "aria-expanded": !b, "aria-controls": N, children: b ? "Bekijk code" : "Verberg code" }) }),
       (0, g.jsxs)("div", {
        className: (0, i.Z)(u["nlds-canvas__code-block"], !r && u["nlds-canvas__code-block--user-select-none"]),
        id: N,
        hidden: b,
        children: [
         (0, g.jsx)(m.u, { syntax: w, textContent: _, trim: !0 }),
         r &&
          (0, g.jsx)("div", {
