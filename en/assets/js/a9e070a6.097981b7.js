 ...
 [5701],
 {
  ...
  3460: (e, n, l) => {
   ...
   const j = (e) => {
    ...
    v = (e) => {
     let { code: n, copy: l = !1, defaultCollapsed: v = !0, children: b, language: x, designTokens: k } = e,
      y = "function" == typeof b ? b() : b,
      f = "function" == typeof n ? n() : (0, d.isValidElement)(n) ? n : void 0,
      _ = "string" == typeof n ? n : h.uS(f || y),
      [w, z] = (0, d.useState)(_);
     (0, d.useEffect)(() => {
      (async () => {
       (w = await c.ZP.format(_, { parser: x, plugins: [t.Z, i.ZP, s.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), z(w);
      })();
     }, [_]);
     const S = (0, p.Z)();
     return (0, g.jsxs)("div", {
      ...
      children: [
       y && (0, g.jsx)("div", { className: (0, o.Z)(u["nlds-canvas__example"]), children: (0, g.jsx)(r.pu, { className: "voorbeeld-theme", style: k, children: y }) }),
       (0, g.jsx)("div", { className: (0, o.Z)(u["nlds-canvas__toolbar"]), children: (0, g.jsx)(r.zx, { className: (0, o.Z)(u["nlds-canvas__button"], u["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: j, "aria-expanded": !v, "aria-controls": S, children: v ? "Bekijk code" : "Verberg code" }) }),
       (0, g.jsxs)("div", {
        className: (0, o.Z)(u["nlds-canvas__code-block"], !l && u["nlds-canvas__code-block--user-select-none"]),
        id: S,
        hidden: v,
        children: [
         (0, g.jsx)(m.u, { syntax: x, textContent: w, trim: !0 }),
         l &&
          (0, g.jsx)("div", {
