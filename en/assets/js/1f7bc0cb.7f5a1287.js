   ...
   const v = (e) => {
    ...
    h = (e) => {
     ...
     return l.createElement(
      ...
      l.createElement("div", { className: (0, t.Z)(a["nlds-canvas__example"]) }, i),
      l.createElement("div", { className: (0, t.Z)(a["nlds-canvas__toolbar"]) }, l.createElement(g.zx, { className: (0, t.Z)(a["nlds-canvas__button"], a["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: v, "aria-expanded": !r, "aria-controls": _ }, r ? "Bekijk code" : "Verberg code")),
      l.createElement(
       "div",
       { className: (0, t.Z)(a["nlds-canvas__code-block"], !o && a["nlds-canvas__code-block--user-select-none"]), id: _, hidden: r },
  ...
  31092: (e, n, o) => {
   ...
   const c = (e) => {
    ...
    const k = { do: "Doen", dont: "Niet doen" },
     m = n ? `${k[o]}: ${n}` : k[o];
    return l.createElement("div", { className: (0, d.Z)(r["nlds-guideline"], r[`nlds-guideline--${o}`]), id: null == n ? void 0 : n.toLowerCase().replace(/\s/g, "-") }, l.createElement("div", { className: (0, d.Z)(r["nlds-guideline__description"]) }, "dont" === o ? l.createElement(i.nv, { className: (0, d.Z)(r["nlds-guideline__badge"], r[`nlds-guideline__badge--${o}`]) }, l.createElement(a.Z, { className: r["nlds-guideline__icon"] }), l.createElement("span", { className: r["nlds-guideline__title"] }, m)) : l.createElement(i.nv, { className: (0, d.Z)(r["nlds-guideline__badge"], r[`nlds-guideline__badge--${o}`]) }, l.createElement(t.Z, { className: r["nlds-guideline__icon"] }), l.createElement("span", { className: r["nlds-guideline__title"] }, m)), c), l.createElement("div", { className: (0, d.Z)(r["nlds-guideline__example"]) }, s));
   };
  },
  37067: (e, n, o) => {
   ...
   const c = { title: "Toegankelijk | Formulieren", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Toegankelijk", sidebar_position: 1, pagination_label: "Toegankelijk", description: "Een formulier moet toegankelijk zijn", keywords: ["richtlijnen", "formulieren", "toegankelijkheid", "labels"] },
    ...
    u =
     ...
     function (e) {
      return console.warn("Component " + g + " was not imported, exported, or provided by MDXProvider as global scope"), (0, t.kt)("div", e);
     });
   var g;
   const p = { toc: b },
    v = "wrapper";
   function h(e) {
    ...
    return (0, t.kt)(v, (0, l.Z)({}, p, o, { components: n, mdxType: "MDXLayout" }), (0, t.kt)("h1", { id: "toegankelijk" }, "Toegankelijk"), (0, t.kt)(i.nv, { lead: !0, mdxType: "Paragraph" }, "Een formulier moet toegankelijk zijn. Dit betekent dat er in ontwerp en techniek rekening is gehouden met alle verschillende manieren waarop mensen websites gebruiken, inclusief mensen met een beperking."), (0, t.kt)("h2", { id: "maak-alles-bereikbaar-met-het-toetsenbord" }, "Maak alles bereikbaar met het toetsenbord"), (0, t.kt)("p", null, "Sommige gebruikers navigeren door een formulier met hun ", (0, t.kt)("inlineCode", { parentName: "p" }, "Tab"), "-toets. Zorg dat alle onderdelen van het formulier bereikbaar zijn en gebruikt kunnen worden met alleen een toetsenbord (inclusief bijvoorbeeld kalenders). Dit ondersteunt toetsenbordgebruikers, maar ook gebruikers met andere randapparatuur die zich als toetsenbordpresenteert, zoals een ", (0, t.kt)("em", { parentName: "p" }, "switch control"), "."), (0, t.kt)("h2", { id: "geef-elk-veld-een-naam" }, "Geef elk veld een naam"), (0, t.kt)("p", null, "Elk formulierveld moet een \u201ctoegankelijke naam\u201d hebben, dit is een naam die in de code gekoppeld is aan het veld. Dit wordt bijvoorbeeld gebruikt in hulptechnologie\xebn als schermlezers en stembediening."), (0, t.kt)("p", null, "De snelste manier om een veld een naam te geven, is door een ", (0, t.kt)("inlineCode", { parentName: "p" }, "<label>"), "-element in code te koppelen aan het veld."), (0, t.kt)("p", null, "Tips:"), (0, t.kt)("ul", null, (0, t.kt)("li", { parentName: "ul" }, "houd de toegankelijke naam en de zichtbare naam hetzelfde (zie ook ", (0, t.kt)("a", { parentName: "li", href: "https://www.w3.org/Translations/WCAG21-nl/#label-in-naam" }, "WCAG 2.5.3 Label in naam"), ")"), (0, t.kt)("li", { parentName: "ul" }, "een snelle test of de koppeling werkt: klik op het label en ga na of het veld focus krijgt")), (0, t.kt)("p", null, "Lees hierover meer op de ", (0, t.kt)("a", { parentName: "p", href: "/richtlijnen/formulieren/alle-richtlijnen/labels" }, "richtlijnen over labels"), "."), (0, t.kt)("h2", { id: "vertrouw-niet-alleen-op-kleur" }, "Vertrouw niet alleen op kleur"), (0, t.kt)("p", null, "Soms gebruikt een formulier kleur om een status aan te geven, bijvoorbeeld dat een veld een fout bevat. Zorg er dan voor dat kleur niet de enige manier is waarop het verschil tussen \u201cgoede\u201d en \u201cfoute\u201d invoer wordt aangegeven. Dan is de status namelijk mogelijk niet te onderscheiden door mensen met kleurenblindheid."), (0, t.kt)("p", null, (0, t.kt)("em", { parentName: "p" }, "Dit is verplicht om te voldoen aan WCAG 2.1, ", (0, t.kt)("a", { parentName: "em", href: "https://www.w3.org/Translations/WCAG21-nl/#gebruik-van-kleur" }, "1.4.1 Gebruik van kleur"), ".")), (0, t.kt)(d.X, { appearance: "do", title: "Beschrijf in tekst", description: (0, t.kt)(i.nv, { mdxType: "Paragraph" }, "Vul de kleur aan met een beschrijving in tekst dat een melding een fout betreft, bijvoorbeeld \u201cFout: \u201d."), mdxType: "Guideline" }, (0, t.kt)(r.X, { language: "html", code: (0, t.kt)(a.Fragment, null, (0, t.kt)(i.Wi, { mdxType: "FormField" }, (0, t.kt)(i.lX, { htmlFor: "name", mdxType: "FormLabel" }, "Voornaam"), (0, t.kt)(u, { invalid: "true", mdxType: "FormFieldDescription" }, "Fout: Dit is geen goede naam"), (0, t.kt)(i.fE, { type: "text", name: "first_name", id: "name", mdxType: "Textbox" }))), mdxType: "Canvas" }, (0, t.kt)(i.Wi, { mdxType: "FormField" }, (0, t.kt)(i.lX, { htmlFor: "name", mdxType: "FormLabel" }, "Voornaam"), (0, t.kt)(u, { invalid: "true", style: { color: "darkred" }, mdxType: "FormFieldDescription" }, "Fout: Dit is geen goede naam"), (0, t.kt)(i.fE, { type: "text", name: "first_name", id: "name", mdxType: "Textbox" })))), (0, t.kt)("h2", { id: "zorg-voor-focusstijlen" }, "Zorg voor focusstijlen"), (0, t.kt)("p", null, "Er is op je hele website altijd precies \xe9\xe9n element dat \u201cfocus\u201d heeft. Als gebruikers een formulier invullen, krijgt het veld waar ze in typen focus. Zorg dat het als zodanig herkenbaar is door een duidelijke focusstijl te gebruiken."), (0, t.kt)("p", null, (0, t.kt)("em", { parentName: "p" }, "Dit is verplicht om te voldoen aan WCAG 2.1, criterium ", (0, t.kt)("a", { parentName: "em", href: "https://www.w3.org/Translations/WCAG21-nl/#focus-zichtbaar" }, "2.4.7 Focus Zichtbaar"), ".")), (0, t.kt)(d.X, { appearance: "dont", title: "Focus uitgezet", description: (0, t.kt)(i.nv, { mdxType: "Paragraph" }, "In CSS kan focus worden uitgezet met ", (0, t.kt)("code", null, "outline: none"), " of ", (0, t.kt)("code", null, "outline: 0"), ". Doe dit net, want het zorgt dat gebruikers niet kunnen zien of het veld focus heeft."), mdxType: "Guideline" }, (0, t.kt)(r.X, { language: "css", code: ":focus { outline: none; }", mdxType: "Canvas" })));
   }
   h.isMDXComponent = !0;
  },
 },
