 ...
 [91188],
 {
  79380: (e, n, t) => {
   ...
   const c = { title: 'WCAG-succescriterium 1.4.12 Tekstafstand', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.12 Tekstafstand', pagination_label: 'WCAG-succescriterium 1.4.12 Tekstafstand', description: 'Tekst kan op een aantal manieren aangepast worden, door mensen voor wie dat prettig is.', slug: '1.4.12', keywords: ['WCAG'] },
    u = void 0,
    g = { id: 'wcag/1.4.12', title: 'WCAG-succescriterium 1.4.12 Tekstafstand', description: 'Tekst kan op een aantal manieren aangepast worden, door mensen voor wie dat prettig is.', source: '@site/docs/wcag/1.4.12.mdx', sourceDirName: 'wcag', slug: '/wcag/1.4.12', permalink: '/en/wcag/1.4.12', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.12.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.4.12 Tekstafstand', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.12 Tekstafstand', pagination_label: 'WCAG-succescriterium 1.4.12 Tekstafstand', description: 'Tekst kan op een aantal manieren aangepast worden, door mensen voor wie dat prettig is.', slug: '1.4.12', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.4.11 Contrast van niet-tekstuele content', permalink: '/en/wcag/1.4.11' }, next: { title: 'WCAG-succescriterium 1.4.13 Content bij hover of focus', permalink: '/en/wcag/1.4.13' } },
    h = {},
    p = [
