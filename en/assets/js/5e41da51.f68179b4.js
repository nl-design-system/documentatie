(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [94960],
 {
  3033: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => g, contentTitle: () => a, default: () => v, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => m, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Drawer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Drawer', pagination_label: 'Drawer', description: 'Een paneel aan de zijkant van een scherm, die geopend kan worden voor gerelateerde informatie, formulieren of acties.', slug: '/drawer', sidebar_custom_props: { illustration: 'DrawerSketch' } },
    a = void 0,
    l = { id: 'componenten/drawer/index', title: 'Drawer', description: 'Een paneel aan de zijkant van een scherm, die geopend kan worden voor gerelateerde informatie, formulieren of acties.', source: '@site/docs/componenten/drawer/index.mdx', sourceDirName: 'componenten/drawer', slug: '/drawer', permalink: '/en/drawer', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/drawer/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Drawer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Drawer', pagination_label: 'Drawer', description: 'Een paneel aan de zijkant van een scherm, die geopend kan worden voor gerelateerde informatie, formulieren of acties.', slug: '/drawer', sidebar_custom_props: { illustration: 'DrawerSketch' } }, sidebar: 'componenten', previous: { title: 'Dot badge', permalink: '/en/dot-badge' }, next: { title: 'Fieldset', permalink: '/en/fieldset' } },
    u = {},
    d = [
