(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [88016],
 {
  39051: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => a, default: () => k, description: () => j, frontMatter: () => s, illustration: () => g, issueNumber: () => y, metadata: () => u, title: () => d, toc: () => h });
   var r = n(52676),
    c = n(24785),
    i = n(31612),
    o = n(60851);
   const s = { title: 'Checkbox group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Checkbox group', pagination_label: 'Checkbox group', description: 'Biedt de mogelijkheid om geen, \xe9\xe9n of meerdere opties te selecteren uit een lijst.', slug: '/checkbox-group', sidebar_custom_props: { illustration: 'CheckboxGroupSketch' }, keywords: ['aankruisvakje', 'aankruizen', 'check', 'checkbox', 'checkbox group', 'checked', 'checkmark', 'choice', 'choices', 'fieldset', 'form field', 'formulierveld', 'indeterminate', 'meerkeuze', 'meerkeuzevraag', 'multiple choice', 'option', 'options', 'select', 'selecteren', 'selectie', 'selectievakje', 'uncheck', 'unchecked', 'vinkje'] },
    a = void 0,
    u = { id: 'componenten/checkbox-group/index', title: 'Checkbox group', description: 'Biedt de mogelijkheid om geen, \xe9\xe9n of meerdere opties te selecteren uit een lijst.', source: '@site/docs/componenten/checkbox-group/index.mdx', sourceDirName: 'componenten/checkbox-group', slug: '/checkbox-group', permalink: '/en/checkbox-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/checkbox-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Checkbox group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Checkbox group', pagination_label: 'Checkbox group', description: 'Biedt de mogelijkheid om geen, \xe9\xe9n of meerdere opties te selecteren uit een lijst.', slug: '/checkbox-group', sidebar_custom_props: { illustration: 'CheckboxGroupSketch' }, keywords: ['aankruisvakje', 'aankruizen', 'check', 'checkbox', 'checkbox group', 'checked', 'checkmark', 'choice', 'choices', 'fieldset', 'form field', 'formulierveld', 'indeterminate', 'meerkeuze', 'meerkeuzevraag', 'multiple choice', 'option', 'options', 'select', 'selecteren', 'selectie', 'selectievakje', 'uncheck', 'unchecked', 'vinkje'] }, sidebar: 'componenten', previous: { title: 'Checkbox', permalink: '/en/checkbox' }, next: { title: 'Data badge', permalink: '/en/data-badge' } },
    l = {},
    h = [
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, c.Z)(x), children: [(0, l.jsxs)('div', { className: (0, c.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: z, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.aC, { role: 'presentation', children: n }), (0, l.jsx)(v.nv, { children: r })] })] });
    };
   var C = n(14669);
   const D = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, c.Z)(g['definition-of-done'], g[`definition-of-done--${(0, C.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
    ...
    T = (e) => {
     ...
     return t && i.length
      ? (0, l.jsx)(j.um, {
         appearance: 'large',
         className: (0, c.Z)(g['implementation-card-group']),
         children: i
          .sort((e, t) => {
          ...
          .map((e) => {
           ...
           return (0, l.jsx)(
            j.Zb,
            {
             className: (0, c.Z)(g['implementation-card']),
    ...
    M = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(b, { level: n, suffix: i && (0, l.jsx)(p.y, { state: i }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  42677: (e, t, n) => {
   'use strict';
