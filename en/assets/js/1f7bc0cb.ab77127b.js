 ...
 [51154],
 {
   ...
   const v = (e) => {
    ...
    h = (e) => {
     ...
     return l.createElement(
      ...
      l.createElement("div", { className: (0, a.Z)(t["nlds-canvas__toolbar"]) }, l.createElement(g.zx, { className: (0, a.Z)(t["nlds-canvas__button"], t["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: v, "aria-expanded": !r, "aria-controls": _ }, r ? "Bekijk code" : "Verberg code")),
      l.createElement(
       "div",
  ...
  31092: (e, n, o) => {
   ...
   const c = (e) => {
    ...
    const k = "Doen",
     m = "Niet doen";
    return l.createElement("div", { className: (0, d.Z)(r["nlds-guideline"], r[`nlds-guideline--${o}`]), id: null == n ? void 0 : n.toLowerCase().replace(/\s/g, "-") }, l.createElement("div", { className: (0, d.Z)(r["nlds-guideline__description"]) }, "dont" === o ? l.createElement(l.Fragment, null, l.createElement(i.nv, { className: (0, d.Z)(r["nlds-guideline__badge"], r[`nlds-guideline__badge--${o}`]) }, l.createElement(t.Z, { className: r["nlds-guideline__icon"] }), l.createElement("span", { className: r["nlds-guideline__title"] }, m)), l.createElement(i.nv, null, n)) : l.createElement(l.Fragment, null, l.createElement(i.nv, { className: (0, d.Z)(r["nlds-guideline__badge"], r[`nlds-guideline__badge--${o}`]) }, l.createElement(a.Z, { className: r["nlds-guideline__icon"] }), l.createElement("span", { className: r["nlds-guideline__title"] }, k)), l.createElement(i.nv, null, n)), c), l.createElement("div", { className: (0, d.Z)(r["nlds-guideline__example"]) }, s));
   };
  },
  37067: (e, n, o) => {
   ...
   const c = { title: "Toegankelijk | Formulieren", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Toegankelijk", sidebar_position: 1, pagination_label: "Toegankelijk", description: "Een formulier moet toegankelijk zijn", keywords: ["richtlijnen", "formulieren", "toegankelijkheid", "labels"] },
    ...
    u =
     ((g = "FormFieldDescription"),
     function (e) {
      return console.warn("Component " + g + " was not imported, exported, or provided by MDXProvider as global scope"), (0, a.kt)("div", e);
     });
   var g;
   const p = { toc: b },
    v = "wrapper";
