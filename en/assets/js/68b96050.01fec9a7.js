(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [23221],
 {
  51102: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => j, component: () => k, contentTitle: () => h, default: () => b, description: () => m, frontMatter: () => d, illustration: () => y, issueNumber: () => v, metadata: () => u, title: () => p, toc: () => g });
   var r = t(52676),
    i = t(24785),
    a = t(31612);
   function s(e) {
