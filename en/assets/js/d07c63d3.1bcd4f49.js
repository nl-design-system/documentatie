...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  69515: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => g, contentTitle: () => h, default: () => m, frontMatter: () => c, metadata: () => u, toc: () => p });
   var r = i(52676),
    t = i(24785),
    o = i(71595),
    s = i(45054),
   ...
   const c = { title: 'WCAG-succescriterium 1.3.6 Identificeer het doel', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.6 Identificeer het doel', pagination_label: 'WCAG-succescriterium 1.3.6 Identificeer het doel', description: 'Maak ten volste gebruik van de mogelijkheden van bijvoorbeeld HTML en ARIA om het doel van onderdelen van een webpagina duidelijk te maken voor software.', slug: '1.3.6', keywords: ['WCAG'] },
    h = void 0,
    u = { id: 'wcag/1.3.06', title: 'WCAG-succescriterium 1.3.6 Identificeer het doel', description: 'Maak ten volste gebruik van de mogelijkheden van bijvoorbeeld HTML en ARIA om het doel van onderdelen van een webpagina duidelijk te maken voor software.', source: '@site/docs/wcag/1.3.06.mdx', sourceDirName: 'wcag', slug: '/wcag/1.3.6', permalink: '/en/wcag/1.3.6', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.3.06.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.3.6 Identificeer het doel', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.6 Identificeer het doel', pagination_label: 'WCAG-succescriterium 1.3.6 Identificeer het doel', description: 'Maak ten volste gebruik van de mogelijkheden van bijvoorbeeld HTML en ARIA om het doel van onderdelen van een webpagina duidelijk te maken voor software.', slug: '1.3.6', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.3.5 Identificeer het doel van de input', permalink: '/en/wcag/1.3.5' }, next: { title: 'WCAG-succescriterium 1.4.1 Gebruik van kleur', permalink: '/en/wcag/1.4.1' } },
    g = {},
    p = [
  ...
  72657: (e, n, i) => {
   ...
   const s = (e) => {
    ...
    return (0, o.jsxs)('hgroup', { className: (0, r.Z)(t['nlds-inline-heading-group'], `utrecht-heading-${s}`, i), ...l, children: [(0, o.jsx)('h1', { className: (0, r.Z)(t['nlds-inline-heading-group__heading']), children: n }), a && (0, o.jsxs)('p', { className: (0, r.Z)(t['nlds-inline-heading-group__suffix']), children: [a ? ' ' : '', a] })] });
   };
  },
  71595: (e, n, i) => {
   i.d(n, { j: () => l });
   ...
   const l = (e) => {
    ...
    return (0, a.jsx)(t.V, { className: o, suffix: i && (0, a.jsx)(r.Ou, { className: s, children: i }), ...l, children: n });
   };
  },
  24785: (e, n, i) => {
   i.d(n, { Z: () => a, a: () => s });
