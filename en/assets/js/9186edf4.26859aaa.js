(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [20994],
 {
  99835: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => a, default: () => k, description: () => j, frontMatter: () => o, illustration: () => y, issueNumber: () => g, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    s = n(60851);
   const o = { title: 'Card as link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Card as link', pagination_label: 'Card as link', description: 'Korte sectie die als geheel een link is naar een gerelateerde pagina.', slug: '/card-as-link', sidebar_custom_props: { illustration: 'CardAsLinkSketch' }, keywords: ['card', 'content card', 'gerelateerd', 'link', 'message card', 'navigate', 'navigatie', 'navigation', 'navigeren', 'product card', 'related', 'sectie', 'section', 'tile'] },
    a = void 0,
    l = { id: 'componenten/card-as-link/index', title: 'Card as link', description: 'Korte sectie die als geheel een link is naar een gerelateerde pagina.', source: '@site/docs/componenten/card-as-link/index.mdx', sourceDirName: 'componenten/card-as-link', slug: '/card-as-link', permalink: '/en/card-as-link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/card-as-link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Card as link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Card as link', pagination_label: 'Card as link', description: 'Korte sectie die als geheel een link is naar een gerelateerde pagina.', slug: '/card-as-link', sidebar_custom_props: { illustration: 'CardAsLinkSketch' }, keywords: ['card', 'content card', 'gerelateerd', 'link', 'message card', 'navigate', 'navigatie', 'navigation', 'navigeren', 'product card', 'related', 'sectie', 'section', 'tile'] }, sidebar: 'componenten', previous: { title: 'Calendar', permalink: '/en/Calendar' }, next: { title: 'Case card', permalink: '/en/case-card' } },
    u = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const k = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    v = (e) => {
     ...
     return (0, u.jsxs)('hgroup', { className: (0, i.Z)(k['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, u.jsx)('h1', { className: (0, i.Z)(k['nlds-inline-heading-group__heading']), children: t }), r && (0, u.jsxs)('p', { className: (0, i.Z)(k['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var b = n(93706),
    _ = n(49427);
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var C = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => C.e9.includes(e.id)),
      s = c && C.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: s.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], y[`definition-of-done--${(0, C.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
         ...
         children: [
          (0, u.jsx)(S, {
           children: e.tasks.map((e) => {
            ...
            return (0, u.jsx)(z, { checked: t, title: n, description: (0, C.Q6)(r) }, r);
           }),
          }),
