...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  15250: (e, n, r) => {
   r.r(n), r.d(n, { assets: () => K, contentTitle: () => X, default: () => B, frontMatter: () => S, metadata: () => A, toc: () => L });
   var o = r(11527),
    i = r(47214),
    t = r(73460),
    s = r(30036);
  ...
  73460: (e, n, r) => {
   ...
   const b = (e) => {
    let { code: n, copy: r = !1, defaultExpandedCode: b = !0, displayCode: v = !0, children: w, container: f = "document", language: k, designTokens: y } = e,
