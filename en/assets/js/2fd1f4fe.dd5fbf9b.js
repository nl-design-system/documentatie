  ...
  16391: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, c.Z)(v), children: [(0, u.jsxs)('div', { className: (0, c.Z)(_, { [x]: t }), children: [(0, u.jsx)('span', { className: w, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var S = n(14669);
   const z = Object.keys({ HELP_WANTED: 'UNKNOWN', COMMUNITY: 'HELP_WANTED', CANDIDATE: 'COMMUNITY', HALL_OF_FAME: 'CANDIDATE' }),
    ...
    L = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.X6, { level: n, children: [t.title, ' ', i && (0, u.jsx)(g.y, { state: i })] }), (0, u.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  42677: (e, t, n) => {
   'use strict';
