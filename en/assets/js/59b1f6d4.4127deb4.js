...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [16882],
 {
  25675: (e, n, i) => {
   ...
   const d = { title: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.2 Aanwijzerannulering', pagination_label: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', slug: '2.5.2', keywords: ['WCAG'] },
    u = void 0,
    g = { id: 'wcag/2.5.02', title: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', source: '@site/docs/wcag/2.5.02.mdx', sourceDirName: 'wcag', slug: '/wcag/2.5.2', permalink: '/en/wcag/2.5.2', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.5.02.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.2 Aanwijzerannulering', pagination_label: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', slug: '2.5.2', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.5.1 Aanwijzergebaren', permalink: '/en/wcag/2.5.1' }, next: { title: 'WCAG-succescriterium 2.5.3 Label in Naam', permalink: '/en/wcag/2.5.3' } },
    h = {},
    p = [
