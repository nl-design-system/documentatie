 ...
 [41769],
 {
  55919: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(87176),
    o = n(90786);
   const s = { title: 'Page Header', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Page Header', pagination_label: 'Page Header', description: 'Een plek bovenaan elke pagina voor een logo, navigatie en zoeken.', slug: '/page-header' },
    a = void 0,
    l = { id: 'componenten/page-header/index', title: 'Page Header', description: 'Een plek bovenaan elke pagina voor een logo, navigatie en zoeken.', source: '@site/docs/componenten/page-header/index.mdx', sourceDirName: 'componenten/page-header', slug: '/page-header', permalink: '/en/page-header', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/page-header/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Page Header', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Page Header', pagination_label: 'Page Header', description: 'Een plek bovenaan elke pagina voor een logo, navigatie en zoeken.', slug: '/page-header' }, sidebar: 'componenten', previous: { title: 'Page Footer', permalink: '/en/page-footer' }, next: { title: 'Pagination', permalink: '/en/pagination' } },
    u = {},
    d = [
