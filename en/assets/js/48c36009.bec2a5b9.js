(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [78239],
 {
  48008: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => g, contentTitle: () => a, default: () => b, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => m, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Date input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date input', pagination_label: 'Date input', description: 'Biedt de mogelijkheid om een datum in te vullen of te kiezen uit een standaard ingebouwde kalender.', slug: '/date-input', sidebar_custom_props: { illustration: 'DateInputSketch' } },
    a = void 0,
    u = { id: 'componenten/date-input/index', title: 'Date input', description: 'Biedt de mogelijkheid om een datum in te vullen of te kiezen uit een standaard ingebouwde kalender.', source: '@site/docs/componenten/date-input/index.mdx', sourceDirName: 'componenten/date-input', slug: '/date-input', permalink: '/en/date-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Date input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date input', pagination_label: 'Date input', description: 'Biedt de mogelijkheid om een datum in te vullen of te kiezen uit een standaard ingebouwde kalender.', slug: '/date-input', sidebar_custom_props: { illustration: 'DateInputSketch' } }, sidebar: 'componenten', previous: { title: 'Data badge', permalink: '/en/data-badge' }, next: { title: 'Date input group', permalink: '/en/date-input-group' } },
    l = {},
    d = [
    ...
    h = 'Date input',
    j = 'Biedt de mogelijkheid om een datum in te vullen of te kiezen uit een standaard ingebouwde kalender.',
    y = 'DateInputSketch',
    m = 188,
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: D, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(k.aC, { role: 'presentation', children: n }), (0, l.jsx)(k.nv, { children: r })] })] });
    };
   var S = n(14669);
   const T = (e) => {
