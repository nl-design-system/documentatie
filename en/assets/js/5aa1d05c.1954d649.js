...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [28533],
 {
  ...
  42843: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => p, contentTitle: () => b, default: () => x, frontMatter: () => m, metadata: () => h, toc: () => g });
   var o = t(52676),
    l = t(24785),
    r = t(3510),
    i = t(66771),
   ...
   const m = { title: 'Toetsenbordnavigatie in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Toetsenbord', sidebar_position: 10, pagination_label: 'Zorg dat het formulier werkt met een toetsenbord', description: 'Het formulier moet goed werken met alleen een toetsenbord, zonder gebruik te maken van een muis.', slug: 'toetsenbord', keywords: ['informatie', 'formulier', 'design', 'code'] },
    b = 'Zorg dat het formulier werkt met een toetsenbord',
    h = { id: 'richtlijnen/formulieren/keyboard-behaviour', title: 'Toetsenbordnavigatie in een formulier | Richtlijnen', description: 'Het formulier moet goed werken met alleen een toetsenbord, zonder gebruik te maken van een muis.', source: '@site/docs/richtlijnen/formulieren/keyboard-behaviour.mdx', sourceDirName: 'richtlijnen/formulieren', slug: '/richtlijnen/formulieren/toetsenbord', permalink: '/en/richtlijnen/formulieren/toetsenbord', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/keyboard-behaviour.mdx', tags: [], version: 'current', sidebarPosition: 10, frontMatter: { title: 'Toetsenbordnavigatie in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Toetsenbord', sidebar_position: 10, pagination_label: 'Zorg dat het formulier werkt met een toetsenbord', description: 'Het formulier moet goed werken met alleen een toetsenbord, zonder gebruik te maken van een muis.', slug: 'toetsenbord', keywords: ['informatie', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Placeholders in een formulier', permalink: '/en/richtlijnen/formulieren/placeholders' }, next: { title: 'Uit te vragen informatie in een formulier', permalink: '/en/richtlijnen/formulieren/vragen' } },
    p = {},
    g = [];
   function v(e) {
  ...
  66771: (e, n, t) => {
   ...
   const p = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(o.Tg, { className: m['nlds-canvas__example-surface'], children: (0, h.jsx)(o.BB, { className: (0, l.Z)('utrecht-document--surface', m['nlds-canvas__example-document']), children: (0, h.jsx)(o.nv, { className: m['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   p.displayName = 'ParagraphContainer';
   const g = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(o.Tg, { className: m['nlds-canvas__example-surface'], children: (0, h.jsx)(o.BB, { className: (0, l.Z)('utrecht-document--surface', m['nlds-canvas__example-document']), children: n }) });
   };
   ...
   const x = (e) => {
    ...
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       w && (0, h.jsx)('div', { className: (0, l.Z)(m['nlds-canvas__example']), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, h.jsx)(P, { children: (0, h.jsx)(o.pu, { children: w }) }) }) }),
       j &&
        (0, h.jsx)('div', {
       ...
       j &&
        (0, h.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, h.jsx)(b.u, { syntax: y, textContent: Z, trim: !0 }),
          t &&
           (0, h.jsx)('div', {
