...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  83831: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => h, contentTitle: () => u, default: () => m, frontMatter: () => c, metadata: () => g, toc: () => p });
   var r = t(52676),
    s = t(24785),
    i = t(71595),
    o = t(45054),
   ...
   const c = { title: 'WCAG-succescriterium 2.1.2 Geen toetsenbordval', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.1.2 Geen toetsenbordval', pagination_label: 'WCAG-succescriterium 2.1.2 Geen toetsenbordval', description: 'Wanneer een gebruiker met het toetsenbord de focus verplaatst naar een deel van de pagina, dan moet deze ook weer weg kunnen gaan met het toetsenbord. De gebruiker kan daarvoor bijvoorbeeld de Tab-toets, Escape-toets of de pijltjestoetsen gebruiken. Zo niet, beschrijf dan met welke toets het wel kan.', slug: '2.1.2', keywords: ['WCAG'] },
    u = void 0,
    g = { id: 'wcag/2.1.02', title: 'WCAG-succescriterium 2.1.2 Geen toetsenbordval', description: 'Wanneer een gebruiker met het toetsenbord de focus verplaatst naar een deel van de pagina, dan moet deze ook weer weg kunnen gaan met het toetsenbord. De gebruiker kan daarvoor bijvoorbeeld de Tab-toets, Escape-toets of de pijltjestoetsen gebruiken. Zo niet, beschrijf dan met welke toets het wel kan.', source: '@site/docs/wcag/2.1.02.mdx', sourceDirName: 'wcag', slug: '/wcag/2.1.2', permalink: '/en/wcag/2.1.2', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.1.02.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.1.2 Geen toetsenbordval', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.1.2 Geen toetsenbordval', pagination_label: 'WCAG-succescriterium 2.1.2 Geen toetsenbordval', description: 'Wanneer een gebruiker met het toetsenbord de focus verplaatst naar een deel van de pagina, dan moet deze ook weer weg kunnen gaan met het toetsenbord. De gebruiker kan daarvoor bijvoorbeeld de Tab-toets, Escape-toets of de pijltjestoetsen gebruiken. Zo niet, beschrijf dan met welke toets het wel kan.', slug: '2.1.2', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.1.1 Toetsenbord', permalink: '/en/wcag/2.1.1' }, next: { title: 'WCAG-succescriterium 2.1.3 Toetsenbord (geen uitzondering)', permalink: '/en/wcag/2.1.3' } },
    h = {},
    p = [
  ...
  72657: (e, n, t) => {
   ...
   var i = t(52676);
   const o = (e) => {
    let { children: n, className: t, level: o = 1, suffix: a, ...d } = e;
    return (0, i.jsxs)('hgroup', { className: (0, r.Z)(s['nlds-inline-heading-group'], `utrecht-heading-${o}`, t), ...d, children: [(0, i.jsx)('h1', { className: (0, r.Z)(s['nlds-inline-heading-group__heading']), children: n }), a && (0, i.jsxs)('p', { className: (0, r.Z)(s['nlds-inline-heading-group__suffix']), children: [a ? ' ' : '', a] })] });
   };
  },
  71595: (e, n, t) => {
   t.d(n, { j: () => d });
   ...
   const d = (e) => {
    ...
    return (0, a.jsx)(s.V, { className: i, suffix: t && (0, a.jsx)(r.Ou, { className: o, children: t }), ...d, children: n });
   };
  },
  24785: (e, n, t) => {
   t.d(n, { Z: () => a, a: () => o });
