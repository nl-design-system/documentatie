...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [50718],
 {
  ...
  75914: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => v, contentTitle: () => m, default: () => _, frontMatter: () => u, metadata: () => h, toc: () => b });
   var o = l(52676),
    s = l(24785),
    r = l(44585),
    i = l(33376);
  ...
  44585: (e, n, l) => {
   ...
   const _ = (e) => {
    ...
    let K = d.Fragment;
    return (
     'paragraph' === x ? (K = v) : 'document' === x ? (K = b) : 'surface' === x && (K = g),
     (0, h.jsxs)('div', {
