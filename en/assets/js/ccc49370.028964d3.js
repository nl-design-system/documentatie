...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [1080],
 {
  ...
  79265: (e, t, o) => {
   ...
   var h = o(92954),
    p = o(76265);
   const g = { container: "container_QItW" };
   function b(e) {
    let { readingTime: t } = e;
    const o = (function () {
   ...
   const k = { authorCol: "authorCol_bxd7", imageOnlyAuthorRow: "imageOnlyAuthorRow_Re_E", imageOnlyAuthorCol: "imageOnlyAuthorCol_iUZe" };
   function P(e) {
    let { className: t } = e;
    const {
     metadata: { authors: o },
   ...
   function w(e) {
    ...
    return (0, c.jsx)("div", { id: l ? _.blogPostContainerID : void 0, className: (0, n.Z)("markdown", o), itemProp: "articleBody", children: (0, c.jsx)(N.Z, { children: t }) });
   }
   var C = o(15951),
    T = o(53548);
   function F() {
   ...
   const B = { blogPostFooterDetailsFull: "blogPostFooterDetailsFull_ImSp" };
   function M() {
    const { metadata: e, isBlogPostPage: t } = (0, s.C)(),
     { tags: o, title: l, editUrl: r, hasTruncateMarker: a } = e,
     i = !t && a,
     d = o.length > 0;
    return d || i || r ? (0, c.jsxs)("footer", { className: (0, n.Z)("row docusaurus-mt-lg", t && B.blogPostFooterDetailsFull), children: [d && (0, c.jsx)("div", { className: (0, n.Z)("col", { "col--9": i }), children: (0, c.jsx)(T.Z, { tags: o }) }), t && r && (0, c.jsx)("div", { className: "col margin-top--sm", children: (0, c.jsx)(C.Z, { editUrl: r }) }), i && (0, c.jsx)("div", { className: (0, n.Z)("col text--right", { "col--3": d }), children: (0, c.jsx)(I, { blogPostTitle: l, to: e.permalink }) })] }) : null;
   }
   function S(e) {
    let { children: t, className: o } = e;
    const l = (function () {
    ...
    return (0, c.jsxs)(i, { className: (0, n.Z)(l, o), children: [(0, c.jsx)(Z, {}), (0, c.jsx)(w, { children: t }), (0, c.jsx)(M, {})] });
   }
   function A() {
   ...
   function L(e) {
    ...
    return (0, c.jsxs)("nav", { className: "pagination-nav docusaurus-mt-lg", "aria-label": (0, h.I)({ id: "theme.blog.post.paginator.navAriaLabel", message: "Blog post page navigation", description: "The ARIA label for the blog posts pagination" }), children: [o && (0, c.jsx)(R.Z, { ...o, subLabel: (0, c.jsx)(h.Z, { id: "theme.blog.post.paginator.newerPost", description: "The blog post button label to navigate to the newer/previous post", children: "Newer Post" }) }), t && (0, c.jsx)(R.Z, { ...t, subLabel: (0, c.jsx)(h.Z, { id: "theme.blog.post.paginator.olderPost", description: "The blog post button label to navigate to the older/next post", children: "Older Post" }), isNext: !0 })] });
   }
   var O = o(9967),
    $ = o(29450);
   function E(e) {
    ...
    return (0, c.jsxs)($.Z, { breadcrumbs: [{ label: "Blog", href: "/blog" }, { label: l.title }], sidebar: t, toc: !d && r.length > 0 ? (0, c.jsx)(O.Z, { toc: r, minHeadingLevel: m, maxHeadingLevel: u }) : void 0, children: [(0, c.jsx)(S, { children: o }), (n || a) && (0, c.jsx)(L, { nextItem: n, prevItem: a })] });
   }
   function U(e) {
    const t = e.content;
