 ...
 [20994],
 {
  99835: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    s = n(60851);
   const o = { title: 'Card as link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Card as link', pagination_label: 'Card as link', description: '', slug: '/card-as-link', sidebar_custom_props: { illustration: 'CardAsLinkSketch' } },
    a = void 0,
    l = { id: 'componenten/card-as-link/index', title: 'Card as link', description: '', source: '@site/docs/componenten/card-as-link/index.mdx', sourceDirName: 'componenten/card-as-link', slug: '/card-as-link', permalink: '/en/card-as-link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/card-as-link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Card as link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Card as link', pagination_label: 'Card as link', description: '', slug: '/card-as-link', sidebar_custom_props: { illustration: 'CardAsLinkSketch' } }, sidebar: 'componenten', previous: { title: 'Calendar', permalink: '/en/Calendar' }, next: { title: 'Case card', permalink: '/en/case-card' } },
    u = {},
    d = [
   ...
   const o = (e) => {
    ...
    l = (e) => {
     ...
     const u = (e) => ('article' === a ? (0, s.jsx)('article', { ...e }) : 'section' === a ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      d = (0, s.jsx)(u, { className: (0, c.Z)(i.cardgroup__card, i[`cardgroup__card--${n}`], o), children: l });
  ...
  60851: (e, t, n) => {
   ...
   var r = n(47027),
    ...
    l = n(32636),
    u = n(52676);
   const d = { figma: (0, u.jsx)(i.Z, {}), github: (0, u.jsx)(s.Z, {}), npm: (0, u.jsx)(o.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, c.Z)(x), children: [(0, u.jsxs)('div', { className: (0, c.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var C = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const i = t && t.projects.filter((e) => C.e9.includes(e.id)),
      s = i && C.e9.map((e) => i.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
    ...
    M = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(v, { level: n, suffix: i && (0, u.jsx)(p.y, { state: i }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  42677: (e, t, n) => {
   'use strict';
