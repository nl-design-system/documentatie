 ...
 [21229],
 {
  ...
  23952: (e, n, t) => {
   ...
   const f = 'task-list_hh8j',
    ...
    _ = 'task-list-item__marker--checked_y8Vc',
    ...
    C = (e) => {
     ...
     return (0, d.jsxs)('li', { className: (0, i.Z)(x), children: [(0, d.jsxs)('div', { className: (0, i.Z)(w, n && _), children: [(0, d.jsx)('span', { className: z, children: n ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), n && (0, d.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(y.X6, { appearance: 'utrecht-heading-3', level: c, children: r }), o, t] })] });
    };
   var N = t(14669);
   const D = (e) => {
    ...
    L = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(k.V, { level: t, suffix: o && (0, d.jsx)(v.y, { state: o }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, n, t) => {
   'use strict';
