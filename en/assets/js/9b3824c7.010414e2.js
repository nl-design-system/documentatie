...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [45671],
 {
  ...
  16694: (e, n, t) => {
   ...
   var c = t(23680);
   const d = { title: 'De toegankelijke naam van een button | Buttons in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Toegankelijke naam button', pagination_label: 'Toegankelijke naam button', description: 'Richtlijnen voor de toegankelijke naam van een button.', slug: '/richtlijnen/formulieren/buttons/toegankelijke-naam', keywords: ['labels', 'formulier', 'design', 'code'] },
    u = void 0,
    h = { id: 'richtlijnen/formulieren/button/accessible-name/README', title: 'De toegankelijke naam van een button | Buttons in een formulier | Richtlijnen', description: 'Richtlijnen voor de toegankelijke naam van een button.', source: '@site/docs/richtlijnen/formulieren/button/5-accessible-name/README.mdx', sourceDirName: 'richtlijnen/formulieren/button/5-accessible-name', slug: '/richtlijnen/formulieren/buttons/toegankelijke-naam', permalink: '/en/richtlijnen/formulieren/buttons/toegankelijke-naam', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/button/5-accessible-name/README.mdx', tags: [], version: 'current', frontMatter: { title: 'De toegankelijke naam van een button | Buttons in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Toegankelijke naam button', pagination_label: 'Toegankelijke naam button', description: 'Richtlijnen voor de toegankelijke naam van een button.', slug: '/richtlijnen/formulieren/buttons/toegankelijke-naam', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Duidelijke buttontekst', permalink: '/en/richtlijnen/formulieren/buttons/duidelijk-buttontekst' }, next: { title: 'Afbeelding als button', permalink: '/en/richtlijnen/formulieren/buttons/afbeelding-als-button' } },
    m = {},
    j = [];
   function g(e) {
