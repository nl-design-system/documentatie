 ...
 [20322],
 {
  22422: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    o = n(60851);
   const s = { title: 'Case card', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Case card', pagination_label: 'Case card', description: 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.', slug: '/case-card', sidebar_custom_props: { illustration: 'CaseCardSketch' }, keywords: ['card', 'case', 'kaart', 'kenmerk', 'zaak', 'zaaknummer'] },
    a = void 0,
    u = { id: 'componenten/case-card/index', title: 'Case card', description: 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.', source: '@site/docs/componenten/case-card/index.mdx', sourceDirName: 'componenten/case-card', slug: '/case-card', permalink: '/en/case-card', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/case-card/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Case card', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Case card', pagination_label: 'Case card', description: 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.', slug: '/case-card', sidebar_custom_props: { illustration: 'CaseCardSketch' }, keywords: ['card', 'case', 'kaart', 'kenmerk', 'zaak', 'zaaknummer'] }, sidebar: 'componenten', previous: { title: 'Card as link', permalink: '/en/card-as-link' }, next: { title: 'Checkbox', permalink: '/en/checkbox' } },
    l = {},
    d = [
         ...
         children: [
          (0, l.jsx)(A, {
           children: e.tasks.map((e) => {
            ...
            return (0, l.jsx)(C, { checked: t, title: n, description: (0, S.Q6)(r) }, r);
           }),
          }),
