...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  42599: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => f, contentTitle: () => p, default: () => x, frontMatter: () => u, metadata: () => m, toc: () => v });
   var r = i(52676),
    t = i(24785),
    o = i(57716),
    s = i(71595),
   ...
   const u = { title: 'WCAG-succescriterium 1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', pagination_label: 'WCAG-succescriterium 1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', description: 'Wordt er in een video informatie getoond die niet wordt voorgelezen? Zorg er dan voor dat een blinde of slechtziende gebruiker deze informatie ook meekrijgt.', slug: '1.2.3', keywords: ['WCAG'] },
    p = void 0,
    m = { id: 'wcag/1.2.03', title: 'WCAG-succescriterium 1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', description: 'Wordt er in een video informatie getoond die niet wordt voorgelezen? Zorg er dan voor dat een blinde of slechtziende gebruiker deze informatie ook meekrijgt.', source: '@site/docs/wcag/1.2.03.mdx', sourceDirName: 'wcag', slug: '/wcag/1.2.3', permalink: '/en/wcag/1.2.3', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.2.03.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', pagination_label: 'WCAG-succescriterium 1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', description: 'Wordt er in een video informatie getoond die niet wordt voorgelezen? Zorg er dan voor dat een blinde of slechtziende gebruiker deze informatie ook meekrijgt.', slug: '1.2.3', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.2.2 Ondertitels voor doven en slechthorenden (vooraf opgenomen)', permalink: '/en/wcag/1.2.2' }, next: { title: 'WCAG-succescriterium 1.2.4 Ondertitels voor doven en slechthorenden (live)', permalink: '/en/wcag/1.2.4' } },
    f = {},
    v = [
