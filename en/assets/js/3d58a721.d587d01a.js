(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [9591],
 {
  90079: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => p, contentTitle: () => a, default: () => k, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => g, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Date input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date input group', pagination_label: 'Date input group', description: 'Biedt de mogelijkheid om een datum in te vullen die bekend of makkelijk op te zoeken is.', slug: '/date-input-group', sidebar_custom_props: { illustration: 'DateInputGroupSketch' } },
    a = void 0,
    u = { id: 'componenten/date-input-group/index', title: 'Date input group', description: 'Biedt de mogelijkheid om een datum in te vullen die bekend of makkelijk op te zoeken is.', source: '@site/docs/componenten/date-input-group/index.mdx', sourceDirName: 'componenten/date-input-group', slug: '/date-input-group', permalink: '/en/date-input-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-input-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Date input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date input group', pagination_label: 'Date input group', description: 'Biedt de mogelijkheid om een datum in te vullen die bekend of makkelijk op te zoeken is.', slug: '/date-input-group', sidebar_custom_props: { illustration: 'DateInputGroupSketch' } }, sidebar: 'componenten', previous: { title: 'Date input', permalink: '/en/date-input' }, next: { title: 'Date picker', permalink: '/en/date-picker' } },
    l = {},
    d = [
    ...
    h = 'Date input group',
    j = 'Biedt de mogelijkheid om een datum in te vullen die bekend of makkelijk op te zoeken is.',
    y = 'DateInputGroupSketch',
    g = 189,
    p = c.find((e) => e.number === g);
   function m(e) {
    const t = { h2: 'h2', ...(0, i.a)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, r.jsx)(o.Rv, { component: p, headingLevel: 1, description: j, illustration: y }), '\n', (0, r.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, r.jsx)(o.cN, { component: p, headingLevel: 3 }), '\n', (0, r.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }), '\n', (0, r.jsx)(o.W, { component: p, headingLevel: 3 }), '\n', (0, r.jsx)(t.h2, { id: 'levende-backlog', children: 'Levende Backlog' }), '\n', (0, r.jsx)(o.Gn, { component: p, headingLevel: 3 })] });
   }
   function k(e = {}) {
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    D = 'task-list-item__marker-label_XAyi',
    z = (e) => {
     let { children: t } = e;
    ...
    A = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: D, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.aC, { role: 'presentation', children: n }), (0, l.jsx)(b.nv, { children: r })] })] });
    };
   var S = n(14669);
   const T = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], y[`definition-of-done--${(0, S.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
    ...
    C = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(v, { level: n, suffix: c && (0, l.jsx)(m.y, { state: c }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  42677: (e, t, n) => {
   'use strict';
