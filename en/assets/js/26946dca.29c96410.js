 ...
 [85781],
 {
   ...
   const s = (e) => {
    ...
    l = (e) => {
     ...
     const d = (e) => ('article' === a ? (0, o.jsx)('article', { ...e }) : 'section' === a ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      u = (0, o.jsx)(d, { className: (0, c.Z)(i.cardgroup__card, i[`cardgroup__card--${n}`], s), children: l });
     return t ? (0, o.jsx)(r.rU, { href: t, boxContent: !0, className: i.cardgroup__link, children: u }) : u;
    },
    d = (e) => {
  ...
  90786: (e, t, n) => {
   ...
   var r = n(56150),
    ...
    l = n(32636),
    d = n(52676);
   const u = { figma: (0, d.jsx)(i.Z, {}), github: (0, d.jsx)(o.Z, {}), npm: (0, d.jsx)(s.Z, {}), storybook: (0, d.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const N = (e) => {
     ...
     return (
      ...
      (0, d.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, c.Z)(m['definition-of-done'], e && m[`definition-of-done--${(0, w.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
    ...
    S = (e) => {
     ...
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(k.V, { level: n, suffix: i && (0, d.jsx)(p.y, { state: i }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  86964: (e, t, n) => {
   'use strict';
