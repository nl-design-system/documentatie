(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [54472],
 {
  24378: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => y, contentTitle: () => s, default: () => p, description: () => j, frontMatter: () => a, issueNumber: () => g, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(7617),
    o = n(63246);
   const a = { title: 'Navigation bar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Navigation bar', pagination_label: 'Navigation bar', description: 'Toont een hi\xebrarchische horizontale navigatie aan de bovenkant van een pagina en biedt de mogelijkheid om tussen pagina\u2019s te navigeren.', slug: '/navigation-bar' },
    s = void 0,
    l = { id: 'componenten/navigation-bar/index', title: 'Navigation bar', description: 'Toont een hi\xebrarchische horizontale navigatie aan de bovenkant van een pagina en biedt de mogelijkheid om tussen pagina\u2019s te navigeren.', source: '@site/docs/componenten/navigation-bar/index.mdx', sourceDirName: 'componenten/navigation-bar', slug: '/navigation-bar', permalink: '/en/navigation-bar', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/navigation-bar/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Navigation bar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Navigation bar', pagination_label: 'Navigation bar', description: 'Toont een hi\xebrarchische horizontale navigatie aan de bovenkant van een pagina en biedt de mogelijkheid om tussen pagina\u2019s te navigeren.', slug: '/navigation-bar' }, sidebar: 'componenten', previous: { title: 'Modal dialog', permalink: '/en/modal-dialog' }, next: { title: 'Non modal dialog', permalink: '/en/non-modal-dialog' } },
    u = {},
    d = [
  ...
  83931: (e, t, n) => {
   ...
   const a = (e) => {
     ...
     return (0, o.jsx)('div', { className: (0, i.Z)(c.card__illustration, t && c['card__illustration--background'], r), ...a, children: n });
    },
    s = (e) => (0, o.jsx)('div', { className: (0, i.Z)(c.card__content), ...e }),
    l = (e) => {
     let { href: t, appearance: n, className: a, component: s = 'div', children: l } = e;
     const u = (e) => ('article' === s ? (0, o.jsx)('article', { ...e }) : 'section' === s ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(u, { className: (0, i.Z)(c.cardgroup__card, c[`cardgroup__card--${n}`], a), children: l });
  ...
  63246: (e, t, n) => {
   ...
   var r = n(56150),
    ...
    l = n(32636),
    u = n(52676);
   const d = { figma: (0, u.jsx)(c.Z, {}), github: (0, u.jsx)(o.Z, {}), npm: (0, u.jsx)(a.Z, {}), storybook: (0, u.jsx)(s.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(_), children: [(0, u.jsxs)('div', { className: (0, i.Z)(x, { [N]: t }), children: [(0, u.jsx)('span', { className: w, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var S = n(14669);
   const T = (e) => {
  ...
  80407: (e, t, n) => {
   ...
   const s = (e) => {
    let { state: t } = e;
    const n = (0, o.mA)(t);
    return (0, a.jsx)(r.Ou, { className: (0, i.Z)(c['estafette-badge'], n && c[`estafette-badge--${n}`]), children: t });
   };
  },
  66120: (e, t, n) => {
   'use strict';
   ...
   var c = n(52676);
   const o = (e) => {
    let { children: t, className: n, level: o = 1, suffix: a, ...s } = e;
    return (0, c.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${o}`, n), ...s, children: [(0, c.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: t }), a && (0, c.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [a ? ' ' : '', a] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => a, Q6: () => c, e9: () => o, mA: () => i });
