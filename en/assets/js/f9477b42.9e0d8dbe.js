...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [606],
 {
  ...
  73460: (e, n, l) => {
   ...
   const v = (e) => {
    let { code: n, copy: l = !1, defaultExpandedCode: v = !0, displayCode: x = !0, children: k, container: f = "document", language: _, designTokens: y } = e,
     w = "function" == typeof k ? k() : k,
     z = "function" == typeof n ? n() : (0, c.isValidElement)(n) ? n : void 0,
     D = "string" == typeof n ? n : h.uS(z || w),
     [N, Z] = (0, c.useState)(D),
     [F, W] = (0, c.useState)(v);
    (0, c.useEffect)(() => {
     (async () => {
      (N = await d.ZP.format(D, { parser: _, plugins: [t.Z, a.ZP, o.ZP, s.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), Z(N);
     })();
    }, [D]);
    const X = (0, c.useId)();
    let A = c.Fragment;
      ...
      children: [
       ...
       x &&
        (0, m.jsxs)("div", {
         ...
         hidden: !F,
         children: [
          (0, m.jsx)(p.u, { syntax: _, textContent: N, trim: !0 }),
          l &&
           (0, m.jsx)("div", {
            className: (0, r.Z)(u["nlds-canvas__toolbar"]),
            children: (0, m.jsx)(i.zx, {
