...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [88737],
 {
  ...
  49803: (e, s, n) => {
   ...
   n(50959);
   var a = n(5341);
   const i = { "session-table-container": "session-table-container_AJ5Z", "session-table": "session-table_UjSe", "session-table__row": "session-table__row_Q8zO", "session-table__time": "session-table__time_X4_g", "session-table__speakers": "session-table__speakers_zhez", "session-table__speaker": "session-table__speaker_Ghbm", speaker__icon: "speaker__icon_kFX7", speaker__organisation: "speaker__organisation_bGt9" };
   var t = n(16532),
    r = n(26373),
    o = n(11527);
   const d = (e) => {
     let { name: s, organisation: n } = e;
     return (0, o.jsxs)(t.nv, { className: (0, a.Z)(i["session-table__speaker"], i.speaker), children: [(0, o.jsx)(t.JO, { role: "presentational", className: i.speaker__icon, children: (0, o.jsx)(r.Z, {}) }), (0, o.jsx)("span", { className: (0, a.Z)(i.speaker__name), children: s }), (0, o.jsx)("br", {}), (0, o.jsx)("span", { className: (0, a.Z)(i.speaker__organisation), children: n })] });
    },
    l = (e) => {
     let { lang: s, sessions: n, className: r, ...l } = e;
     return (0, o.jsx)("div", {
      className: (0, a.Z)(i["session-table-container"], r),
      children: (0, o.jsxs)(t.iA, {
       className: (0, a.Z)(i["session-table"], r),
       ...l,
       children: [
        (0, o.jsx)(t.xD, { children: (0, o.jsxs)(t.SC, { className: (0, a.Z)(i["session-table__row"]), children: [(0, o.jsx)(t.xs, { children: "nl-NL" === s ? "Tijd" : "Time" }), (0, o.jsx)(t.xs, { children: "nl-NL" === s ? "Spreker" : "Speaker" }), (0, o.jsx)(t.xs, { children: "nl-NL" === s ? "Onderwerp" : "Subject" }), "nl-NL" === s && (0, o.jsx)(t.xs, { children: "Taal" })] }) }),
        (0, o.jsx)(t.RM, {
         children: n.map((e) => {
          let { isoDateTime: n, speakers: r, subject: l, singupLink: g, icalLink: m, language: c } = e;
          return (0, o.jsxs)(t.SC, { className: (0, a.Z)(i["session-table__row"]), children: [(0, o.jsx)(t.pj, { className: (0, a.Z)(i["session-table__time"]), children: (0, o.jsx)(t.nv, { children: (0, o.jsx)("time", { dateTime: n, children: new Intl.DateTimeFormat(s, { hour: "numeric", minute: "numeric", timeZone: "Europe/Amsterdam", timeZoneName: "nl-NL" !== s ? "short" : void 0 }).format(new Date(n)) }) }) }), (0, o.jsx)(t.pj, { children: (0, o.jsx)("div", { className: (0, a.Z)(i["session-table__speakers"]), children: r.map((e) => (0, o.jsx)(d, { ...e })) }) }), (0, o.jsx)(t.pj, { className: (0, a.Z)(i["session-table__subject"]), children: (0, o.jsx)(t.nv, { children: (0, o.jsx)(t.rU, { href: g, children: l }) }) }), "nl-NL" === s && (0, o.jsx)(t.pj, { className: (0, a.Z)(i["session-table__language"]), children: (0, o.jsx)("abbr", { title: c.description, children: c.abbr }) })] });
         }),
        }),
       ],
      }),
