 ...
 [81565],
 {
  17191: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(80719),
    o = n(90786);
   const s = { title: 'Form field checkbox option', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field checkbox option', pagination_label: 'Form field checkbox option', description: ' ', slug: '/form-field-checkbox-option' },
    a = void 0,
    l = { id: 'componenten/form-field-checkbox-option/index', title: 'Form field checkbox option', description: ' ', source: '@site/docs/componenten/form-field-checkbox-option/index.mdx', sourceDirName: 'componenten/form-field-checkbox-option', slug: '/form-field-checkbox-option', permalink: '/en/form-field-checkbox-option', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-field-checkbox-option/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form field checkbox option', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field checkbox option', pagination_label: 'Form field checkbox option', description: ' ', slug: '/form-field-checkbox-option' }, sidebar: 'componenten', previous: { title: 'Form field', permalink: '/en/form-field' }, next: { title: 'Form field description', permalink: '/en/form-field-description' } },
    u = {},
    d = [
