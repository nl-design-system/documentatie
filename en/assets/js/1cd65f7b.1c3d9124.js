 ...
 [5793],
 {
  ...
  3460: (e, n, t) => {
   ...
   const j = (e) => {
    ...
    p = (e) => {
     let { code: n, copy: t = !1, defaultCollapsed: p = !0, children: v, language: x, designTokens: k } = e,
      f = "function" == typeof v ? v() : v,
      w = "function" == typeof n ? n() : (0, c.isValidElement)(n) ? n : void 0,
      y = "string" == typeof n ? n : u.uS(w || f),
      [_, z] = (0, c.useState)(y);
     (0, c.useEffect)(() => {
      (async () => {
       (_ = await d.ZP.format(y, { parser: x, plugins: [r.Z, i.ZP, l.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), z(_);
      })();
     }, [y]);
     const S = (0, h.Z)();
     return (0, m.jsxs)("div", {
      ...
      children: [
       f && (0, m.jsx)("div", { className: (0, s.Z)(b["nlds-canvas__example"]), children: (0, m.jsx)(o.pu, { className: "voorbeeld-theme", style: k, children: f }) }),
       (0, m.jsx)("div", { className: (0, s.Z)(b["nlds-canvas__toolbar"]), children: (0, m.jsx)(o.zx, { className: (0, s.Z)(b["nlds-canvas__button"], b["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: j, "aria-expanded": !p, "aria-controls": S, children: p ? "Bekijk code" : "Verberg code" }) }),
       (0, m.jsxs)("div", {
        className: (0, s.Z)(b["nlds-canvas__code-block"], !t && b["nlds-canvas__code-block--user-select-none"]),
        id: S,
        hidden: p,
        children: [
         (0, m.jsx)(g.u, { syntax: x, textContent: _, trim: !0 }),
         t &&
          (0, m.jsx)("div", {
