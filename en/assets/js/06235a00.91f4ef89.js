...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  41739: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => h, contentTitle: () => l, default: () => f, frontMatter: () => a, metadata: () => u, toc: () => g });
   var t = i(52676),
    r = i(24785),
    s = i(91410),
    o = i(88435);
   ...
   const a = { title: 'WCAG-succescriterium 3.2.4 Consistente identificatie', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.4 Consistente identificatie', pagination_label: 'WCAG-succescriterium 3.2.4 Consistente identificatie', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', slug: '3.2.4', keywords: ['WCAG'] },
    l = 'WCAG-succescriterium 3.2.4 Consistente identificatie',
    u = { id: 'wcag/3.2.04', title: 'WCAG-succescriterium 3.2.4 Consistente identificatie', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', source: '@site/docs/wcag/3.2.04.mdx', sourceDirName: 'wcag', slug: '/wcag/3.2.4', permalink: '/en/wcag/3.2.4', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.2.04.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 3.2.4 Consistente identificatie', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.4 Consistente identificatie', pagination_label: 'WCAG-succescriterium 3.2.4 Consistente identificatie', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', slug: '3.2.4', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.2.3 Consistente navigatie', permalink: '/en/wcag/3.2.3' }, next: { title: 'WCAG-succescriterium 3.2.6 Consistente hulp', permalink: '/en/wcag/3.2.6' } },
    h = {},
    g = [
