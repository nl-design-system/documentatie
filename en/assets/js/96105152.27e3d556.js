 ...
 [20933],
 {
  34970: (e, n, i) => {
   ...
   const l = { title: 'WCAG-succescriterium 3.2.2 Bij input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.2 Bij input', pagination_label: 'WCAG-succescriterium 3.2.2 Bij input', description: 'Beschrijving, documentatie, gerelateerde richtlijnen, bronnen, gebruikersonderzoek en hoe te testen.', slug: '3.2.2', keywords: ['WCAG'] },
    ...
    c = { id: 'wcag/3.2.02', title: 'WCAG-succescriterium 3.2.2 Bij input', description: 'Beschrijving, documentatie, gerelateerde richtlijnen, bronnen, gebruikersonderzoek en hoe te testen.', source: '@site/docs/wcag/3.2.02.mdx', sourceDirName: 'wcag', slug: '/wcag/3.2.2', permalink: '/en/wcag/3.2.2', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.2.02.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 3.2.2 Bij input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.2 Bij input', pagination_label: 'WCAG-succescriterium 3.2.2 Bij input', description: 'Beschrijving, documentatie, gerelateerde richtlijnen, bronnen, gebruikersonderzoek en hoe te testen.', slug: '3.2.2', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.2.1 Bij focus', permalink: '/en/wcag/3.2.1' }, next: { title: 'WCAG-succescriterium 3.3.1 Foutidentificatie', permalink: '/en/wcag/3.3.1' } },
    d = {},
    u = [
