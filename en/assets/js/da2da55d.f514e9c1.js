 ...
 [95102],
 {
  29390: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(87176),
    o = n(90786);
   const s = { title: 'Heading Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading Group', pagination_label: 'Heading Group', description: 'Toont een combinatie van een titel en ondersteunende tekst.', slug: '/heading-group' },
    a = void 0,
    u = { id: 'componenten/heading-group/index', title: 'Heading Group', description: 'Toont een combinatie van een titel en ondersteunende tekst.', source: '@site/docs/componenten/heading-group/index.mdx', sourceDirName: 'componenten/heading-group', slug: '/heading-group', permalink: '/en/heading-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/heading-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Heading Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading Group', pagination_label: 'Heading Group', description: 'Toont een combinatie van een titel en ondersteunende tekst.', slug: '/heading-group' }, sidebar: 'componenten', previous: { title: 'Heading 6', permalink: '/en/heading-6' }, next: { title: 'Icon', permalink: '/en/icon' } },
    l = {},
    d = [
    ...
    h = 'Heading Group',
    j = 'Toont een combinatie van een titel en ondersteunende tekst.',
    g = 248,
          ...
          children: [
           (0, l.jsx)(_, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(x, { checked: t, title: n, description: (0, w.Q6)(r) }, r);
            }),
           }),
