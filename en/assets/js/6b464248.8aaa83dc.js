...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [75989],
 {
  ...
  80332: (e, n, r) => {
   r.r(n), r.d(n, { assets: () => g, contentTitle: () => m, default: () => j, frontMatter: () => h, metadata: () => p, toc: () => v });
   var s = r(52676),
    l = r(24785),
    t = r(98480),
    o = r(91050);
   ...
   const h = { title: 'Informeer gebruikers van screenreaders over het statusbericht \xb7 Status in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Informeer screenreaders', pagination_label: 'Informeer screenreaders', description: 'Richtlijnen om gebruikers van screenreaders te informeren over statusberichten.', slug: '/richtlijnen/formulieren/status/screenreaders', keywords: ['labels', 'formulier', 'design', 'code'] },
    m = void 0,
    p = { id: 'richtlijnen/formulieren/status/screenreaders/README', title: 'Informeer gebruikers van screenreaders over het statusbericht \xb7 Status in een formulier \xb7 Richtlijnen', description: 'Richtlijnen om gebruikers van screenreaders te informeren over statusberichten.', source: '@site/docs/richtlijnen/formulieren/status/1-screenreaders/README.mdx', sourceDirName: 'richtlijnen/formulieren/status/1-screenreaders', slug: '/richtlijnen/formulieren/status/screenreaders', permalink: '/en/richtlijnen/formulieren/status/screenreaders', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/status/1-screenreaders/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Informeer gebruikers van screenreaders over het statusbericht \xb7 Status in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Informeer screenreaders', pagination_label: 'Informeer screenreaders', description: 'Richtlijnen om gebruikers van screenreaders te informeren over statusberichten.', slug: '/richtlijnen/formulieren/status/screenreaders', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Status in formulieren', permalink: '/en/richtlijnen/formulieren/status/' }, next: { title: 'Informeer ingezoomde gebruikers', permalink: '/en/richtlijnen/formulieren/status/zoom' } },
    g = {},
    v = [];
   function b(e) {
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', (0, s.jsx)(d, {}), '\n', (0, s.jsx)(a, {}), '\n', (0, s.jsx)(u.ZP, {})] });
  ...
  98480: (e, n, r) => {
   ...
   const g = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(s.Tg, { className: h['nlds-canvas__example-surface'], children: (0, p.jsx)(s.BB, { className: (0, l.Z)('utrecht-document--surface', h['nlds-canvas__example-document']), children: (0, p.jsx)(s.nv, { className: h['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   g.displayName = 'ParagraphContainer';
   const v = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(s.Tg, { className: h['nlds-canvas__example-surface'], children: (0, p.jsx)(s.BB, { className: (0, l.Z)('utrecht-document--surface', h['nlds-canvas__example-document']), children: n }) });
   };
   v.displayName = 'DocumentContainer';
   const b = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(s.Tg, { className: h['nlds-canvas__example-surface'], children: n });
   };
   ...
   const j = (e) => {
    ...
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       w && (0, p.jsx)('div', { className: (0, l.Z)(h['nlds-canvas__example']), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(I, { children: (0, p.jsx)(s.pu, { children: w }) }) }) }),
       x &&
        (0, p.jsx)('div', {
       ...
       x &&
        (0, p.jsxs)('div', {
         ...
         hidden: !Z,
         children: [
          (0, p.jsx)(m.u, { syntax: y, textContent: A, trim: !0 }),
          r &&
           (0, p.jsx)('div', {
