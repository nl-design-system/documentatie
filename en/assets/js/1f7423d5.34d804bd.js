...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [64279],
 {
  ...
  18381: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => h, contentTitle: () => m, default: () => _, frontMatter: () => b, metadata: () => p, toc: () => v });
   var t = l(52676),
    s = l(24785),
    o = l(98480),
    a = l(91050);
  ...
  98480: (e, n, l) => {
   ...
   const h = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(t.Tg, { className: b['nlds-canvas__example-surface'], children: (0, p.jsx)(t.BB, { className: (0, s.Z)('utrecht-document--surface', b['nlds-canvas__example-document']), children: (0, p.jsx)(t.nv, { className: b['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   h.displayName = 'ParagraphContainer';
   const v = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(t.Tg, { className: b['nlds-canvas__example-surface'], children: (0, p.jsx)(t.BB, { className: (0, s.Z)('utrecht-document--surface', b['nlds-canvas__example-document']), children: n }) });
   };
   ...
   const _ = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (z = await c.ZP.format(Z, { parser: f, plugins: [o.Z, a.ZP, i.ZP, r.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(z);
     })();
    }, [Z]);
    const S = (0, d.useId)();
    let R = d.Fragment;
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       w && (0, p.jsx)('div', { className: (0, s.Z)(b['nlds-canvas__example']), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, p.jsx)(R, { children: (0, p.jsx)(t.pu, { children: w }) }) }) }),
       j &&
        (0, p.jsx)('div', {
         className: (0, s.Z)(b['nlds-canvas__toolbar']),
         children: (0, p.jsx)(t.zx, {
          className: (0, s.Z)(b['nlds-canvas__button'], b['nlds-canvas__toggle-code-button']),
       ...
       j &&
        (0, p.jsxs)('div', {
         className: (0, s.Z)(b['nlds-canvas__code-block'], !l && b['nlds-canvas__code-block--user-select-none']),
         id: S,
         hidden: !D,
         children: [
          ...
          l &&
           (0, p.jsx)('div', {
            className: (0, s.Z)(b['nlds-canvas__toolbar'], b['nlds-canvas__toolbar--copy']),
            children: (0, p.jsx)(t.zx, {
