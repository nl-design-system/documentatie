 ...
 [51192],
 {
  33984: (e, l, n) => {
   ...
   function r(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(l.h2, { id: 'over-deze-richtlijnen', children: 'Over deze richtlijnen' }), '\n', (0, s.jsxs)(l.p, { children: ['Deze richtlijnen worden onderhouden door het NL Design System en zijn op dit moment in ', (0, s.jsx)(l.em, { children: 'beta' }), '.'] }), '\n', (0, s.jsxs)(l.p, { children: ['We willen graag van de community horen of ze werkbaar en nuttig zijn. Heb je vragen, aanvullingen of opmerkingen? ', (0, s.jsx)(l.a, { href: 'https://github.com/nl-design-system/documentatie/', children: 'Deel je mening op GitHub' }), ' met je suggesties.'] })] });
   }
   function o(e = {}) {
  ...
  92324: (e, l, n) => {
   n.r(l), n.d(l, { assets: () => v, contentTitle: () => h, default: () => _, frontMatter: () => p, metadata: () => g, toc: () => m });
   var s = n(52676),
    a = n(24785),
    r = n(44585),
    o = n(33376);
   function t(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', (0, s.jsx)(o.X, { appearance: 'do', title: 'Het label altijd tonen en een description gebruiken als aanvullende informatie.', children: (0, s.jsx)(r.X, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(l.label, { for: 'lievelingskleur1', children: 'Wat is je lievelingskleur?' }), (0, s.jsx)(l.p, { id: 'description-kleur1', children: 'Vul de naam van een kleur in.' }), (0, s.jsx)(l.input, { 'aria-describedby': 'description-kleur1', id: 'lievelingskleur1', name: 'lievelingskleur', type: 'text' })] }) }) }), '\n', (0, s.jsx)(o.X, { appearance: 'do', title: 'Het label altijd tonen en een placeholder als korte hint gebruiken.', children: (0, s.jsx)(r.X, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(l.label, { for: 'lievelingskleur2', children: 'Wat is je lievelingskleur?' }), (0, s.jsx)(l.input, { id: 'lievelingskleur2', type: 'text', name: 'lievelingskleur', placeholder: 'Vul een kleurnaam in' })] }) }) }), '\n', (0, s.jsx)(o.X, { appearance: 'dont', title: 'Het label onzichtbaar maken.', children: (0, s.jsx)(r.X, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(l.label, { class: 'sr-only', for: 'lievelingskleur3', children: 'Wat is je lievelingskleur?' }), (0, s.jsx)(l.input, { id: 'lievelingskleur3', name: 'lievelingskleur', placeholder: 'Wat is je lievelingskleur?', type: 'text' })] }) }) }), '\n', (0, s.jsx)(o.X, { appearance: 'dont', title: 'Placeholdertekst heel lang maken zodat een deel uit het formulierveld valt en daardoor onleesbaar wordt. Gebruik in dat geval een description.', children: (0, s.jsx)(r.X, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(l.label, { for: 'lievelingskleur4', children: 'Wat is je lievelingskleur?' }), (0, s.jsx)(l.input, { id: 'lievelingskleur4', name: 'lievelingskleur', placeholder: 'Geef is je lievelingskleur? Bijvoorbeeld rood, wit, geel of blauw.', type: 'text' })] }) }) })] });
   }
   function i(e = {}) {
    const { wrapper: l } = { ...(0, a.a)(), ...e.components };
   ...
   const p = { title: 'Een placeholder is geen vervanger van een label | Placeholders in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Placeholder is geen label', pagination_label: 'Placeholder is geen label', description: 'Richtlijnen over placeholder niet gebruiken als vervanger van een label.', slug: '/richtlijnen/formulieren/placeholders/niet-als-label', keywords: ['labels', 'formulier', 'design', 'code'] },
    h = void 0,
    g = { id: 'richtlijnen/formulieren/placeholder/label/README', title: 'Een placeholder is geen vervanger van een label | Placeholders in een formulier | Richtlijnen', description: 'Richtlijnen over placeholder niet gebruiken als vervanger van een label.', source: '@site/docs/richtlijnen/formulieren/placeholder/1-label/README.mdx', sourceDirName: 'richtlijnen/formulieren/placeholder/1-label', slug: '/richtlijnen/formulieren/placeholders/niet-als-label', permalink: '/en/richtlijnen/formulieren/placeholders/niet-als-label', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/placeholder/1-label/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Een placeholder is geen vervanger van een label | Placeholders in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Placeholder is geen label', pagination_label: 'Placeholder is geen label', description: 'Richtlijnen over placeholder niet gebruiken als vervanger van een label.', slug: '/richtlijnen/formulieren/placeholders/niet-als-label', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Placeholders in een formulier', permalink: '/en/richtlijnen/formulieren/placeholders/' }, next: { title: 'Placeholder bij zoekfunctie', permalink: '/en/richtlijnen/formulieren/placeholders/zoekfunctie' } },
    v = {},
    m = [];
   function b(e) {
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', (0, s.jsx)(d, {}), '\n', (0, s.jsx)(i, {}), '\n', (0, s.jsx)(u.ZP, {})] });
  ...
  44585: (e, l, n) => {
   ...
   const v = (e) => {
    let { children: l } = e;
    return (0, g.jsx)(s.Tg, { className: p['nlds-canvas__example-surface'], children: (0, g.jsx)(s.BB, { className: (0, a.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: (0, g.jsx)(s.nv, { className: p['nlds-canvas__example-paragraph'], children: l }) }) });
   };
   v.displayName = 'ParagraphContainer';
   const m = (e) => {
    let { children: l } = e;
    return (0, g.jsx)(s.Tg, { className: p['nlds-canvas__example-surface'], children: (0, g.jsx)(s.BB, { className: (0, a.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: l }) });
   };
   m.displayName = 'DocumentContainer';
   const b = (e) => {
    let { children: l } = e;
    return (0, g.jsx)(s.Tg, { className: p['nlds-canvas__example-surface'], children: l });
   };
   ...
   const _ = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (P = await c.ZP.format(Z, { parser: k, plugins: [r.Z, o.ZP, t.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), z(P);
     })();
    }, [Z]);
    const S = (0, d.useId)();
    let F = d.Fragment;
    return (
     'paragraph' === x ? (F = v) : 'document' === x ? (F = m) : 'surface' === x && (F = b),
     (0, g.jsxs)('div', {
      className: (0, a.Z)(p['nlds-canvas']),
      children: [
       w && (0, g.jsx)('div', { className: (0, a.Z)(p['nlds-canvas__example']), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, g.jsx)(F, { children: (0, g.jsx)(s.pu, { children: w }) }) }) }),
       j &&
        (0, g.jsx)('div', {
       ...
       j &&
        (0, g.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, g.jsx)(h.u, { syntax: k, textContent: P, trim: !0 }),
          n &&
           (0, g.jsx)('div', {
   ...
   function t(e) {
    ...
    return (
     ...
     (0, o.jsx)(a.y$, {
      ...
      language: n || '',
      children: (e) => {
       let { style: n, tokens: a, getLineProps: r, getTokenProps: t } = e;
       return (0, o.jsx)(s.dn, { style: n, children: a.map((e, n) => (0, o.jsxs)('span', { ...r({ line: e }), children: [l && (0, o.jsx)('span', { children: n + 1 }), e.map((e, l) => (0, o.jsx)('span', { ...t({ token: e }) }, l)), '\n'] }, n)) });
      },
     })
    );
   }
  ...
  33376: (e, l, n) => {
   ...
   const c = (e) => {
    ...
    const p = 'Doen',
     ...
     g = u ? 'figure' : 'div',
     v = u ? 'figcaption' : 'div';
    return (0, i.jsxs)(g, { className: (0, o.Z)(t['nlds-guideline'], t[`nlds-guideline--${n}`]), id: 'string' == typeof l ? l?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(v, { className: (0, o.Z)(t['nlds-guideline__description']), children: ['dont' === n ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(r.nv, { className: (0, o.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${n}`]), children: [(0, i.jsx)(s.Z, { className: t['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: t['nlds-guideline__title'], children: h })] }), (0, i.jsx)(r.nv, { children: l })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(r.nv, { className: (0, o.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${n}`]), children: [(0, i.jsx)(a.Z, { className: t['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: t['nlds-guideline__title'], children: p })] }), (0, i.jsx)(r.nv, { children: l })] }), c] }), (0, i.jsx)('div', { className: (0, o.Z)(t['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, l, n) => {
   n.d(l, { Z: () => t, a: () => o });
   ...
   function t(e) {
    let l;
    return (l = e.disableParentContext ? ('function' == typeof e.components ? e.components(a) : e.components || a) : o(e.components)), s.createElement(r.Provider, { value: l }, e.children);
   }
  },
 },
]);
