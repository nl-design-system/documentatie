 ...
 [71337],
 {
  95615: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Sub heading', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Sub heading', pagination_label: 'Sub heading', description: ' ', slug: '/sub-heading', sidebar_custom_props: { illustration: 'SubHeadingSketch' } },
    a = void 0,
    u = { id: 'componenten/sub-heading/index', title: 'Sub heading', description: ' ', source: '@site/docs/componenten/sub-heading/index.mdx', sourceDirName: 'componenten/sub-heading', slug: '/sub-heading', permalink: '/en/sub-heading', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/sub-heading/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Sub heading', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Sub heading', pagination_label: 'Sub heading', description: ' ', slug: '/sub-heading', sidebar_custom_props: { illustration: 'SubHeadingSketch' } }, sidebar: 'componenten', previous: { title: 'Strong', permalink: '/en/strong' }, next: { title: 'Summary list', permalink: '/en/summary-list' } },
    l = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(S, { [w]: t }), children: [(0, l.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(k.aC, { role: 'presentation', children: n }), (0, l.jsx)(k.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
