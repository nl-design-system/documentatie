   ...
   const T = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(g['definition-of-done'], g[`definition-of-done--${(0, z.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
