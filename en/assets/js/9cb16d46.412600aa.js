...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [70605],
 {
  ...
  4589: (e, n, l) => {
   ...
   var u = l(33984);
   const m = { title: 'Vul bekende informatie in waar mogelijk | Voorkom fouten in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Automatisch invullen', pagination_label: 'Automatisch invullen', description: 'Richtlijnen om invoervelden zoveel mogelijk automatisch in te vullen.', slug: '/richtlijnen/formulieren/voorkom-fouten/automatisch-invullen', keywords: ['labels', 'formulier', 'design', 'code'] },
    p = void 0,
    v = { id: 'richtlijnen/formulieren/help/autofill/README', title: 'Vul bekende informatie in waar mogelijk | Voorkom fouten in een formulier | Richtlijnen', description: 'Richtlijnen om invoervelden zoveel mogelijk automatisch in te vullen.', source: '@site/docs/richtlijnen/formulieren/help/6-autofill/README.mdx', sourceDirName: 'richtlijnen/formulieren/help/6-autofill', slug: '/richtlijnen/formulieren/voorkom-fouten/automatisch-invullen', permalink: '/en/richtlijnen/formulieren/voorkom-fouten/automatisch-invullen', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/help/6-autofill/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Vul bekende informatie in waar mogelijk | Voorkom fouten in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Automatisch invullen', pagination_label: 'Automatisch invullen', description: 'Richtlijnen om invoervelden zoveel mogelijk automatisch in te vullen.', slug: '/richtlijnen/formulieren/voorkom-fouten/automatisch-invullen', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Autocomplete in een formulier', permalink: '/en/richtlijnen/formulieren/voorkom-fouten/autocomplete' }, next: { title: 'Controleren en aanpassen', permalink: '/en/richtlijnen/formulieren/voorkom-fouten/controleren-en-aanpassen' } },
    h = {},
    g = [];
   function b(e) {
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', (0, o.jsx)(d, {}), '\n', (0, o.jsx)(i, {}), '\n', (0, o.jsx)(u.ZP, {})] });
  ...
  44585: (e, n, l) => {
   ...
   const _ = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: _ = !1, displayCode: j = !0, children: x, container: y = 'document', language: f, designTokens: k } = e,
