 ...
 [72837],
 {
  26227: (e, t, n) => {
   ...
   const s = { title: 'Color sample', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Color sample', pagination_label: 'Color sample', description: 'Toont een voorbeeld van een kleur.', slug: '/color-sample', keywords: ['colour', 'kleur', 'voorbeeld', 'color swatch'] },
    a = void 0,
    l = { id: 'componenten/color-sample/index', title: 'Color sample', description: 'Toont een voorbeeld van een kleur.', source: '@site/docs/componenten/color-sample/index.mdx', sourceDirName: 'componenten/color-sample', slug: '/color-sample', permalink: '/en/color-sample', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/color-sample/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Color sample', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Color sample', pagination_label: 'Color sample', description: 'Toont een voorbeeld van een kleur.', slug: '/color-sample', keywords: ['colour', 'kleur', 'voorbeeld', 'color swatch'] }, sidebar: 'componenten', previous: { title: 'Code block', permalink: '/en/code-block' }, next: { title: 'Data badge', permalink: '/en/data-badge' } },
    u = {},
    d = [
    ...
    h = 'Color sample',
    j = 'Toont een voorbeeld van een kleur.',
    y = 325,
  ...
  63246: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, c.Z)(_), children: [(0, u.jsxs)('div', { className: (0, c.Z)(x, { [w]: t }), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var S = n(14669);
   const T = (e) => {
    ...
    L = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(v.V, { level: n, suffix: o && (0, u.jsx)(p.y, { state: o }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
