(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [20322],
 {
  19111: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => s, default: () => p, description: () => j, frontMatter: () => o, issueNumber: () => g, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(7617),
    a = n(63246);
  ...
  83931: (e, t, n) => {
   ...
   const o = (e) => {
     ...
     return (0, a.jsx)('div', { className: (0, i.Z)(c.card__illustration, t && c['card__illustration--background'], r), ...o, children: n });
    },
    s = (e) => (0, a.jsx)('div', { className: (0, i.Z)(c.card__content), ...e }),
    l = (e) => {
     let { href: t, appearance: n, className: o, component: s = 'div', children: l } = e;
     const u = (e) => ('article' === s ? (0, a.jsx)('article', { ...e }) : 'section' === s ? (0, a.jsx)('section', { ...e }) : (0, a.jsx)('div', { ...e })),
      d = (0, a.jsx)(u, { className: (0, i.Z)(c.cardgroup__card, c[`cardgroup__card--${n}`], o), children: l });
     return t ? (0, a.jsx)(r.rU, { href: t, boxContent: !0, className: c.cardgroup__link, children: d }) : d;
    },
    u = (e) => {
  ...
  63246: (e, t, n) => {
   ...
   var r = n(56150),
    ...
    l = n(32636),
    u = n(52676);
   const d = { figma: (0, u.jsx)(c.Z, {}), github: (0, u.jsx)(a.Z, {}), npm: (0, u.jsx)(o.Z, {}), storybook: (0, u.jsx)(s.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const f = 'task-list_hh8j',
    ...
    N = (e) => {
     let { children: t } = e;
     return (0, u.jsx)('ul', { className: f, children: t });
    },
    A = (e) => {
     let { checked: t, title: n, description: r } = e;
     return (0, u.jsxs)('li', { className: (0, i.Z)(_), children: [(0, u.jsxs)('div', { className: (0, i.Z)(x, { [w]: t }), children: [(0, u.jsx)('span', { className: z, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(k.aC, { role: 'presentation', children: n }), (0, u.jsx)(k.nv, { children: r })] })] });
    };
   var S = n(14669);
   const T = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => S.e9.includes(e.id)),
      a = c && S.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: a.map((e) => ({
        className: (0, i.Z)(g['definition-of-done'], e && g[`definition-of-done--${(0, S.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, u.jsx)(N, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(A, { checked: t, title: n, description: (0, S.Q6)(r) }, r);
            }),
           }),
            ...
            j.Zb,
            {
             ...
             children: (0, u.jsxs)(j.aY, {
              children: [
               ...
               (0, u.jsxs)(r.nv, { children: [(0, u.jsx)(y, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(r.rU, { href: e.url, children: [e.title, ' projectbord'] })] }),
               o.length &&
                (0, u.jsxs)(u.Fragment, {
                 children: [
    ...
    L = (e) => {
     ...
     const c = t && S.$3[t.relayStep];
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(v.V, { level: n, suffix: c && (0, u.jsx)(p.y, { state: c }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
   ...
   const s = (e) => {
    let { state: t } = e;
    const n = (0, a.mA)(t);
    return (0, o.jsx)(r.Ou, { className: (0, i.Z)(c['estafette-badge'], n && c[`estafette-badge--${n}`]), children: t });
   };
  },
  66120: (e, t, n) => {
   'use strict';
   ...
   var c = n(52676);
   const a = (e) => {
    let { children: t, className: n, level: a = 1, suffix: o, ...s } = e;
    return (0, c.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${a}`, n), ...s, children: [(0, c.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: t }), o && (0, c.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [o ? ' ' : '', o] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => o, Q6: () => c, e9: () => a, mA: () => i });
