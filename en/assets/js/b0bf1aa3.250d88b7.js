/*! For license information please see b0bf1aa3.250d88b7.js.LICENSE.txt */
"use strict";
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [8595],
 {
  29445: (e, s, n) => {
   n.r(s), n.d(s, { assets: () => g, contentTitle: () => d, default: () => k, frontMatter: () => o, metadata: () => l, toc: () => m });
   var a = n(11527),
    i = n(80877),
    t = n(83778),
    r = n(96207);
   ...
   function c(e) {
    const s = { a: "a", h1: "h1", h2: "h2", p: "p", strong: "strong", ...(0, i.a)(), ...e.components };
    return (0, a.jsxs)(a.Fragment, {
     children: [
      (0, a.jsx)(s.h1, { id: "design-systems-week-tijdschema", children: "Design Systems Week Tijdschema" }),
      "\n",
      (0, a.jsxs)(s.p, { children: ["NL Design System organiseert dit jaar voor de 3e keer de Design Systems Week. Van ", (0, a.jsx)(s.strong, { children: "2 tot 5 oktober" }), " zijn er dagelijks meerdere korte sessies van diverse organisaties over het ", (0, a.jsx)(s.strong, { children: "hoe en waarom van design systems" }), "."] }),
      "\n",
      (0, a.jsx)(s.p, { children: "Dit jaar hebben we nationale \xe9n internationale sprekers. We laten ons inspireren door andere design systems en horen waarom organisaties in een design system investeren. Vanuit verschillende perspectieven leren we hoe design systems bijdragen aan toegankelijkheid en gaan we technisch de diepte in met design tokens en web components." }),
      "\n",
      (0, a.jsxs)(s.p, { children: ["Kijk of luister je mee? Alle sessies zijn gratis online bij te wonen en duren ongeveer 30 minuten. ", (0, a.jsx)(s.a, { href: "https://www.gebruikercentraal.nl/agenda/design-systems-week-2023/#event-booking", children: "Meld je aan" }), " voor de hele week of voor losse sessies. Na aanmelding ontvang je een link die voor alle sessies van de week gebruikt wordt."] }),
      "\n",
      (0, a.jsx)(s.h2, { id: "maandag-2-oktober", children: "maandag 2 oktober" }),
      "\n",
      (0, a.jsx)(r.L, {
       lang: "nl-NL",
       sessions: [
      ...
      "\n",
      (0, a.jsx)(s.h2, { id: "dinsdag-3-oktober", children: "dinsdag 3 oktober" }),
      "\n",
      (0, a.jsx)(r.L, {
       lang: "nl-NL",
       sessions: [
      ...
      "\n",
      (0, a.jsx)(s.h2, { id: "woensdag-4-oktober", children: "woensdag 4 oktober" }),
      "\n",
      (0, a.jsx)(r.L, {
       lang: "nl-NL",
       sessions: [
      ...
      "\n",
      (0, a.jsx)(s.h2, { id: "donderdag-5-oktober", children: "donderdag 5 oktober" }),
      "\n",
      (0, a.jsx)(r.L, {
       lang: "nl-NL",
       sessions: [
      ...
      "\n",
      (0, a.jsx)(s.h2, { id: "organisatie", children: "Organisatie" }),
      "\n",
      (0, a.jsxs)(s.p, { children: ["Design Systems Week wordt georganiseerd door het kernteam van NL Design System, met dank aan het Ministerie van Binnenlandse Zaken en Koninkrijksrelaties en ", (0, a.jsx)(t.rU, { href: "https://www.gebruikercentraal.nl", children: "Gebruiker Centraal" }), ". Alle sessies zijn ook via Gebruiker Centraal bereikbaar ", (0, a.jsx)(t.rU, { href: "https://www.gebruikercentraal.nl/design-systems-week/", children: "Design Systems Week 2023" })] }),
      "\n",
      (0, a.jsx)(s.h2, { id: "code-of-conduct", children: "Code of Conduct" }),
      "\n",
      (0, a.jsxs)(s.p, { children: ["Op Design Systems Week is de ", (0, a.jsx)(s.a, { href: "https://github.com/nl-design-system/.github/blob/main/CODE_OF_CONDUCT.nl.md", children: "NL Design System Code of Conduct" }), " van toepassing. Je gaat daarmee akkoord als je je aanmeldt of spreekt."] }),
      "\n",
   ...
   function k(e = {}) {
    ...
    return s ? (0, a.jsx)(s, { ...e, children: (0, a.jsx)(c, { ...e }) }) : c(e);
   }
  },
  96207: (e, s, n) => {
   n.d(s, { L: () => l });
   ...
   const d = (e) => {
    ...
    l = (e) => {
     ...
     return (0, o.jsx)("div", {
      className: (0, t.Z)(r["session-table-container"], a),
      children: (0, o.jsxs)(i.iA, {
       className: (0, t.Z)(r["session-table"], a),
       ...l,
       children: [
        (0, o.jsx)(i.xD, { children: (0, o.jsxs)(i.SC, { className: (0, t.Z)(r["session-table__row"]), children: [(0, o.jsx)(i.xs, { children: "nl-NL" === s ? "Tijd" : "Time" }), (0, o.jsx)(i.xs, { children: "nl-NL" === s ? "Spreker" : "Speaker" }), (0, o.jsx)(i.xs, { children: "nl-NL" === s ? "Onderwerp" : "Subject" }), "nl-NL" === s && (0, o.jsx)(i.xs, { children: "Taal" })] }) }),
        (0, o.jsx)(i.RM, {
         children: n.map((e, n) => {
          let { isoDateTime: a, speakers: l, subject: g, singupLink: m, language: c } = e;
          return (0, o.jsxs)(i.SC, { className: (0, t.Z)(r["session-table__row"]), children: [(0, o.jsx)(i.pj, { className: (0, t.Z)(r["session-table__time"]), children: (0, o.jsx)(i.nv, { children: (0, o.jsx)("time", { dateTime: a, children: new Intl.DateTimeFormat(s, { hour: "numeric", minute: "numeric", timeZone: "Europe/Amsterdam", timeZoneName: "nl-NL" !== s ? "short" : void 0 }).format(new Date(a)) }) }) }), (0, o.jsx)(i.pj, { children: (0, o.jsx)("div", { className: (0, t.Z)(r["session-table__speakers"]), children: l.map((e, s) => (0, o.jsx)(d, { ...e }, s)) }) }), (0, o.jsx)(i.pj, { className: (0, t.Z)(r["session-table__subject"]), children: (0, o.jsx)(i.nv, { children: (0, o.jsx)(i.rU, { href: m, children: g }) }) }), "nl-NL" === s && (0, o.jsx)(i.pj, { className: (0, t.Z)(r["session-table__language"]), children: (0, o.jsx)("abbr", { title: c.description, children: c.abbr }) })] }, n);
         }),
        }),
       ],
      }),
  ...
  80877: (e, s, n) => {
   ...
   function o(e) {
    let s;
    return (s = e.disableParentContext ? ("function" == typeof e.components ? e.components(i) : e.components || i) : r(e.components)), a.createElement(t.Provider, { value: s }, e.children);
   }
  },
  50502: (e, s, n) => {
   n.d(s, { Z: () => a });
   var a = (0, n(65195).Z)("outline", "user", "IconUser", [
