 ...
 [9910],
 {
  ...
  63246: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, c.Z)(_), children: [(0, l.jsxs)('div', { className: (0, c.Z)(x, { [w]: t }), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.aC, { role: 'presentation', children: n }), (0, l.jsx)(v.nv, { children: r })] })] });
    };
   var S = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const o = t && t.projects.filter((e) => S.e9.includes(e.id)),
      i = o && S.e9.map((e) => o.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: i.map((e) => ({
        className: (0, c.Z)(y['definition-of-done'], e && y[`definition-of-done--${(0, S.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
    ...
    V = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(b.V, { level: n, suffix: o && (0, l.jsx)(p.y, { state: o }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
  ...
  66120: (e, t, n) => {
   ...
   const i = (e) => {
    ...
    return (0, o.jsxs)('hgroup', { className: (0, r.Z)(c['nlds-inline-heading-group'], `utrecht-heading-${i}`, n), ...a, children: [(0, o.jsx)('h1', { className: (0, r.Z)(c['nlds-inline-heading-group__heading']), children: t }), s && (0, o.jsxs)('p', { className: (0, r.Z)(c['nlds-inline-heading-group__suffix']), children: [s ? ' ' : '', s] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => s, Q6: () => o, e9: () => i, mA: () => c });
