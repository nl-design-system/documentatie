(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [2930],
 {
  88086: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => y, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => o, issueNumber: () => g, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    s = n(87176),
    c = n(90786);
  ...
  68963: (e, t, n) => {
   ...
   const o = (e) => {
     ...
     return (0, c.jsx)('div', { className: (0, i.Z)(s.card__illustration, t && s['card__illustration--background'], r), ...o, children: n });
    },
    a = (e) => (0, c.jsx)('div', { className: (0, i.Z)(s.card__content), ...e }),
    l = (e) => {
     ...
     const u = (e) => ('article' === a ? (0, c.jsx)('article', { ...e }) : 'section' === a ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      d = (0, c.jsx)(u, { className: (0, i.Z)(s.cardgroup__card, s[`cardgroup__card--${n}`], o), children: l });
     return t ? (0, c.jsx)(r.rU, { href: t, boxContent: !0, className: s.cardgroup__link, children: d }) : d;
    },
    u = (e) => {
     let { appearance: t = 'medium', children: n, className: r } = e;
     return (0, c.jsx)('div', { className: (0, i.Z)(s.cardgroup, s[`cardgroup--${t}`], r), children: n });
    };
  },
  90786: (e, t, n) => {
   'use strict';
   ...
   var r = n(56150),
    ...
    l = n(32636),
    u = n(52676);
   const d = { figma: (0, u.jsx)(s.Z, {}), github: (0, u.jsx)(c.Z, {}), npm: (0, u.jsx)(o.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const N = (e) => {
     ...
     const s = t && t.projects.filter((e) => w.e9.includes(e.id)),
      c = s && w.e9.map((e) => s.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
    ...
    S = (e) => {
     ...
     const s = t && w.$3[t.relayStep];
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(v.V, { level: n, suffix: s && (0, u.jsx)(p.y, { state: s }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, t, n) => {
   'use strict';
   ...
   const a = (e) => {
    let { state: t } = e;
    const n = (0, c.mA)(t);
    return (0, o.jsx)(r.Ou, { className: (0, i.Z)(s['estafette-badge'], n && s[`estafette-badge--${n}`]), children: t });
   };
  },
  72657: (e, t, n) => {
   'use strict';
   ...
   var s = n(52676);
   const c = (e) => {
    let { children: t, className: n, level: c = 1, suffix: o, ...a } = e;
    return (0, s.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${c}`, n), ...a, children: [(0, s.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: t }), o && (0, s.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [o ? ' ' : '', o] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => o, Q6: () => s, e9: () => c, mA: () => i });
