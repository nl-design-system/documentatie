 ...
 [90258],
 {
  28505: (e, t, n) => {
   ...
   const s = { title: 'Language navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Language navigation', pagination_label: 'Language navigation', description: 'E\xe9n of meerdere links om de website te openen in een andere taal.', slug: '/language-navigation' },
    a = void 0,
    u = { id: 'componenten/language-navigation/index', title: 'Language navigation', description: 'E\xe9n of meerdere links om de website te openen in een andere taal.', source: '@site/docs/componenten/language-navigation/index.mdx', sourceDirName: 'componenten/language-navigation', slug: '/language-navigation', permalink: '/en/language-navigation', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/language-navigation/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Language navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Language navigation', pagination_label: 'Language navigation', description: 'E\xe9n of meerdere links om de website te openen in een andere taal.', slug: '/language-navigation' }, sidebar: 'componenten', previous: { title: 'Invalid form alert', permalink: '/en/invalid-form-alert' }, next: { title: 'Legend', permalink: '/en/legend' } },
    l = {},
    d = [
