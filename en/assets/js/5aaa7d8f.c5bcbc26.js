 ...
 [64995],
 {
   ...
   const o = (e) => {
    ...
    u = (e) => {
     ...
     const l = (e) => ('article' === a ? (0, s.jsx)('article', { ...e }) : 'section' === a ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      h = (0, s.jsx)(l, { className: (0, c.Z)(i.cardgroup__card, i[`cardgroup__card--${n}`], o), children: u });
     return t ? (0, s.jsx)(r.rU, { href: t, boxContent: !0, className: i.cardgroup__link, children: h }) : h;
    },
    l = (e) => {
  ...
  63246: (e, t, n) => {
   ...
   const T = (e) => {
     ...
     const i = t && t.projects.filter((e) => z.e9.includes(e.id)),
      s = i && z.e9.map((e) => i.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
    ...
    V = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(v.V, { level: n, suffix: i && (0, l.jsx)(g.y, { state: i }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
  ...
  66120: (e, t, n) => {
   ...
   const s = (e) => {
    ...
    return (0, i.jsxs)('hgroup', { className: (0, r.Z)(c['nlds-inline-heading-group'], `utrecht-heading-${s}`, n), ...a, children: [(0, i.jsx)('h1', { className: (0, r.Z)(c['nlds-inline-heading-group__heading']), children: t }), o && (0, i.jsxs)('p', { className: (0, r.Z)(c['nlds-inline-heading-group__suffix']), children: [o ? ' ' : '', o] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
