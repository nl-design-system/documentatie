...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [8883],
 {
  ...
  57997: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => S, contentTitle: () => D, default: () => I, frontMatter: () => G, metadata: () => Z, toc: () => V });
   var r = i(11527),
    t = i(27034),
    l = i(73460),
    o = i(30036);
   ...
   const G = { title: "Foutmeldingen in een formulier| Richtlijnen", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Foutmeldingen", sidebar_position: 5, pagination_label: "Foutmeldingen", description: "Als een veld niet goed is ingevuld, moet voor iedereen duidelijk zijn wat er niet klopt. Hoe help je de gebruiker het beste als die onjuiste of onvolledige informatie invult?", slug: "foutmeldingen", keywords: ["informatie", "formulier", "design", "code"] },
    D = "Foutmeldingen in een formulier",
    Z = { id: "richtlijnen/formulieren/errors", title: "Foutmeldingen in een formulier| Richtlijnen", description: "Als een veld niet goed is ingevuld, moet voor iedereen duidelijk zijn wat er niet klopt. Hoe help je de gebruiker het beste als die onjuiste of onvolledige informatie invult?", source: "@site/docs/richtlijnen/formulieren/errors.mdx", sourceDirName: "richtlijnen/formulieren", slug: "/richtlijnen/formulieren/foutmeldingen", permalink: "/en/richtlijnen/formulieren/foutmeldingen", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/errors.mdx", tags: [], version: "current", sidebarPosition: 5, frontMatter: { title: "Foutmeldingen in een formulier| Richtlijnen", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Foutmeldingen", sidebar_position: 5, pagination_label: "Foutmeldingen", description: "Als een veld niet goed is ingevuld, moet voor iedereen duidelijk zijn wat er niet klopt. Hoe help je de gebruiker het beste als die onjuiste of onvolledige informatie invult?", slug: "foutmeldingen", keywords: ["informatie", "formulier", "design", "code"] }, sidebar: "richtlijnen", previous: { title: "Descriptions in een formulier", permalink: "/en/richtlijnen/formulieren/descriptions" }, next: { title: "Labels in een formulier", permalink: "/en/richtlijnen/formulieren/labels" } },
    S = {},
    V = [];
   function H(e) {
  ...
  73460: (e, n, i) => {
   ...
   const g = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(r.Tg, { className: h["nlds-canvas__example-surface"], children: (0, m.jsx)(r.BB, { className: (0, t.Z)("utrecht-document--surface", h["nlds-canvas__example-document"]), children: (0, m.jsx)(r.nv, { className: h["nlds-canvas__example-paragraph"], children: n }) }) });
   };
   g.displayName = "ParagraphContainer";
   const v = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(r.Tg, { className: h["nlds-canvas__example-surface"], children: (0, m.jsx)(r.BB, { className: (0, t.Z)("utrecht-document--surface", h["nlds-canvas__example-document"]), children: n }) });
   };
   ...
   const f = (e) => {
    let { code: n, copy: i = !1, defaultExpandedCode: f = !1, displayCode: x = !0, children: b, container: k = "document", language: y, designTokens: w } = e,
     ...
     F = "string" == typeof n ? n : u.uS(N || _),
     [z, A] = (0, c.useState)(F),
     [C, G] = (0, c.useState)(f);
    (0, c.useEffect)(() => {
     (async () => {
      (z = await a.ZP.format(F, { parser: y, plugins: [l.Z, o.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), A(z);
     })();
    }, [F]);
    const D = (0, c.useId)();
    let Z = c.Fragment;
    return (
     "paragraph" === k ? (Z = g) : "document" === k ? (Z = v) : "surface" === k && (Z = j),
     (0, m.jsxs)("div", {
      className: (0, t.Z)(h["nlds-canvas"]),
      children: [
       _ && (0, m.jsx)("div", { className: (0, t.Z)(h["nlds-canvas__example"]), children: (0, m.jsx)("div", { className: "voorbeeld-theme", style: w, children: (0, m.jsx)(Z, { children: (0, m.jsx)(r.pu, { children: _ }) }) }) }),
       x &&
        (0, m.jsx)("div", {
       ...
       x &&
        (0, m.jsxs)("div", {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(p.u, { syntax: y, textContent: z, trim: !0 }),
          i &&
           (0, m.jsx)("div", {
            className: (0, t.Z)(h["nlds-canvas__toolbar"]),
            children: (0, m.jsx)(r.zx, {
