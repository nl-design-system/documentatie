 ...
 [33874],
 {
  85037: (e, n, o) => {
   ...
   var t = o(13455),
    s = o(31092);
   function d(e) {
    return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(s.X, { appearance: "do", title: "Leg het doel uit.", description: "Met uitleg weet de gebruiker waar die aan toe is.", children: (0, l.jsxs)(t.X, { language: "html", children: [(0, l.jsx)("label", { for: "email", children: "E-mailadres" }), (0, l.jsx)("p", { id: "email-description", children: "We hebben uw e-mailadres nodig om een afspraakbevestiging te kunnen sturen." }), (0, l.jsx)("input", { "aria-describedby": "email-description", autocomplete: "email", id: "email", type: "email" })] }) }), "\n", (0, l.jsx)(s.X, { appearance: "dont", title: "Privacygevoelige informatie vragen zonder uitleg waarom deze gegevens nodig zijn.", children: (0, l.jsxs)(t.X, { language: "html", children: [(0, l.jsx)("label", { for: "bsn", children: "Burgerservicenummer" }), (0, l.jsx)("input", { id: "bsn", type: "text" })] }) })] });
   }
   function c(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
   ...
   function h(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
    return n ? (0, l.jsx)(n, { ...e, children: (0, l.jsx)(u, { ...e }) }) : u();
   }
   function v(e) {
    const n = { h2: "h2", p: "p", ...(0, r.a)(), ...e.components };
   ...
   function b(e) {
    return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(s.X, { appearance: "do", title: "Naast een telefoonnummer ook een e-mailadres uitvragen.", children: (0, l.jsxs)(t.X, { language: "html", children: [(0, l.jsx)("label", { for: "telefoon1", children: "Uw telefoonnummer" }), (0, l.jsx)("input", { id: "telefoon1", type: "tel", name: "telefoon", autocomplete: "tel" }), (0, l.jsx)("label", { for: "email1", children: "Uw e-mailadres" }), (0, l.jsx)("input", { id: "email1", type: "email", name: "email", autocomplete: "email" })] }) }), "\n", (0, l.jsx)(s.X, { appearance: "dont", title: "Alleen een telefoonnummer uitvragen.", children: (0, l.jsxs)(t.X, { language: "html", children: [(0, l.jsx)("label", { for: "telefoon2", children: "Uw telefoonnummer (verplicht)" }), (0, l.jsx)("input", { id: "telefoon2", type: "tel", name: "telefoon", autocomplete: "tel", "aria-required": "true" })] }) })] });
   }
   function j(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
   ...
   function y(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
    return n ? (0, l.jsx)(n, { ...e, children: (0, l.jsx)(w, { ...e }) }) : w(e);
   }
   function z(e) {
    return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(s.X, { appearance: "do", title: "Geef de mogelijkheid korte en lange teksten in te vullen.", children: (0, l.jsxs)(t.X, { language: "html", children: [(0, l.jsx)("label", { for: "woonplaats1", children: "Uw woonplaats" }), (0, l.jsx)("input", { id: "woonplaats1", type: "text", name: "email", autocomplete: "address-level2" })] }) }), "\n", (0, l.jsx)(s.X, { appearance: "dont", title: "Limiteer het maximaal aantal in te voeren tekens.", description: "Mensen uit Gasselterboerveenschemond of Westerhaar-Vriezenveensewijk willen ook graag hun woonplaats invoeren.", children: (0, l.jsxs)(t.X, { language: "html", children: [(0, l.jsx)("label", { for: "woonplaats2", children: "Uw woonplaats" }), (0, l.jsx)("input", { id: "woonplaats2", type: "text", name: "email", maxlength: "20", autocomplete: "address-level2" })] }) }), "\n", (0, l.jsx)(s.X, { appearance: "dont", title: "Limiteer het minimaal aantal in te voeren tekens.", description: "Jo, Bo en X willen ook graag hun voornaam invullen.", children: (0, l.jsxs)(t.X, { language: "html", children: [(0, l.jsx)("label", { for: "voornaam1", children: "Je voornaam" }), (0, l.jsx)("input", { id: "voornaam1", type: "text", name: "voornaam", minlength: "3", autocomplete: "given-name" })] }) })] });
   }
   function S(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
    return n ? (0, l.jsx)(n, { ...e, children: (0, l.jsx)(z, { ...e }) }) : z();
   }
   var N = o(59467);
  ...
  13455: (e, n, o) => {
   ...
   const b = (e) => {
    ...
    j = (e) => {
     let { code: n, copy: o = !1, defaultCollapsed: i = !0, children: t, language: d } = e;
     "function" == typeof t && (t = t());
     const j = c().format(m.uS(n || t), { parser: "html", plugins: [a(), s()], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" }),
      k = (0, v.Z)();
     return (0, p.jsxs)("div", {
      className: (0, r.Z)(l["nlds-canvas"], "voorbeeld-theme", "utrecht-html"),
      children: [
       (0, p.jsx)("div", { className: (0, r.Z)(l["nlds-canvas__example"]), children: t }),
       (0, p.jsx)("div", { className: (0, r.Z)(l["nlds-canvas__toolbar"]), children: (0, p.jsx)(h.zx, { className: (0, r.Z)(l["nlds-canvas__button"], l["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: b, "aria-expanded": !i, "aria-controls": k, children: i ? "Bekijk code" : "Verberg code" }) }),
       (0, p.jsxs)("div", {
        className: (0, r.Z)(l["nlds-canvas__code-block"], !o && l["nlds-canvas__code-block--user-select-none"]),
        id: k,
        hidden: i,
        children: [
         (0, p.jsx)(g.Z, { language: d, style: u, children: j }),
         o &&
          (0, p.jsx)("div", {
  ...
  31092: (e, n, o) => {
   ...
   const d = (e) => {
    ...
    const m = "Doen",
     g = "Niet doen";
    return (0, s.jsxs)("div", { className: (0, a.Z)(i["nlds-guideline"], i[`nlds-guideline--${o}`]), id: n?.toLowerCase().replace(/\s/g, "-"), children: [(0, s.jsxs)("div", { className: (0, a.Z)(i["nlds-guideline__description"]), children: ["dont" === o ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(t.nv, { className: (0, a.Z)(i["nlds-guideline__badge"], i[`nlds-guideline__badge--${o}`]), children: [(0, s.jsx)(l.Z, { className: i["nlds-guideline__icon"] }), (0, s.jsx)("span", { className: i["nlds-guideline__title"], children: g })] }), (0, s.jsx)(t.nv, { children: n })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(t.nv, { className: (0, a.Z)(i["nlds-guideline__badge"], i[`nlds-guideline__badge--${o}`]), children: [(0, s.jsx)(r.Z, { className: i["nlds-guideline__icon"] }), (0, s.jsx)("span", { className: i["nlds-guideline__title"], children: m })] }), (0, s.jsx)(t.nv, { children: n })] }), d] }), (0, s.jsx)("div", { className: (0, a.Z)(i["nlds-guideline__example"]), children: c })] });
   };
  },
 },
]);
