 ...
 [32652],
 {
  47095: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Spinner', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Spinner', pagination_label: 'Spinner', description: 'Toont een animatie die aangeeft dat een pagina of een deel ervan aan het laden is, of een interactie blokkeert.', slug: '/spinner', sidebar_custom_props: { illustration: 'SpinnerSketch' } },
    a = void 0,
    l = { id: 'componenten/spinner/index', title: 'Spinner', description: 'Toont een animatie die aangeeft dat een pagina of een deel ervan aan het laden is, of een interactie blokkeert.', source: '@site/docs/componenten/spinner/index.mdx', sourceDirName: 'componenten/spinner', slug: '/spinner', permalink: '/en/spinner', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/spinner/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Spinner', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Spinner', pagination_label: 'Spinner', description: 'Toont een animatie die aangeeft dat een pagina of een deel ervan aan het laden is, of een interactie blokkeert.', slug: '/spinner', sidebar_custom_props: { illustration: 'SpinnerSketch' } }, sidebar: 'componenten', previous: { title: 'Skip link', permalink: '/en/skip-link' }, next: { title: 'Status badge', permalink: '/en/status-badge' } },
    u = {},
    d = [
    ...
    h = 'Spinner',
    j = 'Toont een animatie die aangeeft dat een pagina of een deel ervan aan het laden is, of een interactie blokkeert.',
    y = 'SpinnerSketch',
    g = 75,
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(S, { [w]: t }), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(k.aC, { role: 'presentation', children: n }), (0, u.jsx)(k.nv, { children: r })] })] });
    };
   var T = n(14669);
   const D = (e) => {
     ...
     return (
      ...
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], y[`definition-of-done--${(0, T.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
         ...
         children: [
          (0, u.jsx)(A, {
           children: e.tasks.map((e) => {
            ...
            return (0, u.jsx)(z, { checked: t, title: n, description: (0, T.Q6)(r) }, r);
           }),
          }),
