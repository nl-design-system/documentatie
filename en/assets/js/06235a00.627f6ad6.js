...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  51244: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => g, contentTitle: () => u, default: () => m, frontMatter: () => a, metadata: () => h, toc: () => f });
   var t = i(52676),
    r = i(24785),
    s = i(71595),
    o = i(45054),
   ...
   const a = { title: 'WCAG-succescriterium 3.2.4 Consistente identificatie', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.4 Consistente identificatie', pagination_label: 'WCAG-succescriterium 3.2.4 Consistente identificatie', description: 'Zorg ervoor dat componenten die dezelfde functie hebben binnen een website, er hetzelfde uitzien en ook hetzelfde werken.', slug: '3.2.4', keywords: ['WCAG'] },
    u = void 0,
    h = { id: 'wcag/3.2.04', title: 'WCAG-succescriterium 3.2.4 Consistente identificatie', description: 'Zorg ervoor dat componenten die dezelfde functie hebben binnen een website, er hetzelfde uitzien en ook hetzelfde werken.', source: '@site/docs/wcag/3.2.04.mdx', sourceDirName: 'wcag', slug: '/wcag/3.2.4', permalink: '/en/wcag/3.2.4', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.2.04.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 3.2.4 Consistente identificatie', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.4 Consistente identificatie', pagination_label: 'WCAG-succescriterium 3.2.4 Consistente identificatie', description: 'Zorg ervoor dat componenten die dezelfde functie hebben binnen een website, er hetzelfde uitzien en ook hetzelfde werken.', slug: '3.2.4', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.2.3 Consistente navigatie', permalink: '/en/wcag/3.2.3' }, next: { title: 'WCAG-succescriterium 3.2.5 Verandering op verzoek', permalink: '/en/wcag/3.2.5' } },
    g = {},
    f = [
