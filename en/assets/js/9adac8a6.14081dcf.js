...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [79871],
 {
  ...
  62577: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => m, contentTitle: () => h, default: () => _, frontMatter: () => p, metadata: () => b, toc: () => g });
   var t = l(52676),
    a = l(24785),
    i = l(98480),
    s = l(91050);
   function o(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(s.X, { appearance: 'do', title: 'Alle informatie als zichtbare tekst in de link plaatsen.', children: (0, t.jsx)(i.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.a, { href: '#', target: '_blank', children: 'Lees het privacybeleid (opent in een nieuwe tab)' }), '.'] }) }) }), '\n', (0, t.jsx)(s.X, { appearance: 'do', title: 'Zichtbaar icoontje plus onzichtbare, maar uitgesproken tekst voor screenreaders.', children: (0, t.jsx)(i.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsxs)(n.a, { href: '#', target: '_blank', class: 'nlds-icon-ext', children: ['Lees het privacybeleid', (0, t.jsx)(n.span, { class: 'sr-only', children: ', opent in een nieuwe tab' })] }), '.'] }) }) }), '\n', (0, t.jsx)(s.X, { appearance: 'do', title: 'Zichtbaar icoontje plus een aria-label voor screenreaders.', children: (0, t.jsx)(i.X, { language: 'html', children: () => (0, t.jsx)(t.Fragment, { children: (0, t.jsx)(n.a, { href: '#', target: '_blank', class: 'nlds-icon-ext', 'aria-label': 'Lees het privacybeleid (opent in een nieuwe tab)', children: 'Lees het privacybeleid' }) }) }) }), '\n', (0, t.jsx)(s.X, { appearance: 'dont', title: 'Informatie over het openen in een nieuwe tab alleen aan screenreadergebruikers geven.', children: (0, t.jsx)(i.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.a, { href: '#', target: '_blank', 'aria-label': 'Lees het privacybeleid (opent in een nieuwe tab)', children: 'Lees het privacybeleid' }), '.'] }) }) }), '\n', (0, t.jsx)(s.X, { appearance: 'dont', title: 'Informatie over het openen in een nieuwe tab voor iedereen weglaten.', children: (0, t.jsx)(i.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.a, { href: '#', target: '_blank', children: 'Lees het privacybeleid' }), '.'] }) }) })] });
   }
   function r(e = {}) {
    const { wrapper: n } = { ...(0, a.a)(), ...e.components };
   ...
   var u = l(23680);
   const p = { title: 'Geef aan als een link in een nieuwe tab opent | Links in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link in nieuwe tab', pagination_label: 'Link in nieuwe tab', description: 'Richtlijnen voor aangeven als een link een nieuwe tab opent.', slug: '/richtlijnen/formulieren/links/nieuwe-tab', keywords: ['labels', 'formulier', 'design', 'code'] },
    h = void 0,
    b = { id: 'richtlijnen/formulieren/link/in-new-tab/README', title: 'Geef aan als een link in een nieuwe tab opent | Links in een formulier | Richtlijnen', description: 'Richtlijnen voor aangeven als een link een nieuwe tab opent.', source: '@site/docs/richtlijnen/formulieren/link/3-in-new-tab/README.mdx', sourceDirName: 'richtlijnen/formulieren/link/3-in-new-tab', slug: '/richtlijnen/formulieren/links/nieuwe-tab', permalink: '/en/richtlijnen/formulieren/links/nieuwe-tab', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/link/3-in-new-tab/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Geef aan als een link in een nieuwe tab opent | Links in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link in nieuwe tab', pagination_label: 'Link in nieuwe tab', description: 'Richtlijnen voor aangeven als een link een nieuwe tab opent.', slug: '/richtlijnen/formulieren/links/nieuwe-tab', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Geen link in label', permalink: '/en/richtlijnen/formulieren/links/niet-in-label' }, next: { title: 'Meerdere stappen', permalink: '/en/richtlijnen/formulieren/meerdere-stappen/' } },
    m = {},
    g = [];
   function v(e) {
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(d, {}), '\n', (0, t.jsx)(r, {}), '\n', (0, t.jsx)(u.ZP, {})] });
  ...
  98480: (e, n, l) => {
   ...
   const m = (e) => {
    let { children: n } = e;
    return (0, b.jsx)(t.Tg, { className: p['nlds-canvas__example-surface'], children: (0, b.jsx)(t.BB, { className: (0, a.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: (0, b.jsx)(t.nv, { className: p['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   m.displayName = 'ParagraphContainer';
   const g = (e) => {
    let { children: n } = e;
    return (0, b.jsx)(t.Tg, { className: p['nlds-canvas__example-surface'], children: (0, b.jsx)(t.BB, { className: (0, a.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: n }) });
   };
   ...
   const _ = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: _ = !1, displayCode: k = !0, children: j, container: x = 'document', language: y, designTokens: f } = e,
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (z = await c.ZP.format(Z, { parser: y, plugins: [i.Z, s.ZP, o.ZP, r.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(z);
     })();
    }, [Z]);
    const F = (0, d.useId)();
    let D = d.Fragment;
    return (
     'paragraph' === x ? (D = m) : 'document' === x ? (D = g) : 'surface' === x && (D = v),
     (0, b.jsxs)('div', {
      className: (0, a.Z)(p['nlds-canvas']),
      children: [
       w && (0, b.jsx)('div', { className: (0, a.Z)(p['nlds-canvas__example']), children: (0, b.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, b.jsx)(D, { children: (0, b.jsx)(t.pu, { children: w }) }) }) }),
       k &&
        (0, b.jsx)('div', {
   ...
   function o(e) {
    ...
    return (
     ...
     (0, s.jsx)(a.y$, {
      ...
      language: l || '',
      children: (e) => {
       let { style: l, tokens: a, getLineProps: i, getTokenProps: o } = e;
       return (0, s.jsx)(t.dn, { style: l, children: a.map((e, l) => (0, s.jsxs)('span', { ...i({ line: e }), children: [n && (0, s.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const p = 'Doen',
     ...
     b = u ? 'figure' : 'div',
     m = u ? 'figcaption' : 'div';
    return (0, r.jsxs)(b, { className: (0, s.Z)(o['nlds-guideline'], o[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, r.jsxs)(m, { className: (0, s.Z)(o['nlds-guideline__description']), children: ['dont' === l ? (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(i.nv, { className: (0, s.Z)(o['nlds-guideline__badge'], o[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(t.Z, { className: o['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: o['nlds-guideline__title'], children: h })] }), (0, r.jsx)(i.nv, { children: n })] }) : (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(i.nv, { className: (0, s.Z)(o['nlds-guideline__badge'], o[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(a.Z, { className: o['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: o['nlds-guideline__title'], children: p })] }), (0, r.jsx)(i.nv, { children: n })] }), c] }), (0, r.jsx)('div', { className: (0, s.Z)(o['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => o, a: () => s });
