 ...
 [95102],
 {
  94645: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(61475),
    o = n(21998);
   const s = { title: 'Heading group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading group', pagination_label: 'Heading group', description: ' ', slug: '/heading-group', sidebar_custom_props: { illustration: 'HeadingGroupSketch' } },
    a = void 0,
    u = { id: 'componenten/heading-group/index', title: 'Heading group', description: ' ', source: '@site/docs/componenten/heading-group/index.mdx', sourceDirName: 'componenten/heading-group', slug: '/heading-group', permalink: '/en/heading-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/heading-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Heading group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading group', pagination_label: 'Heading group', description: ' ', slug: '/heading-group', sidebar_custom_props: { illustration: 'HeadingGroupSketch' } }, sidebar: 'componenten', previous: { title: 'Heading 6', permalink: '/en/heading-6' }, next: { title: 'Icon', permalink: '/en/icon' } },
    l = {},
    d = [
