 ...
 [97979],
 {
  63270: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(80719),
    s = n(90786);
   const o = { title: 'Textarea', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Textarea', pagination_label: 'Textarea', description: 'Invoerveld voor het bewerken van meerdere regels tekst.', slug: '/textarea' },
    a = void 0,
    l = { id: 'componenten/textarea/index', title: 'Textarea', description: 'Invoerveld voor het bewerken van meerdere regels tekst.', source: '@site/docs/componenten/textarea/index.mdx', sourceDirName: 'componenten/textarea', slug: '/textarea', permalink: '/en/textarea', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/textarea/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Textarea', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Textarea', pagination_label: 'Textarea', description: 'Invoerveld voor het bewerken van meerdere regels tekst.', slug: '/textarea' }, sidebar: 'componenten', previous: { title: 'Text input group', permalink: '/en/text-input-group' }, next: { title: 'Toggletip', permalink: '/en/toggletip' } },
    u = {},
    d = [
    ...
    h = 'Textarea',
    j = 'Invoerveld voor het bewerken van meerdere regels tekst.',
    y = 40,
