 ...
 [7869],
 {
  47671: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Number input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number input', pagination_label: 'Number input', description: 'Biedt de mogelijkheid om een numerieke waarde in te vullen.', slug: '/number-input', sidebar_custom_props: { illustration: 'NumberInputSketch' } },
    a = void 0,
    u = { id: 'componenten/number-input/index', title: 'Number input', description: 'Biedt de mogelijkheid om een numerieke waarde in te vullen.', source: '@site/docs/componenten/number-input/index.mdx', sourceDirName: 'componenten/number-input', slug: '/number-input', permalink: '/en/number-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/number-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Number input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number input', pagination_label: 'Number input', description: 'Biedt de mogelijkheid om een numerieke waarde in te vullen.', slug: '/number-input', sidebar_custom_props: { illustration: 'NumberInputSketch' } }, sidebar: 'componenten', previous: { title: 'Number badge', permalink: '/en/number-badge' }, next: { title: 'Ordered list', permalink: '/en/ordered-list' } },
    l = {},
    d = [
    ...
    h = 'Number input',
    j = 'Biedt de mogelijkheid om een numerieke waarde in te vullen.',
    m = 'NumberInputSketch',
    y = 194,
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(N, { [w]: t }), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(k.aC, { role: 'presentation', children: n }), (0, l.jsx)(k.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
