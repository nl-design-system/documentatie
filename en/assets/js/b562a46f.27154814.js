...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [12274],
 {
  ...
  19139: (e, n, l) => {
   ...
   var p = l(33984);
   const u = { title: 'Meerdere descriptions koppelen | Descriptions in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Meerdere descriptions', pagination_label: 'Meerdere descriptions', description: 'Richtlijnen voor koppelen van meerdere descriptions aan een formulierveld.', slug: '/richtlijnen/formulieren/descriptions/meerdere-koppelen', keywords: ['labels', 'formulier', 'design', 'code'] },
    m = void 0,
    _ = { id: 'richtlijnen/formulieren/description/multiple/README', title: 'Meerdere descriptions koppelen | Descriptions in een formulier | Richtlijnen', description: 'Richtlijnen voor koppelen van meerdere descriptions aan een formulierveld.', source: '@site/docs/richtlijnen/formulieren/description/3-multiple/README.mdx', sourceDirName: 'richtlijnen/formulieren/description/3-multiple', slug: '/richtlijnen/formulieren/descriptions/meerdere-koppelen', permalink: '/en/richtlijnen/formulieren/descriptions/meerdere-koppelen', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/description/3-multiple/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Meerdere descriptions koppelen | Descriptions in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Meerdere descriptions', pagination_label: 'Meerdere descriptions', description: 'Richtlijnen voor koppelen van meerdere descriptions aan een formulierveld.', slug: '/richtlijnen/formulieren/descriptions/meerdere-koppelen', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Plaatsing description', permalink: '/en/richtlijnen/formulieren/descriptions/plaatsing' }, next: { title: 'Description bij fieldsets', permalink: '/en/richtlijnen/formulieren/descriptions/plaatsing-bij-fieldset' } },
    h = {},
    v = [];
   function g(e) {
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', (0, o.jsx)(a, {}), '\n', (0, o.jsx)(c, {}), '\n', (0, o.jsx)(p.ZP, {})] });
  ...
  44585: (e, n, l) => {
   ...
   const b = (e) => {
    ...
    (0, a.useEffect)(() => {
     (async () => {
      (C = await d.ZP.format(Z, { parser: f, plugins: [r.Z, t.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), D(C);
     })();
    }, [Z]);
    const z = (0, a.useId)();
    let P = a.Fragment;
  ...
  33376: (e, n, l) => {
   ...
   const d = (e) => {
    ...
    const u = 'Doen',
     ...
     _ = p ? 'figure' : 'div',
     h = p ? 'figcaption' : 'div';
    return (0, c.jsxs)(_, { className: (0, t.Z)(i['nlds-guideline'], i[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(h, { className: (0, t.Z)(i['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(r.nv, { className: (0, t.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { className: i['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: i['nlds-guideline__title'], children: m })] }), (0, c.jsx)(r.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(r.nv, { className: (0, t.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(s.Z, { className: i['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: i['nlds-guideline__title'], children: u })] }), (0, c.jsx)(r.nv, { children: n })] }), d] }), (0, c.jsx)('div', { className: (0, t.Z)(i['nlds-guideline__example']), children: a })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => i, a: () => t });
