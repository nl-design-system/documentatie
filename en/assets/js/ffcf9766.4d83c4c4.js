 ...
 [7869],
 {
  13101: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(61475),
    o = n(21998);
   const s = { title: 'Number input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number input', pagination_label: 'Number input', description: ' ', slug: '/number-input', sidebar_custom_props: { illustration: 'NumberInputSketch' } },
    a = void 0,
    u = { id: 'componenten/number-input/index', title: 'Number input', description: ' ', source: '@site/docs/componenten/number-input/index.mdx', sourceDirName: 'componenten/number-input', slug: '/number-input', permalink: '/en/number-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/number-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Number input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number input', pagination_label: 'Number input', description: ' ', slug: '/number-input', sidebar_custom_props: { illustration: 'NumberInputSketch' } }, sidebar: 'componenten', previous: { title: 'Number badge', permalink: '/en/number-badge' }, next: { title: 'Ordered list', permalink: '/en/ordered-list' } },
    l = {},
    d = [
  ...
  21998: (e, t, n) => {
   ...
   const k = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, c.Z)(f), children: [(0, l.jsxs)('div', { className: (0, c.Z)(_, { [x]: t }), children: [(0, l.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(v.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.aC, { role: 'presentation', children: n }), (0, l.jsx)(b.nv, { children: r })] })] });
    };
   var S = n(14669);
