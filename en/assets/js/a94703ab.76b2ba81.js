 ...
 [4368],
 {
  4238: (e, t, n) => {
   ...
   var a = n(50959),
    ...
    c = n(17750),
    u = n(43867);
   const h = { backToTopButton: "backToTopButton_rhom", backToTopButtonShow: "backToTopButtonShow_KWGx" };
   var m = n(11527);
   function b() {
     ...
     (0, m.jsxs)("li", {
      ...
      children: [
       (0, m.jsxs)("div", {
        ...
        children: [
         _ ? h : (0, m.jsx)(T.Z, { className: (0, i.Z)("menu__link", "utrecht-link", { "menu__link--sublist": b, "menu__link--sublist-caret": !x && b }), href: b ? v ?? "#" : v, ...c, children: h }),
         x &&
          b &&
          (0, m.jsx)(B, {
           categoryLabel: h,
       ...
       (0, m.jsx)(Z.z, { lazy: !0, as: "ul", className: "menu__list", collapsed: f, children: (0, m.jsx)(z, { items: u, tabIndex: f ? -1 : 0, onItemClick: n, activePath: o, level: l + 1 }) }),
      ],
     })
    );
   }
   ...
   function R(e) {
    ...
    return (0, m.jsx)("li", { className: (0, i.Z)(s.k.docs.docSidebarItemLink, s.k.docs.docSidebarItemLinkLevel(n), r && [E.menuHtmlItem, "menu__list-item"], l), dangerouslySetInnerHTML: { __html: o } }, a);
   }
   var W = n(3594),
    F = n(16022);
   ...
   function J(e) {
    ...
    return (0, m.jsx)("nav", { "aria-label": (0, d.I)({ id: "theme.docs.sidebar.navAriaLabel", message: "Docs sidebar", description: "The ARIA label for the sidebar navigation" }), className: (0, i.Z)("menu thin-scrollbar", Y.menu, r && Y.menuWithAnnouncementBar, o), children: (0, m.jsx)("ul", { className: (0, i.Z)(s.k.docs.docSidebarMenu, "menu__list"), children: (0, m.jsx)(z, { items: n, activePath: t, level: 1 }) }) });
   }
   ...
   function $(e) {
    return (0, m.jsx)(X.Zo, { component: Q, props: e });
   }
   const ee = a.memo($);
   function te(e) {
    const t = (0, _.i)(),
   ...
   const ae = { expandButton: "expandButton_wsNt", expandButtonIcon: "expandButtonIcon_od0Y" };
   function ie(e) {
   ...
   const oe = { docSidebarContainer: "docSidebarContainer_RRaU", docSidebarContainerHidden: "docSidebarContainerHidden_Ba4a", sidebarViewport: "sidebarViewport_cmZj" };
   function se(e) {
    let { children: t } = e;
    const n = (0, l.V)();
   ...
   const le = { docMainContainer: "docMainContainer_JR3H", docMainContainerEnhanced: "docMainContainerEnhanced_xm9w", docItemWrapperEnhanced: "docItemWrapperEnhanced_spic" };
   function de(e) {
   ...
   const ce = { docRoot: "docRoot_XKeu", docsWrapper: "docsWrapper_OsO9" };
   function ue(e) {
    let { children: t } = e;
    const n = (0, l.V)(),
     [i, o] = (0, a.useState)(!1);
