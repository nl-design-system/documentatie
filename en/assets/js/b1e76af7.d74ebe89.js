 ...
 [64796],
 {
  ...
  94091: (e, n, r) => {
   ...
   const v = (e) => {
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (D = await a.ZP.format(N, { parser: y, plugins: [l.Z, o.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), C(D);
     })();
    }, [N]);
    const S = (0, c.useId)();
    let B = c.Fragment;
    return (
     ...
     (0, p.jsxs)("div", {
      ...
      children: [
       ...
       x &&
        (0, p.jsxs)("div", {
         className: (0, t.Z)(m["nlds-canvas__code-block"], !r && m["nlds-canvas__code-block--user-select-none"]),
         id: S,
         hidden: !Z,
         children: [
