 ...
 [72755],
 {
  13038: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Heading', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading', pagination_label: 'Heading', description: 'Toont een titel en helpt de inhoud van een pagina te structureren.', slug: '/heading', sidebar_custom_props: { illustration: 'HeadingSketch' } },
    a = void 0,
    u = { id: 'componenten/heading/index', title: 'Heading', description: 'Toont een titel en helpt de inhoud van een pagina te structureren.', source: '@site/docs/componenten/heading/index.mdx', sourceDirName: 'componenten/heading', slug: '/heading', permalink: '/en/heading', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/heading/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Heading', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading', pagination_label: 'Heading', description: 'Toont een titel en helpt de inhoud van een pagina te structureren.', slug: '/heading', sidebar_custom_props: { illustration: 'HeadingSketch' } }, sidebar: 'componenten', previous: { title: 'Form field radio option', permalink: '/en/form-field-radio-option' }, next: { title: 'Heading 1', permalink: '/en/heading-1' } },
    l = {},
    d = [
    ...
    h = 'Heading',
    j = 'Toont een titel en helpt de inhoud van een pagina te structureren.',
    y = 'HeadingSketch',
    g = 114,
