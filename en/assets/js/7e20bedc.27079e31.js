(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [39783],
 {
  62184: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => a, default: () => b, description: () => j, frontMatter: () => o, illustration: () => y, issueNumber: () => g, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    s = n(60851);
   const o = { title: 'Tabs', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Tabs', pagination_label: 'Tabs', description: 'Biedt de mogelijkheid om tussen gerelateerde secties te navigeren, waarbij maar \xe9\xe9n sectie wordt weergegeven.', slug: '/tabs', sidebar_custom_props: { illustration: 'TabsSketch' } },
    a = void 0,
    u = { id: 'componenten/tabs/index', title: 'Tabs', description: 'Biedt de mogelijkheid om tussen gerelateerde secties te navigeren, waarbij maar \xe9\xe9n sectie wordt weergegeven.', source: '@site/docs/componenten/tabs/index.mdx', sourceDirName: 'componenten/tabs', slug: '/tabs', permalink: '/en/tabs', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/tabs/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Tabs', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Tabs', pagination_label: 'Tabs', description: 'Biedt de mogelijkheid om tussen gerelateerde secties te navigeren, waarbij maar \xe9\xe9n sectie wordt weergegeven.', slug: '/tabs', sidebar_custom_props: { illustration: 'TabsSketch' } }, sidebar: 'componenten', previous: { title: 'Table', permalink: '/en/table' }, next: { title: 'Task list', permalink: '/en/task-list' } },
    l = {},
    d = [
    ...
    h = 'Tabs',
    j = 'Biedt de mogelijkheid om tussen gerelateerde secties te navigeren, waarbij maar \xe9\xe9n sectie wordt weergegeven.',
    y = 'TabsSketch',
    g = 51,
   ...
   const o = (e) => {
    ...
    u = (e) => {
     ...
     const l = (e) => ('article' === a ? (0, s.jsx)('article', { ...e }) : 'section' === a ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      d = (0, s.jsx)(l, { className: (0, i.Z)(c.cardgroup__card, c[`cardgroup__card--${n}`], o), children: u });
  ...
  60851: (e, t, n) => {
   ...
   var r = n(47027),
    ...
    u = n(32636),
    l = n(52676);
   const d = { figma: (0, l.jsx)(c.Z, {}), github: (0, l.jsx)(s.Z, {}), npm: (0, l.jsx)(o.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
