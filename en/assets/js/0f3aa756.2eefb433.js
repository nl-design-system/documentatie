...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  43262: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => v, contentTitle: () => p, default: () => x, frontMatter: () => u, metadata: () => j, toc: () => f });
   var t = i(52676),
    r = i(24785),
    s = i(57716),
    l = i(71595),
   ...
   const u = { title: 'WCAG-succescriterium 1.4.9 Afbeeldingen van tekst (geen uitzondering)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.9 Afbeeldingen van tekst (geen uitzondering)', pagination_label: 'WCAG-succescriterium 1.4.9 Afbeeldingen van tekst (geen uitzondering)', description: 'Gebruik geen afbeelding voor tekstweergave, behalve als het echt niet anders kan.', slug: '1.4.9', keywords: ['WCAG'] },
    p = void 0,
    j = { id: 'wcag/1.4.09', title: 'WCAG-succescriterium 1.4.9 Afbeeldingen van tekst (geen uitzondering)', description: 'Gebruik geen afbeelding voor tekstweergave, behalve als het echt niet anders kan.', source: '@site/docs/wcag/1.4.09.mdx', sourceDirName: 'wcag', slug: '/wcag/1.4.9', permalink: '/en/wcag/1.4.9', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.09.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.4.9 Afbeeldingen van tekst (geen uitzondering)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.9 Afbeeldingen van tekst (geen uitzondering)', pagination_label: 'WCAG-succescriterium 1.4.9 Afbeeldingen van tekst (geen uitzondering)', description: 'Gebruik geen afbeelding voor tekstweergave, behalve als het echt niet anders kan.', slug: '1.4.9', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.4.8 Visuele presentatie', permalink: '/en/wcag/1.4.8' }, next: { title: 'WCAG-succescriterium 1.4.10 Reflow', permalink: '/en/wcag/1.4.10' } },
    v = {},
    f = [
