 ...
 [15104],
 {
  22024: (e, n, i) => {
   ...
   const p = { title: 'WCAG-succescriterium 3.2.3 Consistente navigatie', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.3 Consistente navigatie', pagination_label: 'WCAG-succescriterium 3.2.3 Consistente navigatie', description: "Zorg ervoor dat navigatie-componenten die voorkomen op meerdere pagina's overal op dezelfde manier werken. De navigatie staat op dezelfde plek op elke pagina, en de onderdelen staan in dezelfde volgorde.", slug: '3.2.3', keywords: ['WCAG'] },
    u = void 0,
    v = { id: 'wcag/3.2.03', title: 'WCAG-succescriterium 3.2.3 Consistente navigatie', description: "Zorg ervoor dat navigatie-componenten die voorkomen op meerdere pagina's overal op dezelfde manier werken. De navigatie staat op dezelfde plek op elke pagina, en de onderdelen staan in dezelfde volgorde.", source: '@site/docs/wcag/3.2.03.mdx', sourceDirName: 'wcag', slug: '/wcag/3.2.3', permalink: '/en/wcag/3.2.3', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.2.03.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 3.2.3 Consistente navigatie', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.3 Consistente navigatie', pagination_label: 'WCAG-succescriterium 3.2.3 Consistente navigatie', description: "Zorg ervoor dat navigatie-componenten die voorkomen op meerdere pagina's overal op dezelfde manier werken. De navigatie staat op dezelfde plek op elke pagina, en de onderdelen staan in dezelfde volgorde.", slug: '3.2.3', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.2.2 Bij input', permalink: '/en/wcag/3.2.2' }, next: { title: 'WCAG-succescriterium 3.2.4 Consistente identificatie', permalink: '/en/wcag/3.2.4' } },
    m = {},
    j = [
