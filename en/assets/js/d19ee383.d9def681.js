...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  31183: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => c, contentTitle: () => a, default: () => u, frontMatter: () => o, metadata: () => d, toc: () => h });
   var r = i(52676),
    s = i(24785),
    l = i(61663),
    t = i(54894);
   const o = { title: "WCAG-succescriterium 2.4.6 Koppen en labels", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "2.4.6 Koppen en labels", pagination_label: "WCAG-succescriterium 2.4.6 Koppen en labels", description: "Koppen en labels beschrijven het onderwerp of het doel.", slug: "2.4.6", keywords: ["WCAG"] },
    a = "WCAG-succescriterium 2.4.6 Koppen en labels",
    d = { id: "wcag/2.4.6", title: "WCAG-succescriterium 2.4.6 Koppen en labels", description: "Koppen en labels beschrijven het onderwerp of het doel.", source: "@site/docs/wcag/2.4.6.mdx", sourceDirName: "wcag", slug: "/wcag/2.4.6", permalink: "/en/wcag/2.4.6", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.6.mdx", tags: [], version: "current", frontMatter: { title: "WCAG-succescriterium 2.4.6 Koppen en labels", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "2.4.6 Koppen en labels", pagination_label: "WCAG-succescriterium 2.4.6 Koppen en labels", description: "Koppen en labels beschrijven het onderwerp of het doel.", slug: "2.4.6", keywords: ["WCAG"] }, sidebar: "richtlijnen", previous: { title: "WCAG-succescriterium 2.4.4 Linkdoel (in context)", permalink: "/en/wcag/2.4.4" }, next: { title: "2.4.7 Focus zichtbaar", permalink: "/en/wcag/2.4.7" } },
    c = {},
    h = [
