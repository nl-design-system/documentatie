 ...
 [44014],
 {
  26430: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(7617),
    o = n(63246);
   const s = { title: 'Legend', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Legend', pagination_label: 'Legend', description: ' ', slug: '/legend' },
    a = void 0,
    u = { id: 'componenten/legend/index', title: 'Legend', description: ' ', source: '@site/docs/componenten/legend/index.mdx', sourceDirName: 'componenten/legend', slug: '/legend', permalink: '/en/legend', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/legend/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Legend', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Legend', pagination_label: 'Legend', description: ' ', slug: '/legend' }, sidebar: 'componenten', previous: { title: 'Language navigation', permalink: '/en/language-navigation' }, next: { title: 'Link', permalink: '/en/link' } },
    l = {},
    d = [
