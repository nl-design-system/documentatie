   ...
   function i(e) {
    ...
    return (
     ...
     (0, r.jsx)(s.y$, {
      ...
      language: l || '',
      children: (e) => {
       let { style: l, tokens: s, getLineProps: t, getTokenProps: i } = e;
       return (0, r.jsx)(o.dn, { style: l, children: s.map((e, l) => (0, r.jsxs)('span', { ...t({ line: e }), children: [n && (0, r.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, r.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
