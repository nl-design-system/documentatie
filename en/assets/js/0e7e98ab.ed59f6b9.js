...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [15518],
 {
  ...
  6617: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => u, contentTitle: () => g, default: () => j, frontMatter: () => d, metadata: () => m, toc: () => h });
   var i = t(52676),
    r = t(24785);
   function o(e) {
   ...
   var c = t(33984);
   const d = { title: 'Houd het aanklikbare gedeelte groot genoeg | Descriptions in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Grootte aanklikbaar gedeelte', pagination_label: 'Grootte aanklikbaar gedeelte', description: 'Richtlijnen voor formaat aanklikbaar gedeelte van beschrijvingen in een formulier.', slug: '/richtlijnen/formulieren/descriptions/aanklikbaar-gedeelte', keywords: ['labels', 'formulier', 'design', 'code'] },
    g = void 0,
    m = { id: 'richtlijnen/formulieren/description/target-size/README', title: 'Houd het aanklikbare gedeelte groot genoeg | Descriptions in een formulier | Richtlijnen', description: 'Richtlijnen voor formaat aanklikbaar gedeelte van beschrijvingen in een formulier.', source: '@site/docs/richtlijnen/formulieren/description/5-target-size/README.mdx', sourceDirName: 'richtlijnen/formulieren/description/5-target-size', slug: '/richtlijnen/formulieren/descriptions/aanklikbaar-gedeelte', permalink: '/en/richtlijnen/formulieren/descriptions/aanklikbaar-gedeelte', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/description/5-target-size/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Houd het aanklikbare gedeelte groot genoeg | Descriptions in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Grootte aanklikbaar gedeelte', pagination_label: 'Grootte aanklikbaar gedeelte', description: 'Richtlijnen voor formaat aanklikbaar gedeelte van beschrijvingen in een formulier.', slug: '/richtlijnen/formulieren/descriptions/aanklikbaar-gedeelte', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Description bij fieldsets', permalink: '/en/richtlijnen/formulieren/descriptions/plaatsing-bij-fieldset' }, next: { title: 'Lengte description', permalink: '/en/richtlijnen/formulieren/descriptions/lengte' } },
    u = {},
    h = [];
   function p(e) {
