...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [9813],
 {
  24847: (e, n, t) => {
   ...
   var i = t(52676),
    l = t(24785);
   const a = { title: "Invalid form alert", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Invalid form alert", pagination_label: "Invalid form alert", description: "UX richtlijnen voor Invalid form alert component", slug: "/invalid-form-alert", tags: ["Unknown"] },
    o = "Invalid form alert",
    r = { id: "componenten/build/invalid-form-alert", title: "Invalid form alert", description: "UX richtlijnen voor Invalid form alert component", source: "@site/docs/componenten/build/invalid-form-alert.mdx", sourceDirName: "componenten/build", slug: "/invalid-form-alert", permalink: "/en/invalid-form-alert", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/invalid-form-alert.mdx", tags: [{ label: "Unknown", permalink: "/en/tags/unknown" }], version: "current", frontMatter: { title: "Invalid form alert", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Invalid form alert", pagination_label: "Invalid form alert", description: "UX richtlijnen voor Invalid form alert component", slug: "/invalid-form-alert", tags: ["Unknown"] }, sidebar: "componenten", previous: { title: "Image", permalink: "/en/image" }, next: { title: "Language navigation", permalink: "/en/language-nav" } },
    s = {},
    d = [
