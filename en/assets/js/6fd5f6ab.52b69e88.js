 ...
 [72755],
 {
  86786: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(7617),
    o = n(4460);
   const s = { title: 'Heading', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading', pagination_label: 'Heading', description: 'Koptekst die in de koppenstructuur ingesteld kan worden op het juiste niveau.', slug: '/heading' },
    a = void 0,
    u = { id: 'componenten/heading/index', title: 'Heading', description: 'Koptekst die in de koppenstructuur ingesteld kan worden op het juiste niveau.', source: '@site/docs/componenten/heading/index.mdx', sourceDirName: 'componenten/heading', slug: '/heading', permalink: '/en/heading', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/heading/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Heading', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading', pagination_label: 'Heading', description: 'Koptekst die in de koppenstructuur ingesteld kan worden op het juiste niveau.', slug: '/heading' }, sidebar: 'componenten', previous: { title: 'Form field radio option', permalink: '/en/form-field-radio-option' }, next: { title: 'Heading 1', permalink: '/en/heading-1' } },
    l = {},
    d = [
    ...
    h = 'Heading',
    j = 'Koptekst die in de koppenstructuur ingesteld kan worden op het juiste niveau.',
    y = 114,
