 ...
 [34384],
 {
  36998: (e, n, i) => {
   ...
   const g = { title: 'WCAG-succescriterium 3.3.7 Overbodige invoer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.3.7 Overbodige invoer', pagination_label: 'WCAG-succescriterium 3.3.7 Overbodige invoer', description: 'Zorg ervoor dat een gebruiker geen informatie dubbel hoeft in te vullen in een formulier.', slug: '3.3.7', keywords: ['WCAG'] },
    p = void 0,
    v = { id: 'wcag/3.3.07', title: 'WCAG-succescriterium 3.3.7 Overbodige invoer', description: 'Zorg ervoor dat een gebruiker geen informatie dubbel hoeft in te vullen in een formulier.', source: '@site/docs/wcag/3.3.07.mdx', sourceDirName: 'wcag', slug: '/wcag/3.3.7', permalink: '/en/wcag/3.3.7', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.3.07.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 3.3.7 Overbodige invoer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.3.7 Overbodige invoer', pagination_label: 'WCAG-succescriterium 3.3.7 Overbodige invoer', description: 'Zorg ervoor dat een gebruiker geen informatie dubbel hoeft in te vullen in een formulier.', slug: '3.3.7', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.3.6 Foutpreventie (alle)', permalink: '/en/wcag/3.3.6' }, next: { title: 'WCAG-succescriterium 3.3.8 Toegankelijke authenticatie (minimum)', permalink: '/en/wcag/3.3.8' } },
    m = {},
    j = [
