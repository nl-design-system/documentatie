  ...
  4460: (e, t, n) => {
   ...
   const v = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    k = (e) => {
     ...
     return (0, u.jsxs)('hgroup', { className: (0, i.Z)(v['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, u.jsx)('h1', { className: (0, i.Z)(v['nlds-inline-heading-group__heading']), children: t }), r && (0, u.jsxs)('p', { className: (0, i.Z)(v['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var b = n(46506),
    f = n(25953);
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [z]: t }), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var T = n(14669);
   const C = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => T.e9.includes(e.id)),
      a = c && T.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
    ...
    M = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(k, { level: n, suffix: c && (0, u.jsx)(p.y, { state: c }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
