 ...
 [9910],
 {
  2557: (e, t, n) => {
   ...
   const s = { title: 'Action Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Action Group', pagination_label: 'Action Group', description: 'Groepeert \xe9\xe9n of meer gerelateerde acties en verzorgt de lay-out van de content.', slug: '/action-group', keywords: ['action bar', 'action group', 'actions', 'button', 'button container', 'button dock', 'button group', 'button row', 'buttongroup', 'buttons', 'form submission', 'formulier verzenden', 'knop', 'knoppen', 'knoppenbalk', 'toolbar', 'werkbalk'] },
    a = void 0,
    u = { id: 'componenten/action-group/index', title: 'Action Group', description: 'Groepeert \xe9\xe9n of meer gerelateerde acties en verzorgt de lay-out van de content.', source: '@site/docs/componenten/action-group/index.mdx', sourceDirName: 'componenten/action-group', slug: '/action-group', permalink: '/en/action-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/action-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Action Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Action Group', pagination_label: 'Action Group', description: 'Groepeert \xe9\xe9n of meer gerelateerde acties en verzorgt de lay-out van de content.', slug: '/action-group', keywords: ['action bar', 'action group', 'actions', 'button', 'button container', 'button dock', 'button group', 'button row', 'buttongroup', 'buttons', 'form submission', 'formulier verzenden', 'knop', 'knoppen', 'knoppenbalk', 'toolbar', 'werkbalk'] }, sidebar: 'componenten', previous: { title: 'Accordion', permalink: '/en/accordion' }, next: { title: 'Alert', permalink: '/en/alert' } },
    l = {},
    d = [
   ...
   const s = (e) => {
    ...
    u = (e) => {
     ...
     const l = (e) => ('article' === a ? (0, c.jsx)('article', { ...e }) : 'section' === a ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      d = (0, c.jsx)(l, { className: (0, i.Z)(o.cardgroup__card, o[`cardgroup__card--${n}`], s), children: u });
  ...
  23952: (e, t, n) => {
   ...
   var r = n(56150),
    ...
    u = n(32636),
    l = n(52676);
   const d = { figma: (0, l.jsx)(o.Z, {}), github: (0, l.jsx)(c.Z, {}), npm: (0, l.jsx)(s.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(_), children: [(0, l.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.X6, { appearance: 'utrecht-heading-3', level: c, children: r }), o, n] })] });
    };
   var S = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const o = t && t.projects.filter((e) => S.e9.includes(e.id)),
      c = o && S.e9.map((e) => o.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
    ...
    L = (e) => {
     ...
     const o = t && S.$3[t.relayStep];
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(b.V, { level: n, suffix: o && (0, l.jsx)(m.y, { state: o }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, t, n) => {
   'use strict';
