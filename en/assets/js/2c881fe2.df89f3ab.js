(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [82200],
 {
  61983: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => g, contentTitle: () => a, default: () => v, description: () => j, frontMatter: () => o, illustration: () => y, issueNumber: () => m, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    s = n(60851);
   const o = { title: 'Ordered list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Ordered list', pagination_label: 'Ordered list', description: 'Lijst waarvan de volgorde van items betekenis heeft.', slug: '/ordered-list', sidebar_custom_props: { illustration: 'OrderedListSketch' } },
    a = void 0,
    l = { id: 'componenten/ordered-list/index', title: 'Ordered list', description: 'Lijst waarvan de volgorde van items betekenis heeft.', source: '@site/docs/componenten/ordered-list/index.mdx', sourceDirName: 'componenten/ordered-list', slug: '/ordered-list', permalink: '/en/ordered-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/ordered-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Ordered list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Ordered list', pagination_label: 'Ordered list', description: 'Lijst waarvan de volgorde van items betekenis heeft.', slug: '/ordered-list', sidebar_custom_props: { illustration: 'OrderedListSketch' } }, sidebar: 'componenten', previous: { title: 'Number input', permalink: '/en/number-input' }, next: { title: 'Page footer', permalink: '/en/page-footer' } },
    u = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const D = (e) => {
     ...
     const c = t && t.projects.filter((e) => L.e9.includes(e.id)),
      s = c && L.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: s.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], y[`definition-of-done--${(0, L.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
         ...
         children: [
          (0, u.jsx)(S, {
           children: e.tasks.map((e) => {
            ...
            return (0, u.jsx)(z, { checked: t, title: n, description: (0, L.Q6)(r) }, r);
           }),
          }),
