...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [75524],
 {
  13455: (e, l, o) => {
   ...
   const p = (e) => {
     let { target: l } = e;
     const o = l.getAttribute("aria-controls"),
      n = l.ownerDocument.getElementById(o);
     (n.hidden = !n.hidden), l.setAttribute("aria-expanded", !n.hidden), (l.innerText = n.hidden ? "Bekijk code" : "Verberg code");
    },
    h = (e) => {
     let { code: l, copy: o = !1, defaultCollapsed: r = !1, children: i, language: s } = e;
     ...
     return n.createElement(
      ...
      n.createElement("div", { className: (0, t.Z)(a["nlds-canvas__toolbar"]) }, n.createElement(u.zx, { className: (0, t.Z)(a["nlds-canvas__button"], a["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: p, "aria-expanded": !r, "aria-controls": _ }, r ? "Bekijk code" : "Verberg code")),
      n.createElement(
       "div",
       { className: (0, t.Z)(a["nlds-canvas__code-block"], !o && a["nlds-canvas__code-block--user-select-none"]), id: _, hidden: r },
       n.createElement(b.Z, { language: s, style: v }, h),
       o &&
        n.createElement(
         "div",
  ...
  31092: (e, l, o) => {
   ...
   var d = o(86010),
    i = o(65663);
   const c = (e) => {
    let { title: l, appearance: o, description: c, children: s } = e;
    const k = { do: "Doen", dont: "Niet doen" },
     m = l ? `${k[o]}: ${l}` : k[o];
    return n.createElement("div", { className: (0, d.Z)(r["nlds-guideline"], r[`nlds-guideline--${o}`]), id: null == l ? void 0 : l.toLowerCase().replace(/\s/g, "-") }, n.createElement("div", { className: (0, d.Z)(r["nlds-guideline__description"]) }, "dont" === o ? n.createElement(i.nv, { className: (0, d.Z)(r["nlds-guideline__badge"], r[`nlds-guideline__badge--${o}`]) }, n.createElement(a.Z, { className: r["nlds-guideline__icon"] }), n.createElement("span", { className: r["nlds-guideline__title"] }, m)) : n.createElement(i.nv, { className: (0, d.Z)(r["nlds-guideline__badge"], r[`nlds-guideline__badge--${o}`]) }, n.createElement(t.Z, { className: r["nlds-guideline__icon"] }), n.createElement("span", { className: r["nlds-guideline__title"] }, m)), c), n.createElement("div", { className: (0, d.Z)(r["nlds-guideline__example"]) }, s));
   };
  },
  88490: (e, l, o) => {
   o.r(l), o.d(l, { assets: () => m, contentTitle: () => s, default: () => g, frontMatter: () => c, metadata: () => k, toc: () => b });
   var n = o(87462),
    a = o(67294),
    t = o(3905),
    r = o(13455),
