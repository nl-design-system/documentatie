...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  44010: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => a, contentTitle: () => o, default: () => j, frontMatter: () => l, metadata: () => d, toc: () => h });
   var t = i(52676),
    r = i(24785),
    s = i(21004),
    c = i(55400);
   const l = { title: 'Introductie \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Introductie', sidebar_position: 1, pagination_label: 'Introductie', description: 'Introductie richtlijnen NL Design System', slug: '/richtlijnen', keywords: ['richtlijnen', 'design system', 'documentatie'] },
  ...
  21004: (e, n, i) => {
   ...
   const l = (e, n) => e.reduce((e, i) => ('link' === i.type ? (n.includes(i.docId) ? e : [...e, i]) : 'category' === i.type ? [...e, { ...i, items: l(i.items, n) }] : e), []),
    o = (e) => {
     ...
     const d = (0, t.jA)();
     return (0, c.jsx)('div', { ...o, className: (0, r.Z)('margin-top--lg', i), children: (0, c.jsx)(s.Z, { items: l(d.items, n) }) });
    };
  },
  20537: (e, n, i) => {
   i.d(n, { Z: () => m });
   ...
   function d(e) {
    ...
    return (0, o.jsxs)('div', { className: (0, c.Z)('card', l.card), children: [n ? (0, o.jsx)(r.Z, { href: n, className: (0, c.Z)(l.cardLink, 'utrecht-link'), children: (0, o.jsxs)('h2', { className: (0, c.Z)(l.cardTitle), children: [i, ' ', t] }) }) : (0, o.jsxs)('h2', { className: (0, c.Z)(l.cardTitle), children: [i, ' ', t] }), s && (0, o.jsx)('p', { className: (0, c.Z)(l.cardDescription), children: s }), d] });
   }
   function a(e) {
    let { item: n } = e;
   ...
   function m(e) {
    ...
    const r = (0, t.MN)(n);
    return (0, o.jsx)('section', { className: (0, c.Z)('row', i), children: r.map((e, n) => (0, o.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, o.jsx)(u, { item: e }) }, n)) });
   }
  },
  24785: (e, n, i) => {
   i.d(n, { Z: () => l, a: () => c });
