...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [8794],
 {
  11767: (e, n, i) => {
   ...
   const u = { title: 'WCAG-succescriterium 1.3.4 Weergavestand', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.4 Weergavestand', pagination_label: 'WCAG-succescriterium 1.3.4 Weergavestand', description: 'Zorg ervoor dat een gebruiker het scherm niet fysiek hoeft te draaien om de inhoud van de webpagina te goed kunnen zien. Je moet een de website kunnen bekijken in zowel landschap-modus als in portret-modus.', slug: '1.3.4', keywords: ['WCAG'] },
    p = void 0,
    m = { id: 'wcag/1.3.04', title: 'WCAG-succescriterium 1.3.4 Weergavestand', description: 'Zorg ervoor dat een gebruiker het scherm niet fysiek hoeft te draaien om de inhoud van de webpagina te goed kunnen zien. Je moet een de website kunnen bekijken in zowel landschap-modus als in portret-modus.', source: '@site/docs/wcag/1.3.04.mdx', sourceDirName: 'wcag', slug: '/wcag/1.3.4', permalink: '/en/wcag/1.3.4', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.3.04.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.3.4 Weergavestand', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.4 Weergavestand', pagination_label: 'WCAG-succescriterium 1.3.4 Weergavestand', description: 'Zorg ervoor dat een gebruiker het scherm niet fysiek hoeft te draaien om de inhoud van de webpagina te goed kunnen zien. Je moet een de website kunnen bekijken in zowel landschap-modus als in portret-modus.', slug: '1.3.4', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.3.3 Zintuiglijke eigenschappen', permalink: '/en/wcag/1.3.3' }, next: { title: 'WCAG-succescriterium 1.3.5 Identificeer het doel van de input', permalink: '/en/wcag/1.3.5' } },
    j = {},
    v = [
  ...
  72657: (e, n, i) => {
   ...
   var s = i(52676);
   const a = (e) => {
    let { children: n, className: i, level: a = 1, suffix: o, ...d } = e;
    return (0, s.jsxs)('hgroup', { className: (0, t.Z)(r['nlds-inline-heading-group'], `utrecht-heading-${a}`, i), ...d, children: [(0, s.jsx)('h1', { className: (0, t.Z)(r['nlds-inline-heading-group__heading']), children: n }), o && (0, s.jsxs)('p', { className: (0, t.Z)(r['nlds-inline-heading-group__suffix']), children: [o ? ' ' : '', o] })] });
   };
  },
  57716: (e, n, i) => {
   i.d(n, { U: () => c });
   ...
   const a = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, s.jsx)(t.Z, { components: { ...l(i, r), ...d(a) }, children: n });
    };
  },
  71595: (e, n, i) => {
   i.d(n, { j: () => d });
   ...
   const d = (e) => {
    ...
    return (0, o.jsx)(r.V, { className: s, suffix: i && (0, o.jsx)(t.Ou, { className: a, children: i }), ...d, children: n });
   };
  },
  24785: (e, n, i) => {
   i.d(n, { Z: () => o, a: () => a });
