 ...
 [34384],
 {
  36998: (e, n, i) => {
   ...
   function d(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Zorg ervoor dat een gebruiker geen informatie dubbel hoeft in te vullen in een formulier.' }), '\n', (0, r.jsx)(n.p, { children: 'Informatie die al eerder is ingevoerd door of aangeboden aan de gebruiker en opnieuw moet worden ingevoerd in bijvoorbeeld hetzelfde formulier is:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: 'automatisch ingevuld, of' }), '\n', (0, r.jsx)(n.li, { children: 'beschikbaar voor de gebruiker om te selecteren.' }), '\n'] }), '\n', (0, r.jsx)(n.p, { children: 'Behalve wanneer:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: 'opnieuw invoeren van de informatie essentieel is,' }), '\n', (0, r.jsx)(n.li, { children: 'de dubbele informatie nodig is om de veiligheid te waarborgen, of' }), '\n', (0, r.jsx)(n.li, { children: 'eerder ingevoerde informatie niet langer geldig is.' }), '\n'] }), '\n', (0, r.jsx)(n.p, { children: 'Dit maakt het voor alle gebruikers makkelijker om gegevens door te geven, maar speciaal voor mensen die niet goed lezen, typen of onthouden.' })] });
   }
   function a(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(d, { ...e }) }) : d(e);
   }
   const c = { title: 'WCAG-succescriterium 3.3.7 Overbodige invoer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.3.7 Overbodige invoer', pagination_label: 'WCAG-succescriterium 3.3.7 Overbodige invoer', description: 'Zorg ervoor dat een gebruiker geen informatie dubbel hoeft in te vullen in een formulier.', slug: '3.3.7', keywords: ['WCAG'] },
    u = void 0,
    g = { id: 'wcag/3.3.07', title: 'WCAG-succescriterium 3.3.7 Overbodige invoer', description: 'Zorg ervoor dat een gebruiker geen informatie dubbel hoeft in te vullen in een formulier.', source: '@site/docs/wcag/3.3.07.mdx', sourceDirName: 'wcag', slug: '/wcag/3.3.7', permalink: '/en/wcag/3.3.7', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.3.07.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 3.3.7 Overbodige invoer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.3.7 Overbodige invoer', pagination_label: 'WCAG-succescriterium 3.3.7 Overbodige invoer', description: 'Zorg ervoor dat een gebruiker geen informatie dubbel hoeft in te vullen in een formulier.', slug: '3.3.7', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.3.4 Foutpreventie (wettelijk, financieel, gegevens)', permalink: '/en/wcag/3.3.4' }, next: { title: 'WCAG-succescriterium 3.3.8 Toegankelijke authenticatie (minimum)', permalink: '/en/wcag/3.3.8' } },
    h = {},
    p = [
