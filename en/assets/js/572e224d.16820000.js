...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [58936],
 {
  ...
  11566: (e, n, o) => {
   ...
   var a = o(55400);
   const d = { title: 'Zorg ook bij iconen voor voldoende contrast | Iconen | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Zorg voor voldoende contrast', pagination_label: 'Zorg ook bij iconen voor voldoende contrast', description: 'Gebruik je een icoon zonder tekst? Maak het contrast tussen de voor- en achtergrondkleur 3:1 of groter. Tenzij het icoon puur decoratief is.', slug: '/richtlijnen/stijl/iconen/kleurcontrast-iconen', keywords: ['iconen'] },
    h = 'Zorg ook bij iconen voor voldoende contrast',
    u = { id: 'richtlijnen/stijl/icons/colour-contrast/README', title: 'Zorg ook bij iconen voor voldoende contrast | Iconen | Richtlijnen', description: 'Gebruik je een icoon zonder tekst? Maak het contrast tussen de voor- en achtergrondkleur 3:1 of groter. Tenzij het icoon puur decoratief is.', source: '@site/docs/richtlijnen/stijl/icons/6-colour-contrast/README.mdx', sourceDirName: 'richtlijnen/stijl/icons/6-colour-contrast', slug: '/richtlijnen/stijl/iconen/kleurcontrast-iconen', permalink: '/en/richtlijnen/stijl/iconen/kleurcontrast-iconen', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/stijl/icons/6-colour-contrast/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Zorg ook bij iconen voor voldoende contrast | Iconen | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Zorg voor voldoende contrast', pagination_label: 'Zorg ook bij iconen voor voldoende contrast', description: 'Gebruik je een icoon zonder tekst? Maak het contrast tussen de voor- en achtergrondkleur 3:1 of groter. Tenzij het icoon puur decoratief is.', slug: '/richtlijnen/stijl/iconen/kleurcontrast-iconen', keywords: ['iconen'] }, sidebar: 'richtlijnen', previous: { title: 'Laat de lijndikte meeschalen', permalink: '/en/richtlijnen/stijl/iconen/lijndikte-iconen' }, next: { title: 'Respecteer conventies', permalink: '/en/richtlijnen/stijl/iconen/respecteer-conventies' } },
    j = {},
    m = [];
   function g(e) {
