(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [7869],
 {
  47671: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => g, contentTitle: () => a, default: () => b, description: () => j, frontMatter: () => s, illustration: () => m, issueNumber: () => y, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Number input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number input', pagination_label: 'Number input', description: 'Invoerveld voor een heel getal of een getal met decimalen.', slug: '/number-input', sidebar_custom_props: { illustration: 'NumberInputSketch' } },
    a = void 0,
    u = { id: 'componenten/number-input/index', title: 'Number input', description: 'Invoerveld voor een heel getal of een getal met decimalen.', source: '@site/docs/componenten/number-input/index.mdx', sourceDirName: 'componenten/number-input', slug: '/number-input', permalink: '/en/number-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/number-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Number input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number input', pagination_label: 'Number input', description: 'Invoerveld voor een heel getal of een getal met decimalen.', slug: '/number-input', sidebar_custom_props: { illustration: 'NumberInputSketch' } }, sidebar: 'componenten', previous: { title: 'Number badge', permalink: '/en/number-badge' }, next: { title: 'Ordered list', permalink: '/en/ordered-list' } },
    l = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(N, { [w]: t }), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(k.aC, { role: 'presentation', children: n }), (0, l.jsx)(k.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(m['definition-of-done'], m[`definition-of-done--${(0, D.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
