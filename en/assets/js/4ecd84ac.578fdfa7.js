(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [54942],
 {
  99598: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => g, contentTitle: () => a, default: () => b, description: () => j, frontMatter: () => o, illustration: () => y, issueNumber: () => m, metadata: () => u, title: () => d, toc: () => h });
   var r = n(52676),
    c = n(24785),
    i = n(31612),
    s = n(16391);
   ...
   const z = Object.keys({ HELP_WANTED: 'UNKNOWN', COMMUNITY: 'HELP_WANTED', CANDIDATE: 'COMMUNITY', HALL_OF_FAME: 'CANDIDATE' }),
    D = (e) => {
     ...
     const i = t && t.projects.filter((e) => z.includes(e.id)),
      s = i && z.map((e) => i.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
