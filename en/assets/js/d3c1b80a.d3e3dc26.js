 ...
 [58441],
 {
  36265: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(61475),
    o = n(21998);
   const s = { title: 'Avatar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Avatar', pagination_label: 'Avatar', description: ' ', slug: '/avatar', sidebar_custom_props: { illustration: 'AvatarSketch' } },
    a = void 0,
    u = { id: 'componenten/avatar/index', title: 'Avatar', description: ' ', source: '@site/docs/componenten/avatar/index.mdx', sourceDirName: 'componenten/avatar', slug: '/avatar', permalink: '/en/avatar', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/avatar/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Avatar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Avatar', pagination_label: 'Avatar', description: ' ', slug: '/avatar', sidebar_custom_props: { illustration: 'AvatarSketch' } }, sidebar: 'componenten', previous: { title: 'Alert dialog', permalink: '/en/alert-dialog' }, next: { title: 'Blockquote', permalink: '/en/blockquote' } },
    l = {},
    d = [
