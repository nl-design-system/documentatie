  ...
  4460: (e, t, n) => {
   ...
   const v = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    b = (e) => {
     ...
     return (0, l.jsxs)('hgroup', { className: (0, i.Z)(v['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, l.jsx)('h1', { className: (0, i.Z)(v['nlds-inline-heading-group__heading']), children: t }), r && (0, l.jsxs)('p', { className: (0, i.Z)(v['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var f = n(46506),
    k = n(25953);
   const _ = 'task-list_hh8j',
    ...
    D = (e) => {
     let { children: t } = e;
     return (0, l.jsx)('ul', { className: _, children: t });
    },
    z = (e) => {
     let { checked: t, title: n, description: r } = e;
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(f.aC, { role: 'presentation', children: n }), (0, l.jsx)(f.nv, { children: r })] })] });
    };
   var S = n(14669);
   const T = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => S.e9.includes(e.id)),
      o = c && S.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, l.jsx)(D, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(z, { checked: t, title: n, description: (0, S.Q6)(r) }, r);
            }),
           }),
    ...
    M = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(b, { level: n, suffix: c && (0, l.jsx)(p.y, { state: c }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
