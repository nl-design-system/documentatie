 ...
 [90258],
 {
  47202: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Language navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Language navigation', pagination_label: 'Language navigation', description: 'Biedt de optie om een andere taal te selecteren.', slug: '/language-navigation', sidebar_custom_props: { illustration: 'LanguageNavigationSketch' } },
    a = void 0,
    u = { id: 'componenten/language-navigation/index', title: 'Language navigation', description: 'Biedt de optie om een andere taal te selecteren.', source: '@site/docs/componenten/language-navigation/index.mdx', sourceDirName: 'componenten/language-navigation', slug: '/language-navigation', permalink: '/en/language-navigation', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/language-navigation/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Language navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Language navigation', pagination_label: 'Language navigation', description: 'Biedt de optie om een andere taal te selecteren.', slug: '/language-navigation', sidebar_custom_props: { illustration: 'LanguageNavigationSketch' } }, sidebar: 'componenten', previous: { title: 'Invalid form alert', permalink: '/en/invalid-form-alert' }, next: { title: 'Legend', permalink: '/en/legend' } },
    l = {},
    d = [
    ...
    j = 'Biedt de optie om een andere taal te selecteren.',
    g = 'LanguageNavigationSketch',
    y = 243,
