(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [44275],
 {
  72934: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => a, default: () => v, description: () => j, frontMatter: () => s, illustration: () => g, issueNumber: () => y, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Alert dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Alert dialog', pagination_label: 'Alert dialog', description: 'Opent een venster waarin de gebruiker een actie moet uitvoeren om verder te gaan. De rest van de pagina is tijdelijk geblokkeerd.', slug: '/alert-dialog', sidebar_custom_props: { illustration: 'AlertDialogSketch' }, keywords: ['actie', 'action', 'alert', 'bevestigen', 'blocking', 'blokkeren', 'choice', 'confirm', 'continue', 'dialog', 'dialoogvenster', 'doorgaan', 'keuze', 'modal', 'urgent', 'venster', 'waarschuwing'] },
    a = void 0,
   ...
   const T = (e) => {
     ...
     return (
      ...
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(g['definition-of-done'], g[`definition-of-done--${(0, S.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
