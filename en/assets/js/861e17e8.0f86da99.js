(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [43396],
 {
  90613: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => o, issueNumber: () => y, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(87176),
    s = n(90786);
   const o = { title: 'Description List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Description List', pagination_label: 'Description List', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', slug: '/description-list' },
    a = void 0,
    l = { id: 'componenten/definition-list/index', title: 'Description List', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', source: '@site/docs/componenten/definition-list/index.mdx', sourceDirName: 'componenten/definition-list', slug: '/description-list', permalink: '/en/description-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/definition-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Description List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Description List', pagination_label: 'Description List', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', slug: '/description-list' }, sidebar: 'componenten', previous: { title: 'Date Picker', permalink: '/en/date-picker' }, next: { title: 'Dot Badge', permalink: '/en/dot-badge' } },
    u = {},
    d = [
  ...
  90786: (e, t, n) => {
   ...
   const N = (e) => {
    ...
    z = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(b.V, { level: n, suffix: c && (0, u.jsx)(p.y, { state: c }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, t, n) => {
   'use strict';
