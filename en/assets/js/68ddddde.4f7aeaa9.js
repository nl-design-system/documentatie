(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [5643],
 {
  9824: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => o, issueNumber: () => g, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(80719),
    s = n(90786);
   const o = { title: 'Skip link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Skip link', pagination_label: 'Skip link', description: 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.', slug: '/skip-link' },
    a = void 0,
    l = { id: 'componenten/skip-link/index', title: 'Skip link', description: 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.', source: '@site/docs/componenten/skip-link/index.mdx', sourceDirName: 'componenten/skip-link', slug: '/skip-link', permalink: '/en/skip-link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/skip-link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Skip link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Skip link', pagination_label: 'Skip link', description: 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.', slug: '/skip-link' }, sidebar: 'componenten', previous: { title: 'Side navigation', permalink: '/en/side-navigation' }, next: { title: 'Spinner', permalink: '/en/spinner' } },
    u = {},
    d = [
    ...
    h = 'Skip link',
    j = 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.',
    g = 74,
  ...
  68963: (e, t, n) => {
   ...
   const o = (e) => {
     ...
     return (0, s.jsx)('div', { className: (0, i.Z)(c.card__illustration, t && c['card__illustration--background'], r), ...o, children: n });
    },
    a = (e) => (0, s.jsx)('div', { className: (0, i.Z)(c.card__content), ...e }),
    l = (e) => {
     let { href: t, appearance: n, className: o, component: a = 'div', children: l } = e;
     const u = (e) => ('article' === a ? (0, s.jsx)('article', { ...e }) : 'section' === a ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      d = (0, s.jsx)(u, { className: (0, i.Z)(c.cardgroup__card, c[`cardgroup__card--${n}`], o), children: l });
     return t ? (0, s.jsx)(r.rU, { href: t, boxContent: !0, className: c.cardgroup__link, children: d }) : d;
    },
    u = (e) => {
     let { appearance: t = 'medium', children: n, className: r } = e;
     return (0, s.jsx)('div', { className: (0, i.Z)(c.cardgroup, c[`cardgroup--${t}`], r), children: n });
    };
  },
  90786: (e, t, n) => {
   'use strict';
   n.d(t, { cN: () => N, vM: () => A, W: () => S, Rv: () => z });
   var r = n(56150),
    i = n(4814),
    c = (n(75271), n(39854)),
    s = n(7522),
    ...
    l = n(32636),
    u = n(52676);
   const d = { figma: (0, u.jsx)(c.Z, {}), github: (0, u.jsx)(s.Z, {}), npm: (0, u.jsx)(o.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const N = (e) => {
     ...
     const c = t && t.projects.filter((e) => w.e9.includes(e.id)),
      s = c && w.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
  ...
  72657: (e, t, n) => {
   ...
   const s = (e) => {
    ...
    return (0, c.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${s}`, n), ...a, children: [(0, c.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: t }), o && (0, c.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [o ? ' ' : '', o] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
