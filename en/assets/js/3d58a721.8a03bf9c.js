 ...
 [9591],
 {
  54593: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(61475),
    o = n(21998);
   const s = { title: 'Date input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date input group', pagination_label: 'Date input group', description: ' ', slug: '/date-input-group', sidebar_custom_props: { illustration: 'DateInputGroupSketch' } },
    a = void 0,
    u = { id: 'componenten/date-input-group/index', title: 'Date input group', description: ' ', source: '@site/docs/componenten/date-input-group/index.mdx', sourceDirName: 'componenten/date-input-group', slug: '/date-input-group', permalink: '/en/date-input-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-input-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Date input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date input group', pagination_label: 'Date input group', description: ' ', slug: '/date-input-group', sidebar_custom_props: { illustration: 'DateInputGroupSketch' } }, sidebar: 'componenten', previous: { title: 'Date input', permalink: '/en/date-input' }, next: { title: 'Date picker', permalink: '/en/date-picker' } },
    l = {},
    d = [
