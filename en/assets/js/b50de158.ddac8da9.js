(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [12505],
 {
  41697: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => a, default: () => v, description: () => j, frontMatter: () => s, illustration: () => g, issueNumber: () => y, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Side navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Side navigation', pagination_label: 'Side navigation', description: 'Toont een hi\xebrarchische, verticale navigatie aan de zijkant van een pagina.', slug: '/side-navigation', sidebar_custom_props: { illustration: 'SideNavigationSketch' } },
    a = void 0,
    u = { id: 'componenten/side-navigation/index', title: 'Side navigation', description: 'Toont een hi\xebrarchische, verticale navigatie aan de zijkant van een pagina.', source: '@site/docs/componenten/side-navigation/index.mdx', sourceDirName: 'componenten/side-navigation', slug: '/side-navigation', permalink: '/en/side-navigation', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/side-navigation/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Side navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Side navigation', pagination_label: 'Side navigation', description: 'Toont een hi\xebrarchische, verticale navigatie aan de zijkant van een pagina.', slug: '/side-navigation', sidebar_custom_props: { illustration: 'SideNavigationSketch' } }, sidebar: 'componenten', previous: { title: 'Separator', permalink: '/en/separator' }, next: { title: 'Skip link', permalink: '/en/skip-link' } },
    l = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(N, { [S]: t }), children: [(0, l.jsx)('span', { className: w, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.aC, { role: 'presentation', children: n }), (0, l.jsx)(b.nv, { children: r })] })] });
    };
   var T = n(14669);
   const D = (e) => {
         ...
         children: [
          (0, l.jsx)(z, {
           children: e.tasks.map((e) => {
            ...
            return (0, l.jsx)(A, { checked: t, title: n, description: (0, T.Q6)(r) }, r);
           }),
          }),
