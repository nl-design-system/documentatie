 ...
 [97979],
 {
  17687: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    o = n(60851);
   const s = { title: 'Textarea', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Textarea', pagination_label: 'Textarea', description: 'Invoerveld voor het bewerken van meerdere regels tekst.', slug: '/textarea', sidebar_custom_props: { illustration: 'TextAreaSketch' } },
    a = void 0,
    u = { id: 'componenten/textarea/index', title: 'Textarea', description: 'Invoerveld voor het bewerken van meerdere regels tekst.', source: '@site/docs/componenten/textarea/index.mdx', sourceDirName: 'componenten/textarea', slug: '/textarea', permalink: '/en/textarea', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/textarea/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Textarea', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Textarea', pagination_label: 'Textarea', description: 'Invoerveld voor het bewerken van meerdere regels tekst.', slug: '/textarea', sidebar_custom_props: { illustration: 'TextAreaSketch' } }, sidebar: 'componenten', previous: { title: 'Text input group', permalink: '/en/text-input-group' }, next: { title: 'Toggletip', permalink: '/en/toggletip' } },
    l = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, c.Z)(x), children: [(0, l.jsxs)('div', { className: (0, c.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: T, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(k.aC, { role: 'presentation', children: n }), (0, l.jsx)(k.nv, { children: r })] })] });
    };
   var z = n(14669);
   const D = (e) => {
