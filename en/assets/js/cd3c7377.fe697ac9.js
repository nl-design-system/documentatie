(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [25425],
 {
  99766: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => s, issueNumber: () => y, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(7617),
    o = n(4460);
   const s = { title: 'Form field description', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field description', pagination_label: 'Form field description', description: 'Toont ondersteunende tekst en biedt extra context over de in te vullen informatie.', slug: '/form-field-description' },
    a = void 0,
    l = { id: 'componenten/form-field-description/index', title: 'Form field description', description: 'Toont ondersteunende tekst en biedt extra context over de in te vullen informatie.', source: '@site/docs/componenten/form-field-description/index.mdx', sourceDirName: 'componenten/form-field-description', slug: '/form-field-description', permalink: '/en/form-field-description', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-field-description/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form field description', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field description', pagination_label: 'Form field description', description: 'Toont ondersteunende tekst en biedt extra context over de in te vullen informatie.', slug: '/form-field-description' }, sidebar: 'componenten', previous: { title: 'Form field checkbox option', permalink: '/en/form-field-checkbox-option' }, next: { title: 'Form field error message', permalink: '/en/form-field-error-message' } },
    u = {},
    d = [
    ...
    j = 'Toont ondersteunende tekst en biedt extra context over de in te vullen informatie.',
    y = 174,
   ...
   const D = (e) => {
     ...
     return (
      ...
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], e && y[`definition-of-done--${(0, T.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
