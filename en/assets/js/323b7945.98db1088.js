  ...
  82415: (e, t, n) => {
   ...
   const l = (e) => {
    ...
    return (0, r.jsxs)("form", {
     ...
     children: [(0, r.jsxs)(a.Wi, { type: "email", children: [(0, r.jsx)(a.nv, { children: (0, r.jsx)(a.lX, { htmlFor: `id-${d}`, children: "E-mailadres" }) }), j[d] && (0, r.jsx)(a.w7, { children: j[d].message }), (0, r.jsx)(a.nv, { children: (0, r.jsx)(a.fE, { id: `id-${d}`, name: d, type: "email", autoComplete: "email", "aria-required": "true", ...p(`${d}`, { required: { value: !0, message: "Dit veld is verplicht, maar het is niet ingevuld." }, pattern: { value: /\S+@\S+\.\S+/, message: "Dit is geen correct emailadres." } }), invalid: !!j[d] }) })] }), (0, r.jsxs)(a.Wi, { type: "text", children: [(0, r.jsx)(a.nv, { children: (0, r.jsx)(a.lX, { htmlFor: o, children: "Naam" }) }), j[o] && (0, r.jsx)(a.w7, { children: j[o].message }), (0, r.jsx)(a.nv, { children: (0, r.jsx)(a.fE, { id: o, name: o, type: "text", autoComplete: "given-name", "aria-required": "true", ...p(`${o}`, { required: { value: !0, message: "Dit veld is verplicht, maar het is niet ingevuld." } }), invalid: !!j[o] }) })] }), m && (0, r.jsxs)(a.Wi, { type: "text", children: [(0, r.jsx)(a.nv, { children: (0, r.jsx)(a.lX, { htmlFor: m, children: "Organisatie" }) }), j[m] && (0, r.jsx)(a.w7, { children: j[m].message }), (0, r.jsx)(a.nv, { children: (0, r.jsx)(a.fE, { id: m, name: m, type: "text", "aria-required": "true", ...p(`${m}`, { required: { value: !0, message: "Dit veld is verplicht, maar het is niet ingevuld." } }), invalid: !!j[m] }) })] }), c && (0, r.jsxs)(a.pg, { children: [(0, r.jsx)(a.Qv, { children: "Waar wil je NL Design System voor gebruiken? (niet verplicht)" }), (0, r.jsx)(a.ue, { children: "Meerdere antwoorden mogelijk." }), h.map((e, t) => (0, r.jsx)(a.Wi, { type: "checkbox", children: (0, r.jsxs)(a.nv, { children: [(0, r.jsx)(a.XZ, { name: `${c}[]`, value: t >= 6 ? t + 2 : t + 1, id: `${c}-${t + 1}` }), (0, r.jsx)(a.lX, { htmlFor: `${c}-${t + 1}`, children: e })] }) }, e))] }), u && (0, r.jsxs)(a.Wi, { type: "text", children: [(0, r.jsxs)(a.nv, { children: [(0, r.jsx)(a.lX, { htmlFor: u, children: "Aan wat voor projecten werk je? (niet verplicht)" }), (0, r.jsx)(a.ue, { children: "Denk aan mijn-omgevingen, formulieren en/of kaarten." })] }), (0, r.jsx)(a.nv, { children: (0, r.jsx)(a.gx, { id: u, name: u }) })] }), (0, r.jsx)(a.hE, { children: (0, r.jsx)(a.zx, { type: "submit", appearance: "primary-action-button", children: "Aanmelden" }) }), (0, r.jsx)("input", { type: "hidden", name: "next", value: l }), (0, r.jsx)("input", { type: "hidden", name: "a", value: n }), (0, r.jsx)("input", { type: "hidden", name: "l", value: t }), (0, r.jsx)("input", { name: "osnD9cWRI3", autoComplete: "on", id: "id-osnD9cWRI3", type: "hidden", value: "NLDS website" }), (0, r.jsx)("input", { autoComplete: "new-password", type: "email", id: "email", name: "email", placeholder: "Your e-mail here", className: "sr-only", "aria-hidden": "true" })],
    });
   };
  },
  24785: (e, t, n) => {
