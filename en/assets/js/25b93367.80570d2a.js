 ...
 [98634],
 {
  29416: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.', slug: '/link', sidebar_custom_props: { illustration: 'LinkSketch' } },
    a = void 0,
    l = { id: 'componenten/link/index', title: 'Link', description: 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.', source: '@site/docs/componenten/link/index.mdx', sourceDirName: 'componenten/link', slug: '/link', permalink: '/en/link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.', slug: '/link', sidebar_custom_props: { illustration: 'LinkSketch' } }, sidebar: 'componenten', previous: { title: 'Legend', permalink: '/en/legend' }, next: { title: 'Link list', permalink: '/en/link-list' } },
    u = {},
    d = [
