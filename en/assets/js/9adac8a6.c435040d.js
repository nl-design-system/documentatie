 ...
 [79871],
 {
  ...
  66771: (e, n, l) => {
   ...
   const _ = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (z = await c.ZP.format(Z, { parser: y, plugins: [s.Z, i.ZP, o.ZP, r.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(z);
     })();
    }, [Z]);
    const F = (0, d.useId)();
    let D = d.Fragment;
