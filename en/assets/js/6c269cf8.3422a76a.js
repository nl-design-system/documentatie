/*! For license information please see 6c269cf8.3422a76a.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [12356],
 {
  ...
  41179: (e, L, l) => {
   ...
   var r = l(52676);
   function s(e) {
    let { lineNumber: L, syntax: l, textContent: s, trim: a } = e,
     c = s;
    return (
     a && (c = c.trim()),
     (0, r.jsx)(t.y$, {
      ...
      language: l || '',
      children: (e) => {
       let { style: l, tokens: t, getLineProps: o, getTokenProps: s } = e;
       return (0, r.jsx)(n.dn, { style: l, children: t.map((e, l) => (0, r.jsxs)('span', { ...o({ line: e }), children: [L && (0, r.jsx)('span', { children: l + 1 }), e.map((e, L) => (0, r.jsx)('span', { ...s({ token: e }) }, L)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, L, l) => {
   ...
   const c = (e) => {
    ...
    const u = 'Doen',
     ...
     m = d ? 'figure' : 'div',
     v = d ? 'figcaption' : 'div';
    return (0, a.jsxs)(m, { className: (0, r.Z)(s['nlds-guideline'], s[`nlds-guideline--${l}`]), id: 'string' == typeof L ? L?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(v, { className: (0, r.Z)(s['nlds-guideline__description']), children: ['dont' === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(o.nv, { className: (0, r.Z)(s['nlds-guideline__badge'], s[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(n.Z, { className: s['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: s['nlds-guideline__title'], children: p })] }), (0, a.jsx)(o.nv, { children: L })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(o.nv, { className: (0, r.Z)(s['nlds-guideline__badge'], s[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(t.Z, { className: s['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: s['nlds-guideline__title'], children: u })] }), (0, a.jsx)(o.nv, { children: L })] }), c] }), (0, a.jsx)('div', { className: (0, r.Z)(s['nlds-guideline__example']), children: i })] });
   };
  },
  89011: (e, L, l) => {
   ...
   const d = (e) => {
    ...
    return (0, i.jsxs)('dl', { className: c['contrast-ratio'], children: [(0, i.jsxs)('div', { className: c['contrast-ratio__result'], children: [(0, i.jsx)('dt', { className: c['contrast-ratio__result-key'], children: 'Contrast ratio:' }), (0, i.jsx)('dd', { className: c['contrast-ratio__result-value'], children: (0, i.jsxs)(r.Pj, { children: [new Intl.NumberFormat('nl', { maximumSignificantDigits: 3, roundingMode: 'floor' }).format(n), ' \xf7 1'] }) })] }), (0, i.jsxs)('div', { className: (0, s.Z)(c['contrast-ratio__sample'], c['contrast-ratio__sample--background-color']), children: [(0, i.jsx)('dt', { className: c['contrast-ratio__sample-key'], children: 'Achtergrond:' }), (0, i.jsxs)('dd', { className: c['contrast-ratio__sample-value'], children: [(0, i.jsx)(r.B6, { className: c['contrast-ratio__color-sample'], color: L, role: 'img', 'aria-label': `voorbeeld van: ${L}` }), ' ', (0, i.jsx)(r.EK, { children: L })] })] }), (0, i.jsxs)('div', { className: (0, s.Z)(c['contrast-ratio__sample'], c['contrast-ratio__sample--color']), children: [(0, i.jsx)('dt', { className: c['contrast-ratio__sample-key'], children: 'Voorgrond:' }), (0, i.jsxs)('dd', { className: c['contrast-ratio__sample-value'], children: [(0, i.jsx)(r.B6, { className: c['contrast-ratio__color-sample'], color: l, role: 'img', 'aria-label': `voorbeeld van: ${L}` }), ' ', (0, i.jsx)(r.EK, { children: l })] })] })] });
   };
   var u = l(91050),
    p = l(38889),
    m = l(56150);
   const v = (0, a.forwardRef)((e, L) => {
    let { autoComplete: l, defaultValue: n, description: t, disabled: o, errorMessage: r, invalid: c, label: d, max: u, min: p, name: v, onBlur: h, onChange: _, onFocus: x, onInput: g, pattern: b, placeholder: y, readOnly: j, required: k, status: f, type: N, value: C, ...V } = e;
    const Z = (0, a.useId)(),
     H = (0, a.useId)(),
     w = (0, a.useId)(),
     A = (0, a.useId)();
    return (0, i.jsxs)(m.Wi, { invalid: c, ...V, children: [(0, i.jsx)('p', { className: 'utrecht-form-field__label', children: (0, i.jsx)(m.lX, { htmlFor: Z, children: d }) }), t && (0, i.jsx)(m.ue, { id: H, children: t }), c && r && (0, i.jsx)(m.w7, { className: 'utrecht-form-field__error-message', id: A, children: r }), (0, i.jsx)('p', { className: 'utrecht-form-field__input', children: (0, i.jsx)(m.fE, { ref: L, id: Z, name: v, type: N || 'text', autoComplete: l, 'aria-describedby': (0, s.Z)({ [H]: t, [A]: c, [w]: f }) || void 0, invalid: c, dir: 'auto', disabled: o, min: 'number' == typeof p ? String(p) : 'string' == typeof p ? p : void 0, max: 'number' == typeof u ? String(u) : 'string' == typeof u ? u : void 0, pattern: b, placeholder: y, readOnly: j, 'aria-required': k, value: C, onFocus: x, onBlur: h, onInput: g, onChange: _, defaultValue: n }) }), f && (0, i.jsx)('div', { className: 'utrecht-form-field__status', id: w, children: (0, i.jsx)('div', { className: 'utrecht-form-field-description utrecht-form-field-description--status', children: f }) })] });
   });
   ...
   const x = 'nlds-form_L93Q',
    ...
    C = () => {
     const { siteConfig: e } = (0, t.Z)(),
      ...
      s = l.get('background-color'),
      a = l.get('color'),
      c = y(s),
      m = y(a),
      h = `https://nldesignsystem.nl/contrast/?${new URLSearchParams({ 'background-color': s, color: a }).toString()}`,
             ...
             children: [
              ...
              (0, i.jsx)('div', {
               children: j.map((e, L) => {
                ...
                return (0, i.jsx)(u.X, { appearance: r ? 'do' : 'dont', title: n, displayCode: !1, figure: !0, children: (0, i.jsx)(o.X, { language: 'html', code: null, displayCode: !1, container: l, designTokens: { backgroundColor: s, color: a, forcedColorAdjust: 'none', '--utrecht-surface-background-color': s, '--utrecht-surface-color': a, '--utrecht-document-background-color': s, '--utrecht-document-color': a, '--utrecht-icon-color': 'currentColor', '--utrecht-paragraph-color': 'currentColor' }, children: t }) }, L);
               }),
              }),
             ],
            }),
            ...
            (0, i.jsxs)(i.Fragment, {
             children: [
              ...
              (0, i.jsx)('div', {
               children: C.map((e, L) => {
                let { container: l, content: n, example: t, positive: r } = e;
                return (0, i.jsx)(u.X, { appearance: r ? 'do' : 'dont', title: n, displayCode: !1, children: (0, i.jsx)(o.X, { language: 'html', code: null, displayCode: !1, container: l, designTokens: { backgroundColor: s, color: a, forcedColorAdjust: 'none', '--utrecht-surface-background-color': s, '--utrecht-surface-color': a, '--utrecht-document-background-color': s, '--utrecht-document-color': a, '--utrecht-icon-color': 'currentColor', '--utrecht-paragraph-color': 'currentColor' }, children: t }) }, L);
               }),
              }),
             ],
            }),
