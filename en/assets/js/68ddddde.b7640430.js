 ...
 [5643],
 {
  41676: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Skip link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Skip link', pagination_label: 'Skip link', description: 'Biedt de mogelijkheid om content over te slaan en direct naar een onderdeel binnen pagina te navigeren.', slug: '/skip-link', sidebar_custom_props: { illustration: 'SkipLinkSketch' } },
    a = void 0,
    l = { id: 'componenten/skip-link/index', title: 'Skip link', description: 'Biedt de mogelijkheid om content over te slaan en direct naar een onderdeel binnen pagina te navigeren.', source: '@site/docs/componenten/skip-link/index.mdx', sourceDirName: 'componenten/skip-link', slug: '/skip-link', permalink: '/en/skip-link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/skip-link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Skip link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Skip link', pagination_label: 'Skip link', description: 'Biedt de mogelijkheid om content over te slaan en direct naar een onderdeel binnen pagina te navigeren.', slug: '/skip-link', sidebar_custom_props: { illustration: 'SkipLinkSketch' } }, sidebar: 'componenten', previous: { title: 'Side navigation', permalink: '/en/side-navigation' }, next: { title: 'Spinner', permalink: '/en/spinner' } },
    u = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(S, { [w]: t }), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var D = n(14669);
   const L = (e) => {
