  ...
  21004: (e, n, i) => {
   ...
   const o = (e, n) => e.reduce((e, i) => ('link' === i.type ? (n.includes(i.docId) ? e : [...e, i]) : 'category' === i.type ? [...e, { ...i, items: o(i.items, n) }] : e), []),
    a = (e) => {
     ...
     const c = (0, r.jA)();
     return (0, s.jsx)('div', { ...a, className: (0, t.Z)('margin-top--lg', i), children: (0, s.jsx)(l.Z, { items: o(c.items, n) }) });
    };
  },
  20537: (e, n, i) => {
   i.d(n, { Z: () => f });
   ...
   function c(e) {
    ...
    return (0, a.jsxs)('div', { className: (0, s.Z)('card', o.card), children: [n ? (0, a.jsx)(t.Z, { href: n, className: (0, s.Z)(o.cardLink, 'utrecht-link'), children: (0, a.jsxs)('h2', { className: (0, s.Z)(o.cardTitle), children: [i, ' ', r] }) }) : (0, a.jsxs)('h2', { className: (0, s.Z)(o.cardTitle), children: [i, ' ', r] }), l && (0, a.jsx)('p', { className: (0, s.Z)(o.cardDescription), children: l }), c] });
   }
   function d(e) {
    let { item: n } = e;
    return (0, a.jsx)(c, { title: n.label, description: n.description, children: (0, a.jsx)(l.QI, { children: n.items.filter((e) => 'link' === e.type || 'category' === e.type).map((e, n) => (0, a.jsx)(l.AS, { children: 'link' === e.type ? (0, a.jsx)(t.Z, { to: e.href, children: e.label }) : 'category' === e.type ? (0, a.jsxs)(t.Z, { to: e.href, children: [e.items.length, " pagina's voor ", e.label] }) : (0, a.jsx)(a.Fragment, {}) }, n)) }) });
   }
   function u(e) {
    let { item: n } = e;
