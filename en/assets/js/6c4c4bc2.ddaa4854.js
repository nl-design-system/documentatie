 ...
 [7049],
 {
  ...
  3460: (e, n, l) => {
   ...
   const g = (e) => {
    ...
    m = (e) => {
     let { code: n, copy: l = !1, defaultCollapsed: m = !0, children: k, language: v } = e,
      x = "function" == typeof k ? k() : k,
      f = "function" == typeof n ? n() : (0, c.isValidElement)(n) ? n : void 0,
      y = "string" == typeof n ? n : h.uS(f || x),
      [_, w] = (0, c.useState)(y);
     (0, c.useEffect)(() => {
      (async () => {
       (_ = await d.ZP.format(y, { parser: v, plugins: [t.Z, s.ZP, a.ZP, o.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), w(_);
      })();
     }, [y]);
     const z = (0, p.Z)();
     return (0, j.jsxs)("div", {
      ...
      children: [
       ...
       (0, j.jsxs)("div", {
        ...
        hidden: m,
        children: [
         (0, j.jsx)(b.u, { syntax: v, textContent: _, trim: !0 }),
         l &&
          (0, j.jsx)("div", {
           className: (0, r.Z)(u["nlds-canvas__toolbar"]),
           children: (0, j.jsx)(i.zx, {
