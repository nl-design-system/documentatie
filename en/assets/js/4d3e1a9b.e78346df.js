(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [45119],
 {
  46832: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => g, contentTitle: () => a, default: () => k, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => m, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Date picker', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date picker', pagination_label: 'Date picker', description: 'Biedt de mogelijkheid om een beschikbare datum te kiezen uit een op maat gemaakte kalender.', slug: '/date-picker', sidebar_custom_props: { illustration: 'DatePickerSketch' } },
    a = void 0,
    u = { id: 'componenten/date-picker/index', title: 'Date picker', description: 'Biedt de mogelijkheid om een beschikbare datum te kiezen uit een op maat gemaakte kalender.', source: '@site/docs/componenten/date-picker/index.mdx', sourceDirName: 'componenten/date-picker', slug: '/date-picker', permalink: '/en/date-picker', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-picker/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Date picker', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date picker', pagination_label: 'Date picker', description: 'Biedt de mogelijkheid om een beschikbare datum te kiezen uit een op maat gemaakte kalender.', slug: '/date-picker', sidebar_custom_props: { illustration: 'DatePickerSketch' } }, sidebar: 'componenten', previous: { title: 'Date input group', permalink: '/en/date-input-group' }, next: { title: 'Definition list', permalink: '/en/definition-list' } },
    l = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: D, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.aC, { role: 'presentation', children: n }), (0, l.jsx)(v.nv, { children: r })] })] });
    };
   var S = n(14669);
   const T = (e) => {
