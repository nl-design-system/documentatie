 ...
 [74270],
 {
  34434: (e, n, o) => {
   ...
   var t = o(53623),
    d = o(30036);
   function a(e) {
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(d.X, { appearance: "do", title: "Plaats alle descriptions op een consistente plek, liefst tussen het label en het formulierveld.", children: (0, r.jsxs)(t.X, { language: "html", children: [(0, r.jsx)("label", { for: "wachtwoord1", children: "Nieuw wachtwoord" }), (0, r.jsx)("p", { id: "description-wachtwoord1", children: "Kies een wachtwoord van minimaal 8 karakters lang." }), (0, r.jsx)("input", { id: "wachtwoord1", type: "password", name: "nieuw-wachtwoord", "aria-describedby": "description-wachtwoord1" })] }) }), "\n", (0, r.jsx)(d.X, { appearance: "do", title: "Plaats alle descriptions, ook de foutmeldingen, op een consistente plek, liefst tussen het label en het formulierveld.", children: (0, r.jsxs)(t.X, { language: "html", children: [(0, r.jsx)("label", { for: "wachtwoord2", children: "Nieuw wachtwoord" }), (0, r.jsx)("p", { id: "description-wachtwoord2", children: "Kies een wachtwoord van minimaal 8 karakters lang." }), (0, r.jsx)("p", { id: "error-wachtwoord2", children: "Je gekozen wachtwoord is te kort." }), (0, r.jsx)("input", { id: "wachtwoord2", type: "password", name: "nieuw-wachtwoord", "aria-describedby": "description-wachtwoord2 error-wachtwoord2" })] }) }), "\n", (0, r.jsx)(d.X, { appearance: "dont", title: "Description onder het formulierveld plaatsen.", children: (0, r.jsxs)(t.X, { language: "html", children: [(0, r.jsx)("label", { for: "wachtwoord3", children: "Nieuw wachtwoord" }), (0, r.jsx)("input", { id: "wachtwoord3", type: "password", name: "nieuw-wachtwoord", "aria-describedby": "description-wachtwoord3" }), (0, r.jsx)("p", { id: "description-wachtwoord3", children: "Kies een wachtwoord van minimaal 8 karakters lang." })] }) }), "\n", (0, r.jsx)(d.X, { appearance: "dont", title: "Description boven het formulierveld en foutmelding eronder plaatsen.", children: (0, r.jsxs)(t.X, { language: "html", children: [(0, r.jsx)("label", { for: "wachtwoord4", children: "Nieuw wachtwoord" }), (0, r.jsx)("p", { id: "description-wachtwoord4", children: "Kies een wachtwoord van minimaal 8 karakters lang." }), (0, r.jsx)("input", { id: "wachtwoord4", type: "password", name: "nieuw-wachtwoord", "aria-describedby": "description-wachtwoord4 error-wachtwoord4" }), (0, r.jsx)("p", { id: "error-wachtwoord4", children: "Je gekozen wachtwoord is te kort." })] }) })] });
   }
   function c(e = {}) {
    const { wrapper: n } = { ...(0, l.a)(), ...e.components };
   ...
   function u(e) {
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(d.X, { appearance: "do", title: "Koppel een description aan het formulierveld, met aria-describedby.", children: (0, r.jsxs)(t.X, { language: "html", children: [(0, r.jsx)("label", { for: "wachtwoord", children: "Nieuw wachtwoord" }), (0, r.jsx)("p", { id: "description-wachtwoord", children: "Kies een wachtwoord van minimaal 8 karakters lang." }), (0, r.jsx)("input", { id: "wachtwoord", type: "password", name: "nieuw-wachtwoord", "aria-describedby": "description-wachtwoord" })] }) }), "\n", (0, r.jsx)(d.X, { appearance: "dont", title: "Koppeling weglaten.", children: (0, r.jsxs)(t.X, { language: "html", children: [(0, r.jsx)("label", { for: "wachtwoord0", children: "Nieuw wachtwoord" }), (0, r.jsx)("p", { children: "Kies een wachtwoord van minimaal 8 karakters lang." }), (0, r.jsx)("input", { id: "wachtwoord0", type: "password", name: "nieuw-wachtwoord" })] }) })] });
   }
   function g(e = {}) {
    const { wrapper: n } = { ...(0, l.a)(), ...e.components };
   ...
   function k(e) {
    return (0, r.jsx)(d.X, { appearance: "do", title: "Koppel alle descriptions aan het formulierveld.", children: (0, r.jsxs)(t.X, { language: "html", children: [(0, r.jsx)("label", { for: "wachtwoord5", children: "Nieuw wachtwoord" }), (0, r.jsx)("div", { id: "description-wachtwoord5", children: "Kies een wachtwoord van minimaal 8 karakters lang." }), (0, r.jsx)("div", { id: "error-wachtwoord5", children: "Je gekozen wachtwoord is te kort." }), (0, r.jsx)("input", { id: "wachtwoord5", type: "password", name: "nieuw-wachtwoord", "aria-describedby": "description-wachtwoord5 error-wachtwoord5" })] }) });
   }
   function v(e = {}) {
    const { wrapper: n } = { ...(0, l.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(k, { ...e }) }) : k();
   }
   function j(e) {
   ...
   function x(e) {
    return (0, r.jsx)(d.X, { appearance: "do", title: "Koppel een description aan de legend van de fieldset, met aria-describedby.", children: (0, r.jsx)(t.X, { language: "html", children: (0, r.jsxs)("fieldset", { "aria-describedby": "description-inloggen", children: [(0, r.jsx)("legend", { children: "Wilt u inloggen?" }), (0, r.jsx)("p", { id: "description-inloggen", children: "Als u inlogt worden uw gegevens al ingevuld en kunnen we u makkelijker helpen." }), (0, r.jsxs)("div", { children: [(0, r.jsx)("input", { id: "inloggen-ja", type: "radio", name: "inloggen", value: "ja" }), (0, r.jsx)("label", { for: "inloggen-ja", children: " Ja" })] }), (0, r.jsxs)("div", { children: [(0, r.jsx)("input", { id: "inloggen-nee", type: "radio", name: "inloggen", value: "nee" }), (0, r.jsx)("label", { for: "inloggen-nee", children: " Nee" })] })] }) }) });
   }
   function f(e = {}) {
    const { wrapper: n } = { ...(0, l.a)(), ...e.components };
   ...
   function S(e = {}) {
    const { wrapper: n } = { ...(0, l.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(z, { ...e }) }) : z();
   }
   function D(e) {
    const n = { h2: "h2", p: "p", ...(0, l.a)(), ...e.components };
  ...
  53623: (e, n, o) => {
   ...
   const k = (e) => {
    ...
    v = (e) => {
     let { code: n, copy: o = !1, defaultCollapsed: i = !0, children: t, language: a } = e;
     "function" == typeof t && (t = t());
     const v = c().format(h.uS(n || t), { parser: "html", plugins: [s(), d()], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" }),
      j = (0, m.Z)();
     return (0, b.jsxs)("div", {
      className: (0, l.Z)(r["nlds-canvas"], "voorbeeld-theme", "utrecht-html"),
      children: [
       (0, b.jsx)("div", { className: (0, l.Z)(r["nlds-canvas__example"]), children: t }),
       (0, b.jsx)("div", { className: (0, l.Z)(r["nlds-canvas__toolbar"]), children: (0, b.jsx)(g.zx, { className: (0, l.Z)(r["nlds-canvas__button"], r["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: k, "aria-expanded": !i, "aria-controls": j, children: i ? "Bekijk code" : "Verberg code" }) }),
       (0, b.jsxs)("div", {
        className: (0, l.Z)(r["nlds-canvas__code-block"], !o && r["nlds-canvas__code-block--user-select-none"]),
        id: j,
        hidden: i,
        children: [
         (0, b.jsx)(p.Z, { language: a, style: u, children: v }),
         o &&
          (0, b.jsx)("div", {
           className: (0, l.Z)(r["nlds-canvas__toolbar"]),
           children: (0, b.jsx)(g.zx, {
            className: (0, l.Z)(r["nlds-canvas__button"], r["nlds-canvas__copy-button"]),
  ...
  30036: (e, n, o) => {
   ...
   const a = (e) => {
    ...
    const h = "Doen",
     p = "Niet doen";
    return (0, d.jsxs)("div", { className: (0, s.Z)(i["nlds-guideline"], i[`nlds-guideline--${o}`]), id: n?.toLowerCase().replace(/\s/g, "-"), children: [(0, d.jsxs)("div", { className: (0, s.Z)(i["nlds-guideline__description"]), children: ["dont" === o ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.nv, { className: (0, s.Z)(i["nlds-guideline__badge"], i[`nlds-guideline__badge--${o}`]), children: [(0, d.jsx)(r.Z, { className: i["nlds-guideline__icon"] }), (0, d.jsx)("span", { className: i["nlds-guideline__title"], children: p })] }), (0, d.jsx)(t.nv, { children: n })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.nv, { className: (0, s.Z)(i["nlds-guideline__badge"], i[`nlds-guideline__badge--${o}`]), children: [(0, d.jsx)(l.Z, { className: i["nlds-guideline__icon"] }), (0, d.jsx)("span", { className: i["nlds-guideline__title"], children: h })] }), (0, d.jsx)(t.nv, { children: n })] }), a] }), (0, d.jsx)("div", { className: (0, s.Z)(i["nlds-guideline__example"]), children: c })] });
   };
  },
 },
]);
