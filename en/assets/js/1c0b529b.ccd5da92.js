(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [34894],
 {
  49203: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => y, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => s, issueNumber: () => m, metadata: () => l, title: () => d, toc: () => h });
   var r = n(52676),
    i = n(24785),
    c = n(81301),
    o = n(90786);
   const s = { title: 'Checkbox', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Checkbox', pagination_label: 'Checkbox', description: 'Invoerveld voor het kiezen van een optie uit een groep van opties, of om te kiezen tussen "wel" of "niet".', slug: '/checkbox', keywords: ['aankruisen', 'aankruisvakje', 'aanvinken', 'afvinken', 'aria-checked', 'aria-disabled', 'aria-invalid', 'aria-required', 'check', 'check box', 'checkbox', 'checkbox button', 'checkboxes', 'checked', 'form', 'form control', 'formulier', 'indeterminate', 'invoerveld', 'kruis', 'kruisje', 'meerkeuze', 'niet', 'optie', 'option', 'option box', 'optional', 'optioneel', 'required', 'select', 'selecteren', 'selectievakje', 'selection box', 'uncheck', 'unchecked', 'verplicht', 'vink', 'vinkje', 'wel', 'X mark'] },
    a = void 0,
    l = { id: 'componenten/checkbox/index', title: 'Checkbox', description: 'Invoerveld voor het kiezen van een optie uit een groep van opties, of om te kiezen tussen "wel" of "niet".', source: '@site/docs/componenten/checkbox/index.mdx', sourceDirName: 'componenten/checkbox', slug: '/checkbox', permalink: '/en/checkbox', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/checkbox/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Checkbox', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Checkbox', pagination_label: 'Checkbox', description: 'Invoerveld voor het kiezen van een optie uit een groep van opties, of om te kiezen tussen "wel" of "niet".', slug: '/checkbox', keywords: ['aankruisen', 'aankruisvakje', 'aanvinken', 'afvinken', 'aria-checked', 'aria-disabled', 'aria-invalid', 'aria-required', 'check', 'check box', 'checkbox', 'checkbox button', 'checkboxes', 'checked', 'form', 'form control', 'formulier', 'indeterminate', 'invoerveld', 'kruis', 'kruisje', 'meerkeuze', 'niet', 'optie', 'option', 'option box', 'optional', 'optioneel', 'required', 'select', 'selecteren', 'selectievakje', 'selection box', 'uncheck', 'unchecked', 'verplicht', 'vink', 'vinkje', 'wel', 'X mark'] }, sidebar: 'componenten', previous: { title: 'Case Card', permalink: '/en/case-card' }, next: { title: 'Checkbox Group', permalink: '/en/checkbox-group' } },
    u = {},
    h = [
    ...
    d = 'Checkbox',
    j = 'Invoerveld voor het kiezen van een optie uit een groep van opties, of om te kiezen tussen "wel" of "niet".',
    m = 64,
    y = c.find((e) => e.number === m);
   function g(e) {
    const t = { h2: 'h2', ...(0, i.a)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, r.jsx)(o.Rv, { component: y, headingLevel: 1, description: j }), '\n', (0, r.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, r.jsx)(o.cN, { component: y, headingLevel: 3 }), '\n', (0, r.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }), '\n', (0, r.jsx)(o.W, { component: y, headingLevel: 3 }), '\n', (0, r.jsx)(t.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }), '\n', (0, r.jsx)(o.vM, { component: y, headingLevel: 3 })] });
   }
   function p(e = {}) {
  ...
  68963: (e, t, n) => {
   ...
   const s = (e) => {
     ...
     return (0, o.jsx)('div', { className: (0, i.Z)(c.card__illustration, t && c['card__illustration--background'], r), ...s, children: n });
    },
    a = (e) => (0, o.jsx)('div', { className: (0, i.Z)(c.card__content), ...e }),
    l = (e) => {
     ...
     const u = (e) => ('article' === a ? (0, o.jsx)('article', { ...e }) : 'section' === a ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      h = (0, o.jsx)(u, { className: (0, i.Z)(c.cardgroup__card, c[`cardgroup__card--${n}`], s), children: l });
     return t ? (0, o.jsx)(r.rU, { href: t, boxContent: !0, className: c.cardgroup__link, children: h }) : h;
    },
    u = (e) => {
     let { appearance: t = 'medium', children: n, className: r } = e;
     return (0, o.jsx)('div', { className: (0, i.Z)(c.cardgroup, c[`cardgroup--${t}`], r), children: n });
    };
  },
  90786: (e, t, n) => {
   'use strict';
   n.d(t, { cN: () => z, vM: () => A, W: () => N, Rv: () => S });
   var r = n(56150),
    i = n(4814),
    c = (n(75271), n(39854)),
    o = n(7522),
    ...
    l = n(32636),
    u = n(52676);
   const h = { figma: (0, u.jsx)(c.Z, {}), github: (0, u.jsx)(o.Z, {}), npm: (0, u.jsx)(s.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
   ...
   const _ = (e) => {
     let { children: t } = e;
     return (0, u.jsx)('ul', { className: f.Z['task-list'], children: t });
    },
    x = (e) => {
     let { checked: t, children: n, title: r, description: c, headingLevel: o = 3 } = e;
     return (0, u.jsxs)('li', { className: (0, i.Z)(f.Z['task-list-item']), children: [(0, u.jsxs)('div', { className: (0, i.Z)(f.Z['task-list-item__marker'], t && f.Z['task-list-item__marker--checked']), children: [(0, u.jsx)('span', { className: f.Z['task-list-item__marker-label'], children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var w = n(14669);
   const z = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => w.e9.includes(e.id)),
      o = c && w.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, u.jsx)(_, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(x, { checked: t, title: n, description: (0, w.Q6)(r) }, r);
            }),
           }),
                 ...
                 children: [
                  ...
                  (0, u.jsx)(r.Mc, {
                   children: s.map((e) => {
                    ...
                    return t ? (0, u.jsxs)(r.k7, { href: e.value, children: [(0, u.jsx)(d, { brand: t.brand }), ' ', t.desciption] }, e.id) : (0, u.jsx)(u.Fragment, {});
                   }),
                  }),
                 ],
                }),
  ...
  72657: (e, t, n) => {
   ...
   const o = (e) => {
    ...
    return (0, c.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${o}`, n), ...a, children: [(0, c.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: t }), s && (0, c.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [s ? ' ' : '', s] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
