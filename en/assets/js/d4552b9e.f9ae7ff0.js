(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [15403],
 {
  61885: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => g, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => s, issueNumber: () => m, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(7617),
    o = n(4460);
   const s = { title: 'Form field error message', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field error message', pagination_label: 'Form field error message', description: 'Toont een foutmelding die informeert wat er is fout gegaan en hoe dit is op te lossen.', slug: '/form-field-error-message' },
    a = void 0,
    l = { id: 'componenten/form-field-error-message/index', title: 'Form field error message', description: 'Toont een foutmelding die informeert wat er is fout gegaan en hoe dit is op te lossen.', source: '@site/docs/componenten/form-field-error-message/index.mdx', sourceDirName: 'componenten/form-field-error-message', slug: '/form-field-error-message', permalink: '/en/form-field-error-message', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-field-error-message/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form field error message', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field error message', pagination_label: 'Form field error message', description: 'Toont een foutmelding die informeert wat er is fout gegaan en hoe dit is op te lossen.', slug: '/form-field-error-message' }, sidebar: 'componenten', previous: { title: 'Form field description', permalink: '/en/form-field-description' }, next: { title: 'Form field label', permalink: '/en/form-field-label' } },
    u = {},
    d = [
   ...
   const s = (e) => {
    ...
    l = (e) => {
     ...
     const u = (e) => ('article' === a ? (0, o.jsx)('article', { ...e }) : 'section' === a ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(u, { className: (0, i.Z)(c.cardgroup__card, c[`cardgroup__card--${n}`], s), children: l });
     return t ? (0, o.jsx)(r.rU, { href: t, boxContent: !0, className: c.cardgroup__link, children: d }) : d;
    },
    u = (e) => {
  ...
  4460: (e, t, n) => {
   ...
   var r = n(56150),
    ...
    l = n(32636),
    u = n(52676);
   const d = { figma: (0, u.jsx)(c.Z, {}), github: (0, u.jsx)(o.Z, {}), npm: (0, u.jsx)(s.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   var p = n(80407);
   const f = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    v = (e) => {
     let { children: t, level: n = 1, suffix: r } = e;
     return (0, u.jsxs)('hgroup', { className: (0, i.Z)(f['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, u.jsx)('h1', { className: (0, i.Z)(f['nlds-inline-heading-group__heading']), children: t }), r && (0, u.jsxs)('p', { className: (0, i.Z)(f['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var b = n(46506),
    k = n(25953);
   const _ = 'task-list_hh8j',
    ...
    N = 'task-list-item__marker--checked_y8Vc',
    A = 'task-list-item__marker-label_XAyi',
    z = (e) => {
     let { children: t } = e;
     return (0, u.jsx)('ul', { className: _, children: t });
    },
    S = (e) => {
     let { checked: t, title: n, description: r } = e;
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var T = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => T.e9.includes(e.id)),
      o = c && T.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(m['definition-of-done'], e && m[`definition-of-done--${(0, T.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, u.jsx)(z, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(S, { checked: t, title: n, description: (0, T.Q6)(r) }, r);
            }),
           }),
    ...
    C = (e) => {
     ...
     const c = t && T.$3[t.relayStep];
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(v, { level: n, suffix: c && (0, u.jsx)(p.y, { state: c }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
