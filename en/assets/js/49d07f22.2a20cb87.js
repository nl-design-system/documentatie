 ...
 [75524],
 {
  13455: (e, l, n) => {
   ...
   const p = (e) => {
    ...
    h = (e) => {
     ...
     const h = k().format(m.uS(l || i), { parser: "html", plugins: [d(), c()], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" }),
      _ = (0, g.Z)();
     return o.createElement(
      "div",
      { className: (0, t.Z)(a["nlds-canvas"], "voorbeeld-theme", "utrecht-html") },
      o.createElement("div", { className: (0, t.Z)(a["nlds-canvas__example"]) }, i),
      o.createElement("div", { className: (0, t.Z)(a["nlds-canvas__toolbar"]) }, o.createElement(u.zx, { className: (0, t.Z)(a["nlds-canvas__button"], a["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: p, "aria-expanded": !r, "aria-controls": _ }, r ? "Bekijk code" : "Verberg code")),
      o.createElement(
       "div",
       { className: (0, t.Z)(a["nlds-canvas__code-block"], !n && a["nlds-canvas__code-block--user-select-none"]), id: _, hidden: r },
       o.createElement(b.Z, { language: s, style: v }, h),
       n &&
        o.createElement(
         "div",
  ...
  31092: (e, l, n) => {
   ...
   const c = (e) => {
    ...
    const k = "Doen",
     m = "Niet doen";
    return o.createElement("div", { className: (0, d.Z)(r["nlds-guideline"], r[`nlds-guideline--${n}`]), id: null == l ? void 0 : l.toLowerCase().replace(/\s/g, "-") }, o.createElement("div", { className: (0, d.Z)(r["nlds-guideline__description"]) }, "dont" === n ? o.createElement(o.Fragment, null, o.createElement(i.nv, { className: (0, d.Z)(r["nlds-guideline__badge"], r[`nlds-guideline__badge--${n}`]) }, o.createElement(a.Z, { className: r["nlds-guideline__icon"] }), o.createElement("span", { className: r["nlds-guideline__title"] }, m)), o.createElement(i.nv, null, l)) : o.createElement(o.Fragment, null, o.createElement(i.nv, { className: (0, d.Z)(r["nlds-guideline__badge"], r[`nlds-guideline__badge--${n}`]) }, o.createElement(t.Z, { className: r["nlds-guideline__icon"] }), o.createElement("span", { className: r["nlds-guideline__title"] }, k)), o.createElement(i.nv, null, l)), c), o.createElement("div", { className: (0, d.Z)(r["nlds-guideline__example"]) }, s));
   };
  },
  88490: (e, l, n) => {
   n.r(l), n.d(l, { assets: () => m, contentTitle: () => s, default: () => g, frontMatter: () => c, metadata: () => k, toc: () => b });
   var o = n(87462),
    a = n(67294),
    t = n(3905),
    r = n(13455),
   ...
   function g(e) {
    ...
    return (0, t.kt)(u, (0, o.Z)({}, v, n, { components: l, mdxType: "MDXLayout" }), (0, t.kt)("h1", { id: "makkelijk-in-te-vullen" }, "Makkelijk in te vullen"), (0, t.kt)(i.nv, { lead: !0, mdxType: "Paragraph" }, "Maak het de gebruiker makkelijker door bijvoorbeeld informatie vooraf in te vullen."), (0, t.kt)("h2", { id: "vul-bekende-informatie-in-waar-mogelijk" }, "Vul bekende informatie in waar mogelijk"), (0, t.kt)("p", null, "Als de gebruiker is ingelogd, gebruik dan bekende informatie om velden vast in te vullen. In DigiD-sessies is bijvoorbeeld een hoop informatie beschikbaar, die zou kunnen worden geburikt om velden vooraf in te vullen."), (0, t.kt)("h2", { id: "bereid-velden-voor-op-autocomplete" }, "Bereid velden voor op autocomplete"), (0, t.kt)("p", null, "Met het ", (0, t.kt)("inlineCode", { parentName: "p" }, "autocomplete"), " attribuut in HTML kun je per veld aangeven wat voor soort invoer er verwacht wordt, zodat de browser bekende informatie kan voorstellen als autosuggest-opties. Gebruik je bijvoorbeeld ", (0, t.kt)("inlineCode", { parentName: "p" }, 'autocomplete="street-address"'), ", dan kan de browser suggesties doen. Dit kan gebruikers een hoop typewerk schelen."), (0, t.kt)("h2", { id: "check-of-informatie-\xe8cht-nodig-is" }, "Check of informatie \xe8cht nodig is"), (0, t.kt)("p", null, "Kortere formulieren kunnen sneller worden ingevuld. Ga dus per vraag na of deze echt nodig is. Zo is het bijvoorbeeld vaak onnodig om te vragen naar een straatnaam, als huisnummer en postcode al bekend zijn."), (0, t.kt)("h2", { id: "voorkom-herhaling" }, "Voorkom herhaling"), (0, t.kt)("p", null, "Om zeker te weten dat iemand het juiste emailadres heeft ingevuld, wordt in sommige formulieren de vraag twee keer gesteld en dan vergeleken. Dit kan gebruikersvriendelijker!"), (0, t.kt)("p", null, "Als het essentieel is dat de informatie correct is, zijn er deze alternatieven:"), (0, t.kt)("ul", null, (0, t.kt)("li", { parentName: "ul" }, "toon dan voor het verzenden nog eens de invoer, bijvoorbeeld op een bevestigingspagina"), (0, t.kt)("li", { parentName: "ul" }, "(als het om een emailadres gaat) stuur een email ter bevestiging om de juistheid van het emailadres te controleren")), (0, t.kt)(d.X, { appearance: "dont", title: "Herhaling ter bevestiging", description: "Herhaling zorgt dat mensen meer tijd kwijt zijn met het invullen van het formulier, terwijl er vaak andere manieren voorhanden zijn om informatie te bevestigen.", mdxType: "Guideline" }, (0, t.kt)(r.X, { language: "html", code: (0, t.kt)(a.Fragment, null, (0, t.kt)("div", null, (0, t.kt)("label", { htmlFor: "name" }, "Email"), (0, t.kt)("input", { type: "text", name: "first_name", id: "email" })), (0, t.kt)("div", null, (0, t.kt)("label", { htmlFor: "name" }, "Email (ter bevestiging)"), (0, t.kt)("input", { type: "text", name: "first_name", id: "email" }))), defaultCollapsed: !0, mdxType: "Canvas" }, (0, t.kt)(i.Wi, { type: "text", mdxType: "FormField" }, (0, t.kt)(i.nv, { className: "utrecht-form-field__label", mdxType: "Paragraph" }, (0, t.kt)(i.lX, { htmlFor: "email", mdxType: "FormLabel" }, "Email")), (0, t.kt)(i.fE, { name: "email", id: "email", mdxType: "Textbox" })), (0, t.kt)(i.Wi, { type: "text", mdxType: "FormField" }, (0, t.kt)(i.nv, { className: "utrecht-form-field__label", mdxType: "Paragraph" }, (0, t.kt)(i.lX, { htmlFor: "email-rep", mdxType: "FormLabel" }, "Email (ter bevestiging)")), (0, t.kt)(i.fE, { name: "email-rep", id: "email-rep", mdxType: "Textbox" })))));
   }
   g.isMDXComponent = !0;
  },
 },
