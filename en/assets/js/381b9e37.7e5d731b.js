(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [9910],
 {
  1172: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => p, contentTitle: () => a, default: () => b, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => g, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    c = n(24785),
    o = n(31612),
    i = n(60851);
   const s = { title: 'Action group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Action group', pagination_label: 'Action group', description: 'Groepeert \xe9\xe9n of meer gerelateerde acties en verzorgt de lay-out van de content.', slug: '/action-group', sidebar_custom_props: { illustration: 'ActionGroupSketch' }, keywords: ['action bar', 'action group', 'actions', 'button', 'button container', 'button dock', 'button group', 'button row', 'buttongroup', 'buttons', 'form submission', 'formulier verzenden', 'knop', 'knoppen', 'knoppenbalk', 'toolbar', 'werkbalk'] },
    a = void 0,
  ...
  82489: (e, t, n) => {
   ...
   (c.keys = () => Object.keys(r)), (c.id = 82489), (e.exports = c);
  },
  95929: (e, t, n) => {
   'use strict';
   ...
   const s = (e) => {
     ...
     return (0, i.jsx)('div', { className: (0, c.Z)(o.card__illustration, t && o['card__illustration--background'], r), ...s, children: n });
    },
    a = (e) => (0, i.jsx)('div', { className: (0, c.Z)(o.card__content), ...e }),
    u = (e) => {
     ...
     const l = (e) => ('article' === a ? (0, i.jsx)('article', { ...e }) : 'section' === a ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      d = (0, i.jsx)(l, { className: (0, c.Z)(o.cardgroup__card, o[`cardgroup__card--${n}`], s), children: u });
     return t ? (0, i.jsx)(r.rU, { href: t, boxContent: !0, className: o.cardgroup__link, children: d }) : d;
    },
    l = (e) => {
     let { appearance: t = 'medium', children: n, className: r } = e;
     return (0, i.jsx)('div', { className: (0, c.Z)(o.cardgroup, o[`cardgroup--${t}`], r), children: n });
    };
  },
  60851: (e, t, n) => {
   'use strict';
   ...
   var r = n(47027),
    ...
    u = n(32636),
    l = n(52676);
   const d = { figma: (0, l.jsx)(o.Z, {}), github: (0, l.jsx)(i.Z, {}), npm: (0, l.jsx)(s.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, c.Z)(x), children: [(0, l.jsxs)('div', { className: (0, c.Z)(w, { [A]: t }), children: [(0, l.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(k.aC, { role: 'presentation', children: n }), (0, l.jsx)(k.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
     let { component: t, headingLevel: n } = e;
     const o = t && t.projects.filter((e) => D.e9.includes(e.id)),
      i = o && D.e9.map((e) => o.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: i.map((e) => ({
        className: (0, c.Z)(y['definition-of-done'], y[`definition-of-done--${(0, D.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
               ...
               i.length &&
                (0, l.jsxs)(l.Fragment, {
                 children: [
                  ...
                  (0, l.jsx)(r.Mc, {
                   children: i.map((e) => {
                    const { brand: t, desciption: n } = o.get(e.name);
    ...
    C = (e) => {
     ...
     const o = t && D.$3[t.relayStep];
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(v, { level: n, suffix: o && (0, l.jsx)(m.y, { state: o }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  42677: (e, t, n) => {
   'use strict';
   ...
   const a = (e) => {
    let { state: t } = e;
    const n = (0, i.mA)(t);
    return (0, s.jsx)(r.Ou, { className: (0, c.Z)(o['estafette-badge'], n && o[`estafette-badge--${n}`]), children: t });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, Q6: () => o, e9: () => i, mA: () => c });
