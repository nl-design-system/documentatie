 ...
 [92532],
 {
  42931: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Form field option label', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field option label', pagination_label: 'Form field option label', description: ' ', slug: '/form-field-option-label', sidebar_custom_props: { illustration: 'FormFieldOptionLabelSketch' } },
    a = void 0,
    l = { id: 'componenten/form-field-option-label/index', title: 'Form field option label', description: ' ', source: '@site/docs/componenten/form-field-option-label/index.mdx', sourceDirName: 'componenten/form-field-option-label', slug: '/form-field-option-label', permalink: '/en/form-field-option-label', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-field-option-label/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form field option label', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field option label', pagination_label: 'Form field option label', description: ' ', slug: '/form-field-option-label', sidebar_custom_props: { illustration: 'FormFieldOptionLabelSketch' } }, sidebar: 'componenten', previous: { title: 'Form field label', permalink: '/en/form-field-label' }, next: { title: 'Form field partial', permalink: '/en/form-field-partial' } },
    u = {},
    d = [
