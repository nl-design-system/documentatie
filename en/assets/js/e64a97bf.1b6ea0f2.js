 ...
 [95075],
 {
  3812: (e, n, i) => {
   ...
   function h(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Zorg ervoor dat teksten begrijpelijk zijn voor een lezer uit de tweede klas van het middelbaar onderwijs. Als de tekst moeilijker is, bied dan ook een eenvoudig leesbare versie van de tekst aan als alternatief.' }), '\n', (0, r.jsx)(n.p, { children: 'Dit is fijn voor gebruikers die moeite hebben met lezen of van wie de tekst niet hun moedertaal is.' })] });
   }
   function u(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(h, { ...e }) }) : h(e);
   }
   const g = { title: 'WCAG-succescriterium 3.1.5 Leesniveau', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.1.5 Leesniveau', pagination_label: 'WCAG-succescriterium 3.1.5 Leesniveau', description: 'Zorg ervoor dat teksten begrijpelijk zijn voor een lezer uit de tweede klas van het middelbaar onderwijs. Als de tekst moeilijker is, bied dan ook een eenvoudig leesbare versie van de tekst aan als alternatief.', slug: '3.1.5', keywords: ['WCAG'] },
    p = void 0,
    v = { id: 'wcag/3.1.05', title: 'WCAG-succescriterium 3.1.5 Leesniveau', description: 'Zorg ervoor dat teksten begrijpelijk zijn voor een lezer uit de tweede klas van het middelbaar onderwijs. Als de tekst moeilijker is, bied dan ook een eenvoudig leesbare versie van de tekst aan als alternatief.', source: '@site/docs/wcag/3.1.05.mdx', sourceDirName: 'wcag', slug: '/wcag/3.1.5', permalink: '/en/wcag/3.1.5', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.1.05.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 3.1.5 Leesniveau', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.1.5 Leesniveau', pagination_label: 'WCAG-succescriterium 3.1.5 Leesniveau', description: 'Zorg ervoor dat teksten begrijpelijk zijn voor een lezer uit de tweede klas van het middelbaar onderwijs. Als de tekst moeilijker is, bied dan ook een eenvoudig leesbare versie van de tekst aan als alternatief.', slug: '3.1.5', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.1.4 Afkortingen', permalink: '/en/wcag/3.1.4' }, next: { title: 'WCAG-succescriterium 3.1.6 Uitspraak', permalink: '/en/wcag/3.1.6' } },
    j = {},
    m = [
   ...
   function k(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', (0, r.jsx)(l.j, { level: 1, conformanceLevel: 'Niveau AAA', children: 'WCAG-succescriterium 3.1.5 Leesniveau' }), '\n', (0, r.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, r.jsx)(u, {}), '\n', (0, r.jsx)(n.h2, { id: 'opgelet', children: 'Opgelet' }), '\n', (0, r.jsx)(n.p, { children: 'Deze inhoud wordt binnenkort aangevuld met uitgebreidere uitleg, bronnen en informatie over hoe te testen.' }), '\n', (0, r.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, r.jsx)(o.ZP, {}), '\n', (0, r.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#reading-level', children: (0, r.jsx)('span', { lang: 'en', children: '3.1.5 Reading Level' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#leesniveau', children: '3.1.5 Leesniveau' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, r.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#reading-level', children: (0, r.jsx)('span', { lang: 'en', children: 'Quick Reference 3.1.5 Reading Level' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/reading-level.html', children: (0, r.jsx)('span', { lang: 'en', children: 'Understanding SC 3.1.5: Reading Level' }) }), '.'] }), '\n'] }), '\n', (0, r.jsx)(a.CY, { children: (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(d.ZP, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(c.ZP, {}) })] });
   }
   function x(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
