 ...
 [58441],
 {
  38065: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(80719),
    o = n(90786);
   const s = { title: 'Avatar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Avatar', pagination_label: 'Avatar', description: 'Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.', slug: '/avatar', keywords: ['afbeelding', 'avatar', 'foto', 'gebruiker', 'gravatar', 'icon', 'identiteit', 'identity', 'illustratie', 'illustration', 'image', 'initial', 'initialen', 'logo', 'organisation', 'organization', 'photo', 'picture', 'profielafbeelding', 'profile image', 'user'] },
    a = void 0,
    l = { id: 'componenten/avatar/index', title: 'Avatar', description: 'Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.', source: '@site/docs/componenten/avatar/index.mdx', sourceDirName: 'componenten/avatar', slug: '/avatar', permalink: '/en/avatar', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/avatar/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Avatar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Avatar', pagination_label: 'Avatar', description: 'Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.', slug: '/avatar', keywords: ['afbeelding', 'avatar', 'foto', 'gebruiker', 'gravatar', 'icon', 'identiteit', 'identity', 'illustratie', 'illustration', 'image', 'initial', 'initialen', 'logo', 'organisation', 'organization', 'photo', 'picture', 'profielafbeelding', 'profile image', 'user'] }, sidebar: 'componenten', previous: { title: 'Alert dialog', permalink: '/en/alert-dialog' }, next: { title: 'Blockquote', permalink: '/en/blockquote' } },
    u = {},
    d = [
    ...
    h = 'Avatar',
    j = 'Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.',
    g = 83,
  ...
  90786: (e, t, n) => {
   ...
   const _ = (e) => {
     let { children: t } = e;
     return (0, u.jsx)('ul', { className: k.Z['task-list'], children: t });
    },
    x = (e) => {
     let { checked: t, children: n, title: r, description: c, headingLevel: o = 3 } = e;
     return (0, u.jsxs)('li', { className: (0, i.Z)(k.Z['task-list-item']), children: [(0, u.jsxs)('div', { className: (0, i.Z)(k.Z['task-list-item__marker'], t && k.Z['task-list-item__marker--checked']), children: [(0, u.jsx)('span', { className: k.Z['task-list-item__marker-label'], children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var w = n(14669);
   const A = (e) => {
