...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  30412: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => g, default: () => j, frontMatter: () => c, metadata: () => u, toc: () => h });
   var t = i(52676),
    r = i(24785),
    s = i(71595),
    a = i(45054),
   ...
   function o(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.p, { children: 'Zorg ervoor dat de aanklikbare elementen op een pagina groot genoeg zijn om makkelijk aan te klikken met een muis of vinger.' }), '\n', (0, t.jsx)(n.p, { children: 'Hierbij geldt dat het aan te klikken gebied ten minste 24 bij 24 pixels groot is.' }), '\n', (0, t.jsx)(n.p, { children: 'Behalve in de volgende gevallen:' }), '\n', (0, t.jsxs)(n.ul, { children: ['\n', (0, t.jsx)(n.li, { children: 'Het aanklikbare element en de ruimte om het element samen zijn tenminste 24 bij 24 pixels.' }), '\n', (0, t.jsx)(n.li, { children: 'Er is op de pagina een alternatief voor dit element wat wel groot genoeg is.' }), '\n', (0, t.jsx)(n.li, { children: 'Het aanklikbare element, bijvoorbeeld een link, is onderdeel van tekst.' }), '\n', (0, t.jsx)(n.li, { children: 'De browser bepaalt de grootte van het element en dit kan niet gewijzigd worden.' }), '\n', (0, t.jsx)(n.li, { children: 'De kleine weergave is essentieel of wettelijk verplicht.' }), '\n'] })] });
   }
   function d(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
    return n ? (0, t.jsx)(n, { ...e, children: (0, t.jsx)(o, { ...e }) }) : o(e);
   }
   const c = { title: 'WCAG-succescriterium 2.5.8 Grootte van het aanwijsgebied (minimum)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.8 Grootte van het aanwijsgebied (minimum)', pagination_label: 'WCAG-succescriterium 2.5.8 Grootte van het aanwijsgebied (minimum)', description: 'Zorg ervoor dat de aanklikbare elementen op een pagina groot genoeg zijn om makkelijk aan te klikken met een muis of vinger. Hierbij geldt dat het aan te klikken gebied ten minste 24 bij 24 pixels groot is.', slug: '2.5.8', keywords: ['WCAG'] },
    g = void 0,
    u = { id: 'wcag/2.5.08', title: 'WCAG-succescriterium 2.5.8 Grootte van het aanwijsgebied (minimum)', description: 'Zorg ervoor dat de aanklikbare elementen op een pagina groot genoeg zijn om makkelijk aan te klikken met een muis of vinger. Hierbij geldt dat het aan te klikken gebied ten minste 24 bij 24 pixels groot is.', source: '@site/docs/wcag/2.5.08.mdx', sourceDirName: 'wcag', slug: '/wcag/2.5.8', permalink: '/en/wcag/2.5.8', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.5.08.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.5.8 Grootte van het aanwijsgebied (minimum)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.8 Grootte van het aanwijsgebied (minimum)', pagination_label: 'WCAG-succescriterium 2.5.8 Grootte van het aanwijsgebied (minimum)', description: 'Zorg ervoor dat de aanklikbare elementen op een pagina groot genoeg zijn om makkelijk aan te klikken met een muis of vinger. Hierbij geldt dat het aan te klikken gebied ten minste 24 bij 24 pixels groot is.', slug: '2.5.8', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', permalink: '/en/wcag/2.5.7' }, next: { title: 'WCAG-succescriterium 3.1.1 Taal van de pagina', permalink: '/en/wcag/3.1.1' } },
    m = {},
    h = [
