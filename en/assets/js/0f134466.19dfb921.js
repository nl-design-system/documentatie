...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  6368: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => z, contentTitle: () => w, default: () => C, frontMatter: () => y, metadata: () => N, toc: () => Z });
   var r = l(52676),
    o = l(24785),
    t = l(66771),
    s = l(81014);
   ...
   const y = { title: 'Placeholders in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Placeholders', sidebar_position: 9, pagination_label: 'Placeholders in een formulier', description: 'Richtlijnen voor het ontwerp en de code van placeholders in een formulier.', keywords: ['placeholders', 'formulier', 'design', 'code'] },
    w = 'Placeholders in een formulier',
    N = { id: 'richtlijnen/formulieren/placeholders', title: 'Placeholders in een formulier | Richtlijnen', description: 'Richtlijnen voor het ontwerp en de code van placeholders in een formulier.', source: '@site/docs/richtlijnen/formulieren/placeholders.mdx', sourceDirName: 'richtlijnen/formulieren', slug: '/richtlijnen/formulieren/placeholders', permalink: '/en/richtlijnen/formulieren/placeholders', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/placeholders.mdx', tags: [], version: 'current', sidebarPosition: 9, frontMatter: { title: 'Placeholders in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Placeholders', sidebar_position: 9, pagination_label: 'Placeholders in een formulier', description: 'Richtlijnen voor het ontwerp en de code van placeholders in een formulier.', keywords: ['placeholders', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Meerdere stappen', permalink: '/en/richtlijnen/formulieren/meerdere-stappen' }, next: { title: 'Zorg dat het formulier werkt met een toetsenbord', permalink: '/en/richtlijnen/formulieren/toetsenbord' } },
    z = {},
    Z = [];
   function S(e) {
    const n = { a: 'a', h1: 'h1', li: 'li', p: 'p', strong: 'strong', ul: 'ul', ...(0, o.a)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', (0, r.jsx)(n.h1, { id: 'placeholders-in-een-formulier', children: 'Placeholders in een formulier' }), '\n', (0, r.jsx)(n.p, { children: 'Een placeholder geeft de gebruiker een korte hint over het verwachte type gegevens dat in het formulierveld moet worden.' }), '\n', (0, r.jsxs)(n.p, { children: ['Een ', (0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/labels/', children: 'label' }), ' vertelt ', (0, r.jsx)(n.strong, { children: 'wat' }), ' je moet invullen en een ', (0, r.jsx)(n.a, { href: 'https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/placeholder', children: 'placeholder' }), ' vertelt wat voor ', (0, r.jsx)(n.strong, { children: 'soort gegevens' }), ' in een veld wordt verwacht. Voor een e-mailveld kan het label bijvoorbeeld "Jouw e-mailadres" zijn en de placeholder "', (0, r.jsx)(n.a, { href: 'mailto:naam@voorbeeld.com', children: 'naam@voorbeeld.com' }), '".'] }), '\n', (0, r.jsx)(n.p, { children: 'Voor de toegankelijkheid en gebruiksvriendelijkheid van een placeholder is het volgende van belang:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: [(0, r.jsx)(n.a, { href: '#een-placeholder-is-geen-vervanger-van-een-label', children: 'Een placeholder is geen vervanger van een label' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: [(0, r.jsx)(n.a, { href: '#voorkom-verwarring-bij-de-gebruiker', children: 'Voorkom verwarring bij de gebruiker' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: [(0, r.jsx)(n.a, { href: '#zorg-voor-een-goed-kleurcontrast-van-de-placeholdertekst', children: 'Zorg voor een voldoende kleurcontract voor de placeholdertekst' }), '.'] }), '\n'] }), '\n', (0, r.jsx)(b, {}), '\n', (0, r.jsx)(v, {}), '\n', (0, r.jsx)(f, {}), '\n', (0, r.jsx)(k, {}), '\n', (0, r.jsx)(d, {}), '\n', (0, r.jsx)(i, {}), '\n', (0, r.jsx)(m, {}), '\n', (0, r.jsx)(p, {})] });
   }
   function C(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
  ...
  66771: (e, n, l) => {
   ...
   const b = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: b = !1, displayCode: x = !0, children: k, container: _ = 'document', language: f, designTokens: y } = e,
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await c.ZP.format(z, { parser: f, plugins: [t.Z, s.ZP, a.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), S(Z);
     })();
    }, [z]);
    const P = (0, d.useId)();
    let X = d.Fragment;
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       w && (0, m.jsx)('div', { className: (0, o.Z)(p['nlds-canvas__example']), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, m.jsx)(X, { children: (0, m.jsx)(r.pu, { children: w }) }) }) }),
       x &&
        (0, m.jsx)('div', {
       ...
       x &&
        (0, m.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(u.u, { syntax: f, textContent: Z, trim: !0 }),
          l &&
           (0, m.jsx)('div', {
