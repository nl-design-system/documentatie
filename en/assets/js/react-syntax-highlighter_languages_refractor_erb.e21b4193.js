         ...
         !(function s(o) {
          for (var l = 0; l < o.length && !(a >= i.length); l++) {
           ...
           if ("string" == typeof u || (u.content && "string" == typeof u.content)) {
            ...
            if (b > -1) {
             ++a;
             var f = c.substring(0, b),
              m = new e.Token(r, e.tokenize(d, t.grammar), "language-" + r, d),
              y = c.substring(b + p.length),
              k = [];
             f && k.push.apply(k, s([f])), k.push(m), y && k.push.apply(k, s([y])), "string" == typeof u ? o.splice.apply(o, [l, 1].concat(k)) : (u.content = k);
            }
