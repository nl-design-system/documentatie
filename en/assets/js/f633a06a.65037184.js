 ...
 [85270],
 {
  42438: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    s = n(60851);
   const o = { title: 'Link list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link list', pagination_label: 'Link list', description: 'Een lijst met gerelateerde links naar andere pagina\u2019s of websites.', slug: '/link-list', sidebar_custom_props: { illustration: 'LinkListSketch' } },
    a = void 0,
    l = { id: 'componenten/link-list/index', title: 'Link list', description: 'Een lijst met gerelateerde links naar andere pagina\u2019s of websites.', source: '@site/docs/componenten/link-list/index.mdx', sourceDirName: 'componenten/link-list', slug: '/link-list', permalink: '/en/link-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/link-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Link list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link list', pagination_label: 'Link list', description: 'Een lijst met gerelateerde links naar andere pagina\u2019s of websites.', slug: '/link-list', sidebar_custom_props: { illustration: 'LinkListSketch' } }, sidebar: 'componenten', previous: { title: 'Link', permalink: '/en/link' }, next: { title: 'Modal dialog', permalink: '/en/modal-dialog' } },
    u = {},
    d = [
    ...
    h = 'Link list',
    j = 'Een lijst met gerelateerde links naar andere pagina\u2019s of websites.',
    y = 'LinkListSketch',
    g = 264,
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    L = 'task-list-item__marker-label_XAyi',
    A = (e) => {
     let { children: t } = e;
    ...
    S = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: L, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.aC, { role: 'presentation', children: n }), (0, u.jsx)(v.nv, { children: r })] })] });
    };
   var z = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => z.e9.includes(e.id)),
      s = c && z.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: s.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], y[`definition-of-done--${(0, z.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
         ...
         children: [
          (0, u.jsx)(A, {
           children: e.tasks.map((e) => {
            ...
            return (0, u.jsx)(S, { checked: t, title: n, description: (0, z.Q6)(r) }, r);
           }),
          }),
