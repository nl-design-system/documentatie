(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [83373],
 {
  4869: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => d, component: () => g, contentTitle: () => a, default: () => k, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => m, metadata: () => l, title: () => h, toc: () => u });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Calendar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Calendar', pagination_label: 'Calendar', description: 'Toont een op maat gemaakte kalender die de mogelijkheid biedt om uit een beschikbare datum te kiezen.', slug: '/Calendar', sidebar_custom_props: { illustration: 'CalendarSketch' }, keywords: ['calendar', 'dag', 'dagen', 'date', 'date picker', 'datepicker', 'datum', 'datumprikker', 'day', 'days', 'kalender', 'maand', 'month', 'week', 'weeks', 'weken'] },
    a = void 0,
    l = { id: 'componenten/calendar/index', title: 'Calendar', description: 'Toont een op maat gemaakte kalender die de mogelijkheid biedt om uit een beschikbare datum te kiezen.', source: '@site/docs/componenten/calendar/index.mdx', sourceDirName: 'componenten/calendar', slug: '/Calendar', permalink: '/en/Calendar', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/calendar/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Calendar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Calendar', pagination_label: 'Calendar', description: 'Toont een op maat gemaakte kalender die de mogelijkheid biedt om uit een beschikbare datum te kiezen.', slug: '/Calendar', sidebar_custom_props: { illustration: 'CalendarSketch' }, keywords: ['calendar', 'dag', 'dagen', 'date', 'date picker', 'datepicker', 'datum', 'datumprikker', 'day', 'days', 'kalender', 'maand', 'month', 'week', 'weeks', 'weken'] }, sidebar: 'componenten', previous: { title: 'Button', permalink: '/en/button' }, next: { title: 'Card as link', permalink: '/en/card-as-link' } },
    d = {},
    u = [
    ...
    h = 'Calendar',
    j = 'Toont een op maat gemaakte kalender die de mogelijkheid biedt om uit een beschikbare datum te kiezen.',
    y = 'CalendarSketch',
    m = 199,
   ...
   const s = (e) => {
    ...
    l = (e) => {
     ...
     const d = (e) => ('article' === a ? (0, o.jsx)('article', { ...e }) : 'section' === a ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      u = (0, o.jsx)(d, { className: (0, i.Z)(c.cardgroup__card, c[`cardgroup__card--${n}`], s), children: l });
  ...
  60851: (e, t, n) => {
   ...
   var r = n(47027),
    ...
    l = n(32636),
    d = n(52676);
   const u = { figma: (0, d.jsx)(c.Z, {}), github: (0, d.jsx)(o.Z, {}), npm: (0, d.jsx)(s.Z, {}), storybook: (0, d.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const k = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    b = (e) => {
     ...
     return (0, d.jsxs)('hgroup', { className: (0, i.Z)(k['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, d.jsx)('h1', { className: (0, i.Z)(k['nlds-inline-heading-group__heading']), children: t }), r && (0, d.jsxs)('p', { className: (0, i.Z)(k['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var v = n(93706),
    _ = n(49427);
   const f = 'task-list_hh8j',
    ...
    A = (e) => {
     let { children: t } = e;
     return (0, d.jsx)('ul', { className: f, children: t });
    },
    C = (e) => {
     let { checked: t, title: n, description: r } = e;
     return (0, d.jsxs)('li', { className: (0, i.Z)(x), children: [(0, d.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, d.jsx)('span', { className: z, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, d.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(v.aC, { role: 'presentation', children: n }), (0, d.jsx)(v.nv, { children: r })] })] });
    };
   var S = n(14669);
   const T = (e) => {
         ...
         children: [
          (0, d.jsx)(A, {
           children: e.tasks.map((e) => {
            ...
            return (0, d.jsx)(C, { checked: t, title: n, description: (0, S.Q6)(r) }, r);
           }),
          }),
                 ...
                 children: [
                  ...
                  (0, d.jsx)(r.Mc, {
                   children: o.map((e) => {
                    ...
                    return (0, d.jsxs)(r.k7, { href: e.value, children: [(0, d.jsx)(h, { brand: t }), ' ', n] }, e.id);
                   }),
                  }),
                 ],
                }),
    ...
    M = (e) => {
     ...
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(b, { level: n, suffix: c && (0, d.jsx)(p.y, { state: c }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  42677: (e, t, n) => {
   'use strict';
