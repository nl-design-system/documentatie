  ...
  23952: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(_), children: [(0, u.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(k.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var M = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => M.e9.includes(e.id)),
      o = c && M.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(g['definition-of-done'], e && g[`definition-of-done--${(0, M.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, u.jsx)(z, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(A, { checked: t, title: n, description: (0, M.Q6)(r) }, r);
            }),
           }),
