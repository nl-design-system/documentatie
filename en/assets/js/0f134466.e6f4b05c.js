...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  6368: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => z, contentTitle: () => w, default: () => S, frontMatter: () => y, metadata: () => N, toc: () => Z });
   var r = l(52676),
    o = l(24785),
    t = l(66771),
    s = l(81014);
  ...
  66771: (e, n, l) => {
   ...
   const b = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await c.ZP.format(z, { parser: f, plugins: [t.Z, s.ZP, a.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(Z);
     })();
    }, [z]);
    const P = (0, d.useId)();
    let W = d.Fragment;
    return (
     'paragraph' === _ ? (W = g) : 'document' === _ ? (W = v) : 'surface' === _ && (W = j),
     (0, m.jsxs)('div', {
