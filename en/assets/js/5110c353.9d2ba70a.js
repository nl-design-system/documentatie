(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [40284],
 {
  48211: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => Q, component: () => re, contentTitle: () => Y, default: () => oe, description: () => ne, frontMatter: () => K, issueNumber: () => te, metadata: () => J, title: () => ee, toc: () => q });
   var r = t(52676),
    i = t(24785),
    o = t(87176),
    s = t(90786),
   ...
   const u = [
    ...
    h = (new Map(u.map((e) => [e.sc, e])), [{ sc: '4.1.1', title: 'Parsing', url: 'https://www.w3.org/TR/WCAG21/#parsing', conformance: 'A', nldesignsystem: !0, nl: { title: 'Parsen' }, since: 'WCAG22' }]),
    g = [...u.map((e) => ({ ...e, url: e.url.replace(/WCAG21/i, 'WCAG22') })), { sc: '2.4.11', title: 'Focus Not Obscured (Minimum)', url: 'https://www.w3.org/TR/WCAG22/#focus-not-obscured-minimum', conformance: 'AA', nl: { title: 'Focus niet bedekt (minimum)' }, since: 'WCAG22' }, { sc: '2.4.12', title: 'Focus Not Obscured (Enhanced)', url: 'https://www.w3.org/TR/WCAG22/#focus-not-obscured-enhanced', conformance: 'AAA', nl: { title: 'Focus niet bedekt (uitgebreid)' }, since: 'WCAG22' }, { sc: '2.4.13', title: 'Focus Appearance', url: 'https://www.w3.org/TR/WCAG22/#focus-appearance', conformance: 'AAA', nldesignsystem: !0, nl: { title: 'Focusweergave' }, since: 'WCAG22' }, { sc: '2.5.7', title: 'Dragging Movements', url: 'https://www.w3.org/TR/WCAG22/#dragging-movements', conformance: 'AA', nldesignsystem: !0, nl: { title: 'Sleepbewegingen' }, since: 'WCAG22' }, { sc: '2.5.8', title: 'Target Size (minimum)', url: 'https://www.w3.org/TR/WCAG22/#target-size-minimum', conformance: 'AA', nldesignsystem: !0, nl: { title: 'Grootte van het aanwijsgebied (minimum)' }, since: 'WCAG22' }, { sc: '3.2.6', title: 'Consistent Help', url: 'https://www.w3.org/TR/WCAG22/#consistent-help', conformance: 'A', nldesignsystem: !0, nl: { title: 'Consistente hulp' }, since: 'WCAG22' }, { sc: '3.3.7', title: 'Redundant Entry', url: 'https://www.w3.org/TR/WCAG22/#redundant-entry', conformance: 'A', nldesignsystem: !0, nl: { title: 'Overbodige invoer' }, since: 'WCAG22' }, { sc: '3.3.8', title: 'Accessible Authentication (Minimum)', url: 'https://www.w3.org/TR/WCAG22/#accessible-authentication-minimum', conformance: 'AA', nldesignsystem: !0, nl: { title: 'Toegankelijke authenticatie (minimum)' }, since: 'WCAG22' }, { sc: '3.3.9', title: 'Accessible Authentication (Enhanced)', url: 'https://www.w3.org/TR/WCAG22/#accessible-authentication-enhanced', conformance: 'AAA', nl: { title: 'Toegankelijke authenticatie (uitgebreid)' }, since: 'WCAG22' }]
     .map((e) => ({ ...e, fragment: new URL(e.url).hash.replace(/^#/, '') }))
     .filter((e) => {
      let { sc: n } = e;
      return !h.find((e) => e.sc === n);
     }),
    m = new Map(g.map((e) => [e.sc, e])),
    j = (e) => {
     let { sc: n, checked: t, description: i, headingLevel: o = 3 } = e;
     const s = m.get(n),
      u = s ? `${n} ${s.nl?.title}` : n;
     return (0, r.jsxs)('li', { className: (0, l.Z)(d.Z['task-list-item']), children: [(0, r.jsxs)('div', { className: (0, l.Z)(d.Z['task-list-item__marker'], t && d.Z['task-list-item__marker--checked']), children: [(0, r.jsx)('span', { className: d.Z['task-list-item__marker-label'], children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, r.jsx)(a.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, r.jsxs)('div', { children: [(0, r.jsx)(c.X6, { appearance: 'utrecht-heading-3', level: o, children: (0, r.jsx)(c.rU, { href: `/wcag/${n}`, children: u }) }), i] })] });
    },
    p = (e) => {
     let { headingLevel: n, items: t } = e;
     return (0, r.jsx)('ul', { className: d.Z['task-list'], children: t.map((e, t) => (0, r.jsx)(j, { headingLevel: n, ...e }, t)) });
    };
   function w(e) {
   ...
   function _(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, i.a)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Het label van de button bestaat uit gewone tekst, niet uit een afbeelding van tekst. Tenzij om een logo gaat, zoals het DigiD-logo.' }), '\n', (0, r.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: (0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/buttons/afbeelding-als-button', children: 'Afbeeldingen als buttons' }) }), '\n'] })] });
   }
   function G(e = {}) {
    const { wrapper: n } = { ...(0, i.a)(), ...e.components };
   ...
   function S(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Wanneer een button de toetsenbordfocus krijgt is de focus zichtbaar.' }), '\n', (0, r.jsxs)(n.p, { children: ['Verberg de standaard browserfocusstijl nooit met ', (0, r.jsx)(n.code, { children: 'outline:none' }), ' zonder er een goede focusstijl voor in de plaats te zetten die rekening houdt met goede zichtbaarheid. Maak de focusrand ten minste 2 pixels dik, met een contrast van minimaal 3:1, zie ', (0, r.jsx)(n.a, { href: '/wcag/2.4.13', children: 'WCAG-succescriterium 2.4.13 Focusweergave' }), '.'] }), '\n', (0, r.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: (0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/visueel-ontwerp/focus-goed-zichtbaar/', children: 'Maak toetsenbord focus goed zichtbaar' }) }), '\n', (0, r.jsx)(n.li, { children: (0, r.jsx)(n.a, { href: '/richtlijnen/stijl/kleuren/voorkeuren', children: 'Let op voorkeursinstellingen voor kleur' }) }), '\n', (0, r.jsx)(n.li, { children: (0, r.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/voorkeur', children: 'Zorg voor voldoende kleurcontrast voor niet-tekstuele content' }) }), '\n'] })] });
   }
   function F(e = {}) {
    const { wrapper: n } = { ...(0, i.a)(), ...e.components };
   ...
   function V(e) {
    const n = { a: 'a', code: 'code', li: 'li', p: 'p', ul: 'ul', ...(0, i.a)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(n.p, { children: ['Zorg ervoor dat de button een minimale grootte heeft van 44 bij 44 pixels. Definieer hoogte en de breedte niet in ', (0, r.jsx)(n.code, { children: 'px' }), ', maar gebruik een relatieve waarde als ', (0, r.jsx)(n.code, { children: 'em' }), ' of ', (0, r.jsx)(n.code, { children: 'rem' }), '. Anders kan de button niet goed meegroeien wanneer de gebruiker inzoomt.'] }), '\n', (0, r.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: (0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/visueel-ontwerp/invoerveld-goed-aanklikbaar/', children: 'Maak aanklikbare formuliervelden groot genoeg' }) }), '\n', (0, r.jsx)(n.li, { children: (0, r.jsx)(n.a, { href: '/richtlijnen/stijl/ruimte/interactieve-elementen', children: 'Reserveer ruimte tussen interactieve elementen' }) }), '\n'] })] });
   }
   function H(e = {}) {
    const { wrapper: n } = { ...(0, i.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(V, { ...e }) }) : V(e);
   ...
   function O(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(n.p, { children: ['Als een buttontekst in een andere taal is dan de taal van de pagina, dan heeft het element een ', (0, r.jsx)(n.code, { children: 'lang' }), '-attribuut met de juiste taalcode.'] }), '\n', (0, r.jsx)(n.p, { children: 'Denk bijvoorbeeld aan buttons voor het veranderen van de taal van een pagina, bij meertalige websites.' })] });
   }
   function E(e = {}) {
    const { wrapper: n } = { ...(0, i.a)(), ...e.components };
   ...
   function I(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, i.a)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Buttons met gelijke functies hebben hetzelfde uiterlijk en hetzelfde label.' }), '\n', (0, r.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: (0, r.jsx)(n.a, { href: '/richtlijnen/stijl/iconen/respecteer-conventies', children: 'Respecteer conventies' }) }), '\n'] })] });
   }
   function U(e = {}) {
    const { wrapper: n } = { ...(0, i.a)(), ...e.components };
   ...
   const K = { title: 'Button', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Button', pagination_label: 'Button', description: 'Biedt de mogelijkheid om een actie uit te voeren.', slug: '/button', keywords: ['actie', 'action', 'action button', 'activate', 'aria-expanded', 'aria-haspopup', 'aria-pressed', 'bezig', 'busy', 'button', 'buttons', 'call to action', 'click', 'cta', 'disabled', 'icon button', 'indrukken', 'klikken', 'knop', 'knoppen', 'press', 'pressed', 'send', 'submit', 'toggle', 'toggle button', 'uitgeschakeld', 'versturen', 'verzenden'] },
    ...
    ee = 'Button',
    ne = 'Biedt de mogelijkheid om een actie uit te voeren.',
    te = 38,
    re = o.find((e) => e.number === te);
   function ie(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(s.Rv, { component: re, headingLevel: 1, description: ne }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, r.jsx)(s.cN, { component: re, headingLevel: 3 }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, r.jsx)(s.W, { component: re, headingLevel: 3 }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'acceptatiecriteria', children: 'Acceptatiecriteria' }),
      '\n',
      (0, r.jsx)(n.h3, { id: 'wcag-2-succescriterium', children: 'WCAG 2 Succescriterium' }),
      '\n',
      (0, r.jsx)(p, {
       headingLevel: 4,
       items: [
        { sc: '1.1.1', checked: !0, description: (0, r.jsx)(f, {}) },
        { sc: '1.4.3', checked: !0, description: (0, r.jsx)(A, {}) },
        { sc: '1.4.4', checked: !0, description: (0, r.jsx)(T, {}) },
        { sc: '1.4.5', checked: !0, description: (0, r.jsx)(G, {}) },
        { sc: '1.4.11', checked: !0, description: (0, r.jsx)(k, {}) },
        { sc: '1.4.12', checked: !0, description: (0, r.jsx)(y, {}) },
        { sc: '2.1.1', checked: !0, description: (0, r.jsx)(R, {}) },
        { sc: '2.4.6', checked: !0, description: (0, r.jsx)(L, {}) },
        { sc: '2.4.7', checked: !0, description: (0, r.jsx)(F, {}) },
        { sc: '2.4.13', checked: !0, description: (0, r.jsx)(N, {}) },
        { sc: '2.5.2', checked: !0, description: (0, r.jsx)(P, {}) },
        { sc: '2.5.3', checked: !0, description: (0, r.jsx)(B, {}) },
        { sc: '2.5.5', checked: !0, description: (0, r.jsx)(H, {}) },
        { sc: '3.1.2', checked: !0, description: (0, r.jsx)(E, {}) },
        { sc: '3.2.4', checked: !0, description: (0, r.jsx)(U, {}) },
      ...
      '\n',
      (0, r.jsx)(s.vM, { component: re, headingLevel: 3 }),
     ],
    });
   }
   function oe(e = {}) {
    const { wrapper: n } = { ...(0, i.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(ie, { ...e }) }) : ie(e);
   }
  },
  98507: (e, n, t) => {
  ...
  68963: (e, n, t) => {
   ...
   const c = (e) => {
     ...
     return (0, s.jsx)('div', { className: (0, i.Z)(o.card__illustration, n && o['card__illustration--background'], r), ...c, children: t });
    },
    a = (e) => (0, s.jsx)('div', { className: (0, i.Z)(o.card__content), ...e }),
    l = (e) => {
     let { href: n, appearance: t, className: c, component: a = 'div', children: l } = e;
     const d = (e) => ('article' === a ? (0, s.jsx)('article', { ...e }) : 'section' === a ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      u = (0, s.jsx)(d, { className: (0, i.Z)(o.cardgroup__card, o[`cardgroup__card--${t}`], c), children: l });
     return n ? (0, s.jsx)(r.rU, { href: n, boxContent: !0, className: o.cardgroup__link, children: u }) : u;
    },
    d = (e) => {
     let { appearance: n = 'medium', children: t, className: r } = e;
     return (0, s.jsx)('div', { className: (0, i.Z)(o.cardgroup, o[`cardgroup--${n}`], r), children: t });
    };
  },
  90786: (e, n, t) => {
   'use strict';
   t.d(n, { cN: () => C, vM: () => _, W: () => T, Rv: () => G });
   var r = t(56150),
    i = t(4814),
    o = (t(75271), t(39854)),
    s = t(7522),
   ...
   const y = (e) => {
     let { children: n } = e;
     return (0, d.jsx)('ul', { className: v.Z['task-list'], children: n });
    },
    x = (e) => {
     let { checked: n, children: t, title: r, description: o, headingLevel: s = 3 } = e;
     return (0, d.jsxs)('li', { className: (0, i.Z)(v.Z['task-list-item']), children: [(0, d.jsxs)('div', { className: (0, i.Z)(v.Z['task-list-item__marker'], n && v.Z['task-list-item__marker--checked']), children: [(0, d.jsx)('span', { className: v.Z['task-list-item__marker-label'], children: n ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), n && (0, d.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(b.X6, { appearance: 'utrecht-heading-3', level: s, children: r }), o, t] })] });
    };
   var A = t(14669);
   const C = (e) => {
     let { component: n, headingLevel: t } = e;
     const o = n && n.projects.filter((e) => A.e9.includes(e.id)),
      s = o && A.e9.map((e) => o.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
       sections: s.map((e) => ({
        className: (0, i.Z)(m['definition-of-done'], e && m[`definition-of-done--${(0, A.mA)(e.title)}`]),
        headingLevel: t,
        expanded: !1,
          ...
          children: [
           (0, d.jsx)(y, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(x, { checked: n, title: t, description: (0, A.Q6)(r) }, r);
            }),
           }),
    ...
    G = (e) => {
     ...
     const o = n && A.$3[n.relayStep];
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(f.V, { level: t, suffix: o && (0, d.jsx)(w.y, { state: o }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, n, t) => {
   'use strict';
   ...
   const a = (e) => {
    let { state: n } = e;
    const t = (0, s.mA)(n);
    return (0, c.jsx)(r.Ou, { className: (0, i.Z)(o['estafette-badge'], t && o[`estafette-badge--${t}`]), children: n });
   };
  },
  72657: (e, n, t) => {
   'use strict';
   ...
   var o = t(52676);
   const s = (e) => {
    let { children: n, className: t, level: s = 1, suffix: c, ...a } = e;
    return (0, o.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${s}`, t), ...a, children: [(0, o.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: n }), c && (0, o.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [c ? ' ' : '', c] })] });
   };
  },
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, BA: () => c, Q6: () => o, e9: () => s, mA: () => i });
