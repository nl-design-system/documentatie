(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [17903],
 {
  74781: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => a, default: () => f, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => g, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    c = n(24785),
    i = n(31612),
    o = n(60851);
   const s = { title: 'Page footer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Page footer', pagination_label: 'Page footer', description: ' ', slug: '/page-footer', sidebar_custom_props: { illustration: 'PageFooterSketch' } },
    a = void 0,
    u = { id: 'componenten/page-footer/index', title: 'Page footer', description: ' ', source: '@site/docs/componenten/page-footer/index.mdx', sourceDirName: 'componenten/page-footer', slug: '/page-footer', permalink: '/en/page-footer', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/page-footer/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Page footer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Page footer', pagination_label: 'Page footer', description: ' ', slug: '/page-footer', sidebar_custom_props: { illustration: 'PageFooterSketch' } }, sidebar: 'componenten', previous: { title: 'Ordered list', permalink: '/en/ordered-list' }, next: { title: 'Page header', permalink: '/en/page-header' } },
    l = {},
    d = [
