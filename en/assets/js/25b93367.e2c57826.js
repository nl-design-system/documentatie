 ...
 [98634],
 {
  ...
  23952: (e, t, n) => {
   ...
   const S = (e) => {
     ...
     const c = t && t.projects.filter((e) => L.e9.includes(e.id)),
      o = c && L.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(g['definition-of-done'], e && g[`definition-of-done--${(0, L.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, u.jsx)(z, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(A, { checked: t, title: n, description: (0, L.Q6)(r) }, r);
            }),
           }),
