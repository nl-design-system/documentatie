...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [4893],
 {
  35106: (e, n, i) => {
   ...
   const g = { title: 'WCAG-succescriterium 4.1.1 Parsen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '4.1.1 Parsen', pagination_label: 'WCAG-succescriterium 4.1.1 Parsen', description: 'Zorg dat er geen fouten in de HTML-code zijn.', slug: '4.1.1', keywords: ['WCAG'] },
    p = void 0,
    m = { id: 'wcag/4.1.01', title: 'WCAG-succescriterium 4.1.1 Parsen', description: 'Zorg dat er geen fouten in de HTML-code zijn.', source: '@site/docs/wcag/4.1.01.mdx', sourceDirName: 'wcag', slug: '/wcag/4.1.1', permalink: '/en/wcag/4.1.1', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/4.1.01.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 4.1.1 Parsen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '4.1.1 Parsen', pagination_label: 'WCAG-succescriterium 4.1.1 Parsen', description: 'Zorg dat er geen fouten in de HTML-code zijn.', slug: '4.1.1', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.3.9 Toegankelijke authenticatie (uitgebreid)', permalink: '/en/wcag/3.3.9' }, next: { title: 'WCAG-succescriterium 4.1.2 Naam, rol, waarde', permalink: '/en/wcag/4.1.2' } },
    j = {},
    v = [
