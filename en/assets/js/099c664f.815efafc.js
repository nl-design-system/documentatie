...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  16827: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => h, contentTitle: () => u, default: () => m, frontMatter: () => d, metadata: () => g, toc: () => p });
   var r = t(52676),
    i = t(24785),
    s = t(71595),
    l = t(45054),
   ...
   const d = { title: 'WCAG-succescriterium 1.4.4 Herschalen van tekst', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.4 Herschalen van tekst', pagination_label: 'WCAG-succescriterium 1.4.4 Herschalen van tekst', description: 'De gebruiker moet tekst twee keer (200%) kunnen vergroten en nog steeds goed kunnen lezen.', slug: '1.4.4', keywords: ['WCAG'] },
    u = void 0,
    g = { id: 'wcag/1.4.04', title: 'WCAG-succescriterium 1.4.4 Herschalen van tekst', description: 'De gebruiker moet tekst twee keer (200%) kunnen vergroten en nog steeds goed kunnen lezen.', source: '@site/docs/wcag/1.4.04.mdx', sourceDirName: 'wcag', slug: '/wcag/1.4.4', permalink: '/en/wcag/1.4.4', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.04.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.4.4 Herschalen van tekst', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.4 Herschalen van tekst', pagination_label: 'WCAG-succescriterium 1.4.4 Herschalen van tekst', description: 'De gebruiker moet tekst twee keer (200%) kunnen vergroten en nog steeds goed kunnen lezen.', slug: '1.4.4', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.4.3 Contrast (minimum)', permalink: '/en/wcag/1.4.3' }, next: { title: 'WCAG-succescriterium 1.4.5 Afbeeldingen van tekst', permalink: '/en/wcag/1.4.5' } },
    h = {},
    p = [
  ...
  72657: (e, n, t) => {
   ...
   const l = (e) => {
    ...
    return (0, s.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${l}`, t), ...a, children: [(0, s.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: n }), o && (0, s.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [o ? ' ' : '', o] })] });
   };
  },
  71595: (e, n, t) => {
   t.d(n, { j: () => a });
   ...
   const a = (e) => {
    ...
    return (0, o.jsx)(i.V, { className: s, suffix: t && (0, o.jsx)(r.Ou, { className: l, children: t }), ...a, children: n });
   };
  },
  24785: (e, n, t) => {
   t.d(n, { Z: () => o, a: () => l });
