 ...
 [24366],
 {
  21311: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(7617),
    o = n(4460);
   const s = { title: 'Radio group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Radio group', pagination_label: 'Radio group', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren uit een lijst.', slug: '/radio-group', keywords: ['fieldset', 'formulierveld', 'keuze', 'keuzerondje', 'optie', 'opties', 'option', 'option button', 'radio', 'radio button', 'radio group', 'radioknop', 'radios'] },
    a = void 0,
    u = { id: 'componenten/radio-group/index', title: 'Radio group', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren uit een lijst.', source: '@site/docs/componenten/radio-group/index.mdx', sourceDirName: 'componenten/radio-group', slug: '/radio-group', permalink: '/en/radio-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/radio-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Radio group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Radio group', pagination_label: 'Radio group', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren uit een lijst.', slug: '/radio-group', keywords: ['fieldset', 'formulierveld', 'keuze', 'keuzerondje', 'optie', 'opties', 'option', 'option button', 'radio', 'radio button', 'radio group', 'radioknop', 'radios'] }, sidebar: 'componenten', previous: { title: 'Radio button', permalink: '/en/radio-button' }, next: { title: 'Range', permalink: '/en/range' } },
    l = {},
    d = [
