...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [3247],
 {
  ...
  22819: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => L, contentTitle: () => C, default: () => P, frontMatter: () => A, metadata: () => G, toc: () => S });
   var i = l(11527),
    r = l(27034),
    t = l(56108),
    a = l(73460),
