(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [20322],
 {
  69212: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => d, component: () => m, contentTitle: () => o, default: () => p, description: () => j, frontMatter: () => s, issueNumber: () => g, metadata: () => l, title: () => h, toc: () => u });
   var r = n(52676),
    i = n(24785),
    c = n(80719),
    a = n(90786);
   const s = { title: 'Case card', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Case card', pagination_label: 'Case card', description: 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.', slug: '/case-card', keywords: ['aanvraag', 'afgehandeld', 'afgerond', 'archief', 'archive', 'archived', 'bericht', 'beroep', 'bezwaar', 'card', 'case', 'case card', 'complaint', 'data', 'dossier', 'file', 'gearchiveerd', 'in behandeling', 'kenmerk', 'klacht', 'lopende zaak', 'melding', 'Mijn Services', 'MijnOmgeving', 'MijnZaken', 'navigate', 'navigatie', 'navigation', 'navigeren', 'permit', 'procedure', 'record', 'request', 'response', 'terugkoppeling', 'tile', 'vergunning', 'zaak', 'zaak informatie', 'zaaknummer', 'zaaksysteem'] },
    o = void 0,
    l = { id: 'componenten/case-card/index', title: 'Case card', description: 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.', source: '@site/docs/componenten/case-card/index.mdx', sourceDirName: 'componenten/case-card', slug: '/case-card', permalink: '/en/case-card', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/case-card/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Case card', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Case card', pagination_label: 'Case card', description: 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.', slug: '/case-card', keywords: ['aanvraag', 'afgehandeld', 'afgerond', 'archief', 'archive', 'archived', 'bericht', 'beroep', 'bezwaar', 'card', 'case', 'case card', 'complaint', 'data', 'dossier', 'file', 'gearchiveerd', 'in behandeling', 'kenmerk', 'klacht', 'lopende zaak', 'melding', 'Mijn Services', 'MijnOmgeving', 'MijnZaken', 'navigate', 'navigatie', 'navigation', 'navigeren', 'permit', 'procedure', 'record', 'request', 'response', 'terugkoppeling', 'tile', 'vergunning', 'zaak', 'zaak informatie', 'zaaknummer', 'zaaksysteem'] }, sidebar: 'componenten', previous: { title: 'Card as link', permalink: '/en/card-as-link' }, next: { title: 'Checkbox', permalink: '/en/checkbox' } },
    d = {},
    u = [
  ...
  68963: (e, t, n) => {
   'use strict';
   n.d(t, { Zb: () => l, aY: () => o, um: () => d, wu: () => s });
   var r = n(46506),
    i = n(4814);
   n(75271);
   const c = { cardgroup: 'cardgroup_0VVt', 'cardgroup--small': 'cardgroup--small_BDzz', 'cardgroup--medium': 'cardgroup--medium_xS6r', 'cardgroup--large': 'cardgroup--large_Tjo8', cardgroup__card: 'cardgroup__card_emnt', 'cardgroup__card--small': 'cardgroup__card--small_bxfC', 'cardgroup__card--large': 'cardgroup__card--large_PGe3', cardgroup__link: 'cardgroup__link_YISR', card__illustration: 'card__illustration_MVXv', 'card__illustration--background': 'card__illustration--background_cTcZ', card__content: 'card__content_LYKG' };
   var a = n(52676);
   const s = (e) => {
     let { background: t, children: n, className: r, ...s } = e;
     return (0, a.jsx)('div', { className: (0, i.Z)(c.card__illustration, t && c['card__illustration--background'], r), ...s, children: n });
    },
    o = (e) => (0, a.jsx)('div', { className: (0, i.Z)(c.card__content), ...e }),
    l = (e) => {
     let { href: t, appearance: n, className: s, component: o = 'div', children: l } = e;
     const d = (e) => ('article' === o ? (0, a.jsx)('article', { ...e }) : 'section' === o ? (0, a.jsx)('section', { ...e }) : (0, a.jsx)('div', { ...e })),
      u = (0, a.jsx)(d, { className: (0, i.Z)(c.cardgroup__card, c[`cardgroup__card--${n}`], s), children: l });
     return t ? (0, a.jsx)(r.rU, { href: t, boxContent: !0, className: c.cardgroup__link, children: u }) : u;
    },
    d = (e) => {
     let { appearance: t = 'medium', children: n, className: r } = e;
     return (0, a.jsx)('div', { className: (0, i.Z)(c.cardgroup, c[`cardgroup--${t}`], r), children: n });
    };
  },
  90786: (e, t, n) => {
   'use strict';
   n.d(t, { Gn: () => A, cN: () => z, W: () => N, Rv: () => S });
   var r = n(56150),
    i = n(4814),
    c = (n(75271), n(39854)),
    a = n(7522),
    ...
    l = n(32636),
    d = n(52676);
   const u = { figma: (0, d.jsx)(c.Z, {}), github: (0, d.jsx)(a.Z, {}), npm: (0, d.jsx)(s.Z, {}), storybook: (0, d.jsx)(o.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const _ = (e) => {
     let { children: t } = e;
     return (0, d.jsx)('ul', { className: f.Z['task-list'], children: t });
    },
    x = (e) => {
     let { checked: t, children: n, title: r, description: c, headingLevel: a = 3 } = e;
     return (0, d.jsxs)('li', { className: (0, i.Z)(f.Z['task-list-item']), children: [(0, d.jsxs)('div', { className: (0, i.Z)(f.Z['task-list-item__marker'], t && f.Z['task-list-item__marker--checked']), children: [(0, d.jsx)('span', { className: f.Z['task-list-item__marker-label'], children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, d.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(v.X6, { appearance: 'utrecht-heading-3', level: a, children: r }), c, n] })] });
    };
   var w = n(14669);
   const z = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => w.e9.includes(e.id)),
      a = c && w.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, d.jsx)(r.a2, {
       appearance: '',
       sections: a.map((e) => ({
        className: (0, i.Z)(g['definition-of-done'], e && g[`definition-of-done--${(0, w.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, d.jsx)(_, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(x, { checked: t, title: n, description: (0, w.Q6)(r) }, r);
            }),
           }),
          ...
          .map((e) => {
           const t = e.tasks.find((e) => {
            ...
            s = e.tasks.filter((e) => {
             ...
             return a.has(t) && URL.canParse(n) && 'https:' === new URL(n).protocol;
            });
           return (0, d.jsx)(
            j.Zb,
            {
    ...
    A = (e) => {
     let { component: t } = e;
     return t && (0, d.jsxs)(r.nv, { children: ['De ', t.title, ' component staat bij NL Design System in de', ' ', (0, d.jsx)(r.rU, { href: t.backlog, children: 'levende backlog' }), ', heb je een concrete eisen of wensen voor dit component? Laat het ons dan daar weten!'] });
    },
    S = (e) => {
     let { component: t, headingLevel: n, description: i } = e;
     const c = t && w.$3[t.relayStep];
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(k.V, { level: n, suffix: c && (0, d.jsx)(p.y, { state: c }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, t, n) => {
   'use strict';
  ...
  72657: (e, t, n) => {
   ...
   var c = n(52676);
   const a = (e) => {
    let { children: t, className: n, level: a = 1, suffix: s, ...o } = e;
    return (0, c.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${a}`, n), ...o, children: [(0, c.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: t }), s && (0, c.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [s ? ' ' : '', s] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => s, Q6: () => c, e9: () => a, mA: () => i });
