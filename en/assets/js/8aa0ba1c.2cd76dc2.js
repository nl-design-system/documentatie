 ...
 [87034],
 {
  92949: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(81301),
    s = n(90786);
   const o = { title: 'File Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'File Input', pagination_label: 'File Input', description: 'Biedt de mogelijkheid om \xe9\xe9n of meerdere bestanden te selecteren en te uploaden.', slug: '/file-input' },
    a = void 0,
    l = { id: 'componenten/file-input/index', title: 'File Input', description: 'Biedt de mogelijkheid om \xe9\xe9n of meerdere bestanden te selecteren en te uploaden.', source: '@site/docs/componenten/file-input/index.mdx', sourceDirName: 'componenten/file-input', slug: '/file-input', permalink: '/en/file-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/file-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'File Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'File Input', pagination_label: 'File Input', description: 'Biedt de mogelijkheid om \xe9\xe9n of meerdere bestanden te selecteren en te uploaden.', slug: '/file-input' }, sidebar: 'componenten', previous: { title: 'Figure', permalink: '/en/figure' }, next: { title: 'Form Field', permalink: '/en/form-field' } },
    u = {},
    d = [
