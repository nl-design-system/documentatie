...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [8607],
 {
  ...
  17078: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => m, contentTitle: () => p, default: () => g, frontMatter: () => d, metadata: () => u, toc: () => j });
   var i = t(52676),
    s = t(24785);
   function r(e) {
   ...
   var a = t(55400);
   const d = { title: 'Maak gebruik van de spacing concepten | Ruimte | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Spacing concepten', pagination_label: 'Maak gebruik van de spacing concepten', description: 'Binnen het NL Design System is ruimte conceptueel opgezet door vijf herbruikbare spacing scales, dit zijn Inline, Block, Text, Column en Row.', slug: '/richtlijnen/stijl/ruimte/spacing-concepten', keywords: ['kleurcontrast', 'tekst'] },
    p = 'Maak gebruik van de spacing concepten',
    u = { id: 'richtlijnen/stijl/space/spacing-concepts/README', title: 'Maak gebruik van de spacing concepten | Ruimte | Richtlijnen', description: 'Binnen het NL Design System is ruimte conceptueel opgezet door vijf herbruikbare spacing scales, dit zijn Inline, Block, Text, Column en Row.', source: '@site/docs/richtlijnen/stijl/space/3-spacing-concepts/README.mdx', sourceDirName: 'richtlijnen/stijl/space/3-spacing-concepts', slug: '/richtlijnen/stijl/ruimte/spacing-concepten', permalink: '/en/richtlijnen/stijl/ruimte/spacing-concepten', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/stijl/space/3-spacing-concepts/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Maak gebruik van de spacing concepten | Ruimte | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Spacing concepten', pagination_label: 'Maak gebruik van de spacing concepten', description: 'Binnen het NL Design System is ruimte conceptueel opgezet door vijf herbruikbare spacing scales, dit zijn Inline, Block, Text, Column en Row.', slug: '/richtlijnen/stijl/ruimte/spacing-concepten', keywords: ['kleurcontrast', 'tekst'] }, sidebar: 'richtlijnen', previous: { title: 'MWerk en denk vanuit het box model', permalink: '/en/richtlijnen/stijl/ruimte/box-model' }, next: { title: 'Gebruik ruimte om relaties te cre\xebren tussen elementen', permalink: '/en/richtlijnen/stijl/ruimte/relaties' } },
    m = {},
    j = [];
   function h(e) {
