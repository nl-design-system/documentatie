(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [20858],
 {
  74821: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => g, contentTitle: () => a, default: () => m, description: () => j, frontMatter: () => s, issueNumber: () => y, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(7617),
    o = n(4460);
   const s = { title: 'Text input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text input group', pagination_label: 'Text input group', description: ' ', slug: '/text-input-group' },
    a = void 0,
    u = { id: 'componenten/text-input-group/index', title: 'Text input group', description: ' ', source: '@site/docs/componenten/text-input-group/index.mdx', sourceDirName: 'componenten/text-input-group', slug: '/text-input-group', permalink: '/en/text-input-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/text-input-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Text input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text input group', pagination_label: 'Text input group', description: ' ', slug: '/text-input-group' }, sidebar: 'componenten', previous: { title: 'Text input', permalink: '/en/text-input' }, next: { title: 'Textarea', permalink: '/en/textarea' } },
    l = {},
    d = [
  ...
  4460: (e, t, n) => {
   ...
   const D = (e) => {
    ...
    M = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(b, { level: n, suffix: c && (0, l.jsx)(m.y, { state: c }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
