(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [42112],
 {
  41378: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => s, default: () => b, description: () => j, frontMatter: () => o, illustration: () => g, issueNumber: () => y, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    a = n(60851);
   const o = { title: 'Data badge', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Data badge', pagination_label: 'Data badge', description: 'Label met extra informatie, zoals een categorie of een eigenschap.', slug: '/data-badge', sidebar_custom_props: { illustration: 'DataBadgeSketch' }, keywords: ['annotatie', 'annotation', 'badge', 'categorie', 'categoriseren', 'categorize', 'category', 'characteristic', 'chip', 'data', 'data badge', 'eigenschap', 'etiket', 'etiquette', 'filter tag', 'index', 'index term', 'label', 'metadata', 'pill', 'property', 'stamp', 'status', 'status badge', 'sticker', 'tag', 'tagged', 'tagging', 'term'] },
    s = void 0,
