 ...
 [87034],
 {
  38815: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(7617),
    o = n(4460);
   const s = { title: 'File input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'File input', pagination_label: 'File input', description: 'Biedt de mogelijkheid om \xe9\xe9n of meerdere bestanden te selecteren en te uploaden.', slug: '/file-input' },
    a = void 0,
    u = { id: 'componenten/file-input/index', title: 'File input', description: 'Biedt de mogelijkheid om \xe9\xe9n of meerdere bestanden te selecteren en te uploaden.', source: '@site/docs/componenten/file-input/index.mdx', sourceDirName: 'componenten/file-input', slug: '/file-input', permalink: '/en/file-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/file-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'File input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'File input', pagination_label: 'File input', description: 'Biedt de mogelijkheid om \xe9\xe9n of meerdere bestanden te selecteren en te uploaden.', slug: '/file-input' }, sidebar: 'componenten', previous: { title: 'Figure', permalink: '/en/figure' }, next: { title: 'Form field', permalink: '/en/form-field' } },
    l = {},
    d = [
    ...
    h = 'File input',
    j = 'Biedt de mogelijkheid om \xe9\xe9n of meerdere bestanden te selecteren en te uploaden.',
    y = 72,
  ...
  4460: (e, t, n) => {
   ...
   const f = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    b = (e) => {
     ...
     return (0, l.jsxs)('hgroup', { className: (0, i.Z)(f['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, l.jsx)('h1', { className: (0, i.Z)(f['nlds-inline-heading-group__heading']), children: t }), r && (0, l.jsxs)('p', { className: (0, i.Z)(f['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var v = n(46506),
    k = n(25953);
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.aC, { role: 'presentation', children: n }), (0, l.jsx)(v.nv, { children: r })] })] });
    };
   var D = n(14669);
   const F = (e) => {
