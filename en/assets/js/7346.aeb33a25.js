...
exports.modules = {
 ...
 /***/ 77346: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  const FormToggle = class {
   ...
   render() {
    ...
    return (0, _index_593361c2_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { key: '54f5470a38cb60e12130f75e9b24ac02b9d96db9', class: (0, _clsx_eca3fadc_js__WEBPACK_IMPORTED_MODULE_1__.c)('utrecht-form-toggle', checked && 'utrecht-form-toggle--checked', !checked && 'utrecht-form-toggle--not-checked', disabled && 'utrecht-form-toggle--disabled'), tabIndex: disabled ? null : 0, role: 'switch', 'aria-disabled': disabled ? 'true' : null, onClick: handleClick, onKeyPress: handleKeyPress, onKeyUp: handleKeyUp }, (0, _index_593361c2_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { key: 'a265ad79b987d81de246ed844e7383b8bbddc69d', class: 'utrecht-form-toggle__label utrecht-form-toggle__label--off' }), (0, _index_593361c2_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { key: '5832e80fa189690f6b6aad72b14bf6d073af9f43', class: 'utrecht-form-toggle__label utrecht-form-toggle__label--on' }), (0, _index_593361c2_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { key: '2866dd1126c200d2c4f88ec05fc949d66ac2857f', class: (0, _clsx_eca3fadc_js__WEBPACK_IMPORTED_MODULE_1__.c)('utrecht-form-toggle__track', checked && 'utrecht-form-toggle__track--checked', !checked && 'utrecht-form-toggle__track--not-checked', disabled && 'utrecht-form-toggle__track--disabled') }, (0, _index_593361c2_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { key: 'a8da4d30ac7036f5cca07ab77b12e354de09acad', class: (0, _clsx_eca3fadc_js__WEBPACK_IMPORTED_MODULE_1__.c)('utrecht-form-toggle__thumb', checked && 'utrecht-form-toggle__thumb--checked', !checked && 'utrecht-form-toggle__thumb--not-checked', disabled && 'utrecht-form-toggle__thumb--disabled') })));
   }
  };
