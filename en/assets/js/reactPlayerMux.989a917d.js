 ...
 [64258],
 {
  49495: (e, t, n) => {
   var r,
    ...
    h = (e, t, n, r) => {
     if ((t && "object" == typeof t) || "function" == typeof t) for (let s of o(t)) p.call(e, s) || s === n || i(e, s, { get: () => t[s], enumerable: !(r = a(t, s)) || r.enumerable });
     return e;
    },
    u = (e, t, n) => (
     ((e, t, n) => {
   ...
   ((e, t) => {
    ...
    (e.exports = ((r = d), h(i({}, "__esModule", { value: !0 }), r)));
   var c = ((e, t, n) => ((n = null != e ? s(l(e)) : {}), h(!t && e && e.__esModule ? n : i(n, "default", { value: e, enumerable: !0 }), e)))(n(75271)),
    y = n(39090);
   class m extends c.Component {
    constructor() {
     super(...arguments),
      u(this, "onReady", (...e) => this.props.onReady(...e)),
      u(this, "onPlay", (...e) => this.props.onPlay(...e)),
      u(this, "onBuffer", (...e) => this.props.onBuffer(...e)),
      u(this, "onBufferEnd", (...e) => this.props.onBufferEnd(...e)),
      u(this, "onPause", (...e) => this.props.onPause(...e)),
      u(this, "onEnded", (...e) => this.props.onEnded(...e)),
      u(this, "onError", (...e) => this.props.onError(...e)),
      u(this, "onPlayBackRateChange", (e) => this.props.onPlaybackRateChange(e.target.playbackRate)),
      u(this, "onEnablePIP", (...e) => this.props.onEnablePIP(...e)),
      u(this, "onSeek", (e) => {
       this.props.onSeek(e.target.currentTime);
      }),
      u(this, "onDurationChange", () => {
    ...
    async load(e) {
     var t;
     const { onError: n, config: r } = this.props;
     if (!(null == (t = globalThis.customElements) ? void 0 : t.get("mux-player")))
      try {
       const e = "https://cdn.jsdelivr.net/npm/@mux/mux-player@VERSION/dist/mux-player.mjs".replace("VERSION", r.version);
       await import(`${e}`), this.props.onLoaded();
      } catch (i) {
       n(i);
      }
     const [, s] = e.match(y.MATCH_URL_MUX);
     this.player.playbackId = s;
    }
    play() {
    ...
    getPlaybackId(e) {
     const [, t] = e.match(y.MATCH_URL_MUX);
     return t;
    }
    render() {
     const { url: e, playing: t, loop: n, controls: r, muted: s, config: i, width: a, height: o } = this.props,
      l = { width: "auto" === a ? a : "100%", height: "auto" === o ? o : "100%" };
     return !1 === r && (l["--controls"] = "none"), c.default.createElement("mux-player", { ref: this.ref, "playback-id": this.getPlaybackId(e), style: l, preload: "auto", autoPlay: t || void 0, muted: s ? "" : void 0, loop: n ? "" : void 0, ...i.attributes });
    }
   }
   u(m, "displayName", "Mux"), u(m, "canPlay", y.canPlay.mux);
  },
 },
]);
