...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  19563: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => c, contentTitle: () => o, default: () => g, frontMatter: () => l, metadata: () => d, toc: () => h });
   var r = i(52676),
    t = i(24785),
    s = i(61663),
    a = i(54894);
   const l = { title: "WCAG-succescriterium 4.1.1 Parsen", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "4.1.1 Parsen", pagination_label: "WCAG-succescriterium 4.1.1 Parsen", description: "Zorg dat er geen fouten in de HTML-code zijn.", slug: "4.1.1", keywords: ["WCAG"] },
    o = "WCAG-succescriterium 4.1.1 Parsen",
    d = { id: "wcag/4.1.1", title: "WCAG-succescriterium 4.1.1 Parsen", description: "Zorg dat er geen fouten in de HTML-code zijn.", source: "@site/docs/wcag/4.1.1.mdx", sourceDirName: "wcag", slug: "/wcag/4.1.1", permalink: "/en/wcag/4.1.1", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/4.1.1.mdx", tags: [], version: "current", frontMatter: { title: "WCAG-succescriterium 4.1.1 Parsen", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "4.1.1 Parsen", pagination_label: "WCAG-succescriterium 4.1.1 Parsen", description: "Zorg dat er geen fouten in de HTML-code zijn.", slug: "4.1.1", keywords: ["WCAG"] }, sidebar: "richtlijnen", previous: { title: "WCAG-succescriterium 3.3.4 Foutpreventie (wettelijk, financieel, gegevens)", permalink: "/en/wcag/3.3.4" }, next: { title: "WCAG-succescriterium 4.1.2 Naam, rol, waarde", permalink: "/en/wcag/4.1.2" } },
    c = {},
    h = [
