 ...
 [9872],
 {
  ...
  3460: (e, n, t) => {
   ...
   const g = (e) => {
    ...
    v = (e) => {
     let { code: n, copy: t = !1, defaultCollapsed: v = !0, children: j, language: _, designTokens: y } = e,
      x = "function" == typeof j ? j() : j,
      k = "function" == typeof n ? n() : (0, d.isValidElement)(n) ? n : void 0,
      f = "string" == typeof n ? n : u.uS(k || x),
      [w, A] = (0, d.useState)(f);
     (0, d.useEffect)(() => {
      (async () => {
       (w = await c.ZP.format(f, { parser: _, plugins: [s.Z, r.ZP, i.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), A(w);
      })();
     }, [f]);
     const N = (0, p.Z)();
     return (0, b.jsxs)("div", {
      ...
      children: [
       x && (0, b.jsx)("div", { className: (0, o.Z)(m["nlds-canvas__example"]), children: (0, b.jsx)(l.pu, { className: "voorbeeld-theme", style: y, children: x }) }),
       (0, b.jsx)("div", { className: (0, o.Z)(m["nlds-canvas__toolbar"]), children: (0, b.jsx)(l.zx, { className: (0, o.Z)(m["nlds-canvas__button"], m["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: g, "aria-expanded": !v, "aria-controls": N, children: v ? "Bekijk code" : "Verberg code" }) }),
       (0, b.jsxs)("div", {
        className: (0, o.Z)(m["nlds-canvas__code-block"], !t && m["nlds-canvas__code-block--user-select-none"]),
        id: N,
        hidden: v,
        children: [
         (0, b.jsx)(h.u, { syntax: _, textContent: w, trim: !0 }),
         t &&
          (0, b.jsx)("div", {
