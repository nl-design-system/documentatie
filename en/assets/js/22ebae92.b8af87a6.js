(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [20858],
 {
  79856: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => p, contentTitle: () => a, default: () => v, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => g, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Text input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text input group', pagination_label: 'Text input group', description: ' ', slug: '/text-input-group', sidebar_custom_props: { illustration: 'TextInputGroupSketch' } },
    a = void 0,
    u = { id: 'componenten/text-input-group/index', title: 'Text input group', description: ' ', source: '@site/docs/componenten/text-input-group/index.mdx', sourceDirName: 'componenten/text-input-group', slug: '/text-input-group', permalink: '/en/text-input-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/text-input-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Text input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text input group', pagination_label: 'Text input group', description: ' ', slug: '/text-input-group', sidebar_custom_props: { illustration: 'TextInputGroupSketch' } }, sidebar: 'componenten', previous: { title: 'Text input', permalink: '/en/text-input' }, next: { title: 'Textarea', permalink: '/en/textarea' } },
    l = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    T = 'task-list-item__marker-label_XAyi',
    A = (e) => {
     let { children: t } = e;
    ...
    S = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: T, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(k.aC, { role: 'presentation', children: n }), (0, l.jsx)(k.nv, { children: r })] })] });
    };
   var z = n(14669);
   const D = (e) => {
         ...
         children: [
          (0, l.jsx)(A, {
           children: e.tasks.map((e) => {
            ...
            return (0, l.jsx)(S, { checked: t, title: n, description: (0, z.Q6)(r) }, r);
           }),
          }),
