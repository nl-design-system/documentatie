 ...
 [21229],
 {
  ...
  83931: (e, n, t) => {
   ...
   const s = (e) => {
     ...
     return (0, c.jsx)('div', { className: (0, i.Z)(o.card__illustration, n && o['card__illustration--background'], r), ...s, children: t });
    },
    a = (e) => (0, c.jsx)('div', { className: (0, i.Z)(o.card__content), ...e }),
    l = (e) => {
     let { href: n, appearance: t, className: s, component: a = 'div', children: l } = e;
     const d = (e) => ('article' === a ? (0, c.jsx)('article', { ...e }) : 'section' === a ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      h = (0, c.jsx)(d, { className: (0, i.Z)(o.cardgroup__card, o[`cardgroup__card--${t}`], s), children: l });
  ...
  63246: (e, n, t) => {
   ...
   const f = 'task-list_hh8j',
    ...
    C = (e) => {
     ...
     return (0, d.jsxs)('li', { className: (0, i.Z)(x), children: [(0, d.jsxs)('div', { className: (0, i.Z)(_, { [w]: n }), children: [(0, d.jsx)('span', { className: z, children: n ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), n && (0, d.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(y.aC, { role: 'presentation', children: t }), (0, d.jsx)(y.nv, { children: r })] })] });
    };
   var N = t(14669);
   const D = (e) => {
     let { component: n, headingLevel: t } = e;
     const o = n && n.projects.filter((e) => N.e9.includes(e.id)),
      c = o && N.e9.map((e) => o.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, d.jsx)(A, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(C, { checked: n, title: t, description: (0, N.Q6)(r) }, r);
            }),
           }),
    ...
    T = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(v.V, { level: t, suffix: o && (0, d.jsx)(k.y, { state: o }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, n, t) => {
   'use strict';
  ...
  66120: (e, n, t) => {
   ...
   var o = t(52676);
   const c = (e) => {
    let { children: n, className: t, level: c = 1, suffix: s, ...a } = e;
    return (0, o.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${c}`, t), ...a, children: [(0, o.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: n }), s && (0, o.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [s ? ' ' : '', s] })] });
   };
  },
  57716: (e, n, t) => {
   'use strict';
