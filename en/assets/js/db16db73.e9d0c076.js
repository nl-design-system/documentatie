 ...
 [5545],
 {
  ...
  3460: (e, n, l) => {
   ...
   const b = (e) => {
    ...
    p = (e) => {
     let { code: n, copy: l = !1, defaultCollapsed: p = !0, children: j, language: k } = e,
      _ = "function" == typeof j ? j() : j,
      y = "function" == typeof n ? n() : (0, c.isValidElement)(n) ? n : void 0,
      f = "string" == typeof n ? n : u.uS(y || _),
      [x, w] = (0, c.useState)(f);
     (0, c.useEffect)(() => {
      (async () => {
       (x = await a.ZP.format(f, { parser: k, plugins: [i.Z, r.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), w(x);
      })();
     }, [f]);
     const Z = (0, m.Z)();
     return (0, v.jsxs)("div", {
      ...
      children: [
       _ && (0, v.jsx)("div", { className: (0, t.Z)(g["nlds-canvas__example"]), children: (0, v.jsx)(o.pu, { className: "voorbeeld-theme", children: _ }) }),
       (0, v.jsx)("div", { className: (0, t.Z)(g["nlds-canvas__toolbar"]), children: (0, v.jsx)(o.zx, { className: (0, t.Z)(g["nlds-canvas__button"], g["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: b, "aria-expanded": !p, "aria-controls": Z, children: p ? "Bekijk code" : "Verberg code" }) }),
       (0, v.jsxs)("div", {
        className: (0, t.Z)(g["nlds-canvas__code-block"], !l && g["nlds-canvas__code-block--user-select-none"]),
        id: Z,
        hidden: p,
        children: [
         (0, v.jsx)(h.u, { syntax: k, textContent: x, trim: !0 }),
         l &&
          (0, v.jsx)("div", {
           ...
           children: (0, v.jsx)(o.zx, {
            ...
            onClick: () => {
             navigator.clipboard.writeText(x).catch((e) => console.error("Copy code failed", e));
            },
            children: "Kopieer",
           }),
          }),
