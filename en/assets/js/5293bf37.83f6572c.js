  ...
  82415: (e, n, t) => {
   ...
   const d = (e) => {
    ...
    return (0, r.jsxs)('form', {
     ...
     children: [(0, r.jsxs)(i.Wi, { type: 'email', children: [(0, r.jsx)(i.nv, { children: (0, r.jsx)(i.lX, { htmlFor: `id-${l}`, children: y ? 'Email address ' : 'E-mailadres' }) }), j[l] && (0, r.jsx)(i.w7, { children: j[l].message }), (0, r.jsx)(i.nv, { children: (0, r.jsx)(i.fE, { id: `id-${l}`, name: l, type: 'email', autoComplete: 'email', 'aria-required': 'true', ...v(`${l}`, { required: { value: !0, message: y ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' }, pattern: { value: /\S+@\S+\.\S+/, message: y ? 'This is not a valid email address.' : 'Dit is geen correct emailadres.' } }), invalid: !!j[l] }) })] }), (0, r.jsxs)(i.Wi, { type: 'text', children: [(0, r.jsx)(i.nv, { children: (0, r.jsx)(i.lX, { htmlFor: o, children: y ? 'Name' : 'Naam' }) }), j[o] && (0, r.jsx)(i.w7, { children: j[o].message }), (0, r.jsx)(i.nv, { children: (0, r.jsx)(i.fE, { id: o, name: o, type: 'text', autoComplete: 'given-name', 'aria-required': 'true', ...v(`${o}`, { required: { value: !0, message: y ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' } }), invalid: !!j[o] }) })] }), m && (0, r.jsxs)(i.Wi, { type: 'text', children: [(0, r.jsx)(i.nv, { children: (0, r.jsx)(i.lX, { htmlFor: m, children: 'Organisatie' }) }), j[m] && (0, r.jsx)(i.w7, { children: j[m].message }), (0, r.jsx)(i.nv, { children: (0, r.jsx)(i.fE, { id: m, name: m, type: 'text' }) })] }), c && (0, r.jsxs)(i.pg, { children: [(0, r.jsx)(i.Qv, { children: 'Waar wil je NL Design System voor gebruiken? (niet verplicht)' }), (0, r.jsx)(i.ue, { children: 'Meerdere antwoorden mogelijk.' }), h.map((e, n) => (0, r.jsx)(i.Wi, { type: 'checkbox', children: (0, r.jsxs)(i.nv, { children: [(0, r.jsx)(i.XZ, { name: `${c}[]`, value: n >= 6 ? n + 2 : n + 1, id: `${c}-${n + 1}` }), (0, r.jsx)(i.lX, { htmlFor: `${c}-${n + 1}`, children: e })] }) }, e))] }), u && (0, r.jsxs)(i.Wi, { type: 'text', children: [(0, r.jsxs)(i.nv, { children: [(0, r.jsx)(i.lX, { htmlFor: u, children: 'Aan wat voor projecten werk je? (niet verplicht)' }), (0, r.jsx)(i.ue, { children: 'Denk aan mijn-omgevingen, formulieren en/of kaarten.' })] }), (0, r.jsx)(i.nv, { children: (0, r.jsx)(i.gx, { id: u, name: u }) })] }), g && (0, r.jsxs)(i.Wi, { type: 'text', children: [(0, r.jsx)(i.ue, { id: `${g}-description`, children: (0, r.jsxs)('p', { children: ['Op onze activiteiten is de ', (0, r.jsx)('a', { href: '/privacyverklaring', children: 'privacyverklaring van NL Design System' }), ' van toepassing.'] }) }), (0, r.jsxs)(i.Wi, { type: 'checkbox', children: [(0, r.jsx)(i.XZ, { value: '1', id: `${g}-1`, 'aria-describedby': `${g}-description`, 'aria-required': 'true', ...v(`${g}[]`, { required: { value: !0, message: 'Je kunt je alleen aanmelden als je akkoord gaat met de privacyverklaring.' } }), invalid: !!j[`${g}[]`] }), (0, r.jsxs)(i.lX, { htmlFor: `${g}-1`, children: [' ', 'Ik ga akkoord met het gebruik van mijn gegevens volgens de privacyverklaring'] })] }), j[g] && (0, r.jsx)(i.w7, { children: j[g].message })] }), p && (0, r.jsx)('input', { type: 'hidden', name: p.id, value: p.value }), (0, r.jsx)(i.hE, { children: (0, r.jsx)(i.zx, { type: 'submit', appearance: 'primary-action-button', children: y ? 'Sign up' : 'Aanmelden' }) }), (0, r.jsx)('input', { type: 'hidden', name: 'next', value: d }), (0, r.jsx)('input', { type: 'hidden', name: 'a', value: t }), (0, r.jsx)('input', { type: 'hidden', name: 'l', value: n }), (0, r.jsx)('input', { name: 'osnD9cWRI3', autoComplete: 'on', id: 'id-osnD9cWRI3', type: 'hidden', value: 'NLDS website' }), (0, r.jsx)('input', { autoComplete: 'new-password', type: 'email', id: 'email', name: 'email', placeholder: 'Your e-mail here', className: 'sr-only', 'aria-hidden': 'true' })],
    });
   };
  },
  24785: (e, n, t) => {
