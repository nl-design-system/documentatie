...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [84756],
 {
  ...
  4487: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => h, contentTitle: () => b, default: () => _, frontMatter: () => u, metadata: () => m, toc: () => v });
   var t = l(52676),
    s = l(24785),
    i = l(98480),
    o = l(91050);
   function a(e) {
    const n = { a: 'a', fieldset: 'fieldset', input: 'input', label: 'label', legend: 'legend', p: 'p', ...(0, s.a)(), ...e.components };
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(o.X, { appearance: 'do', title: 'Heel basaal, de link vlak boven het formulierveld plaatsen.', children: (0, t.jsx)(i.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsxs)(n.p, { children: [(0, t.jsx)(n.a, { href: '#', children: 'Privacybeleid gemeente Voorbeeld' }), '.'] }), (0, t.jsx)(n.input, { id: 'pb', type: 'checkbox', name: 'privacybeleid' }), (0, t.jsx)(n.label, { for: 'pb', children: 'Ik ga akkoord met het privacybeleid' })] }) }) }), '\n', (0, t.jsx)(o.X, { appearance: 'do', title: 'Groeperen met een fieldset en de informatie koppelen aan het formulierveld met een aria-describedby.', children: (0, t.jsx)(i.X, { language: 'html', children: () => (0, t.jsxs)(n.fieldset, { children: [(0, t.jsx)(n.legend, { children: 'Privacystatement gemeente Voorbeeld' }), (0, t.jsxs)(n.p, { id: 'desc', children: ['Wij hebben jouw toestemming nodig om je e-mailadres op te slaan zodat we je onze nieuwsbrief kunnen sturen. Lees onze ', (0, t.jsx)(n.a, { href: '#', target: '_blank', children: 'privacybeleid (opent in een nieuw venster)' }), '.'] }), (0, t.jsx)(n.input, { type: 'checkbox', 'aria-describedby': 'desc', id: 'pvs' }), (0, t.jsx)(n.label, { for: 'pvs', children: 'Ik ga akkoord met het privacybeleid' })] }) }) }), '\n', (0, t.jsx)(o.X, { appearance: 'dont', title: 'Link in het label plaatsen.', children: (0, t.jsx)(i.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.input, { id: 'privacybeleid', type: 'checkbox', name: 'privacybeleid' }), ' ', (0, t.jsxs)(n.label, { for: 'privacybeleid', children: ['Ik ga akkoord met het ', (0, t.jsx)(n.a, { href: '#', children: 'privacybeleid' })] })] }) }) }), '\n', (0, t.jsx)(o.X, { appearance: 'dont', title: 'Link samen met het invoerveld in een impliciet label plaatsen.', children: (0, t.jsx)(i.X, { language: 'html', children: () => (0, t.jsxs)(n.label, { for: 'tac', children: [(0, t.jsx)(n.input, { id: 'tac', type: 'checkbox', name: 'terms-and-conditions' }), 'Ik ga akkoord met het ', (0, t.jsx)(n.a, { href: '#', children: 'privacybeleid' })] }) }) })] });
   }
   function r(e = {}) {
    const { wrapper: n } = { ...(0, s.a)(), ...e.components };
   ...
   function c(e) {
    const n = { a: 'a', code: 'code', h1: 'h1', img: 'img', li: 'li', p: 'p', pre: 'pre', ul: 'ul', ...(0, s.a)(), ...e.components };
  ...
  98480: (e, n, l) => {
   ...
   const h = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(t.Tg, { className: u['nlds-canvas__example-surface'], children: (0, m.jsx)(t.BB, { className: (0, s.Z)('utrecht-document--surface', u['nlds-canvas__example-document']), children: (0, m.jsx)(t.nv, { className: u['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   h.displayName = 'ParagraphContainer';
   const v = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(t.Tg, { className: u['nlds-canvas__example-surface'], children: (0, m.jsx)(t.BB, { className: (0, s.Z)('utrecht-document--surface', u['nlds-canvas__example-document']), children: n }) });
   };
   ...
   const _ = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (S = await c.ZP.format(Z, { parser: x, plugins: [i.Z, o.ZP, a.ZP, r.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), z(S);
     })();
    }, [Z]);
    const L = (0, d.useId)();
    let P = d.Fragment;
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       w && (0, m.jsx)('div', { className: (0, s.Z)(u['nlds-canvas__example']), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(P, { children: (0, m.jsx)(t.pu, { children: w }) }) }) }),
       k &&
        (0, m.jsx)('div', {
    ...
    return (
     ...
     (0, o.jsx)(s.y$, {
      ...
      children: (e) => {
       ...
       return (0, o.jsx)(t.dn, { style: l, children: s.map((e, l) => (0, o.jsxs)('span', { ...i({ line: e }), children: [n && (0, o.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, o.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const u = 'Doen',
     ...
     m = p ? 'figure' : 'div',
     h = p ? 'figcaption' : 'div';
    return (0, r.jsxs)(m, { className: (0, o.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, r.jsxs)(h, { className: (0, o.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(i.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(t.Z, { className: a['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: a['nlds-guideline__title'], children: b })] }), (0, r.jsx)(i.nv, { children: n })] }) : (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(i.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(s.Z, { className: a['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: a['nlds-guideline__title'], children: u })] }), (0, r.jsx)(i.nv, { children: n })] }), c] }), (0, r.jsx)('div', { className: (0, o.Z)(a['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => a, a: () => o });
