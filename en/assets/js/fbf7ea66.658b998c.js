(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [20322],
 {
  22422: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => y, contentTitle: () => s, default: () => v, description: () => j, frontMatter: () => o, illustration: () => g, issueNumber: () => m, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    a = n(60851);
   const o = { title: 'Case card', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Case card', pagination_label: 'Case card', description: 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.', slug: '/case-card', sidebar_custom_props: { illustration: 'CaseCardSketch' }, keywords: ['aanvraag', 'afgehandeld', 'afgerond', 'archief', 'archive', 'archived', 'bericht', 'beroep', 'bezwaar', 'card', 'case', 'case card', 'complaint', 'data', 'dossier', 'file', 'gearchiveerd', 'in behandeling', 'kenmerk', 'klacht', 'lopende zaak', 'melding', 'Mijn Services', 'MijnOmgeving', 'MijnZaken', 'navigate', 'navigatie', 'navigation', 'navigeren', 'permit', 'procedure', 'record', 'request', 'response', 'terugkoppeling', 'tile', 'vergunning', 'zaak', 'zaak informatie', 'zaaknummer', 'zaaksysteem'] },
    s = void 0,
  ...
  60851: (e, t, n) => {
   ...
   const T = (e) => {
     ...
     const c = t && t.projects.filter((e) => C.e9.includes(e.id)),
      a = c && C.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
         ...
         children: [
          (0, u.jsx)(A, {
           children: e.tasks.map((e) => {
            ...
            return (0, u.jsx)(S, { checked: t, title: n, description: (0, C.Q6)(r) }, r);
           }),
          }),
     ...
     return t && c.length
      ? (0, u.jsx)(j.um, {
         ...
         children: c
          ...
          .map((e) => {
           const { value: t } = e.tasks.find((e) => {
             let { name: t } = e;
             return 'Naam' === t;
            }),
            c = new Map([
             ['Figma URL', { brand: 'figma', desciption: `${t} in Figma` }],
             ['NPM URL (CSS)', { brand: 'npm', desciption: `${t} op NPM` }],
             ['GitHub URL (CSS)', { brand: 'github', desciption: `${t} op GitHub` }],
               ...
               a.length &&
                (0, u.jsxs)(u.Fragment, {
                 children: [
                  ...
                  (0, u.jsx)(r.Mc, {
                   children: a.map((e) => {
                    const { brand: t, desciption: n } = c.get(e.name);
