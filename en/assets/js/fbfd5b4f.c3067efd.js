(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [2930],
 {
  88086: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => y, contentTitle: () => a, default: () => m, description: () => j, frontMatter: () => o, issueNumber: () => g, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(65058),
    s = n(23952);
   const o = { title: 'Progress List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress List', pagination_label: 'Progress List', description: 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.', slug: '/progress-list' },
    a = void 0,
    l = { id: 'componenten/progress-list/index', title: 'Progress List', description: 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.', source: '@site/docs/componenten/progress-list/index.mdx', sourceDirName: 'componenten/progress-list', slug: '/progress-list', permalink: '/en/progress-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/progress-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Progress List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress List', pagination_label: 'Progress List', description: 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.', slug: '/progress-list' }, sidebar: 'componenten', previous: { title: 'Progress Bar', permalink: '/en/progress-bar' }, next: { title: 'Radio Button', permalink: '/en/radio-button' } },
    u = {},
    d = [
  ...
  23952: (e, t, n) => {
   ...
   const k = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(_), children: [(0, u.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.X6, { appearance: 'utrecht-heading-3', level: s, children: r }), c, n] })] });
    };
   var S = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => S.e9.includes(e.id)),
      s = c && S.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, u.jsx)(A, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(z, { checked: t, title: n, description: (0, S.Q6)(r) }, r);
            }),
           }),
    ...
    V = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(v.V, { level: n, suffix: c && (0, u.jsx)(m.y, { state: c }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, t, n) => {
   'use strict';
