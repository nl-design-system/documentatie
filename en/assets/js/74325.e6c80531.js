  ...
  39026: (t, e, n) => {
   function r(t) {
    ...
    if ('string' == typeof t || 'number' == typeof t) i += t;
     ...
     if (Array.isArray(t)) for (e = 0; e < t.length; e++) t[e] && (n = r(t[e])) && (i && (i += ' '), (i += n));
   ...
   const a = class {
    ...
    render() {
     ...
     return (0, r.h)(
      ...
      (0, r.h)('span', { class: 'utrecht-pagination__before' }, a ? o(Object.assign(Object.assign({}, a), { rel: 'prev', textContent: 'Vorige' })) : ''),
      (0, r.h)(
       'span',
       ...
       e
        ...
        .map((t) => (({ current: t = !1, href: e = '', rel: n = null, textContent: a = '' }) => (0, r.h)('a', { class: (0, i.c)('utrecht-pagination__page-link', t && 'utrecht-pagination__page-link--current'), href: e, 'aria-current': t ? 'true' : null, rel: n }, a))(t)),
      ),
      (0, r.h)('span', { class: 'utrecht-pagination__before' }, n ? o(Object.assign(Object.assign({}, n), { rel: 'next', textContent: 'Volgende' })) : ''),
     );
    }
   };
