...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  82630: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => u, contentTitle: () => c, default: () => m, frontMatter: () => d, metadata: () => h, toc: () => g });
   var r = i(52676),
    t = i(24785),
    s = i(91410),
    l = i(88435);
   ...
   const d = { title: 'WCAG-succescriterium 1.3.1 Info en relaties', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.1 Info en relaties', pagination_label: 'WCAG-succescriterium 1.3.1 Info en relaties', description: 'Alle gebruikers moeten over dezelfde informatie kunnen beschikken.', slug: '1.3.1', keywords: ['WCAG'] },
    c = 'WCAG-succescriterium 1.3.1 Info en relaties',
    h = { id: 'wcag/1.3.01', title: 'WCAG-succescriterium 1.3.1 Info en relaties', description: 'Alle gebruikers moeten over dezelfde informatie kunnen beschikken.', source: '@site/docs/wcag/1.3.01.mdx', sourceDirName: 'wcag', slug: '/wcag/1.3.1', permalink: '/en/wcag/1.3.1', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.3.01.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.3.1 Info en relaties', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.1 Info en relaties', pagination_label: 'WCAG-succescriterium 1.3.1 Info en relaties', description: 'Alle gebruikers moeten over dezelfde informatie kunnen beschikken.', slug: '1.3.1', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.2.5 Audiodescriptie (vooraf opgenomen)', permalink: '/en/wcag/1.2.5' }, next: { title: 'WCAG-succescriterium 1.3.2 Betekenisvolle volgorde', permalink: '/en/wcag/1.3.2' } },
    u = {},
    g = [
