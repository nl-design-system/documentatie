...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  26453: (e, n, r) => {
   r.r(n), r.d(n, { assets: () => v, contentTitle: () => p, default: () => b, frontMatter: () => g, metadata: () => j, toc: () => f });
   var t = r(52676),
    i = r(24785),
    o = r(57716),
    s = r(71595),
   ...
   const g = { title: 'WCAG-succescriterium 1.4.13 Content bij hover of focus', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.13 Content bij hover of focus', pagination_label: 'WCAG-succescriterium 1.4.13 Content bij hover of focus', description: 'Als de inhoud wijzigt wanneer een gebruiker over een element hovert met de muis of het de toetsenbordfocus geeft, zorg er dan voor dat de interactie voorspelbaar is.', slug: '1.4.13', keywords: ['WCAG'] },
    p = void 0,
    j = { id: 'wcag/1.4.13', title: 'WCAG-succescriterium 1.4.13 Content bij hover of focus', description: 'Als de inhoud wijzigt wanneer een gebruiker over een element hovert met de muis of het de toetsenbordfocus geeft, zorg er dan voor dat de interactie voorspelbaar is.', source: '@site/docs/wcag/1.4.13.mdx', sourceDirName: 'wcag', slug: '/wcag/1.4.13', permalink: '/en/wcag/1.4.13', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.13.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.4.13 Content bij hover of focus', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.13 Content bij hover of focus', pagination_label: 'WCAG-succescriterium 1.4.13 Content bij hover of focus', description: 'Als de inhoud wijzigt wanneer een gebruiker over een element hovert met de muis of het de toetsenbordfocus geeft, zorg er dan voor dat de interactie voorspelbaar is.', slug: '1.4.13', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.4.12 Tekstafstand', permalink: '/en/wcag/1.4.12' }, next: { title: 'WCAG-succescriterium 2.1.1 Toetsenbord', permalink: '/en/wcag/2.1.1' } },
    v = {},
    f = [
  ...
  72657: (e, n, r) => {
   ...
   const s = (e) => {
    ...
    return (0, o.jsxs)('hgroup', { className: (0, t.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${s}`, r), ...d, children: [(0, o.jsx)('h1', { className: (0, t.Z)(i['nlds-inline-heading-group__heading']), children: n }), l && (0, o.jsxs)('p', { className: (0, t.Z)(i['nlds-inline-heading-group__suffix']), children: [l ? ' ' : '', l] })] });
   };
  },
  57716: (e, n, r) => {
   r.d(n, { U: () => c });
   ...
   const s = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, o.jsx)(t.Z, { components: { ...a(r, i), ...d(s) }, children: n });
    };
  },
  71595: (e, n, r) => {
   r.d(n, { j: () => d });
   ...
   const d = (e) => {
    ...
    return (0, l.jsx)(i.V, { className: o, suffix: r && (0, l.jsx)(t.Ou, { className: s, children: r }), ...d, children: n });
   };
  },
  24785: (e, n, r) => {
   r.d(n, { Z: () => l, a: () => s });
