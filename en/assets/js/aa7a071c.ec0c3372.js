 ...
 [2733],
 {
  ...
  3460: (e, n, r) => {
   ...
   const g = (e) => {
    ...
    v = (e) => {
     let { code: n, copy: r = !1, defaultCollapsed: v = !0, children: x, language: b, designTokens: k } = e,
      f = "function" == typeof x ? x() : x,
      w = "function" == typeof n ? n() : (0, c.isValidElement)(n) ? n : void 0,
      y = "string" == typeof n ? n : u.uS(w || f),
      [_, S] = (0, c.useState)(y);
     (0, c.useEffect)(() => {
      (async () => {
       (_ = await d.ZP.format(y, { parser: b, plugins: [i.Z, o.ZP, a.ZP, s.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), S(_);
      })();
     }, [y]);
     const N = (0, p.Z)();
     return (0, j.jsxs)("div", {
      ...
      children: [
       f && (0, j.jsx)("div", { className: (0, t.Z)(h["nlds-canvas__example"]), children: (0, j.jsx)(l.pu, { className: "voorbeeld-theme", style: k, children: f }) }),
       (0, j.jsx)("div", { className: (0, t.Z)(h["nlds-canvas__toolbar"]), children: (0, j.jsx)(l.zx, { className: (0, t.Z)(h["nlds-canvas__button"], h["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: g, "aria-expanded": !v, "aria-controls": N, children: v ? "Bekijk code" : "Verberg code" }) }),
       (0, j.jsxs)("div", {
        className: (0, t.Z)(h["nlds-canvas__code-block"], !r && h["nlds-canvas__code-block--user-select-none"]),
        id: N,
        hidden: v,
        children: [
         (0, j.jsx)(m.u, { syntax: b, textContent: _, trim: !0 }),
         r &&
          (0, j.jsx)("div", {
