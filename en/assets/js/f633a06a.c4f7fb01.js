 ...
 [85270],
 {
  42438: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    s = n(60851);
   const o = { title: 'Link list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link list', pagination_label: 'Link list', description: 'Toont een lijst aan gerelateerde links.', slug: '/link-list', sidebar_custom_props: { illustration: 'LinkListSketch' } },
    a = void 0,
    l = { id: 'componenten/link-list/index', title: 'Link list', description: 'Toont een lijst aan gerelateerde links.', source: '@site/docs/componenten/link-list/index.mdx', sourceDirName: 'componenten/link-list', slug: '/link-list', permalink: '/en/link-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/link-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Link list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link list', pagination_label: 'Link list', description: 'Toont een lijst aan gerelateerde links.', slug: '/link-list', sidebar_custom_props: { illustration: 'LinkListSketch' } }, sidebar: 'componenten', previous: { title: 'Link', permalink: '/en/link' }, next: { title: 'Modal dialog', permalink: '/en/modal-dialog' } },
    u = {},
    d = [
    ...
    h = 'Link list',
    j = 'Toont een lijst aan gerelateerde links.',
    y = 'LinkListSketch',
    g = 264,
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: L, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var z = n(14669);
   const T = (e) => {
