(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [87034],
 {
  59345: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => p, contentTitle: () => a, default: () => v, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => m, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(61475),
    o = n(21998);
   const s = { title: 'File input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'File input', pagination_label: 'File input', description: ' ', slug: '/file-input', sidebar_custom_props: { illustration: 'FileInputSketch' } },
    a = void 0,
    u = { id: 'componenten/file-input/index', title: 'File input', description: ' ', source: '@site/docs/componenten/file-input/index.mdx', sourceDirName: 'componenten/file-input', slug: '/file-input', permalink: '/en/file-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/file-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'File input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'File input', pagination_label: 'File input', description: ' ', slug: '/file-input', sidebar_custom_props: { illustration: 'FileInputSketch' } }, sidebar: 'componenten', previous: { title: 'Figure', permalink: '/en/figure' }, next: { title: 'Form field', permalink: '/en/form-field' } },
    l = {},
    d = [
