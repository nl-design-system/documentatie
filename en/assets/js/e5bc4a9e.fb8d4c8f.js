   ...
   const D = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, c.Z)(y['definition-of-done'], e && y[`definition-of-done--${(0, T.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
