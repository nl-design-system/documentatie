 ...
 [8321],
 {
  ...
  94091: (e, n, l) => {
   ...
   const b = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await c.ZP.format(z, { parser: _, plugins: [t.Z, s.ZP, a.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), C(Z);
     })();
    }, [z]);
    const P = (0, d.useId)();
    let W = d.Fragment;
    return (
     "paragraph" === f ? (W = g) : "document" === f ? (W = v) : "surface" === f && (W = j),
     (0, m.jsxs)("div", {
