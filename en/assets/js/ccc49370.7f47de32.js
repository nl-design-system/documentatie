...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [46103],
 {
  ...
  58829: (e, t, o) => {
   ...
   var h = o(36933),
    p = o(4424);
   const g = { container: 'container_E5ZG' };
   function b(e) {
    let { readingTime: t } = e;
    const o = (function () {
   ...
   const k = { authorCol: 'authorCol_Z7Ts', imageOnlyAuthorRow: 'imageOnlyAuthorRow_UMur', imageOnlyAuthorCol: 'imageOnlyAuthorCol_aU4S' };
   function P(e) {
    let { className: t } = e;
    const {
     metadata: { authors: o },
   ...
   const I = { blogPostFooterDetailsFull: 'blogPostFooterDetailsFull_OO9X' };
   function M() {
   ...
   function L(e) {
    ...
    return (0, c.jsxs)('nav', { className: 'pagination-nav docusaurus-mt-lg', 'aria-label': (0, h.I)({ id: 'theme.blog.post.paginator.navAriaLabel', message: 'Blog post page navigation', description: 'The ARIA label for the blog posts pagination' }), children: [o && (0, c.jsx)(O.Z, { ...o, subLabel: (0, c.jsx)(h.Z, { id: 'theme.blog.post.paginator.newerPost', description: 'The blog post button label to navigate to the newer/previous post', children: 'Newer Post' }) }), t && (0, c.jsx)(O.Z, { ...t, subLabel: (0, c.jsx)(h.Z, { id: 'theme.blog.post.paginator.olderPost', description: 'The blog post button label to navigate to the older/next post', children: 'Older Post' }), isNext: !0 })] });
   }
   var R = o(25443),
    U = o(29450);
   function $(e) {
    ...
    return (0, c.jsxs)(U.Z, { breadcrumbs: [{ label: 'Blog', href: '/blog' }, { label: l.title }], sidebar: t, toc: !d && r.length > 0 ? (0, c.jsx)(R.Z, { toc: r, minHeadingLevel: m, maxHeadingLevel: u }) : void 0, children: [(0, c.jsx)(S, { children: o }), (n || a) && (0, c.jsx)(L, { nextItem: n, prevItem: a })] });
   }
   function E(e) {
    const t = e.content;
    return (0, c.jsx)(s.n, { content: e.content, isBlogPostPage: !0, children: (0, c.jsxs)(l.FG, { className: (0, n.Z)(r.k.wrapper.blogPages, r.k.page.blogPostPage), children: [(0, c.jsx)(A, {}), (0, c.jsx)($, { sidebar: e.sidebar, children: (0, c.jsx)(t, {}) })] }) });
   }
  },
  21581: (e, t, o) => {
   o.d(t, { Z: () => g });
