 ...
 [61448],
 {
  45826: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(87176),
    s = n(90786);
   const o = { title: 'Subscript', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Subscript', pagination_label: 'Subscript', description: 'Toont tekst met een kleiner lettertype met een verlaagde letterlijn.', slug: '/subscript' },
    a = void 0,
    l = { id: 'componenten/subscript/index', title: 'Subscript', description: 'Toont tekst met een kleiner lettertype met een verlaagde letterlijn.', source: '@site/docs/componenten/subscript/index.mdx', sourceDirName: 'componenten/subscript', slug: '/subscript', permalink: '/en/subscript', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/subscript/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Subscript', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Subscript', pagination_label: 'Subscript', description: 'Toont tekst met een kleiner lettertype met een verlaagde letterlijn.', slug: '/subscript' }, sidebar: 'componenten', previous: { title: 'Sub Heading', permalink: '/en/sub-heading' }, next: { title: 'Superscript', permalink: '/en/superscript' } },
    u = {},
    d = [
