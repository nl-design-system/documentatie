 ...
 [34894],
 {
  19736: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    o = n(16391);
   const s = { title: 'Checkbox', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Checkbox', pagination_label: 'Checkbox', description: ' ', slug: '/checkbox', sidebar_custom_props: { illustration: 'CheckboxSketch' } },
    a = void 0,
    u = { id: 'componenten/checkbox/index', title: 'Checkbox', description: ' ', source: '@site/docs/componenten/checkbox/index.mdx', sourceDirName: 'componenten/checkbox', slug: '/checkbox', permalink: '/en/checkbox', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/checkbox/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Checkbox', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Checkbox', pagination_label: 'Checkbox', description: ' ', slug: '/checkbox', sidebar_custom_props: { illustration: 'CheckboxSketch' } }, sidebar: 'componenten', previous: { title: 'Case card', permalink: '/en/case-card' }, next: { title: 'Checkbox group', permalink: '/en/checkbox-group' } },
    l = {},
    h = [
