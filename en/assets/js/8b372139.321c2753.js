 ...
 [3712],
 {
  70963: (n, t, i) => {
   ...
   const s = { title: "Definition list", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Definition list", pagination_label: "Definition list", description: "UX richtlijnen voor Definition list component", slug: "/definition-list", tags: ["Unknown"] },
    l = "Definition list",
    r = { id: "componenten/build/definition-list", title: "Definition list", description: "UX richtlijnen voor Definition list component", source: "@site/docs/componenten/build/definition-list.mdx", sourceDirName: "componenten/build", slug: "/definition-list", permalink: "/en/definition-list", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/definition-list.mdx", tags: [{ label: "Unknown", permalink: "/en/tags/unknown" }], version: "current", frontMatter: { title: "Definition list", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Definition list", pagination_label: "Definition list", description: "UX richtlijnen voor Definition list component", slug: "/definition-list", tags: ["Unknown"] }, sidebar: "componenten", previous: { title: "Date picker", permalink: "/en/date-picker" }, next: { title: "Details", permalink: "/en/details" } },
    c = {},
    a = [];
   function d(n) {
