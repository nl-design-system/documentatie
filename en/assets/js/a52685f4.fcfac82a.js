...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  10604: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => c, contentTitle: () => d, default: () => p, frontMatter: () => l, metadata: () => a, toc: () => u });
   var r = t(52676),
    i = t(24785),
    s = t(61663),
    o = t(54894);
   const l = { title: "WCAG-succescriterium 1.3.5 Identificeer het doel van de input", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "1.3.5 Identificeer het doel van de input", pagination_label: "WCAG-succescriterium 1.3.5 Identificeer het doel van de input", description: "Zorg dat de browser kan begrijpen wat een gebruiker moet invoeren, zodat die kan helpen en het makkelijker kan maken.", slug: "1.3.5", keywords: ["WCAG"] },
    d = "WCAG-succescriterium 1.3.5 Identificeer het doel van de input",
    a = { id: "wcag/1.3.5", title: "WCAG-succescriterium 1.3.5 Identificeer het doel van de input", description: "Zorg dat de browser kan begrijpen wat een gebruiker moet invoeren, zodat die kan helpen en het makkelijker kan maken.", source: "@site/docs/wcag/1.3.5.mdx", sourceDirName: "wcag", slug: "/wcag/1.3.5", permalink: "/en/wcag/1.3.5", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.3.5.mdx", tags: [], version: "current", frontMatter: { title: "WCAG-succescriterium 1.3.5 Identificeer het doel van de input", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "1.3.5 Identificeer het doel van de input", pagination_label: "WCAG-succescriterium 1.3.5 Identificeer het doel van de input", description: "Zorg dat de browser kan begrijpen wat een gebruiker moet invoeren, zodat die kan helpen en het makkelijker kan maken.", slug: "1.3.5", keywords: ["WCAG"] }, sidebar: "richtlijnen", previous: { title: "WCAG-succescriterium 1.3.1 Info en relaties", permalink: "/en/wcag/1.3.1" }, next: { title: "WCAG-succescriterium 2.1.1 Toetsenbord", permalink: "/en/wcag/2.1.1" } },
    c = {},
    u = [
