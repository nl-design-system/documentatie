 ...
 [2937],
 {
  ...
  20537: (e, n, t) => {
   ...
   function j(e) {
    ...
    const r = (0, i.MN)(n);
    return (0, c.jsx)('section', { className: (0, s.Z)('row', t), children: r.map((e, n) => (0, c.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, c.jsx)(m, { item: e }) }, n)) });
   }
  },
  24785: (e, n, t) => {
   t.d(n, { Z: () => l, a: () => s });
