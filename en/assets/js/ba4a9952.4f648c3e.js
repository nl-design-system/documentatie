/*! For license information please see ba4a9952.4f648c3e.js.LICENSE.txt */
'use strict';
 ...
 [2850],
 {
  71486: (e, n, o) => {
   ...
   var r = o(52676),
    ...
    l = o(81094),
    s = o(46506);
   const a = { title: 'Developer Open Hour', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Developer Open Hour', pagination_label: 'In het Developer Open Hour wisselen developers informatie, inzichten en tips met elkaar uit.', description: 'Wat is Developer Open Hour?', slug: '/events/developer-open-hour' },
    d = 'Developer Open Hour',
    p = { id: 'community/events/developer-open-hour/developer-open-hour', title: 'Developer Open Hour', description: 'Wat is Developer Open Hour?', source: '@site/docs/community/events/developer-open-hour/developer-open-hour.mdx', sourceDirName: 'community/events/developer-open-hour', slug: '/events/developer-open-hour', permalink: '/en/events/developer-open-hour', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/community/events/developer-open-hour/developer-open-hour.mdx', tags: [], version: 'current', frontMatter: { title: 'Developer Open Hour', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Developer Open Hour', pagination_label: 'In het Developer Open Hour wisselen developers informatie, inzichten en tips met elkaar uit.', description: 'Wat is Developer Open Hour?', slug: '/events/developer-open-hour' }, sidebar: 'community', previous: { title: 'Developer Open Hour', permalink: '/en/events/developer-open-hour/overzicht' }, next: { title: 'In het Developer Open Hour wisselen developers informatie, inzichten en tips met elkaar uit.', permalink: '/en/events/developer-open-hour/aanmelden' } },
    u = {},
    h = [
