   ...
   const s = (e) => {
    ...
    u = (e) => {
     ...
     const l = (e) => ('article' === a ? (0, o.jsx)('article', { ...e }) : 'section' === a ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      h = (0, o.jsx)(l, { className: (0, c.Z)(i.cardgroup__card, i[`cardgroup__card--${n}`], s), children: u });
     return t ? (0, o.jsx)(r.rU, { href: t, boxContent: !0, className: i.cardgroup__link, children: h }) : h;
    },
    l = (e) => {
  ...
  4460: (e, t, n) => {
   ...
   const k = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    v = (e) => {
     ...
     return (0, l.jsxs)('hgroup', { className: (0, c.Z)(k['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, l.jsx)('h1', { className: (0, c.Z)(k['nlds-inline-heading-group__heading']), children: t }), r && (0, l.jsxs)('p', { className: (0, c.Z)(k['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var b = n(46506),
    f = n(25953);
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, c.Z)(x), children: [(0, l.jsxs)('div', { className: (0, c.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: z, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.aC, { role: 'presentation', children: n }), (0, l.jsx)(b.nv, { children: r })] })] });
    };
   var C = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const i = t && t.projects.filter((e) => C.e9.includes(e.id)),
      o = i && C.e9.map((e) => i.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, l.jsx)(A, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(S, { checked: t, title: n, description: (0, C.Q6)(r) }, r);
            }),
           }),
    ...
    M = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(v, { level: n, suffix: i && (0, l.jsx)(p.y, { state: i }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
