...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  79062: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => d, contentTitle: () => r, default: () => p, frontMatter: () => i, metadata: () => o, toc: () => l });
   var s = t(11527),
    a = t(27034);
   ...
   function m(e) {
    ...
    return (0, s.jsx)(n.p, { children: "Update over de stand van zaken rondom het traject NL Design System, ge\xefnitieerd door Gebruiker Centraal. In samenwerking met medewerkers van diverse overheidsorganisaties." });
   }
   function p(e = {}) {
  ...
  27034: (e, n, t) => {
   ...
   function o(e) {
    let n;
    return (n = e.disableParentContext ? ("function" == typeof e.components ? e.components(a) : e.components || a) : r(e.components)), s.createElement(i.Provider, { value: n }, e.children);
   }
  },
 },
]);
