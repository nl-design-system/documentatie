(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [43396],
 {
  75494: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => a, default: () => b, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => g, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Definition list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Definition list', pagination_label: 'Definition list', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', slug: '/definition-list', sidebar_custom_props: { illustration: 'DefinitionListSketch' } },
    a = void 0,
    l = { id: 'componenten/definition-list/index', title: 'Definition list', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', source: '@site/docs/componenten/definition-list/index.mdx', sourceDirName: 'componenten/definition-list', slug: '/definition-list', permalink: '/en/definition-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/definition-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Definition list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Definition list', pagination_label: 'Definition list', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', slug: '/definition-list', sidebar_custom_props: { illustration: 'DefinitionListSketch' } }, sidebar: 'componenten', previous: { title: 'Date picker', permalink: '/en/date-picker' }, next: { title: 'Dot badge', permalink: '/en/dot-badge' } },
    u = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: D, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(f.aC, { role: 'presentation', children: n }), (0, u.jsx)(f.nv, { children: r })] })] });
    };
   var z = n(14669);
   const T = (e) => {
