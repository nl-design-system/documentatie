 ...
 [81565],
 {
  35258: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    o = n(60851);
   const s = { title: 'Form field checkbox option', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field checkbox option', pagination_label: 'Form field checkbox option', description: ' ', slug: '/form-field-checkbox-option', sidebar_custom_props: { illustration: 'FormFieldCheckboxOptionSketch' } },
    a = void 0,
    l = { id: 'componenten/form-field-checkbox-option/index', title: 'Form field checkbox option', description: ' ', source: '@site/docs/componenten/form-field-checkbox-option/index.mdx', sourceDirName: 'componenten/form-field-checkbox-option', slug: '/form-field-checkbox-option', permalink: '/en/form-field-checkbox-option', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-field-checkbox-option/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form field checkbox option', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field checkbox option', pagination_label: 'Form field checkbox option', description: ' ', slug: '/form-field-checkbox-option', sidebar_custom_props: { illustration: 'FormFieldCheckboxOptionSketch' } }, sidebar: 'componenten', previous: { title: 'Form field', permalink: '/en/form-field' }, next: { title: 'Form field description', permalink: '/en/form-field-description' } },
    u = {},
    d = [
    ...
    j = '',
    y = 'FormFieldCheckboxOptionSketch',
    m = 172,
   ...
   const D = (e) => {
     ...
     return (
      ...
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, c.Z)(y['definition-of-done'], y[`definition-of-done--${(0, F.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
    ...
    C = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(f, { level: n, suffix: i && (0, u.jsx)(p.y, { state: i }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  42677: (e, t, n) => {
   'use strict';
