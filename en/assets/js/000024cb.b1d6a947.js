...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [3247],
 {
  ...
  43067: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => A, contentTitle: () => C, default: () => P, frontMatter: () => L, metadata: () => S, toc: () => G });
   var i = l(52676),
    r = l(24785),
    t = l(3510),
    a = l(66771),
  ...
  66771: (e, n, l) => {
   ...
   const x = (e) => {
    ...
    let L = c.Fragment;
    return (
     'paragraph' === f ? (L = j) : 'document' === f ? (L = g) : 'surface' === f && (L = b),
     (0, p.jsxs)('div', {
      className: (0, r.Z)(u['nlds-canvas']),
      children: [
       w && (0, p.jsx)('div', { className: (0, r.Z)(u['nlds-canvas__example']), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, p.jsx)(L, { children: (0, p.jsx)(i.pu, { children: w }) }) }) }),
       v &&
        (0, p.jsx)('div', {
