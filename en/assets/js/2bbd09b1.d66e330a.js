   ...
   var d = o.createContext({}),
    ...
    u = o.forwardRef(function (e, n) {
     var t = e.components,
      ...
      m = s(t),
      u = r,
      g = m["".concat(d, ".").concat(u)] || m[u] || c[u] || a;
     return t ? o.createElement(g, i(i({ ref: n }, p), {}, { components: t })) : o.createElement(g, i({ ref: n }, p));
    });
   function g(e, n) {
    var t = arguments,
     r = n && n.mdxType;
    if ("string" == typeof e || r) {
     ...
     (l.originalType = e), (l[m] = "string" == typeof e ? e : r), (i[1] = l);
