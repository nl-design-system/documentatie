...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [7478],
 {
  ...
  19561: (e, n, r) => {
   ...
   function F(e) {
    const n = { input: "input", ...(0, o.a)(), ...e.components };
    return (0, t.jsxs)(t.Fragment, { children: ["\n", "\n", "\n", (0, t.jsx)(i.X, { appearance: "do", title: "Maak de placeholder goed leesbaar door voldoende contrast.", description: (0, t.jsxs)(t.Fragment, { children: ["Dit voorbeeld heeft", " ", (0, t.jsx)(l.rU, { href: "/contrast/?color=%23606060&background-color=%23ffffff", children: "een contrast van 6.28:1" }), "."] }), children: (0, t.jsx)(s.X, { language: "html", designTokens: { "--utrecht-textbox-background-color": "#ffffff", "--utrecht-textbox-placeholder-color": "#606060" }, children: () => (0, t.jsx)(t.Fragment, { children: (0, t.jsx)(n.input, { placeholder: "Zoeken" }) }) }) }), "\n", (0, t.jsx)(i.X, { appearance: "dont", title: "Maak de placeholder slecht zichtbaar door te laag contrast.", description: (0, t.jsxs)(t.Fragment, { children: ["Dit voorbeeld heeft", " ", (0, t.jsx)(l.rU, { href: "/contrast/?color=%23888888&background-color=%23ffffff", children: "een contrast van 3.54:1" }), "."] }), children: (0, t.jsx)(s.X, { language: "html", designTokens: { "--utrecht-textbox-background-color": "#ffffff", "--utrecht-textbox-placeholder-color": "#888888" }, children: () => (0, t.jsx)(t.Fragment, { children: (0, t.jsx)(n.input, { placeholder: "Zoeken" }) }) }) })] });
   }
   function C(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
  ...
  65477: (e, n, r) => {
   ...
   const f = (e) => {
    let { code: n, copy: r = !1, defaultExpandedCode: f = !1, displayCode: v = !0, children: k, container: b = "document", language: w, designTokens: _ } = e,
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (F = await d.ZP.format(A, { parser: w, plugins: [s.Z, i.ZP, l.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), C(F);
     })();
    }, [A]);
    const Z = (0, c.useId)();
    let M = c.Fragment;
    return (
     "paragraph" === b ? (M = m) : "document" === b ? (M = j) : "surface" === b && (M = x),
     (0, g.jsxs)("div", {
    ...
    return (
     ...
     (0, i.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsx)(t.dn, { style: r, children: o.map((e, r) => (0, i.jsxs)("span", { ...s({ line: e }), children: [n && (0, i.jsx)("span", { children: r + 1 }), e.map((e, n) => (0, i.jsx)("span", { ...l({ token: e }) }, n)), "\n"] }, r)) });
      },
     })
    );
   }
  ...
  32957: (e, n, r) => {
   ...
   const d = (e) => {
    ...
    const u = "Doen",
     ...
     g = h ? "figure" : "div",
     m = h ? "figcaption" : "div";
    return (0, a.jsxs)(g, { className: (0, i.Z)(l["nlds-guideline"], l[`nlds-guideline--${r}`]), id: "string" == typeof n ? n?.toLowerCase().replace(/\s/g, "-") : void 0, children: [(0, a.jsxs)(m, { className: (0, i.Z)(l["nlds-guideline__description"]), children: ["dont" === r ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(s.nv, { className: (0, i.Z)(l["nlds-guideline__badge"], l[`nlds-guideline__badge--${r}`]), children: [(0, a.jsx)(t.Z, { className: l["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: l["nlds-guideline__title"], children: p })] }), (0, a.jsx)(s.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(s.nv, { className: (0, i.Z)(l["nlds-guideline__badge"], l[`nlds-guideline__badge--${r}`]), children: [(0, a.jsx)(o.Z, { className: l["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: l["nlds-guideline__title"], children: u })] }), (0, a.jsx)(s.nv, { children: n })] }), d] }), (0, a.jsx)("div", { className: (0, i.Z)(l["nlds-guideline__example"]), children: c })] });
   };
  },
  80877: (e, n, r) => {
   r.d(n, { Z: () => l, a: () => i });
