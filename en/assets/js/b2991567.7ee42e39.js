 ...
 [36918],
 {
  85330: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(87176),
    o = n(90786);
   const s = { title: 'Invalid Form Alert', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Invalid Form Alert', pagination_label: 'Invalid Form Alert', description: ' ', slug: '/invalid-form-alert' },
    a = void 0,
    l = { id: 'componenten/invalid-form-alert/index', title: 'Invalid Form Alert', description: ' ', source: '@site/docs/componenten/invalid-form-alert/index.mdx', sourceDirName: 'componenten/invalid-form-alert', slug: '/invalid-form-alert', permalink: '/en/invalid-form-alert', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/invalid-form-alert/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Invalid Form Alert', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Invalid Form Alert', pagination_label: 'Invalid Form Alert', description: ' ', slug: '/invalid-form-alert' }, sidebar: 'componenten', previous: { title: 'Image', permalink: '/en/image' }, next: { title: 'Language Navigation', permalink: '/en/language-navigation' } },
    u = {},
    d = [
          ...
          children: [
           (0, u.jsx)(_, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(x, { checked: t, title: n, description: (0, A.Q6)(r) }, r);
            }),
           }),
