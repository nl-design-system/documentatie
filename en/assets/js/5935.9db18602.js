(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [5935],
 {
  ...
  38276: (e) => {
   ...
   var d,
    f = "object" == typeof document ? document.createElement("template") : {};
   f.content &&
    (d = function (e) {
    ...
    (e.exports = function (e) {
     ...
     switch ((h && h[1] && (c = h[1].toLowerCase()), c)) {
      case t:
       return (u = s(e)), i.test(e) || ((p = u.querySelector(n)) && p.parentNode.removeChild(p)), a.test(e) || ((p = u.querySelector(r)) && p.parentNode.removeChild(p)), u.querySelectorAll(t);
      case n:
      case r:
       return (f = (u = l(e)).querySelectorAll(c)), a.test(e) && i.test(e) ? f[0].parentNode.childNodes : f;
      default:
       return d ? d(e) : (p = l(e, r).querySelector(r)).childNodes;
     }
    });
  },
  14152: (e, t, n) => {
  ...
  1507: (e, t, n) => {
   for (var r, o = n(47915), i = n(60885).CASE_SENSITIVE_TAG_NAMES, a = o.Comment, l = o.Element, s = o.ProcessingInstruction, c = o.Text, u = {}, p = 0, d = i.length; p < d; p++) (r = i[p]), (u[r.toLowerCase()] = r);
   function f(e) {
   ...
   (t.formatAttributes = f),
    (t.formatDOM = function e(t, n, r) {
     n = n || null;
     for (var o, i = [], u = 0, p = t.length; u < p; u++) {
      var d,
       m = t[u];
      switch (m.nodeType) {
       case 1:
        (o = h(m.nodeName)), ((d = new l(o, f(m.attributes))).children = e("template" === o ? m.content.childNodes : m.childNodes, d));
        break;
       case 3:
        d = new c(m.nodeValue);
        break;
      ...
      var y = i[u - 1] || null;
      y && (y.next = d), (d.parent = n), (d.prev = y), (d.next = null), i.push(d);
     }
     return r && (((d = new s(r.substring(0, r.indexOf(" ")).toLowerCase(), r)).next = i[0] || null), (d.parent = n), i.unshift(d), i[1] && (i[1].prev = i[0])), i;
    });
  },
  30488: (e, t, n) => {
   var r = n(47915),
  ...
  50484: (e, t, n) => {
   ...
   e.exports = function (e, t) {
    var n,
     ...
     h = (e = e || {}).type && l[e.type];
    for (n in e)
     if (((u = e[n]), r.isCustomAttribute(n))) f[n] = u;
     else if ((p = s((c = n.toLowerCase()))))
      switch (((d = r.getPropertyInfo(p)), -1 === i.indexOf(p) || -1 === a.indexOf(t) || h || (p = s("default" + c)), (f[p] = u), d && d.type)) {
       case r.BOOLEAN:
        f[p] = !0;
        break;
     ...
     else o.PRESERVE_CUSTOM_ATTRIBUTES && (f[n] = u);
    return o.setStyleProp(e.style, f), f;
   };
  },
  53670: (e, t, n) => {
   var r = n(67294),
   ...
   e.exports = function e(t, n) {
    for (var i, c, u, p, d, f = (n = n || {}).library || r, h = f.cloneElement, m = f.createElement, y = f.isValidElement, g = [], v = "function" == typeof n.replace, b = n.trim, x = 0, k = t.length; x < k; x++)
     if (((i = t[x]), v && y((u = n.replace(i))))) k > 1 && (u = h(u, { key: u.key || x })), g.push(u);
     else if ("text" !== i.type) {
      switch (((p = i.attribs), s(i) ? a(p.style, p) : p && (p = o(p, i.name)), (d = null), i.type)) {
       case "script":
       case "style":
        i.children[0] && (p.dangerouslySetInnerHTML = { __html: i.children[0].data });
        break;
       case "tag":
        "textarea" === i.name && i.children[0] ? (p.defaultValue = i.children[0].data) : i.children && i.children.length && (d = e(i.children, n));
        break;
       default:
        continue;
      }
  ...
  18139: (e) => {
   ...
   e.exports = function (e, s) {
    ...
    function m(e) {
     (this.start = e), (this.end = { line: p, column: d }), (this.source = s.source);
    }
    ...
    function w() {
     ...
     if (n) {
      ...
      var r = v(a),
       s = e({ type: "declaration", property: u(n[0].replace(t, c)), value: r ? u(r[0].replace(t, c)) : c });
      return v(l), s;
     }
    }
    return (
   ...
   t.camelCase = function (e, t) {
    return (
     ...
     (function (e) {
      ...
      ? e
      : ((e = e.toLowerCase()), (e = t.reactCompat ? e.replace(a, s) : e.replace(i, s)).replace(r, l))
    );
   };
  },
  48849: (e, t, n) => {
