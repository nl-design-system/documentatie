   ...
   function s(e) {
    !(function (e) {
     ...
     var t = /'[{}:=,](?:[^']|'')*'(?!')/,
      ...
      a = { pattern: t, greedy: !0, inside: { escape: n } },
      r = s(
