(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [54942],
 {
  62978: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => o, issueNumber: () => y, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(7617),
    s = n(4460);
   const o = { title: 'Summary list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Summary list', pagination_label: 'Summary list', description: ' ', slug: '/summary-list' },
    a = void 0,
    u = { id: 'componenten/summary-list/index', title: 'Summary list', description: ' ', source: '@site/docs/componenten/summary-list/index.mdx', sourceDirName: 'componenten/summary-list', slug: '/summary-list', permalink: '/en/summary-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/summary-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Summary list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Summary list', pagination_label: 'Summary list', description: ' ', slug: '/summary-list' }, sidebar: 'componenten', previous: { title: 'Sub heading', permalink: '/en/sub-heading' }, next: { title: 'Switch', permalink: '/en/switch' } },
    l = {},
    d = [
  ...
  4460: (e, t, n) => {
   ...
   const T = (e) => {
     ...
     const c = t && t.projects.filter((e) => D.e9.includes(e.id)),
      s = c && D.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
