 ...
 [30059],
 {
  ...
  72657: (e, n, i) => {
   ...
   const r = (e) => {
    ...
    return (0, a.jsxs)('hgroup', { className: (0, s.Z)(t['nlds-inline-heading-group'], `utrecht-heading-${r}`, i), ...o, children: [(0, a.jsx)('h1', { className: (0, s.Z)(t['nlds-inline-heading-group__heading']), children: n }), l && (0, a.jsxs)('p', { className: (0, s.Z)(t['nlds-inline-heading-group__suffix']), children: [l ? ' ' : '', l] })] });
   };
  },
  73381: (e, n, i) => {
   i.d(n, { Y: () => o });
   ...
   const o = (e) => {
    ...
    return (0, l.jsx)(a(), { url: `https://youtube.com/watch?v=${n}`, className: `${(0, s.Z)(r['video-player'])} ${i}`, width: '100%', height: '100%', controls: !0, ...t, config: { youtube: { playerVars: { disablekb: 1 } } } });
   };
  },
  71595: (e, n, i) => {
   i.d(n, { j: () => o });
   ...
   const o = (e) => {
    ...
    return (0, l.jsx)(t.V, { className: a, suffix: i && (0, l.jsx)(s.Ou, { className: r, children: i }), ...o, children: n });
   };
  },
 },
]);
