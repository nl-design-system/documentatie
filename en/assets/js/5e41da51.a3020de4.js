 ...
 [94960],
 {
  4328: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(7617),
    o = n(4460);
   const s = { title: 'Drawer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Drawer', pagination_label: 'Drawer', description: 'Een paneel aan de zijkant van een scherm, die geopend kan worden voor gerelateerde informatie, formulieren of acties.', slug: '/drawer' },
    a = void 0,
    u = { id: 'componenten/drawer/index', title: 'Drawer', description: 'Een paneel aan de zijkant van een scherm, die geopend kan worden voor gerelateerde informatie, formulieren of acties.', source: '@site/docs/componenten/drawer/index.mdx', sourceDirName: 'componenten/drawer', slug: '/drawer', permalink: '/en/drawer', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/drawer/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Drawer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Drawer', pagination_label: 'Drawer', description: 'Een paneel aan de zijkant van een scherm, die geopend kan worden voor gerelateerde informatie, formulieren of acties.', slug: '/drawer' }, sidebar: 'componenten', previous: { title: 'Dot badge', permalink: '/en/dot-badge' }, next: { title: 'Fieldset', permalink: '/en/fieldset' } },
    l = {},
    d = [
  ...
  4460: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    D = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.aC, { role: 'presentation', children: n }), (0, l.jsx)(b.nv, { children: r })] })] });
    };
   var S = n(14669);
   const T = (e) => {
          ...
          children: [
           (0, l.jsx)(z, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(D, { checked: t, title: n, description: (0, S.Q6)(r) }, r);
            }),
           }),
    ...
    M = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(f, { level: n, suffix: c && (0, l.jsx)(p.y, { state: c }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
