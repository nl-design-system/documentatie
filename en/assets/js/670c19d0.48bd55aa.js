...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [87335],
 {
  ...
  87285: (e, n, t) => {
   ...
   var s = t(55400);
   const a = { title: 'Controleer op het juiste moment op fouten \xb7 Foutmeldingen in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Fouten controleren', pagination_label: 'Fouten controleren', description: 'Richtlijnen voor controleren van fouten in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/controleren', keywords: ['labels', 'formulier', 'design', 'code'] },
    c = void 0,
    d = { id: 'richtlijnen/formulieren/error/timing/README', title: 'Controleer op het juiste moment op fouten \xb7 Foutmeldingen in een formulier \xb7 Richtlijnen', description: 'Richtlijnen voor controleren van fouten in een formulier.', source: '@site/docs/richtlijnen/formulieren/error/1-timing/README.mdx', sourceDirName: 'richtlijnen/formulieren/error/1-timing', slug: '/richtlijnen/formulieren/foutmeldingen/controleren', permalink: '/en/richtlijnen/formulieren/foutmeldingen/controleren', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/error/1-timing/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Controleer op het juiste moment op fouten \xb7 Foutmeldingen in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Fouten controleren', pagination_label: 'Fouten controleren', description: 'Richtlijnen voor controleren van fouten in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/controleren', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Foutmeldingen', permalink: '/en/richtlijnen/formulieren/foutmeldingen/' }, next: { title: 'Fouten beschrijven', permalink: '/en/richtlijnen/formulieren/foutmeldingen/beschrijven' } },
    u = {},
    m = [];
   function h(e) {
