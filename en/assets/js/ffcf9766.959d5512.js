 ...
 [7869],
 {
  16641: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(7617),
    o = n(4460);
   const s = { title: 'Number input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number input', pagination_label: 'Number input', description: 'Invoerveld voor een heel getal of een getal met decimalen.', slug: '/number-input' },
    a = void 0,
    u = { id: 'componenten/number-input/index', title: 'Number input', description: 'Invoerveld voor een heel getal of een getal met decimalen.', source: '@site/docs/componenten/number-input/index.mdx', sourceDirName: 'componenten/number-input', slug: '/number-input', permalink: '/en/number-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/number-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Number input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number input', pagination_label: 'Number input', description: 'Invoerveld voor een heel getal of een getal met decimalen.', slug: '/number-input' }, sidebar: 'componenten', previous: { title: 'Number badge', permalink: '/en/number-badge' }, next: { title: 'Ordered list', permalink: '/en/ordered-list' } },
    l = {},
    d = [
  ...
  4460: (e, t, n) => {
   ...
   const b = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    v = (e) => {
     ...
     return (0, l.jsxs)('hgroup', { className: (0, i.Z)(b['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, l.jsx)('h1', { className: (0, i.Z)(b['nlds-inline-heading-group__heading']), children: t }), r && (0, l.jsxs)('p', { className: (0, i.Z)(b['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var f = n(46506),
    k = n(25953);
   const _ = 'task-list_hh8j',
    x = 'task-list-item_oypx',
    N = 'task-list-item__marker_Eefn',
    ...
    S = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(N, { [w]: t }), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(f.aC, { role: 'presentation', children: n }), (0, l.jsx)(f.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], e && y[`definition-of-done--${(0, D.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, l.jsx)(z, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(S, { checked: t, title: n, description: (0, D.Q6)(r) }, r);
            }),
           }),
    ...
    M = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(v, { level: n, suffix: c && (0, l.jsx)(p.y, { state: c }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
