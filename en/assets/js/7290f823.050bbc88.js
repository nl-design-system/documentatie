(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [44275],
 {
  72934: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => a, default: () => v, description: () => j, frontMatter: () => s, illustration: () => y, issueNumber: () => g, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    o = n(60851);
   const s = { title: 'Alert dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Alert dialog', pagination_label: 'Alert dialog', description: ' ', slug: '/alert-dialog', sidebar_custom_props: { illustration: 'AlertDialogSketch' }, keywords: ['alert', 'confirm', 'dialog', 'dialoogvenster', 'modal', 'venster', 'waarschuwing'] },
    a = void 0,
    l = { id: 'componenten/alert-dialog/index', title: 'Alert dialog', description: ' ', source: '@site/docs/componenten/alert-dialog/index.mdx', sourceDirName: 'componenten/alert-dialog', slug: '/alert-dialog', permalink: '/en/alert-dialog', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/alert-dialog/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Alert dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Alert dialog', pagination_label: 'Alert dialog', description: ' ', slug: '/alert-dialog', sidebar_custom_props: { illustration: 'AlertDialogSketch' }, keywords: ['alert', 'confirm', 'dialog', 'dialoogvenster', 'modal', 'venster', 'waarschuwing'] }, sidebar: 'componenten', previous: { title: 'Alert', permalink: '/en/alert' }, next: { title: 'Avatar', permalink: '/en/avatar' } },
    u = {},
    d = [
