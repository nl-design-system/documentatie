 ...
 [82200],
 {
  26757: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(80719),
    s = n(90786);
   const o = { title: 'Ordered list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Ordered list', pagination_label: 'Ordered list', description: 'Lijst waarvan de volgorde van items betekenis heeft.', slug: '/ordered-list' },
    a = void 0,
    l = { id: 'componenten/ordered-list/index', title: 'Ordered list', description: 'Lijst waarvan de volgorde van items betekenis heeft.', source: '@site/docs/componenten/ordered-list/index.mdx', sourceDirName: 'componenten/ordered-list', slug: '/ordered-list', permalink: '/en/ordered-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/ordered-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Ordered list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Ordered list', pagination_label: 'Ordered list', description: 'Lijst waarvan de volgorde van items betekenis heeft.', slug: '/ordered-list' }, sidebar: 'componenten', previous: { title: 'Number input', permalink: '/en/number-input' }, next: { title: 'Page footer', permalink: '/en/page-footer' } },
    u = {},
    d = [
    ...
    h = 'Ordered list',
    j = 'Lijst waarvan de volgorde van items betekenis heeft.',
    y = 117,
