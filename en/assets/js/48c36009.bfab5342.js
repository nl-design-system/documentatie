 ...
 [78239],
 {
  81877: (e, t, n) => {
   ...
   const s = { title: 'Date Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Input', pagination_label: 'Date Input', description: 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.', slug: '/date-input', keywords: ['browser', 'built-in', 'date', 'date field', 'date input', 'date picker', 'date selection', 'datepicker', 'datum', 'datum invoer', 'datumveld', 'form', 'form control', 'formulier', 'formulierelement', 'ingebouwd', 'input', 'input field', 'invoerveld', 'invullen', 'kalender', 'native', 'text field', 'textbox'] },
    a = void 0,
    u = { id: 'componenten/date-input/index', title: 'Date Input', description: 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.', source: '@site/docs/componenten/date-input/index.mdx', sourceDirName: 'componenten/date-input', slug: '/date-input', permalink: '/en/date-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Date Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Input', pagination_label: 'Date Input', description: 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.', slug: '/date-input', keywords: ['browser', 'built-in', 'date', 'date field', 'date input', 'date picker', 'date selection', 'datepicker', 'datum', 'datum invoer', 'datumveld', 'form', 'form control', 'formulier', 'formulierelement', 'ingebouwd', 'input', 'input field', 'invoerveld', 'invullen', 'kalender', 'native', 'text field', 'textbox'] }, sidebar: 'componenten', previous: { title: 'Data Badge', permalink: '/en/data-badge' }, next: { title: 'Date Input Group', permalink: '/en/date-input-group' } },
    l = {},
    d = [
