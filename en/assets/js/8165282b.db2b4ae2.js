 ...
 [49619],
 {
  12270: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(7617),
    o = n(4460);
   const s = { title: 'Text input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text input', pagination_label: 'Text input', description: 'Biedt de mogelijkheid om \xe9\xe9n regel aan tekens in te vullen.', slug: '/text-input' },
    a = void 0,
    u = { id: 'componenten/text-input/index', title: 'Text input', description: 'Biedt de mogelijkheid om \xe9\xe9n regel aan tekens in te vullen.', source: '@site/docs/componenten/text-input/index.mdx', sourceDirName: 'componenten/text-input', slug: '/text-input', permalink: '/en/text-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/text-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Text input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text input', pagination_label: 'Text input', description: 'Biedt de mogelijkheid om \xe9\xe9n regel aan tekens in te vullen.', slug: '/text-input' }, sidebar: 'componenten', previous: { title: 'Task list', permalink: '/en/task-list' }, next: { title: 'Text input group', permalink: '/en/text-input-group' } },
    l = {},
    d = [
    ...
    h = 'Text input',
    j = 'Biedt de mogelijkheid om \xe9\xe9n regel aan tekens in te vullen.',
    y = 200,
  ...
  4460: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.aC, { role: 'presentation', children: n }), (0, l.jsx)(b.nv, { children: r })] })] });
    };
   var S = n(14669);
   const D = (e) => {
    ...
    M = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(k, { level: n, suffix: c && (0, l.jsx)(p.y, { state: c }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
