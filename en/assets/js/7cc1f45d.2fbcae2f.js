  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: z, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.aC, { role: 'presentation', children: n }), (0, l.jsx)(v.nv, { children: r })] })] });
    };
   var D = n(14669);
   const T = (e) => {
     let { component: t, headingLevel: n } = e;
     const o = t && t.projects.filter((e) => D.e9.includes(e.id)),
      c = o && D.e9.map((e) => o.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
    ...
    C = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(k, { level: n, suffix: o && (0, l.jsx)(p.y, { state: o }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  42677: (e, t, n) => {
   'use strict';
