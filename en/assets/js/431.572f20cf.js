(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [431],
 {
    ...
    S = (e, t) => {
     ...
     return (
      (r = class extends h.Component {
       constructor() {
        super(...arguments),
         ...
         p(
          ...
          "getActivePlayer",
          (0, m.default)((r) => {
           for (const t of [...T, ...e]) if (t.canPlay(r)) return t;
           return t || null;
          }),
         ),
         p(
       ...
       renderPreview(e) {
        if (!e) return null;
        const { light: t, playIcon: r, previewTabIndex: n, oEmbedUrl: a } = this.props;
        return h.default.createElement(v, { url: e, light: t, playIcon: r, previewTabIndex: n, oEmbedUrl: a, onClick: this.handleClickPreview });
       }
       render() {
        ...
        return h.default.createElement(o, { ref: s, style: { ...t, width: r, height: n }, ...l }, h.default.createElement(j, { fallback: a }, i ? this.renderPreview(e) : this.renderActivePlayer(e)));
       }
      }),
      ...
      p(r, "canPlay", (t) => {
       for (const r of [...T, ...e]) if (r.canPlay(t)) return !0;
       return !1;
      }),
      p(r, "canEnablePIP", (t) => {
       for (const r of [...T, ...e]) if (r.canEnablePIP && r.canEnablePIP(t)) return !0;
       return !1;
      }),
      r
     );
  ...
  7049: (e, t, r) => {
   ...
   var p = ((e, t, r) => ((r = null != e ? a(s(e)) : {}), c(!t && e && e.__esModule ? r : o(r, "default", { value: e, enumerable: !0 }), e)))(r(157)),
    y = r(7609);
  ...
  3899: (e, t, r) => {
   ...
   const c = /(?:youtu\.be\/|youtube(?:-nocookie|education)?\.com\/(?:embed\/|v\/|watch\/|watch\?v=|watch\?.+&v=|shorts\/|live\/))((\w|-){11})|youtube\.com\/playlist\?list=|youtube\.com\/user\//,
    ...
    E = (e) => {
     ...
     return !(!(0, u.isMediaStream)(e) && !(0, u.isBlobUrl)(e)) || k.test(e) || _.test(e) || j.test(e) || T.test(e) || S.test(e);
    },
    C = { youtube: (e) => (e instanceof Array ? e.every((e) => c.test(e)) : c.test(e)), soundcloud: (e) => d.test(e) && !k.test(e), vimeo: (e) => p.test(e) && !_.test(e) && !j.test(e), facebook: (e) => y.test(e) || h.test(e), streamable: (e) => f.test(e), wistia: (e) => m.test(e), twitch: (e) => b.test(e) || P.test(e), dailymotion: (e) => g.test(e), mixcloud: (e) => w.test(e), vidyard: (e) => v.test(e), kaltura: (e) => O.test(e), file: E };
  },
  157: (e, t, r) => {
   Object.create;
   var n,
   ...
   var c = r(9121),
    d = r(3899),
    p = [
     { key: "youtube", name: "YouTube", canPlay: d.canPlay.youtube, lazyPlayer: (0, c.lazy)(() => r.e(4439).then(r.t.bind(r, 7816, 23))) },
     { key: "soundcloud", name: "SoundCloud", canPlay: d.canPlay.soundcloud, lazyPlayer: (0, c.lazy)(() => r.e(6125).then(r.t.bind(r, 8306, 23))) },
     { key: "vimeo", name: "Vimeo", canPlay: d.canPlay.vimeo, lazyPlayer: (0, c.lazy)(() => r.e(3743).then(r.t.bind(r, 1634, 23))) },
     { key: "facebook", name: "Facebook", canPlay: d.canPlay.facebook, lazyPlayer: (0, c.lazy)(() => r.e(2121).then(r.t.bind(r, 6262, 23))) },
     { key: "streamable", name: "Streamable", canPlay: d.canPlay.streamable, lazyPlayer: (0, c.lazy)(() => r.e(2546).then(r.t.bind(r, 1979, 23))) },
     { key: "wistia", name: "Wistia", canPlay: d.canPlay.wistia, lazyPlayer: (0, c.lazy)(() => r.e(8055).then(r.t.bind(r, 189, 23))) },
     { key: "twitch", name: "Twitch", canPlay: d.canPlay.twitch, lazyPlayer: (0, c.lazy)(() => r.e(6216).then(r.t.bind(r, 758, 23))) },
     { key: "dailymotion", name: "DailyMotion", canPlay: d.canPlay.dailymotion, lazyPlayer: (0, c.lazy)(() => r.e(7596).then(r.t.bind(r, 6407, 23))) },
     { key: "mixcloud", name: "Mixcloud", canPlay: d.canPlay.mixcloud, lazyPlayer: (0, c.lazy)(() => r.e(4667).then(r.t.bind(r, 7789, 23))) },
     { key: "vidyard", name: "Vidyard", canPlay: d.canPlay.vidyard, lazyPlayer: (0, c.lazy)(() => r.e(8888).then(r.t.bind(r, 6994, 23))) },
     { key: "kaltura", name: "Kaltura", canPlay: d.canPlay.kaltura, lazyPlayer: (0, c.lazy)(() => r.e(261).then(r.t.bind(r, 8891, 23))) },
     { key: "file", name: "FilePlayer", canPlay: d.canPlay.file, canEnablePIP: (e) => d.canPlay.file(e) && (document.pictureInPictureEnabled || (0, c.supportsWebKitPresentationMode)()) && !d.AUDIO_EXTENSIONS.test(e), lazyPlayer: (0, c.lazy)(() => r.e(6011).then(r.t.bind(r, 3607, 23))) },
    ];
  },
  1457: (e, t, r) => {
   var n,
   ...
   ((e, t) => {
    ...
    (e.exports = ((n = d), c(o({}, "__esModule", { value: !0 }), n)));
   var p = ((e, t, r) => ((r = null != e ? a(s(e)) : {}), c(!t && e && e.__esModule ? r : o(r, "default", { value: e, enumerable: !0 }), e)))(r(507));
  ...
  9121: (e, t, r) => {
   ...
   ((e, t) => {
    for (var r in t) o(e, r, { get: t[r], enumerable: !0 });
   })(p, { callPlayer: () => R, getConfig: () => C, getSDK: () => E, isBlobUrl: () => A, isMediaStream: () => M, lazy: () => m, omit: () => I, parseEndTime: () => k, parseStartTime: () => O, queryString: () => j, randomString: () => _, supportsWebKitPresentationMode: () => D }),
