   ...
   const s = (e) => {
    ...
    l = (e) => {
     ...
     const u = (e) => ('article' === a ? (0, o.jsx)('article', { ...e }) : 'section' === a ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      h = (0, o.jsx)(u, { className: (0, c.Z)(i.cardgroup__card, i[`cardgroup__card--${n}`], s), children: l });
   ...
   const T = (e) => {
     ...
     return (
      ...
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, c.Z)(y['definition-of-done'], e && y[`definition-of-done--${(0, z.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
    ...
    V = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(v.V, { level: n, suffix: i && (0, u.jsx)(p.y, { state: i }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  80407: (e, t, n) => {
   'use strict';
