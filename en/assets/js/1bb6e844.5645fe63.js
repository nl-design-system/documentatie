...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  21927: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => j, contentTitle: () => u, default: () => b, frontMatter: () => p, metadata: () => m, toc: () => w });
   var r = i(52676),
    t = i(24785),
    s = i(57716),
    l = i(71595),
   ...
   function g(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Acties die werken met sleepbewegingen, waarbij de aanwijzer ingedrukt moet blijven terwijl je van de ene plek naar de andere plek sleept, hebben ook een manier om de handeling zonder sleepbeweging uit te voeren.' }), '\n', (0, r.jsx)(n.p, { children: 'Er is een uitzondering voor als de sleepbeweging essentieel is.' })] });
   }
   function h(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(g, { ...e }) }) : g(e);
   }
   const p = { title: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.7 Sleepbewegingen', pagination_label: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', description: 'Acties die werken met sleepbewegingen, waarbij de aanwijzer ingedrukt moet blijven terwijl je van de ene plek naar de andere plek sleept, hebben ook een manier om de handeling zonder sleepbeweging uit te voeren.', slug: '2.5.7', keywords: ['WCAG'] },
    u = void 0,
    m = { id: 'wcag/2.5.07', title: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', description: 'Acties die werken met sleepbewegingen, waarbij de aanwijzer ingedrukt moet blijven terwijl je van de ene plek naar de andere plek sleept, hebben ook een manier om de handeling zonder sleepbeweging uit te voeren.', source: '@site/docs/wcag/2.5.07.mdx', sourceDirName: 'wcag', slug: '/wcag/2.5.7', permalink: '/en/wcag/2.5.7', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.5.07.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.7 Sleepbewegingen', pagination_label: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', description: 'Acties die werken met sleepbewegingen, waarbij de aanwijzer ingedrukt moet blijven terwijl je van de ene plek naar de andere plek sleept, hebben ook een manier om de handeling zonder sleepbeweging uit te voeren.', slug: '2.5.7', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.5.6 Input gelijktijdige invoermechanismen', permalink: '/en/wcag/2.5.6' }, next: { title: 'WCAG-succescriterium 2.5.8 Grootte van het aanwijsgebied (minimum)', permalink: '/en/wcag/2.5.8' } },
    j = {},
    w = [
