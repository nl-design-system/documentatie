(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [46536],
 {
  17412: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => d, component: () => y, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => s, issueNumber: () => g, metadata: () => l, title: () => h, toc: () => u });
   var r = n(52676),
    i = n(24785),
    c = n(86226),
    o = n(63246);
   const s = { title: 'Modal dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Modal dialog', pagination_label: 'Modal dialog', description: 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina wordt geblokkeerd.', slug: '/modal-dialog' },
    a = void 0,
    l = { id: 'componenten/modal-dialog/index', title: 'Modal dialog', description: 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina wordt geblokkeerd.', source: '@site/docs/componenten/modal-dialog/index.mdx', sourceDirName: 'componenten/modal-dialog', slug: '/modal-dialog', permalink: '/en/modal-dialog', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/modal-dialog/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Modal dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Modal dialog', pagination_label: 'Modal dialog', description: 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina wordt geblokkeerd.', slug: '/modal-dialog' }, sidebar: 'componenten', previous: { title: 'Link list', permalink: '/en/link-list' }, next: { title: 'Navigation bar', permalink: '/en/navigation-bar' } },
    d = {},
    u = [
  ...
  63246: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, d.jsxs)('li', { className: (0, i.Z)(_), children: [(0, d.jsxs)('div', { className: (0, i.Z)(x, { [w]: t }), children: [(0, d.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, d.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(b.aC, { role: 'presentation', children: n }), (0, d.jsx)(b.nv, { children: r })] })] });
    };
   var S = n(14669);
   const T = (e) => {
          ...
          children: [
           (0, d.jsx)(A, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(z, { checked: t, title: n, description: (0, S.Q6)(r) }, r);
            }),
           }),
