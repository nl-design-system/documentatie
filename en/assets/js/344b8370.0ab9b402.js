 ...
 [15987],
 {
  ...
  82685: (e, n, t) => {
   ...
   const d = (e) => {
    ...
    return (0, s.jsx)(i.Z, { url: `https://youtube.com/watch?v=${n}`, className: `${(0, o.Z)(a["video-player"])} ${t}`, width: "100%", height: "100%", controls: !0, ...d, config: { youtube: { playerVars: { disablekb: 1 } } } });
   };
  },
 },
]);
