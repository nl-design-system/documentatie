 ...
 [44275],
 {
  72934: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(31612),
    o = n(16391);
   const s = { title: 'Alert dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Alert dialog', pagination_label: 'Alert dialog', description: ' ', slug: '/alert-dialog', sidebar_custom_props: { illustration: 'AlertDialogSketch' } },
    a = void 0,
    l = { id: 'componenten/alert-dialog/index', title: 'Alert dialog', description: ' ', source: '@site/docs/componenten/alert-dialog/index.mdx', sourceDirName: 'componenten/alert-dialog', slug: '/alert-dialog', permalink: '/en/alert-dialog', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/alert-dialog/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Alert dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Alert dialog', pagination_label: 'Alert dialog', description: ' ', slug: '/alert-dialog', sidebar_custom_props: { illustration: 'AlertDialogSketch' } }, sidebar: 'componenten', previous: { title: 'Alert', permalink: '/en/alert' }, next: { title: 'Avatar', permalink: '/en/avatar' } },
    u = {},
    d = [
  ...
  16391: (e, t, n) => {
   ...
   const k = 'task-list_hh8j',
    ...
    N = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, c.Z)(f), children: [(0, u.jsxs)('div', { className: (0, c.Z)(_, { [x]: t }), children: [(0, u.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.aC, { role: 'presentation', children: n }), (0, u.jsx)(v.nv, { children: r })] })] });
    };
   var S = n(14669);
