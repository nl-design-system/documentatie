(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [45119],
 {
  21543: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => s, issueNumber: () => y, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(7617),
    o = n(4460);
   const s = { title: 'Date picker', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date picker', pagination_label: 'Date picker', description: 'Biedt de mogelijkheid om een beschikbare datum te kiezen uit een op maat gemaakte kalender.', slug: '/date-picker' },
    a = void 0,
    u = { id: 'componenten/date-picker/index', title: 'Date picker', description: 'Biedt de mogelijkheid om een beschikbare datum te kiezen uit een op maat gemaakte kalender.', source: '@site/docs/componenten/date-picker/index.mdx', sourceDirName: 'componenten/date-picker', slug: '/date-picker', permalink: '/en/date-picker', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-picker/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Date picker', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date picker', pagination_label: 'Date picker', description: 'Biedt de mogelijkheid om een beschikbare datum te kiezen uit een op maat gemaakte kalender.', slug: '/date-picker' }, sidebar: 'componenten', previous: { title: 'Date input group', permalink: '/en/date-input-group' }, next: { title: 'Description list', permalink: '/en/description-list' } },
    l = {},
    d = [
    ...
    h = 'Date picker',
    j = 'Biedt de mogelijkheid om een beschikbare datum te kiezen uit een op maat gemaakte kalender.',
    y = 35,
  ...
  4460: (e, t, n) => {
   ...
   var p = n(80407);
   const k = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    b = (e) => {
     let { children: t, level: n = 1, suffix: r } = e;
     return (0, l.jsxs)('hgroup', { className: (0, i.Z)(k['nlds-inline-heading-group'], `utrecht-heading-${n}`), children: [(0, l.jsx)('h1', { className: (0, i.Z)(k['nlds-inline-heading-group__heading']), children: t }), r && (0, l.jsxs)('p', { className: (0, i.Z)(k['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var v = n(46506),
    f = n(25953);
   const _ = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(x), children: [(0, l.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.aC, { role: 'presentation', children: n }), (0, l.jsx)(v.nv, { children: r })] })] });
    };
   var S = n(14669);
   const T = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], e && y[`definition-of-done--${(0, S.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
    ...
    L = (e) => {
     ...
     return t && c.length
      ? (0, l.jsx)(j.um, {
         appearance: 'large',
         className: (0, i.Z)(y['implementation-card-group']),
         children: c
          .sort((e, t) => {
          ...
          .map((e) => {
           ...
           return (0, l.jsx)(
            j.Zb,
            {
             className: (0, i.Z)(y['implementation-card']),
