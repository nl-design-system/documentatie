...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  42205: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => d, contentTitle: () => l, default: () => g, frontMatter: () => a, metadata: () => c, toc: () => u });
   var i = t(11527),
    r = t(80877),
    s = t(45942),
    o = t(17560);
   const a = { title: "WCAG Succescriterium 3.2.2 Bij input", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "3.2.2 Bij input", pagination_label: "WCAG Succescriterium 3.2.2 Bij input", description: "Beschrijving, documentatie, gerelateerde NLDS-richtlijnen, bronnen, gebruikersonderzoek en hoe te testen.", slug: "3.2.2", keywords: ["WCAG"] },
    l = "WCAG Succescriterium 3.2.2 Bij input",
    c = { id: "wcag/3.2.2", title: "WCAG Succescriterium 3.2.2 Bij input", description: "Beschrijving, documentatie, gerelateerde NLDS-richtlijnen, bronnen, gebruikersonderzoek en hoe te testen.", source: "@site/docs/wcag/3.2.2.mdx", sourceDirName: "wcag", slug: "/wcag/3.2.2", permalink: "/en/wcag/3.2.2", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.2.2.mdx", tags: [], version: "current", frontMatter: { title: "WCAG Succescriterium 3.2.2 Bij input", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "3.2.2 Bij input", pagination_label: "WCAG Succescriterium 3.2.2 Bij input", description: "Beschrijving, documentatie, gerelateerde NLDS-richtlijnen, bronnen, gebruikersonderzoek en hoe te testen.", slug: "3.2.2", keywords: ["WCAG"] }, sidebar: "richtlijnen", previous: { title: "WCAG Succescriterium 3.2.1 Bij focus", permalink: "/en/wcag/3.2.1" }, next: { title: "WCAG Succescriterium 3.3.1 Foutidentificatie", permalink: "/en/wcag/3.3.1" } },
    d = {},
    u = [
