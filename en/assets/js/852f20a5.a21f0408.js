 ...
 [7710],
 {
  ...
  32909: (e, n, i) => {
   ...
   var c = i(73460),
    d = i(30036);
   function g(e) {
    const n = { div: "div", li: "li", p: "p", ul: "ul", ...(0, l.a)(), ...e.components };
  ...
  73460: (e, n, i) => {
   ...
   const v = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(s.Tg, { className: u["nlds-canvas__example-surface"], children: (0, p.jsx)(s.BB, { className: (0, l.Z)("utrecht-document--surface", u["nlds-canvas__example-document"]), children: (0, p.jsx)(s.nv, { className: u["nlds-canvas__example-paragraph"], children: n }) }) });
   };
   v.displayName = "ParagraphContainer";
   const h = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(s.Tg, { className: u["nlds-canvas__example-surface"], children: (0, p.jsx)(s.BB, { className: (0, l.Z)("utrecht-document--surface", u["nlds-canvas__example-document"]), children: n }) });
   };
   h.displayName = "DocumentContainer";
   const j = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(s.Tg, { className: u["nlds-canvas__example-surface"], children: n });
   };
   ...
   const b = (e) => {
    ...
    return (
     ...
     (0, p.jsxs)("div", {
      ...
      children: [
       w && (0, p.jsx)("div", { className: (0, l.Z)(u["nlds-canvas__example"]), children: (0, p.jsx)("div", { className: "voorbeeld-theme", style: y, children: (0, p.jsx)(A, { children: (0, p.jsx)(s.pu, { children: w }) }) }) }),
       x &&
        (0, p.jsx)("div", {
       ...
       x &&
        (0, p.jsxs)("div", {
         className: (0, l.Z)(u["nlds-canvas__code-block"], !i && u["nlds-canvas__code-block--user-select-none"]),
         id: D,
         hidden: !B,
         children: [
   ...
   function o(e) {
    ...
    return (
     ...
     (0, r.jsx)(l.y$, {
      ...
      language: i || "",
      children: (e) => {
       let { style: i, tokens: l, getLineProps: t, getTokenProps: o } = e;
       return (0, r.jsx)(s.dn, { style: i, children: l.map((e, i) => (0, r.jsxs)("span", { ...t({ line: e }), children: [n && (0, r.jsx)("span", { children: i + 1 }), e.map((e, n) => (0, r.jsx)("span", { ...o({ token: e }) }, n)), "\n"] }, i)) });
      },
     })
    );
   }
