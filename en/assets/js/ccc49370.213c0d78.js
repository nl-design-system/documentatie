  ...
  86252: (e, t, r) => {
   ...
   function m(e) {
    ...
    const {
     ...
     m = s.image ?? n.image,
     d = n.keywords ?? [];
    return (0, c.jsxs)("article", { className: r, itemProp: "blogPost", itemScope: !0, itemType: "https://schema.org/BlogPosting", children: [l && (0, c.jsx)("meta", { itemProp: "description", content: l }), m && (0, c.jsx)("link", { itemProp: "image", href: o(m, { absolute: !0 }) }), d.length > 0 && (0, c.jsx)("meta", { itemProp: "keywords", content: d.join(",") }), t] });
   }
   var d = r(39960);
   const u = { title: "title_f1Hy" };
   function h(e) {
    let { className: t } = e;
    const { metadata: r, isBlogPostPage: s } = (0, a.C)(),
     { permalink: l, title: o } = r,
     i = s ? "h1" : "h2";
    return (0, c.jsx)(i, { className: (0, n.Z)(u.title, t), itemProp: "headline", children: s ? o : (0, c.jsx)(d.Z, { itemProp: "url", to: l, children: o }) });
   }
   var g = r(95999),
    p = r(88824);
   const x = { container: "container_mt6G" };
   function j(e) {
    let { readingTime: t } = e;
    const r = (function () {
   ...
   function Z(e) {
    ...
    const { name: s, title: l, url: a, imageURL: o, email: i } = t,
     m = a || (i && `mailto:${i}`) || void 0;
    return (0, c.jsxs)("div", { className: (0, n.Z)("avatar margin-bottom--sm", r), children: [o && (0, c.jsx)(P, { href: m, className: "avatar__photo-link", children: (0, c.jsx)("img", { className: "avatar__photo", src: o, alt: s, itemProp: "image" }) }), s && (0, c.jsxs)("div", { className: "avatar__intro", itemProp: "author", itemScope: !0, itemType: "https://schema.org/Person", children: [(0, c.jsx)("div", { className: "avatar__name", children: (0, c.jsx)(P, { href: m, itemProp: "url", children: (0, c.jsx)("span", { itemProp: "name", children: s }) }) }), l && (0, c.jsx)("small", { className: "avatar__subtitle", itemProp: "description", children: l })] })] });
   }
   const _ = { authorCol: "authorCol_Hf19", imageOnlyAuthorRow: "imageOnlyAuthorRow_pa_O", imageOnlyAuthorCol: "imageOnlyAuthorCol_G86a" };
   function y(e) {
    let { className: t } = e;
    const {
     metadata: { authors: r },
   ...
   function I(e) {
    ...
    return (0, c.jsx)(d.Z, { "aria-label": (0, g.I)({ message: "Read more about {title}", id: "theme.blog.post.readMoreLabel", description: "The ARIA label for the link to full blog posts from excerpts" }, { title: t }), ...r, children: (0, c.jsx)(B, {}) });
   }
   const M = { blogPostFooterDetailsFull: "blogPostFooterDetailsFull_mRVl" };
   function A() {
    const { metadata: e, isBlogPostPage: t } = (0, a.C)(),
     { tags: r, title: s, editUrl: l, hasTruncateMarker: o } = e,
     i = !t && o,
     m = r.length > 0;
    return m || i || l ? (0, c.jsxs)("footer", { className: (0, n.Z)("row docusaurus-mt-lg", t && M.blogPostFooterDetailsFull), children: [m && (0, c.jsx)("div", { className: (0, n.Z)("col", { "col--9": i }), children: (0, c.jsx)(F.Z, { tags: r }) }), t && l && (0, c.jsx)("div", { className: "col margin-top--sm", children: (0, c.jsx)(k.Z, { editUrl: l }) }), i && (0, c.jsx)("div", { className: (0, n.Z)("col text--right", { "col--3": m }), children: (0, c.jsx)(I, { blogPostTitle: s, to: e.permalink }) })] }) : null;
   }
   function R(e) {
    let { children: t, className: r } = e;
    const s = (function () {
    ...
    return (0, c.jsxs)(m, { className: (0, n.Z)(s, r), children: [(0, c.jsx)(N, {}), (0, c.jsx)(T, { children: t }), (0, c.jsx)(A, {})] });
   }
   var O = r(32244);
   function L(e) {
    const { nextItem: t, prevItem: r } = e;
    return (0, c.jsxs)("nav", { className: "pagination-nav docusaurus-mt-lg", "aria-label": (0, g.I)({ id: "theme.blog.post.paginator.navAriaLabel", message: "Blog post page navigation", description: "The ARIA label for the blog posts pagination" }), children: [r && (0, c.jsx)(O.Z, { ...r, subLabel: (0, c.jsx)(g.Z, { id: "theme.blog.post.paginator.newerPost", description: "The blog post button label to navigate to the newer/previous post", children: "Newer Post" }) }), t && (0, c.jsx)(O.Z, { ...t, subLabel: (0, c.jsx)(g.Z, { id: "theme.blog.post.paginator.olderPost", description: "The blog post button label to navigate to the older/next post", children: "Older Post" }), isNext: !0 })] });
   }
   function E() {
    const { assets: e, metadata: t } = (0, a.C)(),
     { title: r, description: n, date: l, tags: o, authors: i, frontMatter: m } = t,
     { keywords: d } = m,
     u = e.image ?? m.image;
    return (0, c.jsxs)(s.d, {
     title: r,
   ...
   function $(e) {
    ...
    const { metadata: n, toc: s } = (0, a.C)(),
     { nextItem: l, prevItem: i, frontMatter: m } = n,
     { hide_table_of_contents: d, toc_min_heading_level: u, toc_max_heading_level: h } = m;
    return (0, c.jsxs)(o.Z, { breadcrumbs: [{ label: "Blog", href: "/blog" }, { label: n.title }], sidebar: t, toc: !d && s.length > 0 ? (0, c.jsx)(U.Z, { toc: s, minHeadingLevel: u, maxHeadingLevel: h }) : void 0, children: [(0, c.jsx)(R, { children: r }), (l || i) && (0, c.jsx)(L, { nextItem: l, prevItem: i })] });
   }
   function D(e) {
    const t = e.content;
