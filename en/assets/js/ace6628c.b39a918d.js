(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [83373],
 {
  4869: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => g, contentTitle: () => s, default: () => k, description: () => j, frontMatter: () => o, illustration: () => y, issueNumber: () => m, metadata: () => l, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(31612),
    a = n(60851);
   const o = { title: 'Calendar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Calendar', pagination_label: 'Calendar', description: 'Een kalender waarin je een beschikbare datum kan kiezen.', slug: '/Calendar', sidebar_custom_props: { illustration: 'CalendarSketch' }, keywords: ['afspraak', 'appointment', 'availability', 'beschikbaarheid', 'calendar', 'dag', 'dagen', 'date', 'date picker', 'datepicker', 'datum', 'datumprikker', 'day', 'days', 'jaar', 'kalender', 'maand', 'moment', 'month', 'week', 'weeks', 'weken', 'year'] },
    s = void 0,
    l = { id: 'componenten/calendar/index', title: 'Calendar', description: 'Een kalender waarin je een beschikbare datum kan kiezen.', source: '@site/docs/componenten/calendar/index.mdx', sourceDirName: 'componenten/calendar', slug: '/Calendar', permalink: '/en/Calendar', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/calendar/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Calendar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Calendar', pagination_label: 'Calendar', description: 'Een kalender waarin je een beschikbare datum kan kiezen.', slug: '/Calendar', sidebar_custom_props: { illustration: 'CalendarSketch' }, keywords: ['afspraak', 'appointment', 'availability', 'beschikbaarheid', 'calendar', 'dag', 'dagen', 'date', 'date picker', 'datepicker', 'datum', 'datumprikker', 'day', 'days', 'jaar', 'kalender', 'maand', 'moment', 'month', 'week', 'weeks', 'weken', 'year'] }, sidebar: 'componenten', previous: { title: 'Button', permalink: '/en/button' }, next: { title: 'Card as link', permalink: '/en/card-as-link' } },
    u = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const _ = 'task-list_hh8j',
    ...
    C = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: z, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.aC, { role: 'presentation', children: n }), (0, u.jsx)(v.nv, { children: r })] })] });
    };
   var S = n(14669);
   const D = (e) => {
         ...
         children: [
          (0, u.jsx)(A, {
           children: e.tasks.map((e) => {
            ...
            return (0, u.jsx)(C, { checked: t, title: n, description: (0, S.Q6)(r) }, r);
           }),
          }),
