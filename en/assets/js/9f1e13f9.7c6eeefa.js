 ...
 [45010],
 {
  ...
  53860: (e, n, l) => {
   ...
   function a(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(r.X, { appearance: 'do', title: 'Beschrijf in de titel in welke stap van welk formulier de gebruiker is. ', description: 'Met de titel bedoelen we hier het title-element. Bekijk de code voor een voorbeeld in HTML.', children: (0, t.jsx)(o.X, { language: 'html', code: (0, t.jsx)(n.title, { children: 'Stap 2 van 3, uw gegevens - Gemeente voorbeeld' }), defaultCollapsed: !1 }) }), '\n', (0, t.jsx)(r.X, { appearance: 'dont', title: 'Voor elke (volgende) stap / dezelfde titel.', description: 'Met de titel bedoelen we hier het title-element. Bekijk de code voor een voorbeeld in HTML.', children: (0, t.jsx)(o.X, { language: 'html', code: (0, t.jsx)(n.title, { children: 'Contact opnemen - Gemeente voorbeeld' }), defaultCollapsed: !1 }) }), '\n', (0, t.jsx)(r.X, { appearance: 'do', title: 'Stap in het kopje van het formulier.', children: (0, t.jsx)(o.X, { language: 'html', children: () => (0, t.jsx)(t.Fragment, { children: (0, t.jsx)(n.h2, { children: 'Stap 2 van 3, uw gegevens' }) }) }) }), '\n', (0, t.jsx)(r.X, { appearance: 'do', title: 'Stap onder het kopje van het formulier.', children: (0, t.jsx)(o.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.h2, { children: 'Uw gegevens' }), (0, t.jsx)(n.p, { children: 'Stap 2 van 3' })] }) }) }), '\n', (0, t.jsx)(r.X, { appearance: 'do', title: 'Stap onder het kopje van het formulier.', description: 'Gebruik hgroup om het kopje en de stappen semantisch aan elkaar te koppelen.', children: (0, t.jsx)(o.X, { language: 'html', children: () => (0, t.jsx)(t.Fragment, { children: (0, t.jsxs)(n.hgroup, { children: [(0, t.jsx)(n.h1, { children: 'Uw gegevens' }), (0, t.jsx)(n.p, { children: 'Stap 2 van 3' })] }) }) }) }), '\n', (0, t.jsx)(r.X, { appearance: 'dont', title: 'Stap boven het kopje van het formulier.', children: (0, t.jsx)(o.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.p, { children: 'Stap 2 van 3' }), (0, t.jsx)(n.h2, { children: 'Uw gegevens' })] }) }) })] });
   }
   function i(e = {}) {
    const { wrapper: n } = { ...(0, s.a)(), ...e.components };
  ...
  98480: (e, n, l) => {
   ...
   const v = (e) => {
    let { children: n } = e;
    return (0, g.jsx)(t.Tg, { className: h['nlds-canvas__example-surface'], children: (0, g.jsx)(t.BB, { className: (0, s.Z)('utrecht-document--surface', h['nlds-canvas__example-document']), children: (0, g.jsx)(t.nv, { className: h['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   v.displayName = 'ParagraphContainer';
   const m = (e) => {
    let { children: n } = e;
    return (0, g.jsx)(t.Tg, { className: h['nlds-canvas__example-surface'], children: (0, g.jsx)(t.BB, { className: (0, s.Z)('utrecht-document--surface', h['nlds-canvas__example-document']), children: n }) });
   };
   ...
   const b = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: b = !1, displayCode: _ = !0, children: x, container: y = 'document', language: k, designTokens: f } = e,
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (S = await c.ZP.format(N, { parser: k, plugins: [o.Z, r.ZP, a.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(S);
     })();
    }, [N]);
    const A = (0, d.useId)();
    let P = d.Fragment;
    return (
     ...
     (0, g.jsxs)('div', {
      ...
      children: [
       w && (0, g.jsx)('div', { className: (0, s.Z)(h['nlds-canvas__example']), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, g.jsx)(P, { children: (0, g.jsx)(t.pu, { children: w }) }) }) }),
       _ &&
        (0, g.jsx)('div', {
       ...
       _ &&
        (0, g.jsxs)('div', {
         className: (0, s.Z)(h['nlds-canvas__code-block'], !l && h['nlds-canvas__code-block--user-select-none']),
         id: A,
         hidden: !Z,
         children: [
          (0, g.jsx)(u.u, { syntax: k, textContent: S, trim: !0 }),
          l &&
           (0, g.jsx)('div', {
    ...
    return (
     ...
     (0, r.jsx)(s.y$, {
      ...
      children: (e) => {
       ...
       return (0, r.jsx)(t.dn, { style: l, children: s.map((e, l) => (0, r.jsxs)('span', { ...o({ line: e }), children: [n && (0, r.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, r.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const h = 'Doen',
     ...
     g = p ? 'figure' : 'div',
     v = p ? 'figcaption' : 'div';
    return (0, i.jsxs)(g, { className: (0, r.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(v, { className: (0, r.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(o.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, i.jsx)(t.Z, { className: a['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: a['nlds-guideline__title'], children: u })] }), (0, i.jsx)(o.nv, { children: n })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(o.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, i.jsx)(s.Z, { className: a['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: a['nlds-guideline__title'], children: h })] }), (0, i.jsx)(o.nv, { children: n })] }), c] }), (0, i.jsx)('div', { className: (0, r.Z)(a['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => a, a: () => r });
