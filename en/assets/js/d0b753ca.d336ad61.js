 ...
 [47531],
 {
  33918: (e, t, n) => {
   ...
   const s = { title: 'Radio Button', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Radio Button', pagination_label: 'Radio Button', description: 'Invoerveld voor het kiezen van een enkele optie uit een groep van opties.', slug: '/radio-button', keywords: ['invoerveld', 'optie', 'opties', 'option', 'option button', 'radio', 'radio button', 'radioknop', 'keuze', 'keuzemogelijkheid', 'keuzerondje'] },
    ...
    h = 'Radio Button',
    j = 'Invoerveld voor het kiezen van een enkele optie uit een groep van opties.',
    y = 65,
  ...
  23952: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(_), children: [(0, l.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, l.jsx)('span', { className: z, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.X6, { appearance: 'utrecht-heading-3', level: c, children: r }), o, n] })] });
    };
   var S = n(14669);
   const D = (e) => {
