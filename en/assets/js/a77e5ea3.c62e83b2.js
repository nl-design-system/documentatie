  ...
  23952: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, d.jsxs)('li', { className: (0, i.Z)(_), children: [(0, d.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, d.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, d.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(b.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var z = n(14669);
   const D = (e) => {
          ...
          children: [
           (0, d.jsx)(N, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(S, { checked: t, title: n, description: (0, z.Q6)(r) }, r);
            }),
           }),
