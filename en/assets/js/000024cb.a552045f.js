...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [3247],
 {
  ...
  49636: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => G, contentTitle: () => C, default: () => P, frontMatter: () => A, metadata: () => L, toc: () => S });
   var i = l(52676),
    r = l(24785),
    t = l(2065),
    a = l(94091),
