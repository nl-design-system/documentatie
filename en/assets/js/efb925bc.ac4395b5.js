 ...
 [87870],
 {
  ...
  81826: (e, n, i) => {
   ...
   const d = { title: 'Foutmeldingen in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Introductie foutmeldingen', sidebar_position: 5, pagination_label: 'Foutmeldingen', description: 'Als een veld niet goed is ingevuld, moet voor iedereen duidelijk zijn wat er niet klopt. Hoe help je de gebruiker het beste als die onjuiste of onvolledige informatie invult?', slug: '/richtlijnen/formulieren/foutmeldingen/', keywords: ['informatie', 'formulier', 'design', 'code'] },
    c = 'Foutmeldingen in een formulier',
  ...
  21004: (e, n, i) => {
   ...
   const o = (e, n) => e.reduce((e, i) => ('link' === i.type ? (n.includes(i.docId) ? e : [...e, i]) : 'category' === i.type ? [...e, { ...i, items: o(i.items, n) }] : e), []),
    d = (e) => {
     ...
     const c = (0, r.jA)();
     return (0, s.jsx)('div', { ...d, className: (0, t.Z)('margin-top--lg', i), children: (0, s.jsx)(l.Z, { items: o(c.items, n) }) });
    };
  },
  13879: (e, n, i) => {
   i.d(n, { Z: () => f });
   ...
   function c(e) {
    ...
    return (0, d.jsxs)('div', { className: (0, s.Z)('card', o.card), children: [n ? (0, d.jsx)(t.Z, { href: n, className: (0, s.Z)(o.cardLink, 'utrecht-link'), children: (0, d.jsxs)('h2', { className: (0, s.Z)(o.cardTitle), children: [i, ' ', r] }) }) : (0, d.jsxs)('h2', { className: (0, s.Z)(o.cardTitle), children: [i, ' ', r] }), l && (0, d.jsx)('p', { className: (0, s.Z)(o.cardDescription), children: l }), c] });
   }
   function a(e) {
    let { item: n } = e;
   ...
   function f(e) {
    ...
    const t = (0, r.MN)(n);
    return (0, d.jsx)('section', { className: (0, s.Z)('row', i), children: t.map((e, n) => (0, d.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, d.jsx)(m, { item: e }) }, n)) });
   }
  },
  24785: (e, n, i) => {
   i.d(n, { Z: () => o, a: () => s });
