...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  5250: (e, n, r) => {
   r.r(n), r.d(n, { assets: () => L, contentTitle: () => X, default: () => R, frontMatter: () => S, metadata: () => K, toc: () => C });
   var o = r(1527),
    i = r(7214),
    t = r(3460),
    s = r(36);
  ...
  3460: (e, n, r) => {
   ...
   const j = (e) => {
    ...
    b = (e) => {
     let { code: n, copy: r = !1, defaultCollapsed: b = !0, children: x, language: w } = e,
      v = "function" == typeof x ? x() : x,
      k = "function" == typeof n ? n() : (0, c.isValidElement)(n) ? n : void 0,
      f = "string" == typeof n ? n : p.uS(k || v),
      [y, _] = (0, c.useState)(f);
     (0, c.useEffect)(() => {
      (async () => {
       (y = await d.ZP.format(f, { parser: w, plugins: [t.Z, s.ZP, l.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), _(y);
      })();
     }, [f]);
     const D = (0, h.Z)();
     return (0, g.jsxs)("div", {
      ...
      children: [
       v && (0, g.jsx)("div", { className: (0, i.Z)(u["nlds-canvas__example"]), children: (0, g.jsx)(o.pu, { className: "voorbeeld-theme", children: v }) }),
       (0, g.jsx)("div", { className: (0, i.Z)(u["nlds-canvas__toolbar"]), children: (0, g.jsx)(o.zx, { className: (0, i.Z)(u["nlds-canvas__button"], u["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: j, "aria-expanded": !b, "aria-controls": D, children: b ? "Bekijk code" : "Verberg code" }) }),
       (0, g.jsxs)("div", {
        className: (0, i.Z)(u["nlds-canvas__code-block"], !r && u["nlds-canvas__code-block--user-select-none"]),
        id: D,
        hidden: b,
        children: [
         (0, g.jsx)(m.u, { syntax: w, textContent: y, trim: !0 }),
         r &&
          (0, g.jsx)("div", {
