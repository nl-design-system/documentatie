 ...
 [97366],
 {
  ...
  98480: (e, n, l) => {
   ...
   const h = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (D = await a.ZP.format(Z, { parser: x, plugins: [o.Z, i.ZP, c.ZP, r.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(D);
     })();
    }, [Z]);
    const R = (0, d.useId)();
    let z = d.Fragment;
