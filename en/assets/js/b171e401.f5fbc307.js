 ...
 [67398],
 {
  39706: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(80719),
    s = n(90786);
   const o = { title: 'Switch', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Switch', pagination_label: 'Switch', description: 'Invoerveld om een optie aan of uit te zetten.', slug: '/switch' },
    a = void 0,
    l = { id: 'componenten/switch/index', title: 'Switch', description: 'Invoerveld om een optie aan of uit te zetten.', source: '@site/docs/componenten/switch/index.mdx', sourceDirName: 'componenten/switch', slug: '/switch', permalink: '/en/switch', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/switch/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Switch', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Switch', pagination_label: 'Switch', description: 'Invoerveld om een optie aan of uit te zetten.', slug: '/switch' }, sidebar: 'componenten', previous: { title: 'Superscript', permalink: '/en/superscript' }, next: { title: 'Table', permalink: '/en/table' } },
    u = {},
    h = [
