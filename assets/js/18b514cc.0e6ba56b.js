 ...
 [89914],
 {
  ...
  58639(e, n, o) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: g = !0, children: j, container: b = 'document', language: x, designTokens: f }) => {
    ...
    let M = p.Fragment;
    return (
     'paragraph' === b ? (M = h) : 'document' === b ? (M = y) : 'surface' === b && (M = v),
     (0, m.jsxs)('div', {
