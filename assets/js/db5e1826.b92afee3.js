...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [42684],
 {
  ...
  58639(e, n, r) {
   ...
   const x = ({ code: e, copy: n = !0, defaultExpandedCode: r = !1, displayCode: x = !0, children: g, container: f = 'document', language: b, designTokens: k }) => {
    ...
    (0, h.useEffect)(() => {
     (async () => {
      const e = await c.Ay.format(_, { parser: b, plugins: [o.A, s.Ay, a.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      R(e);
     })();
    }, [_]);
    const F = (0, h.useId)();
      ...
      children: [
       ...
       x &&
        (0, p.jsxs)('div', {
         ...
         hidden: !N,
         children: [
          (0, p.jsx)(l.M, { codeBlockLabel: 'Codevoorbeeld', syntax: b, textContent: z, trim: !0 }),
          n &&
           (0, p.jsx)('div', {
