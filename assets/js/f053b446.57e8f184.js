 ...
 [49189],
 {
  ...
  21034(e, n, t) {
   ...
   const w = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, c.jsx)(f.n, { children: i.map((t) => (0, c.jsx)(f.K, { className: (0, r.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, p.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(m._, { children: t.tasks.map(({ checked: e, name: t, id: s }) => (0, c.jsx)(m.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, p.qZ)(s) }, s)) }), (0, c.jsx)(s.fz, { children: (0, c.jsxs)(s.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
            ...
            o.Zp,
            {
             ...
             children: (0, c.jsxs)(o.Wu, {
              children: [
               ...
               a.length > 0 && (0, c.jsx)(c.Fragment, { children: a.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, c.jsx)(s.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    b = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(s.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, c.jsxs)(s.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, c.jsxs)(s.Xy, { children: [r ? (0, c.jsxs)(s.Er, { children: ['Vul de ', (0, c.jsx)(s.N_, { href: r, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, c.jsxs)(s.Er, { children: [(0, c.jsxs)(s.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, c.jsxs)(s.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, c.jsx)(s.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, c.jsx)(s.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    v = ({ component: e, headingLevel: n, description: t }) => {
     const r = e && p.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(u.p, { level: n, suffix: r && (0, c.jsx)(g.D, { state: r }), children: e.title }), (0, c.jsx)(s.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(r) && (0, c.jsx)(j.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    A = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  32385(e, n, t) {
   'use strict';
   t.d(n, { bo: () => r, KF: () => u, mJ: () => h, VZ: () => k, cR: () => A, Pv: () => f, qZ: () => o, kD: () => b, QQ: () => C, B2: () => m, Pc: () => l, f4: () => a, GT: () => v, fX: () => i, eQ: () => x, B_: () => w, o_: () => j });
   ...
   var g = function (e) {
    ...
    m =
     ...
     (0, a.forwardRef)(function (e, n) {
      ...
      return (0, i.jsxs)('button', d(d({ ref: n, type: v, className: (0, o.$)('nl-button', s, { 'nl-button--pressed': w, 'nl-button--busy': x, 'nl-button--disabled': f || j, 'nl-button--primary': 'primary' === p, 'nl-button--secondary': 'secondary' === p, 'nl-button--subtle': 'subtle' === p, 'nl-button--positive': u(p) && 'positive' === h, 'nl-button--negative': u(p) && 'negative' === h, 'nl-button--icon-only': c }), 'aria-pressed': k ? String(Boolean(w)) : void 0, 'aria-disabled': f || x ? 'true' : void 0, disabled: j }, y), {}, { children: [m && (0, i.jsx)('span', { className: 'nl-button__icon-start', children: m }), A && (0, i.jsx)('span', { className: 'nl-button__label', children: A }), T ? (0, i.jsx)('span', { className: c ? 'nl-button__label' : '', children: t }) : t, g && (0, i.jsx)('span', { className: 'nl-button__icon-end', children: g })] }));
     }));
  ...
  56561(e, n, t) {
   ...
   var g = (0, a.forwardRef)(function (e, n) {
    var t = e.children,
     ...
     c = e.purpose,
     g = (0, r.A)(e, l);
    return (0, i.jsx)('p', d(d({ className: (0, o.$)('nl-paragraph', (0, s.A)({}, 'nl-paragraph--lead', 'lead' === c), a), ref: n }, g), {}, { children: 'lead' === c ? (0, i.jsx)('b', { className: 'nl-paragraph__lead', children: t }) : t }));
   });
   g.displayName = 'Paragraph';
  },
  58907(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => H, component: () => B, contentTitle: () => _, default: () => E, description: () => z, frontMatter: () => W, issueNumber: () => O, metadata: () => s, title: () => P, toc: () => I }));
   ...
   function M(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, r.jsx)(R.Fc, { component: B, headingLevel: 1, description: z }), '\n', (0, r.jsx)(T.e, { component: B }), '\n', (0, r.jsx)(n.admonition, { title: 'Tip', type: 'tip', children: (0, r.jsxs)(n.p, { children: ['Gebruik de ', (0, r.jsx)(n.a, { href: '/code-block/', children: 'Code Block' }), ' component als de code meerdere regels beslaat.'] }) }), '\n', (0, r.jsx)(A.Zp, { className: 'ma-implementation-card', children: (0, r.jsxs)(A.Wu, { children: [(0, r.jsx)(y.DZ, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, r.jsxs)(k.d, { children: [(0, r.jsxs)(k.P, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=2-4', children: [(0, r.jsx)(C.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, r.jsxs)(k.P, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=2-4', children: [(0, r.jsx)(C.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, r.jsx)(y.DZ, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, r.jsxs)(k.d, { children: [(0, r.jsxs)(k.P, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-code--documentatie', children: [(0, r.jsx)(C.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, r.jsxs)(k.P, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/code--documentatie', children: [(0, r.jsx)(C.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, r.jsx)(y.DZ, { level: 2, appearance: 'level-4', children: 'npm' }), (0, r.jsxs)(k.d, { children: [(0, r.jsxs)(k.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-css', children: [(0, r.jsx)(C.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-css'] }), (0, r.jsxs)(k.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-react', children: [(0, r.jsx)(C.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-react'] }), (0, r.jsxs)(k.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-tokens', children: [(0, r.jsx)(C.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-tokens'] })] })] }) }), '\n', (0, r.jsx)(n.h2, { id: 'checklist-voor-toegankelijkheid', children: 'Checklist voor toegankelijkheid' }), '\n', (0, r.jsx)(c.Ay, {}), '\n', (0, r.jsx)(n.h3, { id: 'acceptatiecriteria-bij-gebruik', children: 'Acceptatiecriteria bij gebruik' }), '\n', (0, r.jsx)(l.Ay, {}), '\n', (0, r.jsx)(G.b, { headingLevel: '4', children: b.map(({ component: e, ...n }) => (0, r.jsx)(G.e, { ...n, children: (0, r.jsx)(e, {}) })) }), '\n', (0, r.jsx)(n.h3, { id: 'acceptatiecriteria-van-de-component', children: 'Acceptatiecriteria van de component' }), '\n', (0, r.jsx)(a.Ay, {}), '\n', (0, r.jsx)(G.b, { headingLevel: '4', children: v.map(({ component: e, ...n }) => (0, r.jsx)(G.e, { ...n, children: (0, r.jsx)(e, {}) })) }), '\n', (0, r.jsx)(S.o, { omitH1: !0, headingLevel: 2, children: (0, r.jsx)(F, {}) }), '\n', (0, r.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }), '\n', (0, r.jsx)(N.B, { tokens: L }), '\n', (0, r.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, r.jsx)(R.VK, { component: B, headingLevel: 3 }), '\n', (0, r.jsx)(R.$9, { component: B, headingLevel: 2 }), '\n', (0, r.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, r.jsx)(R.mu, { component: B, headingLevel: 3 }), '\n', (0, r.jsx)(R.K_, { component: B })] });
   }
   function E(e = {}) {
    const { wrapper: n } = { ...(0, i.R)(), ...e.components };
  ...
  70903(e, n, t) {
   ...
   var u = t(43864),
    ...
    v = t(23436),
    A = t(79532);
   const k = { boxShadow: u.A, color: m.A, cursor: p.A, dimension: h.A, fontFamily: f.A, fontFamilies: f.A, fontSize: j.A, fontSizes: j.A, fontWeight: w.A, fontWeights: w.A, lineHeight: x.A, lineHeights: x.A, number: b.A, other: v.A, textDecoration: A.A },
    y = ({ type: e }) => {
