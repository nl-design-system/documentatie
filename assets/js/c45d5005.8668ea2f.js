   ...
   const y = ({ code: e, copy: l = !0, defaultExpandedCode: n = !1, displayCode: y = !0, children: j, container: x = 'document', language: g, designTokens: f }) => {
    ...
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       k && (0, h.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(R, { children: (0, h.jsx)(o.v$, { children: k }) }) }) }),
       y &&
        (0, h.jsx)('div', {
