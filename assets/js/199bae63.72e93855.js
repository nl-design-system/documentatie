...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [61383],
 {
  ...
  49146: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => h, contentTitle: () => a, default: () => j, frontMatter: () => o, metadata: () => d, toc: () => m });
   var t = i(52676),
    r = i(40139),
    l = i(5547),
    s = i(2334),
   ...
   const o = { title: 'Links in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Introductie links', sidebar_position: 7, pagination_label: 'Links in een formulier', description: 'Richtlijnen voor het plaatsen van links binnen een formulier.', slug: '/richtlijnen/formulieren/links/', keywords: ['links', 'formulier', 'design', 'code'] },
    a = 'Richtlijnen NL Design System voor links in een formulier',
   ...
   function u(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(n.h1, { id: 'richtlijnen-nl-design-system-voor-links-in-een-formulier', children: 'Richtlijnen NL Design System voor links in een formulier' }), '\n', (0, t.jsx)(n.p, { children: 'Soms wil je binnen een formulier verwijzen naar een andere pagina, bijvoorbeeld de algemene voorwaarden of het privacybeleid. Zo\u2019n link kun je boven het formulier zetten, maar ook bij een specifieke vraag plaatsen.' }), '\n', (0, t.jsx)(n.h2, { id: 'overzicht-richtlijnen', children: 'Overzicht richtlijnen' }), '\n', (0, t.jsx)(c.l, { excludeDocIDs: ['richtlijnen/formulieren/link/README'] }), '\n', (0, t.jsx)(n.h2, { id: 'deze-documentatie-heeft-nu-een-eigen-pagina', children: 'Deze documentatie heeft nu een eigen pagina' }), '\n', (0, t.jsx)(s._, { id: 'plaats-de-link-boven-het-gerelateerde-formulierveld', children: (0, t.jsxs)(n.p, { children: [(0, t.jsx)(n.a, { href: '/richtlijnen/formulieren/links/plaatsing/', children: 'Plaats de link boven het gerelateerde formulierveld' }), '.'] }) }), '\n', (0, t.jsx)(s._, { id: 'zet-geen-link-in-een-label', children: (0, t.jsxs)(n.p, { children: [(0, t.jsx)(n.a, { href: '/richtlijnen/formulieren/links/niet-in-label/', children: 'Zet geen link in een label' }), '.'] }) }), '\n', (0, t.jsx)(s._, { id: 'geef-aan-als-een-link-in-een-nieuwe-tab-opent', children: (0, t.jsxs)(n.p, { children: [(0, t.jsx)(n.a, { href: '/richtlijnen/formulieren/links/nieuwe-tab/', children: 'Geef aan als een link in een nieuwe tab opent' }), '.'] }) }), '\n', (0, t.jsx)(l.ZP, {})] });
   }
   function j(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
  ...
  57229: (e, n, i) => {
   ...
   const s = (e) => {
    let { className: n, ...i } = e;
    return (0, l.jsx)(t.Z, { className: (0, r.W)('utrecht-link', 'utrecht-link--html-a', n), ...i });
   };
  },
  21004: (e, n, i) => {
   i.d(n, { l: () => o });
  ...
  39772: (e, n, i) => {
   ...
   var t = i(17542),
    ...
    c = i(52676);
   function o(e) {
    let { href: n, icon: i = '', title: t, description: l, children: o } = e;
    return (0, c.jsxs)('div', { className: 'card', children: [n ? (0, c.jsx)(r.r, { href: n, className: (0, s.Z)('cardLink', 'utrecht-link'), children: (0, c.jsxs)('h2', { className: 'cardTitle', children: [i, ' ', t] }) }) : (0, c.jsxs)('h2', { className: 'cardTitle', children: [i, ' ', t] }), l && (0, c.jsx)('p', { className: 'cardDescription', children: l }), o] });
   }
   function a(e) {
    let { item: n } = e;
    return (0, c.jsx)(o, { title: n.label, description: n.description, children: (0, c.jsx)(l.QI, { children: n.items.filter((e) => 'link' === e.type || 'category' === e.type).map((e, n) => (0, c.jsx)(l.AS, { children: 'link' === e.type ? (0, c.jsx)(r.r, { to: e.href, children: e.label }) : 'category' === e.type ? (0, c.jsxs)(r.r, { to: e.href, children: [e.items.length, " pagina's voor ", e.label] }) : (0, c.jsx)(c.Fragment, {}) }, n)) }) });
   }
   function d(e) {
    let { item: n } = e;
    const i = (0, t.xz)(n.docId);
    return (0, c.jsx)(o, { href: n.href, title: n.label, description: n.description ?? i?.description });
   }
   function h(e) {
    let { item: n } = e;
    switch (n.type) {
