 ...
 [85700],
 {
  1292(e, n, t) {
   ...
   var s = t(29181),
    ...
    a = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(o.A, {}), github: (0, d.jsx)(i.A, {}), npm: (0, d.jsx)(r.A, {}), storybook: (0, d.jsx)(l.A, {}) },
    p = ({ brand: e }) => (0, d.jsx)(s.In, { children: c[e] || (0, d.jsx)(a.A, {}) });
  },
  33062(e, n, t) {
   t.d(n, { bo: () => o, KF: () => m, mJ: () => h, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => r, kD: () => v, B2: () => u, Pc: () => a, f4: () => l, GT: () => k, fX: () => i, eQ: () => x, B_: () => b, o_: () => j, Rc: () => _ });
     ...
     return n.map((n) => {
      const s = e.tasks
       ...
       .map(({ name: s, id: o, value: i }) => {
        ...
        return { brand: r.toLowerCase(), name: s, id: o, value: i, description: l };
       });
  ...
  34208(e, n, t) {
   ...
   function f(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, o.jsx)(l.Fc, { component: g, headingLevel: 1, description: m }), '\n', (0, o.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, o.jsx)(l.VK, { component: g, headingLevel: 3 }), '\n', (0, o.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, o.jsx)(l.mu, { component: g, headingLevel: 3 }), '\n', (0, o.jsx)(l.$9, { component: g, headingLevel: 2 })] });
   }
   function j(e = {}) {
  ...
  67970(e, n, t) {
   ...
   const l = ({ state: e }) => {
    const n = (0, i.fX)(e);
    return (0, r.jsx)(s.KE, { className: (0, o.A)('estafette-badge', n && `estafette-badge--${n}`), children: e });
   };
  },
  72642(e, n, t) {
   t.d(n, { p: () => i });
  ...
  80506(e, n, t) {
   ...
   const h = ({ component: e, headingLevel: n }) => {
            ...
            r.Zp,
            {
             ...
             children: (0, d.jsxs)(r.Wu, {
              children: [
               ...
               (p.length > 0 || l.length > 0) && (0, d.jsx)(s.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               p.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               l.length > 0 && (0, d.jsx)(d.Fragment, { children: l.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(s.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, d.jsx)(s.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    j = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(s.DZ, { level: n, children: 'Help om deze component te verbeteren' }), (0, d.jsxs)(s.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, d.jsxs)(s.Xy, { children: [o ? (0, d.jsxs)(s.Er, { children: ['Vul de ', (0, d.jsx)(s.N_, { href: o, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, d.jsxs)(s.Er, { children: [(0, d.jsxs)(s.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, d.jsxs)(s.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, d.jsx)(s.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, d.jsx)(s.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
  ...
  90495(e, n, t) {
   ...
   var s = t(46447),
    o = t(13526),
    i = t(86070);
   const r = ({ background: e, children: n, className: t, ...s }) => (0, i.jsx)('div', { className: (0, o.A)('card__illustration', e && `card__illustration--${e}`, t), ...s, children: n }),
    ...
    a = ({ href: e, appearance: n, className: t, component: r = 'div', background: l, children: a }) => {
     const d = (e) => ('article' === r ? (0, i.jsx)('article', { ...e }) : 'section' === r ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      c = (0, i.jsx)(d, { className: (0, o.A)('cardgroup__card', l && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: a });
