...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [832],
 {
  832(e, t, n) {
   ...
   function x() {
    const e = (0, r.J_)();
    return (0, m.jsx)(h.A, { children: (0, m.jsx)('script', { type: 'application/ld+json', children: JSON.stringify(e) }) });
   }
   var f = n(97982),
    p = n(98775);
   function v({ sidebar: e, children: t }) {
    ...
    return (0, m.jsxs)(l.A, { sidebar: e, toc: !d && s.length > 0 ? (0, m.jsx)(f.A, { toc: s, minHeadingLevel: g, maxHeadingLevel: h }) : void 0, children: [(0, m.jsx)(p.A, { metadata: n }), (0, m.jsx)(o.A, { children: t }), (a || i) && (0, m.jsx)(u, { nextItem: a, prevItem: i })] });
   }
   function j(e) {
    const t = e.content;
    return (0, m.jsx)(r.in, { content: e.content, isBlogPostPage: !0, children: (0, m.jsxs)(a.e3, { className: (0, s.A)(i.G.wrapper.blogPages, i.G.page.blogPostPage), children: [(0, m.jsx)(g, {}), (0, m.jsx)(x, {}), (0, m.jsx)(v, { sidebar: e.sidebar, children: (0, m.jsx)(t, {}) })] }) });
   }
  },
  22125(e, t, n) {
  ...
  71581(e, t, n) {
   ...
   var m = n(54705),
    u = n(86070);
   function g({ toc: e, className: t, linkClassName: n, isChild: s }) {
    return e.length ? (0, u.jsx)('ul', { className: s ? void 0 : t, children: e.map((e) => (0, u.jsxs)('li', { children: [(0, u.jsx)(m.A, { to: `#${e.id}`, className: n ?? void 0, dangerouslySetInnerHTML: { __html: e.value } }), (0, u.jsx)(g, { isChild: !0, toc: e.children, className: t, linkClassName: n })] }, e.id)) }) : null;
   }
   const h = s.memo(g);
   function x({ toc: e, className: t = 'table-of-contents table-of-contents__left-border', linkClassName: n = 'table-of-contents__link', linkActiveClassName: l, minHeadingLevel: o, maxHeadingLevel: c, ...m }) {
    const g = (0, a.p)(),
     ...
     f = c ?? g.tableOfContents.maxHeadingLevel,
    ...
    return (
     ...
     (0, u.jsx)(h, { toc: p, className: t, linkClassName: n, ...m })
    );
   }
  },
  86990(e, t, n) {
  ...
  96907(e, t, n) {
   ...
   function p({ className: e }) {
    ...
    return (0, i.jsxs)('div', { className: (0, s.A)(g, 'margin-vert--md', e), children: [(0, i.jsx)(x, { date: n, formattedDate: ((o = n), l.format(new Date(o))) }), void 0 !== r && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(f, {}), (0, i.jsx)(h, { readingTime: r })] })] });
    var o;
   }
   var v = n(51016);
   const j = 'authorCol_wipH',
    b = 'imageOnlyAuthorRow_QdzG',
    A = 'imageOnlyAuthorCol_RnvU';
   ...
   function y({ children: e, className: t }) {
    ...
    return (0, i.jsx)('div', { id: n ? _.LU : void 0, className: (0, s.A)('markdown', t), children: (0, i.jsx)(T.A, { children: e }) });
   }
   var H = n(77128),
    k = n(58302),
    w = n(90636);
   ...
   function B() {
    ...
    if (t) {
     const e = !!(l || d || c);
     return (0, i.jsxs)('footer', { className: 'docusaurus-mt-lg', children: [u && (0, i.jsx)('div', { className: (0, s.A)('row', 'margin-top--sm', H.G.blog.blogFooterEditMetaRow), children: (0, i.jsx)('div', { className: 'col', children: (0, i.jsx)(w.A, { tags: n }) }) }), e && (0, i.jsx)(k.A, { className: (0, s.A)('margin-top--sm', H.G.blog.blogFooterEditMetaRow), editUrl: l, lastUpdatedAt: d, lastUpdatedBy: c })] });
    }
    return (0, i.jsxs)('footer', { className: 'row docusaurus-mt-lg', children: [u && (0, i.jsx)('div', { className: (0, s.A)('col', { 'col--9': m }), children: (0, i.jsx)(w.A, { tags: n }) }), m && (0, i.jsx)('div', { className: (0, s.A)('col text--right', { 'col--3': u }), children: (0, i.jsx)(P, { blogPostTitle: r, to: e.permalink }) })] });
   }
   function U({ children: e, className: t }) {
    ...
    return (0, i.jsxs)(r, { className: (0, s.A)(n, t), children: [(0, i.jsx)(L, {}), (0, i.jsx)(y, { children: e }), (0, i.jsx)(B, {})] });
   }
  },
  97982(e, t, n) {
   n.d(t, { A: () => l });
