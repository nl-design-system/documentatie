...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [1080],
 {
  ...
  18527: (e, t, o) => {
   ...
   var h = o(9270),
    p = o(29146);
   const g = { container: "container_MS_s" };
   function b(e) {
    let { readingTime: t } = e;
    const o = (function () {
   ...
   const k = { authorCol: "authorCol_UQEe", imageOnlyAuthorRow: "imageOnlyAuthorRow_z1zU", imageOnlyAuthorCol: "imageOnlyAuthorCol_Gox2" };
   function P(e) {
    let { className: t } = e;
    const {
     metadata: { authors: o },
   ...
   const I = { blogPostFooterDetailsFull: "blogPostFooterDetailsFull_yqfK" };
   function M() {
   ...
   function $(e) {
    ...
    return (0, c.jsxs)(U.Z, { breadcrumbs: [{ label: "Blog", href: "/blog" }, { label: l.title }], sidebar: t, toc: !d && r.length > 0 ? (0, c.jsx)(R.Z, { toc: r, minHeadingLevel: m, maxHeadingLevel: u }) : void 0, children: [(0, c.jsx)(S, { children: o }), (n || a) && (0, c.jsx)(O, { nextItem: n, prevItem: a })] });
   }
   function E(e) {
    const t = e.content;
