...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [78311],
 {
  ...
  27267: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => h, contentTitle: () => m, default: () => y, frontMatter: () => u, metadata: () => g, toc: () => v });
   var s = t(52676),
    o = t(87118),
    l = t(49824),
    r = t(43599),
    i = t(40761);
   function a(e) {
    const n = { a: 'a', button: 'button', div: 'div', p: 'p', ...(0, o.a)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', (0, s.jsx)(i.X, { appearance: 'do', title: 'Benoem de stappen consistent.', children: (0, s.jsx)(r.X, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(n.p, { children: (0, s.jsx)(n.a, { href: './stap-1', children: 'Vorige stap' }) }), '[...]', (0, s.jsx)(n.div, { children: (0, s.jsx)(n.button, { children: 'Volgende stap' }) })] }) }) }), '\n', (0, s.jsx)(i.X, { appearance: 'dont', title: 'Verschillen tussen hoe de vorige en volgende stap worden benoemd.', description: 'Gebruik ofwel \u2018terug\u2019/\u2018verder\u2019 ofwel \u2018Vorige stap\u2019/\u2018Volgende stap\u2019.', children: (0, s.jsx)(r.X, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(n.p, { children: (0, s.jsx)(n.a, { href: './stap-1', children: 'Terug' }) }), '[...]', (0, s.jsx)(n.div, { children: (0, s.jsx)(n.button, { children: 'Volgende stap' }) })] }) }) })] });
   }
   function c(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
  ...
  43599: (e, n, t) => {
   ...
   const g = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(o.BB, { className: (0, l.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(o.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   g.displayName = 'ParagraphContainer';
   const h = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(o.BB, { className: (0, l.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const b = (e) => {
    let { code: n, copy: t = !0, defaultExpandedCode: b = !1, displayCode: y = !0, children: x, container: j = 'document', language: f, designTokens: k } = e;
    ...
    let F = p.Fragment;
    return (
     'paragraph' === j ? (F = g) : 'document' === j ? (F = h) : 'surface' === j && (F = v),
     (0, m.jsxs)('div', {
      className: (0, l.Z)('nlds-canvas'),
      children: [
       _ && (0, m.jsx)('div', { className: (0, l.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(F, { children: (0, m.jsx)(o.pu, { children: _ }) }) }) }),
       y &&
        (0, m.jsx)('div', {
       ...
       y &&
        (0, m.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, m.jsx)(s.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: Z, trim: !0 }),
          t &&
           (0, m.jsx)('div', {
    ...
    return (
     ...
     (0, a.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: g, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, a.jsx)(s.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': g, style: t, children: o.map((e, t) => (0, a.jsxs)('span', { ...l({ line: e }), children: [n && (0, a.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
