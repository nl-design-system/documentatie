...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [75524],
 {
  40881: (e, o, n) => {
   ...
   function k(e) {
    const o = { a: "a", code: "code", h1: "h1", h2: "h2", p: "p", ...(0, r.a)(), ...e.components };
    return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(o.h1, { id: "makkelijk-in-te-vullen", children: "Makkelijk in te vullen" }), "\n", (0, l.jsx)(d.nv, { lead: !0, children: "Maak het de gebruiker makkelijker door bijvoorbeeld informatie vooraf in te vullen." }), "\n", (0, l.jsx)(o.h2, { id: "vul-bekende-informatie-in-waar-mogelijk", children: "Vul bekende informatie in waar mogelijk" }), "\n", (0, l.jsx)(o.p, { children: "Als de gebruiker is ingelogd, gebruik dan bekende informatie om velden vast in te vullen. In DigiD-sessies is bijvoorbeeld een hoop informatie beschikbaar, die zou kunnen worden geburikt om velden vooraf in te vullen." }), "\n", (0, l.jsx)(o.h2, { id: "bereid-velden-voor-op-autocomplete", children: "Bereid velden voor op autocomplete" }), "\n", (0, l.jsxs)(o.p, { children: ["Met het ", (0, l.jsx)(o.code, { children: "autocomplete" }), " attribuut in HTML kun je per veld aangeven wat voor soort invoer er verwacht wordt, zodat de browser bekende informatie kan voorstellen als autosuggest-opties. Gebruik je bijvoorbeeld ", (0, l.jsx)(o.code, { children: 'autocomplete="street-address"' }), ", dan kan de browser suggesties doen. Dit kan gebruikers een hoop typewerk schelen."] }), "\n", (0, l.jsx)(o.h2, { id: "check-of-informatie-\xe8cht-nodig-is", children: "Check of informatie \xe8cht nodig is" }), "\n", (0, l.jsxs)(o.p, { children: ["Kortere formulieren kunnen sneller worden ingevuld. Ga dus per vraag na of deze echt nodig is.\nLees ook de ", (0, l.jsx)(o.a, { href: "/richtlijnen/formulieren/alle-richtlijnen/vragen", children: "richtlijnen over uit te vragen informatie" }), "."] }), "\n", (0, l.jsx)(o.h2, { id: "voorkom-herhaling", children: "Voorkom herhaling" }), "\n", (0, l.jsxs)(o.p, { children: ["Om zeker te weten dat iemand het juiste e-mailadres heeft ingevuld, wordt in sommige formulieren de vraag twee keer gesteld en dan vergeleken. Dit kan gebruikersvriendelijker!\nLees verder bij de ", (0, l.jsx)(o.a, { href: "/richtlijnen/formulieren/alle-richtlijnen/vragen", children: "richtlijnen over uit te vragen informatie" }), "."] })] });
   }
   function b(e = {}) {
    const { wrapper: o } = { ...(0, r.a)(), ...e.components };
    return o ? (0, l.jsx)(o, { ...e, children: (0, l.jsx)(k, { ...e }) }) : k(e);
   }
  },
  13455: (e, o, n) => {
   n.d(o, { X: () => p });
   ...
   const h = (e) => {
    ...
    p = (e) => {
     let { code: o, copy: n = !1, defaultCollapsed: d = !0, children: i, language: t } = e;
     "function" == typeof i && (i = i());
     const p = s().format(k.uS(o || i), { parser: "html", plugins: [a(), c()], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" }),
      _ = (0, g.Z)();
     return (0, m.jsxs)("div", {
      className: (0, r.Z)(l["nlds-canvas"], "voorbeeld-theme", "utrecht-html"),
      children: [
       (0, m.jsx)("div", { className: (0, r.Z)(l["nlds-canvas__example"]), children: i }),
       (0, m.jsx)("div", { className: (0, r.Z)(l["nlds-canvas__toolbar"]), children: (0, m.jsx)(u.zx, { className: (0, r.Z)(l["nlds-canvas__button"], l["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: h, "aria-expanded": !d, "aria-controls": _, children: d ? "Bekijk code" : "Verberg code" }) }),
       (0, m.jsxs)("div", {
        className: (0, r.Z)(l["nlds-canvas__code-block"], !n && l["nlds-canvas__code-block--user-select-none"]),
        id: _,
        hidden: d,
        children: [
         (0, m.jsx)(b.Z, { language: t, style: v, children: p }),
         n &&
          (0, m.jsx)("div", {
  ...
  31092: (e, o, n) => {
   ...
   var a = n(90512),
    ...
    c = n(85893);
   const t = (e) => {
    let { title: o, appearance: n, description: t, children: s } = e;
    const k = "Doen",
     b = "Niet doen";
    return (0, c.jsxs)("div", { className: (0, a.Z)(d["nlds-guideline"], d[`nlds-guideline--${n}`]), id: o?.toLowerCase().replace(/\s/g, "-"), children: [(0, c.jsxs)("div", { className: (0, a.Z)(d["nlds-guideline__description"]), children: ["dont" === n ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(i.nv, { className: (0, a.Z)(d["nlds-guideline__badge"], d[`nlds-guideline__badge--${n}`]), children: [(0, c.jsx)(l.Z, { className: d["nlds-guideline__icon"] }), (0, c.jsx)("span", { className: d["nlds-guideline__title"], children: b })] }), (0, c.jsx)(i.nv, { children: o })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(i.nv, { className: (0, a.Z)(d["nlds-guideline__badge"], d[`nlds-guideline__badge--${n}`]), children: [(0, c.jsx)(r.Z, { className: d["nlds-guideline__icon"] }), (0, c.jsx)("span", { className: d["nlds-guideline__title"], children: k })] }), (0, c.jsx)(i.nv, { children: o })] }), t] }), (0, c.jsx)("div", { className: (0, a.Z)(d["nlds-guideline__example"]), children: s })] });
   };
  },
 },
]);
