...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [66492],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => m, mJ: () => u, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => s, kD: () => b, B2: () => p, Pc: () => l, f4: () => a, GT: () => k, fX: () => o, eQ: () => v, B_: () => x, o_: () => j, Rc: () => _ });
  ...
  37131(e, n, t) {
   ...
   const u = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: i && (0, d.jsx)(h.D, { state: i }), children: e.title }), (0, d.jsx)(r.fz, { lead: !0, children: t })] });
    },
    b = ({ component: e }) => {
     const n = (e && u[e.title]) || [];
  ...
  64276(e, n, t) {
   ...
   const d = { title: 'Radio Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Radio Group', pagination_label: 'Radio Group', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren uit een lijst.', slug: '/radio-group', keywords: ['fieldset', 'form', 'formulierveld', 'keuze', 'keuzerondje', 'optie', 'opties', 'option', 'option button', 'radio', 'radio button', 'radio group', 'radioknop', 'radios'] },
    ...
    h = {},
    m = 'Radio Group',
    p = 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren uit een lijst.',
    g = 129,
    u = 'help wanted',
    f = 'radio-group',
