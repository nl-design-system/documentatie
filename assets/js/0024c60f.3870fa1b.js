/*! For license information please see 0024c60f.3870fa1b.js.LICENSE.txt */
 ...
 [72837],
 {
   ...
   function ne(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      (0, d.jsx)(E.W, { tokens: $ }),
      '\n',
      (0, d.jsx)(H.U, { omitH1: !0, headingLevel: 3, children: (0, d.jsx)(I, {}) }),
      '\n',
  ...
  35038: (e, n, t) => {
   ...
   const s = (e) => {
    ...
    a = (e) => {
     let { href: n, appearance: t, className: s, component: l = 'div', children: a } = e;
     const c = (e) => ('article' === l ? (0, i.jsx)('article', { ...e }) : 'section' === l ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      d = (0, i.jsx)(c, { className: (0, o.Z)('cardgroup__card', `cardgroup__card--${t}`, s), children: a });
        ...
        (0, c.jsxs)('div', {
         ...
         children: [
          ...
          (0, c.jsx)(i.k, {
           ...
           children: m.map((e, n) => {
            let t = (0, c.jsx)(s.O, { children: e }, n);
            if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
             const i = o.fg.get(e);
             t = (0, c.jsx)(r.r, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${i.sc} ${i.nl.title}`, style: { lineHeight: 1 }, children: (0, c.jsx)(s.O, { children: `WCAG ${e}` }) }, n);
            }
            return t;
           }),
          }),
          ...
          children: Array.from(l.values()).map((e, n) =>
           (0, c.jsx)(
            i.zx,
            {
             onClick: () =>
              ((e, n) => {
               const i = ('boolean' == typeof n ? n : !o(e)) ? [...t, e] : t.filter((n) => n !== e);
               r(i);
              })(e),
             pressed: o(e),
             appearance: 'subtle',
             className: 'utrecht-button--contents',
             children: (0, c.jsx)(s.O, { children: e }),
            },
            n,
           ),
          ),
