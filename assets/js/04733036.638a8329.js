 ...
 [78311],
 {
  ...
  43599: (e, n, t) => {
   ...
   const b = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      (Z = await d.ZP.format(C, { parser: f, plugins: [r.Z, i.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), w(Z);
     })();
    }, [C]);
    const z = (0, p.useId)();
    let F = p.Fragment;
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       _ && (0, m.jsx)('div', { className: (0, l.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(F, { children: (0, m.jsx)(s.pu, { children: _ }) }) }) }),
       y &&
        (0, m.jsx)('div', {
