 ...
 [53342],
 {
  ...
  15175(e, n, l) {
   ...
   function i({ lineNumber: e, syntax: n, textContent: l, trim: i }) {
    ...
    const { title: p, type: h } = (0, o.useContext)(t.x),
     u = (0, o.useId)();
    return (i && (d = d.trim()), (0, c.jsx)(r.f4, { theme: a, code: d, language: n || '', children: ({ style: n, tokens: l, getLineProps: r, getTokenProps: o }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: u, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, c.jsx)(s.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': u, style: n, children: l.map((n, l) => (0, c.jsxs)('span', { ...r({ line: n }), children: [e && (0, c.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, c.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  18439(e, n, l) {
   l.d(n, { R: () => t, x: () => a });
  ...
  70348(e, n, l) {
   ...
   var s = l(13526),
    ...
    t = l(37168),
    a = l(86070);
   const c = (0, r.forwardRef)(({ as: e, className: n, children: l, ...r }, o) => {
     const t = e || 'div',
      c = (0, s.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(t, { ref: o, className: c, ...r, children: l });
    }),
    i = ({ className: e, classNamePanel: n, label: l, heading: r, headingLevel: c, headingApperance: i, ...d }) => {
     const p = (0, s.A)('utrecht-accordion__section', e),
      h = (0, s.A)('utrecht-accordion__panel', n);
     return (0, a.jsxs)('details', { className: p, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(o.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [r && (0, a.jsx)(t.D, { level: c, appearance: i, children: r }), l] })] }) }), (0, a.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => y });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const s = 'function' == typeof e ? e() : e,
        ...
        t = m().highlight(r, m().languages[n], n);
       return (0, x.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', l), children: [(0, x.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }), (0, x.jsx)(g.n, { children: (0, x.jsx)(g.K, { label: 'Code', children: (0, x.jsx)('pre', { className: 'language-html nl-code-block', children: (0, x.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: t } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: u = !0, children: m, container: g = 'document', language: y, designTokens: f }) => {
       ...
       let P = p.Fragment;
       return (
        'paragraph' === g ? (P = j) : 'document' === g ? (P = b) : 'surface' === g && (P = v),
        (0, x.jsxs)('div', {
         className: (0, o.A)('nlds-canvas'),
         children: [
          w && (0, x.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, x.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, x.jsx)(P, { children: (0, x.jsx)(r.v$, { children: w }) }) }) }),
          u &&
           (0, x.jsx)('div', {
