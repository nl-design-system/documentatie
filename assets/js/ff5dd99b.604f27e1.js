 ...
 [10452],
 {
  ...
  17889(e, t, n) {
   ...
   var p = n(35193),
    ...
    A = n(79532),
    x = n(30758);
   const b = { color: p.A, dimension: j.A, fontFamilies: y.A, fontSizes: k.A, fontWeights: w.A, lineHeights: f.A, other: v.A, textDecoration: A.A },
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => u, mJ: () => p, VZ: () => b, cR: () => x, Pv: () => j, qZ: () => o, kD: () => f, B2: () => m, Pc: () => a, f4: () => c, GT: () => v, fX: () => i, eQ: () => w, B_: () => k, o_: () => y, Rc: () => A });
  ...
  45282(e, t, n) {
   ...
   const i = ({ children: e, ...t }) => {
     ...
     return ('https://nldesignsystem.nl' === c.origin ? ((c.pathname = c.pathname.endsWith('/') ? c.pathname : `${c.pathname}/`), (o = c.toString().replace('https://nldesignsystem.nl', ''))) : ((i.target = '_blank'), (i.rel = 'noopener noreferrer')), (0, s.jsx)('a', { href: o, ...i, children: e }));
    },
  ...
  62853(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => S, component: () => F, contentTitle: () => _, default: () => E, description: () => L, frontMatter: () => z, issueNumber: () => M, metadata: () => r, title: () => D, toc: () => O }));
    ...
    return (0, s.jsxs)(s.Fragment, {
     children: [
      ...
      (0, s.jsx)(b.b, {
       headingLevel: '4',
       items: [
        { title: 'De gemarkeerde tekst is niet alleen herkenbaar aan de achtergrondkleur.', sc: '1.4.1', status: '', component: (0, s.jsx)(k.Ay, {}), tags: ['designer', 'contentmaker'] },
        ...
        { title: 'Tekst in een andere taal heeft het juiste lang-attribuut.', sc: '3.1.2', status: '', component: (0, s.jsx)(y.Ay, {}), tags: ['developer', 'contentmaker'] },
       ],
      }),
      '\n',
      ...
      '\n',
      (0, s.jsx)(T.$9, { component: F, headingLevel: 2 }),
      '\n',
            ...
            o.Zp,
            {
             ...
             children: (0, l.jsxs)(o.Wu, {
              children: [
               ...
               c.length > 0 && (0, l.jsx)(l.Fragment, { children: c.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [s, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
