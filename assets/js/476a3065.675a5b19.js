 ...
 [4805],
 {
  15638(e, n, t) {
   ...
   const c = (0, s.createContext)({}),
    p = ({ title: e, appearance: n, description: t, children: s, figure: p }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      u = p ? 'figure' : 'div',
      v = p ? 'figcaption' : 'div',
      j = 'string' == typeof t ? (0, d.jsx)(l.oz, { children: t }) : t;
     return (0, d.jsxs)(u, { className: (0, a.A)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(v, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(o.fz, { className: (0, a.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(r.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: h.dont })] }), (0, d.jsx)(o.fz, { children: e })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(o.fz, { className: (0, a.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(i.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: h.do })] }), (0, d.jsx)(o.fz, { children: e })] }), j] }), (0, d.jsx)('div', { className: 'nlds-guideline__example', children: (0, d.jsx)(c.Provider, { value: { title: e, type: h[n] }, children: s }) })] });
    };
  },
  18439(e, n, t) {
   t.d(n, { R: () => a, x: () => l });
  ...
  58639(e, n, t) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: g = !0, children: k, container: b = 'document', language: x, designTokens: y }) => {
    ...
    let D = p.Fragment;
    return (
     'paragraph' === b ? (D = v) : 'document' === b ? (D = j) : 'surface' === b && (D = m),
     (0, u.jsxs)('div', {
      className: (0, o.A)('nlds-canvas'),
      children: [
       f && (0, u.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, u.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, u.jsx)(D, { children: (0, u.jsx)(r.v$, { children: f }) }) }) }),
       g &&
        (0, u.jsx)('div', {
