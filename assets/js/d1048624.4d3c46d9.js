 ...
 [65850],
 {
  ...
  38953(e, n, l) {
   ...
   var r = l(28369),
    ...
    v = l(46847),
    b = l(86070);
   const j = ({ children: e }) => (0, b.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(o.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, b.jsx)(o.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   j.displayName = 'ParagraphContainer';
   const x = ({ children: e }) => (0, b.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(o.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   x.displayName = 'DocumentContainer';
   const y = ({ children: e }) => (0, b.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: e });
   y.displayName = 'SurfaceContainer';
   const f = globalThis.isAstro
    ? ({ language: e, className: n, code: l = '<p>No code provided</p>', rawCode: r, copyCode: o, defaultExpandedCode: a, designTokens: t }) => {
       const c = 'string' == typeof l ? l : r || '',
        i = 'string' == typeof l ? u().highlight(l, u().languages[e], e) : u().highlight(r || '', u().languages[e], e);
    ...
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: p = !0, children: u, container: g = 'document', language: v, designTokens: f }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(w, { parser: v, plugins: [a.A, t.Ay, c.Ay, i.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [w]);
       const S = (0, h.useId)();
       let P = h.Fragment;
       return (
        'paragraph' === g ? (P = j) : 'document' === g ? (P = x) : 'surface' === g && (P = y),
        (0, b.jsxs)('div', {
         className: (0, s.A)('nlds-canvas'),
         children: [
          k && (0, b.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, b.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, b.jsx)(P, { children: (0, b.jsx)(o.v$, { children: k }) }) }) }),
          p &&
           (0, b.jsx)('div', {
          ...
          p &&
           (0, b.jsxs)('div', {
            ...
            hidden: !C,
            children: [
             (0, b.jsx)(r.M, { codeBlockLabel: 'Codevoorbeeld', syntax: v, textContent: N, trim: !0 }),
             n &&
              (0, b.jsx)('div', {
