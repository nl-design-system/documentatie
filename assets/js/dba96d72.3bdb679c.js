...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [54862],
 {
  ...
  50848: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => g, contentTitle: () => m, default: () => b, frontMatter: () => p, metadata: () => v, toc: () => h });
   var s = l(52676),
    o = l(24785),
    r = l(66771),
    t = l(81014);
   function i(e) {
    const n = { a: 'a', input: 'input', label: 'label', p: 'p', ...(0, o.a)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', (0, s.jsx)(t.X, { appearance: 'do', title: 'De link boven het gerelateerde invoerveld plaatsen.', children: (0, s.jsx)(r.X, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(n.p, { children: [(0, s.jsx)(n.a, { href: '#', children: 'Voorwaarden vrijwilligerswerk' }), '.'] }), (0, s.jsxs)(n.p, { children: [(0, s.jsx)(n.input, { type: 'checkbox', name: 'vrijwilliger', id: 'vrijwilliger' }), (0, s.jsx)(n.label, { for: 'vrijwilliger', children: 'Ik wil vrijwilliger worden' })] })] }) }) }), '\n', (0, s.jsx)(t.X, { appearance: 'dont', title: 'De link onder het gerelateerde invoerveld plaatsen.', children: (0, s.jsx)(r.X, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(n.p, { children: [(0, s.jsx)(n.input, { type: 'checkbox', name: 'vrijwilliger', id: 'vrijwilliger' }), (0, s.jsx)(n.label, { for: 'vrijwilliger', children: 'Ik wil vrijwilliger worden' })] }), (0, s.jsxs)(n.p, { children: [(0, s.jsx)(n.a, { href: '#', children: 'Voorwaarden vrijwilligerswerk' }), '.'] })] }) }) })] });
   }
   function a(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
  ...
  66771: (e, n, l) => {
   ...
   const g = (e) => {
    let { children: n } = e;
    return (0, v.jsx)(s.Tg, { className: p['nlds-canvas__example-surface'], children: (0, v.jsx)(s.BB, { className: (0, o.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: (0, v.jsx)(s.nv, { className: p['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   g.displayName = 'ParagraphContainer';
   const h = (e) => {
    let { children: n } = e;
    return (0, v.jsx)(s.Tg, { className: p['nlds-canvas__example-surface'], children: (0, v.jsx)(s.BB, { className: (0, o.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: n }) });
   };
   h.displayName = 'DocumentContainer';
   const _ = (e) => {
    let { children: n } = e;
    return (0, v.jsx)(s.Tg, { className: p['nlds-canvas__example-surface'], children: n });
   };
   _.displayName = 'SurfaceContainer';
   const b = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: b = !1, displayCode: j = !0, children: y, container: x = 'document', language: k, designTokens: f } = e,
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (P = await c.ZP.format(Z, { parser: k, plugins: [r.Z, t.ZP, i.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(P);
     })();
    }, [Z]);
    const S = (0, d.useId)();
    let E = d.Fragment;
    return (
     'paragraph' === x ? (E = g) : 'document' === x ? (E = h) : 'surface' === x && (E = _),
     (0, v.jsxs)('div', {
      className: (0, o.Z)(p['nlds-canvas']),
      children: [
       w && (0, v.jsx)('div', { className: (0, o.Z)(p['nlds-canvas__example']), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, v.jsx)(E, { children: (0, v.jsx)(s.pu, { children: w }) }) }) }),
       j &&
        (0, v.jsx)('div', {
       ...
       j &&
        (0, v.jsxs)('div', {
         ...
         hidden: !D,
         children: [
          (0, v.jsx)(m.u, { syntax: k, textContent: P, trim: !0 }),
          l &&
           (0, v.jsx)('div', {
    ...
    return (
     ...
     (0, t.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, t.jsx)(s.dn, { style: l, children: o.map((e, l) => (0, t.jsxs)('span', { ...r({ line: e }), children: [n && (0, t.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, t.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
