...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [56130],
 {
  ...
  33062(e, t, n) {
   n.d(t, { bo: () => s, KF: () => g, mJ: () => u, VZ: () => A, cR: () => _, Pv: () => f, qZ: () => a, kD: () => b, B2: () => m, Pc: () => l, f4: () => o, GT: () => w, fX: () => r, eQ: () => v, B_: () => x, o_: () => j, Rc: () => k });
  ...
  37131(e, t, n) {
   ...
   const u = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    f = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, d.jsx)(i.If, { sections: r.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m._, { children: n.tasks.map(({ checked: e, name: n, id: i }) => (0, d.jsx)(m.Z, { headingLevel: t + 1, checked: e, heading: n, description: (0, p.qZ)(i) }, i)) }), (0, d.jsx)(i.fz, { children: (0, d.jsxs)(i.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
    ...
    v = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(g.p, { level: t, suffix: s && (0, d.jsx)(h.D, { state: s }), children: e.title }), (0, d.jsx)(i.fz, { lead: !0, children: n })] });
    },
    b = ({ component: e }) => {
     const t = (e && u[e.title]) || [];
