...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [3626],
 {
  ...
  65477: (e, n, t) => {
   ...
   const _ = (e) => {
    let { code: n, copy: t = !1, defaultExpandedCode: _ = !1, displayCode: j = !0, children: x, container: y = "document", language: f, designTokens: k } = e,
    ...
    let B = d.Fragment;
    return (
     "paragraph" === y ? (B = b) : "document" === y ? (B = g) : "surface" === y && (B = v),
     (0, h.jsxs)("div", {
