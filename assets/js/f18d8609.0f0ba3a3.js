/*! For license information please see f18d8609.0f0ba3a3.js.LICENSE.txt */
'use strict';
 ...
 [93211],
 {
  ...
  26655(e, n, t) {
   ...
   const o = ({ background: e, children: n, className: t, ...r }) => (0, a.jsx)('div', { className: (0, i.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, t), ...r, children: n }),
    d = (e) => (0, a.jsx)('div', { className: 'ma-card__content', ...e }),
    s = ({ href: e, appearance: n, className: t, component: o = 'div', background: d, children: s }) => {
     const c = (e) => ('article' === o ? (0, a.jsx)('article', { ...e }) : 'section' === o ? (0, a.jsx)('section', { ...e }) : (0, a.jsx)('div', { ...e })),
      l = (0, a.jsx)(c, { className: (0, i.A)('ma-cardgroup__card', d && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, t), children: s });
     return e ? (0, a.jsx)(r.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: l }) : l;
    },
    c = ({ appearance: e = 'medium', children: n, className: t }) => (0, a.jsx)('div', { className: (0, i.A)('ma-cardgroup', `ma-cardgroup--${e}`, t), children: n });
  },
  39831(e, n, t) {
   t.d(n, { Z: () => h });
   var r = t(86070),
     ...
     const p = (0, i.useRef)(null),
      ...
      v = a
       ? {
          ...
          onKeyDown: (e) => {
           ('Enter' === e.key || ' ' === e.key) && p.current && a && (e.preventDefault(), p.current.click());
          },
          'aria-labelledby': k,
         }
       : {};
     return (0, r.jsx)('div', { ref: m, className: c('utrecht-card', s, { 'utrecht-card--link': a }), ...v, ...u, children: (0, r.jsxs)('div', { className: 'utrecht-card__content', children: [(0, r.jsx)('div', { className: c('utrecht-card__heading'), children: t && n && (0, r.jsx)(l, { id: k, className: c(`utrecht-heading-${t}`, 'utrecht-card__header'), level: t, children: (0, r.jsx)(g, { ref: p, href: a, className: c('utrecht-card__link'), children: n }) }) }), e && (0, r.jsx)('div', { className: c('utrecht-card__image'), children: e }), h && (0, r.jsx)('div', { className: c('utrecht-card__body'), children: h })] }) });
    });
   ((h.displayName = 'Card'),
    ((e) => {
