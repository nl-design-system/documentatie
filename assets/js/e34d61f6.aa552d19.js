 ...
 [26048],
 {
  ...
  46076(e, n, i) {
   ...
   var r = i(86070),
    ...
    h = i(66117),
    m = i(50978);
   const g = { title: 'WCAG-succescriterium 2.5.3 Label in Naam', title_sm: '2.5.3 Label in Naam', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.3 Label in Naam', pagination_label: 'WCAG-succescriterium 2.5.3 Label in Naam', description: 'De zichtbare naam van een onderdeel moet terugkomen in de toegankelijke naam.', slug: '2.5.3', conformance_level: 'Niveau A', keywords: ['WCAG', 'A', 'bedienbaar', 'input modaliteiten', 'operable', 'input modalities', 'label in name'] },
    u = void 0,
    j = {},
  ...
  61473(e, n, i) {
   ...
   var t = i(46447),
    r = i(46276),
    a = i(86070);
   const l = ({ children: e, conformanceLevel: n, ...i }) => (globalThis.isAstro ? null : (0, a.jsx)(r.p, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: n && (0, a.jsx)(t.KE, { className: 'nlds-inline-heading-group__badge', children: n }), ...i, children: e }));
  },
  66117(e, n, i) {
   i.d(n, { Ay: () => s, RM: () => a });
   var t = i(86070),
  ...
  66119(e, n, i) {
   ...
   function r(e) {
    ...
    if ('string' == typeof e || 'number' == typeof e) t += e;
     ...
     if (Array.isArray(e)) {
      var a = e.length;
      for (n = 0; n < a; n++) e[n] && (i = r(e[n])) && (t && (t += ' '), (t += i));
     } else for (i in e) e[i] && (t && (t += ' '), (t += i));
    return t;
   }
   function a() {
    for (var e, n, i = 0, t = '', a = arguments.length; i < a; i++) (e = arguments[i]) && (n = r(e)) && (t && (t += ' '), (t += n));
    return t;
   }
   const l = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: r, ...l }, s) => {
    const o = { ...l, ref: s, className: a('utrecht-note', { [`utrecht-note--${r}`]: r }, i) };
