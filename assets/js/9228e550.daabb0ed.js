(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [54291],
 {
  34142: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => a, default: () => g, description: () => j, frontMatter: () => o, issueNumber: () => m, metadata: () => u, title: () => d, toc: () => h });
   var r = n(52676),
    c = n(40139),
    s = n(26838),
    i = n(8657);
   ...
   const i = (e) => {
    ...
    a = (e) => {
     ...
     const u = (e) => ('article' === o ? (0, s.jsx)('article', { ...e }) : 'section' === o ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      l = (0, s.jsx)(u, { className: (0, c.Z)('cardgroup__card', `cardgroup__card--${n}`, i), children: a });
  ...
  8657: (e, t, n) => {
   ...
   const x = (e) => {
     ...
     const s = t && t.projects.filter((e) => w.e9.includes(e.id)),
      i = s && w.e9.map((e) => s.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: i.map((e) => ({
        className: (0, c.Z)('definition-of-done', e && `definition-of-done--${(0, w.mA)(e.title)}`),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, l.jsx)(b, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(f, { headingLevel: n + 1, checked: t, title: r, description: (0, w.Q6)(c) }, c);
            }),
           }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => o, Ee: () => l, Q6: () => s, U: () => j, Yr: () => g, d: () => h, e9: () => i, fO: () => k, mA: () => c, ps: () => m, qU: () => b, s0: () => v, zP: () => y });
