 ...
 [17903],
 {
  34191: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(43282),
    o = n(8657);
   const s = { title: 'Page Footer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Page Footer', pagination_label: 'Page Footer', description: 'Consistente plek onderaan elke pagina, vaak met links, juridische informatie en opties om hulp te krijgen of contact op te nemen.', slug: '/page-footer' },
    a = void 0,
    u = { id: 'componenten/page-footer/index', title: 'Page Footer', description: 'Consistente plek onderaan elke pagina, vaak met links, juridische informatie en opties om hulp te krijgen of contact op te nemen.', source: '@site/docs/componenten/page-footer/index.mdx', sourceDirName: 'componenten/page-footer', slug: '/page-footer', permalink: '/page-footer', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/page-footer/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Page Footer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Page Footer', pagination_label: 'Page Footer', description: 'Consistente plek onderaan elke pagina, vaak met links, juridische informatie en opties om hulp te krijgen of contact op te nemen.', slug: '/page-footer' }, sidebar: 'componenten', previous: { title: 'Ordered List', permalink: '/ordered-list' }, next: { title: 'Page Header', permalink: '/page-header' } },
    l = {},
    h = [
