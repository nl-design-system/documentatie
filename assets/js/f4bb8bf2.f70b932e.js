 ...
 [30347],
 {
   ...
   const d = (0, c.createContext)({}),
    u = ({ title: e, appearance: n, description: l, children: c, figure: u }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      p = u ? 'figure' : 'div',
      m = u ? 'figcaption' : 'div',
      v = 'string' == typeof l ? (0, i.jsx)(a.oz, { components: { a: r.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   var o = l(13526),
    ...
    s = l(37168),
    a = l(86070);
   const c = (0, t.forwardRef)(({ as: e, className: n, children: l, ...t }, r) => {
     const s = e || 'div',
      c = (0, o.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(s, { ref: r, className: c, ...t, children: l });
    }),
    i = ({ className: e, classNamePanel: n, label: l, heading: t, headingLevel: c, headingApperance: i, ...d }) => {
     const u = (0, o.A)('utrecht-accordion__section', e),
      h = (0, o.A)('utrecht-accordion__panel', n);
     return (0, a.jsxs)('details', { className: u, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(r.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [t && (0, a.jsx)(s.D, { level: c, appearance: i, children: t }), l] })] }) }), (0, a.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => j });
   ...
   const j = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       ...
       return (0, g.jsxs)('div', { className: (0, r.A)('ma-canvas-astro', l), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: t } }), (0, g.jsx)(v.n, { children: (0, g.jsx)(v.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: p = !0, children: m, container: v = 'document', language: j, designTokens: y }) => {
       ...
       let S = u.Fragment;
       return (
        'paragraph' === v ? (S = b) : 'document' === v ? (S = x) : 'surface' === v && (S = f),
        (0, g.jsxs)('div', {
  ...
  83753(e, n, l) {
   (l.r(n), l.d(n, { assets: () => b, contentTitle: () => g, default: () => j, frontMatter: () => v, metadata: () => o, toc: () => x }));
