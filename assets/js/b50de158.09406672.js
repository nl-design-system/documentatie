 ...
 [72881],
 {
  1292(e, n, i) {
   ...
   var a = i(29181),
    ...
    l = i(83386),
    d = i(86070);
   const c = { figma: (0, d.jsx)(t.A, {}), github: (0, d.jsx)(s.A, {}), npm: (0, d.jsx)(o.A, {}), storybook: (0, d.jsx)(r.A, {}) },
    g = ({ brand: e }) => (0, d.jsx)(a.In, { children: c[e] || (0, d.jsx)(l.A, {}) });
  },
  33062(e, n, i) {
   i.d(n, { bo: () => t, KF: () => m, mJ: () => v, VZ: () => A, cR: () => N, Pv: () => h, qZ: () => o, kD: () => x, B2: () => p, Pc: () => l, f4: () => r, GT: () => k, fX: () => s, eQ: () => b, B_: () => j, o_: () => f, Rc: () => _ });
   ...
   const g = (e) => [...e].sort((e, n) => d.indexOf(e) - d.indexOf(n)),
    ...
    v = (e) => g(c(e.projects.flatMap((e) => u(e)))),
    h = (e) => {
     const n = u(e),
      i = ((e) => {
      ...
      const a = e.tasks
       ...
       .map(({ name: a, id: t, value: s }) => {
        const o = /^(.+) URL/.exec(a)[1],
         r = 'Storybook' === o ? `${i} (${n}) in Storybook van ${e.title}` : `${i} (${n}) op ${o}`;
        return { brand: o.toLowerCase(), name: a, id: t, value: s, description: r };
       });
  ...
  72642(e, n, i) {
   ...
   var a = i(13526),
    t = i(86070);
   const s = ({ children: e, className: n, level: i = 1, suffix: s, ...o }) => (0, t.jsxs)('hgroup', { className: (0, a.A)('nlds-inline-heading-group', `utrecht-heading-${i}`, n), ...o, children: [(0, t.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), s && (0, t.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
  },
  80506(e, n, i) {
   i.d(n, { VK: () => v, $9: () => f, mu: () => h, Fc: () => j });
   var a = i(29181),
    t = i(13526),
    s = i(1292),
    o = i(90495),
   ...
   const v = ({ component: e, headingLevel: n }) => {
     const i = e && e.projects.filter((e) => u.f4.includes(e.id)),
      s = i && u.f4.map((e) => i.find((n) => n.id === e)).filter(Boolean);
     return e && (0, d.jsx)(a.If, { sections: s.map((i) => ({ className: (0, t.A)('definition-of-done', i && `definition-of-done--${(0, u.fX)(i.title)}`), headingLevel: n, expanded: !1, label: i ? `${i.title} - ${i.progress.value} van ${i.progress.max}` : '', body: i && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p._, { children: i.tasks.map(({ checked: e, name: i, id: a }) => (0, d.jsx)(p.Z, { headingLevel: n + 1, checked: e, heading: i, description: (0, u.qZ)(a) }, a)) }), (0, d.jsx)(a.fz, { children: (0, d.jsxs)(a.N_, { href: `${i.url}?filterQuery=${e.title}`, children: [i.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            o.Zp,
            {
             ...
             children: (0, d.jsxs)(o.Wu, {
              children: [
               ...
               r.length > 0 && (0, d.jsx)(d.Fragment, { children: r.map(({ frameworkName: e, tasks: i }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(a.DZ, { level: n + 2, children: [t, ' in ', e] }), (0, d.jsx)(a.dk, { links: i.map((e) => ({ children: e.description, icon: (0, d.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    j = ({ component: e, headingLevel: n, description: i }) => {
  ...
  87195(e, n, i) {
   (i.r(n), i.d(n, { assets: () => c, component: () => u, contentTitle: () => d, default: () => f, description: () => m, frontMatter: () => l, issueNumber: () => p, metadata: () => a, title: () => g, toc: () => v }));
  ...
  90495(e, n, i) {
   i.d(n, { AC: () => d, Fu: () => o, Wu: () => r, Zp: () => l });
   var a = i(46447),
    t = i(13526),
    s = i(86070);
   const o = ({ background: e, children: n, className: i, ...a }) => (0, s.jsx)('div', { className: (0, t.A)('card__illustration', e && `card__illustration--${e}`, i), ...a, children: n }),
    r = (e) => (0, s.jsx)('div', { className: 'card__content', ...e }),
    l = ({ href: e, appearance: n, className: i, component: o = 'div', background: r, children: l }) => {
     const d = (e) => ('article' === o ? (0, s.jsx)('article', { ...e }) : 'section' === o ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      c = (0, s.jsx)(d, { className: (0, t.A)('cardgroup__card', r && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, i), children: l });
     return e ? (0, s.jsx)(a.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: c }) : c;
    },
    d = ({ appearance: e = 'medium', children: n, className: i }) => (0, s.jsx)('div', { className: (0, t.A)('cardgroup', `cardgroup--${e}`, i), children: n });
  },
 },
]);
