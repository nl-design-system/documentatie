  ...
  23952: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    D = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(_), children: [(0, l.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, l.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(v.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var z = n(14669);
   const S = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(y['definition-of-done'], e && y[`definition-of-done--${(0, z.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
