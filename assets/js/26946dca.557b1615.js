(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [85781],
 {
  ...
  11902: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => f, component: () => x, contentTitle: () => w, default: () => T, description: () => k, frontMatter: () => j, issueNumber: () => b, metadata: () => y, title: () => v, toc: () => A });
   var r = n(52676),
    o = n(24785),
    i = n(96439),
    s = n(34434),
   ...
   const j = { title: 'Code Block', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code Block', pagination_label: 'Code Block', description: 'Toont \xe9\xe9n of meerdere regels computercode en behoudt de opmaak van deze code.', slug: '/code-block', keywords: ['code'] },
    ...
    v = 'Code Block',
    k = 'Toont \xe9\xe9n of meerdere regels computercode en behoudt de opmaak van deze code.',
    b = 329,
    x = i.find((e) => e.number === b);
   function C(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(c.Rv, { component: x, headingLevel: 1, description: k }),
      '\n',
      ...
      (0, r.jsx)(s.t, {
       ...
       items: [
        { title: 'De tekst, gemarkeerd als code, is niet alleen herkenbaar aan een andere achtergrondkleur', sc: '1.4.1', status: '', component: (0, r.jsx)(u.ZP, {}) },
        ...
        { title: 'Wanneer de achtergrondkleur van het Code Block anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina', sc: '1.4.11', status: '', component: (0, r.jsx)(m.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(s.t, {
      ...
      '\n',
      (0, r.jsx)(s.t, { headingLevel: 3, testCategory: 'Toegankelijkheid screenreader', items: [{ title: 'De juiste HTML-elementen voor de Code Block component zijn toegepast', sc: '1.3.1', status: '', component: (0, r.jsx)(d, {}) }] }),
      '\n',
