 ...
 [45313],
 {
   ...
   const d = (0, i.createContext)({}),
    p = ({ title: e, appearance: n, description: t, children: i, figure: p }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      u = p ? 'figure' : 'div',
      g = p ? 'figcaption' : 'div',
      m = 'string' == typeof t ? (0, c.jsx)(a.oz, { components: { a: r.N_ }, children: t }) : t;
  ...
  70348(e, n, t) {
   ...
   var l = t(13526),
    ...
    o = t(37168),
    a = t(86070);
   const i = (0, s.forwardRef)(({ as: e, className: n, children: t, ...s }, r) => {
     const o = e || 'div',
      i = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(o, { ref: r, className: i, ...s, children: t });
    }),
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const l = 'function' == typeof e ? e() : e,
        ...
        o = g().highlight(s, g().languages[n], n);
       return (0, v.jsxs)('div', { className: (0, r.A)('ma-canvas-astro', t), children: [(0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: s } }), (0, v.jsx)(m.n, { children: (0, v.jsx)(m.K, { label: 'Code', children: (0, v.jsx)('pre', { className: 'language-html nl-code-block', children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: u = !0, children: g, container: m = 'document', language: y, designTokens: f }) => {
       ...
       return (
        ...
        (0, v.jsxs)('div', {
         ...
         children: [
          k && (0, v.jsx)('div', { className: (0, r.A)('nlds-canvas__example'), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, v.jsx)(M, { children: (0, v.jsx)(s.v$, { children: k }) }) }) }),
          u &&
           (0, v.jsx)('div', {
