 ...
 [34799],
 {
  ...
  24456(e, n, t) {
   ...
   const i = ({ children: e, ...n }) => {
    ...
    o = ({ className: e, boxContent: n, ...t }) => (0, r.jsx)(i, { className: (0, a.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  24703(e, n, t) {
   'use strict';
   t.d(n, { o: () => d });
  ...
  26877(e, n, t) {
   ...
   const w = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, d.jsx)(x.n, { children: s.map((t) => (0, d.jsx)(x.K, { className: (0, i.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, h.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p._, { children: t.tasks.map(({ checked: e, name: t, id: a }) => (0, d.jsx)(p.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, h.qZ)(a) }, a)) }), (0, d.jsx)(a.fz, { children: (0, d.jsxs)(a.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
            ...
            ? (0, d.jsx)(
               c.Z,
               {
                ...
                description: (0, d.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, d.jsxs)(r.f, { children: [(0, d.jsx)(g, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, d.jsxs)(a.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, d.jsxs)('div', {
                   children: [
                    (p.length > 0 || u.length > 0) && (0, d.jsx)(s.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    p.length > 0 &&
                     (0, d.jsx)(a.dk, {
                      links: p
                  ...
                  u.length > 0 && u.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)('section', { children: [(0, d.jsxs)(s.DZ, { level: Math.min(n + 2, 6), children: [i, ' in ', e] }), (0, d.jsx)(a.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(o.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, d.jsxs)(l.Wu, {
                 children: [
                  ...
                  (0, d.jsxs)(a.fz, { children: [(0, d.jsx)(g, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, d.jsxs)(a.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (p.length > 0 || u.length > 0) && (0, d.jsx)(a.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  p.length > 0 &&
                   (0, d.jsx)(d.Fragment, {
                  ...
                  u.length > 0 && (0, d.jsx)(d.Fragment, { children: u.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(a.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, d.jsx)(a.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: s && (0, d.jsx)(u.D, { state: s }), children: e.title }), (0, d.jsx)(a.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(s) && (0, d.jsx)(f.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    A = ({ component: e }) => {
     const n = (e && j[e.title]) || [];
