...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [28568],
 {
  ...
  19036(e, n, t) {
   (t.r(n), t.d(n, { assets: () => G, component: () => W, contentTitle: () => D, default: () => _, description: () => S, frontMatter: () => R, issueNumber: () => L, metadata: () => i, title: () => N, toc: () => z }));
   ...
   const y = [
     ...
     { title: 'Instructies in de Form Field Description zijn op een inclusieve manier beschreven.', sc: '1.3.3', status: '', component: j.Ay, tags: ['designer', 'contentmaker'] },
     { title: 'De kleur van de Form Field Description geeft geen informatie die niet ook op minimaal 1 andere manier wordt gegeven.', sc: '1.4.1', status: '', component: x.Ay, tags: ['designer', 'contentmaker'] },
     ...
     { title: 'De bezoeker kan de Form Field Description tot 400% vergroten zonder verlies van functionaliteit of informatie.', sc: '1.4.10', status: '', component: u.Ay, tags: ['developer', 'designer'] },
     ...
     { title: 'Als de Form Field Description in een andere taal is dan de taal van de pagina, dan heeft het een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: w.Ay, tags: ['developer'] },
    ],
    C = [
     {
     ...
     { title: 'De Form Field Description is standaard niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: b.Ay, tags: ['developer'] },
  ...
  32385(e, n, t) {
   t.d(n, { bo: () => r, KF: () => m, mJ: () => h, VZ: () => k, cR: () => A, Pv: () => f, qZ: () => a, kD: () => b, QQ: () => C, B2: () => u, Pc: () => l, f4: () => s, GT: () => v, fX: () => o, eQ: () => x, B_: () => j, o_: () => w });
  ...
  70348(e, n, t) {
   ...
   const l = (0, r.forwardRef)(({ as: e, className: n, children: t, ...r }, o) => {
    ...
    d = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: l, headingApperance: d, ...c }) => {
     ...
     return (0, s.jsxs)('details', { className: g, ...c, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(o.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(a.D, { level: l, appearance: d, children: r }), t] })] }) }), (0, s.jsx)('div', { className: m, children: c.children })] });
    };
  },
  70561(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => o });
  ...
  82024(e, n, t) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
            ...
            ? (0, c.jsx)(
               d.Z,
               {
                ...
                description: (0, c.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, c.jsxs)(o.f, { children: [(0, c.jsx)(g, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, c.jsxs)(i.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, c.jsxs)('div', {
                   children: [
                    (p.length > 0 || m.length > 0) && (0, c.jsx)(r.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    p.length > 0 &&
                     (0, c.jsx)(i.dk, {
                      links: p
                  ...
                  m.length > 0 && m.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)('section', { children: [(0, c.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, c.jsxs)(l.Wu, {
                 children: [
                  ...
                  (p.length > 0 || m.length > 0) && (0, c.jsx)(i.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  p.length > 0 &&
                   (0, c.jsx)(c.Fragment, {
                  ...
                  m.length > 0 && (0, c.jsx)(c.Fragment, { children: m.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(i.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    A = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(u.p, { level: n, suffix: r && (0, c.jsx)(m.D, { state: r }), children: e.title }), (0, c.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(r) && (0, c.jsx)(j.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    k = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
         ...
         (0, u.jsx)(a._Q, {
          ...
          children: c.map((e, n) => {
           ...
           if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
            const i = o.pI.get(e);
            t = (0, u.jsx)(r.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${i.sc} ${i.nl.title}`, style: { lineHeight: 1 }, children: (0, u.jsx)(g.KE, { children: `WCAG ${e}` }) }, n);
           }
           return t;
          }),
         }),
         ...
         children: [
          ...
          (0, u.jsx)('div', {
           children: (0, u.jsxs)(u.Fragment, {
            children: [
             (0, u.jsxs)(s.f, { role: 'status', children: [j, ' van de ', f, ' items zijn nu zichtbaar.'] }),
             j < f
              ? (0, u.jsx)(l.$, {
                 purpose: 'secondary',
                 onClick: () => {
