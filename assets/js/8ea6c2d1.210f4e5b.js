 ...
 [6985],
 {
  ...
  12013(e, n, t) {
   ...
   const i = (e, n) => {
    ...
    c = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: s = '', components: i = {} }) => (0, a.jsx)(r.x, { components: { ...d(n, t), ...l(s), ...i }, children: e });
  },
  17045(e, n, t) {
   'use strict';
   t.d(n, { Ay: () => o, RM: () => a });
  ...
  17889(e, n, t) {
   ...
   var p = t(35193),
    ...
    y = t(79532),
    w = t(30758);
   const N = { color: p.A, dimension: j.A, fontFamilies: b.A, fontSizes: x.A, fontWeights: k.A, lineHeights: f.A, other: v.A, textDecoration: y.A },
    A = ({ type: e }) => (0, g.jsx)(m.In, { children: (0, w.createElement)(N[e]) });
   function D({ tokens: e }) {
    const n = (0, a.kD)(e),
     t = (0, a.GT)(n),
     o = t.map((e) => (0, a.B_)(e) + ': ;').join('\n'),
     l = JSON.stringify((0, a.Rc)(t));
    return (0, g.jsxs)(g.Fragment, {
     children: [
      ...
      (0, g.jsxs)(i.e2, { children: [(0, g.jsx)(u, { content: l, language: 'json', children: 'Kopieer als JSON' }), (0, g.jsx)(u, { content: o, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => m, mJ: () => p, VZ: () => N, cR: () => w, Pv: () => j, qZ: () => i, kD: () => f, B2: () => g, Pc: () => l, f4: () => o, GT: () => v, fX: () => a, eQ: () => k, B_: () => x, o_: () => b, Rc: () => y });
  ...
  88722(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => L, component: () => M, contentTitle: () => z, default: () => V, description: () => B, frontMatter: () => T, issueNumber: () => R, metadata: () => r, title: () => C, toc: () => F }));
