 ...
 [42492],
 {
  ...
  41757: (e, n, r) => {
   ...
   var i = r(4814),
    t = r(52676);
   const a = (e) => {
    let { children: n, className: r, level: a = 1, suffix: s, ...o } = e;
    return (0, t.jsxs)('hgroup', { className: (0, i.Z)('nlds-inline-heading-group', `utrecht-heading-${a}`, r), ...o, children: [(0, t.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: n }), s && (0, t.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
   };
  },
  57716: (e, n, r) => {
   r.d(n, { U: () => c });
   ...
   const s = (e, n) => {
    ...
    l = (e) => ({
     img: (n) => {
      let { src: r, ...i } = n;
      return (0, a.jsx)('img', { ...i, src: s(e, r), className: 'utrecht-img utrecht-img--fit' });
     },
    }),
    d = (e, n) => {
     if (e) {
    ...
    c = (e) => {
     ...
     return (0, a.jsx)(i.Z, { components: { ...d(r, t), ...l(s), ...o }, children: n });
    };
  },
  46364: (e, n, r) => {
   r.d(n, { j: () => s });
   ...
   const s = (e) => {
    ...
    return (0, a.jsx)(t.V, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: r && (0, a.jsx)(i.Ou, { className: 'nlds-inline-heading-group__badge', children: r }), ...s, children: n });
   };
  },
  40139: (e, n, r) => {
   r.d(n, { Z: () => o, a: () => s });
