 ...
 [6475],
 {
   ...
   const c = (0, s.createContext)({}),
    u = ({ title: e, appearance: n, description: t, children: s, figure: u }) => {
     const m = { do: 'Doen', dont: 'Niet doen' },
      h = u ? 'figure' : 'div',
      p = u ? 'figcaption' : 'div',
      j = 'string' == typeof t ? (0, d.jsx)(o.oz, { components: { a: i.N_ }, children: t }) : t;
  ...
  70348(e, n, t) {
   ...
   var l = t(13526),
    ...
    a = t(37168),
    o = t(86070);
   const s = (0, r.forwardRef)(({ as: e, className: n, children: t, ...r }, i) => {
     const a = e || 'div',
      s = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, o.jsx)(a, { ref: i, className: s, ...r, children: t });
    }),
    d = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: s, headingApperance: d, ...c }) => {
     ...
     return (0, o.jsxs)('details', { className: u, ...c, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(i.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [r && (0, o.jsx)(a.D, { level: s, appearance: d, children: r }), t] })] }) }), (0, o.jsx)('div', { className: m, children: c.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => y });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       ...
       return (0, b.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', t), children: [(0, b.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }), (0, b.jsx)(j.n, { children: (0, b.jsx)(j.K, { label: 'Code', children: (0, b.jsx)('pre', { className: 'language-html nl-code-block', children: (0, b.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: a } }) }) }) })] });
      }
