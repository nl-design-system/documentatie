...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [10252],
 {
   ...
   const c = (0, o.createContext)({}),
    h = ({ title: e, appearance: n, description: t, children: o, figure: h }) => {
     const v = { do: 'Doen', dont: 'Niet doen' },
      g = h ? 'figure' : 'div',
      b = h ? 'figcaption' : 'div',
      u = 'string' == typeof t ? (0, d.jsx)(s.oz, { children: t }) : t;
     return (0, d.jsxs)(g, { className: (0, r.A)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(b, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(i.fz, { className: (0, r.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(l.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: v.dont })] }), (0, d.jsx)(i.fz, { children: e })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(i.fz, { className: (0, r.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(a.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: v.do })] }), (0, d.jsx)(i.fz, { children: e })] }), u] }), (0, d.jsx)('div', { className: 'nlds-guideline__example', children: (0, d.jsx)(c.Provider, { value: { title: e, type: v[n] }, children: o }) })] });
    };
  },
  18439(e, n, t) {
   t.d(n, { R: () => r, x: () => s });
  ...
  58511(e, n, t) {
   (t.r(n), t.d(n, { assets: () => h, contentTitle: () => c, default: () => b, frontMatter: () => d, metadata: () => a, toc: () => v }));
  ...
  58639(e, n, t) {
   ...
   var a = t(69284),
    ...
    v = t(31186),
    g = t(86070);
   const b = ({ children: e }) => (0, g.jsx)(l.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(l.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(l.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   b.displayName = 'ParagraphContainer';
   const u = ({ children: e }) => (0, g.jsx)(l.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(l.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   u.displayName = 'DocumentContainer';
   const p = ({ children: e }) => (0, g.jsx)(l.ui, { className: 'nlds-canvas__example-surface', children: e });
   ...
   const m = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: m = !0, children: j, container: k = 'document', language: f, designTokens: y }) => {
    const x = 'function' == typeof j ? j() : j,
     ...
     z = 'string' == typeof e ? e : v.qV(_ || x),
     [w, N] = (0, h.useState)(z),
     [A, S] = (0, h.useState)(t);
    (0, h.useEffect)(() => {
     (async () => {
      const e = await c.Ay.format(z, { parser: f, plugins: [r.A, s.Ay, o.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [z]);
    const C = (0, h.useId)();
    ...
    return (
     ...
     (0, g.jsxs)('div', {
      ...
      children: [
       x && (0, g.jsx)('div', { className: (0, i.A)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, g.jsx)(D, { children: (0, g.jsx)(l.v$, { children: x }) }) }) }),
       m &&
        (0, g.jsx)('div', {
       ...
       m &&
        (0, g.jsxs)('div', {
         ...
         hidden: !A,
         children: [
          (0, g.jsx)(a.M, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: w, trim: !0 }),
          n &&
           (0, g.jsx)('div', {
  ...
  69284(e, n, t) {
   ...
   function d({ lineNumber: e, syntax: n, textContent: t, trim: d }) {
    let c = t;
    const { title: h, type: v } = (0, i.useContext)(r.x),
     g = (0, i.useId)();
    return (d && (c = c.trim()), (0, o.jsx)(l.f4, { theme: s, code: c, language: n || '', children: ({ style: n, tokens: t, getLineProps: l, getTokenProps: i }) => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsxs)('span', { hidden: !0, id: g, children: ['codevoorbeeld ', v ? `\u201c${v}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, o.jsx)(a.NG, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': g, style: n, children: t.map((n, t) => (0, o.jsxs)('span', { ...l({ line: n }), children: [e && (0, o.jsx)('span', { children: t + 1 }), n.map((e, n) => (0, o.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, t)) })] }) }));
   }
  },
  78734(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => i });
