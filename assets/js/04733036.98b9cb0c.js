 ...
 [50023],
 {
  ...
  58639(e, n, t) {
   ...
   const b = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: b = !0, children: y, container: j = 'document', language: x, designTokens: f }) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(N, { parser: x, plugins: [r.A, i.Ay, c.Ay, a.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [N]);
    const R = (0, p.useId)();
