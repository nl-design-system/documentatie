 ...
 [42684],
 {
  12013(e, n, r) {
   ...
   const s = (e, n) => {
    ...
    d = (e) => ({ img: ({ src: n, ...r }) => (0, t.jsx)('img', { ...r, src: s(e, n), className: 'utrecht-img utrecht-img--fit' }) }),
    a = (e, n) => {
     if (e) {
      const e = { ...o[n - 1] };
      return ((e.h1 = () => null), e);
    ...
    c = ({ children: e, omitH1: n = !1, headingLevel: r = 1, baseUrl: i = '', components: s = {} }) => (0, t.jsx)(l.x, { components: { ...a(n, r), ...d(i), ...s }, children: e });
  },
  15638(e, n, r) {
   r.d(n, { $: () => c, x: () => a });
   var l = r(4077),
   ...
   const a = (0, o.createContext)({}),
    c = ({ title: e, appearance: n, description: r, children: o, figure: c }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      u = c ? 'figure' : 'div',
      p = c ? 'figcaption' : 'div';
     return (0, d.jsxs)(u, { className: (0, s.A)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(p, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.fz, { className: (0, s.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(i.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: h.dont })] }), (0, d.jsx)(t.fz, { children: e })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.fz, { className: (0, s.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(l.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: h.do })] }), (0, d.jsx)(t.fz, { children: e })] }), r] }), (0, d.jsx)('div', { className: 'nlds-guideline__example', children: (0, d.jsx)(a.Provider, { value: { title: e, type: h[n] }, children: o }) })] });
    };
  },
  18439(e, n, r) {
   r.d(n, { R: () => s, x: () => o });
  ...
  40190(e, n, r) {
   (r.r(n), r.d(n, { assets: () => T, contentTitle: () => N, default: () => V, frontMatter: () => R, metadata: () => l, toc: () => F }));
   ...
   const R = { title: 'Vermeld duidelijk of een veld wel of niet verplicht is \xb7 Voorkom fouten in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Optioneel of verplicht', pagination_label: 'Optioneel of verplicht', description: 'Richtlijnen om duidelijk aan te geven welke velden een gebruiker kan overslaan in een formulier.', slug: '/richtlijnen/formulieren/voorkom-fouten/verplichte-velden/', keywords: ['labels', 'formulier', 'design', 'code'] },
    N = void 0,
    T = {},
  ...
  58639(e, n, r) {
   ...
   const j = ({ children: e }) => (0, p.jsx)(i.ui, { className: 'nlds-canvas__example-surface', children: (0, p.jsx)(i.yo, { className: (0, t.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   j.displayName = 'DocumentContainer';
   const m = ({ children: e }) => (0, p.jsx)(i.ui, { className: 'nlds-canvas__example-surface', children: e });
   m.displayName = 'SurfaceContainer';
   const x = ({ code: e, copy: n = !0, defaultExpandedCode: r = !1, displayCode: x = !0, children: g, container: f = 'document', language: k, designTokens: b }) => {
    ...
    (0, h.useEffect)(() => {
     (async () => {
      const e = await c.Ay.format(_, { parser: k, plugins: [s.A, o.Ay, d.Ay, a.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      R(e);
     })();
    }, [_]);
    const F = (0, h.useId)();
    let A = h.Fragment;
    return (
     'paragraph' === f ? (A = v) : 'document' === f ? (A = j) : 'surface' === f && (A = m),
     (0, p.jsxs)('div', {
      className: (0, t.A)('nlds-canvas'),
      children: [
       y && (0, p.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: b, children: (0, p.jsx)(A, { children: (0, p.jsx)(i.v$, { children: y }) }) }) }),
       x &&
        (0, p.jsx)('div', {
       ...
       x &&
        (0, p.jsxs)('div', {
         ...
         hidden: !N,
         children: [
          (0, p.jsx)(l.M, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: z, trim: !0 }),
          n &&
           (0, p.jsx)('div', {
  ...
  69284(e, n, r) {
   ...
   function a({ lineNumber: e, syntax: n, textContent: r, trim: a }) {
    ...
    const { title: h, type: u } = (0, t.useContext)(s.x),
     p = (0, t.useId)();
    return (a && (c = c.trim()), (0, d.jsx)(i.f4, { theme: o, code: c, language: n || '', children: ({ style: n, tokens: r, getLineProps: i, getTokenProps: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, d.jsx)(l.NG, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': p, style: n, children: r.map((n, r) => (0, d.jsxs)('span', { ...i({ line: n }), children: [e && (0, d.jsx)('span', { children: r + 1 }), n.map((e, n) => (0, d.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, r)) })] }) }));
   }
  },
  78734(e, n, r) {
   r.d(n, { Ay: () => o, RM: () => t });
