 ...
 [94368],
 {
  60329: (e, t, n) => {
   ...
   var a = n(50959),
    ...
    c = n(18943),
    u = n(42650);
   const h = { backToTopButton: "backToTopButton_gxl1", backToTopButtonShow: "backToTopButtonShow_iezY" };
   var b = n(11527);
   function m() {
   ...
   var T = n(49576),
    ...
    A = (0, j.Z)("chevron-up", "IconChevronUp", [["path", { d: "M6 15l6 -6l6 6", key: "svg-0" }]]),
    M = n(16532);
   function B(e) {
   ...
   const U = (0, a.memo)(z),
    K = { menu: "menu_Y1UP", menuWithAnnouncementBar: "menuWithAnnouncementBar_fPny" };
   function Y(e) {
    ...
    return (0, b.jsx)("nav", { "aria-label": (0, d.I)({ id: "theme.docs.sidebar.navAriaLabel", message: "Docs sidebar", description: "The ARIA label for the sidebar navigation" }), className: (0, i.Z)("menu thin-scrollbar", K.menu, r && K.menuWithAnnouncementBar, o), children: (0, b.jsx)("ul", { className: (0, i.Z)(s.k.docs.docSidebarMenu, "menu__list"), children: (0, b.jsx)(U, { items: n, activePath: t, level: 1 }) }) });
   }
   ...
   function O(e) {
    ...
    const {
     ...
     d = (0, a.useId)();
    return (0, b.jsxs)("div", { className: (0, i.Z)(J.sidebar, r && J.sidebarWithHideableNavbar, s && J.sidebarHidden, l && J.sidebarWithNavbar), children: [(0, b.jsx)(M.zx, { appearance: "subtle-button", onClick: o, className: (0, i.Z)(J["sidebar__toggle-button"], s && J["sidebar__toggle-button--icon-only"]), "aria-controls": d, "aria-label": s ? "Toon sidebar" : "Verberg sidebar", "aria-expanded": !s, children: s ? (0, b.jsx)(b.Fragment, { children: (0, b.jsx)(f, {}) }) : (0, b.jsxs)(b.Fragment, { children: [(0, b.jsx)(k, {}), " Verberg"] }) }), (0, b.jsx)("div", { id: d, "aria-expanded": !s, className: (0, i.Z)(J.sidebar__content, s && J["sidebar__content--hidden"]), children: (0, b.jsx)(Y, { path: t, sidebar: n }) })] });
   }
   const Q = a.memo(O);
   var q = n(8784),
    G = n(75511);
   ...
   function $(e) {
    return (0, b.jsx)(q.Zo, { component: X, props: e });
   }
   const ee = a.memo($);
   function te(e) {
    const t = (0, _.i)(),
   ...
   const ae = { expandButton: "expandButton_pbew", expandButtonIcon: "expandButtonIcon_VuyU" };
   function ie(e) {
   ...
   const oe = { docSidebarContainer: "docSidebarContainer_xTAu", docSidebarContainerHidden: "docSidebarContainerHidden_QDZv", sidebarViewport: "sidebarViewport_gAQR" };
   function se(e) {
    let { children: t } = e;
    const n = (0, l.V)();
   ...
   const le = { docMainContainer: "docMainContainer_sKIO", docMainContainerEnhanced: "docMainContainerEnhanced_K8zJ", docItemWrapperEnhanced: "docItemWrapperEnhanced_TKkq" };
   function de(e) {
   ...
   const ce = { docRoot: "docRoot_Qusp", docsWrapper: "docsWrapper_vK1H" };
   function ue(e) {
    let { children: t } = e;
    const n = (0, l.V)(),
     [i, o] = (0, a.useState)(!1);
