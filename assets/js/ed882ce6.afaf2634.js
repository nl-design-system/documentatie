...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  17023(e, n, t) {
   (t.r(n), t.d(n, { assets: () => h, contentTitle: () => m, default: () => p, frontMatter: () => d, metadata: () => i, toc: () => b }));
   ...
   function u(e) {
    const n = { a: 'a', h1: 'h1', header: 'header', img: 'img', li: 'li', p: 'p', strong: 'strong', ul: 'ul', ...(0, o.R)(), ...e.components };
   ...
   const d = { title: 'Plaatsing van een button binnen een formulier \xb7 Buttons in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Plaatsing button', pagination_label: 'Plaatsing button', description: 'Richtlijnen voor plaatsing van een button binnen een formulier.', slug: '/richtlijnen/formulieren/buttons/plaatsing', keywords: ['labels', 'formulier', 'design', 'code'] },
    m = void 0,
    h = {},
    b = [...s.RM];
   function j(e) {
