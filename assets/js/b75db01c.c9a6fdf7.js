 ...
 [91279],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    l = n(86070);
   const u = { figma: (0, l.jsx)(o.A, {}), github: (0, l.jsx)(i.A, {}), npm: (0, l.jsx)(c.A, {}), storybook: (0, l.jsx)(s.A, {}) },
    h = ({ brand: e }) => (0, l.jsx)(r.In, { children: u[e] || (0, l.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => o, KF: () => d, mJ: () => p, VZ: () => _, cR: () => w, Pv: () => g, qZ: () => c, kD: () => b, B2: () => j, Pc: () => a, f4: () => s, GT: () => f, fX: () => i, eQ: () => k, B_: () => v, o_: () => m, Rc: () => x });
   ...
   const h = (e) => [...e].sort((e, t) => l.indexOf(e) - l.indexOf(t)),
    ...
    p = (e) => h(u(e.projects.flatMap((e) => y(e)))),
    g = (e) => {
     const t = y(e),
      n = ((e) => {
   ...
   const c = ({ background: e, children: t, className: n, ...r }) => (0, i.jsx)('div', { className: (0, o.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: c = 'div', background: s, children: a }) => {
     const l = (e) => ('article' === c ? (0, i.jsx)('article', { ...e }) : 'section' === c ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      u = (0, i.jsx)(l, { className: (0, o.A)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
  ...
  99630(e, t, n) {
   ...
   const m = ({ component: e, headingLevel: t }) => {
            ...
            c.Zp,
            {
             ...
             children: (0, a.jsxs)(c.Wu, {
              children: [
               ...
               s.length > 0 && (0, a.jsx)(a.Fragment, { children: s.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [o, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    b = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(h.p, { level: t, suffix: o && (0, a.jsx)(u.D, { state: o }), children: e.title }), (0, a.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
 },
]);
