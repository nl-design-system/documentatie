 ...
 [88230],
 {
  82197: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(31612),
    o = n(60851);
   const s = { title: 'Heading 1', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading 1', pagination_label: 'Heading 1', description: 'Toont de eerste titel van de pagina en helpt de inhoud van een pagina te structureren.', slug: '/heading-1', sidebar_custom_props: { illustration: 'HeadingSketch' } },
    a = void 0,
    u = { id: 'componenten/heading-1/index', title: 'Heading 1', description: 'Toont de eerste titel van de pagina en helpt de inhoud van een pagina te structureren.', source: '@site/docs/componenten/heading-1/index.mdx', sourceDirName: 'componenten/heading-1', slug: '/heading-1', permalink: '/heading-1', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/heading-1/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Heading 1', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading 1', pagination_label: 'Heading 1', description: 'Toont de eerste titel van de pagina en helpt de inhoud van een pagina te structureren.', slug: '/heading-1', sidebar_custom_props: { illustration: 'HeadingSketch' } }, sidebar: 'componenten', previous: { title: 'Heading', permalink: '/heading' }, next: { title: 'Heading 2', permalink: '/heading-2' } },
    l = {},
    d = [
    ...
    h = 'Heading 1',
    j = 'Toont de eerste titel van de pagina en helpt de inhoud van een pagina te structureren.',
    g = 'HeadingSketch',
    y = 257,
