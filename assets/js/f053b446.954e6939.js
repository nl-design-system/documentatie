(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [88474],
 {
  ...
  65022: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => G, component: () => S, contentTitle: () => C, default: () => L, description: () => z, frontMatter: () => b, issueNumber: () => N, metadata: () => T, title: () => R, toc: () => W });
   var r = n(52676),
    s = n(40139),
    o = n(43166),
    i = n(5010),
    c = n(93514);
   function a(e) {
    const t = { code: 'code', p: 'p', pre: 'pre', strong: 'strong', ...(0, s.a)(), ...e.components };
   ...
   function _(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(y.Rv, { component: S, headingLevel: 1, description: z }),
      '\n',
      ...
      '\n',
      (0, r.jsx)(v.U, { omitH1: !0, headingLevel: 3, children: (0, r.jsx)(k, {}) }),
      '\n',
  ...
  94443: (e, t, n) => {
   ...
   const A = (e) => {
     ...
     const o = t && t.projects.filter((e) => v.e9.includes(e.id)),
      i = o && v.e9.map((e) => o.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, d.jsx)(r.a2, {
       appearance: '',
       sections: i.map((e) => ({
        className: (0, s.Z)('definition-of-done', e && `definition-of-done--${(0, v.mA)(e.title)}`),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, d.jsx)(y, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(f, { headingLevel: n + 1, checked: t, title: r, description: (0, v.Q6)(s) }, s);
            }),
           }),
    ...
    k = (e) => {
     let { component: t, headingLevel: n } = e;
     const s = t && t.projects.filter((e) => !v.e9.includes(e.id));
     return t && s.length
      ? (0, d.jsx)(m.um, {
         appearance: 'large',
    ...
    b = (e) => {
     ...
     const o = t && v.$3[t.relayStep];
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.V, { level: n, suffix: o && (0, d.jsx)(g.y, { state: o }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: s })] });
    };
  },
  49556: (e, t, n) => {
   'use strict';
   ...
   var p = n(6076),
    ...
    k = n(49003),
    x = n(75271);
   const b = { color: p.Z, dimension: j.Z, fontFamilies: w.Z, fontSizes: y.Z, fontWeights: f.Z, lineHeights: v.Z, other: A.Z, textDecoration: k.Z },
    C = (e) => {
     let { type: t } = e;
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => j, BA: () => c, Ee: () => d, Q6: () => o, U: () => m, Yr: () => w, d: () => u, e9: () => i, fO: () => f, mA: () => s, ps: () => g, qU: () => v, s0: () => y, zP: () => p });
