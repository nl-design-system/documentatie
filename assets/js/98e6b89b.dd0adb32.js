...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  8047(e, n, a) {
   (a.r(n), a.d(n, { assets: () => d, component: () => x, componentName: () => h, contentTitle: () => g, default: () => v, description: () => m, frontMatter: () => r, issueNumber: () => c, metadata: () => t, relayStep: () => p, title: () => u, toc: () => f }));
  ...
  21034(e, n, a) {
   ...
   const b = ({ component: e, headingLevel: n }) => {
    ...
    k = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(m.p, { level: n, suffix: i && (0, g.jsx)(u.D, { state: i }), children: e.title }), (0, g.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(i) && (0, g.jsx)(f.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    D = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => x, qZ: () => s, kD: () => j, QQ: () => H, B2: () => c, Pc: () => r, f4: () => o, GT: () => k, fX: () => l, eQ: () => v, B_: () => b, o_: () => f });
  ...
  70348(e, n, a) {
   ...
   const o = ({ className: e, ...n }) => {
    ...
    r = ({ className: e, classNamePanel: n, label: a, heading: o, headingLevel: r, headingApperance: g, ...d }) => {
     ...
     return (0, s.jsxs)('details', { className: u, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(i.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [o && (0, s.jsx)(l.D, { level: r, appearance: g, children: o }), a] })] }) }), (0, s.jsx)('div', { className: m, children: d.children })] });
    };
  },
  85162(e, n, a) {
   a.d(n, { s: () => r });
