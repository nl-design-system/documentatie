...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [32141],
 {
  ...
  58639(e, n, o) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: g = !0, children: x, container: j = 'document', language: b, designTokens: f }) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await a.Ay.format(w, { parser: b, plugins: [t.A, c.Ay, i.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      A(e);
     })();
    }, [w]);
    const z = (0, p.useId)();
    let M = p.Fragment;
    return (
     'paragraph' === j ? (M = h) : 'document' === j ? (M = y) : 'surface' === j && (M = v),
     (0, m.jsxs)('div', {
      className: (0, s.A)('nlds-canvas'),
      children: [
       k && (0, m.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(M, { children: (0, m.jsx)(l.v$, { children: k }) }) }) }),
       g &&
        (0, m.jsx)('div', {
       ...
       g &&
        (0, m.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(r.M, { codeBlockLabel: 'Codevoorbeeld', syntax: b, textContent: N, trim: !0 }),
          n &&
           (0, m.jsx)('div', {
