/*! For license information please see 235c86a2.d85126a8.js.LICENSE.txt */
'use strict';
 ...
 [21057],
 {
  ...
  45282(e, n, t) {
   ...
   var a = t(63195),
    r = t(13526),
    i = t(86070);
   const s = ({ className: e, ...n }) => (0, i.jsx)(a.A, { className: (0, r.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  60755(e, n, t) {
   (t.r(n), t.d(n, { assets: () => m, contentTitle: () => c, default: () => b, frontMatter: () => h, metadata: () => a, toc: () => j }));
   ...
   var r = t(86070),
    ...
    o = t(64249),
    d = t(46447);
   const h = { title: 'Heartbeat \xb7 Bijeenkomsten', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heartbeat', pagination_label: '2 wekelijkse updates van het kernteam en community', description: 'Wat is de Heartbeat, hoe meld ik mij aan, en op welke momenten is het?', slug: '/events/heartbeat' },
    c = 'Heartbeat',
    m = {},
    j = [
  ...
  88666(e, n, t) {
   ...
   var a = t(63195),
    r = t(13526),
    i = t(86070);
   const s = ({ appearance: e, ...n }) => (0, i.jsx)(a.A, { className: (0, r.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...n });
  },
 },
]);
