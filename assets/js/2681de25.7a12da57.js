 ...
 [6548],
 {
  ...
  58639(e, n, l) {
   ...
   const x = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: x = !0, children: k, container: g = 'document', language: v, designTokens: y }) => {
    ...
    (0, h.useEffect)(() => {
     (async () => {
      const e = await c.Ay.format(w, { parser: v, plugins: [o.A, a.Ay, i.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [w]);
    const S = (0, h.useId)();
    let D = h.Fragment;
    return (
     'paragraph' === g ? (D = m) : 'document' === g ? (D = u) : 'surface' === g && (D = b),
     (0, p.jsxs)('div', {
      className: (0, s.A)('nlds-canvas'),
      children: [
       f && (0, p.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, p.jsx)(D, { children: (0, p.jsx)(r.v$, { children: f }) }) }) }),
       x &&
        (0, p.jsx)('div', {
