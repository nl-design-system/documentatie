 ...
 [71537],
 {
  ...
  17889(e, t, n) {
   ...
   var j = n(35193),
    ...
    v = n(79532),
    x = n(30758);
   const A = { color: j.A, dimension: p.A, fontFamilies: y.A, fontSizes: w.A, fontWeights: f.A, lineHeights: k.A, other: b.A, textDecoration: v.A },
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => u, mJ: () => j, VZ: () => A, cR: () => x, Pv: () => p, qZ: () => o, kD: () => k, B2: () => g, Pc: () => c, f4: () => a, GT: () => b, fX: () => i, eQ: () => f, B_: () => w, o_: () => y, Rc: () => v });
  ...
  85825(e, t, n) {
   ...
   const j = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    p = ({ checked: e, children: t, title: n, description: r, headingLevel: i = 3 }) => (0, l.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(m.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [n ? (0, l.jsx)(g.DZ, { appearance: 'utrecht-heading-3', level: i, children: n }) : null, r, t] })] });
   var y = n(33062);
   const w = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => y.f4.includes(e.id)),
      i = n && y.f4.map((e) => n.find((t) => t.id === e)).filter(Boolean);
     return e && (0, l.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, y.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(j, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(p, { headingLevel: t + 1, checked: e, title: n, description: (0, y.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
