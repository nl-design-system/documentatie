 ...
 [77068],
 {
  1292(e, n, t) {
   ...
   const c = { figma: (0, d.jsx)(r.A, {}), github: (0, d.jsx)(i.A, {}), npm: (0, d.jsx)(s.A, {}), storybook: (0, d.jsx)(o.A, {}) },
    h = ({ brand: e }) => (0, d.jsx)(a.In, { children: c[e] || (0, d.jsx)(l.A, {}) });
  },
  33062(e, n, t) {
   t.d(n, { bo: () => r, KF: () => m, mJ: () => u, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => s, kD: () => k, B2: () => g, Pc: () => l, f4: () => o, GT: () => b, fX: () => i, eQ: () => x, B_: () => v, o_: () => j, Rc: () => _ });
  ...
  37131(e, n, t) {
   ...
   const u = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
            ...
            s.Zp,
            {
             ...
             children: (0, d.jsxs)(s.Wu, {
              children: [
               ...
               (h.length > 0 || o.length > 0) && (0, d.jsx)(a.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, d.jsx)(d.Fragment, {
    ...
    x = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: r && (0, d.jsx)(h.D, { state: r }), children: e.title }), (0, d.jsx)(a.fz, { lead: !0, children: t })] });
    },
    k = ({ component: e }) => {
     const n = (e && u[e.title]) || [];
  ...
  80427(e, n, t) {
   (t.r(n), t.d(n, { assets: () => h, component: () => j, componentName: () => f, contentTitle: () => c, default: () => k, description: () => g, frontMatter: () => d, issueNumber: () => p, metadata: () => a, relayStep: () => u, title: () => m, toc: () => v }));
