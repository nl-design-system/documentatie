...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [7308],
 {
  ...
  51671(e, n, r) {
   (r.r(n), r.d(n, { assets: () => j, contentTitle: () => p, default: () => f, frontMatter: () => v, metadata: () => i, toc: () => b }));
   const i = JSON.parse('{"id":"wcag/2.4.03","title":"WCAG-succescriterium 2.4.3 Focus volgorde","description":"Wanneer een toetsenbordgebruiker binnen de webpagina navigeert, bijvoorbeeld met de Tab-toets, moet de tabvolgorde logisch en voorspelbaar zijn.","source":"@site/docs/wcag/2.4.03.mdx","sourceDirName":"wcag","slug":"/wcag/2.4.3","permalink":"/wcag/2.4.3","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.03.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 2.4.3 Focus volgorde","title_sm":"2.4.3 Focus volgorde","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"2.4.3 Focus volgorde","pagination_label":"WCAG-succescriterium 2.4.3 Focus volgorde","description":"Wanneer een toetsenbordgebruiker binnen de webpagina navigeert, bijvoorbeeld met de Tab-toets, moet de tabvolgorde logisch en voorspelbaar zijn.","slug":"2.4.3","conformance_level":"Niveau A","keywords":["WCAG","A","bedienbaar","navigeerbaar","operable","navigable","focus order"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 2.4.2 Paginatitel","permalink":"/wcag/2.4.2"},"next":{"title":"WCAG-succescriterium 2.4.4 Linkdoel (in context)","permalink":"/wcag/2.4.4"}}');
   var t = r(86070),
    s = r(18439),
    o = r(24703),
    l = r(61473),
   ...
   const v = { title: 'WCAG-succescriterium 2.4.3 Focus volgorde', title_sm: '2.4.3 Focus volgorde', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.3 Focus volgorde', pagination_label: 'WCAG-succescriterium 2.4.3 Focus volgorde', description: 'Wanneer een toetsenbordgebruiker binnen de webpagina navigeert, bijvoorbeeld met de Tab-toets, moet de tabvolgorde logisch en voorspelbaar zijn.', slug: '2.4.3', conformance_level: 'Niveau A', keywords: ['WCAG', 'A', 'bedienbaar', 'navigeerbaar', 'operable', 'navigable', 'focus order'] },
    p = void 0,
    j = {},
  ...
  61473(e, n, r) {
   ...
   var i = r(46447),
    t = r(46276),
    s = r(86070);
   const o = ({ children: e, conformanceLevel: n, ...r }) => (globalThis.isAstro ? null : (0, s.jsx)(t.p, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: n && (0, s.jsx)(i.KE, { className: 'nlds-inline-heading-group__badge', children: n }), ...r, children: e }));
  },
  66117(e, n, r) {
   r.d(n, { Ay: () => l, RM: () => s });
   var i = r(86070),
  ...
  66119(e, n, r) {
   ...
   function t(e) {
    ...
    if ('string' == typeof e || 'number' == typeof e) i += e;
     ...
     if (Array.isArray(e)) {
      var s = e.length;
      for (n = 0; n < s; n++) e[n] && (r = t(e[n])) && (i && (i += ' '), (i += r));
     } else for (r in e) e[r] && (i && (i += ' '), (i += r));
    return i;
   }
   function s() {
    for (var e, n, r = 0, i = '', s = arguments.length; r < s; r++) (e = arguments[r]) && (n = t(e)) && (i && (i += ' '), (i += n));
    return i;
   }
   const o = (0, r(30758).forwardRef)(({ aside: e, children: n, className: r, purpose: t, ...o }, l) => {
    const a = { ...o, ref: l, className: s('utrecht-note', { [`utrecht-note--${t}`]: t }, r) };
