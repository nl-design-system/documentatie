...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [50718],
 {
  ...
  54629: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => b, contentTitle: () => m, default: () => g, frontMatter: () => u, metadata: () => h, toc: () => v });
   var o = l(52676),
    s = l(24785),
    r = l(98480),
    i = l(91050);
  ...
  98480: (e, n, l) => {
   ...
   const g = (e) => {
    ...
    let K = d.Fragment;
    return (
     'paragraph' === x ? (K = b) : 'document' === x ? (K = v) : 'surface' === x && (K = _),
     (0, h.jsxs)('div', {
    ...
    return (
     ...
     (0, i.jsx)(s.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsx)(o.dn, { tabIndex: 0, style: l, children: s.map((e, l) => (0, i.jsxs)('span', { ...r({ line: e }), children: [n && (0, i.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const a = (e) => {
    ...
    const u = 'Doen',
     ...
     h = p ? 'figure' : 'div',
     b = p ? 'figcaption' : 'div';
    return (0, c.jsxs)(h, { className: (0, i.Z)(t['nlds-guideline'], t[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(b, { className: (0, i.Z)(t['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(r.nv, { className: (0, i.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: t['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: t['nlds-guideline__title'], children: m })] }), (0, c.jsx)(r.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(r.nv, { className: (0, i.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: t['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: t['nlds-guideline__title'], children: u })] }), (0, c.jsx)(r.nv, { children: n })] }), a] }), (0, c.jsx)('div', { className: (0, i.Z)(t['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => t, a: () => i });
