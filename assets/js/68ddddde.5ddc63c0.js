 ...
 [94192],
 {
  ...
  17889(e, n, t) {
   ...
   var h = t(35193),
    ...
    w = t(79532),
    S = t(30758);
   const D = { color: h.A, dimension: k.A, fontFamilies: j.A, fontSizes: x.A, fontWeights: b.A, lineHeights: f.A, other: v.A, textDecoration: w.A },
    L = ({ type: e }) => (0, m.jsx)(u.In, { children: (0, S.createElement)(D[e]) });
   function y({ tokens: e }) {
    const n = (0, r.kD)(e),
     t = (0, r.GT)(n),
       ...
       children: [
        ...
        (0, m.jsx)(s.BF, {
         children: t.map((n) => {
          const t = (0, r.o_)(n),
           o = (0, r.eQ)(e, n).$type;
          return (0, m.jsxs)(s.Hj, { children: [(0, m.jsx)(s.nA, { children: (0, m.jsx)(i.C, { children: (0, m.jsx)(s.kf, { children: t }) }) }), (0, m.jsx)(s.nA, { children: (0, m.jsxs)(a.K, { children: [(0, m.jsx)(L, { type: o }), ' ', o] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, m.jsxs)(s.e2, { children: [(0, m.jsx)(p, { content: l, language: 'json', children: 'Kopieer als JSON' }), (0, m.jsx)(p, { content: o, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => a, KF: () => u, mJ: () => h, VZ: () => D, cR: () => S, Pv: () => k, qZ: () => s, kD: () => f, B2: () => m, Pc: () => l, f4: () => o, GT: () => v, fX: () => r, eQ: () => b, B_: () => x, o_: () => j, Rc: () => w });
  ...
  65655(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => Z, component: () => K, contentTitle: () => $, default: () => Q, description: () => W, frontMatter: () => U, issueNumber: () => J, metadata: () => i, title: () => X, toc: () => q }));
   ...
   const R = [
     ...
     { title: 'Het label van de Skip Link bestaat uit tekst, niet uit een afbeelding van tekst.', sc: '1.4.5', status: '', component: y.Ay, tags: ['developer', 'contentmaker'] },
     { title: 'De Skip Link slaat 1 of meerdere herhalende contentblokken over.', sc: '2.4.1', status: '', component: F.Ay, tags: ['developer'] },
     {
     ...
     { title: 'De Skip Link wordt niet bedekt door een ander element op de pagina.', sc: '2.4.11', status: '', component: z.Ay, tags: ['developer'] },
    ...
    T = [
     ...
     { title: 'Als je de hele webpagina inzoomt tot 400% veroorzaakt de Skip Link geen horizontale scrollbalk en blijft alle tekst op de pagina leesbaar.', sc: '1.4.10', status: '', component: L.Ay, tags: ['developer', 'designer'] },
     {
     ...
     { title: 'De Skip Link heeft een rol van link.', sc: '4.1.2', status: '', component: D.Ay, tags: ['developer'] },
    ];
   var H = t(90495),
    C = t(46447),
    _ = t(56421),
   ...
   const s = ({ background: e, children: n, className: t, ...i }) => (0, r.jsx)('div', { className: (0, a.A)('card__illustration', e && `card__illustration--${e}`, t), ...i, children: n }),
    ...
    l = ({ href: e, appearance: n, className: t, component: s = 'div', background: o, children: l }) => {
     const d = (e) => ('article' === s ? (0, r.jsx)('article', { ...e }) : 'section' === s ? (0, r.jsx)('section', { ...e }) : (0, r.jsx)('div', { ...e })),
      c = (0, r.jsx)(d, { className: (0, a.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: l });
