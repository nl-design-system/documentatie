...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [47544],
 {
               ...
               d.Z,
               {
                ...
                description: (0, m.jsxs)('div', {
                 ...
                 children: [
                  ...
                  g.length > 0 && g.map(({ frameworkName: e, tasks: a }) => (0, m.jsxs)('section', { children: [(0, m.jsxs)(i.DZ, { level: Math.min(n + 2, 6), children: [s, ' in ', e] }), (0, m.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, m.jsx)(r.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               o.Zp,
               {
                ...
                children: (0, m.jsxs)(o.Wu, {
                 children: [
                  ...
                  g.length > 0 && (0, m.jsx)(m.Fragment, { children: g.map(({ frameworkName: e, tasks: a }) => (0, m.jsxs)(m.Fragment, { children: [(0, m.jsxs)(t.DZ, { level: n + 2, children: [s, ' in ', e] }), (0, m.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, m.jsx)(r.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => x, qZ: () => s, kD: () => j, QQ: () => A, B2: () => c, Pc: () => o, f4: () => r, GT: () => k, fX: () => l, eQ: () => v, B_: () => f, o_: () => b });
  ...
  70348(e, n, a) {
   ...
   const o = (0, i.forwardRef)(({ as: e, className: n, children: a, ...i }, l) => {
    ...
    d = ({ className: e, classNamePanel: n, label: a, heading: i, headingLevel: o, headingApperance: d, ...g }) => {
     ...
     return (0, r.jsxs)('details', { className: u, ...g, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(l.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [i && (0, r.jsx)(s.D, { level: o, appearance: d, children: i }), a] })] }) }), (0, r.jsx)('div', { className: m, children: g.children })] });
    };
  },
  70632(e, n, a) {
   (a.r(n), a.d(n, { assets: () => g, component: () => x, componentName: () => h, contentTitle: () => d, default: () => v, description: () => m, frontMatter: () => o, issueNumber: () => c, metadata: () => t, relayStep: () => p, title: () => u, toc: () => b }));
   const t = JSON.parse('{"id":"componenten/alert-dialog/index","title":"Alert Dialog","description":"Opent een venster waarin de gebruiker een actie moet uitvoeren om verder te gaan. De rest van de pagina is tijdelijk geblokkeerd.","source":"@site/docs/componenten/alert-dialog/index.mdx","sourceDirName":"componenten/alert-dialog","slug":"/alert-dialog","permalink":"/alert-dialog","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/alert-dialog/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Alert Dialog","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Alert Dialog","pagination_label":"Alert Dialog","description":"Opent een venster waarin de gebruiker een actie moet uitvoeren om verder te gaan. De rest van de pagina is tijdelijk geblokkeerd.","issue_number":182,"slug":"/alert-dialog","keywords":["actie","action","alert","bevestigen","blocking","blokkeren","choice","confirm","continue","dialog","dialoogvenster","doorgaan","keuze","modal","urgent","venster","waarschuwing"]},"sidebar":"componenten","previous":{"title":"Alert","permalink":"/alert"},"next":{"title":"Avatar","permalink":"/avatar"}}');
   var i = a(86070),
    l = a(18439),
    s = a(82062),
    r = a(21034);
   const o = { title: 'Alert Dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Alert Dialog', pagination_label: 'Alert Dialog', description: 'Opent een venster waarin de gebruiker een actie moet uitvoeren om verder te gaan. De rest van de pagina is tijdelijk geblokkeerd.', issue_number: 182, slug: '/alert-dialog', keywords: ['actie', 'action', 'alert', 'bevestigen', 'blocking', 'blokkeren', 'choice', 'confirm', 'continue', 'dialog', 'dialoogvenster', 'doorgaan', 'keuze', 'modal', 'urgent', 'venster', 'waarschuwing'] },
    d = void 0,
    g = {},
    u = 'Alert Dialog',
    m = 'Opent een venster waarin de gebruiker een actie moet uitvoeren om verder te gaan. De rest van de pagina is tijdelijk geblokkeerd.',
    c = 182,
    p = 'help wanted',
    h = 'alert-dialog',
