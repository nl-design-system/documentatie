...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  5155(e, n, a) {
   (a.r(n), a.d(n, { assets: () => g, component: () => x, componentName: () => p, contentTitle: () => d, default: () => v, description: () => m, frontMatter: () => r, issueNumber: () => c, metadata: () => t, relayStep: () => h, title: () => u, toc: () => b }));
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => p, VZ: () => F, cR: () => D, Pv: () => x, qZ: () => s, kD: () => j, QQ: () => T, B2: () => c, Pc: () => r, f4: () => o, GT: () => k, fX: () => l, eQ: () => v, B_: () => f, o_: () => b });
  ...
  70348(e, n, a) {
   ...
   const o = ({ className: e, ...n }) => {
    ...
    r = ({ className: e, classNamePanel: n, label: a, heading: o, headingLevel: r, headingApperance: d, ...g }) => {
     ...
     return (0, s.jsxs)('details', { className: u, ...g, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(i.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [o && (0, s.jsx)(l.D, { level: r, appearance: d, children: o }), a] })] }) }), (0, s.jsx)('div', { className: m, children: g.children })] });
    };
  },
  85162(e, n, a) {
   a.d(n, { s: () => r });
