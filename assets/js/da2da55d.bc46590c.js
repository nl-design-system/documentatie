 ...
 [39009],
 {
  ...
  21034(e, n, a) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
    ...
    H = ({ component: e, headingLevel: n, description: a }) => {
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => x, qZ: () => r, kD: () => j, QQ: () => N, B2: () => c, Pc: () => o, f4: () => l, GT: () => v, fX: () => s, eQ: () => k, B_: () => b, o_: () => f });
  ...
  32932(e, n, a) {
   ...
   const o = { title: 'Heading Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading Group', pagination_label: 'Heading Group', description: 'Combinatie van een koptekst en ondersteunende tekst.', issue_number: 248, slug: '/heading-group', keywords: ['caption', 'caption group', 'content', 'heading', 'heading group', 'headline', 'kop', 'onderschrift', 'paginakop', 'pre heading', 'sectie', 'section', 'section group', 'structure', 'subkop', 'titel', 'titelgroep', 'title', 'title group', 'voorloopkop'] },
    ...
    g = {},
    u = 'Heading Group',
    m = 'Combinatie van een koptekst en ondersteunende tekst.',
    c = 248,
    p = r.find((e) => e.number === c),
    h = [
