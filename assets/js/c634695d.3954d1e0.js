...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [96233],
 {
  ...
  55863: (e, n, o) => {
   o.r(n), o.d(n, { assets: () => h, contentTitle: () => v, default: () => b, frontMatter: () => p, metadata: () => m, toc: () => g });
   var t = o(52676),
    l = o(24785);
   function r(e) {
  ...
  98480: (e, n, o) => {
   ...
   const h = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(t.Tg, { className: p['nlds-canvas__example-surface'], children: (0, m.jsx)(t.BB, { className: (0, l.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: (0, m.jsx)(t.nv, { className: p['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   h.displayName = 'ParagraphContainer';
   const g = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(t.Tg, { className: p['nlds-canvas__example-surface'], children: (0, m.jsx)(t.BB, { className: (0, l.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: n }) });
   };
   ...
   const b = (e) => {
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (C = await d.ZP.format(N, { parser: f, plugins: [r.Z, i.ZP, a.ZP, s.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(C);
     })();
    }, [N]);
    const E = (0, c.useId)();
    let M = c.Fragment;
    return (
     'paragraph' === _ ? (M = h) : 'document' === _ ? (M = g) : 'surface' === _ && (M = j),
     (0, m.jsxs)('div', {
      className: (0, l.Z)(p['nlds-canvas']),
      children: [
       w && (0, m.jsx)('div', { className: (0, l.Z)(p['nlds-canvas__example']), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, m.jsx)(M, { children: (0, m.jsx)(t.pu, { children: w }) }) }) }),
       k &&
        (0, m.jsx)('div', {
       ...
       k &&
        (0, m.jsxs)('div', {
         ...
         hidden: !D,
         children: [
          (0, m.jsx)(v.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: C, trim: !0 }),
          o &&
           (0, m.jsx)('div', {
  ...
  41179: (e, n, o) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: o, textContent: d, trim: c } = e,
     u = d;
    const { title: p, type: v } = (0, r.useContext)(i.n),
     m = (0, r.useId)();
    return (
     c && (u = u.trim()),
     (0, s.jsx)(l.y$, {
      ...
      language: o || '',
      children: (e) => {
       let { style: o, tokens: l, getLineProps: r, getTokenProps: i } = e;
       return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', v ? `\u201c${v}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, s.jsx)(t.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': m, style: o, children: l.map((e, o) => (0, s.jsxs)('span', { ...r({ line: e }), children: [n && (0, s.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, o)) })] });
      },
     })
    );
   }
   ...
   const c = (0, a.createContext)({}),
    u = (e) => {
     ...
     const v = { do: 'Doen', dont: 'Niet doen' },
      m = p ? 'figure' : 'div',
      h = p ? 'figcaption' : 'div';
     return (0, d.jsxs)(m, { className: (0, i.Z)(s['nlds-guideline'], s[`nlds-guideline--${o}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(h, { className: (0, i.Z)(s['nlds-guideline__description']), children: ['dont' === o ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.nv, { className: (0, i.Z)(s['nlds-guideline__badge'], s[`nlds-guideline__badge--${o}`]), children: [(0, d.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: s['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: s['nlds-guideline__title'], children: v.dont })] }), (0, d.jsx)(r.nv, { children: n })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.nv, { className: (0, i.Z)(s['nlds-guideline__badge'], s[`nlds-guideline__badge--${o}`]), children: [(0, d.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: s['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: s['nlds-guideline__title'], children: v.do })] }), (0, d.jsx)(r.nv, { children: n })] }), a] }), (0, d.jsx)('div', { className: (0, i.Z)(s['nlds-guideline__example']), children: (0, d.jsx)(c.Provider, { value: { title: n, type: v[o] }, children: u }) })] });
    };
  },
  24785: (e, n, o) => {
   o.d(n, { Z: () => a, a: () => i });
