 ...
 [21907],
 {
  ...
  14881(e, n, t) {
   ...
   var i = t(13526),
    ...
    r = t(37168),
    d = t(86070);
   const a = (0, o.forwardRef)(({ as: e, className: n, children: t, ...o }, l) => {
     const r = e || 'div',
      a = (0, i.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, d.jsx)(r, { ref: l, className: a, ...o, children: t });
    }),
    s = ({ className: e, classNamePanel: n, label: t, heading: o, headingLevel: a, headingApperance: s, ...c }) => {
     const g = (0, i.A)('utrecht-accordion__section', e),
      h = (0, i.A)('utrecht-accordion__panel', n);
     return (0, d.jsxs)('details', { className: g, ...c, children: [(0, d.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, d.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, d.jsx)('span', { className: 'nl-button__icon-start', children: (0, d.jsx)(l.A, {}) }), (0, d.jsxs)('span', { className: 'nl-button__label', children: [o && (0, d.jsx)(r.D, { level: a, appearance: s, children: o }), t] })] }) }), (0, d.jsx)('div', { className: h, children: c.children })] });
    };
  },
  18439(e, n, t) {
   t.d(n, { R: () => r, x: () => d });
  ...
  28369(e, n, t) {
   ...
   function s({ lineNumber: e, syntax: n, textContent: t, trim: s }) {
    ...
    const { title: g, type: h } = (0, l.useContext)(r.x),
     v = (0, l.useId)();
    return (s && (c = c.trim()), (0, a.jsx)(o.f4, { theme: d, code: c, language: n || '', children: ({ style: n, tokens: t, getLineProps: o, getTokenProps: l }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: v, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', g ? ': ' : ' ', g] }), (0, a.jsx)(i.NG, { tabIndex: 0, role: g ? 'region' : void 0, 'aria-labelledby': v, style: n, children: t.map((n, t) => (0, a.jsxs)('span', { ...o({ line: n }), children: [e && (0, a.jsx)('span', { children: t + 1 }), n.map((e, n) => (0, a.jsx)('span', { ...l({ token: e }) }, n)), '\n'] }, t)) })] }) }));
   }
  },
  38953(e, n, t) {
   t.d(n, { H: () => f });
   var i = t(28369),
    ...
    j = t(46847),
    m = t(86070);
   const b = ({ children: e }) => (0, m.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(o.yo, { className: (0, l.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(o.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   b.displayName = 'ParagraphContainer';
   const k = ({ children: e }) => (0, m.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(o.yo, { className: (0, l.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   k.displayName = 'DocumentContainer';
   const x = ({ children: e }) => (0, m.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: e });
   x.displayName = 'SurfaceContainer';
   const f = globalThis.isAstro
    ? ({ language: e, className: n, code: t = '<p>No code provided</p>', rawCode: i, copyCode: o, defaultExpandedCode: r, designTokens: d }) => {
       const a = 'string' == typeof t ? t : i || '',
        s = 'string' == typeof t ? p().highlight(t, p().languages[e], e) : p().highlight(i || '', p().languages[e], e);
       return (0, m.jsxs)('div', { className: (0, l.A)('ma-canvas-astro', n), children: [(0, m.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: d, children: (0, m.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: a } }) }), (0, m.jsx)(u.n, { children: (0, m.jsxs)(u.K, { label: 'Code', open: r, children: [(0, m.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, m.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }), 'allow' === o && (0, m.jsx)(j.$, { 'data-copy-code': a, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: v = !0, children: p, container: u = 'document', language: j, designTokens: f }) => {
       const y = 'function' == typeof p ? p() : p,
        z = 'function' == typeof e ? e() : (0, g.isValidElement)(e) ? e : void 0,
        _ = 'string' == typeof e ? e : h.qV(z || y),
        [w, N] = (0, g.useState)(_),
        [C, A] = (0, g.useState)(t);
       (0, g.useEffect)(() => {
        (async () => {
         const e = await c.Ay.format(_, { parser: j, plugins: [r.A, d.Ay, a.Ay, s.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         N(e);
        })();
       }, [_]);
       const O = (0, g.useId)();
       let D = g.Fragment;
       return (
        'paragraph' === u ? (D = b) : 'document' === u ? (D = k) : 'surface' === u && (D = x),
        (0, m.jsxs)('div', {
         className: (0, l.A)('nlds-canvas'),
         children: [
          y && (0, m.jsx)('div', { className: (0, l.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(D, { children: (0, m.jsx)(o.v$, { children: y }) }) }) }),
          v &&
           (0, m.jsx)('div', {
          ...
          v &&
           (0, m.jsxs)('div', {
            ...
            hidden: !C,
            children: [
             (0, m.jsx)(i.M, { codeBlockLabel: 'Codevoorbeeld', syntax: j, textContent: w, trim: !0 }),
             n &&
              (0, m.jsx)('div', {
  ...
  56528(e, n, t) {
   ...
   const c = (0, a.createContext)({}),
    g = ({ title: e, appearance: n, description: t, children: a, figure: g }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      v = g ? 'figure' : 'div',
      p = g ? 'figcaption' : 'div',
      u = 'string' == typeof t ? (0, s.jsx)(d.oz, { components: { a: l.N_ }, children: t }) : t;
     return (0, s.jsxs)(v, { className: (0, r.A)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, s.jsxs)(p, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(l.fz, { className: (0, r.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, s.jsx)(o.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: h.dont })] }), (0, s.jsx)(l.fz, { children: e })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(l.fz, { className: (0, r.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, s.jsx)(i.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: h.do })] }), (0, s.jsx)(l.fz, { children: e })] }), u] }), (0, s.jsx)('div', { className: 'nlds-guideline__example', children: (0, s.jsx)(c.Provider, { value: { title: e, type: h[n] }, children: a }) })] });
    };
  },
  56672(e, n, t) {
   t.d(n, { Ay: () => d, RM: () => l });
