 ...
 [34799],
 {
  ...
  17889(e, n, t) {
   ...
   var j = t(35193),
    ...
    y = t(79532),
    w = t(30758);
   const A = { color: j.A, dimension: u.A, fontFamilies: x.A, fontSizes: k.A, fontWeights: b.A, lineHeights: f.A, other: v.A, textDecoration: y.A },
    D = ({ type: e }) => (0, g.jsx)(h.In, { children: (0, w.createElement)(A[e]) });
   function N({ tokens: e }) {
    const n = (0, s.kD)(e),
     t = (0, s.GT)(n),
       ...
       children: [
        ...
        (0, g.jsx)(i.BF, {
         children: t.map((n) => {
          const t = (0, s.o_)(n),
           o = (0, s.eQ)(e, n).$type;
          return (0, g.jsxs)(i.Hj, { children: [(0, g.jsx)(i.nA, { children: (0, g.jsx)(r.C, { children: (0, g.jsx)(i.kf, { children: t }) }) }), (0, g.jsx)(i.nA, { children: (0, g.jsxs)(a.K, { children: [(0, g.jsx)(D, { type: o }), ' ', o] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  28339(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => L, component: () => P, contentTitle: () => T, default: () => V, description: () => R, frontMatter: () => _, issueNumber: () => M, metadata: () => r, title: () => C, toc: () => F }));
   ...
   const u = [
     ...
     { title: 'Als een paragraaftekst in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: j.Ay, tags: ['developer', 'contentmaker'] },
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => a, KF: () => h, mJ: () => j, VZ: () => A, cR: () => w, Pv: () => u, qZ: () => i, kD: () => f, B2: () => g, Pc: () => l, f4: () => o, GT: () => v, fX: () => s, eQ: () => b, B_: () => k, o_: () => x, Rc: () => y });
