(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [45403],
 {
  ...
  21034(e, n, a) {
   ...
   const k = ({ component: e, headingLevel: n }) => {
               ...
               d.Z,
               {
                ...
                description: (0, m.jsxs)('div', {
                 ...
                 children: [
                  ...
                  (0, m.jsxs)('div', {
                   children: [
                    (h.length > 0 || u.length > 0) && (0, m.jsx)(s.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    h.length > 0 &&
                     (0, m.jsx)(t.dk, {
                      links: h
                  ...
                  u.length > 0 && u.map(({ frameworkName: e, tasks: a }) => (0, m.jsxs)('section', { children: [(0, m.jsxs)(s.DZ, { level: Math.min(n + 2, 6), children: [l, ' in ', e] }), (0, m.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, m.jsx)(r.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               o.Zp,
               {
                ...
                children: (0, m.jsxs)(o.Wu, {
                 children: [
                  ...
                  (h.length > 0 || u.length > 0) && (0, m.jsx)(t.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  h.length > 0 &&
                   (0, m.jsx)(m.Fragment, {
                  ...
                  u.length > 0 && (0, m.jsx)(m.Fragment, { children: u.map(({ frameworkName: e, tasks: a }) => (0, m.jsxs)(m.Fragment, { children: [(0, m.jsxs)(t.DZ, { level: n + 2, children: [l, ' in ', e] }), (0, m.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, m.jsx)(r.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    N = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(p.p, { level: n, suffix: s && (0, m.jsx)(h.D, { state: s }), children: e.title }), (0, m.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(s) && (0, m.jsx)(v.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    F = ({ component: e }) => {
     const n = (e && b[e.title]) || [];
   ...
   const l = ({ background: e, children: n, className: a, ...t }) => (0, i.jsx)('div', { className: (0, s.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, a), ...t, children: n }),
    ...
    o = ({ href: e, appearance: n, className: a, component: l = 'div', background: r, children: o }) => {
     const d = (e) => ('article' === l ? (0, i.jsx)('article', { ...e }) : 'section' === l ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      u = (0, i.jsx)(d, { className: (0, s.A)('ma-cardgroup__card', r && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, a), children: o });
  ...
  32385(e, n, a) {
   'use strict';
   a.d(n, { bo: () => s, KF: () => m, mJ: () => p, VZ: () => D, cR: () => T, Pv: () => x, qZ: () => l, kD: () => v, QQ: () => F, B2: () => c, Pc: () => o, f4: () => r, GT: () => k, fX: () => i, eQ: () => j, B_: () => b, o_: () => f });
  ...
  38713(e, n, a) {
   'use strict';
   (a.r(n), a.d(n, { assets: () => u, component: () => x, componentName: () => p, contentTitle: () => d, default: () => j, description: () => m, frontMatter: () => o, issueNumber: () => c, metadata: () => t, relayStep: () => h, title: () => g, toc: () => f }));
   ...
   const o = { title: 'Pull Quote', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Pull Quote', pagination_label: 'Pull Quote', description: 'Illustratie met een citaat uit de hoofdtekst.', issue_number: 443, slug: '/pull-quote', keywords: ['pull quote', 'citaat', 'callout', 'streamer'] },
    ...
    u = {},
    g = 'Pull Quote',
    m = 'Illustratie met een citaat uit de hoofdtekst.',
    c = 443,
    h = 'help wanted',
    p = 'pull-quote',
   ...
   function b(e) {
    const n = { h2: 'h2', p: 'p', ...(0, i.R)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, s.jsx)(r.Fc, { component: x, headingLevel: 1, description: m }), '\n', (0, s.jsx)(n.p, { children: 'Ook bekend als: Streamer.' }), '\n', (0, s.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, s.jsx)(r.VK, { component: x, headingLevel: 3 }), '\n', (0, s.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, s.jsx)(r.mu, { component: x, headingLevel: 3 }), '\n', (0, s.jsx)(r.K_, { component: x }), '\n', (0, s.jsx)(r.$9, { component: x, headingLevel: 2 })] });
   }
   function j(e = {}) {
  ...
  40889(e, n, a) {
   ...
   var t = a(29181),
    ...
    o = a(83386),
    d = a(86070);
   const u = { figma: (0, d.jsx)(s.A, {}), github: (0, d.jsx)(i.A, {}), npm: (0, d.jsx)(l.A, {}), storybook: (0, d.jsx)(r.A, {}) },
  ...
  51582(e, n, a) {
   ...
   const l = (e, n) => {
    ...
    u = ({ children: e, omitH1: n = !1, headingLevel: a = 1, baseUrl: s = '', components: l = {} }) => (0, i.jsx)(t.x, { components: { ...d(n, a), ...o(s), ...l }, children: e });
  },
  59292(e, n, a) {
   'use strict';
   a.d(n, { f: () => t.f });
  ...
  70348(e, n, a) {
   ...
   const o = (0, s.forwardRef)(({ as: e, className: n, children: a, ...s }, i) => {
    ...
    d = ({ className: e, classNamePanel: n, label: a, heading: s, headingLevel: o, headingApperance: d, ...u }) => {
     const g = (0, t.A)('utrecht-accordion__section', e),
      m = (0, t.A)('utrecht-accordion__panel', n);
     return (0, r.jsxs)('details', { className: g, ...u, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(i.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [s && (0, r.jsx)(l.D, { level: o, appearance: d, children: s }), a] })] }) }), (0, r.jsx)('div', { className: m, children: u.children })] });
    };
  },
  82839(e, n, a) {
