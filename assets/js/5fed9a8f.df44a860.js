 ...
 [9244],
 {
  ...
  73460: (e, n, r) => {
   ...
   const v = (e) => {
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (D = await d.ZP.format(N, { parser: y, plugins: [t.Z, o.ZP, s.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), S(D);
     })();
    }, [N]);
    const Z = (0, c.useId)();
    let B = c.Fragment;
    return (
     "paragraph" === f ? (B = j) : "document" === f ? (B = g) : "surface" === f && (B = b),
     (0, p.jsxs)("div", {
      className: (0, l.Z)(m["nlds-canvas"]),
      children: [
       w && (0, p.jsx)("div", { className: (0, l.Z)(m["nlds-canvas__example"]), children: (0, p.jsx)("div", { className: "voorbeeld-theme", style: _, children: (0, p.jsx)(B, { children: (0, p.jsx)(i.pu, { children: w }) }) }) }),
       x &&
        (0, p.jsx)("div", {
