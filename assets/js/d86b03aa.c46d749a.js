 ...
 [2990],
 {
   ...
   const d = (0, a.createContext)({}),
    m = ({ title: e, appearance: n, description: l, children: a, figure: m }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      p = m ? 'figure' : 'div',
      u = m ? 'figcaption' : 'div',
      g = 'string' == typeof l ? (0, i.jsx)(c.oz, { components: { a: s.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   var o = l(13526),
    ...
    r = l(37168),
    c = l(86070);
   const a = (0, t.forwardRef)(({ as: e, className: n, children: l, ...t }, s) => {
     const r = e || 'div',
      a = (0, o.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, c.jsx)(r, { ref: s, className: a, ...t, children: l });
    }),
    i = ({ className: e, classNamePanel: n, label: l, heading: t, headingLevel: a, headingApperance: i, ...d }) => {
     const m = (0, o.A)('utrecht-accordion__section', e),
      h = (0, o.A)('utrecht-accordion__panel', n);
     return (0, c.jsxs)('details', { className: m, ...d, children: [(0, c.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, c.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, c.jsx)('span', { className: 'nl-button__icon-start', children: (0, c.jsx)(s.A, {}) }), (0, c.jsxs)('span', { className: 'nl-button__label', children: [t && (0, c.jsx)(r.D, { level: a, appearance: i, children: t }), l] })] }) }), (0, c.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => b });
   ...
   const b = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const o = 'function' == typeof e ? e() : e,
        ...
        r = u().highlight(t, u().languages[n], n);
       return (0, v.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', l), children: [(0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: t } }), (0, v.jsx)(g.n, { children: (0, v.jsx)(g.K, { label: 'Code', children: (0, v.jsx)('pre', { className: 'language-html nl-code-block', children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: p = !0, children: u, container: g = 'document', language: b, designTokens: f }) => {
       ...
       let R = m.Fragment;
       return (
        'paragraph' === g ? (R = j) : 'document' === g ? (R = x) : 'surface' === g && (R = y),
        (0, v.jsxs)('div', {
         className: (0, s.A)('nlds-canvas'),
         children: [
          _ && (0, v.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, v.jsx)(R, { children: (0, v.jsx)(t.v$, { children: _ }) }) }) }),
          p &&
           (0, v.jsx)('div', {
