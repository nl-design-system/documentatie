/*! For license information please see 51040.3f05d0f9.js.LICENSE.txt */
'use strict';
 ...
 [51040],
 {
  ...
  5784(e, n, t) {
   ...
   var i = t(30758),
    ...
    l = t(69914),
    a = t(88014);
   const r = 'details_zu1M',
    c = 'isBrowser_ldlA',
    d = 'collapsibleContent_T_Y9';
   var u = t(86070);
   function h(e) {
    return !!e && ('SUMMARY' === e.tagName || h(e.parentElement));
   }
   function m(e, n) {
    return !!e && (e === n || m(e.parentElement, n));
   }
   function f({ summary: e, children: n, ...t }) {
    (0, s.A)().collectAnchor(t.id);
    const f = (0, l.A)(),
     p = (0, i.useRef)(null),
     { collapsed: x, setCollapsed: v } = (0, a.u)({ initialState: !t.open }),
     [j, g] = (0, i.useState)(t.open),
     A = i.isValidElement(e) ? e : (0, u.jsx)('summary', { children: e ?? 'Details' });
    return (0, u.jsxs)('details', {
     ...t,
     ref: p,
     open: j,
     'data-collapsed': x,
     className: (0, o.A)(r, f && c, t.className),
     onMouseDown: (e) => {
      h(e.target) && e.detail > 1 && e.preventDefault();
     },
     onClick: (e) => {
      e.stopPropagation();
      const n = e.target;
      h(n) && m(n, p.current) && (e.preventDefault(), x ? (v(!1), g(!0)) : v(!0));
     },
     children: [
      A,
      (0, u.jsx)(a.N, {
       ...
       children: (0, u.jsx)('div', { className: d, children: n }),
      }),
     ],
    });
   }
   ...
   function x({ ...e }) {
    return (0, u.jsx)(f, { ...e, className: (0, o.A)('alert alert--info', p, e.className) });
   }
  },
  18439(e, n, t) {
   t.d(n, { R: () => l, x: () => a });
  ...
  76713(e, n, t) {
   ...
   var l = t(13526),
    a = t(18236),
    r = t(71639);
   const c = 'admonition_raOx',
    d = 'admonitionHeading_LcOG',
    u = 'admonitionIcon_RjEs',
    h = 'admonitionContent_HpCY';
   ...
   const j = { icon: (0, o.jsx)(v, {}), title: (0, o.jsx)(a.A, { id: 'theme.admonition.note', description: 'The default label used for the Note admonition (:::note)', children: 'note' }) };
   function g(e) {
    return (0, o.jsx)(x, { ...j, ...e, className: (0, l.A)('alert alert--secondary', e.className), children: e.children });
   }
   function A(e) {
    return (0, o.jsx)('svg', { viewBox: '0 0 12 16', ...e, children: (0, o.jsx)('path', { fillRule: 'evenodd', d: 'M6.5 0C3.48 0 1 2.19 1 5c0 .92.55 2.25 1 3 1.34 2.25 1.78 2.78 2 4v1h5v-1c.22-1.22.66-1.75 2-4 .45-.75 1-2.08 1-3 0-2.81-2.48-5-5.5-5zm3.64 7.48c-.25.44-.47.8-.67 1.11-.86 1.41-1.25 2.06-1.45 3.23-.02.05-.02.11-.02.17H5c0-.06 0-.13-.02-.17-.2-1.17-.59-1.83-1.45-3.23-.2-.31-.42-.67-.67-1.11C2.44 6.78 2 5.65 2 5c0-2.2 2.02-4 4.5-4 1.22 0 2.36.42 3.22 1.19C10.55 2.94 11 3.94 11 5c0 .66-.44 1.78-.86 2.48zM4 14h5c-.23 1.14-1.3 2-2.5 2s-2.27-.86-2.5-2z' }) });
   }
   const w = { icon: (0, o.jsx)(A, {}), title: (0, o.jsx)(a.A, { id: 'theme.admonition.tip', description: 'The default label used for the Tip admonition (:::tip)', children: 'tip' }) };
   function y(e) {
    return (0, o.jsx)(x, { ...w, ...e, className: (0, l.A)('alert alert--success', e.className), children: e.children });
   }
   function N(e) {
   ...
   const z = { icon: (0, o.jsx)(C, {}), title: (0, o.jsx)(a.A, { id: 'theme.admonition.warning', description: 'The default label used for the Warning admonition (:::warning)', children: 'warning' }) };
   function b(e) {
    return (0, o.jsx)('svg', { viewBox: '0 0 12 16', ...e, children: (0, o.jsx)('path', { fillRule: 'evenodd', d: 'M5.05.31c.81 2.17.41 3.38-.52 4.31C3.55 5.67 1.98 6.45.9 7.98c-1.45 2.05-1.7 6.53 3.53 7.7-2.2-1.16-2.67-4.52-.3-6.61-.61 2.03.53 3.33 1.94 2.86 1.39-.47 2.3.53 2.27 1.67-.02.78-.31 1.44-1.13 1.81 3.42-.59 4.78-3.42 4.78-5.56 0-2.84-2.53-3.22-1.25-5.61-1.52.13-2.03 1.13-1.89 2.75.09 1.08-1.02 1.8-1.86 1.33-.67-.41-.66-1.19-.06-1.78C8.18 5.31 8.68 2.45 5.05.32L5.03.3l.02.01z' }) });
   }
   const _ = { icon: (0, o.jsx)(b, {}), title: (0, o.jsx)(a.A, { id: 'theme.admonition.danger', description: 'The default label used for the Danger admonition (:::danger)', children: 'danger' }) };
   ...
   const E = {
    ...{
     ...
     info: k,
     warning: function (e) {
      return (0, o.jsx)(x, { ...z, ...e, className: (0, l.A)('alert alert--warning', e.className), children: e.children });
     },
     danger: function (e) {
    ...
    ...{
     ...
     success: (e) => (0, o.jsx)(y, { title: 'success', ...e }),
     caution: function (e) {
   ...
   function H(e) {
    const n = s(e),
     t = ((i = n.type), E[i] || (console.warn(`No admonition component found for admonition type "${i}". Using Info as fallback.`), E.info));
    var i;
    return (0, o.jsx)(t, { ...n });
   }
  },
