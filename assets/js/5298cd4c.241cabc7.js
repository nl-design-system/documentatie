...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [15879],
 {
  18439(e, n, t) {
   ...
   function s(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(r) : e.components || r) : o(e.components)), a.createElement(i.Provider, { value: n }, e.children));
   }
  },
  63986(e, n, t) {
   (t.r(n), t.d(n, { assets: () => p, contentTitle: () => d, default: () => c, frontMatter: () => s, metadata: () => a, toc: () => l }));
   const a = JSON.parse('{"id":"handboek/developer/infrastructuur/pnpm","title":"Werken met pnpm","description":"Werken met pnpm","source":"@site/docs/handboek/developer/05-infrastructuur/06-pnpm.mdx","sourceDirName":"handboek/developer/05-infrastructuur","slug":"/handboek/developer/pnpm/","permalink":"/handboek/developer/pnpm/","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/handboek/developer/05-infrastructuur/06-pnpm.mdx","tags":[],"version":"current","sidebarPosition":6,"frontMatter":{"title":"Werken met pnpm","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Werken met pnpm","pagination_label":"Werken met pnpm","description":"Werken met pnpm","slug":"/handboek/developer/pnpm/","keywords":["developer","pnpm"]},"sidebar":"handboek","previous":{"title":"Werken met Node.js","permalink":"/handboek/developer/node/"},"next":{"title":"Security audit voor npm","permalink":"/pnpm-audit"}}');
   var r = t(86070),
    i = t(18439),
    o = t(76097);
   const s = { title: 'Werken met pnpm', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Werken met pnpm', pagination_label: 'Werken met pnpm', description: 'Werken met pnpm', slug: '/handboek/developer/pnpm/', keywords: ['developer', 'pnpm'] },
    d = 'Werken met pnpm',
    p = {},
    l = [
  ...
  76097(e, n, t) {
   t.d(n, { bo: () => r, KF: () => c, mJ: () => k, VZ: () => x, cR: () => A, Pv: () => h, qZ: () => o, kD: () => j, B2: () => u, Pc: () => d, f4: () => s, GT: () => _, fX: () => i, eQ: () => f, B_: () => v, o_: () => b });
   ...
   const m = (e) => [...e].sort((e, n) => p.indexOf(e) - p.indexOf(n)),
    c = (e) => {
    ...
    g = (e) => {
     const n = / URL \(([^)]+)\)/;
     return m(l(e.tasks.filter(({ name: e, value: t }) => '' !== t && n.test(e)).map(({ name: e }) => n.exec(e)?.[1])));
    },
    k = (e) => m(l(e.projects.flatMap((e) => g(e)))),
    h = (e) => {
     const n = g(e),
      t = ((e) => {
