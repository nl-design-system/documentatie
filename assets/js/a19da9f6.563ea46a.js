...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [97118],
 {
  ...
  68135: (e, n, t) => {
   ...
   const a = { title: 'Kleurgebruik \xb7 Content \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Kleurgebruik', pagination_label: 'Kleurgebruik', description: 'Voldoende contrast zorgt ervoor dat teksten goed leesbaar zijn. Ook wanneer iemand slechtziend is of als de zon op je smartphone schijnt.', slug: '/richtlijnen/content/tekstopmaak/kleurgebruik', keywords: ['tekstopmaak', 'kleurgebruik', 'kleurcontrast'] },
    ...
    u = [
     ...
     { value: 'Grafieken', id: 'grafieken', level: 2 },
     { value: 'Voorbeeld van kleurgebruik in een grafiek', id: 'voorbeeld-van-kleurgebruik-in-een-grafiek', level: 3 },
  ...
  43599: (e, n, t) => {
   ...
   const h = (e) => {
    let { children: n } = e;
    return (0, g.jsx)(l.Tg, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(l.BB, { className: (0, o.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(l.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   h.displayName = 'ParagraphContainer';
   const p = (e) => {
    let { children: n } = e;
    return (0, g.jsx)(l.Tg, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(l.BB, { className: (0, o.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const j = (e) => {
    let { code: n, copy: t = !0, defaultExpandedCode: j = !1, displayCode: b = !0, children: v, container: x = 'document', language: f, designTokens: y } = e;
    ...
    (0, k.useEffect)(() => {
     (async () => {
      const e = await c.ZP.format(z, { parser: f, plugins: [s.Z, i.ZP, a.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [z]);
    const K = (0, k.useId)();
    let G = k.Fragment;
    return (
     'paragraph' === x ? (G = h) : 'document' === x ? (G = p) : 'surface' === x && (G = m),
     (0, g.jsxs)('div', {
      className: (0, o.Z)('nlds-canvas'),
      children: [
       _ && (0, g.jsx)('div', { className: (0, o.Z)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, g.jsx)(G, { children: (0, g.jsx)(l.pu, { children: _ }) }) }) }),
       b &&
        (0, g.jsx)('div', {
       ...
       b &&
        (0, g.jsxs)('div', {
         ...
         hidden: !Z,
         children: [
          (0, g.jsx)(r.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: C, trim: !0 }),
          t &&
           (0, g.jsx)('div', {
  ...
  41179: (e, n, t) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: t, textContent: d, trim: c } = e,
     k = d;
    const { title: u, type: g } = (0, o.useContext)(s.n),
     h = (0, o.useId)();
    return (
     c && (k = k.trim()),
     (0, a.jsx)(l.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', g ? `\u201c${g}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, a.jsx)(r.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': h, style: t, children: l.map((e, t) => (0, a.jsxs)('span', { ...o({ line: e }), children: [n && (0, a.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
