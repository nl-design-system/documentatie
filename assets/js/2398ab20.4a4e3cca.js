...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [66018],
 {
  ...
  35636(e, n, t) {
   (t.r(n), t.d(n, { assets: () => c, contentTitle: () => d, default: () => f, frontMatter: () => r, metadata: () => o, toc: () => p }));
   ...
   var i = t(86070),
    ...
    a = t(59246),
    l = t(94291);
   const r = { title: '5. Testfase \xb7 Hall of Fame stappenplan \xb7 Component bijdragen \xb7 Handboek', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '5. Testfase', sidebar_position: 5, pagination_label: '5. Testfase', description: 'Stappen voor de Testfase van de Definition of Done voor Hall of Fame', slug: '/handboek/estafettemodel/componenten/hall-of-fame/testfase', keywords: ['componenten', 'design system', 'estafettemodel', 'definition of done', 'hall of fame'] },
    d = 'Testfase voor Hall of Fame componenten',
    c = {},
    p = [{ value: 'Richtlijnen getest', id: 'richtlijnen-getest', level: 2 }, { value: 'Doel', id: 'doel', level: 3 }, ...a.RM, { value: 'Uitkomst', id: 'uitkomst', level: 3 }, { value: 'Baseline getest', id: 'baseline-getest', level: 2 }, { value: 'Doel', id: 'doel-1', level: 3 }, ...l.RM, { value: 'Uitkomst', id: 'uitkomst-1', level: 3 }];
   function m(e) {
