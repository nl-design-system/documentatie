 ...
 [49159],
 {
  ...
  41757: (e, n, r) => {
   ...
   const s = (e) => {
    ...
    return (0, i.jsxs)('hgroup', { className: (0, t.Z)('nlds-inline-heading-group', `utrecht-heading-${s}`, r), ...l, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: n }), o && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
   };
  },
  57716: (e, n, r) => {
   r.d(n, { U: () => c });
   ...
   const o = (e, n) => {
    ...
    a = (e) => ({
     img: (n) => {
      let { src: r, ...t } = n;
      return (0, s.jsx)('img', { ...t, src: o(e, r), className: 'utrecht-img utrecht-img--fit' });
     },
    }),
    d = (e, n) => {
     if (e) {
    ...
    c = (e) => {
     let { children: n, omitH1: r = !1, headingLevel: i = 1, baseUrl: o = '', components: l = {} } = e;
     return (0, s.jsx)(t.Z, { components: { ...d(r, i), ...a(o), ...l }, children: n });
    };
  },
  46364: (e, n, r) => {
   r.d(n, { j: () => o });
   ...
   const o = (e) => {
    ...
    return (0, s.jsx)(i.V, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: r && (0, s.jsx)(t.Ou, { className: 'nlds-inline-heading-group__badge', children: r }), ...o, children: n });
   };
  },
  87118: (e, n, r) => {
   r.d(n, { Z: () => l, a: () => o });
