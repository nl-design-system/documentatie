  ...
  75812(e, s, i) {
   ...
   const o = ({ listId: e = '', laPostaId: s = '', thanksPage: i = '', emailFieldId: o = '', firstNameFieldId: c = '', orgId: m = '', interestsId: u = '', interestsLegend: h = 'Waar wil je NL Design System voor gebruiken?', interests: p = [], interestsRequired: g = !1, disallowedInterestValues: y = [], workAreasId: j = '', privacyPolicyId: x = '', language: f, submitText: v = '', talkTitleId: k = '', talkDescriptionId: b = '', roleId: w = '', roleLegend: S = 'Wat is jouw rol?', roles: D = [], roleRequired: W = !1 }) => {
    ...
    return (0, d.jsxs)('form', {
     ...
     children: [(0, d.jsxs)(t.zB, { type: 'email', children: [(0, d.jsx)(n.f, { children: (0, d.jsx)(t.lR, { htmlFor: `id-${o}`, children: R ? 'Email address ' : 'E-mailadres' }) }), $[o] && (0, d.jsx)(t.YB, { children: $[o].message }), (0, d.jsx)(n.f, { children: (0, d.jsx)(t.Rj, { id: `id-${o}`, name: o, type: 'email', autoComplete: 'email', defaultValue: F, 'aria-required': 'true', ..._(`${o}`, { required: { value: !0, message: R ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' }, pattern: { value: /\S+@\S+\.\S+/, message: R ? 'This is not a valid email address.' : 'Dit is geen correct emailadres.' } }), invalid: !!$[o] }) })] }), (0, d.jsxs)(t.zB, { type: 'text', children: [(0, d.jsx)(n.f, { children: (0, d.jsx)(t.lR, { htmlFor: c, children: R ? 'Name' : 'Naam' }) }), $[c] && (0, d.jsx)(t.YB, { children: $[c].message }), (0, d.jsx)(n.f, { children: (0, d.jsx)(t.Rj, { id: c, name: c, type: 'text', defaultValue: q, autoComplete: 'given-name', 'aria-required': 'true', ..._(`${c}`, { required: { value: !0, message: R ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' } }), invalid: !!$[c] }) })] }), k && (0, d.jsxs)(t.zB, { type: 'text', children: [(0, d.jsxs)(n.f, { children: [(0, d.jsx)(t.lR, { htmlFor: k, children: R ? 'Title of your talk' : 'Titel van je presentatie' }), (0, d.jsx)(t.JM, { children: R ? 'What would you name your talk?' : 'Hoe zou jij je presentatie noemen?' })] }), (0, d.jsx)(n.f, { children: (0, d.jsx)(t.Rj, { id: k, name: k, ..._(k, { required: { value: !0, message: R ? 'You can only submit a talk if you provide a title.' : 'Je kunt alleen een voorstel insturen als je een titel toevoegd.' } }) }) })] }), b && (0, d.jsxs)(t.zB, { type: 'text', children: [(0, d.jsxs)(n.f, { children: [(0, d.jsx)(t.lR, { htmlFor: b, children: R ? 'Descibe your talk' : 'Beschrijf je presentatie' }), (0, d.jsx)(t.JM, { children: R ? 'What is it about? Who would be your intended audience? Have you spoken about this topic before?' : 'Waar gaat het over? Voor wie is het interessant? Heb je al vaker over dit onderwerp gesproken?' })] }), (0, d.jsx)(n.f, { children: (0, d.jsx)(t.TM, { id: b, name: b, rows: 12, ..._(b, { required: { value: !0, message: R ? 'You can only submit a talk if you provide a description.' : 'Je kunt alleen een voorstel insturen als je een beschrijving toevoegd.' } }) }) })] }), m && (0, d.jsxs)(t.zB, { type: 'text', children: [(0, d.jsx)(n.f, { children: (0, d.jsx)(t.lR, { htmlFor: m, children: R ? 'Organisation (not required)' : 'Organisatie (niet verplicht)' }) }), $[m] && (0, d.jsx)(t.YB, { children: $[m].message }), (0, d.jsx)(n.f, { children: (0, d.jsx)(t.Rj, { id: m, name: m, type: 'text' }) })] }), u && (0, d.jsxs)(t.LB, { children: [(0, d.jsx)(n.f, { children: (0, d.jsxs)(t.u4, { children: [h, !g && ' (niet verplicht)'] }) }), (0, d.jsx)(t.JM, { children: 'Meerdere antwoorden mogelijk.' }), p.map((e, s) => (0, d.jsxs)(t.zB, { type: 'checkbox', children: [(0, d.jsx)(t.Sc, { name: `${u}[]`, value: z[s], id: `${u}-${z[s]}` }), (0, d.jsx)(t.lR, { type: 'checkbox', htmlFor: `${u}-${z[s]}`, children: e })] }, e))] }), w && (0, d.jsxs)(t.LB, { children: [(0, d.jsx)(n.f, { children: (0, d.jsxs)(t.u4, { children: [S, !W && ' (niet verplicht)'] }) }), (0, d.jsx)(t.JM, { children: 'Meerdere antwoorden mogelijk.' }), D.map((e, s) => (0, d.jsxs)(t.zB, { type: 'checkbox', children: [(0, d.jsx)(t.Sc, { name: `${w}[]`, id: `${w}-${s}` }), (0, d.jsx)(t.lR, { type: 'checkbox', htmlFor: `${w}-${s}`, children: e })] }, e))] }), j && (0, d.jsxs)(t.zB, { type: 'text', children: [(0, d.jsxs)(n.f, { children: [(0, d.jsx)(t.lR, { htmlFor: j, children: 'Aan wat voor projecten werk je? (niet verplicht)' }), (0, d.jsx)(t.JM, { children: 'Denk aan mijn-omgevingen, formulieren en/of kaarten.' })] }), (0, d.jsx)(n.f, { children: (0, d.jsx)(t.TM, { id: j, name: j }) })] }), x && (0, d.jsxs)(t.zB, { type: 'text', children: [(0, d.jsx)(t.JM, { id: `${x}-description`, children: R ? (0, d.jsxs)('p', { className: 'nl-paragraph', children: ['The', ' ', (0, d.jsx)('a', { className: 'nl-link', href: '/privacy-policy/', children: 'privacy policy' }), ' ', 'of NL Design System applies to our activities.'] }) : (0, d.jsxs)('p', { className: 'nl-paragraph', children: ['Op onze activiteiten is de', ' ', (0, d.jsx)('a', { className: 'nl-link', href: '/privacyverklaring/', children: 'privacyverklaring van NL Design System' }), ' ', 'van toepassing.'] }) }), (0, d.jsxs)(t.zB, { type: 'checkbox', children: [(0, d.jsx)(t.Sc, { value: '1', id: `${x}-1`, 'aria-describedby': `${x}-description`, 'aria-required': 'true', ..._(`${x}[]`, { required: { value: !0, message: R ? 'You can only register if you agree with the privacy policy.' : 'Je kunt je alleen aanmelden als je akkoord gaat met de privacyverklaring.' } }), invalid: !!$[`${x}[]`] }), (0, d.jsx)(t.lR, { type: 'checkbox', htmlFor: `${x}-1`, children: R ? 'I agree to the use of my data in accordance with the privacy policy' : 'Ik ga akkoord met het gebruik van mijn gegevens volgens de privacyverklaring' })] }), $[x] && (0, d.jsx)(t.YB, { children: $[x].message })] }), f?.id && (0, d.jsx)('input', { type: 'hidden', name: f.id, value: f.value }), (0, d.jsx)(t.e2, { children: (0, d.jsx)(t.$n, { type: 'submit', appearance: 'primary-action-button', children: v || (R ? 'Sign up' : 'Aanmelden') }) }), (0, d.jsx)('input', { type: 'hidden', name: 'next', value: i }), (0, d.jsx)('input', { type: 'hidden', name: 'a', value: s }), (0, d.jsx)('input', { type: 'hidden', name: 'l', value: e }), (0, d.jsx)('input', { name: 'osnD9cWRI3', autoComplete: 'on', id: 'id-osnD9cWRI3', type: 'hidden', value: 'NLDS website' }), (0, d.jsx)('input', { autoComplete: 'new-password', type: 'email', id: 'email', name: 'email', placeholder: 'Your e-mail here', className: 'sr-only ma-sr-only', 'aria-hidden': 'true', tabIndex: -1 })],
    });
   };
  },
 },
