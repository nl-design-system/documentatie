 ...
 [70767],
 {
  12761(e, n, r) {
   ...
   const x = ({ className: e, ...n }) => {
     const r = (0, i.A)('ma-utrecht-accordion', 'utrecht-accordion', e);
     return (0, d.jsx)('div', { className: r, children: n.children });
    },
    b = ({ className: e, ...n }) => {
     const r = (0, i.A)('utrecht-accordion__section', e);
     return (0, d.jsxs)('details', { className: r, ...n, children: [(0, d.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, d.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, d.jsx)('span', { className: 'nl-button__icon-start', children: (0, d.jsx)(j.A, {}) }), (0, d.jsx)('span', { className: 'nl-button__label', children: (0, d.jsx)(f.D, { level: n.headingLevel, appearance: n.headingApperance, children: n.heading }) })] }) }), (0, d.jsx)('div', { className: 'utrecht-accordion__panel', children: n.children })] });
    },
    v = ({ component: e, headingLevel: n }) => {
     const r = e && e.projects.filter((e) => p.f4.includes(e.id)),
      a = r && p.f4.map((e) => r.find((n) => n.id === e)).filter(Boolean);
     return e && (0, d.jsx)(x, { children: a.map((r) => (0, d.jsx)(b, { className: (0, i.A)('ma-definition-of-done', r && `ma-definition-of-done--${(0, p.fX)(r.title)}`), heading: r ? `${r.title} - ${r.progress.value} van ${r.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m._, { children: r.tasks.map(({ checked: e, name: r, id: t }) => (0, d.jsx)(m.Z, { headingLevel: n + 1, checked: e, heading: r, description: (0, p.qZ)(t) }, t)) }), (0, d.jsx)(t.fz, { children: (0, d.jsxs)(t.N_, { href: `${r.url}?filterQuery=${e.title}`, children: [r.title, ' projectbord op GitHub'] }) })] }) }, r.title)) });
    },
    ...
    w = ({ component: e, headingLevel: n, description: r }) => {
  ...
  69609(e, n, r) {
   (r.r(n), r.d(n, { assets: () => H, component: () => M, contentTitle: () => T, default: () => G, description: () => C, frontMatter: () => L, issueNumber: () => _, metadata: () => t, title: () => R, toc: () => B }));
