 ...
 [94368],
 {
  79698: (e, t, n) => {
   ...
   var a = n(75271),
    ...
    c = n(55510),
    u = n(52945);
   const h = { backToTopButton: 'backToTopButton_bwq8', backToTopButtonShow: 'backToTopButtonShow_SIHd' };
   var b = n(52676);
   function m() {
   ...
   var T = n(88594),
    Z = n(89265),
    w = n(92223),
    L = (0, v.Z)('outline', 'chevron-down', 'IconChevronDown', [['path', { d: 'M6 9l6 6l6 -6', key: 'svg-0' }]]),
    A = (0, v.Z)('outline', 'chevron-up', 'IconChevronUp', [['path', { d: 'M6 15l6 -6l6 6', key: 'svg-0' }]]),
    M = n(93706);
   function B(e) {
   ...
   var F = n(62827),
    P = n(74331);
   const R = { menuExternalLink: 'menuExternalLink_NnFM' };
   function V(e) {
    let { item: t, onItemClick: n, activePath: a, level: o, index: l, ...d } = e;
    const { href: c, label: u, className: h, autoAddBaseUrl: m } = t,
     p = (0, r._F)(t, a),
     x = (0, F.Z)(c);
    return (0, b.jsx)('li', { className: (0, i.Z)(s.k.docs.docSidebarItemLink, s.k.docs.docSidebarItemLinkLevel(o), 'menu__list-item', h), children: (0, b.jsxs)(T.Z, { className: (0, i.Z)('menu__link', !x && R.menuExternalLink, { 'menu__link--active': p }, 'utrecht-link'), autoAddBaseUrl: m, 'aria-current': p ? 'page' : void 0, to: c, ...(x && { onClick: n ? () => n(t) : void 0 }), ...d, children: [u, !x && (0, b.jsx)(P.Z, {})] }) }, u);
   }
   function D(e) {
    let { item: t, ...n } = e;
    switch (t.type) {
   ...
   function X(e) {
    ...
    return (0, b.jsx)('nav', { 'aria-label': (0, d.I)({ id: 'theme.docs.sidebar.navAriaLabel', message: 'Docs sidebar', description: 'The ARIA label for the sidebar navigation' }), className: (0, i.Z)('menu thin-scrollbar', Y.menu, r && Y.menuWithAnnouncementBar, o), children: (0, b.jsx)('ul', { className: (0, i.Z)(s.k.docs.docSidebarMenu, 'menu__list'), children: (0, b.jsx)(U, { items: n, activePath: t, level: 1 }) }) });
   }
   ...
   function J(e) {
    ...
    const {
     ...
     d = (0, a.useId)();
    return (0, b.jsxs)('div', { className: (0, i.Z)(G.sidebar, r && G.sidebarWithHideableNavbar, s && G.sidebarHidden, l && G.sidebarWithNavbar), children: [(0, b.jsx)(M.zx, { appearance: 'subtle-button', onClick: o, className: (0, i.Z)(G['sidebar__toggle-button'], s && G['sidebar__toggle-button--icon-only']), 'aria-controls': d, 'aria-label': s ? 'Toon sidebar' : 'Verberg sidebar', 'aria-expanded': !s, children: s ? (0, b.jsx)(b.Fragment, { children: (0, b.jsx)(f, {}) }) : (0, b.jsxs)(b.Fragment, { children: [(0, b.jsx)(k, {}), ' Verberg'] }) }), (0, b.jsx)('div', { id: d, 'aria-expanded': !s, className: (0, i.Z)(G.sidebar__content, s && G['sidebar__content--hidden']), children: (0, b.jsx)(X, { path: t, sidebar: n }) })] });
   }
   const q = a.memo(J);
   var K = n(31373),
    O = n(10744);
   ...
   const ae = { expandButton: 'expandButton_5pWg', expandButtonIcon: 'expandButtonIcon_YoXl' };
   function ie(e) {
   ...
   const oe = { docSidebarContainer: 'docSidebarContainer_AaPG', docSidebarContainerHidden: 'docSidebarContainerHidden_AuXb', sidebarViewport: 'sidebarViewport_voAv' };
   function se(e) {
    let { children: t } = e;
    const n = (0, l.V)();
   ...
   const le = { docMainContainer: 'docMainContainer_jXIK', docMainContainerEnhanced: 'docMainContainerEnhanced_Eo0t', docItemWrapperEnhanced: 'docItemWrapperEnhanced_kzD7' };
   function de(e) {
   ...
   const ce = { docRoot: 'docRoot_Ib8o', docsWrapper: 'docsWrapper_jSaD' };
   function ue(e) {
    let { children: t } = e;
    const n = (0, l.V)(),
     [i, o] = (0, a.useState)(!1);
