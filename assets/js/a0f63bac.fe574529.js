 ...
 [6907],
 {
  ...
  61473(e, n, t) {
   ...
   var i = t(46447),
    s = t(46276),
    r = t(86070);
   const l = ({ children: e, conformanceLevel: n, ...t }) => (globalThis.isAstro ? null : (0, r.jsx)(s.p, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: n && (0, r.jsx)(i.KE, { className: 'nlds-inline-heading-group__badge', children: n }), ...t, children: e }));
  },
  66117(e, n, t) {
   t.d(n, { Ay: () => a, RM: () => r });
   var i = t(86070),
  ...
  66119(e, n, t) {
   ...
   function s(e) {
    ...
    if ('string' == typeof e || 'number' == typeof e) i += e;
     ...
     if (Array.isArray(e)) {
      var r = e.length;
      for (n = 0; n < r; n++) e[n] && (t = s(e[n])) && (i && (i += ' '), (i += t));
     } else for (t in e) e[t] && (i && (i += ' '), (i += t));
    return i;
   }
   function r() {
    for (var e, n, t = 0, i = '', r = arguments.length; t < r; t++) (e = arguments[t]) && (n = s(e)) && (i && (i += ' '), (i += n));
    return i;
   }
   const l = (0, t(30758).forwardRef)(({ aside: e, children: n, className: t, purpose: s, ...l }, a) => {
    const o = { ...l, ref: a, className: r('utrecht-note', { [`utrecht-note--${s}`]: s }, t) };
    return e ? (0, i.jsx)('aside', { ...o, children: n }) : (0, i.jsx)('section', { role: 'note', ...o, children: n });
   });
   l.displayName = 'Note';
   var a = t(29181);
  ...
  90920(e, n, t) {
   ...
   var s = t(86070),
    ...
    h = t(66117),
    g = t(25634);
   const u = { title: 'WCAG-succescriterium 1.4.5 Afbeeldingen van tekst', title_sm: '1.4.5 Afbeeldingen van tekst', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.5 Afbeeldingen van tekst', pagination_label: 'WCAG-succescriterium 1.4.5 Afbeeldingen van tekst', description: 'Laat tekst buiten afbeeldingen.', slug: '1.4.5', conformance_level: 'Niveau AA', keywords: ['WCAG', 'AA', 'waarneembaar', 'onderscheidbaar', 'perceivable', 'distinguishable', 'images of text'] },
    p = void 0,
    j = {},
