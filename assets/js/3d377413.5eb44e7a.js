 ...
 [17903],
 {
  34191: (e, t, n) => {
   ...
   const s = { title: 'Page Footer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Page Footer', pagination_label: 'Page Footer', description: 'Consistente plek onderaan elke pagina, vaak met links, juridische informatie en opties om hulp te krijgen of contact op te nemen.', slug: '/page-footer', keywords: ['bottom bar', 'bottom section', 'cookies', 'copyright', 'language', 'legal', 'footer', 'page bottom', 'page footer', 'related'] },
    ...
    d = 'Page Footer',
    j = 'Consistente plek onderaan elke pagina, vaak met links, juridische informatie en opties om hulp te krijgen of contact op te nemen.',
    y = 56,
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => g, BA: () => s, Ee: () => u, Q6: () => i, U: () => j, Yr: () => p, d: () => h, e9: () => o, fO: () => k, mA: () => c, ps: () => y, qU: () => b, s0: () => v, zP: () => m });
