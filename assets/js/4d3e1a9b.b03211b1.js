 ...
 [4104],
 {
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    u = n(83386),
    l = n(86070);
   const h = { figma: (0, l.jsx)(c.A, {}), github: (0, l.jsx)(s.A, {}), npm: (0, l.jsx)(o.A, {}), storybook: (0, l.jsx)(a.A, {}) },
   ...
   const b = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    f = ({ checked: e, children: t, title: n, description: r, headingLevel: c = 3 }) => (0, l.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(v.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(k.DZ, { appearance: 'utrecht-heading-3', level: c, children: n }), r, t] })] });
   var x = n(75916);
   const _ = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, l.jsx)(r.If, { sections: c.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(b, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(f, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            j.Zp,
            {
             ...
             children: (0, l.jsxs)(j.Wu, {
              children: [
               ...
               (o.length > 0 || c.length > 0) && (0, l.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               o.length > 0 &&
                (0, l.jsx)(l.Fragment, {
               ...
               c.length > 0 && (0, l.jsx)(l.Fragment, { children: c.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => g, GT: () => b, KF: () => h, Pc: () => o, Pv: () => m, Rc: () => f, bo: () => r, eQ: () => k, f4: () => s, fX: () => i, kD: () => v, mJ: () => y, o_: () => p, qZ: () => c });
