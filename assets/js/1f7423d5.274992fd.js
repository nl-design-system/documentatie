   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: j = !0, children: g, container: x = 'document', language: y, designTokens: f }) => {
    ...
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       k && (0, p.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(S, { children: (0, p.jsx)(t.v$, { children: k }) }) }) }),
       j &&
        (0, p.jsx)('div', {
