    ...
    return (
     ...
     (0, a.jsx)(r.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsx)(o.dn, { tabIndex: 0, style: l, children: r.map((e, l) => (0, a.jsxs)('span', { ...s({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const i = (e) => {
    ...
    const p = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     v = u ? 'figcaption' : 'div';
    return (0, c.jsxs)(h, { className: (0, a.Z)(t['nlds-guideline'], t[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(v, { className: (0, a.Z)(t['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, a.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: t['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: t['nlds-guideline__title'], children: m })] }), (0, c.jsx)(s.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, a.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(r.Z, { 'aria-hidden': 'true', role: 'presentation', className: t['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: t['nlds-guideline__title'], children: p })] }), (0, c.jsx)(s.nv, { children: n })] }), i] }), (0, c.jsx)('div', { className: (0, a.Z)(t['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => t, a: () => a });
