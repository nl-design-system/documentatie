(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [72755],
 {
  ...
  42204: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => _, component: () => V, contentTitle: () => L, default: () => O, description: () => M, frontMatter: () => N, issueNumber: () => P, metadata: () => Z, title: () => S, toc: () => D });
   var r,
    i,
    s,
    o,
   ...
   var G = n(97520),
    ...
    R = n(55240),
    z = n(8657);
   const N = { title: 'Heading', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading', pagination_label: 'Heading', description: 'Koptekst die in de koppenstructuur ingesteld kan worden op het juiste niveau.', slug: '/heading' },
    L = void 0,
   ...
   function F(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, d.jsx)(z.Rv, { component: V, headingLevel: 1, description: M }),
      '\n',
      (0, d.jsx)(G.I, { component: V }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, d.jsx)(W.B, { component: V, illustration: p }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, d.jsx)(z.cN, { component: V, headingLevel: 3 }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, d.jsx)(z.W, { component: V, headingLevel: 3 }),
      '\n',
      ...
      '\n',
      (0, d.jsx)(R.t, { headingLevel: 4, testCategory: 'Toegankelijkheid visueel ontwerp', items: [{ title: 'De contrastverhouding van de tekstkleur met de achtergrondkleur is hoog genoeg', sc: '1.4.3', status: '', component: (0, d.jsx)(f.ZP, {}) }] }),
      '\n',
      (0, d.jsx)(R.t, {
       headingLevel: 4,
       testCategory: 'Toegankelijkheid zoom en herschalen',
       items: [
        { title: 'Als je de tekst vergroot tot 200% blijft deze in zijn geheel zichtbaar', sc: '1.4.4', status: '', component: (0, d.jsx)(A.ZP, {}) },
      ...
      '\n',
      (0, d.jsx)(z.vM, { component: V, headingLevel: 3 }),
     ],
    });
   }
   function O(e = {}) {
