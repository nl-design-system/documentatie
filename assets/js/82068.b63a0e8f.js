/*! For license information please see 82068.b63a0e8f.js.LICENSE.txt */
'use strict';
 ...
 [82068],
 {
  ...
  52071(e, n, t) {
   ...
   var i = t(30758),
    ...
    l = t(65097),
    a = t(31378);
   const r = 'details_XLKE',
    c = 'isBrowser_IoUy',
    d = 'collapsibleContent_XuFj';
   var u = t(86070);
   function h(e) {
   ...
   function f({ summary: e, children: n, ...t }) {
    ...
    const f = (0, l.A)(),
     ...
     y = i.isValidElement(e) ? e : (0, u.jsx)('summary', { children: e ?? 'Details' });
    return (0, u.jsxs)('details', {
     ...
     onClick: (e) => {
      e.stopPropagation();
      const n = e.target;
      h(n) && m(n, p.current) && (e.preventDefault(), x ? (v(!1), j(!0)) : v(!0));
     },
     children: [
      y,
      (0, u.jsx)(a.N, {
  ...
  80345(e, n, t) {
   ...
   const A = { icon: (0, o.jsx)(y, {}), title: (0, o.jsx)(a.A, { id: 'theme.admonition.tip', description: 'The default label used for the Tip admonition (:::tip)', children: 'tip' }) };
   function w(e) {
    return (0, o.jsx)(x, { ...A, ...e, className: (0, l.A)('alert alert--success', e.className), children: e.children });
   }
   function N(e) {
   ...
   const E = {
    ...
    ...{
     ...
     success: (e) => (0, o.jsx)(w, { title: 'success', ...e }),
     caution: function (e) {
