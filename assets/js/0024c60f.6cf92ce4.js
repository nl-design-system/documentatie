/*! For license information please see 0024c60f.6cf92ce4.js.LICENSE.txt */
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [72837],
 {
  ...
  22044: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => U, component: () => X, contentTitle: () => E, default: () => K, description: () => I, frontMatter: () => F, issueNumber: () => $, metadata: () => H, title: () => V, toc: () => B });
   var r,
    o,
    s,
    i,
   ...
   function J(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, d.jsx)(D.Rv, { component: X, headingLevel: 1, description: I }),
      '\n',
  ...
  29659: (e, n, t) => {
   ...
   var r = t(16167),
    ...
    i = t(52676);
   const l = (e) => {
     let { title: n, sc: t, status: s, component: l, headingLevel: a = 4 } = e;
     const c = o.fg.get(t),
      d = c ? `${t} ${c.nl?.title}` : t;
     return (0, i.jsxs)('div', { className: 'component-criteria-section', children: [(0, i.jsx)(r.X6, { appearance: 'utrecht-heading-4', level: a, className: 'component-criteria-section__heading', children: n }), (t || s) && (0, i.jsxs)('dl', { className: 'component-criteria-section__dl', children: [t && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('dt', { className: 'component-criteria-section__dt', children: 'WCAG' }), (0, i.jsx)('dd', { className: 'component-criteria-section__dd', children: (0, i.jsx)(r.rU, { href: `/wcag/${t}`, children: d }) })] }), s && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('dt', { className: 'component-criteria-section__dt', children: 'Status' }), (0, i.jsx)('dd', { className: 'component-criteria-section__dl', children: s })] })] }), l] });
    },
    a = (e) => {
     let { testCategory: n, items: t } = e;
     return (0, i.jsx)(s.a2, { sections: [{ className: 'utrecht-accordion--nlds-subtle', headingLevel: 3, expanded: !1, label: (0, i.jsx)('span', { children: n }), body: t.map((e, n) => (0, i.jsx)(l, { ...e }, n)) }] });
    };
  },
  8657: (e, n, t) => {
   'use strict';
