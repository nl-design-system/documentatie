 ...
 [88474],
 {
  ...
  72089: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    l = n(27512);
   function d(e) {
    const t = { a: 'a', code: 'code', p: 'p', pre: 'pre', strong: 'strong', ...(0, s.a)(), ...e.components };
   ...
   const T = { title: 'Code', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code', pagination_label: 'Code', description: 'Computercode die onderdeel is van lopende tekst.', slug: '/code', keywords: ['actie', 'action', 'code', 'codeblock', 'code block', 'code markering', 'code fences', 'code snippet', 'code voorbeeld', 'coded language', 'codetaal', 'css', 'example', 'html', 'java', 'inline code', 'mono', 'monotype', 'monospace', 'plaintext', 'pre', 'samp', 'source code', 'src', 'voorbeeld'] },
    ...
    z = 'Code',
    S = 'Computercode die onderdeel is van lopende tekst.',
    _ = 326,
    L = o.find((e) => e.number === _);
   function D(e) {
    const t = { a: 'a', h2: 'h2', h3: 'h3', p: 'p', ...(0, s.a)(), ...e.components };
  ...
  35038: (e, t, n) => {
   ...
   const i = (e) => {
     ...
     return (0, o.jsx)('div', { className: (0, s.Z)('card__illustration', t && `card__illustration--${t}`, r), ...i, children: n });
    },
    c = (e) => (0, o.jsx)('div', { className: 'card__content', ...e }),
    a = (e) => {
     let { href: t, appearance: n, className: i, component: c = 'div', background: a, children: l } = e;
     const d = (e) => ('article' === c ? (0, o.jsx)('article', { ...e }) : 'section' === c ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      u = (0, o.jsx)(d, { className: (0, s.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, i), children: l });
     return t ? (0, o.jsx)(r.rU, { href: t, boxContent: !0, className: 'cardgroup__link', children: u }) : u;
    },
    l = (e) => {
  ...
  6503: (e, t, n) => {
   ...
   var r = n(57229),
    ...
    d = n(52676);
   const u = (e) => {
     let { title: t, sc: n, component: l, tags: u } = e;
     const h = (0, a.useId)(),
      m = [...u];
     if (n) {
      m.push(n);
          ...
          (0, d.jsx)(o.k, {
           ...
           children: m.map((e, t) => {
            ...
            if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
             const o = s.fg.get(e);
             n = (0, d.jsx)(r.r, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${o.sc} ${o.nl.title}`, style: { lineHeight: 1 }, children: (0, d.jsx)(i.O, { children: `WCAG ${e}` }) }, t);
            }
            return n;
           }),
          }),
    ...
    h = (e) => {
     ...
     const r = t.reduce(
      ...
      [s, i] = (0, a.useState)(Array.from(r.values())),
      c = (e) => s.includes(e),
      h = (0, a.useId)(),
      m =
       s.length >= 1
       ...
       (0, d.jsxs)('div', {
        ...
        children: [
         (0, d.jsxs)(l.pg, {
          ...
          'aria-labelledby': h,
          children: [
           (0, d.jsx)(l.X6, { level: n, id: h, children: 'Filter acceptatiecriteria voor:' }),
             ...
             l.Wi,
             {
              ...
              children: [
               (0, d.jsx)(l.XZ, {
                ...
                onChange: () =>
                 ((e, t) => {
                  const n = ('boolean' == typeof t ? t : !c(e)) ? [...s, e] : s.filter((t) => t !== e);
                  i(n);
                 })(e),
               }),
  ...
  76233: (e, t, n) => {
   ...
   const a = (e) => {
    ...
    d = (e) => {
     ...
     const { title: u } = t,
      h = (0, i.mA)(u),
      m = o.lazy(() => n(22930)(`./${h}-docs/docs/anatomy/anatomy.md`).catch(() => ({ default: () => null })));
  ...
  8657: (e, t, n) => {
   ...
   var r = n(74824),
    ...
    l = n(32636),
    d = n(52676);
   const u = { figma: (0, d.jsx)(o.Z, {}), github: (0, d.jsx)(i.Z, {}), npm: (0, d.jsx)(c.Z, {}), storybook: (0, d.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const A = (e) => {
     ...
     const o = t && t.projects.filter((e) => x.e9.includes(e.id)),
      i = o && x.e9.map((e) => o.find((t) => t.id === e)).filter(Boolean),
      c = (e) => (['Candidate - New', 'Candidate - Oud'].includes(e.title) ? 'Candidate' : e.title);
     return (
      t &&
      (0, d.jsx)(r.a2, {
       sections: i.map((e) => ({
        className: (0, s.Z)('definition-of-done', e && `definition-of-done--${(0, x.mA)(c(e))}`),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, d.jsx)(f, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(k, { headingLevel: n + 1, checked: t, title: r, description: (0, x.Q6)(s) }, s);
            }),
           }),
            ...
            m.Zb,
            {
             ...
             children: (0, d.jsxs)(m.aY, {
              children: [
               ...
               (c.length > 0 || o.length > 0) && (0, d.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               c.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               o.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: o.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: n + 2, children: [s, ' in ', t] }), (0, d.jsx)(r.Mc, { links: o.map((e) => ({ children: e.description, icon: (0, d.jsx)(h, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
  ...
  49556: (e, t, n) => {
   ...
   function T(e) {
    ...
    const n = (0, o.s0)(t),
     c = (0, o.fO)(n),
     a = c.map((e) => (0, o.$e)(e) + ': ;').join('\n'),
     l = JSON.stringify((0, o.qU)(c));
       ...
       children: [
        ...
        (0, m.jsx)(i.RM, {
         children: c.map((e) => {
          const n = (0, o.zP)(e),
           c = (0, o.Yr)(t, e).$type;
          return (0, m.jsxs)(i.SC, { children: [(0, m.jsx)(i.pj, { children: (0, m.jsx)(r.E, { children: (0, m.jsx)(i.YG, { children: n }) }) }), (0, m.jsx)(i.pj, { children: (0, m.jsxs)(s.O, { children: [(0, m.jsx)(C, { type: c }), ' ', c] }) })] }, n);
         }),
        }),
       ],
      }),
  ...
  57229: (e, t, n) => {
   ...
   const i = (e) => {
    let { className: t, ...n } = e;
    return (0, o.jsx)(r.Z, { className: (0, s.W)('utrecht-link', 'utrecht-link--html-a', t), ...n });
   };
  },
  57716: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => j, BA: () => c, Ee: () => d, Q6: () => o, U: () => m, Yr: () => w, d: () => u, e9: () => i, fO: () => v, mA: () => s, ps: () => g, qU: () => f, s0: () => y, zP: () => p });
    ...
    g = (e) => {
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        let { name: s, id: o, value: i } = r;
        const c = /^(.+) URL/.exec(s)[1],
         a = 'Storybook' === c ? `${n} (${t}) in Storybook van ${((e) => (['Candidate - New', 'Candidate - Oud'].includes(e.title) ? 'Candidate' : e.title))(e)}` : `${n} (${t}) op ${c}`;
        return { brand: c.toLowerCase(), name: s, id: o, value: i, description: a };
       });
