   ...
   const y = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: y = !0, children: j, container: v = 'document', language: b, designTokens: x }) => {
    ...
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       k && (0, p.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, p.jsx)(R, { children: (0, p.jsx)(r.v$, { children: k }) }) }) }),
       y &&
        (0, p.jsx)('div', {
