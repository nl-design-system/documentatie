 ...
 [95850],
 {
  ...
  66820(e, n, i) {
   ...
   var t = i(46447),
    r = i(10645),
    s = i(86070);
   const o = ({ children: e, conformanceLevel: n, ...i }) => (globalThis.isAstro ? null : (0, s.jsx)(r.p, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: n && (0, s.jsx)(t.KE, { className: 'nlds-inline-heading-group__badge', children: n }), ...i, children: e }));
  },
  90290(e, n, i) {
   i.d(n, { Ay: () => l, RM: () => s });
   var t = i(86070),
  ...
  95857(e, n, i) {
   ...
   const o = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: r, ...o }, l) => {
    const a = { ...o, ref: l, className: s('utrecht-note', { [`utrecht-note--${r}`]: r }, i) };
    return e ? (0, t.jsx)('aside', { ...a, children: n }) : (0, t.jsx)('section', { role: 'note', ...a, children: n });
   });
   o.displayName = 'Note';
   var l = i(29181);
  ...
  97225(e, n, i) {
   (i.r(n), i.d(n, { assets: () => j, contentTitle: () => p, default: () => f, frontMatter: () => g, metadata: () => t, toc: () => m }));
   const t = JSON.parse('{"id":"wcag/3.2.02","title":"WCAG-succescriterium 3.2.2 Bij input","description":"Verras een gebruiker niet, maar maak functionaliteit voorspelbaar en daardoor goed te begrijpen. Als een gebruiker een formuliercomponent of -optie selecteert of een invoerveld invult met het toetsenbord of met de muis, veroorzaakt dit niet automatisch een contextwijziging.","source":"@site/docs/wcag/3.2.02.mdx","sourceDirName":"wcag","slug":"/wcag/3.2.2","permalink":"/wcag/3.2.2","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.2.02.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 3.2.2 Bij input","title_sm":"3.2.2 Bij input","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"3.2.2 Bij input","pagination_label":"WCAG-succescriterium 3.2.2 Bij input","description":"Verras een gebruiker niet, maar maak functionaliteit voorspelbaar en daardoor goed te begrijpen. Als een gebruiker een formuliercomponent of -optie selecteert of een invoerveld invult met het toetsenbord of met de muis, veroorzaakt dit niet automatisch een contextwijziging.","slug":"3.2.2","conformance_level":"Niveau A","keywords":["WCAG","A","begrijpelijk","voorspelbaar","understandable","predictable","on input"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 3.2.1 Bij focus","permalink":"/wcag/3.2.1"},"next":{"title":"WCAG-succescriterium 3.2.3 Consistente navigatie","permalink":"/wcag/3.2.3"}}');
   var r = i(86070),
    s = i(18439),
    o = i(51582),
    l = i(66820),
    ...
    h = i(37026),
    u = i(90290);
   const g = { title: 'WCAG-succescriterium 3.2.2 Bij input', title_sm: '3.2.2 Bij input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.2 Bij input', pagination_label: 'WCAG-succescriterium 3.2.2 Bij input', description: 'Verras een gebruiker niet, maar maak functionaliteit voorspelbaar en daardoor goed te begrijpen. Als een gebruiker een formuliercomponent of -optie selecteert of een invoerveld invult met het toetsenbord of met de muis, veroorzaakt dit niet automatisch een contextwijziging.', slug: '3.2.2', conformance_level: 'Niveau A', keywords: ['WCAG', 'A', 'begrijpelijk', 'voorspelbaar', 'understandable', 'predictable', 'on input'] },
    p = void 0,
    j = {},
    m = [{ value: 'Uitleg', id: 'uitleg', level: 2 }, ...u.RM, { value: 'Gerelateerde NL Design System-richtlijn', id: 'gerelateerde-nl-design-system-richtlijn', level: 2 }, { value: 'Gebruikersonderzoek', id: 'gebruikersonderzoek', level: 2 }, ...c.RM, { value: 'Hoe te testen', id: 'hoe-te-testen', level: 2 }, { value: 'W3C referenties', id: 'w3c-referenties', level: 2 }, ...d.RM, { value: 'Help richtlijn verbeteren', id: 'help-richtlijn-verbeteren', level: 2 }, ...h.RM];
   function v(e) {
    const n = { a: 'a', h2: 'h2', li: 'li', p: 'p', strong: 'strong', ul: 'ul', ...(0, s.R)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', (0, r.jsx)(l.E, { level: 1, conformanceLevel: 'Niveau A', children: 'WCAG-succescriterium 3.2.2 Bij input' }), '\n', (0, r.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, r.jsx)(u.Ay, {}), '\n', (0, r.jsx)(n.h2, { id: 'gerelateerde-nl-design-system-richtlijn', children: 'Gerelateerde NL Design System-richtlijn' }), '\n', (0, r.jsxs)(n.p, { children: ['Formulieren: ', (0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/buttons/niet-automatisch-versturen/', children: 'Verstuur een formulier niet automatisch na het wijzigen of invullen van een formulierveld' }), '.'] }), '\n', (0, r.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, r.jsx)(c.Ay, {}), '\n', (0, r.jsx)(n.h2, { id: 'hoe-te-testen', children: 'Hoe te testen' }), '\n', (0, r.jsx)(n.p, { children: 'Bepaal eerst of er interactieve componenten op de pagina zijn, zoals invoervelden, radiobuttons, selects en checkboxes. En dan:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: 'Selecteer/activeer elk formulierelement.' }), '\n', (0, r.jsx)(n.li, { children: 'Indien van toepassing: vul een formulierveld in en verlaat het veld weer (haal de focus weg).' }), '\n', (0, r.jsx)(n.li, { children: 'Test of er geen onverwachte dingen gebeuren zoals het verzenden van het formulier, het verplaatsen van de focus of het openen van een nieuw venster of tab.' }), '\n', (0, r.jsx)(n.li, { children: 'Test dit met de muis en daarna ook met het toetsenbord.' }), '\n'] }), '\n', (0, r.jsxs)(n.p, { children: [(0, r.jsx)(n.strong, { children: 'Let op' }), ': Buttons en links zijn uitgesloten van deze test, hierbij is een verandering van context bij het selecteren/aanklikken verwacht gedrag.'] }), '\n', (0, r.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#on-input', children: (0, r.jsx)('span', { lang: 'en', children: '3.2.2: On Input' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#on-input', children: '3.2.2 Bij input' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, r.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#on-input', children: (0, r.jsx)('span', { lang: 'en', children: 'Quick Reference 3.2.2 On Input' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/on-input.html', children: (0, r.jsx)('span', { lang: 'en', children: 'Understanding SC 3.2.2: On Input' }) }), '.'] }), '\n'] }), '\n', (0, r.jsx)(a.K, { children: (0, r.jsx)(o.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(d.Ay, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, r.jsx)(o.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(h.Ay, {}) })] });
   }
   function f(e = {}) {
