(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [3958],
 {
  ...
  75916: (e, n, t) => {
   'use strict';
   t.d(n, { B2: () => h, B_: () => j, GT: () => k, KF: () => d, Pc: () => c, Pv: () => g, Rc: () => f, bo: () => r, eQ: () => y, f4: () => i, fX: () => o, kD: () => w, mJ: () => m, o_: () => p, qZ: () => s });
   ...
   const a = (e) => {
    ...
    u = (e) => {
     const n = / URL \(([^)]+)\)/;
     return a(l(e.tasks.filter(({ name: e, value: t }) => '' !== t && n.test(e)).map(({ name: e }) => n.exec(e)?.[1])));
    },
    m = (e) => a(l(e.projects.flatMap((e) => u(e)))),
    g = (e) => {
     const n = u(e),
      t = ((e) => {
