/*! For license information please see 19289.de46b16b.js.LICENSE.txt */
'use strict';
 ...
 [19289],
 {
  41973: (e, t, r) => {
   ...
   function q(e, t, r, s, o) {
    switch (t) {
     ...
     case 'option':
      (u = o.selectedValue), e.push(R('option'));
      var h = (p = null),
       d = null,
       f = null;
      for (l in r)
     ...
     case 'textarea':
      for (p in (e.push(R('textarea')), (f = u = l = null), r))
     ...
     case 'input':
      for (u in (e.push(R('input')), (h = f = p = l = null), r))
     ...
     case 'menuitem':
      for (var g in (e.push(R('menuitem')), r))
      ...
      return e.push('>'), null;
     case 'title':
      for (m in (e.push(R('title')), (l = null), r))
     ...
     case 'listing':
     case 'pre':
      for (h in (e.push(R(t)), (u = l = null), r))
     ...
     default:
      ...
      for (d in (e.push(R(t)), (u = l = null), r))
   ...
   function Ie(e, t, r) {
    ...
    return (e = e === qe ? ('function' == typeof t ? t() : t) : void 0 !== r ? r(t) : t), (Se.memoizedState = e), (e = (e = Se.queue = { last: null, dispatch: null }).dispatch = Pe.bind(null, ve, e)), [Se.memoizedState, e];
   }
   function Fe(e, t) {
   ...
   function je(e, t, r, n) {
    ...
    if (null != s) {
     ...
     (t.legacyContext = n), Ze(e, t, i), (t.legacyContext = o);
    } else Ze(e, t, i);
   }
   function Ge(e, t) {
    if (e && e.defaultProps) {
   ...
   function Xe(e, t, r, n, i) {
    if ('function' == typeof r)
     ...
     if ('string' != typeof r) {
      ...
      if ('object' == typeof r && null !== r)
       switch (r.$$typeof) {
        ...
        case O:
         if (((i = n.children), (r = r._context), (n = n.value), (s = r._currentValue2), (r._currentValue2 = n), (re = n = { parent: (o = re), depth: null === o ? 0 : o.depth + 1, context: r, parentValue: s, value: n }), (t.context = n), Ze(e, t, i), null === (e = re))) throw Error(a(403));
         return (n = e.parentValue), (e.context._currentValue2 = n === J ? e.context._defaultValue : n), (e = re = e.parent), void (t.context = e);
        case z:
         return void Ze(e, t, (n = (n = n.children)(r._currentValue2)));
        case G:
     ...
     switch (
      ((s = q((i = t.blockedSegment).chunks, r, n, e.responseState, i.formatContext)),
      (i.lastPushedText = !1),
      (o = i.formatContext),
   ...
   function Ze(e, t, r) {
    if (((t.node = r), 'object' == typeof r && null !== r)) {
     switch (r.$$typeof) {
      ...
      case G:
       var n = r._init;
       return void Ze(e, t, (r = n(r._payload)));
     }
     if (S(r)) return void Ye(e, t, r);
     if ((null === r || 'object' != typeof r ? (n = null) : (n = 'function' == typeof (n = (K && r[K]) || r['@@iterator']) ? n : null), n && (n = n.call(r)))) {
      if (!(r = n.next()).done) {
       var i = [];
       do {
   ...
   function Je(e, t, r) {
    ...
    try {
     ...
     if ((Re(), 'object' != typeof l || null === l || 'function' != typeof l.then)) throw ((t.blockedSegment.formatContext = n), (t.legacyContext = a), (t.context = i), le(i), l);
     r = l;
     ...
     try {
      ...
      for (a = 0; a < i.length; a++) {
       ...
       if (0 === l.status) {
        le(s.context);
        try {
         Ze(o, s, s.node), o.responseState.generateStaticMarkup || (l.lastPushedText && l.textEmbedded && l.chunks.push('\x3c!-- --\x3e')), s.abortSet.delete(s), (l.status = 1), tt(o, s.blockedBoundary, l);
        } catch (d) {
         if ((Re(), 'object' == typeof d && null !== d && 'function' == typeof d.then)) {
          var c = s.ping;
          d.then(c, c);
         } else {
  ...
  2910: (e, t, r) => {
   ...
   function ee(e, t, r, n) {
    ...
    return e.push(Y), K(e, i, r), 'string' == typeof r ? (e.push(p(T(r))), null) : r;
   }
   var te = h('\n'),
    ...
    switch (t) {
     ...
     case 'textarea':
      ...
      if ((null === o && null !== l && (o = l), e.push(Y), null != d)) {
       ...
       if (R(d) && 1 < d.length) throw Error(a(93));
       o = '' + d;
      }
     ...
     case 'input':
      ...
      return null !== d ? Z(e, i, 'checked', d) : null !== u && Z(e, i, 'checked', u), null !== o ? Z(e, i, 'value', o) : null !== c && Z(e, i, 'value', c), e.push(J), null;
     case 'menuitem':
   ...
   function Rt(e, t) {
    var r = t.parent;
    if (null === r) throw Error(a(402));
    e.depth === r.depth ? xt(e, r) : Rt(e, r), (t.context._currentValue = t.value);
   }
   function qt(e) {
    var t = Ct;
    t !== e && (null === t ? Et(e) : null === e ? Tt(t) : t.depth === e.depth ? xt(t, e) : t.depth > e.depth ? Lt(t, e) : Rt(t, e), (Ct = e));
   }
   var It = {
    isMounted: function () {
     return !1;
   ...
   function Yt() {
    return null === zt ? (null === Ot ? (($t = !1), (Ot = zt = Zt())) : (($t = !0), (zt = Ot))) : null === zt.next ? (($t = !1), (zt = zt.next = Zt())) : (($t = !0), (zt = zt.next)), zt;
   }
   function Jt() {
   ...
   function Qt(e, t, r) {
    ...
    return (e = e === Kt ? ('function' == typeof t ? t() : t) : void 0 !== r ? r(t) : t), (zt.memoizedState = e), (e = (e = zt.queue = { last: null, dispatch: null }).dispatch = tr.bind(null, Ht, e)), [zt.memoizedState, e];
   }
   function er(e, t) {
    if (((Ht = Xt()), (t = void 0 === t ? null : t), null !== (zt = Yt()))) {
   ...
   function br(e, t, r) {
    ...
    try {
     ...
     if ((Jt(), 'object' != typeof l || null === l || 'function' != typeof l.then)) throw ((t.blockedSegment.formatContext = n), (t.legacyContext = a), (t.context = i), qt(i), l);
     r = l;
     var s = t.blockedSegment,
      o = ur(0, s.chunks.length, null, s.formatContext, s.lastPushedText, !0);
     s.children.push(o), (s.lastPushedText = !1), (e = cr(e, t.node, t.blockedBoundary, o, t.abortSet, t.legacyContext, t.context, t.treeContext).ping), r.then(e, e), (t.blockedSegment.formatContext = n), (t.legacyContext = a), (t.context = i), qt(i);
    }
   }
   function Sr(e) {
    var t = e.blockedBoundary;
   ...
   function Cr(e) {
    if (2 !== e.status) {
     ...
     try {
      ...
      i.splice(0, a), null !== e.destination && qr(e, e.destination);
     } catch (d) {
      pr(e, d), hr(e, d);
     } finally {
      (ir = n), (sr.current = r), r === ar && qt(t);
     }
    }
   }
   function xr(e, t, r) {
    ...
    return (
     (function (e, t, r, n) {
      switch (r.insertionMode) {
       ...
       case 4:
        return o(e, qe), o(e, t.segmentPrefix), o(e, p(n.toString(16))), l(e, Ie);
       case 5:
   ...
   function Lr(e, t, r) {
    for (var n = r.completedSegments, i = 0; i < n.length; i++) Rr(e, t, r, n[i]);
    ...
    return (r = p(r.toString(16))), o(t, n), o(t, Xe), o(t, e.segmentPrefix), o(t, r), l(t, Ze);
   }
   function Rr(e, t, r, n) {
    if (2 === n.status) return !0;
    var i = n.id;
   ...
   function qr(e, t) {
    ...
    try {
     ...
     for (u = 0; u < h.length; u++) {
      ...
      if ((o(n, m), o(n, Ke), (g || v || y) && (o(n, et), o(n, p(rt(g || '')))), (v || y) && (o(n, et), o(n, p(rt(v || '')))), y && (o(n, et), o(n, p(rt(y)))), !l(n, Qe))) return (e.destination = null), u++, void h.splice(0, u);
     }
     h.splice(0, u);
   ...
   function Ir(e, t) {
    try {
     ...
     r.forEach(function (r) {
      ...
      r.clear(),
      null !== e.destination && qr(e, e.destination);
    } catch (n) {
     pr(e, n), hr(e, n);
    }
   }
    ...
    return new Promise(function (r, n) {
     var a,
      ...
      o = (function (e, t, r, n, a, i, s, o, l) {
       ...
       e,
       (function (e, t, r, n, a) {
        (e = void 0 === e ? '' : e), (t = void 0 === t ? q : h('<script nonce="' + T(t) + '">'));
        var i = [];
  ...
  60027: (e, t, r) => {
   var n, a;
   (n = r(41973)), (a = r(2910)), n.version, n.renderToString, (t.uS = n.renderToStaticMarkup), n.renderToNodeStream, n.renderToStaticNodeStream, a.renderToReadableStream;
  },
  20061: (e, t, r) => {
   r.d(t, { Z: () => n });
  ...
  86017: (e, t, r) => {
   ...
   var n = Object.defineProperty,
    ...
    u = {};
   i(u, { languages: () => qr, options: () => Pr, parsers: () => Nr, printers: () => ka });
   var p = (e, t, r, n) => {
   ...
   function q(e) {
    ...
    if (R(e)) throw new Error('doc is valid.');
   ...
   var K = class {
     ...
     hasLeadingWhitespace(e) {
      return l(this, J).has(e.charAt(0));
     }
     hasTrailingWhitespace(e) {
      return l(this, J).has(L(!1, e, -1));
     }
     trimStart(e) {
      let t = this.getLeadingWhitespaceCount(e);
      return e.slice(t);
   ...
   var ue = function (e, t, r, n) {
    ...
    pe = (e) => String(e).split(/[/\\]/u).pop();
   function he(e, t) {
    if (!t) return;
    let r = pe(t).toLowerCase();
   ...
   var de = function (e, t) {
    ...
    ge = 'normal',
    ve = { listing: 'pre', plaintext: 'pre', pre: 'pre', xmp: 'pre', nobr: 'nowrap', table: 'initial', textarea: 'pre-wrap' };
   var ye = function (e) {
   ...
   function we(e, t) {
    return !!(('ieConditionalComment' === e.type && e.lastChild && !e.lastChild.isSelfClosing && !e.lastChild.endSourceSpan) || ('ieConditionalComment' === e.type && !e.complete) || (Oe(e) && e.children.some((e) => 'text' !== e.type && 'interpolation' !== e.type)) || (Ze(e, t) && !Ce(e) && 'interpolation' !== e.type));
   }
   function ke(e) {
    return (
   ...
   function qe(e) {
    return (
     ...
     (e.firstChild && e.firstChild === e.lastChild && 'text' !== e.firstChild.type && Ne(e.firstChild) && (!e.lastChild.isTrailingSpaceSensitive || De(e.lastChild)))
    );
   }
   function Ie(e) {
   ...
   function Fe(e) {
    return (
     ...
     (e.prev &&
      (function (e) {
       return Me(e) || ('element' === e.type && 'br' === e.fullName) || Pe(e);
      })(e.prev)) ||
     Pe(e)
    );
   }
   ...
   function Ae(e) {
    return e.lastChild ? Ae(e.lastChild) : e;
   }
   function Be(e) {
    if (e)
     switch (e) {
   ...
   function He(e, t) {
    return (
     (function (e, t) {
      ...
      return i || a ? (de(t, { language: i }) ?? Be(a)) : 'babel';
     })(e, t) ??
     (function (e, t) {
   ...
   function ze(e) {
    return ('element' === e.type && (!e.namespace || ye(e)) && ve[e.name]) || ge;
   }
   function $e(
    e,
    t = (function (e) {
   ...
   var je = new Set(['template', 'style', 'script']);
   function Ge(e, t) {
    return Xe(e, t) && !je.has(e.fullName);
   }
   function Xe(e, t) {
    return 'vue' === t.parser && 'element' === e.type && 'root' === e.parent.type && 'html' !== e.fullName.toLowerCase();
   }
   function Ze(e, t) {
    return Xe(e, t) && (Ge(e, t) || (e.attrMap.lang && 'html' !== e.attrMap.lang));
   }
   function Ye(e, t = e.value) {
    return e.parent.isWhitespaceSensitive ? (e.parent.isIndentationSensitive ? P(t) : P($e(be(t)), j)) : X(U, Q.split(t));
   }
   function Je(e, t) {
    return Xe(e, t) && 'script' === e.name;
   }
   var Ke = /\{\{(.+?)\}\}/su;
   function Qe({ parser: e }) {
    return (t, r, n) => ce(We(n.node), t, { parser: e }, le);
   }
   var et = Qe({ parser: '__ng_action' }),
    tt = Qe({ parser: '__ng_binding' }),
    rt = Qe({ parser: '__ng_directive' });
   var nt = function (e, t) {
    ...
    return /^i18n(?:-.+)?$/u.test(n)
     ? () => oe(O(Ye(r, a.trim())), !a.includes('@@'))
     : Ke.test(a)
       ? (e) =>
          (async function (e, t) {
           let r = [];
           for (let [n, a] of e.split(Ke).entries())
            if (n % 2 == 0) r.push(P(a));
            else
             try {
   ...
   var ht = function (e) {
    ...
    for (;;) {
     ...
     (s = l), (t = c(lt)), (r = []), ',' === t.slice(-1) ? ((t = t.replace(ct, '')), h()) : p();
    }
    function p() {
     for (c(st), n = '', a = 'in descriptor'; ; ) {
      if (((i = e.charAt(l)), 'in descriptor' === a))
       if (it(i)) n && (r.push(n), (n = ''), (a = 'after descriptor'));
       else {
      ...
      else if ('after descriptor' === a && !it(i)) {
       if ('' === i) return void h();
       (a = 'in descriptor'), (l -= 1);
      }
      l += 1;
    ...
    function h() {
     let n,
      ...
      f = !1,
      m = {};
     for (o = 0; o < r.length; o++) (l = r[o]), (c = l[l.length - 1]), (p = l.substring(0, l.length - 1)), (h = parseInt(p, 10)), (d = parseFloat(p)), ut.test(p) && 'w' === c ? ((n || a) && (f = !0), 0 === h ? (f = !0) : (n = h)) : pt.test(p) && 'x' === c ? ((n || a || i) && (f = !0), d < 0 ? (f = !0) : (a = d)) : ut.test(p) && 'h' === c ? ((i || a) && (f = !0), 0 === h ? (f = !0) : (i = h)) : (f = !0);
   ...
   var yt = function (e, t) {
    ...
    return (
     vt.has(r) ||
      vt.set(
       r,
       r.children.some((e) => Je(e, t) && ['ts', 'typescript'].includes(e.attrMap.lang)),
      ),
     vt.get(r)
    );
   };
   function bt(e, t, r) {
    let { node: n } = r;
    return ce(`type T<${We(n)}> = any`, e, { parser: 'babel-ts', __isEmbeddedTypescriptGenericParameters: !0 }, le);
   }
   ...
   var kt = function (e, t) {
    ...
    let { node: r } = e,
     n = r.fullName;
    if ('v-for' === n) return St;
    if ('generic' === n && Je(r.parent, t)) return bt;
    let a = We(r),
     i = yt(e, t);
    return (function (e) {
     let t = e.fullName;
     ...
     : n.startsWith('@') || n.startsWith('v-on:')
       ? (e) =>
          (async function (e, t, { parseWithTs: r }) {
           var n;
           try {
            return await wt(e, t, { parseWithTs: r });
           } catch (a) {
   ...
   function qt(e, t) {
    return [e.isSelfClosing ? '' : It(e, t), Ft(e, t)];
   }
   function It(e, t) {
    return e.lastChild && Vt(e.lastChild) ? '' : [Pt(e, t), Dt(e, t)];
   }
   function Ft(e, t) {
    return (e.next ? Bt(e.next) : Ht(e.parent)) ? '' : [Mt(e, t), Nt(e, t)];
   }
   function Pt(e, t) {
    return Ht(e) ? Mt(e.lastChild, t) : '';
   }
   function Nt(e, t) {
    return Vt(e) ? Dt(e.parent, t) : Ot(e) ? Zt(e.next, t) : '';
   }
   function Dt(e, t) {
    if ((Tt(!e.isSelfClosing), At(e, t))) return '';
    switch (e.type) {
     case 'ieConditionalComment':
      return '<!';
     case 'element':
   ...
   function At(e, t) {
    return !e.isSelfClosing && !e.endSourceSpan && (ke(e) || we(e.parent, t));
   }
   function Bt(e) {
    return e.prev && 'docType' !== e.prev.type && 'angularControlFlowBlock' !== e.type && !_e(e.prev) && e.isLeadingSpaceSensitive && !e.hasLeadingSpaces;
   }
   function Ht(e) {
    var t;
    return (null == (t = e.lastChild) ? void 0 : t.isTrailingSpaceSensitive) && !e.lastChild.hasTrailingSpaces && !_e(Ae(e.lastChild)) && !Oe(e);
   }
   function Vt(e) {
    return !e.next && !e.hasTrailingSpaces && e.isTrailingSpaceSensitive && _e(Ae(e));
   }
   function Ot(e) {
    return e.next && !_e(e.next) && _e(e) && e.isTrailingSpaceSensitive && !e.hasTrailingSpaces;
   }
   function zt(e) {
   ...
   function $t(e, t, r) {
    var n;
    let { node: a } = e;
    if (!Et(a.attrs)) return a.isSelfClosing ? ' ' : '';
    let i =
     ...
     o = e.map(({ node: e }) => (s(e) ? P(t.originalText.slice(Lt(e), Rt(e))) : r()), 'attrs'),
     l = 'element' === a.type && 'script' === a.fullName && 1 === a.attrs.length && 'src' === a.attrs[0].fullName && 0 === a.children.length,
     c = t.singleAttributePerLine && a.attrs.length > 1 && !Xe(a, t) ? j : U,
     u = [B([l ? ' ' : U, X(c, o)])];
    return (a.firstChild && zt(a.firstChild)) || (a.isSelfClosing && Ht(a.parent)) || l ? u.push(a.isSelfClosing ? ' ' : '') : u.push(t.bracketSameLine ? (a.isSelfClosing ? ' ' : '') : a.isSelfClosing ? U : W), u;
   }
   function Ut(e) {
    return e.firstChild && zt(e.firstChild) ? '' : Yt(e);
   }
   function Wt(e, t, r) {
    let { node: n } = e;
    return [jt(n, t), $t(e, t, r), n.isSelfClosing ? '' : Ut(n)];
   }
   function jt(e, t) {
    return e.prev && Ot(e.prev) ? '' : [Gt(e, t), Zt(e, t)];
   }
   function Gt(e, t) {
    return zt(e) ? Yt(e.parent) : Bt(e) ? Mt(e.prev, t) : '';
   }
   var Xt = '<!doctype';
   function Zt(e, t) {
    switch (e.type) {
     ...
     case 'docType':
      if ('html' === e.value) {
       let e = t.filepath ?? '';
       if (/\.html?$/u.test(e)) return Xt;
      }
      return t.originalText.slice(Lt(e), Rt(e)).slice(0, Xt.length);
     case 'angularIcuExpression':
      return '{';
     case 'element':
   ...
   var Jt = function (e, t) {
     ...
     e.firstChild && zt(e.firstChild) && (r -= Yt(e).length);
     let n = e.endSourceSpan.start.offset;
     return e.lastChild && Vt(e.lastChild) ? (n += Dt(e, t).length) : Ht(e) && (n -= Mt(e.lastChild, t).length), t.originalText.slice(r, n);
    },
   ...
   var Qt = function (e, t) {
     ...
     switch (r.type) {
      case 'element':
       if (Ce(r) || 'interpolation' === r.type) return;
       if (!r.isSelfClosing && Ze(r, t)) {
        let n = He(r, t);
        return n
         ? async (a, i) => {
            let s = Jt(r, t),
             o = /^\s*$/u.test(s),
             l = '';
            return o || ((l = await a(be(s), { parser: n, __embeddedInHtml: !0 })), (o = '' === l)), [Gt(r, t), V(Wt(e, t, i)), o ? '' : j, l, o ? '' : j, qt(r, t), Nt(r, t)];
           }
         : void 0;
       }
       break;
      case 'text':
       if (Ce(r.parent)) {
        ...
        if (e)
         return async (n) => {
          let a = 'markdown' === e ? $e(r.value.replace(/^[^\S\n]*\n/u, '')) : r.value,
          ...
          return [$, Gt(r, t), await n(a, i), Nt(r, t)];
         };
       } else if ('interpolation' === r.parent.type)
        return async (n) => {
         let a = { __isInHtmlInterpolation: !0, __embeddedInHtml: !0 };
         return 'angular' === t.parser ? (a.parser = '__ng_interpolation') : 'vue' === t.parser ? (a.parser = yt(e, t) ? '__vue_ts_expression' : '__vue_expression') : (a.parser = '__js_expression'), [B([U, await n(r.value, a)]), r.parent.next && Bt(r.parent.next) ? ' ' : U];
        };
       break;
      case 'attribute':
       return Ct(e, t);
      ...
      case 'angularControlFlowBlockParameters':
       return Kt.has(e.parent.name) ? ue : void 0;
   ...
   function sr(e) {
    let t = Rt(e);
    return 'element' === e.type && !e.endSourceSpan && Et(e.children) ? Math.max(t, sr(L(!1, e.children, -1))) : t;
   }
   function or(e, t, r) {
    let n = e.node;
    if (ke(n)) {
     let e = sr(n);
     return [Gt(n, t), P(Q.trimEnd(t.originalText.slice(Lt(n) + (n.prev && Ot(n.prev) ? Zt(n).length : 0), e - (n.next && Bt(n.next) ? Mt(n, t).length : 0)))), Nt(n, t)];
    }
    return r();
   }
   function lr(e, t) {
    return _e(e) && _e(t) ? (e.isTrailingSpaceSensitive ? (e.hasTrailingSpaces ? (Fe(t) ? j : U) : '') : Fe(t) ? j : W) : (Ot(e) && (ke(t) || t.firstChild || t.isSelfClosing || ('element' === t.type && t.attrs.length > 0))) || ('element' === e.type && e.isSelfClosing && Bt(t)) ? '' : !t.isLeadingSpaceSensitive || Fe(t) || (Bt(t) && e.lastChild && Vt(e.lastChild) && e.lastChild.lastChild && Vt(e.lastChild.lastChild)) ? j : t.hasLeadingSpaces ? U : W;
   }
   function cr(e, t, r) {
    let { node: n } = e;
    if (Ie(n))
     return [
      ...
      ...e.map((e) => {
       let n = e.node,
        a = n.prev ? lr(n.prev, n) : '';
       return [a ? [a, Re(n.prev) ? j : ''] : '', or(e, t, r)];
      }, 'children'),
     ];
    ...
    return e.map((e, n) => {
     ...
     if (_e(i)) {
      if (i.prev && _e(i.prev)) {
       let n = lr(i.prev, i);
       if (n) return Re(i.prev) ? [j, j, or(e, t, r)] : [n, or(e, t, r)];
      }
      return or(e, t, r);
     }
     let s = [],
      ...
      l = [],
      c = [],
      u = i.prev ? lr(i.prev, i) : '',
      p = i.next ? lr(i, i.next) : '';
     return u && (Re(i.prev) ? s.push(j, j) : u === j ? s.push(j) : _e(i.prev) ? o.push(u) : o.push(z('', W, { groupId: a[n - 1] }))), p && (Re(i) ? _e(i.next) && c.push(j, j) : p === j ? _e(i.next) && c.push(j) : l.push(p)), [...s, V([...o, V([or(e, t, r), ...l], { id: a[n] })]), ...c];
    }, 'children');
   }
   function ur(e, t, r) {
    let { node: n } = e,
    ...
    (function (e) {
     let { previous: t } = e;
     return 'angularControlFlowBlock' === (null == t ? void 0 : t.type) && !ke(t) && !pr(t);
    })(e) && a.push('} '),
     a.push('@', n.name),
     n.parameters && a.push(' (', V(r('parameters')), ')'),
     a.push(' {');
    let i = pr(n);
    return n.children.length > 0 ? ((n.firstChild.hasLeadingSpaces = !0), (n.lastChild.hasTrailingSpaces = !0), a.push(B([j, cr(e, t, r)])), i && a.push(j, '}')) : i && a.push('}'), V(a, { shouldBreak: !0 });
   }
   function pr(e) {
    var t, r;
   ...
   function hr(e, t, r) {
    let { node: n } = e;
    if (we(n, t)) return [Gt(n, t), V(Wt(e, t, r)), P(Jt(n, t)), ...qt(n, t), Nt(n, t)];
    let a = 1 === n.children.length && ('interpolation' === n.firstChild.type || 'angularIcuExpression' === n.firstChild.type) && n.firstChild.isLeadingSpaceSensitive && !n.firstChild.hasLeadingSpaces && n.lastChild.isTrailingSpaceSensitive && !n.lastChild.hasTrailingSpaces,
     ...
     s = (a) => V([V(Wt(e, t, r), { id: i }), a, qt(n, t)]);
    return 0 === n.children.length
     ...
     : s([
        ...
        a
         ...
         : (!Ce(n) && !Ge(n, t)) || 'root' !== n.parent.type || 'vue' !== t.parser || t.vueIndentScriptAndStyle
           ? B(o)
           : o),
        (n.next ? Bt(n.next) : Ht(n.parent)) ? (n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive ? ' ' : '') : a ? z(W, '', { groupId: i }) : n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive ? U : ('comment' === n.lastChild.type || ('text' === n.lastChild.type && n.isWhitespaceSensitive && n.isIndentationSensitive)) && new RegExp(`\\n[\\t ]{${t.tabWidth * (e.ancestors.length - 1)}}$`, 'u').test(n.lastChild.value) ? '' : W,
       ]);
    var o;
   }
   function dr(e) {
   ...
   ((wr = Sr || (Sr = {}))[(wr.WARNING = 0)] = 'WARNING'), (wr[(wr.ERROR = 1)] = 'ERROR');
   var xr = class {
     constructor(e, t, r = Sr.ERROR) {
      (this.span = e), (this.msg = t), (this.level = r);
     }
     contextualMessage() {
      let e = this.span.start.getContext(100, 3);
      return e ? `${this.msg} ("${e.before}[${Sr[this.level]} ->]${e.after}")` : this.msg;
     }
     toString() {
    ...
    Tr = [
       ...
       if (e.children)
        for (let r = 0; r < e.children.length; r++) {
         ...
         let a = n.prev,
          i = n.firstChild;
         e.removeChild(a), r--;
         let s = new Cr(a.sourceSpan.start, i.sourceSpan.end),
          o = new Cr(s.start, n.sourceSpan.end);
       ...
       e.walk((e) => {
        if (e.children)
         for (let n = 0; n < e.children.length; n++) {
          ...
          let i = a.prev;
          !i || 'text' !== i.type || ((i.value += a.value), (i.sourceSpan = new Cr(i.sourceSpan.start, a.sourceSpan.end)), e.removeChild(a), n--);
         }
       });
      })(
       e,
       ...
       if (
        ...
        for (let t of e.children) {
         ...
         for (let r = 0; r < i.length; r++, n = a) {
          let s = i[r];
          r % 2 != 0 ? ((a = n.moveBy(s.length + 4)), e.insertChildBefore(t, { type: 'interpolation', sourceSpan: new Cr(n, a), children: 0 === s.length ? [] : [{ type: 'text', value: s, sourceSpan: new Cr(n.moveBy(2), a.moveBy(-2)) }] })) : ((a = n.moveBy(s.length)), s.length > 0 && e.insertChildBefore(t, { type: 'text', value: s, sourceSpan: new Cr(n, a) }));
         }
         e.removeChild(t);
        }
      });
     ...
     function (e) {
      e.walk((e) => {
       ...
       let r = (function (e) {
         return Ce(e) || 'interpolation' === e.type || xe(e);
        })(e),
        n = xe(e);
       if (!r)
        for (let a = 0; a < t.length; a++) {
         ...
         let { leadingWhitespace: n, text: i, trailingWhitespace: s } = Se(r.value),
          o = r.prev,
          l = r.next;
         i ? ((r.value = i), (r.sourceSpan = new Cr(r.sourceSpan.start.moveBy(n.length), r.sourceSpan.end.moveBy(-s.length))), n && (o && (o.hasTrailingSpaces = !0), (r.hasLeadingSpaces = !0)), s && ((r.hasTrailingSpaces = !0), l && (l.hasLeadingSpaces = !0))) : (e.removeChild(r), a--, (n || s) && (o && (o.hasTrailingSpaces = !0), l && (l.hasLeadingSpaces = !0)));
        }
       ...
       e.cssDisplay = (function (e, t) {
        ...
        switch (t.htmlWhitespaceSensitivity) {
         ...
         case 'ignore':
          return 'block';
         default:
          return ('element' === e.type && (!e.namespace || n || ye(e)) && me[e.name]) || fe;
        }
       })(e, t);
      });
     },
     ...
     function (e, t) {
      e.walk((e) => {
       let { children: r } = e;
       if (r) {
        if (0 === r.length) return void (e.isDanglingSpaceSensitive = Le(e));
        for (let e of r) (e.isLeadingSpaceSensitive = Te(e, t)), (e.isTrailingSpaceSensitive = Ee(e, t));
      ...
      e.walk((e) => {
       if (e.children)
        for (let r = 0; r < e.children.length; r++) {
         ...
         let a = n.prev,
          i = n.next;
         (a.value += `<${n.rawName}>` + n.firstChild.value + `</${n.rawName}>` + i.value), (a.sourceSpan = new Cr(a.sourceSpan.start, i.sourceSpan.end)), (a.isTrailingSpaceSensitive = i.isTrailingSpaceSensitive), (a.hasTrailingSpaces = i.hasTrailingSpaces), e.removeChild(n), r--, e.removeChild(i);
        }
      });
     },
    ];
   var Er = function (e, t) {
    for (let r of Tr) r(e, t);
    return e;
   };
   var Lr = {
     preprocess: Er,
     print: function (e, t, r) {
      ...
      switch (n.type) {
       case 'front-matter':
        return P(n.raw);
       case 'root':
        return t.__onHtmlRoot && t.__onHtmlRoot(n), [V(cr(e, t, r)), j];
       case 'element':
       case 'ieConditionalComment':
        return hr(e, t, r);
       ...
       case 'angularIcuExpression':
        return (function (e, t, r) {
         let { node: n } = e;
         return [jt(n, t), V([n.switchValue.trim(), ', ', n.clause, n.cases.length > 0 ? [',', B([U, X(U, e.map(r, 'cases'))])] : '', W]), Ft(n, t)];
        })(e, t, r);
       case 'angularIcuCase':
        return (function (e, t, r) {
         let { node: n } = e;
       ...
       case 'ieConditionalEndComment':
        return [jt(n), Ft(n)];
       case 'interpolation':
        return [jt(n, t), ...e.map(r, 'children'), Ft(n, t)];
       case 'text': {
       ...
       case 'docType':
        return [V([jt(n, t), ' ', p(!1, n.value.replace(/^html\b/iu, 'html'), /\s+/gu, ' ')]), Ft(n, t)];
       case 'comment':
        return [Gt(n, t), P(t.originalText.slice(Lt(n), Rt(n))), Nt(n, t)];
       case 'attribute': {
    ...
    Nr = {};
   i(Nr, { angular: () => ba, html: () => ya, lwc: () => wa, vue: () => Sa });
   var Dr, Mr, Ar;
   !(function (e) {
   ...
   function Wr(e) {
    return 'ng-container' === Ur(e)[1];
   }
   function jr(e) {
    return 'ng-content' === Ur(e)[1];
   }
   function Gr(e) {
    return null === e ? null : Ur(e)[0];
   }
   function Xr(e, t) {
    return e ? `:${e}:${t}` : t;
   }
   function Zr() {
    return Or || ((Or = {}), Yr(Br.HTML, ['iframe|srcdoc', '*|innerHTML', '*|outerHTML']), Yr(Br.STYLE, ['*|style']), Yr(Br.URL, ['*|formAction', 'area|href', 'area|ping', 'audio|src', 'a|href', 'a|ping', 'blockquote|cite', 'body|background', 'del|cite', 'form|action', 'img|src', 'input|src', 'ins|cite', 'q|cite', 'source|src', 'track|src', 'video|poster', 'video|src']), Yr(Br.RESOURCE_URL, ['applet|code', 'applet|codebase', 'base|href', 'embed|src', 'frame|src', 'head|profile', 'html|manifest', 'iframe|src', 'link|href', 'media|src', 'object|codebase', 'object|data', 'script|src'])), Or;
   }
   function Yr(e, t) {
   ...
   var Jr = class {},
    ...
    Qr = new Map(Object.entries({ class: 'className', for: 'htmlFor', formaction: 'formAction', innerHtml: 'innerHTML', readonly: 'readOnly', tabindex: 'tabIndex' })),
    en = Array.from(Qr).reduce((e, [t, r]) => (e.set(t, r), e), new Map()),
    tn = class extends Jr {
     constructor() {
      super(),
     ...
     hasProperty(e, t, r) {
      ...
      if (e.indexOf('-') > -1) {
       if (Wr(e) || jr(e)) return !1;
       if (r.some((e) => e.name === zr)) return !0;
      }
      return (this._schema.get(e.toLowerCase()) || this._schema.get('unknown')).has(t);
     }
     hasElement(e, t) {
      return !!(t.some((e) => e.name === $r) || (e.indexOf('-') > -1 && (Wr(e) || jr(e) || t.some((e) => e.name === zr)))) || this._schema.has(e.toLowerCase());
     }
     ...
     normalizeAnimationStyleProperty(e) {
      return (function (e) {
       return e.replace(br, (...e) => e[1].toUpperCase());
      })(e);
     }
   ...
   var rn,
    nn,
    an = class {
     constructor({ closedByChildren: e, implicitNamespacePrefix: t, contentType: r = Vr.PARSABLE_DATA, closedByParent: n = !1, isVoid: a = !1, ignoreFirstLf: i = !1, preventNamespaceInheritance: s = !1, canSelfClose: o = !1 } = {}) {
   ...
   function sn(e) {
    return (
     nn ||
      ((rn = new an({ canSelfClose: !0 })),
      (nn = Object.assign(Object.create(null), { base: new an({ isVoid: !0 }), meta: new an({ isVoid: !0 }), area: new an({ isVoid: !0 }), embed: new an({ isVoid: !0 }), link: new an({ isVoid: !0 }), img: new an({ isVoid: !0 }), input: new an({ isVoid: !0 }), param: new an({ isVoid: !0 }), hr: new an({ isVoid: !0 }), br: new an({ isVoid: !0 }), source: new an({ isVoid: !0 }), track: new an({ isVoid: !0 }), wbr: new an({ isVoid: !0 }), p: new an({ closedByChildren: ['address', 'article', 'aside', 'blockquote', 'div', 'dl', 'fieldset', 'footer', 'form', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'header', 'hgroup', 'hr', 'main', 'nav', 'ol', 'p', 'pre', 'section', 'table', 'ul'], closedByParent: !0 }), thead: new an({ closedByChildren: ['tbody', 'tfoot'] }), tbody: new an({ closedByChildren: ['tbody', 'tfoot'], closedByParent: !0 }), tfoot: new an({ closedByChildren: ['tbody'], closedByParent: !0 }), tr: new an({ closedByChildren: ['tr'], closedByParent: !0 }), td: new an({ closedByChildren: ['td', 'th'], closedByParent: !0 }), th: new an({ closedByChildren: ['td', 'th'], closedByParent: !0 }), col: new an({ isVoid: !0 }), svg: new an({ implicitNamespacePrefix: 'svg' }), foreignObject: new an({ implicitNamespacePrefix: 'svg', preventNamespaceInheritance: !0 }), math: new an({ implicitNamespacePrefix: 'math' }), li: new an({ closedByChildren: ['li'], closedByParent: !0 }), dt: new an({ closedByChildren: ['dt', 'dd'] }), dd: new an({ closedByChildren: ['dt', 'dd'], closedByParent: !0 }), rb: new an({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }), rt: new an({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }), rtc: new an({ closedByChildren: ['rb', 'rtc', 'rp'], closedByParent: !0 }), rp: new an({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }), optgroup: new an({ closedByChildren: ['optgroup'], closedByParent: !0 }), option: new an({ closedByChildren: ['option', 'optgroup'], closedByParent: !0 }), pre: new an({ ignoreFirstLf: !0 }), listing: new an({ ignoreFirstLf: !0 }), style: new an({ contentType: Vr.RAW_TEXT }), script: new an({ contentType: Vr.RAW_TEXT }), title: new an({ contentType: { default: Vr.ESCAPABLE_RAW_TEXT, svg: Vr.PARSABLE_DATA } }), textarea: new an({ contentType: Vr.ESCAPABLE_RAW_TEXT, ignoreFirstLf: !0 }) })),
      new tn().allKnownElementNames().forEach((e) => {
       !nn[e] && null === Gr(e) && (nn[e] = new an({ canSelfClose: !1 }));
      })),
     nn[e] ?? rn
    );
   }
   ...
   var qn = class {
    ...
    In = class {
     constructor(e, t, r) {
      (this._getTagContentType = t), (this._currentTokenStart = null), (this._currentTokenType = null), (this._expansionCaseStack = []), (this._inInterpolation = !1), (this._fullNameStack = []), (this.tokens = []), (this.errors = []), (this.nonNormalizedIcuExpressions = []), (this._tokenizeIcu = r.tokenizeExpansionForms || !1), (this._interpolationConfig = r.interpolationConfig || _n), (this._leadingTriviaCodePoints = r.leadingTriviaChars && r.leadingTriviaChars.map((e) => e.codePointAt(0) || 0)), (this._canSelfClose = r.canSelfClose || !1), (this._allowHtmComponentClosingTags = r.allowHtmComponentClosingTags || !1);
      let n = r.range || { endPos: e.content.length, startPos: 0, startLine: 0, startCol: 0 };
      (this._cursor = r.escapedString ? new On(e, n) : new Vn(e, n)), (this._preserveLineEndings = r.preserveLineEndings || !1), (this._i18nNormalizeLineEndingsInICUs = r.i18nNormalizeLineEndingsInICUs || !1), (this._tokenizeBlocks = r.tokenizeBlocks ?? !0), (this._tokenizeLet = r.tokenizeLet ?? !0);
      try {
       this._cursor.init();
      } catch (a) {
       this.handleError(a);
     ...
     _getBlockName() {
      ...
      return this._attemptCharCodeUntilFn((t) => (dr(t) ? !e : !Bn(t) || ((e = !0), !1))), this._cursor.getChars(t).trim();
     }
     _consumeBlockStart(e) {
      this._beginToken(25, e);
      let t = this._endToken([this._getBlockName()]);
      if (40 === this._cursor.peek()) {
       if ((this._cursor.advance(), this._consumeBlockParameters(), this._attemptCharCodeUntilFn(Fn), !this._attemptCharCode(41))) return void (t.type = 29);
       this._attemptCharCodeUntilFn(Fn);
      }
     ...
     _consumeBlockParameters() {
      for (this._attemptCharCodeUntilFn(Hn); 41 !== this._cursor.peek() && 0 !== this._cursor.peek(); ) {
       this._beginToken(28);
       let e = this._cursor.clone(),
        t = null,
        r = 0;
       ...
       this._endToken([this._cursor.getChars(e)]), this._attemptCharCodeUntilFn(Hn);
      }
     }
     _consumeLetDeclaration(e) {
      ...
      this._attemptCharCodeUntilFn(Fn), this._attemptCharCode(61) ? (this._attemptCharCodeUntilFn((e) => Fn(e) && !gr(e)), this._consumeLetDeclarationValue(), 59 === this._cursor.peek() ? (this._beginToken(32), this._endToken([]), this._cursor.advance()) : ((t.type = 33), (t.sourceSpan = this._cursor.getSpan(e)))) : (t.type = 33);
     }
     ...
     _consumeLetDeclarationValue() {
      ...
      for (this._beginToken(31, e); 0 !== this._cursor.peek(); ) {
       let e = this._cursor.peek();
       if (59 === e) break;
       yr(e) && (this._cursor.advance(), this._attemptCharCodeUntilFn((t) => (92 === t ? (this._cursor.advance(), !1) : t === e))), this._cursor.advance();
      }
     ...
     _endToken(e, t) {
      if (null === this._currentTokenStart) throw new Cn('Programming error - attempted to end a token when there was no start to the token', this._currentTokenType, this._cursor.getSpan(t));
      if (null === this._currentTokenType) throw new Cn('Programming error - attempted to end a token which has no token type', null, this._cursor.getSpan(this._currentTokenStart));
     ...
     _createError(e, t) {
      ...
      let r = new Cn(e, this._currentTokenType, t);
      return (this._currentTokenStart = null), (this._currentTokenType = null), new qn(r);
     }
     handleError(e) {
      if ((e instanceof zn && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), !(e instanceof qn))) throw e;
     ...
     _requireCharCode(e) {
      let t = this._cursor.clone();
      if (!this._attemptCharCode(e)) throw this._createError(Ln(this._cursor.peek()), this._cursor.getSpan(t));
     }
     _attemptStr(e) {
      let t = e.length;
     ...
     _requireStr(e) {
      let t = this._cursor.clone();
      if (!this._attemptStr(e)) throw this._createError(Ln(this._cursor.peek()), this._cursor.getSpan(t));
     }
     _requireStrCaseInsensitive(e) {
      let t = this._cursor.clone();
      if (!this._attemptStrCaseInsensitive(e)) throw this._createError(Ln(this._cursor.peek()), this._cursor.getSpan(t));
     }
     ...
     _requireCharCodeUntilFn(e, t) {
      let r = this._cursor.clone();
      if ((this._attemptCharCodeUntilFn(e), this._cursor.diff(r) < t)) throw this._createError(Ln(this._cursor.peek()), this._cursor.getSpan(r));
     }
     _attemptUntilChar(e) {
     ...
     _consumeEntity(e) {
      ...
      if ((this._cursor.advance(), this._attemptCharCode(35))) {
       ...
       if ((this._attemptCharCodeUntilFn(Dn), 59 != this._cursor.peek())) {
        this._cursor.advance();
        let r = e ? Tn.HEX : Tn.DEC;
       ...
       try {
        ...
        throw this._createError(Rn(this._cursor.getChars(t)), this._cursor.getSpan());
       }
      } else {
       let r = this._cursor.clone();
       if ((this._attemptCharCodeUntilFn(Mn), 59 != this._cursor.peek())) this._beginToken(e, t), (this._cursor = r), this._endToken(['&']);
       else {
        let e = this._cursor.getChars(r);
        this._cursor.advance();
        let n = wn[e];
        if (!n) throw this._createError(Rn(e), this._cursor.getSpan(t));
        this._endToken([n, `&${e};`]);
       }
      }
     }
     ...
     _consumePrefixAndName() {
      let e,
       t = this._cursor.clone(),
       r = '';
      for (; 58 !== this._cursor.peek() && !Nn(this._cursor.peek()); ) this._cursor.advance();
      return 58 === this._cursor.peek() ? ((r = this._cursor.getChars(t)), this._cursor.advance(), (e = this._cursor.clone())) : (e = t), this._requireCharCodeUntilFn(Pn, '' === r ? 0 : 1), [r, this._cursor.getChars(e)];
     }
     _consumeTagOpen(e) {
      let t,
       r,
       ...
       a = [];
      try {
       if (!mr(this._cursor.peek())) throw this._createError(Ln(this._cursor.peek()), this._cursor.getSpan(e));
       for (n = this._consumeTagOpenStart(e), r = n.parts[0], t = n.parts[1], this._attemptCharCodeUntilFn(Fn); 47 !== this._cursor.peek() && 62 !== this._cursor.peek() && 60 !== this._cursor.peek() && 0 !== this._cursor.peek(); ) {
        let [e, t] = this._consumeAttributeName();
        if ((this._attemptCharCodeUntilFn(Fn), this._attemptCharCode(61))) {
         this._attemptCharCodeUntilFn(Fn);
       ...
       if (s instanceof qn) return void (n ? (n.type = 4) : (this._beginToken(5, e), this._endToken(['<'])));
       throw s;
      }
     ...
     _consumeAttributeName() {
      let e = this._cursor.peek();
      if (39 === e || 34 === e) throw this._createError(Ln(e), this._cursor.getSpan());
      this._beginToken(14);
      let t = this._consumePrefixAndName();
     ...
     _consumeTagClose(e) {
      if ((this._beginToken(3, e), this._attemptCharCodeUntilFn(Fn), this._allowHtmComponentClosingTags && this._attemptCharCode(47))) this._attemptCharCodeUntilFn(Fn), this._requireCharCode(62), this._endToken([]);
      else {
       let [e, t] = this._consumePrefixAndName();
       this._attemptCharCodeUntilFn(Fn), this._requireCharCode(62), this._endToken([e, t]), this._handleFullNameStackForTagClose(e, t);
      }
     }
     _consumeExpansionFormStart() {
      ...
      this._requireCharCode(44), this._attemptCharCodeUntilFn(Fn), this._beginToken(7);
      let r = this._readUntil(44);
      this._endToken([r]), this._requireCharCode(44), this._attemptCharCodeUntilFn(Fn);
     }
     _consumeExpansionCaseStart() {
      this._beginToken(21);
      let e = this._readUntil(123).trim();
      this._endToken([e]), this._attemptCharCodeUntilFn(Fn), this._beginToken(22), this._requireCharCode(123), this._endToken([]), this._attemptCharCodeUntilFn(Fn), this._expansionCaseStack.push(22);
     }
     _consumeExpansionCaseEnd() {
      this._beginToken(23), this._requireCharCode(125), this._endToken([]), this._attemptCharCodeUntilFn(Fn), this._expansionCaseStack.pop();
     }
     ...
     _consumeInterpolation(e, t, r) {
      ...
      for (; 0 !== this._cursor.peek() && (null === r || !r()); ) {
       ...
       let t = this._cursor.peek();
       this._cursor.advance(), 92 === t ? this._cursor.advance() : t === i ? (i = null) : !s && null === i && yr(t) && (i = t);
      }
   ...
   var Vn = class e {
     ...
     advanceState(e) {
      if (e.offset >= this.end) throw ((this.state = e), new zn('Unexpected character "EOF"', this));
      let t = this.charAt(e.offset);
      10 === t ? (e.line++, (e.column = 0)) : gr(t) || e.column++, e.offset++, this.updatePeek(e);
     }
     updatePeek(e) {
      e.peek = e.offset >= this.end ? 0 : this.charAt(e.offset);
     }
     locationFromCursor(e) {
      return new kr(e.file, e.state.offset, e.state.line, e.state.column);
     }
    },
    On = class e extends Vn {
     constructor(t, r) {
      ...
      if (92 === e())
       if (((this.internalState = { ...this.state }), this.advanceState(this.internalState), 110 === e())) this.state.peek = 10;
        ...
        let t = '',
         r = 0,
         n = this.clone();
        for (; vr(e()) && r < 3; ) (n = this.clone()), (t += String.fromCodePoint(e())), this.advanceState(this.internalState), r++;
        (this.state.peek = parseInt(t, 8)), (this.internalState = n.internalState);
       } else gr(this.internalState.peek) ? (this.advanceState(this.internalState), (this.state = this.internalState)) : (this.state.peek = this.internalState.peek);
     }
     decodeHexDigits(e, t) {
      let r = this.input.slice(e.internalState.offset, e.internalState.offset + t),
       n = parseInt(r, 16);
      if (isNaN(n)) throw ((e.state = e.internalState), new zn('Invalid hexadecimal escape sequence', e));
      return n;
     }
    },
    zn = class {
    ...
    Wn = class {
     ...
     parse(e, t, r, n = !1, a) {
      let i =
       ...
       h = new jn(c.tokens, s, u, p, n);
      return h.build(), new Un(h.rootNodes, c.errors.concat(h.errors));
     }
    },
    jn = class e {
     constructor(e, t, r, n, a) {
     ...
     build() {
      ...
      for (let e of this._containerStack) e instanceof gn && this.errors.push($n.create(e.name, e.sourceSpan, `Unclosed block "${e.name}"`));
     }
     _advance() {
      let e = this._peek;
     ...
     _consumeCdata(e) {
      ...
      this._addToParent(new cn(r, new Cr(e.sourceSpan.start, (n || t).sourceSpan.end), [t]));
     }
     _consumeComment(e) {
      let t = this._advanceIf(7),
       r = this._advanceIf(11),
       n = null != t ? t.parts[0].trim() : null,
       a = null == r ? e.sourceSpan : new Cr(e.sourceSpan.start, r.sourceSpan.end, e.sourceSpan.fullStart);
      this._addToParent(new fn(n, a));
     }
     _consumeDocType(e) {
      let t = this._advanceIf(7),
       r = this._advanceIf(19),
       n = null != t ? t.parts[0].trim() : null,
       a = new Cr(e.sourceSpan.start, (r || t || e).sourceSpan.end);
      this._addToParent(new mn(n, a));
     }
     _consumeExpansion(e) {
      let t = this._advance(),
       r = this._advance(),
      ...
      if (24 !== this._peek.type) return void this.errors.push($n.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '}'."));
      let a = new Cr(e.sourceSpan.start, this._peek.sourceSpan.end, e.sourceSpan.fullStart);
      this._addToParent(new un(t.parts[0], r.parts[0], n, a, t.sourceSpan)), this._advance();
     }
     _parseExpansionCase() {
      let t = this._advance();
      if (22 !== this._peek.type) return this.errors.push($n.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null;
      let r = this._advance(),
      ...
      let s = new Cr(t.sourceSpan.start, a.sourceSpan.end, t.sourceSpan.fullStart),
       o = new Cr(r.sourceSpan.start, a.sourceSpan.end, r.sourceSpan.fullStart);
      return new pn(t.parts[0], i.rootNodes, s, t.sourceSpan, o);
     }
     _collectExpansionExpTokens(e) {
      ...
      for (;;) {
       if (((20 === this._peek.type || 22 === this._peek.type) && r.push(this._peek.type), 23 === this._peek.type)) {
        if (!Gn(r, 22)) return this.errors.push($n.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
        if ((r.pop(), 0 === r.length)) return t;
       }
       if (24 === this._peek.type) {
        if (!Gn(r, 20)) return this.errors.push($n.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
        r.pop();
       }
       if (34 === this._peek.type) return this.errors.push($n.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
     ...
     _consumeText(e) {
      ...
      for (; 8 === this._peek.type || 5 === this._peek.type || 9 === this._peek.type; ) (e = this._advance()), t.push(e), 8 === e.type ? (n += e.parts.join('').replace(/&([^;]+);/g, Xn)) : 9 === e.type ? (n += e.parts[0]) : (n += e.parts.join(''));
      if (n.length > 0) {
       let a = e.sourceSpan;
       this._addToParent(new ln(n, new Cr(r.start, a.end, r.fullStart, r.details), t));
      }
     }
     _closeVoidElement() {
     ...
     _consumeStartTag(e) {
      ...
      if (2 === this._peek.type) {
       ...
       this.canSelfClose || t.canSelfClose || null !== Gr(a) || t.isVoid || this.errors.push($n.create(a, e.sourceSpan, `Only void, custom and foreign elements can be self closed "${e.parts[1]}"`));
      } else 1 === this._peek.type && (this._advance(), (i = !1));
      let s = this._peek.sourceSpan.fullStart,
       o = new Cr(e.sourceSpan.start, s, e.sourceSpan.fullStart),
       l = new Cr(e.sourceSpan.start, s, e.sourceSpan.fullStart),
       c = new Cr(e.sourceSpan.start.moveBy(1), e.sourceSpan.end),
       u = new dn(a, n, [], o, l, void 0, c),
       p = this._getContainer();
      this._pushContainer(u, p instanceof dn && this.getTagDefinition(p.name).isClosedByChild(u.name)), i ? this._popContainer(a, dn, o) : 4 === e.type && (this._popContainer(a, dn, null), this.errors.push($n.create(a, o, `Opening tag "${a}" not terminated.`)));
     }
     _pushContainer(e, t) {
     ...
     _consumeEndTag(e) {
      ...
      if (t && this.getTagDefinition(t).isVoid) this.errors.push($n.create(t, e.sourceSpan, `Void elements do not have end tags "${e.parts[1]}"`));
       ...
       this.errors.push($n.create(t, e.sourceSpan, r));
      }
     }
     _popContainer(e, t, r) {
      let n = !1;
      for (let a = this._containerStack.length - 1; a >= 0; a--) {
       ...
       if (Gr(i.name) ? i.name === e : (null == e || i.name.toLowerCase() === e.toLowerCase()) && i instanceof t) return (i.endSourceSpan = r), (i.sourceSpan.end = null !== r ? r.end : i.sourceSpan.end), this._containerStack.splice(a, this._containerStack.length - a), !n;
       (i instanceof gn || (i instanceof dn && !this.getTagDefinition(i.name).closedByParent)) && (n = !0);
      }
      return !1;
     }
     _consumeAttr(e) {
      let t,
       r = Xr(e.parts[0], e.parts[1]),
       n = e.sourceSpan.end;
      ...
      if (16 === this._peek.type)
       for (a = this._peek.sourceSpan, i = this._peek.sourceSpan.end; 16 === this._peek.type || 17 === this._peek.type || 9 === this._peek.type; ) {
        let e = this._advance();
        o.push(e), 17 === e.type ? (s += e.parts.join('').replace(/&([^;]+);/g, Xn)) : 9 === e.type ? (s += e.parts[0]) : (s += e.parts.join('')), (i = n = e.sourceSpan.end);
       }
      15 === this._peek.type && (i = n = this._advance().sourceSpan.end);
      let l = a && i && new Cr((null == t ? void 0 : t.sourceSpan.start) ?? a.start, i, (null == t ? void 0 : t.sourceSpan.fullStart) ?? a.fullStart);
      return new hn(r, s, new Cr(e.sourceSpan.start, n, e.sourceSpan.fullStart), e.sourceSpan, l, o.length > 0 ? o : void 0, void 0);
     }
     _consumeBlockOpen(e) {
      let t = [];
      for (; 28 === this._peek.type; ) {
       let e = this._advance();
       t.push(new vn(e.parts[0], e.sourceSpan));
      }
      26 === this._peek.type && this._advance();
      let r = this._peek.sourceSpan.fullStart,
       n = new Cr(e.sourceSpan.start, r, e.sourceSpan.fullStart),
       a = new Cr(e.sourceSpan.start, r, e.sourceSpan.fullStart),
       i = new gn(e.parts[0], t, [], n, e.sourceSpan, a);
      this._pushContainer(i, !1);
     }
     _consumeBlockClose(e) {
      this._popContainer(null, gn, e.sourceSpan) || this.errors.push($n.create(null, e.sourceSpan, 'Unexpected closing block. The block may have been closed earlier. If you meant to write the } character, you should use the "&#125;" HTML entity instead.'));
     }
     _consumeIncompleteBlock(e) {
      ...
      let r = this._peek.sourceSpan.fullStart,
       ...
       a = new Cr(e.sourceSpan.start, r, e.sourceSpan.fullStart),
       i = new gn(e.parts[0], t, [], n, e.sourceSpan, a);
      this._pushContainer(i, !1), this._popContainer(null, gn, null), this.errors.push($n.create(e.parts[0], n, `Incomplete block "${e.parts[0]}". If you meant to write the @ character, you should use the "&#64;" HTML entity instead.`));
     }
     _consumeLet(e) {
      let t,
       r,
       n = e.parts[0];
      if (31 !== this._peek.type) return void this.errors.push($n.create(e.parts[0], e.sourceSpan, `Invalid @let declaration "${n}". Declaration must have a value.`));
      if (((t = this._advance()), 32 !== this._peek.type)) return void this.errors.push($n.create(e.parts[0], e.sourceSpan, `Unterminated @let declaration "${n}". Declaration must be terminated with a semicolon.`));
      r = this._advance();
      let a = r.sourceSpan.fullStart,
       i = new Cr(e.sourceSpan.start, a, e.sourceSpan.fullStart),
       s = e.sourceSpan.toString().lastIndexOf(n),
       o = e.sourceSpan.start.moveBy(s),
       l = new Cr(o, e.sourceSpan.end),
       c = new yn(n, t.parts[0], i, l, t.sourceSpan);
      this._addToParent(c);
     }
     _consumeIncompleteLet(e) {
      ...
      if (t.length > 0) {
       let r = e.sourceSpan.toString().lastIndexOf(t),
        ...
        a = new Cr(n, e.sourceSpan.end),
        i = new Cr(e.sourceSpan.start, e.sourceSpan.start.moveBy(0)),
        s = new yn(t, '', e.sourceSpan, a, i);
       this._addToParent(s);
      }
      this.errors.push($n.create(e.parts[0], e.sourceSpan, `Incomplete @let declaration${r}. @let declarations must be written as \`@let <name> = <value>;\``));
     }
     _getContainer() {
     ...
     _getElementFullName(e, t, r) {
      if ('' === e && '' === (e = this.getTagDefinition(t).implicitNamespacePrefix || '') && null != r) {
       let t = Ur(r.name)[1];
       this.getTagDefinition(t).preventNamespaceInheritance || (e = Gr(r.name));
      }
      return Xr(e, t);
     }
    };
   ...
   function Xn(e, t) {
    return void 0 !== wn[t] ? wn[t] || e : /^#x[a-f0-9]+$/i.test(t) ? String.fromCodePoint(parseInt(t.slice(2), 16)) : /^#\d+$/.test(t) ? String.fromCodePoint(parseInt(t.slice(1), 10)) : e;
   }
   ...
   function Kn(e, t = {}) {
    ...
    return Jn().parse(e, 'angular-html-parser', { tokenizeExpansionForms: s, interpolationConfig: void 0, canSelfClose: r, allowHtmComponentClosingTags: n, tokenizeBlocks: s, tokenizeLet: o }, a, i);
   }
   var Qn = function (e, t) {
   ...
   var ta,
    ...
    aa = function (e) {
     let t = (function (e) {
      ...
      let l = e.slice(0, s);
      return { type: 'front-matter', language: i, explicitLanguage: n, value: e.slice(r + 1, a), startDelimiter: t, endDelimiter: l.slice(-ea), raw: l };
     })(e);
     if (!t) return { content: e };
     let { raw: r } = t;
     return { frontMatter: t, content: p(!1, r, /[^\n]/gu, ' ') + e.slice(r.length) };
    },
    ia = { attrs: !0, children: !0, cases: !0, expression: !0 },
    sa = new Set(['parent']);
   (ta = new WeakSet()),
    (ra = function () {
   ...
   var oa = class e {
    constructor(e = {}) {
     c(this, ta), s(this, 'type'), s(this, 'parent');
     for (let t of new Set([...sa, ...Object.keys(e)])) this.setProperty(t, e[t]);
    }
    setProperty(e, t) {
     if (this[e] !== t) {
      if ((e in ia && (t = t.map((e) => this.createChild(e))), !sa.has(e))) return void (this[e] = t);
    ...
    map(t) {
     ...
     for (let n in ia) {
      let a = this[n];
      if (a) {
       let i = la(a, (e) => e.map(t));
       r !== a && (r || (r = new e({ parent: this.parent })), r.setProperty(n, i));
      }
     }
     if (r) for (let e in this) e in ia || (r[e] = this[e]);
     return t(r || this);
    }
    walk(e) {
     for (let t in ia) {
      ...
      let [, n, a, i] = r,
       ...
       [c, u] = (() => {
        try {
         ...
         return [!1, [{ type: 'text', value: i, sourceSpan: new Cr(o, l) }]];
        }
       })();
      return { type: 'ieConditionalComment', complete: c, children: u, condition: p(!1, a.trim(), /\s+/gu, ' '), sourceSpan: e.sourceSpan, startSourceSpan: new Cr(e.sourceSpan.start, o), endSourceSpan: new Cr(l, e.sourceSpan.end) };
     },
    },
    {
     regex: /^\[if([^\]]*)\]><!$/u,
   ...
   function ha(e, t, r) {
    let { name: n, canSelfClose: a = !0, normalizeTagName: i = !1, normalizeAttributeName: s = !1, allowHtmComponentClosingTags: o = !1, isTagNameCaseSensitive: l = !1, shouldParseAsRawText: c } = t,
     { rootNodes: u, errors: p } = Kn(e, { canSelfClose: a, allowHtmComponentClosingTags: o, isTagNameCaseSensitive: l, getTagContentType: c ? (...e) => (c(...e) ? Vr.RAW_TEXT : void 0) : void 0, tokenizeAngularBlocks: 'angular' === n || void 0, tokenizeAngularLetDeclaration: 'angular' === n || void 0 });
    if ('vue' === n) {
     if (u.some((e) => ('docType' === e.type && 'html' === e.value) || ('element' === e.type && 'html' === e.name.toLowerCase()))) return ha(e, va, r);
     let t,
      n = () => t ?? (t = Kn(e, { canSelfClose: a, allowHtmComponentClosingTags: o, isTagNameCaseSensitive: l })),
      ...
      new (class extends Sn {
       ...
       visit(e) {
        ((e) => {
         ...
         ((e) => {
          if ('element' === e.type) {
           let t = sn(l ? e.name : e.name.toLowerCase());
           !e.namespace || e.namespace === t.implicitNamespacePrefix || ye(e) ? (e.tagDefinition = t) : (e.tagDefinition = sn(''));
          }
         })(e),
         ((e) => {
          if ('element' === e.type && (i && (!e.namespace || e.namespace === e.tagDefinition.implicitNamespacePrefix || ye(e)) && (e.name = d(e.name, (e) => pa.has(e))), s)) for (let t of e.attrs) t.namespace || (t.name = d(t.name, (t) => ua.has(e.name) && (ua.get('*').has(t) || ua.get(e.name).has(t))));
         })(e),
         ((e) => {
          e.sourceSpan && e.endSourceSpan && (e.sourceSpan = new Cr(e.sourceSpan.start, e.endSourceSpan.end));
         })(e);
       }
      })(),
      u,
   ...
   function fa(e) {
    ...
    throw Qn(t, { loc: { start: { line: r.line + 1, column: r.col + 1 }, end: { line: n.line + 1, column: n.col + 1 } }, cause: e });
   }
   function ma(e, t, r = {}, n = !0) {
    let { frontMatter: a, content: i } = n ? aa(e) : { frontMatter: null, content: e },
     s = new _r(e, r.filepath),
     o = new kr(s, 0, 0, 0),
     l = o.moveBy(e.length),
     c = { type: 'root', sourceSpan: new Cr(o, l), children: ha(i, t, r) };
    if (a) {
     let e = new kr(s, 0, 0, 0),
      t = e.moveBy(a.raw.length);
     (a.sourceSpan = new Cr(e, t)), c.children.unshift(a);
    }
    let u = new oa(c),
     h = (n, a) => {
      let { offset: i } = a,
       s = ma(p(!1, e.slice(0, i), /[^\n\r]/gu, ' ') + n, t, r, !1);
      s.sourceSpan = new Cr(a, L(!1, s.children, -1).sourceSpan.end);
      let o = s.children[0];
      return o.length === i ? s.children.shift() : ((o.sourceSpan = new Cr(o.sourceSpan.start.moveBy(i), o.sourceSpan.end)), (o.value = o.value.slice(i))), s;
     };
    return (
     u.walk((e) => {
      if ('comment' === e.type) {
      ...
      (function (e) {
       if ('block' === e.type) {
        if (((e.name = p(!1, e.name.toLowerCase(), /\s+/gu, ' ').trim()), (e.type = 'angularControlFlowBlock'), !Et(e.parameters))) return void delete e.parameters;
        for (let t of e.parameters) t.type = 'angularControlFlowBlockParameter';
        e.parameters = { type: 'angularControlFlowBlockParameters', children: e.parameters, sourceSpan: new Cr(e.parameters[0].sourceSpan.start, L(!1, e.parameters, -1).sourceSpan.end) };
       }
      })(e),
       (function (e) {
        'letDeclaration' === e.type && ((e.type = 'angularLetDeclaration'), (e.id = e.name), (e.init = { type: 'angularLetDeclarationInitializer', sourceSpan: new Cr(e.valueSpan.start, e.valueSpan.end), value: e.value }), delete e.name, delete e.value);
       })(e),
       (function (e) {
   ...
   function ga(e) {
    return { parse: (t, r) => ma(t, e, r), hasPragma: ar, astFormat: 'html', locStart: Lt, locEnd: Rt };
   }
   var va = { name: 'html', normalizeTagName: !0, normalizeAttributeName: !0, allowHtmComponentClosingTags: !0 },
    ya = ga(va),
    ba = ga({ name: 'angular' }),
    Sa = ga({ name: 'vue', isTagNameCaseSensitive: !0, shouldParseAsRawText: (e, t, r, n) => 'html' !== e.toLowerCase() && !r && ('template' !== e || n.some(({ name: e, value: t }) => 'lang' === e && 'html' !== t && '' !== t && void 0 !== t)) }),
    wa = ga({ name: 'lwc', canSelfClose: !1 }),
    ka = { html: Rr },
    _a = u;
  },
 },
