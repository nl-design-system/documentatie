...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [82190],
 {
  ...
  40220: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => g, contentTitle: () => m, default: () => v, frontMatter: () => p, metadata: () => h, toc: () => b });
   var o = l(52676),
    t = l(24785),
    s = l(98480),
    r = l(91050);
  ...
  98480: (e, n, l) => {
   ...
   const v = (e) => {
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (C = await a.ZP.format(Z, { parser: x, plugins: [s.Z, r.ZP, i.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), P(C);
     })();
    }, [Z]);
    const F = (0, c.useId)();
    let D = c.Fragment;
    return (
     'paragraph' === j ? (D = g) : 'document' === j ? (D = b) : 'surface' === j && (D = _),
     (0, h.jsxs)('div', {
      ...
      children: [
       ...
       f &&
        (0, h.jsxs)('div', {
         ...
         hidden: !z,
         children: [
          (0, h.jsx)(m.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: C, trim: !0 }),
          l &&
           (0, h.jsx)('div', {
    ...
    return (
     ...
     (0, d.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, d.jsx)(o.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': h, style: l, children: t.map((e, l) => (0, d.jsxs)('span', { ...s({ line: e }), children: [n && (0, d.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, d.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
   ...
   const c = (0, i.createContext)({}),
    u = (e) => {
     ...
     const m = { do: 'Doen', dont: 'Niet doen' },
      h = p ? 'figure' : 'div',
      g = p ? 'figcaption' : 'div';
     return (0, a.jsxs)(h, { className: (0, r.Z)(d['nlds-guideline'], d[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(g, { className: (0, r.Z)(d['nlds-guideline__description']), children: ['dont' === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(s.nv, { className: (0, r.Z)(d['nlds-guideline__badge'], d[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: d['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: d['nlds-guideline__title'], children: m.dont })] }), (0, a.jsx)(s.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(s.nv, { className: (0, r.Z)(d['nlds-guideline__badge'], d[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: d['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: d['nlds-guideline__title'], children: m.do })] }), (0, a.jsx)(s.nv, { children: n })] }), i] }), (0, a.jsx)('div', { className: (0, r.Z)(d['nlds-guideline__example']), children: (0, a.jsx)(c.Provider, { value: { title: n, type: m[l] }, children: u }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => i, a: () => r });
