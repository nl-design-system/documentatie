 ...
 [42843],
 {
  1292(e, n, t) {
   ...
   var r = t(29181),
    ...
    a = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(i.A, {}), github: (0, d.jsx)(o.A, {}), npm: (0, d.jsx)(l.A, {}), storybook: (0, d.jsx)(s.A, {}) },
    u = ({ brand: e }) => (0, d.jsx)(r.In, { children: c[e] || (0, d.jsx)(a.A, {}) });
  },
  4964(e, n, t) {
   t.d(n, { Ay: () => l });
   var r = t(86070),
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => h, mJ: () => m, VZ: () => y, cR: () => z, Pv: () => g, qZ: () => l, kD: () => k, B2: () => p, Pc: () => a, f4: () => s, GT: () => b, fX: () => o, eQ: () => f, B_: () => v, o_: () => x, Rc: () => w });
   ...
   const u = (e) => [...e].sort((e, n) => d.indexOf(e) - d.indexOf(n)),
    ...
    m = (e) => u(c(e.projects.flatMap((e) => j(e)))),
    g = (e) => {
     const n = j(e),
      t = ((e) => {
     ...
     return n.map((n) => {
      const r = e.tasks
       ...
       .map(({ name: r, id: i, value: o }) => {
        ...
        return { brand: l.toLowerCase(), name: r, id: i, value: o, description: s };
       });
  ...
  36378(e, n, t) {
   (t.r(n), t.d(n, { assets: () => B, component: () => $, contentTitle: () => H, default: () => U, description: () => P, frontMatter: () => Z, issueNumber: () => O, metadata: () => r, title: () => G, toc: () => W }));
  ...
  80506(e, n, t) {
   ...
   const m = ({ component: e, headingLevel: n }) => {
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(h.p, { level: n, suffix: i && (0, d.jsx)(u.D, { state: i }), children: e.title }), (0, d.jsx)(r.fz, { lead: !0, children: t })] });
    };
  },
  83329(e, n, t) {
   t.d(n, { Ay: () => l });
   ...
   const l = ({ background: e, children: n, className: t, ...r }) => (0, o.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, t), ...r, children: n }),
    ...
    a = ({ href: e, appearance: n, className: t, component: l = 'div', background: s, children: a }) => {
     const d = (e) => ('article' === l ? (0, o.jsx)('article', { ...e }) : 'section' === l ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      c = (0, o.jsx)(d, { className: (0, i.A)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: a });
