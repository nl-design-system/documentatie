/*! For license information please see 0f180809.b5eda262.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [42115],
 {
  61804: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => l, default: () => p, frontMatter: () => d, metadata: () => g, toc: () => c });
   var t = i(52676),
    a = i(40139),
    s = i(98227),
    r = i(97247),
  ...
  98227: (e, n, i) => {
   ...
   const g = new Date().toISOString(),
    m = (e) => {
     let { lang: n = 'nl', headingLevel: i = 3, title: m, speakers: c, signupLink: h, organisation: p, videoId: u, children: k, captioned: v, captionLink: j, session: w } = e;
     return (0, l.jsxs)('article', {
      ...
      children: [
       ...
       u || w?.videoId ? (0, l.jsx)(d.Y, { id: u || w?.videoId, title: m }) : (0, l.jsxs)(r.nv, { className: 'dsw-session__subtitle', lead: !0, children: [c.map((e) => e.name).join(' & '), p ? ', ' + p : ''] }),
       w && w.isoDateTime && w.isoDateTime > g && w.icalLink && !u ? (0, l.jsx)(r.nv, { children: (0, l.jsxs)(r.ZP, { href: w.icalLink, download: w.icalLink, style: { paddingInlineStart: 0, paddingInlineEnd: 0 }, children: [(0, l.jsx)(r.JO, { children: (0, l.jsx)(a.Z, {}) }), (0, l.jsx)('time', { dateTime: w.isoDateTime, children: new Intl.DateTimeFormat(n, { dateStyle: 'full', timeStyle: 'nl' === n ? 'short' : 'full', timeZone: 'Europe/Amsterdam' }).format(new Date(w.isoDateTime)) })] }) }) : null,
       k,
       'nl' === n &&
        c.find((e) => {
         let { language: n } = e;
       ...
       v && (0, l.jsxs)(r.nv, { children: [(0, l.jsx)('b', { children: 'Goed te weten:' }), ' Bij deze sessie is een schrijftolk aanwezig', j && (0, l.jsxs)(l.Fragment, { children: [' ', '(', (0, l.jsxs)('a', { href: j, children: ['tolktekst', (0, l.jsxs)('span', { className: 'sr-only', children: [' bij ', m] })] }), ')'] }), '.'] }),
       ...
       h && (0, l.jsx)(r.nv, { className: (0, o.Z)('homepage-hero__call-to-action'), children: (0, l.jsxs)(t.r, { className: (0, o.Z)('utrecht-link', 'homepage-hero__call-to-action-link'), to: h, children: ['en' === n ? 'Sign up for' : 'Aanmelden voor', ' \u201c', m, '\u201d', (0, l.jsx)(s.Z, { className: (0, o.Z)('utrecht-icon', 'homepage-hero__call-to-action-icon'), style: { verticalAlign: 'middle' } })] }) }),
      ],
     });
    };
  },
  97233: (e, n, i) => {
   ...
   const s = (e) => {
    ...
    return (0, a.jsx)(t.Z, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: n, title: i, poster: 'maxresdefault', ...s });
   };
  },
  40139: (e, n, i) => {
   i.d(n, { Z: () => o, a: () => r });
  ...
  84263: (e, n, i) => {
   ...
   var r = t.forwardRef(function (e, n) {
    ...
    var w = e.playlist ? ''.concat(j, '/embed/videoseries?').concat(v.toString()) : ''.concat(j, '/embed/').concat(m, '?').concat(v.toString()),
    ...
    return (
     ...
     t.createElement(
      t.Fragment,
      null,
      t.createElement('link', { rel: H, href: x, as: 'image' }),
      t.createElement(t.Fragment, null, r && t.createElement(t.Fragment, null, t.createElement('link', { rel: 'preconnect', href: j }), t.createElement('link', { rel: 'preconnect', href: 'https://www.google.com' }), S && t.createElement(t.Fragment, null, t.createElement('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), t.createElement('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })))),
      t.createElement(
       M,
       {
        ...
        className: ''.concat(_, ' ').concat(l ? z : ''),
        'data-title': h,
        style: a(a({ backgroundImage: 'url('.concat(x, ')') }, { '--aspect-ratio': ''.concat((L / N) * 100, '%') }), A),
       },
       t.createElement('button', { type: 'button', className: C, 'aria-label': ''.concat(u, ' ').concat(h) }),
       l && t.createElement('iframe', { ref: n, className: I, title: h, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: w }),
      ),
     )
    );
   });
