  ...
  70348(e, n, t) {
   ...
   const o = ({ className: e, ...n }) => {
    ...
    s = ({ className: e, classNamePanel: n, label: t, heading: o, headingLevel: s, headingApperance: d, ...c }) => {
     ...
     return (0, a.jsxs)('details', { className: u, ...c, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(r.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [o && (0, a.jsx)(i.D, { level: s, appearance: d, children: o }), t] })] }) }), (0, a.jsx)('div', { className: m, children: c.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => y });
