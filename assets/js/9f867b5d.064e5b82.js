 ...
 [12487],
 {
  22122: (e, t, n) => {
   ...
   const g = (e) => {
    ...
    const s = (0, h.mA)(n);
    return (0, r.jsxs)(o.Bc, { children: [(0, r.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, u.Z)('component-illustration', `component-illustration--${s}`), fill: 'none', children: [(0, r.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, r.jsx)('rect', { width: '960', height: '540' }), (0, r.jsx)('rect', { width: '960', height: '540' })] }), (0, r.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, r.jsx)('use', { href: `/svg/componenten_overzicht_${(0, h.mA)(t)}.svg#component-illustration` })] }), (0, r.jsx)(o.QD, { className: 'component-illustration__caption', children: a })] });
   };
   var f = n(23355);
   const j = (e) => {
     let { name: t, description: n, relayStep: a, headingLevel: s = 2, href: i, frameworkNames: l } = e;
     return (0, r.jsxs)(m.Zb, { appearance: 'large', className: (0, u.Z)('component-card', !a && 'component-card--suggestion'), component: 'section', children: [(0, r.jsx)(m.wu, { children: (0, r.jsx)(g, { relayStep: a, description: `Schets van de ${t} component`, name: t }) }), (0, r.jsxs)(m.aY, { children: [(0, r.jsxs)('div', { children: [(0, r.jsx)(c.X6, { level: s, className: 'component-card__title', children: t }), a && (0, r.jsx)('p', { children: (0, r.jsx)(f.y, { state: a }) }), n && (0, r.jsx)(c.nv, { children: n }), l && (0, r.jsx)(c.k, { children: l.map((e) => (0, r.jsx)(c.Ou, { children: e }, e)) })] }), i && (0, r.jsx)(c.nv, { children: (0, r.jsxs)(p.r, { className: 'utrecht-link', to: ((o = i), 'string' == typeof o && !1 === o.endsWith('/') ? `${o}/` : o), children: ['Bekijk ', (0, r.jsx)('span', { className: 'w', children: t }), ' component'] }) })] })] });
     var o;
    },
    x = () => {
     const e = 'framework',
     ...
     return (
      (0, d.useEffect)(() => {
       v(x.filter((e) => !_.length || _.some((t) => e.relayStep === t)).filter((e) => !k.length || k.some((t) => (0, h.d)(e, t)))), _.length ? u.set(t, _.join(',')) : u.delete(t), k.length ? u.set(e, k.join(',')) : u.delete(e), p({ ...a, search: u.toString() });
      }, [_, k]),
      (0, r.jsxs)(r.Fragment, {
       children: [
        (0, r.jsx)('div', {
         className: 'filter-accordion',
         children: (0, r.jsx)(o.a2, {
          sections: [
           {
            headingLevel: 2,
            expanded: u.size > 0,
        ...
        (0, r.jsx)(m.um, {
         appearance: 'large',
         children: b.map((e) => {
          let { title: t, id: n, href: a, description: s } = e;
          const i = l.find((e) => e.title === t),
           o = i && h.$3[i.relayStep],
           c = (0, h.U)(i);
          return (0, r.jsx)(j, { name: t, headingLevel: 2, href: a, description: s, relayStep: o, frameworkNames: c }, n);
         }),
        }),
       ],
      })
  ...
  35038: (e, t, n) => {
   ...
   const i = (e) => {
     ...
     return (0, s.jsx)('div', { className: (0, a.Z)('card__illustration', t && `card__illustration--${t}`, r), ...i, children: n });
    },
    l = (e) => (0, s.jsx)('div', { className: 'card__content', ...e }),
    o = (e) => {
     let { href: t, appearance: n, className: i, component: l = 'div', background: o, children: c } = e;
     const d = (e) => ('article' === l ? (0, s.jsx)('article', { ...e }) : 'section' === l ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      h = (0, s.jsx)(d, { className: (0, a.Z)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, i), children: c });
    ...
    c = (e) => {
     ...
     return (0, s.jsx)('div', { className: (0, a.Z)('cardgroup', `cardgroup--${t}`, r), children: n });
    };
  },
  23355: (e, t, n) => {
   n.d(t, { y: () => l });
   ...
   const l = (e) => {
    let { state: t } = e;
    const n = (0, s.mA)(t);
    return (0, i.jsx)(r.Ou, { className: (0, a.Z)('estafette-badge', n && `estafette-badge--${n}`), children: t });
   };
  },
  57229: (e, t, n) => {
   n.d(t, { r: () => i });
   ...
   const i = (e) => {
    let { className: t, ...n } = e;
    return (0, s.jsx)(r.Z, { className: (0, a.W)('utrecht-link', 'utrecht-link--html-a', t), ...n });
   };
  },
  14669: (e, t, n) => {
   n.d(t, { $3: () => r, $e: () => f, BA: () => l, Ee: () => d, Q6: () => s, U: () => p, Yr: () => j, d: () => h, e9: () => i, fO: () => b, mA: () => a, ps: () => u, qU: () => v, s0: () => x, zP: () => g });
    ...
    u = (e) => {
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        let { name: a, id: s, value: i } = r;
        const l = /^(.+) URL/.exec(a)[1],
         o = 'Storybook' === l ? `${n} (${t}) in Storybook van ${((e) => (['Candidate - New', 'Candidate - Oud'].includes(e.title) ? 'Candidate' : e.title))(e)}` : `${n} (${t}) op ${l}`;
