...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [33710],
 {
  ...
  32385(e, n, t) {
   t.d(n, { bo: () => a, KF: () => u, mJ: () => p, VZ: () => D, cR: () => w, Pv: () => j, qZ: () => o, kD: () => f, QQ: () => A, B2: () => m, Pc: () => l, f4: () => s, GT: () => k, fX: () => r, eQ: () => v, B_: () => b, o_: () => x });
  ...
  65082(e, n, t) {
   (t.r(n), t.d(n, { assets: () => F, component: () => _, contentTitle: () => N, default: () => R, description: () => H, frontMatter: () => y, issueNumber: () => C, metadata: () => i, title: () => S, toc: () => T }));
   ...
   const D = [
     ...
     { title: 'De contrastverhouding van de kleur van de markers van de Unordered List met de achtergrondkleur is hoog genoeg.', sc: '1.4.11', status: '', component: h.Ay, tags: ['developer', 'designer'] },
     { title: 'De Unordered List is niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: b.Ay, tags: ['developer'] },
     { title: 'De Unordered List komt niet voor in de normale focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: k.Ay, tags: ['developer'] },
    ...
    L = [
     ...
     { title: 'Als je de tekst van de Unordered List vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: x.Ay, tags: ['developer'] },
     { title: 'Tekst in de Unordered List blijft leesbaar wanneer de tekstafstand vergroot wordt. ', sc: '1.4.12', status: '', component: p.Ay, tags: ['developer'] },
     ...
     { title: 'De Unordered List komt standaard niet voor in de focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: f.Ay, tags: ['developer'] },
    ];
   var A = t(21034);
   const y = { title: 'Unordered List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Unordered List', pagination_label: 'Unordered List', description: 'Opsomming waar de volgorde van items in de lijst niet van belang is.', issue_number: 116, slug: '/unordered-list', keywords: ['bolletjes lijst', 'bullet list', 'bullet points', 'bulleted list', 'bullets', 'items', 'itemslijst', 'lijst', 'lijst met volgorde', 'lijstje', 'lijsten', 'list', 'list items', 'nested list', 'numbered list', 'ongeordend', 'ongeordende lijst', 'ongesorteerde lijst', 'opsomming', 'opsommingslijst', 'order', 'ordered list', 'punten', 'punt', 'sequence', 'ul', 'unordered', 'unordered list', 'vertical list'] },
    ...
    F = {},
    S = 'Unordered List',
    H = 'Opsomming waar de volgorde van items in de lijst niet van belang is.',
    C = 116,
    _ = o.find((e) => e.number === C),
  ...
  70348(e, n, t) {
   ...
   const s = ({ className: e, ...n }) => {
    ...
    l = ({ className: e, label: n, heading: t, headingLevel: s, headingApperance: l, ...d }) => {
     ...
     return (0, o.jsxs)('details', { className: c, ...d, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(a.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [t && (0, o.jsx)(r.D, { level: s, appearance: l, children: t }), n] })] }) }), (0, o.jsx)('div', { className: 'utrecht-accordion__panel', children: d.children })] });
    };
  },
  70561(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => r });
