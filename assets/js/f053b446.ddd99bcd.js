(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [88474],
 {
  ...
  99069: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => A, component: () => x, contentTitle: () => w, default: () => T, description: () => k, frontMatter: () => j, issueNumber: () => b, metadata: () => y, title: () => f, toc: () => v });
   var r = n(52676),
    i = n(24785),
    o = n(96439),
    s = n(92183);
   ...
   var a = n(56733),
    ...
    m = n(55240),
    p = n(8657);
   const j = { title: 'Code', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code', pagination_label: 'Code', description: 'Markeert korte tekst die code vertegenwoordigt.', slug: '/code', keywords: ['code block'] },
    w = void 0,
    y = { id: 'componenten/code/index', title: 'Code', description: 'Markeert korte tekst die code vertegenwoordigt.', source: '@site/docs/componenten/code/index.mdx', sourceDirName: 'componenten/code', slug: '/code', permalink: '/code', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/code/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Code', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code', pagination_label: 'Code', description: 'Markeert korte tekst die code vertegenwoordigt.', slug: '/code', keywords: ['code block'] }, sidebar: 'componenten', previous: { title: 'Checkbox Group', permalink: '/checkbox-group' }, next: { title: 'Code Block', permalink: '/code-block' } },
    A = {},
    v = [
    ...
    f = 'Code',
    k = 'Markeert korte tekst die code vertegenwoordigt.',
    b = 326,
   ...
   function C(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(p.Rv, { component: x, headingLevel: 1, description: k }),
      '\n',
      ...
      (0, r.jsx)(m.t, {
       ...
       items: [
        ...
        { title: 'Wanneer de achtergrondkleur van de Code component anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina', sc: '1.4.11', status: '', component: (0, r.jsx)(a.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(m.t, {
      ...
      '\n',
      (0, r.jsx)(m.t, { headingLevel: 3, testCategory: 'Toegankelijkheid screenreader', items: [{ title: 'Het juiste HTML-element voor de Code component is toegepast', sc: '1.3.1', status: '', component: (0, r.jsx)(l, {}) }] }),
      '\n',
  ...
  35038: (e, t, n) => {
   ...
   const s = (e) => {
    ...
    l = (e) => {
     let { href: t, appearance: n, className: s, component: c = 'div', children: l } = e;
     const a = (e) => ('article' === c ? (0, o.jsx)('article', { ...e }) : 'section' === c ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(a, { className: (0, i.Z)('cardgroup__card', `cardgroup__card--${n}`, s), children: l });
  ...
  8657: (e, t, n) => {
   ...
   const b = (e) => {
     ...
     const o = t && t.projects.filter((e) => k.e9.includes(e.id)),
      s = o && k.e9.map((e) => o.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, d.jsx)(r.a2, {
       appearance: '',
    ...
    T = (e) => {
     ...
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(w.V, { level: n, suffix: o && (0, d.jsx)(j.y, { state: o }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  41757: (e, t, n) => {
   ...
   var r = n(4814),
    i = (n(75271), n(52676));
   const o = (e) => {
    let { children: t, className: n, level: o = 1, suffix: s, ...c } = e;
    return (0, i.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${o}`, n), ...c, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), s && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
