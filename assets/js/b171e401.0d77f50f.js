(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [67398],
 {
  39706: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => g, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => s, issueNumber: () => y, metadata: () => u, title: () => d, toc: () => h });
   var r = n(52676),
    i = n(24785),
    c = n(96439),
    o = n(23952);
   const s = { title: 'Switch', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Switch', pagination_label: 'Switch', description: 'Invoerveld om een optie aan of uit te zetten.', slug: '/switch' },
    a = void 0,
    u = { id: 'componenten/switch/index', title: 'Switch', description: 'Invoerveld om een optie aan of uit te zetten.', source: '@site/docs/componenten/switch/index.mdx', sourceDirName: 'componenten/switch', slug: '/switch', permalink: '/switch', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/switch/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Switch', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Switch', pagination_label: 'Switch', description: 'Invoerveld om een optie aan of uit te zetten.', slug: '/switch' }, sidebar: 'componenten', previous: { title: 'Superscript', permalink: '/superscript' }, next: { title: 'Table', permalink: '/table' } },
    l = {},
    h = [
