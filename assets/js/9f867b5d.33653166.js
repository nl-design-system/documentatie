...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [14408],
 {
   ...
   const i = ({ background: e, children: t, className: n, ...a }) => (0, r.jsx)('div', { className: (0, s.A)('card__illustration', e && `card__illustration--${e}`, n), ...a, children: t }),
    ...
    o = ({ href: e, appearance: t, className: n, component: i = 'div', background: l, children: o }) => {
     const c = (e) => ('article' === i ? (0, r.jsx)('article', { ...e }) : 'section' === i ? (0, r.jsx)('section', { ...e }) : (0, r.jsx)('div', { ...e })),
      d = (0, r.jsx)(c, { className: (0, s.A)('cardgroup__card', l && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: o });
  ...
  75916: (e, t, n) => {
   n.d(t, { B2: () => m, B_: () => j, GT: () => _, KF: () => h, Pc: () => l, Pv: () => u, Rc: () => v, bo: () => a, eQ: () => x, f4: () => i, fX: () => s, kD: () => b, mJ: () => g, o_: () => f, qZ: () => r });
   const a = { UNKNOWN: 'Todo', HELP_WANTED: 'Help Wanted', COMMUNITY: 'Community', CANDIDATE: 'Candidate', HALL_OF_FAME: 'Hall of fame' },
    ...
    o = ['CSS', 'HTML', 'Web Component', 'React', 'Vue', 'Angular', 'Twig'];
   function c(e) {
    return Array.from(new Set(e));
   }
   const d = (e) => [...e].sort((e, t) => o.indexOf(e) - o.indexOf(t)),
    h = (e) => {
    ...
    p = (e) => {
     const t = / URL \(([^)]+)\)/;
     return d(c(e.tasks.filter(({ name: e, value: n }) => '' !== n && t.test(e)).map(({ name: e }) => t.exec(e)?.[1])));
    },
    g = (e) => d(c(e.projects.flatMap((e) => p(e)))),
    u = (e) => {
     const t = p(e),
      n = ((e) => {
     ...
     return t.map((t) => {
      const a = e.tasks
       ...
       .map(({ name: a, id: s, value: r }) => {
        ...
        return { brand: i.toLowerCase(), name: a, id: s, value: r, description: l };
       });
  ...
  91683: (e, t, n) => {
   n.r(t), n.d(t, { assets: () => N, contentTitle: () => A, default: () => w, frontMatter: () => v, metadata: () => a, toc: () => k });
   ...
   const j = ({ name: e, relayStep: t, description: n }) => {
    const a = (0, p.fX)(t);
    return (0, s.jsxs)(d.WK, { children: [(0, s.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, f.A)('component-illustration', `component-illustration--${a}`), fill: 'none', children: [(0, s.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, s.jsx)('rect', { width: '960', height: '540' }), (0, s.jsx)('rect', { width: '960', height: '540' })] }), (0, s.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, s.jsx)('use', { href: `/svg/componenten_overzicht_${(0, p.fX)(e)}.svg#component-illustration` })] }), (0, s.jsx)(d.$P, { className: 'component-illustration__caption', children: n })] });
   };
   var x = n(36444);
   const b = ({ name: e, description: t, relayStep: n, headingLevel: a = 2, href: r, frameworkNames: i }) => {
     return (0, s.jsxs)(g.Zp, { appearance: 'large', className: (0, f.A)('component-card', !n && 'component-card--suggestion'), component: 'section', children: [(0, s.jsx)(g.Fu, { children: (0, s.jsx)(j, { relayStep: n, description: `Schets van de ${e} component`, name: e }) }), (0, s.jsxs)(g.Wu, { children: [(0, s.jsxs)('div', { children: [(0, s.jsx)(h.DZ, { level: a, className: 'component-card__title', children: e }), n && (0, s.jsx)('p', { children: (0, s.jsx)(x.D, { state: n }) }), t && (0, s.jsx)(h.fz, { children: t }), i && (0, s.jsx)(h._Q, { children: i.map((e) => (0, s.jsx)(h.KE, { children: e }, e)) })] }), r && (0, s.jsx)(h.fz, { children: (0, s.jsxs)(u.N, { className: 'utrecht-link', to: ((l = r), 'string' == typeof l && !1 === l.endsWith('/') ? `${l}/` : l), children: ['Bekijk ', (0, s.jsx)('span', { className: 'w', children: e }), ' component'] }) })] })] });
     var l;
    },
    _ = () => {
     const e = 'framework',
      ...
      [k, S] = (0, m.useState)(u.get(e)?.split(',') || []),
      w = (0, p.KF)(j);
     return (
      (0, m.useEffect)(() => {
       v(j.filter((e) => !A.length || A.some((t) => e.relayStep === t)).filter((e) => !k.length || k.some((t) => (0, p.B2)(e, t)))), A.length ? u.set(t, A.join(',')) : u.delete(t), k.length ? u.set(e, k.join(',')) : u.delete(e), r({ ...a, search: u.toString() });
      }, [A, k]),
      (0, s.jsxs)(s.Fragment, {
       children: [
        (0, s.jsx)('div', {
                 ...
                 (0, s.jsxs)(
                  h.zB,
                  {
                   ...
                   children: [
                    ...
                    (0, s.jsx)(h.lR, { htmlFor: e, children: (0, s.jsx)(x.D, { state: t }) }),
                   ],
                  },
                  e,
                 ),
        ...
        (0, s.jsxs)(d.fz, { role: 'status', id: 'filter-results', children: [_.length, ' van ', j.length, ' componenten zichtbaar'] }),
        0 === _.length &&
         (0, s.jsx)(d.fz, {
        ...
        (0, s.jsx)(g.AC, {
         appearance: 'large',
         children: _.map(({ title: e, id: t, href: n, description: a }) => {
          const r = c.find((t) => t.title === e),
           i = r && p.bo[r.relayStep],
           l = (0, p.mJ)(r);
          return (0, s.jsx)(b, { name: e, headingLevel: 2, href: n, description: a, relayStep: i, frameworkNames: l }, t);
         }),
        }),
       ],
      })
  ...
  92420: (e, t, n) => {
   ...
   var a = n(71170),
    s = n(13526),
    r = n(86070);
   const i = ({ className: e, ...t }) => (0, r.jsx)(a.A, { className: (0, s.$)('utrecht-link', 'utrecht-link--html-a', e), ...t });
  },
 },
]);
