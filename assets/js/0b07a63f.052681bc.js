/*! For license information please see 0b07a63f.052681bc.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [8424],
 {
  ...
  18652(e, n, t) {
   ...
   const a = (e, n, t, a) => {
    const o = (0, s.forwardRef)(({ color: t = 'currentColor', size: o = 24, stroke: r = 2, title: l, className: c, children: d, ...m }, u) => (0, s.createElement)('svg', { ref: u, ...i[e], width: o, height: o, className: ['tabler-icon', `tabler-icon-${n}`, c].join(' '), ...('filled' === e ? { fill: t } : { strokeWidth: r, stroke: t }), ...m }, [l && (0, s.createElement)('title', { key: 'svg-title' }, l), ...a.map(([e, n]) => (0, s.createElement)(e, n)), ...(Array.isArray(d) ? d : [d])]));
  ...
  24456(e, n, t) {
   ...
   const o = ({ children: e, ...n }) => {
     ...
     return ('https://nldesignsystem.nl' === l.origin ? (l.pathname.endsWith('/') || (0, i.QQ)(l.pathname) || (l.pathname = `${l.pathname}/`), (r = l.toString().replace('https://nldesignsystem.nl', ''))) : ((o.target = '_blank'), (o.rel = 'noopener noreferrer')), (0, a.jsx)('a', { href: r, ...o, children: e }));
    },
    r = ({ className: e, boxContent: n, ...t }) => (0, a.jsx)(o, { className: (0, s.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  29680(e, n, t) {
   t.d(n, { v: () => r });
   var s = t(24456),
    i = t(13526),
    a = t(86070);
   const o = ({ className: e, children: n, purpose: t, iconStart: s, iconEnd: o, href: r }) => (0, a.jsxs)('a', { className: (0, i.A)('nl-button', e, { 'nl-button--primary': 'primary' === t, 'nl-button--secondary': 'secondary' === t, 'nl-button--subtle': 'subtle' === t }), href: r, children: [s && (0, a.jsx)('span', { className: 'nl-button__icon-start', children: s }), (0, a.jsx)('span', { className: 'nl-button__label', children: n }), o && (0, a.jsx)('span', { className: 'nl-button__icon-end', children: o })] }),
    r = globalThis.isAstro
     ? ({ appearance: e, href: n, ...t }) => {
        let s = 'primary';
        return ((s = 'secondary-action' === e ? 'secondary' : s), (0, a.jsx)(o, { purpose: s, href: n, ...t }));
       }
     : ({ appearance: e, ...n }) => (0, a.jsx)(s.F, { className: (0, i.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...n });
  },
  35683(e, n, t) {
   t.d(n, { K: () => s.e2 });
   var s = t(29181);
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => i, KF: () => u, mJ: () => v, VZ: () => _, cR: () => A, Pv: () => g, qZ: () => o, kD: () => b, QQ: () => x, B2: () => p, Pc: () => l, f4: () => r, GT: () => f, fX: () => a, eQ: () => y, B_: () => k, o_: () => j });
