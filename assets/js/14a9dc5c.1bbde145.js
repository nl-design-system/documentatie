...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  12312(e, n, l) {
   (l.r(n), l.d(n, { assets: () => h, contentTitle: () => d, default: () => p, frontMatter: () => c, metadata: () => t, toc: () => j }));
  ...
  14881(e, n, l) {
   ...
   var t = l(13526),
    ...
    a = l(37168),
    o = l(86070);
   const i = (0, r.forwardRef)(({ as: e, className: n, children: l, ...r }, s) => {
     const a = e || 'div',
      i = (0, t.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, o.jsx)(a, { ref: s, className: i, ...r, children: l });
    }),
    c = ({ className: e, classNamePanel: n, label: l, heading: r, headingLevel: i, headingApperance: c, ...d }) => {
     const h = (0, t.A)('utrecht-accordion__section', e),
      j = (0, t.A)('utrecht-accordion__panel', n);
     return (0, o.jsxs)('details', { className: h, ...d, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(s.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [r && (0, o.jsx)(a.D, { level: i, appearance: c, children: r }), l] })] }) }), (0, o.jsx)('div', { className: j, children: d.children })] });
    };
  },
  18439(e, n, l) {
   l.d(n, { R: () => a, x: () => o });
  ...
  28369(e, n, l) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: l, trim: c }) {
    ...
    const { title: h, type: j } = (0, s.useContext)(a.x),
     m = (0, s.useId)();
    return (c && (d = d.trim()), (0, i.jsx)(r.f4, { theme: o, code: d, language: n || '', children: ({ style: n, tokens: l, getLineProps: r, getTokenProps: s }) => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', j ? `\u201c${j}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, i.jsx)(t.NG, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': m, style: n, children: l.map((n, l) => (0, i.jsxs)('span', { ...r({ line: n }), children: [e && (0, i.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, i.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  38953(e, n, l) {
   l.d(n, { H: () => y });
   var t = l(28369),
    ...
    x = l(46847),
    b = l(86070);
   const g = ({ children: e }) => (0, b.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(r.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, b.jsx)(r.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   g.displayName = 'ParagraphContainer';
   const k = ({ children: e }) => (0, b.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(r.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   k.displayName = 'DocumentContainer';
   const v = ({ children: e }) => (0, b.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: e });
   v.displayName = 'SurfaceContainer';
   const y = globalThis.isAstro
    ? ({ language: e, className: n, code: l = '<p>No code provided</p>', rawCode: t, copyCode: r, defaultExpandedCode: a, designTokens: o }) => {
       const i = 'string' == typeof l ? l : t || '',
        c = 'string' == typeof l ? p().highlight(l, p().languages[e], e) : p().highlight(t || '', p().languages[e], e);
       return (0, b.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', n), children: [(0, b.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: o, children: (0, b.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: i } }) }), (0, b.jsx)(u.n, { children: (0, b.jsxs)(u.K, { label: 'Code', open: a, children: [(0, b.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, b.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: c } }) }), 'allow' === r && (0, b.jsx)(x.$, { 'data-copy-code': i, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: m = !0, children: p, container: u = 'document', language: x, designTokens: y }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: x, plugins: [a.A, o.Ay, i.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         z(e);
        })();
       }, [N]);
       const S = (0, h.useId)();
       let T = h.Fragment;
       return (
        'paragraph' === u ? (T = g) : 'document' === u ? (T = k) : 'surface' === u && (T = v),
        (0, b.jsxs)('div', {
         className: (0, s.A)('nlds-canvas'),
         children: [
          f && (0, b.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, b.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, b.jsx)(T, { children: (0, b.jsx)(r.v$, { children: f }) }) }) }),
          m &&
           (0, b.jsx)('div', {
          ...
          m &&
           (0, b.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, b.jsx)(t.M, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: w, trim: !0 }),
             n &&
              (0, b.jsx)('div', {
