(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [9591],
 {
  81355: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => a, default: () => m, description: () => j, frontMatter: () => s, issueNumber: () => g, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(50460),
    o = n(23952);
   const s = { title: 'Date Input Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Input Group', pagination_label: 'Date Input Group', description: 'Formulierveld voor een datum die de gebruiker al weet of die van bekende gegevens overgenomen kan worden.', slug: '/date-input-group' },
    a = void 0,
    u = { id: 'componenten/date-input-group/index', title: 'Date Input Group', description: 'Formulierveld voor een datum die de gebruiker al weet of die van bekende gegevens overgenomen kan worden.', source: '@site/docs/componenten/date-input-group/index.mdx', sourceDirName: 'componenten/date-input-group', slug: '/date-input-group', permalink: '/date-input-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-input-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Date Input Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Input Group', pagination_label: 'Date Input Group', description: 'Formulierveld voor een datum die de gebruiker al weet of die van bekende gegevens overgenomen kan worden.', slug: '/date-input-group' }, sidebar: 'componenten', previous: { title: 'Date Input', permalink: '/date-input' }, next: { title: 'Date Picker', permalink: '/date-picker' } },
    l = {},
    d = [
  ...
  23952: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    D = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(_), children: [(0, l.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, l.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var z = n(14669);
   const S = (e) => {
     ...
     return (
      ...
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(g['definition-of-done'], e && g[`definition-of-done--${(0, z.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
            ...
            j.Zb,
            {
             ...
             children: (0, l.jsxs)(j.aY, {
              children: [
               ...
               (0, l.jsxs)(r.nv, { children: [(0, l.jsx)(p, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, l.jsxs)(r.rU, { href: e.url, children: [e.title, ' projectbord'] })] }),
               s.length > 0 &&
                (0, l.jsxs)(l.Fragment, {
                 children: [
    ...
    L = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(v.V, { level: n, suffix: c && (0, l.jsx)(m.y, { state: c }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, t, n) => {
   'use strict';
