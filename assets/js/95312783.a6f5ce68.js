...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [5220],
 {
  ...
  73460: (e, n, r) => {
   ...
   const v = (e) => {
    let { code: n, copy: r = !1, defaultExpandedCode: v = !1, displayCode: x = !0, children: b, container: k = "document", language: w, designTokens: _ } = e,
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (F = await d.ZP.format(A, { parser: w, plugins: [s.Z, l.ZP, i.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), G(F);
     })();
    }, [A]);
    const Z = (0, c.useId)();
    let M = c.Fragment;
    return (
     "paragraph" === k ? (M = m) : "document" === k ? (M = j) : "surface" === k && (M = f),
     (0, g.jsxs)("div", {
