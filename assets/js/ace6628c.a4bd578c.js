/*! For license information please see ace6628c.a4bd578c.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [16229],
 {
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => N, cR: () => w, Pv: () => f, qZ: () => l, kD: () => k, QQ: () => D, B2: () => m, Pc: () => o, f4: () => s, GT: () => j, fX: () => i, eQ: () => v, B_: () => b, o_: () => x });
  ...
  72515(e, n, a) {
   ...
   const o = { title: 'Calendar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Calendar', pagination_label: 'Calendar', description: 'Een kalender waarin je een beschikbare datum kan kiezen.', issue_number: 199, slug: '/calendar', keywords: ['afspraak', 'appointment', 'availability', 'beschikbaarheid', 'calendar', 'dag', 'dagen', 'date', 'date picker', 'datepicker', 'datum', 'datumprikker', 'day', 'days', 'jaar', 'kalender', 'maand', 'moment', 'month', 'week', 'weeks', 'weken', 'year'] },
    ...
    g = {},
    c = 'Calendar',
    u = 'Een kalender waarin je een beschikbare datum kan kiezen.',
    m = 199,
    h = 'help wanted',
    p = 'calendar',
