...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [7971],
 {
  ...
  62943(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => x, componentName: () => b, contentTitle: () => g, default: () => j, description: () => c, frontMatter: () => d, issueNumber: () => p, metadata: () => t, relayStep: () => h, title: () => m, toc: () => f }));
   ...
   const d = { title: 'Select Combobox', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Select Combobox', pagination_label: 'Select Combobox', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren, waarbij de getoonde opties kunnen worden gefilterd door tekst in een invoerveld in te voeren.', issue_number: 341, slug: '/select-combobox', keywords: ['autocomplete', 'automatisch aanvullen', 'combo box', 'combobox', 'dropdown', 'dropdown list', 'dropdown menu', 'dropdown with filter', 'filter', 'keuzeveld', 'multiselect', 'opties', 'options', 'option list', 'optie kiezen', 'option selector', 'select', 'select field', 'select input', 'select combobox', 'selection box', 'typeahead'] },
    ...
    u = {},
    m = 'Select Combobox',
    c = 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren, waarbij de getoonde opties kunnen worden gefilterd door tekst in een invoerveld in te voeren.',
    p = 341,
    h = 'help wanted',
    b = 'select-combobox',
    x = s.find((e) => e.number === p),
    f = [
