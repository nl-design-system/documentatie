 ...
 [96545],
 {
  ...
  94719(e, n, i) {
   ...
   const u = { title: 'WCAG-succescriterium 1.4.10 Reflow', title_sm: '1.4.10 Reflow', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.10 Reflow', pagination_label: 'WCAG-succescriterium 1.4.10 Reflow', description: 'De gebruiker moet de webpagina tot 400% kunnen vergroten in de browser. Dezelfde inhoud moet aanwezig zijn, en alles moet nog op eenzelfde manier werken.', slug: '1.4.10', conformance_level: 'Niveau AA', keywords: ['WCAG', 'AA', 'waarneembaar', 'onderscheidbaar', 'perceivable', 'distinguishable', 'reflow'] },
    p = void 0,
    m = {},
    j = [{ value: 'Uitleg', id: 'uitleg', level: 2 }, ...g.RM, { value: 'Hoe te testen', id: 'hoe-te-testen', level: 2 }, { value: 'Gebruikersonderzoek', id: 'gebruikersonderzoek', level: 2 }, ...d.RM, { value: 'W3C referenties', id: 'w3c-referenties', level: 2 }, ...c.RM, { value: 'Help richtlijn verbeteren', id: 'help-richtlijn-verbeteren', level: 2 }, ...h.RM];
   function w(e) {
