 ...
 [49189],
 {
  1457(e, n, t) {
   ...
   const r = ({ component: e }) => {
    ...
    return (0, i.jsx)(o.Suspense, { fallback: null, children: (0, i.jsx)(a.o, { omitH1: !0, headingLevel: 1, children: (0, i.jsx)(l, {}) }) });
   };
  },
  12941(e, n, t) {
   'use strict';
   ...
   const i = (e, n) => {
    ...
    c = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: o = '', components: i = {} }) => (0, s.jsx)(a.x, { components: { ...d(n, t), ...l(o), ...i }, children: e });
  },
  15042(e, n, t) {
   'use strict';
   t.d(n, { p: () => s });
   var a = t(13526),
    o = t(86070);
   const s = ({ children: e, className: n, level: t = 1, suffix: s, ...i }) => (0, o.jsxs)('hgroup', { className: (0, a.A)('nlds-inline-heading-group', `utrecht-heading-${t}`, n), ...i, children: [(0, o.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), s && (0, o.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
  },
  16764(e, n, t) {
   'use strict';
   t.d(n, { B: () => A });
       ...
       children: [
        ...
        (0, m.jsx)(i.BF, {
         children: r.map((n) => {
          const t = (0, s.o_)(n),
           r = (0, s.eQ)(e, n).$type;
          return (0, m.jsxs)(i.Hj, { children: [(0, m.jsx)(i.nA, { children: (0, m.jsx)(a.C, { children: (0, m.jsx)(i.kf, { children: t }) }) }), (0, m.jsx)(i.nA, { children: (0, m.jsxs)(o.K, { children: [(0, m.jsx)(C, { type: r }), ' ', r] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, m.jsxs)(i.e2, { children: [(0, m.jsx)(p, { content: d, language: 'json', children: 'Kopieer als JSON' }), (0, m.jsx)(p, { content: l, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  24215(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => z, component: () => M, contentTitle: () => R, default: () => O, description: () => G, frontMatter: () => _, issueNumber: () => P, metadata: () => a, title: () => B, toc: () => I }));
  ...
  26655(e, n, t) {
   ...
   var a = t(46447),
    o = t(13526),
    s = t(86070);
   const i = ({ background: e, children: n, className: t, ...a }) => (0, s.jsx)('div', { className: (0, o.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, t), ...a, children: n }),
    ...
    l = ({ href: e, appearance: n, className: t, component: i = 'div', background: r, children: l }) => {
     const d = (e) => ('article' === i ? (0, s.jsx)('article', { ...e }) : 'section' === i ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      c = (0, s.jsx)(d, { className: (0, o.A)('ma-cardgroup__card', r && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, t), children: l });
  ...
  31522(e, n, t) {
   ...
   const r = ({ state: e }) => {
    const n = (0, s.fX)(e);
    return (0, i.jsx)(a.KE, { className: (0, o.A)('ma-estafette-badge', n && `ma-estafette-badge--${n}`), children: e });
   };
  },
  34257(e, n, t) {
   'use strict';
  ...
  39948(e, n, t) {
   ...
   var a = t(29181),
    ...
    l = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(o.A, {}), github: (0, d.jsx)(s.A, {}), npm: (0, d.jsx)(i.A, {}), storybook: (0, d.jsx)(r.A, {}) },
            ...
            i.Zp,
            {
             ...
             children: (0, d.jsxs)(i.Wu, {
              children: [
               ...
               r.length > 0 && (0, d.jsx)(d.Fragment, { children: r.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(a.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, d.jsx)(a.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  76097(e, n, t) {
   'use strict';
   t.d(n, { bo: () => o, KF: () => u, mJ: () => h, VZ: () => D, cR: () => y, Pv: () => j, qZ: () => i, kD: () => f, B2: () => m, Pc: () => l, f4: () => r, GT: () => v, fX: () => s, eQ: () => b, B_: () => k, o_: () => x });
     ...
     return n.map((n) => {
      const a = e.tasks
       ...
       .map(({ name: a, id: o, value: s }) => {
        ...
        return { brand: i.toLowerCase(), name: a, id: o, value: s, description: r };
       });
