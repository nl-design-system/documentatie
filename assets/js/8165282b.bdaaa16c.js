...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [42843],
 {
   ...
   const a = ({ background: e, children: n, className: t, ...i }) => (0, o.jsx)('div', { className: (0, r.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, t), ...i, children: n }),
    ...
    s = ({ href: e, appearance: n, className: t, component: a = 'div', background: l, children: s }) => {
     const d = (e) => ('article' === a ? (0, o.jsx)('article', { ...e }) : 'section' === a ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      c = (0, o.jsx)(d, { className: (0, r.A)('ma-cardgroup__card', l && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, t), children: s });
  ...
  32385(e, n, t) {
   t.d(n, { bo: () => r, KF: () => g, mJ: () => p, VZ: () => A, cR: () => k, Pv: () => j, qZ: () => a, kD: () => w, QQ: () => y, B2: () => m, Pc: () => s, f4: () => l, GT: () => b, fX: () => o, eQ: () => v, B_: () => x, o_: () => f });
     ...
     return n.map((n) => {
      const i = e.tasks
       ...
       .map(({ name: i, id: r, value: o }) => {
        ...
        return { brand: a.toLowerCase(), name: i, id: r, value: o, description: l };
       });
  ...
  40889(e, n, t) {
   ...
   var i = t(29181),
    ...
    s = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(r.A, {}), github: (0, d.jsx)(o.A, {}), npm: (0, d.jsx)(a.A, {}), storybook: (0, d.jsx)(l.A, {}) },
  ...
  45005(e, n, t) {
   (t.r(n), t.d(n, { assets: () => V, component: () => $, contentTitle: () => M, default: () => X, description: () => O, frontMatter: () => B, issueNumber: () => Z, metadata: () => i, title: () => E, toc: () => U }));
   ...
   const I = [
     ...
     { title: 'Kleur is niet de enige manier om informatie over een Text Input weer te geven.', sc: '1.4.1', status: '', component: D.Ay, tags: ['designer'] },
     ...
     { title: 'De bezoeker kan de Text Input tot 400% vergroten zonder verlies van functionaliteit of informatie.', sc: '1.4.10', status: '', component: h.Ay, tags: ['developer'] },
     {
     ...
     { title: 'De Text Input veroorzaakt geen toetsenbordval.', sc: '2.1.2', status: '', component: N.Ay, tags: ['developer'] },
     {
     ...
     { title: 'Als de placeholdertekst en invoertekst in een andere taal is dan de taal van de pagina, dan heeft het `input`-element een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: T.Ay, tags: ['developer'] },
     { title: 'Als de Text Input focus krijgt, gebeurt er niets onverwachts.', sc: '3.2.1', status: '', component: L.Ay, tags: ['developer'] },
     { title: 'Bij het invullen van de Text Input gebeurt er niets onverwachts.', sc: '3.2.2', status: '', component: S.Ay, tags: ['developer', 'designer'] },
  ...
  70348(e, n, t) {
   ...
   var i = t(13526),
    ...
    a = t(37168),
    l = t(86070);
   const s = (0, r.forwardRef)(({ as: e, className: n, children: t, ...r }, o) => {
     const a = e || 'div',
      s = (0, i.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, l.jsx)(a, { ref: o, className: s, ...r, children: t });
    }),
    d = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: s, headingApperance: d, ...c }) => {
     ...
     return (0, l.jsxs)('details', { className: u, ...c, children: [(0, l.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, l.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, l.jsx)('span', { className: 'nl-button__icon-start', children: (0, l.jsx)(o.A, {}) }), (0, l.jsxs)('span', { className: 'nl-button__label', children: [r && (0, l.jsx)(a.D, { level: s, appearance: d, children: r }), t] })] }) }), (0, l.jsx)('div', { className: g, children: c.children })] });
    };
  },
  70561(e, n, t) {
   t.d(n, { Ay: () => l, RM: () => o });
  ...
  82024(e, n, t) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
            ...
            ? (0, c.jsx)(
               d.Z,
               {
                ...
                description: (0, c.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, c.jsxs)(o.f, { children: [(0, c.jsx)(u, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, c.jsxs)(i.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, c.jsxs)('div', {
                   children: [
                  ...
                  g.length > 0 && g.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)('section', { children: [(0, c.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(l.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               s.Zp,
               {
                ...
                children: (0, c.jsxs)(s.Wu, {
                 children: [
                  ...
                  g.length > 0 && (0, c.jsx)(c.Fragment, { children: g.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(i.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(l.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    k = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(m.p, { level: n, suffix: r && (0, c.jsx)(g.D, { state: r }), children: e.title }), (0, c.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(r) && (0, c.jsx)(x.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    A = ({ component: e }) => {
     const n = (e && j[e.title]) || [];
  ...
  85162(e, n, t) {
   ...
   const l = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    s = ({ name: e, relayStep: n, description: t }) => {
     const s = (0, o.fX)(n),
      d = l[e] ?? e;
     return (0, a.jsxs)(i.WK, { children: [(0, a.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, r.A)('ma-component-illustration', `ma-component-illustration--${s}`), fill: 'none', children: [(0, a.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, a.jsx)('rect', { width: '960', height: '540' }), (0, a.jsx)('rect', { width: '960', height: '540' })] }), (0, a.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, a.jsx)('use', { href: `/svg/componenten_overzicht_${(0, o.fX)(d)}.svg#component-illustration` })] }), (0, a.jsx)(i.$P, { className: 'ma-component-illustration__caption', children: t })] });
    };
  },
  88166(e, n, t) {
   t.d(n, { Z: () => i.Z });
         ...
         children: [
          ...
          (0, m.jsx)('div', {
           children: (0, m.jsxs)(m.Fragment, {
            children: [
             (0, m.jsxs)(l.f, { role: 'status', children: [x, ' van de ', j, ' items zijn nu zichtbaar.'] }),
             x < j
              ? (0, m.jsx)(s.$, {
                 purpose: 'secondary',
                 onClick: () => {
  ...
  94309(e, n, t) {
   ...
   const a = ({ children: e, ...n }) => {
     ...
     return ('https://nldesignsystem.nl' === s.origin ? (s.pathname.endsWith('/') || (0, r.QQ)(s.pathname) || (s.pathname = `${s.pathname}/`), (l = s.toString().replace('https://nldesignsystem.nl', ''))) : ((a.target = '_blank'), (a.rel = 'noopener noreferrer')), (0, o.jsx)('a', { href: l, ...a, children: e }));
    },
    l = ({ className: e, ...n }) => (0, o.jsx)(a, { className: (0, i.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
 },
]);
