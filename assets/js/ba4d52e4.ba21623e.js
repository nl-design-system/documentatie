/*! For license information please see ba4d52e4.ba21623e.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [81830],
 {
  ...
  12111(e, n, i) {
   i.d(n, { A: () => t });
   var t = (0, i(99773).A)('outline', 'calendar-event', 'IconCalendarEvent', [
  ...
  75112(e, n, i) {
   ...
   const l = new Date().toISOString(),
    d = ({ lang: e = 'nl', headingLevel: n = 3, allSpeakers: i, videoId: d, children: c, allSessions: g, sessionId: m }) => {
     ...
     return u ? (0, r.jsxs)('article', { className: (0, a.A)('dsw-session'), children: [(0, r.jsx)(s.DZ, { level: n, className: 'dsw-session__title', id: u.subject.toLowerCase().replace(/\s/gi, '-'), children: u.subject }), (0, r.jsx)(s.fz, { className: 'dsw-session__subtitle', lead: !0, children: h && h.map((e) => (e?.organisation ? `${e.name} - ${e.organisation}` : e.name)).join(' & ') }), p.length > 0 && p.map((e) => (0, r.jsx)(o.L, { id: e, title: u.subject, style: { marginBlock: '20px' } }, e)), u && u.isoDateTime && u.isoDateTime > l ? (0, r.jsx)(s.fz, { children: (0, r.jsx)('time', { dateTime: u.isoDateTime, children: new Intl.DateTimeFormat(e, { dateStyle: 'full', timeStyle: 'nl' === e ? 'short' : 'full', timeZone: 'Europe/Amsterdam' }).format(new Date(u.isoDateTime)) }) }) : (0, r.jsx)(r.Fragment, {}), c, 'nl' === e && h.find(({ language: e }) => 'nl' !== e) && (0, r.jsxs)(s.fz, { children: [(0, r.jsx)('b', { children: 'Goed te weten:' }), ' Deze sessie is in het Engels.'] }), u.captioned ? (u.captionId ? (0, r.jsx)(r.Fragment, { children: (0, r.jsxs)(s.fz, { children: ['nl' === e ? (0, r.jsx)(r.Fragment, { children: (0, r.jsx)('b', { children: 'Bij deze sessie is een schrijftolk aanwezig: ' }) }) : (0, r.jsx)(r.Fragment, { children: (0, r.jsx)('b', { children: 'Live captioning is available for this session: ' }) }), (0, r.jsxs)('a', { href: `https://text-on-tap.live/#e=${u.captionId}`, children: [(0, r.jsxs)('span', { className: 'sr-only', children: [u.subject, ' '] }), 'nl' === e ? 'in de browser' : 'in the browser'] }), 'nl' === e ? ' of ' : ' or ', (0, r.jsxs)('a', { href: `https://text-on-tap.live/openoverlay.html?e=${u.captionId}`, children: [(0, r.jsxs)('span', { className: 'sr-only', children: [u.subject, ' '] }), 'nl' === e ? 'met de Overlay tool' : 'with the de Overlay tool'] })] }) }) : 'nl' === e ? (0, r.jsx)(s.fz, { children: 'Voor deze sessie hebben we nog geen schrijftolk gevonden' }) : (0, r.jsx)(r.Fragment, {})) : (0, r.jsx)(r.Fragment, {}), (0, r.jsx)('aside', { className: (0, a.A)('dsw-session__speakers'), children: h.map((n, i) => (0, r.jsxs)('div', { className: (0, a.A)('dsw-session__speaker', 'dsw-speaker'), children: [(0, r.jsx)('img', { className: (0, a.A)('dsw-speaker__image'), src: n.image.src, alt: n.image.alt }), (0, r.jsx)(s.fz, { className: (0, a.A)('dsw-speaker__description'), children: n.description[e] })] }, i)) }), u && u.icalLink && !d ? (0, r.jsx)(s.fz, { children: (0, r.jsxs)(s.vx, { href: u.icalLink, download: u.icalLink, appearance: 'primary-action-button', children: [(0, r.jsx)(s.In, { children: (0, r.jsx)(t.A, {}) }), (0, r.jsx)('span', { children: 'nl' === e ? (0, r.jsxs)(r.Fragment, { children: ['Zet', (0, r.jsx)('span', { className: 'sr-only', children: u.subject }), ' in je agenda'] }) : (0, r.jsxs)(r.Fragment, { children: ['Add', (0, r.jsx)('span', { className: 'sr-only', children: u.subject }), ' to your calendar'] }) })] }) }) : null] }) : (0, r.jsx)(r.Fragment, {});
    };
  },
  82702(e) {
     ...
     t.createElement(
      ...
      t.createElement(
       H,
       {
        ...
        'data-title': u,
        style: s(s({ backgroundImage: 'url('.concat(T, ')') }, { '--aspect-ratio': ''.concat((z / E) * 100, '%') }), M),
       },
  ...
  88071(e, n, i) {
   ...
   const t = JSON.parse('{"id":"community/events/design-systems-week/en/previous-editions/2025","title":"Videos \xb7 Design Systems Week 2025","description":"Recordings of talks that are in English for Design Systems Week 2025.","source":"@site/docs/community/events/design-systems-week/en/previous-editions/2025.mdx","sourceDirName":"community/events/design-systems-week/en/previous-editions","slug":"/events/design-systems-week-2025/en/program","permalink":"/events/design-systems-week-2025/en/program","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/community/events/design-systems-week/en/previous-editions/2025.mdx","tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"title":"Videos \xb7 Design Systems Week 2025","description":"Recordings of talks that are in English for Design Systems Week 2025.","hide_title":true,"hide_table_of_contents":true,"sidebar_label":"2025","sidebar_position":1,"pagination_label":"Videos 2025","slug":"/events/design-systems-week-2025/en/program","image":"https://raw.githubusercontent.com/nl-design-system/documentatie/assets/dsw-24-en.png"},"sidebar":"community","previous":{"title":"About Design Systems Week","permalink":"/events/design-systems-week/en"},"next":{"title":"Videos 2025","permalink":"/events/design-systems-week-2025/en/program"}}');
   var s = i(86070),
    a = i(85248),
    o = i(68873),
    r = i(2397),
   ...
   function h(e) {
    ...
    return (0, s.jsxs)('div', { lang: 'en', children: [(0, s.jsx)(n.header, { children: (0, s.jsx)(n.h1, { id: 'design-systems-week-2025', children: 'Design Systems Week 2025' }) }), (0, s.jsx)(o.fz, { lead: !0, children: (0, s.jsx)(n.p, { children: 'During Design Systems Week, you could follow several short talks each day for four days. Topics included TEDI,\nEstonia\u2019s new design system, accessibility, AI, user research, and practical tests for evaluating accessibility.\nLuckily, we still have the videos!' }) }), (0, s.jsx)(n.h2, { id: 'videos', children: 'Videos' }), (0, s.jsxs)(d.H, { allSpeakers: l, allSessions: r, sessionId: '74d8600f-b404-4e3d-a41e-9f652d8f9455', headingLevel: 2, lang: 'en', children: [(0, s.jsx)(o.fz, { children: (0, s.jsx)(n.p, { children: 'How can cities make their design systems more transparent, consistent, and easy to use for developers? The City of Vienna found an answer in the Custom Elements Manifest (CEM) \u2014 a file format that describes custom elements and makes web components easier to document and use in code editors.' }) }), (0, s.jsx)(o.fz, { children: (0, s.jsx)(n.p, { children: 'In this session, Manuel Matuzovi\u0107 shows how Vienna applies CEM to document and maintain its pattern library. He demonstrates how this approach improves usability, accessibility, and collaboration across teams.' }) })] }), (0, s.jsx)(d.H, { allSpeakers: l, allSessions: r, sessionId: '5faa9816-8348-4111-9780-eaa44d964308', headingLevel: 2, lang: 'en', children: (0, s.jsx)(o.fz, { children: (0, s.jsx)(n.p, { children: "TEDI is the design system for the Estonian public sector. What started two years ago as an internal tool quickly\ngrew into a system used nationwide. TEDI replaced the previous design system VEERA from 2018, which didn't offer\ncomponents for developers. In this session, the TEDI core team shares their experiences: the successes and the\nchallenges. They show how the system is technically structured, how the team works together, and how the design\nlibrary has developed." }) }) }), (0, s.jsx)(d.H, { allSpeakers: l, allSessions: r, sessionId: 'e68d397b-87fe-46ab-996b-ed7339f741a4', headingLevel: 2, lang: 'en', children: (0, s.jsx)(o.fz, { children: (0, s.jsx)(n.p, { children: "The Helsinki Design System is an award-winning open-source project, built to be accessible to everyone and available\nin English. This session delves into what it takes to document and scale a design system in practice\u2014covering the\nreal challenges of managing documentation workflows, and how to keep collaboration and consistency on track when the\nlatest tools aren't available. Gain insight into why process and mindset matter far more than tools, and how\nthoughtful documentation can make or break a design system." }) }) }), (0, s.jsx)(d.H, { allSpeakers: l, allSessions: r, headingLevel: 2, sessionId: '02ae9c2a-f84f-4cd1-b7c0-9afe20813acb', lang: 'en', children: (0, s.jsx)(o.fz, { children: (0, s.jsx)(n.p, { children: 'Since 2020, extensive work has been done in Luxembourg on three testing methods for accessibility: web, mobile and\nPDF. These practical tests make it easier to check how a website or web application meets the European Standard (EN\n301 549) for digital accessibility. These tests are useful for anyone working with WCAG and are now being used both in\nLuxembourg and internationally as an approach for accessibility audits. Alain will show how these testing methods work\nin practice. He will highlight the key benefits and explain how you can use and contribute to this Open Source\ninitiative.' }) }) })] });
   }
   function p(e = {}) {
