   ...
   const d = (0, c.createContext)({}),
    p = ({ title: e, appearance: n, description: l, children: c, figure: p }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      u = p ? 'figure' : 'div',
      m = p ? 'figcaption' : 'div',
      j = 'string' == typeof l ? (0, a.jsx)(t.oz, { components: { a: o.N_ }, children: l }) : l;
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const r = 'function' == typeof e ? e() : e,
        ...
        i = m().highlight(s, m().languages[n], n);
       return (0, x.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', l), children: [(0, x.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: s } }), (0, x.jsx)(j.n, { children: (0, x.jsx)(j.K, { label: 'Code', children: (0, x.jsx)('pre', { className: 'language-html nl-code-block', children: (0, x.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: i } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: u = !0, children: m, container: j = 'document', language: y, designTokens: f }) => {
       ...
       return (
        ...
        (0, x.jsxs)('div', {
         ...
         children: [
          _ && (0, x.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, x.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, x.jsx)(K, { children: (0, x.jsx)(s.v$, { children: _ }) }) }) }),
          u &&
           (0, x.jsx)('div', {
