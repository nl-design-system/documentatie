(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [85781],
 {
   ...
   function S(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      (0, r.jsx)(f.W, { tokens: b }),
      '\n',
      (0, r.jsx)(k.U, { omitH1: !0, headingLevel: 3, children: (0, r.jsx)(A, {}) }),
      '\n',
  ...
  94443: (e, t, n) => {
   ...
   const v = (e) => {
     ...
     const s = t && t.projects.filter((e) => k.e9.includes(e.id)),
      i = s && k.e9.map((e) => s.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, d.jsx)(r.a2, {
       appearance: '',
    ...
    x = (e) => {
     ...
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.V, { level: n, suffix: s && (0, d.jsx)(g.y, { state: s }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: o })] });
    };
  },
  49556: (e, t, n) => {
   'use strict';
   ...
   var p = n(6076),
    ...
    A = n(49003),
    b = n(75271);
   const x = { color: p.Z, dimension: j.Z, fontFamilies: w.Z, fontSizes: y.Z, fontWeights: f.Z, lineHeights: k.Z, other: v.Z, textDecoration: A.Z },
    C = (e) => {
     let { type: t } = e;
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => j, BA: () => c, Ee: () => d, Q6: () => s, U: () => m, Yr: () => w, d: () => u, e9: () => i, fO: () => f, mA: () => o, ps: () => g, qU: () => k, s0: () => y, zP: () => p });
