  ...
  82415: (e, n, i) => {
   ...
   const d = (e) => {
    ...
    return (0, r.jsxs)("form", {
     ...
     children: [(0, r.jsxs)(t.Wi, { type: "email", children: [(0, r.jsx)(t.nv, { children: (0, r.jsx)(t.lX, { htmlFor: `id-${o}`, children: "E-mailadres" }) }), v[o] && (0, r.jsx)(t.w7, { children: v[o].message }), (0, r.jsx)(t.nv, { children: (0, r.jsx)(t.fE, { id: `id-${o}`, name: o, type: "email", autoComplete: "email", "aria-required": "true", ...h(`${o}`, { required: { value: !0, message: "Dit veld is verplicht, maar het is niet ingevuld." }, pattern: { value: /\S+@\S+\.\S+/, message: "Dit is geen correct emailadres." } }), invalid: !!v[o] }) })] }), (0, r.jsxs)(t.Wi, { type: "text", children: [(0, r.jsx)(t.nv, { children: (0, r.jsx)(t.lX, { htmlFor: l, children: "Naam" }) }), v[l] && (0, r.jsx)(t.w7, { children: v[l].message }), (0, r.jsx)(t.nv, { children: (0, r.jsx)(t.fE, { id: l, name: l, type: "text", autoComplete: "given-name", "aria-required": "true", ...h(`${l}`, { required: { value: !0, message: "Dit veld is verplicht, maar het is niet ingevuld." } }), invalid: !!v[l] }) })] }), m && (0, r.jsxs)(t.Wi, { type: "text", children: [(0, r.jsx)(t.nv, { children: (0, r.jsx)(t.lX, { htmlFor: m, children: "Organisatie" }) }), v[m] && (0, r.jsx)(t.w7, { children: v[m].message }), (0, r.jsx)(t.nv, { children: (0, r.jsx)(t.fE, { id: m, name: m, type: "text", "aria-required": "true", ...h(`${m}`, { required: { value: !0, message: "Dit veld is verplicht, maar het is niet ingevuld." } }), invalid: !!v[m] }) })] }), u && (0, r.jsxs)(t.pg, { children: [(0, r.jsx)(t.Qv, { children: "Waar wil je NL Design System voor gebruiken? (niet verplicht)" }), (0, r.jsx)(t.ue, { children: "Meerdere antwoorden mogelijk." }), p.map((e, n) => (0, r.jsx)(t.Wi, { type: "checkbox", children: (0, r.jsxs)(t.nv, { children: [(0, r.jsx)(t.XZ, { name: `${u}[]`, value: n + 1, id: `${u}-${n + 1}` }), (0, r.jsx)(t.lX, { htmlFor: `${u}-${n + 1}`, children: e })] }) }, e))] }), c && (0, r.jsxs)(t.Wi, { type: "text", children: [(0, r.jsxs)(t.nv, { children: [(0, r.jsx)(t.lX, { htmlFor: c, children: "Aan wat voor projecten werk je? (niet verplicht)" }), (0, r.jsx)(t.ue, { children: "Denk aan mijn-omgevingen, formulieren en/of kaarten." })] }), (0, r.jsx)(t.nv, { children: (0, r.jsx)(t.gx, { id: c, name: c }) })] }), (0, r.jsx)(t.hE, { children: (0, r.jsx)(t.zx, { type: "submit", appearance: "primary-action-button", children: "Aanmelden" }) }), (0, r.jsx)("input", { type: "hidden", name: "next", value: d }), (0, r.jsx)("input", { type: "hidden", name: "a", value: i }), (0, r.jsx)("input", { type: "hidden", name: "l", value: n }), (0, r.jsx)("input", { name: "osnD9cWRI3", autoComplete: "on", id: "id-osnD9cWRI3", type: "hidden", value: "NLDS website" }), (0, r.jsx)("input", { autoComplete: "new-password", type: "email", id: "email", name: "email", placeholder: "Your e-mail here", className: "sr-only", "aria-hidden": "true" })],
    });
   };
  },
  80877: (e, n, i) => {
