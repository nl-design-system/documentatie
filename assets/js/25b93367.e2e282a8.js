 ...
 [44480],
 {
  ...
  21034(e, n, t) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
    ...
    b = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: a && (0, d.jsx)(g.D, { state: a }), children: e.title }), (0, d.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(a) && (0, d.jsx)(k.s, { relayStep: a, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    y = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
  ...
  32039(e, n, t) {
   ...
   function X(e) {
    ...
    return (t || K('Checklist', !0), i || K('ChecklistItem', !0), (0, a.jsxs)(a.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, a.jsx)(C.Fc, { component: Z, headingLevel: 1, description: O }), '\n', (0, a.jsx)(R.e, { component: Z }), '\n', (0, a.jsx)(N.Zp, { className: 'ma-implementation-card', children: (0, a.jsxs)(N.Wu, { children: [(0, a.jsx)(T.D, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, a.jsxs)(F.dk, { children: [(0, a.jsxs)(F.Pt, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=153-1056', children: [(0, a.jsx)(H.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, a.jsxs)(F.Pt, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=153-1056', children: [(0, a.jsx)(H.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, a.jsx)(T.D, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, a.jsxs)(F.dk, { children: [(0, a.jsxs)(F.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-link--documentatie', children: [(0, a.jsx)(H.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, a.jsxs)(F.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/link--documentatie', children: [(0, a.jsx)(H.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, a.jsx)(T.D, { level: 2, appearance: 'level-4', children: 'npm' }), (0, a.jsxs)(F.dk, { children: [(0, a.jsxs)(F.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/link-css', children: [(0, a.jsx)(H.r, { brand: 'npm' }), ' @nl-design-system-candidate/link-css'] }), (0, a.jsxs)(F.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/link-react', children: [(0, a.jsx)(H.r, { brand: 'npm' }), ' @nl-design-system-candidate/link-react'] }), (0, a.jsxs)(F.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/link-tokens', children: [(0, a.jsx)(H.r, { brand: 'npm' }), ' @nl-design-system-candidate/link-tokens'] })] })] }) }), '\n', (0, a.jsx)(n.h2, { id: 'checklist-voor-toegankelijkheid', children: 'Checklist voor toegankelijkheid' }), '\n', (0, a.jsx)(d.Ay, {}), '\n', (0, a.jsx)(n.h3, { id: 'acceptatiecriteria-bij-gebruik', children: 'Acceptatiecriteria bij gebruik' }), '\n', (0, a.jsx)(o.Ay, {}), '\n', (0, a.jsx)(t, { headingLevel: '4', children: z.map(({ component: e, ...n }) => (0, a.jsx)(i, { ...n, children: (0, a.jsx)(e, {}) })) }), '\n', (0, a.jsx)(n.h3, { id: 'acceptatiecriteria-van-de-component', children: 'Acceptatiecriteria van de component' }), '\n', (0, a.jsx)(l.Ay, {}), '\n', (0, a.jsx)(t, { headingLevel: '4', children: S.map(({ component: e, ...n }) => (0, a.jsx)(i, { ...n, children: (0, a.jsx)(e, {}) })) }), '\n', (0, a.jsx)(B.o, { omitH1: !0, headingLevel: 2, children: (0, a.jsx)(P, {}) }), '\n', (0, a.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }), '\n', (0, a.jsx)(_.B, { tokens: M }), '\n', (0, a.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, a.jsx)(C.VK, { component: Z, headingLevel: 3 }), '\n', (0, a.jsx)(C.$9, { component: Z, headingLevel: 2 }), '\n', (0, a.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, a.jsx)(C.mu, { component: Z, headingLevel: 3 }), '\n', (0, a.jsx)(C.K_, { component: Z })] }));
   }
   function J(e = {}) {
    const { wrapper: n } = { ...(0, r.R)(), ...e.components };
  ...
  32385(e, n, t) {
   'use strict';
   t.d(n, { bo: () => a, KF: () => m, mJ: () => p, VZ: () => w, cR: () => y, Pv: () => j, qZ: () => s, kD: () => f, QQ: () => D, B2: () => u, Pc: () => o, f4: () => l, GT: () => b, fX: () => r, eQ: () => v, B_: () => x, o_: () => k });
  ...
  70348(e, n, t) {
   ...
   const l = ({ className: e, ...n }) => {
    ...
    o = ({ className: e, classNamePanel: n, label: t, heading: l, headingLevel: o, headingApperance: d, ...c }) => {
     ...
     return (0, s.jsxs)('details', { className: g, ...c, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(a.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [l && (0, s.jsx)(r.D, { level: o, appearance: d, children: l }), t] })] }) }), (0, s.jsx)('div', { className: m, children: c.children })] });
    };
  },
  70561(e, n, t) {
   'use strict';
  ...
  70903(e, n, t) {
   ...
   var p = t(43864),
    ...
    D = t(79532),
    L = t(30758);
   const z = { boxShadow: p.A, color: j.A, cursor: k.A, dimension: x.A, fontFamily: v.A, fontFamilies: v.A, fontSize: f.A, fontSizes: f.A, fontWeight: b.A, fontWeights: b.A, lineHeight: y.A, lineHeights: y.A, number: w.A, other: A.A, textDecoration: D.A },
    S = ({ type: e }) => {
  ...
  85162(e, n, t) {
   ...
   const l = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    o = ({ name: e, relayStep: n, description: t }) => {
     const o = (0, r.fX)(n),
      d = l[e] ?? e;
     return (0, s.jsxs)(i.WK, { children: [(0, s.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, a.A)('ma-component-illustration', `ma-component-illustration--${o}`), fill: 'none', children: [(0, s.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, s.jsx)('rect', { width: '960', height: '540' }), (0, s.jsx)('rect', { width: '960', height: '540' })] }), (0, s.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, s.jsx)('use', { href: `/svg/componenten_overzicht_${(0, r.fX)(d)}.svg#component-illustration` })] }), (0, s.jsx)(i.$P, { className: 'ma-component-illustration__caption', children: t })] });
    };
  },
  90581(e, n, t) {
   'use strict';
