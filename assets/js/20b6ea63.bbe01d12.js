 ...
 [73694],
 {
  3227(e, n, i) {
   ...
   function l({ href: e, icon: n = '', title: i, description: t, children: r }) {
    return (0, d.jsxs)('div', { className: 'card', children: [e ? (0, d.jsx)(o.N, { href: e, className: (0, s.A)('cardLink', 'utrecht-link'), children: (0, d.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', i] }) }) : (0, d.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', i] }), t && (0, d.jsx)('p', { className: 'cardDescription', children: t }), r] });
   }
   function c({ item: e }) {
    return (0, d.jsx)(l, { title: e.label, description: e.description, children: (0, d.jsx)(a.Xy, { children: e.items.filter((e) => 'link' === e.type || 'category' === e.type).map((e, n) => (0, d.jsx)(a.Er, { children: 'link' === e.type ? (0, d.jsx)(o.N, { to: e.href, children: e.label }) : 'category' === e.type ? (0, d.jsxs)(o.N, { to: e.href, children: [e.items.length, " pagina's voor ", e.label] }) : (0, d.jsx)(d.Fragment, {}) }, n)) }) });
   }
   function h({ item: e }) {
    const n = (0, r.cC)(e.docId);
    return (0, d.jsx)(l, { href: e.href, title: e.label, description: e.description ?? n?.description });
   }
   function v({ item: e }) {
    switch (e.type) {
     case 'link':
      return (0, d.jsx)(h, { item: e });
     case 'category':
      return (0, d.jsx)(c, { item: e });
     default:
   ...
   function m({ className: e }) {
    const n = (0, t.$S)();
    return (0, d.jsx)(u, { items: n.items, className: e });
   }
   function u(e) {
    const { items: n, className: i } = e;
    if (!n) return (0, d.jsx)(m, { ...e });
    const o = (0, t.d1)(n);
    return (0, d.jsx)('section', { className: (0, s.A)('row', i), ...e, children: o.map((e, n) => (0, d.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, d.jsx)(v, { item: e }) }, n)) });
   }
  },
  18439(e, n, i) {
   i.d(n, { R: () => a, x: () => s });
  ...
  45282(e, n, i) {
   ...
   const r = ({ children: e, ...n }) => {
     ...
     let a = i || t;
     const s = new URL(a, 'https://nldesignsystem.nl');
     return ('https://nldesignsystem.nl' === s.origin ? ((s.pathname = s.pathname.endsWith('/') ? s.pathname : `${s.pathname}/`), (a = s.toString().replace('https://nldesignsystem.nl', ''))) : ((r.target = '_blank'), (r.rel = 'noopener noreferrer')), (0, o.jsx)('a', { href: a, ...r, children: e }));
    },
  ...
  89874(e, n, i) {
   ...
   const s = (e, n) => e.reduce((e, i) => ('link' === i.type ? (n.includes(i.docId) ? e : [...e, i]) : 'category' === i.type ? [...e, { ...i, items: s(i.items, n) }] : e), []),
    d = ({ excludeDocIDs: e = [], className: n, ...i }) => {
     const d = (0, t.$S)();
     return (0, a.jsx)('div', { ...i, className: (0, o.A)('margin-top--lg', n), children: (0, a.jsx)(r.A, { items: s(d.items, e) }) });
    };
  },
  99949(e, n, i) {
   (i.r(n), i.d(n, { assets: () => c, contentTitle: () => l, default: () => m, frontMatter: () => d, metadata: () => t, toc: () => h }));
