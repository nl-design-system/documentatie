 ...
 [67801],
 {
  ...
  12013(e, t, n) {
   ...
   const s = (e, t) => {
    ...
    a = (e) => ({ img: ({ src: t, ...n }) => (0, c.jsx)('img', { ...n, src: s(e, t), className: 'utrecht-img utrecht-img--fit' }) }),
    l = (e, t) => {
     if (e) {
      const e = { ...o[t - 1] };
      return ((e.h1 = () => null), e);
    ...
    h = ({ children: e, omitH1: t = !1, headingLevel: n = 1, baseUrl: i = '', components: s = {} }) => (0, c.jsx)(r.x, { components: { ...l(t, n), ...a(i), ...s }, children: e });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => y, VZ: () => w, cR: () => x, Pv: () => p, qZ: () => s, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => c, eQ: () => q, B_: () => g, o_: () => v, Rc: () => b });
  ...
  67568(e, t, n) {
   ...
   const q = { title: 'Heading 5', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading 5', pagination_label: 'Heading 5', description: 'Koptekst die in de koppenstructuur op het vijfde niveau staat.', slug: '/heading-5', keywords: ['caption', 'content', 'h5', 'heading', 'heading level', 'headline', 'kop', 'paginakop', 'sectie', 'section', 'structure', 'titel', 'title'] },
    ...
    f = {},
    b = 'Heading 5',
    x = 'Koptekst die in de koppenstructuur op het vijfde niveau staat.',
    w = 261,
  ...
  72401(e, t, n) {
   ...
   const o = ({ component: e }) => {
    ...
    return (0, s.jsx)(i.Suspense, { fallback: null, children: (0, s.jsx)(r.o, { omitH1: !0, headingLevel: 1, children: (0, s.jsx)(a, {}) }) });
   };
  },
  72642(e, t, n) {
   'use strict';
  ...
  85825(e, t, n) {
   ...
   const g = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, l.jsx)(r.If, { sections: c.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, v.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(y, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(p, { headingLevel: t + 1, checked: e, title: n, description: (0, v.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
