  ...
  51627(e, n, t) {
   ...
   const l = ({ className: e, ...n }) => {
    ...
    o = ({ className: e, label: n, heading: t, headingLevel: l, headingApperance: o, ...d }) => {
     ...
     return (0, s.jsxs)('details', { className: c, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(i.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [t && (0, s.jsx)(r.D, { level: l, appearance: o, children: t }), n] })] }) }), (0, s.jsx)('div', { className: 'utrecht-accordion__panel', children: d.children })] });
    };
  },
  56167(e, n, t) {
   'use strict';
   t.d(n, { VK: () => j, $9: () => v, mu: () => x, Fc: () => f, K_: () => k });
   var a = t(29181),
    i = t(13526),
    r = t(39948),
    s = t(26655),
