 ...
 [77598],
 {
  1292(e, n, t) {
   ...
   var r = t(14537),
    ...
    c = t(83386),
    l = t(86070);
   const d = { figma: (0, l.jsx)(i.A, {}), github: (0, l.jsx)(a.A, {}), npm: (0, l.jsx)(s.A, {}), storybook: (0, l.jsx)(o.A, {}) },
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => u, mJ: () => m, VZ: () => T, cR: () => w, Pv: () => g, qZ: () => s, kD: () => y, B2: () => j, Pc: () => c, f4: () => o, GT: () => x, fX: () => a, eQ: () => k, B_: () => v, o_: () => b, Rc: () => f });
  ...
  52670(e, n, t) {
   'use strict';
   t.r(n), t.d(n, { assets: () => j, component: () => b, contentTitle: () => u, default: () => y, description: () => m, frontMatter: () => h, issueNumber: () => g, metadata: () => r, title: () => p, toc: () => v });
  ...
  99630(e, n, t) {
   ...
   const p = ({ children: e }) => (0, c.jsx)('ul', { className: 'task-list', children: e }),
    m = ({ checked: e, children: n, title: t, description: r, headingLevel: a = 3 }) => (0, c.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, c.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, c.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, c.jsx)(j.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, c.jsxs)('div', { children: [t ? (0, c.jsx)(u.DZ, { appearance: 'utrecht-heading-3', level: a, children: t }) : null, r, n] })] });
   var g = t(33062);
            ...
            s.Zp,
            {
             ...
             children: (0, c.jsxs)(s.Wu, {
              children: [
               ...
               (h.length > 0 || o.length > 0) && (0, c.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, c.jsx)(c.Fragment, {
               ...
               o.length > 0 && (0, c.jsx)(c.Fragment, { children: o.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(r.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, c.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(a.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
