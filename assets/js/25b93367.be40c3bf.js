(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [44480],
 {
  ...
  18474: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => E, component: () => U, contentTitle: () => P, default: () => X, description: () => I, frontMatter: () => H, issueNumber: () => B, metadata: () => r, title: () => V, toc: () => $ });
   ...
   const H = { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: 'Een verwijzing om een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.', slug: '/link', keywords: ['a', 'a tag', 'anchor', 'anchor element', 'anchor link', 'back link', 'button as link', 'call to action link', 'cta link', 'externe link', 'external link', 'href', 'hyper link', 'hyperlink', 'inline link', 'koppeling', 'label', 'link', 'link button', 'links', 'navigatie', 'navigation', 'navlink', 'ordinal', 'standalone', 'standalone link', 'text link', 'URL', 'url', 'verwijzing', 'web address'] },
    ...
    E = {},
    V = 'Link',
    I = 'Een verwijzing om een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.',
    B = 118,
    U = o.find((e) => e.number === B),
   ...
   function Z(e) {
    ...
    return (0, i.jsxs)(i.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, i.jsx)(D.Fc, { component: U, headingLevel: 1, description: I }),
      '\n',
      (0, i.jsx)(L.e, { component: U }),
      '\n',
      (0, i.jsx)(n.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, i.jsx)(N.H, { component: U, illustration: d.A }),
      '\n',
      ...
      (0, i.jsx)(W.b, {
       headingLevel: '4',
       items: [
        { title: 'Als het label van de Link uit een icoon bestaat, dan heeft deze een goed tekstalternatief.', sc: '1.1.1', status: '', component: (0, i.jsx)(u, {}), tags: ['designer', 'contentmaker'] },
        { title: 'Links in een lopende tekst zijn duidelijk zichtbaar.', sc: '1.4.1', status: '', component: (0, i.jsx)(p, {}), tags: ['designer', 'contentmaker'] },
        { title: 'De contrastverhouding van de tekstkleur van de Link met de achtergrondkleur is hoog genoeg.', sc: '1.4.3', status: '', component: (0, i.jsx)(k.Ay, {}), tags: ['designer', 'contentmaker'] },
        { title: 'Het label van de Link bestaat uit gewone tekst, niet uit een afbeelding van tekst.', sc: '1.4.5', status: '', component: (0, i.jsx)(C.Ay, {}), tags: ['designer', 'contentmaker'] },
        { title: 'Als het zichtbare label van de Link alleen een afbeelding of icoon is, dan is het contrast tussen de afbeelding en de achtergrond minimaal 3:1.', sc: '1.4.11', status: '', component: (0, i.jsx)(m.Ay, {}), tags: ['designer', 'contentmaker'] },
        { title: 'De linktekst van de Link vertelt eenduidig aan de gebruiker waar de link naar toe gaat (het linkdoel).', sc: '2.4.4', status: '', component: (0, i.jsx)(G.Ay, {}), tags: ['designer', 'contentmaker'] },
        { title: 'Als de Link de toetsenbordfocus krijgt, is het element niet volledig bedekt door andere inhoud', sc: '2.4.11', status: '', component: (0, i.jsx)(z.Ay, {}), tags: ['developer', 'designer'] },
        { title: 'Als de tekst van de Link in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: (0, i.jsx)(A.Ay, {}), tags: ['developer', 'contentmaker'] },
        { title: 'Links met gelijke functies hebben hetzelfde uiterlijk en hetzelfde label', sc: '3.2.4', status: '', component: (0, i.jsx)(T.Ay, {}), tags: ['developer', 'designer', 'contentmaker'] },
       ],
      }),
      '\n',
      ...
      (0, i.jsx)(W.b, {
       ...
       items: [
        ...
        { title: 'De functionaliteit van de Link veroorzaakt geen toetsenbordval.', sc: '2.1.2', status: '', component: (0, i.jsx)(R.Ay, {}), tags: ['developer'] },
        ...
        { title: 'Als de gebruiker de Link indrukt met een aanwijzer zoals een muis of vinger, is er de mogelijkheid om de actie te voorkomen of ongedaan te maken.', sc: '2.5.2', status: '', component: (0, i.jsx)(y.Ay, {}), tags: ['developer'] },
      ...
      '\n',
      (0, i.jsx)(D.mu, { component: U, headingLevel: 3 }),
      '\n',
      (0, i.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, i.jsx)(D.VK, { component: U, headingLevel: 3 }),
      '\n',
      (0, i.jsx)(n.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }),
      '\n',
      (0, i.jsx)(D.$9, { component: U, headingLevel: 3 }),
     ],
    });
   }
   function X(e = {}) {
  ...
  50341: (e, n, t) => {
   ...
   const v = ({ children: e }) => (0, d.jsx)('ul', { className: 'task-list', children: e }),
    y = ({ checked: e, children: n, title: t, description: r, headingLevel: s = 3 }) => (0, d.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, d.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, d.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, d.jsx)(w.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(f.DZ, { appearance: 'utrecht-heading-3', level: s, children: t }), r, n] })] });
   var x = t(75916);
  ...
  73361: (e, n, t) => {
   ...
   var j = t(30696),
    ...
    x = t(43825),
    b = t(30758);
   const A = { color: j.A, dimension: p.A, fontFamilies: k.A, fontSizes: f.A, fontWeights: w.A, lineHeights: v.A, other: y.A, textDecoration: x.A },
    T = ({ type: e }) => (0, m.jsx)(u.In, { children: (0, b.createElement)(A[e]) });
   function C({ tokens: e }) {
    const n = (0, s.kD)(e),
     t = (0, s.GT)(n),
       ...
       children: [
        ...
        (0, m.jsx)(o.BF, {
         children: t.map((n) => {
          const t = (0, s.o_)(n),
           a = (0, s.eQ)(e, n).$type;
          return (0, m.jsxs)(o.Hj, { children: [(0, m.jsx)(o.nA, { children: (0, m.jsx)(r.C, { children: (0, m.jsx)(o.kf, { children: t }) }) }), (0, m.jsx)(o.nA, { children: (0, m.jsxs)(i.K, { children: [(0, m.jsx)(T, { type: a }), ' ', a] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  75916: (e, n, t) => {
   'use strict';
   t.d(n, { B2: () => h, B_: () => p, GT: () => w, KF: () => d, Pc: () => a, Pv: () => g, Rc: () => v, bo: () => r, eQ: () => k, f4: () => o, fX: () => i, kD: () => f, mJ: () => m, o_: () => j, qZ: () => s });
   ...
   const l = (e) => {
    ...
    u = (e) => {
     const n = / URL \(([^)]+)\)/;
     return l(c(e.tasks.filter(({ name: e, value: t }) => '' !== t && n.test(e)).map(({ name: e }) => n.exec(e)?.[1])));
    },
