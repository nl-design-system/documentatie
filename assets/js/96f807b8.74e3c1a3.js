...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [84367],
 {
  ...
  43599: (e, l, n) => {
   ...
   const p = (e) => {
    let { children: l } = e;
    return (0, b.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(o.BB, { className: (0, r.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, b.jsx)(o.nv, { className: 'nlds-canvas__example-paragraph', children: l }) }) });
   };
   p.displayName = 'ParagraphContainer';
   const m = (e) => {
    let { children: l } = e;
    return (0, b.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(o.BB, { className: (0, r.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: l }) });
   };
   m.displayName = 'DocumentContainer';
   const v = (e) => {
    let { children: l } = e;
    return (0, b.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: l });
   };
   ...
   const g = (e) => {
    ...
    (0, h.useEffect)(() => {
     (async () => {
      (z = await d.ZP.format(N, { parser: f, plugins: [a.Z, s.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(z);
     })();
    }, [N]);
    const P = (0, h.useId)();
    let S = h.Fragment;
    return (
     ...
     (0, b.jsxs)('div', {
      ...
      children: [
       _ && (0, b.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, b.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, b.jsx)(S, { children: (0, b.jsx)(o.pu, { children: _ }) }) }) }),
       j &&
        (0, b.jsx)('div', {
       ...
       j &&
        (0, b.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, b.jsx)(t.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: z, trim: !0 }),
          n &&
           (0, b.jsx)('div', {
