 ...
 [76950],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    l = n(86070);
   const u = { figma: (0, l.jsx)(c.A, {}), github: (0, l.jsx)(i.A, {}), npm: (0, l.jsx)(o.A, {}), storybook: (0, l.jsx)(s.A, {}) },
    h = ({ brand: e }) => (0, l.jsx)(r.In, { children: u[e] || (0, l.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => g, qZ: () => o, kD: () => b, B2: () => j, Pc: () => a, f4: () => s, GT: () => f, fX: () => i, eQ: () => k, B_: () => v, o_: () => p, Rc: () => x });
   ...
   const o = ({ background: e, children: t, className: n, ...r }) => (0, i.jsx)('div', { className: (0, c.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: o = 'div', background: s, children: a }) => {
     const l = (e) => ('article' === o ? (0, i.jsx)('article', { ...e }) : 'section' === o ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      u = (0, i.jsx)(l, { className: (0, c.A)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
