...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [15412],
 {
  ...
  43599: (e, n, t) => {
   ...
   const p = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(r.BB, { className: (0, i.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, h.jsx)(r.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   p.displayName = 'ParagraphContainer';
   const b = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(r.BB, { className: (0, i.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const g = (e) => {
    ...
    (0, m.useEffect)(() => {
     (async () => {
      (N = await c.ZP.format(z, { parser: y, plugins: [o.Z, a.ZP, d.ZP, s.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(N);
     })();
    }, [z]);
    const D = (0, m.useId)();
    let S = m.Fragment;
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       w && (0, h.jsx)('div', { className: (0, i.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(S, { children: (0, h.jsx)(r.pu, { children: w }) }) }) }),
       v &&
        (0, h.jsx)('div', {
