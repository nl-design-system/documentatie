(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [36360],
 {
  ...
  38206: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => z, component: () => N, contentTitle: () => G, default: () => S, description: () => R, frontMatter: () => T, issueNumber: () => D, metadata: () => L, title: () => W, toc: () => _ });
   var r = t(52676),
    i = t(24785),
    o = t(50460),
    s = t(34434),
  ...
  23952: (e, n, t) => {
   ...
   const z = (e) => {
     ...
     const o = n && n.projects.filter((e) => L.e9.includes(e.id)),
      s = o && L.e9.map((e) => o.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
       sections: s.map((e) => ({
        className: (0, i.Z)(m['definition-of-done'], e && m[`definition-of-done--${(0, L.mA)(e.title)}`]),
        headingLevel: t,
        expanded: !1,
          ...
          children: [
           (0, d.jsx)(T, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(G, { checked: n, title: t, description: (0, L.Q6)(r) }, r);
            }),
           }),
