 ...
 [44275],
 {
  11925: (e, t, n) => {
   ...
   const o = { title: 'Logo', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Logo', pagination_label: 'Logo', description: 'Afbeelding met het beeldmerk of woordmerk van een organisatie.', slug: '/logo', keywords: ['beeldmerk', 'brand', 'brand identity', 'brand logo', 'huisstijl', 'identiteit', 'graphic', 'image', 'logo', 'merkidentiteit', 'pictogram', 'symbol', 'visual identity', 'visual representation', 'visuele representatie', 'word', 'woordmerk'] },
    a = void 0,
    l = { id: 'componenten/logo/index', title: 'Logo', description: 'Afbeelding met het beeldmerk of woordmerk van een organisatie.', source: '@site/docs/componenten/logo/index.mdx', sourceDirName: 'componenten/logo', slug: '/logo', permalink: '/logo', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/logo/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Logo', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Logo', pagination_label: 'Logo', description: 'Afbeelding met het beeldmerk of woordmerk van een organisatie.', slug: '/logo', keywords: ['beeldmerk', 'brand', 'brand identity', 'brand logo', 'huisstijl', 'identiteit', 'graphic', 'image', 'logo', 'merkidentiteit', 'pictogram', 'symbol', 'visual identity', 'visual representation', 'visuele representatie', 'word', 'woordmerk'] }, sidebar: 'componenten', previous: { title: 'Login Link', permalink: '/login-link' }, next: { title: 'Mark', permalink: '/mark' } },
    u = {},
    h = [
