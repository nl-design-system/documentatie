/*! For license information please see 6c269cf8.2c1c31d2.js.LICENSE.txt */
'use strict';
 ...
 [12356],
 {
  98480: (e, L, l) => {
   ...
   const x = (e) => {
    ...
    (0, i.useEffect)(() => {
     (async () => {
      (V = await c.ZP.format(C, { parser: j, plugins: [o.Z, r.ZP, a.ZP, s.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(V);
     })();
    }, [C]);
    const A = (0, i.useId)();
    let S = i.Fragment;
    return (
     'paragraph' === y ? (S = h) : 'document' === y ? (S = v) : 'surface' === y && (S = _),
     (0, m.jsxs)('div', {
  ...
  41179: (e, L, l) => {
   ...
   var r = l(52676);
   function a(e) {
    let { lineNumber: L, syntax: l, textContent: a, trim: s } = e,
     c = a;
    return (
     s && (c = c.trim()),
     (0, r.jsx)(t.y$, {
      ...
      language: l || '',
      children: (e) => {
       let { style: l, tokens: t, getLineProps: o, getTokenProps: a } = e;
       return (0, r.jsx)(n.dn, { tabIndex: 0, style: l, children: t.map((e, l) => (0, r.jsxs)('span', { ...o({ line: e }), children: [L && (0, r.jsx)('span', { children: l + 1 }), e.map((e, L) => (0, r.jsx)('span', { ...a({ token: e }) }, L)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, L, l) => {
   ...
   var s = l(52676);
   const c = (e) => {
    let { title: L, appearance: l, description: c, children: i, figure: d } = e;
    const u = 'Doen',
     p = 'Niet doen',
     m = d ? 'figure' : 'div',
     h = d ? 'figcaption' : 'div';
    return (0, s.jsxs)(m, { className: (0, r.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof L ? L?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, s.jsxs)(h, { className: (0, r.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(o.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, s.jsx)(n.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, s.jsx)('span', { className: a['nlds-guideline__title'], children: p })] }), (0, s.jsx)(o.nv, { children: L })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(o.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, s.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, s.jsx)('span', { className: a['nlds-guideline__title'], children: u })] }), (0, s.jsx)(o.nv, { children: L })] }), c] }), (0, s.jsx)('div', { className: (0, r.Z)(a['nlds-guideline__example']), children: i })] });
   };
  },
  89011: (e, L, l) => {
   l.r(L), l.d(L, { default: () => C, parseColor: () => y });
   var n = l(3225),
    t = l(87502),
    o = l(98480),
    r = l(46506),
   ...
   var u = l(91050),
    p = l(38889),
    m = l(56150);
   const h = (0, s.forwardRef)((e, L) => {
    let { autoComplete: l, defaultValue: n, description: t, disabled: o, errorMessage: r, invalid: c, label: d, max: u, min: p, name: h, onBlur: v, onChange: _, onFocus: x, onInput: g, pattern: b, placeholder: y, readOnly: j, required: k, status: f, type: N, value: C, ...V } = e;
    const Z = (0, s.useId)(),
     H = (0, s.useId)(),
     w = (0, s.useId)(),
     A = (0, s.useId)();
    return (0, i.jsxs)(m.Wi, { invalid: c, ...V, children: [(0, i.jsx)('p', { className: 'utrecht-form-field__label', children: (0, i.jsx)(m.lX, { htmlFor: Z, children: d }) }), t && (0, i.jsx)(m.ue, { id: H, children: t }), c && r && (0, i.jsx)(m.w7, { className: 'utrecht-form-field__error-message', id: A, children: r }), (0, i.jsx)('p', { className: 'utrecht-form-field__input', children: (0, i.jsx)(m.fE, { ref: L, id: Z, name: h, type: N || 'text', autoComplete: l, 'aria-describedby': (0, a.Z)({ [H]: t, [A]: c, [w]: f }) || void 0, invalid: c, dir: 'auto', disabled: o, min: 'number' == typeof p ? String(p) : 'string' == typeof p ? p : void 0, max: 'number' == typeof u ? String(u) : 'string' == typeof u ? u : void 0, pattern: b, placeholder: y, readOnly: j, 'aria-required': k, value: C, onFocus: x, onBlur: v, onInput: g, onChange: _, defaultValue: n }) }), f && (0, i.jsx)('div', { className: 'utrecht-form-field__status', id: w, children: (0, i.jsx)('div', { className: 'utrecht-form-field-description utrecht-form-field-description--status', children: f }) })] });
   });
   ...
   const x = 'nlds-form_L93Q',
    ...
    C = () => {
     const { siteConfig: e } = (0, t.Z)(),
      ...
      c = y(a),
      m = y(s),
      v = `https://nldesignsystem.nl/contrast/?${new URLSearchParams({ 'background-color': a, color: s }).toString()}`,
      ...
      g = [
       ...
       { positive: !0, result: _ >= 3, content: (0, i.jsx)(i.Fragment, { children: 'Je mag de kleuren gebruiken voor tekst groter dan 24px, als je wilt voldoen aan WCAG 2.2 AA niveau.' }), container: 'document', example: N },
