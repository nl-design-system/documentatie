/*! For license information please see 5c0cafdc.69a460fd.js.LICENSE.txt */
'use strict';
  ...
  20201(e, n, t) {
   ...
   const o = s.forwardRef(function (e, n) {
    const [t, o] = s.useState(!1),
     ...
     T = s.useCallback(e.onIframeAdded || function () {}, [e.onIframeAdded]),
    ...
    return (
     s.useEffect(() => {
      l && (T(), e.focusOnLoad && 'object' == typeof n && n?.current && n.current.focus());
     }, [l, T, e.focusOnLoad, n]),
     s.useEffect(() => {
     ...
     (0, a.jsxs)(a.Fragment, {
      children: [
       ...
       (0, a.jsxs)(P, {
        ...
        children: [e.lazyLoad && !l && (0, a.jsx)('img', { src: x, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !l && (0, a.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && l) && (0, a.jsx)('button', { type: 'button', className: _, 'aria-label': `${u} ${p}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, onClick: E, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: u }) }), l && (0, a.jsx)('iframe', { ref: n, className: M, title: p, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: f, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
