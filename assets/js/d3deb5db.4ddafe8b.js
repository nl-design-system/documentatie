 ...
 [67752],
 {
  ...
  23615(e, t, n) {
   ...
   var i = n(86070),
    ...
    o = n(36059),
    s = n(85825);
   const a = { title: 'Toggletip', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Toggletip', pagination_label: 'Toggletip', description: 'Een knop die tijdelijke informatie toont en deze automatisch verbergt wanneer iets anders dan de knop wordt gebruikt.', slug: '/toggletip', keywords: ['callout', 'definition tooltip', 'toggle', 'toggle button', 'toggletip', 'tip', 'tooltip', 'informatiepaneel', 'informatieknop', 'pop-up'] },
    u = void 0,
    l = {},
    h = 'Toggletip',
    d = 'Een knop die tijdelijke informatie toont en deze automatisch verbergt wanneer iets anders dan de knop wordt gebruikt.',
    j = 170,
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => g, VZ: () => _, cR: () => w, Pv: () => p, qZ: () => o, kD: () => b, B2: () => j, Pc: () => a, f4: () => s, GT: () => f, fX: () => c, eQ: () => v, B_: () => k, o_: () => m, Rc: () => x });
  ...
  85825(e, t, n) {
   ...
   const k = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: c.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, m.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(g, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(p, { headingLevel: t + 1, checked: e, title: n, description: (0, m.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
