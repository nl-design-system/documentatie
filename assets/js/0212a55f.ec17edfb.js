 ...
 [47675],
 {
  18127(e, n, t) {
   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: j = !0, children: g, container: x = 'document', language: y, designTokens: f }) => {
    ...
    let V = u.Fragment;
    return (
     'paragraph' === x ? (V = p) : 'document' === x ? (V = v) : 'surface' === x && (V = b),
     (0, m.jsxs)('div', {
      className: (0, l.A)('nlds-canvas'),
      children: [
       k && (0, m.jsx)('div', { className: (0, l.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(V, { children: (0, m.jsx)(o.v$, { children: k }) }) }) }),
       j &&
        (0, m.jsx)('div', {
