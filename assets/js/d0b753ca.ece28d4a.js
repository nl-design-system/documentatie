...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [71842],
 {
  ...
  25674(e, n, t) {
   (t.r(n), t.d(n, { assets: () => c, component: () => g, contentTitle: () => d, default: () => v, description: () => u, frontMatter: () => l, issueNumber: () => m, metadata: () => o, title: () => p, toc: () => h }));
   ...
   const l = { title: 'Radio Button', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Radio Button', pagination_label: 'Radio Button', description: 'Invoerveld voor het kiezen van een enkele optie uit een groep van opties.', slug: '/radio-button', keywords: ['form', 'invoerveld', 'optie', 'opties', 'option', 'option button', 'radio', 'radio button', 'radioknop', 'keuze', 'keuzemogelijkheid', 'keuzerondje'] },
    ...
    c = {},
    p = 'Radio Button',
    u = 'Invoerveld voor het kiezen van een enkele optie uit een groep van opties.',
    m = 65,
    g = a.find((e) => e.number === m),
    h = [
   ...
   function f(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, i.jsx)(s.Fc, { component: g, headingLevel: 1, description: u }), '\n', (0, i.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, i.jsx)(s.VK, { component: g, headingLevel: 3 }), '\n', (0, i.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, i.jsx)(s.mu, { component: g, headingLevel: 3 }), '\n', (0, i.jsx)(s.K_, { component: g }), '\n', (0, i.jsx)(s.$9, { component: g, headingLevel: 2 })] });
   }
   function v(e = {}) {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => u, mJ: () => h, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => a, kD: () => x, B2: () => m, Pc: () => l, f4: () => s, GT: () => k, fX: () => r, eQ: () => b, B_: () => j, o_: () => v, Rc: () => _ });
  ...
  37131(e, n, t) {
   ...
   const h = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    ...
    b = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u.p, { level: n, suffix: i && (0, d.jsx)(p.D, { state: i }), children: e.title }), (0, d.jsx)(o.fz, { lead: !0, children: t })] });
    },
    x = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
