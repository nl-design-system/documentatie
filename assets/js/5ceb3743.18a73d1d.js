...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [16387],
 {
  ...
  18439(e, n, l) {
   ...
   function s(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(o) : e.components || o) : t(e.components)), i.createElement(r.Provider, { value: n }, e.children));
   }
  },
  58639(e, n, l) {
   l.d(n, { H: () => v });
   ...
   const g = ({ children: e }) => (0, m.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(o.yo, { className: (0, r.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const v = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: v = !0, children: y, container: f = 'document', language: x, designTokens: b }) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await a.Ay.format(w, { parser: x, plugins: [t.A, s.Ay, c.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      A(e);
     })();
    }, [w]);
    const C = (0, u.useId)();
    ...
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       k && (0, m.jsx)('div', { className: (0, r.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: b, children: (0, m.jsx)(R, { children: (0, m.jsx)(o.v$, { children: k }) }) }) }),
       v &&
        (0, m.jsx)('div', {
  ...
  69284(e, n, l) {
   ...
   function d({ lineNumber: e, syntax: n, textContent: l, trim: d }) {
    ...
    const { title: u, type: p } = (0, r.useContext)(t.x),
     m = (0, r.useId)();
    return (d && (a = a.trim()), (0, c.jsx)(o.f4, { theme: s, code: a, language: n || '', children: ({ style: n, tokens: l, getLineProps: o, getTokenProps: r }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, c.jsx)(i.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': m, style: n, children: l.map((n, l) => (0, c.jsxs)('span', { ...o({ line: n }), children: [e && (0, c.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, c.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  78734(e, n, l) {
   l.d(n, { Ay: () => s, RM: () => r });
