(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [31116],
 {
  ...
  26095(e, n, a) {
   'use strict';
   (a.r(n), a.d(n, { assets: () => k, component: () => F, contentTitle: () => q, default: () => A, description: () => T, frontMatter: () => x, issueNumber: () => D, metadata: () => t, title: () => j, toc: () => H }));
   ...
   var f = a(1457),
    b = a(12761);
   const x = { title: 'Heading 1', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading 1', pagination_label: 'Heading 1', description: 'Hoofdkop van een pagina.', slug: '/heading-1', keywords: ['caption', 'content', 'h1', 'heading', 'heading level', 'headline', 'kop', 'sectie', 'section', 'structure', 'titel', 'title'] },
    q = void 0,
    k = {},
    j = 'Heading 1',
  ...
  76097(e, n, a) {
   'use strict';
   a.d(n, { bo: () => l, KF: () => m, mJ: () => p, VZ: () => T, cR: () => j, Pv: () => v, qZ: () => s, kD: () => q, QQ: () => F, B2: () => c, Pc: () => r, f4: () => o, GT: () => k, fX: () => i, eQ: () => x, B_: () => b, o_: () => f });
