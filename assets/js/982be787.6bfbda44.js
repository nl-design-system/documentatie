   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: j = !0, children: g, container: x = 'document', language: y, designTokens: f }) => {
    ...
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       k && (0, p.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(R, { children: (0, p.jsx)(r.v$, { children: k }) }) }) }),
       j &&
        (0, p.jsx)('div', {
       ...
       j &&
        (0, p.jsxs)('div', {
         ...
         hidden: !A,
         children: [
          (0, p.jsx)(t.M, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: z, trim: !0 }),
          n &&
           (0, p.jsx)('div', {
