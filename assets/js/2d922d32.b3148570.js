...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  87324: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => p, default: () => x, frontMatter: () => u, metadata: () => j, toc: () => v });
   var t = i(52676),
    r = i(40139),
    s = i(57716),
    a = i(46364),
   ...
   function h(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.p, { children: 'Een website is staand en liggend gelijkwaardig.' }), '\n', (0, t.jsx)(n.p, { children: 'Zorg ervoor dat een bezoeker het scherm niet fysiek hoeft te draaien om een webpagina goed te kunnen gebruiken. Je moet de website kunnen bekijken in zowel landschap-modus (liggend) als in portret-modus (staand).' }), '\n', (0, t.jsx)(n.p, { children: 'Er kan een uitzondering zijn voor delen en/of functies van de website. Bijvoorbeeld voor het maken en uploaden van een foto van een ID kaart of document.' }), '\n', (0, t.jsx)(n.p, { children: 'Sommige mensen hebben hun apparaten in een vaste houding bevestigd. Bijvoorbeeld mensen met een rolstoel met een tablet eraan vast. De tablet is dan niet makkelijk te verplaatsen of te draaien. Een website moet dan werken, los van hoe de tablet gemonteerd is.' })] });
   }
   function g(e = {}) {
   ...
   const u = { title: 'WCAG-succescriterium 1.3.4 Weergavestand', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.4 Weergavestand', pagination_label: 'WCAG-succescriterium 1.3.4 Weergavestand', description: 'Een website is staand en liggend gelijkwaardig.', slug: '1.3.4', keywords: ['WCAG', 'AA', 'waarneembaar', 'aanpasbaar', 'perceivable', 'adaptable', 'orientation'] },
    p = void 0,
    j = { id: 'wcag/1.3.04', title: 'WCAG-succescriterium 1.3.4 Weergavestand', description: 'Een website is staand en liggend gelijkwaardig.', source: '@site/docs/wcag/1.3.04.mdx', sourceDirName: 'wcag', slug: '/wcag/1.3.4', permalink: '/wcag/1.3.4', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.3.04.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.3.4 Weergavestand', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.4 Weergavestand', pagination_label: 'WCAG-succescriterium 1.3.4 Weergavestand', description: 'Een website is staand en liggend gelijkwaardig.', slug: '1.3.4', keywords: ['WCAG', 'AA', 'waarneembaar', 'aanpasbaar', 'perceivable', 'adaptable', 'orientation'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.3.3 Zintuiglijke eigenschappen', permalink: '/wcag/1.3.3' }, next: { title: 'WCAG-succescriterium 1.3.5 Identificeer het doel van de input', permalink: '/wcag/1.3.5' } },
    m = {},
    v = [
   ...
   function w(e) {
    const n = { a: 'a', h2: 'h2', li: 'li', ul: 'ul', ...(0, r.a)(), ...e.components };
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(a.j, { level: 1, conformanceLevel: 'Niveau AA', children: 'WCAG-succescriterium 1.3.4 Weergavestand' }), '\n', (0, t.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, t.jsx)(g, {}), '\n', (0, t.jsx)(n.h2, { id: 'hoe-te-testen', children: 'Hoe te testen' }), '\n', (0, t.jsxs)(n.ul, { children: ['\n', (0, t.jsx)(n.li, { children: 'Open een webpagina in een browser op een computer en pas de verhoudingen van het venster aan. Controleer of dezelfde inhoud en functionaliteit aanwezig is als de verhoudingen liggend en staand zijn.' }), '\n', (0, t.jsx)(n.li, { children: 'Deze test kan ook op een mobiel apparaat gedaan worden. Stel op het apparaat in dat het scherm gedraaid kan worden. Draai het scherm en controleer of dezelfde inhoud en functionaliteit aanwezig is als de verhoudingen liggend en staand zijn.' }), '\n'] }), '\n', (0, t.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, t.jsx)(o.ZP, {}), '\n', (0, t.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, t.jsxs)(n.ul, { children: ['\n', (0, t.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, t.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#orientation', children: (0, t.jsx)('span', { lang: 'en', children: '1.3.4 Orientation' }) }), '.'] }), '\n', (0, t.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, t.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#weergavestand', children: '1.3.4 Weergavestand' }), '.'] }), '\n', (0, t.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, t.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, t.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#orientation', children: (0, t.jsx)('span', { lang: 'en', children: 'Quick Reference 1.3.4 Orientation' }) }), '.'] }), '\n', (0, t.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, t.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/orientation.html', children: (0, t.jsx)('span', { lang: 'en', children: 'Understanding SC 1.3.4 Orientation' }) }), '.'] }), '\n'] }), '\n', (0, t.jsx)(l.CY, { children: (0, t.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, t.jsx)(d.ZP, {}) }) }), '\n', (0, t.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, t.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, t.jsx)(c.ZP, {}) })] });
   }
   function x(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
