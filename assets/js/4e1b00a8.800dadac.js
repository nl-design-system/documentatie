...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  88295: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => v, contentTitle: () => j, default: () => b, frontMatter: () => p, metadata: () => m, toc: () => x });
   var r = i(52676),
    t = i(40139),
    s = i(57716),
    l = i(46364),
