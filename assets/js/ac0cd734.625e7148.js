 ...
 [94318],
 {
  15175(e, l, n) {
   ...
   function c({ lineNumber: e, syntax: l, textContent: n, trim: c }) {
    ...
    const { title: h, type: u } = (0, a.useContext)(t.x),
     m = (0, a.useId)();
    return (c && (d = d.trim()), (0, i.jsx)(s.f4, { theme: o, code: d, language: l || '', children: ({ style: l, tokens: n, getLineProps: s, getTokenProps: a }) => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, i.jsx)(r.NG, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': m, style: l, children: n.map((l, n) => (0, i.jsxs)('span', { ...s({ line: l }), children: [e && (0, i.jsx)('span', { children: n + 1 }), l.map((e, l) => (0, i.jsx)('span', { ...a({ token: e }) }, l)), '\n'] }, n)) })] }) }));
   }
  },
  18439(e, l, n) {
   n.d(l, { R: () => t, x: () => o });
   ...
   const d = (0, i.createContext)({}),
    h = ({ title: e, appearance: l, description: n, children: i, figure: h }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      m = h ? 'figure' : 'div',
      p = h ? 'figcaption' : 'div',
      j = 'string' == typeof n ? (0, c.jsx)(o.oz, { components: { a: a.N_ }, children: n }) : n;
     return (0, c.jsxs)(m, { className: (0, t.A)('nlds-guideline', `nlds-guideline--${l}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(p, { className: 'nlds-guideline__description', children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(a.fz, { className: (0, t.A)('nlds-guideline__badge', `nlds-guideline__badge--${l}`), children: [(0, c.jsx)(s.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, c.jsx)('span', { className: 'nlds-guideline__title', children: u.dont })] }), (0, c.jsx)(a.fz, { children: e })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(a.fz, { className: (0, t.A)('nlds-guideline__badge', `nlds-guideline__badge--${l}`), children: [(0, c.jsx)(r.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, c.jsx)('span', { className: 'nlds-guideline__title', children: u.do })] }), (0, c.jsx)(a.fz, { children: e })] }), j] }), (0, c.jsx)('div', { className: 'nlds-guideline__example', children: (0, c.jsx)(d.Provider, { value: { title: e, type: u[l] }, children: i }) })] });
    };
  },
  70348(e, l, n) {
   n.d(l, { K: () => c, n: () => i });
   var r = n(13526),
    ...
    t = n(37168),
    o = n(86070);
   const i = (0, s.forwardRef)(({ as: e, className: l, children: n, ...s }, a) => {
     const t = e || 'div',
      i = (0, r.A)('ma-utrecht-accordion', 'utrecht-accordion', l);
     return (0, o.jsx)(t, { ref: a, className: i, ...s, children: n });
    }),
    c = ({ className: e, classNamePanel: l, label: n, heading: s, headingLevel: i, headingApperance: c, ...d }) => {
     const h = (0, r.A)('utrecht-accordion__section', e),
      u = (0, r.A)('utrecht-accordion__panel', l);
     return (0, o.jsxs)('details', { className: h, ...d, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(a.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [s && (0, o.jsx)(t.D, { level: i, appearance: c, children: s }), n] })] }) }), (0, o.jsx)('div', { className: u, children: d.children })] });
    };
  },
  80731(e, l, n) {
   n.d(l, { H: () => k });
   var r = n(15175),
    ...
    j = n(70348),
    g = n(86070);
   const b = ({ children: e }) => (0, g.jsx)(s.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(s.yo, { className: (0, a.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(s.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   b.displayName = 'ParagraphContainer';
   const x = ({ children: e }) => (0, g.jsx)(s.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(s.yo, { className: (0, a.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const k = globalThis.isAstro
    ? ({ children: e, language: l, className: n }) => {
       ...
       return (0, g.jsxs)('div', { className: (0, a.A)('ma-canvas-astro', n), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: s } }), (0, g.jsx)(j.n, { children: (0, g.jsx)(j.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: t } }) }) }) })] });
      }
    : ({ code: e, copy: l = !0, defaultExpandedCode: n = !1, displayCode: m = !0, children: p, container: j = 'document', language: k, designTokens: f }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: k, plugins: [t.A, o.Ay, i.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [N]);
       const S = (0, h.useId)();
       ...
       return (
        ...
        (0, g.jsxs)('div', {
         ...
         children: [
          y && (0, g.jsx)('div', { className: (0, a.A)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, g.jsx)(R, { children: (0, g.jsx)(s.v$, { children: y }) }) }) }),
          m &&
           (0, g.jsx)('div', {
  ...
  89347(e, l, n) {
   ...
   function c(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', (0, s.jsx)(l.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, s.jsx)(i.$, { appearance: 'do', title: 'Koppel het label aan het formulierveld.', children: (0, s.jsx)(o.H, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)('p', { children: (0, s.jsx)('label', { htmlFor: 'kleur3', children: 'Wat is je lievelingskleur?' }) }), (0, s.jsx)('p', { children: (0, s.jsx)('input', { type: 'text', id: 'kleur3', name: 'lievelingskleur' }) })] }) }) }), '\n', (0, s.jsx)(i.$, { appearance: 'do', title: 'Koppel het label aan het formulierveld (select).', children: (0, s.jsx)(o.H, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)('p', { children: (0, s.jsx)('label', { htmlFor: 'kleur4', children: 'Wat is je lievelingskleur?' }) }), (0, s.jsx)('p', { children: (0, s.jsxs)('select', { id: 'kleur4', name: 'lievelingskleur', children: [(0, s.jsx)('option', { children: 'Rood' }), (0, s.jsx)('option', { children: 'Blauw' }), (0, s.jsx)('option', { children: 'Wit' })] }) })] }) }) }), '\n', (0, s.jsx)(i.$, { appearance: 'dont', title: 'Een div in plaats van een label gebruiken.', description: 'De for en id koppeling werkt alleen met een label-element.', children: (0, s.jsx)(o.H, { language: 'html', children: () => (0, s.jsxs)('div', { 'data-test-axe': 'false', children: [(0, s.jsx)('div', { htmlFor: 'kleur5', children: 'Wat is je lievelingskleur?' }), (0, s.jsx)('input', { type: 'text', id: 'kleur5', name: 'lievelingskleur', 'data-test-axe': 'false' })] }) }) }), '\n', (0, s.jsx)(i.$, { appearance: 'dont', title: 'Een label zonder gekoppelde input. Door het label-element te gebruiken zonder for mis je de koppeling tussen het label en de input voor mensen die de visuele context niet waarnemen.', children: (0, s.jsx)(o.H, { language: 'html', children: () => (0, s.jsxs)('div', { 'data-test-axe': 'false', children: [(0, s.jsx)('p', { children: (0, s.jsx)('label', { children: 'Wat is je lievelingskleur?' }) }), (0, s.jsx)('p', { children: (0, s.jsxs)('select', { 'data-test-axe': 'false', name: 'lievelingskleur', children: [(0, s.jsx)('option', { children: 'Rood' }), (0, s.jsx)('option', { children: 'Blauw' }), (0, s.jsx)('option', { children: 'Wit' })] }) })] }) }) })] });
   }
   function d(e = {}) {
   ...
   function h(e) {
    const l = { a: 'a', code: 'code', h1: 'h1', h2: 'h2', header: 'header', li: 'li', p: 'p', pre: 'pre', strong: 'strong', ul: 'ul', ...(0, a.R)(), ...e.components };
