(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [44480],
 {
  ...
  33330(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => $, component: () => Z, contentTitle: () => O, default: () => J, description: () => V, frontMatter: () => M, issueNumber: () => U, metadata: () => i, title: () => E, toc: () => K }));
  ...
  48068(e, n, t) {
   ...
   var u = t(43864),
    ...
    b = t(23436),
    v = t(79532);
   const A = { boxShadow: u.A, color: m.A, cursor: h.A, dimension: p.A, fontFamily: j.A, fontFamilies: j.A, fontSize: f.A, fontSizes: f.A, fontWeight: k.A, fontWeights: k.A, lineHeight: x.A, lineHeights: x.A, number: w.A, other: b.A, textDecoration: v.A },
    y = ({ type: e }) => {
  ...
  48262(e, n, t) {
   ...
   const b = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, u.jsx)(x.n, { children: s.map((t) => (0, u.jsx)(x.K, { className: (0, r.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, f.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(j._, { children: t.tasks.map(({ checked: e, name: t, id: i }) => (0, u.jsx)(j.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, f.qZ)(i) }, i)) }), (0, u.jsx)(i.fz, { children: (0, u.jsxs)(i.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
            ...
            ? (0, u.jsx)(
               d.Z,
               {
                ...
                description: (0, u.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, u.jsxs)(a.f, { children: [(0, u.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(i.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, u.jsxs)('div', {
                   children: [
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)('section', { children: [(0, u.jsxs)(s.DZ, { level: Math.min(n + 2, 6), children: [r, ' in ', e] }), (0, u.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(o.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, u.jsxs)(l.Wu, {
                 children: [
                  ...
                  (h.length > 0 || c.length > 0) && (0, u.jsx)(i.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  h.length > 0 &&
                   (0, u.jsx)(u.Fragment, {
                  ...
                  c.length > 0 && (0, u.jsx)(u.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(i.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, u.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    y = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p.p, { level: n, suffix: s && (0, u.jsx)(h.D, { state: s }), children: e.title }), (0, u.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(s) && (0, u.jsx)(w.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    C = ({ component: e }) => {
     const n = (e && k[e.title]) || [];
   ...
   var g = function (e) {
    ...
    m =
     ...
     (0, o.forwardRef)(function (e, n) {
      ...
      return (0, a.jsxs)('button', c(c({ ref: n, type: b, className: (0, r.$)('nl-button', i, { 'nl-button--pressed': k, 'nl-button--busy': x, 'nl-button--disabled': j || f, 'nl-button--primary': 'primary' === h, 'nl-button--secondary': 'secondary' === h, 'nl-button--subtle': 'subtle' === h, 'nl-button--positive': u(h) && 'positive' === p, 'nl-button--negative': u(h) && 'negative' === p, 'nl-button--icon-only': d }), 'aria-pressed': A ? String(Boolean(k)) : void 0, 'aria-disabled': j || x ? 'true' : void 0, disabled: f }, y), {}, { children: [m && (0, a.jsx)('span', { className: 'nl-button__icon-start', children: m }), v && (0, a.jsx)('span', { className: 'nl-button__label', children: v }), T ? (0, a.jsx)('span', { className: d ? 'nl-button__label' : '', children: t }) : t, g && (0, a.jsx)('span', { className: 'nl-button__icon-end', children: g })] }));
     }));
  ...
  84471(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => u, mJ: () => p, VZ: () => A, cR: () => v, Pv: () => j, qZ: () => r, kD: () => w, QQ: () => C, B2: () => m, Pc: () => l, f4: () => o, GT: () => b, fX: () => a, eQ: () => x, B_: () => k, o_: () => f });
