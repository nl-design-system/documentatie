 ...
 [19078],
 {
  ...
  19078: (r, t, o) => {
   ...
   const c = class {
    ...
    render() {
     const { autocomplete: r, cols: t, disabled: o, invalid: c, placeholder: l, readOnly: u, required: n, rows: d, spellcheck: h, value: i } = this;
     return (0, e.h)(
      'textarea',
      {
       key: 'a8d3de7b999f2821d39fe36f1be38e02ab2f5fbf',
       autoComplete: r || null,
      ...
      (0, e.h)('slot', { key: 'b637306a6910010803832204ab9c2b6ea60765d1' }),
     );
    }
   };
