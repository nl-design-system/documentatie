...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [41102],
 {
  ...
  15214(e, n, i) {
   (i.r(n), i.d(n, { assets: () => _, component: () => M, contentTitle: () => C, default: () => O, description: () => G, frontMatter: () => H, issueNumber: () => P, metadata: () => t, title: () => B, toc: () => E }));
   ...
   const T = [
     ...
     { title: 'De Icon komt niet voor in de normale focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: N.Ay, tags: ['developer'] },
     {
  ...
  21034(e, n, i) {
   ...
   const k = ({ component: e, headingLevel: n }) => {
     const i = e && e.projects.filter((e) => h.f4.includes(e.id)),
      r = i && h.f4.map((e) => i.find((n) => n.id === e)).filter(Boolean);
     return e && (0, d.jsx)(j.n, { children: r.map((i) => (0, d.jsx)(j.K, { className: (0, a.A)('ma-definition-of-done', i && `ma-definition-of-done--${(0, h.fX)(i.title)}`), heading: i ? `${i.title} - ${i.progress.value} van ${i.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m._, { children: i.tasks.map(({ checked: e, name: i, id: t }) => (0, d.jsx)(m.Z, { headingLevel: n + 1, checked: e, heading: i, description: (0, h.qZ)(t) }, t)) }), (0, d.jsx)(t.fz, { children: (0, d.jsxs)(t.N_, { href: `${i.url}?filterQuery=${e.title}`, children: [i.title, ' projectbord op GitHub'] }) })] }) }, i.title)) });
    },
            ...
            o.Zp,
            {
             ...
             children: (0, d.jsxs)(o.Wu, {
              children: [
               ...
               s.length > 0 && (0, d.jsx)(d.Fragment, { children: s.map(({ frameworkName: e, tasks: i }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, d.jsx)(t.dk, { links: i.map((e) => ({ children: e.description, icon: (0, d.jsx)(r.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    f = ({ component: e, headingLevel: n, description: i }) => {
     const a = e && h.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(g.p, { level: n, suffix: a && (0, d.jsx)(u.D, { state: a }), children: e.title }), (0, d.jsx)(t.fz, { lead: !0, children: i }), ['Help Wanted', 'Community'].includes(a) && (0, d.jsx)(v.s, { relayStep: a, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    w = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
  ...
  21530(e, n, i) {
   i.d(n, { AC: () => d, Fu: () => o, Wu: () => s, Zp: () => l });
   var t = i(46447),
    a = i(13526),
    r = i(86070);
   const o = ({ background: e, children: n, className: i, ...t }) => (0, r.jsx)('div', { className: (0, a.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, i), ...t, children: n }),
    s = (e) => (0, r.jsx)('div', { className: 'ma-card__content', ...e }),
    l = ({ href: e, appearance: n, className: i, component: o = 'div', background: s, children: l }) => {
     const d = (e) => ('article' === o ? (0, r.jsx)('article', { ...e }) : 'section' === o ? (0, r.jsx)('section', { ...e }) : (0, r.jsx)('div', { ...e })),
      c = (0, r.jsx)(d, { className: (0, a.A)('ma-cardgroup__card', s && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, i), children: l });
     return e ? (0, r.jsx)(t.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: c }) : c;
    },
    d = ({ appearance: e = 'large', children: n, className: i }) => (0, r.jsx)('div', { className: (0, a.A)('ma-cardgroup', `ma-cardgroup--${e}`, i), children: n });
  },
  27823(e, n, i) {
   i.d(n, { Ay: () => o });
   var t = i(86070),
  ...
  32385(e, n, i) {
   i.d(n, { bo: () => a, KF: () => g, mJ: () => p, VZ: () => z, cR: () => w, Pv: () => j, qZ: () => o, kD: () => x, QQ: () => A, B2: () => m, Pc: () => l, f4: () => s, GT: () => f, fX: () => r, eQ: () => b, B_: () => k, o_: () => v });
      ...
      const t = e.tasks
       ...
       .map(({ name: t, id: a, value: r }) => {
        const o = /^(.+) URL/.exec(t)[1],
         s = 'Storybook' === o ? `${i} (${n}) in Storybook van ${e.title}` : `${i} (${n}) op ${o}`;
        return { brand: o.toLowerCase(), name: t, id: a, value: r, description: s };
       });
  ...
  39569(e, n, i) {
   ...
   const s = ({ state: e }) => {
    const n = (0, r.fX)(e);
    return (0, o.jsx)(t.KE, { className: (0, a.A)('ma-estafette-badge', n && `ma-estafette-badge--${n}`), children: e });
   };
  },
  40889(e, n, i) {
   i.d(n, { r: () => u });
   ...
   const c = { figma: (0, d.jsx)(a.A, {}), github: (0, d.jsx)(r.A, {}), npm: (0, d.jsx)(o.A, {}), storybook: (0, d.jsx)(s.A, {}) },
    u = ({ brand: e }) => (0, d.jsx)(t.In, { children: c[e] || (0, d.jsx)(l.A, {}) });
  },
  42628(e, n, i) {
   i.d(n, { Ay: () => o });
   var t = i(86070),
  ...
  70348(e, n, i) {
   ...
   const s = ({ className: e, ...n }) => {
     const i = (0, t.A)('ma-utrecht-accordion', 'utrecht-accordion', e);
     return (0, o.jsx)('div', { className: i, children: n.children });
    },
    l = ({ className: e, classNamePanel: n, label: i, heading: s, headingLevel: l, headingApperance: d, ...c }) => {
     const u = (0, t.A)('utrecht-accordion__section', e),
      g = (0, t.A)('utrecht-accordion__panel', n);
     return (0, o.jsxs)('details', { className: u, ...c, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(a.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [s && (0, o.jsx)(r.D, { level: l, appearance: d, children: s }), i] })] }) }), (0, o.jsx)('div', { className: g, children: c.children })] });
    };
  },
  70561(e, n, i) {
   i.d(n, { Ay: () => s, RM: () => r });
  ...
  85162(e, n, i) {
   ...
   const s = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    l = ({ name: e, relayStep: n, description: i }) => {
     const l = (0, r.fX)(n),
      d = s[e] ?? e;
     return (0, o.jsxs)(t.WK, { children: [(0, o.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, a.A)('ma-component-illustration', `ma-component-illustration--${l}`), fill: 'none', children: [(0, o.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, o.jsx)('rect', { width: '960', height: '540' }), (0, o.jsx)('rect', { width: '960', height: '540' })] }), (0, o.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, o.jsx)('use', { href: `/svg/componenten_overzicht_${(0, r.fX)(d)}.svg#component-illustration` })] }), (0, o.jsx)(t.$P, { className: 'ma-component-illustration__caption', children: i })] });
    };
  },
  88805(e, n, i) {
   i.d(n, { Ay: () => o });
