 ...
 [20858],
 {
  74821: (e, t, n) => {
   ...
   const s = { title: 'Text input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text input group', pagination_label: 'Text input group', description: ' ', slug: '/text-input-group' },
    a = void 0,
    u = { id: 'componenten/text-input-group/index', title: 'Text input group', description: ' ', source: '@site/docs/componenten/text-input-group/index.mdx', sourceDirName: 'componenten/text-input-group', slug: '/text-input-group', permalink: '/text-input-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/text-input-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Text input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text input group', pagination_label: 'Text input group', description: ' ', slug: '/text-input-group' }, sidebar: 'componenten', previous: { title: 'Text input', permalink: '/text-input' }, next: { title: 'Textarea', permalink: '/textarea' } },
    l = {},
    d = [
