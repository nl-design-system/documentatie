 ...
 [91698],
 {
  ...
  70348(e, n, a) {
   ...
   var l = a(13526),
    ...
    r = a(37168),
    i = a(86070);
   const s = (0, o.forwardRef)(({ as: e, className: n, children: a, ...o }, t) => {
     const r = e || 'div',
      s = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, i.jsx)(r, { ref: t, className: s, ...o, children: a });
    }),
    d = ({ className: e, classNamePanel: n, label: a, heading: o, headingLevel: s, headingApperance: d, ...c }) => {
     const g = (0, l.A)('utrecht-accordion__section', e),
      h = (0, l.A)('utrecht-accordion__panel', n);
     return (0, i.jsxs)('details', { className: g, ...c, children: [(0, i.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, i.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, i.jsx)('span', { className: 'nl-button__icon-start', children: (0, i.jsx)(t.A, {}) }), (0, i.jsxs)('span', { className: 'nl-button__label', children: [o && (0, i.jsx)(r.D, { level: s, appearance: d, children: o }), a] })] }) }), (0, i.jsx)('div', { className: h, children: c.children })] });
    };
  },
  80731(e, n, a) {
   a.d(n, { H: () => x });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: a }) => {
       const l = 'function' == typeof e ? e() : e,
        ...
        r = b().highlight(o, b().languages[n], n);
       return (0, p.jsxs)('div', { className: (0, t.A)('ma-canvas-astro', a), children: [(0, p.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }), (0, p.jsx)(m.n, { children: (0, p.jsx)(m.K, { label: 'Code', children: (0, p.jsx)('pre', { className: 'language-html nl-code-block', children: (0, p.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
