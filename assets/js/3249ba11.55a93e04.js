 ...
 [25640],
 {
  ...
  70348(e, n, l) {
   ...
   var a = l(13526),
    ...
    o = l(37168),
    i = l(86070);
   const r = (0, t.forwardRef)(({ as: e, className: n, children: l, ...t }, s) => {
     const o = e || 'div',
      r = (0, a.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, i.jsx)(o, { ref: s, className: r, ...t, children: l });
    }),
    c = ({ className: e, classNamePanel: n, label: l, heading: t, headingLevel: r, headingApperance: c, ...d }) => {
     ...
     return (0, i.jsxs)('details', { className: g, ...d, children: [(0, i.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, i.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, i.jsx)('span', { className: 'nl-button__icon-start', children: (0, i.jsx)(s.A, {}) }), (0, i.jsxs)('span', { className: 'nl-button__label', children: [t && (0, i.jsx)(o.D, { level: r, appearance: c, children: t }), l] })] }) }), (0, i.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => y });
   var a = l(15175),
    ...
    b = l(89974),
    v = l(86070);
   const f = ({ children: e }) => (0, v.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, v.jsx)(t.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, v.jsx)(t.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   ...
   const y = globalThis.isAstro
    ...
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: p = !0, children: u, container: m = 'document', language: b, designTokens: y }) => {
       ...
       (0, g.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: b, plugins: [o.A, i.Ay, r.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         z(e);
        })();
       }, [N]);
       const S = (0, g.useId)();
       ...
       return (
        ...
        (0, v.jsxs)('div', {
         ...
         children: [
          x && (0, v.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, v.jsx)(D, { children: (0, v.jsx)(t.v$, { children: x }) }) }) }),
          p &&
           (0, v.jsx)('div', {
