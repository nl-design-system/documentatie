...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [59939],
 {
  ...
  43599: (e, n, t) => {
   ...
   const h = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(s.Tg, { className: 'nlds-canvas__example-surface', children: (0, p.jsx)(s.BB, { className: (0, r.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, p.jsx)(s.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   h.displayName = 'ParagraphContainer';
   const g = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(s.Tg, { className: 'nlds-canvas__example-surface', children: (0, p.jsx)(s.BB, { className: (0, r.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const j = (e) => {
    ...
    let L = k.Fragment;
    return (
     'paragraph' === x ? (L = h) : 'document' === x ? (L = g) : 'surface' === x && (L = m),
     (0, p.jsxs)('div', {
      className: (0, r.Z)('nlds-canvas'),
      children: [
       _ && (0, p.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(L, { children: (0, p.jsx)(s.pu, { children: _ }) }) }) }),
       v &&
        (0, p.jsx)('div', {
  ...
  41179: (e, n, t) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: t, textContent: d, trim: c } = e,
     k = d;
    const { title: u, type: p } = (0, r.useContext)(l.n),
     h = (0, r.useId)();
    return (
     c && (k = k.trim()),
     (0, i.jsx)(s.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, i.jsx)(o.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': h, style: t, children: s.map((e, t) => (0, i.jsxs)('span', { ...r({ line: e }), children: [n && (0, i.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...l({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
