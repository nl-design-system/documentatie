 ...
 [81710],
 {
  34119: (e, n, i) => {
   ...
   const c = { title: 'WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.5 Grootte van het aanwijsgebied (uitgebreid)', pagination_label: 'WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)', description: 'Maak het aanwijsgebied van buttons, links en formuliervelden groot genoeg, zodat het makkelijker is om deze te selecteren.', slug: '2.5.5', keywords: ['WCAG', 'Niveau AAA', 'Target Size (Enhanced)'] },
    g = void 0,
    u = { id: 'wcag/2.5.05', title: 'WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)', description: 'Maak het aanwijsgebied van buttons, links en formuliervelden groot genoeg, zodat het makkelijker is om deze te selecteren.', source: '@site/docs/wcag/2.5.05.mdx', sourceDirName: 'wcag', slug: '/wcag/2.5.5', permalink: '/wcag/2.5.5', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.5.05.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.5 Grootte van het aanwijsgebied (uitgebreid)', pagination_label: 'WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)', description: 'Maak het aanwijsgebied van buttons, links en formuliervelden groot genoeg, zodat het makkelijker is om deze te selecteren.', slug: '2.5.5', keywords: ['WCAG', 'Niveau AAA', 'Target Size (Enhanced)'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.5.4 Bewegingsactivering', permalink: '/wcag/2.5.4' }, next: { title: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', permalink: '/wcag/2.5.7' } },
    h = {},
    p = [
