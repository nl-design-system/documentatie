...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [43800],
 {
  ...
  26461: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => U, contentTitle: () => C, default: () => P, frontMatter: () => F, metadata: () => S, toc: () => X });
   var t = i(52676),
    r = i(24785),
    l = i(3510),
    o = i(66771),
  ...
  66771: (e, n, i) => {
   ...
   const g = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(t.Tg, { className: u['nlds-canvas__example-surface'], children: (0, h.jsx)(t.BB, { className: (0, r.Z)('utrecht-document--surface', u['nlds-canvas__example-document']), children: (0, h.jsx)(t.nv, { className: u['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   g.displayName = 'ParagraphContainer';
   const v = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(t.Tg, { className: u['nlds-canvas__example-surface'], children: (0, h.jsx)(t.BB, { className: (0, r.Z)('utrecht-document--surface', u['nlds-canvas__example-document']), children: n }) });
   };
   v.displayName = 'DocumentContainer';
   const j = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(t.Tg, { className: u['nlds-canvas__example-surface'], children: n });
   };
   j.displayName = 'SurfaceContainer';
   const x = (e) => {
    let { code: n, copy: i = !0, defaultExpandedCode: x = !1, displayCode: f = !0, children: b, container: _ = 'document', language: k, designTokens: y } = e,
    ...
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       w && (0, h.jsx)('div', { className: (0, r.Z)(u['nlds-canvas__example']), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, h.jsx)(X, { children: (0, h.jsx)(t.pu, { children: w }) }) }) }),
       f &&
        (0, h.jsx)('div', {
   ...
   function a(e) {
    ...
    return (
     ...
     (0, o.jsx)(r.y$, {
      ...
      language: i || '',
      children: (e) => {
       let { style: i, tokens: r, getLineProps: l, getTokenProps: a } = e;
       return (0, o.jsx)(t.dn, { style: i, children: r.map((e, i) => (0, o.jsxs)('span', { ...l({ line: e }), children: [n && (0, o.jsx)('span', { children: i + 1 }), e.map((e, n) => (0, o.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, i)) });
      },
     })
    );
   }
  ...
  81014: (e, n, i) => {
   ...
   var s = i(52676);
   const c = (e) => {
    let { title: n, appearance: i, description: c, children: d, figure: m } = e;
    const u = 'Doen',
     p = 'Niet doen',
     h = m ? 'figure' : 'div',
     g = m ? 'figcaption' : 'div';
    return (0, s.jsxs)(h, { className: (0, o.Z)(a['nlds-guideline'], a[`nlds-guideline--${i}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, s.jsxs)(g, { className: (0, o.Z)(a['nlds-guideline__description']), children: ['dont' === i ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(l.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${i}`]), children: [(0, s.jsx)(t.Z, { className: a['nlds-guideline__icon'] }), (0, s.jsx)('span', { className: a['nlds-guideline__title'], children: p })] }), (0, s.jsx)(l.nv, { children: n })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(l.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${i}`]), children: [(0, s.jsx)(r.Z, { className: a['nlds-guideline__icon'] }), (0, s.jsx)('span', { className: a['nlds-guideline__title'], children: u })] }), (0, s.jsx)(l.nv, { children: n })] }), c] }), (0, s.jsx)('div', { className: (0, o.Z)(a['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, i) => {
   i.d(n, { Z: () => a, a: () => o });
