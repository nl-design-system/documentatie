    ...
    return (
     ...
     (0, r.jsx)(a.y$, {
      ...
      children: (e) => {
       ...
       return (0, r.jsx)(s.dn, { tabIndex: 0, style: n, children: a.map((e, n) => (0, r.jsxs)('span', { ...o({ line: e }), children: [l && (0, r.jsx)('span', { children: n + 1 }), e.map((e, l) => (0, r.jsx)('span', { ...t({ token: e }) }, l)), '\n'] }, n)) });
      },
     })
    );
   }
  ...
  91050: (e, l, n) => {
   ...
   const c = (e) => {
    ...
    const p = 'Doen',
     ...
     m = u ? 'figure' : 'div',
     v = u ? 'figcaption' : 'div';
    return (0, i.jsxs)(m, { className: (0, r.Z)(t['nlds-guideline'], t[`nlds-guideline--${n}`]), id: 'string' == typeof l ? l?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(v, { className: (0, r.Z)(t['nlds-guideline__description']), children: ['dont' === n ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(o.nv, { className: (0, r.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${n}`]), children: [(0, i.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: t['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: t['nlds-guideline__title'], children: h })] }), (0, i.jsx)(o.nv, { children: l })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(o.nv, { className: (0, r.Z)(t['nlds-guideline__badge'], t[`nlds-guideline__badge--${n}`]), children: [(0, i.jsx)(a.Z, { 'aria-hidden': 'true', role: 'presentation', className: t['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: t['nlds-guideline__title'], children: p })] }), (0, i.jsx)(o.nv, { children: l })] }), c] }), (0, i.jsx)('div', { className: (0, r.Z)(t['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, l, n) => {
   n.d(l, { Z: () => t, a: () => r });
