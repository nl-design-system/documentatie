/*! For license information please see 2e11687d.d9d49865.js.LICENSE.txt */
 ...
 [42112],
 {
   ...
   function X(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      '\n',
      (0, d.jsx)(O.U, { omitH1: !0, headingLevel: 3, children: (0, d.jsx)(L, {}) }),
      '\n',
      ...
      (0, d.jsx)(R.W, {
       items: [
        ...
        { title: 'Als een tekst in de Data Badge in een andere taal is dan de taal van de pagina, dan heeft de Data Badge een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: (0, d.jsx)(D.ZP, {}), tags: ['contentmaker', 'developer'] },
       ],
      }),
      '\n',
          ...
          (0, l.jsx)(s.k, {
           ...
           children: g.map((e, t) => {
            ...
            if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
             const s = i.fg.get(e);
             n = (0, l.jsx)(r.r, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${s.sc} ${s.nl.title}`, style: { lineHeight: 1 }, children: (0, l.jsx)(o.O, { children: `WCAG ${e}` }) }, t);
            }
            return n;
           }),
          }),
          ...
          children: Array.from(a.values()).map((e, t) =>
           (0, l.jsx)(
            s.zx,
            {
             onClick: () =>
              ((e, t) => {
               const s = ('boolean' == typeof t ? t : !i(e)) ? [...n, e] : n.filter((t) => t !== e);
               r(s);
              })(e),
             pressed: i(e),
             appearance: 'subtle',
  ...
  49556: (e, t, n) => {
   ...
   var p = n(6076),
    ...
    k = n(49003),
    x = n(75271);
   const A = { color: p.Z, dimension: j.Z, fontFamilies: y.Z, fontSizes: v.Z, fontWeights: f.Z, lineHeights: w.Z, other: b.Z, textDecoration: k.Z },
    C = (e) => {
     let { type: t } = e;
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => j, BA: () => a, Ee: () => d, Q6: () => s, U: () => g, Yr: () => y, d: () => h, e9: () => o, fO: () => f, mA: () => i, ps: () => m, qU: () => w, s0: () => v, zP: () => p });
