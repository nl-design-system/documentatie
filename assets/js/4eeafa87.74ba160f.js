...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [44344],
 {
  ...
  21034(e, n, t) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u.p, { level: n, suffix: i && (0, d.jsx)(g.D, { state: i }), children: e.title }), (0, d.jsx)(a.fz, { lead: !0, children: t })] });
    },
    k = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
  ...
  35419(e, n, t) {
   (t.r(n), t.d(n, { assets: () => L, component: () => R, componentName: () => T, contentTitle: () => S, default: () => I, description: () => z, frontMatter: () => F, issueNumber: () => _, metadata: () => a, relayStep: () => C, title: () => H, toc: () => B }));
   ...
   const A = [
     ...
     { title: 'Instructies in de Note zijn op een inclusieve manier beschreven.', sc: '1.3.3', status: '', component: k.Ay, tags: ['designer', 'contentmaker'] },
     { title: 'De kleur van de Note geeft geen informatie die niet ook op minimaal 1 andere manier wordt gegeven.', sc: '1.4.1', status: '', component: w.Ay, tags: ['designer'] },
     { title: 'De tekst in de Note heeft een contrastratio van minimaal 4,5:1 met de achtergrondkleur.', sc: '1.4.3', status: '', component: j.Ay, tags: ['designer'] },
     { title: 'Als je de tekst van de Note vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: x.Ay, tags: ['developer'] },
     { title: 'De bezoeker kan de Note tot 400% vergroten zonder verlies van functionaliteit of informatie.', sc: '1.4.10', status: '', component: h.Ay, tags: ['developer', 'designer'] },
     { title: 'De Note is niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: f.Ay, tags: ['developer'] },
    ...
    y = [
     { title: 'Tekst in de Note blijft leesbaar wanneer de tekstafstand vergroot wordt.', sc: '1.4.12', status: '', component: p.Ay, tags: ['developer'] },
     { title: 'De Note is standaard niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: N.Ay, tags: ['developer'] },
     { title: 'De Note komt standaard niet voor in de normale focusvolgorde op de pagina', sc: '2.4.3', status: '', component: D.Ay, tags: ['developer'] },
    ],
    F = { title: 'Note', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Note', pagination_label: 'Note', description: 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.', issue_number: 409, slug: '/note', keywords: ['spotlight', 'callout'] },
    S = void 0,
    L = {},
    H = 'Note',
    z = 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.',
    _ = 409,
    C = 'help wanted',
    T = 'note',
    R = o.find((e) => e.number === _),
