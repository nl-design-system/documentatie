 ...
 [8238],
 {
   ...
   const d = (0, a.createContext)({}),
    u = ({ title: e, appearance: n, description: l, children: a, figure: u }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      p = u ? 'figure' : 'div',
      m = u ? 'figcaption' : 'div',
      g = 'string' == typeof l ? (0, i.jsx)(c.oz, { components: { a: t.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   const c = ({ className: e, ...n }) => {
    ...
    a = ({ className: e, classNamePanel: n, label: l, heading: c, headingLevel: a, headingApperance: i, ...d }) => {
     const u = (0, o.A)('utrecht-accordion__section', e),
      h = (0, o.A)('utrecht-accordion__panel', n);
     return (0, r.jsxs)('details', { className: u, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(s.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [c && (0, r.jsx)(t.D, { level: a, appearance: i, children: c }), l] })] }) }), (0, r.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => x });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       ...
       return (0, b.jsxs)('div', { className: (0, t.A)('ma-canvas-astro', l), children: [(0, b.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: s } }), (0, b.jsx)(g.n, { children: (0, b.jsx)(g.K, { label: 'Code', children: (0, b.jsx)('pre', { className: 'language-html nl-code-block', children: (0, b.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
         ...
         children: [
          ...
          p &&
           (0, b.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, b.jsx)(o.M, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: z, trim: !0 }),
             n &&
              (0, b.jsx)('div', {
