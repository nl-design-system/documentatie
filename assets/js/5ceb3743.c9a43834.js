 ...
 [16387],
 {
  ...
  58639(e, n, l) {
   ...
   var o = l(69284),
    ...
    m = l(31186),
    p = l(86070);
   const h = ({ children: e }) => (0, p.jsx)(i.ui, { className: 'nlds-canvas__example-surface', children: (0, p.jsx)(i.yo, { className: (0, t.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, p.jsx)(i.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   h.displayName = 'ParagraphContainer';
   const g = ({ children: e }) => (0, p.jsx)(i.ui, { className: 'nlds-canvas__example-surface', children: (0, p.jsx)(i.yo, { className: (0, t.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   g.displayName = 'DocumentContainer';
   const j = ({ children: e }) => (0, p.jsx)(i.ui, { className: 'nlds-canvas__example-surface', children: e });
   j.displayName = 'SurfaceContainer';
   const v = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: v = !0, children: y, container: f = 'document', language: b, designTokens: x }) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(w, { parser: b, plugins: [r.A, s.Ay, a.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      A(e);
     })();
    }, [w]);
    const C = (0, u.useId)();
    let R = u.Fragment;
    return (
     'paragraph' === f ? (R = h) : 'document' === f ? (R = g) : 'surface' === f && (R = j),
     (0, p.jsxs)('div', {
      className: (0, t.A)('nlds-canvas'),
      children: [
       k && (0, p.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, p.jsx)(R, { children: (0, p.jsx)(i.v$, { children: k }) }) }) }),
       v &&
        (0, p.jsx)('div', {
       ...
       v &&
        (0, p.jsxs)('div', {
         ...
         hidden: !z,
         children: [
          (0, p.jsx)(o.M, { codeBlockLabel: 'Codevoorbeeld', syntax: b, textContent: N, trim: !0 }),
          n &&
           (0, p.jsx)('div', {
  ...
  67837(e, n, l) {
   (l.r(n), l.d(n, { assets: () => v, contentTitle: () => j, default: () => b, frontMatter: () => g, metadata: () => o, toc: () => y }));
   ...
   function c(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, i.jsx)(a.$, { appearance: 'do', title: 'Leg uit waarom een datum wordt afgekeurd.', children: (0, i.jsx)(s.H, { language: 'html', children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('label', { htmlFor: 'passport-validity', children: 'Geldig tot' }), (0, i.jsx)('p', { id: 'description-passport-validity', children: 'Invoerfout: De geldigheidsdatum van uw paspoort moet in de toekomst liggen.' }), (0, i.jsx)('input', { id: 'passport-validity', type: 'text', name: 'passport-validity', 'aria-describedby': 'description-passport-validity' })] }) }) }), '\n', (0, i.jsx)(a.$, { appearance: 'do', title: 'Geef een voorbeeld van wat er verwacht wordt.', children: (0, i.jsx)(s.H, { language: 'html', children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('label', { htmlFor: 'email', children: 'E-mail' }), (0, i.jsx)('p', { id: 'description-email', children: 'Invoerfout: Vul een geldig e-mailadres in, bijvoorbeeld naam@voorbeeld.nl.' }), (0, i.jsx)('input', { id: 'email', type: 'email', name: 'email', 'aria-describedby': 'description-email' })] }) }) }), '\n', (0, i.jsx)(a.$, { appearance: 'dont', title: 'Alleen beschrijven dat het veld verplicht is, zonder toelichting dat er informatie mist of aan welke voorwaarde niet is voldaan.', children: (0, i.jsx)(s.H, { language: 'html', children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('label', { htmlFor: 'passport-validity-2', children: 'Geldig tot' }), (0, i.jsx)('p', { id: 'description-passport-validity-2', children: 'Invoerfout: Dit veld is verplicht.' }), (0, i.jsx)('input', { id: 'passport-validity-2', 'aria-invalid': 'false', type: 'text', name: 'passport-validity-2', 'aria-describedby': 'description-passport-validity-2' })] }) }) })] });
   }
   function d(e = {}) {
   ...
   const g = { title: 'Schrijf een duidelijke foutmelding \xb7 Foutmeldingen in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Duidelijke foutmeldingen', pagination_label: 'Duidelijke foutmeldingen', description: 'Richtlijnen voor duidelijke foutmeldingen in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/duidelijk', keywords: ['labels', 'formulier', 'design', 'code'] },
    j = void 0,
    v = {},
  ...
  69284(e, n, l) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: l, trim: c }) {
    let d = l;
    const { title: u, type: m } = (0, t.useContext)(r.x),
     p = (0, t.useId)();
    return (c && (d = d.trim()), (0, a.jsx)(i.f4, { theme: s, code: d, language: n || '', children: ({ style: n, tokens: l, getLineProps: i, getTokenProps: t }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, a.jsx)(o.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': p, style: n, children: l.map((n, l) => (0, a.jsxs)('span', { ...i({ line: n }), children: [e && (0, a.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, a.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  78734(e, n, l) {
   l.d(n, { Ay: () => s, RM: () => t });
