(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [42119],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => g, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => i, kD: () => b, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => s, eQ: () => k, B_: () => v, o_: () => p, Rc: () => x });
   ...
   const h = (e) => [...e].sort((e, t) => u.indexOf(e) - u.indexOf(t)),
    ...
    g = (e) => h(l(e.projects.flatMap((e) => y(e)))),
    m = (e) => {
     const t = y(e),
      n = ((e) => {
  ...
  88907(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => u, default: () => p, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => h, toc: () => g }));
   ...
   var c = n(86070),
    ...
    i = n(78742),
    o = n(99630);
   const a = { title: 'Strong', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Strong', pagination_label: 'Strong', description: 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.', slug: '/strong', keywords: ['bold', 'bold emphasis', 'bold text', 'dikgedrukt', 'emphasized text', 'important', 'strong', 'vetgedrukt'] },
    u = void 0,
    l = {},
    h = 'Strong',
    d = 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.',
    j = 138,
  ...
  99630(e, t, n) {
   ...
   const p = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, a.jsx)(r.If, { sections: s.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, m.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(y, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, a.jsx)(g, { headingLevel: t + 1, checked: e, title: n, description: (0, m.qZ)(r) }, r)) }), (0, a.jsx)(r.fz, { children: (0, a.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
