 ...
 [15403],
 {
  ...
  68963: (e, t, n) => {
   ...
   const s = (e) => {
     ...
     return (0, c.jsx)('div', { className: (0, i.Z)(o.card__illustration, t && o['card__illustration--background'], r), ...s, children: n });
    },
    a = (e) => (0, c.jsx)('div', { className: (0, i.Z)(o.card__content), ...e }),
    l = (e) => {
     let { href: t, appearance: n, className: s, component: a = 'div', children: l } = e;
     const u = (e) => ('article' === a ? (0, c.jsx)('article', { ...e }) : 'section' === a ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      d = (0, c.jsx)(u, { className: (0, i.Z)(o.cardgroup__card, o[`cardgroup__card--${n}`], s), children: l });
     return t ? (0, c.jsx)(r.rU, { href: t, boxContent: !0, className: o.cardgroup__link, children: d }) : d;
    },
    u = (e) => {
     let { appearance: t = 'medium', children: n, className: r } = e;
     return (0, c.jsx)('div', { className: (0, i.Z)(o.cardgroup, o[`cardgroup--${t}`], r), children: n });
    };
  },
  23952: (e, t, n) => {
   'use strict';
   n.d(t, { cN: () => D, vM: () => T, W: () => S, Rv: () => M });
   var r = n(56150),
    i = n(4814),
    o = (n(75271), n(39854)),
    c = n(7522),
   ...
   const k = 'task-list_hh8j',
    ...
    F = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(_), children: [(0, u.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.X6, { appearance: 'utrecht-heading-3', level: c, children: r }), o, n] })] });
    };
   var z = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const o = t && t.projects.filter((e) => z.e9.includes(e.id)),
      c = o && z.e9.map((e) => o.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, u.jsx)(A, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(F, { checked: t, title: n, description: (0, z.Q6)(r) }, r);
            }),
           }),
    ...
    M = (e) => {
     ...
     const o = t && z.$3[t.relayStep];
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(f.V, { level: n, suffix: o && (0, u.jsx)(p.y, { state: o }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, t, n) => {
   'use strict';
   ...
   const a = (e) => {
    let { state: t } = e;
    const n = (0, c.mA)(t);
    return (0, s.jsx)(r.Ou, { className: (0, i.Z)(o['estafette-badge'], n && o[`estafette-badge--${n}`]), children: t });
   };
  },
  72657: (e, t, n) => {
   'use strict';
   ...
   var o = n(52676);
   const c = (e) => {
    let { children: t, className: n, level: c = 1, suffix: s, ...a } = e;
    return (0, o.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${c}`, n), ...a, children: [(0, o.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: t }), s && (0, o.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [s ? ' ' : '', s] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => s, Q6: () => o, e9: () => c, mA: () => i });
