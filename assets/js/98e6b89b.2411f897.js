 ...
 [35649],
 {
  95470: (e, t, n) => {
   ...
   const s = { title: 'Dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Dialog', pagination_label: 'Dialog', description: 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina blijft mogelijk.', slug: '/dialog', keywords: ['dialog', 'dialoogvenster', 'floating window', 'modal', 'non modal dialog', 'non modal window', 'overlay', 'popup', 'venster', 'window'] },
    a = void 0,
    l = { id: 'componenten/dialog/index', title: 'Dialog', description: 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina blijft mogelijk.', source: '@site/docs/componenten/dialog/index.mdx', sourceDirName: 'componenten/dialog', slug: '/dialog', permalink: '/dialog', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/dialog/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Dialog', pagination_label: 'Dialog', description: 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina blijft mogelijk.', slug: '/dialog', keywords: ['dialog', 'dialoogvenster', 'floating window', 'modal', 'non modal dialog', 'non modal window', 'overlay', 'popup', 'venster', 'window'] }, sidebar: 'componenten', previous: { title: 'Description List', permalink: '/description-list' }, next: { title: 'Dot Badge', permalink: '/dot-badge' } },
    u = {},
    h = [
  ...
  35038: (e, t, n) => {
   ...
   const o = (e) => {
     ...
     return (0, c.jsx)('div', { className: (0, i.Z)('card__illustration', t && `card__illustration--${t}`, r), ...o, children: n });
    },
    s = (e) => (0, c.jsx)('div', { className: 'card__content', ...e }),
    a = (e) => {
     let { href: t, appearance: n, className: o, component: s = 'div', background: a, children: l } = e;
     const u = (e) => ('article' === s ? (0, c.jsx)('article', { ...e }) : 'section' === s ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      h = (0, c.jsx)(u, { className: (0, i.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, o), children: l });
  ...
  8657: (e, t, n) => {
   ...
   const w = (e) => {
     ...
     return (
      ...
      (0, u.jsx)(r.a2, {
       sections: o.map((e) => ({
        className: (0, i.Z)('definition-of-done', e && `definition-of-done--${(0, x.mA)(s(e))}`),
        headingLevel: n,
        expanded: !1,
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => m, BA: () => s, Ee: () => u, Q6: () => c, U: () => j, Yr: () => p, d: () => h, e9: () => o, fO: () => b, mA: () => i, ps: () => y, qU: () => k, s0: () => v, zP: () => g });
