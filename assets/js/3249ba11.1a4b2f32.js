 ...
 [25640],
 {
  ...
  80731(e, n, l) {
   ...
   var a = l(15175),
    ...
    m = l(70348),
    b = l(86070);
   const v = ({ children: e }) => (0, b.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(t.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, b.jsx)(t.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   v.displayName = 'ParagraphContainer';
   const f = ({ children: e }) => (0, b.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(t.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   f.displayName = 'DocumentContainer';
   const j = ({ children: e }) => (0, b.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: e });
   ...
   const k = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const a = 'function' == typeof e ? e() : e,
        ...
        o = u().highlight(t, u().languages[n], n);
       return (0, b.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', l), children: [(0, b.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: t } }), (0, b.jsx)(m.n, { children: (0, b.jsx)(m.K, { label: 'Code', children: (0, b.jsx)('pre', { className: 'language-html nl-code-block', children: (0, b.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: p = !0, children: u, container: m = 'document', language: k, designTokens: y }) => {
       ...
       (0, g.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: k, plugins: [o.A, i.Ay, r.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [N]);
       const C = (0, g.useId)();
       let D = g.Fragment;
       return (
        'paragraph' === m ? (D = v) : 'document' === m ? (D = f) : 'surface' === m && (D = j),
        (0, b.jsxs)('div', {
         className: (0, s.A)('nlds-canvas'),
         children: [
          x && (0, b.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, b.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, b.jsx)(D, { children: (0, b.jsx)(t.v$, { children: x }) }) }) }),
          p &&
           (0, b.jsx)('div', {
          ...
          p &&
           (0, b.jsxs)('div', {
            ...
            hidden: !z,
            children: [
             (0, b.jsx)(a.M, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: w, trim: !0 }),
             n &&
              (0, b.jsx)('div', {
