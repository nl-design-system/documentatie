...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [33527],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => h, mJ: () => u, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => a, kD: () => b, B2: () => p, Pc: () => l, f4: () => o, GT: () => _, fX: () => r, eQ: () => x, B_: () => v, o_: () => j, Rc: () => k });
  ...
  67970(e, n, t) {
   ...
   const o = ({ state: e }) => {
    const n = (0, r.fX)(e);
    return (0, a.jsx)(s.KE, { className: (0, i.A)('estafette-badge', n && `estafette-badge--${n}`), children: e });
   };
  },
  72642(e, n, t) {
   t.d(n, { p: () => r });
            ...
            a.Zp,
            {
             ...
             children: (0, d.jsxs)(a.Wu, {
              children: [
               ...
               o.length > 0 && (0, d.jsx)(d.Fragment, { children: o.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(s.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, d.jsx)(s.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(r.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  83754(e, n, t) {
   ...
   const d = { title: 'Video', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Video', pagination_label: 'Video', description: 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.', slug: '/video' },
    ...
    m = {},
    h = 'Video',
    p = 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.',
    g = 69,
    u = 'help wanted',
    f = 'video',
  ...
  90495(e, n, t) {
   ...
   var s = t(46447),
    i = t(13526),
    r = t(86070);
   const a = ({ background: e, children: n, className: t, ...s }) => (0, r.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, t), ...s, children: n }),
