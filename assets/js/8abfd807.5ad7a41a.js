 ...
 [17713],
 {
  ...
  43599: (e, n, o) => {
   ...
   const f = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (F = await d.ZP.format(N, { parser: y, plugins: [s.Z, a.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(F);
     })();
    }, [N]);
    const S = (0, u.useId)();
    let P = u.Fragment;
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       _ && (0, h.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, h.jsx)(P, { children: (0, h.jsx)(t.pu, { children: _ }) }) }) }),
       g &&
        (0, h.jsx)('div', {
       ...
       g &&
        (0, h.jsxs)('div', {
         ...
         hidden: !Z,
         children: [
          (0, h.jsx)(l.u, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: F, trim: !0 }),
          o &&
           (0, h.jsx)('div', {
