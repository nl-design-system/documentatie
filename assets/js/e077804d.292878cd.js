...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [47050],
 {
  10674(e, n, i) {
   ...
   const r = JSON.parse('{"id":"richtlijnen/formulieren/error/index","title":"Foutmeldingen in een formulier","description":"Als een veld niet goed is ingevuld, moet voor iedereen duidelijk zijn wat er niet klopt. Hoe help je de gebruiker het beste als die onjuiste of onvolledige informatie invult?","source":"@site/docs/richtlijnen/formulieren/error/index.mdx","sourceDirName":"richtlijnen/formulieren/error","slug":"/richtlijnen/formulieren/foutmeldingen/","permalink":"/richtlijnen/formulieren/foutmeldingen/","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/error/index.mdx","tags":[],"version":"current","sidebarPosition":5,"frontMatter":{"title":"Foutmeldingen in een formulier","title_sm":"Foutmeldingen","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Introductie foutmeldingen","sidebar_position":5,"navigation_order":5,"pagination_label":"Foutmeldingen","description":"Als een veld niet goed is ingevuld, moet voor iedereen duidelijk zijn wat er niet klopt. Hoe help je de gebruiker het beste als die onjuiste of onvolledige informatie invult?","slug":"/richtlijnen/formulieren/foutmeldingen/","keywords":["informatie","formulier","design","code"]},"sidebar":"richtlijnen","previous":{"title":"Lengte description","permalink":"/richtlijnen/formulieren/descriptions/lengte"},"next":{"title":"Foutmeldingen","permalink":"/richtlijnen/formulieren/foutmeldingen/"}}');
   var t = i(86070),
    o = i(18439),
    l = i(78734),
    d = i(23606);
   const s = { title: 'Foutmeldingen in een formulier', title_sm: 'Foutmeldingen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Introductie foutmeldingen', sidebar_position: 5, navigation_order: 5, pagination_label: 'Foutmeldingen', description: 'Als een veld niet goed is ingevuld, moet voor iedereen duidelijk zijn wat er niet klopt. Hoe help je de gebruiker het beste als die onjuiste of onvolledige informatie invult?', slug: '/richtlijnen/formulieren/foutmeldingen/', keywords: ['informatie', 'formulier', 'design', 'code'] },
    u = 'Richtlijnen NL Design System voor foutmeldingen in een formulier',
    c = {},
    a = [{ value: 'Overzicht richtlijnen', id: 'overzicht-richtlijnen', level: 2 }, { value: 'Deze documentatie heeft nu een eigen pagina', id: 'deze-documentatie-heeft-nu-een-eigen-pagina', level: 2 }, ...l.RM];
   function h(e) {
