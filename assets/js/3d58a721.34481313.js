...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [710],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => p, mJ: () => h, VZ: () => D, cR: () => w, Pv: () => f, qZ: () => o, kD: () => b, B2: () => m, Pc: () => l, f4: () => s, GT: () => k, fX: () => a, eQ: () => x, B_: () => j, o_: () => v, Rc: () => _ });
  ...
  37131(e, n, t) {
   ...
   const h = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    ...
    x = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.p, { level: n, suffix: i && (0, d.jsx)(u.D, { state: i }), children: e.title }), (0, d.jsx)(r.fz, { lead: !0, children: t })] });
    },
    b = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  54319(e, n, t) {
   (t.r(n), t.d(n, { assets: () => u, component: () => v, componentName: () => f, contentTitle: () => c, default: () => b, description: () => m, frontMatter: () => d, issueNumber: () => g, metadata: () => r, relayStep: () => h, title: () => p, toc: () => j }));
