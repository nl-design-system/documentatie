 ...
 [60574],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    l = n(86070);
   const u = { figma: (0, l.jsx)(i.A, {}), github: (0, l.jsx)(c.A, {}), npm: (0, l.jsx)(o.A, {}), storybook: (0, l.jsx)(s.A, {}) },
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => g, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => o, kD: () => b, B2: () => j, Pc: () => a, f4: () => s, GT: () => f, fX: () => c, eQ: () => k, B_: () => v, o_: () => p, Rc: () => x });
   ...
   const h = (e) => [...e].sort((e, t) => l.indexOf(e) - l.indexOf(t)),
    ...
    g = (e) => h(u(e.projects.flatMap((e) => y(e)))),
    m = (e) => {
     const t = y(e),
      n = ((e) => {
      ...
      const r = e.tasks
       ...
       .map(({ name: r, id: i, value: c }) => {
        const o = /^(.+) URL/.exec(r)[1],
         s = 'Storybook' === o ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${o}`;
        return { brand: o.toLowerCase(), name: r, id: i, value: c, description: s };
       });
  ...
  72642(e, t, n) {
   ...
   var r = n(13526),
    i = n(86070);
   const c = ({ children: e, className: t, level: n = 1, suffix: c, ...o }) => (0, i.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, t), ...o, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), c && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [c ? ' ' : '', c] })] });
  },
  90495(e, t, n) {
   'use strict';
   n.d(t, { AC: () => l, Fu: () => o, Wu: () => s, Zp: () => a });
   var r = n(46447),
    i = n(13526),
    c = n(86070);
   const o = ({ background: e, children: t, className: n, ...r }) => (0, c.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    s = (e) => (0, c.jsx)('div', { className: 'card__content', ...e }),
    a = ({ href: e, appearance: t, className: n, component: o = 'div', background: s, children: a }) => {
     const l = (e) => ('article' === o ? (0, c.jsx)('article', { ...e }) : 'section' === o ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      u = (0, c.jsx)(l, { className: (0, i.A)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
  ...
  99630(e, t, n) {
   ...
   const y = ({ children: e }) => (0, a.jsx)('ul', { className: 'task-list', children: e }),
    g = ({ checked: e, children: t, title: n, description: r, headingLevel: c = 3 }) => (0, a.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, a.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, a.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, a.jsx)(j.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, a.jsxs)('div', { children: [n ? (0, a.jsx)(d.DZ, { appearance: 'utrecht-heading-3', level: c, children: n }) : null, r, t] })] });
   var m = n(33062);
         ...
         children: n
          ...
          .map((e) => {
           const n = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            h = e.tasks.filter(({ name: e, value: t }) => u.has(e) && URL.canParse(t) && 'https:' === new URL(t).protocol);
           return (0, a.jsx)(
            o.Zp,
            {
             ...
             children: (0, a.jsxs)(o.Wu, {
              children: [
               ...
               (h.length > 0 || s.length > 0) && (0, a.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, a.jsx)(a.Fragment, {
               ...
               s.length > 0 && (0, a.jsx)(a.Fragment, { children: s.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(c.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
