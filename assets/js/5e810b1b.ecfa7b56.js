...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  76823: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => p, contentTitle: () => m, default: () => v, frontMatter: () => u, metadata: () => g, toc: () => j });
   var t = i(52676),
    r = i(40139),
    s = i(57716),
    o = i(46364),
    ...
    a = i(91114),
    h = i(97183);
   const u = { title: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.11 Focus niet bedekt (minimum)', pagination_label: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', description: 'Zorg ervoor dat een element dat de toetsenbordfocus heeft zichtbaar is en niet volledig bedekt is door andere inhoud.', slug: '2.4.11', keywords: ['WCAG', 'AA', 'bedienbaar', 'navigeerbaar', 'operable', 'navigable', 'focus not obscured (minimum)'] },
    m = void 0,
    g = { id: 'wcag/2.4.11', title: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', description: 'Zorg ervoor dat een element dat de toetsenbordfocus heeft zichtbaar is en niet volledig bedekt is door andere inhoud.', source: '@site/docs/wcag/2.4.11.mdx', sourceDirName: 'wcag', slug: '/wcag/2.4.11', permalink: '/wcag/2.4.11', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.11.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.11 Focus niet bedekt (minimum)', pagination_label: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', description: 'Zorg ervoor dat een element dat de toetsenbordfocus heeft zichtbaar is en niet volledig bedekt is door andere inhoud.', slug: '2.4.11', keywords: ['WCAG', 'AA', 'bedienbaar', 'navigeerbaar', 'operable', 'navigable', 'focus not obscured (minimum)'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.4.10 Paragraafkoppen', permalink: '/wcag/2.4.10' }, next: { title: 'WCAG-succescriterium 2.4.12 Focus niet bedekt (uitgebreid)', permalink: '/wcag/2.4.12' } },
    p = {},
    j = [
  ...
  57716: (e, n, i) => {
   ...
   const o = (e, n) => {
    ...
    a = (e) => {
     ...
     return (0, s.jsx)(t.Z, { components: { ...d(i, r), ...l(o), ...c }, children: n });
    };
  },
  46364: (e, n, i) => {
   i.d(n, { j: () => o });
