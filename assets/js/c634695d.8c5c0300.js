...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [96233],
 {
  ...
  36564: (e, n, o) => {
   o.r(n), o.d(n, { assets: () => v, contentTitle: () => m, default: () => b, frontMatter: () => u, metadata: () => h, toc: () => g });
   var t = o(52676),
    r = o(87118),
    l = o(49824);
   function i(e) {
  ...
  43599: (e, n, o) => {
   ...
   const j = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await c.ZP.format(z, { parser: f, plugins: [i.Z, a.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [z]);
    const S = (0, p.useId)();
    ...
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       w && (0, m.jsx)('div', { className: (0, l.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, m.jsx)(E, { children: (0, m.jsx)(r.pu, { children: w }) }) }) }),
       b &&
        (0, m.jsx)('div', {
  ...
  41179: (e, n, o) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: o, textContent: d, trim: c } = e,
     p = d;
    const { title: u, type: m } = (0, l.useContext)(i.n),
     h = (0, l.useId)();
    return (
     c && (p = p.trim()),
     (0, s.jsx)(r.y$, {
      ...
      language: o || '',
      children: (e) => {
       let { style: o, tokens: r, getLineProps: l, getTokenProps: i } = e;
       return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, s.jsx)(t.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': h, style: o, children: r.map((e, o) => (0, s.jsxs)('span', { ...l({ line: e }), children: [n && (0, s.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, o)) })] });
      },
     })
    );
   }
   ...
   const d = (0, a.createContext)({}),
    c = (e) => {
     ...
     const u = { do: 'Doen', dont: 'Niet doen' },
      m = p ? 'figure' : 'div',
      h = p ? 'figcaption' : 'div';
     return (0, s.jsxs)(m, { className: (0, i.Z)('nlds-guideline', `nlds-guideline--${o}`), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, s.jsxs)(h, { className: 'nlds-guideline__description', children: ['dont' === o ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(l.nv, { className: (0, i.Z)('nlds-guideline__badge', `nlds-guideline__badge--${o}`), children: [(0, s.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: u.dont })] }), (0, s.jsx)(l.nv, { children: n })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(l.nv, { className: (0, i.Z)('nlds-guideline__badge', `nlds-guideline__badge--${o}`), children: [(0, s.jsx)(r.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: u.do })] }), (0, s.jsx)(l.nv, { children: n })] }), a] }), (0, s.jsx)('div', { className: 'nlds-guideline__example', children: (0, s.jsx)(d.Provider, { value: { title: n, type: u[o] }, children: c }) })] });
    };
  },
  87118: (e, n, o) => {
   o.d(n, { Z: () => a, a: () => i });
   ...
   function a(e) {
    let n;
    return (n = e.disableParentContext ? ('function' == typeof e.components ? e.components(r) : e.components || r) : i(e.components)), t.createElement(l.Provider, { value: n }, e.children);
   }
  },
 },
]);
