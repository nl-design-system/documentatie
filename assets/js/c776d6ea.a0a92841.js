(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [85],
 {
  72208: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => x, component: () => A, contentTitle: () => k, default: () => C, description: () => Z, frontMatter: () => b, issueNumber: () => N, metadata: () => f, title: () => w, toc: () => _ });
   var r,
    c,
    i,
    s,
  ...
  30449: (e, t, n) => {
   ...
   const a = (e) => {
    ...
    const { title: l } = t,
     h = (0, s.mA)(l),
     d = i.lazy(() => n(22930)(`./${h}-docs/docs/anatomy/anatomy.md`).catch(() => ({ default: () => null })));
    return (0, o.jsx)(i.Suspense, { fallback: null, children: (0, o.jsxs)('figure', { className: (0, c.Z)('component-anatomy'), children: [a && (0, o.jsx)(a, { height: null, className: (0, c.Z)('component-anatomy__illustration') }), a && d && (0, o.jsx)('figcaption', { children: (0, o.jsx)(r.U, { omitH1: !0, headingLevel: 1, children: (0, o.jsx)(d, {}) }) })] }) });
   };
  },
  8657: (e, t, n) => {
   'use strict';
   ...
   const _ = (e) => {
    ...
    N = (e) => {
     ...
     return t && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(g.V, { level: n, suffix: i && (0, h.jsx)(v.y, { state: i }), children: t.title }), (0, h.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  57716: (e, t, n) => {
   ...
   const s = (e, t) => {
    ...
    h = (e) => {
     let { children: t, omitH1: n = !1, headingLevel: c = 1, baseUrl: s = '' } = e;
     return (0, i.jsx)(r.Z, { components: { ...l(n, c), ...a(s) }, children: t });
    };
  },
  14669: (e, t, n) => {
   'use strict';
