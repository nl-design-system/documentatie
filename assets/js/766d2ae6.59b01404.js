...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [28360],
 {
  ...
  65738: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => p, contentTitle: () => v, default: () => _, frontMatter: () => m, metadata: () => g, toc: () => h });
   var o = l(52676),
    t = l(24785),
    s = l(98480),
    r = l(91050);
  ...
  98480: (e, n, l) => {
   ...
   const _ = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: _ = !1, displayCode: f = !0, children: y, container: j = 'document', language: x, designTokens: k } = e,
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (C = await d.ZP.format(Z, { parser: x, plugins: [s.Z, r.ZP, i.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), S(C);
     })();
    }, [Z]);
    const D = (0, c.useId)();
    let F = c.Fragment;
    return (
     'paragraph' === j ? (F = p) : 'document' === j ? (F = h) : 'surface' === j && (F = b),
     (0, g.jsxs)('div', {
      ...
      children: [
       ...
       f &&
        (0, g.jsxs)('div', {
         ...
         hidden: !z,
         children: [
          (0, g.jsx)(v.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: C, trim: !0 }),
          l &&
           (0, g.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: l, textContent: d, trim: c } = e,
     u = d;
    const { title: m, type: v } = (0, s.useContext)(r.n),
     g = (0, s.useId)();
    return (
     c && (u = u.trim()),
     (0, a.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: g, children: ['codevoorbeeld ', v ? `\u201c${v}\u201d` : '', ' ', m ? ': ' : ' ', m] }), (0, a.jsx)(o.dn, { tabIndex: 0, role: m ? 'region' : void 0, 'aria-labelledby': g, style: l, children: t.map((e, l) => (0, a.jsxs)('span', { ...s({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (0, i.createContext)({}),
    u = (e) => {
     let { title: n, appearance: l, description: i, children: u, figure: m } = e;
     const v = { do: 'Doen', dont: 'Niet doen' },
      g = m ? 'figure' : 'div',
      p = m ? 'figcaption' : 'div';
     return (0, d.jsxs)(g, { className: (0, r.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(p, { className: (0, r.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(s.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, d.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: v.dont })] }), (0, d.jsx)(s.nv, { children: n })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(s.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, d.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: v.do })] }), (0, d.jsx)(s.nv, { children: n })] }), i] }), (0, d.jsx)('div', { className: (0, r.Z)(a['nlds-guideline__example']), children: (0, d.jsx)(c.Provider, { value: { title: n, type: v[l] }, children: u }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => i, a: () => r });
