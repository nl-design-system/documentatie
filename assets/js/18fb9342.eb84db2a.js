 ...
 [1754],
 {
   ...
   const d = (0, c.createContext)({}),
    p = ({ title: e, appearance: n, description: s, children: c, figure: p }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      m = p ? 'figure' : 'div',
      h = p ? 'figcaption' : 'div',
      g = 'string' == typeof s ? (0, i.jsx)(a.oz, { components: { a: o.N_ }, children: s }) : s;
  ...
  70348(e, n, s) {
   ...
   var t = s(13526),
    ...
    r = s(37168),
    a = s(86070);
   const c = (0, l.forwardRef)(({ as: e, className: n, children: s, ...l }, o) => {
     const r = e || 'div',
      c = (0, t.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(r, { ref: o, className: c, ...l, children: s });
    }),
    i = ({ className: e, classNamePanel: n, label: s, heading: l, headingLevel: c, headingApperance: i, ...d }) => {
     const p = (0, t.A)('utrecht-accordion__section', e),
      u = (0, t.A)('utrecht-accordion__panel', n);
     return (0, a.jsxs)('details', { className: p, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(o.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [l && (0, a.jsx)(r.D, { level: c, appearance: i, children: l }), s] })] }) }), (0, a.jsx)('div', { className: u, children: d.children })] });
    };
  },
  78248(e, n, s) {
  ...
  80731(e, n, s) {
   ...
   const j = globalThis.isAstro
    ? ({ children: e, language: n, className: s }) => {
       const t = 'function' == typeof e ? e() : e,
        ...
        r = h().highlight(l, h().languages[n], n);
       return (0, v.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', s), children: [(0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: l } }), (0, v.jsx)(g.n, { children: (0, v.jsx)(g.K, { label: 'Code', children: (0, v.jsx)('pre', { className: 'language-html nl-code-block', children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
