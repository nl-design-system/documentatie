 ...
 [82479],
 {
  15175(e, n, t) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: t, trim: c }) {
    ...
    const { title: u, type: h } = (0, r.useContext)(s.x),
     m = (0, r.useId)();
    return (c && (d = d.trim()), (0, i.jsx)(o.f4, { theme: a, code: d, language: n || '', children: ({ style: n, tokens: t, getLineProps: o, getTokenProps: r }) => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, i.jsx)(l.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': m, style: n, children: t.map((n, t) => (0, i.jsxs)('span', { ...o({ line: n }), children: [e && (0, i.jsx)('span', { children: t + 1 }), n.map((e, n) => (0, i.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, t)) })] }) }));
   }
  },
  18439(e, n, t) {
   t.d(n, { R: () => s, x: () => a });
   ...
   const d = (0, i.createContext)({}),
    u = ({ title: e, appearance: n, description: t, children: i, figure: u }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      m = u ? 'figure' : 'div',
      p = u ? 'figcaption' : 'div',
      b = 'string' == typeof t ? (0, c.jsx)(a.oz, { components: { a: r.N_ }, children: t }) : t;
  ...
  70348(e, n, t) {
   ...
   var l = t(13526),
    ...
    s = t(37168),
    a = t(86070);
   const i = (0, o.forwardRef)(({ as: e, className: n, children: t, ...o }, r) => {
     const s = e || 'div',
      i = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(s, { ref: r, className: i, ...o, children: t });
    }),
    c = ({ className: e, classNamePanel: n, label: t, heading: o, headingLevel: i, headingApperance: c, ...d }) => {
     const u = (0, l.A)('utrecht-accordion__section', e),
      h = (0, l.A)('utrecht-accordion__panel', n);
     return (0, a.jsxs)('details', { className: u, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(r.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [o && (0, a.jsx)(s.D, { level: i, appearance: c, children: o }), t] })] }) }), (0, a.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => y });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       ...
       return (0, x.jsxs)('div', { className: (0, r.A)('ma-canvas-astro', t), children: [(0, x.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }), (0, x.jsx)(b.n, { children: (0, x.jsx)(b.K, { label: 'Code', children: (0, x.jsx)('pre', { className: 'language-html nl-code-block', children: (0, x.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
