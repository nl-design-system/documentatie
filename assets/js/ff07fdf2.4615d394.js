...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [33710],
 {
               ...
               d.Z,
               {
                ...
                description: (0, u.jsxs)('div', {
                 ...
                 children: [
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)('section', { children: [(0, u.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [o, ' in ', e] }), (0, u.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(a.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, u.jsxs)(l.Wu, {
                 children: [
                  ...
                  c.length > 0 && (0, u.jsx)(u.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(i.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, u.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(a.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
  ...
  32385(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => h, VZ: () => k, cR: () => A, Pv: () => j, qZ: () => o, kD: () => v, QQ: () => C, B2: () => m, Pc: () => l, f4: () => a, GT: () => x, fX: () => s, eQ: () => b, B_: () => w, o_: () => f });
   ...
   var g = function (e) {
    ...
    m =
     ...
     (0, a.forwardRef)(function (e, n) {
      ...
      return (0, s.jsxs)('button', c(c({ ref: n, type: x, className: (0, o.$)('nl-button', i, { 'nl-button--pressed': w, 'nl-button--busy': b, 'nl-button--disabled': j || f, 'nl-button--primary': 'primary' === p, 'nl-button--secondary': 'secondary' === p, 'nl-button--subtle': 'subtle' === p, 'nl-button--positive': u(p) && 'positive' === h, 'nl-button--negative': u(p) && 'negative' === h, 'nl-button--icon-only': d }), 'aria-pressed': k ? String(Boolean(w)) : void 0, 'aria-disabled': j || b ? 'true' : void 0, disabled: f }, y), {}, { children: [m && (0, s.jsx)('span', { className: 'nl-button__icon-start', children: m }), A && (0, s.jsx)('span', { className: 'nl-button__label', children: A }), T ? (0, s.jsx)('span', { className: d ? 'nl-button__label' : '', children: t }) : t, g && (0, s.jsx)('span', { className: 'nl-button__icon-end', children: g })] }));
     }));
  ...
  65082(e, n, t) {
   ...
   const k = [
    ...
    y = [
     ...
     { title: 'Als je de tekst van de Unordered List vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: f.Ay, tags: ['developer'] },
