...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [33527],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => h, mJ: () => u, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => a, kD: () => b, B2: () => g, Pc: () => l, f4: () => o, GT: () => _, fX: () => s, eQ: () => v, B_: () => x, o_: () => j, Rc: () => k });
  ...
  37131(e, n, t) {
   ...
   const u = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(h.p, { level: n, suffix: i && (0, d.jsx)(m.D, { state: i }), children: e.title }), (0, d.jsx)(r.fz, { lead: !0, children: t })] });
    },
    b = ({ component: e }) => {
     const n = (e && u[e.title]) || [];
  ...
  83754(e, n, t) {
   (t.r(n), t.d(n, { assets: () => m, component: () => j, componentName: () => f, contentTitle: () => c, default: () => b, description: () => g, frontMatter: () => d, issueNumber: () => p, metadata: () => r, relayStep: () => u, title: () => h, toc: () => x }));
   ...
   const d = { title: 'Video', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Video', pagination_label: 'Video', description: 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.', slug: '/video' },
    ...
    m = {},
    h = 'Video',
    g = 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.',
    p = 69,
    u = 'help wanted',
    f = 'video',
