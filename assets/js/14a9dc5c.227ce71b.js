   ...
   const v = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const t = 'function' == typeof e ? e() : e,
        ...
        a = p().highlight(r, p().languages[n], n);
       return (0, x.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', l), children: [(0, x.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }), (0, x.jsx)(u.n, { children: (0, x.jsx)(u.K, { label: 'Code', children: (0, x.jsx)('pre', { className: 'language-html nl-code-block', children: (0, x.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: a } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: m = !0, children: p, container: u = 'document', language: v, designTokens: y }) => {
