 ...
 [94957],
 {
  3227(e, t, n) {
   ...
   function p({ className: e }) {
    const t = (0, i.$S)();
    return (0, c.jsx)(k, { items: t.items, className: e });
   }
   function k(e) {
    const { items: t, className: n } = e;
    if (!t) return (0, c.jsx)(p, { ...e });
    const r = (0, i.d1)(t);
    return (0, c.jsx)('section', { className: (0, a.A)('row', n), ...e, children: r.map((e, t) => (0, c.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, c.jsx)(h, { item: e }) }, t)) });
   }
  },
  18439(e, t, n) {
   n.d(t, { R: () => o, x: () => a });
  ...
  45282(e, t, n) {
   ...
   const s = ({ children: e, ...t }) => {
    ...
    o = ({ className: e, ...t }) => (0, r.jsx)(s, { className: (0, i.$)('utrecht-link', 'utrecht-link--html-a', e), ...t });
  },
  60316(e, t, n) {
   n.d(t, { $S: () => i, d1: () => r });
   n(74147);
