 ...
 [45900],
 {
  1292(e, n, t) {
   ...
   var i = t(29181),
    ...
    d = t(83386),
    l = t(86070);
   const c = { figma: (0, l.jsx)(r.A, {}), github: (0, l.jsx)(o.A, {}), npm: (0, l.jsx)(s.A, {}), storybook: (0, l.jsx)(a.A, {}) },
    h = ({ brand: e }) => (0, l.jsx)(i.In, { children: c[e] || (0, l.jsx)(d.A, {}) });
  },
  12013(e, n, t) {
   'use strict';
   t.d(n, { o: () => c });
   ...
   const s = (e, n) => {
    ...
    d = (e) => ({ img: ({ src: n, ...t }) => (0, o.jsx)('img', { ...t, src: s(e, n), className: 'utrecht-img utrecht-img--fit' }) }),
    l = (e, n) => {
     if (e) {
      const e = { ...a[n - 1] };
      return ((e.h1 = () => null), e);
    ...
    c = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: r = '', components: s = {} }) => (0, o.jsx)(i.x, { components: { ...l(n, t), ...d(r), ...s }, children: e });
  },
  17045(e, n, t) {
   'use strict';
   t.d(n, { Ay: () => a, RM: () => o });
  ...
  17889(e, n, t) {
    ...
    return 'clipboard' in navigator
     ? (0, p.jsxs)(s.$n, {
        ...
        onClick: async function () {
         try {
          const e = await c.Ay.format(n, { parser: t, plugins: [a.A, d.Ay, l.Ay] });
   ...
   var m = t(35193),
    ...
    w = t(79532),
    y = t(30758);
   const z = { color: m.A, dimension: g.A, fontFamilies: b.A, fontSizes: x.A, fontWeights: k.A, lineHeights: v.A, other: f.A, textDecoration: w.A },
    A = ({ type: e }) => (0, p.jsx)(u.In, { children: (0, y.createElement)(z[e]) });
   function D({ tokens: e }) {
    const n = (0, o.kD)(e),
     t = (0, o.GT)(n),
     a = t.map((e) => (0, o.B_)(e) + ': ;').join('\n'),
     d = JSON.stringify((0, o.Rc)(t));
       ...
       children: [
        ...
        (0, p.jsx)(s.BF, {
         children: t.map((n) => {
          const t = (0, o.o_)(n),
           a = (0, o.eQ)(e, n).$type;
          return (0, p.jsxs)(s.Hj, { children: [(0, p.jsx)(s.nA, { children: (0, p.jsx)(i.C, { children: (0, p.jsx)(s.kf, { children: t }) }) }), (0, p.jsx)(s.nA, { children: (0, p.jsxs)(r.K, { children: [(0, p.jsx)(A, { type: a }), ' ', a] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, p.jsxs)(s.e2, { children: [(0, p.jsx)(j, { content: d, language: 'json', children: 'Kopieer als JSON' }), (0, p.jsx)(j, { content: a, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => r, KF: () => u, mJ: () => m, VZ: () => z, cR: () => y, Pv: () => g, qZ: () => s, kD: () => v, B2: () => p, Pc: () => d, f4: () => a, GT: () => f, fX: () => o, eQ: () => k, B_: () => x, o_: () => b, Rc: () => w });
  ...
  37500(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => W, component: () => q, contentTitle: () => J, default: () => te, description: () => Q, frontMatter: () => I, issueNumber: () => Y, metadata: () => i, title: () => K, toc: () => ee }));
  ...
  72401(e, n, t) {
   ...
   const a = ({ component: e }) => {
    ...
    return (0, s.jsx)(r.Suspense, { fallback: null, children: (0, s.jsx)(i.o, { omitH1: !0, headingLevel: 1, children: (0, s.jsx)(d, {}) }) });
   };
  },
  72642(e, n, t) {
   'use strict';
            ...
            s.Zp,
            {
             ...
             children: (0, l.jsxs)(s.Wu, {
              children: [
               ...
               (h.length > 0 || a.length > 0) && (0, l.jsx)(i.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, l.jsx)(l.Fragment, {
               ...
               a.length > 0 && (0, l.jsx)(l.Fragment, { children: a.map(({ frameworkName: e, tasks: t }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(i.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, l.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, l.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
   ...
   const s = ({ background: e, children: n, className: t, ...i }) => (0, o.jsx)('div', { className: (0, r.A)('card__illustration', e && `card__illustration--${e}`, t), ...i, children: n }),
    ...
    d = ({ href: e, appearance: n, className: t, component: s = 'div', background: a, children: d }) => {
     const l = (e) => ('article' === s ? (0, o.jsx)('article', { ...e }) : 'section' === s ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      c = (0, o.jsx)(l, { className: (0, r.A)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: d });
