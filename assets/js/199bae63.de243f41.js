  ...
  21004: (e, n, i) => {
   ...
   const o = (e, n) => e.reduce((e, i) => ('link' === i.type ? (n.includes(i.docId) ? e : [...e, i]) : 'category' === i.type ? [...e, { ...i, items: o(i.items, n) }] : e), []),
    c = (e) => {
     ...
     const a = (0, t.jA)();
     return (0, s.jsx)('div', { ...c, className: (0, r.Z)('margin-top--lg', i), children: (0, s.jsx)(l.Z, { items: o(a.items, n) }) });
    };
  },
  39772: (e, n, i) => {
   i.d(n, { Z: () => u });
   var t = i(13894),
    ...
    o = i(52676);
   function c(e) {
    let { href: n, icon: i = '', title: t, description: l, children: c } = e;
    return (0, o.jsxs)('div', { className: 'card', children: [n ? (0, o.jsx)(r.Z, { href: n, className: (0, s.Z)('cardLink', 'utrecht-link'), children: (0, o.jsxs)('h2', { className: 'cardTitle', children: [i, ' ', t] }) }) : (0, o.jsxs)('h2', { className: 'cardTitle', children: [i, ' ', t] }), l && (0, o.jsx)('p', { className: 'cardDescription', children: l }), c] });
   }
   function a(e) {
    let { item: n } = e;
   ...
   function u(e) {
    ...
    const r = (0, t.MN)(n);
    return (0, o.jsx)('section', { className: (0, s.Z)('row', i), children: r.map((e, n) => (0, o.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, o.jsx)(h, { item: e }) }, n)) });
   }
  },
  87118: (e, n, i) => {
   i.d(n, { Z: () => o, a: () => s });
