 ...
 [20940],
 {
  86951: (e, n, i) => {
   ...
   const l = { title: 'WCAG-succescriterium 4.1.1 Parsen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '4.1.1 Parsen', pagination_label: 'WCAG-succescriterium 4.1.1 Parsen', description: 'Zorg dat er geen fouten in de HTML-code zijn.', slug: '4.1.1', keywords: ['WCAG'] },
    ...
    d = { id: 'wcag/4.1.1', title: 'WCAG-succescriterium 4.1.1 Parsen', description: 'Zorg dat er geen fouten in de HTML-code zijn.', source: '@site/docs/wcag/4.1.1.mdx', sourceDirName: 'wcag', slug: '/wcag/4.1.1', permalink: '/wcag/4.1.1', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/4.1.1.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 4.1.1 Parsen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '4.1.1 Parsen', pagination_label: 'WCAG-succescriterium 4.1.1 Parsen', description: 'Zorg dat er geen fouten in de HTML-code zijn.', slug: '4.1.1', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.3.4 Foutpreventie (wettelijk, financieel, gegevens)', permalink: '/wcag/3.3.4' }, next: { title: 'WCAG-succescriterium 4.1.2 Naam, rol, waarde', permalink: '/wcag/4.1.2' } },
    c = {},
    h = [
