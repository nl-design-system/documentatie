 ...
 [36200],
 {
  62495: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(99890),
    s = n(8657);
   const o = { title: 'Strong', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Strong', pagination_label: 'Strong', description: 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.', slug: '/strong', keywords: ['bold', 'bold emphasis', 'bold text', 'dikgedrukt', 'emphasized text', 'important', 'strong', 'vetgedrukt'] },
    a = void 0,
    u = { id: 'componenten/strong/index', title: 'Strong', description: 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.', source: '@site/docs/componenten/strong/index.mdx', sourceDirName: 'componenten/strong', slug: '/strong', permalink: '/strong', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/strong/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Strong', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Strong', pagination_label: 'Strong', description: 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.', slug: '/strong', keywords: ['bold', 'bold emphasis', 'bold text', 'dikgedrukt', 'emphasized text', 'important', 'strong', 'vetgedrukt'] }, sidebar: 'componenten', previous: { title: 'Status Badge', permalink: '/status-badge' }, next: { title: 'Subscript', permalink: '/subscript' } },
    l = {},
    h = [
  ...
  8657: (e, t, n) => {
   ...
   const w = (e) => {
    ...
    A = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p.V, { level: n, suffix: i && (0, l.jsx)(m.y, { state: i }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => m, BA: () => o, Ee: () => l, Q6: () => i, U: () => j, Yr: () => p, d: () => h, e9: () => s, fO: () => b, mA: () => c, ps: () => y, qU: () => k, s0: () => v, zP: () => g });
