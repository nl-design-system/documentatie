 ...
 [65844],
 {
  15175(e, n, t) {
   ...
   function i({ lineNumber: e, syntax: n, textContent: t, trim: i }) {
    ...
    const { title: p, type: h } = (0, o.useContext)(s.x),
     u = (0, o.useId)();
    return (i && (d = d.trim()), (0, c.jsx)(l.f4, { theme: r, code: d, language: n || '', children: ({ style: n, tokens: t, getLineProps: l, getTokenProps: o }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: u, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, c.jsx)(a.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': u, style: n, children: t.map((n, t) => (0, c.jsxs)('span', { ...l({ line: n }), children: [e && (0, c.jsx)('span', { children: t + 1 }), n.map((e, n) => (0, c.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, t)) })] }) }));
   }
  },
  18439(e, n, t) {
   t.d(n, { R: () => s, x: () => r });
   ...
   function r(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(l) : e.components || l) : s(e.components)), a.createElement(o.Provider, { value: n }, e.children));
   }
  },
  49539(e, n, t) {
   t.d(n, { Ay: () => r, RM: () => o });
   ...
   const d = (0, c.createContext)({}),
    p = ({ title: e, appearance: n, description: t, children: c, figure: p }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      u = p ? 'figure' : 'div',
      m = p ? 'figcaption' : 'div',
      b = 'string' == typeof t ? (0, i.jsx)(r.oz, { components: { a: o.N_ }, children: t }) : t;
  ...
  70348(e, n, t) {
   ...
   var a = t(13526),
    ...
    s = t(37168),
    r = t(86070);
   const c = (0, l.forwardRef)(({ as: e, className: n, children: t, ...l }, o) => {
     const s = e || 'div',
      c = (0, a.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, r.jsx)(s, { ref: o, className: c, ...l, children: t });
    }),
    i = ({ className: e, classNamePanel: n, label: t, heading: l, headingLevel: c, headingApperance: i, ...d }) => {
     const p = (0, a.A)('utrecht-accordion__section', e),
      h = (0, a.A)('utrecht-accordion__panel', n);
     return (0, r.jsxs)('details', { className: p, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(o.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [l && (0, r.jsx)(s.D, { level: c, appearance: i, children: l }), t] })] }) }), (0, r.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => y });
   var a = t(15175),
    ...
    b = t(70348),
    g = t(86070);
   const j = ({ children: e }) => (0, g.jsx)(l.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(l.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(l.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   j.displayName = 'ParagraphContainer';
   const k = ({ children: e }) => (0, g.jsx)(l.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(l.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   k.displayName = 'DocumentContainer';
   const v = ({ children: e }) => (0, g.jsx)(l.ui, { className: 'nlds-canvas__example-surface', children: e });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const a = 'function' == typeof e ? e() : e,
        ...
        s = m().highlight(l, m().languages[n], n);
       return (0, g.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', t), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: l } }), (0, g.jsx)(b.n, { children: (0, g.jsx)(b.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: u = !0, children: m, container: b = 'document', language: y, designTokens: x }) => {
       ...
       let K = p.Fragment;
       return (
        'paragraph' === b ? (K = j) : 'document' === b ? (K = k) : 'surface' === b && (K = v),
        (0, g.jsxs)('div', {
         className: (0, o.A)('nlds-canvas'),
         children: [
          f && (0, g.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, g.jsx)(K, { children: (0, g.jsx)(l.v$, { children: f }) }) }) }),
          u &&
           (0, g.jsx)('div', {
          ...
          u &&
           (0, g.jsxs)('div', {
            ...
            hidden: !z,
            children: [
             (0, g.jsx)(a.M, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: w, trim: !0 }),
             n &&
              (0, g.jsx)('div', {
