...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [41323, 63047],
 {
  20680: (e, t, n) => {
   ...
   (e.exports = i), (i.displayName = "liquid"), (i.aliases = []);
  },
  47305: (e) => {
   function t(e) {
    !(function (e) {
       ...
       value: function (n, a, i, o) {
        if (n.language === a) {
         ...
         (n.code = n.code.replace(i, function (e) {
          ...
          for (var i, s = r.length; -1 !== n.code.indexOf((i = t(a, s))); ) ++s;
          return (r[s] = e), i;
         })),
           ...
           if ("string" == typeof c || (c.content && "string" == typeof c.content)) {
            ...
            if (m > -1) {
             ...
             var f = d.substring(0, m),
              ...
              b = [];
             f && b.push.apply(b, r([f])), b.push(_), k && b.push.apply(b, r([k])), "string" == typeof c ? s.splice.apply(s, [l, 1].concat(b)) : (c.content = b);
            }
           } else c.content && r(c.content);
          }
          return s;
         })(n.tokens);
        }
