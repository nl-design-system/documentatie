 ...
 [58441],
 {
  38065: (e, t, n) => {
   ...
   const s = { title: 'Avatar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Avatar', pagination_label: 'Avatar', description: 'Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.', slug: '/avatar', keywords: ['afbeelding', 'avatar', 'foto', 'gebruiker', 'gravatar', 'icon', 'identiteit', 'identity', 'illustratie', 'illustration', 'image', 'initial', 'initialen', 'logo', 'organisation', 'organization', 'photo', 'picture', 'profielafbeelding', 'profile image', 'user'] },
    a = void 0,
    l = { id: 'componenten/avatar/index', title: 'Avatar', description: 'Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.', source: '@site/docs/componenten/avatar/index.mdx', sourceDirName: 'componenten/avatar', slug: '/avatar', permalink: '/avatar', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/avatar/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Avatar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Avatar', pagination_label: 'Avatar', description: 'Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.', slug: '/avatar', keywords: ['afbeelding', 'avatar', 'foto', 'gebruiker', 'gravatar', 'icon', 'identiteit', 'identity', 'illustratie', 'illustration', 'image', 'initial', 'initialen', 'logo', 'organisation', 'organization', 'photo', 'picture', 'profielafbeelding', 'profile image', 'user'] }, sidebar: 'componenten', previous: { title: 'Alert Dialog', permalink: '/alert-dialog' }, next: { title: 'Blockquote', permalink: '/blockquote' } },
    u = {},
    d = [
