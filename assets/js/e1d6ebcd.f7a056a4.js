/*! For license information please see e1d6ebcd.f7a056a4.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [55407],
 {
  ...
  18652(e, n, t) {
   ...
   const s = (e, n, t, s) => {
    const r = (0, i.forwardRef)(({ color: t = 'currentColor', size: r = 24, stroke: o = 2, title: l, className: d, children: c, ...m }, u) => (0, i.createElement)('svg', { ref: u, ...a[e], width: r, height: r, className: ['tabler-icon', `tabler-icon-${n}`, d].join(' '), ...('filled' === e ? { fill: t } : { strokeWidth: o, stroke: t }), ...m }, [l && (0, i.createElement)('title', { key: 'svg-title' }, l), ...s.map(([e, n]) => (0, i.createElement)(e, n)), ...(Array.isArray(c) ? c : [c])]));
   ...
   const o = a.forwardRef(function (e, n) {
    const [t, o] = a.useState(!1),
     ...
     w = b
      ...
      : null,
     x = a.useMemo(() => e.thumbnail || w || `https://i.ytimg.com/${f}/${e.playlist ? m : c}/${h}.${k}`, [e.thumbnail, w, f, e.playlist, m, c, h, k]),
     ...
     T = a.useCallback(e.onIframeAdded || function () {}, [e.onIframeAdded]),
    ...
    return (
     ...
     (0, i.jsxs)(i.Fragment, {
      children: [
       !e.lazyLoad && (0, i.jsx)('link', { rel: O, href: x, as: 'image' }),
       (0, i.jsx)(i.Fragment, { children: t && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('link', { rel: 'preconnect', href: v }), (0, i.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), C && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, i.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
       e.seo && !e.playlist && (0, i.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: r(e.id, u, x, v, e.seo) } }),
       L && !e.playlist && (0, i.jsx)('noscript', { children: (0, i.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${u} on YouTube`, children: ['Watch "', u, '" on YouTube'] }) }),
       (0, i.jsxs)(_, {
        onPointerOver: () => {
         t || o(!0);
        },
        ...
        children: [e.lazyLoad && !l && (0, i.jsx)('img', { src: x, alt: `${u} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !l && (0, i.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && l) && (0, i.jsx)('button', { type: 'button', className: N, 'aria-label': `${p} ${u}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, onClick: P, children: (0, i.jsx)('span', { className: 'lty-visually-hidden', children: p }) }), l && (0, i.jsx)('iframe', { ref: n, className: z, title: u, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: y, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  24456(e, n, t) {
   ...
   const r = ({ children: e, ...n }) => {
    ...
    o = ({ className: e, boxContent: n, ...t }) => (0, s.jsx)(r, { className: (0, i.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  29680(e, n, t) {
   t.d(n, { v: () => o });
   var i = t(24456),
    a = t(13526),
    s = t(86070);
   const r = ({ className: e, children: n, purpose: t, iconStart: i, iconEnd: r, href: o }) => (0, s.jsxs)('a', { className: (0, a.A)('nl-button', e, { 'nl-button--primary': 'primary' === t, 'nl-button--secondary': 'secondary' === t, 'nl-button--subtle': 'subtle' === t }), href: o, children: [i && (0, s.jsx)('span', { className: 'nl-button__icon-start', children: i }), (0, s.jsx)('span', { className: 'nl-button__label', children: n }), r && (0, s.jsx)('span', { className: 'nl-button__icon-end', children: r })] }),
    o = globalThis.isAstro
     ? ({ appearance: e, href: n, ...t }) => {
        let i = 'primary';
        return ((i = 'secondary-action' === e ? 'secondary' : i), (0, s.jsx)(r, { purpose: i, href: n, ...t }));
       }
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => a, KF: () => u, mJ: () => g, VZ: () => x, cR: () => w, Pv: () => j, qZ: () => r, kD: () => k, QQ: () => C, B2: () => h, Pc: () => l, f4: () => o, GT: () => f, fX: () => s, eQ: () => b, B_: () => y, o_: () => v });
