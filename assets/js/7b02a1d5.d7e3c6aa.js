 ...
 [33145],
 {
   ...
   const d = (0, a.createContext)({}),
    h = ({ title: e, appearance: n, description: o, children: a, figure: h }) => {
     const v = { do: 'Doen', dont: 'Niet doen' },
      p = h ? 'figure' : 'div',
      g = h ? 'figcaption' : 'div',
      j = 'string' == typeof o ? (0, c.jsx)(r.oz, { components: { a: i.N_ }, children: o }) : o;
  ...
  70348(e, n, o) {
   ...
   const r = ({ className: e, ...n }) => {
    ...
    a = ({ className: e, classNamePanel: n, label: o, heading: r, headingLevel: a, headingApperance: c, ...d }) => {
     const h = (0, s.A)('utrecht-accordion__section', e),
      v = (0, s.A)('utrecht-accordion__panel', n);
     return (0, t.jsxs)('details', { className: h, ...d, children: [(0, t.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, t.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, t.jsx)('span', { className: 'nl-button__icon-start', children: (0, t.jsx)(l.A, {}) }), (0, t.jsxs)('span', { className: 'nl-button__label', children: [r && (0, t.jsx)(i.D, { level: a, appearance: c, children: r }), o] })] }) }), (0, t.jsx)('div', { className: v, children: d.children })] });
    };
  },
  80731(e, n, o) {
   o.d(n, { H: () => x });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: o }) => {
       const s = 'function' == typeof e ? e() : e,
        ...
        t = g().highlight(l, g().languages[n], n);
       return (0, u.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', o), children: [(0, u.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: l } }), (0, u.jsx)(j.n, { children: (0, u.jsx)(j.K, { label: 'Code', children: (0, u.jsx)('pre', { className: 'language-html nl-code-block', children: (0, u.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: t } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: p = !0, children: g, container: j = 'document', language: x, designTokens: k }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: x, plugins: [t.A, r.Ay, a.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         z(e);
        })();
       }, [N]);
       const S = (0, h.useId)();
         ...
         children: [
          ...
          p &&
           (0, u.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, u.jsx)(s.M, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: w, trim: !0 }),
             n &&
              (0, u.jsx)('div', {
