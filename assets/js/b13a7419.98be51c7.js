    ...
    return (
     ...
     (0, a.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsx)(s.dn, { tabIndex: 0, style: l, children: o.map((e, l) => (0, a.jsxs)('span', { ...i({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const m = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     g = u ? 'figcaption' : 'div';
    return (0, t.jsxs)(h, { className: (0, a.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, t.jsxs)(g, { className: (0, a.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, t.jsxs)(t.Fragment, { children: [(0, t.jsxs)(i.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, t.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, t.jsx)('span', { className: r['nlds-guideline__title'], children: p })] }), (0, t.jsx)(i.nv, { children: n })] }) : (0, t.jsxs)(t.Fragment, { children: [(0, t.jsxs)(i.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, t.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, t.jsx)('span', { className: r['nlds-guideline__title'], children: m })] }), (0, t.jsx)(i.nv, { children: n })] }), c] }), (0, t.jsx)('div', { className: (0, a.Z)(r['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => a });
