 ...
 [8352],
 {
  16057: (e, n, i) => {
   ...
   const o = { title: "WCAG Succescriterium 1.3.1 Info en relaties", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "1.3.1 Info en relaties", pagination_label: "WCAG Succescriterium 1.3.1 Info en relaties", description: "Alle gebruikers moeten over dezelfde informatie kunnen beschikken.", slug: "1.3.1", keywords: ["WCAG"] },
    ...
    d = { id: "wcag/1.3.1", title: "WCAG Succescriterium 1.3.1 Info en relaties", description: "Alle gebruikers moeten over dezelfde informatie kunnen beschikken.", source: "@site/docs/wcag/1.3.1.mdx", sourceDirName: "wcag", slug: "/wcag/1.3.1", permalink: "/wcag/1.3.1", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.3.1.mdx", tags: [], version: "current", frontMatter: { title: "WCAG Succescriterium 1.3.1 Info en relaties", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "1.3.1 Info en relaties", pagination_label: "WCAG Succescriterium 1.3.1 Info en relaties", description: "Alle gebruikers moeten over dezelfde informatie kunnen beschikken.", slug: "1.3.1", keywords: ["WCAG"] }, sidebar: "richtlijnen", previous: { title: "WCAG Succescriterium 1.1.1 Niet-tekstuele content", permalink: "/wcag/1.1.1" }, next: { title: "WCAG Succescriterium 1.3.5 Identificeer het doel van de input", permalink: "/wcag/1.3.5" } },
    c = {},
    h = [
