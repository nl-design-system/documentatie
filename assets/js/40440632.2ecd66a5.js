 ...
 [51528],
 {
  ...
  82685: (e, n, t) => {
   ...
   const l = (e) => {
    ...
    return (0, o.jsx)(a.Z, { url: `https://youtube.com/watch?v=${n}`, className: `${(0, s.Z)(i["video-player"])} ${t}`, width: "100%", height: "100%", controls: !0, ...l, config: { youtube: { playerVars: { disablekb: 1 } } } });
   };
  },
 },
]);
