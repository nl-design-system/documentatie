 ...
 [7177],
 {
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    u = n(83386),
    l = n(86070);
   const h = { figma: (0, l.jsx)(i.A, {}), github: (0, l.jsx)(s.A, {}), npm: (0, l.jsx)(o.A, {}), storybook: (0, l.jsx)(a.A, {}) },
    d = ({ brand: e }) => (0, l.jsx)(r.In, { children: h[e] || (0, l.jsx)(u.A, {}) });
   var j = n(14889),
    y = n(98274);
   const m = ({ checked: e, unchecked: t }) =>
    (0, l.jsx)(y.A, {
   ...
   var g = n(36444),
    ...
    b = n(68873),
    v = n(51797);
   const k = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    f = ({ checked: e, children: t, title: n, description: r, headingLevel: i = 3 }) => (0, l.jsxs)('li', { className: (0, c.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, c.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(v.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.DZ, { appearance: 'utrecht-heading-3', level: i, children: n }), r, t] })] });
   var x = n(75916);
   const w = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => x.f4.includes(e.id)),
      i = n && x.f4.map((e) => n.find((t) => t.id === e)).filter(Boolean);
     return e && (0, l.jsx)(r.If, { sections: i.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(k, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(f, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
          ...
          .map((e) => {
           ...
           return (0, l.jsx)(
            j.Zp,
            {
             ...
             children: (0, l.jsxs)(j.Wu, {
              children: [
               (0, l.jsx)(r.DZ, { level: t, children: e.title.replace(/^Community/i, '') }),
               (0, l.jsxs)(r.fz, { children: [(0, l.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, l.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
               (o.length > 0 || i.length > 0) && (0, l.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               o.length > 0 &&
                (0, l.jsx)(l.Fragment, {
                 children: (0, l.jsx)(r.dk, {
                  links: o
                   ...
                   .map((e) => {
                    ...
                    return { children: t.desciption, icon: (0, l.jsx)(d, { brand: t.brand }), href: e.value };
                   }),
                 }),
                }),
               i.length > 0 && (0, l.jsx)(l.Fragment, { children: i.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    N = ({ component: e, headingLevel: t, description: n }) => {
     const c = e && x.bo[e.relayStep];
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p.p, { level: t, suffix: c && (0, l.jsx)(g.D, { state: c }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  74111: (e, t, n) => {
   ...
   (c.keys = () => Object.keys(r)), (c.id = 74111), (e.exports = c);
  },
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => p, GT: () => k, KF: () => h, Pc: () => o, Pv: () => m, Rc: () => f, bo: () => r, eQ: () => b, f4: () => s, fX: () => c, kD: () => v, mJ: () => y, o_: () => g, qZ: () => i });
