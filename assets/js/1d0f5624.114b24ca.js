 ...
 [58293],
 {
  ...
  58639(e, n, l) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: g = !0, children: v, container: b = 'document', language: y, designTokens: f }) => {
    ...
    let F = p.Fragment;
    return (
     'paragraph' === b ? (F = m) : 'document' === b ? (F = j) : 'surface' === b && (F = x),
     (0, u.jsxs)('div', {
