 ...
 [10721],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    u = n(86070);
   const l = { figma: (0, u.jsx)(c.A, {}), github: (0, u.jsx)(o.A, {}), npm: (0, u.jsx)(i.A, {}), storybook: (0, u.jsx)(s.A, {}) },
    h = ({ brand: e }) => (0, u.jsx)(r.In, { children: l[e] || (0, u.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => p, VZ: () => w, cR: () => _, Pv: () => m, qZ: () => i, kD: () => f, B2: () => j, Pc: () => a, f4: () => s, GT: () => b, fX: () => o, eQ: () => v, B_: () => k, o_: () => g, Rc: () => x });
    ...
    m = (e) => {
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map(({ name: r, id: c, value: o }) => {
        const i = /^(.+) URL/.exec(r)[1],
         s = 'Storybook' === i ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${i}`;
        return { brand: i.toLowerCase(), name: r, id: c, value: o, description: s };
       });
  ...
  72642(e, t, n) {
   ...
   var r = n(13526),
    c = n(86070);
   const o = ({ children: e, className: t, level: n = 1, suffix: o, ...i }) => (0, c.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, t), ...i, children: [(0, c.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), o && (0, c.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
  },
  90495(e, t, n) {
   'use strict';
   n.d(t, { AC: () => u, Fu: () => i, Wu: () => s, Zp: () => a });
   var r = n(46447),
    c = n(13526),
    o = n(86070);
   const i = ({ background: e, children: t, className: n, ...r }) => (0, o.jsx)('div', { className: (0, c.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    s = (e) => (0, o.jsx)('div', { className: 'card__content', ...e }),
    a = ({ href: e, appearance: t, className: n, component: i = 'div', background: s, children: a }) => {
     const u = (e) => ('article' === i ? (0, o.jsx)('article', { ...e }) : 'section' === i ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      l = (0, o.jsx)(u, { className: (0, c.A)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, o.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    u = ({ appearance: e = 'medium', children: t, className: n }) => (0, o.jsx)('div', { className: (0, c.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
  99630(e, t, n) {
   'use strict';
   n.d(t, { VK: () => g, $9: () => v, mu: () => k, Fc: () => f });
   var r = n(29181),
    c = n(13526),
    o = n(1292),
    i = n(90495),
   ...
   const y = ({ children: e }) => (0, a.jsx)('ul', { className: 'task-list', children: e }),
    p = ({ checked: e, children: t, title: n, description: r, headingLevel: o = 3 }) => (0, a.jsxs)('li', { className: (0, c.A)('task-list-item'), children: [(0, a.jsxs)('div', { className: (0, c.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, a.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, a.jsx)(j.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, a.jsxs)('div', { children: [n ? (0, a.jsx)(d.DZ, { appearance: 'utrecht-heading-3', level: o, children: n }) : null, r, t] })] });
   var m = n(33062);
            ...
            i.Zp,
            {
             ...
             children: (0, a.jsxs)(i.Wu, {
              children: [
               ...
               s.length > 0 && (0, a.jsx)(a.Fragment, { children: s.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
