(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [23221],
 {
  3890: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => j, component: () => k, contentTitle: () => h, default: () => x, description: () => m, frontMatter: () => d, issueNumber: () => v, metadata: () => u, title: () => p, toc: () => g });
   var r = t(52676),
    i = t(24785),
    a = t(81301),
    s = t(90786),
  ...
  90786: (e, n, t) => {
   ...
   const f = (e) => {
     let { children: n } = e;
     return (0, d.jsx)('ul', { className: b.Z['task-list'], children: n });
    },
    _ = (e) => {
     let { checked: n, children: t, title: r, description: a, headingLevel: s = 3 } = e;
     return (0, d.jsxs)('li', { className: (0, i.Z)(b.Z['task-list-item']), children: [(0, d.jsxs)('div', { className: (0, i.Z)(b.Z['task-list-item__marker'], n && b.Z['task-list-item__marker--checked']), children: [(0, d.jsx)('span', { className: b.Z['task-list-item__marker-label'], children: n ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), n && (0, d.jsx)(x.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(y.X6, { appearance: 'utrecht-heading-3', level: s, children: r }), a, t] })] });
    };
   var w = t(14669);
   const z = (e) => {
     let { component: n, headingLevel: t } = e;
     const a = n && n.projects.filter((e) => w.e9.includes(e.id)),
      s = a && w.e9.map((e) => a.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
    ...
    N = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(k.V, { level: t, suffix: a && (0, d.jsx)(v.y, { state: a }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, n, t) => {
   'use strict';
