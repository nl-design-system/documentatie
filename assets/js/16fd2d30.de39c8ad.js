(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [32139],
 {
  ...
  26356(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => k, component: () => A, contentTitle: () => b, default: () => w, description: () => _, frontMatter: () => j, issueNumber: () => T, metadata: () => a, title: () => x, toc: () => N }));
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => h, mJ: () => u, VZ: () => T, cR: () => _, Pv: () => q, qZ: () => o, kD: () => b, B2: () => p, Pc: () => r, f4: () => l, GT: () => k, fX: () => i, eQ: () => j, B_: () => f, o_: () => g, Rc: () => x });
            ...
            o.Zp,
            {
             ...
             children: (0, d.jsxs)(o.Wu, {
              children: [
               ...
               (m.length > 0 || l.length > 0) && (0, d.jsx)(a.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               m.length > 0 &&
                (0, d.jsx)(d.Fragment, {
