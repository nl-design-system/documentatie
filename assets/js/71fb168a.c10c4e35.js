/*! For license information please see 71fb168a.c10c4e35.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [31399],
 {
  ...
  18652(e, s, n) {
   ...
   const o = (e, s, n, o) => {
    const r = (0, t.forwardRef)(({ color: n = 'currentColor', size: r = 24, stroke: a = 2, title: l, className: d, children: g, ...c }, m) => (0, t.createElement)('svg', { ref: m, ...i[e], width: r, height: r, className: ['tabler-icon', `tabler-icon-${s}`, d].join(' '), ...('filled' === e ? { fill: n } : { strokeWidth: a, stroke: n }), ...c }, [l && (0, t.createElement)('title', { key: 'svg-title' }, l), ...o.map(([e, s]) => (0, t.createElement)(e, s)), ...(Array.isArray(g) ? g : [g])]));
    return ((r.displayName = `${n}`), r);
   };
  },
  18945(e, s, n) {
   (n.r(s), n.d(s, { assets: () => c, contentTitle: () => g, default: () => y, frontMatter: () => d, isUpComingOrHappening: () => m, metadata: () => t, toc: () => h }));
