/*! For license information please see 5b76b9b7.e537db22.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [42437],
 {
  48538: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => m, contentTitle: () => l, default: () => u, frontMatter: () => o, metadata: () => d, toc: () => g });
   var s = t(52676),
    i = t(40139),
    a = t(97233),
    r = t(37943);
  ...
  97233: (e, n, t) => {
   ...
   var s = t(84263),
    i = t(52676);
   const a = (e) => {
    let { id: n, title: t, ...a } = e;
    return (0, i.jsx)(s.Z, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: n, title: t, poster: 'maxresdefault', ...a });
   };
  },
  40139: (e, n, t) => {
   t.d(n, { Z: () => o, a: () => r });
   ...
   function o(e) {
    let n;
    return (n = e.disableParentContext ? ('function' == typeof e.components ? e.components(i) : e.components || i) : r(e.components)), s.createElement(a.Provider, { value: n }, e.children);
   }
  },
  84263: (e, n, t) => {
   t.d(n, { Z: () => r });
    ...
    i = function () {
     return (
      (i =
       Object.assign ||
       function (e) {
        for (var n, t = 1, s = arguments.length; t < s; t++) for (var i in (n = arguments[t])) Object.prototype.hasOwnProperty.call(n, i) && (e[i] = n[i]);
        return e;
       }),
   ...
   var r = s.forwardRef(function (e, n) {
    var t = s.useState(!1),
     ...
     v = new URLSearchParams(i(i(i(i({}, e.muted ? { mute: '1' } : {}), p ? { autoplay: '1' } : {}), e.enableJsApi ? { enablejsapi: '1' } : {}), e.playlist ? { list: g } : {}));
    e.params &&
    ...
    var w = e.playlist ? ''.concat(y, '/embed/videoseries?').concat(v.toString()) : ''.concat(y, '/embed/').concat(g, '?').concat(v.toString()),
     b = !e.thumbnail && !e.playlist && 'maxresdefault' === k,
     j = e.webp ? 'webp' : 'jpg',
     f = e.webp ? 'vi_webp' : 'vi',
     S = b
      ? (function (e, n, t, i) {
         ...
         return (
          (0, s.useEffect)(
           function () {
            var s = 'https://img.youtube.com/'.concat(n, '/').concat(e, '/').concat(i, '.').concat(t),
    ...
    return (
     ...
     s.createElement(
      s.Fragment,
      null,
      s.createElement('link', { rel: C, href: D, as: 'image' }),
      s.createElement(s.Fragment, null, r && s.createElement(s.Fragment, null, s.createElement('link', { rel: 'preconnect', href: y }), s.createElement('link', { rel: 'preconnect', href: 'https://www.google.com' }), z && s.createElement(s.Fragment, null, s.createElement('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), s.createElement('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })))),
      s.createElement(
       H,
       {
        ...
        className: ''.concat(E, ' ').concat(d ? x : ''),
        'data-title': u,
        style: i(i({ backgroundImage: 'url('.concat(D, ')') }, { '--aspect-ratio': ''.concat((N / O) * 100, '%') }), R),
       },
       s.createElement('button', { type: 'button', className: L, 'aria-label': ''.concat(h, ' ').concat(u) }),
       d && s.createElement('iframe', { ref: n, className: _, title: u, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: w }),
      ),
     )
    );
   });
