  ...
  82415: (e, t, n) => {
   ...
   const d = (e) => {
    ...
    return (0, l.jsxs)('form', {
     ...
     children: [(0, l.jsxs)(i.Wi, { type: 'email', children: [(0, l.jsx)(i.nv, { children: (0, l.jsx)(i.lX, { htmlFor: `id-${o}`, children: f ? 'Email address ' : 'E-mailadres' }) }), k[o] && (0, l.jsx)(i.w7, { children: k[o].message }), (0, l.jsx)(i.nv, { children: (0, l.jsx)(i.fE, { id: `id-${o}`, name: o, type: 'email', autoComplete: 'email', defaultValue: I, 'aria-required': 'true', ...g(`${o}`, { required: { value: !0, message: f ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' }, pattern: { value: /\S+@\S+\.\S+/, message: f ? 'This is not a valid email address.' : 'Dit is geen correct emailadres.' } }), invalid: !!k[o] }) })] }), (0, l.jsxs)(i.Wi, { type: 'text', children: [(0, l.jsx)(i.nv, { children: (0, l.jsx)(i.lX, { htmlFor: m, children: f ? 'Name' : 'Naam' }) }), k[m] && (0, l.jsx)(i.w7, { children: k[m].message }), (0, l.jsx)(i.nv, { children: (0, l.jsx)(i.fE, { id: m, name: m, type: 'text', defaultValue: $, autoComplete: 'given-name', 'aria-required': 'true', ...g(`${m}`, { required: { value: !0, message: f ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' } }), invalid: !!k[m] }) })] }), c && (0, l.jsxs)(i.Wi, { type: 'text', children: [(0, l.jsx)(i.nv, { children: (0, l.jsx)(i.lX, { htmlFor: c, children: 'Organisatie (niet verplicht)' }) }), k[c] && (0, l.jsx)(i.w7, { children: k[c].message }), (0, l.jsx)(i.nv, { children: (0, l.jsx)(i.fE, { id: c, name: c, type: 'text' }) })] }), h && (0, l.jsxs)(i.pg, { children: [(0, l.jsx)(i.Qv, { children: 'Waar wil je NL Design System voor gebruiken? (niet verplicht)' }), (0, l.jsx)(i.ue, { children: 'Meerdere antwoorden mogelijk.' }), u.map((e, t) => (0, l.jsx)(i.Wi, { type: 'checkbox', children: (0, l.jsxs)(i.nv, { children: [(0, l.jsx)(i.XZ, { name: `${h}[]`, value: t >= 6 ? t + 2 : t + 1, id: `${h}-${t + 1}` }), (0, l.jsx)(i.lX, { htmlFor: `${h}-${t + 1}`, children: e })] }) }, e))] }), p && (0, l.jsxs)(i.Wi, { type: 'text', children: [(0, l.jsxs)(i.nv, { children: [(0, l.jsx)(i.lX, { htmlFor: p, children: 'Aan wat voor projecten werk je? (niet verplicht)' }), (0, l.jsx)(i.ue, { children: 'Denk aan mijn-omgevingen, formulieren en/of kaarten.' })] }), (0, l.jsx)(i.nv, { children: (0, l.jsx)(i.gx, { id: p, name: p }) })] }), v && (0, l.jsxs)(i.Wi, { type: 'text', children: [(0, l.jsx)(i.ue, { id: `${v}-description`, children: (0, l.jsxs)('p', { children: ['Op onze activiteiten is de ', (0, l.jsx)('a', { href: '/privacyverklaring', children: 'privacyverklaring van NL Design System' }), ' van toepassing.'] }) }), (0, l.jsxs)(i.Wi, { type: 'checkbox', children: [(0, l.jsx)(i.XZ, { value: '1', id: `${v}-1`, 'aria-describedby': `${v}-description`, 'aria-required': 'true', ...g(`${v}[]`, { required: { value: !0, message: 'Je kunt je alleen aanmelden als je akkoord gaat met de privacyverklaring.' } }), invalid: !!k[`${v}[]`] }), (0, l.jsxs)(i.lX, { htmlFor: `${v}-1`, children: [' ', 'Ik ga akkoord met het gebruik van mijn gegevens volgens de privacyverklaring'] })] }), k[v] && (0, l.jsx)(i.w7, { children: k[v].message })] }), j && (0, l.jsx)('input', { type: 'hidden', name: j.id, value: j.value }), (0, l.jsx)(i.hE, { children: (0, l.jsx)(i.zx, { type: 'submit', appearance: 'primary-action-button', children: x || (f ? 'Sign up' : 'Aanmelden') }) }), (0, l.jsx)('input', { type: 'hidden', name: 'next', value: d }), (0, l.jsx)('input', { type: 'hidden', name: 'a', value: n }), (0, l.jsx)('input', { type: 'hidden', name: 'l', value: t }), (0, l.jsx)('input', { name: 'osnD9cWRI3', autoComplete: 'on', id: 'id-osnD9cWRI3', type: 'hidden', value: 'NLDS website' }), (0, l.jsx)('input', { autoComplete: 'new-password', type: 'email', id: 'email', name: 'email', placeholder: 'Your e-mail here', className: 'sr-only', 'aria-hidden': 'true' })],
    });
   };
  },
  87118: (e, t, n) => {
