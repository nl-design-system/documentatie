 ...
 [10539],
 {
  ...
  85228: (e, t, n) => {
   ...
   const i = { title: "Date input group", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Date input group", pagination_label: "Date input group", description: "UX richtlijnen voor Date input group component", slug: "/date-input-group", tags: ["Help Wanted"] },
    a = void 0,
    p = { unversionedId: "componenten/build/date-input-group", id: "componenten/build/date-input-group", title: "Date input group", description: "UX richtlijnen voor Date input group component", source: "@site/docs/componenten/build/date-input-group.mdx", sourceDirName: "componenten/build", slug: "/date-input-group", permalink: "/date-input-group", draft: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/date-input-group.mdx", tags: [{ label: "Help Wanted", permalink: "/tags/help-wanted" }], version: "current", frontMatter: { title: "Date input group", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Date input group", pagination_label: "Date input group", description: "UX richtlijnen voor Date input group component", slug: "/date-input-group", tags: ["Help Wanted"] }, sidebar: "componenten", previous: { title: "Data list", permalink: "/data-list" }, next: { title: "Date input", permalink: "/date-input" } },
    u = {},
