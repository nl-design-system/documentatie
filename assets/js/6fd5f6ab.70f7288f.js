 ...
 [72755],
 {
  ...
  35038: (e, n, t) => {
   ...
   const o = (e) => {
    ...
    c = (e) => {
     let { href: n, appearance: t, className: o, component: a = 'div', background: c, children: l } = e;
     const d = (e) => ('article' === a ? (0, s.jsx)('article', { ...e }) : 'section' === a ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      h = (0, s.jsx)(d, { className: (0, i.Z)('cardgroup__card', c && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, o), children: l });
  ...
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, $e: () => j, BA: () => a, Ee: () => d, Q6: () => s, U: () => g, Yr: () => k, d: () => h, e9: () => o, fO: () => v, mA: () => i, ps: () => m, qU: () => y, s0: () => w, zP: () => p });
      ...
      const r = e.tasks
       ...
       .map((r) => {
        ...
        const a = /^(.+) URL/.exec(i)[1],
         c = 'Storybook' === a ? `${t} (${n}) in Storybook van ${((e) => (['Candidate - New', 'Candidate - Oud'].includes(e.title) ? 'Candidate' : e.title))(e)}` : `${t} (${n}) op ${a}`;
