 ...
 [11214],
 {
  6656(e, n, l) {
   ...
   var s = l(86070),
    ...
    a = l(15638);
   function c(e) {
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', (0, s.jsx)(a.$, { appearance: 'do', title: 'Simpel label met extra beschrijving. Gebruik waar nodig een losse description om meer uitleg te geven.', children: (0, s.jsx)(i.H, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)('p', { children: (0, s.jsx)('label', { htmlFor: 'first-name', children: 'Voornaam (een of meerdere)' }) }), (0, s.jsx)('p', { id: 'first-name-description', children: 'Vul de voornaam of voornamen in zoals deze op je id-kaart of paspoort staan.' }), (0, s.jsx)('p', { children: (0, s.jsx)('input', { autoComplete: 'given-name', type: 'text', name: 'first_name', id: 'first-name', 'aria-describedby': 'first-name-description' }) })] }) }) }), '\n', (0, s.jsx)(a.$, { appearance: 'dont', title: 'Ingewikkeld label. Door veel informatie in te korten wordt het label onduidelijk', children: (0, s.jsx)(i.H, { language: 'html', children: () => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)('p', { children: (0, s.jsx)('label', { htmlFor: 'first-name2', children: 'Voornaam(en)' }) }), (0, s.jsx)('p', { children: (0, s.jsx)('input', { autoComplete: 'given-name', type: 'text', name: 'first_name', id: 'first-name2' }) })] }) }) })] });
   }
   function d(e = {}) {
   ...
   function u(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(n.header, { children: (0, s.jsx)(n.h1, { id: 'gebruik-duidelijke-labelteksten', children: 'Gebruik duidelijke labelteksten' }) }), '\n', (0, s.jsx)(n.p, { children: 'Het doel van een label is dat de gebruiker de vraag begrijpt. Een effectief label is duidelijk en beschrijvend. Waar nodig wordt er ook extra hulp geboden worden, zoals een omschrijving van waar een BSN-nummer te vinden is.' }), '\n', (0, s.jsx)(n.p, { children: 'Wanneer je een afkorting gebruikt, of je moet jargon gebruiken omdat de offici\xeble term verplicht is, geef dan in de beschrijving een voorbeeld of uitleg.' })] });
   }
   function p(e = {}) {
    const { wrapper: n } = { ...(0, o.R)(), ...e.components };
   ...
   const b = { title: 'Gebruik duidelijke labelteksten', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Duidelijke tekst label', pagination_label: 'Duidelijke tekst label', description: 'Richtlijnen voor duidelijke labelteksten.', slug: '/richtlijnen/formulieren/labels/duidelijke-tekst', keywords: ['labels', 'formulier', 'design', 'code'] },
    j = void 0,
    y = {},
    g = [{ value: 'Meer lezen over gerelateerde WCAG-succescriteria op NL Design System', id: 'meer-lezen-over-gerelateerde-wcag-succescriteria-op-nl-design-system', level: 2 }, ...r.RM];
   function x(e) {
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', (0, s.jsx)(p, {}), '\n', (0, s.jsx)(d, {}), '\n', (0, s.jsx)(h, {}), '\n', (0, s.jsx)(r.Ay, {})] });
   }
   function v(e = {}) {
  ...
  58639(e, n, l) {
   ...
   var t = l(69284),
    ...
    p = l(31186),
    m = l(86070);
   const h = ({ children: e }) => (0, m.jsx)(s.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(s.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(s.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   h.displayName = 'ParagraphContainer';
   const b = ({ children: e }) => (0, m.jsx)(s.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(s.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   b.displayName = 'DocumentContainer';
   const j = ({ children: e }) => (0, m.jsx)(s.ui, { className: 'nlds-canvas__example-surface', children: e });
   j.displayName = 'SurfaceContainer';
   const y = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: y = !0, children: g, container: x = 'document', language: v, designTokens: k }) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(N, { parser: v, plugins: [r.A, i.Ay, a.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      A(e);
     })();
    }, [N]);
    const S = (0, u.useId)();
    let R = u.Fragment;
    return (
     'paragraph' === x ? (R = h) : 'document' === x ? (R = b) : 'surface' === x && (R = j),
     (0, m.jsxs)('div', {
      className: (0, o.A)('nlds-canvas'),
      children: [
       f && (0, m.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(R, { children: (0, m.jsx)(s.v$, { children: f }) }) }) }),
       y &&
        (0, m.jsx)('div', {
       ...
       y &&
        (0, m.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(t.M, { codeBlockLabel: 'Codevoorbeeld', syntax: v, textContent: w, trim: !0 }),
          n &&
           (0, m.jsx)('div', {
  ...
  69284(e, n, l) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: l, trim: c }) {
    ...
    const { title: u, type: p } = (0, o.useContext)(r.x),
     m = (0, o.useId)();
    return (c && (d = d.trim()), (0, a.jsx)(s.f4, { theme: i, code: d, language: n || '', children: ({ style: n, tokens: l, getLineProps: s, getTokenProps: o }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, a.jsx)(t.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': m, style: n, children: l.map((n, l) => (0, a.jsxs)('span', { ...s({ line: n }), children: [e && (0, a.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, a.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  78734(e, n, l) {
   l.d(n, { Ay: () => i, RM: () => o });
