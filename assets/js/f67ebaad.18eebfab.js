 ...
 [33527],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    h = n(86070);
   const u = { figma: (0, h.jsx)(i.A, {}), github: (0, h.jsx)(s.A, {}), npm: (0, h.jsx)(c.A, {}), storybook: (0, h.jsx)(o.A, {}) },
    l = ({ brand: e }) => (0, h.jsx)(r.In, { children: u[e] || (0, h.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => g, qZ: () => c, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => s, eQ: () => f, B_: () => v, o_: () => p, Rc: () => x });
   ...
   const l = (e) => [...e].sort((e, t) => h.indexOf(e) - h.indexOf(t)),
    d = (e) => {
    ...
    y = (e) => {
     const t = / URL \(([^)]+)\)/;
     return l(u(e.tasks.filter(({ name: e, value: n }) => '' !== n && t.test(e)).map(({ name: e }) => t.exec(e)?.[1])));
    },
    m = (e) => l(u(e.projects.flatMap((e) => y(e)))),
    g = (e) => {
     const t = y(e),
      n = ((e) => {
  ...
  83754(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => p, componentName: () => g, contentTitle: () => u, default: () => k, description: () => j, frontMatter: () => h, issueNumber: () => y, metadata: () => r, relayStep: () => m, title: () => d, toc: () => v }));
   const r = JSON.parse('{"id":"componenten/video/index","title":"Video","description":"Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.","source":"@site/docs/componenten/video/index.mdx","sourceDirName":"componenten/video","slug":"/video","permalink":"/video","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/video/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Video","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Video","pagination_label":"Video","description":"Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.","slug":"/video"},"sidebar":"componenten","previous":{"title":"Unordered List","permalink":"/unordered-list"},"next":{"title":"YouTube Video","permalink":"/youtube-video"}}');
   var i = n(86070),
    s = n(18439),
    c = n(87069),
    o = n(85825),
    a = n(44594);
   const h = { title: 'Video', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Video', pagination_label: 'Video', description: 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.', slug: '/video' },
    u = void 0,
    l = {},
    d = 'Video',
    j = 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.',
    y = 69,
    m = 'help wanted',
    g = 'video',
  ...
  85825(e, t, n) {
   ...
   const v = ({ component: e, headingLevel: t }) => {
         ...
         children: n
          ...
          .map((e) => {
           const n = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            l = e.tasks.filter(({ name: e, value: t }) => a.has(e) && URL.canParse(t) && 'https:' === new URL(t).protocol);
           return (0, h.jsx)(
            c.Zp,
            {
             ...
             children: (0, h.jsxs)(c.Wu, {
              children: [
               ...
               (0, h.jsxs)(r.fz, { children: [(0, h.jsx)(u, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, h.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
               (l.length > 0 || o.length > 0) && (0, h.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               l.length > 0 &&
                (0, h.jsx)(h.Fragment, {
    ...
    b = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(d.p, { level: t, suffix: i && (0, h.jsx)(l.D, { state: i }), children: e.title }), (0, h.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
   ...
   const c = ({ background: e, children: t, className: n, ...r }) => (0, s.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: c = 'div', background: o, children: a }) => {
     const h = (e) => ('article' === c ? (0, s.jsx)('article', { ...e }) : 'section' === c ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      u = (0, s.jsx)(h, { className: (0, i.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, s.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: u }) : u;
    },
