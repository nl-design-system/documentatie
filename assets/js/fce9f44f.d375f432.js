...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [1132],
 {
  4258(e, n, t) {
   ...
   var i = t(78236),
    l = t(86070);
   const s = ({ id: e, title: n, ...t }) => (0, l.jsx)(i.A, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: n, poster: 'maxresdefault', ...t });
  },
  18439(e, n, t) {
   t.d(n, { R: () => r, x: () => o });
   var i = t(30758);
  ...
  73225(e, n, t) {
   (t.r(n), t.d(n, { assets: () => u, contentTitle: () => p, default: () => g, frontMatter: () => c, metadata: () => i, toc: () => h }));
   ...
   const c = { title: 'Legends \xb7 Fieldsets \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Legends in een fieldset', pagination_label: 'Legends in een fieldset', description: 'Richtlijnen voor legends in een fieldset in een formulier.', slug: '/richtlijnen/formulieren/fieldsets/legends', keywords: ['labels', 'formulier', 'design', 'code'] },
    p = void 0,
    u = {},
    h = [{ value: 'Koppen in een legend', id: 'koppen-in-een-legend', level: 2 }, ...r.RM];
   function m(e) {
  ...
  78236(e, n, t) {
   ...
   const o = l.forwardRef(function (e, n) {
    const [t, o] = l.useState(!1),
     ...
     b = l.useMemo(() => (e.cookie ? 'https://www.youtube.com' : 'https://www.youtube-nocookie.com'), [e.cookie]),
     j = l.useMemo(() => (e.playlist ? `${b}/embed/videoseries?${f.toString()}` : `${b}/embed/${c}?${f.toString()}`), [e.playlist, b, c, f]),
     ...
     w = v
      ...
      : null,
     k = l.useMemo(() => e.thumbnail || w || `https://i.ytimg.com/${x}/${e.playlist ? p : c}/${h}.${y}`, [e.thumbnail, w, x, e.playlist, p, c, h, y]),
    ...
    return (
     ...
     (0, i.jsxs)(i.Fragment, {
      children: [
       ...
       (0, i.jsx)(i.Fragment, { children: t && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('link', { rel: 'preconnect', href: b }), (0, i.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), _ && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, i.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
       e.seo && !e.playlist && (0, i.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: r(e.id, u, k, b, e.seo) } }),
       ...
       (0, i.jsxs)(E, {
        ...
        style: { ...(!e.lazyLoad && { backgroundImage: `url(${k})` }), '--aspect-ratio': (z / L) * 100 + '%', ...(e.style || {}) },
        children: [e.lazyLoad && !a && (0, i.jsx)('img', { src: k, alt: `${u} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, i.jsx)('button', { type: 'button', className: S, 'aria-label': `${m} ${u}`, 'aria-hidden': a || void 0, tabIndex: a ? -1 : 0, children: (0, i.jsx)('span', { className: 'lty-visually-hidden', children: m }) }), a && (0, i.jsx)('iframe', { ref: n, className: R, title: u, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: j, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
