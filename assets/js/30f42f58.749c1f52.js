...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [15667],
 {
  ...
  31785(e, n, t) {
   ...
   const p = { title: 'WCAG-succescriterium 3.1.1 Taal van de pagina', title_sm: '3.1.1 Taal van de pagina', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.1.1 Taal van de pagina', pagination_label: 'WCAG-succescriterium 3.1.1 Taal van de pagina', description: 'Geef de menselijke taal waarin de tekst van een webpagina is geschreven aan. Dit kan door in het html-element het attribuut \u2018lang\u2019 mee te geven.', slug: '3.1.1', conformance_level: 'Niveau A', keywords: ['WCAG', 'A', 'begrijpelijk', 'leesbaar', 'understandable', 'readable', 'language of page'] },
    j = void 0,
    m = {},
  ...
  61473(e, n, t) {
   ...
   var i = t(46447),
    a = t(46276),
    r = t(86070);
   const l = ({ children: e, conformanceLevel: n, ...t }) => (globalThis.isAstro ? null : (0, r.jsx)(a.p, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: n && (0, r.jsx)(i.KE, { className: 'nlds-inline-heading-group__badge', children: n }), ...t, children: e }));
  },
  66117(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => r });
   var i = t(86070),
  ...
  66119(e, n, t) {
   ...
   function a(e) {
    ...
    if ('string' == typeof e || 'number' == typeof e) i += e;
     ...
     if (Array.isArray(e)) {
      var r = e.length;
      for (n = 0; n < r; n++) e[n] && (t = a(e[n])) && (i && (i += ' '), (i += t));
     } else for (t in e) e[t] && (i && (i += ' '), (i += t));
    return i;
   }
   function r() {
    for (var e, n, t = 0, i = '', r = arguments.length; t < r; t++) (e = arguments[t]) && (n = a(e)) && (i && (i += ' '), (i += n));
    return i;
   }
   const l = (0, t(30758).forwardRef)(({ aside: e, children: n, className: t, purpose: a, ...l }, s) => {
    const o = { ...l, ref: s, className: r('utrecht-note', { [`utrecht-note--${a}`]: a }, t) };
