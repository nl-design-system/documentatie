 ...
 [4476],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    u = n(86070);
   const h = { figma: (0, u.jsx)(s.A, {}), github: (0, u.jsx)(i.A, {}), npm: (0, u.jsx)(c.A, {}), storybook: (0, u.jsx)(o.A, {}) },
    l = ({ brand: e }) => (0, u.jsx)(r.In, { children: h[e] || (0, u.jsx)(a.A, {}) });
  },
  24422(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => g, componentName: () => m, contentTitle: () => h, default: () => f, description: () => j, frontMatter: () => u, issueNumber: () => y, metadata: () => r, relayStep: () => p, title: () => d, toc: () => v }));
   ...
   var s = n(86070),
    ...
    o = n(85825),
    a = n(44594);
   const u = { title: 'Superscript', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Superscript', pagination_label: 'Superscript', description: 'Toont tekst met een kleiner lettertype met een verhoogde letterlijn.', slug: '/superscript', keywords: ['exponent', 'footnote', 'hoge tekst', 'kleine hoge tekst', 'kubieke', 'kwadraat', 'math', 'power', 'subscript', 'sup', 'supscript', 'superscript', 'tot de macht', 'tweetje', 'vierkante', 'voetnoot'] },
    h = void 0,
    l = {},
    d = 'Superscript',
    j = 'Toont tekst met een kleiner lettertype met een verhoogde letterlijn.',
    y = 337,
    p = 'help wanted',
    m = 'superscript',
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => d, mJ: () => p, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => c, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => i, eQ: () => k, B_: () => v, o_: () => g, Rc: () => x });
   ...
   const l = (e) => [...e].sort((e, t) => u.indexOf(e) - u.indexOf(t)),
    ...
    p = (e) => l(h(e.projects.flatMap((e) => y(e)))),
    m = (e) => {
     const t = y(e),
      n = ((e) => {
  ...
  85825(e, t, n) {
   ...
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, g.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(m, { headingLevel: t + 1, checked: e, title: n, description: (0, g.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
    ...
    b = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(d.p, { level: t, suffix: s && (0, u.jsx)(l.D, { state: s }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
   ...
   const c = ({ background: e, children: t, className: n, ...r }) => (0, i.jsx)('div', { className: (0, s.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: c = 'div', background: o, children: a }) => {
     const u = (e) => ('article' === c ? (0, i.jsx)('article', { ...e }) : 'section' === c ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      h = (0, i.jsx)(u, { className: (0, s.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
