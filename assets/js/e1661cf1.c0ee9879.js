 ...
 [76066],
 {
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    u = n(83386),
    l = n(86070);
   const h = { figma: (0, l.jsx)(s.A, {}), github: (0, l.jsx)(c.A, {}), npm: (0, l.jsx)(o.A, {}), storybook: (0, l.jsx)(a.A, {}) },
   ...
   var p = n(36444),
    ...
    v = n(68873),
    f = n(51797);
   const b = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    k = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, l.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(f.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }), r, t] })] });
   var x = n(75916);
   const _ = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, l.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(b, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(k, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
    N = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => !x.f4.includes(e.id));
     return e && n.length
      ? (0, l.jsx)(j.AC, {
         appearance: 'large',
            ...
            j.Zp,
            {
             ...
             children: (0, l.jsxs)(j.Wu, {
              children: [
               ...
               (0, l.jsxs)(r.fz, { children: [(0, l.jsx)(y, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, l.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
               ...
               s.length > 0 && (0, l.jsx)(l.Fragment, { children: s.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    A = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(g.p, { level: t, suffix: i && (0, l.jsx)(p.D, { state: i }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  71595: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => u, default: () => g, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => h, toc: () => y });
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => g, GT: () => b, KF: () => h, Pc: () => o, Pv: () => y, Rc: () => k, bo: () => r, eQ: () => v, f4: () => c, fX: () => i, kD: () => f, mJ: () => m, o_: () => p, qZ: () => s });
   ...
   const l = (e) => [...e].sort((e, t) => a.indexOf(e) - a.indexOf(t)),
    ...
    m = (e) => l(u(e.projects.flatMap((e) => j(e)))),
    y = (e) => {
     const t = j(e),
      n = ((e) => {
