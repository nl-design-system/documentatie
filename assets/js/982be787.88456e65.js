  ...
  70348(e, l, n) {
   ...
   const a = ({ className: e, ...l }) => {
    ...
    i = ({ className: e, classNamePanel: l, label: n, heading: a, headingLevel: i, headingApperance: c, ...d }) => {
     ...
     return (0, o.jsxs)('details', { className: h, ...d, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(t.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [a && (0, o.jsx)(r.D, { level: i, appearance: c, children: a }), n] })] }) }), (0, o.jsx)('div', { className: u, children: d.children })] });
    };
  },
  80731(e, l, n) {
   n.d(l, { H: () => y });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: l, className: n }) => {
       const s = 'function' == typeof e ? e() : e,
        ...
        o = p().highlight(t, p().languages[l], l);
       return (0, v.jsxs)('div', { className: (0, r.A)('ma-canvas-astro', n), children: [(0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: t } }), (0, v.jsx)(b.n, { children: (0, v.jsx)(b.K, { label: 'Code', children: (0, v.jsx)('pre', { className: 'language-html nl-code-block', children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
