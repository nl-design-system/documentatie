...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [26758],
 {
  ...
  79939(e, n, i) {
   ...
   const j = { title: 'WCAG-succescriterium 2.1.3 Toetsenbord (geen uitzondering)', title_sm: '2.1.3 Toetsenbord (geen uitzondering)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.1.3 Toetsenbord (geen uitzondering)', pagination_label: 'WCAG-succescriterium 2.1.3 Toetsenbord (geen uitzondering)', description: 'Zorg dat alle functionaliteit met een toetsenbord te bedienen is. Hier gelden geen uitzonderingen.', slug: '2.1.3', keywords: ['WCAG', 'AAA', 'bedienbaar', 'toetsenbordtoegankelijk', 'operable', 'keyboard accessible', 'keyboard (no exception)'] },
    m = void 0,
    x = {},
    b = [...h.RM, { value: 'Uitleg', id: 'uitleg', level: 2 }, { value: 'Opgelet', id: 'opgelet', level: 2 }, { value: 'Gebruikersonderzoek', id: 'gebruikersonderzoek', level: 2 }, ...c.RM, { value: 'W3C referenties', id: 'w3c-referenties', level: 2 }, ...d.RM, { value: 'Help richtlijn verbeteren', id: 'help-richtlijn-verbeteren', level: 2 }, ...g.RM];
   function v(e) {
