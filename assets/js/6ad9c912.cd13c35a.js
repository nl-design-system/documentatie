...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [19359],
 {
  ...
  27548: (e, n, o) => {
   o.r(n), o.d(n, { assets: () => y, contentTitle: () => h, default: () => b, frontMatter: () => u, metadata: () => m, toc: () => v });
   var t = o(52676),
    l = o(24785),
    r = o(55400),
    s = o(43599),
   ...
   function c(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(a.X, { appearance: 'do', title: 'Sta kopi\xebren van een wachtwoord toe.', children: (0, t.jsx)(s.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.label, { htmlFor: 'pw1', children: 'Uw nieuwe wachtwoord' }), (0, t.jsx)(n.input, { type: 'password', id: 'wachtwoord2', autoComplete: 'new-password', name: 'wachtwoord' })] }) }) })] });
   }
   function i(e = {}) {
    const { wrapper: n } = { ...(0, l.a)(), ...e.components };
  ...
  43599: (e, n, o) => {
   ...
   const k = (e) => {
    let { code: n, copy: o = !0, defaultExpandedCode: k = !1, displayCode: b = !0, children: g, container: j = 'document', language: x, designTokens: f } = e,
     w = 'function' == typeof g ? g() : g,
     _ = 'function' == typeof n ? n() : (0, p.isValidElement)(n) ? n : void 0,
     N = 'string' == typeof n ? n : u.uS(_ || w),
     [C, Z] = (0, p.useState)(N),
     [S, P] = (0, p.useState)(k);
    (0, p.useEffect)(() => {
     (async () => {
      (C = await d.ZP.format(N, { parser: x, plugins: [s.Z, a.ZP, c.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(C);
     })();
    }, [N]);
    const E = (0, p.useId)();
    let F = p.Fragment;
    return (
     'paragraph' === j ? (F = m) : 'document' === j ? (F = y) : 'surface' === j && (F = v),
     (0, h.jsxs)('div', {
      className: (0, r.Z)('nlds-canvas'),
      children: [
       w && (0, h.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(F, { children: (0, h.jsx)(t.pu, { children: w }) }) }) }),
       b &&
        (0, h.jsx)('div', {
       ...
       b &&
        (0, h.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, h.jsx)(l.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: C, trim: !0 }),
          o &&
           (0, h.jsx)('div', {
    ...
    return (
     ...
     (0, c.jsx)(l.y$, {
      ...
      children: (e) => {
       ...
       return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, c.jsx)(t.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': m, style: o, children: l.map((e, o) => (0, c.jsxs)('span', { ...r({ line: e }), children: [n && (0, c.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, c.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, o)) })] });
      },
     })
    );
   }
