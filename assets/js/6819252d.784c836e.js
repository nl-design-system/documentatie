   ...
   const d = (0, s.createContext)({}),
    h = ({ title: e, appearance: n, description: t, children: s, figure: h }) => {
     const p = { do: 'Doen', dont: 'Niet doen' },
      u = h ? 'figure' : 'div',
      m = h ? 'figcaption' : 'div',
      g = 'string' == typeof t ? (0, c.jsx)(l.oz, { components: { a: i.N_ }, children: t }) : t;
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const r = 'function' == typeof e ? e() : e,
        ...
        a = m().highlight(o, m().languages[n], n);
       return (0, b.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', t), children: [(0, b.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }), (0, b.jsx)(g.n, { children: (0, b.jsx)(g.K, { label: 'Code', children: (0, b.jsx)('pre', { className: 'language-html nl-code-block', children: (0, b.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: a } }) }) }) })] });
      }
