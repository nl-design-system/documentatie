...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  31971: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => j, contentTitle: () => p, default: () => b, frontMatter: () => u, metadata: () => m, toc: () => v });
   var t = i(52676),
    r = i(87118),
    s = i(57716),
    o = i(46364),
   ...
   function h(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.p, { children: 'Als de gebruiker een actie kan uitvoeren door een beweging te doen met het apparaat, dan moet er ook een manier zijn om die actie te doen zonder beweging.' }), '\n', (0, t.jsx)(n.p, { children: 'Niet iedereen kan bijvoorbeeld schudden met een mobiel.' }), '\n', (0, t.jsx)(n.p, { children: 'De gebruiker moet ook kunnen instellen dat beweging van het apparaat geen effect heeft, om te voorkomen dat per ongeluk een actie wordt uitgevoerd.' }), '\n', (0, t.jsx)(n.p, { children: 'Er is een uitzondering voor functies waarbij beweging gebruiken essentieel is, bijvoorbeeld voor een stappenteller.' })] });
   }
   function g(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
    return n ? (0, t.jsx)(n, { ...e, children: (0, t.jsx)(h, { ...e }) }) : h(e);
   }
   const u = { title: 'WCAG-succescriterium 2.5.4 Bewegingsactivering', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.4 Bewegingsactivering', pagination_label: 'WCAG-succescriterium 2.5.4 Bewegingsactivering', description: 'Als de gebruiker een actie kan uitvoeren door een beweging te doen met het apparaat, dan moet er ook een manier zijn om die actie te doen zonder beweging. Niet iedereen kan bijvoorbeeld schudden met een mobiel.', slug: '2.5.4', keywords: ['WCAG'] },
    p = void 0,
    m = { id: 'wcag/2.5.04', title: 'WCAG-succescriterium 2.5.4 Bewegingsactivering', description: 'Als de gebruiker een actie kan uitvoeren door een beweging te doen met het apparaat, dan moet er ook een manier zijn om die actie te doen zonder beweging. Niet iedereen kan bijvoorbeeld schudden met een mobiel.', source: '@site/docs/wcag/2.5.04.mdx', sourceDirName: 'wcag', slug: '/wcag/2.5.4', permalink: '/wcag/2.5.4', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.5.04.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.5.4 Bewegingsactivering', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.4 Bewegingsactivering', pagination_label: 'WCAG-succescriterium 2.5.4 Bewegingsactivering', description: 'Als de gebruiker een actie kan uitvoeren door een beweging te doen met het apparaat, dan moet er ook een manier zijn om die actie te doen zonder beweging. Niet iedereen kan bijvoorbeeld schudden met een mobiel.', slug: '2.5.4', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.5.3 Label in Naam', permalink: '/wcag/2.5.3' }, next: { title: 'WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)', permalink: '/wcag/2.5.5' } },
    j = {},
    v = [
  ...
  57716: (e, n, i) => {
   ...
   const o = (e, n) => {
    ...
    d = (e) => {
     ...
     return (0, s.jsx)(t.Z, { components: { ...c(i, r), ...l(o), ...a }, children: n });
    };
  },
  46364: (e, n, i) => {
   i.d(n, { j: () => o });
