 ...
 [33430],
 {
  ...
  35038: (e, t, n) => {
   ...
   const o = (e) => {
     ...
     return (0, c.jsx)('div', { className: (0, s.Z)('card__illustration', t && 'card__illustration--background', r), ...o, children: n });
    },
    ...
    a = (e) => {
     ...
     const l = (e) => ('article' === i ? (0, c.jsx)('article', { ...e }) : 'section' === i ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      d = (0, c.jsx)(l, { className: (0, s.Z)('cardgroup__card', `cardgroup__card--${n}`, o), children: a });
     return t ? (0, c.jsx)(r.rU, { href: t, boxContent: !0, className: 'cardgroup__link', children: d }) : d;
    },
    l = (e) => {
  ...
  76233: (e, t, n) => {
   ...
   const a = (e) => {
    ...
    d = (e) => {
     ...
     return (0, i.jsx)(c.Suspense, {
      fallback: null,
      children: (0, i.jsxs)('figure', {
       className: (0, s.Z)('component-anatomy'),
       children: [
        d && (0, i.jsx)(d, { height: null, className: (0, s.Z)('component-anatomy__illustration') }),
        d &&
         j &&
         (0, i.jsx)('figcaption', {
  ...
  8657: (e, t, n) => {
   ...
   var r = n(41115),
    ...
    l = n(32636),
    d = n(52676);
   const u = { figma: (0, d.jsx)(c.Z, {}), github: (0, d.jsx)(o.Z, {}), npm: (0, d.jsx)(i.Z, {}), storybook: (0, d.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
            ...
            j.Zb,
            {
             ...
             children: (0, d.jsxs)(j.aY, {
              children: [
               ...
               (i.length > 0 || c.length > 0) && (0, d.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               i.length > 0 &&
                (0, d.jsx)(d.Fragment, {
  ...
  41757: (e, t, n) => {
   ...
   var r = n(4814),
    s = n(52676);
   const c = (e) => {
    let { children: t, className: n, level: c = 1, suffix: o, ...i } = e;
    return (0, s.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${c}`, n), ...i, children: [(0, s.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), o && (0, s.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
   };
  },
  57716: (e, t, n) => {
   'use strict';
   ...
   const o = (e, t) => {
    ...
    i = { 1: {}, 2: { h1: s.XJ, h2: s.aC, h3: s.k8, h4: s.by, h5: s.Cd }, 3: { h1: s.aC, h2: s.k8, h3: s.by, h4: s.Cd, h5: s.Cd }, 4: { h1: s.k8, h2: s.by, h3: s.Cd, h4: s.Cd, h5: s.Cd }, 5: { h1: s.by, h2: s.Cd, h3: s.Cd, h4: s.Cd, h5: s.Cd }, 6: { h1: s.Cd, h2: s.Cd, h3: s.Cd, h4: s.Cd, h5: s.Cd } },
    a = (e) => ({
     img: (t) => {
      let { src: n, ...r } = t;
      return (0, c.jsx)('img', { ...r, src: o(e, n), className: 'utrecht-img utrecht-img--fit' });
     },
    }),
    l = (e, t) => {
     if (e) {
    ...
    d = (e) => {
     let { children: t, omitH1: n = !1, headingLevel: s = 1, baseUrl: o = '', components: i = {} } = e;
     return (0, c.jsx)(r.Z, { components: { ...l(n, s), ...a(o), ...i }, children: t });
    };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => g, BA: () => i, Ee: () => d, Q6: () => c, U: () => j, Yr: () => p, d: () => u, e9: () => o, fO: () => k, mA: () => s, ps: () => m, qU: () => b, s0: () => v, zP: () => y });
    ...
    m = (e) => {
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        let { name: s, id: c, value: o } = r;
        const i = /^(.+) URL/.exec(s)[1],
         a = 'Storybook' === i ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${i}`;
        return { brand: i.toLowerCase(), name: s, id: c, value: o, description: a };
       });
