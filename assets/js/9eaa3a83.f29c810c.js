      ...
      (0, a.jsxs)(a.Fragment, {
       children: [
        ...
        (0, a.jsxs)(E, {
         ...
         children: [e.lazyLoad && !o && (0, a.jsx)('img', { src: y, alt: `${u} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !o && (0, a.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && o) && (0, a.jsx)('button', { type: 'button', className: W, 'aria-label': `${p} ${u}`, 'aria-hidden': o || void 0, tabIndex: o ? -1 : 0, onClick: G, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: p }) }), o && (0, a.jsx)('iframe', { ref: n, className: L, title: u, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
