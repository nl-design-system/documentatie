 ...
 [94192],
 {
  ...
  76275(e, n, t) {
   ...
   const G = [
     ...
     { title: 'Het label van de Skip Link bestaat uit tekst, niet uit een afbeelding van tekst.', sc: '1.4.5', status: '', component: T.Ay, tags: ['developer', 'contentmaker'] },
    ...
    N = [
     ...
     { title: 'Als je de hele webpagina inzoomt tot 400% veroorzaakt de Skip Link geen horizontale scrollbalk en blijft alle tekst op de pagina leesbaar.', sc: '1.4.10', status: '', component: C.Ay, tags: ['developer', 'designer'] },
     {
  ...
  84471(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => u, mJ: () => h, VZ: () => A, cR: () => b, Pv: () => k, qZ: () => a, kD: () => w, QQ: () => C, B2: () => m, Pc: () => l, f4: () => o, GT: () => v, fX: () => r, eQ: () => x, B_: () => f, o_: () => j });
