(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [88474],
 {
  ...
  99781: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => S, component: () => V, contentTitle: () => L, default: () => E, description: () => M, frontMatter: () => Z, issueNumber: () => P, metadata: () => _, title: () => F, toc: () => D });
   var r,
    s,
    o,
    i,
   ...
   const Z = { title: 'Code', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code', pagination_label: 'Code', description: 'Computercode die onderdeel is van lopende tekst.', slug: '/code', keywords: ['actie', 'action', 'code', 'codeblock', 'code block', 'code markering', 'code fences', 'code snippet', 'code voorbeeld', 'coded language', 'codetaal', 'css', 'example', 'html', 'java', 'inline code', 'mono', 'monotype', 'monospace', 'plaintext', 'pre', 'samp', 'source code', 'src', 'voorbeeld'] },
    ...
    F = 'Code',
    M = 'Computercode die onderdeel is van lopende tekst.',
    P = 326,
    V = m.find((e) => e.number === P);
   function O(e) {
    ...
    return (0, h.jsxs)(h.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, h.jsx)(W.Rv, { component: V, headingLevel: 1, description: M }),
      '\n',
      ...
      (0, h.jsx)(G.t, {
       ...
       items: [
        { title: 'De tekst, gemarkeerd als code, is niet alleen herkenbaar aan een andere achtergrondkleur', sc: '1.4.1', status: '', component: (0, h.jsx)(b.ZP, {}) },
  ...
  94443: (e, t, n) => {
   ...
   const A = (e) => {
     ...
     const o = t && t.projects.filter((e) => f.e9.includes(e.id)),
      i = o && f.e9.map((e) => o.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, d.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, d.jsx)(y, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(v, { headingLevel: n + 1, checked: t, title: r, description: (0, f.Q6)(s) }, s);
            }),
           }),
               ...
               o.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: o.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: n + 2, children: [s, ' in ', t] }), (0, d.jsx)(r.Mc, { links: o.map((e) => ({ children: e.description, icon: (0, d.jsx)(u, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => c, Ee: () => d, Q6: () => o, U: () => m, d: () => h, e9: () => i, mA: () => s, ps: () => g });
