 ...
 [97366],
 {
  ...
  98480: (e, n, l) => {
   ...
   const h = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (C = await a.ZP.format(Z, { parser: x, plugins: [o.Z, i.ZP, r.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), D(C);
     })();
    }, [Z]);
    const R = (0, d.useId)();
    let z = d.Fragment;
    ...
    return (
     ...
     (0, i.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsx)(s.dn, { tabIndex: 0, style: l, children: t.map((e, l) => (0, i.jsxs)('span', { ...o({ line: e }), children: [n && (0, i.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const a = (e) => {
    ...
    const u = 'Doen',
     ...
     m = p ? 'figure' : 'div',
     _ = p ? 'figcaption' : 'div';
    return (0, c.jsxs)(m, { className: (0, i.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(_, { className: (0, i.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(o.nv, { className: (0, i.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: g })] }), (0, c.jsx)(o.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(o.nv, { className: (0, i.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: u })] }), (0, c.jsx)(o.nv, { children: n })] }), a] }), (0, c.jsx)('div', { className: (0, i.Z)(r['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => i });
