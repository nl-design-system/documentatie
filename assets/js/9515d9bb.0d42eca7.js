...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [58586],
 {
  ...
  49927(e, n, t) {
   (t.r(n), t.d(n, { assets: () => p, contentTitle: () => g, default: () => f, frontMatter: () => h, metadata: () => i, toc: () => j }));
   const i = JSON.parse('{"id":"richtlijnen/formulieren/button/placement/index","title":"Plaatsing van een button binnen een formulier","description":"Richtlijnen voor plaatsing van een button binnen een formulier.","source":"@site/docs/richtlijnen/formulieren/button/3-placement/index.mdx","sourceDirName":"richtlijnen/formulieren/button/3-placement","slug":"/richtlijnen/formulieren/buttons/plaatsing","permalink":"/richtlijnen/formulieren/buttons/plaatsing","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/button/3-placement/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Plaatsing van een button binnen een formulier","title_sm":"Plaatsing button","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Plaatsing button","pagination_label":"Plaatsing button","description":"Richtlijnen voor plaatsing van een button binnen een formulier.","slug":"/richtlijnen/formulieren/buttons/plaatsing","keywords":["labels","formulier","design","code"]},"sidebar":"richtlijnen","previous":{"title":"Verstuur niet automatisch","permalink":"/richtlijnen/formulieren/buttons/niet-automatisch-versturen"},"next":{"title":"Duidelijke buttontekst","permalink":"/richtlijnen/formulieren/buttons/duidelijk-buttontekst"}}');
   var r = t(86070),
    s = t(18439),
    o = t(78734);
   function l(e) {
   ...
   const h = { title: 'Plaatsing van een button binnen een formulier', title_sm: 'Plaatsing button', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Plaatsing button', pagination_label: 'Plaatsing button', description: 'Richtlijnen voor plaatsing van een button binnen een formulier.', slug: '/richtlijnen/formulieren/buttons/plaatsing', keywords: ['labels', 'formulier', 'design', 'code'] },
    g = void 0,
    p = {},
