 ...
 [21229],
 {
  ...
  60851: (e, n, t) => {
   ...
   const D = (e) => {
     ...
     const o = n && n.projects.filter((e) => S.e9.includes(e.id)),
      c = o && S.e9.map((e) => o.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
