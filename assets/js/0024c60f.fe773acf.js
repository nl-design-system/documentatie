/*! For license information please see 0024c60f.fe773acf.js.LICENSE.txt */
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [73512],
 {
  ...
  4398(e, n, t) {
   'use strict';
   t.d(n, { B2: () => u, B_: () => v, GT: () => w, KF: () => h, Pc: () => l, Pv: () => g, Rc: () => k, bo: () => r, eQ: () => y, f4: () => s, fX: () => o, kD: () => f, mJ: () => p, o_: () => j, qZ: () => i });
   ...
   const d = (e) => [...e].sort((e, n) => a.indexOf(e) - a.indexOf(n)),
    ...
    p = (e) => d(c(e.projects.flatMap((e) => m(e)))),
    g = (e) => {
     const n = m(e),
      t = ((e) => {
  ...
  9277(e, n, t) {
   ...
   function D(e = {}) {
    const { wrapper: n } = { ...(0, u.R)(), ...e.components };
    return n ? (0, h.jsx)(n, { ...e, children: (0, h.jsx)(M, { ...e }) }) : M(e);
   }
   function _(e) {
    const n = { a: 'a', code: 'code', li: 'li', p: 'p', ul: 'ul', ...(0, u.R)(), ...e.components };
   ...
   function ne(e) {
    ...
    return (0, h.jsxs)(h.Fragment, {
     children: [
      ...
      '\n',
      (0, h.jsx)(I.B, { tokens: U }),
      '\n',
      (0, h.jsx)(B.o, { omitH1: !0, headingLevel: 3, children: (0, h.jsx)(V, {}) }),
      '\n',
      ...
      (0, h.jsx)(E.b, {
       ...
       items: [
        ...
        { title: 'Het kleurcontrast van de tekst van de eigenschappen van de Color Sample is voldoende.', sc: '1.4.3', status: '', component: (0, h.jsx)(L.Ay, {}), tags: ['contentmaker', 'designer'] },
        { title: 'Als je de beschrijvende tekst bij een Color Sample vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: (0, h.jsx)(O, {}), tags: ['developer'] },
        ...
        { title: 'Als je de tekstafstand van de beschrijvende tekst bij een Color Sample vergroot blijft de tekst in zijn geheel zichtbaar.', sc: '1.4.12', status: '', component: (0, h.jsx)(D, {}), tags: ['developer'] },
       ],
      }),
      '\n',
