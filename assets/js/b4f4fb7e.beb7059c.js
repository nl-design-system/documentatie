 ...
 [26347],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    h = n(86070);
   const l = { figma: (0, h.jsx)(s.A, {}), github: (0, h.jsx)(c.A, {}), npm: (0, h.jsx)(i.A, {}), storybook: (0, h.jsx)(o.A, {}) },
    u = ({ brand: e }) => (0, h.jsx)(r.In, { children: l[e] || (0, h.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => d, mJ: () => y, VZ: () => _, cR: () => w, Pv: () => p, qZ: () => i, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => k, fX: () => c, eQ: () => b, B_: () => v, o_: () => m, Rc: () => x });
  ...
  44594(e, t, n) {
   ...
   const o = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    a = ({ name: e, relayStep: t, description: n }) => {
     const a = (0, c.fX)(t),
      h = o[e] ?? e;
     return (0, i.jsxs)(r.WK, { children: [(0, i.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, s.A)('component-illustration', `component-illustration--${a}`), fill: 'none', children: [(0, i.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, i.jsx)('rect', { width: '960', height: '540' }), (0, i.jsx)('rect', { width: '960', height: '540' })] }), (0, i.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, i.jsx)('use', { href: `/svg/componenten_overzicht_${(0, c.fX)(h)}.svg#component-illustration` })] }), (0, i.jsx)(r.$P, { className: 'component-illustration__caption', children: n })] });
    };
  },
  54565(e, t, n) {
   'use strict';
  ...
  55387(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => u, component: () => m, componentName: () => p, contentTitle: () => l, default: () => f, description: () => j, frontMatter: () => h, issueNumber: () => g, metadata: () => r, relayStep: () => y, title: () => d, toc: () => v }));
   const r = JSON.parse('{"id":"componenten/progress-bar/index","title":"Progress Bar","description":"Toont de voortgang van een proces in een balk.","source":"@site/docs/componenten/progress-bar/index.mdx","sourceDirName":"componenten/progress-bar","slug":"/progress-bar","permalink":"/progress-bar","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/progress-bar/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Progress Bar","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Progress Bar","pagination_label":"Progress Bar","description":"Toont de voortgang van een proces in een balk.","slug":"/progress-bar","keywords":["balk","balkindicator","linear progress","meter","progress","progressbalk","progress bar","progress indicator","progress loader","status","steps","voortgangsbalk"]},"sidebar":"componenten","previous":{"title":"Password Input","permalink":"/password-input"},"next":{"title":"Progress Circle","permalink":"/progress-circle"}}');
   var s = n(86070),
    c = n(18439),
    i = n(87069),
    o = n(85825),
    a = n(44594);
   const h = { title: 'Progress Bar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress Bar', pagination_label: 'Progress Bar', description: 'Toont de voortgang van een proces in een balk.', slug: '/progress-bar', keywords: ['balk', 'balkindicator', 'linear progress', 'meter', 'progress', 'progressbalk', 'progress bar', 'progress indicator', 'progress loader', 'status', 'steps', 'voortgangsbalk'] },
    l = void 0,
    u = {},
    d = 'Progress Bar',
   ...
   function b(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, s.jsx)(o.Fc, { component: m, headingLevel: 1, description: j }), '\n', (0, s.jsx)(a.s, { relayStep: y, description: `Schets van de ${p} component`, name: p }), '\n', (0, s.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, s.jsx)(o.VK, { component: m, headingLevel: 3 }), '\n', (0, s.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, s.jsx)(o.mu, { component: m, headingLevel: 3 }), '\n', (0, s.jsx)(o.$9, { component: m, headingLevel: 2 })] });
   }
   function f(e = {}) {
    const { wrapper: t } = { ...(0, c.R)(), ...e.components };
    return t ? (0, s.jsx)(t, { ...e, children: (0, s.jsx)(b, { ...e }) }) : b(e);
   }
  },
  67970(e, t, n) {
   'use strict';
  ...
  85825(e, t, n) {
   ...
   var u = n(67970),
    ...
    j = n(46447),
    g = n(45561);
   const y = ({ children: e }) => (0, h.jsx)('ul', { className: 'task-list', children: e }),
    p = ({ checked: e, children: t, title: n, description: r, headingLevel: c = 3 }) => (0, h.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, h.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, h.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, h.jsx)(g.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, h.jsxs)('div', { children: [n ? (0, h.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: c, children: n }) : null, r, t] })] });
   var m = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => m.f4.includes(e.id)),
      c = n && m.f4.map((e) => n.find((t) => t.id === e)).filter(Boolean);
     return e && (0, h.jsx)(r.If, { sections: c.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, m.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(y, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, h.jsx)(p, { headingLevel: t + 1, checked: e, title: n, description: (0, m.qZ)(r) }, r)) }), (0, h.jsx)(r.fz, { children: (0, h.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            i.Zp,
            {
             ...
             children: (0, h.jsxs)(i.Wu, {
              children: [
               ...
               o.length > 0 && (0, h.jsx)(h.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, h.jsxs)(h.Fragment, { children: [(0, h.jsxs)(r.DZ, { level: t + 2, children: [s, ' in ', e] }), (0, h.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, h.jsx)(c.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    f = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(r.DZ, { level: t, children: 'Help om deze component te verbeteren' }), (0, h.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, h.jsxs)(r.Xy, { children: [s ? (0, h.jsxs)(r.Er, { children: ['Vul de ', (0, h.jsx)(r.N_, { href: s, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, h.jsxs)(r.Er, { children: [(0, h.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, h.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, h.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, h.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    k = ({ component: e, headingLevel: t, description: n }) => {
     const s = e && m.bo[e.relayStep];
     return e && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(d.p, { level: t, suffix: s && (0, h.jsx)(u.D, { state: s }), children: e.title }), (0, h.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
   n.d(t, { AC: () => h, Fu: () => i, Wu: () => o, Zp: () => a });
   var r = n(46447),
    s = n(13526),
    c = n(86070);
   const i = ({ background: e, children: t, className: n, ...r }) => (0, c.jsx)('div', { className: (0, s.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: i = 'div', background: o, children: a }) => {
     const h = (e) => ('article' === i ? (0, c.jsx)('article', { ...e }) : 'section' === i ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      l = (0, c.jsx)(h, { className: (0, s.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, c.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    h = ({ appearance: e = 'medium', children: t, className: n }) => (0, c.jsx)('div', { className: (0, s.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
 },
]);
