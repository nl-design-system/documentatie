...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [48158],
 {
  ...
  43599: (e, n, a) => {
   ...
   const b = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(t.Tg, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(t.BB, { className: (0, l.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, h.jsx)(t.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   b.displayName = 'ParagraphContainer';
   const m = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(t.Tg, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(t.BB, { className: (0, l.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const u = (e) => {
    let { code: n, copy: a = !0, defaultExpandedCode: u = !1, displayCode: j = !0, children: k, container: x = 'document', language: y, designTokens: f } = e;
    ...
    (0, g.useEffect)(() => {
     (async () => {
      const e = await c.ZP.format(N, { parser: y, plugins: [r.Z, i.ZP, d.ZP, s.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      G(e);
     })();
    }, [N]);
    const D = (0, g.useId)();
    let S = g.Fragment;
    return (
     'paragraph' === x ? (S = b) : 'document' === x ? (S = m) : 'surface' === x && (S = p),
     (0, h.jsxs)('div', {
      className: (0, l.Z)('nlds-canvas'),
      children: [
       _ && (0, h.jsx)('div', { className: (0, l.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(S, { children: (0, h.jsx)(t.pu, { children: _ }) }) }) }),
       j &&
        (0, h.jsx)('div', {
       ...
       j &&
        (0, h.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, h.jsx)(o.u, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: z, trim: !0 }),
          a &&
           (0, h.jsx)('div', {
  ...
  41179: (e, n, a) => {
   ...
   var d = a(52676);
   function s(e) {
    let { lineNumber: n, syntax: a, textContent: s, trim: c } = e,
     g = s;
    ...
    return (
     ...
     (0, d.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)('span', { hidden: !0, id: b, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', v ? ': ' : ' ', v] }), (0, d.jsx)(o.dn, { tabIndex: 0, role: v ? 'region' : void 0, 'aria-labelledby': b, style: a, children: t.map((e, a) => (0, d.jsxs)('span', { ...l({ line: e }), children: [n && (0, d.jsx)('span', { children: a + 1 }), e.map((e, n) => (0, d.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, a)) })] });
      },
     })
    );
   }
   ...
   const s = (0, i.createContext)({}),
    c = (e) => {
     ...
     const v = { do: 'Doen', dont: 'Niet doen' },
      h = g ? 'figure' : 'div',
      b = g ? 'figcaption' : 'div';
     return (0, d.jsxs)(h, { className: (0, r.Z)('nlds-guideline', `nlds-guideline--${a}`), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(b, { className: 'nlds-guideline__description', children: ['dont' === a ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(l.nv, { className: (0, r.Z)('nlds-guideline__badge', `nlds-guideline__badge--${a}`), children: [(0, d.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: v.dont })] }), (0, d.jsx)(l.nv, { children: n })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(l.nv, { className: (0, r.Z)('nlds-guideline__badge', `nlds-guideline__badge--${a}`), children: [(0, d.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: v.do })] }), (0, d.jsx)(l.nv, { children: n })] }), i] }), (0, d.jsx)('div', { className: 'nlds-guideline__example', children: (0, d.jsx)(s.Provider, { value: { title: n, type: v[a] }, children: c }) })] });
    };
  },
  40139: (e, n, a) => {
   a.d(n, { Z: () => i, a: () => r });
