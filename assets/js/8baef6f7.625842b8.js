...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [41102],
 {
  ...
  15214(e, n, t) {
   (t.r(n), t.d(n, { assets: () => H, component: () => M, contentTitle: () => I, default: () => O, description: () => B, frontMatter: () => S, issueNumber: () => P, metadata: () => i, title: () => _, toc: () => E }));
   ...
   const D = [
     ...
     { title: 'Als een Icon een status aangeeft, is die informatie niet alleen afhankelijk van kleur.', sc: '1.4.1', status: '', component: C.Ay, tags: ['designer'] },
     {
     ...
     { title: 'Een informatief Icon heeft een contrastratio van minimaal 3:1 met de achtergrond.', sc: '1.4.11', status: '', component: w.Ay, tags: ['designer', 'contentmaker'] },
     { title: 'De Icon is niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: y.Ay, tags: ['developer'] },
     { title: 'De Icon komt niet voor in de normale focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: z.Ay, tags: ['developer'] },
     {
  ...
  32385(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => A, cR: () => x, Pv: () => j, qZ: () => a, kD: () => b, QQ: () => C, B2: () => m, Pc: () => l, f4: () => s, GT: () => k, fX: () => o, eQ: () => w, B_: () => v, o_: () => f });
  ...
  70348(e, n, t) {
   ...
   const l = (0, r.forwardRef)(({ as: e, className: n, children: t, ...r }, o) => {
    ...
    c = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: l, headingApperance: c, ...d }) => {
     ...
     return (0, s.jsxs)('details', { className: g, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(o.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(a.D, { level: l, appearance: c, children: r }), t] })] }) }), (0, s.jsx)('div', { className: u, children: d.children })] });
    };
  },
  70561(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => o });
  ...
  82024(e, n, t) {
   ...
   const w = ({ component: e, headingLevel: n }) => {
            ...
            ? (0, d.jsx)(
               c.Z,
               {
                ...
                description: (0, d.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, d.jsxs)(o.f, { children: [(0, d.jsx)(g, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, d.jsxs)(i.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, d.jsxs)('div', {
                   children: [
                    (h.length > 0 || u.length > 0) && (0, d.jsx)(r.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    h.length > 0 &&
                     (0, d.jsx)(i.dk, {
                      links: h
                  ...
                  u.length > 0 && u.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)('section', { children: [(0, d.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, d.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, d.jsxs)(l.Wu, {
                 children: [
                  ...
                  (h.length > 0 || u.length > 0) && (0, d.jsx)(i.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  h.length > 0 &&
                   (0, d.jsx)(d.Fragment, {
                  ...
                  u.length > 0 && (0, d.jsx)(d.Fragment, { children: u.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(i.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, d.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    x = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: r && (0, d.jsx)(u.D, { state: r }), children: e.title }), (0, d.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(r) && (0, d.jsx)(v.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    A = ({ component: e }) => {
     const n = (e && j[e.title]) || [];
