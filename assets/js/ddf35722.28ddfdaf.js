...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [30722],
 {
  ...
  28768(e, n, t) {
   (t.r(n), t.d(n, { assets: () => S, component: () => C, contentTitle: () => N, default: () => B, description: () => H, frontMatter: () => A, issueNumber: () => z, metadata: () => a, title: () => T, toc: () => R }));
   ...
   const D = [
     ...
     { title: 'De kleur van het Form Field Label geeft geen informatie die niet ook op minimaal 1 andere manier wordt gegeven.', sc: '1.4.1', status: '', component: x.Ay, tags: ['designer'] },
  ...
  76097(e, n, t) {
   t.d(n, { bo: () => i, KF: () => u, mJ: () => h, VZ: () => w, cR: () => F, Pv: () => j, qZ: () => o, kD: () => k, B2: () => m, Pc: () => s, f4: () => l, GT: () => v, fX: () => r, eQ: () => x, B_: () => f, o_: () => b });
