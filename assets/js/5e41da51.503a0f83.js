...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [39311],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => a, KF: () => m, mJ: () => u, VZ: () => A, cR: () => _, Pv: () => f, qZ: () => i, kD: () => b, B2: () => p, Pc: () => l, f4: () => o, GT: () => w, fX: () => s, eQ: () => v, B_: () => x, o_: () => j, Rc: () => k });
  ...
  37991(e, n, t) {
   (t.r(n), t.d(n, { assets: () => h, component: () => j, componentName: () => f, contentTitle: () => c, default: () => b, description: () => p, frontMatter: () => d, issueNumber: () => g, metadata: () => r, relayStep: () => u, title: () => m, toc: () => x }));
   ...
   const d = { title: 'Drawer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Drawer', pagination_label: 'Drawer', description: 'Een paneel aan de zijkant van een scherm, die geopend kan worden voor gerelateerde informatie, formulieren of acties.', slug: '/drawer', keywords: ['drawer', 'flyout', 'paneel', 'schuifpaneel', 'side panel', 'side sheet', 'tray'] },
    ...
    h = {},
    m = 'Drawer',
    p = 'Een paneel aan de zijkant van een scherm, die geopend kan worden voor gerelateerde informatie, formulieren of acties.',
    g = 256,
    u = 'help wanted',
    f = 'drawer',
