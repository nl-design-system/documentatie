/*! For license information please see a6aa9e1f.330a3a14.js.LICENSE.txt */
'use strict';
 ...
 [93089],
 {
   ...
   const h = (e) => {
    ...
    return (0, o.jsxs)(o.Fragment, {
     children: [
      ...
      g && (0, o.jsx)('div', { className: (0, c.Z)('breadcrumbs', 'breadcrumbs--mobile'), children: (0, o.jsx)(i.hE, { children: (0, o.jsxs)(t.Z, { href: g.href, rel: g.rel, className: 'utrecht-link utrecht-link--html-a', children: [(0, o.jsx)(i.JO, { children: (0, o.jsx)(l.Z, {}) }), g.label] }) }) }),
     ],
    });
   };
  },
  ...
  62987: (e, a, s) => {
   ...
   function u(e) {
    ...
    return (0, m.jsxs)(h.Z, { sidebar: t, breadcrumbs: [{ label: a.blogTitle }], children: [(0, m.jsx)(d.nL, { children: a.blogTitle }), (0, m.jsx)(i.Z, { items: s }), (0, m.jsx)(l.Z, { metadata: a })] });
   }
   function p(e) {
  ...
  67032: (e, a, s) => {
   ...
   var t = s(90441),
    ...
    n = s(35038),
    l = s(4839),
    i = (0, s(69804).Z)('outline', 'calendar', 'IconCalendar', [
  ...
  4839: (e, a, s) => {
   s.d(a, { Z: () => t });
   var t = (0, s(69804).Z)('outline', 'user', 'IconUser', [
