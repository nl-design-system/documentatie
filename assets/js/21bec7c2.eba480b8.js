 ...
 [9198],
 {
  ...
  24703(e, n, i) {
   ...
   const l = (e, n) => {
    ...
    o = (e) => ({ img: ({ src: n, ...i }) => (0, t.jsx)('img', { ...i, src: l(e, n), className: 'utrecht-img utrecht-img--fit' }) }),
    d = (e, n) => {
     if (e) {
      const e = { ...a[n - 1] };
      return ((e.h1 = () => null), e);
    ...
    c = ({ children: e, omitH1: n = !1, headingLevel: i = 1, baseUrl: s = '', components: l = {} }) => (0, t.jsx)(r.x, { components: { ...d(n, i), ...o(s), ...l }, children: e });
  },
  25431(e, n, i) {
   i.d(n, { Ay: () => a, RM: () => t });
   var r = i(86070),
  ...
  61399(e, n, i) {
   (i.r(n), i.d(n, { assets: () => j, contentTitle: () => p, default: () => k, frontMatter: () => g, metadata: () => r, toc: () => v }));
   const r = JSON.parse('{"id":"wcag/2.4.05","title":"WCAG-succescriterium 2.4.5 Meerdere manieren","description":"Een webpagina is op meerdere manieren te vinden.","source":"@site/docs/wcag/2.4.05.mdx","sourceDirName":"wcag","slug":"/wcag/2.4.5","permalink":"/wcag/2.4.5","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.05.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 2.4.5 Meerdere manieren","title_sm":"2.4.5 Meerdere manieren","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"2.4.5 Meerdere manieren","pagination_label":"WCAG-succescriterium 2.4.5 Meerdere manieren","description":"Een webpagina is op meerdere manieren te vinden.","slug":"2.4.5","conformance_level":"Niveau AA","keywords":["WCAG","AA","bedienbaar","navigeerbaar","operable","navigable","multiple ways"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 2.4.4 Linkdoel (in context)","permalink":"/wcag/2.4.4"},"next":{"title":"WCAG-succescriterium 2.4.6 Koppen en labels","permalink":"/wcag/2.4.6"}}');
   var s = i(86070),
    t = i(18439),
    l = i(24703),
    a = i(61473),
   ...
   const g = { title: 'WCAG-succescriterium 2.4.5 Meerdere manieren', title_sm: '2.4.5 Meerdere manieren', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.5 Meerdere manieren', pagination_label: 'WCAG-succescriterium 2.4.5 Meerdere manieren', description: 'Een webpagina is op meerdere manieren te vinden.', slug: '2.4.5', conformance_level: 'Niveau AA', keywords: ['WCAG', 'AA', 'bedienbaar', 'navigeerbaar', 'operable', 'navigable', 'multiple ways'] },
    p = void 0,
    j = {},
  ...
  66119(e, n, i) {
   ...
   const l = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: s, ...l }, a) => {
    const o = { ...l, ref: a, className: t('utrecht-note', { [`utrecht-note--${s}`]: s }, i) };
