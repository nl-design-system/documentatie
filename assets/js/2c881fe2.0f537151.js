 ...
 [94810],
 {
  ...
  6360(e, n, t) {
   ...
   var u = (0, a.forwardRef)(function (e, n) {
    ...
    if (
     ...
     var c = i.dateTime,
      u = (0, r.A)(i, l);
     return (0, s.jsx)('time', g(g({}, u), {}, { dateTime: c, className: a, ref: n, children: t }));
    }
    if (
     (function (e) {
      return 'value' in e;
     ...
     var m = i.value,
      p = (0, r.A)(i, d);
     return (0, s.jsx)('data', g(g({}, p), {}, { value: m, className: a, ref: n, children: t }));
    }
    return (0, s.jsx)('span', g(g({}, i), {}, { className: a, ref: n, children: t }));
   });
  ...
  48262(e, n, t) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, u.jsx)(b.n, { children: r.map((t) => (0, u.jsx)(b.K, { className: (0, a.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, w.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(f._, { children: t.tasks.map(({ checked: e, name: t, id: i }) => (0, u.jsx)(f.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, w.qZ)(i) }, i)) }), (0, u.jsx)(i.fz, { children: (0, u.jsxs)(i.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
            ...
            ? (0, u.jsx)(
               d.Z,
               {
                ...
                description: (0, u.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, u.jsxs)(s.f, { children: [(0, u.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(i.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, u.jsxs)('div', {
                   children: [
                    (p.length > 0 || c.length > 0) && (0, u.jsx)(r.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    p.length > 0 &&
                     (0, u.jsx)(i.dk, {
                      links: p
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)('section', { children: [(0, u.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, u.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(o.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
    ...
    k = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(i.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, u.jsxs)(i.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, u.jsxs)(i.Xy, { children: [r ? (0, u.jsxs)(i.Er, { children: ['Vul de ', (0, u.jsx)(i.N_, { href: r, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, u.jsxs)(i.Er, { children: [(0, u.jsxs)(i.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, u.jsxs)(i.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, u.jsx)(i.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, u.jsx)(i.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    y = ({ component: e, headingLevel: n, description: t }) => {
     const r = e && w.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(h.p, { level: n, suffix: r && (0, u.jsx)(p.D, { state: r }), children: e.title }), (0, u.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(r) && (0, u.jsx)(x.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    C = ({ component: e }) => {
     const n = (e && j[e.title]) || [];
    ...
    m =
     ...
     (0, o.forwardRef)(function (e, n) {
      var t = e.children,
       ...
       y = (0, r.A)(e, l),
       C = Boolean(m || g),
       T = (o.Children.toArray(t).some(o.isValidElement) && C) || d;
      return (0, s.jsxs)('button', c(c({ ref: n, type: v, className: (0, a.$)('nl-button', i, { 'nl-button--pressed': j, 'nl-button--busy': b, 'nl-button--disabled': f || w, 'nl-button--primary': 'primary' === p, 'nl-button--secondary': 'secondary' === p, 'nl-button--subtle': 'subtle' === p, 'nl-button--positive': u(p) && 'positive' === h, 'nl-button--negative': u(p) && 'negative' === h, 'nl-button--icon-only': d }), 'aria-pressed': k ? String(Boolean(j)) : void 0, 'aria-disabled': f || b ? 'true' : void 0, disabled: w }, y), {}, { children: [m && (0, s.jsx)('span', { className: 'nl-button__icon-start', children: m }), A && (0, s.jsx)('span', { className: 'nl-button__label', children: A }), T ? (0, s.jsx)('span', { className: d ? 'nl-button__label' : '', children: t }) : t, g && (0, s.jsx)('span', { className: 'nl-button__icon-end', children: g })] }));
     }));
  ...
  61994(e, n, t) {
   ...
   function l(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(n.p, { children: ['De Ordered List is herkenbaar voor hulpsoftware als geordende lijst omdat de component is opgemaakt met ', (0, r.jsx)(n.code, { children: 'ol' }), ' en ', (0, r.jsx)(n.code, { children: 'li' }), ' elementen.\nIn de browser Safari (', (0, r.jsx)(n.a, { href: '/baseline/2026-05/', children: 'NL Design System baseline mei 2026' }), ') verdwijnt de semantiek van de lijst zodra in CSS ', (0, r.jsx)(n.code, { children: 'list-style: none' }), ' wordt gebruikt. Daarom is de ARIA rol ', (0, r.jsx)(n.code, { children: 'list' }), ' toegevoegd.'] }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-html', children: '<ol role="list">\n  <li>List-item voorbeeld</li>\n  <li>List-item voorbeeld</li>\n  <li>List-item voorbeeld</li>\n  <li>List-item voorbeeld</li>\n</ol>\n' }) }), '\n', (0, r.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: (0, r.jsx)(n.a, { href: '/richtlijnen/content/tekstopmaak/opsommingen/', children: 'Toegankelijke opsommingen' }) }), '\n'] })] });
   }
   function d(e) {
    const n = { code: 'code', p: 'p', pre: 'pre', ...(0, s.R)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Er mag geen inhoud buiten beeld vallen, onbereikbaar of verborgen zijn of gedeeltelijk verborgen worden door andere inhoud wanneer de gebruiker 400% inzoomt of op een buitengewoon klein scherm werkt (320 bij 256 pixels).' }), '\n', (0, r.jsxs)(n.p, { children: ['Definieer in de CSS een wijze om lange woorden af te breken en te laten doorlopen op de volgende regel. Gebruik hiervoor bijvoorbeeld ', (0, r.jsx)(n.code, { children: 'overflow-wrap: break-word; hyphens: auto;' }), ' eventueel in combinatie met ', (0, r.jsx)(n.code, { children: 'text-wrap-style: balance' }), '. Zo ontstaat er geen horizontale scrollbar en wordt tekst niet onleesbaar. Doe dit bij voorkeur op ', (0, r.jsx)(n.code, { children: ':root' }), ' niveau.'] }), '\n', (0, r.jsx)(n.p, { children: 'Bij de Ordered List kan er informatie verloren gaan als het startgetal (de marker) veel ruimte inneemt. Bijvoorbeeld:' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-html', children: '<ol start="10000090">\n  <li>Hallo</li>\n  <li>Ik</li>\n  <li>Ben</li>\n  <li>Een</li>\n  <li>Lijst</li>\n</ol>\n' }) }), '\n', (0, r.jsxs)(n.p, { children: ['Een deel van het getal is dan niet meer zichtbaar. Je kunt dit oplossen door in CSS een grotere ', (0, r.jsx)(n.code, { children: 'margin-inline-start' }), ' te gebruiken voor Ordered Lists met brede markers.'] })] });
   }
   var c = t(54672),
    g = t(37166),
    u = t(53971),
   ...
   function w(e) {
    const n = { a: 'a', code: 'code', li: 'li', p: 'p', pre: 'pre', ul: 'ul', ...(0, s.R)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(n.p, { children: ['Als een tekst in een andere taal is dan de taal van de pagina, dan heeft het element een ', (0, r.jsx)(n.code, { children: 'lang' }), '-attribuut met de juiste taalcode.'] }), '\n', (0, r.jsx)(n.p, { children: 'Dit doe je op het parent-element wanneer de hele inhoud in een andere taal is geschreven, of op het child-element waarvan de inhoud in een andere taal is geschreven.' }), '\n', (0, r.jsx)(n.p, { children: 'Als de hele Ordered List in een andere taal is geschreven:' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-html', children: '<ol lang="en">\n  <li>First item</li>\n  <li>Second item</li>\n  <li>Third item</li>\n</ol>\n' }) }), '\n', (0, r.jsx)(n.p, { children: 'Als alleen de inhoud van \xe9\xe9n van de items in een andere taal is geschreven:' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-html', children: '<ol>\n  <li>Eerste item</li>\n  <li lang="en">Second item</li>\n  <li>Derde item</li>\n</ol>\n' }) }), '\n', (0, r.jsx)(n.p, { children: 'Of:' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-html', children: '<ol>\n  <li>Eerste item</li>\n  <li><p lang="en">Second item</p></li>\n  <li>Derde item</li>\n</ol>\n' }) }), '\n', (0, r.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: (0, r.jsx)(n.a, { href: '/richtlijnen/content/tekstopmaak/taal/', children: 'De juiste taal instellen' }) }), '\n'] })] });
   }
   const j = [
     { title: 'De Ordered List bestaat uit een list met list-items.', sc: '1.3.1', status: '', component: o.Ay, tags: ['developer'] },
     { title: 'De tekst en de tekstuele markers in de Ordered List hebben een contrastratio van minimaal 4,5:1 met de achtergrondkleur.', sc: '1.4.3', status: '', component: g.Ay, tags: ['designer'] },
     {
     ...
     { title: 'De Ordered List komt niet voor in de normale focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: f.Ay, tags: ['developer'] },
     {
    ...
    b = [
     ...
     { title: 'Tekst in de Ordered List blijft leesbaar wanneer de tekstafstand vergroot wordt. ', sc: '1.4.12', status: '', component: c.Ay, tags: ['developer'] },
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => h, VZ: () => k, cR: () => A, Pv: () => f, qZ: () => a, kD: () => x, QQ: () => C, B2: () => m, Pc: () => l, f4: () => o, GT: () => v, fX: () => s, eQ: () => b, B_: () => j, o_: () => w });
