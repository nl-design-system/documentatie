 ...
 [90258],
 {
  ...
  35038: (e, t, n) => {
   ...
   const s = (e) => {
    ...
    o = (e) => {
     let { href: t, appearance: n, className: s, component: a = 'div', background: o, children: l } = e;
     const u = (e) => ('article' === a ? (0, c.jsx)('article', { ...e }) : 'section' === a ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      h = (0, c.jsx)(u, { className: (0, i.Z)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, s), children: l });
        ...
        body:
         ...
         (0, u.jsxs)(u.Fragment, {
          children: [
           ...
           (0, u.jsx)(r.nv, { children: (0, u.jsxs)(r.rU, { href: `${e.url}?filterQuery=${t.title}`, children: [a(e), ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => m, BA: () => a, Ee: () => u, Q6: () => c, U: () => j, Yr: () => p, d: () => h, e9: () => s, fO: () => b, mA: () => i, ps: () => g, qU: () => k, s0: () => v, zP: () => y });
