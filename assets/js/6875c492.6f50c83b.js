 ...
 [18401, 83249, 84813],
 {
  ...
  21530(e, t, n) {
   ...
   const o = ({ background: e, children: t, className: n, ...s }) => (0, l.jsx)('div', { className: (0, r.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, n), ...s, children: t }),
    ...
    c = ({ appearance: e = 'large', children: t, className: n }) => (0, l.jsx)('div', { className: (0, r.A)('ma-cardgroup', `ma-cardgroup--${e}`, n), children: t });
  },
  21729(e, t, n) {
   'use strict';
   n.d(t, { A: () => E });
   ...
   var A = n(25557),
    ...
    k = n(85162),
    N = n(39569);
   const G = ({ name: e, description: t, relayStep: n, headingLevel: s = 2, href: r, frameworkNames: l }) => {
     return (0, i.jsxs)(b.Zp, { appearance: 'large', className: (0, g.A)('ma-component-card', !n && 'ma-component-card--suggestion'), component: 'section', children: [(0, i.jsx)(b.Fu, { children: (0, i.jsx)(k.s, { relayStep: n, description: `Schets van de ${e} component`, name: e }) }), (0, i.jsxs)(b.Wu, { children: [(0, i.jsxs)('div', { children: [(0, i.jsx)(T.D, { level: s, className: 'ma-component-card__title', children: e }), n && (0, i.jsx)('p', { children: (0, i.jsx)(N.D, { state: n }) }), t && (0, i.jsx)(C.f, { children: t }), l && (0, i.jsx)(m._Q, { children: l.map((e) => (0, i.jsx)(m.KE, { children: e }, e)) })] }), r && (0, i.jsx)(C.f, { children: (0, i.jsxs)(v.N, { className: 'utrecht-link', to: ((o = r), 'string' == typeof o && !1 === o.endsWith('/') ? `${o}/` : o), children: ['Bekijk ', (0, i.jsx)('span', { className: 'w', children: e }), ' component'] }) })] })] });
     var o;
    },
    _ = () => {
     const e = 'framework',
        ...
        (0, i.jsx)(b.AC, {
         ...
         children: d.map(({ title: e, id: t, href: n, description: s }) => {
          const r = y.find((t) => t.title === e),
           ...
           o = (0, j.mJ)(r);
          return (0, i.jsx)(G, { name: e, headingLevel: 2, href: n, description: s, relayStep: l, frameworkNames: o }, t);
         }),
        }),
       ],
      })
          ...
          (0, i.jsx)(x._Q, {
           ...
           children: l.map((e, t) => {
            ...
            if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
             const s = W.pI.get(e);
             n = (0, i.jsx)(v.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${s.sc} ${s.nl.title}`, style: { lineHeight: 1 }, children: (0, i.jsx)(R.K, { children: `WCAG ${e}` }) }, t);
            }
            return n;
           }),
          }),
   ...
   const F = ({ children: e }) => (0, i.jsx)('ol', { className: 'nlds-anatomy-list', children: e }),
    ...
    O = ({ title: e, sc: t, status: n, children: s, headingLevel: r = 4 }) => {
     const l = W.pI.get(t),
      o = l ? `${t} ${l.nl?.title}` : t;
    ...
    B = ({ testCategory: e, children: t }) => (0, i.jsx)(x.If, { sections: [{ className: 'utrecht-accordion--nlds-subtle', headingLevel: 3, expanded: !1, label: (0, i.jsx)('span', { children: e }), body: t }] });
   var I = n(58876);
       ...
       e.className?.includes('contains-task-list')
        ? (0, i.jsx)(I._, {
           children: (Array.isArray(e.children) ? e.children : [e.children]).filter(o.isValidElement).map((e) => {
            ...
            return (0, i.jsx)(I.Z, { checked: n.props.checked, description: [...s].join('') }, s.join(''));
           }),
          })
  ...
  32385(e, t, n) {
   'use strict';
   n.d(t, { bo: () => r, KF: () => h, mJ: () => p, VZ: () => v, cR: () => b, Pv: () => w, qZ: () => o, kD: () => x, QQ: () => C, B2: () => g, Pc: () => a, f4: () => i, GT: () => j, fX: () => l, eQ: () => y, B_: () => f, o_: () => A });
  ...
  94309(e, t, n) {
   ...
   const o = ({ children: e, ...t }) => {
     ...
     return ('https://nldesignsystem.nl' === a.origin ? (a.pathname.endsWith('/') || (0, r.QQ)(a.pathname) || (a.pathname = `${a.pathname}/`), (i = a.toString().replace('https://nldesignsystem.nl', ''))) : ((o.target = '_blank'), (o.rel = 'noopener noreferrer')), (0, l.jsx)('a', { href: i, ...o, children: e }));
    },
    i = ({ className: e, ...t }) => (0, l.jsx)(o, { className: (0, s.$)('utrecht-link', 'utrecht-link--html-a', e), ...t });
  },
  94533(e, t, n) {
   'use strict';
   n.d(t, { A: () => o });
