 ...
 [20994],
 {
  99835: (e, t, n) => {
   ...
   const o = { title: 'Card as link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Card as link', pagination_label: 'Card as link', description: 'Korte sectie die als geheel een link is naar een gerelateerde pagina.', slug: '/card-as-link', sidebar_custom_props: { illustration: 'CardAsLinkSketch' }, keywords: ['card', 'content card', 'gerelateerd', 'link', 'message card', 'navigate', 'navigatie', 'navigation', 'navigeren', 'product card', 'related', 'sectie', 'section', 'tile'] },
    a = void 0,
    l = { id: 'componenten/card-as-link/index', title: 'Card as link', description: 'Korte sectie die als geheel een link is naar een gerelateerde pagina.', source: '@site/docs/componenten/card-as-link/index.mdx', sourceDirName: 'componenten/card-as-link', slug: '/card-as-link', permalink: '/card-as-link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/card-as-link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Card as link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Card as link', pagination_label: 'Card as link', description: 'Korte sectie die als geheel een link is naar een gerelateerde pagina.', slug: '/card-as-link', sidebar_custom_props: { illustration: 'CardAsLinkSketch' }, keywords: ['card', 'content card', 'gerelateerd', 'link', 'message card', 'navigate', 'navigatie', 'navigation', 'navigeren', 'product card', 'related', 'sectie', 'section', 'tile'] }, sidebar: 'componenten', previous: { title: 'Calendar', permalink: '/Calendar' }, next: { title: 'Case card', permalink: '/case-card' } },
    u = {},
    d = [
