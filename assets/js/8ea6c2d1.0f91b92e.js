(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [6985],
 {
  ...
  12761(e, n, t) {
   ...
   const x = ({ className: e, ...n }) => {
    ...
    v = ({ className: e, heading: n, headingLevel: t, headingApperance: a, ...r }) => {
     ...
     return (0, d.jsxs)('details', { className: s, ...r, children: [(0, d.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, d.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, d.jsx)('span', { className: 'nl-button__icon-start', children: (0, d.jsx)(b.A, {}) }), (0, d.jsx)('span', { className: 'nl-button__label', children: (0, d.jsx)(j.D, { level: t, appearance: a, children: n }) })] }) }), (0, d.jsx)('div', { className: 'utrecht-accordion__panel', children: r.children })] });
    },
  ...
  46711(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => H, component: () => I, contentTitle: () => B, default: () => O, description: () => G, frontMatter: () => z, issueNumber: () => P, metadata: () => a, title: () => R, toc: () => M }));
  ...
  76097(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => m, mJ: () => p, VZ: () => N, cR: () => y, Pv: () => b, qZ: () => s, kD: () => f, QQ: () => A, B2: () => u, Pc: () => o, f4: () => l, GT: () => k, fX: () => r, eQ: () => v, B_: () => x, o_: () => j });
