(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [41102],
 {
  ...
  82724(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => M, component: () => H, contentTitle: () => P, default: () => Z, description: () => B, frontMatter: () => O, issueNumber: () => V, metadata: () => i, title: () => E, toc: () => U }));
   ...
   function $(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      (0, r.jsx)(_.$9, { component: H, headingLevel: 3 }),
      '\n',
  ...
  99630(e, n, t) {
   ...
   const j = ({ children: e }) => (0, a.jsx)('ul', { className: 'task-list', children: e }),
    m = ({ checked: e, children: n, title: t, description: i, headingLevel: o = 3 }) => (0, a.jsxs)('li', { className: (0, r.A)('task-list-item'), children: [(0, a.jsxs)('div', { className: (0, r.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, a.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, a.jsx)(g.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, a.jsxs)('div', { children: [t ? (0, a.jsx)(h.DZ, { appearance: 'utrecht-heading-3', level: o, children: t }) : null, i, n] })] });
   var p = t(33062);
   const v = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, a.jsx)(i.If, { sections: o.map((t) => ({ className: (0, r.A)('definition-of-done', t && `definition-of-done--${(0, p.fX)(t.title)}`), headingLevel: n, expanded: !1, label: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', body: t && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(j, { children: t.tasks.map(({ checked: e, name: t, id: i }) => (0, a.jsx)(m, { headingLevel: n + 1, checked: e, title: t, description: (0, p.qZ)(i) }, i)) }), (0, a.jsx)(i.fz, { children: (0, a.jsxs)(i.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) })) });
    },
    f = ({ component: e, headingLevel: n }) => {
     ...
     return e && t.length
           ...
           return (0, a.jsx)(
            s.Zp,
            {
             ...
             children: (0, a.jsxs)(s.Wu, {
              children: [
               (0, a.jsx)(i.DZ, { level: n, children: e.title.replace(/^Community/i, '') }),
               (0, a.jsxs)(i.fz, { children: [(0, a.jsx)(l, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, a.jsxs)(i.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
               (u.length > 0 || c.length > 0) && (0, a.jsx)(i.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               u.length > 0 &&
                (0, a.jsx)(a.Fragment, {
                 children: (0, a.jsx)(i.dk, {
                  links: u
               ...
               c.length > 0 && (0, a.jsx)(a.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(i.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, a.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, a.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
      ...
      : (0, a.jsx)(i.fz, { children: 'Er zijn nog geen implementaties' });
    },
    w = ({ component: e }) => {
     const n = e?.projects.find((e) => 'HELP_WANTED' === e.id),
      t = n?.tasks.find((e) => 'PVTF_lADOBGdlVM4AdX8lzgcig7o' === e.id).value;
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(i.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, a.jsxs)(i.Xy, { children: [t ? (0, a.jsxs)(i.Er, { children: ['Vul de ', (0, a.jsx)(i.N_, { href: t, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, a.jsxs)(i.Er, { children: [(0, a.jsxs)(i.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, a.jsxs)(i.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, a.jsx)(i.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, a.jsx)(i.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    k = ({ component: e, headingLevel: n, description: t }) => {
     const r = e && p.bo[e.relayStep];
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(u.p, { level: n, suffix: r && (0, a.jsx)(d.D, { state: r }), children: e.title }), (0, a.jsx)(i.fz, { lead: !0, children: t })] });
    };
  },
 },
]);
