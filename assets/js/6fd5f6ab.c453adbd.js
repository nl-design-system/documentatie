    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      (0, r.jsx)(w.t, {
       ...
       items: [
        { title: 'De koptekst maakt duidelijk waar de sectie over gaat', sc: '2.4.6', status: '', component: (0, r.jsx)(g, {}) },
        { title: 'Elementen moeten genest zijn volgens de HTML-specificatie', sc: '4.1.1', status: '', component: (0, r.jsx)(j, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(w.t, { headingLevel: 4, testCategory: 'Toegankelijkheid visueel ontwerp', items: [{ title: 'De contrastverhouding van de tekstkleur met de achtergrondkleur is hoog genoeg', sc: '1.4.3', status: '', component: (0, r.jsx)(d.ZP, {}) }] }),
      '\n',
      (0, r.jsx)(w.t, {
       headingLevel: 4,
       ...
       items: [
        ...
        { title: 'Als je de tekstafstand vergroot blijft de tekst in zijn geheel zichtbaar', sc: '1.4.12', status: '', component: (0, r.jsx)(l.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(w.t, {
       ...
       items: [
        { title: 'Als tekst er uitziet als een kop, moet dit ook in de HTML een kop zijn en geen vet gemaakte tekst', sc: '1.3.1', status: '', component: (0, r.jsx)(a, {}) },
        { title: 'Als de kop in een andere taal is dan de rest van de pagina, dan heeft het lang-attribuut de juiste taalcode', sc: '3.1.2', status: '', component: (0, r.jsx)(m.ZP, {}) },
       ],
      }),
      '\n',
