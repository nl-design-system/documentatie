 ...
 [44344],
 {
  183(e, n, a) {
   ...
   var i = a(86070),
    ...
    o = a(56167),
    r = a(17842);
   const g = { title: 'Note', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Note', pagination_label: 'Note', description: 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.', slug: '/note', keywords: ['spotlight', 'callout'] },
    d = void 0,
    u = {},
    m = 'Note',
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => D, cR: () => F, Pv: () => f, qZ: () => l, kD: () => k, B2: () => c, Pc: () => r, f4: () => o, GT: () => j, fX: () => s, eQ: () => v, B_: () => b, o_: () => x });
