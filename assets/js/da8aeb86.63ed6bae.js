(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [54472],
 {
  39844: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => s, issueNumber: () => g, metadata: () => u, title: () => d, toc: () => h });
   var r = n(52676),
    i = n(40139),
    c = n(27197),
    o = n(8657);
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => y, BA: () => s, Ee: () => l, Q6: () => c, U: () => j, Yr: () => p, d: () => h, e9: () => o, fO: () => b, mA: () => i, ps: () => g, qU: () => k, s0: () => v, zP: () => m });
