    ...
    return (
     ...
     (0, o.jsxs)(o.Fragment, {
      children: [
       ...
       Z && !e.playlist && (0, o.jsx)('noscript', { children: (0, o.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${p} on YouTube`, children: ['Watch "', p, '" on YouTube'] }) }),
       (0, o.jsxs)(H, {
        onPointerOver: () => {
         t || s(!0);
        },
