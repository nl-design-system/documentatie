(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [79947],
 {
  ...
  75131: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => z, component: () => P, contentTitle: () => R, default: () => M, description: () => D, frontMatter: () => W, issueNumber: () => S, metadata: () => N, title: () => L, toc: () => _ });
   var r,
    i,
    s,
    o,
   ...
   function F(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, d.jsx)(G.Rv, { component: P, headingLevel: 1, description: D }),
      '\n',
      (0, d.jsx)(x.I, { component: P }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, d.jsx)(C.B, { component: P, illustration: j }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, d.jsx)(G.cN, { component: P, headingLevel: 3 }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, d.jsx)(G.W, { component: P, headingLevel: 3 }),
      '\n',
      ...
      '\n',
      (0, d.jsx)(T.t, { headingLevel: 4, testCategory: 'Toegankelijkheid visueel ontwerp', items: [{ title: 'De tekst van de Number Badge heeft voldoende contrast tegen de achtergrond', sc: '1.4.3', status: '', component: (0, d.jsx)(A.ZP, {}) }] }),
      '\n',
      (0, d.jsx)(T.t, {
       headingLevel: 4,
       ...
       items: [
        ...
        { title: 'Als je de tekstafstand van de Number Badge vergroot blijft de tekst in zijn geheel zichtbaar', sc: '1.4.12', status: '', component: (0, d.jsx)(f.ZP, {}) },
       ],
      }),
      '\n',
      ...
      '\n',
      (0, d.jsx)(G.vM, { component: P, headingLevel: 3 }),
     ],
    });
   }
   function M(e = {}) {
          ...
          children: [
           (0, d.jsx)(A, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(v, { headingLevel: n + 1, checked: t, title: r, description: (0, b.Q6)(i) }, i);
            }),
           }),
