/*! For license information please see cc7e1584.a4d5f72b.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [42119],
 {
  ...
  26877(e, n, a) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
    ...
    w = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(m.p, { level: n, suffix: r && (0, g.jsx)(c.D, { state: r }), children: e.title }), (0, g.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(r) && (0, g.jsx)(b.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    N = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
  ...
  55811(e, n, a) {
   (a.r(n), a.d(n, { assets: () => g, component: () => f, componentName: () => p, contentTitle: () => d, default: () => v, description: () => c, frontMatter: () => o, issueNumber: () => m, metadata: () => t, relayStep: () => h, title: () => u, toc: () => x }));
   ...
   const o = { title: 'Strong', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Strong', pagination_label: 'Strong', description: 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.', issue_number: 138, slug: '/strong', keywords: ['bold', 'bold emphasis', 'bold text', 'dikgedrukt', 'emphasized text', 'important', 'strong', 'vetgedrukt'] },
    ...
    g = {},
    u = 'Strong',
    c = 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.',
    m = 138,
    h = 'help wanted',
    p = 'strong',
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => r, KF: () => c, mJ: () => p, VZ: () => N, cR: () => w, Pv: () => f, qZ: () => s, kD: () => k, QQ: () => D, B2: () => m, Pc: () => o, f4: () => l, GT: () => j, fX: () => i, eQ: () => v, B_: () => b, o_: () => x });
