(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [98634],
 {
  ...
  34497: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => F, component: () => H, contentTitle: () => _, default: () => I, description: () => E, frontMatter: () => P, issueNumber: () => U, metadata: () => Z, title: () => O, toc: () => M });
   var r = t(52676),
    i = t(40139),
    s = t(43166),
    o = t(93514),
  ...
  94443: (e, n, t) => {
   ...
   const x = (e) => {
     ...
     const s = n && n.projects.filter((e) => v.e9.includes(e.id)),
      o = s && v.e9.map((e) => s.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, d.jsx)(w, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(f, { headingLevel: t + 1, checked: n, title: r, description: (0, v.Q6)(i) }, i);
            }),
           }),
    ...
    y = (e) => {
     let { component: n, headingLevel: t } = e;
     const i = n && n.projects.filter((e) => !v.e9.includes(e.id));
     return n && i.length
      ? (0, d.jsx)(m.um, {
         appearance: 'large',
