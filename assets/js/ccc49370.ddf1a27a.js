...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [46103],
 {
  ...
  97335: (e, t, l) => {
   ...
   var h = l(23818),
    p = l(82169);
   const g = { container: 'container_D3tA' };
   function b(e) {
    let { readingTime: t } = e;
    const l = (function () {
   ...
   const k = { authorCol: 'authorCol_E2jo', imageOnlyAuthorRow: 'imageOnlyAuthorRow_tfJR', imageOnlyAuthorCol: 'imageOnlyAuthorCol_GZQH' };
   function P(e) {
    let { className: t } = e;
    const {
     metadata: { authors: l },
   ...
   const B = { blogPostFooterDetailsFull: 'blogPostFooterDetailsFull_sh0J' };
   function M() {
   ...
   function D(e) {
    ...
    return (0, c.jsxs)(O.Z, {
     ...
     sidebar: t,
     toc: !d && r.length > 0 ? (0, c.jsx)(S.Z, { toc: r, minHeadingLevel: m, maxHeadingLevel: u }) : void 0,
     children: [(0, c.jsx)($, { children: l }), (n || a) && (0, c.jsx)(R, { nextItem: n, prevItem: a })],
    });
   }
   function U(e) {
    const t = e.content;
    return (0, c.jsx)(s.n, { content: e.content, isBlogPostPage: !0, children: (0, c.jsxs)(o.FG, { className: (0, n.Z)(r.k.wrapper.blogPages, r.k.page.blogPostPage), children: [(0, c.jsx)(A, {}), (0, c.jsx)(D, { sidebar: e.sidebar, children: (0, c.jsx)(t, {}) })] }) });
   }
  },
  39731: (e, t, l) => {
   l.d(t, { Z: () => h });
