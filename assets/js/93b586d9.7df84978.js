 ...
 [10632],
 {
  ...
  68380: (e, n, l) => {
   ...
   const p = { title: 'Placeholders en de zoekfunctie \xb7 Placeholders in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Placeholder bij zoekfunctie', pagination_label: 'Placeholder bij zoekfunctie', description: 'Richtlijnen over placeholder gebruiken in de zoekfunctie.', slug: '/richtlijnen/formulieren/placeholders/zoekfunctie', keywords: ['labels', 'formulier', 'design', 'code'] },
    h = void 0,
    m = { id: 'richtlijnen/formulieren/placeholder/search/README', title: 'Placeholders en de zoekfunctie \xb7 Placeholders in een formulier \xb7 Richtlijnen', description: 'Richtlijnen over placeholder gebruiken in de zoekfunctie.', source: '@site/docs/richtlijnen/formulieren/placeholder/2-search/README.mdx', sourceDirName: 'richtlijnen/formulieren/placeholder/2-search', slug: '/richtlijnen/formulieren/placeholders/zoekfunctie', permalink: '/richtlijnen/formulieren/placeholders/zoekfunctie', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/placeholder/2-search/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Placeholders en de zoekfunctie \xb7 Placeholders in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Placeholder bij zoekfunctie', pagination_label: 'Placeholder bij zoekfunctie', description: 'Richtlijnen over placeholder gebruiken in de zoekfunctie.', slug: '/richtlijnen/formulieren/placeholders/zoekfunctie', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Placeholder is geen label', permalink: '/richtlijnen/formulieren/placeholders/niet-als-label' }, next: { title: 'Placeholder kan verwarren', permalink: '/richtlijnen/formulieren/placeholders/verwarring-voorkomen' } },
    b = {},
    _ = [];
   function v(e) {
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', (0, o.jsx)(d, {}), '\n', (0, o.jsx)(a, {}), '\n', (0, o.jsx)(u.ZP, {})] });
  ...
  98480: (e, n, l) => {
   ...
   const g = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: g = !1, displayCode: y = !0, children: j, container: x = 'document', language: k, designTokens: f } = e,
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await i.ZP.format(w, { parser: k, plugins: [t.Z, c.ZP, r.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), P(Z);
     })();
    }, [w]);
    const E = (0, d.useId)();
    let R = d.Fragment;
    return (
     'paragraph' === x ? (R = b) : 'document' === x ? (R = _) : 'surface' === x && (R = v),
     (0, m.jsxs)('div', {
      className: (0, s.Z)(p['nlds-canvas']),
      children: [
       z && (0, m.jsx)('div', { className: (0, s.Z)(p['nlds-canvas__example']), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(R, { children: (0, m.jsx)(o.pu, { children: z }) }) }) }),
       y &&
        (0, m.jsx)('div', {
       ...
       y &&
        (0, m.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(h.u, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: Z, trim: !0 }),
          l &&
           (0, m.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function i(e) {
    let { lineNumber: n, syntax: l, textContent: i, trim: d } = e,
     u = i;
    const { title: p, type: h } = (0, t.useContext)(c.n),
     m = (0, t.useId)();
    return (
     d && (u = u.trim()),
     (0, a.jsx)(s.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, a.jsx)(o.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': m, style: l, children: s.map((e, l) => (0, a.jsxs)('span', { ...t({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...c({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
   ...
   const d = (0, r.createContext)({}),
    u = (e) => {
     ...
     const h = { do: 'Doen', dont: 'Niet doen' },
      m = p ? 'figure' : 'div',
      b = p ? 'figcaption' : 'div';
     return (0, i.jsxs)(m, { className: (0, c.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(b, { className: (0, c.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(t.nv, { className: (0, c.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, i.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: a['nlds-guideline__title'], children: h.dont })] }), (0, i.jsx)(t.nv, { children: n })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(t.nv, { className: (0, c.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, i.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: a['nlds-guideline__title'], children: h.do })] }), (0, i.jsx)(t.nv, { children: n })] }), r] }), (0, i.jsx)('div', { className: (0, c.Z)(a['nlds-guideline__example']), children: (0, i.jsx)(d.Provider, { value: { title: n, type: h[l] }, children: u }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => c });
