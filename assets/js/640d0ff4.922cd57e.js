...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [60237],
 {
  ...
  18439(e, l, n) {
   ...
   function a(e) {
    let l;
    return ((l = e.disableParentContext ? ('function' == typeof e.components ? e.components(o) : e.components || o) : t(e.components)), r.createElement(s.Provider, { value: l }, e.children));
   }
  },
  40958(e, l, n) {
   (n.r(l), n.d(l, { assets: () => b, contentTitle: () => g, default: () => x, frontMatter: () => v, metadata: () => r, toc: () => j }));
   ...
   function c(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', (0, o.jsx)(l.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, o.jsx)(i.$, { appearance: 'do', title: 'Het label altijd tonen en een description gebruiken als aanvullende informatie.', children: (0, o.jsx)(a.H, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('label', { htmlFor: 'lievelingskleur1', children: 'Wat is je lievelingskleur?' }), (0, o.jsx)('p', { id: 'description-kleur1', children: 'Vul de naam van een kleur in.' }), (0, o.jsx)('input', { 'aria-describedby': 'description-kleur1', id: 'lievelingskleur1', name: 'lievelingskleur', type: 'text' })] }) }) }), '\n', (0, o.jsx)(i.$, { appearance: 'do', title: 'Het label altijd tonen en een placeholder als korte hint gebruiken.', children: (0, o.jsx)(a.H, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('label', { htmlFor: 'lievelingskleur2', children: 'Wat is je lievelingskleur?' }), (0, o.jsx)('input', { id: 'lievelingskleur2', type: 'text', name: 'lievelingskleur', placeholder: 'Vul een kleurnaam in' })] }) }) }), '\n', (0, o.jsx)(i.$, { appearance: 'dont', title: 'Het label onzichtbaar maken.', children: (0, o.jsx)(a.H, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('label', { className: 'sr-only', htmlFor: 'lievelingskleur3', children: 'Wat is je lievelingskleur?' }), (0, o.jsx)('input', { id: 'lievelingskleur3', name: 'lievelingskleur', placeholder: 'Wat is je lievelingskleur?', type: 'text' })] }) }) }), '\n', (0, o.jsx)(i.$, { appearance: 'dont', title: 'Placeholdertekst heel lang maken zodat een deel uit het formulierveld valt en daardoor onleesbaar wordt. Gebruik in dat geval een description.', children: (0, o.jsx)(a.H, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('label', { htmlFor: 'lievelingskleur4', children: 'Wat is je lievelingskleur?' }), (0, o.jsx)('input', { id: 'lievelingskleur4', name: 'lievelingskleur', placeholder: 'Geef is je lievelingskleur? Bijvoorbeeld rood, wit, geel of blauw.', type: 'text' })] }) }) })] });
   }
   function d(e = {}) {
   ...
   function u(e) {
    const l = { h1: 'h1', header: 'header', p: 'p', ...(0, s.R)(), ...e.components };
  ...
  58639(e, l, n) {
   ...
   const b = ({ code: e, copy: l = !0, defaultExpandedCode: n = !1, displayCode: b = !0, children: j, container: y = 'document', language: x, designTokens: f }) => {
    ...
    let S = u.Fragment;
    return (
     'paragraph' === y ? (S = m) : 'document' === y ? (S = v) : 'surface' === y && (S = g),
     (0, p.jsxs)('div', {
      className: (0, s.A)('nlds-canvas'),
      children: [
       k && (0, p.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(S, { children: (0, p.jsx)(o.v$, { children: k }) }) }) }),
       b &&
        (0, p.jsx)('div', {
  ...
  69284(e, l, n) {
   ...
   function c({ lineNumber: e, syntax: l, textContent: n, trim: c }) {
    ...
    const { title: u, type: h } = (0, s.useContext)(t.x),
     p = (0, s.useId)();
    return (c && (d = d.trim()), (0, i.jsx)(o.f4, { theme: a, code: d, language: l || '', children: ({ style: l, tokens: n, getLineProps: o, getTokenProps: s }) => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, i.jsx)(r.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': p, style: l, children: n.map((l, n) => (0, i.jsxs)('span', { ...o({ line: l }), children: [e && (0, i.jsx)('span', { children: n + 1 }), l.map((e, l) => (0, i.jsx)('span', { ...s({ token: e }) }, l)), '\n'] }, n)) })] }) }));
   }
  },
  78734(e, l, n) {
   n.d(l, { Ay: () => a, RM: () => s });
