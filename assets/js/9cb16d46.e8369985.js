 ...
 [70605],
 {
  ...
  2415: (e, n, o) => {
   ...
   function i(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(a.X, { appearance: 'do', title: 'Voeg autocomplete waarden toe aan adresgegevens.', children: (0, t.jsx)(r.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.label, { htmlFor: 'adres1', children: 'Straat en huisnummer' }), (0, t.jsx)(n.input, { type: 'text', id: 'adres1', autoComplete: 'street-address', name: 'adres' }), (0, t.jsx)(n.label, { htmlFor: 'postcode1', children: 'Postcode' }), (0, t.jsx)(n.input, { type: 'text', id: 'postcode1', autoComplete: 'postal-code', name: 'postcode' }), (0, t.jsx)(n.label, { htmlFor: 'woonplaats1', children: 'Woonplaats' }), (0, t.jsx)(n.input, { type: 'text', id: 'woonplaats1', autoComplete: 'address-level2', name: 'woonplaats' })] }) }) }), '\n', (0, t.jsx)(a.X, { appearance: 'dont', title: 'Laat autocomplete waarden weg bij adresgegevens.', children: (0, t.jsx)(r.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.label, { htmlFor: 'adres2', children: 'Straat en huisnummer' }), (0, t.jsx)(n.input, { type: 'text', id: 'adres2', name: 'adres' }), (0, t.jsx)(n.label, { htmlFor: 'postcode2', children: 'Postcode' }), (0, t.jsx)(n.input, { type: 'text', id: 'postcode2', name: 'postcode' }), (0, t.jsx)(n.label, { htmlFor: 'woonplaats2', children: 'Woonplaats' }), (0, t.jsx)(n.input, { type: 'text', id: 'woonplaats2', name: 'woonplaats' })] }) }) })] });
   }
   function c(e = {}) {
    const { wrapper: n } = { ...(0, l.a)(), ...e.components };
   ...
   const g = (e) => {
    ...
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       _ && (0, p.jsx)('div', { className: (0, s.Z)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, p.jsx)(z, { children: (0, p.jsx)(l.pu, { children: _ }) }) }) }),
       j &&
        (0, p.jsx)('div', {
  ...
  41179: (e, n, o) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: o, textContent: c, trim: d } = e,
     u = c;
    const { title: m, type: p } = (0, s.useContext)(r.n),
     h = (0, s.useId)();
    return (
     d && (u = u.trim()),
     (0, i.jsx)(l.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', m ? ': ' : ' ', m] }), (0, i.jsx)(t.dn, { tabIndex: 0, role: m ? 'region' : void 0, 'aria-labelledby': h, style: o, children: l.map((e, o) => (0, i.jsxs)('span', { ...s({ line: e }), children: [n && (0, i.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, o)) })] });
      },
     })
    );
   }
   ...
   const c = (0, a.createContext)({}),
    d = (e) => {
     ...
     const m = { do: 'Doen', dont: 'Niet doen' },
      p = u ? 'figure' : 'div',
      h = u ? 'figcaption' : 'div';
     return (0, i.jsxs)(p, { className: (0, r.Z)('nlds-guideline', `nlds-guideline--${o}`), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(h, { className: 'nlds-guideline__description', children: ['dont' === o ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(s.nv, { className: (0, r.Z)('nlds-guideline__badge', `nlds-guideline__badge--${o}`), children: [(0, i.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, i.jsx)('span', { className: 'nlds-guideline__title', children: m.dont })] }), (0, i.jsx)(s.nv, { children: n })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(s.nv, { className: (0, r.Z)('nlds-guideline__badge', `nlds-guideline__badge--${o}`), children: [(0, i.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, i.jsx)('span', { className: 'nlds-guideline__title', children: m.do })] }), (0, i.jsx)(s.nv, { children: n })] }), a] }), (0, i.jsx)('div', { className: 'nlds-guideline__example', children: (0, i.jsx)(c.Provider, { value: { title: n, type: m[o] }, children: d }) })] });
    };
  },
  87118: (e, n, o) => {
   o.d(n, { Z: () => a, a: () => r });
