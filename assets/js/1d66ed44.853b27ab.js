 ...
 [28911],
 {
  ...
  58639(e, n, l) {
   ...
   const x = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: x = !0, children: y, container: j = 'document', language: b, designTokens: f }) => {
    ...
    let F = m.Fragment;
    return (
     'paragraph' === j ? (F = h) : 'document' === j ? (F = v) : 'surface' === j && (F = g),
     (0, p.jsxs)('div', {
      className: (0, s.A)('nlds-canvas'),
      children: [
       k && (0, p.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(F, { children: (0, p.jsx)(o.v$, { children: k }) }) }) }),
       x &&
        (0, p.jsx)('div', {
