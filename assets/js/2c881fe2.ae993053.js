(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [94810],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => d, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => g, qZ: () => c, kD: () => b, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => i, eQ: () => k, B_: () => v, o_: () => p, Rc: () => x });
  ...
  72078(e, t, n) {
   ...
   const r = JSON.parse('{"id":"componenten/ordered-list/index","title":"Ordered List","description":"Lijst waarvan de volgorde van items betekenis heeft.","source":"@site/docs/componenten/ordered-list/index.mdx","sourceDirName":"componenten/ordered-list","slug":"/ordered-list","permalink":"/ordered-list","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/ordered-list/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Ordered List","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Ordered List","pagination_label":"Ordered List","description":"Lijst waarvan de volgorde van items betekenis heeft.","slug":"/ordered-list","keywords":["genummerde lijst","geordende lijst","gestructureerde lijst","items","itemslijst","lijst","lijst met nummers","lijsten","list","list group","numbered list","nummer","nummering","nummerlijst","nummering","oplopende lijst","order","ordered items","ordered list","sequence list","step-by-step list","volgorde lijst"]},"sidebar":"componenten","previous":{"title":"Number Input","permalink":"/number-input"},"next":{"title":"Page Footer","permalink":"/page-footer"}}');
   var s = n(86070),
    i = n(18439),
    c = n(57641),
    o = n(1842);
   const a = { title: 'Ordered List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Ordered List', pagination_label: 'Ordered List', description: 'Lijst waarvan de volgorde van items betekenis heeft.', slug: '/ordered-list', keywords: ['genummerde lijst', 'geordende lijst', 'gestructureerde lijst', 'items', 'itemslijst', 'lijst', 'lijst met nummers', 'lijsten', 'list', 'list group', 'numbered list', 'nummer', 'nummering', 'nummerlijst', 'nummering', 'oplopende lijst', 'order', 'ordered items', 'ordered list', 'sequence list', 'step-by-step list', 'volgorde lijst'] },
    u = void 0,
    l = {},
    h = 'Ordered List',
    d = 'Lijst waarvan de volgorde van items betekenis heeft.',
    j = 117,
