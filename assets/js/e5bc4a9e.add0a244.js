(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [41990],
 {
  66441: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => p, contentTitle: () => a, default: () => g, description: () => j, frontMatter: () => o, issueNumber: () => y, metadata: () => l, title: () => d, toc: () => h });
   var r = n(52676),
    c = n(40139),
    i = n(23201),
    s = n(8657);
   const o = { title: 'Separator', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Separator', pagination_label: 'Separator', description: 'Markering van de plek waar de tekst op een nieuwe manier verdergaat, zoals een nieuwe sc\xe8ne of een ander onderwerp.', slug: '/separator', keywords: ['divider', 'horizontal rule', 'line break', 'page break', 'rule', 'section break', 'separator', 'splitter', 'vertical line', 'vertical rule'] },
    a = void 0,
    l = { id: 'componenten/separator/index', title: 'Separator', description: 'Markering van de plek waar de tekst op een nieuwe manier verdergaat, zoals een nieuwe sc\xe8ne of een ander onderwerp.', source: '@site/docs/componenten/separator/index.mdx', sourceDirName: 'componenten/separator', slug: '/separator', permalink: '/separator', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/separator/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Separator', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Separator', pagination_label: 'Separator', description: 'Markering van de plek waar de tekst op een nieuwe manier verdergaat, zoals een nieuwe sc\xe8ne of een ander onderwerp.', slug: '/separator', keywords: ['divider', 'horizontal rule', 'line break', 'page break', 'rule', 'section break', 'separator', 'splitter', 'vertical line', 'vertical rule'] }, sidebar: 'componenten', previous: { title: 'Select', permalink: '/select' }, next: { title: 'Side Navigation', permalink: '/side-navigation' } },
    u = {},
    h = [
    ...
    d = 'Separator',
    j = 'Markering van de plek waar de tekst op een nieuwe manier verdergaat, zoals een nieuwe sc\xe8ne of een ander onderwerp.',
    y = 119,
  ...
  8657: (e, t, n) => {
   ...
   const w = (e) => {
    ...
    A = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(g.V, { level: n, suffix: i && (0, u.jsx)(m.y, { state: i }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => m, BA: () => o, Ee: () => u, Q6: () => i, U: () => j, Yr: () => g, d: () => h, e9: () => s, fO: () => k, mA: () => c, ps: () => y, qU: () => b, s0: () => v, zP: () => p });
