(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [72755],
 {
  ...
  87558: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => S, component: () => P, contentTitle: () => N, default: () => O, description: () => D, frontMatter: () => R, issueNumber: () => F, metadata: () => z, title: () => _, toc: () => L });
   var r = t(52676),
    i = t(40139),
    s = t(64332),
    o = t(41326),
   ...
   function H(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(b.Rv, { component: P, headingLevel: 1, description: D }),
      '\n',
      ...
      '\n',
      (0, r.jsx)(A.W, { tokens: W }),
      '\n',
      (0, r.jsx)(C.U, { omitH1: !0, headingLevel: 3, children: (0, r.jsx)(G, {}) }),
      '\n',
      ...
      (0, r.jsx)(x.W, {
       ...
       items: [
        ...
        { title: 'De koptekst maakt duidelijk waar de sectie over gaat.', sc: '2.4.6', status: '', component: (0, r.jsx)(w, {}), tags: ['designer', 'contentmaker'] },
  ...
  35038: (e, n, t) => {
   ...
   const o = (e) => {
    ...
    a = (e) => {
     let { href: n, appearance: t, className: o, component: c = 'div', background: a, children: l } = e;
     const d = (e) => ('article' === c ? (0, s.jsx)('article', { ...e }) : 'section' === c ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      h = (0, s.jsx)(d, { className: (0, i.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, o), children: l });
  ...
  6503: (e, n, t) => {
   ...
   var r = t(57229),
    ...
    d = t(52676);
   const h = (e) => {
     let { title: n, sc: t, component: l, tags: h } = e;
     const u = (0, a.useId)(),
      g = [...h];
     if (t) {
      g.push(t);
    ...
    u = (e) => {
     ...
     const r = n.reduce(
      ...
      [i, o] = (0, a.useState)(Array.from(r.values())),
      c = (e) => i.includes(e),
      u = (0, a.useId)(),
      g =
       i.length >= 1
     ...
     return (0, d.jsxs)('div', {
      children: [
       (0, d.jsxs)('div', {
        ...
        children: [
         (0, d.jsxs)(l.pg, {
          ...
          'aria-labelledby': u,
          children: [
           (0, d.jsx)(l.X6, { level: t, id: u, children: 'Filter acceptatiecriteria voor:' }),
             ...
             l.Wi,
             {
              ...
              children: [
               (0, d.jsx)(l.XZ, {
                ...
                onChange: () =>
                 ((e, n) => {
                  const t = ('boolean' == typeof n ? n : !c(e)) ? [...i, e] : i.filter((n) => n !== e);
                  o(t);
                 })(e),
               }),
       ...
       (0, d.jsx)('ul', { className: 'new-checklist', role: 'list', children: g.map((e, n) => (0, d.jsx)(h, { ...e }, n)) }),
      ],
     });
    };
  },
  ...
  49556: (e, n, t) => {
    ...
    return 'clipboard' in navigator
     ? (0, g.jsxs)(o.zx, {
        ...
        onClick: async function () {
         try {
          const e = await d.ZP.format(t, { parser: r, plugins: [c.Z, a.ZP, l.ZP] });
   ...
   var p = t(6076),
    ...
    x = t(49003),
    b = t(75271);
   const A = { color: p.Z, dimension: j.Z, fontFamilies: k.Z, fontSizes: w.Z, fontWeights: v.Z, lineHeights: y.Z, other: f.Z, textDecoration: x.Z },
    C = (e) => {
     let { type: n } = e;
     return (0, g.jsx)(u.JO, { children: (0, b.createElement)(A[n]) });
    };
   function T(e) {
    let { tokens: n } = e;
    const t = (0, s.s0)(n),
       ...
       children: [
        ...
        (0, g.jsx)(o.RM, {
         children: c.map((e) => {
          const t = (0, s.zP)(e),
           c = (0, s.Yr)(n, e).$type;
          return (0, g.jsxs)(o.SC, { children: [(0, g.jsx)(o.pj, { children: (0, g.jsx)(r.E, { children: (0, g.jsx)(o.YG, { children: t }) }) }), (0, g.jsx)(o.pj, { children: (0, g.jsxs)(i.O, { children: [(0, g.jsx)(C, { type: c }), ' ', c] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, $e: () => j, BA: () => c, Ee: () => d, Q6: () => s, U: () => g, Yr: () => k, d: () => h, e9: () => o, fO: () => v, mA: () => i, ps: () => m, qU: () => y, s0: () => w, zP: () => p });
