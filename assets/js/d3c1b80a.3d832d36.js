(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [86911],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => g, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => s, kD: () => b, B2: () => j, Pc: () => a, f4: () => o, GT: () => k, fX: () => c, eQ: () => f, B_: () => v, o_: () => p, Rc: () => x });
  ...
  71472(e, t, n) {
   ...
   const r = JSON.parse('{"id":"componenten/avatar/index","title":"Avatar","description":"Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.","source":"@site/docs/componenten/avatar/index.mdx","sourceDirName":"componenten/avatar","slug":"/avatar","permalink":"/avatar","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/avatar/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Avatar","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Avatar","pagination_label":"Avatar","description":"Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.","slug":"/avatar","keywords":["afbeelding","avatar","foto","gebruiker","gravatar","icon","identiteit","identity","illustratie","illustration","image","logo","initial","initialen","organisation","organization","photo","picture","profielafbeelding","profile image","user"]},"sidebar":"componenten","previous":{"title":"Alert Dialog","permalink":"/alert-dialog"},"next":{"title":"Blockquote","permalink":"/blockquote"}}');
   var i = n(86070),
    c = n(18439),
    s = n(78742),
    o = n(99630);
   const a = { title: 'Avatar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Avatar', pagination_label: 'Avatar', description: 'Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.', slug: '/avatar', keywords: ['afbeelding', 'avatar', 'foto', 'gebruiker', 'gravatar', 'icon', 'identiteit', 'identity', 'illustratie', 'illustration', 'image', 'logo', 'initial', 'initialen', 'organisation', 'organization', 'photo', 'picture', 'profielafbeelding', 'profile image', 'user'] },
    u = void 0,
    l = {},
    h = 'Avatar',
    d = 'Een afbeelding die een identiteit vertegenwoordigt, meestal in de vorm van een foto, illustratie, of initialen.',
    j = 83,
            ...
            s.Zp,
            {
             ...
             children: (0, a.jsxs)(s.Wu, {
              children: [
               ...
               o.length > 0 && (0, a.jsx)(a.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(c.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
