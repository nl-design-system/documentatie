 ...
 [47675],
 {
  ...
  70348(e, n, t) {
   ...
   var l = t(13526),
    ...
    o = t(37168),
    a = t(86070);
   const i = (0, r.forwardRef)(({ as: e, className: n, children: t, ...r }, s) => {
     const o = e || 'div',
      i = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(o, { ref: s, className: i, ...r, children: t });
    }),
  ...
  80731(e, n, t) {
   ...
   var l = t(15175),
    ...
    v = t(70348),
    j = t(86070);
   const b = ({ children: e }) => (0, j.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(r.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, j.jsx)(r.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   b.displayName = 'ParagraphContainer';
   const g = ({ children: e }) => (0, j.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(r.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const l = 'function' == typeof e ? e() : e,
        ...
        o = p().highlight(r, p().languages[n], n);
       return (0, j.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', t), children: [(0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }), (0, j.jsx)(v.n, { children: (0, j.jsx)(v.K, { label: 'Code', children: (0, j.jsx)('pre', { className: 'language-html nl-code-block', children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: m = !0, children: p, container: v = 'document', language: y, designTokens: f }) => {
       ...
       return (
        ...
        (0, j.jsxs)('div', {
         ...
         children: [
          k && (0, j.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, j.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, j.jsx)(V, { children: (0, j.jsx)(r.v$, { children: k }) }) }) }),
          m &&
           (0, j.jsx)('div', {
  ...
  95701(e, n, t) {
   ...
   function c(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', (0, r.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, r.jsx)(i.$, { appearance: 'do', title: 'Het formulier wordt verzonden na het kiezen van de submitbutton.', children: (0, r.jsx)(a.H, { language: 'html', children: () => (0, r.jsx)(r.Fragment, { children: (0, r.jsxs)('form', { children: [(0, r.jsx)('p', { children: (0, r.jsx)('label', { htmlFor: 'kleur1', children: 'Kies een kleur' }) }), (0, r.jsx)('p', { children: (0, r.jsxs)('select', { id: 'kleur1', children: [(0, r.jsx)('option', { name: 'groen', children: 'Groen' }), (0, r.jsx)('option', { name: 'blauw', children: 'Blauw' }), (0, r.jsx)('option', { name: 'rood', children: 'Rood' })] }) }), (0, r.jsx)('p', { children: (0, r.jsx)('button', { children: 'Verstuur' }) })] }) }) }) }), '\n', (0, r.jsx)(i.$, { appearance: 'dont', title: 'Het formulier wordt automatisch verzonden na het kiezen van van een kleur.', description: 'In dit voorbeeld ontbreekt de submitbutton en wordt het formulier direct verstuurd na het kiezen van een kleur', children: (0, r.jsx)(a.H, { language: 'html', children: () => (0, r.jsx)(r.Fragment, { children: (0, r.jsxs)('form', { children: [(0, r.jsx)('p', { children: (0, r.jsx)('label', { htmlFor: 'kleur2', children: 'Kies een kleur' }) }), (0, r.jsx)('p', { children: (0, r.jsxs)('select', { id: 'kleur2', children: [(0, r.jsx)('option', { name: 'groen', children: 'Groen' }), (0, r.jsx)('option', { name: 'blauw', children: 'Blauw' }), (0, r.jsx)('option', { name: 'rood', children: 'Rood' })] }) })] }) }) }) })] });
   }
   function d(e = {}) {
   ...
   const v = { title: 'Verstuur een formulier niet automatisch na het wijzigen of invullen van een formulierveld', title_sm: 'Verstuur niet automatisch', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Verstuur niet automatisch', pagination_label: 'Verstuur niet automatisch', description: 'Richtlijnen voor niet automatisch versturen na het wijzigen of invullen van een formulierveld.', slug: '/richtlijnen/formulieren/buttons/niet-automatisch-versturen', keywords: ['labels', 'formulier', 'design', 'code'] },
    j = void 0,
    b = {},
    g = [{ value: 'Voorbeelden', id: 'voorbeelden', level: 2 }, { value: 'Meer lezen over gerelateerde WCAG-succescriteria op NL Design System', id: 'meer-lezen-over-gerelateerde-wcag-succescriteria-op-nl-design-system', level: 2 }, ...o.RM];
   function x(e) {
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', (0, r.jsx)(h, {}), '\n', (0, r.jsx)(d, {}), '\n', (0, r.jsx)(p, {}), '\n', (0, r.jsx)(o.Ay, {})] });
   }
   function y(e = {}) {
