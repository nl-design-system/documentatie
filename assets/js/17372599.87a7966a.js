 ...
 [40168],
 {
  ...
  14881(e, n, l) {
   ...
   const c = (0, o.forwardRef)(({ as: e, className: n, children: l, ...o }, t) => {
     const r = e || 'div',
      c = (0, s.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(r, { ref: t, className: c, ...o, children: l });
    }),
    i = ({ className: e, classNamePanel: n, label: l, heading: o, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, a.jsxs)('details', { className: p, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(t.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [o && (0, a.jsx)(r.D, { level: c, appearance: i, children: o }), l] })] }) }), (0, a.jsx)('div', { className: u, children: d.children })] });
    };
  },
  18439(e, n, l) {
   l.d(n, { R: () => r, x: () => a });
  ...
  28369(e, n, l) {
   ...
   function i({ lineNumber: e, syntax: n, textContent: l, trim: i }) {
    ...
    const { title: p, type: u } = (0, t.useContext)(r.x),
     m = (0, t.useId)();
    return (i && (d = d.trim()), (0, c.jsx)(o.f4, { theme: a, code: d, language: n || '', children: ({ style: n, tokens: l, getLineProps: o, getTokenProps: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, c.jsx)(s.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': m, style: n, children: l.map((n, l) => (0, c.jsxs)('span', { ...o({ line: n }), children: [e && (0, c.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, c.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  38953(e, n, l) {
   l.d(n, { H: () => f });
   var s = l(28369),
    ...
    v = l(46847),
    j = l(86070);
   const b = ({ children: e }) => (0, j.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(o.yo, { className: (0, t.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, j.jsx)(o.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   ...
   const f = globalThis.isAstro
    ? ({ language: e, className: n, code: l = '<p>No code provided</p>', rawCode: s, copyCode: o, defaultExpandedCode: r, designTokens: a }) => {
       const c = 'string' == typeof l ? l : s || '',
        i = 'string' == typeof l ? g().highlight(l, g().languages[e], e) : g().highlight(s || '', g().languages[e], e);
       return (0, j.jsxs)('div', { className: (0, t.A)('ma-canvas-astro', n), children: [(0, j.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: a, children: (0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: c } }) }), (0, j.jsx)(h.n, { children: (0, j.jsxs)(h.K, { label: 'Code', open: r, children: [(0, j.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: i } }) }), 'allow' === o && (0, j.jsx)(v.$, { 'data-copy-code': c, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: m = !0, children: g, container: h = 'document', language: v, designTokens: f }) => {
       ...
       let R = p.Fragment;
       return (
        'paragraph' === h ? (R = b) : 'document' === h ? (R = x) : 'surface' === h && (R = y),
        (0, j.jsxs)('div', {
         className: (0, t.A)('nlds-canvas'),
         children: [
          _ && (0, j.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, j.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, j.jsx)(R, { children: (0, j.jsx)(o.v$, { children: _ }) }) }) }),
          m &&
           (0, j.jsx)('div', {
          ...
          m &&
           (0, j.jsxs)('div', {
            ...
            hidden: !z,
            children: [
             (0, j.jsx)(s.M, { codeBlockLabel: 'Codevoorbeeld', syntax: v, textContent: w, trim: !0 }),
             n &&
              (0, j.jsx)('div', {
