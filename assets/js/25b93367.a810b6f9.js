(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [98634],
 {
  ...
  43205: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => I, component: () => J, contentTitle: () => H, default: () => q, description: () => X, frontMatter: () => O, issueNumber: () => K, metadata: () => U, title: () => $, toc: () => B });
   var r,
    i,
    o,
    s,
   ...
   function f(e = {}) {
    ...
    return n ? (0, u.jsx)(n, { ...e, children: (0, u.jsx)(k, { ...e }) }) : k(e);
   }
   var y = t(25093),
    b = t(31573),
    x = t(53590),
    ...
    V = t(55240),
    E = t(8657);
   const O = { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.', slug: '/link' },
    H = void 0,
    U = { id: 'componenten/link/index', title: 'Link', description: 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.', source: '@site/docs/componenten/link/index.mdx', sourceDirName: 'componenten/link', slug: '/link', permalink: '/link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.', slug: '/link' }, sidebar: 'componenten', previous: { title: 'Language Navigation', permalink: '/language-navigation' }, next: { title: 'Link List', permalink: '/link-list' } },
    I = {},
    B = [
    ...
    $ = 'Link',
    X = 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.',
    K = 118,
    J = g.find((e) => e.number === K);
   function Y(e) {
    ...
    return (0, u.jsxs)(u.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, u.jsx)(E.Rv, { component: J, headingLevel: 1, description: X }),
      '\n',
      (0, u.jsx)(F.I, { component: J }),
      '\n',
      (0, u.jsx)(n.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, u.jsx)(M.B, { component: J, illustration: w }),
      '\n',
      (0, u.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, u.jsx)(E.cN, { component: J, headingLevel: 3 }),
      '\n',
      (0, u.jsx)(n.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, u.jsx)(E.W, { component: J, headingLevel: 3 }),
      '\n',
      ...
      (0, u.jsx)(V.t, {
       ...
       items: [
        ...
        { title: 'De linktekst van de Link vertelt eenduidig aan de gebruiker waar de link naar toe gaat (het linkdoel).', sc: '2.4.4', status: '', component: (0, u.jsx)(S.ZP, {}) },
        { title: 'De zichtbare naam van de Link komt voor in de toegankelijke naam', sc: '2.5.3', status: '', component: (0, u.jsx)(L.ZP, {}) },
        { title: 'Als de tekst van de Link in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode', sc: '3.1.2', status: '', component: (0, u.jsx)(W.ZP, {}) },
       ],
      }),
      '\n',
      (0, u.jsx)(V.t, {
       ...
       items: [
        ...
        { title: 'De Link heeft een goed zichtbare focusindicator', sc: '2.4.13', status: '', component: (0, u.jsx)(z.ZP, {}) },
        { title: 'De Link heeft een aanklikbaar gedeelte van ten minste 44 bij 44 pixels', sc: '2.5.5', status: '', component: (0, u.jsx)(Z.ZP, {}) },
        { title: 'Links met gelijke functies hebben hetzelfde uiterlijk en hetzelfde label', sc: '3.2.4', status: '', component: (0, u.jsx)(R.ZP, {}) },
       ],
      }),
      '\n',
      (0, u.jsx)(V.t, {
      ...
      (0, u.jsx)(V.t, {
       ...
       items: [
        ...
        { title: 'De functionaliteit van de Link veroorzaakt geen toetsenbordval', sc: '2.1.2', status: '', component: (0, u.jsx)(P.ZP, {}) },
        { title: 'Wanneer de Link de toetsenbordfocus krijgt is de focus zichtbaar', sc: '2.4.7', status: '', component: (0, u.jsx)(T.ZP, {}) },
        { title: 'Als de Link de toetsenbordfocus krijgt, is het element niet volledig bedekt door andere inhoud', sc: '2.4.11', status: '', component: (0, u.jsx)(_.ZP, {}) },
        { title: 'Als de gebruiker de Link indrukt met een aanwijzer zoals een muis of vinger, is er de mogelijkheid is om actie te voorkomen of ongedaan te maken', sc: '2.5.2', status: '', component: (0, u.jsx)(G.ZP, {}) },
       ],
      }),
      '\n',
      (0, u.jsx)(V.t, {
       ...
       items: [
        ...
        { title: 'De Link heeft een rol van link en een toegankelijke naam die duidelijk maakt waar de Link voor dient', sc: '4.1.2', status: '', component: (0, u.jsx)(D.ZP, {}) },
       ],
      }),
      '\n',
      (0, u.jsx)(n.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }),
      '\n',
      (0, u.jsx)(E.vM, { component: J, headingLevel: 3 }),
     ],
    });
   }
   function q(e = {}) {
