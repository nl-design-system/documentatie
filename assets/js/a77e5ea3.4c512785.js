...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [66449],
 {
  ...
  19879(e, n, t) {
   (t.r(n), t.d(n, { assets: () => P, component: () => $, contentTitle: () => M, default: () => X, description: () => E, frontMatter: () => I, issueNumber: () => O, metadata: () => a, title: () => V, toc: () => W }));
   ...
   const T = [
     ...
     { title: 'Het gedrag van de accordion is voorspelbaar', sc: '3.2.1', status: '', component: R.Ay },
     {
  ...
  21034(e, n, t) {
   ...
   const b = ({ component: e, headingLevel: n }) => {
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(g.p, { level: n, suffix: i && (0, d.jsx)(u.D, { state: i }), children: e.title }), (0, d.jsx)(a.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(i) && (0, d.jsx)(x.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    w = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
