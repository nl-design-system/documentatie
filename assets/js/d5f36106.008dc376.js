 ...
 [38662],
 {
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    u = n(83386),
    l = n(86070);
   const h = { figma: (0, l.jsx)(c.A, {}), github: (0, l.jsx)(i.A, {}), npm: (0, l.jsx)(o.A, {}), storybook: (0, l.jsx)(a.A, {}) },
   ...
   const k = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    f = ({ checked: e, children: t, title: n, description: r, headingLevel: c = 3 }) => (0, l.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(v.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.DZ, { appearance: 'utrecht-heading-3', level: c, children: n }), r, t] })] });
   var x = n(75916);
   const _ = ({ component: e, headingLevel: t }) => {
            ...
            j.Zp,
            {
             ...
             children: (0, l.jsxs)(j.Wu, {
              children: [
               ...
               c.length > 0 && (0, l.jsx)(l.Fragment, { children: c.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [s, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    N = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p.p, { level: t, suffix: s && (0, l.jsx)(m.D, { state: s }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  74111: (e, t, n) => {
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => p, GT: () => k, KF: () => h, Pc: () => o, Pv: () => g, Rc: () => f, bo: () => r, eQ: () => b, f4: () => i, fX: () => s, kD: () => v, mJ: () => y, o_: () => m, qZ: () => c });
