...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  87895: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => j, contentTitle: () => u, default: () => x, frontMatter: () => g, metadata: () => m, toc: () => v });
   var r = i(52676),
    t = i(40139),
    o = i(57716),
    d = i(46364),
   ...
   function h(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Wordt er in een video informatie getoond die niet wordt voorgelezen? Zorg er dan voor dat een blinde of slechtziende gebruiker deze informatie ook meekrijgt.' }), '\n', (0, r.jsx)(n.p, { children: 'Bijvoorbeeld: er staat een telefoonnummer in beeld, maar dit nummer wordt niet voorgelezen.' }), '\n', (0, r.jsx)(n.p, { children: 'Een oplossing is om een audiodescription toe te voegen, waarin het telefoonnummer wordt uitgesproken. Het beste is natuurlijk om alle belangrijke informatie voor te lezen in de video zelf.' })] });
   }
   function p(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(h, { ...e }) }) : h(e);
   }
   const g = { title: 'WCAG-succescriterium 1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', pagination_label: 'WCAG-succescriterium 1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', description: 'Wordt er in een video informatie getoond die niet wordt voorgelezen? Zorg er dan voor dat een blinde of slechtziende gebruiker deze informatie ook meekrijgt.', slug: '1.2.3', keywords: ['WCAG', 'A', 'waarneembaar', 'op tijd gebaseerde media', 'perceivable', 'time-based media', 'audio description or media alternative (prerecorded)', 'audiodescriptie', 'media-alternatief', 'vooraf opgenomen', 'audio description', 'media alternative', 'prerecorded'] },
    u = void 0,
    m = { id: 'wcag/1.2.03', title: 'WCAG-succescriterium 1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', description: 'Wordt er in een video informatie getoond die niet wordt voorgelezen? Zorg er dan voor dat een blinde of slechtziende gebruiker deze informatie ook meekrijgt.', source: '@site/docs/wcag/1.2.03.mdx', sourceDirName: 'wcag', slug: '/wcag/1.2.3', permalink: '/wcag/1.2.3', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.2.03.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', pagination_label: 'WCAG-succescriterium 1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)', description: 'Wordt er in een video informatie getoond die niet wordt voorgelezen? Zorg er dan voor dat een blinde of slechtziende gebruiker deze informatie ook meekrijgt.', slug: '1.2.3', keywords: ['WCAG', 'A', 'waarneembaar', 'op tijd gebaseerde media', 'perceivable', 'time-based media', 'audio description or media alternative (prerecorded)', 'audiodescriptie', 'media-alternatief', 'vooraf opgenomen', 'audio description', 'media alternative', 'prerecorded'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.2.2 Ondertitels voor doven en slechthorenden (vooraf opgenomen)', permalink: '/wcag/1.2.2' }, next: { title: 'WCAG-succescriterium 1.2.4 Ondertitels voor doven en slechthorenden (live)', permalink: '/wcag/1.2.4' } },
    j = {},
    v = [
