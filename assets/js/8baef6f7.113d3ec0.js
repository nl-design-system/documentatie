(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [41102],
 {
  ...
  33037(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => R, component: () => I, contentTitle: () => T, default: () => G, description: () => L, frontMatter: () => N, issueNumber: () => C, metadata: () => i, title: () => S, toc: () => F }));
   ...
   const w = [
     ...
     { title: 'Als een icon een status aangeeft, is die informatie niet alleen afhankelijk van kleur.', sc: '1.4.1', status: '', component: t(44720).Ay, tags: ['designer'] },
     {
   ...
   const N = { title: 'Icon', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Icon', pagination_label: 'Icon', description: 'Grafisch symbool dat visueel informatie geeft over een actie, onderwerp of status.', slug: '/icon', keywords: ['afbeelding', 'button icon', 'caret', 'emoji', 'glyph', 'graphic', 'icon', 'icoon', 'illustratie', 'illustration', 'logo', 'picto', 'pictogram', 'plaatje', 'svg', 'svg icon', 'symbol', 'symbool'] },
    ...
    R = {},
    S = 'Icon',
    L = 'Grafisch symbool dat visueel informatie geeft over een actie, onderwerp of status.',
    C = 275,
    I = l.find((e) => e.number === C),
