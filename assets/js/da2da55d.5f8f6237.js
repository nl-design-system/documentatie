(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [95102],
 {
  24784: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => g, contentTitle: () => a, default: () => m, description: () => j, frontMatter: () => o, issueNumber: () => y, metadata: () => u, title: () => d, toc: () => h });
   var r = n(52676),
    i = n(40139),
    c = n(99890),
    s = n(8657);
   const o = { title: 'Heading Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading Group', pagination_label: 'Heading Group', description: 'Combinatie van een koptekst en ondersteunende tekst.', slug: '/heading-group', keywords: ['caption', 'caption group', 'content', 'heading', 'heading group', 'headline', 'kop', 'onderschrift', 'paginakop', 'pre heading', 'sectie', 'section', 'section group', 'structure', 'subkop', 'titel', 'titelgroep', 'title', 'title group', 'voorloopkop'] },
    ...
    d = 'Heading Group',
    j = 'Combinatie van een koptekst en ondersteunende tekst.',
    y = 248,
  ...
  8657: (e, t, n) => {
   ...
   const _ = (e) => {
    ...
    A = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(m.V, { level: n, suffix: c && (0, l.jsx)(p.y, { state: c }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => o, Ee: () => l, Q6: () => c, U: () => j, Yr: () => m, d: () => h, e9: () => s, fO: () => k, mA: () => i, ps: () => y, qU: () => b, s0: () => v, zP: () => g });
