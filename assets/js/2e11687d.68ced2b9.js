 ...
 [71537],
 {
  ...
  17889(e, n, t) {
   ...
   var j = t(35193),
    ...
    y = t(79532),
    w = t(30758);
   const D = { color: j.A, dimension: u.A, fontFamilies: x.A, fontSizes: k.A, fontWeights: b.A, lineHeights: f.A, other: v.A, textDecoration: y.A },
    A = ({ type: e }) => (0, p.jsx)(g.In, { children: (0, w.createElement)(D[e]) });
   function S({ tokens: e }) {
    const n = (0, s.kD)(e),
     t = (0, s.GT)(n),
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => g, mJ: () => j, VZ: () => D, cR: () => w, Pv: () => u, qZ: () => r, kD: () => f, B2: () => p, Pc: () => d, f4: () => o, GT: () => v, fX: () => s, eQ: () => b, B_: () => k, o_: () => x, Rc: () => y });
