  ...
  4460: (e, n, t) => {
   ...
   const f = 'task-list_hh8j',
    ...
    N = (e) => {
     ...
     return (0, d.jsxs)('li', { className: (0, i.Z)(_), children: [(0, d.jsxs)('div', { className: (0, i.Z)(w, { [z]: n }), children: [(0, d.jsx)('span', { className: C, children: n ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), n && (0, d.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(x.aC, { role: 'presentation', children: t }), (0, d.jsx)(x.nv, { children: r })] })] });
    };
   var S = t(14669);
   const G = (e) => {
     let { component: n, headingLevel: t } = e;
     const a = n && n.projects.filter((e) => S.e9.includes(e.id)),
      s = a && S.e9.map((e) => a.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, d.jsx)(A, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(N, { checked: n, title: t, description: (0, S.Q6)(r) }, r);
            }),
           }),
    ...
    D = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(k, { level: t, suffix: a && (0, d.jsx)(v.y, { state: a }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  80407: (e, n, t) => {
   'use strict';
