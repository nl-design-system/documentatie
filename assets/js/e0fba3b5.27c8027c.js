 ...
 [55579],
 {
  14881(e, n, t) {
   ...
   var s = t(13526),
    ...
    r = t(37168),
    a = t(86070);
   const i = (0, o.forwardRef)(({ as: e, className: n, children: t, ...o }, l) => {
     const r = e || 'div',
      i = (0, s.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(r, { ref: l, className: i, ...o, children: t });
    }),
    d = ({ className: e, classNamePanel: n, label: t, heading: o, headingLevel: i, headingApperance: d, ...c }) => {
     const k = (0, s.A)('utrecht-accordion__section', e),
      u = (0, s.A)('utrecht-accordion__panel', n);
     return (0, a.jsxs)('details', { className: k, ...c, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(l.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [o && (0, a.jsx)(r.D, { level: i, appearance: d, children: o }), t] })] }) }), (0, a.jsx)('div', { className: u, children: c.children })] });
    };
  },
  18439(e, n, t) {
   t.d(n, { R: () => r, x: () => a });
  ...
  28369(e, n, t) {
   ...
   function d({ lineNumber: e, syntax: n, textContent: t, trim: d }) {
    let c = t;
    const { title: k, type: u } = (0, l.useContext)(r.x),
     h = (0, l.useId)();
    return (d && (c = c.trim()), (0, i.jsx)(o.f4, { theme: a, code: c, language: n || '', children: ({ style: n, tokens: t, getLineProps: o, getTokenProps: l }) => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', k ? ': ' : ' ', k] }), (0, i.jsx)(s.NG, { tabIndex: 0, role: k ? 'region' : void 0, 'aria-labelledby': h, style: n, children: t.map((n, t) => (0, i.jsxs)('span', { ...o({ line: n }), children: [e && (0, i.jsx)('span', { children: t + 1 }), n.map((e, n) => (0, i.jsx)('span', { ...l({ token: e }) }, n)), '\n'] }, t)) })] }) }));
   }
  },
  29043(e, n, t) {
   (t.r(n), t.d(n, { assets: () => k, contentTitle: () => c, default: () => p, frontMatter: () => d, metadata: () => s, toc: () => u }));
  ...
  38953(e, n, t) {
   ...
   var s = t(28369),
    ...
    m = t(46847),
    j = t(86070);
   const v = ({ children: e }) => (0, j.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(o.yo, { className: (0, l.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, j.jsx)(o.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   v.displayName = 'ParagraphContainer';
   const b = ({ children: e }) => (0, j.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(o.yo, { className: (0, l.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   b.displayName = 'DocumentContainer';
   const x = ({ children: e }) => (0, j.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: e });
   x.displayName = 'SurfaceContainer';
   const y = globalThis.isAstro
    ? ({ language: e, className: n, code: t = '<p>No code provided</p>', rawCode: s, copyCode: o, defaultExpandedCode: r, designTokens: a }) => {
       const i = 'string' == typeof t ? t : s || '',
        d = 'string' == typeof t ? p().highlight(t, p().languages[e], e) : p().highlight(s || '', p().languages[e], e);
       return (0, j.jsxs)('div', { className: (0, l.A)('ma-canvas-astro', n), children: [(0, j.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: a, children: (0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: i } }) }), (0, j.jsx)(g.n, { children: (0, j.jsxs)(g.K, { label: 'Code', open: r, children: [(0, j.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: d } }) }), 'allow' === o && (0, j.jsx)(m.$, { 'data-copy-code': i, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: h = !0, children: p, container: g = 'document', language: m, designTokens: y }) => {
       ...
       (0, k.useEffect)(() => {
        (async () => {
         const e = await c.Ay.format(z, { parser: m, plugins: [r.A, a.Ay, i.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         N(e);
        })();
       }, [z]);
       const S = (0, k.useId)();
       let L = k.Fragment;
       return (
        'paragraph' === g ? (L = v) : 'document' === g ? (L = b) : 'surface' === g && (L = x),
        (0, j.jsxs)('div', {
         className: (0, l.A)('nlds-canvas'),
         children: [
          f && (0, j.jsx)('div', { className: (0, l.A)('nlds-canvas__example'), children: (0, j.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, j.jsx)(L, { children: (0, j.jsx)(o.v$, { children: f }) }) }) }),
          h &&
           (0, j.jsx)('div', {
          ...
          h &&
           (0, j.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, j.jsx)(s.M, { codeBlockLabel: 'Codevoorbeeld', syntax: m, textContent: w, trim: !0 }),
             n &&
              (0, j.jsx)('div', {
