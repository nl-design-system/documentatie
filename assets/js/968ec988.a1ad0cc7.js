...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [19207],
 {
  ...
  60015: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => h, contentTitle: () => b, default: () => g, frontMatter: () => m, metadata: () => p, toc: () => v });
   var o = t(52676),
    l = t(24785),
    r = t(55400),
    i = t(43599),
  ...
  43599: (e, n, t) => {
   ...
   const p = (e) => {
    let { children: n } = e;
    return (0, b.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(o.BB, { className: (0, r.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, b.jsx)(o.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   p.displayName = 'ParagraphContainer';
   const h = (e) => {
    let { children: n } = e;
    return (0, b.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(o.BB, { className: (0, r.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   h.displayName = 'DocumentContainer';
   const v = (e) => {
    let { children: n } = e;
    return (0, b.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: n });
   };
   ...
   const x = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (C = await c.ZP.format(N, { parser: f, plugins: [i.Z, s.ZP, a.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(C);
     })();
    }, [N]);
    const F = (0, u.useId)();
    let P = u.Fragment;
    return (
     'paragraph' === y ? (P = p) : 'document' === y ? (P = h) : 'surface' === y && (P = v),
     (0, b.jsxs)('div', {
      className: (0, r.Z)('nlds-canvas'),
      children: [
       _ && (0, b.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, b.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, b.jsx)(P, { children: (0, b.jsx)(o.pu, { children: _ }) }) }) }),
       g &&
        (0, b.jsx)('div', {
       ...
       g &&
        (0, b.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, b.jsx)(l.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: C, trim: !0 }),
          t &&
           (0, b.jsx)('div', {
    ...
    return (
     ...
     (0, a.jsx)(l.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', b ? `\u201c${b}\u201d` : '', ' ', m ? ': ' : ' ', m] }), (0, a.jsx)(o.dn, { tabIndex: 0, role: m ? 'region' : void 0, 'aria-labelledby': p, style: t, children: l.map((e, t) => (0, a.jsxs)('span', { ...r({ line: e }), children: [n && (0, a.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
