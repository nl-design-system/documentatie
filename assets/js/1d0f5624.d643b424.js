...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [58293],
 {
  ...
  58639(e, n, o) {
   ...
   const b = ({ children: e }) => (0, u.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, u.jsx)(r.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   b.displayName = 'DocumentContainer';
   const g = ({ children: e }) => (0, u.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: e });
   g.displayName = 'SurfaceContainer';
   const v = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: v = !0, children: j, container: y = 'document', language: x, designTokens: f }) => {
    ...
    let z = p.Fragment;
    return (
     'paragraph' === y ? (z = m) : 'document' === y ? (z = b) : 'surface' === y && (z = g),
     (0, u.jsxs)('div', {
  ...
  73033(e, n, o) {
   (o.r(n), o.d(n, { assets: () => v, contentTitle: () => g, default: () => x, frontMatter: () => b, metadata: () => l, toc: () => j }));
