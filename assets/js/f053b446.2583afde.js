 ...
 [49189],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    l = n(86070);
   const d = { figma: (0, l.jsx)(s.A, {}), github: (0, l.jsx)(o.A, {}), npm: (0, l.jsx)(i.A, {}), storybook: (0, l.jsx)(c.A, {}) },
  ...
  45282(e, t, n) {
   ...
   const o = ({ children: e, ...t }) => {
     ...
     return ('https://nldesignsystem.nl' === c.origin ? ((c.pathname = c.pathname.endsWith('/') ? c.pathname : `${c.pathname}/`), (i = c.toString().replace('https://nldesignsystem.nl', ''))) : ((o.target = '_blank'), (o.rel = 'noopener noreferrer')), (0, s.jsx)('a', { href: i, ...o, children: e }));
    },
    i = ({ className: e, ...t }) => (0, s.jsx)(o, { className: (0, r.$)('utrecht-link', 'utrecht-link--html-a', e), ...t });
  },
  46072(e, t, n) {
   'use strict';
   n.d(t, { NO: () => o, pI: () => i });
  ...
  81330(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => _, component: () => L, contentTitle: () => N, default: () => P, description: () => S, frontMatter: () => W, issueNumber: () => D, metadata: () => r, title: () => z, toc: () => F }));
     ...
     children: [
      ...
      (0, s.jsx)(A.b, {
       ...
       items: [
        ...
        { title: 'De code heeft voldoende contrast met de achtergrondkleur.', sc: '1.4.3', status: '', component: (0, s.jsx)(g.Ay, {}), tags: ['designer', 'contentmaker'] },
        { title: 'Wanneer de achtergrondkleur van de Code component anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina.', sc: '1.4.11', status: '', component: (0, s.jsx)(u.Ay, {}), tags: ['designer', 'contentmaker'] },
       ],
      }),
      '\n',
      ...
      (0, s.jsx)(A.b, {
       headingLevel: '4',
       items: [
        { title: 'Het juiste HTML-element voor de Code component is toegepast.', sc: '1.3.1', status: '', component: (0, s.jsx)(h, {}), tags: ['developer'] },
        { title: 'Als je inzoomt naar 200% blijft alle tekst leesbaar.', sc: '1.4.4', status: '', component: (0, s.jsx)(p.Ay, {}), tags: ['developer'] },
      ...
      '\n',
      (0, s.jsx)(x.VK, { component: L, headingLevel: 3 }),
      '\n',
      (0, s.jsx)(x.$9, { component: L, headingLevel: 2 }),
      '\n',
      (0, s.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
      '\n',
      (0, s.jsx)(x.mu, { component: L, headingLevel: 3 }),
     ],
    });
   }
   function P(e = {}) {
  ...
  85825(e, t, n) {
   ...
   const p = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    j = ({ checked: e, children: t, title: n, description: r, headingLevel: o = 3 }) => (0, l.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(g.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [n ? (0, l.jsx)(m.DZ, { appearance: 'utrecht-heading-3', level: o, children: n }) : null, r, t] })] });
   var w = n(33062);
   const y = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, l.jsx)(r.If, { sections: o.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, w.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(j, { headingLevel: t + 1, checked: e, title: n, description: (0, w.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
                 ...
                 children: (0, l.jsx)(r.dk, {
                  links: h
                   ...
                   .map((e) => {
                    ...
                    return { children: t.desciption, icon: (0, l.jsx)(o.r, { brand: t.brand }), href: e.value };
                   }),
                 }),
                }),
               c.length > 0 && (0, l.jsx)(l.Fragment, { children: c.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [s, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
