...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [94730],
 {
  ...
  25275: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => j, contentTitle: () => h, default: () => v, frontMatter: () => m, metadata: () => p, toc: () => b });
   var o = l(52676),
    r = l(24785),
    t = l(55400),
    i = l(43599),
  ...
  43599: (e, n, l) => {
   ...
   const p = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(o.BB, { className: (0, t.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, h.jsx)(o.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   p.displayName = 'ParagraphContainer';
   const j = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(o.BB, { className: (0, t.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const g = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (Z = await d.ZP.format(N, { parser: f, plugins: [i.Z, s.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(Z);
     })();
    }, [N]);
    const F = (0, u.useId)();
    let S = u.Fragment;
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       _ && (0, h.jsx)('div', { className: (0, t.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, h.jsx)(S, { children: (0, h.jsx)(o.pu, { children: _ }) }) }) }),
       v &&
        (0, h.jsx)('div', {
       ...
       v &&
        (0, h.jsxs)('div', {
         ...
         hidden: !z,
         children: [
          (0, h.jsx)(r.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: Z, trim: !0 }),
          l &&
           (0, h.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: l, textContent: c, trim: d } = e,
     u = c;
    const { title: m, type: h } = (0, t.useContext)(i.n),
     p = (0, t.useId)();
    return (
     d && (u = u.trim()),
     (0, a.jsx)(r.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', m ? ': ' : ' ', m] }), (0, a.jsx)(o.dn, { tabIndex: 0, role: m ? 'region' : void 0, 'aria-labelledby': p, style: l, children: r.map((e, l) => (0, a.jsxs)('span', { ...t({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
