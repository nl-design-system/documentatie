...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [46103],
 {
  ...
  78856: (e, t, o) => {
   ...
   var h = o(8143),
    p = o(50687);
   const g = { container: 'container_lHm_' };
   function b(e) {
    let { readingTime: t } = e;
    const o = (function () {
   ...
   const k = { authorCol: 'authorCol_aRFS', imageOnlyAuthorRow: 'imageOnlyAuthorRow_wd6X', imageOnlyAuthorCol: 'imageOnlyAuthorCol_pBq9' };
   function P(e) {
    let { className: t } = e;
    const {
     metadata: { authors: o },
   ...
   const I = { blogPostFooterDetailsFull: 'blogPostFooterDetailsFull_HJ7t' };
   function M() {
   ...
   function E(e) {
    ...
    return (0, c.jsxs)($.Z, { breadcrumbs: [{ label: 'Blog', href: '/blog' }, { label: l.title }], sidebar: t, toc: !d && r.length > 0 ? (0, c.jsx)(O.Z, { toc: r, minHeadingLevel: m, maxHeadingLevel: u }) : void 0, children: [(0, c.jsx)(A, { children: o }), (n || a) && (0, c.jsx)(L, { nextItem: n, prevItem: a })] });
   }
   function U(e) {
    const t = e.content;
    return (0, c.jsx)(s.n, { content: e.content, isBlogPostPage: !0, children: (0, c.jsxs)(l.FG, { className: (0, n.Z)(r.k.wrapper.blogPages, r.k.page.blogPostPage), children: [(0, c.jsx)(S, {}), (0, c.jsx)(E, { sidebar: e.sidebar, children: (0, c.jsx)(t, {}) })] }) });
   }
  },
  21581: (e, t, o) => {
   o.d(t, { Z: () => g });
