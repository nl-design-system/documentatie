...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [58973],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => a, KF: () => u, mJ: () => h, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => i, kD: () => b, B2: () => p, Pc: () => l, f4: () => s, GT: () => _, fX: () => o, eQ: () => x, B_: () => j, o_: () => v, Rc: () => k });
     ...
     return n.map((n) => {
      const r = e.tasks
       ...
       .map(({ name: r, id: a, value: o }) => {
        ...
        return { brand: i.toLowerCase(), name: r, id: a, value: o, description: s };
       });
            ...
            i.Zp,
            {
             ...
             children: (0, d.jsxs)(i.Wu, {
              children: [
               ...
               (m.length > 0 || s.length > 0) && (0, d.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               m.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               s.length > 0 && (0, d.jsx)(d.Fragment, { children: s.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, d.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  72642(e, n, t) {
   ...
   var r = t(13526),
    a = t(86070);
   const o = ({ children: e, className: n, level: t = 1, suffix: o, ...i }) => (0, a.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${t}`, n), ...i, children: [(0, a.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), o && (0, a.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
  },
  90495(e, n, t) {
   ...
   var r = t(46447),
    a = t(13526),
    o = t(86070);
   const i = ({ background: e, children: n, className: t, ...r }) => (0, o.jsx)('div', { className: (0, a.A)('card__illustration', e && `card__illustration--${e}`, t), ...r, children: n }),
    ...
    l = ({ href: e, appearance: n, className: t, component: i = 'div', background: s, children: l }) => {
     const d = (e) => ('article' === i ? (0, o.jsx)('article', { ...e }) : 'section' === i ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      c = (0, o.jsx)(d, { className: (0, a.A)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: l });
