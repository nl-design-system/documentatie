 ...
 [90316],
 {
  50029: (e, n, i) => {
   ...
   const c = { title: 'WCAG-succescriterium 1.4.2 Geluidsbediening', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.2 Geluidsbediening', pagination_label: 'WCAG-succescriterium 1.4.2 Geluidsbediening', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', slug: '1.4.2', keywords: ['WCAG'] },
    u = void 0,
    g = { id: 'wcag/1.4.02', title: 'WCAG-succescriterium 1.4.2 Geluidsbediening', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', source: '@site/docs/wcag/1.4.02.mdx', sourceDirName: 'wcag', slug: '/wcag/1.4.2', permalink: '/wcag/1.4.2', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.02.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.4.2 Geluidsbediening', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.2 Geluidsbediening', pagination_label: 'WCAG-succescriterium 1.4.2 Geluidsbediening', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', slug: '1.4.2', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.4.1 Gebruik van kleur', permalink: '/wcag/1.4.1' }, next: { title: 'WCAG-succescriterium 1.4.3 Contrast (minimum)', permalink: '/wcag/1.4.3' } },
    h = {},
    p = [
