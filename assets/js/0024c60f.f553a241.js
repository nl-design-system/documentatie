 ...
 [73512],
 {
  ...
  21034(e, n, t) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, g.jsx)(x.n, { children: s.map((t) => (0, g.jsx)(x.K, { className: (0, o.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, f.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(j._, { children: t.tasks.map(({ checked: e, name: t, id: r }) => (0, g.jsx)(j.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, f.qZ)(r) }, r)) }), (0, g.jsx)(r.fz, { children: (0, g.jsxs)(r.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
    k = ({ component: e, headingLevel: n }) => {
     ...
     return e && t.length
            ...
            ? (0, g.jsx)(
               c.Z,
               {
                ...
                description: (0, g.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, g.jsxs)(i.f, { children: [(0, g.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, g.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, g.jsxs)('div', {
                   children: [
                    (h.length > 0 || d.length > 0) && (0, g.jsx)(s.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    h.length > 0 &&
                     (0, g.jsx)(r.dk, {
                      links: h
                       ...
                       .map((e) => {
                        ...
                        return { children: n.desciption, icon: (0, g.jsx)(a.r, { brand: n.brand }), href: e.value };
                       }),
                     }),
                   ],
                  }),
                  d.length > 0 && d.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)('section', { children: [(0, g.jsxs)(s.DZ, { level: Math.min(n + 2, 6), children: [o, ' in ', e] }), (0, g.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(a.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
            ...
            : (0, g.jsx)(
               l.Zp,
               {
                ...
                children: (0, g.jsxs)(l.Wu, {
                 children: [
                  (0, g.jsx)(r.DZ, { level: n, children: e.title.replace(/^Community/i, '') }),
                  (0, g.jsxs)(r.fz, { children: [(0, g.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, g.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (h.length > 0 || d.length > 0) && (0, g.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  h.length > 0 &&
                   (0, g.jsx)(g.Fragment, {
                    children: (0, g.jsx)(r.dk, {
                     links: h
                      .filter((e) => !!u.get(e.name))
                      .map((e) => {
                       const n = u.get(e.name);
                  ...
                  d.length > 0 && (0, g.jsx)(g.Fragment, { children: d.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)(g.Fragment, { children: [(0, g.jsxs)(r.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, g.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(a.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
      ...
      : (0, g.jsx)(r.fz, { children: 'Er zijn nog geen implementaties' });
    },
    A = ({ component: e, headingLevel: n }) => {
     const t = e?.projects.find((e) => 'HELP_WANTED' === e.id),
      s = t?.tasks.find((e) => 'PVTF_lADOBGdlVM4AdX8lzgcig7o' === e.id)?.value;
     return e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(r.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, g.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, g.jsxs)(r.Xy, { children: [s ? (0, g.jsxs)(r.Er, { children: ['Vul de ', (0, g.jsx)(r.N_, { href: s, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, g.jsxs)(r.Er, { children: [(0, g.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, g.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, g.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, g.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    y = ({ component: e, headingLevel: n, description: t }) => {
     const s = e && f.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(p.p, { level: n, suffix: s && (0, g.jsx)(h.D, { state: s }), children: e.title }), (0, g.jsx)(r.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(s) && (0, g.jsx)(b.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    C = ({ component: e }) => {
     const n = (e && w[e.title]) || [];
     return n.length > 0 && (0, g.jsxs)(r.fz, { children: ['Gerelateerde componenten:', ' ', n.map((e, t) => (0, g.jsxs)(g.Fragment, { children: [e.slug ? (0, g.jsx)(r.N_, { href: `/${e.slug}/`, children: e.name }) : e.name, t < n.length - 1 ? ', ' : '.'] }))] });
    };
  },
  21530(e, n, t) {
   'use strict';
   ...
   var r = t(46447),
    s = t(13526),
    i = t(86070);
   const o = ({ background: e, children: n, className: t, ...r }) => (0, i.jsx)('div', { className: (0, s.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, t), ...r, children: n }),
    a = (e) => (0, i.jsx)('div', { className: 'ma-card__content', ...e }),
    l = ({ href: e, appearance: n, className: t, component: o = 'div', background: a, children: l }) => {
     const c = (e) => ('article' === o ? (0, i.jsx)('article', { ...e }) : 'section' === o ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      d = (0, i.jsx)(c, { className: (0, s.A)('ma-cardgroup__card', a && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, t), children: l });
     return e ? (0, i.jsx)(r.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: d }) : d;
    },
    c = ({ appearance: e = 'large', children: n, className: t }) => (0, i.jsx)('div', { className: (0, s.A)('ma-cardgroup', `ma-cardgroup--${e}`, t), children: n });
  },
  22068(e, n, t) {
   'use strict';
   t.d(n, { P: () => r.Pt, d: () => r.dk });
  ...
  32385(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => g, mJ: () => p, VZ: () => A, cR: () => k, Pv: () => j, qZ: () => o, kD: () => b, QQ: () => C, B2: () => m, Pc: () => l, f4: () => a, GT: () => v, fX: () => i, eQ: () => x, B_: () => w, o_: () => f });
  ...
  39569(e, n, t) {
   ...
   const a = ({ state: e }) => {
    const n = (0, i.fX)(e);
    return (0, o.jsx)(r.KE, { className: (0, s.A)('ma-estafette-badge', n && `ma-estafette-badge--${n}`), children: e });
   };
  },
  40889(e, n, t) {
   'use strict';
   ...
   var r = t(29181),
    ...
    l = t(83386),
    c = t(86070);
   const d = { figma: (0, c.jsx)(s.A, {}), github: (0, c.jsx)(i.A, {}), npm: (0, c.jsx)(o.A, {}), storybook: (0, c.jsx)(a.A, {}) },
  ...
  51582(e, n, t) {
   ...
   const o = (e, n) => {
    ...
    d = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: s = '', components: o = {} }) => (0, i.jsx)(r.x, { components: { ...c(n, t), ...l(s), ...o }, children: e });
  },
  54909(e, n, t) {
   'use strict';
   t.d(n, { Ay: () => a, RM: () => i });
  ...
  59778(e, n, t) {
   ...
   const a = ({ component: e }) => {
    ...
    return (0, o.jsx)(s.Suspense, { fallback: null, children: (0, o.jsx)(r.o, { omitH1: !0, headingLevel: 1, children: (0, o.jsx)(l, {}) }) });
   };
  },
  66581(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => B, component: () => E, contentTitle: () => P, default: () => Z, description: () => M, frontMatter: () => z, issueNumber: () => O, metadata: () => r, title: () => I, toc: () => $ }));
   ...
   function p(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(n.p, { children: 'Vertel in tekst welke kleur wordt weergegeven. Denk hierbij bijvoorbeeld de naam van de kleur, de hex-code of de hsl-waarde, de transparantie, het doel van de kleur, de CSS-class.' }), '\n', (0, s.jsxs)(n.p, { children: ['Dan is het voor gebruikers van ', (0, s.jsx)(n.a, { href: '/woordenlijst/#screenreader', children: 'screenreaders' }), ' en mensen die slechtziend of kleurenblind zijn ook duidelijk welke kleur bedoeld wordt.'] }), '\n', (0, s.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, s.jsxs)(n.ul, { children: ['\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/stijl/kleuren/niet-kleur-alleen/', children: 'Vertrouw niet op kleur alleen' }) }), '\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/stijl/kleuren/waarneming/', children: 'Let op verschillen in waarneming van kleur' }) }), '\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/content/afbeeldingen/informatieve-afbeeldingen/', children: 'Informatieve afbeeldingen' }) }), '\n'] })] });
   }
   function j(e) {
    const n = { a: 'a', code: 'code', li: 'li', p: 'p', ul: 'ul', ...(0, i.R)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(n.p, { children: ['Een gebruiker van een ', (0, s.jsx)(n.a, { href: '/woordenlijst/#screenreader', children: 'screenreader' }), ' kan herkennen welk kleurvlak bij welke eigenschappen hoort.\nDit is niet alleen via de visuele informatie beschikbaar, maar ook vanuit de semantiek van de HTML-code.'] }), '\n', (0, s.jsxs)(n.p, { children: ['Dit kan bijvoorbeeld door het weergeven van het kleurvlak en de data in een tabel ', (0, s.jsx)(n.code, { children: '<table>' }), ', een description list ', (0, s.jsx)(n.code, { children: '<dl>' }), ' of in een ongenummerde lijst ', (0, s.jsx)(n.code, { children: '<ul>' }), '.'] }), '\n', (0, s.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, s.jsxs)(n.ul, { children: ['\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/content/tekstopmaak/opsommingen/', children: 'Opsommingen' }) }), '\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/content/tekstopmaak/tabellen/', children: 'Tabellen' }) }), '\n'] })] });
   }
   function f(e) {
    const n = { a: 'a', code: 'code', li: 'li', p: 'p', ul: 'ul', ...(0, i.R)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(n.p, { children: ['De Color Sample kan worden voorzien van een beschrijvende alternatieve tekst, doordat ', (0, s.jsx)(n.code, { children: 'aria-label' }), ' of ', (0, s.jsx)(n.code, { children: 'aria-labelledby' }), ' in de component gebruikt kan worden.'] }), '\n', (0, s.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, s.jsxs)(n.ul, { children: ['\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/content/afbeeldingen/informatieve-afbeeldingen/', children: 'Informatieve afbeeldingen' }) }), '\n'] })] });
   }
   function w(e) {
    const n = { a: 'a', code: 'code', li: 'li', p: 'p', ul: 'ul', ...(0, i.R)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(n.p, { children: ['De Color Sample is herkenbaar als afbeelding voor gebruikers van hulpsoftware, zoals ', (0, s.jsx)(n.a, { href: '/woordenlijst/#screenreader', children: 'screenreaders' }), '. Het ', (0, s.jsx)(n.code, { children: 'svg' }), '-element in de Color Sample heeft de rol ', (0, s.jsx)(n.code, { children: 'img' }), '.'] }), '\n', (0, s.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, s.jsxs)(n.ul, { children: ['\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/content/afbeeldingen/informatieve-afbeeldingen/', children: 'Informatieve afbeeldingen' }) }), '\n'] })] });
   }
   function x(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, i.R)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(n.p, { children: ['Een gebruiker van een ', (0, s.jsx)(n.a, { href: '/woordenlijst/#screenreader', children: 'screenreader' }), ' kan herkennen welke kleurvlakken bij welke eigenschappen horen als de gebruiker van boven naar beneden de webpagina doorleest.\nDe connectie tussen kleurvlak en eigenschappen is niet alleen via de visuele informatie beschikbaar, maar ook in de volgorde van de HTML-code in de ', (0, s.jsx)(n.a, { href: 'https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model', children: 'DOM' }), '.'] }), '\n', (0, s.jsx)(n.p, { children: 'NL Design System richtlijnen' }), '\n', (0, s.jsxs)(n.ul, { children: ['\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/formulieren/visueel-ontwerp/logische-volgorde/', children: 'Zorg voor een logische volgorde van de informatie' }) }), '\n'] })] });
   }
   var b = t(4107);
   function v(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, i.R)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(n.p, { children: ['Geef het kleurvlak (of een kader rond het kleurvlak) een kleurcontrast met de achtergrond van minimaal 3:1. Dit is te controleren met de ', (0, s.jsx)(n.a, { href: '/contrast/', children: 'Contrast checker' }), '.'] }), '\n', (0, s.jsx)(n.p, { children: 'Zorg ervoor dat het vlak visueel goed te onderscheiden is als kleurvlak.' }), '\n', (0, s.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, s.jsxs)(n.ul, { children: ['\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/stijl/kleuren/contrast-niet-tekstuele-content/', children: 'Zorg voor voldoende kleurcontrast voor niet-tekstuele content' }) }), '\n'] })] });
   }
   function k(e) {
    const n = { a: 'a', code: 'code', li: 'li', p: 'p', pre: 'pre', ul: 'ul', ...(0, i.R)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(n.p, { children: 'Gebruik de Color Sample component altijd in combinatie met tekst.' }), '\n', (0, s.jsx)(n.p, { children: "Als je de tekstafstand vergroot blijft de tekst in zijn geheel zichtbaar. Dit gaat om regelhoogte, afstand tussen alinea's, letterafstand en ruimte tussen woorden. Gebruikers kunnen dit instellen vanuit hun browser. Het is niet nodig om hier buttons voor te maken in de website zelf." }), '\n', (0, s.jsx)(n.p, { children: 'Zorg ervoor dat de component mee kan groeien met de tekst. Geef de breedte en de hoogte dus niet hard op in pixels.' }), '\n', (0, s.jsxs)(n.p, { children: ['Definieer in de CSS een wijze om lange woorden af te breken en te laten doorlopen op de volgende regel. Gebruik hiervoor bijvoorbeeld ', (0, s.jsx)(n.code, { children: 'overflow-wrap: break-word; hyphens: auto;' }), ' eventueel in combinatie met ', (0, s.jsx)(n.code, { children: 'text-wrap-style: balance' }), '. Zo ontstaat er geen horizontale scrollbar en wordt tekst niet onleesbaar. Doe dit bij voorkeur op ', (0, s.jsx)(n.code, { children: ':root' }), ' niveau.'] }), '\n', (0, s.jsx)(n.p, { children: 'Je moet de afstand kunnen vergroten naar deze waardes:' }), '\n', (0, s.jsxs)(n.ul, { children: ['\n', (0, s.jsx)(n.li, { children: 'Regelhoogte (regelafstand) naar ten minste 1,5 keer de lettergrootte.' }), '\n', (0, s.jsx)(n.li, { children: "Afstand tussen alinea's naar ten minste 2 keer de lettergrootte." }), '\n', (0, s.jsx)(n.li, { children: 'Letterafstand (spati\xebren van letters) naar ten minste 0,12 keer de lettergrootte.' }), '\n', (0, s.jsx)(n.li, { children: 'Spati\xebren van woorden naar ten minste 0,16 keer de lettergrootte.' }), '\n'] }), '\n', (0, s.jsxs)(n.p, { children: ['Dit is te testen met een extensie zoals Stylus of User CSS, een ', (0, s.jsx)(n.a, { href: 'https://html5accessibility.com/tests/tsbookmarklet.html', children: 'bookmarklet' }), ' of door in de inspector van de browser de volgende code toe te voegen aan de ', (0, s.jsx)(n.code, { children: 'head' }), ' van de pagina:'] }), '\n', (0, s.jsx)(n.pre, { children: (0, s.jsx)(n.code, { className: 'language-css', children: '<style>\nbody * {\n    line-height: 1.5 !important;\n    letter-spacing: 0.12em !important;\n    word-spacing: 0.16em !important;\n}\nbody p {\n    margin-bottom: 2em !important;\n}\n</style>\n' }) }), '\n', (0, s.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, s.jsxs)(n.ul, { children: ['\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/voorkeur/', children: 'Let op voorkeursinstellingen voor typografie' }) }), '\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/lettergrootte/', children: 'Zorg ervoor dat letters groot genoeg zijn' }) }), '\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/regelafstand/', children: 'Zorg voor een comfortabele regelafstand' }) }), '\n'] })] });
   }
   function A(e) {
    const n = { a: 'a', code: 'code', li: 'li', p: 'p', ul: 'ul', ...(0, i.R)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(n.p, { children: 'Gebruik de Color Sample component altijd in combinatie met tekst.' }), '\n', (0, s.jsx)(n.p, { children: 'Als je de tekst vergroot tot 200%, via browserzoom of via de browserinstellingen voor tekstgrootte, blijft de tekst volledig zichtbaar.' }), '\n', (0, s.jsxs)(n.p, { children: ['Zorg ervoor dat de component meegroeit met de tekst. Definieer hoogte en de breedte niet in ', (0, s.jsx)(n.code, { children: 'px' }), ', maar gebruik een relatieve waarde als ', (0, s.jsx)(n.code, { children: 'em' }), ' of ', (0, s.jsx)(n.code, { children: 'rem' }), '.'] }), '\n', (0, s.jsxs)(n.p, { children: ['Definieer in de CSS een wijze om lange woorden af te breken en te laten doorlopen op de volgende regel. Gebruik hiervoor bijvoorbeeld ', (0, s.jsx)(n.code, { children: 'overflow-wrap: break-word; hyphens: auto;' }), ' eventueel in combinatie met ', (0, s.jsx)(n.code, { children: 'text-wrap-style: balance' }), '. Zo ontstaat er geen horizontale scrollbar en wordt tekst niet onleesbaar. Doe dit bij voorkeur op ', (0, s.jsx)(n.code, { children: ':root' }), ' niveau.'] }), '\n', (0, s.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, s.jsxs)(n.ul, { children: ['\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/voorkeur/', children: 'Let op voorkeursinstellingen voor typografie' }) }), '\n', (0, s.jsx)(n.li, { children: (0, s.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/lettergrootte/', children: 'Zorg ervoor dat letters groot genoeg zijn' }) }), '\n'] })] });
   }
   var y = t(54909),
    C = t(72954),
    T = t(46422),
   ...
   function W(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(n.header, { children: (0, s.jsx)(n.h1, { id: 'gebruik-color-sample', children: 'Gebruik Color Sample' }) }), '\n', (0, s.jsx)(n.h2, { id: 'css', children: 'CSS' }), '\n', (0, s.jsx)(n.p, { children: 'De CSS van deze component is gepubliceerd in een npm package:' }), '\n', (0, s.jsx)(n.p, { children: (0, s.jsx)(n.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/color-sample-css', children: '@nl-design-system-candidate/color-sample-css' }) }), '\n', (0, s.jsxs)(n.p, { children: ['Gebruik de ', (0, s.jsx)(n.code, { children: 'nl-color-sample' }), ' class name op een ', (0, s.jsx)(n.code, { children: 'svg' }), ' element:'] }), '\n', (0, s.jsx)(n.pre, { children: (0, s.jsx)(n.code, { className: 'language-html', children: '<svg role="img" xmlns="http://www.w3.org/2000/svg" class="nl-color-sample" style="color: deeppink;">\n  <path d="M0 0H32V32H0Z" fill="currentcolor" />\n</svg>\n' }) }), '\n', (0, s.jsxs)(n.p, { children: ['Zorg dat je een duidelijke beschrijving naast de Color Sample hebt en gebruik wanneer de Color Sample en beschrijving niet direct bij elkaar staan dat je ze goed aan elkaar linkt. Bijvoorbeeld door er een ', (0, s.jsx)(n.code, { children: 'figure' }), ' omheen te zetten:'] }), '\n', (0, s.jsx)(n.pre, { children: (0, s.jsx)(n.code, { className: 'language-html', children: '<h1>Huisstijlkleuren</h1>\n<figure>\n  <svg role="img" xmlns="http://www.w3.org/2000/svg" class="nl-color-sample" style="color: deeppink;">\n    <path d="M0 0H32V32H0Z" fill="currentcolor" />\n  </svg>\n  <figcaption id="kleur-1">Roze</figcaption>\n</figure>\n' }) }), '\n', (0, s.jsx)(n.p, { children: 'Je kunt de CSS zo in je project installeren:' }), '\n', (0, s.jsx)(n.pre, { children: (0, s.jsx)(n.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/color-sample-css\n' }) }), '\n', (0, s.jsx)(n.p, { children: 'Als je een CDN gebruikt, dan kun je de CSS zo importeren:' }), '\n', (0, s.jsx)(n.pre, { children: (0, s.jsx)(n.code, { className: 'language-html', children: '<link\n  rel="stylesheet"\n  href="https://cdn.jsdelivr.net/npm/@nl-design-system-candidate/color-sample-css@1/dist/color-sample.css"\n/>\n' }) }), '\n', (0, s.jsxs)(n.p, { children: ['Gebruik je geen CDN, dan kun je de CSS uit ', (0, s.jsx)(n.code, { children: 'node_modules/' }), ' importeren:'] }), '\n', (0, s.jsx)(n.pre, { children: (0, s.jsx)(n.code, { className: 'language-html', children: '<link rel="stylesheet" href="node_modules/@nl-design-system-candidate/color-sample-css/dist/color-sample.css" />\n' }) }), '\n', (0, s.jsx)(n.p, { children: 'Als je CSS imports gebruikt vanuit JavaScript:' }), '\n', (0, s.jsx)(n.pre, { children: (0, s.jsx)(n.code, { className: 'language-js', children: 'import "@nl-design-system-candidate/color-sample-css/color-sample.css";\n' }) }), '\n', (0, s.jsx)(n.h2, { id: 'react', children: 'React' }), '\n', (0, s.jsx)(n.p, { children: 'De React component is gepubliceerd in een npm package:' }), '\n', (0, s.jsx)(n.p, { children: (0, s.jsx)(n.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/color-sample-react', children: '@nl-design-system-candidate/color-sample-react' }) }), '\n', (0, s.jsx)(n.p, { children: 'Je kunt de npm package zo installeren:' }), '\n', (0, s.jsx)(n.pre, { children: (0, s.jsx)(n.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/color-sample-react\n' }) }), '\n', (0, s.jsx)(n.p, { children: 'Je kunt de React component zo gebruiken:' }), '\n', (0, s.jsx)(n.pre, { children: (0, s.jsx)(n.code, { className: 'language-jsx', children: 'import { ColorSample } from "@nl-design-system-candidate/color-sample-react";\n\nexport const MyPage = () => {\n  return (\n    <html>\n      <body>\n        <ColorSample value="deeppink" />\n      </body>\n    </html>\n  );\n};\n' }) }), '\n', (0, s.jsxs)(n.p, { children: ['Zorg dat je een duidelijke beschrijving naast de Color Sample hebt en gebruik wanneer de Color Sample en beschrijving niet direct bij elkaar staan een ', (0, s.jsx)(n.code, { children: 'id' }), ' op de beschrijving die je met ', (0, s.jsx)(n.code, { children: 'aria-labelledby' }), ' koppelt aan de ', (0, s.jsx)(n.code, { children: 'ColorSample' }), ':'] }), '\n', (0, s.jsx)(n.pre, { children: (0, s.jsx)(n.code, { className: 'language-jsx', children: 'export const MyPage = () => {\n  return (\n    <html>\n      <body>\n        <figure>\n          <ColorSample value="deeppink" />\n          <figcaption>Roze</figcaption>\n        </figure>\n      </body>\n    </html>\n  );\n};\n' }) })] });
   }
   function H(e = {}) {
    const { wrapper: n } = { ...(0, i.R)(), ...e.components };
   ...
   const _ = JSON.parse('{"nl":{"color-sample":{"background-color":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<color>","nl.nldesignsystem.figma-implementation":true},"$type":"color"},"block-size":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":true},"$type":"dimension"},"border-color":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<color>","nl.nldesignsystem.figma-implementation":true},"$type":"color"},"border-radius":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length-percentage>","nl.nldesignsystem.figma-implementation":true},"$type":"dimension"},"border-width":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":true},"$type":"dimension"},"inline-size":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":true},"$type":"dimension"}}}}'),
    ...
    B = {},
    I = 'Color Sample',
    M = 'Toont een voorbeeld van een kleur.',
    O = 325,
    E = o.find((e) => e.number === O),
   ...
   function V(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, s.jsx)(G.Fc, { component: E, headingLevel: 1, description: M }), '\n', (0, s.jsx)(h.e, { component: E }), '\n', (0, s.jsx)(d.Zp, { className: 'ma-implementation-card', children: (0, s.jsxs)(d.Wu, { children: [(0, s.jsx)(g.DZ, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, s.jsxs)(u.d, { children: [(0, s.jsxs)(u.P, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=2-4', children: [(0, s.jsx)(m.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, s.jsxs)(u.P, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=2-4', children: [(0, s.jsx)(m.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, s.jsx)(g.DZ, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, s.jsxs)(u.d, { children: [(0, s.jsxs)(u.P, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-color-sample--documentatie', children: [(0, s.jsx)(m.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, s.jsxs)(u.P, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/color-sample--documentatie', children: [(0, s.jsx)(m.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, s.jsx)(g.DZ, { level: 2, appearance: 'level-4', children: 'npm' }), (0, s.jsxs)(u.d, { children: [(0, s.jsxs)(u.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/color-sample-css', children: [(0, s.jsx)(m.r, { brand: 'npm' }), ' @nl-design-system-candidate/color-sample-css'] }), (0, s.jsxs)(u.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/color-sample-react', children: [(0, s.jsx)(m.r, { brand: 'npm' }), ' @nl-design-system-candidate/color-sample-react'] }), (0, s.jsxs)(u.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/color-sample-tokens', children: [(0, s.jsx)(m.r, { brand: 'npm' }), ' @nl-design-system-candidate/color-sample-tokens'] })] })] }) }), '\n', (0, s.jsx)(n.h2, { id: 'checklist-voor-toegankelijkheid', children: 'Checklist voor toegankelijkheid' }), '\n', (0, s.jsx)(c.Ay, {}), '\n', (0, s.jsx)(n.h3, { id: 'acceptatiecriteria-bij-gebruik', children: 'Acceptatiecriteria bij gebruik' }), '\n', (0, s.jsx)(l.Ay, {}), '\n', (0, s.jsx)(D.b, { headingLevel: '4', children: N.map(({ component: e, ...n }) => (0, s.jsx)(D.e, { ...n, children: (0, s.jsx)(e, {}) })) }), '\n', (0, s.jsx)(n.h3, { id: 'acceptatiecriteria-van-de-component', children: 'Acceptatiecriteria van de component' }), '\n', (0, s.jsx)(a.Ay, {}), '\n', (0, s.jsx)(D.b, { headingLevel: '4', children: N.map(({ component: e, ...n }) => (0, s.jsx)(D.e, { ...n, children: (0, s.jsx)(e, {}) })) }), '\n', (0, s.jsx)(L.o, { omitH1: !0, headingLevel: 2, children: (0, s.jsx)(H, {}) }), '\n', (0, s.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }), '\n', (0, s.jsx)(F.B, { tokens: _ }), '\n', (0, s.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, s.jsx)(G.VK, { component: E, headingLevel: 3 }), '\n', (0, s.jsx)(G.$9, { component: E, headingLevel: 2 }), '\n', (0, s.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, s.jsx)(G.mu, { component: E, headingLevel: 3 }), '\n', (0, s.jsx)(G.K_, { component: E })] });
   }
   function Z(e = {}) {
    const { wrapper: n } = { ...(0, i.R)(), ...e.components };
    return n ? (0, s.jsx)(n, { ...e, children: (0, s.jsx)(V, { ...e }) }) : V(e);
  ...
  70348(e, n, t) {
   ...
   var r = t(13526),
    ...
    o = t(14277),
    a = t(86070);
   const l = (0, s.forwardRef)(({ as: e, className: n, children: t, ...s }, i) => {
     const o = e || 'div',
      l = (0, r.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(o, { ref: i, className: l, ...s, children: t });
    }),
    c = ({ className: e, classNamePanel: n, label: t, heading: s, headingLevel: l, headingApperance: c, ...d }) => {
     const u = (0, r.A)('utrecht-accordion__section', e),
      g = (0, r.A)('utrecht-accordion__panel', n);
     return (0, a.jsxs)('details', { className: u, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(i.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [s && (0, a.jsx)(o.D, { level: l, appearance: c, children: s }), t] })] }) }), (0, a.jsx)('div', { className: g, children: d.children })] });
    };
  },
  70561(e, n, t) {
   'use strict';
  ...
  70903(e, n, t) {
     ...
     (0, d.jsx)(d.Fragment, {
      children:
       ...
       (0, d.jsxs)(o.$n, {
        ...
        children: [e, (0, d.jsx)(c.In, { children: (0, d.jsx)(l.A, {}) })],
       }),
     })
    );
   }
   var g = t(43864),
    ...
    v = t(23436),
    k = t(79532);
   const A = { boxShadow: g.A, color: m.A, cursor: h.A, dimension: p.A, fontFamily: j.A, fontFamilies: j.A, fontSize: f.A, fontSizes: f.A, fontWeight: w.A, fontWeights: w.A, lineHeight: x.A, lineHeights: x.A, number: b.A, other: v.A, textDecoration: k.A },
    y = ({ type: e }) => {
   ...
   function T({ tokens: e }) {
    ...
    return (0, d.jsxs)('div', {
     ...
     children: [
      (0, d.jsxs)(o.XI, {
       children: [
        (0, d.jsx)(o.A0, { children: (0, d.jsxs)(o.Hj, { children: [(0, d.jsx)(o.M_, { children: 'name' }), (0, d.jsx)(o.M_, { children: 'type' })] }) }),
        (0, d.jsx)(o.BF, {
         children: a.map((n) => {
          const t = (0, i.o_)(n),
           a = (0, i.eQ)(e, n).$type;
          return (0, d.jsxs)(o.Hj, { children: [(0, d.jsx)(o.nA, { children: (0, d.jsx)(r.C, { children: (0, d.jsx)(o.kf, { children: t }) }) }), (0, d.jsx)(o.nA, { children: (0, d.jsxs)(s.K, { children: [(0, d.jsx)(y, { type: a }), ' ', a] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, d.jsxs)(o.e2, { children: [(0, d.jsx)(u, { content: c, children: 'Kopieer als JSON' }), (0, d.jsx)(u, { content: l, children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  85068(e, n, t) {
   ...
   var r = t(14277),
    s = t(86070);
   const i = (e) => (0, s.jsx)(r.D, { ...e }),
    o = (e) => (0, s.jsx)(r.D, { ...e, level: 3 });
  },
  85162(e, n, t) {
   'use strict';
   t.d(n, { s: () => l });
   ...
   const a = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    l = ({ name: e, relayStep: n, description: t }) => {
     const l = (0, i.fX)(n),
      c = a[e] ?? e;
     return (0, o.jsxs)(r.WK, { children: [(0, o.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, s.A)('ma-component-illustration', `ma-component-illustration--${l}`), fill: 'none', children: [(0, o.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, o.jsx)('rect', { width: '960', height: '540' }), (0, o.jsx)('rect', { width: '960', height: '540' })] }), (0, o.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, o.jsx)('use', { href: `/svg/componenten_overzicht_${(0, i.fX)(c)}.svg#component-illustration` })] }), (0, o.jsx)(r.$P, { className: 'ma-component-illustration__caption', children: t })] });
    };
  },
  88166(e, n, t) {
   'use strict';
         ...
         (0, m.jsx)(o._Q, {
          ...
          children: d.map((e, n) => {
           ...
           if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
            const r = i.pI.get(e);
            t = (0, m.jsx)(s.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${r.sc} ${r.nl.title}`, style: { lineHeight: 1 }, children: (0, m.jsx)(u.KE, { children: `WCAG ${e}` }) }, n);
           }
           return t;
          }),
         }),
     ...
     return (
      ...
      (0, m.jsxs)('div', {
       children: [
        (0, m.jsxs)('div', {
         ...
         children: [
          (0, m.jsxs)(o.LB, {
           ...
           'aria-labelledby': v,
           children: [
            (0, m.jsx)(d.DZ, { level: n, id: v, children: 'Filter acceptatiecriteria voor:' }),
            Array.from(u).map((e) =>
             (0, m.jsxs)(
              o.zB,
              {
          ...
          (0, m.jsx)('div', {
           children: (0, m.jsxs)(m.Fragment, {
            children: [
             (0, m.jsxs)(a.f, { role: 'status', children: [w, ' van de ', j, ' items zijn nu zichtbaar.'] }),
             w < j
              ? (0, m.jsx)(l.$, {
                 purpose: 'secondary',
                 onClick: () => {
        ...
        (0, m.jsx)(c.n, { className: 'ma-new-checklist', role: 'list', ref: t, children: e }),
       ],
      })
     );
    };
  ...
  94309(e, n, t) {
   ...
   const o = ({ children: e, ...n }) => {
     ...
     return ('https://nldesignsystem.nl' === l.origin ? (l.pathname.endsWith('/') || (0, s.QQ)(l.pathname) || (l.pathname = `${l.pathname}/`), (a = l.toString().replace('https://nldesignsystem.nl', ''))) : ((o.target = '_blank'), (o.rel = 'noopener noreferrer')), (0, i.jsx)('a', { href: a, ...o, children: e }));
    },
    a = ({ className: e, ...n }) => (0, i.jsx)(o, { className: (0, r.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  95732(e, n, t) {
   'use strict';
   t.d(n, { $n: () => m });
   ...
   var u = function (e) {
    ...
    m =
     ...
     (0, a.forwardRef)(function (e, n) {
      ...
      return (0, i.jsxs)('button', d(d({ ref: n, type: v, className: (0, o.$)('nl-button', r, { 'nl-button--pressed': w, 'nl-button--busy': x, 'nl-button--disabled': j || f, 'nl-button--primary': 'primary' === h, 'nl-button--secondary': 'secondary' === h, 'nl-button--subtle': 'subtle' === h, 'nl-button--positive': g(h) && 'positive' === p, 'nl-button--negative': g(h) && 'negative' === p, 'nl-button--icon-only': c }), 'aria-pressed': A ? String(Boolean(w)) : void 0, 'aria-disabled': j || x ? 'true' : void 0, disabled: f }, y), {}, { children: [m && (0, i.jsx)('span', { className: 'nl-button__icon-start', children: m }), k && (0, i.jsx)('span', { className: 'nl-button__label', children: k }), T ? (0, i.jsx)('span', { className: c ? 'nl-button__label' : '', children: t }) : t, u && (0, i.jsx)('span', { className: 'nl-button__icon-end', children: u })] }));
     }));
