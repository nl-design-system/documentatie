...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  45086: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => b, contentTitle: () => s, default: () => g, frontMatter: () => c, metadata: () => t, toc: () => k });
   var o = l(11527),
    r = l(47214),
    a = l(53623),
    d = l(30036),
  ...
  53623: (e, n, l) => {
   ...
   const v = (e) => {
    ...
    p = (e) => {
     let n,
      { code: l, copy: a = !1, defaultCollapsed: i = !0, children: s, language: p } = e;
     n = "function" == typeof s ? s() : s;
     const j = t().format(b.uS(l || n), { parser: "html", plugins: [d(), c()], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" }),
      _ = (0, u.Z)();
     return (0, m.jsxs)("div", {
      ...
      children: [
       ...
       (0, m.jsx)("div", { className: (0, r.Z)(g["nlds-canvas__toolbar"]), children: (0, m.jsx)(o.zx, { className: (0, r.Z)(g["nlds-canvas__button"], g["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: v, "aria-expanded": !i, "aria-controls": _, children: i ? "Bekijk code" : "Verberg code" }) }),
       (0, m.jsxs)("div", {
        className: (0, r.Z)(g["nlds-canvas__code-block"], !a && g["nlds-canvas__code-block--user-select-none"]),
        id: _,
        hidden: i,
        children: [
         (0, m.jsx)(k.Z, { language: p, style: h, children: j }),
         a &&
          (0, m.jsx)("div", {
  ...
  30036: (e, n, l) => {
   ...
   var c = l(11527);
   const s = (e) => {
    let { title: n, appearance: l, description: s, children: t } = e;
    const b = "Doen",
     k = "Niet doen";
    return (0, c.jsxs)("div", { className: (0, d.Z)(i["nlds-guideline"], i[`nlds-guideline--${l}`]), id: n?.toLowerCase().replace(/\s/g, "-"), children: [(0, c.jsxs)("div", { className: (0, d.Z)(i["nlds-guideline__description"]), children: ["dont" === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(a.nv, { className: (0, d.Z)(i["nlds-guideline__badge"], i[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { className: i["nlds-guideline__icon"] }), (0, c.jsx)("span", { className: i["nlds-guideline__title"], children: k })] }), (0, c.jsx)(a.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(a.nv, { className: (0, d.Z)(i["nlds-guideline__badge"], i[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(r.Z, { className: i["nlds-guideline__icon"] }), (0, c.jsx)("span", { className: i["nlds-guideline__title"], children: b })] }), (0, c.jsx)(a.nv, { children: n })] }), s] }), (0, c.jsx)("div", { className: (0, d.Z)(i["nlds-guideline__example"]), children: t })] });
   };
  },
 },
]);
