 ...
 [45010],
 {
  ...
  43599: (e, n, t) => {
   ...
   const j = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      (N = await d.ZP.format(z, { parser: k, plugins: [s.Z, i.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(N);
     })();
    }, [z]);
    const P = (0, p.useId)();
    let M = p.Fragment;
