 ...
 [24171],
 {
  ...
  26655(e, n, a) {
   ...
   const s = ({ background: e, children: n, className: a, ...t }) => (0, i.jsx)('div', { className: (0, r.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, a), ...t, children: n }),
    ...
    d = ({ href: e, appearance: n, className: a, component: s = 'div', background: o, children: d }) => {
     const l = (e) => ('article' === s ? (0, i.jsx)('article', { ...e }) : 'section' === s ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      c = (0, i.jsx)(l, { className: (0, r.A)('ma-cardgroup__card', o && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, a), children: d });
     return e ? (0, i.jsx)(t.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: c }) : c;
    },
    l = ({ appearance: e = 'medium', children: n, className: a }) => (0, i.jsx)('div', { className: (0, r.A)('ma-cardgroup', `ma-cardgroup--${e}`, a), children: n });
  },
  64411(e, n, a) {
   (a.r(n), a.d(n, { assets: () => z, contentTitle: () => x, default: () => D, frontMatter: () => f, metadata: () => t, toc: () => _ }));
   ...
   const d = { name: 'Astrid Brantjes', role: 'Projectmanager', slack: { mention: '@Astrid Brantjes', id: 'U06S00GPXC7' }, Description: () => (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(s.fz, { children: 'Voor veel mensen is Astrid geen onbekende, want vanuit haar vorige baan bij de gemeente Utrecht hield ze zich al bezig met verschillende landelijke innovaties. Hierdoor heeft ze kennis van het ontwikkelen van open source systemen.' }), (0, r.jsx)(s.fz, { children: 'In haar vrije tijd vind je Astrid in haar atelier, op de squashbaan en bij mooi weer op de racefiets.' })] }) },
    ...
    k = { name: 'Richard van Heuven van Staereling', role: 'DevOps Engineer', slack: { mention: '@Richard', id: 'U094W1UDJ6A' }, Description: () => (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(s.fz, { children: 'Richard programmeert sinds jongs af aan voor het web en houdt zich naast code ook bezig met de automatisering erom heen. Hij heeft talloze design systems ontwikkeld voor de websites en apps van kleine en grote organisaties, en praat graag mee over hoe je de gebruikerservaring kan verbeteren.' }), (0, r.jsx)(s.fz, { children: 'Vanuit het kernteam beheert en onderhoudt Richard de technische infrastructuur van NL Design System. Hij adviseert de community op het gebied van security, betrouwbare build- en releasetrajecten, en het toepassen van best practices.' }), (0, r.jsx)(s.fz, { children: 'Dit alles het liefst na een goede kop koffie. En in zijn vrije tijd geeft Richard taekwondoles en pingelt hij op de piano.' })] }) };
   var v = a(26655);
   const u = [d, h, c, l, m, g, j, p, k],
    b = ({ headingLevel: e }) => (0, r.jsx)(v.AC, { appearance: 'large', children: u.map(({ name: n, role: a, Description: t, slack: i }) => (0, r.jsx)(v.Zp, { appearance: 'large', className: (0, o.A)('ma-core-team__card'), component: 'section', children: (0, r.jsxs)(v.Wu, { className: (0, o.A)('ma-core-team__content'), children: [(0, r.jsxs)(s.yI, { className: (0, o.A)('ma-core-team__heading'), children: [(0, r.jsx)(s.DZ, { level: e, className: (0, o.A)('ma-core-team__heading-title'), children: n }), (0, r.jsx)(s.fz, { className: (0, o.A)('ma-core-team__heading-subtitle'), children: a })] }), (0, r.jsx)('div', { className: (0, o.A)('ma-core-team__description'), children: (0, r.jsx)(t, {}) }), (0, r.jsxs)(s.fz, { children: ['Slack: ', (0, r.jsx)(s.N_, { href: `https://codefornl.slack.com/team/${i.id}`, children: i.mention })] })] }) }, n)) }),
    f = { title: 'Kernteam', hide_title: !0, hide_table_of_contents: !0, navigation_order: 3, sidebar_label: 'Kernteam', pagination_label: 'Kernteam', description: 'Contact met NL Design System Kernteam', keywords: ['kernteam', 'over ons', 'nl design system', 'contact'] },
    x = 'Kernteam',
    z = {},
    _ = [];
   function y(e) {
