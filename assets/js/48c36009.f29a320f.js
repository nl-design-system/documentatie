/*! For license information please see 48c36009.f29a320f.js.LICENSE.txt */
'use strict';
 ...
 [39306],
 {
  ...
  3446(e, n, a) {
   ...
   var t = a(29181),
    ...
    o = a(83386),
    d = a(86070);
   const u = { figma: (0, d.jsx)(r.A, {}), github: (0, d.jsx)(i.A, {}), npm: (0, d.jsx)(l.A, {}), storybook: (0, d.jsx)(s.A, {}) },
  ...
  14881(e, n, a) {
   ...
   const o = (0, r.forwardRef)(({ as: e, className: n, children: a, ...r }, i) => {
    ...
    d = ({ className: e, classNamePanel: n, label: a, heading: r, headingLevel: o, headingApperance: d, ...u }) => {
     ...
     return (0, s.jsxs)('details', { className: g, ...u, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(i.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(l.D, { level: o, appearance: d, children: r }), a] })] }) }), (0, s.jsx)('div', { className: c, children: u.children })] });
    };
  },
  15089(e, n, a) {
   a.d(n, { A: () => l });
   ...
   const l = ({ background: e, children: n, className: a, ...t }) => (0, i.jsx)('div', { className: (0, r.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, a), ...t, children: n }),
    ...
    o = ({ href: e, appearance: n, className: a, component: l = 'div', background: s, children: o }) => {
     const d = (e) => ('article' === l ? (0, i.jsx)('article', { ...e }) : 'section' === l ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      u = (0, i.jsx)(d, { className: (0, r.A)('ma-cardgroup__card', s && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, a), children: o });
  ...
  26877(e, n, a) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
               ...
               d.Z,
               {
                ...
                description: (0, u.jsxs)('div', {
                 ...
                 children: [
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: a }) => (0, u.jsxs)('section', { children: [(0, u.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [l, ' in ', e] }), (0, u.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, u.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               o.Zp,
               {
                ...
                children: (0, u.jsxs)(o.Wu, {
                 children: [
                  ...
                  c.length > 0 && (0, u.jsx)(u.Fragment, { children: c.map(({ frameworkName: e, tasks: a }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(t.DZ, { level: n + 2, children: [l, ' in ', e] }), (0, u.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, u.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    w = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(m.p, { level: n, suffix: r && (0, u.jsx)(c.D, { state: r }), children: e.title }), (0, u.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(r) && (0, u.jsx)(b.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    N = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
  ...
  63009(e, n, a) {
   ...
   var g = (0, s.forwardRef)(function (e, n) {
    var a = e.children,
     ...
     m = e.inlineBox,
     h = (0, r.A)(e, o);
    return (0, i.jsx)('a', u(u({ 'aria-current': d || void 0, 'aria-disabled': g, className: (0, l.$)('nl-link', (0, t.A)((0, t.A)((0, t.A)({}, 'nl-link--current', d), 'nl-link--disabled', g), 'nl-link--inline-box', m), s), href: g ? void 0 : c, role: g ? 'link' : void 0, ref: n, tabIndex: g ? 0 : void 0 }, h), {}, { children: a }));
   });
   g.displayName = 'Link';
  },
  66153(e, n, a) {
  ...
  83318(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => h, contentTitle: () => d, default: () => x, description: () => c, frontMatter: () => o, issueNumber: () => m, metadata: () => t, title: () => g, toc: () => p }));
   ...
   const o = { title: 'Date Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Input', pagination_label: 'Date Input', description: 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.', issue_number: 188, slug: '/date-input', keywords: ['browser', 'built-in', 'date', 'datepicker', 'date field', 'date input', 'date picker', 'date selection', 'datum', 'datum invoer', 'datumveld', 'form', 'form control', 'formulier', 'formulierelement', 'ingebouwd', 'input', 'input field', 'invoerveld', 'invullen', 'kalender', 'native', 'text field'] },
    ...
    u = {},
    g = 'Date Input',
    c = 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.',
    m = 188,
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => r, KF: () => c, mJ: () => p, VZ: () => N, cR: () => w, Pv: () => f, qZ: () => l, kD: () => j, QQ: () => D, B2: () => m, Pc: () => o, f4: () => s, GT: () => k, fX: () => i, eQ: () => v, B_: () => b, o_: () => x });
