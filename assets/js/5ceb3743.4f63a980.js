 ...
 [41952],
 {
  ...
  43599: (e, n, l) => {
   ...
   const j = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (Z = await c.ZP.format(N, { parser: x, plugins: [r.Z, s.ZP, a.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(Z);
     })();
    }, [N]);
    const S = (0, u.useId)();
    let z = u.Fragment;
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       _ && (0, m.jsx)('div', { className: (0, i.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(z, { children: (0, m.jsx)(o.pu, { children: _ }) }) }) }),
       y &&
        (0, m.jsx)('div', {
