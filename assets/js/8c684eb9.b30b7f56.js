 ...
 [44684],
 {
  14881(e, n, l) {
   ...
   const c = (0, o.forwardRef)(({ as: e, className: n, children: l, ...o }, t) => {
     ...
     return (0, a.jsx)(s, { ref: t, className: c, ...o, children: l });
    }),
    i = ({ className: e, classNamePanel: n, label: l, heading: o, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, a.jsxs)('details', { className: u, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(t.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [o && (0, a.jsx)(s.D, { level: c, appearance: i, children: o }), l] })] }) }), (0, a.jsx)('div', { className: m, children: d.children })] });
    };
  },
  18439(e, n, l) {
   l.d(n, { R: () => s, x: () => a });
  ...
  28369(e, n, l) {
   ...
   function i({ lineNumber: e, syntax: n, textContent: l, trim: i }) {
    ...
    const { title: u, type: m } = (0, t.useContext)(s.x),
     p = (0, t.useId)();
    return (i && (d = d.trim()), (0, c.jsx)(o.f4, { theme: a, code: d, language: n || '', children: ({ style: n, tokens: l, getLineProps: o, getTokenProps: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, c.jsx)(r.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': p, style: n, children: l.map((n, l) => (0, c.jsxs)('span', { ...o({ line: n }), children: [e && (0, c.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, c.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  38953(e, n, l) {
   l.d(n, { H: () => f });
   ...
   const f = globalThis.isAstro
    ...
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: p = !0, children: h, container: g = 'document', language: v, designTokens: f }) => {
       ...
       (0, u.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(w, { parser: v, plugins: [s.A, a.Ay, c.Ay, i.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         z(e);
        })();
       }, [w]);
       const S = (0, u.useId)();
  ...
  68032(e, n, l) {
   ...
   function i(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', (0, o.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, o.jsx)(c.$, { appearance: 'do', title: 'Geef duidelijk aan dat een formulier verzonden gaat worden.', children: (0, o.jsx)(a.H, { language: 'html', children: () => (0, o.jsx)(o.Fragment, { children: (0, o.jsx)('button', { children: 'Versturen' }) }) }) }), '\n', (0, o.jsx)(c.$, { appearance: 'dont', title: 'Gebruik hetzelfde label voor verzenden als voor de navigatie in een meerstappenformulier.', children: (0, o.jsx)(a.H, { language: 'html', children: () => (0, o.jsx)(o.Fragment, { children: (0, o.jsx)('button', { type: 'submit', children: 'Volgende' }) }) }) })] });
   }
   function d(e = {}) {
