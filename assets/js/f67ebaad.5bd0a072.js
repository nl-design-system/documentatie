/*! For license information please see f67ebaad.5bd0a072.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [33527],
 {
  ...
  47901(e, n, a) {
   (a.r(n), a.d(n, { assets: () => g, component: () => f, componentName: () => p, contentTitle: () => d, default: () => b, description: () => c, frontMatter: () => o, issueNumber: () => m, metadata: () => t, relayStep: () => h, title: () => u, toc: () => x }));
   ...
   const o = { title: 'Video', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Video', pagination_label: 'Video', description: 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.', issue_number: 69, slug: '/video' },
    ...
    g = {},
    u = 'Video',
    c = 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.',
    m = 69,
    h = 'help wanted',
    p = 'video',
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => r, KF: () => c, mJ: () => p, VZ: () => w, cR: () => N, Pv: () => f, qZ: () => s, kD: () => j, QQ: () => D, B2: () => m, Pc: () => o, f4: () => l, GT: () => k, fX: () => i, eQ: () => b, B_: () => v, o_: () => x });
