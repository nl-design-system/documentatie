/*! For license information please see 46500269.a40ce86b.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [51127],
 {
  517(e, n, a) {
   ...
   const t = JSON.parse('{"id":"componenten/range/index","title":"Range","description":"Invoerveld voor een getal dat je bij benadering kunt kiezen door te schuiven tussen een minimum en maximum.","source":"@site/docs/componenten/range/index.mdx","sourceDirName":"componenten/range","slug":"/range","permalink":"/range","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/range/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Range","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Range","pagination_label":"Range","description":"Invoerveld voor een getal dat je bij benadering kunt kiezen door te schuiven tussen een minimum en maximum.","issue_number":36,"slug":"/range","keywords":["adjuster","control","drag bar","range","range input","range slider","slider","slider bar","sliding control"]},"sidebar":"componenten","previous":{"title":"Radio Group","permalink":"/radio-group"},"next":{"title":"Rich Text Content","permalink":"/rich-text-content"}}');
   var r = a(86070),
    i = a(18439),
    s = a(79447),
    l = a(26877);
   const o = { title: 'Range', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Range', pagination_label: 'Range', description: 'Invoerveld voor een getal dat je bij benadering kunt kiezen door te schuiven tussen een minimum en maximum.', issue_number: 36, slug: '/range', keywords: ['adjuster', 'control', 'drag bar', 'range', 'range input', 'range slider', 'slider', 'slider bar', 'sliding control'] },
    d = void 0,
    g = {},
    u = 'Range',
    c = 'Invoerveld voor een getal dat je bij benadering kunt kiezen door te schuiven tussen een minimum en maximum.',
    m = 36,
    h = 'help wanted',
    p = 'range',
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => r, KF: () => c, mJ: () => p, VZ: () => w, cR: () => N, Pv: () => f, qZ: () => s, kD: () => j, QQ: () => D, B2: () => m, Pc: () => o, f4: () => l, GT: () => k, fX: () => i, eQ: () => v, B_: () => b, o_: () => x });
