 ...
 [15483],
 {
  ...
  58639(e, n, l) {
   ...
   const y = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: y = !0, children: g, container: x = 'document', language: v, designTokens: k }) => {
    ...
    let F = u.Fragment;
    return (
     'paragraph' === x ? (F = h) : 'document' === x ? (F = b) : 'surface' === x && (F = j),
     (0, m.jsxs)('div', {
      className: (0, o.A)('nlds-canvas'),
      children: [
       f && (0, m.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(F, { children: (0, m.jsx)(s.v$, { children: f }) }) }) }),
       y &&
        (0, m.jsx)('div', {
