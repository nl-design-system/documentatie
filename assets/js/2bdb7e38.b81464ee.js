  ...
  58639(e, n, t) {
   ...
   const b = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: b = !0, children: y, container: x = 'document', language: j, designTokens: f }) => {
    const k = 'function' == typeof y ? y() : y,
     ...
     z = 'string' == typeof e ? e : p.qV(_ || k),
     [w, N] = (0, u.useState)(z),
     [A, C] = (0, u.useState)(t);
    (0, u.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(z, { parser: j, plugins: [r.A, c.Ay, a.Ay, i.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [z]);
    const S = (0, u.useId)();
    ...
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       k && (0, m.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(F, { children: (0, m.jsx)(l.v$, { children: k }) }) }) }),
       b &&
        (0, m.jsx)('div', {
       ...
       b &&
        (0, m.jsxs)('div', {
         ...
         hidden: !A,
         children: [
          (0, m.jsx)(o.M, { codeBlockLabel: 'Codevoorbeeld', syntax: j, textContent: w, trim: !0 }),
          n &&
           (0, m.jsx)('div', {
