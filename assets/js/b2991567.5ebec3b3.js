 ...
 [36918],
 {
  23116: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(65739),
    s = n(94443);
   const o = { title: 'Invalid Form Alert', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Invalid Form Alert', pagination_label: 'Invalid Form Alert', description: 'Trekt de aandacht naar een overzicht van foutmeldingen.', slug: '/invalid-form-alert', keywords: ['alert', 'banner', 'error', 'error message', 'error summary', 'foutmelding', 'form', 'form error', 'formulier', 'invalid', 'invalid form alert', 'invalid form message', 'message', 'ongeldig', 'onjuist', 'problem', 'samenvatting', 'validatie', 'validation', 'waarschuwing'] },
    a = void 0,
    l = { id: 'componenten/invalid-form-alert/index', title: 'Invalid Form Alert', description: 'Trekt de aandacht naar een overzicht van foutmeldingen.', source: '@site/docs/componenten/invalid-form-alert/index.mdx', sourceDirName: 'componenten/invalid-form-alert', slug: '/invalid-form-alert', permalink: '/invalid-form-alert', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/invalid-form-alert/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Invalid Form Alert', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Invalid Form Alert', pagination_label: 'Invalid Form Alert', description: 'Trekt de aandacht naar een overzicht van foutmeldingen.', slug: '/invalid-form-alert', keywords: ['alert', 'banner', 'error', 'error message', 'error summary', 'foutmelding', 'form', 'form error', 'formulier', 'invalid', 'invalid form alert', 'invalid form message', 'message', 'ongeldig', 'onjuist', 'problem', 'samenvatting', 'validatie', 'validation', 'waarschuwing'] }, sidebar: 'componenten', previous: { title: 'Input Group', permalink: '/input-group' }, next: { title: 'Language Navigation', permalink: '/language-navigation' } },
    u = {},
    h = [
    ...
    d = 'Invalid Form Alert',
    j = 'Trekt de aandacht naar een overzicht van foutmeldingen.',
    m = 175,
