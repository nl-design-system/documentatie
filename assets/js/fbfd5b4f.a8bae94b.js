(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [2930],
 {
  34997: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => g, contentTitle: () => a, default: () => m, description: () => j, frontMatter: () => o, issueNumber: () => y, metadata: () => l, title: () => d, toc: () => h });
   var r = n(52676),
    s = n(40139),
    i = n(99890),
    c = n(8657);
   const o = { title: 'Progress List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress List', pagination_label: 'Progress List', description: 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.', slug: '/progress-list', keywords: ['lijst', 'meter', 'path', 'proceslijst', 'progress', 'progress bar', 'progress indicator', 'progress list', 'progress navigation', 'progress tracker', 'status', 'statusoverzicht', 'stepper', 'stepper indicator', 'stepper vertical', 'steps', 'tijdlijn', 'timeline', 'voortgangslijst', 'voortgangsproces'] },
    a = void 0,
    l = { id: 'componenten/progress-list/index', title: 'Progress List', description: 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.', source: '@site/docs/componenten/progress-list/index.mdx', sourceDirName: 'componenten/progress-list', slug: '/progress-list', permalink: '/progress-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/progress-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Progress List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress List', pagination_label: 'Progress List', description: 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.', slug: '/progress-list', keywords: ['lijst', 'meter', 'path', 'proceslijst', 'progress', 'progress bar', 'progress indicator', 'progress list', 'progress navigation', 'progress tracker', 'status', 'statusoverzicht', 'stepper', 'stepper indicator', 'stepper vertical', 'steps', 'tijdlijn', 'timeline', 'voortgangslijst', 'voortgangsproces'] }, sidebar: 'componenten', previous: { title: 'Progress Circle', permalink: '/progress-circle' }, next: { title: 'Radio Button', permalink: '/radio-button' } },
    u = {},
    h = [
  ...
  35038: (e, t, n) => {
   'use strict';
   n.d(t, { Zb: () => a, aY: () => o, um: () => l, wu: () => c });
   var r = n(37943),
    s = n(4814),
    i = n(52676);
   const c = (e) => {
     let { background: t, children: n, className: r, ...c } = e;
     return (0, i.jsx)('div', { className: (0, s.Z)('card__illustration', t && `card__illustration--${t}`, r), ...c, children: n });
    },
    o = (e) => (0, i.jsx)('div', { className: 'card__content', ...e }),
    a = (e) => {
     let { href: t, appearance: n, className: c, component: o = 'div', background: a, children: l } = e;
     const u = (e) => ('article' === o ? (0, i.jsx)('article', { ...e }) : 'section' === o ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      h = (0, i.jsx)(u, { className: (0, s.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, c), children: l });
  ...
  8657: (e, t, n) => {
   ...
   var r = n(74824),
    ...
    l = n(32636),
    u = n(52676);
   const h = { figma: (0, u.jsx)(i.Z, {}), github: (0, u.jsx)(c.Z, {}), npm: (0, u.jsx)(o.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
          ...
          children: [
           (0, u.jsx)(k, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(f, { headingLevel: n + 1, checked: t, title: r, description: (0, x.Q6)(s) }, s);
            }),
           }),
               ...
               i.length > 0 &&
                (0, u.jsx)(u.Fragment, {
                 children: i.map((e) => {
                  ...
                  return (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.X6, { level: n + 2, children: [s, ' in ', t] }), (0, u.jsx)(r.Mc, { links: i.map((e) => ({ children: e.description, icon: (0, u.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
  ...
  23355: (e, t, n) => {
   ...
   const o = (e) => {
    let { state: t } = e;
    const n = (0, i.mA)(t);
    return (0, c.jsx)(r.Ou, { className: (0, s.Z)('estafette-badge', n && `estafette-badge--${n}`), children: t });
   };
  },
  41757: (e, t, n) => {
   'use strict';
   ...
   var r = n(4814),
    s = n(52676);
   const i = (e) => {
    let { children: t, className: n, level: i = 1, suffix: c, ...o } = e;
    return (0, s.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${i}`, n), ...o, children: [(0, s.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), c && (0, s.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [c ? ' ' : '', c] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => o, Ee: () => u, Q6: () => i, U: () => j, Yr: () => m, d: () => h, e9: () => c, fO: () => b, mA: () => s, ps: () => y, qU: () => k, s0: () => v, zP: () => g });
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        ...
        return { brand: o.toLowerCase(), name: s, id: i, value: c, description: a };
       });
