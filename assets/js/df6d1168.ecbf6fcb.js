...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [46756],
 {
  ...
  66771: (e, n, o) => {
   ...
   const g = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(l.Tg, { className: p['nlds-canvas__example-surface'], children: (0, m.jsx)(l.BB, { className: (0, s.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: (0, m.jsx)(l.nv, { className: p['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   g.displayName = 'ParagraphContainer';
   const v = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(l.Tg, { className: p['nlds-canvas__example-surface'], children: (0, m.jsx)(l.BB, { className: (0, s.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: n }) });
   };
   ...
   const _ = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await i.ZP.format(N, { parser: x, plugins: [t.Z, r.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(Z);
     })();
    }, [N]);
    const A = (0, d.useId)();
    let E = d.Fragment;
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       w && (0, m.jsx)('div', { className: (0, s.Z)(p['nlds-canvas__example']), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(E, { children: (0, m.jsx)(l.pu, { children: w }) }) }) }),
       f &&
        (0, m.jsx)('div', {
   ...
   function a(e) {
    ...
    return (
     ...
     (0, r.jsx)(s.y$, {
      ...
      language: o || '',
      children: (e) => {
       let { style: o, tokens: s, getLineProps: t, getTokenProps: a } = e;
       return (0, r.jsx)(l.dn, { style: o, children: s.map((e, o) => (0, r.jsxs)('span', { ...t({ line: e }), children: [n && (0, r.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, r.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, o)) });
      },
     })
    );
   }
  ...
  81014: (e, n, o) => {
   ...
   const i = (e) => {
    ...
    const p = 'Doen',
     ...
     m = u ? 'figure' : 'div',
     g = u ? 'figcaption' : 'div';
    return (0, c.jsxs)(m, { className: (0, r.Z)(a['nlds-guideline'], a[`nlds-guideline--${o}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(g, { className: (0, r.Z)(a['nlds-guideline__description']), children: ['dont' === o ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(t.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${o}`]), children: [(0, c.jsx)(l.Z, { className: a['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: a['nlds-guideline__title'], children: h })] }), (0, c.jsx)(t.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(t.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${o}`]), children: [(0, c.jsx)(s.Z, { className: a['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: a['nlds-guideline__title'], children: p })] }), (0, c.jsx)(t.nv, { children: n })] }), i] }), (0, c.jsx)('div', { className: (0, r.Z)(a['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, o) => {
   o.d(n, { Z: () => a, a: () => r });
