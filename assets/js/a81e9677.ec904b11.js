...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [11933],
 {
  ...
  6392(e, n, t) {
   (t.r(n), t.d(n, { assets: () => O, component: () => I, contentTitle: () => G, default: () => U, description: () => Z, frontMatter: () => V, issueNumber: () => $, metadata: () => r, title: () => P, toc: () => W }));
   ...
   var y = t(92544),
    ...
    M = t(87711);
   const H = [
     { title: 'De linkteksten van de links in het broodkruimelpad zijn voor iedereen duidelijk', sc: '2.4.4', status: '', component: N.Ay },
     {
    ...
    B = [
     ...
     { title: 'Het broodkruimelpad zorgt niet voor een toetsenbordval', sc: '2.1.2', status: '', component: R.Ay },
     {
