 ...
 [21907],
 {
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n }) => {
       const t = 'function' == typeof e ? e() : e,
        ...
        o = p().highlight(i, p().languages[n], n);
       return (0, j.jsxs)('div', { className: 'ma-canvas-astro', children: [(0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: i } }), (0, j.jsx)(u.n, { children: (0, j.jsx)(u.K, { label: 'Code', children: (0, j.jsx)('pre', { className: 'language-html nl-code-block', children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
  ...
  51627(e, n, t) {
   ...
   const d = ({ className: e, ...n }) => {
    ...
    a = ({ className: e, label: n, heading: t, headingLevel: d, headingApperance: a, ...s }) => {
     const c = (0, i.A)('utrecht-accordion__section', e);
     return (0, r.jsxs)('details', { className: c, ...s, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(o.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [t && (0, r.jsx)(l.D, { level: d, appearance: a, children: t }), n] })] }) }), (0, r.jsx)('div', { className: 'utrecht-accordion__panel', children: s.children })] });
    };
  },
  78734(e, n, t) {
   t.d(n, { Ay: () => d, RM: () => l });
   ...
   const c = (0, a.createContext)({}),
    g = ({ title: e, appearance: n, description: t, children: a, figure: g }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      v = g ? 'figure' : 'div',
      p = g ? 'figcaption' : 'div',
      u = 'string' == typeof t ? (0, s.jsx)(d.oz, { children: t }) : t;
