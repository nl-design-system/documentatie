 ...
 [44617],
 {
  ...
  43599: (e, n, o) => {
   ...
   const g = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (A = await d.ZP.format(N, { parser: x, plugins: [s.Z, i.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(A);
     })();
    }, [N]);
    const S = (0, u.useId)();
    let F = u.Fragment;
      ...
      children: [
       ...
       j &&
        (0, p.jsxs)('div', {
         ...
         hidden: !Z,
         children: [
          (0, p.jsx)(l.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: A, trim: !0 }),
          o &&
           (0, p.jsx)('div', {
