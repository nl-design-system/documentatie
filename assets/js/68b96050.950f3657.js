(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [23221],
 {
  ...
  98674: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => G, component: () => S, contentTitle: () => C, default: () => P, description: () => R, frontMatter: () => b, issueNumber: () => N, metadata: () => T, title: () => W, toc: () => z });
   var r = n(52676),
    s = n(40139),
    i = n(43166),
    o = n(93514),
   ...
   function _(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(y.Rv, { component: S, headingLevel: 1, description: R }),
      '\n',
      (0, r.jsx)(p.I, { component: S }),
      '\n',
      (0, r.jsx)(t.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, r.jsx)(j.B, { component: S, illustration: a.Z }),
      '\n',
      ...
      '\n',
      (0, r.jsx)(A.U, { omitH1: !0, headingLevel: 3, children: (0, r.jsx)(k, {}) }),
      '\n',
  ...
  49556: (e, t, n) => {
   ...
   var p = n(6076),
    ...
    k = n(49003),
    x = n(75271);
   const b = { color: p.Z, dimension: j.Z, fontFamilies: w.Z, fontSizes: y.Z, fontWeights: f.Z, lineHeights: A.Z, other: v.Z, textDecoration: k.Z },
    C = (e) => {
     let { type: t } = e;
     return (0, g.jsx)(u.JO, { children: (0, x.createElement)(b[t]) });
    };
   function T(e) {
    let { tokens: t } = e;
    const n = (0, i.s0)(t),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => j, BA: () => a, Ee: () => d, Q6: () => i, U: () => g, Yr: () => w, d: () => h, e9: () => o, fO: () => f, mA: () => s, ps: () => m, qU: () => A, s0: () => y, zP: () => p });
