 ...
 [35180],
 {
  15638(e, n, t) {
   ...
   const d = (0, a.createContext)({}),
    k = ({ title: e, appearance: n, description: t, children: a, figure: k }) => {
  ...
  58639(e, n, t) {
   ...
   const b = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: b = !0, children: j, container: v = 'document', language: x, designTokens: y }) => {
