 ...
 [45129],
 {
  ...
  70348(e, n, t) {
   ...
   const s = ({ className: e, ...n }) => {
    ...
    o = ({ className: e, classNamePanel: n, label: t, heading: s, headingLevel: o, headingApperance: c, ...d }) => {
     const p = (0, i.A)('utrecht-accordion__section', e),
      h = (0, i.A)('utrecht-accordion__panel', n);
     return (0, l.jsxs)('details', { className: p, ...d, children: [(0, l.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, l.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, l.jsx)('span', { className: 'nl-button__icon-start', children: (0, l.jsx)(r.A, {}) }), (0, l.jsxs)('span', { className: 'nl-button__label', children: [s && (0, l.jsx)(a.D, { level: o, appearance: c, children: s }), t] })] }) }), (0, l.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => x });
