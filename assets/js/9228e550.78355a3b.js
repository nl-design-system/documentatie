 ...
 [54291],
 {
  ...
  35038: (e, t, n) => {
   ...
   const c = (e) => {
    ...
    a = (e) => {
     let { href: t, appearance: n, className: c, component: o = 'div', background: a, children: u } = e;
     const l = (e) => ('article' === o ? (0, i.jsx)('article', { ...e }) : 'section' === o ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      h = (0, i.jsx)(l, { className: (0, s.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, c), children: u });
  ...
  8657: (e, t, n) => {
   ...
   const x = (e) => {
     ...
     const i = t && t.projects.filter((e) => w.e9.includes(e.id)),
      c = i && w.e9.map((e) => i.find((t) => t.id === e)).filter(Boolean),
      o = (e) => (['Candidate - New', 'Candidate - Oud'].includes(e.title) ? 'Candidate' : e.title);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       sections: c.map((e) => ({
        className: (0, s.Z)('definition-of-done', e && `definition-of-done--${(0, w.mA)(o(e))}`),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, l.jsx)(k, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(f, { headingLevel: n + 1, checked: t, title: r, description: (0, w.Q6)(s) }, s);
            }),
           }),
               ...
               i.length > 0 &&
                (0, l.jsx)(l.Fragment, {
                 children: i.map((e) => {
                  ...
                  return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.X6, { level: n + 2, children: [s, ' in ', t] }), (0, l.jsx)(r.Mc, { links: i.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
    ...
    A = (e) => {
     ...
     const i = t && w.$3[t.relayStep];
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(g.V, { level: n, suffix: i && (0, l.jsx)(p.y, { state: i }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: s })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => o, Ee: () => l, Q6: () => i, U: () => j, Yr: () => g, d: () => h, e9: () => c, fO: () => b, mA: () => s, ps: () => y, qU: () => k, s0: () => v, zP: () => m });
