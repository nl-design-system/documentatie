 ...
 [49358],
 {
  1292(e, n, t) {
   ...
   var i = t(29181),
    ...
    l = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(o.A, {}), github: (0, d.jsx)(r.A, {}), npm: (0, d.jsx)(s.A, {}), storybook: (0, d.jsx)(a.A, {}) },
    p = ({ brand: e }) => (0, d.jsx)(i.In, { children: c[e] || (0, d.jsx)(l.A, {}) });
  },
  33062(e, n, t) {
   t.d(n, { bo: () => o, KF: () => u, mJ: () => f, VZ: () => N, cR: () => A, Pv: () => h, qZ: () => s, kD: () => x, B2: () => m, Pc: () => l, f4: () => a, GT: () => k, fX: () => r, eQ: () => v, B_: () => b, o_: () => j, Rc: () => _ });
     ...
     return n.map((n) => {
      const i = e.tasks
       ...
       .map(({ name: i, id: o, value: r }) => {
        ...
        return { brand: s.toLowerCase(), name: i, id: o, value: r, description: a };
       });
  ...
  37131(e, n, t) {
   ...
   const f = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
            ...
            s.Zp,
            {
             ...
             children: (0, d.jsxs)(s.Wu, {
              children: [
               ...
               a.length > 0 && (0, d.jsx)(d.Fragment, { children: a.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(i.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, d.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(r.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u.p, { level: n, suffix: o && (0, d.jsx)(p.D, { state: o }), children: e.title }), (0, d.jsx)(i.fz, { lead: !0, children: t })] });
    },
    x = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
  ...
  67970(e, n, t) {
   ...
   const a = ({ state: e }) => {
    const n = (0, r.fX)(e);
    return (0, s.jsx)(i.KE, { className: (0, o.A)('estafette-badge', n && `estafette-badge--${n}`), children: e });
   };
  },
  72245(e, n, t) {
   (t.r(n), t.d(n, { assets: () => c, component: () => g, contentTitle: () => d, default: () => j, description: () => u, frontMatter: () => l, issueNumber: () => m, metadata: () => i, title: () => p, toc: () => f }));
  ...
  72642(e, n, t) {
   ...
   var i = t(13526),
    o = t(86070);
   const r = ({ children: e, className: n, level: t = 1, suffix: r, ...s }) => (0, o.jsxs)('hgroup', { className: (0, i.A)('nlds-inline-heading-group', `utrecht-heading-${t}`, n), ...s, children: [(0, o.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), r && (0, o.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [r ? ' ' : '', r] })] });
  },
  90495(e, n, t) {
   ...
   var i = t(46447),
    o = t(13526),
    r = t(86070);
   const s = ({ background: e, children: n, className: t, ...i }) => (0, r.jsx)('div', { className: (0, o.A)('card__illustration', e && `card__illustration--${e}`, t), ...i, children: n }),
