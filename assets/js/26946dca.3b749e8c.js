 ...
 [3958],
 {
  ...
  16764(e, n, t) {
   ...
   var h = t(43864),
    ...
    A = t(79532),
    S = t(30758);
   const C = { boxShadow: h.A, color: j.A, cursor: x.A, dimension: k.A, fontFamily: b.A, fontFamilies: b.A, fontSize: f.A, fontSizes: f.A, fontWeight: v.A, fontWeights: v.A, lineHeight: y.A, lineHeights: y.A, number: w.A, other: D.A, textDecoration: A.A },
    F = ({ type: e }) => {
       ...
       children: [
        ...
        (0, m.jsx)(r.BF, {
         children: i.map((n) => {
          const t = (0, s.o_)(n),
           i = (0, s.eQ)(e, n).$type;
          return (0, m.jsxs)(r.Hj, { children: [(0, m.jsx)(r.nA, { children: (0, m.jsx)(a.C, { children: (0, m.jsx)(r.kf, { children: t }) }) }), (0, m.jsx)(r.nA, { children: (0, m.jsxs)(o.K, { children: [(0, m.jsx)(F, { type: i }), ' ', i] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  26655(e, n, t) {
   ...
   const r = ({ background: e, children: n, className: t, ...a }) => (0, s.jsx)('div', { className: (0, o.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, t), ...a, children: n }),
    ...
    d = ({ appearance: e = 'medium', children: n, className: t }) => (0, s.jsx)('div', { className: (0, o.A)('ma-cardgroup', `ma-cardgroup--${e}`, t), children: n });
  },
  31522(e, n, t) {
   'use strict';
   t.d(n, { D: () => i });
  ...
  49895(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => N, component: () => B, contentTitle: () => T, default: () => G, description: () => H, frontMatter: () => F, issueNumber: () => _, metadata: () => a, title: () => L, toc: () => R }));
