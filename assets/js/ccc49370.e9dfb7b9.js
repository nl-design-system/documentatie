 ...
 [18401, 83249],
 {
  ...
  21530(e, t, n) {
   ...
   var s = n(46447),
    o = n(13526),
    l = n(86070);
   const r = ({ background: e, children: t, className: n, ...s }) => (0, l.jsx)('div', { className: (0, o.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, n), ...s, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: r = 'div', background: i, children: a }) => {
     const c = (e) => ('article' === r ? (0, l.jsx)('article', { ...e }) : 'section' === r ? (0, l.jsx)('section', { ...e }) : (0, l.jsx)('div', { ...e })),
      d = (0, l.jsx)(c, { className: (0, o.A)('ma-cardgroup__card', i && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${t}`, n), children: a });
     return e ? (0, l.jsx)(s.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: d }) : d;
    },
    c = ({ appearance: e = 'large', children: t, className: n }) => (0, l.jsx)('div', { className: (0, o.A)('ma-cardgroup', `ma-cardgroup--${e}`, n), children: t });
  },
  21729(e, t, n) {
   'use strict';
   n.d(t, { A: () => E });
   ...
   var A = n(25557),
    ...
    k = n(85162),
    N = n(39569);
   const G = ({ name: e, description: t, relayStep: n, headingLevel: s = 2, href: o, frameworkNames: l }) => {
     return (0, i.jsxs)(v.Zp, { appearance: 'large', className: (0, g.A)('ma-component-card', !n && 'ma-component-card--suggestion'), component: 'section', children: [(0, i.jsx)(v.Fu, { children: (0, i.jsx)(k.s, { relayStep: n, description: `Schets van de ${e} component`, name: e }) }), (0, i.jsxs)(v.Wu, { children: [(0, i.jsxs)('div', { children: [(0, i.jsx)(C.D, { level: s, className: 'ma-component-card__title', children: e }), n && (0, i.jsx)('p', { children: (0, i.jsx)(N.D, { state: n }) }), t && (0, i.jsx)(T.f, { children: t }), l && (0, i.jsx)(m._Q, { children: l.map((e) => (0, i.jsx)(m.KE, { children: e }, e)) })] }), o && (0, i.jsx)(T.f, { children: (0, i.jsxs)(j.N, { className: 'utrecht-link', to: ((r = o), 'string' == typeof r && !1 === r.endsWith('/') ? `${r}/` : r), children: ['Bekijk ', (0, i.jsx)('span', { className: 'w', children: e }), ' component'] }) })] })] });
     var r;
    },
    W = () => {
     const e = 'framework',
        ...
        (0, i.jsx)(v.AC, {
         ...
         children: d.map(({ title: e, id: t, href: n, description: s }) => {
          const o = y.find((t) => t.title === e),
           ...
           r = (0, b.mJ)(o);
          return (0, i.jsx)(G, { name: e, headingLevel: 2, href: n, description: s, relayStep: l, frameworkNames: r }, t);
         }),
        }),
       ],
      })
   ...
   var _ = n(44715),
    R = n(79889);
   const S = ({ title: e, sc: t, children: n, tags: s }) => {
     const o = (0, r.useId)(),
      l = [...s];
     if (t) {
      l.push(t);
     ...
     return (0, i.jsx)('li', {
      ...
      children: (0, i.jsxs)('details', {
       children: [
        (0, i.jsx)('summary', { children: (0, i.jsx)('span', { className: 'ma-new-checklist__title', id: o, children: e }) }),
        (0, i.jsxs)('div', {
         ...
         children: [
          ...
          (0, i.jsx)(x._Q, {
           ...
           children: l.map((e, t) => {
            let n = (0, i.jsx)(R.K, { children: e }, t);
            if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
             const s = _.pI.get(e);
             n = (0, i.jsx)(j.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${s.sc} ${s.nl.title}`, style: { lineHeight: 1 }, children: (0, i.jsx)(R.K, { children: `WCAG ${e}` }) }, t);
            }
            return n;
           }),
          }),
       ...
       (0, i.jsxs)('div', {
        ...
        children: [
         (0, i.jsxs)(m.LB, {
          ...
          'aria-labelledby': c,
          children: [
           (0, i.jsx)(m.DZ, { level: Number(t), id: c, children: 'Filter acceptatiecriteria voor:' }),
   ...
   const P = ({ children: e }) => (0, i.jsx)('ol', { className: 'nlds-anatomy-list', children: e }),
    M = ({ children: e }) => (0, i.jsx)('li', { className: 'nlds-anatomy-list__item', children: e }),
    D = ({ component: e, illustration: t }) => {
     const { title: s } = e,
      o = (0, b.fX)(s),
      l = r.lazy(() => n(51580)(`./${o}-docs/docs/anatomy/anatomy.md`).catch(() => ({ default: () => null })));
     return (0, i.jsx)(r.Suspense, { fallback: null, children: (0, i.jsxs)('figure', { className: (0, g.A)('ma-component-anatomy'), children: [t && (0, i.jsx)(t, { height: null, className: (0, g.A)('ma-component-anatomy__illustration') }), t && l && (0, i.jsx)('figcaption', { children: (0, i.jsx)(F.o, { omitH1: !0, headingLevel: 1, components: { ol: ({ children: e }) => (0, i.jsx)(P, { children: e }), li: ({ children: e }) => (0, i.jsx)(M, { children: e }) }, children: (0, i.jsx)(l, {}) }) })] }) });
    },
    O = ({ title: e, sc: t, status: n, children: s, headingLevel: o = 4 }) => {
     const l = _.pI.get(t),
      r = l ? `${t} ${l.nl?.title}` : t;
     return (0, i.jsxs)('div', { className: 'ma-component-criteria-section', children: [(0, i.jsx)(m.DZ, { appearance: 'utrecht-heading-4', level: o, className: 'ma-component-criteria-section__heading', children: e }), (t || n) && (0, i.jsxs)('dl', { className: 'ma-component-criteria-section__dl', children: [t && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('dt', { className: 'ma-component-criteria-section__dt', children: 'WCAG' }), (0, i.jsx)('dd', { className: 'ma-component-criteria-section__dd', children: (0, i.jsx)(m.N_, { href: `/wcag/${t}/`, children: r }) })] }), n && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('dt', { className: 'ma-component-criteria-section__dt', children: 'Status' }), (0, i.jsx)('dd', { className: 'ma-component-criteria-section__dl', children: n })] })] }), s] });
    },
    I = ({ testCategory: e, children: t }) => (0, i.jsx)(x.If, { sections: [{ className: 'utrecht-accordion--nlds-subtle', headingLevel: 3, expanded: !1, label: (0, i.jsx)('span', { children: e }), body: t }] });
   var z = n(58876);
     ...
     components: {
      ...
      ul: (e) =>
       e.className?.includes('contains-task-list')
        ? (0, i.jsx)(z._, {
           children: (Array.isArray(e.children) ? e.children : [e.children]).filter(r.isValidElement).map((e) => {
            const { children: t } = e.props,
             n = t.find((e) => 'object' == typeof e),
             s = Array.isArray(t) ? t.filter((e) => 'string' == typeof e) : [];
            return (0, i.jsx)(z.Z, { checked: n.props.checked, description: [...s].join('') }, s.join(''));
           }),
          })
  ...
  32385(e, t, n) {
   'use strict';
   n.d(t, { bo: () => o, KF: () => h, mJ: () => p, VZ: () => j, cR: () => v, Pv: () => w, qZ: () => r, kD: () => x, QQ: () => T, B2: () => g, Pc: () => a, f4: () => i, GT: () => b, fX: () => l, eQ: () => y, B_: () => f, o_: () => A });
  ...
  39569(e, t, n) {
   ...
   const i = ({ state: e }) => {
    const t = (0, l.fX)(e);
    return (0, r.jsx)(s.KE, { className: (0, o.A)('ma-estafette-badge', t && `ma-estafette-badge--${t}`), children: e });
   };
  },
  44715(e, t, n) {
   'use strict';
   ...
   const d = (0, a.createContext)({}),
    m = ({ title: e, appearance: t, description: n, children: a, figure: m }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      g = m ? 'figure' : 'div',
      u = m ? 'figcaption' : 'div',
      p = 'string' == typeof n ? (0, c.jsx)(i.oz, { components: { a: l.N_ }, children: n }) : n;
  ...
  85162(e, t, n) {
   ...
   const i = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    a = ({ name: e, relayStep: t, description: n }) => {
     const a = (0, l.fX)(t),
      c = i[e] ?? e;
     return (0, r.jsxs)(s.WK, { children: [(0, r.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, o.A)('ma-component-illustration', `ma-component-illustration--${a}`), fill: 'none', children: [(0, r.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, r.jsx)('rect', { width: '960', height: '540' }), (0, r.jsx)('rect', { width: '960', height: '540' })] }), (0, r.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, r.jsx)('use', { href: `/svg/componenten_overzicht_${(0, l.fX)(c)}.svg#component-illustration` })] }), (0, r.jsx)(s.$P, { className: 'ma-component-illustration__caption', children: n })] });
    };
  },
  94309(e, t, n) {
   'use strict';
   ...
   const r = ({ children: e, ...t }) => {
     ...
     return ('https://nldesignsystem.nl' === a.origin ? (a.pathname.endsWith('/') || (0, o.QQ)(a.pathname) || (a.pathname = `${a.pathname}/`), (i = a.toString().replace('https://nldesignsystem.nl', ''))) : ((r.target = '_blank'), (r.rel = 'noopener noreferrer')), (0, l.jsx)('a', { href: i, ...r, children: e }));
    },
    i = ({ className: e, ...t }) => (0, l.jsx)(r, { className: (0, s.$)('utrecht-link', 'utrecht-link--html-a', e), ...t });
  },
 },
]);
