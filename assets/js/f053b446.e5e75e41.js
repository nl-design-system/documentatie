(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [88474],
 {
  ...
  38895: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => N, component: () => M, contentTitle: () => Z, default: () => F, description: () => S, frontMatter: () => R, issueNumber: () => D, metadata: () => z, title: () => _, toc: () => L });
   var r,
    o,
    s,
    i,
   ...
   const R = { title: 'Code', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code', pagination_label: 'Code', description: 'Markeert korte tekst die code vertegenwoordigt.', slug: '/code', keywords: ['code block'] },
    ...
    _ = 'Code',
    S = 'Markeert korte tekst die code vertegenwoordigt.',
    D = 326,
    M = m.find((e) => e.number === D);
   function P(e) {
    ...
    return (0, h.jsxs)(h.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, h.jsx)(W.Rv, { component: M, headingLevel: 1, description: S }),
      '\n',
