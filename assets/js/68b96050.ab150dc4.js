 ...
 [34799],
 {
  ...
  17889(e, n, a) {
   ...
   var h = a(35193),
    ...
    y = a(79532),
    w = a(30758);
   const D = { color: h.A, dimension: j.A, fontFamilies: x.A, fontSizes: k.A, fontWeights: b.A, lineHeights: f.A, other: v.A, textDecoration: y.A },
       ...
       children: [
        ...
        (0, m.jsx)(i.BF, {
         children: a.map((n) => {
          const a = (0, s.o_)(n),
           o = (0, s.eQ)(e, n).$type;
          return (0, m.jsxs)(i.Hj, { children: [(0, m.jsx)(i.nA, { children: (0, m.jsx)(t.C, { children: (0, m.jsx)(i.kf, { children: a }) }) }), (0, m.jsx)(i.nA, { children: (0, m.jsxs)(r.K, { children: [(0, m.jsx)(A, { type: o }), ' ', o] }) })] }, a);
         }),
        }),
       ],
      }),
      (0, m.jsxs)(i.e2, { children: [(0, m.jsx)(p, { content: l, language: 'json', children: 'Kopieer als JSON' }), (0, m.jsx)(p, { content: o, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  28339(e, n, a) {
   'use strict';
   (a.r(n), a.d(n, { assets: () => C, component: () => R, contentTitle: () => L, default: () => G, description: () => z, frontMatter: () => N, issueNumber: () => _, metadata: () => t, title: () => H, toc: () => P }));
  ...
  33062(e, n, a) {
   'use strict';
   a.d(n, { bo: () => r, KF: () => u, mJ: () => h, VZ: () => D, cR: () => w, Pv: () => j, qZ: () => i, kD: () => f, B2: () => m, Pc: () => l, f4: () => o, GT: () => v, fX: () => s, eQ: () => b, B_: () => k, o_: () => x, Rc: () => y });
  ...
  67970(e, n, a) {
   ...
   const o = ({ state: e }) => {
    const n = (0, s.fX)(e);
    return (0, i.jsx)(t.KE, { className: (0, r.A)('estafette-badge', n && `estafette-badge--${n}`), children: e });
   };
  },
  72401(e, n, a) {
   'use strict';
  ...
  90495(e, n, a) {
   ...
   var t = a(46447),
    r = a(13526),
    s = a(86070);
   const i = ({ background: e, children: n, className: a, ...t }) => (0, s.jsx)('div', { className: (0, r.A)('card__illustration', e && `card__illustration--${e}`, a), ...t, children: n }),
    ...
    l = ({ href: e, appearance: n, className: a, component: i = 'div', background: o, children: l }) => {
     const d = (e) => ('article' === i ? (0, s.jsx)('article', { ...e }) : 'section' === i ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      c = (0, s.jsx)(d, { className: (0, r.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, a), children: l });
     return e ? (0, s.jsx)(t.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: c }) : c;
    },
    d = ({ appearance: e = 'medium', children: n, className: a }) => (0, s.jsx)('div', { className: (0, r.A)('cardgroup', `cardgroup--${e}`, a), children: n });
  },
 },
]);
