/*! For license information please see 71fb168a.80c971f8.js.LICENSE.txt */
'use strict';
 ...
 [31399],
 {
  ...
  24456(e, s, n) {
   ...
   const r = ({ children: e, ...s }) => {
    ...
    a = ({ className: e, boxContent: s, ...n }) => (0, o.jsx)(r, { className: (0, t.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': s }, e), ...n });
  },
  29680(e, s, n) {
   n.d(s, { v: () => a });
   var t = n(24456),
  ...
  84471(e, s, n) {
   n.d(s, { bo: () => i, KF: () => g, mJ: () => u, VZ: () => j, cR: () => S, Pv: () => y, qZ: () => r, kD: () => v, QQ: () => x, B2: () => h, Pc: () => l, f4: () => a, GT: () => w, fX: () => o, eQ: () => k, B_: () => f, o_: () => b });
