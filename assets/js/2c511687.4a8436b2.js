 ...
 [35062],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    l = n(86070);
   const h = { figma: (0, l.jsx)(i.A, {}), github: (0, l.jsx)(s.A, {}), npm: (0, l.jsx)(c.A, {}), storybook: (0, l.jsx)(o.A, {}) },
    u = ({ brand: e }) => (0, l.jsx)(r.In, { children: h[e] || (0, l.jsx)(a.A, {}) });
  },
  2685(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => u, component: () => p, componentName: () => m, contentTitle: () => h, default: () => k, description: () => j, frontMatter: () => l, issueNumber: () => y, metadata: () => r, relayStep: () => g, title: () => d, toc: () => v }));
   const r = JSON.parse('{"id":"componenten/logo/index","title":"Logo","description":"Afbeelding met het beeldmerk of woordmerk van een organisatie.","source":"@site/docs/componenten/logo/index.mdx","sourceDirName":"componenten/logo","slug":"/logo","permalink":"/logo","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/logo/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Logo","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Logo","pagination_label":"Logo","description":"Afbeelding met het beeldmerk of woordmerk van een organisatie.","slug":"/logo","keywords":["beeldmerk","brand","brand identity","brand logo","huisstijl","identiteit","graphic","image","logo","merkidentiteit","pictogram","symbol","visual identity","visual representation","visuele representatie","word","woordmerk"]},"sidebar":"componenten","previous":{"title":"Login Link","permalink":"/login-link"},"next":{"title":"Mark","permalink":"/mark"}}');
   var i = n(86070),
    s = n(18439),
    c = n(87069),
    o = n(85825),
    a = n(44594);
   const l = { title: 'Logo', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Logo', pagination_label: 'Logo', description: 'Afbeelding met het beeldmerk of woordmerk van een organisatie.', slug: '/logo', keywords: ['beeldmerk', 'brand', 'brand identity', 'brand logo', 'huisstijl', 'identiteit', 'graphic', 'image', 'logo', 'merkidentiteit', 'pictogram', 'symbol', 'visual identity', 'visual representation', 'visuele representatie', 'word', 'woordmerk'] },
    h = void 0,
    u = {},
    d = 'Logo',
    j = 'Afbeelding met het beeldmerk of woordmerk van een organisatie.',
    y = 339,
    g = 'help wanted',
    m = 'logo',
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => g, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => c, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => s, eQ: () => f, B_: () => v, o_: () => p, Rc: () => x });
  ...
  44594(e, t, n) {
   ...
   const o = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    a = ({ name: e, relayStep: t, description: n }) => {
     const a = (0, s.fX)(t),
      l = o[e] ?? e;
     return (0, c.jsxs)(r.WK, { children: [(0, c.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, i.A)('component-illustration', `component-illustration--${a}`), fill: 'none', children: [(0, c.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, c.jsx)('rect', { width: '960', height: '540' }), (0, c.jsx)('rect', { width: '960', height: '540' })] }), (0, c.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, c.jsx)('use', { href: `/svg/componenten_overzicht_${(0, s.fX)(l)}.svg#component-illustration` })] }), (0, c.jsx)(r.$P, { className: 'component-illustration__caption', children: n })] });
    };
  },
  54565(e, t, n) {
   'use strict';
  ...
  85825(e, t, n) {
   ...
   const g = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    m = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, l.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(y.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [n ? (0, l.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }) : null, r, t] })] });
   var p = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, l.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(g, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(m, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            c.Zp,
            {
             ...
             children: (0, l.jsxs)(c.Wu, {
              children: [
               ...
               o.length > 0 && (0, l.jsx)(l.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
   ...
   const c = ({ background: e, children: t, className: n, ...r }) => (0, s.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: c = 'div', background: o, children: a }) => {
     const l = (e) => ('article' === c ? (0, s.jsx)('article', { ...e }) : 'section' === c ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      h = (0, s.jsx)(l, { className: (0, i.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
