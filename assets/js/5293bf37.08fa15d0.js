  ...
  78599(e, n, t) {
   ...
   const d = ({ listId: e = '', laPostaId: n = '', thanksPage: t = '', emailFieldId: d = '', firstNameFieldId: o = '', orgId: m = '', interestsId: c = '', interestsLegend: h = 'Waar wil je NL Design System voor gebruiken?', interests: u = [], interestsRequired: g = !1, disallowedInterestValues: p = [], workAreasId: j = '', privacyPolicyId: x = '', language: v, submitText: f = '', talkTitleId: y = '', talkDescriptionId: k = '', roleId: b = '', roleLegend: w = 'Wat is jouw rol?', roles: z = [], roleRequired: I = !1 }) => {
    ...
    return (0, l.jsxs)('form', {
     ...
     children: [(0, l.jsxs)(i.zB, { type: 'email', children: [(0, l.jsx)(i.fz, { children: (0, l.jsx)(i.lR, { htmlFor: `id-${d}`, children: E ? 'Email address ' : 'E-mailadres' }) }), R[d] && (0, l.jsx)(i.YB, { children: R[d].message }), (0, l.jsx)(i.fz, { children: (0, l.jsx)(i.Rj, { id: `id-${d}`, name: d, type: 'email', autoComplete: 'email', defaultValue: q, 'aria-required': 'true', ...D(`${d}`, { required: { value: !0, message: E ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' }, pattern: { value: /\S+@\S+\.\S+/, message: E ? 'This is not a valid email address.' : 'Dit is geen correct emailadres.' } }), invalid: !!R[d] }) })] }), (0, l.jsxs)(i.zB, { type: 'text', children: [(0, l.jsx)(i.fz, { children: (0, l.jsx)(i.lR, { htmlFor: o, children: E ? 'Name' : 'Naam' }) }), R[o] && (0, l.jsx)(i.YB, { children: R[o].message }), (0, l.jsx)(i.fz, { children: (0, l.jsx)(i.Rj, { id: o, name: o, type: 'text', defaultValue: F, autoComplete: 'given-name', 'aria-required': 'true', ...D(`${o}`, { required: { value: !0, message: E ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' } }), invalid: !!R[o] }) })] }), y && (0, l.jsxs)(i.zB, { type: 'text', children: [(0, l.jsxs)(i.fz, { children: [(0, l.jsx)(i.lR, { htmlFor: y, children: E ? 'Title of your talk' : 'Titel van je presentatie' }), (0, l.jsx)(i.JM, { children: E ? 'What would you name your talk?' : 'Hoe zou jij je presentatie noemen?' })] }), (0, l.jsx)(i.fz, { children: (0, l.jsx)(i.Rj, { id: y, name: y, ...D(y, { required: { value: !0, message: E ? 'You can only submit a talk if you provide a title.' : 'Je kunt alleen een voorstel insturen als je een titel toevoegd.' } }) }) })] }), k && (0, l.jsxs)(i.zB, { type: 'text', children: [(0, l.jsxs)(i.fz, { children: [(0, l.jsx)(i.lR, { htmlFor: k, children: E ? 'Descibe your talk' : 'Beschrijf je presentatie' }), (0, l.jsx)(i.JM, { children: E ? 'What is it about? Who would be your intended audience? Have you spoken about this topic before?' : 'Waar gaat het over? Voor wie is het interessant? Heb je al vaker over dit onderwerp gesproken?' })] }), (0, l.jsx)(i.fz, { children: (0, l.jsx)(i.TM, { id: k, name: k, rows: 12, ...D(k, { required: { value: !0, message: E ? 'You can only submit a talk if you provide a description.' : 'Je kunt alleen een voorstel insturen als je een beschrijving toevoegd.' } }) }) })] }), m && (0, l.jsxs)(i.zB, { type: 'text', children: [(0, l.jsx)(i.fz, { children: (0, l.jsx)(i.lR, { htmlFor: m, children: E ? 'Organisation (not required)' : 'Organisatie (niet verplicht)' }) }), R[m] && (0, l.jsx)(i.YB, { children: R[m].message }), (0, l.jsx)(i.fz, { children: (0, l.jsx)(i.Rj, { id: m, name: m, type: 'text' }) })] }), c && (0, l.jsxs)(i.LB, { children: [(0, l.jsx)(i.fz, { children: (0, l.jsxs)(i.u4, { children: [h, !g && ' (niet verplicht)'] }) }), (0, l.jsx)(i.JM, { children: 'Meerdere antwoorden mogelijk.' }), u.map((e, n) => (0, l.jsxs)(i.zB, { type: 'checkbox', children: [(0, l.jsx)(i.Sc, { name: `${c}[]`, value: T[n], id: `${c}-${T[n]}` }), (0, l.jsx)(i.lR, { htmlFor: `${c}-${T[n]}`, children: e })] }, e))] }), b && (0, l.jsxs)(i.LB, { children: [(0, l.jsx)(i.fz, { children: (0, l.jsxs)(i.u4, { children: [w, !I && ' (niet verplicht)'] }) }), (0, l.jsx)(i.JM, { children: 'Meerdere antwoorden mogelijk.' }), z.map((e, n) => (0, l.jsxs)(i.zB, { type: 'checkbox', children: [(0, l.jsx)(i.Sc, { name: `${b}[]`, id: `${b}-${n}` }), (0, l.jsx)(i.lR, { htmlFor: `${b}-${n}`, children: e })] }, e))] }), j && (0, l.jsxs)(i.zB, { type: 'text', children: [(0, l.jsxs)(i.fz, { children: [(0, l.jsx)(i.lR, { htmlFor: j, children: 'Aan wat voor projecten werk je? (niet verplicht)' }), (0, l.jsx)(i.JM, { children: 'Denk aan mijn-omgevingen, formulieren en/of kaarten.' })] }), (0, l.jsx)(i.fz, { children: (0, l.jsx)(i.TM, { id: j, name: j }) })] }), x && (0, l.jsxs)(i.zB, { type: 'text', children: [(0, l.jsx)(i.JM, { id: `${x}-description`, children: E ? (0, l.jsxs)('p', { children: ['The ', (0, l.jsx)('a', { href: '/privacy-policy', children: 'privacy policy' }), ' of NL Design System applies to our activities.'] }) : (0, l.jsxs)('p', { children: ['Op onze activiteiten is de ', (0, l.jsx)('a', { href: '/privacyverklaring', children: 'privacyverklaring van NL Design System' }), ' van toepassing.'] }) }), (0, l.jsxs)(i.zB, { type: 'checkbox', children: [(0, l.jsx)(i.Sc, { value: '1', id: `${x}-1`, 'aria-describedby': `${x}-description`, 'aria-required': 'true', ...D(`${x}[]`, { required: { value: !0, message: E ? 'You can only register if you agree with the privacy policy.' : 'Je kunt je alleen aanmelden als je akkoord gaat met de privacyverklaring.' } }), invalid: !!R[`${x}[]`] }), (0, l.jsx)(i.lR, { htmlFor: `${x}-1`, children: E ? 'I agree to the use of my data in accordance with the privacy policy' : 'Ik ga akkoord met het gebruik van mijn gegevens volgens de privacyverklaring' })] }), R[x] && (0, l.jsx)(i.YB, { children: R[x].message })] }), v?.id && (0, l.jsx)('input', { type: 'hidden', name: v.id, value: v.value }), (0, l.jsx)(i.e2, { children: (0, l.jsx)(i.$n, { type: 'submit', appearance: 'primary-action-button', children: f || (E ? 'Sign up' : 'Aanmelden') }) }), (0, l.jsx)('input', { type: 'hidden', name: 'next', value: t }), (0, l.jsx)('input', { type: 'hidden', name: 'a', value: n }), (0, l.jsx)('input', { type: 'hidden', name: 'l', value: e }), (0, l.jsx)('input', { name: 'osnD9cWRI3', autoComplete: 'on', id: 'id-osnD9cWRI3', type: 'hidden', value: 'NLDS website' }), (0, l.jsx)('input', { autoComplete: 'new-password', type: 'email', id: 'email', name: 'email', placeholder: 'Your e-mail here', className: 'sr-only', 'aria-hidden': 'true', tabIndex: -1 })],
    });
   };
  },
 },
