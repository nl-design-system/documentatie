   ...
   var l = r.createContext({}),
    ...
    c = r.forwardRef(function (e, t) {
     var n = e.components,
      ...
      g = m(n),
      c = i,
      p = g["".concat(l, ".").concat(c)] || g[c] || d[c] || a;
     return n ? r.createElement(p, s(s({ ref: t }, u), {}, { components: n })) : r.createElement(p, s({ ref: t }, u));
    });
   function p(e, t) {
    var n = arguments,
     i = t && t.mdxType;
    if ("string" == typeof e || i) {
     ...
     (o.originalType = e), (o[g] = "string" == typeof e ? e : i), (s[1] = o);
