/*! For license information please see 5c0cafdc.73d21d0d.js.LICENSE.txt */
'use strict';
    ...
    d = (e) => {
     ...
     return k
      ? (0, o.jsxs)('article', {
         ...
         children: [
          (0, o.jsx)(s.X6, { level: i, className: 'dsw-session__title', id: k.subject.toLowerCase().replace(/\s/gi, '-'), children: k.subject }),
          ...
          k && k.isoDateTime && k.isoDateTime > l ? (0, o.jsx)(s.nv, { children: (0, o.jsx)('time', { dateTime: k.isoDateTime, children: new Intl.DateTimeFormat(n, { dateStyle: 'full', timeStyle: 'nl' === n ? 'short' : 'full', timeZone: 'Europe/Amsterdam' }).format(new Date(k.isoDateTime)) }) }) : (0, o.jsx)(o.Fragment, {}),
          g,
          'nl' === n &&
           b.find((e) => {
            let { language: n } = e;
          ...
          m && (0, o.jsxs)(s.nv, { children: [(0, o.jsx)('b', { children: 'Goed te weten:' }), ' Bij deze sessie is een schrijftolk aanwezig', u && (0, o.jsxs)('a', { href: u, children: ['tolktekst', (0, o.jsxs)('span', { className: 'sr-only', children: [' bij ', k.subject] })] }), '.'] }),
          ...
          k && k.icalLink && !c ? (0, o.jsx)(s.nv, { children: (0, o.jsxs)(s.ZP, { href: k.icalLink, download: k.icalLink, appearance: 'primary-action-button', children: [(0, o.jsx)(s.JO, { children: (0, o.jsx)(t.Z, {}) }), (0, o.jsx)('span', { children: 'nl' === n ? (0, o.jsxs)(o.Fragment, { children: ['Zet', (0, o.jsx)('span', { className: 'sr-only', children: k.subject }), ' in je agenda'] }) : (0, o.jsxs)(o.Fragment, { children: ['Add', (0, o.jsx)('span', { className: 'sr-only', children: k.subject }), ' to your calendar'] }) })] }) }) : null,
         ],
        })
      : (0, o.jsx)(o.Fragment, {});
    };
  ...
  84263: (e, n, i) => {
   ...
   var r = t.forwardRef(function (e, n) {
    var i = t.useState(!1),
     ...
     b = new URLSearchParams(s(s(s(s({}, e.muted ? { mute: '1' } : {}), k ? { autoplay: '1' } : {}), e.enableJsApi ? { enablejsapi: '1' } : {}), e.playlist ? { list: g } : {}));
    e.params &&
     ...
     t.createElement(
      ...
      t.createElement(
       C,
       {
        ...
        'data-title': u,
        style: s(s({ backgroundImage: 'url('.concat(S, ')') }, { '--aspect-ratio': ''.concat((E / L) * 100, '%') }), K),
       },
