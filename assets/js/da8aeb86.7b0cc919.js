 ...
 [54592],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    u = n(86070);
   const h = { figma: (0, u.jsx)(i.A, {}), github: (0, u.jsx)(c.A, {}), npm: (0, u.jsx)(o.A, {}), storybook: (0, u.jsx)(s.A, {}) },
    l = ({ brand: e }) => (0, u.jsx)(r.In, { children: h[e] || (0, u.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => g, VZ: () => w, cR: () => _, Pv: () => m, qZ: () => o, kD: () => k, B2: () => j, Pc: () => a, f4: () => s, GT: () => f, fX: () => c, eQ: () => b, B_: () => v, o_: () => p, Rc: () => x });
  ...
  61133(e, t, n) {
   ...
   var i = n(86070),
    ...
    o = n(36059),
    s = n(85825);
   const a = { title: 'Navigation Bar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Navigation Bar', pagination_label: 'Navigation Bar', description: 'Toont een hi\xebrarchische horizontale navigatie aan de bovenkant van een pagina en biedt de mogelijkheid om tussen pagina\u2019s te navigeren.', slug: '/navigation-bar', keywords: ['bovenbalk', 'bovenste navigatie', 'header', 'header menu', 'hoofdmenu', 'horizontale navigatie', 'horizontal navigation', 'horizontal menu', 'main navigation', 'menu', 'menu balk', 'menu bar', 'menu navigatie', 'navigation bar', 'navigatie balk', 'navigatie menu', 'navigatiebalk', 'page header', 'pagina navigatie', 'page navigation', 'top bar', 'top menu', 'top navigation', 'top navigation bar'] },
    u = void 0,
    h = {},
    l = 'Navigation Bar',
    d = 'Toont een hi\xebrarchische horizontale navigatie aan de bovenkant van een pagina en biedt de mogelijkheid om tussen pagina\u2019s te navigeren.',
    j = 265,
   ...
   const o = ({ background: e, children: t, className: n, ...r }) => (0, c.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: o = 'div', background: s, children: a }) => {
     const u = (e) => ('article' === o ? (0, c.jsx)('article', { ...e }) : 'section' === o ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      h = (0, c.jsx)(u, { className: (0, i.A)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
