...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [73536],
 {
  ...
  24844: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => h, contentTitle: () => c, default: () => m, frontMatter: () => i, metadata: () => d, toc: () => p });
   var l = t(52676),
    r = t(40139),
    s = t(43599),
    o = t(40761),
  ...
  43599: (e, n, t) => {
   ...
   const m = (e) => {
    let { children: n } = e;
    return (0, j.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(r.BB, { className: (0, s.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, j.jsx)(r.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   m.displayName = 'ParagraphContainer';
   const u = (e) => {
    let { children: n } = e;
    return (0, j.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(r.BB, { className: (0, s.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   u.displayName = 'DocumentContainer';
   const b = (e) => {
    let { children: n } = e;
    return (0, j.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: n });
   };
   b.displayName = 'SurfaceContainer';
   const g = (e) => {
    let { code: n, copy: t = !0, defaultExpandedCode: g = !1, displayCode: k = !0, children: x, container: v = 'document', language: y, designTokens: f } = e;
    ...
    (0, h.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(N, { parser: y, plugins: [o.Z, a.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      z(e);
     })();
    }, [N]);
    const T = (0, h.useId)();
    let B = h.Fragment;
    return (
     'paragraph' === v ? (B = m) : 'document' === v ? (B = u) : 'surface' === v && (B = b),
     (0, j.jsxs)('div', {
      className: (0, s.Z)('nlds-canvas'),
      children: [
       _ && (0, j.jsx)('div', { className: (0, s.Z)('nlds-canvas__example'), children: (0, j.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, j.jsx)(B, { children: (0, j.jsx)(r.pu, { children: _ }) }) }) }),
       k &&
        (0, j.jsx)('div', {
       ...
       k &&
        (0, j.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, j.jsx)(l.u, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: C, trim: !0 }),
          t &&
           (0, j.jsx)('div', {
  ...
  41179: (e, n, t) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: t, textContent: c, trim: d } = e,
     h = c;
    const { title: p, type: j } = (0, s.useContext)(o.n),
     m = (0, s.useId)();
    return (
     d && (h = h.trim()),
     (0, i.jsx)(r.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', j ? `\u201c${j}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, i.jsx)(l.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': m, style: t, children: r.map((e, t) => (0, i.jsxs)('span', { ...s({ line: e }), children: [n && (0, i.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
