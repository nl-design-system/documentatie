/*! For license information please see 1a4e3797.a2922357.js.LICENSE.txt */
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [7920],
 {
  17331: (e) => {
   ...
   (e.exports = t),
    ...
    (t.prototype.emit = function (e) {
     ...
     else if (n(a)) for (c = Array.prototype.slice.call(arguments, 1), s = (o = a.slice()).length, u = 0; u < s; u++) o[u].apply(this, c);
     return !0;
    }),
   ...
   (m.PARAMETERS = Object.keys(new m())),
    ...
    (m.prototype = {
     ...
     addNumericRefinement: function (e, t, r) {
      ...
      return (a[e] = n({}, a[e])), a[e][t] ? ((a[e][t] = a[e][t].slice()), a[e][t].push(i)) : (a[e][t] = [i]), this.setQueryParameters({ numericRefinements: a });
     },
   ...
   e.exports = function (e) {
    return function (t, r) {
     var s = e.hierarchicalFacets[r],
         ...
         l.data = n(
          p.map(function (e) {
           ...
           return (function (e, t, r, n, i) {
            var a = t.split(r);
            return { name: a[a.length - 1].trim(), path: t, escapedValue: c(t), count: e, isRefined: n === t || 0 === n.indexOf(t + r), exhaustive: i, data: null };
      ...
      g = t;
     return f && (g = t.slice(f.split(h).length)), g.reduce(p, { name: e.hierarchicalFacets[r].name, count: null, isRefined: !0, path: null, escapedValue: null, exhaustive: d, data: null });
    };
   };
   var n = r(42148),
    i = r(7888),
  ...
  23076: (e, t, r) => {
   ...
   function g(e, t, r) {
    ...
    Object.keys(y).forEach(function (t) {
     ...
     if (s) {
      ...
      o.hierarchicalFacets[l][h] = { attribute: t, data: i, exhaustive: a.exhaustiveFacetsCount };
     } else {
      var m,
       d = -1 !== e.disjunctiveFacets.indexOf(t),
       v = -1 !== e.facets.indexOf(t);
      d && ((m = g[t]), (o.disjunctiveFacets[m] = { name: t, data: i, exhaustive: a.exhaustiveFacetsCount }), p(o.disjunctiveFacets[m], a.facets_stats, t)), v && ((m = f[t]), (o.facets[m] = { name: t, data: i, exhaustive: a.exhaustiveFacetsCount }), p(o.facets[m], a.facets_stats, t));
     }
    }),
     ...
     h.forEach(function (r) {
      ...
      Object.keys(c).forEach(function (t) {
       ...
       if (h) {
        ...
        if (-1 === m) return;
        o.hierarchicalFacets[r][m].data = n({}, o.hierarchicalFacets[r][m].data, f);
       } else {
        r = g[t];
        var d = (a.facets && a.facets[t]) || {};
        (o.disjunctiveFacets[r] = { name: t, data: i({}, f, d), exhaustive: s.exhaustiveFacetsCount }),
       ...
       t.slice(v).forEach(function (t) {
        ...
        Object.keys(r).forEach(function (t) {
         ...
         if (-1 !== f) {
          ...
          o.hierarchicalFacets[h][f].data = i(l, c, o.hierarchicalFacets[h][f].data);
         }
        }),
         v++;
       });
     ...
     Object.keys(e.facetsExcludes).forEach(function (t) {
      var r = e.facetsExcludes[t],
       n = f[t];
      (o.facets[n] = { name: t, data: a.facets[t], exhaustive: a.exhaustiveFacetsCount }),
       r.forEach(function (e) {
        (o.facets[n] = o.facets[n] || { name: t }), (o.facets[n].data = o.facets[n].data || {}), (o.facets[n].data[e] = 0);
       });
     }),
   ...
   (g.prototype.getFacetByName = function (e) {
    ...
    (g.prototype.getFacetValues = function (e, t) {
     ...
     if (r) {
      var n,
       s = i({}, t, { sortBy: g.DEFAULT_SORT, facetOrdering: !(t && t.sortBy) }),
       c = this;
   ...
   u(d, c),
    ...
    (d.prototype.searchOnce = function (e, t) {
     ...
     if ((this._currentNbQueries++, this.emit("searchOnce", { state: r }), !t))
      return this.client.search(n).then(
       function (e) {
        return a._currentNbQueries--, 0 === a._currentNbQueries && a.emit("searchQueueEmpty"), { content: new i(r, e.results), state: r, _originalResponse: e };
       },
       function (e) {
    ...
    (d.prototype.findAnswers = function (e) {
     ...
     var n = r.getModifiedState(t),
      i = f({ attributesForPrediction: e.attributesForPrediction, nbHits: e.nbHits }, { params: h(s._getHitsSearchParams(n), ["attributesToSnippet", "hitsPerPage", "restrictSearchableAttributes", "snippetEllipsisText"]) }),
    ...
    (d.prototype.searchForFacetValues = function (e, t, r, n) {
     ...
     return (
      i
       ? (h = this.client.searchForFacetValues([{ indexName: c.index, params: o }]))
       : a
       ? (h = this.client.initIndex(c.index).searchForFacetValues(o))
       : (delete o.facetName,
         (h = this.client.search([{ type: "facet", facet: e, indexName: c.index, params: o }]).then(function (e) {
          return e.results[0];
         }))),
    ...
    (d.prototype.getCurrentPage = g),
    (d.prototype.getPage = g),
    ...
    (d.prototype._search = function (e) {
     var t = this.state,
      r = [],
      n = [];
     e.onlyWithDerivedHelpers || ((n = s._getQueries(t.index, t)), r.push({ state: t, queriesCount: n.length, helper: this }), this.emit("search", { state: t, results: this.lastResults }));
     var i = this.derivedHelpers.map(function (e) {
      ...
      c = this._queryId++;
     if ((this._currentNbQueries++, !a.length)) return Promise.resolve({ results: [] }).then(this._dispatchAlgoliaResponse.bind(this, r, c));
     try {
    ...
    (d.prototype._dispatchAlgoliaResponse = function (e, t, r) {
     if (!(t < this._lastQueryIdReceived)) {
      ...
      e.forEach(function (e) {
       ...
       } else a.emit("result", { results: null, state: t });
      });
     }
    }),
  ...
  96394: (e, t, r) => {
   ...
   var a = {
       ...
       if (s.length > 0 && s[0].split(c).length > 1) {
        ...
        u.forEach(function (n, s) {
         ...
         var h = (c.facetFilters || []).reduce(function (e, t) {
          ...
          f = u[s - 1];
         (c.facetFilters = s > 0 ? h.concat(f.attribute + ":" + f.value) : h.length > 0 ? h : void 0), r.push({ indexName: e, params: c });
        });
       }
      }),
      r
    ...
    _getDisjunctiveFacetSearchParams: function (e, t, r) {
     ...
     return (o.facets = h ? a._getDisjunctiveHierarchicalFacetAttribute(e, h, r) : t), c.length > 0 && (o.numericFilters = c), s.length > 0 && (o.facetFilters = s), i(n({}, e.getQueryParams(), o));
    },
     ...
     return (
      Object.keys(c).forEach(function (i) {
       ...
       if (void 0 !== a) {
        ...
        if (t === i) {
         if (-1 === a.indexOf(h) || (!f && !0 === r) || (f && f.split(h).length === a.split(h).length)) return;
         f ? ((u = f.split(h).length - 1), (a = f)) : ((u = a.split(h).length - 2), (a = a.slice(0, a.lastIndexOf(h)))), (s = o.attributes[u]);
   ...
   e.exports = (function () {
     ...
     return {
      ...
      set: function (e, t) {
       return Promise.resolve().then(function () {
        var i = a();
        return (i[JSON.stringify(e)] = t), n().setItem(r, JSON.stringify(i)), t;
       });
      },
      delete: function (e) {
       return Promise.resolve().then(function () {
    ...
    function _(e, t, n, i) {
     var s = [],
      ...
      m = function t(r, a) {
       var h = r.pop();
       if (void 0 === h) throw { name: "RetryError", message: "Unreachable hosts - your application id may be incorrect. If the error persists, contact support@algolia.com.", transporterStackTrace: w(s) };
       var m = { data: c, headers: u, method: o, url: E(h, n.path, f), connectTimeout: a(l, e.timeouts.connect), responseTimeout: a(l, i.timeout) },
        d = function (e) {
        ...
        p = {
         ...
         onRetry: function (n) {
          ...
          return (
           n.isTimedOut && l++,
           Promise.all([e.logger.info("Retryable failure", O(i)), e.hostsCache.set(h, y(h, n.isTimedOut ? v : g))]).then(function () {
            return t(r, a);
           })
          );
         },
      ...
      return function (t, i) {
       return Promise.all(
        t.map(function (t) {
         ...
         return H(e)(t.indexName, { methods: { searchForFacetValues: k } }).searchForFacetValues(s, c, r(r({}, i), u));
        })
       );
      };
     },
    ...
    function V(e, t, n) {
     var i,
      a = {
       ...
       hostsCache: c({ caches: [s({ key: "".concat("4.17.0", "-").concat(e) }), u()] }),
       userAgent: j("4.17.0").add({ segment: "Browser", version: "lite" }),
       ...
       {},
       {
        methods: {
         ...
         initIndex: function (e) {
          return function (t) {
           return H(e)(t, { methods: { search: C, searchForFacetValues: k, findAnswers: Q } });
          };
         },
        },
       }
  ...
  88824: (e, t, r) => {
   ...
   const c = { locale: "en", pluralForms: s(["one", "other"]), select: (e) => (1 === e ? "one" : "other") };
   function u() {
    const {
  ...
  39172: (e, t, r) => {
   ...
   function j(e) {
    ...
    return n.createElement(
     "div",
     { className: (0, i.Z)("col", "col--3", "padding-left--none", _.searchVersionColumn) },
     r.map((e) => {
      let [i, a] = e;
      const s = r.length > 1 ? `${i}: ` : "";
      return n.createElement(
       "select",
       { key: i, onChange: (e) => t.setSearchVersion(i, e.target.value), defaultValue: t.searchVersions[i], className: _.searchVersionInput },
       a.versions.map((e, t) => n.createElement("option", { key: t, label: `${s}${e.label}`, value: e.name }))
      );
     })
    );
   }
   function E() {
    const {
     ...
     [x, w] = (0, d.K)(),
     O = { items: [], query: null, totalResults: null, totalPages: null, lastPage: null, hasMore: null, loading: null },
     [N, A] = (0, n.useReducer)((e, t) => {
      switch (t.type) {
       case "reset":
        return O;
       case "loading":
        return { ...e, loading: !0 };
       case "update":
        return x !== t.value.query ? e : { ...t.value, items: 0 === t.value.lastPage ? t.value.items : e.items.concat(t.value.items) };
       case "advance": {
     ...
     H = u()(t, r),
     S = s()(H, a, { hitsPerPage: 15, advancedSyntax: !0, disjunctiveFacets: ["language", "docusaurus_tag"] });
    S.on("result", (e) => {
     let {
      results: { query: t, hits: r, page: n, nbHits: i, nbPages: a },
     } = e;
     if ("" === t || !Array.isArray(r)) return void A({ type: "reset" });
     const s = (e) => e.replace(/algolia-docsearch-suggestion--highlight/g, "search-result-match"),
      u = r.map((e) => {
       ...
       return { title: i.pop(), url: c(t), summary: n.content ? `${s(n.content.value)}...` : "", breadcrumbs: i };
      });
     A({ type: "update", value: { items: u, query: t, totalResults: i, totalPages: a, lastPage: n, hasMore: a > n + 1, loading: !1 } });
    });
    const [T, Q] = (0, n.useState)(null),
     C = (0, n.useRef)(0),
     k = (0, n.useRef)(
      o.Z.canUseIntersectionObserver &&
       new IntersectionObserver(
        (e) => {
         ...
         t && C.current > r && A({ type: "advance" }), (C.current = r);
        },
        { threshold: 1 }
       )
     ),
     I = () => (x ? (0, y.I)({ id: "theme.SearchPage.existingResultsTitle", message: 'Search results for "{query}"', description: "The search page title for non-empty query" }, { query: x }) : (0, y.I)({ id: "theme.SearchPage.emptyResultsTitle", message: "Search the documentation", description: "The search page title for empty query" })),
     D = (0, p.zX)(function (t) {
      void 0 === t && (t = 0),
       S.addDisjunctiveFacetRefinement("docusaurus_tag", "default"),
       S.addDisjunctiveFacetRefinement("language", e),
       Object.entries(E.searchVersions).forEach((e) => {
        let [t, r] = e;
        S.addDisjunctiveFacetRefinement("docusaurus_tag", `docs-${t}-${r}`);
       }),
       S.setQuery(x).setPage(t).search();
     });
    return (
     (0, n.useEffect)(() => {
      if (!T) return;
       ...
       N.items.length > 0
        ? n.createElement(
           ...
           N.items.map((e, t) => {
            ...
            return n.createElement(
             "article",
             { key: t, className: _.searchResultItem },
             n.createElement("h2", { className: _.searchResultItemHeading }, n.createElement(f.Z, { to: a, dangerouslySetInnerHTML: { __html: r } })),
             c.length > 0 &&
              n.createElement(
               "nav",
               ...
               n.createElement(
                "ul",
                { className: (0, i.Z)("breadcrumbs", _.searchResultItemPath) },
                c.map((e, t) => n.createElement("li", { key: t, className: "breadcrumbs__item", dangerouslySetInnerHTML: { __html: e } }))
               )
              ),
             s && n.createElement("p", { className: _.searchResultItemSummary, dangerouslySetInnerHTML: { __html: s } })
            );
           })
          )
        : [x && !N.loading && n.createElement("p", { key: "no-results" }, n.createElement(y.Z, { id: "theme.SearchPage.noResultsText", description: "The paragraph for empty search result" }, "No results were found")), !!N.loading && n.createElement("div", { key: "spinner", className: _.loadingSpinner })],
       N.hasMore && n.createElement("div", { className: _.loader, ref: Q }, n.createElement(y.Z, { id: "theme.SearchPage.fetchingNewResults", description: "The paragraph for fetching new search results" }, "Fetching new results..."))
      )
     )
    );
   }
   function x() {
    return n.createElement(g.FG, { className: "search-page-wrapper" }, n.createElement(E, null));
   }
  },
 },
]);
