(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [77598],
 {
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => u, mJ: () => m, VZ: () => T, cR: () => w, Pv: () => g, qZ: () => o, kD: () => v, B2: () => j, Pc: () => c, f4: () => a, GT: () => x, fX: () => s, eQ: () => k, B_: () => y, o_: () => b, Rc: () => f });
  ...
  52670(e, n, t) {
   ...
   var i = t(86070),
    ...
    c = t(12013);
   function l(e) {
    const n = { a: 'a', code: 'code', em: 'em', h1: 'h1', h2: 'h2', h3: 'h3', h4: 'h4', header: 'header', li: 'li', p: 'p', pre: 'pre', ul: 'ul', ...(0, s.R)(), ...e.components };
