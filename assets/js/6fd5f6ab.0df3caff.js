 ...
 [53087],
 {
  ...
  17889(e, n, t) {
   ...
   var m = t(30696),
    ...
    x = t(43825),
    A = t(30758);
   const b = { color: m.A, dimension: j.A, fontFamilies: k.A, fontSizes: v.A, fontWeights: w.A, lineHeights: y.A, other: f.A, textDecoration: x.A },
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => u, mJ: () => m, VZ: () => b, cR: () => A, Pv: () => j, qZ: () => o, kD: () => y, B2: () => g, Pc: () => a, f4: () => c, GT: () => f, fX: () => s, eQ: () => w, B_: () => v, o_: () => k, Rc: () => x });
     ...
     children: [
      ...
      (0, i.jsx)(T.b, {
       ...
       items: [
        ...
        { title: 'De koptekst maakt duidelijk waar de sectie over gaat.', sc: '2.4.6', status: '', component: (0, i.jsx)(v, {}), tags: ['designer', 'contentmaker'] },
