 ...
 [2660],
 {
  ...
  17297: (e, t, n) => {
   ...
   const o = { title: "Date input", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Date input", pagination_label: "Date input", description: "UX richtlijnen voor Date input component", slug: "/date-input", tags: ["Help Wanted"] },
    a = void 0,
    p = { unversionedId: "componenten/build/date-input", id: "componenten/build/date-input", title: "Date input", description: "UX richtlijnen voor Date input component", source: "@site/docs/componenten/build/date-input.mdx", sourceDirName: "componenten/build", slug: "/date-input", permalink: "/date-input", draft: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/date-input.mdx", tags: [{ label: "Help Wanted", permalink: "/tags/help-wanted" }], version: "current", frontMatter: { title: "Date input", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Date input", pagination_label: "Date input", description: "UX richtlijnen voor Date input component", slug: "/date-input", tags: ["Help Wanted"] }, sidebar: "componenten", previous: { title: "Date input group", permalink: "/date-input-group" }, next: { title: "Date Picker", permalink: "/date-picker" } },
    l = {},
