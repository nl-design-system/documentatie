...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [8785],
 {
  ...
  9405(e, n, t) {
   (t.r(n), t.d(n, { assets: () => _, component: () => G, contentTitle: () => C, default: () => M, description: () => R, frontMatter: () => H, issueNumber: () => B, metadata: () => i, title: () => T, toc: () => I }));
  ...
  21034(e, n, t) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u.p, { level: n, suffix: a && (0, d.jsx)(c.D, { state: a }), children: e.title }), (0, d.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(a) && (0, d.jsx)(k.s, { relayStep: a, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    w = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
   ...
   const o = ({ background: e, children: n, className: t, ...i }) => (0, r.jsx)('div', { className: (0, a.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, t), ...i, children: n }),
    ...
    s = ({ href: e, appearance: n, className: t, component: o = 'div', background: l, children: s }) => {
     const d = (e) => ('article' === o ? (0, r.jsx)('article', { ...e }) : 'section' === o ? (0, r.jsx)('section', { ...e }) : (0, r.jsx)('div', { ...e })),
      g = (0, r.jsx)(d, { className: (0, a.A)('ma-cardgroup__card', l && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, t), children: s });
  ...
  32385(e, n, t) {
   t.d(n, { bo: () => a, KF: () => u, mJ: () => p, VZ: () => L, cR: () => w, Pv: () => j, qZ: () => o, kD: () => f, QQ: () => A, B2: () => m, Pc: () => s, f4: () => l, GT: () => v, fX: () => r, eQ: () => b, B_: () => x, o_: () => k });
  ...
  40889(e, n, t) {
   ...
   var i = t(29181),
    ...
    s = t(83386),
    d = t(86070);
   const g = { figma: (0, d.jsx)(a.A, {}), github: (0, d.jsx)(r.A, {}), npm: (0, d.jsx)(o.A, {}), storybook: (0, d.jsx)(l.A, {}) },
  ...
  70348(e, n, t) {
   ...
   const l = ({ className: e, ...n }) => {
    ...
    s = ({ className: e, classNamePanel: n, label: t, heading: l, headingLevel: s, headingApperance: d, ...g }) => {
     const c = (0, i.A)('utrecht-accordion__section', e),
      u = (0, i.A)('utrecht-accordion__panel', n);
     return (0, o.jsxs)('details', { className: c, ...g, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(a.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [l && (0, o.jsx)(r.D, { level: s, appearance: d, children: l }), t] })] }) }), (0, o.jsx)('div', { className: u, children: g.children })] });
    };
  },
  71805(e, n, t) {
   t.d(n, { Ay: () => l, RM: () => r });
