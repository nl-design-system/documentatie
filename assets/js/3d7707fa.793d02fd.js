 ...
 [79280],
 {
  ...
  7414(e, n, t) {
   ...
   const G = [
     ...
     { title: 'De Alert is niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: x.Ay, tags: ['developer'] },
     {
  ...
  24456(e, n, t) {
   ...
   const o = ({ children: e, ...n }) => {
    ...
    s = ({ className: e, boxContent: n, ...t }) => (0, a.jsx)(o, { className: (0, i.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  24908(e, n, t) {
   t.d(n, { Ay: () => o });
   var i = t(86070),
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => k, cR: () => A, Pv: () => f, qZ: () => o, kD: () => v, QQ: () => y, B2: () => m, Pc: () => l, f4: () => s, GT: () => b, fX: () => a, eQ: () => x, B_: () => w, o_: () => j });
