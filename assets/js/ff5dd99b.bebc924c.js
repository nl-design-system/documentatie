(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [10452],
 {
  ...
  32385(e, n, t) {
   'use strict';
   t.d(n, { bo: () => r, KF: () => m, mJ: () => p, VZ: () => y, cR: () => w, Pv: () => j, qZ: () => s, kD: () => f, QQ: () => A, B2: () => u, Pc: () => o, f4: () => l, GT: () => b, fX: () => i, eQ: () => v, B_: () => x, o_: () => k });
  ...
  58596(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => H, component: () => R, contentTitle: () => C, default: () => G, description: () => _, frontMatter: () => F, issueNumber: () => z, metadata: () => a, title: () => L, toc: () => M }));
  ...
  70348(e, n, t) {
   ...
   const l = ({ className: e, ...n }) => {
    ...
    o = ({ className: e, label: n, heading: t, headingLevel: l, headingApperance: o, ...d }) => {
     ...
     return (0, s.jsxs)('details', { className: c, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(r.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [t && (0, s.jsx)(i.D, { level: l, appearance: o, children: t }), n] })] }) }), (0, s.jsx)('div', { className: 'utrecht-accordion__panel', children: d.children })] });
    };
  },
  70561(e, n, t) {
   'use strict';
  ...
  70903(e, n, t) {
   ...
   var p = t(43864),
    ...
    A = t(79532),
    S = t(30758);
   const N = { boxShadow: p.A, color: j.A, cursor: k.A, dimension: x.A, fontFamily: v.A, fontFamilies: v.A, fontSize: f.A, fontSizes: f.A, fontWeight: b.A, fontWeights: b.A, lineHeight: w.A, lineHeights: w.A, number: y.A, other: D.A, textDecoration: A.A },
    T = ({ type: e }) => {
