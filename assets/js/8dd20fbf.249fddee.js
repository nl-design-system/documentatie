   ...
   const c = (0, a.createContext)({}),
    h = ({ title: e, appearance: n, description: r, children: a, figure: h }) => {
     const p = { do: 'Doen', dont: 'Niet doen' },
      u = h ? 'figure' : 'div',
      m = h ? 'figcaption' : 'div',
      v = 'string' == typeof r ? (0, d.jsx)(s.oz, { children: r }) : r;
  ...
  75397(e, n, r) {
   ...
   const s = i.forwardRef(function (e, n) {
     ...
     return (
      ...
      (0, t.jsxs)(t.Fragment, {
       children: [
        !e.lazyLoad && (0, t.jsx)('link', { rel: L, href: w, as: 'image' }),
        ...
        F && !e.playlist && (0, t.jsx)('noscript', { children: (0, t.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${p} on YouTube`, children: ['Watch "', p, '" on YouTube'] }) }),
        (0, t.jsxs)(R, {
         onPointerOver: () => {
          r || s(!0);
         },
         ...
         children: [e.lazyLoad && !a && (0, t.jsx)('img', { src: w, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, t.jsx)('button', { type: 'button', className: S, 'aria-label': `${m} ${p}`, 'aria-hidden': a || void 0, tabIndex: a ? -1 : 0, children: (0, t.jsx)('span', { className: 'lty-visually-hidden', children: m }) }), a && (0, t.jsx)('iframe', { ref: n, className: A, title: p, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
    }),
    a = ({ id: e, title: n, ...r }) => (0, t.jsx)(s, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: n, poster: 'maxresdefault', ...r });
  },
  78734(e, n, r) {
   r.d(n, { Ay: () => s, RM: () => l });
   var t = r(86070),
