 ...
 [65844],
 {
  ...
  70348(e, n, t) {
   ...
   const r = ({ className: e, ...n }) => {
    ...
    c = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: c, headingApperance: i, ...d }) => {
     const p = (0, l.A)('utrecht-accordion__section', e),
      h = (0, l.A)('utrecht-accordion__panel', n);
     return (0, s.jsxs)('details', { className: p, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(a.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(o.D, { level: c, appearance: i, children: r }), t] })] }) }), (0, s.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => y });
   var l = t(15175),
    ...
    b = t(70348),
    g = t(86070);
   const j = ({ children: e }) => (0, g.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(a.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(a.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   j.displayName = 'ParagraphContainer';
   const k = ({ children: e }) => (0, g.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(a.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   k.displayName = 'DocumentContainer';
   const v = ({ children: e }) => (0, g.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: e });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const l = 'function' == typeof e ? e() : e,
        ...
        s = m().highlight(a, m().languages[n], n);
       return (0, g.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', t), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: a } }), (0, g.jsx)(b.n, { children: (0, g.jsx)(b.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: u = !0, children: m, container: b = 'document', language: y, designTokens: x }) => {
       ...
       return (
        ...
        (0, g.jsxs)('div', {
         ...
         children: [
          f && (0, g.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, g.jsx)(K, { children: (0, g.jsx)(a.v$, { children: f }) }) }) }),
          u &&
           (0, g.jsx)('div', {
          ...
          u &&
           (0, g.jsxs)('div', {
            ...
            hidden: !z,
            children: [
             (0, g.jsx)(l.M, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: w, trim: !0 }),
             n &&
              (0, g.jsx)('div', {
