     ...
     children: [
      ...
      (0, r.jsx)(B.t, {
       ...
       items: [
        ...
        { title: "Als het broodkruimelpad op meerdere pagina's voorkomt, ziet het er hetzelfde uit en werkt het hetzelfde", sc: '3.2.4', status: '', component: (0, r.jsx)(O.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(B.t, {
  ...
  8657: (e, n, t) => {
   ...
   const y = (e) => {
     ...
     return (
      ...
      (0, d.jsx)(r.a2, {
       sections: s.map((e) => ({
        className: (0, i.Z)('definition-of-done', e && `definition-of-done--${(0, x.mA)(a(e))}`),
        headingLevel: t,
        expanded: !1,
