...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [41102],
 {
  ...
  33062(e, n, i) {
   i.d(n, { bo: () => o, KF: () => u, mJ: () => p, VZ: () => A, cR: () => z, Pv: () => m, qZ: () => a, kD: () => f, B2: () => j, Pc: () => l, f4: () => s, GT: () => x, fX: () => r, eQ: () => b, B_: () => k, o_: () => v, Rc: () => w });
  ...
  37131(e, n, i) {
   ...
   const p = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    m = ({ component: e, headingLevel: n }) => {
     const i = e && e.projects.filter((e) => g.f4.includes(e.id)),
      r = i && g.f4.map((e) => i.find((n) => n.id === e)).filter(Boolean);
     return e && (0, c.jsx)(t.If, { sections: r.map((i) => ({ className: (0, o.A)('definition-of-done', i && `definition-of-done--${(0, g.fX)(i.title)}`), headingLevel: n, expanded: !1, label: i ? `${i.title} - ${i.progress.value} van ${i.progress.max}` : '', body: i && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(j._, { children: i.tasks.map(({ checked: e, name: i, id: t }) => (0, c.jsx)(j.Z, { headingLevel: n + 1, checked: e, heading: i, description: (0, g.qZ)(t) }, t)) }), (0, c.jsx)(t.fz, { children: (0, c.jsxs)(t.N_, { href: `${i.url}?filterQuery=${e.title}`, children: [i.title, ' projectbord op GitHub'] }) })] }) })) });
    },
