(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [38384],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => j, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => p, qZ: () => s, kD: () => k, B2: () => d, Pc: () => a, f4: () => o, GT: () => f, fX: () => c, eQ: () => b, B_: () => v, o_: () => g, Rc: () => x });
  ...
  69847(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => u, default: () => g, description: () => j, frontMatter: () => a, issueNumber: () => d, metadata: () => r, title: () => h, toc: () => m }));
   ...
   var i = n(86070),
    ...
    s = n(36059),
    o = n(85825);
   const a = { title: 'Description List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Description List', pagination_label: 'Description List', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', slug: '/description-list' },
    u = void 0,
    l = {},
    h = 'Description List',
    j = 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.',
    d = 92,
    y = s.find((e) => e.number === d),
    m = [
  ...
  85825(e, t, n) {
   ...
   const m = ({ children: e }) => (0, u.jsx)('ul', { className: 'task-list', children: e }),
    p = ({ checked: e, children: t, title: n, description: r, headingLevel: c = 3 }) => (0, u.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, u.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, u.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, u.jsx)(y.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [n ? (0, u.jsx)(d.DZ, { appearance: 'utrecht-heading-3', level: c, children: n }) : null, r, t] })] });
   var g = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: c.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, g.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(p, { headingLevel: t + 1, checked: e, title: n, description: (0, g.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
    ...
    f = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(j.p, { level: t, suffix: i && (0, u.jsx)(h.D, { state: i }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
