 ...
 [41102],
 {
  12761(e, n, i) {
   ...
   const k = ({ className: e, ...n }) => {
     const i = (0, a.A)('ma-utrecht-accordion', 'utrecht-accordion', e);
     return (0, d.jsx)('div', { className: i, children: n.children });
    },
    b = ({ className: e, ...n }) => {
     const i = (0, a.A)('utrecht-accordion__section', e);
     return (0, d.jsxs)('details', { className: i, ...n, children: [(0, d.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, d.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, d.jsx)('span', { className: 'nl-button__icon-start', children: (0, d.jsx)(j.A, {}) }), (0, d.jsx)('span', { className: 'nl-button__label', children: (0, d.jsx)(v.D, { level: n.headingLevel, appearance: n.headingApperance, children: n.heading }) })] }) }), (0, d.jsx)('div', { className: 'utrecht-accordion__panel', children: n.children })] });
    },
    ...
    D = ({ component: e, headingLevel: n, description: i }) => {
     const a = e && h.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(g.p, { level: n, suffix: a && (0, d.jsx)(u.D, { state: a }), children: e.title }), (0, d.jsx)(t.fz, { lead: !0, children: i })] });
    },
    z = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
  ...
  26655(e, n, i) {
   ...
   const r = ({ background: e, children: n, className: i, ...t }) => (0, o.jsx)('div', { className: (0, a.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, i), ...t, children: n }),
    ...
    d = ({ appearance: e = 'large', children: n, className: i }) => (0, o.jsx)('div', { className: (0, a.A)('ma-cardgroup', `ma-cardgroup--${e}`, i), children: n });
  },
  30940(e, n, i) {
   i.d(n, { Ay: () => r });
   var t = i(86070),
  ...
  70893(e, n, i) {
   (i.r(n), i.d(n, { assets: () => _, component: () => M, contentTitle: () => H, default: () => O, description: () => G, frontMatter: () => C, issueNumber: () => P, metadata: () => t, title: () => B, toc: () => E }));
  ...
  76097(e, n, i) {
   i.d(n, { bo: () => a, KF: () => g, mJ: () => p, VZ: () => D, cR: () => w, Pv: () => j, qZ: () => r, kD: () => x, B2: () => m, Pc: () => s, f4: () => l, GT: () => f, fX: () => o, eQ: () => b, B_: () => k, o_: () => v });
