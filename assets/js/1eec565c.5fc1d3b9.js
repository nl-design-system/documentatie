 ...
 [76352],
 {
  15638(e, n, o) {
   ...
   const c = (0, l.createContext)({}),
    p = ({ title: e, appearance: n, description: o, children: l, figure: p }) => {
     const k = { do: 'Doen', dont: 'Niet doen' },
      u = p ? 'figure' : 'div',
      v = p ? 'figcaption' : 'div',
      h = 'string' == typeof o ? (0, d.jsx)(s.oz, { children: o }) : o;
     return (0, d.jsxs)(u, { className: (0, i.A)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(v, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.fz, { className: (0, i.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(t.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: k.dont })] }), (0, d.jsx)(r.fz, { children: e })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.fz, { className: (0, i.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(a.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: k.do })] }), (0, d.jsx)(r.fz, { children: e })] }), h] }), (0, d.jsx)('div', { className: 'nlds-guideline__example', children: (0, d.jsx)(c.Provider, { value: { title: e, type: k[n] }, children: l }) })] });
    };
  },
  18439(e, n, o) {
   o.d(n, { R: () => i, x: () => s });
  ...
  58639(e, n, o) {
   ...
   var a = o(69284),
    ...
    k = o(31186),
    u = o(86070);
   const v = ({ children: e }) => (0, u.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, u.jsx)(t.yo, { className: (0, r.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, u.jsx)(t.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   v.displayName = 'ParagraphContainer';
   const h = ({ children: e }) => (0, u.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, u.jsx)(t.yo, { className: (0, r.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const m = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: m = !0, children: j, container: b = 'document', language: x, designTokens: y }) => {
    ...
    let K = p.Fragment;
    return (
     'paragraph' === b ? (K = v) : 'document' === b ? (K = h) : 'surface' === b && (K = g),
     (0, u.jsxs)('div', {
      className: (0, r.A)('nlds-canvas'),
      children: [
       f && (0, u.jsx)('div', { className: (0, r.A)('nlds-canvas__example'), children: (0, u.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, u.jsx)(K, { children: (0, u.jsx)(t.v$, { children: f }) }) }) }),
       m &&
        (0, u.jsx)('div', {
