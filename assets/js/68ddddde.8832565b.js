 ...
 [5643],
 {
  41676: (e, t, n) => {
   ...
   const s = { title: 'Skip link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Skip link', pagination_label: 'Skip link', description: 'Biedt de mogelijkheid om content over te slaan en direct naar een onderdeel binnen pagina te navigeren.', slug: '/skip-link', sidebar_custom_props: { illustration: 'SkipLinkSketch' } },
    a = void 0,
    l = { id: 'componenten/skip-link/index', title: 'Skip link', description: 'Biedt de mogelijkheid om content over te slaan en direct naar een onderdeel binnen pagina te navigeren.', source: '@site/docs/componenten/skip-link/index.mdx', sourceDirName: 'componenten/skip-link', slug: '/skip-link', permalink: '/skip-link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/skip-link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Skip link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Skip link', pagination_label: 'Skip link', description: 'Biedt de mogelijkheid om content over te slaan en direct naar een onderdeel binnen pagina te navigeren.', slug: '/skip-link', sidebar_custom_props: { illustration: 'SkipLinkSketch' } }, sidebar: 'componenten', previous: { title: 'Side navigation', permalink: '/side-navigation' }, next: { title: 'Spinner', permalink: '/spinner' } },
    u = {},
    d = [
