...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [95356],
 {
  ...
  45018(e, n, t) {
   (t.r(n), t.d(n, { assets: () => h, contentTitle: () => d, default: () => v, frontMatter: () => c, metadata: () => a, toc: () => g }));
  ...
  70348(e, n, t) {
   ...
   const r = ({ className: e, ...n }) => {
    ...
    o = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: o, headingApperance: c, ...d }) => {
     const h = (0, a.A)('utrecht-accordion__section', e),
      g = (0, a.A)('utrecht-accordion__panel', n);
     return (0, s.jsxs)('details', { className: h, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(l.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(i.D, { level: o, appearance: c, children: r }), t] })] }) }), (0, s.jsx)('div', { className: g, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => f });
   ...
   const f = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const a = 'function' == typeof e ? e() : e,
        ...
        s = v().highlight(l, v().languages[n], n);
       return (0, p.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', t), children: [(0, p.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: l } }), (0, p.jsx)(b.n, { children: (0, p.jsx)(b.K, { label: 'Code', children: (0, p.jsx)('pre', { className: 'language-html nl-code-block', children: (0, p.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: u = !0, children: v, container: b = 'document', language: f, designTokens: y }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(z, { parser: f, plugins: [s.A, r.Ay, o.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         w(e);
        })();
       }, [z]);
       const C = (0, h.useId)();
         ...
         children: [
          ...
          u &&
           (0, p.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, p.jsx)(a.M, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: N, trim: !0 }),
             n &&
              (0, p.jsx)('div', {
