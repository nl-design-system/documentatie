(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [54472],
 {
  39844: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => s, default: () => p, description: () => j, frontMatter: () => a, issueNumber: () => g, metadata: () => u, title: () => d, toc: () => h });
   var r = n(52676),
    i = n(40139),
    c = n(99890),
    o = n(8657);
  ...
  35038: (e, t, n) => {
   ...
   const o = (e) => {
    ...
    s = (e) => {
     let { href: t, appearance: n, className: o, component: a = 'div', background: s, children: u } = e;
     const l = (e) => ('article' === a ? (0, c.jsx)('article', { ...e }) : 'section' === a ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      h = (0, c.jsx)(l, { className: (0, i.Z)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, o), children: u });
  ...
  8657: (e, t, n) => {
   ...
   var r = n(74824),
    ...
    u = n(32636),
    l = n(52676);
   const h = { figma: (0, l.jsx)(c.Z, {}), github: (0, l.jsx)(o.Z, {}), npm: (0, l.jsx)(a.Z, {}), storybook: (0, l.jsx)(s.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
        ...
        body:
         ...
         (0, l.jsxs)(l.Fragment, {
          children: [
           ...
           (0, l.jsx)(r.nv, { children: (0, l.jsxs)(r.rU, { href: `${e.url}?filterQuery=${t.title}`, children: [a(e), ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
            ...
            j.Zb,
            {
             ...
             children: (0, l.jsxs)(j.aY, {
              children: [
               ...
               (a.length > 0 || c.length > 0) && (0, l.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               a.length > 0 &&
                (0, l.jsx)(l.Fragment, {
               ...
               c.length > 0 &&
                (0, l.jsx)(l.Fragment, {
                 children: c.map((e) => {
                  ...
                  return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.X6, { level: n + 2, children: [i, ' in ', t] }), (0, l.jsx)(r.Mc, { links: c.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => m, BA: () => a, Ee: () => l, Q6: () => c, U: () => j, Yr: () => p, d: () => h, e9: () => o, fO: () => b, mA: () => i, ps: () => g, qU: () => k, s0: () => v, zP: () => y });
   ...
   const u = (e) => {
    ...
    j = (e) => u(s(e.projects.flatMap((e) => d(e)))),
    g = (e) => {
     const t = d(e),
      n = ((e) => {
       const t = e.tasks.find((e) => {
      ...
      const r = e.tasks
       ...
       .map((r) => {
        ...
        const a = /^(.+) URL/.exec(i)[1],
         s = 'Storybook' === a ? `${n} (${t}) in Storybook van ${((e) => (['Candidate - New', 'Candidate - Oud'].includes(e.title) ? 'Candidate' : e.title))(e)}` : `${n} (${t}) op ${a}`;
