...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [27938],
 {
  ...
  58639(e, n, o) {
   ...
   const b = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: b = !0, children: y, container: f = 'document', language: x, designTokens: j }) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(w, { parser: x, plugins: [s.A, c.Ay, a.Ay, i.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [w]);
    const S = (0, p.useId)();
    let R = p.Fragment;
    return (
     'paragraph' === f ? (R = m) : 'document' === f ? (R = g) : 'surface' === f && (R = v),
     (0, h.jsxs)('div', {
      className: (0, t.A)('nlds-canvas'),
      children: [
       k && (0, h.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: j, children: (0, h.jsx)(R, { children: (0, h.jsx)(r.v$, { children: k }) }) }) }),
       b &&
        (0, h.jsx)('div', {
