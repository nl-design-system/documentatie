 ...
 [12781],
 {
   ...
   const d = (0, s.createContext)({}),
    g = ({ title: e, appearance: n, description: l, children: s, figure: g }) => {
     const b = { do: 'Doen', dont: 'Niet doen' },
      h = g ? 'figure' : 'div',
      v = g ? 'figcaption' : 'div',
      u = 'string' == typeof l ? (0, c.jsx)(o.oz, { components: { a: i.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   const o = ({ className: e, ...n }) => {
    ...
    s = ({ className: e, classNamePanel: n, label: l, heading: o, headingLevel: s, headingApperance: c, ...d }) => {
     const g = (0, t.A)('utrecht-accordion__section', e),
      b = (0, t.A)('utrecht-accordion__panel', n);
     return (0, r.jsxs)('details', { className: g, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(a.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [o && (0, r.jsx)(i.D, { level: s, appearance: c, children: o }), l] })] }) }), (0, r.jsx)('div', { className: b, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => k });
   var t = l(15175),
    ...
    u = l(70348),
    m = l(86070);
   const p = ({ children: e }) => (0, m.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(a.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(a.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   p.displayName = 'ParagraphContainer';
   const f = ({ children: e }) => (0, m.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(a.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   f.displayName = 'DocumentContainer';
   const j = ({ children: e }) => (0, m.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: e });
   ...
   const k = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const t = 'function' == typeof e ? e() : e,
        ...
        r = v().highlight(a, v().languages[n], n);
       return (0, m.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', l), children: [(0, m.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: a } }), (0, m.jsx)(u.n, { children: (0, m.jsx)(u.K, { label: 'Code', children: (0, m.jsx)('pre', { className: 'language-html nl-code-block', children: (0, m.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: h = !0, children: v, container: u = 'document', language: k, designTokens: y }) => {
       ...
       let C = g.Fragment;
       return (
        'paragraph' === u ? (C = p) : 'document' === u ? (C = f) : 'surface' === u && (C = j),
        (0, m.jsxs)('div', {
         className: (0, i.A)('nlds-canvas'),
         children: [
          x && (0, m.jsx)('div', { className: (0, i.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, m.jsx)(C, { children: (0, m.jsx)(a.v$, { children: x }) }) }) }),
          h &&
           (0, m.jsx)('div', {
          ...
          h &&
           (0, m.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, m.jsx)(t.M, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: N, trim: !0 }),
             n &&
              (0, m.jsx)('div', {
