(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [65954],
 {
  ...
  21034(e, n, a) {
   ...
   const j = ({ component: e, headingLevel: n }) => {
    ...
    T = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(p.p, { level: n, suffix: s && (0, m.jsx)(h.D, { state: s }), children: e.title }), (0, m.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(s) && (0, m.jsx)(q.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    H = ({ component: e }) => {
     const n = (e && x[e.title]) || [];
  ...
  32385(e, n, a) {
   'use strict';
   a.d(n, { bo: () => s, KF: () => m, mJ: () => p, VZ: () => D, cR: () => k, Pv: () => v, qZ: () => l, kD: () => q, QQ: () => H, B2: () => c, Pc: () => o, f4: () => r, GT: () => j, fX: () => i, eQ: () => b, B_: () => x, o_: () => f });
  ...
  64710(e, n, a) {
   ...
   const b = { title: 'Heading 4', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading 4', pagination_label: 'Heading 4', description: 'Koptekst die in de koppenstructuur op het vierde niveau staat.', issue_number: 260, slug: '/heading-4', keywords: ['caption', 'content', 'h4', 'heading', 'heading level', 'headline', 'kop', 'paginakop', 'sectie', 'section', 'structure', 'titel', 'title'] },
    ...
    j = {},
    k = 'Heading 4',
    D = 'Koptekst die in de koppenstructuur op het vierde niveau staat.',
    T = 260,
