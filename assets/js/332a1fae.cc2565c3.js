 ...
 [21021],
 {
  ...
  73942: (e, t, n) => {
   ...
   const i = { title: "Form field label", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Form field label", pagination_label: "Form field label", description: "UX richtlijnen voor Form field label component", slug: "/form-field-label", tags: ["Help Wanted"] },
    o = void 0,
    a = { unversionedId: "componenten/build/form-field-label", id: "componenten/build/form-field-label", title: "Form field label", description: "UX richtlijnen voor Form field label component", source: "@site/docs/componenten/build/form-field-label.mdx", sourceDirName: "componenten/build", slug: "/form-field-label", permalink: "/form-field-label", draft: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/form-field-label.mdx", tags: [{ label: "Help Wanted", permalink: "/tags/help-wanted" }], version: "current", frontMatter: { title: "Form field label", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Form field label", pagination_label: "Form field label", description: "UX richtlijnen voor Form field label component", slug: "/form-field-label", tags: ["Help Wanted"] }, sidebar: "componenten", previous: { title: "Form field error message", permalink: "/form-field-error-message" }, next: { title: "Form field option label", permalink: "/form-field-option-label" } },
    m = {},
    s = [
