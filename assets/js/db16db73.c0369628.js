 ...
 [55545],
 {
  ...
  53623: (e, n, l) => {
   ...
   const k = (e) => {
    ...
    p = (e) => {
     let n,
      { code: l, copy: r = !1, defaultCollapsed: t = !0, children: c, language: p } = e;
     n = "function" == typeof c ? c() : c;
     const _ = s().format(g.uS(l || n), { parser: "html", plugins: [i(), a()], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" }),
      j = (0, b.Z)();
     return (0, h.jsxs)("div", {
      className: (0, d.Z)(u["nlds-canvas"]),
      children: [
       (0, h.jsx)("div", { className: (0, d.Z)(u["nlds-canvas__example"]), children: (0, h.jsx)(o.pu, { className: "voorbeeld-theme", children: n }) }),
       (0, h.jsx)("div", { className: (0, d.Z)(u["nlds-canvas__toolbar"]), children: (0, h.jsx)(o.zx, { className: (0, d.Z)(u["nlds-canvas__button"], u["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: k, "aria-expanded": !t, "aria-controls": j, children: t ? "Bekijk code" : "Verberg code" }) }),
       (0, h.jsxs)("div", {
        className: (0, d.Z)(u["nlds-canvas__code-block"], !r && u["nlds-canvas__code-block--user-select-none"]),
        id: j,
        hidden: t,
        children: [
         (0, h.jsx)(m.Z, { language: p, style: v, children: _ }),
         r &&
          (0, h.jsx)("div", {
           className: (0, d.Z)(u["nlds-canvas__toolbar"]),
           children: (0, h.jsx)(o.zx, {
            className: (0, d.Z)(u["nlds-canvas__button"], u["nlds-canvas__copy-button"]),
  ...
  30036: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const g = "Doen",
     m = "Niet doen";
    return (0, a.jsxs)("div", { className: (0, i.Z)(t["nlds-guideline"], t[`nlds-guideline--${l}`]), id: n?.toLowerCase().replace(/\s/g, "-"), children: [(0, a.jsxs)("div", { className: (0, i.Z)(t["nlds-guideline__description"]), children: ["dont" === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.nv, { className: (0, i.Z)(t["nlds-guideline__badge"], t[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(o.Z, { className: t["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: t["nlds-guideline__title"], children: m })] }), (0, a.jsx)(r.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.nv, { className: (0, i.Z)(t["nlds-guideline__badge"], t[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(d.Z, { className: t["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: t["nlds-guideline__title"], children: g })] }), (0, a.jsx)(r.nv, { children: n })] }), c] }), (0, a.jsx)("div", { className: (0, i.Z)(t["nlds-guideline__example"]), children: s })] });
   };
  },
 },
]);
