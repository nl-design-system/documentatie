/*! For license information please see 5c0cafdc.1eecfe10.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [50186],
 {
  ...
  6726(e, n, t) {
   (t.r(n), t.d(n, { assets: () => b, contentTitle: () => g, default: () => f, frontMatter: () => u, metadata: () => a, toc: () => k }));
   ...
   const o = s.forwardRef(function (e, n) {
    const [t, o] = s.useState(!1),
     ...
     j = f
      ...
      : null,
     x = s.useMemo(() => e.thumbnail || j || `https://i.ytimg.com/${v}/${e.playlist ? m : c}/${h}.${w}`, [e.thumbnail, j, v, e.playlist, m, c, h, w]),
    ...
    return (
     ...
     (0, a.jsxs)(a.Fragment, {
      children: [
       ...
       e.seo && !e.playlist && (0, a.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: r(e.id, p, x, k, e.seo) } }),
       ...
       (0, a.jsxs)(E, {
        ...
        children: [e.lazyLoad && !l && (0, a.jsx)('img', { src: x, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !l && (0, a.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && l) && (0, a.jsx)('button', { type: 'button', className: M, 'aria-label': `${u} ${p}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, onClick: P, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: u }) }), l && (0, a.jsx)('iframe', { ref: n, className: T, title: p, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: y, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => s, KF: () => p, mJ: () => g, VZ: () => x, cR: () => j, Pv: () => b, qZ: () => r, kD: () => w, QQ: () => D, B2: () => h, Pc: () => l, f4: () => o, GT: () => v, fX: () => i, eQ: () => f, B_: () => y, o_: () => k });
