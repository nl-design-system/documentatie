 ...
 [33430],
 {
   ...
   const i = (e) => {
    ...
    a = (e) => {
     ...
     const d = (e) => ('article' === o ? (0, c.jsx)('article', { ...e }) : 'section' === o ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      u = (0, c.jsx)(d, { className: (0, s.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, i), children: l });
  ...
  76233: (e, t, n) => {
   ...
   const a = (e) => {
    ...
    d = (e) => {
     ...
     const { title: u } = t,
      h = (0, i.mA)(u),
      j = c.lazy(() => n(22930)(`./${h}-docs/docs/anatomy/anatomy.md`).catch(() => ({ default: () => null })));
     return (0, o.jsx)(c.Suspense, {
      fallback: null,
      children: (0, o.jsxs)('figure', {
       className: (0, s.Z)('component-anatomy'),
       children: [
        d && (0, o.jsx)(d, { height: null, className: (0, s.Z)('component-anatomy__illustration') }),
        d &&
         j &&
         (0, o.jsx)('figcaption', {
  ...
  8657: (e, t, n) => {
   ...
   var r = n(74824),
    ...
    l = n(32636),
    d = n(52676);
   const u = { figma: (0, d.jsx)(c.Z, {}), github: (0, d.jsx)(i.Z, {}), npm: (0, d.jsx)(o.Z, {}), storybook: (0, d.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const w = (e) => {
        ...
        body:
         ...
         (0, d.jsxs)(d.Fragment, {
          children: [
           ...
           (0, d.jsx)(r.nv, { children: (0, d.jsxs)(r.rU, { href: `${e.url}?filterQuery=${t.title}`, children: [o(e), ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
            ...
            j.Zb,
            {
             ...
             children: (0, d.jsxs)(j.aY, {
              children: [
               ...
               (o.length > 0 || c.length > 0) && (0, d.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               o.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               c.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: c.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: n + 2, children: [s, ' in ', t] }), (0, d.jsx)(r.Mc, { links: c.map((e) => ({ children: e.description, icon: (0, d.jsx)(h, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
    ...
    A = (e) => {
     ...
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.V, { level: n, suffix: c && (0, d.jsx)(g.y, { state: c }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: s })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  57716: (e, t, n) => {
   ...
   const i = (e, t) => {
    ...
    a = (e) => ({
     img: (t) => {
      let { src: n, ...r } = t;
      return (0, c.jsx)('img', { ...r, src: i(e, n), className: 'utrecht-img utrecht-img--fit' });
     },
    }),
    l = (e, t) => {
     if (e) {
    ...
    d = (e) => {
     let { children: t, omitH1: n = !1, headingLevel: s = 1, baseUrl: i = '', components: o = {} } = e;
     return (0, c.jsx)(r.Z, { components: { ...l(n, s), ...a(i), ...o }, children: t });
    };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => g, BA: () => o, Ee: () => d, Q6: () => c, U: () => j, Yr: () => p, d: () => u, e9: () => i, fO: () => k, mA: () => s, ps: () => m, qU: () => b, s0: () => v, zP: () => y });
