  ...
  16764(e, n, t) {
   ...
   const N = { boxShadow: p.A, color: j.A, cursor: b.A, dimension: x.A, fontFamily: k.A, fontFamilies: k.A, fontSize: v.A, fontSizes: v.A, fontWeight: f.A, fontWeights: f.A, lineHeight: w.A, lineHeights: w.A, number: y.A, other: D.A, textDecoration: A.A },
    S = ({ type: e }) => {
     ...
     return (0, m.jsx)(g.In, { children: (0, z.createElement)(N[n]) });
    };
   var F = t(76223);
   function R({ tokens: e }) {
    const n = (0, r.kD)(e),
       ...
       children: [
        ...
        (0, m.jsx)(o.BF, {
         children: s.map((n) => {
          const t = (0, r.o_)(n),
           s = (0, r.eQ)(e, n).$type;
          return (0, m.jsxs)(o.Hj, { children: [(0, m.jsx)(o.nA, { children: (0, m.jsx)(i.C, { children: (0, m.jsx)(o.kf, { children: t }) }) }), (0, m.jsx)(o.nA, { children: (0, m.jsxs)(a.K, { children: [(0, m.jsx)(S, { type: s }), ' ', s] }) })] }, t);
         }),
        }),
       ],
      }),
