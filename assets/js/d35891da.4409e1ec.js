 ...
 [67360],
 {
  14881(e, n, l) {
   ...
   var o = l(13526),
    ...
    s = l(37168),
    r = l(86070);
   const a = (0, t.forwardRef)(({ as: e, className: n, children: l, ...t }, i) => {
     const s = e || 'div',
      a = (0, o.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, r.jsx)(s, { ref: i, className: a, ...t, children: l });
    }),
    d = ({ className: e, classNamePanel: n, label: l, heading: t, headingLevel: a, headingApperance: d, ...c }) => {
     const h = (0, o.A)('utrecht-accordion__section', e),
      v = (0, o.A)('utrecht-accordion__panel', n);
     return (0, r.jsxs)('details', { className: h, ...c, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(i.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [t && (0, r.jsx)(s.D, { level: a, appearance: d, children: t }), l] })] }) }), (0, r.jsx)('div', { className: v, children: c.children })] });
    };
  },
  18439(e, n, l) {
   l.d(n, { R: () => s, x: () => r });
  ...
  23596(e, n, l) {
   (l.r(n), l.d(n, { assets: () => d, contentTitle: () => a, default: () => v, frontMatter: () => r, metadata: () => o, toc: () => c }));
  ...
  38953(e, n, l) {
   ...
   var o = l(28369),
    ...
    j = l(46847),
    g = l(86070);
   const b = ({ children: e }) => (0, g.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(t.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(t.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   b.displayName = 'ParagraphContainer';
   const x = ({ children: e }) => (0, g.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(t.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   x.displayName = 'DocumentContainer';
   const f = ({ children: e }) => (0, g.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: e });
   f.displayName = 'SurfaceContainer';
   const y = globalThis.isAstro
    ? ({ language: e, className: n, code: l = '<p>No code provided</p>', rawCode: o, copyCode: t, defaultExpandedCode: s, designTokens: r }) => {
       const a = 'string' == typeof l ? l : o || '',
        d = 'string' == typeof l ? p().highlight(l, p().languages[e], e) : p().highlight(o || '', p().languages[e], e);
       return (0, g.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', n), children: [(0, g.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: r, children: (0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: a } }) }), (0, g.jsx)(u.n, { children: (0, g.jsxs)(u.K, { label: 'Code', open: s, children: [(0, g.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: d } }) }), 'allow' === t && (0, g.jsx)(j.$, { 'data-copy-code': a, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: m = !0, children: p, container: u = 'document', language: j, designTokens: y }) => {
       const k = 'function' == typeof p ? p() : p,
        _ = 'function' == typeof e ? e() : (0, h.isValidElement)(e) ? e : void 0,
        N = 'string' == typeof e ? e : v.qV(_ || k),
        [w, z] = (0, h.useState)(N),
        [A, C] = (0, h.useState)(l);
       (0, h.useEffect)(() => {
        (async () => {
         const e = await c.Ay.format(N, { parser: j, plugins: [s.A, r.Ay, a.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         z(e);
        })();
       }, [N]);
       const S = (0, h.useId)();
       let F = h.Fragment;
       return (
        'paragraph' === u ? (F = b) : 'document' === u ? (F = x) : 'surface' === u && (F = f),
        (0, g.jsxs)('div', {
         className: (0, i.A)('nlds-canvas'),
         children: [
          k && (0, g.jsx)('div', { className: (0, i.A)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, g.jsx)(F, { children: (0, g.jsx)(t.v$, { children: k }) }) }) }),
          m &&
           (0, g.jsx)('div', {
   ...
   const c = (0, a.createContext)({}),
    h = ({ title: e, appearance: n, description: l, children: a, figure: h }) => {
     const v = { do: 'Doen', dont: 'Niet doen' },
      m = h ? 'figure' : 'div',
      p = h ? 'figcaption' : 'div',
      u = 'string' == typeof l ? (0, d.jsx)(r.oz, { components: { a: i.N_ }, children: l }) : l;
     return (0, d.jsxs)(m, { className: (0, s.A)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(p, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(i.fz, { className: (0, s.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(t.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: v.dont })] }), (0, d.jsx)(i.fz, { children: e })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(i.fz, { className: (0, s.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(o.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: v.do })] }), (0, d.jsx)(i.fz, { children: e })] }), u] }), (0, d.jsx)('div', { className: 'nlds-guideline__example', children: (0, d.jsx)(c.Provider, { value: { title: e, type: v[n] }, children: a }) })] });
    };
  },
  56672(e, n, l) {
   l.d(n, { Ay: () => r, RM: () => i });
