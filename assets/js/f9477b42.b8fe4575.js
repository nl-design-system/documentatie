  ...
  31092: (e, n, l) => {
   ...
   const s = (e) => {
    ...
    const k = { do: "Doen", dont: "Niet doen" },
     m = n ? `${k[l]}: ${n}` : k[l];
    return t.createElement("div", { className: (0, r.Z)(i["nlds-guideline"], i[`nlds-guideline--${l}`]), id: null == n ? void 0 : n.toLowerCase().replace(/\s/g, "-") }, t.createElement("div", { className: (0, r.Z)(i["nlds-guideline__description"]) }, "dont" === l ? t.createElement(d.nv, { className: (0, r.Z)(i["nlds-guideline__badge"], i[`nlds-guideline__badge--${l}`]) }, t.createElement(o.Z, { className: i["nlds-guideline__icon"] }), t.createElement("span", { className: i["nlds-guideline__title"] }, m)) : t.createElement(d.nv, { className: (0, r.Z)(i["nlds-guideline__badge"], i[`nlds-guideline__badge--${l}`]) }, t.createElement(a.Z, { className: i["nlds-guideline__icon"] }), t.createElement("span", { className: i["nlds-guideline__title"] }, m)), s), t.createElement("div", { className: (0, r.Z)(i["nlds-guideline__example"]) }, c));
   };
  },
  91997: (e, n, l) => {
   ...
   function K(e) {
    let { components: n, ...l } = e;
    return (0, o.kt)(J, (0, t.Z)({}, q, l, { components: n, mdxType: "MDXLayout" }), (0, o.kt)("h1", { id: "labels-in-een-formulier" }, "Labels in een formulier"), (0, o.kt)("p", null, "Een label geeft aan welke gegevens de gebruiker bij een formulierveld in kan vullen.\nVoor de toegankelijkheid van labels en dus ook formuliervelden zijn de volgende punten belangrijk:"), (0, o.kt)("ul", null, (0, o.kt)("li", { parentName: "ul" }, "Geef een formulierveld een toegankelijke naam met een label."), (0, o.kt)("li", { parentName: "ul" }, "De zichtbare naam moet overeenkomen met de toegankelijke naam."), (0, o.kt)("li", { parentName: "ul" }, "Zet het label boven het formulierveld."), (0, o.kt)("li", { parentName: "ul" }, "Zorg ervoor dat het label altijd zichtbaar is."), (0, o.kt)("li", { parentName: "ul" }, "Zet alleen tekst in het label."), (0, o.kt)("li", { parentName: "ul" }, "Gebruik duidelijke labelteksten.")), (0, o.kt)(r, { mdxType: "AccessibleName" }), (0, o.kt)(m, { mdxType: "AccessibleNameCode" }), (0, o.kt)(b, { mdxType: "VisibleAccessibleName" }), (0, o.kt)(h, { mdxType: "VisibleAccessibleNameCode" }), (0, o.kt)(j, { mdxType: "LabelAboveField" }), (0, o.kt)(x, { mdxType: "LabelAboveFieldCode" }), (0, o.kt)(D, { mdxType: "LabelAlwaysVisible" }), (0, o.kt)(X, { mdxType: "LabelAlwaysVisibleCode" }), (0, o.kt)(M, { mdxType: "LabelOnlyText" }), (0, o.kt)(G, { mdxType: "LabelOnlyTextCode" }), (0, o.kt)(H, { mdxType: "LabelText" }), (0, o.kt)(V, { mdxType: "LabelTextCode" }), (0, o.kt)(R.ZP, { mdxType: "FormFooterInfo" }));
   }
   K.isMDXComponent = !0;
  },
  75695: (e, n, l) => {
