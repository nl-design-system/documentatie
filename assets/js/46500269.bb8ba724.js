(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [51127],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => m, VZ: () => w, cR: () => _, Pv: () => g, qZ: () => s, kD: () => b, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => i, eQ: () => k, B_: () => v, o_: () => p, Rc: () => x });
  ...
  90147(e, t, n) {
   ...
   var c = n(86070),
    ...
    s = n(20892),
    o = n(1842);
   const a = { title: 'Range', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Range', pagination_label: 'Range', description: 'Invoerveld voor een getal dat je bij benadering kunt kiezen door te schuiven tussen een minimum en maximum.', slug: '/range', keywords: ['adjuster', 'control', 'drag bar', 'range', 'range input', 'range slider', 'slider', 'slider bar', 'sliding control'] },
    u = void 0,
    l = {},
    h = 'Range',
    d = 'Invoerveld voor een getal dat je bij benadering kunt kiezen door te schuiven tussen een minimum en maximum.',
    j = 36,
