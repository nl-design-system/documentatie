 ...
 [52116],
 {
  ...
  16464: (e, n, l) => {
   ...
   var o = l(52676),
    ...
    r = l(91050);
   function a(e) {
    const n = { form: 'form', h2: 'h2', h3: 'h3', p: 'p', ...(0, t.a)(), ...e.components };
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', (0, o.jsx)(r.X, { appearance: 'do', title: 'Info boven het form element.', children: (0, o.jsx)(s.X, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)(n.h2, { children: 'Uw gegevens' }), (0, o.jsx)(n.p, { children: 'Stap 2 van 3' }), (0, o.jsx)(n.form, { children: '[... inhoud formulier \u2026]' })] }) }) }), '\n', (0, o.jsx)(r.X, { appearance: 'dont', title: 'Info binnen het formulier.', children: (0, o.jsx)(s.X, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)(n.h2, { children: 'Uw gegevens' }), (0, o.jsxs)(n.form, { children: [(0, o.jsx)(n.h3, { children: 'Stap 2 van 3' }), '[... inhoud formulier \u2026]'] })] }) }) })] });
   }
   function i(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
   ...
   function c(e) {
    const n = { a: 'a', code: 'code', h1: 'h1', p: 'p', strong: 'strong', ...(0, t.a)(), ...e.components };
  ...
  98480: (e, n, l) => {
   ...
   const b = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (C = await c.ZP.format(Z, { parser: j, plugins: [s.Z, r.ZP, a.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), P(C);
     })();
    }, [Z]);
    const D = (0, d.useId)();
    let R = d.Fragment;
    return (
     'paragraph' === f ? (R = h) : 'document' === f ? (R = v) : 'surface' === f && (R = _),
     (0, g.jsxs)('div', {
      className: (0, t.Z)(u['nlds-canvas']),
      children: [
       N && (0, g.jsx)('div', { className: (0, t.Z)(u['nlds-canvas__example']), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, g.jsx)(R, { children: (0, g.jsx)(o.pu, { children: N }) }) }) }),
       y &&
        (0, g.jsx)('div', {
       ...
       y &&
        (0, g.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, g.jsx)(m.u, { codeBlockLabel: 'Codevoorbeeld', syntax: j, textContent: C, trim: !0 }),
          l &&
           (0, g.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: l, textContent: c, trim: d } = e,
     p = c;
    const { title: u, type: m } = (0, s.useContext)(r.n),
     g = (0, s.useId)();
    return (
     d && (p = p.trim()),
     (0, i.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: g, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, i.jsx)(o.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': g, style: l, children: t.map((e, l) => (0, i.jsxs)('span', { ...s({ line: e }), children: [n && (0, i.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
   ...
   const d = (0, a.createContext)({}),
    p = (e) => {
     ...
     const m = { do: 'Doen', dont: 'Niet doen' },
      g = u ? 'figure' : 'div',
      h = u ? 'figcaption' : 'div';
     return (0, c.jsxs)(g, { className: (0, r.Z)(i['nlds-guideline'], i[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(h, { className: (0, r.Z)(i['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, r.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: i['nlds-guideline__title'], children: m.dont })] }), (0, c.jsx)(s.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, r.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: i['nlds-guideline__title'], children: m.do })] }), (0, c.jsx)(s.nv, { children: n })] }), a] }), (0, c.jsx)('div', { className: (0, r.Z)(i['nlds-guideline__example']), children: (0, c.jsx)(d.Provider, { value: { title: n, type: m[l] }, children: p }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => a, a: () => r });
