 ...
 [92043],
 {
  ...
  53838(e, n, t) {
   ...
   var i = t(86070),
    a = t(18439),
    r = t(73058);
   const d = { title: 'Zelf componenten uitbreiden', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Zelf componenten uitbreiden', sidebar_position: 4, pagination_label: 'Zelf componenten uitbreiden', description: 'Informatie voor designers over hoe je zelf componenten kunt uitbreiden in Figma met design tokens.', slug: '/handboek/designer/zelf-componenten-uitbreiden', keywords: ['index', 'designer', 'meedoen', 'componenten', 'figma', 'design tokens'] },
  ...
  73058(e, n, t) {
   ...
   const d = i.forwardRef(function (e, n) {
     const [t, d] = i.useState(!1),
      ...
      y = i.useMemo(() => (e.playlist ? `${g}/embed/videoseries?${b.toString()}` : `${g}/embed/${c}?${b.toString()}`), [e.playlist, g, c, b]),
      ...
      w = k
       ...
       : null,
      x = i.useMemo(() => e.thumbnail || w || `https://i.ytimg.com/${v}/${e.playlist ? m : c}/${p}.${j}`, [e.thumbnail, w, v, e.playlist, m, c, p, j]),
     ...
     return (
      ...
      (0, o.jsxs)(o.Fragment, {
       children: [
        ...
        F && !e.playlist && (0, o.jsx)('noscript', { children: (0, o.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${u} on YouTube`, children: ['Watch "', u, '" on YouTube'] }) }),
        (0, o.jsxs)(I, {
         onPointerOver: () => {
          t || d(!0);
         },
         ...
         children: [e.lazyLoad && !s && (0, o.jsx)('img', { src: x, alt: `${u} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !s && (0, o.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && s) && (0, o.jsx)('button', { type: 'button', className: S, 'aria-label': `${h} ${u}`, 'aria-hidden': s || void 0, tabIndex: s ? -1 : 0, onClick: N, children: (0, o.jsx)('span', { className: 'lty-visually-hidden', children: h }) }), s && (0, o.jsx)('iframe', { ref: n, className: $, title: u, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: y, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
