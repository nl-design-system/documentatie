 ...
 [65850],
 {
  18127(e, n, r) {
   ...
   var l = r(95822),
    ...
    h = r(31186),
    u = r(86070);
   const m = ({ children: e }) => (0, u.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, u.jsx)(o.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, u.jsx)(o.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   m.displayName = 'ParagraphContainer';
   const v = ({ children: e }) => (0, u.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, u.jsx)(o.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const b = ({ code: e, copy: n = !0, defaultExpandedCode: r = !1, displayCode: b = !0, children: y, container: j = 'document', language: x, designTokens: f }) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(w, { parser: x, plugins: [t.A, c.Ay, a.Ay, i.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      A(e);
     })();
    }, [w]);
    const S = (0, p.useId)();
    let F = p.Fragment;
    return (
     'paragraph' === j ? (F = m) : 'document' === j ? (F = v) : 'surface' === j && (F = g),
     (0, u.jsxs)('div', {
      className: (0, s.A)('nlds-canvas'),
      children: [
       k && (0, u.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, u.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, u.jsx)(F, { children: (0, u.jsx)(o.v$, { children: k }) }) }) }),
       b &&
        (0, u.jsx)('div', {
  ...
  22703(e, n, r) {
   ...
   function i(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', (0, o.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, o.jsx)(a.$, { appearance: 'do', title: 'Geen placeholder gebruiken als het label duidelijk genoeg is.', children: (0, o.jsx)(c.H, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('p', { children: (0, o.jsx)('label', { htmlFor: 'voornaam1', children: 'Je voornaam' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('input', { autoComplete: 'given-name', id: 'voornaam1', name: 'voornaam', type: 'text' }) })] }) }) }), '\n', (0, o.jsx)(a.$, { appearance: 'dont', title: 'De labeltekst herhalen in de placeholder.', children: (0, o.jsx)(c.H, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('p', { children: (0, o.jsx)('label', { htmlFor: 'voornaam2', children: 'Voornaam' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('input', { autoComplete: 'given-name', id: 'voornaam2', name: 'voornaam', placeholder: 'Voornaam', type: 'text' }) })] }) }) })] });
   }
   function d(e = {}) {
   ...
   const v = { title: 'Voorkom verwarring bij de gebruiker', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Placeholder kan verwarren', pagination_label: 'Placeholder kan verwarren', description: 'Richtlijnen om verwarring bij de gebruiker te voorkomen.', slug: '/richtlijnen/formulieren/placeholders/verwarring-voorkomen', keywords: ['labels', 'formulier', 'design', 'code'] },
    g = void 0,
    b = {},
  ...
  88022(e, n, r) {
   ...
   const d = (0, a.createContext)({}),
    p = ({ title: e, appearance: n, description: r, children: a, figure: p }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      u = p ? 'figure' : 'div',
      m = p ? 'figcaption' : 'div',
      v = 'string' == typeof r ? (0, i.jsx)(c.oz, { children: r }) : r;
     return (0, i.jsxs)(u, { className: (0, t.A)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(m, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(s.fz, { className: (0, t.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, i.jsx)(o.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, i.jsx)('span', { className: 'nlds-guideline__title', children: h.dont })] }), (0, i.jsx)(s.fz, { children: e })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(s.fz, { className: (0, t.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, i.jsx)(l.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, i.jsx)('span', { className: 'nlds-guideline__title', children: h.do })] }), (0, i.jsx)(s.fz, { children: e })] }), v] }), (0, i.jsx)('div', { className: 'nlds-guideline__example', children: (0, i.jsx)(d.Provider, { value: { title: e, type: h[n] }, children: a }) })] });
    };
  },
  95822(e, n, r) {
   r.d(n, { M: () => i });
   ...
   function i({ lineNumber: e, syntax: n, textContent: r, trim: i }) {
    ...
    const { title: p, type: h } = (0, s.useContext)(t.x),
     u = (0, s.useId)();
    return (i && (d = d.trim()), (0, a.jsx)(o.f4, { theme: c, code: d, language: n || '', children: ({ style: n, tokens: r, getLineProps: o, getTokenProps: s }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: u, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, a.jsx)(l.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': u, style: n, children: r.map((n, r) => (0, a.jsxs)('span', { ...o({ line: n }), children: [e && (0, a.jsx)('span', { children: r + 1 }), n.map((e, n) => (0, a.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, r)) })] }) }));
   }
  },
 },
]);
