(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [42112],
 {
  ...
  49463: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => B, component: () => H, contentTitle: () => F, default: () => V, description: () => Z, frontMatter: () => _, issueNumber: () => E, metadata: () => P, title: () => O, toc: () => M });
   var r,
    i,
    s,
    o,
   ...
   const _ = { title: 'Data Badge', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Data Badge', pagination_label: 'Data Badge', description: 'Label met extra informatie, zoals een categorie of een eigenschap.', slug: '/data-badge', keywords: ['annotatie', 'annotation', 'badge', 'categorie', 'category', 'categorie aanduiding', 'categoriseren', 'categorize', 'characteristic', 'chip', 'data', 'data badge', 'data tag', 'eigenschap', 'etiket', 'etiquette', 'filteren op', 'filter tag', 'index', 'index term', 'info', 'info tag', 'informatiebadge', 'label', 'metadata', 'pill', 'property', 'stamp', 'status', 'status badge', 'sticker', 'tag', 'tagging', 'tagged', 'term', 'time'] },
    ...
    O = 'Data Badge',
    Z = 'Label met extra informatie, zoals een categorie of een eigenschap.',
    E = 94,
    H = u.find((e) => e.number === E);
   function U(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, d.jsx)(D.Rv, { component: H, headingLevel: 1, description: Z }),
      '\n',
      (0, d.jsx)(W.I, { component: H }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, d.jsx)(R.B, { component: H, illustration: p }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'gebruik-deze-component', children: 'Gebruik deze component' }),
      '\n',
      (0, d.jsx)(S.U, { omitH1: !0, headingLevel: 3, children: (0, d.jsx)(L, {}) }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, d.jsx)(D.cN, { component: H, headingLevel: 3 }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, d.jsx)(D.W, { component: H, headingLevel: 3 }),
      '\n',
      ...
      (0, d.jsx)(z.t, {
       ...
       items: [
        { title: 'Gebruik niet alleen kleur om de betekenis van de Data Badge duidelijk te maken', sc: '1.4.1', status: '', component: (0, d.jsx)(b, {}) },
      ...
      (0, d.jsx)(z.t, {
       ...
       items: [
        ...
        { title: 'Als je de tekstafstand van de Data Badge vergroot blijft de tekst in zijn geheel zichtbaar', sc: '1.4.12', status: '', component: (0, d.jsx)(k.ZP, {}) },
       ],
      }),
      '\n',
      (0, d.jsx)(z.t, {
      ...
      '\n',
      (0, d.jsx)(D.vM, { component: H, headingLevel: 3 }),
     ],
    });
   }
   function V(e = {}) {
    const { wrapper: t } = { ...(0, h.a)(), ...e.components };
    return t ? (0, d.jsx)(t, { ...e, children: (0, d.jsx)(U, { ...e }) }) : U(e);
   }
  },
  54907: (e, t, n) => {
  ...
  94443: (e, t, n) => {
   ...
   const A = (e) => {
     ...
     const s = t && t.projects.filter((e) => v.e9.includes(e.id)),
      o = s && v.e9.map((e) => s.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, d.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)('definition-of-done', e && `definition-of-done--${(0, v.mA)(e.title)}`),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, d.jsx)(y, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(f, { headingLevel: n + 1, checked: t, title: r, description: (0, v.Q6)(i) }, i);
            }),
           }),
    ...
    b = (e) => {
     let { component: t, headingLevel: n } = e;
     const i = t && t.projects.filter((e) => !v.e9.includes(e.id));
     return t && i.length
      ? (0, d.jsx)(g.um, {
         appearance: 'large',
               ...
               s.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: s.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: n + 2, children: [i, ' in ', t] }), (0, d.jsx)(r.Mc, { children: s.map((e) => (0, d.jsxs)(r.k7, { href: e.value, children: [(0, d.jsx)(u, { brand: e.brand }), ' ', e.description] }, e.id)) })] });
                 }),
                }),
              ],
             }),
    ...
    x = (e) => {
     ...
     const s = t && v.$3[t.relayStep];
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.V, { level: n, suffix: s && (0, d.jsx)(m.y, { state: s }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => a, Q6: () => s, U: () => l, e9: () => o, mA: () => i, ps: () => d });
