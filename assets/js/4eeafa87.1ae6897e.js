 ...
 [44344],
 {
  ...
  25623(e, n, t) {
   ...
   const y = [
     ...
     { title: 'Instructies in de Note zijn op een inclusieve manier beschreven.', sc: '1.3.3', status: '', component: b.Ay, tags: ['designer', 'contentmaker'] },
     ...
     { title: 'De Note komt niet voor in de normale focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: x.Ay, tags: ['developer'] },
    ...
    T = [
     ...
     { title: 'De Note komt standaard niet voor in de normale focusvolgorde op de pagina', sc: '2.4.3', status: '', component: C.Ay, tags: ['developer'] },
    ],
    R = { title: 'Note', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Note', pagination_label: 'Note', description: 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.', issue_number: 409, slug: '/note', keywords: ['admonition', 'aside', 'call out', 'callout', 'highlight box', 'highlight', 'highlighter', 'info', 'information', 'note', 'notice', 'spotlight', 'tip'] },
    N = void 0,
    G = {},
    D = 'Note',
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => k, cR: () => A, Pv: () => f, qZ: () => o, kD: () => v, QQ: () => y, B2: () => m, Pc: () => l, f4: () => s, GT: () => b, fX: () => a, eQ: () => x, B_: () => j, o_: () => w });
