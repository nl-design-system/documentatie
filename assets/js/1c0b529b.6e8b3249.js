 ...
 [34894],
 {
  19736: (e, t, n) => {
   ...
   const s = { title: 'Checkbox', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Checkbox', pagination_label: 'Checkbox', description: ' ', slug: '/checkbox', sidebar_custom_props: { illustration: 'CheckboxSketch' }, keywords: ['aankruisvakje', 'aankruizen', 'check', 'checkbox', 'indeterminate', 'meerkeuze', 'select', 'selecteren', 'selectie', 'selectievakje', 'vinkje'] },
    a = void 0,
    u = { id: 'componenten/checkbox/index', title: 'Checkbox', description: ' ', source: '@site/docs/componenten/checkbox/index.mdx', sourceDirName: 'componenten/checkbox', slug: '/checkbox', permalink: '/checkbox', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/checkbox/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Checkbox', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Checkbox', pagination_label: 'Checkbox', description: ' ', slug: '/checkbox', sidebar_custom_props: { illustration: 'CheckboxSketch' }, keywords: ['aankruisvakje', 'aankruizen', 'check', 'checkbox', 'indeterminate', 'meerkeuze', 'select', 'selecteren', 'selectie', 'selectievakje', 'vinkje'] }, sidebar: 'componenten', previous: { title: 'Case card', permalink: '/case-card' }, next: { title: 'Checkbox group', permalink: '/checkbox-group' } },
    l = {},
    h = [
