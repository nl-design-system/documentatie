   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const s = 'function' == typeof e ? e() : e,
        ...
        r = g().highlight(o, g().languages[n], n);
       return (0, v.jsxs)('div', { className: (0, t.A)('ma-canvas-astro', l), children: [(0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }), (0, v.jsx)(h.n, { children: (0, v.jsx)(h.K, { label: 'Code', children: (0, v.jsx)('pre', { className: 'language-html nl-code-block', children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: m = !0, children: g, container: h = 'document', language: y, designTokens: f }) => {
