/*! For license information please see 94158.bc76fa85.js.LICENSE.txt */
'use strict';
  ...
  79889(e, n, t) {
   ...
   var v = (0, i.forwardRef)(function (e, n) {
    ...
    if (
     ...
     var g = a.dateTime,
      v = (0, l.A)(a, d);
     return (0, r.jsx)('time', h(h({}, v), {}, { dateTime: g, className: i, ref: n, children: t }));
    }
    if (
     (function (e) {
      return 'value' in e;
     ...
     var c = a.value,
      p = (0, l.A)(a, s);
     return (0, r.jsx)('data', h(h({}, p), {}, { value: c, className: i, ref: n, children: t }));
    }
    return (0, r.jsx)('span', h(h({}, a), {}, { className: i, ref: n, children: t }));
   });
   ...
   var g = function () {
    ...
    h = (0, i.forwardRef)(function (e, n) {
     var t = e.children,
      a = e.className,
      i = (0, l.A)(e, o);
     return (0, r.jsx)('code', s(s({ dir: 'ltr', translate: 'no', className: g('nl-code', a) }, i), {}, { ref: n, children: t }));
    });
   h.displayName = 'Code';
   !(function (e, n) {
    void 0 === n && (n = {});
