...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [16229],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => r, KF: () => m, mJ: () => u, VZ: () => A, cR: () => w, Pv: () => f, qZ: () => s, kD: () => b, B2: () => g, Pc: () => l, f4: () => o, GT: () => v, fX: () => i, eQ: () => k, B_: () => x, o_: () => j, Rc: () => _ });
  ...
  40062(e, n, t) {
   (t.r(n), t.d(n, { assets: () => h, component: () => j, componentName: () => f, contentTitle: () => c, default: () => b, description: () => g, frontMatter: () => d, issueNumber: () => p, metadata: () => a, relayStep: () => u, title: () => m, toc: () => x }));
   ...
   const d = { title: 'Calendar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Calendar', pagination_label: 'Calendar', description: 'Een kalender waarin je een beschikbare datum kan kiezen.', slug: '/calendar', keywords: ['afspraak', 'appointment', 'availability', 'beschikbaarheid', 'calendar', 'dag', 'dagen', 'date', 'date picker', 'datepicker', 'datum', 'datumprikker', 'day', 'days', 'jaar', 'kalender', 'maand', 'moment', 'month', 'week', 'weeks', 'weken', 'year'] },
    ...
    h = {},
    m = 'Calendar',
    g = 'Een kalender waarin je een beschikbare datum kan kiezen.',
    p = 199,
    u = 'help wanted',
    f = 'calendar',
