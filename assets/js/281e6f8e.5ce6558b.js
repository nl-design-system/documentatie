...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  74133: (e, i, n) => {
   n.r(i), n.d(i, { assets: () => d, contentTitle: () => l, default: () => p, frontMatter: () => s, metadata: () => o, toc: () => c });
   var t = n(52676),
    r = n(40139),
    a = n(82415);
  ...
  82415: (e, i, n) => {
   ...
   var t = n(87573),
    ...
    l = n(52676);
   const o = (e) => {
    let { listId: i = '', laPostaId: n = '', thanksPage: o = '', emailFieldId: d = '', firstNameFieldId: c = '', orgId: h = '', interestsId: p = '', interests: m = [], workAreasId: u = '', privacyPolicyId: j = '', language: v, submitText: g = '' } = e;
    const {
      register: x,
      handleSubmit: b,
      formState: { errors: f },
    ...
    return (0, l.jsxs)('form', {
     ...
     children: [(0, l.jsxs)(r.Wi, { type: 'email', children: [(0, l.jsx)(r.nv, { children: (0, l.jsx)(r.lX, { htmlFor: `id-${d}`, children: y ? 'Email address ' : 'E-mailadres' }) }), f[d] && (0, l.jsx)(r.w7, { children: f[d].message }), (0, l.jsx)(r.nv, { children: (0, l.jsx)(r.fE, { id: `id-${d}`, name: d, type: 'email', autoComplete: 'email', defaultValue: I, 'aria-required': 'true', ...x(`${d}`, { required: { value: !0, message: y ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' }, pattern: { value: /\S+@\S+\.\S+/, message: y ? 'This is not a valid email address.' : 'Dit is geen correct emailadres.' } }), invalid: !!f[d] }) })] }), (0, l.jsxs)(r.Wi, { type: 'text', children: [(0, l.jsx)(r.nv, { children: (0, l.jsx)(r.lX, { htmlFor: c, children: y ? 'Name' : 'Naam' }) }), f[c] && (0, l.jsx)(r.w7, { children: f[c].message }), (0, l.jsx)(r.nv, { children: (0, l.jsx)(r.fE, { id: c, name: c, type: 'text', defaultValue: D, autoComplete: 'given-name', 'aria-required': 'true', ...x(`${c}`, { required: { value: !0, message: y ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' } }), invalid: !!f[c] }) })] }), h && (0, l.jsxs)(r.Wi, { type: 'text', children: [(0, l.jsx)(r.nv, { children: (0, l.jsx)(r.lX, { htmlFor: h, children: y ? 'Organisation (not required)' : 'Organisatie (niet verplicht)' }) }), f[h] && (0, l.jsx)(r.w7, { children: f[h].message }), (0, l.jsx)(r.nv, { children: (0, l.jsx)(r.fE, { id: h, name: h, type: 'text' }) })] }), p && (0, l.jsxs)(r.pg, { children: [(0, l.jsx)(r.Qv, { children: 'Waar wil je NL Design System voor gebruiken? (niet verplicht)' }), (0, l.jsx)(r.ue, { children: 'Meerdere antwoorden mogelijk.' }), m.map((e, i) => (0, l.jsx)(r.Wi, { type: 'checkbox', children: (0, l.jsxs)(r.nv, { children: [(0, l.jsx)(r.XZ, { name: `${p}[]`, value: i >= 6 ? i + 2 : i + 1, id: `${p}-${i + 1}` }), (0, l.jsx)(r.lX, { htmlFor: `${p}-${i + 1}`, children: e })] }) }, e))] }), u && (0, l.jsxs)(r.Wi, { type: 'text', children: [(0, l.jsxs)(r.nv, { children: [(0, l.jsx)(r.lX, { htmlFor: u, children: 'Aan wat voor projecten werk je? (niet verplicht)' }), (0, l.jsx)(r.ue, { children: 'Denk aan mijn-omgevingen, formulieren en/of kaarten.' })] }), (0, l.jsx)(r.nv, { children: (0, l.jsx)(r.gx, { id: u, name: u }) })] }), j && (0, l.jsxs)(r.Wi, { type: 'text', children: [(0, l.jsx)(r.ue, { id: `${j}-description`, children: y ? (0, l.jsxs)('p', { children: ['The ', (0, l.jsx)('a', { href: '/privacy-policy', children: 'privacy policy' }), ' of NL Design System applies to our activities.'] }) : (0, l.jsxs)('p', { children: ['Op onze activiteiten is de ', (0, l.jsx)('a', { href: '/privacyverklaring', children: 'privacyverklaring van NL Design System' }), ' van toepassing.'] }) }), (0, l.jsxs)(r.Wi, { type: 'checkbox', children: [(0, l.jsx)(r.XZ, { value: '1', id: `${j}-1`, 'aria-describedby': `${j}-description`, 'aria-required': 'true', ...x(`${j}[]`, { required: { value: !0, message: y ? 'You can only register if you agree with the privacy policy.' : 'Je kunt je alleen aanmelden als je akkoord gaat met de privacyverklaring.' } }), invalid: !!f[`${j}[]`] }), (0, l.jsx)(r.lX, { htmlFor: `${j}-1`, children: y ? 'I agree to the use of my data in accordance with the privacy policy' : 'Ik ga akkoord met het gebruik van mijn gegevens volgens de privacyverklaring' })] }), f[j] && (0, l.jsx)(r.w7, { children: f[j].message })] }), v?.id && (0, l.jsx)('input', { type: 'hidden', name: v.id, value: v.value }), (0, l.jsx)(r.hE, { children: (0, l.jsx)(r.zx, { type: 'submit', appearance: 'primary-action-button', children: g || (y ? 'Sign up' : 'Aanmelden') }) }), (0, l.jsx)('input', { type: 'hidden', name: 'next', value: o }), (0, l.jsx)('input', { type: 'hidden', name: 'a', value: n }), (0, l.jsx)('input', { type: 'hidden', name: 'l', value: i }), (0, l.jsx)('input', { name: 'osnD9cWRI3', autoComplete: 'on', id: 'id-osnD9cWRI3', type: 'hidden', value: 'NLDS website' }), (0, l.jsx)('input', { autoComplete: 'new-password', type: 'email', id: 'email', name: 'email', placeholder: 'Your e-mail here', className: 'sr-only', 'aria-hidden': 'true' })],
    });
   };
  },
  40139: (e, i, n) => {
   ...
   function l(e) {
    let i;
    return (i = e.disableParentContext ? ('function' == typeof e.components ? e.components(r) : e.components || r) : s(e.components)), t.createElement(a.Provider, { value: i }, e.children);
   }
  },
 },
]);
