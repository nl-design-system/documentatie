 ...
 [43166],
 {
  32649: (e, n, t) => {
   ...
   const d = { title: 'Table', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Table', pagination_label: 'Table', description: 'UX richtlijnen voor Table component', slug: '/table', sidebar_custom_props: { illustration: 'TableSketch' } },
    h = void 0,
    u = { id: 'componenten/table/index', title: 'Table', description: 'UX richtlijnen voor Table component', source: '@site/docs/componenten/table/index.mdx', sourceDirName: 'componenten/table', slug: '/table', permalink: '/table', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/table/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Table', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Table', pagination_label: 'Table', description: 'UX richtlijnen voor Table component', slug: '/table', sidebar_custom_props: { illustration: 'TableSketch' } }, sidebar: 'componenten', previous: { title: 'Switch', permalink: '/switch' }, next: { title: 'Tabs', permalink: '/tabs' } },
    j = {},
    m = [
