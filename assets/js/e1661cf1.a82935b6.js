(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [29865],
 {
  ...
  94443: (e, t, n) => {
   ...
   const k = (e) => {
     ...
     const s = t && t.projects.filter((e) => f.e9.includes(e.id)),
      c = s && f.e9.map((e) => s.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, u.jsx)(v, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(b, { headingLevel: n + 1, checked: t, title: r, description: (0, f.Q6)(i) }, i);
            }),
           }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => o, Ee: () => u, Q6: () => s, U: () => j, d: () => h, e9: () => c, mA: () => i, ps: () => m });
