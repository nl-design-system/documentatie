...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [34875],
 {
  ...
  58639(e, n, l) {
   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: j = !0, children: v, container: x = 'document', language: g, designTokens: f }) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(z, { parser: g, plugins: [s.A, c.Ay, i.Ay, a.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [z]);
    const S = (0, u.useId)();
    let P = u.Fragment;
    return (
     'paragraph' === x ? (P = m) : 'document' === x ? (P = b) : 'surface' === x && (P = y),
     (0, p.jsxs)('div', {
      ...
      children: [
       ...
       j &&
        (0, p.jsxs)('div', {
         ...
         hidden: !A,
         children: [
          (0, p.jsx)(o.M, { codeBlockLabel: 'Codevoorbeeld', syntax: g, textContent: w, trim: !0 }),
          n &&
           (0, p.jsx)('div', {
  ...
  59845(e, n, l) {
   ...
   var r = l(86070),
    ...
    i = l(15638);
   function a(e) {
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', (0, r.jsx)(i.$, { appearance: 'do', title: 'De placeholder samen met tekst van de submitbutton gebruiken zichtbaar label in een kort zoekformulier.', children: (0, r.jsx)(c.H, { language: 'html', children: () => (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)('p', { children: (0, r.jsx)('label', { className: 'sr-only', htmlFor: 'header-search', children: 'Zoek' }) }), (0, r.jsx)('p', { children: (0, r.jsx)('input', { id: 'header-search', placeholder: 'Zoek', type: 'search' }) }), (0, r.jsx)('p', { children: (0, r.jsx)('button', { children: 'Zoek' }) })] }) }) })] });
   }
   function d(e = {}) {
