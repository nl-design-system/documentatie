...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [41952],
 {
  ...
  24451: (e, n, l) => {
   ...
   var u = l(3510);
   const p = { title: 'Schrijf een duidelijke foutmelding | Foutmeldingen in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Duidelijke foutmeldingen', pagination_label: 'Duidelijke foutmeldingen', description: 'Richtlijnen voor duidelijke foutmeldingen in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/duidelijk - labels - formulier - design - code' },
    m = void 0,
    g = { id: 'richtlijnen/formulieren/error/clarity/README', title: 'Schrijf een duidelijke foutmelding | Foutmeldingen in een formulier | Richtlijnen', description: 'Richtlijnen voor duidelijke foutmeldingen in een formulier.', source: '@site/docs/richtlijnen/formulieren/error/3-clarity/README.mdx', sourceDirName: 'richtlijnen/formulieren/error/3-clarity', slug: '/richtlijnen/formulieren/foutmeldingen/duidelijk - labels - formulier - design - code', permalink: '/richtlijnen/formulieren/foutmeldingen/duidelijk - labels - formulier - design - code', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/error/3-clarity/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Schrijf een duidelijke foutmelding | Foutmeldingen in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Duidelijke foutmeldingen', pagination_label: 'Duidelijke foutmeldingen', description: 'Richtlijnen voor duidelijke foutmeldingen in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/duidelijk - labels - formulier - design - code' }, sidebar: 'richtlijnen', previous: { title: 'Fouten beschrijven', permalink: '/richtlijnen/formulieren/foutmeldingen/beschrijven' }, next: { title: 'Plaatsing foutmelding', permalink: '/richtlijnen/formulieren/foutmeldingen/plaatsing' } },
    h = {},
    v = [];
   function j(e) {
