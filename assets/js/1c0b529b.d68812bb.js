 ...
 [44125],
 {
  12761(e, n, a) {
   ...
   const k = ({ className: e, ...n }) => {
     ...
     return (0, u.jsx)('div', { className: a, children: n.children });
    },
    f = ({ className: e, ...n }) => {
     const a = (0, i.A)('utrecht-accordion__section', e);
     return (0, u.jsxs)('details', { className: a, ...n, children: [(0, u.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, u.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, u.jsx)('span', { className: 'nl-button__icon-start', children: (0, u.jsx)(b.A, {}) }), (0, u.jsx)('span', { className: 'nl-button__label', children: (0, u.jsx)(x.D, { level: n.headingLevel, appearance: n.headingApperance, children: n.heading }) })] }) }), (0, u.jsx)('div', { className: 'utrecht-accordion__panel', children: n.children })] });
    },
    v = ({ component: e, headingLevel: n }) => {
     const a = e && e.projects.filter((e) => p.f4.includes(e.id)),
      l = a && p.f4.map((e) => a.find((n) => n.id === e)).filter(Boolean);
     return e && (0, u.jsx)(k, { children: l.map((a) => (0, u.jsx)(f, { className: (0, i.A)('ma-definition-of-done', a && `ma-definition-of-done--${(0, p.fX)(a.title)}`), heading: a ? `${a.title} - ${a.progress.value} van ${a.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(c._, { children: a.tasks.map(({ checked: e, name: a, id: t }) => (0, u.jsx)(c.Z, { headingLevel: n + 1, checked: e, heading: a, description: (0, p.qZ)(t) }, t)) }), (0, u.jsx)(t.fz, { children: (0, u.jsxs)(t.N_, { href: `${a.url}?filterQuery=${e.title}`, children: [a.title, ' projectbord op GitHub'] }) })] }) }, a.title)) });
    },
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => b, qZ: () => o, kD: () => v, B2: () => c, Pc: () => r, f4: () => s, GT: () => j, fX: () => l, eQ: () => f, B_: () => k, o_: () => x });
