   ...
   const a = class {
    ...
    render() {
     ...
     return (0, r.h)(
      ...
      (0, r.h)('span', { key: '8adb1c5a2a6d773dbc0465d5150bdd5c3f3fac12', class: 'utrecht-pagination__before' }, a ? o(Object.assign(Object.assign({}, a), { rel: 'prev', textContent: 'Vorige' })) : ''),
      (0, r.h)(
       'span',
       ...
       e
        ...
        .map((t) => (({ current: t = !1, href: e = '', rel: n = null, textContent: a = '' }) => (0, r.h)('a', { key: 'c854d21859190a4dc0184bca5f79294b62db9247', class: (0, i.c)('utrecht-pagination__page-link', t && 'utrecht-pagination__page-link--current'), href: e, 'aria-current': t ? 'true' : null, rel: n }, a))(t)),
      ),
      (0, r.h)('span', { key: '3484a2527d62be3a62f7fe3a6c7e0df8af2f0912', class: 'utrecht-pagination__before' }, n ? o(Object.assign(Object.assign({}, n), { rel: 'next', textContent: 'Volgende' })) : ''),
     );
    }
   };
