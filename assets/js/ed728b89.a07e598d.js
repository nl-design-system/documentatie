 ...
 [68203],
 {
  ...
  24703(e, n, i) {
   ...
   const l = (e, n) => {
    ...
    d = ({ children: e, omitH1: n = !1, headingLevel: i = 1, baseUrl: r = '', components: l = {} }) => (0, s.jsx)(t.x, { components: { ...c(n, i), ...a(r), ...l }, children: e });
  },
  25431(e, n, i) {
   i.d(n, { Ay: () => o, RM: () => s });
   var t = i(86070),
  ...
  46332(e, n, i) {
   (i.r(n), i.d(n, { assets: () => m, contentTitle: () => v, default: () => x, frontMatter: () => p, metadata: () => t, toc: () => j }));
   const t = JSON.parse('{"id":"wcag/1.2.04","title":"WCAG-succescriterium 1.2.4 Ondertitels voor doven en slechthorenden (live)","description":"Voor alle live audio-streams zijn ondertitels beschikbaar.","source":"@site/docs/wcag/1.2.04.mdx","sourceDirName":"wcag","slug":"/wcag/1.2.4","permalink":"/wcag/1.2.4","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.2.04.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 1.2.4 Ondertitels voor doven en slechthorenden (live)","title_sm":"1.2.4 Ondertitels voor doven en slechthorenden (live)","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"1.2.4 Ondertitels voor doven en slechthorenden (live)","pagination_label":"WCAG-succescriterium 1.2.4 Ondertitels voor doven en slechthorenden (live)","description":"Voor alle live audio-streams zijn ondertitels beschikbaar.","slug":"1.2.4","conformance_level":"Niveau AA","keywords":["WCAG","AA","waarneembaar","op tijd gebaseerde media","perceivable","time-based media","captions (live)","live","captions"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 1.2.3 Audiodescriptie of media-alternatief (vooraf opgenomen)","permalink":"/wcag/1.2.3"},"next":{"title":"WCAG-succescriterium 1.2.5 Audiodescriptie (vooraf opgenomen)","permalink":"/wcag/1.2.5"}}');
   var r = i(86070),
    s = i(18439),
    l = i(24703),
    o = i(61473),
   ...
   function g(e) {
    ...
    return (0, r.jsx)(n.p, { children: 'Voor alle live audio-streams zijn ondertitels beschikbaar. Deze ondertiteling heeft niet alleen gesproken woord. Ondertitels voor doven en slechthorenden maken ook duidelijk wie er spreekt en welk geluid nog meer belangrijk is, zoals muziek, omgevingsgeluid en geluidseffecten.' });
   }
   function u(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(g, { ...e }) }) : g(e);
   }
   const p = { title: 'WCAG-succescriterium 1.2.4 Ondertitels voor doven en slechthorenden (live)', title_sm: '1.2.4 Ondertitels voor doven en slechthorenden (live)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.2.4 Ondertitels voor doven en slechthorenden (live)', pagination_label: 'WCAG-succescriterium 1.2.4 Ondertitels voor doven en slechthorenden (live)', description: 'Voor alle live audio-streams zijn ondertitels beschikbaar.', slug: '1.2.4', conformance_level: 'Niveau AA', keywords: ['WCAG', 'AA', 'waarneembaar', 'op tijd gebaseerde media', 'perceivable', 'time-based media', 'captions (live)', 'live', 'captions'] },
    v = void 0,
    m = {},
   ...
   function f(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', (0, r.jsx)(o.E, { level: 1, conformanceLevel: 'Niveau AA', children: ' WCAG-succescriterium 1.2.4 Ondertitels voor doven en slechthorenden (live)' }), '\n', (0, r.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, r.jsx)(u, {}), '\n', (0, r.jsx)(n.h2, { id: 'opgelet', children: 'Opgelet' }), '\n', (0, r.jsx)(n.p, { children: 'Deze inhoud wordt binnenkort aangevuld met uitgebreidere uitleg, bronnen en informatie over hoe te testen.' }), '\n', (0, r.jsx)(n.h2, { id: 'gerelateerde-nl-design-system-richtlijnen', children: 'Gerelateerde NL Design System-richtlijnen' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Content: ', (0, r.jsx)(n.a, { href: '/richtlijnen/content/video/ondertiteling/', children: 'Ondertiteling' }), '.'] }), '\n'] }), '\n', (0, r.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, r.jsx)(c.Ay, {}), '\n', (0, r.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#captions-live', children: (0, r.jsx)('span', { lang: 'en', children: '1.2.4 Captions (Live)' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#captions-live', children: '1.2.4 Ondertitels voor doven en slechthorenden (live)' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, r.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#captions-live', children: (0, r.jsx)('span', { lang: 'en', children: 'Quick Reference 1.2.4 Captions (Live)' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/captions-live.html', children: (0, r.jsx)('span', { lang: 'en', children: 'Understanding SC 1.2.4 Captions (Live)' }) }), '.'] }), '\n'] }), '\n', (0, r.jsx)(a.K, { children: (0, r.jsx)(l.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(d.Ay, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, r.jsx)(l.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(h.Ay, {}) })] });
   }
   function x(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
  ...
  66119(e, n, i) {
   ...
   const l = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: r, ...l }, o) => {
    const a = { ...l, ref: o, className: s('utrecht-note', { [`utrecht-note--${r}`]: r }, i) };
