 ...
 [75221],
 {
  62163: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(96439),
    o = n(23952);
   const s = { title: 'Unordered List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Unordered List', pagination_label: 'Unordered List', description: 'Opsomming waar de volgorde van items in de lijst niet van belang is.', slug: '/unordered-list' },
    a = void 0,
    l = { id: 'componenten/unordered-list/index', title: 'Unordered List', description: 'Opsomming waar de volgorde van items in de lijst niet van belang is.', source: '@site/docs/componenten/unordered-list/index.mdx', sourceDirName: 'componenten/unordered-list', slug: '/unordered-list', permalink: '/unordered-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/unordered-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Unordered List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Unordered List', pagination_label: 'Unordered List', description: 'Opsomming waar de volgorde van items in de lijst niet van belang is.', slug: '/unordered-list' }, sidebar: 'componenten', previous: { title: 'Toggletip', permalink: '/toggletip' }, next: { title: 'Video', permalink: '/video' } },
    u = {},
    d = [
    ...
    h = 'Unordered List',
    j = 'Opsomming waar de volgorde van items in de lijst niet van belang is.',
    g = 116,
