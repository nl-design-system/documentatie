 ...
 [77598],
 {
  ...
  21034(e, n, a) {
   ...
   const f = ({ component: e, headingLevel: n }) => {
     const a = e && e.projects.filter((e) => j.f4.includes(e.id)),
      i = a && j.f4.map((e) => a.find((n) => n.id === e)).filter(Boolean);
     return e && (0, u.jsx)(k.n, { children: i.map((a) => (0, u.jsx)(k.K, { className: (0, r.A)('ma-definition-of-done', a && `ma-definition-of-done--${(0, j.fX)(a.title)}`), heading: a ? `${a.title} - ${a.progress.value} van ${a.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(b._, { children: a.tasks.map(({ checked: e, name: a, id: t }) => (0, u.jsx)(b.Z, { headingLevel: n + 1, checked: e, heading: a, description: (0, j.qZ)(t) }, t)) }), (0, u.jsx)(t.fz, { children: (0, u.jsxs)(t.N_, { href: `${a.url}?filterQuery=${e.title}`, children: [a.title, ' projectbord op GitHub'] }) })] }) }, a.title)) });
    },
            ...
            ? (0, u.jsx)(
               d.Z,
               {
                ...
                description: (0, u.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, u.jsxs)(l.f, { children: [(0, u.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(t.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, u.jsxs)('div', {
                   children: [
                  ...
                  g.length > 0 && g.map(({ frameworkName: e, tasks: a }) => (0, u.jsxs)('section', { children: [(0, u.jsxs)(i.DZ, { level: Math.min(n + 2, 6), children: [r, ' in ', e] }), (0, u.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, u.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               o.Zp,
               {
                ...
                children: (0, u.jsxs)(o.Wu, {
                 children: [
                  ...
                  (0, u.jsxs)(t.fz, { children: [(0, u.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(t.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  ...
                  g.length > 0 && (0, u.jsx)(u.Fragment, { children: g.map(({ frameworkName: e, tasks: a }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(t.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, u.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, u.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => i, KF: () => u, mJ: () => p, VZ: () => T, cR: () => w, Pv: () => b, qZ: () => r, kD: () => v, QQ: () => N, B2: () => m, Pc: () => o, f4: () => s, GT: () => f, fX: () => l, eQ: () => k, B_: () => x, o_: () => j });
