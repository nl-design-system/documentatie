 ...
 [59797],
 {
  ...
  58639(e, n, o) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: g = !0, children: f, container: x = 'document', language: y, designTokens: j }) => {
    ...
    let R = u.Fragment;
    return (
     'paragraph' === x ? (R = v) : 'document' === x ? (R = m) : 'surface' === x && (R = b),
     (0, h.jsxs)('div', {
      className: (0, l.A)('nlds-canvas'),
      children: [
       k && (0, h.jsx)('div', { className: (0, l.A)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: j, children: (0, h.jsx)(R, { children: (0, h.jsx)(r.v$, { children: k }) }) }) }),
       g &&
        (0, h.jsx)('div', {
