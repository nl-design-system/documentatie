(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [85781],
 {
  ...
  94443: (e, t, n) => {
   ...
   const v = (e) => {
     ...
     const s = t && t.projects.filter((e) => f.e9.includes(e.id)),
      i = s && f.e9.map((e) => s.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, d.jsx)(r.a2, {
       appearance: '',
       sections: i.map((e) => ({
        className: (0, o.Z)('definition-of-done', e && `definition-of-done--${(0, f.mA)(e.title)}`),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, d.jsx)(y, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(k, { headingLevel: n + 1, checked: t, title: r, description: (0, f.Q6)(o) }, o);
            }),
           }),
    ...
    A = (e) => {
     let { component: t, headingLevel: n } = e;
     const o = t && t.projects.filter((e) => !f.e9.includes(e.id));
     return t && o.length
      ? (0, d.jsx)(m.um, {
         appearance: 'large',
               ...
               s.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: s.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: n + 2, children: [o, ' in ', t] }), (0, d.jsx)(r.Mc, { children: s.map((e) => (0, d.jsxs)(r.k7, { href: e.value, children: [(0, d.jsx)(h, { brand: e.brand }), ' ', e.description] }, e.id)) })] });
                 }),
                }),
              ],
             }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => c, Q6: () => s, U: () => a, e9: () => i, mA: () => o, ps: () => d });
   const r = { UNKNOWN: 'Todo', HELP_WANTED: 'Help Wanted', COMMUNITY: 'Community', CANDIDATE: 'Candidate', HALL_OF_FAME: 'Hall of fame' },
    ...
    a = (e) => Array.from(new Set(e.projects.flatMap((e) => l(e)))),
    d = (e) => {
     const t = l(e),
      n = ((e) => {
       const t = e.tasks.find((e) => {
