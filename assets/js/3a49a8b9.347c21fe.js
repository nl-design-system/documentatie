 ...
 [3407],
 {
  15295: (e, n, t) => {
   ...
   const c = { title: "Checkbox group", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Checkbox group", pagination_label: "Checkbox group", description: "UX richtlijnen voor Checkbox group component", slug: "/checkbox-group", tags: ["Unknown"] },
    s = "Checkbox group",
    l = { id: "componenten/build/checkbox-group", title: "Checkbox group", description: "UX richtlijnen voor Checkbox group component", source: "@site/docs/componenten/build/checkbox-group.mdx", sourceDirName: "componenten/build", slug: "/checkbox-group", permalink: "/checkbox-group", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/checkbox-group.mdx", tags: [{ label: "Unknown", permalink: "/tags/unknown" }], version: "current", frontMatter: { title: "Checkbox group", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Checkbox group", pagination_label: "Checkbox group", description: "UX richtlijnen voor Checkbox group component", slug: "/checkbox-group", tags: ["Unknown"] }, sidebar: "componenten", previous: { title: "Character count", permalink: "/character-count" }, next: { title: "Checkbox", permalink: "/checkbox" } },
    r = {},
    a = [
