 ...
 [94730],
 {
  ...
  43599: (e, n, l) => {
   ...
   const g = (e) => {
    ...
    let E = u.Fragment;
    return (
     'paragraph' === k ? (E = p) : 'document' === k ? (E = j) : 'surface' === k && (E = b),
     (0, m.jsxs)('div', {
      className: (0, t.Z)('nlds-canvas'),
      children: [
       _ && (0, m.jsx)('div', { className: (0, t.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, m.jsx)(E, { children: (0, m.jsx)(r.pu, { children: _ }) }) }) }),
       v &&
        (0, m.jsx)('div', {
