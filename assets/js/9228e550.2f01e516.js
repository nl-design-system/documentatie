  ...
  21034(e, n, a) {
   ...
   const b = ({ component: e, headingLevel: n }) => {
    ...
    k = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: s && (0, d.jsx)(u.D, { state: s }), children: e.title }), (0, d.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(s) && (0, d.jsx)(x.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    w = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
