(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [40284],
 {
  ...
  86678: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => _, component: () => M, contentTitle: () => D, default: () => O, description: () => F, frontMatter: () => N, issueNumber: () => Z, metadata: () => L, title: () => P, toc: () => S });
   var r = n(52676),
    i = n(40139),
    o = n(65739),
    s = n(93514);
   ...
   function B(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(R.Rv, { component: M, headingLevel: 1, description: F }),
      '\n',
      (0, r.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, r.jsx)(R.cN, { component: M, headingLevel: 3 }),
      '\n',
      (0, r.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, r.jsx)(R.W, { component: M, headingLevel: 3 }),
      '\n',
      ...
      '\n',
      (0, r.jsx)(R.vM, { component: M, headingLevel: 3 }),
     ],
    });
   }
   function O(e = {}) {
  ...
  94443: (e, t, n) => {
   ...
   const k = (e) => {
          ...
          children: [
           (0, d.jsx)(b, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(v, { headingLevel: n + 1, checked: t, title: r, description: (0, f.Q6)(i) }, i);
            }),
           }),
               ...
               o.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: o.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: n + 2, children: [i, ' in ', t] }), (0, d.jsx)(r.Mc, { children: o.map((e) => (0, d.jsxs)(r.k7, { href: e.value, children: [(0, d.jsx)(h, { brand: e.brand }), ' ', e.description] }, e.id)) })] });
                 }),
                }),
              ],
             }),
    ...
    A = (e) => {
     ...
     const o = t && f.$3[t.relayStep];
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(j.V, { level: n, suffix: o && (0, d.jsx)(m.y, { state: o }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => a, Q6: () => o, U: () => l, e9: () => s, mA: () => i, ps: () => d });
