...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [33990],
 {
  ...
  80287: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => b, contentTitle: () => m, default: () => v, frontMatter: () => u, metadata: () => h, toc: () => g });
   var o = l(52676),
    s = l(24785),
    t = l(98480),
    r = l(91050);
  ...
  98480: (e, n, l) => {
   ...
   const v = (e) => {
    ...
    let F = d.Fragment;
    return (
     'paragraph' === j ? (F = b) : 'document' === j ? (F = g) : 'surface' === j && (F = _),
     (0, h.jsxs)('div', {
    ...
    return (
     ...
     (0, r.jsx)(s.y$, {
      ...
      children: (e) => {
       ...
       return (0, r.jsx)(o.dn, { tabIndex: 0, style: l, children: s.map((e, l) => (0, r.jsxs)('span', { ...t({ line: e }), children: [n && (0, r.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, r.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const u = 'Doen',
     ...
     h = p ? 'figure' : 'div',
     b = p ? 'figcaption' : 'div';
    return (0, i.jsxs)(h, { className: (0, r.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(b, { className: (0, r.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(t.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, i.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: a['nlds-guideline__title'], children: m })] }), (0, i.jsx)(t.nv, { children: n })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(t.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, i.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: a['nlds-guideline__title'], children: u })] }), (0, i.jsx)(t.nv, { children: n })] }), c] }), (0, i.jsx)('div', { className: (0, r.Z)(a['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => a, a: () => r });
