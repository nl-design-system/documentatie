...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [12421],
 {
  ...
  37214: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => g, contentTitle: () => p, default: () => b, frontMatter: () => u, metadata: () => v, toc: () => _ });
   var t = l(52676),
    o = l(24785),
    s = l(98480),
    a = l(91050);
   function i(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(a.X, { appearance: 'do', title: 'Geef de mogelijkheid korte en lange teksten in te vullen.', children: (0, t.jsx)(s.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.label, { for: 'woonplaats1', children: 'Uw woonplaats' }), (0, t.jsx)(n.input, { id: 'woonplaats1', type: 'text', name: 'woonplaats', autocomplete: 'address-level2' })] }) }) }), '\n', (0, t.jsx)(a.X, { appearance: 'dont', title: 'Limiteer het maximaal aantal in te voeren tekens.', description: 'Mensen uit Gasselterboerveenschemond of Westerhaar-Vriezenveensewijk willen ook graag hun woonplaats invoeren.', children: (0, t.jsx)(s.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.label, { for: 'woonplaats2', children: 'Uw woonplaats' }), (0, t.jsx)(n.input, { id: 'woonplaats2', type: 'text', name: 'email', maxlength: '20', autocomplete: 'address-level2' })] }) }) }), '\n', (0, t.jsx)(a.X, { appearance: 'dont', title: 'Limiteer het minimaal aantal in te voeren tekens.', description: 'Jo, Bo en X willen ook graag hun voornaam invullen.', children: (0, t.jsx)(s.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.label, { for: 'voornaam1', children: 'Je voornaam' }), (0, t.jsx)(n.input, { id: 'voornaam1', type: 'text', name: 'voornaam', minlength: '3', autocomplete: 'given-name' })] }) }) })] });
   }
   function r(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
  ...
  98480: (e, n, l) => {
   ...
   const g = (e) => {
    let { children: n } = e;
    return (0, v.jsx)(t.Tg, { className: u['nlds-canvas__example-surface'], children: (0, v.jsx)(t.BB, { className: (0, o.Z)('utrecht-document--surface', u['nlds-canvas__example-document']), children: (0, v.jsx)(t.nv, { className: u['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   g.displayName = 'ParagraphContainer';
   const _ = (e) => {
    let { children: n } = e;
    return (0, v.jsx)(t.Tg, { className: u['nlds-canvas__example-surface'], children: (0, v.jsx)(t.BB, { className: (0, o.Z)('utrecht-document--surface', u['nlds-canvas__example-document']), children: n }) });
   };
   _.displayName = 'DocumentContainer';
   const h = (e) => {
    let { children: n } = e;
    return (0, v.jsx)(t.Tg, { className: u['nlds-canvas__example-surface'], children: n });
   };
   h.displayName = 'SurfaceContainer';
   const b = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: b = !1, displayCode: x = !0, children: y, container: j = 'document', language: f, designTokens: k } = e,
    ...
    let F = d.Fragment;
    return (
     'paragraph' === j ? (F = g) : 'document' === j ? (F = _) : 'surface' === j && (F = h),
     (0, v.jsxs)('div', {
      className: (0, o.Z)(u['nlds-canvas']),
      children: [
       w && (0, v.jsx)('div', { className: (0, o.Z)(u['nlds-canvas__example']), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, v.jsx)(F, { children: (0, v.jsx)(t.pu, { children: w }) }) }) }),
       x &&
        (0, v.jsx)('div', {
    ...
    return (
     ...
     (0, r.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)('span', { hidden: !0, id: v, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, r.jsx)(t.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': v, style: l, children: o.map((e, l) => (0, r.jsxs)('span', { ...s({ line: e }), children: [n && (0, r.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, r.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const d = (0, i.createContext)({}),
    m = (e) => {
     let { title: n, appearance: l, description: i, children: m, figure: u } = e;
     const p = { do: 'Doen', dont: 'Niet doen' },
      v = u ? 'figure' : 'div',
      g = u ? 'figcaption' : 'div';
     return (0, c.jsxs)(v, { className: (0, a.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(g, { className: (0, a.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: p.dont })] }), (0, c.jsx)(s.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: p.do })] }), (0, c.jsx)(s.nv, { children: n })] }), i] }), (0, c.jsx)('div', { className: (0, a.Z)(r['nlds-guideline__example']), children: (0, c.jsx)(d.Provider, { value: { title: n, type: p[l] }, children: m }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => i, a: () => a });
