 ...
 [56732],
 {
  ...
  12941(e, n, i) {
   ...
   const l = (e, n) => {
    ...
    h = ({ children: e, omitH1: n = !1, headingLevel: i = 1, baseUrl: r = '', components: l = {} }) => (0, s.jsx)(t.x, { components: { ...c(n, i), ...o(r), ...l }, children: e });
  },
  15042(e, n, i) {
   i.d(n, { p: () => s });
   var t = i(13526),
  ...
  37536(e, n, i) {
   (i.r(n), i.d(n, { assets: () => v, contentTitle: () => j, default: () => w, frontMatter: () => m, metadata: () => t, toc: () => k }));
   const t = JSON.parse('{"id":"wcag/2.5.06","title":"WCAG-succescriterium 2.5.6 Input gelijktijdige invoermechanismen","description":"Geef een gebruiker de mogelijkheid om de website of app te gebruiken met alle beschikbare invoermanieren die op hun platform beschikbaar zijn. Behalve wanneer een bepaalde manier van invoeren essentieel of vereist is.","source":"@site/docs/wcag/2.5.06.mdx","sourceDirName":"wcag","slug":"/wcag/2.5.6","permalink":"/wcag/2.5.6","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.5.06.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 2.5.6 Input gelijktijdige invoermechanismen","title_sm":"2.5.6 Input gelijktijdige invoermechanismen","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"2.5.6 Input gelijktijdige invoermechanismen","pagination_label":"WCAG-succescriterium 2.5.6 Input gelijktijdige invoermechanismen","description":"Geef een gebruiker de mogelijkheid om de website of app te gebruiken met alle beschikbare invoermanieren die op hun platform beschikbaar zijn. Behalve wanneer een bepaalde manier van invoeren essentieel of vereist is.","slug":"2.5.6","keywords":["WCAG","AAA","bedienbaar","input modaliteiten","operable","input modalities","concurrent input mechanisms"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)","permalink":"/wcag/2.5.5"},"next":{"title":"WCAG-succescriterium 2.5.7 Sleepbewegingen","permalink":"/wcag/2.5.7"}}');
   var r = i(86070),
    s = i(18439),
    l = i(12941),
    a = i(87491),
