...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [33710],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => h, VZ: () => L, cR: () => w, Pv: () => j, qZ: () => o, kD: () => k, B2: () => m, Pc: () => l, f4: () => s, GT: () => f, fX: () => a, eQ: () => v, B_: () => x, o_: () => b, Rc: () => D });
  ...
  99063(e, n, t) {
   (t.r(n), t.d(n, { assets: () => S, component: () => T, contentTitle: () => A, default: () => _, description: () => C, frontMatter: () => F, issueNumber: () => H, metadata: () => i, title: () => N, toc: () => R }));
   ...
   function f(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, a.R)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Componenten en elementen die niet interactief zijn, komen niet voor in de normale toetsenbord-focusvolgorde van de pagina.' }), '\n', (0, r.jsx)(n.p, { children: 'Een uitzondering geldt voor situaties waarbij een interactief component een Skip Link of een Link in een zij-navigatie, de bezoeker direct naar de component of het element stuurt.' }), '\n', (0, r.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: (0, r.jsx)(n.a, { href: '/richtlijnen/formulieren/toetsenbord/', children: 'Toetsenbordtoegankelijkheid' }) }), '\n'] })] });
   }
   var D = t(24838);
   const w = [
