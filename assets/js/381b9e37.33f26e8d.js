 ...
 [55335],
 {
  ...
  1842(e, t, n) {
   ...
   const p = ({ children: e }) => (0, u.jsx)('ul', { className: 'task-list', children: e }),
    m = ({ checked: e, children: t, title: n, description: r, headingLevel: o = 3 }) => (0, u.jsxs)('li', { className: (0, c.A)('task-list-item'), children: [(0, u.jsxs)('div', { className: (0, c.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, u.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, u.jsx)(y.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [n ? (0, u.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: o, children: n }) : null, r, t] })] });
   var g = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => g.f4.includes(e.id)),
      o = n && g.f4.map((e) => n.find((t) => t.id === e)).filter(Boolean);
     return e && (0, u.jsx)(r.If, { sections: o.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, g.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(m, { headingLevel: t + 1, checked: e, title: n, description: (0, g.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
                 ...
                 children: (0, u.jsx)(r.dk, {
                  links: h
                   ...
                   .map((e) => {
                    ...
                    return { children: t.desciption, icon: (0, u.jsx)(o.r, { brand: t.brand }), href: e.value };
                   }),
                 }),
                }),
               s.length > 0 && (0, u.jsx)(u.Fragment, { children: s.map(({ frameworkName: e, tasks: n }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, u.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, u.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  3222(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => p, contentTitle: () => u, default: () => v, description: () => d, frontMatter: () => a, illustration: () => j, issueNumber: () => y, metadata: () => r, title: () => h, toc: () => m }));
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => p, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => i, kD: () => k, B2: () => j, Pc: () => a, f4: () => s, GT: () => f, fX: () => o, eQ: () => b, B_: () => v, o_: () => g, Rc: () => x });
