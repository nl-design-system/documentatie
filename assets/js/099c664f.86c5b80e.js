 ...
 [54916],
 {
  ...
  24703(e, n, t) {
   ...
   const l = (e, n) => {
    ...
    o = (e) => ({ img: ({ src: n, ...t }) => (0, s.jsx)('img', { ...t, src: l(e, n), className: 'utrecht-img utrecht-img--fit' }) }),
    c = (e, n) => {
     if (e) {
      const e = { ...a[n - 1] };
      return ((e.h1 = () => null), e);
    ...
    d = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: r = '', components: l = {} }) => (0, s.jsx)(i.x, { components: { ...c(n, t), ...o(r), ...l }, children: e });
  },
  25431(e, n, t) {
   t.d(n, { Ay: () => a, RM: () => s });
   var i = t(86070),
  ...
  66119(e, n, t) {
   ...
   const l = (0, t(30758).forwardRef)(({ aside: e, children: n, className: t, purpose: r, ...l }, a) => {
    const o = { ...l, ref: a, className: s('utrecht-note', { [`utrecht-note--${r}`]: r }, t) };
