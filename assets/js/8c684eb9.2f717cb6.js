   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: j = !0, children: y, container: b = 'document', language: x, designTokens: f }) => {
    ...
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       k && (0, m.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(R, { children: (0, m.jsx)(o.v$, { children: k }) }) }) }),
       j &&
        (0, m.jsx)('div', {
