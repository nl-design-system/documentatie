/*! For license information please see ffcf9766.49a2cda0.js.LICENSE.txt */
'use strict';
  ...
  26877(e, n, a) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
    ...
    N = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(m.p, { level: n, suffix: r && (0, u.jsx)(c.D, { state: r }), children: e.title }), (0, u.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(r) && (0, u.jsx)(v.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    w = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
