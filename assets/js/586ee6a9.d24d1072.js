  ...
  70348(e, n, l) {
   ...
   const a = ({ className: e, ...n }) => {
    ...
    i = ({ className: e, classNamePanel: n, label: l, heading: a, headingLevel: i, headingApperance: c, ...d }) => {
     const m = (0, s.A)('utrecht-accordion__section', e),
      u = (0, s.A)('utrecht-accordion__panel', n);
     return (0, t.jsxs)('details', { className: m, ...d, children: [(0, t.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, t.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, t.jsx)('span', { className: 'nl-button__icon-start', children: (0, t.jsx)(o.A, {}) }), (0, t.jsxs)('span', { className: 'nl-button__label', children: [a && (0, t.jsx)(r.D, { level: i, appearance: c, children: a }), l] })] }) }), (0, t.jsx)('div', { className: u, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => x });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       ...
       return (0, v.jsxs)('div', { className: (0, r.A)('ma-canvas-astro', l), children: [(0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }), (0, v.jsx)(g.n, { children: (0, v.jsx)(g.K, { label: 'Code', children: (0, v.jsx)('pre', { className: 'language-html nl-code-block', children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: t } }) }) }) })] });
      }
