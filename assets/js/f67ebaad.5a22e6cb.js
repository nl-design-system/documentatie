...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [33527],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => r, KF: () => h, mJ: () => u, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => a, kD: () => b, B2: () => g, Pc: () => l, f4: () => o, GT: () => _, fX: () => s, eQ: () => v, B_: () => x, o_: () => j, Rc: () => k });
  ...
  37131(e, n, t) {
   ...
   const u = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(h.p, { level: n, suffix: r && (0, d.jsx)(m.D, { state: r }), children: e.title }), (0, d.jsx)(i.fz, { lead: !0, children: t })] });
    },
    b = ({ component: e }) => {
     const n = (e && u[e.title]) || [];
  ...
  67970(e, n, t) {
   ...
   const o = ({ state: e }) => {
    const n = (0, s.fX)(e);
    return (0, a.jsx)(i.KE, { className: (0, r.A)('estafette-badge', n && `estafette-badge--${n}`), children: e });
   };
  },
  72642(e, n, t) {
   t.d(n, { p: () => s });
  ...
  90495(e, n, t) {
   ...
   var i = t(46447),
    r = t(13526),
    s = t(86070);
   const a = ({ background: e, children: n, className: t, ...i }) => (0, s.jsx)('div', { className: (0, r.A)('card__illustration', e && `card__illustration--${e}`, t), ...i, children: n }),
