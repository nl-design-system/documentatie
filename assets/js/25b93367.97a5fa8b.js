 ...
 [98634],
 {
  29416: (e, t, n) => {
   ...
   const s = { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: "Biedt de mogelijkheid om naar andere pagina's of secties te navigeren.", slug: '/link', sidebar_custom_props: { illustration: 'LinkSketch' } },
    a = void 0,
    l = { id: 'componenten/link/index', title: 'Link', description: "Biedt de mogelijkheid om naar andere pagina's of secties te navigeren.", source: '@site/docs/componenten/link/index.mdx', sourceDirName: 'componenten/link', slug: '/link', permalink: '/link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: "Biedt de mogelijkheid om naar andere pagina's of secties te navigeren.", slug: '/link', sidebar_custom_props: { illustration: 'LinkSketch' } }, sidebar: 'componenten', previous: { title: 'Legend', permalink: '/legend' }, next: { title: 'Link list', permalink: '/link-list' } },
    u = {},
    d = [
