 ...
 [86792],
 {
  ...
  41757: (e, n, i) => {
   ...
   const a = (e) => {
    ...
    return (0, t.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${a}`, i), ...l, children: [(0, t.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: n }), s && (0, t.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
   };
  },
  57716: (e, n, i) => {
   i.d(n, { U: () => c });
   ...
   const s = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, a.jsx)(r.Z, { components: { ...d(i, t), ...o(s), ...l }, children: n });
    };
  },
  46364: (e, n, i) => {
   i.d(n, { j: () => s });
