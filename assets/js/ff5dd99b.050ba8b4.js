 ...
 [10452],
 {
  ...
  17889(e, t, n) {
   ...
   var p = n(35193),
    ...
    b = n(79532),
    w = n(30758);
   const A = { color: p.A, dimension: g.A, fontFamilies: k.A, fontSizes: y.A, fontWeights: v.A, lineHeights: x.A, other: f.A, textDecoration: b.A },
       ...
       children: [
        ...
        (0, j.jsx)(o.BF, {
         children: n.map((t) => {
          const n = (0, i.o_)(t),
           c = (0, i.eQ)(e, t).$type;
          return (0, j.jsxs)(o.Hj, { children: [(0, j.jsx)(o.nA, { children: (0, j.jsx)(r.C, { children: (0, j.jsx)(o.kf, { children: n }) }) }), (0, j.jsx)(o.nA, { children: (0, j.jsxs)(s.K, { children: [(0, j.jsx)(z, { type: c }), ' ', c] }) })] }, n);
         }),
        }),
       ],
      }),
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => u, mJ: () => p, VZ: () => A, cR: () => w, Pv: () => g, qZ: () => o, kD: () => x, B2: () => j, Pc: () => a, f4: () => c, GT: () => f, fX: () => i, eQ: () => v, B_: () => y, o_: () => k, Rc: () => b });
  ...
  85825(e, t, n) {
   ...
   const y = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, l.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, k.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(g, { headingLevel: t + 1, checked: e, title: n, description: (0, k.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
