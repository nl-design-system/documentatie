 ...
 [76352],
 {
  15638(e, n, o) {
   ...
   const d = (0, l.createContext)({}),
    c = ({ title: e, appearance: n, description: o, children: l, figure: c }) => {
     const p = { do: 'Doen', dont: 'Niet doen' },
      k = c ? 'figure' : 'div',
      u = c ? 'figcaption' : 'div';
     return (0, s.jsxs)(k, { className: (0, i.A)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, s.jsxs)(u, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(r.fz, { className: (0, i.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, s.jsx)(t.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: p.dont })] }), (0, s.jsx)(r.fz, { children: e })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(r.fz, { className: (0, i.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, s.jsx)(a.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: p.do })] }), (0, s.jsx)(r.fz, { children: e })] }), o] }), (0, s.jsx)('div', { className: 'nlds-guideline__example', children: (0, s.jsx)(d.Provider, { value: { title: e, type: p[n] }, children: l }) })] });
    };
  },
  18439(e, n, o) {
   o.d(n, { R: () => i, x: () => l });
  ...
  58639(e, n, o) {
   ...
   const m = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: m = !0, children: j, container: b = 'document', language: x, designTokens: y }) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await c.Ay.format(z, { parser: x, plugins: [i.A, l.Ay, s.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [z]);
    const C = (0, p.useId)();
  ...
  69284(e, n, o) {
   ...
   function d({ lineNumber: e, syntax: n, textContent: o, trim: d }) {
    ...
    const { title: p, type: k } = (0, r.useContext)(i.x),
     u = (0, r.useId)();
    return (d && (c = c.trim()), (0, s.jsx)(t.f4, { theme: l, code: c, language: n || '', children: ({ style: n, tokens: o, getLineProps: t, getTokenProps: r }) => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: u, children: ['codevoorbeeld ', k ? `\u201c${k}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, s.jsx)(a.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': u, style: n, children: o.map((n, o) => (0, s.jsxs)('span', { ...t({ line: n }), children: [e && (0, s.jsx)('span', { children: o + 1 }), n.map((e, n) => (0, s.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, o)) })] }) }));
   }
  },
  78734(e, n, o) {
   o.d(n, { Ay: () => l, RM: () => r });
