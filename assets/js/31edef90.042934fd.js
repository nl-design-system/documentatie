 ...
 [25974],
 {
  ...
  39906(e, n, l) {
   ...
   function a(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, i.jsx)(d.$, { appearance: 'do', title: 'Leg uit waarom een datum wordt afgekeurd.', children: (0, i.jsx)(s.H, { language: 'html', children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('p', { children: (0, i.jsx)('label', { htmlFor: 'passport-validity', children: 'Geldig tot' }) }), (0, i.jsx)('p', { id: 'description-passport-validity', children: 'Invoerfout: De geldigheidsdatum van uw paspoort moet in de toekomst liggen.' }), (0, i.jsx)('p', { children: (0, i.jsx)('input', { id: 'passport-validity', type: 'text', name: 'passport-validity', 'aria-describedby': 'description-passport-validity' }) })] }) }) }), '\n', (0, i.jsx)(d.$, { appearance: 'do', title: 'Geef een voorbeeld van wat er verwacht wordt.', children: (0, i.jsx)(s.H, { language: 'html', children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('p', { children: (0, i.jsx)('label', { htmlFor: 'email', children: 'E-mail' }) }), (0, i.jsx)('p', { id: 'description-email', children: 'Invoerfout: Vul een geldig e-mailadres in, bijvoorbeeld naam@voorbeeld.nl.' }), (0, i.jsx)('p', { children: (0, i.jsx)('input', { id: 'email', type: 'email', name: 'email', 'aria-describedby': 'description-email' }) })] }) }) }), '\n', (0, i.jsx)(d.$, { appearance: 'dont', title: 'Alleen beschrijven dat het veld verplicht is, zonder toelichting dat er informatie mist of aan welke voorwaarde niet is voldaan.', children: (0, i.jsx)(s.H, { language: 'html', children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('p', { children: (0, i.jsx)('label', { htmlFor: 'passport-validity-2', children: 'Geldig tot' }) }), (0, i.jsx)('p', { id: 'description-passport-validity-2', children: 'Invoerfout: Dit veld is verplicht.' }), (0, i.jsx)('p', { children: (0, i.jsx)('input', { id: 'passport-validity-2', 'aria-invalid': 'false', type: 'text', name: 'passport-validity-2', 'aria-describedby': 'description-passport-validity-2' }) })] }) }) })] });
   }
   function c(e = {}) {
   ...
   function x(e = {}) {
    const { wrapper: n } = { ...(0, r.R)(), ...e.components };
    return n ? (0, i.jsx)(n, { ...e, children: (0, i.jsx)(f, { ...e }) }) : f();
   }
  },
  58639(e, n, l) {
   l.d(n, { H: () => v });
   var o = l(69284),
    ...
    p = l(31186),
    m = l(86070);
   const h = ({ children: e }) => (0, m.jsx)(i.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(i.yo, { className: (0, r.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(i.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   h.displayName = 'ParagraphContainer';
   const g = ({ children: e }) => (0, m.jsx)(i.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(i.yo, { className: (0, r.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const v = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: v = !0, children: y, container: f = 'document', language: x, designTokens: b }) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await c.Ay.format(w, { parser: x, plugins: [t.A, s.Ay, d.Ay, a.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      z(e);
     })();
    }, [w]);
    const C = (0, u.useId)();
    ...
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       k && (0, m.jsx)('div', { className: (0, r.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: b, children: (0, m.jsx)(D, { children: (0, m.jsx)(i.v$, { children: k }) }) }) }),
       v &&
        (0, m.jsx)('div', {
  ...
  69284(e, n, l) {
   ...
   function a({ lineNumber: e, syntax: n, textContent: l, trim: a }) {
    ...
    const { title: u, type: p } = (0, r.useContext)(t.x),
     m = (0, r.useId)();
    return (a && (c = c.trim()), (0, d.jsx)(i.f4, { theme: s, code: c, language: n || '', children: ({ style: n, tokens: l, getLineProps: i, getTokenProps: r }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, d.jsx)(o.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': m, style: n, children: l.map((n, l) => (0, d.jsxs)('span', { ...i({ line: n }), children: [e && (0, d.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, d.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  78734(e, n, l) {
   l.d(n, { Ay: () => s, RM: () => r });
