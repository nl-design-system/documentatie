 ...
 [76401],
 {
  ...
  29659: (e, n, t) => {
   ...
   var r = t(16167),
    ...
    s = t(52676);
   const c = (e) => {
     let { title: n, sc: t, status: i, component: c, headingLevel: a = 4 } = e;
     const l = o.fg.get(t),
      d = l ? `${t} ${l.nl?.title}` : t;
     return (0, s.jsxs)('div', { className: 'component-criteria-section', children: [(0, s.jsx)(r.X6, { appearance: 'utrecht-heading-4', level: a, className: 'component-criteria-section__heading', children: n }), (t || i) && (0, s.jsxs)('dl', { className: 'component-criteria-section__dl', children: [t && (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)('dt', { className: 'component-criteria-section__dt', children: 'WCAG' }), (0, s.jsx)('dd', { className: 'component-criteria-section__dd', children: (0, s.jsx)(r.rU, { href: `/wcag/${t}`, children: d }) })] }), i && (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)('dt', { className: 'component-criteria-section__dt', children: 'Status' }), (0, s.jsx)('dd', { className: 'component-criteria-section__dl', children: i })] })] }), c] });
    },
    a = (e) => {
     let { testCategory: n, items: t } = e;
     return (0, s.jsx)(i.a2, { sections: [{ className: 'utrecht-accordion--nlds-subtle', headingLevel: 3, expanded: !1, label: (0, s.jsx)('span', { children: n }), body: t.map((e, n) => (0, s.jsx)(c, { ...e }, n)) }] });
    };
  },
  8657: (e, n, t) => {
   'use strict';
          ...
          children: [
           (0, d.jsx)(k, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(b, { headingLevel: t + 1, checked: n, title: r, description: (0, x.Q6)(o) }, o);
            }),
           }),
            ...
            m.Zb,
            {
             ...
             children: (0, d.jsxs)(m.aY, {
              children: [
               ...
               (c.length > 0 || i.length > 0) && (0, d.jsx)(r.X6, { level: t + 1, children: 'Snel aan de slag' }),
               c.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               i.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: i.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: t + 2, children: [o, ' in ', n] }), (0, d.jsx)(r.Mc, { links: i.map((e) => ({ children: e.description, icon: (0, d.jsx)(h, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
  ...
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, $e: () => j, BA: () => c, Ee: () => d, Q6: () => i, U: () => m, Yr: () => w, d: () => u, e9: () => s, fO: () => v, mA: () => o, ps: () => g, qU: () => k, s0: () => f, zP: () => p });
     ...
     return n.map((n) => {
      const r = e.tasks
       ...
       .map((r) => {
        ...
        return { brand: c.toLowerCase(), name: o, id: i, value: s, description: a };
       });
