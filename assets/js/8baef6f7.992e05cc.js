...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [41102],
 {
  ...
  15214(e, n, t) {
   (t.r(n), t.d(n, { assets: () => H, component: () => O, contentTitle: () => I, default: () => V, description: () => P, frontMatter: () => W, issueNumber: () => B, metadata: () => i, title: () => _, toc: () => E }));
  ...
  21034(e, n, t) {
   ...
   const k = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, g.jsx)(b.n, { children: r.map((t) => (0, g.jsx)(b.K, { className: (0, a.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, f.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(j._, { children: t.tasks.map(({ checked: e, name: t, id: i }) => (0, g.jsx)(j.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, f.qZ)(i) }, i)) }), (0, g.jsx)(i.fz, { children: (0, g.jsxs)(i.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
               ...
               c.Z,
               {
                ...
                description: (0, g.jsxs)('div', {
                 ...
                 children: [
                  ...
                  (0, g.jsxs)('div', {
                   children: [
                    (h.length > 0 || d.length > 0) && (0, g.jsx)(r.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    h.length > 0 &&
                     (0, g.jsx)(i.dk, {
                      links: h
                  ...
                  d.length > 0 && d.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)('section', { children: [(0, g.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, g.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, g.jsxs)(l.Wu, {
                 children: [
                  ...
                  (h.length > 0 || d.length > 0) && (0, g.jsx)(i.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  h.length > 0 &&
                   (0, g.jsx)(g.Fragment, {
                  ...
                  d.length > 0 && (0, g.jsx)(g.Fragment, { children: d.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)(g.Fragment, { children: [(0, g.jsxs)(i.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, g.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    y = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(p.p, { level: n, suffix: r && (0, g.jsx)(h.D, { state: r }), children: e.title }), (0, g.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(r) && (0, g.jsx)(w.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    T = ({ component: e }) => {
     const n = (e && v[e.title]) || [];
         ...
         children: [
          ...
          (0, m.jsx)('div', {
           children: (0, m.jsxs)(m.Fragment, {
            children: [
             (0, m.jsxs)(s.f, { role: 'status', children: [v, ' van de ', j, ' items zijn nu zichtbaar.'] }),
             v < j
              ? (0, m.jsx)(l.$, {
                 purpose: 'secondary',
                 onClick: () => {
