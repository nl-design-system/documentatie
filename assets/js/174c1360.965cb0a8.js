 ...
 [4206],
 {
  ...
  43599: (e, n, t) => {
   ...
   const g = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (Z = await d.ZP.format(F, { parser: x, plugins: [i.Z, s.ZP, c.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(Z);
     })();
    }, [F]);
    const P = (0, u.useId)();
    let D = u.Fragment;
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       _ && (0, m.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(D, { children: (0, m.jsx)(l.pu, { children: _ }) }) }) }),
       y &&
        (0, m.jsx)('div', {
