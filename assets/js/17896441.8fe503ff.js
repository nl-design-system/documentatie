 ...
 [18401, 83249],
 {
  ...
  24456(e, t, n) {
   ...
   const l = ({ children: e, ...t }) => {
    ...
    i = ({ className: e, boxContent: t, ...n }) => (0, r.jsx)(l, { className: (0, s.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': t }, e), ...n });
  },
  24703(e, t, n) {
   'use strict';
   n.d(t, { o: () => d });
  ...
  28369(e, t, n) {
   ...
   function c({ lineNumber: e, syntax: t, textContent: n, trim: c }) {
    let d = n;
    const { title: m, type: h } = (0, r.useContext)(l.x),
     g = (0, r.useId)();
  ...
  49431(e, t, n) {
   ...
   var m = n(46447),
    ...
    g = n(13526),
    p = n(82110);
   const u = (e, t) => e.reduce((e, n) => ('link' === n.type ? (t.includes(n.docId) ? e : [...e, n]) : 'category' === n.type ? [...e, { ...n, items: u(n.items, t) }] : e), []),
    w = ({ excludeDocIDs: e = [], className: t, ...n }) => {
     const s = (0, h.$S)();
     return (0, i.jsx)('div', { ...n, className: (0, g.A)('margin-top--lg', t), children: (0, i.jsx)(p.A, { items: u(s.items, e) }) });
    };
   var A = n(25557),
    f = n(33617),
    y = n(79447),
    ...
    k = n(3387),
    G = n(87856);
   const W = ({ name: e, description: t, relayStep: n, headingLevel: s = 2, href: o, frameworkNames: r }) => {
     return (0, i.jsxs)(v.Zp, { appearance: 'large', className: (0, g.A)('ma-component-card', !n && 'ma-component-card--suggestion'), component: 'section', children: [(0, i.jsx)(v.Fu, { children: (0, i.jsx)(k.s, { relayStep: n, description: `Schets van de ${e} component`, name: e }) }), (0, i.jsxs)(v.Wu, { children: [(0, i.jsxs)('div', { children: [(0, i.jsx)(j.D, { level: s, className: 'ma-component-card__title', children: e }), n && (0, i.jsx)('p', { children: (0, i.jsx)(G.D, { state: n }) }), t && (0, i.jsx)(C.f, { children: t }), r && (0, i.jsx)(m._Q, { children: r.map((e) => (0, i.jsx)(m.KE, { children: e }, e)) })] }), o && (0, i.jsx)(C.f, { children: (0, i.jsxs)(T.N, { className: 'utrecht-link', to: ((l = o), 'string' == typeof l && !1 === l.endsWith('/') ? `${l}/` : l), children: ['Bekijk ', (0, i.jsx)('span', { className: 'w', children: e }), ' component'] }) })] })] });
     var l;
    },
    N = () => {
     const e = 'framework',
      ...
      a = (e) => e.title && y.find(({ title: t }) => t && (0, x.Pc)(t) === (0, x.Pc)(e.title)),
      c = n.items
       ...
       .map((e) => ({ ...e, ...a(e) })),
      [d, g] = (0, l.useState)(c),
      [p, u] = (0, l.useState)(r.get(t)?.split(',') || []),
      [w, T] = (0, l.useState)(r.get(e)?.split(',') || []),
      j = (0, x.KF)(c);
     return (
      (0, l.useEffect)(() => {
       (g(c.filter((e) => !p.length || p.some((t) => e.relayStep === t)).filter((e) => !w.length || w.some((t) => (0, x.B2)(e, t)))), p.length ? r.set(t, p.join(',')) : r.delete(t), w.length ? r.set(e, w.join(',')) : r.delete(e), o({ ...s, search: r.toString() }));
      }, [p, w]),
      (0, i.jsxs)(i.Fragment, {
       children: [
        (0, i.jsx)('div', {
         className: 'ma-filter-accordion',
         children: (0, i.jsx)(b.If, {
          sections: [
           {
            headingLevel: 2,
            expanded: r.size > 0,
                 ...
                 (0, i.jsxs)(
                  m.zB,
                  {
                   ...
                   children: [
                    ...
                    (0, i.jsx)(m.lR, { htmlFor: e, children: (0, i.jsx)(G.D, { state: t }) }),
                   ],
                  },
                  e,
                 ),
        ...
        (0, i.jsxs)(b.fz, { role: 'status', id: 'filter-results', children: [d.length, ' van ', c.length, ' componenten zichtbaar'] }),
        0 === d.length &&
         (0, i.jsx)(b.fz, {
          children: (0, i.jsx)(b.bm, {
           onClick: () => {
        ...
        (0, i.jsx)(v.AC, {
         ...
         children: d.map(({ title: e, id: t, href: n, description: s }) => {
          const o = y.find((t) => t.title === e),
           r = o && x.bo[o.relayStep],
           l = (0, x.mJ)(o);
          return (0, i.jsx)(W, { name: e, headingLevel: 2, href: n, description: s, relayStep: r, frameworkNames: l }, t);
         }),
        }),
       ],
      })
   ...
   const _ = ({ children: e }) => (0, i.jsx)('ol', { className: 'nlds-anatomy-list', children: e }),
    ...
    L = ({ component: e, illustration: t }) => {
     ...
     return (0, i.jsx)(l.Suspense, { fallback: null, children: (0, i.jsxs)('figure', { className: (0, g.A)('ma-component-anatomy'), children: [t && (0, i.jsx)(t, { height: null, className: (0, g.A)('ma-component-anatomy__illustration') }), t && r && (0, i.jsx)('figcaption', { children: (0, i.jsx)(R.o, { omitH1: !0, headingLevel: 1, components: { ol: ({ children: e }) => (0, i.jsx)(_, { children: e }), li: ({ children: e }) => (0, i.jsx)(S, { children: e }) }, children: (0, i.jsx)(r, {}) }) })] }) });
    };
   var P = n(12086);
   const F = ({ title: e, sc: t, status: n, children: s, headingLevel: o = 4 }) => {
    ...
    M = ({ testCategory: e, children: t }) => (0, i.jsx)(b.If, { sections: [{ className: 'utrecht-accordion--nlds-subtle', headingLevel: 3, expanded: !1, label: (0, i.jsx)('span', { children: e }), body: t }] });
   var D = n(58876);
  ...
  51580(e, t, n) {
   var s = { './button-docs/docs/anatomy/anatomy.md': [72180, 72180], './code-block-docs/docs/anatomy/anatomy.md': [8161, 8161], './code-docs/docs/anatomy/anatomy.md': [36657, 36657], './color-sample-docs/docs/anatomy/anatomy.md': [76290, 76290], './data-badge-docs/docs/anatomy/anatomy.md': [87252, 87252], './heading-1-docs/docs/anatomy/anatomy.md': [68082, 68082], './heading-2-docs/docs/anatomy/anatomy.md': [53966, 53966], './heading-3-docs/docs/anatomy/anatomy.md': [98258, 98258], './heading-4-docs/docs/anatomy/anatomy.md': [50806, 50806], './heading-5-docs/docs/anatomy/anatomy.md': [16290, 16290], './heading-6-docs/docs/anatomy/anatomy.md': [64070, 64070], './heading-docs/docs/anatomy/anatomy.md': [20763, 20763], './link-docs/docs/anatomy/anatomy.md': [1067, 1067], './mark-docs/docs/anatomy/anatomy.md': [89677, 89677], './number-badge-docs/docs/anatomy/anatomy.md': [62849, 62849], './paragraph-docs/docs/anatomy/anatomy.md': [45043, 45043], './skip-link-docs/docs/anatomy/anatomy.md': [70019, 70019] };
   function o(e) {
    if (!n.o(s, e))
   ...
   const d = (0, a.createContext)({}),
    m = ({ title: e, appearance: t, description: n, children: a, figure: m }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      g = m ? 'figure' : 'div',
      p = m ? 'figcaption' : 'div',
      u = 'string' == typeof n ? (0, c.jsx)(i.oz, { components: { a: r.N_ }, children: n }) : n;
     return (0, c.jsxs)(g, { className: (0, l.A)('nlds-guideline', `nlds-guideline--${t}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(p, { className: 'nlds-guideline__description', children: ['dont' === t ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(r.fz, { className: (0, l.A)('nlds-guideline__badge', `nlds-guideline__badge--${t}`), children: [(0, c.jsx)(o.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, c.jsx)('span', { className: 'nlds-guideline__title', children: h.dont })] }), (0, c.jsx)(r.fz, { children: e })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(r.fz, { className: (0, l.A)('nlds-guideline__badge', `nlds-guideline__badge--${t}`), children: [(0, c.jsx)(s.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, c.jsx)('span', { className: 'nlds-guideline__title', children: h.do })] }), (0, c.jsx)(r.fz, { children: e })] }), u] }), (0, c.jsx)('div', { className: 'nlds-guideline__example', children: (0, c.jsx)(d.Provider, { value: { title: e, type: h[t] }, children: a }) })] });
    };
  },
  82110(e, t, n) {
   'use strict';
   ...
   function g({ className: e }) {
    const t = (0, s.$S)();
    return (0, a.jsx)(p, { items: t.items, className: e });
   }
   function p(e) {
  ...
  84471(e, t, n) {
   'use strict';
   n.d(t, { bo: () => o, KF: () => h, mJ: () => u, VZ: () => T, cR: () => v, Pv: () => w, qZ: () => l, kD: () => b, QQ: () => C, B2: () => g, Pc: () => a, f4: () => i, GT: () => x, fX: () => r, eQ: () => y, B_: () => f, o_: () => A });
   ...
   const v = () => {
    ...
    j = new Set(['ics', 'json', 'pdf']),
    C = (e) => {
     const t = e.split('/').pop() ?? '',
      n = t.split('.').pop()?.toLowerCase();
     return void 0 !== n && j.has(n);
    };
  },
  87856(e, t, n) {
   'use strict';
