 ...
 [18401, 83249],
 {
                 ...
                 (0, i.jsxs)(
                  m.zB,
                  {
                   ...
                   children: [
                    ...
                    (0, i.jsx)(m.lR, { htmlFor: e, children: (0, i.jsx)(T.D, { state: t }) }),
                   ],
                  },
                  e,
                 ),
        ...
        (0, i.jsx)(v.AC, {
         ...
         children: d.map(({ title: e, id: t, href: n, description: s }) => {
          const o = y.find((t) => t.title === e),
           ...
           r = (0, b.mJ)(o);
          return (0, i.jsx)(k, { name: e, headingLevel: 2, href: n, description: s, relayStep: l, frameworkNames: r }, t);
         }),
        }),
       ],
      })
          ...
          (0, i.jsx)(x._Q, {
           ...
           children: l.map((e, t) => {
            ...
            if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
             const s = G.pI.get(e);
             n = (0, i.jsx)(j.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${s.sc} ${s.nl.title}`, style: { lineHeight: 1 }, children: (0, i.jsx)(W.K, { children: `WCAG ${e}` }) }, t);
            }
            return n;
           }),
          }),
  ...
  90495(e, t, n) {
   ...
   const r = ({ background: e, children: t, className: n, ...s }) => (0, l.jsx)('div', { className: (0, o.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, n), ...s, children: t }),
    ...
    c = ({ appearance: e = 'medium', children: t, className: n }) => (0, l.jsx)('div', { className: (0, o.A)('ma-cardgroup', `ma-cardgroup--${e}`, n), children: t });
  },
 },
]);
