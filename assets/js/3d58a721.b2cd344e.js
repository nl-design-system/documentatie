(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [710],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => p, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => c, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => s, eQ: () => f, B_: () => v, o_: () => g, Rc: () => x });
   ...
   const h = (e) => [...e].sort((e, t) => u.indexOf(e) - u.indexOf(t)),
    ...
    p = (e) => h(l(e.projects.flatMap((e) => y(e)))),
    m = (e) => {
     const t = y(e),
      n = ((e) => {
  ...
  54319(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => h, component: () => g, componentName: () => m, contentTitle: () => l, default: () => k, description: () => j, frontMatter: () => u, issueNumber: () => y, metadata: () => r, relayStep: () => p, title: () => d, toc: () => v }));
   ...
   var i = n(86070),
    ...
    o = n(85825),
    a = n(44594);
   const u = { title: 'Date Input Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Input Group', pagination_label: 'Date Input Group', description: 'Formulierveld voor een datum die de gebruiker al weet of die van bekende gegevens overgenomen kan worden.', slug: '/date-input-group', keywords: ['date', 'date field', 'date input', 'date input group', 'date selection', 'datum invoer', 'datumveld', 'form', 'formulier', 'formulierelement', 'input field', 'input fields', 'input group', 'invoervelden', 'text field'] },
    l = void 0,
    h = {},
    d = 'Date Input Group',
    j = 'Formulierveld voor een datum die de gebruiker al weet of die van bekende gegevens overgenomen kan worden.',
    y = 189,
    p = 'help wanted',
    m = 'date-input-group',
   ...
   function f(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, i.jsx)(o.Fc, { component: g, headingLevel: 1, description: j }), '\n', (0, i.jsx)(a.s, { relayStep: p, description: `Schets van de ${m} component`, name: m }), '\n', (0, i.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, i.jsx)(o.VK, { component: g, headingLevel: 3 }), '\n', (0, i.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, i.jsx)(o.mu, { component: g, headingLevel: 3 }), '\n', (0, i.jsx)(o.$9, { component: g, headingLevel: 2 })] });
   }
   function k(e = {}) {
  ...
  85825(e, t, n) {
   ...
   var h = n(67970),
    ...
    j = n(46447),
    y = n(45561);
   const p = ({ children: e }) => (0, u.jsx)('ul', { className: 'task-list', children: e }),
    m = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, u.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, u.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, u.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, u.jsx)(y.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [n ? (0, u.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }) : null, r, t] })] });
   var g = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => g.f4.includes(e.id)),
      s = n && g.f4.map((e) => n.find((t) => t.id === e)).filter(Boolean);
     return e && (0, u.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, g.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(m, { headingLevel: t + 1, checked: e, title: n, description: (0, g.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
