...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [7177],
 {
  ...
  12483(e, n, t) {
   (t.r(n), t.d(n, { assets: () => m, component: () => f, componentName: () => b, contentTitle: () => c, default: () => v, description: () => p, frontMatter: () => d, issueNumber: () => g, metadata: () => a, relayStep: () => u, title: () => h, toc: () => j }));
   ...
   const d = { title: 'Tabs', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Tabs', pagination_label: 'Tabs', description: 'Paneel om onderwerpen te groeperen, waarbij er maar \xe9\xe9n per keer zichtbaar is, met buttons om te kiezen welk onderwerp wordt weergegeven.', slug: '/tabs', keywords: ['content tabs', 'navigation', 'navigation tabs', 'nav tabs', 'panel', 'pivot', 'scoped tabs', 'switch', 'tab', 'tabs', 'tab bar', 'tab control', 'tab group', 'tab menu', 'tab nav', 'tab panel', 'tabbed interface', 'tabbed view'] },
    ...
    m = {},
    h = 'Tabs',
    p = 'Paneel om onderwerpen te groeperen, waarbij er maar \xe9\xe9n per keer zichtbaar is, met buttons om te kiezen welk onderwerp wordt weergegeven.',
    g = 51,
    u = 'help wanted',
    b = 'tabs',
    f = i.find((e) => e.number === g),
    j = [
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => r, KF: () => h, mJ: () => u, VZ: () => A, cR: () => _, Pv: () => b, qZ: () => i, kD: () => v, B2: () => p, Pc: () => l, f4: () => o, GT: () => w, fX: () => s, eQ: () => x, B_: () => j, o_: () => f, Rc: () => k });
