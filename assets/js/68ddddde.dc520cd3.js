(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [5643],
 {
  ...
  98008: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => N, component: () => V, contentTitle: () => S, default: () => O, description: () => _, frontMatter: () => D, issueNumber: () => M, metadata: () => P, title: () => F, toc: () => Z });
   var r = t(52676),
    i = t(24785),
    o = t(96439),
    s = t(92183),
   ...
   var f = t(40001),
    ...
    L = t(55240),
    R = t(8657);
   const D = { title: 'Skip Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Skip Link', pagination_label: 'Skip Link', description: 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.', slug: '/skip-link' },
    S = void 0,
    P = { id: 'componenten/skip-link/index', title: 'Skip Link', description: 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.', source: '@site/docs/componenten/skip-link/index.mdx', sourceDirName: 'componenten/skip-link', slug: '/skip-link', permalink: '/skip-link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/skip-link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Skip Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Skip Link', pagination_label: 'Skip Link', description: 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.', slug: '/skip-link' }, sidebar: 'componenten', previous: { title: 'Side Navigation', permalink: '/side-navigation' }, next: { title: 'Spinner', permalink: '/spinner' } },
    N = {},
    Z = [
    ...
    F = 'Skip Link',
    _ = 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.',
    M = 74,
   ...
   function H(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(R.Rv, { component: V, headingLevel: 1, description: _ }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, r.jsx)(R.cN, { component: V, headingLevel: 3 }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, r.jsx)(R.W, { component: V, headingLevel: 3 }),
      '\n',
      ...
      (0, r.jsx)(L.t, {
       ...
       items: [
        { title: 'Het label van de Skip Link bestaat uit gewone tekst, niet uit een afbeelding van tekst', sc: '1.4.5', status: '', component: (0, r.jsx)(x.ZP, {}) },
        { title: 'De linktekst van de Skip Link vertelt eenduidig aan de gebruiker waar de link naar toe gaat (het linkdoel)', sc: '2.4.4', status: '', component: (0, r.jsx)(T.ZP, {}) },
        { title: 'Als de gebruiker de Skip Link indrukt met een aanwijzer zoals een muis of vinger, is er de mogelijkheid is om actie te voorkomen of ongedaan te maken', sc: '2.5.2', status: '', component: (0, r.jsx)(m.ZP, {}) },
        { title: 'De zichtbare naam van de Skip Link komt voor in de toegankelijke naam', sc: '2.5.3', status: '', component: (0, r.jsx)(p.ZP, {}) },
        { title: 'De Skip Link heeft een aanklikbaar gedeelte van ten minste 44 bij 44 pixels', sc: '2.5.5', status: '', component: (0, r.jsx)(j.ZP, {}) },
        { title: 'Als de Skip Link toetsenbordfocus krijgt vindt er geen contextwijziging plaats', sc: '3.2.1', status: '', component: (0, r.jsx)(G.ZP, {}) },
        { title: "Skip Links die op meerdere pagina's voorkomen staan in dezelfde relatieve volgorde", sc: '3.2.3', status: '', component: (0, r.jsx)(W.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(L.t, {
       ...
       items: [
        ...
        { title: 'Wanneer de Skip Link de toetsenbordfocus krijgt is de focus zichtbaar', sc: '2.4.7', status: '', component: (0, r.jsx)(g, {}) },
        { title: 'De Skip Link heeft een goed zichtbare focusindicator', sc: '2.4.13', status: '', component: (0, r.jsx)(u.ZP, {}) },
        { title: 'De Skip Link heeft een aanklikbaar gedeelte van ten minste 44 bij 44 pixels', sc: '2.5.5', status: '', component: (0, r.jsx)(j.ZP, {}) },
        { title: 'Skip Links met gelijke functies hebben hetzelfde uiterlijk en hetzelfde label', sc: '3.2.4', status: '', component: (0, r.jsx)(v, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(L.t, {
       ...
       items: [
        ...
        { title: 'Als je de hele webpagina inzoomt tot 400% blijft veroorzaakt de Skip Link veroorzaakt geen horizontale scrollbalk en alle tekst op de pagina blijft leesbaar', sc: '1.4.10', status: '', component: (0, r.jsx)(b.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(L.t, {
       ...
       items: [
        { title: 'Je kunt de Skip Link focussen met de tabtoets en activeren met de entertoets', sc: '2.1.1', status: '', component: (0, r.jsx)(d.ZP, {}) },
        { title: 'Als een gebruiker de Skip Link focust met het toetsenbord, dan moet deze ook weer weg kunnen gaan met het toetsenbord', sc: '2.1.2', status: '', component: (0, r.jsx)(y.ZP, {}) },
        { title: "De Skip Link slaat een contentblok over dat op meerdere pagina's voorkomt", sc: '2.4.1', status: '', component: (0, r.jsx)(A.ZP, {}) },
        { title: 'De Skip Link staat op een logische plek in de focusvolgorde', sc: '2.4.3', status: '', component: (0, r.jsx)(C.ZP, {}) },
        { title: 'Wanneer de Skip Link de toetsenbordfocus krijgt is de focus zichtbaar', sc: '2.4.7', status: '', component: (0, r.jsx)(g, {}) },
        { title: 'De Skip Link wordt niet bedekt door een ander element op de pagina', sc: '2.4.11', status: '', component: (0, r.jsx)(z.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(L.t, {
       ...
       items: [
        { title: 'Als de tekst van de Skip Link in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode', sc: '3.1.2', status: '', component: (0, r.jsx)(k.ZP, {}) },
        { title: 'De Skip Link heeft een rol van link en een toegankelijke naam die duidelijk maakt waar de Skip Link voor dient', sc: '4.1.2', status: '', component: (0, r.jsx)(f.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }),
      '\n',
      (0, r.jsx)(R.vM, { component: V, headingLevel: 3 }),
     ],
    });
   }
   function O(e = {}) {
          ...
          children: [
           (0, d.jsx)(f, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(b, { checked: n, title: t, description: (0, x.Q6)(r) }, r);
            }),
           }),
