 ...
 [20911],
 {
  ...
  35038: (e, t, n) => {
   ...
   const c = (e) => {
     ...
     return (0, o.jsx)('div', { className: (0, i.Z)('card__illustration', t && 'card__illustration--background', r), ...c, children: n });
    },
    s = (e) => (0, o.jsx)('div', { className: 'card__content', ...e }),
    a = (e) => {
     let { href: t, appearance: n, className: c, component: s = 'div', children: a } = e;
     const l = (e) => ('article' === s ? (0, o.jsx)('article', { ...e }) : 'section' === s ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      u = (0, o.jsx)(l, { className: (0, i.Z)('cardgroup__card', `cardgroup__card--${n}`, c), children: a });
  ...
  94443: (e, t, n) => {
   ...
   var r = n(41115),
    ...
    l = n(32636),
    u = n(52676);
   const h = { figma: (0, u.jsx)(o.Z, {}), github: (0, u.jsx)(c.Z, {}), npm: (0, u.jsx)(s.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
   ...
   const f = (e) => {
     ...
     const o = t && t.projects.filter((e) => k.e9.includes(e.id)),
      c = o && k.e9.map((e) => o.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
               ...
               o.length > 0 &&
                (0, u.jsx)(u.Fragment, {
                 children: o.map((e) => {
                  ...
                  return (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.X6, { level: n + 2, children: [i, ' in ', t] }), (0, u.jsx)(r.Mc, { links: o.map((e) => ({ children: e.description, icon: (0, u.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
    ...
    _ = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(g.V, { level: n, suffix: o && (0, u.jsx)(y.y, { state: o }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => m, BA: () => s, Ee: () => u, Q6: () => o, U: () => j, Yr: () => p, d: () => h, e9: () => c, fO: () => b, mA: () => i, ps: () => y, qU: () => k, s0: () => v, zP: () => g });
