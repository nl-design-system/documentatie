...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [59088],
 {
  ...
  52400: (e, n, o) => {
   o.r(n), o.d(n, { assets: () => m, contentTitle: () => g, default: () => y, frontMatter: () => u, metadata: () => v, toc: () => h });
   var l = o(52676),
    t = o(24785),
    s = o(55400),
    r = o(43599),
   ...
   function i(e) {
    ...
    return (0, l.jsxs)(l.Fragment, { children: ['\n', '\n', '\n', (0, l.jsx)(a.X, { appearance: 'do', title: 'Informeren dat het formulier is verzonden en wat de vervolgacties zijn.', children: (0, l.jsx)(r.X, { language: 'html', children: () => (0, l.jsxs)(n.div, { children: [(0, l.jsx)(n.p, { children: 'Uw vraag is met succes verstuurd. Zaaknummer 123456789.' }), (0, l.jsx)(n.p, { children: 'Wat gaat er nu gebeuren?' }), (0, l.jsxs)(n.ul, { children: [(0, l.jsx)(n.li, { children: 'U ontvangt een bevestigingsmail op gebruiker@voorbeeld.com' }), (0, l.jsx)(n.li, { children: 'De afdeling Vraagbaak gaat met uw vraag aan de slag.' }), (0, l.jsx)(n.li, { children: 'U wordt per e-mail op de hoogte gehouden maar kunt de voortgang ook inzien binnen uw Mijn omgeving.' })] })] }) }) }), '\n', (0, l.jsx)(a.X, { appearance: 'dont', title: 'Vervolgstappen weglaten.', children: (0, l.jsx)(r.X, { language: 'html', children: () => (0, l.jsx)(n.p, { children: 'Uw vraag is verstuurd.' }) }) })] });
   }
   function c(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
  ...
  43599: (e, n, o) => {
   ...
   const v = (e) => {
    let { children: n } = e;
    return (0, g.jsx)(l.Tg, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(l.BB, { className: (0, s.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(l.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   v.displayName = 'ParagraphContainer';
   const m = (e) => {
    let { children: n } = e;
    return (0, g.jsx)(l.Tg, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(l.BB, { className: (0, s.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const b = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      (Z = await d.ZP.format(N, { parser: f, plugins: [r.Z, a.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(Z);
     })();
    }, [N]);
    const B = (0, p.useId)();
    let P = p.Fragment;
    return (
     'paragraph' === x ? (P = v) : 'document' === x ? (P = m) : 'surface' === x && (P = h),
     (0, g.jsxs)('div', {
      className: (0, s.Z)('nlds-canvas'),
      children: [
       _ && (0, g.jsx)('div', { className: (0, s.Z)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, g.jsx)(P, { children: (0, g.jsx)(l.pu, { children: _ }) }) }) }),
       y &&
        (0, g.jsx)('div', {
       ...
       y &&
        (0, g.jsxs)('div', {
         ...
         hidden: !z,
         children: [
          (0, g.jsx)(t.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: Z, trim: !0 }),
          o &&
           (0, g.jsx)('div', {
  ...
  41179: (e, n, o) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: o, textContent: c, trim: d } = e,
     p = c;
    const { title: u, type: g } = (0, s.useContext)(r.n),
     v = (0, s.useId)();
    return (
     d && (p = p.trim()),
     (0, i.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: v, children: ['codevoorbeeld ', g ? `\u201c${g}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, i.jsx)(l.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': v, style: o, children: t.map((e, o) => (0, i.jsxs)('span', { ...s({ line: e }), children: [n && (0, i.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, o)) })] });
      },
     })
    );
   }
