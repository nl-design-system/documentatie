 ...
 [97979],
 {
  63270: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(96439),
    o = n(23952);
   const s = { title: 'Text Area', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text Area', pagination_label: 'Text Area', description: 'Invoerveld voor het bewerken van meerdere regels tekst.', slug: '/text-area' },
    a = void 0,
    l = { id: 'componenten/textarea/index', title: 'Text Area', description: 'Invoerveld voor het bewerken van meerdere regels tekst.', source: '@site/docs/componenten/textarea/index.mdx', sourceDirName: 'componenten/textarea', slug: '/text-area', permalink: '/text-area', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/textarea/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Text Area', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text Area', pagination_label: 'Text Area', description: 'Invoerveld voor het bewerken van meerdere regels tekst.', slug: '/text-area' }, sidebar: 'componenten', previous: { title: 'Text Input Group', permalink: '/text-input-group' }, next: { title: 'Toggletip', permalink: '/toggletip' } },
    u = {},
    d = [
          ...
          children: [
           (0, u.jsx)(N, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(T, { checked: t, title: n, description: (0, z.Q6)(r) }, r);
            }),
           }),
