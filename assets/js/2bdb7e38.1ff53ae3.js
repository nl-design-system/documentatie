  ...
  15175(e, n, l) {
   ...
   function i({ lineNumber: e, syntax: n, textContent: l, trim: i }) {
    ...
    const { title: u, type: p } = (0, o.useContext)(r.x),
     m = (0, o.useId)();
    return (i && (d = d.trim()), (0, c.jsx)(s.f4, { theme: a, code: d, language: n || '', children: ({ style: n, tokens: l, getLineProps: s, getTokenProps: o }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, c.jsx)(t.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': m, style: n, children: l.map((n, l) => (0, c.jsxs)('span', { ...s({ line: n }), children: [e && (0, c.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, c.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  18439(e, n, l) {
   l.d(n, { R: () => r, x: () => a });
  ...
  70348(e, n, l) {
   ...
   const a = ({ className: e, ...n }) => {
    ...
    c = ({ className: e, classNamePanel: n, label: l, heading: a, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, r.jsxs)('details', { className: u, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(s.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [a && (0, r.jsx)(o.D, { level: c, appearance: i, children: a }), l] })] }) }), (0, r.jsx)('div', { className: p, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => j });
   ...
   const j = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const t = 'function' == typeof e ? e() : e,
        ...
        r = h().highlight(s, h().languages[n], n);
       return (0, v.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', l), children: [(0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: s } }), (0, v.jsx)(g.n, { children: (0, v.jsx)(g.K, { label: 'Code', children: (0, v.jsx)('pre', { className: 'language-html nl-code-block', children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: m = !0, children: h, container: g = 'document', language: j, designTokens: f }) => {
