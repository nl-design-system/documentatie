 ...
 [68255],
 {
  15175(e, n, t) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: t, trim: c }) {
    let d = t;
    const { title: h, type: g } = (0, s.useContext)(i.x),
     m = (0, s.useId)();
    return (c && (d = d.trim()), (0, o.jsx)(a.f4, { theme: r, code: d, language: n || '', children: ({ style: n, tokens: t, getLineProps: a, getTokenProps: s }) => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', g ? `\u201c${g}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, o.jsx)(l.NG, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': m, style: n, children: t.map((n, t) => (0, o.jsxs)('span', { ...a({ line: n }), children: [e && (0, o.jsx)('span', { children: t + 1 }), n.map((e, n) => (0, o.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, t)) })] }) }));
   }
  },
  18439(e, n, t) {
   t.d(n, { R: () => i, x: () => r });
   ...
   function r(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(a) : e.components || a) : i(e.components)), l.createElement(s.Provider, { value: n }, e.children));
   }
  },
  49539(e, n, t) {
   t.d(n, { Ay: () => r, RM: () => s });
   ...
   const d = (0, o.createContext)({}),
    h = ({ title: e, appearance: n, description: t, children: o, figure: h }) => {
     const g = { do: 'Doen', dont: 'Niet doen' },
      m = h ? 'figure' : 'div',
      u = h ? 'figcaption' : 'div',
      p = 'string' == typeof t ? (0, c.jsx)(r.oz, { components: { a: s.N_ }, children: t }) : t;
     return (0, c.jsxs)(m, { className: (0, i.A)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(u, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.fz, { className: (0, i.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, c.jsx)(a.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, c.jsx)('span', { className: 'nlds-guideline__title', children: g.dont })] }), (0, c.jsx)(s.fz, { children: e })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.fz, { className: (0, i.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, c.jsx)(l.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, c.jsx)('span', { className: 'nlds-guideline__title', children: g.do })] }), (0, c.jsx)(s.fz, { children: e })] }), p] }), (0, c.jsx)('div', { className: 'nlds-guideline__example', children: (0, c.jsx)(d.Provider, { value: { title: e, type: g[n] }, children: o }) })] });
    };
  },
  54766(e, n, t) {
  ...
  70348(e, n, t) {
   ...
   var l = t(13526),
    ...
    i = t(37168),
    r = t(86070);
   const o = (0, a.forwardRef)(({ as: e, className: n, children: t, ...a }, s) => {
     const i = e || 'div',
      o = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, r.jsx)(i, { ref: s, className: o, ...a, children: t });
    }),
    c = ({ className: e, classNamePanel: n, label: t, heading: a, headingLevel: o, headingApperance: c, ...d }) => {
     const h = (0, l.A)('utrecht-accordion__section', e),
      g = (0, l.A)('utrecht-accordion__panel', n);
     return (0, r.jsxs)('details', { className: h, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(s.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [a && (0, r.jsx)(i.D, { level: o, appearance: c, children: a }), t] })] }) }), (0, r.jsx)('div', { className: g, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => f });
   var l = t(15175),
    ...
    p = t(70348),
    b = t(86070);
   const j = ({ children: e }) => (0, b.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(a.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, b.jsx)(a.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   j.displayName = 'ParagraphContainer';
   const v = ({ children: e }) => (0, b.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(a.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const f = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const l = 'function' == typeof e ? e() : e,
        ...
        i = u().highlight(a, u().languages[n], n);
       return (0, b.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', t), children: [(0, b.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: a } }), (0, b.jsx)(p.n, { children: (0, b.jsx)(p.K, { label: 'Code', children: (0, b.jsx)('pre', { className: 'language-html nl-code-block', children: (0, b.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: i } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: m = !0, children: u, container: p = 'document', language: f, designTokens: y }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(A, { parser: f, plugins: [i.A, r.Ay, o.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         N(e);
        })();
       }, [A]);
       const S = (0, h.useId)();
       ...
       return (
        ...
        (0, b.jsxs)('div', {
         ...
         children: [
          x && (0, b.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, b.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, b.jsx)(L, { children: (0, b.jsx)(a.v$, { children: x }) }) }) }),
          m &&
           (0, b.jsx)('div', {
