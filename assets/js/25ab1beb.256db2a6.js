/*! For license information please see 25ab1beb.256db2a6.js.LICENSE.txt */
'use strict';
   ...
   const l = t.forwardRef(function (e, n) {
    const [i, l] = t.useState(!1),
     ...
     w = y
      ...
      : null,
     x = t.useMemo(() => e.thumbnail || w || `https://i.ytimg.com/${f}/${e.playlist ? u : m}/${h}.${b}`, [e.thumbnail, w, f, e.playlist, u, m, h, b]),
    ...
    return (
     ...
     (0, s.jsxs)(s.Fragment, {
      children: [
       ...
       e.seo && !e.playlist && (0, s.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: o(e.id, c, x, g, e.seo) } }),
       ...
       (0, s.jsxs)(N, {
        ...
        children: [e.lazyLoad && !a && (0, s.jsx)('img', { src: x, alt: `${c} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, s.jsx)('button', { type: 'button', className: H, 'aria-label': `${j} ${c}`, 'aria-hidden': a || void 0, tabIndex: a ? -1 : 0, children: (0, s.jsx)('span', { className: 'lty-visually-hidden', children: j }) }), a && (0, s.jsx)('iframe', { ref: n, className: D, title: c, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: v, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
