...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [1080],
 {
  ...
  86519: (e, t, o) => {
   ...
   var h = o(48714),
    p = o(17196);
   const g = { container: "container_ZCoO" };
   function b(e) {
    let { readingTime: t } = e;
    const o = (function () {
   ...
   const k = { authorCol: "authorCol_DjdN", imageOnlyAuthorRow: "imageOnlyAuthorRow_ZTIm", imageOnlyAuthorCol: "imageOnlyAuthorCol_ddGf" };
   function P(e) {
    let { className: t } = e;
    const {
     metadata: { authors: o },
   ...
   function w(e) {
    ...
    return (0, c.jsx)("div", { id: l ? N.blogPostContainerID : void 0, className: (0, n.Z)("markdown", o), itemProp: "articleBody", children: (0, c.jsx)(_.Z, { children: t }) });
   }
   var C = o(30542),
    T = o(79170);
   function F() {
   ...
   const I = { blogPostFooterDetailsFull: "blogPostFooterDetailsFull_cZjZ" };
   function M() {
   ...
   function D(e) {
    ...
    return (0, c.jsxs)($.Z, { breadcrumbs: [{ label: "Blog", href: "/blog" }, { label: l.title }], sidebar: t, toc: !d && r.length > 0 ? (0, c.jsx)(R.Z, { toc: r, minHeadingLevel: m, maxHeadingLevel: u }) : void 0, children: [(0, c.jsx)(A, { children: o }), (n || a) && (0, c.jsx)(O, { nextItem: n, prevItem: a })] });
   }
   function E(e) {
    const t = e.content;
    return (0, c.jsx)(s.n, { content: e.content, isBlogPostPage: !0, children: (0, c.jsxs)(l.FG, { className: (0, n.Z)(r.k.wrapper.blogPages, r.k.page.blogPostPage), children: [(0, c.jsx)(S, {}), (0, c.jsx)(D, { sidebar: e.sidebar, children: (0, c.jsx)(t, {}) })] }) });
   }
  },
  21581: (e, t, o) => {
   o.d(t, { Z: () => g });
