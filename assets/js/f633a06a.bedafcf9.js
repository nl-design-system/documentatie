/*! For license information please see f633a06a.bedafcf9.js.LICENSE.txt */
'use strict';
 ...
 [86429],
 {
  9312(e, n, a) {
   ...
   const o = { title: 'Link List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link List', pagination_label: 'Link List', description: 'Een lijst met gerelateerde links naar andere pagina\u2019s of websites.', issue_number: 264, slug: '/link-list', keywords: ['anchor', 'externe link', 'external link', 'gerelateerde links', 'hyperlink', 'koppelingen lijst', 'lijst', 'link', 'link collection', 'link group', 'link lijst', 'linken', 'links', 'list', 'lijst met koppelingen', 'lijst met links', 'related links', 'related link list', 'url', 'url list'] },
    ...
    g = {},
    c = 'Link List',
    u = 'Een lijst met gerelateerde links naar andere pagina\u2019s of websites.',
    m = 264,
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => i, KF: () => u, mJ: () => p, VZ: () => N, cR: () => w, Pv: () => f, qZ: () => l, kD: () => k, QQ: () => L, B2: () => m, Pc: () => o, f4: () => s, GT: () => j, fX: () => r, eQ: () => v, B_: () => b, o_: () => x });
  ...
  63009(e, n, a) {
   ...
   var c = (0, s.forwardRef)(function (e, n) {
    var a = e.children,
     ...
     m = e.inlineBox,
     h = (0, i.A)(e, o);
    return (0, r.jsx)('a', g(g({ 'aria-current': d || void 0, 'aria-disabled': c, className: (0, l.$)('nl-link', (0, t.A)((0, t.A)((0, t.A)({}, 'nl-link--current', d), 'nl-link--disabled', c), 'nl-link--inline-box', m), s), href: c ? void 0 : u, role: c ? 'link' : void 0, ref: n, tabIndex: c ? 0 : void 0 }, h), {}, { children: a }));
   });
   c.displayName = 'Link';
  },
  70348(e, n, a) {
   ...
   const o = (0, i.forwardRef)(({ as: e, className: n, children: a, ...i }, r) => {
    ...
    d = ({ className: e, classNamePanel: n, label: a, heading: i, headingLevel: o, headingApperance: d, ...g }) => {
     ...
     return (0, s.jsxs)('details', { className: c, ...g, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(r.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [i && (0, s.jsx)(l.D, { level: o, appearance: d, children: i }), a] })] }) }), (0, s.jsx)('div', { className: u, children: g.children })] });
    };
  },
  74172(e, n, a) {
   a.d(n, { A: () => l });
               ...
               d.Z,
               {
                ...
                description: (0, g.jsxs)('div', {
                 ...
                 children: [
                  ...
                  u.length > 0 && u.map(({ frameworkName: e, tasks: a }) => (0, g.jsxs)('section', { children: [(0, g.jsxs)(i.DZ, { level: Math.min(n + 2, 6), children: [l, ' in ', e] }), (0, g.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, g.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
