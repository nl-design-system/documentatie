(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [84463],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => d, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => g, qZ: () => c, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => i, eQ: () => v, B_: () => k, o_: () => p, Rc: () => x });
  ...
  74168(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => u, component: () => p, componentName: () => g, contentTitle: () => h, default: () => f, description: () => j, frontMatter: () => l, issueNumber: () => y, metadata: () => r, relayStep: () => m, title: () => d, toc: () => k }));
   ...
   var s = n(86070),
    ...
    o = n(85825),
    a = n(44594);
   const l = { title: 'Task List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Task List', pagination_label: 'Task List', description: 'Lijst met taken die zijn gemarkeerd als voltooid of onvoltooid.', slug: '/task-list', keywords: ['checklist', 'completed', 'onvoltooide taken', 'taakbeheer', 'taaklijst', 'takenlijst', 'task list', 'ticked list', 'to-do lijst', 'to-dolist', 'voltooid vinkje', 'voltooide taken'] },
    h = void 0,
    u = {},
    d = 'Task List',
    j = 'Lijst met taken die zijn gemarkeerd als voltooid of onvoltooid.',
    y = 263,
    m = 'help wanted',
    g = 'task-list',
  ...
  85825(e, t, n) {
   ...
   const m = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    g = ({ checked: e, children: t, title: n, description: r, headingLevel: i = 3 }) => (0, l.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(y.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [n ? (0, l.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: i, children: n }) : null, r, t] })] });
   var p = n(33062);
