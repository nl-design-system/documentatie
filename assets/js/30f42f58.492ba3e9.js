...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  32699: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => m, contentTitle: () => j, default: () => b, frontMatter: () => u, metadata: () => p, toc: () => v });
   var a = t(52676),
    i = t(40139),
    r = t(57716),
    l = t(46364),
   ...
   const u = { title: 'WCAG-succescriterium 3.1.1 Taal van de pagina', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.1.1 Taal van de pagina', pagination_label: 'WCAG-succescriterium 3.1.1 Taal van de pagina', description: 'Geef de menselijke taal waarin de tekst van een webpagina is geschreven aan. Dit kan door in het html-element het attribuut \u2018lang\u2019 mee te geven.', slug: '3.1.1', keywords: ['WCAG', 'A', 'begrijpelijk', 'leesbaar', 'understandable', 'readable', 'language of page'] },
    j = void 0,
    p = { id: 'wcag/3.1.01', title: 'WCAG-succescriterium 3.1.1 Taal van de pagina', description: 'Geef de menselijke taal waarin de tekst van een webpagina is geschreven aan. Dit kan door in het html-element het attribuut \u2018lang\u2019 mee te geven.', source: '@site/docs/wcag/3.1.01.mdx', sourceDirName: 'wcag', slug: '/wcag/3.1.1', permalink: '/wcag/3.1.1', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.1.01.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 3.1.1 Taal van de pagina', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.1.1 Taal van de pagina', pagination_label: 'WCAG-succescriterium 3.1.1 Taal van de pagina', description: 'Geef de menselijke taal waarin de tekst van een webpagina is geschreven aan. Dit kan door in het html-element het attribuut \u2018lang\u2019 mee te geven.', slug: '3.1.1', keywords: ['WCAG', 'A', 'begrijpelijk', 'leesbaar', 'understandable', 'readable', 'language of page'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.5.8 Grootte van het aanwijsgebied (minimum)', permalink: '/wcag/2.5.8' }, next: { title: 'WCAG-succescriterium 3.1.2 Taal van onderdelen', permalink: '/wcag/3.1.2' } },
    m = {},
    v = [
  ...
  41757: (e, n, t) => {
   ...
   var a = t(4814),
    i = t(52676);
   const r = (e) => {
    let { children: n, className: t, level: r = 1, suffix: l, ...s } = e;
    return (0, i.jsxs)('hgroup', { className: (0, a.Z)('nlds-inline-heading-group', `utrecht-heading-${r}`, t), ...s, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: n }), l && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [l ? ' ' : '', l] })] });
   };
  },
  57716: (e, n, t) => {
   t.d(n, { U: () => c });
   ...
   const l = (e, n) => {
    ...
    c = (e) => {
     let { children: n, omitH1: t = !1, headingLevel: i = 1, baseUrl: l = '', components: s = {} } = e;
     return (0, r.jsx)(a.Z, { components: { ...o(t, i), ...d(l), ...s }, children: n });
    };
  },
  46364: (e, n, t) => {
   t.d(n, { j: () => l });
   ...
   const l = (e) => {
    ...
    return (0, r.jsx)(i.V, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: t && (0, r.jsx)(a.Ou, { className: 'nlds-inline-heading-group__badge', children: t }), ...l, children: n });
   };
  },
  40139: (e, n, t) => {
   t.d(n, { Z: () => s, a: () => l });
