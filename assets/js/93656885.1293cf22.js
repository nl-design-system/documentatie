 ...
 [45403],
 {
  ...
  12761(e, n, a) {
   ...
   const b = ({ className: e, ...n }) => {
    ...
    j = ({ className: e, heading: n, headingLevel: a, headingApperance: t, ...i }) => {
     const l = (0, s.A)('utrecht-accordion__section', e);
     return (0, d.jsxs)('details', { className: l, ...i, children: [(0, d.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, d.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, d.jsx)('span', { className: 'nl-button__icon-start', children: (0, d.jsx)(x.A, {}) }), (0, d.jsx)('span', { className: 'nl-button__label', children: (0, d.jsx)(f.D, { level: a, appearance: t, children: n }) })] }) }), (0, d.jsx)('div', { className: 'utrecht-accordion__panel', children: i.children })] });
    },
            ...
            l.Zp,
            {
             ...
             children: (0, d.jsxs)(l.Wu, {
              children: [
               ...
               (g.length > 0 || r.length > 0) && (0, d.jsx)(t.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               g.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               r.length > 0 && (0, d.jsx)(d.Fragment, { children: r.map(({ frameworkName: e, tasks: a }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.DZ, { level: n + 2, children: [s, ' in ', e] }), (0, d.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, d.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  68396(e, n, a) {
   'use strict';
   (a.r(n), a.d(n, { assets: () => g, component: () => f, componentName: () => x, contentTitle: () => u, default: () => k, description: () => c, frontMatter: () => d, issueNumber: () => h, metadata: () => t, relayStep: () => p, title: () => m, toc: () => b }));
   ...
   function j(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, s.jsx)(r.Fc, { component: f, headingLevel: 1, description: c }), '\n', (0, s.jsx)(n.p, { children: 'Ook bekend als: Streamer.' }), '\n', (0, s.jsx)(o.s, { relayStep: p, description: `Schets van de ${x} component`, name: x }), '\n', (0, s.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, s.jsx)(r.VK, { component: f, headingLevel: 3 }), '\n', (0, s.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, s.jsx)(r.mu, { component: f, headingLevel: 3 }), '\n', (0, s.jsx)(r.K_, { component: f }), '\n', (0, s.jsx)(r.$9, { component: f, headingLevel: 2 })] });
   }
   function k(e = {}) {
  ...
  76097(e, n, a) {
   'use strict';
   a.d(n, { bo: () => s, KF: () => m, mJ: () => p, VZ: () => D, cR: () => T, Pv: () => x, qZ: () => l, kD: () => k, QQ: () => N, B2: () => c, Pc: () => o, f4: () => r, GT: () => v, fX: () => i, eQ: () => j, B_: () => b, o_: () => f });
