...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [28568],
 {
  ...
  19036(e, n, t) {
   (t.r(n), t.d(n, { assets: () => L, component: () => C, contentTitle: () => S, default: () => B, description: () => T, frontMatter: () => y, issueNumber: () => z, metadata: () => i, title: () => H, toc: () => _ }));
   ...
   const w = [
    ...
    A = [
     ...
     { title: 'De Form Field Description is standaard niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: v.Ay, tags: ['developer'] },
  ...
  21034(e, n, t) {
   ...
   const f = ({ component: e, headingLevel: n }) => {
    ...
    k = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u.p, { level: n, suffix: r && (0, d.jsx)(g.D, { state: r }), children: e.title }), (0, d.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(r) && (0, d.jsx)(x.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    F = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  32385(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => h, VZ: () => D, cR: () => F, Pv: () => j, qZ: () => o, kD: () => v, QQ: () => A, B2: () => m, Pc: () => l, f4: () => s, GT: () => k, fX: () => a, eQ: () => b, B_: () => f, o_: () => x });
  ...
  70348(e, n, t) {
   ...
   const s = ({ className: e, ...n }) => {
    ...
    l = ({ className: e, label: n, heading: t, headingLevel: s, headingApperance: l, ...d }) => {
     ...
     return (0, o.jsxs)('details', { className: c, ...d, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(r.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [t && (0, o.jsx)(a.D, { level: s, appearance: l, children: t }), n] })] }) }), (0, o.jsx)('div', { className: 'utrecht-accordion__panel', children: d.children })] });
    };
  },
  70561(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => a });
