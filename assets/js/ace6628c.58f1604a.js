(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [83373],
 {
  83725: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => o, default: () => p, description: () => j, frontMatter: () => a, issueNumber: () => y, metadata: () => l, title: () => d, toc: () => h });
   var r = n(52676),
    i = n(40139),
    c = n(65739),
    s = n(94443);
  ...
  35038: (e, t, n) => {
   ...
   const s = (e) => {
    ...
    a = (e) => (0, c.jsx)('div', { className: 'card__content', ...e }),
    o = (e) => {
     ...
     const l = (e) => ('article' === a ? (0, c.jsx)('article', { ...e }) : 'section' === a ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      u = (0, c.jsx)(l, { className: (0, i.Z)('cardgroup__card', `cardgroup__card--${n}`, s), children: o });
  ...
  94443: (e, t, n) => {
   ...
   var r = n(41115),
    ...
    l = n(32636),
    u = n(52676);
   const h = { figma: (0, u.jsx)(c.Z, {}), github: (0, u.jsx)(s.Z, {}), npm: (0, u.jsx)(a.Z, {}), storybook: (0, u.jsx)(o.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
   ...
   const f = (e) => {
     ...
     const c = t && t.projects.filter((e) => b.e9.includes(e.id)),
      s = c && b.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
            ...
            j.Zb,
            {
             ...
             children: (0, u.jsxs)(j.aY, {
              children: [
               ...
               (a.length > 0 || c.length > 0) && (0, u.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               a.length > 0 &&
                (0, u.jsx)(u.Fragment, {
    ...
    _ = (e) => {
     ...
     const c = t && b.$3[t.relayStep];
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(m.V, { level: n, suffix: c && (0, u.jsx)(y.y, { state: c }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  41757: (e, t, n) => {
   ...
   const c = (e) => {
    ...
    return (0, i.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${c}`, n), ...a, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), s && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => a, Q6: () => c, U: () => l, e9: () => s, mA: () => i, ps: () => u });
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        ...
        return { brand: a.toLowerCase(), name: i, id: c, value: s, description: o };
       });
