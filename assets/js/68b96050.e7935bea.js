 ...
 [34799],
 {
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    l = n(83386),
    d = n(86070);
   const h = { figma: (0, d.jsx)(i.A, {}), github: (0, d.jsx)(o.A, {}), npm: (0, d.jsx)(a.A, {}), storybook: (0, d.jsx)(c.A, {}) },
   ...
   const b = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, d.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, A.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(k, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, d.jsx)(v, { headingLevel: t + 1, checked: e, title: n, description: (0, A.qZ)(r) }, r)) }), (0, d.jsx)(r.fz, { children: (0, d.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
  ...
  73361: (e, t, n) => {
   ...
   var p = n(30696),
    ...
    A = n(43825),
    b = n(30758);
   const x = { color: p.A, dimension: j.A, fontFamilies: w.A, fontSizes: y.A, fontWeights: f.A, lineHeights: k.A, other: v.A, textDecoration: A.A },
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => u, B_: () => w, GT: () => k, KF: () => h, Pc: () => a, Pv: () => p, Rc: () => v, bo: () => r, eQ: () => y, f4: () => o, fX: () => s, kD: () => f, mJ: () => m, o_: () => j, qZ: () => i });
  ...
  80840: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => z, component: () => S, contentTitle: () => G, default: () => F, description: () => N, frontMatter: () => R, issueNumber: () => _, metadata: () => r, title: () => W, toc: () => D });
   ...
   function L(e) {
    ...
    return (0, s.jsxs)(s.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, s.jsx)(v.Fc, { component: S, headingLevel: 1, description: N }),
      '\n',
      (0, s.jsx)(y.e, { component: S }),
      '\n',
      (0, s.jsx)(t.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, s.jsx)(f.H, { component: S, illustration: d.A }),
      '\n',
      ...
      '\n',
      (0, s.jsx)(A.B, { tokens: C }),
      '\n',
      (0, s.jsx)(b.o, { omitH1: !0, headingLevel: 3, children: (0, s.jsx)(T, {}) }),
      '\n',
      ...
      (0, s.jsx)(k.b, {
       ...
       items: [
        ...
        { title: 'Als een paragraaftekst in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: (0, s.jsx)(w.Ay, {}), tags: ['developer', 'contentmaker'] },
        { title: 'Als je de hele webpagina inzoomt tot 400% blijft de paragraaftekst leesbaar.', sc: '1.4.10', status: '', component: (0, s.jsx)(g.Ay, {}), tags: ['developer'] },
       ],
      }),
      '\n',
      ...
      (0, s.jsx)(k.b, {
       headingLevel: '4',
       items: [
        { title: 'Gebruik het p-element voor paragraaftekst.', sc: '1.3.1', status: '', component: (0, s.jsx)(u, {}), tags: ['developer'] },
        { title: 'Als je de paragraaftekst vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: (0, s.jsx)(j.Ay, {}), tags: ['developer'] },
