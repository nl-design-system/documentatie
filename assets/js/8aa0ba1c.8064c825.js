 ...
 [87034],
 {
  55328: (e, t, n) => {
   ...
   const o = { title: 'File Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'File Input', pagination_label: 'File Input', description: 'Knop om \xe9\xe9n of meerdere bestanden te kiezen en te uploaden.', slug: '/file-input', keywords: ['bestand', 'bestandsinvoer', 'dropzone', 'file', 'filedrop', 'file input', 'file picker', 'file selector', 'file upload', 'file uploader', 'input file', 'upload'] },
    a = void 0,
    l = { id: 'componenten/file-input/index', title: 'File Input', description: 'Knop om \xe9\xe9n of meerdere bestanden te kiezen en te uploaden.', source: '@site/docs/componenten/file-input/index.mdx', sourceDirName: 'componenten/file-input', slug: '/file-input', permalink: '/file-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/file-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'File Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'File Input', pagination_label: 'File Input', description: 'Knop om \xe9\xe9n of meerdere bestanden te kiezen en te uploaden.', slug: '/file-input', keywords: ['bestand', 'bestandsinvoer', 'dropzone', 'file', 'filedrop', 'file input', 'file picker', 'file selector', 'file upload', 'file uploader', 'input file', 'upload'] }, sidebar: 'componenten', previous: { title: 'Figure', permalink: '/figure' }, next: { title: 'Form Field', permalink: '/form-field' } },
    u = {},
    h = [
