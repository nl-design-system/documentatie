 ...
 [44344],
 {
  183(e, t, n) {
   ...
   var c = n(86070),
    ...
    s = n(36059),
    o = n(85825);
   const a = { title: 'Note', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Note', pagination_label: 'Note', description: 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.', slug: '/note', keywords: ['spotlight', 'callout'] },
    u = void 0,
    l = {},
    h = 'Note',
    d = 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.',
    j = 409,
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => m, VZ: () => w, cR: () => _, Pv: () => p, qZ: () => s, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => i, eQ: () => f, B_: () => v, o_: () => g, Rc: () => x });
