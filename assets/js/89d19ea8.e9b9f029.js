 ...
 [59088],
 {
  ...
  32662: (e, n, o) => {
   ...
   var l = o(52676),
    ...
    a = o(40761);
   function i(e) {
    const n = { div: 'div', h2: 'h2', li: 'li', p: 'p', ul: 'ul', ...(0, t.a)(), ...e.components };
  ...
  43599: (e, n, o) => {
   ...
   const v = (e) => {
    let { children: n } = e;
    return (0, g.jsx)(t.Tg, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(t.BB, { className: (0, s.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(t.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   v.displayName = 'ParagraphContainer';
   const m = (e) => {
    let { children: n } = e;
    return (0, g.jsx)(t.Tg, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(t.BB, { className: (0, s.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   m.displayName = 'DocumentContainer';
   const h = (e) => {
    let { children: n } = e;
    return (0, g.jsx)(t.Tg, { className: 'nlds-canvas__example-surface', children: n });
   };
   ...
   const b = (e) => {
    ...
    return (
     ...
     (0, g.jsxs)('div', {
      ...
      children: [
       _ && (0, g.jsx)('div', { className: (0, s.Z)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, g.jsx)(P, { children: (0, g.jsx)(t.pu, { children: _ }) }) }) }),
       y &&
        (0, g.jsx)('div', {
       ...
       y &&
        (0, g.jsxs)('div', {
         ...
         hidden: !z,
         children: [
          (0, g.jsx)(l.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: Z, trim: !0 }),
          o &&
           (0, g.jsx)('div', {
