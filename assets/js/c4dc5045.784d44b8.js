 ...
 [92043],
 {
  ...
  53838(e, n, t) {
   ...
   var o = t(86070),
    a = t(18439),
    r = t(75397);
   const l = { title: 'Zelf componenten uitbreiden', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Zelf componenten uitbreiden', sidebar_position: 4, pagination_label: 'Zelf componenten uitbreiden', description: 'Informatie voor designers over hoe je zelf componenten kunt uitbreiden in Figma met design tokens.', slug: '/handboek/designer/zelf-componenten-uitbreiden', keywords: ['index', 'designer', 'meedoen', 'componenten', 'figma', 'design tokens'] },
  ...
  75397(e, n, t) {
   ...
   const l = i.forwardRef(function (e, n) {
     const [t, l] = i.useState(!1),
      [d, s] = i.useState(e.alwaysLoadIframe || !1),
      ...
      j = i.useMemo(() => (e.playlist ? `${g}/embed/videoseries?${f.toString()}` : `${g}/embed/${c}?${f.toString()}`), [e.playlist, g, c, f]),
      ...
      y = k
       ...
       : null,
      w = i.useMemo(() => e.thumbnail || y || `https://i.ytimg.com/${x}/${e.playlist ? m : c}/${p}.${v}`, [e.thumbnail, y, x, e.playlist, m, c, p, v]),
     ...
     return (
      i.useEffect(() => {
       d && (L(), e.focusOnLoad && 'object' == typeof n && null != n && n.current && n.current.focus());
      }, [d, L, e.focusOnLoad, n]),
      (0, o.jsxs)(o.Fragment, {
       children: [
        !e.lazyLoad && (0, o.jsx)('link', { rel: N, href: w, as: 'image' }),
        (0, o.jsx)(o.Fragment, { children: t && (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('link', { rel: 'preconnect', href: g }), (0, o.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), C && (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, o.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
        e.seo && !e.playlist && (0, o.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: r(e.id, u, w, g, e.seo) } }),
        D && !e.playlist && (0, o.jsx)('noscript', { children: (0, o.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${u} on YouTube`, children: ['Watch "', u, '" on YouTube'] }) }),
        (0, o.jsxs)(S, {
         onPointerOver: () => {
          t || l(!0);
         },
         ...
         children: [e.lazyLoad && !d && (0, o.jsx)('img', { src: w, alt: `${u} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, o.jsx)('button', { type: 'button', className: I, 'aria-label': `${h} ${u}`, 'aria-hidden': d || void 0, tabIndex: d ? -1 : 0, children: (0, o.jsx)('span', { className: 'lty-visually-hidden', children: h }) }), d && (0, o.jsx)('iframe', { ref: n, className: F, title: u, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: j, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
    ...
    d = ({ id: e, title: n, ...t }) => {
     ...
     return (0, o.jsx)('div', { ref: a, children: (0, o.jsx)(l, { adNetwork: !1, announce: 'Bekijk', cookie: !1, containerElement: 'div', id: e, title: n, poster: 'maxresdefault', ...t }) });
    };
  },
 },
]);
