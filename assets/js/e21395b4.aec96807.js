/*! For license information please see e21395b4.aec96807.js.LICENSE.txt */
'use strict';
 ...
 [46190],
 {
  ...
  24414(e, n, a) {
   ...
   const o = { title: 'Notification Banner', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Notification Banner', pagination_label: 'Notification Banner', description: 'Toont een informerend bericht dat niet direct is gerelateerd aan de inhoud van een pagina.', issue_number: 169, slug: '/notification-banner', keywords: ['alert', 'banner', 'banner alert', 'call alert', 'callout', 'feedback', 'highlighter', 'inline alert', 'inline message', 'message', 'message bar', 'note', 'notificatie', 'notificatiebanner', 'notification', 'notification banner', 'page alert', 'panel', 'top of page alert', 'waarschuwing', 'warning'] },
    ...
    u = 'Toont een informerend bericht dat niet direct is gerelateerd aan de inhoud van een pagina.',
    m = 169,
    h = 'help wanted',
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => w, cR: () => N, Pv: () => f, qZ: () => l, kD: () => j, QQ: () => D, B2: () => m, Pc: () => o, f4: () => s, GT: () => k, fX: () => i, eQ: () => v, B_: () => x, o_: () => b });
