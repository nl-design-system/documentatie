...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [38384],
 {
  ...
  69847(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => b, componentName: () => x, contentTitle: () => g, default: () => v, description: () => c, frontMatter: () => d, issueNumber: () => p, metadata: () => t, relayStep: () => h, title: () => m, toc: () => f }));
   ...
   var i = a(86070),
    ...
    r = a(12761),
    o = a(17842);
   const d = { title: 'Description List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Description List', pagination_label: 'Description List', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', slug: '/description-list' },
    g = void 0,
    u = {},
    m = 'Description List',
    c = 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.',
    p = 92,
    h = 'help wanted',
    x = 'definition-list',
    b = l.find((e) => e.number === p),
    f = [
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => x, qZ: () => l, kD: () => v, B2: () => c, Pc: () => o, f4: () => r, GT: () => k, fX: () => s, eQ: () => j, B_: () => f, o_: () => b });
