 ...
 [80951],
 {
  ...
  82685: (e, n, t) => {
   ...
   const s = (e) => {
    ...
    return (0, a.jsx)(o.Z, { url: `https://youtube.com/watch?v=${n}`, className: `${(0, i.Z)(d["video-player"])} ${t}`, width: "100%", height: "100%", controls: !0, ...s, config: { youtube: { playerVars: { disablekb: 1 } } } });
   };
  },
 },
]);
