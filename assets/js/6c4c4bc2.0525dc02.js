 ...
 [87049],
 {
  ...
  53623: (e, n, l) => {
   ...
   const v = (e) => {
    ...
    m = (e) => {
     let n,
      { code: l, copy: i = !1, defaultCollapsed: s = !0, children: d, language: m } = e;
     ...
     return (0, u.jsxs)("div", {
      ...
      children: [
       (0, u.jsx)("div", { className: (0, r.Z)(g["nlds-canvas__example"]), children: (0, u.jsx)(o.pu, { className: "voorbeeld-theme", children: n }) }),
       (0, u.jsx)("div", { className: (0, r.Z)(g["nlds-canvas__toolbar"]), children: (0, u.jsx)(o.zx, { className: (0, r.Z)(g["nlds-canvas__button"], g["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: v, "aria-expanded": !s, "aria-controls": x, children: s ? "Bekijk code" : "Verberg code" }) }),
       (0, u.jsxs)("div", {
  ...
  30036: (e, n, l) => {
   ...
   const d = (e) => {
    ...
    const h = "Doen",
     b = "Niet doen";
    return (0, t.jsxs)("div", { className: (0, a.Z)(s["nlds-guideline"], s[`nlds-guideline--${l}`]), id: n?.toLowerCase().replace(/\s/g, "-"), children: [(0, t.jsxs)("div", { className: (0, a.Z)(s["nlds-guideline__description"]), children: ["dont" === l ? (0, t.jsxs)(t.Fragment, { children: [(0, t.jsxs)(i.nv, { className: (0, a.Z)(s["nlds-guideline__badge"], s[`nlds-guideline__badge--${l}`]), children: [(0, t.jsx)(o.Z, { className: s["nlds-guideline__icon"] }), (0, t.jsx)("span", { className: s["nlds-guideline__title"], children: b })] }), (0, t.jsx)(i.nv, { children: n })] }) : (0, t.jsxs)(t.Fragment, { children: [(0, t.jsxs)(i.nv, { className: (0, a.Z)(s["nlds-guideline__badge"], s[`nlds-guideline__badge--${l}`]), children: [(0, t.jsx)(r.Z, { className: s["nlds-guideline__icon"] }), (0, t.jsx)("span", { className: s["nlds-guideline__title"], children: h })] }), (0, t.jsx)(i.nv, { children: n })] }), d] }), (0, t.jsx)("div", { className: (0, a.Z)(s["nlds-guideline__example"]), children: c })] });
   };
  },
 },
]);
