...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [30588],
 {
  ...
  27012(e, n, i) {
   (i.r(n), i.d(n, { assets: () => m, contentTitle: () => v, default: () => k, frontMatter: () => j, metadata: () => r, toc: () => f }));
   const r = JSON.parse('{"id":"wcag/3.2.05","title":"WCAG-succescriterium 3.2.5 Verandering op verzoek","description":"Geef gebruikers volledige controle over veranderingen in de content. Of bied de mogelijkheid automatische veranderingen uit te zetten.","source":"@site/docs/wcag/3.2.05.mdx","sourceDirName":"wcag","slug":"/wcag/3.2.5","permalink":"/wcag/3.2.5","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.2.05.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 3.2.5 Verandering op verzoek","title_sm":"3.2.5 Verandering op verzoek","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"3.2.5 Verandering op verzoek","pagination_label":"WCAG-succescriterium 3.2.5 Verandering op verzoek","description":"Geef gebruikers volledige controle over veranderingen in de content. Of bied de mogelijkheid automatische veranderingen uit te zetten.","slug":"3.2.5","conformance_level":"Niveau AAA","keywords":["WCAG","AAA","begrijpelijk","voorspelbaar","understandable","predictable","change on request"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 3.2.4 Consistente identificatie","permalink":"/wcag/3.2.4"},"next":{"title":"WCAG-succescriterium 3.2.6 Consistente hulp","permalink":"/wcag/3.2.6"}}');
   var t = i(86070),
    s = i(18439),
    o = i(51582),
    l = i(66820),
   ...
   const j = { title: 'WCAG-succescriterium 3.2.5 Verandering op verzoek', title_sm: '3.2.5 Verandering op verzoek', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.5 Verandering op verzoek', pagination_label: 'WCAG-succescriterium 3.2.5 Verandering op verzoek', description: 'Geef gebruikers volledige controle over veranderingen in de content. Of bied de mogelijkheid automatische veranderingen uit te zetten.', slug: '3.2.5', conformance_level: 'Niveau AAA', keywords: ['WCAG', 'AAA', 'begrijpelijk', 'voorspelbaar', 'understandable', 'predictable', 'change on request'] },
    v = void 0,
    m = {},
