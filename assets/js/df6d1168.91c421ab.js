 ...
 [46756],
 {
  ...
  43599: (e, n, o) => {
   ...
   const g = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (N = await d.ZP.format(z, { parser: x, plugins: [r.Z, c.ZP, a.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(N);
     })();
    }, [z]);
    const S = (0, u.useId)();
    let P = u.Fragment;
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       _ && (0, p.jsx)('div', { className: (0, s.Z)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, p.jsx)(P, { children: (0, p.jsx)(t.pu, { children: _ }) }) }) }),
       f &&
        (0, p.jsx)('div', {
       ...
       f &&
        (0, p.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, p.jsx)(l.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: N, trim: !0 }),
          o &&
           (0, p.jsx)('div', {
