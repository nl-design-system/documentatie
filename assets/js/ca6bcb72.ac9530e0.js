 ...
 [29895],
 {
  ...
  45282(e, n, i) {
   ...
   const s = ({ children: e, ...n }) => {
     ...
     return ('https://nldesignsystem.nl' === l.origin ? ((l.pathname = l.pathname.endsWith('/') ? l.pathname : `${l.pathname}/`), (a = l.toString().replace('https://nldesignsystem.nl', ''))) : ((s.target = '_blank'), (s.rel = 'noopener noreferrer')), (0, t.jsx)('a', { href: a, ...s, children: e }));
    },
    a = ({ className: e, ...n }) => (0, t.jsx)(s, { className: (0, r.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  60316(e, n, i) {
   i.d(n, { $S: () => r, d1: () => t });
   i(74147);
