 ...
 [6985],
 {
  ...
  17889(e, n, t) {
   ...
   var p = t(35193),
    ...
    v = t(79532),
    A = t(30758);
   const x = { color: p.A, dimension: j.A, fontFamilies: y.A, fontSizes: b.A, fontWeights: w.A, lineHeights: f.A, other: k.A, textDecoration: v.A },
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => h, mJ: () => p, VZ: () => x, cR: () => A, Pv: () => j, qZ: () => o, kD: () => f, B2: () => m, Pc: () => c, f4: () => a, GT: () => k, fX: () => i, eQ: () => w, B_: () => b, o_: () => y, Rc: () => v });
  ...
  85825(e, n, t) {
   ...
   const p = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    j = ({ checked: e, children: n, title: t, description: r, headingLevel: i = 3 }) => (0, l.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(g.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [t ? (0, l.jsx)(m.DZ, { appearance: 'utrecht-heading-3', level: i, children: t }) : null, r, n] })] });
   var y = t(33062);
   const b = ({ component: e, headingLevel: n }) => {
     const t = e && e.projects.filter((e) => y.f4.includes(e.id)),
      i = t && y.f4.map((e) => t.find((n) => n.id === e)).filter(Boolean);
     return e && (0, l.jsx)(r.If, { sections: i.map((t) => ({ className: (0, s.A)('definition-of-done', t && `definition-of-done--${(0, y.fX)(t.title)}`), headingLevel: n, expanded: !1, label: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', body: t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p, { children: t.tasks.map(({ checked: e, name: t, id: r }) => (0, l.jsx)(j, { headingLevel: n + 1, checked: e, title: t, description: (0, y.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            o.Zp,
            {
             ...
             children: (0, l.jsxs)(o.Wu, {
              children: [
               ...
               a.length > 0 && (0, l.jsx)(l.Fragment, { children: a.map(({ frameworkName: e, tasks: t }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: n + 2, children: [s, ' in ', e] }), (0, l.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, l.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    k = ({ component: e, headingLevel: n, description: t }) => {
     const s = e && y.bo[e.relayStep];
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(h.p, { level: n, suffix: s && (0, l.jsx)(u.D, { state: s }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: t })] });
    };
  },
  90069(e, n, t) {
   'use strict';
   ...
   function M(e) {
    ...
    return (0, s.jsxs)(s.Fragment, {
     children: [
      ...
      '\n',
      (0, s.jsx)(y.Zp, { className: 'implementation-card', children: (0, s.jsxs)(y.Wu, { children: [(0, s.jsx)(w.D, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, s.jsxs)(b.dk, { children: [(0, s.jsxs)(b.N_, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=1233-4271', children: [(0, s.jsx)(f.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, s.jsxs)(b.N_, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=1233-4271', children: [(0, s.jsx)(f.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, s.jsx)(w.D, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, s.jsxs)(b.dk, { children: [(0, s.jsxs)(b.N_, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-number-badge--documentatie', children: [(0, s.jsx)(f.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, s.jsxs)(b.N_, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/number-badge--documentatie', children: [(0, s.jsx)(f.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, s.jsx)(w.D, { level: 2, appearance: 'level-4', children: 'npm' }), (0, s.jsxs)(b.dk, { children: [(0, s.jsxs)(b.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/number-badge-css', children: [(0, s.jsx)(f.r, { brand: 'npm' }), ' @nl-design-system-candidate/number-badge-css'] }), (0, s.jsxs)(b.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/number-badge-react', children: [(0, s.jsx)(f.r, { brand: 'npm' }), ' @nl-design-system-candidate/number-badge-react'] }), (0, s.jsxs)(b.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/number-badge-tokens', children: [(0, s.jsx)(f.r, { brand: 'npm' }), ' @nl-design-system-candidate/number-badge-tokens'] })] })] }) }),
      '\n',
      ...
      '\n',
      (0, s.jsx)(A.$9, { component: L, headingLevel: 2 }),
      '\n',
