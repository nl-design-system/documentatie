...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  22328: (e, s, n) => {
   n.r(s), n.d(s, { assets: () => l, contentTitle: () => i, default: () => m, frontMatter: () => t, metadata: () => a, toc: () => d });
   var o = n(52676),
    r = n(40139);
   const t = { title: 'Baseline oktober 2025', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Baseline oktober 2025', pagination_label: 'Baseline oktober 2025', description: 'De softwareversies waarmee we in oktober 2025 voor NL Design System testen voor Baseline support.', slug: '/baseline/2025-10', keywords: ['Accessibility Support Baseline', 'Baseline', 'browser support', 'browserversie'] },
    i = 'NL Design System Baseline: oktober 2025',
    a = { id: 'baseline/2025-10', title: 'Baseline oktober 2025', description: 'De softwareversies waarmee we in oktober 2025 voor NL Design System testen voor Baseline support.', source: '@site/docs/baseline/2025-10.mdx', sourceDirName: 'baseline', slug: '/baseline/2025-10', permalink: '/baseline/2025-10', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/baseline/2025-10.mdx', tags: [], version: 'current', frontMatter: { title: 'Baseline oktober 2025', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Baseline oktober 2025', pagination_label: 'Baseline oktober 2025', description: 'De softwareversies waarmee we in oktober 2025 voor NL Design System testen voor Baseline support.', slug: '/baseline/2025-10', keywords: ['Accessibility Support Baseline', 'Baseline', 'browser support', 'browserversie'] }, sidebar: 'handboek', previous: { title: 'Baseline september 2025', permalink: '/baseline/2025-09' }, next: { title: 'Woordenlijst', permalink: '/woordenlijst' } },
    l = {},
  ...
  40139: (e, s, n) => {
   ...
   function a(e) {
    let s;
    return (s = e.disableParentContext ? ('function' == typeof e.components ? e.components(r) : e.components || r) : i(e.components)), o.createElement(t.Provider, { value: s }, e.children);
   }
  },
 },
]);
