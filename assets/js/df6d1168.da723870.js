...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [46756],
 {
  ...
  58097: (e, n, o) => {
   o.r(n), o.d(n, { assets: () => v, contentTitle: () => h, default: () => _, frontMatter: () => p, metadata: () => m, toc: () => g });
   var l = o(52676),
    t = o(24785),
    s = o(98480),
    r = o(91050);
  ...
  98480: (e, n, o) => {
   ...
   const _ = (e) => {
    ...
    let P = d.Fragment;
    return (
     'paragraph' === y ? (P = v) : 'document' === y ? (P = g) : 'surface' === y && (P = b),
     (0, m.jsxs)('div', {
      className: (0, t.Z)(p['nlds-canvas']),
      children: [
       w && (0, m.jsx)('div', { className: (0, t.Z)(p['nlds-canvas__example']), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(P, { children: (0, m.jsx)(l.pu, { children: w }) }) }) }),
       f &&
        (0, m.jsx)('div', {
       ...
       f &&
        (0, m.jsxs)('div', {
         ...
         hidden: !F,
         children: [
          (0, m.jsx)(h.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: Z, trim: !0 }),
          o &&
           (0, m.jsx)('div', {
    ...
    return (
     ...
     (0, c.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, c.jsx)(l.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': m, style: o, children: t.map((e, o) => (0, c.jsxs)('span', { ...s({ line: e }), children: [n && (0, c.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, c.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, o)) })] });
      },
     })
    );
   }
   ...
   const d = (0, a.createContext)({}),
    u = (e) => {
     ...
     const h = { do: 'Doen', dont: 'Niet doen' },
      m = p ? 'figure' : 'div',
      v = p ? 'figcaption' : 'div';
     return (0, i.jsxs)(m, { className: (0, r.Z)(c['nlds-guideline'], c[`nlds-guideline--${o}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(v, { className: (0, r.Z)(c['nlds-guideline__description']), children: ['dont' === o ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(s.nv, { className: (0, r.Z)(c['nlds-guideline__badge'], c[`nlds-guideline__badge--${o}`]), children: [(0, i.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: c['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: c['nlds-guideline__title'], children: h.dont })] }), (0, i.jsx)(s.nv, { children: n })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(s.nv, { className: (0, r.Z)(c['nlds-guideline__badge'], c[`nlds-guideline__badge--${o}`]), children: [(0, i.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: c['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: c['nlds-guideline__title'], children: h.do })] }), (0, i.jsx)(s.nv, { children: n })] }), a] }), (0, i.jsx)('div', { className: (0, r.Z)(c['nlds-guideline__example']), children: (0, i.jsx)(d.Provider, { value: { title: n, type: h[o] }, children: u }) })] });
    };
  },
  24785: (e, n, o) => {
   o.d(n, { Z: () => a, a: () => r });
