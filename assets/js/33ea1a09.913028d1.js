 ...
 [99368],
 {
  1292(e, n, t) {
   ...
   var o = t(29181),
    ...
    l = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(r.A, {}), github: (0, d.jsx)(s.A, {}), npm: (0, d.jsx)(i.A, {}), storybook: (0, d.jsx)(a.A, {}) },
    m = ({ brand: e }) => (0, d.jsx)(o.In, { children: c[e] || (0, d.jsx)(l.A, {}) });
  },
  33062(e, n, t) {
   t.d(n, { bo: () => r, KF: () => p, mJ: () => h, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => i, kD: () => x, B2: () => u, Pc: () => l, f4: () => a, GT: () => k, fX: () => s, eQ: () => v, B_: () => b, o_: () => j, Rc: () => _ });
  ...
  37131(e, n, t) {
   ...
   const h = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
            ...
            i.Zp,
            {
             ...
             children: (0, d.jsxs)(i.Wu, {
              children: [
               ...
               a.length > 0 && (0, d.jsx)(d.Fragment, { children: a.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(o.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, d.jsx)(o.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.p, { level: n, suffix: r && (0, d.jsx)(m.D, { state: r }), children: e.title }), (0, d.jsx)(o.fz, { lead: !0, children: t })] });
    },
    x = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  51801(e, n, t) {
   (t.r(n), t.d(n, { assets: () => c, component: () => g, contentTitle: () => d, default: () => j, description: () => p, frontMatter: () => l, issueNumber: () => u, metadata: () => o, title: () => m, toc: () => h }));
   const o = JSON.parse('{"id":"componenten/root/index","title":"Root","description":"Onderlaag waarin basiskeuzes worden gemaakt voor alle componenten die in de website zitten.","source":"@site/docs/componenten/root/index.mdx","sourceDirName":"componenten/root","slug":"/root","permalink":"/root","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/root/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Root","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Root","pagination_label":"Root","description":"Onderlaag waarin basiskeuzes worden gemaakt voor alle componenten die in de website zitten.","slug":"/root","keywords":["html","body","root"]},"sidebar":"componenten","previous":{"title":"Rich Text Content","permalink":"/rich-text-content"},"next":{"title":"Select","permalink":"/select"}}');
   var r = t(86070),
    s = t(18439),
    i = t(64792),
    a = t(37131);
   const l = { title: 'Root', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Root', pagination_label: 'Root', description: 'Onderlaag waarin basiskeuzes worden gemaakt voor alle componenten die in de website zitten.', slug: '/root', keywords: ['html', 'body', 'root'] },
    d = void 0,
    c = {},
    m = 'Root',
    p = 'Onderlaag waarin basiskeuzes worden gemaakt voor alle componenten die in de website zitten.',
    u = 406,
