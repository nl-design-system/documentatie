 ...
 [16833],
 {
   ...
   const c = (e) => {
    ...
    a = (e) => {
     ...
     const u = (e) => ('article' === o ? (0, s.jsx)('article', { ...e }) : 'section' === o ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      l = (0, s.jsx)(u, { className: (0, i.Z)('cardgroup__card', `cardgroup__card--${n}`, c), children: a });
  ...
  94443: (e, t, n) => {
   ...
   var r = n(41115),
    ...
    u = n(32636),
    l = n(52676);
   const h = { figma: (0, l.jsx)(s.Z, {}), github: (0, l.jsx)(c.Z, {}), npm: (0, l.jsx)(o.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
   ...
   const f = (e) => {
          ...
          children: [
           (0, l.jsx)(b, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(v, { headingLevel: n + 1, checked: t, title: r, description: (0, k.Q6)(i) }, i);
            }),
           }),
               ...
               s.length > 0 &&
                (0, l.jsx)(l.Fragment, {
                 children: s.map((e) => {
                  ...
                  return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.X6, { level: n + 2, children: [i, ' in ', t] }), (0, l.jsx)(r.Mc, { links: s.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
    ...
    w = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(m.V, { level: n, suffix: s && (0, l.jsx)(y.y, { state: s }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => g, BA: () => o, Ee: () => l, Q6: () => s, U: () => j, Yr: () => p, d: () => h, e9: () => c, fO: () => v, mA: () => i, ps: () => y, qU: () => k, s0: () => b, zP: () => m });
