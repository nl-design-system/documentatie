/*! For license information please see 25ab1beb.40ea6314.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [40721],
 {
  ...
  76222(e, n, i) {
   i.r(n), i.d(n, { assets: () => u, contentTitle: () => c, default: () => p, frontMatter: () => m, metadata: () => s, toc: () => h });
   ...
   const m = { title: 'Rijkshuisstijl Community \xb7 Community Sprints \xb7 Community', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Rijkshuisstijl Community', pagination_label: 'Rijkshuisstijl Community', description: 'Lees meer over de NL Design System Rijkshuisstijl Community Sprint.', keywords: ['nl design system', 'community sprints', 'rijkshuisstijl community'] },
    c = 'Community Sprint: Rijkshuisstijl Community',
    u = {},
    h = [
  ...
  87423(e, n, i) {
   ...
   var o = s.forwardRef(function (e, n) {
    var i = s.useState(!1),
     ...
     g = new URLSearchParams(t(t(t(t({}, e.muted ? { mute: '1' } : {}), k ? { autoplay: '1' } : {}), e.enableJsApi ? { enablejsapi: '1' } : {}), e.playlist ? { list: c } : {}));
    e.params &&
    ...
    var y = e.playlist ? ''.concat(v, '/embed/videoseries?').concat(g.toString()) : ''.concat(v, '/embed/').concat(c, '?').concat(g.toString()),
    ...
    return (
     ...
     s.createElement(
      s.Fragment,
      null,
      s.createElement('link', { rel: O, href: C, as: 'image' }),
      ...
      s.createElement(
       I,
       {
        ...
        'data-title': h,
        style: t(t({ backgroundImage: 'url('.concat(C, ')') }, { '--aspect-ratio': ''.concat((S / D) * 100, '%') }), _),
       },
  ...
  99773(e, n, i) {
   ...
   const r = (e, n, i, r) => {
    const o = (0, s.forwardRef)(({ color: i = 'currentColor', size: o = 24, stroke: l = 2, title: a, className: d, children: m, ...c }, u) => (0, s.createElement)('svg', { ref: u, ...t[e], width: o, height: o, className: ['tabler-icon', `tabler-icon-${n}`, d].join(' '), ...('filled' === e ? { fill: i } : { strokeWidth: l, stroke: i }), ...c }, [a && (0, s.createElement)('title', { key: 'svg-title' }, a), ...r.map(([e, n]) => (0, s.createElement)(e, n)), ...(Array.isArray(m) ? m : [m])]));
