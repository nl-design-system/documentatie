(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [88474],
 {
  ...
  99781: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => S, component: () => V, contentTitle: () => L, default: () => E, description: () => P, frontMatter: () => Z, issueNumber: () => M, metadata: () => _, title: () => F, toc: () => D });
   var r,
    s,
    o,
    i,
               ...
               o.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: o.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: n + 2, children: [s, ' in ', t] }), (0, d.jsx)(r.Mc, { children: o.map((e) => (0, d.jsxs)(r.k7, { href: e.value, children: [(0, d.jsx)(u, { brand: e.brand }), ' ', e.description] }, e.id)) })] });
                 }),
                }),
              ],
             }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => c, Q6: () => o, U: () => l, e9: () => i, mA: () => s, ps: () => d });
