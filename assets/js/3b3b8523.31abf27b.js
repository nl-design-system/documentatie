...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [8742],
 {
  ...
  99257: (e, n, i) => {
   ...
   var a = i(33984);
   const d = { title: 'Gebruik geen HTML-formuliervalidatie | Foutmeldingen in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'HTML-formuliervalidatie', pagination_label: 'HTML-formuliervalidatie', description: 'Richtlijnen voor gebruik van HTML-formuliervalidatie in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/html-formuliervalidatie', keywords: ['labels', 'formulier', 'design', 'code'] },
    s = void 0,
    c = { id: 'richtlijnen/formulieren/error/no-native-validation/README', title: 'Gebruik geen HTML-formuliervalidatie | Foutmeldingen in een formulier | Richtlijnen', description: 'Richtlijnen voor gebruik van HTML-formuliervalidatie in een formulier.', source: '@site/docs/richtlijnen/formulieren/error/5-no-native-validation/README.mdx', sourceDirName: 'richtlijnen/formulieren/error/5-no-native-validation', slug: '/richtlijnen/formulieren/foutmeldingen/html-formuliervalidatie', permalink: '/richtlijnen/formulieren/foutmeldingen/html-formuliervalidatie', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/error/5-no-native-validation/README.mdx', tags: [], version: 'current', frontMatter: { title: 'Gebruik geen HTML-formuliervalidatie | Foutmeldingen in een formulier | Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'HTML-formuliervalidatie', pagination_label: 'HTML-formuliervalidatie', description: 'Richtlijnen voor gebruik van HTML-formuliervalidatie in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/html-formuliervalidatie', keywords: ['labels', 'formulier', 'design', 'code'] }, sidebar: 'richtlijnen', previous: { title: 'Plaatsing foutmelding', permalink: '/richtlijnen/formulieren/foutmeldingen/plaatsing' }, next: { title: 'Samenvatting fouten', permalink: '/richtlijnen/formulieren/foutmeldingen/samenvatting' } },
    u = {},
    m = [];
   function h(e) {
