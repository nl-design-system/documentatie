...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [1132],
 {
  ...
  54156(e, n, t) {
   ...
   const u = { title: 'Legends', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Legends in een fieldset', pagination_label: 'Legends in een fieldset', description: 'Richtlijnen voor legends in een fieldset in een formulier.', slug: '/richtlijnen/formulieren/fieldsets/legends', keywords: ['labels', 'formulier', 'design', 'code'] },
    h = void 0,
    m = {},
  ...
  75397(e, n, t) {
   ...
   const o = l.forwardRef(function (e, n) {
     ...
     return (
      ...
      (0, i.jsxs)(i.Fragment, {
       children: [
        !e.lazyLoad && (0, i.jsx)('link', { rel: D, href: k, as: 'image' }),
        ...
        (0, i.jsxs)(I, {
         ...
         style: { ...(!e.lazyLoad && { backgroundImage: `url(${k})` }), '--aspect-ratio': (L / S) * 100 + '%', ...(e.style || {}) },
         children: [e.lazyLoad && !a && (0, i.jsx)('img', { src: k, alt: `${u} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, i.jsx)('button', { type: 'button', className: R, 'aria-label': `${m} ${u}`, 'aria-hidden': a || void 0, tabIndex: a ? -1 : 0, children: (0, i.jsx)('span', { className: 'lty-visually-hidden', children: m }) }), a && (0, i.jsx)('iframe', { ref: n, className: _, title: u, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
    }),
    a = ({ id: e, title: n, ...t }) => (0, i.jsx)(o, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: n, ...t });
  },
  78734(e, n, t) {
   t.d(n, { Ay: () => o, RM: () => s });
   var i = t(86070),
