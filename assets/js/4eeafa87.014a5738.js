(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [44344],
 {
  183(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => u, component: () => p, componentName: () => g, contentTitle: () => h, default: () => k, description: () => j, frontMatter: () => l, issueNumber: () => y, metadata: () => r, relayStep: () => m, title: () => d, toc: () => f }));
   const r = JSON.parse('{"id":"componenten/note/index","title":"Note","description":"Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.","source":"@site/docs/componenten/note/index.mdx","sourceDirName":"componenten/note","slug":"/note","permalink":"/note","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/note/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Note","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Note","pagination_label":"Note","description":"Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.","slug":"/note","keywords":["spotlight","callout"]},"sidebar":"componenten","previous":{"title":"Navigation Bar","permalink":"/navigation-bar"},"next":{"title":"Notification Banner","permalink":"/notification-banner"}}');
   var i = n(86070),
    s = n(18439),
    c = n(36059),
    o = n(85825),
    a = n(44594);
   const l = { title: 'Note', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Note', pagination_label: 'Note', description: 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.', slug: '/note', keywords: ['spotlight', 'callout'] },
    h = void 0,
    u = {},
    d = 'Note',
    j = 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.',
    y = 409,
    m = 'help wanted',
    g = 'note',
  ...
  33062(e, t, n) {
   ...
   const u = (e) => [...e].sort((e, t) => l.indexOf(e) - l.indexOf(t)),
    ...
    m = (e) => u(h(e.projects.flatMap((e) => y(e)))),
    g = (e) => {
     const t = y(e),
      n = ((e) => {
  ...
  85825(e, t, n) {
   ...
   const f = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, l.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(g, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
