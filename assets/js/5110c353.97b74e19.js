(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [45900],
 {
       ...
       children: [
        ...
        (0, j.jsx)(o.BF, {
         children: t.map((n) => {
          const t = (0, s.o_)(n),
           c = (0, s.eQ)(e, n).$type;
          return (0, j.jsxs)(o.Hj, { children: [(0, j.jsx)(o.nA, { children: (0, j.jsx)(r.C, { children: (0, j.jsx)(o.kf, { children: t }) }) }), (0, j.jsx)(o.nA, { children: (0, j.jsxs)(i.K, { children: [(0, j.jsx)(z, { type: c }), ' ', c] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, j.jsxs)(o.e2, { children: [(0, j.jsx)(g, { content: a, language: 'json', children: 'Kopieer als JSON' }), (0, j.jsx)(g, { content: c, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  26813(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => ie, component: () => ae, contentTitle: () => re, default: () => ue, description: () => oe, frontMatter: () => te, issueNumber: () => ce, metadata: () => r, title: () => se, toc: () => le }));
   ...
   function de(e) {
    ...
    return (0, i.jsxs)(i.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, i.jsx)(K.Fc, { component: ae, headingLevel: 1, description: oe }),
      '\n',
      ...
      '\n',
      (0, i.jsx)(K.VK, { component: ae, headingLevel: 3 }),
      '\n',
      (0, i.jsx)(n.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }),
      '\n',
      (0, i.jsx)(K.$9, { component: ae, headingLevel: 3 }),
      '\n',
      (0, i.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
      '\n',
      (0, i.jsx)(K.mu, { component: ae, headingLevel: 3 }),
     ],
    });
   }
   function ue(e = {}) {
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => h, mJ: () => m, VZ: () => A, cR: () => y, Pv: () => p, qZ: () => o, kD: () => v, B2: () => j, Pc: () => a, f4: () => c, GT: () => x, fX: () => s, eQ: () => f, B_: () => k, o_: () => b, Rc: () => w });
