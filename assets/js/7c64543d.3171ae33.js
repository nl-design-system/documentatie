/*! For license information please see 7c64543d.3171ae33.js.LICENSE.txt */
'use strict';
 ...
 [89033],
 {
  ...
  18252(e, n, s) {
   ...
   var i = s(90578),
    ...
    r = s(13526),
    o = s(86070);
   const l = ({ name: e, organisation: n }) => (0, o.jsxs)(a.fz, { className: (0, r.A)('ma-session-table__speaker', 'ma-speaker'), children: [(0, o.jsx)(a.In, { className: 'ma-speaker__icon', children: (0, o.jsx)(t, {}) }), (0, o.jsx)('span', { className: 'ma-speaker__name', children: e }), (0, o.jsx)('br', {}), (0, o.jsx)('span', { className: 'ma-speaker__organisation', children: n })] }),
    c = ({ lang: e, sessions: n, speakers: s, className: t, ...c }) =>
     (0, o.jsx)('div', {
      ...
      children: (0, o.jsxs)(a.XI, {
       ...
       ...c,
       children: [
        (0, o.jsx)(a.A0, { children: (0, o.jsxs)(a.Hj, { className: 'ma-session-table__row', children: [(0, o.jsx)(a.M_, { className: 'ma-session-table__header-cell', children: 'nl-NL' === e ? 'Tijd' : 'Time' }), (0, o.jsx)(a.M_, { className: 'ma-session-table__header-cell', children: 'nl-NL' === e ? 'Taal' : 'Language' }), (0, o.jsx)(a.M_, { className: 'ma-session-table__header-cell', children: 'nl-NL' === e ? 'Spreker' : 'Speaker' }), (0, o.jsx)(a.M_, { className: 'ma-session-table__header-cell', children: 'nl-NL' === e ? 'Onderwerp' : 'Subject' }), (0, o.jsx)(a.M_, { className: 'ma-session-table__header-cell', children: 'nl-NL' === e ? 'Agenda' : 'Calendar' })] }) }),
        (0, o.jsx)(a.BF, {
         children: n.map(
          ({ isoDateTime: n, speakers: t, subject: r, icalLink: c, language: d, cancelled: m }, g) =>
           !m &&
           (0, o.jsxs)(
            a.Hj,
            {
             ...
             children: [
              (0, o.jsx)(a.nA, { className: 'ma-session-table__time', children: (0, o.jsx)(a.fz, { children: (0, o.jsx)('time', { dateTime: n, children: new Intl.DateTimeFormat(e, { hour: 'numeric', minute: 'numeric', timeZone: 'Europe/Amsterdam', timeZoneName: 'nl-NL' !== e ? 'short' : void 0 }).format(new Date(n)) }) }) }),
              (0, o.jsx)(a.nA, { className: 'ma-session-table__language', children: (0, o.jsx)('abbr', { title: d.description, children: d.abbr }) }),
              (0, o.jsx)(a.nA, {
              ...
              (0, o.jsx)(a.nA, { className: 'ma-session-table__subject', children: (0, o.jsx)(a.fz, { lang: d.abbr, children: (0, o.jsx)(a.N_, { href: `/events/design-systems-week-2025/${'nl-NL' === e ? 'programma' : 'EN' === d.abbr ? 'en/program' : 'programma'}#${r.toLowerCase().replace(/\s/gi, '-')}`, children: r }) }) }),
              (0, o.jsx)(a.nA, { className: 'ma-session-table__time', children: c && (0, o.jsxs)(a.vx, { href: c, download: c, 'aria-labelledby': 'ical-description', children: [(0, o.jsx)(a.In, { children: (0, o.jsx)(i.A, {}) }), ' ', (0, o.jsxs)('span', { id: 'ical-description', className: 'sr-only', children: ['iCal file for ', (0, o.jsx)('span', { lang: d.abbr, children: r }), '(download)'] })] }) }),
             ],
            },
            g,
           ),
  ...
  18652(e, n, s) {
   ...
   const a = (e, n, s, a) => {
    const r = (0, t.forwardRef)(({ color: s = 'currentColor', size: r = 24, stroke: o = 2, title: l, className: c, children: d, ...m }, g) => (0, t.createElement)('svg', { ref: g, ...i[e], width: r, height: r, className: ['tabler-icon', `tabler-icon-${n}`, c].join(' '), ...('filled' === e ? { fill: s } : { strokeWidth: o, stroke: s }), ...m }, [l && (0, t.createElement)('title', { key: 'svg-title' }, l), ...a.map(([e, n]) => (0, t.createElement)(e, n)), ...(Array.isArray(d) ? d : [d])]));
  ...
  24456(e, n, s) {
   ...
   const r = ({ children: e, ...n }) => {
    ...
    o = ({ className: e, ...n }) => (0, a.jsx)(r, { className: (0, t.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  29680(e, n, s) {
   s.d(n, { v: () => o });
   var t = s(24456),
    i = s(13526),
    a = s(86070);
   const r = ({ className: e, children: n, purpose: s, iconStart: t, iconEnd: r, href: o }) => (0, a.jsxs)('a', { className: (0, i.A)('nl-button', e, { 'nl-button--primary': 'primary' === s, 'nl-button--secondary': 'secondary' === s, 'nl-button--subtle': 'subtle' === s }), href: o, children: [t && (0, a.jsx)('span', { className: 'nl-button__icon-start', children: t }), (0, a.jsx)('span', { className: 'nl-button__label', children: n }), r && (0, a.jsx)('span', { className: 'nl-button__icon-end', children: r })] }),
    o = globalThis.isAstro
     ? ({ appearance: e, href: n, ...s }) => {
        let t = 'primary';
        return ((t = 'secondary-action' === e ? 'secondary' : t), (0, a.jsx)(r, { purpose: t, href: n, ...s }));
       }
     : ({ appearance: e, ...n }) => (0, a.jsx)(t.F, { className: (0, i.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...n });
  },
  35683(e, n, s) {
   s.d(n, { K: () => t.e2 });
   var t = s(29181);
  ...
  56561(e, n, s) {
   ...
   var m = (0, o.forwardRef)(function (e, n) {
    var s = e.children,
     ...
     c = e.purpose,
     m = (0, i.A)(e, l);
    return (0, a.jsx)('p', d(d({ className: (0, r.$)('nl-paragraph', (0, t.A)({}, 'nl-paragraph--lead', 'lead' === c), o), ref: n }, m), {}, { children: 'lead' === c ? (0, a.jsx)('b', { className: 'nl-paragraph__lead', children: s }) : s }));
   });
  ...
  63009(e, n, s) {
   ...
   var m = (0, o.forwardRef)(function (e, n) {
    var s = e.children,
     ...
     h = e.inlineBox,
     p = (0, i.A)(e, l);
    return (0, a.jsx)('a', d(d({ 'aria-current': c || void 0, 'aria-disabled': m, className: (0, r.$)('nl-link', (0, t.A)((0, t.A)((0, t.A)({}, 'nl-link--current', c), 'nl-link--disabled', m), 'nl-link--inline-box', h), o), href: m ? void 0 : g, role: m ? 'link' : void 0, ref: n, tabIndex: m ? 0 : void 0 }, p), {}, { children: s }));
   });
   m.displayName = 'Link';
  },
  64249(e, n, s) {
  ...
  70758(e, n, s) {
   (s.r(n), s.d(n, { assets: () => k, contentTitle: () => b, default: () => v, frontMatter: () => u, metadata: () => t, toc: () => j }));
   ...
   function y(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(n.header, { children: (0, i.jsxs)(n.h1, { id: 'design-systems-week-settingsyear-timetable', children: ['Design Systems Week ', p.Ok, ' Timetable'] }) }), '\n', (0, i.jsx)(c.f, { purpose: 'lead', children: (0, i.jsxs)(n.p, { children: ['NL Design System is organising the Design Systems Week for the ', p.en.Z, ' time. It will feature a number of\nshort talks about the how and why of design systems. All online. From ', p.en.M, ', we will cover subjects\nlike managing design systems, integrating accessibility, user research and code.'] }) }), '\n', !p.dF && (0, i.jsx)(o.K, { children: (0, i.jsxs)(r.v, { href: '/events/design-systems-week/en', appearance: 'primary-action', children: ['About Design Systems Week', (0, i.jsx)(d.A, { slot: 'icon-end' })] }) }), '\n', !!p.dF && (0, i.jsx)(i.Fragment, { children: (0, i.jsxs)(o.K, { children: [(0, i.jsxs)(r.v, { href: `/events/design-systems-week-${p.Ok}/en/program`, appearance: 'primary-action', children: ['See the program', (0, i.jsx)(d.A, { slot: 'icon-end' })] }), !!p.MX && (0, i.jsxs)(r.v, { href: p.MX, appearance: 'secondary-action', children: ['Use Miro', (0, i.jsx)(d.A, { slot: 'icon-end' })] })] }) }), '\n', !p.Ic && (0, i.jsx)(i.Fragment, { children: (0, i.jsx)(c.f, { children: 'The timetable is not yet final. The sessions will be further developed and added in the coming weeks. Keep an eye on this page for updates.' }) }), '\n', '\n', (0, i.jsx)(n.h2, { id: 'monday-october-26', children: 'Monday, October 26' }), '\n', (0, i.jsx)(h.F, { speakers: g, sessions: m.filter(({ isoDateTime: e }) => e.startsWith(`${p.Ok}-10-26`)) }), '\n', (0, i.jsx)(n.h2, { id: 'tuesday-october-27', children: 'Tuesday, October 27' }), '\n', (0, i.jsx)(h.F, { speakers: g, sessions: m.filter(({ isoDateTime: e }) => e.startsWith(`${p.Ok}-10-27`)) }), '\n', (0, i.jsx)(n.h2, { id: 'wednesday-october-28', children: 'Wednesday, October 28' }), '\n', (0, i.jsx)(h.F, { speakers: g, sessions: m.filter(({ isoDateTime: e }) => e.startsWith(`${p.Ok}-10-28`)) }), '\n', (0, i.jsx)(n.h2, { id: 'thursday-october-29', children: 'Thursday, October 29' }), '\n', (0, i.jsx)(h.F, { speakers: g, sessions: m.filter(({ isoDateTime: e }) => e.startsWith(`${p.Ok}-10-29`)) }), '\n', !!p.dF && (0, i.jsx)(i.Fragment, { children: (0, i.jsx)('hr', {}) }), '\n', (0, i.jsx)(n.h2, { id: 'organisation', children: 'Organisation' }), '\n', (0, i.jsxs)(n.p, { children: ['Design Systems Week is organised by the NL Design System core team, thanks to the support of the Ministry of the Interior and Kingdom Relations (BZK) and ', (0, i.jsx)(l.N, { href: 'https://international.gebruikercentraal.nl', children: 'User Needs First' }), '.'] }), '\n', (0, i.jsx)(n.h2, { id: 'code-of-conduct', children: 'Code of Conduct' }), '\n', (0, i.jsxs)(n.p, { children: ['All participants of Design Systems Week are expected to abide by our ', (0, i.jsx)(n.a, { href: 'https://github.com/nl-design-system/.github/blob/main/CODE_OF_CONDUCT.md', children: 'NL Design System Code of Conduct' }), ". By signing up for one or more sessions you've agreed to these terms."] }), '\n', (0, i.jsx)(n.h2, { id: 'accessibility', children: 'Accessibility' }), '\n', (0, i.jsxs)(n.p, { children: ['We do our best to organise Design Systems Week accessibly. If you have specific questions or requests, please do reach to the NL Design System core team at ', (0, i.jsx)(n.a, { href: 'mailto:info@nldesignsystem.nl', children: 'info@nldesignsystem.nl' }), '.'] })] });
   }
   function v(e = {}) {
  ...
  84471(e, n, s) {
   s.d(n, { bo: () => i, KF: () => g, mJ: () => u, VZ: () => x, cR: () => w, Pv: () => b, qZ: () => r, kD: () => v, QQ: () => O, B2: () => h, Pc: () => l, f4: () => o, GT: () => f, fX: () => a, eQ: () => y, B_: () => j, o_: () => k });
     ...
     return n.map((n) => {
      const t = e.tasks
       ...
       .map(({ name: t, id: i, value: a }) => {
        ...
        return { brand: r.toLowerCase(), name: t, id: i, value: a, description: o };
       });
