(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [49189],
 {
          ...
          (0, d.jsx)(o._Q, {
           ...
           children: u.map((e, t) => {
            ...
            if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
             const o = s.pI.get(e);
             n = (0, d.jsx)(r.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${o.sc} ${o.nl.title}`, style: { lineHeight: 1 }, children: (0, d.jsx)(i.K, { children: `WCAG ${e}` }) }, t);
            }
            return n;
           }),
          }),
  ...
  14889: (e, t, n) => {
   'use strict';
   n.d(t, { AC: () => l, Fu: () => i, Wu: () => c, Zp: () => a });
   var r = n(68873),
    s = n(13526),
    o = n(86070);
   const i = ({ background: e, children: t, className: n, ...r }) => (0, o.jsx)('div', { className: (0, s.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    c = (e) => (0, o.jsx)('div', { className: 'card__content', ...e }),
    a = ({ href: e, appearance: t, className: n, component: i = 'div', background: c, children: a }) => {
     const l = (e) => ('article' === i ? (0, o.jsx)('article', { ...e }) : 'section' === i ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(l, { className: (0, s.A)('cardgroup__card', c && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, o.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: d }) : d;
    },
    l = ({ appearance: e = 'medium', children: t, className: n }) => (0, o.jsx)('div', { className: (0, s.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
  17045: (e, t, n) => {
   'use strict';
   n.d(t, { Ay: () => c, RM: () => o });
  ...
  46563: (e, t, n) => {
   ...
   const i = (e, t) => {
    ...
    a = (e) => ({ img: ({ src: t, ...n }) => (0, o.jsx)('img', { ...n, src: i(e, t), className: 'utrecht-img utrecht-img--fit' }) }),
    l = (e, t) => {
     if (e) {
      const e = { ...c[t - 1] };
      return (e.h1 = () => null), e;
    ...
    d = ({ children: e, omitH1: t = !1, headingLevel: n = 1, baseUrl: s = '', components: i = {} }) => (0, o.jsx)(r.x, { components: { ...l(t, n), ...a(s), ...i }, children: e });
  },
  50341: (e, t, n) => {
   'use strict';
   n.d(t, { VK: () => x, $9: () => C, mu: () => b, Fc: () => T });
   var r = n(14537),
    s = n(13526),
    o = n(74172),
    i = n(15089),
    ...
    l = n(83386),
    d = n(86070);
   const h = { figma: (0, d.jsx)(o.A, {}), github: (0, d.jsx)(i.A, {}), npm: (0, d.jsx)(c.A, {}), storybook: (0, d.jsx)(a.A, {}) },
   ...
   const v = ({ children: e }) => (0, d.jsx)('ul', { className: 'task-list', children: e }),
    k = ({ checked: e, children: t, title: n, description: r, headingLevel: o = 3 }) => (0, d.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, d.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, d.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, d.jsx)(f.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(w.DZ, { appearance: 'utrecht-heading-3', level: o, children: n }), r, t] })] });
   var A = n(75916);
   const x = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => A.f4.includes(e.id)),
      o = n && A.f4.map((e) => n.find((t) => t.id === e)).filter(Boolean);
     return e && (0, d.jsx)(r.If, { sections: o.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, A.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(v, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, d.jsx)(k, { headingLevel: t + 1, checked: e, title: n, description: (0, A.qZ)(r) }, r)) }), (0, d.jsx)(r.fz, { children: (0, d.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
         ...
         children: n
          ...
          .map((e) => {
           const n = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            c = e.tasks.filter(({ name: e, value: t }) => i.has(e) && URL.canParse(t) && 'https:' === new URL(t).protocol);
           return (0, d.jsx)(
            m.Zp,
            {
             ...
             children: (0, d.jsxs)(m.Wu, {
              children: [
               ...
               (c.length > 0 || o.length > 0) && (0, d.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               c.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               o.length > 0 && (0, d.jsx)(d.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.DZ, { level: t + 2, children: [s, ' in ', e] }), (0, d.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, d.jsx)(u, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  62254: (e, t, n) => {
   ...
   const a = ({ children: e }) => (0, c.jsx)('ol', { className: 'nlds-anatomy-list', children: e }),
    ...
    d = ({ component: e, illustration: t }) => {
     const { title: d } = e,
      h = (0, i.fX)(d),
      u = o.lazy(() => n(51580)(`./${h}-docs/docs/anatomy/anatomy.md`).catch(() => ({ default: () => null })));
     return (0, c.jsx)(o.Suspense, { fallback: null, children: (0, c.jsxs)('figure', { className: (0, s.A)('component-anatomy'), children: [t && (0, c.jsx)(t, { height: null, className: (0, s.A)('component-anatomy__illustration') }), t && u && (0, c.jsx)('figcaption', { children: (0, c.jsx)(r.o, { omitH1: !0, headingLevel: 1, components: { ol: ({ children: e }) => (0, c.jsx)(a, { children: e }), li: ({ children: e }) => (0, c.jsx)(l, { children: e }) }, children: (0, c.jsx)(u, {}) }) })] }) });
    };
  },
  73361: (e, t, n) => {
   'use strict';
   ...
   var p = n(30696),
    ...
    A = n(43825),
    x = n(30758);
   const b = { color: p.A, dimension: j.A, fontFamilies: y.A, fontSizes: w.A, fontWeights: f.A, lineHeights: v.A, other: k.A, textDecoration: A.A },
    C = ({ type: e }) => (0, m.jsx)(u.In, { children: (0, x.createElement)(b[e]) });
   function T({ tokens: e }) {
    const t = (0, o.kD)(e),
     n = (0, o.GT)(t),
     c = n.map((e) => (0, o.B_)(e) + ': ;').join('\n'),
     a = JSON.stringify((0, o.Rc)(n));
       ...
       children: [
        ...
        (0, m.jsx)(i.BF, {
         children: n.map((t) => {
          const n = (0, o.o_)(t),
           c = (0, o.eQ)(e, t).$type;
          return (0, m.jsxs)(i.Hj, { children: [(0, m.jsx)(i.nA, { children: (0, m.jsx)(r.C, { children: (0, m.jsx)(i.kf, { children: n }) }) }), (0, m.jsx)(i.nA, { children: (0, m.jsxs)(s.K, { children: [(0, m.jsx)(C, { type: c }), ' ', c] }) })] }, n);
         }),
        }),
       ],
      }),
      (0, m.jsxs)(i.e2, { children: [(0, m.jsx)(g, { content: a, language: 'json', children: 'Kopieer als JSON' }), (0, m.jsx)(g, { content: c, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => u, B_: () => y, GT: () => v, KF: () => h, Pc: () => c, Pv: () => p, Rc: () => k, bo: () => r, eQ: () => w, f4: () => i, fX: () => s, kD: () => f, mJ: () => g, o_: () => j, qZ: () => o });
   ...
   const d = (e) => [...e].sort((e, t) => a.indexOf(e) - a.indexOf(t)),
    h = (e) => {
  ...
  81330: (e, t, n) => {
   ...
   var s = n(86070),
    ...
    d = n(40808);
   function h(e) {
    const t = { a: 'a', code: 'code', p: 'p', pre: 'pre', strong: 'strong', ...(0, o.R)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(t.p, { children: ['Gebruik voor tekst gemarkeerd als code semantische HTML. In het geval van de component Code is dat het HTML-element ', (0, s.jsx)(t.code, { children: 'code' }), '.'] }), '\n', (0, s.jsx)(t.p, { children: 'Dus niet zo:' }), '\n', (0, s.jsx)(t.pre, { children: (0, s.jsx)(t.code, { className: 'language-html', children: '\x3c!-- Foute code, niet gebruiken --\x3e\nEen zin over het element <span class="code">button</span> met een achtergrondkleur in CSS.\n' }) }), '\n', (0, s.jsx)(t.p, { children: 'Maar zo:' }), '\n', (0, s.jsx)(t.pre, { children: (0, s.jsx)(t.code, { className: 'language-html', children: 'Een zin over het element `<code>button</code>` met een achtergrondkleur in CSS.\n' }) }), '\n', (0, s.jsxs)(t.p, { children: [(0, s.jsx)(t.strong, { children: 'Let op' }), ': Het element ', (0, s.jsx)(t.code, { children: '<code>' }), ' wordt op het moment van schrijven (2025) nog niet ondersteund door alle hulpsoftware. Dat betekent niet dat bezoekers die bijvoorbeeld een ', (0, s.jsx)(t.a, { href: '/woordenlijst/#screenreader', children: 'screenreader' }), ' gebruiken de inhoud van het element niet horen, alleen dat er op dit moment niet wordt aangegeven dat het om een ', (0, s.jsx)(t.code, { children: 'code' }), ' element gaat.'] })] });
   }
   function u(e = {}) {
   ...
   function L(e) {
    const t = { a: 'a', h2: 'h2', h3: 'h3', p: 'p', ...(0, o.R)(), ...e.components };
    return (0, s.jsxs)(s.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, s.jsx)(k.Fc, { component: S, headingLevel: 1, description: z }),
      '\n',
      (0, s.jsx)(w.e, { component: S }),
      '\n',
      (0, s.jsx)(t.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, s.jsx)(f.H, { component: S, illustration: c.A }),
      '\n',
      (0, s.jsx)(t.h2, { id: 'candidate-component-gebruiken', children: 'Candidate component gebruiken' }),
      '\n',
      (0, s.jsxs)(t.p, { children: ['Let op: Gebruik de component ', (0, s.jsx)(t.a, { href: '/code-block/', children: 'Code Block' }), ' als de code meerdere regels beslaat.'] }),
      '\n',
      (0, s.jsx)(t.h3, { id: 'design-tokens', children: 'Design tokens' }),
      '\n',
      (0, s.jsx)(A.B, { tokens: T }),
      '\n',
      (0, s.jsx)(x.o, { omitH1: !0, headingLevel: 3, children: (0, s.jsx)(C, {}) }),
      '\n',
      ...
      (0, s.jsx)(v.b, {
       headingLevel: '4',
       items: [
        { title: 'De code is niet alleen herkenbaar aan een andere achtergrondkleur.', sc: '1.4.1', status: '', component: (0, s.jsx)(y.Ay, {}), tags: ['designer', 'contentmaker', 'developer'] },
        { title: 'De code heeft voldoende contrast met de achtergrondkleur.', sc: '1.4.3', status: '', component: (0, s.jsx)(p.Ay, {}), tags: ['designer', 'contentmaker'] },
        { title: 'Wanneer de achtergrondkleur van de Code component anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina.', sc: '1.4.11', status: '', component: (0, s.jsx)(m.Ay, {}), tags: ['designer', 'contentmaker'] },
       ],
      }),
      '\n',
      ...
      (0, s.jsx)(v.b, {
       headingLevel: '4',
       items: [
        { title: 'Het juiste HTML-element voor de Code component is toegepast.', sc: '1.3.1', status: '', component: (0, s.jsx)(u, {}), tags: ['developer'] },
  ...
  92420: (e, t, n) => {
   ...
   var r = n(71170),
    s = n(13526),
    o = n(86070);
   const i = ({ className: e, ...t }) => (0, o.jsx)(r.A, { className: (0, s.$)('utrecht-link', 'utrecht-link--html-a', e), ...t });
  },
  98584: (e, t, n) => {
   'use strict';
   n.d(t, { p: () => o });
   var r = n(13526),
    s = n(86070);
   const o = ({ children: e, className: t, level: n = 1, suffix: o, ...i }) => (0, s.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, t), ...i, children: [(0, s.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), o && (0, s.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
  },
 },
]);
