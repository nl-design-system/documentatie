   ...
   const c = (0, i.createContext)({}),
    h = ({ title: e, appearance: n, description: t, children: i, figure: h }) => {
     const j = { do: 'Doen', dont: 'Niet doen' },
      p = h ? 'figure' : 'div',
      m = h ? 'figcaption' : 'div',
      u = 'string' == typeof t ? (0, d.jsx)(a.oz, { children: t }) : t;
      ...
      children: [
       ...
       k &&
        (0, p.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, p.jsx)(l.M, { codeBlockLabel: 'Codevoorbeeld', syntax: v, textContent: z, trim: !0 }),
          n &&
           (0, p.jsx)('div', {
