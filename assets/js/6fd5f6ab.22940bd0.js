 ...
 [53087],
 {
  1292(e, n, t) {
   ...
   var r = t(29181),
    ...
    a = t(83386),
    l = t(86070);
   const d = { figma: (0, l.jsx)(i.A, {}), github: (0, l.jsx)(s.A, {}), npm: (0, l.jsx)(o.A, {}), storybook: (0, l.jsx)(c.A, {}) },
  ...
  17889(e, n, t) {
   ...
   var m = t(35193),
    ...
    x = t(79532),
    A = t(30758);
   const b = { color: m.A, dimension: j.A, fontFamilies: k.A, fontSizes: y.A, fontWeights: w.A, lineHeights: v.A, other: f.A, textDecoration: x.A },
   ...
   function C({ tokens: e }) {
    ...
    return (0, g.jsxs)(g.Fragment, {
     children: [
      ...
      (0, g.jsxs)(o.e2, { children: [(0, g.jsx)(p, { content: a, language: 'json', children: 'Kopieer als JSON' }), (0, g.jsx)(p, { content: c, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => u, mJ: () => m, VZ: () => b, cR: () => A, Pv: () => j, qZ: () => o, kD: () => v, B2: () => g, Pc: () => a, f4: () => c, GT: () => f, fX: () => s, eQ: () => w, B_: () => y, o_: () => k, Rc: () => x });
  ...
  65149(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => D, component: () => M, contentTitle: () => S, default: () => E, description: () => F, frontMatter: () => z, issueNumber: () => H, metadata: () => r, title: () => L, toc: () => O }));
   ...
   const z = { title: 'Heading', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading', pagination_label: 'Heading', description: 'Koptekst die in de koppenstructuur ingesteld kan worden op het juiste niveau.', slug: '/heading', keywords: ['bold-text', 'caption', 'content', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'header', 'heading', 'heading level', 'headline', 'hoofdkop', 'hoofdstuk', 'hoofdtekst', 'hyperlink', 'kop', 'kopje', 'kop tekst', 'koptekst', 'linktekst', 'pagina titel', 'paragraaf titel', 'sectie', 'section', 'structure', 'titel', 'title', 'tussenkop', 'tussenkopje', 'url'] },
    ...
    D = {},
    L = 'Heading',
    F = 'Koptekst die in de koppenstructuur ingesteld kan worden op het juiste niveau.',
    H = 114,
    M = o.find((e) => e.number === H),
   ...
   function P(e) {
    ...
    return (0, i.jsxs)(i.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, i.jsx)(C.Fc, { component: M, headingLevel: 1, description: F }),
      '\n',
      (0, i.jsx)(b.e, { component: M }),
      '\n',
      (0, i.jsx)(v.Zp, { className: 'implementation-card', children: (0, i.jsxs)(v.Wu, { children: [(0, i.jsx)(x.D, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, i.jsxs)(f.dk, { children: [(0, i.jsxs)(f.N_, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=153-1039', children: [(0, i.jsx)(A.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, i.jsxs)(f.N_, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=153-1039', children: [(0, i.jsx)(A.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, i.jsx)(x.D, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, i.jsxs)(f.dk, { children: [(0, i.jsxs)(f.N_, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-heading--documentatie', children: [(0, i.jsx)(A.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, i.jsxs)(f.N_, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/heading--documentatie', children: [(0, i.jsx)(A.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, i.jsx)(x.D, { level: 2, appearance: 'level-4', children: 'npm' }), (0, i.jsxs)(f.dk, { children: [(0, i.jsxs)(f.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/heading-css', children: [(0, i.jsx)(A.r, { brand: 'npm' }), ' @nl-design-system-candidate/heading-css'] }), (0, i.jsxs)(f.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/heading-react', children: [(0, i.jsx)(A.r, { brand: 'npm' }), ' @nl-design-system-candidate/heading-react'] }), (0, i.jsxs)(f.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/heading-tokens', children: [(0, i.jsx)(A.r, { brand: 'npm' }), ' @nl-design-system-candidate/heading-tokens'] })] })] }) }),
      '\n',
      ...
      (0, i.jsx)(T.b, {
       headingLevel: '4',
       items: [
        { title: 'Het niveau van de kop klopt binnen de koppenstructuur van de pagina.', sc: '1.3.1', status: '', component: (0, i.jsx)(h, {}), tags: ['contentmaker'] },
        { title: 'De contrastverhouding van de tekstkleur met de achtergrondkleur is hoog genoeg.', sc: '1.4.3', status: '', component: (0, i.jsx)(m.Ay, {}), tags: ['designer', 'contentmaker'] },
        { title: 'De koptekst maakt duidelijk waar de sectie over gaat.', sc: '2.4.6', status: '', component: (0, i.jsx)(y, {}), tags: ['designer', 'contentmaker'] },
        { title: 'Als de kop in een andere taal is dan de rest van de pagina, dan heeft het lang-attribuut de juiste taalcode.', sc: '3.1.2', status: '', component: (0, i.jsx)(w.Ay, {}), tags: ['contentmaker', 'developer'] },
       ],
      }),
      '\n',
      ...
      (0, i.jsx)(T.b, {
       headingLevel: '4',
       items: [
        { title: 'Als tekst er uitziet als een kop, moet dit ook in de HTML een kop zijn.', sc: '1.3.1', status: '', component: (0, i.jsx)(g, {}), tags: ['developer'] },
        { title: 'Als je de tekst vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: (0, i.jsx)(j.Ay, {}), tags: ['developer'] },
      ...
      '\n',
      (0, i.jsx)(G.o, { omitH1: !0, headingLevel: 2, children: (0, i.jsx)(W, {}) }),
      '\n',
      (0, i.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }),
      '\n',
      (0, i.jsx)(R.B, { tokens: _ }),
      '\n',
      (0, i.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, i.jsx)(C.VK, { component: M, headingLevel: 3 }),
      '\n',
      (0, i.jsx)(C.$9, { component: M, headingLevel: 2 }),
      '\n',
      (0, i.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
      '\n',
      (0, i.jsx)(C.mu, { component: M, headingLevel: 3 }),
     ],
    });
   }
   function E(e = {}) {
  ...
  99630(e, n, t) {
   ...
   const p = ({ children: e }) => (0, a.jsx)('ul', { className: 'task-list', children: e }),
    m = ({ checked: e, children: n, title: t, description: r, headingLevel: s = 3 }) => (0, a.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, a.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, a.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, a.jsx)(g.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, a.jsxs)('div', { children: [t ? (0, a.jsx)(u.DZ, { appearance: 'utrecht-heading-3', level: s, children: t }) : null, r, n] })] });
   var j = t(33062);
   const k = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, a.jsx)(r.If, { sections: s.map((t) => ({ className: (0, i.A)('definition-of-done', t && `definition-of-done--${(0, j.fX)(t.title)}`), headingLevel: n, expanded: !1, label: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', body: t && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(p, { children: t.tasks.map(({ checked: e, name: t, id: r }) => (0, a.jsx)(m, { headingLevel: n + 1, checked: e, title: t, description: (0, j.qZ)(r) }, r)) }), (0, a.jsx)(r.fz, { children: (0, a.jsxs)(r.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            o.Zp,
            {
             ...
             children: (0, a.jsxs)(o.Wu, {
              children: [
               ...
               (h.length > 0 || c.length > 0) && (0, a.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, a.jsx)(a.Fragment, {
                 children: (0, a.jsx)(r.dk, {
                  links: h
                   ...
                   .map((e) => {
                    ...
                    return { children: n.desciption, icon: (0, a.jsx)(s.r, { brand: n.brand }), href: e.value };
                   }),
                 }),
                }),
               c.length > 0 && (0, a.jsx)(a.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, a.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, a.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(h.p, { level: n, suffix: i && (0, a.jsx)(d.D, { state: i }), children: e.title }), (0, a.jsx)(r.fz, { lead: !0, children: t })] });
    };
  },
 },
]);
