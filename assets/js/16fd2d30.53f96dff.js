 ...
 [32139],
 {
  1292(e, t, n) {
   ...
   var r = n(14537),
    ...
    a = n(83386),
    l = n(86070);
   const h = { figma: (0, l.jsx)(s.A, {}), github: (0, l.jsx)(o.A, {}), npm: (0, l.jsx)(c.A, {}), storybook: (0, l.jsx)(i.A, {}) },
  ...
  12013(e, t, n) {
   ...
   const c = (e, t) => {
    ...
    a = (e) => ({ img: ({ src: t, ...n }) => (0, o.jsx)('img', { ...n, src: c(e, t), className: 'utrecht-img utrecht-img--fit' }) }),
    l = (e, t) => {
     if (e) {
      const e = { ...i[t - 1] };
      return (e.h1 = () => null), e;
    ...
    h = ({ children: e, omitH1: t = !1, headingLevel: n = 1, baseUrl: s = '', components: c = {} }) => (0, o.jsx)(r.x, { components: { ...l(t, n), ...a(s), ...c }, children: e });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => u, mJ: () => y, VZ: () => _, cR: () => x, Pv: () => g, qZ: () => c, kD: () => k, B2: () => m, Pc: () => a, f4: () => i, GT: () => f, fX: () => o, eQ: () => q, B_: () => v, o_: () => p, Rc: () => b });
      ...
      const r = e.tasks
       ...
       .map(({ name: r, id: s, value: o }) => {
        const c = /^(.+) URL/.exec(r)[1],
         i = 'Storybook' === c ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${c}`;
        return { brand: c.toLowerCase(), name: r, id: s, value: o, description: i };
       });
  ...
  47451(e, t, n) {
   'use strict';
   n.r(t), n.d(t, { assets: () => b, component: () => N, contentTitle: () => f, default: () => A, description: () => _, frontMatter: () => k, issueNumber: () => w, metadata: () => r, title: () => x, toc: () => T });
  ...
  72642(e, t, n) {
   ...
   var r = n(13526),
    s = n(86070);
   const o = ({ children: e, className: t, level: n = 1, suffix: o, ...c }) => (0, s.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, t), ...c, children: [(0, s.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), o && (0, s.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
  },
  74111(e, t, n) {
  ...
  84068(e, t, n) {
   ...
   const a = ({ children: e }) => (0, i.jsx)('ol', { className: 'nlds-anatomy-list', children: e }),
    ...
    h = ({ component: e, illustration: t }) => {
     const { title: h } = e,
      d = (0, c.fX)(h),
      u = o.lazy(() => n(51580)(`./${d}-docs/docs/anatomy/anatomy.md`).catch(() => ({ default: () => null })));
     return (0, i.jsx)(o.Suspense, { fallback: null, children: (0, i.jsxs)('figure', { className: (0, s.A)('component-anatomy'), children: [t && (0, i.jsx)(t, { height: null, className: (0, s.A)('component-anatomy__illustration') }), t && u && (0, i.jsx)('figcaption', { children: (0, i.jsx)(r.o, { omitH1: !0, headingLevel: 1, components: { ol: ({ children: e }) => (0, i.jsx)(a, { children: e }), li: ({ children: e }) => (0, i.jsx)(l, { children: e }) }, children: (0, i.jsx)(u, {}) }) })] }) });
    };
  },
  90495(e, t, n) {
   'use strict';
   n.d(t, { AC: () => l, Fu: () => c, Wu: () => i, Zp: () => a });
   var r = n(68873),
    s = n(13526),
    o = n(86070);
   const c = ({ background: e, children: t, className: n, ...r }) => (0, o.jsx)('div', { className: (0, s.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    i = (e) => (0, o.jsx)('div', { className: 'card__content', ...e }),
    a = ({ href: e, appearance: t, className: n, component: c = 'div', background: i, children: a }) => {
     const l = (e) => ('article' === c ? (0, o.jsx)('article', { ...e }) : 'section' === c ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      h = (0, o.jsx)(l, { className: (0, s.A)('cardgroup__card', i && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, o.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: h }) : h;
    },
    l = ({ appearance: e = 'medium', children: t, className: n }) => (0, o.jsx)('div', { className: (0, s.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
  99630(e, t, n) {
   'use strict';
   n.d(t, { VK: () => p, $9: () => q, mu: () => v, Fc: () => k });
   var r = n(14537),
    s = n(13526),
    o = n(1292),
    c = n(90495),
   ...
   const p = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, a.jsx)(r.If, { sections: o.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, g.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(j, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, a.jsx)(y, { headingLevel: t + 1, checked: e, title: n, description: (0, g.qZ)(r) }, r)) }), (0, a.jsx)(r.fz, { children: (0, a.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            c.Zp,
            {
             ...
             children: (0, a.jsxs)(c.Wu, {
              children: [
               ...
               (d.length > 0 || i.length > 0) && (0, a.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               d.length > 0 &&
                (0, a.jsx)(a.Fragment, {
               ...
               i.length > 0 && (0, a.jsx)(a.Fragment, { children: i.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [s, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
