 ...
 [18227],
 {
  14881(e, n, o) {
   ...
   var s = o(13526),
    ...
    r = o(37168),
    a = o(86070);
   const i = (0, t.forwardRef)(({ as: e, className: n, children: o, ...t }, l) => {
     const r = e || 'div',
      i = (0, s.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(r, { ref: l, className: i, ...t, children: o });
    }),
    c = ({ className: e, classNamePanel: n, label: o, heading: t, headingLevel: i, headingApperance: c, ...d }) => {
     const p = (0, s.A)('utrecht-accordion__section', e),
      m = (0, s.A)('utrecht-accordion__panel', n);
     return (0, a.jsxs)('details', { className: p, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(l.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [t && (0, a.jsx)(r.D, { level: i, appearance: c, children: t }), o] })] }) }), (0, a.jsx)('div', { className: m, children: d.children })] });
    };
  },
  18439(e, n, o) {
   o.d(n, { R: () => r, x: () => a });
  ...
  28369(e, n, o) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: o, trim: c }) {
    let d = o;
    const { title: p, type: m } = (0, l.useContext)(r.x),
     u = (0, l.useId)();
    return (c && (d = d.trim()), (0, i.jsx)(t.f4, { theme: a, code: d, language: n || '', children: ({ style: n, tokens: o, getLineProps: t, getTokenProps: l }) => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: u, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, i.jsx)(s.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': u, style: n, children: o.map((n, o) => (0, i.jsxs)('span', { ...t({ line: n }), children: [e && (0, i.jsx)('span', { children: o + 1 }), n.map((e, n) => (0, i.jsx)('span', { ...l({ token: e }) }, n)), '\n'] }, o)) })] }) }));
   }
  },
  38953(e, n, o) {
   o.d(n, { H: () => f });
   var s = o(28369),
    ...
    v = o(46847),
    x = o(86070);
   const j = ({ children: e }) => (0, x.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, x.jsx)(t.yo, { className: (0, l.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, x.jsx)(t.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   j.displayName = 'ParagraphContainer';
   const b = ({ children: e }) => (0, x.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, x.jsx)(t.yo, { className: (0, l.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const f = globalThis.isAstro
    ? ({ language: e, className: n, code: o = '<p>No code provided</p>', rawCode: s, copyCode: t, defaultExpandedCode: r, designTokens: a }) => {
       const i = 'string' == typeof o ? o : s || '',
        c = 'string' == typeof o ? h().highlight(o, h().languages[e], e) : h().highlight(s || '', h().languages[e], e);
       return (0, x.jsxs)('div', { className: (0, l.A)('ma-canvas-astro', n), children: [(0, x.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: a, children: (0, x.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: i } }) }), (0, x.jsx)(g.n, { children: (0, x.jsxs)(g.K, { label: 'Code', open: r, children: [(0, x.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, x.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: c } }) }), 'allow' === t && (0, x.jsx)(v.$, { 'data-copy-code': i, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: u = !0, children: h, container: g = 'document', language: v, designTokens: f }) => {
       ...
       return (
        ...
        (0, x.jsxs)('div', {
         ...
         children: [
          _ && (0, x.jsx)('div', { className: (0, l.A)('nlds-canvas__example'), children: (0, x.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, x.jsx)(P, { children: (0, x.jsx)(t.v$, { children: _ }) }) }) }),
          u &&
           (0, x.jsx)('div', {
  ...
  42574(e, n, o) {
   ...
   function c(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', (0, t.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, t.jsx)(i.$, { appearance: 'do', title: 'Info boven het form element.', children: (0, t.jsx)(a.H, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)('h2', { children: 'Uw gegevens' }), (0, t.jsx)('p', { children: 'Stap 2 van 3' }), (0, t.jsx)('form', { children: '[... inhoud formulier \u2026]' })] }) }) }), '\n', (0, t.jsx)(i.$, { appearance: 'do', title: 'De tekst van de stap opnemen in het kopje, boven het formulier.', description: 'En deze tekst visueel op een andere regel plaatsen. ', children: (0, t.jsx)(a.H, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsxs)('h2', { children: [(0, t.jsx)('span', { class: 'example-progress-indicator', children: 'Stap 2 van 3' }), 'Uw gegevens'] }), (0, t.jsx)('form', { children: '[... inhoud formulier \u2026]' })] }) }) }), '\n', (0, t.jsx)(i.$, { appearance: 'dont', title: 'Info binnen het formulier.', children: (0, t.jsx)(a.H, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)('h2', { children: 'Uw gegevens' }), (0, t.jsxs)('form', { children: [(0, t.jsx)('h3', { children: 'Stap 2 van 3' }), '[... inhoud formulier \u2026]'] })] }) }) })] });
   }
   function d(e = {}) {
