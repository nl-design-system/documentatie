 ...
 [64279],
 {
      ...
      children: [
       ...
       j &&
        (0, m.jsxs)('div', {
         ...
         hidden: !P,
         children: [
          (0, m.jsx)(p.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: z, trim: !0 }),
          l &&
           (0, m.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: l, textContent: c, trim: d } = e,
     u = c;
    const { title: b, type: p } = (0, s.useContext)(a.n),
     m = (0, s.useId)();
    return (
     d && (u = u.trim()),
     (0, r.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', b ? ': ' : ' ', b] }), (0, r.jsx)(t.dn, { tabIndex: 0, role: b ? 'region' : void 0, 'aria-labelledby': m, style: l, children: o.map((e, l) => (0, r.jsxs)('span', { ...s({ line: e }), children: [n && (0, r.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, r.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const d = (0, i.createContext)({}),
    u = (e) => {
     let { title: n, appearance: l, description: i, children: u, figure: b } = e;
     const p = { do: 'Doen', dont: 'Niet doen' },
      m = b ? 'figure' : 'div',
      h = b ? 'figcaption' : 'div';
     return (0, c.jsxs)(m, { className: (0, a.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(h, { className: (0, a.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: p.dont })] }), (0, c.jsx)(s.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: p.do })] }), (0, c.jsx)(s.nv, { children: n })] }), i] }), (0, c.jsx)('div', { className: (0, a.Z)(r['nlds-guideline__example']), children: (0, c.jsx)(d.Provider, { value: { title: n, type: p[l] }, children: u }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => i, a: () => a });
