 ...
 [83373],
 {
  89887: (e, t, n) => {
   ...
   const s = { title: 'Calendar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Calendar', pagination_label: 'Calendar', description: ' ', slug: '/Calendar', sidebar_custom_props: { illustration: 'CalendarSketch' } },
    a = void 0,
    l = { id: 'componenten/calendar/index', title: 'Calendar', description: ' ', source: '@site/docs/componenten/calendar/index.mdx', sourceDirName: 'componenten/calendar', slug: '/Calendar', permalink: '/Calendar', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/calendar/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Calendar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Calendar', pagination_label: 'Calendar', description: ' ', slug: '/Calendar', sidebar_custom_props: { illustration: 'CalendarSketch' } }, sidebar: 'componenten', previous: { title: 'Button', permalink: '/button' }, next: { title: 'Card as link', permalink: '/card-as-link' } },
    u = {},
    d = [
