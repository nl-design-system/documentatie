...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [94810],
 {
  ...
  30930(e, n, t) {
   (t.r(n), t.d(n, { assets: () => N, component: () => C, contentTitle: () => A, default: () => _, description: () => F, frontMatter: () => w, issueNumber: () => S, metadata: () => i, title: () => y, toc: () => T }));
   ...
   const b = [
     { title: 'De Ordered List bestaat uit een list met list-items.', sc: '1.3.1', status: '', component: l.Ay, tags: ['developer'] },
  ...
  76097(e, n, t) {
   t.d(n, { bo: () => a, KF: () => u, mJ: () => h, VZ: () => D, cR: () => L, Pv: () => j, qZ: () => o, kD: () => k, B2: () => m, Pc: () => s, f4: () => l, GT: () => f, fX: () => r, eQ: () => v, B_: () => b, o_: () => x });
