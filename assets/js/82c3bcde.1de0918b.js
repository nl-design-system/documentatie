(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [92703],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => p, qZ: () => s, kD: () => b, B2: () => j, Pc: () => a, f4: () => o, GT: () => k, fX: () => c, eQ: () => v, B_: () => f, o_: () => g, Rc: () => x });
  ...
  79919(e, t, n) {
   ...
   var i = n(86070),
    ...
    s = n(57641),
    o = n(1842);
   const a = { title: 'Form Field Label Suffix', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Field Label Suffix', pagination_label: 'Form Field Label Suffix', description: 'Toont een tekstlabel dat aangeeft dat de in te vullen informatie wel of niet verplicht is.', slug: '/form-field-label-suffix', keywords: ['suffix', 'form field label suffix', 'form label', 'form label suffix', 'optioneel', 'optional', 'niet verplicht', 'not required', 'verplicht', 'required', 'asterisk', 'sterretje'] },
    l = void 0,
    u = {},
    h = 'Form Field Label Suffix',
    d = 'Toont een tekstlabel dat aangeeft dat de in te vullen informatie wel of niet verplicht is.',
    j = 417,
