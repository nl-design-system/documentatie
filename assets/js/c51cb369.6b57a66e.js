 ...
 [90258],
 {
  47202: (e, t, n) => {
   ...
   const s = { title: 'Language navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Language navigation', pagination_label: 'Language navigation', description: 'Biedt de optie om een andere taal te selecteren.', slug: '/language-navigation', sidebar_custom_props: { illustration: 'LanguageNavigationSketch' } },
    a = void 0,
    u = { id: 'componenten/language-navigation/index', title: 'Language navigation', description: 'Biedt de optie om een andere taal te selecteren.', source: '@site/docs/componenten/language-navigation/index.mdx', sourceDirName: 'componenten/language-navigation', slug: '/language-navigation', permalink: '/language-navigation', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/language-navigation/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Language navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Language navigation', pagination_label: 'Language navigation', description: 'Biedt de optie om een andere taal te selecteren.', slug: '/language-navigation', sidebar_custom_props: { illustration: 'LanguageNavigationSketch' } }, sidebar: 'componenten', previous: { title: 'Invalid form alert', permalink: '/invalid-form-alert' }, next: { title: 'Legend', permalink: '/legend' } },
    l = {},
    d = [
