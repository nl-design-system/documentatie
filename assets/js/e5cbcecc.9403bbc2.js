 ...
 [70096],
 {
  ...
  58639(e, n, o) {
   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: j = !0, children: y, container: b = 'document', language: x, designTokens: f }) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(k, { parser: x, plugins: [s.A, a.Ay, i.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      A(e);
     })();
    }, [k]);
    const S = (0, u.useId)();
    let R = u.Fragment;
    return (
     'paragraph' === b ? (R = h) : 'document' === b ? (R = g) : 'surface' === b && (R = v),
     (0, m.jsxs)('div', {
      className: (0, t.A)('nlds-canvas'),
      children: [
       w && (0, m.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(R, { children: (0, m.jsx)(r.v$, { children: w }) }) }) }),
       j &&
        (0, m.jsx)('div', {
