 ...
 [3958],
 {
  ...
  12013(e, t, n) {
   ...
   const i = (e, t) => {
    ...
    l = (e) => ({ img: ({ src: t, ...n }) => (0, s.jsx)('img', { ...n, src: i(e, t), className: 'utrecht-img utrecht-img--fit' }) }),
    a = (e, t) => {
     if (e) {
      const e = { ...c[t - 1] };
      return ((e.h1 = () => null), e);
    ...
    d = ({ children: e, omitH1: t = !1, headingLevel: n = 1, baseUrl: o = '', components: i = {} }) => (0, s.jsx)(r.x, { components: { ...a(t, n), ...l(o), ...i }, children: e });
  },
  17045(e, t, n) {
   'use strict';
   n.d(t, { Ay: () => c, RM: () => s });
  ...
  17889(e, t, n) {
   ...
   var r = n(96547),
    ...
    u = n(29181),
    m = n(86070);
   function p({ children: e, content: t, language: n }) {
    return 'clipboard' in navigator
     ? (0, m.jsxs)(i.$n, {
        ...
        onClick: async function () {
         try {
          const e = await d.Ay.format(t, { parser: n, plugins: [c.A, l.Ay, a.Ay] });
   ...
   var g = n(35193),
    ...
    b = n(79532),
    A = n(30758);
   const x = { color: g.A, dimension: j.A, fontFamilies: w.A, fontSizes: y.A, fontWeights: k.A, lineHeights: f.A, other: v.A, textDecoration: b.A },
    C = ({ type: e }) => (0, m.jsx)(u.In, { children: (0, A.createElement)(x[e]) });
   function T({ tokens: e }) {
    const t = (0, s.kD)(e),
     n = (0, s.GT)(t),
     c = n.map((e) => (0, s.B_)(e) + ': ;').join('\n'),
     l = JSON.stringify((0, s.Rc)(n));
       ...
       children: [
        ...
        (0, m.jsx)(i.BF, {
         children: n.map((t) => {
          const n = (0, s.o_)(t),
           c = (0, s.eQ)(e, t).$type;
          return (0, m.jsxs)(i.Hj, { children: [(0, m.jsx)(i.nA, { children: (0, m.jsx)(r.C, { children: (0, m.jsx)(i.kf, { children: n }) }) }), (0, m.jsx)(i.nA, { children: (0, m.jsxs)(o.K, { children: [(0, m.jsx)(C, { type: c }), ' ', c] }) })] }, n);
         }),
        }),
       ],
      }),
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => o, KF: () => u, mJ: () => g, VZ: () => x, cR: () => A, Pv: () => j, qZ: () => i, kD: () => f, B2: () => m, Pc: () => l, f4: () => c, GT: () => v, fX: () => s, eQ: () => k, B_: () => y, o_: () => w, Rc: () => b });
      ...
      const r = e.tasks
       ...
       .map(({ name: r, id: o, value: s }) => {
        const i = /^(.+) URL/.exec(r)[1],
         c = 'Storybook' === i ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${i}`;
  ...
  34257(e, t, n) {
   ...
   var r = n(86070),
    o = n(18439);
   function s(e) {
    const t = { a: 'a', code: 'code', li: 'li', p: 'p', ul: 'ul', ...(0, o.R)(), ...e.components };
  ...
  45282(e, t, n) {
   ...
   var r = n(13526),
    o = n(86070);
   const s = ({ children: e, ...t }) => {
     const { to: n, href: r, ...s } = t;
     let i = n || r;
     const c = new URL(i, 'https://nldesignsystem.nl');
     return ('https://nldesignsystem.nl' === c.origin ? ((c.pathname = c.pathname.endsWith('/') ? c.pathname : `${c.pathname}/`), (i = c.toString().replace('https://nldesignsystem.nl', ''))) : ((s.target = '_blank'), (s.rel = 'noopener noreferrer')), (0, o.jsx)('a', { href: i, ...s, children: e }));
    },
    i = ({ className: e, ...t }) => (0, o.jsx)(s, { className: (0, r.$)('utrecht-link', 'utrecht-link--html-a', e), ...t });
  },
  46072(e, t, n) {
   'use strict';
   n.d(t, { NO: () => s, pI: () => i });
  ...
  59840(e, t, n) {
   ...
   var r = n(45282),
    ...
    a = n(46447),
    d = n(86070);
   const h = ({ title: e, sc: t, component: n, tags: a }) => {
     const h = (0, l.useId)(),
      u = [...a];
     if (t) {
      u.push(t);
        ...
        (0, d.jsxs)('div', {
         ...
         children: [
          ...
          (0, d.jsx)(s._Q, {
           ...
           children: u.map((e, t) => {
            let n = (0, d.jsx)(i.K, { children: e }, t);
            if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
             const s = o.pI.get(e);
             n = (0, d.jsx)(r.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${s.sc} ${s.nl.title}`, style: { lineHeight: 1 }, children: (0, d.jsx)(i.K, { children: `WCAG ${e}` }) }, t);
            }
            return n;
           }),
          }),
       ...
       (0, d.jsxs)('div', {
        ...
        children: [
         (0, d.jsxs)(a.LB, {
          ...
          'aria-labelledby': c,
          children: [
           (0, d.jsx)(a.DZ, { level: t, id: c, children: 'Filter acceptatiecriteria voor:' }),
             ...
             a.zB,
             {
              ...
              children: [
               (0, d.jsx)(a.Sc, {
                ...
                onChange: () =>
                 ((e, t) => {
                  const n = ('boolean' == typeof t ? t : !i(e)) ? [...r, e] : r.filter((t) => t !== e);
                  o(n);
                 })(e),
               }),
  ...
  64600(e, t, n) {
   ...
   var o = n(86070),
    ...
    a = n(40808);
   function d(e) {
    const t = { a: 'a', code: 'code', p: 'p', pre: 'pre', strong: 'strong', ...(0, s.R)(), ...e.components };
    return (0, o.jsxs)(o.Fragment, { children: [(0, o.jsxs)(t.p, { children: ['Gebruik voor tekst gemarkeerd als opgemaakte code semantische HTML. In het geval van de component Code Block is dat het HTML-element ', (0, o.jsx)(t.code, { children: 'code' }), '\nin combinatie met ', (0, o.jsx)(t.code, { children: 'pre' }), '.'] }), '\n', (0, o.jsx)(t.p, { children: 'Dus niet zo:' }), '\n', (0, o.jsx)(t.pre, { children: (0, o.jsx)(t.code, { className: 'language-html', children: '\x3c!-- Foute code, niet gebruiken --\x3e\n<pre>\n  <div class="code-block">\n    @use "./mixin";\n    \n    .nl-heading-1 {\n    @include mixin.nl-heading-1;\n    }\n  </div>\n</pre>\n' }) }), '\n', (0, o.jsx)(t.p, { children: 'Maar zo:' }), '\n', (0, o.jsx)(t.pre, { children: (0, o.jsx)(t.code, { className: 'language-html', children: '<pre>\n  <code class="code-block">\n    @use "./mixin";\n  \n    .nl-heading-1 {\n    @include mixin.nl-heading-1;\n    }\n  </code>\n</pre>\n' }) }), '\n', (0, o.jsxs)(t.p, { children: [(0, o.jsx)(t.strong, { children: 'Let op' }), ': Het element ', (0, o.jsx)(t.code, { children: '<code>' }), ' wordt op het moment van schrijven (2025) nog niet ondersteund door alle hulpsoftware. Dat betekent niet dat bezoekers die bijvoorbeeld een ', (0, o.jsx)(t.a, { href: '/woordenlijst/#screenreader', children: 'screenreader' }), ' gebruiken de inhoud van het element niet horen, alleen dat er op dit moment niet wordt aangegeven dat het om een ', (0, o.jsx)(t.code, { children: 'code' }), ' element gaat.'] })] });
   }
   function h(e = {}) {
   ...
   function T(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)(t.header, { children: (0, o.jsx)(t.h1, { id: 'gebruik-code-block', children: 'Gebruik Code Block' }) }), '\n', (0, o.jsx)(t.h2, { id: 'css', children: 'CSS' }), '\n', (0, o.jsx)(t.p, { children: 'De CSS van deze component is gepubliceerd in een npm package:' }), '\n', (0, o.jsx)(t.p, { children: (0, o.jsx)(t.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-css', children: '@nl-design-system-candidate/code-block-css' }) }), '\n', (0, o.jsxs)(t.p, { children: ['Gebruik de ', (0, o.jsx)(t.code, { children: 'nl-code-block' }), ' class name op een ', (0, o.jsx)(t.code, { children: 'pre' }), ' element met de ', (0, o.jsx)(t.code, { children: 'nl-code-block__code' }), ' class name op een ', (0, o.jsx)(t.code, { children: 'code' }), ' element:'] }), '\n', (0, o.jsx)(t.pre, { children: (0, o.jsx)(t.code, { className: 'language-html', children: '<pre dir="ltr" translate="no" class="nl-code-block">\n  <code class="nl-code-block__code">function addNumbers(a, b) {\n  return a + b;\n}</code>\n</pre>\n' }) }), '\n', (0, o.jsx)(t.p, { children: 'Je kunt de CSS zo in je project installeren:' }), '\n', (0, o.jsx)(t.pre, { children: (0, o.jsx)(t.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/code-block-css\n' }) }), '\n', (0, o.jsx)(t.p, { children: 'Als je een CDN gebruikt, dan kun je de CSS zo importeren:' }), '\n', (0, o.jsx)(t.pre, { children: (0, o.jsx)(t.code, { className: 'language-html', children: '<link\n  rel="stylesheet"\n  href="https://cdn.jsdelivr.net/npm/@nl-design-system-candidate/code-block-css@1/dist/code-block.css"\n/>\n' }) }), '\n', (0, o.jsxs)(t.p, { children: ['Gebruik je geen CDN, dan kun je de CSS uit ', (0, o.jsx)(t.code, { children: 'node_modules/' }), ' importeren:'] }), '\n', (0, o.jsx)(t.pre, { children: (0, o.jsx)(t.code, { className: 'language-html', children: '<link rel="stylesheet" href="node_modules/@nl-design-system-candidate/code-block-css/dist/code-block.css" />\n' }) }), '\n', (0, o.jsx)(t.p, { children: 'Als je CSS imports gebruikt vanuit JavaScript:' }), '\n', (0, o.jsx)(t.pre, { children: (0, o.jsx)(t.code, { className: 'language-js', children: 'import "@nl-design-system-candidate/code-block-css/code-block.css";\n' }) }), '\n', (0, o.jsx)(t.h2, { id: 'react', children: 'React' }), '\n', (0, o.jsx)(t.p, { children: 'De React component is gepubliceerd in een npm package:' }), '\n', (0, o.jsx)(t.p, { children: (0, o.jsx)(t.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-react', children: '@nl-design-system-candidate/code-block-react' }) }), '\n', (0, o.jsx)(t.p, { children: 'Je kunt de npm package zo installeren:' }), '\n', (0, o.jsx)(t.pre, { children: (0, o.jsx)(t.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/code-block-react\n' }) }), '\n', (0, o.jsx)(t.p, { children: 'Je kunt de React component zo gebruiken:' }), '\n', (0, o.jsx)(t.pre, { children: (0, o.jsx)(t.code, { className: 'language-jsx', children: 'import { CodeBlock } from "@nl-design-system-candidate/code-block-react";\n\nexport const MyPage = () => {\n  return (\n    <html>\n      <body>\n        function addNumbers(a, b) {\n          return a + b;\n        }\n      </body>\n    </html>\n  );\n};\n' }) })] });
   }
   function R(e = {}) {
    const { wrapper: t } = { ...(0, s.R)(), ...e.components };
    return t ? (0, o.jsx)(t, { ...e, children: (0, o.jsx)(T, { ...e }) }) : T(e);
   }
   var G = n(89019);
   ...
   function M(e) {
    const t = { a: 'a', admonition: 'admonition', h2: 'h2', h3: 'h3', p: 'p', ...(0, s.R)(), ...e.components };
    return (0, o.jsxs)(o.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, o.jsx)(A.Fc, { component: L, headingLevel: 1, description: S }),
      '\n',
      (0, o.jsx)(v.e, { component: L }),
      '\n',
      (0, o.jsx)(t.admonition, { title: 'Tip', type: 'tip', children: (0, o.jsxs)(t.p, { children: ['Gebruik de ', (0, o.jsx)(t.a, { href: '/code/', children: 'Code' }), ' component als de code in een regel met andere tekst staat.'] }) }),
      '\n',
      (0, o.jsx)(w.Zp, { className: 'implementation-card', children: (0, o.jsxs)(w.Wu, { children: [(0, o.jsx)(k.D, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, o.jsxs)(y.dk, { children: [(0, o.jsxs)(y.N_, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=13778-3553', children: [(0, o.jsx)(f.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, o.jsxs)(y.N_, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=13778-3553', children: [(0, o.jsx)(f.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, o.jsx)(k.D, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, o.jsxs)(y.dk, { children: [(0, o.jsxs)(y.N_, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-code-block--documentatie', children: [(0, o.jsx)(f.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, o.jsxs)(y.N_, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/code-block--documentatie', children: [(0, o.jsx)(f.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, o.jsx)(k.D, { level: 2, appearance: 'level-4', children: 'npm' }), (0, o.jsxs)(y.dk, { children: [(0, o.jsxs)(y.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-css', children: [(0, o.jsx)(f.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-css'] }), (0, o.jsxs)(y.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-react', children: [(0, o.jsx)(f.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-react'] }), (0, o.jsxs)(y.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-tokens', children: [(0, o.jsx)(f.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-tokens'] })] })] }) }),
      '\n',
      (0, o.jsx)(t.h2, { id: 'checklist-voor-toegankelijkheid', children: 'Checklist voor toegankelijkheid' }),
      '\n',
      (0, o.jsx)(a.Ay, {}),
      '\n',
      (0, o.jsx)(t.h3, { id: 'acceptatiecriteria-bij-gebruik', children: 'Acceptatiecriteria bij gebruik' }),
      '\n',
      (0, o.jsx)(l.Ay, {}),
      '\n',
      (0, o.jsx)(b.b, {
       headingLevel: '4',
       items: [
        { title: 'De code is niet alleen herkenbaar aan een andere achtergrondkleur.', sc: '1.4.1', status: '', component: (0, o.jsx)(j.Ay, {}), tags: ['designer', 'contentmaker', 'developer'] },
        ...
        { title: 'Wanneer de achtergrondkleur van het Code Block anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina.', sc: '1.4.11', status: '', component: (0, o.jsx)(u.Ay, {}), tags: ['designer', 'contentmaker'] },
       ],
      }),
      '\n',
      (0, o.jsx)(t.h3, { id: 'acceptatiecriteria-van-de-component', children: 'Acceptatiecriteria van de component' }),
      '\n',
      (0, o.jsx)(c.Ay, {}),
      '\n',
      (0, o.jsx)(b.b, {
       headingLevel: '4',
       items: [
        { title: 'De juiste HTML-elementen voor de Code Block component zijn toegepast.', sc: '1.3.1', status: '', component: (0, o.jsx)(h, {}), tags: ['developer'] },
        { title: 'Als je inzoomt naar 200% blijft alle tekst leesbaar.', sc: '1.4.4', status: '', component: (0, o.jsx)(g.Ay, {}), tags: ['developer'] },
        { title: 'Als je de tekstafstand vergroot blijft de tekst in zijn geheel zichtbaar.', sc: '1.4.12', status: '', component: (0, o.jsx)(m.Ay, {}), tags: ['developer'] },
       ],
      }),
      '\n',
      (0, o.jsx)(C.o, { omitH1: !0, headingLevel: 2, children: (0, o.jsx)(R, {}) }),
      '\n',
      (0, o.jsx)(t.h2, { id: 'design-tokens', children: 'Design tokens' }),
      '\n',
      (0, o.jsx)(x.B, { tokens: G }),
      '\n',
      (0, o.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, o.jsx)(A.VK, { component: L, headingLevel: 3 }),
      '\n',
      (0, o.jsx)(A.$9, { component: L, headingLevel: 2 }),
      '\n',
      (0, o.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
      '\n',
      (0, o.jsx)(A.mu, { component: L, headingLevel: 3 }),
     ],
    });
   }
   function B(e = {}) {
  ...
  72401(e, t, n) {
   ...
   const c = ({ component: e }) => {
    const { title: t } = e,
     c = (0, s.fX)(t),
     l = o.lazy(() => n(82839)(`./${c}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
  ...
  72642(e, t, n) {
   ...
   var r = n(13526),
    o = n(86070);
   const s = ({ children: e, className: t, level: n = 1, suffix: s, ...i }) => (0, o.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, t), ...i, children: [(0, o.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), s && (0, o.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
  },
  82839(e, t, n) {
  ...
  83329(e, t, n) {
   ...
   var r = n(86070),
    o = n(18439);
   function s(e) {
    const t = { a: 'a', code: 'code', li: 'li', p: 'p', pre: 'pre', ul: 'ul', ...(0, o.R)(), ...e.components };
  ...
  83672(e, t, n) {
   ...
   var r = n(86070),
    o = n(18439);
   function s(e) {
    const t = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, o.R)(), ...e.components };
  ...
  85825(e, t, n) {
   ...
   const g = ({ children: e }) => (0, a.jsx)('ul', { className: 'task-list', children: e }),
    j = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, a.jsxs)('li', { className: (0, o.A)('task-list-item'), children: [(0, a.jsxs)('div', { className: (0, o.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, a.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, a.jsx)(p.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, a.jsxs)('div', { children: [n ? (0, a.jsx)(m.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }) : null, r, t] })] });
   var w = n(33062);
   const y = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => w.f4.includes(e.id)),
      s = n && w.f4.map((e) => n.find((t) => t.id === e)).filter(Boolean);
     return e && (0, a.jsx)(r.If, { sections: s.map((n) => ({ className: (0, o.A)('definition-of-done', n && `definition-of-done--${(0, w.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(g, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, a.jsx)(j, { headingLevel: t + 1, checked: e, title: n, description: (0, w.qZ)(r) }, r)) }), (0, a.jsx)(r.fz, { children: (0, a.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            i.Zp,
            {
             ...
             children: (0, a.jsxs)(i.Wu, {
              children: [
               ...
               (0, a.jsxs)(r.fz, { children: [(0, a.jsx)(d, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, a.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                 ...
                 children: (0, a.jsx)(r.dk, {
                  links: h
                   ...
                   .map((e) => {
                    ...
                    return { children: t.desciption, icon: (0, a.jsx)(s.r, { brand: t.brand }), href: e.value };
                   }),
                 }),
                }),
               c.length > 0 && (0, a.jsx)(a.Fragment, { children: c.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [o, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    f = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(r.DZ, { level: t, children: 'Help om deze component te verbeteren' }), (0, a.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, a.jsxs)(r.Xy, { children: [o ? (0, a.jsxs)(r.Er, { children: ['Vul de ', (0, a.jsx)(r.N_, { href: o, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, a.jsxs)(r.Er, { children: [(0, a.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, a.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, a.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, a.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    v = ({ component: e, headingLevel: t, description: n }) => {
     const o = e && w.bo[e.relayStep];
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(u.p, { level: t, suffix: o && (0, a.jsx)(h.D, { state: o }), children: e.title }), (0, a.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
   n.d(t, { AC: () => a, Fu: () => i, Wu: () => c, Zp: () => l });
   var r = n(46447),
    o = n(13526),
    s = n(86070);
   const i = ({ background: e, children: t, className: n, ...r }) => (0, s.jsx)('div', { className: (0, o.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    c = (e) => (0, s.jsx)('div', { className: 'card__content', ...e }),
    l = ({ href: e, appearance: t, className: n, component: i = 'div', background: c, children: l }) => {
     const a = (e) => ('article' === i ? (0, s.jsx)('article', { ...e }) : 'section' === i ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      d = (0, s.jsx)(a, { className: (0, o.A)('cardgroup__card', c && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: l });
     return e ? (0, s.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: d }) : d;
    },
    a = ({ appearance: e = 'medium', children: t, className: n }) => (0, s.jsx)('div', { className: (0, o.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
 },
]);
