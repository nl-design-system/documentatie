 ...
 [4104],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    u = n(86070);
   const l = { figma: (0, u.jsx)(c.A, {}), github: (0, u.jsx)(i.A, {}), npm: (0, u.jsx)(s.A, {}), storybook: (0, u.jsx)(o.A, {}) },
  ...
  1842(e, t, n) {
   ...
   const k = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: i.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, g.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(p, { headingLevel: t + 1, checked: e, title: n, description: (0, g.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            s.Zp,
            {
             ...
             children: (0, u.jsxs)(s.Wu, {
              children: [
               ...
               o.length > 0 && (0, u.jsx)(u.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, u.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, u.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    f = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(r.DZ, { level: t, children: 'Help om deze component te verbeteren' }), (0, u.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, u.jsxs)(r.Xy, { children: [c ? (0, u.jsxs)(r.Er, { children: ['Vul de ', (0, u.jsx)(r.N_, { href: c, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, u.jsxs)(r.Er, { children: [(0, u.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, u.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, u.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, u.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    b = ({ component: e, headingLevel: t, description: n }) => {
     const c = e && g.bo[e.relayStep];
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(d.p, { level: t, suffix: c && (0, u.jsx)(h.D, { state: c }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => m, VZ: () => w, cR: () => _, Pv: () => p, qZ: () => s, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => i, eQ: () => v, B_: () => k, o_: () => g, Rc: () => x });
  ...
  87440(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => u, default: () => g, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => h, toc: () => m }));
   const r = JSON.parse('{"id":"componenten/date-picker/index","title":"Date Picker","description":"Invoerveld om een beschikbare datum te kiezen via een op maat gemaakte kalender.","source":"@site/docs/componenten/date-picker/index.mdx","sourceDirName":"componenten/date-picker","slug":"/date-picker","permalink":"/date-picker","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-picker/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Date Picker","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Date Picker","pagination_label":"Date Picker","description":"Invoerveld om een beschikbare datum te kiezen via een op maat gemaakte kalender.","slug":"/date-picker","keywords":["calendar","custom","date","datepicker","date field","date input","date picker","date selection","daterange","date range picker","datetime picker","datum kiezer","datum invoer","datumveld","form","formulier","formulierelement","kalender","input field","month picker","scrollable calendar","text field","time picker"]},"sidebar":"componenten","previous":{"title":"Date Input Group","permalink":"/date-input-group"},"next":{"title":"Description List","permalink":"/description-list"}}');
   var c = n(86070),
    i = n(18439),
    s = n(57641),
    o = n(1842);
   const a = { title: 'Date Picker', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Picker', pagination_label: 'Date Picker', description: 'Invoerveld om een beschikbare datum te kiezen via een op maat gemaakte kalender.', slug: '/date-picker', keywords: ['calendar', 'custom', 'date', 'datepicker', 'date field', 'date input', 'date picker', 'date selection', 'daterange', 'date range picker', 'datetime picker', 'datum kiezer', 'datum invoer', 'datumveld', 'form', 'formulier', 'formulierelement', 'kalender', 'input field', 'month picker', 'scrollable calendar', 'text field', 'time picker'] },
    u = void 0,
    l = {},
    h = 'Date Picker',
    d = 'Invoerveld om een beschikbare datum te kiezen via een op maat gemaakte kalender.',
    j = 35,
   ...
   function p(e) {
    ...
    return (0, c.jsxs)(c.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, c.jsx)(o.Fc, { component: y, headingLevel: 1, description: d }), '\n', (0, c.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, c.jsx)(o.VK, { component: y, headingLevel: 3 }), '\n', (0, c.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, c.jsx)(o.mu, { component: y, headingLevel: 3 }), '\n', (0, c.jsx)(o.$9, { component: y, headingLevel: 2 })] });
   }
   function g(e = {}) {
    const { wrapper: t } = { ...(0, i.R)(), ...e.components };
    return t ? (0, c.jsx)(t, { ...e, children: (0, c.jsx)(p, { ...e }) }) : p(e);
   }
  },
  90495(e, t, n) {
   'use strict';
   n.d(t, { AC: () => u, Fu: () => s, Wu: () => o, Zp: () => a });
   var r = n(46447),
    c = n(13526),
    i = n(86070);
   const s = ({ background: e, children: t, className: n, ...r }) => (0, i.jsx)('div', { className: (0, c.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: s = 'div', background: o, children: a }) => {
     const u = (e) => ('article' === s ? (0, i.jsx)('article', { ...e }) : 'section' === s ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      l = (0, i.jsx)(u, { className: (0, c.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, i.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    u = ({ appearance: e = 'medium', children: t, className: n }) => (0, i.jsx)('div', { className: (0, c.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
 },
]);
