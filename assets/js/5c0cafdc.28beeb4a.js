/*! For license information please see 5c0cafdc.28beeb4a.js.LICENSE.txt */
'use strict';
 ...
 [66152],
 {
  ...
  98227: (e, n, i) => {
   ...
   const l = new Date().toISOString(),
    d = (e) => {
     let { lang: n = 'nl', headingLevel: i = 3, allSpeakers: d, videoId: c, children: g, captioned: m, captionLink: u, allSessions: h, sessionId: p } = e;
     const b = h?.find((e) => {
       let { uuid: n } = e;
       return p === n;
      }),
      k = b && b.speakers.map((e) => d[e]).filter(Boolean);
     return b
      ? (0, o.jsxs)('article', {
         className: (0, a.Z)('dsw-session'),
         children: [
          (0, o.jsx)(s.X6, { level: i, className: 'dsw-session__title', id: b.subject.toLowerCase().replace(/\s/gi, '-'), children: b.subject }),
          (0, o.jsx)(s.nv, { className: 'dsw-session__subtitle', lead: !0, children: k && k.map((e) => (e?.organisation ? `${e.name} - ${e.organisation}` : e.name)).join(' & ') }),
          c || (b?.videoId && (0, o.jsx)(r.Y, { id: c || b?.videoId, title: b.subject, style: { marginBlock: '20px' } })),
          b && b.isoDateTime && b.isoDateTime > l ? (0, o.jsx)(s.nv, { children: (0, o.jsx)('time', { dateTime: b.isoDateTime, children: new Intl.DateTimeFormat(n, { dateStyle: 'full', timeStyle: 'nl' === n ? 'short' : 'full', timeZone: 'Europe/Amsterdam' }).format(new Date(b.isoDateTime)) }) }) : (0, o.jsx)(o.Fragment, {}),
          g,
          'nl' === n &&
           k.find((e) => {
            let { language: n } = e;
          ...
          m && (0, o.jsxs)(s.nv, { children: [(0, o.jsx)('b', { children: 'Goed te weten:' }), ' Bij deze sessie is een schrijftolk aanwezig', u && (0, o.jsxs)('a', { href: u, children: ['tolktekst', (0, o.jsxs)('span', { className: 'sr-only', children: [' bij ', b.subject] })] }), '.'] }),
          (0, o.jsx)('aside', { className: (0, a.Z)('dsw-session__speakers'), children: k.map((e, i) => (0, o.jsxs)('div', { className: (0, a.Z)('dsw-session__speaker', 'dsw-speaker'), children: [(0, o.jsx)('img', { className: (0, a.Z)('dsw-speaker__image'), src: e.image.src, alt: e.image.alt }), (0, o.jsx)(s.nv, { className: (0, a.Z)('dsw-speaker__description'), children: e.description[n] })] }, i)) }),
          b && b.icalLink && !c ? (0, o.jsx)(s.nv, { children: (0, o.jsxs)(s.ZP, { href: b.icalLink, download: b.icalLink, appearance: 'primary-action-button', children: [(0, o.jsx)(s.JO, { children: (0, o.jsx)(t.Z, {}) }), (0, o.jsx)('span', { children: 'nl' === n ? (0, o.jsxs)(o.Fragment, { children: ['Zet', (0, o.jsx)('span', { className: 'sr-only', children: b.subject }), ' in je agenda'] }) : (0, o.jsxs)(o.Fragment, { children: ['Add', (0, o.jsx)('span', { className: 'sr-only', children: b.subject }), ' to your calendar'] }) })] }) }) : null,
         ],
        })
      : (0, o.jsx)(o.Fragment, {});
    };
  ...
  84263: (e, n, i) => {
   ...
   var r = t.forwardRef(function (e, n) {
    ...
    var w = e.playlist ? ''.concat(v, '/embed/videoseries?').concat(k.toString()) : ''.concat(v, '/embed/').concat(g, '?').concat(k.toString()),
    ...
    return (
     ...
     t.createElement(
      t.Fragment,
      null,
      t.createElement('link', { rel: C, href: S, as: 'image' }),
      ...
      t.createElement(
       Z,
       {
        ...
        'data-title': u,
        style: s(s({ backgroundImage: 'url('.concat(S, ')') }, { '--aspect-ratio': ''.concat((E / L) * 100, '%') }), H),
       },
       t.createElement('button', { type: 'button', className: N, 'aria-label': ''.concat(p, ' ').concat(u) }),
       d && t.createElement('iframe', { ref: n, className: z, title: u, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: w }),
      ),
     )
    );
   });
