...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [97366],
 {
  ...
  43599: (e, n, l) => {
   ...
   const g = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(s.Tg, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(s.BB, { className: (0, o.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(s.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   g.displayName = 'ParagraphContainer';
   const b = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(s.Tg, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(s.BB, { className: (0, o.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const y = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      (Z = await d.ZP.format(w, { parser: x, plugins: [i.Z, r.ZP, c.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(Z);
     })();
    }, [w]);
    const S = (0, p.useId)();
    let F = p.Fragment;
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       _ && (0, m.jsx)('div', { className: (0, o.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(F, { children: (0, m.jsx)(s.pu, { children: _ }) }) }) }),
       j &&
        (0, m.jsx)('div', {
