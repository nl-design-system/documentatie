(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [47544],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => y, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => s, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => c, eQ: () => k, B_: () => v, o_: () => p, Rc: () => x });
  ...
  57942(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => u, component: () => p, componentName: () => m, contentTitle: () => h, default: () => f, description: () => j, frontMatter: () => l, issueNumber: () => g, metadata: () => r, relayStep: () => y, title: () => d, toc: () => v }));
   const r = JSON.parse('{"id":"componenten/alert-dialog/index","title":"Alert Dialog","description":"Opent een venster waarin de gebruiker een actie moet uitvoeren om verder te gaan. De rest van de pagina is tijdelijk geblokkeerd.","source":"@site/docs/componenten/alert-dialog/index.mdx","sourceDirName":"componenten/alert-dialog","slug":"/alert-dialog","permalink":"/alert-dialog","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/alert-dialog/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Alert Dialog","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Alert Dialog","pagination_label":"Alert Dialog","description":"Opent een venster waarin de gebruiker een actie moet uitvoeren om verder te gaan. De rest van de pagina is tijdelijk geblokkeerd.","slug":"/alert-dialog","keywords":["actie","action","alert","bevestigen","blocking","blokkeren","choice","confirm","continue","dialog","dialoogvenster","doorgaan","keuze","modal","urgent","venster","waarschuwing"]},"sidebar":"componenten","previous":{"title":"Alert","permalink":"/alert"},"next":{"title":"Avatar","permalink":"/avatar"}}');
   var i = n(86070),
    c = n(18439),
    s = n(36059),
    o = n(85825),
    a = n(44594);
   const l = { title: 'Alert Dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Alert Dialog', pagination_label: 'Alert Dialog', description: 'Opent een venster waarin de gebruiker een actie moet uitvoeren om verder te gaan. De rest van de pagina is tijdelijk geblokkeerd.', slug: '/alert-dialog', keywords: ['actie', 'action', 'alert', 'bevestigen', 'blocking', 'blokkeren', 'choice', 'confirm', 'continue', 'dialog', 'dialoogvenster', 'doorgaan', 'keuze', 'modal', 'urgent', 'venster', 'waarschuwing'] },
    h = void 0,
    u = {},
    d = 'Alert Dialog',
    j = 'Opent een venster waarin de gebruiker een actie moet uitvoeren om verder te gaan. De rest van de pagina is tijdelijk geblokkeerd.',
    g = 182,
    y = 'help wanted',
    m = 'alert-dialog',
