...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [42684],
 {
  ...
  58639(e, n, r) {
   ...
   const x = ({ code: e, copy: n = !0, defaultExpandedCode: r = !1, displayCode: x = !0, children: g, container: k = 'document', language: f, designTokens: b }) => {
    ...
    (0, h.useEffect)(() => {
     (async () => {
      const e = await c.Ay.format(_, { parser: f, plugins: [s.A, o.Ay, d.Ay, a.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [_]);
    const R = (0, h.useId)();
    let A = h.Fragment;
    return (
     'paragraph' === k ? (A = v) : 'document' === k ? (A = j) : 'surface' === k && (A = m),
     (0, p.jsxs)('div', {
