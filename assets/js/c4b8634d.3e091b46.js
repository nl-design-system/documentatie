...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [8785],
 {
  ...
  9405(e, n, t) {
   (t.r(n), t.d(n, { assets: () => C, component: () => G, contentTitle: () => _, default: () => M, description: () => R, frontMatter: () => H, issueNumber: () => B, metadata: () => i, title: () => T, toc: () => I }));
   ...
   const y = [
    ...
    C = {},
    T = 'Login Link',
    R = 'Biedt de mogelijkheid om naar de beschikbare inlogmiddelen te navigeren.',
    B = 268,
    G = o.find((e) => e.number === B),
    I = [{ value: 'Definition of Done', id: 'definition-of-done', level: 2 }, { value: 'Community implementaties', id: 'community-implementaties', level: 2 }, { value: 'Acceptatiecriteria', id: 'acceptatiecriteria', level: 2 }, ...s.RM];
   function P(e) {
    const n = { h2: 'h2', ...(0, r.R)(), ...e.components },
     { CriteriaList: t, CriteriaListItem: i } = n;
    return (t || V('CriteriaList', !0), i || V('CriteriaListItem', !0), (0, a.jsxs)(a.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, a.jsx)(l.Fc, { component: G, headingLevel: 1, description: R }), '\n', (0, a.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, a.jsx)(l.VK, { component: G, headingLevel: 3 }), '\n', (0, a.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, a.jsx)(l.mu, { component: G, headingLevel: 3 }), '\n', (0, a.jsx)(l.K_, { component: G }), '\n', (0, a.jsx)(n.h2, { id: 'acceptatiecriteria', children: 'Acceptatiecriteria' }), '\n', (0, a.jsx)(s.Ay, {}), '\n', (0, a.jsx)(t, { headingLevel: 4, testCategory: 'Toegankelijkheid algemeen', children: y.map(({ component: e, ...n }) => (0, a.jsx)(i, { ...n, children: (0, a.jsx)(e, {}) })) }), '\n', (0, a.jsx)(t, { headingLevel: 4, testCategory: 'Toegankelijkheid visueel ontwerp', children: F.map(({ component: e, ...n }) => (0, a.jsx)(i, { ...n, children: (0, a.jsx)(e, {}) })) }), '\n', (0, a.jsx)(t, { headingLevel: 4, testCategory: 'Toegankelijkheid zoom en herschalen', children: N.map(({ component: e, ...n }) => (0, a.jsx)(i, { ...n, children: (0, a.jsx)(e, {}) })) }), '\n', (0, a.jsx)(t, { headingLevel: 4, testCategory: 'Toegankelijkheid toetsenbord', children: z.map(({ component: e, ...n }) => (0, a.jsx)(i, { ...n, children: (0, a.jsx)(e, {}) })) }), '\n', (0, a.jsx)(t, { headingLevel: 4, testCategory: 'Toegankelijkheid screenreader', children: S.map(({ component: e, ...n }) => (0, a.jsx)(i, { ...n, children: (0, a.jsx)(e, {}) })) }), '\n', (0, a.jsx)(l.$9, { component: G, headingLevel: 2 })] }));
   }
   function M(e = {}) {
    const { wrapper: n } = { ...(0, r.R)(), ...e.components };
  ...
  21034(e, n, t) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
     const t = e && e.projects.filter((e) => k.f4.includes(e.id)),
      a = t && k.f4.map((e) => t.find((n) => n.id === e)).filter(Boolean);
     return e && (0, u.jsx)(b.n, { children: a.map((t) => (0, u.jsx)(b.K, { className: (0, o.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, k.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(j._, { children: t.tasks.map(({ checked: e, name: t, id: i }) => (0, u.jsx)(j.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, k.qZ)(i) }, i)) }), (0, u.jsx)(i.fz, { children: (0, u.jsxs)(i.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
               ...
               d.Z,
               {
                ...
                description: (0, u.jsxs)('div', {
                 ...
                 children: [
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)('section', { children: [(0, u.jsxs)(a.DZ, { level: Math.min(n + 2, 6), children: [o, ' in ', e] }), (0, u.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
    ...
    L = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(i.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, u.jsxs)(i.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, u.jsxs)(i.Xy, { children: [a ? (0, u.jsxs)(i.Er, { children: ['Vul de ', (0, u.jsx)(i.N_, { href: a, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, u.jsxs)(i.Er, { children: [(0, u.jsxs)(i.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, u.jsxs)(i.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, u.jsx)(i.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, u.jsx)(i.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    D = ({ component: e, headingLevel: n, description: t }) => {
     const a = e && k.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p.p, { level: n, suffix: a && (0, u.jsx)(h.D, { state: a }), children: e.title }), (0, u.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(a) && (0, u.jsx)(f.s, { relayStep: a, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    A = ({ component: e }) => {
     const n = (e && x[e.title]) || [];
  ...
  32385(e, n, t) {
   t.d(n, { bo: () => a, KF: () => u, mJ: () => p, VZ: () => L, cR: () => w, Pv: () => j, qZ: () => o, kD: () => f, QQ: () => A, B2: () => m, Pc: () => l, f4: () => s, GT: () => v, fX: () => r, eQ: () => b, B_: () => x, o_: () => k });
  ...
  70348(e, n, t) {
   ...
   const l = (0, a.forwardRef)(({ as: e, className: n, children: t, ...a }, r) => {
     ...
     return (0, s.jsx)(o, { ref: r, className: l, ...a, children: t });
    }),
    d = ({ className: e, classNamePanel: n, label: t, heading: a, headingLevel: l, headingApperance: d, ...c }) => {
     ...
     return (0, s.jsxs)('details', { className: g, ...c, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(r.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [a && (0, s.jsx)(o.D, { level: l, appearance: d, children: a }), t] })] }) }), (0, s.jsx)('div', { className: u, children: c.children })] });
    };
  },
  71805(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => r });
  ...
  85162(e, n, t) {
   ...
   const s = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    l = ({ name: e, relayStep: n, description: t }) => {
     const l = (0, r.fX)(n),
      d = s[e] ?? e;
     return (0, o.jsxs)(i.WK, { children: [(0, o.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, a.A)('ma-component-illustration', `ma-component-illustration--${l}`), fill: 'none', children: [(0, o.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, o.jsx)('rect', { width: '960', height: '540' }), (0, o.jsx)('rect', { width: '960', height: '540' })] }), (0, o.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, o.jsx)('use', { href: `/svg/componenten_overzicht_${(0, r.fX)(d)}.svg#component-illustration` })] }), (0, o.jsx)(i.$P, { className: 'ma-component-illustration__caption', children: t })] });
    };
  },
  88166(e, n, t) {
   t.d(n, { Z: () => i.Z });
