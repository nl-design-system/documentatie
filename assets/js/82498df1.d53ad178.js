   ...
   const v = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: v = !0, children: y, container: j = 'document', language: x, designTokens: f }) => {
    ...
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       k && (0, p.jsx)('div', { className: (0, l.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(T, { children: (0, p.jsx)(r.v$, { children: k }) }) }) }),
       v &&
        (0, p.jsx)('div', {
