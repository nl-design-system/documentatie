 ...
 [22151],
 {
   ...
   const d = (0, i.createContext)({}),
    u = ({ title: e, appearance: n, description: l, children: i, figure: u }) => {
     const m = { do: 'Doen', dont: 'Niet doen' },
      h = u ? 'figure' : 'div',
      p = u ? 'figcaption' : 'div',
      g = 'string' == typeof l ? (0, a.jsx)(c.oz, { components: { a: t.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   const i = (0, r.forwardRef)(({ as: e, className: n, children: l, ...r }, t) => {
     ...
     return (0, c.jsx)(s, { ref: t, className: i, ...r, children: l });
    }),
    a = ({ className: e, classNamePanel: n, label: l, heading: r, headingLevel: i, headingApperance: a, ...d }) => {
     const u = (0, o.A)('utrecht-accordion__section', e),
      m = (0, o.A)('utrecht-accordion__panel', n);
     return (0, c.jsxs)('details', { className: u, ...d, children: [(0, c.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, c.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, c.jsx)('span', { className: 'nl-button__icon-start', children: (0, c.jsx)(t.A, {}) }), (0, c.jsxs)('span', { className: 'nl-button__label', children: [r && (0, c.jsx)(s.D, { level: i, appearance: a, children: r }), l] })] }) }), (0, c.jsx)('div', { className: m, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => b });
   ...
   const b = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const o = 'function' == typeof e ? e() : e,
        ...
        s = p().highlight(r, p().languages[n], n);
       return (0, f.jsxs)('div', { className: (0, t.A)('ma-canvas-astro', l), children: [(0, f.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }), (0, f.jsx)(g.n, { children: (0, f.jsx)(g.K, { label: 'Code', children: (0, f.jsx)('pre', { className: 'language-html nl-code-block', children: (0, f.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: h = !0, children: p, container: g = 'document', language: b, designTokens: y }) => {
       ...
       let P = u.Fragment;
       return (
        'paragraph' === g ? (P = j) : 'document' === g ? (P = x) : 'surface' === g && (P = v),
        (0, f.jsxs)('div', {
         className: (0, t.A)('nlds-canvas'),
         children: [
          _ && (0, f.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, f.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, f.jsx)(P, { children: (0, f.jsx)(r.v$, { children: _ }) }) }) }),
          h &&
           (0, f.jsx)('div', {
