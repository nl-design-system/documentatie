 ...
 [28911],
 {
  ...
  58639(e, n, l) {
   ...
   const x = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: x = !0, children: y, container: j = 'document', language: b, designTokens: f }) => {
    ...
    let G = m.Fragment;
    return (
     'paragraph' === j ? (G = h) : 'document' === j ? (G = v) : 'surface' === j && (G = g),
     (0, p.jsxs)('div', {
      className: (0, s.A)('nlds-canvas'),
      children: [
       k && (0, p.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(G, { children: (0, p.jsx)(o.v$, { children: k }) }) }) }),
       x &&
        (0, p.jsx)('div', {
