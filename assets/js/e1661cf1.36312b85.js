 ...
 [29865],
 {
  61935: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(81862),
    s = n(8657);
   const o = { title: 'Form Navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Navigation', pagination_label: 'Form Navigation', description: 'Overzicht van stappen in een formulier, met de mogelijkheid om direct naar beschikbare stappen te navigeren.', slug: '/form-navigation' },
    a = void 0,
    u = { id: 'componenten/form-navigation/index', title: 'Form Navigation', description: 'Overzicht van stappen in een formulier, met de mogelijkheid om direct naar beschikbare stappen te navigeren.', source: '@site/docs/componenten/form-navigation/index.mdx', sourceDirName: 'componenten/form-navigation', slug: '/form-navigation', permalink: '/form-navigation', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-navigation/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form Navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Navigation', pagination_label: 'Form Navigation', description: 'Overzicht van stappen in een formulier, met de mogelijkheid om direct naar beschikbare stappen te navigeren.', slug: '/form-navigation' }, sidebar: 'componenten', previous: { title: 'Form Field Partial Label', permalink: '/form-field-partial-label' }, next: { title: 'Form Summary', permalink: '/form-summary' } },
    l = {},
    h = [
