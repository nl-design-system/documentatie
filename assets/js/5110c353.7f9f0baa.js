 ...
 [45900],
 {
   ...
   function C({ tokens: e }) {
    ...
    return (0, c.jsxs)('div', {
     ...
     children: [
      ...
      (0, c.jsxs)(a.e2, { children: [(0, c.jsx)(u, { content: d, children: 'Kopieer als JSON' }), (0, c.jsx)(u, { content: l, children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  48262(e, n, t) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, g.jsx)(x.n, { children: s.map((t) => (0, g.jsx)(x.K, { className: (0, a.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, b.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(j._, { children: t.tasks.map(({ checked: e, name: t, id: i }) => (0, g.jsx)(j.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, b.qZ)(i) }, i)) }), (0, g.jsx)(i.fz, { children: (0, g.jsxs)(i.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
            ...
            ? (0, g.jsx)(
               d.Z,
               {
                ...
                description: (0, g.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, g.jsxs)(r.f, { children: [(0, g.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, g.jsxs)(i.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, g.jsxs)('div', {
                   children: [
                    (h.length > 0 || c.length > 0) && (0, g.jsx)(s.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    h.length > 0 &&
                     (0, g.jsx)(i.dk, {
                      links: h
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)('section', { children: [(0, g.jsxs)(s.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, g.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(o.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, g.jsxs)(l.Wu, {
                 children: [
                  ...
                  (h.length > 0 || c.length > 0) && (0, g.jsx)(i.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  h.length > 0 &&
                   (0, g.jsx)(g.Fragment, {
                  ...
                  c.length > 0 && (0, g.jsx)(g.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)(g.Fragment, { children: [(0, g.jsxs)(i.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, g.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    A = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(i.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, g.jsxs)(i.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, g.jsxs)(i.Xy, { children: [s ? (0, g.jsxs)(i.Er, { children: ['Vul de ', (0, g.jsx)(i.N_, { href: s, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, g.jsxs)(i.Er, { children: [(0, g.jsxs)(i.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, g.jsxs)(i.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, g.jsx)(i.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, g.jsx)(i.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    y = ({ component: e, headingLevel: n, description: t }) => {
     const s = e && b.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(p.p, { level: n, suffix: s && (0, g.jsx)(h.D, { state: s }), children: e.title }), (0, g.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(s) && (0, g.jsx)(k.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    T = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
