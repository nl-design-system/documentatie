 ...
 [28737],
 {
  14881(e, n, l) {
   ...
   var t = l(13526),
    ...
    a = l(37168),
    i = l(86070);
   const o = (0, r.forwardRef)(({ as: e, className: n, children: l, ...r }, s) => {
     const a = e || 'div',
      o = (0, t.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, i.jsx)(a, { ref: s, className: o, ...r, children: l });
    }),
    c = ({ className: e, classNamePanel: n, label: l, heading: r, headingLevel: o, headingApperance: c, ...d }) => {
     const u = (0, t.A)('utrecht-accordion__section', e),
      h = (0, t.A)('utrecht-accordion__panel', n);
     return (0, i.jsxs)('details', { className: u, ...d, children: [(0, i.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, i.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, i.jsx)('span', { className: 'nl-button__icon-start', children: (0, i.jsx)(s.A, {}) }), (0, i.jsxs)('span', { className: 'nl-button__label', children: [r && (0, i.jsx)(a.D, { level: o, appearance: c, children: r }), l] })] }) }), (0, i.jsx)('div', { className: h, children: d.children })] });
    };
  },
  18439(e, n, l) {
   l.d(n, { R: () => a, x: () => i });
  ...
  38953(e, n, l) {
   ...
   var t = l(28369),
    ...
    g = l(46847),
    j = l(86070);
   const v = ({ children: e }) => (0, j.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(r.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, j.jsx)(r.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   v.displayName = 'ParagraphContainer';
   const x = ({ children: e }) => (0, j.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(r.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   x.displayName = 'DocumentContainer';
   const k = ({ children: e }) => (0, j.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: e });
   k.displayName = 'SurfaceContainer';
   const y = globalThis.isAstro
    ? ({ language: e, className: n, code: l = '<p>No code provided</p>', rawCode: t, copyCode: r, defaultExpandedCode: a, designTokens: i }) => {
       const o = 'string' == typeof l ? l : t || '',
        c = 'string' == typeof l ? m().highlight(l, m().languages[e], e) : m().highlight(t || '', m().languages[e], e);
       return (0, j.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', n), children: [(0, j.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: i, children: (0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }) }), (0, j.jsx)(b.n, { children: (0, j.jsxs)(b.K, { label: 'Code', open: a, children: [(0, j.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: c } }) }), 'allow' === r && (0, j.jsx)(g.$, { 'data-copy-code': o, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: p = !0, children: m, container: b = 'document', language: g, designTokens: y }) => {
       ...
       (0, u.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(w, { parser: g, plugins: [a.A, i.Ay, o.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [w]);
       const L = (0, u.useId)();
       let S = u.Fragment;
       return (
        'paragraph' === b ? (S = v) : 'document' === b ? (S = x) : 'surface' === b && (S = k),
        (0, j.jsxs)('div', {
         className: (0, s.A)('nlds-canvas'),
         children: [
          f && (0, j.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, j.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, j.jsx)(S, { children: (0, j.jsx)(r.v$, { children: f }) }) }) }),
          p &&
           (0, j.jsx)('div', {
          ...
          p &&
           (0, j.jsxs)('div', {
            ...
            hidden: !z,
            children: [
             (0, j.jsx)(t.M, { codeBlockLabel: 'Codevoorbeeld', syntax: g, textContent: N, trim: !0 }),
             n &&
              (0, j.jsx)('div', {
   ...
   const d = (0, o.createContext)({}),
    u = ({ title: e, appearance: n, description: l, children: o, figure: u }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      p = u ? 'figure' : 'div',
      m = u ? 'figcaption' : 'div',
      b = 'string' == typeof l ? (0, c.jsx)(i.oz, { components: { a: s.N_ }, children: l }) : l;
