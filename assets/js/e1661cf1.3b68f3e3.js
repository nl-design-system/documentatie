(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [76066],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => p, VZ: () => w, cR: () => _, Pv: () => y, qZ: () => c, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => s, eQ: () => f, B_: () => v, o_: () => g, Rc: () => x });
   ...
   const h = (e) => [...e].sort((e, t) => u.indexOf(e) - u.indexOf(t)),
    ...
    p = (e) => h(l(e.projects.flatMap((e) => m(e)))),
    y = (e) => {
     const t = m(e),
      n = ((e) => {
  ...
  99630(e, t, n) {
   ...
   const g = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, a.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, y.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, a.jsx)(p, { headingLevel: t + 1, checked: e, title: n, description: (0, y.qZ)(r) }, r)) }), (0, a.jsx)(r.fz, { children: (0, a.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            c.Zp,
            {
             ...
             children: (0, a.jsxs)(c.Wu, {
              children: [
               ...
               o.length > 0 && (0, a.jsx)(a.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    k = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(h.p, { level: t, suffix: i && (0, a.jsx)(l.D, { state: i }), children: e.title }), (0, a.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
 },
]);
