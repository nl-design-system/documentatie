...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [79649],
 {
  ...
  43599: (e, n, l) => {
   ...
   const p = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(t.Tg, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(t.BB, { className: (0, o.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, h.jsx)(t.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   p.displayName = 'ParagraphContainer';
   const b = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(t.Tg, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(t.BB, { className: (0, o.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const v = (e) => {
    ...
    (0, m.useEffect)(() => {
     (async () => {
      (w = await d.ZP.format(z, { parser: x, plugins: [r.Z, s.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(w);
     })();
    }, [z]);
    const P = (0, m.useId)();
    let D = m.Fragment;
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       _ && (0, h.jsx)('div', { className: (0, o.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(D, { children: (0, h.jsx)(t.pu, { children: _ }) }) }) }),
       j &&
        (0, h.jsx)('div', {
       ...
       j &&
        (0, h.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, h.jsx)(a.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: w, trim: !0 }),
          l &&
           (0, h.jsx)('div', {
