(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [34799],
 {
         ...
         (0, m.jsx)(i._Q, {
          ...
          children: c.map((e, n) => {
           ...
           if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
            const a = s.pI.get(e);
            t = (0, m.jsx)(r.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${a.sc} ${a.nl.title}`, style: { lineHeight: 1 }, children: (0, m.jsx)(g.KE, { children: `WCAG ${e}` }) }, n);
           }
           return t;
          }),
         }),
  ...
  29857(e, n, t) {
   ...
   var a = t(37168),
    r = t(86070);
   const s = (e) => (0, r.jsx)(a.D, { ...e }),
    i = (e) => (0, r.jsx)(a.D, { ...e, level: 3 });
  },
  33201(e, n, t) {
   'use strict';
   t.d(n, { Ay: () => i });
  ...
  48262(e, n, t) {
   ...
   const b = ({ component: e, headingLevel: n }) => {
     const t = e && e.projects.filter((e) => x.f4.includes(e.id)),
      r = t && x.f4.map((e) => t.find((n) => n.id === e)).filter(Boolean);
     return e && (0, u.jsx)(w.n, { children: r.map((t) => (0, u.jsx)(w.K, { className: (0, i.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, x.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(j._, { children: t.tasks.map(({ checked: e, name: t, id: a }) => (0, u.jsx)(j.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, x.qZ)(a) }, a)) }), (0, u.jsx)(a.fz, { children: (0, u.jsxs)(a.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
            ...
            ? (0, u.jsx)(
               d.Z,
               {
                ...
                description: (0, u.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, u.jsxs)(s.f, { children: [(0, u.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(a.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, u.jsxs)('div', {
                   children: [
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)('section', { children: [(0, u.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [i, ' in ', e] }), (0, u.jsx)(a.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(o.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, u.jsxs)(l.Wu, {
                 children: [
                  ...
                  (p.length > 0 || c.length > 0) && (0, u.jsx)(a.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  p.length > 0 &&
                   (0, u.jsx)(u.Fragment, {
                  ...
                  c.length > 0 && (0, u.jsx)(u.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(a.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, u.jsx)(a.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    A = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(a.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, u.jsxs)(a.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, u.jsxs)(a.Xy, { children: [r ? (0, u.jsxs)(a.Er, { children: ['Vul de ', (0, u.jsx)(a.N_, { href: r, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, u.jsxs)(a.Er, { children: [(0, u.jsxs)(a.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, u.jsxs)(a.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, u.jsx)(a.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, u.jsx)(a.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    y = ({ component: e, headingLevel: n, description: t }) => {
     const r = e && x.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(h.p, { level: n, suffix: r && (0, u.jsx)(p.D, { state: r }), children: e.title }), (0, u.jsx)(a.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(r) && (0, u.jsx)(k.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    T = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
