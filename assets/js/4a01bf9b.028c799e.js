...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [13612],
 {
  ...
  88566: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => g, contentTitle: () => h, default: () => b, frontMatter: () => p, metadata: () => m, toc: () => v });
   var o = l(52676),
    t = l(24785),
    s = l(98480),
    r = l(91050);
  ...
  98480: (e, n, l) => {
   ...
   const b = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: b = !1, displayCode: y = !0, children: x, container: j = 'document', language: k, designTokens: f } = e,
     N = 'function' == typeof x ? x() : x,
     C = 'function' == typeof n ? n() : (0, i.isValidElement)(n) ? n : void 0,
     Z = 'string' == typeof n ? n : u.uS(C || N),
     [S, w] = (0, i.useState)(Z),
     [P, z] = (0, i.useState)(b);
    (0, i.useEffect)(() => {
     (async () => {
      (S = await d.ZP.format(Z, { parser: k, plugins: [s.Z, r.ZP, c.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), w(S);
     })();
    }, [Z]);
    const D = (0, i.useId)();
    let E = i.Fragment;
      ...
      children: [
       ...
       y &&
        (0, m.jsxs)('div', {
         ...
         hidden: !P,
         children: [
          (0, m.jsx)(h.u, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: S, trim: !0 }),
          l &&
           (0, m.jsx)('div', {
    ...
    return (
     ...
     (0, a.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, a.jsx)(o.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': m, style: l, children: t.map((e, l) => (0, a.jsxs)('span', { ...s({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const i = (0, c.createContext)({}),
    u = (e) => {
     let { title: n, appearance: l, description: c, children: u, figure: p } = e;
     const h = { do: 'Doen', dont: 'Niet doen' },
      m = p ? 'figure' : 'div',
      g = p ? 'figcaption' : 'div';
     return (0, d.jsxs)(m, { className: (0, r.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(g, { className: (0, r.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(s.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, d.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: h.dont })] }), (0, d.jsx)(s.nv, { children: n })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(s.nv, { className: (0, r.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, d.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: h.do })] }), (0, d.jsx)(s.nv, { children: n })] }), c] }), (0, d.jsx)('div', { className: (0, r.Z)(a['nlds-guideline__example']), children: (0, d.jsx)(i.Provider, { value: { title: n, type: h[l] }, children: u }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => c, a: () => r });
