 ...
 [22410],
 {
  ...
  1842(e, t, n) {
   ...
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, m.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(g, { headingLevel: t + 1, checked: e, title: n, description: (0, m.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => d, mJ: () => p, VZ: () => w, cR: () => _, Pv: () => g, qZ: () => c, kD: () => b, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => i, eQ: () => k, B_: () => v, o_: () => m, Rc: () => x });
  ...
  36844(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => u, default: () => m, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => h, toc: () => p }));
   ...
   var s = n(86070),
    ...
    c = n(57641),
    o = n(1842);
   const a = { title: 'Progress List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress List', pagination_label: 'Progress List', description: 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.', slug: '/progress-list', keywords: ['lijst', 'meter', 'path', 'proceslijst', 'progress', 'progress bar', 'progress indicator', 'progress list', 'progress navigation', 'progress tracker', 'status', 'statusoverzicht', 'stepper', 'stepper indicator', 'stepper vertical', 'steps', 'tijdlijn', 'timeline', 'voortgangslijst', 'voortgangsproces'] },
    u = void 0,
    l = {},
    h = 'Progress List',
    d = 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.',
    j = 150,
   ...
   function g(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, s.jsx)(o.Fc, { component: y, headingLevel: 1, description: d }), '\n', (0, s.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, s.jsx)(o.VK, { component: y, headingLevel: 3 }), '\n', (0, s.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, s.jsx)(o.mu, { component: y, headingLevel: 3 }), '\n', (0, s.jsx)(o.$9, { component: y, headingLevel: 2 })] });
   }
   function m(e = {}) {
