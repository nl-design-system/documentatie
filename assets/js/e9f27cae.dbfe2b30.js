 ...
 [11341],
 {
   ...
   const d = (0, c.createContext)({}),
    p = ({ title: e, appearance: n, description: l, children: c, figure: p }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      u = p ? 'figure' : 'div',
      m = p ? 'figcaption' : 'div',
      g = 'string' == typeof l ? (0, i.jsx)(a.oz, { components: { a: s.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   var o = l(13526),
    ...
    r = l(37168),
    a = l(86070);
   const c = (0, t.forwardRef)(({ as: e, className: n, children: l, ...t }, s) => {
     const r = e || 'div',
      c = (0, o.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(r, { ref: s, className: c, ...t, children: l });
    }),
    i = ({ className: e, classNamePanel: n, label: l, heading: t, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, a.jsxs)('details', { className: p, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(s.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [t && (0, a.jsx)(r.D, { level: c, appearance: i, children: t }), l] })] }) }), (0, a.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => b });
   ...
   const b = globalThis.isAstro
    ...
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: u = !0, children: m, container: g = 'document', language: b, designTokens: k }) => {
       ...
       (0, p.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(w, { parser: b, plugins: [r.A, a.Ay, c.Ay, i.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [w]);
       const z = (0, p.useId)();
