 ...
 [32288],
 {
  88168: (e, n, i) => {
   ...
   const a = { title: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.11 Focus niet bedekt (minimum)', pagination_label: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', description: 'Zorg ervoor dat een element dat de toetsenbordfocus heeft zichtbaar is en niet volledig bedekt is door andere inhoud.', slug: '2.4.11', keywords: ['WCAG'] },
    u = void 0,
    h = { id: 'wcag/2.4.11', title: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', description: 'Zorg ervoor dat een element dat de toetsenbordfocus heeft zichtbaar is en niet volledig bedekt is door andere inhoud.', source: '@site/docs/wcag/2.4.11.mdx', sourceDirName: 'wcag', slug: '/wcag/2.4.11', permalink: '/wcag/2.4.11', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.11.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.11 Focus niet bedekt (minimum)', pagination_label: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', description: 'Zorg ervoor dat een element dat de toetsenbordfocus heeft zichtbaar is en niet volledig bedekt is door andere inhoud.', slug: '2.4.11', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.4.10 Paragraafkoppen', permalink: '/wcag/2.4.10' }, next: { title: '2.4.13 Focusweergave', permalink: '/wcag/2.4.13' } },
    m = {},
    g = [
