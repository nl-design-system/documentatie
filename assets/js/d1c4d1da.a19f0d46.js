 ...
 [20259],
 {
  14881(e, n, t) {
   ...
   var l = t(13526),
    ...
    r = t(37168),
    i = t(86070);
   const a = (0, s.forwardRef)(({ as: e, className: n, children: t, ...s }, o) => {
     const r = e || 'div',
      a = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, i.jsx)(r, { ref: o, className: a, ...s, children: t });
    }),
    c = ({ className: e, classNamePanel: n, label: t, heading: s, headingLevel: a, headingApperance: c, ...d }) => {
     const h = (0, l.A)('utrecht-accordion__section', e),
      p = (0, l.A)('utrecht-accordion__panel', n);
     return (0, i.jsxs)('details', { className: h, ...d, children: [(0, i.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, i.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, i.jsx)('span', { className: 'nl-button__icon-start', children: (0, i.jsx)(o.A, {}) }), (0, i.jsxs)('span', { className: 'nl-button__label', children: [s && (0, i.jsx)(r.D, { level: a, appearance: c, children: s }), t] })] }) }), (0, i.jsx)('div', { className: p, children: d.children })] });
    };
  },
  18439(e, n, t) {
   t.d(n, { R: () => r, x: () => i });
  ...
  38953(e, n, t) {
   ...
   const b = ({ children: e }) => (0, v.jsx)(s.ui, { className: 'nlds-canvas__example-surface', children: (0, v.jsx)(s.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const k = globalThis.isAstro
    ...
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: u = !0, children: g, container: m = 'document', language: j, designTokens: k }) => {
       ...
       let S = h.Fragment;
       return (
        'paragraph' === m ? (S = y) : 'document' === m ? (S = b) : 'surface' === m && (S = x),
        (0, v.jsxs)('div', {
         className: (0, o.A)('nlds-canvas'),
         children: [
          f && (0, v.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, v.jsx)(S, { children: (0, v.jsx)(s.v$, { children: f }) }) }) }),
          u &&
           (0, v.jsx)('div', {
          ...
          u &&
           (0, v.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, v.jsx)(l.M, { codeBlockLabel: 'Codevoorbeeld', syntax: j, textContent: w, trim: !0 }),
             n &&
              (0, v.jsx)('div', {
   ...
   const d = (0, a.createContext)({}),
    h = ({ title: e, appearance: n, description: t, children: a, figure: h }) => {
     const p = { do: 'Doen', dont: 'Niet doen' },
      u = h ? 'figure' : 'div',
      g = h ? 'figcaption' : 'div',
      m = 'string' == typeof t ? (0, c.jsx)(i.oz, { components: { a: o.N_ }, children: t }) : t;
