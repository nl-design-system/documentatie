 ...
 [65429],
 {
  ...
  24456(e, n, t) {
   ...
   const o = ({ children: e, ...n }) => {
    ...
    s = ({ className: e, boxContent: n, ...t }) => (0, a.jsx)(o, { className: (0, r.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  26165(e, n, t) {
   ...
   const o = ({ background: e, children: n, className: t, ...r }) => (0, a.jsx)('div', { className: (0, i.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, t), ...r, children: n }),
    ...
    l = ({ href: e, appearance: n, className: t, component: o = 'div', background: s, children: l }) => {
     const c = (e) => ('article' === o ? (0, a.jsx)('article', { ...e }) : 'section' === o ? (0, a.jsx)('section', { ...e }) : (0, a.jsx)('div', { ...e })),
      m = (0, a.jsx)(c, { className: (0, i.A)('ma-cardgroup__card', s && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, t), children: l });
  ...
  37168(e, n, t) {
   ...
   var r = t(15540),
    i = t(69967),
    a = t(30758),
    o = ['level', 'appearance', 'children', 'className'];
   function s(e, n) {
    var t = Object.keys(e);
  ...
  56561(e, n, t) {
   ...
   var d = (0, s.forwardRef)(function (e, n) {
    var t = e.children,
     ...
     c = e.purpose,
     d = (0, i.A)(e, l);
    return (0, a.jsx)('p', m(m({ className: (0, o.$)('nl-paragraph', (0, r.A)({}, 'nl-paragraph--lead', 'lead' === c), s), ref: n }, d), {}, { children: 'lead' === c ? (0, a.jsx)('b', { className: 'nl-paragraph__lead', children: t }) : t }));
   });
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => i, KF: () => p, mJ: () => v, VZ: () => S, cR: () => w, Pv: () => g, qZ: () => o, kD: () => b, QQ: () => _, B2: () => u, Pc: () => l, f4: () => s, GT: () => k, fX: () => a, eQ: () => f, B_: () => j, o_: () => y });
