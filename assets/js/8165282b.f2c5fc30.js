 ...
 [42843],
 {
     ...
     children: [
      ...
      (0, i.jsx)($.b, {
       ...
       items: [
        ...
        { title: 'De naam en instructies over het invullen van de Text Input staan niet alleen in de placeholder', sc: '3.3.2', status: '', component: (0, i.jsx)(_, {}), tags: ['developer', 'designer'] },
  ...
  99630(e, n, t) {
   ...
   const p = ({ children: e }) => (0, a.jsx)('ul', { className: 'task-list', children: e }),
    m = ({ checked: e, children: n, title: t, description: r, headingLevel: o = 3 }) => (0, a.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, a.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, a.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, a.jsx)(j.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, a.jsxs)('div', { children: [t ? (0, a.jsx)(h.DZ, { appearance: 'utrecht-heading-3', level: o, children: t }) : null, r, n] })] });
   var g = t(33062);
   const f = ({ component: e, headingLevel: n }) => {
            ...
            s.Zp,
            {
             ...
             children: (0, a.jsxs)(s.Wu, {
              children: [
               ...
               (0, a.jsxs)(r.fz, { children: [(0, a.jsx)(c, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, a.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
               (u.length > 0 || l.length > 0) && (0, a.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               u.length > 0 &&
                (0, a.jsx)(a.Fragment, {
               ...
               l.length > 0 && (0, a.jsx)(a.Fragment, { children: l.map(({ frameworkName: e, tasks: t }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, a.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, a.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    k = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(r.DZ, { level: n, children: 'Help om deze component te verbeteren' }), (0, a.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, a.jsxs)(r.Xy, { children: [i ? (0, a.jsxs)(r.Er, { children: ['Vul de ', (0, a.jsx)(r.N_, { href: i, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, a.jsxs)(r.Er, { children: [(0, a.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, a.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, a.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, a.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
