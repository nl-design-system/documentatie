(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [8785],
 {
  ...
  42189(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => S, component: () => M, contentTitle: () => _, default: () => E, description: () => F, frontMatter: () => N, issueNumber: () => T, metadata: () => r, title: () => R, toc: () => C }));
    ...
    return (
     ...
     (0, i.jsxs)(i.Fragment, {
      children: [
       ...
       '\n',
       '\n',
       (0, i.jsx)(D.Fc, { component: M, headingLevel: 1, description: F }),
       '\n',
       (0, i.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
       '\n',
       (0, i.jsx)(D.VK, { component: M, headingLevel: 3 }),
       '\n',
       (0, i.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
       '\n',
       (0, i.jsx)(D.mu, { component: M, headingLevel: 3 }),
       '\n',
       ...
       (0, i.jsx)(t, {
        ...
        items: [
         { title: 'Het label van de Login Link bestaat uit gewone tekst, niet uit een afbeelding van tekst', sc: '1.4.5', status: '', component: (0, i.jsx)(w.Ay, {}) },
         { title: 'De linktekst van de Login Link vertelt eenduidig aan de gebruiker waar de link naar toe gaat (het linkdoel).', sc: '2.4.4', status: '', component: (0, i.jsx)(L.Ay, {}) },
       ...
       (0, i.jsx)(t, {
        ...
        items: [
         ...
         { title: 'De functionaliteit van de Login Link veroorzaakt geen toetsenbordval', sc: '2.1.2', status: '', component: (0, i.jsx)(z.Ay, {}) },
       ...
       (0, i.jsx)(t, {
        ...
        items: [
         ...
         { title: 'De Login Link heeft een rol van link en een toegankelijke naam die duidelijk maakt waar de Login Link voor dient', sc: '4.1.2', status: '', component: (0, i.jsx)(f.Ay, {}) },
        ],
       }),
       '\n',
       (0, i.jsx)(D.$9, { component: M, headingLevel: 2 }),
      ],
     })
    );
   }
