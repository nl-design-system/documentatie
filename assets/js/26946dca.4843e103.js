 ...
 [3958],
 {
         ...
         (0, m.jsx)(r._Q, {
          ...
          children: d.map((e, n) => {
           ...
           if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
            const s = i.pI.get(e);
            t = (0, m.jsx)(o.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${s.sc} ${s.nl.title}`, style: { lineHeight: 1 }, children: (0, m.jsx)(g.KE, { children: `WCAG ${e}` }) }, n);
           }
           return t;
          }),
         }),
        ...
        (0, m.jsxs)('div', {
         ...
         children: [
          (0, m.jsxs)(r.LB, {
           ...
           'aria-labelledby': k,
           children: [
            (0, m.jsx)(d.DZ, { level: n, id: k, children: 'Filter acceptatiecriteria voor:' }),
            Array.from(g).map((e) =>
             (0, m.jsxs)(
              r.zB,
              {
          ...
          (0, m.jsx)('div', {
           children: (0, m.jsxs)(m.Fragment, {
            children: [
             (0, m.jsxs)(a.f, { role: 'status', children: [j, ' van de ', w, ' items zijn nu zichtbaar.'] }),
             j < w
              ? (0, m.jsx)(l.$, {
                 purpose: 'secondary',
                 onClick: () => {
  ...
  3387(e, n, t) {
   ...
   const a = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    l = ({ name: e, relayStep: n, description: t }) => {
     const l = (0, i.fX)(n),
      c = a[e] ?? e;
     return (0, r.jsxs)(s.WK, { children: [(0, r.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, o.A)('ma-component-illustration', `ma-component-illustration--${l}`), fill: 'none', children: [(0, r.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, r.jsx)('rect', { width: '960', height: '540' }), (0, r.jsx)('rect', { width: '960', height: '540' })] }), (0, r.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, r.jsx)('use', { href: `/svg/componenten_overzicht_${(0, i.fX)(c)}.svg#component-illustration` })] }), (0, r.jsx)(s.$P, { className: 'ma-component-illustration__caption', children: t })] });
    };
  },
  3446(e, n, t) {
   'use strict';
  ...
  3889(e, n, t) {
   ...
   var g = t(41231),
    ...
    h = t(53971);
   const p = [
     { title: 'De code is niet alleen herkenbaar aan een andere achtergrondkleur.', sc: '1.4.1', status: '', component: t(64862).Ay, tags: ['designer', 'contentmaker', 'developer'] },
     { title: 'De code heeft voldoende contrast met de achtergrondkleur', sc: '1.4.3', status: '', component: m.Ay, tags: ['designer', 'contentmaker'] },
     { title: 'Wanneer de achtergrondkleur van het Code Block anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina.', sc: '1.4.11', status: '', component: g.Ay, tags: ['designer', 'contentmaker'] },
    ],
    w = [
     {
   ...
   const N = { title: 'Code Block', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code Block', pagination_label: 'Code Block', description: 'Blok met \xe9\xe9n of meerdere regels computercode.', issue_number: 329, slug: '/code-block', keywords: ['code', 'code block', 'code blok', 'code container', 'code example', 'code fences', 'code memo', 'code snippet', 'code snippet blok', 'code voorbeeld', 'code wrapper', 'codeblock', 'codepen', 'copy paste blok', 'css voorbeeld', 'html voorbeeld', 'inline code', 'monospace', 'monotype', 'pre', 'snippet', 'source code', 'source doc', 'toepassing', 'voorbeeld blok', 'Code Snippet', 'Code Blok', 'Code Example'] },
    ...
    D = {},
    F = 'Code Block',
    L = 'Blok met \xe9\xe9n of meerdere regels computercode.',
    W = 329,
    _ = r.find((e) => e.number === W),
   ...
   function B(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, o.jsx)(A.Fc, { component: _, headingLevel: 1, description: L }), '\n', (0, o.jsx)(k.e, { component: _ }), '\n', (0, o.jsx)(n.admonition, { title: 'Tip', type: 'tip', children: (0, o.jsxs)(n.p, { children: ['Gebruik de ', (0, o.jsx)(n.a, { href: '/code/', children: 'Code' }), ' component als de code in een regel met andere tekst staat.'] }) }), '\n', (0, o.jsx)(f.Zp, { className: 'ma-implementation-card', children: (0, o.jsxs)(f.Wu, { children: [(0, o.jsx)(x.DZ, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, o.jsxs)(j.d, { children: [(0, o.jsxs)(j.P, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=13778-3553', children: [(0, o.jsx)(b.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, o.jsxs)(j.P, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=13778-3553', children: [(0, o.jsx)(b.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, o.jsx)(x.DZ, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, o.jsxs)(j.d, { children: [(0, o.jsxs)(j.P, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-code-block--documentatie', children: [(0, o.jsx)(b.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, o.jsxs)(j.P, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/code-block--documentatie', children: [(0, o.jsx)(b.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, o.jsx)(x.DZ, { level: 2, appearance: 'level-4', children: 'npm' }), (0, o.jsxs)(j.d, { children: [(0, o.jsxs)(j.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-css', children: [(0, o.jsx)(b.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-css'] }), (0, o.jsxs)(j.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-react', children: [(0, o.jsx)(b.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-react'] }), (0, o.jsxs)(j.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-tokens', children: [(0, o.jsx)(b.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-tokens'] })] })] }) }), '\n', (0, o.jsx)(n.h2, { id: 'checklist-voor-toegankelijkheid', children: 'Checklist voor toegankelijkheid' }), '\n', (0, o.jsx)(c.Ay, {}), '\n', (0, o.jsx)(n.h3, { id: 'acceptatiecriteria-bij-gebruik', children: 'Acceptatiecriteria bij gebruik' }), '\n', (0, o.jsx)(l.Ay, {}), '\n', (0, o.jsx)(v.b, { headingLevel: '4', children: p.map(({ component: e, ...n }) => (0, o.jsx)(v.e, { ...n, children: (0, o.jsx)(e, {}) })) }), '\n', (0, o.jsx)(n.h3, { id: 'acceptatiecriteria-van-de-component', children: 'Acceptatiecriteria van de component' }), '\n', (0, o.jsx)(a.Ay, {}), '\n', (0, o.jsx)(v.b, { headingLevel: '4', children: w.map(({ component: e, ...n }) => (0, o.jsx)(v.e, { ...n, children: (0, o.jsx)(e, {}) })) }), '\n', (0, o.jsx)(y.o, { omitH1: !0, headingLevel: 2, children: (0, o.jsx)(R, {}) }), '\n', (0, o.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }), '\n', (0, o.jsx)(C.B, { tokens: G }), '\n', (0, o.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, o.jsx)(A.VK, { component: _, headingLevel: 3 }), '\n', (0, o.jsx)(A.$9, { component: _, headingLevel: 2 }), '\n', (0, o.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, o.jsx)(A.mu, { component: _, headingLevel: 3 }), '\n', (0, o.jsx)(A.K_, { component: _ })] });
   }
   function P(e = {}) {
    const { wrapper: n } = { ...(0, i.R)(), ...e.components };
  ...
  14881(e, n, t) {
   ...
   var s = t(13526),
    ...
    r = t(37168),
    a = t(86070);
   const l = (0, o.forwardRef)(({ as: e, className: n, children: t, ...o }, i) => {
     const r = e || 'div',
      l = (0, s.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(r, { ref: i, className: l, ...o, children: t });
    }),
    c = ({ className: e, classNamePanel: n, label: t, heading: o, headingLevel: l, headingApperance: c, ...d }) => {
     const g = (0, s.A)('utrecht-accordion__section', e),
      u = (0, s.A)('utrecht-accordion__panel', n);
     return (0, a.jsxs)('details', { className: g, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(i.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [o && (0, a.jsx)(r.D, { level: l, appearance: c, children: o }), t] })] }) }), (0, a.jsx)('div', { className: u, children: d.children })] });
    };
  },
  19707(e, n, t) {
   'use strict';
  ...
  24456(e, n, t) {
   ...
   const r = ({ children: e, ...n }) => {
     ...
     return ('https://nldesignsystem.nl' === l.origin ? (l.pathname.endsWith('/') || (0, o.QQ)(l.pathname) || (l.pathname = `${l.pathname}/`), (a = l.toString().replace('https://nldesignsystem.nl', ''))) : ((r.target = '_blank'), (r.rel = 'noopener noreferrer')), (0, i.jsx)('a', { href: a, ...r, children: e }));
    },
    a = ({ className: e, ...n }) => (0, i.jsx)(r, { className: (0, s.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  24703(e, n, t) {
   'use strict';
   t.d(n, { o: () => d });
   ...
   const r = (e, n) => {
     ...
     if ('resolve:' === t.protocol) {
      const { pathname: t, search: s, hash: o } = new URL(n, new URL(e, 'http://example.com/'));
      return t + s + o;
     }
     return t.toString();
    },
    a = { 1: {}, 2: { h1: o.fV, h2: o._B, h3: o.f_, h4: o.mM, h5: o.TT }, 3: { h1: o._B, h2: o.f_, h3: o.mM, h4: o.TT, h5: o.TT }, 4: { h1: o.f_, h2: o.mM, h3: o.TT, h4: o.TT, h5: o.TT }, 5: { h1: o.mM, h2: o.TT, h3: o.TT, h4: o.TT, h5: o.TT }, 6: { h1: o.TT, h2: o.TT, h3: o.TT, h4: o.TT, h5: o.TT } },
    ...
    d = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: o = '', components: r = {} }) => (0, i.jsx)(s.x, { components: { ...c(n, t), ...l(o), ...r }, children: e });
  },
  26165(e, n, t) {
   'use strict';
   t.d(n, { AC: () => c, Fu: () => r, Wu: () => a, Zp: () => l });
   var s = t(46447),
    o = t(13526),
    i = t(86070);
   const r = ({ background: e, children: n, className: t, ...s }) => (0, i.jsx)('div', { className: (0, o.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, t), ...s, children: n }),
    ...
    l = ({ href: e, appearance: n, className: t, component: r = 'div', background: a, children: l }) => {
     const c = (e) => ('article' === r ? (0, i.jsx)('article', { ...e }) : 'section' === r ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      d = (0, i.jsx)(c, { className: (0, o.A)('ma-cardgroup__card', a && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, t), children: l });
     return e ? (0, i.jsx)(s.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: d }) : d;
    },
    c = ({ appearance: e = 'large', children: n, className: t }) => (0, i.jsx)('div', { className: (0, o.A)('ma-cardgroup', `ma-cardgroup--${e}`, t), children: n });
  },
  29857(e, n, t) {
   'use strict';
   t.d(n, { DZ: () => i, _B: () => r });
   var s = t(37168),
    o = t(86070);
   const i = (e) => (0, o.jsx)(s.D, { ...e }),
    r = (e) => (0, o.jsx)(s.D, { ...e, level: 3 });
  },
  37166(e, n, t) {
   'use strict';
   t.d(n, { Ay: () => r });
  ...
  46276(e, n, t) {
   ...
   var s = t(13526),
    o = t(86070);
   const i = ({ children: e, className: n, level: t = 1, suffix: i, ...r }) => (0, o.jsxs)('hgroup', { className: (0, s.A)('nlds-inline-heading-group', `utrecht-heading-${t}`, n), ...r, children: [(0, o.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), i && (0, o.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [i ? ' ' : '', i] })] });
  },
  46847(e, n, t) {
   'use strict';
   t.d(n, { $: () => s.$n });
  ...
  48068(e, n, t) {
   ...
   var u = t(43864),
    ...
    k = t(23436),
    A = t(79532);
   const v = { boxShadow: u.A, color: m.A, cursor: h.A, dimension: p.A, fontFamily: w.A, fontFamilies: w.A, fontSize: f.A, fontSizes: f.A, fontWeight: j.A, fontWeights: j.A, lineHeight: x.A, lineHeights: x.A, number: b.A, other: k.A, textDecoration: A.A },
    C = ({ type: e }) => {
     const n = Object.hasOwn(v, e) ? e : 'other';
     return (0, d.jsx)(c.In, { children: (0, a.createElement)(v[n]) });
    };
   var y = t(76223);
   function T({ tokens: e }) {
    const n = (0, i.kD)(e),
     t = (0, y.sj)(e, (e) => (((e) => null !== e && 'object' == typeof e && Object.hasOwn(e, '$type') && 'string' == typeof e.$type)(e) ? { $type: e.$type, $value: '' } : void 0)),
     a = (0, i.GT)(n),
    ...
    return (0, d.jsxs)('div', {
     ...
     children: [
      (0, d.jsxs)(r.XI, {
       children: [
        (0, d.jsx)(r.A0, { children: (0, d.jsxs)(r.Hj, { children: [(0, d.jsx)(r.M_, { children: 'name' }), (0, d.jsx)(r.M_, { children: 'type' })] }) }),
        (0, d.jsx)(r.BF, {
         children: a.map((n) => {
          const t = (0, i.o_)(n),
           a = (0, i.eQ)(e, n).$type;
          return (0, d.jsxs)(r.Hj, { children: [(0, d.jsx)(r.nA, { children: (0, d.jsx)(s.C, { children: (0, d.jsx)(r.kf, { children: t }) }) }), (0, d.jsx)(r.nA, { children: (0, d.jsxs)(o.K, { children: [(0, d.jsx)(C, { type: a }), ' ', a] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, d.jsxs)(r.e2, { children: [(0, d.jsx)(g, { content: c, children: 'Kopieer als JSON' }), (0, d.jsx)(g, { content: l, children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  48262(e, n, t) {
   ...
   const k = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, u.jsx)(x.n, { children: o.map((t) => (0, u.jsx)(x.K, { className: (0, r.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, f.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(w._, { children: t.tasks.map(({ checked: e, name: t, id: s }) => (0, u.jsx)(w.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, f.qZ)(s) }, s)) }), (0, u.jsx)(s.fz, { children: (0, u.jsxs)(s.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
               ...
               c.Z,
               {
                ...
                description: (0, u.jsxs)('div', {
                 ...
                 children: [
                  ...
                  (0, u.jsxs)('div', {
                   children: [
                    (h.length > 0 || d.length > 0) && (0, u.jsx)(o.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    h.length > 0 &&
                     (0, u.jsx)(s.dk, {
                      links: h
                       ...
                       .map((e) => {
                        ...
                        return { children: n.desciption, icon: (0, u.jsx)(a.r, { brand: n.brand }), href: e.value };
                       }),
                     }),
                   ],
                  }),
                  d.length > 0 && d.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)('section', { children: [(0, u.jsxs)(o.DZ, { level: Math.min(n + 2, 6), children: [r, ' in ', e] }), (0, u.jsx)(s.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(a.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, u.jsxs)(l.Wu, {
                 children: [
                  ...
                  d.length > 0 && (0, u.jsx)(u.Fragment, { children: d.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(s.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, u.jsx)(s.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(a.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    v = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(s.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, u.jsxs)(s.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, u.jsxs)(s.Xy, { children: [o ? (0, u.jsxs)(s.Er, { children: ['Vul de ', (0, u.jsx)(s.N_, { href: o, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, u.jsxs)(s.Er, { children: [(0, u.jsxs)(s.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, u.jsxs)(s.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, u.jsx)(s.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, u.jsx)(s.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    C = ({ component: e, headingLevel: n, description: t }) => {
     const o = e && f.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p.p, { level: n, suffix: o && (0, u.jsx)(h.D, { state: o }), children: e.title }), (0, u.jsx)(s.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(o) && (0, u.jsx)(b.s, { relayStep: o, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    y = ({ component: e }) => {
     const n = (e && j[e.title]) || [];
  ...
  56323(e, n, t) {
   ...
   const a = ({ component: e }) => {
    ...
    const { title: n } = e,
     a = (0, i.fX)(n),
     l = o.lazy(() => t(82839)(`./${a}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
    return (0, r.jsx)(o.Suspense, { fallback: null, children: (0, r.jsx)(s.o, { omitH1: !0, headingLevel: 1, children: (0, r.jsx)(l, {}) }) });
   };
  },
  64862(e, n, t) {
   'use strict';
  ...
  82839(e, n, t) {
   ...
   ((o.keys = () => Object.keys(s)), (o.id = 82839), (e.exports = o));
  },
  84471(e, n, t) {
   'use strict';
   t.d(n, { bo: () => o, KF: () => u, mJ: () => p, VZ: () => v, cR: () => A, Pv: () => w, qZ: () => r, kD: () => b, QQ: () => y, B2: () => m, Pc: () => l, f4: () => a, GT: () => k, fX: () => i, eQ: () => x, B_: () => j, o_: () => f });
    ...
    w = (e) => {
     ...
     return n.map((n) => {
      const s = e.tasks
       ...
       .map(({ name: s, id: o, value: i }) => {
        const r = /^(.+) URL/.exec(s)[1],
         a = 'Storybook' === r ? `${t} (${n}) in Storybook van ${e.title}` : `${t} (${n}) op ${r}`;
        return { brand: r.toLowerCase(), name: s, id: o, value: i, description: a };
       });
  ...
  87856(e, n, t) {
   ...
   const a = ({ state: e }) => {
    const n = (0, i.fX)(e);
    return (0, r.jsx)(s.KE, { className: (0, o.A)('ma-estafette-badge', n && `ma-estafette-badge--${n}`), children: e });
   };
  },
  90515(e, n, t) {
   'use strict';
