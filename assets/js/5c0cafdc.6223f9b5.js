/*! For license information please see 5c0cafdc.6223f9b5.js.LICENSE.txt */
'use strict';
   ...
   var r = t.forwardRef(function (e, n) {
    ...
    return (
     ...
     t.createElement(
      t.Fragment,
      null,
      t.createElement('link', { rel: C, href: T, as: 'image' }),
      ...
      t.createElement(
       Z,
       {
        ...
        'data-title': u,
        style: s(s({ backgroundImage: 'url('.concat(T, ')') }, { '--aspect-ratio': ''.concat((E / z) * 100, '%') }), H),
       },
