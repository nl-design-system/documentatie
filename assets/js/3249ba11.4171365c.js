 ...
 [25640],
 {
  14881(e, n, l) {
   ...
   var a = l(13526),
    ...
    s = l(37168),
    i = l(86070);
   const r = (0, t.forwardRef)(({ as: e, className: n, children: l, ...t }, o) => {
     const s = e || 'div',
      r = (0, a.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, i.jsx)(s, { ref: o, className: r, ...t, children: l });
    }),
    c = ({ className: e, classNamePanel: n, label: l, heading: t, headingLevel: r, headingApperance: c, ...d }) => {
     const g = (0, a.A)('utrecht-accordion__section', e),
      h = (0, a.A)('utrecht-accordion__panel', n);
     return (0, i.jsxs)('details', { className: g, ...d, children: [(0, i.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, i.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, i.jsx)('span', { className: 'nl-button__icon-start', children: (0, i.jsx)(o.A, {}) }), (0, i.jsxs)('span', { className: 'nl-button__label', children: [t && (0, i.jsx)(s.D, { level: r, appearance: c, children: t }), l] })] }) }), (0, i.jsx)('div', { className: h, children: d.children })] });
    };
  },
  18439(e, n, l) {
   l.d(n, { R: () => s, x: () => i });
  ...
  28369(e, n, l) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: l, trim: c }) {
    let d = l;
    const { title: g, type: h } = (0, o.useContext)(s.x),
     p = (0, o.useId)();
    return (c && (d = d.trim()), (0, r.jsx)(t.f4, { theme: i, code: d, language: n || '', children: ({ style: n, tokens: l, getLineProps: t, getTokenProps: o }) => (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', g ? ': ' : ' ', g] }), (0, r.jsx)(a.NG, { tabIndex: 0, role: g ? 'region' : void 0, 'aria-labelledby': p, style: n, children: l.map((n, l) => (0, r.jsxs)('span', { ...t({ line: n }), children: [e && (0, r.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, r.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  38953(e, n, l) {
   l.d(n, { H: () => y });
   var a = l(28369),
    ...
    b = l(46847),
    v = l(86070);
   const f = ({ children: e }) => (0, v.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, v.jsx)(t.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, v.jsx)(t.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   ...
   const k = ({ children: e }) => (0, v.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: e });
   k.displayName = 'SurfaceContainer';
   const y = globalThis.isAstro
    ? ({ language: e, className: n, code: l = '<p>No code provided</p>', rawCode: a, copyCode: t, defaultExpandedCode: s, designTokens: i }) => {
       const r = 'string' == typeof l ? l : a || '',
        c = 'string' == typeof l ? u().highlight(l, u().languages[e], e) : u().highlight(a || '', u().languages[e], e);
       return (0, v.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', n), children: [(0, v.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: i, children: (0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }) }), (0, v.jsx)(m.n, { children: (0, v.jsxs)(m.K, { label: 'Code', open: s, children: [(0, v.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: c } }) }), 'allow' === t && (0, v.jsx)(b.$, { 'data-copy-code': r, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: p = !0, children: u, container: m = 'document', language: b, designTokens: y }) => {
       const x = 'function' == typeof u ? u() : u,
        _ = 'function' == typeof e ? e() : (0, g.isValidElement)(e) ? e : void 0,
        N = 'string' == typeof e ? e : h.qV(_ || x),
        [w, z] = (0, g.useState)(N),
        [A, C] = (0, g.useState)(l);
       (0, g.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: b, plugins: [s.A, i.Ay, r.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         z(e);
        })();
       }, [N]);
       const S = (0, g.useId)();
       let D = g.Fragment;
       return (
        'paragraph' === m ? (D = f) : 'document' === m ? (D = j) : 'surface' === m && (D = k),
        (0, v.jsxs)('div', {
         className: (0, o.A)('nlds-canvas'),
         children: [
          x && (0, v.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, v.jsx)(D, { children: (0, v.jsx)(t.v$, { children: x }) }) }) }),
          p &&
           (0, v.jsx)('div', {
          ...
          p &&
           (0, v.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, v.jsx)(a.M, { codeBlockLabel: 'Codevoorbeeld', syntax: b, textContent: w, trim: !0 }),
             n &&
              (0, v.jsx)('div', {
