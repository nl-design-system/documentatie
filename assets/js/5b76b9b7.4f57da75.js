...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [57255],
 {
  ...
  20201(e, n, t) {
   ...
   const r = i.forwardRef(function (e, n) {
    const [t, r] = i.useState(!1),
     ...
     b = i.useMemo(() => (e.playlist ? `${k}/embed/videoseries?${y.toString()}` : `${k}/embed/${c}?${y.toString()}`), [e.playlist, k, c, y]),
     ...
     j = v
      ...
      : null,
     S = i.useMemo(() => e.thumbnail || j || `https://i.ytimg.com/${f}/${e.playlist ? m : c}/${u}.${w}`, [e.thumbnail, j, f, e.playlist, m, c, u, w]),
    ...
    return (
     ...
     (0, s.jsxs)(s.Fragment, {
      children: [
       !e.lazyLoad && (0, s.jsx)('link', { rel: R, href: S, as: 'image' }),
       (0, s.jsx)(s.Fragment, { children: t && (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)('link', { rel: 'preconnect', href: k }), (0, s.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), x && (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, s.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
       e.seo && !e.playlist && (0, s.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: o(e.id, g, S, k, e.seo) } }),
       E && !e.playlist && (0, s.jsx)('noscript', { children: (0, s.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${g} on YouTube`, children: ['Watch "', g, '" on YouTube'] }) }),
       (0, s.jsxs)(_, {
        onPointerOver: () => {
         t || r(!0);
        },
        ...
        children: [e.lazyLoad && !l && (0, s.jsx)('img', { src: S, alt: `${g} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !l && (0, s.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && l) && (0, s.jsx)('button', { type: 'button', className: P, 'aria-label': `${p} ${g}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, onClick: W, children: (0, s.jsx)('span', { className: 'lty-visually-hidden', children: p }) }), l && (0, s.jsx)('iframe', { ref: n, className: N, title: g, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  56561(e, n, t) {
   ...
   var m = (0, r.forwardRef)(function (e, n) {
    var t = e.children,
     ...
     d = e.purpose,
     m = (0, i.A)(e, l);
    return (0, a.jsx)('p', c(c({ className: (0, o.$)('nl-paragraph', (0, s.A)({}, 'nl-paragraph--lead', 'lead' === d), r), ref: n }, m), {}, { children: 'lead' === d ? (0, a.jsx)('b', { className: 'nl-paragraph__lead', children: t }) : t }));
   });
  ...
  80883(e, n, t) {
   ...
   var s = t(20201),
    i = t(86070);
   const a = ({ id: e, title: n, ...t }) => (0, i.jsx)(s.Ay, { lazyLoad: !0, adNetwork: !1, announce: 'Bekijk', cookie: !1, containerElement: 'div', id: e, title: n, poster: 'maxresdefault', ...t });
  },
  82764(e, n, t) {
   (t.r(n), t.d(n, { assets: () => c, contentTitle: () => d, default: () => u, frontMatter: () => l, metadata: () => s, toc: () => m }));
