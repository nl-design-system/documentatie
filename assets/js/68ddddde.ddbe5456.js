(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [5643],
 {
  ...
  51836: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => K, component: () => ee, contentTitle: () => $, default: () => te, description: () => q, frontMatter: () => I, issueNumber: () => Q, metadata: () => X, title: () => Y, toc: () => J });
   var r,
    i,
    o,
    s,
   ...
   var D = t(13838),
    ...
    V = t(55240),
    B = t(8657);
   const I = { title: 'Skip Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Skip Link', pagination_label: 'Skip Link', description: 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.', slug: '/skip-link' },
    $ = void 0,
    X = { id: 'componenten/skip-link/index', title: 'Skip Link', description: 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.', source: '@site/docs/componenten/skip-link/index.mdx', sourceDirName: 'componenten/skip-link', slug: '/skip-link', permalink: '/skip-link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/skip-link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Skip Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Skip Link', pagination_label: 'Skip Link', description: 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.', slug: '/skip-link' }, sidebar: 'componenten', previous: { title: 'Side Navigation', permalink: '/side-navigation' }, next: { title: 'Spinner', permalink: '/spinner' } },
    K = {},
    J = [
   ...
   function ne(e) {
    ...
    return (0, m.jsxs)(m.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, m.jsx)(B.Rv, { component: ee, headingLevel: 1, description: q }),
      '\n',
      (0, m.jsx)(H.I, { component: ee }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, m.jsx)(U.B, { component: ee, illustration: v }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, m.jsx)(B.cN, { component: ee, headingLevel: 3 }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, m.jsx)(B.W, { component: ee, headingLevel: 3 }),
      '\n',
      ...
      (0, m.jsx)(V.t, {
       ...
       items: [
        ...
        { title: 'Als je de hele webpagina inzoomt tot 400% blijft veroorzaakt de Skip Link veroorzaakt geen horizontale scrollbalk en alle tekst op de pagina blijft leesbaar', sc: '1.4.10', status: '', component: (0, m.jsx)(S.ZP, {}) },
       ],
      }),
      '\n',
      (0, m.jsx)(V.t, {
      ...
      '\n',
      (0, m.jsx)(B.vM, { component: ee, headingLevel: 3 }),
     ],
    });
   }
   function te(e = {}) {
    const { wrapper: n } = { ...(0, g.a)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(ne, { ...e }) }) : ne(e);
   }
  },
  66015: (e, n, t) => {
   'use strict';
