  ...
  9386(e, n, l) {
   ...
   const k = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       ...
       return (0, p.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', l), children: [(0, p.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: a } }), (0, p.jsx)(u.n, { children: (0, p.jsx)(u.K, { label: 'Code', children: (0, p.jsx)('pre', { className: 'language-html nl-code-block', children: (0, p.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
         ...
         children: [
          ...
          h &&
           (0, p.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, p.jsx)(t.M, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: N, trim: !0 }),
             n &&
              (0, p.jsx)('div', {
