 ...
 [506],
 {
  58614: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(80719),
    s = n(90786);
   const o = { title: 'Pre-heading', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Pre-heading', pagination_label: 'Pre-heading', description: 'Een ondersteunende tekst die boven een kop staat.', slug: '/pre-heading' },
    a = void 0,
    l = { id: 'componenten/pre-heading/index', title: 'Pre-heading', description: 'Een ondersteunende tekst die boven een kop staat.', source: '@site/docs/componenten/pre-heading/index.mdx', sourceDirName: 'componenten/pre-heading', slug: '/pre-heading', permalink: '/pre-heading', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/pre-heading/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Pre-heading', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Pre-heading', pagination_label: 'Pre-heading', description: 'Een ondersteunende tekst die boven een kop staat.', slug: '/pre-heading' }, sidebar: 'componenten', previous: { title: 'Password input', permalink: '/password-input' }, next: { title: 'Progress bar', permalink: '/progress-bar' } },
    u = {},
    d = [
