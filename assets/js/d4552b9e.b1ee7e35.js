 ...
 [70767],
 {
  ...
  21034(e, n, r) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
     const r = e && e.projects.filter((e) => h.f4.includes(e.id)),
      a = r && h.f4.map((e) => r.find((n) => n.id === e)).filter(Boolean);
     return e && (0, d.jsx)(j.n, { children: a.map((r) => (0, d.jsx)(j.K, { className: (0, i.A)('ma-definition-of-done', r && `ma-definition-of-done--${(0, h.fX)(r.title)}`), heading: r ? `${r.title} - ${r.progress.value} van ${r.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u._, { children: r.tasks.map(({ checked: e, name: r, id: t }) => (0, d.jsx)(u.Z, { headingLevel: n + 1, checked: e, heading: r, description: (0, h.qZ)(t) }, t)) }), (0, d.jsx)(t.fz, { children: (0, d.jsxs)(t.N_, { href: `${r.url}?filterQuery=${e.title}`, children: [r.title, ' projectbord op GitHub'] }) })] }) }, r.title)) });
    },
            ...
            o.Zp,
            {
             ...
             children: (0, d.jsxs)(o.Wu, {
              children: [
               ...
               s.length > 0 && (0, d.jsx)(d.Fragment, { children: s.map(({ frameworkName: e, tasks: r }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, d.jsx)(t.dk, { links: r.map((e) => ({ children: e.description, icon: (0, d.jsx)(a.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    k = ({ component: e, headingLevel: n, description: r }) => {
     const i = e && h.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: i && (0, d.jsx)(g.D, { state: i }), children: e.title }), (0, d.jsx)(t.fz, { lead: !0, children: r }), ['Help Wanted', 'Community'].includes(i) && (0, d.jsx)(f.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    F = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
  ...
  21530(e, n, r) {
   ...
   const o = ({ background: e, children: n, className: r, ...t }) => (0, a.jsx)('div', { className: (0, i.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, r), ...t, children: n }),
    ...
    l = ({ href: e, appearance: n, className: r, component: o = 'div', background: s, children: l }) => {
     const d = (e) => ('article' === o ? (0, a.jsx)('article', { ...e }) : 'section' === o ? (0, a.jsx)('section', { ...e }) : (0, a.jsx)('div', { ...e })),
      c = (0, a.jsx)(d, { className: (0, i.A)('ma-cardgroup__card', s && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, r), children: l });
  ...
  32385(e, n, r) {
   r.d(n, { bo: () => i, KF: () => m, mJ: () => p, VZ: () => w, cR: () => F, Pv: () => j, qZ: () => o, kD: () => v, QQ: () => A, B2: () => u, Pc: () => l, f4: () => s, GT: () => k, fX: () => a, eQ: () => b, B_: () => x, o_: () => f });
      ...
      const t = e.tasks
       ...
       .map(({ name: t, id: i, value: a }) => {
        const o = /^(.+) URL/.exec(t)[1],
         s = 'Storybook' === o ? `${r} (${n}) in Storybook van ${e.title}` : `${r} (${n}) op ${o}`;
        return { brand: o.toLowerCase(), name: t, id: i, value: a, description: s };
       });
  ...
  68517(e, n, r) {
   (r.r(n), r.d(n, { assets: () => T, component: () => M, contentTitle: () => L, default: () => G, description: () => R, frontMatter: () => H, issueNumber: () => _, metadata: () => t, title: () => C, toc: () => B }));
  ...
  70348(e, n, r) {
   ...
   const s = ({ className: e, ...n }) => {
    ...
    l = ({ className: e, classNamePanel: n, label: r, heading: s, headingLevel: l, headingApperance: d, ...c }) => {
     const g = (0, t.A)('utrecht-accordion__section', e),
      m = (0, t.A)('utrecht-accordion__panel', n);
     return (0, o.jsxs)('details', { className: g, ...c, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(i.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [s && (0, o.jsx)(a.D, { level: l, appearance: d, children: s }), r] })] }) }), (0, o.jsx)('div', { className: m, children: c.children })] });
    };
  },
  70561(e, n, r) {
   r.d(n, { Ay: () => s, RM: () => a });
  ...
  85162(e, n, r) {
   ...
   const s = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    l = ({ name: e, relayStep: n, description: r }) => {
     const l = (0, a.fX)(n),
      d = s[e] ?? e;
     return (0, o.jsxs)(t.WK, { children: [(0, o.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, i.A)('ma-component-illustration', `ma-component-illustration--${l}`), fill: 'none', children: [(0, o.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, o.jsx)('rect', { width: '960', height: '540' }), (0, o.jsx)('rect', { width: '960', height: '540' })] }), (0, o.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, o.jsx)('use', { href: `/svg/componenten_overzicht_${(0, a.fX)(d)}.svg#component-illustration` })] }), (0, o.jsx)(t.$P, { className: 'ma-component-illustration__caption', children: r })] });
    };
  },
  89445(e, n, r) {
   r.d(n, { Ay: () => o });
