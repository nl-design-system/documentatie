   ...
   const d = (0, i.createContext)({}),
    h = ({ title: e, appearance: n, description: t, children: i, figure: h }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      k = h ? 'figure' : 'div',
      g = h ? 'figcaption' : 'div',
      p = 'string' == typeof t ? (0, c.jsx)(a.oz, { components: { a: s.N_ }, children: t }) : t;
  ...
  70348(e, n, t) {
   ...
   const a = ({ className: e, ...n }) => {
    ...
    i = ({ className: e, classNamePanel: n, label: t, heading: a, headingLevel: i, headingApperance: c, ...d }) => {
     ...
     return (0, o.jsxs)('details', { className: h, ...d, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(r.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [a && (0, o.jsx)(s.D, { level: i, appearance: c, children: a }), t] })] }) }), (0, o.jsx)('div', { className: u, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => x });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const l = 'function' == typeof e ? e() : e,
        ...
        o = g().highlight(r, g().languages[n], n);
       return (0, m.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', t), children: [(0, m.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }), (0, m.jsx)(p.n, { children: (0, m.jsx)(p.K, { label: 'Code', children: (0, m.jsx)('pre', { className: 'language-html nl-code-block', children: (0, m.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
