...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [39439],
 {
  ...
  46242(e, n, t) {
   (t.r(n), t.d(n, { assets: () => i, contentTitle: () => l, default: () => c, frontMatter: () => s, metadata: () => o, toc: () => p }));
   ...
   var r = t(86070),
    a = t(18439);
   const s = { title: 'Introductie patronen en templates', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Introductie patronen en templates', sidebar_position: 0, pagination_label: 'Introductie', description: 'Verzameling van patronen en templates.', slug: '/voorbeelden/patronen-en-templates', keywords: ['voorbeelden', 'patronen', 'templates', 'gebruikersonderzoek'] },
