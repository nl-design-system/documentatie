 ...
 [47916],
 {
  ...
  98296(e, n, a) {
   ...
   var i = a(86070),
    ...
    s = a(82461),
    o = a(56167);
   const r = { title: 'Grid', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Grid', pagination_label: 'Grid', description: 'Verdeelt content in rijen en kolommen voor een consistente en overzichtelijke layout.', issue_number: 435, slug: '/grid', keywords: ['grid', 'layout', 'row', 'column', 'rij', 'rijen', 'kolom', 'kolommen', 'raster'] },
    d = void 0,
    g = {},
    u = 'Grid',
