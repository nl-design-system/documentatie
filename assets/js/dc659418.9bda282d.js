 ...
 [88963],
 {
  14881(e, n, l) {
   ...
   const c = (0, o.forwardRef)(({ as: e, className: n, children: l, ...o }, t) => {
     ...
     return (0, s.jsx)(r, { ref: t, className: c, ...o, children: l });
    }),
    i = ({ className: e, classNamePanel: n, label: l, heading: o, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, s.jsxs)('details', { className: m, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(t.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [o && (0, s.jsx)(r.D, { level: c, appearance: i, children: o }), l] })] }) }), (0, s.jsx)('div', { className: h, children: d.children })] });
    };
  },
  18439(e, n, l) {
   l.d(n, { R: () => r, x: () => s });
   ...
   function s(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(o) : e.components || o) : r(e.components)), a.createElement(t.Provider, { value: n }, e.children));
   }
  },
  28369(e, n, l) {
   l.d(n, { M: () => i });
  ...
  38953(e, n, l) {
   ...
   const k = globalThis.isAstro
    ...
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: u = !0, children: p, container: b = 'document', language: g, designTokens: k }) => {
       ...
       (0, m.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: g, plugins: [r.A, s.Ay, c.Ay, i.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         w(e);
        })();
       }, [N]);
       const S = (0, m.useId)();
  ...
  55832(e, n, l) {
   ...
   function i(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', (0, o.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, o.jsx)(c.$, { appearance: 'do', title: 'Het zichtbare label is de toegankelijke naam.', children: (0, o.jsx)(s.H, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('p', { children: (0, o.jsx)('label', { htmlFor: 'hond', children: 'Hoe heet je hond' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('input', { type: 'text', id: 'hond', name: 'hond' }) })] }) }) }), '\n', (0, o.jsx)(c.$, { appearance: 'dont', title: 'Alleen een placeholder gebruiken om te laten zien wat de gebruiker moet invullen,', description: 'terwijl de onzichtbare toegankelijke naam een hele andere inhoud heeft.', children: (0, o.jsx)(s.H, { language: 'html', children: () => (0, o.jsx)('p', { children: (0, o.jsx)('input', { type: 'text', name: 'lievelingskleur', 'aria-label': 'Vul een kleur in', placeholder: 'Wat is je lievelingskleur' }) }) }) }), '\n', (0, o.jsx)(c.$, { appearance: 'dont', title: 'Alleen losse tekst gebruiken om te laten zien wat de gebruiker moet invullen,', description: 'terwijl de onzichtbare toegankelijke naam een hele andere inhoud heeft.', children: (0, o.jsx)(s.H, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('p', { children: 'Zoek' }), (0, o.jsx)('input', { type: 'search', name: 'trefwoord', 'aria-label': 'Trefwoord' })] }) }) })] });
   }
   function d(e = {}) {
