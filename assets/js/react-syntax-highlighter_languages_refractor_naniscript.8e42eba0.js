       ...
       e.tokens.forEach(function (e) {
        if ("string" != typeof e && "generic-text" === e.type) {
         ...
         (function (e) {
          ...
          return 0 === a.length;
         })(n) || ((e.type = "bad-line"), (e.content = n));
        }
       });
      });
    })(e);
   }
   (e.exports = n), (n.displayName = "naniscript"), (n.aliases = []);
  },
 },
]);
