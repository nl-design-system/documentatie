 ...
 [39306],
 {
  1292(e, t, n) {
   ...
   const l = { figma: (0, u.jsx)(i.A, {}), github: (0, u.jsx)(c.A, {}), npm: (0, u.jsx)(s.A, {}), storybook: (0, u.jsx)(o.A, {}) },
    d = ({ brand: e }) => (0, u.jsx)(r.In, { children: l[e] || (0, u.jsx)(a.A, {}) });
  },
  21909(e, t, n) {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => u, default: () => g, description: () => h, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => d, toc: () => m });
   ...
   const a = { title: 'Date Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Input', pagination_label: 'Date Input', description: 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.', slug: '/date-input', keywords: ['browser', 'built-in', 'date', 'datepicker', 'date field', 'date input', 'date picker', 'date selection', 'datum', 'datum invoer', 'datumveld', 'form', 'form control', 'formulier', 'formulierelement', 'ingebouwd', 'input', 'input field', 'invoerveld', 'invullen', 'kalender', 'native', 'text field'] },
    ...
    l = {},
    d = 'Date Input',
    h = 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.',
    j = 188,
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => h, mJ: () => m, VZ: () => w, cR: () => _, Pv: () => p, qZ: () => s, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => k, fX: () => c, eQ: () => b, B_: () => v, o_: () => g, Rc: () => x });
   ...
   const d = (e) => [...e].sort((e, t) => u.indexOf(e) - u.indexOf(t)),
    h = (e) => {
    ...
    m = (e) => d(l(e.projects.flatMap((e) => y(e)))),
    p = (e) => {
     const t = y(e),
      n = ((e) => {
  ...
  99630(e, t, n) {
   ...
   const g = ({ component: e, headingLevel: t }) => {
         ...
         children: n
          ...
          .map((e) => {
           const n = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            d = e.tasks.filter(({ name: e, value: t }) => l.has(e) && URL.canParse(t) && 'https:' === new URL(t).protocol);
           return (0, a.jsx)(
            s.Zp,
            {
    ...
    f = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(d.p, { level: t, suffix: i && (0, a.jsx)(l.D, { state: i }), children: e.title }), (0, a.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
 },
]);
