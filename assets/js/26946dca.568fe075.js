 ...
 [3958],
 {
   ...
   function M(e) {
    ...
    return (0, o.jsxs)(o.Fragment, {
     children: [
      ...
      '\n',
      (0, o.jsx)(t.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }),
      '\n',
      (0, o.jsx)(A.$9, { component: L, headingLevel: 3 }),
      '\n',
  ...
  99630(e, t, n) {
   ...
   const p = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    g = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, l.jsxs)('li', { className: (0, o.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, o.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(m.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [n ? (0, l.jsx)(u.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }) : null, r, t] })] });
   var j = n(33062);
   const w = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => j.f4.includes(e.id)),
      s = n && j.f4.map((e) => n.find((t) => t.id === e)).filter(Boolean);
     return e && (0, l.jsx)(r.If, { sections: s.map((n) => ({ className: (0, o.A)('definition-of-done', n && `definition-of-done--${(0, j.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(g, { headingLevel: t + 1, checked: e, title: n, description: (0, j.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            i.Zp,
            {
             ...
             children: (0, l.jsxs)(i.Wu, {
              children: [
               ...
               (h.length > 0 || c.length > 0) && (0, l.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, l.jsx)(l.Fragment, {
               ...
               c.length > 0 && (0, l.jsx)(l.Fragment, { children: c.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [o, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    f = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(h.p, { level: t, suffix: o && (0, l.jsx)(d.D, { state: o }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
 },
]);
