(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [9910],
 {
  2557: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => p, contentTitle: () => a, default: () => b, description: () => j, frontMatter: () => s, illustration: () => g, issueNumber: () => y, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    o = n(24785),
    i = n(14147),
    c = n(23952);
   const s = { title: 'Action Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Action Group', pagination_label: 'Action Group', description: 'Groepeert \xe9\xe9n of meer gerelateerde acties en verzorgt de lay-out van de content.', slug: '/action-group', keywords: ['action bar', 'action group', 'actions', 'button', 'button container', 'button dock', 'button group', 'button row', 'buttongroup', 'buttons', 'form submission', 'formulier verzenden', 'knop', 'knoppen', 'knoppenbalk', 'toolbar', 'werkbalk'] },
    a = void 0,
    u = { id: 'componenten/action-group/index', title: 'Action Group', description: 'Groepeert \xe9\xe9n of meer gerelateerde acties en verzorgt de lay-out van de content.', source: '@site/docs/componenten/action-group/index.mdx', sourceDirName: 'componenten/action-group', slug: '/action-group', permalink: '/action-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/action-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Action Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Action Group', pagination_label: 'Action Group', description: 'Groepeert \xe9\xe9n of meer gerelateerde acties en verzorgt de lay-out van de content.', slug: '/action-group', keywords: ['action bar', 'action group', 'actions', 'button', 'button container', 'button dock', 'button group', 'button row', 'buttongroup', 'buttons', 'form submission', 'formulier verzenden', 'knop', 'knoppen', 'knoppenbalk', 'toolbar', 'werkbalk'] }, sidebar: 'componenten', previous: { title: 'Accordion', permalink: '/accordion' }, next: { title: 'Alert', permalink: '/alert' } },
    l = {},
    d = [
    ...
    h = 'Action Group',
    j = 'Groepeert \xe9\xe9n of meer gerelateerde acties en verzorgt de lay-out van de content.',
    g = 'ActionGroupSketch',
    y = 153,
    p = i.find((e) => e.number === y);
   function m(e) {
    const t = { h2: 'h2', ...(0, o.a)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, r.jsx)(c.Rv, { component: p, headingLevel: 1, description: j }), '\n', (0, r.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, r.jsx)(c.cN, { component: p, headingLevel: 3 }), '\n', (0, r.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }), '\n', (0, r.jsx)(c.W, { component: p, headingLevel: 3 }), '\n', (0, r.jsx)(t.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }), '\n', (0, r.jsx)(c.vM, { component: p, headingLevel: 3 })] });
   }
   function b(e = {}) {
  ...
  68963: (e, t, n) => {
   ...
   const s = (e) => {
     ...
     return (0, c.jsx)('div', { className: (0, o.Z)(i.card__illustration, t && i['card__illustration--background'], r), ...s, children: n });
    },
    a = (e) => (0, c.jsx)('div', { className: (0, o.Z)(i.card__content), ...e }),
    u = (e) => {
     let { href: t, appearance: n, className: s, component: a = 'div', children: u } = e;
     const l = (e) => ('article' === a ? (0, c.jsx)('article', { ...e }) : 'section' === a ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      d = (0, c.jsx)(l, { className: (0, o.Z)(i.cardgroup__card, i[`cardgroup__card--${n}`], s), children: u });
     return t ? (0, c.jsx)(r.rU, { href: t, boxContent: !0, className: i.cardgroup__link, children: d }) : d;
    },
    l = (e) => {
     let { appearance: t = 'medium', children: n, className: r } = e;
     return (0, c.jsx)('div', { className: (0, o.Z)(i.cardgroup, i[`cardgroup--${t}`], r), children: n });
    };
  },
  23952: (e, t, n) => {
   'use strict';
   n.d(t, { cN: () => D, vM: () => G, W: () => T, Rv: () => L });
   var r = n(56150),
    o = n(4814),
    i = (n(75271), n(39854)),
    c = n(7522),
    ...
    u = n(32636),
    l = n(52676);
   const d = { figma: (0, l.jsx)(i.Z, {}), github: (0, l.jsx)(c.Z, {}), npm: (0, l.jsx)(s.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const f = 'task-list_hh8j',
    ...
    z = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, o.Z)(_), children: [(0, l.jsxs)('div', { className: (0, o.Z)(x, t && w), children: [(0, l.jsx)('span', { className: A, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(v.X6, { appearance: 'utrecht-heading-3', level: c, children: r }), i, n] })] });
    };
   var S = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const i = t && t.projects.filter((e) => S.e9.includes(e.id)),
      c = i && S.e9.map((e) => i.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: c.map((e) => ({
        className: (0, o.Z)(g['definition-of-done'], e && g[`definition-of-done--${(0, S.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
    ...
    T = (e) => {
     ...
     return t && i.length
      ? (0, l.jsx)(j.um, {
         appearance: 'large',
         className: (0, o.Z)(g['implementation-card-group']),
         children: i
          .sort((e, t) => {
          ...
          .map((e) => {
           ...
           return (0, l.jsx)(
            j.Zb,
            {
             className: (0, o.Z)(g['implementation-card']),
    ...
    L = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(b.V, { level: n, suffix: i && (0, l.jsx)(m.y, { state: i }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: o })] });
    };
  },
  86964: (e, t, n) => {
   'use strict';
   ...
   const a = (e) => {
    let { state: t } = e;
    const n = (0, c.mA)(t);
    return (0, s.jsx)(r.Ou, { className: (0, o.Z)(i['estafette-badge'], n && i[`estafette-badge--${n}`]), children: t });
   };
  },
  72657: (e, t, n) => {
   'use strict';
   ...
   const c = (e) => {
    ...
    return (0, i.jsxs)('hgroup', { className: (0, r.Z)(o['nlds-inline-heading-group'], `utrecht-heading-${c}`, n), ...a, children: [(0, i.jsx)('h1', { className: (0, r.Z)(o['nlds-inline-heading-group__heading']), children: t }), s && (0, i.jsxs)('p', { className: (0, r.Z)(o['nlds-inline-heading-group__suffix']), children: [s ? ' ' : '', s] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => s, Q6: () => i, e9: () => c, mA: () => o });
