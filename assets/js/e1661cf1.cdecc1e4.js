 ...
 [76066],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    h = n(86070);
   const l = { figma: (0, h.jsx)(i.A, {}), github: (0, h.jsx)(s.A, {}), npm: (0, h.jsx)(c.A, {}), storybook: (0, h.jsx)(o.A, {}) },
    u = ({ brand: e }) => (0, h.jsx)(r.In, { children: l[e] || (0, h.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => p, VZ: () => _, cR: () => w, Pv: () => g, qZ: () => c, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => s, eQ: () => f, B_: () => v, o_: () => y, Rc: () => x });
   const r = JSON.parse('{"sP":{"//":"Update @types/node to match the highest node version here","node":">=24 <=25","pnpm":"^10.17.0"}}'),
    ...
    h = ['CSS', 'HTML', 'Web Component', 'React', 'Vue', 'Angular', 'Twig'];
   function l(e) {
    return Array.from(new Set(e));
   }
   const u = (e) => [...e].sort((e, t) => h.indexOf(e) - h.indexOf(t)),
    d = (e) => {
     const t = e.flatMap(({ projects: e }) => e).flatMap((e) => m(e));
     return u(l(t));
    },
    j = (e, t) => p(e).includes(t),
    m = (e) => {
     const t = / URL \(([^)]+)\)/;
     return u(l(e.tasks.filter(({ name: e, value: n }) => '' !== n && t.test(e)).map(({ name: e }) => t.exec(e)?.[1])));
    },
    p = (e) => u(l(e.projects.flatMap((e) => m(e)))),
    g = (e) => {
     const t = m(e),
      n = ((e) => {
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map(({ name: r, id: i, value: s }) => {
        ...
        return { brand: c.toLowerCase(), name: r, id: i, value: s, description: o };
       });
  ...
  44594(e, t, n) {
   ...
   const o = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    a = ({ name: e, relayStep: t, description: n }) => {
     const a = (0, s.fX)(t),
      h = o[e] ?? e;
     return (0, c.jsxs)(r.WK, { children: [(0, c.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, i.A)('component-illustration', `component-illustration--${a}`), fill: 'none', children: [(0, c.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, c.jsx)('rect', { width: '960', height: '540' }), (0, c.jsx)('rect', { width: '960', height: '540' })] }), (0, c.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, c.jsx)('use', { href: `/svg/componenten_overzicht_${(0, s.fX)(h)}.svg#component-illustration` })] }), (0, c.jsx)(r.$P, { className: 'component-illustration__caption', children: n })] });
    };
  },
  54565(e, t, n) {
   'use strict';
  ...
  67970(e, t, n) {
   ...
   const o = ({ state: e }) => {
    const t = (0, s.fX)(e);
    return (0, c.jsx)(r.KE, { className: (0, i.A)('estafette-badge', t && `estafette-badge--${t}`), children: e });
   };
  },
  71595(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => u, component: () => y, componentName: () => g, contentTitle: () => l, default: () => k, description: () => j, frontMatter: () => h, issueNumber: () => m, metadata: () => r, relayStep: () => p, title: () => d, toc: () => v }));
   const r = JSON.parse('{"id":"componenten/form-navigation/index","title":"Form Navigation","description":"Overzicht van stappen in een formulier, met de mogelijkheid om direct naar beschikbare stappen te navigeren.","source":"@site/docs/componenten/form-navigation/index.mdx","sourceDirName":"componenten/form-navigation","slug":"/form-navigation","permalink":"/form-navigation","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-navigation/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Form Navigation","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Form Navigation","pagination_label":"Form Navigation","description":"Overzicht van stappen in een formulier, met de mogelijkheid om direct naar beschikbare stappen te navigeren.","slug":"/form-navigation","keywords":["form navigation","formulier navigatie","formulier","formulierstap","formulier stappen","form steps","meter","progress","progress indicator","progress list","progress navigation","progress stepper","progress tracker","stap","stepform","stepper","stepper vertical","stepper indicator","steps","steps list","vertical stepper"]},"sidebar":"componenten","previous":{"title":"Form Field Label Suffix","permalink":"/form-field-label-suffix"},"next":{"title":"Form Summary","permalink":"/form-summary"}}');
   var i = n(86070),
    s = n(18439),
    c = n(36059),
    o = n(85825),
    a = n(44594);
   const h = { title: 'Form Navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Navigation', pagination_label: 'Form Navigation', description: 'Overzicht van stappen in een formulier, met de mogelijkheid om direct naar beschikbare stappen te navigeren.', slug: '/form-navigation', keywords: ['form navigation', 'formulier navigatie', 'formulier', 'formulierstap', 'formulier stappen', 'form steps', 'meter', 'progress', 'progress indicator', 'progress list', 'progress navigation', 'progress stepper', 'progress tracker', 'stap', 'stepform', 'stepper', 'stepper vertical', 'stepper indicator', 'steps', 'steps list', 'vertical stepper'] },
    l = void 0,
    u = {},
    d = 'Form Navigation',
    j = 'Overzicht van stappen in een formulier, met de mogelijkheid om direct naar beschikbare stappen te navigeren.',
    m = 41,
    p = 'help wanted',
    g = 'form-navigation',
    y = c.find((e) => e.number === m),
    v = [
  ...
  72642(e, t, n) {
   ...
   var r = n(13526),
    i = n(86070);
   const s = ({ children: e, className: t, level: n = 1, suffix: s, ...c }) => (0, i.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, t), ...c, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), s && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
  },
  85825(e, t, n) {
   'use strict';
   n.d(t, { VK: () => v, $9: () => k, mu: () => f, Fc: () => b });
   var r = n(29181),
    i = n(13526),
    s = n(1292),
    c = n(90495),
   ...
   var u = n(67970),
    ...
    j = n(46447),
    m = n(45561);
   const p = ({ children: e }) => (0, h.jsx)('ul', { className: 'task-list', children: e }),
    g = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, h.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, h.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, h.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, h.jsx)(m.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, h.jsxs)('div', { children: [n ? (0, h.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }) : null, r, t] })] });
   var y = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, h.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, y.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, h.jsx)(g, { headingLevel: t + 1, checked: e, title: n, description: (0, y.qZ)(r) }, r)) }), (0, h.jsx)(r.fz, { children: (0, h.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
         ...
         children: n
          ...
          .map((e) => {
           const n = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            u = e.tasks.filter(({ name: e, value: t }) => a.has(e) && URL.canParse(t) && 'https:' === new URL(t).protocol);
           return (0, h.jsx)(
            c.Zp,
            {
             className: 'implementation-card',
             children: (0, h.jsxs)(c.Wu, {
              children: [
               (0, h.jsx)(r.DZ, { level: t, children: e.title.replace(/^Community/i, '') }),
               (0, h.jsxs)(r.fz, { children: [(0, h.jsx)(l, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, h.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
               (u.length > 0 || o.length > 0) && (0, h.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               u.length > 0 &&
                (0, h.jsx)(h.Fragment, {
                 children: (0, h.jsx)(r.dk, {
                  links: u
                   ...
                   .map((e) => {
                    ...
                    return { children: t.desciption, icon: (0, h.jsx)(s.r, { brand: t.brand }), href: e.value };
                   }),
                 }),
                }),
               o.length > 0 && (0, h.jsx)(h.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, h.jsxs)(h.Fragment, { children: [(0, h.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, h.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, h.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    k = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(r.DZ, { level: t, children: 'Help om deze component te verbeteren' }), (0, h.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, h.jsxs)(r.Xy, { children: [i ? (0, h.jsxs)(r.Er, { children: ['Vul de ', (0, h.jsx)(r.N_, { href: i, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, h.jsxs)(r.Er, { children: [(0, h.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, h.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, h.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, h.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    b = ({ component: e, headingLevel: t, description: n }) => {
     const i = e && y.bo[e.relayStep];
     return e && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(d.p, { level: t, suffix: i && (0, h.jsx)(u.D, { state: i }), children: e.title }), (0, h.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
   n.d(t, { AC: () => h, Fu: () => c, Wu: () => o, Zp: () => a });
   var r = n(46447),
    i = n(13526),
    s = n(86070);
   const c = ({ background: e, children: t, className: n, ...r }) => (0, s.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    o = (e) => (0, s.jsx)('div', { className: 'card__content', ...e }),
    a = ({ href: e, appearance: t, className: n, component: c = 'div', background: o, children: a }) => {
     const h = (e) => ('article' === c ? (0, s.jsx)('article', { ...e }) : 'section' === c ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      l = (0, s.jsx)(h, { className: (0, i.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, s.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    h = ({ appearance: e = 'medium', children: t, className: n }) => (0, s.jsx)('div', { className: (0, i.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
 },
]);
