 ...
 [56175],
 {
  ...
  70348(e, n, r) {
   ...
   const a = ({ className: e, ...n }) => {
    ...
    s = ({ className: e, classNamePanel: n, label: r, heading: a, headingLevel: s, headingApperance: c, ...d }) => {
     const p = (0, o.A)('utrecht-accordion__section', e),
      u = (0, o.A)('utrecht-accordion__panel', n);
     return (0, i.jsxs)('details', { className: p, ...d, children: [(0, i.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, i.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, i.jsx)('span', { className: 'nl-button__icon-start', children: (0, i.jsx)(l.A, {}) }), (0, i.jsxs)('span', { className: 'nl-button__label', children: [a && (0, i.jsx)(t.D, { level: s, appearance: c, children: a }), r] })] }) }), (0, i.jsx)('div', { className: u, children: d.children })] });
    };
  },
  80731(e, n, r) {
   r.d(n, { H: () => k });
