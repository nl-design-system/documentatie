 ...
 [84367],
 {
  5547: (e, l, n) => {
   ...
   var o = n(52676),
    r = n(40139);
   function t(e) {
    const l = { a: 'a', em: 'em', h2: 'h2', p: 'p', ...(0, r.a)(), ...e.components };
   ...
   function a(e = {}) {
    const { wrapper: l } = { ...(0, r.a)(), ...e.components };
  ...
  12085: (e, l, n) => {
   ...
   var o = n(52676),
    ...
    s = n(40761);
   function i(e) {
    const l = { h2: 'h2', input: 'input', label: 'label', ...(0, r.a)(), ...e.components };
   ...
   function d(e) {
    const l = { a: 'a', h1: 'h1', p: 'p', strong: 'strong', ...(0, r.a)(), ...e.components };
  ...
  43599: (e, l, n) => {
   ...
   const p = (e) => {
    let { children: l } = e;
    return (0, b.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(r.BB, { className: (0, t.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, b.jsx)(r.nv, { className: 'nlds-canvas__example-paragraph', children: l }) }) });
   };
   p.displayName = 'ParagraphContainer';
   const m = (e) => {
    let { children: l } = e;
    return (0, b.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(r.BB, { className: (0, t.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: l }) });
   };
   m.displayName = 'DocumentContainer';
   const v = (e) => {
    let { children: l } = e;
    return (0, b.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: l });
   };
   ...
   const g = (e) => {
    ...
    return (
     ...
     (0, b.jsxs)('div', {
      ...
      children: [
       _ && (0, b.jsx)('div', { className: (0, t.Z)('nlds-canvas__example'), children: (0, b.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, b.jsx)(S, { children: (0, b.jsx)(r.pu, { children: _ }) }) }) }),
       j &&
        (0, b.jsx)('div', {
  ...
  41179: (e, l, n) => {
   ...
   function c(e) {
    let { lineNumber: l, syntax: n, textContent: c, trim: d } = e,
     h = c;
    const { title: u, type: b } = (0, t.useContext)(a.n),
     p = (0, t.useId)();
    return (
     d && (h = h.trim()),
     (0, i.jsx)(r.y$, {
      ...
      language: n || '',
      children: (e) => {
       let { style: n, tokens: r, getLineProps: t, getTokenProps: a } = e;
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', b ? `\u201c${b}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, i.jsx)(o.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': p, style: n, children: r.map((e, n) => (0, i.jsxs)('span', { ...t({ line: e }), children: [l && (0, i.jsx)('span', { children: n + 1 }), e.map((e, l) => (0, i.jsx)('span', { ...a({ token: e }) }, l)), '\n'] }, n)) })] });
      },
     })
    );
   }
   ...
   const c = (0, s.createContext)({}),
    d = (e) => {
     ...
     const u = { do: 'Doen', dont: 'Niet doen' },
      b = h ? 'figure' : 'div',
      p = h ? 'figcaption' : 'div';
     return (0, i.jsxs)(b, { className: (0, a.Z)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof l ? l?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(p, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(t.nv, { className: (0, a.Z)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, i.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, i.jsx)('span', { className: 'nlds-guideline__title', children: u.dont })] }), (0, i.jsx)(t.nv, { children: l })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(t.nv, { className: (0, a.Z)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, i.jsx)(r.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, i.jsx)('span', { className: 'nlds-guideline__title', children: u.do })] }), (0, i.jsx)(t.nv, { children: l })] }), s] }), (0, i.jsx)('div', { className: 'nlds-guideline__example', children: (0, i.jsx)(c.Provider, { value: { title: l, type: u[n] }, children: d }) })] });
    };
  },
  40139: (e, l, n) => {
   n.d(l, { Z: () => s, a: () => a });
