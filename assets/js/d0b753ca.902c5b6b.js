 ...
 [71842],
 {
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    u = n(83386),
    l = n(86070);
   const h = { figma: (0, l.jsx)(o.A, {}), github: (0, l.jsx)(c.A, {}), npm: (0, l.jsx)(s.A, {}), storybook: (0, l.jsx)(a.A, {}) },
         ...
         children: n
          ...
          .map((e) => {
           const n = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            s = e.tasks.filter(({ name: e, value: t }) => c.has(e) && URL.canParse(t) && 'https:' === new URL(t).protocol);
           return (0, l.jsx)(
            j.Zp,
            {
             ...
             children: (0, l.jsxs)(j.Wu, {
              children: [
               ...
               o.length > 0 && (0, l.jsx)(l.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => g, GT: () => k, KF: () => h, Pc: () => s, Pv: () => m, Rc: () => f, bo: () => r, eQ: () => v, f4: () => c, fX: () => i, kD: () => b, mJ: () => y, o_: () => p, qZ: () => o });
