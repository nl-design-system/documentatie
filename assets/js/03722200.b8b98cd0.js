 ...
 [74075],
 {
  63025: (e, n, t) => {
   ...
   var r = t(52676),
    ...
    i = t(16167),
    s = t(4814);
   const o = { name: 'Astrid Brantjes', role: 'Projectmanager', slack: { mention: '@Astrid Brantjes', id: 'U06S00GPXC7' }, Description: () => (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(i.nv, { children: 'Voor veel mensen is Astrid geen onbekende, want vanuit haar vorige baan bij de gemeente Utrecht hield ze zich al bezig met verschillende landelijke innovaties. Hierdoor heeft ze kennis van het ontwikkelen van open source systemen.' }), (0, r.jsx)(i.nv, { children: 'In haar vrije tijd vind je Astrid in haar atelier, op de squashbaan en bij mooi weer op de racefiets.' })] }) },
    l = { name: 'Jeffrey Lauwers', role: 'Designer', slack: { mention: '@Jeffrey Lauwers', id: 'U0412KZ9TV1' }, Description: () => (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(i.nv, { children: 'Jeffrey vervult binnen het NL Design System de designrol. Eerder realiseerde hij design systems voor het Ministerie van VWS, Nederlandse Spoorwegen, Nationale Nederlanden en Randstad.' }), (0, r.jsx)(i.nv, { children: 'Naast een passie voor Design Systems en Ajax heeft Jeffrey een passie voor toegankelijkheid.' })] }) },
    d = { name: 'Robbert Broersma', role: 'Design System lead & Developer Relations', slack: { mention: '@Robbert', id: 'U019X17U5HQ' }, Description: () => (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(i.nv, { children: 'Robbert is design system lead van NL Design System. Met zijn ervaring bij andere design systems kent hij zowel de valkuilen van een team overstijgend design system als de waarde van het hergebruik van stabiele, toegankelijke componenten.' }), (0, r.jsx)(i.nv, { children: 'In de rol van developer relations werkt hij graag online samen met developers van verschillende organisaties om dit community gedragen design system neer te zetten. Zijn passie voor keukengerei is daarbij niet te missen! RVS met een haakje? Dan kun je het waarschijnlijk op zijn achtergrond vinden.' })] }) },
    c = { name: 'Rozerin Ayerdem', role: 'Designer', slack: { mention: '@Rozerin', id: 'D038ABXNAG3' }, Description: () => (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(i.nv, { children: 'Als ontwerper is Rozerin bezig met het verzamelen, toevoegen en documenteren van interactiepatronen, componenten en richtlijnen. Ze werkte vanuit haar eerdere rol bij de gemeente Den Haag al samen met het kernteam van NL Design System.' }), (0, r.jsx)(i.nv, { children: 'Naast haar werk is Rozerin gepassioneerd door reizen, natuur, fotografie en architectuur.' })] }) },
  ...
  35038: (e, n, t) => {
   ...
   const s = (e) => {
     ...
     return (0, i.jsx)('div', { className: (0, a.Z)('card__illustration', n && 'card__illustration--background', r), ...s, children: t });
    },
    ...
    l = (e) => {
     ...
     const d = (e) => ('article' === o ? (0, i.jsx)('article', { ...e }) : 'section' === o ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      c = (0, i.jsx)(d, { className: (0, a.Z)('cardgroup__card', `cardgroup__card--${t}`, s), children: l });
     return n ? (0, i.jsx)(r.rU, { href: n, boxContent: !0, className: 'cardgroup__link', children: c }) : c;
    },
    d = (e) => {
     let { appearance: n = 'medium', children: t, className: r } = e;
     return (0, i.jsx)('div', { className: (0, a.Z)('cardgroup', `cardgroup--${n}`, r), children: t });
    };
  },
  40139: (e, n, t) => {
   t.d(n, { Z: () => o, a: () => s });
