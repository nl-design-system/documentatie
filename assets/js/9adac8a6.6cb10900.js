 ...
 [79871],
 {
  ...
  98480: (e, n, l) => {
   ...
   const _ = (e) => {
    ...
    let P = d.Fragment;
    return (
     'paragraph' === y ? (P = m) : 'document' === y ? (P = g) : 'surface' === y && (P = v),
     (0, h.jsxs)('div', {
      className: (0, a.Z)(p['nlds-canvas']),
      children: [
       w && (0, h.jsx)('div', { className: (0, a.Z)(p['nlds-canvas__example']), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(P, { children: (0, h.jsx)(t.pu, { children: w }) }) }) }),
       k &&
        (0, h.jsx)('div', {
       ...
       k &&
        (0, h.jsxs)('div', {
         ...
         hidden: !L,
         children: [
          (0, h.jsx)(b.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: z, trim: !0 }),
          l &&
           (0, h.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: l, textContent: c, trim: d } = e,
     u = c;
    const { title: p, type: b } = (0, s.useContext)(i.n),
     h = (0, s.useId)();
    return (
     d && (u = u.trim()),
     (0, r.jsx)(a.y$, {
      ...
      children: (e) => {
       ...
       return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', b ? `\u201c${b}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, r.jsx)(t.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': h, style: l, children: a.map((e, l) => (0, r.jsxs)('span', { ...s({ line: e }), children: [n && (0, r.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, r.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const d = (0, o.createContext)({}),
    u = (e) => {
     let { title: n, appearance: l, description: o, children: u, figure: p } = e;
     const b = { do: 'Doen', dont: 'Niet doen' },
      h = p ? 'figure' : 'div',
      m = p ? 'figcaption' : 'div';
     return (0, c.jsxs)(h, { className: (0, i.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(m, { className: (0, i.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, i.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: b.dont })] }), (0, c.jsx)(s.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, i.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(a.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: b.do })] }), (0, c.jsx)(s.nv, { children: n })] }), o] }), (0, c.jsx)('div', { className: (0, i.Z)(r['nlds-guideline__example']), children: (0, c.jsx)(d.Provider, { value: { title: n, type: b[l] }, children: u }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => o, a: () => i });
