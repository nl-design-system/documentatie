 ...
 [49189],
 {
  1292(e, n, t) {
   ...
   var r = t(29181),
    ...
    a = t(83386),
    d = t(86070);
   const l = { figma: (0, d.jsx)(o.A, {}), github: (0, d.jsx)(s.A, {}), npm: (0, d.jsx)(i.A, {}), storybook: (0, d.jsx)(c.A, {}) },
    h = ({ brand: e }) => (0, d.jsx)(r.In, { children: l[e] || (0, d.jsx)(a.A, {}) });
  },
  12013(e, n, t) {
   'use strict';
   t.d(n, { o: () => l });
   ...
   const i = (e, n) => {
    ...
    l = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: o = '', components: i = {} }) => (0, s.jsx)(r.x, { components: { ...d(n, t), ...a(o), ...i }, children: e });
  },
  17045(e, n, t) {
   'use strict';
   t.d(n, { Ay: () => c, RM: () => s });
  ...
  17889(e, n, t) {
    ...
    return 'clipboard' in navigator
     ? (0, j.jsxs)(i.$n, {
        ...
        onClick: async function () {
         try {
          const e = await l.Ay.format(n, { parser: t, plugins: [c.A, a.Ay, d.Ay] });
   ...
   var m = t(35193),
    ...
    f = t(79532),
    w = t(30758);
   const A = { color: m.A, dimension: g.A, fontFamilies: y.A, fontSizes: k.A, fontWeights: v.A, lineHeights: x.A, other: b.A, textDecoration: f.A },
    z = ({ type: e }) => (0, j.jsx)(u.In, { children: (0, w.createElement)(A[e]) });
   function _({ tokens: e }) {
    const n = (0, s.kD)(e),
     t = (0, s.GT)(n),
       ...
       children: [
        ...
        (0, j.jsx)(i.BF, {
         children: t.map((n) => {
          const t = (0, s.o_)(n),
           c = (0, s.eQ)(e, n).$type;
          return (0, j.jsxs)(i.Hj, { children: [(0, j.jsx)(i.nA, { children: (0, j.jsx)(r.C, { children: (0, j.jsx)(i.kf, { children: t }) }) }), (0, j.jsx)(i.nA, { children: (0, j.jsxs)(o.K, { children: [(0, j.jsx)(z, { type: c }), ' ', c] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => o, KF: () => u, mJ: () => m, VZ: () => A, cR: () => w, Pv: () => g, qZ: () => i, kD: () => x, B2: () => j, Pc: () => a, f4: () => c, GT: () => b, fX: () => s, eQ: () => v, B_: () => k, o_: () => y, Rc: () => f });
   ...
   const h = (e) => [...e].sort((e, n) => d.indexOf(e) - d.indexOf(n)),
    ...
    m = (e) => h(l(e.projects.flatMap((e) => p(e)))),
    g = (e) => {
     const n = p(e),
      t = ((e) => {
  ...
  81330(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => C, component: () => R, contentTitle: () => D, default: () => V, description: () => L, frontMatter: () => S, issueNumber: () => M, metadata: () => r, title: () => T, toc: () => F }));
    ...
    return (
     ...
     (0, o.jsxs)(o.Fragment, {
      children: [
       ...
       '\n',
       (0, o.jsx)(y.Zp, { className: 'implementation-card', children: (0, o.jsxs)(y.Wu, { children: [(0, o.jsx)(v.D, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, o.jsxs)(k.dk, { children: [(0, o.jsxs)(k.Pt, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=13778-1279', children: [(0, o.jsx)(x.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, o.jsxs)(k.Pt, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=13778-1279', children: [(0, o.jsx)(x.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, o.jsx)(v.D, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, o.jsxs)(k.dk, { children: [(0, o.jsxs)(k.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-code--documentatie', children: [(0, o.jsx)(x.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, o.jsxs)(k.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/code--documentatie', children: [(0, o.jsx)(x.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, o.jsx)(v.D, { level: 2, appearance: 'level-4', children: 'npm' }), (0, o.jsxs)(k.dk, { children: [(0, o.jsxs)(k.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-css', children: [(0, o.jsx)(x.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-css'] }), (0, o.jsxs)(k.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-react', children: [(0, o.jsx)(x.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-react'] }), (0, o.jsxs)(k.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-tokens', children: [(0, o.jsx)(x.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-tokens'] })] })] }) }),
       '\n',
       ...
       (0, o.jsx)(t, {
        ...
        items: [
         ...
         { title: 'Wanneer de achtergrondkleur van de Code component anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina.', sc: '1.4.11', status: '', component: (0, o.jsx)(u.Ay, {}), tags: ['designer', 'contentmaker'] },
        ],
       }),
       '\n',
       ...
       (0, o.jsx)(t, {
        headingLevel: '4',
        items: [
         { title: 'Het juiste HTML-element voor de Code component is toegepast.', sc: '1.3.1', status: '', component: (0, o.jsx)(h, {}), tags: ['developer'] },
       ...
       '\n',
       (0, o.jsx)(A.o, { omitH1: !0, headingLevel: 2, children: (0, o.jsx)(_, {}) }),
       '\n',
   ...
   function V(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
    return n ? (0, o.jsx)(n, { ...e, children: (0, o.jsx)(O, { ...e }) }) : O(e);
   }
  },
  82839(e, n, t) {
  ...
  85825(e, n, t) {
   ...
   const m = ({ children: e }) => (0, d.jsx)('ul', { className: 'task-list', children: e }),
    g = ({ checked: e, children: n, title: t, description: r, headingLevel: s = 3 }) => (0, d.jsxs)('li', { className: (0, o.A)('task-list-item'), children: [(0, d.jsxs)('div', { className: (0, o.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, d.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, d.jsx)(p.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [t ? (0, d.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: s, children: t }) : null, r, n] })] });
   var y = t(33062);
   const k = ({ component: e, headingLevel: n }) => {
     const t = e && e.projects.filter((e) => y.f4.includes(e.id)),
      s = t && y.f4.map((e) => t.find((n) => n.id === e)).filter(Boolean);
     return e && (0, d.jsx)(r.If, { sections: s.map((t) => ({ className: (0, o.A)('definition-of-done', t && `definition-of-done--${(0, y.fX)(t.title)}`), headingLevel: n, expanded: !1, label: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', body: t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m, { children: t.tasks.map(({ checked: e, name: t, id: r }) => (0, d.jsx)(g, { headingLevel: n + 1, checked: e, title: t, description: (0, y.qZ)(r) }, r)) }), (0, d.jsx)(r.fz, { children: (0, d.jsxs)(r.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            i.Zp,
            {
             ...
             children: (0, d.jsxs)(i.Wu, {
              children: [
               ...
               (h.length > 0 || c.length > 0) && (0, d.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               c.length > 0 && (0, d.jsx)(d.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, d.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    x = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(r.DZ, { level: n, children: 'Help om deze component te verbeteren' }), (0, d.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, d.jsxs)(r.Xy, { children: [o ? (0, d.jsxs)(r.Er, { children: ['Vul de ', (0, d.jsx)(r.N_, { href: o, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, d.jsxs)(r.Er, { children: [(0, d.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, d.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, d.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, d.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    b = ({ component: e, headingLevel: n, description: t }) => {
     const o = e && y.bo[e.relayStep];
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u.p, { level: n, suffix: o && (0, d.jsx)(h.D, { state: o }), children: e.title }), (0, d.jsx)(r.fz, { lead: !0, children: t })] });
    };
  },
  90495(e, n, t) {
   'use strict';
   t.d(n, { AC: () => d, Fu: () => i, Wu: () => c, Zp: () => a });
   var r = t(46447),
    o = t(13526),
    s = t(86070);
   const i = ({ background: e, children: n, className: t, ...r }) => (0, s.jsx)('div', { className: (0, o.A)('card__illustration', e && `card__illustration--${e}`, t), ...r, children: n }),
    ...
    a = ({ href: e, appearance: n, className: t, component: i = 'div', background: c, children: a }) => {
     const d = (e) => ('article' === i ? (0, s.jsx)('article', { ...e }) : 'section' === i ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      l = (0, s.jsx)(d, { className: (0, o.A)('cardgroup__card', c && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: a });
