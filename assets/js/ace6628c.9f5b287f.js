(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [16229],
 {
   ...
   const s = ({ background: e, children: t, className: n, ...r }) => (0, i.jsx)('div', { className: (0, c.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: s = 'div', background: o, children: a }) => {
     const l = (e) => ('article' === s ? (0, i.jsx)('article', { ...e }) : 'section' === s ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      u = (0, i.jsx)(l, { className: (0, c.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
  ...
  40062: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => y, contentTitle: () => l, default: () => p, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => h, toc: () => m });
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    l = n(83386),
    u = n(86070);
   const h = { figma: (0, u.jsx)(i.A, {}), github: (0, u.jsx)(s.A, {}), npm: (0, u.jsx)(o.A, {}), storybook: (0, u.jsx)(a.A, {}) },
   ...
   var g = n(36444),
    ...
    k = n(68873),
    b = n(51797);
   const v = ({ children: e }) => (0, u.jsx)('ul', { className: 'task-list', children: e }),
    f = ({ checked: e, children: t, title: n, description: r, headingLevel: i = 3 }) => (0, u.jsxs)('li', { className: (0, c.A)('task-list-item'), children: [(0, u.jsxs)('div', { className: (0, c.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, u.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, u.jsx)(b.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(k.DZ, { appearance: 'utrecht-heading-3', level: i, children: n }), r, t] })] });
   var x = n(75916);
   const _ = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: i.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(v, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(f, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            j.Zp,
            {
             ...
             children: (0, u.jsxs)(j.Wu, {
              children: [
               ...
               (o.length > 0 || i.length > 0) && (0, u.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               o.length > 0 &&
                (0, u.jsx)(u.Fragment, {
               ...
               i.length > 0 && (0, u.jsx)(u.Fragment, { children: i.map(({ frameworkName: e, tasks: n }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, u.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, u.jsx)(d, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    N = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p.p, { level: t, suffix: c && (0, u.jsx)(g.D, { state: c }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  74111: (e, t, n) => {
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => p, GT: () => v, KF: () => h, Pc: () => o, Pv: () => m, Rc: () => f, bo: () => r, eQ: () => k, f4: () => s, fX: () => c, kD: () => b, mJ: () => y, o_: () => g, qZ: () => i });
   ...
   const u = (e) => [...e].sort((e, t) => a.indexOf(e) - a.indexOf(t)),
    ...
    y = (e) => u(l(e.projects.flatMap((e) => j(e)))),
    m = (e) => {
     const t = j(e),
      n = ((e) => {
