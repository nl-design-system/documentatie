/*! For license information please see reactPlayerVimeo.9af19121.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [73743],
 {
  20667: (e, t, n) => {
   ...
   function a() {
    ...
    function l(e, t, n, i) {
     var o = t && t.prototype instanceof d ? t : d,
      ...
      u = new _(i || []);
     return r(a, '_invoke', { value: E(e, n, u) }), a;
    }
    function h(e, t, n) {
     try {
    ...
    return (
     ...
     (_.prototype = {
      constructor: _,
      reset: function (e) {
       if (((this.prev = 0), (this.next = 0), (this.sent = this._sent = void 0), (this.done = !1), (this.delegate = null), (this.method = 'next'), (this.arg = void 0), this.tryEntries.forEach(P), !e)) for (var t in this) 't' === t.charAt(0) && n.call(this, t) && !isNaN(+t.slice(1)) && (this[t] = void 0);
      },
      stop: function () {
       this.done = !0;
      ...
      finish: function (e) {
       for (var t = this.tryEntries.length - 1; t >= 0; --t) {
        ...
        if (n.finallyLoc === e) return this.complete(n.completion, n.afterLoc), P(n), f;
       }
      },
      catch: function (e) {
       for (var t = this.tryEntries.length - 1; t >= 0; --t) {
      ...
      delegateYield: function (e, t, n) {
       return (this.delegate = { iterator: j(e), resultName: t, nextLoc: n }), 'next' === this.method && (this.arg = void 0), f;
      },
     }),
     e
    );
   ...
   function f(e, t, n) {
    return (t = b(t)) in e ? Object.defineProperty(e, t, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : (e[t] = n), e;
   }
   function d(e) {
    return (
   ...
   var k = void 0 !== n.g && '[object global]' === {}.toString.call(n.g);
   function E(e, t) {
   ...
   function P() {
    ...
    if (x(i)) return i.replace('http:', 'https:');
   ...
   if (!(k || (j && O))) throw new Error('Sorry, the Vimeo Player API is not available in this browser.');
   var C = 'undefined' != typeof globalThis ? globalThis : 'undefined' != typeof window ? window : void 0 !== n.g ? n.g : 'undefined' != typeof self ? self : {};
   !(function (e) {
    if (!e.WeakMap) {
     ...
     e.WeakMap = (function () {
      function e() {
       ...
       if ((r(this, '_id', '_WeakMap' + '_' + o() + '.' + o()), arguments.length > 0)) throw new TypeError('WeakMap iterable is not supported');
      }
      function n(e, n) {
   ...
   })('undefined' != typeof globalThis ? globalThis : 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : C);
   var M,
    N,
    A =
     ((M = function (e) {
        ...
        if (!n.triggered) {
         ...
         try {
          (t = a(e))
           ...
           : ((n.msg = e), (n.state = 1), n.chain.length > 0 && o(u, n));
         } catch (y) {
          l.call(new f(n), y);
         }
        }
     ...
     M((N = { exports: {} }), N.exports),
     N.exports),
    S = new WeakMap();
   function L(e, t, n) {
    var r = S.get(e.element) || {};
    t in r || (r[t] = []), r[t].push(n), S.set(e.element, r);
   }
   function R(e, t) {
    return (S.get(e.element) || {})[t] || [];
   }
   function F(e, t, n) {
    var r = S.get(e.element) || {};
    if (!r[t]) return !0;
    if (!n) return (r[t] = []), S.set(e.element, r), !0;
    var i = r[t].indexOf(n);
    return -1 !== i && r[t].splice(i, 1), S.set(e.element, r), r[t] && 0 === r[t].length;
   }
   function q(e) {
    if ('string' == typeof e)
     try {
   ...
   function V(e, t) {
    ...
    if ((t = q(t)).event) {
     if ('error' === t.event)
      R(e, t.data.method).forEach(function (n) {
       var r = new Error(t.data.message);
       (r.name = t.data.name), n.reject(r), F(e, t.data.method, n);
      });
     (r = R(e, 'event:'.concat(t.event))), (n = t.data);
    } else if (t.method) {
     var i = (function (e, t) {
      var n = R(e, t);
   ...
   function z(e) {
    ...
    return new Promise(function (r, i) {
     if (!x(e)) throw new TypeError('\u201c'.concat(e, '\u201d is not a vimeo.com url.'));
     var o = (function (e) {
      ...
      a = 'https://'.concat(o, '/api/oembed.json?url=').concat(encodeURIComponent(e));
       ...
       if (404 !== s.status)
        if (403 !== s.status)
         try {
          ...
          if (403 === t.domain_status_code) return D(t, n), void i(new Error('\u201c'.concat(e, '\u201d is not embeddable.')));
          r(t);
         } catch (o) {
          i(o);
         }
   ...
   var B = { role: 'viewer', autoPlayMuted: !0, allowedDrift: 0.3, maxAllowedDrift: 1, minCheckInterval: 0.1, maxRateAdjustment: 0.2, maxTimeToCatchUp: 1 },
    U = (function (e) {
     !(function (e, t) {
     ...
     function u(e, t) {
      ...
      return (
       c(this, u),
       f(g((n = i.call(this))), 'logger', void 0),
       f(g(n), 'speedAdjustment', 0),
       f(
        g(n),
        'adjustSpeed',
        (function () {
           ...
           return a().wrap(function (e) {
            for (;;)
             switch ((e.prev = e.next)) {
              ...
              case 4:
               return (e.t0 = e.sent), (e.t1 = n.speedAdjustment), (e.t2 = e.t0 - e.t1), (e.t3 = r), (i = e.t2 + e.t3), n.log('New playbackRate:  '.concat(i)), (e.next = 12), t.setPlaybackRate(i);
              case 12:
               n.speedAdjustment = r;
              case 13:
              case 'end':
            ...
            function (e) {
             for (;;)
              switch ((e.prev = e.next)) {
               ...
               case 5:
                (i = _(t, 'change', function () {
                 return s.updatePlayer(t, n, r);
                })),
                 (o = this.maintainPlaybackPosition(t, n, r)),
           ...
           return a().wrap(
            function (e) {
             for (;;)
              switch ((e.prev = e.next)) {
               case 0:
                if (((i = t.query()), (o = i.position), (u = i.velocity), 'number' == typeof o && n.setCurrentTime(o), 'number' != typeof u)) {
                 e.next = 25;
                 break;
                }
                if (0 !== u) {
               ...
               case 21:
                if (((e.t2 = e.sent), (e.t3 = u), e.t2 === e.t3)) {
                 e.next = 25;
                 break;
                }
                n.setPlaybackRate(u);
       ...
       },
       {
        ...
        value: function (e, t, n) {
         var r = this,
          i = n.allowedDrift,
          o = n.maxAllowedDrift,
          u = n.minCheckInterval,
          c = n.maxRateAdjustment,
          l = n.maxTimeToCatchUp,
          h = 1e3 * Math.min(l, Math.max(u, o)),
          f = (function () {
           var n = s(
            a().mark(function n() {
             var u, s, h, f, d;
             return a().wrap(function (n) {
              for (;;)
               switch ((n.prev = n.next)) {
                ...
                case 11:
                 if (((n.t3 = n.sent), (u = n.t2 - n.t3), (s = Math.abs(u)), r.log('Drift: '.concat(u)), !(s > o))) {
                  n.next = 22;
                  break;
                 }
                ...
                case 22:
                 ...
                 return (d = (h = s / l) < (f = c) ? (f - h) / 2 : f), (n.next = 28), r.adjustSpeed(t, d * Math.sign(u));
                case 28:
       ...
       },
       {
        ...
        value: function (e, t) {
         return new Promise(function (n) {
          !(function r() {
           e.readyState === t ? n() : e.addEventListener('readystatechange', r, { once: !0 });
          })();
         });
        },
       },
    ...
    Q = (function () {
     function e(t) {
      ...
      if ('IFRAME' === t.nodeName && !x(t.getAttribute('src') || '')) throw new Error('The player element passed isn\u2019t a Vimeo embed.');
      if ($.has(t)) return $.get(t);
      (this._window = t.ownerDocument.defaultView), (this.element = t), (this.origin = '*');
      var o = new A(function (e, i) {
       if (
        ((n._onMessage = function (t) {
         if (x(t.origin) && n.element.contentWindow === t.source) {
        ...
        z(P(o), o, t)
         .then(function (e) {
          var r,
           ...
           o,
           a = D(e, t);
          return (n.element = a), (n._originalElement = t), (r = t), (i = a), (o = S.get(r)), S.set(i, o), S.delete(r), $.set(n.element, n), e;
         })
         .catch(i);
       }
      });
      if ((G.set(this, o), $.set(this.element, this), 'IFRAME' === this.element.nodeName && I(this, 'ping'), Y.isEnabled)) {
       var a = function () {
        return Y.exit();
       };
       (this.fullscreenchangeHandler = function () {
        Y.isFullscreen ? L(n, 'event:exitFullscreen', a) : F(n, 'event:exitFullscreen', a),
         n.ready().then(function () {
          I(n, 'fullscreenchange', Y.isFullscreen);
         });
       }),
      ...
      h(e, [
        ...
        value: function (e) {
         ...
         return new A(function (n, i) {
          return t
           .ready()
           .then(function () {
            L(t, e, { resolve: n, reject: i }), I(t, e, r);
           })
           .catch(i);
         });
        },
         ...
         return new A(function (n, r) {
          return (
           ...
           t
            .ready()
            .then(function () {
             L(t, e, { resolve: n, reject: r }), I(t, e);
            })
            .catch(r)
          );
         });
       ...
       },
       {
        ...
        value: function (e, t) {
         ...
         return new A(function (r, i) {
          if (((e = E(e, 'set')), null == t)) throw new TypeError('There must be a value to set.');
          return n
           .ready()
           .then(function () {
            L(n, e, { resolve: r, reject: i }), I(n, e, t);
           })
           .catch(i);
         });
        },
       },
       {
        ...
        value: function (e, t) {
         ...
         0 === R(this, 'event:'.concat(e)).length && this.callMethod('addEventListener', e).catch(function () {}), L(this, 'event:'.concat(e), t);
        },
       },
       {
        key: 'off',
       ...
       },
       {
        key: 'getFullscreen',
        value: function () {
         return Y.isEnabled ? A.resolve(Y.isFullscreen) : this.get('fullscreen');
        },
       },
       {
       ...
       },
       {
        ...
        value: function () {
         ...
         return new A(function (t) {
          if ((G.delete(e), $.delete(e.element), e._originalElement && ($.delete(e._originalElement), e._originalElement.removeAttribute('data-vimeo-initialized')), e.element && 'IFRAME' === e.element.nodeName && e.element.parentNode && (e.element.parentNode.parentNode && e._originalElement && e._originalElement !== e.element.parentNode ? e.element.parentNode.parentNode.removeChild(e.element.parentNode) : e.element.parentNode.removeChild(e.element)), e.element && 'DIV' === e.element.nodeName && e.element.parentNode)) {
             ...
             for (;;)
              switch ((e.prev = e.next)) {
               ...
               case 4:
                return (
                 (r = new U(this, t, n)),
                 I(this, 'notifyTimingObjectConnect'),
                 r.addEventListener('disconnect', function () {
                  return I(i, 'notifyTimingObjectDisconnect');
                 }),
                 e.abrupt('return', r)
                );
               case 8:
    ...
    (function () {
     ...
     window.VimeoPlayerResizeEmbeds_ ||
      ...
      window.addEventListener('message', function (t) {
       if (x(t.origin) && t.data && 'spacechange' === t.data.event)
       ...
       if (x(t.origin)) {
        ...
        if (n && 'ready' === n.event)
         for (var r = e.querySelectorAll('iframe'), i = 0; i < r.length; i++) {
          var o = r[i],
           a = o.contentWindow === t.source;
          T(o.src) && a && new Q(o).callMethod('appendVideoMetadata', window.location.href);
         }
       }
      }));
    })(),
   ...
   const J = Q,
    ...
    Z = /vimeo\.com\/(?:video\/)?(\d+)(?:\/([\w-]+))?/;
   function K(e, t = {}) {
    const n = { src: ee(e, t), frameborder: 0, width: '100%', height: '100%', allow: 'accelerometer; fullscreen; autoplay; encrypted-media; gyroscope; picture-in-picture' };
    return (
     t.config && (n['data-config'] = JSON.stringify(t.config)),
   ...
   function ee(e, t) {
    if (!e.src) return;
    const n = e.src.match(Z),
     r = n && n[1],
     i = n && n[2],
     o = { controls: '' === e.controls ? null : 0, autoplay: e.autoplay, loop: e.loop, muted: e.muted, playsinline: e.playsinline, preload: e.preload ?? 'metadata', transparent: !1, autopause: e.autopause, h: i, ...t.config };
     ...
     return String(
      new URLSearchParams(
       (function (e) {
        ...
        for (let n in e) {
         let r = e[n];
         !0 === r || '' === r ? (t[n] = 1) : !1 === r ? (t[n] = 0) : null != r && (t[n] = r);
        }
        return t;
       })(e),
      ),
   ...
   class te extends (globalThis.HTMLElement ?? class {}) {
    ...
    requestFullscreen() {
     var e, t;
     return null == (t = null == (e = this.api) ? void 0 : e.requestFullscreen) ? void 0 : t.call(e);
    }
    exitFullscreen() {
     var e, t;
     return null == (t = null == (e = this.api) ? void 0 : e.exitFullscreen) ? void 0 : t.call(e);
    }
    requestPictureInPicture() {
     var e, t;
     return null == (t = null == (e = this.api) ? void 0 : e.requestPictureInPicture) ? void 0 : t.call(e);
    }
    exitPictureInPicture() {
     var e, t;
     return null == (t = null == (e = this.api) ? void 0 : e.exitPictureInPicture) ? void 0 : t.call(e);
    }
    get config() {
     return this.#p;
    }
    ...
    async load() {
     ...
     if (this.#e) return;
     const t = !this.#t;
     this.#t && (this.loadComplete = new re()), (this.#t = !0), await (this.#e = Promise.resolve()), (this.#e = null), (this.#r = 0), (this.#i = NaN), (this.#o = !1), (this.#a = !this.autoplay), (this.#u = 1), (this.#s = 0), (this.#c = 0), (this.#l = !1), (this.#h = 1), (this.#c = 0), (this.#f = NaN), (this.#d = NaN), this.dispatchEvent(new Event('emptied'));
     let n = this.api;
     if (((this.api = null), !this.src)) return;
     this.dispatchEvent(new Event('loadstart'));
     const r = { autoplay: this.autoplay, controls: this.controls, loop: this.loop, muted: this.defaultMuted, playsinline: this.playsInline, preload: this.preload ?? 'metadata', transparent: !1, autopause: this.hasAttribute('autopause'), ...this.#p },
      i = async () => {
     ...
     if (this.#n) return (this.api = n), await this.api.loadVideo({ ...r, url: this.src }), await i(), void (await this.loadComplete);
     this.#n = !0;
     let o = null == (e = this.shadowRoot) ? void 0 : e.querySelector('iframe');
     t && o && (this.#p = JSON.parse(o.getAttribute('data-config') || '{}')),
      this.shadowRoot ||
       (this.attachShadow({ mode: 'open' }),
       (this.shadowRoot.innerHTML = K(
        (function (e) {
         let t = {};
       ...
       (o = this.shadowRoot.querySelector('iframe'))),
      (this.api = new J(o));
     const a = () => {
      this.api.off('loaded', a), i();
     };
     this.api.on('loaded', a),
      this.api.on('bufferstart', () => {
       this.#a && ((this.#a = !1), this.dispatchEvent(new Event('play'))), this.dispatchEvent(new Event('waiting'));
      }),
      this.api.on('play', () => {
       this.#a && ((this.#a = !1), this.dispatchEvent(new Event('play')));
      }),
      this.api.on('playing', () => {
       (this.#c = 3), (this.#a = !1), this.dispatchEvent(new Event('playing'));
      }),
      this.api.on('seeking', () => {
       (this.#l = !0), this.dispatchEvent(new Event('seeking'));
      }),
      this.api.on('seeked', () => {
       (this.#l = !1), this.dispatchEvent(new Event('seeked'));
      }),
      this.api.on('pause', () => {
       (this.#a = !0), this.dispatchEvent(new Event('pause'));
      }),
      this.api.on('ended', () => {
       (this.#a = !0), this.dispatchEvent(new Event('ended'));
      }),
      this.api.on('ratechange', ({ playbackRate: e }) => {
       (this.#u = e), this.dispatchEvent(new Event('ratechange'));
      }),
      this.api.on('volumechange', async ({ volume: e }) => {
       (this.#h = e), this.api && (this.#o = await this.api.getMuted()), this.dispatchEvent(new Event('volumechange'));
      }),
      this.api.on('durationchange', ({ duration: e }) => {
       (this.#i = e), this.dispatchEvent(new Event('durationchange'));
      }),
      this.api.on('timeupdate', ({ seconds: e }) => {
       (this.#r = e), this.dispatchEvent(new Event('timeupdate'));
      }),
      this.api.on('progress', ({ seconds: e }) => {
       (this.#s = e), this.dispatchEvent(new Event('progress'));
      }),
      this.api.on('resize', ({ videoWidth: e, videoHeight: t }) => {
       (this.#f = e), (this.#d = t), this.dispatchEvent(new Event('resize'));
      }),
    ...
    async attributeChangedCallback(e, t, n) {
     if (t !== n) {
      ...
      if ((await this.loadComplete, 'loop' === e)) this.api.setLoop(this.loop);
     }
    }
    async play() {
     var e;
     (this.#a = !1), this.dispatchEvent(new Event('play')), await this.loadComplete;
     try {
      await (null == (e = this.api) ? void 0 : e.play());
     } catch (t) {
      throw ((this.#a = !0), this.dispatchEvent(new Event('pause')), t);
     }
    }
    async pause() {
     var e;
     return await this.loadComplete, null == (e = this.api) ? void 0 : e.pause();
    }
    get ended() {
    ...
    get buffered() {
     return this.#s > 0 ? ie(0, this.#s) : ie();
    }
    get controls() {
    ...
    set currentTime(e) {
     this.currentTime != e &&
      ...
      this.loadComplete.then(() => {
       var t;
       null == (t = this.api) || t.setCurrentTime(e).catch(() => {});
      }));
    }
    get defaultMuted() {
    ...
    set muted(e) {
     this.muted != e &&
      ...
      this.loadComplete.then(() => {
       var t;
       null == (t = this.api) || t.setMuted(e).catch(() => {});
      }));
    }
    get playbackRate() {
     return this.#u;
    ...
    set playbackRate(e) {
     this.playbackRate != e &&
      ...
      this.loadComplete.then(() => {
       var t;
       null == (t = this.api) || t.setPlaybackRate(e).catch(() => {});
      }));
    }
    get playsInline() {
    ...
    set volume(e) {
     this.volume != e &&
      ...
      this.loadComplete.then(() => {
       var t;
       null == (t = this.api) || t.setVolume(e).catch(() => {});
      }));
    }
    #v(e) {
   ...
   function ie(e, t) {
    return Array.isArray(e) ? oe(e) : oe(null == e || null == t || (0 === e && 0 === t) ? [[0, 0]] : [[e, t]]);
   }
   function oe(e) {
    return Object.defineProperties(e, { start: { value: (t) => e[t][0] }, end: { value: (t) => e[t][1] } }), e;
   }
   globalThis.customElements && !globalThis.customElements.get('vimeo-video') && globalThis.customElements.define('vimeo-video', te);
   var ae = te,
    ue = new Set(['style', 'children', 'ref', 'key', 'suppressContentEditableWarning', 'suppressHydrationWarning', 'dangerouslySetInnerHTML']),
    se = { className: 'class', htmlFor: 'for' };
   function ce(e) {
   ...
   function he(e, t, n) {
    var r;
    (e[t] = n), null == n && t in ((null == (r = globalThis.HTMLElement) ? void 0 : r.prototype) ?? {}) && e.removeAttribute(t);
   }
   var fe = (function ({ react: e, tagName: t, elementClass: n, events: r, displayName: i, defaultProps: o, toAttributeName: a = ce, toAttributeValue: u = le }) {
    const s = Number.parseInt(e.version) >= 19,
     c = e.forwardRef((i, c) => {
      var l, h;
      ...
      for (const [e, t] of Object.entries(i)) {
       ...
       const r = a(se[e] ?? e);
       if (n.prototype && e in n.prototype && !(e in ((null == (l = globalThis.HTMLElement) ? void 0 : l.prototype) ?? {})) && !(null == (h = n.observedAttributes) ? void 0 : h.some((e) => e === r))) {
        m[e] = t;
        continue;
       }
       if (e.startsWith('on')) {
       ...
       const i = u(t);
       if ((r && null != i && ((v[r] = String(i)), s || (y[r] = i)), r && s)) {
        const e = le(t);
        y[r] = i !== e ? i : t;
       }
      }
      if ('undefined' != typeof window) {
       for (const t in p) {
        const n = p[t],
         ...
         o = ((null == r ? void 0 : r[t]) ?? t.slice(2).toLowerCase()).slice(0, i ? -7 : void 0);
        e.useLayoutEffect(() => {
         ...
         if (e && 'function' == typeof n)
          return (
           ...
           () => {
            e.removeEventListener(o, n, i);
           }
          );
        }, [null == f ? void 0 : f.current, n]);
       }
       e.useLayoutEffect(() => {
        if (null === f.current) return;
        const e = new Map();
        for (const t in m) he(f.current, t, m[t]), d.current.delete(t), e.set(t, m[t]);
        for (const [t, n] of d.current) he(f.current, t, void 0);
        d.current = e;
       });
      }
      if ('undefined' == typeof window && (null == n ? void 0 : n.getTemplateHTML) && (null == n ? void 0 : n.shadowRootOptions)) {
       const { mode: t, delegatesFocus: r } = n.shadowRootOptions,
        o = e.createElement('template', { shadowrootmode: t, shadowrootdelegatesfocus: r, dangerouslySetInnerHTML: { __html: n.getTemplateHTML(v, i) } });
       y.children = [o, y.children];
      }
      return e.createElement(t, {
       ...
       ref: e.useCallback(
        (e) => {
         (f.current = e), 'function' == typeof c ? c(e) : null !== c && (c.current = e);
        },
        [c],
       ),
      });
     });
    return (c.displayName = i ?? n.name), c;
   })({ react: r, tagName: 'vimeo-video', elementClass: ae, toAttributeName: (e) => ('muted' === e ? '' : 'defaultMuted' === e ? 'muted' : ce(e)) });
  },
 },
]);
