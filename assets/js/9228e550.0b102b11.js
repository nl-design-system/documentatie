/*! For license information please see 9228e550.0b102b11.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [73649],
 {
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => r, KF: () => c, mJ: () => p, VZ: () => N, cR: () => w, Pv: () => f, qZ: () => s, kD: () => j, QQ: () => D, B2: () => m, Pc: () => o, f4: () => l, GT: () => k, fX: () => i, eQ: () => b, B_: () => v, o_: () => x });
  ...
  86641(e, n, a) {
   (a.r(n), a.d(n, { assets: () => g, component: () => h, contentTitle: () => d, default: () => x, description: () => c, frontMatter: () => o, issueNumber: () => m, metadata: () => t, title: () => u, toc: () => p }));
   ...
   const o = { title: 'Password Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Password Input', pagination_label: 'Password Input', description: 'Afgeschermd invoerveld om een geheime tekst in te vullen, zoals een wachtwoord.', issue_number: 133, slug: '/password-input', keywords: ['code', 'confidential input', 'form', 'form control', 'form field', 'hidden', 'hidden input', 'input field', 'mask', 'masker', 'masked input', 'password', 'password field', 'secret', 'secure input', 'verborgen', 'wachtwoord', 'wachtwoordinvoer', 'wachtwoordveld'] },
    ...
    g = {},
    u = 'Password Input',
    c = 'Afgeschermd invoerveld om een geheime tekst in te vullen, zoals een wachtwoord.',
    m = 133,
