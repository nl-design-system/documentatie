 ...
 [18491],
 {
  ...
  51582(e, n, i) {
   ...
   const l = (e, n) => {
    ...
    a = (e) => ({ img: ({ src: n, ...i }) => (0, r.jsx)('img', { ...i, src: l(e, n), className: 'utrecht-img utrecht-img--fit' }) }),
    c = (e, n) => {
     if (e) {
      const e = { ...o[n - 1] };
      return ((e.h1 = () => null), e);
    ...
    d = ({ children: e, omitH1: n = !1, headingLevel: i = 1, baseUrl: s = '', components: l = {} }) => (0, r.jsx)(t.x, { components: { ...c(n, i), ...a(s), ...l }, children: e });
  },
  66820(e, n, i) {
   i.d(n, { E: () => l });
   var t = i(46447),
  ...
  95857(e, n, i) {
   ...
   const l = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: s, ...l }, o) => {
    const a = { ...l, ref: o, className: r('utrecht-note', { [`utrecht-note--${s}`]: s }, i) };
  ...
  96011(e, n, i) {
   ...
   const g = { title: 'WCAG-succescriterium 3.2.6 Consistente hulp', title_sm: '3.2.6 Consistente hulp', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.6 Consistente hulp', pagination_label: 'WCAG-succescriterium 3.2.6 Consistente hulp', description: 'Hulp moet op elke pagina binnen de website op dezelfde plek terugkomen.', slug: '3.2.6', conformance_level: 'Niveau A', keywords: ['WCAG', 'A', 'begrijpelijk', 'voorspelbaar', 'understandable', 'predictable', 'consistent help'] },
    j = void 0,
    m = {},
