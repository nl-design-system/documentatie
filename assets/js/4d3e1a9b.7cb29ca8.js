 ...
 [4104],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    l = n(86070);
   const u = { figma: (0, l.jsx)(i.A, {}), github: (0, l.jsx)(c.A, {}), npm: (0, l.jsx)(s.A, {}), storybook: (0, l.jsx)(o.A, {}) },
    h = ({ brand: e }) => (0, l.jsx)(r.In, { children: u[e] || (0, l.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => y, VZ: () => _, cR: () => w, Pv: () => p, qZ: () => s, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => c, eQ: () => v, B_: () => k, o_: () => g, Rc: () => x });
   ...
   const h = (e) => [...e].sort((e, t) => l.indexOf(e) - l.indexOf(t)),
    ...
    y = (e) => h(u(e.projects.flatMap((e) => m(e)))),
    p = (e) => {
     const t = m(e),
      n = ((e) => {
  ...
  85825(e, t, n) {
   ...
   const y = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    p = ({ checked: e, children: t, title: n, description: r, headingLevel: c = 3 }) => (0, l.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(m.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [n ? (0, l.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: c, children: n }) : null, r, t] })] });
   var g = n(33062);
   const k = ({ component: e, headingLevel: t }) => {
            ...
            s.Zp,
            {
             ...
             children: (0, l.jsxs)(s.Wu, {
              children: [
               ...
               (h.length > 0 || o.length > 0) && (0, l.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, l.jsx)(l.Fragment, {
    ...
    b = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(d.p, { level: t, suffix: i && (0, l.jsx)(h.D, { state: i }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  87440(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => h, component: () => g, componentName: () => p, contentTitle: () => u, default: () => f, description: () => j, frontMatter: () => l, issueNumber: () => m, metadata: () => r, relayStep: () => y, title: () => d, toc: () => k }));
