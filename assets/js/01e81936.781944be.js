 ...
 [23164],
 {
  85398: (e, n, i) => {
   ...
   const u = { title: 'WCAG-succescriterium 3.1.4 Afkortingen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.1.4 Afkortingen', pagination_label: 'WCAG-succescriterium 3.1.4 Afkortingen', description: 'Leg afkortingen uit. Zo help je alle gebruikers die de afkorting niet kennen.', slug: '3.1.4', keywords: ['WCAG'] },
    p = void 0,
    j = { id: 'wcag/3.1.04', title: 'WCAG-succescriterium 3.1.4 Afkortingen', description: 'Leg afkortingen uit. Zo help je alle gebruikers die de afkorting niet kennen.', source: '@site/docs/wcag/3.1.04.mdx', sourceDirName: 'wcag', slug: '/wcag/3.1.4', permalink: '/wcag/3.1.4', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.1.04.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 3.1.4 Afkortingen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.1.4 Afkortingen', pagination_label: 'WCAG-succescriterium 3.1.4 Afkortingen', description: 'Leg afkortingen uit. Zo help je alle gebruikers die de afkorting niet kennen.', slug: '3.1.4', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.1.3 Ongebruikelijke woorden', permalink: '/wcag/3.1.3' }, next: { title: 'WCAG-succescriterium 3.1.5 Leesniveau', permalink: '/wcag/3.1.5' } },
    m = {},
    k = [
