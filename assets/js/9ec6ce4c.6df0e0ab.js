(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [67801],
 {
  10645(e, a, n) {
   ...
   var t = n(13526),
    i = n(86070);
   const l = ({ children: e, className: a, level: n = 1, suffix: l, ...s }) => (0, i.jsxs)('hgroup', { className: (0, t.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, a), ...s, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), l && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [l ? ' ' : '', l] })] });
  },
  21034(e, a, n) {
   'use strict';
   n.d(a, { VK: () => x, $9: () => q, mu: () => b, Fc: () => k, K_: () => j });
   var t = n(29181),
    i = n(13526),
    l = n(40889),
    s = n(21530),
   ...
   var v = n(70348),
    f = n(85162);
   const x = ({ component: e, headingLevel: a }) => {
     const n = e && e.projects.filter((e) => h.f4.includes(e.id)),
      l = n && h.f4.map((e) => n.find((a) => a.id === e)).filter(Boolean);
     return e && (0, d.jsx)(v.n, { children: l.map((n) => (0, d.jsx)(v.K, { className: (0, i.A)('ma-definition-of-done', n && `ma-definition-of-done--${(0, h.fX)(n.title)}`), heading: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', headingLevel: a, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(c._, { children: n.tasks.map(({ checked: e, name: n, id: t }) => (0, d.jsx)(c.Z, { headingLevel: a + 1, checked: e, heading: n, description: (0, h.qZ)(t) }, t)) }), (0, d.jsx)(t.fz, { children: (0, d.jsxs)(t.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) }, n.title)) });
    },
                 ...
                 children: (0, d.jsx)(t.dk, {
                  links: u
                   ...
                   .map((e) => {
                    ...
                    return { children: a.desciption, icon: (0, d.jsx)(l.r, { brand: a.brand }), href: e.value };
                   }),
                 }),
                }),
               r.length > 0 && (0, d.jsx)(d.Fragment, { children: r.map(({ frameworkName: e, tasks: n }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.DZ, { level: a + 2, children: [i, ' in ', e] }), (0, d.jsx)(t.dk, { links: n.map((e) => ({ children: e.description, icon: (0, d.jsx)(l.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  21530(e, a, n) {
   'use strict';
   n.d(a, { AC: () => d, Fu: () => s, Wu: () => r, Zp: () => o });
   var t = n(46447),
    i = n(13526),
    l = n(86070);
   const s = ({ background: e, children: a, className: n, ...t }) => (0, l.jsx)('div', { className: (0, i.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, n), ...t, children: a }),
    r = (e) => (0, l.jsx)('div', { className: 'ma-card__content', ...e }),
    o = ({ href: e, appearance: a, className: n, component: s = 'div', background: r, children: o }) => {
     const d = (e) => ('article' === s ? (0, l.jsx)('article', { ...e }) : 'section' === s ? (0, l.jsx)('section', { ...e }) : (0, l.jsx)('div', { ...e })),
      g = (0, l.jsx)(d, { className: (0, i.A)('ma-cardgroup__card', r && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${a}`, n), children: o });
     return e ? (0, l.jsx)(t.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: g }) : g;
    },
    d = ({ appearance: e = 'large', children: a, className: n }) => (0, l.jsx)('div', { className: (0, i.A)('ma-cardgroup', `ma-cardgroup--${e}`, n), children: a });
  },
  32385(e, a, n) {
   'use strict';
   n.d(a, { bo: () => i, KF: () => m, mJ: () => p, VZ: () => T, cR: () => j, Pv: () => v, qZ: () => s, kD: () => q, QQ: () => H, B2: () => c, Pc: () => o, f4: () => r, GT: () => k, fX: () => l, eQ: () => b, B_: () => x, o_: () => f });
      ...
      const t = e.tasks
       ...
       .map(({ name: t, id: i, value: l }) => {
        const s = /^(.+) URL/.exec(t)[1],
         r = 'Storybook' === s ? `${n} (${a}) in Storybook van ${e.title}` : `${n} (${a}) op ${s}`;
   ...
   function q(e, a = []) {
    return Object.hasOwn(e, '$type') ? [a] : Object.keys(e).flatMap((n) => ('object' == typeof e[n] && null !== e[n] ? q(e[n], [...a, n]) : []));
   }
   function k(e) {
    const a = new Map();
    function n(e) {
  ...
  39569(e, a, n) {
   ...
   const r = ({ state: e }) => {
    const a = (0, l.fX)(e);
    return (0, s.jsx)(t.KE, { className: (0, i.A)('ma-estafette-badge', a && `ma-estafette-badge--${a}`), children: e });
   };
  },
  40889(e, a, n) {
   'use strict';
  ...
  51582(e, a, n) {
   ...
   const s = (e, a) => {
     ...
     if ('resolve:' === n.protocol) {
      const { pathname: n, search: t, hash: i } = new URL(a, new URL(e, 'http://example.com/'));
      return n + t + i;
     }
     return n.toString();
    },
    ...
    o = (e) => ({ img: ({ src: a, ...n }) => (0, l.jsx)('img', { ...n, src: s(e, a), className: 'utrecht-img utrecht-img--fit' }) }),
    d = (e, a) => {
     if (e) {
      const e = { ...r[a - 1] };
      return ((e.h1 = () => null), e);
    ...
    g = ({ children: e, omitH1: a = !1, headingLevel: n = 1, baseUrl: i = '', components: s = {} }) => (0, l.jsx)(t.x, { components: { ...d(a, n), ...o(i), ...s }, children: e });
  },
  59778(e, a, n) {
   'use strict';
   n.d(a, { e: () => r });
   ...
   const r = ({ component: e }) => {
    ...
    const { title: a } = e,
     r = (0, l.fX)(a),
     o = i.lazy(() => n(82839)(`./${r}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
  ...
  70348(e, a, n) {
   ...
   var t = n(13526),
    ...
    s = n(37168),
    r = n(86070);
   const o = (0, i.forwardRef)(({ as: e, className: a, children: n, ...i }, l) => {
     const s = e || 'div',
      o = (0, t.A)('ma-utrecht-accordion', 'utrecht-accordion', a);
     return (0, r.jsx)(s, { ref: l, className: o, ...i, children: n });
    }),
    d = ({ className: e, classNamePanel: a, label: n, heading: i, headingLevel: o, headingApperance: d, ...g }) => {
     ...
     return (0, r.jsxs)('details', { className: u, ...g, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(l.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [i && (0, r.jsx)(s.D, { level: o, appearance: d, children: i }), n] })] }) }), (0, r.jsx)('div', { className: m, children: g.children })] });
    };
  },
  82839(e, a, n) {
  ...
  94454(e, a, n) {
   'use strict';
   (n.r(a), n.d(a, { assets: () => k, component: () => H, contentTitle: () => q, default: () => _, description: () => T, frontMatter: () => b, issueNumber: () => D, metadata: () => t, title: () => j, toc: () => F }));
