 ...
 [22410],
 {
  ...
  26655(e, n, a) {
   ...
   const r = ({ background: e, children: n, className: a, ...t }) => (0, i.jsx)('div', { className: (0, s.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, a), ...t, children: n }),
    ...
    g = ({ appearance: e = 'medium', children: n, className: a }) => (0, i.jsx)('div', { className: (0, s.A)('ma-cardgroup', `ma-cardgroup--${e}`, a), children: n });
  },
  31522(e, n, a) {
   a.d(n, { D: () => l });
   var t = a(46447),
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => s, KF: () => m, mJ: () => h, VZ: () => D, cR: () => F, Pv: () => x, qZ: () => r, kD: () => j, B2: () => c, Pc: () => o, f4: () => l, GT: () => k, fX: () => i, eQ: () => v, B_: () => b, o_: () => f });
