 ...
 [89423],
 {
  ...
  70348(e, n, r) {
   ...
   const o = ({ className: e, ...n }) => {
    ...
    a = ({ className: e, label: n, heading: r, headingLevel: o, headingApperance: a, ...d }) => {
     const c = (0, l.A)('utrecht-accordion__section', e);
     return (0, s.jsxs)('details', { className: c, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(i.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(t.D, { level: o, appearance: a, children: r }), n] })] }) }), (0, s.jsx)('div', { className: 'utrecht-accordion__panel', children: d.children })] });
    };
  },
  80731(e, n, r) {
   r.d(n, { H: () => f });
  ...
  92460(e, n, r) {
   (r.r(n), r.d(n, { assets: () => T, contentTitle: () => A, default: () => V, frontMatter: () => z, metadata: () => l, toc: () => F }));
