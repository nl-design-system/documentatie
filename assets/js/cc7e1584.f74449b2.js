...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [42119],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => s, KF: () => h, mJ: () => u, VZ: () => A, cR: () => w, Pv: () => f, qZ: () => a, kD: () => b, B2: () => m, Pc: () => l, f4: () => o, GT: () => k, fX: () => i, eQ: () => v, B_: () => x, o_: () => j, Rc: () => _ });
  ...
  37131(e, n, t) {
   ...
   const u = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(h.p, { level: n, suffix: s && (0, d.jsx)(g.D, { state: s }), children: e.title }), (0, d.jsx)(r.fz, { lead: !0, children: t })] });
    },
    b = ({ component: e }) => {
     const n = (e && u[e.title]) || [];
  ...
  88907(e, n, t) {
   (t.r(n), t.d(n, { assets: () => g, component: () => j, componentName: () => f, contentTitle: () => c, default: () => b, description: () => m, frontMatter: () => d, issueNumber: () => p, metadata: () => r, relayStep: () => u, title: () => h, toc: () => x }));
   ...
   var s = t(86070),
    ...
    o = t(37131),
    l = t(44594);
   const d = { title: 'Strong', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Strong', pagination_label: 'Strong', description: 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.', slug: '/strong', keywords: ['bold', 'bold emphasis', 'bold text', 'dikgedrukt', 'emphasized text', 'important', 'strong', 'vetgedrukt'] },
    c = void 0,
    g = {},
    h = 'Strong',
