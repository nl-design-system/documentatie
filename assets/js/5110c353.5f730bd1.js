 ...
 [40284],
 {
  18461: (e, t, n) => {
   ...
   const s = { title: 'Button', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Button', pagination_label: 'Button', description: 'Biedt de mogelijkheid om een actie uit te voeren.', slug: '/button', sidebar_custom_props: { illustration: 'ButtonSketch' }, keywords: ['action', 'activate', 'button', 'knop', 'knoppen', 'submit', 'toggle button', 'versturen', 'verzenden'] },
    a = void 0,
    u = { id: 'componenten/button/index', title: 'Button', description: 'Biedt de mogelijkheid om een actie uit te voeren.', source: '@site/docs/componenten/button/index.mdx', sourceDirName: 'componenten/button', slug: '/button', permalink: '/button', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/button/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Button', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Button', pagination_label: 'Button', description: 'Biedt de mogelijkheid om een actie uit te voeren.', slug: '/button', sidebar_custom_props: { illustration: 'ButtonSketch' }, keywords: ['action', 'activate', 'button', 'knop', 'knoppen', 'submit', 'toggle button', 'versturen', 'verzenden'] }, sidebar: 'componenten', previous: { title: 'Breadcrumb navigation', permalink: '/breadcrumb-navigation' }, next: { title: 'Calendar', permalink: '/Calendar' } },
    l = {},
    d = [
