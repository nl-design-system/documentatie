 ...
 [7966],
 {
   ...
   const d = (0, a.createContext)({}),
    u = ({ title: e, appearance: l, description: n, children: a, figure: u }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      p = u ? 'figure' : 'div',
      m = u ? 'figcaption' : 'div',
      b = 'string' == typeof n ? (0, i.jsx)(c.oz, { components: { a: r.N_ }, children: n }) : n;
  ...
  70348(e, l, n) {
   ...
   var s = n(13526),
    ...
    t = n(37168),
    c = n(86070);
   const a = (0, o.forwardRef)(({ as: e, className: l, children: n, ...o }, r) => {
     const t = e || 'div',
      a = (0, s.A)('ma-utrecht-accordion', 'utrecht-accordion', l);
     return (0, c.jsx)(t, { ref: r, className: a, ...o, children: n });
    }),
    i = ({ className: e, classNamePanel: l, label: n, heading: o, headingLevel: a, headingApperance: i, ...d }) => {
     const u = (0, s.A)('utrecht-accordion__section', e),
      h = (0, s.A)('utrecht-accordion__panel', l);
     return (0, c.jsxs)('details', { className: u, ...d, children: [(0, c.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, c.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, c.jsx)('span', { className: 'nl-button__icon-start', children: (0, c.jsx)(r.A, {}) }), (0, c.jsxs)('span', { className: 'nl-button__label', children: [o && (0, c.jsx)(t.D, { level: a, appearance: i, children: o }), n] })] }) }), (0, c.jsx)('div', { className: h, children: d.children })] });
    };
  },
  75223(e, l, n) {
   ...
   const v = globalThis.isAstro
    ? ({ children: e, language: l, className: n }) => {
       const s = 'function' == typeof e ? e() : e,
        ...
        t = m().highlight(o, m().languages[l], l);
       return (0, j.jsxs)('div', { className: (0, r.A)('ma-canvas-astro', n), children: [(0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }), (0, j.jsx)(b.n, { children: (0, j.jsx)(b.K, { label: 'Code', children: (0, j.jsx)('pre', { className: 'language-html nl-code-block', children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: t } }) }) }) })] });
      }
