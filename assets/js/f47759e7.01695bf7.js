...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [29989],
 {
  18439(e, n, t) {
   ...
   function d(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(r) : e.components || r) : i(e.components)), s.createElement(o.Provider, { value: n }, e.children));
   }
  },
  33062(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => h, VZ: () => D, cR: () => w, Pv: () => j, qZ: () => i, kD: () => f, B2: () => p, Pc: () => a, f4: () => d, GT: () => x, fX: () => o, eQ: () => k, B_: () => b, o_: () => v, Rc: () => N });
     ...
     return n.map((n) => {
      const s = e.tasks
       ...
       .map(({ name: s, id: r, value: o }) => {
        ...
        return { brand: i.toLowerCase(), name: s, id: r, value: o, description: d };
       });
  ...
  54117(e, n, t) {
   (t.r(n), t.d(n, { assets: () => l, contentTitle: () => a, default: () => u, frontMatter: () => d, metadata: () => s, toc: () => c }));
   const s = JSON.parse('{"id":"handboek/developer/infrastructuur/node","title":"Werken met Node.js","description":"Werken met Node.js","source":"@site/docs/handboek/developer/05-infrastructuur/05-node.mdx","sourceDirName":"handboek/developer/05-infrastructuur","slug":"/handboek/developer/node/","permalink":"/handboek/developer/node/","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/handboek/developer/05-infrastructuur/05-node.mdx","tags":[],"version":"current","sidebarPosition":5,"frontMatter":{"title":"Werken met Node.js","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Werken met Node.js","pagination_label":"Werken met Node.js","description":"Werken met Node.js","slug":"/handboek/developer/node/","keywords":["developer","node","node.js","nodejs","nvm","versies"]},"sidebar":"handboek","previous":{"title":"Linting en code formatting","permalink":"/linting-en-code-formatting/"},"next":{"title":"Werken met pnpm","permalink":"/handboek/developer/pnpm/"}}');
   var r = t(86070),
    o = t(18439),
    i = t(33062);
   const d = { title: 'Werken met Node.js', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Werken met Node.js', pagination_label: 'Werken met Node.js', description: 'Werken met Node.js', slug: '/handboek/developer/node/', keywords: ['developer', 'node', 'node.js', 'nodejs', 'nvm', 'versies'] },
