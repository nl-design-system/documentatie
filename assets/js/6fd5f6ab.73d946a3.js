(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [72755],
 {
  ...
  45124: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => M, component: () => E, contentTitle: () => _, default: () => U, description: () => H, frontMatter: () => S, issueNumber: () => V, metadata: () => D, title: () => F, toc: () => P });
   var r,
    i,
    s,
    o,
   ...
   function O(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, d.jsx)(N.Rv, { component: E, headingLevel: 1, description: H }),
      '\n',
  ...
  55240: (e, n, t) => {
   ...
   const d = (e) => {
    ...
    h = (e) => {
     ...
     return (0, l.jsx)(a.a2, { sections: [{ className: 'utrecht-accordion--nlds-subtle', headingLevel: 2, expanded: !1, label: (0, l.jsx)('span', { children: n }), body: t.map((e, n) => (0, l.jsx)(d, { ...e }, n)) }] });
    };
  },
  8657: (e, n, t) => {
   'use strict';
