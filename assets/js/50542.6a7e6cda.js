/*! For license information please see 50542.6a7e6cda.js.LICENSE.txt */
'use strict';
  ...
  79889(e, n, t) {
   ...
   var g = (0, i.forwardRef)(function (e, n) {
    ...
    if (
     ...
     var h = a.dateTime,
      g = (0, l.A)(a, d);
     return (0, r.jsx)('time', s(s({}, g), {}, { dateTime: h, className: i, ref: n, children: t }));
    }
    if (
     (function (e) {
      return 'value' in e;
     ...
     var c = a.value,
      f = (0, l.A)(a, v);
     return (0, r.jsx)('data', s(s({}, f), {}, { value: c, className: i, ref: n, children: t }));
    }
    return (0, r.jsx)('span', s(s({}, a), {}, { className: i, ref: n, children: t }));
   });
   ...
   var h = function () {
    ...
    s = (0, i.forwardRef)(function (e, n) {
     var t = e.children,
      a = e.className,
      i = (0, l.A)(e, o);
     return (0, r.jsx)('code', v(v({ dir: 'ltr', translate: 'no', className: h('nl-code', a) }, i), {}, { ref: n, children: t }));
    });
   s.displayName = 'Code';
   !(function (e, n) {
    void 0 === n && (n = {});
