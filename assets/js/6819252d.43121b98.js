 ...
 [13562],
 {
  14881(e, n, t) {
   ...
   var r = t(13526),
    ...
    a = t(37168),
    l = t(86070);
   const s = (0, o.forwardRef)(({ as: e, className: n, children: t, ...o }, i) => {
     const a = e || 'div',
      s = (0, r.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, l.jsx)(a, { ref: i, className: s, ...o, children: t });
    }),
    d = ({ className: e, classNamePanel: n, label: t, heading: o, headingLevel: s, headingApperance: d, ...c }) => {
     const h = (0, r.A)('utrecht-accordion__section', e),
      p = (0, r.A)('utrecht-accordion__panel', n);
     return (0, l.jsxs)('details', { className: h, ...c, children: [(0, l.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, l.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, l.jsx)('span', { className: 'nl-button__icon-start', children: (0, l.jsx)(i.A, {}) }), (0, l.jsxs)('span', { className: 'nl-button__label', children: [o && (0, l.jsx)(a.D, { level: s, appearance: d, children: o }), t] })] }) }), (0, l.jsx)('div', { className: p, children: c.children })] });
    };
  },
  18439(e, n, t) {
   t.d(n, { R: () => a, x: () => l });
  ...
  19472(e, n, t) {
   ...
   var r = t(20201),
    o = t(86070);
   const i = ({ id: e, title: n, ...t }) => (0, o.jsx)(r.Ay, { lazyLoad: !0, adNetwork: !1, announce: 'Bekijk', cookie: !1, containerElement: 'div', id: e, title: n, poster: 'maxresdefault', ...t });
  },
  20201(e, n, t) {
   t.d(n, { Ay: () => l });
   var r = t(86070),
   ...
   const l = o.forwardRef(function (e, n) {
    const [t, l] = o.useState(!1),
     ...
     j = o.useMemo(() => (e.playlist ? `${v}/embed/videoseries?${b.toString()}` : `${v}/embed/${c}?${b.toString()}`), [e.playlist, v, c, b]),
     ...
     (0, r.jsxs)(r.Fragment, {
      children: [
       ...
       (0, r.jsxs)(I, {
        ...
        children: [e.lazyLoad && !s && (0, r.jsx)('img', { src: w, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !s && (0, r.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && s) && (0, r.jsx)('button', { type: 'button', className: z, 'aria-label': `${m} ${p}`, 'aria-hidden': s || void 0, tabIndex: s ? -1 : 0, onClick: L, children: (0, r.jsx)('span', { className: 'lty-visually-hidden', children: m }) }), s && (0, r.jsx)('iframe', { ref: n, className: A, title: p, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: j, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  38953(e, n, t) {
   ...
   var r = t(28369),
    ...
    b = t(46847),
    v = t(86070);
   const j = ({ children: e }) => (0, v.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, v.jsx)(o.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, v.jsx)(o.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   j.displayName = 'ParagraphContainer';
   const f = ({ children: e }) => (0, v.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, v.jsx)(o.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   f.displayName = 'DocumentContainer';
   const y = ({ children: e }) => (0, v.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: e });
   y.displayName = 'SurfaceContainer';
   const x = globalThis.isAstro
    ? ({ language: e, className: n, code: t = '<p>No code provided</p>', rawCode: r, copyCode: o, defaultExpandedCode: a, designTokens: l }) => {
       const s = 'string' == typeof t ? t : r || '',
        d = 'string' == typeof t ? m().highlight(t, m().languages[e], e) : m().highlight(r || '', m().languages[e], e);
       return (0, v.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', n), children: [(0, v.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: l, children: (0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: s } }) }), (0, v.jsx)(g.n, { children: (0, v.jsxs)(g.K, { label: 'Code', open: a, children: [(0, v.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: d } }) }), 'allow' === o && (0, v.jsx)(b.$, { 'data-copy-code': s, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: u = !0, children: m, container: g = 'document', language: b, designTokens: x }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await c.Ay.format(_, { parser: b, plugins: [a.A, l.Ay, s.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         C(e);
        })();
       }, [_]);
       const z = (0, h.useId)();
       let $ = h.Fragment;
       return (
        'paragraph' === g ? ($ = j) : 'document' === g ? ($ = f) : 'surface' === g && ($ = y),
        (0, v.jsxs)('div', {
         className: (0, i.A)('nlds-canvas'),
         children: [
          k && (0, v.jsx)('div', { className: (0, i.A)('nlds-canvas__example'), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, v.jsx)($, { children: (0, v.jsx)(o.v$, { children: k }) }) }) }),
          u &&
           (0, v.jsx)('div', {
          ...
          u &&
           (0, v.jsxs)('div', {
            ...
            hidden: !S,
            children: [
             (0, v.jsx)(r.M, { codeBlockLabel: 'Codevoorbeeld', syntax: b, textContent: N, trim: !0 }),
             n &&
              (0, v.jsx)('div', {
   ...
   const c = (0, s.createContext)({}),
    h = ({ title: e, appearance: n, description: t, children: s, figure: h }) => {
     const p = { do: 'Doen', dont: 'Niet doen' },
      u = h ? 'figure' : 'div',
      m = h ? 'figcaption' : 'div',
      g = 'string' == typeof t ? (0, d.jsx)(l.oz, { components: { a: i.N_ }, children: t }) : t;
