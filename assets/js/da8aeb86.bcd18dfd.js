(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [54592],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => y, qZ: () => c, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => k, fX: () => s, eQ: () => b, B_: () => v, o_: () => p, Rc: () => x });
   ...
   const l = (e) => [...e].sort((e, t) => h.indexOf(e) - h.indexOf(t)),
    ...
    m = (e) => l(u(e.projects.flatMap((e) => g(e)))),
    y = (e) => {
     const t = g(e),
      n = ((e) => {
  ...
  61133(e, t, n) {
   ...
   function f(e = {}) {
    ...
    return t ? (0, i.jsx)(t, { ...e, children: (0, i.jsx)(b, { ...e }) }) : b(e);
   }
  },
  67970(e, t, n) {
   'use strict';
  ...
  85825(e, t, n) {
   ...
   const m = ({ children: e }) => (0, h.jsx)('ul', { className: 'task-list', children: e }),
    y = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, h.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, h.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, h.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, h.jsx)(g.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, h.jsxs)('div', { children: [n ? (0, h.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }) : null, r, t] })] });
   var p = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, h.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, h.jsx)(y, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, h.jsx)(r.fz, { children: (0, h.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
