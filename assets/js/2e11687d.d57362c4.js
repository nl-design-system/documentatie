(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [71537],
 {
  9875(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => G, component: () => M, contentTitle: () => R, default: () => E, description: () => $, frontMatter: () => _, issueNumber: () => I, metadata: () => a, title: () => P, toc: () => V }));
  ...
  32385(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => m, mJ: () => p, VZ: () => w, cR: () => y, Pv: () => j, qZ: () => r, kD: () => v, QQ: () => A, B2: () => u, Pc: () => o, f4: () => l, GT: () => k, fX: () => s, eQ: () => f, B_: () => b, o_: () => x });
  ...
  70348(e, n, t) {
   ...
   const l = ({ className: e, ...n }) => {
    ...
    o = ({ className: e, classNamePanel: n, label: t, heading: l, headingLevel: o, headingApperance: d, ...c }) => {
     ...
     return (0, r.jsxs)('details', { className: g, ...c, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(i.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [l && (0, r.jsx)(s.D, { level: o, appearance: d, children: l }), t] })] }) }), (0, r.jsx)('div', { className: m, children: c.children })] });
    };
  },
  70561(e, n, t) {
   'use strict';
  ...
  70903(e, n, t) {
   ...
   var p = t(43864),
    ...
    A = t(79532),
    S = t(30758);
   const N = { boxShadow: p.A, color: j.A, cursor: x.A, dimension: b.A, fontFamily: f.A, fontFamilies: f.A, fontSize: v.A, fontSizes: v.A, fontWeight: k.A, fontWeights: k.A, lineHeight: y.A, lineHeights: y.A, number: w.A, other: D.A, textDecoration: A.A },
    T = ({ type: e }) => {
