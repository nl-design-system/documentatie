 ...
 [48087],
 {
  3227(e, n, i) {
   ...
   function f(e) {
    ...
    const t = (0, r.d1)(n);
    return (0, c.jsx)('section', { className: (0, s.A)('row', i), ...e, children: t.map((e, n) => (0, c.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, c.jsx)(m, { item: e }) }, n)) });
   }
  },
  18439(e, n, i) {
   i.d(n, { R: () => l, x: () => s });
  ...
  45282(e, n, i) {
   ...
   const o = ({ children: e, ...n }) => {
     const { to: i, href: r, ...o } = n;
     let l = i || r;
     const s = new URL(l, 'https://nldesignsystem.nl');
     return ('https://nldesignsystem.nl' === s.origin ? ((s.pathname = s.pathname.endsWith('/') ? s.pathname : `${s.pathname}/`), (l = s.toString().replace('https://nldesignsystem.nl', ''))) : ((o.target = '_blank'), (o.rel = 'noopener noreferrer')), (0, t.jsx)('a', { href: l, ...o, children: e }));
    },
    l = ({ className: e, ...n }) => (0, t.jsx)(o, { className: (0, r.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  60316(e, n, i) {
   i.d(n, { $S: () => r, d1: () => t });
   i(74147);
  ...
  81001(e, n, i) {
   (i.r(n), i.d(n, { assets: () => h, contentTitle: () => d, default: () => f, frontMatter: () => a, metadata: () => r, toc: () => m }));
