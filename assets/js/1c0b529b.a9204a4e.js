...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [44125],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => u, mJ: () => g, VZ: () => N, cR: () => A, Pv: () => k, qZ: () => a, kD: () => b, B2: () => m, Pc: () => l, f4: () => s, GT: () => j, fX: () => r, eQ: () => x, B_: () => v, o_: () => f, Rc: () => _ });
  ...
  37131(e, n, t) {
   ...
   const g = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    ...
    v = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(o.DZ, { level: n, children: 'Help om deze component te verbeteren' }), (0, c.jsxs)(o.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, c.jsxs)(o.Xy, { children: [i ? (0, c.jsxs)(o.Er, { children: ['Vul de ', (0, c.jsx)(o.N_, { href: i, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, c.jsxs)(o.Er, { children: [(0, c.jsxs)(o.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, c.jsxs)(o.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, c.jsx)(o.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, c.jsx)(o.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    x = ({ component: e, headingLevel: n, description: t }) => {
     const i = e && h.bo[e.relayStep];
     return e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(u.p, { level: n, suffix: i && (0, c.jsx)(p.D, { state: i }), children: e.title }), (0, c.jsx)(o.fz, { lead: !0, children: t })] });
    },
    b = ({ component: e }) => {
     const n = (e && g[e.title]) || [];
  ...
  37815(e, n, t) {
   (t.r(n), t.d(n, { assets: () => d, component: () => h, contentTitle: () => c, default: () => f, description: () => u, frontMatter: () => l, issueNumber: () => m, metadata: () => o, title: () => p, toc: () => g }));
