 ...
 [24515],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    h = n(86070);
   const u = { figma: (0, h.jsx)(c.A, {}), github: (0, h.jsx)(i.A, {}), npm: (0, h.jsx)(s.A, {}), storybook: (0, h.jsx)(o.A, {}) },
    l = ({ brand: e }) => (0, h.jsx)(r.In, { children: u[e] || (0, h.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => y, VZ: () => _, cR: () => w, Pv: () => p, qZ: () => s, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => i, eQ: () => v, B_: () => k, o_: () => g, Rc: () => x });
   ...
   const l = (e) => [...e].sort((e, t) => h.indexOf(e) - h.indexOf(t)),
    ...
    y = (e) => l(u(e.projects.flatMap((e) => m(e)))),
    p = (e) => {
     const t = m(e),
      n = ((e) => {
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map(({ name: r, id: c, value: i }) => {
        const s = /^(.+) URL/.exec(r)[1],
         o = 'Storybook' === s ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${s}`;
        return { brand: s.toLowerCase(), name: r, id: c, value: i, description: o };
       });
  ...
  44594(e, t, n) {
   ...
   const o = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    a = ({ name: e, relayStep: t, description: n }) => {
     const a = (0, i.fX)(t),
      h = o[e] ?? e;
     return (0, s.jsxs)(r.WK, { children: [(0, s.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, c.A)('component-illustration', `component-illustration--${a}`), fill: 'none', children: [(0, s.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, s.jsx)('rect', { width: '960', height: '540' }), (0, s.jsx)('rect', { width: '960', height: '540' })] }), (0, s.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, s.jsx)('use', { href: `/svg/componenten_overzicht_${(0, i.fX)(h)}.svg#component-illustration` })] }), (0, s.jsx)(r.$P, { className: 'component-illustration__caption', children: n })] });
    };
  },
  54565(e, t, n) {
   'use strict';
  ...
  57365(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => g, componentName: () => p, contentTitle: () => u, default: () => f, description: () => j, frontMatter: () => h, issueNumber: () => m, metadata: () => r, relayStep: () => y, title: () => d, toc: () => k }));
   ...
   var c = n(86070),
    ...
    o = n(85825),
    a = n(44594);
   const h = { title: 'Checkbox Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Checkbox Group', pagination_label: 'Checkbox Group', description: 'Biedt de mogelijkheid om geen, \xe9\xe9n of meerdere opties te selecteren uit een lijst.', slug: '/checkbox-group', keywords: ['aankruisen', 'aankruisvakje', 'aanvinken', 'afvinken', 'aria-disabled', 'check', 'check box', 'checkbox', 'checkbox button', 'checkbox group', 'checkboxes', 'checked', 'checkmark', 'choice', 'choices', 'fieldset', 'form', 'form control', 'form field', 'formulier', 'formulierveld', 'indeterminate', 'invoerveld', 'kruis', 'kruisje', 'meerkeuze', 'meerkeuzevraag', 'multiple choice', 'niet', 'optie', 'option', 'option box', 'optional', 'optioneel', 'options', 'required', 'select', 'selecteren', 'selectie', 'selectievakje', 'selection box', 'uncheck', 'unchecked', 'verplicht', 'vink', 'vinkje', 'wel', 'X mark'] },
    u = void 0,
    l = {},
    d = 'Checkbox Group',
    j = 'Biedt de mogelijkheid om geen, \xe9\xe9n of meerdere opties te selecteren uit een lijst.',
    m = 128,
    y = 'help wanted',
    p = 'checkbox-group',
    g = s.find((e) => e.number === m),
    k = [
   ...
   function v(e) {
    ...
    return (0, c.jsxs)(c.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, c.jsx)(o.Fc, { component: g, headingLevel: 1, description: j }), '\n', (0, c.jsx)(a.s, { relayStep: y, description: `Schets van de ${p} component`, name: p }), '\n', (0, c.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, c.jsx)(o.VK, { component: g, headingLevel: 3 }), '\n', (0, c.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, c.jsx)(o.mu, { component: g, headingLevel: 3 }), '\n', (0, c.jsx)(o.$9, { component: g, headingLevel: 2 })] });
   }
   function f(e = {}) {
    const { wrapper: t } = { ...(0, i.R)(), ...e.components };
    return t ? (0, c.jsx)(t, { ...e, children: (0, c.jsx)(v, { ...e }) }) : v(e);
   }
  },
  67970(e, t, n) {
   'use strict';
   ...
   const o = ({ state: e }) => {
    const t = (0, i.fX)(e);
    return (0, s.jsx)(r.KE, { className: (0, c.A)('estafette-badge', t && `estafette-badge--${t}`), children: e });
   };
  },
  72642(e, t, n) {
   'use strict';
   ...
   var r = n(13526),
    c = n(86070);
   const i = ({ children: e, className: t, level: n = 1, suffix: i, ...s }) => (0, c.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, t), ...s, children: [(0, c.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), i && (0, c.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [i ? ' ' : '', i] })] });
  },
  85825(e, t, n) {
   'use strict';
   ...
   const y = ({ children: e }) => (0, h.jsx)('ul', { className: 'task-list', children: e }),
    p = ({ checked: e, children: t, title: n, description: r, headingLevel: i = 3 }) => (0, h.jsxs)('li', { className: (0, c.A)('task-list-item'), children: [(0, h.jsxs)('div', { className: (0, c.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, h.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, h.jsx)(m.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, h.jsxs)('div', { children: [n ? (0, h.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: i, children: n }) : null, r, t] })] });
   var g = n(33062);
   const k = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, h.jsx)(r.If, { sections: i.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, g.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(y, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, h.jsx)(p, { headingLevel: t + 1, checked: e, title: n, description: (0, g.qZ)(r) }, r)) }), (0, h.jsx)(r.fz, { children: (0, h.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            s.Zp,
            {
             ...
             children: (0, h.jsxs)(s.Wu, {
              children: [
               ...
               o.length > 0 && (0, h.jsx)(h.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, h.jsxs)(h.Fragment, { children: [(0, h.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, h.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, h.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    f = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(r.DZ, { level: t, children: 'Help om deze component te verbeteren' }), (0, h.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, h.jsxs)(r.Xy, { children: [c ? (0, h.jsxs)(r.Er, { children: ['Vul de ', (0, h.jsx)(r.N_, { href: c, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, h.jsxs)(r.Er, { children: [(0, h.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, h.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, h.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, h.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    b = ({ component: e, headingLevel: t, description: n }) => {
     const c = e && g.bo[e.relayStep];
     return e && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(d.p, { level: t, suffix: c && (0, h.jsx)(l.D, { state: c }), children: e.title }), (0, h.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
   ...
   var r = n(46447),
    c = n(13526),
    i = n(86070);
   const s = ({ background: e, children: t, className: n, ...r }) => (0, i.jsx)('div', { className: (0, c.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    o = (e) => (0, i.jsx)('div', { className: 'card__content', ...e }),
    a = ({ href: e, appearance: t, className: n, component: s = 'div', background: o, children: a }) => {
     const h = (e) => ('article' === s ? (0, i.jsx)('article', { ...e }) : 'section' === s ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      u = (0, i.jsx)(h, { className: (0, c.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, i.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: u }) : u;
    },
    h = ({ appearance: e = 'medium', children: t, className: n }) => (0, i.jsx)('div', { className: (0, c.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
 },
]);
