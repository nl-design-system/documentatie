 ...
 [82190],
 {
  ...
  43599: (e, n, o) => {
   ...
   const b = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(N, { parser: x, plugins: [s.Z, i.ZP, c.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [N]);
    const S = (0, u.useId)();
