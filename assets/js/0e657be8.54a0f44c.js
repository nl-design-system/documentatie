...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [96921],
 {
  ...
  25838(e, n, i) {
   (i.r(n), i.d(n, { assets: () => v, contentTitle: () => j, default: () => w, frontMatter: () => p, metadata: () => t, toc: () => x }));
   const t = JSON.parse('{"id":"wcag/2.3.03","title":"WCAG-succescriterium 2.3.3 Animatie uit interacties","description":"Zorg ervoor dat de gebruiker beweging en animatie uit kan zetten.","source":"@site/docs/wcag/2.3.03.mdx","sourceDirName":"wcag","slug":"/wcag/2.3.3","permalink":"/wcag/2.3.3","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.3.03.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 2.3.3 Animatie uit interacties","title_sm":"2.3.3 Animatie uit interacties","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"2.3.3 Animatie uit interacties","pagination_label":"WCAG-succescriterium 2.3.3 Animatie uit interacties","description":"Zorg ervoor dat de gebruiker beweging en animatie uit kan zetten.","slug":"2.3.3","conformance_level":"Niveau AAA","keywords":["WCAG","AAA","bedienbaar","toevallen en fysieke reacties","operable","seizures and physical reactions","animation from interactions"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 2.3.2 Drie flitsen","permalink":"/wcag/2.3.2"},"next":{"title":"WCAG-succescriterium 2.4.1 Blokken omzeilen","permalink":"/wcag/2.4.1"}}');
   var r = i(86070),
    s = i(18439),
    a = i(12941),
    l = i(87491),
   ...
   function u(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Zorg ervoor dat de gebruiker beweging en animatie uit kan zetten. Dit gaat over beweging die de gebruiker zelf start door interactie met interactieve elementen, zoals bij een link, button of checkbox.\nBehalve als de animatie essentieel is voor de functionaliteit.' }), '\n', (0, r.jsx)(n.p, { children: 'Dit is belangrijk voor gebruikers die snel afgeleid worden of er zelfs misselijk van worden.' }), '\n', (0, r.jsxs)(n.p, { children: ['Respecteer daarom de instellingen van de browser voor ', (0, r.jsx)(n.a, { href: 'https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-reduced-motion', children: "'prefers-reduced-motion'" }), ' of voeg een optie op de pagina toe die deze beweging uitzet.'] }), '\n', (0, r.jsx)(n.p, { children: 'De beste oplossing: gebruik helemaal geen animatie op een interactief element.' })] });
   }
   function m(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(u, { ...e }) }) : u(e);
   }
   const p = { title: 'WCAG-succescriterium 2.3.3 Animatie uit interacties', title_sm: '2.3.3 Animatie uit interacties', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.3.3 Animatie uit interacties', pagination_label: 'WCAG-succescriterium 2.3.3 Animatie uit interacties', description: 'Zorg ervoor dat de gebruiker beweging en animatie uit kan zetten.', slug: '2.3.3', conformance_level: 'Niveau AAA', keywords: ['WCAG', 'AAA', 'bedienbaar', 'toevallen en fysieke reacties', 'operable', 'seizures and physical reactions', 'animation from interactions'] },
    j = void 0,
    v = {},
   ...
   function f(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', (0, r.jsx)(l.E, { level: 1, conformanceLevel: 'Niveau AAA', children: 'WCAG-succescriterium 2.3.3 Animatie uit interacties' }), '\n', (0, r.jsx)(o.K7, { children: (0, r.jsx)(a.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(h.Ay, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, r.jsx)(m, {}), '\n', (0, r.jsx)(n.h2, { id: 'opgelet', children: 'Opgelet' }), '\n', (0, r.jsx)(n.p, { children: 'Deze inhoud wordt binnenkort aangevuld met uitgebreidere uitleg, bronnen en informatie over hoe te testen.' }), '\n', (0, r.jsx)(n.h2, { id: 'gerelateerde-nl-design-system-richtlijnen', children: 'Gerelateerde NL Design System-richtlijnen' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Content: ', (0, r.jsx)(n.a, { href: '/richtlijnen/content/video/flitsen/', children: 'Flitsen in video' }), '.'] }), '\n'] }), '\n', (0, r.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, r.jsx)(c.Ay, {}), '\n', (0, r.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#animation-from-interactions', children: (0, r.jsx)('span', { lang: 'en', children: '2.3.3 Animation from Interactions' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#animation-from-interactions', children: '2.3.3 Animatie uit interacties' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, r.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#animation-from-interactions', children: (0, r.jsx)('span', { lang: 'en', children: 'Quick Reference 2.3.3 Animation from Interactions' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/animation-from-interactions.html', children: (0, r.jsx)('span', { lang: 'en', children: 'Understanding SC 2.3.3 Animation from Interactions' }) }), '.'] }), '\n'] }), '\n', (0, r.jsx)(o.K7, { children: (0, r.jsx)(a.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(d.Ay, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, r.jsx)(a.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(g.Ay, {}) })] });
   }
   function w(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
