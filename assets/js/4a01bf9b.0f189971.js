    ...
    return (
     ...
     (0, r.jsx)(s.y$, {
      ...
      children: (e) => {
       ...
       return (0, r.jsx)(o.dn, { tabIndex: 0, style: l, children: s.map((e, l) => (0, r.jsxs)('span', { ...t({ line: e }), children: [n && (0, r.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, r.jsx)('span', { ...c({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const d = (e) => {
    ...
    const p = 'Doen',
     ...
     m = u ? 'figure' : 'div',
     _ = u ? 'figcaption' : 'div';
    return (0, a.jsxs)(m, { className: (0, r.Z)(c['nlds-guideline'], c[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(_, { className: (0, r.Z)(c['nlds-guideline__description']), children: ['dont' === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, r.Z)(c['nlds-guideline__badge'], c[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: c['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: c['nlds-guideline__title'], children: h })] }), (0, a.jsx)(t.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, r.Z)(c['nlds-guideline__badge'], c[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: c['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: c['nlds-guideline__title'], children: p })] }), (0, a.jsx)(t.nv, { children: n })] }), d] }), (0, a.jsx)('div', { className: (0, r.Z)(c['nlds-guideline__example']), children: i })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => c, a: () => r });
