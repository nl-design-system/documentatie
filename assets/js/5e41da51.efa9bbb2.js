...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [39311],
 {
  ...
  37991(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => x, componentName: () => f, contentTitle: () => g, default: () => v, description: () => c, frontMatter: () => d, issueNumber: () => p, metadata: () => t, relayStep: () => h, title: () => m, toc: () => b }));
   ...
   var i = a(86070),
    ...
    l = a(12761),
    o = a(17842);
   const d = { title: 'Drawer', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Drawer', pagination_label: 'Drawer', description: 'Een paneel aan de zijkant van een scherm, die geopend kan worden voor gerelateerde informatie, formulieren of acties.', slug: '/drawer', keywords: ['drawer', 'flyout', 'paneel', 'schuifpaneel', 'side panel', 'side sheet', 'tray'] },
    g = void 0,
    u = {},
    m = 'Drawer',
    c = 'Een paneel aan de zijkant van een scherm, die geopend kan worden voor gerelateerde informatie, formulieren of acties.',
    p = 256,
    h = 'help wanted',
    f = 'drawer',
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => f, qZ: () => s, kD: () => v, B2: () => c, Pc: () => o, f4: () => l, GT: () => k, fX: () => r, eQ: () => j, B_: () => b, o_: () => x });
