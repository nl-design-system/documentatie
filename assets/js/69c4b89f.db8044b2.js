 ...
 [75922],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    u = n(86070);
   const l = { figma: (0, u.jsx)(s.A, {}), github: (0, u.jsx)(i.A, {}), npm: (0, u.jsx)(c.A, {}), storybook: (0, u.jsx)(o.A, {}) },
    h = ({ brand: e }) => (0, u.jsx)(r.In, { children: l[e] || (0, u.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => d, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => g, qZ: () => c, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => i, eQ: () => k, B_: () => v, o_: () => p, Rc: () => x });
   ...
   const h = (e) => [...e].sort((e, t) => u.indexOf(e) - u.indexOf(t)),
    d = (e) => {
    ...
    m = (e) => h(l(e.projects.flatMap((e) => y(e)))),
    g = (e) => {
     const t = y(e),
      n = ((e) => {
  ...
  44594(e, t, n) {
   ...
   const o = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    a = ({ name: e, relayStep: t, description: n }) => {
     const a = (0, i.fX)(t),
      u = o[e] ?? e;
     return (0, c.jsxs)(r.WK, { children: [(0, c.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, s.A)('component-illustration', `component-illustration--${a}`), fill: 'none', children: [(0, c.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, c.jsx)('rect', { width: '960', height: '540' }), (0, c.jsx)('rect', { width: '960', height: '540' })] }), (0, c.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, c.jsx)('use', { href: `/svg/componenten_overzicht_${(0, i.fX)(u)}.svg#component-illustration` })] }), (0, c.jsx)(r.$P, { className: 'component-illustration__caption', children: n })] });
    };
  },
  54565(e, t, n) {
   'use strict';
  ...
  85825(e, t, n) {
   ...
   var h = n(67970),
    ...
    j = n(46447),
    y = n(45561);
   const m = ({ children: e }) => (0, u.jsx)('ul', { className: 'task-list', children: e }),
    g = ({ checked: e, children: t, title: n, description: r, headingLevel: i = 3 }) => (0, u.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, u.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, u.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, u.jsx)(y.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [n ? (0, u.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: i, children: n }) : null, r, t] })] });
   var p = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(g, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
          ...
          .map((e) => {
           ...
           return (0, u.jsx)(
            c.Zp,
            {
             ...
             children: (0, u.jsxs)(c.Wu, {
              children: [
               (0, u.jsx)(r.DZ, { level: t, children: e.title.replace(/^Community/i, '') }),
               (0, u.jsxs)(r.fz, { children: [(0, u.jsx)(l, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
               (h.length > 0 || o.length > 0) && (0, u.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, u.jsx)(u.Fragment, {
                 children: (0, u.jsx)(r.dk, {
                  links: h
                   ...
                   .map((e) => {
                    ...
                    return { children: t.desciption, icon: (0, u.jsx)(i.r, { brand: t.brand }), href: e.value };
                   }),
                 }),
                }),
               o.length > 0 && (0, u.jsx)(u.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: t + 2, children: [s, ' in ', e] }), (0, u.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, u.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    f = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(r.DZ, { level: t, children: 'Help om deze component te verbeteren' }), (0, u.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, u.jsxs)(r.Xy, { children: [s ? (0, u.jsxs)(r.Er, { children: ['Vul de ', (0, u.jsx)(r.N_, { href: s, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, u.jsxs)(r.Er, { children: [(0, u.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, u.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, u.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, u.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    b = ({ component: e, headingLevel: t, description: n }) => {
     const s = e && p.bo[e.relayStep];
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(d.p, { level: t, suffix: s && (0, u.jsx)(h.D, { state: s }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
   n.d(t, { AC: () => u, Fu: () => c, Wu: () => o, Zp: () => a });
   var r = n(46447),
    s = n(13526),
    i = n(86070);
   const c = ({ background: e, children: t, className: n, ...r }) => (0, i.jsx)('div', { className: (0, s.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: c = 'div', background: o, children: a }) => {
     const u = (e) => ('article' === c ? (0, i.jsx)('article', { ...e }) : 'section' === c ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      l = (0, i.jsx)(u, { className: (0, s.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, i.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    u = ({ appearance: e = 'medium', children: t, className: n }) => (0, i.jsx)('div', { className: (0, s.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
 },
]);
