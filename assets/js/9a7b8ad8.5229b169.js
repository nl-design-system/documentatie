/*! For license information please see 9a7b8ad8.5229b169.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [67287],
 {
  ...
  18652(e, n, s) {
   ...
   const a = (e, n, s, a) => {
    const r = (0, t.forwardRef)(({ color: s = 'currentColor', size: r = 24, stroke: l = 2, title: o, className: d, children: c, ...h }, m) => (0, t.createElement)('svg', { ref: m, ...i[e], width: r, height: r, className: ['tabler-icon', `tabler-icon-${n}`, d].join(' '), ...('filled' === e ? { fill: s } : { strokeWidth: l, stroke: s }), ...h }, [o && (0, t.createElement)('title', { key: 'svg-title' }, o), ...a.map(([e, n]) => (0, t.createElement)(e, n)), ...(Array.isArray(c) ? c : [c])]));
  ...
  20698(e, n, s) {
   ...
   var t = s(53538),
    i = s(13526),
    a = s(86070);
   const r = ({ appearance: e, ...n }) => (0, a.jsx)(t.F, { className: (0, i.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...n });
  },
  53538(e, n, s) {
   s.d(n, { F: () => r, N: () => l });
   var t = s(13526),
   ...
   const r = ({ children: e, ...n }) => {
     ...
     return ('https://nldesignsystem.nl' === o.origin ? (o.pathname.endsWith('/') || (0, i.QQ)(o.pathname) || (o.pathname = `${o.pathname}/`), (l = o.toString().replace('https://nldesignsystem.nl', ''))) : ((r.target = '_blank'), (r.rel = 'noopener noreferrer')), (0, a.jsx)('a', { href: l, ...r, children: e }));
    },
    l = ({ className: e, ...n }) => (0, a.jsx)(r, { className: (0, t.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  64249(e, n, s) {
   s.d(n, { A: () => t });
  ...
  76097(e, n, s) {
   s.d(n, { bo: () => i, KF: () => m, mJ: () => p, VZ: () => S, cR: () => x, Pv: () => g, qZ: () => r, kD: () => y, QQ: () => C, B2: () => k, Pc: () => o, f4: () => l, GT: () => b, fX: () => a, eQ: () => f, B_: () => v, o_: () => j });
     ...
     return n.map((n) => {
      const t = e.tasks
       ...
       .map(({ name: t, id: i, value: a }) => {
        ...
        return { brand: r.toLowerCase(), name: t, id: i, value: a, description: l };
       });
  ...
  80232(e, n, s) {
   (s.r(n), s.d(n, { assets: () => h, contentTitle: () => c, default: () => u, frontMatter: () => d, metadata: () => t, toc: () => m }));
