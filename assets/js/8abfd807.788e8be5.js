 ...
 [59797],
 {
  ...
  58489(e, n, o) {
   ...
   var l = o(86070),
    ...
    a = o(46447);
   function d(e) {
    const n = { div: 'div', fieldset: 'fieldset', input: 'input', label: 'label', legend: 'legend', ...(0, t.R)(), ...e.components };
    return (0, l.jsxs)(l.Fragment, { children: ['\n', '\n', (0, l.jsx)(c.$, { appearance: 'do', title: 'Geef invoerveld een duidelijke rand met voldoende contrast.', description: (0, l.jsxs)(l.Fragment, { children: ['Dit voorbeeld heeft', ' ', (0, l.jsx)(a.N_, { href: '/contrast/?color=%23006FA1&background-color=%23ffffff', children: 'een contrast van 5.54:1' }), '.'] }), children: (0, l.jsx)(i.H, { language: 'html', designTokens: { '--utrecht-textbox-background-color': '#ffffff', '--utrecht-textbox-border-color': '#006FA1' }, children: () => (0, l.jsx)(l.Fragment, { children: (0, l.jsx)(n.input, { type: 'text' }) }) }) }), '\n', (0, l.jsx)(c.$, { appearance: 'do', title: 'Geef een radiobutton voldoende kleurcontrast.', description: (0, l.jsxs)(l.Fragment, { children: ['Dit voorbeeld heeft', ' ', (0, l.jsx)(a.N_, { href: '/contrast/?color=%23006FA1&background-color=%23ffffff', children: 'een contrast van 5.54:1' }), '.'] }), children: (0, l.jsx)(i.H, { language: 'html', designTokens: { '--utrecht-radio-button-background-color': '#FFFFFF', '--utrecht-radio-button-border-color': '#006FA1' }, children: () => (0, l.jsx)(l.Fragment, { children: (0, l.jsxs)(n.fieldset, { children: [(0, l.jsx)(n.legend, { children: 'Kies je kleur' }), (0, l.jsxs)(n.div, { children: [(0, l.jsx)(n.input, { type: 'radio', id: 'radio1', name: 'kleur' }), ' ', (0, l.jsx)(n.label, { htmlFor: 'radio1', children: 'Blauw' })] }), (0, l.jsxs)(n.div, { children: [(0, l.jsx)(n.input, { type: 'radio', id: 'radio2', name: 'kleur' }), ' ', (0, l.jsx)(n.label, { htmlFor: 'radio2', children: 'Groen' })] }), (0, l.jsxs)(n.div, { children: [(0, l.jsx)(n.input, { type: 'radio', id: 'radio3', name: 'kleur' }), ' ', (0, l.jsx)(n.label, { htmlFor: 'radio3', children: 'Rood' })] })] }) }) }) }), '\n', (0, l.jsx)(c.$, { appearance: 'dont', title: 'Geef invoerveld een slecht zichtbare rand met onvoldoende contrast.', description: (0, l.jsxs)(l.Fragment, { children: ['Dit voorbeeld heeft', ' ', (0, l.jsx)(a.N_, { href: '/contrast/?color=%23f8f5f1&background-color=%23ffffff', children: 'een contrast van 1.08:1' }), '.'] }), children: (0, l.jsx)(i.H, { language: 'html', designTokens: { '--utrecht-textbox-background-color': '#ffffff', '--utrecht-textbox-border-color': '#f8f4f1' }, children: () => (0, l.jsx)(l.Fragment, { children: (0, l.jsx)(n.input, { type: 'text' }) }) }) })] });
   }
   function u(e = {}) {
  ...
  58639(e, n, o) {
   ...
   var r = o(69284),
    ...
    p = o(31186),
    h = o(86070);
   const v = ({ children: e }) => (0, h.jsx)(l.ui, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(l.yo, { className: (0, t.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, h.jsx)(l.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: g = !0, children: b, container: j = 'document', language: x, designTokens: y }) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(w, { parser: x, plugins: [s.A, i.Ay, c.Ay, a.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      A(e);
     })();
    }, [w]);
    const C = (0, u.useId)();
    let R = u.Fragment;
    return (
     'paragraph' === j ? (R = v) : 'document' === j ? (R = m) : 'surface' === j && (R = f),
     (0, h.jsxs)('div', {
  ...
  69284(e, n, o) {
   ...
   function a({ lineNumber: e, syntax: n, textContent: o, trim: a }) {
    ...
    const { title: u, type: p } = (0, t.useContext)(s.x),
     h = (0, t.useId)();
    return (a && (d = d.trim()), (0, c.jsx)(l.f4, { theme: i, code: d, language: n || '', children: ({ style: n, tokens: o, getLineProps: l, getTokenProps: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, c.jsx)(r.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': h, style: n, children: o.map((n, o) => (0, c.jsxs)('span', { ...l({ line: n }), children: [e && (0, c.jsx)('span', { children: o + 1 }), n.map((e, n) => (0, c.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, o)) })] }) }));
   }
  },
  78734(e, n, o) {
   o.d(n, { Ay: () => i, RM: () => t });
