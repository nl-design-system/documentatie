 ...
 [31116],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    l = n(86070);
   const h = { figma: (0, l.jsx)(c.A, {}), github: (0, l.jsx)(i.A, {}), npm: (0, l.jsx)(s.A, {}), storybook: (0, l.jsx)(o.A, {}) },
  ...
  12013(e, t, n) {
   ...
   const s = (e, t) => {
    ...
    o = { 1: {}, 2: { h1: c.fV, h2: c._B, h3: c.f_, h4: c.mM, h5: c.TT }, 3: { h1: c._B, h2: c.f_, h3: c.mM, h4: c.TT, h5: c.TT }, 4: { h1: c.f_, h2: c.mM, h3: c.TT, h4: c.TT, h5: c.TT }, 5: { h1: c.mM, h2: c.TT, h3: c.TT, h4: c.TT, h5: c.TT }, 6: { h1: c.TT, h2: c.TT, h3: c.TT, h4: c.TT, h5: c.TT } },
    a = (e) => ({ img: ({ src: t, ...n }) => (0, i.jsx)('img', { ...n, src: s(e, t), className: 'utrecht-img utrecht-img--fit' }) }),
    l = (e, t) => {
     if (e) {
      const e = { ...o[t - 1] };
      return ((e.h1 = () => null), e);
    ...
    h = ({ children: e, omitH1: t = !1, headingLevel: n = 1, baseUrl: c = '', components: s = {} }) => (0, i.jsx)(r.x, { components: { ...l(t, n), ...a(c), ...s }, children: e });
  },
  26095(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => q, component: () => _, contentTitle: () => k, default: () => A, description: () => x, frontMatter: () => f, issueNumber: () => w, metadata: () => r, title: () => b, toc: () => z }));
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => y, VZ: () => w, cR: () => x, Pv: () => g, qZ: () => s, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => q, fX: () => i, eQ: () => f, B_: () => v, o_: () => p, Rc: () => b });
  ...
  72401(e, t, n) {
   ...
   const o = ({ component: e }) => {
    const { title: t } = e,
     o = (0, i.fX)(t),
     a = c.lazy(() => n(82839)(`./${o}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
    return (0, s.jsx)(c.Suspense, { fallback: null, children: (0, s.jsx)(r.o, { omitH1: !0, headingLevel: 1, children: (0, s.jsx)(a, {}) }) });
   };
  },
  72642(e, t, n) {
   'use strict';
  ...
  85825(e, t, n) {
   ...
   const y = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    g = ({ checked: e, children: t, title: n, description: r, headingLevel: i = 3 }) => (0, l.jsxs)('li', { className: (0, c.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, c.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(m.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [n ? (0, l.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: i, children: n }) : null, r, t] })] });
   var p = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
            ...
            s.Zp,
            {
             ...
             children: (0, l.jsxs)(s.Wu, {
              children: [
               ...
               o.length > 0 && (0, l.jsx)(l.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    q = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(d.p, { level: t, suffix: c && (0, l.jsx)(u.D, { state: c }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
   ...
   const s = ({ background: e, children: t, className: n, ...r }) => (0, i.jsx)('div', { className: (0, c.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: s = 'div', background: o, children: a }) => {
     const l = (e) => ('article' === s ? (0, i.jsx)('article', { ...e }) : 'section' === s ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      h = (0, i.jsx)(l, { className: (0, c.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, i.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: h }) : h;
    },
    l = ({ appearance: e = 'medium', children: t, className: n }) => (0, i.jsx)('div', { className: (0, c.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
 },
]);
