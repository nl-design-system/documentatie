 ...
 [34492],
 {
  47210: (e, t, n) => {
   ...
   const o = { title: 'Progress Bar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress Bar', pagination_label: 'Progress Bar', description: 'Toont de voortgang van een proces in een balk.', slug: '/progress-bar', keywords: ['balk', 'balkindicator', 'linear progress', 'meter', 'progress', 'progressbalk', 'progress bar', 'progress indicator', 'progress loader', 'status', 'steps', 'voortgangsbalk'] },
    a = void 0,
    u = { id: 'componenten/progress-bar/index', title: 'Progress Bar', description: 'Toont de voortgang van een proces in een balk.', source: '@site/docs/componenten/progress-bar/index.mdx', sourceDirName: 'componenten/progress-bar', slug: '/progress-bar', permalink: '/progress-bar', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/progress-bar/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Progress Bar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress Bar', pagination_label: 'Progress Bar', description: 'Toont de voortgang van een proces in een balk.', slug: '/progress-bar', keywords: ['balk', 'balkindicator', 'linear progress', 'meter', 'progress', 'progressbalk', 'progress bar', 'progress indicator', 'progress loader', 'status', 'steps', 'voortgangsbalk'] }, sidebar: 'componenten', previous: { title: 'Password Input', permalink: '/password-input' }, next: { title: 'Progress Circle', permalink: '/progress-circle' } },
    l = {},
    h = [
  ...
  8657: (e, t, n) => {
   ...
   const _ = (e) => {
    ...
    A = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p.V, { level: n, suffix: c && (0, l.jsx)(m.y, { state: c }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: s })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => m, BA: () => o, Ee: () => l, Q6: () => c, U: () => j, Yr: () => p, d: () => h, e9: () => i, fO: () => b, mA: () => s, ps: () => y, qU: () => k, s0: () => v, zP: () => g });
