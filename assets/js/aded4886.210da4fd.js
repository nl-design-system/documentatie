...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  84525: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => j, default: () => k, frontMatter: () => u, metadata: () => p, toc: () => v });
   var r = i(52676),
    t = i(40139),
    s = i(57716),
    a = i(46364),
   ...
   function w(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', (0, r.jsx)(a.j, { level: 1, conformanceLevel: 'Niveau A', children: 'WCAG-succescriterium 2.5.1 Aanwijzergebaren' }), '\n', (0, r.jsx)(n.h2, { id: 'in-het-kort', children: 'In het kort' }), '\n', (0, r.jsxs)('dl', { children: [(0, r.jsxs)('div', { class: 'dl__item', children: [(0, r.jsx)('dt', { class: 'dl__term', children: 'Doel' }), (0, r.jsx)('dd', { class: 'dl__definition', children: 'Laat gebruikers touchscreens bedienen met \xe9\xe9n vinger en eenvoudige gebaren.' })] }), (0, r.jsxs)('div', { class: 'dl__item', children: [(0, r.jsx)('dt', { class: 'dl__term', children: 'Wat te doen' }), (0, r.jsx)('dd', { class: 'dl__definition', children: 'Alle functies zijn ook met \xe9\xe9n aanwijzer te bedienen.' })] }), (0, r.jsxs)('div', { class: 'dl__item', children: [(0, r.jsx)('dt', { class: 'dl__term', children: 'Waarom het belangrijk is' }), (0, r.jsx)('dd', { class: 'dl__definition', children: 'Niet iedereen kan ingewikkelde gebaren uitvoeren.' })] })] }), '\n', (0, r.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, r.jsx)(g, {}), '\n', (0, r.jsx)(n.p, { children: 'Aanwijsgebaren zijn bijvoorbeeld:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: 'Het slepen van inhoud binnen bepaalde kaders.' }), '\n', (0, r.jsx)(n.li, { children: "Het swipen van foto's." }), '\n', (0, r.jsx)(n.li, { children: 'Het vergroten van een kaart met twee vingers.' }), '\n', (0, r.jsx)(n.li, { children: 'Een slider of carousel waar je doorheen kunt swipen.' }), '\n'] }), '\n', (0, r.jsx)(n.p, { children: 'Een simpele beweging is bijvoorbeeld de beweging van een vinger van het ene punt naar het andere (zoals swipen zonder specifieke).\nZodra er meerdere vingers nodig zijn is de beweging te complex. Ook al de route van het ene punt naar het andere gaat, maar via een ander punt of een specifieke route, dan is het te complex (zoals een swipe via een specifieke route).' }), '\n', (0, r.jsx)(n.p, { children: 'Zorg ervoor dat de gebruiker deze acties ook kan doen met \xe9\xe9n aanwijzer zoals een muis of een vinger zonder deze extra gebaren te hoeven maken.' }), '\n', (0, r.jsx)(n.p, { children: 'Je hoeft hierbij geen rekening te houden met de aanwijzergebaren in de software van de gebruiker. Een screenreader die een gebaar met 3 vingers vereist is niet de verantwoordelijkheid van de website.\nGebaren die niet anders kunnen zijn ook uitgezonderd. Denk bijvoorbeeld aan het zetten van een digitale handtekening.' }), '\n', (0, r.jsx)(n.h2, { id: 'hoe-te-testen', children: 'Hoe te testen' }), '\n', (0, r.jsx)(n.p, { children: 'Voor alle acties die met een aanwijzergebaar uit te voeren zijn, test of een van de volgende dingen klopt:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: 'Het gebaar is eenvoudig en kan met \xe9\xe9n aanwijzer uitgevoerd worden.' }), '\n', (0, r.jsx)(n.li, { children: 'Het gebaar is niet eenvoudig of heeft meerdere aanwijzers nodig, maar het kan ook eenvoudig en met \xe9\xe9n aanwijzer.' }), '\n'] }), '\n', (0, r.jsx)(n.h2, { id: 'tips', children: 'Tips' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: 'Als je twijfelt of je aanwijzergebaar niet te complex is. Bijvoorbeeld omdat het veel precisie vereist. Voeg dan voor de zekerheid een alternatief toe.' }), '\n'] }), '\n', (0, r.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, r.jsx)(d.ZP, {}), '\n', (0, r.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#pointer-gestures', children: (0, r.jsx)('span', { lang: 'en', children: '2.5.1 Pointer Gestures' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#pointer-gestures', children: '2.5.1 Aanwijzergebaren' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, r.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#pointer-gestures', children: (0, r.jsx)('span', { lang: 'en', children: 'Quick Reference 2.5.1 Pointer Gestures' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/pointer-gestures.html', children: (0, r.jsx)('span', { lang: 'en', children: 'Understanding SC 2.5.1 Pointer Gestures' }) }), '.'] }), '\n'] }), '\n', (0, r.jsx)(l.CY, { children: (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(o.ZP, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(c.ZP, {}) })] });
   }
   function k(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
  ...
  57716: (e, n, i) => {
   ...
   const a = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, s.jsx)(r.Z, { components: { ...o(i, t), ...d(a), ...l }, children: n });
    };
  },
  46364: (e, n, i) => {
   i.d(n, { j: () => a });
