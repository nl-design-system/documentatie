  ...
  15175(e, L, l) {
   ...
   function c({ lineNumber: e, syntax: L, textContent: l, trim: c }) {
    ...
    const { title: d, type: u } = (0, t.useContext)(r.x),
     m = (0, t.useId)();
    return (c && (i = i.trim()), (0, s.jsx)(n.f4, { theme: a, code: i, language: L || '', children: ({ style: L, tokens: l, getLineProps: n, getTokenProps: t }) => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', d ? ': ' : ' ', d] }), (0, s.jsx)(o.NG, { tabIndex: 0, role: d ? 'region' : void 0, 'aria-labelledby': m, style: L, children: l.map((L, l) => (0, s.jsxs)('span', { ...n({ line: L }), children: [e && (0, s.jsx)('span', { children: l + 1 }), L.map((e, L) => (0, s.jsx)('span', { ...t({ token: e }) }, L)), '\n'] }, l)) })] }) }));
   }
  },
  26292(e, L, l) {
   ...
   const i = (0, s.createContext)({}),
    d = ({ title: e, appearance: L, description: l, children: s, figure: d }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      m = d ? 'figure' : 'div',
      p = d ? 'figcaption' : 'div',
      h = 'string' == typeof l ? (0, c.jsx)(a.oz, { components: { a: t.N_ }, children: l }) : l;
  ...
  70348(e, L, l) {
   ...
   const a = ({ className: e, ...L }) => {
    ...
    s = ({ className: e, label: L, heading: l, headingLevel: a, headingApperance: s, ...c }) => {
     ...
     return (0, r.jsxs)('details', { className: i, ...c, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(n.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [l && (0, r.jsx)(t.D, { level: a, appearance: s, children: l }), L] })] }) }), (0, r.jsx)('div', { className: 'utrecht-accordion__panel', children: c.children })] });
    };
  },
  80731(e, L, l) {
   l.d(L, { H: () => b });
   var o = l(15175),
    ...
    h = l(70348),
    x = l(86070);
   const g = ({ children: e }) => (0, x.jsx)(n.ui, { className: 'nlds-canvas__example-surface', children: (0, x.jsx)(n.yo, { className: (0, t.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, x.jsx)(n.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   g.displayName = 'ParagraphContainer';
   const v = ({ children: e }) => (0, x.jsx)(n.ui, { className: 'nlds-canvas__example-surface', children: (0, x.jsx)(n.yo, { className: (0, t.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   v.displayName = 'DocumentContainer';
   const y = ({ children: e }) => (0, x.jsx)(n.ui, { className: 'nlds-canvas__example-surface', children: e });
   y.displayName = 'SurfaceContainer';
   const b = globalThis.isAstro
    ? ({ children: e, language: L, className: l }) => {
       const o = 'function' == typeof e ? e() : e,
        ...
        r = p().highlight(n, p().languages[L], L);
       return (0, x.jsxs)('div', { className: (0, t.A)('ma-canvas-astro', l), children: [(0, x.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: n } }), (0, x.jsx)(h.n, { children: (0, x.jsx)(h.K, { label: 'Code', children: (0, x.jsx)('pre', { className: 'language-html nl-code-block', children: (0, x.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
    : ({ code: e, copy: L = !0, defaultExpandedCode: l = !1, displayCode: m = !0, children: p, container: h = 'document', language: b, designTokens: j }) => {
       ...
       return (
        ...
        (0, x.jsxs)('div', {
         ...
         children: [
          k && (0, x.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, x.jsx)('div', { className: 'voorbeeld-theme', style: j, children: (0, x.jsx)(z, { children: (0, x.jsx)(n.v$, { children: k }) }) }) }),
          m &&
           (0, x.jsx)('div', {
            className: (0, t.A)('nlds-canvas__toolbar'),
            children: (0, x.jsx)(n.$n, {
