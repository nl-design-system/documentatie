 ...
 [73512],
 {
   ...
   function X(e) {
    ...
    return (0, o.jsxs)(o.Fragment, {
     children: [
      ...
      '\n',
      (0, o.jsx)(D.$9, { component: U, headingLevel: 2 }),
      '\n',
  ...
  45282(e, n, t) {
   ...
   const s = ({ children: e, ...n }) => {
    ...
    i = ({ className: e, ...n }) => (0, o.jsx)(s, { className: (0, r.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  46072(e, n, t) {
   'use strict';
   t.d(n, { NO: () => s, pI: () => i });
  ...
  85825(e, n, t) {
   ...
   const g = ({ children: e }) => (0, a.jsx)('ul', { className: 'task-list', children: e }),
    j = ({ checked: e, children: n, title: t, description: r, headingLevel: s = 3 }) => (0, a.jsxs)('li', { className: (0, o.A)('task-list-item'), children: [(0, a.jsxs)('div', { className: (0, o.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, a.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, a.jsx)(p.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, a.jsxs)('div', { children: [t ? (0, a.jsx)(m.DZ, { appearance: 'utrecht-heading-3', level: s, children: t }) : null, r, n] })] });
   var w = t(33062);
   const y = ({ component: e, headingLevel: n }) => {
     const t = e && e.projects.filter((e) => w.f4.includes(e.id)),
      s = t && w.f4.map((e) => t.find((n) => n.id === e)).filter(Boolean);
     return e && (0, a.jsx)(r.If, { sections: s.map((t) => ({ className: (0, o.A)('definition-of-done', t && `definition-of-done--${(0, w.fX)(t.title)}`), headingLevel: n, expanded: !1, label: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', body: t && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(g, { children: t.tasks.map(({ checked: e, name: t, id: r }) => (0, a.jsx)(j, { headingLevel: n + 1, checked: e, title: t, description: (0, w.qZ)(r) }, r)) }), (0, a.jsx)(r.fz, { children: (0, a.jsxs)(r.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            i.Zp,
            {
             ...
             children: (0, a.jsxs)(i.Wu, {
              children: [
               ...
               c.length > 0 && (0, a.jsx)(a.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, a.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, a.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    k = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(r.DZ, { level: n, children: 'Help om deze component te verbeteren' }), (0, a.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, a.jsxs)(r.Xy, { children: [o ? (0, a.jsxs)(r.Er, { children: ['Vul de ', (0, a.jsx)(r.N_, { href: o, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, a.jsxs)(r.Er, { children: [(0, a.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, a.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, a.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, a.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    v = ({ component: e, headingLevel: n, description: t }) => {
     const o = e && w.bo[e.relayStep];
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(u.p, { level: n, suffix: o && (0, a.jsx)(h.D, { state: o }), children: e.title }), (0, a.jsx)(r.fz, { lead: !0, children: t })] });
    };
  },
  90495(e, n, t) {
   'use strict';
