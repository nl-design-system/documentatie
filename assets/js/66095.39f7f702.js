...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [66095],
 {
  24785: (t, s, e) => {
   ...
   function m(t) {
    let s;
    return (s = t.disableParentContext ? ("function" == typeof t.components ? t.components(n) : t.components || n) : a(t.components)), i.createElement(o.Provider, { value: s }, t.children);
   }
  },
  41665: (t, s, e) => {
   var i, n, o, a;
   e.d(s, { $3: () => o, HY: () => m }),
    ...
    (function (t) {
     (t.DISCOURAGED = "Discouraged"), (t.TODO = "Help Wanted"), (t.UNKNOWN = "Unknown"), (t.COMMUNITY = "Community"), (t.NL_UNSTABLE = "Candidate"), (t.NL_STABLE = "Hall of fame");
    })(o || (o = {})),
    (function (t) {
   ...
   const m = [
    ...
    },
    {
     ...
     preview: "https://raw.githubusercontent.com/nl-design-system/documentatie/assets/componenten_overzicht_number-badge.svg",
    ...
    { id: "date-picker", name: "Date picker", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/35" },
    { id: "range", name: "Range", aliases: ["slider"], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/36", discussion: "https://github.com/orgs/nl-design-system/discussions/231" },
    {
     id: "button",
     name: "Button",
    ...
    { id: "progress", name: "Progress", aliases: ["progress-bar", "progress-indicator"], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "https://raw.githubusercontent.com/nl-design-system/documentatie/assets/component_progress.svg", backlog: "https://github.com/nl-design-system/backlog/issues/42" },
    ...
    { id: "page-header", name: "Page header", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/55" },
    { id: "page-footer", name: "Page footer", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/56" },
    {
     id: "checkbox",
     name: "Checkbox",
     aliases: [],
    ...
    },
    {
     ...
     aliases: ["modal"],
     state: o.UNKNOWN,
     communityDocs: [{ organisation: n.DEN_HAAG, type: a.UX, href: "https://github.com/nl-design-system/denhaag/tree/main/components/Modal" }],
     implementations: [
      { organisation: n.DEN_HAAG, type: i.CSS, implementation: "https://github.com/nl-design-system/denhaag/blob/main/components/Modal/src/index.scss", story: "https://nl-design-system.github.io/denhaag/?path=/story/css-feedback-modal--default-story" },
      { organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NLDS---Voorbeeld---Bibliotheek?type=design&node-id=5910-3096&" },
     ],
     preview: "",
    ...
    { id: "video", name: "Video", aliases: ["media-player"], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/69" },
    { id: "figure", name: "Figure", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/70", discussion: "https://github.com/orgs/nl-design-system/discussions/221" },
    { id: "file-input", name: "File input", aliases: ["file-upload"], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.DEN_HAAG, type: i.FIGMA, implementation: "https://www.figma.com/file/JpoY3waVoQGlLQzQXTL9nn/Design-System---Gemeente-Den-Haag?node-id=10817%3A61351" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/72" },
    {
     id: "blockquote",
     name: "Blockquote",
    ...
    { id: "skip-link", name: "Skip link", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NLDS---Voorbeeld---Bibliotheek?type=design&node-id=2217-10122" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/74", discussion: "https://github.com/orgs/nl-design-system/discussions/252" },
    { id: "spinner", name: "Spinner", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/75" },
    { id: "avatar", name: "Avatar", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NL-Design-System---Bibliotheek?type=design&node-id=423-455" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/83" },
    { id: "data-badge", name: "Data badge", aliases: ["text-badge", "tag", "chip"], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/94" },
    { id: "dot-badge", name: "Dot badge", aliases: ["dot-indicator"], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.DEN_HAAG, type: i.REACT, implementation: "https://github.com/nl-design-system/denhaag/tree/main/components/DotIndicator/src", story: "https://nl-design-system.github.io/denhaag/?path=/story/react-data-display-dot-indicator--indicator-on-rectangle" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/98" },
    { id: "card-as-link", name: "Card as link", aliases: ["link-card"], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/101" },
    {
     id: "accordion",
     name: "Accordion",
     aliases: [],
    ...
    { id: "form-field-error-message", name: "Form field error message", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NLDS---Voorbeeld---Bibliotheek?type=design&node-id=851-939" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/122", discussion: "https://github.com/orgs/nl-design-system/discussions/228" },
    { id: "fieldset", name: "Fieldset", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.UTRECHT, type: i.CSS, implementation: "https://github.com/nl-design-system/utrecht/tree/main/components/form-fieldset/css", story: "https://nl-design-system.github.io/utrecht/storybook/?path=/docs/css-form-fieldset--default-story", storyTemplate: "@utrecht/components/form-fieldset/css/story-template.jsx", package: "@utrecht/component-library-css", designTokenPrefixes: ["utrecht.form-fieldset"] }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/124" },
    { id: "number-input", name: "Number input", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/125", discussion: "https://github.com/orgs/nl-design-system/discussions/235" },
    { id: "rich-text-content", name: "Rich text content", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/127" },
    { id: "checkbox-group", name: "Checkbox group", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NL-Design-System---Bibliotheek?type=design&node-id=954-2226" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/128", discussion: "https://github.com/orgs/nl-design-system/discussions/223" },
    { id: "radio-group", name: "Radio group", aliases: ["radio-button-group"], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NLDS---Voorbeeld---Bibliotheek?type=design&node-id=954-1910" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/129", discussion: "https://github.com/orgs/nl-design-system/discussions/222" },
    { id: "character-count", name: "Character count", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/130" },
    { id: "password-input", name: "Password input", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/133" },
    {
     id: "strong",
     name: "Strong",
    ...
    { id: "progress-list", name: "Progress list", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.DEN_HAAG, type: i.HTML, implementation: "https://github.com/nl-design-system/utrecht/tree/main/components/emphasis/html", story: "https://nl-design-system.github.io/denhaag/?path=/docs/react-process-steps-status--docs" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/150", discussion: "https://github.com/orgs/nl-design-system/discussions/250" },
    { id: "button-group", name: "Button group", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NLDS---Voorbeeld---Bibliotheek?type=design&node-id=4626-10492" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/153", discussion: "https://github.com/orgs/nl-design-system/discussions/234" },
    { id: "notification-banner", name: "Notification banner", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/169" },
    { id: "toggletip", name: "Toggletip", aliases: ["tooltip"], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/170" },
    { id: "form-field-option-label", name: "Form field option label", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NL-Design-System---Bibliotheek?type=design&node-id=1031-3472" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/171", discussion: "https://github.com/orgs/nl-design-system/discussions/226" },
    { id: "form-field-checkbox-option", name: "Form field checkbox option", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NL-Design-System---Bibliotheek?type=design&node-id=1031-2917" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/172" },
    { id: "form-field-radio-option", name: "Form field radio option", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NL-Design-System---Bibliotheek?type=design&node-id=1039-2941" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/173" },
    { id: "form-field-description", name: "Form field description", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NL-Design-System---Bibliotheek?type=design&node-id=851-924" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/174", discussion: "https://github.com/orgs/nl-design-system/discussions/227" },
    { id: "invalid-form-alert", name: "Invalid form alert", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NL-Design-System---Bibliotheek?type=design&node-id=1300-5679" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/175" },
    { id: "form-field", name: "Form field", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NL-Design-System---Bibliotheek?type=design&node-id=958-1925" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/176" },
    ...
    { id: "text-input-group", name: "Text input group", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/178", discussion: "https://github.com/orgs/nl-design-system/discussions/225" },
    { id: "form-field-partial", name: "Form field partial", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/179" },
    { id: "form-field-partial-label", name: "Form field partial label", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/180" },
    { id: "non-modal-dialog", name: "Non modal dialog", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/181" },
    { id: "alert-dialog", name: "Alert dialog", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/182" },
    { id: "summary-list", name: "Summary list", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.NLDS, type: i.FIGMA, implementation: "https://www.figma.com/file/shhwGcqPLi2CapK0P1zz8O/NL-Design-System---Bibliotheek?type=design&node-id=1238-4478" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/185", discussion: "https://github.com/orgs/nl-design-system/discussions/215" },
    { id: "legend", name: "Legend", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/186" },
    { id: "date-input", name: "Date input", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/188" },
    { id: "date-input-group", name: "Date input group", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/189" },
    { id: "calendar", name: "Calendar", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.UTRECHT, type: i.REACT, implementation: "https://nl-design-system.github.io/utrecht/storybook-react/?path=/docs/react-calendar--docs" }], preview: "", backlog: "https://github.com/nl-design-system/backlog/issues/199" },
    {
     id: "image",
     name: "Image",
     aliases: [],
     ...
     communityDocs: [],
     implementations: [
      { organisation: n.UTRECHT, type: i.CSS, implementation: "https://nl-design-system.github.io/utrecht/storybook-css/?path=/docs/css-img--docs" },
      { organisation: n.UTRECHT, type: i.REACT, implementation: "https://nl-design-system.github.io/utrecht/storybook-react/?path=/docs/react-image--docs" },
      { organisation: n.UTRECHT, type: i.VUE, implementation: "https://nl-design-system.github.io/utrecht/storybook/?path=/docs/vue_vue-image--docs" },
     ],
     preview: "",
    ...
    },
    {
     ...
     communityDocs: [],
     implementations: [
      { organisation: n.UTRECHT, type: i.CSS, implementation: "https://nl-design-system.github.io/utrecht/storybook-css/index.html?path=/docs/css-alternate-lang-nav--docs" },
      { organisation: n.UTRECHT, type: i.REACT, implementation: "https://nl-design-system.github.io/utrecht/storybook-react/index.html?path=/docs/react-alternate-lang-nav--docs" },
     ],
     preview: "",
     backlog: "https://github.com/nl-design-system/backlog/issues/243",
    },
    { id: "case-card", name: "Case card", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [{ organisation: n.DEN_HAAG, type: i.REACT, implementation: "https://nl-design-system.github.io/denhaag/?path=/docs/react-cards-case-card--docs" }], preview: "", backlog: void 0, discussion: "https://github.com/orgs/nl-design-system/discussions/245" },
    { id: "details", name: "Details", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: void 0, discussion: "https://github.com/orgs/nl-design-system/discussions/218" },
    { id: "drawer", name: "Drawer", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: void 0, discussion: "https://github.com/orgs/nl-design-system/discussions/238" },
    { id: "definition-list", name: "Definition list", aliases: [], state: o.UNKNOWN, communityDocs: [], implementations: [], preview: "", backlog: void 0, discussion: "https://github.com/orgs/nl-design-system/discussions/216" },
   ];
  },
 },
]);
