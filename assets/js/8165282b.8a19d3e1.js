...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [42843],
 {
         ...
         (0, m.jsx)(a._Q, {
          ...
          children: c.map((e, n) => {
           ...
           if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
            const r = o.pI.get(e);
            t = (0, m.jsx)(i.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${r.sc} ${r.nl.title}`, style: { lineHeight: 1 }, children: (0, m.jsx)(u.KE, { children: `WCAG ${e}` }) }, n);
           }
           return t;
          }),
         }),
  ...
  48262(e, n, t) {
   ...
   const w = ({ component: e, headingLevel: n }) => {
            ...
            ? (0, g.jsx)(
               d.Z,
               {
                ...
                description: (0, g.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, g.jsxs)(o.f, { children: [(0, g.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, g.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, g.jsxs)('div', {
                   children: [
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)('section', { children: [(0, g.jsxs)(i.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, g.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(l.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               s.Zp,
               {
                ...
                children: (0, g.jsxs)(s.Wu, {
                 children: [
                  ...
                  (h.length > 0 || c.length > 0) && (0, g.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  h.length > 0 &&
                   (0, g.jsx)(g.Fragment, {
                  ...
                  c.length > 0 && (0, g.jsx)(g.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)(g.Fragment, { children: [(0, g.jsxs)(r.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, g.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(l.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    A = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(r.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, g.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, g.jsxs)(r.Xy, { children: [i ? (0, g.jsxs)(r.Er, { children: ['Vul de ', (0, g.jsx)(r.N_, { href: i, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, g.jsxs)(r.Er, { children: [(0, g.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, g.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, g.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, g.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    y = ({ component: e, headingLevel: n, description: t }) => {
     const i = e && f.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(p.p, { level: n, suffix: i && (0, g.jsx)(h.D, { state: i }), children: e.title }), (0, g.jsx)(r.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(i) && (0, g.jsx)(b.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    T = ({ component: e }) => {
     const n = (e && x[e.title]) || [];
   ...
   var u = function (e) {
    ...
    m =
     ...
     (0, l.forwardRef)(function (e, n) {
      ...
      return (0, o.jsxs)('button', c(c({ ref: n, type: w, className: (0, a.$)('nl-button', r, { 'nl-button--pressed': x, 'nl-button--busy': v, 'nl-button--disabled': j || f, 'nl-button--primary': 'primary' === h, 'nl-button--secondary': 'secondary' === h, 'nl-button--subtle': 'subtle' === h, 'nl-button--positive': g(h) && 'positive' === p, 'nl-button--negative': g(h) && 'negative' === p, 'nl-button--icon-only': d }), 'aria-pressed': A ? String(Boolean(x)) : void 0, 'aria-disabled': j || v ? 'true' : void 0, disabled: f }, y), {}, { children: [m && (0, o.jsx)('span', { className: 'nl-button__icon-start', children: m }), k && (0, o.jsx)('span', { className: 'nl-button__label', children: k }), R ? (0, o.jsx)('span', { className: d ? 'nl-button__label' : '', children: t }) : t, u && (0, o.jsx)('span', { className: 'nl-button__icon-end', children: u })] }));
     }));
  ...
  74814(e, n, t) {
   (t.r(n), t.d(n, { assets: () => M, component: () => $, contentTitle: () => O, default: () => X, description: () => V, frontMatter: () => B, issueNumber: () => Z, metadata: () => r, title: () => E, toc: () => U }));
   ...
   function K(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, i.jsx)(_.Fc, { component: $, headingLevel: 1, description: V }), '\n', (0, i.jsx)(n.h2, { id: 'checklist-voor-toegankelijkheid', children: 'Checklist voor toegankelijkheid' }), '\n', (0, i.jsx)(d.Ay, {}), '\n', (0, i.jsx)(n.h3, { id: 'acceptatiecriteria-bij-gebruik', children: 'Acceptatiecriteria bij gebruik' }), '\n', (0, i.jsx)(s.Ay, {}), '\n', (0, i.jsx)(P.b, { headingLevel: '4', children: I.map(({ component: e, ...n }) => (0, i.jsx)(P.e, { ...n, children: (0, i.jsx)(e, {}) })) }), '\n', (0, i.jsx)(n.h3, { id: 'acceptatiecriteria-van-de-component', children: 'Acceptatiecriteria van de component' }), '\n', (0, i.jsx)(l.Ay, {}), '\n', (0, i.jsx)(P.b, { headingLevel: '4', children: H.map(({ component: e, ...n }) => (0, i.jsx)(P.e, { ...n, children: (0, i.jsx)(e, {}) })) }), '\n', (0, i.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, i.jsx)(_.VK, { component: $, headingLevel: 3 }), '\n', (0, i.jsx)(_.$9, { component: $, headingLevel: 2 }), '\n', (0, i.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, i.jsx)(_.mu, { component: $, headingLevel: 3 }), '\n', (0, i.jsx)(_.K_, { component: $ })] });
   }
   function X(e = {}) {
    const { wrapper: n } = { ...(0, o.R)(), ...e.components };
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => i, KF: () => g, mJ: () => p, VZ: () => A, cR: () => k, Pv: () => j, qZ: () => a, kD: () => b, QQ: () => T, B2: () => m, Pc: () => s, f4: () => l, GT: () => w, fX: () => o, eQ: () => v, B_: () => x, o_: () => f });
