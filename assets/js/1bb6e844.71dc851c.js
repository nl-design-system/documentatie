 ...
 [35135],
 {
  10706: (e, n, i) => {
   ...
   function g(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.p, { children: 'Acties die werken met sleepbewegingen, waarbij de aanwijzer ingedrukt moet blijven terwijl je van de ene plek naar de andere plek sleept, hebben ook een manier om de handeling zonder sleepbeweging uit te voeren.' }), '\n', (0, t.jsx)(n.p, { children: 'Er is een uitzondering voor als de sleepbeweging essentieel is.' })] });
   }
   function h(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
    return n ? (0, t.jsx)(n, { ...e, children: (0, t.jsx)(g, { ...e }) }) : g(e);
   }
   const p = { title: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.7 Sleepbewegingen', pagination_label: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', description: 'Acties die werken met sleepbewegingen, waarbij de aanwijzer ingedrukt moet blijven terwijl je van de ene plek naar de andere plek sleept, hebben ook een manier om de handeling zonder sleepbeweging uit te voeren.', slug: '2.5.7', keywords: ['WCAG', 'AA', 'bedienbaar', 'input modaliteiten', 'operable', 'input modalities', 'dragging movements'] },
    u = void 0,
  ...
  57716: (e, n, i) => {
   ...
   const l = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, s.jsx)(t.Z, { components: { ...o(i, r), ...d(l), ...a }, children: n });
    };
  },
  46364: (e, n, i) => {
   i.d(n, { j: () => l });
