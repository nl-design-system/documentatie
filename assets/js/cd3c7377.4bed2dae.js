 ...
 [28568],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    l = n(83386),
    a = n(86070);
   const d = { figma: (0, a.jsx)(i.A, {}), github: (0, a.jsx)(o.A, {}), npm: (0, a.jsx)(s.A, {}), storybook: (0, a.jsx)(c.A, {}) },
    u = ({ brand: e }) => (0, a.jsx)(r.In, { children: d[e] || (0, a.jsx)(l.A, {}) });
  },
  17045(e, t, n) {
   'use strict';
   n.d(t, { Ay: () => c, RM: () => o });
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => h, mJ: () => g, VZ: () => x, cR: () => A, Pv: () => j, qZ: () => s, kD: () => v, B2: () => m, Pc: () => l, f4: () => c, GT: () => b, fX: () => o, eQ: () => y, B_: () => f, o_: () => w, Rc: () => k });
      ...
      const r = e.tasks
       ...
       .map(({ name: r, id: i, value: o }) => {
        const s = /^(.+) URL/.exec(r)[1],
         c = 'Storybook' === s ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${s}`;
  ...
  45282(e, t, n) {
   ...
   const o = ({ children: e, ...t }) => {
     ...
     return ('https://nldesignsystem.nl' === c.origin ? ((c.pathname = c.pathname.endsWith('/') ? c.pathname : `${c.pathname}/`), (s = c.toString().replace('https://nldesignsystem.nl', ''))) : ((o.target = '_blank'), (o.rel = 'noopener noreferrer')), (0, i.jsx)('a', { href: s, ...o, children: e }));
    },
   ...
   const u = ({ title: e, sc: t, component: n, tags: a }) => {
    ...
    h = ({ items: e, headingLevel: t }) => {
     const n = e.reduce(
      ...
      [r, i] = (0, l.useState)(Array.from(n.values())),
      s = (e) => r.includes(e),
      c = (0, l.useId)(),
  ...
  63666(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => C, component: () => z, contentTitle: () => x, default: () => D, description: () => R, frontMatter: () => A, issueNumber: () => G, metadata: () => r, title: () => T, toc: () => W }));
   ...
   function a(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(t.p, { children: ['Koppel de Form Field Description met ', (0, i.jsx)(t.code, { children: 'aria-describedby' }), ' aan het bijbehorende element voor formulierinvoer:'] }), '\n', (0, i.jsx)(t.pre, { children: (0, i.jsx)(t.code, { className: 'language-html', children: '<label for="name">Naam</label>\n<p id="description-name">Vul je voornaam en achternaam in.</p>\n<input id="name" aria-describedby="description-name" autocomplete="name" />\n' }) }), '\n', (0, i.jsx)(t.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, i.jsxs)(t.ul, { children: ['\n', (0, i.jsx)(t.li, { children: (0, i.jsx)(t.a, { href: '/richtlijnen/formulieren/descriptions/', children: 'Toegankelijke instructies en beschrijvingen' }) }), '\n', (0, i.jsx)(t.li, { children: (0, i.jsx)(t.a, { href: '/richtlijnen/formulieren/', children: 'Toegankelijke formulieren' }) }), '\n'] })] });
   }
   function d(e = {}) {
   ...
   function u(e) {
    const t = { a: 'a', code: 'code', li: 'li', p: 'p', pre: 'pre', ul: 'ul', ...(0, o.R)(), ...e.components };
    return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(t.p, { children: ['De Form Field Description kan met ', (0, i.jsx)(t.code, { children: 'aria-describedby' }), ' aan het bijbehorende element voor formulierinvoer worden gekoppeld.'] }), '\n', (0, i.jsx)(t.pre, { children: (0, i.jsx)(t.code, { className: 'language-html', children: '<label for="name">Naam</label>\n<p id="description-name">Vul je voornaam en achternaam in.</p>\n<input id="name" aria-describedby="description-name" autocomplete="name" />\n' }) }), '\n', (0, i.jsx)(t.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, i.jsxs)(t.ul, { children: ['\n', (0, i.jsx)(t.li, { children: (0, i.jsx)(t.a, { href: '/richtlijnen/formulieren/descriptions/', children: 'Toegankelijke descriptions bij formuliervelden' }) }), '\n', (0, i.jsx)(t.li, { children: (0, i.jsx)(t.a, { href: '/richtlijnen/formulieren/', children: 'Toegankelijke formulieren' }) }), '\n'] })] });
   }
   function h(e = {}) {
    const { wrapper: t } = { ...(0, o.R)(), ...e.components };
   ...
   function m(e) {
    const t = { a: 'a', code: 'code', li: 'li', p: 'p', pre: 'pre', ul: 'ul', ...(0, o.R)(), ...e.components };
    return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(t.p, { children: 'Zorg ervoor dat instructies die nodig zijn om te begrijpen wat er van de bezoeker verwacht wordt op een logische plek staan en gekoppeld zijn aan het element voor formulierinvoer.' }), '\n', (0, i.jsx)(t.p, { children: 'De meest gebruiksvriendelijke plek voor instructies is tussen het label en het element voor formulierinvoer. Als instructies er \xf3nder staan, worden ze mogelijk bedekt door de autocomplete-functionaliteit van de browser.' }), '\n', (0, i.jsxs)(t.p, { children: ['Een screenreader schakelt in een formulierveld over van leesmodus naar focusmodus. Als een bezoeker daarna instructies t\xfassen de velden wil lezen, moet diegene weer handmatig terugschakelen naar de leesmodus. Koppel instructies daarom ook aan het element voor formulierinvoer met ', (0, i.jsx)(t.code, { children: 'aria-describedby' }), '. Op die manier wordt de beschrijving voorgelezen wanneer de toetsenbordfocus op dat element staat.'] }), '\n', (0, i.jsx)(t.p, { children: 'Voorbeeld:' }), '\n', (0, i.jsx)(t.pre, { children: (0, i.jsx)(t.code, { className: 'language-html', children: '<label for="name">Naam</label>\n<p id="description-name">Vul je voornaam en achternaam in.</p>\n<input id="name" aria-describedby="description-name" autocomplete="name" />\n' }) }), '\n', (0, i.jsx)(t.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, i.jsxs)(t.ul, { children: ['\n', (0, i.jsx)(t.li, { children: (0, i.jsx)(t.a, { href: '/richtlijnen/formulieren/descriptions/', children: 'Toegankelijke instructies en beschrijvingen' }) }), '\n', (0, i.jsx)(t.li, { children: (0, i.jsx)(t.a, { href: '/richtlijnen/formulieren/', children: 'Toegankelijke formulieren' }) }), '\n'] })] });
   }
   function p(e = {}) {
    const { wrapper: t } = { ...(0, o.R)(), ...e.components };
   ...
   var g = n(55552),
    ...
    b = n(59840),
    k = n(85825);
   const A = { title: 'Form Field Description', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Field Description', pagination_label: 'Form Field Description', description: 'Toont ondersteunende tekst en biedt extra context over de in te vullen informatie.', slug: '/form-field-description', keywords: ['beschrijving', 'description', 'form', 'form field', 'form field description', 'form field help text', 'form field hint', 'formulier', 'formulierelement', 'helper', 'help text', 'hint', 'hint label', 'hint tekst', 'hint text'] },
    x = void 0,
    C = {},
    T = 'Form Field Description',
    R = 'Toont ondersteunende tekst en biedt extra context over de in te vullen informatie.',
    G = 174,
    z = s.find((e) => e.number === G),
    W = [{ value: 'Acceptatiecriteria bij gebruik', id: 'acceptatiecriteria-bij-gebruik', level: 3 }, ...l.RM, { value: 'Acceptatiecriteria van de component', id: 'acceptatiecriteria-van-de-component', level: 3 }, ...c.RM, { value: 'Definition of Done', id: 'definition-of-done', level: 2 }, { value: 'Community implementaties', id: 'community-implementaties', level: 2 }];
   function N(e) {
    ...
    return (0, i.jsxs)(i.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, i.jsx)(k.Fc, { component: z, headingLevel: 1, description: R }),
      '\n',
      ...
      (0, i.jsx)(b.b, {
       headingLevel: '4',
       items: [
        { title: 'De Form Field Description is gekoppeld aan het bijbehorende element voor formulierinvoer', sc: '1.3.1', status: '', component: (0, i.jsx)(d, {}), tags: ['developer'] },
        { title: 'De Form Field Description staat op een logische plek', sc: '1.3.2', status: '', component: (0, i.jsx)(p, {}), tags: ['designer', 'developer'] },
        { title: 'Instructies in de Form Field Description zijn op een inclusieve manier beschreven.', sc: '1.3.3', status: '', component: (0, i.jsx)(v.Ay, {}), tags: ['designer', 'contentmaker'] },
        { title: 'De tekst in de Form Field Description heeft een contrastratio van minimaal 4,5:1 met de achtergrondkleur.', sc: '1.4.3', status: '', component: (0, i.jsx)(w.Ay, {}), tags: ['designer'] },
        { title: 'Als je de tekst van de Form Field Description vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: (0, i.jsx)(f.Ay, {}), tags: ['developer'] },
        { title: 'De bezoeker kan de Form Field Description tot 400% vergroten zonder verlies van functionaliteit of informatie.', sc: '1.4.10', status: '', component: (0, i.jsx)(g.Ay, {}), tags: ['developer', 'designer'] },
        { title: 'Als de Form Field Description in een andere taal is dan de taal van de pagina, dan heeft het een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: (0, i.jsx)(y.Ay, {}), tags: ['developer'] },
       ],
      }),
      '\n',
      ...
      (0, i.jsx)(b.b, {
       headingLevel: '4',
       items: [
        { title: 'De Form Field Description kan aan een element voor formulierinvoer gekoppeld worden.', sc: '1.3.1', status: '', component: (0, i.jsx)(h, {}), tags: ['developer'] },
        { title: 'Tekst in de Form Field Description blijft leesbaar wanneer de tekstafstand vergroot wordt. ', sc: '1.4.12', status: '', component: (0, i.jsx)(j.Ay, {}), tags: ['developer'] },
       ],
      }),
      '\n',
  ...
  79889(e, t, n) {
   ...
   var h = (0, s.forwardRef)(function (e, t) {
    ...
    if (
     ...
     var m = r.value,
      p = (0, i.A)(r, a);
     return (0, o.jsx)('data', u(u({}, p), {}, { value: m, className: s, ref: t, children: n }));
    }
  ...
  85825(e, t, n) {
   ...
   const f = ({ component: e, headingLevel: t }) => {
         ...
         children: n
          ...
          .map((e) => {
           const n = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            u = e.tasks.filter(({ name: e, value: t }) => l.has(e) && URL.canParse(t) && 'https:' === new URL(t).protocol);
           return (0, a.jsx)(
            s.Zp,
            {
             ...
             children: (0, a.jsxs)(s.Wu, {
              children: [
               ...
               (u.length > 0 || c.length > 0) && (0, a.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               u.length > 0 &&
                (0, a.jsx)(a.Fragment, {
               ...
               c.length > 0 && (0, a.jsx)(a.Fragment, { children: c.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    b = ({ component: e, headingLevel: t, description: n }) => {
     const i = e && w.bo[e.relayStep];
  ...
  90495(e, t, n) {
   ...
   const s = ({ background: e, children: t, className: n, ...r }) => (0, o.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    l = ({ href: e, appearance: t, className: n, component: s = 'div', background: c, children: l }) => {
     const a = (e) => ('article' === s ? (0, o.jsx)('article', { ...e }) : 'section' === s ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(a, { className: (0, i.A)('cardgroup__card', c && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: l });
  ...
  91391(e, t, n) {
   ...
   const o = [];
   function s(e) {
    const t = { li: 'li', p: 'p', ul: 'ul', ...(0, i.R)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(t.p, { children: 'Geef instructies op een inclusieve manier. De instructies kunnen begrijpen moet niet afhankelijk zijn van eigenschappen die sommige gebruikers niet ervaren.' }), '\n', (0, r.jsx)(t.p, { children: 'Het gaat hierbij om eigenschappen zoals vorm, kleur, afmeting, locatie op het scherm, richting, of geluid. Bijvoorbeeld:' }), '\n', (0, r.jsxs)(t.ul, { children: ['\n', (0, r.jsx)(t.li, { children: '"De fouten zijn met een rode rand gemarkeerd". Niet iedereen kan zien, niet iedereen kan de kleur rood van zwart onderscheiden.' }), '\n', (0, r.jsx)(t.li, { children: '"Klik op de meest rechtse knop". Niet iedereen kan zien, sommige gebruikers zijn ingezoomd waardoor de knoppen op twee regels staan.' }), '\n', (0, r.jsx)(t.li, { children: '"Als je het geluid hoort, heb je nog 5 minuten." Niet iedereen kan dat geluid goed horen of heeft het geluid aanstaan.' }), '\n'] })] });
   }
   function c(e = {}) {
    const { wrapper: t } = { ...(0, i.R)(), ...e.components };
    return t ? (0, r.jsx)(t, { ...e, children: (0, r.jsx)(s, { ...e }) }) : s(e);
