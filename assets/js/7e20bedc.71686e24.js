 ...
 [7177],
 {
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    u = n(83386),
    l = n(86070);
   const h = { figma: (0, l.jsx)(s.A, {}), github: (0, l.jsx)(i.A, {}), npm: (0, l.jsx)(o.A, {}), storybook: (0, l.jsx)(a.A, {}) },
            ...
            j.Zp,
            {
             ...
             children: (0, l.jsxs)(j.Wu, {
              children: [
               ...
               (o.length > 0 || s.length > 0) && (0, l.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               o.length > 0 &&
                (0, l.jsx)(l.Fragment, {
               ...
               s.length > 0 && (0, l.jsx)(l.Fragment, { children: s.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => h, B_: () => p, GT: () => v, KF: () => l, Pc: () => o, Pv: () => y, Rc: () => k, bo: () => r, eQ: () => g, f4: () => i, fX: () => c, kD: () => b, mJ: () => j, o_: () => m, qZ: () => s });
   ...
   const u = (e) => {
    ...
    d = (e) => {
     const t = / URL \(([^)]+)\)/;
     return u(a(e.tasks.filter(({ name: e, value: n }) => '' !== n && t.test(e)).map(({ name: e }) => t.exec(e)?.[1])));
    },
    j = (e) => u(a(e.projects.flatMap((e) => d(e)))),
    y = (e) => {
     const t = d(e),
      n = ((e) => {
