 ...
 [64796],
 {
  ...
  94091: (e, n, r) => {
   ...
   const v = (e) => {
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (D = await a.ZP.format(N, { parser: y, plugins: [l.Z, o.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(D);
     })();
    }, [N]);
    const A = (0, c.useId)();
    let B = c.Fragment;
