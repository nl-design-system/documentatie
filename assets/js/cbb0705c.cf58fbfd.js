 ...
 [7971],
 {
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    l = n(83386),
    u = n(86070);
   const h = { figma: (0, u.jsx)(c.A, {}), github: (0, u.jsx)(i.A, {}), npm: (0, u.jsx)(s.A, {}), storybook: (0, u.jsx)(a.A, {}) },
   ...
   const k = ({ children: e }) => (0, u.jsx)('ul', { className: 'task-list', children: e }),
    f = ({ checked: e, children: t, title: n, description: r, headingLevel: c = 3 }) => (0, u.jsxs)('li', { className: (0, o.A)('task-list-item'), children: [(0, u.jsxs)('div', { className: (0, o.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, u.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, u.jsx)(v.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.DZ, { appearance: 'utrecht-heading-3', level: c, children: n }), r, t] })] });
   var x = n(75916);
   const w = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: c.map((n) => ({ className: (0, o.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(k, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(f, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            j.Zp,
            {
             ...
             children: (0, u.jsxs)(j.Wu, {
              children: [
               ...
               c.length > 0 && (0, u.jsx)(u.Fragment, { children: c.map(({ frameworkName: e, tasks: n }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: t + 2, children: [o, ' in ', e] }), (0, u.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, u.jsx)(d, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    N = ({ component: e, headingLevel: t, description: n }) => {
     const o = e && x.bo[e.relayStep];
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(g.p, { level: t, suffix: o && (0, u.jsx)(p.D, { state: o }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  62943: (e, t, n) => {
   'use strict';
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => g, GT: () => k, KF: () => h, Pc: () => s, Pv: () => m, Rc: () => f, bo: () => r, eQ: () => b, f4: () => i, fX: () => o, kD: () => v, mJ: () => y, o_: () => p, qZ: () => c });
