 ...
 [20360],
 {
  ...
  43599: (e, n, t) => {
   ...
   const g = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (z = await d.ZP.format(N, { parser: f, plugins: [s.Z, a.ZP, c.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(z);
     })();
    }, [N]);
    const S = (0, u.useId)();
    let P = u.Fragment;
