/*! For license information please see d5f36106.f12ec53c.js.LICENSE.txt */
'use strict';
 ...
 [38662],
 {
  ...
  50172(e, n, a) {
   ...
   const u = ({ level: e = 2, children: n, ...a }) => {
    ...
    c = (0, o.forwardRef)(({ heading: e, headingLevel: n = 2, subheading: a, description: r, metadata: i, image: s, href: o, target: d, linkLabel: c, title: m, className: h, children: p, ...f }, b) => (0, t.jsxs)('div', { className: g('rhc-card', 'rhc-card--default', h), ref: b, ...f, children: [s && (0, t.jsx)('div', { className: 'rhc-card__image', children: s }), (0, t.jsxs)('div', { className: 'rhc-card__content', children: [(0, t.jsx)(u, { className: 'rhc-card__heading', level: n, children: o ? (0, t.jsx)(l, { className: 'rhc-card__link', href: o, target: d, title: m, children: e }) : e }), a && (0, t.jsx)('p', { className: 'rhc-card__subheading', children: a }), r && (0, t.jsx)('p', { className: 'rhc-card__description', children: r }), i && (0, t.jsx)('p', { className: 'rhc-card__metadata', children: i }), p] }), c && (0, t.jsx)('div', { className: 'rhc-card__footer', children: (0, t.jsx)('div', { className: 'rhc-card__link', 'data-testid': 'rhc-card__link', children: (0, t.jsx)(l, { href: o, target: d, title: m, children: c }) }) })] }));
   c.displayName = 'Card';
  },
  52264(e, n, a) {
   (a.r(n), a.d(n, { assets: () => g, component: () => h, contentTitle: () => d, default: () => b, description: () => c, frontMatter: () => o, issueNumber: () => m, metadata: () => t, title: () => u, toc: () => p }));
   const t = JSON.parse('{"id":"componenten/status-badge/index","title":"Status Badge","description":"Label dat informeert over een status en de aandacht trekt met een signaalkleur.","source":"@site/docs/componenten/status-badge/index.mdx","sourceDirName":"componenten/status-badge","slug":"/status-badge","permalink":"/status-badge","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/status-badge/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Status Badge","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Status Badge","pagination_label":"Status Badge","description":"Label dat informeert over een status en de aandacht trekt met een signaalkleur.","issue_number":202,"slug":"/status-badge","keywords":["alert badge","badge","chip","counter","label","pill","status","status badge","status label","status marker","notification badge","notification label","stamp","tag"]},"sidebar":"componenten","previous":{"title":"Spinner","permalink":"/spinner"},"next":{"title":"Strong","permalink":"/strong"}}');
   var r = a(86070),
    i = a(18439),
    s = a(79447),
    l = a(82024);
   const o = { title: 'Status Badge', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Status Badge', pagination_label: 'Status Badge', description: 'Label dat informeert over een status en de aandacht trekt met een signaalkleur.', issue_number: 202, slug: '/status-badge', keywords: ['alert badge', 'badge', 'chip', 'counter', 'label', 'pill', 'status', 'status badge', 'status label', 'status marker', 'notification badge', 'notification label', 'stamp', 'tag'] },
    d = void 0,
    g = {},
    u = 'Status Badge',
    c = 'Label dat informeert over een status en de aandacht trekt met een signaalkleur.',
    m = 202,
  ...
  63009(e, n, a) {
   ...
   var u = (0, l.forwardRef)(function (e, n) {
    var a = e.children,
     ...
     m = e.inlineBox,
     h = (0, r.A)(e, o);
    return (0, i.jsx)('a', g(g({ 'aria-current': d || void 0, 'aria-disabled': u, className: (0, s.$)('nl-link', (0, t.A)((0, t.A)((0, t.A)({}, 'nl-link--current', d), 'nl-link--disabled', u), 'nl-link--inline-box', m), l), href: u ? void 0 : c, role: u ? 'link' : void 0, ref: n, tabIndex: u ? 0 : void 0 }, h), {}, { children: a }));
   });
   u.displayName = 'Link';
  },
  70348(e, n, a) {
   ...
   const o = (0, r.forwardRef)(({ as: e, className: n, children: a, ...r }, i) => {
    ...
    d = ({ className: e, classNamePanel: n, label: a, heading: r, headingLevel: o, headingApperance: d, ...g }) => {
     ...
     return (0, l.jsxs)('details', { className: u, ...g, children: [(0, l.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, l.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, l.jsx)('span', { className: 'nl-button__icon-start', children: (0, l.jsx)(i.A, {}) }), (0, l.jsxs)('span', { className: 'nl-button__label', children: [r && (0, l.jsx)(s.D, { level: o, appearance: d, children: r }), a] })] }) }), (0, l.jsx)('div', { className: c, children: g.children })] });
    };
  },
  74172(e, n, a) {
   a.d(n, { A: () => s });
  ...
  82024(e, n, a) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
               ...
               d.Z,
               {
                ...
                description: (0, g.jsxs)('div', {
                 ...
                 children: [
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: a }) => (0, g.jsxs)('section', { children: [(0, g.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [s, ' in ', e] }), (0, g.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, g.jsx)(l.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               o.Zp,
               {
                ...
                children: (0, g.jsxs)(o.Wu, {
                 children: [
                  ...
                  c.length > 0 && (0, g.jsx)(g.Fragment, { children: c.map(({ frameworkName: e, tasks: a }) => (0, g.jsxs)(g.Fragment, { children: [(0, g.jsxs)(t.DZ, { level: n + 2, children: [s, ' in ', e] }), (0, g.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, g.jsx)(l.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    N = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(m.p, { level: n, suffix: r && (0, g.jsx)(c.D, { state: r }), children: e.title }), (0, g.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(r) && (0, g.jsx)(x.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    w = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
