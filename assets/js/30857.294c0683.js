(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [30857],
 {
  45268(e, n, t) {
   ...
   t.d(n, { oz: () => Ir });
   var r = {};
   (t.r(r), t.d(r, { boolean: () => x, booleanish: () => v, commaOrSpaceSeparated: () => C, commaSeparated: () => S, number: () => b, overloadedBoolean: () => k, spaceSeparated: () => w }));
   var o = {};
   function i() {}
   function l() {}
   (t.r(o), t.d(o, { attentionMarkers: () => rt, contentInitial: () => Xn, disable: () => ot, document: () => Jn, flow: () => Gn, flowInitial: () => Zn, insideSpan: () => tt, string: () => et, text: () => nt }));
   const a = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
    s = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
    u = {};
   function c(e, n) {
    return ((n || u).jsx ? s : a).test(e);
   }
   const f = /[ \t\n\f\r]/g;
   function p(e) {
    return '' === e.replace(f, '');
   ...
   const W = { classId: 'classID', dataType: 'datatype', itemId: 'itemID', strokeDashArray: 'strokeDasharray', strokeDashOffset: 'strokeDashoffset', strokeLineCap: 'strokeLinecap', strokeLineJoin: 'strokeLinejoin', strokeMiterLimit: 'strokeMiterlimit', typeOf: 'typeof', xLinkActuate: 'xlinkActuate', xLinkArcRole: 'xlinkArcrole', xLinkHref: 'xlinkHref', xLinkRole: 'xlinkRole', xLinkShow: 'xlinkShow', xLinkTitle: 'xlinkTitle', xLinkType: 'xlinkType', xmlnsXLink: 'xmlnsXlink' };
   var K = t(82059);
   const Y = K.default || K,
    Q = X('end'),
    J = X('start');
   ...
   const re = {}.hasOwnProperty,
    ...
    se = new Set(['td', 'th']),
    ue = 'https://github.com/syntax-tree/hast-util-to-jsx-runtime';
   function ce(e, n) {
   ...
   function me(e, n, t) {
    ...
    if (!(null == t || ('number' == typeof t && Number.isNaN(t)))) {
        ...
        : (function (e, n) {
           ...
           try {
            ...
            if (!e.ignoreInvalidStyle) {
             ...
             throw ((t.file = e.filePath || void 0), (t.url = ue + '#cannot-parse-style-attribute'), t);
            }
           }
           return t;
           function r(e, n) {
     ...
     return ['react' === e.elementAttributeNameCase && r.space ? W[r.property] || r.property : r.attribute, t];
    }
   }
   function ge(e, n, t) {
    let r;
    if (t)
     if (n.includes('.')) {
      ...
      let t,
       o = -1;
      for (; ++o < e.length; ) {
       const n = c(e[o]) ? { type: 'Identifier', name: e[o] } : { type: 'Literal', value: e[o] };
       t = t ? { type: 'MemberExpression', object: t, property: n, computed: Boolean(o && 'Literal' === n.type), optional: !1 } : n;
      }
      r = t;
     } else r = c(n) && !/^[a-z]/.test(n) ? { type: 'Identifier', name: n } : { type: 'Literal', value: n };
   ...
   function ye(e, n) {
    ...
    throw ((t.file = e.filePath || void 0), (t.url = ue + '#cannot-handle-mdx-estrees-without-createevaluater'), t);
   }
   function xe(e) {
   ...
   function Ce(e, n, t) {
    if (
     ...
     if ('children' in e) return Ee(e.children, n, t);
    }
   ...
   function Te(e) {
    ...
    for (; ++u < e.length; ) {
     ...
     if ('enter' === t[0]) t[1].contentType && (Object.assign(n, Ae(e, u)), (u = n[u]), (s = !0));
      ...
      r && ((t[1].end = Object.assign({}, e[r][1].start)), (l = e.slice(r, u)), l.unshift(t), Pe(e, r, u - r + 1, l));
     }
    }
    return !s;
   }
   ...
   function We(e, n, t, r) {
    ...
    let i = 0;
    return function (r) {
     if (Ve(r)) return (e.enter(t), l(r));
     return n(r);
    };
    function l(r) {
     return Ve(r) && i++ < o ? (e.consume(r), l) : (e.exit(t), n(r));
    }
   }
   const Ke = {
    tokenize: function (e) {
     const n = e.attempt(
      ...
      function (t) {
       ...
       return (e.enter('lineEnding'), e.consume(t), e.exit('lineEnding'), We(e, n, 'linePrefix'));
      },
      function (n) {
     ...
     function o(n) {
      return null === n ? (e.exit('chunkText'), e.exit('paragraph'), void e.consume(n)) : Ue(n) ? (e.consume(n), e.exit('chunkText'), r) : (e.consume(n), o);
     }
    },
   };
   const Ye = {
     tokenize: function (e) {
      ...
      function s(e) {
       if ((l++, n.containerState._closeFlow)) {
        ...
        return (Pe(n.events, i + 1, 0, n.events.slice(t)), (n.events.length = a), u(e));
       }
       return a(e);
      }
      function u(o) {
       ...
       return ((n.containerState = {}), e.check(Qe, c, f)(o));
      }
      function c(e) {
       return (r && x(), y(l), p(e));
      }
      ...
      function m(t) {
       return null === t ? (g(e.exit('chunkFlow'), !0), y(0), void e.consume(t)) : Ue(t) ? (e.consume(t), g(e.exit('chunkFlow')), (l = 0), (n.interrupt = void 0), a) : (e.consume(t), m);
      }
      function g(e, t) {
    ...
    Qe = {
     tokenize: function (e, n, t) {
      return We(e, e.attempt(this.parser.constructs.document, n, t), 'linePrefix', this.parser.constructs.disable.null.includes('codeIndented') ? void 0 : 4);
     },
    };
   const Je = {
    tokenize: function (e, n, t) {
     return function (n) {
      return Ve(n) ? We(e, r, 'linePrefix')(n) : r(n);
     };
     function r(e) {
      return null === e || Ue(e) ? n(e) : t(e);
     }
    },
    partial: !0,
   };
   const Xe = {
     tokenize: function (e, n) {
      ...
      function r(n) {
       return null === n ? o(n) : Ue(n) ? e.check(Ze, i, o)(n) : (e.consume(n), r);
      }
      function o(t) {
    ...
    Ze = {
     tokenize: function (e, n, t) {
      const r = this;
      return function (n) {
       return (e.exit('chunkContent'), e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), We(e, o, 'linePrefix'));
      };
      function o(o) {
       if (null === o || Ue(o)) return t(o);
   ...
   function sn(e, n, t) {
    ...
    const u = {
      consume: function (e) {
       Ue(e) ? (r.line++, (r.column = 1), (r.offset += -3 === e ? 2 : 1), k()) : -1 !== e && (r.column++, r.offset++);
     ...
     c = {
      ...
      write: function (e) {
       ...
       return (v(n, 0), (c.events = an(i, c.events, c)), c.events);
      },
     };
    let f,
    ...
    function v(e, n) {
     (e.resolveAll && !i.includes(e) && i.push(e), e.resolve && Pe(c.events, n, c.events.length - n, e.resolve(c.events.slice(n), c)), e.resolveTo && (c.events = e.resolveTo(c.events, c)));
    }
    function k() {
   ...
   const un = {
    ...
    tokenize: function (e, n, t) {
     ...
     function i(i) {
      return i === r ? (e.enter('thematicBreakSequence'), l(i)) : o >= 3 && (null === i || Ue(i)) ? (e.exit('thematicBreak'), n(i)) : t(i);
     }
     function l(n) {
      return n === r ? (e.consume(n), o++, l) : (e.exit('thematicBreakSequence'), Ve(n) ? We(e, i, 'whitespace')(n) : i(n));
     }
    },
   };
   const cn = {
     ...
     tokenize: function (e, n, t) {
      ...
      return function (n) {
       ...
       if ('listUnordered' === o ? !r.containerState.marker || n === r.containerState.marker : Ne(n)) {
        if ((r.containerState.type || ((r.containerState.type = o), e.enter(o, { _container: !0 })), 'listUnordered' === o)) return (e.enter('listItemPrefix'), 42 === n || 45 === n ? e.check(un, t, s)(n) : s(n));
      ...
      function s(n) {
       return (e.enter('listItemMarker'), e.consume(n), e.exit('listItemMarker'), (r.containerState.marker = r.containerState.marker || n), e.check(Je, r.interrupt ? t : u, e.attempt(fn, f, c)));
      }
      function u(e) {
       return ((r.containerState.initialBlankLine = !0), i++, f(e));
      }
      function c(n) {
       return Ve(n) ? (e.enter('listItemPrefixWhitespace'), e.consume(n), e.exit('listItemPrefixWhitespace'), f) : t(n);
      }
      function f(t) {
     ...
     continuation: {
      tokenize: function (e, n, t) {
       const r = this;
       return ((r.containerState._closeFlow = void 0), e.check(Je, o, i));
       function o(t) {
        return ((r.containerState.furtherBlankLines = r.containerState.furtherBlankLines || r.containerState.initialBlankLine), We(e, n, 'listItemIndent', r.containerState.size + 1)(t));
       }
       function i(t) {
        return r.containerState.furtherBlankLines || !Ve(t) ? ((r.containerState.furtherBlankLines = void 0), (r.containerState.initialBlankLine = void 0), l(t)) : ((r.containerState.furtherBlankLines = void 0), (r.containerState.initialBlankLine = void 0), e.attempt(pn, n, l)(t));
       }
       function l(o) {
        return ((r.containerState._closeFlow = !0), (r.interrupt = void 0), We(e, e.attempt(cn, n, t), 'linePrefix', r.parser.constructs.disable.null.includes('codeIndented') ? void 0 : 4)(o));
       }
      },
     },
     exit: function (e) {
     ...
     tokenize: function (e, n, t) {
      ...
      return We(
       ...
       function (e) {
        ...
        return !Ve(e) && o && 'listItemPrefixWhitespace' === o[1].type ? n(e) : t(e);
       },
   ...
   const dn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function o(t) {
      return Ve(t) ? (e.enter('blockQuotePrefixWhitespace'), e.consume(t), e.exit('blockQuotePrefixWhitespace'), e.exit('blockQuotePrefix'), n) : (e.exit('blockQuotePrefix'), n(t));
     }
    },
    continuation: {
     tokenize: function (e, n, t) {
      const r = this;
      return function (n) {
       if (Ve(n)) return We(e, o, 'linePrefix', r.parser.constructs.disable.null.includes('codeIndented') ? void 0 : 4)(n);
       return o(n);
      };
      function o(r) {
   ...
   function hn(e, n, t, r, o, i, l, a, s) {
    ...
    function p(n) {
     return 62 === n ? (e.exit('chunkString'), e.exit(a), f(n)) : null === n || 60 === n || Ue(n) ? t(n) : (e.consume(n), 92 === n ? d : p);
    }
    function d(n) {
     return 60 === n || 62 === n || 92 === n ? (e.consume(n), p) : p(n);
    }
    function h(o) {
     return c || (null !== o && 41 !== o && !He(o)) ? (c < u && 40 === o ? (e.consume(o), c++, h) : 41 === o ? (e.consume(o), c--, h) : null === o || 32 === o || 40 === o || Re(o) ? t(o) : (e.consume(o), 92 === o ? m : h)) : (e.exit('chunkString'), e.exit(a), e.exit(l), e.exit(r), n(o));
    }
    function m(n) {
   ...
   function mn(e, n, t, r, o, i) {
    ...
    function u(f) {
     return s > 999 || null === f || 91 === f || (93 === f && !a) || (94 === f && !s && '_hiddenFootnoteSupport' in l.parser.constructs) ? t(f) : 93 === f ? (e.exit(i), e.enter(o), e.consume(f), e.exit(o), e.exit(r), n) : Ue(f) ? (e.enter('lineEnding'), e.consume(f), e.exit('lineEnding'), u) : (e.enter('chunkString', { contentType: 'string' }), c(f));
    }
    function c(n) {
     return null === n || 91 === n || 93 === n || Ue(n) || s++ > 999 ? (e.exit('chunkString'), u(n)) : (e.consume(n), a || (a = !Ve(n)), 92 === n ? f : c);
    }
    function f(n) {
   ...
   function gn(e, n, t, r, o, i) {
    ...
    function s(n) {
     return n === l ? (e.exit(i), a(l)) : null === n ? t(n) : Ue(n) ? (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), We(e, s, 'linePrefix')) : (e.enter('chunkString', { contentType: 'string' }), u(n));
    }
    function u(n) {
     return n === l || null === n || Ue(n) ? (e.exit('chunkString'), s(n)) : (e.consume(n), 92 === n ? c : u);
    }
    function c(n) {
   ...
   function yn(e, n) {
    let t;
    return function r(o) {
     if (Ue(o)) return (e.enter('lineEnding'), e.consume(o), e.exit('lineEnding'), (t = !0), r);
     if (Ve(o)) return We(e, r, t ? 'linePrefix' : 'lineSuffix')(o);
     return n(o);
    };
   }
   function xn(e) {
   ...
   const vn = {
     ...
     tokenize: function (e, n, t) {
      ...
      function s(n) {
       return e.attempt(kn, u, u)(n);
      }
      function u(n) {
       return Ve(n) ? We(e, c, 'whitespace')(n) : c(n);
      }
      function c(i) {
       return null === i || Ue(i) ? (e.exit('definition'), r.parser.defined.push(o), n(i)) : t(i);
      }
     },
    },
    kn = {
   ...
   const bn = {
     ...
     tokenize: function (e, n, t) {
      ...
      function i(n) {
       return null === n ? a(n) : Ue(n) ? e.attempt(wn, i, a)(n) : (e.enter('codeFlowValue'), l(n));
      }
      function l(n) {
       return null === n || Ue(n) ? (e.exit('codeFlowValue'), i(n)) : (e.consume(n), l);
      }
      function a(t) {
    ...
    wn = {
     tokenize: function (e, n, t) {
      ...
      return o;
      function o(n) {
       return r.parser.lazy[r.now().line] ? t(n) : Ue(n) ? (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), o) : We(e, i, 'linePrefix', 5)(n);
      }
      function i(e) {
       const i = r.events[r.events.length - 1];
       return i && 'linePrefix' === i[1].type && i[2].sliceSerialize(i[1], !0).length >= 4 ? n(e) : Ue(e) ? o(e) : t(e);
      }
     },
     partial: !0,
    };
   const Sn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function o(n) {
      return 35 === n && r++ < 6 ? (e.consume(n), o) : null === n || He(n) ? (e.exit('atxHeadingSequence'), i(n)) : t(n);
     }
     function i(t) {
      return 35 === t ? (e.enter('atxHeadingSequence'), l(t)) : null === t || Ue(t) ? (e.exit('atxHeading'), n(t)) : Ve(t) ? We(e, i, 'whitespace')(t) : (e.enter('atxHeadingText'), a(t));
     }
     function l(n) {
      return 35 === n ? (e.consume(n), l) : (e.exit('atxHeadingSequence'), i(n));
     }
     function a(n) {
      return null === n || 35 === n || He(n) ? (e.exit('atxHeadingText'), i(n)) : (e.consume(n), a);
     }
    },
   ...
   const Cn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function i(n) {
      return n === o ? (e.consume(n), i) : (e.exit('setextHeadingLineSequence'), Ve(n) ? We(e, l, 'lineSuffix')(n) : l(n));
     }
     function l(r) {
      return null === r || Ue(r) ? (e.exit('setextHeadingLine'), n(r)) : t(r);
     }
    },
   ...
   const En = ['address', 'article', 'aside', 'base', 'basefont', 'blockquote', 'body', 'caption', 'center', 'col', 'colgroup', 'dd', 'details', 'dialog', 'dir', 'div', 'dl', 'dt', 'fieldset', 'figcaption', 'figure', 'footer', 'form', 'frame', 'frameset', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'head', 'header', 'hr', 'html', 'iframe', 'legend', 'li', 'link', 'main', 'menu', 'menuitem', 'nav', 'noframes', 'ol', 'optgroup', 'option', 'p', 'param', 'search', 'section', 'summary', 'table', 'tbody', 'td', 'tfoot', 'th', 'thead', 'title', 'tr', 'track', 'ul'],
    ...
    In = {
     ...
     tokenize: function (e, n, t) {
      ...
      function u(a) {
       return 33 === a ? (e.consume(a), c) : 47 === a ? (e.consume(a), (i = !0), d) : 63 === a ? (e.consume(a), (o = 3), r.interrupt ? n : M) : Me(a) ? (e.consume(a), (l = String.fromCharCode(a)), h) : t(a);
      }
      function c(i) {
      ...
      function h(a) {
       if (null === a || 47 === a || 62 === a || He(a)) {
        const s = 47 === a,
         u = l.toLowerCase();
        return s || i || !Pn.includes(u) ? (En.includes(l.toLowerCase()) ? ((o = 6), s ? (e.consume(a), m) : r.interrupt ? n(a) : P(a)) : ((o = 7), r.interrupt && !r.parser.lazy[r.now().line] ? t(a) : i ? g(a) : y(a))) : ((o = 1), r.interrupt ? n(a) : P(a));
       }
       return 45 === a || je(a) ? (e.consume(a), (l += String.fromCharCode(a)), h) : t(a);
      }
      function m(o) {
       return 62 === o ? (e.consume(o), r.interrupt ? n : P) : t(o);
      }
      function g(n) {
       return Ve(n) ? (e.consume(n), g) : C(n);
      }
      function y(n) {
       return 47 === n ? (e.consume(n), C) : 58 === n || 95 === n || Me(n) ? (e.consume(n), x) : Ve(n) ? (e.consume(n), y) : C(n);
      }
      function x(n) {
       return 45 === n || 46 === n || 58 === n || 95 === n || je(n) ? (e.consume(n), x) : v(n);
      }
      function v(n) {
       return 61 === n ? (e.consume(n), k) : Ve(n) ? (e.consume(n), v) : y(n);
      }
      function k(n) {
       return null === n || 60 === n || 61 === n || 62 === n || 96 === n ? t(n) : 34 === n || 39 === n ? (e.consume(n), (s = n), b) : Ve(n) ? (e.consume(n), k) : w(n);
      }
      function b(n) {
       return n === s ? (e.consume(n), (s = null), S) : null === n || Ue(n) ? t(n) : (e.consume(n), b);
      }
      function w(n) {
       return null === n || 34 === n || 39 === n || 47 === n || 60 === n || 61 === n || 62 === n || 96 === n || He(n) ? v(n) : (e.consume(n), w);
      }
      function S(e) {
       return 47 === e || 62 === e || Ve(e) ? y(e) : t(e);
      }
      function C(n) {
       return 62 === n ? (e.consume(n), E) : t(n);
      }
      function E(n) {
       return null === n || Ue(n) ? P(n) : Ve(n) ? (e.consume(n), E) : t(n);
      }
      function P(n) {
       return 45 === n && 2 === o ? (e.consume(n), O) : 60 === n && 1 === o ? (e.consume(n), L) : 62 === n && 4 === o ? (e.consume(n), j) : 63 === n && 3 === o ? (e.consume(n), M) : 93 === n && 5 === o ? (e.consume(n), z) : !Ue(n) || (6 !== o && 7 !== o) ? (null === n || Ue(n) ? (e.exit('htmlFlowData'), I(n)) : (e.consume(n), P)) : (e.exit('htmlFlowData'), e.check(Tn, F, I)(n));
      }
      function I(n) {
       return e.check(An, T, F)(n);
      }
      function T(n) {
       return (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), A);
      }
      function A(n) {
       return null === n || Ue(n) ? I(n) : (e.enter('htmlFlowData'), P(n));
      }
      function O(n) {
      ...
      function D(n) {
       if (62 === n) {
        ...
        return Pn.includes(t) ? (e.consume(n), j) : P(n);
       }
      ...
      function M(n) {
       return 62 === n ? (e.consume(n), j) : 45 === n && 2 === o ? (e.consume(n), M) : P(n);
      }
      function j(n) {
       return null === n || Ue(n) ? (e.exit('htmlFlowData'), F(n)) : (e.consume(n), j);
      }
      function F(t) {
    ...
    Tn = {
     tokenize: function (e, n, t) {
      return function (r) {
       return (e.enter('lineEnding'), e.consume(r), e.exit('lineEnding'), e.attempt(Je, n, t));
      };
     },
     partial: !0,
    },
    An = {
     tokenize: function (e, n, t) {
      const r = this;
      return function (n) {
       if (Ue(n)) return (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), o);
       return t(n);
      };
      function o(e) {
   ...
   const On = {
    ...
    Ln = {
     ...
     tokenize: function (e, n, t) {
      const r = this,
       o = {
        tokenize: function (e, n, t) {
         ...
         function s(n) {
          return (e.enter('codeFencedFence'), Ve(n) ? We(e, u, 'linePrefix', r.parser.constructs.disable.null.includes('codeIndented') ? void 0 : 4)(n) : u(n));
         }
         function u(n) {
          return n === i ? (e.enter('codeFencedFenceSequence'), c(n)) : t(n);
         }
         function c(n) {
          return n === i ? (o++, e.consume(n), c) : o >= a ? (e.exit('codeFencedFenceSequence'), Ve(n) ? We(e, f, 'whitespace')(n) : f(n)) : t(n);
         }
         function f(r) {
          return null === r || Ue(r) ? (e.exit('codeFencedFence'), n(r)) : t(r);
         }
        },
        partial: !0,
       };
      ...
      function s(n) {
       return n === i ? (a++, e.consume(n), s) : a < 3 ? t(n) : (e.exit('codeFencedFenceSequence'), Ve(n) ? We(e, u, 'whitespace')(n) : u(n));
      }
      function u(t) {
       return null === t || Ue(t) ? (e.exit('codeFencedFence'), r.interrupt ? n(t) : e.check(On, d, x)(t)) : (e.enter('codeFencedFenceInfo'), e.enter('chunkString', { contentType: 'string' }), c(t));
      }
      function c(n) {
       return null === n || Ue(n) ? (e.exit('chunkString'), e.exit('codeFencedFenceInfo'), u(n)) : Ve(n) ? (e.exit('chunkString'), e.exit('codeFencedFenceInfo'), We(e, f, 'whitespace')(n)) : 96 === n && n === i ? t(n) : (e.consume(n), c);
      }
      function f(n) {
       return null === n || Ue(n) ? u(n) : (e.enter('codeFencedFenceMeta'), e.enter('chunkString', { contentType: 'string' }), p(n));
      }
      function p(n) {
       return null === n || Ue(n) ? (e.exit('chunkString'), e.exit('codeFencedFenceMeta'), u(n)) : 96 === n && n === i ? t(n) : (e.consume(n), p);
      }
      function d(n) {
      ...
      function m(n) {
       return l > 0 && Ve(n) ? We(e, g, 'linePrefix', l + 1)(n) : g(n);
      }
      function g(n) {
       return null === n || Ue(n) ? e.check(On, d, x)(n) : (e.enter('codeFlowValue'), y(n));
      }
      function y(n) {
       return null === n || Ue(n) ? (e.exit('codeFlowValue'), g(n)) : (e.consume(n), y);
      }
      function x(t) {
   ...
   const Mn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function a(n) {
      return 35 === n ? (e.enter('characterReferenceMarkerNumeric'), e.consume(n), e.exit('characterReferenceMarkerNumeric'), s) : (e.enter('characterReferenceValue'), (o = 31), (i = je), u(n));
     }
     function s(n) {
      return 88 === n || 120 === n ? (e.enter('characterReferenceMarkerHexadecimal'), e.consume(n), e.exit('characterReferenceMarkerHexadecimal'), e.enter('characterReferenceValue'), (o = 6), (i = _e), u) : (e.enter('characterReferenceValue'), (o = 7), (i = Ne), u(n));
     }
     function u(a) {
      if (59 === a && l) {
       const o = e.exit('characterReferenceValue');
       return i !== je || zn(r.sliceSerialize(o)) ? (e.enter('characterReferenceMarker'), e.consume(a), e.exit('characterReferenceMarker'), e.exit('characterReference'), n) : t(a);
      }
   ...
   const Rn = {
     ...
     tokenize: function (e, n, t) {
      ...
      function a(n) {
       return 40 === n ? e.attempt(Nn, u, i ? u : c)(n) : 91 === n ? e.attempt(_n, u, i ? s : c)(n) : i ? u(n) : c(n);
      }
      function s(n) {
       return e.attempt(Bn, u, c)(n);
      }
      function u(e) {
       return n(e);
      }
     ...
     resolveTo: function (e, n) {
      ...
      return (
       ...
       (i = Ie(i, [['exit', c, n], e[o - 2], e[o - 1], ['exit', u, n]])),
       (i = Ie(i, e.slice(o + 1))),
       (i = Ie(i, [['exit', s, n]])),
       Pe(e, r, e.length, i),
       e
    ...
    Nn = {
     tokenize: function (e, n, t) {
      ...
      function r(n) {
       return He(n) ? yn(e, o)(n) : o(n);
      }
      function o(n) {
       return 41 === n ? u(n) : hn(e, i, l, 'resourceDestination', 'resourceDestinationLiteral', 'resourceDestinationLiteralMarker', 'resourceDestinationRaw', 'resourceDestinationString', 32)(n);
      }
      function i(n) {
       return He(n) ? yn(e, a)(n) : u(n);
      }
      function l(e) {
       return t(e);
      }
      function a(n) {
       return 34 === n || 39 === n || 40 === n ? gn(e, s, t, 'resourceTitle', 'resourceTitleMarker', 'resourceTitleString')(n) : u(n);
      }
      function s(n) {
       return He(n) ? yn(e, u)(n) : u(n);
      }
      function u(r) {
       ...
       for (t = c; t--; )
        if ('exit' === e[t][0] && 'attentionSequence' === e[t][1].type && e[t][1]._open && n.sliceSerialize(e[t][1]).charCodeAt(0) === n.sliceSerialize(e[c][1]).charCodeAt(0)) {
         ...
         (qn(f, -a),
          ...
          (s = Ie(s, an(n.parser.constructs.insideSpan.null, e.slice(t + 1, c), n))),
          (s = Ie(s, [
           ['exit', o, n],
           ['enter', l, n],
           ['exit', l, n],
   ...
   const $n = {
    ...
    tokenize: function (e, n, t) {
     ...
     function i(e) {
      return 43 === e || 45 === e || 46 === e || je(e) ? ((r = 1), l(e)) : s(e);
     }
     function l(n) {
      return 58 === n ? (e.consume(n), (r = 0), a) : (43 === n || 45 === n || 46 === n || je(n)) && r++ < 32 ? (e.consume(n), l) : ((r = 0), s(n));
     }
     function a(r) {
     ...
     function s(n) {
      return 64 === n ? (e.consume(n), u) : Fe(n) ? (e.consume(n), s) : t(n);
     }
     function u(e) {
      return je(e) ? c(e) : t(e);
     }
   ...
   const Wn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function s(n) {
      return 45 === n ? (e.consume(n), u) : 91 === n ? (e.consume(n), (i = 0), d) : Me(n) ? (e.consume(n), y) : t(n);
     }
     function u(n) {
      return 45 === n ? (e.consume(n), p) : t(n);
     }
     function c(n) {
      return null === n ? t(n) : 45 === n ? (e.consume(n), f) : Ue(n) ? ((l = c), D(n)) : (e.consume(n), c);
     }
     function f(n) {
     ...
     function h(n) {
      return null === n ? t(n) : 93 === n ? (e.consume(n), m) : Ue(n) ? ((l = h), D(n)) : (e.consume(n), h);
     }
     function m(n) {
     ...
     function y(n) {
      return null === n || 62 === n ? L(n) : Ue(n) ? ((l = y), D(n)) : (e.consume(n), y);
     }
     function x(n) {
      return null === n ? t(n) : 63 === n ? (e.consume(n), v) : Ue(n) ? ((l = x), D(n)) : (e.consume(n), x);
     }
     function v(e) {
      return 62 === e ? L(e) : x(e);
     }
     ...
     function b(n) {
      return 45 === n || je(n) ? (e.consume(n), b) : w(n);
     }
     function w(n) {
      return Ue(n) ? ((l = w), D(n)) : Ve(n) ? (e.consume(n), w) : L(n);
     }
     function S(n) {
      return 45 === n || je(n) ? (e.consume(n), S) : 47 === n || 62 === n || He(n) ? C(n) : t(n);
     }
     function C(n) {
      return 47 === n ? (e.consume(n), L) : 58 === n || 95 === n || Me(n) ? (e.consume(n), E) : Ue(n) ? ((l = C), D(n)) : Ve(n) ? (e.consume(n), C) : L(n);
     }
     function E(n) {
      return 45 === n || 46 === n || 58 === n || 95 === n || je(n) ? (e.consume(n), E) : P(n);
     }
     function P(n) {
      return 61 === n ? (e.consume(n), I) : Ue(n) ? ((l = P), D(n)) : Ve(n) ? (e.consume(n), P) : C(n);
     }
     function I(n) {
      return null === n || 60 === n || 61 === n || 62 === n || 96 === n ? t(n) : 34 === n || 39 === n ? (e.consume(n), (o = n), T) : Ue(n) ? ((l = I), D(n)) : Ve(n) ? (e.consume(n), I) : (e.consume(n), A);
     }
     function T(n) {
      return n === o ? (e.consume(n), (o = void 0), O) : null === n ? t(n) : Ue(n) ? ((l = T), D(n)) : (e.consume(n), T);
     }
     function A(n) {
      return null === n || 34 === n || 39 === n || 60 === n || 61 === n || 96 === n ? t(n) : 47 === n || 62 === n || He(n) ? C(n) : (e.consume(n), A);
     }
     function O(e) {
      return 47 === e || 62 === e || He(e) ? C(e) : t(e);
     }
     function L(r) {
     ...
     function z(n) {
      return Ve(n) ? We(e, M, 'linePrefix', r.parser.constructs.disable.null.includes('codeIndented') ? void 0 : 4)(n) : M(n);
     }
     function M(n) {
   ...
   const Yn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function r(r) {
      return Ue(r) ? (e.exit('hardBreakEscape'), n(r)) : t(r);
     }
    },
   };
   const Qn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function a(n) {
      return null === n ? t(n) : 32 === n ? (e.enter('space'), e.consume(n), e.exit('space'), a) : 96 === n ? ((o = e.enter('codeTextSequence')), (r = 0), u(n)) : Ue(n) ? (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), a) : (e.enter('codeTextData'), s(n));
     }
     function s(n) {
      return null === n || 32 === n || 96 === n || Ue(n) ? (e.exit('codeTextData'), a(n)) : (e.consume(n), s);
     }
     function u(t) {
   ...
   const Jn = { 42: cn, 43: cn, 45: cn, 48: cn, 49: cn, 50: cn, 51: cn, 52: cn, 53: cn, 54: cn, 55: cn, 56: cn, 57: cn, 62: dn },
    Xn = { 91: vn },
    Zn = { [-2]: bn, [-1]: bn, 32: bn },
    Gn = { 35: Sn, 42: un, 45: [Cn, un], 60: In, 61: Cn, 95: un, 96: Ln, 126: Ln },
    et = { 38: Mn, 92: jn },
    nt = { [-5]: Fn, [-4]: Fn, [-3]: Fn, 33: Un, 38: Mn, 42: Vn, 60: [$n, Wn], 91: Kn, 92: [Yn, jn], 93: Rn, 95: Vn, 96: Qn },
    tt = { null: [Vn, en] },
    rt = { null: [42, 95] },
    ot = { null: [] };
   function it(e) {
    const n = (function (e) {
     ...
     t = { defined: [], lazy: {}, constructs: n, content: r(Ke), document: r(Ye), flow: r(Ge), string: r(nn), text: r(tn) };
    return t;
    function r(e) {
     return function (n) {
      return sn(t, e, n);
   ...
   function ft(e, n, t) {
    return (
     ...
     (function (e) {
      const n = { transforms: [], canContainEols: ['emphasis', 'fragment', 'heading', 'paragraph', 'strong'], enter: { autolink: i(ne), autolinkProtocol: E, autolinkEmail: E, atxHeading: i(J), blockQuote: i($), characterEscape: E, characterReference: E, codeFenced: i(W), codeFencedFenceInfo: l, codeFencedFenceMeta: l, codeIndented: i(W, l), codeText: i(K, l), codeTextData: E, data: E, codeFlowValue: E, definition: i(Y), definitionDestinationString: l, definitionLabelString: l, definitionTitleString: l, emphasis: i(Q), hardBreakEscape: i(X), hardBreakTrailing: i(X), htmlFlow: i(G, l), htmlFlowData: E, htmlText: i(G, l), htmlTextData: E, image: i(ee), label: l, link: i(ne), listItem: i(re), listItemValue: p, listOrdered: i(te, f), listUnordered: i(te), paragraph: i(oe), reference: _, referenceString: l, resourceDestinationString: l, resourceTitleString: l, setextHeading: i(J), strong: i(ie), thematicBreak: i(ae) }, exit: { atxHeading: s(), atxHeadingSequence: b, autolink: s(), autolinkEmail: q, autolinkProtocol: V, blockQuote: s(), characterEscapeValue: P, characterReferenceMarkerHexadecimal: U, characterReferenceMarkerNumeric: U, characterReferenceValue: H, codeFenced: s(g), codeFencedFence: m, codeFencedFenceInfo: d, codeFencedFenceMeta: h, codeFlowValue: P, codeIndented: s(y), codeText: s(L), codeTextData: P, data: P, definition: s(), definitionDestinationString: k, definitionLabelString: x, definitionTitleString: v, emphasis: s(), hardBreakEscape: s(T), hardBreakTrailing: s(T), htmlFlow: s(A), htmlFlowData: P, htmlText: s(O), htmlTextData: P, image: s(z), label: j, labelText: M, lineEnding: I, link: s(D), listItem: s(), listOrdered: s(), listUnordered: s(), paragraph: s(), referenceString: B, resourceDestinationString: F, resourceTitleString: R, resource: N, setextHeading: s(C), setextHeadingLineSequence: S, setextHeadingText: w, strong: s(), thematicBreak: s() } };
      ...
      function r(e) {
       ...
       for (f = -1; ++f < e.length; ) {
        const t = n[e[f][0]];
        ct.call(t, e[f][1].type) && t[e[f][1].type].call(Object.assign({ sliceSerialize: e[f][2].sliceSerialize }, i), e[f][1]);
       }
      ...
      function c() {
       return (function (e, n) {
        const t = n || Se;
        return Ce(e, 'boolean' != typeof t.includeImageAlt || t.includeImageAlt, 'boolean' != typeof t.includeHtml || t.includeHtml);
       })(this.stack.pop());
      }
      function f() {
         ...
         (function () {
          ...
          return function (o, i, l) {
           ...
           for (o = t + ('string' == typeof o ? o.toString() : new TextDecoder(i || void 0).decode(o)), c = 0, t = '', r && (65279 === o.charCodeAt(0) && c++, (r = void 0)); c < o.length; ) {
            if (((lt.lastIndex = c), (s = lt.exec(o)), (f = s && void 0 !== s.index ? s.index : o.length), (p = o.charCodeAt(f)), !s)) {
             t = o.slice(c);
             break;
            }
   ...
   const yt = 'object' == typeof self ? self : globalThis,
    ...
    Et = 'function' == typeof structuredClone ? (e, n) => (n && ('json' in n || 'lossy' in n) ? xt(Ct(e, n)) : structuredClone(e)) : (e, n) => xt(Ct(e, n));
   function Pt(e) {
    const n = [];
    let t = -1,
     r = 0,
    ...
    for (; ++t < e.length; ) {
     ...
     let l = '';
     if (37 === i && je(e.charCodeAt(t + 1)) && je(e.charCodeAt(t + 2))) o = 2;
   ...
   const Ht = {
    ...
    text: function (e, n) {
     const t = { type: 'text', value: Bt(String(n.value)) };
     return (e.patch(n, t), e.applyData(n, t));
    },
   ...
   function Kt(e, n) {
    ...
    if (e && e.data) {
     ...
     ('element' === t.type && o && Object.assign(t.properties, Et(o)), 'children' in t && t.children && null != r && (t.children = r));
    }
    return t;
   }
   function Yt(e, n) {
    const t = n.data || {},
     r = !('value' in n) || qt.call(t, 'hProperties') || qt.call(t, 'hChildren') ? { type: 'element', tagName: 'div', properties: {}, children: e.all(n) } : { type: 'text', value: n.value };
    return (e.patch(n, r), e.applyData(n, r));
   }
   function Qt(e, n) {
    const t = [];
      ...
      const t = n || $t,
       ...
       a = {
        ...
        one: function (e, n) {
         const t = e.type,
          r = a.handlers[t];
         if (qt.call(a.handlers, t) && r) return r(a, e, n);
     ...
     o = (function (e) {
      ...
      if (0 !== a.length)
       return {
        ...
        children: [
         { type: 'element', tagName: i, properties: { ...Et(l), id: 'footnote-label' }, children: [{ type: 'text', value: o }] },
         { type: 'text', value: '\n' },
   ...
   const rr = {
    ...
    join: function (...e) {
     let n,
      t = -1;
     for (; ++t < e.length; ) (or(e[t]), e[t] && (n = void 0 === n ? e[t] : n + '/' + e[t]));
     return void 0 === n
      ? '.'
      : (function (e) {
         or(e);
   ...
   const sr = ['history', 'path', 'basename', 'stem', 'extname', 'dirname'];
   class ur {
    constructor(e) {
     let n;
     ((n = e
     ...
     for (t in n) sr.includes(t) || (this[t] = n[t]);
    }
    get basename() {
     return 'string' == typeof this.path ? rr.basename(this.path) : void 0;
    }
    set basename(e) {
     (fr(e, 'basename'), cr(e, 'basename'), (this.path = rr.join(this.dirname || '', e)));
    }
    get dirname() {
     return 'string' == typeof this.path ? rr.dirname(this.path) : void 0;
    }
    set dirname(e) {
     (pr(this.basename, 'dirname'), (this.path = rr.join(e || '', this.basename)));
    }
    get extname() {
     return 'string' == typeof this.path ? rr.extname(this.path) : void 0;
    }
    set extname(e) {
     if ((cr(e, 'extname'), pr(this.dirname, 'extname'), e)) {
     ...
     this.path = rr.join(this.dirname, this.stem + (e || ''));
    }
    get path() {
     return this.history[this.history.length - 1];
    }
    set path(e) {
     (lr(e) && (e = ar(e)), fr(e, 'path'), this.path !== e && this.history.push(e));
    }
    get stem() {
     return 'string' == typeof this.path ? rr.basename(this.path, this.extname) : void 0;
    }
    set stem(e) {
     (fr(e, 'stem'), cr(e, 'stem'), (this.path = rr.join(this.dirname || '', e + (this.extname || ''))));
    }
    fail(e, n, t) {
   ...
   function cr(e, n) {
    if (e && e.includes(rr.sep)) throw new Error('`' + n + '` cannot be a path: did not expect `' + rr.sep + '`');
   }
   function fr(e, n) {
   ...
   class mr extends dr {
    constructor() {
     (super('copy'), (this.Compiler = void 0), (this.Parser = void 0), (this.attachers = []), (this.compiler = void 0), (this.freezeIndex = -1), (this.frozen = void 0), (this.namespace = {}), (this.parser = void 0), (this.transformers = tr()));
    }
    copy() {
     const e = new mr();
     let n = -1;
    ...
    data(e, n) {
     return 'string' == typeof e ? (2 === arguments.length ? (vr('data', this.frozen), (this.namespace[e] = n), this) : (hr.call(this.namespace, e) && this.namespace[e]) || void 0) : e ? (vr('data', this.frozen), (this.namespace = e), this) : this.namespace;
    }
    freeze() {
    ...
    parse(e) {
     ...
     return (yr('parse', t), t(String(n), n));
    }
    process(e, n) {
     const t = this;
     return (this.freeze(), yr('process', this.parser || this.Parser), xr('process', this.compiler || this.Compiler), n ? r(void 0, n) : new Promise(r));
     function r(r, o) {
      const i = wr(e),
       l = t.parse(i);
      function a(e, t) {
    ...
    processSync(e) {
     ...
     return (
      this.freeze(),
      yr('processSync', this.parser || this.Parser),
      xr('processSync', this.compiler || this.Compiler),
      this.process(e, function (e, r) {
       ((t = !0), Gt(e), (n = r));
      }),
      br('processSync', 'process', t),
      n
     );
    }
    run(e, n, t) {
    ...
    stringify(e, n) {
     ...
     return (xr('stringify', r), kr(e), r(e, t));
    }
    use(e, ...n) {
     const t = this.attachers,
      r = this.namespace;
     if ((vr('use', this.frozen), null == e));
     ...
     function i(e) {
      ...
      (l(e.plugins), e.settings && (r.settings = er(!0, r.settings, e.settings)));
     }
     function l(e) {
      let n = -1;
      if (null == e);
     ...
     function a(e, n) {
      ...
      if (-1 === o) t.push([e, ...n]);
       ...
       let [r, ...i] = n;
       const l = t[o][1];
       (nr(l) && nr(r) && (r = er(!0, l, r)), (t[o] = [e, r, ...i]));
      }
     }
    }
   }
   const gr = new mr().freeze();
   function yr(e, n) {
   ...
   function kr(e) {
    if (!nr(e) || 'string' != typeof e.type) throw new TypeError('Expected node, got `' + e + '`');
   }
   function br(e, n, t) {
   ...
   function Or(e, n) {
    const t = n.allowedElements,
     ...
     u = n.urlTransform || Lr;
    for (const c of Pr) Object.hasOwn(n, c.from) && l((c.from, c.to && c.to, c.id));
    return (
     Rt(e, function (e, n, o) {
       ...
       for (n in be)
        if (Object.hasOwn(be, n) && Object.hasOwn(e.properties, n)) {
         const t = e.properties[n],
          r = be[n];
         (null === r || r.includes(e.tagName)) && (e.properties[n] = u(String(t || ''), n, e));
        }
      }
      if ('element' === e.type) {
     ...
     ce(e, { Fragment: we.Fragment, components: o, ignoreInvalidStyle: !0, jsx: we.jsx, jsxs: we.jsxs, passKeys: !0, passNode: !0 })
    );
   }
   function Lr(e) {
    const n = e.indexOf(':'),
     ...
     r = e.indexOf('#'),
     o = e.indexOf('/');
    return -1 === n || (-1 !== o && n > o) || (-1 !== t && n > t) || (-1 !== r && n > r) || Er.test(e.slice(0, n)) ? e : '';
   }
  },
  60710(e) {
   'use strict';
   ...
   e.exports = function (e, s) {
    ...
    function b() {
     ...
     if ('/' == e.charAt(0) && '*' == e.charAt(1)) {
      for (var t = 2; u != e.charAt(t) && ('*' != e.charAt(t) || '/' != e.charAt(t + 1)); ) ++t;
      if (((t += 2), u === e.charAt(t - 1))) return y('End of comment missing');
      var r = e.slice(2, t - 2);
    ...
    function w() {
     ...
     if (t) {
      ...
      var r = x(l),
       s = e({ type: 'declaration', property: c(t[0].replace(n, u)), value: r ? c(r[0].replace(n, u)) : u });
      return (x(a), s);
     }
    }
    return (
  ...
  78236(e, n, t) {
   ...
   function l(e, n, t, r, o) {
    const i = { '@context': 'https://schema.org', '@type': 'VideoObject', name: (null == o ? void 0 : o.name) || n, thumbnailUrl: [(null == o ? void 0 : o.thumbnailUrl) || t], embedUrl: (null == o ? void 0 : o.embedUrl) || `${r}/embed/${e}`, contentUrl: (null == o ? void 0 : o.contentUrl) || `https://www.youtube.com/watch?v=${e}`, ...((null == o ? void 0 : o.description) && { description: o.description }), ...((null == o ? void 0 : o.uploadDate) && { uploadDate: o.uploadDate }), ...((null == o ? void 0 : o.duration) && { duration: o.duration }) };
    ...
    return (
     ...
     (0, r.jsxs)(r.Fragment, {
      children: [
       ...
       (0, r.jsx)(r.Fragment, { children: t && (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)('link', { rel: 'preconnect', href: y }), (0, r.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), E && (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, r.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
       e.seo && !e.playlist && (0, r.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: l(e.id, p, S, y, e.seo) } }),
       M && !e.playlist && (0, r.jsx)('noscript', { children: (0, r.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${p} on YouTube`, children: ['Watch "', p, '" on YouTube'] }) }),
       (0, r.jsxs)(z, {
        onPointerOver: () => {
         t || a(!0);
        },
        ...
        children: [e.lazyLoad && !s && (0, r.jsx)('img', { src: S, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, r.jsx)('button', { type: 'button', className: A, 'aria-label': `${h} ${p}`, 'aria-hidden': s || void 0, tabIndex: s ? -1 : 0, children: (0, r.jsx)('span', { className: 'lty-visually-hidden', children: h }) }), s && (0, r.jsx)('iframe', { ref: n, className: T, title: p, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: x, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
