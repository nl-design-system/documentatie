 ...
 [3958],
 {
  ...
  17889(e, n, t) {
   ...
   var u = t(35193),
    ...
    y = t(79532),
    w = t(30758);
   const A = { color: u.A, dimension: j.A, fontFamilies: k.A, fontSizes: x.A, fontWeights: b.A, lineHeights: v.A, other: f.A, textDecoration: y.A },
  ...
  19316(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => T, component: () => R, contentTitle: () => C, default: () => V, description: () => L, frontMatter: () => S, issueNumber: () => M, metadata: () => o, title: () => z, toc: () => B }));
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => r, KF: () => p, mJ: () => u, VZ: () => A, cR: () => w, Pv: () => j, qZ: () => i, kD: () => v, B2: () => m, Pc: () => d, f4: () => a, GT: () => f, fX: () => s, eQ: () => b, B_: () => x, o_: () => k, Rc: () => y });
