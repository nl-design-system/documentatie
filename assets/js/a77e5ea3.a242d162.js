  ...
  1842(e, n, t) {
   ...
   const f = ({ component: e, headingLevel: n }) => {
     const t = e && e.projects.filter((e) => w.f4.includes(e.id)),
      o = t && w.f4.map((e) => t.find((n) => n.id === e)).filter(Boolean);
     return e && (0, l.jsx)(r.If, { sections: o.map((t) => ({ className: (0, i.A)('definition-of-done', t && `definition-of-done--${(0, w.fX)(t.title)}`), headingLevel: n, expanded: !1, label: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', body: t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p, { children: t.tasks.map(({ checked: e, name: t, id: r }) => (0, l.jsx)(j, { headingLevel: n + 1, checked: e, title: t, description: (0, w.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) })) });
    },
