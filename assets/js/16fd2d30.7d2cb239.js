(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [33430],
 {
  14419: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => j, component: () => v, contentTitle: () => u, default: () => b, description: () => g, frontMatter: () => d, issueNumber: () => p, metadata: () => h, title: () => y, toc: () => m });
   var r = n(52676),
    c = n(40139),
    s = n(27197),
    o = n(45994),
   ...
   const d = { title: 'Heading 2', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading 2', pagination_label: 'Heading 2', description: 'Koptekst die volgt na de hoofdkop en in de koppenstructuur op het tweede niveau staat.', slug: '/heading-2', keywords: ['caption', 'content', 'h2', 'heading', 'heading level', 'headline', 'kop', 'paginakop', 'sectie', 'section', 'structure', 'titel', 'title'] },
    ...
    y = 'Heading 2',
    g = 'Koptekst die volgt na de hoofdkop en in de koppenstructuur op het tweede niveau staat.',
    p = 258,
    v = s.find((e) => e.number === p);
   function k(e) {
    const t = { h2: 'h2', ...(0, c.a)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', '\n', (0, r.jsx)(l.Rv, { component: v, headingLevel: 1, description: g }), '\n', (0, r.jsx)(i.I, { component: v }), '\n', (0, r.jsx)(t.h2, { id: 'anatomie', children: 'Anatomie' }), '\n', (0, r.jsx)(a.B, { component: v, illustration: o.Z }), '\n', (0, r.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, r.jsx)(l.cN, { component: v, headingLevel: 3 }), '\n', (0, r.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, r.jsx)(l.W, { component: v, headingLevel: 3 }), '\n', (0, r.jsx)(t.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }), '\n', (0, r.jsx)(l.vM, { component: v, headingLevel: 3 })] });
   }
   function b(e = {}) {
  ...
  35038: (e, t, n) => {
   'use strict';
   n.d(t, { Zb: () => a, aY: () => i, um: () => l, wu: () => o });
   var r = n(28439),
    c = n(4814),
    s = n(52676);
   const o = (e) => {
     let { background: t, children: n, className: r, ...o } = e;
     return (0, s.jsx)('div', { className: (0, c.Z)('card__illustration', t && 'card__illustration--background', r), ...o, children: n });
    },
    i = (e) => (0, s.jsx)('div', { className: 'card__content', ...e }),
    a = (e) => {
     let { href: t, appearance: n, className: o, component: i = 'div', children: a } = e;
     const l = (e) => ('article' === i ? (0, s.jsx)('article', { ...e }) : 'section' === i ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      d = (0, s.jsx)(l, { className: (0, c.Z)('cardgroup__card', `cardgroup__card--${n}`, o), children: a });
  ...
  97520: (e, t, n) => {
   ...
   const i = (e) => {
    ...
    return (0, o.jsx)(c.Suspense, { fallback: null, children: (0, o.jsx)(r.U, { omitH1: !0, headingLevel: 1, children: (0, o.jsx)(l, {}) }) });
   };
  },
  76233: (e, t, n) => {
   'use strict';
   ...
   const a = (e) => {
     let { children: t } = e;
     return (0, i.jsx)('ol', { className: 'nlds-anatomy-list', children: t });
    },
    l = (e) => {
     let { children: t } = e;
     return (0, i.jsx)('li', { className: 'nlds-anatomy-list__item', children: t });
    },
    d = (e) => {
     let { component: t, illustration: d } = e;
     const { title: u } = t,
      h = (0, o.mA)(u),
      j = s.lazy(() => n(22930)(`./${h}-docs/docs/anatomy/anatomy.md`).catch(() => ({ default: () => null })));
     return (0, i.jsx)(s.Suspense, {
      fallback: null,
      children: (0, i.jsxs)('figure', {
       className: (0, c.Z)('component-anatomy'),
       children: [
        d && (0, i.jsx)(d, { height: null, className: (0, c.Z)('component-anatomy__illustration') }),
        d &&
         j &&
         (0, i.jsx)('figcaption', {
  ...
  8657: (e, t, n) => {
   ...
   var r = n(35076),
    ...
    l = n(32636),
    d = n(52676);
   const u = { figma: (0, d.jsx)(s.Z, {}), github: (0, d.jsx)(o.Z, {}), npm: (0, d.jsx)(i.Z, {}), storybook: (0, d.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const w = (e) => {
            ...
            j.Zb,
            {
             ...
             children: (0, d.jsxs)(j.aY, {
              children: [
               ...
               (i.length > 0 || s.length > 0) && (0, d.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               i.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               s.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: s.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: n + 2, children: [c, ' in ', t] }), (0, d.jsx)(r.Mc, { links: s.map((e) => ({ children: e.description, icon: (0, d.jsx)(h, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
    ...
    A = (e) => {
     ...
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.V, { level: n, suffix: s && (0, d.jsx)(g.y, { state: s }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
   ...
   const i = (e) => {
    let { state: t } = e;
    const n = (0, s.mA)(t);
    return (0, o.jsx)(r.Ou, { className: (0, c.Z)('estafette-badge', n && `estafette-badge--${n}`), children: t });
   };
  },
  41757: (e, t, n) => {
   'use strict';
   ...
   var r = n(4814),
    c = n(52676);
   const s = (e) => {
    let { children: t, className: n, level: s = 1, suffix: o, ...i } = e;
    return (0, c.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${s}`, n), ...i, children: [(0, c.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), o && (0, c.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
   };
  },
  57716: (e, t, n) => {
   'use strict';
   ...
   const o = (e, t) => {
    ...
    i = { 1: {}, 2: { h1: c.XJ, h2: c.aC, h3: c.k8, h4: c.by, h5: c.Cd }, 3: { h1: c.aC, h2: c.k8, h3: c.by, h4: c.Cd, h5: c.Cd }, 4: { h1: c.k8, h2: c.by, h3: c.Cd, h4: c.Cd, h5: c.Cd }, 5: { h1: c.by, h2: c.Cd, h3: c.Cd, h4: c.Cd, h5: c.Cd }, 6: { h1: c.Cd, h2: c.Cd, h3: c.Cd, h4: c.Cd, h5: c.Cd } },
    a = (e) => ({
     img: (t) => {
      let { src: n, ...r } = t;
    ...
    d = (e) => {
     let { children: t, omitH1: n = !1, headingLevel: c = 1, baseUrl: o = '', components: i = {} } = e;
     return (0, s.jsx)(r.Z, { components: { ...l(n, c), ...a(o), ...i }, children: t });
    };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => g, BA: () => i, Ee: () => d, Q6: () => s, U: () => j, Yr: () => p, d: () => u, e9: () => o, fO: () => k, mA: () => c, ps: () => m, qU: () => b, s0: () => v, zP: () => y });
    ...
    m = (e) => {
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        let { name: c, id: s, value: o } = r;
        const i = /^(.+) URL/.exec(c)[1],
         a = 'Storybook' === i ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${i}`;
        return { brand: i.toLowerCase(), name: c, id: s, value: o, description: a };
       });
