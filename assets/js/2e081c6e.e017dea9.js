 ...
 [22151],
 {
  18127(e, n, o) {
   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: j = !0, children: y, container: v = 'document', language: b, designTokens: x }) => {
    ...
    let F = u.Fragment;
    return (
     'paragraph' === v ? (F = h) : 'document' === v ? (F = g) : 'surface' === v && (F = f),
     (0, m.jsxs)('div', {
      className: (0, t.A)('nlds-canvas'),
      children: [
       k && (0, m.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, m.jsx)(F, { children: (0, m.jsx)(r.v$, { children: k }) }) }) }),
       j &&
        (0, m.jsx)('div', {
