...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  48694: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => g, default: () => b, frontMatter: () => j, metadata: () => u, toc: () => v });
   var r = i(52676),
    s = i(40139),
    l = i(57716),
    t = i(46364),
  ...
  41757: (e, n, i) => {
   ...
   var r = i(4814),
    s = i(52676);
   const l = (e) => {
    let { children: n, className: i, level: l = 1, suffix: t, ...a } = e;
    return (0, s.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${l}`, i), ...a, children: [(0, s.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: n }), t && (0, s.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [t ? ' ' : '', t] })] });
   };
  },
  57716: (e, n, i) => {
   i.d(n, { U: () => c });
   ...
   const t = (e, n) => {
    ...
    o = (e) => ({
     img: (n) => {
      let { src: i, ...r } = n;
      return (0, l.jsx)('img', { ...r, src: t(e, i), className: 'utrecht-img utrecht-img--fit' });
     },
    }),
    d = (e, n) => {
     if (e) {
    ...
    c = (e) => {
     let { children: n, omitH1: i = !1, headingLevel: s = 1, baseUrl: t = '', components: a = {} } = e;
     return (0, l.jsx)(r.Z, { components: { ...d(i, s), ...o(t), ...a }, children: n });
    };
  },
  46364: (e, n, i) => {
   i.d(n, { j: () => t });
   var r = i(16167),
    ...
    l = i(52676);
   const t = (e) => {
    let { children: n, conformanceLevel: i, ...t } = e;
    return (0, l.jsx)(s.V, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: i && (0, l.jsx)(r.Ou, { className: 'nlds-inline-heading-group__badge', children: i }), ...t, children: n });
   };
  },
  40139: (e, n, i) => {
   i.d(n, { Z: () => a, a: () => t });
