(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [43166],
 {
  29943: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => j, component: () => y, contentTitle: () => h, default: () => x, description: () => p, frontMatter: () => d, illustration: () => b, issueNumber: () => k, metadata: () => u, title: () => m, toc: () => g });
   var r = t(52676),
    i = t(24785),
    a = t(31612);
   function o(e) {
   ...
   const d = { title: 'Table', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Table', pagination_label: 'Table', description: 'Toont en organiseert data in gestructureerde rijen en kolommen.', slug: '/table', sidebar_custom_props: { illustration: 'TableSketch' } },
    h = void 0,
    u = { id: 'componenten/table/index', title: 'Table', description: 'Toont en organiseert data in gestructureerde rijen en kolommen.', source: '@site/docs/componenten/table/index.mdx', sourceDirName: 'componenten/table', slug: '/table', permalink: '/table', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/table/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Table', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Table', pagination_label: 'Table', description: 'Toont en organiseert data in gestructureerde rijen en kolommen.', slug: '/table', sidebar_custom_props: { illustration: 'TableSketch' } }, sidebar: 'componenten', previous: { title: 'Switch', permalink: '/switch' }, next: { title: 'Tabs', permalink: '/tabs' } },
    j = {},
    g = [
  ...
  60851: (e, n, t) => {
   ...
   const k = { 'nlds-inline-heading-group__heading': 'nlds-inline-heading-group__heading_bHAJ', 'nlds-inline-heading-group__suffix': 'nlds-inline-heading-group__suffix_ioH2' },
    y = (e) => {
     ...
     return (0, d.jsxs)('hgroup', { className: (0, i.Z)(k['nlds-inline-heading-group'], `utrecht-heading-${t}`), children: [(0, d.jsx)('h1', { className: (0, i.Z)(k['nlds-inline-heading-group__heading']), children: n }), r && (0, d.jsxs)('p', { className: (0, i.Z)(k['nlds-inline-heading-group__suffix']), children: [r ? ' ' : '', r] })] });
    };
   var v = t(93706),
    x = t(49427);
   const f = 'task-list_hh8j',
    ...
    A = (e) => {
     ...
     return (0, d.jsxs)('li', { className: (0, i.Z)(_), children: [(0, d.jsxs)('div', { className: (0, i.Z)(w, { [z]: n }), children: [(0, d.jsx)('span', { className: T, children: n ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), n && (0, d.jsx)(x.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(v.aC, { role: 'presentation', children: t }), (0, d.jsx)(v.nv, { children: r })] })] });
    };
   var S = t(14669);
   const C = (e) => {
    ...
    M = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(y, { level: t, suffix: a && (0, d.jsx)(b.y, { state: a }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  42677: (e, n, t) => {
   'use strict';
