(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [88021],
 {
  19896: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => y, contentTitle: () => a, default: () => m, description: () => j, frontMatter: () => s, issueNumber: () => g, metadata: () => l, title: () => d, toc: () => h });
   var r = n(52676),
    i = n(40139),
    c = n(66840),
    o = n(8657);
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => s, Ee: () => u, Q6: () => c, U: () => j, Yr: () => m, d: () => h, e9: () => o, fO: () => k, mA: () => i, ps: () => g, qU: () => b, s0: () => v, zP: () => y });
