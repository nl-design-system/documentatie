 ...
 [50186],
 {
  ...
  20201(e, n, t) {
   ...
   const o = s.forwardRef(function (e, n) {
    const [t, o] = s.useState(!1),
     ...
     f = s.useMemo(() => (e.playlist ? `${y}/embed/videoseries?${b.toString()}` : `${y}/embed/${d}?${b.toString()}`), [e.playlist, y, d, b]),
     ...
     j = k
      ...
      : null,
     x = s.useMemo(() => e.thumbnail || j || `https://i.ytimg.com/${v}/${e.playlist ? m : d}/${h}.${w}`, [e.thumbnail, j, v, e.playlist, m, d, h, w]),
     ...
     M = s.useCallback(e.onIframeAdded || function () {}, [e.onIframeAdded]),
    ...
    return (
     ...
     }, [l, e.enableJsApi, e.onReady, e.onStateChange, e.onError, e.onPlay, e.onPause, e.onEnd, e.onBuffering, e.onPlaybackRateChange, e.onPlaybackQualityChange, e.stopOnEnd, e.id, d, p, n]),
     (0, a.jsxs)(a.Fragment, {
      children: [
       !e.lazyLoad && (0, a.jsx)('link', { rel: _, href: x, as: 'image' }),
       (0, a.jsx)(a.Fragment, { children: t && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)('link', { rel: 'preconnect', href: y }), (0, a.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), D && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, a.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
       e.seo && !e.playlist && (0, a.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: r(e.id, p, x, y, e.seo) } }),
       L && !e.playlist && (0, a.jsx)('noscript', { children: (0, a.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${p} on YouTube`, children: ['Watch "', p, '" on YouTube'] }) }),
       (0, a.jsxs)(E, {
        onPointerOver: () => {
         t || o(!0);
        },
        ...
        children: [e.lazyLoad && !l && (0, a.jsx)('img', { src: x, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !l && (0, a.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && l) && (0, a.jsx)('button', { type: 'button', className: O, 'aria-label': `${u} ${p}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, onClick: P, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: u }) }), l && (0, a.jsx)('iframe', { ref: n, className: T, title: p, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: f, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  31439(e, n, t) {
   ...
   const l = new Date().toISOString(),
    c = ({ lang: e = 'nl', headingLevel: n = 3, allSpeakers: t, videoId: c, children: d, allSessions: m, sessionId: p }) => {
     const h = m?.find(({ uuid: e }) => p === e),
      u = h && h.speakers.map((e) => t[e]).filter(Boolean),
      g = [c, h?.videoId, ...(h?.videoIds ?? [])].filter(Boolean);
     return h ? (0, o.jsxs)('article', { className: (0, i.A)('ma-dsw-session'), children: [(0, o.jsx)(s.DZ, { level: n, className: 'ma-dsw-session__title', id: h.subject.toLowerCase().replace(/\s/gi, '-'), children: h.subject }), (0, o.jsx)(s.fz, { className: 'ma-dsw-session__subtitle', lead: !0, children: u && u.map((e) => (e?.organisation ? `${e.name} - ${e.organisation}` : e.name)).join(' & ') }), g.length > 0 && g.map((e) => (0, o.jsx)(r.L, { id: e, title: h.subject, style: { marginBlock: '20px' } }, e)), h && h.isoDateTime && h.isoDateTime > l ? (0, o.jsx)(s.fz, { children: (0, o.jsx)('time', { dateTime: h.isoDateTime, children: new Intl.DateTimeFormat(e, { dateStyle: 'full', timeStyle: 'nl' === e ? 'short' : 'full', timeZone: 'Europe/Amsterdam' }).format(new Date(h.isoDateTime)) }) }) : (0, o.jsx)(o.Fragment, {}), d, 'nl' === e && u.find(({ language: e }) => 'nl' !== e) && (0, o.jsxs)(s.fz, { children: [(0, o.jsx)('b', { children: 'Goed te weten:' }), ' Deze sessie is in het Engels.'] }), h.captioned ? (h.captionId ? (0, o.jsx)(o.Fragment, { children: (0, o.jsxs)(s.fz, { children: ['nl' === e ? (0, o.jsx)(o.Fragment, { children: (0, o.jsx)('b', { children: 'Bij deze sessie is een schrijftolk aanwezig: ' }) }) : (0, o.jsx)(o.Fragment, { children: (0, o.jsx)('b', { children: 'Live captioning is available for this session: ' }) }), (0, o.jsxs)('a', { href: `https://text-on-tap.live/#e=${h.captionId}`, children: [(0, o.jsxs)('span', { className: 'sr-only', children: [h.subject, ' '] }), 'nl' === e ? 'in de browser' : 'in the browser'] }), 'nl' === e ? ' of ' : ' or ', (0, o.jsxs)('a', { href: `https://text-on-tap.live/openoverlay.html?e=${h.captionId}`, children: [(0, o.jsxs)('span', { className: 'sr-only', children: [h.subject, ' '] }), 'nl' === e ? 'met de Overlay tool' : 'with the de Overlay tool'] })] }) }) : 'nl' === e ? (0, o.jsx)(s.fz, { children: 'Voor deze sessie hebben we nog geen schrijftolk gevonden' }) : (0, o.jsx)(o.Fragment, {})) : (0, o.jsx)(o.Fragment, {}), (0, o.jsx)('aside', { className: (0, i.A)('ma-dsw-session__speakers'), children: u.map((n, t) => (0, o.jsxs)('div', { className: (0, i.A)('ma-dsw-session__speaker', 'ma-dsw-speaker'), children: [(0, o.jsx)('img', { className: (0, i.A)('ma-dsw-speaker__image'), src: n.image.src, alt: n.image.alt }), (0, o.jsx)(s.fz, { className: (0, i.A)('ma-dsw-speaker__description'), dangerouslySetInnerHTML: { __html: n.description[e] } })] }, t)) }), h && h.icalLink && !c ? (0, o.jsx)(s.fz, { children: (0, o.jsxs)(s.vx, { href: h.icalLink, download: h.icalLink, appearance: 'primary-action-button', children: [(0, o.jsx)(s.In, { children: (0, o.jsx)(a.A, {}) }), (0, o.jsx)('span', { children: 'nl' === e ? (0, o.jsxs)(o.Fragment, { children: ['Zet', (0, o.jsx)('span', { className: 'sr-only', children: h.subject }), ' in je agenda'] }) : (0, o.jsxs)(o.Fragment, { children: ['Add', (0, o.jsx)('span', { className: 'sr-only', children: h.subject }), ' to your calendar'] }) })] }) }) : null] }) : (0, o.jsx)(o.Fragment, {});
    };
  },
  32385(e, n, t) {
   t.d(n, { bo: () => s, KF: () => p, mJ: () => g, VZ: () => x, cR: () => j, Pv: () => b, qZ: () => r, kD: () => w, QQ: () => D, B2: () => h, Pc: () => l, f4: () => o, GT: () => v, fX: () => i, eQ: () => k, B_: () => f, o_: () => y });
   ...
   const m = (e) => [...e].sort((e, n) => c.indexOf(e) - c.indexOf(n)),
    ...
    g = (e) => m(d(e.projects.flatMap((e) => u(e)))),
    b = (e) => {
     const n = u(e),
      t = ((e) => {
  ...
  56561(e, n, t) {
   ...
   var m = (0, o.forwardRef)(function (e, n) {
    var t = e.children,
     ...
     c = e.purpose,
     m = (0, s.A)(e, l);
    return (0, i.jsx)('p', d(d({ className: (0, r.$)('nl-paragraph', (0, a.A)({}, 'nl-paragraph--lead', 'lead' === c), o), ref: n }, m), {}, { children: 'lead' === c ? (0, i.jsx)('b', { className: 'nl-paragraph__lead', children: t }) : t }));
   });
