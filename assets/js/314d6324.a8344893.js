...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [54348],
 {
  10645(e, a, n) {
   ...
   var t = n(13526),
    i = n(86070);
   const s = ({ children: e, className: a, level: n = 1, suffix: s, ...l }) => (0, i.jsxs)('hgroup', { className: (0, t.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, a), ...l, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), s && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
  },
  21034(e, a, n) {
   n.d(a, { VK: () => b, $9: () => v, mu: () => j, Fc: () => k, K_: () => D });
   var t = n(29181),
    i = n(13526),
    s = n(40889),
    l = n(21530),
   ...
   var x = n(70348),
    f = n(85162);
   const b = ({ component: e, headingLevel: a }) => {
     const n = e && e.projects.filter((e) => p.f4.includes(e.id)),
      s = n && p.f4.map((e) => n.find((a) => a.id === e)).filter(Boolean);
     return e && (0, d.jsx)(x.n, { children: s.map((n) => (0, d.jsx)(x.K, { className: (0, i.A)('ma-definition-of-done', n && `ma-definition-of-done--${(0, p.fX)(n.title)}`), heading: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', headingLevel: a, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(c._, { children: n.tasks.map(({ checked: e, name: n, id: t }) => (0, d.jsx)(c.Z, { headingLevel: a + 1, checked: e, heading: n, description: (0, p.qZ)(t) }, t)) }), (0, d.jsx)(t.fz, { children: (0, d.jsxs)(t.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) }, n.title)) });
    },
    j = ({ component: e, headingLevel: a }) => {
     const n = e && e.projects.filter((e) => !p.f4.includes(e.id));
     return e && n.length
      ? (0, d.jsx)(l.AC, {
         appearance: 'large',
            ...
            l.Zp,
            {
             ...
             children: (0, d.jsxs)(l.Wu, {
              children: [
               ...
               (u.length > 0 || r.length > 0) && (0, d.jsx)(t.DZ, { level: a + 1, children: 'Snel aan de slag' }),
               u.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               r.length > 0 && (0, d.jsx)(d.Fragment, { children: r.map(({ frameworkName: e, tasks: n }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.DZ, { level: a + 2, children: [i, ' in ', e] }), (0, d.jsx)(t.dk, { links: n.map((e) => ({ children: e.description, icon: (0, d.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    k = ({ component: e, headingLevel: a, description: n }) => {
     const i = e && p.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: a, suffix: i && (0, d.jsx)(u.D, { state: i }), children: e.title }), (0, d.jsx)(t.fz, { lead: !0, children: n }), ['Help Wanted', 'Community'].includes(i) && (0, d.jsx)(f.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    D = ({ component: e }) => {
     const a = (e && h[e.title]) || [];
  ...
  21530(e, a, n) {
   n.d(a, { AC: () => d, Fu: () => l, Wu: () => r, Zp: () => o });
   var t = n(46447),
    i = n(13526),
    s = n(86070);
   const l = ({ background: e, children: a, className: n, ...t }) => (0, s.jsx)('div', { className: (0, i.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, n), ...t, children: a }),
    r = (e) => (0, s.jsx)('div', { className: 'ma-card__content', ...e }),
    o = ({ href: e, appearance: a, className: n, component: l = 'div', background: r, children: o }) => {
     const d = (e) => ('article' === l ? (0, s.jsx)('article', { ...e }) : 'section' === l ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      g = (0, s.jsx)(d, { className: (0, i.A)('ma-cardgroup__card', r && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${a}`, n), children: o });
     return e ? (0, s.jsx)(t.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: g }) : g;
    },
    d = ({ appearance: e = 'large', children: a, className: n }) => (0, s.jsx)('div', { className: (0, i.A)('ma-cardgroup', `ma-cardgroup--${e}`, n), children: a });
  },
  32385(e, a, n) {
   n.d(a, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => x, qZ: () => l, kD: () => v, QQ: () => H, B2: () => c, Pc: () => o, f4: () => r, GT: () => k, fX: () => s, eQ: () => j, B_: () => b, o_: () => f });
      ...
      const t = e.tasks
       ...
       .map(({ name: t, id: i, value: s }) => {
        const l = /^(.+) URL/.exec(t)[1],
         r = 'Storybook' === l ? `${n} (${a}) in Storybook van ${e.title}` : `${n} (${a}) op ${l}`;
   ...
   const D = () => {
    ...
    H = (e) => {
     const a = e.split('/').pop() ?? '',
      n = a.split('.').pop()?.toLowerCase();
     return void 0 !== n && N.has(n);
    };
  },
  37970(e, a, n) {
   (n.r(a), n.d(a, { assets: () => g, component: () => x, componentName: () => h, contentTitle: () => d, default: () => j, description: () => m, frontMatter: () => o, issueNumber: () => c, metadata: () => t, relayStep: () => p, title: () => u, toc: () => f }));
   ...
   const o = { title: 'Data Summary', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Data Summary', pagination_label: 'Data Summary', description: 'Lijst met eigenschappen en bijbehorende data over een onderwerp.', issue_number: 357, slug: '/data-summary', keywords: ['check', 'controle', 'data', 'data overzicht', 'data list', 'datalijst', 'data samenvatting', 'data summary', 'definitie lijst', 'definition list', 'eigenschappen', 'eigenschappenlijst', 'key', 'lijst', 'list', 'list group', 'overzicht', 'summary', 'samenvatting', 'summary data', 'terugkoppeling', 'value', 'waarde'] },
    ...
    g = {},
    u = 'Data Summary',
    m = 'Lijst met eigenschappen en bijbehorende data over een onderwerp.',
    c = 357,
    p = 'help wanted',
    h = 'data-summary',
   ...
   function j(e = {}) {
    ...
    return a ? (0, i.jsx)(a, { ...e, children: (0, i.jsx)(b, { ...e }) }) : b(e);
   }
  },
  39569(e, a, n) {
   n.d(a, { D: () => r });
   ...
   const r = ({ state: e }) => {
    const a = (0, s.fX)(e);
    return (0, l.jsx)(t.KE, { className: (0, i.A)('ma-estafette-badge', a && `ma-estafette-badge--${a}`), children: e });
   };
  },
  40889(e, a, n) {
   n.d(a, { r: () => u });
  ...
  70348(e, a, n) {
   ...
   var t = n(13526),
    ...
    l = n(37168),
    r = n(86070);
   const o = (0, i.forwardRef)(({ as: e, className: a, children: n, ...i }, s) => {
     const l = e || 'div',
      o = (0, t.A)('ma-utrecht-accordion', 'utrecht-accordion', a);
     return (0, r.jsx)(l, { ref: s, className: o, ...i, children: n });
    }),
    d = ({ className: e, classNamePanel: a, label: n, heading: i, headingLevel: o, headingApperance: d, ...g }) => {
     const u = (0, t.A)('utrecht-accordion__section', e),
      m = (0, t.A)('utrecht-accordion__panel', a);
     return (0, r.jsxs)('details', { className: u, ...g, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(s.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [i && (0, r.jsx)(l.D, { level: o, appearance: d, children: i }), n] })] }) }), (0, r.jsx)('div', { className: m, children: g.children })] });
    };
  },
  85162(e, a, n) {
   n.d(a, { s: () => o });
