...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [64852],
 {
  ...
  28430: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => h, contentTitle: () => p, default: () => b, frontMatter: () => u, metadata: () => v, toc: () => g });
   var t = l(52676),
    o = l(87118),
    r = l(49824),
    s = l(43599),
   ...
   function a(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(i.X, { appearance: 'dont', title: 'Herhaling ter bevestiging.', children: (0, t.jsx)(s.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.label, { htmlFor: 'email1', children: 'Uw e-mailadres' }), (0, t.jsx)(n.input, { id: 'email1', type: 'email', name: 'email', autoComplete: 'email' }), (0, t.jsx)(n.label, { htmlFor: 'email2', children: 'Herhaal uw e-mailadres' }), (0, t.jsx)(n.input, { id: 'email2', type: 'email', name: 'email', autoComplete: 'email' })] }) }) })] });
   }
   function c(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
  ...
  43599: (e, n, l) => {
   ...
   const y = (e) => {
    ...
    let F = m.Fragment;
    return (
     'paragraph' === f ? (F = v) : 'document' === f ? (F = h) : 'surface' === f && (F = g),
     (0, p.jsxs)('div', {
      className: (0, r.Z)('nlds-canvas'),
      children: [
       _ && (0, p.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, p.jsx)(F, { children: (0, p.jsx)(o.pu, { children: _ }) }) }) }),
       b &&
        (0, p.jsx)('div', {
    ...
    return (
     ...
     (0, a.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: v, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, a.jsx)(t.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': v, style: l, children: o.map((e, l) => (0, a.jsxs)('span', { ...r({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
