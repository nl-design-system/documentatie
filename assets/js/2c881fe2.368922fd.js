 ...
 [94810],
 {
         ...
         children: [
          ...
          (0, m.jsx)('div', {
           children: (0, m.jsxs)(m.Fragment, {
            children: [
             (0, m.jsxs)(o.f, { role: 'status', children: [j, ' van de ', w, ' items zijn nu zichtbaar.'] }),
             j < w
              ? (0, m.jsx)(l.$, {
                 purpose: 'secondary',
                 onClick: () => {
  ...
  24456(e, n, t) {
   ...
   const a = ({ children: e, ...n }) => {
    ...
    o = ({ className: e, boxContent: n, ...t }) => (0, s.jsx)(a, { className: (0, i.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  24908(e, n, t) {
   t.d(n, { Ay: () => a });
   var i = t(86070),
               ...
               d.Z,
               {
                ...
                description: (0, c.jsxs)('div', {
                 ...
                 children: [
                  ...
                  u.length > 0 && u.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)('section', { children: [(0, c.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(o.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
  ...
  61994(e, n, t) {
   (t.r(n), t.d(n, { assets: () => R, component: () => D, contentTitle: () => T, default: () => W, description: () => G, frontMatter: () => y, issueNumber: () => N, metadata: () => i, title: () => L, toc: () => F }));
   ...
   const j = [
     ...
     { title: 'De Ordered List komt niet voor in de normale focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: w.Ay, tags: ['developer'] },
     {
    ...
    x = [
     ...
     { title: 'De Ordered List is standaard niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: h.Ay, tags: ['developer'] },
     { title: 'De Ordered List komt standaard niet voor in de focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: p.Ay, tags: ['developer'] },
    ];
   var b = t(13839),
    A = t(37674),
    v = t(78134),
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => k, cR: () => v, Pv: () => w, qZ: () => a, kD: () => b, QQ: () => y, B2: () => m, Pc: () => l, f4: () => o, GT: () => A, fX: () => s, eQ: () => x, B_: () => j, o_: () => f });
