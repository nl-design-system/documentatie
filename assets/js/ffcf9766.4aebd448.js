 ...
 [7869],
 {
  16641: (e, t, n) => {
   ...
   const s = { title: 'Number input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number input', pagination_label: 'Number input', description: 'Invoerveld voor een heel getal of een getal met decimalen.', slug: '/number-input' },
    a = void 0,
    u = { id: 'componenten/number-input/index', title: 'Number input', description: 'Invoerveld voor een heel getal of een getal met decimalen.', source: '@site/docs/componenten/number-input/index.mdx', sourceDirName: 'componenten/number-input', slug: '/number-input', permalink: '/number-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/number-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Number input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number input', pagination_label: 'Number input', description: 'Invoerveld voor een heel getal of een getal met decimalen.', slug: '/number-input' }, sidebar: 'componenten', previous: { title: 'Number badge', permalink: '/number-badge' }, next: { title: 'Ordered list', permalink: '/ordered-list' } },
    l = {},
    d = [
