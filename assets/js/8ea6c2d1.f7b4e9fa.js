 ...
 [6985],
 {
  ...
  21034(e, n, t) {
   ...
   const j = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, d.jsx)(b.n, { children: i.map((t) => (0, d.jsx)(b.K, { className: (0, a.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, p.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m._, { children: t.tasks.map(({ checked: e, name: t, id: s }) => (0, d.jsx)(m.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, p.qZ)(s) }, s)) }), (0, d.jsx)(s.fz, { children: (0, d.jsxs)(s.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
            ...
            r.Zp,
            {
             ...
             children: (0, d.jsxs)(r.Wu, {
              children: [
               ...
               (g.length > 0 || o.length > 0) && (0, d.jsx)(s.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               g.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               o.length > 0 && (0, d.jsx)(d.Fragment, { children: o.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(s.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, d.jsx)(s.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    A = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u.p, { level: n, suffix: a && (0, d.jsx)(g.D, { state: a }), children: e.title }), (0, d.jsx)(s.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(a) && (0, d.jsx)(f.s, { relayStep: a, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    v = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  32385(e, n, t) {
   'use strict';
   t.d(n, { bo: () => a, KF: () => u, mJ: () => h, VZ: () => k, cR: () => v, Pv: () => b, qZ: () => r, kD: () => x, QQ: () => T, B2: () => m, Pc: () => l, f4: () => o, GT: () => A, fX: () => i, eQ: () => w, B_: () => j, o_: () => f });
  ...
  70903(e, n, t) {
   ...
   var u = t(43864),
    ...
    A = t(23436),
    v = t(79532);
   const k = { boxShadow: u.A, color: m.A, cursor: p.A, dimension: h.A, fontFamily: b.A, fontFamilies: b.A, fontSize: f.A, fontSizes: f.A, fontWeight: j.A, fontWeights: j.A, lineHeight: w.A, lineHeights: w.A, number: x.A, other: A.A, textDecoration: v.A },
    y = ({ type: e }) => {
  ...
  71544(e, n, t) {
   ...
   var g = (0, o.forwardRef)(function (e, n) {
    var t = e.children,
     ...
     d = e.purpose,
     g = (0, a.A)(e, l);
    return (0, i.jsx)('p', c(c({ className: (0, r.$)('nl-paragraph', (0, s.A)({}, 'nl-paragraph--lead', 'lead' === d), o), ref: n }, g), {}, { children: 'lead' === d ? (0, i.jsx)('b', { className: 'nl-paragraph__lead', children: t }) : t }));
   });
  ...
  75213(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => H, component: () => O, contentTitle: () => W, default: () => M, description: () => B, frontMatter: () => _, issueNumber: () => z, metadata: () => s, title: () => P, toc: () => I }));
        ...
        (0, m.jsxs)('div', {
         ...
         children: [
          (0, m.jsxs)(r.LB, {
           ...
           'aria-labelledby': A,
           children: [
            (0, m.jsx)(c.DZ, { level: n, id: A, children: 'Filter acceptatiecriteria voor:' }),
            Array.from(g).map((e) =>
             (0, m.jsxs)(
              r.zB,
              {
   ...
   var g = function (e) {
    ...
    m =
     ...
     (0, o.forwardRef)(function (e, n) {
      ...
      return (0, i.jsxs)('button', c(c({ ref: n, type: A, className: (0, r.$)('nl-button', s, { 'nl-button--pressed': j, 'nl-button--busy': w, 'nl-button--disabled': b || f, 'nl-button--primary': 'primary' === p, 'nl-button--secondary': 'secondary' === p, 'nl-button--subtle': 'subtle' === p, 'nl-button--positive': u(p) && 'positive' === h, 'nl-button--negative': u(p) && 'negative' === h, 'nl-button--icon-only': d }), 'aria-pressed': k ? String(Boolean(j)) : void 0, 'aria-disabled': b || w ? 'true' : void 0, disabled: f }, y), {}, { children: [m && (0, i.jsx)('span', { className: 'nl-button__icon-start', children: m }), v && (0, i.jsx)('span', { className: 'nl-button__label', children: v }), C ? (0, i.jsx)('span', { className: d ? 'nl-button__label' : '', children: t }) : t, g && (0, i.jsx)('span', { className: 'nl-button__icon-end', children: g })] }));
     }));
