 ...
 [10709],
 {
  ...
  39772: (e, n, r) => {
   ...
   var i = r(13894),
    ...
    s = r(52676);
   function c(e) {
    let { href: n, icon: r = '', title: i, description: o, children: c } = e;
    return (0, s.jsxs)('div', { className: 'card', children: [n ? (0, s.jsx)(t.r, { href: n, className: (0, l.Z)('cardLink', 'utrecht-link'), children: (0, s.jsxs)('h2', { className: 'cardTitle', children: [r, ' ', i] }) }) : (0, s.jsxs)('h2', { className: 'cardTitle', children: [r, ' ', i] }), o && (0, s.jsx)('p', { className: 'cardDescription', children: o }), c] });
   }
   function a(e) {
    let { item: n } = e;
   ...
   function j(e) {
    ...
    const t = (0, i.MN)(n);
    return (0, s.jsx)('section', { className: (0, l.Z)('row', r), children: t.map((e, n) => (0, s.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, s.jsx)(h, { item: e }) }, n)) });
   }
  },
  87118: (e, n, r) => {
   r.d(n, { Z: () => s, a: () => l });
