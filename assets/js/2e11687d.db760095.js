 ...
 [71537],
 {
  ...
  17889(e, t, n) {
   ...
   var p = n(30696),
    ...
    v = n(43825),
    x = n(30758);
   const A = { color: p.A, dimension: j.A, fontFamilies: y.A, fontSizes: w.A, fontWeights: f.A, lineHeights: b.A, other: k.A, textDecoration: v.A },
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => u, mJ: () => p, VZ: () => A, cR: () => x, Pv: () => j, qZ: () => o, kD: () => b, B2: () => g, Pc: () => c, f4: () => a, GT: () => k, fX: () => i, eQ: () => f, B_: () => w, o_: () => y, Rc: () => v });
