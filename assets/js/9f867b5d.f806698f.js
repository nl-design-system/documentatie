 ...
 [12487],
 {
  41792: (e, t, n) => {
   ...
   const j = (e) => {
     ...
     return (0, a.jsxs)(h.Zb, { appearance: 'large', className: (0, p.Z)('component-card', !s && 'component-card--suggestion'), component: 'section', children: [(0, a.jsx)(h.wu, { children: (0, a.jsx)(u, { relayStep: s, description: `Schets van de ${t} component`, name: t }) }), (0, a.jsxs)(h.aY, { children: [(0, a.jsxs)('div', { children: [(0, a.jsx)(c.X6, { level: r, className: 'component-card__title', children: t }), s && (0, a.jsx)('p', { children: (0, a.jsx)(x.y, { state: s }) }), n && (0, a.jsx)(c.nv, { children: n })] }), l && (0, a.jsx)(c.nv, { children: (0, a.jsxs)(m.Z, { className: 'utrecht-link', to: l, children: ['Bekijk ', (0, a.jsx)('span', { className: 'w', children: t }), ' component'] }) })] })] });
    },
    f = () => {
     const e = 'filter',
      t = 'todo',
     ...
     const X = v.filter((e) => 'UNKNOWN' === e.relayStep),
      V = v.filter((e) => 'HELP_WANTED' === e.relayStep),
      I = v.filter((e) => 'COMMUNITY' === e.relayStep),
     ...
     return (0, a.jsxs)(a.Fragment, {
      children: [
       (0, a.jsx)(o.a2, { sections: [{ className: 'utrecht-accordion--nlds-subtle', headingLevel: 2, expanded: !1, label: (0, a.jsx)('span', { id: 'filter-results-label', children: 'Filter componenten' }), body: (0, a.jsx)(a.Fragment, { children: (0, a.jsxs)(o.pg, { 'aria-describedby': 'filter-results', 'aria-labelledby': 'filter-results-label', children: [!!X.length && (0, a.jsxs)(c.Wi, { type: 'checkbox', children: [(0, a.jsx)(c.XZ, { defaultChecked: D, id: 'TODO', onChange: () => y((e) => !e) }), (0, a.jsx)(c.lX, { htmlFor: 'TODO', children: (0, a.jsx)(x.y, { state: 'Todo' }) })] }), !!V.length && (0, a.jsxs)(c.Wi, { type: 'checkbox', children: [(0, a.jsx)(c.XZ, { defaultChecked: T, id: 'HELP_WANTED', onChange: () => C((e) => !e) }), (0, a.jsx)(c.lX, { htmlFor: 'HELP_WANTED', children: (0, a.jsx)(x.y, { state: 'Help Wanted' }) })] }), !!I.length && (0, a.jsxs)(c.Wi, { type: 'checkbox', children: [(0, a.jsx)(c.XZ, { defaultChecked: w, id: 'COMMUNITY', onChange: () => E((e) => !e) }), (0, a.jsx)(c.lX, { htmlFor: 'COMMUNITY', children: (0, a.jsx)(x.y, { state: 'Community' }) })] }), !!B.length && (0, a.jsxs)(c.Wi, { type: 'checkbox', children: [(0, a.jsx)(c.XZ, { defaultChecked: O, id: 'CANDIDATE', onChange: () => M((e) => !e) }), (0, a.jsx)(c.lX, { htmlFor: 'CANDIDATE', children: (0, a.jsx)(x.y, { state: 'Candidate' }) })] }), !!W.length && (0, a.jsxs)(c.Wi, { type: 'checkbox', children: [(0, a.jsx)(c.XZ, { defaultChecked: F, id: 'HALL_OF_FAME', onChange: () => L((e) => !e) }), (0, a.jsx)(c.lX, { htmlFor: 'HALL_OF_FAME', children: (0, a.jsx)(x.y, { state: 'Hall of Fame' }) })] }), (0, a.jsxs)(o.nv, { style: { '--utrecht-paragraph-margin-block-end': '1rem' }, children: [(0, a.jsx)('b', { children: 'Tip' }), ': Zien welke componenten je nu al kunt gebruiken? Kies dan onderstaande optie om alleen beschikbare componenten te tonen.'] }), !!H.length && (0, a.jsx)(a.Fragment, { children: (0, a.jsxs)(c.Wi, { type: 'checkbox', className: 'utrecht-form-field--nlds-switch', children: [(0, a.jsx)(o.NI, { defaultChecked: z, id: 'ONLY_IMPLEMENTED', onChange: () => P((e) => !e) }), (0, a.jsx)(c.lX, { htmlFor: 'ONLY_IMPLEMENTED', children: 'Toon alleen beschikbare componenten' })] }) })] }) }) }] }),
       (0, a.jsxs)(o.nv, { role: 'status', id: 'filter-results', children: [S.length, ' van ', v.length, ' componenten zichtbaar'] }),
       (0, a.jsx)(h.um, {
        appearance: 'large',
        children: S.map((e) => {
         let { title: t, id: n, href: s, customProps: r, description: l } = e;
         const o = i.find((e) => e.title === t),
          c = o && g.$3[o.relayStep];
         return (0, a.jsx)(j, { illustration: r?.illustration, name: t, headingLevel: 2, href: s, description: l, relayStep: c }, n);
        }),
       }),
      ],
     });
