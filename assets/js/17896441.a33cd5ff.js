...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [18401],
 {
  ...
  47273(e, t, s) {
   ...
   const m = 'breadcrumbHomeIcon_STkE';
   function h() {
    const e = (0, i.Ay)('/');
   ...
   const x = 'breadcrumbsContainer_TIIe';
  ...
  47464(e, t, s) {
   ...
   var f = s(31378),
    _ = s(98204),
    k = s(63475);
   const A = 'tocCollapsibleButton_ru3C',
    N = 'tocCollapsibleButtonExpanded_ohrT';
   function T({ collapsed: e, ...t }) {
   ...
   const L = 'tocCollapsible_RYGb',
    C = 'tocCollapsibleContent_KcS3',
    M = 'tocCollapsibleExpanded_C97u';
   function w({ toc: e, className: t, minHeadingLevel: s, maxHeadingLevel: o }) {
    const { collapsed: l, toggleCollapsed: n } = (0, f.u)({ initialState: !0 });
    return (0, r.jsxs)('div', { className: (0, u.A)(L, !l && M, t), children: [(0, r.jsx)(T, { collapsed: l, onClick: n }), (0, r.jsx)(f.N, { lazy: !0, className: C, collapsed: l, children: (0, r.jsx)(_.A, { toc: e, minHeadingLevel: s, maxHeadingLevel: o }) })] });
   }
   const S = 'tocMobile_MDU5';
   function V() {
   ...
   function F({ children: e }) {
    ...
    return (0, r.jsxs)('div', { className: (0, u.A)(x.G.docs.docMarkdown, 'markdown'), children: [t && (0, r.jsx)('header', { children: (0, r.jsx)(H.A, { as: 'h1', children: t }) }), (0, r.jsx)(G.A, { children: e })] });
   }
   var $ = s(47273),
    D = s(72434);
   const U = 'docItemContainer_LgMq',
    E = 'docItemCol_kJrR';
   function P({ children: e }) {
    const t = (function () {
      const { frontMatter: e, toc: t } = i(),
       ...
       l = !o && t.length > 0;
      return { hidden: o, mobile: l ? (0, r.jsx)(V, {}) : void 0, desktop: !l || ('desktop' !== s && 'ssr' !== s) ? void 0 : (0, r.jsx)(I, {}) };
     })(),
     { metadata: s } = i();
    return (0, r.jsxs)('div', { className: 'row', children: [(0, r.jsxs)('div', { className: (0, u.A)('col', !t.hidden && E), children: [(0, r.jsx)(D.A, { metadata: s }), (0, r.jsx)(p.A, {}), (0, r.jsxs)('div', { className: U, children: [(0, r.jsxs)('article', { children: [(0, r.jsx)($.A, {}), (0, r.jsx)(v.A, {}), t.mobile, (0, r.jsx)(F, { children: e }), (0, r.jsx)(j, {})] }), (0, r.jsx)(b, {})] })] }), t.desktop && (0, r.jsx)('div', { className: 'col col--3', children: t.desktop })] });
   }
   function R(e) {
