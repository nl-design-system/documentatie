(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [38384],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => g, qZ: () => c, kD: () => b, B2: () => j, Pc: () => a, f4: () => o, GT: () => k, fX: () => s, eQ: () => f, B_: () => v, o_: () => p, Rc: () => x });
  ...
  69847(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => u, component: () => p, componentName: () => g, contentTitle: () => l, default: () => b, description: () => j, frontMatter: () => h, issueNumber: () => y, metadata: () => r, relayStep: () => m, title: () => d, toc: () => v }));
   const r = JSON.parse('{"id":"componenten/definition-list/index","title":"Description List","description":"Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.","source":"@site/docs/componenten/definition-list/index.mdx","sourceDirName":"componenten/definition-list","slug":"/description-list","permalink":"/description-list","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/definition-list/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Description List","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Description List","pagination_label":"Description List","description":"Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.","slug":"/description-list"},"sidebar":"componenten","previous":{"title":"Date Picker","permalink":"/date-picker"},"next":{"title":"Dialog","permalink":"/dialog"}}');
   var i = n(86070),
    s = n(18439),
    c = n(36059),
    o = n(85825),
    a = n(44594);
   const h = { title: 'Description List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Description List', pagination_label: 'Description List', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', slug: '/description-list' },
    l = void 0,
    u = {},
    d = 'Description List',
    j = 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.',
    y = 92,
    m = 'help wanted',
    g = 'definition-list',
