 ...
 [22410],
 {
  1292(e, t, n) {
   ...
   var r = n(14537),
    ...
    a = n(83386),
    l = n(86070);
   const u = { figma: (0, l.jsx)(s.A, {}), github: (0, l.jsx)(i.A, {}), npm: (0, l.jsx)(c.A, {}), storybook: (0, l.jsx)(o.A, {}) },
    h = ({ brand: e }) => (0, l.jsx)(r.In, { children: u[e] || (0, l.jsx)(a.A, {}) });
  },
  4398(e, t, n) {
   'use strict';
   n.d(t, { B2: () => d, B_: () => m, GT: () => k, KF: () => h, Pc: () => o, Pv: () => g, Rc: () => f, bo: () => r, eQ: () => v, f4: () => c, fX: () => s, kD: () => b, mJ: () => y, o_: () => p, qZ: () => i });
   ...
   const c = ({ background: e, children: t, className: n, ...r }) => (0, i.jsx)('div', { className: (0, s.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: c = 'div', background: o, children: a }) => {
     const l = (e) => ('article' === c ? (0, i.jsx)('article', { ...e }) : 'section' === c ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      u = (0, i.jsx)(l, { className: (0, s.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
  ...
  99630(e, t, n) {
   ...
   const m = ({ component: e, headingLevel: t }) => {
    ...
    k = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(h.p, { level: t, suffix: s && (0, a.jsx)(u.D, { state: s }), children: e.title }), (0, a.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
 },
]);
