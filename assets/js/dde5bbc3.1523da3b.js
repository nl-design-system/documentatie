 ...
 [82479],
 {
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const t = 'function' == typeof e ? e() : e,
        ...
        s = p().highlight(o, p().languages[n], n);
       return (0, x.jsxs)('div', { className: (0, r.A)('ma-canvas-astro', l), children: [(0, x.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }), (0, x.jsx)(b.n, { children: (0, x.jsx)(b.K, { label: 'Code', children: (0, x.jsx)('pre', { className: 'language-html nl-code-block', children: (0, x.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: m = !0, children: p, container: b = 'document', language: y, designTokens: f }) => {
       ...
       (0, u.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(w, { parser: y, plugins: [s.A, a.Ay, i.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [w]);
       const S = (0, u.useId)();
         ...
         children: [
          ...
          m &&
           (0, x.jsxs)('div', {
            ...
            hidden: !z,
            children: [
             (0, x.jsx)(t.M, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: N, trim: !0 }),
             n &&
              (0, x.jsx)('div', {
  ...
  41588(e, n, l) {
   ...
   function c(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', (0, o.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, o.jsx)(i.$, { appearance: 'do', title: 'Formulier zonder tabindex.', children: (0, o.jsx)(a.H, { language: 'html', children: () => (0, o.jsx)(o.Fragment, { children: (0, o.jsxs)('form', { children: [(0, o.jsx)('p', { children: (0, o.jsx)('label', { htmlFor: 'naam1', children: 'Uw naam' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('input', { id: 'naam1', autoComplete: 'name' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('label', { htmlFor: 'email1', children: 'Uw e-mailadres' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('input', { id: 'email1', autoComplete: 'email' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('button', { children: 'Stuur mij de nieuwsbrief!' }) })] }) }) }) }), '\n', (0, o.jsx)(i.$, { appearance: 'dont', title: 'Formulier met gebruik van een positieve tabindex.', children: (0, o.jsx)(a.H, { language: 'html', children: () => (0, o.jsx)(o.Fragment, { children: (0, o.jsxs)('form', { children: [(0, o.jsx)('p', { children: (0, o.jsx)('label', { htmlFor: 'naam2', children: 'Uw naam' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('input', { id: 'naam2', autoComplete: 'name', tabIndex: '1' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('label', { htmlFor: 'email2', children: 'Uw e-mailadres' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('input', { id: 'email2', autoComplete: 'email' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('button', { children: 'Stuur mij de nieuwsbrief!' }) })] }) }) }) })] });
   }
   function d(e = {}) {
  ...
  51627(e, n, l) {
   ...
   const a = ({ className: e, ...n }) => {
    ...
    i = ({ className: e, label: n, heading: l, headingLevel: a, headingApperance: i, ...c }) => {
     ...
     return (0, s.jsxs)('details', { className: d, ...c, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(o.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [l && (0, s.jsx)(r.D, { level: a, appearance: i, children: l }), n] })] }) }), (0, s.jsx)('div', { className: 'utrecht-accordion__panel', children: c.children })] });
    };
  },
  78734(e, n, l) {
   l.d(n, { Ay: () => a, RM: () => r });
  ...
  95822(e, n, l) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: l, trim: c }) {
    ...
    const { title: u, type: h } = (0, r.useContext)(s.x),
     m = (0, r.useId)();
    return (c && (d = d.trim()), (0, i.jsx)(o.f4, { theme: a, code: d, language: n || '', children: ({ style: n, tokens: l, getLineProps: o, getTokenProps: r }) => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, i.jsx)(t.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': m, style: n, children: l.map((n, l) => (0, i.jsxs)('span', { ...o({ line: n }), children: [e && (0, i.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, i.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
 },
]);
