 ...
 [15412],
 {
  ...
  98480: (e, n, t) => {
   ...
   const v = (e) => {
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (Z = await s.ZP.format(N, { parser: f, plugins: [r.Z, o.ZP, a.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(Z);
     })();
    }, [N]);
    const B = (0, c.useId)();
    let A = c.Fragment;
  ...
  41179: (e, n, t) => {
   ...
   function s(e) {
    let { lineNumber: n, syntax: t, textContent: s, trim: c } = e,
     u = s;
    const { title: m, type: p } = (0, r.useContext)(o.n),
     h = (0, r.useId)();
    return (
     c && (u = u.trim()),
     (0, d.jsx)(i.y$, {
      ...
      language: t || '',
      children: (e) => {
       let { style: t, tokens: i, getLineProps: r, getTokenProps: o } = e;
       return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', m ? ': ' : ' ', m] }), (0, d.jsx)(l.dn, { tabIndex: 0, role: m ? 'region' : void 0, 'aria-labelledby': h, style: t, children: i.map((e, t) => (0, d.jsxs)('span', { ...r({ line: e }), children: [n && (0, d.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, d.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, t) => {
   ...
   const c = (0, a.createContext)({}),
    u = (e) => {
     let { title: n, appearance: t, description: a, children: u, figure: m } = e;
     const p = { do: 'Doen', dont: 'Niet doen' },
      h = m ? 'figure' : 'div',
      b = m ? 'figcaption' : 'div';
     return (0, s.jsxs)(h, { className: (0, o.Z)(d['nlds-guideline'], d[`nlds-guideline--${t}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, s.jsxs)(b, { className: (0, o.Z)(d['nlds-guideline__description']), children: ['dont' === t ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(r.nv, { className: (0, o.Z)(d['nlds-guideline__badge'], d[`nlds-guideline__badge--${t}`]), children: [(0, s.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: d['nlds-guideline__icon'] }), (0, s.jsx)('span', { className: d['nlds-guideline__title'], children: p.dont })] }), (0, s.jsx)(r.nv, { children: n })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(r.nv, { className: (0, o.Z)(d['nlds-guideline__badge'], d[`nlds-guideline__badge--${t}`]), children: [(0, s.jsx)(i.Z, { 'aria-hidden': 'true', role: 'presentation', className: d['nlds-guideline__icon'] }), (0, s.jsx)('span', { className: d['nlds-guideline__title'], children: p.do })] }), (0, s.jsx)(r.nv, { children: n })] }), a] }), (0, s.jsx)('div', { className: (0, o.Z)(d['nlds-guideline__example']), children: (0, s.jsx)(c.Provider, { value: { title: n, type: p[t] }, children: u }) })] });
    };
  },
  24785: (e, n, t) => {
   t.d(n, { Z: () => a, a: () => o });
