 ...
 [45129],
 {
   ...
   const d = (0, o.createContext)({}),
    p = ({ title: e, appearance: n, description: t, children: o, figure: p }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      u = p ? 'figure' : 'div',
      v = p ? 'figcaption' : 'div',
      j = 'string' == typeof t ? (0, c.jsx)(s.oz, { components: { a: a.N_ }, children: t }) : t;
  ...
  70348(e, n, t) {
   ...
   const o = (0, r.forwardRef)(({ as: e, className: n, children: t, ...r }, a) => {
     ...
     return (0, s.jsx)(l, { ref: a, className: o, ...r, children: t });
    }),
    c = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: o, headingApperance: c, ...d }) => {
     const p = (0, i.A)('utrecht-accordion__section', e),
      h = (0, i.A)('utrecht-accordion__panel', n);
     return (0, s.jsxs)('details', { className: p, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(a.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(l.D, { level: o, appearance: c, children: r }), t] })] }) }), (0, s.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => x });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const i = 'function' == typeof e ? e() : e,
        ...
        l = v().highlight(r, v().languages[n], n);
       return (0, m.jsxs)('div', { className: (0, a.A)('ma-canvas-astro', t), children: [(0, m.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }), (0, m.jsx)(j.n, { children: (0, m.jsx)(j.K, { label: 'Code', children: (0, m.jsx)('pre', { className: 'language-html nl-code-block', children: (0, m.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: l } }) }) }) })] });
      }
