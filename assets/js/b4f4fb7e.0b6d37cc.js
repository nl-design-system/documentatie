 ...
 [26347],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    u = n(86070);
   const l = { figma: (0, u.jsx)(s.A, {}), github: (0, u.jsx)(c.A, {}), npm: (0, u.jsx)(i.A, {}), storybook: (0, u.jsx)(o.A, {}) },
    h = ({ brand: e }) => (0, u.jsx)(r.In, { children: l[e] || (0, u.jsx)(a.A, {}) });
  },
  1842(e, t, n) {
   'use strict';
   n.d(t, { VK: () => v, $9: () => k, mu: () => b, Fc: () => f });
   var r = n(29181),
    s = n(13526),
    c = n(1292),
    i = n(90495),
   ...
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: c.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, m.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(g, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(p, { headingLevel: t + 1, checked: e, title: n, description: (0, m.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            i.Zp,
            {
             ...
             children: (0, u.jsxs)(i.Wu, {
              children: [
               ...
               o.length > 0 && (0, u.jsx)(u.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: t + 2, children: [s, ' in ', e] }), (0, u.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, u.jsx)(c.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => d, mJ: () => g, VZ: () => _, cR: () => w, Pv: () => p, qZ: () => i, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => c, eQ: () => b, B_: () => v, o_: () => m, Rc: () => x });
  ...
  55387(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => u, default: () => m, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => h, toc: () => g }));
  ...
  90495(e, t, n) {
   ...
   const i = ({ background: e, children: t, className: n, ...r }) => (0, c.jsx)('div', { className: (0, s.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: i = 'div', background: o, children: a }) => {
     const u = (e) => ('article' === i ? (0, c.jsx)('article', { ...e }) : 'section' === i ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      l = (0, c.jsx)(u, { className: (0, s.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, c.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    u = ({ appearance: e = 'medium', children: t, className: n }) => (0, c.jsx)('div', { className: (0, s.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
 },
]);
