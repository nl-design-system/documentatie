...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  29885: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => u, contentTitle: () => c, default: () => v, frontMatter: () => s, metadata: () => r, toc: () => m });
   ...
   const s = { title: 'Gebruik geen HTML-formuliervalidatie \xb7 Foutmeldingen in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'HTML-formuliervalidatie', pagination_label: 'HTML-formuliervalidatie', description: 'Richtlijnen voor gebruik van HTML-formuliervalidatie in een formulier.', slug: '/richtlijnen/formulieren/foutmeldingen/html-formuliervalidatie', keywords: ['labels', 'formulier', 'design', 'code'] },
    c = void 0,
    u = {},
    m = [{ value: 'Progressive enhancement', id: 'progressive-enhancement', level: 3 }, ...o.RM];
   function h(e) {
