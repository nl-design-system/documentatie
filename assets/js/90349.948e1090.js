...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [90349],
 {
  90349(t, e, n) {
   ...
   const i = a,
    h = {};
   for (const q of Object.keys(r)) h[r[q]] = q;
   ...
   for (const q of Object.keys(c)) {
    if (!('channels' in c[q])) throw new Error('missing channels property: ' + q);
    if (!('labels' in c[q])) throw new Error('missing channel labels property: ' + q);
    if (c[q].labels.length !== c[q].channels) throw new Error('channel and label counts mismatch: ' + q);
    const { channels: t, labels: e } = c[q];
    delete c[q].channels, delete c[q].labels, Object.defineProperty(c[q], 'channels', { value: t }), Object.defineProperty(c[q], 'labels', { value: e });
   }
   function g(t) {
    const e = (function () {
      const t = {},
   ...
   function f(t, e) {
    ...
    let r = u[e[t].parent][t],
     o = e[t].parent;
    for (; e[o].parent; ) n.unshift(e[o].parent), (r = d(u[e[o].parent][o], r)), (o = e[o].parent);
   ...
   (c.rgb.hsl = function (t) {
    ...
    (c.rgb.hsv = function (t) {
     ...
     if (0 === c) (o = 0), (a = 0);
      ...
      switch (((a = c / h), (e = u(s)), (n = u(l)), (r = u(i)), h)) {
       case s:
        o = r - n;
        break;
       case l:
     ...
     return [360 * o, 100 * a, 100 * h];
    }),
    (c.rgb.hwb = function (t) {
     const e = t[0],
      n = t[1];
     let r = t[2];
     const o = c.rgb.hsl(t)[0],
    ...
    (c.hsl.rgb = function (t) {
     ...
     const s = r < 0.5 ? r * (1 + n) : r + n - r * n,
      l = 2 * r - s,
      i = [0, 0, 0];
     for (let h = 0; h < 3; h++) (o = e + (1 / 3) * -(h - 1)), o < 0 && o++, o > 1 && o--, (a = 6 * o < 1 ? l + 6 * (s - l) * o : 2 * o < 1 ? s : 3 * o < 2 ? l + (s - l) * (2 / 3 - o) * 6 : l), (i[h] = 255 * a);
     return i;
    }),
   ...
   function j(t, e) {
    ...
    if (null == t) (this.model = 'rgb'), (this.color = [0, 0, 0]), (this.valpha = 1);
     ...
     (this.color = A(n, r)), (this.valpha = 'number' == typeof t[r] ? t[r] : 1);
   ...
   j.prototype = {
    ...
    hex(t) {
     return void 0 !== t ? new j(t) : i.to.hex(...this.rgb().round().color);
    },
    hexa(t) {
     ...
     let n = Math.round(255 * this.valpha)
      .toString(16)
      .toUpperCase();
     return 1 === n.length && (n = '0' + n), i.to.hex(...e) + n;
    },
    rgbNumber() {
     const t = this.rgb().color;
    ...
    mix(t, e) {
     ...
     const n = t.rgb(),
      ...
      i = 1 - l;
     return j.rgb(l * n.red() + i * r.red(), l * n.green() + i * r.green(), l * n.blue() + i * r.blue(), n.alpha() * o + r.alpha() * (1 - o));
    },
   };
   for (const q of Object.keys(v)) {
    ...
    (j.prototype[q] = function (...t) {
     ...
     (j[q] = function (...e) {
      let n = e[0];
      return 'number' == typeof n && (n = A(e, t)), new j(n, q);
     });
   }
   function O(t) {
    return function (e) {
