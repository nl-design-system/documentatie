/*! For license information please see a77e5ea3.a9c83b07.js.LICENSE.txt */
'use strict';
 ...
 [66449],
 {
  ...
  15089(e, n, t) {
   ...
   function o(e) {
    var n = e.size,
     ...
     l = (0, a.$i)(e, i);
    return r.createElement('svg', (0, a._P)({ xmlns: 'http://www.w3.org/2000/svg', className: 'icon icon-tabler icon-tabler-brand-github', width: t, height: t, viewBox: '0 0 24 24', stroke: s, strokeWidth: '2', fill: 'none', strokeLinecap: 'round', strokeLinejoin: 'round' }, l), r.createElement('path', { stroke: 'none', d: 'M0 0h24v24H0z', fill: 'none' }), r.createElement('path', { d: 'M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5' }));
   }
  },
  19349(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => i });
  ...
  26877(e, n, t) {
   ...
   const b = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, c.jsx)(x.n, { children: r.map((t) => (0, c.jsx)(x.K, { className: (0, o.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, p.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(h._, { children: t.tasks.map(({ checked: e, name: t, id: a }) => (0, c.jsx)(h.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, p.qZ)(a) }, a)) }), (0, c.jsx)(a.fz, { children: (0, c.jsxs)(a.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
    v = ({ component: e, headingLevel: n }) => {
     ...
     return e && t.length
            ...
            ? (0, c.jsx)(
               d.Z,
               {
                ...
                description: (0, c.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, c.jsxs)(i.f, { children: [(0, c.jsx)(u, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, c.jsxs)(a.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, c.jsxs)('div', {
                   children: [
                    (h.length > 0 || g.length > 0) && (0, c.jsx)(r.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    h.length > 0 &&
                     (0, c.jsx)(a.dk, {
                      links: h
                  ...
                  g.length > 0 && g.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)('section', { children: [(0, c.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [o, ' in ', e] }), (0, c.jsx)(a.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
            ...
            : (0, c.jsx)(
               l.Zp,
               {
                ...
                children: (0, c.jsxs)(l.Wu, {
                 children: [
                  (0, c.jsx)(a.DZ, { level: n, children: e.title.replace(/^Community/i, '') }),
                  (0, c.jsxs)(a.fz, { children: [(0, c.jsx)(u, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, c.jsxs)(a.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (h.length > 0 || g.length > 0) && (0, c.jsx)(a.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  h.length > 0 &&
                   (0, c.jsx)(c.Fragment, {
                    children: (0, c.jsx)(a.dk, {
                     links: h
                      .filter((e) => !!m.get(e.name))
                      .map((e) => {
                       const n = m.get(e.name);
                  ...
                  g.length > 0 && (0, c.jsx)(c.Fragment, { children: g.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(a.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, c.jsx)(a.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
      ...
      : (0, c.jsx)(a.fz, { children: 'Er zijn nog geen implementaties' });
    },
    k = ({ component: e, headingLevel: n }) => {
     const t = e?.projects.find((e) => 'HELP_WANTED' === e.id),
      r = t?.tasks.find((e) => 'PVTF_lADOBGdlVM4AdX8lzgcig7o' === e.id)?.value;
     return e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(a.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, c.jsxs)(a.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, c.jsxs)(a.Xy, { children: [r ? (0, c.jsxs)(a.Er, { children: ['Vul de ', (0, c.jsx)(a.N_, { href: r, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, c.jsxs)(a.Er, { children: [(0, c.jsxs)(a.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, c.jsxs)(a.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, c.jsx)(a.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, c.jsx)(a.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    w = ({ component: e, headingLevel: n, description: t }) => {
     const r = e && p.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(m.p, { level: n, suffix: r && (0, c.jsx)(g.D, { state: r }), children: e.title }), (0, c.jsx)(a.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(r) && (0, c.jsx)(f.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    D = ({ component: e }) => {
     const n = (e && j[e.title]) || [];
     return n.length > 0 && (0, c.jsxs)(a.fz, { children: ['Gerelateerde componenten:', ' ', n.map((e, t) => (0, c.jsxs)(c.Fragment, { children: [e.slug ? (0, c.jsx)(a.N_, { href: `/${e.slug}/`, children: e.name }) : e.name, t < n.length - 1 ? ', ' : '.'] }))] });
    };
  },
  28377(e, n, t) {
   t.d(n, { A: () => o });
   ...
   function o(e) {
    var n = e.size,
     ...
     s = void 0 === o ? 'currentColor' : o,
     l = (0, a.$i)(e, i);
    return r.createElement('svg', (0, a._P)({ xmlns: 'http://www.w3.org/2000/svg', className: 'icon icon-tabler icon-tabler-brand-npm', width: t, height: t, viewBox: '0 0 24 24', stroke: s, strokeWidth: '2', fill: 'none', strokeLinecap: 'round', strokeLinejoin: 'round' }, l), r.createElement('path', { stroke: 'none', d: 'M0 0h24v24H0z', fill: 'none' }), r.createElement('path', { d: 'M1 8h22v7h-12v2h-4v-2h-6z' }), r.createElement('path', { d: 'M7 8v7' }), r.createElement('path', { d: 'M14 8v7' }), r.createElement('path', { d: 'M17 11v4' }), r.createElement('path', { d: 'M4 11v4' }), r.createElement('path', { d: 'M11 11v1' }), r.createElement('path', { d: 'M20 11v4' }));
   }
  },
  29857(e, n, t) {
   t.d(n, { DZ: () => i, _B: () => o });
  ...
  33648(e, n, t) {
   ...
   function o(e) {
    var n = e.size,
     ...
     s = void 0 === o ? 'currentColor' : o,
     l = (0, a.$i)(e, i);
    return r.createElement('svg', (0, a._P)({ xmlns: 'http://www.w3.org/2000/svg', className: 'icon icon-tabler icon-tabler-brand-storybook', width: t, height: t, viewBox: '0 0 24 24', stroke: s, strokeWidth: '2', fill: 'none', strokeLinecap: 'round', strokeLinejoin: 'round' }, l), r.createElement('path', { stroke: 'none', d: 'M0 0h24v24H0z', fill: 'none' }), r.createElement('path', { d: 'M5 4l.5 16.5l13.5 .5v-18z' }), r.createElement('path', { d: 'M9 15c.6 1.5 1.639 2 3.283 2h-.283c1.8 0 3 -.974 3 -2.435c0 -1.194 -.831 -1.799 -2.147 -2.333l-1.975 -.802c-1.15 -.467 -1.878 -1.422 -1.878 -2.467c0 -.97 .899 -1.786 2.087 -1.893l.613 -.055c1.528 -.138 2.999 .762 3.3 1.985' }), r.createElement('path', { d: 'M16 3.5v1' }));
   }
  },
  36882(e, n, t) {
   (t.r(n), t.d(n, { assets: () => O, component: () => $, contentTitle: () => E, default: () => U, description: () => G, frontMatter: () => P, issueNumber: () => V, metadata: () => a, title: () => I, toc: () => W }));
   const a = JSON.parse('{"id":"componenten/accordion/index","title":"Accordion","description":"Secties met de mogelijkheid om gerelateerde content te tonen en weer te verbergen.","source":"@site/docs/componenten/accordion/index.mdx","sourceDirName":"componenten/accordion","slug":"/accordion","permalink":"/accordion","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/accordion/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Accordion","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Accordion","pagination_label":"Accordion","description":"Secties met de mogelijkheid om gerelateerde content te tonen en weer te verbergen.","issue_number":102,"slug":"/accordion","keywords":["accordeon","accordion","aria-expanded","collapse","collapsible","details","disclosure","expand","expandable","expandable section","expanded","ingeklapt","inklappen","secties","sections","toggle","uitgeklapt","uitklappen","uitklapper","lamellen","blinders"]},"sidebar":"componenten","previous":{"title":"Overzicht","permalink":"/componenten/"},"next":{"title":"Action Group","permalink":"/action-group"}}');
   var r = t(86070),
    i = t(18439),
    o = t(79447),
    s = t(67346),
   ...
   const R = [
     ...
     { title: 'Het is duidelijk welke content in de accordion aanwezig is', sc: '2.4.6', status: '', component: b },
     {
     ...
     { title: 'Als de accordion tekst bevat in een taal anders dan de aangegeven taal van de pagina, is er een taalwissel aanwezig', sc: '3.1.2', status: '', component: L.Ay },
     { title: 'Het gedrag van de accordion is voorspelbaar', sc: '3.2.1', status: '', component: H.Ay },
     {
    ...
    C = [
     ...
     { title: 'Interactieve elementen in de accordion hebben een zichtbare focusstyling', sc: '2.4.7', status: '', component: _.Ay },
     { title: 'Accordions met dezelfde functie of informatie zien er op iedere pagina waar de accordion voorkomt hetzelfde uit', sc: '3.2.4', status: '', component: S.Ay },
    ],
    T = [
     {
     ...
     { title: 'De bezoeker kan de accordeon tot 400% vergroten zonder verlies van functionaliteit of informatie', sc: '1.4.10', status: '', component: A.Ay },
     { title: 'De tekstopmaak in de accordion kan aangepast worden zonder verlies van functionaliteit of informatie', sc: '1.4.12', status: '', component: N.Ay },
     {
    ...
    M = [
     ...
     { title: 'De accordion zorgt niet voor een toetsenbordval', sc: '2.1.2', status: '', component: z.Ay },
     {
     ...
     { title: 'Interactieve elementen in de accordion hebben een zichtbare focusstyling', sc: '2.4.6', status: '', component: b },
     { title: 'De accordion wordt niet bedekt door andere content', sc: '2.4.11', status: '', component: F.Ay },
    ],
    B = [
     {
    ...
    P = { title: 'Accordion', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Accordion', pagination_label: 'Accordion', description: 'Secties met de mogelijkheid om gerelateerde content te tonen en weer te verbergen.', issue_number: 102, slug: '/accordion', keywords: ['accordeon', 'accordion', 'aria-expanded', 'collapse', 'collapsible', 'details', 'disclosure', 'expand', 'expandable', 'expandable section', 'expanded', 'ingeklapt', 'inklappen', 'secties', 'sections', 'toggle', 'uitgeklapt', 'uitklappen', 'uitklapper', 'lamellen', 'blinders'] },
    E = void 0,
    O = {},
    I = 'Accordion',
    G = 'Secties met de mogelijkheid om gerelateerde content te tonen en weer te verbergen.',
    V = 102,
    $ = o.find((e) => e.number === V),
   ...
   function Z(e) {
    ...
    return (t || X('CriteriaList', !0), a || X('CriteriaListItem', !0), (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, r.jsx)(l.Fc, { component: $, headingLevel: 1, description: G }), '\n', (0, r.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, r.jsx)(l.VK, { component: $, headingLevel: 3 }), '\n', (0, r.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, r.jsx)(l.mu, { component: $, headingLevel: 3 }), '\n', (0, r.jsx)(l.K_, { component: $ }), '\n', (0, r.jsx)(n.h2, { id: 'acceptatiecriteria', children: 'Acceptatiecriteria' }), '\n', (0, r.jsx)(s.Ay, {}), '\n', (0, r.jsx)(t, { headingLevel: 3, testCategory: 'Toegankelijkheid algemeen', children: R.map(({ component: e, ...n }) => (0, r.jsx)(a, { ...n, children: (0, r.jsx)(e, {}) })) }), '\n', (0, r.jsx)(t, { headingLevel: 3, testCategory: 'Toegankelijkheid visueel ontwerp', children: C.map(({ component: e, ...n }) => (0, r.jsx)(a, { ...n, children: (0, r.jsx)(e, {}) })) }), '\n', (0, r.jsx)(t, { headingLevel: 3, testCategory: 'Toegankelijkheid zoom en herschalen', children: T.map(({ component: e, ...n }) => (0, r.jsx)(a, { ...n, children: (0, r.jsx)(e, {}) })) }), '\n', (0, r.jsx)(t, { headingLevel: 3, testCategory: 'Toegankelijkheid toetsenbord', children: M.map(({ component: e, ...n }) => (0, r.jsx)(a, { ...n, children: (0, r.jsx)(e, {}) })) }), '\n', (0, r.jsx)(t, { headingLevel: 3, testCategory: 'Toegankelijkheid screenreader', children: B.map(({ component: e, ...n }) => (0, r.jsx)(a, { ...n, children: (0, r.jsx)(e, {}) })) }), '\n', (0, r.jsx)(l.$9, { component: $, headingLevel: 2 })] }));
   }
   function U(e = {}) {
    const { wrapper: n } = { ...(0, i.R)(), ...e.components };
  ...
  50172(e, n, t) {
   ...
   function i(e) {
    ...
    if ('string' == typeof e || 'number' == typeof e) a += e;
     ...
     if (Array.isArray(e)) {
      var r = e.length;
      for (n = 0; n < r; n++) e[n] && (t = i(e[n])) && (a && (a += ' '), (a += t));
     } else for (t in e) e[t] && (a && (a += ' '), (a += t));
    return a;
   }
   function o() {
    for (var e, n, t = 0, a = '', r = arguments.length; t < r; t++) (e = arguments[t]) && (n = i(e)) && (a && (a += ' '), (a += n));
    return a;
   }
   const s = ({ ref: e, children: n, className: t, inline: i, ...s }) => (0, a.jsx)(r.N, { ...s, className: o('rhc-link', { 'rhc-link--inline': i }, t), disabled: !1, ref: e, children: n });
   s.displayName = 'Link';
   var l = t(30758);
   function d(e) {
    var n,
    ...
    if ('string' == typeof e || 'number' == typeof e) a += e;
     ...
     if (Array.isArray(e)) {
      var r = e.length;
      for (n = 0; n < r; n++) e[n] && (t = d(e[n])) && (a && (a += ' '), (a += t));
     } else for (t in e) e[t] && (a && (a += ' '), (a += t));
    return a;
   }
   function c() {
    for (var e, n, t = 0, a = '', r = arguments.length; t < r; t++) (e = arguments[t]) && (n = d(e)) && (a && (a += ' '), (a += n));
    return a;
   }
   const u = ({ level: e = 2, children: n, ...t }) => {
     const a = `h${e}`;
     return l.createElement(a, t, n);
    },
    g = (0, l.forwardRef)(({ heading: e, headingLevel: n = 2, subheading: t, description: r, metadata: i, image: o, href: l, target: d, linkLabel: g, title: m, className: h, children: p, ...j }, x) => (0, a.jsxs)('div', { className: c('rhc-card', 'rhc-card--default', h), ref: x, ...j, children: [o && (0, a.jsx)('div', { className: 'rhc-card__image', children: o }), (0, a.jsxs)('div', { className: 'rhc-card__content', children: [(0, a.jsx)(u, { className: 'rhc-card__heading', level: n, children: l ? (0, a.jsx)(s, { className: 'rhc-card__link', href: l, target: d, title: m, children: e }) : e }), t && (0, a.jsx)('p', { className: 'rhc-card__subheading', children: t }), r && (0, a.jsx)('p', { className: 'rhc-card__description', children: r }), i && (0, a.jsx)('p', { className: 'rhc-card__metadata', children: i }), p] }), g && (0, a.jsx)('div', { className: 'rhc-card__footer', children: (0, a.jsx)('div', { className: 'rhc-card__link', 'data-testid': 'rhc-card__link', children: (0, a.jsx)(s, { href: l, target: d, title: m, children: g }) }) })] }));
   g.displayName = 'Card';
  },
  51704(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => i });
  ...
  63009(e, n, t) {
   ...
   var u = (0, s.forwardRef)(function (e, n) {
    var t = e.children,
     ...
     m = e.inlineBox,
     h = (0, r.A)(e, l);
    return (0, i.jsx)('a', c(c({ 'aria-current': d || void 0, 'aria-disabled': u, className: (0, o.$)('nl-link', (0, a.A)((0, a.A)((0, a.A)({}, 'nl-link--current', d), 'nl-link--disabled', u), 'nl-link--inline-box', m), s), href: u ? void 0 : g, role: u ? 'link' : void 0, ref: n, tabIndex: u ? 0 : void 0 }, h), {}, { children: t }));
   });
   u.displayName = 'Link';
  },
  66153(e, n, t) {
  ...
  74172(e, n, t) {
   ...
   function o(e) {
    var n = e.size,
     ...
     s = void 0 === o ? 'currentColor' : o,
     l = (0, a.$i)(e, i);
    return r.createElement('svg', (0, a._P)({ xmlns: 'http://www.w3.org/2000/svg', className: 'icon icon-tabler icon-tabler-brand-figma', width: t, height: t, viewBox: '0 0 24 24', stroke: s, strokeWidth: '2', fill: 'none', strokeLinecap: 'round', strokeLinejoin: 'round' }, l), r.createElement('path', { stroke: 'none', d: 'M0 0h24v24H0z', fill: 'none' }), r.createElement('circle', { cx: '15', cy: '12', r: '3' }), r.createElement('rect', { x: '6', y: '3', width: '12', height: '6', rx: '3' }), r.createElement('path', { d: 'M9 9a3 3 0 0 0 0 6h3m-3 0a3 3 0 1 0 3 3v-15' }));
   }
  },
  76306(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => i });
  ...
  83386(e, n, t) {
   ...
   function o(e) {
    var n = e.size,
     ...
     s = void 0 === o ? 'currentColor' : o,
     l = (0, a.$i)(e, i);
    return r.createElement('svg', (0, a._P)({ xmlns: 'http://www.w3.org/2000/svg', className: 'icon icon-tabler icon-tabler-external-link', width: t, height: t, viewBox: '0 0 24 24', stroke: s, strokeWidth: '2', fill: 'none', strokeLinecap: 'round', strokeLinejoin: 'round' }, l), r.createElement('path', { stroke: 'none', d: 'M0 0h24v24H0z', fill: 'none' }), r.createElement('path', { d: 'M11 7h-5a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-5' }), r.createElement('line', { x1: '10', y1: '14', x2: '20', y2: '4' }), r.createElement('polyline', { points: '15 4 20 4 20 9' }));
   }
  },
  84471(e, n, t) {
   t.d(n, { bo: () => r, KF: () => g, mJ: () => p, VZ: () => D, cR: () => w, Pv: () => j, qZ: () => o, kD: () => v, QQ: () => A, B2: () => m, Pc: () => l, f4: () => s, GT: () => k, fX: () => i, eQ: () => b, B_: () => f, o_: () => x });
  ...
  96345(e, n, t) {
   t.d(n, { A: () => a });
   const a = (0, t(18652).A)('outline', 'chevron-down', 'ChevronDown', [['path', { d: 'M6 9l6 6l6 -6', key: 'svg-0' }]]);
  },
 },
]);
