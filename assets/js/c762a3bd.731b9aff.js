 ...
 [34531],
 {
  14881(e, n, o) {
   ...
   var a = o(13526),
    ...
    i = o(37168),
    s = o(86070);
   const l = (0, r.forwardRef)(({ as: e, className: n, children: o, ...r }, t) => {
     const i = e || 'div',
      l = (0, a.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, s.jsx)(i, { ref: t, className: l, ...r, children: o });
    }),
    d = ({ className: e, classNamePanel: n, label: o, heading: r, headingLevel: l, headingApperance: d, ...c }) => {
     const p = (0, a.A)('utrecht-accordion__section', e),
      u = (0, a.A)('utrecht-accordion__panel', n);
     return (0, s.jsxs)('details', { className: p, ...c, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(t.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(i.D, { level: l, appearance: d, children: r }), o] })] }) }), (0, s.jsx)('div', { className: u, children: c.children })] });
    };
  },
  18439(e, n, o) {
   o.d(n, { R: () => i, x: () => s });
  ...
  28369(e, n, o) {
   ...
   function d({ lineNumber: e, syntax: n, textContent: o, trim: d }) {
    ...
    const { title: p, type: u } = (0, t.useContext)(i.x),
     k = (0, t.useId)();
    return (d && (c = c.trim()), (0, l.jsx)(r.f4, { theme: s, code: c, language: n || '', children: ({ style: n, tokens: o, getLineProps: r, getTokenProps: t }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)('span', { hidden: !0, id: k, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, l.jsx)(a.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': k, style: n, children: o.map((n, o) => (0, l.jsxs)('span', { ...r({ line: n }), children: [e && (0, l.jsx)('span', { children: o + 1 }), n.map((e, n) => (0, l.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, o)) })] }) }));
   }
  },
  38953(e, n, o) {
   o.d(n, { H: () => y });
   var a = o(28369),
    ...
    g = o(46847),
    m = o(86070);
   const j = ({ children: e }) => (0, m.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(r.yo, { className: (0, t.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(r.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   j.displayName = 'ParagraphContainer';
   const b = ({ children: e }) => (0, m.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(r.yo, { className: (0, t.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   b.displayName = 'DocumentContainer';
   const x = ({ children: e }) => (0, m.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: e });
   x.displayName = 'SurfaceContainer';
   const y = globalThis.isAstro
    ? ({ language: e, className: n, code: o = '<p>No code provided</p>', rawCode: a, copyCode: r, defaultExpandedCode: i, designTokens: s }) => {
       const l = 'string' == typeof o ? o : a || '',
        d = 'string' == typeof o ? h().highlight(o, h().languages[e], e) : h().highlight(a || '', h().languages[e], e);
       return (0, m.jsxs)('div', { className: (0, t.A)('ma-canvas-astro', n), children: [(0, m.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: s, children: (0, m.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: l } }) }), (0, m.jsx)(v.n, { children: (0, m.jsxs)(v.K, { label: 'Code', open: i, children: [(0, m.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, m.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: d } }) }), 'allow' === r && (0, m.jsx)(g.$, { 'data-copy-code': l, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: k = !0, children: h, container: v = 'document', language: g, designTokens: y }) => {
       ...
       (0, p.useEffect)(() => {
        (async () => {
         const e = await c.Ay.format(w, { parser: g, plugins: [i.A, s.Ay, l.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         N(e);
        })();
       }, [w]);
       const C = (0, p.useId)();
       let K = p.Fragment;
       return (
        'paragraph' === v ? (K = j) : 'document' === v ? (K = b) : 'surface' === v && (K = x),
        (0, m.jsxs)('div', {
         className: (0, t.A)('nlds-canvas'),
         children: [
          f && (0, m.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, m.jsx)(K, { children: (0, m.jsx)(r.v$, { children: f }) }) }) }),
          k &&
           (0, m.jsx)('div', {
          ...
          k &&
           (0, m.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, m.jsx)(a.M, { codeBlockLabel: 'Codevoorbeeld', syntax: g, textContent: z, trim: !0 }),
             n &&
              (0, m.jsx)('div', {
