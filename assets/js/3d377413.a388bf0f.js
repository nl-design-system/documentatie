...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [10721],
 {
   ...
   const l = ({ background: e, children: n, className: a, ...t }) => (0, o.jsx)('div', { className: (0, i.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, a), ...t, children: n }),
    ...
    r = ({ href: e, appearance: n, className: a, component: l = 'div', background: s, children: r }) => {
     const g = (e) => ('article' === l ? (0, o.jsx)('article', { ...e }) : 'section' === l ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      u = (0, o.jsx)(g, { className: (0, i.A)('ma-cardgroup__card', s && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, a), children: r });
  ...
  33149(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => p, contentTitle: () => g, default: () => b, description: () => m, frontMatter: () => r, issueNumber: () => c, metadata: () => t, title: () => d, toc: () => h }));
  ...
  39948(e, n, a) {
   ...
   var t = a(29181),
    ...
    r = a(83386),
    g = a(86070);
   const u = { figma: (0, g.jsx)(i.A, {}), github: (0, g.jsx)(o.A, {}), npm: (0, g.jsx)(l.A, {}), storybook: (0, g.jsx)(s.A, {}) },
            ...
            l.Zp,
            {
             ...
             children: (0, g.jsxs)(l.Wu, {
              children: [
               ...
               (d.length > 0 || s.length > 0) && (0, g.jsx)(t.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               d.length > 0 &&
                (0, g.jsx)(g.Fragment, {
               ...
               s.length > 0 && (0, g.jsx)(g.Fragment, { children: s.map(({ frameworkName: e, tasks: a }) => (0, g.jsxs)(g.Fragment, { children: [(0, g.jsxs)(t.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, g.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, g.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => D, cR: () => F, Pv: () => f, qZ: () => l, kD: () => v, B2: () => c, Pc: () => r, f4: () => s, GT: () => j, fX: () => o, eQ: () => k, B_: () => x, o_: () => b });
