 ...
 [87915],
 {
  ...
  58639(e, n, o) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: g = !0, children: j, container: y = 'document', language: f, designTokens: x }) => {
    ...
    let S = u.Fragment;
    return (
     'paragraph' === y ? (S = h) : 'document' === y ? (S = v) : 'surface' === y && (S = b),
     (0, m.jsxs)('div', {
      className: (0, r.A)('nlds-canvas'),
      children: [
       k && (0, m.jsx)('div', { className: (0, r.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, m.jsx)(S, { children: (0, m.jsx)(l.v$, { children: k }) }) }) }),
       g &&
        (0, m.jsx)('div', {
       ...
       g &&
        (0, m.jsxs)('div', {
         ...
         hidden: !z,
         children: [
          (0, m.jsx)(t.M, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: A, trim: !0 }),
          n &&
           (0, m.jsx)('div', {
  ...
  69982(e, n, o) {
   (o.r(n), o.d(n, { assets: () => g, contentTitle: () => b, default: () => f, frontMatter: () => v, metadata: () => t, toc: () => j }));
