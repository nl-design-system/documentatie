 ...
 [64013],
 {
  ...
  89846: (e, s, t) => {
   ...
   const g = (e) => {
    ...
    const g = [{ href: (0, a.Z)('/'), label: 'Home', rel: 'home' }, ...s],
     { pathname: b } = (0, l.TH)(),
     j = [...g].reverse().find((e) => e.href !== b);
    return (0, u.jsxs)(u.Fragment, {
     children: [
      (0, u.jsx)('div', {
       className: (0, i.Z)(h, m),
       children: (0, u.jsx)(c.Qu, {
        ...t,
        label: 'breadcrumb',
        children: g.map((e, s, t) => {
         let { label: r, href: l, rel: a } = e,
          { length: n } = t;
         return (0, u.jsxs)(d.Fragment, { children: [(0, u.jsx)(c.yY, { href: l, current: s === n - 1, disabled: s === n - 1, rel: (0, i.Z)(a, { up: s === n - 2 }), children: r }), s < n - 1 && (0, u.jsx)(c.sc, { children: '/' })] }, s);
        }),
       }),
      }),
      j && (0, u.jsx)('div', { className: (0, i.Z)(h, o), children: (0, u.jsx)(c.hE, { children: (0, u.jsxs)(r.Z, { href: j.href, rel: j.rel, className: 'utrecht-link utrecht-link--html-a', children: [(0, u.jsx)(c.JO, { children: (0, u.jsx)(n.Z, {}) }), j.label] }) }) }),
     ],
    });
   };
  },
