/*! For license information please see 68ddddde.ea798d57.js.LICENSE.txt */
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [5643],
 {
  ...
  56324: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => ee, component: () => se, contentTitle: () => Y, default: () => ae, description: () => re, frontMatter: () => q, issueNumber: () => ie, metadata: () => Q, title: () => te, toc: () => ne });
   var r,
    i,
    s,
    o,
   ...
   t(72925);
   function A(e) {
    const n = { a: 'a', code: 'code', li: 'li', p: 'p', ul: 'ul', ...(0, p.a)(), ...e.components };
   ...
   function z(e = {}) {
    const { wrapper: n } = { ...(0, p.a)(), ...e.components };
   ...
   var C = t(71504),
    ...
    S = t(56050);
   function L(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, p.a)(), ...e.components };
   ...
   var D = t(71811),
    ...
    B = t(57716);
   function X(e) {
    const n = { a: 'a', code: 'code', h1: 'h1', h2: 'h2', p: 'p', pre: 'pre', ...(0, p.a)(), ...e.components };
   ...
   const K = JSON.parse('{"nl":{"skip-link":{"background-color":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<color>","nl.nldesignsystem.figma-implementation":true},"$type":"color"},"color":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<color>","nl.nldesignsystem.figma-implementation":true},"$type":"color"},"font-size":{"$extensions":{"nl.nldesignsystem.css-property-syntax":["<length>","<percentage>"],"nl.nldesignsystem.figma-implementation":true},"$type":"fontSizes"},"line-height":{"$extensions":{"nl.nldesignsystem.css-property-syntax":["<length>","<number>"],"nl.nldesignsystem.figma-implementation":true},"$type":"lineHeights"},"min-block-size":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":true},"$type":"dimension"},"min-inline-size":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":true},"$type":"dimension"},"padding-block":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":true},"$type":"dimension"},"padding-inline":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":true},"$type":"dimension"},"text-decoration-thickness":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":false},"$type":"other"},"text-underline-offset":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":false},"$type":"other"}}}}'),
    ...
    ie = 74,
    se = g.find((e) => e.number === ie);
   function oe(e) {
    const n = { h2: 'h2', h3: 'h3', ...(0, p.a)(), ...e.components };
    return (0, m.jsxs)(m.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, m.jsx)(V.Rv, { component: se, headingLevel: 1, description: re }),
      '\n',
      (0, m.jsx)(H.I, { component: se }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, m.jsx)(U.B, { component: se, illustration: f }),
      '\n',
      ...
      '\n',
      (0, m.jsx)(I.W, { tokens: K }),
      '\n',
      (0, m.jsx)(B.U, { omitH1: !0, headingLevel: 3, children: (0, m.jsx)(J, {}) }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, m.jsx)(V.cN, { component: se, headingLevel: 3 }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, m.jsx)(V.W, { component: se, headingLevel: 3 }),
      '\n',
      ...
      (0, m.jsx)($.t, {
       ...
       items: [
        { title: 'Het label van de Skip Link bestaat uit gewone tekst, niet uit een afbeelding van tekst', sc: '1.4.5', status: '', component: (0, m.jsx)(R.ZP, {}) },
        { title: 'De linktekst van de Skip Link vertelt eenduidig aan de gebruiker waar de link naar toe gaat (het linkdoel)', sc: '2.4.4', status: '', component: (0, m.jsx)(_.ZP, {}) },
        { title: 'Als de gebruiker de Skip Link indrukt met een aanwijzer zoals een muis of vinger, is er de mogelijkheid is om actie te voorkomen of ongedaan te maken', sc: '2.5.2', status: '', component: (0, m.jsx)(C.ZP, {}) },
        ...
        { title: 'Als de Skip Link toetsenbordfocus krijgt vindt er geen contextwijziging plaats', sc: '3.2.1', status: '', component: (0, m.jsx)(F.ZP, {}) },
        { title: "Skip Links die op meerdere pagina's voorkomen staan in dezelfde relatieve volgorde", sc: '3.2.3', status: '', component: (0, m.jsx)(E.ZP, {}) },
       ],
      }),
      '\n',
      (0, m.jsx)($.t, {
       ...
       items: [
        { title: 'De tekstkleur van de Skip Link heeft voldoende contrast met de achtergrondkleur', sc: '1.4.3', status: '', component: (0, m.jsx)(w.ZP, {}) },
        { title: 'Als je de tekstafstand vergroot blijft de tekst in zijn geheel zichtbaar', sc: '1.4.12', status: '', component: (0, m.jsx)(y.ZP, {}) },
      ...
      (0, m.jsx)($.t, {
       ...
       items: [
        { title: 'Als je de tekst vergroot tot 200% blijft deze in zijn geheel zichtbaar', sc: '1.4.4', status: '', component: (0, m.jsx)(b.ZP, {}) },
      ...
      (0, m.jsx)($.t, {
       ...
       items: [
        ...
        { title: "De Skip Link slaat een contentblok over dat op meerdere pagina's voorkomt", sc: '2.4.1', status: '', component: (0, m.jsx)(P.ZP, {}) },
        { title: 'De Skip Link staat op een logische plek in de focusvolgorde', sc: '2.4.3', status: '', component: (0, m.jsx)(O.ZP, {}) },
        { title: 'Wanneer de Skip Link de toetsenbordfocus krijgt is de focus zichtbaar', sc: '2.4.7', status: '', component: (0, m.jsx)(z, {}) },
        { title: 'De Skip Link wordt niet bedekt door een ander element op de pagina', sc: '2.4.11', status: '', component: (0, m.jsx)(M.ZP, {}) },
       ],
      }),
      '\n',
      (0, m.jsx)($.t, {
       ...
       items: [
        { title: 'Als de tekst van de Skip Link in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode', sc: '3.1.2', status: '', component: (0, m.jsx)(S.ZP, {}) },
      ...
      '\n',
      (0, m.jsx)(V.vM, { component: se, headingLevel: 3 }),
     ],
    });
   }
   function ae(e = {}) {
  ...
  94443: (e, n, t) => {
   ...
   const w = (e) => {
          ...
          children: [
           (0, d.jsx)(v, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(f, { headingLevel: t + 1, checked: n, title: r, description: (0, y.Q6)(i) }, i);
            }),
           }),
    ...
    A = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(g.V, { level: t, suffix: s && (0, d.jsx)(p.y, { state: s }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  49556: (e, n, t) => {
   'use strict';
       ...
       children: [
        ...
        (0, m.jsx)(o.RM, {
         children: a.map((e) => {
          const t = (0, s.zP)(e),
           a = (0, s.Yr)(n, e).$type;
          return (0, m.jsxs)(o.SC, { children: [(0, m.jsx)(o.pj, { children: (0, m.jsx)(r.E, { children: (0, m.jsx)(o.YG, { children: t }) }) }), (0, m.jsx)(o.pj, { children: (0, m.jsxs)(i.O, { children: [(0, m.jsx)(z, { type: a }), ' ', a] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, m.jsxs)(o.hE, { children: [(0, m.jsx)(p, { content: c, language: 'json', children: 'Kopieer als JSON' }), (0, m.jsx)(p, { content: l, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, $e: () => j, BA: () => a, Ee: () => d, Q6: () => s, U: () => m, Yr: () => k, d: () => h, e9: () => o, fO: () => f, mA: () => i, ps: () => p, qU: () => y, s0: () => v, zP: () => g });
