...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [8373],
 {
  ...
  72926: (e, n, r) => {
   r.r(n), r.d(n, { assets: () => K, contentTitle: () => U, default: () => Y, frontMatter: () => R, metadata: () => I, toc: () => J });
   var i = r(11527),
    t = r(80877),
    l = r(12921),
    o = r(65477),
  ...
  65477: (e, n, r) => {
   ...
   const x = (e) => {
    let { code: n, copy: r = !1, defaultExpandedCode: x = !1, displayCode: f = !0, children: k, container: b = "document", language: w, designTokens: y } = e,
     _ = "function" == typeof k ? k() : k,
     z = "function" == typeof n ? n() : (0, c.isValidElement)(n) ? n : void 0,
     F = "string" == typeof n ? n : u.uS(z || _),
     [N, S] = (0, c.useState)(F),
     [V, W] = (0, c.useState)(x);
    (0, c.useEffect)(() => {
     (async () => {
      (N = await d.ZP.format(F, { parser: w, plugins: [l.Z, o.ZP, s.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), S(N);
     })();
    }, [F]);
    const X = (0, c.useId)();
    let C = c.Fragment;
    return (
     ...
     (0, m.jsxs)("div", {
      ...
      children: [
       _ && (0, m.jsx)("div", { className: (0, t.Z)(h["nlds-canvas__example"]), children: (0, m.jsx)("div", { className: "voorbeeld-theme", style: y, children: (0, m.jsx)(C, { children: (0, m.jsx)(i.pu, { children: _ }) }) }) }),
       f &&
        (0, m.jsx)("div", {
