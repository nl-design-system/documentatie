 ...
 [34799],
 {
   ...
   function F(e) {
    ...
    return (0, s.jsxs)(s.Fragment, {
     children: [
      ...
      '\n',
      (0, s.jsx)(b.$9, { component: L, headingLevel: 3 }),
      '\n',
  ...
  99630(e, t, n) {
   ...
   const g = ({ children: e }) => (0, c.jsx)('ul', { className: 'task-list', children: e }),
    m = ({ checked: e, children: t, title: n, description: r, headingLevel: i = 3 }) => (0, c.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, c.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, c.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, c.jsx)(p.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, c.jsxs)('div', { children: [n ? (0, c.jsx)(u.DZ, { appearance: 'utrecht-heading-3', level: i, children: n }) : null, r, t] })] });
   var j = n(33062);
   const w = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, c.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, j.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(g, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, c.jsx)(m, { headingLevel: t + 1, checked: e, title: n, description: (0, j.qZ)(r) }, r)) }), (0, c.jsx)(r.fz, { children: (0, c.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
