...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [7966],
 {
  ...
  58639(e, n, l) {
   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: j = !0, children: x, container: v = 'document', language: g, designTokens: f }) => {
    ...
    let P = u.Fragment;
    return (
     'paragraph' === v ? (P = m) : 'document' === v ? (P = b) : 'surface' === v && (P = y),
     (0, p.jsxs)('div', {
  ...
  69024(e, n, l) {
   (l.r(n), l.d(n, { assets: () => j, contentTitle: () => y, default: () => g, frontMatter: () => b, metadata: () => o, toc: () => x }));
