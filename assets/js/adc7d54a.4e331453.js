  ...
  82415: (e, n, t) => {
   ...
   const o = (e) => {
    ...
    return (0, r.jsxs)("form", {
     ...
     children: [(0, r.jsxs)(i.Wi, { type: "email", children: [(0, r.jsx)(i.nv, { children: (0, r.jsx)(i.lX, { htmlFor: `id-${l}`, children: "E-mailadres" }) }), v[l] && (0, r.jsx)(i.w7, { children: (0, r.jsx)(i.nv, { children: v[l].message }) }), (0, r.jsx)(i.nv, { children: (0, r.jsx)(i.fE, { id: `id-${l}`, name: l, type: "email", "aria-required": "true", autoComplete: "email", ...h(`${l}`, { required: { value: !0, message: "Dit veld is verplicht, maar het is niet ingevuld." }, pattern: { value: /\S+@\S+\.\S+/, message: "Dit is geen correct emailadres." } }), invalid: !!v[l] }) })] }), (0, r.jsxs)(i.Wi, { type: "text", children: [(0, r.jsx)(i.nv, { children: (0, r.jsx)(i.lX, { htmlFor: d, children: "Naam (niet verplicht)" }) }), (0, r.jsx)(i.nv, { children: (0, r.jsx)(i.fE, { id: d, name: d, type: "text", autoComplete: "given-name" }) })] }), m && (0, r.jsxs)(i.Wi, { type: "text", children: [(0, r.jsx)(i.nv, { children: (0, r.jsx)(i.lX, { htmlFor: m, children: "Organisatie (niet verplicht)" }) }), (0, r.jsx)(i.nv, { children: (0, r.jsx)(i.fE, { id: m, name: m, type: "text" }) })] }), p && (0, r.jsxs)(i.pg, { children: [(0, r.jsx)(i.Qv, { children: "Waar ligt je interesse? (niet verplicht)" }), c.map((e, n) => (0, r.jsx)(i.Wi, { type: "checkbox", children: (0, r.jsxs)(i.nv, { children: [(0, r.jsx)(i.XZ, { name: `${p}[]`, value: n + 1, id: `${p}-${n + 1}` }), (0, r.jsx)(i.lX, { htmlFor: `${p}-${n + 1}`, children: e })] }) }, e))] }), u && (0, r.jsxs)(i.Wi, { type: "text", children: [(0, r.jsx)(i.nv, { children: (0, r.jsx)(i.lX, { htmlFor: u, children: "Waar werk je momenteel vooral aan? Denk aan mijn-omgevingen, formulieren, kaarten. (niet verplicht)" }) }), (0, r.jsx)(i.nv, { children: (0, r.jsx)(i.fE, { id: u, name: u, type: "text" }) })] }), (0, r.jsx)(i.hE, { children: (0, r.jsx)(i.zx, { type: "submit", appearance: "primary-action-button", children: "Aanmelden" }) }), (0, r.jsx)("input", { type: "hidden", name: "next", value: o }), (0, r.jsx)("input", { type: "hidden", name: "a", value: t }), (0, r.jsx)("input", { type: "hidden", name: "l", value: n }), (0, r.jsx)("input", { name: "osnD9cWRI3", autoComplete: "on", id: "id-osnD9cWRI3", type: "hidden", value: "NLDS website" }), (0, r.jsx)("input", { autoComplete: "new-password", type: "email", id: "email", name: "email", placeholder: "Your e-mail here", className: "sr-only", "aria-hidden": "true" })],
    });
   };
  },
  80877: (e, n, t) => {
