 ...
 [94192],
 {
  ...
  17889(e, n, t) {
   ...
   const A = { color: u.A, dimension: g.A, fontFamilies: j.A, fontSizes: x.A, fontWeights: v.A, lineHeights: f.A, other: b.A, textDecoration: w.A },
    y = ({ type: e }) => (0, k.jsx)(h.In, { children: (0, S.createElement)(A[e]) });
   function z({ tokens: e }) {
    const n = (0, s.kD)(e),
     t = (0, s.GT)(n),
       ...
       children: [
        ...
        (0, k.jsx)(o.BF, {
         children: t.map((n) => {
          const t = (0, s.o_)(n),
           a = (0, s.eQ)(e, n).$type;
          return (0, k.jsxs)(o.Hj, { children: [(0, k.jsx)(o.nA, { children: (0, k.jsx)(i.C, { children: (0, k.jsx)(o.kf, { children: t }) }) }), (0, k.jsx)(o.nA, { children: (0, k.jsxs)(r.K, { children: [(0, k.jsx)(y, { type: a }), ' ', a] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => r, KF: () => h, mJ: () => u, VZ: () => A, cR: () => S, Pv: () => g, qZ: () => o, kD: () => f, B2: () => k, Pc: () => l, f4: () => a, GT: () => b, fX: () => s, eQ: () => v, B_: () => x, o_: () => j, Rc: () => w });
