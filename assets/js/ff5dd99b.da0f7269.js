(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [68925],
 {
  ...
  39412: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => D, component: () => E, contentTitle: () => _, default: () => H, description: () => V, frontMatter: () => S, issueNumber: () => O, metadata: () => M, title: () => P, toc: () => F });
   var r,
    s,
    i,
    o,
   ...
   function U(e) {
    ...
    return (0, h.jsxs)(h.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, h.jsx)(z.Rv, { component: E, headingLevel: 1, description: V }),
      '\n',
      (0, h.jsx)(G.I, { component: E }),
      '\n',
      (0, h.jsx)(t.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, h.jsx)(W.B, { component: E, illustration: w }),
      '\n',
      ...
      '\n',
      (0, h.jsx)(z.cN, { component: E, headingLevel: 3 }),
      '\n',
      (0, h.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, h.jsx)(z.W, { component: E, headingLevel: 3 }),
      '\n',
      ...
      '\n',
      (0, h.jsx)(z.vM, { component: E, headingLevel: 3 }),
     ],
    });
   }
   function H(e = {}) {
          ...
          children: [
           (0, d.jsx)(v, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(y, { headingLevel: n + 1, checked: t, title: r, description: (0, k.Q6)(s) }, s);
            }),
           }),
            ...
            m.Zb,
            {
             ...
             children: (0, d.jsxs)(m.aY, {
              children: [
               ...
               (c.length > 0 || i.length > 0) && (0, d.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               c.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               i.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: i.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: n + 2, children: [s, ' in ', t] }), (0, d.jsx)(r.Mc, { children: i.map((e) => (0, d.jsxs)(r.k7, { href: e.value, children: [(0, d.jsx)(u, { brand: e.brand }), ' ', e.description] }, e.id)) })] });
                 }),
                }),
              ],
             }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => c, Q6: () => i, U: () => l, e9: () => o, mA: () => s, ps: () => d });
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        ...
        const c = s.match(/^(.+) URL/)[1],
         a = 'Storybook' === c ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${c}`;
        return { brand: c.toLowerCase(), name: s, id: i, value: o, description: a };
       });
