 ...
 [45129],
 {
  14881(e, n, t) {
   ...
   var i = t(13526),
    ...
    s = t(37168),
    l = t(86070);
   const o = (0, r.forwardRef)(({ as: e, className: n, children: t, ...r }, a) => {
     const s = e || 'div',
      o = (0, i.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, l.jsx)(s, { ref: a, className: o, ...r, children: t });
    }),
    d = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: o, headingApperance: d, ...c }) => {
     const p = (0, i.A)('utrecht-accordion__section', e),
      h = (0, i.A)('utrecht-accordion__panel', n);
     return (0, l.jsxs)('details', { className: p, ...c, children: [(0, l.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, l.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, l.jsx)('span', { className: 'nl-button__icon-start', children: (0, l.jsx)(a.A, {}) }), (0, l.jsxs)('span', { className: 'nl-button__label', children: [r && (0, l.jsx)(s.D, { level: o, appearance: d, children: r }), t] })] }) }), (0, l.jsx)('div', { className: h, children: c.children })] });
    };
  },
  18439(e, n, t) {
   t.d(n, { R: () => s, x: () => l });
  ...
  38953(e, n, t) {
   ...
   var i = t(28369),
    ...
    m = t(46847),
    g = t(86070);
   const b = ({ children: e }) => (0, g.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(r.yo, { className: (0, a.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(r.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   b.displayName = 'ParagraphContainer';
   const k = ({ children: e }) => (0, g.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(r.yo, { className: (0, a.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const y = globalThis.isAstro
    ? ({ language: e, className: n, code: t = '<p>No code provided</p>', rawCode: i, copyCode: r, defaultExpandedCode: s, designTokens: l }) => {
       const o = 'string' == typeof t ? t : i || '',
        d = 'string' == typeof t ? v().highlight(t, v().languages[e], e) : v().highlight(i || '', v().languages[e], e);
       return (0, g.jsxs)('div', { className: (0, a.A)('ma-canvas-astro', n), children: [(0, g.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: l, children: (0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }) }), (0, g.jsx)(j.n, { children: (0, g.jsxs)(j.K, { label: 'Code', open: s, children: [(0, g.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: d } }) }), 'allow' === r && (0, g.jsx)(m.$, { 'data-copy-code': o, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: u = !0, children: v, container: j = 'document', language: m, designTokens: y }) => {
       ...
       (0, p.useEffect)(() => {
        (async () => {
         const e = await c.Ay.format(z, { parser: m, plugins: [s.A, l.Ay, o.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         N(e);
        })();
       }, [z]);
       const S = (0, p.useId)();
       let T = p.Fragment;
       return (
        'paragraph' === j ? (T = b) : 'document' === j ? (T = k) : 'surface' === j && (T = x),
        (0, g.jsxs)('div', {
         className: (0, a.A)('nlds-canvas'),
         children: [
          f && (0, g.jsx)('div', { className: (0, a.A)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, g.jsx)(T, { children: (0, g.jsx)(r.v$, { children: f }) }) }) }),
          u &&
           (0, g.jsx)('div', {
          ...
          u &&
           (0, g.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, g.jsx)(i.M, { codeBlockLabel: 'Codevoorbeeld', syntax: m, textContent: w, trim: !0 }),
             n &&
              (0, g.jsx)('div', {
   ...
   const c = (0, o.createContext)({}),
    p = ({ title: e, appearance: n, description: t, children: o, figure: p }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      u = p ? 'figure' : 'div',
      v = p ? 'figcaption' : 'div',
      j = 'string' == typeof t ? (0, d.jsx)(l.oz, { components: { a: a.N_ }, children: t }) : t;
     return (0, d.jsxs)(u, { className: (0, s.A)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(v, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(a.fz, { className: (0, s.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(r.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: h.dont })] }), (0, d.jsx)(a.fz, { children: e })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(a.fz, { className: (0, s.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, d.jsx)(i.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, d.jsx)('span', { className: 'nlds-guideline__title', children: h.do })] }), (0, d.jsx)(a.fz, { children: e })] }), j] }), (0, d.jsx)('div', { className: 'nlds-guideline__example', children: (0, d.jsx)(c.Provider, { value: { title: e, type: h[n] }, children: o }) })] });
    };
  },
  56672(e, n, t) {
   t.d(n, { Ay: () => l, RM: () => a });
