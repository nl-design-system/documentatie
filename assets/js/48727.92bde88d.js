/*! For license information please see 48727.92bde88d.js.LICENSE.txt */
'use strict';
 ...
 [48727],
 {
  ...
  10264(e, n, a) {
   ...
   var t = a(13526),
    ...
    l = a(6833),
    r = a(19758);
   const o = 'iconEdit_xKkT';
   var s = a(86070);
   function d({ className: e, ...n }) {
    return (0, s.jsx)('svg', { fill: 'currentColor', height: '20', width: '20', viewBox: '0 0 40 40', className: (0, t.A)(o, e), 'aria-hidden': 'true', ...n, children: (0, s.jsx)('g', { children: (0, s.jsx)('path', { d: 'm34.5 11.7l-3 3.1-6.3-6.3 3.1-3q0.5-0.5 1.2-0.5t1.1 0.5l3.9 3.9q0.5 0.4 0.5 1.1t-0.5 1.2z m-29.5 17.1l18.4-18.5 6.3 6.3-18.4 18.4h-6.3v-6.2z' }) }) });
   }
   ...
   function g({ lastUpdatedAt: e }) {
    ...
    return (0, s.jsx)(i.A, { id: 'theme.lastUpdated.atDate', description: 'The words used to describe on which date a page has been last updated', values: { date: (0, s.jsx)('b', { children: (0, s.jsx)('time', { dateTime: n.toISOString(), itemProp: 'dateModified', children: a }) }) }, children: ' on {date}' });
   }
   ...
   const f = 'lastUpdated_MSAa',
    p = 'noPrint_v040';
   function u({ className: e, editUrl: n, lastUpdatedAt: a, lastUpdatedBy: i }) {
    return (0, s.jsxs)('div', { className: (0, t.A)('row', e), children: [(0, s.jsx)('div', { className: (0, t.A)('col', p), children: n && (0, s.jsx)(c, { editUrl: n }) }), (0, s.jsx)('div', { className: (0, t.A)('col', f), children: (a || i) && (0, s.jsx)(m, { lastUpdatedAt: a, lastUpdatedBy: i }) })] });
   }
  },
  12535(e, n, a) {
   a.d(n, { A: () => p });
   var t = a(30758),
    ...
    r = a(71831),
    o = a(17996);
   const s = 'details_rfeB',
    d = 'isBrowser_Dgf9',
    c = 'collapsibleContent_lkJv';
   var h = a(86070);
   function g(e) {
   ...
   function m({ summary: e, children: n, ...a }) {
    (0, l.A)().collectAnchor(a.id);
    const m = (0, r.A)(),
     f = (0, t.useRef)(null),
     { collapsed: p, setCollapsed: u } = (0, o.u)({ initialState: !a.open }),
     [x, b] = (0, t.useState)(a.open),
    ...
    return (0, h.jsxs)('details', {
     ...
     open: x,
     'data-collapsed': p,
     className: (0, i.A)(s, m && d, a.className),
     onMouseDown: (e) => {
     ...
     onClick: (e) => {
      e.stopPropagation();
      const n = e.target;
      g(n) && v(n, f.current) && (e.preventDefault(), p ? (u(!1), b(!0)) : u(!0));
     },
     children: [
      j,
      (0, h.jsx)(o.N, {
   ...
   const f = 'details_EERr';
   function p({ ...e }) {
    return (0, h.jsx)(m, { ...e, className: (0, i.A)('alert alert--info', f, e.className) });
   }
  },
  34484(e, n, a) {
   a.d(n, { A: () => r });
   ...
   var t = a(13526),
    ...
    l = a(86070);
   function r(e) {
    const { permalink: n, title: a, subLabel: r, isNext: o } = e;
    return (0, l.jsxs)(i.A, { className: (0, t.A)('pagination-nav__link', o ? 'pagination-nav__link--next' : 'pagination-nav__link--prev'), to: n, children: [r && (0, l.jsx)('div', { className: 'pagination-nav__sublabel', children: r }), (0, l.jsx)('div', { className: 'pagination-nav__label', children: a })] });
   }
  },
  40972(e, n, a) {
   a.d(n, { A: () => B });
   ...
   function l(e) {
    const { mdxAdmonitionTitle: n, rest: a } = (function (e) {
     ...
     l = e.title ?? n;
    return { ...e, ...(l && { title: l }), children: a };
   }
   var r = a(13526),
    o = a(16807),
    s = a(6833);
   const d = 'admonition_vzfL',
    c = 'admonitionHeading_W4bL',
    h = 'admonitionIcon_yccl',
    g = 'admonitionContent_fgY0';
   function v({ type: e, className: n, children: a }) {
    return (0, i.jsx)('div', { className: (0, r.A)(s.G.common.admonition, s.G.common.admonitionType(e), d, n), children: a });
   }
   ...
   function p(e) {
    const { type: n, icon: a, title: t, children: l, className: r } = e;
    return (0, i.jsxs)(v, { type: n, className: r, children: [t || a ? (0, i.jsx)(m, { title: t, icon: a }) : null, (0, i.jsx)(f, { children: l })] });
   }
   function u(e) {
   ...
   function b(e) {
    return (0, i.jsx)(p, { ...x, ...e, className: (0, r.A)('alert alert--secondary', e.className), children: e.children });
   }
   function j(e) {
   ...
   function A(e) {
    return (0, i.jsx)(p, { ...y, ...e, className: (0, r.A)('alert alert--success', e.className), children: e.children });
   }
   function k(e) {
   ...
   function N(e) {
    return (0, i.jsx)(p, { ...w, ...e, className: (0, r.A)('alert alert--info', e.className), children: e.children });
   }
   function _(e) {
   ...
   const U = {
    ...{
     ...
     info: N,
     warning: function (e) {
      return (0, i.jsx)(p, { ...z, ...e, className: (0, r.A)('alert alert--warning', e.className), children: e.children });
     },
     danger: function (e) {
      return (0, i.jsx)(p, { ...C, ...e, className: (0, r.A)('alert alert--danger', e.className), children: e.children });
     },
    },
    ...{
     ...
     caution: function (e) {
      return (0, i.jsx)(p, { ...M, ...e, className: (0, r.A)('alert alert--warning', e.className), children: e.children });
     },
    },
   };
   function B(e) {
    const n = l(e),
     a = ((t = n.type), U[t] || (console.warn(`No admonition component found for admonition type "${t}". Using Info as fallback.`), U.info));
    var t;
    return (0, i.jsx)(a, { ...n });
   }
  },
  ...
  45916(e, n, a) {
   ...
   var s = a(86070);
   function d({ tags: e }) {
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)('b', { children: (0, s.jsx)(i.A, { id: 'theme.tags.tagsListLabel', description: 'The label alongside a tag list', children: 'Tags:' }) }), (0, s.jsx)('ul', { className: (0, t.A)(r, 'padding--none', 'margin-left--sm'), children: e.map((e) => (0, s.jsx)('li', { className: o, children: (0, s.jsx)(l.A, { ...e }) }, e.permalink)) })] });
   }
  },
  48004(e, n, a) {
   a.d(n, { f: () => t.f });
   ...
   !(function (e, n) {
    ...
    if ('undefined' != typeof document) {
     ...
     ((i.type = 'text/css'), 'top' === a && t.firstChild ? t.insertBefore(i, t.firstChild) : t.appendChild(i), i.styleSheet ? (i.styleSheet.cssText = e) : i.appendChild(document.createTextNode(e)));
    }
  ...
  71864(e, n, a) {
   ...
   const l = 'tag_or6L',
    ...
    o = 'tagWithCount_l5w2';
   var s = a(86070);
   function d({ permalink: e, label: n, count: a, description: d }) {
    return (0, s.jsxs)(i.A, { rel: 'tag', href: e, title: d, className: (0, t.A)(l, a ? o : r), children: [n, a && (0, s.jsx)('span', { children: a })] });
   }
  },
  97238(e, n, a) {
   a.d(n, { $S: () => t, d1: () => i });
