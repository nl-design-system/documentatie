 ...
 [49189],
 {
  ...
  16764(e, n, t) {
   ...
   var p = t(43864),
    ...
    D = t(79532),
    C = t(30758);
   const S = { boxShadow: p.A, color: j.A, cursor: x.A, dimension: v.A, fontFamily: f.A, fontFamilies: f.A, fontSize: k.A, fontSizes: k.A, fontWeight: b.A, fontWeights: b.A, lineHeight: y.A, lineHeights: y.A, number: w.A, other: A.A, textDecoration: D.A },
    N = ({ type: e }) => {
