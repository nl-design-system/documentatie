...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [84463],
 {
  ...
  33062(e, t, n) {
   n.d(t, { bo: () => i, KF: () => h, mJ: () => u, VZ: () => N, cR: () => w, Pv: () => f, qZ: () => o, kD: () => k, B2: () => g, Pc: () => l, f4: () => r, GT: () => b, fX: () => a, eQ: () => x, B_: () => v, o_: () => j, Rc: () => _ });
   ...
   const m = (e) => [...e].sort((e, t) => d.indexOf(e) - d.indexOf(t)),
    h = (e) => {
    ...
    p = (e) => {
     const t = / URL \(([^)]+)\)/;
     return m(c(e.tasks.filter(({ name: e, value: n }) => '' !== n && t.test(e)).map(({ name: e }) => t.exec(e)?.[1])));
    },
  ...
  74168(e, t, n) {
   (n.r(t), n.d(t, { assets: () => m, component: () => j, componentName: () => f, contentTitle: () => c, default: () => k, description: () => g, frontMatter: () => d, issueNumber: () => p, metadata: () => s, relayStep: () => u, title: () => h, toc: () => v }));
   ...
   function k(e = {}) {
    ...
    return t ? (0, i.jsx)(t, { ...e, children: (0, i.jsx)(x, { ...e }) }) : x(e);
   }
  },
  80506(e, t, n) {
   n.d(t, { VK: () => u, $9: () => j, mu: () => f, Fc: () => v });
   var s = n(29181),
    i = n(13526),
    a = n(1292),
    o = n(90495),
   ...
   const u = ({ component: e, headingLevel: t }) => {
         ...
         children: n
          ...
          .map((e) => {
           const n = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            m = e.tasks.filter(({ name: e, value: t }) => l.has(e) && URL.canParse(t) && 'https:' === new URL(t).protocol);
           return (0, d.jsx)(
            o.Zp,
            {
             ...
             children: (0, d.jsxs)(o.Wu, {
              children: [
               ...
               (m.length > 0 || r.length > 0) && (0, d.jsx)(s.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               m.length > 0 &&
                (0, d.jsx)(d.Fragment, {
    ...
    v = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(h.p, { level: t, suffix: i && (0, d.jsx)(m.D, { state: i }), children: e.title }), (0, d.jsx)(s.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
