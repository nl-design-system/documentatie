 ...
 [34492],
 {
  61441: (e, t, n) => {
   ...
   const o = { title: 'Progress Bar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress Bar', pagination_label: 'Progress Bar', description: 'Toont de voortgang van een proces in een balk.', slug: '/progress-bar', keywords: ['balk', 'balkindicator', 'linear progress', 'meter', 'progress', 'progressbalk', 'progress bar', 'progress indicator', 'progress loader', 'status', 'steps', 'voortgangsbalk'] },
    a = void 0,
    l = { id: 'componenten/progress-bar/index', title: 'Progress Bar', description: 'Toont de voortgang van een proces in een balk.', source: '@site/docs/componenten/progress-bar/index.mdx', sourceDirName: 'componenten/progress-bar', slug: '/progress-bar', permalink: '/progress-bar', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/progress-bar/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Progress Bar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress Bar', pagination_label: 'Progress Bar', description: 'Toont de voortgang van een proces in een balk.', slug: '/progress-bar', keywords: ['balk', 'balkindicator', 'linear progress', 'meter', 'progress', 'progressbalk', 'progress bar', 'progress indicator', 'progress loader', 'status', 'steps', 'voortgangsbalk'] }, sidebar: 'componenten', previous: { title: 'Password Input', permalink: '/password-input' }, next: { title: 'Progress Circle', permalink: '/progress-circle' } },
    u = {},
    h = [
  ...
  35038: (e, t, n) => {
   ...
   const i = (e) => {
     ...
     return (0, c.jsx)('div', { className: (0, s.Z)('card__illustration', t && 'card__illustration--background', r), ...i, children: n });
    },
    ...
    a = (e) => {
     ...
     const l = (e) => ('article' === o ? (0, c.jsx)('article', { ...e }) : 'section' === o ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      u = (0, c.jsx)(l, { className: (0, s.Z)('cardgroup__card', `cardgroup__card--${n}`, i), children: a });
  ...
  94443: (e, t, n) => {
   ...
   var r = n(41115),
    ...
    l = n(32636),
    u = n(52676);
   const h = { figma: (0, u.jsx)(c.Z, {}), github: (0, u.jsx)(i.Z, {}), npm: (0, u.jsx)(o.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
   ...
   const f = (e) => {
     ...
     const c = t && t.projects.filter((e) => k.e9.includes(e.id)),
      i = c && k.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
               ...
               c.length > 0 &&
                (0, u.jsx)(u.Fragment, {
                 children: c.map((e) => {
                  ...
                  return (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.X6, { level: n + 2, children: [s, ' in ', t] }), (0, u.jsx)(r.Mc, { links: c.map((e) => ({ children: e.description, icon: (0, u.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
    ...
    w = (e) => {
     ...
     const c = t && k.$3[t.relayStep];
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(g.V, { level: n, suffix: c && (0, u.jsx)(y.y, { state: c }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: s })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => m, BA: () => o, Ee: () => u, Q6: () => c, U: () => j, Yr: () => p, d: () => h, e9: () => i, fO: () => b, mA: () => s, ps: () => y, qU: () => k, s0: () => v, zP: () => g });
