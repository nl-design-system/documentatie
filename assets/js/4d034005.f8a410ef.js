/*! For license information please see 4d034005.f8a410ef.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [26733],
 {
  ...
  18652(e, n, i) {
   ...
   const s = (e, n, i, s) => {
    const o = (0, t.forwardRef)(({ color: i = 'currentColor', size: o = 24, stroke: a = 2, title: l, className: d, children: c, ...h }, g) => (0, t.createElement)('svg', { ref: g, ...r[e], width: o, height: o, className: ['tabler-icon', `tabler-icon-${n}`, d].join(' '), ...('filled' === e ? { fill: i } : { strokeWidth: a, stroke: i }), ...h }, [l && (0, t.createElement)('title', { key: 'svg-title' }, l), ...s.map(([e, n]) => (0, t.createElement)(e, n)), ...(Array.isArray(c) ? c : [c])]));
    return ((o.displayName = `${i}`), o);
   };
  },
  28330(e, n, i) {
   (i.r(n), i.d(n, { assets: () => h, contentTitle: () => c, default: () => u, frontMatter: () => d, metadata: () => t, toc: () => g }));
   const t = JSON.parse('{"id":"community/events/design-open-hour/index","title":"Design Open Hour","description":"Wat is Design Open Hour, hoe meld ik mij aan, en op welke momenten is het?","source":"@site/docs/community/events/design-open-hour/index.mdx","sourceDirName":"community/events/design-open-hour","slug":"/events/design-open-hour","permalink":"/events/design-open-hour","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/community/events/design-open-hour/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Design Open Hour","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Design Open Hour","pagination_label":"In de Design Open Hour wisselen designers informatie, inzichten en tips met elkaar uit.","description":"Wat is Design Open Hour, hoe meld ik mij aan, en op welke momenten is het?","slug":"/events/design-open-hour"},"sidebar":"community","previous":{"title":"Design Open Hour","permalink":"/events/design-open-hour/overzicht"},"next":{"title":"In de Design Open Hour wisselen designers informatie, inzichten en tips met elkaar uit.","permalink":"/events/design-open-hour/aanmelden"}}');
   var r = i(86070),
    s = i(18439),
    o = i(88666),
    a = i(64249),
