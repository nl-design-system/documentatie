 ...
 [70767],
 {
   ...
   const o = ({ background: e, children: t, className: n, ...r }) => (0, s.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: o = 'div', background: c, children: a }) => {
     const l = (e) => ('article' === o ? (0, s.jsx)('article', { ...e }) : 'section' === o ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      u = (0, s.jsx)(l, { className: (0, i.A)('cardgroup__card', c && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    l = n(83386),
    u = n(86070);
   const h = { figma: (0, u.jsx)(s.A, {}), github: (0, u.jsx)(o.A, {}), npm: (0, u.jsx)(c.A, {}), storybook: (0, u.jsx)(a.A, {}) },
   ...
   const b = ({ children: e }) => (0, u.jsx)('ul', { className: 'task-list', children: e }),
    k = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, u.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, u.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, u.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, u.jsx)(v.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(f.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }), r, t] })] });
   var x = n(75916);
   const _ = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(b, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(k, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            j.Zp,
            {
             ...
             children: (0, u.jsxs)(j.Wu, {
              children: [
               ...
               (0, u.jsxs)(r.fz, { children: [(0, u.jsx)(y, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
               (c.length > 0 || s.length > 0) && (0, u.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               c.length > 0 &&
                (0, u.jsx)(u.Fragment, {
               ...
               s.length > 0 && (0, u.jsx)(u.Fragment, { children: s.map(({ frameworkName: e, tasks: n }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, u.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, u.jsx)(d, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    N = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p.p, { level: t, suffix: i && (0, u.jsx)(g.D, { state: i }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  74111: (e, t, n) => {
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => p, GT: () => b, KF: () => h, Pc: () => c, Pv: () => y, Rc: () => k, bo: () => r, eQ: () => f, f4: () => o, fX: () => i, kD: () => v, mJ: () => m, o_: () => g, qZ: () => s });
   ...
   const u = (e) => [...e].sort((e, t) => a.indexOf(e) - a.indexOf(t)),
    ...
    m = (e) => u(l(e.projects.flatMap((e) => j(e)))),
    y = (e) => {
     const t = j(e),
      n = ((e) => {
  ...
  89840: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => l, default: () => p, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => h, toc: () => y });
