 ...
 [11341],
 {
  14881(e, n, o) {
   ...
   var l = o(13526),
    ...
    r = o(37168),
    a = o(86070);
   const c = (0, t.forwardRef)(({ as: e, className: n, children: o, ...t }, s) => {
     const r = e || 'div',
      c = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(r, { ref: s, className: c, ...t, children: o });
    }),
    i = ({ className: e, classNamePanel: n, label: o, heading: t, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, a.jsxs)('details', { className: p, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(s.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [t && (0, a.jsx)(r.D, { level: c, appearance: i, children: t }), o] })] }) }), (0, a.jsx)('div', { className: h, children: d.children })] });
    };
  },
  18439(e, n, o) {
   o.d(n, { R: () => r, x: () => a });
  ...
  28369(e, n, o) {
   ...
   function i({ lineNumber: e, syntax: n, textContent: o, trim: i }) {
    ...
    const { title: p, type: h } = (0, s.useContext)(r.x),
     u = (0, s.useId)();
    return (i && (d = d.trim()), (0, c.jsx)(t.f4, { theme: a, code: d, language: n || '', children: ({ style: n, tokens: o, getLineProps: t, getTokenProps: s }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: u, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, c.jsx)(l.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': u, style: n, children: o.map((n, o) => (0, c.jsxs)('span', { ...t({ line: n }), children: [e && (0, c.jsx)('span', { children: o + 1 }), n.map((e, n) => (0, c.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, o)) })] }) }));
   }
  },
  38953(e, n, o) {
   o.d(n, { H: () => k });
   var l = o(28369),
    ...
    y = o(46847),
    g = o(86070);
   const x = ({ children: e }) => (0, g.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(t.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(t.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   x.displayName = 'ParagraphContainer';
   const j = ({ children: e }) => (0, g.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(t.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const k = globalThis.isAstro
    ? ({ language: e, className: n, code: o = '<p>No code provided</p>', rawCode: l, copyCode: t, defaultExpandedCode: r, designTokens: a }) => {
       const c = 'string' == typeof o ? o : l || '',
        i = 'string' == typeof o ? m().highlight(o, m().languages[e], e) : m().highlight(l || '', m().languages[e], e);
       return (0, g.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', n), children: [(0, g.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: a, children: (0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: c } }) }), (0, g.jsx)(v.n, { children: (0, g.jsxs)(v.K, { label: 'Code', open: r, children: [(0, g.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: i } }) }), 'allow' === t && (0, g.jsx)(y.$, { 'data-copy-code': c, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: u = !0, children: m, container: v = 'document', language: y, designTokens: k }) => {
       ...
       (0, p.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(_, { parser: y, plugins: [r.A, a.Ay, c.Ay, i.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [_]);
       const z = (0, p.useId)();
       let R = p.Fragment;
       return (
        'paragraph' === v ? (R = x) : 'document' === v ? (R = j) : 'surface' === v && (R = b),
        (0, g.jsxs)('div', {
         className: (0, s.A)('nlds-canvas'),
         children: [
          f && (0, g.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, g.jsx)(R, { children: (0, g.jsx)(t.v$, { children: f }) }) }) }),
          u &&
           (0, g.jsx)('div', {
          ...
          u &&
           (0, g.jsxs)('div', {
            ...
            hidden: !C,
            children: [
             (0, g.jsx)(l.M, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: N, trim: !0 }),
             n &&
              (0, g.jsx)('div', {
