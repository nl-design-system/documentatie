 ...
 [99452],
 {
  ...
  19988(e, n, a) {
   ...
   var s = a(86070),
    ...
    l = a(56167),
    o = a(17842);
   const g = { title: 'Progress Circle', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress Circle', pagination_label: 'Progress Circle', description: 'Toont de voortgang van een bepaald proces in de vorm van een cirkel.', issue_number: 366, slug: '/progress-circle' },
    d = void 0,
    u = {},
    m = 'Progress Circle',
    c = 'Toont de voortgang van een bepaald proces in de vorm van een cirkel.',
    p = 366,
    h = 'help wanted',
    x = 'progress-circle',
