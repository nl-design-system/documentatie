 ...
 [46190],
 {
  ...
  28384(e, n, t) {
   ...
   const d = { title: 'Notification Banner', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Notification Banner', pagination_label: 'Notification Banner', description: 'Toont een informerend bericht dat niet direct is gerelateerd aan de inhoud van een pagina.', slug: '/notification-banner', keywords: ['alert', 'banner', 'banner alert', 'call alert', 'callout', 'feedback', 'highlighter', 'inline alert', 'inline message', 'message', 'message bar', 'note', 'notificatie', 'notificatiebanner', 'notification', 'notification banner', 'page alert', 'panel', 'top of page alert', 'waarschuwing', 'warning'] },
    ...
    g = 'Toont een informerend bericht dat niet direct is gerelateerd aan de inhoud van een pagina.',
    p = 169,
    u = 'help wanted',
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => m, mJ: () => u, VZ: () => w, cR: () => N, Pv: () => f, qZ: () => s, kD: () => v, B2: () => g, Pc: () => l, f4: () => o, GT: () => _, fX: () => r, eQ: () => b, B_: () => x, o_: () => j, Rc: () => k });
     ...
     return n.map((n) => {
      const a = e.tasks
       ...
       .map(({ name: a, id: i, value: r }) => {
        ...
        return { brand: s.toLowerCase(), name: a, id: i, value: r, description: o };
       });
  ...
  44594(e, n, t) {
   ...
   const o = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    l = ({ name: e, relayStep: n, description: t }) => {
     const l = (0, r.fX)(n),
      d = o[e] ?? e;
     return (0, s.jsxs)(a.WK, { children: [(0, s.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, i.A)('component-illustration', `component-illustration--${l}`), fill: 'none', children: [(0, s.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, s.jsx)('rect', { width: '960', height: '540' }), (0, s.jsx)('rect', { width: '960', height: '540' })] }), (0, s.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, s.jsx)('use', { href: `/svg/componenten_overzicht_${(0, r.fX)(d)}.svg#component-illustration` })] }), (0, s.jsx)(a.$P, { className: 'component-illustration__caption', children: t })] });
    };
  },
  54565(e, n, t) {
   t.d(n, { c: () => i });
  ...
  67970(e, n, t) {
   ...
   const o = ({ state: e }) => {
    const n = (0, r.fX)(e);
    return (0, s.jsx)(a.KE, { className: (0, i.A)('estafette-badge', n && `estafette-badge--${n}`), children: e });
   };
  },
  72642(e, n, t) {
   t.d(n, { p: () => r });
  ...
  80506(e, n, t) {
   ...
   const u = ({ component: e, headingLevel: n }) => {
    ...
    x = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: i && (0, d.jsx)(h.D, { state: i }), children: e.title }), (0, d.jsx)(a.fz, { lead: !0, children: t })] });
    };
  },
  90495(e, n, t) {
   ...
   var a = t(46447),
    i = t(13526),
    r = t(86070);
   const s = ({ background: e, children: n, className: t, ...a }) => (0, r.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, t), ...a, children: n }),
    ...
    l = ({ href: e, appearance: n, className: t, component: s = 'div', background: o, children: l }) => {
     const d = (e) => ('article' === s ? (0, r.jsx)('article', { ...e }) : 'section' === s ? (0, r.jsx)('section', { ...e }) : (0, r.jsx)('div', { ...e })),
      c = (0, r.jsx)(d, { className: (0, i.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: l });
