 ...
 [12543],
 {
  3227(e, n, i) {
   ...
   function a({ href: e, icon: n = '', title: i, description: t, children: o }) {
    return (0, c.jsxs)('div', { className: 'card', children: [e ? (0, c.jsx)(r.N, { href: e, className: (0, l.A)('cardLink', 'utrecht-link'), children: (0, c.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', i] }) }) : (0, c.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', i] }), t && (0, c.jsx)('p', { className: 'cardDescription', children: t }), o] });
   }
   function d({ item: e }) {
   ...
   function m({ className: e }) {
    const n = (0, t.$S)();
    return (0, c.jsx)(u, { items: n.items, className: e });
   }
   function u(e) {
    const { items: n, className: i } = e;
    if (!n) return (0, c.jsx)(m, { ...e });
    const r = (0, t.d1)(n);
    return (0, c.jsx)('section', { className: (0, l.A)('row', i), ...e, children: r.map((e, n) => (0, c.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, c.jsx)(j, { item: e }) }, n)) });
   }
  },
  18439(e, n, i) {
   i.d(n, { R: () => s, x: () => l });
  ...
  45282(e, n, i) {
   ...
   const o = ({ children: e, ...n }) => {
    ...
    s = ({ className: e, ...n }) => (0, r.jsx)(o, { className: (0, t.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  60316(e, n, i) {
   i.d(n, { $S: () => t, d1: () => r });
   i(74147);
  ...
  89874(e, n, i) {
   ...
   const l = (e, n) => e.reduce((e, i) => ('link' === i.type ? (n.includes(i.docId) ? e : [...e, i]) : 'category' === i.type ? [...e, { ...i, items: l(i.items, n) }] : e), []),
    c = ({ excludeDocIDs: e = [], className: n, ...i }) => {
     const c = (0, t.$S)();
     return (0, s.jsx)('div', { ...i, className: (0, r.A)('margin-top--lg', n), children: (0, s.jsx)(o.A, { items: l(c.items, e) }) });
    };
  },
 },
]);
