(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [40958],
 {
  50583: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => a, default: () => g, description: () => j, frontMatter: () => s, issueNumber: () => y, metadata: () => l, title: () => d, toc: () => h });
   var r = n(52676),
    o = n(40139),
    c = n(99890),
    i = n(8657);
   const s = { title: 'Select Combobox', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Select Combobox', pagination_label: 'Select Combobox', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren, waarbij de getoonde opties kunnen worden gefilterd door tekst in een invoerveld in te voeren.', slug: '/select-combobox', keywords: ['autocomplete', 'automatisch aanvullen', 'combo box', 'combobox', 'dropdown', 'dropdown list', 'dropdown menu', 'dropdown with filter', 'filter', 'keuzeveld', 'multiselect', 'opties', 'options', 'option list', 'optie kiezen', 'option selector', 'select', 'select field', 'select input', 'select combobox', 'selection box', 'typeahead'] },
    a = void 0,
    l = { id: 'componenten/select-combobox/index', title: 'Select Combobox', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren, waarbij de getoonde opties kunnen worden gefilterd door tekst in een invoerveld in te voeren.', source: '@site/docs/componenten/select-combobox/index.mdx', sourceDirName: 'componenten/select-combobox', slug: '/select-combobox', permalink: '/select-combobox', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/select-combobox/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Select Combobox', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Select Combobox', pagination_label: 'Select Combobox', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren, waarbij de getoonde opties kunnen worden gefilterd door tekst in een invoerveld in te voeren.', slug: '/select-combobox', keywords: ['autocomplete', 'automatisch aanvullen', 'combo box', 'combobox', 'dropdown', 'dropdown list', 'dropdown menu', 'dropdown with filter', 'filter', 'keuzeveld', 'multiselect', 'opties', 'options', 'option list', 'optie kiezen', 'option selector', 'select', 'select field', 'select input', 'select combobox', 'selection box', 'typeahead'] }, sidebar: 'componenten', previous: { title: 'Select', permalink: '/select' }, next: { title: 'Separator', permalink: '/separator' } },
    u = {},
    h = [
  ...
  35038: (e, t, n) => {
   'use strict';
   n.d(t, { Zb: () => a, aY: () => s, um: () => l, wu: () => i });
   var r = n(37943),
    o = n(4814),
    c = n(52676);
   const i = (e) => {
     let { background: t, children: n, className: r, ...i } = e;
     return (0, c.jsx)('div', { className: (0, o.Z)('card__illustration', t && `card__illustration--${t}`, r), ...i, children: n });
    },
    s = (e) => (0, c.jsx)('div', { className: 'card__content', ...e }),
    a = (e) => {
     let { href: t, appearance: n, className: i, component: s = 'div', background: a, children: l } = e;
     const u = (e) => ('article' === s ? (0, c.jsx)('article', { ...e }) : 'section' === s ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      h = (0, c.jsx)(u, { className: (0, o.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, i), children: l });
    ...
    l = (e) => {
     ...
     return (0, c.jsx)('div', { className: (0, o.Z)('cardgroup', `cardgroup--${t}`, r), children: n });
    };
  },
  8657: (e, t, n) => {
   'use strict';
   ...
   var r = n(74824),
    ...
    l = n(32636),
    u = n(52676);
   const h = { figma: (0, u.jsx)(c.Z, {}), github: (0, u.jsx)(i.Z, {}), npm: (0, u.jsx)(s.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
   ...
   const w = (e) => {
     ...
     return (
      ...
      (0, u.jsx)(r.a2, {
       sections: i.map((e) => ({
        className: (0, o.Z)('definition-of-done', e && `definition-of-done--${(0, x.mA)(s(e))}`),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, u.jsx)(k, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(f, { headingLevel: n + 1, checked: t, title: r, description: (0, x.Q6)(o) }, o);
            }),
           }),
           (0, u.jsx)(r.nv, { children: (0, u.jsxs)(r.rU, { href: `${e.url}?filterQuery=${t.title}`, children: [s(e), ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
            ...
            j.Zb,
            {
             ...
             children: (0, u.jsxs)(j.aY, {
              children: [
               ...
               (s.length > 0 || c.length > 0) && (0, u.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               s.length > 0 &&
                (0, u.jsx)(u.Fragment, {
               ...
               c.length > 0 &&
                (0, u.jsx)(u.Fragment, {
                 children: c.map((e) => {
                  ...
                  return (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.X6, { level: n + 2, children: [o, ' in ', t] }), (0, u.jsx)(r.Mc, { links: c.map((e) => ({ children: e.description, icon: (0, u.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
  ...
  41757: (e, t, n) => {
   ...
   var r = n(4814),
    o = n(52676);
   const c = (e) => {
    let { children: t, className: n, level: c = 1, suffix: i, ...s } = e;
    return (0, o.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${c}`, n), ...s, children: [(0, o.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), i && (0, o.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [i ? ' ' : '', i] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => s, Ee: () => u, Q6: () => c, U: () => j, Yr: () => g, d: () => h, e9: () => i, fO: () => v, mA: () => o, ps: () => y, qU: () => k, s0: () => b, zP: () => m });
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        ...
        return { brand: s.toLowerCase(), name: o, id: c, value: i, description: a };
       });
