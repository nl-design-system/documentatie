 ...
 [34531],
 {
  15175(e, n, a) {
   ...
   function d({ lineNumber: e, syntax: n, textContent: a, trim: d }) {
    ...
    const { title: p, type: u } = (0, r.useContext)(i.x),
     k = (0, r.useId)();
    return (d && (c = c.trim()), (0, s.jsx)(t.f4, { theme: l, code: c, language: n || '', children: ({ style: n, tokens: a, getLineProps: t, getTokenProps: r }) => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: k, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, s.jsx)(o.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': k, style: n, children: a.map((n, a) => (0, s.jsxs)('span', { ...t({ line: n }), children: [e && (0, s.jsx)('span', { children: a + 1 }), n.map((e, n) => (0, s.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, a)) })] }) }));
   }
  },
  18439(e, n, a) {
   a.d(n, { R: () => i, x: () => l });
  ...
  70348(e, n, a) {
   ...
   const l = ({ className: e, ...n }) => {
     const a = (0, o.A)('ma-utrecht-accordion', 'utrecht-accordion', e);
     return (0, i.jsx)('div', { className: a, children: n.children });
    },
    s = ({ className: e, classNamePanel: n, label: a, heading: l, headingLevel: s, headingApperance: d, ...c }) => {
     const p = (0, o.A)('utrecht-accordion__section', e),
      u = (0, o.A)('utrecht-accordion__panel', n);
     return (0, i.jsxs)('details', { className: p, ...c, children: [(0, i.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, i.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, i.jsx)('span', { className: 'nl-button__icon-start', children: (0, i.jsx)(t.A, {}) }), (0, i.jsxs)('span', { className: 'nl-button__label', children: [l && (0, i.jsx)(r.D, { level: s, appearance: d, children: l }), a] })] }) }), (0, i.jsx)('div', { className: u, children: c.children })] });
    };
  },
  80731(e, n, a) {
   a.d(n, { H: () => x });
   var o = a(15175),
    ...
    v = a(70348),
    g = a(86070);
   const m = ({ children: e }) => (0, g.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(t.yo, { className: (0, r.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(t.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   m.displayName = 'ParagraphContainer';
   const j = ({ children: e }) => (0, g.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(t.yo, { className: (0, r.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: a }) => {
       const o = 'function' == typeof e ? e() : e,
        ...
        i = h().highlight(t, h().languages[n], n);
       return (0, g.jsxs)('div', { className: (0, r.A)('ma-canvas-astro', a), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: t } }), (0, g.jsx)(v.n, { children: (0, g.jsx)(v.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: i } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: a = !1, displayCode: k = !0, children: h, container: v = 'document', language: x, designTokens: y }) => {
       ...
       return (
        ...
        (0, g.jsxs)('div', {
         ...
         children: [
          f && (0, g.jsx)('div', { className: (0, r.A)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, g.jsx)(K, { children: (0, g.jsx)(t.v$, { children: f }) }) }) }),
          k &&
           (0, g.jsx)('div', {
          ...
          k &&
           (0, g.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, g.jsx)(o.M, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: z, trim: !0 }),
             n &&
              (0, g.jsx)('div', {
