(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [33430],
 {
  83588: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => j, component: () => v, contentTitle: () => h, default: () => b, description: () => g, frontMatter: () => d, issueNumber: () => p, metadata: () => u, title: () => y, toc: () => m });
   var r = n(52676),
    s = n(40139),
    c = n(43166),
    i = n(45994),
   ...
   const i = (e) => {
    ...
    a = (e) => {
     ...
     const l = (e) => ('article' === o ? (0, c.jsx)('article', { ...e }) : 'section' === o ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      d = (0, c.jsx)(l, { className: (0, s.Z)('cardgroup__card', `cardgroup__card--${n}`, i), children: a });
  ...
  76233: (e, t, n) => {
   ...
   const a = (e) => {
    ...
    d = (e) => {
     ...
     const { title: h } = t,
      u = (0, i.mA)(h),
      j = c.lazy(() => n(22930)(`./${u}-docs/docs/anatomy/anatomy.md`).catch(() => ({ default: () => null })));
  ...
  94443: (e, t, n) => {
   ...
   var r = n(41115),
    ...
    l = n(32636),
    d = n(52676);
   const h = { figma: (0, d.jsx)(c.Z, {}), github: (0, d.jsx)(i.Z, {}), npm: (0, d.jsx)(o.Z, {}), storybook: (0, d.jsx)(a.Z, {}) },
    u = (e) => {
     let { brand: t } = e;
   ...
   const f = (e) => {
          ...
          children: [
           (0, d.jsx)(v, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(k, { headingLevel: n + 1, checked: t, title: r, description: (0, b.Q6)(s) }, s);
            }),
           }),
               ...
               c.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: c.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: n + 2, children: [s, ' in ', t] }), (0, d.jsx)(r.Mc, { links: c.map((e) => ({ children: e.description, icon: (0, d.jsx)(u, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
    ...
    w = (e) => {
     ...
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(y.V, { level: n, suffix: c && (0, d.jsx)(m.y, { state: c }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: s })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => g, BA: () => o, Ee: () => d, Q6: () => c, U: () => j, Yr: () => p, d: () => h, e9: () => i, fO: () => k, mA: () => s, ps: () => m, qU: () => b, s0: () => v, zP: () => y });
   ...
   const l = (e) => {
    ...
    j = (e) => l(a(e.projects.flatMap((e) => u(e)))),
    m = (e) => {
     const t = u(e),
      n = ((e) => {
       const t = e.tasks.find((e) => {
