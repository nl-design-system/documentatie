 ...
 [27297],
 {
  ...
  41757: (e, n, i) => {
   ...
   var r = i(4814),
    t = i(52676);
   const l = (e) => {
    let { children: n, className: i, level: l = 1, suffix: s, ...o } = e;
    return (0, t.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${l}`, i), ...o, children: [(0, t.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: n }), s && (0, t.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
   };
  },
  57716: (e, n, i) => {
   i.d(n, { U: () => c });
   ...
   const s = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, l.jsx)(r.Z, { components: { ...d(i, t), ...a(s), ...o }, children: n });
    };
  },
  46364: (e, n, i) => {
   i.d(n, { j: () => s });
