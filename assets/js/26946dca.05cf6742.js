 ...
 [3958],
 {
  1292(e, n, t) {
   ...
   var r = t(29181),
    ...
    a = t(83386),
    l = t(86070);
   const d = { figma: (0, l.jsx)(o.A, {}), github: (0, l.jsx)(s.A, {}), npm: (0, l.jsx)(c.A, {}), storybook: (0, l.jsx)(i.A, {}) },
  ...
  12013(e, n, t) {
   ...
   const c = (e, n) => {
    ...
    a = (e) => ({ img: ({ src: n, ...t }) => (0, s.jsx)('img', { ...t, src: c(e, n), className: 'utrecht-img utrecht-img--fit' }) }),
    l = (e, n) => {
     if (e) {
      const e = { ...i[n - 1] };
      return ((e.h1 = () => null), e);
    ...
    d = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: o = '', components: c = {} }) => (0, s.jsx)(r.x, { components: { ...l(n, t), ...a(o), ...c }, children: e });
  },
  17045(e, n, t) {
   'use strict';
   t.d(n, { Ay: () => i, RM: () => s });
  ...
  17889(e, n, t) {
    ...
    return 'clipboard' in navigator
     ? (0, j.jsxs)(c.$n, {
        ...
        onClick: async function () {
         try {
          const e = await d.Ay.format(n, { parser: t, plugins: [i.A, a.Ay, l.Ay] });
   ...
   var m = t(35193),
    ...
    f = t(79532),
    w = t(30758);
   const A = { color: m.A, dimension: g.A, fontFamilies: k.A, fontSizes: y.A, fontWeights: b.A, lineHeights: v.A, other: x.A, textDecoration: f.A },
    _ = ({ type: e }) => (0, j.jsx)(u.In, { children: (0, w.createElement)(A[e]) });
   function z({ tokens: e }) {
    const n = (0, s.kD)(e),
     t = (0, s.GT)(n),
     i = t.map((e) => (0, s.B_)(e) + ': ;').join('\n'),
     a = JSON.stringify((0, s.Rc)(t));
    return (0, j.jsxs)(j.Fragment, {
     children: [
      (0, j.jsxs)(c.XI, {
       children: [
        (0, j.jsx)(c.A0, { children: (0, j.jsxs)(c.Hj, { children: [(0, j.jsx)(c.M_, { children: 'name' }), (0, j.jsx)(c.M_, { children: 'type' })] }) }),
        (0, j.jsx)(c.BF, {
         children: t.map((n) => {
          const t = (0, s.o_)(n),
           i = (0, s.eQ)(e, n).$type;
          return (0, j.jsxs)(c.Hj, { children: [(0, j.jsx)(c.nA, { children: (0, j.jsx)(r.C, { children: (0, j.jsx)(c.kf, { children: t }) }) }), (0, j.jsx)(c.nA, { children: (0, j.jsxs)(o.K, { children: [(0, j.jsx)(_, { type: i }), ' ', i] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, j.jsxs)(c.e2, { children: [(0, j.jsx)(p, { content: a, language: 'json', children: 'Kopieer als JSON' }), (0, j.jsx)(p, { content: i, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => o, KF: () => u, mJ: () => m, VZ: () => A, cR: () => w, Pv: () => g, qZ: () => c, kD: () => v, B2: () => j, Pc: () => a, f4: () => i, GT: () => x, fX: () => s, eQ: () => b, B_: () => y, o_: () => k, Rc: () => f });
      ...
      const r = e.tasks
       ...
       .map(({ name: r, id: o, value: s }) => {
        const c = /^(.+) URL/.exec(r)[1],
         i = 'Storybook' === c ? `${t} (${n}) in Storybook van ${e.title}` : `${t} (${n}) op ${c}`;
        return { brand: c.toLowerCase(), name: r, id: o, value: s, description: i };
       });
  ...
  64600(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => C, component: () => R, contentTitle: () => S, default: () => O, description: () => L, frontMatter: () => D, issueNumber: () => M, metadata: () => r, title: () => T, toc: () => F }));
   ...
   function z(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
    return n ? (0, o.jsx)(n, { ...e, children: (0, o.jsx)(_, { ...e }) }) : _(e);
   }
   var N = t(89019);
    ...
    return (
     ...
     (0, o.jsxs)(o.Fragment, {
      children: [
       ...
       '\n',
       '\n',
       (0, o.jsx)(f.Fc, { component: R, headingLevel: 1, description: L }),
       '\n',
       (0, o.jsx)(x.e, { component: R }),
       '\n',
       ...
       '\n',
       (0, o.jsx)(k.Zp, { className: 'implementation-card', children: (0, o.jsxs)(k.Wu, { children: [(0, o.jsx)(b.D, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, o.jsxs)(y.dk, { children: [(0, o.jsxs)(y.Pt, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=13778-3553', children: [(0, o.jsx)(v.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, o.jsxs)(y.Pt, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=13778-3553', children: [(0, o.jsx)(v.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, o.jsx)(b.D, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, o.jsxs)(y.dk, { children: [(0, o.jsxs)(y.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-code-block--documentatie', children: [(0, o.jsx)(v.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, o.jsxs)(y.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/code-block--documentatie', children: [(0, o.jsx)(v.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, o.jsx)(b.D, { level: 2, appearance: 'level-4', children: 'npm' }), (0, o.jsxs)(y.dk, { children: [(0, o.jsxs)(y.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-css', children: [(0, o.jsx)(v.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-css'] }), (0, o.jsxs)(y.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-react', children: [(0, o.jsx)(v.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-react'] }), (0, o.jsxs)(y.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-tokens', children: [(0, o.jsx)(v.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-tokens'] })] })] }) }),
       '\n',
       ...
       (0, o.jsx)(t, {
        headingLevel: '4',
        items: [
         { title: 'De code is niet alleen herkenbaar aan een andere achtergrondkleur.', sc: '1.4.1', status: '', component: (0, o.jsx)(g.Ay, {}), tags: ['designer', 'contentmaker', 'developer'] },
       ...
       (0, o.jsx)(t, {
        ...
        items: [
         ...
         { title: 'Als je inzoomt naar 200% blijft alle tekst leesbaar.', sc: '1.4.4', status: '', component: (0, o.jsx)(m.Ay, {}), tags: ['developer'] },
         { title: 'Als je de tekstafstand vergroot blijft de tekst in zijn geheel zichtbaar.', sc: '1.4.12', status: '', component: (0, o.jsx)(j.Ay, {}), tags: ['developer'] },
        ],
       }),
       '\n',
       (0, o.jsx)(A.o, { omitH1: !0, headingLevel: 2, children: (0, o.jsx)(z, {}) }),
       '\n',
       (0, o.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }),
       '\n',
       (0, o.jsx)(w.B, { tokens: N }),
       '\n',
       (0, o.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
       '\n',
       (0, o.jsx)(f.VK, { component: R, headingLevel: 3 }),
       '\n',
       (0, o.jsx)(f.$9, { component: R, headingLevel: 2 }),
       '\n',
       (0, o.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
       '\n',
       (0, o.jsx)(f.mu, { component: R, headingLevel: 3 }),
      ],
     })
    );
   }
  ...
  67970(e, n, t) {
   ...
   const i = ({ state: e }) => {
    const n = (0, s.fX)(e);
    return (0, c.jsx)(r.KE, { className: (0, o.A)('estafette-badge', n && `estafette-badge--${n}`), children: e });
   };
  },
  72401(e, n, t) {
   'use strict';
   ...
   const i = ({ component: e }) => {
    const { title: n } = e,
     i = (0, s.fX)(n),
     a = o.lazy(() => t(82839)(`./${i}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
    return (0, c.jsx)(o.Suspense, { fallback: null, children: (0, c.jsx)(r.o, { omitH1: !0, headingLevel: 1, children: (0, c.jsx)(a, {}) }) });
   };
  },
  72642(e, n, t) {
   'use strict';
   ...
   var r = t(13526),
    o = t(86070);
   const s = ({ children: e, className: n, level: t = 1, suffix: s, ...c }) => (0, o.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${t}`, n), ...c, children: [(0, o.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), s && (0, o.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
  },
  82839(e, n, t) {
            ...
            c.Zp,
            {
             ...
             children: (0, l.jsxs)(c.Wu, {
              children: [
               ...
               (h.length > 0 || i.length > 0) && (0, l.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, l.jsx)(l.Fragment, {
               ...
               i.length > 0 && (0, l.jsx)(l.Fragment, { children: i.map(({ frameworkName: e, tasks: t }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, l.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, l.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  90495(e, n, t) {
   'use strict';
   t.d(n, { AC: () => l, Fu: () => c, Wu: () => i, Zp: () => a });
   var r = t(46447),
    o = t(13526),
    s = t(86070);
   const c = ({ background: e, children: n, className: t, ...r }) => (0, s.jsx)('div', { className: (0, o.A)('card__illustration', e && `card__illustration--${e}`, t), ...r, children: n }),
    i = (e) => (0, s.jsx)('div', { className: 'card__content', ...e }),
    a = ({ href: e, appearance: n, className: t, component: c = 'div', background: i, children: a }) => {
     const l = (e) => ('article' === c ? (0, s.jsx)('article', { ...e }) : 'section' === c ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      d = (0, s.jsx)(l, { className: (0, o.A)('cardgroup__card', i && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: a });
