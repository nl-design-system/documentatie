(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [98634],
 {
  ...
  43205: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => U, component: () => K, contentTitle: () => O, default: () => Y, description: () => $, frontMatter: () => E, issueNumber: () => X, metadata: () => H, title: () => B, toc: () => I });
   var r,
    i,
    o,
    s,
   ...
   var y = t(25093),
    ...
    M = t(55240),
    V = t(8657);
   const E = { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.', slug: '/link' },
    O = void 0,
    H = { id: 'componenten/link/index', title: 'Link', description: 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.', source: '@site/docs/componenten/link/index.mdx', sourceDirName: 'componenten/link', slug: '/link', permalink: '/link', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/link/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.', slug: '/link' }, sidebar: 'componenten', previous: { title: 'Language Navigation', permalink: '/language-navigation' }, next: { title: 'Link List', permalink: '/link-list' } },
    U = {},
    I = [
   ...
   function J(e) {
    ...
    return (0, u.jsxs)(u.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, u.jsx)(V.Rv, { component: K, headingLevel: 1, description: $ }),
      '\n',
      (0, u.jsx)(S.I, { component: K }),
      '\n',
      (0, u.jsx)(n.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, u.jsx)(F.B, { component: K, illustration: w }),
      '\n',
      (0, u.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, u.jsx)(V.cN, { component: K, headingLevel: 3 }),
      '\n',
      (0, u.jsx)(n.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, u.jsx)(V.W, { component: K, headingLevel: 3 }),
      '\n',
      ...
      (0, u.jsx)(M.t, {
       ...
       items: [
        ...
        { title: 'De linktekst van de Link vertelt eenduidig aan de gebruiker waar de link naar toe gaat (het linkdoel).', sc: '2.4.4', status: '', component: (0, u.jsx)(P.ZP, {}) },
      ...
      (0, u.jsx)(M.t, {
       ...
       items: [
        ...
        { title: 'Links met gelijke functies hebben hetzelfde uiterlijk en hetzelfde label', sc: '3.2.4', status: '', component: (0, u.jsx)(Z.ZP, {}) },
       ],
      }),
      '\n',
      (0, u.jsx)(M.t, {
      ...
      (0, u.jsx)(M.t, {
       ...
       items: [
        ...
        { title: 'Als de gebruiker de Link indrukt met een aanwijzer zoals een muis of vinger, is er de mogelijkheid is om actie te voorkomen of ongedaan te maken', sc: '2.5.2', status: '', component: (0, u.jsx)(z.ZP, {}) },
       ],
      }),
      '\n',
      (0, u.jsx)(M.t, {
      ...
      '\n',
      (0, u.jsx)(V.vM, { component: K, headingLevel: 3 }),
     ],
    });
   }
   function Y(e = {}) {
    const { wrapper: n } = { ...(0, m.a)(), ...e.components };
    return n ? (0, u.jsx)(n, { ...e, children: (0, u.jsx)(J, { ...e }) }) : J(e);
   }
  },
  35622: (e, n, t) => {
   'use strict';
