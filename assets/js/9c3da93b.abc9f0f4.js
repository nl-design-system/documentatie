 ...
 [21907],
 {
  ...
  80731(e, n, t) {
   ...
   var i = t(15175),
    ...
    u = t(70348),
    j = t(86070);
   const m = ({ children: e }) => (0, j.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(o.yo, { className: (0, l.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, j.jsx)(o.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   ...
   const k = ({ children: e }) => (0, j.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: e });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       ...
       return (0, j.jsxs)('div', { className: (0, l.A)('ma-canvas-astro', t), children: [(0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }), (0, j.jsx)(u.n, { children: (0, j.jsx)(u.K, { label: 'Code', children: (0, j.jsx)('pre', { className: 'language-html nl-code-block', children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: v = !0, children: p, container: u = 'document', language: x, designTokens: f }) => {
       ...
       (0, g.useEffect)(() => {
        (async () => {
         const e = await c.Ay.format(_, { parser: x, plugins: [r.A, d.Ay, a.Ay, s.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         N(e);
        })();
       }, [_]);
       const O = (0, g.useId)();
       let D = g.Fragment;
       return (
        'paragraph' === u ? (D = m) : 'document' === u ? (D = b) : 'surface' === u && (D = k),
        (0, j.jsxs)('div', {
         className: (0, l.A)('nlds-canvas'),
         children: [
          y && (0, j.jsx)('div', { className: (0, l.A)('nlds-canvas__example'), children: (0, j.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, j.jsx)(D, { children: (0, j.jsx)(o.v$, { children: y }) }) }) }),
          v &&
           (0, j.jsx)('div', {
          ...
          v &&
           (0, j.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, j.jsx)(i.M, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: w, trim: !0 }),
             n &&
              (0, j.jsx)('div', {
