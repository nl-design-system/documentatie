 ...
 [91416],
 {
  ...
  50341: (e, t, n) => {
   ...
   const _ = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, l.jsx)(r.If, { sections: i.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(f, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(k, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => p, GT: () => f, KF: () => h, Pc: () => o, Pv: () => m, Rc: () => k, bo: () => r, eQ: () => v, f4: () => s, fX: () => c, kD: () => b, mJ: () => y, o_: () => g, qZ: () => i });
