   ...
   const b = ({ code: e, copy: l = !0, defaultExpandedCode: n = !1, displayCode: b = !0, children: j, container: x = 'document', language: y, designTokens: f }) => {
    ...
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       k && (0, p.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(F, { children: (0, p.jsx)(s.v$, { children: k }) }) }) }),
       b &&
        (0, p.jsx)('div', {
