...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [51192],
 {
  ...
  43599: (e, l, n) => {
   ...
   const m = (e) => {
    let { children: l } = e;
    return (0, h.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(r.BB, { className: (0, t.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, h.jsx)(r.nv, { className: 'nlds-canvas__example-paragraph', children: l }) }) });
   };
   m.displayName = 'ParagraphContainer';
   const b = (e) => {
    let { children: l } = e;
    return (0, h.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(r.BB, { className: (0, t.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: l }) });
   };
   b.displayName = 'DocumentContainer';
   const v = (e) => {
    let { children: l } = e;
    return (0, h.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: l });
   };
   ...
   const g = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (P = await d.ZP.format(w, { parser: k, plugins: [a.Z, s.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(P);
     })();
    }, [w]);
    const z = (0, u.useId)();
    let E = u.Fragment;
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       _ && (0, h.jsx)('div', { className: (0, t.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(E, { children: (0, h.jsx)(r.pu, { children: _ }) }) }) }),
       j &&
        (0, h.jsx)('div', {
       ...
       j &&
        (0, h.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, h.jsx)(o.u, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: P, trim: !0 }),
          n &&
           (0, h.jsx)('div', {
