 ...
 [44125],
 {
  1292(e, n, t) {
   ...
   var o = t(29181),
    ...
    c = t(83386),
    l = t(86070);
   const d = { figma: (0, l.jsx)(i.A, {}), github: (0, l.jsx)(s.A, {}), npm: (0, l.jsx)(r.A, {}), storybook: (0, l.jsx)(a.A, {}) },
    u = ({ brand: e }) => (0, l.jsx)(o.In, { children: d[e] || (0, l.jsx)(c.A, {}) });
  },
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => p, mJ: () => g, VZ: () => N, cR: () => A, Pv: () => k, qZ: () => r, kD: () => x, B2: () => m, Pc: () => c, f4: () => a, GT: () => j, fX: () => s, eQ: () => b, B_: () => f, o_: () => v, Rc: () => _ });
   ...
   const u = (e) => [...e].sort((e, n) => l.indexOf(e) - l.indexOf(n)),
    ...
    g = (e) => u(d(e.projects.flatMap((e) => h(e)))),
    k = (e) => {
     const n = h(e),
      t = ((e) => {
  ...
  37815(e, n, t) {
   (t.r(n), t.d(n, { assets: () => d, component: () => h, contentTitle: () => l, default: () => v, description: () => p, frontMatter: () => c, issueNumber: () => m, metadata: () => o, title: () => u, toc: () => g }));
   ...
   function k(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, i.jsx)(a.Fc, { component: h, headingLevel: 1, description: p }), '\n', (0, i.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, i.jsx)(a.VK, { component: h, headingLevel: 3 }), '\n', (0, i.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, i.jsx)(a.mu, { component: h, headingLevel: 3 }), '\n', (0, i.jsx)(a.$9, { component: h, headingLevel: 2 })] });
   }
   function v(e = {}) {
  ...
  80506(e, n, t) {
   ...
   const g = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, l.jsx)(o.If, { sections: s.map((t) => ({ className: (0, i.A)('definition-of-done', t && `definition-of-done--${(0, h.fX)(t.title)}`), headingLevel: n, expanded: !1, label: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', body: t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(m._, { children: t.tasks.map(({ checked: e, name: t, id: o }) => (0, l.jsx)(m.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, h.qZ)(o) }, o)) }), (0, l.jsx)(o.fz, { children: (0, l.jsxs)(o.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            r.Zp,
            {
             ...
             children: (0, l.jsxs)(r.Wu, {
              children: [
               ...
               (0, l.jsxs)(o.fz, { children: [(0, l.jsx)(d, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, l.jsxs)(o.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
               (u.length > 0 || a.length > 0) && (0, l.jsx)(o.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               u.length > 0 &&
                (0, l.jsx)(l.Fragment, {
               ...
               a.length > 0 && (0, l.jsx)(l.Fragment, { children: a.map(({ frameworkName: e, tasks: t }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(o.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, l.jsx)(o.dk, { links: t.map((e) => ({ children: e.description, icon: (0, l.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    v = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(o.DZ, { level: n, children: 'Help om deze component te verbeteren' }), (0, l.jsxs)(o.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, l.jsxs)(o.Xy, { children: [i ? (0, l.jsxs)(o.Er, { children: ['Vul de ', (0, l.jsx)(o.N_, { href: i, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, l.jsxs)(o.Er, { children: [(0, l.jsxs)(o.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, l.jsxs)(o.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, l.jsx)(o.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, l.jsx)(o.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    f = ({ component: e, headingLevel: n, description: t }) => {
     const i = e && h.bo[e.relayStep];
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p.p, { level: n, suffix: i && (0, l.jsx)(u.D, { state: i }), children: e.title }), (0, l.jsx)(o.fz, { lead: !0, children: t })] });
    };
  },
  90495(e, n, t) {
   t.d(n, { AC: () => l, Fu: () => r, Wu: () => a, Zp: () => c });
   var o = t(46447),
    i = t(13526),
    s = t(86070);
   const r = ({ background: e, children: n, className: t, ...o }) => (0, s.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, t), ...o, children: n }),
    ...
    c = ({ href: e, appearance: n, className: t, component: r = 'div', background: a, children: c }) => {
