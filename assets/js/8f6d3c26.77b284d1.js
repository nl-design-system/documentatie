(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [50537],
 {
  ...
  4398(e, t, n) {
   'use strict';
   n.d(t, { B2: () => u, B_: () => v, GT: () => k, KF: () => d, Pc: () => o, Pv: () => y, Rc: () => b, bo: () => r, eQ: () => p, f4: () => i, fX: () => s, kD: () => q, mJ: () => j, o_: () => g, qZ: () => c });
  ...
  62340(e, t, n) {
   'use strict';
   n.r(t), n.d(t, { assets: () => f, component: () => T, contentTitle: () => b, default: () => N, description: () => _, frontMatter: () => k, issueNumber: () => w, metadata: () => r, title: () => x, toc: () => z });
