(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [10452],
 {
   ...
   function S({ tokens: e }) {
    ...
    return (0, u.jsxs)(u.Fragment, {
     children: [
      ...
      (0, u.jsxs)(i.e2, { children: [(0, u.jsx)(h, { content: l, language: 'json', children: 'Kopieer als JSON' }), (0, u.jsx)(h, { content: o, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  33062(e, n, a) {
   'use strict';
   a.d(n, { bo: () => r, KF: () => m, mJ: () => p, VZ: () => w, cR: () => D, Pv: () => k, qZ: () => i, kD: () => f, B2: () => u, Pc: () => l, f4: () => o, GT: () => v, fX: () => s, eQ: () => b, B_: () => x, o_: () => j, Rc: () => y });
