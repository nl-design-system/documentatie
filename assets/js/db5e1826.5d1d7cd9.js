 ...
 [42684],
 {
  ...
  40190(e, n, r) {
   ...
   function u(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: ['\n', '\n', (0, i.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, i.jsx)(h.$, { appearance: 'do', title: 'Geef boven het formulier aan hoe niet-verplichte velden worden aangegeven.', children: (0, i.jsx)(c.H, { language: 'html', children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('p', { children: 'Vul alles in. Als iets niet verplicht is, staat dat erbij.' }), (0, i.jsxs)('form', { children: [(0, i.jsx)('label', { htmlFor: 'kleur1', children: 'Wat is je lievelingskleur' }), (0, i.jsx)('input', { type: 'text', id: 'kleur1', name: 'lievelingskleur', 'aria-required': 'true', 'aria-invalid': 'false' }), (0, i.jsx)('label', { htmlFor: 'dier1', children: 'Wat is je lievelingsdier (niet verplicht)' }), (0, i.jsx)('input', { type: 'text', id: 'dier1', name: 'lievelingsdier' }), (0, i.jsx)('button', { children: 'Verstuur' })] })] }) }) }), '\n', (0, i.jsx)(h.$, { appearance: 'dont', title: 'De gebruiker laten raden wat er al dan niet verplicht is.', children: (0, i.jsx)(c.H, { language: 'html', children: () => (0, i.jsx)(i.Fragment, { children: (0, i.jsxs)('form', { children: [(0, i.jsx)('label', { htmlFor: 'kleur2', children: 'Wat is je lievelingskleur' }), (0, i.jsx)('input', { type: 'text', id: 'kleur2', name: 'lievelingskleur', 'aria-required': 'true', 'aria-invalid': 'false' }), (0, i.jsx)('label', { htmlFor: 'dier2', children: 'Wat is je lievelingsdier' }), (0, i.jsx)('input', { type: 'text', id: 'dier2', name: 'lievelingsdier' }), (0, i.jsx)('button', { children: 'Verstuur' })] }) }) }) })] });
   }
   function p(e = {}) {
    const { wrapper: n } = { ...(0, t.R)(), ...e.components };
   ...
   function j(e) {
    const n = { h2: 'h2', ...(0, t.R)(), ...e.components };
    return (0, i.jsxs)(i.Fragment, { children: ['\n', '\n', (0, i.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, i.jsx)(h.$, { appearance: 'do', title: 'Geef boven het formulier aan hoe verplichte velden worden aangegeven.', children: (0, i.jsx)(c.H, { language: 'html', children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('p', { children: 'Als iets verplicht is, staat dit erbij.' }), (0, i.jsxs)('form', { children: [(0, i.jsx)('label', { htmlFor: 'kleur3', children: 'Wat is je lievelingskleur (verplicht)' }), (0, i.jsx)('input', { type: 'text', id: 'kleur3', name: 'lievelingskleur', 'aria-required': 'true', 'aria-invalid': 'false' }), (0, i.jsx)('label', { htmlFor: 'dier3', children: 'Wat is je lievelingsdier' }), (0, i.jsx)('input', { type: 'text', id: 'dier3', name: 'lievelingsdier' }), (0, i.jsx)('button', { children: 'Verstuur' })] })] }) }) }), '\n', (0, i.jsx)(h.$, { appearance: 'do', title: 'Geef boven het formulier aan hoe verplichte velden worden aangegeven en leg uit wat asterisk betekent.', children: (0, i.jsx)(c.H, { language: 'html', children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('p', { children: 'Als iets verplicht is, staat er een * bij.' }), (0, i.jsxs)('form', { children: [(0, i.jsx)('label', { htmlFor: 'kleur4', children: 'Wat is je lievelingskleur *' }), (0, i.jsx)('input', { type: 'text', id: 'kleur24', name: 'lievelingskleur', 'aria-required': 'true', 'aria-invalid': 'false' }), (0, i.jsx)('label', { htmlFor: 'dier4', children: 'Wat is je lievelingsdier' }), (0, i.jsx)('input', { type: 'text', id: 'dier4', name: 'lievelingsdier' }), (0, i.jsx)('button', { children: 'Verstuur' })] })] }) }) }), '\n', (0, i.jsx)(h.$, { appearance: 'dont', title: 'Bij alle velden aangeven of het al dan niet verplicht is.', children: (0, i.jsx)(c.H, { language: 'html', children: () => (0, i.jsx)(i.Fragment, { children: (0, i.jsxs)('form', { children: [(0, i.jsx)('label', { htmlFor: 'kleur5', children: 'Wat is je lievelingskleur (verplicht)' }), (0, i.jsx)('input', { type: 'text', id: 'kleur5', name: 'lievelingskleur', 'aria-required': 'true', 'aria-invalid': 'false' }), (0, i.jsx)('label', { htmlFor: 'dier5', children: 'Wat is je lievelingsdier (niet verplicht)' }), (0, i.jsx)('input', { type: 'text', id: 'dier5', name: 'lievelingsdier' }), (0, i.jsx)('button', { children: 'Verstuur' })] }) }) }) })] });
   }
   function x(e = {}) {
    const { wrapper: n } = { ...(0, t.R)(), ...e.components };
   ...
   function k(e) {
    const n = { h2: 'h2', ...(0, t.R)(), ...e.components };
    return (0, i.jsxs)(i.Fragment, { children: ['\n', '\n', (0, i.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, i.jsx)(h.$, { appearance: 'do', title: 'Gebruik aria-required om aan te geven of een veld verplicht is.', children: (0, i.jsx)(c.H, { language: 'html', children: () => (0, i.jsx)(i.Fragment, { children: (0, i.jsxs)('form', { children: [(0, i.jsx)('label', { htmlFor: 'kleur8', children: 'Wat is je lievelingskleur (verplicht)' }), (0, i.jsx)('input', { type: 'text', id: 'kleur8', name: 'lievelingskleur', 'aria-required': 'true', 'aria-invalid': 'false' }), (0, i.jsx)('button', { children: 'Verstuur' })] }) }) }) }), '\n', (0, i.jsx)(h.$, { appearance: 'do', title: 'Gebruik required om aan te geven of een veld verplicht is, in combinatie met novalidate.', children: (0, i.jsx)(c.H, { language: 'html', children: () => (0, i.jsx)(i.Fragment, { children: (0, i.jsxs)('form', { noValidate: !0, children: [(0, i.jsx)('label', { htmlFor: 'kleur9', children: 'Wat is je lievelingskleur (verplicht)' }), (0, i.jsx)('input', { type: 'text', id: 'kleur9', name: 'lievelingskleur', required: !0, 'aria-invalid': 'false' }), (0, i.jsx)('button', { children: 'Verstuur' })] }) }) }) }), '\n', (0, i.jsx)(h.$, { appearance: 'dont', title: 'Geef helemaal niet aan of een veld verplicht is, en laat de gebruiker dit pas weten bij de foutmeldingen.', children: (0, i.jsx)(c.H, { language: 'html', children: () => (0, i.jsx)(i.Fragment, { children: (0, i.jsxs)('form', { children: [(0, i.jsx)('label', { htmlFor: 'kleur10', children: 'Wat is je lievelingskleur' }), (0, i.jsx)('p', { id: 'fout10', children: 'Invoerfout: Vul de naam van een kleur in.' }), (0, i.jsx)('input', { type: 'text', id: 'kleur10', 'aria-describedby': 'fout10', name: 'lievelingskleur' }), (0, i.jsx)('button', { children: 'Verstuur' })] }) }) }) })] });
   }
   function b(e = {}) {
    const { wrapper: n } = { ...(0, t.R)(), ...e.components };
  ...
  58639(e, n, r) {
   ...
   const x = ({ code: e, copy: n = !0, defaultExpandedCode: r = !1, displayCode: x = !0, children: g, container: f = 'document', language: k, designTokens: b }) => {
    ...
    (0, h.useEffect)(() => {
     (async () => {
      const e = await c.Ay.format(_, { parser: k, plugins: [o.A, s.Ay, a.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      R(e);
     })();
    }, [_]);
    const F = (0, h.useId)();
    let A = h.Fragment;
    return (
     'paragraph' === f ? (A = v) : 'document' === f ? (A = m) : 'surface' === f && (A = j),
     (0, p.jsxs)('div', {
