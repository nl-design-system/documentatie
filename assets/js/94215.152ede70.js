/*! For license information please see 94215.152ede70.js.LICENSE.txt */
'use strict';
  ...
  79889(e, n, t) {
   ...
   var g = (0, i.forwardRef)(function (e, n) {
    ...
    if (
     ...
     var v = a.dateTime,
      g = (0, l.A)(a, d);
     return (0, r.jsx)('time', h(h({}, g), {}, { dateTime: v, className: i, ref: n, children: t }));
    }
    if (
     (function (e) {
      return 'value' in e;
     ...
     var c = a.value,
      f = (0, l.A)(a, s);
     return (0, r.jsx)('data', h(h({}, f), {}, { value: c, className: i, ref: n, children: t }));
    }
   ...
   var v = function () {
    ...
    h = (0, i.forwardRef)(function (e, n) {
     var t = e.children,
      a = e.className,
      i = (0, l.A)(e, o);
     return (0, r.jsx)('code', s(s({ dir: 'ltr', translate: 'no', className: v('nl-code', a) }, i), {}, { ref: n, children: t }));
    });
   h.displayName = 'Code';
   !(function (e, n) {
    void 0 === n && (n = {});
