...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [82059],
 {
  ...
  48164(e, n, i) {
   (i.r(n), i.d(n, { assets: () => d, contentTitle: () => o, default: () => p, frontMatter: () => s, metadata: () => t, toc: () => l }));
   ...
   var r = i(86070),
    a = i(18439);
   const s = { title: 'Security audit voor npm', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Security audit voor npm', pagination_label: 'Security audit voor npm', description: 'Hoe voorkom je dat je security vulnerabilities installeert?', slug: '/pnpm-audit', keywords: ['GitHub Actions', 'Continuous Integration', 'npm'] },
    ...
    l = [
     ...
     { value: 'Lockfile bijwerken (aanbevolen)', id: 'lockfile-bijwerken-aanbevolen', level: 3 },
     { value: 'Overrides toevoegen', id: 'overrides-toevoegen', level: 3 },
     { value: 'Risico accepteren', id: 'risico-accepteren', level: 2 },
    ];
   function c(e) {
    const n = { a: 'a', code: 'code', h1: 'h1', h2: 'h2', h3: 'h3', header: 'header', p: 'p', pre: 'pre', strong: 'strong', ...(0, a.R)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.header, { children: (0, r.jsx)(n.h1, { id: 'security-audit-voor-npm', children: 'Security audit voor npm' }) }), '\n', (0, r.jsxs)(n.p, { children: ['Om te voorkomen dat hackers controle kunnen krijgen over de software releases van NL Design System, doen we altijd eerst een security scan met ', (0, r.jsx)(n.code, { children: 'pnpm audit' }), ' voordat ', (0, r.jsx)(n.code, { children: 'pnpm install' }), ' wordt uitgevoerd. In GitHub Actions doen we dat zo:'] }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-yaml', children: '- name: Audit dependencies\n  run: pnpm audit --audit-level critical\n\n- name: Install dependencies\n  run: pnpm install --frozen-lockfile\n' }) }), '\n', (0, r.jsx)(n.p, { children: 'Op deze manier stopt de GitHub Action wanneer in de dependencies een npm package is gevonden, waarvan inmiddels bekend is dat het onveilig kan zijn.' }), '\n', (0, r.jsx)(n.h2, { id: 'snel-ingrijpen', children: 'Snel ingrijpen' }), '\n', (0, r.jsxs)(n.p, { children: ['Wanneer een security vulnerability bekend wordt, zoals ', (0, r.jsx)(n.a, { href: 'https://snyk.io/blog/sha1-hulud-npm-supply-chain-incident/', children: 'SHA1-Hulud' }), ', wil je snel kunnen ingrijpen en voorkomen dat de kwaadaardige npm package wordt ge\xefnstalleerd op een plek waar gevoelige "environment secrets" uit kunnen lekken.'] }), '\n', (0, r.jsxs)(n.p, { children: ['Omdat het in de praktijk niet mogelijk is om snel genoeg alle branches van alle repositories te controleren, gebruiken we deze aanpak om automatisch elke ', (0, r.jsx)(n.code, { children: 'pnpm install' }), ' te voorkomen. Wanneer veiligheidsonderzoekers op een centrale plek een melding doen van een critical vulnerability, dan grijpt ', (0, r.jsx)(n.code, { children: 'pnpm audit' }), ' vanaf dat moment automatisch in.'] }), '\n', (0, r.jsx)(n.h2, { id: 'betere-versies-installeren', children: 'Betere versies installeren' }), '\n', (0, r.jsx)(n.p, { children: 'Vaak is het probleem al opgelost in een nieuwe versie, en dan is de oplossing om een update te installeren.\nMet pnpm 11 kun je kwetsbaarheden op twee manieren oplossen.' }), '\n', (0, r.jsx)(n.h3, { id: 'lockfile-bijwerken-aanbevolen', children: 'Lockfile bijwerken (aanbevolen)' }), '\n', (0, r.jsx)(n.p, { children: 'Zo los je critical vulnerabilities op door, waar mogelijk, ge\xfcpdatete, veiligere versies in de lockfile te zetten.' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-shell', children: 'pnpm audit --fix update --audit-level critical\npnpm install --ignore-scripts\n' }) }), '\n', (0, r.jsxs)(n.p, { children: ['Met ', (0, r.jsx)(n.code, { children: '--fix=update' }), ' worden kwetsbare packages in de lockfile bijgewerkt, zonder overrides in ', (0, r.jsx)(n.code, { children: 'pnpm-workspace.yaml' }), '.\nWil je zelf kiezen welke kwetsbaarheden je oplost?\nGebruik dan ', (0, r.jsx)(n.code, { children: '--interactive' }), ' (of ', (0, r.jsx)(n.code, { children: '-i' }), '):'] }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-shell', children: 'pnpm audit --fix update --interactive\n' }) }), '\n', (0, r.jsx)(n.h3, { id: 'overrides-toevoegen', children: 'Overrides toevoegen' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-shell', children: 'pnpm audit --fix override\npnpm install --ignore-scripts\n' }) }), '\n', (0, r.jsxs)(n.p, { children: ['Dit voegt overrides toe aan ', (0, r.jsx)(n.code, { children: 'pnpm-workspace.yaml' }), ' om veiligere versies af te dwingen.\nGebruik deze aanpak wanneer ', (0, r.jsx)(n.code, { children: '--fix=update' }), ' niet volstaat: de kwetsbare package komt dan indirect binnen via een andere dependency (transitieve dependency), of de semver-range in ', (0, r.jsx)(n.code, { children: 'package.json' }), ' staat een update naar de gepatchte versie niet toe.'] }), '\n', (0, r.jsxs)(n.p, { children: ['Wanneer ', (0, r.jsx)(n.code, { children: 'minimumReleaseAge' }), ' is ingesteld, voegt ', (0, r.jsx)(n.code, { children: '--fix' }), ' de minimale gepatchte versie ook toe aan ', (0, r.jsx)(n.code, { children: 'minimumReleaseAgeExclude' }), ', zodat security fixes direct ge\xefnstalleerd kunnen worden zonder te wachten op de release age.'] }), '\n', (0, r.jsx)(n.p, { children: 'Het tweede commando installeert de aangepaste dependencies en past de lockfile aan.' }), '\n', (0, r.jsx)(n.p, { children: 'Controleer of met deze wijzigingen de belangrijkste security vulnerabilities zijn opgelost:' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-shell', children: 'pnpm audit --audit-level critical\n' }) }), '\n', (0, r.jsxs)(n.p, { children: ['Commit de wijzigingen aan ', (0, r.jsx)(n.code, { children: 'pnpm-lock.yaml' }), ' en ', (0, r.jsx)(n.code, { children: 'pnpm-workspace.yaml' }), ' en maak een Pull Request met je wijzigingen.'] }), '\n', (0, r.jsxs)(n.p, { children: [(0, r.jsx)(n.strong, { children: 'Let op:' }), ' test goed of je project nog goed werkt na het installeren van de updates, op de voor jou gebruikelijke manier. De updates bevatten meestal niet alleen veiligheidsverbeteringen, maar ook algemene verbeteringen die zijn gedaan sinds je voor het laatst alle updates installeerde.'] }), '\n', (0, r.jsx)(n.h2, { id: 'risico-accepteren', children: 'Risico accepteren' }), '\n', (0, r.jsx)(n.p, { children: 'Wanneer je GitHub Action niet meer werkt door een critical security vulnerability dan kan het zijn dat je werk geblokkeerd wordt, als er nog geen betere versie beschikbaar is.' }), '\n', (0, r.jsxs)(n.p, { children: ['Als je zeker weet dat de security vulnerability niet op jouw project van toepassing is, dan kun je het risico accepteren en een specifieke advisory negeren.\nVanaf pnpm 11 gebruikt ', (0, r.jsx)(n.code, { children: 'pnpm audit' }), " GitHub Security Advisory ID's (", (0, r.jsx)(n.a, { href: 'https://github.com/advisories', children: 'GHSA' }), ') in plaats van CVE-nummers.\nDe GHSA-code staat in de kolom "More info" van de ', (0, r.jsx)(n.code, { children: 'pnpm audit' }), '-uitvoer.\nZet die code in ', (0, r.jsx)(n.code, { children: 'auditConfig.ignoreGhsas' }), ' in ', (0, r.jsx)(n.code, { children: 'pnpm-workspace.yaml' }), '.\nLees hiervoor de documentatie over ', (0, r.jsxs)(n.a, { href: 'https://pnpm.io/cli/audit#auditconfigignoreghsas', children: ['ignoreGhsas van ', (0, r.jsx)(n.code, { children: 'pnpm' })] }), '.'] })] });
   }
   function p(e = {}) {
