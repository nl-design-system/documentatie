/*! For license information please see 8ea6c2d1.cd1833fa.js.LICENSE.txt */
 ...
 [79947],
 {
   ...
   function H(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, d.jsx)(z.Rv, { component: $, headingLevel: 1, description: B }),
      '\n',
      ...
      (0, d.jsx)(G.W, {
       items: [
        ...
        { title: 'Als je de tekstafstand van de Number Badge vergroot blijft de tekst in zijn geheel zichtbaar', sc: '1.4.12', status: '', component: (0, d.jsx)(v.ZP, {}), tags: ['developer'] },
       ],
      }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
      '\n',
      (0, d.jsx)(z.W, { component: $, headingLevel: 3 }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, d.jsx)(z.cN, { component: $, headingLevel: 3 }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }),
      '\n',
      (0, d.jsx)(z.vM, { component: $, headingLevel: 3 }),
     ],
    });
   }
   function U(e = {}) {
  ...
  49556: (e, t, n) => {
   ...
   var p = n(6076),
    ...
    k = n(49003),
    x = n(75271);
   const A = { color: p.Z, dimension: j.Z, fontFamilies: y.Z, fontSizes: b.Z, fontWeights: w.Z, lineHeights: f.Z, other: v.Z, textDecoration: k.Z },
    C = (e) => {
     let { type: t } = e;
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => j, BA: () => a, Ee: () => d, Q6: () => i, U: () => m, Yr: () => y, d: () => u, e9: () => o, fO: () => w, mA: () => s, ps: () => g, qU: () => f, s0: () => b, zP: () => p });
