(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [21229],
 {
  90618: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => j, component: () => y, contentTitle: () => h, default: () => b, description: () => p, frontMatter: () => d, issueNumber: () => v, metadata: () => u, title: () => m, toc: () => g });
   var r = t(52676),
    i = t(40139),
    o = t(65739),
    c = t(94443),
   ...
   const d = { title: 'Icon', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Icon', pagination_label: 'Icon', description: 'Grafisch symbool dat visueel informatie geeft over een actie, onderwerp of status.', slug: '/icon', keywords: ['button icon', 'graphic', 'icon', 'icoon', 'illustratie', 'illustration', 'pictogram', 'svg', 'svg icon', 'symbol', 'symbool'] },
    h = void 0,
    u = { id: 'componenten/icon/index', title: 'Icon', description: 'Grafisch symbool dat visueel informatie geeft over een actie, onderwerp of status.', source: '@site/docs/componenten/icon/index.mdx', sourceDirName: 'componenten/icon', slug: '/icon', permalink: '/icon', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/icon/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Icon', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Icon', pagination_label: 'Icon', description: 'Grafisch symbool dat visueel informatie geeft over een actie, onderwerp of status.', slug: '/icon', keywords: ['button icon', 'graphic', 'icon', 'icoon', 'illustratie', 'illustration', 'pictogram', 'svg', 'svg icon', 'symbol', 'symbool'] }, sidebar: 'componenten', previous: { title: 'Heading Group', permalink: '/heading-group' }, next: { title: 'Image', permalink: '/image' } },
    j = {},
    g = [
  ...
  94443: (e, n, t) => {
   ...
   const f = (e) => {
          ...
          children: [
           (0, d.jsx)(y, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(k, { headingLevel: t + 1, checked: n, title: r, description: (0, b.Q6)(i) }, i);
            }),
           }),
            ...
            j.Zb,
            {
             ...
             children: (0, d.jsxs)(j.aY, {
              children: [
               ...
               (s.length > 0 || o.length > 0) && (0, d.jsx)(r.X6, { level: t + 1, children: 'Snel aan de slag' }),
               s.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               o.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: o.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: t + 2, children: [i, ' in ', n] }), (0, d.jsx)(r.Mc, { children: o.map((e) => (0, d.jsxs)(r.k7, { href: e.value, children: [(0, d.jsx)(u, { brand: e.brand }), ' ', e.description] }, e.id)) })] });
                 }),
                }),
              ],
             }),
    ...
    z = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.V, { level: t, suffix: o && (0, d.jsx)(g.y, { state: o }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, n, t) => {
   'use strict';
  ...
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, BA: () => s, Q6: () => o, U: () => l, e9: () => c, mA: () => i, ps: () => d });
