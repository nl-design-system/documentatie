 ...
 [74309],
 {
  ...
  70348(e, n, l) {
   ...
   const i = (0, r.forwardRef)(({ as: e, className: n, children: l, ...r }, o) => {
     ...
     return (0, a.jsx)(s, { ref: o, className: i, ...r, children: l });
    }),
    c = ({ className: e, classNamePanel: n, label: l, heading: r, headingLevel: i, headingApperance: c, ...d }) => {
     ...
     return (0, a.jsxs)('details', { className: u, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(o.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [r && (0, a.jsx)(s.D, { level: i, appearance: c, children: r }), l] })] }) }), (0, a.jsx)('div', { className: m, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => b });
   ...
   const b = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       ...
       return (0, v.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', l), children: [(0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }), (0, v.jsx)(g.n, { children: (0, v.jsx)(g.K, { label: 'Code', children: (0, v.jsx)('pre', { className: 'language-html nl-code-block', children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
