 ...
 [34875],
 {
  ...
  58639(e, n, l) {
   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: j = !0, children: v, container: g = 'document', language: x, designTokens: f }) => {
    ...
    let S = u.Fragment;
    return (
     'paragraph' === g ? (S = m) : 'document' === g ? (S = b) : 'surface' === g && (S = y),
     (0, p.jsxs)('div', {
  ...
  59845(e, n, l) {
   ...
   var r = l(86070),
    ...
    i = l(15638);
   function a(e) {
    const n = { button: 'button', input: 'input', label: 'label', ...(0, t.R)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', (0, r.jsx)(i.$, { appearance: 'do', title: 'De placeholder samen met tekst van de submitbutton gebruiken zichtbaar label in een kort zoekformulier.', children: (0, r.jsx)(c.H, { language: 'html', children: () => (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.label, { className: 'sr-only', htmlFor: 'header-search', children: 'Zoek' }), (0, r.jsx)(n.input, { id: 'header-search', placeholder: 'Zoek', type: 'search' }), (0, r.jsx)(n.button, { children: 'Zoek' })] }) }) })] });
   }
   function d(e = {}) {
