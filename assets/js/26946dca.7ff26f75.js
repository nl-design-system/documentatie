(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [85781],
 {
  ...
  11902: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => y, component: () => b, contentTitle: () => j, default: () => C, description: () => v, frontMatter: () => p, issueNumber: () => k, metadata: () => w, title: () => A, toc: () => f });
   var r = n(52676),
    o = n(24785),
    i = n(50460),
    s = n(34434),
   ...
   const p = { title: 'Code Block', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code Block', pagination_label: 'Code Block', description: 'Toont \xe9\xe9n of meerdere regels computercode en behoudt de opmaak van deze code.', slug: '/code-block', keywords: ['code'] },
    ...
    A = 'Code Block',
    v = 'Toont \xe9\xe9n of meerdere regels computercode en behoudt de opmaak van deze code.',
    k = 329,
    b = i.find((e) => e.number === k);
   function x(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(c.Rv, { component: b, headingLevel: 1, description: v }),
      '\n',
      ...
      (0, r.jsx)(s.t, {
       ...
       items: [
        { title: 'De tekst, gemarkeerd als code, is niet alleen herkenbaar aan een andere achtergrondkleur', sc: '1.4.1', status: '', component: (0, r.jsx)(d.ZP, {}) },
        { title: 'De tekst, gemarkeerd als code, heeft voldoende contrast met de achtergrondkleur', sc: '1.4.3', status: '', component: (0, r.jsx)(u.ZP, {}) },
        { title: 'Wanneer de achtergrondkleur van het Code Block anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina', sc: '1.4.11', status: '', component: (0, r.jsx)(g.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(s.t, {
      ...
      '\n',
      (0, r.jsx)(s.t, { headingLevel: 3, testCategory: 'Toegankelijkheid screenreader', items: [{ title: 'De juiste HTML-elementen voor de Code Block component zijn toegepast', sc: '1.3.1', status: '', component: (0, r.jsx)(a, {}) }] }),
      '\n',
  ...
  68963: (e, t, n) => {
   ...
   const c = (e) => {
     ...
     return (0, s.jsx)('div', { className: (0, o.Z)(i.card__illustration, t && i['card__illustration--background'], r), ...c, children: n });
    },
    l = (e) => (0, s.jsx)('div', { className: (0, o.Z)(i.card__content), ...e }),
    a = (e) => {
     ...
     const d = (e) => ('article' === l ? (0, s.jsx)('article', { ...e }) : 'section' === l ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      u = (0, s.jsx)(d, { className: (0, o.Z)(i.cardgroup__card, i[`cardgroup__card--${n}`], c), children: a });
     return t ? (0, s.jsx)(r.rU, { href: t, boxContent: !0, className: i.cardgroup__link, children: u }) : u;
    },
    d = (e) => {
     let { appearance: t = 'medium', children: n, className: r } = e;
     return (0, s.jsx)('div', { className: (0, o.Z)(i.cardgroup, i[`cardgroup--${t}`], r), children: n });
    };
  },
  34434: (e, t, n) => {
   'use strict';
   ...
   const o = {},
    ...
    c = [...i.map((e) => ({ ...e, url: e.url.replace(/WCAG21/i, 'WCAG22') })), { sc: '2.4.11', title: 'Focus Not Obscured (Minimum)', url: 'https://www.w3.org/TR/WCAG22/#focus-not-obscured-minimum', conformance: 'AA', nl: { title: 'Focus niet bedekt (minimum)' }, since: 'WCAG22' }, { sc: '2.4.12', title: 'Focus Not Obscured (Enhanced)', url: 'https://www.w3.org/TR/WCAG22/#focus-not-obscured-enhanced', conformance: 'AAA', nl: { title: 'Focus niet bedekt (uitgebreid)' }, since: 'WCAG22' }, { sc: '2.4.13', title: 'Focus Appearance', url: 'https://www.w3.org/TR/WCAG22/#focus-appearance', conformance: 'AAA', nldesignsystem: !0, nl: { title: 'Focusweergave' }, since: 'WCAG22' }, { sc: '2.5.7', title: 'Dragging Movements', url: 'https://www.w3.org/TR/WCAG22/#dragging-movements', conformance: 'AA', nldesignsystem: !0, nl: { title: 'Sleepbewegingen' }, since: 'WCAG22' }, { sc: '2.5.8', title: 'Target Size (minimum)', url: 'https://www.w3.org/TR/WCAG22/#target-size-minimum', conformance: 'AA', nldesignsystem: !0, nl: { title: 'Grootte van het aanwijsgebied (minimum)' }, since: 'WCAG22' }, { sc: '3.2.6', title: 'Consistent Help', url: 'https://www.w3.org/TR/WCAG22/#consistent-help', conformance: 'A', nldesignsystem: !0, nl: { title: 'Consistente hulp' }, since: 'WCAG22' }, { sc: '3.3.7', title: 'Redundant Entry', url: 'https://www.w3.org/TR/WCAG22/#redundant-entry', conformance: 'A', nldesignsystem: !0, nl: { title: 'Overbodige invoer' }, since: 'WCAG22' }, { sc: '3.3.8', title: 'Accessible Authentication (Minimum)', url: 'https://www.w3.org/TR/WCAG22/#accessible-authentication-minimum', conformance: 'AA', nldesignsystem: !0, nl: { title: 'Toegankelijke authenticatie (minimum)' }, since: 'WCAG22' }, { sc: '3.3.9', title: 'Accessible Authentication (Enhanced)', url: 'https://www.w3.org/TR/WCAG22/#accessible-authentication-enhanced', conformance: 'AAA', nl: { title: 'Toegankelijke authenticatie (uitgebreid)' }, since: 'WCAG22' }]
     .map((e) => ({ ...e, fragment: new URL(e.url).hash.replace(/^#/, '') }))
     .filter((e) => {
      let { sc: t } = e;
   ...
   const d = (e) => {
    ...
    u = (e) => {
     ...
     return (0, a.jsxs)('details', { className: o['task-list'], children: [(0, a.jsx)('summary', { children: (0, a.jsx)('h3', { children: t }) }), n.map((e, t) => (0, a.jsx)(d, { ...e }, t))] });
    };
  },
  23952: (e, t, n) => {
   'use strict';
   ...
   var r = n(56150),
    ...
    a = n(32636),
    d = n(52676);
   const u = { figma: (0, d.jsx)(i.Z, {}), github: (0, d.jsx)(s.Z, {}), npm: (0, d.jsx)(c.Z, {}), storybook: (0, d.jsx)(l.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const W = (e) => {
    ...
    R = (e) => {
     ...
     return t && i.length
      ? (0, d.jsx)(g.um, {
         appearance: 'large',
         className: (0, o.Z)(m['implementation-card-group']),
         children: i
          .sort((e, t) => {
          ...
          .map((e) => {
           ...
           return (0, d.jsx)(
            g.Zb,
            {
             className: (0, o.Z)(m['implementation-card']),
  ...
  86964: (e, t, n) => {
   ...
   const l = (e) => {
    let { state: t } = e;
    const n = (0, s.mA)(t);
    return (0, c.jsx)(r.Ou, { className: (0, o.Z)(i['estafette-badge'], n && i[`estafette-badge--${n}`]), children: t });
   };
  },
  72657: (e, t, n) => {
   'use strict';
   ...
   const s = (e) => {
    ...
    return (0, i.jsxs)('hgroup', { className: (0, r.Z)(o['nlds-inline-heading-group'], `utrecht-heading-${s}`, n), ...l, children: [(0, i.jsx)('h1', { className: (0, r.Z)(o['nlds-inline-heading-group__heading']), children: t }), c && (0, i.jsxs)('p', { className: (0, r.Z)(o['nlds-inline-heading-group__suffix']), children: [c ? ' ' : '', c] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
