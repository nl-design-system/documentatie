(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [54472],
 {
  19249: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => s, default: () => p, description: () => j, frontMatter: () => o, issueNumber: () => g, metadata: () => l, title: () => d, toc: () => h });
   var r = n(52676),
    i = n(40139),
    c = n(65739),
    a = n(94443);
  ...
  35038: (e, t, n) => {
   'use strict';
   n.d(t, { Zb: () => s, aY: () => o, um: () => l, wu: () => a });
   var r = n(16167),
    i = n(4814),
    c = n(52676);
   const a = (e) => {
     let { background: t, children: n, className: r, ...a } = e;
     return (0, c.jsx)('div', { className: (0, i.Z)('card__illustration', t && 'card__illustration--background', r), ...a, children: n });
    },
    o = (e) => (0, c.jsx)('div', { className: 'card__content', ...e }),
    s = (e) => {
     let { href: t, appearance: n, className: a, component: o = 'div', children: s } = e;
     const l = (e) => ('article' === o ? (0, c.jsx)('article', { ...e }) : 'section' === o ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      u = (0, c.jsx)(l, { className: (0, i.Z)('cardgroup__card', `cardgroup__card--${n}`, a), children: s });
  ...
  94443: (e, t, n) => {
   ...
   var r = n(41115),
    ...
    l = n(32636),
    u = n(52676);
   const h = { figma: (0, u.jsx)(c.Z, {}), github: (0, u.jsx)(a.Z, {}), npm: (0, u.jsx)(o.Z, {}), storybook: (0, u.jsx)(s.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
   ...
   const f = (e) => {
               ...
               c.length > 0 &&
                (0, u.jsx)(u.Fragment, {
                 children: c.map((e) => {
                  ...
                  return (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.X6, { level: n + 2, children: [i, ' in ', t] }), (0, u.jsx)(r.Mc, { children: c.map((e) => (0, u.jsxs)(r.k7, { href: e.value, children: [(0, u.jsx)(d, { brand: e.brand }), ' ', e.description] }, e.id)) })] });
                 }),
                }),
              ],
             }),
    ...
    N = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(m.V, { level: n, suffix: c && (0, u.jsx)(g.y, { state: c }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
   ...
   const o = (e) => {
    let { state: t } = e;
    const n = (0, c.mA)(t);
    return (0, a.jsx)(r.Ou, { className: (0, i.Z)('estafette-badge', n && `estafette-badge--${n}`), children: t });
   };
  },
  41757: (e, t, n) => {
   'use strict';
   ...
   var r = n(4814),
    i = n(52676);
   const c = (e) => {
    let { children: t, className: n, level: c = 1, suffix: a, ...o } = e;
    return (0, i.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${c}`, n), ...o, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), a && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [a ? ' ' : '', a] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => o, Q6: () => c, U: () => l, e9: () => a, mA: () => i, ps: () => u });
   const r = { UNKNOWN: 'Todo', HELP_WANTED: 'Help Wanted', COMMUNITY: 'Community', CANDIDATE: 'Candidate', HALL_OF_FAME: 'Hall of fame' },
    ...
    l = (e) => Array.from(new Set(e.projects.flatMap((e) => s(e)))),
    u = (e) => {
     const t = s(e),
      n = ((e) => {
       const t = e.tasks.find((e) => {
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        let { name: i, id: c, value: a } = r;
        const o = i.match(/^(.+) URL/)[1],
         s = 'Storybook' === o ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${o}`;
        return { brand: o.toLowerCase(), name: i, id: c, value: a, description: s };
       });
