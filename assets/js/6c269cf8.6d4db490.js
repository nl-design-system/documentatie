 ...
 [39580],
 {
  ...
  58639(e, L, o) {
   ...
   const g = ({ code: e, copy: L = !0, defaultExpandedCode: o = !1, displayCode: g = !0, children: v, container: y = 'document', language: b, designTokens: j }) => {
    ...
    let z = d.Fragment;
    return (
     'paragraph' === y ? (z = m) : 'document' === y ? (z = h) : 'surface' === y && (z = x),
     (0, p.jsxs)('div', {
      className: (0, r.A)('nlds-canvas'),
      children: [
       k && (0, p.jsx)('div', { className: (0, r.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: j, children: (0, p.jsx)(z, { children: (0, p.jsx)(t.v$, { children: k }) }) }) }),
       g &&
        (0, p.jsx)('div', {
