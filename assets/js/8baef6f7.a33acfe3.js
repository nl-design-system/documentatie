   ...
   function X(e) {
    ...
    return (0, i.jsxs)(i.Fragment, {
     children: [
      ...
      '\n',
      (0, i.jsx)(_.U, { omitH1: !0, headingLevel: 3, children: (0, i.jsx)(F, {}) }),
      '\n',
  ...
  8657: (e, n, t) => {
   ...
   const y = (e) => {
     ...
     return (
      ...
      (0, d.jsx)(i.a2, {
       sections: s.map((e) => ({
        className: (0, r.Z)('definition-of-done', e && `definition-of-done--${(0, x.mA)(c(e))}`),
        headingLevel: t,
        expanded: !1,
        ...
        body:
         ...
         (0, d.jsxs)(d.Fragment, {
          children: [
           ...
           (0, d.jsx)(i.nv, { children: (0, d.jsxs)(i.rU, { href: `${e.url}?filterQuery=${n.title}`, children: [c(e), ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
