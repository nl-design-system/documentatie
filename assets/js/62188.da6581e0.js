/*! For license information please see 62188.da6581e0.js.LICENSE.txt */
'use strict';
 ...
 [62188],
 {
  ...
  73497: (n, e, t) => {
   ...
   var a = t(4814),
    l = t(40217),
    c = t(65697);
   const r = { admonition: 'admonition_rxXX', admonitionHeading: 'admonitionHeading_eMFo', admonitionIcon: 'admonitionIcon_EbBA', admonitionContent: 'admonitionContent_GPTu' };
   function d(n) {
   ...
   const b = { icon: (0, o.jsx)(w, {}), title: (0, o.jsx)(l.Z, { id: 'theme.admonition.danger', description: 'The default label used for the Danger admonition (:::danger)', children: 'danger' }) };
   const z = { icon: (0, o.jsx)(Z, {}), title: (0, o.jsx)(l.Z, { id: 'theme.admonition.caution', description: 'The default label used for the Caution admonition (:::caution)', children: 'caution' }) };
   const _ = {
    ...{
     note: x,
     tip: g,
     ...
     danger: function (n) {
      return (0, o.jsx)(h, { ...b, ...n, className: (0, a.Z)('alert alert--danger', n.className), children: n.children });
     },
    },
    ...{
     ...
     caution: function (n) {
      return (0, o.jsx)(h, { ...z, ...n, className: (0, a.Z)('alert alert--warning', n.className), children: n.children });
     },
    },
   };
   function k(n) {
    const e = s(n),
     t = ((i = e.type), _[i] || (console.warn(`No admonition component found for admonition type "${i}". Using Info as fallback.`), _.info));
    var i;
    return (0, o.jsx)(t, { ...e });
   }
  },
  27583: (n, e, t) => {
   ...
   var i = t(75271),
    ...
    s = t(97674),
    a = t(96401);
   const l = { details: 'details_pUJb', isBrowser: 'isBrowser__m4A', collapsibleContent: 'collapsibleContent_lHT6' };
   var c = t(52676);
   function r(n) {
