 ...
 [71537],
 {
  ...
  16764(e, n, t) {
   ...
   var p = t(43864),
    ...
    A = t(79532),
    S = t(30758);
   const T = { boxShadow: p.A, color: j.A, cursor: x.A, dimension: b.A, fontFamily: f.A, fontFamilies: f.A, fontSize: v.A, fontSizes: v.A, fontWeight: k.A, fontWeights: k.A, lineHeight: y.A, lineHeights: y.A, number: D.A, other: w.A, textDecoration: A.A },
    N = ({ type: e }) => {
     const n = Object.hasOwn(T, e) ? e : 'other';
     return (0, u.jsx)(m.In, { children: (0, S.createElement)(T[n]) });
    };
   var F = t(76223);
   function L({ tokens: e }) {
    const n = (0, s.kD)(e),
       ...
       children: [
        ...
        (0, u.jsx)(r.BF, {
         children: l.map((n) => {
          const t = (0, s.o_)(n),
           l = (0, s.eQ)(e, n).$type;
          return (0, u.jsxs)(r.Hj, { children: [(0, u.jsx)(r.nA, { children: (0, u.jsx)(a.C, { children: (0, u.jsx)(r.kf, { children: t }) }) }), (0, u.jsx)(r.nA, { children: (0, u.jsxs)(i.K, { children: [(0, u.jsx)(N, { type: l }), ' ', l] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  76097(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => m, mJ: () => p, VZ: () => D, cR: () => y, Pv: () => j, qZ: () => r, kD: () => v, B2: () => u, Pc: () => o, f4: () => l, GT: () => k, fX: () => s, eQ: () => f, B_: () => b, o_: () => x });
