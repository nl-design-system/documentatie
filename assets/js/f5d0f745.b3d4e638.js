...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [59044],
 {
  ...
  49188(e, n, i) {
   (i.r(n), i.d(n, { assets: () => c, contentTitle: () => d, default: () => u, frontMatter: () => o, metadata: () => l, toc: () => h }));
   const l = JSON.parse('{"id":"richtlijnen/formulieren/label/index","title":"Labels in een formulier","description":"Richtlijnen voor labels in een formulier.","source":"@site/docs/richtlijnen/formulieren/label/index.mdx","sourceDirName":"richtlijnen/formulieren/label","slug":"/richtlijnen/formulieren/labels/","permalink":"/richtlijnen/formulieren/labels/","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/label/index.mdx","tags":[],"version":"current","sidebarPosition":6,"frontMatter":{"title":"Labels in een formulier","title_sm":"Labels","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Introductie labels","sidebar_position":6,"navigation_order":6,"pagination_label":"Labels in een formulier","description":"Richtlijnen voor labels in een formulier.","slug":"/richtlijnen/formulieren/labels/","keywords":["labels","formulier","design","code"]},"sidebar":"richtlijnen","previous":{"title":"Descriptions in een fieldset","permalink":"/richtlijnen/formulieren/fieldsets/descriptions"},"next":{"title":"Labels in een formulier","permalink":"/richtlijnen/formulieren/labels/"}}');
   var r = i(86070),
    t = i(18439),
    s = i(78734),
    a = i(23606);
   const o = { title: 'Labels in een formulier', title_sm: 'Labels', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Introductie labels', sidebar_position: 6, navigation_order: 6, pagination_label: 'Labels in een formulier', description: 'Richtlijnen voor labels in een formulier.', slug: '/richtlijnen/formulieren/labels/', keywords: ['labels', 'formulier', 'design', 'code'] },
