(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [42112],
 {
  ...
  97839: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => b, component: () => W, contentTitle: () => v, default: () => z, description: () => T, frontMatter: () => f, issueNumber: () => G, metadata: () => k, title: () => C, toc: () => x });
   var r = n(52676),
    i = n(87118),
    s = n(15557),
    o = n(78187);
   ...
   const f = { title: 'Data Badge', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Data Badge', pagination_label: 'Data Badge', description: 'Label met extra informatie, zoals een categorie of een eigenschap.', slug: '/data-badge', keywords: ['annotatie', 'annotation', 'badge', 'categorie', 'categoriseren', 'categorize', 'category', 'characteristic', 'chip', 'data', 'data badge', 'eigenschap', 'etiket', 'etiquette', 'filter tag', 'index', 'index term', 'label', 'metadata', 'pill', 'property', 'stamp', 'status', 'status badge', 'sticker', 'tag', 'tagged', 'tagging', 'term'] },
    ...
    C = 'Data Badge',
    T = 'Label met extra informatie, zoals een categorie of een eigenschap.',
    G = 94,
    W = s.find((e) => e.number === G);
   function R(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(A.Rv, { component: W, headingLevel: 1, description: T }),
      '\n',
      (0, r.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, r.jsx)(A.cN, { component: W, headingLevel: 3 }),
      '\n',
      (0, r.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, r.jsx)(A.W, { component: W, headingLevel: 3 }),
      '\n',
      ...
      (0, r.jsx)(y.t, {
       ...
       items: [
        { title: 'Gebruik geen afbeeldingen van tekst voor de Data Badge', sc: '1.4.5', status: '', component: (0, r.jsx)(p.ZP, {}) },
        { title: 'Als een tekst in de Data Badge in een andere taal is dan de taal van de pagina, dan heeft de Data Badge een lang-attribuut met de juiste taalcode', sc: '3.1.2', status: '', component: (0, r.jsx)(w.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(y.t, {
       ...
       items: [
        { title: 'Gebruik niet alleen kleur om de betekenis van de Data Badge duidelijk te maken', sc: '1.4.1', status: '', component: (0, r.jsx)(h, {}) },
      ...
      (0, r.jsx)(y.t, {
       ...
       items: [
        { title: 'Als je de tekst van de Data Badge vergroot tot 200% blijft de tekst in zijn geheel zichtbaar', sc: '1.4.4', status: '', component: (0, r.jsx)(j.ZP, {}) },
        { title: 'Als je de tekstafstand van de Data Badge vergroot blijft de tekst in zijn geheel zichtbaar', sc: '1.4.12', status: '', component: (0, r.jsx)(g.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(y.t, {
       ...
       items: [
        { title: 'Als er in de Data Badge een informatief icoon staat, is er een goed tekstalternatief', sc: '1.1.1', status: '', component: (0, r.jsx)(c, {}) },
        { title: 'Gebruik zoveel mogelijk semantische HTML voor de Data Badge', sc: '1.3.1', status: '', component: (0, r.jsx)(d, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(t.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }),
      '\n',
      (0, r.jsx)(A.vM, { component: W, headingLevel: 3 }),
     ],
    });
   }
   function z(e = {}) {
  ...
  55240: (e, t, n) => {
   ...
   const l = (e) => {
     ...
     const l = a.get(n),
      d = l ? `${n} ${l.nl?.title}` : n;
     return (0, c.jsxs)('div', { children: [(0, c.jsx)(r.X6, { appearance: 'utrecht-heading-4', level: o, children: t }), (n || i) && (0, c.jsxs)('dl', { children: [n && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)('dt', { children: 'WCAG' }), (0, c.jsx)('dd', { children: (0, c.jsx)(r.rU, { href: `/wcag/${n}`, children: d }) })] }), i && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)('dt', { children: 'Status' }), (0, c.jsx)('dd', { children: i })] })] }), s] });
    },
    d = (e) => {
     let { testCategory: t, items: n } = e;
     return (0, c.jsxs)('details', { className: 'task-list', children: [(0, c.jsx)('summary', { children: (0, c.jsx)('h3', { children: t }) }), n.map((e, t) => (0, c.jsx)(l, { ...e }, t))] });
    };
  },
  8657: (e, t, n) => {
   'use strict';
   ...
   const b = (e) => {
          ...
          children: [
           (0, d.jsx)(f, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(v, { headingLevel: n + 1, checked: t, title: r, description: (0, k.Q6)(i) }, i);
            }),
           }),
    ...
    T = (e) => {
     ...
     return t && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(w.V, { level: n, suffix: s && (0, d.jsx)(p.y, { state: s }), children: t.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
