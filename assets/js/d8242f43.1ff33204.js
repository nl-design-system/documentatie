...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [8238],
 {
  ...
  58639(e, n, o) {
   ...
   const v = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: v = !0, children: f, container: y = 'document', language: j, designTokens: x }) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(z, { parser: j, plugins: [r.A, c.Ay, i.Ay, a.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [z]);
    const F = (0, u.useId)();
    let S = u.Fragment;
    return (
     'paragraph' === y ? (S = m) : 'document' === y ? (S = g) : 'surface' === y && (S = b),
     (0, p.jsxs)('div', {
      ...
      children: [
       ...
       v &&
        (0, p.jsxs)('div', {
         ...
         hidden: !A,
         children: [
          (0, p.jsx)(t.M, { codeBlockLabel: 'Codevoorbeeld', syntax: j, textContent: w, trim: !0 }),
          n &&
           (0, p.jsx)('div', {
