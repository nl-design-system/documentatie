 ...
 [13432],
 {
  ...
  72863(e, n, t) {
   ...
   const r = i.forwardRef(function (e, n) {
     ...
     return (
      i.useEffect(() => {
       s && (_(), e.focusOnLoad && 'object' == typeof n && n?.current && n.current.focus());
      }, [s, _, e.focusOnLoad, n]),
      i.useEffect(() => {
      ...
      (0, a.jsxs)(a.Fragment, {
       children: [
        ...
        (0, a.jsxs)(L, {
         ...
         children: [e.lazyLoad && !s && (0, a.jsx)('img', { src: x, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !s && (0, a.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && s) && (0, a.jsx)('button', { type: 'button', className: R, 'aria-label': `${m} ${p}`, 'aria-hidden': s || void 0, tabIndex: s ? -1 : 0, onClick: D, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: m }) }), s && (0, a.jsx)('iframe', { ref: n, className: $, title: p, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: f, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
