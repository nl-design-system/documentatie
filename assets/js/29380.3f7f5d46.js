(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [29380],
 {
   ...
   e.exports = function (e, s) {
    ...
    function w() {
     var e = h(),
      t = v(o);
     if (t) {
      if ((b(), !v(i))) return y("property missing ':'");
      var r = v(l),
  ...
  97626: (e, n, t) => {
   ...
   t.d(n, { UG: () => Tr });
   var r = {};
   t.r(r), t.d(r, { boolean: () => g, booleanish: () => y, commaOrSpaceSeparated: () => w, commaSeparated: () => b, number: () => x, overloadedBoolean: () => v, spaceSeparated: () => k });
   var o = {};
   t.r(o), t.d(o, { attentionMarkers: () => nt, contentInitial: () => Yn, disable: () => tt, document: () => Qn, flow: () => Jn, flowInitial: () => Xn, insideSpan: () => et, string: () => Zn, text: () => Gn });
   ...
   class E extends h {
    constructor(e, n, t, o) {
     let i = -1;
     if ((super(e, n), C(this, 'space', o), 'number' == typeof t))
      for (; ++i < P.length; ) {
       const e = P[i];
       C(this, P[i], (t & r[e]) === r[e]);
      }
    }
   }
   function C(e, n, t) {
   ...
   function ue(e, n, t) {
    return 'element' === n.type
     ? (function (e, n, t) {
        ...
        return ce(e, l, i, n), fe(l, a), e.ancestors.pop(), (e.schema = r), e.create(n, i, l, t);
       })(e, n, t)
   ...
   const xe = { action: ['form'], cite: ['blockquote', 'del', 'ins', 'q'], data: ['object'], formAction: ['button', 'input'], href: ['a', 'area', 'base', 'link'], icon: ['menuitem'], itemId: null, manifest: ['html'], ping: ['a', 'area'], poster: ['video'], src: ['audio', 'embed', 'iframe', 'img', 'input', 'script', 'source', 'track', 'video'] };
   var ke = t(52676);
   t(75271);
   const be = {};
   function we(e, n, t) {
   ...
   function Ce(e) {
    ...
    for (; ++u < e.length; ) {
     ...
     if ('enter' === t[0]) t[1].contentType && (Object.assign(n, Ie(e, u)), (u = n[u]), (s = !0));
     ...
     tokenize: function (e) {
      ...
      function s(e) {
       if ((l++, n.containerState._closeFlow)) {
        (n.containerState._closeFlow = void 0), r && v();
      ...
      function u(o) {
       ...
       return (n.containerState = {}), e.check(Ke, c, f)(o);
      }
      function c(e) {
       return r && v(), y(l), p(e);
      }
      ...
      function h(t) {
       return null === t ? (r && v(), y(0), void e.consume(t)) : ((r = r || n.parser.flow(n.now())), e.enter('chunkFlow', { contentType: 'flow', previous: o, _tokenizer: r }), m(t));
      }
      function m(t) {
   ...
   const Qe = {
    tokenize: function (e, n, t) {
     return function (n) {
      return Ue(n) ? qe(e, r, 'linePrefix')(n) : r(n);
     };
     function r(e) {
   ...
   const Ye = {
     tokenize: function (e, n) {
      ...
      function r(n) {
       return null === n ? o(n) : _e(n) ? e.check(Xe, i, o)(n) : (e.consume(n), r);
      }
      function o(t) {
    ...
    tokenize: function (e) {
     const n = this,
      t = e.attempt(
       ...
       e.attempt(this.parser.constructs.flowInitial, r, qe(e, e.attempt(this.parser.constructs.flow, r, e.attempt(Ye, r)), 'linePrefix')),
      );
     return t;
     function r(r) {
    ...
    const u = {
     ...
     c = {
      ...
      write: function (e) {
       ...
       return x(n, 0), (c.events = on(i, c.events, c)), c.events;
      },
     };
    let f,
     ...
     return function (t, o, i) {
      ...
      function g(e) {
       return function (t) {
        ...
        if (e.name && c.parser.constructs.disable.null.includes(e.name)) return v(t);
        return e.tokenize.call(n ? Object.assign(Object.create(c), n) : c, u, y, v)(t);
       };
      }
      function y(n) {
       return (s = !0), e(p, d), o;
   ...
   const an = {
    ...
    tokenize: function (e, n, t) {
     ...
     function l(n) {
      return n === r ? (e.consume(n), o++, l) : (e.exit('thematicBreakSequence'), Ue(n) ? qe(e, i, 'whitespace')(n) : i(n));
     }
    },
   };
   const sn = {
     ...
     tokenize: function (e, n, t) {
      ...
      return function (n) {
       ...
       if ('listUnordered' === o ? !r.containerState.marker || n === r.containerState.marker : Re(n)) {
      ...
      function a(n) {
       return Re(n) && ++l < 10 ? (e.consume(n), a) : (!r.interrupt || l < 2) && (r.containerState.marker ? n === r.containerState.marker : 41 === n || 46 === n) ? (e.exit('listItemValue'), s(n)) : t(n);
      }
      function s(n) {
       return e.enter('listItemMarker'), e.consume(n), e.exit('listItemMarker'), (r.containerState.marker = r.containerState.marker || n), e.check(Qe, r.interrupt ? t : u, e.attempt(un, f, c));
      }
      function u(e) {
     ...
     continuation: {
      tokenize: function (e, n, t) {
       ...
       function i(t) {
        return r.containerState.furtherBlankLines || !Ue(t) ? ((r.containerState.furtherBlankLines = void 0), (r.containerState.initialBlankLine = void 0), l(t)) : ((r.containerState.furtherBlankLines = void 0), (r.containerState.initialBlankLine = void 0), e.attempt(cn, n, l)(t));
       }
       function l(o) {
   ...
   const fn = {
    ...
    continuation: {
     tokenize: function (e, n, t) {
      const r = this;
      return function (n) {
       if (Ue(n)) return qe(e, o, 'linePrefix', r.parser.constructs.disable.null.includes('codeIndented') ? void 0 : 4)(n);
       return o(n);
      };
      function o(r) {
   ...
   function pn(e, n, t, r, o, i, l, a, s) {
    ...
    function h(o) {
     return c || (null !== o && 41 !== o && !Be(o)) ? (c < u && 40 === o ? (e.consume(o), c++, h) : 41 === o ? (e.consume(o), c--, h) : null === o || 32 === o || 40 === o || Fe(o) ? t(o) : (e.consume(o), 92 === o ? m : h)) : (e.exit('chunkString'), e.exit(a), e.exit(l), e.exit(r), n(o));
    }
    function m(n) {
   ...
   function dn(e, n, t, r, o, i) {
    ...
    function u(f) {
     return s > 999 || null === f || 91 === f || (93 === f && !a) || (94 === f && !s && '_hiddenFootnoteSupport' in l.parser.constructs) ? t(f) : 93 === f ? (e.exit(i), e.enter(o), e.consume(f), e.exit(o), e.exit(r), n) : _e(f) ? (e.enter('lineEnding'), e.consume(f), e.exit('lineEnding'), u) : (e.enter('chunkString', { contentType: 'string' }), c(f));
    }
    function c(n) {
     return null === n || 91 === n || 93 === n || _e(n) || s++ > 999 ? (e.exit('chunkString'), u(n)) : (e.consume(n), a || (a = !Ue(n)), 92 === n ? f : c);
    }
    function f(n) {
   ...
   function hn(e, n, t, r, o, i) {
    ...
    function s(n) {
     return n === l ? (e.exit(i), a(l)) : null === n ? t(n) : _e(n) ? (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), qe(e, s, 'linePrefix')) : (e.enter('chunkString', { contentType: 'string' }), u(n));
    }
    function u(n) {
     return n === l || null === n || _e(n) ? (e.exit('chunkString'), s(n)) : (e.consume(n), 92 === n ? c : u);
    }
    function c(n) {
   ...
   function mn(e, n) {
    ...
    return function r(o) {
     ...
     if (Ue(o)) return qe(e, r, t ? 'linePrefix' : 'lineSuffix')(o);
     return n(o);
    };
   }
   function gn(e) {
   ...
   const yn = {
     ...
     tokenize: function (e, n, t) {
      ...
      function s(n) {
       return e.attempt(vn, u, u)(n);
      }
      function u(n) {
       return Ue(n) ? qe(e, c, 'whitespace')(n) : c(n);
      }
      function c(i) {
    ...
    vn = {
     tokenize: function (e, n, t) {
      ...
      function o(n) {
       return Ue(n) ? qe(e, i, 'whitespace')(n) : i(n);
      }
      function i(e) {
       return null === e || _e(e) ? n(e) : t(e);
      }
   ...
   const bn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function i(t) {
      return 35 === t ? (e.enter('atxHeadingSequence'), l(t)) : null === t || _e(t) ? (e.exit('atxHeading'), n(t)) : Ue(t) ? qe(e, i, 'whitespace')(t) : (e.enter('atxHeadingText'), a(t));
     }
     function l(n) {
   ...
   const wn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function i(n) {
      return n === o ? (e.consume(n), i) : (e.exit('setextHeadingLineSequence'), Ue(n) ? qe(e, l, 'lineSuffix')(n) : l(n));
     }
     function l(r) {
   ...
   const Sn = ['address', 'article', 'aside', 'base', 'basefont', 'blockquote', 'body', 'caption', 'center', 'col', 'colgroup', 'dd', 'details', 'dialog', 'dir', 'div', 'dl', 'dt', 'fieldset', 'figcaption', 'figure', 'footer', 'form', 'frame', 'frameset', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'head', 'header', 'hr', 'html', 'iframe', 'legend', 'li', 'link', 'main', 'menu', 'menuitem', 'nav', 'noframes', 'ol', 'optgroup', 'option', 'p', 'param', 'search', 'section', 'summary', 'table', 'tbody', 'td', 'tfoot', 'th', 'thead', 'title', 'tr', 'track', 'ul'],
    ...
    En = {
     ...
     tokenize: function (e, n, t) {
      ...
      function u(a) {
       return 33 === a ? (e.consume(a), c) : 47 === a ? (e.consume(a), (i = !0), d) : 63 === a ? (e.consume(a), (o = 3), r.interrupt ? n : M) : De(a) ? (e.consume(a), (l = String.fromCharCode(a)), h) : t(a);
      }
      function c(i) {
      ...
      function p(o) {
       const i = 'CDATA[';
       return o === i.charCodeAt(a++) ? (e.consume(o), 6 === a ? (r.interrupt ? n : C) : p) : t(o);
      }
      function d(n) {
      ...
      function h(a) {
       if (null === a || 47 === a || 62 === a || Be(a)) {
        const s = 47 === a,
         u = l.toLowerCase();
        return s || i || !Pn.includes(u) ? (Sn.includes(l.toLowerCase()) ? ((o = 6), s ? (e.consume(a), m) : r.interrupt ? n(a) : C(a)) : ((o = 7), r.interrupt && !r.parser.lazy[r.now().line] ? t(a) : i ? g(a) : y(a))) : ((o = 1), r.interrupt ? n(a) : C(a));
       }
      ...
      function g(n) {
       return Ue(n) ? (e.consume(n), g) : P(n);
      }
      function y(n) {
       return 47 === n ? (e.consume(n), P) : 58 === n || 95 === n || De(n) ? (e.consume(n), v) : Ue(n) ? (e.consume(n), y) : P(n);
      }
      function v(n) {
       return 45 === n || 46 === n || 58 === n || 95 === n || ze(n) ? (e.consume(n), v) : x(n);
      }
      function x(n) {
       return 61 === n ? (e.consume(n), k) : Ue(n) ? (e.consume(n), x) : y(n);
      }
      function k(n) {
      ...
      function w(n) {
       return null === n || 34 === n || 39 === n || 47 === n || 60 === n || 61 === n || 62 === n || 96 === n || Be(n) ? x(n) : (e.consume(n), w);
      }
      function S(e) {
      ...
      function E(n) {
       return null === n || _e(n) ? C(n) : Ue(n) ? (e.consume(n), E) : t(n);
      }
      function C(n) {
       return 45 === n && 2 === o ? (e.consume(n), O) : 60 === n && 1 === o ? (e.consume(n), L) : 62 === n && 4 === o ? (e.consume(n), F) : 63 === n && 3 === o ? (e.consume(n), M) : 93 === n && 5 === o ? (e.consume(n), z) : !_e(n) || (6 !== o && 7 !== o) ? (null === n || _e(n) ? (e.exit('htmlFlowData'), I(n)) : (e.consume(n), C)) : (e.exit('htmlFlowData'), e.check(Cn, R, I)(n));
      }
      function I(n) {
       return e.check(In, T, R)(n);
      }
      function T(n) {
       return e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), A;
      }
      function A(n) {
       return null === n || _e(n) ? I(n) : (e.enter('htmlFlowData'), C(n));
      }
      function O(n) {
       return 45 === n ? (e.consume(n), M) : C(n);
      }
      function L(n) {
      ...
      function D(n) {
       if (62 === n) {
        ...
        return Pn.includes(t) ? (e.consume(n), F) : C(n);
       }
       return De(n) && l.length < 8 ? (e.consume(n), (l += String.fromCharCode(n)), D) : C(n);
      }
      function z(n) {
       return 93 === n ? (e.consume(n), M) : C(n);
      }
      function M(n) {
       return 62 === n ? (e.consume(n), F) : 45 === n && 2 === o ? (e.consume(n), M) : C(n);
      }
      function F(n) {
       return null === n || _e(n) ? (e.exit('htmlFlowData'), R(n)) : (e.consume(n), F);
      }
      function R(t) {
   ...
   const Tn = {
    ...
    An = {
     ...
     tokenize: function (e, n, t) {
      const r = this,
       o = {
        tokenize: function (e, n, t) {
         ...
         function s(n) {
          return e.enter('codeFencedFence'), Ue(n) ? qe(e, u, 'linePrefix', r.parser.constructs.disable.null.includes('codeIndented') ? void 0 : 4)(n) : u(n);
         }
         function u(n) {
          return n === i ? (e.enter('codeFencedFenceSequence'), c(n)) : t(n);
         }
         function c(n) {
          return n === i ? (o++, e.consume(n), c) : o >= a ? (e.exit('codeFencedFenceSequence'), Ue(n) ? qe(e, f, 'whitespace')(n) : f(n)) : t(n);
         }
         function f(r) {
      ...
      function s(n) {
       return n === i ? (a++, e.consume(n), s) : a < 3 ? t(n) : (e.exit('codeFencedFenceSequence'), Ue(n) ? qe(e, u, 'whitespace')(n) : u(n));
      }
      function u(t) {
       return null === t || _e(t) ? (e.exit('codeFencedFence'), r.interrupt ? n(t) : e.check(Tn, d, v)(t)) : (e.enter('codeFencedFenceInfo'), e.enter('chunkString', { contentType: 'string' }), c(t));
      }
      function c(n) {
       return null === n || _e(n) ? (e.exit('chunkString'), e.exit('codeFencedFenceInfo'), u(n)) : Ue(n) ? (e.exit('chunkString'), e.exit('codeFencedFenceInfo'), qe(e, f, 'whitespace')(n)) : 96 === n && n === i ? t(n) : (e.consume(n), c);
      }
      function f(n) {
       return null === n || _e(n) ? u(n) : (e.enter('codeFencedFenceMeta'), e.enter('chunkString', { contentType: 'string' }), p(n));
      }
      function p(n) {
       return null === n || _e(n) ? (e.exit('chunkString'), e.exit('codeFencedFenceMeta'), u(n)) : 96 === n && n === i ? t(n) : (e.consume(n), p);
      }
      function d(n) {
       return e.attempt(o, v, h)(n);
      }
      function h(n) {
       return e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), m;
      }
      function m(n) {
       return l > 0 && Ue(n) ? qe(e, g, 'linePrefix', l + 1)(n) : g(n);
      }
      function g(n) {
       return null === n || _e(n) ? e.check(Tn, d, v)(n) : (e.enter('codeFlowValue'), y(n));
      }
      function y(n) {
   ...
   const Dn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function a(n) {
      return 35 === n ? (e.enter('characterReferenceMarkerNumeric'), e.consume(n), e.exit('characterReferenceMarkerNumeric'), s) : (e.enter('characterReferenceValue'), (o = 31), (i = ze), u(n));
     }
     function s(n) {
      return 88 === n || 120 === n ? (e.enter('characterReferenceMarkerHexadecimal'), e.consume(n), e.exit('characterReferenceMarkerHexadecimal'), e.enter('characterReferenceValue'), (o = 6), (i = je), u) : (e.enter('characterReferenceValue'), (o = 7), (i = Re), u(n));
     }
     function u(a) {
      if (59 === a && l) {
   ...
   const Fn = {
     ...
     tokenize: function (e, n, t) {
      ...
      function a(n) {
       return 40 === n ? e.attempt(Rn, u, i ? u : c)(n) : 91 === n ? e.attempt(jn, u, i ? s : c)(n) : i ? u(n) : c(n);
      }
      function s(n) {
       return e.attempt(Nn, u, c)(n);
      }
      function u(e) {
       return n(e);
      }
     ...
     resolveTo: function (e, n) {
      ...
      return (
       ...
       (i = Ee(i, [['exit', c, n], e[o - 2], e[o - 1], ['exit', u, n]])),
       (i = Ee(i, e.slice(o + 1))),
       (i = Ee(i, [['exit', s, n]])),
       Pe(e, r, e.length, i),
       e
    ...
    Rn = {
     tokenize: function (e, n, t) {
      ...
      function o(n) {
       return 41 === n ? u(n) : pn(e, i, l, 'resourceDestination', 'resourceDestinationLiteral', 'resourceDestinationLiteralMarker', 'resourceDestinationRaw', 'resourceDestinationString', 32)(n);
      }
      function i(n) {
       return Be(n) ? mn(e, a)(n) : u(n);
      }
      function l(e) {
       return t(e);
      }
      function a(n) {
       return 34 === n || 39 === n || 40 === n ? hn(e, s, t, 'resourceTitle', 'resourceTitleMarker', 'resourceTitleString')(n) : u(n);
      }
      function s(n) {
       return Be(n) ? mn(e, u)(n) : u(n);
      }
      function u(r) {
       ...
       for (t = c; t--; )
        if ('exit' === e[t][0] && 'attentionSequence' === e[t][1].type && e[t][1]._open && n.sliceSerialize(e[t][1]).charCodeAt(0) === n.sliceSerialize(e[c][1]).charCodeAt(0)) {
         ...
         Hn(f, -a),
          ...
          (s = Ee(s, on(n.parser.constructs.insideSpan.null, e.slice(t + 1, c), n))),
          (s = Ee(s, [
           ['exit', o, n],
           ['enter', l, n],
           ['exit', l, n],
   ...
   const Vn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function s(n) {
      return 64 === n ? (e.consume(n), u) : Me(n) ? (e.consume(n), s) : t(n);
     }
     function u(e) {
      return ze(e) ? c(e) : t(e);
     }
   ...
   const qn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function a(n) {
      return 33 === n ? (e.consume(n), s) : 47 === n ? (e.consume(n), k) : 63 === n ? (e.consume(n), v) : De(n) ? (e.consume(n), S) : t(n);
     }
     function s(n) {
      return 45 === n ? (e.consume(n), u) : 91 === n ? (e.consume(n), (i = 0), d) : De(n) ? (e.consume(n), y) : t(n);
     }
     function u(n) {
      return 45 === n ? (e.consume(n), p) : t(n);
     }
     function c(n) {
      return null === n ? t(n) : 45 === n ? (e.consume(n), f) : _e(n) ? ((l = c), D(n)) : (e.consume(n), c);
     }
     function f(n) {
     ...
     function v(n) {
      return null === n ? t(n) : 63 === n ? (e.consume(n), x) : _e(n) ? ((l = v), D(n)) : (e.consume(n), v);
     }
     function x(e) {
      return 62 === e ? L(e) : v(e);
     }
     ...
     function S(n) {
      return 45 === n || ze(n) ? (e.consume(n), S) : 47 === n || 62 === n || Be(n) ? P(n) : t(n);
     }
     function P(n) {
      return 47 === n ? (e.consume(n), L) : 58 === n || 95 === n || De(n) ? (e.consume(n), E) : _e(n) ? ((l = P), D(n)) : Ue(n) ? (e.consume(n), P) : L(n);
     }
     function E(n) {
      return 45 === n || 46 === n || 58 === n || 95 === n || ze(n) ? (e.consume(n), E) : C(n);
     }
     function C(n) {
      return 61 === n ? (e.consume(n), I) : _e(n) ? ((l = C), D(n)) : Ue(n) ? (e.consume(n), C) : P(n);
     }
     function I(n) {
      return null === n || 60 === n || 61 === n || 62 === n || 96 === n ? t(n) : 34 === n || 39 === n ? (e.consume(n), (o = n), T) : _e(n) ? ((l = I), D(n)) : Ue(n) ? (e.consume(n), I) : (e.consume(n), A);
     }
     function T(n) {
      return n === o ? (e.consume(n), (o = void 0), O) : null === n ? t(n) : _e(n) ? ((l = T), D(n)) : (e.consume(n), T);
     }
     function A(n) {
      return null === n || 34 === n || 39 === n || 60 === n || 61 === n || 96 === n ? t(n) : 47 === n || 62 === n || Be(n) ? P(n) : (e.consume(n), A);
     }
     function O(e) {
      return 47 === e || 62 === e || Be(e) ? P(e) : t(e);
     }
     function L(r) {
     ...
     function z(n) {
      return Ue(n) ? qe(e, M, 'linePrefix', r.parser.constructs.disable.null.includes('codeIndented') ? void 0 : 4)(n) : M(n);
     }
     function M(n) {
   ...
   const Kn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function a(n) {
      return null === n ? t(n) : 32 === n ? (e.enter('space'), e.consume(n), e.exit('space'), a) : 96 === n ? ((o = e.enter('codeTextSequence')), (r = 0), u(n)) : _e(n) ? (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), a) : (e.enter('codeTextData'), s(n));
     }
     function s(n) {
   ...
   const Qn = { 42: sn, 43: sn, 45: sn, 48: sn, 49: sn, 50: sn, 51: sn, 52: sn, 53: sn, 54: sn, 55: sn, 56: sn, 57: sn, 62: fn },
    Yn = { 91: yn },
    Xn = { [-2]: xn, [-1]: xn, 32: xn },
    Jn = { 35: bn, 42: an, 45: [wn, an], 60: En, 61: wn, 95: an, 96: An, 126: An },
    Zn = { 38: Dn, 92: zn },
    Gn = { [-5]: Mn, [-4]: Mn, [-3]: Mn, 33: _n, 38: Dn, 42: Un, 60: [Vn, qn], 91: Wn, 92: [$n, zn], 93: Fn, 95: Un, 96: Kn },
    et = { null: [Un, Ze] },
    nt = { null: [42, 95] },
    tt = { null: [] };
   function rt(e) {
    const n = (function (e) {
     ...
     t = { defined: [], lazy: {}, constructs: n, content: r(We), document: r($e), flow: r(Je), string: r(Ge), text: r(en) };
    return t;
    function r(e) {
     return function (n) {
      return ln(t, e, n);
   ...
   function ut(e, n, t) {
    return (
     ...
     (function (e) {
      const n = { transforms: [], canContainEols: ['emphasis', 'fragment', 'heading', 'paragraph', 'strong'], enter: { autolink: i(ne), autolinkProtocol: E, autolinkEmail: E, atxHeading: i(J), blockQuote: i(W), characterEscape: E, characterReference: E, codeFenced: i($), codeFencedFenceInfo: l, codeFencedFenceMeta: l, codeIndented: i($, l), codeText: i(K, l), codeTextData: E, data: E, codeFlowValue: E, definition: i(Q), definitionDestinationString: l, definitionLabelString: l, definitionTitleString: l, emphasis: i(Y), hardBreakEscape: i(Z), hardBreakTrailing: i(Z), htmlFlow: i(G, l), htmlFlowData: E, htmlText: i(G, l), htmlTextData: E, image: i(ee), label: l, link: i(ne), listItem: i(re), listItemValue: p, listOrdered: i(te, f), listUnordered: i(te), paragraph: i(oe), reference: _, referenceString: l, resourceDestinationString: l, resourceTitleString: l, setextHeading: i(J), strong: i(ie), thematicBreak: i(ae) }, exit: { atxHeading: s(), atxHeadingSequence: b, autolink: s(), autolinkEmail: q, autolinkProtocol: V, blockQuote: s(), characterEscapeValue: C, characterReferenceMarkerHexadecimal: U, characterReferenceMarkerNumeric: U, characterReferenceValue: H, codeFenced: s(g), codeFencedFence: m, codeFencedFenceInfo: d, codeFencedFenceMeta: h, codeFlowValue: C, codeIndented: s(y), codeText: s(L), codeTextData: C, data: C, definition: s(), definitionDestinationString: k, definitionLabelString: v, definitionTitleString: x, emphasis: s(), hardBreakEscape: s(T), hardBreakTrailing: s(T), htmlFlow: s(A), htmlFlowData: C, htmlText: s(O), htmlTextData: C, image: s(z), label: F, labelText: M, lineEnding: I, link: s(D), listItem: s(), listOrdered: s(), listUnordered: s(), paragraph: s(), referenceString: B, resourceDestinationString: R, resourceTitleString: j, resource: N, setextHeading: s(P), setextHeadingLineSequence: S, setextHeadingText: w, strong: s(), thematicBreak: s() } };
      ...
      function r(e) {
       ...
       for (r.position = { start: ct(e.length > 0 ? e[0][1].start : { line: 1, column: 1, offset: 0 }), end: ct(e.length > 0 ? e[e.length - 2][1].end : { line: 1, column: 1, offset: 0 }) }, f = -1; ++f < n.transforms.length; ) r = n.transforms[f](r) || r;
       return r;
      }
      function o(e, n, t) {
       let r,
      ...
      function a(e, n, t) {
       this.stack[this.stack.length - 1].children.push(e), this.stack.push(e), this.tokenStack.push([n, t]), (e.position = { start: ct(n.start), end: void 0 });
      }
      function s(e) {
       return n;
       function n(n) {
      ...
      function u(e, n) {
       ...
       if (!r) throw new Error('Cannot close `' + e.type + '` (' + X({ start: e.start, end: e.end }) + '): it\u2019s not open');
       if (r[0].type !== e.type)
        if (n) n.call(this, e, r[0]);
        else {
         (r[1] || dt).call(this, e, r[0]);
        }
       t.position.end = ct(e.end);
      }
      function c() {
       return (function (e, n) {
        const t = n || be;
      ...
      function E(e) {
       ...
       let t = n[n.length - 1];
       (t && 'text' === t.type) || ((t = le()), (t.position = { start: ct(e.start), end: void 0 }), n.push(t)), this.stack.push(t);
      }
      function C(e) {
       const n = this.stack.pop();
       (n.value += this.sliceSerialize(e)), (n.position.end = ct(e.end));
      }
      function I(e) {
       const t = this.stack[this.stack.length - 1];
       if (this.data.atHardBreak) {
        return (t.children[t.children.length - 1].position.end = ct(e.end)), void (this.data.atHardBreak = void 0);
       }
       !this.data.setextHeadingSlurpLineEnding && n.canContainEols.includes(t.type) && (E.call(this, e), C.call(this, e));
      }
      function T() {
         ...
         (function () {
          ...
          return function (o, i, l) {
           ...
           for (o = t + ('string' == typeof o ? o.toString() : new TextDecoder(i || void 0).decode(o)), c = 0, t = '', r && (65279 === o.charCodeAt(0) && c++, (r = void 0)); c < o.length; ) {
            if (((ot.lastIndex = c), (s = ot.exec(o)), (f = s && void 0 !== s.index ? s.index : o.length), (p = o.charCodeAt(f)), !s)) {
             t = o.slice(c);
             break;
            }
   ...
   function dt(e, n) {
    throw e ? new Error('Cannot close `' + e.type + '` (' + X({ start: e.start, end: e.end }) + '): a different token (`' + n.type + '`, ' + X({ start: n.start, end: n.end }) + ') is open') : new Error('Cannot close document, a token (`' + n.type + '`, ' + X({ start: n.start, end: n.end }) + ') is still open');
   }
   function ht(e) {
    const n = this;
    n.parser = function (t) {
     return ut(t, { ...n.data('settings'), ...e, extensions: n.data('micromarkExtensions') || [], mdastExtensions: n.data('fromMarkdownExtensions') || [] });
    };
   }
        ...
        i = (r) => {
         ...
         switch (l) {
          ...
          case 2: {
           ...
           const t = [],
            s = o([l, t], r);
           for (const n of xt(r)) (!e && bt(kt(r[n]))) || t.push([i(n), i(r[n])]);
           return s;
          }
          case 3:
    ...
    const t = (function (e, n) {
     ...
     o = (function (e) {
      const n = 'string' == typeof e.options.clobberPrefix ? e.options.clobberPrefix : 'user-content-',
       ...
       r = e.options.footnoteBackLabel || Ct,
   ...
   const ur = ['history', 'path', 'basename', 'stem', 'extname', 'dirname'];
   class cr {
    constructor(e) {
     let n;
     (n = e
     ...
     for (t in n) ur.includes(t) || (this[t] = n[t]);
    }
    get basename() {
   ...
   class gr extends hr {
    ...
    parse(e) {
     ...
     return vr('parse', t), t(String(n), n);
    }
    process(e, n) {
     const t = this;
     return this.freeze(), vr('process', this.parser || this.Parser), xr('process', this.compiler || this.Compiler), n ? r(void 0, n) : new Promise(r);
     function r(r, o) {
      const i = Sr(e),
       l = t.parse(i);
      function a(e, t) {
    ...
    processSync(e) {
     ...
     return (
      this.freeze(),
      vr('processSync', this.parser || this.Parser),
    ...
    stringify(e, n) {
     ...
     return xr('stringify', r), br(e), r(e, t);
    }
    use(e, ...n) {
   ...
   function Ar(e) {
    const n = e.rehypePlugins || Pr,
     t = e.remarkPlugins || Pr,
   ...
   function Lr(e, n) {
    const t = n.allowedElements,
     ...
     s = n.urlTransform || Dr;
    for (const u of Ir) Object.hasOwn(n, u.from) && (u.from, u.to && u.to, u.id);
    return (
     Rt(e, function (e, n, o) {
      ...
      if ('element' === e.type) {
       let n;
       for (n in xe)
        if (Object.hasOwn(xe, n) && Object.hasOwn(e.properties, n)) {
   ...
   function Dr(e) {
    const n = e.indexOf(':'),
     ...
     r = e.indexOf('#'),
     o = e.indexOf('/');
    return -1 === n || (-1 !== o && n > o) || (-1 !== t && n > t) || (-1 !== r && n > r) || Cr.test(e.slice(0, n)) ? e : '';
   }
  },
  46686: (e, n, t) => {
   'use strict';
   ...
   const o = /\.(m4a|m4b|mp4a|mpga|mp2|mp2a|mp3|m2a|m3a|wav|weba|aac|oga|spx)($|\?)/i,
    ...
    d = /(?:www\.|go\.)?twitch\.tv\/([a-zA-Z0-9_]+|(videos?\/|\?video=)\d+)($|\?)/,
    h = /tiktok\.com\/(?:@[^/]+\/video\/)?(\d+)(?:\/([\w-]+))?/,
    m = (e, n) => {
     if (Array.isArray(e)) {
      for (const t of e) {
    ...
    g = { html: (e) => m(e, (e) => o.test(e) || i.test(e)), hls: (e) => m(e, (e) => l.test(e)), dash: (e) => m(e, (e) => a.test(e)), mux: (e) => s.test(e), youtube: (e) => u.test(e), vimeo: (e) => c.test(e) && !i.test(e) && !l.test(e), wistia: (e) => f.test(e), spotify: (e) => p.test(e), twitch: (e) => d.test(e), tiktok: (e) => h.test(e) };
   var y = r.forwardRef((e, n) => {
    const t = o.test(`${e.src}`) ? 'audio' : 'video';
    return r.createElement(t, { ...e, ref: n }, e.children);
   });
   var v = [
    { key: 'hls', name: 'hls.js', canPlay: g.hls, canEnablePIP: () => !0, player: (0, r.lazy)(() => Promise.all([t.e(29177), t.e(53184)]).then(t.bind(t, 99823))) },
    { key: 'dash', name: 'dash.js', canPlay: g.dash, canEnablePIP: () => !0, player: (0, r.lazy)(() => t.e(78443).then(t.bind(t, 67177))) },
    { key: 'mux', name: 'Mux', canPlay: g.mux, canEnablePIP: () => !0, player: (0, r.lazy)(() => Promise.all([t.e(29177), t.e(64258)]).then(t.bind(t, 74486))) },
    { key: 'youtube', name: 'YouTube', canPlay: g.youtube, player: (0, r.lazy)(() => t.e(64439).then(t.bind(t, 21489))) },
    { key: 'vimeo', name: 'Vimeo', canPlay: g.vimeo, player: (0, r.lazy)(() => t.e(73743).then(t.bind(t, 20667))) },
    { key: 'wistia', name: 'Wistia', canPlay: g.wistia, canEnablePIP: () => !0, player: (0, r.lazy)(() => t.e(88055).then(t.bind(t, 51820))) },
    { key: 'spotify', name: 'Spotify', canPlay: g.spotify, canEnablePIP: () => !1, player: (0, r.lazy)(() => t.e(41954).then(t.bind(t, 37949))) },
    { key: 'twitch', name: 'Twitch', canPlay: g.twitch, canEnablePIP: () => !1, player: (0, r.lazy)(() => t.e(86216).then(t.bind(t, 1997))) },
    { key: 'tiktok', name: 'TikTok', canPlay: g.tiktok, canEnablePIP: () => !1, player: (0, r.lazy)(() => t.e(34491).then(t.bind(t, 51102))) },
    { key: 'html', name: 'html', canPlay: g.html, canEnablePIP: () => !0, player: y },
   ];
   const x = { width: '320px', height: '180px', volume: 1, playbackRate: 1, previewTabIndex: 0, previewAriaLabel: '', oEmbedUrl: 'https://noembed.com/embed?url={url}' },
    k = r.forwardRef((e, n) => {
     const { playing: t, pip: o } = e,
      i = e.activePlayer,
      l = (0, r.useRef)(null),
      a = (0, r.useRef)(!0);
     (0, r.useEffect)(() => {
      var n, r;
      l.current && (l.current.paused && !0 === t && l.current.play(), l.current.paused || !1 !== t || l.current.pause(), (l.current.playbackRate = null != (n = e.playbackRate) ? n : 1), (l.current.volume = null != (r = e.volume) ? r : 1));
     }),
      (0, r.useEffect)(() => {
       var e, n, t, r, i;
       if (l.current && globalThis.document) {
        ...
        if (!o && document.pictureInPictureElement)
         try {
          null == (r = (t = l.current).exitPictureInPicture) || r.call(t), null == (i = document.exitPictureInPicture) || i.call(document);
         } catch (a) {}
       }
      }, [o]);
     if (!i) return null;
     const s = {};
     for (const r in e) r.startsWith('on') && (s[r] = e[r]);
     return r.createElement(
      i,
      {
       ...
       onLoadStart: (n) => {
        var t, r;
        (a.current = !0), null == (t = e.onReady) || t.call(e), null == (r = e.onLoadStart) || r.call(e, n);
       },
       onPlay: (n) => {
        var t, r;
        a.current && ((a.current = !1), null == (t = e.onStart) || t.call(e, n)), null == (r = e.onPlay) || r.call(e, n);
       },
      },
      e.children,
     );
    });
   k.displayName = 'Player';
   var b = k;
   const w = (0, r.lazy)(() => t.e(87664).then(t.bind(t, 79240))),
    S = [],
    P = ({ children: e }) => e;
   var E = ((e, n) => {
    const t = r.forwardRef((t, o) => {
     const i = { ...x, ...t },
      { src: l, slot: a, className: s, style: u, width: c, height: f, fallback: p, wrapper: d } = i,
      [h, m] = (0, r.useState)(!!i.light);
     (0, r.useEffect)(() => {
      i.light ? m(!0) : m(!1);
     }, [i.light]);
     const g = (e) => {
     ...
     return r.createElement(
      y,
      { slot: a, className: s, style: { width: c, height: f, ...u } },
      r.createElement(
       v,
       { fallback: p },
       h
        ? ((e) => {
           if (!e) return null;
           const { light: n, playIcon: t, previewTabIndex: o, oEmbedUrl: l, previewAriaLabel: a } = i;
           return r.createElement(w, { src: e, light: n, playIcon: t, previewTabIndex: o, previewAriaLabel: a, oEmbedUrl: l, onClickPreview: g });
          })(l)
        : ((t) => {
           var l, u;
           const c = ((t) => {
            for (const n of [...S, ...e]) if (t && n.canPlay(t)) return n;
            return n || null;
           })(t);
           if (!c) return null;
           const { style: f, width: p, height: d, wrapper: h } = i,
            m = null == (l = i.config) ? void 0 : l[c.key];
           return r.createElement(b, { ...i, ref: o, activePlayer: null != (u = c.player) ? u : c, slot: h ? void 0 : a, className: h ? void 0 : s, style: h ? { display: 'block', width: '100%', height: '100%' } : { display: 'block', width: p, height: d, ...f }, config: m });
          })(l),
      ),
     );
    });
    return (
     ...
     (t.canPlay = (n) => {
      if (n) for (const t of [...S, ...e]) if (t.canPlay(n)) return !0;
      return !1;
     }),
     (t.canEnablePIP = (n) => {
      var t;
      if (n) for (const r of [...S, ...e]) if (r.canPlay(n) && (null == (t = r.canEnablePIP) ? void 0 : t.call(r))) return !0;
      return !1;
     }),
     t
    );
