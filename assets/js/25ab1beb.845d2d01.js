/*! For license information please see 25ab1beb.845d2d01.js.LICENSE.txt */
'use strict';
  ...
  75397(e, n, i) {
   ...
   const l = t.forwardRef(function (e, n) {
     const [i, l] = t.useState(!1),
      ...
      H = t.useCallback(e.onIframeAdded || function () {}, [e.onIframeAdded]),
      ...
      (0, s.jsxs)(s.Fragment, {
       children: [
        ...
        (0, s.jsxs)(O, {
         ...
         children: [e.lazyLoad && !a && (0, s.jsx)('img', { src: w, alt: `${c} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, s.jsx)('button', { type: 'button', className: L, 'aria-label': `${j} ${c}`, 'aria-hidden': a || void 0, tabIndex: a ? -1 : 0, children: (0, s.jsx)('span', { className: 'lty-visually-hidden', children: j }) }), a && (0, s.jsx)('iframe', { ref: n, className: D, title: c, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: v, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
    }),
    a = ({ id: e, title: n, ...i }) => (0, s.jsx)(l, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: n, poster: 'maxresdefault', ...i });
  },
  76222(e, n, i) {
