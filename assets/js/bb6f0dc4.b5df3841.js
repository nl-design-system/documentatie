 ...
 [31466],
 {
   ...
   const d = (0, c.createContext)({}),
    h = ({ title: e, appearance: l, description: n, children: c, figure: h }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      p = h ? 'figure' : 'div',
      m = h ? 'figcaption' : 'div',
      g = 'string' == typeof n ? (0, i.jsx)(o.oz, { components: { a: a.N_ }, children: n }) : n;
  ...
  70348(e, l, n) {
   ...
   const o = ({ className: e, ...l }) => {
    ...
    c = ({ className: e, classNamePanel: l, label: n, heading: o, headingLevel: c, headingApperance: i, ...d }) => {
     const h = (0, r.A)('utrecht-accordion__section', e),
      u = (0, r.A)('utrecht-accordion__panel', l);
     return (0, t.jsxs)('details', { className: h, ...d, children: [(0, t.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, t.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, t.jsx)('span', { className: 'nl-button__icon-start', children: (0, t.jsx)(s.A, {}) }), (0, t.jsxs)('span', { className: 'nl-button__label', children: [o && (0, t.jsx)(a.D, { level: c, appearance: i, children: o }), n] })] }) }), (0, t.jsx)('div', { className: u, children: d.children })] });
    };
  },
  80731(e, l, n) {
   n.d(l, { H: () => y });
