  ...
  75397(e, n, t) {
   ...
   const s = r.forwardRef(function (e, n) {
     const [t, s] = r.useState(!1),
      [a, d] = r.useState(e.alwaysLoadIframe || !1),
      ...
      j = r.useMemo(() => (e.cookie ? 'https://www.youtube.com' : 'https://www.youtube-nocookie.com'), [e.cookie]),
      b = r.useMemo(() => (e.playlist ? `${j}/embed/videoseries?${g.toString()}` : `${j}/embed/${c}?${g.toString()}`), [e.playlist, j, c, g]),
      ...
      k = f
       ? ((e, n, t, i = 'maxresdefault') => {
          ...
          return (
           (0, r.useEffect)(() => {
            const r = `https://img.youtube.com/${n}/${e}/${i}.${t}`,
       ...
       : null,
      w = r.useMemo(() => e.thumbnail || k || `https://i.ytimg.com/${y}/${e.playlist ? h : c}/${u}.${x}`, [e.thumbnail, k, y, e.playlist, h, c, u, x]),
      ...
      I = r.useCallback(e.onIframeAdded || function () {}, [e.onIframeAdded]),
     ...
     return (
      ...
      (0, i.jsxs)(i.Fragment, {
       children: [
        ...
        (0, i.jsx)(i.Fragment, { children: t && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('link', { rel: 'preconnect', href: j }), (0, i.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), N && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, i.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
        e.seo && !e.playlist && (0, i.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: o(e.id, p, w, j, e.seo) } }),
        R && !e.playlist && (0, i.jsx)('noscript', { children: (0, i.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${p} on YouTube`, children: ['Watch "', p, '" on YouTube'] }) }),
        (0, i.jsxs)(F, {
         onPointerOver: () => {
          t || s(!0);
         },
         ...
         children: [e.lazyLoad && !a && (0, i.jsx)('img', { src: w, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, i.jsx)('button', { type: 'button', className: $, 'aria-label': `${m} ${p}`, 'aria-hidden': a || void 0, tabIndex: a ? -1 : 0, children: (0, i.jsx)('span', { className: 'lty-visually-hidden', children: m }) }), a && (0, i.jsx)('iframe', { ref: n, className: S, title: p, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
    ...
    a = ({ id: e, title: n, ...t }) => {
     ...
     return (0, i.jsx)('div', { ref: l, children: (0, i.jsx)(s, { adNetwork: !1, announce: 'Bekijk', cookie: !1, containerElement: 'div', id: e, title: n, poster: 'maxresdefault', ...t }) });
    };
  },
  78734(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => l });
