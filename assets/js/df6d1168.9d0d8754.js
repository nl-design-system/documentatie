...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [46756],
 {
  ...
  58097: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => g, contentTitle: () => m, default: () => _, frontMatter: () => p, metadata: () => h, toc: () => v });
   var o = l(52676),
    s = l(24785),
    t = l(98480),
    a = l(91050);
  ...
  98480: (e, n, l) => {
   ...
   const g = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(o.Tg, { className: p['nlds-canvas__example-surface'], children: (0, h.jsx)(o.BB, { className: (0, s.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: (0, h.jsx)(o.nv, { className: p['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   g.displayName = 'ParagraphContainer';
   const v = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(o.Tg, { className: p['nlds-canvas__example-surface'], children: (0, h.jsx)(o.BB, { className: (0, s.Z)('utrecht-document--surface', p['nlds-canvas__example-document']), children: n }) });
   };
   ...
   const _ = (e) => {
    ...
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       w && (0, h.jsx)('div', { className: (0, s.Z)(p['nlds-canvas__example']), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, h.jsx)(E, { children: (0, h.jsx)(o.pu, { children: w }) }) }) }),
       f &&
        (0, h.jsx)('div', {
  ...
  91050: (e, n, l) => {
   ...
   const i = (e) => {
    ...
    const p = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     g = u ? 'figcaption' : 'div';
    return (0, c.jsxs)(h, { className: (0, a.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(g, { className: (0, a.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(t.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: m })] }), (0, c.jsx)(t.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(t.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(s.Z, { className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: p })] }), (0, c.jsx)(t.nv, { children: n })] }), i] }), (0, c.jsx)('div', { className: (0, a.Z)(r['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => a });
