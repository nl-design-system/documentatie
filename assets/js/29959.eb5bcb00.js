/*! For license information please see 29959.eb5bcb00.js.LICENSE.txt */
'use strict';
  ...
  79889(e, n, t) {
   ...
   var h = (0, i.forwardRef)(function (e, n) {
    ...
    if (
     ...
     var c = a.dateTime,
      h = (0, r.A)(a, d);
     return (0, l.jsx)('time', v(v({}, h), {}, { dateTime: c, className: i, ref: n, children: t }));
    }
    if (
     (function (e) {
      return 'value' in e;
     ...
     var g = a.value,
      f = (0, r.A)(a, s);
     return (0, l.jsx)('data', v(v({}, f), {}, { value: g, className: i, ref: n, children: t }));
    }
    return (0, l.jsx)('span', v(v({}, a), {}, { className: i, ref: n, children: t }));
   });
