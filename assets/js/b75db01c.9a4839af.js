...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [91279],
 {
                     ...
                     (0, m.jsx)(t.dk, {
                      links: p
                       ...
                       .map((e) => {
                        ...
                        return { children: n.desciption, icon: (0, m.jsx)(o.r, { brand: n.brand }), href: e.value };
                       }),
                     }),
                   ],
                  }),
                  g.length > 0 && g.map(({ frameworkName: e, tasks: a }) => (0, m.jsxs)('section', { children: [(0, m.jsxs)(i.DZ, { level: Math.min(n + 2, 6), children: [s, ' in ', e] }), (0, m.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, m.jsx)(o.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               r.Zp,
               {
                ...
                children: (0, m.jsxs)(r.Wu, {
                 children: [
                  ...
                  g.length > 0 && (0, m.jsx)(m.Fragment, { children: g.map(({ frameworkName: e, tasks: a }) => (0, m.jsxs)(m.Fragment, { children: [(0, m.jsxs)(t.DZ, { level: n + 2, children: [s, ' in ', e] }), (0, m.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, m.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => x, qZ: () => s, kD: () => j, QQ: () => w, B2: () => c, Pc: () => r, f4: () => o, GT: () => k, fX: () => l, eQ: () => v, B_: () => b, o_: () => f });
  ...
  70348(e, n, a) {
   ...
   var t = a(13526),
    ...
    s = a(14277),
    o = a(86070);
   const r = (0, i.forwardRef)(({ as: e, className: n, children: a, ...i }, l) => {
     const s = e || 'div',
      r = (0, t.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, o.jsx)(s, { ref: l, className: r, ...i, children: a });
    }),
    d = ({ className: e, classNamePanel: n, label: a, heading: i, headingLevel: r, headingApperance: d, ...g }) => {
     ...
     return (0, o.jsxs)('details', { className: u, ...g, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(l.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [i && (0, o.jsx)(s.D, { level: r, appearance: d, children: i }), a] })] }) }), (0, o.jsx)('div', { className: m, children: g.children })] });
    };
  },
  79597(e, n, a) {
   (a.r(n), a.d(n, { assets: () => g, component: () => p, contentTitle: () => d, default: () => f, description: () => m, frontMatter: () => r, issueNumber: () => c, metadata: () => t, title: () => u, toc: () => h }));
