(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [45403],
 {
  ...
  21034(e, n, a) {
   ...
   const b = ({ component: e, headingLevel: n }) => {
    ...
    k = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: s && (0, d.jsx)(g.D, { state: s }), children: e.title }), (0, d.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(s) && (0, d.jsx)(f.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    T = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
  ...
  32385(e, n, a) {
   'use strict';
   a.d(n, { bo: () => s, KF: () => m, mJ: () => p, VZ: () => D, cR: () => T, Pv: () => x, qZ: () => l, kD: () => v, QQ: () => N, B2: () => c, Pc: () => o, f4: () => r, GT: () => k, fX: () => i, eQ: () => j, B_: () => b, o_: () => f });
