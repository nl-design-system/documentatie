 ...
 [15483],
 {
  ...
  15175(e, l, n) {
   ...
   function c({ lineNumber: e, syntax: l, textContent: n, trim: c }) {
    let d = n;
    const { title: u, type: m } = (0, r.useContext)(o.x),
     p = (0, r.useId)();
    return (c && (d = d.trim()), (0, i.jsx)(t.f4, { theme: a, code: d, language: l || '', children: ({ style: l, tokens: n, getLineProps: t, getTokenProps: r }) => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, i.jsx)(s.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': p, style: l, children: n.map((l, n) => (0, i.jsxs)('span', { ...t({ line: l }), children: [e && (0, i.jsx)('span', { children: n + 1 }), l.map((e, l) => (0, i.jsx)('span', { ...r({ token: e }) }, l)), '\n'] }, n)) })] }) }));
   }
  },
  18439(e, l, n) {
   n.d(l, { R: () => o, x: () => a });
  ...
  70348(e, l, n) {
   ...
   const a = ({ className: e, ...l }) => {
    ...
    i = ({ className: e, classNamePanel: l, label: n, heading: a, headingLevel: i, headingApperance: c, ...d }) => {
     const u = (0, s.A)('utrecht-accordion__section', e),
      m = (0, s.A)('utrecht-accordion__panel', l);
     return (0, o.jsxs)('details', { className: u, ...d, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(t.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [a && (0, o.jsx)(r.D, { level: i, appearance: c, children: a }), n] })] }) }), (0, o.jsx)('div', { className: m, children: d.children })] });
    };
  },
  80731(e, l, n) {
   n.d(l, { H: () => v });
   ...
   const v = globalThis.isAstro
    ? ({ children: e, language: l, className: n }) => {
       const s = 'function' == typeof e ? e() : e,
        ...
        o = h().highlight(t, h().languages[l], l);
       return (0, j.jsxs)('div', { className: (0, r.A)('ma-canvas-astro', n), children: [(0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: t } }), (0, j.jsx)(b.n, { children: (0, j.jsx)(b.K, { label: 'Code', children: (0, j.jsx)('pre', { className: 'language-html nl-code-block', children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
    : ({ code: e, copy: l = !0, defaultExpandedCode: n = !1, displayCode: p = !0, children: h, container: b = 'document', language: v, designTokens: k }) => {
       const f = 'function' == typeof h ? h() : h,
        _ = 'function' == typeof e ? e() : (0, u.isValidElement)(e) ? e : void 0,
        N = 'string' == typeof e ? e : m.qV(_ || f),
        [A, w] = (0, u.useState)(N),
        [C, z] = (0, u.useState)(n);
       (0, u.useEffect)(() => {
        (async () => {
