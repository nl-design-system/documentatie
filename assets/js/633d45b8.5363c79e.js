...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [84756],
 {
  ...
  46959: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => u, contentTitle: () => m, default: () => y, frontMatter: () => h, metadata: () => b, toc: () => v });
   var t = l(52676),
    o = l(87118),
    i = l(49824),
    r = l(43599),
    s = l(40761);
   function a(e) {
    const n = { a: 'a', fieldset: 'fieldset', h2: 'h2', input: 'input', label: 'label', legend: 'legend', p: 'p', ...(0, o.a)(), ...e.components };
  ...
  43599: (e, n, l) => {
   ...
   const b = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(o.BB, { className: (0, i.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(o.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   b.displayName = 'ParagraphContainer';
   const u = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(o.Tg, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(o.BB, { className: (0, i.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const k = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(w, { parser: x, plugins: [r.Z, s.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      S(e);
     })();
    }, [w]);
    const P = (0, p.useId)();
    let z = p.Fragment;
    return (
     'paragraph' === j ? (z = b) : 'document' === j ? (z = u) : 'surface' === j && (z = v),
     (0, m.jsxs)('div', {
      className: (0, i.Z)('nlds-canvas'),
      children: [
       _ && (0, m.jsx)('div', { className: (0, i.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(z, { children: (0, m.jsx)(o.pu, { children: _ }) }) }) }),
       y &&
        (0, m.jsx)('div', {
       ...
       y &&
        (0, m.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(t.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: Z, trim: !0 }),
          l &&
           (0, m.jsx)('div', {
    ...
    return (
     ...
     (0, a.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: b, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, a.jsx)(t.dn, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': b, style: l, children: o.map((e, l) => (0, a.jsxs)('span', { ...i({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
