 ...
 [34799],
 {
  ...
  17889(e, t, n) {
   ...
   const x = { color: m.A, dimension: j.A, fontFamilies: w.A, fontSizes: y.A, fontWeights: f.A, lineHeights: k.A, other: v.A, textDecoration: A.A },
    T = ({ type: e }) => (0, g.jsx)(u.In, { children: (0, b.createElement)(x[e]) });
   function C({ tokens: e }) {
    const t = (0, i.kD)(e),
     n = (0, i.GT)(t),
    ...
    return (0, g.jsxs)(g.Fragment, {
     children: [
      ...
      (0, g.jsxs)(o.e2, { children: [(0, g.jsx)(p, { content: c, language: 'json', children: 'Kopieer als JSON' }), (0, g.jsx)(p, { content: a, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => u, mJ: () => m, VZ: () => x, cR: () => b, Pv: () => j, qZ: () => o, kD: () => k, B2: () => g, Pc: () => c, f4: () => a, GT: () => v, fX: () => i, eQ: () => f, B_: () => y, o_: () => w, Rc: () => A });
