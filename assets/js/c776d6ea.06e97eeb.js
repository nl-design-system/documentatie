(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [65954],
 {
  ...
  84471(e, n, a) {
   'use strict';
   a.d(n, { bo: () => s, KF: () => m, mJ: () => p, VZ: () => D, cR: () => T, Pv: () => x, qZ: () => r, kD: () => j, QQ: () => H, B2: () => c, Pc: () => o, f4: () => l, GT: () => k, fX: () => i, eQ: () => v, B_: () => b, o_: () => f });
  ...
  94994(e, n, a) {
   'use strict';
   (a.r(n), a.d(n, { assets: () => m, component: () => x, contentTitle: () => u, default: () => v, description: () => h, frontMatter: () => g, issueNumber: () => p, metadata: () => t, title: () => c, toc: () => f }));
   ...
   const g = { title: 'Heading 4', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading 4', pagination_label: 'Heading 4', description: 'Koptekst die in de koppenstructuur op het vierde niveau staat.', issue_number: 260, slug: '/heading-4', keywords: ['caption', 'content', 'h4', 'heading', 'heading level', 'headline', 'kop', 'paginakop', 'sectie', 'section', 'structure', 'titel', 'title'] },
    ...
    m = {},
    c = 'Heading 4',
    h = 'Koptekst die in de koppenstructuur op het vierde niveau staat.',
    p = 260,
