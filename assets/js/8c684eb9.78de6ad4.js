 ...
 [44684],
 {
  ...
  70348(e, n, l) {
   ...
   const c = (0, t.forwardRef)(({ as: e, className: n, children: l, ...t }, s) => {
     ...
     return (0, a.jsx)(o, { ref: s, className: c, ...t, children: l });
    }),
    i = ({ className: e, classNamePanel: n, label: l, heading: t, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, a.jsxs)('details', { className: u, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(s.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [t && (0, a.jsx)(o.D, { level: c, appearance: i, children: t }), l] })] }) }), (0, a.jsx)('div', { className: m, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => x });
