 ...
 [1998],
 {
   ...
   const d = (0, a.createContext)({}),
    h = ({ title: e, appearance: n, description: l, children: a, figure: h }) => {
     const p = { do: 'Doen', dont: 'Niet doen' },
      m = h ? 'figure' : 'div',
      u = h ? 'figcaption' : 'div',
      b = 'string' == typeof l ? (0, c.jsx)(o.oz, { components: { a: r.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   const a = (0, t.forwardRef)(({ as: e, className: n, children: l, ...t }, r) => {
     ...
     return (0, o.jsx)(i, { ref: r, className: a, ...t, children: l });
    }),
    c = ({ className: e, classNamePanel: n, label: l, heading: t, headingLevel: a, headingApperance: c, ...d }) => {
     ...
     return (0, o.jsxs)('details', { className: h, ...d, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(r.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [t && (0, o.jsx)(i.D, { level: a, appearance: c, children: t }), l] })] }) }), (0, o.jsx)('div', { className: p, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => y });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const s = 'function' == typeof e ? e() : e,
        ...
        i = u().highlight(t, u().languages[n], n);
       return (0, g.jsxs)('div', { className: (0, r.A)('ma-canvas-astro', l), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: t } }), (0, g.jsx)(b.n, { children: (0, g.jsx)(b.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: i } }) }) }) })] });
      }
