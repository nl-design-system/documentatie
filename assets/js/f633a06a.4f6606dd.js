 ...
 [86429],
 {
  ...
  50341: (e, t, n) => {
   ...
   const _ = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(b, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(f, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
  ...
  75156: (e, t, n) => {
   ...
   const a = { title: 'Link List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link List', pagination_label: 'Link List', description: 'Een lijst met gerelateerde links naar andere pagina\u2019s of websites.', slug: '/link-list', keywords: ['anchor', 'externe link', 'external link', 'gerelateerde links', 'hyperlink', 'koppelingen lijst', 'lijst', 'link', 'link collection', 'link group', 'link lijst', 'linken', 'links', 'list', 'lijst met koppelingen', 'lijst met links', 'related links', 'related link list', 'url', 'url list'] },
    ...
    u = {},
    h = 'Link List',
    d = 'Een lijst met gerelateerde links naar andere pagina\u2019s of websites.',
    j = 264,
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => p, GT: () => b, KF: () => h, Pc: () => o, Pv: () => m, Rc: () => f, bo: () => r, eQ: () => k, f4: () => c, fX: () => i, kD: () => v, mJ: () => y, o_: () => g, qZ: () => s });
