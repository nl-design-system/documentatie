...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  3211(e, n, i) {
   (i.r(n), i.d(n, { assets: () => p, contentTitle: () => m, default: () => f, frontMatter: () => u, metadata: () => r, toc: () => k }));
   const r = JSON.parse('{"id":"wcag/1.3.01","title":"WCAG-succescriterium 1.3.1 Info en relaties","description":"Alle gebruikers moeten over dezelfde informatie kunnen beschikken.","source":"@site/docs/wcag/1.3.01.mdx","sourceDirName":"wcag","slug":"/wcag/1.3.1","permalink":"/wcag/1.3.1","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.3.01.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 1.3.1 Info en relaties","title_sm":"1.3.1 Info en relaties","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"1.3.1 Info en relaties","pagination_label":"WCAG-succescriterium 1.3.1 Info en relaties","description":"Alle gebruikers moeten over dezelfde informatie kunnen beschikken.","slug":"1.3.1","conformance_level":"Niveau A","keywords":["WCAG","A","waarneembaar","aanpasbaar","perceivable","adaptable","info and relationships"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 1.2.9 Louter-geluid (live)","permalink":"/wcag/1.2.9"},"next":{"title":"WCAG-succescriterium 1.3.2 Betekenisvolle volgorde","permalink":"/wcag/1.3.2"}}');
   var t = i(86070),
    l = i(18439),
    s = i(51582),
    o = i(66820),
   ...
   const u = { title: 'WCAG-succescriterium 1.3.1 Info en relaties', title_sm: '1.3.1 Info en relaties', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.1 Info en relaties', pagination_label: 'WCAG-succescriterium 1.3.1 Info en relaties', description: 'Alle gebruikers moeten over dezelfde informatie kunnen beschikken.', slug: '1.3.1', conformance_level: 'Niveau A', keywords: ['WCAG', 'A', 'waarneembaar', 'aanpasbaar', 'perceivable', 'adaptable', 'info and relationships'] },
    m = void 0,
    p = {},
   ...
   function v(e) {
    const n = { a: 'a', blockquote: 'blockquote', code: 'code', h2: 'h2', li: 'li', p: 'p', strong: 'strong', ul: 'ul', ...(0, l.R)(), ...e.components };
  ...
  51582(e, n, i) {
   ...
   const s = (e, n) => {
    ...
    a = (e) => ({ img: ({ src: n, ...i }) => (0, l.jsx)('img', { ...i, src: s(e, n), className: 'utrecht-img utrecht-img--fit' }) }),
    d = (e, n) => {
     if (e) {
      const e = { ...o[n - 1] };
      return ((e.h1 = () => null), e);
    ...
    c = ({ children: e, omitH1: n = !1, headingLevel: i = 1, baseUrl: t = '', components: s = {} }) => (0, l.jsx)(r.x, { components: { ...d(n, i), ...a(t), ...s }, children: e });
  },
  66820(e, n, i) {
   i.d(n, { E: () => s });
   var r = i(46447),
