...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [60574],
 {
  ...
  9261(e, n, t) {
   (t.r(n), t.d(n, { assets: () => g, component: () => j, componentName: () => f, contentTitle: () => c, default: () => b, description: () => h, frontMatter: () => d, issueNumber: () => p, metadata: () => a, relayStep: () => u, title: () => m, toc: () => x }));
   ...
   const d = { title: 'Dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Dialog', pagination_label: 'Dialog', description: 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina blijft mogelijk.', slug: '/dialog', keywords: ['dialog', 'dialoogvenster', 'floating window', 'modal', 'non modal dialog', 'non modal window', 'overlay', 'popup', 'venster', 'window'] },
    ...
    g = {},
    m = 'Dialog',
    h = 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina blijft mogelijk.',
    p = 181,
    u = 'help wanted',
    f = 'dialog',
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => m, mJ: () => u, VZ: () => D, cR: () => w, Pv: () => f, qZ: () => r, kD: () => b, B2: () => h, Pc: () => l, f4: () => s, GT: () => k, fX: () => o, eQ: () => v, B_: () => x, o_: () => j, Rc: () => _ });
