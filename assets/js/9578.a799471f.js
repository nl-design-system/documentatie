...
exports.modules = {
 ...
 /***/ 69578: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  const FormToggle = class {
   ...
   render() {
    ...
    return (0, _index_593361c2_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { key: '5fab336353956969278692ab16d49b4670219d7d', class: (0, _clsx_eca3fadc_js__WEBPACK_IMPORTED_MODULE_1__.c)('utrecht-form-toggle', checked && 'utrecht-form-toggle--checked', !checked && 'utrecht-form-toggle--not-checked', disabled && 'utrecht-form-toggle--disabled'), tabIndex: disabled ? null : 0, role: 'switch', 'aria-disabled': disabled ? 'true' : null, onClick: handleClick, onKeyPress: handleKeyPress, onKeyUp: handleKeyUp }, (0, _index_593361c2_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { key: '42ee41122748db652c5d4b8d9b581e3b062f67f8', class: 'utrecht-form-toggle__label utrecht-form-toggle__label--off' }), (0, _index_593361c2_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { key: 'e2f61213f75785fceb109d7aa6e5f8e858082100', class: 'utrecht-form-toggle__label utrecht-form-toggle__label--on' }), (0, _index_593361c2_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { key: 'f9924fd642a74914f8a5ad028c71253fd6aae559', class: (0, _clsx_eca3fadc_js__WEBPACK_IMPORTED_MODULE_1__.c)('utrecht-form-toggle__track', checked && 'utrecht-form-toggle__track--checked', !checked && 'utrecht-form-toggle__track--not-checked', disabled && 'utrecht-form-toggle__track--disabled') }, (0, _index_593361c2_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { key: '97b4e2262123e0749147b9b196fbb1ee19003415', class: (0, _clsx_eca3fadc_js__WEBPACK_IMPORTED_MODULE_1__.c)('utrecht-form-toggle__thumb', checked && 'utrecht-form-toggle__thumb--checked', !checked && 'utrecht-form-toggle__thumb--not-checked', disabled && 'utrecht-form-toggle__thumb--disabled') })));
   }
  };
