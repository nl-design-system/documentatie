 ...
 [53087],
 {
  ...
  17889(e, n, t) {
   ...
   const A = { color: j.A, dimension: m.A, fontFamilies: k.A, fontSizes: x.A, fontWeights: v.A, lineHeights: f.A, other: b.A, textDecoration: y.A },
    D = ({ type: e }) => (0, g.jsx)(p.In, { children: (0, w.createElement)(A[e]) });
   function N({ tokens: e }) {
    const n = (0, r.kD)(e),
     t = (0, r.GT)(n),
       ...
       children: [
        ...
        (0, g.jsx)(a.BF, {
         children: t.map((n) => {
          const t = (0, r.o_)(n),
           o = (0, r.eQ)(e, n).$type;
          return (0, g.jsxs)(a.Hj, { children: [(0, g.jsx)(a.nA, { children: (0, g.jsx)(i.C, { children: (0, g.jsx)(a.kf, { children: t }) }) }), (0, g.jsx)(a.nA, { children: (0, g.jsxs)(s.K, { children: [(0, g.jsx)(D, { type: o }), ' ', o] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  80545(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => C, component: () => F, contentTitle: () => L, default: () => V, description: () => R, frontMatter: () => z, issueNumber: () => M, metadata: () => i, title: () => H, toc: () => G }));
