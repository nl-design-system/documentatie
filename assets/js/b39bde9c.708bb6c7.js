...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [4962],
 {
  ...
  57229: (e, n, r) => {
   ...
   const o = (e) => {
    let { className: n, ...r } = e;
    return (0, t.jsx)(i.Z, { className: (0, l.W)('utrecht-link', 'utrecht-link--html-a', n), ...r });
   };
  },
  21004: (e, n, r) => {
   r.d(n, { l: () => c });
  ...
  39772: (e, n, r) => {
   ...
   function c(e) {
    ...
    return (0, s.jsxs)('div', { className: 'card', children: [n ? (0, s.jsx)(l.r, { href: n, className: (0, o.Z)('cardLink', 'utrecht-link'), children: (0, s.jsxs)('h2', { className: 'cardTitle', children: [r, ' ', i] }) }) : (0, s.jsxs)('h2', { className: 'cardTitle', children: [r, ' ', i] }), t && (0, s.jsx)('p', { className: 'cardDescription', children: t }), c] });
   }
   function a(e) {
    let { item: n } = e;
    return (0, s.jsx)(c, { title: n.label, description: n.description, children: (0, s.jsx)(t.QI, { children: n.items.filter((e) => 'link' === e.type || 'category' === e.type).map((e, n) => (0, s.jsx)(t.AS, { children: 'link' === e.type ? (0, s.jsx)(l.r, { to: e.href, children: e.label }) : 'category' === e.type ? (0, s.jsxs)(l.r, { to: e.href, children: [e.items.length, " pagina's voor ", e.label] }) : (0, s.jsx)(s.Fragment, {}) }, n)) }) });
   }
   function d(e) {
    let { item: n } = e;
