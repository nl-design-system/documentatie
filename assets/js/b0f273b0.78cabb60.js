 ...
 [17393],
 {
  69461: (e, t, n) => {
   ...
   const o = { title: 'Form Summary', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Summary', pagination_label: 'Form Summary', description: 'Overzicht van ingevoerde data in een formulier.', slug: '/form-summary', keywords: ['antwoordlijst', 'conclusion', 'contents list', 'form summary', 'grouped list', 'lijst', 'list', 'overview', 'overzicht', 'samenvatting', 'summary', 'summary data', 'summary list', 'verzameling'] },
    ...
    d = 'Form Summary',
    j = 'Overzicht van ingevoerde data in een formulier.',
    m = 185,
          ...
          children: [
           (0, l.jsx)(f, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(k, { headingLevel: n + 1, checked: t, title: r, description: (0, x.Q6)(i) }, i);
            }),
           }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => g, BA: () => o, Ee: () => l, Q6: () => c, U: () => j, Yr: () => p, d: () => h, e9: () => s, fO: () => b, mA: () => i, ps: () => m, qU: () => f, s0: () => v, zP: () => y });
