 ...
 [31328],
 {
  29334: (e, n, t) => {
   ...
   const o = { title: "Form field option label", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Form field option label", pagination_label: "Form field option label", description: "UX richtlijnen voor Form field option label component", slug: "/form-field-option-label", tags: ["Help Wanted"] },
    ...
    s = { id: "componenten/build/form-field-option-label", title: "Form field option label", description: "UX richtlijnen voor Form field option label component", source: "@site/docs/componenten/build/form-field-option-label.mdx", sourceDirName: "componenten/build", slug: "/form-field-option-label", permalink: "/form-field-option-label", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/form-field-option-label.mdx", tags: [{ label: "Help Wanted", permalink: "/tags/help-wanted" }], version: "current", frontMatter: { title: "Form field option label", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Form field option label", pagination_label: "Form field option label", description: "UX richtlijnen voor Form field option label component", slug: "/form-field-option-label", tags: ["Help Wanted"] }, sidebar: "componenten", previous: { title: "Form field label", permalink: "/form-field-label" }, next: { title: "Form field partial label", permalink: "/form-field-partial-label" } },
    d = {},
    r = [
