 ...
 [50186],
 {
  ...
  6726(e, n, t) {
   ...
   var s = t(86070),
    ...
    g = t(24658),
    p = t(51130);
   const h = { title: 'Program', lang: 'en', description: 'Program for the Design Systems Week 2026 organised by NL Design System', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Program', pagination_label: 'Design Systems Week 2026', sidebar_position: 2, slug: '/events/design-systems-week-2026/en/program', translations: { nl: '/events/design-systems-week-2026/programma/' }, image: 'https://raw.githubusercontent.com/nl-design-system/documentatie/assets/community-design-systems-week-en-2026.png', image_alt: 'NL Design System Design Systems Week 2026 26-29 October, online' },
    u = 'Design Systems Week settings.year',
    b = {},
    k = [];
   function y(e) {
    const n = { h1: 'h1', header: 'header', p: 'p', ...(0, i.R)(), ...e.components };
    return (0, s.jsxs)('div', { lang: 'en', children: [(0, s.jsx)(n.header, { children: (0, s.jsxs)(n.h1, { id: 'design-systems-week-settingsyear', children: ['Design Systems Week ', p.Ok] }) }), (0, s.jsx)(l.f, { purpose: 'lead', children: (0, s.jsxs)(n.p, { children: ['NL Design System is organising the Design Systems Week for the fifth time. It will feature a number of short talks\nabout the how and why of design systems. All online. From ', p.en.M, ', we will cover subjects like\nmanaging design systems, integrating accessibility, user research and code.'] }) }), (0, s.jsxs)(o.K, { children: [(0, s.jsxs)(r.v, { href: `/events/design-systems-week-${p.Ok}/en/timetable`, appearance: 'primary-action', children: ['View the timetable', (0, s.jsx)(d.A, { slot: 'icon-end' })] }), !!p.MX && (0, s.jsxs)(r.v, { href: p.MX, appearance: 'secondary-action', children: ['Use Miro', (0, s.jsx)(d.A, { slot: 'icon-end' })] })] }), !p.Ic && (0, s.jsx)(s.Fragment, { children: (0, s.jsx)(l.f, { children: 'The timetable is not yet final. The sessions will be further developed and added in the coming weeks. Keep an eye on this page for updates.' }) }), (0, s.jsxs)(g.H, { allSpeakers: m, allSessions: c, sessionId: '1bfd50e8-d845-492b-9553-51cae7dafd5b', headingLevel: 2, lang: 'en', children: [(0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'Accessibility conformance is often documented in separate reports that quickly become outdated. But what if\naccessibility data lived alongside your code instead?' }) }), (0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'In this session, you\u2019ll discover how the open-source publishing platform Janeway rethought its accessibility process\nby integrating conformance data directly into its code-base. Every accessibility finding is linked to the commit it\nwas audited against cross referenced with the work needed to improve it. This underpins a continuous workflow of\ntargeted accessibility audits and improvements instead of relying on audits every few years.' }) }), (0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'Steph shares the motivation behind this approach, how it was implemented, and the lessons learned along the way.\nWhether you\u2019re a developer, accessibility specialist, or simply curious about improving accessibility workflows,\nthis session offers practical insights into a more sustainable way of managing conformance data.' }) }), (0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'The implementation is open source, making it easy to dive into the technical details after the session.' }) })] }), (0, s.jsxs)(g.H, { allSpeakers: m, allSessions: c, sessionId: 'a23217db-b17d-4e97-ad46-1fd7d113c567', headingLevel: 2, lang: 'en', children: [(0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: "What happens when you replace your own design system with a new, shared standard? How do you make sure accessibility\ndoesn't take a step backwards?" }) }), (0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'In this session, Marion Couesnon from the Access to Justice team shares their experience of migrating from their\nin-house design system to the KERN Design System, which they see as the future standard for German public services.' }) }), (0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: "You'll learn how the team approached the migration from an accessibility perspective, the checks and decisions they\nmade along the way, and the unexpected challenges they still encountered. Because even when a design system is built\nwith accessibility in mind, adopting it doesn't automatically guarantee an accessible result." }) }), (0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'A practical session packed with lessons learned, pitfalls to avoid, and tips for teams planning a similar\ntransition.' }) })] }), (0, s.jsxs)(g.H, { allSpeakers: m, allSessions: c, sessionId: '5c426f34-76eb-44c3-a951-277b49e6b442', headingLevel: 2, lang: 'en', children: [(0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'What if you could build exactly the design tools your team needs, instead of adapting your workflow to the tools\navailable?' }) }), (0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'Creating custom design tooling has become easier than ever. Instead of relying solely on generic plugins and\nframeworks, teams can now build small, purpose-made tools that address the specific needs of their projects and\ndesign systems.' }) }), (0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'In this session, Javier Cuello shares practical examples of how he has been creating and using custom mini plugins\nand design tools to solve problems that previously seemed difficult to tackle. He\u2019ll show what\u2019s possible, where\nthese tools can add value, and how they can improve everyday design workflows.' }) }), (0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'A practical and inspiring session for designers who want to rethink their tooling, with plenty of useful insights\nfor developers too.' }) })] }), (0, s.jsxs)(g.H, { allSpeakers: m, allSessions: c, sessionId: 'aec41135-5d58-404d-a427-47dcb6730b20', headingLevel: 2, lang: 'en', children: [(0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'Design systems often solve many of the same problems, over and over again. What if we could share the universal\nparts? What if sharing could not hinder, but enable uniqueness and identity. This talk covers the Norwegian project\n"Designsystemet" and its approach to building a framework agnostic, design agnostic, open-source toolkit to enable\nyour design system.' }) }), (0, s.jsx)(l.f, { children: (0, s.jsx)(n.p, { children: 'We also take a deep dive into how prioritising native HTML, CSS and browser behaviour makes components more\npredictable, flexible and composable, and challenge what parts of a design system you actually need to own and\nmaintain yourself.' }) })] })] });
   }
   function f(e = {}) {
  ...
  18652(e, n, t) {
   ...
   const i = (e, n, t, i) => {
    const r = (0, a.forwardRef)(({ color: t = 'currentColor', size: r = 24, stroke: o = 2, title: l, className: d, children: c, ...m }, g) => (0, a.createElement)('svg', { ref: g, ...s[e], width: r, height: r, className: ['tabler-icon', `tabler-icon-${n}`, d].join(' '), ...('filled' === e ? { fill: t } : { strokeWidth: o, stroke: t }), ...m }, [l && (0, a.createElement)('title', { key: 'svg-title' }, l), ...i.map(([e, n]) => (0, a.createElement)(e, n)), ...(Array.isArray(c) ? c : [c])]));
  ...
  20201(e, n, t) {
   ...
   const o = s.forwardRef(function (e, n) {
    const [t, o] = s.useState(!1),
     ...
     y = s.useMemo(() => (e.playlist ? `${k}/embed/videoseries?${b.toString()}` : `${k}/embed/${c}?${b.toString()}`), [e.playlist, k, c, b]),
     ...
     j = f
      ...
      : null,
     x = s.useMemo(() => e.thumbnail || j || `https://i.ytimg.com/${v}/${e.playlist ? m : c}/${p}.${w}`, [e.thumbnail, j, v, e.playlist, m, c, p, w]),
    ...
    return (
     ...
     (0, a.jsxs)(a.Fragment, {
      children: [
       !e.lazyLoad && (0, a.jsx)('link', { rel: O, href: x, as: 'image' }),
       (0, a.jsx)(a.Fragment, { children: t && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)('link', { rel: 'preconnect', href: k }), (0, a.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), D && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, a.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
       e.seo && !e.playlist && (0, a.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: r(e.id, g, x, k, e.seo) } }),
       ...
       (0, a.jsxs)(L, {
        ...
        style: { ...(!e.lazyLoad && { backgroundImage: `url(${x})` }), '--aspect-ratio': (A / N) * 100 + '%', ...(e.style || {}) },
        children: [e.lazyLoad && !l && (0, a.jsx)('img', { src: x, alt: `${g} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !l && (0, a.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && l) && (0, a.jsx)('button', { type: 'button', className: M, 'aria-label': `${h} ${g}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, onClick: P, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: h }) }), l && (0, a.jsx)('iframe', { ref: n, className: T, title: g, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: y, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  24456(e, n, t) {
   ...
   const r = ({ children: e, ...n }) => {
    ...
    o = ({ className: e, boxContent: n, ...t }) => (0, i.jsx)(r, { className: (0, a.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  24658(e, n, t) {
   t.d(n, { H: () => d });
   var a = t(90578),
   ...
   const l = new Date().toISOString(),
    d = ({ lang: e = 'nl', headingLevel: n = 3, allSpeakers: t, videoId: d, children: c, allSessions: m, sessionId: g }) => {
     const p = m?.find(({ uuid: e }) => g === e),
      h = p && p.speakers.map((e) => t[e]).filter(Boolean),
      u = [d, p?.videoId, ...(p?.videoIds ?? [])].filter(Boolean);
     return p ? (0, o.jsxs)('article', { className: (0, i.A)('ma-dsw-session'), children: [(0, o.jsx)(s.DZ, { level: n, className: 'ma-dsw-session__title', id: p.subject.toLowerCase().replace(/\s/gi, '-'), children: p.subject }), (0, o.jsx)(s.fz, { className: 'ma-dsw-session__subtitle', lead: !0, children: h && h.map((e) => (e?.organisation ? `${e.name} - ${e.organisation}` : e.name)).join(' & ') }), u.length > 0 && u.map((e) => (0, o.jsx)(r.L, { id: e, title: p.subject, style: { marginBlock: '20px' } }, e)), p && p.isoDateTime && p.isoDateTime > l ? (0, o.jsx)(s.fz, { children: (0, o.jsx)('time', { dateTime: p.isoDateTime, children: new Intl.DateTimeFormat(e, { dateStyle: 'full', timeStyle: 'nl' === e ? 'short' : 'full', timeZone: 'Europe/Amsterdam' }).format(new Date(p.isoDateTime)) }) }) : (0, o.jsx)(o.Fragment, {}), c, 'nl' === e && h.find(({ language: e }) => 'nl' !== e) && (0, o.jsxs)(s.fz, { children: [(0, o.jsx)('b', { children: 'Goed te weten:' }), ' Deze sessie is in het Engels.'] }), p.captioned ? (p.captionId ? (0, o.jsx)(o.Fragment, { children: (0, o.jsxs)(s.fz, { children: ['nl' === e ? (0, o.jsx)(o.Fragment, { children: (0, o.jsx)('b', { children: 'Bij deze sessie is een schrijftolk aanwezig: ' }) }) : (0, o.jsx)(o.Fragment, { children: (0, o.jsx)('b', { children: 'Live captioning is available for this session: ' }) }), (0, o.jsxs)('a', { href: `https://text-on-tap.live/#e=${p.captionId}`, children: [(0, o.jsxs)('span', { className: 'sr-only', children: [p.subject, ' '] }), 'nl' === e ? 'in de browser' : 'in the browser'] }), 'nl' === e ? ' of ' : ' or ', (0, o.jsxs)('a', { href: `https://text-on-tap.live/openoverlay.html?e=${p.captionId}`, children: [(0, o.jsxs)('span', { className: 'sr-only', children: [p.subject, ' '] }), 'nl' === e ? 'met de Overlay tool' : 'with the de Overlay tool'] })] }) }) : 'nl' === e ? (0, o.jsx)(s.fz, { children: 'Voor deze sessie hebben we nog geen schrijftolk gevonden' }) : (0, o.jsx)(o.Fragment, {})) : (0, o.jsx)(o.Fragment, {}), (0, o.jsx)('aside', { className: (0, i.A)('ma-dsw-session__speakers'), children: h.map((n, t) => (0, o.jsxs)('div', { className: (0, i.A)('ma-dsw-session__speaker', 'ma-dsw-speaker'), children: [(0, o.jsx)('img', { className: (0, i.A)('ma-dsw-speaker__image'), src: n.image.src, alt: n.image.alt }), (0, o.jsx)(s.fz, { className: (0, i.A)('ma-dsw-speaker__description'), dangerouslySetInnerHTML: { __html: n.description[e] } })] }, t)) }), p && p.icalLink && !d ? (0, o.jsx)(s.fz, { children: (0, o.jsxs)(s.vx, { href: p.icalLink, download: p.icalLink, appearance: 'primary-action-button', children: [(0, o.jsx)(s.In, { children: (0, o.jsx)(a.A, {}) }), (0, o.jsx)('span', { children: 'nl' === e ? (0, o.jsxs)(o.Fragment, { children: ['Zet', (0, o.jsx)('span', { className: 'sr-only', children: p.subject }), ' in je agenda'] }) : (0, o.jsxs)(o.Fragment, { children: ['Add', (0, o.jsx)('span', { className: 'sr-only', children: p.subject }), ' to your calendar'] }) })] }) }) : null] }) : (0, o.jsx)(o.Fragment, {});
    };
  },
  29680(e, n, t) {
   t.d(n, { v: () => o });
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => s, KF: () => g, mJ: () => u, VZ: () => x, cR: () => j, Pv: () => b, qZ: () => r, kD: () => w, QQ: () => D, B2: () => p, Pc: () => l, f4: () => o, GT: () => v, fX: () => i, eQ: () => f, B_: () => y, o_: () => k });
