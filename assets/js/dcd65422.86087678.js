  ...
  75397(e, t, n) {
   ...
   const r = a.forwardRef(function (e, t) {
     const [n, r] = a.useState(!1),
      ...
      w = !e.thumbnail && !e.playlist && 'maxresdefault' === m,
      v = e.webp ? 'webp' : 'jpg',
      k = e.webp ? 'vi_webp' : 'vi',
      x = w
       ...
       : null,
      j = a.useMemo(() => e.thumbnail || x || `https://i.ytimg.com/${k}/${e.playlist ? p : c}/${m}.${v}`, [e.thumbnail, x, k, e.playlist, p, c, m, v]),
