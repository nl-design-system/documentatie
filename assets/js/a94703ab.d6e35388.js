  ...
  73611: (e, t, n) => {
   ...
   function E(e) {
    ...
    const { items: u, label: h, collapsible: b, className: p, href: x } = t,
     ...
     { expandedItem: y, setExpandedItem: A } = (function () {
     ...
     (0, m.jsxs)('li', {
      ...
      children: [
       (0, m.jsxs)('div', {
        ...
        children: [
         g ? h : (0, m.jsx)(T.Z, { className: (0, i.Z)('menu__link', 'utrecht-link', { 'menu__link--sublist': b, 'menu__link--sublist-caret': !x && b }), href: b ? (k ?? '#') : k, ...d, children: h }),
         x &&
          b &&
          (0, m.jsx)(B, {
           categoryLabel: h,
       ...
       (0, m.jsx)(Z.z, { lazy: !0, as: 'ul', className: 'menu__list', collapsed: f, children: (0, m.jsx)(D, { items: u, tabIndex: f ? -1 : 0, onItemClick: n, activePath: o, level: l + 1 }) }),
      ],
     })
    );
   }
   ...
   function W(e) {
    ...
    const { href: d, label: u, className: h, autoAddBaseUrl: b } = t,
     p = (0, r._F)(t, a),
     x = (0, F.Z)(d);
    return (0, m.jsx)('li', { className: (0, i.Z)(s.k.docs.docSidebarItemLink, s.k.docs.docSidebarItemLinkLevel(o), 'menu__list-item', h), children: (0, m.jsxs)(T.Z, { className: (0, i.Z)('menu__link', !x && 'menuExternalLink', { 'menu__link--active': p }, 'utrecht-link'), autoAddBaseUrl: b, 'aria-current': p ? 'page' : void 0, to: d, ...(x && { onClick: n ? () => n(t) : void 0 }), ...c, children: [u, !x && (0, m.jsx)(R.Z, {})] }) }, u);
   }
   function P(e) {
    let { item: t, ...n } = e;
    switch (t.type) {
   ...
   function V(e) {
    let { items: t, ...n } = e;
    return (0, m.jsx)(y, { children: t.map((e, t) => (0, m.jsx)(P, { item: e, index: t, ...n }, t)) });
   }
   const D = (0, a.memo)(V);
   function z(e) {
   ...
   function G(e) {
    ...
    const {
     ...
     c = (0, a.useId)();
    return (0, m.jsxs)('div', { className: (0, i.Z)('sidebar', r && 'sidebarWithHideableNavbar', s && 'sidebarHidden', l && 'sidebarWithNavbar'), children: [(0, m.jsx)(L.zx, { appearance: 'subtle-button', onClick: o, className: (0, i.Z)('sidebar__toggle-button', s && 'sidebar__toggle-button--icon-only'), 'aria-controls': c, 'aria-label': s ? 'Toon sidebar' : 'Verberg sidebar', 'aria-expanded': !s, children: s ? (0, m.jsx)(m.Fragment, { children: (0, m.jsx)(f, {}) }) : (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(_, {}), ' Verberg'] }) }), (0, m.jsx)('div', { id: c, 'aria-expanded': !s, className: (0, i.Z)('sidebar__content', s && 'sidebar__content--hidden'), children: (0, m.jsx)(z, { path: t, sidebar: n }) })] });
   }
   const O = a.memo(G);
   var U = n(27132),
    Y = n(25596);
   ...
   function K(e) {
    return (0, m.jsx)(U.Zo, { component: J, props: e });
   }
   const q = a.memo(K);
   function Q(e) {
    const t = (0, g.i)(),
     n = 'desktop' === t || 'ssr' === t,
     a = 'mobile' === t;
    return (0, m.jsxs)(m.Fragment, { children: [n && (0, m.jsx)(O, { ...e }), a && (0, m.jsx)(q, { ...e })] });
   }
   function X(e) {
   ...
   const $ = { expandButton: 'expandButton_inbk', expandButtonIcon: 'expandButtonIcon_OBA1' };
   function ee(e) {
   ...
   const te = { docSidebarContainer: 'docSidebarContainer_Kl_C', docSidebarContainerHidden: 'docSidebarContainerHidden_wpMJ', sidebarViewport: 'sidebarViewport_Av1C' };
   function ne(e) {
    let { children: t } = e;
    const n = (0, l.V)();
   ...
   const ie = { docMainContainer: 'docMainContainer_I8lA', docMainContainerEnhanced: 'docMainContainerEnhanced_Do6G', docItemWrapperEnhanced: 'docItemWrapperEnhanced_MZ3t' };
   function oe(e) {
   ...
   const se = { docRoot: 'docRoot_uhSi', docsWrapper: 'docsWrapper_GG9F' };
   function re(e) {
    let { children: t } = e;
    const n = (0, l.V)(),
     [i, o] = (0, a.useState)(!1);
