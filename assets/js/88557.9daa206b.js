...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [88557],
 {
  88557: (t, e, n) => {
   ...
   for (const q in r) Object.hasOwn(r, q) && (o[r[q]] = q);
   const a = { to: {}, get: {} };
   function s(t, e, n) {
   ...
   (a.get = function (t) {
    ...
    (a.get.rgb = function (t) {
     ...
     if ((e = t.match(/^#([a-f\d]{6})([a-f\d]{2})?$/i))) {
      ...
      for (n = 0; n < 3; n++) a[n] = Number.parseInt(e[n + 1], 10);
      e[4] && (a[3] = e[5] ? 0.01 * Number.parseFloat(e[4]) : Number.parseFloat(e[4]));
     } else {
      if (!(e = t.match(/^rgba?\(\s*([+-]?[\d.]+)%\s*,?\s*([+-]?[\d.]+)%\s*,?\s*([+-]?[\d.]+)%\s*(?:[,|/]\s*([+-]?[\d.]+)(%?)\s*)?\)$/))) return (e = t.match(/^(\w+)$/)) ? ('transparent' === e[1] ? [0, 0, 0, 0] : Object.hasOwn(r, e[1]) ? ((a = r[e[1]]), (a[3] = 1), a) : null) : null;
    ...
    (a.get.hwb = function (t) {
     if (!t) return null;
     const e = t.match(/^hwb\(\s*([+-]?\d{0,3}(?:\.\d+)?)(?:deg)?\s*,\s*([+-]?[\d.]+)%\s*,\s*([+-]?[\d.]+)%\s*(?:,\s*([+-]?(?=\.\d|\d)(?:0|[1-9]\d*)?(?:\.\d*)?(?:[eE][+-]?\d+)?)\s*)?\)$/);
     if (e) {
      const t = Number.parseFloat(e[4]);
      return [((Number.parseFloat(e[1]) % 360) + 360) % 360, s(Number.parseFloat(e[2]), 0, 100), s(Number.parseFloat(e[3]), 0, 100), s(Number.isNaN(t) ? 1 : t, 0, 1)];
     }
   ...
   const c = a,
    i = {};
   for (const q of Object.keys(r)) i[r[q]] = q;
   ...
   for (const q of Object.keys(h)) {
    if (!('channels' in h[q])) throw new Error('missing channels property: ' + q);
    if (!('labels' in h[q])) throw new Error('missing channel labels property: ' + q);
    if (h[q].labels.length !== h[q].channels) throw new Error('channel and label counts mismatch: ' + q);
    const { channels: t, labels: e } = h[q];
    delete h[q].channels, delete h[q].labels, Object.defineProperty(h[q], 'channels', { value: t }), Object.defineProperty(h[q], 'labels', { value: e });
   }
   function g(t) {
    const e = (function () {
      const t = {},
   ...
   function d(t, e) {
    ...
    let r = u[e[t].parent][t],
     o = e[t].parent;
    for (; e[o].parent; ) n.unshift(e[o].parent), (r = f(u[e[o].parent][o], r)), (o = e[o].parent);
   ...
   (h.rgb.hsl = function (t) {
    ...
    (h.rgb.keyword = function (t) {
     ...
     for (const l of Object.keys(r)) {
      const e = ((s = r[l]), ((a = t)[0] - s[0]) ** 2 + (a[1] - s[1]) ** 2 + (a[2] - s[2]) ** 2);
      e < o && ((o = e), (n = l));
     }
     var a, s;
     return n;
    ...
    (h.xyz.rgb = function (t) {
     const e = t[0] / 100,
      ...
      r = t[2] / 100;
     let o, a, s;
     return (o = 3.2404542 * e + -1.5371385 * n + -0.4985314 * r), (a = -0.969266 * e + 1.8760108 * n + 0.041556 * r), (s = 0.0556434 * e + -0.2040259 * n + 1.0572252 * r), (o = o > 0.0031308 ? 1.055 * o ** (1 / 2.4) - 0.055 : 12.92 * o), (a = a > 0.0031308 ? 1.055 * a ** (1 / 2.4) - 0.055 : 12.92 * a), (s = s > 0.0031308 ? 1.055 * s ** (1 / 2.4) - 0.055 : 12.92 * s), (o = Math.min(Math.max(0, o), 1)), (a = Math.min(Math.max(0, a), 1)), (s = Math.min(Math.max(0, s), 1)), [255 * o, 255 * a, 255 * s];
    }),
   ...
   for (const q of y) {
    (p[q] = {}), Object.defineProperty(p[q], 'channels', { value: u[q].channels }), Object.defineProperty(p[q], 'labels', { value: u[q].labels });
    const t = m(q),
     e = Object.keys(t);
    for (const n of e) {
     const e = t[n];
     (p[q][n] = k(e)), (p[q][n].raw = w(e));
    }
   }
   const v = p,
    M = ['keyword', 'gray', 'hex'],
    x = {};
   for (const q of Object.keys(v)) x[[...v[q].labels].sort().join('')] = q;
   const N = {};
   function j(t, e) {
    if (!(this instanceof j)) return new j(t, e);
    if ((e && e in M && (e = null), e && !(e in v))) throw new Error('Unknown model: ' + e);
    let n, r;
    if (null == t) (this.model = 'rgb'), (this.color = [0, 0, 0]), (this.valpha = 1);
    else if (t instanceof j) (this.model = t.model), (this.color = [...t.color]), (this.valpha = t.valpha);
    else if ('string' == typeof t) {
     const e = c.get(t);
     if (null === e) throw new Error('Unable to parse color from string: ' + t);
     (this.model = e.model), (r = v[this.model].channels), (this.color = e.value.slice(0, r)), (this.valpha = 'number' == typeof e.value[r] ? e.value[r] : 1);
    } else if (t.length > 0) {
     (this.model = e || 'rgb'), (r = v[this.model].channels);
     const n = Array.prototype.slice.call(t, 0, r);
     (this.color = I(n, r)), (this.valpha = 'number' == typeof t[r] ? t[r] : 1);
     ...
     const r = e.sort().join('');
     if (!(r in x)) throw new Error('Unable to parse color from object: ' + JSON.stringify(t));
     this.model = x[r];
     const { labels: o } = v[this.model],
      a = [];
     for (n = 0; n < o.length; n++) a.push(t[o[n]]);
     this.color = I(a);
    }
    if (N[this.model])
     for (r = v[this.model].channels, n = 0; n < r; n++) {
      const t = N[this.model][n];
   ...
   j.prototype = {
    ...
    object() {
     const t = {},
      { channels: e } = v[this.model],
      { labels: n } = v[this.model];
    ...
    round(t) {
     return (t = Math.max(t || 0, 0)), new j([...this.color.map(O(t)), this.valpha], this.model);
    },
    alpha(t) {
     return void 0 !== t ? new j([...this.color, Math.max(0, Math.min(1, t))], this.model) : this.valpha;
    },
    red: F('rgb', 0, z(255)),
    green: F('rgb', 1, z(255)),
    blue: F('rgb', 2, z(255)),
    hue: F(['hsl', 'hsv', 'hsl', 'hwb', 'hcg'], 0, (t) => ((t % 360) + 360) % 360),
    saturationl: F('hsl', 1, z(100)),
    lightness: F('hsl', 2, z(100)),
    saturationv: F('hsv', 1, z(100)),
    value: F('hsv', 2, z(100)),
    chroma: F('hcg', 1, z(100)),
    gray: F('hcg', 2, z(100)),
    white: F('hwb', 1, z(100)),
    wblack: F('hwb', 2, z(100)),
    cyan: F('cmyk', 0, z(100)),
    magenta: F('cmyk', 1, z(100)),
    yellow: F('cmyk', 2, z(100)),
    black: F('cmyk', 3, z(100)),
    x: F('xyz', 0, z(95.047)),
    y: F('xyz', 1, z(100)),
    z: F('xyz', 2, z(108.833)),
    l: F('lab', 0, z(100)),
    ...
    b: F('lab', 2),
    keyword(t) {
     return void 0 !== t ? new j(t) : v[this.model].keyword(this.color);
    },
    hex(t) {
     return void 0 !== t ? new j(t) : c.to.hex(...this.rgb().round().color);
    },
    hexa(t) {
     if (void 0 !== t) return new j(t);
    ...
    mix(t, e) {
     ...
     const n = t.rgb(),
      ...
      c = 1 - l;
     return j.rgb(l * n.red() + c * r.red(), l * n.green() + c * r.green(), l * n.blue() + c * r.blue(), n.alpha() * o + r.alpha() * (1 - o));
    },
   };
   for (const q of Object.keys(v)) {
    if (M.includes(q)) continue;
    const { channels: t } = v[q];
    (j.prototype[q] = function (...t) {
     return this.model === q ? new j(this) : t.length > 0 ? new j(t, q) : new j([...((e = v[this.model][q].raw(this.color)), Array.isArray(e) ? e : [e]), this.valpha], q);
     var e;
    }),
     (j[q] = function (...e) {
      let n = e[0];
      return 'number' == typeof n && (n = I(e, t)), new j(n, q);
     });
   }
   function O(t) {
    return function (e) {
