 ...
 [94318],
 {
  18127(e, n, l) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: g = !0, children: x, container: v = 'document', language: k, designTokens: f }) => {
    ...
    let R = u.Fragment;
    return (
     'paragraph' === v ? (R = p) : 'document' === v ? (R = j) : 'surface' === v && (R = b),
     (0, m.jsxs)('div', {
      className: (0, s.A)('nlds-canvas'),
      children: [
       y && (0, m.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(R, { children: (0, m.jsx)(o.v$, { children: y }) }) }) }),
       g &&
        (0, m.jsx)('div', {
