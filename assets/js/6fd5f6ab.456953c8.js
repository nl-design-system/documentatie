(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [72755],
 {
  ...
  63100: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => M, component: () => O, contentTitle: () => S, default: () => U, description: () => P, frontMatter: () => _, issueNumber: () => V, metadata: () => D, title: () => H, toc: () => F });
   var r,
    i,
    s,
    o,
   ...
   function E(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      '\n',
      (0, d.jsx)(z.U, { omitH1: !0, headingLevel: 3, children: (0, d.jsx)(Z, {}) }),
      '\n',
  ...
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, BA: () => c, Ee: () => d, Q6: () => s, U: () => m, d: () => h, e9: () => o, mA: () => i, ps: () => g });
