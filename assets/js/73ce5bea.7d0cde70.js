/*! For license information please see 73ce5bea.7d0cde70.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [63390],
 {
  13076(e, n, i) {
   (i.r(n), i.d(n, { assets: () => m, contentTitle: () => u, default: () => j, frontMatter: () => c, metadata: () => t, toc: () => h }));
  ...
  19472(e, n, i) {
   ...
   var t = i(20201),
    s = i(86070);
   const o = ({ id: e, title: n, ...i }) => (0, s.jsx)(t.Ay, { lazyLoad: !0, adNetwork: !1, announce: 'Bekijk', cookie: !1, containerElement: 'div', id: e, title: n, poster: 'maxresdefault', ...i });
  },
  20201(e, n, i) {
   i.d(n, { Ay: () => a });
   var t = i(86070),
   ...
   const a = s.forwardRef(function (e, n) {
    const [i, a] = s.useState(!1),
     ...
     g = s.useMemo(() => {
      const n = new URLSearchParams({ ...(e.muted ? { mute: '1' } : {}), ...(j ? { autoplay: '1' } : {}), ...(e.enableJsApi ? { enablejsapi: '1' } : {}), ...(e.enableJsApi && typeof window < 'u' ? { origin: window.location.origin } : {}), ...(e.playlist ? { list: c } : {}) });
      return (
       e.params &&
     ...
     L = s.useCallback(e.onIframeAdded || function () {}, [e.onIframeAdded]),
     ...
     (0, t.jsxs)(t.Fragment, {
      children: [
       ...
       (0, t.jsxs)(P, {
        ...
        children: [e.lazyLoad && !l && (0, t.jsx)('img', { src: x, alt: `${m} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !l && (0, t.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && l) && (0, t.jsx)('button', { type: 'button', className: A, 'aria-label': `${p} ${m}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, onClick: _, children: (0, t.jsx)('span', { className: 'lty-visually-hidden', children: p }) }), l && (0, t.jsx)('iframe', { ref: n, className: D, title: m, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: y, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  84471(e, n, i) {
   i.d(n, { bo: () => s, KF: () => m, mJ: () => j, VZ: () => x, cR: () => w, Pv: () => g, qZ: () => r, kD: () => v, QQ: () => S, B2: () => h, Pc: () => l, f4: () => a, GT: () => f, fX: () => o, eQ: () => b, B_: () => y, o_: () => k });
   ...
   const u = (e) => [...e].sort((e, n) => d.indexOf(e) - d.indexOf(n)),
    ...
    j = (e) => u(c(e.projects.flatMap((e) => p(e)))),
    g = (e) => {
     const n = p(e),
      i = ((e) => {
