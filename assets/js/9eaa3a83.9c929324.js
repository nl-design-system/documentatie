 ...
 [77104],
 {
  ...
  75397(e, n, t) {
   ...
   function l(e, n, t, a, r) {
    const i = { '@context': 'https://schema.org', '@type': 'VideoObject', name: (null == r ? void 0 : r.name) || n, thumbnailUrl: [(null == r ? void 0 : r.thumbnailUrl) || t], embedUrl: (null == r ? void 0 : r.embedUrl) || `${a}/embed/${e}`, contentUrl: (null == r ? void 0 : r.contentUrl) || `https://www.youtube.com/watch?v=${e}`, ...((null == r ? void 0 : r.description) && { description: r.description }), ...((null == r ? void 0 : r.uploadDate) && { uploadDate: r.uploadDate }), ...((null == r ? void 0 : r.duration) && { duration: r.duration }) };
   ...
   const s = a.forwardRef(function (e, n) {
     const [t, s] = a.useState(!1),
      ...
      b = a.useMemo(() => (e.playlist ? `${v}/embed/videoseries?${j.toString()}` : `${v}/embed/${c}?${j.toString()}`), [e.playlist, v, c, j]),
      w = !e.thumbnail && !e.playlist && 'maxresdefault' === g,
      f = e.webp ? 'webp' : 'jpg',
      k = e.webp ? 'vi_webp' : 'vi',
      x = w
       ? ((e, n, t, r = 'maxresdefault') => {
          const [l, s] = (0, a.useState)('');
          return (
           (0, a.useEffect)(() => {
            const a = `https://img.youtube.com/${n}/${e}/${r}.${t}`,
       ...
       : null,
      y = a.useMemo(() => e.thumbnail || x || `https://i.ytimg.com/${k}/${e.playlist ? h : c}/${g}.${f}`, [e.thumbnail, x, k, e.playlist, h, c, g, f]),
      ...
      M = a.useCallback(e.onIframeAdded || function () {}, [e.onIframeAdded]),
     ...
     return (
      ...
      (0, r.jsxs)(r.Fragment, {
       children: [
        !e.lazyLoad && (0, r.jsx)('link', { rel: G, href: y, as: 'image' }),
        (0, r.jsx)(r.Fragment, { children: t && (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)('link', { rel: 'preconnect', href: v }), (0, r.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), A && (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, r.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
        e.seo && !e.playlist && (0, r.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: l(e.id, u, y, v, e.seo) } }),
        R && !e.playlist && (0, r.jsx)('noscript', { children: (0, r.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${u} on YouTube`, children: ['Watch "', u, '" on YouTube'] }) }),
        (0, r.jsxs)(D, {
         onPointerOver: () => {
          t || s(!0);
         },
         ...
         children: [e.lazyLoad && !o && (0, r.jsx)('img', { src: y, alt: `${u} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, r.jsx)('button', { type: 'button', className: L, 'aria-label': `${p} ${u}`, 'aria-hidden': o || void 0, tabIndex: o ? -1 : 0, children: (0, r.jsx)('span', { className: 'lty-visually-hidden', children: p }) }), o && (0, r.jsx)('iframe', { ref: n, className: _, title: u, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
    ...
    o = ({ id: e, title: n, ...t }) => {
     ...
     return (0, r.jsx)('div', { ref: i, children: (0, r.jsx)(s, { adNetwork: !1, announce: 'Bekijk', cookie: !1, containerElement: 'div', id: e, title: n, poster: 'maxresdefault', ...t }) });
    };
  },
  80003(e, n, t) {
   t.d(n, { E: () => l });
