(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [75922],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => p, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => i, kD: () => v, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => s, eQ: () => b, B_: () => k, o_: () => g, Rc: () => x });
  ...
  41093(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => u, default: () => g, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => h, toc: () => p }));
   ...
   function g(e = {}) {
    ...
    return t ? (0, c.jsx)(t, { ...e, children: (0, c.jsx)(m, { ...e }) }) : m(e);
   }
  },
  42962(e, t, n) {
  ...
  99630(e, t, n) {
   ...
   const y = ({ children: e }) => (0, a.jsx)('ul', { className: 'task-list', children: e }),
    p = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, a.jsxs)('li', { className: (0, c.A)('task-list-item'), children: [(0, a.jsxs)('div', { className: (0, c.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, a.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, a.jsx)(j.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, a.jsxs)('div', { children: [n ? (0, a.jsx)(d.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }) : null, r, t] })] });
   var m = n(33062);
   const g = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, a.jsx)(r.If, { sections: s.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, m.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(y, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, a.jsx)(p, { headingLevel: t + 1, checked: e, title: n, description: (0, m.qZ)(r) }, r)) }), (0, a.jsx)(r.fz, { children: (0, a.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            i.Zp,
            {
             ...
             children: (0, a.jsxs)(i.Wu, {
              children: [
               ...
               o.length > 0 && (0, a.jsx)(a.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
