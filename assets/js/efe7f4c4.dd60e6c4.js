...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  44012: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => d, contentTitle: () => o, default: () => u, frontMatter: () => a, metadata: () => l, toc: () => m });
   var t = i(52676),
    r = i(40139),
    s = i(82415);
  ...
  82415: (e, n, i) => {
   ...
   var t = i(87573),
    ...
    o = i(52676);
   const l = (e) => {
    let { listId: n = '', laPostaId: i = '', thanksPage: l = '', emailFieldId: d = '', firstNameFieldId: m = '', orgId: c = '', interestsId: u = '', interestsLegend: h = 'Waar wil je NL Design System voor gebruiken?', interests: p = [], disallowedInterestValues: v = [], workAreasId: y = '', privacyPolicyId: j = '', language: g, submitText: x = '', talkTitleId: b = '', talkDescriptionId: f = '' } = e;
    const {
      register: k,
      handleSubmit: w,
      formState: { errors: C },
