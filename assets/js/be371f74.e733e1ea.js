...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [45522],
 {
  ...
  96302(e, n, i) {
   (i.r(n), i.d(n, { assets: () => b, contentTitle: () => j, default: () => f, frontMatter: () => g, metadata: () => t, toc: () => p }));
   const t = JSON.parse('{"id":"wcag/2.4.07","title":"WCAG-succescriterium 2.4.7 Focus zichtbaar","description":"Zorg dat het goed zichtbaar is welk element de toetsenbordfocus heeft, wanneer je door de website navigeert met een toetsenbord of vergelijkbare bediening. Dit kan bijvoorbeeld door het gebruik van een focusring (outline).","source":"@site/docs/wcag/2.4.07.mdx","sourceDirName":"wcag","slug":"/wcag/2.4.7","permalink":"/wcag/2.4.7","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.07.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 2.4.7 Focus zichtbaar","title_sm":"2.4.7 Focus zichtbaar","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"2.4.7 Focus zichtbaar","pagination_label":"2.4.7 Focus zichtbaar","description":"Zorg dat het goed zichtbaar is welk element de toetsenbordfocus heeft, wanneer je door de website navigeert met een toetsenbord of vergelijkbare bediening. Dit kan bijvoorbeeld door het gebruik van een focusring (outline).","slug":"2.4.7","conformance_level":"Niveau AA","keywords":["WCAG","AA","bedienbaar","navigeerbaar","operable","navigable","focus visible"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 2.4.6 Koppen en labels","permalink":"/wcag/2.4.6"},"next":{"title":"2.4.8 Locatie","permalink":"/wcag/2.4.8"}}');
   var r = i(86070),
    s = i(18439),
    o = i(24703),
    l = i(61473),
    ...
    h = i(66117),
    u = i(2158);
   const g = { title: 'WCAG-succescriterium 2.4.7 Focus zichtbaar', title_sm: '2.4.7 Focus zichtbaar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.7 Focus zichtbaar', pagination_label: '2.4.7 Focus zichtbaar', description: 'Zorg dat het goed zichtbaar is welk element de toetsenbordfocus heeft, wanneer je door de website navigeert met een toetsenbord of vergelijkbare bediening. Dit kan bijvoorbeeld door het gebruik van een focusring (outline).', slug: '2.4.7', conformance_level: 'Niveau AA', keywords: ['WCAG', 'AA', 'bedienbaar', 'navigeerbaar', 'operable', 'navigable', 'focus visible'] },
    j = void 0,
    b = {},
