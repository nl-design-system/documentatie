      ...
      children: [
       ...
       j &&
        (0, p.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, p.jsx)(b.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: Z, trim: !0 }),
          l &&
           (0, p.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: l, textContent: c, trim: d } = e,
     m = c;
    const { title: u, type: b } = (0, t.useContext)(s.n),
     p = (0, t.useId)();
    return (
     d && (m = m.trim()),
     (0, i.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', b ? `\u201c${b}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, i.jsx)(a.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': p, style: l, children: o.map((e, l) => (0, i.jsxs)('span', { ...t({ line: e }), children: [n && (0, i.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
   ...
   const d = (0, r.createContext)({}),
    m = (e) => {
     ...
     const b = { do: 'Doen', dont: 'Niet doen' },
      p = u ? 'figure' : 'div',
      h = u ? 'figcaption' : 'div';
     return (0, c.jsxs)(p, { className: (0, s.Z)(i['nlds-guideline'], i[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(h, { className: (0, s.Z)(i['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(t.nv, { className: (0, s.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(a.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: i['nlds-guideline__title'], children: b.dont })] }), (0, c.jsx)(t.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(t.nv, { className: (0, s.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: i['nlds-guideline__title'], children: b.do })] }), (0, c.jsx)(t.nv, { children: n })] }), r] }), (0, c.jsx)('div', { className: (0, s.Z)(i['nlds-guideline__example']), children: (0, c.jsx)(d.Provider, { value: { title: n, type: b[l] }, children: m }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => s });
