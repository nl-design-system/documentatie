   ...
   const d = (0, a.createContext)({}),
    h = ({ title: e, appearance: n, description: l, children: a, figure: h }) => {
     const v = { do: 'Doen', dont: 'Niet doen' },
      m = h ? 'figure' : 'div',
      p = h ? 'figcaption' : 'div',
      u = 'string' == typeof l ? (0, c.jsx)(r.oz, { components: { a: i.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   const a = (0, t.forwardRef)(({ as: e, className: n, children: l, ...t }, i) => {
    ...
    c = ({ className: e, classNamePanel: n, label: l, heading: t, headingLevel: a, headingApperance: c, ...d }) => {
     ...
     return (0, r.jsxs)('details', { className: h, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(i.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [t && (0, r.jsx)(s.D, { level: a, appearance: c, children: t }), l] })] }) }), (0, r.jsx)('div', { className: v, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => x });
   ...
   const f = ({ children: e }) => (0, j.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: e });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const o = 'function' == typeof e ? e() : e,
        ...
        s = p().highlight(t, p().languages[n], n);
       return (0, j.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', l), children: [(0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: t } }), (0, j.jsx)(u.n, { children: (0, j.jsx)(u.K, { label: 'Code', children: (0, j.jsx)('pre', { className: 'language-html nl-code-block', children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: m = !0, children: p, container: u = 'document', language: x, designTokens: y }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: x, plugins: [s.A, r.Ay, a.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [N]);
       const S = (0, h.useId)();
       let F = h.Fragment;
       return (
        'paragraph' === u ? (F = g) : 'document' === u ? (F = b) : 'surface' === u && (F = f),
        (0, j.jsxs)('div', {
