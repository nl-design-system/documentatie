 ...
 [44147],
 {
  ...
  98480: (e, n, l) => {
   ...
   const b = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (C = await c.ZP.format(Z, { parser: f, plugins: [s.Z, i.ZP, a.ZP, r.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), z(C);
     })();
    }, [Z]);
    const E = (0, d.useId)();
    let F = d.Fragment;
    return (
     'paragraph' === x ? (F = v) : 'document' === x ? (F = _) : 'surface' === x && (F = h),
     (0, p.jsxs)('div', {
      className: (0, t.Z)(m['nlds-canvas']),
      children: [
       w && (0, p.jsx)('div', { className: (0, t.Z)(m['nlds-canvas__example']), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, p.jsx)(F, { children: (0, p.jsx)(o.pu, { children: w }) }) }) }),
       y &&
        (0, p.jsx)('div', {
       ...
       y &&
        (0, p.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, p.jsx)(g.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: C, trim: !0 }),
          l &&
           (0, p.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: l, textContent: c, trim: d } = e,
     u = c;
    const { title: m, type: g } = (0, s.useContext)(i.n),
     p = (0, s.useId)();
    return (
     d && (u = u.trim()),
     (0, r.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', g ? `\u201c${g}\u201d` : '', ' ', m ? ': ' : ' ', m] }), (0, r.jsx)(o.dn, { tabIndex: 0, role: m ? 'region' : void 0, 'aria-labelledby': p, style: l, children: t.map((e, l) => (0, r.jsxs)('span', { ...s({ line: e }), children: [n && (0, r.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, r.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
   ...
   const d = (0, a.createContext)({}),
    u = (e) => {
     ...
     const g = { do: 'Doen', dont: 'Niet doen' },
      p = m ? 'figure' : 'div',
      v = m ? 'figcaption' : 'div';
     return (0, c.jsxs)(p, { className: (0, i.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(v, { className: (0, i.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, i.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: g.dont })] }), (0, c.jsx)(s.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, i.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: g.do })] }), (0, c.jsx)(s.nv, { children: n })] }), a] }), (0, c.jsx)('div', { className: (0, i.Z)(r['nlds-guideline__example']), children: (0, c.jsx)(d.Provider, { value: { title: n, type: g[l] }, children: u }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => a, a: () => i });
