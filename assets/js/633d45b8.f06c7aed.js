...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [84756],
 {
  ...
  98480: (e, n, l) => {
   ...
   const _ = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: _ = !1, displayCode: k = !0, children: y, container: x = 'document', language: j, designTokens: f } = e,
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (S = await c.ZP.format(Z, { parser: j, plugins: [s.Z, o.ZP, a.ZP, r.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), z(S);
     })();
    }, [Z]);
    const L = (0, d.useId)();
    let P = d.Fragment;
      ...
      children: [
       ...
       k &&
        (0, m.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(b.u, { syntax: j, textContent: S, trim: !0 }),
          l &&
           (0, m.jsx)('div', {
    ...
    return (
     ...
     (0, o.jsx)(i.y$, {
      ...
      children: (e) => {
       ...
       return (0, o.jsx)(t.dn, { tabIndex: 0, style: l, children: i.map((e, l) => (0, o.jsxs)('span', { ...s({ line: e }), children: [n && (0, o.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, o.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const u = 'Doen',
     ...
     m = p ? 'figure' : 'div',
     h = p ? 'figcaption' : 'div';
    return (0, r.jsxs)(m, { className: (0, o.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, r.jsxs)(h, { className: (0, o.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(s.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: a['nlds-guideline__title'], children: b })] }), (0, r.jsx)(s.nv, { children: n })] }) : (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(s.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(i.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: a['nlds-guideline__title'], children: u })] }), (0, r.jsx)(s.nv, { children: n })] }), c] }), (0, r.jsx)('div', { className: (0, o.Z)(a['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => a, a: () => o });
