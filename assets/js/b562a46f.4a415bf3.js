 ...
 [12274],
 {
  ...
  43599: (e, n, o) => {
   ...
   const b = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(N, { parser: f, plugins: [t.Z, c.ZP, i.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [N]);
    const M = (0, p.useId)();
    ...
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       _ && (0, m.jsx)('div', { className: (0, s.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(P, { children: (0, m.jsx)(r.pu, { children: _ }) }) }) }),
       g &&
        (0, m.jsx)('div', {
       ...
       g &&
        (0, m.jsxs)('div', {
         ...
         hidden: !D,
         children: [
          (0, m.jsx)(l.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: Z, trim: !0 }),
          o &&
           (0, m.jsx)('div', {
    ...
    return (
     ...
     (0, i.jsx)(r.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, i.jsx)(l.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': h, style: o, children: r.map((e, o) => (0, i.jsxs)('span', { ...s({ line: e }), children: [n && (0, i.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, o)) })] });
      },
     })
    );
   }
