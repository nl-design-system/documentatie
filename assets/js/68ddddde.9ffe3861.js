(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [94192],
 {
  ...
  26877(e, n, t) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
         ...
         children: t
          ...
          .map((e) => {
           const t = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            p = e.tasks.filter(({ name: e, value: n }) => m.has(e) && URL.canParse(n) && 'https:' === new URL(n).protocol);
            ...
            ? (0, c.jsx)(
               d.Z,
               {
                ...
                description: (0, c.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, c.jsxs)(a.f, { children: [(0, c.jsx)(g, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, c.jsxs)(i.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, c.jsxs)('div', {
                   children: [
                    (p.length > 0 || u.length > 0) && (0, c.jsx)(s.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    p.length > 0 &&
                     (0, c.jsx)(i.dk, {
                      links: p
                  ...
                  u.length > 0 && u.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)('section', { children: [(0, c.jsxs)(s.DZ, { level: Math.min(n + 2, 6), children: [r, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(o.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, c.jsxs)(l.Wu, {
                 children: [
                  ...
                  (p.length > 0 || u.length > 0) && (0, c.jsx)(i.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  p.length > 0 &&
                   (0, c.jsx)(c.Fragment, {
                  ...
                  u.length > 0 && (0, c.jsx)(c.Fragment, { children: u.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(i.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    b = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(m.p, { level: n, suffix: s && (0, c.jsx)(u.D, { state: s }), children: e.title }), (0, c.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(s) && (0, c.jsx)(f.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    A = ({ component: e }) => {
     const n = (e && k[e.title]) || [];
  ...
  29857(e, n, t) {
   ...
   var i = t(37168),
    s = t(86070);
   const a = (e) => (0, s.jsx)(i.D, { ...e }),
    r = (e) => (0, s.jsx)(i.D, { ...e, level: 3 });
  },
  31686(e, n, t) {
   'use strict';
   t.d(n, { Ay: () => o, RM: () => a });
  ...
  48068(e, n, t) {
   ...
   var u = t(43864),
    ...
    v = t(23436),
    b = t(79532);
   const A = { boxShadow: u.A, color: m.A, cursor: p.A, dimension: h.A, fontFamily: k.A, fontFamilies: k.A, fontSize: j.A, fontSizes: j.A, fontWeight: f.A, fontWeights: f.A, lineHeight: x.A, lineHeights: x.A, number: w.A, other: v.A, textDecoration: b.A },
    y = ({ type: e }) => {
  ...
  84471(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => u, mJ: () => h, VZ: () => A, cR: () => b, Pv: () => k, qZ: () => r, kD: () => w, QQ: () => T, B2: () => m, Pc: () => l, f4: () => o, GT: () => v, fX: () => a, eQ: () => x, B_: () => f, o_: () => j });
