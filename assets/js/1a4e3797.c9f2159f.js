/*! For license information please see 1a4e3797.c9f2159f.js.LICENSE.txt */
 ...
 [97920],
 {
      ...
      r(
       ...
       {},
       {
        methods: {
         ...
         multipleQueries: S,
         multipleSearchForFacetValues: Q,
         customRequest: A,
         initIndex: function (e) {
          return function (t) {
           return H(e)(t, { methods: { search: C, searchForFacetValues: I, findAnswers: T } });
          };
         },
        },
       },
  ...
  16919: (e, t, r) => {
   ...
   var n = r(75271),
    ...
    j = r(95360),
    P = r(6709);
   const x = { searchQueryInput: 'searchQueryInput_EUf7', searchVersionInput: 'searchVersionInput_Z7Qq', searchResultsColumn: 'searchResultsColumn_MqDj', algoliaLogo: 'algoliaLogo_ylWN', algoliaLogoPathFill: 'algoliaLogoPathFill_tZtI', searchResultItem: 'searchResultItem_yQaz', searchResultItemHeading: 'searchResultItemHeading_PUFc', searchResultItemPath: 'searchResultItemPath_CNiJ', searchResultItemSummary: 'searchResultItemSummary_tF1W', searchQueryColumn: 'searchQueryColumn_fwVd', searchVersionColumn: 'searchVersionColumn_qKn9', searchLogoColumn: 'searchLogoColumn_tYkX', loadingSpinner: 'loadingSpinner__wtv', 'loading-spin': 'loading-spin_mOlM', loader: 'loader_o0qm' };
   var _ = r(52676);
   function E(e) {
   ...
   function w() {
    const {
     ...
     Q = u()(t, r),
     T = a()(Q, s, { hitsPerPage: 15, advancedSyntax: !0, disjunctiveFacets: ['language', 'docusaurus_tag'] });
    T.on('result', (e) => {
     let {
    ...
    const [C, I] = (0, n.useState)(null),
     ...
     V = (0, p.zX)(function (t) {
      void 0 === t && (t = 0),
       T.addDisjunctiveFacetRefinement('docusaurus_tag', 'default'),
       T.addDisjunctiveFacetRefinement('language', e),
       Object.entries(w.searchVersions).forEach((e) => {
        let [t, r] = e;
        T.addDisjunctiveFacetRefinement('docusaurus_tag', `docs-${t}-${r}`);
       }),
       T.setQuery(O).setPage(t).search();
     });
    return (
     (0, n.useEffect)(() => {
      if (!C) return;
       ...
       (0, _.jsxs)('div', {
        ...
        children: [
         ...
         H.items.length > 0
          ...
          : [O && !H.loading && (0, _.jsx)('p', { children: (0, _.jsx)(y.Z, { id: 'theme.SearchPage.noResultsText', description: 'The paragraph for empty search result', children: 'No results were found' }) }, 'no-results'), !!H.loading && (0, _.jsx)('div', { className: x.loadingSpinner }, 'spinner')],
