(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [34799],
 {
  ...
  4398(e, t, n) {
   'use strict';
   n.d(t, { B2: () => u, B_: () => w, GT: () => k, KF: () => h, Pc: () => a, Pv: () => m, Rc: () => v, bo: () => r, eQ: () => y, f4: () => o, fX: () => s, kD: () => f, mJ: () => p, o_: () => j, qZ: () => i });
  ...
  80840(e, t, n) {
   'use strict';
   n.r(t), n.d(t, { assets: () => W, component: () => L, contentTitle: () => N, default: () => M, description: () => S, frontMatter: () => z, issueNumber: () => D, metadata: () => r, title: () => _, toc: () => F });
   ...
   function P(e) {
    ...
    return (0, s.jsxs)(s.Fragment, {
     children: [
      ...
      '\n',
      (0, s.jsx)(w.Zp, { className: 'implementation-card', children: (0, s.jsxs)(w.Wu, { children: [(0, s.jsx)(f.D, { level: 3, appearance: 'level-4', children: 'Figma' }), (0, s.jsxs)(y.dk, { children: [(0, s.jsxs)(y.N_, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=150-734', children: [(0, s.jsx)(k.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, s.jsxs)(y.N_, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=150-734', children: [(0, s.jsx)(k.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, s.jsx)(f.D, { level: 3, appearance: 'level-4', children: 'Storybook' }), (0, s.jsxs)(y.dk, { children: [(0, s.jsxs)(y.N_, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-paragraph--documentatie', children: [(0, s.jsx)(k.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, s.jsxs)(y.N_, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/paragraph--documentatie', children: [(0, s.jsx)(k.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, s.jsx)(f.D, { level: 3, appearance: 'level-4', children: 'NPM' }), (0, s.jsxs)(y.dk, { children: [(0, s.jsxs)(y.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/paragraph-css', children: [(0, s.jsx)(k.r, { brand: 'npm' }), ' @nl-design-system-candidate/paragraph-css'] }), (0, s.jsxs)(y.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/paragraph-react', children: [(0, s.jsx)(k.r, { brand: 'npm' }), ' @nl-design-system-candidate/paragraph-react'] }), (0, s.jsxs)(y.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/paragraph-tokens', children: [(0, s.jsx)(k.r, { brand: 'npm' }), ' @nl-design-system-candidate/paragraph-tokens'] })] })] }) }),
      '\n',
  ...
  99630(e, t, n) {
   ...
   const w = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, c.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, j.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, c.jsx)(m, { headingLevel: t + 1, checked: e, title: n, description: (0, j.qZ)(r) }, r)) }), (0, c.jsx)(r.fz, { children: (0, c.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
