/*! For license information please see 74873.92660e40.js.LICENSE.txt */
'use strict';
  ...
  79889(e, n, t) {
   ...
   var c = (0, i.forwardRef)(function (e, n) {
    ...
    if (
     ...
     var g = l.dateTime,
      c = (0, a.A)(l, s);
     return (0, r.jsx)('time', h(h({}, c), {}, { dateTime: g, className: i, ref: n, children: t }));
    }
    if (
     (function (e) {
      return 'value' in e;
     ...
     var v = l.value,
      y = (0, a.A)(l, d);
     return (0, r.jsx)('data', h(h({}, y), {}, { value: v, className: i, ref: n, children: t }));
    }
    return (0, r.jsx)('span', h(h({}, l), {}, { className: i, ref: n, children: t }));
   });
   c.displayName = 'DataBadge';
   !(function (e, n) {
    void 0 === n && (n = {});
    var t = n.insertAt;
    if ('undefined' != typeof document) {
