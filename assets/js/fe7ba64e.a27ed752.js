 ...
 [12421],
 {
  ...
  43599: (e, n, t) => {
   ...
   const x = (e) => {
    ...
    (0, m.useEffect)(() => {
     (async () => {
      (C = await d.ZP.format(N, { parser: f, plugins: [r.Z, a.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(C);
     })();
    }, [N]);
    const P = (0, m.useId)();
    let z = m.Fragment;
      ...
      children: [
       ...
       y &&
        (0, p.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, p.jsx)(o.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: C, trim: !0 }),
          t &&
           (0, p.jsx)('div', {
