...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  79981: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => j, default: () => b, frontMatter: () => g, metadata: () => k, toc: () => v });
   var r = i(52676),
    t = i(40139),
    s = i(57716),
    a = i(46364),
   ...
   const g = { title: 'WCAG-succescriterium 2.4.10 Paragraafkoppen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.10 Paragraafkoppen', pagination_label: 'WCAG-succescriterium 2.4.10 Paragraafkoppen', description: 'Gebruik paragraafkoppen (kopjes) om de content te structureren.', slug: '2.4.10', keywords: ['WCAG'] },
    j = void 0,
