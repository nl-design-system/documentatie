 ...
 [67360],
 {
  ...
  70348(e, n, l) {
   ...
   const r = ({ className: e, ...n }) => {
    ...
    a = ({ className: e, classNamePanel: n, label: l, heading: r, headingLevel: a, headingApperance: c, ...d }) => {
     const h = (0, o.A)('utrecht-accordion__section', e),
      v = (0, o.A)('utrecht-accordion__panel', n);
     return (0, s.jsxs)('details', { className: h, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(t.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(i.D, { level: a, appearance: c, children: r }), l] })] }) }), (0, s.jsx)('div', { className: v, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => f });
   ...
   const f = globalThis.isAstro
    ...
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: m = !0, children: p, container: u = 'document', language: f, designTokens: y }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: f, plugins: [s.A, r.Ay, a.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [N]);
       const S = (0, h.useId)();
         ...
         children: [
          ...
          m &&
           (0, j.jsxs)('div', {
            ...
            hidden: !z,
            children: [
             (0, j.jsx)(o.M, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: w, trim: !0 }),
             n &&
              (0, j.jsx)('div', {
