 ...
 [9591],
 {
  90079: (e, t, n) => {
   ...
   const s = { title: 'Date input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date input group', pagination_label: 'Date input group', description: 'Biedt de mogelijkheid om een datum in te vullen die bekend of makkelijk op te zoeken is.', slug: '/date-input-group', sidebar_custom_props: { illustration: 'DateInputGroupSketch' } },
    a = void 0,
    u = { id: 'componenten/date-input-group/index', title: 'Date input group', description: 'Biedt de mogelijkheid om een datum in te vullen die bekend of makkelijk op te zoeken is.', source: '@site/docs/componenten/date-input-group/index.mdx', sourceDirName: 'componenten/date-input-group', slug: '/date-input-group', permalink: '/date-input-group', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-input-group/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Date input group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date input group', pagination_label: 'Date input group', description: 'Biedt de mogelijkheid om een datum in te vullen die bekend of makkelijk op te zoeken is.', slug: '/date-input-group', sidebar_custom_props: { illustration: 'DateInputGroupSketch' } }, sidebar: 'componenten', previous: { title: 'Date input', permalink: '/date-input' }, next: { title: 'Date picker', permalink: '/date-picker' } },
    l = {},
    d = [
