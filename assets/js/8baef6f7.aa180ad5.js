 ...
 [41102],
 {
  ...
  51627(e, n, i) {
   ...
   const l = ({ className: e, ...n }) => {
    ...
    s = ({ className: e, label: n, heading: i, headingLevel: l, headingApperance: s, ...d }) => {
     const c = (0, t.A)('utrecht-accordion__section', e);
     return (0, r.jsxs)('details', { className: c, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(a.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [i && (0, r.jsx)(o.D, { level: l, appearance: s, children: i }), n] })] }) }), (0, r.jsx)('div', { className: 'utrecht-accordion__panel', children: d.children })] });
    };
  },
  55552(e, n, i) {
   i.d(n, { Ay: () => r });
  ...
  56167(e, n, i) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
    ...
    x = ({ component: e, headingLevel: n, description: i }) => {
  ...
  76097(e, n, i) {
   i.d(n, { bo: () => a, KF: () => g, mJ: () => p, VZ: () => D, cR: () => w, Pv: () => j, qZ: () => r, kD: () => x, QQ: () => A, B2: () => m, Pc: () => s, f4: () => l, GT: () => f, fX: () => o, eQ: () => b, B_: () => k, o_: () => v });
