 ...
 [21630],
 {
  ...
  39772: (e, t, n) => {
   ...
   function l(e) {
    ...
    return (0, o.jsxs)('div', { className: 'card', children: [t ? (0, o.jsx)(r.Z, { href: t, className: (0, c.Z)('cardLink', 'utrecht-link'), children: (0, o.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', i] }) }) : (0, o.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', i] }), s && (0, o.jsx)('p', { className: 'cardDescription', children: s }), l] });
   }
   function a(e) {
    let { item: t } = e;
   ...
   function d(e) {
    ...
    return (0, o.jsx)(l, { linkDescription: t.label, href: t.href, title: t.label, description: t.description ?? n?.description });
   }
   function j(e) {
    let { item: t } = e;
    switch (t.type) {
