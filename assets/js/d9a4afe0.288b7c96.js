 ...
 [23020],
 {
  13455: (e, l, o) => {
   ...
   const p = (e) => {
    ...
    h = (e) => {
     let { code: l, copy: o = !1, defaultCollapsed: d = !0, children: i, language: s } = e;
     const h = u().format(b.uS(l || i), { parser: "html", plugins: [t(), c()], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" }),
      _ = (0, v.Z)();
     return n.createElement(
      "div",
      { className: (0, a.Z)(r["nlds-canvas"], "voorbeeld-theme", "utrecht-html") },
      n.createElement("div", { className: (0, a.Z)(r["nlds-canvas__example"]) }, i),
      n.createElement("div", { className: (0, a.Z)(r["nlds-canvas__toolbar"]) }, n.createElement(m.zx, { className: (0, a.Z)(r["nlds-canvas__button"], r["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: p, "aria-expanded": !d, "aria-controls": _ }, d ? "Bekijk code" : "Verberg code")),
      n.createElement(
       "div",
       { className: (0, a.Z)(r["nlds-canvas__code-block"], !o && r["nlds-canvas__code-block--user-select-none"]), id: _, hidden: d },
       n.createElement(g.Z, { language: s, style: k }, h),
       o &&
        n.createElement(
         "div",
         { className: (0, a.Z)(r["nlds-canvas__toolbar"]) },
         n.createElement(
          m.zx,
          {
           className: (0, a.Z)(r["nlds-canvas__button"], r["nlds-canvas__copy-button"]),
  ...
  70618: (e, l, o) => {
   ...
   function g(e) {
    ...
    return (0, r.kt)(b, (0, n.Z)({}, u, o, { components: l, mdxType: "MDXLayout" }), (0, r.kt)("h1", { id: "duidelijk" }, "Duidelijk"), (0, r.kt)(a.nv, { lead: !0, mdxType: "Paragraph" }, "Een duidelijk formulier zorgt dat gebruikers met meer vertrouwen en zelfstandiger door je formulier kunnen gaan."), (0, r.kt)("h2", { id: "vermijd-belangrijke-informatie-in-tooltips" }, "Vermijd belangrijke informatie in tooltips"), (0, r.kt)("p", null, "Informatie die nodig is om een veld in te kunnen vullen, kan het beste worden opgenomen als onderdeel van de content, bijvoorbeeld als omschrijving onder het label. Vermijd het gebruik van tooltips (of placeholders) voor belangrijke informatie.."), (0, r.kt)("h2", { id: "leg-jargon-uit" }, "Leg jargon uit"), (0, r.kt)("p", null, "Soms is het niet te voorkomen dat een formulier jargon bevat, bijvoorbeeld omdat termen wettelijk zijn vastgelegd. Leg in zulke gevallen duidelijk uit wat zo'n term betekent."), (0, r.kt)("h2", { id: "houd-taal-consistent" }, "Houd taal consistent"), (0, r.kt)("p", null, "Zorg ervoor dat door het hele formulier voor dezelfde dingen dezelfde termen worden gebruikt."), (0, r.kt)("h2", { id: "duidelijke-labels" }, "Duidelijke labels"), (0, r.kt)("p", null, "Het doel van een label is dat de gebruiker de vraag begrijpt. Een effectief label is duidelijk en beschrijvend. Waar nodig wordt er ook extra hulp geboden worden, zoals een omschrijving van waar een BSN-nummer te vinden is.\nLees hierover meer op de ", (0, r.kt)("a", { parentName: "p", href: "/richtlijnen/formulieren/alle-richtlijnen/labels" }, "richtlijnen over labels"), "."), (0, r.kt)("h2", { id: "leg-uit-waarom-informatie-nodig-is" }, "Leg uit waarom informatie nodig is"), (0, r.kt)("p", null, "Soms lijkt een vraag overbodig, terwijl deze essentieel is. In zulke gevallen is het een goed idee een korte uitleg toe te vragen, om bijvoorbeeld het doel te beschrijven.\nLees hierover meer op de ", (0, r.kt)("a", { parentName: "p", href: "/richtlijnen/formulieren/alle-richtlijnen/labels" }, "richtlijnen over uit te vragen informatie"), "."));
   }
   g.isMDXComponent = !0;
  },
 },
