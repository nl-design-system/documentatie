...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [75989],
 {
  ...
  43599: (e, n, r) => {
   ...
   const m = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(s.Tg, { className: 'nlds-canvas__example-surface', children: (0, p.jsx)(s.BB, { className: (0, l.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, p.jsx)(s.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   m.displayName = 'ParagraphContainer';
   const g = (e) => {
    let { children: n } = e;
    return (0, p.jsx)(s.Tg, { className: 'nlds-canvas__example-surface', children: (0, p.jsx)(s.BB, { className: (0, l.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const b = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (N = await d.ZP.format(z, { parser: k, plugins: [o.Z, i.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), A(N);
     })();
    }, [z]);
    const Z = (0, u.useId)();
    let I = u.Fragment;
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       _ && (0, p.jsx)('div', { className: (0, l.Z)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(I, { children: (0, p.jsx)(s.pu, { children: _ }) }) }) }),
       j &&
        (0, p.jsx)('div', {
       ...
       j &&
        (0, p.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, p.jsx)(t.u, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: N, trim: !0 }),
          r &&
           (0, p.jsx)('div', {
