/*! For license information please see 68ddddde.e32f31a7.js.LICENSE.txt */
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [94192],
 {
  ...
  4398(e, n, t) {
   'use strict';
   t.d(n, { B2: () => u, B_: () => k, GT: () => y, KF: () => h, Pc: () => a, Pv: () => g, Rc: () => w, bo: () => r, eQ: () => v, f4: () => o, fX: () => i, kD: () => f, mJ: () => m, o_: () => j, qZ: () => s });
   ...
   const d = (e) => [...e].sort((e, n) => l.indexOf(e) - l.indexOf(n)),
    ...
    m = (e) => d(c(e.projects.flatMap((e) => p(e)))),
    g = (e) => {
     const n = p(e),
      t = ((e) => {
  ...
  17889(e, n, t) {
   ...
   var g = t(30696),
    ...
    b = t(43825),
    x = t(30758);
   const A = { color: g.A, dimension: j.A, fontFamilies: k.A, fontSizes: v.A, fontWeights: f.A, lineHeights: y.A, other: w.A, textDecoration: b.A },
    z = ({ type: e }) => (0, p.jsx)(u.In, { children: (0, x.createElement)(A[e]) });
   function C({ tokens: e }) {
    const n = (0, s.kD)(e),
     t = (0, s.GT)(n),
       ...
       children: [
        ...
        (0, p.jsx)(o.BF, {
         children: t.map((n) => {
          const t = (0, s.o_)(n),
           a = (0, s.eQ)(e, n).$type;
          return (0, p.jsxs)(o.Hj, { children: [(0, p.jsx)(o.nA, { children: (0, p.jsx)(r.C, { children: (0, p.jsx)(o.kf, { children: t }) }) }), (0, p.jsx)(o.nA, { children: (0, p.jsxs)(i.K, { children: [(0, p.jsx)(z, { type: a }), ' ', a] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, p.jsxs)(o.e2, { children: [(0, p.jsx)(m, { content: l, language: 'json', children: 'Kopieer als JSON' }), (0, p.jsx)(m, { content: a, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  54030(e, n, t) {
   'use strict';
   t.r(n), t.d(n, { assets: () => ue, component: () => je, contentTitle: () => he, default: () => fe, description: () => me, frontMatter: () => de, issueNumber: () => ge, metadata: () => r, title: () => pe, toc: () => ke });
   ...
   const b = (e) => {
    let { title: n, titleId: t, ...r } = e;
    return y.createElement('svg', w({ xmlns: 'http://www.w3.org/2000/svg', width: 960, height: 540, fill: 'none', 'aria-label': 'Een woord \\u201Clabel\\u201D met een achtergrondkleur en dikke stippellijn eromheen. Het geheel is aangeduid met het cijfer 1.', viewBox: '0 0 960 540', role: 'img', 'aria-labelledby': t }, r), n ? y.createElement('title', { id: t }, n) : null, i || (i = y.createElement('path', { fill: '#fff', d: 'M.5.5h959v539H.5z' })), s || (s = y.createElement('path', { stroke: '#CCC', d: 'M.5.5h959v539H.5z' })), o || (o = y.createElement('path', { fill: '#FFE76B', d: 'M444 246h72v48h-72z' })), a || (a = y.createElement('path', { stroke: '#5315F6', strokeDasharray: '2 2', d: 'M443.5 245.5h73v49h-73z' })), l || (l = y.createElement('path', { stroke: '#fff', strokeWidth: 2, d: 'M443 245h74v50h-74z' })), c || (c = y.createElement('path', { stroke: '#5315F6', strokeDasharray: '2 2', strokeWidth: 2, d: 'M443 245h74v50h-74z' })), d || (d = y.createElement('path', { fill: '#000', d: 'M463.12 263.976v9.696h4.528l-.176 1.328H461.6v-11.024zm11.893 9.056q0 .512.176.768.175.24.528.368l-.336 1.024q-.657-.08-1.056-.368-.4-.288-.592-.896-.849 1.264-2.512 1.264-1.248 0-1.968-.704t-.72-1.84q0-1.344.96-2.064.975-.72 2.752-.72h1.296v-.624q0-.896-.432-1.28t-1.328-.384q-.928 0-2.272.448l-.368-1.072q1.568-.576 2.912-.576 1.488 0 2.224.736.736.72.736 2.064zm-3.456 1.056q1.264 0 1.984-1.312v-1.936h-1.104q-2.337 0-2.336 1.728 0 .752.368 1.136t1.088.384m10.335-7.712q1.44 0 2.288 1.168.848 1.152.848 3.232 0 1.312-.4 2.32-.4.992-1.152 1.552-.752.544-1.76.544-1.329 0-2.24-1.12l-.144.928h-1.296v-11.824l1.472-.176v4.624q.911-1.248 2.384-1.248m-.528 7.648q.975 0 1.52-.784.56-.8.56-2.464 0-1.712-.512-2.464-.513-.768-1.456-.768-1.12 0-1.968 1.312v4.032q.336.528.816.832.495.304 1.04.304m12.54-3.488q0 .368-.032.752h-5.376q.096 1.392.704 2.048t1.568.656q.607 0 1.12-.176a4.5 4.5 0 0 0 1.072-.56l.64.88q-1.344 1.056-2.944 1.056-1.76 0-2.752-1.152-.976-1.152-.976-3.168 0-1.312.416-2.32.432-1.024 1.216-1.6.8-.576 1.872-.576 1.68 0 2.576 1.104t.896 3.056m-1.456-.432q0-1.248-.496-1.904-.497-.656-1.488-.656-1.809 0-1.968 2.656h3.952zm5.486 5.088q-.816 0-1.296-.48-.464-.496-.464-1.376v-10.16l1.472-.176v10.304q0 .352.112.512.128.16.416.16.304 0 .544-.096l.384 1.024a2.4 2.4 0 0 1-1.168.288' })), h || (h = y.createElement('rect', { width: 32, height: 32, x: 364, y: 254, fill: '#DE00A4', rx: 16 })), u || (u = y.createElement('path', { fill: '#fff', d: 'M382.502 264.368V276.5H380v-9.612l-2.664 1.638-1.116-1.728 4.032-2.43z' })), p || (p = y.createElement('path', { stroke: '#DE00A4', strokeLinecap: 'square', strokeLinejoin: 'bevel', strokeWidth: 2, d: 'M396 270h48' })));
   };
   function x(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, g.R)(), ...e.components };
    return (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(n.p, { children: "Als je de tekstafstand vergroot blijft de tekst in de component in zijn geheel zichtbaar. Dit gaat om regelhoogte, afstand tussen alinea's, letterafstand en ruimte tussen woorden:" }), '\n', (0, m.jsxs)(n.ul, { children: ['\n', (0, m.jsx)(n.li, { children: 'Regelhoogte (regelafstand) naar ten minste 1,5 keer de lettergrootte.' }), '\n', (0, m.jsx)(n.li, { children: "Afstand tussen alinea's naar ten minste 2 keer de lettergrootte." }), '\n', (0, m.jsx)(n.li, { children: 'Letterafstand (spati\xebren van letters) naar ten minste 0,12 keer de lettergrootte.' }), '\n', (0, m.jsx)(n.li, { children: 'Spati\xebren van woorden naar ten minste 0,16 keer de lettergrootte.' }), '\n'] }), '\n', (0, m.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, m.jsxs)(n.ul, { children: ['\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/voorkeur/', children: 'Let op voorkeursinstellingen voor typografie' }) }), '\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/lettergrootte/', children: 'Zorg ervoor dat letters groot genoeg zijn' }) }), '\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/regelafstand/', children: 'Zorg voor een comfortabele regelafstand' }) }), '\n'] })] });
   }
   function A(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(x, { ...e }) }) : x(e);
   }
   t(83329);
   var z = t(83672);
   t(34257);
   function C(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, g.R)(), ...e.components };
    return (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(n.p, { children: 'Als je de tekst vergroot tot 200%, bijvoorbeeld via browserzoom of via de browserinstellingen voor tekstgrootte, blijft de tekst in de component volledig zichtbaar.' }), '\n', (0, m.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, m.jsxs)(n.ul, { children: ['\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/voorkeur/', children: 'Let op voorkeursinstellingen voor typografie' }) }), '\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/lettergrootte/', children: 'Zorg ervoor dat letters groot genoeg zijn' }) }), '\n'] })] });
   }
   function T(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(C, { ...e }) }) : C(e);
   }
   t(36369);
   function R(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, g.R)(), ...e.components };
    return (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(n.p, { children: 'Interactieve elementen in de component zijn bedienbaar met het toetsenbord.' }), '\n', (0, m.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, m.jsxs)(n.ul, { children: ['\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/formulieren/toetsenbord/', children: 'Toetsenbordtoegankelijkheid' }) }), '\n'] })] });
   }
   function S(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(R, { ...e }) }) : R(e);
   }
   function L(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, g.R)(), ...e.components };
    return (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(n.p, { children: 'Interactieve elementen in de component hebben een goed zichtbare focusindicator met een minimale dikte van 2 pixels.' }), '\n', (0, m.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, m.jsxs)(n.ul, { children: ['\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/formulieren/visueel-ontwerp/focus-goed-zichtbaar/', children: 'Maak toetsenbordfocus goed zichtbaar' }) }), '\n'] })] });
   }
   function D(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(L, { ...e }) }) : L(e);
   }
   function G(e) {
    const n = { code: 'code', p: 'p', ...(0, g.R)(), ...e.components };
    return (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(n.p, { children: 'De Skip Link naar de hoofdinhoud van de pagina is het eerste interactieve element op de pagina dat toetsenbordfocus krijgt. Overige Skip Links naar andere onderdelen van de pagina, zoals het hoofdmenu, volgen daarna.' }), '\n', (0, m.jsxs)(n.p, { children: ['De Skip Link verwijst naar de plek op de pagina waar de hoofdinhoud start. Dit is bijvoorbeeld de ', (0, m.jsx)(n.code, { children: 'main' }), ' van de pagina. Omdat dit normaal gesproken geen interactief element is, moet het element focusbaar gemaakt worden. Aangezien het niet de bedoeling is dat de ', (0, m.jsx)(n.code, { children: 'main' }), ' in de normale focusvolgorde van de pagina voorkomt, kun je hiervoor ', (0, m.jsx)(n.code, { children: 'tabindex="-1"' }), ' gebruiken. Geef het vervolgens een ', (0, m.jsx)(n.code, { children: 'id' }), ' attribuut mee, bijvoorbeeld ', (0, m.jsx)(n.code, { children: 'id="hoofdinhoud"' }), ' waar je in de Skip Link in het ', (0, m.jsx)(n.code, { children: 'href' }), ' attribuut naar verwijst. Vergeet niet ook een focusstijl in te stellen voor het element waar je naar verwijst, zodat toetsenbordgebruikers weten waar ze zich op de pagina bevinden.'] }), '\n', (0, m.jsxs)(n.p, { children: ['Let op: Bevat je ', (0, m.jsx)(n.code, { children: 'main' }), ' w\xe9l herhalende content? Gebruik dan een ander element n\xe1 de herhalende content.'] }), '\n', (0, m.jsx)(n.p, { children: 'Let op: Heeft je website een cookiemelding die altijd over een deel van de pagina staat, waardoor bezoekers de cookiemelding \xe9\xe9rst weg moeten klikken om verder te gaan? Zorg er dan voor dat de cookiemelding nog v\xf3\xf3r de Skip Links focus krijgt en weggeklikt kan worden.' })] });
   }
   function N(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(G, { ...e }) }) : G(e);
   }
   function M(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, g.R)(), ...e.components };
    return (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(n.p, { children: 'De linktekst in de Skip Link vertelt duidelijk waar de link naar verwijst. Bijvoorbeeld: "Direct naar de inhoud" of "Hoofdinhoud".' }), '\n', (0, m.jsx)(n.p, { children: 'Je kunt er ook voor kiezen om meerdere Skip Links toe te voegen. Zorg er dan voor dat iedere link een unieke beschrijvende linktekst heeft. Een beschrijvende naam voor een Skip Link waarmee bezoekers direct naar de hoofdnavigatie kunnen, is bijvoorbeeld "Direct naar het hoofdmenu".' }), '\n', (0, m.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, m.jsxs)(n.ul, { children: ['\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/content/tekstopmaak/linkteksten/', children: 'Toegankelijke linkteksten' }) }), '\n'] })] });
   }
   function W(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(M, { ...e }) }) : M(e);
   }
   function _(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, g.R)(), ...e.components };
    return (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(n.p, { children: 'Wanneer een interactief element in de component toetsenbordfocus heeft is het element en de focusindicator zichtbaar.' }), '\n', (0, m.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, m.jsxs)(n.ul, { children: ['\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/formulieren/visueel-ontwerp/focus-goed-zichtbaar/', children: 'Maak toetsenbordfocus goed zichtbaar' }) }), '\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/stijl/kleuren/voorkeuren/', children: 'Let op voorkeursinstellingen voor kleur' }) }), '\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/stijl/typografie/voorkeur/', children: 'Zorg voor voldoende kleurcontrast voor niet-tekstuele content' }) }), '\n'] })] });
   }
   function F(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(_, { ...e }) }) : _(e);
   }
   function O(e) {
    const n = { p: 'p', ...(0, g.R)(), ...e.components };
    return (0, m.jsx)(n.p, { children: 'Het is mogelijk om een actie te voorkomen of ongedaan te maken als de gebruiker een interactief element in de component indrukt met een enkele aanwijzer zoals een muis of vinger.' });
   }
   function P(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(O, { ...e }) }) : O(e);
   }
   t(60577);
   var E = t(27055);
   function H(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, g.R)(), ...e.components };
    return (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(n.p, { children: 'Het aanwijsgebied van interactieve elementen in de component is minimaal 44 bij 44 pixels.' }), '\n', (0, m.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, m.jsxs)(n.ul, { children: ['\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/formulieren/visueel-ontwerp/invoerveld-goed-aanklikbaar/', children: 'Maak aanklikbare formuliervelden groot genoeg' }) }), '\n', (0, m.jsx)(n.li, { children: (0, m.jsx)(n.a, { href: '/richtlijnen/stijl/ruimte/interactieve-elementen/', children: 'Reserveer ruimte tussen interactieve elementen' }) }), '\n'] })] });
   }
   function $(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(H, { ...e }) }) : H(e);
   }
   var B = t(24838);
   function V(e) {
    const n = { li: 'li', p: 'p', ul: 'ul', ...(0, g.R)(), ...e.components };
    return (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(n.p, { children: "Op pagina's met \xe9\xe9n of meerdere Skip Links:" }), '\n', (0, m.jsxs)(n.ul, { children: ['\n', (0, m.jsx)(n.li, { children: 'Zorg ervoor dat de Skip Link naar de hoofdinhoud van de pagina het eerste interactieve element op de pagina is.' }), '\n', (0, m.jsx)(n.li, { children: 'Zorg ervoor dat de Skip Links naar andere onderdelen van de pagina in dezelfde volgorde staan.' }), '\n'] }), '\n', (0, m.jsx)(n.p, { children: 'Let op: Heeft je website een cookiemelding die altijd over een deel van de pagina staat, waardoor bezoekers de cookiemelding \xe9\xe9rst weg moeten klikken om verder te gaan? Zorg er dan voor dat de cookiemelding nog v\xf3\xf3r de Skip Links focus krijgt en weggeklikt kan worden.' })] });
   }
   function I(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(V, { ...e }) }) : V(e);
   }
   function U(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, g.R)(), ...e.components };
   ...
   function Z(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(U, { ...e }) }) : U(e);
   }
   t(5160);
   var q = t(68413),
    K = t(30536),
   ...
   const de = { title: 'Skip Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Skip Link', pagination_label: 'Skip Link', description: 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.', slug: '/skip-link', keywords: ['anchor link', 'accessibility link', 'blokken omzijlen', 'direct naar link', 'direct naar x', 'content', 'go to content', 'hidden link', 'inhoud', 'inhoud overslaan', 'jump link', 'jump to', 'jump to main content', 'keyboard', 'link', 'naar content', 'naar de inhoud', 'navigeer snel naar', 'overslaan', 'quick link', 'screen reader link', 'section', 'skip link', 'skip links', 'skiplinks', 'skipnav', 'skip to content', 'skip to main', 'skip navigation', 'skip to section', 'skip nav', 'snel naar inhoud', 'spring naar inhoud', 'springlink', 'springplank link'] },
    ...
    ue = {},
    pe = 'Skip Link',
    me = 'Verborgen mogelijkheid om snel naar een ander deel van de pagina te navigeren zonder gebruik te maken van een muis of touchscreen.',
    ge = 74,
    je = j.find((e) => e.number === ge),
    ke = [{ value: 'Anatomie', id: 'anatomie', level: 2 }, { value: 'Candidate component gebruiken', id: 'candidate-component-gebruiken', level: 2 }, { value: 'Design tokens', id: 'design-tokens', level: 3 }, { value: 'CSS', id: 'css', level: 2 }, { value: 'React', id: 'react', level: 2 }, { value: 'Figma', id: 'figma', level: 2 }, { value: 'Checklist voor toegankelijkheid', id: 'checklist-voor-toegankelijkheid', level: 2 }, ...f.RM, { value: 'Acceptatiecriteria bij gebruik', id: 'acceptatiecriteria-bij-gebruik', level: 3 }, ...v.RM, { value: 'Acceptatiecriteria van de component', id: 'acceptatiecriteria-van-de-component', level: 3 }, ...k.RM, { value: 'Community implementaties', id: 'community-implementaties', level: 2 }, { value: 'Definition of Done', id: 'definition-of-done', level: 2 }, { value: 'Help component verbeteren', id: 'help-component-verbeteren', level: 2 }];
   function ve(e) {
    const n = { h2: 'h2', h3: 'h3', p: 'p', ...(0, g.R)(), ...e.components };
    return (0, m.jsxs)(m.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, m.jsx)(re.Fc, { component: je, headingLevel: 1, description: me }),
      '\n',
      (0, m.jsx)(n.p, { children: "Gebruik de Skip Link zodat gebruikers met een toetsenbord of hulpsoftware makkelijk contentblokken kunnen overslaan. Bijvoorbeeld navigatie die op meerdere pagina's herhaald wordt." }),
      '\n',
      (0, m.jsx)(ne.e, { component: je }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, m.jsx)(te.H, { component: je, illustration: b }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'candidate-component-gebruiken', children: 'Candidate component gebruiken' }),
      '\n',
      (0, m.jsx)(n.h3, { id: 'design-tokens', children: 'Design tokens' }),
      '\n',
      (0, m.jsx)(ie.B, { tokens: le }),
      '\n',
      (0, m.jsx)(se.o, { omitH1: !0, headingLevel: 3, children: (0, m.jsx)(ae, {}) }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'checklist-voor-toegankelijkheid', children: 'Checklist voor toegankelijkheid' }),
      '\n',
      (0, m.jsx)(f.Ay, {}),
      '\n',
      (0, m.jsx)(n.h3, { id: 'acceptatiecriteria-bij-gebruik', children: 'Acceptatiecriteria bij gebruik' }),
      '\n',
      (0, m.jsx)(v.Ay, {}),
      '\n',
      (0, m.jsx)(ce.b, {
       headingLevel: '4',
       items: [
        { title: 'De tekstkleur van de Skip Link heeft voldoende contrast met de achtergrondkleur.', sc: '1.4.3', status: '', component: (0, m.jsx)(z.Ay, {}), tags: ['designer'] },
        { title: 'Het label van de Skip Link bestaat uit tekst, niet uit een afbeelding van tekst.', sc: '1.4.5', status: '', component: (0, m.jsx)(X.Ay, {}), tags: ['developer', 'contentmaker'] },
        { title: 'De Skip Link slaat 1 of meerdere herhalende contentblokken over.', sc: '2.4.1', status: '', component: (0, m.jsx)(Q.Ay, {}), tags: ['developer'] },
        { title: 'De Skip Link staat vooraan in de focusvolgorde van een pagina en verwijst naar de eerste niet-herhalende content op de pagina.', sc: '2.4.3', status: '', component: (0, m.jsx)(N, {}), tags: ['developer'] },
        { title: 'De linktekst van de Skip Link beschrijft duidelijk het linkdoel.', sc: '2.4.4', status: '', component: (0, m.jsx)(W, {}), tags: ['developer', 'contentmaker'] },
        { title: 'De Skip Link wordt niet bedekt door een ander element op de pagina.', sc: '2.4.11', status: '', component: (0, m.jsx)(Y.Ay, {}), tags: ['developer'] },
        { title: 'Als de tekst van de Skip Link in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: (0, m.jsx)(B.Ay, {}), tags: ['developer', 'contentmaker'] },
        { title: "Skip Links die op meerdere pagina's voorkomen staan op iedere pagina vooraan in de focusvolgorde van een pagina.", sc: '3.2.3', status: '', component: (0, m.jsx)(I, {}), tags: ['developer', 'designer'] },
       ],
      }),
      '\n',
      (0, m.jsx)(n.h3, { id: 'acceptatiecriteria-van-de-component', children: 'Acceptatiecriteria van de component' }),
      '\n',
      (0, m.jsx)(k.Ay, {}),
      '\n',
      (0, m.jsx)(ce.b, {
       headingLevel: '4',
       items: [
        { title: 'Als je de tekst vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: (0, m.jsx)(T, {}), tags: ['developer'] },
        { title: 'Als je de hele webpagina inzoomt tot 400% veroorzaakt de Skip Link geen horizontale scrollbalk en blijft alle tekst op de pagina leesbaar.', sc: '1.4.10', status: '', component: (0, m.jsx)(K.Ay, {}), tags: ['developer', 'designer'] },
        { title: 'De tekst in de Skip Link blijft zichtbaar als je de tekstafstand vergoot.', sc: '1.4.12', status: '', component: (0, m.jsx)(A, {}), tags: ['developer', 'designer'] },
        { title: 'Je kunt de Skip Link focussen met de tabtoets en activeren met de entertoets.', sc: '2.1.1', status: '', component: (0, m.jsx)(S, {}), tags: ['developer'] },
        { title: 'Als een gebruiker de Skip Link focust met het toetsenbord, dan moet deze ook weer weg kunnen gaan met het toetsenbord.', sc: '2.1.2', status: '', component: (0, m.jsx)(J.Ay, {}), tags: ['developer'] },
        { title: 'De Skip Link heeft een zichtbare focusindicator.', sc: '2.4.7', status: '', component: (0, m.jsx)(F, {}), tags: ['developer', 'designer'] },
        { title: 'De Skip Link heeft een zichtbare focusindicator met een dikte van minimaal 2 pixels.', sc: '2.4.13', status: '', component: (0, m.jsx)(D, {}), tags: ['developer', 'designer'] },
        { title: 'De Skip Link activeren met een enkele aanwijzer kan voorkomen of geannuleerd worden.', sc: '2.5.2', status: '', component: (0, m.jsx)(P, {}), tags: ['developer'] },
        { title: 'De zichtbare naam van de Skip Link komt voor in de toegankelijke naam.', sc: '2.5.3', status: '', component: (0, m.jsx)(E.Ay, {}), tags: ['developer'] },
        { title: 'Het aanwijsgebied van de Skip Link is groot genoeg.', sc: '2.5.5', status: '', component: (0, m.jsx)($, {}), tags: ['developer'] },
        { title: 'Als de Skip Link toetsenbordfocus krijgt vindt er geen contextwijziging plaats.', sc: '3.2.1', status: '', component: (0, m.jsx)(ee.Ay, {}), tags: ['developer'] },
        { title: 'Skip Links met gelijke functies hebben hetzelfde uiterlijk en hetzelfde label.', sc: '3.2.4', status: '', component: (0, m.jsx)(Z, {}), tags: ['developer', 'designer'] },
        { title: 'De Skip Link heeft een rol van link.', sc: '4.1.2', status: '', component: (0, m.jsx)(q.Ay, {}), tags: ['developer'] },
       ],
      }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
      '\n',
      (0, m.jsx)(re.mu, { component: je, headingLevel: 3 }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, m.jsx)(re.VK, { component: je, headingLevel: 3 }),
      '\n',
      (0, m.jsx)(n.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }),
      '\n',
      (0, m.jsx)(re.$9, { component: je, headingLevel: 3 }),
     ],
    });
   }
   function fe(e = {}) {
    const { wrapper: n } = { ...(0, g.R)(), ...e.components };
    return n ? (0, m.jsx)(n, { ...e, children: (0, m.jsx)(ve, { ...e }) }) : ve(e);
   }
  },
  57837(e, n, t) {
   'use strict';
   ...
   var h = (0, a.forwardRef)(function (e, n) {
    var t = e.children,
     r = e.className,
     a = (0, i.A)(e, l);
    return (0, s.jsx)('code', d(d({ dir: 'ltr', translate: 'no', className: (0, o.$)('nl-code', r) }, a), {}, { ref: n, children: t }));
   });
   h.displayName = 'Code';
   !(function (e, n) {
    void 0 === n && (n = {});
  ...
  84068(e, n, t) {
   ...
   var r = t(12013),
    ...
    o = t(4398),
    a = t(86070);
   const l = ({ children: e }) => (0, a.jsx)('ol', { className: 'nlds-anatomy-list', children: e }),
    c = ({ children: e }) => (0, a.jsx)('li', { className: 'nlds-anatomy-list__item', children: e }),
    d = ({ component: e, illustration: n }) => {
     const { title: d } = e,
      h = (0, o.fX)(d),
      u = s.lazy(() => t(51580)(`./${h}-docs/docs/anatomy/anatomy.md`).catch(() => ({ default: () => null })));
     return (0, a.jsx)(s.Suspense, { fallback: null, children: (0, a.jsxs)('figure', { className: (0, i.A)('component-anatomy'), children: [n && (0, a.jsx)(n, { height: null, className: (0, i.A)('component-anatomy__illustration') }), n && u && (0, a.jsx)('figcaption', { children: (0, a.jsx)(r.o, { omitH1: !0, headingLevel: 1, components: { ol: ({ children: e }) => (0, a.jsx)(l, { children: e }), li: ({ children: e }) => (0, a.jsx)(c, { children: e }) }, children: (0, a.jsx)(u, {}) }) })] }) });
    };
  },
  90495(e, n, t) {
   'use strict';
  ...
  95565(e, n, t) {
   ...
   var r = t(14537),
    ...
    c = t(83386),
    d = t(86070);
   const h = { figma: (0, d.jsx)(s.A, {}), github: (0, d.jsx)(o.A, {}), npm: (0, d.jsx)(a.A, {}), storybook: (0, d.jsx)(l.A, {}) },
         ...
         children: t
          ...
          .map((e) => {
           const t = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            a = e.tasks.filter(({ name: e, value: n }) => o.has(e) && URL.canParse(n) && 'https:' === new URL(n).protocol);
           return (0, d.jsx)(
            p.Zp,
            {
             className: 'implementation-card',
             children: (0, d.jsxs)(p.Wu, {
              children: [
               ...
               (a.length > 0 || s.length > 0) && (0, d.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               a.length > 0 &&
                (0, d.jsx)(d.Fragment, {
