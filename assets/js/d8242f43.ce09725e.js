 ...
 [8238],
 {
  ...
  15175(e, n, o) {
   ...
   function i({ lineNumber: e, syntax: n, textContent: o, trim: i }) {
    ...
    const { title: u, type: h } = (0, t.useContext)(r.x),
     p = (0, t.useId)();
    return (i && (d = d.trim()), (0, a.jsx)(s.f4, { theme: c, code: d, language: n || '', children: ({ style: n, tokens: o, getLineProps: s, getTokenProps: t }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, a.jsx)(l.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': p, style: n, children: o.map((n, o) => (0, a.jsxs)('span', { ...s({ line: n }), children: [e && (0, a.jsx)('span', { children: o + 1 }), n.map((e, n) => (0, a.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, o)) })] }) }));
   }
  },
  18439(e, n, o) {
   o.d(n, { R: () => r, x: () => c });
  ...
  70348(e, n, o) {
   ...
   const c = ({ className: e, ...n }) => {
     const o = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', e);
     return (0, r.jsx)('div', { className: o, children: n.children });
    },
    a = ({ className: e, label: n, heading: o, headingLevel: c, headingApperance: a, ...i }) => {
     const d = (0, l.A)('utrecht-accordion__section', e);
     return (0, r.jsxs)('details', { className: d, ...i, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(s.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [o && (0, r.jsx)(t.D, { level: c, appearance: a, children: o }), n] })] }) }), (0, r.jsx)('div', { className: 'utrecht-accordion__panel', children: i.children })] });
    };
  },
  80731(e, n, o) {
   o.d(n, { H: () => x });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: o }) => {
       ...
       return (0, b.jsxs)('div', { className: (0, t.A)('ma-canvas-astro', o), children: [(0, b.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: s } }), (0, b.jsx)(g.n, { children: (0, b.jsx)(g.K, { label: 'Code', children: (0, b.jsx)('pre', { className: 'language-html nl-code-block', children: (0, b.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: p = !0, children: m, container: g = 'document', language: x, designTokens: y }) => {
         ...
         children: [
          ...
          p &&
           (0, b.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, b.jsx)(l.M, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: z, trim: !0 }),
             n &&
              (0, b.jsx)('div', {
