...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [51127],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => a, KF: () => m, mJ: () => p, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => s, kD: () => b, B2: () => h, Pc: () => l, f4: () => o, GT: () => k, fX: () => i, eQ: () => v, B_: () => x, o_: () => j, Rc: () => _ });
   ...
   const g = (e) => [...e].sort((e, n) => d.indexOf(e) - d.indexOf(n)),
    ...
    p = (e) => g(c(e.projects.flatMap((e) => u(e)))),
    f = (e) => {
     const n = u(e),
      t = ((e) => {
  ...
  37131(e, n, t) {
   ...
   const p = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: a && (0, d.jsx)(g.D, { state: a }), children: e.title }), (0, d.jsx)(r.fz, { lead: !0, children: t })] });
    },
    b = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
  ...
  90147(e, n, t) {
   (t.r(n), t.d(n, { assets: () => g, component: () => j, componentName: () => f, contentTitle: () => c, default: () => b, description: () => h, frontMatter: () => d, issueNumber: () => u, metadata: () => r, relayStep: () => p, title: () => m, toc: () => x }));
