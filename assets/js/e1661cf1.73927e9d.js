 ...
 [29865],
 {
  37424: (e, t, n) => {
   ...
   const o = { title: 'Form Navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Navigation', pagination_label: 'Form Navigation', description: 'Overzicht van stappen in een formulier, met de mogelijkheid om direct naar beschikbare stappen te navigeren.', slug: '/form-navigation', keywords: ['form navigation', 'formulier navigatie', 'formulier', 'formulierstap', 'formulier stappen', 'form steps', 'meter', 'progress', 'progress indicator', 'progress list', 'progress navigation', 'progress stepper', 'progress tracker', 'stap', 'stepform', 'stepper', 'stepper vertical', 'stepper indicator', 'steps', 'steps list', 'vertical stepper'] },
    a = void 0,
    l = { id: 'componenten/form-navigation/index', title: 'Form Navigation', description: 'Overzicht van stappen in een formulier, met de mogelijkheid om direct naar beschikbare stappen te navigeren.', source: '@site/docs/componenten/form-navigation/index.mdx', sourceDirName: 'componenten/form-navigation', slug: '/form-navigation', permalink: '/form-navigation', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-navigation/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form Navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Navigation', pagination_label: 'Form Navigation', description: 'Overzicht van stappen in een formulier, met de mogelijkheid om direct naar beschikbare stappen te navigeren.', slug: '/form-navigation', keywords: ['form navigation', 'formulier navigatie', 'formulier', 'formulierstap', 'formulier stappen', 'form steps', 'meter', 'progress', 'progress indicator', 'progress list', 'progress navigation', 'progress stepper', 'progress tracker', 'stap', 'stepform', 'stepper', 'stepper vertical', 'stepper indicator', 'steps', 'steps list', 'vertical stepper'] }, sidebar: 'componenten', previous: { title: 'Form Field Label', permalink: '/form-field-label' }, next: { title: 'Form Summary', permalink: '/form-summary' } },
    u = {},
    h = [
  ...
  35038: (e, t, n) => {
   ...
   const c = (e) => {
     ...
     return (0, s.jsx)('div', { className: (0, i.Z)('card__illustration', t && `card__illustration--${t}`, r), ...c, children: n });
    },
    ...
    a = (e) => {
     ...
     const u = (e) => ('article' === o ? (0, s.jsx)('article', { ...e }) : 'section' === o ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      h = (0, s.jsx)(u, { className: (0, i.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, c), children: l });
  ...
  8657: (e, t, n) => {
   ...
   var r = n(74824),
    ...
    l = n(32636),
    u = n(52676);
   const h = { figma: (0, u.jsx)(s.Z, {}), github: (0, u.jsx)(c.Z, {}), npm: (0, u.jsx)(o.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
   ...
   const _ = (e) => {
               ...
               s.length > 0 &&
                (0, u.jsx)(u.Fragment, {
                 children: s.map((e) => {
                  ...
                  return (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.X6, { level: n + 2, children: [i, ' in ', t] }), (0, u.jsx)(r.Mc, { links: s.map((e) => ({ children: e.description, icon: (0, u.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
    ...
    A = (e) => {
     ...
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(g.V, { level: n, suffix: s && (0, u.jsx)(p.y, { state: s }), children: t.title }), (0, u.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  41757: (e, t, n) => {
   ...
   var r = n(4814),
    i = n(52676);
   const s = (e) => {
    let { children: t, className: n, level: s = 1, suffix: c, ...o } = e;
    return (0, i.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${s}`, n), ...o, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), c && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [c ? ' ' : '', c] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => o, Ee: () => u, Q6: () => s, U: () => j, Yr: () => g, d: () => h, e9: () => c, fO: () => b, mA: () => i, ps: () => m, qU: () => f, s0: () => v, zP: () => y });
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        ...
        return { brand: o.toLowerCase(), name: i, id: s, value: c, description: a };
       });
