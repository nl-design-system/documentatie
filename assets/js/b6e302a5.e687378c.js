/*! For license information please see b6e302a5.e687378c.js.LICENSE.txt */
'use strict';
 ...
 [40415],
 {
  ...
  24456(e, n, i) {
   ...
   const o = ({ children: e, ...n }) => {
    ...
    a = ({ className: e, boxContent: n, ...i }) => (0, r.jsx)(o, { className: (0, t.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...i });
  },
  29680(e, n, i) {
   i.d(n, { v: () => a });
   var t = i(24456),
  ...
  84471(e, n, i) {
   i.d(n, { bo: () => s, KF: () => h, mJ: () => p, VZ: () => S, cR: () => y, Pv: () => k, qZ: () => o, kD: () => w, QQ: () => C, B2: () => v, Pc: () => d, f4: () => a, GT: () => f, fX: () => r, eQ: () => b, B_: () => j, o_: () => g });
   ...
   function w(e, n = []) {
    return Object.hasOwn(e, '$type') ? [n] : Object.keys(e).flatMap((i) => ('object' == typeof e[i] && null !== e[i] ? w(e[i], [...n, i]) : []));
   }
   function f(e) {
    const n = new Map();
    function i(e) {
