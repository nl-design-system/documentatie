...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [56947],
 {
  ...
  63903(e, n, i) {
   ...
   const t = JSON.parse('{"id":"wcag/2.4.11","title":"WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)","description":"Een onderdeel dat toetsenbordfocus heeft mag niet volledig bedekt zijn.","source":"@site/docs/wcag/2.4.11.mdx","sourceDirName":"wcag","slug":"/wcag/2.4.11","permalink":"/wcag/2.4.11","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.11.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)","title_sm":"2.4.11 Focus niet bedekt (minimum)","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"2.4.11 Focus niet bedekt (minimum)","pagination_label":"WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)","description":"Een onderdeel dat toetsenbordfocus heeft mag niet volledig bedekt zijn.","slug":"2.4.11","conformance_level":"Niveau AA","keywords":["WCAG","AA","bedienbaar","navigeerbaar","operable","navigable","focus not obscured (minimum)","focus"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 2.4.10 Paragraafkoppen","permalink":"/wcag/2.4.10"},"next":{"title":"WCAG-succescriterium 2.4.12 Focus niet bedekt (uitgebreid)","permalink":"/wcag/2.4.12"}}');
   var s = i(86070),
    r = i(18439),
    l = i(51582),
    o = i(66820),
    ...
    h = i(37026),
    u = i(81529);
   const m = { title: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', title_sm: '2.4.11 Focus niet bedekt (minimum)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.11 Focus niet bedekt (minimum)', pagination_label: 'WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)', description: 'Een onderdeel dat toetsenbordfocus heeft mag niet volledig bedekt zijn.', slug: '2.4.11', conformance_level: 'Niveau AA', keywords: ['WCAG', 'AA', 'bedienbaar', 'navigeerbaar', 'operable', 'navigable', 'focus not obscured (minimum)', 'focus'] },
    g = void 0,
    j = {},
  ...
  95857(e, n, i) {
   ...
   const l = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: s, ...l }, o) => {
    const c = { ...l, ref: o, className: r('utrecht-note', { [`utrecht-note--${s}`]: s }, i) };
    return e ? (0, t.jsx)('aside', { ...c, children: n }) : (0, t.jsx)('section', { role: 'note', ...c, children: n });
   });
   l.displayName = 'Note';
   var o = i(29181);
   const c = globalThis.isAstro ? l : o.K7;
  },
 },
]);
