 ...
 [52207],
 {
  ...
  12941(e, n, i) {
   ...
   const s = (e, n) => {
    ...
    d = ({ children: e, omitH1: n = !1, headingLevel: i = 1, baseUrl: t = '', components: s = {} }) => (0, l.jsx)(r.x, { components: { ...c(n, i), ...a(t), ...s }, children: e });
  },
  15042(e, n, i) {
   i.d(n, { p: () => l });
   var r = i(13526),
  ...
  55635(e, n, i) {
   ...
   var t = i(86070),
    ...
    h = i(47219);
   function g(e) {
    const n = { a: 'a', li: 'li', p: 'p', strong: 'strong', ul: 'ul', ...(0, l.R)(), ...e.components };
   ...
   const p = { title: 'WCAG-succescriterium 3.3.6 Foutpreventie (alle)', title_sm: '3.3.6 Foutpreventie (alle)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.3.6 Foutpreventie (alle)', pagination_label: 'WCAG-succescriterium 3.3.6 Foutpreventie (alle)', description: 'Wanneer een gebruiker een formulier invult zorg er dan voor dat gebruiker de ingevulde gegevens kan controleren en corrigeren.', slug: '3.3.6', conformance_level: 'Niveau AAA', keywords: ['WCAG', 'AAA', 'begrijpelijk', 'assistentie bij invoer', 'understandable', 'input assistance', 'error prevention (all)'] },
    v = void 0,
    j = {},
