 ...
 [77068],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    h = n(86070);
   const l = { figma: (0, h.jsx)(i.A, {}), github: (0, h.jsx)(c.A, {}), npm: (0, h.jsx)(s.A, {}), storybook: (0, h.jsx)(o.A, {}) },
    u = ({ brand: e }) => (0, h.jsx)(r.In, { children: l[e] || (0, h.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => y, qZ: () => s, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => c, eQ: () => k, B_: () => v, o_: () => p, Rc: () => x });
   ...
   const u = (e) => [...e].sort((e, t) => h.indexOf(e) - h.indexOf(t)),
    ...
    m = (e) => u(l(e.projects.flatMap((e) => g(e)))),
    y = (e) => {
     const t = g(e),
      n = ((e) => {
  ...
  44594(e, t, n) {
   ...
   const o = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    a = ({ name: e, relayStep: t, description: n }) => {
     const a = (0, c.fX)(t),
      h = o[e] ?? e;
     return (0, s.jsxs)(r.WK, { children: [(0, s.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, i.A)('component-illustration', `component-illustration--${a}`), fill: 'none', children: [(0, s.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, s.jsx)('rect', { width: '960', height: '540' }), (0, s.jsx)('rect', { width: '960', height: '540' })] }), (0, s.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, s.jsx)('use', { href: `/svg/componenten_overzicht_${(0, c.fX)(h)}.svg#component-illustration` })] }), (0, s.jsx)(r.$P, { className: 'component-illustration__caption', children: n })] });
    };
  },
  54565(e, t, n) {
   'use strict';
  ...
  80427(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => u, component: () => p, componentName: () => y, contentTitle: () => l, default: () => f, description: () => j, frontMatter: () => h, issueNumber: () => g, metadata: () => r, relayStep: () => m, title: () => d, toc: () => v }));
   const r = JSON.parse('{"id":"componenten/case-card/index","title":"Case Card","description":"Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.","source":"@site/docs/componenten/case-card/index.mdx","sourceDirName":"componenten/case-card","slug":"/case-card","permalink":"/case-card","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/case-card/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Case Card","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Case Card","pagination_label":"Case Card","description":"Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.","slug":"/case-card","keywords":["aanvraag","afgehandeld","afgerond","archief","archive","archived","bezwaar","beroep","bericht","card","case","case card","complaint","data","dossier","file","gearchiveerd","in behandeling","kenmerk","klacht","lopende zaak","melding","MijnOmgeving","MijnServices","MijnZaken","navigeren","navigate","navigatie","navigation","permit","procedure","record","response","request","terugkoppeling","tile","vergunning","zaak","zaak informatie","zaaknummer","zaaksysteem"]},"sidebar":"componenten","previous":{"title":"Card as Link","permalink":"/card-as-link"},"next":{"title":"Checkbox","permalink":"/checkbox"}}');
   var i = n(86070),
    c = n(18439),
    s = n(36059),
    o = n(85825),
    a = n(44594);
   const h = { title: 'Case Card', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Case Card', pagination_label: 'Case Card', description: 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.', slug: '/case-card', keywords: ['aanvraag', 'afgehandeld', 'afgerond', 'archief', 'archive', 'archived', 'bezwaar', 'beroep', 'bericht', 'card', 'case', 'case card', 'complaint', 'data', 'dossier', 'file', 'gearchiveerd', 'in behandeling', 'kenmerk', 'klacht', 'lopende zaak', 'melding', 'MijnOmgeving', 'MijnServices', 'MijnZaken', 'navigeren', 'navigate', 'navigatie', 'navigation', 'permit', 'procedure', 'record', 'response', 'request', 'terugkoppeling', 'tile', 'vergunning', 'zaak', 'zaak informatie', 'zaaknummer', 'zaaksysteem'] },
    l = void 0,
    u = {},
    d = 'Case Card',
    j = 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.',
    g = 253,
    m = 'help wanted',
    y = 'case-card',
    p = s.find((e) => e.number === g),
    v = [
  ...
  85825(e, t, n) {
   ...
   const m = ({ children: e }) => (0, h.jsx)('ul', { className: 'task-list', children: e }),
    y = ({ checked: e, children: t, title: n, description: r, headingLevel: c = 3 }) => (0, h.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, h.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, h.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, h.jsx)(g.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, h.jsxs)('div', { children: [n ? (0, h.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: c, children: n }) : null, r, t] })] });
   var p = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, h.jsx)(r.If, { sections: c.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, h.jsx)(y, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, h.jsx)(r.fz, { children: (0, h.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
                 ...
                 children: (0, h.jsx)(r.dk, {
                  links: u
                   ...
                   .map((e) => {
                    ...
                    return { children: t.desciption, icon: (0, h.jsx)(c.r, { brand: t.brand }), href: e.value };
                   }),
                 }),
                }),
               o.length > 0 && (0, h.jsx)(h.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, h.jsxs)(h.Fragment, { children: [(0, h.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, h.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, h.jsx)(c.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  90495(e, t, n) {
   ...
   const s = ({ background: e, children: t, className: n, ...r }) => (0, c.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: s = 'div', background: o, children: a }) => {
     const h = (e) => ('article' === s ? (0, c.jsx)('article', { ...e }) : 'section' === s ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      l = (0, c.jsx)(h, { className: (0, i.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, c.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    h = ({ appearance: e = 'medium', children: t, className: n }) => (0, c.jsx)('div', { className: (0, i.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
 },
]);
