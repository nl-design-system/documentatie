  ...
  60710(e) {
   ...
   e.exports = function e() {
    var n,
     ...
     d = arguments.length,
     h = !1;
    for ('boolean' == typeof f && ((h = f), (f = arguments[1] || {}), (p = 2)), (null == f || ('object' != typeof f && 'function' != typeof f)) && (f = {}); p < d; ++p) if (null != (n = arguments[p])) for (t in n) ((r = s(f, t)), f !== (o = s(n, t)) && (h && o && (l(o) || (u = i(o))) ? (u ? ((u = !1), (c = r && i(r) ? r : [])) : (c = r && l(r) ? r : {}), a(f, { name: t, newValue: e(h, c, o) })) : void 0 !== o && a(f, { name: t, newValue: o })));
    return f;
   };
  },
  94988(e, n, t) {
   ...
   var o = {};
   (t.r(o), t.d(o, { attentionMarkers: () => ct, contentInitial: () => ot, disable: () => ft, document: () => rt, flow: () => lt, flowInitial: () => it, insideSpan: () => ut, string: () => at, text: () => st }));
    ...
    const r = (function (e, n) {
      ...
      function f() {
       ...
       if ('/' == e.charAt(0) && '*' == e.charAt(1)) {
        ...
        if (((t += 2), G === e.charAt(t - 1))) return a('End of comment missing');
        var l = e.slice(2, t - 2);
      ...
      function p() {
       var e = i(),
        n = s(X);
       if (n) {
        if ((f(), !s(Y))) return a("property missing ':'");
        var t = s($),
   ...
   function ye(e, n) {
    ...
    const o = { Fragment: n.Fragment, ancestors: [], components: n.components || {}, create: r, elementAttributeNameCase: n.elementAttributeNameCase || 'react', evaluater: n.createEvaluater ? n.createEvaluater() : void 0, filePath: t, ignoreInvalidStyle: n.ignoreInvalidStyle || !1, passKeys: !1 !== n.passKeys, passNode: n.passNode || !1, schema: 'svg' === n.space ? N : j, stylePropertyNameCase: n.stylePropertyNameCase || 'dom', tableCellAlignToStyle: !1 !== n.tableCellAlignToStyle },
     i = xe(o, e, void 0);
   ...
   function xe(e, n, t) {
    return 'element' === n.type
     ? (function (e, n, t) {
        ...
        return (ve(e, l, i, n), ke(l, a), e.ancestors.pop(), (e.schema = r), e.create(n, i, l, t));
       })(e, n, t)
      ...
      return (
       'css' === e.stylePropertyNameCase &&
        (n = (function (e) {
         const n = {};
         let t;
         for (t in e) ce.call(e, t) && (n[Ee(t)] = e[t]);
         return n;
        })(n)),
       ['style', n]
      );
   ...
   function Fe(e) {
    ...
    for (; ++u < e.length; ) {
     for (; u in n; ) u = n[u];
     if (((t = e[u]), u && 'chunkFlow' === t[1].type && 'listItemPrefix' === e[u - 1][1].type && ((a = t[1]._tokenizer.events), (o = 0), o < a.length && 'lineEndingBlank' === a[o][1].type && (o += 2), o < a.length && 'content' === a[o][1].type))) for (; ++o < a.length && 'content' !== a[o][1].type; ) 'chunkText' === a[o][1].type && ((a[o][1]._isInFirstContentOfListItem = !0), o++);
     if ('enter' === t[0]) t[1].contentType && (Object.assign(n, Re(e, u)), (u = n[u]), (s = !0));
   ...
   function Re(e, n) {
    ...
    for (l.events = [], d ? ((d._tokenizer = void 0), (d.previous = void 0)) : g.pop(), p = g.length; p--; ) {
     const n = a.slice(g[p], g[p + 1]),
      t = i.pop();
     (s.unshift([t, t + n.length - 1]), ze(e, t, 2, n));
    }
   ...
   const en = {
    tokenize: function (e) {
     ...
     function o(n) {
      return null === n ? (e.exit('chunkText'), e.exit('paragraph'), void e.consume(n)) : Xe(n) ? (e.consume(n), e.exit('chunkText'), r) : (e.consume(n), o);
     }
    },
   };
   const nn = {
     tokenize: function (e) {
      ...
      function a(r) {
       if (l < t.length) {
        const o = t[l];
        return ((n.containerState = o[1]), e.attempt(o[0].continuation, s, u)(r));
       }
       return u(r);
      }
      function s(e) {
       if ((l++, n.containerState._closeFlow)) {
        ...
        return (ze(n.events, i + 1, 0, n.events.slice(t)), (n.events.length = a), u(e));
       }
       return a(e);
      }
      function u(o) {
      ...
      function m(t) {
       return null === t ? (g(e.exit('chunkFlow'), !0), y(0), void e.consume(t)) : Xe(t) ? (e.consume(t), g(e.exit('chunkFlow')), (l = 0), (n.interrupt = void 0), a) : (e.consume(t), m);
      }
      function g(e, t) {
       ...
       if ((t && a.push(null), (e.previous = o), o && (o.next = e), (o = e), r.defineSkip(e.start), r.write(a), n.parser.lazy[e.start.line])) {
        ...
        (ze(n.events, s + 1, 0, n.events.slice(t)), (n.events.length = e));
       }
      }
      function y(r) {
       let o = t.length;
   ...
   const on = {
     tokenize: function (e, n) {
      ...
      function r(n) {
       return null === n ? o(n) : Xe(n) ? e.check(ln, i, o)(n) : (e.consume(n), r);
      }
      function o(t) {
   ...
   function mn(e, n, t) {
    ...
    const u = {
      consume: function (e) {
       Xe(e) ? (r.line++, (r.column = 1), (r.offset += -3 === e ? 2 : 1), k()) : -1 !== e && (r.column++, r.offset++);
       r._bufferIndex < 0 ? r._index++ : (r._bufferIndex++, r._bufferIndex === l[r._index].length && ((r._bufferIndex = -1), r._index++));
       ((c.previous = e), (s = !0));
      },
      enter: function (e, n) {
       const t = n || {};
       return ((t.type = e), (t.start = h()), c.events.push(['enter', t, c]), a.push(t), t);
      },
      exit: function (e) {
       const n = a.pop();
      ...
      function g(e) {
       return function (t) {
        ((d = (function () {
         ...
         function l() {
          ((r = e), (c.previous = n), (c.currentConstruct = t), (c.events.length = o), (a = i), k());
         }
        })()),
         (p = e),
   ...
   const gn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function i(i) {
      return i === r ? (e.enter('thematicBreakSequence'), l(i)) : o >= 3 && (null === i || Xe(i)) ? (e.exit('thematicBreak'), n(i)) : t(i);
     }
     function l(n) {
     ...
     tokenize: function (e, n, t) {
      ...
      return function (n) {
       ...
       if ('listUnordered' === o ? !r.containerState.marker || n === r.containerState.marker : We(n)) {
        if ((r.containerState.type || ((r.containerState.type = o), e.enter(o, { _container: !0 })), 'listUnordered' === o)) return (e.enter('listItemPrefix'), 42 === n || 45 === n ? e.check(gn, t, s)(n) : s(n));
        if (!r.interrupt || 49 === n) return (e.enter('listItemPrefix'), e.enter('listItemValue'), a(n));
       }
       return t(n);
      };
      function a(n) {
       return We(n) && ++l < 10 ? (e.consume(n), a) : (!r.interrupt || l < 2) && (r.containerState.marker ? n === r.containerState.marker : 41 === n || 46 === n) ? (e.exit('listItemValue'), s(n)) : t(n);
      }
      function s(n) {
   ...
   function bn(e, n, t, r, o, i, l, a, s) {
    ...
    function p(n) {
     return 62 === n ? (e.exit('chunkString'), e.exit(a), f(n)) : null === n || 60 === n || Xe(n) ? t(n) : (e.consume(n), 92 === n ? d : p);
    }
    function d(n) {
     return 60 === n || 62 === n || 92 === n ? (e.consume(n), p) : p(n);
    }
    function h(o) {
     return c || (null !== o && 41 !== o && !Ye(o)) ? (c < u && 40 === o ? (e.consume(o), c++, h) : 41 === o ? (e.consume(o), c--, h) : null === o || 32 === o || 40 === o || qe(o) ? t(o) : (e.consume(o), 92 === o ? m : h)) : (e.exit('chunkString'), e.exit(a), e.exit(l), e.exit(r), n(o));
    }
    function m(n) {
   ...
   function wn(e, n, t, r, o, i) {
    ...
    function u(f) {
     return s > 999 || null === f || 91 === f || (93 === f && !a) || (94 === f && !s && '_hiddenFootnoteSupport' in l.parser.constructs) ? t(f) : 93 === f ? (e.exit(i), e.enter(o), e.consume(f), e.exit(o), e.exit(r), n) : Xe(f) ? (e.enter('lineEnding'), e.consume(f), e.exit('lineEnding'), u) : (e.enter('chunkString', { contentType: 'string' }), c(f));
    }
    function c(n) {
     return null === n || 91 === n || 93 === n || Xe(n) || s++ > 999 ? (e.exit('chunkString'), u(n)) : (e.consume(n), a || (a = !$e(n)), 92 === n ? f : c);
    }
    function f(n) {
   ...
   function Sn(e, n, t, r, o, i) {
    ...
    function s(n) {
     return n === l ? (e.exit(i), a(l)) : null === n ? t(n) : Xe(n) ? (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), Ge(e, s, 'linePrefix')) : (e.enter('chunkString', { contentType: 'string' }), u(n));
    }
    function u(n) {
     return n === l || null === n || Xe(n) ? (e.exit('chunkString'), s(n)) : (e.consume(n), 92 === n ? c : u);
    }
    function c(n) {
   ...
   function Cn(e, n) {
    let t;
    return function r(o) {
     if (Xe(o)) return (e.enter('lineEnding'), e.consume(o), e.exit('lineEnding'), (t = !0), r);
   ...
   const Pn = {
     ...
     tokenize: function (e, n, t) {
      ...
      function i(n) {
       return ((o = En(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1))), 58 === n ? (e.enter('definitionMarker'), e.consume(n), e.exit('definitionMarker'), l) : t(n));
      }
      function l(n) {
       return Ye(n) ? Cn(e, a)(n) : a(n);
      }
      function a(n) {
       return bn(e, s, t, 'definitionDestination', 'definitionDestinationLiteral', 'definitionDestinationLiteralMarker', 'definitionDestinationRaw', 'definitionDestinationString')(n);
      }
      function s(n) {
      ...
      function c(i) {
       return null === i || Xe(i) ? (e.exit('definition'), r.parser.defined.push(o), n(i)) : t(i);
      }
     },
    },
    In = {
   ...
   const Tn = {
     ...
     tokenize: function (e, n, t) {
      ...
      function i(n) {
       return null === n ? a(n) : Xe(n) ? e.attempt(An, i, a)(n) : (e.enter('codeFlowValue'), l(n));
      }
      function l(n) {
       return null === n || Xe(n) ? (e.exit('codeFlowValue'), i(n)) : (e.consume(n), l);
      }
      function a(t) {
    ...
    An = {
     tokenize: function (e, n, t) {
      ...
      return o;
      function o(n) {
       return r.parser.lazy[r.now().line] ? t(n) : Xe(n) ? (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), o) : Ge(e, i, 'linePrefix', 5)(n);
      }
      function i(e) {
       const i = r.events[r.events.length - 1];
       return i && 'linePrefix' === i[1].type && i[2].sliceSerialize(i[1], !0).length >= 4 ? n(e) : Xe(e) ? o(e) : t(e);
      }
     },
     partial: !0,
    };
   const On = {
    ...
    tokenize: function (e, n, t) {
     ...
     function o(n) {
      return 35 === n && r++ < 6 ? (e.consume(n), o) : null === n || Ye(n) ? (e.exit('atxHeadingSequence'), i(n)) : t(n);
     }
     function i(t) {
      return 35 === t ? (e.enter('atxHeadingSequence'), l(t)) : null === t || Xe(t) ? (e.exit('atxHeading'), n(t)) : $e(t) ? Ge(e, i, 'whitespace')(t) : (e.enter('atxHeadingText'), a(t));
     }
     function l(n) {
      return 35 === n ? (e.consume(n), l) : (e.exit('atxHeadingSequence'), i(n));
     }
     function a(n) {
      return null === n || 35 === n || Ye(n) ? (e.exit('atxHeadingText'), i(n)) : (e.consume(n), a);
     }
    },
   ...
   const Ln = {
    ...
    tokenize: function (e, n, t) {
     ...
     function l(r) {
      return null === r || Xe(r) ? (e.exit('setextHeadingLine'), n(r)) : t(r);
     }
    },
   ...
   const Dn = ['address', 'article', 'aside', 'base', 'basefont', 'blockquote', 'body', 'caption', 'center', 'col', 'colgroup', 'dd', 'details', 'dialog', 'dir', 'div', 'dl', 'dt', 'fieldset', 'figcaption', 'figure', 'footer', 'form', 'frame', 'frameset', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'head', 'header', 'hr', 'html', 'iframe', 'legend', 'li', 'link', 'main', 'menu', 'menuitem', 'nav', 'noframes', 'ol', 'optgroup', 'option', 'p', 'param', 'search', 'section', 'summary', 'table', 'tbody', 'td', 'tfoot', 'th', 'thead', 'title', 'tr', 'track', 'ul'],
    ...
    Mn = {
     ...
     tokenize: function (e, n, t) {
      ...
      function u(a) {
       return 33 === a ? (e.consume(a), c) : 47 === a ? (e.consume(a), (i = !0), d) : 63 === a ? (e.consume(a), (o = 3), r.interrupt ? n : M) : He(a) ? (e.consume(a), (l = String.fromCharCode(a)), h) : t(a);
      }
      function c(i) {
       return 45 === i ? (e.consume(i), (o = 2), f) : 91 === i ? (e.consume(i), (o = 5), (a = 0), p) : He(i) ? (e.consume(i), (o = 4), r.interrupt ? n : M) : t(i);
      }
      function f(o) {
      ...
      function d(n) {
       return He(n) ? (e.consume(n), (l = String.fromCharCode(n)), h) : t(n);
      }
      function h(a) {
       if (null === a || 47 === a || 62 === a || Ye(a)) {
        const s = 47 === a,
         u = l.toLowerCase();
        return s || i || !zn.includes(u) ? (Dn.includes(l.toLowerCase()) ? ((o = 6), s ? (e.consume(a), m) : r.interrupt ? n(a) : P(a)) : ((o = 7), r.interrupt && !r.parser.lazy[r.now().line] ? t(a) : i ? g(a) : y(a))) : ((o = 1), r.interrupt ? n(a) : P(a));
       }
       return 45 === a || Ue(a) ? (e.consume(a), (l += String.fromCharCode(a)), h) : t(a);
      }
      function m(o) {
       return 62 === o ? (e.consume(o), r.interrupt ? n : P) : t(o);
      }
      function g(n) {
       return $e(n) ? (e.consume(n), g) : C(n);
      }
      function y(n) {
       return 47 === n ? (e.consume(n), C) : 58 === n || 95 === n || He(n) ? (e.consume(n), x) : $e(n) ? (e.consume(n), y) : C(n);
      }
      function x(n) {
       return 45 === n || 46 === n || 58 === n || 95 === n || Ue(n) ? (e.consume(n), x) : v(n);
      }
      function v(n) {
       return 61 === n ? (e.consume(n), k) : $e(n) ? (e.consume(n), v) : y(n);
      }
      function k(n) {
       return null === n || 60 === n || 61 === n || 62 === n || 96 === n ? t(n) : 34 === n || 39 === n ? (e.consume(n), (s = n), b) : $e(n) ? (e.consume(n), k) : w(n);
      }
      function b(n) {
       return n === s ? (e.consume(n), (s = null), S) : null === n || Xe(n) ? t(n) : (e.consume(n), b);
      }
      function w(n) {
       return null === n || 34 === n || 39 === n || 47 === n || 60 === n || 61 === n || 62 === n || 96 === n || Ye(n) ? v(n) : (e.consume(n), w);
      }
      function S(e) {
      ...
      function E(n) {
       return null === n || Xe(n) ? P(n) : $e(n) ? (e.consume(n), E) : t(n);
      }
      function P(n) {
       return 45 === n && 2 === o ? (e.consume(n), O) : 60 === n && 1 === o ? (e.consume(n), L) : 62 === n && 4 === o ? (e.consume(n), F) : 63 === n && 3 === o ? (e.consume(n), M) : 93 === n && 5 === o ? (e.consume(n), z) : !Xe(n) || (6 !== o && 7 !== o) ? (null === n || Xe(n) ? (e.exit('htmlFlowData'), I(n)) : (e.consume(n), P)) : (e.exit('htmlFlowData'), e.check(Fn, R, I)(n));
      }
      function I(n) {
       return e.check(Rn, T, R)(n);
      }
      function T(n) {
       return (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), A);
      }
      function A(n) {
       return null === n || Xe(n) ? I(n) : (e.enter('htmlFlowData'), P(n));
      }
      function O(n) {
      ...
      function D(n) {
       if (62 === n) {
        ...
        return zn.includes(t) ? (e.consume(n), F) : P(n);
       }
       return He(n) && l.length < 8 ? (e.consume(n), (l += String.fromCharCode(n)), D) : P(n);
      }
      function z(n) {
      ...
      function F(n) {
       return null === n || Xe(n) ? (e.exit('htmlFlowData'), R(n)) : (e.consume(n), F);
      }
      function R(t) {
    ...
    Rn = {
     tokenize: function (e, n, t) {
      const r = this;
      return function (n) {
       if (Xe(n)) return (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), o);
       return t(n);
      };
      function o(e) {
   ...
   const jn = {
    ...
    Nn = {
     ...
     tokenize: function (e, n, t) {
      const r = this,
       o = {
        tokenize: function (e, n, t) {
         ...
         function c(n) {
          return n === i ? (o++, e.consume(n), c) : o >= a ? (e.exit('codeFencedFenceSequence'), $e(n) ? Ge(e, f, 'whitespace')(n) : f(n)) : t(n);
         }
         function f(r) {
          return null === r || Xe(r) ? (e.exit('codeFencedFence'), n(r)) : t(r);
         }
        },
        partial: !0,
       };
      ...
      function s(n) {
       return n === i ? (a++, e.consume(n), s) : a < 3 ? t(n) : (e.exit('codeFencedFenceSequence'), $e(n) ? Ge(e, u, 'whitespace')(n) : u(n));
      }
      function u(t) {
       return null === t || Xe(t) ? (e.exit('codeFencedFence'), r.interrupt ? n(t) : e.check(jn, d, x)(t)) : (e.enter('codeFencedFenceInfo'), e.enter('chunkString', { contentType: 'string' }), c(t));
      }
      function c(n) {
       return null === n || Xe(n) ? (e.exit('chunkString'), e.exit('codeFencedFenceInfo'), u(n)) : $e(n) ? (e.exit('chunkString'), e.exit('codeFencedFenceInfo'), Ge(e, f, 'whitespace')(n)) : 96 === n && n === i ? t(n) : (e.consume(n), c);
      }
      function f(n) {
       return null === n || Xe(n) ? u(n) : (e.enter('codeFencedFenceMeta'), e.enter('chunkString', { contentType: 'string' }), p(n));
      }
      function p(n) {
       return null === n || Xe(n) ? (e.exit('chunkString'), e.exit('codeFencedFenceMeta'), u(n)) : 96 === n && n === i ? t(n) : (e.consume(n), p);
      }
      function d(n) {
      ...
      function g(n) {
       return null === n || Xe(n) ? e.check(jn, d, x)(n) : (e.enter('codeFlowValue'), y(n));
      }
      function y(n) {
       return null === n || Xe(n) ? (e.exit('codeFlowValue'), g(n)) : (e.consume(n), y);
      }
      function x(t) {
   ...
   const _n = document.createElement('i');
   function Bn(e) {
    const n = '&' + e + ';';
    _n.innerHTML = n;
    const t = _n.textContent;
   ...
   const Hn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function a(n) {
      return 35 === n ? (e.enter('characterReferenceMarkerNumeric'), e.consume(n), e.exit('characterReferenceMarkerNumeric'), s) : (e.enter('characterReferenceValue'), (o = 31), (i = Ue), u(n));
     }
     function s(n) {
     ...
     function u(a) {
      if (59 === a && l) {
       ...
       return i !== Ue || Bn(r.sliceSerialize(o)) ? (e.enter('characterReferenceMarker'), e.consume(a), e.exit('characterReferenceMarker'), e.exit('characterReference'), n) : t(a);
      }
      return i(a) && l++ < o ? (e.consume(a), u) : t(a);
     }
    },
   };
   const Un = {
   ...
   const qn = {
     ...
     tokenize: function (e, n, t) {
      ...
      return function (n) {
       ...
       return ((i = r.parser.defined.includes(En(r.sliceSerialize({ start: o.end, end: r.now() })))), e.enter('labelEnd'), e.enter('labelMarker'), e.consume(n), e.exit('labelMarker'), e.exit('labelEnd'), a);
      };
      function a(n) {
       return 40 === n ? e.attempt(Wn, u, i ? u : c)(n) : 91 === n ? e.attempt(Kn, u, i ? s : c)(n) : i ? u(n) : c(n);
      }
      function s(n) {
     ...
     resolveTo: function (e, n) {
      ...
      return (
       ...
       (i = Me(i, e.slice(r + 1, r + a + 3))),
       (i = Me(i, [['enter', c, n]])),
       (i = Me(i, hn(n.parser.constructs.insideSpan.null, e.slice(r + a + 4, o - 3), n))),
    ...
    Wn = {
     tokenize: function (e, n, t) {
      ...
      function i(n) {
       return Ye(n) ? Cn(e, a)(n) : u(n);
      }
      function l(e) {
       return t(e);
      }
      function a(n) {
       return 34 === n || 39 === n || 40 === n ? Sn(e, s, t, 'resourceTitle', 'resourceTitleMarker', 'resourceTitleString')(n) : u(n);
      }
      function s(n) {
       return Ye(n) ? Cn(e, u)(n) : u(n);
      }
      function u(r) {
    ...
    Kn = {
     tokenize: function (e, n, t) {
      ...
      function o(e) {
       return r.parser.defined.includes(En(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1))) ? n(e) : t(e);
      }
      function i(e) {
       return t(e);
      }
    ...
    tokenize: function (e, n) {
     ...
     function l(a) {
      ...
      const s = e.exit('attentionSequence'),
       u = Yn(a),
       c = !u || (2 === u && o) || t.includes(a),
       f = !o || (2 === o && u) || t.includes(r);
      return ((s._open = Boolean(42 === i ? c : c && (o || !f))), (s._close = Boolean(42 === i ? f : f && (u || !c))), n(a));
     }
    },
      ...
      if ('enter' === e[c][0] && 'attentionSequence' === e[c][1].type && e[c][1]._close)
       for (t = c; t--; )
        if ('exit' === e[t][0] && 'attentionSequence' === e[t][1].type && e[t][1]._open && n.sliceSerialize(e[t][1]).charCodeAt(0) === n.sliceSerialize(e[c][1]).charCodeAt(0)) {
         ...
         a = e[t][1].end.offset - e[t][1].start.offset > 1 && e[c][1].end.offset - e[c][1].start.offset > 1 ? 2 : 1;
         ...
         (Jn(f, -a),
          ...
          (o = { type: a > 1 ? 'strongText' : 'emphasisText', start: Object.assign({}, e[t][1].end), end: Object.assign({}, e[c][1].start) }),
          ...
          (s = Me(s, hn(n.parser.constructs.insideSpan.null, e.slice(t + 1, c), n))),
          (s = Me(s, [
           ['exit', o, n],
           ['enter', l, n],
           ['exit', l, n],
   ...
   const Zn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function o(n) {
      return He(n) ? (e.consume(n), i) : s(n);
     }
     function i(e) {
      return 43 === e || 45 === e || 46 === e || Ue(e) ? ((r = 1), l(e)) : s(e);
     }
     function l(n) {
      return 58 === n ? (e.consume(n), (r = 0), a) : (43 === n || 45 === n || 46 === n || Ue(n)) && r++ < 32 ? (e.consume(n), l) : ((r = 0), s(n));
     }
     function a(r) {
      return 62 === r ? (e.exit('autolinkProtocol'), e.enter('autolinkMarker'), e.consume(r), e.exit('autolinkMarker'), e.exit('autolink'), n) : null === r || 32 === r || 60 === r || qe(r) ? t(r) : (e.consume(r), a);
     }
     function s(n) {
      return 64 === n ? (e.consume(n), u) : Ve(n) ? (e.consume(n), s) : t(n);
     }
     function u(e) {
      return Ue(e) ? c(e) : t(e);
     }
   ...
   const Gn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function a(n) {
      return 33 === n ? (e.consume(n), s) : 47 === n ? (e.consume(n), k) : 63 === n ? (e.consume(n), x) : He(n) ? (e.consume(n), S) : t(n);
     }
     function s(n) {
      return 45 === n ? (e.consume(n), u) : 91 === n ? (e.consume(n), (i = 0), d) : He(n) ? (e.consume(n), y) : t(n);
     }
     function u(n) {
      return 45 === n ? (e.consume(n), p) : t(n);
     }
     function c(n) {
      return null === n ? t(n) : 45 === n ? (e.consume(n), f) : Xe(n) ? ((l = c), D(n)) : (e.consume(n), c);
     }
     function f(n) {
     ...
     function h(n) {
      return null === n ? t(n) : 93 === n ? (e.consume(n), m) : Xe(n) ? ((l = h), D(n)) : (e.consume(n), h);
     }
     function m(n) {
     ...
     function y(n) {
      return null === n || 62 === n ? L(n) : Xe(n) ? ((l = y), D(n)) : (e.consume(n), y);
     }
     function x(n) {
      return null === n ? t(n) : 63 === n ? (e.consume(n), v) : Xe(n) ? ((l = x), D(n)) : (e.consume(n), x);
     }
     function v(e) {
      return 62 === e ? L(e) : x(e);
     }
     function k(n) {
      return He(n) ? (e.consume(n), b) : t(n);
     }
     function b(n) {
      return 45 === n || Ue(n) ? (e.consume(n), b) : w(n);
     }
     function w(n) {
      return Xe(n) ? ((l = w), D(n)) : $e(n) ? (e.consume(n), w) : L(n);
     }
     function S(n) {
      return 45 === n || Ue(n) ? (e.consume(n), S) : 47 === n || 62 === n || Ye(n) ? C(n) : t(n);
     }
     function C(n) {
      return 47 === n ? (e.consume(n), L) : 58 === n || 95 === n || He(n) ? (e.consume(n), E) : Xe(n) ? ((l = C), D(n)) : $e(n) ? (e.consume(n), C) : L(n);
     }
     function E(n) {
      return 45 === n || 46 === n || 58 === n || 95 === n || Ue(n) ? (e.consume(n), E) : P(n);
     }
     function P(n) {
      return 61 === n ? (e.consume(n), I) : Xe(n) ? ((l = P), D(n)) : $e(n) ? (e.consume(n), P) : C(n);
     }
     function I(n) {
      return null === n || 60 === n || 61 === n || 62 === n || 96 === n ? t(n) : 34 === n || 39 === n ? (e.consume(n), (o = n), T) : Xe(n) ? ((l = I), D(n)) : $e(n) ? (e.consume(n), I) : (e.consume(n), A);
     }
     function T(n) {
      return n === o ? (e.consume(n), (o = void 0), O) : null === n ? t(n) : Xe(n) ? ((l = T), D(n)) : (e.consume(n), T);
     }
     function A(n) {
      return null === n || 34 === n || 39 === n || 60 === n || 61 === n || 96 === n ? t(n) : 47 === n || 62 === n || Ye(n) ? C(n) : (e.consume(n), A);
     }
     function O(e) {
      return 47 === e || 62 === e || Ye(e) ? C(e) : t(e);
     }
     function L(r) {
   ...
   const nt = {
    ...
    tokenize: function (e, n, t) {
     ...
     function r(r) {
      return Xe(r) ? (e.exit('hardBreakEscape'), n(r)) : t(r);
     }
    },
   };
   const tt = {
    ...
    tokenize: function (e, n, t) {
     ...
     function a(n) {
      return null === n ? t(n) : 32 === n ? (e.enter('space'), e.consume(n), e.exit('space'), a) : 96 === n ? ((o = e.enter('codeTextSequence')), (r = 0), u(n)) : Xe(n) ? (e.enter('lineEnding'), e.consume(n), e.exit('lineEnding'), a) : (e.enter('codeTextData'), s(n));
     }
     function s(n) {
      return null === n || 32 === n || 96 === n || Xe(n) ? (e.exit('codeTextData'), a(n)) : (e.consume(n), s);
     }
     function u(t) {
      return 96 === t ? (e.consume(t), r++, u) : r === i ? (e.exit('codeTextSequence'), e.exit('codeText'), n(t)) : ((o.type = 'codeTextData'), s(t));
     }
    },
    resolve: function (e) {
     let n,
   ...
   const rt = { 42: yn, 43: yn, 45: yn, 48: yn, 49: yn, 50: yn, 51: yn, 52: yn, 53: yn, 54: yn, 55: yn, 56: yn, 57: yn, 62: kn },
    ot = { 91: Pn },
    it = { [-2]: Tn, [-1]: Tn, 32: Tn },
    lt = { 35: On, 42: gn, 45: [Ln, gn], 60: Mn, 61: Ln, 95: gn, 96: Nn, 126: Nn },
    at = { 38: Hn, 92: Un },
    st = { [-5]: Vn, [-4]: Vn, [-3]: Vn, 33: Xn, 38: Hn, 42: $n, 60: [Zn, Gn], 91: et, 92: [nt, Un], 93: qn, 95: $n, 96: tt },
    ut = { null: [$n, sn] },
    ct = { null: [42, 95] },
    ft = { null: [] };
   function pt(e) {
    const n = (function (e) {
      const n = {};
      let t = -1;
      for (; ++t < e.length; ) Ne(n, e[t]);
      return n;
     })([o, ...((e || {}).extensions || [])]),
     t = { defined: [], lazy: {}, constructs: n, content: r(en), document: r(nn), flow: r(an), string: r(un), text: r(cn) };
    return t;
    function r(e) {
     return function (n) {
      return mn(t, e, n);
   ...
   function xt(e, n, t) {
    return (
     n && 'object' == typeof n && ((t = n), (n = void 0)),
     (function (e) {
      const n = { transforms: [], canContainEols: ['emphasis', 'fragment', 'heading', 'paragraph', 'strong'], enter: { autolink: i(ne), autolinkProtocol: E, autolinkEmail: E, atxHeading: i(J), blockQuote: i(K), characterEscape: E, characterReference: E, codeFenced: i(Q), codeFencedFenceInfo: l, codeFencedFenceMeta: l, codeIndented: i(Q, l), codeText: i(X, l), codeTextData: E, data: E, codeFlowValue: E, definition: i(Y), definitionDestinationString: l, definitionLabelString: l, definitionTitleString: l, emphasis: i($), hardBreakEscape: i(Z), hardBreakTrailing: i(Z), htmlFlow: i(G, l), htmlFlowData: E, htmlText: i(G, l), htmlTextData: E, image: i(ee), label: l, link: i(ne), listItem: i(re), listItemValue: p, listOrdered: i(te, f), listUnordered: i(te), paragraph: i(oe), reference: _, referenceString: l, resourceDestinationString: l, resourceTitleString: l, setextHeading: i(J), strong: i(le), thematicBreak: i(se) }, exit: { atxHeading: s(), atxHeadingSequence: b, autolink: s(), autolinkEmail: W, autolinkProtocol: q, blockQuote: s(), characterEscapeValue: P, characterReferenceMarkerHexadecimal: H, characterReferenceMarkerNumeric: H, characterReferenceValue: U, characterReference: V, codeFenced: s(g), codeFencedFence: m, codeFencedFenceInfo: d, codeFencedFenceMeta: h, codeFlowValue: P, codeIndented: s(y), codeText: s(L), codeTextData: P, data: P, definition: s(), definitionDestinationString: k, definitionLabelString: x, definitionTitleString: v, emphasis: s(), hardBreakEscape: s(T), hardBreakTrailing: s(T), htmlFlow: s(A), htmlFlowData: P, htmlText: s(O), htmlTextData: P, image: s(z), label: F, labelText: M, lineEnding: I, link: s(D), listItem: s(), listOrdered: s(), listUnordered: s(), paragraph: s(), referenceString: B, resourceDestinationString: R, resourceTitleString: j, resource: N, setextHeading: s(C), setextHeadingLineSequence: S, setextHeadingText: w, strong: s(), thematicBreak: s() } };
      kt(n, (e || {}).mdastExtensions || []);
      const t = {};
      return r;
      function r(e) {
       let r = { type: 'root', children: [] };
       const i = { stack: [r], tokenStack: [], config: n, enter: a, exit: u, buffer: l, resume: c, data: t },
        s = [];
       let f = -1;
       for (; ++f < e.length; )
      ...
      function a(e, n, t) {
       (this.stack[this.stack.length - 1].children.push(e), this.stack.push(e), this.tokenStack.push([n, t || void 0]), (e.position = { start: vt(n.start), end: void 0 }));
      }
      function s(e) {
       return n;
       function n(n) {
      ...
      function x(e) {
       ...
       ((t.label = n), (t.identifier = En(this.sliceSerialize(e)).toLowerCase()));
      }
      function v() {
       const e = this.resume();
      ...
      function E(e) {
       ...
       let t = n[n.length - 1];
       ((t && 'text' === t.type) || ((t = ae()), (t.position = { start: vt(e.start), end: void 0 }), n.push(t)), this.stack.push(t));
      }
      function P(e) {
      ...
      function B(e) {
       const n = this.resume(),
        t = this.stack[this.stack.length - 1];
       ((t.label = n), (t.identifier = En(this.sliceSerialize(e)).toLowerCase()), (this.data.referenceType = 'full'));
      }
      function H(e) {
      ...
      function V(e) {
       this.stack.pop().position.end = vt(e.end);
      }
      function q(e) {
       P.call(this, e);
         ...
         (function () {
          ...
          return function (o, i, l) {
           ...
           for (o = t + ('string' == typeof o ? o.toString() : new TextDecoder(i || void 0).decode(o)), c = 0, t = '', r && (65279 === o.charCodeAt(0) && c++, (r = void 0)); c < o.length; ) {
            if (((dt.lastIndex = c), (s = dt.exec(o)), (f = s && void 0 !== s.index ? s.index : o.length), (p = o.charCodeAt(f)), !s)) {
             t = o.slice(c);
             break;
            }
            if (10 === p && c === f && e) (a.push(-3), (e = void 0));
            else
             switch ((e && (a.push(-5), (e = void 0)), c < f && (a.push(o.slice(c, f)), (n += f - c)), p)) {
              case 0:
               (a.push(65533), n++);
               break;
              case 9:
               for (u = 4 * Math.ceil(n / 4), a.push(-2); n++ < u; ) a.push(-1);
               break;
              case 10:
               (a.push(-4), (n = 1));
               break;
   ...
   const Ct = 'object' == typeof self ? self : globalThis,
    Et = (e) =>
     ((e, n) => {
    ...
    Dt = 'function' == typeof structuredClone ? (e, n) => (n && ('json' in n || 'lossy' in n) ? Et(Lt(e, n)) : structuredClone(e)) : (e, n) => Et(Lt(e, n));
   function zt(e) {
    const n = [];
    let t = -1,
     r = 0,
    ...
    for (; ++t < e.length; ) {
     ...
     let l = '';
     if (37 === i && Ue(e.charCodeAt(t + 1)) && Ue(e.charCodeAt(t + 2))) o = 2;
   ...
   function jt(e) {
    return function (n, t, r) {
     return Boolean(_t(n) && e.call(this, n, 'number' == typeof t ? t : void 0, r || void 0));
    };
   }
   function Nt() {
    return !0;
     ...
     function c() {
      ...
      if ('children' in o && o.children) {
       ...
       if (n.children && 'skip' !== p[0])
        for (c = (r ? n.children.length : -1) + l, f = s.concat(n); c > -1 && c < n.children.length; ) {
   ...
   const Qt = {
    ...
    tableRow: function (e, n, t) {
     ...
     for (; ++a < l; ) {
      ...
      (t && ((u.children = e.all(t)), e.patch(t, u), (u = e.applyData(t, u))), s.push(u));
     }
   ...
   function Gt(e, n) {
    const t = n.data || {},
     r = !('value' in n) || Yt.call(t, 'hProperties') || Yt.call(t, 'hChildren') ? { type: 'element', tagName: 'div', properties: {}, children: e.all(n) } : { type: 'text', value: n.value };
    return (e.patch(n, r), e.applyData(n, r));
   }
   function er(e, n) {
    const t = [];
    ...
    const t = (function (e, n) {
      const t = n || $t,
       ...
       a = {
        ...
        one: function (e, n) {
         const t = e.type,
          r = a.handlers[t];
         if (Yt.call(a.handlers, t) && r) return r(a, e, n);
         ...
         return (a.options.unknownHandler || Gt)(a, e, n);
        },
        options: t,
        patch: Jt,
        wrap: er,
     ...
     o = (function (e) {
      const n = 'string' == typeof e.options.clobberPrefix ? e.options.clobberPrefix : 'user-content-',
       ...
       r = e.options.footnoteBackLabel || Ft,
      ...
      for (; ++s < e.footnoteOrder.length; ) {
       ...
       for (; void 0 !== p && ++c <= p; ) {
        ...
        let e = 'string' == typeof t ? t : t(s, c);
        ('string' == typeof e && (e = { type: 'text', value: e }), f.push({ type: 'element', tagName: 'a', properties: { href: '#' + n + 'fnref-' + u + (c > 1 ? '-' + c : ''), dataFootnoteBackref: '', ariaLabel: 'string' == typeof r ? r : r(s, c), className: ['data-footnote-backref'] }, children: Array.isArray(e) ? e : [e] }));
       }
   ...
   function mr(e, n) {
    if (e && e.includes(sr.sep)) throw new Error('`' + n + '` cannot be a path: did not expect `' + sr.sep + '`');
   }
   function gr(e, n) {
   ...
   const xr = function (e) {
     ...
     return (Object.setPrototypeOf(r, n), r);
    },
    vr = {}.hasOwnProperty;
   class kr extends xr {
    constructor() {
    ...
    data(e, n) {
     return 'string' == typeof e ? (2 === arguments.length ? (Cr('data', this.frozen), (this.namespace[e] = n), this) : (vr.call(this.namespace, e) && this.namespace[e]) || void 0) : e ? (Cr('data', this.frozen), (this.namespace = e), this) : this.namespace;
    }
    freeze() {
    ...
    stringify(e, n) {
     ...
     return (Sr('stringify', r), Er(e), r(e, t));
    }
    use(e, ...n) {
     const t = this.attachers,
      r = this.namespace;
     if ((Cr('use', this.frozen), null == e));
   ...
   const Tr = [],
    Ar = { allowDangerousHtml: !0 },
    Or = /^(https?|ircs?|mailto|xmpp)$/i,
    Lr = [
   ...
   function Dr(e) {
    const n = zr(e),
     t = Mr(e);
    return Fr(n.runSync(n.parse(t), t), e);
   }
   function zr(e) {
    const n = e.rehypePlugins || Tr,
     t = e.remarkPlugins || Tr,
     r = e.remarkRehypeOptions ? { ...e.remarkRehypeOptions, ...Ar } : Ar;
   ...
   function Fr(e, n) {
    const t = n.allowedElements,
     ...
     s = n.urlTransform || Rr;
    for (const u of Lr) Object.hasOwn(n, u.from) && (u.from, u.to && u.to, u.id);
    return (
     Ut(e, function (e, n, o) {
   ...
   function Rr(e) {
    const n = e.indexOf(':'),
     ...
     r = e.indexOf('#'),
     o = e.indexOf('/');
    return -1 === n || (-1 !== o && n > o) || (-1 !== t && n > t) || (-1 !== r && n > r) || Or.test(e.slice(0, n)) ? e : '';
   }
  },
 },
]);
