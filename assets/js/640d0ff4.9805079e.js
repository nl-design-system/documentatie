...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [60237],
 {
   ...
   const c = (0, i.createContext)({}),
    d = ({ title: e, appearance: l, description: n, children: i, figure: d }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      h = d ? 'figure' : 'div',
      p = d ? 'figcaption' : 'div';
     return (0, a.jsxs)(h, { className: (0, t.A)('nlds-guideline', `nlds-guideline--${l}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(p, { className: 'nlds-guideline__description', children: ['dont' === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(o.fz, { className: (0, t.A)('nlds-guideline__badge', `nlds-guideline__badge--${l}`), children: [(0, a.jsx)(s.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, a.jsx)('span', { className: 'nlds-guideline__title', children: u.dont })] }), (0, a.jsx)(o.fz, { children: e })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(o.fz, { className: (0, t.A)('nlds-guideline__badge', `nlds-guideline__badge--${l}`), children: [(0, a.jsx)(r.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, a.jsx)('span', { className: 'nlds-guideline__title', children: u.do })] }), (0, a.jsx)(o.fz, { children: e })] }), n] }), (0, a.jsx)('div', { className: 'nlds-guideline__example', children: (0, a.jsx)(c.Provider, { value: { title: e, type: u[l] }, children: i }) })] });
    };
  },
  18439(e, l, n) {
   n.d(l, { R: () => t, x: () => i });
  ...
  40958(e, l, n) {
   (n.r(l), n.d(l, { assets: () => b, contentTitle: () => g, default: () => y, frontMatter: () => v, metadata: () => r, toc: () => j }));
  ...
  58639(e, l, n) {
   ...
   const v = ({ children: e }) => (0, p.jsx)(s.ui, { className: 'nlds-canvas__example-surface', children: (0, p.jsx)(s.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const b = ({ code: e, copy: l = !0, defaultExpandedCode: n = !1, displayCode: b = !0, children: j, container: x = 'document', language: y, designTokens: f }) => {
    ...
    let S = u.Fragment;
    return (
     'paragraph' === x ? (S = m) : 'document' === x ? (S = v) : 'surface' === x && (S = g),
     (0, p.jsxs)('div', {
