/*! For license information please see 2c511687.4048ecd0.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [35062],
 {
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => N, cR: () => w, Pv: () => f, qZ: () => l, kD: () => k, QQ: () => D, B2: () => m, Pc: () => o, f4: () => s, GT: () => j, fX: () => i, eQ: () => v, B_: () => x, o_: () => b });
  ...
  84576(e, n, a) {
   ...
   const o = { title: 'Logo', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Logo', pagination_label: 'Logo', description: 'Afbeelding met het beeldmerk of woordmerk van een organisatie.', issue_number: 339, slug: '/logo', keywords: ['beeldmerk', 'brand', 'brand identity', 'brand logo', 'huisstijl', 'identiteit', 'graphic', 'image', 'logo', 'merkidentiteit', 'pictogram', 'symbol', 'visual identity', 'visual representation', 'visuele representatie', 'word', 'woordmerk'] },
    ...
    g = {},
    c = 'Logo',
    u = 'Afbeelding met het beeldmerk of woordmerk van een organisatie.',
    m = 339,
    h = 'help wanted',
    p = 'logo',
