   ...
   const f = (e) => {
    ...
    return (
     ...
     (0, v.jsxs)('div', {
      ...
      children: [
       _ && (0, v.jsx)('div', { className: (0, a.Z)('nlds-canvas__example'), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, v.jsx)(P, { children: (0, v.jsx)(i.pu, { children: _ }) }) }) }),
       m &&
        (0, v.jsx)('div', {
         className: (0, a.Z)('nlds-canvas__toolbar'),
         children: (0, v.jsx)(i.zx, {
  ...
  41179: (e, n, t) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: t, textContent: d, trim: c } = e,
     g = d;
    const { title: b, type: v } = (0, a.useContext)(o.n),
     u = (0, a.useId)();
    return (
     c && (g = g.trim()),
     (0, s.jsx)(i.y$, {
      ...
      children: (e) => {
       ...
       return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: u, children: ['codevoorbeeld ', v ? `\u201c${v}\u201d` : '', ' ', b ? ': ' : ' ', b] }), (0, s.jsx)(l.dn, { tabIndex: 0, role: b ? 'region' : void 0, 'aria-labelledby': u, style: t, children: i.map((e, t) => (0, s.jsxs)('span', { ...a({ line: e }), children: [n && (0, s.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
   ...
   const d = (0, r.createContext)({}),
    c = (e) => {
     ...
     const b = { do: 'Doen', dont: 'Niet doen' },
      v = g ? 'figure' : 'div',
      u = g ? 'figcaption' : 'div';
     return (0, s.jsxs)(v, { className: (0, o.Z)('nlds-guideline', `nlds-guideline--${t}`), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, s.jsxs)(u, { className: 'nlds-guideline__description', children: ['dont' === t ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(a.nv, { className: (0, o.Z)('nlds-guideline__badge', `nlds-guideline__badge--${t}`), children: [(0, s.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: b.dont })] }), (0, s.jsx)(a.nv, { children: n })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(a.nv, { className: (0, o.Z)('nlds-guideline__badge', `nlds-guideline__badge--${t}`), children: [(0, s.jsx)(i.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: b.do })] }), (0, s.jsx)(a.nv, { children: n })] }), r] }), (0, s.jsx)('div', { className: 'nlds-guideline__example', children: (0, s.jsx)(d.Provider, { value: { title: n, type: b[t] }, children: c }) })] });
    };
  },
  40139: (e, n, t) => {
   t.d(n, { Z: () => r, a: () => o });
