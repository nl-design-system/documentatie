 ...
 [44480],
 {
  ...
  16764(e, n, t) {
   ...
   var p = t(35193),
    ...
    y = t(79532),
    w = t(30758);
   const D = { color: p.A, dimension: j.A, fontFamilies: k.A, fontSizes: x.A, fontWeights: b.A, lineHeights: f.A, other: v.A, textDecoration: y.A },
  ...
  41467(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => V, component: () => Z, contentTitle: () => $, default: () => J, description: () => O, frontMatter: () => P, issueNumber: () => U, metadata: () => i, title: () => E, toc: () => W }));
  ...
  76097(e, n, t) {
   'use strict';
   t.d(n, { bo: () => a, KF: () => u, mJ: () => p, VZ: () => w, cR: () => y, Pv: () => j, qZ: () => r, kD: () => f, B2: () => m, Pc: () => l, f4: () => o, GT: () => v, fX: () => s, eQ: () => b, B_: () => x, o_: () => k });
