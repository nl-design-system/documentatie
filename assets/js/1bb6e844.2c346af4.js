...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  95111: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => u, default: () => x, frontMatter: () => p, metadata: () => j, toc: () => k });
   var r = i(52676),
    t = i(40139),
    s = i(57716),
    l = i(46364),
   ...
   function h(e) {
    ...
    return (0, r.jsx)(n.p, { children: 'Acties waarbij men moet slepen, kunnen ook zonder slepen.' });
   }
   function g(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(h, { ...e }) }) : h(e);
   }
   const p = { title: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.7 Sleepbewegingen', pagination_label: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', description: 'Acties waarbij men moet slepen, kunnen ook zonder slepen.', slug: '2.5.7', keywords: ['WCAG', 'AA', 'bedienbaar', 'input modaliteiten', 'slepen', 'operable', 'input modalities', 'dragging movements'] },
    u = void 0,
    j = { id: 'wcag/2.5.07', title: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', description: 'Acties waarbij men moet slepen, kunnen ook zonder slepen.', source: '@site/docs/wcag/2.5.07.mdx', sourceDirName: 'wcag', slug: '/wcag/2.5.7', permalink: '/wcag/2.5.7', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.5.07.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.7 Sleepbewegingen', pagination_label: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', description: 'Acties waarbij men moet slepen, kunnen ook zonder slepen.', slug: '2.5.7', keywords: ['WCAG', 'AA', 'bedienbaar', 'input modaliteiten', 'slepen', 'operable', 'input modalities', 'dragging movements'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.5.6 Input gelijktijdige invoermechanismen', permalink: '/wcag/2.5.6' }, next: { title: 'WCAG-succescriterium 2.5.8 Grootte van het aanwijsgebied (minimum)', permalink: '/wcag/2.5.8' } },
    m = {},
    k = [
   ...
   function v(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', (0, r.jsx)(l.j, { level: 1, conformanceLevel: 'Niveau AA', children: 'WCAG-succescriterium 2.5.7 Sleepbewegingen' }), '\n', (0, r.jsx)(n.h2, { id: 'in-het-kort', children: 'In het kort' }), '\n', (0, r.jsxs)('dl', { children: [(0, r.jsxs)('div', { class: 'dl__item', children: [(0, r.jsx)('dt', { class: 'dl__term', children: 'Doel' }), (0, r.jsx)('dd', { class: 'dl__definition', children: 'Wees niet afhankelijk van slepen voor acties.' })] }), (0, r.jsxs)('div', { class: 'dl__item', children: [(0, r.jsx)('dt', { class: 'dl__term', children: 'Wat te doen' }), (0, r.jsx)('dd', { class: 'dl__definition', children: 'Als men moet slepen, zorg er ook een andere makkelijke manier is.' })] }), (0, r.jsxs)('div', { class: 'dl__item', children: [(0, r.jsx)('dt', { class: 'dl__term', children: 'Waarom het belangrijk is' }), (0, r.jsx)('dd', { class: 'dl__definition', children: 'Niet iedereen kan slepen.' })] })] }), '\n', (0, r.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, r.jsx)(g, {}), '\n', (0, r.jsx)(n.p, { children: 'Slepen is bijvoorbeeld het indrukken van een muisknop op een plek, de muis bewegen, en op een tweede plek weer los laten. Dit kan ook met andere vormen van bediening zoals aanraken.' }), '\n', (0, r.jsx)(n.p, { children: 'Bij slepen kun je denken aan verschillende patronen:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: 'Een plek vinden op een kaart.' }), '\n', (0, r.jsx)(n.li, { children: 'Een slider waarmee je voor- en achteruit kan in een video, voor volume, of om aantallen in te voeren.' }), '\n', (0, r.jsx)(n.li, { children: 'Objecten die van volgorde veranderd kunnen worden met een "drag and drop"-patroon.' }), '\n', (0, r.jsx)(n.li, { children: 'Een onderdeel dat kan draaien of schuiven, bijvoorbeeld om een kleur uit te kiezen.' }), '\n', (0, r.jsx)(n.li, { children: 'Notities of andere zelfgeschreven teksten die geordend kunnen worden.' }), '\n', (0, r.jsx)(n.li, { children: 'Sliders en carousels die door slepen in een andere stand gaan.' }), '\n'] }), '\n', (0, r.jsx)(n.p, { children: 'Voor al deze situaties moet er ook een manier zijn om hetzelfde te doen, maar dan zonder te slepen. Denk bijvoorbeeld aan een kaart met pijltjes knoppen die geactiveerd kunnen worden. Bij een slider kan ook op de balk geklikt worden, en voor gebruiksvriendelijkheid kunnen er ook knoppen toegevoegd worden die hetzelfde doen.' }), '\n', (0, r.jsxs)(n.p, { children: ['Let op: De andere manier moet ook met een ', (0, r.jsx)(n.a, { href: '/woordenlijst/', children: 'aanwijzer' }), ' bediend kunnen worden, een andere manier via het toetsenbord is niet voldoende voor dit succescriterium.'] }), '\n', (0, r.jsx)(n.p, { children: 'Als slepen noodzakelijk is, of het gedrag van het onderdeel is niet door de bouwer bepaald, dan is er een uitzondering.' }), '\n', (0, r.jsx)(n.h2, { id: 'hoe-te-testen', children: 'Hoe te testen' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: 'Vind alle plekken op een website waar je iets kan doen.' }), '\n', (0, r.jsx)(n.li, { children: 'Als je iets kan doen door te slepen, controleer dan of het ook zonder slepen kan.' }), '\n'] }), '\n', (0, r.jsx)(n.h2, { id: 'tips', children: 'Tips' }), '\n', (0, r.jsxs)(n.p, { children: ['Slepen als enige optie is niet goed. Er moet een makkelijkere manier zijn die ook werkt met bijvoorbeeld muis of aanraking. Denk ook aan andere manieren om een apparaat te bedienen zoals een toetsenbord of screen reader. Dit heb je nodig voor ', (0, r.jsx)(n.a, { href: '/wcag/2.1.1/', children: '2.1.1 Keyboard' }), ' (niveau A).'] }), '\n', (0, r.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, r.jsx)(d.ZP, {}), '\n', (0, r.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#dragging-movements', children: (0, r.jsx)('span', { lang: 'en', children: '2.5.7 Dragging Movements' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#dragging-movements', children: '2.5.7 Sleepbewegingen' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, r.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#dragging-movements', children: (0, r.jsx)('span', { lang: 'en', children: 'Quick Reference 2.5.7 Dragging Movements' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/dragging-movements.html', children: (0, r.jsx)('span', { lang: 'en', children: 'Understanding SC 2.5.7 Dragging Movements' }) }), '.'] }), '\n'] }), '\n', (0, r.jsx)(o.CY, { children: (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(a.ZP, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(c.ZP, {}) })] });
   }
   function x(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
  ...
  57716: (e, n, i) => {
   ...
   const l = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, s.jsx)(r.Z, { components: { ...a(i, t), ...d(l), ...o }, children: n });
    };
  },
  46364: (e, n, i) => {
   i.d(n, { j: () => l });
