 ...
 [710],
 {
  1292(e, n, t) {
   ...
   var r = t(29181),
    ...
    d = t(83386),
    l = t(86070);
   const c = { figma: (0, l.jsx)(i.A, {}), github: (0, l.jsx)(a.A, {}), npm: (0, l.jsx)(s.A, {}), storybook: (0, l.jsx)(o.A, {}) },
    u = ({ brand: e }) => (0, l.jsx)(r.In, { children: c[e] || (0, l.jsx)(d.A, {}) });
  },
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => p, mJ: () => h, VZ: () => A, cR: () => w, Pv: () => f, qZ: () => s, kD: () => b, B2: () => m, Pc: () => d, f4: () => o, GT: () => k, fX: () => a, eQ: () => x, B_: () => j, o_: () => v, Rc: () => _ });
  ...
  44594(e, n, t) {
   ...
   const o = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    d = ({ name: e, relayStep: n, description: t }) => {
     const d = (0, a.fX)(n),
      l = o[e] ?? e;
     return (0, s.jsxs)(r.WK, { children: [(0, s.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, i.A)('component-illustration', `component-illustration--${d}`), fill: 'none', children: [(0, s.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, s.jsx)('rect', { width: '960', height: '540' }), (0, s.jsx)('rect', { width: '960', height: '540' })] }), (0, s.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, s.jsx)('use', { href: `/svg/componenten_overzicht_${(0, a.fX)(l)}.svg#component-illustration` })] }), (0, s.jsx)(r.$P, { className: 'component-illustration__caption', children: t })] });
    };
  },
  54319(e, n, t) {
   (t.r(n), t.d(n, { assets: () => u, component: () => v, componentName: () => f, contentTitle: () => c, default: () => b, description: () => m, frontMatter: () => l, issueNumber: () => g, metadata: () => r, relayStep: () => h, title: () => p, toc: () => j }));
   ...
   var i = t(86070),
    ...
    o = t(80506),
    d = t(44594);
   const l = { title: 'Date Input Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Input Group', pagination_label: 'Date Input Group', description: 'Formulierveld voor een datum die de gebruiker al weet of die van bekende gegevens overgenomen kan worden.', slug: '/date-input-group', keywords: ['date', 'date field', 'date input', 'date input group', 'date selection', 'datum invoer', 'datumveld', 'form', 'formulier', 'formulierelement', 'input field', 'input fields', 'input group', 'invoervelden', 'text field'] },
    c = void 0,
    u = {},
    p = 'Date Input Group',
  ...
  80506(e, n, t) {
   ...
   const h = ({ component: e, headingLevel: n }) => {
            ...
            s.Zp,
            {
             ...
             children: (0, l.jsxs)(s.Wu, {
              children: [
               ...
               (u.length > 0 || o.length > 0) && (0, l.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               u.length > 0 &&
                (0, l.jsx)(l.Fragment, {
               ...
               o.length > 0 && (0, l.jsx)(l.Fragment, { children: o.map(({ frameworkName: e, tasks: t }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, l.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, l.jsx)(a.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    j = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p.p, { level: n, suffix: i && (0, l.jsx)(u.D, { state: i }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: t })] });
    };
  },
  90495(e, n, t) {
   ...
   const s = ({ background: e, children: n, className: t, ...r }) => (0, a.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, t), ...r, children: n }),
    ...
    d = ({ href: e, appearance: n, className: t, component: s = 'div', background: o, children: d }) => {
     const l = (e) => ('article' === s ? (0, a.jsx)('article', { ...e }) : 'section' === s ? (0, a.jsx)('section', { ...e }) : (0, a.jsx)('div', { ...e })),
      c = (0, a.jsx)(l, { className: (0, i.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: d });
