  ...
  43599: (e, n, t) => {
   ...
   const x = (e) => {
    ...
    const _ = 'function' == typeof g ? g() : g,
     ...
     w = 'string' == typeof n ? n : j.uS(z || _),
     [N, C] = (0, h.useState)(w),
     [S, Z] = (0, h.useState)(x);
    (0, h.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(w, { parser: y, plugins: [o.Z, a.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [w]);
    const T = (0, h.useId)();
      ...
      children: [
       ...
       k &&
        (0, m.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, m.jsx)(l.u, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: N, trim: !0 }),
          t &&
           (0, m.jsx)('div', {
  ...
  41179: (e, n, t) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: t, textContent: c, trim: d } = e,
     h = c;
    const { title: j, type: m } = (0, s.useContext)(o.n),
     p = (0, s.useId)();
    return (
     d && (h = h.trim()),
     (0, i.jsx)(r.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', j ? ': ' : ' ', j] }), (0, i.jsx)(l.dn, { tabIndex: 0, role: j ? 'region' : void 0, 'aria-labelledby': p, style: t, children: r.map((e, t) => (0, i.jsxs)('span', { ...s({ line: e }), children: [n && (0, i.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
