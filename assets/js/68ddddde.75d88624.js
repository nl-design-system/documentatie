 ...
 [94192],
 {
  ...
  16764(e, n, t) {
   ...
   var h = t(35193),
    ...
    y = t(79532),
    w = t(30758);
   const S = { color: h.A, dimension: k.A, fontFamilies: j.A, fontSizes: x.A, fontWeights: f.A, lineHeights: b.A, other: v.A, textDecoration: y.A },
  ...
  75390(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => Z, component: () => K, contentTitle: () => U, default: () => Q, description: () => W, frontMatter: () => E, issueNumber: () => J, metadata: () => i, title: () => X, toc: () => q }));
   ...
   const R = [
    ...
    T = [
     ...
     { title: 'De zichtbare naam van de Skip Link komt voor in de toegankelijke naam.', sc: '2.5.3', status: '', component: f.Ay, tags: ['developer'] },
     {
  ...
  76097(e, n, t) {
   'use strict';
   t.d(n, { bo: () => a, KF: () => u, mJ: () => h, VZ: () => w, cR: () => y, Pv: () => k, qZ: () => r, kD: () => b, B2: () => m, Pc: () => l, f4: () => o, GT: () => v, fX: () => s, eQ: () => f, B_: () => x, o_: () => j });
