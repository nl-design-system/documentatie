/*! For license information please see 5c0cafdc.2ab2e462.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [66152],
 {
  39884: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => u, contentTitle: () => g, default: () => k, frontMatter: () => c, metadata: () => m, toc: () => h });
   var s = i(52676),
    t = i(40139),
    a = i(28439),
    r = i(78511),
    ...
    d = (e) => {
     ...
     return k
      ? (0, o.jsxs)('article', {
         ...
         children: [
          (0, o.jsx)(t.X6, { level: i, className: 'dsw-session__title', id: k.subject.toLowerCase().replace(/\s/gi, '-'), children: k.subject }),
          (0, o.jsx)(t.nv, { className: 'dsw-session__subtitle', lead: !0, children: b && b.map((e) => (e?.organisation ? `${e.name} - ${e.organisation}` : e.name)).join(' & ') }),
          c || (k?.videoId && (0, o.jsx)(r.Y, { id: c || k?.videoId, title: k.subject, style: { marginBlock: '20px' } })),
          k && k.isoDateTime && k.isoDateTime > l ? (0, o.jsx)(t.nv, { children: (0, o.jsx)('time', { dateTime: k.isoDateTime, children: new Intl.DateTimeFormat(n, { dateStyle: 'full', timeStyle: 'nl' === n ? 'short' : 'full', timeZone: 'Europe/Amsterdam' }).format(new Date(k.isoDateTime)) }) }) : (0, o.jsx)(o.Fragment, {}),
          g,
          'nl' === n &&
           b.find((e) => {
            let { language: n } = e;
          ...
          m && (0, o.jsxs)(t.nv, { children: [(0, o.jsx)('b', { children: 'Goed te weten:' }), ' Bij deze sessie is een schrijftolk aanwezig', u && (0, o.jsxs)('a', { href: u, children: ['tolktekst', (0, o.jsxs)('span', { className: 'sr-only', children: [' bij ', k.subject] })] }), '.'] }),
          ...
          k && k.icalLink && !c ? (0, o.jsx)(t.nv, { children: (0, o.jsxs)(t.ZP, { href: k.icalLink, download: k.icalLink, appearance: 'primary-action-button', children: [(0, o.jsx)(t.JO, { children: (0, o.jsx)(s.Z, {}) }), (0, o.jsx)('span', { children: 'nl' === n ? (0, o.jsxs)(o.Fragment, { children: ['Zet', (0, o.jsx)('span', { className: 'sr-only', children: k.subject }), ' in je agenda'] }) : (0, o.jsxs)(o.Fragment, { children: ['Add', (0, o.jsx)('span', { className: 'sr-only', children: k.subject }), ' to your calendar'] }) })] }) }) : null,
         ],
        })
      : (0, o.jsx)(o.Fragment, {});
    };
  ...
  78511: (e, n, i) => {
   i.d(n, { Z: () => s });
   var s = (0, i(72315).Z)('outline', 'chevron-right', 'IconChevronRight', [['path', { d: 'M9 6l6 6l-6 6', key: 'svg-0' }]]);
  },
  84263: (e, n, i) => {
   i.d(n, { Z: () => r });
   var s = i(75271),
   ...
   var r = s.forwardRef(function (e, n) {
    var i = s.useState(!1),
     r = i[0],
     o = i[1],
     l = s.useState(e.alwaysLoadIframe || !1),
     d = l[0],
     c = l[1],
     ...
     b = new URLSearchParams(t(t(t(t({}, e.muted ? { mute: '1' } : {}), k ? { autoplay: '1' } : {}), e.enableJsApi ? { enablejsapi: '1' } : {}), e.playlist ? { list: g } : {}));
    e.params &&
    ...
    var y = e.playlist ? ''.concat(v, '/embed/videoseries?').concat(b.toString()) : ''.concat(v, '/embed/').concat(g, '?').concat(b.toString()),
    ...
    return (
     ...
     s.createElement(
      s.Fragment,
      null,
      s.createElement('link', { rel: A, href: S, as: 'image' }),
      s.createElement(s.Fragment, null, r && s.createElement(s.Fragment, null, s.createElement('link', { rel: 'preconnect', href: v }), s.createElement('link', { rel: 'preconnect', href: 'https://www.google.com' }), x && s.createElement(s.Fragment, null, s.createElement('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), s.createElement('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })))),
      s.createElement(
       C,
       {
        ...
        'data-title': u,
        style: t(t({ backgroundImage: 'url('.concat(S, ')') }, { '--aspect-ratio': ''.concat((E / L) * 100, '%') }), K),
       },
       s.createElement('button', { type: 'button', className: N, 'aria-label': ''.concat(p, ' ').concat(u) }),
       d && s.createElement('iframe', { ref: n, className: z, title: u, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: y }),
      ),
     )
    );
   });
