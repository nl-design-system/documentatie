...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [91876],
 {
  ...
  4258(e, n, t) {
   ...
   var a = t(78236),
    i = t(86070);
   const s = ({ id: e, title: n, ...t }) => (0, i.jsx)(a.A, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: n, poster: 'maxresdefault', ...t });
  },
  18439(e, n, t) {
   t.d(n, { R: () => o, x: () => r });
   var a = t(30758);
  ...
  78236(e, n, t) {
   ...
   const r = i.forwardRef(function (e, n) {
    const [t, r] = i.useState(!1),
     ...
     b = i.useMemo(() => (e.playlist ? `${v}/embed/videoseries?${k.toString()}` : `${v}/embed/${c}?${k.toString()}`), [e.playlist, v, c, k]),
    ...
    return (
     ...
     (0, a.jsxs)(a.Fragment, {
      children: [
       ...
       e.seo && !e.playlist && (0, a.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: o(e.id, h, y, v, e.seo) } }),
       ...
       (0, a.jsxs)(I, {
        ...
        children: [e.lazyLoad && !l && (0, a.jsx)('img', { src: y, alt: `${h} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, a.jsx)('button', { type: 'button', className: L, 'aria-label': `${g} ${h}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: g }) }), l && (0, a.jsx)('iframe', { ref: n, className: N, title: h, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
