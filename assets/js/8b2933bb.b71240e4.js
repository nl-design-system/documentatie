(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [48599],
 {
  41418: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => g, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => o, issueNumber: () => y, metadata: () => l, title: () => d, toc: () => h });
   var r = n(52676),
    c = n(40139),
    s = n(99890),
    i = n(8657);
   const o = { title: 'Progress Circle', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress Circle', pagination_label: 'Progress Circle', description: 'Toont de voortgang van een bepaald proces in de vorm van een cirkel.', slug: '/progress-circle' },
    a = void 0,
    l = { id: 'componenten/progress-circle/index', title: 'Progress Circle', description: 'Toont de voortgang van een bepaald proces in de vorm van een cirkel.', source: '@site/docs/componenten/progress-circle/index.mdx', sourceDirName: 'componenten/progress-circle', slug: '/progress-circle', permalink: '/progress-circle', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/progress-circle/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Progress Circle', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress Circle', pagination_label: 'Progress Circle', description: 'Toont de voortgang van een bepaald proces in de vorm van een cirkel.', slug: '/progress-circle' }, sidebar: 'componenten', previous: { title: 'Progress Bar', permalink: '/progress-bar' }, next: { title: 'Progress List', permalink: '/progress-list' } },
    u = {},
    h = [
    ...
    d = 'Progress Circle',
    j = 'Toont de voortgang van een bepaald proces in de vorm van een cirkel.',
    y = 366,
    g = s.find((e) => e.number === y);
   function m(e) {
    const t = { h2: 'h2', ...(0, c.a)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, r.jsx)(i.Rv, { component: g, headingLevel: 1, description: j }), '\n', (0, r.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, r.jsx)(i.cN, { component: g, headingLevel: 3 }), '\n', (0, r.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, r.jsx)(i.W, { component: g, headingLevel: 3 }), '\n', (0, r.jsx)(t.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }), '\n', (0, r.jsx)(i.vM, { component: g, headingLevel: 3 })] });
   }
   function p(e = {}) {
   ...
   const i = (e) => {
    ...
    a = (e) => {
     ...
     const u = (e) => ('article' === o ? (0, s.jsx)('article', { ...e }) : 'section' === o ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      h = (0, s.jsx)(u, { className: (0, c.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, i), children: l });
  ...
  8657: (e, t, n) => {
   ...
   var r = n(74824),
    ...
    l = n(32636),
    u = n(52676);
   const h = { figma: (0, u.jsx)(s.Z, {}), github: (0, u.jsx)(i.Z, {}), npm: (0, u.jsx)(o.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
          ...
          children: [
           (0, u.jsx)(k, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(f, { headingLevel: n + 1, checked: t, title: r, description: (0, x.Q6)(c) }, c);
            }),
           }),
           (0, u.jsx)(r.nv, { children: (0, u.jsxs)(r.rU, { href: `${e.url}?filterQuery=${t.title}`, children: [o(e), ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
            ...
            j.Zb,
            {
             ...
             children: (0, u.jsxs)(j.aY, {
              children: [
               ...
               (o.length > 0 || s.length > 0) && (0, u.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               o.length > 0 &&
                (0, u.jsx)(u.Fragment, {
               ...
               s.length > 0 &&
                (0, u.jsx)(u.Fragment, {
                 children: s.map((e) => {
                  ...
                  return (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.X6, { level: n + 2, children: [c, ' in ', t] }), (0, u.jsx)(r.Mc, { links: s.map((e) => ({ children: e.description, icon: (0, u.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => m, BA: () => o, Ee: () => u, Q6: () => s, U: () => j, Yr: () => p, d: () => h, e9: () => i, fO: () => b, mA: () => c, ps: () => y, qU: () => k, s0: () => v, zP: () => g });
