...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [46190],
 {
  12761(e, n, a) {
   ...
   const x = ({ className: e, ...n }) => {
    ...
    j = ({ className: e, heading: n, headingLevel: a, headingApperance: t, ...r }) => {
     ...
     return (0, g.jsxs)('details', { className: s, ...r, children: [(0, g.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, g.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, g.jsx)('span', { className: 'nl-button__icon-start', children: (0, g.jsx)(f.A, {}) }), (0, g.jsx)('span', { className: 'nl-button__label', children: (0, g.jsx)(b.D, { level: a, appearance: t, children: n }) })] }) }), (0, g.jsx)('div', { className: 'utrecht-accordion__panel', children: r.children })] });
    },
    v = ({ component: e, headingLevel: n }) => {
     const a = e && e.projects.filter((e) => h.f4.includes(e.id)),
      r = a && h.f4.map((e) => a.find((n) => n.id === e)).filter(Boolean);
     return e && (0, g.jsx)(x, { children: r.map((a) => (0, g.jsx)(j, { className: (0, i.A)('ma-definition-of-done', a && `ma-definition-of-done--${(0, h.fX)(a.title)}`), heading: a ? `${a.title} - ${a.progress.value} van ${a.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(c._, { children: a.tasks.map(({ checked: e, name: a, id: t }) => (0, g.jsx)(c.Z, { headingLevel: n + 1, checked: e, heading: a, description: (0, h.qZ)(t) }, t)) }), (0, g.jsx)(t.fz, { children: (0, g.jsxs)(t.N_, { href: `${a.url}?filterQuery=${e.title}`, children: [a.title, ' projectbord op GitHub'] }) })] }) }, a.title)) });
    },
  ...
  28384(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => b, componentName: () => f, contentTitle: () => d, default: () => v, description: () => c, frontMatter: () => g, issueNumber: () => h, metadata: () => t, relayStep: () => p, title: () => m, toc: () => x }));
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => p, VZ: () => D, cR: () => N, Pv: () => f, qZ: () => s, kD: () => v, B2: () => c, Pc: () => o, f4: () => l, GT: () => k, fX: () => r, eQ: () => j, B_: () => x, o_: () => b });
