 ...
 [55335],
 {
  1292(e, n, a) {
   ...
   var t = a(29181),
    ...
    s = a(83386),
    g = a(86070);
   const u = { figma: (0, g.jsx)(i.A, {}), github: (0, g.jsx)(o.A, {}), npm: (0, g.jsx)(l.A, {}), storybook: (0, g.jsx)(r.A, {}) },
    d = ({ brand: e }) => (0, g.jsx)(t.In, { children: u[e] || (0, g.jsx)(s.A, {}) });
  },
  3222(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => h, contentTitle: () => g, default: () => x, description: () => m, frontMatter: () => s, illustration: () => c, issueNumber: () => p, metadata: () => t, title: () => d, toc: () => b }));
  ...
  33062(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => A, cR: () => D, Pv: () => b, qZ: () => l, kD: () => v, B2: () => c, Pc: () => s, f4: () => r, GT: () => j, fX: () => o, eQ: () => k, B_: () => x, o_: () => f, Rc: () => F });
     ...
     return n.map((n) => {
      const t = e.tasks
       ...
       .map(({ name: t, id: i, value: o }) => {
        ...
        return { brand: l.toLowerCase(), name: t, id: i, value: o, description: r };
       });
  ...
  90495(e, n, a) {
   ...
   const l = ({ background: e, children: n, className: a, ...t }) => (0, o.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, a), ...t, children: n }),
    ...
    s = ({ href: e, appearance: n, className: a, component: l = 'div', background: r, children: s }) => {
     const g = (e) => ('article' === l ? (0, o.jsx)('article', { ...e }) : 'section' === l ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      u = (0, o.jsx)(g, { className: (0, i.A)('cardgroup__card', r && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, a), children: s });
     return e ? (0, o.jsx)(t.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: u }) : u;
    },
