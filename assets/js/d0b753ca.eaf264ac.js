 ...
 [47531],
 {
  ...
  35038: (e, t, n) => {
   ...
   const c = (e) => {
    ...
    a = (e) => {
     let { href: t, appearance: n, className: c, component: s = 'div', background: a, children: u } = e;
     const l = (e) => ('article' === s ? (0, o.jsx)('article', { ...e }) : 'section' === s ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      h = (0, o.jsx)(l, { className: (0, i.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, c), children: u });
     return t ? (0, o.jsx)(r.rU, { href: t, boxContent: !0, className: 'cardgroup__link', children: h }) : h;
    },
    u = (e) => {
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => s, Ee: () => l, Q6: () => o, U: () => j, Yr: () => g, d: () => h, e9: () => c, fO: () => b, mA: () => i, ps: () => y, qU: () => k, s0: () => v, zP: () => m });
