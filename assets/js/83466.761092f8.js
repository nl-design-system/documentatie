   ...
   const l = class {
    ...
    render() {
     ...
     return (0, o.h)(
      'div',
      {
       key: '68f6714cc9e818aaec8c28fbd6ad582e8eaa6f33',
      ...
      (0, o.h)('div', { key: '082fed006a759c9c25e954ef6e217add47f7cd77', class: 'utrecht-form-toggle__label utrecht-form-toggle__label--off' }),
      (0, o.h)('div', { key: '68e2770332b982aa279a11c2d6c9ecf3083bd2eb', class: 'utrecht-form-toggle__label utrecht-form-toggle__label--on' }),
      (0, o.h)('div', { key: 'f873dd15cf01359f2029b2e1a28f084de5393b4f', class: (0, c.c)('utrecht-form-toggle__track', t && 'utrecht-form-toggle__track--checked', !t && 'utrecht-form-toggle__track--not-checked', e && 'utrecht-form-toggle__track--disabled') }, (0, o.h)('div', { key: '649cfd6f0fea118b429101ad8b95fbba89b5650b', class: (0, c.c)('utrecht-form-toggle__thumb', t && 'utrecht-form-toggle__thumb--checked', !t && 'utrecht-form-toggle__thumb--not-checked', e && 'utrecht-form-toggle__thumb--disabled') })),
     );
    }
   };
