 ...
 [84367],
 {
  ...
  64333: (e, n, l) => {
   ...
   function r(e) {
    ...
    return (0, a.jsxs)(a.Fragment, { children: ['\n', '\n', '\n', (0, a.jsx)(t.X, { appearance: 'do', title: 'Het label blijft zichtbaar, ook als de gebruiker gaat invullen.', children: (0, a.jsx)(s.X, { language: 'html', children: () => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(n.label, { for: 'dier1', children: 'Wat is je lievelingsdier?' }), (0, a.jsx)(n.input, { type: 'text', id: 'dier1', name: 'lievelingsdier', placeholder: 'Bijvoorbeeld cavia' })] }) }) }), '\n', (0, a.jsx)(t.X, { appearance: 'dont', title: 'Alleen een placeholder gebruiken als zichtbaar label.', children: (0, a.jsx)(s.X, { language: 'html', children: () => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(n.label, { for: 'dier2', class: 'visually-hidden', children: 'Wat is je lievelingsdier?' }), (0, a.jsx)(n.input, { type: 'text', id: 'dier2', name: 'lievelingsdier', placeholder: 'Wat is je lievelingsdier?' })] }) }) })] });
   }
   function i(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
   ...
   function c(e) {
    ...
    return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(n.h1, { id: 'zorg-ervoor-dat-het-label-altijd-zichtbaar-is', children: 'Zorg ervoor dat het label altijd zichtbaar is' }), '\n', (0, a.jsx)(n.p, { children: 'Waarom? Als het label verdwijnt bij het typen kan er verwarring ontstaan: wat moet je ook alweer invullen? Daarom is een placeholder geen goede vervanging van het label.' }), '\n', (0, a.jsxs)(n.p, { children: ['De placeholder kan ook voor verwarring zorgen bij gebruikers. Is het al veld ingevuld? Zie het onderzoek ', (0, a.jsx)(n.a, { href: 'https://www.nngroup.com/articles/form-design-placeholders/', children: (0, a.jsx)('span', { lang: 'en', children: 'Placeholders in Form Fields Are Harmful' }) }), ' van de Nielsen Norman Group.'] }), '\n', (0, a.jsxs)(n.p, { children: ['Een label vertelt ', (0, a.jsx)(n.strong, { children: 'wat' }), ' je moet invullen en een placeholder ', (0, a.jsx)(n.strong, { children: 'hoe' }), ' je een formulierveld moet invullen. Voor een e-mailveld kan het label bijvoorbeeld "Jouw e-mailadres" zijn en de placeholder "', (0, a.jsx)(n.a, { href: 'mailto:naam@voorbeeld.com', children: 'naam@voorbeeld.com' }), '".'] }), '\n', (0, a.jsxs)(n.p, { children: ['De ', (0, a.jsx)(n.strong, { children: 'hoe' }), ' informatie kan ook in een description worden opgenomen, dan blijft deze informatie ook zichtbaar tijdens het invullen.'] }), '\n', (0, a.jsx)(n.p, { children: 'Een andere reden om een label niet te verbergen is om beter te kunnen controleren of alles goed is ingevuld met autocomplete.' }), '\n', (0, a.jsx)(n.p, { children: 'Namen, adressen en telefoonnummers kunnen automatisch vooraf worden ingevuld door de browser. Wanneer het label verborgen is, moet de gebruiker controleren of elke waarde juist is ingevuld bij het goede formulierveld. Dat is veel gemakkelijker, als het label altijd zichtbaar is.' })] });
   }
   function d(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
  ...
  98480: (e, n, l) => {
   ...
   const m = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(a.Tg, { className: b['nlds-canvas__example-surface'], children: (0, h.jsx)(a.BB, { className: (0, o.Z)('utrecht-document--surface', b['nlds-canvas__example-document']), children: (0, h.jsx)(a.nv, { className: b['nlds-canvas__example-paragraph'], children: n }) }) });
   };
   m.displayName = 'ParagraphContainer';
   const v = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(a.Tg, { className: b['nlds-canvas__example-surface'], children: (0, h.jsx)(a.BB, { className: (0, o.Z)('utrecht-document--surface', b['nlds-canvas__example-document']), children: n }) });
   };
   v.displayName = 'DocumentContainer';
   const g = (e) => {
    let { children: n } = e;
    return (0, h.jsx)(a.Tg, { className: b['nlds-canvas__example-surface'], children: n });
   };
   ...
   const _ = (e) => {
    ...
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       w && (0, h.jsx)('div', { className: (0, o.Z)(b['nlds-canvas__example']), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, h.jsx)(E, { children: (0, h.jsx)(a.pu, { children: w }) }) }) }),
       j &&
        (0, h.jsx)('div', {
    ...
    return (
     ...
     (0, t.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, t.jsx)(a.dn, { tabIndex: 0, style: l, children: o.map((e, l) => (0, t.jsxs)('span', { ...s({ line: e }), children: [n && (0, t.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, t.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const b = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     m = u ? 'figcaption' : 'div';
    return (0, i.jsxs)(h, { className: (0, t.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(m, { className: (0, t.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(s.nv, { className: (0, t.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, i.jsx)(a.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: r['nlds-guideline__title'], children: p })] }), (0, i.jsx)(s.nv, { children: n })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(s.nv, { className: (0, t.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, i.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: r['nlds-guideline__title'], children: b })] }), (0, i.jsx)(s.nv, { children: n })] }), c] }), (0, i.jsx)('div', { className: (0, t.Z)(r['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => t });
