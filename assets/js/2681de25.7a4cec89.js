...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [73536],
 {
  ...
  43599: (e, n, t) => {
   ...
   const k = (e) => {
    let { code: n, copy: t = !0, defaultExpandedCode: k = !1, displayCode: x = !0, children: g, container: v = 'document', language: y, designTokens: f } = e;
    ...
    (0, h.useEffect)(() => {
     (async () => {
      const e = await c.ZP.format(N, { parser: y, plugins: [a.Z, o.ZP, i.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [N]);
    const T = (0, h.useId)();
  ...
  41179: (e, n, t) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: t, textContent: d, trim: c } = e,
     h = d;
    const { title: j, type: p } = (0, s.useContext)(a.n),
     m = (0, s.useId)();
    return (
     c && (h = h.trim()),
     (0, i.jsx)(r.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', j ? ': ' : ' ', j] }), (0, i.jsx)(l.dn, { tabIndex: 0, role: j ? 'region' : void 0, 'aria-labelledby': m, style: t, children: r.map((e, t) => (0, i.jsxs)('span', { ...s({ line: e }), children: [n && (0, i.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
