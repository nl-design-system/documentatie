 ...
 [67398],
 {
  57266: (e, t, n) => {
   ...
   const s = { title: 'Switch', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Switch', pagination_label: 'Switch', description: ' ', slug: '/switch', sidebar_custom_props: { illustration: 'SwitchSketch' } },
    a = void 0,
    u = { id: 'componenten/switch/index', title: 'Switch', description: ' ', source: '@site/docs/componenten/switch/index.mdx', sourceDirName: 'componenten/switch', slug: '/switch', permalink: '/switch', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/switch/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Switch', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Switch', pagination_label: 'Switch', description: ' ', slug: '/switch', sidebar_custom_props: { illustration: 'SwitchSketch' } }, sidebar: 'componenten', previous: { title: 'Summary list', permalink: '/summary-list' }, next: { title: 'Table', permalink: '/table' } },
    l = {},
    h = [
