 ...
 [6475],
 {
   ...
   const c = (0, s.createContext)({}),
    u = ({ title: e, appearance: n, description: t, children: s, figure: u }) => {
     const m = { do: 'Doen', dont: 'Niet doen' },
      h = u ? 'figure' : 'div',
      p = u ? 'figcaption' : 'div',
      j = 'string' == typeof t ? (0, d.jsx)(a.oz, { children: t }) : t;
  ...
  58639(e, n, t) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: g = !0, children: v, container: x = 'document', language: y, designTokens: k }) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await c.Ay.format(_, { parser: y, plugins: [o.A, a.Ay, s.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [_]);
    const A = (0, u.useId)();
    let F = u.Fragment;
    return (
     'paragraph' === x ? (F = p) : 'document' === x ? (F = j) : 'surface' === x && (F = b),
     (0, h.jsxs)('div', {
      className: (0, i.A)('nlds-canvas'),
      children: [
       f && (0, h.jsx)('div', { className: (0, i.A)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, h.jsx)(F, { children: (0, h.jsx)(l.v$, { children: f }) }) }) }),
       g &&
        (0, h.jsx)('div', {
