 ...
 [84367],
 {
  ...
  64333: (e, n, l) => {
   ...
   function r(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', (0, o.jsx)(s.X, { appearance: 'do', title: 'Het label blijft zichtbaar, ook als de gebruiker gaat invullen.', children: (0, o.jsx)(t.X, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)(n.label, { for: 'dier1', children: 'Wat is je lievelingsdier?' }), (0, o.jsx)(n.input, { type: 'text', id: 'dier1', name: 'lievelingsdier', placeholder: 'Bijvoorbeeld cavia' })] }) }) }), '\n', (0, o.jsx)(s.X, { appearance: 'dont', title: 'Alleen een placeholder gebruiken als zichtbaar label.', children: (0, o.jsx)(t.X, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)(n.label, { for: 'dier2', class: 'visually-hidden', children: 'Wat is je lievelingsdier?' }), (0, o.jsx)(n.input, { type: 'text', id: 'dier2', name: 'lievelingsdier', placeholder: 'Wat is je lievelingsdier?' })] }) }) })] });
   }
   function i(e = {}) {
    const { wrapper: n } = { ...(0, a.a)(), ...e.components };
  ...
  98480: (e, n, l) => {
   ...
   const _ = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await c.ZP.format(N, { parser: f, plugins: [t.Z, s.ZP, r.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(Z);
     })();
    }, [N]);
    const L = (0, d.useId)();
    let D = d.Fragment;
    return (
     'paragraph' === x ? (D = m) : 'document' === x ? (D = v) : 'surface' === x && (D = g),
     (0, h.jsxs)('div', {
      className: (0, a.Z)(b['nlds-canvas']),
      children: [
       w && (0, h.jsx)('div', { className: (0, a.Z)(b['nlds-canvas__example']), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, h.jsx)(D, { children: (0, h.jsx)(o.pu, { children: w }) }) }) }),
       j &&
        (0, h.jsx)('div', {
       ...
       j &&
        (0, h.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, h.jsx)(p.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: Z, trim: !0 }),
          l &&
           (0, h.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: l, textContent: c, trim: d } = e,
     u = c;
    const { title: b, type: p } = (0, t.useContext)(s.n),
     h = (0, t.useId)();
    return (
     d && (u = u.trim()),
     (0, i.jsx)(a.y$, {
      ...
      language: l || '',
      children: (e) => {
       let { style: l, tokens: a, getLineProps: t, getTokenProps: s } = e;
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', b ? ': ' : ' ', b] }), (0, i.jsx)(o.dn, { tabIndex: 0, role: b ? 'region' : void 0, 'aria-labelledby': h, style: l, children: a.map((e, l) => (0, i.jsxs)('span', { ...t({ line: e }), children: [n && (0, i.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const d = (0, r.createContext)({}),
    u = (e) => {
     let { title: n, appearance: l, description: r, children: u, figure: b } = e;
     const p = { do: 'Doen', dont: 'Niet doen' },
      h = b ? 'figure' : 'div',
      m = b ? 'figcaption' : 'div';
     return (0, c.jsxs)(h, { className: (0, s.Z)(i['nlds-guideline'], i[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(m, { className: (0, s.Z)(i['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(t.nv, { className: (0, s.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: i['nlds-guideline__title'], children: p.dont })] }), (0, c.jsx)(t.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(t.nv, { className: (0, s.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(a.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: i['nlds-guideline__title'], children: p.do })] }), (0, c.jsx)(t.nv, { children: n })] }), r] }), (0, c.jsx)('div', { className: (0, s.Z)(i['nlds-guideline__example']), children: (0, c.jsx)(d.Provider, { value: { title: n, type: p[l] }, children: u }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => s });
   ...
   function r(e) {
    let n;
    return (n = e.disableParentContext ? ('function' == typeof e.components ? e.components(a) : e.components || a) : s(e.components)), o.createElement(t.Provider, { value: n }, e.children);
   }
  },
 },
]);
