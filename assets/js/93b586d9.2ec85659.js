      ...
      children: [
       ...
       y &&
        (0, m.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(h.u, { syntax: k, textContent: Z, trim: !0 }),
          l &&
           (0, m.jsx)('div', {
    ...
    return (
     ...
     (0, c.jsx)(s.y$, {
      ...
      children: (e) => {
       ...
       return (0, c.jsx)(o.dn, { tabIndex: 0, style: l, children: s.map((e, l) => (0, c.jsxs)('span', { ...t({ line: e }), children: [n && (0, c.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, c.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const i = (e) => {
    ...
    const p = 'Doen',
     ...
     m = u ? 'figure' : 'div',
     b = u ? 'figcaption' : 'div';
    return (0, a.jsxs)(m, { className: (0, c.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(b, { className: (0, c.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, c.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: r['nlds-guideline__title'], children: h })] }), (0, a.jsx)(t.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, c.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: r['nlds-guideline__title'], children: p })] }), (0, a.jsx)(t.nv, { children: n })] }), i] }), (0, a.jsx)('div', { className: (0, c.Z)(r['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => c });
