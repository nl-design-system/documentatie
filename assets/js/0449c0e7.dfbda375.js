...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [84907],
 {
  ...
  18439(e, n, t) {
   ...
   function o(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(i) : e.components || i) : r(e.components)), l.createElement(a.Provider, { value: n }, e.children));
   }
  },
  58639(e, n, t) {
   t.d(n, { H: () => p });
   ...
   const p = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: p = !0, children: m, container: j = 'document', language: k, designTokens: y }) => {
    ...
    (0, g.useEffect)(() => {
     (async () => {
      const e = await c.Ay.format(w, { parser: k, plugins: [r.A, o.Ay, s.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [w]);
    const S = (0, g.useId)();
    let C = g.Fragment;
    return (
     'paragraph' === j ? (C = h) : 'document' === j ? (C = f) : 'surface' === j && (C = u),
     (0, v.jsxs)('div', {
      className: (0, a.A)('nlds-canvas'),
      children: [
       x && (0, v.jsx)('div', { className: (0, a.A)('nlds-canvas__example'), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, v.jsx)(C, { children: (0, v.jsx)(i.v$, { children: x }) }) }) }),
       p &&
        (0, v.jsx)('div', {
