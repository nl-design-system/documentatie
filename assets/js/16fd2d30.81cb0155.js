 ...
 [33430],
 {
   ...
   const c = (e) => {
    ...
    a = (e) => {
     ...
     const d = (e) => ('article' === o ? (0, i.jsx)('article', { ...e }) : 'section' === o ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      l = (0, i.jsx)(d, { className: (0, s.Z)('cardgroup__card', `cardgroup__card--${n}`, c), children: a });
     return t ? (0, i.jsx)(r.rU, { href: t, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    d = (e) => {
  ...
  97520: (e, t, n) => {
   ...
   const o = (e) => {
    ...
    const { title: o } = t,
     a = (0, i.mA)(o),
     d = s.lazy(() => n(42767)(`./${a}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
    return (0, c.jsx)(s.Suspense, { fallback: null, children: (0, c.jsx)(r.U, { omitH1: !0, headingLevel: 1, children: (0, c.jsx)(d, {}) }) });
   };
  },
  76233: (e, t, n) => {
   'use strict';
   ...
   const a = (e) => {
    ...
    l = (e) => {
     ...
     const { title: h } = t,
      u = (0, c.mA)(h),
      j = i.lazy(() => n(22930)(`./${u}-docs/docs/anatomy/anatomy.md`).catch(() => ({ default: () => null })));
     return (0, o.jsx)(i.Suspense, {
      fallback: null,
      children: (0, o.jsxs)('figure', {
       className: (0, s.Z)('component-anatomy'),
       children: [
        l && (0, o.jsx)(l, { height: null, className: (0, s.Z)('component-anatomy__illustration') }),
        l &&
         j &&
         (0, o.jsx)('figcaption', {
  ...
  94443: (e, t, n) => {
   ...
   var r = n(41115),
    ...
    d = n(32636),
    l = n(52676);
   const h = { figma: (0, l.jsx)(i.Z, {}), github: (0, l.jsx)(c.Z, {}), npm: (0, l.jsx)(o.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    u = (e) => {
     let { brand: t } = e;
   ...
   const f = (e) => {
          ...
          children: [
           (0, l.jsx)(v, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(k, { headingLevel: n + 1, checked: t, title: r, description: (0, b.Q6)(s) }, s);
            }),
           }),
            ...
            j.Zb,
            {
             ...
             children: (0, l.jsxs)(j.aY, {
              children: [
               ...
               (0, l.jsx)(r.nv, { children: (0, l.jsxs)(r.rU, { href: e.url, children: [e.title, ' projectbord'] }) }),
               ...
               i.length > 0 &&
                (0, l.jsx)(l.Fragment, {
                 children: i.map((e) => {
                  ...
                  return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.X6, { level: n + 2, children: [s, ' in ', t] }), (0, l.jsx)(r.Mc, { children: i.map((e) => (0, l.jsxs)(r.k7, { href: e.value, children: [(0, l.jsx)(u, { brand: e.brand }), ' ', e.description] }, e.id)) })] });
                 }),
                }),
              ],
             }),
    ...
    w = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(y.V, { level: n, suffix: i && (0, l.jsx)(m.y, { state: i }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: s })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  57716: (e, t, n) => {
   ...
   const c = (e, t) => {
    ...
    a = (e) => ({
     img: (t) => {
      let { src: n, ...r } = t;
      return (0, i.jsx)('img', { ...r, src: c(e, n), className: 'utrecht-img utrecht-img--fit' });
     },
    }),
    d = (e, t) => {
     if (e) {
    ...
    l = (e) => {
     let { children: t, omitH1: n = !1, headingLevel: s = 1, baseUrl: c = '', components: o = {} } = e;
     return (0, i.jsx)(r.Z, { components: { ...d(n, s), ...a(c), ...o }, children: t });
    };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => o, Q6: () => i, U: () => d, e9: () => c, mA: () => s, ps: () => l });
   const r = { UNKNOWN: 'Todo', HELP_WANTED: 'Help Wanted', COMMUNITY: 'Community', CANDIDATE: 'Candidate', HALL_OF_FAME: 'Hall of fame' },
    ...
    d = (e) => Array.from(new Set(e.projects.flatMap((e) => a(e)))),
    l = (e) => {
     const t = a(e),
      n = ((e) => {
       const t = e.tasks.find((e) => {
