 ...
 [95840],
 {
  1292(e, n, t) {
   ...
   var r = t(29181),
    ...
    l = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(o.A, {}), github: (0, d.jsx)(a.A, {}), npm: (0, d.jsx)(s.A, {}), storybook: (0, d.jsx)(i.A, {}) },
    m = ({ brand: e }) => (0, d.jsx)(r.In, { children: c[e] || (0, d.jsx)(l.A, {}) });
  },
  33062(e, n, t) {
   t.d(n, { bo: () => o, KF: () => p, mJ: () => h, VZ: () => N, cR: () => _, Pv: () => f, qZ: () => s, kD: () => b, B2: () => u, Pc: () => l, f4: () => i, GT: () => k, fX: () => a, eQ: () => j, B_: () => v, o_: () => x, Rc: () => A });
    ...
    f = (e) => {
     ...
     return n.map((n) => {
      const r = e.tasks
       ...
       .map(({ name: r, id: o, value: a }) => {
        const s = /^(.+) URL/.exec(r)[1],
         i = 'Storybook' === s ? `${t} (${n}) in Storybook van ${e.title}` : `${t} (${n}) op ${s}`;
        return { brand: s.toLowerCase(), name: r, id: o, value: a, description: i };
       });
  ...
  37131(e, n, t) {
   ...
   const h = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
            ...
            s.Zp,
            {
             ...
             children: (0, d.jsxs)(s.Wu, {
              children: [
               ...
               i.length > 0 && (0, d.jsx)(d.Fragment, { children: i.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, d.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(a.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    j = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.p, { level: n, suffix: o && (0, d.jsx)(m.D, { state: o }), children: e.title }), (0, d.jsx)(r.fz, { lead: !0, children: t })] });
    },
    b = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  61749(e, n, t) {
   ...
   function f(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, o.jsx)(i.Fc, { component: g, headingLevel: 1, description: p }), '\n', (0, o.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, o.jsx)(i.VK, { component: g, headingLevel: 3 }), '\n', (0, o.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, o.jsx)(i.mu, { component: g, headingLevel: 3 }), '\n', (0, o.jsx)(i.K_, { component: g }), '\n', (0, o.jsx)(i.$9, { component: g, headingLevel: 2 })] });
   }
   function x(e = {}) {
  ...
  72642(e, n, t) {
   ...
   var r = t(13526),
    o = t(86070);
   const a = ({ children: e, className: n, level: t = 1, suffix: a, ...s }) => (0, o.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${t}`, n), ...s, children: [(0, o.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), a && (0, o.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [a ? ' ' : '', a] })] });
  },
  90495(e, n, t) {
   ...
   var r = t(46447),
    o = t(13526),
    a = t(86070);
   const s = ({ background: e, children: n, className: t, ...r }) => (0, a.jsx)('div', { className: (0, o.A)('card__illustration', e && `card__illustration--${e}`, t), ...r, children: n }),
    ...
    l = ({ href: e, appearance: n, className: t, component: s = 'div', background: i, children: l }) => {
     const d = (e) => ('article' === s ? (0, a.jsx)('article', { ...e }) : 'section' === s ? (0, a.jsx)('section', { ...e }) : (0, a.jsx)('div', { ...e })),
      c = (0, a.jsx)(d, { className: (0, o.A)('cardgroup__card', i && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: l });
     return e ? (0, a.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: c }) : c;
    },
    d = ({ appearance: e = 'medium', children: n, className: t }) => (0, a.jsx)('div', { className: (0, o.A)('cardgroup', `cardgroup--${e}`, t), children: n });
  },
 },
]);
