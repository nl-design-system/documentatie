 ...
 [63365],
 {
  16031(e, n, t) {
   ...
   function l({ className: e }) {
    const n = (0, r.r)();
    return n.badge ? (0, o.jsx)('span', { className: (0, s.A)(e, a.G.docs.docVersionBadge, 'badge badge--secondary'), children: (0, o.jsx)(i.A, { id: 'theme.docs.versionBadge.label', values: { versionLabel: n.label }, children: 'Version: {versionLabel}' }) }) : null;
   }
  },
  22082(e, n, t) {
   t.d(n, { A: () => b });
   ...
   function x({ className: e, versionMetadata: n }) {
    const {
     ...
     { pluginId: a } = (0, o.vT)({ failfast: !0 }),
     { savePreferredVersionName: r } = (0, c.g1)(a),
     { latestDocSuggestion: d, latestVersionSuggestion: m } = (0, o.HW)(a),
     x = d ?? (b = m).docs.find((e) => e.id === b.mainDocId);
    var b;
    return (0, u.jsxs)('div', { className: (0, s.A)(e, l.G.docs.docVersionBanner, 'alert alert--warning margin-bottom--md'), role: 'alert', children: [(0, u.jsx)('div', { children: (0, u.jsx)(h, { siteTitle: t, versionMetadata: n }) }), (0, u.jsx)('div', { className: 'margin-top--md', children: (0, u.jsx)(v, { versionLabel: m.label, to: x.path, onClick: () => r(m.name) }) })] });
   }
  ...
  22125(e, n, t) {
   t.d(n, { AE: () => l, Rc: () => r, TT: () => d, Uh: () => o, Yh: () => c });
   t(30758);
   var s = t(73285),
    i = t(4919),
    a = t(86070);
  ...
  27170(e, n, t) {
   ...
   const m = 'breadcrumbHomeIcon_e7yf';
   function h() {
    const e = (0, c.Ay)('/');
    return (0, d.jsx)('li', { className: 'breadcrumbs__item', children: (0, d.jsx)(o.A, { 'aria-label': (0, l.T)({ id: 'theme.docs.breadcrumbs.home', message: 'Home page', description: 'The ARIA label for the home page in the breadcrumbs' }), className: 'breadcrumbs__link', href: e, children: (0, d.jsx)(u, { className: m }) }) });
   }
   var v = t(4919),
    x = t(44941);
   function b(e) {
   ...
   const f = 'breadcrumbsContainer_oCI4';
   function g({ children: e, href: n, isLast: t }) {
    const s = 'breadcrumbs__link';
    return t ? (0, d.jsx)('span', { className: s, children: e }) : n ? (0, d.jsx)(o.A, { className: s, href: n, children: (0, d.jsx)('span', { children: e }) }) : (0, d.jsx)('span', { className: s, children: e });
   }
     ...
     ? (0, d.jsxs)(d.Fragment, {
        children: [
         ...
         (0, d.jsx)('nav', {
          ...
          'aria-label': (0, l.T)({ id: 'theme.docs.breadcrumbs.navAriaLabel', message: 'Breadcrumbs', description: 'The ARIA label for the breadcrumbs' }),
  ...
  63365(e, n, t) {
   ...
   function l({ children: e, content: n }) {
    const t = (function (e) {
   ...
   function p() {
    const { metadata: e } = c(),
     ...
     a = i.length > 0,
     o = !!(n || t || s);
    return a || o ? (0, r.jsxs)('footer', { className: (0, u.A)(f.G.docs.docFooter, 'docusaurus-mt-lg'), children: [a && (0, r.jsx)('div', { className: (0, u.A)('row margin-top--sm', f.G.docs.docFooterTagsRow), children: (0, r.jsx)('div', { className: 'col', children: (0, r.jsx)(g.A, { tags: i }) }) }), o && (0, r.jsx)(j.A, { className: (0, u.A)('margin-top--sm', f.G.docs.docFooterEditMetaRow), editUrl: n, lastUpdatedAt: t, lastUpdatedBy: s })] }) : null;
   }
   var A = t(34891),
    L = t(71581),
    N = t(73285);
   const _ = 'tocCollapsibleButton_Wy_J',
    T = 'tocCollapsibleButtonExpanded_VwPK';
   function C({ collapsed: e, ...n }) {
    return (0, r.jsx)('button', { type: 'button', ...n, className: (0, u.A)('clean-btn', _, !e && T, n.className), children: (0, r.jsx)(N.A, { id: 'theme.TOCCollapsible.toggleButtonLabel', description: 'The label used by the button on the collapsible TOC component', children: 'On this page' }) });
   }
   const k = 'tocCollapsible_py1n',
    H = 'tocCollapsibleContent_LJ47',
    y = 'tocCollapsibleExpanded_MH39';
   function M({ toc: e, className: n, minHeadingLevel: t, maxHeadingLevel: s }) {
    const { collapsed: i, toggleCollapsed: a } = (0, A.u)({ initialState: !0 });
    return (0, r.jsxs)('div', { className: (0, u.A)(k, !i && y, n), children: [(0, r.jsx)(C, { collapsed: i, onClick: a }), (0, r.jsx)(A.N, { lazy: !0, className: H, collapsed: i, children: (0, r.jsx)(L.A, { toc: e, minHeadingLevel: t, maxHeadingLevel: s }) })] });
   }
   const w = 'tocMobile_HuhR';
   function B() {
   ...
   function E() {
    const { toc: e, frontMatter: n } = c();
    return (0, r.jsx)(V.A, { toc: e, minHeadingLevel: n.toc_min_heading_level, maxHeadingLevel: n.toc_max_heading_level, className: f.G.docs.docTocDesktop });
   }
   var I = t(28394),
    O = t(21729);
   ...
   function F({ children: e }) {
    const n = (function () {
      const { frontMatter: e, toc: n } = c(),
       ...
       i = !s && n.length > 0;
      return { hidden: s, mobile: i ? (0, r.jsx)(B, {}) : void 0, desktop: !i || ('desktop' !== t && 'ssr' !== t) ? void 0 : (0, r.jsx)(E, {}) };
     })(),
     { metadata: t } = c();
    return (0, r.jsxs)('div', { className: 'row', children: [(0, r.jsxs)('div', { className: (0, u.A)('col', !n.hidden && D), children: [(0, r.jsx)(U.A, { metadata: t }), (0, r.jsx)(x.A, {}), (0, r.jsxs)('div', { className: S, children: [(0, r.jsxs)('article', { children: [(0, r.jsx)(G.A, {}), (0, r.jsx)(b.A, {}), n.mobile, (0, r.jsx)(R, { children: e }), (0, r.jsx)(p, {})] }), (0, r.jsx)(v, {})] })] }), n.desktop && (0, r.jsx)('div', { className: 'col col--3', children: n.desktop })] });
   }
   function z(e) {
    const n = `docs-doc-id-${e.content.metadata.id}`,
     t = e.content;
    return (0, r.jsx)(l, { content: e.content, children: (0, r.jsxs)(i.e3, { className: n, children: [(0, r.jsx)(d, {}), (0, r.jsx)(F, { children: (0, r.jsx)(t, {}) })] }) });
   }
  },
  71581(e, n, t) {
   t.d(n, { A: () => x });
   ...
   function l(e, { anchorTopOffset: n }) {
    const t = e.find((e) => o(e).top >= n);
    if (t) {
     return (function (e) {
    ...
    (0, s.useEffect)(() => {
     ...
     function o() {
      const e = (function (e) {
       ...
       c = l(o, { anchorTopOffset: t.current }),
       d = e.find(
        (e) =>
         c &&
         c.id ===
   ...
   const v = s.memo(h);
   function x({ toc: e, className: n = 'table-of-contents table-of-contents__left-border', linkClassName: t = 'table-of-contents__link', linkActiveClassName: o, minHeadingLevel: l, maxHeadingLevel: c, ...u }) {
    const h = (0, i.p)(),
     x = l ?? h.tableOfContents.minHeadingLevel,
    ...
    return (
     d(
      (0, s.useMemo)(() => {
       if (t && o) return { linkClassName: t, linkActiveClassName: o, minHeadingLevel: x, maxHeadingLevel: b };
      }, [t, o, x, b]),
     ),
  ...
  86990(e, n, t) {
   ...
   var s = t(13526),
    ...
    o = t(86070);
   function l({ className: e }) {
    return (0, o.jsx)(r.A, { type: 'caution', title: (0, o.jsx)(a.Rc, {}), className: (0, s.A)(e, i.G.common.unlistedBanner), children: (0, o.jsx)(a.Uh, {}) });
   }
   function c(e) {
    return (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)(a.AE, {}), (0, o.jsx)(l, { ...e })] });
   }
  },
  89675(e, n, t) {
   t.d(n, { A: () => o });
   ...
   var s = t(13526),
    ...
    r = t(86070);
   function o(e) {
    const { className: n, previous: t, next: o } = e;
  ...
  98775(e, n, t) {
   ...
   var s = t(13526),
    ...
    o = t(86070);
   function l({ className: e }) {
    return (0, o.jsx)(r.A, { type: 'caution', title: (0, o.jsx)(i.Yh, {}), className: (0, s.A)(e, a.G.common.draftBanner), children: (0, o.jsx)(i.TT, {}) });
   }
   var c = t(86990);
   function d({ metadata: e }) {
    const { unlisted: n, frontMatter: t } = e;
    return (0, o.jsxs)(o.Fragment, { children: [(n || t.unlisted) && (0, o.jsx)(c.A, {}), t.draft && (0, o.jsx)(l, {})] });
   }
  },
 },
]);
