...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [69606],
 {
  ...
  56154(e, n, t) {
   (t.r(n), t.d(n, { assets: () => g, contentTitle: () => v, default: () => f, frontMatter: () => j, metadata: () => l, toc: () => y }));
  ...
  58639(e, n, t) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: g = !0, children: y, container: b = 'document', language: f, designTokens: x }) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(N, { parser: f, plugins: [s.A, i.Ay, c.Ay, a.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      w(e);
     })();
    }, [N]);
    const F = (0, u.useId)();
    let R = u.Fragment;
    return (
     'paragraph' === b ? (R = h) : 'document' === b ? (R = j) : 'surface' === b && (R = v),
     (0, m.jsxs)('div', {
      className: (0, r.A)('nlds-canvas'),
      children: [
       k && (0, m.jsx)('div', { className: (0, r.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, m.jsx)(R, { children: (0, m.jsx)(o.v$, { children: k }) }) }) }),
       g &&
        (0, m.jsx)('div', {
