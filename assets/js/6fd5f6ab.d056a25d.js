 ...
 [53087],
 {
  ...
  45282(e, n, t) {
   ...
   const s = ({ children: e, ...n }) => {
     ...
     let o = t || r;
     const c = new URL(o, 'https://nldesignsystem.nl');
     return ('https://nldesignsystem.nl' === c.origin ? ((c.pathname = c.pathname.endsWith('/') ? c.pathname : `${c.pathname}/`), (o = c.toString().replace('https://nldesignsystem.nl', ''))) : ((s.target = '_blank'), (s.rel = 'noopener noreferrer')), (0, i.jsx)('a', { href: o, ...s, children: e }));
    },
            ...
            o.Zp,
            {
             ...
             children: (0, l.jsxs)(o.Wu, {
              children: [
               ...
               c.length > 0 && (0, l.jsx)(l.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, l.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, l.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
