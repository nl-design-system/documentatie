/*! For license information please see 25ab1beb.ba6c3a12.js.LICENSE.txt */
'use strict';
  ...
  75397(e, n, i) {
   ...
   const l = s.forwardRef(function (e, n) {
     const [i, l] = s.useState(!1),
      [a, d] = s.useState(e.alwaysLoadIframe || !1),
      ...
      v = s.useMemo(() => (e.playlist ? `${g}/embed/videoseries?${k.toString()}` : `${g}/embed/${u}?${k.toString()}`), [e.playlist, g, u, k]),
      ...
      x = y
       ...
       : null,
      w = s.useMemo(() => e.thumbnail || x || `https://i.ytimg.com/${f}/${e.playlist ? m : u}/${h}.${b}`, [e.thumbnail, x, f, e.playlist, m, u, h, b]),
      ...
      H = s.useCallback(e.onIframeAdded || function () {}, [e.onIframeAdded]),
      N = e.rel ? 'prefetch' : 'preload',
      O = e.containerElement || 'article',
      I = !1 !== e.noscriptFallback;
     return (
      s.useEffect(() => {
       a && (H(), e.focusOnLoad && 'object' == typeof n && null != n && n.current && n.current.focus());
      }, [a, H, e.focusOnLoad, n]),
      (0, t.jsxs)(t.Fragment, {
       children: [
        !e.lazyLoad && (0, t.jsx)('link', { rel: N, href: w, as: 'image' }),
        (0, t.jsx)(t.Fragment, { children: i && (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)('link', { rel: 'preconnect', href: g }), (0, t.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), R && (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, t.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
        e.seo && !e.playlist && (0, t.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: o(e.id, c, w, g, e.seo) } }),
        I && !e.playlist && (0, t.jsx)('noscript', { children: (0, t.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${c} on YouTube`, children: ['Watch "', c, '" on YouTube'] }) }),
        (0, t.jsxs)(O, {
         onPointerOver: () => {
          i || l(!0);
         },
         ...
         children: [e.lazyLoad && !a && (0, t.jsx)('img', { src: w, alt: `${c} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, t.jsx)('button', { type: 'button', className: L, 'aria-label': `${j} ${c}`, 'aria-hidden': a || void 0, tabIndex: a ? -1 : 0, children: (0, t.jsx)('span', { className: 'lty-visually-hidden', children: j }) }), a && (0, t.jsx)('iframe', { ref: n, className: D, title: c, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: v, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
