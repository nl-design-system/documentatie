 ...
 [70605],
 {
  ...
  43599: (e, n, o) => {
   ...
   const g = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (C = await d.ZP.format(N, { parser: f, plugins: [s.Z, a.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(C);
     })();
    }, [N]);
    const A = (0, u.useId)();
    let z = u.Fragment;
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       _ && (0, p.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, p.jsx)(z, { children: (0, p.jsx)(t.pu, { children: _ }) }) }) }),
       j &&
        (0, p.jsx)('div', {
