/*! For license information please see ba4d52e4.c72c212b.js.LICENSE.txt */
'use strict';
   ...
   const l = new Date().toISOString(),
    d = (e) => {
     ...
     const h = m?.find((e) => {
      ...
      b = [c, h?.videoId, ...(h?.videoIds ?? [])].filter(Boolean);
     return h
      ? (0, r.jsxs)('article', {
         ...
         children: [
          ...
          b.length > 0 && b.map((e) => (0, r.jsx)(o.Y, { id: e, title: h.subject, style: { marginBlock: '20px' } }, e)),
