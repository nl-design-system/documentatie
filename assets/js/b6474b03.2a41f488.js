 ...
 [5961],
 {
  43552: (e, n, t) => {
   ...
   const i = { title: "Page header", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Page header", pagination_label: "Page header", description: "UX richtlijnen voor Page header component", slug: "/page-header", tags: ["Unknown"] },
    r = "Page header",
    s = { id: "componenten/build/page-header", title: "Page header", description: "UX richtlijnen voor Page header component", source: "@site/docs/componenten/build/page-header.mdx", sourceDirName: "componenten/build", slug: "/page-header", permalink: "/page-header", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/page-header.mdx", tags: [{ label: "Unknown", permalink: "/tags/unknown" }], version: "current", frontMatter: { title: "Page header", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Page header", pagination_label: "Page header", description: "UX richtlijnen voor Page header component", slug: "/page-header", tags: ["Unknown"] }, sidebar: "componenten", previous: { title: "Page footer", permalink: "/page-footer" }, next: { title: "Pagination", permalink: "/pagination" } },
    d = {},
