 ...
 [34799],
 {
  ...
  17889(e, n, t) {
   ...
   var g = t(35193),
    ...
    f = t(79532),
    w = t(30758);
   const z = { color: g.A, dimension: m.A, fontFamilies: y.A, fontSizes: k.A, fontWeights: x.A, lineHeights: v.A, other: b.A, textDecoration: f.A },
       ...
       children: [
        ...
        (0, j.jsx)(o.BF, {
         children: t.map((n) => {
          const t = (0, i.o_)(n),
           a = (0, i.eQ)(e, n).$type;
          return (0, j.jsxs)(o.Hj, { children: [(0, j.jsx)(o.nA, { children: (0, j.jsx)(r.C, { children: (0, j.jsx)(o.kf, { children: t }) }) }), (0, j.jsx)(o.nA, { children: (0, j.jsxs)(s.K, { children: [(0, j.jsx)(A, { type: a }), ' ', a] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => u, mJ: () => g, VZ: () => z, cR: () => w, Pv: () => m, qZ: () => o, kD: () => v, B2: () => j, Pc: () => c, f4: () => a, GT: () => b, fX: () => i, eQ: () => x, B_: () => k, o_: () => y, Rc: () => f });
