(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [15403],
 {
  88125: (e, t, r) => {
   'use strict';
   r.r(t), r.d(t, { assets: () => u, component: () => y, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => c, issueNumber: () => m, metadata: () => l, title: () => d, toc: () => h });
   var n = r(52676),
    i = r(40139),
    s = r(43282),
    o = r(8657);
   const c = { title: 'Form Field Error Message', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Field Error Message', pagination_label: 'Form Field Error Message', description: 'Toont een foutmelding die informeert wat er is fout gegaan en hoe dit is op te lossen.', slug: '/form-field-error-message', keywords: ['error', 'error message', 'form', 'form error', 'form field', 'form field error message', 'formulier', 'formulierelement', 'fout', 'foutmelding', 'ongeldig', 'onjuist', 'problem', 'validatie', 'validation', 'waarschuwing'] },
    a = void 0,
    l = { id: 'componenten/form-field-error-message/index', title: 'Form Field Error Message', description: 'Toont een foutmelding die informeert wat er is fout gegaan en hoe dit is op te lossen.', source: '@site/docs/componenten/form-field-error-message/index.mdx', sourceDirName: 'componenten/form-field-error-message', slug: '/form-field-error-message', permalink: '/form-field-error-message', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-field-error-message/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form Field Error Message', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Field Error Message', pagination_label: 'Form Field Error Message', description: 'Toont een foutmelding die informeert wat er is fout gegaan en hoe dit is op te lossen.', slug: '/form-field-error-message', keywords: ['error', 'error message', 'form', 'form error', 'form field', 'form field error message', 'formulier', 'formulierelement', 'fout', 'foutmelding', 'ongeldig', 'onjuist', 'problem', 'validatie', 'validation', 'waarschuwing'] }, sidebar: 'componenten', previous: { title: 'Form Field Description', permalink: '/form-field-description' }, next: { title: 'Form Field Label', permalink: '/form-field-label' } },
    u = {},
    h = [
  ...
  54907: (e, t, r) => {
   ...
   (i.keys = () => Object.keys(n)), (i.id = 54907), (e.exports = i);
  },
  35038: (e, t, r) => {
   'use strict';
   r.d(t, { Zb: () => a, aY: () => c, um: () => l, wu: () => o });
   var n = r(16167),
    i = r(4814),
    s = r(52676);
   const o = (e) => {
     let { background: t, children: r, className: n, ...o } = e;
     return (0, s.jsx)('div', { className: (0, i.Z)('card__illustration', t && 'card__illustration--background', n), ...o, children: r });
    },
    c = (e) => (0, s.jsx)('div', { className: 'card__content', ...e }),
    a = (e) => {
     let { href: t, appearance: r, className: o, component: c = 'div', children: a } = e;
     const l = (e) => ('article' === c ? (0, s.jsx)('article', { ...e }) : 'section' === c ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      u = (0, s.jsx)(l, { className: (0, i.Z)('cardgroup__card', `cardgroup__card--${r}`, o), children: a });
     return t ? (0, s.jsx)(n.rU, { href: t, boxContent: !0, className: 'cardgroup__link', children: u }) : u;
    },
    l = (e) => {
     let { appearance: t = 'medium', children: r, className: n } = e;
     return (0, s.jsx)('div', { className: (0, i.Z)('cardgroup', `cardgroup--${t}`, n), children: r });
    };
  },
  8657: (e, t, r) => {
   'use strict';
   r.d(t, { cN: () => _, vM: () => N, W: () => w, Rv: () => A });
   var n = r(41115),
    i = r(4814),
    s = r(39854),
    o = r(7522),
    ...
    l = r(32636),
    u = r(52676);
   const h = { figma: (0, u.jsx)(s.Z, {}), github: (0, u.jsx)(o.Z, {}), npm: (0, u.jsx)(c.Z, {}), storybook: (0, u.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
     return (0, u.jsx)(n.JO, { children: h[t] || (0, u.jsx)(l.Z, {}) });
    };
   var j = r(35038),
    m = r(40598);
   const y = (e) => {
    let { checked: t, unchecked: n } = e;
    return (0, u.jsx)(m.Z, {
     ...
     children: () => {
      ...
      return (0, u.jsx)(e, {
       ...
       data: [
        ...
        { fill: 'var(--component-progress-background-color--unchecked, #ddd)', key: 'Todo', value: n, stroke: '2' },
       ],
       donutValue: null,
       showLabels: !1,
      });
   ...
   const b = (e) => {
    ...
    k = (e) => {
     let { checked: t, children: r, title: n, description: s, headingLevel: o = 3 } = e;
     return (0, u.jsxs)('li', { className: (0, i.Z)('task-list-item'), children: [(0, u.jsxs)('div', { className: (0, i.Z)('task-list-item__marker', t && 'task-list-item__marker--checked'), children: [(0, u.jsx)('span', { className: 'task-list-item__marker-label', children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.X6, { appearance: 'utrecht-heading-3', level: o, children: n }), s, r] })] });
    };
   var x = r(14669);
   const _ = (e) => {
     let { component: t, headingLevel: r } = e;
          ...
          children: [
           (0, u.jsx)(b, {
            children: e.tasks.map((e) => {
             let { checked: t, name: n, id: i } = e;
             return (0, u.jsx)(k, { headingLevel: r + 1, checked: t, title: n, description: (0, x.Q6)(i) }, i);
            }),
           }),
           (0, u.jsx)(n.nv, { children: (0, u.jsxs)(n.rU, { href: `${e.url}?filterQuery=${t.title}`, children: [e.title, ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
    ...
    w = (e) => {
     ...
     return t && i.length
         ...
         children: i
          .sort((e, t) => {
           const r = e.progress.max - e.progress.value,
            n = t.progress.max - t.progress.value;
           return r === n ? e.title.localeCompare(t.title) : r - n;
          })
          .map((e) => {
           const t = e.tasks.find((e) => {
            ...
            o = e.tasks.filter((e) => {
             ...
             return s.has(t) && URL.canParse(r) && 'https:' === new URL(r).protocol;
            });
           return (0, u.jsx)(
            j.Zb,
            {
             ...
             children: (0, u.jsxs)(j.aY, {
              children: [
               (0, u.jsx)(n.X6, { level: r, children: e.title }),
               (0, u.jsxs)(n.nv, { children: [(0, u.jsx)(y, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(n.rU, { href: e.url, children: [e.title, ' projectbord'] })] }),
               o.length > 0 &&
                (0, u.jsxs)(u.Fragment, {
                 children: [
                  (0, u.jsx)(n.X6, { level: r + 1, children: 'Component gebruiken?' }),
                  (0, u.jsx)(n.Mc, {
                   children: o.map((e) => {
                    const t = s.get(e.name);
                    return t ? (0, u.jsxs)(n.k7, { href: e.value, children: [(0, u.jsx)(d, { brand: t.brand }), ' ', t.desciption] }, e.id) : (0, u.jsx)(u.Fragment, {});
                   }),
                  }),
                 ],
                }),
      ...
      : (0, u.jsx)(n.nv, { children: 'Er zijn nog geen implementaties' });
    },
    N = (e) => {
     let { component: t } = e;
     const r = t?.projects.find((e) => 'HELP_WANTED' === e.id),
      i = r?.tasks.find((e) => 'PVTF_lADOBGdlVM4AdX8lzgcig7o' === e.id).value;
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(n.nv, { children: ['We vinden het belangrijk dat de component ', t.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, u.jsxs)(n.QI, { children: [i ? (0, u.jsxs)(n.AS, { children: ['Vul de ', (0, u.jsx)(n.rU, { href: i, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, u.jsxs)(n.AS, { children: [(0, u.jsxs)(n.rU, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', t.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, u.jsxs)(n.AS, { children: ['Draag bij aan de voortgang van ', t.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, u.jsx)(n.rU, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, u.jsx)(n.rU, { href: t.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    A = (e) => {
     let { component: t, headingLevel: r, description: i } = e;
     const s = t && x.$3[t.relayStep];
     return t && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p.V, { level: r, suffix: s && (0, u.jsx)(g.y, { state: s }), children: t.title }), (0, u.jsx)(n.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, t, r) => {
   'use strict';
   ...
   const c = (e) => {
    let { state: t } = e;
    const r = (0, s.mA)(t);
    return (0, o.jsx)(n.Ou, { className: (0, i.Z)('estafette-badge', r && `estafette-badge--${r}`), children: t });
   };
  },
  41757: (e, t, r) => {
   'use strict';
   ...
   var n = r(4814),
    i = r(52676);
   const s = (e) => {
    let { children: t, className: r, level: s = 1, suffix: o, ...c } = e;
    return (0, i.jsxs)('hgroup', { className: (0, n.Z)('nlds-inline-heading-group', `utrecht-heading-${s}`, r), ...c, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), o && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
   };
  },
  14669: (e, t, r) => {
   'use strict';
   r.d(t, { $3: () => n, BA: () => c, Q6: () => s, e9: () => o, mA: () => i });
   const n = { UNKNOWN: 'Todo', HELP_WANTED: 'Help Wanted', COMMUNITY: 'Community', CANDIDATE: 'Candidate', HALL_OF_FAME: 'Hall of fame' },
