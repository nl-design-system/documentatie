...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  14806(e, n, l) {
   (l.r(n), l.d(n, { assets: () => b, contentTitle: () => v, default: () => j, frontMatter: () => g, metadata: () => o, toc: () => x }));
  ...
  14881(e, n, l) {
   ...
   var o = l(13526),
    ...
    s = l(37168),
    c = l(86070);
   const a = (0, r.forwardRef)(({ as: e, className: n, children: l, ...r }, t) => {
     const s = e || 'div',
      a = (0, o.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, c.jsx)(s, { ref: t, className: a, ...r, children: l });
    }),
    d = ({ className: e, classNamePanel: n, label: l, heading: r, headingLevel: a, headingApperance: d, ...i }) => {
     const h = (0, o.A)('utrecht-accordion__section', e),
      u = (0, o.A)('utrecht-accordion__panel', n);
     return (0, c.jsxs)('details', { className: h, ...i, children: [(0, c.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, c.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, c.jsx)('span', { className: 'nl-button__icon-start', children: (0, c.jsx)(t.A, {}) }), (0, c.jsxs)('span', { className: 'nl-button__label', children: [r && (0, c.jsx)(s.D, { level: a, appearance: d, children: r }), l] })] }) }), (0, c.jsx)('div', { className: u, children: i.children })] });
    };
  },
  18439(e, n, l) {
   l.d(n, { R: () => s, x: () => c });
  ...
  28369(e, n, l) {
   ...
   function d({ lineNumber: e, syntax: n, textContent: l, trim: d }) {
    ...
    const { title: h, type: u } = (0, t.useContext)(s.x),
     p = (0, t.useId)();
    return (d && (i = i.trim()), (0, a.jsx)(r.f4, { theme: c, code: i, language: n || '', children: ({ style: n, tokens: l, getLineProps: r, getTokenProps: t }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, a.jsx)(o.NG, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': p, style: n, children: l.map((n, l) => (0, a.jsxs)('span', { ...r({ line: n }), children: [e && (0, a.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, a.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  38953(e, n, l) {
   l.d(n, { H: () => f });
   var o = l(28369),
    ...
    v = l(46847),
    b = l(86070);
   const x = ({ children: e }) => (0, b.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(r.yo, { className: (0, t.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, b.jsx)(r.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   x.displayName = 'ParagraphContainer';
   const y = ({ children: e }) => (0, b.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(r.yo, { className: (0, t.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   y.displayName = 'DocumentContainer';
   const j = ({ children: e }) => (0, b.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: e });
   j.displayName = 'SurfaceContainer';
   const f = globalThis.isAstro
    ? ({ language: e, className: n, code: l = '<p>No code provided</p>', rawCode: o, copyCode: r, defaultExpandedCode: s, designTokens: c }) => {
       const a = 'string' == typeof l ? l : o || '',
        d = 'string' == typeof l ? m().highlight(l, m().languages[e], e) : m().highlight(o || '', m().languages[e], e);
       return (0, b.jsxs)('div', { className: (0, t.A)('ma-canvas-astro', n), children: [(0, b.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: c, children: (0, b.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: a } }) }), (0, b.jsx)(g.n, { children: (0, b.jsxs)(g.K, { label: 'Code', open: s, children: [(0, b.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, b.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: d } }) }), 'allow' === r && (0, b.jsx)(v.$, { 'data-copy-code': a, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: p = !0, children: m, container: g = 'document', language: v, designTokens: f }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await i.Ay.format(N, { parser: v, plugins: [s.A, c.Ay, a.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         z(e);
        })();
       }, [N]);
       const S = (0, h.useId)();
       ...
       return (
        ...
        (0, b.jsxs)('div', {
         ...
         children: [
          _ && (0, b.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, b.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, b.jsx)(R, { children: (0, b.jsx)(r.v$, { children: _ }) }) }) }),
          p &&
           (0, b.jsx)('div', {
          ...
          p &&
           (0, b.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, b.jsx)(o.M, { codeBlockLabel: 'Codevoorbeeld', syntax: v, textContent: w, trim: !0 }),
             n &&
              (0, b.jsx)('div', {
