...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [75989],
 {
  ...
  98480: (e, n, r) => {
   ...
   const j = (e) => {
    let { code: n, copy: r = !0, defaultExpandedCode: j = !1, displayCode: x = !0, children: _, container: y = 'document', language: k, designTokens: f } = e,
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (A = await c.ZP.format(N, { parser: k, plugins: [t.Z, o.ZP, i.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), S(A);
     })();
    }, [N]);
    const R = (0, d.useId)();
    let I = d.Fragment;
    return (
     'paragraph' === y ? (I = g) : 'document' === y ? (I = v) : 'surface' === y && (I = b),
     (0, m.jsxs)('div', {
      ...
      children: [
       ...
       x &&
        (0, m.jsxs)('div', {
         ...
         hidden: !Z,
         children: [
          (0, m.jsx)(p.u, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: A, trim: !0 }),
          r &&
           (0, m.jsx)('div', {
  ...
  41179: (e, n, r) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: r, textContent: c, trim: d } = e,
     u = c;
    const { title: h, type: p } = (0, t.useContext)(o.n),
     m = (0, t.useId)();
    return (
     d && (u = u.trim()),
     (0, a.jsx)(l.y$, {
      ...
      language: r || '',
      children: (e) => {
       let { style: r, tokens: l, getLineProps: t, getTokenProps: o } = e;
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, a.jsx)(s.dn, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': m, style: r, children: l.map((e, r) => (0, a.jsxs)('span', { ...t({ line: e }), children: [n && (0, a.jsx)('span', { children: r + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, r)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, r) => {
   ...
   const d = (0, i.createContext)({}),
    u = (e) => {
     let { title: n, appearance: r, description: i, children: u, figure: h } = e;
     const p = { do: 'Doen', dont: 'Niet doen' },
      m = h ? 'figure' : 'div',
      g = h ? 'figcaption' : 'div';
     return (0, c.jsxs)(m, { className: (0, o.Z)(a['nlds-guideline'], a[`nlds-guideline--${r}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(g, { className: (0, o.Z)(a['nlds-guideline__description']), children: ['dont' === r ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(t.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${r}`]), children: [(0, c.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: a['nlds-guideline__title'], children: p.dont })] }), (0, c.jsx)(t.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(t.nv, { className: (0, o.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${r}`]), children: [(0, c.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: a['nlds-guideline__title'], children: p.do })] }), (0, c.jsx)(t.nv, { children: n })] }), i] }), (0, c.jsx)('div', { className: (0, o.Z)(a['nlds-guideline__example']), children: (0, c.jsx)(d.Provider, { value: { title: n, type: p[r] }, children: u }) })] });
    };
  },
  24785: (e, n, r) => {
   r.d(n, { Z: () => i, a: () => o });
