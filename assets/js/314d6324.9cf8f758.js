(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [54348],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => y, VZ: () => _, cR: () => w, Pv: () => g, qZ: () => c, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => s, eQ: () => f, B_: () => v, o_: () => p, Rc: () => x });
   ...
   const l = (e) => [...e].sort((e, t) => u.indexOf(e) - u.indexOf(t)),
    ...
    y = (e) => l(h(e.projects.flatMap((e) => m(e)))),
    g = (e) => {
     const t = m(e),
      n = ((e) => {
  ...
  85825(e, t, n) {
   ...
   var l = n(67970),
    ...
    j = n(46447),
    m = n(45561);
   const y = ({ children: e }) => (0, u.jsx)('ul', { className: 'task-list', children: e }),
    g = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, u.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, u.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, u.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, u.jsx)(m.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [n ? (0, u.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }) : null, r, t] })] });
   var p = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(y, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(g, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
