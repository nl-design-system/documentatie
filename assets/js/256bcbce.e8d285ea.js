  ...
  75397(e, n, t) {
   ...
   const r = s.forwardRef(function (e, n) {
     const [t, r] = s.useState(!1),
      ...
      b = s.useMemo(() => (e.playlist ? `${v}/embed/videoseries?${k.toString()}` : `${v}/embed/${c}?${k.toString()}`), [e.playlist, v, c, k]),
      ...
      x = j
       ...
       : null,
      y = s.useMemo(() => e.thumbnail || x || `https://i.ytimg.com/${w}/${e.playlist ? g : c}/${h}.${f}`, [e.thumbnail, x, w, e.playlist, g, c, h, f]),
     ...
     return (
      ...
      (0, a.jsxs)(a.Fragment, {
       children: [
        !e.lazyLoad && (0, a.jsx)('link', { rel: I, href: y, as: 'image' }),
        ...
        e.seo && !e.playlist && (0, a.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: o(e.id, u, y, v, e.seo) } }),
        O && !e.playlist && (0, a.jsx)('noscript', { children: (0, a.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${u} on YouTube`, children: ['Watch "', u, '" on YouTube'] }) }),
        (0, a.jsxs)(M, {
         onPointerOver: () => {
          t || r(!0);
         },
         ...
         children: [e.lazyLoad && !l && (0, a.jsx)('img', { src: y, alt: `${u} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, a.jsx)('button', { type: 'button', className: L, 'aria-label': `${m} ${u}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: m }) }), l && (0, a.jsx)('iframe', { ref: n, className: N, title: u, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
    }),
    l = ({ id: e, title: n, ...t }) => (0, a.jsx)(r, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: n, ...t });
  },
 },
]);
