 ...
 [77104],
 {
  ...
  20201(e, n, t) {
   ...
   function l(e, n, t, a, i) {
    const r = { '@context': 'https://schema.org', '@type': 'VideoObject', name: i?.name || n, thumbnailUrl: [i?.thumbnailUrl || t], embedUrl: i?.embedUrl || `${a}/embed/${e}`, contentUrl: i?.contentUrl || `https://www.youtube.com/watch?v=${e}`, ...(i?.description && { description: i.description }), ...(i?.uploadDate && { uploadDate: i.uploadDate }), ...(i?.duration && { duration: i.duration }) };
   ...
   const s = i.forwardRef(function (e, n) {
    const [t, s] = i.useState(!1),
     ...
     f = !e.thumbnail && !e.playlist && 'maxresdefault' === g,
     w = e.webp ? 'webp' : 'jpg',
     k = e.webp ? 'vi_webp' : 'vi',
     x = f
      ...
      : null,
     y = i.useMemo(() => e.thumbnail || x || `https://i.ytimg.com/${k}/${e.playlist ? h : c}/${g}.${w}`, [e.thumbnail, x, k, e.playlist, h, c, g, w]),
     ...
     W = i.useCallback(e.onIframeAdded || function () {}, [e.onIframeAdded]),
     M = e.rel ? 'prefetch' : 'preload',
     E = e.containerElement || 'article',
     S = !1 !== e.noscriptFallback,
     D = () => {
      o || d(!0);
     };
    return (
     ...
     i.useEffect(() => {
      ...
      return (
       ...
       () => {
        (window.removeEventListener('message', i), r.forEach(clearTimeout), 'object' == typeof n && n?.current && n.current.removeEventListener('load', s));
       }
      );
     ...
     (0, a.jsxs)(a.Fragment, {
      children: [
       !e.lazyLoad && (0, a.jsx)('link', { rel: M, href: y, as: 'image' }),
       (0, a.jsx)(a.Fragment, { children: t && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)('link', { rel: 'preconnect', href: v }), (0, a.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), C && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, a.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
       e.seo && !e.playlist && (0, a.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: l(e.id, u, y, v, e.seo) } }),
       S && !e.playlist && (0, a.jsx)('noscript', { children: (0, a.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${u} on YouTube`, children: ['Watch "', u, '" on YouTube'] }) }),
       (0, a.jsxs)(E, {
        onPointerOver: () => {
         t || s(!0);
        },
        ...
        style: { ...(!e.lazyLoad && { backgroundImage: `url(${y})` }), '--aspect-ratio': (A / z) * 100 + '%', ...(e.style || {}) },
        children: [e.lazyLoad && !o && (0, a.jsx)('img', { src: y, alt: `${u} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !o && (0, a.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && o) && (0, a.jsx)('button', { type: 'button', className: _, 'aria-label': `${p} ${u}`, 'aria-hidden': o || void 0, tabIndex: o ? -1 : 0, onClick: D, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: p }) }), o && (0, a.jsx)('iframe', { ref: n, className: L, title: u, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  62781(e, n, t) {
   (t.r(n), t.d(n, { assets: () => j, contentTitle: () => m, default: () => f, frontMatter: () => p, metadata: () => a, toc: () => v }));
  ...
  66820(e, n, t) {
   ...
   var a = t(46447),
    i = t(10645),
    r = t(86070);
   const l = ({ children: e, conformanceLevel: n, ...t }) => (globalThis.isAstro ? null : (0, r.jsx)(i.p, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: n && (0, r.jsx)(a.KE, { className: 'nlds-inline-heading-group__badge', children: n }), ...t, children: e }));
  },
  80883(e, n, t) {
   t.d(n, { L: () => r });
   var a = t(20201),
    i = t(86070);
   const r = ({ id: e, title: n, ...t }) => (0, i.jsx)(a.Ay, { lazyLoad: !0, adNetwork: !1, announce: 'Bekijk', cookie: !1, containerElement: 'div', id: e, title: n, poster: 'maxresdefault', ...t });
  },
  91170(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => r });
   var a = t(86070),
