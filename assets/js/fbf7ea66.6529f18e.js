 ...
 [77068],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    u = n(86070);
   const h = { figma: (0, u.jsx)(c.A, {}), github: (0, u.jsx)(i.A, {}), npm: (0, u.jsx)(s.A, {}), storybook: (0, u.jsx)(o.A, {}) },
    l = ({ brand: e }) => (0, u.jsx)(r.In, { children: h[e] || (0, u.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => g, qZ: () => s, kD: () => b, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => i, eQ: () => k, B_: () => v, o_: () => p, Rc: () => x });
   ...
   const l = (e) => [...e].sort((e, t) => u.indexOf(e) - u.indexOf(t)),
    ...
    m = (e) => l(h(e.projects.flatMap((e) => y(e)))),
    g = (e) => {
     const t = y(e),
      n = ((e) => {
  ...
  80427(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => h, component: () => y, contentTitle: () => u, default: () => p, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => l, toc: () => m }));
   ...
   var c = n(86070),
    ...
    s = n(57641),
    o = n(85825);
   const a = { title: 'Case Card', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Case Card', pagination_label: 'Case Card', description: 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.', slug: '/case-card', keywords: ['aanvraag', 'afgehandeld', 'afgerond', 'archief', 'archive', 'archived', 'bezwaar', 'beroep', 'bericht', 'card', 'case', 'case card', 'complaint', 'data', 'dossier', 'file', 'gearchiveerd', 'in behandeling', 'kenmerk', 'klacht', 'lopende zaak', 'melding', 'MijnOmgeving', 'MijnServices', 'MijnZaken', 'navigeren', 'navigate', 'navigatie', 'navigation', 'permit', 'procedure', 'record', 'response', 'request', 'terugkoppeling', 'tile', 'vergunning', 'zaak', 'zaak informatie', 'zaaknummer', 'zaaksysteem'] },
    u = void 0,
    h = {},
    l = 'Case Card',
    d = 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.',
    j = 253,
   ...
   function p(e = {}) {
    ...
    return t ? (0, c.jsx)(t, { ...e, children: (0, c.jsx)(g, { ...e }) }) : g(e);
   }
  },
  85825(e, t, n) {
   'use strict';
   n.d(t, { VK: () => v, $9: () => b, mu: () => k, Fc: () => f });
   var r = n(29181),
    c = n(13526),
    i = n(1292),
    s = n(90495),
   ...
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: i.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(g, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
    ...
    f = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(d.p, { level: t, suffix: c && (0, u.jsx)(l.D, { state: c }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
   ...
   const s = ({ background: e, children: t, className: n, ...r }) => (0, i.jsx)('div', { className: (0, c.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: s = 'div', background: o, children: a }) => {
     const u = (e) => ('article' === s ? (0, i.jsx)('article', { ...e }) : 'section' === s ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      h = (0, i.jsx)(u, { className: (0, c.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
