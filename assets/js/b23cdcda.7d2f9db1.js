...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [44617],
 {
  ...
  60151: (e, n, o) => {
   o.r(n), o.d(n, { assets: () => b, contentTitle: () => p, default: () => _, frontMatter: () => m, metadata: () => h, toc: () => v });
   var t = o(52676),
    l = o(24785),
    r = o(98480),
    s = o(91050);
  ...
  98480: (e, n, o) => {
   ...
   const _ = (e) => {
    ...
    let P = d.Fragment;
    return (
     'paragraph' === f ? (P = b) : 'document' === f ? (P = v) : 'surface' === f && (P = g),
     (0, h.jsxs)('div', {
    ...
    return (
     ...
     (0, s.jsx)(l.y$, {
      ...
      children: (e) => {
       ...
       return (0, s.jsx)(t.dn, { tabIndex: 0, style: o, children: l.map((e, o) => (0, s.jsxs)('span', { ...r({ line: e }), children: [n && (0, s.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, o)) });
      },
     })
    );
   }
  ...
  91050: (e, n, o) => {
   ...
   const c = (e) => {
    ...
    const m = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     b = u ? 'figcaption' : 'div';
    return (0, i.jsxs)(h, { className: (0, s.Z)(a['nlds-guideline'], a[`nlds-guideline--${o}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(b, { className: (0, s.Z)(a['nlds-guideline__description']), children: ['dont' === o ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(r.nv, { className: (0, s.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${o}`]), children: [(0, i.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: a['nlds-guideline__title'], children: p })] }), (0, i.jsx)(r.nv, { children: n })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(r.nv, { className: (0, s.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${o}`]), children: [(0, i.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, i.jsx)('span', { className: a['nlds-guideline__title'], children: m })] }), (0, i.jsx)(r.nv, { children: n })] }), c] }), (0, i.jsx)('div', { className: (0, s.Z)(a['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, o) => {
   o.d(n, { Z: () => a, a: () => s });
