 ...
 [70767],
 {
         ...
         (0, m.jsx)(a._Q, {
          ...
          children: c.map((e, n) => {
           ...
           if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
            const r = o.pI.get(e);
            t = (0, m.jsx)(i.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${r.sc} ${r.nl.title}`, style: { lineHeight: 1 }, children: (0, m.jsx)(g.KE, { children: `WCAG ${e}` }) }, n);
           }
           return t;
          }),
         }),
  ...
  6360(e, n, t) {
   ...
   var u = (0, a.forwardRef)(function (e, n) {
    ...
    if (
     ...
     var c = r.dateTime,
      u = (0, i.A)(r, l);
     return (0, o.jsx)('time', g(g({}, u), {}, { dateTime: c, className: a, ref: n, children: t }));
    }
    if (
     (function (e) {
      return 'value' in e;
     ...
     var m = r.value,
      p = (0, i.A)(r, d);
     return (0, o.jsx)('data', g(g({}, p), {}, { value: m, className: a, ref: n, children: t }));
    }
    return (0, o.jsx)('span', g(g({}, r), {}, { className: a, ref: n, children: t }));
   });
  ...
  14881(e, n, t) {
   ...
   const l = (0, i.forwardRef)(({ as: e, className: n, children: t, ...i }, o) => {
    ...
    d = ({ className: e, classNamePanel: n, label: t, heading: i, headingLevel: l, headingApperance: d, ...c }) => {
     ...
     return (0, s.jsxs)('details', { className: g, ...c, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(o.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [i && (0, s.jsx)(a.D, { level: l, appearance: d, children: i }), t] })] }) }), (0, s.jsx)('div', { className: u, children: c.children })] });
    };
  },
  19707(e, n, t) {
   t.d(n, { Z: () => r.Z });
  ...
  48262(e, n, t) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, u.jsx)(b.n, { children: i.map((t) => (0, u.jsx)(b.K, { className: (0, a.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, j.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(f._, { children: t.tasks.map(({ checked: e, name: t, id: r }) => (0, u.jsx)(f.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, j.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
            ...
            ? (0, u.jsx)(
               d.Z,
               {
                ...
                description: (0, u.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, u.jsxs)(o.f, { children: [(0, u.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, u.jsxs)('div', {
                   children: [
                    (p.length > 0 || c.length > 0) && (0, u.jsx)(i.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    p.length > 0 &&
                     (0, u.jsx)(r.dk, {
                      links: p
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)('section', { children: [(0, u.jsxs)(i.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, u.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
            ...
            : (0, u.jsx)(
               l.Zp,
               {
                ...
                children: (0, u.jsxs)(l.Wu, {
                 children: [
                  (0, u.jsx)(r.DZ, { level: n, children: e.title.replace(/^Community/i, '') }),
                  (0, u.jsxs)(r.fz, { children: [(0, u.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(r.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (p.length > 0 || c.length > 0) && (0, u.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  p.length > 0 &&
                   (0, u.jsx)(u.Fragment, {
                  ...
                  c.length > 0 && (0, u.jsx)(u.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, u.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    k = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(r.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, u.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, u.jsxs)(r.Xy, { children: [i ? (0, u.jsxs)(r.Er, { children: ['Vul de ', (0, u.jsx)(r.N_, { href: i, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, u.jsxs)(r.Er, { children: [(0, u.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, u.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, u.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, u.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    y = ({ component: e, headingLevel: n, description: t }) => {
     const i = e && j.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(h.p, { level: n, suffix: i && (0, u.jsx)(p.D, { state: i }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(i) && (0, u.jsx)(v.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    C = ({ component: e }) => {
     const n = (e && w[e.title]) || [];
     return n.length > 0 && (0, u.jsxs)(r.fz, { children: ['Gerelateerde componenten:', ' ', n.map((e, t) => (0, u.jsxs)(u.Fragment, { children: [e.slug ? (0, u.jsx)(r.N_, { href: `/${e.slug}/`, children: e.name }) : e.name, t < n.length - 1 ? ', ' : '.'] }))] });
    };
  },
  50805(e, n, t) {
   t.d(n, { $n: () => m });
   ...
   var g = function (e) {
    ...
    m =
     ...
     (0, s.forwardRef)(function (e, n) {
      ...
      return (0, o.jsxs)('button', c(c({ ref: n, type: x, className: (0, a.$)('nl-button', r, { 'nl-button--pressed': w, 'nl-button--busy': b, 'nl-button--disabled': f || j, 'nl-button--primary': 'primary' === p, 'nl-button--secondary': 'secondary' === p, 'nl-button--subtle': 'subtle' === p, 'nl-button--positive': u(p) && 'positive' === h, 'nl-button--negative': u(p) && 'negative' === h, 'nl-button--icon-only': d }), 'aria-pressed': k ? String(Boolean(w)) : void 0, 'aria-disabled': f || b ? 'true' : void 0, disabled: j }, y), {}, { children: [m && (0, o.jsx)('span', { className: 'nl-button__icon-start', children: m }), A && (0, o.jsx)('span', { className: 'nl-button__label', children: A }), T ? (0, o.jsx)('span', { className: d ? 'nl-button__label' : '', children: t }) : t, g && (0, o.jsx)('span', { className: 'nl-button__icon-end', children: g })] }));
     }));
  ...
  80130(e, n, t) {
   (t.r(n), t.d(n, { assets: () => L, component: () => _, contentTitle: () => S, default: () => E, description: () => z, frontMatter: () => G, issueNumber: () => H, metadata: () => r, title: () => W, toc: () => P }));
   ...
   const F = [
     ...
     { title: 'Instructies in de Form Field Error Message zijn op een inclusieve manier beschreven.', sc: '1.3.3', status: '', component: x.Ay, tags: ['designer', 'contentmaker'] },
     { title: 'Als kleuren worden gebruikt om aan te geven dat er een fout gemaakt is, dan is er ook ten minste \xe9\xe9n andere manier om de foutmelding te herkennen.', sc: '1.4.1', status: '', component: A.Ay, tags: ['designer'] },
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => i, KF: () => u, mJ: () => h, VZ: () => k, cR: () => A, Pv: () => f, qZ: () => a, kD: () => v, QQ: () => C, B2: () => m, Pc: () => l, f4: () => s, GT: () => x, fX: () => o, eQ: () => b, B_: () => w, o_: () => j });
