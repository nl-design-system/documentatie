 ...
 [17623],
 {
  ...
  43599: (e, n, t) => {
   ...
   const g = (e) => {
    ...
    (0, k.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(z, { parser: x, plugins: [o.Z, r.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [z]);
    const D = (0, k.useId)();
    let T = k.Fragment;
    return (
     'paragraph' === y ? (T = u) : 'document' === y ? (T = m) : 'surface' === y && (T = j),
     (0, h.jsxs)('div', {
      className: (0, i.Z)('nlds-canvas'),
      children: [
       _ && (0, h.jsx)('div', { className: (0, i.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(T, { children: (0, h.jsx)(s.pu, { children: _ }) }) }) }),
       b &&
        (0, h.jsx)('div', {
       ...
       b &&
        (0, h.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, h.jsx)(l.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: N, trim: !0 }),
          t &&
           (0, h.jsx)('div', {
