(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [45900],
 {
               ...
               d.Z,
               {
                ...
                description: (0, c.jsxs)('div', {
                 ...
                 children: [
                  ...
                  g.length > 0 && g.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)('section', { children: [(0, c.jsxs)(s.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(o.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, c.jsxs)(l.Wu, {
                 children: [
                  ...
                  g.length > 0 && (0, c.jsx)(c.Fragment, { children: g.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(i.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
  ...
  84471(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => g, mJ: () => p, VZ: () => A, cR: () => w, Pv: () => j, qZ: () => a, kD: () => k, QQ: () => T, B2: () => m, Pc: () => l, f4: () => o, GT: () => v, fX: () => r, eQ: () => f, B_: () => x, o_: () => b });
