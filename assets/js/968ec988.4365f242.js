   ...
   const x = (e) => {
    ...
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       w && (0, p.jsx)('div', { className: (0, o.Z)(b['nlds-canvas__example']), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, p.jsx)(G, { children: (0, p.jsx)(t.pu, { children: w }) }) }) }),
       _ &&
        (0, p.jsx)('div', {
    ...
    return (
     ...
     (0, s.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, s.jsx)(t.dn, { tabIndex: 0, style: l, children: o.map((e, l) => (0, s.jsxs)('span', { ...i({ line: e }), children: [n && (0, s.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const d = (e) => {
    ...
    const b = 'Doen',
     ...
     p = u ? 'figure' : 'div',
     h = u ? 'figcaption' : 'div';
    return (0, a.jsxs)(p, { className: (0, s.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(h, { className: (0, s.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(i.nv, { className: (0, s.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: r['nlds-guideline__title'], children: m })] }), (0, a.jsx)(i.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(i.nv, { className: (0, s.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: r['nlds-guideline__title'], children: b })] }), (0, a.jsx)(i.nv, { children: n })] }), d] }), (0, a.jsx)('div', { className: (0, s.Z)(r['nlds-guideline__example']), children: c })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => s });
