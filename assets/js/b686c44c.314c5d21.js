...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [31686],
 {
  ...
  40378: (e, n, o) => {
   o.r(n), o.d(n, { assets: () => g, contentTitle: () => p, default: () => h, frontMatter: () => b, metadata: () => m, toc: () => v });
   var t = o(52676),
    l = o(24785),
    s = o(98480),
    r = o(91050);
  ...
  98480: (e, n, o) => {
   ...
   const h = (e) => {
    let { code: n, copy: o = !0, defaultExpandedCode: h = !1, displayCode: y = !0, children: x, container: j = 'document', language: f, designTokens: k } = e,
    ...
    let P = d.Fragment;
    return (
     'paragraph' === j ? (P = g) : 'document' === j ? (P = v) : 'surface' === j && (P = _),
     (0, m.jsxs)('div', {
      ...
      children: [
       ...
       y &&
        (0, m.jsxs)('div', {
         ...
         hidden: !T,
         children: [
          (0, m.jsx)(p.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: C, trim: !0 }),
          o &&
           (0, m.jsx)('div', {
    ...
    return (
     ...
     (0, i.jsx)(l.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', b ? ': ' : ' ', b] }), (0, i.jsx)(t.dn, { tabIndex: 0, role: b ? 'region' : void 0, 'aria-labelledby': m, style: o, children: l.map((e, o) => (0, i.jsxs)('span', { ...s({ line: e }), children: [n && (0, i.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, o)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, o) => {
   ...
   const d = (0, a.createContext)({}),
    u = (e) => {
     let { title: n, appearance: o, description: a, children: u, figure: b } = e;
     const p = { do: 'Doen', dont: 'Niet doen' },
      m = b ? 'figure' : 'div',
      g = b ? 'figcaption' : 'div';
     return (0, c.jsxs)(m, { className: (0, r.Z)(i['nlds-guideline'], i[`nlds-guideline--${o}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(g, { className: (0, r.Z)(i['nlds-guideline__description']), children: ['dont' === o ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, r.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${o}`]), children: [(0, c.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: i['nlds-guideline__title'], children: p.dont })] }), (0, c.jsx)(s.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.nv, { className: (0, r.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${o}`]), children: [(0, c.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: i['nlds-guideline__title'], children: p.do })] }), (0, c.jsx)(s.nv, { children: n })] }), a] }), (0, c.jsx)('div', { className: (0, r.Z)(i['nlds-guideline__example']), children: (0, c.jsx)(d.Provider, { value: { title: n, type: p[o] }, children: u }) })] });
    };
  },
  24785: (e, n, o) => {
   o.d(n, { Z: () => a, a: () => r });
