/*! For license information please see 5b76b9b7.dd7d6008.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [57255],
 {
  4258(e, n, t) {
   ...
   var s = t(87423),
    i = t(86070);
   const a = ({ id: e, title: n, ...t }) => (0, i.jsx)(s.A, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: n, poster: 'maxresdefault', ...t });
  },
  84800(e, n, t) {
   t.r(n), t.d(n, { assets: () => m, contentTitle: () => d, default: () => u, frontMatter: () => l, metadata: () => s, toc: () => g });
   ...
   var i = t(86070),
    ...
    r = t(4258),
    o = t(68873);
   const l = { title: 'Design Systems Week 2022', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 2022, sidebar_position: 4, pagination_label: 'Design Systems Week 2022', slug: '/events/design-systems-week-2022' },
  ...
  87423(e, n, t) {
   ...
   var r = s.forwardRef(function (e, n) {
    ...
    var b = e.playlist ? ''.concat(y, '/embed/videoseries?').concat(v.toString()) : ''.concat(y, '/embed/').concat(g, '?').concat(v.toString()),
     w = !e.thumbnail && !e.playlist && 'maxresdefault' === k,
     j = e.webp ? 'webp' : 'jpg',
     f = e.webp ? 'vi_webp' : 'vi',
     S = w
      ? (function (e, n, t, i) {
    ...
    return (
     ...
     s.createElement(
      s.Fragment,
      null,
      s.createElement('link', { rel: I, href: D, as: 'image' }),
      ...
      s.createElement(
       C,
       {
        ...
        'data-title': u,
        style: i(i({ backgroundImage: 'url('.concat(D, ')') }, { '--aspect-ratio': ''.concat((L / N) * 100, '%') }), H),
       },
       s.createElement('button', { type: 'button', className: _, 'aria-label': ''.concat(h, ' ').concat(u) }),
       d && s.createElement('iframe', { ref: n, className: O, title: u, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b }),
      ),
     )
    );
   });
