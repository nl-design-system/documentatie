            ...
            r.Zp,
            {
             ...
             children: (0, g.jsxs)(r.Wu, {
              children: [
               ...
               l.length > 0 && (0, g.jsx)(g.Fragment, { children: l.map(({ frameworkName: e, tasks: a }) => (0, g.jsxs)(g.Fragment, { children: [(0, g.jsxs)(t.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, g.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, g.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
