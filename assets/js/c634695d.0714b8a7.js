...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [96233],
 {
  ...
  55863: (e, n, o) => {
   o.r(n), o.d(n, { assets: () => h, contentTitle: () => m, default: () => b, frontMatter: () => p, metadata: () => v, toc: () => g });
   var t = o(52676),
    l = o(24785);
   function r(e) {
    ...
    return (
     ...
     (0, i.jsx)(l.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsx)(t.dn, { tabIndex: 0, style: o, children: l.map((e, o) => (0, i.jsxs)('span', { ...r({ line: e }), children: [n && (0, i.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, o)) });
      },
     })
    );
   }
  ...
  91050: (e, n, o) => {
   ...
   const d = (e) => {
    ...
    const p = 'Doen',
     ...
     v = u ? 'figure' : 'div',
     h = u ? 'figcaption' : 'div';
    return (0, s.jsxs)(v, { className: (0, i.Z)(a['nlds-guideline'], a[`nlds-guideline--${o}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, s.jsxs)(h, { className: (0, i.Z)(a['nlds-guideline__description']), children: ['dont' === o ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(r.nv, { className: (0, i.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${o}`]), children: [(0, s.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, s.jsx)('span', { className: a['nlds-guideline__title'], children: m })] }), (0, s.jsx)(r.nv, { children: n })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(r.nv, { className: (0, i.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${o}`]), children: [(0, s.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, s.jsx)('span', { className: a['nlds-guideline__title'], children: p })] }), (0, s.jsx)(r.nv, { children: n })] }), d] }), (0, s.jsx)('div', { className: (0, i.Z)(a['nlds-guideline__example']), children: c })] });
   };
  },
  24785: (e, n, o) => {
   o.d(n, { Z: () => a, a: () => i });
