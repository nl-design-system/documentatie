 ...
 [94318],
 {
  ...
  58639(e, n, l) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: g = !0, children: x, container: v = 'document', language: k, designTokens: f }) => {
    ...
    let R = u.Fragment;
    return (
     'paragraph' === v ? (R = m) : 'document' === v ? (R = j) : 'surface' === v && (R = b),
     (0, p.jsxs)('div', {
      className: (0, s.A)('nlds-canvas'),
      children: [
       y && (0, p.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(R, { children: (0, p.jsx)(o.v$, { children: y }) }) }) }),
       g &&
        (0, p.jsx)('div', {
