 ...
 [43166],
 {
  ...
  16391: (e, n, t) => {
   ...
   const v = 'task-list_hh8j',
    ...
    z = (e) => {
     let { children: n } = e;
     return (0, d.jsx)('ul', { className: v, children: n });
    },
    T = (e) => {
   ...
   const A = (e) => {
     ...
     const o = n && n.projects.filter((e) => N.e9.includes(e.id)),
      a = o && N.e9.map((e) => o.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
         ...
         children: [
          (0, d.jsx)(z, {
           children: e.tasks.map((e) => {
            ...
            return (0, d.jsx)(T, { checked: n, title: t, description: (0, N.Q6)(r) }, r);
           }),
          }),
