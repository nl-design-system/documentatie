   ...
   const d = (0, c.createContext)({}),
    u = ({ title: e, appearance: n, description: l, children: c, figure: u }) => {
     const p = { do: 'Doen', dont: 'Niet doen' },
      h = u ? 'figure' : 'div',
      m = u ? 'figcaption' : 'div',
      j = 'string' == typeof l ? (0, a.jsx)(i.oz, { components: { a: r.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   const i = ({ className: e, ...n }) => {
    ...
    c = ({ className: e, classNamePanel: n, label: l, heading: i, headingLevel: c, headingApperance: a, ...d }) => {
     ...
     return (0, o.jsxs)('details', { className: u, ...d, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(s.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [i && (0, o.jsx)(r.D, { level: c, appearance: a, children: i }), l] })] }) }), (0, o.jsx)('div', { className: p, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => b });
   var t = l(15175),
    ...
    j = l(70348),
    g = l(86070);
   const v = ({ children: e }) => (0, g.jsx)(s.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(s.yo, { className: (0, r.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(s.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   v.displayName = 'ParagraphContainer';
   const y = ({ children: e }) => (0, g.jsx)(s.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(s.yo, { className: (0, r.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const b = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       ...
       return (0, g.jsxs)('div', { className: (0, r.A)('ma-canvas-astro', l), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: s } }), (0, g.jsx)(j.n, { children: (0, g.jsx)(j.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: h = !0, children: m, container: j = 'document', language: b, designTokens: f }) => {
       ...
       let z = u.Fragment;
       return (
        'paragraph' === j ? (z = v) : 'document' === j ? (z = y) : 'surface' === j && (z = x),
        (0, g.jsxs)('div', {
         className: (0, r.A)('nlds-canvas'),
         children: [
          _ && (0, g.jsx)('div', { className: (0, r.A)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, g.jsx)(z, { children: (0, g.jsx)(s.v$, { children: _ }) }) }) }),
          h &&
           (0, g.jsx)('div', {
          ...
          h &&
           (0, g.jsxs)('div', {
            ...
            hidden: !S,
            children: [
             (0, g.jsx)(t.M, { codeBlockLabel: 'Codevoorbeeld', syntax: b, textContent: A, trim: !0 }),
             n &&
              (0, g.jsx)('div', {
