(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [85781],
 {
  ...
  68444: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => R, component: () => L, contentTitle: () => G, default: () => P, description: () => S, frontMatter: () => T, issueNumber: () => _, metadata: () => W, title: () => z, toc: () => N });
   var r = n(52676),
    o = n(40139),
    s = n(7629),
    i = n(19031),
   ...
   function x(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(t.h1, { id: 'gebruik-code-block', children: 'Gebruik Code Block' }), '\n', (0, r.jsx)(t.h2, { id: 'css', children: 'CSS' }), '\n', (0, r.jsx)(t.p, { children: 'De CSS van deze component is gepubliceerd in een npm package:' }), '\n', (0, r.jsxs)(t.p, { children: [(0, r.jsxs)(t.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-css', children: [(0, r.jsx)('img', { src: 'https://badge.fury.io/js/@nl-design-system-candidate%2Fcode-block-css.svg', alt: '', style: { verticalAlign: 'middle' } }), ' @nl-design-system-candidate/code-block-css'] }), '\nversie 1.'] }), '\n', (0, r.jsxs)(t.p, { children: ['Gebruik de ', (0, r.jsx)(t.code, { children: 'nl-code-block' }), ' class name op een ', (0, r.jsx)(t.code, { children: 'pre' }), ' element met de ', (0, r.jsx)(t.code, { children: 'nl-code-block__code' }), ' class name op een ', (0, r.jsx)(t.code, { children: 'code' }), ' element:'] }), '\n', (0, r.jsx)(t.pre, { children: (0, r.jsx)(t.code, { className: 'language-html', children: '<pre dir="ltr" translate="no" class="nl-code-block">\n  <code class="nl-code-block__code">function addNumbers(a, b) {\n  return a + b;\n}</code>\n</pre>\n' }) }), '\n', (0, r.jsx)(t.p, { children: 'Je kunt de CSS zo in je project installeren:' }), '\n', (0, r.jsx)(t.pre, { children: (0, r.jsx)(t.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/code-block-css\n' }) }), '\n', (0, r.jsx)(t.p, { children: 'Als je een CDN gebruikt, dan kun je de CSS zo importeren:' }), '\n', (0, r.jsx)(t.pre, { children: (0, r.jsx)(t.code, { className: 'language-html', children: '<link\n  rel="stylesheet"\n  href="https://cdn.jsdelivr.net/npm/@nl-design-system-candidate/code-block-css@1/dist/code-block.css"\n/>\n' }) }), '\n', (0, r.jsxs)(t.p, { children: ['Gebruik je geen CDN, dan kun je de CSS uit ', (0, r.jsx)(t.code, { children: 'node_modules/' }), ' importeren:'] }), '\n', (0, r.jsx)(t.pre, { children: (0, r.jsx)(t.code, { className: 'language-html', children: '<link rel="stylesheet" href="node_modules/@nl-design-system-candidate/code-block-css/dist/code-block.css" />\n' }) }), '\n', (0, r.jsx)(t.p, { children: 'Als je CSS imports gebruikt vanuit JavaScript:' }), '\n', (0, r.jsx)(t.pre, { children: (0, r.jsx)(t.code, { className: 'language-js', children: 'import "@nl-design-system-candidate/code-block-css/code-block.css";\n' }) }), '\n', (0, r.jsx)(t.h2, { id: 'react', children: 'React' }), '\n', (0, r.jsx)(t.p, { children: 'De React component is gepubliceerd in een npm package:' }), '\n', (0, r.jsxs)(t.p, { children: [(0, r.jsxs)(t.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-react', children: [(0, r.jsx)('img', { src: 'https://badge.fury.io/js/@nl-design-system-candidate%2Fcode-block-react.svg', alt: '', style: { verticalAlign: 'middle' } }), ' @nl-design-system-candidate/code-block-react'] }), '\nversie 1.'] }), '\n', (0, r.jsx)(t.p, { children: 'Je kunt de npm package zo installeren:' }), '\n', (0, r.jsx)(t.pre, { children: (0, r.jsx)(t.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/code-block-react\n' }) }), '\n', (0, r.jsx)(t.p, { children: 'Je kunt de React component zo gebruiken:' }), '\n', (0, r.jsx)(t.pre, { children: (0, r.jsx)(t.code, { className: 'language-jsx', children: 'import { CodeBlock } from "@nl-design-system-candidate/code-block-react";\n\nexport const MyPage = () => {\n  return (\n    <html>\n      <body>\n        function addNumbers(a, b) {\n          return a + b;\n        }\n      </body>\n    </html>\n  );\n};\n' }) }), '\n', (0, r.jsx)(t.h2, { id: 'figma', children: 'Figma' }), '\n', (0, r.jsxs)(t.p, { children: ['De Figma component staat in ', (0, r.jsx)(t.a, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=13778-3553', children: 'NL Design System Voorbeeld Bibliotheek \u2014 Code Block' }), '.'] })] });
   }
   function A(e = {}) {
    const { wrapper: t } = { ...(0, o.a)(), ...e.components };
   ...
   const T = { title: 'Code Block', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code Block', pagination_label: 'Code Block', description: 'Blok met \xe9\xe9n of meerdere regels computercode.', slug: '/code-block', keywords: ['code', 'code block', 'code blok', 'code container', 'code example', 'code fences', 'code memo', 'code snippet', 'code snippet blok', 'code voorbeeld', 'code wrapper', 'codeblock', 'codepen', 'copy paste blok', 'css voorbeeld', 'html voorbeeld', 'inline code', 'monospace', 'monotype', 'pre', 'snippet', 'source code', 'source doc', 'toepassing', 'voorbeeld blok', 'Code Snippet', 'Code Blok', 'Code Example'] },
    ...
    _ = 329,
    L = s.find((e) => e.number === _);
   function D(e) {
    const t = { h2: 'h2', h3: 'h3', ...(0, o.a)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(f.Rv, { component: L, headingLevel: 1, description: S }),
      '\n',
      ...
      (0, r.jsx)(k.W, {
       ...
       items: [
        ...
        { title: 'Wanneer de achtergrondkleur van het Code Block anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina.', sc: '1.4.11', status: '', component: (0, r.jsx)(h.ZP, {}), tags: ['designer', 'contentmaker'] },
       ],
      }),
      '\n',
      ...
      (0, r.jsx)(k.W, {
       headingLevel: '4',
       items: [
        { title: 'De juiste HTML-elementen voor de Code Block component zijn toegepast.', sc: '1.3.1', status: '', component: (0, r.jsx)(u, {}), tags: ['developer'] },
  ...
  35038: (e, t, n) => {
   ...
   const i = (e) => {
     ...
     return (0, s.jsx)('div', { className: (0, o.Z)('card__illustration', t && `card__illustration--${t}`, r), ...i, children: n });
    },
    c = (e) => (0, s.jsx)('div', { className: 'card__content', ...e }),
    l = (e) => {
     let { href: t, appearance: n, className: i, component: c = 'div', background: l, children: a } = e;
     const d = (e) => ('article' === c ? (0, s.jsx)('article', { ...e }) : 'section' === c ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      u = (0, s.jsx)(d, { className: (0, o.Z)('cardgroup__card', l && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, i), children: a });
     return t ? (0, s.jsx)(r.rU, { href: t, boxContent: !0, className: 'cardgroup__link', children: u }) : u;
    },
    a = (e) => {
  ...
  6503: (e, t, n) => {
   ...
   var r = n(57229),
    ...
    d = n(52676);
   const u = (e) => {
     let { title: t, sc: n, component: a, tags: u } = e;
     const h = (0, l.useId)(),
      m = [...u];
     if (n) {
      m.push(n);
     ...
     return (0, d.jsx)('li', {
      ...
      children: (0, d.jsxs)('details', {
       children: [
        (0, d.jsx)('summary', { children: (0, d.jsx)('span', { className: 'new-checklist__title', id: h, children: t }) }),
        (0, d.jsxs)('div', {
         className: 'new-checklist__content',
         children: [
          (0, d.jsx)('div', { children: a }),
          (0, d.jsx)(s.k, {
           className: 'new-checklist__badge-list',
           children: m.map((e, t) => {
            let n = (0, d.jsx)(i.O, { children: e }, t);
            if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
             const s = o.fg.get(e);
             n = (0, d.jsx)(r.r, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${s.sc} ${s.nl.title}`, style: { lineHeight: 1 }, children: (0, d.jsx)(i.O, { children: `WCAG ${e}` }) }, t);
            }
            return n;
           }),
          }),
    ...
    h = (e) => {
     ...
     const r = t.reduce(
      ...
      [o, i] = (0, l.useState)(Array.from(r.values())),
      c = (e) => o.includes(e),
      h = (0, l.useId)(),
      m =
       o.length >= 1
     ...
     return (0, d.jsxs)('div', {
      children: [
       (0, d.jsxs)('div', {
        ...
        children: [
         (0, d.jsxs)(a.pg, {
          ...
          'aria-labelledby': h,
          children: [
           (0, d.jsx)(a.X6, { level: n, id: h, children: 'Filter acceptatiecriteria voor:' }),
             ...
             a.Wi,
             {
              ...
              children: [
               (0, d.jsx)(a.XZ, {
                ...
                onChange: () =>
                 ((e, t) => {
                  const n = ('boolean' == typeof t ? t : !c(e)) ? [...o, e] : o.filter((t) => t !== e);
                  i(n);
                 })(e),
               }),
               (0, d.jsx)(a.lX, { htmlFor: e, children: e }),
              ],
             },
             e,
            ),
         ...
         (0, d.jsx)('div', {
          children: (0, d.jsxs)(d.Fragment, {
           children: [
            (0, d.jsxs)('p', { role: 'status', children: [t.length - g, ' van de ', t.length, ' items zijn nu zichtbaar.'] }),
            g >= 1
             ? (0, d.jsx)(s.zx, {
                appearance: 'secondary-action-button',
                onClick: () => {
                 i(Array.from(r.values()));
                },
                children: 'Toon alles',
               })
             : (0, d.jsx)(d.Fragment, {}),
       ...
       (0, d.jsx)('ul', { className: 'new-checklist', role: 'list', children: m.map((e, t) => (0, d.jsx)(u, { ...e }, t)) }),
      ],
     });
    };
  },
  ...
  8657: (e, t, n) => {
   ...
   const x = (e) => {
     ...
     return (
      ...
      (0, d.jsx)(r.a2, {
       sections: i.map((e) => ({
        className: (0, o.Z)('definition-of-done', e && `definition-of-done--${(0, b.mA)(c(e))}`),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, d.jsx)(f, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(v, { headingLevel: n + 1, checked: t, title: r, description: (0, b.Q6)(o) }, o);
            }),
           }),
           (0, d.jsx)(r.nv, { children: (0, d.jsxs)(r.rU, { href: `${e.url}?filterQuery=${t.title}`, children: [c(e), ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
    ...
    A = (e) => {
     let { component: t, headingLevel: n } = e;
     const o = t && t.projects.filter((e) => !b.e9.includes(e.id));
     return t && o.length
      ? (0, d.jsx)(m.um, {
         appearance: 'large',
  ...
  49556: (e, t, n) => {
    ...
    return 'clipboard' in navigator
     ? (0, m.jsxs)(i.zx, {
        ...
        onClick: async function () {
         try {
          const e = await d.ZP.format(n, { parser: r, plugins: [c.Z, l.ZP, a.ZP] });
   ...
   var p = n(6076),
    ...
    b = n(49003),
    x = n(75271);
   const A = { color: p.Z, dimension: j.Z, fontFamilies: w.Z, fontSizes: y.Z, fontWeights: k.Z, lineHeights: f.Z, other: v.Z, textDecoration: b.Z },
    C = (e) => {
     let { type: t } = e;
   ...
   function T(e) {
    ...
    const n = (0, s.s0)(t),
     c = (0, s.fO)(n),
     l = c.map((e) => (0, s.$e)(e) + ': ;').join('\n'),
     a = JSON.stringify((0, s.qU)(c));
    return (0, m.jsxs)(m.Fragment, {
     children: [
      ...
      (0, m.jsxs)(i.hE, { children: [(0, m.jsx)(g, { content: a, language: 'json', children: 'Kopieer als JSON' }), (0, m.jsx)(g, { content: l, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  57229: (e, t, n) => {
   ...
   const i = (e) => {
    let { className: t, ...n } = e;
    return (0, s.jsx)(r.Z, { className: (0, o.W)('utrecht-link', 'utrecht-link--html-a', t), ...n });
   };
  },
  57716: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => j, BA: () => c, Ee: () => d, Q6: () => s, U: () => m, Yr: () => w, d: () => u, e9: () => i, fO: () => k, mA: () => o, ps: () => g, qU: () => f, s0: () => y, zP: () => p });
   ...
   const a = (e) => {
    ...
    m = (e) => a(l(e.projects.flatMap((e) => h(e)))),
    g = (e) => {
     const t = h(e),
      n = ((e) => {
       const t = e.tasks.find((e) => {
      ...
      const r = e.tasks
       ...
       .map((r) => {
        ...
        const c = /^(.+) URL/.exec(o)[1],
         l = 'Storybook' === c ? `${n} (${t}) in Storybook van ${((e) => (['Candidate - New', 'Candidate - Oud'].includes(e.title) ? 'Candidate' : e.title))(e)}` : `${n} (${t}) op ${c}`;
        return { brand: c.toLowerCase(), name: o, id: s, value: i, description: l };
       });
