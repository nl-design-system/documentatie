...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  48649: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => m, contentTitle: () => u, default: () => w, frontMatter: () => g, metadata: () => p, toc: () => j });
   var i = t(52676),
    r = t(40139),
    s = t(57716),
    a = t(46364),
    ...
    c = t(91114),
    h = t(31259);
   const g = { title: 'WCAG-succescriterium 1.4.12 Tekstafstand', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.12 Tekstafstand', pagination_label: 'WCAG-succescriterium 1.4.12 Tekstafstand', description: 'Tekst kan op een aantal manieren aangepast worden, door mensen voor wie dat prettig is.', slug: '1.4.12', keywords: ['WCAG'] },
    u = void 0,
    p = { id: 'wcag/1.4.12', title: 'WCAG-succescriterium 1.4.12 Tekstafstand', description: 'Tekst kan op een aantal manieren aangepast worden, door mensen voor wie dat prettig is.', source: '@site/docs/wcag/1.4.12.mdx', sourceDirName: 'wcag', slug: '/wcag/1.4.12', permalink: '/wcag/1.4.12', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.12.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.4.12 Tekstafstand', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.12 Tekstafstand', pagination_label: 'WCAG-succescriterium 1.4.12 Tekstafstand', description: 'Tekst kan op een aantal manieren aangepast worden, door mensen voor wie dat prettig is.', slug: '1.4.12', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.4.11 Contrast van niet-tekstuele content', permalink: '/wcag/1.4.11' }, next: { title: 'WCAG-succescriterium 1.4.13 Content bij hover of focus', permalink: '/wcag/1.4.13' } },
    m = {},
    j = [
  ...
  41757: (e, n, t) => {
   ...
   const s = (e) => {
    ...
    return (0, r.jsxs)('hgroup', { className: (0, i.Z)('nlds-inline-heading-group', `utrecht-heading-${s}`, t), ...l, children: [(0, r.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: n }), a && (0, r.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [a ? ' ' : '', a] })] });
   };
  },
  57716: (e, n, t) => {
   t.d(n, { U: () => c });
   ...
   const a = (e, n) => {
    ...
    c = (e) => {
     let { children: n, omitH1: t = !1, headingLevel: r = 1, baseUrl: a = '', components: l = {} } = e;
     return (0, s.jsx)(i.Z, { components: { ...d(t, r), ...o(a), ...l }, children: n });
    };
  },
  46364: (e, n, t) => {
   t.d(n, { j: () => a });
