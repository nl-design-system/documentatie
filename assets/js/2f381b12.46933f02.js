   ...
   const j = ({ code: e, copy: l = !0, defaultExpandedCode: n = !1, displayCode: j = !0, children: g, container: y = 'document', language: x, designTokens: f }) => {
    ...
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       k && (0, p.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(F, { children: (0, p.jsx)(o.v$, { children: k }) }) }) }),
       j &&
        (0, p.jsx)('div', {
