  ...
  70348(e, n, t) {
   ...
   const i = ({ className: e, ...n }) => {
    ...
    a = ({ className: e, classNamePanel: n, label: t, heading: i, headingLevel: a, headingApperance: c, ...d }) => {
     ...
     return (0, r.jsxs)('details', { className: h, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(s.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [i && (0, r.jsx)(o.D, { level: a, appearance: c, children: i }), t] })] }) }), (0, r.jsx)('div', { className: p, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => x });
