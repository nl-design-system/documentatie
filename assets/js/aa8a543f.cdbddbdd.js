...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [77057],
 {
  ...
  64004: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => T, contentTitle: () => P, default: () => L, frontMatter: () => E, metadata: () => W, toc: () => M });
   var r = t(52676),
    s = t(24785);
   function o(e) {
   ...
   function y(e = {}) {
    const { wrapper: n } = { ...(0, s.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(_, { ...e }) }) : _();
   }
   function z(e) {
    const n = { a: 'a', h2: 'h2', img: 'img', li: 'li', p: 'p', ul: 'ul', ...(0, s.a)(), ...e.components };
  ...
  66771: (e, n, t) => {
   ...
   const x = (e) => {
    let { code: n, copy: t = !0, defaultExpandedCode: x = !1, displayCode: v = !0, children: k, container: f = 'document', language: w, designTokens: _ } = e,
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (S = await d.ZP.format(N, { parser: w, plugins: [o.Z, i.ZP, l.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), D(S);
     })();
    }, [N]);
    const C = (0, c.useId)();
    let V = c.Fragment;
    return (
     'paragraph' === f ? (V = j) : 'document' === f ? (V = g) : 'surface' === f && (V = p),
     (0, m.jsxs)('div', {
      className: (0, s.Z)(h['nlds-canvas']),
      children: [
       y && (0, m.jsx)('div', { className: (0, s.Z)(h['nlds-canvas__example']), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: _, children: (0, m.jsx)(V, { children: (0, m.jsx)(r.pu, { children: y }) }) }) }),
       v &&
        (0, m.jsx)('div', {
