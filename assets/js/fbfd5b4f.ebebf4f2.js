 ...
 [22410],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    l = n(86070);
   const h = { figma: (0, l.jsx)(s.A, {}), github: (0, l.jsx)(i.A, {}), npm: (0, l.jsx)(c.A, {}), storybook: (0, l.jsx)(o.A, {}) },
    u = ({ brand: e }) => (0, l.jsx)(r.In, { children: h[e] || (0, l.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => d, mJ: () => p, VZ: () => _, cR: () => w, Pv: () => y, qZ: () => c, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => i, eQ: () => f, B_: () => v, o_: () => m, Rc: () => x });
   ...
   const u = (e) => [...e].sort((e, t) => l.indexOf(e) - l.indexOf(t)),
    ...
    p = (e) => u(h(e.projects.flatMap((e) => g(e)))),
    y = (e) => {
     const t = g(e),
      n = ((e) => {
  ...
  44594(e, t, n) {
   ...
   const o = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    a = ({ name: e, relayStep: t, description: n }) => {
     const a = (0, i.fX)(t),
      l = o[e] ?? e;
     return (0, c.jsxs)(r.WK, { children: [(0, c.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, s.A)('component-illustration', `component-illustration--${a}`), fill: 'none', children: [(0, c.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, c.jsx)('rect', { width: '960', height: '540' }), (0, c.jsx)('rect', { width: '960', height: '540' })] }), (0, c.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, c.jsx)('use', { href: `/svg/componenten_overzicht_${(0, i.fX)(l)}.svg#component-illustration` })] }), (0, c.jsx)(r.$P, { className: 'component-illustration__caption', children: n })] });
    };
  },
  54565(e, t, n) {
   'use strict';
  ...
  85825(e, t, n) {
   ...
   const p = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    y = ({ checked: e, children: t, title: n, description: r, headingLevel: i = 3 }) => (0, l.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(g.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [n ? (0, l.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: i, children: n }) : null, r, t] })] });
   var m = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => m.f4.includes(e.id)),
      i = n && m.f4.map((e) => n.find((t) => t.id === e)).filter(Boolean);
     return e && (0, l.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, m.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(y, { headingLevel: t + 1, checked: e, title: n, description: (0, m.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            c.Zp,
            {
             ...
             children: (0, l.jsxs)(c.Wu, {
              children: [
               ...
               o.length > 0 && (0, l.jsx)(l.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [s, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    b = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(d.p, { level: t, suffix: s && (0, l.jsx)(u.D, { state: s }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
