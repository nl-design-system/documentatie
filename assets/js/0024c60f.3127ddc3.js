 ...
 [73512],
 {
        ...
        (0, u.jsxs)('div', {
         ...
         children: [
          (0, u.jsxs)(o.LB, {
           ...
           'aria-labelledby': k,
           children: [
            (0, u.jsx)(d.DZ, { level: n, id: k, children: 'Filter acceptatiecriteria voor:' }),
            Array.from(g).map((e) =>
             (0, u.jsxs)(
              o.zB,
              {
  ...
  24456(e, n, t) {
   ...
   const o = ({ children: e, ...n }) => {
    ...
    a = ({ className: e, boxContent: n, ...t }) => (0, i.jsx)(o, { className: (0, s.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  24703(e, n, t) {
   'use strict';
   t.d(n, { o: () => d });
  ...
  48068(e, n, t) {
   ...
   var m = t(43864),
    ...
    k = t(23436),
    v = t(79532);
   const A = { boxShadow: m.A, color: u.A, cursor: h.A, dimension: p.A, fontFamily: j.A, fontFamilies: j.A, fontSize: f.A, fontSizes: f.A, fontWeight: x.A, fontWeights: x.A, lineHeight: w.A, lineHeights: w.A, number: b.A, other: k.A, textDecoration: v.A },
    y = ({ type: e }) => {
  ...
  84471(e, n, t) {
   'use strict';
   t.d(n, { bo: () => r, KF: () => m, mJ: () => p, VZ: () => A, cR: () => v, Pv: () => j, qZ: () => o, kD: () => b, QQ: () => C, B2: () => u, Pc: () => l, f4: () => a, GT: () => k, fX: () => i, eQ: () => w, B_: () => x, o_: () => f });
