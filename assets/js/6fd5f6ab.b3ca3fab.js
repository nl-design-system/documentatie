(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [72755],
 {
  ...
  63100: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => M, component: () => O, contentTitle: () => _, default: () => U, description: () => P, frontMatter: () => Z, issueNumber: () => V, metadata: () => D, title: () => H, toc: () => F });
   var r,
    i,
    s,
    o,
   ...
   function E(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, d.jsx)(N.Rv, { component: O, headingLevel: 1, description: P }),
      '\n',
      (0, d.jsx)(G.I, { component: O }),
      '\n',
      (0, d.jsx)(n.h2, { id: 'anatomie', children: 'Anatomie' }),
      '\n',
      (0, d.jsx)(W.B, { component: O, illustration: p }),
      '\n',
      ...
      '\n',
      (0, d.jsx)(N.cN, { component: O, headingLevel: 3 }),
      '\n',
      (0, d.jsx)(n.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, d.jsx)(N.W, { component: O, headingLevel: 3 }),
      '\n',
      ...
      '\n',
      (0, d.jsx)(N.vM, { component: O, headingLevel: 3 }),
     ],
    });
   }
   function U(e = {}) {
  ...
  94443: (e, n, t) => {
   ...
   const f = (e) => {
          ...
          children: [
           (0, d.jsx)(w, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(y, { headingLevel: t + 1, checked: n, title: r, description: (0, k.Q6)(i) }, i);
            }),
           }),
    ...
    A = (e) => {
     let { component: n, headingLevel: t } = e;
     const i = n && n.projects.filter((e) => !k.e9.includes(e.id));
     return n && i.length
      ? (0, d.jsx)(m.um, {
         appearance: 'large',
               ...
               s.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: s.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: t + 2, children: [i, ' in ', n] }), (0, d.jsx)(r.Mc, { children: s.map((e) => (0, d.jsxs)(r.k7, { href: e.value, children: [(0, d.jsx)(u, { brand: e.brand }), ' ', e.description] }, e.id)) })] });
                 }),
                }),
              ],
             }),
    ...
    b = (e) => {
     ...
     const s = n && k.$3[n.relayStep];
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.V, { level: t, suffix: s && (0, d.jsx)(g.y, { state: s }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, n, t) => {
   'use strict';
  ...
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, BA: () => c, Q6: () => s, U: () => l, e9: () => o, mA: () => i, ps: () => d });
