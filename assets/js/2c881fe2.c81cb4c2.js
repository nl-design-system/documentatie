 ...
 [82200],
 {
  26757: (e, t, n) => {
   ...
   const o = { title: 'Ordered List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Ordered List', pagination_label: 'Ordered List', description: 'Lijst waarvan de volgorde van items betekenis heeft.', slug: '/ordered-list' },
    a = void 0,
    l = { id: 'componenten/ordered-list/index', title: 'Ordered List', description: 'Lijst waarvan de volgorde van items betekenis heeft.', source: '@site/docs/componenten/ordered-list/index.mdx', sourceDirName: 'componenten/ordered-list', slug: '/ordered-list', permalink: '/ordered-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/ordered-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Ordered List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Ordered List', pagination_label: 'Ordered List', description: 'Lijst waarvan de volgorde van items betekenis heeft.', slug: '/ordered-list' }, sidebar: 'componenten', previous: { title: 'Number Input', permalink: '/number-input' }, next: { title: 'Page Footer', permalink: '/page-footer' } },
    u = {},
    d = [
