 ...
 [43166],
 {
  ...
  35038: (e, n, t) => {
   ...
   const s = (e) => {
    ...
    c = (e) => {
     let { href: n, appearance: t, className: s, component: o = 'div', background: c, children: l } = e;
     const d = (e) => ('article' === o ? (0, a.jsx)('article', { ...e }) : 'section' === o ? (0, a.jsx)('section', { ...e }) : (0, a.jsx)('div', { ...e })),
      h = (0, a.jsx)(d, { className: (0, i.Z)('cardgroup__card', c && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, s), children: l });
     return n ? (0, a.jsx)(r.rU, { href: n, boxContent: !0, className: 'cardgroup__link', children: h }) : h;
    },
    l = (e) => {
  ...
  8657: (e, n, t) => {
   ...
   const w = (e) => {
     ...
     return (
      ...
      (0, d.jsx)(r.a2, {
       sections: s.map((e) => ({
        className: (0, i.Z)('definition-of-done', e && `definition-of-done--${(0, f.mA)(o(e))}`),
        headingLevel: t,
        expanded: !1,
        ...
        body:
         ...
         (0, d.jsxs)(d.Fragment, {
          children: [
           ...
           (0, d.jsx)(r.nv, { children: (0, d.jsxs)(r.rU, { href: `${e.url}?filterQuery=${n.title}`, children: [o(e), ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
      ...
      const r = e.tasks
       ...
       .map((r) => {
        ...
        const o = /^(.+) URL/.exec(i)[1],
         c = 'Storybook' === o ? `${t} (${n}) in Storybook van ${((e) => (['Candidate - New', 'Candidate - Oud'].includes(e.title) ? 'Candidate' : e.title))(e)}` : `${t} (${n}) op ${o}`;
