...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [8610],
 {
  36374: (e, n, t) => {
   ...
   const T = { icon: (0, r.jsx)(N, {}), title: (0, r.jsx)(l.Z, { id: "theme.admonition.caution", description: "The default label used for the Caution admonition (:::caution)", children: "caution" }) };
   const M = {
    ...{
     note: x,
     tip: _,
    ...
    ...{
     ...
     caution: function (e) {
      return (0, r.jsx)(m, { ...T, ...e, className: (0, i.Z)("alert alert--warning", e.className), children: e.children });
     },
    },
   };
   function P(e) {
    const n = s(e),
     t = ((a = n.type), M[a] || (console.warn(`No admonition component found for admonition type "${a}". Using Info as fallback.`), M.info));
    var a;
    return (0, r.jsx)(t, { ...n });
   }
  },
  ...
  9756: (e, n, t) => {
   ...
   var a = t(54447),
    ...
    s = t(45726),
    i = t(50502),
    l = (0, t(65195).Z)("outline", "calendar", "IconCalendar", [
  ...
  50502: (e, n, t) => {
   t.d(n, { Z: () => a });
   var a = (0, t(65195).Z)("outline", "user", "IconUser", [
