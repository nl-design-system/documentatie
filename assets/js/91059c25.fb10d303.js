 ...
 [93787],
 {
  ...
  12013(e, t, n) {
   ...
   const c = (e, t) => {
    ...
    a = (e) => ({ img: ({ src: t, ...n }) => (0, s.jsx)('img', { ...n, src: c(e, t), className: 'utrecht-img utrecht-img--fit' }) }),
    l = (e, t) => {
     if (e) {
      const e = { ...o[t - 1] };
      return ((e.h1 = () => null), e);
    ...
    h = ({ children: e, omitH1: t = !1, headingLevel: n = 1, baseUrl: i = '', components: c = {} }) => (0, s.jsx)(r.x, { components: { ...l(t, n), ...a(i), ...c }, children: e });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => y, VZ: () => w, cR: () => x, Pv: () => v, qZ: () => c, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => s, eQ: () => q, B_: () => g, o_: () => p, Rc: () => b });
   ...
   const u = (e) => [...e].sort((e, t) => l.indexOf(e) - l.indexOf(t)),
    ...
    y = (e) => u(h(e.projects.flatMap((e) => m(e)))),
    v = (e) => {
     const t = m(e),
      n = ((e) => {
  ...
  41895(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => f, component: () => _, contentTitle: () => k, default: () => A, description: () => x, frontMatter: () => q, issueNumber: () => w, metadata: () => r, title: () => b, toc: () => z }));
   ...
   const q = { title: 'Heading 6', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading 6', pagination_label: 'Heading 6', description: 'Koptekst die in de koppenstructuur op het zesde niveau staat.', slug: '/heading-6', keywords: ['caption', 'content', 'h6', 'heading', 'heading level', 'headline', 'kop', 'paginakop', 'sectie', 'section', 'structure', 'titel', 'title'] },
    ...
    f = {},
    b = 'Heading 6',
    x = 'Koptekst die in de koppenstructuur op het zesde niveau staat.',
    w = 262,
    _ = j.find((e) => e.number === w),
    z = [
  ...
  72401(e, t, n) {
   ...
   const o = ({ component: e }) => {
    const { title: t } = e,
     o = (0, s.fX)(t),
     a = i.lazy(() => n(82839)(`./${o}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
    return (0, c.jsx)(i.Suspense, { fallback: null, children: (0, c.jsx)(r.o, { omitH1: !0, headingLevel: 1, children: (0, c.jsx)(a, {}) }) });
   };
  },
  72642(e, t, n) {
   'use strict';
