 ...
 [22619],
 {
  ...
  8238: (e, n, l) => {
   ...
   var t = l(52676),
    ...
    a = l(40761);
   function i(e) {
    const n = { button: 'button', h2: 'h2', ...(0, o.a)(), ...e.components };
  ...
  43599: (e, n, l) => {
   ...
   const y = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(z, { parser: x, plugins: [s.Z, a.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      Z(e);
     })();
    }, [z]);
    const D = (0, u.useId)();
    ...
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       _ && (0, m.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(P, { children: (0, m.jsx)(o.pu, { children: _ }) }) }) }),
       b &&
        (0, m.jsx)('div', {
       ...
       b &&
        (0, m.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(t.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: N, trim: !0 }),
          l &&
           (0, m.jsx)('div', {
    ...
    return (
     ...
     (0, i.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, i.jsx)(t.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': h, style: l, children: o.map((e, l) => (0, i.jsxs)('span', { ...r({ line: e }), children: [n && (0, i.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
