 ...
 [48541],
 {
  71507: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(80719),
    s = n(90786);
   const o = { title: 'Image', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Image', pagination_label: 'Image', description: 'Toont een afbeelding', slug: '/image' },
    a = void 0,
    l = { id: 'componenten/image/index', title: 'Image', description: 'Toont een afbeelding', source: '@site/docs/componenten/image/index.mdx', sourceDirName: 'componenten/image', slug: '/image', permalink: '/image', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/image/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Image', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Image', pagination_label: 'Image', description: 'Toont een afbeelding', slug: '/image' }, sidebar: 'componenten', previous: { title: 'Icon', permalink: '/icon' }, next: { title: 'Invalid form alert', permalink: '/invalid-form-alert' } },
    u = {},
    d = [
