(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [9910],
 {
  ...
  35038: (e, t, n) => {
   'use strict';
   n.d(t, { Zb: () => a, aY: () => s, um: () => u, wu: () => i });
   var r = n(28439),
    c = n(4814),
    o = n(52676);
   const i = (e) => {
     let { background: t, children: n, className: r, ...i } = e;
     return (0, o.jsx)('div', { className: (0, c.Z)('card__illustration', t && 'card__illustration--background', r), ...i, children: n });
    },
    ...
    a = (e) => {
     ...
     const u = (e) => ('article' === s ? (0, o.jsx)('article', { ...e }) : 'section' === s ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      l = (0, o.jsx)(u, { className: (0, c.Z)('cardgroup__card', `cardgroup__card--${n}`, i), children: a });
     return t ? (0, o.jsx)(r.rU, { href: t, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    u = (e) => {
     let { appearance: t = 'medium', children: n, className: r } = e;
     return (0, o.jsx)('div', { className: (0, c.Z)('cardgroup', `cardgroup--${t}`, r), children: n });
    };
  },
  8657: (e, t, n) => {
   'use strict';
   ...
   var r = n(35076),
    ...
    u = n(32636),
    l = n(52676);
   const h = { figma: (0, l.jsx)(o.Z, {}), github: (0, l.jsx)(i.Z, {}), npm: (0, l.jsx)(s.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
   ...
   const w = (e) => {
            ...
            j.Zb,
            {
             ...
             children: (0, l.jsxs)(j.aY, {
              children: [
               ...
               (s.length > 0 || o.length > 0) && (0, l.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               s.length > 0 &&
                (0, l.jsx)(l.Fragment, {
               ...
               o.length > 0 &&
                (0, l.jsx)(l.Fragment, {
                 children: o.map((e) => {
                  ...
                  return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.X6, { level: n + 2, children: [c, ' in ', t] }), (0, l.jsx)(r.Mc, { links: o.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
    ...
    N = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(g.V, { level: n, suffix: o && (0, l.jsx)(p.y, { state: o }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  41757: (e, t, n) => {
   ...
   var r = n(4814),
    c = n(52676);
   const o = (e) => {
    let { children: t, className: n, level: o = 1, suffix: i, ...s } = e;
    return (0, c.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${o}`, n), ...s, children: [(0, c.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), i && (0, c.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [i ? ' ' : '', i] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => s, Ee: () => l, Q6: () => o, U: () => j, Yr: () => g, d: () => h, e9: () => i, fO: () => b, mA: () => c, ps: () => y, qU: () => k, s0: () => v, zP: () => m });
    ...
    y = (e) => {
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        let { name: c, id: o, value: i } = r;
        const s = /^(.+) URL/.exec(c)[1],
         a = 'Storybook' === s ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${s}`;
        return { brand: s.toLowerCase(), name: c, id: o, value: i, description: a };
       });
