 ...
 [44344],
 {
  183(e, n, t) {
   ...
   const d = { title: 'Note', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Note', pagination_label: 'Note', description: 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.', slug: '/note', keywords: ['spotlight', 'callout'] },
    ...
    h = {},
    m = 'Note',
    g = 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.',
    p = 409,
    u = 'help wanted',
    f = 'note',
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => r, KF: () => m, mJ: () => u, VZ: () => A, cR: () => k, Pv: () => f, qZ: () => s, kD: () => b, B2: () => g, Pc: () => l, f4: () => o, GT: () => _, fX: () => i, eQ: () => v, B_: () => x, o_: () => j, Rc: () => N });
