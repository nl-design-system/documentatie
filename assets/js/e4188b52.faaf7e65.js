...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [31764],
 {
  ...
  13905(e, n, t) {
   (t.r(n), t.d(n, { assets: () => p, contentTitle: () => k, default: () => x, frontMatter: () => j, metadata: () => s, toc: () => m }));
   const s = JSON.parse('{"id":"wcag/2.1.04","title":"WCAG-succescriterium 2.1.4 Enkel teken sneltoetsen","description":"Bied geen sneltoetsen aan die bestaan uit \xe9\xe9n teken.","source":"@site/docs/wcag/2.1.04.mdx","sourceDirName":"wcag","slug":"/wcag/2.1.4","permalink":"/wcag/2.1.4","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.1.04.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 2.1.4 Enkel teken sneltoetsen","title_sm":"2.1.4 Enkel teken sneltoetsen","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"2.1.4 Enkel teken sneltoetsen","pagination_label":"WCAG-succescriterium 2.1.4 Enkel teken sneltoetsen","description":"Bied geen sneltoetsen aan die bestaan uit \xe9\xe9n teken.","slug":"2.1.4","conformance_level":"Niveau A","keywords":["WCAG","A","bedienbaar","toetsenbordtoegankelijk","operable","keyboard accessible","character key shortcuts"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 2.1.3 Toetsenbord (geen uitzondering)","permalink":"/wcag/2.1.3"},"next":{"title":"WCAG-succescriterium 2.2.1 Timing aanpasbaar","permalink":"/wcag/2.2.1"}}');
   var i = t(86070),
    r = t(18439),
    l = t(51582),
    o = t(66820),
   ...
   const j = { title: 'WCAG-succescriterium 2.1.4 Enkel teken sneltoetsen', title_sm: '2.1.4 Enkel teken sneltoetsen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.1.4 Enkel teken sneltoetsen', pagination_label: 'WCAG-succescriterium 2.1.4 Enkel teken sneltoetsen', description: 'Bied geen sneltoetsen aan die bestaan uit \xe9\xe9n teken.', slug: '2.1.4', conformance_level: 'Niveau A', keywords: ['WCAG', 'A', 'bedienbaar', 'toetsenbordtoegankelijk', 'operable', 'keyboard accessible', 'character key shortcuts'] },
    k = void 0,
    p = {},
  ...
  66820(e, n, t) {
   ...
   var s = t(46447),
    i = t(10645),
    r = t(86070);
   const l = ({ children: e, conformanceLevel: n, ...t }) => (globalThis.isAstro ? null : (0, r.jsx)(i.p, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: n && (0, r.jsx)(s.KE, { className: 'nlds-inline-heading-group__badge', children: n }), ...t, children: e }));
  },
  91170(e, n, t) {
   t.d(n, { Ay: () => o, RM: () => r });
   var s = t(86070),
  ...
  95857(e, n, t) {
   ...
   function i(e) {
    ...
    if ('string' == typeof e || 'number' == typeof e) s += e;
     ...
     if (Array.isArray(e)) {
      var r = e.length;
      for (n = 0; n < r; n++) e[n] && (t = i(e[n])) && (s && (s += ' '), (s += t));
     } else for (t in e) e[t] && (s && (s += ' '), (s += t));
    return s;
   }
   function r() {
    for (var e, n, t = 0, s = '', r = arguments.length; t < r; t++) (e = arguments[t]) && (n = i(e)) && (s && (s += ' '), (s += n));
    return s;
   }
   const l = (0, t(30758).forwardRef)(({ aside: e, children: n, className: t, purpose: i, ...l }, o) => {
    const a = { ...l, ref: o, className: r('utrecht-note', { [`utrecht-note--${i}`]: i }, t) };
    return e ? (0, s.jsx)('aside', { ...a, children: n }) : (0, s.jsx)('section', { role: 'note', ...a, children: n });
   });
   l.displayName = 'Note';
   var o = t(29181);
