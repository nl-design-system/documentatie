...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [94977],
 {
  ...
  58639(e, n, l) {
   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: j = !0, children: y, container: v = 'document', language: f, designTokens: x }) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(w, { parser: f, plugins: [i.A, r.Ay, c.Ay, a.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      A(e);
     })();
    }, [w]);
    const S = (0, p.useId)();
    let D = p.Fragment;
    return (
     'paragraph' === v ? (D = m) : 'document' === v ? (D = g) : 'surface' === v && (D = b),
     (0, h.jsxs)('div', {
      className: (0, o.A)('nlds-canvas'),
      children: [
       k && (0, h.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, h.jsx)(D, { children: (0, h.jsx)(t.v$, { children: k }) }) }) }),
       j &&
        (0, h.jsx)('div', {
       ...
       j &&
        (0, h.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, h.jsx)(s.M, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: N, trim: !0 }),
          n &&
           (0, h.jsx)('div', {
  ...
  93741(e, n, l) {
   (l.r(n), l.d(n, { assets: () => j, contentTitle: () => b, default: () => f, frontMatter: () => g, metadata: () => s, toc: () => y }));
