...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [73536],
 {
  ...
  24844: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => h, contentTitle: () => c, default: () => p, frontMatter: () => i, metadata: () => d, toc: () => j });
   var l = t(52676),
    r = t(40139),
    s = t(43599),
    a = t(40761),
  ...
  43599: (e, n, t) => {
   ...
   const p = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(r.BB, { className: (0, s.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(r.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   p.displayName = 'ParagraphContainer';
   const u = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(r.Tg, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(r.BB, { className: (0, s.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   ...
   const x = (e) => {
    ...
    const _ = 'function' == typeof g ? g() : g,
     z = 'function' == typeof n ? n() : (0, h.isValidElement)(n) ? n : void 0,
     N = 'string' == typeof n ? n : j.uS(z || _),
     [w, C] = (0, h.useState)(N),
     [S, Z] = (0, h.useState)(x);
    (0, h.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(N, { parser: y, plugins: [a.Z, o.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [N]);
    const T = (0, h.useId)();
    let D = h.Fragment;
    return (
     'paragraph' === v ? (D = p) : 'document' === v ? (D = u) : 'surface' === v && (D = b),
     (0, m.jsxs)('div', {
      className: (0, s.Z)('nlds-canvas'),
      children: [
       _ && (0, m.jsx)('div', { className: (0, s.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(D, { children: (0, m.jsx)(r.pu, { children: _ }) }) }) }),
       k &&
        (0, m.jsx)('div', {
       ...
       k &&
        (0, m.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, m.jsx)(l.u, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: w, trim: !0 }),
          t &&
           (0, m.jsx)('div', {
  ...
  41179: (e, n, t) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: t, textContent: c, trim: d } = e,
     h = c;
    const { title: j, type: m } = (0, s.useContext)(a.n),
     p = (0, s.useId)();
    return (
     d && (h = h.trim()),
     (0, i.jsx)(r.y$, {
      ...
      language: t || '',
      children: (e) => {
       let { style: t, tokens: r, getLineProps: s, getTokenProps: a } = e;
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', j ? ': ' : ' ', j] }), (0, i.jsx)(l.dn, { tabIndex: 0, role: j ? 'region' : void 0, 'aria-labelledby': p, style: t, children: r.map((e, t) => (0, i.jsxs)('span', { ...s({ line: e }), children: [n && (0, i.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
  ...
  40761: (e, n, t) => {
   ...
   const c = (0, o.createContext)({}),
    d = (e) => {
     let { title: n, appearance: t, description: o, children: d, figure: h } = e;
     const j = { do: 'Doen', dont: 'Niet doen' },
      m = h ? 'figure' : 'div',
      p = h ? 'figcaption' : 'div';
     return (0, i.jsxs)(m, { className: (0, a.Z)('nlds-guideline', `nlds-guideline--${t}`), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, i.jsxs)(p, { className: 'nlds-guideline__description', children: ['dont' === t ? (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(s.nv, { className: (0, a.Z)('nlds-guideline__badge', `nlds-guideline__badge--${t}`), children: [(0, i.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, i.jsx)('span', { className: 'nlds-guideline__title', children: j.dont })] }), (0, i.jsx)(s.nv, { children: n })] }) : (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(s.nv, { className: (0, a.Z)('nlds-guideline__badge', `nlds-guideline__badge--${t}`), children: [(0, i.jsx)(r.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, i.jsx)('span', { className: 'nlds-guideline__title', children: j.do })] }), (0, i.jsx)(s.nv, { children: n })] }), o] }), (0, i.jsx)('div', { className: 'nlds-guideline__example', children: (0, i.jsx)(c.Provider, { value: { title: n, type: j[t] }, children: d }) })] });
    };
  },
  40139: (e, n, t) => {
   t.d(n, { Z: () => o, a: () => a });
