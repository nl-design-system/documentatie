    ...
    return (
     ...
     (0, o.jsx)(l.y$, {
      ...
      children: (e) => {
       ...
       return (0, o.jsx)(s.dn, { tabIndex: 0, style: r, children: l.map((e, r) => (0, o.jsxs)('span', { ...t({ line: e }), children: [n && (0, o.jsx)('span', { children: r + 1 }), e.map((e, n) => (0, o.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, r)) });
      },
     })
    );
   }
  ...
  91050: (e, n, r) => {
   ...
   const c = (e) => {
    ...
    const h = 'Doen',
     ...
     m = u ? 'figure' : 'div',
     g = u ? 'figcaption' : 'div';
    return (0, a.jsxs)(m, { className: (0, o.Z)(i['nlds-guideline'], i[`nlds-guideline--${r}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(g, { className: (0, o.Z)(i['nlds-guideline__description']), children: ['dont' === r ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, o.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${r}`]), children: [(0, a.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: i['nlds-guideline__title'], children: p })] }), (0, a.jsx)(t.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, o.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${r}`]), children: [(0, a.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: i['nlds-guideline__title'], children: h })] }), (0, a.jsx)(t.nv, { children: n })] }), c] }), (0, a.jsx)('div', { className: (0, o.Z)(i['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, r) => {
   r.d(n, { Z: () => i, a: () => o });
