 ...
 [45119],
 {
  71305: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(43282),
    s = n(8657);
   const o = { title: 'Date Picker', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Picker', pagination_label: 'Date Picker', description: 'Invoerveld om een beschikbare datum te kiezen via een op maat gemaakte kalender.', slug: '/date-picker' },
    a = void 0,
    u = { id: 'componenten/date-picker/index', title: 'Date Picker', description: 'Invoerveld om een beschikbare datum te kiezen via een op maat gemaakte kalender.', source: '@site/docs/componenten/date-picker/index.mdx', sourceDirName: 'componenten/date-picker', slug: '/date-picker', permalink: '/date-picker', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-picker/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Date Picker', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Picker', pagination_label: 'Date Picker', description: 'Invoerveld om een beschikbare datum te kiezen via een op maat gemaakte kalender.', slug: '/date-picker' }, sidebar: 'componenten', previous: { title: 'Date Input Group', permalink: '/date-input-group' }, next: { title: 'Description List', permalink: '/description-list' } },
    l = {},
    h = [
