...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [78311],
 {
  ...
  53560: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => v, contentTitle: () => m, default: () => _, frontMatter: () => u, metadata: () => g, toc: () => b });
   var s = t(52676),
    l = t(24785),
    o = t(98480),
    a = t(91050);
  ...
  98480: (e, n, t) => {
   ...
   const _ = (e) => {
    let { code: n, copy: t = !0, defaultExpandedCode: _ = !1, displayCode: y = !0, children: x, container: j = 'document', language: f, designTokens: k } = e,
    ...
    let E = d.Fragment;
    return (
     'paragraph' === j ? (E = v) : 'document' === j ? (E = b) : 'surface' === j && (E = h),
     (0, g.jsxs)('div', {
      className: (0, l.Z)(u['nlds-canvas']),
      children: [
       N && (0, g.jsx)('div', { className: (0, l.Z)(u['nlds-canvas__example']), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, g.jsx)(E, { children: (0, g.jsx)(s.pu, { children: N }) }) }) }),
       y &&
        (0, g.jsx)('div', {
  ...
  41179: (e, n, t) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: t, textContent: c, trim: d } = e,
     p = c;
    const { title: u, type: m } = (0, o.useContext)(a.n),
     g = (0, o.useId)();
    return (
     d && (p = p.trim()),
     (0, r.jsx)(l.y$, {
      ...
      children: (e) => {
       ...
       return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)('span', { hidden: !0, id: g, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, r.jsx)(s.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': g, style: t, children: l.map((e, t) => (0, r.jsxs)('span', { ...o({ line: e }), children: [n && (0, r.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, r.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, t) => {
   ...
   const d = (0, i.createContext)({}),
    p = (e) => {
     let { title: n, appearance: t, description: i, children: p, figure: u } = e;
     const m = { do: 'Doen', dont: 'Niet doen' },
      g = u ? 'figure' : 'div',
      v = u ? 'figcaption' : 'div';
     return (0, c.jsxs)(g, { className: (0, a.Z)(r['nlds-guideline'], r[`nlds-guideline--${t}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(v, { className: (0, a.Z)(r['nlds-guideline__description']), children: ['dont' === t ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(o.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${t}`]), children: [(0, c.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: m.dont })] }), (0, c.jsx)(o.nv, { children: n })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(o.nv, { className: (0, a.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${t}`]), children: [(0, c.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: r['nlds-guideline__title'], children: m.do })] }), (0, c.jsx)(o.nv, { children: n })] }), i] }), (0, c.jsx)('div', { className: (0, a.Z)(r['nlds-guideline__example']), children: (0, c.jsx)(d.Provider, { value: { title: n, type: m[t] }, children: p }) })] });
    };
  },
  24785: (e, n, t) => {
   t.d(n, { Z: () => i, a: () => a });
   ...
   function i(e) {
    let n;
    return (n = e.disableParentContext ? ('function' == typeof e.components ? e.components(l) : e.components || l) : a(e.components)), s.createElement(o.Provider, { value: n }, e.children);
   }
  },
 },
]);
