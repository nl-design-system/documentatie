(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [20858],
 {
  56010: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => p, contentTitle: () => a, default: () => m, description: () => j, frontMatter: () => o, issueNumber: () => y, metadata: () => u, title: () => d, toc: () => h });
   var r = n(52676),
    c = n(87118),
    i = n(56616),
    s = n(8657);
   const o = { title: 'Text Input Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text Input Group', pagination_label: 'Text Input Group', description: ' ', slug: '/text-input-group' },
    a = void 0,
  ...
  8657: (e, t, n) => {
   ...
   const _ = (e) => {
     ...
     const i = t && t.projects.filter((e) => f.e9.includes(e.id)),
      s = i && f.e9.map((e) => i.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
    ...
    A = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(m.V, { level: n, suffix: i && (0, l.jsx)(g.y, { state: i }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
