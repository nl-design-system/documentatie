 ...
 [81733],
 {
  ...
  98480: (e, n, t) => {
   ...
   const _ = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await c.ZP.format(z, { parser: x, plugins: [r.Z, s.ZP, i.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(Z);
     })();
    }, [z]);
    const V = (0, d.useId)();
    let P = d.Fragment;
    ...
    return (
     ...
     (0, s.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, s.jsx)(l.dn, { tabIndex: 0, style: t, children: o.map((e, t) => (0, s.jsxs)('span', { ...r({ line: e }), children: [n && (0, s.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, t)) });
      },
     })
    );
   }
  ...
  91050: (e, n, t) => {
   ...
   const c = (e) => {
    ...
    const m = 'Doen',
     ...
     p = u ? 'figure' : 'div',
     v = u ? 'figcaption' : 'div';
    return (0, a.jsxs)(p, { className: (0, s.Z)(i['nlds-guideline'], i[`nlds-guideline--${t}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(v, { className: (0, s.Z)(i['nlds-guideline__description']), children: ['dont' === t ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.nv, { className: (0, s.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${t}`]), children: [(0, a.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: i['nlds-guideline__title'], children: h })] }), (0, a.jsx)(r.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.nv, { className: (0, s.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${t}`]), children: [(0, a.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: i['nlds-guideline__title'], children: m })] }), (0, a.jsx)(r.nv, { children: n })] }), c] }), (0, a.jsx)('div', { className: (0, s.Z)(i['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, t) => {
   t.d(n, { Z: () => i, a: () => s });
