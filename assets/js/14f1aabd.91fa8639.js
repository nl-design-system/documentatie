/*! For license information please see 14f1aabd.91fa8639.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [43975],
 {
  12484: (e, n, s) => {
   s.r(n), s.d(n, { assets: () => h, contentTitle: () => c, default: () => j, frontMatter: () => o, metadata: () => d, toc: () => m });
   var i = s(52676),
    t = s(40139),
    l = s(68257),
    r = s(78511),
    a = s(37943);
   const o = { title: 'Slack \xb7 Project', slug: '/slack/', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Slack', pagination_label: 'Slack', description: 'Wij hebben chatkanelen in Slack, lees hier hoe je mee kan doen.', keywords: ['chat', 'Code for NL', 'codefor.nl', 'global-design-system', 'huddle', 'nl design system', 'nl-design-system', 'nl-design-system-a11y', 'nl-design-system-content', 'nl-design-system-designers', 'nl-design-system-developers', 'rijkshuisstijl-community', 'Slack'] },
    c = 'Slack voor NL Design System',
    d = { id: 'project/slack', title: 'Slack \xb7 Project', description: 'Wij hebben chatkanelen in Slack, lees hier hoe je mee kan doen.', source: '@site/docs/project/slack.mdx', sourceDirName: 'project', slug: '/slack/', permalink: '/slack/', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/project/slack.mdx', tags: [], version: 'current', frontMatter: { title: 'Slack \xb7 Project', slug: '/slack/', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Slack', pagination_label: 'Slack', description: 'Wij hebben chatkanelen in Slack, lees hier hoe je mee kan doen.', keywords: ['chat', 'Code for NL', 'codefor.nl', 'global-design-system', 'huddle', 'nl design system', 'nl-design-system', 'nl-design-system-a11y', 'nl-design-system-content', 'nl-design-system-designers', 'nl-design-system-developers', 'rijkshuisstijl-community', 'Slack'] }, sidebar: 'community', previous: { title: 'Belangenorganisaties', permalink: '/community/belangenorganisaties/aanmelden' } },
    h = {},
    m = [
  ...
  68257: (e, n, s) => {
   ...
   var i = s(44679),
    ...
    l = s(52676);
   const r = (e) => {
    let { appearance: n, ...s } = e;
    return (0, l.jsx)(i.Z, { className: (0, t.W)('utrecht-button-link', `utrecht-button-link--${n}`), ...s });
   };
  },
  40139: (e, n, s) => {
   s.d(n, { Z: () => a, a: () => r });
