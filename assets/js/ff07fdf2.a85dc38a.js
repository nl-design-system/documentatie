 ...
 [33710],
 {
         ...
         children: [
          ...
          (0, m.jsx)('div', {
           children: (0, m.jsxs)(m.Fragment, {
            children: [
             (0, m.jsxs)(a.f, { role: 'status', children: [f, ' van de ', w, ' items zijn nu zichtbaar.'] }),
             f < w
              ? (0, m.jsx)(l.$, {
                 purpose: 'secondary',
                 onClick: () => {
  ...
  24456(e, n, t) {
   ...
   const o = ({ children: e, ...n }) => {
    ...
    a = ({ className: e, boxContent: n, ...t }) => (0, s.jsx)(o, { className: (0, i.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  24908(e, n, t) {
   t.d(n, { Ay: () => o });
   var i = t(86070),
  ...
  26877(e, n, t) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
    ...
    A = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(m.p, { level: n, suffix: r && (0, c.jsx)(u.D, { state: r }), children: e.title }), (0, c.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(r) && (0, c.jsx)(f.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    k = ({ component: e }) => {
     const n = (e && w[e.title]) || [];
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => k, cR: () => A, Pv: () => w, qZ: () => o, kD: () => b, QQ: () => C, B2: () => m, Pc: () => l, f4: () => a, GT: () => v, fX: () => s, eQ: () => x, B_: () => f, o_: () => j });
  ...
  95408(e, n, t) {
   (t.r(n), t.d(n, { assets: () => L, component: () => S, contentTitle: () => G, default: () => _, description: () => N, frontMatter: () => R, issueNumber: () => F, metadata: () => i, title: () => D, toc: () => W }));
   ...
   const k = [
     ...
     { title: 'De tekst in de Unordered List heeft een contrastratio van minimaal 4,5:1 met de achtergrondkleur.', sc: '1.4.3', status: '', component: w.Ay, tags: ['designer'] },
     ...
     { title: 'De Unordered List is niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: f.Ay, tags: ['developer'] },
     { title: 'De Unordered List komt niet voor in de normale focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: v.Ay, tags: ['developer'] },
    ...
    y = [
     ...
     { title: 'De Unordered List is standaard niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: x.Ay, tags: ['developer'] },
     { title: 'De Unordered List komt standaard niet voor in de focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: b.Ay, tags: ['developer'] },
    ];
   var C = t(26877),
    T = t(1866);
