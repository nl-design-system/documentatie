 ...
 [37572],
 {
  ...
  43599: (e, n, o) => {
   ...
   const b = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      (Z = await d.ZP.format(N, { parser: j, plugins: [s.Z, c.ZP, a.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), z(Z);
     })();
    }, [N]);
    const S = (0, p.useId)();
    let F = p.Fragment;
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       _ && (0, h.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, h.jsx)(F, { children: (0, h.jsx)(l.pu, { children: _ }) }) }) }),
       y &&
        (0, h.jsx)('div', {
       ...
       y &&
        (0, h.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, h.jsx)(t.u, { codeBlockLabel: 'Codevoorbeeld', syntax: j, textContent: Z, trim: !0 }),
          o &&
           (0, h.jsx)('div', {
