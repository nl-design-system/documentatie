...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [56689],
 {
  ...
  42528(e, n, i) {
   ...
   const r = JSON.parse('{"id":"richtlijnen/formulieren/questions/index","title":"Uit te vragen informatie in een formulier","description":"Richtlijnen voor uit te vragen informatie in een formulier.","source":"@site/docs/richtlijnen/formulieren/questions/index.mdx","sourceDirName":"richtlijnen/formulieren/questions","slug":"/richtlijnen/formulieren/vragen/","permalink":"/richtlijnen/formulieren/vragen/","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/questions/index.mdx","tags":[],"version":"current","sidebarPosition":11,"frontMatter":{"title":"Uit te vragen informatie in een formulier","title_sm":"Uit te vragen informatie","hide_title":true,"hide_table_of_contents":true,"sidebar_label":"Introductie uit te vragen informatie","sidebar_position":11,"navigation_order":11,"pagination_label":"Uit te vragen informatie in een formulier","description":"Richtlijnen voor uit te vragen informatie in een formulier.","slug":"/richtlijnen/formulieren/vragen/","keywords":["informatie","formulier","design","code"]},"sidebar":"richtlijnen","previous":{"title":"Geen positieve tabindex","permalink":"/richtlijnen/formulieren/toetsenbord/tabindex"},"next":{"title":"Uit te vragen informatie in een formulier","permalink":"/richtlijnen/formulieren/vragen/"}}');
   var t = i(86070),
    o = i(18439),
    a = i(78734),
    l = i(23606);
   const s = { title: 'Uit te vragen informatie in een formulier', title_sm: 'Uit te vragen informatie', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Introductie uit te vragen informatie', sidebar_position: 11, navigation_order: 11, pagination_label: 'Uit te vragen informatie in een formulier', description: 'Richtlijnen voor uit te vragen informatie in een formulier.', slug: '/richtlijnen/formulieren/vragen/', keywords: ['informatie', 'formulier', 'design', 'code'] },
    c = 'Richtlijnen NL Design System voor uit te vragen informatie in een formulier',
    d = {},
    m = [{ value: 'Overzicht richtlijnen', id: 'overzicht-richtlijnen', level: 2 }, { value: 'Deze documentatie heeft nu een eigen pagina', id: 'deze-documentatie-heeft-nu-een-eigen-pagina', level: 2 }, ...a.RM];
   function h(e) {
