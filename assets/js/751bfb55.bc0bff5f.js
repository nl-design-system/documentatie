/*! For license information please see 751bfb55.bc0bff5f.js.LICENSE.txt */
'use strict';
 ...
 [67064],
 {
  ...
  97233: (e, n, t) => {
   ...
   const i = (e) => {
    ...
    return (0, o.jsx)(a.Z, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: n, title: t, poster: 'maxresdefault', ...i });
   };
  },
  40139: (e, n, t) => {
   t.d(n, { Z: () => s, a: () => r });
     ...
     a.createElement(
      ...
      a.createElement(
       M,
       {
        ...
        'data-title': h,
        style: o(o({ backgroundImage: 'url('.concat(z, ')') }, { '--aspect-ratio': ''.concat((N / C) * 100, '%') }), T),
       },
