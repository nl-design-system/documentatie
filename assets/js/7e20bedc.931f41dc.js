 ...
 [39783],
 {
   ...
   const i = (e) => {
    ...
    a = (e) => {
     ...
     const l = (e) => ('article' === o ? (0, s.jsx)('article', { ...e }) : 'section' === o ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      h = (0, s.jsx)(l, { className: (0, c.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, i), children: u });
  ...
  8657: (e, t, n) => {
   ...
   var r = n(74824),
    ...
    u = n(32636),
    l = n(52676);
   const h = { figma: (0, l.jsx)(s.Z, {}), github: (0, l.jsx)(i.Z, {}), npm: (0, l.jsx)(o.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
          ...
          children: [
           (0, l.jsx)(k, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(f, { headingLevel: n + 1, checked: t, title: r, description: (0, x.Q6)(c) }, c);
            }),
           }),
            ...
            j.Zb,
            {
             ...
             children: (0, l.jsxs)(j.aY, {
              children: [
               ...
               (o.length > 0 || s.length > 0) && (0, l.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               o.length > 0 &&
                (0, l.jsx)(l.Fragment, {
               ...
               s.length > 0 &&
                (0, l.jsx)(l.Fragment, {
                 children: s.map((e) => {
                  ...
                  return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.X6, { level: n + 2, children: [c, ' in ', t] }), (0, l.jsx)(r.Mc, { links: s.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => g, BA: () => o, Ee: () => l, Q6: () => s, U: () => j, Yr: () => p, d: () => h, e9: () => i, fO: () => v, mA: () => c, ps: () => y, qU: () => k, s0: () => b, zP: () => m });
