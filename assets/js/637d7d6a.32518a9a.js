  ...
  70348(e, n, l) {
   ...
   const a = ({ className: e, ...n }) => {
    ...
    c = ({ className: e, classNamePanel: n, label: l, heading: a, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, s.jsxs)('details', { className: u, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(t.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [a && (0, s.jsx)(r.D, { level: c, appearance: i, children: a }), l] })] }) }), (0, s.jsx)('div', { className: m, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => y });
