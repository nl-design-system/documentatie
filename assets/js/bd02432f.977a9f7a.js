   ...
   const d = (0, r.createContext)({}),
    g = ({ title: e, appearance: n, description: l, children: r, figure: g }) => {
     const m = { do: 'Doen', dont: 'Niet doen' },
      f = g ? 'figure' : 'div',
      h = g ? 'figcaption' : 'div',
      p = 'string' == typeof l ? (0, c.jsx)(s.oz, { components: { a: i.N_ }, children: l }) : l;
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const t = 'function' == typeof e ? e() : e,
        ...
        o = h().highlight(a, h().languages[n], n);
       return (0, b.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', l), children: [(0, b.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: a } }), (0, b.jsx)(p.n, { children: (0, b.jsx)(p.K, { label: 'Code', children: (0, b.jsx)('pre', { className: 'language-html nl-code-block', children: (0, b.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
