 ...
 [69634],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    u = n(86070);
   const l = { figma: (0, u.jsx)(i.A, {}), github: (0, u.jsx)(s.A, {}), npm: (0, u.jsx)(c.A, {}), storybook: (0, u.jsx)(o.A, {}) },
    h = ({ brand: e }) => (0, u.jsx)(r.In, { children: l[e] || (0, u.jsx)(a.A, {}) });
  },
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => g, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => c, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => s, eQ: () => f, B_: () => v, o_: () => y, Rc: () => x });
   ...
   const h = (e) => [...e].sort((e, t) => u.indexOf(e) - u.indexOf(t)),
    ...
    g = (e) => h(l(e.projects.flatMap((e) => p(e)))),
    m = (e) => {
     const t = p(e),
      n = ((e) => {
  ...
  44594(e, t, n) {
   ...
   const o = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    a = ({ name: e, relayStep: t, description: n }) => {
     const a = (0, s.fX)(t),
      u = o[e] ?? e;
     return (0, c.jsxs)(r.WK, { children: [(0, c.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, i.A)('component-illustration', `component-illustration--${a}`), fill: 'none', children: [(0, c.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, c.jsx)('rect', { width: '960', height: '540' }), (0, c.jsx)('rect', { width: '960', height: '540' })] }), (0, c.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, c.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, c.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, c.jsx)('use', { href: `/svg/componenten_overzicht_${(0, s.fX)(u)}.svg#component-illustration` })] }), (0, c.jsx)(r.$P, { className: 'component-illustration__caption', children: n })] });
    };
  },
  54565(e, t, n) {
   'use strict';
  ...
  85825(e, t, n) {
   ...
   var h = n(67970),
    ...
    j = n(46447),
    p = n(45561);
   const g = ({ children: e }) => (0, u.jsx)('ul', { className: 'task-list', children: e }),
    m = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, u.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, u.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, u.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, u.jsx)(p.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [n ? (0, u.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }) : null, r, t] })] });
   var y = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, y.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(g, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(m, { headingLevel: t + 1, checked: e, title: n, description: (0, y.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
                 ...
                 children: (0, u.jsx)(r.dk, {
                  links: h
                   ...
                   .map((e) => {
                    ...
                    return { children: t.desciption, icon: (0, u.jsx)(s.r, { brand: t.brand }), href: e.value };
                   }),
                 }),
                }),
               o.length > 0 && (0, u.jsx)(u.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, u.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, u.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    k = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(r.DZ, { level: t, children: 'Help om deze component te verbeteren' }), (0, u.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, u.jsxs)(r.Xy, { children: [i ? (0, u.jsxs)(r.Er, { children: ['Vul de ', (0, u.jsx)(r.N_, { href: i, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, u.jsxs)(r.Er, { children: [(0, u.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, u.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, u.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, u.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    b = ({ component: e, headingLevel: t, description: n }) => {
     const i = e && y.bo[e.relayStep];
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(d.p, { level: t, suffix: i && (0, u.jsx)(h.D, { state: i }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
   ...
   const c = ({ background: e, children: t, className: n, ...r }) => (0, s.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: c = 'div', background: o, children: a }) => {
     const u = (e) => ('article' === c ? (0, s.jsx)('article', { ...e }) : 'section' === c ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      l = (0, s.jsx)(u, { className: (0, i.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, s.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    u = ({ appearance: e = 'medium', children: t, className: n }) => (0, s.jsx)('div', { className: (0, i.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
 },
]);
