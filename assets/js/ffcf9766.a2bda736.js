...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [38100],
 {
  ...
  21034(e, n, a) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
    ...
    k = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: i && (0, d.jsx)(g.D, { state: i }), children: e.title }), (0, d.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(i) && (0, d.jsx)(b.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    N = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => D, cR: () => N, Pv: () => f, qZ: () => r, kD: () => j, QQ: () => H, B2: () => c, Pc: () => o, f4: () => s, GT: () => k, fX: () => l, eQ: () => v, B_: () => x, o_: () => b });
  ...
  70348(e, n, a) {
   ...
   const o = (0, i.forwardRef)(({ as: e, className: n, children: a, ...i }, l) => {
    ...
    d = ({ className: e, classNamePanel: n, label: a, heading: i, headingLevel: o, headingApperance: d, ...u }) => {
     ...
     return (0, s.jsxs)('details', { className: g, ...u, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(l.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [i && (0, s.jsx)(r.D, { level: o, appearance: d, children: i }), a] })] }) }), (0, s.jsx)('div', { className: m, children: u.children })] });
    };
  },
  74352(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => f, componentName: () => h, contentTitle: () => d, default: () => v, description: () => m, frontMatter: () => o, issueNumber: () => c, metadata: () => t, relayStep: () => p, title: () => g, toc: () => b }));
