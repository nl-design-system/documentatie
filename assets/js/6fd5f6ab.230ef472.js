 ...
 [53087],
 {
   ...
   function M(e) {
    ...
    return (0, i.jsxs)(i.Fragment, {
     children: [
      ...
      '\n',
      (0, i.jsx)(C.B, { tokens: N }),
      '\n',
      (0, i.jsx)(T.o, { omitH1: !0, headingLevel: 3, children: (0, i.jsx)(G, {}) }),
      '\n',
  ...
  73361: (e, n, t) => {
   ...
   var p = t(30696),
    ...
    x = t(43825),
    A = t(30758);
   const b = { color: p.A, dimension: j.A, fontFamilies: v.A, fontSizes: k.A, fontWeights: y.A, lineHeights: w.A, other: f.A, textDecoration: x.A },
       ...
       children: [
        ...
        (0, g.jsx)(o.BF, {
         children: t.map((n) => {
          const t = (0, s.o_)(n),
           c = (0, s.eQ)(e, n).$type;
          return (0, g.jsxs)(o.Hj, { children: [(0, g.jsx)(o.nA, { children: (0, g.jsx)(r.C, { children: (0, g.jsx)(o.kf, { children: t }) }) }), (0, g.jsx)(o.nA, { children: (0, g.jsxs)(i.K, { children: [(0, g.jsx)(C, { type: c }), ' ', c] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  75916: (e, n, t) => {
   'use strict';
   t.d(n, { B2: () => h, B_: () => j, GT: () => y, KF: () => d, Pc: () => c, Pv: () => m, Rc: () => w, bo: () => r, eQ: () => v, f4: () => o, fX: () => i, kD: () => k, mJ: () => g, o_: () => p, qZ: () => s });
