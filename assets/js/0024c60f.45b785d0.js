(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [73512],
 {
  ...
  21034(e, n, t) {
   ...
   const w = ({ component: e, headingLevel: n }) => {
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(g.p, { level: n, suffix: s && (0, c.jsx)(u.D, { state: s }), children: e.title }), (0, c.jsx)(r.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(s) && (0, c.jsx)(f.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    k = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  32385(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => g, mJ: () => h, VZ: () => A, cR: () => k, Pv: () => j, qZ: () => o, kD: () => b, QQ: () => C, B2: () => m, Pc: () => l, f4: () => a, GT: () => v, fX: () => i, eQ: () => x, B_: () => w, o_: () => f });
   ...
   var u = function (e) {
    ...
    m =
     ...
     (0, a.forwardRef)(function (e, n) {
      ...
      return (0, i.jsxs)('button', d(d({ ref: n, type: v, className: (0, o.$)('nl-button', r, { 'nl-button--pressed': w, 'nl-button--busy': x, 'nl-button--disabled': j || f, 'nl-button--primary': 'primary' === p, 'nl-button--secondary': 'secondary' === p, 'nl-button--subtle': 'subtle' === p, 'nl-button--positive': g(p) && 'positive' === h, 'nl-button--negative': g(p) && 'negative' === h, 'nl-button--icon-only': c }), 'aria-pressed': A ? String(Boolean(w)) : void 0, 'aria-disabled': j || x ? 'true' : void 0, disabled: f }, y), {}, { children: [m && (0, i.jsx)('span', { className: 'nl-button__icon-start', children: m }), k && (0, i.jsx)('span', { className: 'nl-button__label', children: k }), T ? (0, i.jsx)('span', { className: c ? 'nl-button__label' : '', children: t }) : t, u && (0, i.jsx)('span', { className: 'nl-button__icon-end', children: u })] }));
     }));
  ...
  56561(e, n, t) {
   ...
   var u = (0, a.forwardRef)(function (e, n) {
    var t = e.children,
     ...
     c = e.purpose,
     u = (0, s.A)(e, l);
    return (0, i.jsx)('p', d(d({ className: (0, o.$)('nl-paragraph', (0, r.A)({}, 'nl-paragraph--lead', 'lead' === c), a), ref: n }, u), {}, { children: 'lead' === c ? (0, i.jsx)('b', { className: 'nl-paragraph__lead', children: t }) : t }));
   });
  ...
  66581(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => O, component: () => E, contentTitle: () => z, default: () => U, description: () => I, frontMatter: () => P, issueNumber: () => M, metadata: () => r, title: () => B, toc: () => $ }));
  ...
  70903(e, n, t) {
   ...
   var g = t(43864),
    ...
    v = t(23436),
    k = t(79532);
   const A = { boxShadow: g.A, color: m.A, cursor: p.A, dimension: h.A, fontFamily: j.A, fontFamilies: j.A, fontSize: f.A, fontSizes: f.A, fontWeight: w.A, fontWeights: w.A, lineHeight: x.A, lineHeights: x.A, number: b.A, other: v.A, textDecoration: k.A },
    y = ({ type: e }) => {
