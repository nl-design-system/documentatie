(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [79947],
 {
  ...
  34162: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => S, component: () => B, contentTitle: () => _, default: () => E, description: () => P, frontMatter: () => z, issueNumber: () => M, metadata: () => L, title: () => F, toc: () => D });
   var r,
    s,
    i,
    o,
   ...
   var R = n(57716);
   const z = { title: 'Number Badge', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Number Badge', pagination_label: 'Number Badge', description: 'Klein label dat de aandacht trekt informeert over een aantal.', slug: '/number-badge' },
    _ = void 0,
    ...
    F = 'Number Badge',
    P = 'Klein label dat de aandacht trekt informeert over een aantal.',
    M = 7,
    B = h.find((e) => e.number === M);
   function O(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, d.jsx)(G.Rv, { component: B, headingLevel: 1, description: P }),
      '\n',
      (0, d.jsx)(x.I, { component: B }),
      '\n',
      ...
      '\n',
      (0, d.jsx)(G.cN, { component: B, headingLevel: 3 }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, d.jsx)(G.W, { component: B, headingLevel: 3 }),
      '\n',
      ...
      '\n',
      (0, d.jsx)(G.vM, { component: B, headingLevel: 3 }),
     ],
    });
   }
   function E(e = {}) {
    const { wrapper: t } = { ...(0, u.a)(), ...e.components };
    return t ? (0, d.jsx)(t, { ...e, children: (0, d.jsx)(O, { ...e }) }) : O(e);
   }
  },
  54907: (e, t, n) => {
