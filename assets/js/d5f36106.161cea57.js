(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [38662],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => m, VZ: () => w, cR: () => _, Pv: () => g, qZ: () => i, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => s, eQ: () => v, B_: () => b, o_: () => p, Rc: () => x });
  ...
  46292(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => u, default: () => p, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => h, toc: () => m }));
   const r = JSON.parse('{"id":"componenten/status-badge/index","title":"Status Badge","description":"Label dat informeert over een status en de aandacht trekt met een signaalkleur.","source":"@site/docs/componenten/status-badge/index.mdx","sourceDirName":"componenten/status-badge","slug":"/status-badge","permalink":"/status-badge","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/status-badge/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Status Badge","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Status Badge","pagination_label":"Status Badge","description":"Label dat informeert over een status en de aandacht trekt met een signaalkleur.","slug":"/status-badge","keywords":["alert badge","badge","chip","counter","label","pill","status","status badge","status label","status marker","notification badge","notification label","stamp","tag"]},"sidebar":"componenten","previous":{"title":"Spinner","permalink":"/spinner"},"next":{"title":"Strong","permalink":"/strong"}}');
   var c = n(86070),
    s = n(18439),
    i = n(78742),
    o = n(99630);
   const a = { title: 'Status Badge', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Status Badge', pagination_label: 'Status Badge', description: 'Label dat informeert over een status en de aandacht trekt met een signaalkleur.', slug: '/status-badge', keywords: ['alert badge', 'badge', 'chip', 'counter', 'label', 'pill', 'status', 'status badge', 'status label', 'status marker', 'notification badge', 'notification label', 'stamp', 'tag'] },
    u = void 0,
    l = {},
    h = 'Status Badge',
    d = 'Label dat informeert over een status en de aandacht trekt met een signaalkleur.',
    j = 202,
