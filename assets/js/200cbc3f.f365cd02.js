  ...
  70348(e, n, l) {
   ...
   const i = ({ className: e, ...n }) => {
    ...
    c = ({ className: e, label: n, heading: l, headingLevel: i, headingApperance: c, ...a }) => {
     ...
     return (0, r.jsxs)('details', { className: d, ...a, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(t.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [l && (0, r.jsx)(o.D, { level: i, appearance: c, children: l }), n] })] }) }), (0, r.jsx)('div', { className: 'utrecht-accordion__panel', children: a.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => v });
   ...
   const v = globalThis.isAstro
    ...
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: h = !0, children: m, container: g = 'document', language: v, designTokens: f }) => {
       ...
       let D = p.Fragment;
       return (
        'paragraph' === g ? (D = b) : 'document' === g ? (D = x) : 'surface' === g && (D = y),
        (0, j.jsxs)('div', {
         className: (0, o.A)('nlds-canvas'),
         children: [
          _ && (0, j.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, j.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, j.jsx)(D, { children: (0, j.jsx)(t.v$, { children: _ }) }) }) }),
          h &&
           (0, j.jsx)('div', {
