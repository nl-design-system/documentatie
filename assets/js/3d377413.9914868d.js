 ...
 [10721],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    u = n(86070);
   const l = { figma: (0, u.jsx)(c.A, {}), github: (0, u.jsx)(i.A, {}), npm: (0, u.jsx)(o.A, {}), storybook: (0, u.jsx)(s.A, {}) },
    h = ({ brand: e }) => (0, u.jsx)(r.In, { children: l[e] || (0, u.jsx)(a.A, {}) });
  },
  1842(e, t, n) {
   'use strict';
   n.d(t, { VK: () => k, $9: () => v, mu: () => f, Fc: () => b });
   var r = n(29181),
    c = n(13526),
    i = n(1292),
    o = n(90495),
   ...
   const k = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: i.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, g.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(m, { headingLevel: t + 1, checked: e, title: n, description: (0, g.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            o.Zp,
            {
             ...
             children: (0, u.jsxs)(o.Wu, {
              children: [
               ...
               s.length > 0 && (0, u.jsx)(u.Fragment, { children: s.map(({ frameworkName: e, tasks: n }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, u.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, u.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => p, VZ: () => w, cR: () => _, Pv: () => m, qZ: () => o, kD: () => v, B2: () => j, Pc: () => a, f4: () => s, GT: () => b, fX: () => i, eQ: () => f, B_: () => k, o_: () => g, Rc: () => x });
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map(({ name: r, id: c, value: i }) => {
        ...
        return { brand: o.toLowerCase(), name: r, id: c, value: i, description: s };
       });
  ...
  72642(e, t, n) {
   ...
   var r = n(13526),
    c = n(86070);
   const i = ({ children: e, className: t, level: n = 1, suffix: i, ...o }) => (0, c.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, t), ...o, children: [(0, c.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), i && (0, c.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [i ? ' ' : '', i] })] });
  },
  90495(e, t, n) {
   'use strict';
   ...
   var r = n(46447),
    c = n(13526),
    i = n(86070);
   const o = ({ background: e, children: t, className: n, ...r }) => (0, i.jsx)('div', { className: (0, c.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    s = (e) => (0, i.jsx)('div', { className: 'card__content', ...e }),
    a = ({ href: e, appearance: t, className: n, component: o = 'div', background: s, children: a }) => {
     const u = (e) => ('article' === o ? (0, i.jsx)('article', { ...e }) : 'section' === o ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      l = (0, i.jsx)(u, { className: (0, c.A)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
