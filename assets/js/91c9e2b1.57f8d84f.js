 ...
 [24515],
 {
  ...
  50341: (e, t, n) => {
   ...
   const _ = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, l.jsx)(r.If, { sections: i.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(v, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(f, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => g, GT: () => v, KF: () => h, Pc: () => s, Pv: () => m, Rc: () => f, bo: () => r, eQ: () => k, f4: () => o, fX: () => c, kD: () => b, mJ: () => y, o_: () => p, qZ: () => i });
