...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  8381: (e, t, n) => {
   n.r(t), n.d(t, { assets: () => l, contentTitle: () => s, default: () => h, frontMatter: () => i, metadata: () => r, toc: () => a });
   var o = n(52676),
    c = n(24785);
   const i = { title: "Rich text content", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Rich text content", pagination_label: "Rich text content", description: "UX richtlijnen voor Rich text content component", slug: "/rich-text-content", tags: ["Unknown"] },
    s = "Rich text content",
    r = { id: "componenten/build/rich-text-content", title: "Rich text content", description: "UX richtlijnen voor Rich text content component", source: "@site/docs/componenten/build/rich-text-content.mdx", sourceDirName: "componenten/build", slug: "/rich-text-content", permalink: "/rich-text-content", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/rich-text-content.mdx", tags: [{ label: "Unknown", permalink: "/tags/unknown" }], version: "current", frontMatter: { title: "Rich text content", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Rich text content", pagination_label: "Rich text content", description: "UX richtlijnen voor Rich text content component", slug: "/rich-text-content", tags: ["Unknown"] }, sidebar: "componenten", previous: { title: "Range", permalink: "/range" }, next: { title: "Select", permalink: "/select" } },
    l = {},
