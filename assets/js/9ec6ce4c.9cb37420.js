 ...
 [67801],
 {
  ...
  51627(e, a, n) {
   ...
   const o = ({ className: e, ...a }) => {
     ...
     return (0, s.jsx)('div', { className: n, children: a.children });
    },
    r = ({ className: e, label: a, heading: n, headingLevel: o, headingApperance: r, ...d }) => {
     const g = (0, t.A)('utrecht-accordion__section', e);
     return (0, s.jsxs)('details', { className: g, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(l.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [n && (0, s.jsx)(i.D, { level: o, appearance: r, children: n }), a] })] }) }), (0, s.jsx)('div', { className: 'utrecht-accordion__panel', children: d.children })] });
    };
  },
  56167(e, a, n) {
   'use strict';
   n.d(a, { VK: () => f, $9: () => q, mu: () => b, Fc: () => x, K_: () => k });
   var t = n(29181),
    l = n(13526),
    i = n(39948),
    s = n(26655),
   ...
   const f = ({ component: e, headingLevel: a }) => {
    ...
    x = ({ component: e, headingLevel: a, description: n }) => {
