 ...
 [95282],
 {
  31183: (e, n, i) => {
   ...
   const o = { title: 'WCAG-succescriterium 2.4.6 Koppen en labels', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.6 Koppen en labels', pagination_label: 'WCAG-succescriterium 2.4.6 Koppen en labels', description: 'Koppen en labels beschrijven het onderwerp of het doel.', slug: '2.4.6', keywords: ['WCAG'] },
    ...
    d = { id: 'wcag/2.4.6', title: 'WCAG-succescriterium 2.4.6 Koppen en labels', description: 'Koppen en labels beschrijven het onderwerp of het doel.', source: '@site/docs/wcag/2.4.6.mdx', sourceDirName: 'wcag', slug: '/wcag/2.4.6', permalink: '/wcag/2.4.6', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.6.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.4.6 Koppen en labels', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.6 Koppen en labels', pagination_label: 'WCAG-succescriterium 2.4.6 Koppen en labels', description: 'Koppen en labels beschrijven het onderwerp of het doel.', slug: '2.4.6', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.4.4 Linkdoel (in context)', permalink: '/wcag/2.4.4' }, next: { title: '2.4.7 Focus zichtbaar', permalink: '/wcag/2.4.7' } },
    c = {},
    h = [
