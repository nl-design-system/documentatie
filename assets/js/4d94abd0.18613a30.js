   ...
   const d = (0, i.createContext)({}),
    p = ({ title: e, appearance: n, description: l, children: i, figure: p }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      h = p ? 'figure' : 'div',
      m = p ? 'figcaption' : 'div',
      g = 'string' == typeof l ? (0, a.jsx)(c.oz, { components: { a: o.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   const c = ({ className: e, ...n }) => {
    ...
    i = ({ className: e, classNamePanel: n, label: l, heading: c, headingLevel: i, headingApperance: a, ...d }) => {
     ...
     return (0, t.jsxs)('details', { className: p, ...d, children: [(0, t.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, t.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, t.jsx)('span', { className: 'nl-button__icon-start', children: (0, t.jsx)(r.A, {}) }), (0, t.jsxs)('span', { className: 'nl-button__label', children: [c && (0, t.jsx)(o.D, { level: i, appearance: a, children: c }), l] })] }) }), (0, t.jsx)('div', { className: u, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => b });
