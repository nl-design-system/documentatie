 ...
 [85382],
 {
  ...
  50341: (e, t, n) => {
   ...
   const _ = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: i.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(b, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(f, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
    ...
    N = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p.p, { level: t, suffix: c && (0, u.jsx)(m.D, { state: c }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  74111: (e, t, n) => {
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => h, B_: () => m, GT: () => k, KF: () => u, Pc: () => o, Pv: () => y, Rc: () => b, bo: () => r, eQ: () => p, f4: () => s, fX: () => c, kD: () => v, mJ: () => j, o_: () => g, qZ: () => i });
