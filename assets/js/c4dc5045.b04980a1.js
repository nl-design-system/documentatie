/*! For license information please see c4dc5045.b04980a1.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [92043],
 {
  ...
  53838(e, n, t) {
   t.r(n), t.d(n, { assets: () => s, contentTitle: () => l, default: () => u, frontMatter: () => d, metadata: () => i, toc: () => c });
  ...
  87423(e, n, t) {
   ...
   var r = i.forwardRef(function (e, n) {
    ...
    var j = e.playlist ? ''.concat(k, '/embed/videoseries?').concat(b.toString()) : ''.concat(k, '/embed/').concat(m, '?').concat(b.toString()),
    ...
    return (
     ...
     i.createElement(
      i.Fragment,
      null,
      i.createElement('link', { rel: N, href: z, as: 'image' }),
      ...
      i.createElement(
       P,
       {
        ...
        'data-title': p,
        style: o(o({ backgroundImage: 'url('.concat(z, ')') }, { '--aspect-ratio': ''.concat((E / F) * 100, '%') }), S),
       },
       i.createElement('button', { type: 'button', className: Z, 'aria-label': ''.concat(f, ' ').concat(p) }),
       s && i.createElement('iframe', { ref: n, className: H, title: p, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: j }),
      ),
     )
    );
   });
