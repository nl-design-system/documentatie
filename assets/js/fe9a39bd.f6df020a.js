 ...
 [35959],
 {
  5008: (e, n, t) => {
   ...
   const i = { title: 'De top-10 aan onderwerpen die waarde toevoegen aan een design systeem', slug: 'top-10-aan-onderwerpen-die-waarde-toevoegen-aan-een-design-system', authors: [{ name: 'Angela Imhof', title: 'Projectmanager', url: 'https://www.linkedin.com/in/angelaimhof' }], tags: ['update', 'NL Design System'], image: 'https://designsystem.gebruikercentraal.nl/wp-content/uploads/sites/26/2020/08/drie-mannen-design-system.jpg', hide_table_of_contents: !1, date: new Date('2020-01-22T00:00:00.000Z') },
    r = void 0,
    o = {
     permalink: '/blog/top-10-aan-onderwerpen-die-waarde-toevoegen-aan-een-design-system',
     ...
     unlisted: !1,
     prevItem: { title: 'Innovatiebudget voor het NL Design System', permalink: '/blog/innovatiebudget-voor-nl-design-system' },
     nextItem: { title: 'Update - NL Design System', permalink: '/blog/update-nl-design-system' },
    },
    d = { authorsImageUrls: [void 0] },
    l = [];
   function g(e) {
    const n = { a: 'a', p: 'p', ...(0, s.a)(), ...e.components };
    return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(n.p, { children: 'Tijdens de International Design in Government conferentie vroegen we de aanwezige deelnemers of ze een vragenlijst over design systemen wilden invullen. Omdat wij bezig zijn met de ontwikkeling van een centraal design systeem voor de Nederlandse overheid: het NL Design System, willen we gebruikmaken en leren van bestaande kennis en ervaring.' }), '\n', (0, a.jsx)(n.p, { children: 'Uitkomsten vragenlijst design systeem' }), '\n', (0, a.jsx)(n.p, { children: 'Het resultaat: een top 10 aan onderwerpen die volgens de respondenten de meeste waarde toevoegen aan een design systeem. De eerste versie van het NL Design System komt in de loop van februari online beschikbaar. Bij de doorontwikkeling gaan we prioriteit geven aan de verzamelde top 10.' }), '\n', (0, a.jsxs)(n.p, { children: [(0, a.jsx)(n.a, { href: 'https://www.gebruikercentraal.nl/blog/de-top-10-aan-onderwerpen-die-waarde-toevoegen-aan-een-design-systeem/', children: 'Lees het volledige artikel op Gebruiker Centraal' }), '.'] })] });
   }
   function m(e = {}) {
