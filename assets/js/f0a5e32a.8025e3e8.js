/*! For license information please see f0a5e32a.8025e3e8.js.LICENSE.txt */
'use strict';
 ...
 [29004],
 {
  ...
  45282(e, n, i) {
   ...
   const r = ({ children: e, ...n }) => {
    ...
    a = ({ className: e, ...n }) => (0, s.jsx)(r, { className: (0, t.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  64249(e, n, i) {
   i.d(n, { A: () => t });
  ...
  75397(e, n, i) {
   ...
   const o = t.forwardRef(function (e, n) {
     const [i, o] = t.useState(!1),
      ...
      y = t.useMemo(() => (e.playlist ? `${g}/embed/videoseries?${v.toString()}` : `${g}/embed/${m}?${v.toString()}`), [e.playlist, g, m, v]),
      ...
      w = k
       ...
       : null,
      x = t.useMemo(() => e.thumbnail || w || `https://i.ytimg.com/${f}/${e.playlist ? c : m}/${h}.${b}`, [e.thumbnail, w, f, e.playlist, c, m, h, b]),
     ...
     return (
      ...
      (0, s.jsxs)(s.Fragment, {
       children: [
        ...
        (0, s.jsx)(s.Fragment, { children: i && (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)('link', { rel: 'preconnect', href: g }), (0, s.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), M && (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, s.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
        e.seo && !e.playlist && (0, s.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: a(e.id, u, x, g, e.seo) } }),
        F && !e.playlist && (0, s.jsx)('noscript', { children: (0, s.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${u} on YouTube`, children: ['Watch "', u, '" on YouTube'] }) }),
        (0, s.jsxs)(_, {
         onPointerOver: () => {
          i || o(!0);
         },
         ...
         style: { ...(!e.lazyLoad && { backgroundImage: `url(${x})` }), '--aspect-ratio': (C / z) * 100 + '%', ...(e.style || {}) },
         children: [e.lazyLoad && !l && (0, s.jsx)('img', { src: x, alt: `${u} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, s.jsx)('button', { type: 'button', className: $, 'aria-label': `${p} ${u}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, children: (0, s.jsx)('span', { className: 'lty-visually-hidden', children: p }) }), l && (0, s.jsx)('iframe', { ref: n, className: D, title: u, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: y, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
    ...
    l = ({ id: e, title: n, ...i }) => {
     ...
     return (0, s.jsx)('div', { ref: r, children: (0, s.jsx)(o, { adNetwork: !1, announce: 'Bekijk', cookie: !1, containerElement: 'div', id: e, title: n, poster: 'maxresdefault', ...i }) });
    };
  },
  76641(e, n, i) {
   ...
   var s = i(86070),
    ...
    l = i(64249),
    d = i(46447);
   const m = { title: 'MijnServices Community', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Over MijnServices Community', pagination_label: 'Over MijnServices Community', description: 'Informatie over de NL Design System MijnServices Community Sprint', slug: '/community/community-sprints/mijn-services-community/', keywords: ['nl design system', 'community sprints', 'mijn services community', 'mijnservices community', 'mijn services community afstemming', 'mijn services community check-in', 'overheidsbrede portalen community'] },
  ...
  88666(e, n, i) {
   ...
   var t = i(45282),
    s = i(13526),
    r = i(86070);
   const a = ({ appearance: e, ...n }) => (0, r.jsx)(t.F, { className: (0, s.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...n });
  },
 },
]);
