 ...
 [68925],
 {
   ...
   function D(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(f.Rv, { component: _, headingLevel: 1, description: S }),
      '\n',
      ...
      '\n',
      (0, r.jsx)(f.cN, { component: _, headingLevel: 3 }),
      '\n',
      (0, r.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, r.jsx)(f.W, { component: _, headingLevel: 3 }),
      '\n',
      ...
      '\n',
      (0, r.jsx)(f.vM, { component: _, headingLevel: 3 }),
     ],
    });
   }
   function M(e = {}) {
          ...
          children: [
           (0, d.jsx)(f, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(v, { headingLevel: n + 1, checked: t, title: r, description: (0, A.Q6)(s) }, s);
            }),
           }),
  ...
  49556: (e, t, n) => {
   ...
   var p = n(6076),
    ...
    A = n(49003),
    x = n(75271);
   const b = { color: p.Z, dimension: j.Z, fontFamilies: w.Z, fontSizes: y.Z, fontWeights: k.Z, lineHeights: f.Z, other: v.Z, textDecoration: A.Z },
    C = (e) => {
     let { type: t } = e;
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => j, BA: () => a, Ee: () => d, Q6: () => i, U: () => m, Yr: () => w, d: () => u, e9: () => o, fO: () => k, mA: () => s, ps: () => g, qU: () => f, s0: () => y, zP: () => p });
