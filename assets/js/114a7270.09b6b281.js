 ...
 [32414],
 {
  ...
  51582(e, n, i) {
   ...
   const o = (e, n) => {
    ...
    d = ({ children: e, omitH1: n = !1, headingLevel: i = 1, baseUrl: r = '', components: o = {} }) => (0, s.jsx)(t.x, { components: { ...a(n, i), ...l(r), ...o }, children: e });
  },
  66820(e, n, i) {
   i.d(n, { E: () => o });
   var t = i(46447),
  ...
  95857(e, n, i) {
   ...
   const o = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: r, ...o }, c) => {
    const l = { ...o, ref: c, className: s('utrecht-note', { [`utrecht-note--${r}`]: r }, i) };
    return e ? (0, t.jsx)('aside', { ...l, children: n }) : (0, t.jsx)('section', { role: 'note', ...l, children: n });
   });
   o.displayName = 'Note';
   var c = i(29181);
   const l = globalThis.isAstro ? o : c.K7;
  },
  98948(e, n, i) {
   (i.r(n), i.d(n, { assets: () => v, contentTitle: () => m, default: () => x, frontMatter: () => j, metadata: () => t, toc: () => b }));
   const t = JSON.parse('{"id":"wcag/2.4.12","title":"WCAG-succescriterium 2.4.12 Focus niet bedekt (uitgebreid)","description":"Zorg ervoor dat een element dat de toetsenbordfocus heeft volledig zichtbaar is en niet bedekt is door andere inhoud.","source":"@site/docs/wcag/2.4.12.mdx","sourceDirName":"wcag","slug":"/wcag/2.4.12","permalink":"/wcag/2.4.12","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.12.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 2.4.12 Focus niet bedekt (uitgebreid)","title_sm":"2.4.12 Focus niet bedekt (uitgebreid)","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"2.4.12 Focus niet bedekt (uitgebreid)","pagination_label":"WCAG-succescriterium 2.4.12 Focus niet bedekt (uitgebreid)","description":"Zorg ervoor dat een element dat de toetsenbordfocus heeft volledig zichtbaar is en niet bedekt is door andere inhoud.","slug":"2.4.12","conformance_level":"Niveau AAA","keywords":["WCAG","AAA","bedienbaar","navigeerbaar","operable","navigable","focus not obscured (enhanced)"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 2.4.11 Focus niet bedekt (minimum)","permalink":"/wcag/2.4.11"},"next":{"title":"2.4.13 Focusweergave","permalink":"/wcag/2.4.13"}}');
   var r = i(86070),
    s = i(18439),
    o = i(51582),
    c = i(66820),
   ...
   const j = { title: 'WCAG-succescriterium 2.4.12 Focus niet bedekt (uitgebreid)', title_sm: '2.4.12 Focus niet bedekt (uitgebreid)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.12 Focus niet bedekt (uitgebreid)', pagination_label: 'WCAG-succescriterium 2.4.12 Focus niet bedekt (uitgebreid)', description: 'Zorg ervoor dat een element dat de toetsenbordfocus heeft volledig zichtbaar is en niet bedekt is door andere inhoud.', slug: '2.4.12', conformance_level: 'Niveau AAA', keywords: ['WCAG', 'AAA', 'bedienbaar', 'navigeerbaar', 'operable', 'navigable', 'focus not obscured (enhanced)'] },
    m = void 0,
    v = {},
    b = [...h.RM, { value: 'Uitleg', id: 'uitleg', level: 2 }, { value: 'Opgelet', id: 'opgelet', level: 2 }, { value: 'Gebruikersonderzoek', id: 'gebruikersonderzoek', level: 2 }, ...a.RM, { value: 'W3C referenties', id: 'w3c-referenties', level: 2 }, ...d.RM, { value: 'Help richtlijn verbeteren', id: 'help-richtlijn-verbeteren', level: 2 }, ...u.RM];
   function f(e) {
    const n = { a: 'a', h2: 'h2', li: 'li', p: 'p', ul: 'ul', ...(0, s.R)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', (0, r.jsx)(c.E, { level: 1, conformanceLevel: 'Niveau AAA', children: 'WCAG-succescriterium 2.4.12 Focus niet bedekt (uitgebreid)' }), '\n', (0, r.jsx)(l.K, { children: (0, r.jsx)(o.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(h.Ay, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, r.jsx)(p, {}), '\n', (0, r.jsx)(n.h2, { id: 'opgelet', children: 'Opgelet' }), '\n', (0, r.jsx)(n.p, { children: 'Deze inhoud wordt binnenkort aangevuld met uitgebreidere uitleg, bronnen en informatie over hoe te testen.' }), '\n', (0, r.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, r.jsx)(a.Ay, {}), '\n', (0, r.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#focus-not-obscured-enhanced', children: (0, r.jsx)('span', { lang: 'en', children: '2.4.12 Focus Not Obscured (Enhanced)' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#focus-not-obscured-enhanced', children: '2.4.12 Focus niet bedekt (uitgebreid)' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, r.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#focus-not-obscured-enhanced', children: (0, r.jsx)('span', { lang: 'en', children: 'Quick Reference 2.4.12 Focus Not Obscured (Enhanced)' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/focus-not-obscured-enhanced.html', children: (0, r.jsx)('span', { lang: 'en', children: 'Understanding SC 2.4.12 Focus Not Obscured (Enhanced)' }) }), '.'] }), '\n'] }), '\n', (0, r.jsx)(l.K, { children: (0, r.jsx)(o.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(d.Ay, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, r.jsx)(o.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(u.Ay, {}) })] });
   }
   function x(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
