...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [16386],
 {
  ...
  79940: (e, n, r) => {
   r.r(n), r.d(n, { assets: () => F, contentTitle: () => _, default: () => q, frontMatter: () => w, metadata: () => C, toc: () => N });
   var l = r(52676),
    t = r(24785),
    i = r(55400),
    o = r(57716);
  ...
  43599: (e, n, r) => {
   ...
   const x = (e) => {
    let { code: n, copy: r = !0, defaultExpandedCode: x = !1, displayCode: g = !0, children: k, container: b = 'document', language: f, designTokens: y } = e,
    ...
    (0, h.useEffect)(() => {
     (async () => {
      (F = await c.ZP.format(C, { parser: f, plugins: [o.Z, s.ZP, a.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), N(F);
     })();
    }, [C]);
    const V = (0, h.useId)();
    let Z = h.Fragment;
    return (
     'paragraph' === b ? (Z = v) : 'document' === b ? (Z = m) : 'surface' === b && (Z = j),
     (0, p.jsxs)('div', {
      className: (0, i.Z)('nlds-canvas'),
      children: [
       w && (0, p.jsx)('div', { className: (0, i.Z)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, p.jsx)(Z, { children: (0, p.jsx)(l.pu, { children: w }) }) }) }),
       g &&
        (0, p.jsx)('div', {
       ...
       g &&
        (0, p.jsxs)('div', {
         ...
         hidden: !z,
         children: [
          (0, p.jsx)(t.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: F, trim: !0 }),
          r &&
           (0, p.jsx)('div', {
  ...
  57716: (e, n, r) => {
   ...
   const o = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, i.jsx)(l.Z, { components: { ...d(r, t), ...a(o) }, children: n });
    };
  },
  24785: (e, n, r) => {
   r.d(n, { Z: () => s, a: () => o });
