 ...
 [79871],
 {
  ...
  62577: (e, n, l) => {
   ...
   function s(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(i.X, { appearance: 'do', title: 'Alle informatie als zichtbare tekst in de link plaatsen.', children: (0, t.jsx)(o.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.a, { href: '#', target: '_blank', children: 'Lees het privacybeleid (opent in een nieuwe tab)' }), '.'] }) }) }), '\n', (0, t.jsx)(i.X, { appearance: 'do', title: 'Zichtbaar icoontje plus onzichtbare, maar uitgesproken tekst voor screenreaders.', children: (0, t.jsx)(o.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsxs)(n.a, { href: '#', target: '_blank', className: 'nlds-icon-ext', children: ['Lees het privacybeleid', (0, t.jsx)(n.span, { className: 'sr-only', children: ', opent in een nieuwe tab' })] }), '.'] }) }) }), '\n', (0, t.jsx)(i.X, { appearance: 'do', title: 'Zichtbaar icoontje plus een aria-label voor screenreaders.', children: (0, t.jsx)(o.X, { language: 'html', children: () => (0, t.jsx)(t.Fragment, { children: (0, t.jsx)(n.a, { href: '#', target: '_blank', className: 'nlds-icon-ext', 'aria-label': 'Lees het privacybeleid (opent in een nieuwe tab)', children: 'Lees het privacybeleid' }) }) }) }), '\n', (0, t.jsx)(i.X, { appearance: 'dont', title: 'Informatie over het openen in een nieuwe tab alleen aan screenreadergebruikers geven.', children: (0, t.jsx)(o.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.a, { href: '#', target: '_blank', 'aria-label': 'Lees het privacybeleid (opent in een nieuwe tab)', children: 'Lees het privacybeleid' }), '.'] }) }) }), '\n', (0, t.jsx)(i.X, { appearance: 'dont', title: 'Informatie over het openen in een nieuwe tab voor iedereen weglaten.', children: (0, t.jsx)(o.X, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.a, { href: '#', target: '_blank', children: 'Lees het privacybeleid' }), '.'] }) }) })] });
   }
   function c(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
  ...
  43599: (e, n, l) => {
   ...
   const v = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      (Z = await d.ZP.format(N, { parser: x, plugins: [o.Z, i.ZP, s.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), z(Z);
     })();
    }, [N]);
    const S = (0, p.useId)();
    let F = p.Fragment;
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       _ && (0, h.jsx)('div', { className: (0, a.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(F, { children: (0, h.jsx)(t.pu, { children: _ }) }) }) }),
       k &&
        (0, h.jsx)('div', {
       ...
       k &&
        (0, h.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, h.jsx)(r.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: Z, trim: !0 }),
          l &&
           (0, h.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: l, textContent: c, trim: d } = e,
     p = c;
    const { title: u, type: h } = (0, a.useContext)(o.n),
     b = (0, a.useId)();
    return (
     d && (p = p.trim()),
     (0, s.jsx)(r.y$, {
      ...
      language: l || '',
      children: (e) => {
       let { style: l, tokens: r, getLineProps: a, getTokenProps: o } = e;
       return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: b, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, s.jsx)(t.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': b, style: l, children: r.map((e, l) => (0, s.jsxs)('span', { ...a({ line: e }), children: [n && (0, s.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
  ...
  40761: (e, n, l) => {
   ...
   const c = (0, i.createContext)({}),
    d = (e) => {
     let { title: n, appearance: l, description: i, children: d, figure: p } = e;
     const u = { do: 'Doen', dont: 'Niet doen' },
      h = p ? 'figure' : 'div',
      b = p ? 'figcaption' : 'div';
     return (0, s.jsxs)(h, { className: (0, o.Z)('nlds-guideline', `nlds-guideline--${l}`), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, s.jsxs)(b, { className: 'nlds-guideline__description', children: ['dont' === l ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(a.nv, { className: (0, o.Z)('nlds-guideline__badge', `nlds-guideline__badge--${l}`), children: [(0, s.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: u.dont })] }), (0, s.jsx)(a.nv, { children: n })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(a.nv, { className: (0, o.Z)('nlds-guideline__badge', `nlds-guideline__badge--${l}`), children: [(0, s.jsx)(r.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: u.do })] }), (0, s.jsx)(a.nv, { children: n })] }), i] }), (0, s.jsx)('div', { className: 'nlds-guideline__example', children: (0, s.jsx)(c.Provider, { value: { title: n, type: u[l] }, children: d }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => i, a: () => o });
