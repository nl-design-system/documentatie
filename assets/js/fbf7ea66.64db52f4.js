...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [77068],
 {
  12761(e, n, a) {
   ...
   const b = ({ className: e, ...n }) => {
    ...
    v = ({ className: e, ...n }) => {
     ...
     return (0, d.jsxs)('details', { className: a, ...n, children: [(0, d.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, d.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, d.jsx)('span', { className: 'nl-button__icon-start', children: (0, d.jsx)(f.A, {}) }), (0, d.jsx)('span', { className: 'nl-button__label', children: (0, d.jsx)(x.D, { level: n.headingLevel, appearance: n.headingApperance, children: n.heading }) })] }) }), (0, d.jsx)('div', { className: 'utrecht-accordion__panel', children: n.children })] });
    },
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => p, VZ: () => F, cR: () => D, Pv: () => f, qZ: () => s, kD: () => k, B2: () => c, Pc: () => o, f4: () => l, GT: () => j, fX: () => r, eQ: () => v, B_: () => b, o_: () => x });
  ...
  80427(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => x, componentName: () => f, contentTitle: () => g, default: () => k, description: () => c, frontMatter: () => d, issueNumber: () => h, metadata: () => t, relayStep: () => p, title: () => m, toc: () => b }));
   ...
   var i = a(86070),
    ...
    l = a(12761),
    o = a(17842);
   const d = { title: 'Case Card', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Case Card', pagination_label: 'Case Card', description: 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.', slug: '/case-card', keywords: ['aanvraag', 'afgehandeld', 'afgerond', 'archief', 'archive', 'archived', 'bezwaar', 'beroep', 'bericht', 'card', 'case', 'case card', 'complaint', 'data', 'dossier', 'file', 'gearchiveerd', 'in behandeling', 'kenmerk', 'klacht', 'lopende zaak', 'melding', 'MijnOmgeving', 'MijnServices', 'MijnZaken', 'navigeren', 'navigate', 'navigatie', 'navigation', 'permit', 'procedure', 'record', 'response', 'request', 'terugkoppeling', 'tile', 'vergunning', 'zaak', 'zaak informatie', 'zaaknummer', 'zaaksysteem'] },
    g = void 0,
    u = {},
    m = 'Case Card',
    c = 'Toont meta-informatie over een zaak en biedt de mogelijkheid hier naartoe te navigeren.',
    h = 253,
    p = 'help wanted',
    f = 'case-card',
    x = s.find((e) => e.number === h),
    b = [
