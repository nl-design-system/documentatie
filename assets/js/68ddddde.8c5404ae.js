 ...
 [94192],
 {
  ...
  16764(e, n, t) {
   ...
   var p = t(43864),
    ...
    D = t(79532),
    L = t(30758);
   const A = { boxShadow: p.A, color: k.A, cursor: j.A, dimension: v.A, fontFamily: x.A, fontFamilies: x.A, fontSize: f.A, fontSizes: f.A, fontWeight: b.A, fontWeights: b.A, lineHeight: y.A, lineHeights: y.A, number: w.A, other: S.A, textDecoration: D.A },
    z = ({ type: e }) => {
     const n = Object.hasOwn(A, e) ? e : 'other';
     return (0, m.jsx)(u.In, { children: (0, L.createElement)(A[n]) });
    };
   var N = t(76223);
   function F({ tokens: e }) {
    const n = (0, r.kD)(e),
       ...
       children: [
        ...
        (0, m.jsx)(s.BF, {
         children: o.map((n) => {
          const t = (0, r.o_)(n),
           o = (0, r.eQ)(e, n).$type;
          return (0, m.jsxs)(s.Hj, { children: [(0, m.jsx)(s.nA, { children: (0, m.jsx)(i.C, { children: (0, m.jsx)(s.kf, { children: t }) }) }), (0, m.jsx)(s.nA, { children: (0, m.jsxs)(a.K, { children: [(0, m.jsx)(z, { type: o }), ' ', o] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, m.jsxs)(s.e2, { children: [(0, m.jsx)(h, { content: d, language: 'json', children: 'Kopieer als JSON' }), (0, m.jsx)(h, { content: l, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  76097(e, n, t) {
   'use strict';
   t.d(n, { bo: () => a, KF: () => u, mJ: () => p, VZ: () => w, cR: () => y, Pv: () => k, qZ: () => s, kD: () => f, B2: () => m, Pc: () => l, f4: () => o, GT: () => b, fX: () => r, eQ: () => x, B_: () => v, o_: () => j });
