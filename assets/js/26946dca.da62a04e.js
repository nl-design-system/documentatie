 ...
 [3958],
 {
  ...
  12761(e, n, t) {
   ...
   const k = ({ className: e, ...n }) => {
    ...
    b = ({ className: e, ...n }) => {
     const t = (0, o.A)('utrecht-accordion__section', e);
     return (0, d.jsxs)('details', { className: t, ...n, children: [(0, d.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, d.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, d.jsx)('span', { className: 'nl-button__icon-start', children: (0, d.jsx)(j.A, {}) }), (0, d.jsx)('span', { className: 'nl-button__label', children: (0, d.jsx)(x.D, { level: n.headingLevel, appearance: n.headingApperance, children: n.heading }) })] }) }), (0, d.jsx)('div', { className: 'utrecht-accordion__panel', children: n.children })] });
    },
    f = ({ component: e, headingLevel: n }) => {
     const t = e && e.projects.filter((e) => p.f4.includes(e.id)),
      s = t && p.f4.map((e) => t.find((n) => n.id === e)).filter(Boolean);
     return e && (0, d.jsx)(k, { children: s.map((t) => (0, d.jsx)(b, { className: (0, o.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, p.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m._, { children: t.tasks.map(({ checked: e, name: t, id: a }) => (0, d.jsx)(m.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, p.qZ)(a) }, a)) }), (0, d.jsx)(a.fz, { children: (0, d.jsxs)(a.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
    ...
    w = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u.p, { level: n, suffix: o && (0, d.jsx)(g.D, { state: o }), children: e.title }), (0, d.jsx)(a.fz, { lead: !0, children: t })] });
    },
    A = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  16764(e, n, t) {
   ...
   var h = t(43864),
    ...
    D = t(79532),
    S = t(30758);
   const C = { boxShadow: h.A, color: j.A, cursor: x.A, dimension: k.A, fontFamily: b.A, fontFamilies: b.A, fontSize: f.A, fontSizes: f.A, fontWeight: v.A, fontWeights: v.A, lineHeight: y.A, lineHeights: y.A, number: w.A, other: A.A, textDecoration: D.A },
    N = ({ type: e }) => {
  ...
  49895(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => T, component: () => B, contentTitle: () => F, default: () => G, description: () => _, frontMatter: () => N, issueNumber: () => H, metadata: () => a, title: () => L, toc: () => R }));
  ...
  76097(e, n, t) {
   'use strict';
   t.d(n, { bo: () => o, KF: () => u, mJ: () => h, VZ: () => w, cR: () => y, Pv: () => j, qZ: () => r, kD: () => f, B2: () => m, Pc: () => l, f4: () => i, GT: () => v, fX: () => s, eQ: () => b, B_: () => k, o_: () => x });
