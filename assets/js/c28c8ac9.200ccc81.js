 ...
 [19678],
 {
  ...
  32814(e, n, i) {
   ...
   const v = { title: 'WCAG-succescriterium 1.2.9 Louter-geluid (live)', title_sm: '1.2.9 Louter-geluid (live)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.2.9 Louter-geluid (live)', pagination_label: 'WCAG-succescriterium 1.2.9 Louter-geluid (live)', description: 'Maak bij een live audio-opname de inhoud ook als uitgeschreven tekst beschikbaar, als live ondertitels of vooraf als tekstdocument.', slug: '1.2.9', conformance_level: 'Niveau AAA', keywords: ['WCAG', 'AAA', 'waarneembaar', 'op tijd gebaseerde media', 'perceivable', 'time-based media', 'audio-only (live)', 'audio-only', 'live'] },
    j = void 0,
    m = {},
    f = [...h.RM, { value: 'Uitleg', id: 'uitleg', level: 2 }, { value: 'Opgelet', id: 'opgelet', level: 2 }, { value: 'Gebruikersonderzoek', id: 'gebruikersonderzoek', level: 2 }, ...d.RM, { value: 'W3C referenties', id: 'w3c-referenties', level: 2 }, ...c.RM, { value: 'Help richtlijn verbeteren', id: 'help-richtlijn-verbeteren', level: 2 }, ...u.RM];
   function x(e) {
