/*! For license information please see 89ab4fc1.f8575b55.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [9289],
 {
   ...
   const o = i.forwardRef(function (e, n) {
    const [a, o] = i.useState(!1),
     ...
     y = v
      ...
      : null,
     x = i.useMemo(() => e.thumbnail || y || `https://i.ytimg.com/${f}/${e.playlist ? g : c}/${p}.${w}`, [e.thumbnail, y, f, e.playlist, g, c, p, w]),
    ...
    return (
     ...
     (0, t.jsxs)(t.Fragment, {
      children: [
       ...
       L && !e.playlist && (0, t.jsx)('noscript', { children: (0, t.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${m} on YouTube`, children: ['Watch "', m, '" on YouTube'] }) }),
       (0, t.jsxs)(C, {
        onPointerOver: () => {
         a || o(!0);
        },
        ...
        children: [e.lazyLoad && !l && (0, t.jsx)('img', { src: x, alt: `${m} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !l && (0, t.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && l) && (0, t.jsx)('button', { type: 'button', className: M, 'aria-label': `${h} ${m}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, onClick: _, children: (0, t.jsx)('span', { className: 'lty-visually-hidden', children: h }) }), l && (0, t.jsx)('iframe', { ref: n, className: N, title: m, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: j, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => u, VZ: () => x, cR: () => y, Pv: () => k, qZ: () => r, kD: () => w, QQ: () => D, B2: () => p, Pc: () => l, f4: () => o, GT: () => f, fX: () => s, eQ: () => v, B_: () => j, o_: () => b });
