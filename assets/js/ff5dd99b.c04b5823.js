(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [68925],
 {
  ...
  39903: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => f, component: () => T, contentTitle: () => A, default: () => W, description: () => x, frontMatter: () => y, issueNumber: () => C, metadata: () => v, title: () => b, toc: () => k });
   var r = n(52676),
    i = n(24785),
    s = n(96439),
    o = n(92183);
   ...
   const y = { title: 'Mark', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Mark', pagination_label: 'Mark', description: 'Markeert tekst, zodat je ernaar kan verwijzen vanuit een andere context of omdat de tekst relevant is voor de huidige activiteit.', slug: '/mark', keywords: ['highlight', 'highlighter'] },
    ...
    b = 'Mark',
    x = 'Markeert tekst, zodat je ernaar kan verwijzen vanuit een andere context of omdat de tekst relevant is voor de huidige activiteit.',
    C = 333,
    T = s.find((e) => e.number === C);
   function G(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(w.Rv, { component: T, headingLevel: 1, description: x }),
      '\n',
      (0, r.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, r.jsx)(w.cN, { component: T, headingLevel: 3 }),
      '\n',
      (0, r.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, r.jsx)(w.W, { component: T, headingLevel: 3 }),
      '\n',
      (0, r.jsx)(t.h2, { id: 'acceptatiecriteria', children: 'Acceptatiecriteria' }),
      '\n',
      (0, r.jsx)(o.ZP, {}),
      '\n',
      (0, r.jsx)(j.t, { headingLevel: 4, testCategory: 'Toegankelijkheid algemeen', items: [{ title: 'Tekst in een andere taal heeft het juiste lang-attribuut', sc: '3.1.2', status: '', component: (0, r.jsx)(m.ZP, {}) }] }),
      '\n',
      (0, r.jsx)(j.t, {
       headingLevel: 4,
       testCategory: 'Toegankelijkheid visueel ontwerp',
       items: [
        { title: 'De gemarkeerde tekst is niet alleen herkenbaar aan de achtergrondkleur', sc: '1.4.1', status: '', component: (0, r.jsx)(p.ZP, {}) },
        { title: 'De gemarkeerde tekst heeft voldoende contrast met de achtergrondkleur', sc: '1.4.3', status: '', component: (0, r.jsx)(h.ZP, {}) },
        { title: 'Wanneer de achtergrondkleur van de Mark component anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina', sc: '1.4.11', status: '', component: (0, r.jsx)(d, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(j.t, {
      ...
      '\n',
      (0, r.jsx)(j.t, { headingLevel: 3, testCategory: 'Toegankelijkheid screenreader', items: [{ title: 'Gebruik het juiste HTML-element voor de Mark component', sc: '1.3.1', status: '', component: (0, r.jsx)(a, {}) }] }),
      '\n',
      (0, r.jsx)(t.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }),
      '\n',
      (0, r.jsx)(w.vM, { component: T, headingLevel: 3 }),
     ],
    });
   }
   function W(e = {}) {
