 ...
 [30722],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    c = n(83386),
    a = n(86070);
   const d = { figma: (0, a.jsx)(i.A, {}), github: (0, a.jsx)(o.A, {}), npm: (0, a.jsx)(s.A, {}), storybook: (0, a.jsx)(l.A, {}) },
    u = ({ brand: e }) => (0, a.jsx)(r.In, { children: d[e] || (0, a.jsx)(c.A, {}) });
  },
  4964(e, t, n) {
   'use strict';
   n.d(t, { Ay: () => s });
   ...
   function o(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(t.p, { children: "Zorg ervoor dat invoervelden die op meerdere pagina's voorkomen en die dezelfde functie hebben, er op die pagina's hetzelfde uitzien en dezelfde visuele en toegankelijke naam hebben." }), '\n', (0, r.jsx)(t.p, { children: 'Bijvoorbeeld:' }), '\n', (0, r.jsxs)(t.ul, { children: ['\n', (0, r.jsx)(t.li, { children: "Een algemene zoekfunctie heeft op iedere pagina het label 'Zoeken' en niet op de ene plek 'Zoeken' en op de andere plek 'Waar ben je naar op zoek?' of 'Zoek op website'." }), '\n', (0, r.jsx)(t.li, { children: "Een inschrijfformulier van evenementen waarin persoonlijke gegevens worden gevraagd, hebben allebei het veld 'Voor- en achternaam' en niet op de ene plek 'Voor- en achternaam' en op de andere plek 'Volledige naam' of 'Hoe heet je?'." }), '\n'] }), '\n', (0, r.jsx)(t.p, { children: 'Dit geldt ook voor het gebruik van icons.' }), '\n', (0, r.jsx)(t.p, { children: 'Als componenten op verschillende plekken andere functies hebben hoeven die uiteraard niet hetzelfde visuele label te hebben. Bijvoorbeeld:' }), '\n', (0, r.jsxs)(t.ul, { children: ['\n', (0, r.jsx)(t.li, { children: "Een algemene zoekfunctie genaamd 'Zoeken' in de header van iedere pagina." }), '\n', (0, r.jsx)(t.li, { children: "Een specifieke zoekfunctie genaamd 'Zoek in de database'." }), '\n'] }), '\n', (0, r.jsx)(t.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, r.jsxs)(t.ul, { children: ['\n', (0, r.jsx)(t.li, { children: (0, r.jsx)(t.a, { href: '/richtlijnen/stijl/iconen/respecteer-conventies/', children: 'Respecteer conventies' }) }), '\n', (0, r.jsx)(t.li, { children: (0, r.jsx)(t.a, { href: '/richtlijnen/formulieren/labels/duidelijke-tekst/', children: 'Gebruik duidelijke labels' }) }), '\n'] })] });
   }
   function s(e = {}) {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => h, mJ: () => p, VZ: () => x, cR: () => A, Pv: () => j, qZ: () => s, kD: () => y, B2: () => m, Pc: () => c, f4: () => l, GT: () => v, fX: () => o, eQ: () => b, B_: () => w, o_: () => f, Rc: () => k });
   ...
   const u = (e) => [...e].sort((e, t) => a.indexOf(e) - a.indexOf(t)),
    h = (e) => {
    ...
    g = (e) => {
     const t = / URL \(([^)]+)\)/;
     return u(d(e.tasks.filter(({ name: e, value: n }) => '' !== n && t.test(e)).map(({ name: e }) => t.exec(e)?.[1])));
    },
    p = (e) => u(d(e.projects.flatMap((e) => g(e)))),
    j = (e) => {
     const t = g(e),
      n = ((e) => {
      ...
      const r = e.tasks
       ...
       .map(({ name: r, id: i, value: o }) => {
        const s = /^(.+) URL/.exec(r)[1],
         l = 'Storybook' === s ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${s}`;
  ...
  45282(e, t, n) {
   ...
   const o = ({ children: e, ...t }) => {
     const { to: n, href: r, ...o } = t;
     let s = n || r;
     const l = new URL(s, 'https://nldesignsystem.nl');
     return ('https://nldesignsystem.nl' === l.origin ? ((l.pathname = l.pathname.endsWith('/') ? l.pathname : `${l.pathname}/`), (s = l.toString().replace('https://nldesignsystem.nl', ''))) : ((o.target = '_blank'), (o.rel = 'noopener noreferrer')), (0, i.jsx)('a', { href: s, ...o, children: e }));
    },
    s = ({ className: e, ...t }) => (0, i.jsx)(o, { className: (0, r.$)('utrecht-link', 'utrecht-link--html-a', e), ...t });
  },
  46072(e, t, n) {
   'use strict';
   n.d(t, { NO: () => o, pI: () => s });
  ...
  59840(e, t, n) {
   ...
   var r = n(45282),
    ...
    a = n(46447),
    d = n(86070);
   const u = ({ title: e, sc: t, component: n, tags: a }) => {
     const u = (0, c.useId)(),
      h = [...a];
     if (t) {
      h.push(t);
        ...
        (0, d.jsxs)('div', {
         ...
         children: [
          ...
          (0, d.jsx)(o._Q, {
           ...
           children: h.map((e, t) => {
            let n = (0, d.jsx)(s.K, { children: e }, t);
            if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
             const o = i.pI.get(e);
             n = (0, d.jsx)(r.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${o.sc} ${o.nl.title}`, style: { lineHeight: 1 }, children: (0, d.jsx)(s.K, { children: `WCAG ${e}` }) }, t);
            }
            return n;
           }),
          }),
    ...
    h = ({ items: e, headingLevel: t }) => {
     ...
     return (0, d.jsxs)('div', {
      children: [
       (0, d.jsxs)('div', {
        ...
        children: [
         (0, d.jsxs)(a.LB, {
          ...
          'aria-labelledby': l,
          children: [
           (0, d.jsx)(a.DZ, { level: t, id: l, children: 'Filter acceptatiecriteria voor:' }),
             ...
             a.zB,
             {
              ...
              children: [
               (0, d.jsx)(a.Sc, {
                ...
                onChange: () =>
                 ((e, t) => {
                  const n = ('boolean' == typeof t ? t : !s(e)) ? [...r, e] : r.filter((t) => t !== e);
                  i(n);
                 })(e),
               }),
       ...
       (0, d.jsx)('ul', { className: 'new-checklist', role: 'list', children: h.map((e, t) => (0, d.jsx)(u, { ...e }, t)) }),
      ],
     });
    };
  },
  66015(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => T, component: () => W, contentTitle: () => C, default: () => L, description: () => G, frontMatter: () => x, issueNumber: () => z, metadata: () => r, title: () => R, toc: () => F }));
   ...
   function d(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(t.p, { children: ['Koppel het ', (0, i.jsx)(t.code, { children: 'label' }), '-element met de attributen ', (0, i.jsx)(t.code, { children: 'for' }), ' en ', (0, i.jsx)(t.code, { children: 'id' }), ' aan het bijbehorende input-element.'] }), '\n', (0, i.jsx)(t.pre, { children: (0, i.jsx)(t.code, { className: 'language-html', children: '<label for="voorbeeld">Ik ben een Text Input</label> <input type="text" id="voorbeeld" />\n' }) }), '\n', (0, i.jsxs)(t.p, { children: ['Op die manier is het Form Field Label expliciet gekoppeld met het input-element, ook als het input-element niet binnen een ', (0, i.jsx)(t.code, { children: 'label' }), '-element genest is.'] }), '\n', (0, i.jsx)(t.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, i.jsxs)(t.ul, { children: ['\n', (0, i.jsx)(t.li, { children: (0, i.jsx)(t.a, { href: '/richtlijnen/formulieren/labels/toegankelijke-naam/', children: 'Toegankelijke naam label' }) }), '\n', (0, i.jsx)(t.li, { children: (0, i.jsx)(t.a, { href: '/richtlijnen/formulieren/', children: 'Toegankelijke formulieren' }) }), '\n'] })] });
   }
   function u(e = {}) {
   ...
   function h(e) {
    const t = { a: 'a', code: 'code', li: 'li', p: 'p', pre: 'pre', ul: 'ul', ...(0, o.R)(), ...e.components };
    return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)(t.p, { children: ['Het Form Field Label kan met de attributen ', (0, i.jsx)(t.code, { children: 'for' }), ' en ', (0, i.jsx)(t.code, { children: 'id' }), ' aan het bijbehorende element voor formulierinvoer worden gekoppeld.'] }), '\n', (0, i.jsx)(t.pre, { children: (0, i.jsx)(t.code, { className: 'language-html', children: '<label for="voorbeeld">Ik ben een Text Input</label> <input type="text" id="voorbeeld" />\n' }) }), '\n', (0, i.jsxs)(t.p, { children: ['Op die manier is het Form Field Label expliciet gekoppeld met het element voor formulierinvoer, ook als die niet binnen een ', (0, i.jsx)(t.code, { children: 'label' }), '-element genest is.'] }), '\n', (0, i.jsx)(t.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, i.jsxs)(t.ul, { children: ['\n', (0, i.jsx)(t.li, { children: (0, i.jsx)(t.a, { href: '/richtlijnen/formulieren/labels/toegankelijke-naam/', children: 'Toegankelijke naam label' }) }), '\n', (0, i.jsx)(t.li, { children: (0, i.jsx)(t.a, { href: '/richtlijnen/formulieren/', children: 'Toegankelijke formulieren' }) }), '\n'] })] });
   }
   function m(e = {}) {
    const { wrapper: t } = { ...(0, o.R)(), ...e.components };
   ...
   var g = n(55552),
    ...
    k = n(59840),
    A = n(85825);
   const x = { title: 'Form Field Label', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Field Label', pagination_label: 'Form Field Label', description: 'Toont een tekstlabel dat informeert over de in te vullen informatie.', slug: '/form-field-label', keywords: ['caption', 'form', 'field label', 'form field label', 'form input', 'form label', 'formlabel', 'formulier', 'formulierelement', 'input label', 'label', 'text label', 'textlabel'] },
    C = void 0,
    T = {},
    R = 'Form Field Label',
    G = 'Toont een tekstlabel dat informeert over de in te vullen informatie.',
    z = 177,
    W = s.find((e) => e.number === z),
    F = [{ value: 'Checklist voor toegankelijkheid', id: 'checklist-voor-toegankelijkheid', level: 2 }, ...a.RM, { value: 'Acceptatiecriteria bij gebruik', id: 'acceptatiecriteria-bij-gebruik', level: 3 }, ...c.RM, { value: 'Acceptatiecriteria van de component', id: 'acceptatiecriteria-van-de-component', level: 3 }, ...l.RM, { value: 'Definition of Done', id: 'definition-of-done', level: 2 }, { value: 'Community implementaties', id: 'community-implementaties', level: 2 }];
   function N(e) {
    const t = { h2: 'h2', h3: 'h3', ...(0, o.R)(), ...e.components };
    return (0, i.jsxs)(i.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, i.jsx)(A.Fc, { component: W, headingLevel: 1, description: G }),
      '\n',
      ...
      (0, i.jsx)(k.b, {
       headingLevel: '4',
       items: [
        { title: 'Het Form Field label is gekoppeld aan het bijbehorende element voor formulierinvoer.', sc: '1.3.1', status: '', component: (0, i.jsx)(u, {}), tags: ['developer'] },
        { title: 'De kleur van het Form Field Label geeft geen informatie die niet ook op minimaal 1 andere manier wordt gegeven.', sc: '1.4.1', status: '', component: (0, i.jsx)(v.Ay, {}), tags: ['designer'] },
        { title: 'De tekst in het Form Field Label heeft een contrastratio van minimaal 4,5:1 met de achtergrondkleur.', sc: '1.4.3', status: '', component: (0, i.jsx)(j.Ay, {}), tags: ['designer'] },
        { title: 'De bezoeker kan het Form Field Label tot 400% vergroten zonder verlies van functionaliteit of informatie.', sc: '1.4.10', status: '', component: (0, i.jsx)(g.Ay, {}), tags: ['developer', 'designer'] },
        { title: 'Het Form Field Label beschrijft wat de bezoeker moet invullen.', sc: '2.4.6', status: '', component: (0, i.jsx)(w.Ay, {}), tags: ['designer', 'contentmaker'] },
        { title: 'Als het Form Field Label in een andere taal is dan de taal van de pagina, dan heeft het label-element een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: (0, i.jsx)(b.Ay, {}), tags: ['developer'] },
        { title: 'Elementen voor formulierinvoer met dezelfde functie hebben hetzelfde label.', sc: '3.2.4', status: '', component: (0, i.jsx)(y.Ay, {}), tags: ['designer', 'contentmaker'] },
       ],
      }),
      '\n',
      ...
      (0, i.jsx)(k.b, {
       headingLevel: '4',
       items: [
        { title: 'Het Form Field Label kan aan een element voor formulierinvoer gekoppeld worden.', sc: '1.3.1', status: '', component: (0, i.jsx)(m, {}), tags: ['developer'] },
        { title: 'Als je de tekst van het Form Field Label vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: (0, i.jsx)(f.Ay, {}), tags: ['developer'] },
        { title: 'Tekst in het Form Field Label blijft leesbaar wanneer de tekstafstand vergroot wordt. ', sc: '1.4.12', status: '', component: (0, i.jsx)(p.Ay, {}), tags: ['developer'] },
       ],
      }),
      '\n',
      (0, i.jsx)(t.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, i.jsx)(A.VK, { component: W, headingLevel: 3 }),
      '\n',
      (0, i.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
      '\n',
      (0, i.jsx)(A.mu, { component: W, headingLevel: 3 }),
      '\n',
      (0, i.jsx)(A.$9, { component: W, headingLevel: 2 }),
     ],
    });
   }
   function L(e = {}) {
    const { wrapper: t } = { ...(0, o.R)(), ...e.components };
    return t ? (0, i.jsx)(t, { ...e, children: (0, i.jsx)(N, { ...e }) }) : N(e);
   }
  },
  67970(e, t, n) {
   'use strict';
  ...
  72642(e, t, n) {
   ...
   var r = n(13526),
    i = n(86070);
   const o = ({ children: e, className: t, level: n = 1, suffix: o, ...s }) => (0, i.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, t), ...s, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), o && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
  },
  79889(e, t, n) {
   'use strict';
   n.d(t, { K: () => h });
   ...
   var h = (0, s.forwardRef)(function (e, t) {
    ...
    if (
     ...
     var d = r.dateTime,
      h = (0, i.A)(r, c);
     return (0, o.jsx)('time', u(u({}, h), {}, { dateTime: d, className: s, ref: t, children: n }));
    }
    if (
     (function (e) {
      return 'value' in e;
     ...
     var m = r.value,
      g = (0, i.A)(r, a);
     return (0, o.jsx)('data', u(u({}, g), {}, { value: m, className: s, ref: t, children: n }));
    }
    return (0, o.jsx)('span', u(u({}, r), {}, { className: s, ref: t, children: n }));
   });
  ...
  85825(e, t, n) {
   ...
   const p = ({ children: e }) => (0, a.jsx)('ul', { className: 'task-list', children: e }),
    j = ({ checked: e, children: t, title: n, description: r, headingLevel: o = 3 }) => (0, a.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, a.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, a.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, a.jsx)(g.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, a.jsxs)('div', { children: [n ? (0, a.jsx)(m.DZ, { appearance: 'utrecht-heading-3', level: o, children: n }) : null, r, t] })] });
   var f = n(33062);
   const w = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => f.f4.includes(e.id)),
      o = n && f.f4.map((e) => n.find((t) => t.id === e)).filter(Boolean);
     return e && (0, a.jsx)(r.If, { sections: o.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, f.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(p, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, a.jsx)(j, { headingLevel: t + 1, checked: e, title: n, description: (0, f.qZ)(r) }, r)) }), (0, a.jsx)(r.fz, { children: (0, a.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
         ...
         children: n
          ...
          .map((e) => {
           const n = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            u = e.tasks.filter(({ name: e, value: t }) => c.has(e) && URL.canParse(t) && 'https:' === new URL(t).protocol);
           return (0, a.jsx)(
            s.Zp,
            {
             ...
             children: (0, a.jsxs)(s.Wu, {
              children: [
               ...
               (u.length > 0 || l.length > 0) && (0, a.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               u.length > 0 &&
                (0, a.jsx)(a.Fragment, {
                 children: (0, a.jsx)(r.dk, {
                  links: u
                   ...
                   .map((e) => {
                    ...
                    return { children: t.desciption, icon: (0, a.jsx)(o.r, { brand: t.brand }), href: e.value };
                   }),
                 }),
                }),
               l.length > 0 && (0, a.jsx)(a.Fragment, { children: l.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    y = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(r.DZ, { level: t, children: 'Help om deze component te verbeteren' }), (0, a.jsxs)(r.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, a.jsxs)(r.Xy, { children: [i ? (0, a.jsxs)(r.Er, { children: ['Vul de ', (0, a.jsx)(r.N_, { href: i, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, a.jsxs)(r.Er, { children: [(0, a.jsxs)(r.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, a.jsxs)(r.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, a.jsx)(r.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, a.jsx)(r.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    v = ({ component: e, headingLevel: t, description: n }) => {
     const i = e && f.bo[e.relayStep];
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(h.p, { level: t, suffix: i && (0, a.jsx)(u.D, { state: i }), children: e.title }), (0, a.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
   n.d(t, { AC: () => a, Fu: () => s, Wu: () => l, Zp: () => c });
   var r = n(46447),
    i = n(13526),
    o = n(86070);
   const s = ({ background: e, children: t, className: n, ...r }) => (0, o.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    l = (e) => (0, o.jsx)('div', { className: 'card__content', ...e }),
    c = ({ href: e, appearance: t, className: n, component: s = 'div', background: l, children: c }) => {
     const a = (e) => ('article' === s ? (0, o.jsx)('article', { ...e }) : 'section' === s ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(a, { className: (0, i.A)('cardgroup__card', l && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: c });
     return e ? (0, o.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: d }) : d;
    },
    a = ({ appearance: e = 'medium', children: t, className: n }) => (0, o.jsx)('div', { className: (0, i.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
  99805(e, t, n) {
   'use strict';
   n.d(t, { Ay: () => s });
   ...
   function o(e) {
    const t = { a: 'a', code: 'code', li: 'li', p: 'p', ul: 'ul', ...(0, i.R)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(t.p, { children: 'Het label van een invoerveld maakt kort en bondig duidelijk welke invoer van de bezoeker gevraagd wordt. Een tekstueel label kan een tekst zijn, of een icoon waar de alternatieve tekst het doel van het invoerveld beschrijft.' }), '\n', (0, r.jsx)(t.p, { children: "Bijvoorbeeld: de alternatieve tekst van een vergrootglas icoon is 'Zoeken' en niet 'Vergrootglas'." }), '\n', (0, r.jsxs)(t.p, { children: ['Let op: Gebruik je een asterisk (', (0, r.jsx)(t.code, { children: '*' }), ") om aan te geven dat een veld verplicht is? Zorg dan dat je v\xf3\xf3r de eerste asterisk uitlegt wat de betekenis is. Plaats bijvoorbeeld bovenaan het formulier de tekst: 'Velden met een ", (0, r.jsx)(t.code, { children: '*' }), " zijn verplicht'."] }), '\n', (0, r.jsx)(t.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, r.jsxs)(t.ul, { children: ['\n', (0, r.jsx)(t.li, { children: (0, r.jsx)(t.a, { href: '/richtlijnen/formulieren/labels/duidelijke-tekst/', children: 'Gebruik duidelijke labelteksten' }) }), '\n', (0, r.jsx)(t.li, { children: (0, r.jsx)(t.a, { href: '/richtlijnen/formulieren/', children: 'Toegankelijke formulieren' }) }), '\n'] })] });
   }
   function s(e = {}) {
    const { wrapper: t } = { ...(0, i.R)(), ...e.components };
    return t ? (0, r.jsx)(t, { ...e, children: (0, r.jsx)(o, { ...e }) }) : o(e);
