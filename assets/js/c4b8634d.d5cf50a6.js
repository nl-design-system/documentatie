(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [36360],
 {
  ...
  38206: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => D, component: () => F, contentTitle: () => W, default: () => M, description: () => S, frontMatter: () => L, issueNumber: () => _, metadata: () => R, title: () => P, toc: () => N });
   var r = t(52676),
    i = t(24785),
    o = t(96439),
    s = t(92183);
   ...
   function Z(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(G.Rv, { component: F, headingLevel: 1, description: S }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, r.jsx)(G.cN, { component: F, headingLevel: 3 }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, r.jsx)(G.W, { component: F, headingLevel: 3 }),
      '\n',
      ...
      (0, r.jsx)(z.t, {
       ...
       items: [
        { title: 'Het label van de Login Link bestaat uit gewone tekst, niet uit een afbeelding van tekst', sc: '1.4.5', status: '', component: (0, r.jsx)(x.ZP, {}) },
        { title: 'De linktekst van de Login Link vertelt eenduidig aan de gebruiker waar de link naar toe gaat (het linkdoel).', sc: '2.4.4', status: '', component: (0, r.jsx)(T.ZP, {}) },
        { title: 'De zichtbare naam van de Login Link komt voor in de toegankelijke naam', sc: '2.5.3', status: '', component: (0, r.jsx)(w.ZP, {}) },
        { title: 'Als de tekst van de Login Link in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode', sc: '3.1.2', status: '', component: (0, r.jsx)(v.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(z.t, {
       ...
       items: [
        ...
        { title: 'De Login Link heeft een goed zichtbare focusindicator', sc: '2.4.13', status: '', component: (0, r.jsx)(m.ZP, {}) },
        ...
        { title: 'Login Links met gelijke functies hebben hetzelfde uiterlijk en hetzelfde label', sc: '3.2.4', status: '', component: (0, r.jsx)(y, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(z.t, {
      ...
      (0, r.jsx)(z.t, {
       ...
       items: [
        ...
        { title: 'De functionaliteit van de Login Link veroorzaakt geen toetsenbordval', sc: '2.1.2', status: '', component: (0, r.jsx)(A.ZP, {}) },
        { title: 'Wanneer de Login Link de toetsenbordfocus krijgt is de focus zichtbaar', sc: '2.4.7', status: '', component: (0, r.jsx)(j.ZP, {}) },
        { title: 'Als de Login Link de toetsenbordfocus krijgt, is het element niet volledig bedekt door andere inhoud', sc: '2.4.11', status: '', component: (0, r.jsx)(C.ZP, {}) },
        { title: 'Als de gebruiker de Login Link indrukt met een aanwijzer zoals een muis of vinger, is er de mogelijkheid is om actie te voorkomen of ongedaan te maken', sc: '2.5.2', status: '', component: (0, r.jsx)(p.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(z.t, {
      ...
      '\n',
      (0, r.jsx)(G.vM, { component: F, headingLevel: 3 }),
     ],
    });
   }
   function M(e = {}) {
  ...
  55240: (e, n, t) => {
   ...
   const c = (e) => {
    ...
    d = (e) => {
     ...
     return (0, l.jsxs)('details', { className: 'task-list', children: [(0, l.jsx)('summary', { children: (0, l.jsx)('h3', { children: n }) }), t.map((e, n) => (0, l.jsx)(c, { ...e }, n))] });
    };
  },
  8657: (e, n, t) => {
   'use strict';
   ...
   const x = (e) => {
          ...
          children: [
           (0, d.jsx)(f, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(y, { checked: n, title: t, description: (0, b.Q6)(r) }, r);
            }),
           }),
    ...
    T = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(w.V, { level: t, suffix: o && (0, d.jsx)(p.y, { state: o }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, n, t) => {
   'use strict';
