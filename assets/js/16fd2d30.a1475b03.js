 ...
 [32139],
 {
  ...
  12761(e, n, a) {
   ...
   const f = ({ className: e, ...n }) => {
    ...
    b = ({ className: e, heading: n, headingLevel: a, headingApperance: t, ...i }) => {
  ...
  26356(e, n, a) {
   'use strict';
   (a.r(n), a.d(n, { assets: () => k, component: () => F, contentTitle: () => x, default: () => A, description: () => T, frontMatter: () => b, issueNumber: () => D, metadata: () => t, title: () => j, toc: () => N }));
  ...
  76097(e, n, a) {
   'use strict';
   a.d(n, { bo: () => l, KF: () => m, mJ: () => p, VZ: () => T, cR: () => j, Pv: () => v, qZ: () => s, kD: () => x, QQ: () => F, B2: () => c, Pc: () => r, f4: () => o, GT: () => k, fX: () => i, eQ: () => b, B_: () => f, o_: () => q });
