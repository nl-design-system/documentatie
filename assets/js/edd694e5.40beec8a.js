  ...
  21004: (e, n, i) => {
   ...
   const s = (e, n) => e.reduce((e, i) => ('link' === i.type ? (n.includes(i.docId) ? e : [...e, i]) : 'category' === i.type ? [...e, { ...i, items: s(i.items, n) }] : e), []),
    a = (e) => {
     ...
     const c = (0, r.jA)();
     return (0, o.jsx)('div', { ...a, className: (0, t.Z)('margin-top--lg', i), children: (0, o.jsx)(l.Z, { items: s(c.items, n) }) });
    };
  },
  13879: (e, n, i) => {
   i.d(n, { Z: () => f });
   ...
   function c(e) {
    ...
    return (0, a.jsxs)('div', { className: (0, o.Z)('card', s.card), children: [n ? (0, a.jsx)(t.Z, { href: n, className: (0, o.Z)(s.cardLink, 'utrecht-link'), children: (0, a.jsxs)('h2', { className: (0, o.Z)(s.cardTitle), children: [i, ' ', r] }) }) : (0, a.jsxs)('h2', { className: (0, o.Z)(s.cardTitle), children: [i, ' ', r] }), l && (0, a.jsx)('p', { className: (0, o.Z)(s.cardDescription), children: l }), c] });
   }
   function d(e) {
    let { item: n } = e;
   ...
   function f(e) {
    ...
    const t = (0, r.MN)(n);
    return (0, a.jsx)('section', { className: (0, o.Z)('row', i), children: t.map((e, n) => (0, a.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, a.jsx)(u, { item: e }) }, n)) });
   }
  },
  24785: (e, n, i) => {
   i.d(n, { Z: () => s, a: () => o });
