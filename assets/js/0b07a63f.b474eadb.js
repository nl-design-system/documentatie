/*! For license information please see 0b07a63f.b474eadb.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [41627],
 {
  76294: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => d, contentTitle: () => l, default: () => p, frontMatter: () => m, metadata: () => c, toc: () => u });
   var i = t(52676),
    s = t(40139),
    o = t(86135),
    r = t(68257),
  ...
  68257: (e, n, t) => {
   ...
   const r = (e) => {
    ...
    return (0, o.jsx)(i.Z, { className: (0, s.W)('utrecht-button-link', `utrecht-button-link--${n}`), ...t });
   };
  },
  40139: (e, n, t) => {
   t.d(n, { Z: () => a, a: () => r });
  ...
  72315: (e, n, t) => {
   ...
   const o = (e, n, t, o) => {
    const r = (0, i.forwardRef)(({ color: t = 'currentColor', size: r = 24, stroke: a = 2, title: m, className: l, children: c, ...d }, u) => (0, i.createElement)('svg', { ref: u, ...s[e], width: r, height: r, className: ['tabler-icon', `tabler-icon-${n}`, l].join(' '), ...('filled' === e ? { fill: t } : { strokeWidth: a, stroke: t }), ...d }, [m && (0, i.createElement)('title', { key: 'svg-title' }, m), ...o.map(([e, n]) => (0, i.createElement)(e, n)), ...(Array.isArray(c) ? c : [c])]));
