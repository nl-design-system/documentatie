 ...
 [13562],
 {
  18127(e, n, t) {
   ...
   const v = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: v = !0, children: f, container: j = 'document', language: y, designTokens: x }) => {
    ...
    let $ = h.Fragment;
    return (
     'paragraph' === j ? ($ = m) : 'document' === j ? ($ = g) : 'surface' === j && ($ = b),
     (0, u.jsxs)('div', {
      className: (0, i.A)('nlds-canvas'),
      children: [
       k && (0, u.jsx)('div', { className: (0, i.A)('nlds-canvas__example'), children: (0, u.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, u.jsx)($, { children: (0, u.jsx)(o.v$, { children: k }) }) }) }),
       v &&
        (0, u.jsx)('div', {
