...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [4104],
 {
  ...
  21034(e, n, a) {
   ...
   const b = ({ component: e, headingLevel: n }) => {
    ...
    j = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: i && (0, d.jsx)(u.D, { state: i }), children: e.title }), (0, d.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(i) && (0, d.jsx)(f.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    D = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => x, qZ: () => l, kD: () => v, QQ: () => H, B2: () => c, Pc: () => o, f4: () => r, GT: () => j, fX: () => s, eQ: () => k, B_: () => b, o_: () => f });
  ...
  70348(e, n, a) {
   ...
   const r = ({ className: e, ...n }) => {
    ...
    o = ({ className: e, classNamePanel: n, label: a, heading: r, headingLevel: o, headingApperance: d, ...g }) => {
