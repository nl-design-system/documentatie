   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const l = 'function' == typeof e ? e() : e,
        ...
        s = u().highlight(o, u().languages[n], n);
       return (0, k.jsxs)('div', { className: (0, a.A)('ma-canvas-astro', t), children: [(0, k.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }), (0, k.jsx)(g.n, { children: (0, k.jsx)(g.K, { label: 'Code', children: (0, k.jsx)('pre', { className: 'language-html nl-code-block', children: (0, k.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
