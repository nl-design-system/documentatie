 ...
 [41192],
 {
  ...
  41192: (r, t, o) => {
   ...
   const c = class {
    ...
    render() {
     const { autocomplete: r, cols: t, disabled: o, invalid: c, placeholder: l, readOnly: u, required: d, rows: h, spellcheck: n, value: i } = this;
     return (0, e.h)(
      'textarea',
      {
       key: 'dd85e3cd9b2af2d3c9033de9dbab80677e36793f',
       autoComplete: r || null,
      ...
      (0, e.h)('slot', { key: '021a7dba13030b4822b819a15364ff54529f116b' }),
     );
    }
   };
