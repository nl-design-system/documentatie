...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [12421],
 {
  ...
  37214: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => v, contentTitle: () => p, default: () => b, frontMatter: () => u, metadata: () => g, toc: () => _ });
   var t = l(52676),
    o = l(24785),
    s = l(98480),
    a = l(91050);
  ...
  98480: (e, n, l) => {
   ...
   const b = (e) => {
    ...
    let P = d.Fragment;
    return (
     'paragraph' === j ? (P = v) : 'document' === j ? (P = _) : 'surface' === j && (P = h),
     (0, g.jsxs)('div', {
      className: (0, o.Z)(u['nlds-canvas']),
      children: [
       w && (0, g.jsx)('div', { className: (0, o.Z)(u['nlds-canvas__example']), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, g.jsx)(P, { children: (0, g.jsx)(t.pu, { children: w }) }) }) }),
       x &&
        (0, g.jsx)('div', {
    ...
    return (
     ...
     (0, a.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsx)(t.dn, { tabIndex: 0, style: l, children: o.map((e, l) => (0, a.jsxs)('span', { ...s({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const u = 'Doen',
     ...
     g = m ? 'figure' : 'div',
     v = m ? 'figcaption' : 'div';
    return (0, r.jsxs)(g, { className: (0, a.Z)(i['nlds-guideline'], i[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, r.jsxs)(v, { className: (0, a.Z)(i['nlds-guideline__description']), children: ['dont' === l ? (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(s.nv, { className: (0, a.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: i['nlds-guideline__title'], children: p })] }), (0, r.jsx)(s.nv, { children: n })] }) : (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(s.nv, { className: (0, a.Z)(i['nlds-guideline__badge'], i[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: i['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: i['nlds-guideline__title'], children: u })] }), (0, r.jsx)(s.nv, { children: n })] }), c] }), (0, r.jsx)('div', { className: (0, a.Z)(i['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => i, a: () => a });
