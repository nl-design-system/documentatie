(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [28568],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => y, VZ: () => w, cR: () => _, Pv: () => p, qZ: () => s, kD: () => b, B2: () => j, Pc: () => a, f4: () => o, GT: () => k, fX: () => c, eQ: () => v, B_: () => f, o_: () => g, Rc: () => x });
  ...
  88398(e, t, n) {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => m, contentTitle: () => l, default: () => g, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => h, toc: () => y });
