 ...
 [86681],
 {
  ...
  66359: (e, n, t) => {
   ...
   var s = t(52676),
    ...
    r = t(40761),
    i = t(66968);
   const a = { title: 'Opsommingen \xb7 Content \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Opsommingen', pagination_label: 'Opsommingen', description: 'Zorg dat een opsomming goed is opgemaakt, zodat deze beter bruikbaar is voor bijvoorbeeld blinde mensen die een schermlezer gebruiken.', slug: '/richtlijnen/content/tekstopmaak/opsommingen', keywords: ['semantiek', 'tekstopmaak', 'structuur', 'tekststructuur', 'opsommingen', 'geordende', 'ongeordende', 'lijst'] },
    c = 'Opsommingen',
    d = { id: 'richtlijnen/content/tekstopmaak/summaries', title: 'Opsommingen \xb7 Content \xb7 Richtlijnen', description: 'Zorg dat een opsomming goed is opgemaakt, zodat deze beter bruikbaar is voor bijvoorbeeld blinde mensen die een schermlezer gebruiken.', source: '@site/docs/richtlijnen/content/tekstopmaak/summaries.md', sourceDirName: 'richtlijnen/content/tekstopmaak', slug: '/richtlijnen/content/tekstopmaak/opsommingen', permalink: '/richtlijnen/content/tekstopmaak/opsommingen', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/content/tekstopmaak/summaries.md', tags: [], version: 'current', frontMatter: { title: 'Opsommingen \xb7 Content \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Opsommingen', pagination_label: 'Opsommingen', description: 'Zorg dat een opsomming goed is opgemaakt, zodat deze beter bruikbaar is voor bijvoorbeeld blinde mensen die een schermlezer gebruiken.', slug: '/richtlijnen/content/tekstopmaak/opsommingen', keywords: ['semantiek', 'tekstopmaak', 'structuur', 'tekststructuur', 'opsommingen', 'geordende', 'ongeordende', 'lijst'] }, sidebar: 'richtlijnen', previous: { title: 'Citaten', permalink: '/richtlijnen/content/citaten' }, next: { title: 'Tabellen', permalink: '/richtlijnen/content/tekstopmaak/tabellen' } },
    m = {},
    p = [
  ...
  43599: (e, n, t) => {
   ...
   const b = (e) => {
    ...
    (0, m.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(z, { parser: y, plugins: [r.Z, i.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [z]);
    const D = (0, m.useId)();
    let O = m.Fragment;
    return (
     'paragraph' === x ? (O = j) : 'document' === x ? (O = h) : 'surface' === x && (O = g),
     (0, u.jsxs)('div', {
      ...
      children: [
       ...
       k &&
        (0, u.jsxs)('div', {
         ...
         hidden: !Z,
         children: [
          (0, u.jsx)(s.u, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: N, trim: !0 }),
          t &&
           (0, u.jsx)('div', {
