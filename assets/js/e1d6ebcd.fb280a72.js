/*! For license information please see e1d6ebcd.fb280a72.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [55407],
 {
  ...
  18652(e, n, i) {
   ...
   const a = (e, n, i, a) => {
    const r = (0, t.forwardRef)(({ color: i = 'currentColor', size: r = 24, stroke: o = 2, title: l, className: d, children: c, ...m }, u) => (0, t.createElement)('svg', { ref: u, ...s[e], width: r, height: r, className: ['tabler-icon', `tabler-icon-${n}`, d].join(' '), ...('filled' === e ? { fill: i } : { strokeWidth: o, stroke: i }), ...m }, [l && (0, t.createElement)('title', { key: 'svg-title' }, l), ...a.map(([e, n]) => (0, t.createElement)(e, n)), ...(Array.isArray(c) ? c : [c])]));
  ...
  73058(e, n, i) {
   ...
   const o = s.forwardRef(function (e, n) {
     const [i, o] = s.useState(!1),
      ...
      y = s.useMemo(() => (e.playlist ? `${v}/embed/videoseries?${j.toString()}` : `${v}/embed/${c}?${j.toString()}`), [e.playlist, v, c, j]),
      ...
      w = k
       ...
       : null,
      x = s.useMemo(() => e.thumbnail || w || `https://i.ytimg.com/${b}/${e.playlist ? m : c}/${h}.${f}`, [e.thumbnail, w, b, e.playlist, m, c, h, f]),
