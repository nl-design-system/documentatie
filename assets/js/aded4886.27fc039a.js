...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  2461: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => p, default: () => b, frontMatter: () => u, metadata: () => j, toc: () => v });
   var r = i(52676),
    t = i(40139),
    s = i(57716),
    a = i(46364),
   ...
   function h(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: "Aanwijsgebaren zijn bijvoorbeeld het slepen van inhoud binnen bepaalde kaders, het swipen van foto's of het vergroten van een kaart met twee vingers." }), '\n', (0, r.jsx)(n.p, { children: 'Zorg ervoor dat de gebruiker deze acties ook kan doen met \xe9\xe9n aanwijzer zoals een muis of een vinger zonder deze extra gebaren te hoeven maken.' }), '\n', (0, r.jsx)(n.p, { children: 'Bijvoorbeeld:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: "Je kunt foto's swipen om meer foto's te bekijken. Maar je kunt ook op een button klikken." }), '\n', (0, r.jsx)(n.li, { children: 'Je kunt een slider voor de maximumprijs verslepen. Maar je kunt ook klikken op de maximumprijs die je wilt instellen of het getal handmatig invoeren.' }), '\n'] }), '\n', (0, r.jsx)(n.p, { children: 'Er is een uitzondering voor als aanwijsgebaar essentieel is voor de functionaliteit.' })] });
   }
   function g(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(h, { ...e }) }) : h(e);
   }
   const u = { title: 'WCAG-succescriterium 2.5.1 Aanwijzergebaren', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.1 Aanwijzergebaren', pagination_label: 'WCAG-succescriterium 2.5.1 Aanwijzergebaren', description: "Aanwijsgebaren zijn bijvoorbeeld het slepen van inhoud binnen bepaalde kaders, het swipen van foto's of het vergroten van een kaart met twee vingers. Zorg ervoor dat de gebruiker deze acties ook kan doen met \xe9\xe9n aanwijzer zoals een muis of een vinger zonder deze extra gebaren te hoeven maken.", slug: '2.5.1', keywords: ['WCAG', 'A', 'bedienbaar', 'input modaliteiten', 'operable', 'input modalities', 'pointer gestures'] },
    p = void 0,
    j = { id: 'wcag/2.5.01', title: 'WCAG-succescriterium 2.5.1 Aanwijzergebaren', description: "Aanwijsgebaren zijn bijvoorbeeld het slepen van inhoud binnen bepaalde kaders, het swipen van foto's of het vergroten van een kaart met twee vingers. Zorg ervoor dat de gebruiker deze acties ook kan doen met \xe9\xe9n aanwijzer zoals een muis of een vinger zonder deze extra gebaren te hoeven maken.", source: '@site/docs/wcag/2.5.01.mdx', sourceDirName: 'wcag', slug: '/wcag/2.5.1', permalink: '/wcag/2.5.1', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.5.01.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.5.1 Aanwijzergebaren', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.1 Aanwijzergebaren', pagination_label: 'WCAG-succescriterium 2.5.1 Aanwijzergebaren', description: "Aanwijsgebaren zijn bijvoorbeeld het slepen van inhoud binnen bepaalde kaders, het swipen van foto's of het vergroten van een kaart met twee vingers. Zorg ervoor dat de gebruiker deze acties ook kan doen met \xe9\xe9n aanwijzer zoals een muis of een vinger zonder deze extra gebaren te hoeven maken.", slug: '2.5.1', keywords: ['WCAG', 'A', 'bedienbaar', 'input modaliteiten', 'operable', 'input modalities', 'pointer gestures'] }, sidebar: 'richtlijnen', previous: { title: '2.4.13 Focusweergave', permalink: '/wcag/2.4.13' }, next: { title: 'WCAG-succescriterium 2.5.2 Aanwijzerannulering', permalink: '/wcag/2.5.2' } },
    m = {},
    v = [
