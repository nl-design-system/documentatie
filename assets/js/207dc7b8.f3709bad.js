...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  16640: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => v, contentTitle: () => j, default: () => b, frontMatter: () => p, metadata: () => m, toc: () => w });
   var t = i(52676),
    r = i(40139),
    s = i(57716),
    a = i(46364),
   ...
   const p = { title: 'WCAG-succescriterium 2.4.8 Locatie', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.8 Locatie', pagination_label: '2.4.8 Locatie', description: 'Laat gebruikers weten waar ze zich precies bevinden binnen een website.', slug: '2.4.8', keywords: ['WCAG', 'Toetsenbord'] },
    j = void 0,
    m = { id: 'wcag/2.4.08', title: 'WCAG-succescriterium 2.4.8 Locatie', description: 'Laat gebruikers weten waar ze zich precies bevinden binnen een website.', source: '@site/docs/wcag/2.4.08.mdx', sourceDirName: 'wcag', slug: '/wcag/2.4.8', permalink: '/wcag/2.4.8', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.4.08.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.4.8 Locatie', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.8 Locatie', pagination_label: '2.4.8 Locatie', description: 'Laat gebruikers weten waar ze zich precies bevinden binnen een website.', slug: '2.4.8', keywords: ['WCAG', 'Toetsenbord'] }, sidebar: 'richtlijnen', previous: { title: '2.4.7 Focus zichtbaar', permalink: '/wcag/2.4.7' }, next: { title: 'WCAG-succescriterium 2.4.9 Linkdoel (alleen link)', permalink: '/wcag/2.4.9' } },
    v = {},
    w = [
