   ...
   const d = (0, c.createContext)({}),
    u = ({ title: e, appearance: n, description: l, children: c, figure: u }) => {
     const m = { do: 'Doen', dont: 'Niet doen' },
      p = u ? 'figure' : 'div',
      h = u ? 'figcaption' : 'div',
      v = 'string' == typeof l ? (0, i.jsx)(a.oz, { components: { a: s.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   const a = ({ className: e, ...n }) => {
    ...
    c = ({ className: e, classNamePanel: n, label: l, heading: a, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, r.jsxs)('details', { className: u, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(t.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [a && (0, r.jsx)(s.D, { level: c, appearance: i, children: a }), l] })] }) }), (0, r.jsx)('div', { className: m, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => y });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       const o = 'function' == typeof e ? e() : e,
        ...
        r = h().highlight(t, h().languages[n], n);
       return (0, g.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', l), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: t } }), (0, g.jsx)(v.n, { children: (0, g.jsx)(v.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
