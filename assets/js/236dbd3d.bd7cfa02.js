 ...
 [15483],
 {
  18127(e, n, l) {
   ...
   const y = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: y = !0, children: g, container: x = 'document', language: v, designTokens: k }) => {
    ...
    let D = u.Fragment;
    return (
     'paragraph' === x ? (D = h) : 'document' === x ? (D = b) : 'surface' === x && (D = j),
     (0, m.jsxs)('div', {
      className: (0, o.A)('nlds-canvas'),
      children: [
       f && (0, m.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(D, { children: (0, m.jsx)(s.v$, { children: f }) }) }) }),
       y &&
        (0, m.jsx)('div', {
