 ...
 [24171],
 {
  ...
  24456(e, n, t) {
   ...
   const a = ({ children: e, ...n }) => {
    ...
    o = ({ className: e, boxContent: n, ...t }) => (0, s.jsx)(a, { className: (0, r.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  38332(e, n, t) {
   (t.r(n), t.d(n, { assets: () => u, contentTitle: () => p, default: () => j, frontMatter: () => g, metadata: () => r, toc: () => v }));
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => i, KF: () => h, mJ: () => u, VZ: () => D, cR: () => y, Pv: () => v, qZ: () => a, kD: () => b, QQ: () => S, B2: () => g, Pc: () => l, f4: () => o, GT: () => x, fX: () => s, eQ: () => f, B_: () => j, o_: () => k });
