 ...
 [28568],
 {
  ...
  14881(e, n, t) {
   ...
   const l = (0, r.forwardRef)(({ as: e, className: n, children: t, ...r }, o) => {
    ...
    d = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: l, headingApperance: d, ...c }) => {
     ...
     return (0, s.jsxs)('details', { className: g, ...c, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(o.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(a.D, { level: l, appearance: d, children: r }), t] })] }) }), (0, s.jsx)('div', { className: u, children: c.children })] });
    };
  },
  19707(e, n, t) {
   t.d(n, { Z: () => i.Z });
  ...
  24456(e, n, t) {
   ...
   const a = ({ children: e, ...n }) => {
    ...
    s = ({ className: e, boxContent: n, ...t }) => (0, o.jsx)(a, { className: (0, i.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  24908(e, n, t) {
   t.d(n, { Ay: () => a });
   var i = t(86070),
  ...
  26877(e, n, t) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
               ...
               d.Z,
               {
                ...
                description: (0, c.jsxs)('div', {
                 ...
                 children: [
                  ...
                  (0, c.jsxs)('div', {
                   children: [
                    (p.length > 0 || u.length > 0) && (0, c.jsx)(r.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    p.length > 0 &&
                     (0, c.jsx)(i.dk, {
                      links: p
                  ...
                  u.length > 0 && u.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)('section', { children: [(0, c.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, c.jsxs)(l.Wu, {
                 children: [
                  ...
                  u.length > 0 && (0, c.jsx)(c.Fragment, { children: u.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(i.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    A = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(m.p, { level: n, suffix: r && (0, c.jsx)(u.D, { state: r }), children: e.title }), (0, c.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(r) && (0, c.jsx)(j.s, { relayStep: r, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    k = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => h, VZ: () => k, cR: () => A, Pv: () => f, qZ: () => a, kD: () => b, QQ: () => C, B2: () => m, Pc: () => l, f4: () => s, GT: () => v, fX: () => o, eQ: () => x, B_: () => j, o_: () => w });
