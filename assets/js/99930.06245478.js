 ...
 [99930],
 {
  99930: (e, t, l) => {
   ...
   const r = class {
    ...
    render() {
     return (0, a.h)(a.H, { key: '7acc0fede04e4eb026fbd8fa3eaf0c8e8e916f2e', role: 'col' === this.scope ? 'columnheader' : 'row' === this.scope ? 'rowheader' : 'cell' }, (0, a.h)('slot', { key: '03d891a51809f2b4b1f52a8de217e0efacf7e6fe' }));
    }
   };
