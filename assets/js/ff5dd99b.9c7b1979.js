 ...
 [10452],
 {
  ...
  16764(e, n, a) {
   ...
   var p = a(43864),
    ...
    A = a(79532),
    S = a(30758);
   const T = { boxShadow: p.A, color: k.A, cursor: j.A, dimension: v.A, fontFamily: x.A, fontFamilies: x.A, fontSize: f.A, fontSizes: f.A, fontWeight: b.A, fontWeights: b.A, lineHeight: y.A, lineHeights: y.A, number: w.A, other: D.A, textDecoration: A.A },
    F = ({ type: e }) => {
   ...
   function C({ tokens: e }) {
    const n = (0, i.kD)(e),
     a = (0, N.sj)(e, (e) => (((e) => null !== e && 'object' == typeof e && Object.hasOwn(e, '$type') && 'string' == typeof e.$type)(e) ? { $type: e.$type, $value: '' } : void 0)),
     l = (0, i.GT)(n),
       ...
       children: [
        ...
        (0, u.jsx)(s.BF, {
         children: l.map((n) => {
          const a = (0, i.o_)(n),
           l = (0, i.eQ)(e, n).$type;
          return (0, u.jsxs)(s.Hj, { children: [(0, u.jsx)(s.nA, { children: (0, u.jsx)(t.C, { children: (0, u.jsx)(s.kf, { children: a }) }) }), (0, u.jsx)(s.nA, { children: (0, u.jsxs)(r.K, { children: [(0, u.jsx)(F, { type: l }), ' ', l] }) })] }, a);
         }),
        }),
       ],
      }),
  ...
  49863(e, n, a) {
   'use strict';
   (a.r(n), a.d(n, { assets: () => L, component: () => R, contentTitle: () => C, default: () => G, description: () => z, frontMatter: () => N, issueNumber: () => _, metadata: () => t, title: () => H, toc: () => M }));
   ...
   const F = JSON.parse('{"nl":{"mark":{"background-color":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<color>","nl.nldesignsystem.figma-implementation":true},"$type":"color"},"color":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<color>","nl.nldesignsystem.figma-implementation":true},"$type":"color"}}}}'),
    ...
    L = {},
    H = 'Mark',
    z = 'Markeert tekst, zodat je ernaar kan verwijzen vanuit een andere context of omdat de tekst relevant is voor de huidige activiteit.',
    _ = 333,
    R = s.find((e) => e.number === _),
  ...
  76097(e, n, a) {
   'use strict';
   a.d(n, { bo: () => r, KF: () => m, mJ: () => p, VZ: () => w, cR: () => y, Pv: () => k, qZ: () => s, kD: () => f, B2: () => u, Pc: () => o, f4: () => l, GT: () => b, fX: () => i, eQ: () => x, B_: () => v, o_: () => j });
