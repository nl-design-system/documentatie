   ...
   const d = (0, i.createContext)({}),
    h = ({ title: e, appearance: l, description: n, children: i, figure: h }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      p = h ? 'figure' : 'div',
      m = h ? 'figcaption' : 'div',
      b = 'string' == typeof n ? (0, c.jsx)(t.oz, { components: { a: a.N_ }, children: n }) : n;
  ...
  80731(e, l, n) {
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: l, className: n }) => {
       ...
       return (0, g.jsxs)('div', { className: (0, a.A)('ma-canvas-astro', n), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: s } }), (0, g.jsx)(b.n, { children: (0, g.jsx)(b.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
