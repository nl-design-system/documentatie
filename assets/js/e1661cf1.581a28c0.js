(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [29865],
 {
  ...
  94443: (e, t, n) => {
   ...
   const k = (e) => {
     ...
     const s = t && t.projects.filter((e) => b.e9.includes(e.id)),
      c = s && b.e9.map((e) => s.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, u.jsx)(v, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(f, { headingLevel: n + 1, checked: t, title: r, description: (0, b.Q6)(i) }, i);
            }),
           }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => o, Ee: () => u, Q6: () => s, U: () => j, Yr: () => g, d: () => h, e9: () => c, fO: () => f, mA: () => i, ps: () => m, qU: () => b, s0: () => v, zP: () => y });
