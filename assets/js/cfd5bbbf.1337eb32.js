 ...
 [74865],
 {
  18127(e, n, t) {
   ...
   const y = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: y = !0, children: g, container: x = 'document', language: b, designTokens: f }) => {
    ...
    let z = u.Fragment;
    return (
     'paragraph' === x ? (z = h) : 'document' === x ? (z = j) : 'surface' === x && (z = v),
     (0, m.jsxs)('div', {
      className: (0, r.A)('nlds-canvas'),
      children: [
       k && (0, m.jsx)('div', { className: (0, r.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(z, { children: (0, m.jsx)(o.v$, { children: k }) }) }) }),
       y &&
        (0, m.jsx)('div', {
