...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [77104],
 {
  ...
  19472(e, n, t) {
   ...
   var a = t(20201),
    r = t(86070);
   const i = ({ id: e, title: n, ...t }) => (0, r.jsx)(a.Ay, { lazyLoad: !0, adNetwork: !1, announce: 'Bekijk', cookie: !1, containerElement: 'div', id: e, title: n, poster: 'maxresdefault', ...t });
  },
  20201(e, n, t) {
   t.d(n, { Ay: () => s });
   var a = t(86070),
   ...
   function l(e, n, t, a, r) {
    const i = { '@context': 'https://schema.org', '@type': 'VideoObject', name: r?.name || n, thumbnailUrl: [r?.thumbnailUrl || t], embedUrl: r?.embedUrl || `${a}/embed/${e}`, contentUrl: r?.contentUrl || `https://www.youtube.com/watch?v=${e}`, ...(r?.description && { description: r.description }), ...(r?.uploadDate && { uploadDate: r.uploadDate }), ...(r?.duration && { duration: r.duration }) };
    return JSON.stringify(i);
   }
   const s = r.forwardRef(function (e, n) {
    const [t, s] = r.useState(!1),
     [o, d] = r.useState(e.alwaysLoadIframe || !1),
     ...
     f = r.useMemo(() => (e.cookie ? 'https://www.youtube.com' : 'https://www.youtube-nocookie.com'), [e.cookie]),
     v = r.useMemo(() => (e.playlist ? `${f}/embed/videoseries?${j.toString()}` : `${f}/embed/${c}?${j.toString()}`), [e.playlist, f, c, j]),
     b = !e.thumbnail && !e.playlist && 'maxresdefault' === g,
     w = e.webp ? 'webp' : 'jpg',
     k = e.webp ? 'vi_webp' : 'vi',
     x = b
      ? ((e, n, t, a = 'maxresdefault') => {
         const [l, s] = (0, r.useState)('');
         return (
          (0, r.useEffect)(() => {
           const r = `https://img.youtube.com/${n}/${e}/${a}.${t}`,
      ...
      : null,
     y = r.useMemo(() => e.thumbnail || x || `https://i.ytimg.com/${k}/${e.playlist ? h : c}/${g}.${w}`, [e.thumbnail, x, k, e.playlist, h, c, g, w]),
     ...
     W = r.useCallback(e.onIframeAdded || function () {}, [e.onIframeAdded]),
    ...
    return (
     r.useEffect(() => {
      o && (W(), e.focusOnLoad && 'object' == typeof n && n?.current && n.current.focus());
     }, [o, W, e.focusOnLoad, n]),
     r.useEffect(() => {
      if (!o || !e.enableJsApi || !(e.onReady || e.onStateChange || e.onError || e.onPlay || e.onPause || e.onEnd || e.onBuffering || e.onPlaybackRateChange || e.onPlaybackQualityChange)) return;
      let t = !1,
       a = !1;
      const r = (a) => {
       ...
       switch (r.event) {
        ...
        case 'infoDelivery':
         if (void 0 !== r.info?.playerState) {
          const t = r.info.playerState;
          switch ((e.onStateChange && e.onStateChange({ state: t, currentTime: r.info.currentTime, duration: r.info.duration }), t)) {
           case 1:
            e.onPlay?.();
            break;
           case 2:
      ...
      return (
       ...
       () => {
        (window.removeEventListener('message', r), i.forEach(clearTimeout), 'object' == typeof n && n?.current && n.current.removeEventListener('load', s));
       }
      );
     }, [o, e.enableJsApi, e.onReady, e.onStateChange, e.onError, e.onPlay, e.onPause, e.onEnd, e.onBuffering, e.onPlaybackRateChange, e.onPlaybackQualityChange, e.stopOnEnd, e.id, c, u, n]),
     (0, a.jsxs)(a.Fragment, {
      children: [
       ...
       e.seo && !e.playlist && (0, a.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: l(e.id, u, y, f, e.seo) } }),
       E && !e.playlist && (0, a.jsx)('noscript', { children: (0, a.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${u} on YouTube`, children: ['Watch "', u, '" on YouTube'] }) }),
       (0, a.jsxs)(M, {
        onPointerOver: () => {
         t || s(!0);
        },
        ...
        className: `${_} ${o ? T : ''}`,
        'data-title': u,
        role: o || e.lazyLoad ? void 0 : 'img',
        'aria-label': o ? void 0 : `${u} - YouTube video preview`,
        style: { ...(!e.lazyLoad && { backgroundImage: `url(${y})` }), '--aspect-ratio': (C / z) * 100 + '%', ...(e.style || {}) },
        children: [e.lazyLoad && !o && (0, a.jsx)('img', { src: y, alt: `${u} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !o && (0, a.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && o) && (0, a.jsx)('button', { type: 'button', className: R, 'aria-label': `${p} ${u}`, 'aria-hidden': o || void 0, tabIndex: o ? -1 : 0, onClick: S, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: p }) }), o && (0, a.jsx)('iframe', { ref: n, className: L, title: u, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: v, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  28470(e, n, t) {
   ...
   var r = t(86070),
    ...
    u = t(66117),
    g = t(80598);
   const p = { title: 'WCAG-succescriterium 3.1.2 Taal van onderdelen', title_sm: '3.1.2 Taal van onderdelen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.1.2 Taal van onderdelen', pagination_label: 'WCAG-succescriterium 3.1.2 Taal van onderdelen', description: 'Als je pagina tekst bevat in een andere taal dan de hoofdtaal, geef dit dan aan. Dit kan door in het html-element waarbinnen de tekst staat het attribuut \u2018lang\u2019 mee te geven.', slug: '3.1.2', conformance_level: 'Niveau AA', keywords: ['WCAG', 'AA', 'begrijpelijk', 'leesbaar', 'understandable', 'readable', 'language of parts'] },
    m = void 0,
    j = {},
  ...
  61473(e, n, t) {
   ...
   var a = t(46447),
    r = t(46276),
    i = t(86070);
   const l = ({ children: e, conformanceLevel: n, ...t }) => (globalThis.isAstro ? null : (0, i.jsx)(r.p, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: n && (0, i.jsx)(a.KE, { className: 'nlds-inline-heading-group__badge', children: n }), ...t, children: e }));
  },
  66117(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => i });
   var a = t(86070),
  ...
  66119(e, n, t) {
   ...
   function r(e) {
    ...
    if ('string' == typeof e || 'number' == typeof e) a += e;
     ...
     if (Array.isArray(e)) {
      var i = e.length;
      for (n = 0; n < i; n++) e[n] && (t = r(e[n])) && (a && (a += ' '), (a += t));
     } else for (t in e) e[t] && (a && (a += ' '), (a += t));
    return a;
   }
   function i() {
    for (var e, n, t = 0, a = '', i = arguments.length; t < i; t++) (e = arguments[t]) && (n = r(e)) && (a && (a += ' '), (a += n));
    return a;
   }
   const l = (0, t(30758).forwardRef)(({ aside: e, children: n, className: t, purpose: r, ...l }, s) => {
    const o = { ...l, ref: s, className: i('utrecht-note', { [`utrecht-note--${r}`]: r }, t) };
    return e ? (0, a.jsx)('aside', { ...o, children: n }) : (0, a.jsx)('section', { role: 'note', ...o, children: n });
   });
   l.displayName = 'Note';
   var s = t(29181);
   const o = globalThis.isAstro ? l : s.K7;
  },
  80598(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => i });
   var a = t(86070),
