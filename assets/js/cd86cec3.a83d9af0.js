 ...
 [71134],
 {
  ...
  45282(e, t, i) {
   ...
   const l = ({ children: e, ...t }) => {
     const { to: i, href: n, ...l } = t;
     let r = i || n;
     const o = new URL(r, 'https://nldesignsystem.nl');
     return ('https://nldesignsystem.nl' === o.origin ? ((o.pathname = o.pathname.endsWith('/') ? o.pathname : `${o.pathname}/`), (r = o.toString().replace('https://nldesignsystem.nl', ''))) : ((l.target = '_blank'), (l.rel = 'noopener noreferrer')), (0, a.jsx)('a', { href: r, ...l, children: e }));
    },
    r = ({ className: e, ...t }) => (0, a.jsx)(l, { className: (0, n.$)('utrecht-link', 'utrecht-link--html-a', e), ...t });
  },
  75397(e, t, i) {
   i.d(t, { L: () => s });
   var n = i(86070),
   ...
   const o = a.forwardRef(function (e, t) {
     const [i, o] = a.useState(!1),
      ...
      j = a.useMemo(() => (e.cookie ? 'https://www.youtube.com' : 'https://www.youtube-nocookie.com'), [e.cookie]),
      x = a.useMemo(() => (e.playlist ? `${j}/embed/videoseries?${k.toString()}` : `${j}/embed/${c}?${k.toString()}`), [e.playlist, j, c, k]),
      b = !e.thumbnail && !e.playlist && 'maxresdefault' === h,
      y = e.webp ? 'webp' : 'jpg',
      f = e.webp ? 'vi_webp' : 'vi',
      v = b
       ? ((e, t, i, n = 'maxresdefault') => {
          const [r, o] = (0, a.useState)('');
          return (
           (0, a.useEffect)(() => {
            const a = `https://img.youtube.com/${t}/${e}/${n}.${i}`,
             r = `https://img.youtube.com/${t}/${e}/hqdefault.${i}`,
             s = l[n],
             d = new Image();
            ((d.onload = () => {
             d.width < s ? o(r) : o(a);
       ...
       : null,
      w = a.useMemo(() => e.thumbnail || v || `https://i.ytimg.com/${f}/${e.playlist ? p : c}/${h}.${y}`, [e.thumbnail, v, f, e.playlist, p, c, h, y]),
     ...
     return (
      ...
      (0, n.jsxs)(n.Fragment, {
       children: [
        !e.lazyLoad && (0, n.jsx)('link', { rel: S, href: w, as: 'image' }),
        (0, n.jsx)(n.Fragment, { children: i && (0, n.jsxs)(n.Fragment, { children: [(0, n.jsx)('link', { rel: 'preconnect', href: j }), (0, n.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), $ && (0, n.jsxs)(n.Fragment, { children: [(0, n.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, n.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
        e.seo && !e.playlist && (0, n.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: r(e.id, m, w, j, e.seo) } }),
        I && !e.playlist && (0, n.jsx)('noscript', { children: (0, n.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${m} on YouTube`, children: ['Watch "', m, '" on YouTube'] }) }),
        (0, n.jsxs)(U, {
         onPointerOver: () => {
          i || o(!0);
         },
         ...
         children: [e.lazyLoad && !s && (0, n.jsx)('img', { src: w, alt: `${m} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, n.jsx)('button', { type: 'button', className: E, 'aria-label': `${u} ${m}`, 'aria-hidden': s || void 0, tabIndex: s ? -1 : 0, children: (0, n.jsx)('span', { className: 'lty-visually-hidden', children: u }) }), s && (0, n.jsx)('iframe', { ref: t, className: T, title: m, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: x, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
    }),
    s = ({ id: e, title: t, ...i }) => (0, n.jsx)(o, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: t, poster: 'maxresdefault', ...i });
  },
  88666(e, t, i) {
   i.d(t, { v: () => r });
   var n = i(45282),
    a = i(13526),
    l = i(86070);
   const r = ({ appearance: e, ...t }) => (0, l.jsx)(n.F, { className: (0, a.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...t });
  },
  90495(e, t, i) {
   i.d(t, { AC: () => d, Fu: () => r, Wu: () => o, Zp: () => s });
   var n = i(46447),
    a = i(13526),
    l = i(86070);
   const r = ({ background: e, children: t, className: i, ...n }) => (0, l.jsx)('div', { className: (0, a.A)('card__illustration', e && `card__illustration--${e}`, i), ...n, children: t }),
    o = (e) => (0, l.jsx)('div', { className: 'card__content', ...e }),
    s = ({ href: e, appearance: t, className: i, component: r = 'div', background: o, children: s }) => {
     const d = (e) => ('article' === r ? (0, l.jsx)('article', { ...e }) : 'section' === r ? (0, l.jsx)('section', { ...e }) : (0, l.jsx)('div', { ...e })),
      c = (0, l.jsx)(d, { className: (0, a.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, i), children: s });
     return e ? (0, l.jsx)(n.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: c }) : c;
    },
    d = ({ appearance: e = 'medium', children: t, className: i }) => (0, l.jsx)('div', { className: (0, a.A)('cardgroup', `cardgroup--${e}`, i), children: t });
  },
 },
]);
