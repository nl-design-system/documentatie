   ...
   const b = ({ code: e, copy: l = !0, defaultExpandedCode: n = !1, displayCode: b = !0, children: j, container: x = 'document', language: y, designTokens: f }) => {
    ...
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       k && (0, h.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(F, { children: (0, h.jsx)(s.v$, { children: k }) }) }) }),
       b &&
        (0, h.jsx)('div', {
  ...
  95822(e, l, n) {
   ...
   function c({ lineNumber: e, syntax: l, textContent: n, trim: c }) {
    ...
    const { title: u, type: p } = (0, o.useContext)(t.x),
     h = (0, o.useId)();
    return (c && (d = d.trim()), (0, a.jsx)(s.f4, { theme: i, code: d, language: l || '', children: ({ style: l, tokens: n, getLineProps: s, getTokenProps: o }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, a.jsx)(r.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': h, style: l, children: n.map((l, n) => (0, a.jsxs)('span', { ...s({ line: l }), children: [e && (0, a.jsx)('span', { children: n + 1 }), l.map((e, l) => (0, a.jsx)('span', { ...o({ token: e }) }, l)), '\n'] }, n)) })] }) }));
   }
  },
  98687(e, l, n) {
