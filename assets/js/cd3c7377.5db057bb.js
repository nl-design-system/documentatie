...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [28568],
 {
  ...
  19036(e, n, t) {
   (t.r(n), t.d(n, { assets: () => G, component: () => W, contentTitle: () => R, default: () => H, description: () => S, frontMatter: () => D, issueNumber: () => L, metadata: () => i, title: () => N, toc: () => _ }));
   ...
   const y = [
     ...
     { title: 'Instructies in de Form Field Description zijn op een inclusieve manier beschreven.', sc: '1.3.3', status: '', component: w.Ay, tags: ['designer', 'contentmaker'] },
     ...
     { title: 'Als je de tekst van de Form Field Description vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: f.Ay, tags: ['developer'] },
     ...
     { title: 'De Form Field Description is niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: A.Ay, tags: ['developer'] },
     { title: 'De Form Field Description komt niet voor in de normale focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: k.Ay, tags: ['developer'] },
     { title: 'Als de Form Field Description in een andere taal is dan de taal van de pagina, dan heeft het een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: j.Ay, tags: ['developer'] },
    ],
    C = [
     {
     ...
     { title: 'De Form Field Description is standaard niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: x.Ay, tags: ['developer'] },
  ...
  21034(e, n, t) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
     const t = e && e.projects.filter((e) => j.f4.includes(e.id)),
      r = t && j.f4.map((e) => t.find((n) => n.id === e)).filter(Boolean);
     return e && (0, g.jsx)(b.n, { children: r.map((t) => (0, g.jsx)(b.K, { className: (0, a.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, j.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(f._, { children: t.tasks.map(({ checked: e, name: t, id: i }) => (0, g.jsx)(f.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, j.qZ)(i) }, i)) }), (0, g.jsx)(i.fz, { children: (0, g.jsxs)(i.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
            ...
            ? (0, g.jsx)(
               d.Z,
               {
                ...
                description: (0, g.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, g.jsxs)(o.f, { children: [(0, g.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, g.jsxs)(i.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, g.jsxs)('div', {
                   children: [
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)('section', { children: [(0, g.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, g.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, g.jsxs)(l.Wu, {
                 children: [
                  ...
                  c.length > 0 && (0, g.jsx)(g.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)(g.Fragment, { children: [(0, g.jsxs)(i.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, g.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
   ...
   const a = ({ background: e, children: n, className: t, ...i }) => (0, o.jsx)('div', { className: (0, r.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, t), ...i, children: n }),
    ...
    l = ({ href: e, appearance: n, className: t, component: a = 'div', background: s, children: l }) => {
     const d = (e) => ('article' === a ? (0, o.jsx)('article', { ...e }) : 'section' === a ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      c = (0, o.jsx)(d, { className: (0, r.A)('ma-cardgroup__card', s && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, t), children: l });
     return e ? (0, o.jsx)(i.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: c }) : c;
    },
    d = ({ appearance: e = 'large', children: n, className: t }) => (0, o.jsx)('div', { className: (0, r.A)('ma-cardgroup', `ma-cardgroup--${e}`, t), children: n });
  },
  27823(e, n, t) {
   t.d(n, { Ay: () => a });
   var i = t(86070),
  ...
  32385(e, n, t) {
   t.d(n, { bo: () => r, KF: () => g, mJ: () => h, VZ: () => k, cR: () => A, Pv: () => f, qZ: () => a, kD: () => x, QQ: () => C, B2: () => m, Pc: () => l, f4: () => s, GT: () => v, fX: () => o, eQ: () => b, B_: () => w, o_: () => j });
  ...
  40889(e, n, t) {
   ...
   var i = t(29181),
    ...
    l = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(r.A, {}), github: (0, d.jsx)(o.A, {}), npm: (0, d.jsx)(a.A, {}), storybook: (0, d.jsx)(s.A, {}) },
  ...
  70348(e, n, t) {
   ...
   const l = (0, r.forwardRef)(({ as: e, className: n, children: t, ...r }, o) => {
    ...
    d = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: l, headingApperance: d, ...c }) => {
     ...
     return (0, s.jsxs)('details', { className: u, ...c, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(o.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(a.D, { level: l, appearance: d, children: r }), t] })] }) }), (0, s.jsx)('div', { className: g, children: c.children })] });
    };
  },
  70561(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => o });
  ...
  85068(e, n, t) {
   ...
   var i = t(14277),
    r = t(86070);
   const o = (e) => (0, r.jsx)(i.D, { ...e }),
    a = (e) => (0, r.jsx)(i.D, { ...e, level: 3 });
  },
  85162(e, n, t) {
   t.d(n, { s: () => l });
   var i = t(29181),
   ...
   const s = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    l = ({ name: e, relayStep: n, description: t }) => {
     const l = (0, o.fX)(n),
      d = s[e] ?? e;
     return (0, a.jsxs)(i.WK, { children: [(0, a.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, r.A)('ma-component-illustration', `ma-component-illustration--${l}`), fill: 'none', children: [(0, a.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, a.jsx)('rect', { width: '960', height: '540' }), (0, a.jsx)('rect', { width: '960', height: '540' })] }), (0, a.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, a.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, a.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, a.jsx)('use', { href: `/svg/componenten_overzicht_${(0, o.fX)(d)}.svg#component-illustration` })] }), (0, a.jsx)(i.$P, { className: 'ma-component-illustration__caption', children: t })] });
    };
  },
  88166(e, n, t) {
   t.d(n, { Z: () => i.Z });
   ...
   var u = function (e) {
    ...
    m =
     ...
     (0, s.forwardRef)(function (e, n) {
      ...
      return (0, o.jsxs)('button', c(c({ ref: n, type: v, className: (0, a.$)('nl-button', i, { 'nl-button--pressed': w, 'nl-button--busy': b, 'nl-button--disabled': f || j, 'nl-button--primary': 'primary' === p, 'nl-button--secondary': 'secondary' === p, 'nl-button--subtle': 'subtle' === p, 'nl-button--positive': g(p) && 'positive' === h, 'nl-button--negative': g(p) && 'negative' === h, 'nl-button--icon-only': d }), 'aria-pressed': k ? String(Boolean(w)) : void 0, 'aria-disabled': f || b ? 'true' : void 0, disabled: j }, y), {}, { children: [m && (0, o.jsx)('span', { className: 'nl-button__icon-start', children: m }), A && (0, o.jsx)('span', { className: 'nl-button__label', children: A }), T ? (0, o.jsx)('span', { className: d ? 'nl-button__label' : '', children: t }) : t, u && (0, o.jsx)('span', { className: 'nl-button__icon-end', children: u })] }));
     }));
