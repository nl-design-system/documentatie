...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [50718],
 {
  ...
  43599: (e, n, o) => {
   ...
   const y = (e) => {
    let { code: n, copy: o = !0, defaultExpandedCode: y = !1, displayCode: j = !0, children: g, container: x = 'document', language: f, designTokens: k } = e,
    ...
    (0, p.useEffect)(() => {
     (async () => {
      (z = await d.ZP.format(N, { parser: f, plugins: [t.Z, i.ZP, c.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(z);
     })();
    }, [N]);
    const S = (0, p.useId)();
    let F = p.Fragment;
    return (
     'paragraph' === x ? (F = h) : 'document' === x ? (F = b) : 'surface' === x && (F = v),
     (0, m.jsxs)('div', {
      className: (0, s.Z)('nlds-canvas'),
      children: [
       _ && (0, m.jsx)('div', { className: (0, s.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(F, { children: (0, m.jsx)(r.pu, { children: _ }) }) }) }),
       j &&
        (0, m.jsx)('div', {
