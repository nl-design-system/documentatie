 ...
 [97979],
 {
  17687: (e, t, n) => {
   ...
   const s = { title: 'Textarea', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Textarea', pagination_label: 'Textarea', description: ' ', slug: '/textarea', sidebar_custom_props: { illustration: 'TextAreaSketch' } },
    a = void 0,
    u = { id: 'componenten/textarea/index', title: 'Textarea', description: ' ', source: '@site/docs/componenten/textarea/index.mdx', sourceDirName: 'componenten/textarea', slug: '/textarea', permalink: '/textarea', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/textarea/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Textarea', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Textarea', pagination_label: 'Textarea', description: ' ', slug: '/textarea', sidebar_custom_props: { illustration: 'TextAreaSketch' } }, sidebar: 'componenten', previous: { title: 'Text input group', permalink: '/text-input-group' }, next: { title: 'Toggletip', permalink: '/toggletip' } },
    l = {},
    d = [
