...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [7049],
 {
  ...
  73460: (e, n, l) => {
   ...
   const v = (e) => {
    let { code: n, copy: l = !1, defaultExpandedCode: v = !0, displayCode: k = !0, children: x, container: f = "document", language: y, designTokens: _ } = e,
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (L = await d.ZP.format(N, { parser: y, plugins: [t.Z, s.ZP, a.ZP, o.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), Z(L);
     })();
    }, [N]);
    const D = (0, c.useId)();
    let C = c.Fragment;
  ...
  30036: (e, n, l) => {
   ...
   const d = (e) => {
    ...
    const h = "Doen",
     ...
     m = p ? "figure" : "div",
     b = p ? "figcaption" : "div";
    return (0, o.jsxs)(m, { className: (0, s.Z)(a["nlds-guideline"], a[`nlds-guideline--${l}`]), id: "string" == typeof n ? n?.toLowerCase().replace(/\s/g, "-") : void 0, children: [(0, o.jsxs)(b, { className: (0, s.Z)(a["nlds-guideline__description"]), children: ["dont" === l ? (0, o.jsxs)(o.Fragment, { children: [(0, o.jsxs)(t.nv, { className: (0, s.Z)(a["nlds-guideline__badge"], a[`nlds-guideline__badge--${l}`]), children: [(0, o.jsx)(i.Z, { className: a["nlds-guideline__icon"] }), (0, o.jsx)("span", { className: a["nlds-guideline__title"], children: u })] }), (0, o.jsx)(t.nv, { children: n })] }) : (0, o.jsxs)(o.Fragment, { children: [(0, o.jsxs)(t.nv, { className: (0, s.Z)(a["nlds-guideline__badge"], a[`nlds-guideline__badge--${l}`]), children: [(0, o.jsx)(r.Z, { className: a["nlds-guideline__icon"] }), (0, o.jsx)("span", { className: a["nlds-guideline__title"], children: h })] }), (0, o.jsx)(t.nv, { children: n })] }), d] }), (0, o.jsx)("div", { className: (0, s.Z)(a["nlds-guideline__example"]), children: c })] });
   };
  },
  47214: (e, n, l) => {
   l.d(n, { Z: () => a, a: () => s });
