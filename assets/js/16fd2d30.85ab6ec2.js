(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [32139],
 {
  ...
  12761(e, a, n) {
   ...
   var v = n(96345),
    q = n(37168);
   const f = ({ className: e, ...a }) => {
     const n = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', e);
     return (0, d.jsx)('div', { className: n, children: a.children });
    },
    b = ({ className: e, heading: a, headingLevel: n, headingApperance: t, ...i }) => {
     const s = (0, l.A)('utrecht-accordion__section', e);
     return (0, d.jsxs)('details', { className: s, ...i, children: [(0, d.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, d.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, d.jsx)('span', { className: 'nl-button__icon-start', children: (0, d.jsx)(v.A, {}) }), (0, d.jsx)('span', { className: 'nl-button__label', children: (0, d.jsx)(q.D, { level: n, appearance: t, children: a }) })] }) }), (0, d.jsx)('div', { className: 'utrecht-accordion__panel', children: i.children })] });
    },
    ...
    T = ({ component: e, headingLevel: a, description: n }) => {
  ...
  26356(e, a, n) {
   'use strict';
   (n.r(a), n.d(a, { assets: () => k, component: () => F, contentTitle: () => x, default: () => A, description: () => T, frontMatter: () => b, issueNumber: () => D, metadata: () => t, title: () => j, toc: () => N }));
   ...
   function A(e = {}) {
    ...
    return a ? (0, u.jsx)(a, { ...e, children: (0, u.jsx)(H, { ...e }) }) : H(e);
   }
  },
  26655(e, a, n) {
   'use strict';
   ...
   const s = ({ background: e, children: a, className: n, ...t }) => (0, i.jsx)('div', { className: (0, l.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, n), ...t, children: a }),
    ...
    d = ({ appearance: e = 'large', children: a, className: n }) => (0, i.jsx)('div', { className: (0, l.A)('ma-cardgroup', `ma-cardgroup--${e}`, n), children: a });
  },
  31522(e, a, n) {
   'use strict';
   n.d(a, { D: () => o });
  ...
  76097(e, a, n) {
   'use strict';
   n.d(a, { bo: () => l, KF: () => m, mJ: () => p, VZ: () => T, cR: () => j, Pv: () => v, qZ: () => s, kD: () => x, B2: () => c, Pc: () => r, f4: () => o, GT: () => k, fX: () => i, eQ: () => b, B_: () => f, o_: () => q });
   ...
   function k(e) {
    const a = new Map();
    function n(e) {
     return (a.has(e) || a.set(e, q(e)), a.get(e));
    }
