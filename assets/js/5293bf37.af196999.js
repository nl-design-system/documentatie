 ...
 [66004],
 {
  ...
  82415: (e, n, t) => {
   ...
   var i = t(19696),
    ...
    l = t(52676);
   const d = (e) => {
    let { listId: n = '', laPostaId: t = '', thanksPage: d = '', emailFieldId: o = '', firstNameFieldId: m = '', orgId: c = '', interestsId: h = '', interestsLegend: u = 'Waar wil je NL Design System voor gebruiken?', interests: g = [], disallowedInterestValues: p = [], workAreasId: v = '', privacyPolicyId: j = '', language: x, submitText: f = '', talkTitleId: y = '', talkDescriptionId: k = '' } = e;
    const {
      register: b,
      handleSubmit: w,
      formState: { errors: D },
