 ...
 [30023],
 {
   ...
   const d = (0, a.createContext)({}),
    u = ({ title: e, appearance: n, description: t, children: a, figure: u }) => {
     const p = { do: 'Doen', dont: 'Niet doen' },
      b = u ? 'figure' : 'div',
      m = u ? 'figcaption' : 'div',
      h = 'string' == typeof t ? (0, i.jsx)(c.oz, { components: { a: s.N_ }, children: t }) : t;
  ...
  70348(e, n, t) {
   ...
   const c = ({ className: e, ...n }) => {
    ...
    a = ({ className: e, classNamePanel: n, label: t, heading: c, headingLevel: a, headingApperance: i, ...d }) => {
     const u = (0, o.A)('utrecht-accordion__section', e),
      p = (0, o.A)('utrecht-accordion__panel', n);
     return (0, r.jsxs)('details', { className: u, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(l.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [c && (0, r.jsx)(s.D, { level: a, appearance: i, children: c }), t] })] }) }), (0, r.jsx)('div', { className: p, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => x });
