...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [64279],
 {
  ...
  18381: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => b, contentTitle: () => p, default: () => j, frontMatter: () => h, metadata: () => m, toc: () => v });
   var t = l(52676),
    o = l(24785),
    r = l(55400),
    s = l(43599),
  ...
  43599: (e, n, l) => {
   ...
   const g = (e) => {
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (Z = await d.ZP.format(N, { parser: f, plugins: [s.Z, i.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), z(Z);
     })();
    }, [N]);
    const D = (0, u.useId)();
    let S = u.Fragment;
    return (
     ...
     (0, p.jsxs)('div', {
      ...
      children: [
       _ && (0, p.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, p.jsx)(S, { children: (0, p.jsx)(t.pu, { children: _ }) }) }) }),
       j &&
        (0, p.jsx)('div', {
       ...
       j &&
        (0, p.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, p.jsx)(o.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: Z, trim: !0 }),
          l &&
           (0, p.jsx)('div', {
    ...
    return (
     ...
     (0, a.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, a.jsx)(t.dn, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': m, style: l, children: o.map((e, l) => (0, a.jsxs)('span', { ...r({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
