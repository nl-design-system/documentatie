 ...
 [87122],
 {
  14881(e, n, t) {
   ...
   var l = t(13526),
    ...
    s = t(37168),
    a = t(86070);
   const i = (0, r.forwardRef)(({ as: e, className: n, children: t, ...r }, o) => {
     const s = e || 'div',
      i = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(s, { ref: o, className: i, ...r, children: t });
    }),
    c = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: i, headingApperance: c, ...d }) => {
     const h = (0, l.A)('utrecht-accordion__section', e),
      u = (0, l.A)('utrecht-accordion__panel', n);
     return (0, a.jsxs)('details', { className: h, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(o.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [r && (0, a.jsx)(s.D, { level: i, appearance: c, children: r }), t] })] }) }), (0, a.jsx)('div', { className: u, children: d.children })] });
    };
  },
  15258(e, n, t) {
  ...
  28369(e, n, t) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: t, trim: c }) {
    let d = t;
    const { title: h, type: u } = (0, o.useContext)(s.x),
     k = (0, o.useId)();
    return (c && (d = d.trim()), (0, i.jsx)(r.f4, { theme: a, code: d, language: n || '', children: ({ style: n, tokens: t, getLineProps: r, getTokenProps: o }) => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: k, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, i.jsx)(l.NG, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': k, style: n, children: t.map((n, t) => (0, i.jsxs)('span', { ...r({ line: n }), children: [e && (0, i.jsx)('span', { children: t + 1 }), n.map((e, n) => (0, i.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, t)) })] }) }));
   }
  },
  38953(e, n, t) {
   t.d(n, { H: () => y });
   ...
   const v = ({ children: e }) => (0, j.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(r.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const y = globalThis.isAstro
    ? ({ language: e, className: n, code: t = '<p>No code provided</p>', rawCode: l, copyCode: r, defaultExpandedCode: s, designTokens: a }) => {
       const i = 'string' == typeof t ? t : l || '',
        c = 'string' == typeof t ? g().highlight(t, g().languages[e], e) : g().highlight(l || '', g().languages[e], e);
       return (0, j.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', n), children: [(0, j.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: a, children: (0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: i } }) }), (0, j.jsx)(p.n, { children: (0, j.jsxs)(p.K, { label: 'Code', open: s, children: [(0, j.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: c } }) }), 'allow' === r && (0, j.jsx)(m.$, { 'data-copy-code': i, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: k = !0, children: g, container: p = 'document', language: m, designTokens: y }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: m, plugins: [s.A, a.Ay, i.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         w(e);
        })();
       }, [N]);
       const K = (0, h.useId)();
       let S = h.Fragment;
       return (
        'paragraph' === p ? (S = b) : 'document' === p ? (S = v) : 'surface' === p && (S = x),
        (0, j.jsxs)('div', {
         className: (0, o.A)('nlds-canvas'),
         children: [
          f && (0, j.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, j.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, j.jsx)(S, { children: (0, j.jsx)(r.v$, { children: f }) }) }) }),
          k &&
           (0, j.jsx)('div', {
          ...
          k &&
           (0, j.jsxs)('div', {
            ...
            hidden: !C,
            children: [
             (0, j.jsx)(l.M, { codeBlockLabel: 'Codevoorbeeld', syntax: m, textContent: z, trim: !0 }),
             n &&
              (0, j.jsx)('div', {
