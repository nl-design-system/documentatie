...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [97824],
 {
  ...
  23412: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => g, contentTitle: () => d, default: () => u, frontMatter: () => r, metadata: () => c, toc: () => m });
   var l = t(52676),
    a = t(40139),
    i = t(43599),
    s = t(40761),
  ...
  43599: (e, n, t) => {
   ...
   const v = (e) => {
    ...
    (0, g.useEffect)(() => {
     (async () => {
      const e = await c.ZP.format(z, { parser: y, plugins: [s.Z, o.ZP, r.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      A(e);
     })();
    }, [z]);
    const S = (0, g.useId)();
