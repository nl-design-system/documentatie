...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [48158],
 {
  ...
  4149: (e, n, a) => {
   a.r(n), a.d(n, { assets: () => d, contentTitle: () => i, default: () => v, frontMatter: () => r, metadata: () => s, toc: () => c });
   var o = a(52676),
    t = a(40139),
    l = (a(43599), a(40761), a(66968));
   const r = { title: 'Gebarentaal \xb7 Content \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Gebarentaal', pagination_label: 'Gebarentaal', description: "Richtlijnen voor gebarentaal bij video's binnen NL Design System", slug: '/richtlijnen/content/video/gebarentaal', keywords: ['video', 'YouTube', 'Vimeo', 'gebarentaal', 'sign language', 'gebaren tolk', 'Nederlandse gebarentaal', 'NGT', 'Nederlands met Gebaren', 'NmG', 'tolk'] },
    i = 'Video met gebarentaal',
    s = { id: 'richtlijnen/content/video/gebarentaal', title: 'Gebarentaal \xb7 Content \xb7 Richtlijnen', description: "Richtlijnen voor gebarentaal bij video's binnen NL Design System", source: '@site/docs/richtlijnen/content/video/gebarentaal.md', sourceDirName: 'richtlijnen/content/video', slug: '/richtlijnen/content/video/gebarentaal', permalink: '/richtlijnen/content/video/gebarentaal', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/content/video/gebarentaal.md', tags: [], version: 'current', frontMatter: { title: 'Gebarentaal \xb7 Content \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Gebarentaal', pagination_label: 'Gebarentaal', description: "Richtlijnen voor gebarentaal bij video's binnen NL Design System", slug: '/richtlijnen/content/video/gebarentaal', keywords: ['video', 'YouTube', 'Vimeo', 'gebarentaal', 'sign language', 'gebaren tolk', 'Nederlandse gebarentaal', 'NGT', 'Nederlands met Gebaren', 'NmG', 'tolk'] }, sidebar: 'richtlijnen', previous: { title: 'Flitsen', permalink: '/richtlijnen/content/video/flitsen' }, next: { title: 'Ondertiteling', permalink: '/richtlijnen/content/video/ondertiteling' } },
    d = {},
    c = [
     ...
     { value: 'Automatisch gegenereerde gebarentaal', id: 'automatisch-gegenereerde-gebarentaal', level: 2 },
  ...
  43599: (e, n, a) => {
   ...
   const h = (e) => {
    let { children: n } = e;
    return (0, b.jsx)(t.Tg, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(t.BB, { className: (0, l.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, b.jsx)(t.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   h.displayName = 'ParagraphContainer';
   const p = (e) => {
    let { children: n } = e;
    return (0, b.jsx)(t.Tg, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(t.BB, { className: (0, l.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   p.displayName = 'DocumentContainer';
   const m = (e) => {
    let { children: n } = e;
    return (0, b.jsx)(t.Tg, { className: 'nlds-canvas__example-surface', children: n });
   };
   m.displayName = 'SurfaceContainer';
   const u = (e) => {
    let { code: n, copy: a = !0, defaultExpandedCode: u = !1, displayCode: j = !0, children: k, container: y = 'document', language: x, designTokens: f } = e;
    const _ = 'function' == typeof k ? k() : k,
     w = 'function' == typeof n ? n() : (0, g.isValidElement)(n) ? n : void 0,
     N = 'string' == typeof n ? n : v.uS(w || _),
     [z, G] = (0, g.useState)(N),
     [C, Z] = (0, g.useState)(u);
    (0, g.useEffect)(() => {
     (async () => {
      const e = await c.ZP.format(N, { parser: x, plugins: [r.Z, i.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      G(e);
     })();
    }, [N]);
    const D = (0, g.useId)();
    let S = g.Fragment;
    return (
     'paragraph' === y ? (S = h) : 'document' === y ? (S = p) : 'surface' === y && (S = m),
     (0, b.jsxs)('div', {
      className: (0, l.Z)('nlds-canvas'),
      children: [
       _ && (0, b.jsx)('div', { className: (0, l.Z)('nlds-canvas__example'), children: (0, b.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, b.jsx)(S, { children: (0, b.jsx)(t.pu, { children: _ }) }) }) }),
       j &&
        (0, b.jsx)('div', {
       ...
       j &&
        (0, b.jsxs)('div', {
         className: (0, l.Z)('nlds-canvas__code-block', !a && 'nlds-canvas__code-block--user-select-none'),
         id: D,
         hidden: !C,
         children: [
          (0, b.jsx)(o.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: z, trim: !0 }),
          a &&
           (0, b.jsx)('div', {
  ...
  41179: (e, n, a) => {
   ...
   var s = a(52676);
   function d(e) {
    let { lineNumber: n, syntax: a, textContent: d, trim: c } = e,
     g = d;
    const { title: v, type: b } = (0, l.useContext)(r.n),
     h = (0, l.useId)();
    return (
     c && (g = g.trim()),
     (0, s.jsx)(t.y$, {
      ...
      language: a || '',
      children: (e) => {
       let { style: a, tokens: t, getLineProps: l, getTokenProps: r } = e;
       return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', b ? `\u201c${b}\u201d` : '', ' ', v ? ': ' : ' ', v] }), (0, s.jsx)(o.dn, { tabIndex: 0, role: v ? 'region' : void 0, 'aria-labelledby': h, style: a, children: t.map((e, a) => (0, s.jsxs)('span', { ...l({ line: e }), children: [n && (0, s.jsx)('span', { children: a + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, a)) })] });
      },
     })
    );
   }
  ...
  40761: (e, n, a) => {
   ...
   const d = (0, i.createContext)({}),
    c = (e) => {
     let { title: n, appearance: a, description: i, children: c, figure: g } = e;
     const v = { do: 'Doen', dont: 'Niet doen' },
      b = g ? 'figure' : 'div',
      h = g ? 'figcaption' : 'div';
     return (0, s.jsxs)(b, { className: (0, r.Z)('nlds-guideline', `nlds-guideline--${a}`), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, s.jsxs)(h, { className: 'nlds-guideline__description', children: ['dont' === a ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(l.nv, { className: (0, r.Z)('nlds-guideline__badge', `nlds-guideline__badge--${a}`), children: [(0, s.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: v.dont })] }), (0, s.jsx)(l.nv, { children: n })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(l.nv, { className: (0, r.Z)('nlds-guideline__badge', `nlds-guideline__badge--${a}`), children: [(0, s.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: v.do })] }), (0, s.jsx)(l.nv, { children: n })] }), i] }), (0, s.jsx)('div', { className: 'nlds-guideline__example', children: (0, s.jsx)(d.Provider, { value: { title: n, type: v[a] }, children: c }) })] });
    };
  },
  40139: (e, n, a) => {
   a.d(n, { Z: () => i, a: () => r });
