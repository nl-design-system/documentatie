/*! For license information please see 6a94b0c3.a100f712.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [59071],
 {
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => w, cR: () => N, Pv: () => f, qZ: () => l, kD: () => j, QQ: () => F, B2: () => m, Pc: () => o, f4: () => s, GT: () => k, fX: () => i, eQ: () => v, B_: () => b, o_: () => x });
  ...
  85684(e, n, a) {
   ...
   const o = { title: 'Form Field', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form Field', pagination_label: 'Form Field', description: 'Een invoerveld en bijbehorende onderdelen die helpen bij het invullen.', issue_number: 176, slug: '/form-field', keywords: ['description', 'field', 'form', 'form field', 'form field description', 'form field label', 'form input', 'formulier', 'formulierveld', 'input', 'input field', 'invoerveld', 'label', 'tekstveld', 'textbox', 'text field', 'text input', 'veld'] },
    ...
    g = {},
    c = 'Form Field',
    u = 'Een invoerveld en bijbehorende onderdelen die helpen bij het invullen.',
    m = 176,
