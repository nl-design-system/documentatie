 ...
 [81733],
 {
  ...
  8340: (e, n, t) => {
   ...
   var o = t(52676),
    ...
    i = t(40761);
   function a(e) {
    const n = { button: 'button', form: 'form', label: 'label', option: 'option', select: 'select', ...(0, r.a)(), ...e.components };
  ...
  43599: (e, n, t) => {
   ...
   const j = (e) => {
    let { code: n, copy: t = !0, defaultExpandedCode: j = !1, displayCode: g = !0, children: y, container: f = 'document', language: x, designTokens: k } = e,
    ...
    (0, u.useEffect)(() => {
     (async () => {
      (z = await d.ZP.format(N, { parser: x, plugins: [s.Z, i.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(z);
     })();
    }, [N]);
    const B = (0, u.useId)();
    let P = u.Fragment;
    return (
     'paragraph' === f ? (P = p) : 'document' === f ? (P = v) : 'surface' === f && (P = b),
     (0, h.jsxs)('div', {
      className: (0, l.Z)('nlds-canvas'),
      children: [
       _ && (0, h.jsx)('div', { className: (0, l.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, h.jsx)(P, { children: (0, h.jsx)(o.pu, { children: _ }) }) }) }),
       g &&
        (0, h.jsx)('div', {
