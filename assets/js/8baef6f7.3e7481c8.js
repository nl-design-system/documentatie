...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [41102],
 {
  ...
  37131(e, n, i) {
   ...
   const g = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    ...
    k = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(t.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, c.jsxs)(t.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, c.jsxs)(t.Xy, { children: [o ? (0, c.jsxs)(t.Er, { children: ['Vul de ', (0, c.jsx)(t.N_, { href: o, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, c.jsxs)(t.Er, { children: [(0, c.jsxs)(t.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, c.jsxs)(t.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, c.jsx)(t.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, c.jsx)(t.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    ...
    f = ({ component: e }) => {
     const n = (e && g[e.title]) || [];
     return n.length > 0 && (0, c.jsxs)(t.fz, { children: ['Gerelateerde componenten:', ' ', n.map((e, i) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(t.N_, { href: `/${e.toLowerCase().replaceAll(' ', '-')}/`, children: e }), i < n.length - 1 ? ', ' : '.'] }))] });
    };
  },
  40808(e, n, i) {
   i.d(n, { Ay: () => s, RM: () => r });
  ...
  58617(e, n, i) {
   (i.r(n), i.d(n, { assets: () => S, component: () => M, contentTitle: () => L, default: () => V, description: () => F, frontMatter: () => R, issueNumber: () => I, metadata: () => t, title: () => C, toc: () => G }));
   ...
   const D = [
     ...
     { title: 'Als een icon een status aangeeft, is die informatie niet alleen afhankelijk van kleur.', sc: '1.4.1', status: '', component: A.Ay, tags: ['designer'] },
     {
