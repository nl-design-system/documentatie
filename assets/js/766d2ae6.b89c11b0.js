 ...
 [28360],
 {
  ...
  43599: (e, n, t) => {
   ...
   const f = (e) => {
    ...
    (0, m.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(Z, { parser: x, plugins: [s.Z, i.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [Z]);
    const z = (0, m.useId)();
