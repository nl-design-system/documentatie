/*! For license information please see 25ab1beb.d55a6aae.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [95081],
 {
  46695: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => d, contentTitle: () => l, default: () => c, frontMatter: () => o, metadata: () => a, toc: () => m });
   var s = i(52676),
    t = i(40139),
    r = i(97233);
  ...
  97233: (e, n, i) => {
   ...
   const r = (e) => {
    ...
    return (0, t.jsx)(s.Z, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: n, title: i, poster: 'maxresdefault', ...r });
   };
  },
  40139: (e, n, i) => {
   i.d(n, { Z: () => l, a: () => o });
  ...
  84263: (e, n, i) => {
   ...
   var o = s.forwardRef(function (e, n) {
    var i = s.useState(!1),
     o = i[0],
     l = i[1],
     a = s.useState(e.alwaysLoadIframe || !1),
     d = a[0],
     m = a[1],
     ...
     g = new URLSearchParams(t(t(t(t({}, e.muted ? { mute: '1' } : {}), k ? { autoplay: '1' } : {}), e.enableJsApi ? { enablejsapi: '1' } : {}), e.playlist ? { list: u } : {}));
    e.params &&
    ...
    var y = e.playlist ? ''.concat(v, '/embed/videoseries?').concat(g.toString()) : ''.concat(v, '/embed/').concat(u, '?').concat(g.toString()),
     b = !e.thumbnail && !e.playlist && 'maxresdefault' === j,
     f = e.webp ? 'webp' : 'jpg',
     w = e.webp ? 'vi_webp' : 'vi',
     x = b
      ? (function (e, n, i, t) {
    ...
    return (
     ...
     s.createElement(
      s.Fragment,
      null,
      s.createElement('link', { rel: I, href: C, as: 'image' }),
      s.createElement(s.Fragment, null, o && s.createElement(s.Fragment, null, s.createElement('link', { rel: 'preconnect', href: v }), s.createElement('link', { rel: 'preconnect', href: 'https://www.google.com' }), z && s.createElement(s.Fragment, null, s.createElement('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), s.createElement('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })))),
      s.createElement(
       _,
       {
        ...
        className: ''.concat(E, ' ').concat(d ? R : ''),
        'data-title': h,
        style: t(t({ backgroundImage: 'url('.concat(C, ')') }, { '--aspect-ratio': ''.concat((S / D) * 100, '%') }), F),
       },
       s.createElement('button', { type: 'button', className: L, 'aria-label': ''.concat(p, ' ').concat(h) }),
       d && s.createElement('iframe', { ref: n, className: H, title: h, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: y }),
      ),
     )
    );
   });
