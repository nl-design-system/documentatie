 ...
 [4206],
 {
  ...
  98480: (e, n, l) => {
   ...
   const b = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (C = await a.ZP.format(Z, { parser: x, plugins: [s.Z, i.ZP, r.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), F(C);
     })();
    }, [Z]);
    const z = (0, d.useId)();
    let D = d.Fragment;
  ...
  41179: (e, n, l) => {
   ...
   function a(e) {
    let { lineNumber: n, syntax: l, textContent: a, trim: d } = e,
     u = a;
    const { title: p, type: m } = (0, s.useContext)(i.n),
     h = (0, s.useId)();
    return (
     d && (u = u.trim()),
     (0, c.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, c.jsx)(t.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': h, style: l, children: o.map((e, l) => (0, c.jsxs)('span', { ...s({ line: e }), children: [n && (0, c.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, c.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
   ...
   const d = (0, r.createContext)({}),
    u = (e) => {
     ...
     const m = { do: 'Doen', dont: 'Niet doen' },
      h = p ? 'figure' : 'div',
      v = p ? 'figcaption' : 'div';
     return (0, a.jsxs)(h, { className: (0, i.Z)(c['nlds-guideline'], c[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(v, { className: (0, i.Z)(c['nlds-guideline__description']), children: ['dont' === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(s.nv, { className: (0, i.Z)(c['nlds-guideline__badge'], c[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: c['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: c['nlds-guideline__title'], children: m.dont })] }), (0, a.jsx)(s.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(s.nv, { className: (0, i.Z)(c['nlds-guideline__badge'], c[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: c['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: c['nlds-guideline__title'], children: m.do })] }), (0, a.jsx)(s.nv, { children: n })] }), r] }), (0, a.jsx)('div', { className: (0, i.Z)(c['nlds-guideline__example']), children: (0, a.jsx)(d.Provider, { value: { title: n, type: m[l] }, children: u }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => i });
