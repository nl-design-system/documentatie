 ...
 [606],
 {
  ...
  3460: (e, n, l) => {
   ...
   const g = (e) => {
    ...
    b = (e) => {
     let { code: n, copy: l = !1, defaultCollapsed: b = !0, children: v, language: x, designTokens: k } = e,
     ...
     (0, c.useEffect)(() => {
      (async () => {
       (w = await d.ZP.format(_, { parser: x, plugins: [t.Z, o.ZP, a.ZP, s.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), z(w);
      })();
     }, [_]);
     const D = (0, u.Z)();
     return (0, m.jsxs)("div", {
      ...
      children: [
       f && (0, m.jsx)("div", { className: (0, r.Z)(j["nlds-canvas__example"]), children: (0, m.jsx)(i.pu, { className: "voorbeeld-theme", style: k, children: f }) }),
       (0, m.jsx)("div", { className: (0, r.Z)(j["nlds-canvas__toolbar"]), children: (0, m.jsx)(i.zx, { className: (0, r.Z)(j["nlds-canvas__button"], j["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: g, "aria-expanded": !b, "aria-controls": D, children: b ? "Bekijk code" : "Verberg code" }) }),
       (0, m.jsxs)("div", {
        className: (0, r.Z)(j["nlds-canvas__code-block"], !l && j["nlds-canvas__code-block--user-select-none"]),
        id: D,
        hidden: b,
        children: [
         (0, m.jsx)(p.u, { syntax: x, textContent: w, trim: !0 }),
         l &&
          (0, m.jsx)("div", {
