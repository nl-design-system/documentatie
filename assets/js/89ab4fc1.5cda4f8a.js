/*! For license information please see 89ab4fc1.5cda4f8a.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [9289],
 {
  ...
  18439(e, n, t) {
   ...
   function o(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(i) : e.components || i) : r(e.components)), a.createElement(s.Provider, { value: n }, e.children));
   }
  },
  18652(e, n, t) {
   t.d(n, { A: () => s });
   ...
   const s = (e, n, t, s) => {
    const r = (0, a.forwardRef)(({ color: t = 'currentColor', size: r = 24, stroke: o = 2, title: l, className: d, children: c, ...m }, p) => (0, a.createElement)('svg', { ref: p, ...i[e], width: r, height: r, className: ['tabler-icon', `tabler-icon-${n}`, d].join(' '), ...('filled' === e ? { fill: t } : { strokeWidth: o, stroke: t }), ...m }, [l && (0, a.createElement)('title', { key: 'svg-title' }, l), ...s.map(([e, n]) => (0, a.createElement)(e, n)), ...(Array.isArray(c) ? c : [c])]));
  ...
  19472(e, n, t) {
   ...
   var a = t(20201),
    i = t(86070);
   const s = ({ id: e, title: n, ...t }) => (0, i.jsx)(a.Ay, { lazyLoad: !0, adNetwork: !1, announce: 'Bekijk', cookie: !1, containerElement: 'div', id: e, title: n, poster: 'maxresdefault', ...t });
  },
  20201(e, n, t) {
   t.d(n, { Ay: () => o });
   var a = t(86070),
   ...
   function r(e, n, t, a, i) {
    const s = { '@context': 'https://schema.org', '@type': 'VideoObject', name: i?.name || n, thumbnailUrl: [i?.thumbnailUrl || t], embedUrl: i?.embedUrl || `${a}/embed/${e}`, contentUrl: i?.contentUrl || `https://www.youtube.com/watch?v=${e}`, ...(i?.description && { description: i.description }), ...(i?.uploadDate && { uploadDate: i.uploadDate }), ...(i?.duration && { duration: i.duration }) };
   ...
   const o = i.forwardRef(function (e, n) {
    const [t, o] = i.useState(!1),
     ...
     y = v
      ...
      : null,
     x = i.useMemo(() => e.thumbnail || y || `https://i.ytimg.com/${w}/${e.playlist ? m : c}/${g}.${f}`, [e.thumbnail, y, w, e.playlist, m, c, g, f]),
     ...
     T = i.useCallback(e.onIframeAdded || function () {}, [e.onIframeAdded]),
     ...
     (0, a.jsxs)(a.Fragment, {
      children: [
       ...
       (0, a.jsxs)(_, {
        ...
        children: [e.lazyLoad && !l && (0, a.jsx)('img', { src: x, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !l && (0, a.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && l) && (0, a.jsx)('button', { type: 'button', className: N, 'aria-label': `${h} ${p}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, onClick: P, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: h }) }), l && (0, a.jsx)('iframe', { ref: n, className: O, title: p, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: j, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  24456(e, n, t) {
   ...
   const r = ({ children: e, ...n }) => {
    ...
    o = ({ className: e, ...n }) => (0, s.jsx)(r, { className: (0, a.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  24658(e, n, t) {
   t.d(n, { H: () => d });
   var a = t(90578),
   ...
   const l = new Date().toISOString(),
    d = ({ lang: e = 'nl', headingLevel: n = 3, allSpeakers: t, videoId: d, children: c, allSessions: m, sessionId: p }) => {
     ...
     return g ? (0, o.jsxs)('article', { className: (0, s.A)('ma-dsw-session'), children: [(0, o.jsx)(i.DZ, { level: n, className: 'ma-dsw-session__title', id: g.subject.toLowerCase().replace(/\s/gi, '-'), children: g.subject }), (0, o.jsx)(i.fz, { className: 'ma-dsw-session__subtitle', lead: !0, children: h && h.map((e) => (e?.organisation ? `${e.name} - ${e.organisation}` : e.name)).join(' & ') }), u.length > 0 && u.map((e) => (0, o.jsx)(r.L, { id: e, title: g.subject, style: { marginBlock: '20px' } }, e)), g && g.isoDateTime && g.isoDateTime > l ? (0, o.jsx)(i.fz, { children: (0, o.jsx)('time', { dateTime: g.isoDateTime, children: new Intl.DateTimeFormat(e, { dateStyle: 'full', timeStyle: 'nl' === e ? 'short' : 'full', timeZone: 'Europe/Amsterdam' }).format(new Date(g.isoDateTime)) }) }) : (0, o.jsx)(o.Fragment, {}), c, 'nl' === e && h.find(({ language: e }) => 'nl' !== e) && (0, o.jsxs)(i.fz, { children: [(0, o.jsx)('b', { children: 'Goed te weten:' }), ' Deze sessie is in het Engels.'] }), g.captioned ? (g.captionId ? (0, o.jsx)(o.Fragment, { children: (0, o.jsxs)(i.fz, { children: ['nl' === e ? (0, o.jsx)(o.Fragment, { children: (0, o.jsx)('b', { children: 'Bij deze sessie is een schrijftolk aanwezig: ' }) }) : (0, o.jsx)(o.Fragment, { children: (0, o.jsx)('b', { children: 'Live captioning is available for this session: ' }) }), (0, o.jsxs)('a', { href: `https://text-on-tap.live/#e=${g.captionId}`, children: [(0, o.jsxs)('span', { className: 'sr-only', children: [g.subject, ' '] }), 'nl' === e ? 'in de browser' : 'in the browser'] }), 'nl' === e ? ' of ' : ' or ', (0, o.jsxs)('a', { href: `https://text-on-tap.live/openoverlay.html?e=${g.captionId}`, children: [(0, o.jsxs)('span', { className: 'sr-only', children: [g.subject, ' '] }), 'nl' === e ? 'met de Overlay tool' : 'with the de Overlay tool'] })] }) }) : 'nl' === e ? (0, o.jsx)(i.fz, { children: 'Voor deze sessie hebben we nog geen schrijftolk gevonden' }) : (0, o.jsx)(o.Fragment, {})) : (0, o.jsx)(o.Fragment, {}), (0, o.jsx)('aside', { className: (0, s.A)('ma-dsw-session__speakers'), children: h.map((n, t) => (0, o.jsxs)('div', { className: (0, s.A)('ma-dsw-session__speaker', 'ma-dsw-speaker'), children: [(0, o.jsx)('img', { className: (0, s.A)('ma-dsw-speaker__image'), src: n.image.src, alt: n.image.alt }), (0, o.jsx)(i.fz, { className: (0, s.A)('ma-dsw-speaker__description'), dangerouslySetInnerHTML: { __html: n.description[e] } })] }, t)) }), g && g.icalLink && !d ? (0, o.jsx)(i.fz, { children: (0, o.jsxs)(i.vx, { href: g.icalLink, download: g.icalLink, appearance: 'primary-action-button', children: [(0, o.jsx)(i.In, { children: (0, o.jsx)(a.A, {}) }), (0, o.jsx)('span', { children: 'nl' === e ? (0, o.jsxs)(o.Fragment, { children: ['Zet', (0, o.jsx)('span', { className: 'sr-only', children: g.subject }), ' in je agenda'] }) : (0, o.jsxs)(o.Fragment, { children: ['Add', (0, o.jsx)('span', { className: 'sr-only', children: g.subject }), ' to your calendar'] }) })] }) }) : null] }) : (0, o.jsx)(o.Fragment, {});
    };
  },
  29680(e, n, t) {
   t.d(n, { v: () => o });
   var a = t(24456),
    i = t(13526),
    s = t(86070);
   const r = ({ className: e, children: n, purpose: t, iconStart: a, iconEnd: r, href: o }) => (0, s.jsxs)('a', { className: (0, i.A)('nl-button', e, { 'nl-button--primary': 'primary' === t, 'nl-button--secondary': 'secondary' === t, 'nl-button--subtle': 'subtle' === t }), href: o, children: [a && (0, s.jsx)('span', { className: 'nl-button__icon-start', children: a }), (0, s.jsx)('span', { className: 'nl-button__label', children: n }), r && (0, s.jsx)('span', { className: 'nl-button__icon-end', children: r })] }),
    o = globalThis.isAstro
     ? ({ appearance: e, href: n, ...t }) => {
        let a = 'primary';
        return ((a = 'secondary-action' === e ? 'secondary' : a), (0, s.jsx)(r, { purpose: a, href: n, ...t }));
       }
     : ({ appearance: e, ...n }) => (0, s.jsx)(a.F, { className: (0, i.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...n });
  },
  35683(e, n, t) {
   t.d(n, { K: () => a.e2 });
   var a = t(29181);
  ...
  56561(e, n, t) {
   ...
   var m = (0, o.forwardRef)(function (e, n) {
    var t = e.children,
     ...
     d = e.purpose,
     m = (0, i.A)(e, l);
    return (0, s.jsx)('p', c(c({ className: (0, r.$)('nl-paragraph', (0, a.A)({}, 'nl-paragraph--lead', 'lead' === d), o), ref: n }, m), {}, { children: 'lead' === d ? (0, s.jsx)('b', { className: 'nl-paragraph__lead', children: t }) : t }));
   });
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => i, KF: () => p, mJ: () => u, VZ: () => x, cR: () => y, Pv: () => k, qZ: () => r, kD: () => f, QQ: () => D, B2: () => g, Pc: () => l, f4: () => o, GT: () => w, fX: () => s, eQ: () => v, B_: () => j, o_: () => b });
