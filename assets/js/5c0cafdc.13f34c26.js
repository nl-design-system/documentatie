/*! For license information please see 5c0cafdc.13f34c26.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [66152],
 {
  39884: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => u, contentTitle: () => g, default: () => b, frontMatter: () => c, metadata: () => m, toc: () => h });
   var t = i(52676),
    s = i(40139),
    a = i(37943),
    r = i(78511),
    ...
    l = i(72826),
    d = i(98227);
   const c = { title: 'Program \xb7 Design Systems Week 2025', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Program', pagination_label: 'Design Systems Week 2025', sidebar_position: 2, slug: '/events/design-systems-week-2025/en/program', image: 'https://raw.githubusercontent.com/nl-design-system/documentatie/assets/community-design-systems-week-en-2025.png' },
    g = 'Design Systems Week 2025 Program',
    m = { id: 'community/events/design-systems-week/en/program', title: 'Program \xb7 Design Systems Week 2025', description: 'NL Design System is organising the Design Systems Week for the fifth time. It will feature a number of short talks', source: '@site/docs/community/events/design-systems-week/en/program.mdx', sourceDirName: 'community/events/design-systems-week/en', slug: '/events/design-systems-week-2025/en/program', permalink: '/events/design-systems-week-2025/en/program', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/community/events/design-systems-week/en/program.mdx', tags: [], version: 'current', sidebarPosition: 2, frontMatter: { title: 'Program \xb7 Design Systems Week 2025', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Program', pagination_label: 'Design Systems Week 2025', sidebar_position: 2, slug: '/events/design-systems-week-2025/en/program', image: 'https://raw.githubusercontent.com/nl-design-system/documentatie/assets/community-design-systems-week-en-2025.png' }, sidebar: 'community', previous: { title: 'About Design Systems Week', permalink: '/events/design-systems-week/en' }, next: { title: 'Timetable', permalink: '/events/design-systems-week-2025/en/timetable' } },
    u = {},
    h = [];
   function p(e) {
    const n = { h1: 'h1', p: 'p', ...(0, s.a)(), ...e.components };
    return (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.h1, { id: 'design-systems-week-2025-program', children: 'Design Systems Week 2025 Program' }), '\n', (0, t.jsx)(a.nv, { lead: !0, children: (0, t.jsx)(n.p, { children: 'NL Design System is organising the Design Systems Week for the fifth time. It will feature a number of short talks\nabout the how and why of design systems. All online. From October 27 to October 30, we will cover subjects like\nmanaging design systems, integrating accessibility, user research and code.' }) }), '\n', (0, t.jsxs)(a.hE, { children: [(0, t.jsxs)(a.ZP, { href: '/events/design-systems-week-2025/en/timetable', appearance: 'primary-action-button', children: ['View the timetable', (0, t.jsx)(r.Z, {})] }), (0, t.jsxs)(a.ZP, { href: 'https://miro.com/app/board/uXjVLTpHyN8=/', appearance: 'secondary-action-button', children: ['Use Miro', (0, t.jsx)(r.Z, {})] })] }), '\n', (0, t.jsxs)(d.S, { allSpeakers: l, allSessions: o, sessionId: '74d8600f-b404-4e3d-a41e-9f652d8f9455', headingLevel: 2, lang: 'en', children: [(0, t.jsx)(a.nv, { children: (0, t.jsx)(n.p, { children: 'How can cities make their design systems more transparent, consistent, and easy to use for developers? The City of Vienna found an answer in the Custom Elements Manifest (CEM) \u2014 a file format that describes custom elements and makes web components easier to document and use in code editors.' }) }), (0, t.jsx)(a.nv, { children: (0, t.jsx)(n.p, { children: 'In this session, Manuel Matuzovi\u0107 shows how Vienna applies CEM to document and maintain its pattern library. He demonstrates how this approach improves usability, accessibility, and collaboration across teams.' }) })] }), '\n', (0, t.jsx)(d.S, { allSpeakers: l, allSessions: o, sessionId: '5faa9816-8348-4111-9780-eaa44d964308', headingLevel: 2, lang: 'en', children: (0, t.jsx)(a.nv, { children: (0, t.jsx)(n.p, { children: "TEDI is the design system for the Estonian public sector. What started two years ago as an internal tool quickly\ngrew into a system used nationwide. TEDI replaced the previous design system VEERA from 2018, which didn't offer\ncomponents for developers. In this session, the TEDI core team shares their experiences: the successes and the\nchallenges. They show how the system is technically structured, how the team works together, and how the design\nlibrary has developed." }) }) }), '\n', (0, t.jsxs)(d.S, { allSpeakers: l, allSessions: o, headingLevel: 2, sessionId: '02ae9c2a-f84f-4cd1-b7c0-9afe20813acb', lang: 'en', children: [(0, t.jsx)(a.nv, { lead: !0, children: (0, t.jsxs)(n.p, { children: [(0, t.jsx)('strong', { children: 'Heads up!' }), " This session has unfortunately been cancelled due to illness. We're looking into whether\nAlain can be rescheduled as a 5th session on Thursday. We'll keep you posted."] }) }), (0, t.jsx)(a.nv, { children: (0, t.jsx)(n.p, { children: 'Since 2020, extensive work has been done in Luxembourg on three testing methods for accessibility: web, mobile and\nPDF. These practical tests make it easier to check how a website or web application meets the European Standard (EN\n301 549) for digital accessibility. These tests are useful for anyone working with WCAG and are now being used both in\nLuxembourg and internationally as an approach for accessibility audits. Alain will show how these testing methods work\nin practice. He will highlight the key benefits and explain how you can use and contribute to this Open Source\ninitiative.' }) })] }), '\n', (0, t.jsx)(d.S, { allSpeakers: l, allSessions: o, sessionId: 'e68d397b-87fe-46ab-996b-ed7339f741a4', headingLevel: 2, lang: 'en', children: (0, t.jsx)(a.nv, { children: (0, t.jsx)(n.p, { children: "The Helsinki Design System is an award-winning open-source project, built to be accessible to everyone and available\nin English. This session delves into what it takes to document and scale a design system in practice\u2014covering the\nreal challenges of managing documentation workflows, and how to keep collaboration and consistency on track when the\nlatest tools aren't available. Gain insight into why process and mindset matter far more than tools, and how\nthoughtful documentation can make or break a design system." }) }) })] });
   }
   function b(e = {}) {
  ...
  98227: (e, n, i) => {
   ...
   const l = new Date().toISOString(),
    d = (e) => {
     let { lang: n = 'nl', headingLevel: i = 3, allSpeakers: d, videoId: c, children: g, allSessions: m, sessionId: u } = e;
     const h = m?.find((e) => {
       let { uuid: n } = e;
       return u === n;
      }),
     ...
     return h
      ? (0, o.jsxs)('article', {
         ...
         children: [
          (0, o.jsx)(s.X6, { level: i, className: 'dsw-session__title', id: h.subject.toLowerCase().replace(/\s/gi, '-'), children: h.subject }),
          (0, o.jsx)(s.nv, { className: 'dsw-session__subtitle', lead: !0, children: p && p.map((e) => (e?.organisation ? `${e.name} - ${e.organisation}` : e.name)).join(' & ') }),
          c || (h?.videoId && (0, o.jsx)(r.Y, { id: c || h?.videoId, title: h.subject, style: { marginBlock: '20px' } })),
          h && h.isoDateTime && h.isoDateTime > l ? (0, o.jsx)(s.nv, { children: (0, o.jsx)('time', { dateTime: h.isoDateTime, children: new Intl.DateTimeFormat(n, { dateStyle: 'full', timeStyle: 'nl' === n ? 'short' : 'full', timeZone: 'Europe/Amsterdam' }).format(new Date(h.isoDateTime)) }) }) : (0, o.jsx)(o.Fragment, {}),
          g,
          'nl' === n &&
           p.find((e) => {
            let { language: n } = e;
          ...
          h.captioned ? (h.captionId ? (0, o.jsx)(o.Fragment, { children: (0, o.jsxs)(s.nv, { children: ['nl' === n ? (0, o.jsx)(o.Fragment, { children: (0, o.jsx)('b', { children: 'Bij deze sessie is een schrijftolk aanwezig: ' }) }) : (0, o.jsx)(o.Fragment, { children: (0, o.jsx)('b', { children: 'Live captioning is available for this session: ' }) }), (0, o.jsxs)('a', { href: `https://text-on-tap.live/#e=${h.captionId}`, children: [(0, o.jsxs)('span', { className: 'sr-only', children: [h.subject, ' '] }), 'nl' === n ? 'in de browser' : 'in the browser'] }), 'nl' === n ? ' of ' : ' or ', (0, o.jsxs)('a', { href: `https://text-on-tap.live/openoverlay.html?e=${h.captionId}`, children: [(0, o.jsxs)('span', { className: 'sr-only', children: [h.subject, ' '] }), 'nl' === n ? 'met de Overlay tool' : 'with the de Overlay tool'] })] }) }) : 'nl' === n ? (0, o.jsx)(s.nv, { children: 'Voor deze sessie hebben we nog geen schrijftolk gevonden' }) : (0, o.jsx)(o.Fragment, {})) : (0, o.jsx)(o.Fragment, {}),
          (0, o.jsx)('aside', { className: (0, a.Z)('dsw-session__speakers'), children: p.map((e, i) => (0, o.jsxs)('div', { className: (0, a.Z)('dsw-session__speaker', 'dsw-speaker'), children: [(0, o.jsx)('img', { className: (0, a.Z)('dsw-speaker__image'), src: e.image.src, alt: e.image.alt }), (0, o.jsx)(s.nv, { className: (0, a.Z)('dsw-speaker__description'), children: e.description[n] })] }, i)) }),
          h && h.icalLink && !c ? (0, o.jsx)(s.nv, { children: (0, o.jsxs)(s.ZP, { href: h.icalLink, download: h.icalLink, appearance: 'primary-action-button', children: [(0, o.jsx)(s.JO, { children: (0, o.jsx)(t.Z, {}) }), (0, o.jsx)('span', { children: 'nl' === n ? (0, o.jsxs)(o.Fragment, { children: ['Zet', (0, o.jsx)('span', { className: 'sr-only', children: h.subject }), ' in je agenda'] }) : (0, o.jsxs)(o.Fragment, { children: ['Add', (0, o.jsx)('span', { className: 'sr-only', children: h.subject }), ' to your calendar'] }) })] }) }) : null,
         ],
        })
      : (0, o.jsx)(o.Fragment, {});
    };
  ...
  84263: (e, n, i) => {
   ...
   var r = t.forwardRef(function (e, n) {
    var i = t.useState(!1),
     ...
     k = new URLSearchParams(s(s(s(s({}, e.muted ? { mute: '1' } : {}), b ? { autoplay: '1' } : {}), e.enableJsApi ? { enablejsapi: '1' } : {}), e.playlist ? { list: g } : {}));
    e.params &&
    ...
    return (
     ...
     t.createElement(
      t.Fragment,
      null,
      t.createElement('link', { rel: H, href: S, as: 'image' }),
      t.createElement(t.Fragment, null, r && t.createElement(t.Fragment, null, t.createElement('link', { rel: 'preconnect', href: v }), t.createElement('link', { rel: 'preconnect', href: 'https://www.google.com' }), x && t.createElement(t.Fragment, null, t.createElement('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), t.createElement('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })))),
      t.createElement(
       C,
       {
        ...
        className: ''.concat(I, ' ').concat(d ? D : ''),
        'data-title': u,
        style: s(s({ backgroundImage: 'url('.concat(S, ')') }, { '--aspect-ratio': ''.concat((E / L) * 100, '%') }), Z),
       },
       t.createElement('button', { type: 'button', className: N, 'aria-label': ''.concat(p, ' ').concat(u) }),
       d && t.createElement('iframe', { ref: n, className: z, title: u, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: y }),
      ),
     )
    );
   });
