   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const o = 'function' == typeof e ? e() : e,
        ...
        r = m().highlight(l, m().languages[n], n);
       return (0, g.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', t), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: l } }), (0, g.jsx)(h.n, { children: (0, g.jsx)(h.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: p = !0, children: m, container: h = 'document', language: x, designTokens: f }) => {
       const _ = 'function' == typeof m ? m() : m,
        k = 'function' == typeof e ? e() : (0, u.isValidElement)(e) ? e : void 0,
        N = 'string' == typeof e ? e : b.qV(k || _),
        [A, w] = (0, u.useState)(N),
        [z, C] = (0, u.useState)(t);
       (0, u.useEffect)(() => {
        (async () => {
