 ...
 [9686],
 {
  ...
  95857(e, n, i) {
   ...
   const l = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: r, ...l }, o) => {
    const d = { ...l, ref: o, className: s('utrecht-note', { [`utrecht-note--${r}`]: r }, i) };
  ...
  97857(e, n, i) {
   ...
   var r = i(86070),
    ...
    h = i(37026),
    j = i(19972);
   const u = { title: 'WCAG-succescriterium 3.2.4 Consistente identificatie', title_sm: '3.2.4 Consistente identificatie', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.4 Consistente identificatie', pagination_label: 'WCAG-succescriterium 3.2.4 Consistente identificatie', description: 'Onderdelen die hetzelfde doen moeten ook hetzelfde te herkennen zijn.', slug: '3.2.4', conformance_level: 'Niveau AA', keywords: ['WCAG', 'AA', 'begrijpelijk', 'voorspelbaar', 'understandable', 'predictable', 'consistent identification'] },
    g = void 0,
    m = {},
