 ...
 [39311],
 {
  ...
  50341: (e, t, n) => {
   ...
   const w = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: c.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(k, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(b, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
