 ...
 [94510],
 {
  ...
  43599: (e, n, o) => {
   ...
   const m = (e) => {
    ...
    const w = 'function' == typeof b ? b() : b,
     ...
     z = 'string' == typeof n ? n : k.uS(_ || w),
     [N, D] = (0, p.useState)(z),
     [K, C] = (0, p.useState)(m);
    (0, p.useEffect)(() => {
     (async () => {
      const e = await c.ZP.format(z, { parser: y, plugins: [i.Z, l.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      D(e);
     })();
    }, [z]);
    const Z = (0, p.useId)();
    ...
    return (
     ...
     (0, u.jsxs)('div', {
      ...
      children: [
       w && (0, u.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, u.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, u.jsx)(S, { children: (0, u.jsx)(a.pu, { children: w }) }) }) }),
       j &&
        (0, u.jsx)('div', {
  ...
  41179: (e, n, o) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: o, textContent: d, trim: c } = e,
     p = d;
    const { title: k, type: u } = (0, r.useContext)(i.n),
     h = (0, r.useId)();
    return (
     c && (p = p.trim()),
     (0, s.jsx)(a.y$, {
      ...
      language: o || '',
      children: (e) => {
       let { style: o, tokens: a, getLineProps: r, getTokenProps: i } = e;
       return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', k ? ': ' : ' ', k] }), (0, s.jsx)(t.dn, { tabIndex: 0, role: k ? 'region' : void 0, 'aria-labelledby': h, style: o, children: a.map((e, o) => (0, s.jsxs)('span', { ...r({ line: e }), children: [n && (0, s.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, o)) })] });
      },
     })
    );
   }
  ...
  40761: (e, n, o) => {
   ...
   const d = (0, l.createContext)({}),
    c = (e) => {
     let { title: n, appearance: o, description: l, children: c, figure: p } = e;
     const k = { do: 'Doen', dont: 'Niet doen' },
      u = p ? 'figure' : 'div',
      h = p ? 'figcaption' : 'div';
     return (0, s.jsxs)(u, { className: (0, i.Z)('nlds-guideline', `nlds-guideline--${o}`), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, s.jsxs)(h, { className: 'nlds-guideline__description', children: ['dont' === o ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(r.nv, { className: (0, i.Z)('nlds-guideline__badge', `nlds-guideline__badge--${o}`), children: [(0, s.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: k.dont })] }), (0, s.jsx)(r.nv, { children: n })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(r.nv, { className: (0, i.Z)('nlds-guideline__badge', `nlds-guideline__badge--${o}`), children: [(0, s.jsx)(a.Z, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, s.jsx)('span', { className: 'nlds-guideline__title', children: k.do })] }), (0, s.jsx)(r.nv, { children: n })] }), l] }), (0, s.jsx)('div', { className: 'nlds-guideline__example', children: (0, s.jsx)(d.Provider, { value: { title: n, type: k[o] }, children: c }) })] });
    };
  },
  40139: (e, n, o) => {
   o.d(n, { Z: () => l, a: () => i });
