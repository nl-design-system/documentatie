/*! For license information please see 7c64543d.81c7f236.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [89033],
 {
  ...
  18252(e, n, s) {
   s.d(n, { F: () => d });
   const i = (0, s(18652).A)('outline', 'user', 'User', [
   ...
   var t = s(90578),
    ...
    r = s(13526),
    o = s(86070);
   const l = ({ name: e, organisation: n }) => (0, o.jsxs)(a.fz, { className: (0, r.A)('ma-session-table__speaker', 'ma-speaker'), children: [(0, o.jsx)(a.In, { className: 'ma-speaker__icon', children: (0, o.jsx)(i, {}) }), (0, o.jsx)('span', { className: 'ma-speaker__name', children: e }), (0, o.jsx)('br', {}), (0, o.jsx)('span', { className: 'ma-speaker__organisation', children: n })] }),
    d = ({ year: e, lang: n, sessions: s, speakers: i, className: d, ...c }) =>
     (0, o.jsx)('div', {
          ...
          ({ isoDateTime: s, speakers: r, subject: d, icalLink: c, language: m, cancelled: g }, h) =>
           ...
           (0, o.jsxs)(
            a.Hj,
            {
             ...
             children: [
              (0, o.jsx)(a.nA, { className: 'ma-session-table__time', children: (0, o.jsx)(a.fz, { children: (0, o.jsx)('time', { dateTime: s, children: new Intl.DateTimeFormat(n, { hour: 'numeric', minute: 'numeric', timeZone: 'Europe/Amsterdam', timeZoneName: 'nl-NL' !== n ? 'short' : void 0 }).format(new Date(s)) }) }) }),
              (0, o.jsx)(a.nA, { className: 'ma-session-table__language', children: (0, o.jsx)('abbr', { title: m.description, children: m.abbr }) }),
              (0, o.jsx)(a.nA, {
              ...
              (0, o.jsx)(a.nA, { className: 'ma-session-table__subject', children: (0, o.jsx)(a.fz, { lang: m.abbr, children: (0, o.jsx)(a.N_, { href: `/events/design-systems-week-${e}/${'nl-NL' === n ? 'programma' : 'EN' === m.abbr ? 'en/program' : 'programma'}#${d.toLowerCase().replace(/\s/gi, '-')}`, children: d }) }) }),
              (0, o.jsx)(a.nA, { className: 'ma-session-table__time', children: c && (0, o.jsxs)(a.vx, { href: c, download: c, 'aria-labelledby': 'ical-description', children: [(0, o.jsx)(a.In, { children: (0, o.jsx)(t.A, {}) }), ' ', (0, o.jsxs)('span', { id: 'ical-description', className: 'sr-only', children: ['iCal file for ', (0, o.jsx)('span', { lang: m.abbr, children: d }), '(download)'] })] }) }),
             ],
            },
            h,
           ),
  ...
  18652(e, n, s) {
   ...
   const a = (e, n, s, a) => {
    const r = (0, i.forwardRef)(({ color: s = 'currentColor', size: r = 24, stroke: o = 2, title: l, className: d, children: c, ...m }, g) => (0, i.createElement)('svg', { ref: g, ...t[e], width: r, height: r, className: ['tabler-icon', `tabler-icon-${n}`, d].join(' '), ...('filled' === e ? { fill: s } : { strokeWidth: o, stroke: s }), ...m }, [l && (0, i.createElement)('title', { key: 'svg-title' }, l), ...a.map(([e, n]) => (0, i.createElement)(e, n)), ...(Array.isArray(c) ? c : [c])]));
  ...
  24456(e, n, s) {
   ...
   const r = ({ children: e, ...n }) => {
    ...
    o = ({ className: e, boxContent: n, ...s }) => (0, a.jsx)(r, { className: (0, i.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...s });
  },
  29680(e, n, s) {
   s.d(n, { v: () => o });
   var i = s(24456),
    t = s(13526),
    a = s(86070);
   const r = ({ className: e, children: n, purpose: s, iconStart: i, iconEnd: r, href: o }) => (0, a.jsxs)('a', { className: (0, t.A)('nl-button', e, { 'nl-button--primary': 'primary' === s, 'nl-button--secondary': 'secondary' === s, 'nl-button--subtle': 'subtle' === s }), href: o, children: [i && (0, a.jsx)('span', { className: 'nl-button__icon-start', children: i }), (0, a.jsx)('span', { className: 'nl-button__label', children: n }), r && (0, a.jsx)('span', { className: 'nl-button__icon-end', children: r })] }),
    o = globalThis.isAstro
     ? ({ appearance: e, href: n, ...s }) => {
        let i = 'primary';
        return ((i = 'secondary-action' === e ? 'secondary' : i), (0, a.jsx)(r, { purpose: i, href: n, ...s }));
       }
     : ({ appearance: e, ...n }) => (0, a.jsx)(i.F, { className: (0, t.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...n });
  },
  35683(e, n, s) {
   s.d(n, { K: () => i.e2 });
   var i = s(29181);
  ...
  56561(e, n, s) {
   ...
   var m = (0, o.forwardRef)(function (e, n) {
    var s = e.children,
     ...
     d = e.purpose,
     m = (0, t.A)(e, l);
    return (0, a.jsx)('p', c(c({ className: (0, r.$)('nl-paragraph', (0, i.A)({}, 'nl-paragraph--lead', 'lead' === d), o), ref: n }, m), {}, { children: 'lead' === d ? (0, a.jsx)('b', { className: 'nl-paragraph__lead', children: s }) : s }));
   });
  ...
  63009(e, n, s) {
   ...
   var m = (0, o.forwardRef)(function (e, n) {
    var s = e.children,
     ...
     h = e.inlineBox,
     p = (0, t.A)(e, l);
    return (0, a.jsx)('a', c(c({ 'aria-current': d || void 0, 'aria-disabled': m, className: (0, r.$)('nl-link', (0, i.A)((0, i.A)((0, i.A)({}, 'nl-link--current', d), 'nl-link--disabled', m), 'nl-link--inline-box', h), o), href: m ? void 0 : g, role: m ? 'link' : void 0, ref: n, tabIndex: m ? 0 : void 0 }, p), {}, { children: s }));
   });
   m.displayName = 'Link';
  },
  64249(e, n, s) {
  ...
  84471(e, n, s) {
   s.d(n, { bo: () => t, KF: () => g, mJ: () => u, VZ: () => D, cR: () => w, Pv: () => b, qZ: () => r, kD: () => y, QQ: () => x, B2: () => h, Pc: () => l, f4: () => o, GT: () => f, fX: () => a, eQ: () => v, B_: () => j, o_: () => k });
    ...
    b = (e) => {
     ...
     return n.map((n) => {
      const i = e.tasks
       ...
       .map(({ name: i, id: t, value: a }) => {
        const r = /^(.+) URL/.exec(i)[1],
         o = 'Storybook' === r ? `${s} (${n}) in Storybook van ${e.title}` : `${s} (${n}) op ${r}`;
        return { brand: r.toLowerCase(), name: i, id: t, value: a, description: o };
       });
   ...
   function y(e, n = []) {
    return Object.hasOwn(e, '$type') ? [n] : Object.keys(e).flatMap((s) => ('object' == typeof e[s] && null !== e[s] ? y(e[s], [...n, s]) : []));
   }
   function f(e) {
    const n = new Map();
    function s(e) {
