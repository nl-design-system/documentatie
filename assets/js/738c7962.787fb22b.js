 ...
 [14366],
 {
  ...
  45282(e, n, t) {
   ...
   const a = ({ children: e, ...n }) => {
     ...
     return ('https://nldesignsystem.nl' === l.origin ? ((l.pathname = l.pathname.endsWith('/') ? l.pathname : `${l.pathname}/`), (s = l.toString().replace('https://nldesignsystem.nl', ''))) : ((a.target = '_blank'), (a.rel = 'noopener noreferrer')), (0, r.jsx)('a', { href: s, ...a, children: e }));
    },
    s = ({ className: e, ...n }) => (0, r.jsx)(a, { className: (0, i.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  60316(e, n, t) {
   t.d(n, { $S: () => i, d1: () => r });
   t(74147);
