 ...
 [73512],
 {
  1292(e, n, a) {
   ...
   var t = a(29181),
    ...
    l = a(83386),
    d = a(86070);
   const c = { figma: (0, d.jsx)(r.A, {}), github: (0, d.jsx)(o.A, {}), npm: (0, d.jsx)(s.A, {}), storybook: (0, d.jsx)(i.A, {}) },
  ...
  12013(e, n, a) {
   ...
   const s = (e, n) => {
    ...
    l = (e) => ({ img: ({ src: n, ...a }) => (0, o.jsx)('img', { ...a, src: s(e, n), className: 'utrecht-img utrecht-img--fit' }) }),
    d = (e, n) => {
     if (e) {
      const e = { ...i[n - 1] };
      return ((e.h1 = () => null), e);
    ...
    c = ({ children: e, omitH1: n = !1, headingLevel: a = 1, baseUrl: r = '', components: s = {} }) => (0, o.jsx)(t.x, { components: { ...d(n, a), ...l(r), ...s }, children: e });
  },
  17045(e, n, a) {
   'use strict';
   a.d(n, { Ay: () => i, RM: () => o });
  ...
  17889(e, n, a) {
    ...
    return 'clipboard' in navigator
     ? (0, u.jsxs)(s.$n, {
        ...
        onClick: async function () {
         try {
          const e = await c.Ay.format(n, { parser: a, plugins: [i.A, l.Ay, d.Ay] });
   ...
   function T({ tokens: e }) {
    const n = (0, o.kD)(e),
     a = (0, C.sj)(e, (e) => (((e) => null !== e && 'object' == typeof e && Object.hasOwn(e, '$type') && 'string' == typeof e.$type)(e) ? { $type: e.$type, $value: '' } : void 0)),
     i = (0, o.GT)(n),
     l = i.map((e) => (0, o.B_)(e) + ': ;').join('\n'),
     d = JSON.stringify(a);
       ...
       children: [
        ...
        (0, u.jsx)(s.BF, {
         children: i.map((n) => {
          const a = (0, o.o_)(n),
           i = (0, o.eQ)(e, n).$type;
          return (0, u.jsxs)(s.Hj, { children: [(0, u.jsx)(s.nA, { children: (0, u.jsx)(t.C, { children: (0, u.jsx)(s.kf, { children: a }) }) }), (0, u.jsx)(s.nA, { children: (0, u.jsxs)(r.K, { children: [(0, u.jsx)(D, { type: i }), ' ', i] }) })] }, a);
         }),
        }),
       ],
      }),
  ...
  33062(e, n, a) {
   'use strict';
   a.d(n, { bo: () => r, KF: () => m, mJ: () => h, VZ: () => w, cR: () => y, Pv: () => j, qZ: () => s, kD: () => f, B2: () => u, Pc: () => l, f4: () => i, GT: () => v, fX: () => o, eQ: () => b, B_: () => k, o_: () => x });
     ...
     return n.map((n) => {
      const t = e.tasks
       ...
       .map(({ name: t, id: r, value: o }) => {
        ...
        return { brand: s.toLowerCase(), name: t, id: r, value: o, description: i };
       });
            ...
            s.Zp,
            {
             ...
             children: (0, d.jsxs)(s.Wu, {
              children: [
               ...
               i.length > 0 && (0, d.jsx)(d.Fragment, { children: i.map(({ frameworkName: e, tasks: a }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, d.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, d.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    return (
     ...
     (0, r.jsxs)(r.Fragment, {
      children: [
       ...
       '\n',
       '\n',
       (0, r.jsx)(R.Fc, { component: U, headingLevel: 1, description: $ }),
       '\n',
       (0, r.jsx)(H.e, { component: U }),
       '\n',
       (0, r.jsx)(F.Zp, { className: 'ma-implementation-card', children: (0, r.jsxs)(F.Wu, { children: [(0, r.jsx)(N.D, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, r.jsxs)(A.dk, { children: [(0, r.jsxs)(A.Pt, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=2-4', children: [(0, r.jsx)(L.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, r.jsxs)(A.Pt, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=2-4', children: [(0, r.jsx)(L.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, r.jsx)(N.D, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, r.jsxs)(A.dk, { children: [(0, r.jsxs)(A.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-color-sample--documentatie', children: [(0, r.jsx)(L.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, r.jsxs)(A.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/color-sample--documentatie', children: [(0, r.jsx)(L.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, r.jsx)(N.D, { level: 2, appearance: 'level-4', children: 'npm' }), (0, r.jsxs)(A.dk, { children: [(0, r.jsxs)(A.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/color-sample-css', children: [(0, r.jsx)(L.r, { brand: 'npm' }), ' @nl-design-system-candidate/color-sample-css'] }), (0, r.jsxs)(A.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/color-sample-react', children: [(0, r.jsx)(L.r, { brand: 'npm' }), ' @nl-design-system-candidate/color-sample-react'] }), (0, r.jsxs)(A.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/color-sample-tokens', children: [(0, r.jsx)(L.r, { brand: 'npm' }), ' @nl-design-system-candidate/color-sample-tokens'] })] })] }) }),
       '\n',
       ...
       (0, r.jsx)(a, {
        ...
        items: [
         ...
         { title: 'Kleur is niet de enige manier waarop de informatie over de Color Sample beschikbaar is.', sc: '1.4.1', status: '', component: (0, r.jsx)(f.Ay, {}), tags: ['contentmaker', 'designer'] },
         { title: 'Het kleurcontrast van de tekst van de eigenschappen van de Color Sample is voldoende.', sc: '1.4.3', status: '', component: (0, r.jsx)(T.Ay, {}), tags: ['contentmaker', 'designer'] },
         { title: 'Als je de beschrijvende tekst bij een Color Sample vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: (0, r.jsx)(C, {}), tags: ['developer'] },
       ...
       (0, r.jsx)(a, {
        headingLevel: '4',
        items: [
         { title: 'De Color Sample kan een alternatieve tekst hebben. ', sc: '1.1.1', status: '', component: (0, r.jsx)(h, {}), tags: ['developer'] },
         { title: 'De Color Sample heeft de rol van afbeelding in de accessibility tree.', sc: '1.3.1', status: '', component: (0, r.jsx)(x, {}), tags: ['developer'] },
        ],
       }),
       '\n',
       (0, r.jsx)(z.o, { omitH1: !0, headingLevel: 2, children: (0, r.jsx)(M, {}) }),
       '\n',
       (0, r.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }),
       '\n',
       (0, r.jsx)(_.B, { tokens: P }),
       '\n',
       (0, r.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
       '\n',
       (0, r.jsx)(R.VK, { component: U, headingLevel: 3 }),
       '\n',
       (0, r.jsx)(R.$9, { component: U, headingLevel: 2 }),
       '\n',
       (0, r.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
       '\n',
       (0, r.jsx)(R.mu, { component: U, headingLevel: 3 }),
       '\n',
       (0, r.jsx)(R.K_, { component: U }),
      ],
     })
    );
   }
  ...
  72401(e, n, a) {
   ...
   const i = ({ component: e }) => {
    const { title: n } = e,
     i = (0, o.fX)(n),
     l = r.lazy(() => a(82839)(`./${i}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
  ...
  72642(e, n, a) {
   ...
   var t = a(13526),
    r = a(86070);
   const o = ({ children: e, className: n, level: a = 1, suffix: o, ...s }) => (0, r.jsxs)('hgroup', { className: (0, t.A)('nlds-inline-heading-group', `utrecht-heading-${a}`, n), ...s, children: [(0, r.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), o && (0, r.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
  },
  78762(e, n, a) {
   'use strict';
   a.d(n, { Ay: () => i, RM: () => o });
   ...
   function s(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.p, { children: 'Het contrast van de tekstkleur ten opzichte van de achtergrondkleur moet hoog genoeg zijn, zodat de tekst in het algemeen goed leesbaar wordt gevonden.' }), '\n', (0, t.jsx)(n.p, { children: 'De criteria voor kleurcontrast zijn:' }), '\n', (0, t.jsxs)(n.ul, { children: ['\n', (0, t.jsxs)(n.li, { children: [(0, t.jsx)(n.a, { href: '/contrast/?background-color=white&color=%23767676', children: '4,5:1 contrast' }), ' voor normale tekst.'] }), '\n', (0, t.jsxs)(n.li, { children: [(0, t.jsx)(n.a, { href: '/contrast/?background-color=white&color=%23949494', children: '3:1 contrast' }), ' voor grotere letters (vanaf 24 pixels).'] }), '\n', (0, t.jsx)(n.li, { children: '3:1 contrast voor vette letters (vet en groter of gelijk aan 19 pixels).' }), '\n'] }), '\n', (0, t.jsx)(n.p, { children: 'Tekst die over een afbeelding staat, moet ook voldoende contrast hebben met de kleuren in de afbeelding er omheen.' }), '\n', (0, t.jsx)(n.p, { children: 'Deze eis geldt niet voor tekst op een logo of van een merknaam, of tekst op een afbeelding die alleen ter decoratie dient en geen deel uitmaakt van de inhoud.' })] });
   }
   function i(e = {}) {
    const { wrapper: n } = { ...(0, r.R)(), ...e.components };
    return n ? (0, t.jsx)(n, { ...e, children: (0, t.jsx)(s, { ...e }) }) : s(e);
  ...
  90495(e, n, a) {
   ...
   var t = a(46447),
    r = a(13526),
    o = a(86070);
   const s = ({ background: e, children: n, className: a, ...t }) => (0, o.jsx)('div', { className: (0, r.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, a), ...t, children: n }),
    ...
    l = ({ href: e, appearance: n, className: a, component: s = 'div', background: i, children: l }) => {
     const d = (e) => ('article' === s ? (0, o.jsx)('article', { ...e }) : 'section' === s ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      c = (0, o.jsx)(d, { className: (0, r.A)('ma-cardgroup__card', i && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, a), children: l });
     return e ? (0, o.jsx)(t.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: c }) : c;
    },
    d = ({ appearance: e = 'medium', children: n, className: a }) => (0, o.jsx)('div', { className: (0, r.A)('ma-cardgroup', `ma-cardgroup--${e}`, a), children: n });
  },
 },
]);
