...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [65792],
 {
  ...
  23606(e, n, i) {
   ...
   var r = i(13526),
    t = i(86070);
   const a = ({ children: e, className: n, ...i }) => (0, t.jsx)('div', { ...i, className: (0, r.A)('nlds-fragment-redirect', n), children: e });
  },
  27354(e, n, i) {
   (i.r(n), i.d(n, { assets: () => p, contentTitle: () => d, default: () => h, frontMatter: () => l, metadata: () => r, toc: () => c }));
   const r = JSON.parse('{"id":"richtlijnen/formulieren/multistep/index","title":"Meerdere stappen in een formulier","description":"Bestaat een formulier uit veel vragen, dan kan het gebruiksvriendelijk en overzichtelijk zijn om het formulier in meerdere stappen op te delen, of om een vraag per stap te stellen.","source":"@site/docs/richtlijnen/formulieren/multistep/index.mdx","sourceDirName":"richtlijnen/formulieren/multistep","slug":"/richtlijnen/formulieren/meerdere-stappen/","permalink":"/richtlijnen/formulieren/meerdere-stappen/","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/multistep/index.mdx","tags":[],"version":"current","sidebarPosition":8,"frontMatter":{"title":"Meerdere stappen in een formulier","title_sm":"Meerdere stappen","hide_title":true,"hide_table_of_contents":true,"sidebar_label":"Introductie meerdere stappen","sidebar_position":8,"navigation_order":8,"pagination_label":"Meerdere stappen","description":"Bestaat een formulier uit veel vragen, dan kan het gebruiksvriendelijk en overzichtelijk zijn om het formulier in meerdere stappen op te delen, of om een vraag per stap te stellen.","slug":"/richtlijnen/formulieren/meerdere-stappen/","keywords":["informatie","formulier","design","code"]},"sidebar":"richtlijnen","previous":{"title":"Link in nieuwe tab","permalink":"/richtlijnen/formulieren/links/nieuwe-tab"},"next":{"title":"Meerdere stappen","permalink":"/richtlijnen/formulieren/meerdere-stappen/"}}');
   var t = i(86070),
    a = i(18439),
    s = i(78734),
    o = i(23606);
   const l = { title: 'Meerdere stappen in een formulier', title_sm: 'Meerdere stappen', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Introductie meerdere stappen', sidebar_position: 8, navigation_order: 8, pagination_label: 'Meerdere stappen', description: 'Bestaat een formulier uit veel vragen, dan kan het gebruiksvriendelijk en overzichtelijk zijn om het formulier in meerdere stappen op te delen, of om een vraag per stap te stellen.', slug: '/richtlijnen/formulieren/meerdere-stappen/', keywords: ['informatie', 'formulier', 'design', 'code'] },
    d = 'Richtlijnen NL Design System voor meerdere stappen in een formulier',
    p = {},
    c = [{ value: 'Overzicht richtlijnen', id: 'overzicht-richtlijnen', level: 2 }, { value: 'Deze documentatie heeft nu een eigen pagina', id: 'deze-documentatie-heeft-nu-een-eigen-pagina', level: 2 }, ...s.RM];
   function m(e) {
