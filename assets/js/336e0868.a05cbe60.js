 ...
 [54728],
 {
  ...
  58639(e, n, t) {
   ...
   const y = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: y = !0, children: v, container: b = 'document', language: k, designTokens: x }) => {
    ...
    let R = h.Fragment;
    return (
     'paragraph' === b ? (R = g) : 'document' === b ? (R = m) : 'surface' === b && (R = j),
     (0, u.jsxs)('div', {
      className: (0, s.A)('nlds-canvas'),
      children: [
       f && (0, u.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, u.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, u.jsx)(R, { children: (0, u.jsx)(l.v$, { children: f }) }) }) }),
       y &&
        (0, u.jsx)('div', {
