 ...
 [75404],
 {
  3227(e, n, i) {
   ...
   function d({ href: e, icon: n = '', title: i, description: t, children: s }) {
    return (0, o.jsxs)('div', { className: 'card', children: [e ? (0, o.jsx)(r.N, { href: e, className: (0, c.A)('cardLink', 'utrecht-link'), children: (0, o.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', i] }) }) : (0, o.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', i] }), t && (0, o.jsx)('p', { className: 'cardDescription', children: t }), s] });
   }
   function a({ item: e }) {
    return (0, o.jsx)(d, { title: e.label, description: e.description, children: (0, o.jsx)(l.Xy, { children: e.items.filter((e) => 'link' === e.type || 'category' === e.type).map((e, n) => (0, o.jsx)(l.Er, { children: 'link' === e.type ? (0, o.jsx)(r.N, { to: e.href, children: e.label }) : 'category' === e.type ? (0, o.jsxs)(r.N, { to: e.href, children: [e.items.length, " pagina's voor ", e.label] }) : (0, o.jsx)(o.Fragment, {}) }, n)) }) });
   }
   function h({ item: e }) {
  ...
  45282(e, n, i) {
   ...
   const s = ({ children: e, ...n }) => {
     ...
     let l = i || t;
     const c = new URL(l, 'https://nldesignsystem.nl');
     return ('https://nldesignsystem.nl' === c.origin ? ((c.pathname = c.pathname.endsWith('/') ? c.pathname : `${c.pathname}/`), (l = c.toString().replace('https://nldesignsystem.nl', ''))) : ((s.target = '_blank'), (s.rel = 'noopener noreferrer')), (0, r.jsx)('a', { href: l, ...s, children: e }));
    },
  ...
  89874(e, n, i) {
   ...
   const c = (e, n) => e.reduce((e, i) => ('link' === i.type ? (n.includes(i.docId) ? e : [...e, i]) : 'category' === i.type ? [...e, { ...i, items: c(i.items, n) }] : e), []),
    o = ({ excludeDocIDs: e = [], className: n, ...i }) => {
     const o = (0, t.$S)();
     return (0, l.jsx)('div', { ...i, className: (0, r.A)('margin-top--lg', n), children: (0, l.jsx)(s.A, { items: c(o.items, e) }) });
    };
  },
 },
]);
