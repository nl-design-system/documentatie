 ...
 [26592],
 {
  14881(e, n, t) {
   ...
   var l = t(13526),
    ...
    a = t(37168),
    r = t(86070);
   const i = (0, s.forwardRef)(({ as: e, className: n, children: t, ...s }, o) => {
     const a = e || 'div',
      i = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, r.jsx)(a, { ref: o, className: i, ...s, children: t });
    }),
    c = ({ className: e, classNamePanel: n, label: t, heading: s, headingLevel: i, headingApperance: c, ...d }) => {
     const h = (0, l.A)('utrecht-accordion__section', e),
      k = (0, l.A)('utrecht-accordion__panel', n);
     return (0, r.jsxs)('details', { className: h, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(o.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [s && (0, r.jsx)(a.D, { level: i, appearance: c, children: s }), t] })] }) }), (0, r.jsx)('div', { className: k, children: d.children })] });
    };
  },
  18439(e, n, t) {
   t.d(n, { R: () => a, x: () => r });
   ...
   function r(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(s) : e.components || s) : a(e.components)), l.createElement(o.Provider, { value: n }, e.children));
   }
  },
  28369(e, n, t) {
   t.d(n, { M: () => c });
   ...
   function c({ lineNumber: e, syntax: n, textContent: t, trim: c }) {
    let d = t;
    const { title: h, type: k } = (0, o.useContext)(a.x),
     p = (0, o.useId)();
    return (c && (d = d.trim()), (0, i.jsx)(s.f4, { theme: r, code: d, language: n || '', children: ({ style: n, tokens: t, getLineProps: s, getTokenProps: o }) => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', k ? `\u201c${k}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, i.jsx)(l.NG, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': p, style: n, children: t.map((n, t) => (0, i.jsxs)('span', { ...s({ line: n }), children: [e && (0, i.jsx)('span', { children: t + 1 }), n.map((e, n) => (0, i.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, t)) })] }) }));
   }
  },
  38953(e, n, t) {
   t.d(n, { H: () => y });
   var l = t(28369),
    ...
    j = t(46847),
    g = t(86070);
   const x = ({ children: e }) => (0, g.jsx)(s.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(s.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, g.jsx)(s.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   x.displayName = 'ParagraphContainer';
   const b = ({ children: e }) => (0, g.jsx)(s.ui, { className: 'nlds-canvas__example-surface', children: (0, g.jsx)(s.yo, { className: (0, o.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   ...
   const y = globalThis.isAstro
    ? ({ language: e, className: n, code: t = '<p>No code provided</p>', rawCode: l, copyCode: s, defaultExpandedCode: a, designTokens: r }) => {
       const i = 'string' == typeof t ? t : l || '',
        c = 'string' == typeof t ? m().highlight(t, m().languages[e], e) : m().highlight(l || '', m().languages[e], e);
       return (0, g.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', n), children: [(0, g.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: r, children: (0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: i } }) }), (0, g.jsx)(u.n, { children: (0, g.jsxs)(u.K, { label: 'Code', open: a, children: [(0, g.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: c } }) }), 'allow' === s && (0, g.jsx)(j.$, { 'data-copy-code': i, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: p = !0, children: m, container: u = 'document', language: j, designTokens: y }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(w, { parser: j, plugins: [a.A, r.Ay, i.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         z(e);
        })();
       }, [w]);
       const S = (0, h.useId)();
       let T = h.Fragment;
       return (
        'paragraph' === u ? (T = x) : 'document' === u ? (T = b) : 'surface' === u && (T = v),
        (0, g.jsxs)('div', {
         className: (0, o.A)('nlds-canvas'),
         children: [
          f && (0, g.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, g.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, g.jsx)(T, { children: (0, g.jsx)(s.v$, { children: f }) }) }) }),
          p &&
           (0, g.jsx)('div', {
          ...
          p &&
           (0, g.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, g.jsx)(l.M, { codeBlockLabel: 'Codevoorbeeld', syntax: j, textContent: N, trim: !0 }),
             n &&
              (0, g.jsx)('div', {
  ...
  80593(e, n, t) {
   (t.r(n), t.d(n, { assets: () => h, contentTitle: () => d, default: () => m, frontMatter: () => c, metadata: () => l, toc: () => k }));
