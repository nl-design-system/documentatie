  ...
  75397(e, n, t) {
   ...
   const r = a.forwardRef(function (e, n) {
     const [t, r] = a.useState(!1),
      ...
      v = a.useMemo(() => (e.playlist ? `${k}/embed/videoseries?${j.toString()}` : `${k}/embed/${c}?${j.toString()}`), [e.playlist, k, c, j]),
      ...
      x = b
       ...
       : null,
      y = a.useMemo(() => e.thumbnail || x || `https://i.ytimg.com/${w}/${e.playlist ? u : c}/${p}.${f}`, [e.thumbnail, x, w, e.playlist, u, c, p, f]),
     ...
     return (
      a.useEffect(() => {
       o && (I(), e.focusOnLoad && 'object' == typeof n && null != n && n.current && n.current.focus());
      }, [o, I, e.focusOnLoad, n]),
      (0, i.jsxs)(i.Fragment, {
       children: [
        !e.lazyLoad && (0, i.jsx)('link', { rel: L, href: y, as: 'image' }),
        (0, i.jsx)(i.Fragment, { children: t && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('link', { rel: 'preconnect', href: k }), (0, i.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), $ && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, i.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
        e.seo && !e.playlist && (0, i.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: s(e.id, h, y, k, e.seo) } }),
        A && !e.playlist && (0, i.jsx)('noscript', { children: (0, i.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${h} on YouTube`, children: ['Watch "', h, '" on YouTube'] }) }),
        (0, i.jsxs)(T, {
         onPointerOver: () => {
          t || r(!0);
         },
         ...
         children: [e.lazyLoad && !o && (0, i.jsx)('img', { src: y, alt: `${h} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, i.jsx)('button', { type: 'button', className: M, 'aria-label': `${m} ${h}`, 'aria-hidden': o || void 0, tabIndex: o ? -1 : 0, children: (0, i.jsx)('span', { className: 'lty-visually-hidden', children: m }) }), o && (0, i.jsx)('iframe', { ref: n, className: _, title: h, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: v, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
    ...
    o = ({ id: e, title: n, ...t }) => {
     ...
     return (0, i.jsx)('div', { ref: l, children: (0, i.jsx)(r, { adNetwork: !1, announce: 'Bekijk', cookie: !1, containerElement: 'div', id: e, title: n, poster: 'maxresdefault', ...t }) });
    };
  },
  78734(e, n, t) {
   t.d(n, { Ay: () => r, RM: () => l });
