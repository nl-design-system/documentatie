...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  57930: (e, n, a) => {
   a.r(n), a.d(n, { assets: () => t, contentTitle: () => s, default: () => p, frontMatter: () => o, metadata: () => r, toc: () => l });
   const r = JSON.parse('{"id":"handboek/developer/deprecation","title":"Versies en packages markeren als verouderd (deprecation)","description":"Hoe en waarom je een package of specifieke versie als verouderd (deprecated) markeert op NPM, zonder deze te verwijderen.","source":"@site/docs/handboek/developer/13-deprecation.md","sourceDirName":"handboek/developer","slug":"/handboek/developer/deprecation","permalink":"/handboek/developer/deprecation","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/handboek/developer/13-deprecation.md","tags":[],"version":"current","sidebarPosition":13,"frontMatter":{"title":"Versies en packages markeren als verouderd (deprecation)","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Verouderde versies (deprecation)","pagination_label":"Verouderde versies (deprecation)","description":"Hoe en waarom je een package of specifieke versie als verouderd (deprecated) markeert op NPM, zonder deze te verwijderen.","keywords":["developer","aan de slag","componenten","versionering","semver","deprecation"]},"sidebar":"handboek","previous":{"title":"SemVer: Major, Minor of Patch?","permalink":"/handboek/developer/changes"},"next":{"title":"Tips voor het bijdragen aan componenten","permalink":"/handboek/developer/bijdragen"}}');
   var i = a(86070),
    d = a(85248);
   const o = { title: 'Versies en packages markeren als verouderd (deprecation)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Verouderde versies (deprecation)', pagination_label: 'Verouderde versies (deprecation)', description: 'Hoe en waarom je een package of specifieke versie als verouderd (deprecated) markeert op NPM, zonder deze te verwijderen.', keywords: ['developer', 'aan de slag', 'componenten', 'versionering', 'semver', 'deprecation'] },
    s = 'Een package markeren als verouderd (deprecation)',
    t = {},
    l = [
