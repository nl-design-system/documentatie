 ...
 [54862],
 {
  ...
  98480: (e, n, l) => {
   ...
   const _ = (e) => {
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (C = await d.ZP.format(Z, { parser: k, plugins: [r.Z, t.ZP, i.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), P(C);
     })();
    }, [Z]);
    const S = (0, c.useId)();
    let E = c.Fragment;
    return (
     'paragraph' === x ? (E = g) : 'document' === x ? (E = h) : 'surface' === x && (E = b),
     (0, v.jsxs)('div', {
      ...
      children: [
       ...
       y &&
        (0, v.jsxs)('div', {
         ...
         hidden: !D,
         children: [
          (0, v.jsx)(m.u, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: C, trim: !0 }),
          l &&
           (0, v.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: l, textContent: d, trim: c } = e,
     u = d;
    const { title: p, type: m } = (0, r.useContext)(t.n),
     v = (0, r.useId)();
    return (
     c && (u = u.trim()),
     (0, a.jsx)(s.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: v, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, a.jsx)(o.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': v, style: l, children: s.map((e, l) => (0, a.jsxs)('span', { ...r({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (0, i.createContext)({}),
    u = (e) => {
     let { title: n, appearance: l, description: i, children: u, figure: p } = e;
     const m = { do: 'Doen', dont: 'Niet doen' },
      v = p ? 'figure' : 'div',
      g = p ? 'figcaption' : 'div';
     return (0, d.jsxs)(v, { className: (0, t.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(g, { className: (0, t.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.nv, { className: (0, t.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, d.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: m.dont })] }), (0, d.jsx)(r.nv, { children: n })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.nv, { className: (0, t.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, d.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: m.do })] }), (0, d.jsx)(r.nv, { children: n })] }), i] }), (0, d.jsx)('div', { className: (0, t.Z)(a['nlds-guideline__example']), children: (0, d.jsx)(c.Provider, { value: { title: n, type: m[l] }, children: u }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => i, a: () => t });
