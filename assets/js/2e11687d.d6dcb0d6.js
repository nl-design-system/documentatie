 ...
 [71537],
 {
         ...
         (0, u.jsx)(r._Q, {
          ...
          children: c.map((e, n) => {
           ...
           if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(e)) {
            const s = i.pI.get(e);
            t = (0, u.jsx)(a.N, { href: `/wcag/${e}`, 'aria-label': `WCAG Succescriterium ${s.sc} ${s.nl.title}`, style: { lineHeight: 1 }, children: (0, u.jsx)(g.KE, { children: `WCAG ${e}` }) }, n);
           }
           return t;
          }),
         }),
        ...
        (0, u.jsxs)('div', {
         ...
         children: [
          (0, u.jsxs)(r.LB, {
           ...
           'aria-labelledby': k,
           children: [
            (0, u.jsx)(c.DZ, { level: n, id: k, children: 'Filter acceptatiecriteria voor:' }),
            Array.from(g).map((e) =>
             (0, u.jsxs)(
              r.zB,
              {
               ...
               children: [
                ...
                (0, u.jsx)(r.lR, { htmlFor: e, children: e }),
               ],
              },
              e,
             ),
          ...
          (0, u.jsx)('div', {
           children: (0, u.jsxs)(u.Fragment, {
            children: [
             (0, u.jsxs)(o.f, { role: 'status', children: [x, ' van de ', f, ' items zijn nu zichtbaar.'] }),
             x < f
              ? (0, u.jsx)(l.$, {
                 purpose: 'secondary',
                 onClick: () => {
  ...
  14881(e, n, t) {
   ...
   const l = (0, a.forwardRef)(({ as: e, className: n, children: t, ...a }, i) => {
    ...
    d = ({ className: e, classNamePanel: n, label: t, heading: a, headingLevel: l, headingApperance: d, ...c }) => {
     ...
     return (0, o.jsxs)('details', { className: g, ...c, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(i.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [a && (0, o.jsx)(r.D, { level: l, appearance: d, children: a }), t] })] }) }), (0, o.jsx)('div', { className: m, children: c.children })] });
    };
  },
  19707(e, n, t) {
   'use strict';
  ...
  24456(e, n, t) {
   ...
   const r = ({ children: e, ...n }) => {
    ...
    o = ({ className: e, boxContent: n, ...t }) => (0, i.jsx)(r, { className: (0, s.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  24703(e, n, t) {
   'use strict';
   t.d(n, { o: () => c });
  ...
  26877(e, n, t) {
   ...
   const w = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, c.jsx)(j.n, { children: a.map((t) => (0, c.jsx)(j.K, { className: (0, r.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, p.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(h._, { children: t.tasks.map(({ checked: e, name: t, id: s }) => (0, c.jsx)(h.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, p.qZ)(s) }, s)) }), (0, c.jsx)(s.fz, { children: (0, c.jsxs)(s.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
            ...
            ? (0, c.jsx)(
               d.Z,
               {
                ...
                description: (0, c.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, c.jsxs)(i.f, { children: [(0, c.jsx)(g, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, c.jsxs)(s.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, c.jsxs)('div', {
                   children: [
                    (h.length > 0 || m.length > 0) && (0, c.jsx)(a.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    h.length > 0 &&
                     (0, c.jsx)(s.dk, {
                      links: h
                  ...
                  m.length > 0 && m.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)('section', { children: [(0, c.jsxs)(a.DZ, { level: Math.min(n + 2, 6), children: [r, ' in ', e] }), (0, c.jsx)(s.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(o.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, c.jsxs)(l.Wu, {
                 children: [
                  ...
                  (0, c.jsxs)(s.fz, { children: [(0, c.jsx)(g, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, c.jsxs)(s.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (h.length > 0 || m.length > 0) && (0, c.jsx)(s.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  h.length > 0 &&
                   (0, c.jsx)(c.Fragment, {
                  ...
                  m.length > 0 && (0, c.jsx)(c.Fragment, { children: m.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, c.jsx)(s.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    k = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(s.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, c.jsxs)(s.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, c.jsxs)(s.Xy, { children: [a ? (0, c.jsxs)(s.Er, { children: ['Vul de ', (0, c.jsx)(s.N_, { href: a, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, c.jsxs)(s.Er, { children: [(0, c.jsxs)(s.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, c.jsxs)(s.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, c.jsx)(s.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, c.jsx)(s.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    A = ({ component: e, headingLevel: n, description: t }) => {
     const a = e && p.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(u.p, { level: n, suffix: a && (0, c.jsx)(m.D, { state: a }), children: e.title }), (0, c.jsx)(s.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(a) && (0, c.jsx)(x.s, { relayStep: a, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    v = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
  ...
  48068(e, n, t) {
   ...
   var m = t(43864),
    ...
    k = t(23436),
    A = t(79532);
   const v = { boxShadow: m.A, color: u.A, cursor: h.A, dimension: p.A, fontFamily: f.A, fontFamilies: f.A, fontSize: j.A, fontSizes: j.A, fontWeight: x.A, fontWeights: x.A, lineHeight: w.A, lineHeights: w.A, number: b.A, other: k.A, textDecoration: A.A },
    y = ({ type: e }) => {
     const n = Object.hasOwn(v, e) ? e : 'other';
     return (0, c.jsx)(d.In, { children: (0, o.createElement)(v[n]) });
    };
   var T = t(76223);
   function C({ tokens: e }) {
    const n = (0, i.kD)(e),
  ...
  72197(e, n, t) {
   ...
   function c(e) {
    ...
    return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(n.p, { children: 'Als de Data Badge een icoon bevat, of een icoon bevat dat extra informatie geeft naast de tekst, dan heeft dit icoon een goed tekstalternatief, zodat de informatie ook beschikbaar is voor mensen die de de afbeelding niet kunnen zien.' }), '\n', (0, a.jsxs)(n.p, { children: ['Het beste is om altijd visueel een tekst te tonen naast of onder een icoon. Iconen zijn immers niet altijd voor iedereen duidelijk. Een tekstalternatief voor het icoon is niet nodig als er tekst in beeld is die hetzelfde betekent. Een ', (0, a.jsx)(n.code, { children: 'img' }), ' kan dan een leeg ', (0, a.jsx)(n.code, { children: 'alt' }), '-attribuut krijgen (', (0, a.jsx)(n.code, { children: 'alt=""' }), ').'] }), '\n', (0, a.jsx)(n.p, { children: 'Is het toch gewenst om alleen een icoon of een extra informatief icoon te tonen, hou dan rekening met het volgende.' }), '\n', (0, a.jsxs)(n.p, { children: ['Een ', (0, a.jsx)(n.code, { children: 'img' }), ' met een alt-attribuut is een robuuste manier om een alternatieve tekst toe te voegen.'] }), '\n', (0, a.jsx)(n.pre, { children: (0, a.jsx)(n.code, { className: 'language-html', children: '<span><img src="klok.svg" alt="tijd" />12.45</span>\n' }) }), '\n', (0, a.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, a.jsxs)(n.ul, { children: ['\n', (0, a.jsx)(n.li, { children: (0, a.jsx)(n.a, { href: '/richtlijnen/stijl/iconen/gebruik-svg/', children: 'Gebruik SVG voor iconen en geen font' }) }), '\n', (0, a.jsx)(n.li, { children: (0, a.jsx)(n.a, { href: '/richtlijnen/stijl/iconen/gebruik-svg/#toepassen-van-een-svg-in-code', children: 'Toepassen van een SVG in code' }) }), '\n', (0, a.jsx)(n.li, { children: (0, a.jsx)(n.a, { href: '/richtlijnen/content/afbeeldingen/informatieve-afbeeldingen/', children: 'Informatieve afbeeldingen' }) }), '\n'] })] });
   }
   function g(e) {
    const n = { a: 'a', code: 'code', p: 'p', ...(0, i.R)(), ...e.components };
    return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(n.p, { children: ['Gebruik zoveel mogelijk semantische HTML, bijvoorbeeld het ', (0, a.jsxs)(n.a, { href: 'https://developer.mozilla.org/en-US/docs/Web/HTML/Element/time', children: [(0, a.jsx)(n.code, { children: 'time' }), '-element'] }), ' als het om een datum of een tijd gaat.'] }), '\n', (0, a.jsxs)(n.p, { children: ['De toevoeging van de Data Badge mag niet verwarrend zijn voor gebruikers van ', (0, a.jsx)(n.a, { href: '/woordenlijst/#screenreader', children: 'screenreaders' }), '. De Data Badge geeft informatie die onmiddelijk duidelijk is voor ziende gebruikers. Dit voordeel hebben screenreadergebruikers niet.'] })] });
   }
   function m(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, i.R)(), ...e.components };
    return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(n.p, { children: 'Gebruik niet alleen kleur om de betekenis van de Data Badge duidelijk te maken. Rood staat bijvoorbeeld voor gevaar, groen bijvoorbeeld voor het feit dat iets is gelukt. Veel mensen kunnen kleur niet of niet goed waarnemen. Zorg daarom dat er een tweede manier is om de betekenis te herkennen.' }), '\n', (0, a.jsx)(n.p, { children: "Het gebruik van duidelijke teksten is hierbij een goede oplossing. Bijvoorbeeld een rode Data Badge met de tekst 'fout', en een groene Data Badge met de tekst 'gelukt'." }), '\n', (0, a.jsx)(n.p, { children: 'NL Design System richtlijnen:' }), '\n', (0, a.jsxs)(n.ul, { children: ['\n', (0, a.jsx)(n.li, { children: (0, a.jsx)(n.a, { href: '/richtlijnen/stijl/kleuren/doel/', children: 'Gebruik kleur met een doel' }) }), '\n', (0, a.jsx)(n.li, { children: (0, a.jsx)(n.a, { href: '/richtlijnen/content/tekstopmaak/kleurgebruik-in-tekst/', children: 'Gebruik van kleur in tekst' }) }), '\n'] })] });
   }
   var u = t(54672),
    h = t(37166),
    p = t(53971),
   ...
   const A = [
     ...
     { title: 'De Data Badge is niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: x.Ay, tags: ['developer'] },
    ...
    v = [
     ...
     { title: 'De Data Badge is standaard niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: w.Ay, tags: ['developer'] },
     { title: 'De Data Badge komt standaard niet voor in de focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: b.Ay, tags: ['developer'] },
    ];
   var y = t(26165),
    T = t(45009),
    C = t(29857),
   ...
   function L(e) {
    ...
    return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(n.header, { children: (0, a.jsx)(n.h1, { id: 'gebruik-data-badge', children: 'Gebruik Data Badge' }) }), '\n', (0, a.jsx)(n.h2, { id: 'css', children: 'CSS' }), '\n', (0, a.jsx)(n.p, { children: 'De CSS van deze component is gepubliceerd in een npm package:' }), '\n', (0, a.jsx)(n.p, { children: (0, a.jsx)(n.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/data-badge-css', children: '@nl-design-system-candidate/data-badge-css' }) }), '\n', (0, a.jsxs)(n.p, { children: ['Gebruik de ', (0, a.jsx)(n.code, { children: 'nl-data-badge' }), ' class name op een ', (0, a.jsx)(n.code, { children: 'span' }), ' element:'] }), '\n', (0, a.jsx)(n.pre, { children: (0, a.jsx)(n.code, { className: 'language-html', children: '<span class="nl-data-badge">42</span>\n' }) }), '\n', (0, a.jsx)(n.p, { children: 'Je kunt de CSS zo in je project installeren:' }), '\n', (0, a.jsx)(n.pre, { children: (0, a.jsx)(n.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/data-badge-css\n' }) }), '\n', (0, a.jsx)(n.p, { children: 'Als je een CDN gebruikt, dan kun je de CSS zo importeren:' }), '\n', (0, a.jsx)(n.pre, { children: (0, a.jsx)(n.code, { className: 'language-html', children: '<link\n  rel="stylesheet"\n  href="https://cdn.jsdelivr.net/npm/@nl-design-system-candidate/data-badge-css@1/dist/data-badge.css"\n/>\n' }) }), '\n', (0, a.jsxs)(n.p, { children: ['Gebruik je geen CDN, dan kun je de CSS uit ', (0, a.jsx)(n.code, { children: 'node_modules/' }), ' importeren:'] }), '\n', (0, a.jsx)(n.pre, { children: (0, a.jsx)(n.code, { className: 'language-html', children: '<link rel="stylesheet" href="node_modules/@nl-design-system-candidate/data-badge-css/dist/data-badge.css" />\n' }) }), '\n', (0, a.jsx)(n.p, { children: 'Als je CSS imports gebruikt vanuit JavaScript:' }), '\n', (0, a.jsx)(n.pre, { children: (0, a.jsx)(n.code, { className: 'language-js', children: 'import "@nl-design-system-candidate/data-badge-css/data-badge.css";\n' }) }), '\n', (0, a.jsx)(n.h2, { id: 'react', children: 'React' }), '\n', (0, a.jsx)(n.p, { children: 'De React component is gepubliceerd in een npm package:' }), '\n', (0, a.jsx)(n.p, { children: (0, a.jsx)(n.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/data-badge-react', children: '@nl-design-system-candidate/data-badge-react' }) }), '\n', (0, a.jsx)(n.p, { children: 'Je kunt de npm package zo installeren:' }), '\n', (0, a.jsx)(n.pre, { children: (0, a.jsx)(n.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/data-badge-react\n' }) }), '\n', (0, a.jsx)(n.p, { children: 'Je kunt de React component zo gebruiken:' }), '\n', (0, a.jsx)(n.pre, { children: (0, a.jsx)(n.code, { className: 'language-jsx', children: 'import { DataBadge } from "@nl-design-system-candidate/data-badge-react";\n\nexport const MyPage = () => {\n  return (\n    <html>\n      <body>\n        <DataBadge>42</DataBadge>\n      </body>\n    </html>\n  );\n};\n' }) })] });
   }
   function W(e = {}) {
    const { wrapper: n } = { ...(0, i.R)(), ...e.components };
   ...
   function O(e) {
    ...
    return (0, a.jsxs)(a.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, a.jsx)(G.Fc, { component: $, headingLevel: 1, description: I }), '\n', (0, a.jsx)(D.e, { component: $ }), '\n', (0, a.jsx)(y.Zp, { className: 'ma-implementation-card', children: (0, a.jsxs)(y.Wu, { children: [(0, a.jsx)(C.DZ, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, a.jsxs)(T.d, { children: [(0, a.jsxs)(T.P, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=2-4', children: [(0, a.jsx)(R.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, a.jsxs)(T.P, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=2-4', children: [(0, a.jsx)(R.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, a.jsx)(C.DZ, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, a.jsxs)(T.d, { children: [(0, a.jsxs)(T.P, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-data-badge--documentatie', children: [(0, a.jsx)(R.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, a.jsxs)(T.P, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/data-badge--documentatie', children: [(0, a.jsx)(R.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, a.jsx)(C.DZ, { level: 2, appearance: 'level-4', children: 'npm' }), (0, a.jsxs)(T.d, { children: [(0, a.jsxs)(T.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/data-badge-css', children: [(0, a.jsx)(R.r, { brand: 'npm' }), ' @nl-design-system-candidate/data-badge-css'] }), (0, a.jsxs)(T.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/data-badge-react', children: [(0, a.jsx)(R.r, { brand: 'npm' }), ' @nl-design-system-candidate/data-badge-react'] }), (0, a.jsxs)(T.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/data-badge-tokens', children: [(0, a.jsx)(R.r, { brand: 'npm' }), ' @nl-design-system-candidate/data-badge-tokens'] })] })] }) }), '\n', (0, a.jsx)(n.h2, { id: 'checklist-voor-toegankelijkheid', children: 'Checklist voor toegankelijkheid' }), '\n', (0, a.jsx)(d.Ay, {}), '\n', (0, a.jsx)(n.h3, { id: 'acceptatiecriteria-bij-gebruik', children: 'Acceptatiecriteria bij gebruik' }), '\n', (0, a.jsx)(l.Ay, {}), '\n', (0, a.jsx)(N.b, { headingLevel: '4', children: A.map(({ component: e, ...n }) => (0, a.jsx)(N.e, { ...n, children: (0, a.jsx)(e, {}) })) }), '\n', (0, a.jsx)(n.h3, { id: 'acceptatiecriteria-van-de-component', children: 'Acceptatiecriteria van de component' }), '\n', (0, a.jsx)(o.Ay, {}), '\n', (0, a.jsx)(N.b, { headingLevel: '4', children: v.map(({ component: e, ...n }) => (0, a.jsx)(N.e, { ...n, children: (0, a.jsx)(e, {}) })) }), '\n', (0, a.jsx)(F.o, { omitH1: !0, headingLevel: 2, children: (0, a.jsx)(W, {}) }), '\n', (0, a.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }), '\n', (0, a.jsx)(S.B, { tokens: H }), '\n', (0, a.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, a.jsx)(G.VK, { component: $, headingLevel: 3 }), '\n', (0, a.jsx)(G.$9, { component: $, headingLevel: 2 }), '\n', (0, a.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, a.jsx)(G.mu, { component: $, headingLevel: 3 }), '\n', (0, a.jsx)(G.K_, { component: $ })] });
   }
   function V(e = {}) {
    const { wrapper: n } = { ...(0, i.R)(), ...e.components };
  ...
  84471(e, n, t) {
   'use strict';
   t.d(n, { bo: () => a, KF: () => m, mJ: () => p, VZ: () => v, cR: () => A, Pv: () => f, qZ: () => r, kD: () => b, QQ: () => T, B2: () => u, Pc: () => l, f4: () => o, GT: () => k, fX: () => i, eQ: () => w, B_: () => x, o_: () => j });
