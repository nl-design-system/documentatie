 ...
 [82200],
 {
  61983: (e, t, n) => {
   ...
   const s = { title: 'Ordered list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Ordered list', pagination_label: 'Ordered list', description: 'Toont een lijst met items waarvan de volgorde betekenis heeft.', slug: '/ordered-list', sidebar_custom_props: { illustration: 'OrderedListSketch' } },
    a = void 0,
    l = { id: 'componenten/ordered-list/index', title: 'Ordered list', description: 'Toont een lijst met items waarvan de volgorde betekenis heeft.', source: '@site/docs/componenten/ordered-list/index.mdx', sourceDirName: 'componenten/ordered-list', slug: '/ordered-list', permalink: '/ordered-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/ordered-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Ordered list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Ordered list', pagination_label: 'Ordered list', description: 'Toont een lijst met items waarvan de volgorde betekenis heeft.', slug: '/ordered-list', sidebar_custom_props: { illustration: 'OrderedListSketch' } }, sidebar: 'componenten', previous: { title: 'Number input', permalink: '/number-input' }, next: { title: 'Page footer', permalink: '/page-footer' } },
    u = {},
    d = [
