/*! For license information please see 25ab1beb.62ee82b7.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [95081],
 {
  46695: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => a, default: () => c, frontMatter: () => o, metadata: () => l, toc: () => d });
   var t = i(52676),
    s = i(40139),
    r = i(97233);
  ...
  84263: (e, n, i) => {
   ...
   var o = t.forwardRef(function (e, n) {
    ...
    var v = e.playlist ? ''.concat(y, '/embed/videoseries?').concat(g.toString()) : ''.concat(y, '/embed/').concat(u, '?').concat(g.toString()),
     f = !e.thumbnail && !e.playlist && 'maxresdefault' === j,
     b = e.webp ? 'webp' : 'jpg',
     w = e.webp ? 'vi_webp' : 'vi',
     x = f
      ? (function (e, n, i, s) {
    ...
    return (
     ...
     t.createElement(
      t.Fragment,
      null,
      t.createElement('link', { rel: E, href: C, as: 'image' }),
      ...
      t.createElement(
       I,
       {
        ...
        className: ''.concat(H, ' ').concat(m ? R : ''),
        'data-title': h,
        style: s(s({ backgroundImage: 'url('.concat(C, ')') }, { '--aspect-ratio': ''.concat((z / D) * 100, '%') }), F),
       },
       t.createElement('button', { type: 'button', className: _, 'aria-label': ''.concat(p, ' ').concat(h) }),
       m && t.createElement('iframe', { ref: n, className: L, title: h, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: v }),
      ),
     )
    );
   });
