/*! For license information please see 1a4e3797.67f923b8.js.LICENSE.txt */
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [7920],
 {
  ...
  54294: (e, t, r) => {
   ...
   (a.version = r(94513)), (a.AlgoliaSearchHelper = n), (a.SearchParameters = i), (a.SearchResults = s), (e.exports = a);
  },
  20057: (e, t, r) => {
   "use strict";
   var n = r(3698);
   ...
   e.exports = (function () {
    ...
    function P(e, t, n, i) {
     var a = [],
      ...
      m = function t(r, s) {
       var h = r.pop();
       if (void 0 === h) throw { name: "RetryError", message: "Unreachable hosts - your application id may be incorrect. If the error persists, contact support@algolia.com.", transporterStackTrace: w(a) };
       var m = { data: c, headers: u, method: o, url: _(h, n.path, f), connectTimeout: s(l, e.timeouts.connect), responseTimeout: s(l, i.timeout) },
        ...
        p = {
         ...
         onRetry: function (n) {
          ...
          return (
           n.isTimedOut && l++,
           Promise.all([e.logger.info("Retryable failure", O(i)), e.hostsCache.set(h, y(h, n.isTimedOut ? g : v))]).then(function () {
            return t(r, s);
           })
          );
         },
      ...
      return function (t, i) {
       return Promise.all(
        t.map(function (t) {
         ...
         return A(e)(t.indexName, { methods: { searchForFacetValues: I } }).searchForFacetValues(a, c, r(r({}, i), u));
        }),
       );
      };
     },
       ...
       {},
       {
        methods: {
         ...
         initIndex: function (e) {
          return function (t) {
           return A(e)(t, { methods: { search: C, searchForFacetValues: I, findAnswers: Q } });
          };
         },
        },
       },
  ...
  33552: (e, t, r) => {
   ...
   var n = r(50959),
    ...
    j = r(80413),
    P = r(77207);
   const x = { searchQueryInput: "searchQueryInput_XLdH", searchVersionInput: "searchVersionInput_u8mv", searchResultsColumn: "searchResultsColumn_PfzW", algoliaLogo: "algoliaLogo_l4jV", algoliaLogoPathFill: "algoliaLogoPathFill_xmWH", searchResultItem: "searchResultItem_zSRf", searchResultItemHeading: "searchResultItemHeading_cFDv", searchResultItemPath: "searchResultItemPath_umrc", searchResultItemSummary: "searchResultItemSummary_CG8i", searchQueryColumn: "searchQueryColumn_ybZ5", searchVersionColumn: "searchVersionColumn_mi0h", searchLogoColumn: "searchLogoColumn_bI5w", loadingSpinner: "loadingSpinner_wJRk", "loading-spin": "loading-spin_Rw24", loader: "loader_nC5G" };
   var _ = r(11527);
   function E(e) {
   ...
   function w() {
    const {
     ...
     [O, N] = (0, d.K)(),
     H = { items: [], query: null, totalResults: null, totalPages: null, lastPage: null, hasMore: null, loading: null },
     [A, S] = (0, n.useReducer)((e, t) => {
      switch (t.type) {
       ...
       case "loading":
        return { ...e, loading: !0 };
       case "update":
        return O !== t.value.query ? e : { ...t.value, items: 0 === t.value.lastPage ? t.value.items : e.items.concat(t.value.items) };
       case "advance": {
    ...
    const [C, I] = (0, n.useState)(null),
     ...
     q = () => (O ? (0, y.I)({ id: "theme.SearchPage.existingResultsTitle", message: 'Search results for "{query}"', description: "The search page title for non-empty query" }, { query: O }) : (0, y.I)({ id: "theme.SearchPage.emptyResultsTitle", message: "Search the documentation", description: "The search page title for empty query" })),
     L = (0, p.zX)(function (t) {
      void 0 === t && (t = 0),
       Q.addDisjunctiveFacetRefinement("docusaurus_tag", "default"),
       Q.addDisjunctiveFacetRefinement("language", e),
       Object.entries(w.searchVersions).forEach((e) => {
        let [t, r] = e;
    ...
    return (
     ...
     }, [O, w.searchVersions, L]),
     (0, n.useEffect)(() => {
      A.lastPage && 0 !== A.lastPage && L(A.lastPage);
     }, [L, A.lastPage]),
     (0, _.jsxs)(j.Z, {
      children: [
       ...
       (0, _.jsxs)("div", {
        ...
        children: [
         ...
         A.items.length > 0
          ...
          : [O && !A.loading && (0, _.jsx)("p", { children: (0, _.jsx)(y.Z, { id: "theme.SearchPage.noResultsText", description: "The paragraph for empty search result", children: "No results were found" }) }, "no-results"), !!A.loading && (0, _.jsx)("div", { className: x.loadingSpinner }, "spinner")],
         A.hasMore && (0, _.jsx)("div", { className: x.loader, ref: I, children: (0, _.jsx)(y.Z, { id: "theme.SearchPage.fetchingNewResults", description: "The paragraph for fetching new search results", children: "Fetching new results..." }) }),
        ],
       }),
      ],
     })
   ...
   function O() {
    return (0, _.jsx)(v.FG, { className: "search-page-wrapper", children: (0, _.jsx)(w, {}) });
   }
  },
 },
]);
