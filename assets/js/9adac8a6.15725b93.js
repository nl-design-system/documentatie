    ...
    return (
     ...
     (0, i.jsx)(a.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsx)(t.dn, { tabIndex: 0, style: l, children: a.map((e, l) => (0, i.jsxs)('span', { ...s({ line: e }), children: [n && (0, i.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (e) => {
    ...
    const p = 'Doen',
     ...
     h = u ? 'figure' : 'div',
     m = u ? 'figcaption' : 'div';
    return (0, r.jsxs)(h, { className: (0, i.Z)(o['nlds-guideline'], o[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, r.jsxs)(m, { className: (0, i.Z)(o['nlds-guideline__description']), children: ['dont' === l ? (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(s.nv, { className: (0, i.Z)(o['nlds-guideline__badge'], o[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: o['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: o['nlds-guideline__title'], children: b })] }), (0, r.jsx)(s.nv, { children: n })] }) : (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)(s.nv, { className: (0, i.Z)(o['nlds-guideline__badge'], o[`nlds-guideline__badge--${l}`]), children: [(0, r.jsx)(a.Z, { 'aria-hidden': 'true', role: 'presentation', className: o['nlds-guideline__icon'] }), (0, r.jsx)('span', { className: o['nlds-guideline__title'], children: p })] }), (0, r.jsx)(s.nv, { children: n })] }), c] }), (0, r.jsx)('div', { className: (0, i.Z)(o['nlds-guideline__example']), children: d })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => o, a: () => i });
