 ...
 [68255],
 {
  14881(e, n, t) {
   ...
   var l = t(13526),
    ...
    s = t(37168),
    r = t(86070);
   const o = (0, a.forwardRef)(({ as: e, className: n, children: t, ...a }, i) => {
     const s = e || 'div',
      o = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, r.jsx)(s, { ref: i, className: o, ...a, children: t });
    }),
    c = ({ className: e, classNamePanel: n, label: t, heading: a, headingLevel: o, headingApperance: c, ...d }) => {
     ...
     return (0, r.jsxs)('details', { className: h, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(i.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [a && (0, r.jsx)(s.D, { level: o, appearance: c, children: a }), t] })] }) }), (0, r.jsx)('div', { className: g, children: d.children })] });
    };
  },
  18439(e, n, t) {
   t.d(n, { R: () => s, x: () => r });
  ...
  38953(e, n, t) {
   ...
   var l = t(28369),
    ...
    b = t(46847),
    j = t(86070);
   const v = ({ children: e }) => (0, j.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(a.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, j.jsx)(a.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   v.displayName = 'ParagraphContainer';
   const k = ({ children: e }) => (0, j.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: (0, j.jsx)(a.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   k.displayName = 'DocumentContainer';
   const f = ({ children: e }) => (0, j.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: e });
   f.displayName = 'SurfaceContainer';
   const y = globalThis.isAstro
    ? ({ language: e, className: n, code: t = '<p>No code provided</p>', rawCode: l, copyCode: a, defaultExpandedCode: s, designTokens: r }) => {
       const o = 'string' == typeof t ? t : l || '',
        c = 'string' == typeof t ? u().highlight(t, u().languages[e], e) : u().highlight(l || '', u().languages[e], e);
       return (0, j.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', n), children: [(0, j.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: r, children: (0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }) }), (0, j.jsx)(p.n, { children: (0, j.jsxs)(p.K, { label: 'Code', open: s, children: [(0, j.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: c } }) }), 'allow' === a && (0, j.jsx)(b.$, { 'data-copy-code': o, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: m = !0, children: u, container: p = 'document', language: b, designTokens: y }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(A, { parser: b, plugins: [s.A, r.Ay, o.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         w(e);
        })();
       }, [A]);
       const S = (0, h.useId)();
       let L = h.Fragment;
       return (
        'paragraph' === p ? (L = v) : 'document' === p ? (L = k) : 'surface' === p && (L = f),
        (0, j.jsxs)('div', {
         className: (0, i.A)('nlds-canvas'),
         children: [
          x && (0, j.jsx)('div', { className: (0, i.A)('nlds-canvas__example'), children: (0, j.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, j.jsx)(L, { children: (0, j.jsx)(a.v$, { children: x }) }) }) }),
          m &&
           (0, j.jsx)('div', {
          ...
          m &&
           (0, j.jsxs)('div', {
            ...
            hidden: !z,
            children: [
             (0, j.jsx)(l.M, { codeBlockLabel: 'Codevoorbeeld', syntax: b, textContent: N, trim: !0 }),
             n &&
              (0, j.jsx)('div', {
   ...
   const d = (0, o.createContext)({}),
    h = ({ title: e, appearance: n, description: t, children: o, figure: h }) => {
     const g = { do: 'Doen', dont: 'Niet doen' },
      m = h ? 'figure' : 'div',
      u = h ? 'figcaption' : 'div',
      p = 'string' == typeof t ? (0, c.jsx)(r.oz, { components: { a: i.N_ }, children: t }) : t;
