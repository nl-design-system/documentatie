 ...
 [18401, 83249, 84813],
 {
  ...
  8671(e, t, n) {
   ...
   const k = ({ name: e, description: t, relayStep: n, headingLevel: s = 2, href: r, frameworkNames: l }) => {
     return (0, i.jsxs)(b.Zp, { appearance: 'large', className: (0, g.A)('component-card', !n && 'component-card--suggestion'), component: 'section', children: [(0, i.jsx)(b.Fu, { children: (0, i.jsx)(T.s, { relayStep: n, description: `Schets van de ${e} component`, name: e }) }), (0, i.jsxs)(b.Wu, { children: [(0, i.jsxs)('div', { children: [(0, i.jsx)(m.DZ, { level: s, className: 'component-card__title', children: e }), n && (0, i.jsx)('p', { children: (0, i.jsx)(C.D, { state: n }) }), t && (0, i.jsx)(m.fz, { children: t }), l && (0, i.jsx)(m._Q, { children: l.map((e) => (0, i.jsx)(m.KE, { children: e }, e)) })] }), r && (0, i.jsx)(m.fz, { children: (0, i.jsxs)(v.N, { className: 'utrecht-link', to: ((o = r), 'string' == typeof o && !1 === o.endsWith('/') ? `${o}/` : o), children: ['Bekijk ', (0, i.jsx)('span', { className: 'w', children: e }), ' component'] }) })] })] });
     var o;
    },
    N = () => {
     const e = 'framework',
   ...
   const P = ({ children: e }) => (0, i.jsx)('ol', { className: 'nlds-anatomy-list', children: e }),
    ...
    F = ({ component: e, illustration: t }) => {
     ...
     return (0, i.jsx)(o.Suspense, { fallback: null, children: (0, i.jsxs)('figure', { className: (0, g.A)('component-anatomy'), children: [t && (0, i.jsx)(t, { height: null, className: (0, g.A)('component-anatomy__illustration') }), t && l && (0, i.jsx)('figcaption', { children: (0, i.jsx)(S.o, { omitH1: !0, headingLevel: 1, components: { ol: ({ children: e }) => (0, i.jsx)(P, { children: e }), li: ({ children: e }) => (0, i.jsx)(L, { children: e }) }, children: (0, i.jsx)(l, {}) }) })] }) });
    },
    M = ({ title: e, sc: t, status: n, children: s, headingLevel: r = 4 }) => {
     const l = G.pI.get(t),
      o = l ? `${t} ${l.nl?.title}` : t;
     return (0, i.jsxs)('div', { className: 'component-criteria-section', children: [(0, i.jsx)(m.DZ, { appearance: 'utrecht-heading-4', level: r, className: 'component-criteria-section__heading', children: e }), (t || n) && (0, i.jsxs)('dl', { className: 'component-criteria-section__dl', children: [t && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('dt', { className: 'component-criteria-section__dt', children: 'WCAG' }), (0, i.jsx)('dd', { className: 'component-criteria-section__dd', children: (0, i.jsx)(m.N_, { href: `/wcag/${t}/`, children: o }) })] }), n && (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)('dt', { className: 'component-criteria-section__dt', children: 'Status' }), (0, i.jsx)('dd', { className: 'component-criteria-section__dl', children: n })] })] }), s] });
    },
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => r, KF: () => h, mJ: () => p, VZ: () => T, cR: () => v, Pv: () => w, qZ: () => o, kD: () => x, B2: () => g, Pc: () => a, f4: () => i, GT: () => j, fX: () => l, eQ: () => y, B_: () => f, o_: () => A, Rc: () => b });
  ...
  44594(e, t, n) {
   ...
   const i = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    a = ({ name: e, relayStep: t, description: n }) => {
     const a = (0, l.fX)(t),
      c = i[e] ?? e;
     return (0, o.jsxs)(s.WK, { children: [(0, o.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, r.A)('component-illustration', `component-illustration--${a}`), fill: 'none', children: [(0, o.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, o.jsx)('rect', { width: '960', height: '540' }), (0, o.jsx)('rect', { width: '960', height: '540' })] }), (0, o.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, o.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, o.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, o.jsx)('use', { href: `/svg/componenten_overzicht_${(0, l.fX)(c)}.svg#component-illustration` })] }), (0, o.jsx)(s.$P, { className: 'component-illustration__caption', children: n })] });
    };
  },
  45282(e, t, n) {
   'use strict';
  ...
  67970(e, t, n) {
   ...
   const i = ({ state: e }) => {
    const t = (0, l.fX)(e);
    return (0, o.jsx)(s.KE, { className: (0, r.A)('estafette-badge', t && `estafette-badge--${t}`), children: e });
   };
  },
  69284(e, t, n) {
   'use strict';
  ...
  76310(e, t, n) {
   ...
   var s = n(13526),
    ...
    i = n(86070);
   function a({ className: e }) {
    return (0, i.jsx)(o.A, { type: 'caution', title: (0, i.jsx)(l.Rc, {}), className: (0, s.A)(e, r.G.common.unlistedBanner), children: (0, i.jsx)(l.Uh, {}) });
   }
   function c(e) {
    return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(l.AE, {}), (0, i.jsx)(a, { ...e })] });
   }
  },
  79540(e, t, n) {
   'use strict';
   n.d(t, { AE: () => a, Rc: () => o, TT: () => d, Uh: () => i, Yh: () => c });
   n(30758);
   var s = n(18236),
    r = n(70241),
    l = n(86070);
   function o() {
    return (0, l.jsx)(s.A, { id: 'theme.contentVisibility.unlistedBanner.title', description: 'The unlisted content banner title', children: 'Unlisted page' });
   }
   function i() {
    return (0, l.jsx)(s.A, { id: 'theme.contentVisibility.unlistedBanner.message', description: 'The unlisted content banner message', children: 'This page is unlisted. Search engines will not index it, and only users having a direct link can access it.' });
   }
   function a() {
    return (0, l.jsx)(r.A, { children: (0, l.jsx)('meta', { name: 'robots', content: 'noindex, nofollow' }) });
   }
   function c() {
    return (0, l.jsx)(s.A, { id: 'theme.contentVisibility.draftBanner.title', description: 'The draft content banner title', children: 'Draft page' });
   }
   function d() {
    return (0, l.jsx)(s.A, { id: 'theme.contentVisibility.draftBanner.message', description: 'The draft content banner message', children: 'This page is a draft. It will only be visible in dev and be excluded from the production build.' });
   }
  },
  90495(e, t, n) {
   'use strict';
   ...
   var s = n(46447),
    r = n(13526),
    l = n(86070);
   const o = ({ background: e, children: t, className: n, ...s }) => (0, l.jsx)('div', { className: (0, r.A)('card__illustration', e && `card__illustration--${e}`, n), ...s, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: o = 'div', background: i, children: a }) => {
     const c = (e) => ('article' === o ? (0, l.jsx)('article', { ...e }) : 'section' === o ? (0, l.jsx)('section', { ...e }) : (0, l.jsx)('div', { ...e })),
      d = (0, l.jsx)(c, { className: (0, r.A)('cardgroup__card', i && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, l.jsx)(s.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: d }) : d;
    },
    c = ({ appearance: e = 'medium', children: t, className: n }) => (0, l.jsx)('div', { className: (0, r.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
  99816(e, t, n) {
   'use strict';
   n.d(t, { A: () => o });
