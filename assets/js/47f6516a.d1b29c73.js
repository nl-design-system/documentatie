 ...
 [75809],
 {
  35254: (e, n, i) => {
   ...
   function g(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: "Voeg bij opgenomen video's de inhoud ook als uitgeschreven tekst toe." }), '\n', (0, r.jsx)(n.p, { children: 'Uitgeschreven tekst van de inhoud kan verschillende gebruikers helpen, zoals mensen die:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: 'doofblind zijn en de tekst met een brailleregel lezen;' }), '\n', (0, r.jsx)(n.li, { children: 'niet goed genoeg kunnen zien of snel genoeg kunnen lezen om de ondertiteling te begrijpen;' }), '\n', (0, r.jsx)(n.li, { children: 'niet goed genoeg kunnen horen om de gesproken tekst te verstaan.' }), '\n'] }), '\n', (0, r.jsx)(n.p, { children: 'Deze gebruikers kunnen de tekst dan in hun eigen tempo en met hun eigen hulpmiddelen lezen.' })] });
   }
   function p(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(g, { ...e }) }) : g(e);
   }
   const u = { title: 'WCAG-succescriterium 1.2.8 Media-alternatief (vooraf opgenomen)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.2.8 Media-alternatief (vooraf opgenomen)', pagination_label: 'WCAG-succescriterium 1.2.8 Media-alternatief (vooraf opgenomen)', description: "Voeg bij opgenomen video's de inhoud ook als uitgeschreven tekst toe.", slug: '1.2.8', keywords: ['WCAG', 'AAA', 'waarneembaar', 'op tijd gebaseerde media', 'perceivable', 'time-based media', 'media alternative (prerecorded)', 'prerecorded', 'vooraf opgenomen'] },
    m = void 0,
    j = { id: 'wcag/1.2.08', title: 'WCAG-succescriterium 1.2.8 Media-alternatief (vooraf opgenomen)', description: "Voeg bij opgenomen video's de inhoud ook als uitgeschreven tekst toe.", source: '@site/docs/wcag/1.2.08.mdx', sourceDirName: 'wcag', slug: '/wcag/1.2.8', permalink: '/wcag/1.2.8', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.2.08.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.2.8 Media-alternatief (vooraf opgenomen)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.2.8 Media-alternatief (vooraf opgenomen)', pagination_label: 'WCAG-succescriterium 1.2.8 Media-alternatief (vooraf opgenomen)', description: "Voeg bij opgenomen video's de inhoud ook als uitgeschreven tekst toe.", slug: '1.2.8', keywords: ['WCAG', 'AAA', 'waarneembaar', 'op tijd gebaseerde media', 'perceivable', 'time-based media', 'media alternative (prerecorded)', 'prerecorded', 'vooraf opgenomen'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.2.7 Verlengde audiodescriptie (vooraf opgenomen)', permalink: '/wcag/1.2.7' }, next: { title: 'WCAG-succescriterium 1.2.9 Louter-geluid (live)', permalink: '/wcag/1.2.9' } },
    v = {},
    x = [
   ...
   function f(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', (0, r.jsx)(o.j, { level: 1, conformanceLevel: 'Niveau AAA', children: 'WCAG-succescriterium 1.2.8 Media-alternatief (vooraf opgenomen)' }), '\n', (0, r.jsx)(l.CY, { children: (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(c.ZP, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, r.jsx)(p, {}), '\n', (0, r.jsx)(n.h2, { id: 'opgelet', children: 'Opgelet' }), '\n', (0, r.jsx)(n.p, { children: 'Deze inhoud wordt binnenkort aangevuld met uitgebreidere uitleg, bronnen en informatie over hoe te testen.' }), '\n', (0, r.jsx)(n.h2, { id: 'gerelateerde-nl-design-system-richtlijnen', children: 'Gerelateerde NL Design System-richtlijnen' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Content: ', (0, r.jsx)(n.a, { href: '/richtlijnen/content/video/transcript', children: 'Transcript bij video' }), '.'] }), '\n'] }), '\n', (0, r.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, r.jsx)(a.ZP, {}), '\n', (0, r.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#media-alternative-prerecorded', children: (0, r.jsx)('span', { lang: 'en', children: '1.2.8 Media Alternative (Prerecorded)' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#media-alternatief-vooraf-opgenomen', children: '1.2.8 Media-alternatief (vooraf opgenomen)' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, r.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#media-alternative-prerecorded', children: (0, r.jsx)('span', { lang: 'en', children: 'Quick Reference 1.2.8 Media Alternative (Prerecorded)' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/media-alternative-prerecorded.html', children: (0, r.jsx)('span', { lang: 'en', children: 'Understanding SC 1.2.8 Media Alternative (Prerecorded)' }) }), '.'] }), '\n'] }), '\n', (0, r.jsx)(l.CY, { children: (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(d.ZP, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(h.ZP, {}) })] });
   }
   function w(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
  ...
  57716: (e, n, i) => {
   ...
   const o = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, s.jsx)(r.Z, { components: { ...d(i, t), ...a(o), ...l }, children: n });
    };
  },
  46364: (e, n, i) => {
   i.d(n, { j: () => o });
