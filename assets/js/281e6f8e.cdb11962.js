 ...
 [98218],
 {
  ...
  82415: (e, n, i) => {
   ...
   var t = i(56150),
    ...
    a = i(52676);
   const l = (e) => {
    let { listId: n = '', laPostaId: i = '', thanksPage: l = '', emailFieldId: o = '', firstNameFieldId: d = '', orgId: c = '', interestsId: h = '', interests: m = [], workAreasId: p = '', privacyPolicyId: j = '', language: u = {} } = e;
    const {
      register: v,
      handleSubmit: g,
      formState: { errors: x },
    ...
    return (0, a.jsxs)('form', {
     ...
     children: [(0, a.jsxs)(t.Wi, { type: 'email', children: [(0, a.jsx)(t.nv, { children: (0, a.jsx)(t.lX, { htmlFor: `id-${o}`, children: f ? 'Email address ' : 'E-mailadres' }) }), x[o] && (0, a.jsx)(t.w7, { children: x[o].message }), (0, a.jsx)(t.nv, { children: (0, a.jsx)(t.fE, { id: `id-${o}`, name: o, type: 'email', autoComplete: 'email', 'aria-required': 'true', ...v(`${o}`, { required: { value: !0, message: f ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' }, pattern: { value: /\S+@\S+\.\S+/, message: f ? 'This is not a valid email address.' : 'Dit is geen correct emailadres.' } }), invalid: !!x[o] }) })] }), (0, a.jsxs)(t.Wi, { type: 'text', children: [(0, a.jsx)(t.nv, { children: (0, a.jsx)(t.lX, { htmlFor: d, children: f ? 'Name' : 'Naam' }) }), x[d] && (0, a.jsx)(t.w7, { children: x[d].message }), (0, a.jsx)(t.nv, { children: (0, a.jsx)(t.fE, { id: d, name: d, type: 'text', autoComplete: 'given-name', 'aria-required': 'true', ...v(`${d}`, { required: { value: !0, message: f ? 'This field is required, but it was left empty.' : 'Dit veld is verplicht, maar het is niet ingevuld.' } }), invalid: !!x[d] }) })] }), c && (0, a.jsxs)(t.Wi, { type: 'text', children: [(0, a.jsx)(t.nv, { children: (0, a.jsx)(t.lX, { htmlFor: c, children: 'Organisatie' }) }), x[c] && (0, a.jsx)(t.w7, { children: x[c].message }), (0, a.jsx)(t.nv, { children: (0, a.jsx)(t.fE, { id: c, name: c, type: 'text' }) })] }), h && (0, a.jsxs)(t.pg, { children: [(0, a.jsx)(t.Qv, { children: 'Waar wil je NL Design System voor gebruiken? (niet verplicht)' }), (0, a.jsx)(t.ue, { children: 'Meerdere antwoorden mogelijk.' }), m.map((e, n) => (0, a.jsx)(t.Wi, { type: 'checkbox', children: (0, a.jsxs)(t.nv, { children: [(0, a.jsx)(t.XZ, { name: `${h}[]`, value: n >= 6 ? n + 2 : n + 1, id: `${h}-${n + 1}` }), (0, a.jsx)(t.lX, { htmlFor: `${h}-${n + 1}`, children: e })] }) }, e))] }), p && (0, a.jsxs)(t.Wi, { type: 'text', children: [(0, a.jsxs)(t.nv, { children: [(0, a.jsx)(t.lX, { htmlFor: p, children: 'Aan wat voor projecten werk je? (niet verplicht)' }), (0, a.jsx)(t.ue, { children: 'Denk aan mijn-omgevingen, formulieren en/of kaarten.' })] }), (0, a.jsx)(t.nv, { children: (0, a.jsx)(t.gx, { id: p, name: p }) })] }), j && (0, a.jsxs)(t.Wi, { type: 'text', children: [(0, a.jsx)(t.ue, { id: `${j}-description`, children: (0, a.jsxs)('p', { children: ['Op onze activiteiten is de ', (0, a.jsx)('a', { href: '/privacyverklaring', children: 'privacyverklaring van NL Design System' }), ' van toepassing.'] }) }), (0, a.jsxs)(t.Wi, { type: 'checkbox', children: [(0, a.jsx)(t.XZ, { value: '1', id: `${j}-1`, 'aria-describedby': `${j}-description`, 'aria-required': 'true', ...v(`${j}[]`, { required: { value: !0, message: 'Je kunt je alleen aanmelden als je akkoord gaat met de privacyverklaring.' } }), invalid: !!x[`${j}[]`] }), (0, a.jsxs)(t.lX, { htmlFor: `${j}-1`, children: [' ', 'Ik ga akkoord met het gebruik van mijn gegevens volgens de privacyverklaring'] })] }), x[j] && (0, a.jsx)(t.w7, { children: x[j].message })] }), u && (0, a.jsx)('input', { type: 'hidden', name: u.id, value: u.value }), (0, a.jsx)(t.hE, { children: (0, a.jsx)(t.zx, { type: 'submit', appearance: 'primary-action-button', children: f ? 'Sign up' : 'Aanmelden' }) }), (0, a.jsx)('input', { type: 'hidden', name: 'next', value: l }), (0, a.jsx)('input', { type: 'hidden', name: 'a', value: i }), (0, a.jsx)('input', { type: 'hidden', name: 'l', value: n }), (0, a.jsx)('input', { name: 'osnD9cWRI3', autoComplete: 'on', id: 'id-osnD9cWRI3', type: 'hidden', value: 'NLDS website' }), (0, a.jsx)('input', { autoComplete: 'new-password', type: 'email', id: 'email', name: 'email', placeholder: 'Your e-mail here', className: 'sr-only', 'aria-hidden': 'true' })],
    });
   };
  },
  24785: (e, n, i) => {
