...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [42843],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => u, mJ: () => m, VZ: () => y, cR: () => z, Pv: () => g, qZ: () => l, kD: () => k, B2: () => p, Pc: () => s, f4: () => a, GT: () => b, fX: () => o, eQ: () => f, B_: () => v, o_: () => x, Rc: () => w });
  ...
  36378(e, n, t) {
   (t.r(n), t.d(n, { assets: () => H, component: () => $, contentTitle: () => Z, default: () => X, description: () => G, frontMatter: () => E, issueNumber: () => P, metadata: () => r, title: () => O, toc: () => U }));
   ...
   const V = [
     ...
     { title: 'Een Text Input die om persoonlijke gegevens vraagt heeft het juiste autocomplete-attribuut.', sc: '1.3.5', status: '', component: p, tags: ['developer'] },
     ...
     { title: 'De bezoeker kan de Text Input tot 400% vergroten zonder verlies van functionaliteit of informatie.', sc: '1.4.10', status: '', component: j.Ay, tags: ['developer'] },
     {
    ...
    C = [
     { title: 'Het is mogelijk om autocomplete in te stellen bij de Text Input.', sc: '1.3.5', status: '', component: p, tags: ['developer'] },
