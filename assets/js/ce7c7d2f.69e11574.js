 ...
 [7309],
 {
  ...
  73460: (e, n, l) => {
   ...
   const v = (e) => {
    ...
    let F = c.Fragment;
    return (
     "paragraph" === f ? (F = b) : "document" === f ? (F = g) : "surface" === f && (F = j),
     (0, m.jsxs)("div", {
      className: (0, r.Z)(h["nlds-canvas"]),
      children: [
       w && (0, m.jsx)("div", { className: (0, r.Z)(h["nlds-canvas__example"]), children: (0, m.jsx)("div", { className: "voorbeeld-theme", style: _, children: (0, m.jsx)(F, { children: (0, m.jsx)(i.pu, { children: w }) }) }) }),
       k &&
        (0, m.jsx)("div", {
