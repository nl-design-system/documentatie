 ...
 [42843],
 {
        ...
        (0, m.jsxs)('div', {
         ...
         children: [
          (0, m.jsxs)(a.LB, {
           ...
           'aria-labelledby': w,
           children: [
            (0, m.jsx)(c.DZ, { level: n, id: w, children: 'Filter acceptatiecriteria voor:' }),
            Array.from(u).map((e) =>
             (0, m.jsxs)(
              a.zB,
              {
  ...
  24456(e, n, t) {
   ...
   const a = ({ children: e, ...n }) => {
    ...
    l = ({ className: e, boxContent: n, ...t }) => (0, o.jsx)(a, { className: (0, i.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  26165(e, n, t) {
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => r, KF: () => g, mJ: () => p, VZ: () => A, cR: () => k, Pv: () => j, qZ: () => a, kD: () => b, QQ: () => y, B2: () => m, Pc: () => s, f4: () => l, GT: () => w, fX: () => o, eQ: () => v, B_: () => x, o_: () => f });
