 ...
 [49189],
 {
  ...
  16764(e, n, t) {
   ...
   var p = t(43864),
    ...
    A = t(79532),
    C = t(30758);
   const S = { boxShadow: p.A, color: j.A, cursor: x.A, dimension: v.A, fontFamily: f.A, fontFamilies: f.A, fontSize: k.A, fontSizes: k.A, fontWeight: b.A, fontWeights: b.A, lineHeight: y.A, lineHeights: y.A, number: w.A, other: D.A, textDecoration: A.A },
    T = ({ type: e }) => {
       ...
       children: [
        ...
        (0, u.jsx)(o.BF, {
         children: s.map((n) => {
          const t = (0, r.o_)(n),
           s = (0, r.eQ)(e, n).$type;
          return (0, u.jsxs)(o.Hj, { children: [(0, u.jsx)(o.nA, { children: (0, u.jsx)(a.C, { children: (0, u.jsx)(o.kf, { children: t }) }) }), (0, u.jsx)(o.nA, { children: (0, u.jsxs)(i.K, { children: [(0, u.jsx)(T, { type: s }), ' ', s] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  24215(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => R, component: () => M, contentTitle: () => _, default: () => V, description: () => G, frontMatter: () => z, issueNumber: () => P, metadata: () => a, title: () => B, toc: () => I }));
  ...
  76097(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => m, mJ: () => p, VZ: () => w, cR: () => y, Pv: () => j, qZ: () => o, kD: () => k, B2: () => u, Pc: () => l, f4: () => s, GT: () => b, fX: () => r, eQ: () => f, B_: () => v, o_: () => x });
