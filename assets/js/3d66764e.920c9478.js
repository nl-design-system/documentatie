...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [19419],
 {
  ...
  65304: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => v, contentTitle: () => d, default: () => u, frontMatter: () => s, metadata: () => c, toc: () => p });
   var a = t(52676),
    l = t(40139),
    i = t(43599),
    r = t(40761),
  ...
  43599: (e, n, t) => {
   ...
   const m = (e) => {
    ...
    let A = v.Fragment;
    return (
     'paragraph' === f ? (A = u) : 'document' === f ? (A = b) : 'surface' === f && (A = h),
     (0, g.jsxs)('div', {
  ...
  41179: (e, n, t) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: t, textContent: d, trim: c } = e,
     v = d;
    const { title: p, type: g } = (0, i.useContext)(r.n),
     u = (0, i.useId)();
    return (
     c && (v = v.trim()),
     (0, s.jsx)(l.y$, {
      ...
      children: (e) => {
       ...
       return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: u, children: ['codevoorbeeld ', g ? `\u201c${g}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, s.jsx)(a.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': u, style: t, children: l.map((e, t) => (0, s.jsxs)('span', { ...i({ line: e }), children: [n && (0, s.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
