 ...
 [31466],
 {
  ...
  70348(e, l, n) {
   ...
   var r = n(13526),
    ...
    o = n(37168),
    t = n(86070);
   const c = (0, s.forwardRef)(({ as: e, className: l, children: n, ...s }, a) => {
     const o = e || 'div',
      c = (0, r.A)('ma-utrecht-accordion', 'utrecht-accordion', l);
     return (0, t.jsx)(o, { ref: a, className: c, ...s, children: n });
    }),
    i = ({ className: e, classNamePanel: l, label: n, heading: s, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, t.jsxs)('details', { className: h, ...d, children: [(0, t.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, t.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, t.jsx)('span', { className: 'nl-button__icon-start', children: (0, t.jsx)(a.A, {}) }), (0, t.jsxs)('span', { className: 'nl-button__label', children: [s && (0, t.jsx)(o.D, { level: c, appearance: i, children: s }), n] })] }) }), (0, t.jsx)('div', { className: u, children: d.children })] });
    };
  },
  80731(e, l, n) {
   n.d(l, { H: () => y });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: l, className: n }) => {
       ...
       return (0, v.jsxs)('div', { className: (0, a.A)('ma-canvas-astro', n), children: [(0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: s } }), (0, v.jsx)(g.n, { children: (0, v.jsx)(g.K, { label: 'Code', children: (0, v.jsx)('pre', { className: 'language-html nl-code-block', children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
