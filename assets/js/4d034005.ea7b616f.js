/*! For license information please see 4d034005.ea7b616f.js.LICENSE.txt */
'use strict';
 ...
 [26733],
 {
  ...
  29680(e, n, t) {
   ...
   var i = t(24456),
    r = t(13526),
    s = t(86070);
   const o = ({ className: e, children: n, purpose: t, iconStart: i, iconEnd: o, href: a }) => (0, s.jsxs)('a', { className: (0, r.A)('nl-button', e, { 'nl-button--primary': 'primary' === t, 'nl-button--secondary': 'secondary' === t, 'nl-button--subtle': 'subtle' === t }), href: a, children: [i && (0, s.jsx)('span', { className: 'nl-button__icon-start', children: i }), (0, s.jsx)('span', { className: 'nl-button__label', children: n }), o && (0, s.jsx)('span', { className: 'nl-button__icon-end', children: o })] }),
    a = globalThis.isAstro
     ? ({ appearance: e, href: n, ...t }) => {
        let i = 'primary';
        return ((i = 'secondary-action' === e ? 'secondary' : i), (0, s.jsx)(o, { purpose: i, href: n, ...t }));
       }
     : ({ appearance: e, ...n }) => (0, s.jsx)(i.F, { className: (0, r.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...n });
  },
  35683(e, n, t) {
   t.d(n, { K: () => i.e2 });
   var i = t(29181);
  ...
  51785(e, n, t) {
   (t.r(n), t.d(n, { assets: () => p, contentTitle: () => c, default: () => m, frontMatter: () => d, metadata: () => i, toc: () => g }));
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => r, KF: () => g, mJ: () => h, VZ: () => D, cR: () => x, Pv: () => k, qZ: () => o, kD: () => f, QQ: () => A, B2: () => u, Pc: () => l, f4: () => a, GT: () => w, fX: () => s, eQ: () => b, B_: () => j, o_: () => v });
