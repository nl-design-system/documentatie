 ...
 [7066],
 {
  5461: (e, n, s) => {
   ...
   const o = { title: "Progress list", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Progress list", pagination_label: "Progress list", description: "UX richtlijnen voor Progress list component", slug: "/progress-list", tags: ["Unknown"] },
    r = "Progress list",
    l = { id: "componenten/build/progress-list", title: "Progress list", description: "UX richtlijnen voor Progress list component", source: "@site/docs/componenten/build/progress-list.mdx", sourceDirName: "componenten/build", slug: "/progress-list", permalink: "/progress-list", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/progress-list.mdx", tags: [{ label: "Unknown", permalink: "/tags/unknown" }], version: "current", frontMatter: { title: "Progress list", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Progress list", pagination_label: "Progress list", description: "UX richtlijnen voor Progress list component", slug: "/progress-list", tags: ["Unknown"] }, sidebar: "componenten", previous: { title: "Password input", permalink: "/password-input" }, next: { title: "Progress", permalink: "/progress" } },
    a = {},
    c = [
