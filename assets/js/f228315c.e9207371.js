...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [97824],
 {
  ...
  23412: (e, n, t) => {
   t.r(n), t.d(n, { assets: () => g, contentTitle: () => c, default: () => u, frontMatter: () => r, metadata: () => d, toc: () => h });
   var l = t(52676),
    a = t(40139),
    i = t(43599),
    s = t(40761),
  ...
  43599: (e, n, t) => {
   ...
   const u = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(a.Tg, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(a.BB, { className: (0, i.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(a.nv, { className: 'nlds-canvas__example-paragraph', children: n }) }) });
   };
   u.displayName = 'ParagraphContainer';
   const p = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(a.Tg, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(a.BB, { className: (0, i.Z)('utrecht-document--surface', 'nlds-canvas__example-document'), children: n }) });
   };
   p.displayName = 'DocumentContainer';
   const b = (e) => {
    let { children: n } = e;
    return (0, m.jsx)(a.Tg, { className: 'nlds-canvas__example-surface', children: n });
   };
   ...
   const v = (e) => {
    ...
    let P = g.Fragment;
    return (
     'paragraph' === f ? (P = u) : 'document' === f ? (P = p) : 'surface' === f && (P = b),
     (0, m.jsxs)('div', {
      className: (0, i.Z)('nlds-canvas'),
      children: [
       _ && (0, m.jsx)('div', { className: (0, i.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, m.jsx)(P, { children: (0, m.jsx)(a.pu, { children: _ }) }) }) }),
       j &&
        (0, m.jsx)('div', {
         className: (0, i.Z)('nlds-canvas__toolbar'),
         children: (0, m.jsx)(a.zx, {
    ...
    return (
     ...
     (0, r.jsx)(a.y$, {
      ...
      children: (e) => {
       ...
       return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsxs)('span', { hidden: !0, id: u, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, r.jsx)(l.dn, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': u, style: t, children: a.map((e, t) => (0, r.jsxs)('span', { ...i({ line: e }), children: [n && (0, r.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, r.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
