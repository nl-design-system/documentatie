(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [31116],
 {
  ...
  26095(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => b, component: () => N, contentTitle: () => q, default: () => A, description: () => w, frontMatter: () => f, issueNumber: () => _, metadata: () => r, title: () => x, toc: () => T }));
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => u, mJ: () => y, VZ: () => w, cR: () => x, Pv: () => g, qZ: () => o, kD: () => f, B2: () => m, Pc: () => a, f4: () => i, GT: () => q, fX: () => s, eQ: () => k, B_: () => v, o_: () => p, Rc: () => b });
  ...
  99630(e, t, n) {
   ...
   const j = ({ children: e }) => (0, a.jsx)('ul', { className: 'task-list', children: e }),
    y = ({ checked: e, children: t, title: n, description: r, headingLevel: s = 3 }) => (0, a.jsxs)('li', { className: (0, c.A)('task-list-item'), children: [(0, a.jsxs)('div', { className: (0, c.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, a.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, a.jsx)(m.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, a.jsxs)('div', { children: [n ? (0, a.jsx)(u.DZ, { appearance: 'utrecht-heading-3', level: s, children: n }) : null, r, t] })] });
   var g = n(33062);
   const p = ({ component: e, headingLevel: t }) => {
            ...
            o.Zp,
            {
             ...
             children: (0, a.jsxs)(o.Wu, {
              children: [
               ...
               i.length > 0 && (0, a.jsx)(a.Fragment, { children: i.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    f = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(d.p, { level: t, suffix: c && (0, a.jsx)(h.D, { state: c }), children: e.title }), (0, a.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
 },
]);
