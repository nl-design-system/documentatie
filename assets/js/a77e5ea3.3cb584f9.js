 ...
 [66449],
 {
  1292(e, n, t) {
   ...
   var o = t(29181),
    ...
    l = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(r.A, {}), github: (0, d.jsx)(i.A, {}), npm: (0, d.jsx)(a.A, {}), storybook: (0, d.jsx)(s.A, {}) },
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => j, VZ: () => A, cR: () => z, Pv: () => g, qZ: () => a, kD: () => f, B2: () => h, Pc: () => l, f4: () => s, GT: () => v, fX: () => i, eQ: () => b, B_: () => k, o_: () => x, Rc: () => w });
   ...
   const p = (e) => [...e].sort((e, n) => d.indexOf(e) - d.indexOf(n)),
    ...
    j = (e) => p(c(e.projects.flatMap((e) => m(e)))),
    g = (e) => {
     const n = m(e),
      t = ((e) => {
  ...
  37131(e, n, t) {
   ...
   const j = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
            ...
            a.Zp,
            {
             ...
             children: (0, d.jsxs)(a.Wu, {
              children: [
               ...
               s.length > 0 && (0, d.jsx)(d.Fragment, { children: s.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(o.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, d.jsx)(o.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    k = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(o.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, d.jsxs)(o.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, d.jsxs)(o.Xy, { children: [r ? (0, d.jsxs)(o.Er, { children: ['Vul de ', (0, d.jsx)(o.N_, { href: r, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, d.jsxs)(o.Er, { children: [(0, d.jsxs)(o.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, d.jsxs)(o.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, d.jsx)(o.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, d.jsx)(o.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    b = ({ component: e, headingLevel: n, description: t }) => {
     const r = e && m.bo[e.relayStep];
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u.p, { level: n, suffix: r && (0, d.jsx)(p.D, { state: r }), children: e.title }), (0, d.jsx)(o.fz, { lead: !0, children: t })] });
    },
    f = ({ component: e }) => {
     const n = (e && j[e.title]) || [];
  ...
  88107(e, n, t) {
   (t.r(n), t.d(n, { assets: () => B, component: () => I, contentTitle: () => H, default: () => X, description: () => P, frontMatter: () => E, issueNumber: () => $, metadata: () => o, title: () => G, toc: () => W }));
   ...
   const T = [
    ...
    F = [
     ...
     { title: 'Interactieve elementen in de accordion hebben een zichtbare focusstyling', sc: '2.4.7', status: '', component: R.Ay },
    ...
    O = [
     ...
     { title: 'De accordion zorgt niet voor een toetsenbordval', sc: '2.1.2', status: '', component: N.Ay },
     {
     ...
     { title: 'De accordion wordt niet bedekt door andere content', sc: '2.4.11', status: '', component: _.Ay },
    ],
    V = [
     {
   ...
   const a = ({ background: e, children: n, className: t, ...o }) => (0, i.jsx)('div', { className: (0, r.A)('card__illustration', e && `card__illustration--${e}`, t), ...o, children: n }),
    ...
    l = ({ href: e, appearance: n, className: t, component: a = 'div', background: s, children: l }) => {
     const d = (e) => ('article' === a ? (0, i.jsx)('article', { ...e }) : 'section' === a ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      c = (0, i.jsx)(d, { className: (0, r.A)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: l });
     return e ? (0, i.jsx)(o.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: c }) : c;
    },
    d = ({ appearance: e = 'medium', children: n, className: t }) => (0, i.jsx)('div', { className: (0, r.A)('cardgroup', `cardgroup--${e}`, t), children: n });
  },
 },
]);
