 ...
 [10709],
 {
  ...
  39772: (e, n, r) => {
   ...
   function c(e) {
    ...
    return (0, s.jsxs)('div', { className: 'card', children: [n ? (0, s.jsx)(t.Z, { href: n, className: (0, l.Z)('cardLink', 'utrecht-link'), children: (0, s.jsxs)('h2', { className: 'cardTitle', children: [r, ' ', i] }) }) : (0, s.jsxs)('h2', { className: 'cardTitle', children: [r, ' ', i] }), o && (0, s.jsx)('p', { className: 'cardDescription', children: o }), c] });
   }
   function a(e) {
    let { item: n } = e;
   ...
   function d(e) {
    ...
    return (0, s.jsx)(c, { linkDescription: n.label, href: n.href, title: n.label, description: n.description ?? r?.description });
   }
   function h(e) {
    let { item: n } = e;
    switch (n.type) {
