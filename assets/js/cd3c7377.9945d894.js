(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [28568],
 {
  ...
  58160(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => x, component: () => A, contentTitle: () => b, default: () => _, description: () => z, frontMatter: () => f, issueNumber: () => D, metadata: () => r, title: () => w, toc: () => F }));
   ...
   const y = [
     ...
     { title: 'De tekst in de Form Field Description heeft een contrastratio van minimaal 4,5:1 met de achtergrondkleur.', sc: '1.4.3', status: '', component: p.Ay, tags: ['designer'] },
     { title: 'Als je de tekst van de Form Field Description vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: m.Ay, tags: ['developer'] },
    ...
    v = [
     ...
     { title: 'Tekst in de Form Field Description blijft leesbaar wanneer de tekstafstand vergroot wordt. ', sc: '1.4.12', status: '', component: j.Ay, tags: ['developer'] },
    ];
   var k = t(85825);
