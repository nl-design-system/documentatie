  ...
  55240: (e, n, t) => {
   ...
   const d = (e) => {
    ...
    h = (e) => {
     ...
     return (0, a.jsx)(l.a2, { sections: [{ className: 'utrecht-accordion--nlds-subtle', headingLevel: 3, expanded: !1, label: (0, a.jsx)('span', { children: n }), body: t.map((e, n) => (0, a.jsx)(d, { ...e }, n)) }] });
    };
  },
  8657: (e, n, t) => {
   'use strict';
          ...
          children: [
           (0, d.jsx)(k, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(f, { headingLevel: t + 1, checked: n, title: r, description: (0, A.Q6)(s) }, s);
            }),
           }),
