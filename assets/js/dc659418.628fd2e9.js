 ...
 [88963],
 {
  ...
  70348(e, n, l) {
   ...
   const c = (0, t.forwardRef)(({ as: e, className: n, children: l, ...t }, o) => {
     ...
     return (0, r.jsx)(s, { ref: o, className: c, ...t, children: l });
    }),
    i = ({ className: e, classNamePanel: n, label: l, heading: t, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, r.jsxs)('details', { className: m, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(o.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [t && (0, r.jsx)(s.D, { level: c, appearance: i, children: t }), l] })] }) }), (0, r.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => y });
