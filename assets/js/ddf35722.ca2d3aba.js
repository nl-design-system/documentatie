 ...
 [68424],
 {
  76677: (e, t, n) => {
   ...
   const s = { title: 'Form field label', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field label', pagination_label: 'Form field label', description: 'Toont een tekstlabel dat informeert over de in te vullen informatie.', slug: '/form-field-label' },
    a = void 0,
    l = { id: 'componenten/form-field-label/index', title: 'Form field label', description: 'Toont een tekstlabel dat informeert over de in te vullen informatie.', source: '@site/docs/componenten/form-field-label/index.mdx', sourceDirName: 'componenten/form-field-label', slug: '/form-field-label', permalink: '/form-field-label', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-field-label/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form field label', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field label', pagination_label: 'Form field label', description: 'Toont een tekstlabel dat informeert over de in te vullen informatie.', slug: '/form-field-label' }, sidebar: 'componenten', previous: { title: 'Form field error message', permalink: '/form-field-error-message' }, next: { title: 'Form field option label', permalink: '/form-field-option-label' } },
    u = {},
    d = [
