...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  511(e, n, i) {
   (i.r(n), i.d(n, { assets: () => u, contentTitle: () => j, default: () => x, frontMatter: () => m, metadata: () => r, toc: () => k }));
   ...
   const m = { title: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', title_sm: '2.5.7 Sleepbewegingen', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.7 Sleepbewegingen', pagination_label: 'WCAG-succescriterium 2.5.7 Sleepbewegingen', description: 'Acties waarbij men moet slepen, kunnen ook zonder slepen.', slug: '2.5.7', conformance_level: 'Niveau AA', keywords: ['WCAG', 'AA', 'bedienbaar', 'input modaliteiten', 'slepen', 'operable', 'input modalities', 'dragging movements'] },
    j = void 0,
    u = {},
