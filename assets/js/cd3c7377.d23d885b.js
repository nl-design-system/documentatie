...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [28568],
 {
  ...
  19036(e, n, t) {
   (t.r(n), t.d(n, { assets: () => N, component: () => W, contentTitle: () => R, default: () => P, description: () => S, frontMatter: () => F, issueNumber: () => L, metadata: () => r, title: () => G, toc: () => _ }));
  ...
  21034(e, n, t) {
   ...
   const j = ({ component: e, headingLevel: n }) => {
            ...
            a.Zp,
            {
             ...
             children: (0, d.jsxs)(a.Wu, {
              children: [
               ...
               (u.length > 0 || s.length > 0) && (0, d.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               u.length > 0 &&
                (0, d.jsx)(d.Fragment, {
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(g.p, { level: n, suffix: i && (0, d.jsx)(u.D, { state: i }), children: e.title }), (0, d.jsx)(r.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(i) && (0, d.jsx)(w.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    A = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  32385(e, n, t) {
   t.d(n, { bo: () => i, KF: () => g, mJ: () => h, VZ: () => k, cR: () => A, Pv: () => f, qZ: () => a, kD: () => x, QQ: () => C, B2: () => m, Pc: () => l, f4: () => s, GT: () => v, fX: () => o, eQ: () => b, B_: () => j, o_: () => w });
  ...
  70348(e, n, t) {
   ...
   const l = (0, i.forwardRef)(({ as: e, className: n, children: t, ...i }, o) => {
    ...
    d = ({ className: e, classNamePanel: n, label: t, heading: i, headingLevel: l, headingApperance: d, ...c }) => {
     ...
     return (0, s.jsxs)('details', { className: u, ...c, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(o.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [i && (0, s.jsx)(a.D, { level: l, appearance: d, children: i }), t] })] }) }), (0, s.jsx)('div', { className: g, children: c.children })] });
    };
  },
  70561(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => o });
  ...
  71544(e, n, t) {
   ...
   var u = (0, s.forwardRef)(function (e, n) {
    var t = e.children,
     ...
     d = e.purpose,
     u = (0, i.A)(e, l);
    return (0, o.jsx)('p', c(c({ className: (0, a.$)('nl-paragraph', (0, r.A)({}, 'nl-paragraph--lead', 'lead' === d), s), ref: n }, u), {}, { children: 'lead' === d ? (0, o.jsx)('b', { className: 'nl-paragraph__lead', children: t }) : t }));
   });
   ...
   var u = function (e) {
    ...
    m =
     ...
     (0, s.forwardRef)(function (e, n) {
      ...
      return (0, o.jsxs)('button', c(c({ ref: n, type: v, className: (0, a.$)('nl-button', r, { 'nl-button--pressed': j, 'nl-button--busy': b, 'nl-button--disabled': f || w, 'nl-button--primary': 'primary' === p, 'nl-button--secondary': 'secondary' === p, 'nl-button--subtle': 'subtle' === p, 'nl-button--positive': g(p) && 'positive' === h, 'nl-button--negative': g(p) && 'negative' === h, 'nl-button--icon-only': d }), 'aria-pressed': k ? String(Boolean(j)) : void 0, 'aria-disabled': f || b ? 'true' : void 0, disabled: w }, y), {}, { children: [m && (0, o.jsx)('span', { className: 'nl-button__icon-start', children: m }), A && (0, o.jsx)('span', { className: 'nl-button__label', children: A }), T ? (0, o.jsx)('span', { className: d ? 'nl-button__label' : '', children: t }) : t, u && (0, o.jsx)('span', { className: 'nl-button__icon-end', children: u })] }));
     }));
