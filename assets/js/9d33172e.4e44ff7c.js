/*! For license information please see 9d33172e.4e44ff7c.js.LICENSE.txt */
'use strict';
 ...
 [32537],
 {
  ...
  24456(e, n, t) {
   ...
   const a = ({ children: e, ...n }) => {
    ...
    r = ({ className: e, boxContent: n, ...t }) => (0, o.jsx)(a, { className: (0, s.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  29680(e, n, t) {
   t.d(n, { v: () => r });
   var s = t(24456),
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => i, KF: () => u, mJ: () => j, VZ: () => x, cR: () => w, Pv: () => k, qZ: () => a, kD: () => f, QQ: () => _, B2: () => h, Pc: () => l, f4: () => r, GT: () => v, fX: () => o, eQ: () => b, B_: () => y, o_: () => g });
