/*! For license information please see ac504141.3be3158a.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [64256],
 {
  ...
  18652(e, n, o) {
   ...
   const a = (e, n, o, a) => {
    const l = (0, t.forwardRef)(({ color: o = 'currentColor', size: l = 24, stroke: s = 2, title: i, className: d, children: p, ...c }, u) => (0, t.createElement)('svg', { ref: u, ...r[e], width: l, height: l, className: ['tabler-icon', `tabler-icon-${n}`, d].join(' '), ...('filled' === e ? { fill: o } : { strokeWidth: s, stroke: o }), ...c }, [i && (0, t.createElement)('title', { key: 'svg-title' }, i), ...a.map(([e, n]) => (0, t.createElement)(e, n)), ...(Array.isArray(p) ? p : [p])]));
  ...
  24456(e, n, o) {
   ...
   const l = ({ children: e, ...n }) => {
     const { to: o, href: t, ...l } = n;
     let s = o || t;
     const i = new URL(s, 'https://nldesignsystem.nl');
     return ('https://nldesignsystem.nl' === i.origin ? (i.pathname.endsWith('/') || (0, r.QQ)(i.pathname) || (i.pathname = `${i.pathname}/`), (s = i.toString().replace('https://nldesignsystem.nl', ''))) : ((l.target = '_blank'), (l.rel = 'noopener noreferrer')), (0, a.jsx)('a', { href: s, ...l, children: e }));
    },
    s = ({ className: e, boxContent: n, ...o }) => (0, a.jsx)(l, { className: (0, t.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...o });
  },
  29680(e, n, o) {
   o.d(n, { v: () => s });
   var t = o(24456),
    r = o(13526),
    a = o(86070);
   const l = ({ className: e, children: n, purpose: o, iconStart: t, iconEnd: l, href: s }) => (0, a.jsxs)('a', { className: (0, r.A)('nl-button', e, { 'nl-button--primary': 'primary' === o, 'nl-button--secondary': 'secondary' === o, 'nl-button--subtle': 'subtle' === o }), href: s, children: [t && (0, a.jsx)('span', { className: 'nl-button__icon-start', children: t }), (0, a.jsx)('span', { className: 'nl-button__label', children: n }), l && (0, a.jsx)('span', { className: 'nl-button__icon-end', children: l })] }),
    s = globalThis.isAstro
     ? ({ appearance: e, href: n, ...o }) => {
        let t = 'primary';
        return ((t = 'secondary-action' === e ? 'secondary' : t), (0, a.jsx)(l, { purpose: t, href: n, ...o }));
       }
     : ({ appearance: e, ...n }) => (0, a.jsx)(t.F, { className: (0, r.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...n });
  },
  35683(e, n, o) {
   o.d(n, { K: () => t.e2 });
   var t = o(29181);
  ...
  84471(e, n, o) {
   o.d(n, { bo: () => r, KF: () => u, mJ: () => v, VZ: () => w, cR: () => x, Pv: () => g, qZ: () => l, kD: () => f, QQ: () => y, B2: () => m, Pc: () => i, f4: () => s, GT: () => D, fX: () => a, eQ: () => b, B_: () => k, o_: () => j });
     ...
     return n.map((n) => {
      const t = e.tasks
       ...
       .map(({ name: t, id: r, value: a }) => {
        ...
        return { brand: l.toLowerCase(), name: t, id: r, value: a, description: s };
       });
