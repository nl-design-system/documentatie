   ...
   const p = (e) => {
    ...
    h = (e) => {
     ...
     return l.createElement(
      "div",
      { className: (0, d.Z)(t["nlds-canvas"], "voorbeeld-theme", "utrecht-html") },
      l.createElement("div", { className: (0, d.Z)(t["nlds-canvas__example"]) }, i),
      l.createElement("div", { className: (0, d.Z)(t["nlds-canvas__toolbar"]) }, l.createElement(k.zx, { className: (0, d.Z)(t["nlds-canvas__button"], t["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: p, "aria-expanded": !r, "aria-controls": _ }, r ? "Bekijk code" : "Verberg code")),
      l.createElement(
       "div",
       { className: (0, d.Z)(t["nlds-canvas__code-block"], !o && t["nlds-canvas__code-block--user-select-none"]), id: _, hidden: r },
       l.createElement(b.Z, { language: s, style: u }, h),
       o &&
        l.createElement(
         "div",
         { className: (0, d.Z)(t["nlds-canvas__toolbar"]) },
         l.createElement(
          k.zx,
          {
           className: (0, d.Z)(t["nlds-canvas__button"], t["nlds-canvas__copy-button"]),
  ...
  31092: (e, n, o) => {
   ...
   const c = (e) => {
    ...
    const m = { do: "Doen", dont: "Niet doen" },
     g = n ? `${m[o]}: ${n}` : m[o];
    return l.createElement("div", { className: (0, a.Z)(r["nlds-guideline"], r[`nlds-guideline--${o}`]), id: null == n ? void 0 : n.toLowerCase().replace(/\s/g, "-") }, l.createElement("div", { className: (0, a.Z)(r["nlds-guideline__description"]) }, "dont" === o ? l.createElement(i.nv, { className: (0, a.Z)(r["nlds-guideline__badge"], r[`nlds-guideline__badge--${o}`]) }, l.createElement(t.Z, { className: r["nlds-guideline__icon"] }), l.createElement("span", { className: r["nlds-guideline__title"] }, g)) : l.createElement(i.nv, { className: (0, a.Z)(r["nlds-guideline__badge"], r[`nlds-guideline__badge--${o}`]) }, l.createElement(d.Z, { className: r["nlds-guideline__icon"] }), l.createElement("span", { className: r["nlds-guideline__title"] }, g)), c), l.createElement("div", { className: (0, a.Z)(r["nlds-guideline__example"]) }, s));
   };
  },
  19712: (e, n, o) => {
   o.r(n), o.d(n, { assets: () => g, contentTitle: () => s, default: () => v, frontMatter: () => c, metadata: () => m, toc: () => b });
   var l = o(87462),
    t = o(67294),
    d = o(3905),
    r = o(13455),
   ...
   const c = { title: "Goed gecontroleerd | Formulieren", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Goed gecontroleerd", sidebar_position: 4, pagination_label: "Goed gecontroleerd", description: "Formuliervalidatie werkt het best met duidelijke en goed getimede foutmeldingen en logische validatieregels", keywords: ["richtlijnen", "formulieren", "toegankelijkheid", "labels"] },
    ...
    b = [
     ...
     { value: "Geldige emailadressen", id: "geldige-emailadressen", level: 3 },
   ...
   function v(e) {
    ...
    return (0, d.kt)(k, (0, l.Z)({}, u, o, { components: n, mdxType: "MDXLayout" }), (0, d.kt)("h1", { id: "goed-gecontroleerd" }, "Goed gecontroleerd"), (0, d.kt)(i.nv, { lead: !0, mdxType: "Paragraph" }, "Formuliervalidatie werkt het best met duidelijke en goed getimede foutmeldingen en logische validatieregels."), (0, d.kt)("h2", { id: "zorg-voor-duidelijke-foutmeldingen" }, "Zorg voor duidelijke foutmeldingen"), (0, d.kt)("p", null, "Bij foutmeldingen is het belangrijk dat ze precies beschrijven wat er niet klopt aan de invoer, om het gebruikers zo makkelijk mogelijk te maken een fout te herstellen."), (0, d.kt)("p", null, "Zeg bijvoorbeeld niet: \u201cDit BSN is niet geldig\u201d, maar leg uit dat een BSN-nummer uit 10 karakters bestaat."), (0, d.kt)("p", null, "Plaats foutmeldingen tussen het invoerveld en het label. Zo zijn ze het best te vinden voor bijvoorbeeld gebruikers met vergrootsoftware."), (0, d.kt)(a.X, { appearance: "do", title: "Foutmelding tussen label en veld", description: (0, d.kt)(i.nv, { mdxType: "Paragraph" }, "Foutmeldingen werken het best tussen label en veld."), mdxType: "Guideline" }, (0, d.kt)(r.X, { language: "html", code: (0, d.kt)(t.Fragment, null, (0, d.kt)("label", { htmlFor: "bsn" }, "Burgerservicenummer"), (0, d.kt)("p", { id: "error" }, "Foutieve invoer: een burgerservicenummer bestaat uit 10 cijfers"), (0, d.kt)("input", { type: "text", name: "bsn", id: "bsn", "aria-describedby": "error" })), copy: !0, defaultCollapsed: !0, mdxType: "Canvas" }, (0, d.kt)(i.Wi, { type: "text", mdxType: "FormField" }, (0, d.kt)(i.nv, { className: "utrecht-form-field__label", mdxType: "Paragraph" }, (0, d.kt)(i.lX, { htmlFor: "bsn", mdxType: "FormLabel" }, "Burgerservicenummer")), (0, d.kt)(i.ue, { className: "utrecht-form-field__description", style: { color: "darkred" }, id: "error", mdxType: "FormFieldDescription" }, "Foutieve invoer: een burgerservicenummer bestaat uit 10 cijfers."), (0, d.kt)(i.fE, { name: "bsn", id: "bsn", "aria-describedby": "error", mdxType: "Textbox" })))), (0, d.kt)("h2", { id: "toon-foutmeldingen-op-het-juiste-moment" }, "Toon foutmeldingen op het juiste moment"), (0, d.kt)("p", null, "Wacht met het tonen van foutmeldingen totdat de gebruiker het veld heeft ingevuld, of zelfs tot de hele sectie of het hele formulier is ingevuld. Zo wordt de gebruiker niet met foutmeldingen geconfronteerd, terwijl ze nog niet klaar zijn met hun invoer."), (0, d.kt)("h2", { id: "keur-niet-te-snel-af" }, "Keur niet te snel af"), (0, d.kt)("h3", { id: "geldige-emailadressen" }, "Geldige emailadressen"), (0, d.kt)("p", null, "Sommige mensen gebruiken een ", (0, d.kt)("inlineCode", { parentName: "p" }, "+"), " in hun emailadres, bijvoorbeeld om emails makkelijker te kunnen groeperen. Zo kiezen ze voor ", (0, d.kt)("inlineCode", { parentName: "p" }, "naam+school@voorbeeld.nl"), " voor emails van school en ", (0, d.kt)("inlineCode", { parentName: "p" }, "naam+werk@voorbeeld.nl"), " voor emails over werk. Dit zijn geldige emailadressen, keur ze dus niet af."), (0, d.kt)("h3", { id: "eenduidig-te-herschrijven" }, "Eenduidig te herschrijven"), (0, d.kt)("p", null, "Postcodes kunnen op verschillende manieren worden geschreven: bijvoorbeeld \u201c1234 AA\u201d (met spatie), \u201c1234AA\u201d (zonder spatie), \u201c1234aa\u201d (met kleine letters)."), (0, d.kt)("p", null, "In code kunnen deze vormen gemakkelijk naar elkaar worden herschreven. Door alle vormen te accepteren, geef je prioriteit aan de gebruiker, in plaats van aan je systeem."), (0, d.kt)("h3", { id: "minimale-en-maximale-tekstlengtes" }, "Minimale en maximale tekstlengtes"), (0, d.kt)("p", null, "Soms is het verleidelijk om met minimale of maximale lengtes te werken. Maar in veel gevallen, bijvoorbeeld bij namen, kan dit bijvoorbeeld zorgen dat mensen hun naam niet kunnen invullen. Optimaliseer in dit geval voor uitersten. Er zijn namen van \xe9\xe9n karakter en van vijftig: aannames vermijden is dus het devies."));
   }
   v.isMDXComponent = !0;
  },
 },
