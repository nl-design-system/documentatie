 ...
 [5011],
 {
  ...
  50226(e, n, l) {
   ...
   function c(e) {
    ...
    return (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', (0, o.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, o.jsx)(a.$, { appearance: 'do', title: 'Koppel het label aan het formulierveld.', children: (0, o.jsx)(i.H, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('p', { children: (0, o.jsx)('label', { htmlFor: 'kleur3', children: 'Wat is je lievelingskleur?' }) }), (0, o.jsx)('p', { children: (0, o.jsx)('input', { type: 'text', id: 'kleur3', name: 'lievelingskleur' }) })] }) }) }), '\n', (0, o.jsx)(a.$, { appearance: 'do', title: 'Koppel het label aan het formulierveld (select).', children: (0, o.jsx)(i.H, { language: 'html', children: () => (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)('p', { children: (0, o.jsx)('label', { htmlFor: 'kleur4', children: 'Wat is je lievelingskleur?' }) }), (0, o.jsx)('p', { children: (0, o.jsxs)('select', { id: 'kleur4', name: 'lievelingskleur', children: [(0, o.jsx)('option', { children: 'Rood' }), (0, o.jsx)('option', { children: 'Blauw' }), (0, o.jsx)('option', { children: 'Wit' })] }) })] }) }) }), '\n', (0, o.jsx)(a.$, { appearance: 'dont', title: 'Een div in plaats van een label gebruiken.', description: 'De for en id koppeling werkt alleen met een label-element.', children: (0, o.jsx)(i.H, { language: 'html', children: () => (0, o.jsxs)('div', { 'datatest-id': 'exclude-axe', children: [(0, o.jsx)('div', { htmlFor: 'kleur5', children: 'Wat is je lievelingskleur?' }), (0, o.jsx)('input', { type: 'text', id: 'kleur5', name: 'lievelingskleur' })] }) }) }), '\n', (0, o.jsx)(a.$, { appearance: 'dont', title: 'Een label zonder gekoppelde input. Door het label-element te gebruiken zonder for mis je de koppeling tussen het label en de input voor mensen die de visuele context niet waarnemen.', children: (0, o.jsx)(i.H, { language: 'html', children: () => (0, o.jsxs)('div', { 'datatest-id': 'exclude-axe', children: [(0, o.jsx)('p', { children: (0, o.jsx)('label', { children: 'Wat is je lievelingskleur?' }) }), (0, o.jsx)('p', { children: (0, o.jsxs)('select', { name: 'lievelingskleur', children: [(0, o.jsx)('option', { children: 'Rood' }), (0, o.jsx)('option', { children: 'Blauw' }), (0, o.jsx)('option', { children: 'Wit' })] }) })] }) }) })] });
   }
   function d(e = {}) {
  ...
  58639(e, n, l) {
   ...
   const j = ({ children: e }) => (0, p.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, p.jsx)(o.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   j.displayName = 'DocumentContainer';
   const b = ({ children: e }) => (0, p.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: e });
   b.displayName = 'SurfaceContainer';
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: g = !0, children: x, container: v = 'document', language: k, designTokens: f }) => {
    const y = 'function' == typeof x ? x() : x,
    ...
    let S = u.Fragment;
    return (
     'paragraph' === v ? (S = m) : 'document' === v ? (S = j) : 'surface' === v && (S = b),
     (0, p.jsxs)('div', {
      className: (0, s.A)('nlds-canvas'),
      children: [
       y && (0, p.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, p.jsx)(S, { children: (0, p.jsx)(o.v$, { children: y }) }) }) }),
       g &&
        (0, p.jsx)('div', {
       ...
       g &&
        (0, p.jsxs)('div', {
         ...
         hidden: !z,
         children: [
          (0, p.jsx)(r.M, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: N, trim: !0 }),
          n &&
           (0, p.jsx)('div', {
  ...
  69284(e, n, l) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: l, trim: c }) {
    ...
    const { title: u, type: h } = (0, s.useContext)(t.x),
     p = (0, s.useId)();
    return (c && (d = d.trim()), (0, a.jsx)(o.f4, { theme: i, code: d, language: n || '', children: ({ style: n, tokens: l, getLineProps: o, getTokenProps: s }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', h ? `\u201c${h}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, a.jsx)(r.NG, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': p, style: n, children: l.map((n, l) => (0, a.jsxs)('span', { ...o({ line: n }), children: [e && (0, a.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, a.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  78734(e, n, l) {
   l.d(n, { Ay: () => i, RM: () => s });
