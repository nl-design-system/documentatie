 ...
 [17623],
 {
  ...
  43599: (e, n, t) => {
   ...
   const g = (e) => {
    ...
    (0, k.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(N, { parser: x, plugins: [o.Z, r.ZP, a.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [N]);
    const T = (0, k.useId)();
