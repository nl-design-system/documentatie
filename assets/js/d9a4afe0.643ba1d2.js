  ...
  13455: (e, l, o) => {
   ...
   const p = (e) => {
    ...
    _ = (e) => {
     ...
     const _ = u().format(b.uS(l || i), { parser: "html", plugins: [r(), c()], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" }),
      h = (0, v.Z)();
     return n.createElement(
      ...
      n.createElement("div", { className: (0, d.Z)(a["nlds-canvas__toolbar"]) }, n.createElement(m.zx, { className: (0, d.Z)(a["nlds-canvas__button"], a["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: p, "aria-expanded": !t, "aria-controls": h }, t ? "Bekijk code" : "Verberg code")),
      n.createElement(
       "div",
       { className: (0, d.Z)(a["nlds-canvas__code-block"], !o && a["nlds-canvas__code-block--user-select-none"]), id: h, hidden: t },
       n.createElement(k.Z, { language: s, style: g }, _),
       o &&
        n.createElement(
         "div",
