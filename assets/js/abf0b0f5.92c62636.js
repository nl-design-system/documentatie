 ...
 [90037],
 {
  ...
  70348(e, n, t) {
   ...
   const i = ({ className: e, ...n }) => {
    ...
    r = ({ className: e, classNamePanel: n, label: t, heading: i, headingLevel: r, headingApperance: c, ...d }) => {
     const p = (0, o.A)('utrecht-accordion__section', e),
      h = (0, o.A)('utrecht-accordion__panel', n);
     return (0, s.jsxs)('details', { className: p, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(l.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [i && (0, s.jsx)(a.D, { level: r, appearance: c, children: i }), t] })] }) }), (0, s.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => y });
