 ...
 [38662],
 {
  ...
  1842(e, t, n) {
   ...
   const b = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: s.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(g, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(m, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => g, VZ: () => w, cR: () => _, Pv: () => m, qZ: () => i, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => s, eQ: () => v, B_: () => b, o_: () => p, Rc: () => x });
