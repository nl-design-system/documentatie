 ...
 [30221],
 {
  ...
  58639(e, n, t) {
   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: j = !0, children: v, container: b = 'document', language: x, designTokens: y }) => {
    ...
    let L = k.Fragment;
    return (
     'paragraph' === b ? (L = h) : 'document' === b ? (L = g) : 'surface' === b && (L = m),
     (0, p.jsxs)('div', {
      className: (0, r.A)('nlds-canvas'),
      children: [
       f && (0, p.jsx)('div', { className: (0, r.A)('nlds-canvas__example'), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, p.jsx)(L, { children: (0, p.jsx)(s.v$, { children: f }) }) }) }),
       j &&
        (0, p.jsx)('div', {
