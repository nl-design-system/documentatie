  ...
  70348(e, n, l) {
   ...
   const c = ({ className: e, ...n }) => {
    ...
    a = ({ className: e, classNamePanel: n, label: l, heading: c, headingLevel: a, headingApperance: i, ...d }) => {
     ...
     return (0, r.jsxs)('details', { className: m, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(t.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [c && (0, r.jsx)(s.D, { level: a, appearance: i, children: c }), l] })] }) }), (0, r.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => b });
