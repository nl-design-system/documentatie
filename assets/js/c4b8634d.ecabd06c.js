  ...
  94443: (e, n, t) => {
   ...
   const b = (e) => {
     ...
     const o = n && n.projects.filter((e) => f.e9.includes(e.id)),
      s = o && f.e9.map((e) => o.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
    ...
    A = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(j.V, { level: t, suffix: o && (0, d.jsx)(m.y, { state: o }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, n, t) => {
   'use strict';
