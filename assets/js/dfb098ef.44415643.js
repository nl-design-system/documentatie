/*! For license information please see dfb098ef.44415643.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [39629],
 {
  4258(e, n, t) {
   ...
   var o = t(87423),
    i = t(86070);
   const a = ({ id: e, title: n, ...t }) => (0, i.jsx)(o.A, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: n, poster: 'maxresdefault', ...t });
  },
  72223(e, n, t) {
   t.r(n), t.d(n, { assets: () => s, contentTitle: () => c, default: () => p, frontMatter: () => l, metadata: () => o, toc: () => m });
   const o = JSON.parse('{"id":"handboek/designer/zelf-componenten-maken","title":"Zelf componenten maken \xb7 Designer \xb7 Handboek","description":"Informatie voor designers over hoe je zelf componenten kunt maken in Figma met design tokens.","source":"@site/docs/handboek/designer/zelf-componenten-maken.mdx","sourceDirName":"handboek/designer","slug":"/handboek/designer/zelf-componenten-maken","permalink":"/handboek/designer/zelf-componenten-maken","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/handboek/designer/zelf-componenten-maken.mdx","tags":[],"version":"current","sidebarPosition":5,"frontMatter":{"title":"Zelf componenten maken \xb7 Designer \xb7 Handboek","hide_title":true,"hide_table_of_contents":true,"sidebar_label":"Zelf componenten maken","sidebar_position":5,"pagination_label":"Zelf componenten maken","description":"Informatie voor designers over hoe je zelf componenten kunt maken in Figma met design tokens.","slug":"/handboek/designer/zelf-componenten-maken","keywords":["index","designer","meedoen","componenten","figma","design tokens"]},"sidebar":"handboek","previous":{"title":"Zelf componenten uitbreiden","permalink":"/handboek/designer/zelf-componenten-uitbreiden"},"next":{"title":"Figma-bestanden overzicht","permalink":"/figma"}}');
   var i = t(86070),
    a = t(85248),
    r = t(4258);
   const l = { title: 'Zelf componenten maken \xb7 Designer \xb7 Handboek', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Zelf componenten maken', sidebar_position: 5, pagination_label: 'Zelf componenten maken', description: 'Informatie voor designers over hoe je zelf componenten kunt maken in Figma met design tokens.', slug: '/handboek/designer/zelf-componenten-maken', keywords: ['index', 'designer', 'meedoen', 'componenten', 'figma', 'design tokens'] },
    c = 'Zelf componenten maken',
    s = {},
    m = [
  ...
  87423(e, n, t) {
   ...
   var r = o.forwardRef(function (e, n) {
    var t = o.useState(!1),
     r = t[0],
     l = t[1],
     c = o.useState(e.alwaysLoadIframe || !1),
     s = c[0],
     m = c[1],
     ...
     f = new URLSearchParams(i(i(i(i({}, e.muted ? { mute: '1' } : {}), k ? { autoplay: '1' } : {}), e.enableJsApi ? { enablejsapi: '1' } : {}), e.playlist ? { list: d } : {}));
    e.params &&
    ...
    var j = e.playlist ? ''.concat(b, '/embed/videoseries?').concat(f.toString()) : ''.concat(b, '/embed/').concat(d, '?').concat(f.toString()),
     ...
     w = v
      ? (function (e, n, t, i) {
         ...
         return (
          (0, o.useEffect)(
           function () {
            var o = 'https://img.youtube.com/'.concat(n, '/').concat(e, '/').concat(i, '.').concat(t),
    ...
    return (
     ...
     o.createElement(
      o.Fragment,
      null,
      o.createElement('link', { rel: H, href: C, as: 'image' }),
      ...
      o.createElement(
       L,
       {
        ...
        className: ''.concat(F, ' ').concat(s ? z : ''),
        'data-title': h,
        style: i(i({ backgroundImage: 'url('.concat(C, ')') }, { '--aspect-ratio': ''.concat((D / E) * 100, '%') }), N),
       },
       o.createElement('button', { type: 'button', className: S, 'aria-label': ''.concat(g, ' ').concat(h) }),
       s && o.createElement('iframe', { ref: n, className: I, title: h, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: j }),
      ),
     )
    );
   });
