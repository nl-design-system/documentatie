...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [19207],
 {
  ...
  98480: (e, n, t) => {
   ...
   const x = (e) => {
    let { code: n, copy: t = !0, defaultExpandedCode: x = !1, displayCode: j = !0, children: _, container: y = 'document', language: f, designTokens: k } = e,
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (C = await d.ZP.format(Z, { parser: f, plugins: [i.Z, s.ZP, r.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), z(C);
     })();
    }, [Z]);
    const A = (0, c.useId)();
    let G = c.Fragment;
    return (
     'paragraph' === y ? (G = h) : 'document' === y ? (G = v) : 'surface' === y && (G = g),
     (0, p.jsxs)('div', {
      className: (0, o.Z)(b['nlds-canvas']),
      children: [
       w && (0, p.jsx)('div', { className: (0, o.Z)(b['nlds-canvas__example']), children: (0, p.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, p.jsx)(G, { children: (0, p.jsx)(l.pu, { children: w }) }) }) }),
       j &&
        (0, p.jsx)('div', {
       ...
       j &&
        (0, p.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, p.jsx)(m.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: C, trim: !0 }),
          t &&
           (0, p.jsx)('div', {
  ...
  41179: (e, n, t) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: t, textContent: d, trim: c } = e,
     u = d;
    const { title: b, type: m } = (0, i.useContext)(s.n),
     p = (0, i.useId)();
    return (
     c && (u = u.trim()),
     (0, a.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: p, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', b ? ': ' : ' ', b] }), (0, a.jsx)(l.dn, { tabIndex: 0, role: b ? 'region' : void 0, 'aria-labelledby': p, style: t, children: o.map((e, t) => (0, a.jsxs)('span', { ...i({ line: e }), children: [n && (0, a.jsx)('span', { children: t + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, t)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, t) => {
   ...
   const c = (0, r.createContext)({}),
    u = (e) => {
     let { title: n, appearance: t, description: r, children: u, figure: b } = e;
     const m = { do: 'Doen', dont: 'Niet doen' },
      p = b ? 'figure' : 'div',
      h = b ? 'figcaption' : 'div';
     return (0, d.jsxs)(p, { className: (0, s.Z)(a['nlds-guideline'], a[`nlds-guideline--${t}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(h, { className: (0, s.Z)(a['nlds-guideline__description']), children: ['dont' === t ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(i.nv, { className: (0, s.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${t}`]), children: [(0, d.jsx)(l.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: m.dont })] }), (0, d.jsx)(i.nv, { children: n })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(i.nv, { className: (0, s.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${t}`]), children: [(0, d.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: m.do })] }), (0, d.jsx)(i.nv, { children: n })] }), r] }), (0, d.jsx)('div', { className: (0, s.Z)(a['nlds-guideline__example']), children: (0, d.jsx)(c.Provider, { value: { title: n, type: m[t] }, children: u }) })] });
    };
  },
  24785: (e, n, t) => {
   t.d(n, { Z: () => r, a: () => s });
