(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [16833],
 {
  ...
  35038: (e, t, n) => {
   'use strict';
   n.d(t, { Zb: () => a, aY: () => o, um: () => u, wu: () => i });
   var r = n(37943),
    s = n(4814),
    c = n(52676);
   const i = (e) => {
     let { background: t, children: n, className: r, ...i } = e;
     return (0, c.jsx)('div', { className: (0, s.Z)('card__illustration', t && `card__illustration--${t}`, r), ...i, children: n });
    },
    o = (e) => (0, c.jsx)('div', { className: 'card__content', ...e }),
    a = (e) => {
     let { href: t, appearance: n, className: i, component: o = 'div', background: a, children: u } = e;
     const l = (e) => ('article' === o ? (0, c.jsx)('article', { ...e }) : 'section' === o ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      h = (0, c.jsx)(l, { className: (0, s.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, i), children: u });
    ...
    u = (e) => {
     ...
     return (0, c.jsx)('div', { className: (0, s.Z)('cardgroup', `cardgroup--${t}`, r), children: n });
    };
  },
  8657: (e, t, n) => {
   'use strict';
   ...
   var r = n(74824),
    ...
    u = n(32636),
    l = n(52676);
   const h = { figma: (0, l.jsx)(c.Z, {}), github: (0, l.jsx)(i.Z, {}), npm: (0, l.jsx)(o.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
   ...
   const k = (e) => {
    ...
    f = (e) => {
     let { checked: t, children: n, title: r, description: c, headingLevel: i = 3 } = e;
     return (0, l.jsxs)('li', { className: (0, s.Z)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, s.Z)('task-list-item__marker', t && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(v.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.X6, { appearance: 'utrecht-heading-3', level: i, children: r }), c, n] })] });
    };
   var x = n(14669);
   const _ = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => x.e9.includes(e.id)),
      i = c && x.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean),
      o = (e) => (['Candidate - New', 'Candidate - Oud'].includes(e.title) ? 'Candidate' : e.title);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       sections: i.map((e) => ({
        className: (0, s.Z)('definition-of-done', e && `definition-of-done--${(0, x.mA)(o(e))}`),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, l.jsx)(k, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(f, { headingLevel: n + 1, checked: t, title: r, description: (0, x.Q6)(s) }, s);
            }),
           }),
           (0, l.jsx)(r.nv, { children: (0, l.jsxs)(r.rU, { href: `${e.url}?filterQuery=${t.title}`, children: [o(e), ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
           ...
           return (0, l.jsx)(
            j.Zb,
            {
             ...
             children: (0, l.jsxs)(j.aY, {
              children: [
               (0, l.jsx)(r.X6, { level: n, children: e.title.replace(/^Community/i, '') }),
               ...
               (o.length > 0 || c.length > 0) && (0, l.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               o.length > 0 &&
                (0, l.jsx)(l.Fragment, {
                 children: (0, l.jsx)(r.Mc, {
                  links: o
               ...
               c.length > 0 &&
                (0, l.jsx)(l.Fragment, {
                 children: c.map((e) => {
                  ...
                  return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.X6, { level: n + 2, children: [s, ' in ', t] }), (0, l.jsx)(r.Mc, { links: c.map((e) => ({ children: e.description, icon: (0, l.jsx)(d, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
  ...
  41757: (e, t, n) => {
   ...
   var r = n(4814),
    s = n(52676);
   const c = (e) => {
    let { children: t, className: n, level: c = 1, suffix: i, ...o } = e;
    return (0, s.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${c}`, n), ...o, children: [(0, s.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), i && (0, s.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [i ? ' ' : '', i] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => g, BA: () => o, Ee: () => l, Q6: () => c, U: () => j, Yr: () => p, d: () => h, e9: () => i, fO: () => v, mA: () => s, ps: () => y, qU: () => k, s0: () => b, zP: () => m });
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        ...
        return { brand: o.toLowerCase(), name: s, id: c, value: i, description: a };
       });
