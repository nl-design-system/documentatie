 ...
 [19359],
 {
  ...
  43599: (e, n, o) => {
   ...
   const k = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await d.ZP.format(N, { parser: x, plugins: [s.Z, a.ZP, c.ZP, i.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      Z(e);
     })();
    }, [N]);
    const E = (0, p.useId)();
    ...
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       w && (0, h.jsx)('div', { className: (0, r.Z)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, h.jsx)(F, { children: (0, h.jsx)(l.pu, { children: w }) }) }) }),
       b &&
        (0, h.jsx)('div', {
       ...
       b &&
        (0, h.jsxs)('div', {
         ...
         hidden: !S,
         children: [
          (0, h.jsx)(t.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: C, trim: !0 }),
          o &&
           (0, h.jsx)('div', {
