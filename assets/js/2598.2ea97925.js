 ...
 [2598],
 {
  ...
  40976: (e, n, t) => {
   ...
   function h(e) {
    ...
    return (0, a.jsxs)(d, { type: n, className: s, children: [(0, a.jsx)(u, { title: i, icon: t }), (0, a.jsx)(m, { children: l })] });
   }
   function f(e) {
   ...
   const p = { icon: (0, a.jsx)(x, {}), title: (0, a.jsx)(o.Z, { id: "theme.admonition.tip", description: "The default label used for the Tip admonition (:::tip)", children: "tip" }) };
   function j(e) {
    return (0, a.jsx)(h, { ...p, ...e, className: (0, s.Z)("alert alert--success", e.className), children: e.children });
   }
   function N(e) {
   ...
   const Z = { icon: (0, a.jsx)(_, {}), title: (0, a.jsx)(o.Z, { id: "theme.admonition.warning", description: "The default label used for the Warning admonition (:::warning)", children: "warning" }) };
   function L(e) {
    return (0, a.jsx)("svg", { viewBox: "0 0 12 16", ...e, children: (0, a.jsx)("path", { fillRule: "evenodd", d: "M5.05.31c.81 2.17.41 3.38-.52 4.31C3.55 5.67 1.98 6.45.9 7.98c-1.45 2.05-1.7 6.53 3.53 7.7-2.2-1.16-2.67-4.52-.3-6.61-.61 2.03.53 3.33 1.94 2.86 1.39-.47 2.3.53 2.27 1.67-.02.78-.31 1.44-1.13 1.81 3.42-.59 4.78-3.42 4.78-5.56 0-2.84-2.53-3.22-1.25-5.61-1.52.13-2.03 1.13-1.89 2.75.09 1.08-1.02 1.8-1.86 1.33-.67-.41-.66-1.19-.06-1.78C8.18 5.31 8.68 2.45 5.05.32L5.03.3l.02.01z" }) });
   }
   const H = { icon: (0, a.jsx)(L, {}), title: (0, a.jsx)(o.Z, { id: "theme.admonition.danger", description: "The default label used for the Danger admonition (:::danger)", children: "danger" }) };
   const k = { icon: (0, a.jsx)(_, {}), title: (0, a.jsx)(o.Z, { id: "theme.admonition.caution", description: "The default label used for the Caution admonition (:::caution)", children: "caution" }) };
   const y = {
    ...{
     note: g,
     tip: j,
     info: b,
     warning: function (e) {
      return (0, a.jsx)(h, { ...Z, ...e, className: (0, s.Z)("alert alert--warning", e.className), children: e.children });
     },
     danger: function (e) {
      return (0, a.jsx)(h, { ...H, ...e, className: (0, s.Z)("alert alert--danger", e.className), children: e.children });
     },
    },
    ...{
     ...
     caution: function (e) {
      return (0, a.jsx)(h, { ...k, ...e, className: (0, s.Z)("alert alert--warning", e.className), children: e.children });
     },
    },
   };
   function w(e) {
    const n = l(e),
     t = ((i = n.type), y[i] || (console.warn(`No admonition component found for admonition type "${i}". Using Info as fallback.`), y.info));
    var i;
    return (0, a.jsx)(t, { ...n });
   }
  },
  80697: (e, n, t) => {
   ...
   var i = t(50959),
    ...
    l = t(77709),
    s = t(29893);
   const o = { details: "details_GIrA", isBrowser: "isBrowser_j21U", collapsibleContent: "collapsibleContent_R3qf" };
   var r = t(11527);
   function c(e) {
   ...
   function u(e) {
    ...
    const m = (0, l.Z)(),
     h = (0, i.useRef)(null),
     { collapsed: f, setCollapsed: v } = (0, s.u)({ initialState: !u.open }),
     [g, x] = (0, i.useState)(u.open),
     p = i.isValidElement(n) ? n : (0, r.jsx)("summary", { children: n ?? "Details" });
    return (0, r.jsxs)("details", {
     ...u,
     ref: h,
     open: g,
     "data-collapsed": f,
     className: (0, a.Z)(o.details, m && o.isBrowser, u.className),
     onMouseDown: (e) => {
     ...
     onClick: (e) => {
      e.stopPropagation();
      const n = e.target;
      c(n) && d(n, h.current) && (e.preventDefault(), f ? (v(!1), x(!0)) : v(!0));
     },
     children: [
      p,
      (0, r.jsx)(s.z, {
   ...
   const m = { details: "details_Kt1M" },
    h = "alert alert--info";
   function f(e) {
    let { ...n } = e;
    return (0, r.jsx)(u, { ...n, className: (0, a.Z)(h, m.details, n.className) });
   }
  },
  15951: (e, n, t) => {
   t.d(n, { Z: () => d });
   ...
   var i = t(92954),
    ...
    l = t(47800),
    s = t(86259);
   const o = { iconEdit: "iconEdit_nFVY" };
   var r = t(11527);
   function c(e) {
    let { className: n, ...t } = e;
  ...
  9967: (e, n, t) => {
   ...
   var i = t(86259),
    a = t(87769);
   const l = { tableOfContents: "tableOfContents_Itoy", docItemContainer: "docItemContainer_y6SO" };
   var s = t(11527);
  ...
  87769: (e, n, t) => {
   ...
   function h(e) {
    ...
    return n.length ? (0, m.jsx)("ul", { className: a ? void 0 : t, children: n.map((e) => (0, m.jsxs)("li", { children: [(0, m.jsx)(u.Z, { to: `#${e.id}`, className: i ?? void 0, dangerouslySetInnerHTML: { __html: e.value } }), (0, m.jsx)(h, { isChild: !0, toc: e.children, className: t, linkClassName: i })] }, e.id)) }) : null;
   }
   const f = i.memo(h);
   function v(e) {
    let { toc: n, className: t = "table-of-contents table-of-contents__left-border", linkClassName: o = "table-of-contents__link", linkActiveClassName: r, minHeadingLevel: c, maxHeadingLevel: u, ...h } = e;
    const v = (0, a.L)(),
     ...
     })({ toc: n, minHeadingLevel: g, maxHeadingLevel: x });
    return (
     d(
      (0, i.useMemo)(() => {
       if (o && r) return { linkClassName: o, linkActiveClassName: r, minHeadingLevel: g, maxHeadingLevel: x };
      }, [o, r, g, x]),
     ),
     (0, m.jsx)(f, { toc: p, className: t, linkClassName: o, ...h })
    );
   }
  },
  4563: (e, n, t) => {
   ...
   var i = t(86259),
    a = t(47800);
   const l = { tag: "tag_UfKX", tagRegular: "tagRegular_StQs", tagWithCount: "tagWithCount_tR06" };
   var s = t(11527);
   function o(e) {
  ...
  53548: (e, n, t) => {
   ...
   var i = t(86259),
    a = t(92954),
    l = t(4563);
   const s = { tags: "tags_DyiK", tag: "tag_y51p" };
   var o = t(11527);
   function r(e) {
    let { tags: n } = e;
