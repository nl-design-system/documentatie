 ...
 [88963],
 {
  15638(e, n, l) {
   ...
   const d = (0, i.createContext)({}),
    m = ({ title: e, appearance: n, description: l, children: i, figure: m }) => {
     ...
     return (0, c.jsxs)(h, { className: (0, r.A)('nlds-guideline', `nlds-guideline--${n}`), id: 'string' == typeof e ? e?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(p, { className: 'nlds-guideline__description', children: ['dont' === n ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(a.fz, { className: (0, r.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, c.jsx)(t.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, c.jsx)('span', { className: 'nlds-guideline__title', children: u.dont })] }), (0, c.jsx)(a.fz, { children: e })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(a.fz, { className: (0, r.A)('nlds-guideline__badge', `nlds-guideline__badge--${n}`), children: [(0, c.jsx)(o.A, { 'aria-hidden': 'true', role: 'presentation', className: 'nlds-guideline__icon' }), (0, c.jsx)('span', { className: 'nlds-guideline__title', children: u.do })] }), (0, c.jsx)(a.fz, { children: e })] }), b] }), (0, c.jsx)('div', { className: 'nlds-guideline__example', children: (0, c.jsx)(d.Provider, { value: { title: e, type: u[n] }, children: i }) })] });
    };
  },
  18439(e, n, l) {
   l.d(n, { R: () => r, x: () => s });
  ...
  58639(e, n, l) {
   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: j = !0, children: v, container: y = 'document', language: x, designTokens: k }) => {
    ...
    (0, m.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(z, { parser: x, plugins: [r.A, s.Ay, i.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      N(e);
     })();
    }, [z]);
    const S = (0, m.useId)();
    let R = m.Fragment;
    return (
     'paragraph' === y ? (R = p) : 'document' === y ? (R = b) : 'surface' === y && (R = g),
     (0, h.jsxs)('div', {
      className: (0, a.A)('nlds-canvas'),
      children: [
       f && (0, h.jsx)('div', { className: (0, a.A)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, h.jsx)(R, { children: (0, h.jsx)(t.v$, { children: f }) }) }) }),
       j &&
        (0, h.jsx)('div', {
