...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  12670(e, n, i) {
   (i.r(n), i.d(n, { assets: () => v, contentTitle: () => m, default: () => x, frontMatter: () => j, metadata: () => t, toc: () => w }));
   const t = JSON.parse('{"id":"wcag/2.5.05","title":"WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)","description":"Maak het aanwijsgebied van buttons, links en formuliervelden groot genoeg, zodat het makkelijker is om deze te selecteren.","source":"@site/docs/wcag/2.5.05.mdx","sourceDirName":"wcag","slug":"/wcag/2.5.5","permalink":"/wcag/2.5.5","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.5.05.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)","title_sm":"2.5.5 Grootte van het aanwijsgebied (uitgebreid)","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"2.5.5 Grootte van het aanwijsgebied (uitgebreid)","pagination_label":"WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)","description":"Maak het aanwijsgebied van buttons, links en formuliervelden groot genoeg, zodat het makkelijker is om deze te selecteren.","slug":"2.5.5","conformance_level":"Niveau AAA","keywords":["WCAG","AAA","bedienbaar","input modaliteiten","operable","input modalities","target size (enhanced)"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 2.5.4 Bewegingsactivering","permalink":"/wcag/2.5.4"},"next":{"title":"WCAG-succescriterium 2.5.6 Input gelijktijdige invoermechanismen","permalink":"/wcag/2.5.6"}}');
   var r = i(86070),
    s = i(18439),
    a = i(24703),
    o = i(61473),
   ...
   function u(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Maak het aanwijsgebied van buttons, links en formuliervelden groot genoeg, zodat het makkelijker is om deze te selecteren.\nHoud hiervoor een grootte aan van tenminste 44 bij 44 pixels.' }), '\n', (0, r.jsx)(n.p, { children: 'Dit zorgt ervoor dat de website makkelijker te navigeren is en dat formulieren makkelijker in te vullen zijn. Dit geldt speciaal voor mensen met dikke vingers op aanraakschermen en muisgebruikers met trillende handen door bijvoorbeeld Parkinson.' }), '\n', (0, r.jsxs)(n.p, { children: [(0, r.jsx)(n.strong, { children: 'Let op' }), ': Links in zinnen en paragrafen van tekst zijn uitgezonderd. De grootte van het aanwijsgebied is hier afhankelijk van de grootte van de linktekst zelf.'] })] });
   }
   function p(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(u, { ...e }) }) : u(e);
   }
   const j = { title: 'WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)', title_sm: '2.5.5 Grootte van het aanwijsgebied (uitgebreid)', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.5.5 Grootte van het aanwijsgebied (uitgebreid)', pagination_label: 'WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)', description: 'Maak het aanwijsgebied van buttons, links en formuliervelden groot genoeg, zodat het makkelijker is om deze te selecteren.', slug: '2.5.5', conformance_level: 'Niveau AAA', keywords: ['WCAG', 'AAA', 'bedienbaar', 'input modaliteiten', 'operable', 'input modalities', 'target size (enhanced)'] },
    m = void 0,
    v = {},
   ...
   function k(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', (0, r.jsx)(o.E, { level: 1, conformanceLevel: 'Niveau AAA', children: 'WCAG-succescriterium 2.5.5 Grootte van het aanwijsgebied (uitgebreid)' }), '\n', (0, r.jsx)(l.K, { children: (0, r.jsx)(a.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(h.Ay, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, r.jsx)(p, {}), '\n', (0, r.jsx)(n.h2, { id: 'opgelet', children: 'Opgelet' }), '\n', (0, r.jsx)(n.p, { children: 'Deze inhoud wordt binnenkort aangevuld met uitgebreidere uitleg, bronnen en informatie over hoe te testen.' }), '\n', (0, r.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, r.jsx)(c.Ay, {}), '\n', (0, r.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#target-size-enhanced', children: (0, r.jsx)('span', { lang: 'en', children: '2.5.5 Target Size (Enhanced)' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#target-size-enhanced', children: '2.5.5 Grootte van het aanwijsgebied (uitgebreid)' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, r.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#target-size-enhanced', children: (0, r.jsx)('span', { lang: 'en', children: 'Quick Reference 2.5.5 Target Size (Enhanced)' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/target-size-enhanced.html', children: (0, r.jsx)('span', { lang: 'en', children: 'Understanding SC 2.5.5 Target Size (Enhanced)' }) }), '.'] }), '\n'] }), '\n', (0, r.jsx)(l.K, { children: (0, r.jsx)(a.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(d.Ay, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, r.jsx)(a.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(g.Ay, {}) })] });
   }
   function x(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
  ...
  24703(e, n, i) {
   ...
   const a = (e, n) => {
    ...
    d = ({ children: e, omitH1: n = !1, headingLevel: i = 1, baseUrl: r = '', components: a = {} }) => (0, s.jsx)(t.x, { components: { ...c(n, i), ...l(r), ...a }, children: e });
  },
  25431(e, n, i) {
   i.d(n, { Ay: () => o, RM: () => s });
   var t = i(86070),
  ...
  66119(e, n, i) {
   ...
   const a = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: r, ...a }, o) => {
    const l = { ...a, ref: o, className: s('utrecht-note', { [`utrecht-note--${r}`]: r }, i) };
    return e ? (0, t.jsx)('aside', { ...l, children: n }) : (0, t.jsx)('section', { role: 'note', ...l, children: n });
   });
   a.displayName = 'Note';
   var o = i(29181);
   const l = globalThis.isAstro ? a : o.K7;
  },
 },
]);
