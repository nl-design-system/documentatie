 ...
 [73512],
 {
  ...
  16764(e, n, t) {
   ...
   var p = t(43864),
    ...
    D = t(79532),
    C = t(30758);
   const A = { boxShadow: p.A, color: j.A, cursor: v.A, dimension: x.A, fontFamily: k.A, fontFamilies: k.A, fontSize: b.A, fontSizes: b.A, fontWeight: f.A, fontWeights: f.A, lineHeight: y.A, lineHeights: y.A, number: w.A, other: S.A, textDecoration: D.A },
    T = ({ type: e }) => {
     const n = Object.hasOwn(A, e) ? e : 'other';
     return (0, u.jsx)(m.In, { children: (0, C.createElement)(A[n]) });
    };
   var N = t(76223);
   function F({ tokens: e }) {
    const n = (0, i.kD)(e),
       ...
       children: [
        ...
        (0, u.jsx)(l.BF, {
         children: o.map((n) => {
          const t = (0, i.o_)(n),
           o = (0, i.eQ)(e, n).$type;
          return (0, u.jsxs)(l.Hj, { children: [(0, u.jsx)(l.nA, { children: (0, u.jsx)(a.C, { children: (0, u.jsx)(l.kf, { children: t }) }) }), (0, u.jsx)(l.nA, { children: (0, u.jsxs)(r.K, { children: [(0, u.jsx)(T, { type: o }), ' ', o] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  36835(e, n, t) {
   ...
   const N = [
    ...
    { title: 'De Color Sample komt niet voor in de normale focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: T.Ay, tags: ['developer'] },
   ];
   (C.Ay, A.Ay);
   var F = t(56167),
    L = t(16764),
  ...
  76097(e, n, t) {
   'use strict';
   t.d(n, { bo: () => r, KF: () => m, mJ: () => p, VZ: () => w, cR: () => y, Pv: () => j, qZ: () => l, kD: () => b, B2: () => u, Pc: () => s, f4: () => o, GT: () => f, fX: () => i, eQ: () => k, B_: () => x, o_: () => v });
