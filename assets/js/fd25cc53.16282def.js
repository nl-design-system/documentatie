...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [9568],
 {
  ...
  89542: (e, n, r) => {
   r.r(n), r.d(n, { assets: () => K, contentTitle: () => P, default: () => I, frontMatter: () => C, metadata: () => X, toc: () => B });
   var i = r(11527),
    o = r(27034),
    s = r(73460),
    t = r(30036);
   ...
   function F(e = {}) {
    const { wrapper: n } = { ...(0, o.a)(), ...e.components };
    return n ? (0, i.jsx)(n, { ...e, children: (0, i.jsx)(z, { ...e }) }) : z();
   }
   function Z(e) {
  ...
  73460: (e, n, r) => {
   ...
   const b = (e) => {
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (z = await d.ZP.format(D, { parser: k, plugins: [s.Z, t.ZP, l.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), F(z);
     })();
    }, [D]);
    const A = (0, c.useId)();
    let C = c.Fragment;
      ...
      children: [
       ...
       v &&
        (0, m.jsxs)("div", {
         ...
         hidden: !Z,
         children: [
          (0, m.jsx)(u.u, { syntax: k, textContent: z, trim: !0 }),
          r &&
           (0, m.jsx)("div", {
            className: (0, o.Z)(h["nlds-canvas__toolbar"]),
            children: (0, m.jsx)(i.zx, {
