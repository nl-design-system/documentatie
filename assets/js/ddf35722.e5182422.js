  ...
  94443: (e, t, n) => {
   ...
   const k = (e) => {
     ...
     const c = t && t.projects.filter((e) => f.e9.includes(e.id)),
      s = c && f.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
