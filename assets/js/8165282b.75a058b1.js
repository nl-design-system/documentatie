 ...
 [49619],
 {
  12270: (e, t, n) => {
   ...
   const s = { title: 'Text input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text input', pagination_label: 'Text input', description: 'Biedt de mogelijkheid om \xe9\xe9n regel aan tekens in te vullen.', slug: '/text-input' },
    a = void 0,
    u = { id: 'componenten/text-input/index', title: 'Text input', description: 'Biedt de mogelijkheid om \xe9\xe9n regel aan tekens in te vullen.', source: '@site/docs/componenten/text-input/index.mdx', sourceDirName: 'componenten/text-input', slug: '/text-input', permalink: '/text-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/text-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Text input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text input', pagination_label: 'Text input', description: 'Biedt de mogelijkheid om \xe9\xe9n regel aan tekens in te vullen.', slug: '/text-input' }, sidebar: 'componenten', previous: { title: 'Task list', permalink: '/task-list' }, next: { title: 'Text input group', permalink: '/text-input-group' } },
    l = {},
    d = [
