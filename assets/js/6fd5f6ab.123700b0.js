 ...
 [53087],
 {
  ...
  21034(e, n, t) {
   ...
   const x = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, d.jsx)(j.n, { children: s.map((t) => (0, d.jsx)(j.K, { className: (0, a.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, h.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p._, { children: t.tasks.map(({ checked: e, name: t, id: i }) => (0, d.jsx)(p.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, h.qZ)(i) }, i)) }), (0, d.jsx)(i.fz, { children: (0, d.jsxs)(i.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
  ...
  32385(e, n, t) {
   'use strict';
   t.d(n, { bo: () => a, KF: () => u, mJ: () => m, VZ: () => w, cR: () => D, Pv: () => j, qZ: () => r, kD: () => f, QQ: () => H, B2: () => p, Pc: () => l, f4: () => o, GT: () => b, fX: () => s, eQ: () => v, B_: () => k, o_: () => x });
   ...
   const g = (e) => [...e].sort((e, n) => d.indexOf(e) - d.indexOf(n)),
    ...
    m = (e) => g(c(e.projects.flatMap((e) => h(e)))),
    j = (e) => {
     const n = h(e),
      t = ((e) => {
  ...
  70348(e, n, t) {
   ...
   const o = ({ className: e, ...n }) => {
    ...
    l = ({ className: e, label: n, heading: t, headingLevel: o, headingApperance: l, ...d }) => {
     ...
     return (0, r.jsxs)('details', { className: c, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(a.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [t && (0, r.jsx)(s.D, { level: o, appearance: l, children: t }), n] })] }) }), (0, r.jsx)('div', { className: 'utrecht-accordion__panel', children: d.children })] });
    };
  },
  70561(e, n, t) {
   'use strict';
  ...
  70903(e, n, t) {
   ...
   var m = t(43864),
    ...
    H = t(79532),
    S = t(30758);
   const N = { boxShadow: m.A, color: j.A, cursor: x.A, dimension: k.A, fontFamily: v.A, fontFamilies: v.A, fontSize: f.A, fontSizes: f.A, fontWeight: b.A, fontWeights: b.A, lineHeight: D.A, lineHeights: D.A, number: w.A, other: y.A, textDecoration: H.A },
    A = ({ type: e }) => {
       ...
       children: [
        ...
        (0, p.jsx)(r.BF, {
         children: o.map((n) => {
          const t = (0, s.o_)(n),
           o = (0, s.eQ)(e, n).$type;
          return (0, p.jsxs)(r.Hj, { children: [(0, p.jsx)(r.nA, { children: (0, p.jsx)(i.C, { children: (0, p.jsx)(r.kf, { children: t }) }) }), (0, p.jsx)(r.nA, { children: (0, p.jsxs)(a.K, { children: [(0, p.jsx)(A, { type: o }), ' ', o] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, p.jsxs)(r.e2, { children: [(0, p.jsx)(h, { content: d, language: 'json', children: 'Kopieer als JSON' }), (0, p.jsx)(h, { content: l, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  82026(e, n, t) {
   ...
   const ye = [
     ...
     { title: 'De Heading komt niet voor in de normale focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: we.Ay, tags: ['developer'] },
     {
    ...
    He = [
     ...
     { title: 'De Heading komt standaard niet voor in de focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: De.Ay, tags: ['developer'] },
    ];
   var Se = t(70903),
    Ne = t(51582);
   function Ae(e) {
