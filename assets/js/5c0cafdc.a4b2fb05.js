/*! For license information please see 5c0cafdc.a4b2fb05.js.LICENSE.txt */
'use strict';
    ...
    return (
     ...
     t.createElement(
      ...
      t.createElement(
       ...
       t.createElement('button', { type: 'button', className: L, 'aria-label': ''.concat(p, ' ').concat(u) }),
       d && t.createElement('iframe', { ref: n, className: N, title: u, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: y }),
      ),
     )
    );
   });
