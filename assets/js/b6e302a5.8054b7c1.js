/*! For license information please see b6e302a5.8054b7c1.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [40415],
 {
  ...
  76097(e, n, i) {
   i.d(n, { bo: () => s, KF: () => v, mJ: () => k, VZ: () => S, cR: () => y, Pv: () => g, qZ: () => o, kD: () => w, QQ: () => C, B2: () => h, Pc: () => d, f4: () => a, GT: () => f, fX: () => r, eQ: () => b, B_: () => j, o_: () => p });
   ...
   const m = (e) => [...e].sort((e, n) => c.indexOf(e) - c.indexOf(n)),
    ...
    k = (e) => m(l(e.projects.flatMap((e) => u(e)))),
    g = (e) => {
     const n = u(e),
      i = ((e) => {
  ...
  89152(e, n, i) {
   (i.r(n), i.d(n, { assets: () => m, contentTitle: () => l, default: () => u, frontMatter: () => c, metadata: () => t, toc: () => v }));
