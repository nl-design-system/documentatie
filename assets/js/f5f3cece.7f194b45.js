 ...
 [32652],
 {
  15669: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(14147),
    o = n(23952);
   const s = { title: 'Spinner', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Spinner', pagination_label: 'Spinner', description: 'Een animatie die aangeeft dat een proces nog bezig is, waardoor een deel van de pagina nog niet volledig is geladen of buttons niet bedienbaar zijn.', slug: '/spinner' },
    a = void 0,
    l = { id: 'componenten/spinner/index', title: 'Spinner', description: 'Een animatie die aangeeft dat een proces nog bezig is, waardoor een deel van de pagina nog niet volledig is geladen of buttons niet bedienbaar zijn.', source: '@site/docs/componenten/spinner/index.mdx', sourceDirName: 'componenten/spinner', slug: '/spinner', permalink: '/spinner', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/spinner/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Spinner', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Spinner', pagination_label: 'Spinner', description: 'Een animatie die aangeeft dat een proces nog bezig is, waardoor een deel van de pagina nog niet volledig is geladen of buttons niet bedienbaar zijn.', slug: '/spinner' }, sidebar: 'componenten', previous: { title: 'Skip Link', permalink: '/skip-link' }, next: { title: 'Status Badge', permalink: '/status-badge' } },
    u = {},
    d = [
  ...
  23952: (e, t, n) => {
   ...
   const k = 'task-list_hh8j',
    ...
    z = (e) => {
     let { children: t } = e;
     return (0, u.jsx)('ul', { className: k, children: t });
    },
    S = (e) => {
     let { checked: t, children: n, title: r, description: c, headingLevel: o = 3 } = e;
     return (0, u.jsxs)('li', { className: (0, i.Z)(_), children: [(0, u.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, u.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(v.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var A = n(14669);
   const D = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => A.e9.includes(e.id)),
      o = c && A.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(g['definition-of-done'], e && g[`definition-of-done--${(0, A.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, u.jsx)(z, {
            children: e.tasks.map((e) => {
             ...
             return (0, u.jsx)(S, { checked: t, title: n, description: (0, A.Q6)(r) }, r);
            }),
           }),
