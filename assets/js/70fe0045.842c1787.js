 ...
 [97979],
 {
  17687: (e, t, n) => {
   ...
   const s = { title: 'Textarea', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Textarea', pagination_label: 'Textarea', description: 'Biedt de mogelijkheid om meerdere regels aan tekens in te vullen.', slug: '/textarea', sidebar_custom_props: { illustration: 'TextAreaSketch' } },
    a = void 0,
    l = { id: 'componenten/textarea/index', title: 'Textarea', description: 'Biedt de mogelijkheid om meerdere regels aan tekens in te vullen.', source: '@site/docs/componenten/textarea/index.mdx', sourceDirName: 'componenten/textarea', slug: '/textarea', permalink: '/textarea', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/textarea/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Textarea', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Textarea', pagination_label: 'Textarea', description: 'Biedt de mogelijkheid om meerdere regels aan tekens in te vullen.', slug: '/textarea', sidebar_custom_props: { illustration: 'TextAreaSketch' } }, sidebar: 'componenten', previous: { title: 'Text input group', permalink: '/text-input-group' }, next: { title: 'Toggletip', permalink: '/toggletip' } },
    u = {},
    d = [
  ...
  60851: (e, t, n) => {
   ...
   const f = 'task-list_hh8j',
    ...
    S = (e) => {
     ...
     return (0, u.jsxs)('li', { className: (0, i.Z)(x), children: [(0, u.jsxs)('div', { className: (0, i.Z)(w, { [N]: t }), children: [(0, u.jsx)('span', { className: T, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, u.jsx)(_.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, u.jsxs)('div', { children: [(0, u.jsx)(b.aC, { role: 'presentation', children: n }), (0, u.jsx)(b.nv, { children: r })] })] });
    };
   var z = n(14669);
   const D = (e) => {
