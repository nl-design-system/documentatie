(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [34894],
 {
  66434: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => a, default: () => g, description: () => j, frontMatter: () => s, issueNumber: () => y, metadata: () => u, title: () => d, toc: () => h });
   var r = n(52676),
    c = n(40139),
    i = n(7629),
    o = n(8657);
  ...
  35038: (e, t, n) => {
   ...
   const o = (e) => {
     ...
     return (0, i.jsx)('div', { className: (0, c.Z)('card__illustration', t && `card__illustration--${t}`, r), ...o, children: n });
    },
    s = (e) => (0, i.jsx)('div', { className: 'card__content', ...e }),
    a = (e) => {
     let { href: t, appearance: n, className: o, component: s = 'div', background: a, children: u } = e;
     const l = (e) => ('article' === s ? (0, i.jsx)('article', { ...e }) : 'section' === s ? (0, i.jsx)('section', { ...e }) : (0, i.jsx)('div', { ...e })),
      h = (0, i.jsx)(l, { className: (0, c.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, o), children: u });
  ...
  8657: (e, t, n) => {
   ...
   var r = n(74824),
    ...
    u = n(32636),
    l = n(52676);
   const h = { figma: (0, l.jsx)(i.Z, {}), github: (0, l.jsx)(o.Z, {}), npm: (0, l.jsx)(s.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    d = (e) => {
     let { brand: t } = e;
   ...
   const w = (e) => {
     ...
     const i = t && t.projects.filter((e) => x.e9.includes(e.id)),
      ...
      s = (e) => (['Candidate - New', 'Candidate - Oud'].includes(e.title) ? 'Candidate' : e.title);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       sections: o.map((e) => ({
        className: (0, c.Z)('definition-of-done', e && `definition-of-done--${(0, x.mA)(s(e))}`),
        headingLevel: n,
        expanded: !1,
        label: e ? `${s(e)} - ${e.progress.value} van ${e.progress.max}` : '',
        body:
         e &&
         (0, l.jsxs)(l.Fragment, {
          children: [
           ...
           (0, l.jsx)(r.nv, { children: (0, l.jsxs)(r.rU, { href: `${e.url}?filterQuery=${t.title}`, children: [s(e), ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
            ...
            j.Zb,
            {
             ...
             children: (0, l.jsxs)(j.aY, {
              children: [
               ...
               (s.length > 0 || i.length > 0) && (0, l.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               s.length > 0 &&
                (0, l.jsx)(l.Fragment, {
  ...
  41757: (e, t, n) => {
   ...
   var r = n(4814),
    c = n(52676);
   const i = (e) => {
    let { children: t, className: n, level: i = 1, suffix: o, ...s } = e;
    return (0, c.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${i}`, n), ...s, children: [(0, c.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: t }), o && (0, c.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
   };
  },
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => s, Ee: () => l, Q6: () => i, U: () => j, Yr: () => g, d: () => h, e9: () => o, fO: () => v, mA: () => c, ps: () => y, qU: () => b, s0: () => k, zP: () => m });
    ...
    y = (e) => {
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        let { name: c, id: i, value: o } = r;
        const s = /^(.+) URL/.exec(c)[1],
         a = 'Storybook' === s ? `${n} (${t}) in Storybook van ${((e) => (['Candidate - New', 'Candidate - Oud'].includes(e.title) ? 'Candidate' : e.title))(e)}` : `${n} (${t}) op ${s}`;
        return { brand: s.toLowerCase(), name: c, id: i, value: o, description: a };
       });
