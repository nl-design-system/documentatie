...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [12274],
 {
  ...
  44534: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => h, contentTitle: () => m, default: () => g, frontMatter: () => u, metadata: () => _, toc: () => v });
   var o = l(52676),
    s = l(24785),
    r = l(98480),
    t = l(91050);
  ...
  98480: (e, n, l) => {
   ...
   const g = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: g = !1, displayCode: y = !0, children: x, container: j = 'document', language: f, designTokens: k } = e,
    ...
    let z = a.Fragment;
    return (
     'paragraph' === j ? (z = h) : 'document' === j ? (z = v) : 'surface' === j && (z = b),
     (0, _.jsxs)('div', {
      className: (0, s.Z)(u['nlds-canvas']),
      children: [
       w && (0, _.jsx)('div', { className: (0, s.Z)(u['nlds-canvas__example']), children: (0, _.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, _.jsx)(z, { children: (0, _.jsx)(o.pu, { children: w }) }) }) }),
       y &&
        (0, _.jsx)('div', {
       ...
       y &&
        (0, _.jsxs)('div', {
         ...
         hidden: !M,
         children: [
          (0, _.jsx)(m.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: C, trim: !0 }),
          l &&
           (0, _.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   var c = l(52676);
   function d(e) {
    let { lineNumber: n, syntax: l, textContent: d, trim: a } = e,
     p = d;
    const { title: u, type: m } = (0, r.useContext)(t.n),
     _ = (0, r.useId)();
    return (
     a && (p = p.trim()),
     (0, c.jsx)(s.y$, {
      ...
      children: (e) => {
       ...
       return (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: _, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, c.jsx)(o.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': _, style: l, children: s.map((e, l) => (0, c.jsxs)('span', { ...r({ line: e }), children: [n && (0, c.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, c.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
   ...
   const a = (0, i.createContext)({}),
    p = (e) => {
     ...
     const m = { do: 'Doen', dont: 'Niet doen' },
      _ = u ? 'figure' : 'div',
      h = u ? 'figcaption' : 'div';
     return (0, d.jsxs)(_, { className: (0, t.Z)(c['nlds-guideline'], c[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(h, { className: (0, t.Z)(c['nlds-guideline__description']), children: ['dont' === l ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.nv, { className: (0, t.Z)(c['nlds-guideline__badge'], c[`nlds-guideline__badge--${l}`]), children: [(0, d.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: c['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: c['nlds-guideline__title'], children: m.dont })] }), (0, d.jsx)(r.nv, { children: n })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.nv, { className: (0, t.Z)(c['nlds-guideline__badge'], c[`nlds-guideline__badge--${l}`]), children: [(0, d.jsx)(s.Z, { 'aria-hidden': 'true', role: 'presentation', className: c['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: c['nlds-guideline__title'], children: m.do })] }), (0, d.jsx)(r.nv, { children: n })] }), i] }), (0, d.jsx)('div', { className: (0, t.Z)(c['nlds-guideline__example']), children: (0, d.jsx)(a.Provider, { value: { title: n, type: m[l] }, children: p }) })] });
    };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => i, a: () => t });
