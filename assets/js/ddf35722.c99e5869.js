 ...
 [30722],
 {
         ...
         children: [
          ...
          (0, m.jsx)('div', {
           children: (0, m.jsxs)(m.Fragment, {
            children: [
             (0, m.jsxs)(l.f, { role: 'status', children: [w, ' van de ', f, ' items zijn nu zichtbaar.'] }),
             w < f
              ? (0, m.jsx)(s.$, {
                 purpose: 'secondary',
                 onClick: () => {
  ...
  24456(e, n, t) {
   ...
   const o = ({ children: e, ...n }) => {
    ...
    l = ({ className: e, boxContent: n, ...t }) => (0, a.jsx)(o, { className: (0, i.$)('utrecht-link', 'utrecht-link--html-a', { 'utrecht-link--box-content': n }, e), ...t });
  },
  24908(e, n, t) {
   t.d(n, { Ay: () => o });
   var i = t(86070),
               ...
               d.Z,
               {
                ...
                description: (0, c.jsxs)('div', {
                 ...
                 children: [
                  ...
                  u.length > 0 && u.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)('section', { children: [(0, c.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [o, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(l.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => A, cR: () => k, Pv: () => f, qZ: () => o, kD: () => x, QQ: () => C, B2: () => m, Pc: () => s, f4: () => l, GT: () => v, fX: () => a, eQ: () => b, B_: () => w, o_: () => j });
  ...
  95051(e, n, t) {
   (t.r(n), t.d(n, { assets: () => L, component: () => W, contentTitle: () => G, default: () => _, description: () => D, frontMatter: () => R, issueNumber: () => S, metadata: () => i, title: () => N, toc: () => H }));
   ...
   const y = [
     ...
     { title: 'De kleur van het Form Field Label geeft geen informatie die niet ook op minimaal 1 andere manier wordt gegeven.', sc: '1.4.1', status: '', component: b.Ay, tags: ['designer'] },
     { title: 'De tekst in het Form Field Label heeft een contrastratio van minimaal 4,5:1 met de achtergrondkleur.', sc: '1.4.3', status: '', component: h.Ay, tags: ['designer'] },
     { title: 'De bezoeker kan het Form Field Label tot 400% vergroten zonder verlies van functionaliteit of informatie.', sc: '1.4.10', status: '', component: u.Ay, tags: ['developer', 'designer'] },
     ...
     { title: 'Als het Form Field Label in een andere taal is dan de taal van de pagina, dan heeft het label-element een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: j.Ay, tags: ['developer'] },
     { title: 'Elementen voor formulierinvoer met dezelfde functie hebben hetzelfde label.', sc: '3.2.4', status: '', component: w.Ay, tags: ['designer', 'contentmaker'] },
    ],
    C = [
     {
     ...
     { title: 'Als je de tekst van het Form Field Label vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: p.Ay, tags: ['developer'] },
