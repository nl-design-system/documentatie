(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [54592],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => y, VZ: () => N, cR: () => _, Pv: () => m, qZ: () => c, kD: () => k, B2: () => j, Pc: () => a, f4: () => s, GT: () => f, fX: () => o, eQ: () => b, B_: () => v, o_: () => p, Rc: () => x });
   ...
   const h = (e) => [...e].sort((e, t) => u.indexOf(e) - u.indexOf(t)),
    ...
    y = (e) => h(l(e.projects.flatMap((e) => g(e)))),
    m = (e) => {
     const t = g(e),
      n = ((e) => {
  ...
  61133(e, t, n) {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => g, contentTitle: () => u, default: () => p, description: () => d, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => h, toc: () => y });
  ...
  99630(e, t, n) {
   ...
   const p = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, a.jsx)(r.If, { sections: o.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, m.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(g, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, a.jsx)(y, { headingLevel: t + 1, checked: e, title: n, description: (0, m.qZ)(r) }, r)) }), (0, a.jsx)(r.fz, { children: (0, a.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
