 ...
 [71842],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    u = n(86070);
   const l = { figma: (0, u.jsx)(i.A, {}), github: (0, u.jsx)(o.A, {}), npm: (0, u.jsx)(c.A, {}), storybook: (0, u.jsx)(s.A, {}) },
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => p, VZ: () => w, cR: () => _, Pv: () => m, qZ: () => c, kD: () => b, B2: () => j, Pc: () => a, f4: () => s, GT: () => f, fX: () => o, eQ: () => k, B_: () => v, o_: () => g, Rc: () => x });
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map(({ name: r, id: i, value: o }) => {
        ...
        return { brand: c.toLowerCase(), name: r, id: i, value: o, description: s };
       });
  ...
  72642(e, t, n) {
   ...
   var r = n(13526),
    i = n(86070);
   const o = ({ children: e, className: t, level: n = 1, suffix: o, ...c }) => (0, i.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, t), ...c, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), o && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
  },
  90495(e, t, n) {
   'use strict';
   n.d(t, { AC: () => u, Fu: () => c, Wu: () => s, Zp: () => a });
   var r = n(46447),
    i = n(13526),
    o = n(86070);
   const c = ({ background: e, children: t, className: n, ...r }) => (0, o.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    s = (e) => (0, o.jsx)('div', { className: 'card__content', ...e }),
    a = ({ href: e, appearance: t, className: n, component: c = 'div', background: s, children: a }) => {
     const u = (e) => ('article' === c ? (0, o.jsx)('article', { ...e }) : 'section' === c ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      l = (0, o.jsx)(u, { className: (0, i.A)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, o.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    u = ({ appearance: e = 'medium', children: t, className: n }) => (0, o.jsx)('div', { className: (0, i.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
  99630(e, t, n) {
   'use strict';
            ...
            c.Zp,
            {
             ...
             children: (0, a.jsxs)(c.Wu, {
              children: [
               ...
               s.length > 0 && (0, a.jsx)(a.Fragment, { children: s.map(({ frameworkName: e, tasks: n }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(r.DZ, { level: t + 2, children: [i, ' in ', e] }), (0, a.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, a.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
