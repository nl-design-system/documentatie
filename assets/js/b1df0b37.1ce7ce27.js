 ...
 [18498],
 {
  ...
  66119(e, n, i) {
   ...
   const s = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: t, ...s }, l) => {
    const c = { ...s, ref: l, className: o('utrecht-note', { [`utrecht-note--${t}`]: t }, i) };
    return e ? (0, r.jsx)('aside', { ...c, children: n }) : (0, r.jsx)('section', { role: 'note', ...c, children: n });
   });
   s.displayName = 'Note';
   var l = i(29181);
   const c = globalThis.isAstro ? s : l.K7;
  },
  73357(e, n, i) {
   (i.r(n), i.d(n, { assets: () => v, contentTitle: () => p, default: () => x, frontMatter: () => g, metadata: () => r, toc: () => f }));
   const r = JSON.parse('{"id":"wcag/1.4.13","title":"WCAG-succescriterium 1.4.13 Content bij hover of focus","description":"Maak tijdelijke inhoud voorspelbaar.","source":"@site/docs/wcag/1.4.13.mdx","sourceDirName":"wcag","slug":"/wcag/1.4.13","permalink":"/wcag/1.4.13","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.13.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 1.4.13 Content bij hover of focus","title_sm":"1.4.13 Content bij hover of focus","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"1.4.13 Content bij hover of focus","pagination_label":"WCAG-succescriterium 1.4.13 Content bij hover of focus","description":"Maak tijdelijke inhoud voorspelbaar.","slug":"1.4.13","conformance_level":"Niveau AA","keywords":["WCAG","AA","waarneembaar","onderscheidbaar","perceivable","distinguishable","content on hover or focus"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 1.4.12 Tekstafstand","permalink":"/wcag/1.4.12"},"next":{"title":"WCAG-succescriterium 2.1.1 Toetsenbord","permalink":"/wcag/2.1.1"}}');
   var t = i(86070),
    o = i(18439),
    s = i(24703),
    l = i(61473),
