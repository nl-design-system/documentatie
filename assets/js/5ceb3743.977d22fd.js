    ...
    return (
     ...
     (0, s.jsx)(o.y$, {
      ...
      children: (e) => {
       ...
       return (0, s.jsx)(i.dn, { tabIndex: 0, style: l, children: o.map((e, l) => (0, s.jsxs)('span', { ...t({ line: e }), children: [n && (0, s.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const d = (e) => {
    ...
    const p = 'Doen',
     ...
     g = u ? 'figure' : 'div',
     h = u ? 'figcaption' : 'div';
    return (0, a.jsxs)(g, { className: (0, s.Z)(r['nlds-guideline'], r[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(h, { className: (0, s.Z)(r['nlds-guideline__description']), children: ['dont' === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, s.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(i.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: r['nlds-guideline__title'], children: m })] }), (0, a.jsx)(t.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, s.Z)(r['nlds-guideline__badge'], r[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(o.Z, { 'aria-hidden': 'true', role: 'presentation', className: r['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: r['nlds-guideline__title'], children: p })] }), (0, a.jsx)(t.nv, { children: n })] }), d] }), (0, a.jsx)('div', { className: (0, s.Z)(r['nlds-guideline__example']), children: c })] });
   };
  },
  24785: (e, n, l) => {
   l.d(n, { Z: () => r, a: () => s });
