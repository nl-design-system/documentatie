...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [80358],
 {
  ...
  58639(e, n, o) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: g = !0, children: j, container: x = 'document', language: b, designTokens: k }) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(N, { parser: b, plugins: [s.A, c.Ay, a.Ay, i.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      S(e);
     })();
    }, [N]);
    const z = (0, p.useId)();
    let R = p.Fragment;
    return (
     'paragraph' === x ? (R = m) : 'document' === x ? (R = y) : 'surface' === x && (R = v),
     (0, h.jsxs)('div', {
      ...
      children: [
       ...
       g &&
        (0, h.jsxs)('div', {
         ...
         hidden: !w,
         children: [
          (0, h.jsx)(l.M, { codeBlockLabel: 'Codevoorbeeld', syntax: b, textContent: C, trim: !0 }),
          n &&
           (0, h.jsx)('div', {
