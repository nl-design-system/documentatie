 ...
 [22619],
 {
  ...
  84074: (e, n, l) => {
   ...
   var t = l(52676),
    ...
    a = l(40761);
   function i(e) {
    const n = { button: 'button', ...(0, r.a)(), ...e.components };
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', '\n', (0, t.jsx)(a.X, { appearance: 'do', title: 'Geef duidelijk aan dat een formulier verzonden gaat worden.', children: (0, t.jsx)(s.X, { language: 'html', children: () => (0, t.jsx)(t.Fragment, { children: (0, t.jsx)(n.button, { children: 'Versturen' }) }) }) }), '\n', (0, t.jsx)(a.X, { appearance: 'dont', title: 'Gebruik hetzelfde label voor verzenden als voor de navigatie in een meerstappenformulier.', children: (0, t.jsx)(s.X, { language: 'html', children: () => (0, t.jsx)(t.Fragment, { children: (0, t.jsx)(n.button, { type: 'submit', children: 'Volgende' }) }) }) })] });
   }
   function c(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
  ...
  43599: (e, n, l) => {
   ...
   const y = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: y = !1, displayCode: b = !0, children: j, container: f = 'document', language: x, designTokens: k } = e,
     _ = 'function' == typeof j ? j() : j,
     w = 'function' == typeof n ? n() : (0, u.isValidElement)(n) ? n : void 0,
     z = 'string' == typeof n ? n : p.uS(w || _),
     [N, Z] = (0, u.useState)(z),
     [C, S] = (0, u.useState)(y);
    (0, u.useEffect)(() => {
     (async () => {
      (N = await d.ZP.format(z, { parser: x, plugins: [s.Z, a.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(N);
     })();
    }, [z]);
    const D = (0, u.useId)();
    let P = u.Fragment;
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       _ && (0, m.jsx)('div', { className: (0, o.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(P, { children: (0, m.jsx)(t.pu, { children: _ }) }) }) }),
       b &&
        (0, m.jsx)('div', {
       ...
       b &&
        (0, m.jsxs)('div', {
         ...
         hidden: !C,
         children: [
          (0, m.jsx)(r.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: N, trim: !0 }),
          l &&
           (0, m.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function c(e) {
    let { lineNumber: n, syntax: l, textContent: c, trim: d } = e,
     u = c;
    const { title: p, type: m } = (0, o.useContext)(s.n),
     h = (0, o.useId)();
    return (
     d && (u = u.trim()),
     (0, i.jsx)(r.y$, {
      ...
      children: (e) => {
       ...
       return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', m ? `\u201c${m}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, i.jsx)(t.dn, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': h, style: l, children: r.map((e, l) => (0, i.jsxs)('span', { ...o({ line: e }), children: [n && (0, i.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, i.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
