 ...
 [20911],
 {
  28904: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    c = n(65739),
    o = n(94443);
   const s = { title: 'Non Modal Dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Non Modal Dialog', pagination_label: 'Non Modal Dialog', description: 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina blijft mogelijk.', slug: '/non-modal-dialog', keywords: ['dialog', 'dialoogvenster', 'floating window', 'modal', 'non modal dialog', 'non modal window', 'overlay', 'popup', 'venster', 'window'] },
    a = void 0,
    l = { id: 'componenten/non-modal-dialog/index', title: 'Non Modal Dialog', description: 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina blijft mogelijk.', source: '@site/docs/componenten/non-modal-dialog/index.mdx', sourceDirName: 'componenten/non-modal-dialog', slug: '/non-modal-dialog', permalink: '/non-modal-dialog', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/non-modal-dialog/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Non Modal Dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Non Modal Dialog', pagination_label: 'Non Modal Dialog', description: 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina blijft mogelijk.', slug: '/non-modal-dialog', keywords: ['dialog', 'dialoogvenster', 'floating window', 'modal', 'non modal dialog', 'non modal window', 'overlay', 'popup', 'venster', 'window'] }, sidebar: 'componenten', previous: { title: 'Navigation Bar', permalink: '/navigation-bar' }, next: { title: 'Notification Banner', permalink: '/notification-banner' } },
    u = {},
    h = [
   ...
   const o = (e) => {
    ...
    a = (e) => {
     ...
     const l = (e) => ('article' === s ? (0, c.jsx)('article', { ...e }) : 'section' === s ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      u = (0, c.jsx)(l, { className: (0, i.Z)('cardgroup__card', `cardgroup__card--${n}`, o), children: a });
  ...
  94443: (e, t, n) => {
   ...
   const f = (e) => {
     ...
     const c = t && t.projects.filter((e) => k.e9.includes(e.id)),
      o = c && k.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, u.jsx)(r.a2, {
       appearance: '',
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, BA: () => s, Q6: () => c, U: () => l, e9: () => o, mA: () => i, ps: () => u });
    ...
    u = (e) => {
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        let { name: i, id: c, value: o } = r;
        const s = i.match(/^(.+) URL/)[1],
         a = 'Storybook' === s ? `${n} (${t}) in Storybook van ${e.title}` : `${n} (${t}) op ${s}`;
        return { brand: s.toLowerCase(), name: i, id: c, value: o, description: a };
       });
