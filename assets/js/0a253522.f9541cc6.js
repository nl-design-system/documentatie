  ...
  70348(e, n, t) {
   ...
   const a = ({ className: e, ...n }) => {
    ...
    i = ({ className: e, classNamePanel: n, label: t, heading: a, headingLevel: i, headingApperance: c, ...d }) => {
     ...
     return (0, o.jsxs)('details', { className: p, ...d, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(s.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [a && (0, o.jsx)(r.D, { level: i, appearance: c, children: a }), t] })] }) }), (0, o.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => y });
