...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [46103],
 {
  ...
  24910: (e, t, o) => {
   ...
   var h = o(29989),
    p = o(40879);
   const g = { container: 'container_RVvr' };
   function b(e) {
    let { readingTime: t } = e;
    const o = (function () {
   ...
   const k = { authorCol: 'authorCol_l8ez', imageOnlyAuthorRow: 'imageOnlyAuthorRow_s7Qc', imageOnlyAuthorCol: 'imageOnlyAuthorCol_M4Sb' };
   function P(e) {
    let { className: t } = e;
    const {
     metadata: { authors: o },
   ...
   const I = { blogPostFooterDetailsFull: 'blogPostFooterDetailsFull_QsdR' };
   function M() {
   ...
   function L(e) {
    ...
    return (0, c.jsxs)('nav', { className: 'pagination-nav docusaurus-mt-lg', 'aria-label': (0, h.I)({ id: 'theme.blog.post.paginator.navAriaLabel', message: 'Blog post page navigation', description: 'The ARIA label for the blog posts pagination' }), children: [o && (0, c.jsx)(A.Z, { ...o, subLabel: (0, c.jsx)(h.Z, { id: 'theme.blog.post.paginator.newerPost', description: 'The blog post button label to navigate to the newer/previous post', children: 'Newer Post' }) }), t && (0, c.jsx)(A.Z, { ...t, subLabel: (0, c.jsx)(h.Z, { id: 'theme.blog.post.paginator.olderPost', description: 'The blog post button label to navigate to the older/next post', children: 'Older Post' }), isNext: !0 })] });
   }
   var O = o(71738),
    $ = o(29450);
   function E(e) {
    ...
    return (0, c.jsxs)($.Z, { breadcrumbs: [{ label: 'Blog', href: '/blog' }, { label: l.title }], sidebar: t, toc: !d && r.length > 0 ? (0, c.jsx)(O.Z, { toc: r, minHeadingLevel: m, maxHeadingLevel: u }) : void 0, children: [(0, c.jsx)(R, { children: o }), (n || a) && (0, c.jsx)(L, { nextItem: n, prevItem: a })] });
   }
   function U(e) {
    const t = e.content;
