/*! For license information please see 0eacf79f.bd977521.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [3318],
 {
  ...
  18652(e, n, i) {
   ...
   const s = (e, n, i, s) => {
    const o = (0, t.forwardRef)(({ color: i = 'currentColor', size: o = 24, stroke: a = 2, title: l, className: d, children: h, ...c }, g) => (0, t.createElement)('svg', { ref: g, ...r[e], width: o, height: o, className: ['tabler-icon', `tabler-icon-${n}`, d].join(' '), ...('filled' === e ? { fill: i } : { strokeWidth: a, stroke: i }), ...c }, [l && (0, t.createElement)('title', { key: 'svg-title' }, l), ...s.map(([e, n]) => (0, t.createElement)(e, n)), ...(Array.isArray(h) ? h : [h])]));
  ...
  45282(e, n, i) {
   ...
   const s = ({ children: e, ...n }) => {
     ...
     return ('https://nldesignsystem.nl' === a.origin ? ((a.pathname = a.pathname.endsWith('/') ? a.pathname : `${a.pathname}/`), (o = a.toString().replace('https://nldesignsystem.nl', ''))) : ((s.target = '_blank'), (s.rel = 'noopener noreferrer')), (0, r.jsx)('a', { href: o, ...s, children: e }));
    },
    o = ({ className: e, ...n }) => (0, r.jsx)(s, { className: (0, t.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  49797(e, n, i) {
   (i.r(n), i.d(n, { assets: () => c, contentTitle: () => h, default: () => u, frontMatter: () => d, metadata: () => t, toc: () => g }));
   const t = JSON.parse('{"id":"community/events/design-open-hour/design-open-hour","title":"Design Open Hour \xb7 Bijeenkomsten","description":"Wat is Design Open Hour, hoe meld ik mij aan, en op welke momenten is het?","source":"@site/docs/community/events/design-open-hour/design-open-hour.mdx","sourceDirName":"community/events/design-open-hour","slug":"/events/design-open-hour","permalink":"/events/design-open-hour","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/community/events/design-open-hour/design-open-hour.mdx","tags":[],"version":"current","frontMatter":{"title":"Design Open Hour \xb7 Bijeenkomsten","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Design Open Hour","pagination_label":"In de Design Open Hour wisselen designers informatie, inzichten en tips met elkaar uit.","description":"Wat is Design Open Hour, hoe meld ik mij aan, en op welke momenten is het?","slug":"/events/design-open-hour"},"sidebar":"community","previous":{"title":"Design Open Hour","permalink":"/events/design-open-hour/overzicht"},"next":{"title":"In de Design Open Hour wisselen designers informatie, inzichten en tips met elkaar uit.","permalink":"/events/design-open-hour/aanmelden"}}');
   var r = i(86070),
    s = i(18439),
    o = i(88666),
    a = i(64249),
  ...
  88666(e, n, i) {
   ...
   var t = i(45282),
    r = i(13526),
    s = i(86070);
   const o = ({ appearance: e, ...n }) => (0, s.jsx)(t.F, { className: (0, r.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...n });
  },
 },
]);
