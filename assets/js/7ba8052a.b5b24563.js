 ...
 [42492],
 {
  ...
  41757: (e, n, r) => {
   ...
   var i = r(4814),
    t = r(52676);
   const o = (e) => {
    let { children: n, className: r, level: o = 1, suffix: a, ...s } = e;
    return (0, t.jsxs)('hgroup', { className: (0, i.Z)('nlds-inline-heading-group', `utrecht-heading-${o}`, r), ...s, children: [(0, t.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: n }), a && (0, t.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [a ? ' ' : '', a] })] });
   };
  },
  57716: (e, n, r) => {
   r.d(n, { U: () => d });
   ...
   const a = (e, n) => {
    ...
    l = (e) => ({
     img: (n) => {
      let { src: r, ...i } = n;
      return (0, o.jsx)('img', { ...i, src: a(e, r), className: 'utrecht-img utrecht-img--fit' });
     },
    }),
    c = (e, n) => {
     if (e) {
    ...
    d = (e) => {
     let { children: n, omitH1: r = !1, headingLevel: t = 1, baseUrl: a = '', components: s = {} } = e;
     return (0, o.jsx)(i.Z, { components: { ...c(r, t), ...l(a), ...s }, children: n });
    };
  },
  46364: (e, n, r) => {
   r.d(n, { j: () => a });
   ...
   const a = (e) => {
    ...
    return (0, o.jsx)(t.V, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: r && (0, o.jsx)(i.Ou, { className: 'nlds-inline-heading-group__badge', children: r }), ...a, children: n });
   };
  },
  87118: (e, n, r) => {
   r.d(n, { Z: () => s, a: () => a });
