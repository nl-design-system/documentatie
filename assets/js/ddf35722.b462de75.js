 ...
 [30722],
 {
  1292(e, n, t) {
   ...
   var r = t(29181),
    ...
    s = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(i.A, {}), github: (0, d.jsx)(o.A, {}), npm: (0, d.jsx)(l.A, {}), storybook: (0, d.jsx)(a.A, {}) },
    h = ({ brand: e }) => (0, d.jsx)(r.In, { children: c[e] || (0, d.jsx)(s.A, {}) });
  },
  4964(e, n, t) {
   t.d(n, { Ay: () => l });
   var r = t(86070),
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => i, KF: () => p, mJ: () => j, VZ: () => y, cR: () => A, Pv: () => g, qZ: () => l, kD: () => x, B2: () => m, Pc: () => s, f4: () => a, GT: () => v, fX: () => o, eQ: () => k, B_: () => b, o_: () => f, Rc: () => w });
     ...
     return n.map((n) => {
      const r = e.tasks
       ...
       .map(({ name: r, id: i, value: o }) => {
        ...
        return { brand: l.toLowerCase(), name: r, id: i, value: o, description: a };
       });
  ...
  37131(e, n, t) {
   ...
   const j = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
         ...
         children: t
          ...
          .map((e) => {
           const t = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            h = e.tasks.filter(({ name: e, value: n }) => s.has(e) && URL.canParse(n) && 'https:' === new URL(n).protocol);
           return (0, d.jsx)(
            l.Zp,
            {
             ...
             children: (0, d.jsxs)(l.Wu, {
              children: [
               ...
               (h.length > 0 || a.length > 0) && (0, d.jsx)(r.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, d.jsx)(d.Fragment, {
    ...
    k = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.p, { level: n, suffix: i && (0, d.jsx)(h.D, { state: i }), children: e.title }), (0, d.jsx)(r.fz, { lead: !0, children: t })] });
    },
    x = ({ component: e }) => {
     const n = (e && j[e.title]) || [];
  ...
  67970(e, n, t) {
   ...
   const a = ({ state: e }) => {
    const n = (0, o.fX)(e);
    return (0, l.jsx)(r.KE, { className: (0, i.A)('estafette-badge', n && `estafette-badge--${n}`), children: e });
   };
  },
  72642(e, n, t) {
   t.d(n, { p: () => o });
   var r = t(13526),
    i = t(86070);
   const o = ({ children: e, className: n, level: t = 1, suffix: o, ...l }) => (0, i.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${t}`, n), ...l, children: [(0, i.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), o && (0, i.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [o ? ' ' : '', o] })] });
  },
  83329(e, n, t) {
   t.d(n, { Ay: () => l });
   var r = t(86070),
  ...
  83918(e, n, t) {
   (t.r(n), t.d(n, { assets: () => y, component: () => N, contentTitle: () => A, default: () => S, description: () => F, frontMatter: () => w, issueNumber: () => z, metadata: () => r, title: () => D, toc: () => L }));
   ...
   const k = [
     ...
     { title: 'De kleur van het Form Field Label geeft geen informatie die niet ook op minimaal 1 andere manier wordt gegeven.', sc: '1.4.1', status: '', component: t(44720).Ay, tags: ['designer'] },
     { title: 'De tekst in het Form Field Label heeft een contrastratio van minimaal 4,5:1 met de achtergrondkleur.', sc: '1.4.3', status: '', component: u.Ay, tags: ['designer'] },
     { title: 'De bezoeker kan het Form Field Label tot 400% vergroten zonder verlies van functionaliteit of informatie.', sc: '1.4.10', status: '', component: p.Ay, tags: ['developer', 'designer'] },
     { title: 'Het Form Field Label beschrijft wat de bezoeker moet invullen.', sc: '2.4.6', status: '', component: g.Ay, tags: ['designer', 'contentmaker'] },
     { title: 'Als het Form Field Label in een andere taal is dan de taal van de pagina, dan heeft het label-element een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: f.Ay, tags: ['developer'] },
     { title: 'Elementen voor formulierinvoer met dezelfde functie hebben hetzelfde label.', sc: '3.2.4', status: '', component: b.Ay, tags: ['designer', 'contentmaker'] },
    ],
    x = [
     {
     ...
     { title: 'Als je de tekst van het Form Field Label vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: j.Ay, tags: ['developer'] },
  ...
  90495(e, n, t) {
   t.d(n, { AC: () => d, Fu: () => l, Wu: () => a, Zp: () => s });
   var r = t(46447),
    i = t(13526),
    o = t(86070);
   const l = ({ background: e, children: n, className: t, ...r }) => (0, o.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, t), ...r, children: n }),
    a = (e) => (0, o.jsx)('div', { className: 'card__content', ...e }),
    s = ({ href: e, appearance: n, className: t, component: l = 'div', background: a, children: s }) => {
     const d = (e) => ('article' === l ? (0, o.jsx)('article', { ...e }) : 'section' === l ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      c = (0, o.jsx)(d, { className: (0, i.A)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: s });
