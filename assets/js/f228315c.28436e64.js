 ...
 [63481],
 {
  ...
  58639(e, n, t) {
   ...
   var l = t(69284),
    ...
    h = t(31186),
    m = t(86070);
   const u = ({ children: e }) => (0, m.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(a.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(a.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   u.displayName = 'ParagraphContainer';
   const p = ({ children: e }) => (0, m.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(a.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   p.displayName = 'DocumentContainer';
   const b = ({ children: e }) => (0, m.jsx)(a.ui, { className: 'nlds-canvas__example-surface', children: e });
   ...
   const v = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: v = !0, children: j, container: k = 'document', language: f, designTokens: y }) => {
    ...
    (0, g.useEffect)(() => {
     (async () => {
      const e = await c.Ay.format(w, { parser: f, plugins: [s.A, o.Ay, r.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      z(e);
     })();
    }, [w]);
    const S = (0, g.useId)();
    let D = g.Fragment;
    return (
     'paragraph' === k ? (D = u) : 'document' === k ? (D = p) : 'surface' === k && (D = b),
     (0, m.jsxs)('div', {
