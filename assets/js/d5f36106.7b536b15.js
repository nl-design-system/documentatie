 ...
 [38662],
 {
   ...
   const l = ({ background: e, children: n, className: a, ...t }) => (0, s.jsx)('div', { className: (0, i.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, a), ...t, children: n }),
    ...
    r = ({ href: e, appearance: n, className: a, component: l = 'div', background: o, children: r }) => {
     const g = (e) => ('article' === l ? (0, s.jsx)('article', { ...e }) : 'section' === l ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      u = (0, s.jsx)(g, { className: (0, i.A)('ma-cardgroup__card', o && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, a), children: r });
  ...
  39948(e, n, a) {
   ...
   var t = a(29181),
    ...
    r = a(83386),
    g = a(86070);
   const u = { figma: (0, g.jsx)(i.A, {}), github: (0, g.jsx)(s.A, {}), npm: (0, g.jsx)(l.A, {}), storybook: (0, g.jsx)(o.A, {}) },
    d = ({ brand: e }) => (0, g.jsx)(t.In, { children: u[e] || (0, g.jsx)(r.A, {}) });
  },
  46292(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => p, contentTitle: () => g, default: () => f, description: () => m, frontMatter: () => r, issueNumber: () => c, metadata: () => t, title: () => d, toc: () => h }));
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => D, cR: () => F, Pv: () => b, qZ: () => l, kD: () => v, B2: () => c, Pc: () => r, f4: () => o, GT: () => j, fX: () => s, eQ: () => k, B_: () => x, o_: () => f });
