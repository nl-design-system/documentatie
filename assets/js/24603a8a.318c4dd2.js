...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  81362: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => k, contentTitle: () => c, default: () => p, frontMatter: () => d, metadata: () => h, toc: () => u });
   var t = i(52676),
    r = i(24785),
    l = i(91410),
    s = i(88435);
