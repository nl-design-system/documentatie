 ...
 [3318],
 {
  21157: (e, t, n) => {
   ...
   var i = n(52676),
    s = n(24785),
    l = n(17925);
   const r = { title: "Ordered list", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Ordered list", pagination_label: "Ordered list", description: "UX richtlijnen voor Ordered list component", slug: "/ordered-list", tags: ["Unknown"] },
    d = "Ordered list",
    o = { id: "componenten/build/ordered-list", title: "Ordered list", description: "UX richtlijnen voor Ordered list component", source: "@site/docs/componenten/build/ordered-list.mdx", sourceDirName: "componenten/build", slug: "/ordered-list", permalink: "/ordered-list", draft: !1, unlisted: !1, editUrl: "https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/build/ordered-list.mdx", tags: [{ label: "Unknown", permalink: "/tags/unknown" }], version: "current", frontMatter: { title: "Ordered list", hide_title: !0, hide_table_of_contents: !1, sidebar_label: "Ordered list", pagination_label: "Ordered list", description: "UX richtlijnen voor Ordered list component", slug: "/ordered-list", tags: ["Unknown"] }, sidebar: "componenten", previous: { title: "Number input", permalink: "/number-input" }, next: { title: "Page footer", permalink: "/page-footer" } },
    h = {},
    a = [
