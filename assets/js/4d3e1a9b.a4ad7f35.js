(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [45119],
 {
  18535: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => m, contentTitle: () => a, default: () => g, description: () => j, frontMatter: () => o, issueNumber: () => y, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(40139),
    c = n(99890),
    s = n(8657);
   ...
   const s = (e) => {
    ...
    a = (e) => {
     ...
     const l = (e) => ('article' === o ? (0, c.jsx)('article', { ...e }) : 'section' === o ? (0, c.jsx)('section', { ...e }) : (0, c.jsx)('div', { ...e })),
      d = (0, c.jsx)(l, { className: (0, i.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, s), children: u });
                 ...
                 children: (0, l.jsx)(r.Mc, {
                  links: o
                   ...
                   .map((e) => {
                    ...
                    return { children: t.desciption, icon: (0, l.jsx)(h, { brand: t.brand }), href: e.value };
                   }),
                 }),
                }),
               c.length > 0 &&
                (0, l.jsx)(l.Fragment, {
                 children: c.map((e) => {
                  ...
                  return (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.X6, { level: n + 2, children: [i, ' in ', t] }), (0, l.jsx)(r.Mc, { links: c.map((e) => ({ children: e.description, icon: (0, l.jsx)(h, { brand: e.brand }), href: e.value })) })] });
                 }),
                }),
              ],
             }),
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => o, Ee: () => l, Q6: () => c, U: () => j, Yr: () => g, d: () => d, e9: () => s, fO: () => v, mA: () => i, ps: () => y, qU: () => b, s0: () => k, zP: () => m });
   ...
   const u = (e) => {
    ...
    j = (e) => u(a(e.projects.flatMap((e) => h(e)))),
    y = (e) => {
     const t = h(e),
      n = ((e) => {
       const t = e.tasks.find((e) => {
