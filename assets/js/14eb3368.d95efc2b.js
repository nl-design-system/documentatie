...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [46969],
 {
  2618(e, n, s) {
   ...
   const u = 'breadcrumbHomeIcon_NSFQ';
   function h() {
    const e = (0, c.Ay)('/');
    return (0, d.jsx)('li', { className: 'breadcrumbs__item', children: (0, d.jsx)(o.A, { 'aria-label': (0, l.T)({ id: 'theme.docs.breadcrumbs.home', message: 'Home page', description: 'The ARIA label for the home page in the breadcrumbs' }), className: 'breadcrumbs__link', href: e, children: (0, d.jsx)(m, { className: u }) }) });
   }
   var p = s(28836),
    b = s(35378);
   function g(e) {
   ...
   const v = 'breadcrumbsContainer_oSgQ';
   function x({ children: e, href: n, isLast: s }) {
    const t = 'breadcrumbs__link';
    return s ? (0, d.jsx)('span', { className: t, children: e }) : n ? (0, d.jsx)(o.A, { className: t, href: n, children: (0, d.jsx)('span', { children: e }) }) : (0, d.jsx)('span', { className: t, children: e });
   }
  ...
  34484(e, n, s) {
   ...
   var t = s(13526),
    ...
    i = s(86070);
   function r(e) {
    const { permalink: n, title: s, subLabel: r, isNext: o } = e;
    return (0, i.jsxs)(a.A, { className: (0, t.A)('pagination-nav__link', o ? 'pagination-nav__link--next' : 'pagination-nav__link--prev'), to: n, children: [r && (0, i.jsx)('div', { className: 'pagination-nav__sublabel', children: r }), (0, i.jsx)('div', { className: 'pagination-nav__label', children: s })] });
   }
  },
  52685(e, n, s) {
   s.d(n, { A: () => o });
  ...
  66518(e, n, s) {
   ...
   var t = s(66150),
    ...
    d = s(2618),
    m = s(58249);
   const u = { generatedIndexPage: 'generatedIndexPage_g1Ok', title: 'title_FWF1' };
   var h = s(86070);
   ...
   function b({ categoryGeneratedIndex: e }) {
    const n = (0, a.$S)();
    return (0, h.jsxs)('div', { className: u.generatedIndexPage, children: [(0, h.jsx)(l.A, {}), (0, h.jsx)(d.A, {}), (0, h.jsx)(c.A, {}), (0, h.jsxs)('header', { children: [(0, h.jsx)(m.A, { as: 'h1', className: u.title, children: e.title }), e.description && (0, h.jsx)('p', { children: e.description })] }), (0, h.jsx)('article', { className: 'margin-top--lg', children: (0, h.jsx)(r.A, { items: n.items, className: u.list }) }), (0, h.jsx)('footer', { className: 'margin-top--md', children: (0, h.jsx)(o.A, { previous: e.navigation.previous, next: e.navigation.next }) })] });
   }
   function g(e) {
  ...
  74952(e, n, s) {
   ...
   function b({ className: e, versionMetadata: n }) {
    const {
     ...
     { latestDocSuggestion: d, latestVersionSuggestion: u } = (0, o.HW)(i),
     b = d ?? (g = u).docs.find((e) => e.id === g.mainDocId);
    var g;
    return (0, m.jsxs)('div', { className: (0, t.A)(e, l.G.docs.docVersionBanner, 'alert alert--warning margin-bottom--md'), role: 'alert', children: [(0, m.jsx)('div', { children: (0, m.jsx)(h, { siteTitle: s, versionMetadata: n }) }), (0, m.jsx)('div', { className: 'margin-top--md', children: (0, m.jsx)(p, { versionLabel: u.label, to: b.path, onClick: () => r(u.name) }) })] });
   }
  ...
  78641(e, n, s) {
   ...
   function l({ className: e }) {
    const n = (0, r.r)();
    return n.badge ? (0, o.jsx)('span', { className: (0, t.A)(e, i.G.docs.docVersionBadge, 'badge badge--secondary'), children: (0, o.jsx)(a.A, { id: 'theme.docs.versionBadge.label', values: { versionLabel: n.label }, children: 'Version: {versionLabel}' }) }) : null;
   }
  },
  82110(e, n, s) {
   s.d(n, { A: () => p });
   ...
   function c({ href: e, icon: n = '', title: s, description: t, children: i }) {
    return (0, l.jsxs)('div', { className: 'card', children: [e ? (0, l.jsx)(a.N, { href: e, className: (0, o.A)('cardLink', 'utrecht-link'), children: (0, l.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', s] }) }) : (0, l.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', s] }), t && (0, l.jsx)('p', { className: 'cardDescription', children: t }), i] });
   }
   function d({ item: e }) {
    return (0, l.jsx)(c, { title: e.label, description: e.description, children: (0, l.jsx)(r.Xy, { children: e.items.filter((e) => 'link' === e.type || 'category' === e.type).map((e, n) => (0, l.jsx)(r.Er, { children: 'link' === e.type ? (0, l.jsx)(a.N, { to: e.href, children: e.label }) : 'category' === e.type ? (0, l.jsxs)(a.N, { to: e.href, children: [e.items.length, " pagina's voor ", e.label] }) : (0, l.jsx)(l.Fragment, {}) }, n)) }) });
   }
   function m({ item: e }) {
    const n = (0, i.cC)(e.docId);
    return (0, l.jsx)(c, { href: e.href, title: e.label, description: e.description ?? n?.description });
   }
   function u({ item: e }) {
    switch (e.type) {
     case 'link':
   ...
   function h({ className: e }) {
    const n = (0, t.$S)();
    return (0, l.jsx)(p, { items: n.items, className: e });
   }
   function p(e) {
    const { items: n, className: s } = e;
    if (!n) return (0, l.jsx)(h, { ...e });
    const a = (0, t.d1)(n);
    return (0, l.jsx)('section', { className: (0, o.A)('row', s), ...e, children: a.map((e, n) => (0, l.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, l.jsx)(u, { item: e }) }, n)) });
   }
  },
  84471(e, n, s) {
   s.d(n, { bo: () => a, KF: () => u, mJ: () => b, VZ: () => k, cR: () => N, Pv: () => g, qZ: () => r, kD: () => f, QQ: () => _, B2: () => h, Pc: () => l, f4: () => o, GT: () => A, fX: () => i, eQ: () => j, B_: () => x, o_: () => v });
