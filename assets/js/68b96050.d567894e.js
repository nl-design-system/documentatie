(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [23221],
 {
  3890: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => j, component: () => v, contentTitle: () => h, default: () => x, description: () => p, frontMatter: () => d, issueNumber: () => k, metadata: () => u, title: () => m, toc: () => g });
   var r = t(52676),
    i = t(24785),
    a = t(80719),
    s = t(90786),
   ...
   const d = { title: 'Paragraph', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Paragraph', pagination_label: 'Paragraph', description: 'Toont een alinea aan tekst.', slug: '/paragraph', tags: ['Community'] },
    ...
    m = 'Paragraph',
    p = 'Toont een alinea aan tekst.',
    k = 115,
    v = a.find((e) => e.number === k);
   function y(e) {
  ...
  90786: (e, n, t) => {
   ...
   const z = (e) => {
    ...
    N = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(v.V, { level: t, suffix: a && (0, d.jsx)(k.y, { state: a }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, n, t) => {
   'use strict';
