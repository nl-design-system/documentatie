...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [4270],
 {
  ...
  39170(e, n, i) {
   ...
   const j = { title: 'WCAG-succescriterium 2.4.6 Koppen en labels', title_sm: '2.4.6 Koppen en labels', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.4.6 Koppen en labels', pagination_label: 'WCAG-succescriterium 2.4.6 Koppen en labels', description: 'Koppen en labels beschrijven het onderwerp of het doel.', slug: '2.4.6', conformance_level: 'Niveau AA', keywords: ['WCAG', 'AA', 'bedienbaar', 'navigeerbaar', 'operable', 'navigable', 'headings and labels'] },
    u = void 0,
    m = {},
  ...
  61473(e, n, i) {
   ...
   var r = i(46447),
    s = i(46276),
    l = i(86070);
   const t = ({ children: e, conformanceLevel: n, ...i }) => (globalThis.isAstro ? null : (0, l.jsx)(s.p, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: n && (0, l.jsx)(r.KE, { className: 'nlds-inline-heading-group__badge', children: n }), ...i, children: e }));
  },
  66117(e, n, i) {
   i.d(n, { Ay: () => a, RM: () => l });
   var r = i(86070),
  ...
  66119(e, n, i) {
   ...
   function s(e) {
    ...
    if ('string' == typeof e || 'number' == typeof e) r += e;
     ...
     if (Array.isArray(e)) {
      var l = e.length;
      for (n = 0; n < l; n++) e[n] && (i = s(e[n])) && (r && (r += ' '), (r += i));
     } else for (i in e) e[i] && (r && (r += ' '), (r += i));
    return r;
   }
   function l() {
    for (var e, n, i = 0, r = '', l = arguments.length; i < l; i++) (e = arguments[i]) && (n = s(e)) && (r && (r += ' '), (r += n));
    return r;
   }
   const t = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: s, ...t }, a) => {
    const o = { ...t, ref: a, className: l('utrecht-note', { [`utrecht-note--${s}`]: s }, i) };
    return e ? (0, r.jsx)('aside', { ...o, children: n }) : (0, r.jsx)('section', { role: 'note', ...o, children: n });
   });
   t.displayName = 'Note';
   var a = i(29181);
   const o = globalThis.isAstro ? t : a.K7;
  },
 },
]);
