 ...
 [79048],
 {
  50236(e, t, n) {
   ...
   var a = n(30758),
    ...
    d = n(426),
    u = n(45196);
   const m = 'backToTopButton_V1p1',
    b = 'backToTopButtonShow_ZqSz';
   var h = n(86070);
   function p() {
   ...
   const C = 'collapseSidebarButton_oF6F',
    A = 'collapseSidebarButtonIcon_HX45';
   ...
   var L = n(17996),
    ...
    B = n(36998),
    H = n(72676);
   const P = 'menuExternalLink_qx7w',
    G = 'linkLabel_l6Oo';
   function D({ label: e }) {
    return (0, h.jsx)('span', { title: e, className: G, children: e });
   }
   function R({ item: e, onItemClick: t, activePath: n, level: a, index: s, ...r }) {
    const { href: c, label: d, className: u, autoAddBaseUrl: m } = e,
     b = (0, l.w8)(e, n),
     p = (0, B.A)(c);
    return (0, h.jsx)('li', { className: (0, i.A)(o.G.docs.docSidebarItemLink, o.G.docs.docSidebarItemLinkLevel(a), 'menu__list-item', u), children: (0, h.jsxs)(E.A, { className: (0, i.A)('menu__link', !p && P, { 'menu__link--active': b }), autoAddBaseUrl: m, 'aria-current': b ? 'page' : void 0, to: c, ...(p && { onClick: t ? () => t(e) : void 0 }), ...r, children: [(0, h.jsx)(D, { label: d }), !p && (0, h.jsx)(H.A, {})] }) }, d);
   }
   const V = 'categoryLink_k2bN',
    F = 'categoryLinkLabel_nM6S';
   ...
   function q({ label: e }) {
    return (0, h.jsx)('span', { title: e, className: F, children: e });
   }
   function U(e) {
    return 0 === (0, l.Y)(e.item.items, e.activePath).length ? (0, h.jsx)(Y, { ...e }) : (0, h.jsx)(z, { ...e });
   }
   function Y({ item: e, ...t }) {
   ...
   function z({ item: e, onItemClick: t, activePath: n, level: s, index: r, ...c }) {
    const { items: d, label: u, collapsible: m, className: b, href: p } = e,
     ...
     j = (0, l.w8)(e, n),
     g = (0, w.ys)(p, n),
     { collapsed: v, setCollapsed: C } = (0, L.u)({ initialState: () => !!m && !j && e.collapsed }),
    ...
    })({ isActive: j, collapsed: v, updateCollapsed: S, activePath: n }),
     (0, a.useEffect)(() => {
      m && null != A && A !== r && x && C(!0);
     }, [m, A, r, C, x]));
    return (0, h.jsxs)('li', {
     ...
     children: [
      (0, h.jsxs)('div', {
       ...
       children: [
        (0, h.jsx)(E.A, {
         className: (0, i.A)(V, 'menu__link', { 'menu__link--sublist': m, 'menu__link--sublist-caret': !p && m, 'menu__link--active': j }),
         onClick: (n) => {
      ...
      (0, h.jsx)(L.N, { lazy: !0, as: 'ul', className: 'menu__list', collapsed: v, children: (0, h.jsx)(K, { items: d, tabIndex: v ? -1 : 0, onItemClick: t, activePath: n, level: s + 1 }) }),
     ],
    });
   }
   const O = 'menuHtmlItem_aq6b';
   function Z({ item: e, level: t, index: n }) {
   ...
   function X({ items: e, ...t }) {
    ...
    return (0, h.jsx)(I, { children: n.map((e, n) => (0, h.jsx)(Q, { item: e, index: n, ...t }, n)) });
   }
   const K = (0, a.memo)(X),
    $ = 'menu_rQlf',
    J = 'menuWithAnnouncementBar_FEC8';
   function ee({ path: e, sidebar: t, className: n }) {
    ...
    return (0, h.jsx)('nav', { 'aria-label': (0, c.T)({ id: 'theme.docs.sidebar.navAriaLabel', message: 'Docs sidebar', description: 'The ARIA label for the sidebar navigation' }), className: (0, i.A)('menu thin-scrollbar', $, s && J, n), children: (0, h.jsx)('ul', { className: (0, i.A)(o.G.docs.docSidebarMenu, 'menu__list'), children: (0, h.jsx)(K, { items: t, activePath: e, level: 1 }) }) });
   }
   const te = 'sidebar_REVN',
    ne = 'sidebarWithHideableNavbar__OG4',
    ae = 'sidebarHidden_DiuM',
    ie = 'sidebarLogo_LAd8';
   ...
   const be = 'expandButton_VnDr',
    he = 'expandButtonIcon_U3dV';
   ...
   const xe = { docSidebarContainer: 'docSidebarContainer_TxCG', docSidebarContainerHidden: 'docSidebarContainerHidden_zqIU', sidebarViewport: 'sidebarViewport_Sg7C' };
   function fe({ children: e }) {
    const t = (0, r.t)();
    return (0, h.jsx)(a.Fragment, { children: e }, t?.name ?? 'noSidebar');
   }
   function je({ sidebar: e, hiddenSidebarContainer: t, setHiddenSidebarContainer: n }) {
    const { pathname: s } = (0, f.zy)(),
     [l, r] = (0, a.useState)(!1),
     c = (0, a.useCallback)(() => {
    ...
    return (0, h.jsx)('aside', {
     ...
     children: (0, h.jsx)(fe, { children: (0, h.jsxs)('div', { className: (0, i.A)(xe.sidebarViewport, l && xe.sidebarViewportHidden), children: [(0, h.jsx)(me, { sidebar: e, path: s, onCollapse: c, isHidden: l }), l && (0, h.jsx)(pe, { toggleSidebar: c })] }) }),
    });
   }
   const _e = { docMainContainer: 'docMainContainer_tYQO', docMainContainerEnhanced: 'docMainContainerEnhanced_jgt_', docItemWrapperEnhanced: 'docItemWrapperEnhanced_tpWi' };
   ...
   const ve = 'docRoot_YPC2',
    Ce = 'docsWrapper_mqiE';
   function Ae({ children: e }) {
    const t = (0, r.t)(),
     [n, i] = (0, a.useState)(!1);
    return (0, h.jsxs)('div', { className: Ce, children: [(0, h.jsx)(p, {}), (0, h.jsxs)('div', { className: ve, children: [t && (0, h.jsx)(je, { sidebar: t.items, hiddenSidebarContainer: n, setHiddenSidebarContainer: i }), (0, h.jsx)(ge, { hiddenSidebarContainer: n, children: e })] })] });
   }
   var ke = n(99625);
   function Se(e) {
    const t = (0, l.B5)(e);
