(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [98634],
 {
  ...
  24424: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => R, component: () => _, contentTitle: () => W, default: () => Z, description: () => P, frontMatter: () => G, issueNumber: () => S, metadata: () => L, title: () => N, toc: () => D });
   var r = t(52676),
    i = t(24785),
    s = t(96439),
    o = t(92183);
   ...
   const G = { title: 'Link', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Link', pagination_label: 'Link', description: 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.', slug: '/link' },
    ...
    N = 'Link',
    P = 'Een verwijzing om een een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.',
    S = 118,
    _ = s.find((e) => e.number === S);
   function F(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(z.Rv, { component: _, headingLevel: 1, description: P }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, r.jsx)(z.cN, { component: _, headingLevel: 3 }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, r.jsx)(z.W, { component: _, headingLevel: 3 }),
      '\n',
      ...
      (0, r.jsx)(T.t, {
       ...
       items: [
        { title: 'Het label van de Link bestaat uit gewone tekst, niet uit een afbeelding van tekst', sc: '1.4.5', status: '', component: (0, r.jsx)(x.ZP, {}) },
        ...
        { title: 'De zichtbare naam van de Link komt voor in de toegankelijke naam', sc: '2.5.3', status: '', component: (0, r.jsx)(w.ZP, {}) },
        { title: 'Als de tekst van de Link in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode', sc: '3.1.2', status: '', component: (0, r.jsx)(v.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(T.t, {
       ...
       items: [
        ...
        { title: 'Als het zichtbare label van de Link alleen een afbeelding of icoon is, dan is het contrast tussen de afbeelding en de achtergrond minimaal 3:1', sc: '1.4.11', status: '', component: (0, r.jsx)(l.ZP, {}) },
        { title: 'De Link heeft een goed zichtbare focusindicator', sc: '2.4.13', status: '', component: (0, r.jsx)(j.ZP, {}) },
        { title: 'De Link heeft een aanklikbaar gedeelte van ten minste 44 bij 44 pixels', sc: '2.5.5', status: '', component: (0, r.jsx)(k.ZP, {}) },
        { title: 'Links met gelijke functies hebben hetzelfde uiterlijk en hetzelfde label', sc: '3.2.4', status: '', component: (0, r.jsx)(f.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(T.t, {
      ...
      (0, r.jsx)(T.t, {
       ...
       items: [
        ...
        { title: 'De functionaliteit van de Link veroorzaakt geen toetsenbordval', sc: '2.1.2', status: '', component: (0, r.jsx)(y.ZP, {}) },
        { title: 'Wanneer de Link de toetsenbordfocus krijgt is de focus zichtbaar', sc: '2.4.7', status: '', component: (0, r.jsx)(m.ZP, {}) },
        ...
        { title: 'Als de gebruiker de Link indrukt met een aanwijzer zoals een muis of vinger, is er de mogelijkheid is om actie te voorkomen of ongedaan te maken', sc: '2.5.2', status: '', component: (0, r.jsx)(p.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(T.t, {
       ...
       items: [
        ...
        { title: 'De Link heeft een rol van link en een toegankelijke naam die duidelijk maakt waar de Link voor dient', sc: '4.1.2', status: '', component: (0, r.jsx)(b.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }),
      '\n',
      (0, r.jsx)(z.vM, { component: _, headingLevel: 3 }),
     ],
    });
   }
   function Z(e = {}) {
  ...
  8657: (e, n, t) => {
   ...
   const y = (e) => {
    ...
    T = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(w.V, { level: t, suffix: s && (0, d.jsx)(p.y, { state: s }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, n, t) => {
   'use strict';
