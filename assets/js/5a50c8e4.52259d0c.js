 ...
 [17684],
 {
  1292(e, n, t) {
   ...
   var r = t(29181),
    ...
    l = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(s.A, {}), github: (0, d.jsx)(o.A, {}), npm: (0, d.jsx)(i.A, {}), storybook: (0, d.jsx)(a.A, {}) },
    m = ({ brand: e }) => (0, d.jsx)(r.In, { children: c[e] || (0, d.jsx)(l.A, {}) });
  },
  33062(e, n, t) {
   t.d(n, { bo: () => s, KF: () => p, mJ: () => f, VZ: () => N, cR: () => A, Pv: () => h, qZ: () => i, kD: () => x, B2: () => u, Pc: () => l, f4: () => a, GT: () => k, fX: () => o, eQ: () => b, B_: () => j, o_: () => v, Rc: () => _ });
   ...
   const m = (e) => [...e].sort((e, n) => d.indexOf(e) - d.indexOf(n)),
    ...
    f = (e) => m(c(e.projects.flatMap((e) => g(e)))),
    h = (e) => {
     const n = g(e),
      t = ((e) => {
     ...
     return n.map((n) => {
      const r = e.tasks
       ...
       .map(({ name: r, id: s, value: o }) => {
        ...
        return { brand: i.toLowerCase(), name: r, id: s, value: o, description: a };
       });
            ...
            i.Zp,
            {
             ...
             children: (0, d.jsxs)(i.Wu, {
              children: [
               ...
               a.length > 0 && (0, d.jsx)(d.Fragment, { children: a.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.DZ, { level: n + 2, children: [s, ' in ', e] }), (0, d.jsx)(r.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  84118(e, n, t) {
   (t.r(n), t.d(n, { assets: () => c, component: () => g, contentTitle: () => d, default: () => v, description: () => p, frontMatter: () => l, issueNumber: () => u, metadata: () => r, title: () => m, toc: () => f }));
   ...
   const l = { title: 'Fieldset', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Fieldset', pagination_label: 'Fieldset', description: 'Groep van gerelateerde formuliervelden.', slug: '/fieldset', keywords: ['choicegroup', 'fieldset', 'field set', 'form', 'form block', 'form group', 'form fieldset', 'formulier', 'formfieldgroup', 'formulierelement', 'groupbox', 'input group', 'option group', 'selection group', 'wrapper'] },
    ...
    c = {},
    m = 'Fieldset',
    p = 'Groep van gerelateerde formuliervelden.',
    u = 124,
   ...
   function h(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, s.jsx)(a.Fc, { component: g, headingLevel: 1, description: p }), '\n', (0, s.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, s.jsx)(a.VK, { component: g, headingLevel: 3 }), '\n', (0, s.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, s.jsx)(a.mu, { component: g, headingLevel: 3 }), '\n', (0, s.jsx)(a.$9, { component: g, headingLevel: 2 })] });
   }
   function v(e = {}) {
