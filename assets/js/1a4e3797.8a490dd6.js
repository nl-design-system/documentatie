(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [62138],
 {
  ...
  34459: (e, t, r) => {
   ...
   (o.version = r(48558)), (o.AlgoliaSearchHelper = i), (o.SearchParameters = a), (o.RecommendParameters = n), (o.SearchResults = c), (o.RecommendResults = s), (e.exports = o);
  },
  38157: (e) => {
   'use strict';
   e.exports = function (e, t) {
  ...
  80184: (e, t, r) => {
   ...
   function _({ hosts: e, hostsCache: t, baseHeaders: r, logger: i, baseQueryParameters: n, algoliaAgent: s, timeouts: a, requester: c, requestsCache: o, responsesCache: u }) {
    ...
    return {
     ...
     request: function (e, t = {}) {
      const i = e.useReadTransporter || 'GET' === e.method;
      if (!i) return h(e, t, i);
      const s = () => h(e, t);
      if (!0 !== (t.cacheable || e.cacheable)) return s();
   ...
   var P = r(10517),
    ...
    D = r(39309),
    k = r(60054);
   const q = { searchQueryInput: 'searchQueryInput_Z9SV', searchVersionInput: 'searchVersionInput_WGNq', searchResultsColumn: 'searchResultsColumn_DpeQ', searchLogoColumn: 'searchLogoColumn_BU_O', searchResultItem: 'searchResultItem_vNwx', searchResultItemHeading: 'searchResultItemHeading_Mr_N', searchResultItemPath: 'searchResultItemPath_DqKk', searchResultItemSummary: 'searchResultItemSummary_foZv', searchQueryColumn: 'searchQueryColumn_NgON', searchVersionColumn: 'searchVersionColumn_iZ2m', loadingSpinner: 'loadingSpinner_AYhN', 'loading-spin': 'loading-spin_zUix', loader: 'loader_pv89' };
   var L = r(86070);
   function V({ docsSearchVersionsHelpers: e }) {
    const t = Object.entries(e.allDocsData).filter(([, e]) => e.versions.length > 1);
    return (0, L.jsx)('div', {
     className: (0, n.A)('col', 'col--3', 'padding-left--none', q.searchVersionColumn),
     children: t.map(([r, i]) => {
      const n = t.length > 1 ? `${r}: ` : '';
      return (0, L.jsx)('select', { onChange: (t) => e.setSearchVersion(r, t.target.value), defaultValue: e.searchVersions[r], className: q.searchVersionInput, children: i.versions.map((e, t) => (0, L.jsx)('option', { label: `${n}${e.label}`, value: e.name }, t)) }, r);
     }),
    });
   }
   function $() {
   ...
   function B() {
    const {
     ...
     [l, f] = (0, N.b)(),
     m = (function (e) {
      return e ? (0, Q.T)({ id: 'theme.SearchPage.existingResultsTitle', message: 'Search results for "{query}"', description: 'The search page title for non-empty query' }, { query: e }) : (0, Q.T)({ id: 'theme.SearchPage.emptyResultsTitle', message: 'Search the documentation', description: 'The search page title for empty query' });
     })(l),
