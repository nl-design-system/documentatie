 ...
 [66449],
 {
  ...
  3387(e, n, t) {
   ...
   const s = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    l = ({ name: e, relayStep: n, description: t }) => {
     const l = (0, o.fX)(n),
      d = s[e] ?? e;
     return (0, r.jsxs)(a.WK, { children: [(0, r.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, i.A)('ma-component-illustration', `ma-component-illustration--${l}`), fill: 'none', children: [(0, r.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, r.jsx)('rect', { width: '960', height: '540' }), (0, r.jsx)('rect', { width: '960', height: '540' })] }), (0, r.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, r.jsx)('use', { href: `/svg/componenten_overzicht_${(0, o.fX)(d)}.svg#component-illustration` })] }), (0, r.jsx)(a.$P, { className: 'ma-component-illustration__caption', children: t })] });
    };
  },
  3446(e, n, t) {
   t.d(n, { r: () => u });
  ...
  14881(e, n, t) {
   ...
   const l = (0, i.forwardRef)(({ as: e, className: n, children: t, ...i }, o) => {
     ...
     return (0, s.jsx)(r, { ref: o, className: l, ...i, children: t });
    }),
    d = ({ className: e, classNamePanel: n, label: t, heading: i, headingLevel: l, headingApperance: d, ...c }) => {
     ...
     return (0, s.jsxs)('details', { className: u, ...c, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(o.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [i && (0, s.jsx)(r.D, { level: l, appearance: d, children: i }), t] })] }) }), (0, s.jsx)('div', { className: g, children: c.children })] });
    };
  },
  19349(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => o });
  ...
  29857(e, n, t) {
   ...
   var a = t(37168),
    i = t(86070);
   const o = (e) => (0, i.jsx)(a.D, { ...e }),
    r = (e) => (0, i.jsx)(a.D, { ...e, level: 3 });
  },
  31686(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => o });
   var a = t(86070),
  ...
  36882(e, n, t) {
   (t.r(n), t.d(n, { assets: () => P, component: () => $, contentTitle: () => I, default: () => U, description: () => E, frontMatter: () => M, issueNumber: () => O, metadata: () => a, title: () => V, toc: () => Z }));
   ...
   const T = [
    ...
    _ = [
     ...
     { title: 'Accordions met dezelfde functie of informatie zien er op iedere pagina waar de accordion voorkomt hetzelfde uit', sc: '3.2.4', status: '', component: R.Ay },
    ],
    C = [
     {
    ...
    B = [
     ...
     { title: 'De accordion wordt niet bedekt door andere content', sc: '2.4.11', status: '', component: H.Ay },
    ],
    G = [
     {
  ...
  48262(e, n, t) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
     const t = e && e.projects.filter((e) => x.f4.includes(e.id)),
      i = t && x.f4.map((e) => t.find((n) => n.id === e)).filter(Boolean);
     return e && (0, g.jsx)(k.n, { children: i.map((t) => (0, g.jsx)(k.K, { className: (0, r.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, x.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(j._, { children: t.tasks.map(({ checked: e, name: t, id: a }) => (0, g.jsx)(j.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, x.qZ)(a) }, a)) }), (0, g.jsx)(a.fz, { children: (0, g.jsxs)(a.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
            ...
            ? (0, g.jsx)(
               d.Z,
               {
                ...
                description: (0, g.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, g.jsxs)(o.f, { children: [(0, g.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, g.jsxs)(a.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, g.jsxs)('div', {
                   children: [
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)('section', { children: [(0, g.jsxs)(i.DZ, { level: Math.min(n + 2, 6), children: [r, ' in ', e] }), (0, g.jsx)(a.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               l.Zp,
               {
                ...
                children: (0, g.jsxs)(l.Wu, {
                 children: [
                  ...
                  c.length > 0 && (0, g.jsx)(g.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, g.jsxs)(g.Fragment, { children: [(0, g.jsxs)(a.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, g.jsx)(a.dk, { links: t.map((e) => ({ children: e.description, icon: (0, g.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    D = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(a.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, g.jsxs)(a.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, g.jsxs)(a.Xy, { children: [i ? (0, g.jsxs)(a.Er, { children: ['Vul de ', (0, g.jsx)(a.N_, { href: i, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, g.jsxs)(a.Er, { children: [(0, g.jsxs)(a.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, g.jsxs)(a.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, g.jsx)(a.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, g.jsx)(a.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    A = ({ component: e, headingLevel: n, description: t }) => {
     const i = e && x.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(p.p, { level: n, suffix: i && (0, g.jsx)(h.D, { state: i }), children: e.title }), (0, g.jsx)(a.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(i) && (0, g.jsx)(f.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    z = ({ component: e }) => {
     const n = (e && b[e.title]) || [];
  ...
  84471(e, n, t) {
   t.d(n, { bo: () => i, KF: () => g, mJ: () => p, VZ: () => D, cR: () => w, Pv: () => j, qZ: () => r, kD: () => f, QQ: () => z, B2: () => m, Pc: () => l, f4: () => s, GT: () => v, fX: () => o, eQ: () => k, B_: () => b, o_: () => x });
