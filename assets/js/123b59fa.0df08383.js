 ...
 [90316],
 {
  50029: (e, n, i) => {
   ...
   function o(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Speelt er automatisch geluid af op de webpagina en duurt dit langer dan 3 seconden?\nZorg er dan voor dat de gebruiker het geluid kan stoppen, pauzeren of het volume kan regelen.' }), '\n', (0, r.jsx)(n.p, { children: 'Dit is belangrijk voor screenreadergebruikers, die afhankelijk zijn van geluid om de inhoud van de webpagina te lezen.' })] });
   }
   function a(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(o, { ...e }) }) : o(e);
   }
   const c = { title: 'WCAG-succescriterium 1.4.2 Geluidsbediening', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.2 Geluidsbediening', pagination_label: 'WCAG-succescriterium 1.4.2 Geluidsbediening', description: 'Speelt er automatisch geluid af op de webpagina en duurt dit langer dan 3 seconden? Zorg er dan voor dat de gebruiker het geluid kan stoppen, pauzeren of het volume kan regelen.', slug: '1.4.2', keywords: ['WCAG'] },
    u = void 0,
    g = { id: 'wcag/1.4.02', title: 'WCAG-succescriterium 1.4.2 Geluidsbediening', description: 'Speelt er automatisch geluid af op de webpagina en duurt dit langer dan 3 seconden? Zorg er dan voor dat de gebruiker het geluid kan stoppen, pauzeren of het volume kan regelen.', source: '@site/docs/wcag/1.4.02.mdx', sourceDirName: 'wcag', slug: '/wcag/1.4.2', permalink: '/wcag/1.4.2', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.02.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 1.4.2 Geluidsbediening', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.2 Geluidsbediening', pagination_label: 'WCAG-succescriterium 1.4.2 Geluidsbediening', description: 'Speelt er automatisch geluid af op de webpagina en duurt dit langer dan 3 seconden? Zorg er dan voor dat de gebruiker het geluid kan stoppen, pauzeren of het volume kan regelen.', slug: '1.4.2', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 1.4.1 Gebruik van kleur', permalink: '/wcag/1.4.1' }, next: { title: 'WCAG-succescriterium 1.4.3 Contrast (minimum)', permalink: '/wcag/1.4.3' } },
    h = {},
    p = [
  ...
  72657: (e, n, i) => {
   ...
   var s = i(52676);
   const l = (e) => {
    let { children: n, className: i, level: l = 1, suffix: d, ...o } = e;
    return (0, s.jsxs)('hgroup', { className: (0, r.Z)(t['nlds-inline-heading-group'], `utrecht-heading-${l}`, i), ...o, children: [(0, s.jsx)('h1', { className: (0, r.Z)(t['nlds-inline-heading-group__heading']), children: n }), d && (0, s.jsxs)('p', { className: (0, r.Z)(t['nlds-inline-heading-group__suffix']), children: [d ? ' ' : '', d] })] });
   };
  },
  71595: (e, n, i) => {
   i.d(n, { j: () => o });
   ...
   const o = (e) => {
    ...
    return (0, d.jsx)(t.V, { className: s, suffix: i && (0, d.jsx)(r.Ou, { className: l, children: i }), ...o, children: n });
   };
  },
  24785: (e, n, i) => {
   i.d(n, { Z: () => d, a: () => l });
