 ...
 [25425],
 {
  99766: (e, t, n) => {
   ...
   const s = { title: 'Form field description', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field description', pagination_label: 'Form field description', description: 'Toont ondersteunende tekst en biedt extra context over de in te vullen informatie.', slug: '/form-field-description' },
    a = void 0,
    l = { id: 'componenten/form-field-description/index', title: 'Form field description', description: 'Toont ondersteunende tekst en biedt extra context over de in te vullen informatie.', source: '@site/docs/componenten/form-field-description/index.mdx', sourceDirName: 'componenten/form-field-description', slug: '/form-field-description', permalink: '/form-field-description', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/form-field-description/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Form field description', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Form field description', pagination_label: 'Form field description', description: 'Toont ondersteunende tekst en biedt extra context over de in te vullen informatie.', slug: '/form-field-description' }, sidebar: 'componenten', previous: { title: 'Form field checkbox option', permalink: '/form-field-checkbox-option' }, next: { title: 'Form field error message', permalink: '/form-field-error-message' } },
    u = {},
    d = [
