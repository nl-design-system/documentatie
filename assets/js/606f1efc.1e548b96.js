 ...
 [82190],
 {
  ...
  98480: (e, n, l) => {
   ...
   const v = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (C = await c.ZP.format(Z, { parser: x, plugins: [s.Z, r.ZP, i.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), P(C);
     })();
    }, [Z]);
    const F = (0, d.useId)();
    let D = d.Fragment;
