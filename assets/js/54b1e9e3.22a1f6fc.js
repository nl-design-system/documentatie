 ...
 [6981],
 {
  ...
  39772: (e, n, i) => {
   ...
   function c(e) {
    ...
    return (0, l.jsxs)('div', { className: 'card', children: [n ? (0, l.jsx)(r.Z, { href: n, className: (0, s.Z)('cardLink', 'utrecht-link'), children: (0, l.jsxs)('h2', { className: 'cardTitle', children: [i, ' ', t] }) }) : (0, l.jsxs)('h2', { className: 'cardTitle', children: [i, ' ', t] }), o && (0, l.jsx)('p', { className: 'cardDescription', children: o }), c] });
   }
   function a(e) {
    let { item: n } = e;
