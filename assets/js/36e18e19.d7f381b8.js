 ...
 [64281],
 {
  83831: (e, n, t) => {
   ...
   const c = { title: 'WCAG-succescriterium 2.1.2 Geen toetsenbordval', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.1.2 Geen toetsenbordval', pagination_label: 'WCAG-succescriterium 2.1.2 Geen toetsenbordval', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', slug: '2.1.2', keywords: ['WCAG'] },
    u = void 0,
    g = { id: 'wcag/2.1.02', title: 'WCAG-succescriterium 2.1.2 Geen toetsenbordval', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', source: '@site/docs/wcag/2.1.02.mdx', sourceDirName: 'wcag', slug: '/wcag/2.1.2', permalink: '/wcag/2.1.2', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.1.02.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 2.1.2 Geen toetsenbordval', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.1.2 Geen toetsenbordval', pagination_label: 'WCAG-succescriterium 2.1.2 Geen toetsenbordval', description: 'Aan deze inhoud wordt gewerkt en bevat nu referenties en een korte samenvatting.', slug: '2.1.2', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 2.1.1 Toetsenbord', permalink: '/wcag/2.1.1' }, next: { title: 'WCAG-succescriterium 2.1.3 Toetsenbord (geen uitzondering)', permalink: '/wcag/2.1.3' } },
    h = {},
    p = [
