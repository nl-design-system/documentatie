/*! For license information please see 14f1aabd.2b828575.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [43975],
 {
  12484: (e, n, s) => {
   s.r(n), s.d(n, { assets: () => h, contentTitle: () => c, default: () => j, frontMatter: () => a, metadata: () => d, toc: () => m });
   var i = s(52676),
    t = s(40139),
    r = s(68257),
    l = s(78511),
    o = s(37943);
   const a = { title: 'Slack \xb7 Project', slug: '/slack/', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Slack', pagination_label: 'Slack', description: 'Wij hebben chatkanelen in Slack, lees hier hoe je mee kan doen.', keywords: ['chat', 'Code for NL', 'codefor.nl', 'global-design-system', 'huddle', 'nl design system', 'nl-design-system', 'nl-design-system-a11y', 'nl-design-system-content', 'nl-design-system-designers', 'nl-design-system-developers', 'rijkshuisstijl-community', 'Slack'] },
  ...
  68257: (e, n, s) => {
   ...
   const l = (e) => {
    ...
    return (0, r.jsx)(i.Z, { className: (0, t.W)('utrecht-button-link', `utrecht-button-link--${n}`), ...s });
   };
  },
  40139: (e, n, s) => {
   s.d(n, { Z: () => o, a: () => l });
  ...
  72315: (e, n, s) => {
   ...
   const r = (e, n, s, r) => {
    const l = (0, i.forwardRef)(({ color: s = 'currentColor', size: l = 24, stroke: o = 2, title: a, className: c, children: d, ...h }, m) => (0, i.createElement)('svg', { ref: m, ...t[e], width: l, height: l, className: ['tabler-icon', `tabler-icon-${n}`, c].join(' '), ...('filled' === e ? { fill: s } : { strokeWidth: o, stroke: s }), ...h }, [a && (0, i.createElement)('title', { key: 'svg-title' }, a), ...r.map(([e, n]) => (0, i.createElement)(e, n)), ...(Array.isArray(d) ? d : [d])]));
