 ...
 [31116],
 {
  1292(e, n, t) {
   ...
   var a = t(29181),
    ...
    r = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(s.A, {}), github: (0, d.jsx)(l.A, {}), npm: (0, d.jsx)(i.A, {}), storybook: (0, d.jsx)(o.A, {}) },
  ...
  12013(e, n, t) {
   ...
   const i = (e, n) => {
    ...
    r = (e) => ({ img: ({ src: n, ...t }) => (0, l.jsx)('img', { ...t, src: i(e, n), className: 'utrecht-img utrecht-img--fit' }) }),
    d = (e, n) => {
     if (e) {
      const e = { ...o[n - 1] };
      return ((e.h1 = () => null), e);
    ...
    c = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: s = '', components: i = {} }) => (0, l.jsx)(a.x, { components: { ...d(n, t), ...r(s), ...i }, children: e });
  },
  26095(e, n, t) {
   'use strict';
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => h, mJ: () => u, VZ: () => T, cR: () => _, Pv: () => g, qZ: () => i, kD: () => b, B2: () => v, Pc: () => r, f4: () => o, GT: () => x, fX: () => l, eQ: () => j, B_: () => f, o_: () => q, Rc: () => k });
    ...
    g = (e) => {
     ...
     return n.map((n) => {
      const a = e.tasks
       ...
       .map(({ name: a, id: s, value: l }) => {
        const i = /^(.+) URL/.exec(a)[1],
         o = 'Storybook' === i ? `${t} (${n}) in Storybook van ${e.title}` : `${t} (${n}) op ${i}`;
        return { brand: i.toLowerCase(), name: a, id: s, value: l, description: o };
       });
  ...
  72401(e, n, t) {
   ...
   const o = ({ component: e }) => {
    ...
    return (0, i.jsx)(s.Suspense, { fallback: null, children: (0, i.jsx)(a.o, { omitH1: !0, headingLevel: 1, children: (0, i.jsx)(r, {}) }) });
   };
  },
  72642(e, n, t) {
   'use strict';
   ...
   var a = t(13526),
    s = t(86070);
   const l = ({ children: e, className: n, level: t = 1, suffix: l, ...i }) => (0, s.jsxs)('hgroup', { className: (0, a.A)('nlds-inline-heading-group', `utrecht-heading-${t}`, n), ...i, children: [(0, s.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), l && (0, s.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [l ? ' ' : '', l] })] });
  },
  80506(e, n, t) {
   'use strict';
   t.d(n, { VK: () => u, $9: () => q, mu: () => g, Fc: () => f });
   var a = t(29181),
    s = t(13526),
    l = t(1292),
    i = t(90495),
   ...
   const u = ({ component: e, headingLevel: n }) => {
     const t = e && e.projects.filter((e) => p.f4.includes(e.id)),
      l = t && p.f4.map((e) => t.find((n) => n.id === e)).filter(Boolean);
            ...
            i.Zp,
            {
             ...
             children: (0, d.jsxs)(i.Wu, {
              children: [
               ...
               o.length > 0 && (0, d.jsx)(d.Fragment, { children: o.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(a.DZ, { level: n + 2, children: [s, ' in ', e] }), (0, d.jsx)(a.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(l.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  90495(e, n, t) {
   'use strict';
   t.d(n, { AC: () => d, Fu: () => i, Wu: () => o, Zp: () => r });
   var a = t(46447),
    s = t(13526),
    l = t(86070);
   const i = ({ background: e, children: n, className: t, ...a }) => (0, l.jsx)('div', { className: (0, s.A)('card__illustration', e && `card__illustration--${e}`, t), ...a, children: n }),
    o = (e) => (0, l.jsx)('div', { className: 'card__content', ...e }),
    r = ({ href: e, appearance: n, className: t, component: i = 'div', background: o, children: r }) => {
     const d = (e) => ('article' === i ? (0, l.jsx)('article', { ...e }) : 'section' === i ? (0, l.jsx)('section', { ...e }) : (0, l.jsx)('div', { ...e })),
      c = (0, l.jsx)(d, { className: (0, s.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: r });
