 ...
 [75221],
 {
  79489: (e, t, n) => {
   ...
   const s = { title: 'Unordered list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Unordered list', pagination_label: 'Unordered list', description: 'Toont een lijst met items waarvan de volgorde geen betekenis heeft.', slug: '/unordered-list', sidebar_custom_props: { illustration: 'UnorderedListSketch' } },
    a = void 0,
    l = { id: 'componenten/unordered-list/index', title: 'Unordered list', description: 'Toont een lijst met items waarvan de volgorde geen betekenis heeft.', source: '@site/docs/componenten/unordered-list/index.mdx', sourceDirName: 'componenten/unordered-list', slug: '/unordered-list', permalink: '/unordered-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/unordered-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Unordered list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Unordered list', pagination_label: 'Unordered list', description: 'Toont een lijst met items waarvan de volgorde geen betekenis heeft.', slug: '/unordered-list', sidebar_custom_props: { illustration: 'UnorderedListSketch' } }, sidebar: 'componenten', previous: { title: 'Toggletip', permalink: '/toggletip' }, next: { title: 'Video', permalink: '/video' } },
    u = {},
    d = [
