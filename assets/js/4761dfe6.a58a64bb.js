...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [26592],
 {
  ...
  18439(e, n, t) {
   ...
   function r(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(s) : e.components || s) : o(e.components)), l.createElement(a.Provider, { value: n }, e.children));
   }
  },
  49539(e, n, t) {
   t.d(n, { Ay: () => r, RM: () => a });
  ...
  70348(e, n, t) {
   ...
   const r = ({ className: e, ...n }) => {
    ...
    i = ({ className: e, classNamePanel: n, label: t, heading: r, headingLevel: i, headingApperance: c, ...d }) => {
     const h = (0, l.A)('utrecht-accordion__section', e),
      k = (0, l.A)('utrecht-accordion__panel', n);
     return (0, o.jsxs)('details', { className: h, ...d, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(s.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [r && (0, o.jsx)(a.D, { level: i, appearance: c, children: r }), t] })] }) }), (0, o.jsx)('div', { className: k, children: d.children })] });
    };
  },
  80731(e, n, t) {
   t.d(n, { H: () => v });
   ...
   const v = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       ...
       return (0, j.jsxs)('div', { className: (0, a.A)('ma-canvas-astro', t), children: [(0, j.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: s } }), (0, j.jsx)(u.n, { children: (0, j.jsx)(u.K, { label: 'Code', children: (0, j.jsx)('pre', { className: 'language-html nl-code-block', children: (0, j.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: o } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: p = !0, children: m, container: u = 'document', language: v, designTokens: y }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(w, { parser: v, plugins: [o.A, r.Ay, i.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [w]);
       const S = (0, h.useId)();
       let T = h.Fragment;
       return (
        'paragraph' === u ? (T = g) : 'document' === u ? (T = b) : 'surface' === u && (T = x),
        (0, j.jsxs)('div', {
