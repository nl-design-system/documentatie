...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  13705(e, n, t) {
   (t.r(n), t.d(n, { assets: () => j, contentTitle: () => p, default: () => v, frontMatter: () => g, metadata: () => i, toc: () => m }));
   const i = JSON.parse('{"id":"wcag/3.2.01","title":"WCAG-succescriterium 3.2.1 Bij focus","description":"Maak functionaliteit voorspelbaar en daardoor goed te begrijpen. Als een gebruiker een component focus geeft met het toetsenbord of door erop te klikken met de muis, zorg dan dat die actie niet automatisch een contextwijziging veroorzaakt.","source":"@site/docs/wcag/3.2.01.mdx","sourceDirName":"wcag","slug":"/wcag/3.2.1","permalink":"/wcag/3.2.1","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.2.01.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 3.2.1 Bij focus","title_sm":"3.2.1 Bij focus","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"3.2.1 Bij focus","pagination_label":"WCAG-succescriterium 3.2.1 Bij focus","description":"Maak functionaliteit voorspelbaar en daardoor goed te begrijpen. Als een gebruiker een component focus geeft met het toetsenbord of door erop te klikken met de muis, zorg dan dat die actie niet automatisch een contextwijziging veroorzaakt.","slug":"3.2.1","conformance_level":"Niveau A","keywords":["WCAG","A","begrijpelijk","voorspelbaar","understandable","predictable","on focus"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 3.1.6 Uitspraak","permalink":"/wcag/3.1.6"},"next":{"title":"WCAG-succescriterium 3.2.2 Bij input","permalink":"/wcag/3.2.2"}}');
   var r = t(86070),
    o = t(18439),
    s = t(24703),
    a = t(61473),
    ...
    h = t(66117),
    u = t(59602);
   const g = { title: 'WCAG-succescriterium 3.2.1 Bij focus', title_sm: '3.2.1 Bij focus', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.2.1 Bij focus', pagination_label: 'WCAG-succescriterium 3.2.1 Bij focus', description: 'Maak functionaliteit voorspelbaar en daardoor goed te begrijpen. Als een gebruiker een component focus geeft met het toetsenbord of door erop te klikken met de muis, zorg dan dat die actie niet automatisch een contextwijziging veroorzaakt.', slug: '3.2.1', conformance_level: 'Niveau A', keywords: ['WCAG', 'A', 'begrijpelijk', 'voorspelbaar', 'understandable', 'predictable', 'on focus'] },
    p = void 0,
    j = {},
  ...
  24703(e, n, t) {
   ...
   const s = (e, n) => {
    ...
    d = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: r = '', components: s = {} }) => (0, o.jsx)(i.x, { components: { ...c(n, t), ...l(r), ...s }, children: e });
  },
  25431(e, n, t) {
   t.d(n, { Ay: () => a, RM: () => o });
   var i = t(86070),
  ...
  61473(e, n, t) {
   ...
   var i = t(46447),
    r = t(46276),
    o = t(86070);
   const s = ({ children: e, conformanceLevel: n, ...t }) => (globalThis.isAstro ? null : (0, o.jsx)(r.p, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: n && (0, o.jsx)(i.KE, { className: 'nlds-inline-heading-group__badge', children: n }), ...t, children: e }));
  },
  66117(e, n, t) {
   t.d(n, { Ay: () => a, RM: () => o });
   var i = t(86070),
  ...
  66119(e, n, t) {
   ...
   function r(e) {
    ...
    if ('string' == typeof e || 'number' == typeof e) i += e;
     ...
     if (Array.isArray(e)) {
      var o = e.length;
      for (n = 0; n < o; n++) e[n] && (t = r(e[n])) && (i && (i += ' '), (i += t));
     } else for (t in e) e[t] && (i && (i += ' '), (i += t));
    return i;
   }
   function o() {
    for (var e, n, t = 0, i = '', o = arguments.length; t < o; t++) (e = arguments[t]) && (n = r(e)) && (i && (i += ' '), (i += n));
    return i;
   }
   const s = (0, t(30758).forwardRef)(({ aside: e, children: n, className: t, purpose: r, ...s }, a) => {
    const l = { ...s, ref: a, className: o('utrecht-note', { [`utrecht-note--${r}`]: r }, t) };
    return e ? (0, i.jsx)('aside', { ...l, children: n }) : (0, i.jsx)('section', { role: 'note', ...l, children: n });
   });
   s.displayName = 'Note';
   var a = t(29181);
   const l = globalThis.isAstro ? s : a.K7;
  },
 },
]);
