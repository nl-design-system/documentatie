(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [66492],
 {
  ...
  64276(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => p, componentName: () => g, contentTitle: () => h, default: () => k, description: () => j, frontMatter: () => u, issueNumber: () => y, metadata: () => r, relayStep: () => m, title: () => d, toc: () => f }));
   ...
   var i = n(86070),
    ...
    o = n(85825),
    a = n(44594);
   const u = { title: 'Radio Group', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Radio Group', pagination_label: 'Radio Group', description: 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren uit een lijst.', slug: '/radio-group', keywords: ['fieldset', 'form', 'formulierveld', 'keuze', 'keuzerondje', 'optie', 'opties', 'option', 'option button', 'radio', 'radio button', 'radio group', 'radioknop', 'radios'] },
    h = void 0,
    l = {},
    d = 'Radio Group',
    j = 'Biedt de mogelijkheid om \xe9\xe9n optie te selecteren uit een lijst.',
    y = 129,
    m = 'help wanted',
    g = 'radio-group',
  ...
  85825(e, t, n) {
   ...
   const f = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: s.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(g, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
