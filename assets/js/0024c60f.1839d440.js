/*! For license information please see 0024c60f.1839d440.js.LICENSE.txt */
 ...
 [72837],
 {
  ...
  55240: (e, n, t) => {
   ...
   const d = (e) => {
     ...
     const a = l.get(t),
      d = a ? `${t} ${a.nl?.title}` : t;
     return (0, c.jsxs)('div', { className: 'component-criteria-section', children: [(0, c.jsx)(r.X6, { appearance: 'utrecht-heading-4', level: i, className: 'component-criteria-section__heading', children: n }), (t || o) && (0, c.jsxs)('dl', { className: 'component-criteria-section__dl', children: [t && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)('dt', { className: 'component-criteria-section__dt', children: 'WCAG' }), (0, c.jsx)('dd', { className: 'component-criteria-section__dd', children: (0, c.jsx)(r.rU, { href: `/wcag/${t}`, children: d }) })] }), o && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)('dt', { className: 'component-criteria-section__dt', children: 'Status' }), (0, c.jsx)('dd', { className: 'component-criteria-section__dl', children: o })] })] }), s] });
    },
    h = (e) => {
  ...
  8657: (e, n, t) => {
   ...
   const x = (e) => {
    ...
    T = (e) => {
     ...
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(y.V, { level: t, suffix: s && (0, d.jsx)(j.y, { state: s }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: o })] });
    };
  },
  49556: (e, n, t) => {
   'use strict';
  ...
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, $e: () => j, BA: () => l, Ee: () => d, Q6: () => s, U: () => m, Yr: () => y, d: () => h, e9: () => i, fO: () => w, mA: () => o, ps: () => p, qU: () => f, s0: () => v, zP: () => g });
