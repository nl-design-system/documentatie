    ...
    return (
     ...
     (0, i.jsxs)(i.Fragment, {
      children: [
       ...
       M && !e.playlist && (0, i.jsx)('noscript', { children: (0, i.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${p} on YouTube`, children: ['Watch "', p, '" on YouTube'] }) }),
       (0, i.jsxs)(O, {
        onPointerOver: () => {
         t || l(!0);
        },
        ...
        style: { ...(!e.lazyLoad && { backgroundImage: `url(${k})` }), '--aspect-ratio': (R / L) * 100 + '%', ...(e.style || {}) },
        children: [e.lazyLoad && !s && (0, i.jsx)('img', { src: k, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !s && (0, i.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && s) && (0, i.jsx)('button', { type: 'button', className: E, 'aria-label': `${m} ${p}`, 'aria-hidden': s || void 0, tabIndex: s ? -1 : 0, onClick: N, children: (0, i.jsx)('span', { className: 'lty-visually-hidden', children: m }) }), s && (0, i.jsx)('iframe', { ref: n, className: z, title: p, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: y, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
