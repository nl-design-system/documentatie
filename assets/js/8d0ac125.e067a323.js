/*! For license information please see 8d0ac125.e067a323.js.LICENSE.txt */
'use strict';
 ...
 [4861],
 {
  ...
  33550(e, n, a) {
   ...
   const o = { title: 'File', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'File', pagination_label: 'File', description: 'Toont meta-informatie over een bestand en biedt \xe9\xe9n of meer acties, zoals bekijken, downloaden of verwijderen.', issue_number: 348, slug: '/file', keywords: ['file', 'bestand', 'files', 'bestanden', 'attachment', 'bijlage', 'attachments', 'bijlagen', 'file upload', 'file uploader', 'upload', 'uploaden', 'file input', 'file download', 'download', 'downloadable', 'downloaden', 'bestandsgrootte', 'file list', 'bestandslijst', 'document', 'document list', 'metadata'] },
    ...
    g = {},
    c = 'File',
    u = 'Toont meta-informatie over een bestand en biedt \xe9\xe9n of meer acties, zoals bekijken, downloaden of verwijderen.',
    m = 348,
    h = 'help wanted',
    p = 'file',
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => N, cR: () => w, Pv: () => f, qZ: () => l, kD: () => j, QQ: () => D, B2: () => m, Pc: () => o, f4: () => s, GT: () => k, fX: () => i, eQ: () => v, B_: () => x, o_: () => b });
