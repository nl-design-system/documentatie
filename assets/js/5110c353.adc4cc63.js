(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [40284],
 {
  ...
  25677: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => P, component: () => V, contentTitle: () => L, default: () => E, description: () => M, frontMatter: () => N, issueNumber: () => B, metadata: () => S, title: () => Z, toc: () => F });
   var r = n(52676),
    i = n(24785),
    o = n(14147),
    s = n(34434),
   ...
   const N = { title: 'Button', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Button', pagination_label: 'Button', description: 'Biedt de mogelijkheid om een actie uit te voeren.', slug: '/button', keywords: ['actie', 'action', 'action button', 'activate', 'aria-expanded', 'aria-haspopup', 'aria-pressed', 'bezig', 'busy', 'button', 'buttons', 'call to action', 'click', 'cta', 'disabled', 'icon button', 'indrukken', 'klikken', 'knop', 'knoppen', 'press', 'pressed', 'send', 'submit', 'toggle', 'toggle button', 'uitgeschakeld', 'versturen', 'verzenden'] },
    ...
    Z = 'Button',
    M = 'Biedt de mogelijkheid om een actie uit te voeren.',
    B = 38,
    V = o.find((e) => e.number === B);
   function H(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(a.Rv, { component: V, headingLevel: 1, description: M }),
      '\n',
      ...
      (0, r.jsx)(s.t, {
       ...
       items: [
        { title: 'Het label van de button bestaat uit gewone tekst, niet uit een afbeelding van tekst', sc: '1.4.5', status: '', component: (0, r.jsx)(p.ZP, {}) },
        { title: 'Het label van de button maakt kort en bondig duidelijk waar de button voor dient', sc: '2.4.6', status: '', component: (0, r.jsx)(y, {}) },
        { title: 'De zichtbare naam van de button is gelijk aan de toegankelijke naam', sc: '2.5.3', status: '', component: (0, r.jsx)(G, {}) },
        { title: 'De button heeft een minimale grootte van 44 bij 44 pixels', sc: '2.5.5', status: '', component: (0, r.jsx)(z.ZP, {}) },
        { title: 'Als een buttontekst in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode', sc: '3.1.2', status: '', component: (0, r.jsx)(_.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(s.t, {
       ...
       items: [
        { title: 'De contrastverhouding van de tekstkleur in de button met de achtergrondkleur is hoog genoeg.', sc: '1.4.3', status: '', component: (0, r.jsx)(m.ZP, {}) },
        { title: 'Als het zichtbare label van de button een afbeelding of icoon is, dan is het contrast tussen de afbeelding en de achtergrond minimaal 3:1.', sc: '1.4.11', status: '', component: (0, r.jsx)(h, {}) },
        { title: 'Wanneer een button de toetsenbordfocus krijgt is de focus zichtbaar', sc: '2.4.7', status: '', component: (0, r.jsx)(A.ZP, {}) },
        { title: 'De button heeft een goed zichtbare focusindicator', sc: '2.4.13', status: '', component: (0, r.jsx)(k.ZP, {}) },
        { title: 'Buttons met gelijke functies hebben hetzelfde uiterlijk en hetzelfde label', sc: '3.2.4', status: '', component: (0, r.jsx)(W.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(s.t, {
      ...
      (0, r.jsx)(s.t, {
       ...
       items: [
        { title: 'Je kunt de button focussen met de tabtoets en activeren met de spacebar en de entertoets', sc: '2.1.1', status: '', component: (0, r.jsx)(f, {}) },
        { title: 'De functionaliteit van de button veroorzaakt geen toetsenbordval', sc: '2.1.2', status: '', component: (0, r.jsx)(b.ZP, {}) },
        { title: 'Als de gebruiker een button indrukt met een aanwijzer zoals een muis of vinger, is er de mogelijkheid is om actie te voorkomen of ongedaan te maken', sc: '2.5.2', status: '', component: (0, r.jsx)(C.ZP, {}) },
        { title: 'Als de Button de toetsenbordfocus krijgt, is het element niet volledig bedekt door andere inhoud', sc: '2.4.11', status: '', component: (0, r.jsx)(v.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(s.t, {
       ...
       items: [
        { title: 'Als het label van een button uit een icoon bestaat, dan heeft deze een goed tekstalternatief', sc: '1.1.1', status: '', component: (0, r.jsx)(d, {}) },
        { title: 'De button heeft een rol van button en een toegankelijke naam die duidelijk maakt waar de button voor dient', sc: '4.1.2', status: '', component: (0, r.jsx)(D, {}) },
       ],
      }),
      '\n',
  ...
  23952: (e, t, n) => {
   ...
   const k = 'task-list_hh8j',
    ...
    G = (e) => {
     ...
     return (0, d.jsxs)('li', { className: (0, i.Z)(x), children: [(0, d.jsxs)('div', { className: (0, i.Z)(y, t && A), children: [(0, d.jsx)('span', { className: C, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, d.jsx)(v.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(b.X6, { appearance: 'utrecht-heading-3', level: s, children: r }), o, n] })] });
    };
   var z = n(14669);
   const _ = (e) => {
     let { component: t, headingLevel: n } = e;
     const o = t && t.projects.filter((e) => z.e9.includes(e.id)),
      s = o && z.e9.map((e) => o.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, d.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, d.jsx)(T, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(G, { checked: t, title: n, description: (0, z.Q6)(r) }, r);
            }),
           }),
