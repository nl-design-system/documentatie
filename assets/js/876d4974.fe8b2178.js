 ...
 [76950],
 {
  1292(e, n, t) {
   ...
   var i = t(29181),
    ...
    l = t(83386),
    c = t(86070);
   const d = { figma: (0, c.jsx)(a.A, {}), github: (0, c.jsx)(o.A, {}), npm: (0, c.jsx)(s.A, {}), storybook: (0, c.jsx)(r.A, {}) },
    m = ({ brand: e }) => (0, c.jsx)(i.In, { children: d[e] || (0, c.jsx)(l.A, {}) });
  },
  33062(e, n, t) {
   t.d(n, { bo: () => a, KF: () => h, mJ: () => u, VZ: () => A, cR: () => w, Pv: () => f, qZ: () => s, kD: () => b, B2: () => g, Pc: () => l, f4: () => r, GT: () => k, fX: () => o, eQ: () => x, B_: () => v, o_: () => j, Rc: () => _ });
  ...
  44594(e, n, t) {
   ...
   const r = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    l = ({ name: e, relayStep: n, description: t }) => {
     const l = (0, o.fX)(n),
      c = r[e] ?? e;
     return (0, s.jsxs)(i.WK, { children: [(0, s.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, a.A)('component-illustration', `component-illustration--${l}`), fill: 'none', children: [(0, s.jsxs)('g', { fill: 'var(--component-illustration-background-color, white)', children: [(0, s.jsx)('rect', { width: '960', height: '540' }), (0, s.jsx)('rect', { width: '960', height: '540' })] }), (0, s.jsxs)('g', { fill: 'var(--component-illustration-grid-color, #eee)', children: [(0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, s.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, s.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, s.jsx)('use', { href: `/svg/componenten_overzicht_${(0, o.fX)(c)}.svg#component-illustration` })] }), (0, s.jsx)(i.$P, { className: 'component-illustration__caption', children: t })] });
    };
  },
  51762(e, n, t) {
            ...
            s.Zp,
            {
             ...
             children: (0, c.jsxs)(s.Wu, {
              children: [
               ...
               (m.length > 0 || r.length > 0) && (0, c.jsx)(i.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               m.length > 0 &&
                (0, c.jsx)(c.Fragment, {
               ...
               r.length > 0 && (0, c.jsx)(c.Fragment, { children: r.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(i.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, c.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
   ...
   const s = ({ background: e, children: n, className: t, ...i }) => (0, o.jsx)('div', { className: (0, a.A)('card__illustration', e && `card__illustration--${e}`, t), ...i, children: n }),
    ...
    l = ({ href: e, appearance: n, className: t, component: s = 'div', background: r, children: l }) => {
     const c = (e) => ('article' === s ? (0, o.jsx)('article', { ...e }) : 'section' === s ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(c, { className: (0, a.A)('cardgroup__card', r && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: l });
