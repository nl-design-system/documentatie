    ...
    return (
     ...
     (0, s.jsx)(i.y$, {
      ...
      children: (e) => {
       ...
       return (0, s.jsx)(r.dn, { tabIndex: 0, style: l, children: i.map((e, l) => (0, s.jsxs)('span', { ...t({ line: e }), children: [n && (0, s.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...o({ token: e }) }, n)), '\n'] }, l)) });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const d = (e) => {
    ...
    const h = 'Doen',
     ...
     v = u ? 'figure' : 'div',
     m = u ? 'figcaption' : 'div';
    return (0, a.jsxs)(v, { className: (0, s.Z)(o['nlds-guideline'], o[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, a.jsxs)(m, { className: (0, s.Z)(o['nlds-guideline__description']), children: ['dont' === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, s.Z)(o['nlds-guideline__badge'], o[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(r.Z, { 'aria-hidden': 'true', role: 'presentation', className: o['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: o['nlds-guideline__title'], children: p })] }), (0, a.jsx)(t.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(t.nv, { className: (0, s.Z)(o['nlds-guideline__badge'], o[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(i.Z, { 'aria-hidden': 'true', role: 'presentation', className: o['nlds-guideline__icon'] }), (0, a.jsx)('span', { className: o['nlds-guideline__title'], children: h })] }), (0, a.jsx)(t.nv, { children: n })] }), d] }), (0, a.jsx)('div', { className: (0, s.Z)(o['nlds-guideline__example']), children: c })] });
   };
  },
  57716: (e, n, l) => {
   l.d(n, { U: () => c });
