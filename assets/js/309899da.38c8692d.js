...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [25326],
 {
  ...
  58874(e, n, i) {
   (i.r(n), i.d(n, { assets: () => v, contentTitle: () => m, default: () => k, frontMatter: () => j, metadata: () => t, toc: () => f }));
   const t = JSON.parse('{"id":"wcag/1.4.08","title":"WCAG-succescriterium 1.4.8 Visuele presentatie","description":"Een gebruiker moet de visuele weergave van tekstblokken zelf kunnen aanpassen om deze beter te kunnen lezen.","source":"@site/docs/wcag/1.4.08.mdx","sourceDirName":"wcag","slug":"/wcag/1.4.8","permalink":"/wcag/1.4.8","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/1.4.08.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 1.4.8 Visuele presentatie","title_sm":"1.4.8 Visuele presentatie","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"1.4.8 Visuele presentatie","pagination_label":"WCAG-succescriterium 1.4.8 Visuele presentatie","description":"Een gebruiker moet de visuele weergave van tekstblokken zelf kunnen aanpassen om deze beter te kunnen lezen.","slug":"1.4.8","conformance_level":"Niveau AAA","keywords":["WCAG","AAA","waarneembaar","onderscheidbaar","perceivable","distinguishable","visual presentation"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 1.4.7 Weinig of geen achtergrondgeluid","permalink":"/wcag/1.4.7"},"next":{"title":"WCAG-succescriterium 1.4.9 Afbeeldingen van tekst (geen uitzondering)","permalink":"/wcag/1.4.9"}}');
   var r = i(86070),
    s = i(18439),
    l = i(24703),
    a = i(61473),
   ...
   function g(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Sommige gebruikers maken teksten die meerdere zinnen lang zijn beter leesbaar voor zichzelf. Dit kan door het zelf aanpassen van de computer- of browserinstellingen of met eigen hulpsoftware.' }), '\n', (0, r.jsx)(n.p, { children: 'Zoals het aanpassen van:' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsx)(n.li, { children: 'de kleur van de tekst en de achtergrondkleur;' }), '\n', (0, r.jsx)(n.li, { children: 'de breedte van de tekst;' }), '\n', (0, r.jsx)(n.li, { children: 'de uitlijning van de tekst;' }), '\n', (0, r.jsx)(n.li, { children: 'de regelafstand;' }), '\n', (0, r.jsx)(n.li, { children: 'de mogelijkheid alleen tekst te vergroten.' }), '\n'] }), '\n', (0, r.jsx)(n.p, { children: 'Hiervoor hoeven er geen opties of buttons op de website zelf beschikbaar te zijn, maar het ontwerp en de HTML/CSS mogen de aanpassingen door een gebruiker niet blokkeren.' })] });
   }
   function p(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
    return n ? (0, r.jsx)(n, { ...e, children: (0, r.jsx)(g, { ...e }) }) : g(e);
   }
   const j = { title: 'WCAG-succescriterium 1.4.8 Visuele presentatie', title_sm: '1.4.8 Visuele presentatie', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.4.8 Visuele presentatie', pagination_label: 'WCAG-succescriterium 1.4.8 Visuele presentatie', description: 'Een gebruiker moet de visuele weergave van tekstblokken zelf kunnen aanpassen om deze beter te kunnen lezen.', slug: '1.4.8', conformance_level: 'Niveau AAA', keywords: ['WCAG', 'AAA', 'waarneembaar', 'onderscheidbaar', 'perceivable', 'distinguishable', 'visual presentation'] },
    m = void 0,
    v = {},
    f = [...h.RM, { value: 'Uitleg', id: 'uitleg', level: 2 }, { value: 'Opgelet', id: 'opgelet', level: 2 }, { value: 'Gebruikersonderzoek', id: 'gebruikersonderzoek', level: 2 }, ...c.RM, { value: 'W3C referenties', id: 'w3c-referenties', level: 2 }, ...d.RM, { value: 'Help richtlijn verbeteren', id: 'help-richtlijn-verbeteren', level: 2 }, ...u.RM];
   function x(e) {
    const n = { a: 'a', h2: 'h2', li: 'li', p: 'p', ul: 'ul', ...(0, s.R)(), ...e.components };
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', (0, r.jsx)(a.E, { level: 1, conformanceLevel: 'Niveau AAA', children: 'WCAG-succescriterium 1.4.8 Visuele presentatie' }), '\n', (0, r.jsx)(o.K, { children: (0, r.jsx)(l.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(h.Ay, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, r.jsx)(p, {}), '\n', (0, r.jsx)(n.h2, { id: 'opgelet', children: 'Opgelet' }), '\n', (0, r.jsx)(n.p, { children: 'Deze inhoud wordt binnenkort aangevuld met uitgebreidere uitleg, bronnen en informatie over hoe te testen.' }), '\n', (0, r.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, r.jsx)(c.Ay, {}), '\n', (0, r.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#visual-presentation', children: (0, r.jsx)('span', { lang: 'en', children: '1.4.8 Visual Presentation' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#visual-presentation', children: '1.4.8 Visuele presentatie' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, r.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#visual-presentation', children: (0, r.jsx)('span', { lang: 'en', children: 'Quick Reference 1.4.8 Visual Presentation' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/visual-presentation.html', children: (0, r.jsx)('span', { lang: 'en', children: 'Understanding SC 1.4.8 Visual Presentation' }) }), '.'] }), '\n'] }), '\n', (0, r.jsx)(o.K, { children: (0, r.jsx)(l.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(d.Ay, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, r.jsx)(l.o, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(u.Ay, {}) })] });
   }
   function k(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
  ...
  66119(e, n, i) {
   ...
   const l = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: r, ...l }, a) => {
    const o = { ...l, ref: a, className: s('utrecht-note', { [`utrecht-note--${r}`]: r }, i) };
