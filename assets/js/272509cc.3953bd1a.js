 ...
 [12370],
 {
  3227(e, n, i) {
   ...
   function c({ href: e, icon: n = '', title: i, description: t, children: s }) {
    return (0, a.jsxs)('div', { className: 'card', children: [e ? (0, a.jsx)(r.N, { href: e, className: (0, o.A)('cardLink', 'utrecht-link'), children: (0, a.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', i] }) }) : (0, a.jsxs)('h2', { className: 'cardTitle', children: [n, ' ', i] }), t && (0, a.jsx)('p', { className: 'cardDescription', children: t }), s] });
   }
   function d({ item: e }) {
    return (0, a.jsx)(c, { title: e.label, description: e.description, children: (0, a.jsx)(l.Xy, { children: e.items.filter((e) => 'link' === e.type || 'category' === e.type).map((e, n) => (0, a.jsx)(l.Er, { children: 'link' === e.type ? (0, a.jsx)(r.N, { to: e.href, children: e.label }) : 'category' === e.type ? (0, a.jsxs)(r.N, { to: e.href, children: [e.items.length, " pagina's voor ", e.label] }) : (0, a.jsx)(a.Fragment, {}) }, n)) }) });
   }
   function h({ item: e }) {
   ...
   function p(e) {
    ...
    const r = (0, t.d1)(n);
    return (0, a.jsx)('section', { className: (0, o.A)('row', i), ...e, children: r.map((e, n) => (0, a.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, a.jsx)(u, { item: e }) }, n)) });
   }
  },
  18439(e, n, i) {
   i.d(n, { R: () => l, x: () => o });
  ...
  45282(e, n, i) {
   ...
   const s = ({ children: e, ...n }) => {
     ...
     return ('https://nldesignsystem.nl' === o.origin ? ((o.pathname = o.pathname.endsWith('/') ? o.pathname : `${o.pathname}/`), (l = o.toString().replace('https://nldesignsystem.nl', ''))) : ((s.target = '_blank'), (s.rel = 'noopener noreferrer')), (0, r.jsx)('a', { href: l, ...s, children: e }));
    },
    l = ({ className: e, ...n }) => (0, r.jsx)(s, { className: (0, t.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  58773(e, n, i) {
   (i.r(n), i.d(n, { assets: () => d, contentTitle: () => c, default: () => m, frontMatter: () => a, metadata: () => t, toc: () => h }));
  ...
  89874(e, n, i) {
   ...
   const o = (e, n) => e.reduce((e, i) => ('link' === i.type ? (n.includes(i.docId) ? e : [...e, i]) : 'category' === i.type ? [...e, { ...i, items: o(i.items, n) }] : e), []),
    a = ({ excludeDocIDs: e = [], className: n, ...i }) => {
     const a = (0, t.$S)();
     return (0, l.jsx)('div', { ...i, className: (0, r.A)('margin-top--lg', n), children: (0, l.jsx)(s.A, { items: o(a.items, e) }) });
    };
  },
 },
]);
