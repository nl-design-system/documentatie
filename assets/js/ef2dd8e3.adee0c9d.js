 ...
 [95356],
 {
  14881(e, n, t) {
   ...
   var a = t(13526),
    ...
    s = t(37168),
    r = t(86070);
   const o = (0, l.forwardRef)(({ as: e, className: n, children: t, ...l }, i) => {
     const s = e || 'div',
      o = (0, a.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, r.jsx)(s, { ref: i, className: o, ...l, children: t });
    }),
    d = ({ className: e, classNamePanel: n, label: t, heading: l, headingLevel: o, headingApperance: d, ...c }) => {
     const h = (0, a.A)('utrecht-accordion__section', e),
      g = (0, a.A)('utrecht-accordion__panel', n);
     return (0, r.jsxs)('details', { className: h, ...c, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(i.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [l && (0, r.jsx)(s.D, { level: o, appearance: d, children: l }), t] })] }) }), (0, r.jsx)('div', { className: g, children: c.children })] });
    };
  },
  18439(e, n, t) {
   t.d(n, { R: () => s, x: () => r });
  ...
  38953(e, n, t) {
   ...
   var a = t(28369),
    ...
    p = t(46847),
    m = t(86070);
   const j = ({ children: e }) => (0, m.jsx)(l.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(l.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, m.jsx)(l.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   j.displayName = 'ParagraphContainer';
   const k = ({ children: e }) => (0, m.jsx)(l.ui, { className: 'nlds-canvas__example-surface', children: (0, m.jsx)(l.yo, { className: (0, i.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   k.displayName = 'DocumentContainer';
   const f = ({ children: e }) => (0, m.jsx)(l.ui, { className: 'nlds-canvas__example-surface', children: e });
   f.displayName = 'SurfaceContainer';
   const y = globalThis.isAstro
    ? ({ language: e, className: n, code: t = '<p>No code provided</p>', rawCode: a, copyCode: l, defaultExpandedCode: s, designTokens: r }) => {
       const o = 'string' == typeof t ? t : a || '',
        d = 'string' == typeof t ? u().highlight(t, u().languages[e], e) : u().highlight(a || '', u().languages[e], e);
       return (0, m.jsxs)('div', { className: (0, i.A)('ma-canvas-astro', n), children: [(0, m.jsx)('div', { className: 'voorbeeld-theme utrecht-root', style: r, children: (0, m.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }) }), (0, m.jsx)(b.n, { children: (0, m.jsxs)(b.K, { label: 'Code', open: s, children: [(0, m.jsx)('pre', { className: 'language-html nl-code-block', tabIndex: 0, children: (0, m.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: d } }) }), 'allow' === l && (0, m.jsx)(p.$, { 'data-copy-code': o, purpose: 'secondary', children: 'Kopieer code' })] }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: v = !0, children: u, container: b = 'document', language: p, designTokens: y }) => {
       const x = 'function' == typeof u ? u() : u,
        _ = 'function' == typeof e ? e() : (0, h.isValidElement)(e) ? e : void 0,
        N = 'string' == typeof e ? e : g.qV(_ || x),
        [z, w] = (0, h.useState)(N),
        [A, C] = (0, h.useState)(t);
       (0, h.useEffect)(() => {
        (async () => {
         const e = await c.Ay.format(N, { parser: p, plugins: [s.A, r.Ay, o.Ay, d.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         w(e);
        })();
       }, [N]);
       const S = (0, h.useId)();
       let D = h.Fragment;
       return (
        'paragraph' === b ? (D = j) : 'document' === b ? (D = k) : 'surface' === b && (D = f),
        (0, m.jsxs)('div', {
         className: (0, i.A)('nlds-canvas'),
         children: [
          x && (0, m.jsx)('div', { className: (0, i.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, m.jsx)(D, { children: (0, m.jsx)(l.v$, { children: x }) }) }) }),
          v &&
           (0, m.jsx)('div', {
          ...
          v &&
           (0, m.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, m.jsx)(a.M, { codeBlockLabel: 'Codevoorbeeld', syntax: p, textContent: z, trim: !0 }),
             n &&
              (0, m.jsx)('div', {
  ...
  40620(e, n, t) {
   (t.r(n), t.d(n, { assets: () => h, contentTitle: () => c, default: () => u, frontMatter: () => d, metadata: () => a, toc: () => g }));
