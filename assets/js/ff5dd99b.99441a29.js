 ...
 [10452],
 {
  ...
  17889(e, n, t) {
   ...
   const A = { color: u.A, dimension: j.A, fontFamilies: k.A, fontSizes: x.A, fontWeights: v.A, lineHeights: f.A, other: b.A, textDecoration: y.A },
    S = ({ type: e }) => (0, p.jsx)(m.In, { children: (0, w.createElement)(A[e]) });
   function D({ tokens: e }) {
    const n = (0, a.kD)(e),
     t = (0, a.GT)(n),
       ...
       children: [
        ...
        (0, p.jsx)(i.BF, {
         children: t.map((n) => {
          const t = (0, a.o_)(n),
           o = (0, a.eQ)(e, n).$type;
          return (0, p.jsxs)(i.Hj, { children: [(0, p.jsx)(i.nA, { children: (0, p.jsx)(r.C, { children: (0, p.jsx)(i.kf, { children: t }) }) }), (0, p.jsx)(i.nA, { children: (0, p.jsxs)(s.K, { children: [(0, p.jsx)(S, { type: o }), ' ', o] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, p.jsxs)(i.e2, { children: [(0, p.jsx)(g, { content: l, language: 'json', children: 'Kopieer als JSON' }), (0, p.jsx)(g, { content: o, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => m, mJ: () => u, VZ: () => A, cR: () => w, Pv: () => j, qZ: () => i, kD: () => f, B2: () => p, Pc: () => l, f4: () => o, GT: () => b, fX: () => a, eQ: () => v, B_: () => x, o_: () => k, Rc: () => y });
  ...
  45041(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => M, component: () => F, contentTitle: () => z, default: () => O, description: () => L, frontMatter: () => T, issueNumber: () => R, metadata: () => r, title: () => C, toc: () => V }));
