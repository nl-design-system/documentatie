 ...
 [25974],
 {
  14881(e, n, l) {
   ...
   var o = l(13526),
    ...
    t = l(37168),
    i = l(86070);
   const a = (0, r.forwardRef)(({ as: e, className: n, children: l, ...r }, s) => {
     const t = e || 'div',
      a = (0, o.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, i.jsx)(t, { ref: s, className: a, ...r, children: l });
    }),
  ...
  38953(e, n, l) {
   ...
   var o = l(28369),
    ...
    j = l(46847),
    v = l(86070);
   const x = ({ children: e }) => (0, v.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, v.jsx)(r.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, v.jsx)(r.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   x.displayName = 'ParagraphContainer';
   const y = ({ children: e }) => (0, v.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: (0, v.jsx)(r.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   y.displayName = 'DocumentContainer';
   const f = ({ children: e }) => (0, v.jsx)(r.ui, { className: 'nlds-canvas__example-surface', children: e });
   f.displayName = 'SurfaceContainer';
   const b = globalThis.isAstro
    ? ({ language: e, className: n, code: l = '<p>No code provided</p>', rawCode: o, copyCode: r, defaultExpandedCode: t, designTokens: i }) => {
    ...
    : ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: m = !0, children: h, container: g = 'document', language: j, designTokens: b }) => {
       ...
       (0, u.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: j, plugins: [t.A, i.Ay, a.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [N]);
       const S = (0, u.useId)();
       ...
       return (
        ...
        (0, v.jsxs)('div', {
         ...
         children: [
          k && (0, v.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: b, children: (0, v.jsx)(D, { children: (0, v.jsx)(r.v$, { children: k }) }) }) }),
          m &&
           (0, v.jsx)('div', {
   ...
   const d = (0, a.createContext)({}),
    u = ({ title: e, appearance: n, description: l, children: a, figure: u }) => {
     const p = { do: 'Doen', dont: 'Niet doen' },
      m = u ? 'figure' : 'div',
      h = u ? 'figcaption' : 'div',
      g = 'string' == typeof l ? (0, c.jsx)(i.oz, { components: { a: s.N_ }, children: l }) : l;
