     ...
     return (
      ...
      (0, s.jsxs)(s.Fragment, {
       children: [
        ...
        W && !e.playlist && (0, s.jsx)('noscript', { children: (0, s.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${g} on YouTube`, children: ['Watch "', g, '" on YouTube'] }) }),
        (0, s.jsxs)(E, {
         onPointerOver: () => {
          t || r(!0);
         },
         ...
         children: [e.lazyLoad && !l && (0, s.jsx)('img', { src: S, alt: `${g} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !l && (0, s.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && l) && (0, s.jsx)('button', { type: 'button', className: C, 'aria-label': `${h} ${g}`, 'aria-hidden': l || void 0, tabIndex: l ? -1 : 0, onClick: _, children: (0, s.jsx)('span', { className: 'lty-visually-hidden', children: h }) }), l && (0, s.jsx)('iframe', { ref: n, className: N, title: g, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
