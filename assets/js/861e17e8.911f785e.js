 ...
 [43396],
 {
  90613: (e, t, n) => {
   ...
   const o = { title: 'Description list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Description list', pagination_label: 'Description list', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', slug: '/description-list' },
    a = void 0,
    l = { id: 'componenten/definition-list/index', title: 'Description list', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', source: '@site/docs/componenten/definition-list/index.mdx', sourceDirName: 'componenten/definition-list', slug: '/description-list', permalink: '/description-list', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/definition-list/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Description list', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Description list', pagination_label: 'Description list', description: 'Toont een lijst aan termen en hun beschrijving, bijvoorbeeld een woordenlijst.', slug: '/description-list' }, sidebar: 'componenten', previous: { title: 'Date picker', permalink: '/date-picker' }, next: { title: 'Dot badge', permalink: '/dot-badge' } },
    u = {},
    d = [
