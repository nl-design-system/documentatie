   ...
   const r = ({ background: e, children: t, className: n, ...a }) => (0, o.jsx)('div', { className: (0, i.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, n), ...a, children: t }),
    ...
    s = ({ href: e, appearance: t, className: n, component: r = 'div', background: l, children: s }) => {
     const c = (e) => ('article' === r ? (0, o.jsx)('article', { ...e }) : 'section' === r ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(c, { className: (0, i.A)('ma-cardgroup__card', l && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${t}`, n), children: s });
     return e ? (0, o.jsx)(a.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: d }) : d;
    },
    c = ({ appearance: e = 'medium', children: t, className: n }) => (0, o.jsx)('div', { className: (0, i.A)('ma-cardgroup', `ma-cardgroup--${e}`, n), children: t });
  },
  33500(e, t, n) {
   ...
   const l = i.forwardRef(function (e, t) {
     const [n, l] = i.useState(!1),
      ...
      v = f
       ...
       : null,
      w = i.useMemo(() => e.thumbnail || v || `https://i.ytimg.com/${x}/${e.playlist ? p : d}/${u}.${j}`, [e.thumbnail, v, x, e.playlist, p, d, u, j]),
     ...
     return (
      ...
      }, [s, e.enableJsApi, e.onReady, e.onStateChange, e.onError, e.onPlay, e.onPause, e.onEnd, e.onBuffering, e.onPlaybackRateChange, e.onPlaybackQualityChange, e.stopOnEnd, e.id, d, m, t]),
      (0, a.jsxs)(a.Fragment, {
       children: [
        ...
        e.seo && !e.playlist && (0, a.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: r(e.id, m, w, y, e.seo) } }),
        R && !e.playlist && (0, a.jsx)('noscript', { children: (0, a.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${m} on YouTube`, children: ['Watch "', m, '" on YouTube'] }) }),
        (0, a.jsxs)(L, {
         onPointerOver: () => {
          n || l(!0);
         },
