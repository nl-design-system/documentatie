 ...
 [53087],
 {
  ...
  17889(e, n, t) {
   ...
   function H({ tokens: e }) {
    const n = (0, s.kD)(e),
     t = (0, s.GT)(n),
     l = t.map((e) => (0, s.B_)(e) + ': ;').join('\n'),
     o = JSON.stringify((0, s.Rc)(t));
       ...
       children: [
        ...
        (0, h.jsx)(r.BF, {
         children: t.map((n) => {
          const t = (0, s.o_)(n),
           l = (0, s.eQ)(e, n).$type;
          return (0, h.jsxs)(r.Hj, { children: [(0, h.jsx)(r.nA, { children: (0, h.jsx)(a.C, { children: (0, h.jsx)(r.kf, { children: t }) }) }), (0, h.jsx)(r.nA, { children: (0, h.jsxs)(i.K, { children: [(0, h.jsx)(S, { type: l }), ' ', l] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => u, mJ: () => p, VZ: () => D, cR: () => w, Pv: () => j, qZ: () => r, kD: () => b, B2: () => h, Pc: () => o, f4: () => l, GT: () => f, fX: () => s, eQ: () => v, B_: () => k, o_: () => x, Rc: () => y });
  ...
  80545(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => C, component: () => G, contentTitle: () => L, default: () => P, description: () => _, frontMatter: () => T, issueNumber: () => z, metadata: () => a, title: () => R, toc: () => B }));
   ...
   const r = ({ background: e, children: n, className: t, ...a }) => (0, s.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, t), ...a, children: n }),
    ...
    o = ({ href: e, appearance: n, className: t, component: r = 'div', background: l, children: o }) => {
     const d = (e) => ('article' === r ? (0, s.jsx)('article', { ...e }) : 'section' === r ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      c = (0, s.jsx)(d, { className: (0, i.A)('cardgroup__card', l && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: o });
