 ...
 [7177],
 {
  1292(e, t, n) {
   ...
   var r = n(29181),
    ...
    a = n(83386),
    u = n(86070);
   const l = { figma: (0, u.jsx)(c.A, {}), github: (0, u.jsx)(s.A, {}), npm: (0, u.jsx)(i.A, {}), storybook: (0, u.jsx)(o.A, {}) },
  ...
  12483(e, t, n) {
   ...
   var c = n(86070),
    ...
    i = n(36059),
    o = n(85825);
   const a = { title: 'Tabs', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Tabs', pagination_label: 'Tabs', description: 'Paneel om onderwerpen te groeperen, waarbij er maar \xe9\xe9n per keer zichtbaar is, met buttons om te kiezen welk onderwerp wordt weergegeven.', slug: '/tabs', keywords: ['content tabs', 'navigation', 'navigation tabs', 'nav tabs', 'panel', 'pivot', 'scoped tabs', 'switch', 'tab', 'tabs', 'tab bar', 'tab control', 'tab group', 'tab menu', 'tab nav', 'tab panel', 'tabbed interface', 'tabbed view'] },
    u = void 0,
    l = {},
    h = 'Tabs',
    d = 'Paneel om onderwerpen te groeperen, waarbij er maar \xe9\xe9n per keer zichtbaar is, met buttons om te kiezen welk onderwerp wordt weergegeven.',
    j = 51,
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => c, KF: () => d, mJ: () => m, VZ: () => _, cR: () => x, Pv: () => p, qZ: () => i, kD: () => k, B2: () => j, Pc: () => a, f4: () => o, GT: () => f, fX: () => s, eQ: () => v, B_: () => b, o_: () => g, Rc: () => w });
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map(({ name: r, id: c, value: s }) => {
        ...
        return { brand: i.toLowerCase(), name: r, id: c, value: s, description: o };
       });
  ...
  67970(e, t, n) {
   ...
   const o = ({ state: e }) => {
    const t = (0, s.fX)(e);
    return (0, i.jsx)(r.KE, { className: (0, c.A)('estafette-badge', t && `estafette-badge--${t}`), children: e });
   };
  },
  72642(e, t, n) {
   'use strict';
   ...
   var r = n(13526),
    c = n(86070);
   const s = ({ children: e, className: t, level: n = 1, suffix: s, ...i }) => (0, c.jsxs)('hgroup', { className: (0, r.A)('nlds-inline-heading-group', `utrecht-heading-${n}`, t), ...i, children: [(0, c.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), s && (0, c.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
  },
  85825(e, t, n) {
   'use strict';
   ...
   const b = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: s.map((n) => ({ className: (0, c.A)('definition-of-done', n && `definition-of-done--${(0, g.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(p, { headingLevel: t + 1, checked: e, title: n, description: (0, g.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            i.Zp,
            {
             ...
             children: (0, u.jsxs)(i.Wu, {
              children: [
               ...
               o.length > 0 && (0, u.jsx)(u.Fragment, { children: o.map(({ frameworkName: e, tasks: n }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: t + 2, children: [c, ' in ', e] }), (0, u.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, u.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  90495(e, t, n) {
   'use strict';
   n.d(t, { AC: () => u, Fu: () => i, Wu: () => o, Zp: () => a });
   var r = n(46447),
    c = n(13526),
    s = n(86070);
   const i = ({ background: e, children: t, className: n, ...r }) => (0, s.jsx)('div', { className: (0, c.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    o = (e) => (0, s.jsx)('div', { className: 'card__content', ...e }),
    a = ({ href: e, appearance: t, className: n, component: i = 'div', background: o, children: a }) => {
     const u = (e) => ('article' === i ? (0, s.jsx)('article', { ...e }) : 'section' === i ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      l = (0, s.jsx)(u, { className: (0, c.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, s.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    u = ({ appearance: e = 'medium', children: t, className: n }) => (0, s.jsx)('div', { className: (0, c.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
 },
]);
