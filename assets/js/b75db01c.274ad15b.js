 ...
 [91279],
 {
  1292(e, t, n) {
   ...
   var r = n(14537),
    ...
    a = n(83386),
    l = n(86070);
   const u = { figma: (0, l.jsx)(i.A, {}), github: (0, l.jsx)(o.A, {}), npm: (0, l.jsx)(c.A, {}), storybook: (0, l.jsx)(s.A, {}) },
    d = ({ brand: e }) => (0, l.jsx)(r.In, { children: u[e] || (0, l.jsx)(a.A, {}) });
  },
  4398(e, t, n) {
   'use strict';
   n.d(t, { B2: () => h, B_: () => p, GT: () => b, KF: () => d, Pc: () => s, Pv: () => g, Rc: () => f, bo: () => r, eQ: () => v, f4: () => c, fX: () => i, kD: () => k, mJ: () => y, o_: () => m, qZ: () => o });
  ...
  41912(e, t, n) {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => y, contentTitle: () => l, default: () => p, description: () => h, frontMatter: () => a, issueNumber: () => j, metadata: () => r, title: () => d, toc: () => g });
   ...
   const a = { title: 'Modal Dialog', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Modal Dialog', pagination_label: 'Modal Dialog', description: 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina wordt geblokkeerd.', slug: '/modal-dialog', keywords: ['dialog', 'dialoogvenster', 'floating window', 'modaal venster', 'modale dialoog', 'modale popup', 'modale venster', 'modal', 'modal dialog', 'modal popup', 'modal window', 'overlay', 'popup', 'popup dialog', 'popup window', 'venster', 'window'] },
    ...
    u = {},
    d = 'Modal Dialog',
    h = 'Toont een venster over de pagina om de aandacht op een enkele taak of bericht te vestigen. Interactie met onderliggende pagina wordt geblokkeerd.',
    j = 66,
   ...
   const c = ({ background: e, children: t, className: n, ...r }) => (0, o.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    a = ({ href: e, appearance: t, className: n, component: c = 'div', background: s, children: a }) => {
     const l = (e) => ('article' === c ? (0, o.jsx)('article', { ...e }) : 'section' === c ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      u = (0, o.jsx)(l, { className: (0, i.A)('cardgroup__card', s && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: a });
     return e ? (0, o.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: u }) : u;
    },
    l = ({ appearance: e = 'medium', children: t, className: n }) => (0, o.jsx)('div', { className: (0, i.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
  99630(e, t, n) {
   'use strict';
   ...
   const y = ({ children: e }) => (0, a.jsx)('ul', { className: 'task-list', children: e }),
    g = ({ checked: e, children: t, title: n, description: r, headingLevel: o = 3 }) => (0, a.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, a.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, a.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, a.jsx)(j.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, a.jsxs)('div', { children: [n ? (0, a.jsx)(h.DZ, { appearance: 'utrecht-heading-3', level: o, children: n }) : null, r, t] })] });
   var m = n(4398);
   const p = ({ component: e, headingLevel: t }) => {
         ...
         children: n
          ...
          .map((e) => {
           const n = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            d = e.tasks.filter(({ name: e, value: t }) => u.has(e) && URL.canParse(t) && 'https:' === new URL(t).protocol);
           return (0, a.jsx)(
            c.Zp,
            {
             ...
             children: (0, a.jsxs)(c.Wu, {
              children: [
               ...
               (d.length > 0 || s.length > 0) && (0, a.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               d.length > 0 &&
                (0, a.jsx)(a.Fragment, {
    ...
    b = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(d.p, { level: t, suffix: i && (0, a.jsx)(u.D, { state: i }), children: e.title }), (0, a.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
 },
]);
