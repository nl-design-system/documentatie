...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  5626: (e, n, l) => {
   l.r(n), l.d(n, { assets: () => u, contentTitle: () => d, default: () => g, frontMatter: () => a, metadata: () => c, toc: () => h });
   var o = l(1527),
    t = l(7214),
    i = l(3460),
    s = l(36),
  ...
  3460: (e, n, l) => {
   ...
   const b = (e) => {
    ...
    p = (e) => {
     ...
     (0, c.useEffect)(() => {
      (async () => {
       (f = await d.ZP.format(x, { parser: v, plugins: [i.Z, s.ZP, r.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), w(f);
      })();
     }, [x]);
     const Z = (0, h.Z)();
     return (0, k.jsxs)("div", {
      ...
      children: [
       _ && (0, k.jsx)("div", { className: (0, t.Z)(m["nlds-canvas__example"]), children: (0, k.jsx)(o.pu, { className: "voorbeeld-theme", children: _ }) }),
       (0, k.jsx)("div", { className: (0, t.Z)(m["nlds-canvas__toolbar"]), children: (0, k.jsx)(o.zx, { className: (0, t.Z)(m["nlds-canvas__button"], m["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: b, "aria-expanded": !p, "aria-controls": Z, children: p ? "Bekijk code" : "Verberg code" }) }),
       (0, k.jsxs)("div", {
        className: (0, t.Z)(m["nlds-canvas__code-block"], !l && m["nlds-canvas__code-block--user-select-none"]),
        id: Z,
        hidden: p,
        children: [
         (0, k.jsx)(g.u, { syntax: v, textContent: f, trim: !0 }),
         l &&
          (0, k.jsx)("div", {
           className: (0, t.Z)(m["nlds-canvas__toolbar"]),
           children: (0, k.jsx)(o.zx, {
