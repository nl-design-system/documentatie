/*! For license information please see 0024c60f.757c667c.js.LICENSE.txt */
 ...
 [73512],
 {
  ...
  17889(e, n, t) {
   ...
   var u = t(35193),
    ...
    y = t(79532),
    w = t(30758);
   const S = { color: u.A, dimension: v.A, fontFamilies: j.A, fontSizes: f.A, fontWeights: k.A, lineHeights: x.A, other: b.A, textDecoration: y.A },
    A = ({ type: e }) => (0, m.jsx)(p.In, { children: (0, w.createElement)(S[e]) });
   function D({ tokens: e }) {
    const n = (0, i.kD)(e),
     t = (0, i.GT)(n),
       ...
       children: [
        ...
        (0, m.jsx)(l.BF, {
         children: t.map((n) => {
          const t = (0, i.o_)(n),
           s = (0, i.eQ)(e, n).$type;
          return (0, m.jsxs)(l.Hj, { children: [(0, m.jsx)(l.nA, { children: (0, m.jsx)(r.C, { children: (0, m.jsx)(l.kf, { children: t }) }) }), (0, m.jsx)(l.nA, { children: (0, m.jsxs)(o.K, { children: [(0, m.jsx)(A, { type: s }), ' ', s] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => o, KF: () => p, mJ: () => u, VZ: () => S, cR: () => w, Pv: () => v, qZ: () => l, kD: () => x, B2: () => m, Pc: () => a, f4: () => s, GT: () => b, fX: () => i, eQ: () => k, B_: () => f, o_: () => j, Rc: () => y });
  ...
  63683(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => V, component: () => U, contentTitle: () => E, default: () => W, description: () => G, frontMatter: () => B, issueNumber: () => Z, metadata: () => r, title: () => $, toc: () => X }));
    ...
    return (
     ...
     (0, o.jsxs)(o.Fragment, {
      children: [
       ...
       '\n',
       '\n',
       (0, o.jsx)(O.Fc, { component: U, headingLevel: 1, description: G }),
       '\n',
       (0, o.jsx)(_.e, { component: U }),
       '\n',
       ...
       '\n',
       (0, o.jsx)(L.o, { omitH1: !0, headingLevel: 2, children: (0, o.jsx)(P, {}) }),
       '\n',
       (0, o.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }),
       '\n',
       (0, o.jsx)(R.B, { tokens: H }),
       '\n',
       (0, o.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
       '\n',
       (0, o.jsx)(O.VK, { component: U, headingLevel: 3 }),
       '\n',
       (0, o.jsx)(O.$9, { component: U, headingLevel: 2 }),
       '\n',
       (0, o.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
       '\n',
       (0, o.jsx)(O.mu, { component: U, headingLevel: 3 }),
      ],
     })
    );
   }
