(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [31116],
 {
  10645(e, n, a) {
   ...
   var t = a(13526),
    l = a(86070);
   const s = ({ children: e, className: n, level: a = 1, suffix: s, ...i }) => (0, l.jsxs)('hgroup', { className: (0, t.A)('nlds-inline-heading-group', `utrecht-heading-${a}`, n), ...i, children: [(0, l.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), s && (0, l.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
  },
  21034(e, n, a) {
   'use strict';
   a.d(n, { VK: () => j, $9: () => D, mu: () => k, Fc: () => T, K_: () => H });
   var t = a(29181),
    l = a(85068),
    s = a(59292),
    i = a(13526),
   ...
   const j = ({ component: e, headingLevel: n }) => {
     const a = e && e.projects.filter((e) => f.f4.includes(e.id)),
      l = a && f.f4.map((e) => a.find((n) => n.id === e)).filter(Boolean);
     return e && (0, m.jsx)(b.n, { children: l.map((a) => (0, m.jsx)(b.K, { className: (0, i.A)('ma-definition-of-done', a && `ma-definition-of-done--${(0, f.fX)(a.title)}`), heading: a ? `${a.title} - ${a.progress.value} van ${a.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(v._, { children: a.tasks.map(({ checked: e, name: a, id: t }) => (0, m.jsx)(v.Z, { headingLevel: n + 1, checked: e, heading: a, description: (0, f.qZ)(t) }, t)) }), (0, m.jsx)(t.fz, { children: (0, m.jsxs)(t.N_, { href: `${a.url}?filterQuery=${e.title}`, children: [a.title, ' projectbord op GitHub'] }) })] }) }, a.title)) });
    },
    k = ({ component: e, headingLevel: n }) => {
     ...
     return e && a.length
           ...
           return globalThis.isAstro
            ? (0, m.jsx)(
               d.Z,
               {
                ...
                headingLevel: n,
                description: (0, m.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, m.jsxs)(s.f, { children: [(0, m.jsx)(c, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, m.jsxs)(t.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, m.jsxs)('div', {
                   children: [
                    (h.length > 0 || g.length > 0) && (0, m.jsx)(l.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    h.length > 0 &&
                     (0, m.jsx)(t.dk, {
                      links: h
                       ...
                       .map((e) => {
                        ...
                        return { children: n.desciption, icon: (0, m.jsx)(r.r, { brand: n.brand }), href: e.value };
                       }),
                     }),
                   ],
                  }),
                  g.length > 0 && g.map(({ frameworkName: e, tasks: a }) => (0, m.jsxs)('section', { children: [(0, m.jsxs)(l.DZ, { level: Math.min(n + 2, 6), children: [i, ' in ', e] }), (0, m.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, m.jsx)(r.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
            ...
            : (0, m.jsx)(
               o.Zp,
               {
                ...
                children: (0, m.jsxs)(o.Wu, {
                 children: [
                  (0, m.jsx)(t.DZ, { level: n, children: e.title.replace(/^Community/i, '') }),
                  (0, m.jsxs)(t.fz, { children: [(0, m.jsx)(c, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, m.jsxs)(t.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (h.length > 0 || g.length > 0) && (0, m.jsx)(t.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  h.length > 0 &&
                   (0, m.jsx)(m.Fragment, {
                    children: (0, m.jsx)(t.dk, {
                     links: h
                      .filter((e) => !!u.get(e.name))
                      .map((e) => {
                       const n = u.get(e.name);
                  ...
                  g.length > 0 && (0, m.jsx)(m.Fragment, { children: g.map(({ frameworkName: e, tasks: a }) => (0, m.jsxs)(m.Fragment, { children: [(0, m.jsxs)(t.DZ, { level: n + 2, children: [i, ' in ', e] }), (0, m.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, m.jsx)(r.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
      ...
      : (0, m.jsx)(t.fz, { children: 'Er zijn nog geen implementaties' });
    },
    D = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(t.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, m.jsxs)(t.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, m.jsxs)(t.Xy, { children: [l ? (0, m.jsxs)(t.Er, { children: ['Vul de ', (0, m.jsx)(t.N_, { href: l, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, m.jsxs)(t.Er, { children: [(0, m.jsxs)(t.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, m.jsxs)(t.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, m.jsx)(t.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, m.jsx)(t.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    T = ({ component: e, headingLevel: n, description: a }) => {
     const l = e && f.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(p.p, { level: n, suffix: l && (0, m.jsx)(h.D, { state: l }), children: e.title }), (0, m.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(l) && (0, m.jsx)(q.s, { relayStep: l, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    H = ({ component: e }) => {
     const n = (e && x[e.title]) || [];
     return n.length > 0 && (0, m.jsxs)(t.fz, { children: ['Gerelateerde componenten:', ' ', n.map((e, a) => (0, m.jsxs)(m.Fragment, { children: [e.slug ? (0, m.jsx)(t.N_, { href: `/${e.slug}/`, children: e.name }) : e.name, a < n.length - 1 ? ', ' : '.'] }))] });
    };
  },
  21530(e, n, a) {
   'use strict';
   a.d(n, { AC: () => d, Fu: () => i, Wu: () => r, Zp: () => o });
   var t = a(46447),
    l = a(13526),
    s = a(86070);
   const i = ({ background: e, children: n, className: a, ...t }) => (0, s.jsx)('div', { className: (0, l.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, a), ...t, children: n }),
    r = (e) => (0, s.jsx)('div', { className: 'ma-card__content', ...e }),
    o = ({ href: e, appearance: n, className: a, component: i = 'div', background: r, children: o }) => {
     const d = (e) => ('article' === i ? (0, s.jsx)('article', { ...e }) : 'section' === i ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      g = (0, s.jsx)(d, { className: (0, l.A)('ma-cardgroup__card', r && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, a), children: o });
     return e ? (0, s.jsx)(t.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: g }) : g;
    },
    d = ({ appearance: e = 'large', children: n, className: a }) => (0, s.jsx)('div', { className: (0, l.A)('ma-cardgroup', `ma-cardgroup--${e}`, a), children: n });
  },
  32385(e, n, a) {
   'use strict';
   a.d(n, { bo: () => l, KF: () => m, mJ: () => p, VZ: () => D, cR: () => k, Pv: () => v, qZ: () => i, kD: () => q, QQ: () => H, B2: () => c, Pc: () => o, f4: () => r, GT: () => j, fX: () => s, eQ: () => b, B_: () => x, o_: () => f });
    ...
    v = (e) => {
     ...
     return n.map((n) => {
      const t = e.tasks
       ...
       .map(({ name: t, id: l, value: s }) => {
        const i = /^(.+) URL/.exec(t)[1],
         r = 'Storybook' === i ? `${a} (${n}) in Storybook van ${e.title}` : `${a} (${n}) op ${i}`;
        return { brand: i.toLowerCase(), name: t, id: l, value: s, description: r };
       });
   ...
   function q(e, n = []) {
    return Object.hasOwn(e, '$type') ? [n] : Object.keys(e).flatMap((a) => ('object' == typeof e[a] && null !== e[a] ? q(e[a], [...n, a]) : []));
   }
   function j(e) {
    const n = new Map();
    function a(e) {
  ...
  39569(e, n, a) {
   ...
   const r = ({ state: e }) => {
    const n = (0, s.fX)(e);
    return (0, i.jsx)(t.KE, { className: (0, l.A)('ma-estafette-badge', n && `ma-estafette-badge--${n}`), children: e });
   };
  },
  40889(e, n, a) {
   'use strict';
   ...
   var t = a(29181),
    ...
    o = a(83386),
    d = a(86070);
   const g = { figma: (0, d.jsx)(l.A, {}), github: (0, d.jsx)(s.A, {}), npm: (0, d.jsx)(i.A, {}), storybook: (0, d.jsx)(r.A, {}) },
  ...
  51582(e, n, a) {
   ...
   const i = (e, n) => {
    ...
    g = ({ children: e, omitH1: n = !1, headingLevel: a = 1, baseUrl: l = '', components: i = {} }) => (0, s.jsx)(t.x, { components: { ...d(n, a), ...o(l), ...i }, children: e });
  },
  59292(e, n, a) {
   'use strict';
   a.d(n, { f: () => t.f });
  ...
  59778(e, n, a) {
   ...
   const r = ({ component: e }) => {
    ...
    const { title: n } = e,
     r = (0, s.fX)(n),
     o = l.lazy(() => a(82839)(`./${r}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
    return (0, i.jsx)(l.Suspense, { fallback: null, children: (0, i.jsx)(t.o, { omitH1: !0, headingLevel: 1, children: (0, i.jsx)(o, {}) }) });
   };
  },
  70348(e, n, a) {
   'use strict';
  ...
  81462(e, n, a) {
   ...
   function F(e) {
    ...
    return (
     ...
     (0, u.jsxs)(u.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, u.jsx)(x.Fc, { component: H, headingLevel: 1, description: D }), '\n', (0, u.jsx)(f.e, { component: H }), '\n', (0, u.jsx)(n.h2, { id: 'anatomie', children: 'Anatomie' }), '\n', (0, u.jsx)(a, { component: H, illustration: v }), '\n', (0, u.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, u.jsx)(x.VK, { component: H, headingLevel: 3 }), '\n', (0, u.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, u.jsx)(x.mu, { component: H, headingLevel: 3 }), '\n', (0, u.jsx)(x.K_, { component: H }), '\n', (0, u.jsx)(x.$9, { component: H, headingLevel: 2 })] })
    );
   }
   function _(e = {}) {
    const { wrapper: n } = { ...(0, m.R)(), ...e.components };
    return n ? (0, u.jsx)(n, { ...e, children: (0, u.jsx)(F, { ...e }) }) : F(e);
   }
  },
  82839(e, n, a) {
  ...
  85068(e, n, a) {
   ...
   var t = a(14277),
    l = a(86070);
   const s = (e) => (0, l.jsx)(t.D, { ...e }),
    i = (e) => (0, l.jsx)(t.D, { ...e, level: 3 });
  },
  85162(e, n, a) {
   'use strict';
   a.d(n, { s: () => o });
   ...
   const r = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    o = ({ name: e, relayStep: n, description: a }) => {
     const o = (0, s.fX)(n),
      d = r[e] ?? e;
     return (0, i.jsxs)(t.WK, { children: [(0, i.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, l.A)('ma-component-illustration', `ma-component-illustration--${o}`), fill: 'none', children: [(0, i.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, i.jsx)('rect', { width: '960', height: '540' }), (0, i.jsx)('rect', { width: '960', height: '540' })] }), (0, i.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, i.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, i.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, i.jsx)('use', { href: `/svg/componenten_overzicht_${(0, s.fX)(d)}.svg#component-illustration` })] }), (0, i.jsx)(t.$P, { className: 'ma-component-illustration__caption', children: a })] });
    };
  },
  88166(e, n, a) {
   'use strict';
