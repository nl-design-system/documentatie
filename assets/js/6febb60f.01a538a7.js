...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  56546: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => p, contentTitle: () => j, default: () => f, frontMatter: () => g, metadata: () => m, toc: () => k });
   var r = i(52676),
    t = i(87118),
    s = i(57716),
    l = i(46364),
   ...
   const g = { title: 'WCAG-succescriterium 1.3.1 Info en relaties', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '1.3.1 Info en relaties', pagination_label: 'WCAG-succescriterium 1.3.1 Info en relaties', description: 'Alle gebruikers moeten over dezelfde informatie kunnen beschikken.', slug: '1.3.1', keywords: ['WCAG'] },
    j = void 0,
