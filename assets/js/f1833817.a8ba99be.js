(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [43166],
 {
  ...
  94443: (e, n, t) => {
   ...
   const y = (e) => {
    ...
    k = (e) => {
     ...
     return (0, d.jsxs)('li', { className: (0, i.Z)('task-list-item'), children: [(0, d.jsxs)('div', { className: (0, i.Z)('task-list-item__marker', n && 'task-list-item__marker--checked'), children: [(0, d.jsx)('span', { className: 'task-list-item__marker-label', children: n ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), n && (0, d.jsx)(b.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(p.X6, { appearance: 'utrecht-heading-3', level: s, children: r }), a, t] })] });
    };
   var v = t(14669);
   const x = (e) => {
     let { component: n, headingLevel: t } = e;
     const a = n && n.projects.filter((e) => v.e9.includes(e.id)),
      s = a && v.e9.map((e) => a.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, d.jsx)(y, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(k, { headingLevel: t + 1, checked: n, title: r, description: (0, v.Q6)(i) }, i);
            }),
           }),
               ...
               a.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: a.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: t + 2, children: [i, ' in ', n] }), (0, d.jsx)(r.Mc, { children: a.map((e) => (0, d.jsxs)(r.k7, { href: e.value, children: [(0, d.jsx)(u, { brand: e.brand }), ' ', e.description] }, e.id)) })] });
                 }),
                }),
              ],
             }),
    ...
    z = (e) => {
     ...
     const a = n && v.$3[n.relayStep];
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(g.V, { level: t, suffix: a && (0, d.jsx)(m.y, { state: a }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, n, t) => {
   'use strict';
  ...
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, BA: () => o, Q6: () => a, U: () => l, e9: () => s, mA: () => i, ps: () => d });
