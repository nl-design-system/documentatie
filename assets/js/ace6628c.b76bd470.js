(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [16229],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => m, VZ: () => _, cR: () => w, Pv: () => g, qZ: () => s, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => c, eQ: () => v, B_: () => k, o_: () => p, Rc: () => x });
  ...
  40062(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => u, component: () => p, componentName: () => g, contentTitle: () => l, default: () => f, description: () => j, frontMatter: () => h, issueNumber: () => y, metadata: () => r, relayStep: () => m, title: () => d, toc: () => k }));
   const r = JSON.parse('{"id":"componenten/calendar/index","title":"Calendar","description":"Een kalender waarin je een beschikbare datum kan kiezen.","source":"@site/docs/componenten/calendar/index.mdx","sourceDirName":"componenten/calendar","slug":"/calendar","permalink":"/calendar","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/calendar/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Calendar","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Calendar","pagination_label":"Calendar","description":"Een kalender waarin je een beschikbare datum kan kiezen.","slug":"/calendar","keywords":["afspraak","appointment","availability","beschikbaarheid","calendar","dag","dagen","date","date picker","datepicker","datum","datumprikker","day","days","jaar","kalender","maand","moment","month","week","weeks","weken","year"]},"sidebar":"componenten","previous":{"title":"Button","permalink":"/button"},"next":{"title":"Card as Link","permalink":"/card-as-link"}}');
   var i = n(86070),
    c = n(18439),
    s = n(87069),
    o = n(85825),
    a = n(44594);
   const h = { title: 'Calendar', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Calendar', pagination_label: 'Calendar', description: 'Een kalender waarin je een beschikbare datum kan kiezen.', slug: '/calendar', keywords: ['afspraak', 'appointment', 'availability', 'beschikbaarheid', 'calendar', 'dag', 'dagen', 'date', 'date picker', 'datepicker', 'datum', 'datumprikker', 'day', 'days', 'jaar', 'kalender', 'maand', 'moment', 'month', 'week', 'weeks', 'weken', 'year'] },
    l = void 0,
    u = {},
    d = 'Calendar',
    j = 'Een kalender waarin je een beschikbare datum kan kiezen.',
    y = 199,
    m = 'help wanted',
    g = 'calendar',
    p = s.find((e) => e.number === y),
    k = [
  ...
  85825(e, t, n) {
   ...
   const m = ({ children: e }) => (0, h.jsx)('ul', { className: 'task-list', children: e }),
    g = ({ checked: e, children: t, title: n, description: r, headingLevel: c = 3 }) => (0, h.jsxs)('li', { className: (0, i.A)('task-list-item'), children: [(0, h.jsxs)('div', { className: (0, i.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, h.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, h.jsx)(y.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, h.jsxs)('div', { children: [n ? (0, h.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: c, children: n }) : null, r, t] })] });
   var p = n(33062);
   const k = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, h.jsx)(r.If, { sections: c.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, h.jsx)(g, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, h.jsx)(r.fz, { children: (0, h.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
