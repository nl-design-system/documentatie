     ...
     return (
      ...
      (0, a.jsxs)(a.Fragment, {
       children: [
        ...
        (0, a.jsx)(a.Fragment, { children: t && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)('link', { rel: 'preconnect', href: k }), (0, a.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), C && (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, a.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
        e.seo && !e.playlist && (0, a.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: s(e.id, h, y, k, e.seo) } }),
        R && !e.playlist && (0, a.jsx)('noscript', { children: (0, a.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${h} on YouTube`, children: ['Watch "', h, '" on YouTube'] }) }),
        (0, a.jsxs)(L, {
         onPointerOver: () => {
          t || r(!0);
         },
         ...
         style: { ...(!e.lazyLoad && { backgroundImage: `url(${y})` }), '--aspect-ratio': ($ / S) * 100 + '%', ...(e.style || {}) },
