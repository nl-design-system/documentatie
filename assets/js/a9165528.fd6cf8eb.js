 ...
 [48541],
 {
  80612: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(27197),
    s = n(8657);
   const o = { title: 'Image', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Image', pagination_label: 'Image', description: 'Toont een afbeelding', slug: '/image', keywords: ['afbeelding', 'beeld', 'bijschrift', 'description', 'foto', 'graphic', 'image', 'images', 'photo', 'picture', 'plaatje'] },
    a = void 0,
    u = { id: 'componenten/image/index', title: 'Image', description: 'Toont een afbeelding', source: '@site/docs/componenten/image/index.mdx', sourceDirName: 'componenten/image', slug: '/image', permalink: '/image', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/image/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Image', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Image', pagination_label: 'Image', description: 'Toont een afbeelding', slug: '/image', keywords: ['afbeelding', 'beeld', 'bijschrift', 'description', 'foto', 'graphic', 'image', 'images', 'photo', 'picture', 'plaatje'] }, sidebar: 'componenten', previous: { title: 'Icon', permalink: '/icon' }, next: { title: 'Input Group', permalink: '/input-group' } },
    l = {},
    h = [
