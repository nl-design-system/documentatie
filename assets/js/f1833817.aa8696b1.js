(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [43166],
 {
  31539: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => j, component: () => y, contentTitle: () => h, default: () => v, description: () => p, frontMatter: () => d, issueNumber: () => b, metadata: () => u, title: () => m, toc: () => g });
   var r = t(52676),
    i = t(24785),
    o = t(96439),
    a = t(23952),
  ...
  23952: (e, n, t) => {
   ...
   const x = 'task-list_hh8j',
    ...
    A = (e) => {
     let { checked: n, children: t, title: r, description: o, headingLevel: a = 3 } = e;
     return (0, d.jsxs)('li', { className: (0, i.Z)(f), children: [(0, d.jsxs)('div', { className: (0, i.Z)(_, n && w), children: [(0, d.jsx)('span', { className: z, children: n ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), n && (0, d.jsx)(v.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(k.X6, { appearance: 'utrecht-heading-3', level: a, children: r }), o, t] })] });
    };
   var T = t(14669);
   const S = (e) => {
     let { component: n, headingLevel: t } = e;
     const o = n && n.projects.filter((e) => T.e9.includes(e.id)),
      a = o && T.e9.map((e) => o.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, d.jsx)(N, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(A, { checked: n, title: t, description: (0, T.Q6)(r) }, r);
            }),
           }),
    ...
    L = (e) => {
     ...
     const o = n && T.$3[n.relayStep];
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(y.V, { level: t, suffix: o && (0, d.jsx)(b.y, { state: o }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  86964: (e, n, t) => {
   'use strict';
  ...
  72657: (e, n, t) => {
   ...
   var o = t(52676);
   const a = (e) => {
    let { children: n, className: t, level: a = 1, suffix: s, ...c } = e;
    return (0, o.jsxs)('hgroup', { className: (0, r.Z)(i['nlds-inline-heading-group'], `utrecht-heading-${a}`, t), ...c, children: [(0, o.jsx)('h1', { className: (0, r.Z)(i['nlds-inline-heading-group__heading']), children: n }), s && (0, o.jsxs)('p', { className: (0, r.Z)(i['nlds-inline-heading-group__suffix']), children: [s ? ' ' : '', s] })] });
   };
  },
  57716: (e, n, t) => {
   'use strict';
