...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [47916],
 {
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => D, cR: () => F, Pv: () => b, qZ: () => s, kD: () => v, QQ: () => _, B2: () => c, Pc: () => r, f4: () => o, GT: () => j, fX: () => l, eQ: () => k, B_: () => f, o_: () => x });
  ...
  98296(e, n, a) {
   ...
   const t = JSON.parse('{"id":"componenten/grid/index","title":"Grid","description":"Verdeelt content in rijen en kolommen voor een consistente en overzichtelijke layout.","source":"@site/docs/componenten/grid/index.mdx","sourceDirName":"componenten/grid","slug":"/grid","permalink":"/grid","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/grid/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Grid","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Grid","pagination_label":"Grid","description":"Verdeelt content in rijen en kolommen voor een consistente en overzichtelijke layout.","slug":"/grid","keywords":["grid","layout","row","column","rij","rijen","kolom","kolommen","raster"]},"sidebar":"componenten","previous":{"title":"Form Summary","permalink":"/form-summary"},"next":{"title":"Heading","permalink":"/heading"}}');
   var i = a(86070),
    l = a(18439),
    s = a(82461),
    o = a(12761);
   const r = { title: 'Grid', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Grid', pagination_label: 'Grid', description: 'Verdeelt content in rijen en kolommen voor een consistente en overzichtelijke layout.', slug: '/grid', keywords: ['grid', 'layout', 'row', 'column', 'rij', 'rijen', 'kolom', 'kolommen', 'raster'] },
    d = void 0,
    g = {},
    u = 'Grid',
