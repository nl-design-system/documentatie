...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [51562],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => a, KF: () => p, mJ: () => h, VZ: () => D, cR: () => A, Pv: () => f, qZ: () => r, kD: () => x, B2: () => g, Pc: () => l, f4: () => s, GT: () => _, fX: () => i, eQ: () => b, B_: () => v, o_: () => j, Rc: () => k });
  ...
  36837(e, n, t) {
   (t.r(n), t.d(n, { assets: () => c, component: () => u, contentTitle: () => d, default: () => j, description: () => p, frontMatter: () => l, issueNumber: () => g, metadata: () => o, title: () => m, toc: () => h }));
   const o = JSON.parse('{"id":"componenten/page-body/index","title":"Page Body","description":"De hoofdinhoud en eventuele aanvullende informatie.","source":"@site/docs/componenten/page-body/index.mdx","sourceDirName":"componenten/page-body","slug":"/page-body","permalink":"/page-body","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/page-body/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Page Body","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Page Body","pagination_label":"Page Body","description":"De hoofdinhoud en eventuele aanvullende informatie.","slug":"/page-body","keywords":["main","page body"]},"sidebar":"componenten","previous":{"title":"Ordered List","permalink":"/ordered-list"},"next":{"title":"Page Footer","permalink":"/page-footer"}}');
   var a = t(86070),
    i = t(18439),
    r = t(64792),
    s = t(37131);
   const l = { title: 'Page Body', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Page Body', pagination_label: 'Page Body', description: 'De hoofdinhoud en eventuele aanvullende informatie.', slug: '/page-body', keywords: ['main', 'page body'] },
    d = void 0,
    c = {},
    m = 'Page Body',
    p = 'De hoofdinhoud en eventuele aanvullende informatie.',
    g = 404,
  ...
  37131(e, n, t) {
   ...
   const h = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
            ...
            r.Zp,
            {
             ...
             children: (0, d.jsxs)(r.Wu, {
              children: [
               ...
               (m.length > 0 || s.length > 0) && (0, d.jsx)(o.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               m.length > 0 &&
                (0, d.jsx)(d.Fragment, {
    ...
    b = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.p, { level: n, suffix: a && (0, d.jsx)(m.D, { state: a }), children: e.title }), (0, d.jsx)(o.fz, { lead: !0, children: t })] });
    },
    x = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
