...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [91279],
 {
  ...
  33062(e, n, o) {
   o.d(n, { bo: () => t, KF: () => m, mJ: () => h, VZ: () => D, cR: () => A, Pv: () => f, qZ: () => r, kD: () => x, B2: () => g, Pc: () => l, f4: () => s, GT: () => k, fX: () => i, eQ: () => b, B_: () => j, o_: () => v, Rc: () => _ });
  ...
  41912(e, n, o) {
   (o.r(n), o.d(n, { assets: () => c, component: () => u, contentTitle: () => d, default: () => v, description: () => m, frontMatter: () => l, issueNumber: () => g, metadata: () => a, title: () => p, toc: () => h }));
  ...
  80506(e, n, o) {
   ...
   const h = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, d.jsx)(a.If, { sections: i.map((o) => ({ className: (0, t.A)('definition-of-done', o && `definition-of-done--${(0, u.fX)(o.title)}`), headingLevel: n, expanded: !1, label: o ? `${o.title} - ${o.progress.value} van ${o.progress.max}` : '', body: o && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(g._, { children: o.tasks.map(({ checked: e, name: o, id: a }) => (0, d.jsx)(g.Z, { headingLevel: n + 1, checked: e, heading: o, description: (0, u.qZ)(a) }, a)) }), (0, d.jsx)(a.fz, { children: (0, d.jsxs)(a.N_, { href: `${o.url}?filterQuery=${e.title}`, children: [o.title, ' projectbord op GitHub'] }) })] }) })) });
    },
    ...
    j = ({ component: e, headingLevel: n, description: o }) => {
     const t = e && u.bo[e.relayStep];
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: t && (0, d.jsx)(p.D, { state: t }), children: e.title }), (0, d.jsx)(a.fz, { lead: !0, children: o })] });
    };
  },
  90495(e, n, o) {
