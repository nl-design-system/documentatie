...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  34712: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => j, contentTitle: () => m, default: () => k, frontMatter: () => p, metadata: () => v, toc: () => w });
   var r = i(52676),
    t = i(40139),
    s = i(57716),
    a = i(46364),
   ...
   function h(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.p, { children: 'Waarschuw de gebruiker vooraf dat gegevens verloren kunnen gaan, als deze wordt uitgelogd vanwege inactiviteit op de website. Behalve wanneer deze gegevens meer dan 20 uur bewaard worden.' }), '\n', (0, r.jsx)(n.p, { children: 'Soms moet een gebruiker veel gegevens opzoeken voor bijvoorbeeld het boeken van een reis. Dat kan langer duren dat de maximale tijd van de inlogsessie.' }), '\n', (0, r.jsxs)(n.p, { children: [(0, r.jsx)(n.strong, { children: 'Let op:' }), ' Als dit privacygevoelige gegevens zijn, moet de gebruiker wel eerst toestemming geven voor het bewaren van deze data. Dit is opgenomen in de Algemene verordening gegevensbescherming (AVG).'] }), '\n', (0, r.jsx)(n.p, { children: 'Kinderen jonger dan 16 jaar kunnen zelf geen geldige toestemming geven voor het verwerken van hun gegevens. Toestemming is alleen geldig als een van de ouders of verzorgers van een kind de toestemming geeft.' }), '\n', (0, r.jsx)(n.p, { children: 'Overleg zonodig met privacyprofessionals en vraag juridisch advies om aan dit succescriterium te voldoen.' })] });
   }
   function u(e = {}) {
   ...
   function x(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', (0, r.jsx)(a.j, { level: 1, conformanceLevel: 'Niveau AAA', children: 'WCAG-succescriterium 2.2.6 Time-outs' }), '\n', (0, r.jsx)(o.CY, { children: (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(c.ZP, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'uitleg', children: 'Uitleg' }), '\n', (0, r.jsx)(u, {}), '\n', (0, r.jsx)(n.h2, { id: 'opgelet', children: 'Opgelet' }), '\n', (0, r.jsx)(n.p, { children: 'Deze inhoud wordt binnenkort aangevuld met uitgebreidere uitleg, bronnen en informatie over hoe te testen.' }), '\n', (0, r.jsx)(n.h2, { id: 'gebruikersonderzoek', children: 'Gebruikersonderzoek' }), '\n', (0, r.jsx)(l.ZP, {}), '\n', (0, r.jsx)(n.h2, { id: 'w3c-referenties', children: 'W3C referenties' }), '\n', (0, r.jsxs)(n.ul, { children: ['\n', (0, r.jsxs)(n.li, { children: ['Engelse tekst van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/TR/WCAG22/#timeouts', children: (0, r.jsx)('span', { lang: 'en', children: '2.2.6 Timeouts' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Nederlandse vertaling van het WCAG-succescriterium: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/Translations/WCAG22-nl/#time-outs', children: '2.2.6 Time-outs' }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige informatie op ', (0, r.jsx)('span', { lang: 'en', children: 'How to Meet WCAG' }), ': ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/quickref/#timeouts', children: (0, r.jsx)('span', { lang: 'en', children: 'Quick Reference 2.2.6 Timeouts' }) }), '.'] }), '\n', (0, r.jsxs)(n.li, { children: ['Engelstalige toelichting: ', (0, r.jsx)(n.a, { href: 'https://www.w3.org/WAI/WCAG22/Understanding/timeouts.html', children: (0, r.jsx)('span', { lang: 'en', children: 'Understanding SC 2.2.6 Timeouts' }) }), '.'] }), '\n'] }), '\n', (0, r.jsx)(o.CY, { children: (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(d.ZP, {}) }) }), '\n', (0, r.jsx)(n.h2, { id: 'help-richtlijn-verbeteren', children: 'Help richtlijn verbeteren' }), '\n', (0, r.jsx)(s.U, { omitH1: !0, headinglevel: 3, children: (0, r.jsx)(g.ZP, {}) })] });
   }
   function k(e = {}) {
    const { wrapper: n } = { ...(0, t.a)(), ...e.components };
  ...
  41757: (e, n, i) => {
   ...
   const s = (e) => {
    ...
    return (0, t.jsxs)('hgroup', { className: (0, r.Z)('nlds-inline-heading-group', `utrecht-heading-${s}`, i), ...o, children: [(0, t.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: n }), a && (0, t.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [a ? ' ' : '', a] })] });
   };
  },
  57716: (e, n, i) => {
   i.d(n, { U: () => c });
   ...
   const a = (e, n) => {
    ...
    c = (e) => {
     let { children: n, omitH1: i = !1, headingLevel: t = 1, baseUrl: a = '', components: o = {} } = e;
     return (0, s.jsx)(r.Z, { components: { ...d(i, t), ...l(a), ...o }, children: n });
    };
  },
  46364: (e, n, i) => {
   i.d(n, { j: () => a });
