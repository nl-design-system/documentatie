 ...
 [79837],
 {
   ...
   const d = (0, a.createContext)({}),
    p = ({ title: e, appearance: l, description: n, children: a, figure: p }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      h = p ? 'figure' : 'div',
      m = p ? 'figcaption' : 'div',
      g = 'string' == typeof n ? (0, i.jsx)(c.oz, { components: { a: s.N_ }, children: n }) : n;
  ...
  70348(e, l, n) {
   ...
   const c = ({ className: e, ...l }) => {
    ...
    a = ({ className: e, classNamePanel: l, label: n, heading: c, headingLevel: a, headingApperance: i, ...d }) => {
     const p = (0, o.A)('utrecht-accordion__section', e),
      u = (0, o.A)('utrecht-accordion__panel', l);
     return (0, t.jsxs)('details', { className: p, ...d, children: [(0, t.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, t.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, t.jsx)('span', { className: 'nl-button__icon-start', children: (0, t.jsx)(r.A, {}) }), (0, t.jsxs)('span', { className: 'nl-button__label', children: [c && (0, t.jsx)(s.D, { level: a, appearance: i, children: c }), n] })] }) }), (0, t.jsx)('div', { className: u, children: d.children })] });
    };
  },
  80731(e, l, n) {
   n.d(l, { H: () => b });
   ...
   const b = globalThis.isAstro
    ? ({ children: e, language: l, className: n }) => {
       const o = 'function' == typeof e ? e() : e,
        ...
        t = m().highlight(r, m().languages[l], l);
       return (0, v.jsxs)('div', { className: (0, s.A)('ma-canvas-astro', n), children: [(0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }), (0, v.jsx)(g.n, { children: (0, v.jsx)(g.K, { label: 'Code', children: (0, v.jsx)('pre', { className: 'language-html nl-code-block', children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: t } }) }) }) })] });
      }
    : ({ code: e, copy: l = !0, defaultExpandedCode: n = !1, displayCode: h = !0, children: m, container: g = 'document', language: b, designTokens: k }) => {
       ...
       let P = p.Fragment;
       return (
        'paragraph' === g ? (P = y) : 'document' === g ? (P = x) : 'surface' === g && (P = j),
        (0, v.jsxs)('div', {
         className: (0, s.A)('nlds-canvas'),
         children: [
          f && (0, v.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, v.jsx)(P, { children: (0, v.jsx)(r.v$, { children: f }) }) }) }),
          h &&
           (0, v.jsx)('div', {
