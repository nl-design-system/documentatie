 ...
 [97627],
 {
  1292(e, n, t) {
   ...
   var o = t(29181),
    ...
    l = t(83386),
    c = t(86070);
   const d = { figma: (0, c.jsx)(a.A, {}), github: (0, c.jsx)(s.A, {}), npm: (0, c.jsx)(i.A, {}), storybook: (0, c.jsx)(r.A, {}) },
    u = ({ brand: e }) => (0, c.jsx)(o.In, { children: d[e] || (0, c.jsx)(l.A, {}) });
  },
  33062(e, n, t) {
   t.d(n, { bo: () => a, KF: () => m, mJ: () => h, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => i, kD: () => k, B2: () => p, Pc: () => l, f4: () => r, GT: () => x, fX: () => s, eQ: () => v, B_: () => j, o_: () => b, Rc: () => _ });
    ...
    f = (e) => {
     ...
     return n.map((n) => {
      const o = e.tasks
       ...
       .map(({ name: o, id: a, value: s }) => {
        const i = /^(.+) URL/.exec(o)[1],
         r = 'Storybook' === i ? `${t} (${n}) in Storybook van ${e.title}` : `${t} (${n}) op ${i}`;
        return { brand: i.toLowerCase(), name: o, id: a, value: s, description: r };
       });
  ...
  60420(e, n, t) {
   (t.r(n), t.d(n, { assets: () => d, component: () => g, contentTitle: () => c, default: () => b, description: () => m, frontMatter: () => l, issueNumber: () => p, metadata: () => o, title: () => u, toc: () => h }));
  ...
  72642(e, n, t) {
   ...
   var o = t(13526),
    a = t(86070);
   const s = ({ children: e, className: n, level: t = 1, suffix: s, ...i }) => (0, a.jsxs)('hgroup', { className: (0, o.A)('nlds-inline-heading-group', `utrecht-heading-${t}`, n), ...i, children: [(0, a.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), s && (0, a.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
  },
  80506(e, n, t) {
   ...
   const h = ({ component: e, headingLevel: n }) => {
            ...
            i.Zp,
            {
             ...
             children: (0, c.jsxs)(i.Wu, {
              children: [
               ...
               (u.length > 0 || r.length > 0) && (0, c.jsx)(o.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               u.length > 0 &&
                (0, c.jsx)(c.Fragment, {
               ...
               r.length > 0 && (0, c.jsx)(c.Fragment, { children: r.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(o.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, c.jsx)(o.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    b = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(o.DZ, { level: n, children: 'Help om deze component te verbeteren' }), (0, c.jsxs)(o.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, c.jsxs)(o.Xy, { children: [a ? (0, c.jsxs)(o.Er, { children: ['Vul de ', (0, c.jsx)(o.N_, { href: a, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, c.jsxs)(o.Er, { children: [(0, c.jsxs)(o.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, c.jsxs)(o.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, c.jsx)(o.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, c.jsx)(o.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    j = ({ component: e, headingLevel: n, description: t }) => {
     const a = e && g.bo[e.relayStep];
     return e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(m.p, { level: n, suffix: a && (0, c.jsx)(u.D, { state: a }), children: e.title }), (0, c.jsx)(o.fz, { lead: !0, children: t })] });
    };
  },
  90495(e, n, t) {
   t.d(n, { AC: () => c, Fu: () => i, Wu: () => r, Zp: () => l });
   var o = t(46447),
    a = t(13526),
    s = t(86070);
   const i = ({ background: e, children: n, className: t, ...o }) => (0, s.jsx)('div', { className: (0, a.A)('card__illustration', e && `card__illustration--${e}`, t), ...o, children: n }),
    ...
    l = ({ href: e, appearance: n, className: t, component: i = 'div', background: r, children: l }) => {
     const c = (e) => ('article' === i ? (0, s.jsx)('article', { ...e }) : 'section' === i ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      d = (0, s.jsx)(c, { className: (0, a.A)('cardgroup__card', r && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: l });
     return e ? (0, s.jsx)(o.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: d }) : d;
    },
    c = ({ appearance: e = 'medium', children: n, className: t }) => (0, s.jsx)('div', { className: (0, a.A)('cardgroup', `cardgroup--${e}`, t), children: n });
  },
 },
]);
