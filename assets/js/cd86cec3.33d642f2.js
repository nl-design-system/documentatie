...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [71134],
 {
  ...
  18439(e, t, i) {
   ...
   function o(e) {
    let t;
    return ((t = e.disableParentContext ? ('function' == typeof e.components ? e.components(n) : e.components || n) : r(e.components)), a.createElement(l.Provider, { value: t }, e.children));
   }
  },
  33500(e, t, i) {
   (i.r(t), i.d(t, { assets: () => d, contentTitle: () => s, default: () => m, frontMatter: () => o, metadata: () => a, toc: () => c }));
   ...
   var n = i(86070),
    l = i(18439),
    r = (i(46447), i(90495), i(45282), i(4258));
   i(88666);
  ...
  45282(e, t, i) {
   ...
   const l = ({ children: e, ...t }) => {
     const { to: i, href: a, ...l } = t;
     let r = i || a;
     const o = new URL(r, 'https://nldesignsystem.nl');
     return ('https://nldesignsystem.nl' === o.origin ? ((o.pathname = o.pathname.endsWith('/') ? o.pathname : `${o.pathname}/`), (r = o.toString().replace('https://nldesignsystem.nl', ''))) : ((l.target = '_blank'), (l.rel = 'noopener noreferrer')), (0, n.jsx)('a', { href: r, ...l, children: e }));
    },
    r = ({ className: e, ...t }) => (0, n.jsx)(l, { className: (0, a.$)('utrecht-link', 'utrecht-link--html-a', e), ...t });
  },
  78236(e, t, i) {
   i.d(t, { A: () => o });
   var a = i(86070),
   ...
   const o = n.forwardRef(function (e, t) {
    const [i, o] = n.useState(!1),
     ...
     v = b
      ...
      : null,
     w = n.useMemo(() => e.thumbnail || v || `https://i.ytimg.com/${f}/${e.playlist ? p : c}/${h}.${y}`, [e.thumbnail, v, f, e.playlist, p, c, h, y]),
    ...
    return (
     ...
     (0, a.jsxs)(a.Fragment, {
      children: [
       ...
       e.seo && !e.playlist && (0, a.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: r(e.id, m, w, j, e.seo) } }),
       ...
       (0, a.jsxs)(U, {
        ...
        children: [e.lazyLoad && !s && (0, a.jsx)('img', { src: w, alt: `${m} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, a.jsx)('button', { type: 'button', className: E, 'aria-label': `${u} ${m}`, 'aria-hidden': s || void 0, tabIndex: s ? -1 : 0, children: (0, a.jsx)('span', { className: 'lty-visually-hidden', children: u }) }), s && (0, a.jsx)('iframe', { ref: t, className: T, title: m, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: x, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
  ...
  88666(e, t, i) {
   ...
   var a = i(45282),
    n = i(13526),
    l = i(86070);
   const r = ({ appearance: e, ...t }) => (0, l.jsx)(a.F, { className: (0, n.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...t });
  },
  90495(e, t, i) {
   ...
   var a = i(46447),
    n = i(13526),
    l = i(86070);
   const r = ({ background: e, children: t, className: i, ...a }) => (0, l.jsx)('div', { className: (0, n.A)('card__illustration', e && `card__illustration--${e}`, i), ...a, children: t }),
    ...
    s = ({ href: e, appearance: t, className: i, component: r = 'div', background: o, children: s }) => {
     const d = (e) => ('article' === r ? (0, l.jsx)('article', { ...e }) : 'section' === r ? (0, l.jsx)('section', { ...e }) : (0, l.jsx)('div', { ...e })),
      c = (0, l.jsx)(d, { className: (0, n.A)('cardgroup__card', o && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, i), children: s });
