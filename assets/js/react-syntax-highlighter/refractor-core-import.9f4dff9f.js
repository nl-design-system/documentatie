/*! For license information please see refractor-core-import.9f4dff9f.js.LICENSE.txt */
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [95082, 131, 35008, 27279, 2496],
 {
  72107: (e, n) => {
   "use strict";
   n.Q = function (e) {
  ...
  84892: (e) => {
   ...
   e.exports = function (e, t) {
    var a,
     ...
     s = {},
     u = 0;
    for (; u < o.length; ) (n.lastIndex = u), (l = n.exec(o)), (a = o.slice(u, l ? l.index : o.length)) && (r ? ("#" === r ? (s.id = a) : s.className ? s.className.push(a) : (s.className = [a])) : (i = a), (u += a.length)), l && ((r = l[0]), u++);
  ...
  3177: (e, n, t) => {
    ...
    return (function (e, n) {
     ...
     for (; ++ge < pe; )
      if ((I === f && (fe = ce[de] || 1), (I = e.charCodeAt(ge)) === v)) {
       if ((U = e.charCodeAt(ge + 1)) === d || U === f || U === m || U === h || U === v || U === b || U != U || (ne && U === ne)) {
        (he += c(I)), fe++;
        continue;
       }
       ...
       (o = e.charCodeAt(ee) === y) && (ee++, (l = G === S && s(g)) && ((t = g), (Z = l))), (X = 1 + ee - K), (o || te) && (g ? (G === S ? (o && !Z ? H(M, 1) : (t !== g && ((X = 1 + (ee = V + t.length) - V), (o = !1)), o || ((q = t ? O : N), n.attribute ? ((U = e.charCodeAt(ee)) === x ? (H(q, X), (Z = null)) : i(U) ? (Z = null) : H(q, X)) : H(q, X))), (B = Z)) : (o || H($, X), z((B = parseInt(g, P[G]))) ? (H(_, X), (B = c(A))) : B in r ? (H(T, X), (B = r[B])) : ((W = ""), R(B) && H(T, X), B > 65535 && ((W += c(((B -= 65536) >>> 10) | 55296)), (B = 56320 | (1023 & B))), (B = W + c(B))))) : G !== S && H(j, X)), B ? (xe(), (J = ye()), (ge = ee - 1), (fe += ee - K + 1), ve.push(B), (Y = ye()).offset++, re && re.call(ie, B, { start: J, end: Y }, e.slice(K - 1, ee)), (J = Y)) : ((g = e.slice(K - 1, ee)), (he += g), (fe += g.length), (ge = ee - 1));
      } else 10 === I && (me++, de++, (fe = 0)), I == I ? ((he += c(I)), fe++) : xe();
     return ve.join("");
     function ye() {
      return { line: me, column: fe, offset: ge + (ue.offset || 0) };
     }
     function be(e, n) {
      var t = ye();
     ...
     function xe() {
      he && (ve.push(he), ae && ae.call(oe, he, { start: J, end: ye() }), (he = ""));
     }
    })(e, o);
   };
   ...
   (D[O] = "Named character references must be terminated by a semicolon"), (D[$] = "Numeric character references must be terminated by a semicolon"), (D[N] = "Named character references cannot be empty"), (D[j] = "Numeric character references cannot be empty"), (D[M] = "Named character references must be known"), (D[T] = "Numeric character references cannot be disallowed"), (D[_] = "Numeric character references cannot be outside the permissible Unicode range");
  },
  58925: (e, n, t) => {
   var a = (function (e) {
     ...
     for (var g in t)
      if (t.hasOwnProperty(g) && t[g]) {
       ...
       for (var f = 0; f < d.length; ++f) {
        ...
        for (var w = m.pattern || m, k = a.next, F = s; k !== n.tail && !(p && F >= p.reach); F += k.value.length, k = k.next) {
         var A = k.value;
         ...
         if (!(A instanceof l)) {
          ...
          var T = k.prev;
          if ((N && ((T = u(n, T, N)), (F += N.length)), c(n, T, C), (k = u(n, T, new l(g, h ? r.tokenize($, h) : $, b, $))), j && u(n, k, j), C > 1)) {
           var _ = { cause: g + "," + f, reach: M };
           i(e, n, t, k.prev, F, _), p && _.reach > p.reach && (p.reach = _.reach);
          }
         }
        }
       }
   ...
   (e.exports = h),
    (h.highlight = function (e, n) {
     ...
     if ("Object" === h.util.type(n)) (t = n), (n = null);
      ...
      if (!f.call(h.languages, n)) throw new Error("Unknown language: `" + n + "` is not registered");
      t = h.languages[n];
     }
    ...
    (h.Token.stringify = function (e, n, t) {
     ...
     if ("Array" === h.util.type(e))
      return (function (e, n) {
       ...
       (l = -1), (r = a.length);
       for (; ++l < r; ) (t = a[l]), (a[l] = h.Token.stringify(t, n, a));
       return a;
      })(e, n);
     (a = { type: e.type, content: h.Token.stringify(e.content, n, t), tag: "span", classes: ["token", e.type], attributes: {}, language: n, parent: t }), e.alias && (a.classes = a.classes.concat(e.alias));
     return (
      h.hooks.run("wrap", a),
      i(
