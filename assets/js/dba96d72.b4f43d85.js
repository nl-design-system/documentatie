 ...
 [54026],
 {
  ...
  58639(e, n, l) {
   ...
   const b = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: b = !0, children: j, container: y = 'document', language: x, designTokens: f }) => {
    ...
    let D = u.Fragment;
    return (
     'paragraph' === y ? (D = h) : 'document' === y ? (D = v) : 'surface' === y && (D = g),
     (0, m.jsxs)('div', {
      className: (0, s.A)('nlds-canvas'),
      children: [
       k && (0, m.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(D, { children: (0, m.jsx)(o.v$, { children: k }) }) }) }),
       b &&
        (0, m.jsx)('div', {
