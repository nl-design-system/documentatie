...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [7177],
 {
  ...
  21034(e, n, a) {
   ...
   const k = ({ component: e, headingLevel: n }) => {
     const a = e && e.projects.filter((e) => x.f4.includes(e.id)),
      s = a && x.f4.map((e) => a.find((n) => n.id === e)).filter(Boolean);
               ...
               d.Z,
               {
                ...
                description: (0, m.jsxs)('div', {
                 ...
                 children: [
                  ...
                  (0, m.jsxs)('div', {
                   children: [
                    (p.length > 0 || g.length > 0) && (0, m.jsx)(s.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    p.length > 0 &&
                     (0, m.jsx)(t.dk, {
                      links: p
                  ...
                  g.length > 0 && g.map(({ frameworkName: e, tasks: a }) => (0, m.jsxs)('section', { children: [(0, m.jsxs)(s.DZ, { level: Math.min(n + 2, 6), children: [r, ' in ', e] }), (0, m.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, m.jsx)(l.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => s, KF: () => m, mJ: () => h, VZ: () => D, cR: () => w, Pv: () => b, qZ: () => r, kD: () => j, QQ: () => N, B2: () => c, Pc: () => o, f4: () => l, GT: () => k, fX: () => i, eQ: () => v, B_: () => f, o_: () => x });
  ...
  85152(e, n, a) {
   (a.r(n), a.d(n, { assets: () => g, component: () => h, componentName: () => p, contentTitle: () => d, default: () => f, description: () => m, frontMatter: () => o, issueNumber: () => c, metadata: () => t, title: () => u, toc: () => b }));
   ...
   const o = { title: 'Tabs', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Tabs', pagination_label: 'Tabs', description: 'Paneel om onderwerpen te groeperen, waarbij er maar \xe9\xe9n per keer zichtbaar is, met buttons om te kiezen welk onderwerp wordt weergegeven.', issue_number: 51, slug: '/tabs', keywords: ['content tabs', 'navigation', 'navigation tabs', 'nav tabs', 'panel', 'pivot', 'scoped tabs', 'switch', 'tab', 'tabs', 'tab bar', 'tab control', 'tab group', 'tab menu', 'tab nav', 'tab panel', 'tabbed interface', 'tabbed view'] },
    ...
    g = {},
    u = 'Tabs',
    m = 'Paneel om onderwerpen te groeperen, waarbij er maar \xe9\xe9n per keer zichtbaar is, met buttons om te kiezen welk onderwerp wordt weergegeven.',
    c = 51,
    p = 'tabs',
   ...
   function x(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, s.jsx)(l.Fc, { component: h, headingLevel: 1, description: m }), '\n', (0, s.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, s.jsx)(l.VK, { component: h, headingLevel: 3 }), '\n', (0, s.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, s.jsx)(l.mu, { component: h, headingLevel: 3 }), '\n', (0, s.jsx)(l.K_, { component: h }), '\n', (0, s.jsx)(l.$9, { component: h, headingLevel: 2 })] });
   }
   function f(e = {}) {
