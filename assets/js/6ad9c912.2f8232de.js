 ...
 [67688],
 {
  ...
  58639(e, n, o) {
   ...
   var l = o(69284),
    ...
    u = o(31186),
    h = o(86070);
   const m = ({ children: e }) => (0, h.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(t.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, h.jsx)(t.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   m.displayName = 'ParagraphContainer';
   const y = ({ children: e }) => (0, h.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: (0, h.jsx)(t.yo, { className: (0, s.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   y.displayName = 'DocumentContainer';
   const v = ({ children: e }) => (0, h.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: e });
   v.displayName = 'SurfaceContainer';
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: g = !0, children: k, container: j = 'document', language: b, designTokens: x }) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await d.Ay.format(_, { parser: b, plugins: [r.A, c.Ay, a.Ay, i.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      A(e);
     })();
    }, [_]);
    const z = (0, p.useId)();
    ...
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       f && (0, h.jsx)('div', { className: (0, s.A)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, h.jsx)(R, { children: (0, h.jsx)(t.v$, { children: f }) }) }) }),
       g &&
        (0, h.jsx)('div', {
  ...
  72389(e, n, o) {
   ...
   function i(e) {
    ...
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', (0, t.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, t.jsx)(a.$, { appearance: 'do', title: 'Sta kopi\xebren van een wachtwoord toe.', children: (0, t.jsx)(c.H, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)('label', { htmlFor: 'pw1', children: 'Uw nieuwe wachtwoord' }), (0, t.jsx)('input', { type: 'password', id: 'pw1', autoComplete: 'new-password', name: 'wachtwoord' })] }) }) })] });
   }
   function d(e = {}) {
   ...
   const y = { title: 'Sta knippen en plakken van een wachtwoord toe', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Wachtwoord plakken', pagination_label: 'Wachtwoord plakken', description: 'Richtlijnen om knippen en plakken van een wachtwoord toe te staan.', slug: '/richtlijnen/formulieren/voorkom-fouten/wachtwoord-plakken/', keywords: ['labels', 'formulier', 'design', 'code'] },
    v = void 0,
    g = {},
    k = [{ value: 'Voorbeelden', id: 'voorbeelden', level: 2 }, { value: 'Meer lezen over gerelateerde WCAG-succescriteria op NL Design System', id: 'meer-lezen-over-gerelateerde-wcag-succescriteria-op-nl-design-system', level: 2 }, ...r.RM];
   function j(e) {
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', (0, t.jsx)(u, {}), '\n', (0, t.jsx)(d, {}), '\n', (0, t.jsx)(m, {}), '\n', (0, t.jsx)(r.Ay, {})] });
   }
   function b(e = {}) {
