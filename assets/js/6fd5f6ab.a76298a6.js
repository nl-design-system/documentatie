 ...
 [53087],
 {
  ...
  12761(e, n, t) {
   ...
   const k = ({ className: e, ...n }) => {
    ...
    b = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, d.jsx)(k, { children: s.map((t) => (0, d.jsx)(v, { className: (0, i.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, m.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(h._, { children: t.tasks.map(({ checked: e, name: t, id: a }) => (0, d.jsx)(h.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, m.qZ)(a) }, a)) }), (0, d.jsx)(a.fz, { children: (0, d.jsxs)(a.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
  ...
  13528(e, n, t) {
   ...
   const S = [
     ...
     { title: 'De Heading komt niet voor in de normale focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: N.Ay, tags: ['developer'] },
     {
    ...
    H = [
     ...
     { title: 'De Heading komt standaard niet voor in de focusvolgorde van de pagina.', sc: '2.4.3', status: '', component: A.Ay, tags: ['developer'] },
    ];
   var F = t(16764),
    T = t(12941);
   function L(e) {
  ...
  16764(e, n, t) {
   ...
   var p = t(43864),
    ...
    A = t(79532),
    N = t(30758);
   const S = { boxShadow: p.A, color: j.A, cursor: x.A, dimension: k.A, fontFamily: v.A, fontFamilies: v.A, fontSize: b.A, fontSizes: b.A, fontWeight: f.A, fontWeights: f.A, lineHeight: y.A, lineHeights: y.A, number: w.A, other: D.A, textDecoration: A.A },
    H = ({ type: e }) => {
     const n = Object.hasOwn(S, e) ? e : 'other';
     return (0, h.jsx)(u.In, { children: (0, N.createElement)(S[n]) });
    };
   var F = t(76223);
   function T({ tokens: e }) {
    const n = (0, s.kD)(e),
       ...
       children: [
        ...
        (0, h.jsx)(r.BF, {
         children: l.map((n) => {
          const t = (0, s.o_)(n),
           l = (0, s.eQ)(e, n).$type;
          return (0, h.jsxs)(r.Hj, { children: [(0, h.jsx)(r.nA, { children: (0, h.jsx)(a.C, { children: (0, h.jsx)(r.kf, { children: t }) }) }), (0, h.jsx)(r.nA, { children: (0, h.jsxs)(i.K, { children: [(0, h.jsx)(H, { type: l }), ' ', l] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, h.jsxs)(r.e2, { children: [(0, h.jsx)(m, { content: d, language: 'json', children: 'Kopieer als JSON' }), (0, h.jsx)(m, { content: o, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  ...
  76097(e, n, t) {
   'use strict';
   t.d(n, { bo: () => i, KF: () => u, mJ: () => p, VZ: () => w, cR: () => y, Pv: () => j, qZ: () => r, kD: () => b, B2: () => h, Pc: () => o, f4: () => l, GT: () => f, fX: () => s, eQ: () => v, B_: () => k, o_: () => x });
