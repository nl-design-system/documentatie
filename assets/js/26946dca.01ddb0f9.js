 ...
 [3958],
 {
  ...
  12013(e, t, n) {
   ...
   const i = (e, t) => {
    ...
    l = (e) => ({ img: ({ src: t, ...n }) => (0, o.jsx)('img', { ...n, src: i(e, t), className: 'utrecht-img utrecht-img--fit' }) }),
    a = (e, t) => {
     if (e) {
      const e = { ...c[t - 1] };
      return (e.h1 = () => null), e;
    ...
    d = ({ children: e, omitH1: t = !1, headingLevel: n = 1, baseUrl: s = '', components: i = {} }) => (0, o.jsx)(r.x, { components: { ...a(t, n), ...l(s), ...i }, children: e });
  },
  17045(e, t, n) {
   'use strict';
   n.d(t, { Ay: () => c, RM: () => o });
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => u, mJ: () => p, VZ: () => x, cR: () => A, Pv: () => j, qZ: () => i, kD: () => f, B2: () => m, Pc: () => l, f4: () => c, GT: () => v, fX: () => o, eQ: () => k, B_: () => y, o_: () => w, Rc: () => b });
   ...
   const h = ({ title: e, sc: t, component: n, tags: a }) => {
    ...
    u = ({ items: e, headingLevel: t }) => {
     const n = e.reduce(
      ...
      [r, s] = (0, l.useState)(Array.from(n.values())),
      i = (e) => r.includes(e),
      c = (0, l.useId)(),
     ...
     children: [
      ...
      (0, s.jsx)(b.b, {
       ...
       items: [
        ...
        { title: 'Wanneer de achtergrondkleur van het Code Block anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina.', sc: '1.4.11', status: '', component: (0, s.jsx)(u.Ay, {}), tags: ['designer', 'contentmaker'] },
       ],
      }),
      '\n',
  ...
  72401(e, t, n) {
   ...
   const c = ({ component: e }) => {
    const { title: t } = e,
     c = (0, o.fX)(t),
     l = s.lazy(() => n(82839)(`./${c}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
   ...
   const i = ({ background: e, children: t, className: n, ...r }) => (0, o.jsx)('div', { className: (0, s.A)('card__illustration', e && `card__illustration--${e}`, n), ...r, children: t }),
    ...
    l = ({ href: e, appearance: t, className: n, component: i = 'div', background: c, children: l }) => {
     const a = (e) => ('article' === i ? (0, o.jsx)('article', { ...e }) : 'section' === i ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(a, { className: (0, s.A)('cardgroup__card', c && 'cardgroup__card--light-purple', `cardgroup__card--${t}`, n), children: l });
     return e ? (0, o.jsx)(r.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: d }) : d;
    },
    a = ({ appearance: e = 'medium', children: t, className: n }) => (0, o.jsx)('div', { className: (0, s.A)('cardgroup', `cardgroup--${e}`, n), children: t });
  },
  99630(e, t, n) {
   'use strict';
   ...
   const g = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    p = ({ checked: e, children: t, title: n, description: r, headingLevel: o = 3 }) => (0, l.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(m.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [n ? (0, l.jsx)(u.DZ, { appearance: 'utrecht-heading-3', level: o, children: n }) : null, r, t] })] });
   var j = n(33062);
   const w = ({ component: e, headingLevel: t }) => {
    ...
    f = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(h.p, { level: t, suffix: s && (0, l.jsx)(d.D, { state: s }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
 },
]);
