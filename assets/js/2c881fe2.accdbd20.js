...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [94810],
 {
  ...
  33062(e, n, t) {
   t.d(n, { bo: () => r, KF: () => p, mJ: () => h, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => o, kD: () => x, B2: () => u, Pc: () => l, f4: () => a, GT: () => k, fX: () => i, eQ: () => b, B_: () => v, o_: () => j, Rc: () => _ });
  ...
  37131(e, n, t) {
   ...
   const h = JSON.parse('{"Notification Banner":["Alert","Note"],"Note":["Alert","Notification Banner"],"Modal Dialog":["Alert Dialog","Drawer","Dialog"],"Drawer":["Modal Dialog","Dialog"],"Dialog":["Alert Dialog","Drawer"],"Alert Dialog":["Alert","Modal Dialog","Dialog"],"Alert":["Alert Dialog","Notification Banner","Note"],"Unordered List":["Ordered List","Rich Text Content","Link List","Task List"],"Ordered List":["Rich Text Content","Unordered List"]}'),
    ...
    b = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.p, { level: n, suffix: r && (0, d.jsx)(m.D, { state: r }), children: e.title }), (0, d.jsx)(s.fz, { lead: !0, children: t })] });
    },
    x = ({ component: e }) => {
     const n = (e && h[e.title]) || [];
  ...
  72078(e, n, t) {
   (t.r(n), t.d(n, { assets: () => c, component: () => g, contentTitle: () => d, default: () => j, description: () => p, frontMatter: () => l, issueNumber: () => u, metadata: () => s, title: () => m, toc: () => h }));
   ...
   const l = { title: 'Ordered List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Ordered List', pagination_label: 'Ordered List', description: 'Lijst waarvan de volgorde van items betekenis heeft.', slug: '/ordered-list', keywords: ['alfabetische lijst', 'array', 'enum', 'genummerde lijst', 'geordende lijst', 'gesorteerde lijst', 'inhoudsopgave', 'lijst', 'lijst met nummers', 'list', 'list items', 'nested list', 'numbered list', 'numerieke lijst', 'nummer lijst', 'nummering', 'ol', 'opsomming', 'opsommings lijst', 'ordered', 'ordered list', 'rangschikking', 'sequence', 'stappen', 'vertical list'] },
    ...
    c = {},
    m = 'Ordered List',
    p = 'Lijst waarvan de volgorde van items betekenis heeft.',
    u = 117,
   ...
   function f(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, r.jsx)(a.Fc, { component: g, headingLevel: 1, description: p }), '\n', (0, r.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, r.jsx)(a.VK, { component: g, headingLevel: 3 }), '\n', (0, r.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, r.jsx)(a.mu, { component: g, headingLevel: 3 }), '\n', (0, r.jsx)(a.K_, { component: g }), '\n', (0, r.jsx)(a.$9, { component: g, headingLevel: 2 })] });
   }
   function j(e = {}) {
