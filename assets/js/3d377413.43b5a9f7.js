 ...
 [10721],
 {
  1292(e, n, t) {
   ...
   var o = t(29181),
    ...
    l = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(a.A, {}), github: (0, d.jsx)(s.A, {}), npm: (0, d.jsx)(r.A, {}), storybook: (0, d.jsx)(i.A, {}) },
    p = ({ brand: e }) => (0, d.jsx)(o.In, { children: c[e] || (0, d.jsx)(l.A, {}) });
  },
  33062(e, n, t) {
   t.d(n, { bo: () => a, KF: () => m, mJ: () => h, VZ: () => N, cR: () => A, Pv: () => f, qZ: () => r, kD: () => k, B2: () => g, Pc: () => l, f4: () => i, GT: () => x, fX: () => s, eQ: () => v, B_: () => b, o_: () => j, Rc: () => _ });
     ...
     return n.map((n) => {
      const o = e.tasks
       ...
       .map(({ name: o, id: a, value: s }) => {
        ...
        return { brand: r.toLowerCase(), name: o, id: a, value: s, description: i };
       });
  ...
  72642(e, n, t) {
   ...
   var o = t(13526),
    a = t(86070);
   const s = ({ children: e, className: n, level: t = 1, suffix: s, ...r }) => (0, a.jsxs)('hgroup', { className: (0, o.A)('nlds-inline-heading-group', `utrecht-heading-${t}`, n), ...r, children: [(0, a.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), s && (0, a.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
  },
  80506(e, n, t) {
            ...
            r.Zp,
            {
             ...
             children: (0, d.jsxs)(r.Wu, {
              children: [
               ...
               (p.length > 0 || i.length > 0) && (0, d.jsx)(o.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               p.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               i.length > 0 && (0, d.jsx)(d.Fragment, { children: i.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(o.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, d.jsx)(o.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  90495(e, n, t) {
   ...
   var o = t(46447),
    a = t(13526),
    s = t(86070);
   const r = ({ background: e, children: n, className: t, ...o }) => (0, s.jsx)('div', { className: (0, a.A)('card__illustration', e && `card__illustration--${e}`, t), ...o, children: n }),
