 ...
 [42564],
 {
  ...
  70348(e, n, s) {
   ...
   var l = s(13526),
    ...
    r = s(37168),
    a = s(86070);
   const i = (0, t.forwardRef)(({ as: e, className: n, children: s, ...t }, o) => {
     const r = e || 'div',
      i = (0, l.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(r, { ref: o, className: i, ...t, children: s });
    }),
    c = ({ className: e, classNamePanel: n, label: s, heading: t, headingLevel: i, headingApperance: c, ...d }) => {
     const m = (0, l.A)('utrecht-accordion__section', e),
      p = (0, l.A)('utrecht-accordion__panel', n);
     return (0, a.jsxs)('details', { className: m, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(o.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [t && (0, a.jsx)(r.D, { level: i, appearance: c, children: t }), s] })] }) }), (0, a.jsx)('div', { className: p, children: d.children })] });
    };
  },
  80731(e, n, s) {
   s.d(n, { H: () => v });
   ...
   const v = globalThis.isAstro
    ? ({ children: e, language: n, className: s }) => {
       ...
       return (0, g.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', s), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: t } }), (0, g.jsx)(j.n, { children: (0, g.jsx)(j.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: r } }) }) }) })] });
      }
