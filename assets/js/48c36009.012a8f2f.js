(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [78239],
 {
  81877: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => l, component: () => y, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => s, issueNumber: () => m, metadata: () => u, title: () => h, toc: () => d });
   var r = n(52676),
    i = n(24785),
    c = n(14147),
    o = n(23952);
   const s = { title: 'Date Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Input', pagination_label: 'Date Input', description: 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.', slug: '/date-input', keywords: ['browser', 'built-in', 'date', 'date field', 'date input', 'date picker', 'date selection', 'datepicker', 'datum', 'datum invoer', 'datumveld', 'form', 'form control', 'formulier', 'formulierelement', 'ingebouwd', 'input', 'input field', 'invoerveld', 'invullen', 'kalender', 'native', 'text field', 'textbox'] },
    a = void 0,
    u = { id: 'componenten/date-input/index', title: 'Date Input', description: 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.', source: '@site/docs/componenten/date-input/index.mdx', sourceDirName: 'componenten/date-input', slug: '/date-input', permalink: '/date-input', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/date-input/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Date Input', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Input', pagination_label: 'Date Input', description: 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.', slug: '/date-input', keywords: ['browser', 'built-in', 'date', 'date field', 'date input', 'date picker', 'date selection', 'datepicker', 'datum', 'datum invoer', 'datumveld', 'form', 'form control', 'formulier', 'formulierelement', 'ingebouwd', 'input', 'input field', 'invoerveld', 'invullen', 'kalender', 'native', 'text field', 'textbox'] }, sidebar: 'componenten', previous: { title: 'Data Badge', permalink: '/data-badge' }, next: { title: 'Date Input Group', permalink: '/date-input-group' } },
    l = {},
    d = [
    ...
    h = 'Date Input',
    j = 'Invoerveld om een datum in te vullen met de mogelijkheden die de browser biedt.',
    m = 188,
  ...
  68963: (e, t, n) => {
   ...
   const s = (e) => {
    ...
    u = (e) => {
     let { href: t, appearance: n, className: s, component: a = 'div', children: u } = e;
     const l = (e) => ('article' === a ? (0, o.jsx)('article', { ...e }) : 'section' === a ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      d = (0, o.jsx)(l, { className: (0, i.Z)(c.cardgroup__card, c[`cardgroup__card--${n}`], s), children: u });
  ...
  23952: (e, t, n) => {
   ...
   var r = n(56150),
    ...
    u = n(32636),
    l = n(52676);
   const d = { figma: (0, l.jsx)(c.Z, {}), github: (0, l.jsx)(o.Z, {}), npm: (0, l.jsx)(s.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    h = (e) => {
     let { brand: t } = e;
   ...
   const k = 'task-list_hh8j',
    ...
    D = (e) => {
     ...
     return (0, l.jsxs)('li', { className: (0, i.Z)(_), children: [(0, l.jsxs)('div', { className: (0, i.Z)(x, t && w), children: [(0, l.jsx)('span', { className: N, children: t ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), t && (0, l.jsx)(f.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [(0, l.jsx)(b.X6, { appearance: 'utrecht-heading-3', level: o, children: r }), c, n] })] });
    };
   var z = n(14669);
   const S = (e) => {
     let { component: t, headingLevel: n } = e;
     const c = t && t.projects.filter((e) => z.e9.includes(e.id)),
      o = c && z.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       appearance: '',
       sections: o.map((e) => ({
        className: (0, i.Z)(m['definition-of-done'], e && m[`definition-of-done--${(0, z.mA)(e.title)}`]),
        headingLevel: n,
        expanded: !1,
          ...
          children: [
           (0, l.jsx)(A, {
            children: e.tasks.map((e) => {
             ...
             return (0, l.jsx)(D, { checked: t, title: n, description: (0, z.Q6)(r) }, r);
            }),
           }),
                 ...
                 children: [
                  ...
                  (0, l.jsx)(r.Mc, {
                   children: s.map((e) => {
                    ...
                    return t ? (0, l.jsxs)(r.k7, { href: e.value, children: [(0, l.jsx)(h, { brand: t.brand }), ' ', t.desciption] }, e.id) : (0, l.jsx)(l.Fragment, {});
                   }),
                  }),
                 ],
                }),
