 ...
 [34531],
 {
  15175(e, n, a) {
   ...
   function d({ lineNumber: e, syntax: n, textContent: a, trim: d }) {
    ...
    const { title: p, type: u } = (0, t.useContext)(i.x),
     k = (0, t.useId)();
    return (d && (c = c.trim()), (0, s.jsx)(r.f4, { theme: l, code: c, language: n || '', children: ({ style: n, tokens: a, getLineProps: r, getTokenProps: t }) => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: k, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, s.jsx)(o.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': k, style: n, children: a.map((n, a) => (0, s.jsxs)('span', { ...r({ line: n }), children: [e && (0, s.jsx)('span', { children: a + 1 }), n.map((e, n) => (0, s.jsx)('span', { ...t({ token: e }) }, n)), '\n'] }, a)) })] }) }));
   }
  },
  18439(e, n, a) {
   a.d(n, { R: () => i, x: () => l });
   ...
   const c = (0, s.createContext)({}),
    p = ({ title: e, appearance: n, description: a, children: s, figure: p }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      k = p ? 'figure' : 'div',
      h = p ? 'figcaption' : 'div',
      v = 'string' == typeof a ? (0, d.jsx)(l.oz, { components: { a: t.N_ }, children: a }) : a;
  ...
  70348(e, n, a) {
   ...
   var o = a(13526),
    ...
    i = a(37168),
    l = a(86070);
   const s = (0, r.forwardRef)(({ as: e, className: n, children: a, ...r }, t) => {
     const i = e || 'div',
      s = (0, o.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, l.jsx)(i, { ref: t, className: s, ...r, children: a });
    }),
    d = ({ className: e, classNamePanel: n, label: a, heading: r, headingLevel: s, headingApperance: d, ...c }) => {
     ...
     return (0, l.jsxs)('details', { className: p, ...c, children: [(0, l.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, l.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, l.jsx)('span', { className: 'nl-button__icon-start', children: (0, l.jsx)(t.A, {}) }), (0, l.jsxs)('span', { className: 'nl-button__label', children: [r && (0, l.jsx)(i.D, { level: s, appearance: d, children: r }), a] })] }) }), (0, l.jsx)('div', { className: u, children: c.children })] });
    };
  },
  80731(e, n, a) {
   a.d(n, { H: () => x });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: a }) => {
       const o = 'function' == typeof e ? e() : e,
        ...
        i = h().highlight(r, h().languages[n], n);
       return (0, g.jsxs)('div', { className: (0, t.A)('ma-canvas-astro', a), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }), (0, g.jsx)(v.n, { children: (0, g.jsx)(v.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: i } }) }) }) })] });
      }
