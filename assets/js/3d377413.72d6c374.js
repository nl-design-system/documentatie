 ...
 [10721],
 {
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    u = n(83386),
    l = n(86070);
   const h = { figma: (0, l.jsx)(c.A, {}), github: (0, l.jsx)(o.A, {}), npm: (0, l.jsx)(s.A, {}), storybook: (0, l.jsx)(a.A, {}) },
   ...
   const _ = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, l.jsx)(r.If, { sections: c.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(f, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(b, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            j.Zp,
            {
             ...
             children: (0, l.jsxs)(j.Wu, {
              children: [
               ...
               (s.length > 0 || c.length > 0) && (0, l.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               s.length > 0 &&
                (0, l.jsx)(l.Fragment, {
    ...
    N = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p.p, { level: t, suffix: i && (0, l.jsx)(g.D, { state: i }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  74111: (e, t, n) => {
  ...
  75916: (e, t, n) => {
   'use strict';
   n.d(t, { B2: () => d, B_: () => p, GT: () => f, KF: () => h, Pc: () => s, Pv: () => m, Rc: () => b, bo: () => r, eQ: () => k, f4: () => o, fX: () => i, kD: () => v, mJ: () => y, o_: () => g, qZ: () => c });
