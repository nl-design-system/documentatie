(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [44921],
 {
  ...
  20151: (e, n, t) => {
   'use strict';
   t.r(n), t.d(n, { assets: () => $, component: () => Q, contentTitle: () => I, default: () => ee, description: () => q, frontMatter: () => E, issueNumber: () => Y, metadata: () => U, title: () => K, toc: () => X });
   var r = t(52676),
    i = t(40139),
    o = t(65739),
    s = t(93514);
   ...
   const E = { title: 'Breadcrumb Navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Breadcrumb Navigation', pagination_label: 'Breadcrumb Navigation', description: 'Toont de locatie van de pagina binnen de hi\xebrarchie van een website en biedt de mogelijkheid om tussen niveaus te navigeren.', slug: '/breadcrumb-navigation', keywords: ['back', 'back link', 'breadcrumb navigation', 'breadcrumb trail', 'breadcrumbs', 'broodkruimelpad', 'broodkruimels', 'hi\xebrarchie', 'hierarchy', 'home', 'homepage', 'home', 'kruimelpad', 'links', 'nav', 'navigatie', 'navigeren', 'navigation', 'trail', 'up'] },
    ...
    K = 'Breadcrumb Navigation',
    q = 'Toont de locatie van de pagina binnen de hi\xebrarchie van een website en biedt de mogelijkheid om tussen niveaus te navigeren.',
    Y = 54,
    Q = o.find((e) => e.number === Y);
   function J(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, r.jsx)(V.Rv, { component: Q, headingLevel: 1, description: q }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }),
      '\n',
      (0, r.jsx)(V.cN, { component: Q, headingLevel: 3 }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, r.jsx)(V.W, { component: Q, headingLevel: 3 }),
      '\n',
      ...
      (0, r.jsx)(O.t, {
       ...
       items: [
        { title: 'De linkteksten van de links in het broodkruimelpad zijn voor iedereen duidelijk', sc: '2.4.4', status: '', component: (0, r.jsx)(S.ZP, {}) },
        { title: 'De bezoeker kan het activeren van links in het broodkruimelpad annuleren', sc: '2.5.2', status: '', component: (0, r.jsx)(C, {}) },
        { title: 'De visuele naam van de links in het broodkruimelpad komen voor in de toegankelijke naam van de links in het broodkruimelpad', sc: '2.5.3', status: '', component: (0, r.jsx)(H.ZP, {}) },
        { title: 'Het aanwijsgebied van de links in het broodkruimelpad is groot genoeg', sc: '2.5.8', status: '', component: (0, r.jsx)(G, {}) },
        { title: 'Als het broodkruimelpad tekst in een andere taal dan de hoofdtaal van de pagina bevat, wordt hier een taalwissel voor aangegeven', sc: '3.1.2', status: '', component: (0, r.jsx)(Z.ZP, {}) },
        { title: 'Het gedrag van het broodkruimelpad is voorspelbaar', sc: '3.2.1', status: '', component: (0, r.jsx)(M.ZP, {}) },
        { title: "Als het broodkruimelpad op meerdere pagina's voorkomt, staat het overal op dezelfde plek en de links in het broodkruimelpad staan in dezelfde volgorde", sc: '3.2.3', status: '', component: (0, r.jsx)(R, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(O.t, {
       ...
       items: [
        { title: 'De contrastratio tussen de tekst en de achtergrondkleur in het broodkruimelpad is hoog genoeg', sc: '1.4.3', status: '', component: (0, r.jsx)(u.ZP, {}) },
        { title: 'Het broodkruimelpad bevat niet onnodig afbeeldingen van tekst', sc: '1.4.5', status: '', component: (0, r.jsx)(_.ZP, {}) },
        { title: 'Niet-tekstuele content in het broodkruimelpad heeft een contrastratio van minimaal 3:1 met de achtergrond', sc: '1.4.11', status: '', component: (0, r.jsx)(k, {}) },
        { title: 'Het zichtbaar wanneer links in het broodkruimelpad toetsenbordfocus hebben', sc: '2.4.7', status: '', component: (0, r.jsx)(y.ZP, {}) },
        { title: 'Het aanwijsgebied van de links in het broodkruimelpad is groot genoeg', sc: '2.5.8', status: '', component: (0, r.jsx)(G, {}) },
        { title: 'Het is duidelijk zichtbaar wanneer links in het broodkruimelpad toetsenbordfocus hebben', sc: '2.4.13', status: '', component: (0, r.jsx)(A.ZP, {}) },
        { title: "Als het broodkruimelpad op meerdere pagina's voorkomt, ziet het er hetzelfde uit en werkt het hetzelfde", sc: '3.2.4', status: '', component: (0, r.jsx)(B.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(O.t, {
       ...
       items: [
        { title: 'Als je de tekst vergroot tot 200% blijft deze in zijn geheel zichtbaar', sc: '1.4.4', status: '', component: (0, r.jsx)(m, {}) },
        { title: 'Bij inzoomen gaat er geen informatie of functionaliteit verloren', sc: '1.4.10', status: '', component: (0, r.jsx)(p, {}) },
        { title: 'Als je de tekstafstand vergroot blijft de tekst in zijn geheel zichtbaar', sc: '1.4.12', status: '', component: (0, r.jsx)(v, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(O.t, {
       ...
       items: [
        { title: 'Links in het broodkruimelpad zijn bereikbaar en bedienbaar met het toetsenbord', sc: '2.1.1', status: '', component: (0, r.jsx)(w.ZP, {}) },
        { title: 'Het broodkruimelpad zorgt niet voor een toetsenbordval', sc: '2.1.2', status: '', component: (0, r.jsx)(P.ZP, {}) },
        { title: 'De focus volgorde volgt de hi\xebrarchische structuur van het broodkruimelpad', sc: '2.4.3', status: '', component: (0, r.jsx)(x, {}) },
        { title: 'Het zichtbaar wanneer links in het broodkruimelpad toetsenbordfocus hebben', sc: '2.4.7', status: '', component: (0, r.jsx)(y.ZP, {}) },
        { title: 'De links in het broodkruimelpad worden niet bedekt door andere content', sc: '2.4.11', status: '', component: (0, r.jsx)(F.ZP, {}) },
        { title: 'Het is duidelijk zichtbaar wanneer links in het broodkruimelpad toetsenbordfocus hebben', sc: '2.4.13', status: '', component: (0, r.jsx)(A.ZP, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(O.t, {
       ...
       items: [
        { title: 'Informatieve afbeeldingen hebben een alternatieve tekst en decoratieve tekens en iconen zijn verborgen', sc: '1.1.1', status: '', component: (0, r.jsx)(l, {}) },
        { title: 'Het is duidelijk dat het om een navigatiemenu gaat en de relatie tussen de links in het broodkruimelpad is voor iedereen duidelijk ', sc: '1.3.1', status: '', component: (0, r.jsx)(d, {}) },
        { title: 'De leesvolgorde van tekst en links in het broodkruimelpad is voor iedereen logisch', sc: '1.3.2', status: '', component: (0, r.jsx)(L.ZP, {}) },
        { title: 'Als het broodkruimelpad tekst in een andere taal dan de hoofdtaal van de pagina bevat, wordt hier een taalwissel voor aangegeven', sc: '3.1.2', status: '', component: (0, r.jsx)(Z.ZP, {}) },
        { title: 'Het broodkruimelpad en de links in het broodkruimelpad hebben een toegankelijke naam, rol en status', sc: '4.1.2', status: '', component: (0, r.jsx)(N, {}) },
       ],
      }),
      '\n',
      (0, r.jsx)(n.h2, { id: 'help-component-verbeteren', children: 'Help component verbeteren' }),
      '\n',
      (0, r.jsx)(V.vM, { component: Q, headingLevel: 3 }),
     ],
    });
   }
   function ee(e = {}) {
  ...
  94443: (e, n, t) => {
   ...
   const b = (e) => {
    ...
    v = (e) => {
     ...
     return (0, d.jsxs)('li', { className: (0, i.Z)('task-list-item'), children: [(0, d.jsxs)('div', { className: (0, i.Z)('task-list-item__marker', n && 'task-list-item__marker--checked'), children: [(0, d.jsx)('span', { className: 'task-list-item__marker-label', children: n ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), n && (0, d.jsx)(k.NgG, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, d.jsxs)('div', { children: [(0, d.jsx)(j.X6, { appearance: 'utrecht-heading-3', level: s, children: r }), o, t] })] });
    };
   var w = t(14669);
   const f = (e) => {
     let { component: n, headingLevel: t } = e;
     const o = n && n.projects.filter((e) => w.e9.includes(e.id)),
      s = o && w.e9.map((e) => o.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
       sections: s.map((e) => ({
        className: (0, i.Z)('definition-of-done', e && `definition-of-done--${(0, w.mA)(e.title)}`),
        headingLevel: t,
        expanded: !1,
          ...
          children: [
           (0, d.jsx)(b, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(v, { headingLevel: t + 1, checked: n, title: r, description: (0, w.Q6)(i) }, i);
            }),
           }),
    ...
    x = (e) => {
     let { component: n, headingLevel: t } = e;
     const i = n && n.projects.filter((e) => !w.e9.includes(e.id));
     return n && i.length
      ? (0, d.jsx)(m.um, {
         appearance: 'large',
               ...
               o.length > 0 &&
                (0, d.jsx)(d.Fragment, {
                 children: o.map((e) => {
                  ...
                  return (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(r.X6, { level: t + 2, children: [i, ' in ', n] }), (0, d.jsx)(r.Mc, { children: o.map((e) => (0, d.jsxs)(r.k7, { href: e.value, children: [(0, d.jsx)(h, { brand: e.brand }), ' ', e.description] }, e.id)) })] });
                 }),
                }),
              ],
             }),
    ...
    A = (e) => {
     ...
     const o = n && w.$3[n.relayStep];
     return n && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(p.V, { level: t, suffix: o && (0, d.jsx)(g.y, { state: o }), children: n.title }), (0, d.jsx)(r.nv, { lead: !0, children: i })] });
    };
  },
  23355: (e, n, t) => {
   'use strict';
  ...
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, BA: () => a, Q6: () => o, U: () => c, e9: () => s, mA: () => i, ps: () => d });
   const r = { UNKNOWN: 'Todo', HELP_WANTED: 'Help Wanted', COMMUNITY: 'Community', CANDIDATE: 'Candidate', HALL_OF_FAME: 'Hall of fame' },
    ...
    c = (e) => Array.from(new Set(e.projects.flatMap((e) => l(e)))),
    d = (e) => {
     const n = l(e),
      t = ((e) => {
       const n = e.tasks.find((e) => {
