 ...
 [56175],
 {
   ...
   const d = (0, s.createContext)({}),
    p = ({ title: e, appearance: n, description: r, children: s, figure: p }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      h = p ? 'figure' : 'div',
      m = p ? 'figcaption' : 'div',
      v = 'string' == typeof r ? (0, c.jsx)(a.oz, { components: { a: t.N_ }, children: r }) : r;
  ...
  70348(e, n, r) {
   ...
   var o = r(13526),
    ...
    i = r(37168),
    a = r(86070);
   const s = (0, l.forwardRef)(({ as: e, className: n, children: r, ...l }, t) => {
     const i = e || 'div',
      s = (0, o.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, a.jsx)(i, { ref: t, className: s, ...l, children: r });
    }),
    c = ({ className: e, classNamePanel: n, label: r, heading: l, headingLevel: s, headingApperance: c, ...d }) => {
     const p = (0, o.A)('utrecht-accordion__section', e),
      u = (0, o.A)('utrecht-accordion__panel', n);
     return (0, a.jsxs)('details', { className: p, ...d, children: [(0, a.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, a.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, a.jsx)('span', { className: 'nl-button__icon-start', children: (0, a.jsx)(t.A, {}) }), (0, a.jsxs)('span', { className: 'nl-button__label', children: [l && (0, a.jsx)(i.D, { level: s, appearance: c, children: l }), r] })] }) }), (0, a.jsx)('div', { className: u, children: d.children })] });
    };
  },
  80731(e, n, r) {
   r.d(n, { H: () => k });
