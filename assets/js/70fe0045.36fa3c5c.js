/*! For license information please see 70fe0045.36fa3c5c.js.LICENSE.txt */
'use strict';
 ...
 [95840],
 {
  ...
  39514(e, n, a) {
   ...
   const o = { title: 'Text Area', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Text Area', pagination_label: 'Text Area', description: 'Invoerveld voor het bewerken van meerdere regels tekst.', issue_number: 40, slug: '/text-area', keywords: ['form', 'form control', 'formulier', 'formulierelement', 'input field', 'invoer', 'invoerveld', 'multiline textfield', 'tekstbox', 'tekstgebied', 'tekstinvoer', 'tekstveld', 'text area', 'textarea', 'textarea autosize'] },
    ...
    g = {},
    u = 'Text Area',
    c = 'Invoerveld voor het bewerken van meerdere regels tekst.',
    m = 40,
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => r, KF: () => c, mJ: () => p, VZ: () => N, cR: () => w, Pv: () => f, qZ: () => l, kD: () => k, QQ: () => D, B2: () => m, Pc: () => o, f4: () => s, GT: () => j, fX: () => i, eQ: () => b, B_: () => v, o_: () => x });
