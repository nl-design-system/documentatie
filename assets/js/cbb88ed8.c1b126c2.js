...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  12288(e, n, l) {
   (l.r(n), l.d(n, { assets: () => v, contentTitle: () => g, default: () => k, frontMatter: () => b, metadata: () => o, toc: () => j }));
   ...
   var t = l(86070),
    ...
    i = l(15638);
   function c(e) {
    const n = { div: 'div', h2: 'h2', input: 'input', label: 'label', ...(0, a.R)(), ...e.components };
    return (0, t.jsxs)(t.Fragment, { children: ['\n', '\n', (0, t.jsx)(n.h2, { id: 'voorbeelden', children: 'Voorbeelden' }), '\n', (0, t.jsx)(i.$, { appearance: 'do', title: 'Het zichtbare label is de toegankelijke naam.', children: (0, t.jsx)(s.H, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.label, { htmlFor: 'hond', children: 'Hoe heet je hond' }), (0, t.jsx)(n.input, { type: 'text', id: 'hond', name: 'hond' })] }) }) }), '\n', (0, t.jsx)(i.$, { appearance: 'dont', title: 'Alleen een placeholder gebruiken om te laten zien wat de gebruiker moet invullen,', description: 'terwijl de onzichtbare toegankelijke naam een hele andere inhoud heeft.', children: (0, t.jsx)(s.H, { language: 'html', children: () => (0, t.jsx)(n.input, { type: 'text', name: 'lievelingskleur', 'aria-label': 'Vul een kleur in', placeholder: 'Wat is je lievelingskleur' }) }) }), '\n', (0, t.jsx)(i.$, { appearance: 'dont', title: 'Alleen losse tekst gebruiken om te laten zien wat de gebruiker moet invullen,', description: 'terwijl de onzichtbare toegankelijke naam een hele andere inhoud heeft.', children: (0, t.jsx)(s.H, { language: 'html', children: () => (0, t.jsxs)(t.Fragment, { children: [(0, t.jsx)(n.div, { children: 'Zoek' }), (0, t.jsx)(n.input, { type: 'search', name: 'trefwoord', 'aria-label': 'Trefwoord' })] }) }) })] });
   }
   function d(e = {}) {
   ...
   const b = { title: 'De zichtbare naam moet overeenkomen met de toegankelijke naam \xb7 Labels in een formulier \xb7 Richtlijnen', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Zichtbare naam label', pagination_label: 'Zichtbare naam label', description: 'Richtlijnen voor zichtbare naam gelijk maken aan toegankelijke naam van formuliervelden.', slug: '/richtlijnen/formulieren/labels/zichtbare-naam', keywords: ['labels', 'formulier', 'design', 'code'] },
    g = void 0,
    v = {},
  ...
  58639(e, n, l) {
   ...
   const v = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: v = !0, children: j, container: y = 'document', language: k, designTokens: x }) => {
    ...
    return (
     ...
     (0, h.jsxs)('div', {
      ...
      children: [
       f && (0, h.jsx)('div', { className: (0, a.A)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, h.jsx)(S, { children: (0, h.jsx)(t.v$, { children: f }) }) }) }),
       v &&
        (0, h.jsx)('div', {
       ...
       v &&
        (0, h.jsxs)('div', {
         ...
         hidden: !A,
         children: [
          (0, h.jsx)(o.M, { codeBlockLabel: 'Codevoorbeeld', syntax: k, textContent: w, trim: !0 }),
          n &&
           (0, h.jsx)('div', {
  ...
  69284(e, n, l) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: l, trim: c }) {
    ...
    const { title: m, type: u } = (0, a.useContext)(r.x),
     h = (0, a.useId)();
    return (c && (d = d.trim()), (0, i.jsx)(t.f4, { theme: s, code: d, language: n || '', children: ({ style: n, tokens: l, getLineProps: t, getTokenProps: a }) => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', m ? ': ' : ' ', m] }), (0, i.jsx)(o.NG, { tabIndex: 0, role: m ? 'region' : void 0, 'aria-labelledby': h, style: n, children: l.map((n, l) => (0, i.jsxs)('span', { ...t({ line: n }), children: [e && (0, i.jsx)('span', { children: l + 1 }), n.map((e, n) => (0, i.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, l)) })] }) }));
   }
  },
  78734(e, n, l) {
   l.d(n, { Ay: () => s, RM: () => a });
