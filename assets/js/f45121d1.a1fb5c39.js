...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [65361],
 {
  ...
  53283(e, n, i) {
   (i.r(n), i.d(n, { assets: () => j, contentTitle: () => f, default: () => w, frontMatter: () => u, metadata: () => r, toc: () => m }));
   const r = JSON.parse('{"id":"wcag/2.3.01","title":"WCAG-succescriterium 2.3.1 Drie flitsen of beneden drempelwaarde","description":"Maximaal drie flitsen in een seconde.","source":"@site/docs/wcag/2.3.01.mdx","sourceDirName":"wcag","slug":"/wcag/2.3.1","permalink":"/wcag/2.3.1","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/2.3.01.mdx","tags":[],"version":"current","frontMatter":{"title":"WCAG-succescriterium 2.3.1 Drie flitsen of beneden drempelwaarde","title_sm":"2.3.1 Drie flitsen of beneden drempelwaarde","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"2.3.1 Drie flitsen of beneden drempelwaarde","pagination_label":"WCAG-succescriterium 2.3.1 Drie flitsen of beneden drempelwaarde","description":"Maximaal drie flitsen in een seconde.","slug":"2.3.1","conformance_level":"Niveau A","keywords":["WCAG","A","bedienbaar","toevallen en fysieke reacties","operable","seizures and physical reactions","three flashes or below threshold","non-interferentie"]},"sidebar":"richtlijnen","previous":{"title":"WCAG-succescriterium 2.2.6 Time-outs","permalink":"/wcag/2.2.6"},"next":{"title":"WCAG-succescriterium 2.3.2 Drie flitsen","permalink":"/wcag/2.3.2"}}');
   var s = i(86070),
    t = i(18439),
    l = i(24703),
    o = i(61473),
   ...
   const u = { title: 'WCAG-succescriterium 2.3.1 Drie flitsen of beneden drempelwaarde', title_sm: '2.3.1 Drie flitsen of beneden drempelwaarde', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '2.3.1 Drie flitsen of beneden drempelwaarde', pagination_label: 'WCAG-succescriterium 2.3.1 Drie flitsen of beneden drempelwaarde', description: 'Maximaal drie flitsen in een seconde.', slug: '2.3.1', conformance_level: 'Niveau A', keywords: ['WCAG', 'A', 'bedienbaar', 'toevallen en fysieke reacties', 'operable', 'seizures and physical reactions', 'three flashes or below threshold', 'non-interferentie'] },
    f = void 0,
    j = {},
  ...
  61473(e, n, i) {
   ...
   var r = i(46447),
    s = i(46276),
    t = i(86070);
   const l = ({ children: e, conformanceLevel: n, ...i }) => (globalThis.isAstro ? null : (0, t.jsx)(s.p, { className: 'nlds-inline-heading-group--wcag-heading-group', suffix: n && (0, t.jsx)(r.KE, { className: 'nlds-inline-heading-group__badge', children: n }), ...i, children: e }));
  },
  66117(e, n, i) {
   i.d(n, { Ay: () => o, RM: () => t });
   var r = i(86070),
  ...
  66119(e, n, i) {
   ...
   function s(e) {
    ...
    if ('string' == typeof e || 'number' == typeof e) r += e;
     ...
     if (Array.isArray(e)) {
      var t = e.length;
      for (n = 0; n < t; n++) e[n] && (i = s(e[n])) && (r && (r += ' '), (r += i));
     } else for (i in e) e[i] && (r && (r += ' '), (r += i));
    return r;
   }
   function t() {
    for (var e, n, i = 0, r = '', t = arguments.length; i < t; i++) (e = arguments[i]) && (n = s(e)) && (r && (r += ' '), (r += n));
    return r;
   }
   const l = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: s, ...l }, o) => {
    const a = { ...l, ref: o, className: t('utrecht-note', { [`utrecht-note--${s}`]: s }, i) };
