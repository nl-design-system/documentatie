 ...
 [34799],
 {
  ...
  17889(e, t, n) {
   ...
   var m = n(35193),
    ...
    A = n(79532),
    b = n(30758);
   const x = { color: m.A, dimension: j.A, fontFamilies: w.A, fontSizes: y.A, fontWeights: f.A, lineHeights: k.A, other: v.A, textDecoration: A.A },
    T = ({ type: e }) => (0, p.jsx)(u.In, { children: (0, b.createElement)(x[e]) });
   function C({ tokens: e }) {
    const t = (0, i.kD)(e),
     n = (0, i.GT)(t),
       ...
       children: [
        ...
        (0, p.jsx)(o.BF, {
         children: n.map((t) => {
          const n = (0, i.o_)(t),
           a = (0, i.eQ)(e, t).$type;
          return (0, p.jsxs)(o.Hj, { children: [(0, p.jsx)(o.nA, { children: (0, p.jsx)(r.C, { children: (0, p.jsx)(o.kf, { children: n }) }) }), (0, p.jsx)(o.nA, { children: (0, p.jsxs)(s.K, { children: [(0, p.jsx)(T, { type: a }), ' ', a] }) })] }, n);
         }),
        }),
       ],
      }),
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => u, mJ: () => m, VZ: () => x, cR: () => b, Pv: () => j, qZ: () => o, kD: () => k, B2: () => p, Pc: () => c, f4: () => a, GT: () => v, fX: () => i, eQ: () => f, B_: () => y, o_: () => w, Rc: () => A });
  ...
  45282(e, t, n) {
   ...
   const i = ({ children: e, ...t }) => {
     const { to: n, href: r, ...i } = t;
     let o = n || r;
     const a = new URL(o, 'https://nldesignsystem.nl');
     return ('https://nldesignsystem.nl' === a.origin ? ((a.pathname = a.pathname.endsWith('/') ? a.pathname : `${a.pathname}/`), (o = a.toString().replace('https://nldesignsystem.nl', ''))) : ((i.target = '_blank'), (i.rel = 'noopener noreferrer')), (0, s.jsx)('a', { href: o, ...i, children: e }));
    },
    o = ({ className: e, ...t }) => (0, s.jsx)(i, { className: (0, r.$)('utrecht-link', 'utrecht-link--html-a', e), ...t });
  },
  46072(e, t, n) {
   'use strict';
   n.d(t, { NO: () => i, pI: () => o });
  ...
  80840(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => W, component: () => L, contentTitle: () => N, default: () => M, description: () => S, frontMatter: () => z, issueNumber: () => D, metadata: () => r, title: () => _, toc: () => P }));
   ...
   function d(e) {
    ...
    return (0, s.jsxs)(t.p, { children: ['Zorg dat een alinea in een paragraaf-element staat. Gebruik geen ', (0, s.jsx)(t.code, { children: '<div>' }), ' of ', (0, s.jsx)(t.code, { children: '<span>' }), ' voor op zichzelf staande teksten.\nZelfs als geen CSS geladen kan worden, blijft de tekst dan duidelijk weergegeven.'] });
   }
   function h(e = {}) {
   ...
   function C(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsx)(t.header, { children: (0, s.jsx)(t.h1, { id: 'gebruik-paragraph', children: 'Gebruik Paragraph' }) }), '\n', (0, s.jsx)(t.h2, { id: 'css', children: 'CSS' }), '\n', (0, s.jsx)(t.p, { children: 'De CSS van deze component is gepubliceerd in een npm package:' }), '\n', (0, s.jsx)(t.p, { children: (0, s.jsx)(t.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/paragraph-css', children: '@nl-design-system-candidate/paragraph-css' }) }), '\n', (0, s.jsxs)(t.p, { children: ['Gebruik de ', (0, s.jsx)(t.code, { children: 'nl-paragraph' }), ' class name op een ', (0, s.jsx)(t.code, { children: 'p' }), ' element:'] }), '\n', (0, s.jsx)(t.pre, { children: (0, s.jsx)(t.code, { className: 'language-html', children: '<p class="nl-paragraph">Op brute w\u0133ze ving de schooljuf de quasi-kalme lynx.</p>\n' }) }), '\n', (0, s.jsxs)(t.p, { children: ['Voor de Lead Paragraph gebruik je de extra class name ', (0, s.jsx)(t.code, { children: 'nl-paragraph--lead' }), ':'] }), '\n', (0, s.jsx)(t.pre, { children: (0, s.jsx)(t.code, { className: 'language-html', children: '<p class="nl-paragraph nl-paragraph--lead">\n  Op brute w\u0133ze ving de schooljuf de quasi-kalme lynx. Je gelooft nooit wat er toen gebeurde!\n</p>\n' }) }), '\n', (0, s.jsx)(t.p, { children: 'Je kunt de CSS zo in je project installeren:' }), '\n', (0, s.jsx)(t.pre, { children: (0, s.jsx)(t.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/paragraph-css\n' }) }), '\n', (0, s.jsx)(t.p, { children: 'Als je een CDN gebruikt, dan kun je de CSS zo importeren:' }), '\n', (0, s.jsx)(t.pre, { children: (0, s.jsx)(t.code, { className: 'language-html', children: '<link\n  rel="stylesheet"\n  href="https://cdn.jsdelivr.net/npm/@nl-design-system-candidate/paragraph-css@2/dist/paragraph.css"\n/>\n' }) }), '\n', (0, s.jsxs)(t.p, { children: ['Gebruik je geen CDN, dan kun je de CSS uit ', (0, s.jsx)(t.code, { children: 'node_modules/' }), ' importeren:'] }), '\n', (0, s.jsx)(t.pre, { children: (0, s.jsx)(t.code, { className: 'language-html', children: '<link rel="stylesheet" href="node_modules/@nl-design-system-candidate/paragraph-css/dist/paragraph.css" />\n' }) }), '\n', (0, s.jsx)(t.p, { children: 'Als je CSS imports gebruikt vanuit JavaScript:' }), '\n', (0, s.jsx)(t.pre, { children: (0, s.jsx)(t.code, { className: 'language-js', children: 'import "@nl-design-system-candidate/paragraph-css/paragraph.css";\n' }) }), '\n', (0, s.jsx)(t.h2, { id: 'react', children: 'React' }), '\n', (0, s.jsx)(t.p, { children: 'De React component is gepubliceerd in een npm package:' }), '\n', (0, s.jsx)(t.p, { children: (0, s.jsx)(t.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/paragraph-react', children: '@nl-design-system-candidate/paragraph-react' }) }), '\n', (0, s.jsx)(t.p, { children: 'Je kunt de npm package zo installeren:' }), '\n', (0, s.jsx)(t.pre, { children: (0, s.jsx)(t.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/paragraph-react\n' }) }), '\n', (0, s.jsx)(t.p, { children: 'Je kunt de React component zo gebruiken:' }), '\n', (0, s.jsx)(t.pre, { children: (0, s.jsx)(t.code, { className: 'language-jsx', children: 'import { Paragraph } from "@nl-design-system-candidate/paragraph-react";\n\nexport const MyPage = () => {\n  return (\n    <html>\n      <body>\n        <Paragraph>Op brute w\u0133ze ving de schooljuf de quasi-kalme lynx.</Paragraph>\n      </body>\n    </html>\n  );\n};\n' }) }), '\n', (0, s.jsx)(t.p, { children: 'De Lead Paragraph werkt zo:' }), '\n', (0, s.jsx)(t.p, { children: 'Je kunt de React component zo gebruiken:' }), '\n', (0, s.jsx)(t.pre, { children: (0, s.jsx)(t.code, { className: 'language-jsx', children: '<Paragraph purpose="lead">Op brute w\u0133ze ving de schooljuf de quasi-kalme lynx.</Paragraph>\n' }) })] });
   }
   function R(e = {}) {
    const { wrapper: t } = { ...(0, i.R)(), ...e.components };
   ...
   function F(e) {
    ...
    return (0, s.jsxs)(s.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, s.jsx)(b.Fc, { component: L, headingLevel: 1, description: S }),
      '\n',
      (0, s.jsx)(v.e, { component: L }),
      '\n',
      (0, s.jsx)(w.Zp, { className: 'implementation-card', children: (0, s.jsxs)(w.Wu, { children: [(0, s.jsx)(f.D, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, s.jsxs)(y.dk, { children: [(0, s.jsxs)(y.N_, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=150-734', children: [(0, s.jsx)(k.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, s.jsxs)(y.N_, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=150-734', children: [(0, s.jsx)(k.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, s.jsx)(f.D, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, s.jsxs)(y.dk, { children: [(0, s.jsxs)(y.N_, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-paragraph--documentatie', children: [(0, s.jsx)(k.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, s.jsxs)(y.N_, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/paragraph--documentatie', children: [(0, s.jsx)(k.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, s.jsx)(f.D, { level: 2, appearance: 'level-4', children: 'npm' }), (0, s.jsxs)(y.dk, { children: [(0, s.jsxs)(y.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/paragraph-css', children: [(0, s.jsx)(k.r, { brand: 'npm' }), ' @nl-design-system-candidate/paragraph-css'] }), (0, s.jsxs)(y.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/paragraph-react', children: [(0, s.jsx)(k.r, { brand: 'npm' }), ' @nl-design-system-candidate/paragraph-react'] }), (0, s.jsxs)(y.N_, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/paragraph-tokens', children: [(0, s.jsx)(k.r, { brand: 'npm' }), ' @nl-design-system-candidate/paragraph-tokens'] })] })] }) }),
      '\n',
      ...
      (0, s.jsx)(A.b, {
       headingLevel: '4',
       items: [
        { title: 'De contrastverhouding van de tekstkleur van de paragraaf met de achtergrondkleur is hoog genoeg.', sc: '1.4.3', status: '', component: (0, s.jsx)(g.Ay, {}), tags: ['designer', 'contentmaker'] },
        { title: 'Als een paragraaftekst in een andere taal is dan de taal van de pagina, dan heeft het element een lang-attribuut met de juiste taalcode.', sc: '3.1.2', status: '', component: (0, s.jsx)(j.Ay, {}), tags: ['developer', 'contentmaker'] },
      ...
      (0, s.jsx)(A.b, {
       ...
       items: [
        ...
        { title: 'Als je de paragraaftekst vergroot tot 200% blijft deze in zijn geheel zichtbaar.', sc: '1.4.4', status: '', component: (0, s.jsx)(m.Ay, {}), tags: ['developer'] },
      ...
      '\n',
      (0, s.jsx)(T.o, { omitH1: !0, headingLevel: 2, children: (0, s.jsx)(R, {}) }),
      '\n',
      ...
      '\n',
      (0, s.jsx)(b.VK, { component: L, headingLevel: 3 }),
      '\n',
      (0, s.jsx)(b.$9, { component: L, headingLevel: 2 }),
      '\n',
      (0, s.jsx)(t.h2, { id: 'community-implementaties', children: 'Community implementaties' }),
      '\n',
      (0, s.jsx)(b.mu, { component: L, headingLevel: 3 }),
     ],
    });
   }
   function M(e = {}) {
  ...
  85825(e, t, n) {
   ...
   const m = ({ children: e }) => (0, l.jsx)('ul', { className: 'task-list', children: e }),
    j = ({ checked: e, children: t, title: n, description: r, headingLevel: i = 3 }) => (0, l.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, l.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, l.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, l.jsx)(g.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, l.jsxs)('div', { children: [n ? (0, l.jsx)(p.DZ, { appearance: 'utrecht-heading-3', level: i, children: n }) : null, r, t] })] });
   var w = n(33062);
   const y = ({ component: e, headingLevel: t }) => {
     const n = e && e.projects.filter((e) => w.f4.includes(e.id)),
      i = n && w.f4.map((e) => n.find((t) => t.id === e)).filter(Boolean);
     return e && (0, l.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, w.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(m, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, l.jsx)(j, { headingLevel: t + 1, checked: e, title: n, description: (0, w.qZ)(r) }, r)) }), (0, l.jsx)(r.fz, { children: (0, l.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            o.Zp,
            {
             ...
             children: (0, l.jsxs)(o.Wu, {
              children: [
               ...
               (h.length > 0 || a.length > 0) && (0, l.jsx)(r.DZ, { level: t + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, l.jsx)(l.Fragment, {
                 children: (0, l.jsx)(r.dk, {
                  links: h
                   ...
                   .map((e) => {
                    ...
                    return { children: t.desciption, icon: (0, l.jsx)(i.r, { brand: t.brand }), href: e.value };
                   }),
                 }),
                }),
               a.length > 0 && (0, l.jsx)(l.Fragment, { children: a.map(({ frameworkName: e, tasks: n }) => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsxs)(r.DZ, { level: t + 2, children: [s, ' in ', e] }), (0, l.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, l.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    v = ({ component: e, headingLevel: t, description: n }) => {
     const s = e && w.bo[e.relayStep];
     return e && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(u.p, { level: t, suffix: s && (0, l.jsx)(h.D, { state: s }), children: e.title }), (0, l.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  90495(e, t, n) {
   'use strict';
