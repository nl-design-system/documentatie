/*! For license information please see 4d3e1a9b.99067bd8.js.LICENSE.txt */
'use strict';
 ...
 [4104],
 {
  ...
  30077(e, n, a) {
   ...
   const o = { title: 'Date Picker', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Date Picker', pagination_label: 'Date Picker', description: 'Invoerveld om een beschikbare datum te kiezen via een op maat gemaakte kalender.', issue_number: 35, slug: '/date-picker', keywords: ['calendar', 'custom', 'date', 'datepicker', 'date field', 'date input', 'date picker', 'date selection', 'daterange', 'date range picker', 'datetime picker', 'datum kiezer', 'datum invoer', 'datumveld', 'form', 'formulier', 'formulierelement', 'kalender', 'input field', 'month picker', 'scrollable calendar', 'text field', 'time picker'] },
    ...
    g = {},
    c = 'Date Picker',
    u = 'Invoerveld om een beschikbare datum te kiezen via een op maat gemaakte kalender.',
    m = 35,
    h = 'help wanted',
    p = 'date-picker',
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => r, KF: () => u, mJ: () => p, VZ: () => w, cR: () => N, Pv: () => f, qZ: () => l, kD: () => k, QQ: () => D, B2: () => m, Pc: () => o, f4: () => s, GT: () => j, fX: () => i, eQ: () => v, B_: () => b, o_: () => x });
  ...
  50172(e, n, a) {
   ...
   const c = ({ level: e = 2, children: n, ...a }) => {
    ...
    u = (0, o.forwardRef)(({ heading: e, headingLevel: n = 2, subheading: a, description: r, metadata: i, image: l, href: o, target: d, linkLabel: u, title: m, className: h, children: p, ...f }, x) => (0, t.jsxs)('div', { className: g('rhc-card', 'rhc-card--default', h), ref: x, ...f, children: [l && (0, t.jsx)('div', { className: 'rhc-card__image', children: l }), (0, t.jsxs)('div', { className: 'rhc-card__content', children: [(0, t.jsx)(c, { className: 'rhc-card__heading', level: n, children: o ? (0, t.jsx)(s, { className: 'rhc-card__link', href: o, target: d, title: m, children: e }) : e }), a && (0, t.jsx)('p', { className: 'rhc-card__subheading', children: a }), r && (0, t.jsx)('p', { className: 'rhc-card__description', children: r }), i && (0, t.jsx)('p', { className: 'rhc-card__metadata', children: i }), p] }), u && (0, t.jsx)('div', { className: 'rhc-card__footer', children: (0, t.jsx)('div', { className: 'rhc-card__link', 'data-testid': 'rhc-card__link', children: (0, t.jsx)(s, { href: o, target: d, title: m, children: u }) }) })] }));
   u.displayName = 'Card';
  },
  59292(e, n, a) {
   a.d(n, { f: () => t.f });
  ...
  63009(e, n, a) {
   ...
   var c = (0, s.forwardRef)(function (e, n) {
    var a = e.children,
     ...
     m = e.inlineBox,
     h = (0, r.A)(e, o);
    return (0, i.jsx)('a', g(g({ 'aria-current': d || void 0, 'aria-disabled': c, className: (0, l.$)('nl-link', (0, t.A)((0, t.A)((0, t.A)({}, 'nl-link--current', d), 'nl-link--disabled', c), 'nl-link--inline-box', m), s), href: c ? void 0 : u, role: c ? 'link' : void 0, ref: n, tabIndex: c ? 0 : void 0 }, h), {}, { children: a }));
   });
   c.displayName = 'Link';
  },
  70348(e, n, a) {
   ...
   const o = (0, r.forwardRef)(({ as: e, className: n, children: a, ...r }, i) => {
    ...
    d = ({ className: e, classNamePanel: n, label: a, heading: r, headingLevel: o, headingApperance: d, ...g }) => {
     ...
     return (0, s.jsxs)('details', { className: c, ...g, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(i.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(l.D, { level: o, appearance: d, children: r }), a] })] }) }), (0, s.jsx)('div', { className: u, children: g.children })] });
    };
  },
  74172(e, n, a) {
   a.d(n, { A: () => l });
               ...
               d.Z,
               {
                ...
                description: (0, g.jsxs)('div', {
                 ...
                 children: [
                  ...
                  u.length > 0 && u.map(({ frameworkName: e, tasks: a }) => (0, g.jsxs)('section', { children: [(0, g.jsxs)(r.DZ, { level: Math.min(n + 2, 6), children: [l, ' in ', e] }), (0, g.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, g.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               o.Zp,
               {
                ...
                children: (0, g.jsxs)(o.Wu, {
                 children: [
                  ...
                  u.length > 0 && (0, g.jsx)(g.Fragment, { children: u.map(({ frameworkName: e, tasks: a }) => (0, g.jsxs)(g.Fragment, { children: [(0, g.jsxs)(t.DZ, { level: n + 2, children: [l, ' in ', e] }), (0, g.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, g.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
