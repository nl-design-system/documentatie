 ...
 [79048],
 {
  46565(e, t, n) {
   ...
   var a = n(30758),
    ...
    d = n(12647),
    u = n(74081);
   const m = 'backToTopButton_zFGH',
    b = 'backToTopButtonShow_tXI4';
   var h = n(86070);
   function p() {
   ...
   const A = 'collapseSidebarButton_MXOj',
    C = 'collapseSidebarButtonIcon_I3_5';
   ...
   var w = n(34891),
    ...
    M = n(37591),
    H = n(673);
   const P = 'menuExternalLink_w1Km',
    G = 'linkLabel_VvnX';
   function R({ label: e }) {
    return (0, h.jsx)('span', { title: e, className: G, children: e });
   }
   function D({ item: e, onItemClick: t, activePath: n, level: a, index: s, ...r }) {
   ...
   const W = 'categoryLink_RdBQ',
    F = 'categoryLinkLabel_bWKB';
   function V({ collapsed: e, categoryLabel: t, onClick: n }) {
   ...
   function X({ item: e, onItemClick: t, activePath: n, level: s, index: r, ...c }) {
    const { items: d, label: u, collapsible: m, className: b, href: p } = e,
     ...
     j = (0, l.w8)(e, n),
     g = (0, L.ys)(p, n),
     { collapsed: v, setCollapsed: A } = (0, w.u)({ initialState: () => !!m && !j && e.collapsed }),
     { expandedItem: C, setExpandedItem: k } = (function () {
      const e = (0, a.useContext)(T);
      if (e === I) throw new N.dV('DocSidebarItemsExpandedStateProvider');
      return e;
     })(),
     S = (e = !v) => {
      (k(e ? null : r), A(e));
    ...
    return (0, h.jsxs)('li', {
     ...
     children: [
      (0, h.jsxs)('div', {
       ...
       children: [
        (0, h.jsx)(E.A, {
         className: (0, i.A)(W, 'menu__link', { 'menu__link--sublist': m, 'menu__link--sublist-caret': !p && m, 'menu__link--active': j }),
         onClick: (n) => {
   ...
   const K = 'menuHtmlItem_TlHo';
   function J({ item: e, level: t, index: n }) {
    const { value: a, defaultStyle: s, className: l } = e;
    return (0, h.jsx)('li', { className: (0, i.A)(o.G.docs.docSidebarItemLink, o.G.docs.docSidebarItemLinkLevel(t), s && [K, 'menu__list-item'], l), dangerouslySetInnerHTML: { __html: a } }, n);
   }
   function O({ item: e, ...t }) {
    switch (e.type) {
     case 'category':
   ...
   function Z({ items: e, ...t }) {
    ...
    return (0, h.jsx)(y, { children: n.map((e, n) => (0, h.jsx)(O, { item: e, index: n, ...t }, n)) });
   }
   const q = (0, a.memo)(Z),
    Q = 'menu_xGch',
    $ = 'menuWithAnnouncementBar_IeNe';
   function ee({ path: e, sidebar: t, className: n }) {
    ...
    return (0, h.jsx)('nav', { 'aria-label': (0, c.T)({ id: 'theme.docs.sidebar.navAriaLabel', message: 'Docs sidebar', description: 'The ARIA label for the sidebar navigation' }), className: (0, i.A)('menu thin-scrollbar', Q, s && $, n), children: (0, h.jsx)('ul', { className: (0, i.A)(o.G.docs.docSidebarMenu, 'menu__list'), children: (0, h.jsx)(q, { items: t, activePath: e, level: 1 }) }) });
   }
   const te = 'sidebar_dEeK',
    ne = 'sidebarWithHideableNavbar_cJA5',
    ae = 'sidebarHidden_xQoA',
    ie = 'sidebarLogo_Rk6I';
   ...
   const be = 'expandButton_aEFR',
    he = 'expandButtonIcon_ZbAV';
   ...
   const xe = { docSidebarContainer: 'docSidebarContainer_YBpk', docSidebarContainerHidden: 'docSidebarContainerHidden_aovi', sidebarViewport: 'sidebarViewport_ams0' };
   ...
   const _e = { docMainContainer: 'docMainContainer_PeWh', docMainContainerEnhanced: 'docMainContainerEnhanced_Pfrt', docItemWrapperEnhanced: 'docItemWrapperEnhanced_PsDC' };
   ...
   const ve = 'docRoot_UJkX',
    Ae = 'docsWrapper_S_Jp';
   function Ce({ children: e }) {
    const t = (0, r.t)(),
     [n, i] = (0, a.useState)(!1);
    return (0, h.jsxs)('div', { className: Ae, children: [(0, h.jsx)(p, {}), (0, h.jsxs)('div', { className: ve, children: [t && (0, h.jsx)(je, { sidebar: t.items, hiddenSidebarContainer: n, setHiddenSidebarContainer: i }), (0, h.jsx)(ge, { hiddenSidebarContainer: n, children: e })] })] });
   }
   var ke = n(74079);
   function Se(e) {
    const t = (0, l.B5)(e);
