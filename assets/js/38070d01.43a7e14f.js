/*! For license information please see 38070d01.43a7e14f.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [13432],
 {
   ...
   var r = a.forwardRef(function (e, n) {
    ...
    return (
     ...
     a.createElement(
      a.Fragment,
      null,
      a.createElement('link', { rel: T, href: z, as: 'image' }),
      ...
      a.createElement(
       A,
       {
        ...
        className: ''.concat(R, ' ').concat(d ? C : ''),
        'data-title': p,
        style: i(i({ backgroundImage: 'url('.concat(z, ')') }, { '--aspect-ratio': ''.concat((E / _) * 100, '%') }), G),
       },
       a.createElement('button', { type: 'button', className: I, 'aria-label': ''.concat(g, ' ').concat(p) }),
       d && a.createElement('iframe', { ref: n, className: D, title: p, width: '560', height: '315', frameBorder: '0', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: v }),
      ),
     )
    );
   });
  ...
  99060: (e, n, t) => {
   ...
   var a = t(87423),
    i = t(86070);
   const l = ({ id: e, title: n, ...t }) => (0, i.jsx)(a.A, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: n, poster: 'maxresdefault', ...t });
  },
 },
]);
