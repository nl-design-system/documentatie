 ...
 [16267],
 {
  ...
  95857(e, n, i) {
   ...
   const s = (0, i(30758).forwardRef)(({ aside: e, children: n, className: i, purpose: t, ...s }, a) => {
    const d = { ...s, ref: a, className: o('utrecht-note', { [`utrecht-note--${t}`]: t }, i) };
    return e ? (0, r.jsx)('aside', { ...d, children: n }) : (0, r.jsx)('section', { role: 'note', ...d, children: n });
   });
   s.displayName = 'Note';
   var a = i(29181);
   const d = globalThis.isAstro ? s : a.K7;
  },
 },
]);
