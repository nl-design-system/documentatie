...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [10709],
 {
  ...
  57229: (e, n, r) => {
   ...
   const o = (e) => {
    let { className: n, ...r } = e;
    return (0, l.jsx)(i.Z, { className: (0, t.W)('utrecht-link', 'utrecht-link--html-a', n), ...r });
   };
  },
  21004: (e, n, r) => {
   r.d(n, { l: () => c });
   ...
   const s = (e, n) => e.reduce((e, r) => ('link' === r.type ? (n.includes(r.docId) ? e : [...e, r]) : 'category' === r.type ? [...e, { ...r, items: s(r.items, n) }] : e), []),
    c = (e) => {
     ...
     const a = (0, i.jA)();
     return (0, o.jsx)('div', { ...c, className: (0, t.Z)('margin-top--lg', r), children: (0, o.jsx)(l.Z, { items: s(a.items, n) }) });
    };
  },
  39772: (e, n, r) => {
   r.d(n, { Z: () => j });
   var i = r(17542),
    ...
    s = r(52676);
   function c(e) {
    let { href: n, icon: r = '', title: i, description: l, children: c } = e;
    return (0, s.jsxs)('div', { className: 'card', children: [n ? (0, s.jsx)(t.r, { href: n, className: (0, o.Z)('cardLink', 'utrecht-link'), children: (0, s.jsxs)('h2', { className: 'cardTitle', children: [r, ' ', i] }) }) : (0, s.jsxs)('h2', { className: 'cardTitle', children: [r, ' ', i] }), l && (0, s.jsx)('p', { className: 'cardDescription', children: l }), c] });
   }
   function a(e) {
    let { item: n } = e;
    return (0, s.jsx)(c, { title: n.label, description: n.description, children: (0, s.jsx)(l.QI, { children: n.items.filter((e) => 'link' === e.type || 'category' === e.type).map((e, n) => (0, s.jsx)(l.AS, { children: 'link' === e.type ? (0, s.jsx)(t.r, { to: e.href, children: e.label }) : 'category' === e.type ? (0, s.jsxs)(t.r, { to: e.href, children: [e.items.length, " pagina's voor ", e.label] }) : (0, s.jsx)(s.Fragment, {}) }, n)) }) });
   }
   function d(e) {
    let { item: n } = e;
   ...
   function u(e) {
    let { className: n } = e;
    const r = (0, i.jA)();
    return (0, s.jsx)(j, { items: r.items, className: n });
   }
   function j(e) {
    const { items: n, className: r } = e;
    if (!n) return (0, s.jsx)(u, { ...e });
    const t = (0, i.MN)(n);
    return (0, s.jsx)('section', { className: (0, o.Z)('row', r), children: t.map((e, n) => (0, s.jsx)('article', { className: 'col col--12 margin-bottom--lg doc-card-list', children: (0, s.jsx)(h, { item: e }) }, n)) });
   }
  },
  40139: (e, n, r) => {
   r.d(n, { Z: () => s, a: () => o });
