  ...
  70348(e, n, l) {
   ...
   const a = ({ className: e, ...n }) => {
    ...
    c = ({ className: e, classNamePanel: n, label: l, heading: a, headingLevel: c, headingApperance: i, ...d }) => {
     ...
     return (0, r.jsxs)('details', { className: p, ...d, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(t.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [a && (0, r.jsx)(s.D, { level: c, appearance: i, children: a }), l] })] }) }), (0, r.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => b });
