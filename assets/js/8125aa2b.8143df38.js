/*! For license information please see 8125aa2b.8143df38.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [62739],
 {
  ...
  61359(e, n, a) {
   ...
   const t = JSON.parse('{"id":"componenten/page-layout/index","title":"Page Layout","description":"Indeling voor de inhoud van de pagina en consistent aanwezige onderdelen, zoals de Page Header, navigatie en Page Footer.","source":"@site/docs/componenten/page-layout/index.mdx","sourceDirName":"componenten/page-layout","slug":"/page-layout","permalink":"/page-layout","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/page-layout/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Page Layout","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Page Layout","pagination_label":"Page Layout","description":"Indeling voor de inhoud van de pagina en consistent aanwezige onderdelen, zoals de Page Header, navigatie en Page Footer.","issue_number":432,"slug":"/page-layout","keywords":["page header","page footer","page layout"]},"sidebar":"componenten","previous":{"title":"Page Header","permalink":"/page-header"},"next":{"title":"Page Number Navigation","permalink":"/page-number-navigation"}}');
   var r = a(86070),
    i = a(18439),
    s = a(79447),
    l = a(26877);
   const o = { title: 'Page Layout', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Page Layout', pagination_label: 'Page Layout', description: 'Indeling voor de inhoud van de pagina en consistent aanwezige onderdelen, zoals de Page Header, navigatie en Page Footer.', issue_number: 432, slug: '/page-layout', keywords: ['page header', 'page footer', 'page layout'] },
    d = void 0,
    g = {},
    u = 'Page Layout',
    c = 'Indeling voor de inhoud van de pagina en consistent aanwezige onderdelen, zoals de Page Header, navigatie en Page Footer.',
    m = 432,
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => r, KF: () => c, mJ: () => p, VZ: () => N, cR: () => w, Pv: () => f, qZ: () => s, kD: () => j, QQ: () => y, B2: () => m, Pc: () => o, f4: () => l, GT: () => k, fX: () => i, eQ: () => b, B_: () => v, o_: () => x });
