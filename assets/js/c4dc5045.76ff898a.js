  ...
  75397(e, n, t) {
   ...
   const l = o.forwardRef(function (e, n) {
     const [t, l] = o.useState(!1),
      ...
      b = o.useMemo(() => {
       const n = new URLSearchParams({ ...(e.muted ? { mute: '1' } : {}), ...(f ? { autoplay: '1' } : {}), ...(e.enableJsApi ? { enablejsapi: '1' } : {}), ...(e.playlist ? { list: c } : {}) });
       return (
        e.params &&
      ...
      j = o.useMemo(() => (e.playlist ? `${g}/embed/videoseries?${b.toString()}` : `${g}/embed/${c}?${b.toString()}`), [e.playlist, g, c, b]),
     ...
     return (
      ...
      (0, i.jsxs)(i.Fragment, {
       children: [
        !e.lazyLoad && (0, i.jsx)('link', { rel: N, href: w, as: 'image' }),
        ...
        H && !e.playlist && (0, i.jsx)('noscript', { children: (0, i.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${u} on YouTube`, children: ['Watch "', u, '" on YouTube'] }) }),
        (0, i.jsxs)(D, {
         onPointerOver: () => {
          t || l(!0);
         },
    ...
    d = ({ id: e, title: n, ...t }) => (0, i.jsx)(l, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: n, poster: 'maxresdefault', ...t });
  },
 },
]);
