 ...
 [69606],
 {
  ...
  58639(e, n, t) {
   ...
   const g = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: g = !0, children: y, container: f = 'document', language: b, designTokens: x }) => {
    ...
    let R = u.Fragment;
    return (
     'paragraph' === f ? (R = h) : 'document' === f ? (R = j) : 'surface' === f && (R = v),
     (0, m.jsxs)('div', {
