   ...
   function U(e) {
    ...
    return (0, d.jsxs)(d.Fragment, {
     children: [
      ...
      '\n',
      '\n',
      (0, d.jsx)(z.Rv, { component: H, headingLevel: 1, description: Z }),
      '\n',
      ...
      '\n',
      (0, d.jsx)(z.cN, { component: H, headingLevel: 3 }),
      '\n',
      (0, d.jsx)(t.h2, { id: 'implementaties', children: 'Implementaties' }),
      '\n',
      (0, d.jsx)(z.W, { component: H, headingLevel: 3 }),
      '\n',
      ...
      (0, d.jsx)(D.t, {
       ...
       items: [
        { title: 'Gebruik niet alleen kleur om de betekenis van de Data Badge duidelijk te maken', sc: '1.4.1', status: '', component: (0, d.jsx)(A, {}) },
      ...
      '\n',
      (0, d.jsx)(z.vM, { component: H, headingLevel: 3 }),
     ],
    });
   }
   function V(e = {}) {
  ...
  8657: (e, t, n) => {
   ...
   const k = (e) => {
     ...
     const s = t && t.projects.filter((e) => A.e9.includes(e.id)),
      o = s && A.e9.map((e) => s.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, d.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, d.jsx)(v, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(b, { headingLevel: n + 1, checked: t, title: r, description: (0, A.Q6)(i) }, i);
            }),
           }),
