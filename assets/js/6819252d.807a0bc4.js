 ...
 [13562],
 {
  15175(e, n, t) {
   ...
   function c({ lineNumber: e, syntax: n, textContent: t, trim: c }) {
    let d = t;
    const { title: h, type: p } = (0, a.useContext)(i.x),
     u = (0, a.useId)();
    return (c && (d = d.trim()), (0, s.jsx)(o.f4, { theme: l, code: d, language: n || '', children: ({ style: n, tokens: t, getLineProps: o, getTokenProps: a }) => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: u, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, s.jsx)(r.NG, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': u, style: n, children: t.map((n, t) => (0, s.jsxs)('span', { ...o({ line: n }), children: [e && (0, s.jsx)('span', { children: t + 1 }), n.map((e, n) => (0, s.jsx)('span', { ...a({ token: e }) }, n)), '\n'] }, t)) })] }) }));
   }
  },
  18439(e, n, t) {
   t.d(n, { R: () => i, x: () => l });
   ...
   function l(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(o) : e.components || o) : i(e.components)), r.createElement(a.Provider, { value: n }, e.children));
   }
  },
  49539(e, n, t) {
   t.d(n, { Ay: () => l, RM: () => a });
  ...
  69280(e, n, t) {
   ...
   function i(e, n, t, r, o) {
    const a = { '@context': 'https://schema.org', '@type': 'VideoObject', name: o?.name || n, thumbnailUrl: [o?.thumbnailUrl || t], embedUrl: o?.embedUrl || `${r}/embed/${e}`, contentUrl: o?.contentUrl || `https://www.youtube.com/watch?v=${e}`, ...(o?.description && { description: o.description }), ...(o?.uploadDate && { uploadDate: o.uploadDate }), ...(o?.duration && { duration: o.duration }) };
   ...
   const l = o.forwardRef(function (e, n) {
     const [t, l] = o.useState(!1),
      ...
      j = o.useMemo(() => (e.playlist ? `${v}/embed/videoseries?${b.toString()}` : `${v}/embed/${d}?${b.toString()}`), [e.playlist, v, d, b]),
      ...
      k = f
          ...
          return (
           (0, o.useEffect)(() => {
            const o = `https://img.youtube.com/${n}/${e}/${r}.${t}`,
             i = `https://img.youtube.com/${n}/${e}/hqdefault.${t}`,
             s = a[r],
             c = new Image();
            ((c.onload = () => {
             c.width < s ? l(i) : l(o);
       ...
       : null,
      w = o.useMemo(() => e.thumbnail || k || `https://i.ytimg.com/${x}/${e.playlist ? h : d}/${u}.${y}`, [e.thumbnail, k, x, e.playlist, h, d, u, y]),
     ...
     return (
      ...
      }, [s, e.enableJsApi, e.onReady, e.onStateChange, e.onError, e.onPlay, e.onPause, e.onEnd, e.onBuffering, e.onPlaybackRateChange, e.onPlaybackQualityChange, e.stopOnEnd, e.id, d, p, n]),
      (0, r.jsxs)(r.Fragment, {
       children: [
        ...
        e.seo && !e.playlist && (0, r.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: i(e.id, p, w, v, e.seo) } }),
        ...
        (0, r.jsxs)(E, {
         ...
         style: { ...(!e.lazyLoad && { backgroundImage: `url(${w})` }), '--aspect-ratio': (C / A) * 100 + '%', ...(e.style || {}) },
         children: [e.lazyLoad && !s && (0, r.jsx)('img', { src: w, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), e.playlist && !s && (0, r.jsx)('div', { className: 'lty-playlist-icon', 'aria-hidden': 'true' }), !(e.hideButtonOnActivate && s) && (0, r.jsx)('button', { type: 'button', className: z, 'aria-label': `${m} ${p}`, 'aria-hidden': s || void 0, tabIndex: s ? -1 : 0, onClick: L, children: (0, r.jsx)('span', { className: 'lty-visually-hidden', children: m }) }), s && (0, r.jsx)('iframe', { ref: n, className: S, title: p, width: '560', height: '315', allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: j, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
        }),
       ],
      })
     );
  ...
  70348(e, n, t) {
   ...
   var r = t(13526),
    ...
    i = t(37168),
    l = t(86070);
   const s = (0, o.forwardRef)(({ as: e, className: n, children: t, ...o }, a) => {
     const i = e || 'div',
      s = (0, r.A)('ma-utrecht-accordion', 'utrecht-accordion', n);
     return (0, l.jsx)(i, { ref: a, className: s, ...o, children: t });
    }),
    c = ({ className: e, classNamePanel: n, label: t, heading: o, headingLevel: s, headingApperance: c, ...d }) => {
     const h = (0, r.A)('utrecht-accordion__section', e),
      p = (0, r.A)('utrecht-accordion__panel', n);
     return (0, l.jsxs)('details', { className: h, ...d, children: [(0, l.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, l.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, l.jsx)('span', { className: 'nl-button__icon-start', children: (0, l.jsx)(a.A, {}) }), (0, l.jsxs)('span', { className: 'nl-button__label', children: [o && (0, l.jsx)(i.D, { level: s, appearance: c, children: o }), t] })] }) }), (0, l.jsx)('div', { className: p, children: d.children })] });
    };
  },
  71907(e, n, t) {
   (t.r(n), t.d(n, { assets: () => j, contentTitle: () => v, default: () => x, frontMatter: () => b, metadata: () => r, toc: () => f }));
   const r = JSON.parse('{"id":"richtlijnen/formulieren/description/content/index","title":"Gebruik alleen tekst in descriptions","description":"Richtlijnen voor de inhoud van beschrijvingen in een formulier.","source":"@site/docs/richtlijnen/formulieren/description/2-content/index.mdx","sourceDirName":"richtlijnen/formulieren/description/2-content","slug":"/richtlijnen/formulieren/descriptions/inhoud","permalink":"/richtlijnen/formulieren/descriptions/inhoud","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/richtlijnen/formulieren/description/2-content/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Gebruik alleen tekst in descriptions","title_sm":"Inhoud description","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Inhoud description","pagination_label":"Inhoud description","description":"Richtlijnen voor de inhoud van beschrijvingen in een formulier.","slug":"/richtlijnen/formulieren/descriptions/inhoud","keywords":["labels","formulier","design","code"]},"sidebar":"richtlijnen","previous":{"title":"Koppel description","permalink":"/richtlijnen/formulieren/descriptions/koppelen"},"next":{"title":"Plaatsing description","permalink":"/richtlijnen/formulieren/descriptions/plaatsing"}}');
   var o = t(86070),
    a = t(18439),
    i = t(49539),
    l = t(80731),
  ...
  80731(e, n, t) {
   ...
   var r = t(15175),
    ...
    g = t(70348),
    b = t(86070);
   const v = ({ children: e }) => (0, b.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(o.yo, { className: (0, a.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: (0, b.jsx)(o.fz, { className: 'nlds-canvas__example-paragraph', children: e }) }) });
   v.displayName = 'ParagraphContainer';
   const j = ({ children: e }) => (0, b.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: (0, b.jsx)(o.yo, { className: (0, a.A)('utrecht-document--surface', 'nlds-canvas__example-document'), children: e }) });
   j.displayName = 'DocumentContainer';
   const f = ({ children: e }) => (0, b.jsx)(o.ui, { className: 'nlds-canvas__example-surface', children: e });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: t }) => {
       const r = 'function' == typeof e ? e() : e,
        ...
        i = m().highlight(o, m().languages[n], n);
       return (0, b.jsxs)('div', { className: (0, a.A)('ma-canvas-astro', t), children: [(0, b.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: o } }), (0, b.jsx)(g.n, { children: (0, b.jsx)(g.K, { label: 'Code', children: (0, b.jsx)('pre', { className: 'language-html nl-code-block', children: (0, b.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: i } }) }) }) })] });
      }
    : ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: u = !0, children: m, container: g = 'document', language: y, designTokens: x }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(_, { parser: y, plugins: [i.A, l.Ay, s.Ay, c.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         C(e);
        })();
       }, [_]);
       const z = (0, h.useId)();
       let $ = h.Fragment;
       return (
        'paragraph' === g ? ($ = v) : 'document' === g ? ($ = j) : 'surface' === g && ($ = f),
        (0, b.jsxs)('div', {
         className: (0, a.A)('nlds-canvas'),
         children: [
          k && (0, b.jsx)('div', { className: (0, a.A)('nlds-canvas__example'), children: (0, b.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, b.jsx)($, { children: (0, b.jsx)(o.v$, { children: k }) }) }) }),
          u &&
           (0, b.jsx)('div', {
          ...
          u &&
           (0, b.jsxs)('div', {
            ...
            hidden: !A,
            children: [
             (0, b.jsx)(r.M, { codeBlockLabel: 'Codevoorbeeld', syntax: y, textContent: N, trim: !0 }),
             n &&
              (0, b.jsx)('div', {
