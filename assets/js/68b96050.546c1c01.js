(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [34799],
 {
  ...
  12761(e, n, a) {
   ...
   const b = ({ className: e, ...n }) => {
    ...
    k = ({ className: e, heading: n, headingLevel: a, headingApperance: t, ...i }) => {
     const s = (0, r.A)('utrecht-accordion__section', e);
    ...
    f = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, d.jsx)(b, { children: i.map((a) => (0, d.jsx)(k, { className: (0, r.A)('ma-definition-of-done', a && `ma-definition-of-done--${(0, p.fX)(a.title)}`), heading: a ? `${a.title} - ${a.progress.value} van ${a.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m._, { children: a.tasks.map(({ checked: e, name: a, id: t }) => (0, d.jsx)(m.Z, { headingLevel: n + 1, checked: e, heading: a, description: (0, p.qZ)(t) }, t)) }), (0, d.jsx)(t.fz, { children: (0, d.jsxs)(t.N_, { href: `${a.url}?filterQuery=${e.title}`, children: [a.title, ' projectbord op GitHub'] }) })] }) }, a.title)) });
    },
  ...
  76097(e, n, a) {
   'use strict';
   a.d(n, { bo: () => r, KF: () => u, mJ: () => h, VZ: () => w, cR: () => y, Pv: () => j, qZ: () => s, kD: () => f, QQ: () => D, B2: () => m, Pc: () => l, f4: () => o, GT: () => v, fX: () => i, eQ: () => k, B_: () => b, o_: () => x });
  ...
  91576(e, n, a) {
   'use strict';
   (a.r(n), a.d(n, { assets: () => R, component: () => I, contentTitle: () => H, default: () => V, description: () => B, frontMatter: () => _, issueNumber: () => G, metadata: () => t, title: () => P, toc: () => M }));
