/*! For license information please see 6c269cf8.d59ea074.js.LICENSE.txt */
'use strict';
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [12356],
 {
  98480: (e, L, l) => {
   ...
   const v = (e) => {
    let { children: L } = e;
    return (0, m.jsx)(n.Tg, { className: u['nlds-canvas__example-surface'], children: (0, m.jsx)(n.BB, { className: (0, t.Z)('utrecht-document--surface', u['nlds-canvas__example-document']), children: (0, m.jsx)(n.nv, { className: u['nlds-canvas__example-paragraph'], children: L }) }) });
   };
   v.displayName = 'ParagraphContainer';
   const h = (e) => {
    let { children: L } = e;
    return (0, m.jsx)(n.Tg, { className: u['nlds-canvas__example-surface'], children: (0, m.jsx)(n.BB, { className: (0, t.Z)('utrecht-document--surface', u['nlds-canvas__example-document']), children: L }) });
   };
   h.displayName = 'DocumentContainer';
   const _ = (e) => {
    let { children: L } = e;
    return (0, m.jsx)(n.Tg, { className: u['nlds-canvas__example-surface'], children: L });
   };
   _.displayName = 'SurfaceContainer';
   const x = (e) => {
    let { code: L, copy: l = !0, defaultExpandedCode: x = !1, displayCode: g = !0, children: b, container: y = 'document', language: j, designTokens: k } = e,
     f = 'function' == typeof b ? b() : b,
     C = 'function' == typeof L ? L() : (0, i.isValidElement)(L) ? L : void 0,
     N = 'string' == typeof L ? L : d.uS(C || f),
     [V, Z] = (0, i.useState)(N),
     [H, w] = (0, i.useState)(x);
    (0, i.useEffect)(() => {
     (async () => {
      (V = await c.ZP.format(N, { parser: j, plugins: [o.Z, r.ZP, a.ZP, s.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), Z(V);
     })();
    }, [N]);
    const A = (0, i.useId)();
    let S = i.Fragment;
    return (
     'paragraph' === y ? (S = v) : 'document' === y ? (S = h) : 'surface' === y && (S = _),
     (0, m.jsxs)('div', {
      className: (0, t.Z)(u['nlds-canvas']),
      children: [
       f && (0, m.jsx)('div', { className: (0, t.Z)(u['nlds-canvas__example']), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(S, { children: (0, m.jsx)(n.pu, { children: f }) }) }) }),
       g &&
        (0, m.jsx)('div', {
         className: (0, t.Z)(u['nlds-canvas__toolbar']),
         children: (0, m.jsx)(n.zx, {
          ...
          'aria-expanded': H,
          'aria-controls': A,
          children: H ? 'Verberg code' : 'Bekijk code',
         }),
        }),
       g &&
        (0, m.jsxs)('div', {
         ...
         hidden: !H,
         children: [
          (0, m.jsx)(p.u, { codeBlockLabel: 'Codevoorbeeld', syntax: j, textContent: V, trim: !0 }),
          l &&
           (0, m.jsx)('div', {
  ...
  41179: (e, L, l) => {
   ...
   var s = l(52676);
   function c(e) {
    let { lineNumber: L, syntax: l, textContent: c, trim: i } = e,
     d = c;
    const { title: u, type: p } = (0, o.useContext)(r.n),
     m = (0, o.useId)();
    return (
     i && (d = d.trim()),
     (0, s.jsx)(t.y$, {
      ...
      children: (e) => {
       ...
       return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', u ? ': ' : ' ', u] }), (0, s.jsx)(n.dn, { tabIndex: 0, role: u ? 'region' : void 0, 'aria-labelledby': m, style: l, children: t.map((e, l) => (0, s.jsxs)('span', { ...o({ line: e }), children: [L && (0, s.jsx)('span', { children: l + 1 }), e.map((e, L) => (0, s.jsx)('span', { ...r({ token: e }) }, L)), '\n'] }, l)) })] });
      },
     })
    );
   }
  ...
  91050: (e, L, l) => {
   ...
   const i = (0, a.createContext)({}),
    d = (e) => {
     let { title: L, appearance: l, description: a, children: d, figure: u } = e;
     const p = { do: 'Doen', dont: 'Niet doen' },
      m = u ? 'figure' : 'div',
      v = u ? 'figcaption' : 'div';
     return (0, c.jsxs)(m, { className: (0, r.Z)(s['nlds-guideline'], s[`nlds-guideline--${l}`]), id: 'string' == typeof L ? L?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, c.jsxs)(v, { className: (0, r.Z)(s['nlds-guideline__description']), children: ['dont' === l ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(o.nv, { className: (0, r.Z)(s['nlds-guideline__badge'], s[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(n.Z, { 'aria-hidden': 'true', role: 'presentation', className: s['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: s['nlds-guideline__title'], children: p.dont })] }), (0, c.jsx)(o.nv, { children: L })] }) : (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(o.nv, { className: (0, r.Z)(s['nlds-guideline__badge'], s[`nlds-guideline__badge--${l}`]), children: [(0, c.jsx)(t.Z, { 'aria-hidden': 'true', role: 'presentation', className: s['nlds-guideline__icon'] }), (0, c.jsx)('span', { className: s['nlds-guideline__title'], children: p.do })] }), (0, c.jsx)(o.nv, { children: L })] }), a] }), (0, c.jsx)('div', { className: (0, r.Z)(s['nlds-guideline__example']), children: (0, c.jsx)(i.Provider, { value: { title: L, type: p[l] }, children: d }) })] });
    };
  },
  89011: (e, L, l) => {
   l.r(L), l.d(L, { default: () => N, parseColor: () => y });
   var n = l(3225),
    t = l(87502),
    o = l(98480),
    r = l(46506),
   ...
   const x = 'nlds-form_L93Q',
    ...
    j = (e) => {
     let { children: L, label: l, ...n } = e;
     return (0, i.jsx)('div', { role: 'img', 'aria-label': l, className: g, ...n, children: L });
    },
    k = () => (0, i.jsx)(j, { label: 'voorbeeldtekst in verschillende font-sizes groter dan 18.5px, met vette tekst', style: { '--utrecht-paragraph-font-size': '16px' }, children: (0, i.jsx)(r.nv, { children: '16px: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.' }) }),
    f = () => (0, i.jsxs)(j, { label: 'voorbeeldtekst in verschillende font-sizes groter dan 18.5px, met vette tekst', style: { '--utrecht-paragraph-font-weight': '600' }, children: [(0, i.jsx)(r.nv, { style: { '--utrecht-paragraph-font-size': '18.5px' }, children: '18.5px: Lorem ipsum' }), (0, i.jsx)(r.nv, { style: { '--utrecht-paragraph-font-size': '24px' }, children: '24px: Lorem ipsum' }), (0, i.jsx)(r.nv, { style: { '--utrecht-paragraph-font-size': '32px' }, children: '32px: Lorem ipsum' }), (0, i.jsx)(r.nv, { style: { '--utrecht-paragraph-font-size': '48px' }, children: '48px: Lorem ipsum' })] }),
    C = () => (0, i.jsxs)(j, { label: 'voorbeeldtekst in verschillende font-sizes groter dan 24px', children: [(0, i.jsx)(r.nv, { style: { '--utrecht-paragraph-font-size': '24px' }, children: '24px: Lorem ipsum' }), (0, i.jsx)(r.nv, { style: { '--utrecht-paragraph-font-size': '32px' }, children: '32px: Lorem ipsum' }), (0, i.jsx)(r.nv, { style: { '--utrecht-paragraph-font-size': '48px' }, children: '48px: Lorem ipsum' })] }),
    N = () => {
     const { siteConfig: e } = (0, t.Z)(),
      { search: L } = (0, n.TH)(),
      l = new URLSearchParams(L),
      a = l.get('background-color'),
      s = l.get('color'),
      c = y(a),
      m = y(s),
      h = `https://nldesignsystem.nl/contrast/?${new URLSearchParams({ 'background-color': a, color: s }).toString()}`,
      _ = c && m ? c.contrast(m) : null,
      g = [
       { positive: !0, result: _ >= 4.5, content: (0, i.jsx)(i.Fragment, { children: 'Je mag de kleuren gebruiken voor alle tekst, als je wilt voldoen aan WCAG 2.2 AA niveau.' }), container: 'document', example: k },
       { positive: !0, result: _ >= 3, content: (0, i.jsx)(i.Fragment, { children: 'Je mag de kleuren voor iconen gebruiken, als je wilt voldoen aan WCAG 2.2 AA niveau.' }), container: 'document', example: b },
       { positive: !0, result: _ >= 3, content: (0, i.jsx)(i.Fragment, { children: 'Je mag de kleuren gebruiken voor tekst groter dan 24px, als je wilt voldoen aan WCAG 2.2 AA niveau.' }), container: 'document', example: C },
       { positive: !0, result: _ >= 3, content: (0, i.jsx)(i.Fragment, { children: 'Je mag de kleuren gebruiken voor vette tekst groter dan 18.5px, als je wilt voldoen aan WCAG 2.2 AA niveau.' }), container: 'document', example: f },
       { positive: !1, result: _ >= 3, content: (0, i.jsx)(i.Fragment, { children: 'Je mag de kleuren niet voor iconen gebruiken, hiermee zou je niet voldoen aan WCAG 2.2 AA niveau.' }), container: 'document', example: b },
       { positive: !1, result: _ >= 4.5, content: (0, i.jsx)(i.Fragment, { children: 'Je mag de kleuren niet gebruiken voor tekst, hiermee zou je niet voldoen aan WCAG 2.2 AA niveau.' }), container: 'document', example: k },
       { positive: !1, result: _ >= 7, content: (0, i.jsx)(i.Fragment, { children: 'Je mag de kleuren niet gebruiken voor tekst, als je wilt voldoen aan WCAG 2.2 AAA niveau.' }), container: 'document', example: k },
      ],
      j = g.filter((e) => {
       let { result: L, positive: l } = e;
       return l && L === l;
      }),
      N = g.filter((e) => {
       let { result: L, positive: l } = e;
     ...
     return (0, i.jsx)(p.Z, {
      title: `Contrast van kleuren - ${e.title}`,
      children: (0, i.jsxs)(r.JH, {
       style: { '--utrecht-space-around': 1, maxInlineSize: '600px', marginInlineEnd: 'auto', marginInlineStart: 'auto' },
       children: [
        (0, i.jsx)(r.nL, { children: 'Contrast van kleuren' }),
        (0, i.jsx)(r.nv, { lead: !0, children: 'Vul de CSS-kleurcodes in van twee kleuren. Controleer dan voor welke toepassingen je de combinatie kunt gebruiken.' }),
        (0, i.jsxs)('form', { method: 'get', action: './', className: x, children: [(0, i.jsx)(v, { name: 'background-color', label: (0, i.jsx)(r.EK, { children: 'background-color' }), defaultValue: a, style: { '--utrecht-textbox-font-family': 'var(--utrecht-code-font-family)' } }), (0, i.jsx)(v, { name: 'color', defaultValue: s, label: (0, i.jsx)(r.EK, { children: 'color' }), style: { '--utrecht-textbox-font-family': 'var(--utrecht-code-font-family)' } }), (0, i.jsx)(r.zx, { type: 'submit', appearance: 'primary-action-button', children: 'Contrast berekenen' })] }),
        'number' == typeof _ &&
         (0, i.jsxs)('div', {
          children: [
           (0, i.jsx)(r.XJ, { id: 'output', children: 'Resultaat' }),
           (0, i.jsx)(d, { backgroundColor: a, color: s, contrastRatio: _ }),
           (0, i.jsx)(r.hE, { style: { display: 'none' }, children: (0, i.jsx)(r.zx, { appearance: 'secondary-action-button', onClick: () => navigator.clipboard.writeText(h), children: 'Link kopi\xebren' }) }),
           j.length > 0 &&
            (0, i.jsxs)(i.Fragment, {
             children: [
              (0, i.jsx)(r.nv, { children: 'Gebruik deze kleuren voor bijvoorbeeld:' }),
              (0, i.jsx)('div', {
               children: j.map((e, L) => {
                let { container: l, content: n, example: t, positive: r } = e;
                return (0, i.jsx)(u.X, { appearance: r ? 'do' : 'dont', title: n, displayCode: !1, figure: !0, children: (0, i.jsx)(o.X, { language: 'html', code: null, displayCode: !1, container: l, designTokens: { backgroundColor: a, color: s, forcedColorAdjust: 'none', '--utrecht-surface-background-color': a, '--utrecht-surface-color': s, '--utrecht-document-background-color': a, '--utrecht-document-color': s, '--utrecht-icon-color': 'currentColor', '--utrecht-paragraph-color': 'currentColor' }, children: t }) }, L);
               }),
              }),
             ],
            }),
           N.length > 0 &&
            (0, i.jsxs)(i.Fragment, {
             children: [
              (0, i.jsx)(r.XJ, { children: 'Niet doen' }),
              (0, i.jsxs)(r.nv, { children: ['Deze kleuren moet je ', (0, i.jsx)('strong', { children: 'niet gebruiken' }), ' voor:'] }),
              ' ',
              (0, i.jsx)('div', {
               children: N.map((e, L) => {
                let { container: l, content: n, example: t, positive: r } = e;
                return (0, i.jsx)(u.X, { appearance: r ? 'do' : 'dont', title: n, displayCode: !1, children: (0, i.jsx)(o.X, { language: 'html', code: null, displayCode: !1, container: l, designTokens: { backgroundColor: a, color: s, forcedColorAdjust: 'none', '--utrecht-surface-background-color': a, '--utrecht-surface-color': s, '--utrecht-document-background-color': a, '--utrecht-document-color': s, '--utrecht-icon-color': 'currentColor', '--utrecht-paragraph-color': 'currentColor' }, children: t }) }, L);
               }),
              }),
             ],
            }),
