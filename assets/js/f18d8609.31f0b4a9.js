/*! For license information please see f18d8609.31f0b4a9.js.LICENSE.txt */
'use strict';
 ...
 [93211],
 {
    ...
    h = (0, i.forwardRef)(({ image: e, heading: n, headingLevel: t, href: o, Link: a, className: s, body: h, ...u }, m) => {
     const p = (0, i.useRef)(null),
      ...
      v = o
       ...
       : {};
     return (0, r.jsx)('div', { ref: m, className: c('utrecht-card', s, { 'utrecht-card--link': o }), ...v, ...u, children: (0, r.jsxs)('div', { className: 'utrecht-card__content', children: [(0, r.jsx)('div', { className: c('utrecht-card__heading'), children: t && n && (0, r.jsx)(l, { id: k, className: c(`utrecht-heading-${t}`, 'utrecht-card__header'), level: t, children: (0, r.jsx)(g, { ref: p, href: o, className: c('utrecht-card__link'), children: n }) }) }), e && (0, r.jsx)('div', { className: c('utrecht-card__image'), children: e }), h && (0, r.jsx)('div', { className: c('utrecht-card__body'), children: h })] }) });
    });
   ((h.displayName = 'Card'),
    ((e) => {
  ...
  90495(e, n, t) {
   ...
   const a = ({ background: e, children: n, className: t, ...r }) => (0, o.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, t), ...r, children: n }),
    d = (e) => (0, o.jsx)('div', { className: 'card__content', ...e }),
    s = ({ href: e, appearance: n, className: t, component: a = 'div', background: d, children: s }) => {
     const c = (e) => ('article' === a ? (0, o.jsx)('article', { ...e }) : 'section' === a ? (0, o.jsx)('section', { ...e }) : (0, o.jsx)('div', { ...e })),
      l = (0, o.jsx)(c, { className: (0, i.A)('cardgroup__card', d && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: s });
