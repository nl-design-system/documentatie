 ...
 [22410],
 {
  ...
  50341: (e, t, n) => {
   ...
   var r = n(14537),
    ...
    l = n(83386),
    u = n(86070);
   const h = { figma: (0, u.jsx)(i.A, {}), github: (0, u.jsx)(c.A, {}), npm: (0, u.jsx)(o.A, {}), storybook: (0, u.jsx)(a.A, {}) },
   ...
   const _ = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, u.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, x.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(k, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, u.jsx)(f, { headingLevel: t + 1, checked: e, title: n, description: (0, x.qZ)(r) }, r)) }), (0, u.jsx)(r.fz, { children: (0, u.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            j.Zp,
            {
             ...
             children: (0, u.jsxs)(j.Wu, {
              children: [
               ...
               i.length > 0 && (0, u.jsx)(u.Fragment, { children: i.map(({ frameworkName: e, tasks: n }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(r.DZ, { level: t + 2, children: [s, ' in ', e] }), (0, u.jsx)(r.dk, { links: n.map((e) => ({ children: e.description, icon: (0, u.jsx)(d, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    N = ({ component: e, headingLevel: t, description: n }) => {
     ...
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(m.p, { level: t, suffix: s && (0, u.jsx)(p.D, { state: s }), children: e.title }), (0, u.jsx)(r.fz, { lead: !0, children: n })] });
    };
  },
  74111: (e, t, n) => {
