 ...
 [88963],
 {
   ...
   const d = (0, c.createContext)({}),
    m = ({ title: e, appearance: n, description: l, children: c, figure: m }) => {
     const h = { do: 'Doen', dont: 'Niet doen' },
      u = m ? 'figure' : 'div',
      p = m ? 'figcaption' : 'div',
      b = 'string' == typeof l ? (0, i.jsx)(r.oz, { components: { a: o.N_ }, children: l }) : l;
  ...
  70348(e, n, l) {
   ...
   const r = ({ className: e, ...n }) => {
    ...
    c = ({ className: e, classNamePanel: n, label: l, heading: r, headingLevel: c, headingApperance: i, ...d }) => {
     const m = (0, a.A)('utrecht-accordion__section', e),
      h = (0, a.A)('utrecht-accordion__panel', n);
     return (0, s.jsxs)('details', { className: m, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(t.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [r && (0, s.jsx)(o.D, { level: c, appearance: i, children: r }), l] })] }) }), (0, s.jsx)('div', { className: h, children: d.children })] });
    };
  },
  80731(e, n, l) {
   l.d(n, { H: () => y });
   ...
   const y = globalThis.isAstro
    ? ({ children: e, language: n, className: l }) => {
       ...
       return (0, g.jsxs)('div', { className: (0, o.A)('ma-canvas-astro', l), children: [(0, g.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: t } }), (0, g.jsx)(b.n, { children: (0, g.jsx)(b.K, { label: 'Code', children: (0, g.jsx)('pre', { className: 'language-html nl-code-block', children: (0, g.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
