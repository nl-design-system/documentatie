(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [3958],
 {
  ...
  10645(e, n, t) {
   ...
   var a = t(13526),
    o = t(86070);
   const s = ({ children: e, className: n, level: t = 1, suffix: s, ...r }) => (0, o.jsxs)('hgroup', { className: (0, a.A)('nlds-inline-heading-group', `utrecht-heading-${t}`, n), ...r, children: [(0, o.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), s && (0, o.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [s ? ' ' : '', s] })] });
  },
  11444(e, n, t) {
   'use strict';
   t.d(n, { Ay: () => r });
  ...
  21034(e, n, t) {
   ...
   const k = ({ component: e, headingLevel: n }) => {
            ...
            r.Zp,
            {
             ...
             children: (0, d.jsxs)(r.Wu, {
              children: [
               ...
               (g.length > 0 || i.length > 0) && (0, d.jsx)(a.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               g.length > 0 &&
                (0, d.jsx)(d.Fragment, {
               ...
               i.length > 0 && (0, d.jsx)(d.Fragment, { children: i.map(({ frameworkName: e, tasks: t }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(a.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, d.jsx)(a.dk, { links: t.map((e) => ({ children: e.description, icon: (0, d.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    v = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u.p, { level: n, suffix: o && (0, d.jsx)(g.D, { state: o }), children: e.title }), (0, d.jsx)(a.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(o) && (0, d.jsx)(x.s, { relayStep: o, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    w = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
  ...
  21530(e, n, t) {
   'use strict';
   t.d(n, { AC: () => d, Fu: () => r, Wu: () => i, Zp: () => l });
   var a = t(46447),
    o = t(13526),
    s = t(86070);
   const r = ({ background: e, children: n, className: t, ...a }) => (0, s.jsx)('div', { className: (0, o.A)('ma-card__illustration', e && `ma-card__illustration--${e}`, t), ...a, children: n }),
    i = (e) => (0, s.jsx)('div', { className: 'ma-card__content', ...e }),
    l = ({ href: e, appearance: n, className: t, component: r = 'div', background: i, children: l }) => {
     const d = (e) => ('article' === r ? (0, s.jsx)('article', { ...e }) : 'section' === r ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      c = (0, s.jsx)(d, { className: (0, o.A)('ma-cardgroup__card', i && 'ma-cardgroup__card--light-purple', `ma-cardgroup__card--${n}`, t), children: l });
     return e ? (0, s.jsx)(a.N_, { href: e, boxContent: !0, className: 'ma-cardgroup__link', children: c }) : c;
    },
    d = ({ appearance: e = 'large', children: n, className: t }) => (0, s.jsx)('div', { className: (0, o.A)('ma-cardgroup', `ma-cardgroup--${e}`, t), children: n });
  },
  32385(e, n, t) {
   'use strict';
   t.d(n, { bo: () => o, KF: () => u, mJ: () => p, VZ: () => y, cR: () => w, Pv: () => j, qZ: () => r, kD: () => f, QQ: () => D, B2: () => m, Pc: () => l, f4: () => i, GT: () => v, fX: () => s, eQ: () => b, B_: () => k, o_: () => x });
    ...
    j = (e) => {
     ...
     return n.map((n) => {
      const a = e.tasks
       ...
       .map(({ name: a, id: o, value: s }) => {
        const r = /^(.+) URL/.exec(a)[1],
         i = 'Storybook' === r ? `${t} (${n}) in Storybook van ${e.title}` : `${t} (${n}) op ${r}`;
        return { brand: r.toLowerCase(), name: a, id: o, value: s, description: i };
       });
  ...
  40889(e, n, t) {
   ...
   var a = t(29181),
    ...
    l = t(83386),
    d = t(86070);
   const c = { figma: (0, d.jsx)(o.A, {}), github: (0, d.jsx)(s.A, {}), npm: (0, d.jsx)(r.A, {}), storybook: (0, d.jsx)(i.A, {}) },
  ...
  51582(e, n, t) {
   ...
   const r = (e, n) => {
    ...
    c = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: o = '', components: r = {} }) => (0, s.jsx)(a.x, { components: { ...d(n, t), ...l(o), ...r }, children: e });
  },
  51604(e, n, t) {
   'use strict';
   t.d(n, { Ay: () => r });
  ...
  59778(e, n, t) {
   ...
   const i = ({ component: e }) => {
    ...
    return (0, r.jsx)(o.Suspense, { fallback: null, children: (0, r.jsx)(a.o, { omitH1: !0, headingLevel: 1, children: (0, r.jsx)(l, {}) }) });
   };
  },
  70348(e, n, t) {
   'use strict';
   ...
   const i = ({ className: e, ...n }) => {
    ...
    l = ({ className: e, classNamePanel: n, label: t, heading: i, headingLevel: l, headingApperance: d, ...c }) => {
     const g = (0, a.A)('utrecht-accordion__section', e),
      u = (0, a.A)('utrecht-accordion__panel', n);
     return (0, r.jsxs)('details', { className: g, ...c, children: [(0, r.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, r.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, r.jsx)('span', { className: 'nl-button__icon-start', children: (0, r.jsx)(o.A, {}) }), (0, r.jsxs)('span', { className: 'nl-button__label', children: [i && (0, r.jsx)(s.D, { level: l, appearance: d, children: i }), t] })] }) }), (0, r.jsx)('div', { className: u, children: c.children })] });
    };
  },
  70561(e, n, t) {
   'use strict';
  ...
  70903(e, n, t) {
    ...
    return 'clipboard' in navigator
     ? (0, m.jsxs)(r.$n, {
        ...
        onClick: async function () {
         try {
          const e = await c.Ay.format(n, { parser: t, plugins: [i.A, l.Ay, d.Ay] });
   ...
   var p = t(43864),
    ...
    D = t(79532),
    S = t(30758);
   const C = { boxShadow: p.A, color: j.A, cursor: x.A, dimension: k.A, fontFamily: b.A, fontFamilies: b.A, fontSize: f.A, fontSizes: f.A, fontWeight: v.A, fontWeights: v.A, lineHeight: w.A, lineHeights: w.A, number: y.A, other: A.A, textDecoration: D.A },
    N = ({ type: e }) => {
       ...
       children: [
        ...
        (0, m.jsx)(r.BF, {
         children: i.map((n) => {
          const t = (0, s.o_)(n),
           i = (0, s.eQ)(e, n).$type;
          return (0, m.jsxs)(r.Hj, { children: [(0, m.jsx)(r.nA, { children: (0, m.jsx)(a.C, { children: (0, m.jsx)(r.kf, { children: t }) }) }), (0, m.jsx)(r.nA, { children: (0, m.jsxs)(o.K, { children: [(0, m.jsx)(N, { type: i }), ' ', i] }) })] }, t);
         }),
        }),
       ],
      }),
  ...
  85162(e, n, t) {
   ...
   const i = { 'Heading 1': 'Heading', 'Heading 2': 'Heading', 'Heading 3': 'Heading', 'Heading 4': 'Heading', 'Heading 5': 'Heading', 'Heading 6': 'Heading' },
    l = ({ name: e, relayStep: n, description: t }) => {
     const l = (0, s.fX)(n),
      d = i[e] ?? e;
     return (0, r.jsxs)(a.WK, { children: [(0, r.jsxs)('svg', { width: '960', height: '540', viewBox: '0 0 960 540', xmlns: 'http://www.w3.org/2000/svg', className: (0, o.A)('ma-component-illustration', `ma-component-illustration--${l}`), fill: 'none', children: [(0, r.jsxs)('g', { fill: 'var(--ma-component-illustration-background-color, white)', children: [(0, r.jsx)('rect', { width: '960', height: '540' }), (0, r.jsx)('rect', { width: '960', height: '540' })] }), (0, r.jsxs)('g', { fill: 'var(--ma-component-illustration-grid-color, #eee)', children: [(0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(69)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(151)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(233)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(315)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(397)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(479)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(561)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(643)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(725)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(807)' }), (0, r.jsx)('rect', { width: '2', height: '540', transform: 'translate(889)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 64)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 146)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 228)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 310)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 392)' }), (0, r.jsx)('rect', { width: '960', height: '2', transform: 'translate(0 474)' })] }), (0, r.jsx)('use', { href: `/svg/componenten_overzicht_${(0, s.fX)(d)}.svg#component-illustration` })] }), (0, r.jsx)(a.$P, { className: 'ma-component-illustration__caption', children: t })] });
    };
  },
  88257(e, n, t) {
   'use strict';
   ...
   const N = { title: 'Code Block', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code Block', pagination_label: 'Code Block', description: 'Blok met \xe9\xe9n of meerdere regels computercode.', issue_number: 329, slug: '/code-block', keywords: ['code', 'code block', 'code blok', 'code container', 'code example', 'code fences', 'code memo', 'code snippet', 'code snippet blok', 'code voorbeeld', 'code wrapper', 'codeblock', 'codepen', 'copy paste blok', 'css voorbeeld', 'html voorbeeld', 'inline code', 'monospace', 'monotype', 'pre', 'snippet', 'source code', 'source doc', 'toepassing', 'voorbeeld blok', 'Code Snippet', 'Code Blok', 'Code Example'] },
    ...
    L = 329,
    B = r.find((e) => e.number === L),
    R = [{ value: 'Checklist voor toegankelijkheid', id: 'checklist-voor-toegankelijkheid', level: 2 }, ...d.RM, { value: 'Acceptatiecriteria bij gebruik', id: 'acceptatiecriteria-bij-gebruik', level: 3 }, ...l.RM, { value: 'Acceptatiecriteria van de component', id: 'acceptatiecriteria-van-de-component', level: 3 }, ...i.RM, { value: 'CSS', id: 'css', level: 2 }, { value: 'React', id: 'react', level: 2 }, { value: 'Design tokens', id: 'design-tokens', level: 2 }, { value: 'Definition of Done', id: 'definition-of-done', level: 2 }, { value: 'Community implementaties', id: 'community-implementaties', level: 2 }];
   function z(e) {
    const n = { a: 'a', admonition: 'admonition', h2: 'h2', h3: 'h3', p: 'p', ...(0, s.R)(), ...e.components },
     { Checklist: t, ChecklistItem: a } = n;
    return (t || G('Checklist', !0), a || G('ChecklistItem', !0), (0, o.jsxs)(o.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, o.jsx)(w.Fc, { component: B, headingLevel: 1, description: _ }), '\n', (0, o.jsx)(v.e, { component: B }), '\n', (0, o.jsx)(n.admonition, { title: 'Tip', type: 'tip', children: (0, o.jsxs)(n.p, { children: ['Gebruik de ', (0, o.jsx)(n.a, { href: '/code/', children: 'Code' }), ' component als de code in een regel met andere tekst staat.'] }) }), '\n', (0, o.jsx)(x.Zp, { className: 'ma-implementation-card', children: (0, o.jsxs)(x.Wu, { children: [(0, o.jsx)(b.D, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, o.jsxs)(k.dk, { children: [(0, o.jsxs)(k.Pt, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=13778-3553', children: [(0, o.jsx)(f.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, o.jsxs)(k.Pt, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=13778-3553', children: [(0, o.jsx)(f.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, o.jsx)(b.D, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, o.jsxs)(k.dk, { children: [(0, o.jsxs)(k.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-code-block--documentatie', children: [(0, o.jsx)(f.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, o.jsxs)(k.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/code-block--documentatie', children: [(0, o.jsx)(f.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, o.jsx)(b.D, { level: 2, appearance: 'level-4', children: 'npm' }), (0, o.jsxs)(k.dk, { children: [(0, o.jsxs)(k.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-css', children: [(0, o.jsx)(f.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-css'] }), (0, o.jsxs)(k.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-react', children: [(0, o.jsx)(f.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-react'] }), (0, o.jsxs)(k.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-tokens', children: [(0, o.jsx)(f.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-tokens'] })] })] }) }), '\n', (0, o.jsx)(n.h2, { id: 'checklist-voor-toegankelijkheid', children: 'Checklist voor toegankelijkheid' }), '\n', (0, o.jsx)(d.Ay, {}), '\n', (0, o.jsx)(n.h3, { id: 'acceptatiecriteria-bij-gebruik', children: 'Acceptatiecriteria bij gebruik' }), '\n', (0, o.jsx)(l.Ay, {}), '\n', (0, o.jsx)(t, { headingLevel: '4', children: p.map(({ component: e, ...n }) => (0, o.jsx)(a, { ...n, children: (0, o.jsx)(e, {}) })) }), '\n', (0, o.jsx)(n.h3, { id: 'acceptatiecriteria-van-de-component', children: 'Acceptatiecriteria van de component' }), '\n', (0, o.jsx)(i.Ay, {}), '\n', (0, o.jsx)(t, { headingLevel: '4', children: j.map(({ component: e, ...n }) => (0, o.jsx)(a, { ...n, children: (0, o.jsx)(e, {}) })) }), '\n', (0, o.jsx)(A.o, { omitH1: !0, headingLevel: 2, children: (0, o.jsx)(S, {}) }), '\n', (0, o.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }), '\n', (0, o.jsx)(y.B, { tokens: C }), '\n', (0, o.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, o.jsx)(w.VK, { component: B, headingLevel: 3 }), '\n', (0, o.jsx)(w.$9, { component: B, headingLevel: 2 }), '\n', (0, o.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, o.jsx)(w.mu, { component: B, headingLevel: 3 }), '\n', (0, o.jsx)(w.K_, { component: B })] }));
   }
   function P(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
