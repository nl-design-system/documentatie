(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [72837],
 {
  ...
  25772: (e, n, t) => {
   ...
   function A(e = {}) {
    const { wrapper: n } = { ...(0, h.a)(), ...e.components };
    return n ? (0, d.jsx)(n, { ...e, children: (0, d.jsx)(f, { ...e }) }) : f(e);
   }
   var b = t(27794);
   function x(e) {
    const n = { a: 'a', li: 'li', p: 'p', ul: 'ul', ...(0, h.a)(), ...e.components };
     ...
     children: [
      ...
      (0, d.jsx)(L.t, {
       ...
       items: [
        ...
        { title: 'Het kleurvlak en de bijbehorende eigenschappen horen semantisch bij elkaar', sc: '1.3.1', status: '', component: (0, d.jsx)(k, {}) },
  ...
  35038: (e, n, t) => {
   ...
   const i = (e) => {
    ...
    c = (e) => {
     ...
     const a = (e) => ('article' === l ? (0, s.jsx)('article', { ...e }) : 'section' === l ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      d = (0, s.jsx)(a, { className: (0, o.Z)('cardgroup__card', `cardgroup__card--${t}`, i), children: c });
  ...
  97520: (e, n, t) => {
   ...
   const l = (e) => {
    ...
    const { title: l } = n,
     c = (0, s.mA)(l),
     a = o.lazy(() => t(42767)(`./${c}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
  ...
  8657: (e, n, t) => {
   ...
   var r = t(41115),
    ...
    a = t(32636),
    d = t(52676);
   const h = { figma: (0, d.jsx)(s.Z, {}), github: (0, d.jsx)(i.Z, {}), npm: (0, d.jsx)(l.Z, {}), storybook: (0, d.jsx)(c.Z, {}) },
    u = (e) => {
     let { brand: n } = e;
   ...
   const b = (e) => {
     ...
     const s = n && n.projects.filter((e) => A.e9.includes(e.id)),
      i = s && A.e9.map((e) => s.find((n) => n.id === e)).filter(Boolean);
     return (
      n &&
      (0, d.jsx)(r.a2, {
       appearance: '',
          ...
          children: [
           (0, d.jsx)(k, {
            children: e.tasks.map((e) => {
             ...
             return (0, d.jsx)(f, { headingLevel: t + 1, checked: n, title: r, description: (0, A.Q6)(o) }, o);
            }),
           }),
  ...
  57716: (e, n, t) => {
   ...
   const i = (e, n) => {
    ...
    d = (e) => {
     ...
     return (0, s.jsx)(r.Z, { components: { ...a(t, o), ...c(i), ...l }, children: n });
    };
  },
  14669: (e, n, t) => {
   'use strict';
   t.d(n, { $3: () => r, BA: () => l, Q6: () => s, e9: () => i, mA: () => o });
