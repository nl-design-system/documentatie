 ...
 [3800],
 {
  ...
  73460: (e, n, t) => {
   ...
   const x = (e) => {
    ...
    (0, d.useEffect)(() => {
     (async () => {
      (Z = await c.ZP.format(z, { parser: k, plugins: [l.Z, o.ZP, a.ZP, s.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), F(Z);
     })();
    }, [z]);
    const U = (0, d.useId)();
    let X = d.Fragment;
