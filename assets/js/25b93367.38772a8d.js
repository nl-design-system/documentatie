(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [44480],
 {
  ...
  41703(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => ye, component: () => De, contentTitle: () => Ae, default: () => Ge, description: () => Te, frontMatter: () => ve, issueNumber: () => Ce, metadata: () => i, title: () => Re, toc: () => Ne }));
   ...
   const b = JSON.parse('{"D":"De linktekst geeft niet voldoende informatie"}');
   function w(e) {
    const n = { p: 'p', ...(0, r.R)(), ...e.components };
   ...
   const L = JSON.parse('{"D":"De link is niet bedienbaar met het toetsenbord"}');
   function G(e) {
    const n = { p: 'p', ...(0, r.R)(), ...e.components };
   ...
   const B = JSON.parse('{"D":"De link heeft geen zichtbare focusrand"}');
   function I(e) {
    const n = { p: 'p', ...(0, r.R)(), ...e.components };
   ...
   const we = JSON.parse('{"nl":{"link":{"active":{"color":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<color>","nl.nldesignsystem.figma-implementation":true},"$type":"color"}},"color":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<color>","nl.nldesignsystem.figma-implementation":true},"$type":"color"},"current":{"cursor":{"$extensions":{"nl.nldesignsystem.css-property-syntax":["<url>","pointer","*"],"nl.nldesignsystem.figma-implementation":false},"$type":"other"}},"disabled":{"color":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<color>","nl.nldesignsystem.figma-implementation":true},"$type":"color"},"cursor":{"$extensions":{"nl.nldesignsystem.css-property-syntax":["<url>","pointer","*"],"nl.nldesignsystem.figma-implementation":false},"$type":"other"}},"hover":{"color":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<color>","nl.nldesignsystem.figma-implementation":true},"$type":"color"},"text-decoration-line":{"$extensions":{"nl.nldesignsystem.css-property-syntax":["inherit","none","underline"],"nl.nldesignsystem.figma-implementation":true},"$type":"textDecoration"},"text-decoration-thickness":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":false},"$type":"other"}},"text-decoration-color":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<color>","nl.nldesignsystem.figma-implementation":true},"$type":"color"},"text-decoration-line":{"$extensions":{"nl.nldesignsystem.css-property-syntax":["inherit","none","underline"],"nl.nldesignsystem.figma-implementation":true},"$type":"textDecoration"},"text-decoration-thickness":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":false},"$type":"other"},"text-underline-offset":{"$extensions":{"nl.nldesignsystem.css-property-syntax":"<length>","nl.nldesignsystem.figma-implementation":false},"$type":"other"}}}}'),
    ...
    ye = {},
    Re = 'Link',
    Te = 'Een verwijzing om een externe bron of bestand te openen of te navigeren binnen dezelfde pagina of website.',
    Ce = 118,
    De = a.find((e) => e.number === Ce),
  ...
  48068(e, n, t) {
   ...
   var u = t(43864),
    ...
    w = t(23436),
    v = t(79532);
   const A = { boxShadow: u.A, color: m.A, cursor: h.A, dimension: p.A, fontFamily: j.A, fontFamilies: j.A, fontSize: k.A, fontSizes: k.A, fontWeight: f.A, fontWeights: f.A, lineHeight: x.A, lineHeights: x.A, number: b.A, other: w.A, textDecoration: v.A },
    y = ({ type: e }) => {
  ...
  48262(e, n, t) {
   ...
   const w = ({ component: e, headingLevel: n }) => {
    ...
    y = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(p.p, { level: n, suffix: s && (0, u.jsx)(h.D, { state: s }), children: e.title }), (0, u.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(s) && (0, u.jsx)(b.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    R = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
    ...
    m =
     ...
     (0, o.forwardRef)(function (e, n) {
      var t = e.children,
       ...
       y = (0, s.A)(e, l),
       R = Boolean(m || g),
       T = (o.Children.toArray(t).some(o.isValidElement) && R) || d;
      return (0, r.jsxs)('button', c(c({ ref: n, type: w, className: (0, a.$)('nl-button', i, { 'nl-button--pressed': f, 'nl-button--busy': x, 'nl-button--disabled': j || k, 'nl-button--primary': 'primary' === h, 'nl-button--secondary': 'secondary' === h, 'nl-button--subtle': 'subtle' === h, 'nl-button--positive': u(h) && 'positive' === p, 'nl-button--negative': u(h) && 'negative' === p, 'nl-button--icon-only': d }), 'aria-pressed': A ? String(Boolean(f)) : void 0, 'aria-disabled': j || x ? 'true' : void 0, disabled: k }, y), {}, { children: [m && (0, r.jsx)('span', { className: 'nl-button__icon-start', children: m }), v && (0, r.jsx)('span', { className: 'nl-button__label', children: v }), T ? (0, r.jsx)('span', { className: d ? 'nl-button__label' : '', children: t }) : t, g && (0, r.jsx)('span', { className: 'nl-button__icon-end', children: g })] }));
     }));
  ...
  84471(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => u, mJ: () => p, VZ: () => A, cR: () => v, Pv: () => j, qZ: () => a, kD: () => b, QQ: () => R, B2: () => m, Pc: () => l, f4: () => o, GT: () => w, fX: () => r, eQ: () => x, B_: () => f, o_: () => k });
