 ...
 [2816],
 {
  ...
  19481: (e, n, o) => {
   ...
   var l = o(52676),
    ...
    i = o(40761);
   function c(e) {
    const n = { div: 'div', h2: 'h2', input: 'input', label: 'label', ...(0, r.a)(), ...e.components };
  ...
  43599: (e, n, o) => {
   ...
   const b = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      const e = await a.ZP.format(N, { parser: f, plugins: [t.Z, i.ZP, c.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
      C(e);
     })();
    }, [N]);
    const M = (0, p.useId)();
  ...
  41179: (e, n, o) => {
   ...
   var c = o(52676);
   function d(e) {
    let { lineNumber: n, syntax: o, textContent: d, trim: a } = e,
     p = d;
