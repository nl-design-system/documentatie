...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  545(e, n, a) {
   (a.r(n), a.d(n, { assets: () => g, component: () => h, contentTitle: () => d, default: () => b, description: () => m, frontMatter: () => o, issueNumber: () => c, metadata: () => t, title: () => u, toc: () => p }));
   ...
   const o = { title: 'Status Badge', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Status Badge', pagination_label: 'Status Badge', description: 'Label dat informeert over een status en de aandacht trekt met een signaalkleur.', issue_number: 202, slug: '/status-badge', keywords: ['alert badge', 'badge', 'chip', 'counter', 'label', 'pill', 'status', 'status badge', 'status label', 'status marker', 'notification badge', 'notification label', 'stamp', 'tag'] },
    ...
    g = {},
    u = 'Status Badge',
    m = 'Label dat informeert over een status en de aandacht trekt met een signaalkleur.',
    c = 202,
   ...
   function x(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, s.jsx)(r.Fc, { component: h, headingLevel: 1, description: m }), '\n', (0, s.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, s.jsx)(r.VK, { component: h, headingLevel: 3 }), '\n', (0, s.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, s.jsx)(r.mu, { component: h, headingLevel: 3 }), '\n', (0, s.jsx)(r.K_, { component: h }), '\n', (0, s.jsx)(r.$9, { component: h, headingLevel: 2 })] });
   }
   function b(e = {}) {
               ...
               d.Z,
               {
                ...
                description: (0, m.jsxs)('div', {
                 ...
                 children: [
                  ...
                  (0, m.jsxs)('div', {
                   children: [
                    (h.length > 0 || g.length > 0) && (0, m.jsx)(s.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    h.length > 0 &&
                     (0, m.jsx)(t.dk, {
                      links: h
                  ...
                  g.length > 0 && g.map(({ frameworkName: e, tasks: a }) => (0, m.jsxs)('section', { children: [(0, m.jsxs)(s.DZ, { level: Math.min(n + 2, 6), children: [l, ' in ', e] }), (0, m.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, m.jsx)(r.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => s, KF: () => m, mJ: () => p, VZ: () => F, cR: () => D, Pv: () => x, qZ: () => l, kD: () => v, QQ: () => H, B2: () => c, Pc: () => o, f4: () => r, GT: () => k, fX: () => i, eQ: () => j, B_: () => f, o_: () => b });
