 ...
 [3981],
 {
  ...
  39772: (e, n, i) => {
   ...
   function o(e) {
    ...
    return (0, c.jsxs)('div', { className: 'card', children: [n ? (0, c.jsx)(r.Z, { href: n, className: (0, l.Z)('cardLink', 'utrecht-link'), children: (0, c.jsxs)('h2', { className: 'cardTitle', children: [i, ' ', t] }) }) : (0, c.jsxs)('h2', { className: 'cardTitle', children: [i, ' ', t] }), s && (0, c.jsx)('p', { className: 'cardDescription', children: s }), o] });
   }
   function d(e) {
    let { item: n } = e;
