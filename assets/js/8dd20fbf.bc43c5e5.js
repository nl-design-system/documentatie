...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [28631],
 {
  4258(e, n, t) {
   ...
   var r = t(78236),
    i = t(86070);
   const l = ({ id: e, title: n, ...t }) => (0, i.jsx)(r.A, { adNetwork: !1, announce: 'Bekijk', cookie: !1, id: e, title: n, poster: 'maxresdefault', ...t });
  },
  15638(e, n, t) {
   t.d(n, { $: () => c, x: () => d });
   var r = t(4077),
  ...
  18080(e, n, t) {
   ...
   var i = t(86070),
    ...
    a = t(15638);
   function d(e) {
    const n = { div: 'div', form: 'form', h2: 'h2', h3: 'h3', input: 'input', label: 'label', li: 'li', p: 'p', ul: 'ul', ...(0, l.R)(), ...e.components };
  ...
  18439(e, n, t) {
   ...
   function s(e) {
    let n;
    return ((n = e.disableParentContext ? ('function' == typeof e.components ? e.components(i) : e.components || i) : o(e.components)), r.createElement(l.Provider, { value: n }, e.children));
   }
  },
  58639(e, n, t) {
   t.d(n, { H: () => j });
   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: t = !1, displayCode: j = !0, children: b, container: f = 'document', language: x, designTokens: y }) => {
  ...
  69284(e, n, t) {
   ...
   function d({ lineNumber: e, syntax: n, textContent: t, trim: d }) {
    ...
    const { title: h, type: p } = (0, l.useContext)(o.x),
     u = (0, l.useId)();
    return (d && (c = c.trim()), (0, a.jsx)(i.f4, { theme: s, code: c, language: n || '', children: ({ style: n, tokens: t, getLineProps: i, getTokenProps: l }) => (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: u, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, a.jsx)(r.NG, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': u, style: n, children: t.map((n, t) => (0, a.jsxs)('span', { ...i({ line: n }), children: [e && (0, a.jsx)('span', { children: t + 1 }), n.map((e, n) => (0, a.jsx)('span', { ...l({ token: e }) }, n)), '\n'] }, t)) })] }) }));
   }
  },
  78236(e, n, t) {
   t.d(n, { A: () => s });
   ...
   function o(e, n, t, r, i) {
    const l = { '@context': 'https://schema.org', '@type': 'VideoObject', name: (null == i ? void 0 : i.name) || n, thumbnailUrl: [(null == i ? void 0 : i.thumbnailUrl) || t], embedUrl: (null == i ? void 0 : i.embedUrl) || `${r}/embed/${e}`, contentUrl: (null == i ? void 0 : i.contentUrl) || `https://www.youtube.com/watch?v=${e}`, ...((null == i ? void 0 : i.description) && { description: i.description }), ...((null == i ? void 0 : i.uploadDate) && { uploadDate: i.uploadDate }), ...((null == i ? void 0 : i.duration) && { duration: i.duration }) };
    ...
    return (
     ...
     (0, r.jsxs)(r.Fragment, {
      children: [
       ...
       (0, r.jsx)(r.Fragment, { children: t && (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)('link', { rel: 'preconnect', href: j }), (0, r.jsx)('link', { rel: 'preconnect', href: 'https://www.google.com' }), N && (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)('link', { rel: 'preconnect', href: 'https://static.doubleclick.net' }), (0, r.jsx)('link', { rel: 'preconnect', href: 'https://googleads.g.doubleclick.net' })] })] }) }),
       e.seo && !e.playlist && (0, r.jsx)('script', { type: 'application/ld+json', dangerouslySetInnerHTML: { __html: o(e.id, p, w, j, e.seo) } }),
       D && !e.playlist && (0, r.jsx)('noscript', { children: (0, r.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${p} on YouTube`, children: ['Watch "', p, '" on YouTube'] }) }),
       (0, r.jsxs)(L, {
        onPointerOver: () => {
         t || s(!0);
        },
        ...
        children: [e.lazyLoad && !a && (0, r.jsx)('img', { src: w, alt: `${p} - YouTube thumbnail`, className: 'lty-thumbnail', loading: 'lazy' }), (0, r.jsx)('button', { type: 'button', className: S, 'aria-label': `${m} ${p}`, 'aria-hidden': a || void 0, tabIndex: a ? -1 : 0, children: (0, r.jsx)('span', { className: 'lty-visually-hidden', children: m }) }), a && (0, r.jsx)('iframe', { ref: n, className: $, title: p, width: '560', height: '315', style: { border: 0 }, allow: 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture', allowFullScreen: !0, src: b, referrerPolicy: e.referrerPolicy || 'strict-origin-when-cross-origin' })],
       }),
      ],
     })
    );
