/*! For license information please see 9d33172e.96cfff1f.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [32537],
 {
  ...
  18652(e, n, i) {
   ...
   const o = (e, n, i, o) => {
    const r = (0, t.forwardRef)(({ color: i = 'currentColor', size: r = 24, stroke: l = 2, title: a, className: d, children: m, ...u }, h) => (0, t.createElement)('svg', { ref: h, ...s[e], width: r, height: r, className: ['tabler-icon', `tabler-icon-${n}`, d].join(' '), ...('filled' === e ? { fill: i } : { strokeWidth: l, stroke: i }), ...u }, [a && (0, t.createElement)('title', { key: 'svg-title' }, a), ...o.map(([e, n]) => (0, t.createElement)(e, n)), ...(Array.isArray(m) ? m : [m])]));
    return ((r.displayName = `${i}`), r);
   };
  },
  40535(e, n, i) {
   (i.r(n), i.d(n, { assets: () => u, contentTitle: () => m, default: () => j, frontMatter: () => d, metadata: () => t, toc: () => h }));
  ...
  45282(e, n, i) {
   ...
   const o = ({ children: e, ...n }) => {
    ...
    r = ({ className: e, ...n }) => (0, s.jsx)(o, { className: (0, t.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  88666(e, n, i) {
   i.d(n, { v: () => r });
   var t = i(45282),
