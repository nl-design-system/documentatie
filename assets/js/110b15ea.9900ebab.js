   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: j = !0, children: x, container: b = 'document', language: y, designTokens: f }) => {
    ...
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       k && (0, m.jsx)('div', { className: (0, l.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(P, { children: (0, m.jsx)(t.v$, { children: k }) }) }) }),
       j &&
        (0, m.jsx)('div', {
