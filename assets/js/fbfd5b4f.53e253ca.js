...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [22410],
 {
  ...
  36844(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => b, componentName: () => x, contentTitle: () => d, default: () => j, description: () => c, frontMatter: () => g, issueNumber: () => p, metadata: () => t, relayStep: () => h, title: () => m, toc: () => f }));
   ...
   var s = a(86070),
    ...
    l = a(56167),
    o = a(17842);
   const g = { title: 'Progress List', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Progress List', pagination_label: 'Progress List', description: 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.', issue_number: 150, slug: '/progress-list', keywords: ['lijst', 'meter', 'path', 'proceslijst', 'progress', 'progress bar', 'progress indicator', 'progress list', 'progress navigation', 'progress tracker', 'status', 'statusoverzicht', 'stepper', 'stepper indicator', 'stepper vertical', 'steps', 'tijdlijn', 'timeline', 'voortgangslijst', 'voortgangsproces'] },
    d = void 0,
    u = {},
    m = 'Progress List',
    c = 'Toont de voortgang van een reeks stappen en biedt indien nodig extra details over een stap.',
    p = 150,
    h = 'help wanted',
    x = 'progress-list',
