 ...
 [94209],
 {
  67637: (e, t, n) => {
   ...
   var r = n(52676),
    ...
    i = n(81133),
    s = n(8657);
   const o = { title: 'Note', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Note', pagination_label: 'Note', description: 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.', slug: '/note', keywords: ['spotlight', 'callout'] },
    a = void 0,
    u = { id: 'componenten/note/index', title: 'Note', description: 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.', source: '@site/docs/componenten/note/index.mdx', sourceDirName: 'componenten/note', slug: '/note', permalink: '/note', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/note/index.mdx', tags: [], version: 'current', frontMatter: { title: 'Note', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Note', pagination_label: 'Note', description: 'Visueel ondersteunend element dat de aandacht vestigt op aanvullende of belangrijke informatie.', slug: '/note', keywords: ['spotlight', 'callout'] }, sidebar: 'componenten', previous: { title: 'Navigation Bar', permalink: '/navigation-bar' }, next: { title: 'Notification Banner', permalink: '/notification-banner' } },
    l = {},
    h = [
  ...
  8657: (e, t, n) => {
   ...
   const _ = (e) => {
    ...
    A = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(p.V, { level: n, suffix: i && (0, l.jsx)(g.y, { state: i }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: c })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => g, BA: () => o, Ee: () => l, Q6: () => i, U: () => j, Yr: () => p, d: () => h, e9: () => s, fO: () => b, mA: () => c, ps: () => y, qU: () => k, s0: () => v, zP: () => m });
