 ...
 [3958],
 {
  1292(e, n, t) {
   ...
   var o = t(29181),
    ...
    a = t(83386),
    c = t(86070);
   const l = { figma: (0, c.jsx)(r.A, {}), github: (0, c.jsx)(s.A, {}), npm: (0, c.jsx)(i.A, {}), storybook: (0, c.jsx)(d.A, {}) },
    h = ({ brand: e }) => (0, c.jsx)(o.In, { children: l[e] || (0, c.jsx)(a.A, {}) });
  },
  12013(e, n, t) {
   'use strict';
   t.d(n, { o: () => l });
   ...
   const i = (e, n) => {
    ...
    d = { 1: {}, 2: { h1: r.fV, h2: r._B, h3: r.f_, h4: r.mM, h5: r.TT }, 3: { h1: r._B, h2: r.f_, h3: r.mM, h4: r.TT, h5: r.TT }, 4: { h1: r.f_, h2: r.mM, h3: r.TT, h4: r.TT, h5: r.TT }, 5: { h1: r.mM, h2: r.TT, h3: r.TT, h4: r.TT, h5: r.TT }, 6: { h1: r.TT, h2: r.TT, h3: r.TT, h4: r.TT, h5: r.TT } },
    ...
    l = ({ children: e, omitH1: n = !1, headingLevel: t = 1, baseUrl: r = '', components: i = {} }) => (0, s.jsx)(o.x, { components: { ...c(n, t), ...a(r), ...i }, children: e });
  },
  17045(e, n, t) {
   'use strict';
   t.d(n, { Ay: () => d, RM: () => s });
  ...
  17889(e, n, t) {
    ...
    return 'clipboard' in navigator
     ? (0, m.jsxs)(i.$n, {
        ...
        onClick: async function () {
         try {
          const e = await l.Ay.format(n, { parser: t, plugins: [d.A, a.Ay, c.Ay] });
   ...
   var g = t(35193),
    ...
    y = t(79532),
    w = t(30758);
   const A = { color: g.A, dimension: j.A, fontFamilies: k.A, fontSizes: x.A, fontWeights: b.A, lineHeights: v.A, other: f.A, textDecoration: y.A },
    _ = ({ type: e }) => (0, m.jsx)(p.In, { children: (0, w.createElement)(A[e]) });
   function S({ tokens: e }) {
    const n = (0, s.kD)(e),
     t = (0, s.GT)(n),
     d = t.map((e) => (0, s.B_)(e) + ': ;').join('\n'),
       ...
       children: [
        ...
        (0, m.jsx)(i.BF, {
         children: t.map((n) => {
          const t = (0, s.o_)(n),
           d = (0, s.eQ)(e, n).$type;
          return (0, m.jsxs)(i.Hj, { children: [(0, m.jsx)(i.nA, { children: (0, m.jsx)(o.C, { children: (0, m.jsx)(i.kf, { children: t }) }) }), (0, m.jsx)(i.nA, { children: (0, m.jsxs)(r.K, { children: [(0, m.jsx)(_, { type: d }), ' ', d] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, m.jsxs)(i.e2, { children: [(0, m.jsx)(u, { content: a, language: 'json', children: 'Kopieer als JSON' }), (0, m.jsx)(u, { content: d, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
  19316(e, n, t) {
   ...
   const g = [
     ...
     { title: 'Wanneer de achtergrondkleur van het Code Block anders is dan de default browserkleur, dan heeft deze een kleurcontrast van minimaal 3:1 met de achtergrondkleur van de pagina.', sc: '1.4.11', status: '', component: h.Ay, tags: ['designer', 'contentmaker'] },
    ],
    j = [
     {
     ...
     { title: 'Als je inzoomt naar 200% blijft alle tekst leesbaar.', sc: '1.4.4', status: '', component: u.Ay, tags: ['developer'] },
   ...
   function _(e) {
    ...
    return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(n.header, { children: (0, r.jsx)(n.h1, { id: 'gebruik-code-block', children: 'Gebruik Code Block' }) }), '\n', (0, r.jsx)(n.h2, { id: 'css', children: 'CSS' }), '\n', (0, r.jsx)(n.p, { children: 'De CSS van deze component is gepubliceerd in een npm package:' }), '\n', (0, r.jsx)(n.p, { children: (0, r.jsx)(n.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-css', children: '@nl-design-system-candidate/code-block-css' }) }), '\n', (0, r.jsxs)(n.p, { children: ['Gebruik de ', (0, r.jsx)(n.code, { children: 'nl-code-block' }), ' class name op een ', (0, r.jsx)(n.code, { children: 'pre' }), ' element met de ', (0, r.jsx)(n.code, { children: 'nl-code-block__code' }), ' class name op een ', (0, r.jsx)(n.code, { children: 'code' }), ' element:'] }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-html', children: '<pre dir="ltr" translate="no" class="nl-code-block">\n  <code class="nl-code-block__code">function addNumbers(a, b) {\n  return a + b;\n}</code>\n</pre>\n' }) }), '\n', (0, r.jsx)(n.p, { children: 'Je kunt de CSS zo in je project installeren:' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/code-block-css\n' }) }), '\n', (0, r.jsx)(n.p, { children: 'Als je een CDN gebruikt, dan kun je de CSS zo importeren:' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-html', children: '<link\n  rel="stylesheet"\n  href="https://cdn.jsdelivr.net/npm/@nl-design-system-candidate/code-block-css@1/dist/code-block.css"\n/>\n' }) }), '\n', (0, r.jsxs)(n.p, { children: ['Gebruik je geen CDN, dan kun je de CSS uit ', (0, r.jsx)(n.code, { children: 'node_modules/' }), ' importeren:'] }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-html', children: '<link rel="stylesheet" href="node_modules/@nl-design-system-candidate/code-block-css/dist/code-block.css" />\n' }) }), '\n', (0, r.jsx)(n.p, { children: 'Als je CSS imports gebruikt vanuit JavaScript:' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-js', children: 'import "@nl-design-system-candidate/code-block-css/code-block.css";\n' }) }), '\n', (0, r.jsx)(n.h2, { id: 'react', children: 'React' }), '\n', (0, r.jsx)(n.p, { children: 'De React component is gepubliceerd in een npm package:' }), '\n', (0, r.jsx)(n.p, { children: (0, r.jsx)(n.a, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-react', children: '@nl-design-system-candidate/code-block-react' }) }), '\n', (0, r.jsx)(n.p, { children: 'Je kunt de npm package zo installeren:' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-sh', children: 'npm install --save-dev @nl-design-system-candidate/code-block-react\n' }) }), '\n', (0, r.jsx)(n.p, { children: 'Je kunt de React component zo gebruiken:' }), '\n', (0, r.jsx)(n.pre, { children: (0, r.jsx)(n.code, { className: 'language-jsx', children: 'import { CodeBlock } from "@nl-design-system-candidate/code-block-react";\n\nexport const MyPage = () => {\n  return (\n    <html>\n      <body>\n        function addNumbers(a, b) {\n          return a + b;\n        }\n      </body>\n    </html>\n  );\n};\n' }) })] });
   }
   function S(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
   ...
   const D = { title: 'Code Block', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Code Block', pagination_label: 'Code Block', description: 'Blok met \xe9\xe9n of meerdere regels computercode.', slug: '/code-block', keywords: ['code', 'code block', 'code blok', 'code container', 'code example', 'code fences', 'code memo', 'code snippet', 'code snippet blok', 'code voorbeeld', 'code wrapper', 'codeblock', 'codepen', 'copy paste blok', 'css voorbeeld', 'html voorbeeld', 'inline code', 'monospace', 'monotype', 'pre', 'snippet', 'source code', 'source doc', 'toepassing', 'voorbeeld blok', 'Code Snippet', 'Code Blok', 'Code Example'] },
    ...
    B = [{ value: 'Checklist voor toegankelijkheid', id: 'checklist-voor-toegankelijkheid', level: 2 }, ...c.RM, { value: 'Acceptatiecriteria bij gebruik', id: 'acceptatiecriteria-bij-gebruik', level: 3 }, ...a.RM, { value: 'Acceptatiecriteria van de component', id: 'acceptatiecriteria-van-de-component', level: 3 }, ...d.RM, { value: 'CSS', id: 'css', level: 2 }, { value: 'React', id: 'react', level: 2 }, { value: 'Design tokens', id: 'design-tokens', level: 2 }, { value: 'Definition of Done', id: 'definition-of-done', level: 2 }, { value: 'Community implementaties', id: 'community-implementaties', level: 2 }];
   function F(e) {
    const n = { a: 'a', admonition: 'admonition', h2: 'h2', h3: 'h3', p: 'p', ...(0, s.R)(), ...e.components },
     { Checklist: t, ChecklistItem: o } = n;
    return (t || H('Checklist', !0), o || H('ChecklistItem', !0), (0, r.jsxs)(r.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', '\n', (0, r.jsx)(y.Fc, { component: R, headingLevel: 1, description: L }), '\n', (0, r.jsx)(f.e, { component: R }), '\n', (0, r.jsx)(n.admonition, { title: 'Tip', type: 'tip', children: (0, r.jsxs)(n.p, { children: ['Gebruik de ', (0, r.jsx)(n.a, { href: '/code/', children: 'Code' }), ' component als de code in een regel met andere tekst staat.'] }) }), '\n', (0, r.jsx)(k.Zp, { className: 'implementation-card', children: (0, r.jsxs)(k.Wu, { children: [(0, r.jsx)(b.D, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, r.jsxs)(x.dk, { children: [(0, r.jsxs)(x.Pt, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=13778-3553', children: [(0, r.jsx)(v.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, r.jsxs)(x.Pt, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=13778-3553', children: [(0, r.jsx)(v.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, r.jsx)(b.D, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, r.jsxs)(x.dk, { children: [(0, r.jsxs)(x.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-code-block--documentatie', children: [(0, r.jsx)(v.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, r.jsxs)(x.Pt, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/code-block--documentatie', children: [(0, r.jsx)(v.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, r.jsx)(b.D, { level: 2, appearance: 'level-4', children: 'npm' }), (0, r.jsxs)(x.dk, { children: [(0, r.jsxs)(x.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-css', children: [(0, r.jsx)(v.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-css'] }), (0, r.jsxs)(x.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-react', children: [(0, r.jsx)(v.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-react'] }), (0, r.jsxs)(x.Pt, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/code-block-tokens', children: [(0, r.jsx)(v.r, { brand: 'npm' }), ' @nl-design-system-candidate/code-block-tokens'] })] })] }) }), '\n', (0, r.jsx)(n.h2, { id: 'checklist-voor-toegankelijkheid', children: 'Checklist voor toegankelijkheid' }), '\n', (0, r.jsx)(c.Ay, {}), '\n', (0, r.jsx)(n.h3, { id: 'acceptatiecriteria-bij-gebruik', children: 'Acceptatiecriteria bij gebruik' }), '\n', (0, r.jsx)(a.Ay, {}), '\n', (0, r.jsx)(t, { headingLevel: '4', children: g.map(({ component: e, ...n }) => (0, r.jsx)(o, { ...n, children: (0, r.jsx)(e, {}) })) }), '\n', (0, r.jsx)(n.h3, { id: 'acceptatiecriteria-van-de-component', children: 'Acceptatiecriteria van de component' }), '\n', (0, r.jsx)(d.Ay, {}), '\n', (0, r.jsx)(t, { headingLevel: '4', children: j.map(({ component: e, ...n }) => (0, r.jsx)(o, { ...n, children: (0, r.jsx)(e, {}) })) }), '\n', (0, r.jsx)(A.o, { omitH1: !0, headingLevel: 2, children: (0, r.jsx)(S, {}) }), '\n', (0, r.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }), '\n', (0, r.jsx)(w.B, { tokens: N }), '\n', (0, r.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, r.jsx)(y.VK, { component: R, headingLevel: 3 }), '\n', (0, r.jsx)(y.$9, { component: R, headingLevel: 2 }), '\n', (0, r.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, r.jsx)(y.mu, { component: R, headingLevel: 3 })] }));
   }
   function V(e = {}) {
    const { wrapper: n } = { ...(0, s.R)(), ...e.components };
  ...
  33062(e, n, t) {
   'use strict';
   t.d(n, { bo: () => r, KF: () => p, mJ: () => g, VZ: () => A, cR: () => w, Pv: () => j, qZ: () => i, kD: () => v, B2: () => m, Pc: () => a, f4: () => d, GT: () => f, fX: () => s, eQ: () => b, B_: () => x, o_: () => k, Rc: () => y });
   ...
   const h = (e) => [...e].sort((e, n) => c.indexOf(e) - c.indexOf(n)),
    ...
    g = (e) => h(l(e.projects.flatMap((e) => u(e)))),
    j = (e) => {
     const n = u(e),
      t = ((e) => {
      ...
      const o = e.tasks
       ...
       .map(({ name: o, id: r, value: s }) => {
        const i = /^(.+) URL/.exec(o)[1],
         d = 'Storybook' === i ? `${t} (${n}) in Storybook van ${e.title}` : `${t} (${n}) op ${i}`;
        return { brand: i.toLowerCase(), name: o, id: r, value: s, description: d };
       });
  ...
  72401(e, n, t) {
   ...
   const d = ({ component: e }) => {
    const { title: n } = e,
     d = (0, s.fX)(n),
     a = r.lazy(() => t(82839)(`./${d}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
    return (0, i.jsx)(r.Suspense, { fallback: null, children: (0, i.jsx)(o.o, { omitH1: !0, headingLevel: 1, children: (0, i.jsx)(a, {}) }) });
   };
  },
  72642(e, n, t) {
   'use strict';
            ...
            i.Zp,
            {
             ...
             children: (0, c.jsxs)(i.Wu, {
              children: [
               ...
               (h.length > 0 || d.length > 0) && (0, c.jsx)(o.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               h.length > 0 &&
                (0, c.jsx)(c.Fragment, {
               ...
               d.length > 0 && (0, c.jsx)(c.Fragment, { children: d.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(o.DZ, { level: n + 2, children: [r, ' in ', e] }), (0, c.jsx)(o.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
  ...
  90495(e, n, t) {
   ...
   const i = ({ background: e, children: n, className: t, ...o }) => (0, s.jsx)('div', { className: (0, r.A)('card__illustration', e && `card__illustration--${e}`, t), ...o, children: n }),
    d = (e) => (0, s.jsx)('div', { className: 'card__content', ...e }),
    a = ({ href: e, appearance: n, className: t, component: i = 'div', background: d, children: a }) => {
     const c = (e) => ('article' === i ? (0, s.jsx)('article', { ...e }) : 'section' === i ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      l = (0, s.jsx)(c, { className: (0, r.A)('cardgroup__card', d && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, t), children: a });
