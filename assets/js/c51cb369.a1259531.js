/*! For license information please see c51cb369.a1259531.js.LICENSE.txt */
'use strict';
 ...
 [92229],
 {
  ...
  14881(e, n, a) {
   ...
   const o = (0, i.forwardRef)(({ as: e, className: n, children: a, ...i }, r) => {
    ...
    g = ({ className: e, classNamePanel: n, label: a, heading: i, headingLevel: o, headingApperance: g, ...d }) => {
     ...
     return (0, s.jsxs)('details', { className: u, ...d, children: [(0, s.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, s.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, s.jsx)('span', { className: 'nl-button__icon-start', children: (0, s.jsx)(r.A, {}) }), (0, s.jsxs)('span', { className: 'nl-button__label', children: [i && (0, s.jsx)(l.D, { level: o, appearance: g, children: i }), a] })] }) }), (0, s.jsx)('div', { className: c, children: d.children })] });
    };
  },
  15089(e, n, a) {
   a.d(n, { A: () => l });
  ...
  26877(e, n, a) {
   ...
   const b = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, d.jsx)(v.n, { children: i.map((a) => (0, d.jsx)(v.K, { className: (0, l.A)('ma-definition-of-done', a && `ma-definition-of-done--${(0, p.fX)(a.title)}`), heading: a ? `${a.title} - ${a.progress.value} van ${a.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(h._, { children: a.tasks.map(({ checked: e, name: a, id: t }) => (0, d.jsx)(h.Z, { headingLevel: n + 1, checked: e, heading: a, description: (0, p.qZ)(t) }, t)) }), (0, d.jsx)(t.fz, { children: (0, d.jsxs)(t.N_, { href: `${a.url}?filterQuery=${e.title}`, children: [a.title, ' projectbord op GitHub'] }) })] }) }, a.title)) });
    },
            ...
            ? (0, d.jsx)(
               g.Z,
               {
                ...
                description: (0, d.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, d.jsxs)(r.f, { children: [(0, d.jsx)(u, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, d.jsxs)(t.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, d.jsxs)('div', {
                   children: [
                    (h.length > 0 || c.length > 0) && (0, d.jsx)(i.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    h.length > 0 &&
                     (0, d.jsx)(t.dk, {
                      links: h
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: a }) => (0, d.jsxs)('section', { children: [(0, d.jsxs)(i.DZ, { level: Math.min(n + 2, 6), children: [l, ' in ', e] }), (0, d.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, d.jsx)(s.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
               ...
               o.Zp,
               {
                ...
                children: (0, d.jsxs)(o.Wu, {
                 children: [
                  ...
                  (h.length > 0 || c.length > 0) && (0, d.jsx)(t.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  h.length > 0 &&
                   (0, d.jsx)(d.Fragment, {
                  ...
                  c.length > 0 && (0, d.jsx)(d.Fragment, { children: c.map(({ frameworkName: e, tasks: a }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.DZ, { level: n + 2, children: [l, ' in ', e] }), (0, d.jsx)(t.dk, { links: a.map((e) => ({ children: e.description, icon: (0, d.jsx)(s.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
    ...
    w = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: i && (0, d.jsx)(c.D, { state: i }), children: e.title }), (0, d.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(i) && (0, d.jsx)(x.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    N = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
  ...
  50172(e, n, a) {
   ...
   function g(e) {
    ...
    if ('string' == typeof e || 'number' == typeof e) t += e;
     ...
     if (Array.isArray(e)) {
      var i = e.length;
      for (n = 0; n < i; n++) e[n] && (a = g(e[n])) && (t && (t += ' '), (t += a));
     } else for (a in e) e[a] && (t && (t += ' '), (t += a));
    return t;
   }
   function d() {
    for (var e, n, a = 0, t = '', i = arguments.length; a < i; a++) (e = arguments[a]) && (n = g(e)) && (t && (t += ' '), (t += n));
    return t;
   }
   const u = ({ level: e = 2, children: n, ...a }) => {
    ...
    c = (0, o.forwardRef)(({ heading: e, headingLevel: n = 2, subheading: a, description: i, metadata: r, image: l, href: o, target: g, linkLabel: c, title: m, className: h, children: p, ...f }, v) => (0, t.jsxs)('div', { className: d('rhc-card', 'rhc-card--default', h), ref: v, ...f, children: [l && (0, t.jsx)('div', { className: 'rhc-card__image', children: l }), (0, t.jsxs)('div', { className: 'rhc-card__content', children: [(0, t.jsx)(u, { className: 'rhc-card__heading', level: n, children: o ? (0, t.jsx)(s, { className: 'rhc-card__link', href: o, target: g, title: m, children: e }) : e }), a && (0, t.jsx)('p', { className: 'rhc-card__subheading', children: a }), i && (0, t.jsx)('p', { className: 'rhc-card__description', children: i }), r && (0, t.jsx)('p', { className: 'rhc-card__metadata', children: r }), p] }), c && (0, t.jsx)('div', { className: 'rhc-card__footer', children: (0, t.jsx)('div', { className: 'rhc-card__link', 'data-testid': 'rhc-card__link', children: (0, t.jsx)(s, { href: o, target: g, title: m, children: c }) }) })] }));
   c.displayName = 'Card';
  },
  63009(e, n, a) {
   a.d(n, { N: () => u });
   ...
   function d(e) {
    for (var n = 1; n < arguments.length; n++) {
     ...
     n % 2
      ? g(Object(a), !0).forEach(function (n) {
         (0, t.A)(e, n, a[n]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(a))
        : g(Object(a)).forEach(function (n) {
   ...
   var u = (0, s.forwardRef)(function (e, n) {
    var a = e.children,
     ...
     m = e.inlineBox,
     h = (0, i.A)(e, o);
    return (0, r.jsx)('a', d(d({ 'aria-current': g || void 0, 'aria-disabled': u, className: (0, l.$)('nl-link', (0, t.A)((0, t.A)((0, t.A)({}, 'nl-link--current', g), 'nl-link--disabled', u), 'nl-link--inline-box', m), s), href: u ? void 0 : c, role: u ? 'link' : void 0, ref: n, tabIndex: u ? 0 : void 0 }, h), {}, { children: a }));
   });
   u.displayName = 'Link';
  },
  66153(e, n, a) {
  ...
  70857(e, n, a) {
   (a.r(n), a.d(n, { assets: () => d, component: () => f, componentName: () => p, contentTitle: () => g, default: () => b, description: () => c, frontMatter: () => o, issueNumber: () => m, metadata: () => t, relayStep: () => h, title: () => u, toc: () => v }));
   ...
   const o = { title: 'Language Navigation', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Language Navigation', pagination_label: 'Language Navigation', description: 'E\xe9n of meerdere links om de website te openen in een andere taal.', issue_number: 243, slug: '/language-navigation', keywords: ['language', 'language choices', 'language menu', 'language navigation', 'language options', 'language selection', 'language switcher', 'language switcher menu', 'multilingual', 'switcher', 'taal', 'taalkeuze', 'taalmenu', 'taalnavigatie', 'taalopties', 'taalselectie', 'translate', 'translate navigation', 'translator', 'vertaling', 'vlag', 'vlaggen'] },
    ...
    c = 'E\xe9n of meerdere links om de website te openen in een andere taal.',
    m = 243,
    h = 'help wanted',
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => i, KF: () => c, mJ: () => p, VZ: () => N, cR: () => w, Pv: () => f, qZ: () => l, kD: () => j, QQ: () => D, B2: () => m, Pc: () => o, f4: () => s, GT: () => k, fX: () => r, eQ: () => b, B_: () => x, o_: () => v });
