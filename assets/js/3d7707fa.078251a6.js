...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [79280],
 {
  ...
  13807(e, n, t) {
   (t.r(n), t.d(n, { assets: () => L, component: () => _, contentTitle: () => H, default: () => P, description: () => T, frontMatter: () => S, issueNumber: () => R, metadata: () => r, title: () => C, toc: () => B }));
   ...
   const y = [
     ...
     { title: 'De Alert is niet bereikbaar en bedienbaar met het toetsenbord.', sc: '2.1.1', status: '', component: f.Ay, tags: ['developer'] },
     {
    ...
    L = {},
    C = 'Alert',
    T = 'Belangrijk bericht dat informeert over de huidige activiteit van de gebruiker.',
    R = 9,
  ...
  21034(e, n, t) {
   ...
   const f = ({ component: e, headingLevel: n }) => {
    ...
    k = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u.p, { level: n, suffix: i && (0, d.jsx)(g.D, { state: i }), children: e.title }), (0, d.jsx)(r.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(i) && (0, d.jsx)(x.s, { relayStep: i, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    w = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
  ...
  32385(e, n, t) {
   t.d(n, { bo: () => i, KF: () => u, mJ: () => p, VZ: () => A, cR: () => w, Pv: () => j, qZ: () => o, kD: () => b, QQ: () => z, B2: () => m, Pc: () => l, f4: () => s, GT: () => k, fX: () => a, eQ: () => v, B_: () => f, o_: () => x });
  ...
  70348(e, n, t) {
   ...
   const s = ({ className: e, ...n }) => {
    ...
    l = ({ className: e, classNamePanel: n, label: t, heading: s, headingLevel: l, headingApperance: d, ...c }) => {
     ...
     return (0, o.jsxs)('details', { className: g, ...c, children: [(0, o.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, o.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, o.jsx)('span', { className: 'nl-button__icon-start', children: (0, o.jsx)(i.A, {}) }), (0, o.jsxs)('span', { className: 'nl-button__label', children: [s && (0, o.jsx)(a.D, { level: l, appearance: d, children: s }), t] })] }) }), (0, o.jsx)('div', { className: u, children: c.children })] });
    };
  },
  70561(e, n, t) {
   t.d(n, { Ay: () => s, RM: () => a });
