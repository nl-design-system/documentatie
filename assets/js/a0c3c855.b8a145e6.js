...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [94977],
 {
   ...
   const d = (0, c.createContext)({}),
    p = ({ title: e, appearance: n, description: l, children: c, figure: p }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      h = p ? 'figure' : 'div',
      m = p ? 'figcaption' : 'div',
      g = 'string' == typeof l ? (0, a.jsx)(r.oz, { children: l }) : l;
  ...
  58639(e, n, l) {
   ...
   const j = ({ children: e }) => (0, h.jsx)(t.ui, { className: 'nlds-canvas__example-surface', children: e });
   j.displayName = 'SurfaceContainer';
   const b = ({ code: e, copy: n = !0, defaultExpandedCode: l = !1, displayCode: b = !0, children: y, container: v = 'document', language: f, designTokens: x }) => {
    ...
    let z = p.Fragment;
    return (
     'paragraph' === v ? (z = m) : 'document' === v ? (z = g) : 'surface' === v && (z = j),
     (0, h.jsxs)('div', {
      className: (0, o.A)('nlds-canvas'),
      children: [
       k && (0, h.jsx)('div', { className: (0, o.A)('nlds-canvas__example'), children: (0, h.jsx)('div', { className: 'voorbeeld-theme', style: x, children: (0, h.jsx)(z, { children: (0, h.jsx)(t.v$, { children: k }) }) }) }),
       b &&
        (0, h.jsx)('div', {
  ...
  93741(e, n, l) {
   (l.r(n), l.d(n, { assets: () => b, contentTitle: () => j, default: () => f, frontMatter: () => g, metadata: () => s, toc: () => y }));
