/*! For license information please see 67916.660e57db.js.LICENSE.txt */
 ...
 [67916],
 {
  ...
  62478(e, n, t) {
   ...
   const Xe = {
    tokenize: function (e, n, t) {
     return function (n) {
      return He(n) ? Ve(e, r, 'linePrefix')(n) : r(n);
     };
     function r(e) {
   ...
   const an = {
    ...
    tokenize: function (e, n, t) {
     ...
     function l(n) {
      return n === r ? (e.consume(n), o++, l) : (e.exit('thematicBreakSequence'), He(n) ? Ve(e, i, 'whitespace')(n) : i(n));
     }
    },
   };
   const sn = {
   ...
   const fn = {
    ...
    continuation: {
     tokenize: function (e, n, t) {
      const r = this;
      return function (n) {
       if (He(n)) return Ve(e, o, 'linePrefix', r.parser.constructs.disable.null.includes('codeIndented') ? void 0 : 4)(n);
       return o(n);
      };
      function o(r) {
   ...
   function mn(e, n) {
    ...
    return function r(o) {
     ...
     if (He(o)) return Ve(e, r, t ? 'linePrefix' : 'lineSuffix')(o);
     return n(o);
    };
   }
   function gn(e) {
   ...
   const yn = {
     ...
     tokenize: function (e, n, t) {
      ...
      function c(n) {
       return He(n) ? Ve(e, u, 'whitespace')(n) : u(n);
      }
      function u(i) {
    ...
    xn = {
     tokenize: function (e, n, t) {
      ...
      function o(n) {
       return He(n) ? Ve(e, i, 'whitespace')(n) : i(n);
      }
      function i(e) {
       return null === e || _e(e) ? n(e) : t(e);
      }
   ...
   const bn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function i(t) {
      return 35 === t ? (e.enter('atxHeadingSequence'), l(t)) : null === t || _e(t) ? (e.exit('atxHeading'), n(t)) : He(t) ? Ve(e, i, 'whitespace')(t) : (e.enter('atxHeadingText'), a(t));
     }
     function l(n) {
   ...
   const wn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function i(n) {
      return n === o ? (e.consume(n), i) : (e.exit('setextHeadingLineSequence'), He(n) ? Ve(e, l, 'lineSuffix')(n) : l(n));
     }
     function l(r) {
   ...
   const Sn = ['address', 'article', 'aside', 'base', 'basefont', 'blockquote', 'body', 'caption', 'center', 'col', 'colgroup', 'dd', 'details', 'dialog', 'dir', 'div', 'dl', 'dt', 'fieldset', 'figcaption', 'figure', 'footer', 'form', 'frame', 'frameset', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'head', 'header', 'hr', 'html', 'iframe', 'legend', 'li', 'link', 'main', 'menu', 'menuitem', 'nav', 'noframes', 'ol', 'optgroup', 'option', 'p', 'param', 'search', 'section', 'summary', 'table', 'tbody', 'td', 'tfoot', 'th', 'thead', 'title', 'tr', 'track', 'ul'],
    ...
    Cn = {
     ...
     tokenize: function (e, n, t) {
      ...
      function g(n) {
       return He(n) ? (e.consume(n), g) : E(n);
      }
      function y(n) {
       return 47 === n ? (e.consume(n), E) : 58 === n || 95 === n || De(n) ? (e.consume(n), x) : He(n) ? (e.consume(n), y) : E(n);
      }
      function x(n) {
      ...
      function C(n) {
       return null === n || _e(n) ? P(n) : He(n) ? (e.consume(n), C) : t(n);
      }
      function P(n) {
       return 45 === n && 2 === o ? (e.consume(n), O) : 60 === n && 1 === o ? (e.consume(n), L) : 62 === n && 4 === o ? (e.consume(n), F) : 63 === n && 3 === o ? (e.consume(n), M) : 93 === n && 5 === o ? (e.consume(n), z) : !_e(n) || (6 !== o && 7 !== o) ? (null === n || _e(n) ? (e.exit('htmlFlowData'), I(n)) : (e.consume(n), P)) : (e.exit('htmlFlowData'), e.check(Pn, j, I)(n));
      }
      function I(n) {
   ...
   const Tn = {
    ...
    An = {
     ...
     tokenize: function (e, n, t) {
      const r = this,
       o = {
        tokenize: function (e, n, t) {
         ...
         function s(n) {
          return e.enter('codeFencedFence'), He(n) ? Ve(e, c, 'linePrefix', r.parser.constructs.disable.null.includes('codeIndented') ? void 0 : 4)(n) : c(n);
         }
         function c(n) {
          return n === i ? (e.enter('codeFencedFenceSequence'), u(n)) : t(n);
         }
         function u(n) {
          return n === i ? (o++, e.consume(n), u) : o >= a ? (e.exit('codeFencedFenceSequence'), He(n) ? Ve(e, f, 'whitespace')(n) : f(n)) : t(n);
         }
         function f(r) {
      ...
      function s(n) {
       return n === i ? (a++, e.consume(n), s) : a < 3 ? t(n) : (e.exit('codeFencedFenceSequence'), He(n) ? Ve(e, c, 'whitespace')(n) : c(n));
      }
      function c(t) {
      ...
      function u(n) {
       return null === n || _e(n) ? (e.exit('chunkString'), e.exit('codeFencedFenceInfo'), c(n)) : He(n) ? (e.exit('chunkString'), e.exit('codeFencedFenceInfo'), Ve(e, f, 'whitespace')(n)) : 96 === n && n === i ? t(n) : (e.consume(n), u);
      }
      function f(n) {
      ...
      function m(n) {
       return l > 0 && He(n) ? Ve(e, g, 'linePrefix', l + 1)(n) : g(n);
      }
      function g(n) {
   ...
   const Vn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function w(n) {
      return _e(n) ? ((l = w), D(n)) : He(n) ? (e.consume(n), w) : L(n);
     }
     function S(n) {
      return 45 === n || ze(n) ? (e.consume(n), S) : 47 === n || 62 === n || Be(n) ? E(n) : t(n);
     }
     function E(n) {
      return 47 === n ? (e.consume(n), L) : 58 === n || 95 === n || De(n) ? (e.consume(n), C) : _e(n) ? ((l = E), D(n)) : He(n) ? (e.consume(n), E) : L(n);
     }
     function C(n) {
      return 45 === n || 46 === n || 58 === n || 95 === n || ze(n) ? (e.consume(n), C) : P(n);
     }
     function P(n) {
      return 61 === n ? (e.consume(n), I) : _e(n) ? ((l = P), D(n)) : He(n) ? (e.consume(n), P) : E(n);
     }
     function I(n) {
      return null === n || 60 === n || 61 === n || 62 === n || 96 === n ? t(n) : 34 === n || 39 === n ? (e.consume(n), (o = n), T) : _e(n) ? ((l = I), D(n)) : He(n) ? (e.consume(n), I) : (e.consume(n), A);
     }
     function T(n) {
      return n === o ? (e.consume(n), (o = void 0), O) : null === n ? t(n) : _e(n) ? ((l = T), D(n)) : (e.consume(n), T);
     }
     function A(n) {
      return null === n || 34 === n || 39 === n || 60 === n || 61 === n || 96 === n ? t(n) : 47 === n || 62 === n || Be(n) ? E(n) : (e.consume(n), A);
     }
     function O(e) {
     ...
     function z(n) {
      return He(n) ? Ve(e, M, 'linePrefix', r.parser.constructs.disable.null.includes('codeIndented') ? void 0 : 4)(n) : M(n);
     }
     function M(n) {
   ...
   const Xn = { 42: sn, 43: sn, 45: sn, 48: sn, 49: sn, 50: sn, 51: sn, 52: sn, 53: sn, 54: sn, 55: sn, 56: sn, 57: sn, 62: fn },
    Yn = { 91: yn },
    $n = { [-2]: vn, [-1]: vn, 32: vn },
    Jn = { 35: bn, 42: an, 45: [wn, an], 60: Cn, 61: wn, 95: an, 96: An, 126: An },
    Zn = { 38: Dn, 92: zn },
    Gn = { [-5]: Mn, [-4]: Mn, [-3]: Mn, 33: _n, 38: Dn, 42: Hn, 60: [qn, Vn], 91: Wn, 92: [Kn, zn], 93: Fn, 95: Hn, 96: Qn },
    et = { null: [Hn, Ze] },
    nt = { null: [42, 95] },
    tt = { null: [] };
   function rt(e) {
      ...
      if ('children' in o && o.children) {
       ...
       if (n.children && 'skip' !== p[0])
        for (u = (r ? n.children.length : -1) + l, f = s.concat(n); u > -1 && u < n.children.length; ) {
         ...
         if (((c = e(t, u, f)()), false === c[0])) return c;
      ...
      const t = n || Ht,
       ...
       a = {
        all: function (e) {
         ...
         if ('children' in e) {
          ...
          for (; ++r < t.length; ) {
           const o = a.one(t[r], e);
           if (o) {
            if (r && 'break' === t[r - 1].type && (Array.isArray(o) || 'text' !== o.type || (o.value = Kt(o.value)), !Array.isArray(o) && 'element' === o.type)) {
             const e = o.children[0];
             e && 'text' === e.type && (e.value = Kt(e.value));
            }
        ...
        one: function (e, n) {
         ...
         return (a.options.unknownHandler || Vt)(a, e, n);
        },
        options: t,
        patch: Ut,
        wrap: Wt,
   ...
   class fr extends cr {
    ...
    copy() {
     ...
     return e.data($t(!0, {}, this.namespace)), e;
    }
    data(e, n) {
     return 'string' == typeof e ? (2 === arguments.length ? (mr('data', this.frozen), (this.namespace[e] = n), this) : (ur.call(this.namespace, e) && this.namespace[e]) || void 0) : e ? (mr('data', this.frozen), (this.namespace = e), this) : this.namespace;
    }
    freeze() {
    ...
    use(e, ...n) {
     ...
     function i(e) {
      ...
      l(e.plugins), e.settings && (r.settings = $t(!0, r.settings, e.settings));
     }
     function l(e) {
      let n = -1;
      if (null == e);
   ...
   function Er(e) {
    ...
    return pr().use(ht).use(t).use(Xt, r).use(n);
   }
   function Cr(e) {
    const n = e.children || '',
     t = new ir();
   ...
   function Pr(e, n) {
    const t = n.allowedElements,
     ...
     s = n.urlTransform || Ir;
    for (const c of wr) Object.hasOwn(n, c.from) && (c.from, c.to && c.to, c.id);
    return (
     zt(e, function (e, n, o) {
