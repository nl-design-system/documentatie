(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [26350],
 {
  25359(e, n, t) {
   ...
   var o = {};
   (t.r(o), t.d(o, { attentionMarkers: () => nt, contentInitial: () => Qn, disable: () => tt, document: () => Yn, flow: () => Xn, flowInitial: () => Jn, insideSpan: () => et, string: () => Zn, text: () => Gn }));
   ...
   function Pe(e) {
    ...
    for (; ++u < e.length; ) {
     ...
     if ('enter' === t[0]) t[1].contentType && (Object.assign(n, Ie(e, u)), (u = n[u]), (s = !0));
      ...
      r && ((t[1].end = Object.assign({}, e[r][1].start)), (l = e.slice(r, u)), l.unshift(t), Ce(e, r, u - r + 1, l));
     }
    }
    return !s;
   }
     ...
     tokenize: function (e) {
      ...
      function s(e) {
       if ((l++, n.containerState._closeFlow)) {
        ...
        return (Ce(n.events, i + 1, 0, n.events.slice(t)), (n.events.length = a), u(e));
       }
       return a(e);
      }
      function u(o) {
   ...
   const Qe = {
     tokenize: function (e, n) {
      ...
      function r(n) {
       return null === n ? o(n) : _e(n) ? e.check(Je, i, o)(n) : (e.consume(n), r);
      }
      function o(t) {
   ...
   function ln(e, n, t) {
    ...
    const u = {
     ...
     c = {
      ...
      write: function (e) {
       ...
       return (v(n, 0), (c.events = on(i, c.events, c)), c.events);
      },
     };
    let f,
    ...
    function v(e, n) {
     (e.resolveAll && !i.includes(e) && i.push(e), e.resolve && Ce(c.events, n, c.events.length - n, e.resolve(c.events.slice(n), c)), e.resolveTo && (c.events = e.resolveTo(c.events, c)));
    }
    function k() {
   ...
   const sn = {
     ...
     tokenize: function (e, n, t) {
      ...
      return function (n) {
       ...
       if ('listUnordered' === o ? !r.containerState.marker || n === r.containerState.marker : Fe(n)) {
      ...
      function a(n) {
       return Fe(n) && ++l < 10 ? (e.consume(n), a) : (!r.interrupt || l < 2) && (r.containerState.marker ? n === r.containerState.marker : 41 === n || 46 === n) ? (e.exit('listItemValue'), s(n)) : t(n);
      }
      function s(n) {
       return (e.enter('listItemMarker'), e.consume(n), e.exit('listItemMarker'), (r.containerState.marker = r.containerState.marker || n), e.check(Ye, r.interrupt ? t : u, e.attempt(un, f, c)));
      }
      function u(e) {
     ...
     continuation: {
      tokenize: function (e, n, t) {
       const r = this;
       return ((r.containerState._closeFlow = void 0), e.check(Ye, o, i));
       function o(t) {
   ...
   function pn(e, n, t, r, o, i, l, a, s) {
    ...
    return function (n) {
     ...
     if (null === n || 32 === n || 41 === n || je(n)) return t(n);
    ...
    function h(o) {
     return c || (null !== o && 41 !== o && !Be(o)) ? (c < u && 40 === o ? (e.consume(o), c++, h) : 41 === o ? (e.consume(o), c--, h) : null === o || 32 === o || 40 === o || je(o) ? t(o) : (e.consume(o), 92 === o ? m : h)) : (e.exit('chunkString'), e.exit(a), e.exit(l), e.exit(r), n(o));
    }
    function m(n) {
   ...
   const Sn = ['address', 'article', 'aside', 'base', 'basefont', 'blockquote', 'body', 'caption', 'center', 'col', 'colgroup', 'dd', 'details', 'dialog', 'dir', 'div', 'dl', 'dt', 'fieldset', 'figcaption', 'figure', 'footer', 'form', 'frame', 'frameset', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'head', 'header', 'hr', 'html', 'iframe', 'legend', 'li', 'link', 'main', 'menu', 'menuitem', 'nav', 'noframes', 'ol', 'optgroup', 'option', 'p', 'param', 'search', 'section', 'summary', 'table', 'tbody', 'td', 'tfoot', 'th', 'thead', 'title', 'tr', 'track', 'ul'],
     ...
     tokenize: function (e, n, t) {
      ...
      function h(a) {
       if (null === a || 47 === a || 62 === a || Be(a)) {
        const s = 47 === a,
         u = l.toLowerCase();
        return s || i || !Cn.includes(u) ? (Sn.includes(l.toLowerCase()) ? ((o = 6), s ? (e.consume(a), m) : r.interrupt ? n(a) : P(a)) : ((o = 7), r.interrupt && !r.parser.lazy[r.now().line] ? t(a) : i ? g(a) : y(a))) : ((o = 1), r.interrupt ? n(a) : P(a));
       }
      ...
      function g(n) {
       return Ue(n) ? (e.consume(n), g) : C(n);
      }
      function y(n) {
       return 47 === n ? (e.consume(n), C) : 58 === n || 95 === n || De(n) ? (e.consume(n), x) : Ue(n) ? (e.consume(n), y) : C(n);
      }
      function x(n) {
      ...
      function E(n) {
       return null === n || _e(n) ? P(n) : Ue(n) ? (e.consume(n), E) : t(n);
      }
      function P(n) {
       return 45 === n && 2 === o ? (e.consume(n), O) : 60 === n && 1 === o ? (e.consume(n), L) : 62 === n && 4 === o ? (e.consume(n), j) : 63 === n && 3 === o ? (e.consume(n), M) : 93 === n && 5 === o ? (e.consume(n), z) : !_e(n) || (6 !== o && 7 !== o) ? (null === n || _e(n) ? (e.exit('htmlFlowData'), I(n)) : (e.consume(n), P)) : (e.exit('htmlFlowData'), e.check(Pn, F, I)(n));
      }
      function I(n) {
       return e.check(In, T, F)(n);
      }
      function T(n) {
      ...
      function D(n) {
       if (62 === n) {
        ...
        return Cn.includes(t) ? (e.consume(n), j) : P(n);
       }
      ...
      function j(n) {
       return null === n || _e(n) ? (e.exit('htmlFlowData'), F(n)) : (e.consume(n), j);
      }
      function F(t) {
    ...
    Pn = {
     tokenize: function (e, n, t) {
      return function (r) {
       return (e.enter('lineEnding'), e.consume(r), e.exit('lineEnding'), e.attempt(Ye, n, t));
      };
     },
     partial: !0,
    },
   ...
   const Tn = {
    ...
    An = {
     ...
     tokenize: function (e, n, t) {
      ...
      function u(t) {
       return null === t || _e(t) ? (e.exit('codeFencedFence'), r.interrupt ? n(t) : e.check(Tn, d, x)(t)) : (e.enter('codeFencedFenceInfo'), e.enter('chunkString', { contentType: 'string' }), c(t));
      }
      function c(n) {
   ...
   const Dn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function s(n) {
      return 88 === n || 120 === n ? (e.enter('characterReferenceMarkerHexadecimal'), e.consume(n), e.exit('characterReferenceMarkerHexadecimal'), e.enter('characterReferenceValue'), (o = 6), (i = Re), u) : (e.enter('characterReferenceValue'), (o = 7), (i = Fe), u(n));
     }
     function u(a) {
      if (59 === a && l) {
   ...
   const jn = {
     ...
     tokenize: function (e, n, t) {
      ...
      function a(n) {
       return 40 === n ? e.attempt(Fn, u, i ? u : c)(n) : 91 === n ? e.attempt(Rn, u, i ? s : c)(n) : i ? u(n) : c(n);
      }
      function s(n) {
   ...
   const Vn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function a(r) {
      return 62 === r ? (e.exit('autolinkProtocol'), e.enter('autolinkMarker'), e.consume(r), e.exit('autolinkMarker'), e.exit('autolink'), n) : null === r || 32 === r || 60 === r || je(r) ? t(r) : (e.consume(r), a);
     }
     function s(n) {
   ...
   const qn = {
    ...
    tokenize: function (e, n, t) {
     ...
     function S(n) {
      return 45 === n || ze(n) ? (e.consume(n), S) : 47 === n || 62 === n || Be(n) ? C(n) : t(n);
     }
     function C(n) {
      return 47 === n ? (e.consume(n), L) : 58 === n || 95 === n || De(n) ? (e.consume(n), E) : _e(n) ? ((l = C), D(n)) : Ue(n) ? (e.consume(n), C) : L(n);
     }
     function E(n) {
      return 45 === n || 46 === n || 58 === n || 95 === n || ze(n) ? (e.consume(n), E) : P(n);
     }
     function P(n) {
      return 61 === n ? (e.consume(n), I) : _e(n) ? ((l = P), D(n)) : Ue(n) ? (e.consume(n), P) : C(n);
     }
     function I(n) {
   ...
   const Yn = { 42: sn, 43: sn, 45: sn, 48: sn, 49: sn, 50: sn, 51: sn, 52: sn, 53: sn, 54: sn, 55: sn, 56: sn, 57: sn, 62: fn },
    Qn = { 91: yn },
    Jn = { [-2]: vn, [-1]: vn, 32: vn },
    Xn = { 35: bn, 42: an, 45: [wn, an], 60: En, 61: wn, 95: an, 96: An, 126: An },
    Zn = { 38: Dn, 92: zn },
    Gn = { [-5]: Mn, [-4]: Mn, [-3]: Mn, 33: _n, 38: Dn, 42: Un, 60: [Vn, qn], 91: $n, 92: [Wn, zn], 93: jn, 95: Un, 96: Kn },
    et = { null: [Un, Ze] },
    nt = { null: [42, 95] },
    tt = { null: [] };
   function rt(e) {
    const n = (function (e) {
     ...
     t = { defined: [], lazy: {}, constructs: n, content: r($e), document: r(We), flow: r(Xe), string: r(Ge), text: r(en) };
    return t;
    function r(e) {
     return function (n) {
      return ln(t, e, n);
   ...
   function dt(e, n) {
    throw e ? new Error('Cannot close `' + e.type + '` (' + J({ start: e.start, end: e.end }) + '): a different token (`' + n.type + '`, ' + J({ start: n.start, end: n.end }) + ') is open') : new Error('Cannot close document, a token (`' + n.type + '`, ' + J({ start: n.start, end: n.end }) + ') is still open');
   }
   function ht(e) {
    const n = this;
    n.parser = function (t) {
   ...
   const Nt = {
    ...
    text: function (e, n) {
     const t = { type: 'text', value: Ft(String(n.value)) };
     return (e.patch(n, t), e.applyData(n, t));
    },
   ...
   function qt(e, n) {
    const t = n.data || {},
     r = !('value' in n) || Bt.call(t, 'hProperties') || Bt.call(t, 'hChildren') ? { type: 'element', tagName: 'div', properties: {}, children: e.all(n) } : { type: 'text', value: n.value };
    return (e.patch(n, r), e.applyData(n, r));
   }
   function $t(e, n) {
    const t = [];
      ...
      const t = n || Ut,
       ...
       a = {
        all: function (e) {
         ...
         if ('children' in e) {
          ...
          for (; ++r < t.length; ) {
           const o = a.one(t[r], e);
           if (o) {
            if (r && 'break' === t[r - 1].type && (Array.isArray(o) || 'text' !== o.type || (o.value = Wt(o.value)), !Array.isArray(o) && 'element' === o.type)) {
             const e = o.children[0];
             e && 'text' === e.type && (e.value = Wt(e.value));
            }
        ...
        one: function (e, n) {
         const t = e.type,
          r = a.handlers[t];
         if (Bt.call(a.handlers, t) && r) return r(a, e, n);
         ...
         return (a.options.unknownHandler || qt)(a, e, n);
        },
        options: t,
        patch: Ht,
        wrap: $t,
   ...
   const Gt = {
    ...
    join: function (...e) {
     let n,
      t = -1;
     for (; ++t < e.length; ) (er(e[t]), e[t] && (n = void 0 === n ? e[t] : n + '/' + e[t]));
     return void 0 === n
      ? '.'
      : (function (e) {
         er(e);
   ...
   class ir {
    constructor(e) {
     ...
     for (t in n) or.includes(t) || (this[t] = n[t]);
    }
    get basename() {
     return 'string' == typeof this.path ? Gt.basename(this.path) : void 0;
    }
    set basename(e) {
     (ar(e, 'basename'), lr(e, 'basename'), (this.path = Gt.join(this.dirname || '', e)));
    }
    get dirname() {
     return 'string' == typeof this.path ? Gt.dirname(this.path) : void 0;
    }
    set dirname(e) {
     (sr(this.basename, 'dirname'), (this.path = Gt.join(e || '', this.basename)));
    }
    get extname() {
    ...
    set path(e) {
     (tr(e) && (e = rr(e)), ar(e, 'path'), this.path !== e && this.history.push(e));
    }
    get stem() {
     return 'string' == typeof this.path ? Gt.basename(this.path, this.extname) : void 0;
    }
    set stem(e) {
     (ar(e, 'stem'), lr(e, 'stem'), (this.path = Gt.join(this.dirname || '', e + (this.extname || ''))));
    }
    fail(e, n, t) {
   ...
   function lr(e, n) {
    if (e && e.includes(Gt.sep)) throw new Error('`' + n + '` cannot be a path: did not expect `' + Gt.sep + '`');
   }
   function ar(e, n) {
   ...
   class fr extends ur {
    constructor() {
     (super('copy'), (this.Compiler = void 0), (this.Parser = void 0), (this.attachers = []), (this.compiler = void 0), (this.freezeIndex = -1), (this.frozen = void 0), (this.namespace = {}), (this.parser = void 0), (this.transformers = Zt()));
    }
    copy() {
     const e = new fr();
     let n = -1;
    ...
    data(e, n) {
     return 'string' == typeof e ? (2 === arguments.length ? (mr('data', this.frozen), (this.namespace[e] = n), this) : (cr.call(this.namespace, e) && this.namespace[e]) || void 0) : e ? (mr('data', this.frozen), (this.namespace = e), this) : this.namespace;
    }
    freeze() {
    ...
    parse(e) {
     ...
     return (dr('parse', t), t(String(n), n));
    }
    process(e, n) {
     const t = this;
     return (this.freeze(), dr('process', this.parser || this.Parser), hr('process', this.compiler || this.Compiler), n ? r(void 0, n) : new Promise(r));
     function r(r, o) {
      const i = xr(e),
       l = t.parse(i);
      function a(e, t) {
    ...
    stringify(e, n) {
     ...
     return (hr('stringify', r), gr(e), r(e, t));
    }
    use(e, ...n) {
     ...
     function i(e) {
      ...
      (l(e.plugins), e.settings && (r.settings = Jt(!0, r.settings, e.settings)));
     }
     function l(e) {
      let n = -1;
      if (null == e);
     ...
     function a(e, n) {
      ...
      if (-1 === o) t.push([e, ...n]);
       ...
       let [r, ...i] = n;
       const l = t[o][1];
       (Xt(l) && Xt(r) && (r = Jt(!0, l, r)), (t[o] = [e, r, ...i]));
      }
     }
    }
   }
   ...
   function gr(e) {
    if (!Xt(e) || 'string' != typeof e.type) throw new TypeError('Expected node, got `' + e + '`');
   }
   function yr(e, n, t) {
   ...
   function Sr(e) {
    const n = Cr(e),
     t = Er(e);
    return Pr(n.runSync(n.parse(t), t), e);
   }
   function Cr(e) {
    const n = e.rehypePlugins || vr,
     t = e.remarkPlugins || vr,
     r = e.remarkRehypeOptions ? { ...e.remarkRehypeOptions, ...kr } : kr;
    return pr().use(ht).use(t).use(Yt, r).use(n);
   }
   function Er(e) {
    const n = e.children || '',
     t = new ir();
   ...
   function Pr(e, n) {
    const t = n.allowedElements,
     ...
     s = n.urlTransform || Ir;
    for (const u of wr) Object.hasOwn(n, u.from) && (u.from, u.to && u.to, u.id);
    return (
     zt(e, function (e, n, o) {
