 ...
 [29468],
 {
  18127(e, n, o) {
   ...
   const j = ({ code: e, copy: n = !0, defaultExpandedCode: o = !1, displayCode: j = !0, children: y, container: x = 'document', language: b, designTokens: f }) => {
    ...
    let G = u.Fragment;
    return (
     'paragraph' === x ? (G = h) : 'document' === x ? (G = g) : 'surface' === x && (G = v),
     (0, m.jsxs)('div', {
      className: (0, t.A)('nlds-canvas'),
      children: [
       w && (0, m.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, m.jsx)(G, { children: (0, m.jsx)(r.v$, { children: w }) }) }) }),
       j &&
        (0, m.jsx)('div', {
