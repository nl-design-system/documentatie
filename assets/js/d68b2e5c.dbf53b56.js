 ...
 [52116],
 {
  ...
  43599: (e, n, t) => {
   ...
   const b = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      (C = await d.ZP.format(w, { parser: x, plugins: [s.Z, a.ZP, i.ZP, c.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), P(C);
     })();
    }, [w]);
    const z = (0, p.useId)();
    let D = p.Fragment;
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       _ && (0, m.jsx)('div', { className: (0, l.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: k, children: (0, m.jsx)(D, { children: (0, m.jsx)(o.pu, { children: _ }) }) }) }),
       y &&
        (0, m.jsx)('div', {
       ...
       y &&
        (0, m.jsxs)('div', {
         ...
         hidden: !Z,
         children: [
          (0, m.jsx)(r.u, { codeBlockLabel: 'Codevoorbeeld', syntax: x, textContent: C, trim: !0 }),
          t &&
           (0, m.jsx)('div', {
