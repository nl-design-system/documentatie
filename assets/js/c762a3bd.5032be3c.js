  ...
  15175(e, n, o) {
   ...
   function d({ lineNumber: e, syntax: n, textContent: o, trim: d }) {
    ...
    const { title: p, type: u } = (0, r.useContext)(i.x),
     k = (0, r.useId)();
    return (d && (c = c.trim()), (0, s.jsx)(t.f4, { theme: l, code: c, language: n || '', children: ({ style: n, tokens: o, getLineProps: t, getTokenProps: r }) => (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: k, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, s.jsx)(a.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': k, style: n, children: o.map((n, o) => (0, s.jsxs)('span', { ...t({ line: n }), children: [e && (0, s.jsx)('span', { children: o + 1 }), n.map((e, n) => (0, s.jsx)('span', { ...r({ token: e }) }, n)), '\n'] }, o)) })] }) }));
   }
  },
  18439(e, n, o) {
   o.d(n, { R: () => i, x: () => l });
   ...
   const c = (0, s.createContext)({}),
    p = ({ title: e, appearance: n, description: o, children: s, figure: p }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      k = p ? 'figure' : 'div',
      h = p ? 'figcaption' : 'div',
      v = 'string' == typeof o ? (0, d.jsx)(l.oz, { components: { a: r.N_ }, children: o }) : o;
  ...
  70348(e, n, o) {
   ...
   const l = ({ className: e, ...n }) => {
    ...
    s = ({ className: e, label: n, heading: o, headingLevel: l, headingApperance: s, ...d }) => {
     ...
     return (0, i.jsxs)('details', { className: c, ...d, children: [(0, i.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, i.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, i.jsx)('span', { className: 'nl-button__icon-start', children: (0, i.jsx)(t.A, {}) }), (0, i.jsxs)('span', { className: 'nl-button__label', children: [o && (0, i.jsx)(r.D, { level: l, appearance: s, children: o }), n] })] }) }), (0, i.jsx)('div', { className: 'utrecht-accordion__panel', children: d.children })] });
    };
  },
  80731(e, n, o) {
   o.d(n, { H: () => x });
   ...
   const x = globalThis.isAstro
    ? ({ children: e, language: n, className: o }) => {
