 ...
 [8373],
 {
  ...
  6281: (e, n, r) => {
   ...
   function s(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: ["\n", "\n", "\n", (0, i.jsx)(a.X, { appearance: "do", title: "Sta kopi\xebren van een wachtwoord toe.", children: (0, i.jsx)(o.X, { language: "html", children: () => (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(n.label, { for: "pw1", children: "Uw nieuwe wachtwoord" }), (0, i.jsx)(n.input, { type: "password", id: "wachtwoord2", autocomplete: "new-password", name: "wachtwoord" })] }) }) })] });
   }
   function d(e = {}) {
    const { wrapper: n } = { ...(0, l.a)(), ...e.components };
  ...
  65477: (e, n, r) => {
   ...
   const x = (e) => {
    ...
    (0, c.useEffect)(() => {
     (async () => {
      (S = await d.ZP.format(N, { parser: w, plugins: [t.Z, o.ZP, a.ZP, s.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), F(S);
     })();
    }, [N]);
    const C = (0, c.useId)();
    let V = c.Fragment;
    return (
     "paragraph" === k ? (V = j) : "document" === k ? (V = g) : "surface" === k && (V = v),
     (0, p.jsxs)("div", {
      className: (0, l.Z)(h["nlds-canvas"]),
      children: [
       y && (0, p.jsx)("div", { className: (0, l.Z)(h["nlds-canvas__example"]), children: (0, p.jsx)("div", { className: "voorbeeld-theme", style: _, children: (0, p.jsx)(V, { children: (0, p.jsx)(i.pu, { children: y }) }) }) }),
       f &&
        (0, p.jsx)("div", {
       ...
       f &&
        (0, p.jsxs)("div", {
         ...
         hidden: !D,
         children: [
          (0, p.jsx)(m.u, { syntax: w, textContent: S, trim: !0 }),
          r &&
           (0, p.jsx)("div", {
            className: (0, l.Z)(h["nlds-canvas__toolbar"]),
            children: (0, p.jsx)(i.zx, {
   ...
   function a(e) {
    ...
    return (
     ...
     (0, o.jsx)(l.y$, {
      ...
      language: r || "",
      children: (e) => {
       let { style: r, tokens: l, getLineProps: t, getTokenProps: a } = e;
       return (0, o.jsx)(i.dn, { style: r, children: l.map((e, r) => (0, o.jsxs)("span", { ...t({ line: e }), children: [n && (0, o.jsx)("span", { children: r + 1 }), e.map((e, n) => (0, o.jsx)("span", { ...a({ token: e }) }, n)), "\n"] }, r)) });
      },
     })
    );
   }
  ...
  32957: (e, n, r) => {
   ...
   const d = (e) => {
    ...
    const h = "Doen",
     ...
     p = u ? "figure" : "div",
     j = u ? "figcaption" : "div";
    return (0, s.jsxs)(p, { className: (0, o.Z)(a["nlds-guideline"], a[`nlds-guideline--${r}`]), id: "string" == typeof n ? n?.toLowerCase().replace(/\s/g, "-") : void 0, children: [(0, s.jsxs)(j, { className: (0, o.Z)(a["nlds-guideline__description"]), children: ["dont" === r ? (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(t.nv, { className: (0, o.Z)(a["nlds-guideline__badge"], a[`nlds-guideline__badge--${r}`]), children: [(0, s.jsx)(i.Z, { className: a["nlds-guideline__icon"] }), (0, s.jsx)("span", { className: a["nlds-guideline__title"], children: m })] }), (0, s.jsx)(t.nv, { children: n })] }) : (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)(t.nv, { className: (0, o.Z)(a["nlds-guideline__badge"], a[`nlds-guideline__badge--${r}`]), children: [(0, s.jsx)(l.Z, { className: a["nlds-guideline__icon"] }), (0, s.jsx)("span", { className: a["nlds-guideline__title"], children: h })] }), (0, s.jsx)(t.nv, { children: n })] }), d] }), (0, s.jsx)("div", { className: (0, o.Z)(a["nlds-guideline__example"]), children: c })] });
   };
  },
  80877: (e, n, r) => {
   r.d(n, { Z: () => a, a: () => o });
