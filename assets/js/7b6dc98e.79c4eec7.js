 ...
 [97627],
 {
  ...
  51627(e, n, a) {
   ...
   const o = ({ className: e, ...n }) => {
    ...
    r = ({ className: e, label: n, heading: a, headingLevel: o, headingApperance: r, ...u }) => {
  ...
  60420(e, n, a) {
   (a.r(n), a.d(n, { assets: () => g, component: () => p, contentTitle: () => u, default: () => f, description: () => m, frontMatter: () => r, issueNumber: () => c, metadata: () => t, title: () => d, toc: () => h }));
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => b, qZ: () => s, kD: () => v, QQ: () => _, B2: () => c, Pc: () => r, f4: () => o, GT: () => j, fX: () => l, eQ: () => k, B_: () => x, o_: () => f });
