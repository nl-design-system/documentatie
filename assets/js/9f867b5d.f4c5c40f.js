...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  33062(e, t, n) {
   n.d(t, { bo: () => s, KF: () => m, mJ: () => u, VZ: () => k, cR: () => N, Pv: () => f, qZ: () => i, kD: () => v, B2: () => p, Pc: () => l, f4: () => o, GT: () => _, fX: () => r, eQ: () => b, B_: () => x, o_: () => j, Rc: () => A });
  ...
  93857(e, t, n) {
   (n.r(t), n.d(t, { assets: () => k, contentTitle: () => N, default: () => D, frontMatter: () => A, metadata: () => a, toc: () => w }));
   ...
   var b = n(67970);
   const v = ({ name: e, description: t, relayStep: n, headingLevel: a = 2, href: r, frameworkNames: i }) => {
    ...
    _ = () => {
     ...
     return (
      (0, m.useEffect)(() => {
       (_(j.filter((e) => !A.length || A.some((t) => e.relayStep === t)).filter((e) => !k.length || k.some((t) => (0, p.B2)(e, t)))), A.length ? u.set(t, A.join(',')) : u.delete(t), k.length ? u.set(e, k.join(',')) : u.delete(e), r({ ...a, search: u.toString() }));
      }, [A, k]),
      (0, s.jsxs)(s.Fragment, {
       children: [
        (0, s.jsx)('div', {
        ...
        (0, s.jsx)(g.AC, {
         ...
         children: x.map(({ title: e, id: t, href: n, description: a }) => {
          const r = c.find((t) => t.title === e),
           ...
           o = (0, p.mJ)(r);
          return (0, s.jsx)(v, { name: e, headingLevel: 2, href: n, description: a, relayStep: i, frameworkNames: o }, t);
         }),
        }),
       ],
      })
    ...
    A = { title: 'Componenten Overzicht', hide_title: !0, hide_table_of_contents: !0, sidebar_label: 'Overzicht', sidebar_position: 1, pagination_label: 'Overzicht', description: 'Een overzicht van alle gedocumenteerde componenten uit NL Design System', keywords: ['componenten', 'design system', 'overzicht', 'utrecht', 'den haag'] },
    N = 'Componenten',
    k = {},
    w = [];
   function S(e) {
