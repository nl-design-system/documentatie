 ...
 [3900],
 {
  1414: (e, n, t) => {
   ...
   function m(e) {
    ...
    return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(n.p, { children: 'Eind vorig jaar hebben we samen met de community stilgestaan bij de plannen en werkzaamheden voor 2022. Nu het jaar er bijna op zit, is het dan ook tijd om terug te blikken en te kijken naar wat er allemaal gedaan is. E\xe9n ding is zeker; 2022 was een druk jaar.' }), '\n', (0, a.jsx)(n.p, { children: 'We kijken er vanuit het kernteam met een grote glimlach op terug! Er zijn namelijk weer meer teams aangesloten en meer mensen enthousiast over het NL Design System.' }), '\n', (0, a.jsxs)(n.p, { children: [(0, a.jsx)(n.a, { href: 'https://praatmee.codefor.nl', children: 'Op Slack' }), ' heeft Yolijn beschreven wat we hebben gedaan met de doelen die we hadden gesteld voor 2022.'] }), '\n', (0, a.jsx)(n.p, { children: 'Een aantal hoogtepunten:' }), '\n', (0, a.jsxs)(n.p, { children: ['RVO die NL Design System voor een groter publiek bij de Rijksoverheid beschikbaar heeft gemaakt;\nOnze nieuwe documentatie-website;\nDe drukbezochte Design Systems Week. Gemist? Geen nood: ', (0, a.jsx)(n.a, { href: 'https://nldesignsystem.nl/events/design-systems-week-2022', children: 'de sessies zijn terug te kijken' }), '.'] }), '\n', (0, a.jsx)(n.p, { children: 'Samenwerken in Figma' }), '\n', (0, a.jsx)(n.p, { children: 'We zijn ook heel blij met onze nieuwe collega en UX-designer Jeffrey Lauwers die bij heeft gedragen aan een betere samenwerking tussen designers. Jeffrey zegt daar zelf het volgende over:' }), '\n', (0, a.jsx)(n.p, { children: 'Vanaf oktober ben ik als designer onderdeel gaan uitmaken van het kernteam. Na een leuke kennismaking en het nodige inlezen ben ik gesprekken gaan voeren met andere designers uit de community.' }), '\n', (0, a.jsx)(n.p, { children: 'Al snel werd duidelijk dat het in ontwerpprogramma Figma een behoorlijke uitdaging was om samen te werken. Inmiddels hebben we daar een mooie oplossing voor gevonden. Nu kunnen designers gebruik maken van een Figma-bibliotheek met NL Design System-componenten \xe9n daar de huisstijl van hun eigen organisatie eenvoudig op toepassen. Vooralsnog staan hier 5 componenten, maar ons doel is om daar in 2023 een behoorlijke set aan toe te voegen. Dit alles uiteraard ondersteund met de nodige documentatie.' }), '\n', (0, a.jsx)(n.p, { children: 'Uiteraard kunnen we dit niet zonder input van de community dus blijf ons vooral volgen en laat van je horen!' })] });
   }
   function g(e = {}) {
