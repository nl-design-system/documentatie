 ...
 [43800],
 {
  ...
  53596: (e, n, t) => {
   ...
   function d(e) {
    ...
    return (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(n.h2, { id: "biedt-verschillende-manieren-om-contact-op-te-nemen", children: "Biedt verschillende manieren om contact op te nemen" }), "\n", (0, i.jsx)(n.p, { children: "Vraag niet alleen om contact via een telefoonnummer." }), "\n", (0, i.jsx)(n.p, { children: "Vraag niet alleen om contact via een telefoonnummer. Gebruikers die doof zijn of heel verlegen, stotteren of een vorm van autisme hebben, kunnen soms niet (goed) bellen. Andere gebruikers spreken de Nederlandse taal misschien niet goed, waardoor zij liever niet bellen." }), "\n", (0, i.jsxs)(n.p, { children: ["Voeg een alternatief toe, bijvoorbeeld een e-mailadres. De blogpost ", (0, i.jsx)(n.a, { href: "/blog/meerdere-manieren-contact", children: "Ik wil je wat vragen, maar ik heb geen WhatsApp!" }), " gaat hier uitgebreid op in."] })] });
   }
   function m(e = {}) {
    const { wrapper: n } = { ...(0, r.a)(), ...e.components };
  ...
  94091: (e, n, t) => {
   ...
   const x = (e) => {
    let { code: n, copy: t = !0, defaultExpandedCode: x = !1, displayCode: f = !0, children: b, container: _ = "document", language: k, designTokens: y } = e,
