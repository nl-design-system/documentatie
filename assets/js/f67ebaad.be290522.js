...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [33527],
 {
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => x, qZ: () => l, kD: () => j, B2: () => c, Pc: () => o, f4: () => r, GT: () => k, fX: () => s, eQ: () => v, B_: () => b, o_: () => f });
  ...
  83754(e, n, a) {
   (a.r(n), a.d(n, { assets: () => u, component: () => f, componentName: () => x, contentTitle: () => g, default: () => j, description: () => c, frontMatter: () => d, issueNumber: () => p, metadata: () => t, relayStep: () => h, title: () => m, toc: () => b }));
   ...
   var i = a(86070),
    ...
    r = a(12761),
    o = a(17842);
   const d = { title: 'Video', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Video', pagination_label: 'Video', description: 'Video met bedieningselementen voor afspelen, pauzeren, tekstalternatieven, en meer.', slug: '/video' },
    g = void 0,
    u = {},
    m = 'Video',
