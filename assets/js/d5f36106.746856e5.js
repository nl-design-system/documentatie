...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [38662],
 {
  12761(e, n, a) {
   ...
   const x = ({ className: e, ...n }) => {
    ...
    k = ({ className: e, heading: n, headingLevel: a, headingApperance: t, ...i }) => {
     ...
     return (0, g.jsxs)('details', { className: l, ...i, children: [(0, g.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, g.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, g.jsx)('span', { className: 'nl-button__icon-start', children: (0, g.jsx)(b.A, {}) }), (0, g.jsx)('span', { className: 'nl-button__label', children: (0, g.jsx)(f.D, { level: a, appearance: t, children: n }) })] }) }), (0, g.jsx)('div', { className: 'utrecht-accordion__panel', children: i.children })] });
    },
    v = ({ component: e, headingLevel: n }) => {
     const a = e && e.projects.filter((e) => p.f4.includes(e.id)),
      i = a && p.f4.map((e) => a.find((n) => n.id === e)).filter(Boolean);
     return e && (0, g.jsx)(x, { children: i.map((a) => (0, g.jsx)(k, { className: (0, s.A)('ma-definition-of-done', a && `ma-definition-of-done--${(0, p.fX)(a.title)}`), heading: a ? `${a.title} - ${a.progress.value} van ${a.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, g.jsxs)(g.Fragment, { children: [(0, g.jsx)(c._, { children: a.tasks.map(({ checked: e, name: a, id: t }) => (0, g.jsx)(c.Z, { headingLevel: n + 1, checked: e, heading: a, description: (0, p.qZ)(t) }, t)) }), (0, g.jsx)(t.fz, { children: (0, g.jsxs)(t.N_, { href: `${a.url}?filterQuery=${e.title}`, children: [a.title, ' projectbord op GitHub'] }) })] }) }, a.title)) });
    },
  ...
  76097(e, n, a) {
   a.d(n, { bo: () => s, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => b, qZ: () => l, kD: () => v, QQ: () => S, B2: () => c, Pc: () => o, f4: () => r, GT: () => j, fX: () => i, eQ: () => k, B_: () => x, o_: () => f });
