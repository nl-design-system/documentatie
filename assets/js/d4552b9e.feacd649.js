 ...
 [70767],
 {
  1292(e, n, r) {
   ...
   var o = r(29181),
    ...
    l = r(83386),
    d = r(86070);
   const c = { figma: (0, d.jsx)(s.A, {}), github: (0, d.jsx)(t.A, {}), npm: (0, d.jsx)(i.A, {}), storybook: (0, d.jsx)(a.A, {}) },
    m = ({ brand: e }) => (0, d.jsx)(o.In, { children: c[e] || (0, d.jsx)(l.A, {}) });
  },
  33062(e, n, r) {
   r.d(n, { bo: () => s, KF: () => g, mJ: () => f, VZ: () => N, cR: () => A, Pv: () => h, qZ: () => i, kD: () => x, B2: () => u, Pc: () => l, f4: () => a, GT: () => _, fX: () => t, eQ: () => b, B_: () => v, o_: () => j, Rc: () => k });
    ...
    h = (e) => {
     ...
     return n.map((n) => {
      const o = e.tasks
       ...
       .map(({ name: o, id: s, value: t }) => {
        const i = /^(.+) URL/.exec(o)[1],
         a = 'Storybook' === i ? `${r} (${n}) in Storybook van ${e.title}` : `${r} (${n}) op ${i}`;
        return { brand: i.toLowerCase(), name: o, id: s, value: t, description: a };
       });
  ...
  67970(e, n, r) {
   ...
   const a = ({ state: e }) => {
    const n = (0, t.fX)(e);
    return (0, i.jsx)(o.KE, { className: (0, s.A)('estafette-badge', n && `estafette-badge--${n}`), children: e });
   };
  },
  72642(e, n, r) {
   r.d(n, { p: () => t });
   var o = r(13526),
    s = r(86070);
   const t = ({ children: e, className: n, level: r = 1, suffix: t, ...i }) => (0, s.jsxs)('hgroup', { className: (0, o.A)('nlds-inline-heading-group', `utrecht-heading-${r}`, n), ...i, children: [(0, s.jsx)('h1', { className: 'nlds-inline-heading-group__heading', children: e }), t && (0, s.jsxs)('p', { className: 'nlds-inline-heading-group__suffix', children: [t ? ' ' : '', t] })] });
  },
  80506(e, n, r) {
   r.d(n, { VK: () => f, $9: () => j, mu: () => h, Fc: () => v });
   var o = r(29181),
    s = r(13526),
    t = r(1292),
    i = r(90495),
   ...
   const f = ({ component: e, headingLevel: n }) => {
     const r = e && e.projects.filter((e) => p.f4.includes(e.id)),
      t = r && p.f4.map((e) => r.find((n) => n.id === e)).filter(Boolean);
     return e && (0, d.jsx)(o.If, { sections: t.map((r) => ({ className: (0, s.A)('definition-of-done', r && `definition-of-done--${(0, p.fX)(r.title)}`), headingLevel: n, expanded: !1, label: r ? `${r.title} - ${r.progress.value} van ${r.progress.max}` : '', body: r && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(u._, { children: r.tasks.map(({ checked: e, name: r, id: o }) => (0, d.jsx)(u.Z, { headingLevel: n + 1, checked: e, heading: r, description: (0, p.qZ)(o) }, o)) }), (0, d.jsx)(o.fz, { children: (0, d.jsxs)(o.N_, { href: `${r.url}?filterQuery=${e.title}`, children: [r.title, ' projectbord op GitHub'] }) })] }) })) });
    },
            ...
            i.Zp,
            {
             ...
             children: (0, d.jsxs)(i.Wu, {
              children: [
               ...
               a.length > 0 && (0, d.jsx)(d.Fragment, { children: a.map(({ frameworkName: e, tasks: r }) => (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(o.DZ, { level: n + 2, children: [s, ' in ', e] }), (0, d.jsx)(o.dk, { links: r.map((e) => ({ children: e.description, icon: (0, d.jsx)(t.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    j = ({ component: e, headingLevel: n }) => {
     const r = e?.projects.find((e) => 'HELP_WANTED' === e.id),
      s = r?.tasks.find((e) => 'PVTF_lADOBGdlVM4AdX8lzgcig7o' === e.id)?.value;
    ...
    v = ({ component: e, headingLevel: n, description: r }) => {
     ...
     return e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(g.p, { level: n, suffix: s && (0, d.jsx)(m.D, { state: s }), children: e.title }), (0, d.jsx)(o.fz, { lead: !0, children: r })] });
    };
  },
  89840(e, n, r) {
   ...
   function h(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, s.jsx)(a.Fc, { component: p, headingLevel: 1, description: g }), '\n', (0, s.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, s.jsx)(a.VK, { component: p, headingLevel: 3 }), '\n', (0, s.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, s.jsx)(a.mu, { component: p, headingLevel: 3 }), '\n', (0, s.jsx)(a.$9, { component: p, headingLevel: 2 })] });
   }
   function j(e = {}) {
  ...
  90495(e, n, r) {
   r.d(n, { AC: () => d, Fu: () => i, Wu: () => a, Zp: () => l });
   var o = r(46447),
    s = r(13526),
    t = r(86070);
   const i = ({ background: e, children: n, className: r, ...o }) => (0, t.jsx)('div', { className: (0, s.A)('card__illustration', e && `card__illustration--${e}`, r), ...o, children: n }),
    a = (e) => (0, t.jsx)('div', { className: 'card__content', ...e }),
    l = ({ href: e, appearance: n, className: r, component: i = 'div', background: a, children: l }) => {
     const d = (e) => ('article' === i ? (0, t.jsx)('article', { ...e }) : 'section' === i ? (0, t.jsx)('section', { ...e }) : (0, t.jsx)('div', { ...e })),
      c = (0, t.jsx)(d, { className: (0, s.A)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, r), children: l });
     return e ? (0, t.jsx)(o.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: c }) : c;
    },
    d = ({ appearance: e = 'medium', children: n, className: r }) => (0, t.jsx)('div', { className: (0, s.A)('cardgroup', `cardgroup--${e}`, r), children: n });
  },
 },
]);
