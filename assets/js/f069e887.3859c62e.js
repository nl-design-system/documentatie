/*! For license information please see f069e887.3859c62e.js.LICENSE.txt */
'use strict';
 ...
 [87010],
 {
  ...
  53538(e, n, t) {
   ...
   const s = ({ children: e, ...n }) => {
     ...
     return ('https://nldesignsystem.nl' === o.origin ? (o.pathname.endsWith('/') || (0, r.QQ)(o.pathname) || (o.pathname = `${o.pathname}/`), (l = o.toString().replace('https://nldesignsystem.nl', ''))) : ((s.target = '_blank'), (s.rel = 'noopener noreferrer')), (0, i.jsx)('a', { href: l, ...s, children: e }));
    },
    l = ({ className: e, ...n }) => (0, i.jsx)(s, { className: (0, a.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  64249(e, n, t) {
   t.d(n, { A: () => a });
  ...
  76097(e, n, t) {
   t.d(n, { bo: () => r, KF: () => m, mJ: () => b, VZ: () => A, cR: () => w, Pv: () => g, qZ: () => s, kD: () => f, QQ: () => S, B2: () => p, Pc: () => o, f4: () => l, GT: () => x, fX: () => i, eQ: () => v, B_: () => k, o_: () => j });
