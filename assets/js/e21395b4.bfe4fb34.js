(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [46190],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => i, KF: () => d, mJ: () => g, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => s, kD: () => b, B2: () => j, Pc: () => a, f4: () => o, GT: () => k, fX: () => c, eQ: () => v, B_: () => f, o_: () => p, Rc: () => x });
   ...
   const u = (e) => [...e].sort((e, t) => h.indexOf(e) - h.indexOf(t)),
    ...
    g = (e) => u(l(e.projects.flatMap((e) => y(e)))),
    m = (e) => {
     const t = y(e),
      n = ((e) => {
  ...
  85825(e, t, n) {
   ...
   const f = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, h.jsx)(r.If, { sections: c.map((n) => ({ className: (0, i.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(g, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, h.jsx)(m, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, h.jsx)(r.fz, { children: (0, h.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
