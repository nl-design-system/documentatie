...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [16386],
 {
  ...
  98480: (e, n, l) => {
   ...
   const g = (e) => {
    let { code: n, copy: l = !0, defaultExpandedCode: g = !1, displayCode: b = !0, children: k, container: f = 'document', language: _, designTokens: y } = e,
    ...
    let S = c.Fragment;
    return (
     'paragraph' === f ? (S = m) : 'document' === f ? (S = j) : 'surface' === f && (S = x),
     (0, v.jsxs)('div', {
      className: (0, i.Z)(h['nlds-canvas']),
      children: [
       w && (0, v.jsx)('div', { className: (0, i.Z)(h['nlds-canvas__example']), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, v.jsx)(S, { children: (0, v.jsx)(r.pu, { children: w }) }) }) }),
       b &&
        (0, v.jsx)('div', {
       ...
       b &&
        (0, v.jsxs)('div', {
         ...
         hidden: !Z,
         children: [
          (0, v.jsx)(p.u, { codeBlockLabel: 'Codevoorbeeld', syntax: _, textContent: z, trim: !0 }),
          l &&
           (0, v.jsx)('div', {
  ...
  41179: (e, n, l) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: l, textContent: d, trim: c } = e,
     u = d;
    const { title: h, type: p } = (0, t.useContext)(s.n),
     v = (0, t.useId)();
    return (
     c && (u = u.trim()),
     (0, a.jsx)(i.y$, {
      ...
      language: l || '',
      children: (e) => {
       let { style: l, tokens: i, getLineProps: t, getTokenProps: s } = e;
       return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)('span', { hidden: !0, id: v, children: ['codevoorbeeld ', p ? `\u201c${p}\u201d` : '', ' ', h ? ': ' : ' ', h] }), (0, a.jsx)(r.dn, { tabIndex: 0, role: h ? 'region' : void 0, 'aria-labelledby': v, style: l, children: i.map((e, l) => (0, a.jsxs)('span', { ...t({ line: e }), children: [n && (0, a.jsx)('span', { children: l + 1 }), e.map((e, n) => (0, a.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, l)) })] });
      },
     })
    );
   }
  ...
  91050: (e, n, l) => {
   ...
   const c = (0, o.createContext)({}),
    u = (e) => {
     let { title: n, appearance: l, description: o, children: u, figure: h } = e;
     const p = { do: 'Doen', dont: 'Niet doen' },
      v = h ? 'figure' : 'div',
      m = h ? 'figcaption' : 'div';
     return (0, d.jsxs)(v, { className: (0, s.Z)(a['nlds-guideline'], a[`nlds-guideline--${l}`]), id: 'string' == typeof n ? n?.toLowerCase().replace(/\s/g, '-') : void 0, children: [(0, d.jsxs)(m, { className: (0, s.Z)(a['nlds-guideline__description']), children: ['dont' === l ? (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.nv, { className: (0, s.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, d.jsx)(r.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: p.dont })] }), (0, d.jsx)(t.nv, { children: n })] }) : (0, d.jsxs)(d.Fragment, { children: [(0, d.jsxs)(t.nv, { className: (0, s.Z)(a['nlds-guideline__badge'], a[`nlds-guideline__badge--${l}`]), children: [(0, d.jsx)(i.Z, { 'aria-hidden': 'true', role: 'presentation', className: a['nlds-guideline__icon'] }), (0, d.jsx)('span', { className: a['nlds-guideline__title'], children: p.do })] }), (0, d.jsx)(t.nv, { children: n })] }), o] }), (0, d.jsx)('div', { className: (0, s.Z)(a['nlds-guideline__example']), children: (0, d.jsx)(c.Provider, { value: { title: n, type: p[l] }, children: u }) })] });
    };
  },
  57716: (e, n, l) => {
   l.d(n, { U: () => c });
