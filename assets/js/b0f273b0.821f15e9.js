 ...
 [58973],
 {
  1292(e, n, a) {
   ...
   var t = a(29181),
    ...
    o = a(83386),
    g = a(86070);
   const u = { figma: (0, g.jsx)(i.A, {}), github: (0, g.jsx)(s.A, {}), npm: (0, g.jsx)(l.A, {}), storybook: (0, g.jsx)(r.A, {}) },
  ...
  33062(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => h, VZ: () => N, cR: () => D, Pv: () => f, qZ: () => l, kD: () => k, B2: () => c, Pc: () => o, f4: () => r, GT: () => F, fX: () => s, eQ: () => v, B_: () => x, o_: () => b, Rc: () => j });
   ...
   const l = ({ background: e, children: n, className: a, ...t }) => (0, s.jsx)('div', { className: (0, i.A)('card__illustration', e && `card__illustration--${e}`, a), ...t, children: n }),
    ...
    o = ({ href: e, appearance: n, className: a, component: l = 'div', background: r, children: o }) => {
     const g = (e) => ('article' === l ? (0, s.jsx)('article', { ...e }) : 'section' === l ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      u = (0, s.jsx)(g, { className: (0, i.A)('cardgroup__card', r && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, a), children: o });
     return e ? (0, s.jsx)(t.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: u }) : u;
    },
