  ...
  69284(e, n, o) {
   ...
   function d({ lineNumber: e, syntax: n, textContent: o, trim: d }) {
    ...
    const { title: p, type: u } = (0, s.useContext)(t.x),
     m = (0, s.useId)();
    return (d && (a = a.trim()), (0, c.jsx)(l.f4, { theme: i, code: a, language: n || '', children: ({ style: n, tokens: o, getLineProps: l, getTokenProps: s }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)('span', { hidden: !0, id: m, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', p ? ': ' : ' ', p] }), (0, c.jsx)(r.NG, { tabIndex: 0, role: p ? 'region' : void 0, 'aria-labelledby': m, style: n, children: o.map((n, o) => (0, c.jsxs)('span', { ...l({ line: n }), children: [e && (0, c.jsx)('span', { children: o + 1 }), n.map((e, n) => (0, c.jsx)('span', { ...s({ token: e }) }, n)), '\n'] }, o)) })] }) }));
   }
  },
  74079(e, n, o) {
   (o.r(n), o.d(n, { assets: () => b, contentTitle: () => v, default: () => x, frontMatter: () => y, metadata: () => r, toc: () => g }));
