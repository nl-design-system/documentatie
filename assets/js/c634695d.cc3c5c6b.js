 ...
 [96233],
 {
  ...
  43599: (e, n, o) => {
   ...
   const j = (e) => {
    ...
    (0, p.useEffect)(() => {
     (async () => {
      (N = await c.ZP.format(z, { parser: f, plugins: [l.Z, a.ZP, s.ZP, d.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' })), C(N);
     })();
    }, [z]);
    const S = (0, p.useId)();
    let E = p.Fragment;
    return (
     ...
     (0, m.jsxs)('div', {
      ...
      children: [
       w && (0, m.jsx)('div', { className: (0, i.Z)('nlds-canvas__example'), children: (0, m.jsx)('div', { className: 'voorbeeld-theme', style: y, children: (0, m.jsx)(E, { children: (0, m.jsx)(t.pu, { children: w }) }) }) }),
       b &&
        (0, m.jsx)('div', {
       ...
       b &&
        (0, m.jsxs)('div', {
         ...
         hidden: !Z,
         children: [
          (0, m.jsx)(r.u, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: N, trim: !0 }),
          o &&
           (0, m.jsx)('div', {
