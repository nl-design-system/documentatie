 ...
 [94192],
 {
  ...
  70903(e, n, t) {
   ...
   var p = t(43864),
    ...
    T = t(79532),
    C = t(30758);
   const R = { boxShadow: p.A, color: k.A, cursor: f.A, dimension: j.A, fontFamily: v.A, fontFamilies: v.A, fontSize: b.A, fontSizes: b.A, fontWeight: w.A, fontWeights: w.A, lineHeight: x.A, lineHeights: x.A, number: A.A, other: y.A, textDecoration: T.A },
    S = ({ type: e }) => {
     const n = Object.hasOwn(R, e) ? e : 'other';
     return (0, m.jsx)(u.In, { children: (0, C.createElement)(R[n]) });
    };
   var L = t(76223);
   function D({ tokens: e }) {
    const n = (0, s.kD)(e),
       ...
       children: [
        ...
        (0, m.jsx)(a.BF, {
         children: o.map((n) => {
          const t = (0, s.o_)(n),
           o = (0, s.eQ)(e, n).$type;
          return (0, m.jsxs)(a.Hj, { children: [(0, m.jsx)(a.nA, { children: (0, m.jsx)(i.C, { children: (0, m.jsx)(a.kf, { children: t }) }) }), (0, m.jsx)(a.nA, { children: (0, m.jsxs)(r.K, { children: [(0, m.jsx)(S, { type: o }), ' ', o] }) })] }, t);
         }),
        }),
       ],
      }),
