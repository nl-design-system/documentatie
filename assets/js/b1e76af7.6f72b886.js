 ...
 [4796],
 {
  ...
  65477: (e, n, r) => {
   ...
   const v = (e) => {
    ...
    let W = c.Fragment;
    return (
     "paragraph" === f ? (W = j) : "document" === f ? (W = b) : "surface" === f && (W = g),
     (0, p.jsxs)("div", {
      className: (0, t.Z)(m["nlds-canvas"]),
      children: [
       w && (0, p.jsx)("div", { className: (0, t.Z)(m["nlds-canvas__example"]), children: (0, p.jsx)("div", { className: "voorbeeld-theme", style: _, children: (0, p.jsx)(W, { children: (0, p.jsx)(i.pu, { children: w }) }) }) }),
       x &&
        (0, p.jsx)("div", {
