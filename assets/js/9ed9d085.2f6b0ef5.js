 ...
 [65429],
 {
  ...
  45282(e, n, i) {
   ...
   const s = ({ children: e, ...n }) => {
     ...
     let o = i || t;
     const m = new URL(o, 'https://nldesignsystem.nl');
     return ('https://nldesignsystem.nl' === m.origin ? ((m.pathname = m.pathname.endsWith('/') ? m.pathname : `${m.pathname}/`), (o = m.toString().replace('https://nldesignsystem.nl', ''))) : ((s.target = '_blank'), (s.rel = 'noopener noreferrer')), (0, r.jsx)('a', { href: o, ...s, children: e }));
    },
    o = ({ className: e, ...n }) => (0, r.jsx)(s, { className: (0, t.$)('utrecht-link', 'utrecht-link--html-a', e), ...n });
  },
  75344(e, n, i) {
   (i.r(n), i.d(n, { assets: () => c, contentTitle: () => l, default: () => h, frontMatter: () => d, metadata: () => t, toc: () => u }));
   const t = JSON.parse('{"id":"community/community-sprints/index","title":"Community Sprints \xb7 Community","description":"Uitleg over de NL Design System Community Sprints","source":"@site/docs/community/community-sprints/index.mdx","sourceDirName":"community/community-sprints","slug":"/community/community-sprints/","permalink":"/community/community-sprints/","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/community/community-sprints/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Community Sprints \xb7 Community","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Community Sprints","pagination_label":"Community Sprints","description":"Uitleg over de NL Design System Community Sprints","slug":"/community/community-sprints/","keywords":["nl design system","community sprints","rijkshuisstijl community","mijn services community","mijnservices community","overheidsbrede portalen community"]},"sidebar":"community","previous":{"title":"Wie doet mee?","permalink":"/community/wie-doet-mee"},"next":{"title":"Over MijnServices Community","permalink":"/community/community-sprints/mijn-services-community/"}}');
   var r = i(86070),
    s = i(18439),
    o = i(46447),
    m = i(90495),
    a = i(45282);
   const d = { title: 'Community Sprints \xb7 Community', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Community Sprints', pagination_label: 'Community Sprints', description: 'Uitleg over de NL Design System Community Sprints', slug: '/community/community-sprints/', keywords: ['nl design system', 'community sprints', 'rijkshuisstijl community', 'mijn services community', 'mijnservices community', 'overheidsbrede portalen community'] },
  ...
  90495(e, n, i) {
   ...
   const o = ({ background: e, children: n, className: i, ...t }) => (0, s.jsx)('div', { className: (0, r.A)('card__illustration', e && `card__illustration--${e}`, i), ...t, children: n }),
    ...
    a = ({ href: e, appearance: n, className: i, component: o = 'div', background: m, children: a }) => {
     const d = (e) => ('article' === o ? (0, s.jsx)('article', { ...e }) : 'section' === o ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      l = (0, s.jsx)(d, { className: (0, r.A)('cardgroup__card', m && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, i), children: a });
     return e ? (0, s.jsx)(t.N_, { href: e, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
