...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [7420],
 {
  ...
  25777(e, l, n) {
   (n.r(l), n.d(l, { assets: () => b, contentTitle: () => v, default: () => f, frontMatter: () => g, metadata: () => o, toc: () => x }));
   ...
   const d = (0, a.createContext)({}),
    h = ({ title: e, appearance: l, description: n, children: a, figure: h }) => {
     const u = { do: 'Doen', dont: 'Niet doen' },
      p = h ? 'figure' : 'div',
      m = h ? 'figcaption' : 'div',
      g = 'string' == typeof n ? (0, i.jsx)(c.oz, { components: { a: t.N_ }, children: n }) : n;
  ...
  70348(e, l, n) {
   ...
   var o = n(13526),
    ...
    s = n(37168),
    c = n(86070);
   const a = (0, r.forwardRef)(({ as: e, className: l, children: n, ...r }, t) => {
     const s = e || 'div',
      a = (0, o.A)('ma-utrecht-accordion', 'utrecht-accordion', l);
     return (0, c.jsx)(s, { ref: t, className: a, ...r, children: n });
    }),
    i = ({ className: e, classNamePanel: l, label: n, heading: r, headingLevel: a, headingApperance: i, ...d }) => {
     const h = (0, o.A)('utrecht-accordion__section', e),
      u = (0, o.A)('utrecht-accordion__panel', l);
     return (0, c.jsxs)('details', { className: h, ...d, children: [(0, c.jsx)('summary', { className: 'utrecht-accordion__header', children: (0, c.jsxs)('span', { className: 'nl-button nl-button--subtle', children: [(0, c.jsx)('span', { className: 'nl-button__icon-start', children: (0, c.jsx)(t.A, {}) }), (0, c.jsxs)('span', { className: 'nl-button__label', children: [r && (0, c.jsx)(s.D, { level: a, appearance: i, children: r }), n] })] }) }), (0, c.jsx)('div', { className: u, children: d.children })] });
    };
  },
  80731(e, l, n) {
   n.d(l, { H: () => f });
   ...
   const f = globalThis.isAstro
    ? ({ children: e, language: l, className: n }) => {
       ...
       return (0, v.jsxs)('div', { className: (0, t.A)('ma-canvas-astro', n), children: [(0, v.jsx)('div', { className: 'ma-canvas-astro__example utrecht-html ma-flow', dangerouslySetInnerHTML: { __html: r } }), (0, v.jsx)(g.n, { children: (0, v.jsx)(g.K, { label: 'Code', children: (0, v.jsx)('pre', { className: 'language-html nl-code-block', children: (0, v.jsx)('code', { className: 'language-html nl-code-block__code', dangerouslySetInnerHTML: { __html: s } }) }) }) })] });
      }
    : ({ code: e, copy: l = !0, defaultExpandedCode: n = !1, displayCode: p = !0, children: m, container: g = 'document', language: f, designTokens: j }) => {
       ...
       (0, h.useEffect)(() => {
        (async () => {
         const e = await d.Ay.format(N, { parser: f, plugins: [s.A, c.Ay, a.Ay, i.Ay], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: 'off', htmlWhitespaceSensitivity: 'ignore' });
         A(e);
        })();
       }, [N]);
       const S = (0, h.useId)();
       ...
       return (
        ...
        (0, v.jsxs)('div', {
         ...
         children: [
          _ && (0, v.jsx)('div', { className: (0, t.A)('nlds-canvas__example'), children: (0, v.jsx)('div', { className: 'voorbeeld-theme', style: j, children: (0, v.jsx)(R, { children: (0, v.jsx)(r.v$, { children: _ }) }) }) }),
          p &&
           (0, v.jsx)('div', {
          ...
          p &&
           (0, v.jsxs)('div', {
            ...
            hidden: !z,
            children: [
             (0, v.jsx)(o.M, { codeBlockLabel: 'Codevoorbeeld', syntax: f, textContent: w, trim: !0 }),
             l &&
              (0, v.jsx)('div', {
