 ...
 [46190],
 {
  ...
  21034(e, n, a) {
   ...
   const k = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, m.jsx)(j.n, { children: i.map((a) => (0, m.jsx)(j.K, { className: (0, r.A)('ma-definition-of-done', a && `ma-definition-of-done--${(0, b.fX)(a.title)}`), heading: a ? `${a.title} - ${a.progress.value} van ${a.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(f._, { children: a.tasks.map(({ checked: e, name: a, id: t }) => (0, m.jsx)(f.Z, { headingLevel: n + 1, checked: e, heading: a, description: (0, b.qZ)(t) }, t)) }), (0, m.jsx)(t.fz, { children: (0, m.jsxs)(t.N_, { href: `${a.url}?filterQuery=${e.title}`, children: [a.title, ' projectbord op GitHub'] }) })] }) }, a.title)) });
    },
  ...
  32385(e, n, a) {
   a.d(n, { bo: () => i, KF: () => m, mJ: () => p, VZ: () => D, cR: () => N, Pv: () => f, qZ: () => r, kD: () => v, QQ: () => H, B2: () => c, Pc: () => o, f4: () => l, GT: () => k, fX: () => s, eQ: () => j, B_: () => x, o_: () => b });
