 ...
 [1154],
 {
  ...
  3460: (e, n, l) => {
   ...
   const g = (e) => {
    ...
    p = (e) => {
     let { code: n, copy: l = !1, defaultCollapsed: p = !0, children: j, language: v } = e,
      _ = "function" == typeof j ? j() : j,
      y = "function" == typeof n ? n() : (0, c.isValidElement)(n) ? n : void 0,
      x = "string" == typeof n ? n : u.uS(y || _),
      [f, w] = (0, c.useState)(x);
     (0, c.useEffect)(() => {
      (async () => {
       (f = await d.ZP.format(x, { parser: v, plugins: [i.Z, r.ZP, s.ZP, a.ZP], semi: !1, singleAttributePerLine: !0, embeddedLanguageFormatting: "off", htmlWhitespaceSensitivity: "ignore" })), w(f);
      })();
     }, [x]);
     const Z = (0, h.Z)();
     return (0, b.jsxs)("div", {
      ...
      children: [
       (0, b.jsx)("div", { className: (0, t.Z)(m["nlds-canvas__example"]), children: (0, b.jsx)(o.pu, { className: "voorbeeld-theme", children: _ }) }),
       (0, b.jsx)("div", { className: (0, t.Z)(m["nlds-canvas__toolbar"]), children: (0, b.jsx)(o.zx, { className: (0, t.Z)(m["nlds-canvas__button"], m["nlds-canvas__toggle-code-button"]), appearance: "subtle-button", onClick: g, "aria-expanded": !p, "aria-controls": Z, children: p ? "Bekijk code" : "Verberg code" }) }),
       (0, b.jsxs)("div", {
        className: (0, t.Z)(m["nlds-canvas__code-block"], !l && m["nlds-canvas__code-block--user-select-none"]),
        id: Z,
        hidden: p,
        children: [
         (0, b.jsx)(k.u, { syntax: v, textContent: f, trim: !0 }),
         l &&
          (0, b.jsx)("div", {
  ...
  36: (e, n, l) => {
   ...
   const d = (e) => {
    ...
    const u = "Doen",
     h = "Niet doen";
    return (0, a.jsxs)("div", { className: (0, r.Z)(s["nlds-guideline"], s[`nlds-guideline--${l}`]), id: n?.toLowerCase().replace(/\s/g, "-"), children: [(0, a.jsxs)("div", { className: (0, r.Z)(s["nlds-guideline__description"]), children: ["dont" === l ? (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(i.nv, { className: (0, r.Z)(s["nlds-guideline__badge"], s[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(o.Z, { className: s["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: s["nlds-guideline__title"], children: h })] }), (0, a.jsx)(i.nv, { children: n })] }) : (0, a.jsxs)(a.Fragment, { children: [(0, a.jsxs)(i.nv, { className: (0, r.Z)(s["nlds-guideline__badge"], s[`nlds-guideline__badge--${l}`]), children: [(0, a.jsx)(t.Z, { className: s["nlds-guideline__icon"] }), (0, a.jsx)("span", { className: s["nlds-guideline__title"], children: u })] }), (0, a.jsx)(i.nv, { children: n })] }), d] }), (0, a.jsx)("div", { className: (0, r.Z)(s["nlds-guideline__example"]), children: c })] });
   };
  },
 },
]);
