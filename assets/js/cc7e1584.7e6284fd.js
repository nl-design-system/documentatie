(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [42119],
 {
  ...
  33062(e, t, n) {
   'use strict';
   n.d(t, { bo: () => s, KF: () => d, mJ: () => y, VZ: () => _, cR: () => w, Pv: () => m, qZ: () => c, kD: () => f, B2: () => j, Pc: () => a, f4: () => o, GT: () => b, fX: () => i, eQ: () => k, B_: () => v, o_: () => p, Rc: () => x });
   ...
   const l = (e) => [...e].sort((e, t) => h.indexOf(e) - h.indexOf(t)),
    ...
    y = (e) => l(u(e.projects.flatMap((e) => g(e)))),
    m = (e) => {
     const t = g(e),
      n = ((e) => {
  ...
  85825(e, t, n) {
   ...
   const y = ({ children: e }) => (0, h.jsx)('ul', { className: 'task-list', children: e }),
    m = ({ checked: e, children: t, title: n, description: r, headingLevel: i = 3 }) => (0, h.jsxs)('li', { className: (0, s.A)('task-list-item'), children: [(0, h.jsxs)('div', { className: (0, s.A)('task-list-item__marker', e && 'task-list-item__marker--checked'), children: [(0, h.jsx)('span', { className: 'task-list-item__marker-label', children: e ? 'Afgevinkt. ' : 'Niet afgevinkt. ' }), e && (0, h.jsx)(g.UJe, { 'aria-hidden': !0, className: 'utrecht-icon' })] }), (0, h.jsxs)('div', { children: [n ? (0, h.jsx)(j.DZ, { appearance: 'utrecht-heading-3', level: i, children: n }) : null, r, t] })] });
   var p = n(33062);
   const v = ({ component: e, headingLevel: t }) => {
     ...
     return e && (0, h.jsx)(r.If, { sections: i.map((n) => ({ className: (0, s.A)('definition-of-done', n && `definition-of-done--${(0, p.fX)(n.title)}`), headingLevel: t, expanded: !1, label: n ? `${n.title} - ${n.progress.value} van ${n.progress.max}` : '', body: n && (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)(y, { children: n.tasks.map(({ checked: e, name: n, id: r }) => (0, h.jsx)(m, { headingLevel: t + 1, checked: e, title: n, description: (0, p.qZ)(r) }, r)) }), (0, h.jsx)(r.fz, { children: (0, h.jsxs)(r.N_, { href: `${n.url}?filterQuery=${e.title}`, children: [n.title, ' projectbord op GitHub'] }) })] }) })) });
    },
  ...
  88907(e, t, n) {
   'use strict';
   (n.r(t), n.d(t, { assets: () => l, component: () => p, componentName: () => m, contentTitle: () => u, default: () => f, description: () => j, frontMatter: () => h, issueNumber: () => g, metadata: () => r, relayStep: () => y, title: () => d, toc: () => v }));
   const r = JSON.parse('{"id":"componenten/strong/index","title":"Strong","description":"Korte belangrijke tekst die vetgedrukt wordt weergegeven.","source":"@site/docs/componenten/strong/index.mdx","sourceDirName":"componenten/strong","slug":"/strong","permalink":"/strong","draft":false,"unlisted":false,"editUrl":"https://github.com/nl-design-system/documentatie/tree/main/docs/componenten/strong/index.mdx","tags":[],"version":"current","frontMatter":{"title":"Strong","hide_title":true,"hide_table_of_contents":false,"sidebar_label":"Strong","pagination_label":"Strong","description":"Korte belangrijke tekst die vetgedrukt wordt weergegeven.","slug":"/strong","keywords":["bold","bold emphasis","bold text","dikgedrukt","emphasized text","important","strong","vetgedrukt"]},"sidebar":"componenten","previous":{"title":"Status Badge","permalink":"/status-badge"},"next":{"title":"Subscript","permalink":"/subscript"}}');
   var s = n(86070),
    i = n(18439),
    c = n(36059),
    o = n(85825),
    a = n(44594);
   const h = { title: 'Strong', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Strong', pagination_label: 'Strong', description: 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.', slug: '/strong', keywords: ['bold', 'bold emphasis', 'bold text', 'dikgedrukt', 'emphasized text', 'important', 'strong', 'vetgedrukt'] },
    u = void 0,
    l = {},
    d = 'Strong',
    j = 'Korte belangrijke tekst die vetgedrukt wordt weergegeven.',
    g = 138,
    y = 'help wanted',
    m = 'strong',
    p = c.find((e) => e.number === g),
    v = [
