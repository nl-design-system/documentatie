...
(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 ...
 {
  20374: (e, n, i) => {
   i.r(n), i.d(n, { assets: () => m, contentTitle: () => j, default: () => x, frontMatter: () => p, metadata: () => v, toc: () => k });
   var t = i(52676),
    r = i(87118),
    s = i(57716),
    l = i(46364),
   ...
   const p = { title: 'WCAG-succescriterium 3.1.5 Leesniveau', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.1.5 Leesniveau', pagination_label: 'WCAG-succescriterium 3.1.5 Leesniveau', description: 'Zorg ervoor dat teksten begrijpelijk zijn voor een lezer uit de tweede klas van het middelbaar onderwijs. Als de tekst moeilijker is, bied dan ook een eenvoudig leesbare versie van de tekst aan als alternatief.', slug: '3.1.5', keywords: ['WCAG'] },
    j = void 0,
    v = { id: 'wcag/3.1.05', title: 'WCAG-succescriterium 3.1.5 Leesniveau', description: 'Zorg ervoor dat teksten begrijpelijk zijn voor een lezer uit de tweede klas van het middelbaar onderwijs. Als de tekst moeilijker is, bied dan ook een eenvoudig leesbare versie van de tekst aan als alternatief.', source: '@site/docs/wcag/3.1.05.mdx', sourceDirName: 'wcag', slug: '/wcag/3.1.5', permalink: '/wcag/3.1.5', draft: !1, unlisted: !1, editUrl: 'https://github.com/nl-design-system/documentatie/tree/main/docs/wcag/3.1.05.mdx', tags: [], version: 'current', frontMatter: { title: 'WCAG-succescriterium 3.1.5 Leesniveau', hide_title: !0, hide_table_of_contents: !1, sidebar_label: '3.1.5 Leesniveau', pagination_label: 'WCAG-succescriterium 3.1.5 Leesniveau', description: 'Zorg ervoor dat teksten begrijpelijk zijn voor een lezer uit de tweede klas van het middelbaar onderwijs. Als de tekst moeilijker is, bied dan ook een eenvoudig leesbare versie van de tekst aan als alternatief.', slug: '3.1.5', keywords: ['WCAG'] }, sidebar: 'richtlijnen', previous: { title: 'WCAG-succescriterium 3.1.4 Afkortingen', permalink: '/wcag/3.1.4' }, next: { title: 'WCAG-succescriterium 3.1.6 Uitspraak', permalink: '/wcag/3.1.6' } },
    m = {},
    k = [
  ...
  57716: (e, n, i) => {
   ...
   const l = (e, n) => {
    ...
    c = (e) => {
     ...
     return (0, s.jsx)(t.Z, { components: { ...d(i, r), ...o(l), ...a }, children: n });
    };
  },
  46364: (e, n, i) => {
   i.d(n, { j: () => l });
