/*! For license information please see f0a5e32a.2d37d920.js.LICENSE.txt */
'use strict';
   ...
   const o = s.forwardRef(function (e, n) {
     const [i, o] = s.useState(!1),
      ...
      w = k
       ...
       : null,
      x = s.useMemo(() => e.thumbnail || w || `https://i.ytimg.com/${b}/${e.playlist ? c : m}/${h}.${f}`, [e.thumbnail, w, b, e.playlist, c, m, h, f]),
