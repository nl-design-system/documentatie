...
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [75922],
 {
  ...
  43185(e, n, a) {
   (a.r(n), a.d(n, { assets: () => g, component: () => x, componentName: () => h, contentTitle: () => d, default: () => j, description: () => m, frontMatter: () => o, issueNumber: () => c, metadata: () => t, relayStep: () => p, title: () => u, toc: () => b }));
   ...
   const o = { title: 'Subscript', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Subscript', pagination_label: 'Subscript', description: 'Toont tekst met een kleiner lettertype met een verlaagde letterlijn.', issue_number: 335, slug: '/subscript', keywords: ['aantekening', 'chemische verbinding', 'index', 'kleine lage tekst', 'kleine tekst', 'laaghangende tekst', 'laag tweetje', 'onder nummer', 'onderschrift', 'ondertekst', 'structuurformule', 'scheikunde taal', 'superscript', 'sub', 'subscript', 'tiny', 'voetnoot'] },
    ...
    g = {},
    u = 'Subscript',
    m = 'Toont tekst met een kleiner lettertype met een verlaagde letterlijn.',
    c = 335,
    p = 'help wanted',
    h = 'subscript',
  ...
  48262(e, n, a) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
    ...
    N = ({ component: e, headingLevel: n, description: a }) => {
     ...
     return globalThis.isAstro ? null : e && (0, m.jsxs)(m.Fragment, { children: [(0, m.jsx)(h.p, { level: n, suffix: s && (0, m.jsx)(p.D, { state: s }), children: e.title }), (0, m.jsx)(t.fz, { lead: !0, children: a }), ['Help Wanted', 'Community'].includes(s) && (0, m.jsx)(k.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    H = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
  ...
  84471(e, n, a) {
   a.d(n, { bo: () => s, KF: () => m, mJ: () => h, VZ: () => F, cR: () => D, Pv: () => x, qZ: () => r, kD: () => k, QQ: () => H, B2: () => c, Pc: () => o, f4: () => l, GT: () => v, fX: () => i, eQ: () => j, B_: () => f, o_: () => b });
