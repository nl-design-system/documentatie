/*! For license information please see e1d6ebcd.c8c52721.js.LICENSE.txt */
'use strict';
(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [55407],
 {
    ...
    return (
     ...
     (0, t.jsxs)(t.Fragment, {
      children: [
       ...
       L && !e.playlist && (0, t.jsx)('noscript', { children: (0, t.jsxs)('a', { href: `https://www.youtube.com/watch?v=${e.id}`, 'aria-label': `Watch ${u} on YouTube`, children: ['Watch "', u, '" on YouTube'] }) }),
       (0, t.jsxs)(_, {
        onPointerOver: () => {
         i || o(!0);
        },
  ...
  32385(e, n, i) {
   i.d(n, { bo: () => a, KF: () => u, mJ: () => g, VZ: () => x, cR: () => w, Pv: () => j, qZ: () => r, kD: () => k, QQ: () => C, B2: () => h, Pc: () => l, f4: () => o, GT: () => f, fX: () => s, eQ: () => b, B_: () => y, o_: () => v });
   ...
   function k(e, n = []) {
    return Object.hasOwn(e, '$type') ? [n] : Object.keys(e).flatMap((i) => ('object' == typeof e[i] && null !== e[i] ? k(e[i], [...n, i]) : []));
   }
   function f(e) {
    const n = new Map();
    function i(e) {
  ...
  34225(e, n, i) {
   ...
   var t = i(94309),
    a = i(13526),
    s = i(86070);
   const r = ({ className: e, children: n, purpose: i, iconStart: t, iconEnd: r, href: o }) => (0, s.jsxs)('a', { className: (0, a.A)('nl-button', e, { 'nl-button--primary': 'primary' === i, 'nl-button--secondary': 'secondary' === i, 'nl-button--subtle': 'subtle' === i }), href: o, children: [t && (0, s.jsx)('span', { className: 'nl-button__icon-start', children: t }), (0, s.jsx)('span', { className: 'nl-button__label', children: n }), r && (0, s.jsx)('span', { className: 'nl-button__icon-end', children: r })] }),
    o = globalThis.isAstro
     ? ({ appearance: e, href: n, ...i }) => {
        let t = 'primary';
        return ((t = 'secondary-action' === e ? 'secondary' : t), (0, s.jsx)(r, { purpose: t, href: n, ...i }));
       }
     : ({ appearance: e, ...n }) => (0, s.jsx)(t.F, { className: (0, a.$)('utrecht-button-link', `utrecht-button-link--${e}`), ...n });
  },
  52452(e, n, i) {
