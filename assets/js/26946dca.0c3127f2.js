  ...
  21034(e, n, t) {
   ...
   const j = ({ component: e, headingLevel: n }) => {
            ...
            r.Zp,
            {
             ...
             children: (0, c.jsxs)(r.Wu, {
              children: [
               ...
               (g.length > 0 || a.length > 0) && (0, c.jsx)(s.DZ, { level: n + 1, children: 'Snel aan de slag' }),
               g.length > 0 &&
                (0, c.jsx)(c.Fragment, {
               ...
               a.length > 0 && (0, c.jsx)(c.Fragment, { children: a.map(({ frameworkName: e, tasks: t }) => (0, c.jsxs)(c.Fragment, { children: [(0, c.jsxs)(s.DZ, { level: n + 2, children: [o, ' in ', e] }), (0, c.jsx)(s.dk, { links: t.map((e) => ({ children: e.description, icon: (0, c.jsx)(i.r, { brand: e.brand }), href: e.value })) })] })) }),
              ],
             }),
            },
            e.title,
    ...
    b = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(s.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, c.jsxs)(s.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, c.jsxs)(s.Xy, { children: [o ? (0, c.jsxs)(s.Er, { children: ['Vul de ', (0, c.jsx)(s.N_, { href: o, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, c.jsxs)(s.Er, { children: [(0, c.jsxs)(s.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, c.jsxs)(s.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, c.jsx)(s.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, c.jsx)(s.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    k = ({ component: e, headingLevel: n, description: t }) => {
     const o = e && h.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(u.p, { level: n, suffix: o && (0, c.jsx)(g.D, { state: o }), children: e.title }), (0, c.jsx)(s.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(o) && (0, c.jsx)(f.s, { relayStep: o, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    A = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
