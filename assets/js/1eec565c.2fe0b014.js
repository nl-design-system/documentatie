   ...
   const m = (e) => {
    ...
    return (
     ...
     (0, u.jsxs)('div', {
      ...
      children: [
       w && (0, u.jsx)('div', { className: (0, a.Z)('nlds-canvas__example'), children: (0, u.jsx)('div', { className: 'voorbeeld-theme', style: f, children: (0, u.jsx)(S, { children: (0, u.jsx)(r.pu, { children: w }) }) }) }),
       j &&
        (0, u.jsx)('div', {
  ...
  41179: (e, n, o) => {
   ...
   function d(e) {
    let { lineNumber: n, syntax: o, textContent: d, trim: c } = e,
     p = d;
    const { title: k, type: u } = (0, a.useContext)(i.n),
     h = (0, a.useId)();
    return (
     c && (p = p.trim()),
     (0, s.jsx)(r.y$, {
      ...
      language: o || '',
      children: (e) => {
       let { style: o, tokens: r, getLineProps: a, getTokenProps: i } = e;
       return (0, s.jsxs)(s.Fragment, { children: [(0, s.jsxs)('span', { hidden: !0, id: h, children: ['codevoorbeeld ', u ? `\u201c${u}\u201d` : '', ' ', k ? ': ' : ' ', k] }), (0, s.jsx)(t.dn, { tabIndex: 0, role: k ? 'region' : void 0, 'aria-labelledby': h, style: o, children: r.map((e, o) => (0, s.jsxs)('span', { ...a({ line: e }), children: [n && (0, s.jsx)('span', { children: o + 1 }), e.map((e, n) => (0, s.jsx)('span', { ...i({ token: e }) }, n)), '\n'] }, o)) })] });
      },
     })
    );
   }
