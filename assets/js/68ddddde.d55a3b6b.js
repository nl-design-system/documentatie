 ...
 [94192],
 {
              ...
              a.zB,
              {
               ...
               children: [
                (0, m.jsx)(a.Sc, {
                 ...
                 onChange: () =>
                  ((e, n) => {
                   const t = ('boolean' == typeof n ? n : !w(e)) ? [...p, e] : p.filter((n) => n !== e);
                   h(t);
                  })(e),
                }),
  ...
  48068(e, n, t) {
   ...
   var u = t(43864),
    ...
    b = t(23436),
    v = t(79532);
   const A = { boxShadow: u.A, color: m.A, cursor: p.A, dimension: h.A, fontFamily: k.A, fontFamilies: k.A, fontSize: j.A, fontSizes: j.A, fontWeight: f.A, fontWeights: f.A, lineHeight: x.A, lineHeights: x.A, number: w.A, other: b.A, textDecoration: v.A },
    y = ({ type: e }) => {
  ...
  48262(e, n, t) {
   ...
   const b = ({ component: e, headingLevel: n }) => {
     ...
     return e && (0, u.jsx)(x.n, { children: s.map((t) => (0, u.jsx)(x.K, { className: (0, a.A)('ma-definition-of-done', t && `ma-definition-of-done--${(0, j.fX)(t.title)}`), heading: t ? `${t.title} - ${t.progress.value} van ${t.progress.max}` : '', headingLevel: n, headingApperance: 'level-5', children: (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(k._, { children: t.tasks.map(({ checked: e, name: t, id: i }) => (0, u.jsx)(k.Z, { headingLevel: n + 1, checked: e, heading: t, description: (0, j.qZ)(i) }, i)) }), (0, u.jsx)(i.fz, { children: (0, u.jsxs)(i.N_, { href: `${t.url}?filterQuery=${e.title}`, children: [t.title, ' projectbord op GitHub'] }) })] }) }, t.title)) });
    },
    v = ({ component: e, headingLevel: n }) => {
     ...
     return e && t.length
         ...
         children: t
          ...
          .map((e) => {
           const t = e.tasks.find(({ name: e }) => 'Naam' === e),
            ...
            p = e.tasks.filter(({ name: e, value: n }) => g.has(e) && URL.canParse(n) && 'https:' === new URL(n).protocol);
            ...
            ? (0, u.jsx)(
               d.Z,
               {
                ...
                description: (0, u.jsxs)('div', {
                 className: 'ma-flow',
                 children: [
                  (0, u.jsxs)(r.f, { children: [(0, u.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(i.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (0, u.jsxs)('div', {
                   children: [
                    (p.length > 0 || c.length > 0) && (0, u.jsx)(s.DZ, { level: Math.min(n + 1, 6), children: 'Snel aan de slag' }),
                    p.length > 0 &&
                     (0, u.jsx)(i.dk, {
                      links: p
                  ...
                  c.length > 0 && c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)('section', { children: [(0, u.jsxs)(s.DZ, { level: Math.min(n + 2, 6), children: [a, ' in ', e] }), (0, u.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(o.r, { brand: e.brand }), href: e.value })) })] }, e)),
                 ],
                }),
               },
               e.title,
            ...
            : (0, u.jsx)(
               l.Zp,
               {
                ...
                children: (0, u.jsxs)(l.Wu, {
                 children: [
                  (0, u.jsx)(i.DZ, { level: n, children: e.title.replace(/^Community/i, '') }),
                  (0, u.jsxs)(i.fz, { children: [(0, u.jsx)(m, { checked: e.progress.value, unchecked: e.progress.max - e.progress.value }), e.progress.value, ' van ', e.progress.max, ' stappen gedocumenteerd op het', ' ', (0, u.jsxs)(i.N_, { href: e.url, children: [e.title, ' projectbord'] })] }),
                  (p.length > 0 || c.length > 0) && (0, u.jsx)(i.DZ, { level: n + 1, children: 'Snel aan de slag' }),
                  p.length > 0 &&
                   (0, u.jsx)(u.Fragment, {
                    children: (0, u.jsx)(i.dk, {
                     links: p
                      .filter((e) => !!g.get(e.name))
                      .map((e) => {
                       const n = g.get(e.name);
                  ...
                  c.length > 0 && (0, u.jsx)(u.Fragment, { children: c.map(({ frameworkName: e, tasks: t }) => (0, u.jsxs)(u.Fragment, { children: [(0, u.jsxs)(i.DZ, { level: n + 2, children: [a, ' in ', e] }), (0, u.jsx)(i.dk, { links: t.map((e) => ({ children: e.description, icon: (0, u.jsx)(o.r, { brand: e.brand }), href: e.value })) })] })) }),
                 ],
                }),
               },
               e.title,
      ...
      : (0, u.jsx)(i.fz, { children: 'Er zijn nog geen implementaties' });
    },
    A = ({ component: e, headingLevel: n }) => {
     const t = e?.projects.find((e) => 'HELP_WANTED' === e.id),
      s = t?.tasks.find((e) => 'PVTF_lADOBGdlVM4AdX8lzgcig7o' === e.id)?.value;
     return e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(i.DZ, { id: 'help-component-verbeteren', level: n, children: 'Help om deze component te verbeteren' }), (0, u.jsxs)(i.fz, { children: ['We vinden het belangrijk dat de component ', e.title, ' goed te gebruiken is door iedereen. Help je mee?'] }), (0, u.jsxs)(i.Xy, { children: [s ? (0, u.jsxs)(i.Er, { children: ['Vul de ', (0, u.jsx)(i.N_, { href: s, children: 'GitHub Discussion' }), ' aan met de eisen en wensen voor jouw project of organisatie.'] }) : (0, u.jsxs)(i.Er, { children: [(0, u.jsxs)(i.N_, { href: 'https://github.com/orgs/nl-design-system/discussions/categories/component-suggestions', children: ['Start een GitHub Discussion voor ', e.title] }), ' ', 'en voeg de eisen en wensen voor jouw project of organisatie toe.'] }), (0, u.jsxs)(i.Er, { children: ['Draag bij aan de voortgang van ', e.title, ' door te zorgen dat deze aan meer checkpoints van de', ' ', (0, u.jsx)(i.N_, { href: '#definition-of-done', children: 'Definition of Done' }), ' voldoet. Deze houden we bij in de projectborden bij de ', (0, u.jsx)(i.N_, { href: e.backlog, children: 'publieke GitHub Backlog' }), '.', ' '] })] })] });
    },
    y = ({ component: e, headingLevel: n, description: t }) => {
     const s = e && j.bo[e.relayStep];
     return globalThis.isAstro ? null : e && (0, u.jsxs)(u.Fragment, { children: [(0, u.jsx)(h.p, { level: n, suffix: s && (0, u.jsx)(p.D, { state: s }), children: e.title }), (0, u.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(s) && (0, u.jsx)(w.s, { relayStep: s, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    T = ({ component: e }) => {
     const n = (e && f[e.title]) || [];
     return n.length > 0 && (0, u.jsxs)(i.fz, { children: ['Gerelateerde componenten:', ' ', n.map((e, t) => (0, u.jsxs)(u.Fragment, { children: [e.slug ? (0, u.jsx)(i.N_, { href: `/${e.slug}/`, children: e.name }) : e.name, t < n.length - 1 ? ', ' : '.'] }))] });
    };
  },
  49925(e, n, t) {
   'use strict';
   ...
   var g = function (e) {
    ...
    m =
     ...
     (0, o.forwardRef)(function (e, n) {
      ...
      return (0, r.jsxs)('button', c(c({ ref: n, type: b, className: (0, a.$)('nl-button', i, { 'nl-button--pressed': f, 'nl-button--busy': x, 'nl-button--disabled': k || j, 'nl-button--primary': 'primary' === p, 'nl-button--secondary': 'secondary' === p, 'nl-button--subtle': 'subtle' === p, 'nl-button--positive': u(p) && 'positive' === h, 'nl-button--negative': u(p) && 'negative' === h, 'nl-button--icon-only': d }), 'aria-pressed': A ? String(Boolean(f)) : void 0, 'aria-disabled': k || x ? 'true' : void 0, disabled: j }, y), {}, { children: [m && (0, r.jsx)('span', { className: 'nl-button__icon-start', children: m }), v && (0, r.jsx)('span', { className: 'nl-button__label', children: v }), C ? (0, r.jsx)('span', { className: d ? 'nl-button__label' : '', children: t }) : t, g && (0, r.jsx)('span', { className: 'nl-button__icon-end', children: g })] }));
     }));
  ...
  76275(e, n, t) {
   'use strict';
   (t.r(n), t.d(n, { assets: () => U, component: () => J, contentTitle: () => Z, default: () => ee, description: () => X, frontMatter: () => V, issueNumber: () => q, metadata: () => i, title: () => K, toc: () => Q }));
   ...
   const G = [
    ...
    N = [
     ...
     { title: 'De zichtbare naam van de Skip Link komt voor in de toegankelijke naam.', sc: '2.5.3', status: '', component: x.Ay, tags: ['developer'] },
     {
   ...
   function Y(e) {
    ...
    return (0, s.jsxs)(s.Fragment, { children: ['\n', '\n', '\n', '\n', '\n', (0, s.jsx)(P.Fc, { component: J, headingLevel: 1, description: X }), '\n', (0, s.jsx)(n.p, { children: "Gebruik de Skip Link zodat gebruikers met een toetsenbord of hulpsoftware makkelijk contentblokken kunnen overslaan. Bijvoorbeeld navigatie die op meerdere pagina's herhaald wordt." }), '\n', (0, s.jsx)(_.e, { component: J }), '\n', (0, s.jsx)(F.Zp, { className: 'ma-implementation-card', children: (0, s.jsxs)(F.Wu, { children: [(0, s.jsx)(W.DZ, { level: 2, appearance: 'level-4', children: 'Figma' }), (0, s.jsxs)(z.d, { children: [(0, s.jsxs)(z.P, { href: 'https://www.figma.com/design/FqAr99wvrlHxTJYAHkFRQN/NL-Design-System---Bibliotheek?node-id=3462-12790', children: [(0, s.jsx)(H.r, { brand: 'figma' }), 'Figma - Start bibliotheek'] }), (0, s.jsxs)(z.P, { href: 'https://www.figma.com/design/0J3EiRpZH3LJ0cx396XLNC/NL-Design-System---Bibliotheek---Voorbeeld?node-id=3462-12790', children: [(0, s.jsx)(H.r, { brand: 'figma' }), 'Figma - Voorbeeld bibliotheek'] })] }), (0, s.jsx)(W.DZ, { level: 2, appearance: 'level-4', children: 'Storybook' }), (0, s.jsxs)(z.d, { children: [(0, s.jsxs)(z.P, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/css-skip-link--documentatie', children: [(0, s.jsx)(H.r, { brand: 'storybook' }), 'Storybook - CSS'] }), (0, s.jsxs)(z.P, { href: 'https://nl-design-system.github.io/candidate/?path=/docs/skip-link--documentatie', children: [(0, s.jsx)(H.r, { brand: 'storybook' }), 'Storybook - React'] })] }), (0, s.jsx)(W.DZ, { level: 2, appearance: 'level-4', children: 'npm' }), (0, s.jsxs)(z.d, { children: [(0, s.jsxs)(z.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/skip-link-css', children: [(0, s.jsx)(H.r, { brand: 'npm' }), ' @nl-design-system-candidate/skip-link-css'] }), (0, s.jsxs)(z.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/skip-link-react', children: [(0, s.jsx)(H.r, { brand: 'npm' }), ' @nl-design-system-candidate/skip-link-react'] }), (0, s.jsxs)(z.P, { href: 'https://www.npmjs.com/package/@nl-design-system-candidate/skip-link-tokens', children: [(0, s.jsx)(H.r, { brand: 'npm' }), ' @nl-design-system-candidate/skip-link-tokens'] })] })] }) }), '\n', (0, s.jsx)(n.h2, { id: 'checklist-voor-toegankelijkheid', children: 'Checklist voor toegankelijkheid' }), '\n', (0, s.jsx)(d.Ay, {}), '\n', (0, s.jsx)(n.h3, { id: 'acceptatiecriteria-bij-gebruik', children: 'Acceptatiecriteria bij gebruik' }), '\n', (0, s.jsx)(l.Ay, {}), '\n', (0, s.jsx)(B.b, { headingLevel: '4', children: G.map(({ component: e, ...n }) => (0, s.jsx)(B.e, { ...n, children: (0, s.jsx)(e, {}) })) }), '\n', (0, s.jsx)(n.h3, { id: 'acceptatiecriteria-van-de-component', children: 'Acceptatiecriteria van de component' }), '\n', (0, s.jsx)(o.Ay, {}), '\n', (0, s.jsx)(B.b, { headingLevel: '4', children: N.map(({ component: e, ...n }) => (0, s.jsx)(B.e, { ...n, children: (0, s.jsx)(e, {}) })) }), '\n', (0, s.jsx)(I.o, { omitH1: !0, headingLevel: 2, children: (0, s.jsx)($, {}) }), '\n', (0, s.jsx)(n.h2, { id: 'design-tokens', children: 'Design tokens' }), '\n', (0, s.jsx)(M.B, { tokens: E }), '\n', (0, s.jsx)(n.h2, { id: 'definition-of-done', children: 'Definition of Done' }), '\n', (0, s.jsx)(P.VK, { component: J, headingLevel: 3 }), '\n', (0, s.jsx)(P.$9, { component: J, headingLevel: 2 }), '\n', (0, s.jsx)(n.h2, { id: 'community-implementaties', children: 'Community implementaties' }), '\n', (0, s.jsx)(P.mu, { component: J, headingLevel: 3 }), '\n', (0, s.jsx)(P.K_, { component: J })] });
   }
   function ee(e = {}) {
    const { wrapper: n } = { ...(0, r.R)(), ...e.components };
  ...
  82839(e, n, t) {
   var i = { './button-docs/docs/aliases.md': [64163, 64163], './code-block-docs/docs/aliases.md': [47318, 47318], './code-docs/docs/aliases.md': [50566, 50566], './color-sample-docs/docs/aliases.md': [72965, 72965], './data-badge-docs/docs/aliases.md': [79971, 79971], './heading-1-docs/docs/aliases.md': [24053, 24053], './heading-2-docs/docs/aliases.md': [80713, 80713], './heading-3-docs/docs/aliases.md': [69461, 69461], './heading-4-docs/docs/aliases.md': [8289, 8289], './heading-docs/docs/aliases.md': [43020, 43020], './link-docs/docs/aliases.md': [71164, 71164], './mark-docs/docs/aliases.md': [92698, 92698], './number-badge-docs/docs/aliases.md': [36630, 36630], './paragraph-docs/docs/aliases.md': [42388, 42388], './skip-link-docs/docs/aliases.md': [7236, 7236] };
   function s(e) {
    if (!t.o(i, e))
  ...
  84471(e, n, t) {
   'use strict';
   t.d(n, { bo: () => s, KF: () => u, mJ: () => h, VZ: () => A, cR: () => v, Pv: () => k, qZ: () => a, kD: () => w, QQ: () => T, B2: () => m, Pc: () => l, f4: () => o, GT: () => b, fX: () => r, eQ: () => x, B_: () => f, o_: () => j });
