(globalThis.webpackChunk_nl_design_system_website = globalThis.webpackChunk_nl_design_system_website || []).push([
 [94192],
 {
  ...
  21034(e, n, t) {
   ...
   const v = ({ component: e, headingLevel: n }) => {
    ...
    b = ({ component: e, headingLevel: n, description: t }) => {
     ...
     return globalThis.isAstro ? null : e && (0, d.jsxs)(d.Fragment, { children: [(0, d.jsx)(m.p, { level: n, suffix: a && (0, d.jsx)(g.D, { state: a }), children: e.title }), (0, d.jsx)(i.fz, { lead: !0, children: t }), ['Help Wanted', 'Community'].includes(a) && (0, d.jsx)(j.s, { relayStep: a, description: `Schets van de ${e.title} component`, name: e.title })] });
    },
    w = ({ component: e }) => {
     const n = (e && p[e.title]) || [];
  ...
  32385(e, n, t) {
   'use strict';
   t.d(n, { bo: () => a, KF: () => m, mJ: () => p, VZ: () => y, cR: () => w, Pv: () => k, qZ: () => s, kD: () => f, QQ: () => D, B2: () => u, Pc: () => l, f4: () => o, GT: () => b, fX: () => r, eQ: () => x, B_: () => v, o_: () => j });
  ...
  48853(e, n, t) {
   ...
   const T = [
    ...
    R = [
     ...
     { title: 'Als de Skip Link toetsenbordfocus krijgt vindt er geen contextwijziging plaats.', sc: '3.2.1', status: '', component: F.Ay, tags: ['developer'] },
     {
  ...
  70903(e, n, t) {
   ...
   var p = t(43864),
    ...
    D = t(79532),
    L = t(30758);
   const A = { boxShadow: p.A, color: k.A, cursor: j.A, dimension: v.A, fontFamily: x.A, fontFamilies: x.A, fontSize: f.A, fontSizes: f.A, fontWeight: b.A, fontWeights: b.A, lineHeight: w.A, lineHeights: w.A, number: y.A, other: S.A, textDecoration: D.A },
    z = ({ type: e }) => {
     const n = Object.hasOwn(A, e) ? e : 'other';
     return (0, u.jsx)(m.In, { children: (0, L.createElement)(A[n]) });
    };
   var N = t(76223);
   function F({ tokens: e }) {
    const n = (0, r.kD)(e),
       ...
       children: [
        ...
        (0, u.jsx)(s.BF, {
         children: o.map((n) => {
          const t = (0, r.o_)(n),
           o = (0, r.eQ)(e, n).$type;
          return (0, u.jsxs)(s.Hj, { children: [(0, u.jsx)(s.nA, { children: (0, u.jsx)(i.C, { children: (0, u.jsx)(s.kf, { children: t }) }) }), (0, u.jsx)(s.nA, { children: (0, u.jsxs)(a.K, { children: [(0, u.jsx)(z, { type: o }), ' ', o] }) })] }, t);
         }),
        }),
       ],
      }),
      (0, u.jsxs)(s.e2, { children: [(0, u.jsx)(h, { content: d, language: 'json', children: 'Kopieer als JSON' }), (0, u.jsx)(h, { content: l, language: 'css', children: 'Kopieer als CSS' })] }),
     ],
    });
   }
  },
