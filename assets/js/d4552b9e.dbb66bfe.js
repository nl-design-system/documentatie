(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [15403],
 {
  89802: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => u, component: () => y, contentTitle: () => a, default: () => p, description: () => j, frontMatter: () => c, issueNumber: () => m, metadata: () => l, title: () => d, toc: () => h });
   var r = n(52676),
    i = n(40139),
    s = n(99890),
    o = n(8657);
  ...
  35038: (e, t, n) => {
   ...
   const o = (e) => {
    ...
    a = (e) => {
     let { href: t, appearance: n, className: o, component: c = 'div', background: a, children: l } = e;
     const u = (e) => ('article' === c ? (0, s.jsx)('article', { ...e }) : 'section' === c ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      h = (0, s.jsx)(u, { className: (0, i.Z)('cardgroup__card', a && 'cardgroup__card--light-purple', `cardgroup__card--${n}`, o), children: l });
        ...
        body:
         ...
         (0, u.jsxs)(u.Fragment, {
          children: [
           ...
           (0, u.jsx)(r.nv, { children: (0, u.jsxs)(r.rU, { href: `${e.url}?filterQuery=${t.title}`, children: [c(e), ' projectbord op GitHub'] }) }),
          ],
         }),
       })),
      })
            ...
            j.Zb,
            {
             ...
             children: (0, u.jsxs)(j.aY, {
              children: [
               ...
               (c.length > 0 || s.length > 0) && (0, u.jsx)(r.X6, { level: n + 1, children: 'Snel aan de slag' }),
               c.length > 0 &&
                (0, u.jsx)(u.Fragment, {
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => g, BA: () => c, Ee: () => u, Q6: () => s, U: () => j, Yr: () => p, d: () => h, e9: () => o, fO: () => v, mA: () => i, ps: () => m, qU: () => b, s0: () => f, zP: () => y });
     ...
     return t.map((t) => {
      const r = e.tasks
       ...
       .map((r) => {
        ...
        return { brand: c.toLowerCase(), name: i, id: s, value: o, description: a };
       });
