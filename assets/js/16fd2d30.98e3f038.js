(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [33430],
 {
  83588: (e, t, n) => {
   'use strict';
   n.r(t), n.d(t, { assets: () => j, component: () => v, contentTitle: () => h, default: () => b, description: () => g, frontMatter: () => l, issueNumber: () => p, metadata: () => u, title: () => y, toc: () => m });
   var r = n(52676),
    c = n(40139),
    s = n(62481),
    i = n(45994),
    ...
    a = n(76233),
    d = n(8657);
   const l = { title: 'Heading 2', hide_title: !0, hide_table_of_contents: !1, sidebar_label: 'Heading 2', pagination_label: 'Heading 2', description: 'Koptekst die volgt na de hoofdkop en in de koppenstructuur op het tweede niveau staat.', slug: '/heading-2' },
    h = void 0,
   ...
   const i = (e) => {
    ...
    a = (e) => {
     ...
     const d = (e) => ('article' === o ? (0, s.jsx)('article', { ...e }) : 'section' === o ? (0, s.jsx)('section', { ...e }) : (0, s.jsx)('div', { ...e })),
      l = (0, s.jsx)(d, { className: (0, c.Z)('cardgroup__card', `cardgroup__card--${n}`, i), children: a });
     return t ? (0, s.jsx)(r.rU, { href: t, boxContent: !0, className: 'cardgroup__link', children: l }) : l;
    },
    d = (e) => {
  ...
  97520: (e, t, n) => {
   ...
   const o = (e) => {
    ...
    const { title: o } = t,
     a = (0, s.mA)(o),
     d = c.lazy(() => n(42767)(`./${a}-docs/docs/aliases.md`).catch(() => ({ default: () => null })));
    return (0, i.jsx)(c.Suspense, { fallback: null, children: (0, i.jsx)(r.U, { omitH1: !0, headingLevel: 1, children: (0, i.jsx)(d, {}) }) });
   };
  },
  76233: (e, t, n) => {
   'use strict';
   ...
   const a = (e) => {
    ...
    l = (e) => {
     let { component: t, illustration: l } = e;
     const { title: h } = t,
      u = (0, i.mA)(h),
      j = s.lazy(() => n(22930)(`./${u}-docs/docs/anatomy/anatomy.md`).catch(() => ({ default: () => null })));
  ...
  8657: (e, t, n) => {
   ...
   const h = { figma: (0, l.jsx)(s.Z, {}), github: (0, l.jsx)(i.Z, {}), npm: (0, l.jsx)(o.Z, {}), storybook: (0, l.jsx)(a.Z, {}) },
    u = (e) => {
     let { brand: t } = e;
     return (0, l.jsx)(r.JO, { children: h[t] || (0, l.jsx)(d.Z, {}) });
    };
   var j = n(35038),
    m = n(40598);
   const y = (e) => {
                 ...
                 children: [
                  ...
                  (0, l.jsx)(r.Mc, {
                   children: i.map((e) => {
                    ...
                    return t ? (0, l.jsxs)(r.k7, { href: e.value, children: [(0, l.jsx)(u, { brand: t.brand }), ' ', t.desciption] }, e.id) : (0, l.jsx)(l.Fragment, {});
                   }),
                  }),
                 ],
                }),
  ...
  57716: (e, t, n) => {
   ...
   const i = (e, t) => {
    ...
    l = (e) => {
     ...
     return (0, s.jsx)(r.Z, { components: { ...d(n, c), ...a(i), ...o }, children: t });
    };
  },
  14669: (e, t, n) => {
   'use strict';
