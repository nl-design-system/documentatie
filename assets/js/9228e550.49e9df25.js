(self.webpackChunk_nl_design_system_website = self.webpackChunk_nl_design_system_website || []).push([
 [54291],
 {
  ...
  8657: (e, t, n) => {
   ...
   const x = (e) => {
     ...
     const c = t && t.projects.filter((e) => w.e9.includes(e.id)),
      i = c && w.e9.map((e) => c.find((t) => t.id === e)).filter(Boolean);
     return (
      t &&
      (0, l.jsx)(r.a2, {
       sections: i.map((e) => ({
        className: (0, s.Z)('definition-of-done', e && `definition-of-done--${(0, w.mA)(e.title)}`),
        headingLevel: n,
        expanded: !1,
    ...
    N = (e) => {
     ...
     return t && (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(g.V, { level: n, suffix: c && (0, l.jsx)(p.y, { state: c }), children: t.title }), (0, l.jsx)(r.nv, { lead: !0, children: s })] });
    };
  },
  23355: (e, t, n) => {
   'use strict';
  ...
  14669: (e, t, n) => {
   'use strict';
   n.d(t, { $3: () => r, $e: () => p, BA: () => o, Ee: () => l, Q6: () => c, U: () => j, Yr: () => g, d: () => h, e9: () => i, fO: () => b, mA: () => s, ps: () => y, qU: () => k, s0: () => v, zP: () => m });
